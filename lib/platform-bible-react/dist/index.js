...
var Kt = (t, e, r) => Ki(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as ye, a as Wr, C as Ee, u as Eo, T as Mt, b as $t, d as It, e as At, A as ie, P as Oe, f as Ye, B as W, h as Me, i as $e, j as Ie, k as Ne, l as Hi, m as qi, n as Gi, E as Wi, o as Xa, r as ge, p as Yi, q as mn, s as aa, t as oa, L as _t, R as Ja, v as Yr, D as Da, w as Oa, x as Ma, y as $a, z as vn, F as Lr, G as Za, H as bn, I as Qa, J as qe, K as kr, M as Ae, N as Pe, O as Ve, S as _r, Q as rr, U as Xi, V as Er, W as We, X as ze, Z as Xe, Y as Se, _ as ar, $ as to, a0 as eo, a1 as Xr, a2 as ro, a3 as xn, a4 as Ji, a5 as Zi, a6 as Qi, a7 as Ia, a8 as yn, a9 as na, aa as kn, ab as ts, ac as es, ad as rs, ae as as, af as _n, ag as Nn, ah as ao, ai as os, aj as Cn, ak as ga, al as To, am as fa, an as ns, ao as is, ap as ss, aq as cs, ar as ls, as as Tr, at as oo, au as ds, av as ws } from "./resizable-CqDIffSo.js";
import { aw as yg, ax as kg, ay as _g, az as Ng, aA as Cg, aB as Eg, aC as Tg, aD as Sg, aE as zg, aF as Rg, aG as Dg, aH as Og, aI as Mg, aJ as $g, aK as Ig, aL as Ag, aM as Pg, aN as Vg, aO as Lg, aP as jg, aQ as Fg, aR as Bg, aS as Ug, aT as Kg } from "./resizable-CqDIffSo.js";
import { jsx as a, jsxs as u, Fragment as it } from "react/jsx-runtime";
import { Canon as Ot } from "@sillsdev/scripture";
import { Check as Re, Clock as So, ChevronsLeft as zo, ChevronsRight as Ro, ChevronLeft as Aa, ChevronRight as Pa, ArrowLeft as us, ArrowRight as ps, ChevronDown as ir, BoldIcon as hs, ItalicIcon as gs, X as no, AtSign as En, Pencil as fs, Trash2 as ms, ArrowUp as Tn, MoreHorizontal as vs, MailOpen as bs, Mail as xs, ChevronUp as ys, FilterIcon as ks, ArrowLeftIcon as _s, ChevronLeftIcon as Ns, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as Sn, Filter as Ts, User as Ss, Link as zs, CircleHelp as Rs, Undo as Ds, Redo as Os, SquareX as zn, FunctionSquare as Rn, SquareSigma as Dn, Ban as Ms, AlertCircle as Va, CircleCheckIcon as $s, CircleXIcon as Is, CircleHelpIcon as As, ArrowUpIcon as Ps, ArrowDownIcon as Vs, ScrollText as Ls, ChevronsUpDown as js, MenuIcon as Fs, Menu as Bs, EllipsisVertical as Us, MoreVertical as Ks } from "lucide-react";
import { Section as wt, getChaptersForBook as Hs, formatScrRef as ke, getSectionForBook as jr, formatRelativeDate as qs, formatReplacementString as Ge, sanitizeHtml as io, NumberFormat as On, formatBytes as Gs, getCurrentLocale as Ws, usfmMarkers as Fr, getFormatCallerFunction as Ys, deepEqual as Xs, isString as Do, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Js, getLocalizeKeyForScrollGroupId as Oo, formatReplacementStringToArray as Mo, collectUsjMarkers as Zs } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as M, createContext as Sr, useContext as ia, useState as k, useEffect as G, useCallback as F, useImperativeHandle as Qs, useLayoutEffect as Xt, Component as tc, createElement as $o, Suspense as ec, forwardRef as Mn, useId as Io, Fragment as sa } from "react";
import { IconSelector as $n, IconCheck as ca, IconChevronDown as rc, IconChevronUp as ac, IconLayoutSidebar as oc, IconLayoutSidebarRight as nc, IconChevronRight as In, IconSearch as ic, IconLoader as sc, IconAlertOctagon as cc, IconAlertTriangle as lc, IconInfoCircle as dc, IconCircleCheck as wc } from "@tabler/icons-react";
import { createEditor as An, $getRoot as De, $createParagraphNode as zr, $getSelection as Jt, HISTORY_MERGE_TAG as so, ParagraphNode as Pn, TextNode as Vn, $getPreviousSelection as uc, $isRangeSelection as pe, $caretFromPoint as pc, $getSiblingCaret as Ln, $getChildCaret as hc, $getAdjacentChildCaret as gc, $isChildCaret as fc, $normalizeCaret as mc, $setSelectionFromCaretRange as vc, $getCollapsedCaretRange as bc, $getCaretInDirection as Ao, $splitAtPointCaretNext as xc, $isTextPointCaret as yc, $findMatchingParent as jn, $isElementNode as Nr, mergeRegister as Ce, getDOMTextNode as kc, isHTMLElement as _c, CLEAR_EDITOR_COMMAND as Fn, COMMAND_PRIORITY_EDITOR as co, shallowMergeConfig as Nc, defineExtension as re, safeCast as Je, createState as Cc, FORMAT_TEXT_COMMAND as Bn, $isNodeSelection as Un, COMMAND_PRIORITY_LOW as Kn, RootNode as Ec, LineBreakNode as Tc, TabNode as Sc, $isEditorState as zc, createCommand as Rc, CLICK_COMMAND as Dc, isDOMNode as Oc, $getNodeFromDOMNode as Mc, $createNodeSelection as $c, $setSelection as Ic, $getEditor as Ac, DecoratorNode as ja, $getState as Pc, toggleTextFormatType as Po, TEXT_TYPE_TO_FORMAT as Vc, $setState as Lc, addClassNamesToElement as Hn, $create as jc, $getNodeByKey as Fc, removeClassNamesFromElement as Bc, KEY_TAB_COMMAND as Uc, $isBlockElementNode as Kc, $createRangeSelection as Hc, $normalizeSelection__EXPERIMENTAL as qc, OUTDENT_CONTENT_COMMAND as Gc, INDENT_CONTENT_COMMAND as Vo, INSERT_TAB_COMMAND as Wc, COMMAND_PRIORITY_CRITICAL as lo, $isDecoratorNode as Yc, $isParagraphNode as Xc, $isTextNode as Fa, SELECTION_CHANGE_COMMAND as qn, $insertNodes as Jc } from "lexical";
import { HeadingNode as Zc, QuoteNode as Qc, registerRichText as tl } from "@lexical/rich-text";
import { flushSync as el, createPortal as rl } from "react-dom";
import { $isTableSelection as al } from "@lexical/table";
import { createHeadlessEditor as Gn } from "@lexical/headless";
import { $generateHtmlFromNodes as ol, $generateNodesFromDOM as nl } from "@lexical/html";
import { Avatar as wo, Select as qt, Checkbox as Lo, Slot as Rr, Tabs as se, Menubar as fe, ContextMenu as Pt, Progress as jo, Slider as Mr, Switch as Fo } from "radix-ui";
import { useReactTable as Wn, getFilteredRowModel as il, getSortedRowModel as Yn, getPaginationRowModel as sl, getCoreRowModel as Xn, flexRender as xr, getGroupedRowModel as cl, getExpandedRowModel as ll } from "@tanstack/react-table";
import dl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ba, HIDDEN_NOTE_CALLER as Ua, getDefaultViewOptions as wl, isInsertEmbedOpOfType as $r, Editorial as ul } from "@eten-tech-foundation/platform-editor";
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        ...
        {
          ref: t,
          value: d || `${e} ${Ot.bookIdToEnglishName(e)}`,
          onSelect: h,
          onMouseDown: g,
          role: "option",
          "aria-selected": r,
...
function vl({
  ...
  G(() => {
    var _;
    ml();
    const j = (_ = O.current) == null ? void 0 : _.closest('button, [role="combobox"], [tabindex]');
    if (!j) return;
    const D = (J) => !!J && J.scrollWidth > J.clientWidth, H = () => {
      Ka !== "pointer" && (C || D(h.current) || D(l.current)) && N(!0);
    }, z = () => N(!1);
    return j.addEventListener("focus", H), j.addEventListener("blur", z), () => {
      j.removeEventListener("focus", H), j.removeEventListener("blur", z);
    };
  }, [C, h, l]);
  const I = F(() => {
    C && E(!0), f(), U && w();
  ...
  const T = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), A = U ? (
        ...
        children: [
          /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                K,
                K && L && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                L
              ]
            }
          ) }),
          /* @__PURE__ */ a(At, { children: s })
        ]
      }
    ) })
  );
...
function bl({
  ...
  return /* @__PURE__ */ u(Oe, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Me, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ne, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      Ee,
      {
        onSelect: () => E(y),
...
function Uo(t, e) {
  return Ot.bookIdToNumber(t) < Ot.bookIdToNumber(e.book);
}
function _l(t, e, r) {
  const o = Ot.bookIdToNumber(t) - Ot.bookIdToNumber(r.book);
  return o < 0 ? !0 : o > 0 ? !1 : e < r.chapterNum;
}
function ba(t, e, r, o) {
  const n = Ot.bookIdToNumber(t) - Ot.bookIdToNumber(o.book);
...
function xa({
  ...
  const U = ge(), C = fl(), [I, $] = k(!1), [T, A] = k(""), [K, L] = k(""), [j, D] = k("books"), [H, z] = k(void 0), [_, J] = k(
    void 0
  ), [Z, gt] = k(void 0), [ft, Vt] = k(!1), Y = B(null), nt = B(!1), at = B(void 0), ut = B(void 0), ct = B(void 0), Ft = B(void 0), pt = B({}), Zt = B({}), xt = F(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Et = M(() => o ? o() : Yi, [o]), Bt = M(() => ({
    [wt.OT]: Et.filter((q) => Ot.isBookOT(q)),
    [wt.NT]: Et.filter((q) => Ot.isBookNT(q)),
    [wt.DC]: Et.filter((q) => Ot.isBookDC(q)),
    [wt.Extra]: Et.filter((q) => Ot.extraBooks().includes(q))
  }), [Et]), ae = M(() => Object.values(Bt).flat(), [Bt]), ce = M(() => {
    if (!K.trim()) return Bt;
    const x = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((tt) => {
      x[tt] = Bt[tt].filter((Rt) => Xa(Rt, K, n));
    }), x;
  }, [Bt, K, n]), S = M(
    () => Nl(K, ae, n),
    [K, ae, n]
  ...
  const Lt = F(() => {
    if (S) {
      const x = S.chapterNum ?? 1, q = S.verseNum ?? 1;
      if (w && ba(S.book, x, q, w))
        return;
      xt({
        book: S.book,
        chapterNum: x,
    ...
    (x) => {
      const q = _ ?? (S == null ? void 0 : S.book), tt = Z ?? (S == null ? void 0 : S.chapterNum);
      !q || !tt || (xt({
        book: q,
        chapterNum: tt,
        verseNum: x
    ...
    (x) => {
      const q = j === "chapters" ? H : S == null ? void 0 : S.book;
      if (q) {
        if (d && d(q, x) > 1) {
          J(q), gt(x), D("verses"), A("");
          return;
    ...
    D("books"), z(void 0), J(void 0), gt(void 0), setTimeout(() => {
      ut.current && ut.current.focus();
    }, 0);
  }, []), st = F(() => {
    const x = _;
    J(void 0), gt(void 0), x ? (z(x), D("chapters"), A("")) : et();
  }, [_, et]), rt = F((x) => {
    $(x), x && (D("books"), z(void 0), J(void 0), gt(void 0), L(""));
  }, []);
  G(() => {
    O && rt(!1);
  }, [O, rt]);
  ...
  G(() => {
    var x;
    bt !== 0 && ((x = ut.current) == null || x.focus());
  }, [bt]), Qs(
    N,
    () => ({
      open: () => {
  ...
  const { otLong: mt, ntLong: St, dcLong: Ut, extraLong: jt } = {
    ...
    (x) => S ? !!S.chapterNum && !x.toString().includes(S.chapterNum.toString()) : !1,
    [S]
  ), R = M(
    () => ke(
      t,
    ...
    () => C >= Br.TIGHT ? Wr(t.book, n) : ye(t.book, n),
    [t.book, n, C]
  ), zt = `${t.chapterNum}:${t.verseNum}`, Qt = F((x) => (q) => {
    pt.current[x] = q;
  }, []), je = F((x) => (q) => {
    Zt.current[x] = q;
  }, []), Ze = M(
    () => kl(K),
    [K]
  ), pr = M(() => !d || !S || !S.chapterNum || !Ze ? !1 : d(S.book, S.chapterNum) > 0, [d, S, Ze]), Dr = F(
    (x) => w ? Uo(x, w) : !1,
    [w]
  ), hr = F(
    (x) => (q) => w ? _l(x, q, w) : !1,
    ...
    [w]
  ), fr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Fe = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Be = F(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && S && S.chapterNum !== void 0 && S.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), Lt());
    },
    [p, S, Lt]
  ), ha = F(
    (x) => {
      var be, xe, Qe;
      if (x.ctrlKey) return;
      const { isLetter: q, isDigit: tt } = Ko(x.key);
      if ((j === "chapters" || j === "verses") && (x.key === " " || x.key === "Enter")) {
        const Ct = x.target instanceof HTMLElement ? x.target : void 0;
        ...
        const kt = (be = at.current) == null ? void 0 : be.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (kt) {
          x.preventDefault(), x.stopPropagation(), kt.click();
          return;
        }
      }
      if ((j === "chapters" || j === "verses") && (q || tt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (j === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), et();
        return;
      }
      if (j === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), st();
        return;
      }
      const Rt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (j === "verses" && Rt) {
        const Ct = _, yt = Z;
        if (!Ct || !yt || !d) return;
        const kt = d(Ct, yt);
        if (!kt) return;
        (xe = at.current) == null || xe.focus();
        const vt = (() => {
          if (!T) return 1;
          const Ue = T.match(/:(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            vt !== 0 && (te = vt > 1 ? vt - 1 : kt);
            break;
          case "ArrowRight":
            vt !== 0 && (te = vt < kt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            te = vt === 0 ? kt : Math.max(1, vt - de);
            break;
          case "ArrowDown":
            te = vt === 0 ? 1 : Math.min(kt, vt + de);
            break;
          default:
            return;
        }
        te !== vt && (x.preventDefault(), x.stopPropagation(), A(
          `${Ct} ${ie[Ct] || ""} ${yt}:${te}`
        ), setTimeout(() => {
          const Ue = Zt.current[te];
          Ue && Ue.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((j === "chapters" || j === "books" && S) && Rt) {
        const Ct = j === "chapters" ? H : S == null ? void 0 : S.book;
        if (!Ct) return;
        j === "chapters" && ((Qe = at.current) == null || Qe.focus());
        const yt = (() => {
          if (!T) return 1;
          const de = T.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            yt !== 0 && (vt = yt > 1 ? yt - 1 : kt);
            break;
          case "ArrowRight":
            yt !== 0 && (vt = yt < kt ? yt + 1 : 1);
            break;
          case "ArrowUp":
            vt = yt === 0 ? kt : Math.max(1, yt - te);
            break;
          case "ArrowDown":
            vt = yt === 0 ? 1 : Math.min(kt, yt + te);
            break;
          default:
            return;
        }
        vt !== yt && (x.preventDefault(), x.stopPropagation(), A(
          `${Ct} ${ie[Ct] || ""} ${vt}`
        ), setTimeout(() => {
          const de = pt.current[vt];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Rt = ut.current) == null || Rt.focus();
      return;
    }
    const { isLetter: q, isDigit: tt } = Ko(x.key);
    (q || tt) && (x.preventDefault(), L((be) => be + x.key), ut.current.focus(), Vt(!1));
  }, []);
  return Xt(() => {
    const x = setTimeout(() => {
      if (I && j === "books" && ct.current && Ft.current) {
        const q = ct.current, tt = Ft.current, Rt = tt.offsetTop, be = q.clientHeight, xe = tt.clientHeight, Qe = Rt - be / 2 + xe / 2;
        q.scrollTo({
          top: Math.max(0, Qe),
          behavior: "smooth"
        }), A(ti(t.book));
    ...
    if (j === "chapters" && H) {
      const x = H === t.book, q = x ? t.chapterNum : 1;
      A(
        `${H} ${ie[H] || ""} ${q}`
      ), setTimeout(() => {
        if (ct.current)
          if (x) {
            const tt = pt.current[t.chapterNum];
  ...
  }, [j, H, S, t.book, t.chapterNum]), Xt(() => {
    if (j === "verses" && _ && Z !== void 0) {
      const x = _ === t.book && Z === t.chapterNum, q = x ? t.verseNum : 1;
      A(
        `${_} ${ie[_] || ""} ${Z}:${q}`
      ), setTimeout(() => {
        if (ct.current)
          if (x) {
            const tt = Zt.current[t.verseNum];
            tt && tt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            ct.current.scrollTo({ top: 0 });
        at.current && at.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Oe, { open: I, onOpenChange: rt, modal: E, children: [
    /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ u(
      W,
      {
        ...
        onClick: (x) => {
          nt.current && (nt.current = !1, x.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a(
            vl,
            {
              primary: Nt,
              secondary: zt,
              showSecondary: C < Br.MINIMUM,
              isPartial: C >= Br.TIGHT,
              fullText: R
            }
          ),
          f && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      Me,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: q } = x;
          I && Y.current && q instanceof Node && Y.current.contains(q) && (nt.current = !0, rt(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          $e,
          {
            ...
            children: [
              j === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: lt.map(
                  ({ onClick: x, disabled: q, title: tt, icon: Rt }) => /* @__PURE__ */ a(
                    W,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  W,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: j === "verses" ? st : et,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: U === "ltr" ? /* @__PURE__ */ a(us, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ps, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                j === "chapters" && H && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ye(H, n) }),
                j === "verses" && _ && Z !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ye(_, n)} ${Z}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: j === "verses" ? Fe : fr
                  }
                )
              ] }),
              !ft && /* @__PURE__ */ u(Ie, { ref: ct, children: [
                j === "books" && /* @__PURE__ */ u(it, { children: [
                  !S && Object.entries(ce).map(([x, q]) => {
                    if (q.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ne, { heading: Gt(x), children: q.map((tt) => /* @__PURE__ */ a(
                          Jn,
                          {
                            bookId: tt,
                            onSelect: (Rt) => oe(Rt),
                  ...
                  S && /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(
                    Ee,
                    {
                      ...
                      children: ke(
                        ...
                        n ? Wr(S.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  S && pr && S.chapterNum && d && /* @__PURE__ */ u(it, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ye(S.book, n)} ${S.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      qo,
                      {
                        ...
                        endVerse: d(S.book, S.chapterNum),
                        scrRef: t,
                        onVerseSelect: le,
                        setVerseRef: je,
                        isVerseDisabled: gr(S.book, S.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  S && !pr && or(S.book) > 1 && /* @__PURE__ */ u(it, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ye(S.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Ho,
                      {
                        ...
                        setChapterRef: Qt,
                        isChapterDimmed: ve,
                        isChapterDisabled: hr(S.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                j === "chapters" && H && /* @__PURE__ */ a(
                  Ho,
                  {
                    bookId: H,
                    scrRef: t,
                    onChapterSelect: V,
                    setChapterRef: Qt,
                    isChapterDisabled: hr(H),
                    className: "tw:p-4"
                  }
                ),
                j === "verses" && _ && Z !== void 0 && d && /* @__PURE__ */ a(
                  qo,
                  {
                    bookId: _,
                    chapterNum: Z,
...
function Go({
  ...
  const [N, O] = k(!1), U = d ?? l, C = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], I = ($, T) => {
    const A = l($), K = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, L = `${T ?? ""}${A}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ee,
      {
        value: A,
  ...
  return /* @__PURE__ */ u(Oe, { open: N, onOpenChange: O, ...y, children: [
    /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ u(
      W,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Me,
      {
        ...
        children: /* @__PURE__ */ u($e, { children: [
          ...
          /* @__PURE__ */ a(Ie, { children: C(e) ? e.map(($) => /* @__PURE__ */ a(Ne, { heading: $.groupHeading, children: $.options.map((T) => I(T, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(Ne, { children: e.map(($) => I($)) }) })
        ] })
      }
    )
  ] });
    ...
    Ja,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:flex tw:items-center", children: o.map((m) => Ot.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            W,
            {
...
const ai = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Sl = ai ? Xt : G, Ar = { tag: so };
function zl({ initialConfig: t, children: e }) {
  const r = M(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Tl(null, o), w = An({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = zr();
            g.append(f);
            const b = ai ? document.activeElement : null;
...
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
...
class Ml extends tc {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && $l(e.resetKeys, n)) {
      var i, s;
...
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
function Pl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Vl() {
  return function(t) {
    const [e] = me(), r = M(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = B(o);
    return Al(() => {
...
const oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, jl = oi && "documentMode" in document ? document.documentMode : null;
!(!oi || !("InputEvent" in window) || jl) && "getTargetRanges" in new window.InputEvent("input");
function ue(t) {
  return `${t}px`;
}
const Fl = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Bl(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const c = document.createElement("div");
  function l() {
    o === null && Jr(182), n === null && Jr(183);
    const { left: p, top: h } = n.getBoundingClientRect(), g = Ll(t, e);
    var f, b;
    ...
    for (let E = 0; E < g.length; E++) {
      ...
      const C = ue(y.top - h);
      O.top !== C && (N.style.top = C, m = !0);
      const I = ue(y.width);
      O.width !== I && (N.style.width = I, m = !0);
      const $ = ue(y.height);
      O.height !== $ && (N.style.height = $, m = !0), N.parentNode !== c && (c.append(N), m = !0), s[E] = N;
    }
...
function Kl(t, e = Ul) {
  ...
  function d(w) {
    w.read(() => {
      const p = Jt();
      if (!pe(p)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function($) {
        const T = $.getStartEndPoints();
        return $.isBackward() ? [T[1], T[0]] : T;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, O = t.getElementByKey(b), U = t.getElementByKey(y), C = r === null || O !== o || m !== n || b !== r.getKey(), I = i === null || U !== s || N !== c || y !== i.getKey();
      if ((C || I) && O !== null && U !== null) {
        const $ = function(T, A, K, L, j, D, H) {
          const z = (T._window ? T._window.document : document).createRange();
          return z.setStart(...Wo(A, K, L)), z.setEnd(...Wo(j, D, H)), z;
        }(t, h, f, O, g, E, U);
        l(), l = Bl(t, $, e);
      }
      r = f, o = O, n = m, i = E, s = U, c = N;
    });
  }
...
function Hl(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = Kl(t, e));
  };
...
function Gl(t) {
  const e = Jt() || uc();
  let r;
  if (pe(e)) r = pc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Ln(c, "next"));
    }
    r = r || hc(De(), "previous").getFlipped().insert(zr());
  }
  const o = Wl(t, r), n = gc(o), i = fc(n) ? mc(n) : o;
  return vc(bc(i)), t.getLatest();
}
function Wl(t, e, r) {
  let o = Ao(e, "next");
  for (let n = o; n; n = xc(n, r)) o = n;
  return yc(o) && Jr(283), o.insert(t.isInline() ? zr().append(t) : t), Ao(Ln(t.getLatest(), "next"), e.direction);
}
function Yl(t) {
  const e = Jt();
  if (!pe(e)) return !1;
...
let Zr, _e = 0, Qr = 0, Zl = 0, qa = 0, Kr = 0;
function Xo(t) {
  if (ot === void 0) return;
  let e = t.n;
...
function Ke(t, e) {
  Ht.call(this, void 0), this.x = t, this.s = void 0, this.g = Kr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Ql(t, e) {
  return new Ke(t, e);
}
...
function td(t) {
  ...
  ii(this), ot = t, this.f &= -2, 8 & this.f && ho(this), wa();
}
function er(t, e) {
...
Ht.prototype.brand = Xl, Ht.prototype.h = function() {
  return !0;
...
} }), Ke.prototype = new Ht(), Ke.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Kr)) return !0;
  if (this.g = Kr, this.f |= 1, this.i > 0 && !ni(this)) return this.f &= -2, !0;
  const t = ot;
  try {
    Jo(this), ot = this;
    const e = this.x();
  ...
  return ot = t, ii(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, si(this), Jo(this), _e++;
  const t = ot;
  return ot = this, td.bind(this, t);
...
re({ build: (t, e, r) => ur(e), config: Je({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ci() {
  const t = De(), e = Jt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), pe(e) && (e.format = 0);
}
function li(t, e = ci) {
  return t.registerCommand(Fn, (r) => (t.update(e), !0), co);
}
re({ build: (t, e, r) => ur(e), config: Je({ $onClear: ci }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return he(() => li(t, o.value));
} });
function ed(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const _a = Cc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class di extends ja {
  $config() {
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [di], register: (t, e, r) => t.registerCommand(Bn, (o) => {
  const n = Jt();
  if (Un(n) || pe(n)) for (const i of n.getNodes()) rd(i) && i.toggleFormat(o);
  return !1;
}, Kn) });
function wi(t, e) {
  let r;
...
const Ga = re({ build: (t) => wi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const go = 0, Wa = 1, pi = 2, Na = 3, Pr = 4, tr = 5, Ca = 6, vr = 7;
function Ea(t) {
  return t.id === go;
}
function hi(t) {
...
function ad(t) {
  return function(e) {
    return e.id === Wa;
  }(t) || dt(305, String(t.id), String(Wa)), Object.assign(t, { id: pi });
}
...
class nd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && dt(307, String(r.id), String(tr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== tr && dt(308, String(o.id), String(tr));
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || od;
  }
  getPeerNameSet() {
...
const sd = re({ config: Je({ setOptions: Zo, updateOptions: Zo }), init: ({ $initialEditorState: t = id }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Ec, Vn, Tc, Sc, Pn] }), Qo = Symbol.for("@lexical/extension/LexicalBuilder");
function tn() {
}
function cd(t) {
  throw t;
...
class nr {
  ...
  static maybeFromEditor(e) {
    const r = e[Qo];
    return r && (r.PACKAGE_VERSION !== Ta && dt(292, r.PACKAGE_VERSION, Ta), r instanceof nr || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ea(i) || dt(300, s, n || "[unknown]"), Ea(c = i) || dt(304, String(c.id), String(go)), i = Object.assign(c, { id: Wa }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = ad(i), o.state = i, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of ed(p)) {
...
const ld = /* @__PURE__ */ new Set(), en = re({ build(t, e, r) {
  const o = r.getDependency(Ga).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = wi(() => {
  }, () => he(() => {
...
class sr extends ja {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: wd, priority: 0 }) };
  }
  exportDOM() {
...
re({ dependencies: [Ga, en], name: "@lexical/extension/HorizontalRule", nodes: () => [sr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(dd, (s) => {
    const c = Jt();
    if (!pe(c)) return !1;
    ...
    return !0;
  }, co), t.registerCommand(Dc, (s) => {
    if (Oc(s.target)) {
      const c = Mc(s.target);
      if (ud(c)) return function(l, d = !1) {
        const w = Jt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Un(w) ? g = w : (g = $c(), Ic(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
    ...
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(he(() => {
      const d = c.value;
      d && (l.value ? Hn(d, i) : Bc(d, i));
    }));
    return Ce(...s);
  }));
} });
re({ build: (t, e) => ur({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Je({ $getParentEditor: function() {
  const t = Ac();
...
re({ build: (t, e, r) => ur(e), config: Je({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return he(() => {
    if (!o.disabled.value) return Hl(t, o.onReposition.value);
  });
} });
function gi(t) {
  return t.canBeEmpty();
}
function pd(t, e, r = gi) {
  return Ce(t.registerCommand(Uc, (o) => {
    const n = Jt();
    if (!pe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Gc : Vo : Wc;
    return t.dispatchCommand(i, void 0);
  }, co), t.registerCommand(Vo, () => {
...
re({ build: (t, e, r) => ur(e), config: Je({ $canIndent: gi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
re({ build: (t, e, r) => ur(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => he(() => r.getOutput().disabled.value ? void 0 : mi(t)) });
function vd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const mo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
  ...
  return function(r, o) {
    ...
    return mo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(ec, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(rl(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function rn(t) {
  return t.getEditorState().read(fi(t.isComposing()));
}
function yd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = me();
  return function(n) {
    mo(() => Ce(tl(n), mi(n)), [n]);
  }(o), u(it, { children: [t, a(kd, { content: e }), a(xd, { editor: o, ErrorBoundary: r })] });
}
...
function _d({ defaultSelection: t }) {
  const [e] = me();
  return G(() => {
    e.focus(() => {
...
const Nd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
function Cd({ onClear: t }) {
  const [e] = me();
  return Nd(() => li(e, t), [e, t]), null;
}
const vi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
function Ed({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: E = !0, style: y, tabIndex: N, "data-testid": O, ...U }, C) {
  const [I, $] = k(t.isEditable()), T = F((K) => {
    K && K.ownerDocument && K.ownerDocument.defaultView ? t.setRootElement(K) : t.setRootElement(null);
  }, [t]), A = M(() => /* @__PURE__ */ function(...K) {
    return (L) => {
      for (const j of K) typeof j == "function" ? j(L) : j != null && (j.current = L);
    };
  }(C, T), [T, C]);
  return vi(() => ($(t.isEditable()), t.registerEditableListener((K) => {
    $(K);
  })), [t]), a("div", { "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? r : "none", "aria-controls": I ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": I ? p : void 0, "aria-readonly": !I || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: I, "data-testid": O, id: b, ref: A, role: m, spellCheck: E, style: y, tabIndex: N, ...U });
}
const Td = Mn(Ed);
function an(t) {
  return t.getEditorState().read(fi(t.isComposing()));
...
function zd(t, e) {
  ...
  return u(it, { children: [a(Td, { editor: n, ...o, ref: e }), r != null && a(Rd, { editor: n, content: r })] });
}
...
function Od({
  ...
  return /* @__PURE__ */ a(bi.Provider, { value: s, children: i });
}
function xi() {
  const t = ia(bi);
  if (!t)
...
function $d({
  ...
  const [e] = me(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = Md(), l = () => {
  };
...
function Ad() {
  const { activeEditor: t } = xi(), [e, r] = k([]), o = F((n) => {
    if (pe(n) || al(n)) {
      const i = [];
      on.forEach(({ format: s }) => {
...
function Vd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a($d, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Ad, {}) }) }),
      ...
      /* @__PURE__ */ a(
        yd,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Dd, { placeholder: t }) }),
          ErrorBoundary: Il
        }
      ),
      e && /* @__PURE__ */ a(_d, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ a(
          zl,
          {
            ...
            children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Vd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Dl,
                {
...
function ki(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : ki(e.children)
  ) : !1;
}
function ee(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? ki(t.root.children) : !1;
}
function jd(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = nl(e, n);
      De().clear(), Jc(i);
    },
    {
      discrete: !0
...
function Ni({
  ...
  return /* @__PURE__ */ u(Za, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(bn, {}),
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
const Fd = "verseText", pp = Object.freeze([
...
function Ei(t) {
  return (t == null ? void 0 : t.conflictType) === Fd;
}
function Ti(t) {
...
function hp({
  ...
  const [i, s] = k(Bd), [c, l] = k(n), [d, w] = k(!1), p = B(void 0), h = B(null);
  G(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Oe, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Me,
        {
          ...
          children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Ie, { children: t.map((m) => /* @__PURE__ */ a(
            Ee,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : bo(m) && (m.preventDefault(), m.stopPropagation(), ee(i) && g());
        },
        onKeyDown: (m) => {
...
function sn({
  ...
  }, [t.date, r]), m = M(() => t.user, [t.user]), E = M(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = M(() => io(t.contents), [t.contents]), N = M(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), O = !!t.conflictResolutionAction && !N, U = M(() => {
    if (o && c)
      return /* @__PURE__ */ u(it, { children: [
        /* @__PURE__ */ u(
          qe,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), p(jd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(qd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Gd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : bo(C) && (C.preventDefault(), C.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (C) => {
                vo(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(it, { children: [
            ...
            O ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: Ti(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: v(
        ...
        U && /* @__PURE__ */ u(Ae, { children: [
          /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(vs, {}) }) }),
          /* @__PURE__ */ a(Ve, { align: "end", children: U })
        ] })
      ]
    }
  );
...
function zi({
  ...
  const [L, j] = k(cn), [D, H] = k(), [z, _] = k(), J = o, [Z, gt] = k(!1), [ft, Vt] = k(!1), [Y, nt] = k(!1), [at, ut] = k(!1), [ct, Ft] = k(!1), [pt, Zt] = k(O), [xt, Et] = k(!1), Bt = B(void 0), [ae, ce] = k(/* @__PURE__ */ new Map());
  G(() => {
    let R = !0;
    return (async () => {
    ...
    let R = !0;
    if (!o) {
      ut(!1), ce(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const zt = E ? await E(l) : !1;
      R && ut(zt);
    })(), () => {
      R = !1;
    };
  ...
  G(() => {
    if (!o) {
      S.current !== "idle" && (H(void 0), _(void 0), S.current = "idle");
      return;
    }
    S.current === "idle" && (S.current = "pending"), at ? S.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (H(I), S.current = "auto-populated") : S.current === "auto-populated" && (H(void 0), S.current = "pending");
  }, [o, I, at, i]);
  const Tt = M(
  ...
  const Lt = M(() => Tt[0], [Tt]), le = B(null), oe = B(void 0), V = F(() => {
    var R;
    (R = oe.current) == null || R.call(oe), j(cn);
  }, []), Q = F(() => {
    const R = !pt;
    Zt(R), Et(!R), f == null || f(l, R);
  }, [pt, f, l]);
  G(() => {
    gt(!1);
  }, [o]), G(() => {
    if (o && !pt && !xt) {
      ...
      return Bt.current = R, () => clearTimeout(R);
    }
  ...
  }, [i, r]), st = M(() => Tt.slice(1), [Tt]), rt = M(() => st.length ?? 0, [st.length]), bt = M(() => rt > 0, [rt]), ht = M(() => Z || rt <= 2 ? st : st.slice(-2), [st, rt, Z]), mt = M(() => Z || rt <= 2 ? 0 : rt - 2, [rt, Z]), St = M(
    () => rt === 1 ? lt.singleReply : Ge(lt.multipleReplies, { count: rt }),
    [rt, lt]
  ), Ut = M(
    () => mt === 1 ? lt.singleReply : Ge(lt.multipleReplies, { count: mt }),
    [mt, lt]
  );
  G(() => {
    !o && ft && bt && Vt(!1);
  ...
  const jt = F(
    async (R) => {
      ...
      Nt && await p({ threadId: l, contents: Nt }) && V();
    },
    [
      V,
      L,
    ...
    async (R) => {
      const Nt = ee(L) ? ea(L) : void 0, zt = R.status ? R.assignedUser : D ?? R.assignedUser, Qt = await p({
        ...R,
        contents: Nt,
        assignedUser: zt
      });
      return Qt && (zt !== void 0 && _(zt), Nt && V()), Qt;
    },
    [V, L, p, D]
  );
  ...
  const ve = /* @__PURE__ */ a(
    sn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: Gt,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: Vt,
      canEditOrDelete: (!ft && ae.get(Lt.id)) ?? !1,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              W,
              {
                ...
                children: pt ? /* @__PURE__ */ a(bs, {}) : /* @__PURE__ */ a(xs, {})
              }
            ),
            A === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: ct && w !== "Resolved",
                  onClick: () => Gt({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(it, { children: [
          ...
          !o && ee(L) && /* @__PURE__ */ a(
            ta,
            {
              ...
              onSerializedChange: (R) => j(R),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(it, { children: [
            K && ht.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    Z ? /* @__PURE__ */ a(ys, {}) : /* @__PURE__ */ a(ir, {})
                  ] })
                ]
              }
            ),
            ht.map((R) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              sn,
              {
                comment: R,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Vt,
                canEditOrDelete: (!ft && ae.get(R.id)) ?? !1
              }
            ) }, R.id)),
            m !== !1 && (!ft || ee(L)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (R) => {
                  bo(R) && (R.preventDefault(), R.stopPropagation(), (ee(L) || D !== void 0 && D !== z) && jt());
                },
                onKeyDown: (R) => {
                  vo(R), (R.key === "Enter" || R.key === " ") && R.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    D !== void 0 && (ee(L) || D !== z) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                    ...
                    /* @__PURE__ */ u(Oe, { open: Y, onOpenChange: nt, children: [
                      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ a(
                        W,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !at || !b || b.length === 0 || !b.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Me,
                        {
                          ...
                          children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Ie, { children: b == null ? void 0 : b.map((R) => /* @__PURE__ */ a(
                            Ee,
                            {
                              onSelect: () => {
                                H(R !== i ? R : void 0), S.current = "user-selected", _(void 0), nt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Hr(R, r) })
                            },
                            R || "unassigned"
                          )) }) })
                        }
...
), Yd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => Yd(io(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Xd({
  ...
  const A = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: A }), L = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : K, j = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: E }) : K : L(z === "reject" ? t.rejectedResultText : t.resultText);
  }, D = (z) => p && z.value === "reject", H = (z) => {
    const _ = f === z.value, J = `${d}-${z.value}`, Z = D(z);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(it, { children: [
        ...
        /* @__PURE__ */ a(
          Ja,
          {
            ...
            children: C.map((z) => D(z) ? /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u($t, { children: [
              /* @__PURE__ */ a(It, { asChild: !0, children: H(z) }),
              /* @__PURE__ */ a(At, { children: O })
            ] }) }, z.value) : H(z))
          }
        ),
        /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u($t, { children: [
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return Ti(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function ew(t) {
  ...
  } = t, c = M(() => e.filter((E) => !E.deleted), [e]), l = M(
    () => c.find((E) => E.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = tw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function _p({
  ...
  const [y, N] = k(/* @__PURE__ */ new Set()), [O, U] = k(), [C, I] = k(), $ = F(
    async (_) => {
      const J = await i(_);
      return J !== void 0 && _.assignedUser !== void 0 && _.assignedUser !== "" && I(_.assignedUser), J;
    },
    [i]
  );
  G(() => {
    f && (N((_) => new Set(_).add(f)), U(f));
  }, [f]);
  const T = r.filter(
    (_) => _.comments.some((J) => !J.deleted)
  ), A = T.map((_) => ({ id: _.id })), K = F(
    (_) => {
      N((J) => new Set(J).add(_.id)), U(_.id), b == null || b(_.id);
    },
    [b]
  ), L = F(
    (_) => {
      ...
      N((Z) => {
        const gt = new Set(Z);
        return gt.has(_) ? gt.delete(_) : gt.add(_), gt;
      }), U(_), b == null || b(J ? void 0 : _);
    },
    [y, b]
  ), { listboxRef: j, activeId: D, handleKeyDown: H } = Xi({
    options: A,
    onOptionSelect: K
  }), z = F(
    (_) => {
      _.key === "Escape" ? (O && y.has(O) && (N((J) => {
        const Z = new Set(J);
        return Z.delete(O), Z;
      }), U(void 0), b == null || b(void 0)), _.preventDefault(), _.stopPropagation()) : H(_);
    },
    [O, y, H, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: T.map((_) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: _.type === "Conflict" ? /* @__PURE__ */ a(ew, { ...J, conflictResolution: E }) : /* @__PURE__ */ a(zi, { ...J })
          },
          _.id
        );
      })
...
function rw({ table: t }) {
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        cr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(wr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ne, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function sw({
  ...
  var C;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, E] = k({}), y = M(() => e ?? [], [e]), N = Wn({
    data: y,
    columns: t,
    getCoreRowModel: Xn(),
  ...
  let U;
  return l ? U = Array.from({ length: 10 }).map((T, A) => `skeleton-row-${A}`).map((T) => /* @__PURE__ */ a(Se, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ar, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(rr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, T)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? U = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Se,
    {
      onClick: () => s(I, N),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map(($) => /* @__PURE__ */ a(ar, { children: xr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    I.id
  )) : U = /* @__PURE__ */ a(Se, { children: /* @__PURE__ */ a(ar, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(rw, { table: N }),
    /* @__PURE__ */ u(to, { stickyHeader: i, children: [
      /* @__PURE__ */ a(eo, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Se, { children: I.headers.map(($) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : xr($.column.columnDef.header, $.getContext()) }, $.id)) }, I.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(W, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Sn, {}) })
        ] }),
...
function zp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(W, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Ve, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(xn, { children: d.itemType === 0 ? /* @__PURE__ */ a(it, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ze,
        {
          checked: o[w][h],
        ...
        Ji,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Zi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(We, {})
    ] }, d.label)) })
...
function Dp({
  ...
  const s = M(() => Gs(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Ws(), { type: "language" });
...
function pw({
  ...
  return /* @__PURE__ */ u(Za, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u("p", { children: [
        d,
    ...
    e && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        W,
        {
          "aria-label": w,
...
const gw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(it, { children: [
...
function fw({
  ...
  return /* @__PURE__ */ u(Ae, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: gw(t, n, r) }) }) }),
      /* @__PURE__ */ a(At, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Ve,
      {
...
const mw = (t, e) => t === "f" ? /* @__PURE__ */ u(it, { children: [
  /* @__PURE__ */ a(Rn, {}),
  " ",
...
function bw({
  ...
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(W, { variant: "outline", className: "tw:h-6", children: mw(t, r) }) }) }),
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: vw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ve, { style: { zIndex: yn }, children: [
  ...
  return /* @__PURE__ */ u(
    Ee,
    {
      ...
      children: [
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(yw, { icon: t.icon }) }) }),
...
function Mp({
  ...
  const [f, b] = k("generated"), [m, E] = k("generated"), [y, N] = k("*"), [O, U] = k("*"), [C, I] = k("f"), [$, T] = k(!1), [A, K] = k(!0), [L, j] = k(!1), D = B(!1), H = B(""), [z, _] = k(!1), [J, Z] = k(), [gt, ft] = k(), [Vt, Y] = k(), [nt, at] = k(), ut = B(null), ct = M(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  G(() => {
    ...
    if (Q && $r("note", Q)) {
      const st = (lt = Q.insert.note) == null ? void 0 : lt.caller;
      let rt = "custom";
      st === Ba ? rt = "generated" : st === Ua ? rt = "hidden" : st && (N(st), U(st)), b(rt), E(rt), I(((et = Q.insert.note) == null ? void 0 : et.style) ?? "f"), V = setTimeout(() => {
        var bt;
  ...
  const pt = F(
    (V, Q, lt = !1) => {
      var st, rt, bt;
      const et = (rt = (st = w.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : rt.at(0);
      if (et && $r("note", et)) {
        if (et.insert.note) {
          let ht;
          V === "custom" ? ht = Q : V === "generated" ? ht = Ba : ht = Ua, et.insert.note.caller = ht;
        }
        r == null || r([et]), lt && d && i && ((bt = d.current) == null || bt.replaceEmbedUpdate(i, [et]));
      }
    },
    [i, r, d]
  ), Zt = F(() => {
  ...
  const Et = B({ book: n.book, chapterNum: n.chapterNum });
  Xt(() => {
    (Et.current.book !== n.book || Et.current.chapterNum !== n.chapterNum) && (Et.current = { book: n.book, chapterNum: n.chapterNum }, xt.current());
  }, [n.book, n.chapterNum]);
  const Bt = () => {
    var Q;
    ...
    var lt, et, st, rt, bt;
    I(V);
    const Q = (et = (lt = w.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : et.at(0);
    if (Q && $r("note", Q)) {
      Q.insert.note && (Q.insert.note.style = V);
      const ht = (rt = (st = Q.insert.note) == null ? void 0 : st.contents) == null ? void 0 : rt.ops;
      C !== "x" && V === "x" ? ht == null || ht.forEach((mt) => Cw(mt)) : C === "x" && V !== "x" && (ht == null || ht.forEach((mt) => Ew(mt))), (bt = w.current) == null || bt.applyUpdate([Q, { delete: 1 }]);
    }
  }, Tt = (V) => {
    at(V.contextMarker), j(V.canRedo);
  }, Lt = F(
    (V) => {
      var lt, et, st, rt, bt;
      const Q = (et = (lt = w.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (Q && $r("note", Q)) {
        ...
        const ht = (st = Q.insert.note) == null ? void 0 : st.style, mt = (bt = (rt = Q.insert.note) == null ? void 0 : rt.contents) == null ? void 0 : bt.ops;
        if (ht || T(!1), T(
          ht === "x" ? !!(mt != null && mt.every((St) => {
            var jt, Gt;
            if (!((jt = St.attributes) != null && jt.char)) return !0;
            const Ut = ((Gt = St.attributes) == null ? void 0 : Gt.char).style;
          ...
          D.current = !0, H.current = JSON.stringify(Q), K(!0);
          return;
        }
        K(JSON.stringify(Q) === H.current), pt(f, y);
      } else
        T(!1), K(!0);
    },
    [f, y, pt]
    ...
    if (h.current && Ft.length && V && V.rangeCount > 0) {
      const Q = V.getRangeAt(0).getBoundingClientRect(), lt = h.current.getBoundingClientRect();
      Z(Q.left - lt.left), ft(Q.top - lt.top), Y(Q.height), _(!0);
    }
  }, [Ft, h]);
  G(() => {
    const V = () => {
    ...
    var V;
    z && ((V = ut.current) == null || V.focus());
  }, [z]), G(() => {
    var lt;
    const V = ((lt = p.current) == null ? void 0 : lt.querySelector(".editor-input")) ?? void 0, Q = (et) => {
      !z && V && document.activeElement === V && et.key === c ? (et.preventDefault(), le()) : z && et.key === "Escape" && (et.preventDefault(), _(!1));
    };
    return document.addEventListener("keydown", Q), () => {
      document.removeEventListener("keydown", Q);
    };
  }, [z, le, c]);
  const oe = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(it, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
              /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
                W,
                {
                  "aria-label": oe,
              ...
              /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: oe }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(it, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(it, { children: Sw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Ip({
  ...
  const w = l ?? Ys(r, void 0), p = (y, N) => {
    d == null || d(y, N, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = k(h), b = (y, N, O) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function Ow({
  ...
  return /* @__PURE__ */ u(to, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(eo, { stickyHeader: !0, children: /* @__PURE__ */ u(Se, { children: [
    ...
    /* @__PURE__ */ a(ro, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Se,
      {
        ...
        children: [
          /* @__PURE__ */ a(ar, { children: ke(c.reference, "English") }),
          /* @__PURE__ */ a(ar, { className: o, children: Dw(c.text) })
        ]
      },
...
const Mw = (t) => {
...
}, ua = (t, e, r) => /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
  /* @__PURE__ */ u(
    It,
    {
  ...
  /* @__PURE__ */ a(At, { side: "bottom", children: e })
] }) }), Ap = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Iw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Bp = Object.freeze([
...
function Up({
  ...
  const g = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), b = we(r, "%webView_inventory_unapproved%"), m = we(r, "%webView_inventory_unknown%"), E = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), N = we(r, "%webView_inventory_scope_verse%"), O = we(r, "%webView_inventory_filter_text%"), U = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = we(r, "%webView_inventory_no_results%"), [I, $] = k(!1), [T, A] = k("all"), [K, L] = k(""), [j, D] = k([]), H = M(() => {
    const Y = t ?? [];
    return Y.length === 0 ? [] : Pw(Y, n, i);
  }, [t, n, i]), z = M(() => {
    if (I) return H;
    const Y = [];
    return H.forEach((nt) => {
      const at = nt.items[0], ut = Y.find(
        (ct) => ct.items[0] === at
      );
      ut ? (ut.count += nt.count, ut.occurrences = ut.occurrences.concat(nt.occurrences)) : Y.push({
        items: [at],
        count: nt.count,
  ...
  }, [I, H]), _ = M(() => z.length === 0 ? [] : Aw(z, T, K), [z, T, K]), J = M(() => {
    var at, ut;
    if (!I) return l;
    const Y = (at = o == null ? void 0 : o.tableHeaders) == null ? void 0 : at.length;
    if (!Y) return l;
    const nt = [];
    for (let ct = 0; ct < Y; ct++)
      nt.push(
        $w(
          ((ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut[ct]) || "Additional Item",
          ct + 1
        )
      );
    return [...nt, ...l];
  ...
  G(() => {
    _.length === 0 ? D([]) : _.length === 1 && D(_[0].items);
  }, [_]);
  const Z = (Y, nt) => {
    nt.setRowSelection(() => {
      const ut = {};
      return ut[Y.index] = !0, ut;
    });
    const at = Y.original.items;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(cr, { onValueChange: (Y) => gt(Y), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
        ...
        /* @__PURE__ */ a(At, { children: (o == null ? void 0 : o.checkboxText) ?? U })
      ] }) })
    ] }),
...
const Vw = "16rem", Lw = "3rem", Oi = Yt.createContext(void 0);
function pa() {
  const t = Yt.useContext(Oi);
  if (!t)
...
function jw({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", m = ge() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Oi.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Kp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    W,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(oc, {}) : /* @__PURE__ */ a(nc, {}),
...
function Gw({
  ...
  const c = t ? Rr.Root : "button", { state: l } = pa(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(qw({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u($t, { children: [
    ...
    Fw,
    {
      ...
      children: /* @__PURE__ */ u(Uw, { children: [
        /* @__PURE__ */ u(un, { children: [
          ...
          /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Kw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Hw, { children: /* @__PURE__ */ a(
            Gw,
            {
              onClick: () => d(g),
              isActive: h(g),
    ...
    /* @__PURE__ */ u(
      jw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Bw, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Te = "scrBook", Yw = "scrRef", He = "source", Xw = "details", Jw = "Scripture Reference", Zw = "Scripture Book", Mi = "Type", Qw = "Details";
function tu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Ot.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Te ? ke(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: He,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Mi : void 0,
...
}, gn = (t) => `${eu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function oh({
  sources: t,
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Te, desc: !1 }]), [g, f] = k({}), b = M(
    () => t.flatMap((T) => T.data.map((A) => ({
      ...A,
      source: T.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const T = E.getSelectedRowModel().rowsById, A = Object.keys(T);
      if (A.length === 1) {
        const K = b.find((L) => gn(L) === A[0]) || void 0;
        K && c(K);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Zw, N = i ?? Mi, O = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Te] },
    ...
    !T.getIsGrouped() && !T.getIsSelected() && T.getToggleSelectedHandler()(A);
  }, I = (T, A) => T.getIsGrouped() ? "" : v("banded-row", A % 2 === 0 ? "even" : "odd"), $ = (T, A, K) => {
    if (!((T == null ? void 0 : T.length) === 0 || A.depth < K.column.getGroupedIndex())) {
      if (A.getIsGrouped())
        switch (A.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wr, { position: "item-aligned", children: /* @__PURE__ */ a(aw, { children: O.map((T) => /* @__PURE__ */ a(ne, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(to, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(eo, { children: E.getHeaderGroups().map((T) => /* @__PURE__ */ a(Se, { children: T.headers.filter((A) => A.column.columnDef.header).map((A) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Xr, { colSpan: A.colSpan, className: "tw:sticky top-0", children: A.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          A.column.getCanGroup() ? /* @__PURE__ */ a(
            W,
            {
              variant: "ghost",
          ...
          " ",
          xr(A.column.columnDef.header, A.getContext())
        ] }) }, A.id)
      )) }, T.id)) }),
      /* @__PURE__ */ a(ro, { children: E.getRowModel().rows.map((T, A) => {
        const K = ge();
        return /* @__PURE__ */ a(
          Se,
          {
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      W,
                      {
                        ...
                        children: [
                          ...
                          !T.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a(Pa, {}) : /* @__PURE__ */ a(Aa, {})),
                          " ",
...
function ru({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, E] = k(!1), [y, N] = k(""), O = B(void 0), U = B(!1), C = M(
    () => Nn(t),
    [t]
  ), I = M(() => {
    if (!y.trim()) {
    ...
    (D, H = !1) => {
      if (!H || !O.current) {
        r(
          e.includes(D) ? e.filter((ft) => ft !== D) : [...e, D]
        ), O.current = D;
        return;
      }
      const z = C.findIndex((ft) => ft === O.current), _ = C.findIndex((ft) => ft === D);
      if (z === -1 || _ === -1) return;
      const [J, Z] = [
        Math.min(z, _),
        Math.max(z, _)
      ], gt = C.slice(J, Z + 1).map((ft) => ft);
      r(
        e.includes(D) ? e.filter((ft) => !gt.includes(ft)) : [.../* @__PURE__ */ new Set([...e, ...gt])]
      );
    },
    [e, r, C]
  ), T = (D) => {
              ...
              $e,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(W, { variant: "ghost", size: "sm", onClick: L, children: w })
                  ] }),
                  /* @__PURE__ */ u(Ie, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(oa, { children: p }),
                    Object.values(wt).filter((D) => I[D].length > 0).map((D, H) => {
                      const z = I[D];
                      return /* @__PURE__ */ u(sa, { children: [
                        H > 0 && /* @__PURE__ */ a(kn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ne,
                          {
                            heading: mn(D, h, g, f, b),
                            children: z.map((_) => /* @__PURE__ */ a(
                              Jn,
                              {
                                bookId: _,
                  ...
                  j.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: j.map(({ section: D, explanation: H }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: H }, D)) })
                ]
              }
            )
          }
...
function ou({
  ...
  return /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u($t, { children: [
    /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
      au,
      {
        className: o,
    ...
    t && /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { className: "tw:max-w-xs tw:whitespace-pre-line", children: e }) })
  ] }) });
}
function nu({
  section: t,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ra ? Ra : fn
      ).map((d) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: ye(d, n) }, d)),
...
function ih({
  ...
  const U = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Dt(s, "%webView_scope_selector_verse%"), I = Dt(s, "%webView_scope_selector_chapter%"), $ = Dt(s, "%webView_scope_selector_book%"), T = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), A = Dt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), K = Dt(s, "%webView_scope_selector_current_book%"), L = Dt(s, "%webView_scope_selector_choose_books%"), j = Dt(s, "%webView_scope_selector_scope%"), D = Dt(s, "%webView_scope_selector_select_books%"), H = Dt(s, "%webView_scope_selector_range%"), z = Dt(s, "%webView_scope_selector_select_range%"), _ = Dt(s, "%webView_scope_selector_range_start%"), J = Dt(s, "%webView_scope_selector_range_end%"), Z = Dt(s, "%webView_scope_selector_ok%"), gt = Dt(s, "%webView_scope_selector_cancel%"), ft = Dt(s, "%webView_scope_selector_navigate%"), Vt = (P) => {
    if (!b) return;
  ...
  ], nt = (P, X, Wt = !1) => /* @__PURE__ */ u(it, { children: [
    P,
    X && !Wt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), at = e ? Y.filter((P) => e.includes(P.value)) : Y, ut = b ?? va, ct = p ?? ut, Ft = h ?? ut, pt = () => {
  }, Zt = B(null), xt = B(null), Et = B(!1), Bt = B(null), ae = B(!1), [ce, S] = k(void 0), Tt = B(!1), Lt = B(!1), le = B(null), oe = F((P) => {
    if (P) {
      S("start"), Tt.current = !1;
      return;
    }
    S((X) => X === "start" ? void 0 : X), Tt.current && (Tt.current = !1, requestAnimationFrame(() => {
      var Wt;
      const X = (Wt = Zt.current) == null ? void 0 : Wt.querySelector("button");
      X == null || X.click();
    }));
  }, []), V = F((P) => {
    if (P) {
    ...
    (P) => {
      g == null || g(P), f == null || f(P), Tt.current = !0;
    },
    [g, f]
  ), lt = F(
    (P) => {
      f == null || f(P), Lt.current = !0;
    },
    [f]
  ), et = F(
    (P) => {
    ...
    [r, n, b, i]
  ), st = at.find((P) => P.value === t), rt = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? Js(ct, Ft, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : st ? nt(st.label, st.scrRefSuffix) : t, bt = at.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), ht = at.find((P) => P.value === "selectedBooks"), mt = at.find((P) => P.value === "range"), [St, Ut] = k(!1), [jt, Gt] = k(void 0), [ve, R] = k(void 0), [Nt, zt] = k(void 0), [Qt, je] = k(void 0), [Ze, pr] = k([]), Dr = w === "dropdown" && jt === "selectedBooks", hr = /* @__PURE__ */ a(
    iu,
    {
      availableBookInfo: o,
      selectedBookIds: Dr ? Ze : n,
      onChangeSelectedBookIds: Dr ? pr : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), gr = ce === "end", fr = ce === "start", Fe = "tw:text-muted-foreground", Be = w === "dropdown" && jt === "range", ha = Be ? zt : Q, x = Be ? je : f ? lt : pt, q = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: v(gr && Fe), children: _ }),
      /* @__PURE__ */ a(
        xa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Zt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: v(fr && Fe), children: J }),
      /* @__PURE__ */ a(
        xa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: E,
          getEndVerse: y,
          disableReferencesUpTo: Be ? Nt ?? ct : ct,
          onOpenChange: V,
          onCloseAutoFocus: (P) => {
            var X;
            Lt.current && (Lt.current = !1, P.preventDefault(), (X = le.current) == null || X.focus());
          },
          className: v(fr && Fe),
          modal: !0,
          align: "start"
  ...
  G(() => {
    ...
    const X = requestAnimationFrame(() => {
      P = requestAnimationFrame(() => {
        var Wt;
        (Wt = tt.current[t]) == null || Wt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(X), P && cancelAnimationFrame(P);
    };
  }, [St, t]);
  const [xe, Qe] = k(null), [Ct, yt] = k(null), [kt, vt] = k(null), te = 200, [de, Ue] = k(!1);
  G(() => {
    if (!kt || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([X]) => {
      Ue(X.contentRect.width < te);
    });
    return P.observe(kt), () => P.disconnect();
  }, [kt]);
  const ko = F(
    (P) => {
      R(P), zt(ct), je(Ft), pr(n), Ut(!1), Gt(P);
    },
    [ct, Ft, n]
  ), _o = F(() => {
    ve !== void 0 && (ve === "range" ? (Nt && (g == null || g(Nt)), Qt && (f == null || f(Qt))) : ve === "selectedBooks" && i(Ze), et(ve), Gt(void 0), R(void 0));
  }, [
    ve,
    Nt,
    Qt,
    ...
    P || (Gt(void 0), R(void 0));
  }, []), No = F((P) => {
    var X;
    P.preventDefault(), (X = be.current) == null || X.focus();
  }, []), Co = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Re, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(_t, { children: j }),
      w === "dropdown" ? /* @__PURE__ */ u(Ae, { open: St, onOpenChange: Ut, children: [
        ...
        /* @__PURE__ */ a(
          Ve,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ga, { container: kt, children: [
              bt.map(({ value: P, label: X, dropdownLabel: Wt, scrRefSuffix: mr, id: Bi }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Rt(P),
                  ...
                  children: [
                    t === P && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Re, { className: "tw:h-4 tw:w-4" }) }),
                    nt(Wt ?? X, mr, de)
                  ]
                },
                Bi
              ...
              m && /* @__PURE__ */ u(it, { children: [
                /* @__PURE__ */ a(We, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: ft }),
                /* @__PURE__ */ a(
                  qe,
                  {
                    ref: Bt,
                    ...
                    onSelect: (P) => {
                      var X, Wt;
                      if (P.preventDefault(), Et.current) {
                        Et.current = !1;
                        return;
                      }
                      ae.current || (Wt = (X = xt.current) == null ? void 0 : X.querySelector("button")) == null || Wt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (P) => {
                          const X = P.target instanceof HTMLElement ? P.target : void 0;
                          X != null && X.closest("button") && (Et.current = !0, requestAnimationFrame(() => {
                            Et.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          xa,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var X;
                              P.preventDefault(), (X = Bt.current) == null || X.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(it, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ke(b ?? va, "id") }),
                              /* @__PURE__ */ a(ir, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ja,
        {
          ...
          children: at.map(({ value: P, label: X, scrRefSuffix: Wt, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Yr, { className: "tw:me-2", value: P, id: mr }),
            /* @__PURE__ */ a(_t, { htmlFor: mr, children: nt(X, Wt) })
          ] }, mr))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && q,
    w === "dropdown" && ht && /* @__PURE__ */ a(Da, { open: jt === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Oa,
      {
        ref: yt,
        onCloseAutoFocus: No,
        ...
        children: /* @__PURE__ */ u(ga, { container: Ct, children: [
          /* @__PURE__ */ a(Ma, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: L }) }),
          hr,
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Or(!1), children: gt }),
            /* @__PURE__ */ a(W, { onClick: _o, children: Z })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && mt && /* @__PURE__ */ a(Da, { open: jt === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Oa,
      {
        ref: Qe,
        onCloseAutoFocus: No,
        onEscapeKeyDown: (P) => {
          xe != null && xe.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(ga, { container: xe, children: [
          /* @__PURE__ */ a(Ma, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: z }) }),
          q,
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(W, { variant: "outline", onClick: () => Or(!1), children: gt }),
            /* @__PURE__ */ a(W, { ref: le, onClick: _o, children: Z })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          wr,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[Oo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ii = (t, e, r, o) => r ? Object.entries(t).filter(
  ([i, s]) => "column" in s && s.column === r || i === r
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u($t, { children: [
  /* @__PURE__ */ a(It, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ss, { children: /* @__PURE__ */ a(cs, { children: Ii(
      t,
      e,
      $i(t, c.id),
      o
  ...
  c.tooltip && /* @__PURE__ */ a(At, { children: c.tooltip })
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ae, { variant: i, children: [
    /* @__PURE__ */ a(Pe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(W, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Fs, {}) }) }),
    /* @__PURE__ */ a(Ve, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(sa, { children: [
      /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(Mt, { children: Ii(e.groups, e.items, l, t) }) }),
...
const wu = Object.freeze([520, 420, 340]), Pi = Yt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, i] = k(void 0), s = B(o);
    s.current = o;
    const c = F((w) => {
      i(w ?? void 0);
      const p = s.current;
...
function wh({
  ...
  return /* @__PURE__ */ u(Pi, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ya,
      {
        onSelectMenuItem: t,
...
const Vi = Yt.forwardRef(({ className: t, ...e }, r) => {
  const o = ge();
  return /* @__PURE__ */ a(
    se.Root,
    {
...
Vi.displayName = se.List.displayName;
const Li = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.List,
  {
    ref: r,
    className: v(
...
Li.displayName = se.List.displayName;
const uu = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Trigger,
  {
    ref: r,
    ...e,
...
)), ji = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  se.Content,
  {
    ref: r,
    className: v(
...
ji.displayName = se.Content.displayName;
function ph({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Vi, { children: [
      /* @__PURE__ */ a(Li, { children: t.map((c) => /* @__PURE__ */ a(uu, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(ji, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function pu({
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u($t, { children: [
      ...
      d.tooltip && /* @__PURE__ */ a(At, { children: d.tooltip })
  ...
  if (pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(pu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(hu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Mt, { children: Fi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const Nu = Object.freeze([950, 800, 700]);
function hh(t) {
  switch (t) {
    case void 0:
      return;
...
function fh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: Ge(d, {
...
function vh({
  ...
  return /* @__PURE__ */ u($e, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ds, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(ws, { children: /* @__PURE__ */ a(ic, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ie, { children: [
...
function xh({
  ...
  const c = t ? Mo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = zu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
  return /* @__PURE__ */ u(Mt, { children: [
    /* @__PURE__ */ a("span", { role: "status", className: "tw:sr-only", children: c }),
    /* @__PURE__ */ u($t, { open: t, onOpenChange: () => {
    }, children: [
      /* @__PURE__ */ a(
        It,
        {
...
function kh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function Nh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = M(() => {
    const c = new On(o);
    return (l) => c.format(l);
...
function Vh({
  ...
  return /* @__PURE__ */ u(
    Pt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Pt.ItemIndicator, { children: /* @__PURE__ */ a(ca, {}) }) }),
        e
      ]
    }
  );
...
function Uh({ ...t }) {
  return /* @__PURE__ */ a(Le.Root, { "data-slot": "drawer", ...t });
}
function Kh({ ...t }) {
  return /* @__PURE__ */ a(Le.Trigger, { "data-slot": "drawer-trigger", ...t });
}
function Du({ ...t }) {
  return /* @__PURE__ */ a(Le.Portal, { "data-slot": "drawer-portal", ...t });
}
function Hh({ ...t }) {
  return /* @__PURE__ */ a(Le.Close, { "data-slot": "drawer-close", ...t });
}
function Ou({
  className: t,
  ...e
  ...
  return /* @__PURE__ */ a(
    gl,
    {
      ...
      icons: {
        ...
        warning: /* @__PURE__ */ a(lc, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(cc, { className: "tw:size-4" }),
...
function cg({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", $u({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function gg(t) {
  const e = M(() => Zs(t).slice().sort().join(" "), [t]);
...
function vg({ value: t, children: e }) {
  return /* @__PURE__ */ a(Zn.Provider, { value: t, children: /* @__PURE__ */ a(da.Provider, { value: t, children: e }) });
}
function Vu(t, e = "top") {
...
Vu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Eh as AlertTitle,
  qd as Avatar,
  Gd as AvatarFallback,
  kp as AvatarImage,
  dp as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  wp as BOOK_SELECTOR_STRING_KEYS,
  kr as Badge,
  ...
  yg as ButtonGroupText,
  _i as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  gp as COMMENT_EDITOR_STRING_KEYS,
  Ud as COMMENT_LIST_ELEMENT_ID,
  fp as COMMENT_LIST_STRING_KEYS,
  pp as CONFLICT_NOTE_STRING_KEYS,
  Ni as CancelAcceptButtons,
  Kd as Card,
  Hd as CardContent,
  ...
  sw as DataTable,
  xh as DestructiveKeyConfirmation,
  Da as Dialog,
  kg as DialogClose,
  Oa as DialogContent,
  _g as DialogDescription,
  To as DialogFooter,
  Ma as DialogHeader,
  Ng as DialogOverlay,
  Cg as DialogPortal,
  $a as DialogTitle,
  Eg as DialogTrigger,
  ou as DisabledActionTooltip,
  au as DisabledTooltipWrapper,
  Uh as Drawer,
  Hh as DrawerClose,
  qh as DrawerContent,
  ...
  Tp as ERROR_POPOVER_STRING_KEYS,
  hw as EditorKeyboardShortcuts,
  Jh as Empty,
  rg as EmptyContent,
  eg as EmptyDescription,
  Zh as EmptyHeader,
  Qh as EmptyMedia,
  kh as EmptyState,
  tg as EmptyTitle,
  ...
  Og as ResizableHandle,
  Mg as ResizablePanel,
  $g as ResizablePanelGroup,
  yh as ResultsCard,
  ...
  vg as ShrinkStepOverride,
  Zn as ShrinkStepOverrideContext,
  Fw as Sidebar,
  ...
  th as SidebarMenuSub,
  rh as SidebarMenuSubButton,
  ...
  hh as getToolbarOSReservedSpaceClassName,
  Pp as inventoryCountColumn,
  Ap as inventoryItemColumn,
  Vp as inventoryStatusColumn,
  Qa as isMacOs,
  Kg as isWindows,
  Pu as pickTabIconUrl,
  qg as sonner,
  wg as useEvent,
  ug as useEventAsync,
  gg as useExtraValidMarkers,
  Xi as useListbox,
  pg as usePromise,
  lp as useRecentSearches,
  fg as useRunWhenVisible,
  Ai as useShrinkStep,
  Qn as useShrinkStepOverride,
  fl as useShrinkStepValue,
  pa as useSidebar,
  hg as useStylesheet,
  mg as useTabIconSelection,
  Eo as useTruncationTooltip,
  Au as useViewVisibility
};
