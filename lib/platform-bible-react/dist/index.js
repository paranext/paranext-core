...
import { c as b, g as Te, a as zr, C as Ue, L as Kn, u as Qo, T as Dt, b as Nt, d as Ct, e as Et, A as ha, D as Oe, f as xe, h as Me, i as br, j as Ae, B as Z, x as fs, k as ms, l as vs, I as bs, m as _o, n as Be, r as _e, o as xs, p as Hn, P as Ze, q as xr, s as Xe, t as Je, v as Na, w as Ca, y as No, z as Qe, E as Ea, F as Rt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as qn, O as na, Q as Eo, S as $r, U as Vr, V as dr, W as ys, X as ks, Y as We, Z as Le, _ as ze, $ as $e, a0 as wr, a1 as To, a2 as So, a3 as fa, a4 as Ro, a5 as Gn, a6 as _s, a7 as Ns, a8 as Cs, a9 as io, aa as Wn, ab as Ta, ac as Es, ad as Yn, ae as Ts, af as Ss, ag as Rs, ah as tn, ai as Ds, aj as Os, ak as Ms, al as Zn, am as Xn, an as Do, ao as zs, ap as Jn, aq as Ba, ar as en, as as ja, at as Is, au as Ps, av as As, aw as $s, ax as Vs, ay as jr, az as Oo, aA as Ls, aB as Bs } from "./resizable-ESKWSVhk.js";
import { aC as of, aD as nf, aE as sf, aF as cf, aG as lf, aH as df, aI as wf, aJ as uf, aK as pf, aL as hf, aM as gf, aN as ff, aO as mf, aP as vf, aQ as bf, aR as xf, aS as yf, aT as kf, aU as _f, aV as Nf, aW as Cf, aX as Ef, aY as Tf, aZ as Sf, a_ as Rf, a$ as Df, b0 as Of, b1 as Mf, b2 as zf, b3 as If, b4 as Pf, b5 as Af, b6 as $f, b7 as Vf, b8 as Lf, b9 as Bf, ba as jf, bb as Ff, bc as Uf, bd as Kf, be as Hf, bf as qf, bg as Gf, bh as Wf } from "./resizable-ESKWSVhk.js";
...
import { Section as St, compareScrRefs as ma, getChaptersForBook as yc, formatScrRef as Se, formatReplacementString as Ve, getSectionForBook as ia, formatRelativeDate as kc, sanitizeHtml as zo, NumberFormat as ii, formatBytes as _c, getCurrentLocale as Nc, usfmMarkers as sa, isPlatformError as Cc, ABORTED as Ec, getErrorMessage as Tc, getFormatCallerFunction as Sc, deepEqual as Rc, isString as nn, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Dc, getLocalizeKeyForScrollGroupId as sn, formatReplacementStringToArray as cn, collectUsjMarkers as Oc } from "platform-bible-utils";
...
function id({
  ...
  const [h, g] = N(!1), [f, y] = N(!1), x = co(), D = B(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : ee(n, od), I = ee(s, nd), T = (O) => {
...
function Ha({
  ...
  const T = _e(), V = td(), [P, M] = N(!1), [O, W] = N(""), [F, et] = N(""), [_, tt] = N("books"), [z, R] = N(void 0), [q, ct] = N(
    void 0
  ), [nt, dt] = N(void 0), [yt, X] = N(!1), [lt, ut] = N(!1), [gt, kt] = N(!1), [Tt, ft] = N(!1), Vt = B(null), Jt = B(!1), Ot = B(void 0), mt = B(void 0), Kt = B(void 0), Qt = B(void 0), Mt = B({}), zt = B({}), vt = j(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
  ...
  const { otLong: kr, ntLong: _r, dcLong: Nr, extraLong: Cr } = {
    ...
    (v) => {
      ...
      if (!(!!H && !!((Zo = Ot.current) != null && Zo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const $t = Ot.current ? fd(Ot.current) : [];
        if ($t.length === 0) {
  ...
  }, [_, m, we, Q, O]), /* @__PURE__ */ u(Ze, { open: P, onOpenChange: Pt, modal: k, children: [
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xd = Di ? Zt : Y, ra = { tag: Po };
...
const Oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Md = Oi && "documentMode" in document ? document.documentMode : null;
!(!Oi || !("InputEvent" in window) || Md) && "getTargetRanges" in new window.InputEvent("input");
function be(t) {
  return `${t}px`;
}
    ...
    w.read(() => {
      ...
      if ((T || V) && E !== null && I !== null) {
        const P = function(M, O, W, F, et, _, tt) {
          ...
          return z.setStart(...kn(O, W, F)), z.setEnd(...kn(et, _, tt)), z;
        }(t, h, f, E, g, D, I);
        l(), l = Id(t, P, e);
      }
...
function qd(t) {
  ...
  zi(this), st = t, this.f &= -2, 8 & this.f && jo(this), Oa();
}
function lr(t, e) {
...
const Fo = 0, yo = 1, Bi = 2, Ya = 3, aa = 4, cr = 5, Za = 6, Dr = 7;
function Xa(t) {
  return t.id === Fo;
}
function ji(t) {
...
ce({ dependencies: [xo, Rn], name: "@lexical/extension/HorizontalRule", nodes: () => [hr], register(t, e, r) {
  ...
  return De(t.registerCommand(rw, (i) => {
    const c = re();
    if (!ye(c)) return !1;
...
function nw(t, e, r = Fi) {
  return De(t.registerCommand(kl, (o) => {
    const n = re();
    if (!ye(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
function rs({
  ...
  const [F, et] = N(Pn), [_, tt] = N(), [z, R] = N(), q = o, [ct, nt] = N(!1), [dt, yt] = N(!1), [X, lt] = N(!1), [ut, gt] = N(!1), [kt, Tt] = N(!1), [ft, Vt] = N(E), [Jt, Ot] = N(!1), mt = B(void 0), [Kt, Qt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let S = !0;
    return (async () => {
      ...
      children: M.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(Gw, { ...q, conflictResolution: D }) : /* @__PURE__ */ a(rs, { ...q })
          },
          R.id
        );
      })
...
function Ah({
  ...
  }, [V, tt]), R = $(() => z.length === 0 ? [] : Du(z, M, W), [z, M, W]), q = $(() => {
    var ut, gt;
    if (!V) return l;
...
function Xh({
  ...
  Y(() => {
    if (c) {
      ...
      if (O.length === 1) {
        const W = y.find((F) => Fn(F) === O[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, y, c, D]);
...
function Qh({
  ...
  const T = jt(
    ...
    [r, n, x, s]
  ), _t = gt.find((L) => L.value === t), fe = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Dc(Tt, ft, {
...
function ko({
  ...
  return /* @__PURE__ */ u(Oe, { variant: s, children: [
    ...
    /* @__PURE__ */ a(Me, { align: "start", style: { zIndex: ze }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Ur, { children: [
      /* @__PURE__ */ a(Gn, { children: /* @__PURE__ */ a(Dt, { children: ss(e.groups, e.items, l, t) }) }),
...
function Jg(t) {
  const e = $(() => Oc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Rp = () => {
  const [t, e] = N(
...
export {
  ...
  lf as CONTENT_ZOOM_CSS_VARIABLE_PREFIX,
  df as CONTENT_ZOOM_DEFAULT_CSS_VARIABLE,
  wf as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  ...
  Ef as KbdGroup,
  Rt as Label,
  Tf as MAIN_CONTENT_ZOOM_AREA_ID,
