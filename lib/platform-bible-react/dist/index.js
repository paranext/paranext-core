import es, { jsxs as fe, jsx as T, Fragment as Fn } from "react/jsx-runtime";
...
var Is = Object.defineProperty, _s = (e, t, n) => t in e ? Is(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (_s(e, typeof t != "symbol" ? t + "" : t, n), n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
const Ws = ge.Root, qs = ge.Trigger, Gs = w.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ fe(
  ge.SubTrigger,
  {
    ref: o,
    className: je(
...
const Xs = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ fe(
  ge.CheckboxItem,
  {
    ref: o,
    className: je(
...
const Ys = w.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ fe(
  ge.RadioItem,
  {
    ref: r,
    className: je(
...
const Js = ts(
  ({ handleSearch: e, handleKeyDown: t, ...n }, r) => /* @__PURE__ */ fe("div", { style: { position: "relative", display: "inline-block" }, children: [
    /* @__PURE__ */ T(
      _i,
      {
        ...n,
...
function Zs({ endChapter: e, activeChapter: t, handleSelectChapter: n }) {
  ...
  return /* @__PURE__ */ T("div", { className: "pr-flex pr-flex-wrap pr-content-start pr-items-start pr-self-stretch pr-bg-amber-50", children: r.map((o) => (
...
function Qs({
  ...
  return /* @__PURE__ */ fe(
    ...
    {
      textValue: e,
      className: je("pr-font-sans pr-font-normal pr-text-slate-700", n ?? "selected"),
      onSelect: (i) => {
        i.preventDefault(), t(e);
      },
      children: [
        /* @__PURE__ */ T(cs, { className: je("pr-mr-2.5 pr-h-4 pr-w-0.5", `${r.toLowerCase()}`) }),
...
function gm({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = he, [r, o] = ze(""), [i, s] = ze(""), [l, c] = ze(!1), u = Nn(void 0), d = $e(
    (S) => ({
      OT: n.filter((x) => he.isBookOT(x)),
      NT: n.filter((x) => he.isBookNT(x)),
      DC: n.filter((x) => he.isBookDC(x))
    })[S],
    [n]
  ), f = $e(
    (S) => d(S).filter(
    ...
    o(S);
  }, b = $e((S) => yi(he.bookIdToNumber(S)), []), v = (S) => {
    s(i !== S ? S : ""), b(S) === -1 && (t({
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ fe(Ws, { modal: !1, open: l, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ T(
      Ni,
      {
        ...
        onKeyDown: E,
        children: tl.map((S) => /* @__PURE__ */ fe("div", { children: [
          /* @__PURE__ */ T(Mi, { className: "pr-font-semibold pr-text-slate-700", children: el[S] }),
...
function bm({
  ...
  return /* @__PURE__ */ fe(Fn, { children: [
    /* @__PURE__ */ T(
      wo,
      {
...
function Wi() {
  ...
  function n() {
    return t.current ? (kr = !0, _l.start(100, () => {
      kr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
function In(e) {
  const {
    ...
    isEnabled: s = sc,
    open: l
  } = e, c = w.useRef(!1), u = w.useRef(null), d = w.useRef(null), f = w.useRef(null), p = w.useRef(null), b = w.useRef(!1), v = w.useRef(null), g = Be(t.ref, v), m = w.useRef(null);
  w.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    return () => {
      clearInterval(C), y.removeEventListener("focusin", h), y.removeEventListener("keydown", x, !0);
    };
  }, [n, r, o, s, l, i]);
  const E = (y) => {
...
const an = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    ...
    container: o,
    disablePortal: i = !1
  } = t, [s, l] = w.useState(null), c = Be(/* @__PURE__ */ w.isValidElement(r) ? r.ref : null, n);
  if (ht(() => {
...
function bc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), b = w.useRef(null), v = w.useRef(null), g = Be(v, f), [m, E] = w.useState(!d), S = hc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const x = () => we(b.current), h = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), C = () => {
    o.mount(h(), {
      disableScrollLock: r
  ...
  }), A = w.useCallback(() => o.isTopModal(h()), [o]), _ = on((N) => {
...
var Se = "top", Le = "bottom", Fe = "right", Ce = "left", Br = "auto", pn = [Se, Le, Fe, Ce], _t = "start", sn = "end", vc = "clippingParents", ra = "viewport", Gt = "popper", yc = "reference", Uo = /* @__PURE__ */ pn.reduce(function(e, t) {
...
function _c(e) {
  ...
  var o = Un(e);
  for (Lr(o) && (o = o.host); De(o) && ["html", "body"].indexOf(We(o)) < 0; ) {
    var i = Ze(o);
...
function fn(e) {
  for (var t = Ie(e), n = Ho(e); n && Ic(n) && Ze(n).position === "static"; )
    n = Ho(n);
  return n && (We(n) === "html" || We(n) === "body" && Ze(n).position === "static") ? t : n || _c(e) || t;
}
function Vr(e) {
...
function jc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Ue(n.placement), c = Vr(l), u = [Ce, Fe].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = Dc(o.padding, n), p = Fr(i), b = c === "y" ? Se : Ce, v = c === "y" ? Le : Fe, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = fn(i), S = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, x = f[b], h = S - p[d] - f[v], C = S / 2 - p[d] / 2 + y, P = tn(x, C, h), A = c;
...
function Wo(e) {
  ...
  b = m.x, g = m.y;
  var E = s.hasOwnProperty("x"), S = s.hasOwnProperty("y"), y = Ce, x = Se, h = window;
  if (u) {
  ...
  if (b = z.x, g = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[x] = S ? "0" : "", G[y] = E ? "0" : "", G.transform = (h.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", G));
  }
...
function ua(e) {
  return ["html", "body", "#document"].indexOf(We(e)) >= 0 ? e.ownerDocument.body : De(e) && Hr(e) ? e : ua(Un(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ua(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Ie(r), s = o ? [i].concat(i.visualViewport || [], Hr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? vc : l, u = n.rootBoundary, d = u === void 0 ? ra : u, f = n.elementContext, p = f === void 0 ? Gt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = la(typeof m != "number" ? m : ca(m, pn)), S = p === Gt ? yc : Gt, y = e.rects.popper, x = e.elements[v ? S : p], h = Zc(bt(x) ? x : x.contextElement || at(e.elements.popper), c, d, s), C = Dt(e.elements.reference), P = da({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
...
function tu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), S = E === m, y = c || (S || !v ? [Sn(m)] : eu(m)), x = [m].concat(y).reduce(function(F, U) {
      return F.concat(Ue(U) === Br ? Qc(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
    ...
    }, []), h = t.rects.reference, C = t.rects.popper, P = /* @__PURE__ */ new Map(), A = !0, _ = x[0], D = 0; D < x.length; D++) {
      var B = x[D], z = Ue(B), G = jt(B) === _t, L = [Se, Le].indexOf(z) >= 0, I = L ? "width" : "height", N = ln(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function du(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = ln(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), S = jt(t.placement), y = !S, x = Vr(E), h = uu(x), C = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, _ = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof _ == "number" ? {
    mainAxis: _,
    altAxis: _
  ...
  if (C) {
    if (i) {
      var G, L = x === "y" ? Se : Ce, I = x === "y" ? Le : Fe, N = x === "y" ? "height" : "width", j = C[x], Q = j + m[L], Z = j - m[I], O = b ? -A[N] / 2 : 0, M = S === _t ? P[N] : A[N], V = S === _t ? -A[N] : -P[N], K = t.elements.arrow, F = b && K ? Fr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sa(), W = U[L], q = U[I], H = tn(0, P[N], F[N]), X = y ? P[N] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -P[N] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), $ = ne ? x === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[x]) != null ? G : 0, R = j + X - J - $, re = j + Y - J, ve = tn(b ? _n(Q, R) : Q, j, b ? ft(Z, re) : Z);
      C[x] = ve, z[x] = ve - j;
    }
    if (l) {
      var Te, me = x === "x" ? Se : Ce, lt = x === "x" ? Le : Fe, ke = C[h], Ge = h === "y" ? "height" : "width", Pe = ke + m[me], Ke = ke - m[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[h]) != null ? Te : 0, ct = ye ? Pe : ke - P[Ge] - A[Ge] - yt + D.altAxis, Vt = ye ? ke + P[Ge] + A[Ge] - yt - D.altAxis : Ke, bn = b && ye ? Ac(ct, ke, Vt) : tn(b ? ct : Pe, ke, b ? Vt : Ke);
      C[h] = bn, z[h] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function gu(e, t, n) {
  n === void 0 && (n = !1);
  var r = De(t), o = De(t) && hu(t), i = at(t), s = Dt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Hr(i)) && (l = mu(t)), De(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Ur(i))), {
  ...
  return function(l, c, u) {
        ...
        if (!p) {
          ...
          if (Jo(S, y)) {
            ...
            for (var x = 0; x < d.orderedModifiers.length; x++) {
              ...
              var h = d.orderedModifiers[x], C = h.fn, P = h.options, A = P === void 0 ? {} : P, _ = h.name;
    ...
    function v() {
      d.orderedModifiers.forEach(function(m) {
        var E = m.name, S = m.options, y = S === void 0 ? {} : S, x = m.effect;
...
const Ru = () => et({
  ...
  } = t, m = ce(t, Ou), E = w.useRef(null), S = Be(E, n), y = w.useRef(null), x = Be(y, p), h = w.useRef(x);
  ht(() => {
    h.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const C = Cu(d, s), [P, A] = w.useState(C), [_, D] = w.useState(An(o));
  w.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: m = {},
    slots: E = {}
  } = t, S = ce(t, Su), [y, x] = w.useState(!0), h = () => {
    x(!1);
  }, C = () => {
    x(!0);
  };
...
const Mu = ["values", "unit", "step"], Iu = (e) => {
...
function _u(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = ce(e, Mu), i = Iu(t), s = Object.keys(i);
  function l(p) {
...
pe.propTypes = process.env.NODE_ENV !== "production" ? Gn.reduce((e, t) => (e[t] = st, e), {}) : {};
pe.filterProps = Gn;
...
const Ku = Ve("border", Ae), Xu = Ve("borderTop", Ae), Yu = Ve("borderRight", Ae), Ju = Ve("borderBottom", Ae), Zu = Ve("borderLeft", Ae), Qu = Ve("borderColor"), ed = Ve("borderTopColor"), td = Ve("borderRightColor"), nd = Ve("borderBottomColor"), rd = Ve("borderLeftColor"), od = Ve("outline", Ae), id = Ve("outlineColor"), Xn = (e) => {
...
Kn(Yn, Jn, Zn, ad, sd, ld, cd, ud, dd, pd, fd, md);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const hd = be({
...
function Xr(e = {}, ...t) {
  ...
  return u.applyStyles = Pd, u = t.reduce((d, f) => Ye(d, f), u), u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
const Md = ["ownerState"], Id = ["variants"], _d = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Ad(e) {
  return Object.keys(e).length === 0;
}
function Dd(e) {
...
function Ld(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Rs(s, (h) => h.filter((C) => !(C != null && C.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    const S = Cs(s, k({
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${He(u || "")}`), B === void 0 && (B = `Styled(${Tl(s)})`), D.displayName = B;
      }
...
function cp(e) {
  ...
  function f(g) {
    const m = ni(g, fr.text.primary) >= n ? fr.text.primary : ri.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ni(g, m);
...
function pp(e, t) {
  ...
  const b = o / 14, v = f || ((E) => `${E / u * b}rem`), g = (E, S, y, x, h) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(S),
...
const Ip = {
...
}, mr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Qr = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, E = ce(t, Mp), S = Jt(), y = w.useRef(), x = gn(), h = w.useRef(null), C = Be(h, i.ref, n), P = (I) => (N) => {
    if (I) {
      const j = h.current;
      N === void 0 ? I(j) : I(j, N);
    }
    ...
    let Z;
    g === "auto" ? (Z = x.transitions.getAutoHeightDuration(I.clientHeight), y.current = Z) : Z = N, I.style.transition = [x.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), x.transitions.create("transform", {
  ...
  return /* @__PURE__ */ T(m, k({
    ...
    children: (I, N) => /* @__PURE__ */ w.cloneElement(i, k({
      style: k({
        opacity: 0,
        transform: Nr(0.75),
        visibility: I === "exited" && !l ? "hidden" : void 0
      }, Ip[I], v, i.props.style),
      ref: C
    }, N))
  }));
});
...
const $r = Qr, _p = (e) => {
...
}, ci = _p, Ap = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Dp = Ee(fa, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ba(), i = tt({
    ...
    slots: y,
    slotProps: x
  } = i, h = ce(i, Ap), C = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Oa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, b, v, g, m, E, S, y, x, h;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [me, lt] = w.useState(), [ke, Ge] = w.useState(null), Pe = w.useRef(!1), Ke = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, ro] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oo = (ee) => {
    ...
    (ee) => {
      ui.start(800 + M, () => {
        kn = !1;
      }), ro(!1), K && Xe && K(ee), ye.start(ve.transitions.duration.shortest, () => {
        Pe.current = !1;
      });
    }
  ), tr = (ee) => {
    ...
    me || lt(ee.currentTarget), Ua(ee), ao.current === !0 && (so(!0), tr(ee));
  }, uo = (ee) => {
    Pe.current = !0;
    const Re = re.props;
...
`));
  ...
  const Ht = {};
  I || (_e.onTouchStart = Wa, _e.onTouchEnd = qa), G || (_e.onMouseOver = On(po, _e.onMouseOver), _e.onMouseLeave = On(fo, _e.onMouseLeave), Ke || (Ht.onMouseOver = po, Ht.onMouseLeave = fo)), z || (_e.onFocus = On(co, _e.onFocus), _e.onBlur = On(lo, _e.onBlur), Ke || (Ht.onFocus = co, Ht.onBlur = lo)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Xa = w.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Pe.current
  }), or = Vp(Wt), mo = (r = (o = Y.popper) != null ? o : _.Popper) != null ? r : zp, ho = (i = (s = (l = Y.transition) != null ? l : _.Transition) != null ? s : $) != null ? i : $r, go = (c = (u = Y.tooltip) != null ? u : _.Tooltip) != null ? c : Up, bo = (d = (f = Y.arrow) != null ? f : _.Arrow) != null ? d : Hp, Ya = Zt(mo, k({}, H, (p = X.popper) != null ? p : D.popper, {
    className: xe(or.popper, H == null ? void 0 : H.className, (b = (v = X.popper) != null ? v : D.popper) == null ? void 0 : b.className)
  }), Wt), Ja = Zt(ho, k({}, J, (g = X.transition) != null ? g : D.transition), Wt), Za = Zt(go, k({}, (m = X.tooltip) != null ? m : D.tooltip, {
    className: xe(or.tooltip, (E = (S = X.tooltip) != null ? S : D.tooltip) == null ? void 0 : E.className)
  }), Wt), Qa = Zt(bo, k({}, (y = X.arrow) != null ? y : D.arrow, {
    className: xe(or.arrow, (x = (h = X.arrow) != null ? h : D.arrow) == null ? void 0 : x.className)
  }), Wt);
  return /* @__PURE__ */ fe(w.Fragment, {
...
function Ra(e) {
  const {
    ...
    gs,
    {
      ...
      onClick: t,
      id: g,
      children: n ? /* @__PURE__ */ fe(Fn, { children: [
        fi(i, n, !0),
...
const hf = Ma, gf = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function gr(e, t, n) {
...
const _a = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  const g = (y) => {
    const x = b.current, h = y.key, C = we(x).activeElement;
    if (h === "ArrowDown")
      y.preventDefault(), Yt(x, C, u, c, gr);
    else if (h === "ArrowUp")
      y.preventDefault(), Yt(x, C, u, c, mi);
    else if (h === "Home")
...
const bf = _a, vf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], yf = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, y = ce(t, vf), x = w.useRef(null), h = Be(x, l.ref, n), C = (L) => (I) => {
    if (L) {
      const N = x.current;
      I === void 0 ? L(N) : L(N, I);
    }
  ...
  return /* @__PURE__ */ T(S, k({
    ...
    children: (L, I) => /* @__PURE__ */ w.cloneElement(l, k({
      style: k({
        opacity: 0,
...
const Ef = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Tf = (e) => {
  ...
  const s = tt({
    ...
    component: u,
    invisible: p
  }), x = Tf(y), h = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ T(m, k({
    in: b,
    timeout: E
  }, S, {
    children: /* @__PURE__ */ T(kf, k({
      ...
      className: xe(x.root, c, h == null ? void 0 : h.className),
...
const If = ["className", "component", "elevation", "square", "variant"], _f = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
...
const Vf = (e) => {
  ...
  } = s, D = ce(s.TransitionProps, Bf), B = ce(s, Lf), z = (r = x == null ? void 0 : x.paper) != null ? r : S, G = w.useRef(), L = Be(G, z.ref), I = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
...
`));
    ...
    return {
      top: re.top + hi(re, u.vertical),
      left: re.left + gi(re, u.horizontal)
    };
  }, [c, u.horizontal, u.vertical, d, f]), Q = w.useCallback((J) => ({
    vertical: hi(J, h.vertical),
    horizontal: gi(J, h.horizontal)
...
const Wf = ["onEntering"], qf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Gf = {
  ...
  const i = tt({
    ...
    slots: S = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, Wf), h = ce(i, qf), C = gn(), P = C.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: E
  }), _ = Xf(A), D = s && !u && p, B = w.useRef(null), z = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const I = (r = S.paper) != null ? r : Jf, N = (o = y.paper) != null ? o : b, j = gt({
    elementType: S.root,
  ...
  return /* @__PURE__ */ T(Yf, k({
    ...
    children: /* @__PURE__ */ T(Zf, k({
      ...
      className: xe(_.list, d.className),
      children: l
    }))
  }));
});
...
function nm({
  ...
  Vn(() => {
    if (c) {
      ...
      if (x) {
        const h = x.getBoundingClientRect(), C = window.scrollY, P = window.scrollX, A = h.top + C + x.clientHeight, _ = h.left + P;
        m({ top: A, left: _ });
      }
    }
  }, [c, o]);
...
function xm({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c, u) => {
...
function wm({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = ze(""), i = (s) => {
    o(s), e(s);
  };
...
const rm = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ T(
  nl,
  {
    ...r,
    isChecked: n,
...
function Sm({
  ...
  const i = Nn(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T(Os, { position: "static", id: r, children: /* @__PURE__ */ fe(Ss, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      nm,
      {
        commandHandler: t,
...
`, "top");
export {
  gm as BookChapterControl,
  xt as Button,
  bm as ChapterRangeSelector,
  nl as Checkbox,
  xr as ComboBox,
  vm as ContextMenu,
  cf as GridMenu,
