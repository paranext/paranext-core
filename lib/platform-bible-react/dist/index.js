import Dl, { jsx as m, jsxs as B, Fragment as dt } from "react/jsx-runtime";
...
const Ro = ge.Root, ji = ge.Trigger, Uc = ge.Group, wv = ge.Portal, xv = ge.Sub, Ev = ge.RadioGroup, Hc = G.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ B(
  ge.SubTrigger,
  {
    ref: o,
    className: F(
...
function dp({
  ...
  return /* @__PURE__ */ B("div", { children: [
    ...
    /* @__PURE__ */ m("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ B(wr, { children: [
      /* @__PURE__ */ m(xr, { children: h.getHeaderGroups().map((b) => /* @__PURE__ */ m(yt, { children: b.headers.map((x) => /* @__PURE__ */ m(Pn, { children: x.isPlaceholder ? void 0 : xn(x.column.columnDef.header, x.getContext()) }, x.id)) }, b.id)) }),
      /* @__PURE__ */ m(Er, { children: (u = h.getRowModel().rows) != null && u.length ? h.getRowModel().rows.map((b) => /* @__PURE__ */ m(
        ...
        b.id
      )) : /* @__PURE__ */ m(yt, { children: /* @__PURE__ */ m(Yt, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }) }),
...
var ch = function(t) {
  return t.scrollTop;
}, wn = "unmounted", Ct = "exited", Ot = "entering", Xt = "entered", go = "exiting", mt = /* @__PURE__ */ function(e) {
  sh(t, e);
  function t(r, o) {
    var a;
...
const gh = wt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), vt = gh, bh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function vh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const yh = (e) => {
  ...
  [`&[data-popper-placement*="right"] .${vt.arrow}`]: R({}, t.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${vt.arrow}`]: R({}, t.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${vt.popper}[data-popper-placement*="left"] &`]: R({
  ...
  [`.${vt.popper}[data-popper-placement*="right"] &`]: R({
  ...
  [`.${vt.popper}[data-popper-placement*="top"] &`]: R({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, t.touch && {
    marginBottom: "24px"
  }),
  [`.${vt.popper}[data-popper-placement*="bottom"] &`]: R({
...
function Hs(e) {
  const {
    ...
    hc,
    {
      ...
      onClick: t,
      id: u,
      children: n ? /* @__PURE__ */ B(dt, { children: [
        ui(a, n, !0),
...
const bt = "scrBook", Eg = "scrRef", St = "source", kg = "details", Tg = "Scripture Reference", Ng = "Scripture Book", rl = "Type", Cg = "Details";
function Og(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? me.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === bt ? Vr(o.start) : void 0;
      },
...
function Sv({
  ...
  const [c, d] = ie([]), [f, v] = ie([{ id: bt, desc: !1 }]), [g, p] = ie(() => e.flatMap((k) => {
    const O = k.source;
    return k.data.map(($) => ({
      ...$,
      source: O
  ...
  return /* @__PURE__ */ B("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    ...
    /* @__PURE__ */ B(wr, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ m(xr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(yt, { children: k.headers.filter((O) => O.column.columnDef.header).map((O) => (
...
const Iv = De.Root, Pg = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m(
  De.List,
  {
    ref: n,
    className: F(
...
function jg({
  ...
  return Ve(
    ...
    /* @__PURE__ */ m(xr, { children: /* @__PURE__ */ B(yt, { children: [
...
function Bv({
  ...
  return /* @__PURE__ */ m(
    ve,
    {
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ m(gr, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ B(dt, { children: [
...
function jv({ isEnabling: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    ve,
    {
      className: F(
      ...
      onClick: t,
      children: e ? /* @__PURE__ */ B(dt, { children: [
...
function Lv({ isDisabling: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    ve,
    {
      className: F(
...
function Fv({ isUpdating: e, handleClick: t }) {
  return /* @__PURE__ */ m(
    ve,
    {
      className: F(
...
`, { _: h }));
  ...
  const i = [], l = {}, c = { blockQuote: { t: it(al), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Gg, ""), u) }), h: (p, h, u) => r("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: gn(Wg), i: ae.HIGH, l: to, h: (p, h, u) => r("br", { key: u.k }) }, breakThematic: { t: it(Xg), i: ae.HIGH, l: to, h: (p, h, u) => r("hr", { key: u.k }) }, codeBlock: { t: it(sl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => r("pre", { key: u.k }, r("code", Pt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(il), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: gt(qg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => r("code", { key: u.k }, p.v) }, footnote: { t: it(Jg), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: no }, footnoteReference: { t: ht(Zg), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => r("a", { key: u.k, href: Gt(p.B) }, r("sup", { key: u.k }, p.v)) }, gfmTask: { t: ht(eb), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => r("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? cl : ll), i: ae.HIGH, l: (p, h, u) => ({ v: or(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => r(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: it(pl), i: ae.MAX, l: (p, h, u) => ({ v: or(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: gn(dl), i: ae.HIGH, l: () => ({}), h: no }, image: { t: gt(Mb), i: ae.HIGH, l: (p) => ({ D: p[1], B: Ti(p[2]), F: p[3] }), h: (p, h, u) => r("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Gt(p.B) }) }, link: { t: ht(_b), i: ae.LOW, l: (p, h, u) => ({ v: Lb(h, p[1], u), B: Ti(p[2]), F: p[3] }), h: (p, h, u) => r("a", { key: u.k, href: Gt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: ht(ib), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : ht(ob)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: ht(ab), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
...
` }, paragraph: { t: jb, i: ae.LOW, l: eo, h: (p, h, u) => r("p", { key: u.k }, h(p.v, u)) }, ref: { t: ht(lb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: no }, refImage: { t: gt(cb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => r("img", { key: u.k, alt: p.D, src: Gt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: ht(pb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(db, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? r("a", { key: u.k, href: Gt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : r("span", { key: u.k }, h(p.Z, u)) }, table: { t: it(ul), i: ae.HIGH, l: Bb, h: (p, h, u) => r("table", { key: u.k }, r("thead", null, r("tr", null, p.L.map(function(b, x) {
  ...
  }, h: () => " | " }, text: { t: gn(Nb), i: ae.MIN, l: (p) => ({ v: p[0].replace(tb, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: gt(wb), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => r("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: gt(xb), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => r("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: gt(Tb), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: gt(Eb), i: ae.LOW, l: eo, h: (p, h, u) => r("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: gt(kb), i: ae.LOW, l: eo, h: (p, h, u) => r("del", { key: u.k }, h(p.v, u)) } };
...
const Hb = Eo((e, t) => /* @__PURE__ */ B(
  ...
  {
    ref: t,
    className: "pr-rounded-md pr-border pr-border-dashed pr-border-gray-400 pr-bg-white pr-px-4 pr-py-2 pr-text-black pr-transition pr-duration-300 pr-ease-in-out hover:pr-text-blue-600 hover:pr-border-blue-600 hover:pr-bg-white",
    ...e,
    children: [
      /* @__PURE__ */ m(nc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ m(To, { size: 16, className: "pr-ml-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" })
    ]
  }
));
function zv({ groups: e }) {
  return /* @__PURE__ */ B(Ro, { children: [
    ...
    /* @__PURE__ */ m(vr, { children: e.map((t) => /* @__PURE__ */ B(dt, { children: [
      /* @__PURE__ */ m(Dn, { children: t.label }),
      /* @__PURE__ */ m(Uc, { children: t.items.map((n) => /* @__PURE__ */ m("div", { children: n.checkbox ? /* @__PURE__ */ m(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ m(Fi, { onClick: n.onClick, value: n.label, children: n.label }) })) }),
      /* @__PURE__ */ m(yr, {})
    ] })) })
  ] });
}
...
const qb = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("p", { ref: n, className: F("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
), Zb = G.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ m("div", { ref: r, role: "alert", className: F(Jb({ variant: t }), e), ...n }));
...
const ev = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ m("div", { ref: n, className: F("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
ev.displayName = "AlertDescription";
const tv = G.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ B(
  bn.Root,
  {
    ref: n,
    className: F(
