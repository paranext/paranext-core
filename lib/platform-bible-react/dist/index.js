...
import { getChaptersForBook as dc, compareScrRefs as ao, scrRefToBBBCCCVVV as Vn, formatScrRef as Fn } from "platform-bible-utils";
import { useReactTable as Ci, getCoreRowModel as Oi, getPaginationRowModel as uc, getSortedRowModel as Ri, getFilteredRowModel as fc, flexRender as kr, getExpandedRowModel as mc, getGroupedRowModel as hc } from "@tanstack/react-table";
import { Slot as gc } from "@radix-ui/react-slot";
import { cva as To } from "class-variance-authority";
import * as xe from "@radix-ui/react-select";
import { FormControlLabel as ya, FormLabel as bc, Checkbox as vc, MenuItem as yc, ListItemText as wc, ListItemIcon as Pi, Menu as xc, Grid as $i, List as kc, IconButton as _i, Drawer as Ec, Slider as Nc, Snackbar as Tc, Switch as Sc, AppBar as Cc, Toolbar as Oc } from "@mui/material";
import * as Or from "@radix-ui/react-popover";
import { Command as Ae } from "cmdk";
import * as Qe from "@radix-ui/react-dialog";
import Rc, { ThemeContext as Pc, internal_processStyles as $c } from "@mui/styled-engine";
...
var Ac = Object.defineProperty, Dc = (e, t, r) => t in e ? Ac(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => Dc(e, typeof t != "symbol" ? t + "" : t, r);
const It = [
  "GEN",
  "EXO",
  "LEV",
...
const Ro = ge.Root, Vi = ge.Trigger, Xc = ge.Group, Sv = ge.Portal, Cv = ge.Sub, Ov = ge.RadioGroup, Yc = W.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ _(
  ge.SubTrigger,
  {
    ref: o,
    className: F(
    ...
    children: [
      r,
      /* @__PURE__ */ d(Vl, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
...
const Fi = W.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ge.Item,
  {
    ref: n,
    className: F(
...
const zi = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  ge.RadioItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(ge.ItemIndicator, { children: /* @__PURE__ */ d(Fl, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
...
const Er = me.allBookIds, ep = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ka = ["OT", "NT", "DC"], tp = 32 + 32 + 32, rp = [
  /^(\w+)$/i,
...
function Rv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ce(""), [o, a] = ce(
    ...
    rp.forEach((E) => {
      const C = r.match(E);
      if (C) {
        const [$, z = void 0, U = void 0] = C.slice(1), j = ip($);
        ...
        children: [
          ...
          ka.map(
            (E, C) => x(E).length > 0 && /* @__PURE__ */ _("div", { children: [
              /* @__PURE__ */ d(jr, { className: "pr-font-semibold pr-text-slate-700", children: ep[E] }),
...
const sp = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? gc : "button", { className: F(sp({ variant: t, size: r, className: e })), ref: a, ...o })
);
...
const an = xe.Root, cp = xe.Group, sn = xe.Value, Rr = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  xe.Trigger,
  {
    ref: n,
    className: F(
...
const dp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.Separator,
  {
    ref: r,
    className: F("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
...
dp.displayName = xe.Separator.displayName;
function up({ table: e }) {
...
const wn = W.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d("div", { className: F("pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ d(
  "table",
  {
    ref: n,
...
const kn = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: F("[&_tr:last-child]:pr-border-0", e), ...t }));
...
]), $o = (e) => e === "asc" ? /* @__PURE__ */ d(Jl, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(Zl, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(Ql, { className: "pr-ml-2 pr-h-4 pr-w-4" }), vp = (e, t, r) => {
  let n = e;
...
const _v = (e) => ({
  accessorKey: "item",
  header: ({ column: t }) => /* @__PURE__ */ _(we, { onClick: () => t.toggleSorting(void 0), children: [
    e,
    $o(t.getIsSorted())
  ] })
}), Mv = (e) => ({
  ...
  header: ({ column: r, table: n }) => {
    ...
    return o.forEach((i) => {
      ...
      /* @__PURE__ */ d("div", { className: "pr-flex pr-justify-center", children: /* @__PURE__ */ _(we, { className: "pr-mt-1", onClick: () => r.toggleSorting(void 0), children: [
        e,
        $o(r.getIsSorted())
      ] }) }),
...
}), wp = Or.Root, xp = Or.Trigger, Gi = W.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d(Or.Portal, { children: /* @__PURE__ */ d(
  Or.Content,
  {
    ref: o,
    align: t,
...
const kp = Qe.Portal, Wi = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Overlay,
  {
    ref: r,
    className: F(
...
const Ep = W.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(kp, { children: [
  /* @__PURE__ */ d(Wi, {}),
  /* @__PURE__ */ _(
    Qe.Content,
    {
...
Ep.displayName = Qe.Content.displayName;
...
Np.displayName = Qe.Title.displayName;
const Tp = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Description,
  {
    ref: r,
...
Tp.displayName = Qe.Description.displayName;
...
Sp.displayName = Ae.Group.displayName;
...
Cp.displayName = Ae.Separator.displayName;
...
function Ta({
  ...
  const [m, v] = ce(!1);
  return /* @__PURE__ */ _(wp, { open: m, onOpenChange: v, children: [
    /* @__PURE__ */ d(xp, { asChild: !0, children: /* @__PURE__ */ _(
      we,
      {
        variant: f,
        role: "combobox",
...
function Rp({
  ...
  let v;
  if (r) {
    const g = n === Xt.Before || n === Xt.Above, p = /* @__PURE__ */ d("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: r }), h = n === Xt.Before || n === Xt.After, u = h ? p : /* @__PURE__ */ d("div", { children: p }), b = h ? m : /* @__PURE__ */ d("div", { children: m });
    v = /* @__PURE__ */ _(
      bc,
      {
...
function Ip() {
  return Ca || (Ca = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = f, S = l, M = i, D = t, V = m, E = n, C = h, $ = p, z = r, U = a, j = o, B = v, Z = !1;
    function Q(L) {
...
function jp() {
  if (Ma)
    return Xn;
  Ma = 1;
  var e = es(), t = Ap(), r = Mo(), n = ts(), o = Dp(), a = function() {
  };
  ...
  return Xn = function(l, c) {
    ...
    function V() {
      function R(I, H, J, G, X) {
        return z(I[H]) ? null : new u("Invalid " + G + " `" + X + "` supplied to " + ("`" + J + "`, expected a ReactNode."));
      }
      return b(R);
    }
    function E(R, I, H, J, G) {
      return new u(
...
if (process.env.NODE_ENV !== "production") {
  var Lp = es(), Vp = !0;
  so.exports = jp()(Lp.isElement, Vp);
} else
  so.exports = Bp()();
var Fp = so.exports;
const s = /* @__PURE__ */ Pp(Fp);
function zp(e) {
  const {
    prototype: t = {}
  } = e;
...
function rs(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !zp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function Hp(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !Up(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Gp = ar(s.elementType, Hp), Wp = "exact-prop: ​";
function os(e) {
...
function Yp() {
  return Da || (Da = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, S = a, M = e, D = c, V = r, E = g, C = v, $ = t, z = o, U = n, j = f, B = m, Z = !1, Q = !1;
    function R(A) {
...
const Zp = s.oneOfType([s.func, s.object]), Io = Zp;
function et(e) {
  if (typeof e != "string")
...
const rd = typeof window < "u" ? N.useLayoutEffect : N.useEffect, At = rd;
let Ba = 0;
function nd(e) {
...
function fd(e) {
  e.addEventListener("keydown", dd, !0), e.addEventListener("mousedown", qn, !0), e.addEventListener("pointerdown", qn, !0), e.addEventListener("touchstart", qn, !0), e.addEventListener("visibilitychange", ud, !0);
}
function md(e) {
  const {
    target: t
...
function cs() {
  const e = N.useCallback((o) => {
    o != null && fd(o.ownerDocument);
  }, []), t = N.useRef(!1);
  function r() {
    return t.current ? (po = !0, ld.start(100, () => {
      po = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
...
function wd(e, t = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
function Ed(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = he(e, xd), a = kd(t), i = Object.keys(a);
  function l(g) {
...
const Nd = {
  borderRadius: 4
}, Td = Nd, Sd = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, kt = Sd;
function Nr(e, t) {
  return t ? st(e, t, {
    clone: !1
...
const Pd = {
  ...
  if (e.length > 2)
    if (Ua[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Pd[t], o = $d[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), Tn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Sn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Md = [...Tn, ...Sn];
function Vr(e, t, r, n) {
  var o;
...
function Ad(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = _d(r), a = Id(o, n), i = e[r];
  return ct(e, i, a);
}
function vs(e, t) {
  const r = bs(e.theme);
  return Object.keys(e).map((n) => Ad(e, t, n, r)).reduce(Nr, {});
}
function ve(e) {
  return vs(e, Tn);
}
...
ye.filterProps = Sn;
process.env.NODE_ENV !== "production" && Md.reduce((e, t) => (e[t] = kt, e), {});
function Dd(e = 8) {
  if (e.mui)
    return e;
  const t = bs({
...
const jd = qe("border", Ue), Bd = qe("borderTop", Ue), Ld = qe("borderRight", Ue), Vd = qe("borderBottom", Ue), Fd = qe("borderLeft", Ue), zd = qe("borderColor"), Ud = qe("borderTopColor"), Hd = qe("borderRightColor"), Gd = qe("borderBottomColor"), Wd = qe("borderLeftColor"), Xd = qe("outline", Ue), Yd = qe("outlineColor"), On = (e) => {
...
Cn(jd, Bd, Ld, Vd, Fd, zd, Ud, Hd, Gd, Wd, On, Xd, Yd);
const Rn = (e) => {
...
Cn(Rn, Pn, $n, qd, Kd, Jd, Zd, Qd, eu, tu, ru, nu);
function qt(e, t) {
  return t === "grey" ? t : e;
}
const ou = Ee({
...
function gu() {
  ...
  function t(r) {
    ...
    function l(c) {
      ...
      if (!f)
        return null;
      const m = Cd(a.breakpoints), v = Object.keys(m);
      let g = m;
...
function Lo(e = {}, ...t) {
  ...
  return f.applyStyles = bu, f = t.reduce((m, v) => st(m, v), f), f.unstable_sxConfig = P({}, jo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return Bo({
      sx: v,
      theme: this
    });
...
const xu = ["ownerState"], ku = ["variants"], Eu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Nu(e) {
  return Object.keys(e).length === 0;
}
function Tu(e) {
...
const Su = Lo(), Ha = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Kr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Ou(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    $c(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = Cu(Ha(f))
    } = l, p = he(l, Eu), h = m !== void 0 ? m : (
    ...
    let x = en;
    f === "Root" || f === "root" ? x = n : f ? x = o : Tu(i) && (x = void 0);
    const O = Rc(i, P({
      shouldForwardProp: x,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let E;
        c && (E = `${c}${et(f || "")}`), E === void 0 && (E = `Styled(${Jp(i)})`), V.displayName = E;
      }
...
function Vo(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), wd(e, t, r);
}
function $u(e) {
  e = e.slice(1);
...
function Ga(e) {
  e = Dt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Dt(_u(e)).values : e.values;
...
function dn(e, t) {
  return e = Dt(e), t = Vo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, _n(e);
}
function Mu(e, t) {
  if (e = Dt(e), t = Vo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Du = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ht = Hu, Gu = ["mode", "contrastThreshold", "tonalOffset"], Xa = {
...
function Ya(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = Iu(e.main, o) : t === "dark" && (e.dark = Mu(e.main, a)));
}
function Wu(e = "light") {
  return e === "dark" ? {
    main: zt[200],
...
function Zu(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, Gu), a = e.primary || Wu(t), i = e.secondary || Xu(t), l = e.error || Yu(t), c = e.info || qu(t), f = e.success || Ku(t), m = e.warning || Ju(t);
  function v(u) {
...
const rf = 0.2, nf = 0.14, of = 0.12;
function be(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${rf})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${nf})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${of})`].join(",");
}
const af = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], sf = af, lf = ["duration", "easing", "delay"], cf = {
...
function uf(e) {
  const t = P({}, cf, e.easing), r = P({}, pf, e.duration);
  return P({
...
const ff = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, mf = ff, hf = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function gf(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
const ks = (e) => en(e) && e !== "classes", vf = Ou({
  themeId: zo,
  defaultTheme: Fo,
...
const wf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], xf = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: n
  ...
  const n = ut({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = he(n, wf), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Tf = /* @__PURE__ */ $p(Nf);
var Qa;
function Sf() {
...
var Ns = _o.default = void 0, Of = Cf(Sf()), Rf = Bl;
Ns = _o.default = (0, Of.default)(/* @__PURE__ */ (0, Rf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ts(e) {
...
const Lf = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function Vf(e) {
...
function Uf(e) {
  const t = [], r = [];
  return Array.from(e.querySelectorAll(Lf)).forEach((n, o) => {
    const a = Vf(n);
    a === -1 || !zf(n) || (a === 0 ? t.push(n) : r.push({
      documentOrder: o,
      tabIndex: a,
      node: n
    }));
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Oe(h.current), k = (S) => {
      ...
      if ((w.activeElement === f.current || w.activeElement === m.current) && (M = a(h.current)), M.length > 0) {
        var D, V;
        const E = !!((D = b.current) != null && D.shiftKey && ((V = b.current) == null ? void 0 : V.key) === "Tab"), C = M[0], $ = M[M.length - 1];
...
const Ir = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  return /* @__PURE__ */ d(N.Fragment, {
    children: i && /* @__PURE__ */ _c.createPortal(n, i)
  });
});
...
process.env.NODE_ENV !== "production" && (Ir["propTypes"] = os(Ir.propTypes));
function Wf(e) {
  const t = Oe(e);
...
function em(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, x] = N.useState(!m), O = Zf(c);
  let w = !0;
  ...
  const E = (j) => (B) => {
    ...
    !M()) && (r || (B.stopPropagation(), f && f(B, "escapeKeyDown")));
  }, C = (j) => (B) => {
    var Z;
...
var Me = "top", Xe = "bottom", Ye = "right", Ie = "left", Ho = "auto", zr = [Me, Xe, Ye, Ie], er = "start", Ar = "end", tm = "clippingParents", Rs = "viewport", mr = "popper", rm = "reference", ni = /* @__PURE__ */ zr.reduce(function(e, t) {
  return e.concat([t + "-" + er, t + "-" + Ar]);
}, []), Ps = /* @__PURE__ */ [].concat(zr, [Ho]).reduce(function(e, t) {
  return e.concat([t, t + "-" + er, t + "-" + Ar]);
}, []), nm = "beforeRead", om = "read", am = "afterRead", im = "beforeMain", sm = "main", lm = "afterMain", cm = "beforeWrite", pm = "write", dm = "afterWrite", um = [nm, om, am, im, sm, lm, cm, pm, dm];
function tt(e) {
...
function rr(e, t, r) {
  ...
  var i = Bt(e) ? Fe(e) : window, l = i.visualViewport, c = !$s() && r, f = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
function Ur(e) {
  for (var t = Fe(e), r = oi(e); r && gm(r) && pt(r).position === "static"; )
    r = oi(r);
  return r && (tt(r) === "html" || tt(r) === "body" && pt(r).position === "static") ? t : r || bm(e) || t;
}
function Xo(e) {
...
var ym = function(t, r) {
  ...
  })) : t, Is(typeof t != "number" ? t : As(t, zr));
};
function wm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Ze(r.placement), c = Xo(l), f = [Ie, Ye].indexOf(l) >= 0, m = f ? "height" : "width";
  if (!(!a || !i)) {
    var v = ym(o.padding, r), g = Wo(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = Ur(a), O = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, k = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + w, S = Sr(k, T, y), M = c;
...
function ai(e) {
  ...
  p = b.x, u = b.y;
  var x = i.hasOwnProperty("x"), O = i.hasOwnProperty("y"), w = Ie, k = Me, y = window;
  if (f) {
    var T = Ur(r), S = "clientHeight", M = "clientWidth";
    if (T === Fe(r) && (T = Et(r), pt(T).position !== "static" && l === "absolute" && (S = "scrollHeight", M = "scrollWidth")), T = T, o === Me || (o === Ie || o === Ye) && a === Ar) {
      k = Xe;
...
function Cm(e) {
  var t = e.state, r = e.instance, n = e.options, o = n.scroll, a = o === void 0 ? !0 : o, i = n.resize, l = i === void 0 ? !0 : i, c = Fe(t.elements.popper), f = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function _m(e) {
  var t, r = Et(e), n = Yo(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = Mt(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = Mt(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -n.scrollLeft + qo(e), c = -n.scrollTop;
...
function Ds(e) {
  return ["html", "body", "#document"].indexOf(tt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && Ko(e) ? e : Ds(Mn(e));
}
function Cr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Ds(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = Fe(n), i = o ? [a].concat(a.visualViewport || [], Ko(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function si(e, t, r) {
  return t === Rs ? mo($m(e, r)) : Bt(t) ? Mm(t, r) : mo(_m(Et(e)));
}
function Im(e) {
  var t = Cr(Mn(e)), r = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, n = r && Ge(e) ? Ur(e) : e;
  return Bt(n) ? t.filter(function(o) {
    return Bt(o) && _s(o, n) && tt(o) !== "body";
  }) : [];
}
function Am(e, t, r, n) {
  var o = t === "clippingParents" ? Im(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, f) {
    var m = si(e, f, n);
...
function Dr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? tm : l, f = r.rootBoundary, m = f === void 0 ? Rs : f, v = r.elementContext, g = v === void 0 ? mr : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, x = Is(typeof b != "number" ? b : As(b, zr)), O = g === mr ? rm : mr, w = e.rects.popper, k = e.elements[h ? O : g], y = Am(Bt(k) ? k : k.contextElement || Et(e.elements.popper), c, m, i), T = rr(e.elements.reference), S = js({
    reference: T,
    element: w,
    strategy: "absolute",
    placement: o
...
function Bm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, x = Ze(b), O = x === b, w = c || (O || !h ? [rn(b)] : jm(b)), k = [b].concat(w).reduce(function(G, X) {
      return G.concat(Ze(X) === Ho ? Dm(t, {
        placement: X,
        boundary: m,
        rootBoundary: v,
        padding: f,
      ...
      var E = k[V], C = Ze(E), $ = nr(E) === er, z = [Me, Xe].indexOf(C) >= 0, U = z ? "width" : "height", j = Dr(t, {
        placement: E,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
...
function Ym(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Dr(t, {
    ...
    padding: v,
    altBoundary: m
  }), x = Ze(t.placement), O = nr(t.placement), w = !O, k = Xo(x), y = Xm(k), T = t.modifiersData.popperOffsets, S = t.rects.reference, M = t.rects.popper, D = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, V = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (T) {
    if (a) {
      var $, z = k === "y" ? Me : Ie, U = k === "y" ? Xe : Ye, j = k === "y" ? "height" : "width", B = T[k], Z = B + b[z], Q = B - b[U], R = p ? -M[j] / 2 : 0, I = O === er ? S[j] : M[j], H = O === er ? -M[j] : -S[j], J = t.elements.arrow, G = p && J ? Wo(J) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Ms(), q = X[z], K = X[U], Y = Sr(0, S[j], G[j]), ee = w ? S[j] / 2 - R - Y - q - V.mainAxis : I - Y - q - V.mainAxis, te = w ? -S[j] / 2 + R + Y + K + V.mainAxis : H + Y + K + V.mainAxis, ie = t.elements.arrow && Ur(t.elements.arrow), L = ie ? k === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = ($ = E == null ? void 0 : E[k]) != null ? $ : 0, A = B + ee - re - L, se = B + te - re, Ne = Sr(p ? fn(Z, A) : Z, B, p ? Mt(Q, se) : Q);
      T[k] = Ne, C[k] = Ne - B;
    }
    if (l) {
      var Pe, ke = k === "x" ? Me : Ie, Nt = k === "x" ? Xe : Ye, $e = T[y], nt = y === "y" ? "height" : "width", je = $e + b[ke], ot = $e - b[Nt], Te = [Me, Ie].indexOf(x) !== -1, Lt = (Pe = E == null ? void 0 : E[y]) != null ? Pe : 0, Tt = Te ? je : $e - S[nt] - M[nt] - Lt + V.altAxis, ir = Te ? $e + S[nt] + M[nt] - Lt - V.altAxis : ot, Gr = p && Te ? vm(Tt, $e, ir) : Sr(p ? Tt : je, $e, p ? ir : ot);
      T[y] = Gr, C[y] = Gr - $e;
    }
    t.modifiersData[n] = C;
  }
...
function Qm(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && Zm(t), a = Et(t), i = rr(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ko(a)) && (l = Jm(t)), Ge(t) ? (c = rr(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
  ...
  return function(l, c, f) {
    ...
    var m = {
      ...
      setOptions: function(x) {
        ...
        var w = th(nh([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (di(O, w)) {
            m.rects = {
              reference: Qm(O, Ur(w), m.options.strategy === "fixed"),
              popper: Wo(w)
...
var ah = [Om, Wm, Sm, hm, Hm, Lm, qm, km, Fm], ih = /* @__PURE__ */ oh({
  defaultModifiers: ah
});
const Bs = "Popper";
function sh(e) {
...
Bf(Bs, ["root"]);
const lh = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], ch = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function ph(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const uh = () => dt({
  root: ["root"]
}, _f(sh)), fh = {}, mh = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = he(t, lh), x = N.useRef(null), O = We(x, r), w = N.useRef(null), k = We(w, g), y = N.useRef(k);
  At(() => {
    y.current = k;
  }, [k]), N.useImperativeHandle(g, () => w.current, []);
  const T = ph(m, i), [S, M] = N.useState(T), [D, V] = N.useState(mn(o));
  N.useEffect(() => {
...
`));
  ...
  const C = uh(), $ = (n = h.root) != null ? n : "div", z = jt({
    elementType: $,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, O = he(t, ch), [w, k] = N.useState(!0), y = () => {
    k(!1);
  }, T = () => {
    k(!0);
  };
  ...
  if (a)
    ...
    const V = mn(n);
    S = V && In(V) ? Oe(V).body : Oe(null).body;
  }
...
var gh = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.shape({
  enter: s.number,
  exit: s.number,
  appear: s.number
}).isRequired]) : null;
...
var bh = function(t) {
  return t.scrollTop;
}, xr = "unmounted", Ct = "exited", Ot = "entering", Yt = "entered", go = "exiting", ft = /* @__PURE__ */ function(e) {
  hh(t, e);
  function t(n, o) {
    var a;
    a = e.call(this, n, o) || this;
    var i = o, l = i && !i.isMounting ? n.enter : n.appear, c;
    return a.appearStatus = null, n.in ? l ? (c = Ct, a.appearStatus = Ot) : c = Yt : n.unmountOnExit || n.mountOnEnter ? c = xr : c = Ct, a.state = {
      status: c
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Ot && i !== Yt && (a = Ot) : (i === Ot || i === Yt) && (a = go);
    }
...
const vh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function bo(e) {
  return `scale(${e}, ${e ** 2})`;
}
const yh = {
  ...
  } = t, x = he(t, vh), O = yr(), w = N.useRef(), k = Hr(), y = N.useRef(null), T = We(y, a.ref, r), S = (U) => (j) => {
    if (U) {
      const B = y.current;
      j === void 0 ? U(B) : U(B, j);
    }
...
const vo = Jo, wh = (e) => {
...
}, fi = wh, xh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], kh = Re(Ls, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ws(), a = ut({
    ...
    slots: w,
    slotProps: k
  } = a, y = he(a, xh), T = (n = w == null ? void 0 : w.root) != null ? n : c == null ? void 0 : c.Root, S = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Nh = xt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), vt = Nh, Th = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Sh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Ch = (e) => {
...
const Gs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ut({
    ...
    TransitionProps: re
  } = T, A = he(T, Th), se = /* @__PURE__ */ N.isValidElement(M) ? M : /* @__PURE__ */ d("span", {
    children: M
  }), Ne = Hr(), Pe = Ne.direction === "rtl", [ke, Nt] = N.useState(), [$e, nt] = N.useState(null), je = N.useRef(!1), ot = z || Q, Te = yr(), Lt = yr(), Tt = yr(), ir = yr(), [Gr, ta] = ls({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const ra = (ne) => {
    ...
    je.current && ne.type !== "touchstart" || (ke && ke.removeAttribute("title"), Lt.clear(), Tt.clear(), j || Zr && B ? Lt.start(Zr ? B : j, () => {
      ra(ne);
    }) : ra(ne));
  }, na = (ne) => {
    Lt.clear(), Tt.start(I, () => {
...
`));
  const Ml = N.useMemo(() => {
    ...
    touch: je.current
  }), Ln = Ch(pr), da = (n = (o = te.popper) != null ? o : D.Popper) != null ? n : Oh, ua = (a = (i = (l = te.transition) != null ? l : D.Transition) != null ? i : L) != null ? a : vo, fa = (c = (f = te.tooltip) != null ? f : D.Tooltip) != null ? c : Rh, ma = (m = (v = te.arrow) != null ? v : D.Arrow) != null ? m : Ph, Il = wr(da, P({}, Y, (g = ee.popper) != null ? g : V.popper, {
    className: Ce(Ln.popper, Y == null ? void 0 : Y.className, (p = (h = ee.popper) != null ? h : V.popper) == null ? void 0 : p.className)
  }), pr), Al = wr(ua, P({}, re, (u = ee.transition) != null ? u : V.transition), pr), Dl = wr(fa, P({}, (b = ee.tooltip) != null ? b : V.tooltip, {
    className: Ce(Ln.tooltip, (x = (O = ee.tooltip) != null ? O : V.tooltip) == null ? void 0 : x.className)
  }), pr), jl = wr(ma, P({}, (w = ee.arrow) != null ? w : V.arrow, {
    className: Ce(Ln.arrow, (k = (y = ee.arrow) != null ? y : V.arrow) == null ? void 0 : k.className)
  }), pr);
  return /* @__PURE__ */ _(N.Fragment, {
  ...
  const {
    ...
    yc,
    {
      ...
      children: r ? /* @__PURE__ */ _(wt, { children: [
        hi(a, r, !0),
        /* @__PURE__ */ d(wc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Pi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(Ns, {}) }) : hi(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d($h, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: x }) }) : x;
}
function Xs(e) {
...
const Mh = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function Zo(e) {
...
const Lh = ["children", "className", "component", "dense", "disablePadding", "subheader"], Vh = (e) => {
  const {
    classes: t,
    disablePadding: r,
    dense: n,
...
const zh = qs, Uh = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Qn(e, t, r) {
...
const Js = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  } = t, g = he(t, Uh), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (w) => {
    ...
    if (y === "ArrowDown")
      ...
      const V = T && !S.repeating && Ks(T, S);
      S.previousKeyMatched && (V || gr(k, T, !1, c, Qn, S)) ? w.preventDefault() : S.previousKeyMatched = !1;
    }
    m && m(w);
  }, b = We(p, r);
  let x = -1;
...
const Hh = Js, Gh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Wh = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const n = Hr(), o = {
    ...
    timeout: x = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: O = Fs
  } = t, w = he(t, Gh), k = N.useRef(null), y = We(k, l.ref, r), T = (z) => (U) => {
    if (z) {
      const j = k.current;
      U === void 0 ? z(j) : z(j, U);
    }
...
const qh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Kh = (e) => {
  const {
    classes: t,
    invisible: r
  } = e;
  ...
  const i = ut({
    ...
    slotProps: h = {},
    slots: u = {},
    TransitionComponent: b = Xh,
    transitionDuration: x
  } = i, O = he(i, qh), w = P({}, i, {
    component: f,
    invisible: g
  }), k = Kh(w), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ d(b, P({
    in: p,
    timeout: x
  }, O, {
    children: /* @__PURE__ */ d(Jh, P({
      "aria-hidden": !0
    }, y, {
...
const eg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], tg = (e) => {
  ...
  const K = (n = (o = z == null ? void 0 : z.root) != null ? o : x.Root) != null ? n : rg, Y = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : x.Backdrop) != null ? a : m, ee = (l = $ == null ? void 0 : $.root) != null ? l : O.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : O.backdrop, ie = jt({
    elementType: K,
  ...
  return !V && !C && (!J || H) ? null : /* @__PURE__ */ d(Ir, {
    ref: R,
    container: u,
    disablePortal: T,
...
const ig = ["className", "component", "elevation", "square", "variant"], sg = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
...
const dg = ["onEntering"], ug = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], fg = ["slotProps"];
function bi(e, t) {
  let r = 0;
...
const mg = (e) => {
  ...
  } = i, V = he(i.TransitionProps, dg), E = he(i, ug), C = (n = k == null ? void 0 : k.paper) != null ? n : O, $ = N.useRef(), z = We($, C.ref), U = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`)), b !== null && ke < b) {
  ...
  const q = h || (c ? Oe(nn(c)).body : void 0), K = (o = w == null ? void 0 : w.root) != null ? o : hg, Y = (a = w == null ? void 0 : w.paper) != null ? a : rl, ee = jt({
    elementType: Y,
...
const vg = ["onEntering"], yg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], wg = {
  vertical: "top",
  horizontal: "right"
}, xg = {
  vertical: "top",
  ...
  const a = ut({
    ...
    slots: O = {},
    slotProps: w = {}
  } = a, k = he(a.TransitionProps, vg), y = he(a, yg), T = Hr(), S = T.direction === "rtl", M = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: k,
    variant: x
  }), D = kg(M), V = i && !f && g, E = N.useRef(null), C = (Q, R) => {
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || z === -1) && (z = R));
  ...
  const U = (n = O.paper) != null ? n : Ng, j = (o = w.paper) != null ? o : p, B = jt({
    elementType: O.root,
  ...
  return /* @__PURE__ */ d(Eg, P({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: S ? "right" : "left"
    },
    transformOrigin: S ? wg : xg,
    slots: {
      paper: U,
      root: O.root
    },
...
const bt = "scrBook", Pg = "scrRef", Rt = "source", $g = "details", _g = "Scripture Reference", Mg = "Scripture Book", al = "Type", Ig = "Details";
function Ag(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      id: bt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? _g,
      cell: (n) => {
    ...
    },
    {
      ...
      id: $g,
      header: (e == null ? void 0 : e.detailsColumnName) ?? Ig,
      cell: (n) => n.getValue(),
      enableGrouping: !1
    }
  ];
...
function Lv({
  ...
  }, D = (E, C) => E.getIsGrouped() ? "" : F("banded-row", C % 2 === 0 ? "even" : "odd"), V = (E, C, $) => {
    ...
    !t && /* @__PURE__ */ _(
      an,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Pr, { position: "item-aligned", children: /* @__PURE__ */ d(cp, { children: T.map((E) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
), il = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(Mi.Root, { ref: r, className: F(Dg(), e), ...t }));
il.displayName = Mi.Root.displayName;
function jg({
  id: e,
  isDisabled: t = !1,
  hasError: r = !1,
...
function Vv({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [n, o] = ce(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ d(
...
function Hv({
  ...
  const a = _t(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Cc, { position: "static", id: n, children: /* @__PURE__ */ _(Oc, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ d(
      Rg,
      {
        commandHandler: t,
...
const Gv = De.Root, Bg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: F(
...
const Lg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    className: F(
...
Lg.displayName = De.Trigger.displayName;
...
const Fg = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Root,
  {
...
const Wv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    ...t,
...
)), Ug = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: F(
...
const Hg = ["children", "options"], wi = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), xi = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Gg = ["style", "script"], Wg = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Xg = /mailto:/i, Yg = /\n{2,}$/, sl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, qg = /^ *> ?/gm, Kg = /^ {2,}\n/, Jg = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, ll = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, cl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Zg = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, Qg = /^(?:\n *)*\n/, eb = /\r\n?/g, tb = /^\[\^([^\]]+)](:.*)\n/, rb = /^\[\^([^\]]+)]/, nb = /\f/g, ob = /^\s*?\[(x|\s)\]/, pl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, dl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, ul = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, wo = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, ab = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, fl = /^<!--[\s\S]*?(?:-->)/, ib = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, xo = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, sb = /^\{.*\}$/, lb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, cb = /^<([^ >]+@[^ >]+)>/, pb = /^<([^ >]+:\/[^ >]+)>/, db = /-([a-z])?/gi, ml = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, ub = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, fb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, mb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, hb = /(\[|\])/g, gb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, bb = /\t/g, vb = /^ *\| */, yb = /(^ *\||\| *$)/g, wb = / *$/, xb = /^ *:-+: *$/, kb = /^ *:-+ *$/, Eb = /^ *-+: *$/, Nb = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, Tb = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, Sb = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, Cb = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, Ob = /^\\([^0-9A-Za-z\s])/, Rb = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, Pb = /^\n+/, $b = /^([ \t]*)/, _b = /\\([^\\])/g, ki = / *\n+$/, Mb = /(?:^|\n)( *)$/, Qo = "(?:\\d+\\.)", ea = "(?:[*+-])";
function hl(e) {
  return "( *)(" + (e === 1 ? Qo : ea) + ") +";
}
...
function Ei(e, t) {
  const r = t === 1, n = r ? El : Nl, o = r ? wl : xl, a = r ? Ib : Ab;
  return { t(i, l, c) {
    const f = Mb.exec(c);
    return f && (l.o || !l._ && !l.u) ? n.exec(i = f[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const f = r ? +i[2] : void 0, m = i[0].replace(Yg, `
`).match(o);
    let v = !1;
...
const Db = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, jb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Tl = [sl, ll, cl, pl, ul, dl, fl, ml, wl, El, xl, Nl], Bb = [...Tl, /^[^\n]+(?:  \n|\n{2,})/, wo, xo];
function Lb(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function Vb(e) {
  return Eb.test(e) ? "right" : xb.test(e) ? "center" : kb.test(e) ? "left" : null;
}
function Ni(e, t, r) {
  const n = r.$;
  r.$ = !0;
...
function Fb(e, t, r) {
  r._ = !0;
  const n = Ni(e[1], t, r), o = e[2].replace(yb, "").split("|").map(Vb), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Ni(f, l, c);
    });
...
var ae;
function Wb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Lb, t.namedCodesToUnicode = t.namedCodesToUnicode ? $t({}, xi, t.namedCodesToUnicode) : xi;
  ...
  function n(p, h, ...u) {
    ...
    }(p, t.overrides), $t({}, h, b, { className: Gb(h == null ? void 0 : h.className, b.className) || void 0 }), ...u);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = gb.test(p) === !1);
    const u = m(f(h ? p : `${p.trimEnd().replace(Pb, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (O !== -1) {
        const w = function(S) {
          return S.indexOf("-") !== -1 && S.match(ib) === null && (S = S.replace(db, function(M, D) {
          ...
          return S === "style" ? M.split(/;\s?/).reduce(function(D, V) {
            ...
            return D[E.replace(/(-[a-z])/g, (C) => C[1].toUpperCase())] = V.slice(E.length + 1).trim(), D;
          }, {}) : S === "href" ? Wt(M) : (M.match(sb) && (M = M.slice(1, M.length - 1)), M === "true" || M !== "false" && M);
        }(w, k);
  ...
  const i = [], l = {}, c = { blockQuote: { t: it(sl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(qg, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: br(Kg), i: ae.HIGH, l: to, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: it(Jg), i: ae.HIGH, l: to, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: it(cl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", $t({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(ll), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: gt(Zg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: it(tb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: ro }, footnoteReference: { t: ht(rb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Wt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: ht(ob), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? dl : pl), i: ae.HIGH, l: (p, h, u) => ({ v: on(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: it(ul), i: ae.MAX, l: (p, h, u) => ({ v: on(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: br(fl), i: ae.HIGH, l: () => ({}), h: ro }, image: { t: gt(jb), i: ae.HIGH, l: (p) => ({ D: p[1], B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Wt(p.B) }) }, link: { t: ht(Db), i: ae.LOW, l: (p, h, u) => ({ v: Ub(h, p[1], u), B: Si(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Wt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: ht(pb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : ht(lb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: ht(cb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Xg.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Ei(n, 1), unorderedList: Ei(n, 2), newlineCoalescer: { t: it(Qg), i: ae.LOW, l: to, h: () => `
` }, paragraph: { t: zb, i: ae.LOW, l: eo, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: ht(ub), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: ro }, refImage: { t: gt(fb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Wt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: ht(mb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(hb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Wt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: it(ml), i: ae.HIGH, l: Fb, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
  ...
  }, h: () => " | " }, text: { t: br(Rb), i: ae.MIN, l: (p) => ({ v: p[0].replace(ab, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: gt(Nb), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: gt(Tb), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: gt(Ob), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: gt(Sb), i: ae.LOW, l: eo, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: gt(Cb), i: ae.LOW, l: eo, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: br(wo), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match($b), x = new RegExp(`^${b}`, "gm"), O = p[3].replace(x, ""), w = (k = O, Bb.some((M) => M.test(k)) ? Hb : on);
    var k;
    const y = p[1].toLowerCase(), T = Gg.indexOf(y) !== -1;
    u.N = u.N || y === "a";
...
const Xb = (e) => {
  ...
  return N.cloneElement(Wb(t, r), n);
};
function Jv({ id: e, markdown: t }) {
  return /* @__PURE__ */ d("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ d(Xb, { children: t }) });
}
const Yb = ko((e, t) => /* @__PURE__ */ _(
  we,
  {
    ref: t,
      ...
      children: [
        ...
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            ...
            /* @__PURE__ */ d("span", { className: "pr-text-xs pr-font-semibold pr-text-gray-700", children: Object.values(r).reduce((i, l) => i + l, 0) })
          ] }),
          /* @__PURE__ */ d("span", { className: "pr-text-xs pr-text-gray-500", children: "USERS" })
        ] }),
        /* @__PURE__ */ d("div", { className: "pr-mx-2 pr-h-10 pr-border-l pr-border-gray-300" }),
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ d("div", { className: "pr-flex pr-items-center", children: n.slice(0, 3).map((i) => /* @__PURE__ */ d(
            "span",
            {
...
function Kb({ id: e, versionHistory: t }) {
...
function t0({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(Kb, { versionHistory: o }),
    ...
    /* @__PURE__ */ _("div", { className: "pr-md:mt-0 pr-mt-4 pr-flex-1 pr-space-y-3", children: [
      ...
      /* @__PURE__ */ _("div", { className: "pr-flex pr-items-start pr-justify-between pr-pr-4 pr-text-xs pr-text-gray-600", children: [
        ...
        /* @__PURE__ */ d("div", { className: "pr-flex pr-w-3/4 pr-items-center pr-justify-between pr-text-xs pr-text-gray-600", children: /* @__PURE__ */ _("p", { className: "pr-flex pr-flex-col pr-justify-start", children: [
          ...
          /* @__PURE__ */ d("span", { className: "pr-font-semibold", children: i.join(", ") })
        ] }) })
      ] })
    ] })
  ] }) });
...
Zb.displayName = "CardHeader";
const Qb = W.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d(
    "h3",
    {
      ref: r,
...
const ev = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: F("pr-text-sm pr-text-muted-foreground", e), ...t }));
ev.displayName = "CardDescription";
...
), ov = W.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: F(nv({ variant: t }), e), ...r }));
ov.displayName = "Alert";
...
av.displayName = "AlertTitle";
const iv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
iv.displayName = "AlertDescription";
const sv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _(
  vr.Root,
  {
    ref: r,
    className: F(
...
sv.displayName = vr.Root.displayName;
const lv = W.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  io.Root,
  {
    className: F(
...
lv.displayName = io.Root.displayName;
function cv(e, t = "top") {
...
export {
  ov as Alert,
  iv as AlertDescription,
  av as AlertTitle,
  Rv as BookChapterControl,
  we as Button,
  Jb as Card,
  tv as CardContent,
  ...
  Yv as EnableButton,
  Yb as FilterButton,
  Zv as FilterDropdown,
  t0 as Footer,
  Dh as GridMenu,
  Rg as HamburgerMenuButton,
  ...
  Hv as Toolbar,
  Kv as UpdateButton,
  Kb as VersionHistory,
  Fg as VerticalTabs,
  Ug as VerticalTabsContent,
  zg as VerticalTabsList,
  Wv as VerticalTabsTrigger,
  sp as buttonVariants,
  $o as getSortingIcon,
  Mv as inventoryCountColumn,
  _v as inventoryItemColumn,
  Iv as inventoryStatusColumn,
  r0 as useEvent,
  n0 as useEventAsync,
  yo as usePromise
};
