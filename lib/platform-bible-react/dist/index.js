...
function sh({ currentStep: t, totalSteps: e, locale: r = "en" }) {
  const o = r || "en", n = D(() => new kn(o), [o]), i = Math.min(Math.max(t, 1), e), s = D(() => Array.from({ length: e }, (c, d) => d + 1), [e]);
      ...
      /* @__PURE__ */ a(
        "div",
        {
          className: m(
            ...
            l && "tw:bg-primary tw:text-primary-foreground",
            d && "tw:bg-muted tw:text-muted-foreground",
            !l && !d && "tw:border tw:border-muted-foreground tw:text-muted-foreground"
          ),
          children: n.format(c)
        }
      )
