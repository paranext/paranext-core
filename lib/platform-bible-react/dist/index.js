...
var Rt = (t, e, r) => ji(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Ft, Z as Fi, B, c as g, a as Bi, C as Te, P as ze, b as Ie, d as De, e as Ve, f as Le, g as pe, h as kr, i as ta, T as ee, S as He, j as re, k as ae, l as oe, D as Ge, m as vr, n as _e, o as Ne, p as Ce, u as Ui, q as _r, s as Ye, t as Re, v as Sa, w as dn, x as Ki, y as qi, z as wn, A as un, E as Gi, F as Hi, G as Yi, H as Wi, I as wa, J as ua, K as ea, L as Xi, M as Ji, N as Zi, O as Qi, Q as ts, R as Nr, U as Ya } from "./resizable-CUvCloPJ.js";
...
import { includes as Mr, Section as Z, getChaptersForBook as es, formatScrRef as ye, getSectionForBook as gr, formatRelativeDate as rs, formatReplacementString as xe, sanitizeHtml as Lr, NumberFormat as as, formatBytes as os, getCurrentLocale as ns, usfmMarkers as jr, getFormatCallerFunction as is, deepEqual as ss, isString as bo, compareScrRefs as Oa, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as cs, getLocalizeKeyForScrollGroupId as xo } from "platform-bible-utils";
import { Check as Ae, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as $a, ChevronRight as Ma, ArrowLeft as ls, ArrowRight as ds, ChevronDown as or, BoldIcon as ws, ItalicIcon as us, X as ra, AtSign as pn, Pencil as ps, Trash2 as hs, ArrowUp as hn, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as gn, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, ChevronsUpDown as fn, Star as zs, Undo as Ds, Redo as Ss, SquareX as mn, FunctionSquare as vn, SquareSigma as bn, Ban as Os, AlertCircle as Ra, CircleCheckIcon as $s, CircleXIcon as Ms, CircleHelpIcon as Rs, ArrowUpIcon as As, ArrowDownIcon as Ps, Search as Is, LoaderCircle as Vs, ScrollText as Ls, MenuIcon as js, Menu as Fs, EllipsisVertical as Bs, MoreVertical as No } from "lucide-react";
import ut, { useRef as q, useMemo as L, useState as N, useCallback as j, useEffect as Y, useLayoutEffect as Jt, createContext as Wa, useContext as xn, Component as Us, createElement as Co, Suspense as Ks, forwardRef as aa, useId as qs, Fragment as yn } from "react";
import { Dialog as he, Label as Gs, RadioGroup as Aa, ToggleGroup as kn, Slot as ir, Avatar as Xa, Select as Pt, Checkbox as Eo, Tabs as le, Menubar as me, ContextMenu as Dt, Progress as To, Slider as Rr, Switch as zo } from "radix-ui";
import { createEditor as _n, $getRoot as Pe, $createParagraphNode as Cr, $getSelection as jt, HISTORY_MERGE_TAG as Ja, ParagraphNode as Nn, TextNode as Cn, $getPreviousSelection as Hs, $isRangeSelection as ge, $caretFromPoint as Ys, $getSiblingCaret as En, $getChildCaret as Ws, $getAdjacentChildCaret as Xs, $isChildCaret as Js, $normalizeCaret as Zs, $setSelectionFromCaretRange as Qs, $getCollapsedCaretRange as tc, $getCaretInDirection as Do, $splitAtPointCaretNext as ec, $isTextPointCaret as rc, $findMatchingParent as Tn, $isElementNode as br, mergeRegister as Ee, getDOMTextNode as ac, isHTMLElement as oc, CLEAR_EDITOR_COMMAND as zn, COMMAND_PRIORITY_EDITOR as Za, shallowMergeConfig as nc, defineExtension as ne, safeCast as Qe, createState as ic, FORMAT_TEXT_COMMAND as Dn, $isNodeSelection as Sn, COMMAND_PRIORITY_LOW as On, RootNode as sc, LineBreakNode as cc, TabNode as lc, $isEditorState as dc, createCommand as wc, CLICK_COMMAND as uc, isDOMNode as pc, $getNodeFromDOMNode as hc, $createNodeSelection as gc, $setSelection as fc, $getEditor as mc, DecoratorNode as Pa, $getState as vc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as bc, $setState as xc, addClassNamesToElement as $n, $create as yc, $getNodeByKey as kc, removeClassNamesFromElement as _c, KEY_TAB_COMMAND as Nc, $isBlockElementNode as Cc, $createRangeSelection as Ec, $normalizeSelection__EXPERIMENTAL as Tc, OUTDENT_CONTENT_COMMAND as zc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Dc, COMMAND_PRIORITY_CRITICAL as Qa, $isDecoratorNode as Sc, $isParagraphNode as Oc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as $c } from "lexical";
...
import { IconX as Vc, IconCheck as oa, IconChevronDown as Lc, IconChevronUp as jc, IconSelector as Fc, IconLayoutSidebar as Bc, IconLayoutSidebarRight as Uc, IconChevronRight as Rn, IconLoader as Kc, IconAlertOctagon as qc, IconAlertTriangle as Gc, IconInfoCircle as Hc, IconCircleCheck as Yc } from "@tabler/icons-react";
...
import { useReactTable as Pn, getFilteredRowModel as Zc, getSortedRowModel as In, getPaginationRowModel as Qc, getCoreRowModel as Vn, flexRender as fr, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Va, HIDDEN_NOTE_CALLER as La, getDefaultViewOptions as al, isInsertEmbedOpOfType as Ar, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function fa({
  ...
  const C = Ft(), [k, _] = N(!1), [I, F] = N(""), [V, $] = N(""), [y, z] = N("books"), [A, S] = N(void 0), [O, W] = N(
    void 0
  ...
  const Vt = j(() => {
    ...
    (b, G) => (J) => w ? ga(b, G, J, w) : !1,
    [w]
  ), Be = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", lr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", dr = j(
    (b) => {
    ...
    (b) => {
      var Zt, tr, wr;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: J } = Ro(b.key);
      ...
      if ((y === "chapters" || y === "books" && D) && Et) {
        ...
        if (!Mt) return;
        y === "chapters" && ((wr = bt.current) == null || wr.focus());
        const _t = (() => {
          if (!I) return 1;
          const Wt = I.match(/(\d+)$/);
  ...
  return Jt(() => {
    const b = setTimeout(() => {
      if (k && y === "books" && U.current && rt.current) {
        const G = U.current, J = rt.current, Et = J.offsetTop, Zt = G.clientHeight, tr = J.clientHeight, wr = Et - Zt / 2 + tr / 2;
        G.scrollTo({
          top: Math.max(0, wr),
          behavior: "smooth"
        }), F(Bn(t.book));
          ...
          Ve,
          {
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                y === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Me(A, n) }),
                y === "verses" && O && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Me(O, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? lr : Be
                  }
                )
              ] }),
                  ...
                  D && kt && D.chapterNum && l && /* @__PURE__ */ u(tt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Po,
                      {
                        ...
                        onVerseSelect: ie,
                        setVerseRef: wt,
                        isVerseDisabled: cr(D.book, D.chapterNum),
...
function Io({
  ...
  const [k, _] = N(!1), I = l ?? d, F = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, y) => {
    ...
    /* @__PURE__ */ a(
      De,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: F(e) ? e.map(($) => /* @__PURE__ */ a(pe, { heading: $.groupHeading, children: $.options.map((y) => V(y, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(pe, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Gn ? Jt : Y, Pr = { tag: Ja };
function yl({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = bl(null, o), w = _n({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, f) {
      if (f !== null) {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = Hn && "documentMode" in document ? document.documentMode : null;
!(!Hn || !("InputEvent" in window) || $l) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Rl(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < h.length; E++) {
      const C = h[E], k = s[E] || document.createElement("div"), _ = k.style;
      ...
      const $ = we(C.height);
      _.height !== $ && (k.style.height = $, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[E] = k;
    }
...
function Pl(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = f.getNode(), x = m.getKey(), v = f.offset, E = h.getNode(), C = E.getKey(), k = h.offset, _ = t.getElementByKey(x), I = t.getElementByKey(C), F = r === null || _ !== o || v !== n || x !== r.getKey(), V = i === null || I !== s || k !== c || C !== i.getKey();
      if ((F || V) && _ !== null && I !== null) {
        const $ = function(y, z, A, S, O, W, K) {
          const M = (y._window ? y._window.document : document).createRange();
          return M.setStart(...Vo(z, A, S)), M.setEnd(...Vo(O, W, K)), M;
        }(t, f, m, _, h, E, I);
        d(), d = Rl(t, $, e);
      }
      r = m, o = _, n = v, i = E, s = I, c = k;
    });
  }
...
function Vl(t) {
  const e = Tn(t, (r) => br(r) && !r.isInline());
  return br(e) || Hr(4, t.__key), e;
}
function Ll(t) {
  const e = jt() || Hs();
  let r;
  if (ge(e)) r = Ys(e.focus, "next");
    ...
    r = r || Ws(Pe(), "previous").getFlipped().insert(Cr());
  }
...
function jl(t, e, r) {
  ...
  return rc(o) && Hr(283), o.insert(t.isInline() ? Cr().append(t) : t), Do(En(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = jt();
  if (!ge(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Tn(i, (l) => br(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Yr, ke = 0, Wr = 0, Kl = 0, Ka = 0, Br = 0;
function jo(t) {
  if (et === void 0) return;
  let e = t.n;
...
function Gl(t) {
  ...
  Wn(this), et = t, this.f &= -2, 8 & this.f && oo(this), na();
}
function rr(t, e) {
...
At.prototype.brand = Bl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ke !== 0 && Wr === 0 && e.l !== Ka && (e.l = Ka, Yr = { S: e, v: e.v, i: e.i, o: Yr });
  ...
  return et = t, Wn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Fo(this), ke++;
  const t = et;
...
ne({ build: (t, e, r) => sr(e), config: Qe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Jn() {
  const t = Pe(), e = jt(), r = Cr();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function Zn(t, e = Jn) {
  return t.registerCommand(zn, (r) => (t.update(e), !0), Za);
}
ne({ build: (t, e, r) => sr(e), config: Qe({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return fe(() => Zn(t, o.value));
} });
function Hl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ba = ic("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Qn extends Pa {
  $config() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Dn, (o) => {
  const n = jt();
  if (Sn(n) || ge(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function ti(t, e) {
  let r;
...
const qa = ne({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const no = 0, Ga = 1, ri = 2, xa = 3, Ir = 4, er = 5, ya = 6, pr = 7;
function ka(t) {
  return t.id === no;
}
function ai(t) {
...
class Jl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && lt(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const Ql = ne({ config: Qe({ setOptions: Bo, updateOptions: Bo }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [sc, Cn, cc, lc, Nn] }), Uo = Symbol.for("@lexical/extension/LexicalBuilder");
function Ko() {
}
function td(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Uo];
    return r && (r.PACKAGE_VERSION !== _a && lt(292, r.PACKAGE_VERSION, _a), r instanceof ar || lt(293)), r;
  }
  static fromEditor(e) {
...
const ed = /* @__PURE__ */ new Set(), qo = ne({ build(t, e, r) {
  const o = r.getDependency(qa).output, n = xr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => fe(() => {
...
ne({ dependencies: [qa, qo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return Ee(t.registerCommand(rd, (s) => {
    ...
    return !0;
  }, Za), t.registerCommand(uc, (s) => {
    if (pc(s.target)) {
      const c = hc(s.target);
      if (od(c)) return function(d, l = !1) {
        const w = jt(), p = d.isSelected(), f = d.getKey();
        let h;
        l && Sn(w) ? h = w : (h = gc(), fc(h)), p ? h.delete(f) : h.add(f);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
ne({ build: (t, e) => sr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Qe({ $getParentEditor: function() {
  const t = mc();
...
ne({ build: (t, e, r) => sr(e), config: Qe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return fe(() => {
...
ne({ build: (t, e, r) => sr(e), config: Qe({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(m)) {
                const x = m.anchor;
                let v = x.getNode(), E = 0, C = 0;
                if (Ia(v) && l >= 0 && w >= 0 && (E = l, C = l + w, m.setTextNodeRange(v, E, v, C)), E === C && p === "" || (m.insertRawText(p), v = x.getNode()), Ia(v)) {
                  E = f, C = f + h;
                  const k = v.getTextContentSize();
                  E = E > k ? k : E, C = C > k ? k : C, m.setTextNodeRange(v, E, v, C);
                }
...
ne({ build: (t, e, r) => sr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Zu({
  ...
  const [i, s] = N(Ad), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), f = q(null);
  Y(() => {
    let v = !0;
    const E = f.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : wo(v) && (v.preventDefault(), v.stopPropagation(), Qt(i) && h());
        },
        onKeyDown: (v) => {
...
function Xo({
  ...
  }, [t.date, r]), v = L(() => t.user, [t.user]), E = L(
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), h()) : wo(_) && (_.preventDefault(), _.stopPropagation(), Qt(w) && m());
              },
              onKeyDown: (_) => {
...
function jd({
  ...
  const [$, y] = N(Jo), [z, A] = N(), [S, O] = N(), W = o, [K, M] = N(!1), [Q, mt] = N(!1), [ct, Bt] = N(!1), [bt, St] = N(!1), [U, rt] = N(!1), [ot, nt] = N(_), [it, It] = N(!1), vt = q(void 0), [Ut, Kt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Ot = L(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !k) {
      Kt(/* @__PURE__ */ new Map());
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ...
              v !== !1 && (!Q || Qt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    wo(T) && (T.preventDefault(), T.stopPropagation(), (Qt($) || z !== void 0 && z !== S) && gt());
                  },
                  onKeyDown: (T) => {
...
function ip({
  ...
  const [E, C] = N(/* @__PURE__ */ new Set()), [k, _] = N(), [I, F] = N(), V = j(
    async (M) => {
      const Q = await i(M);
  ...
  const $ = r.filter(
    ...
    (M) => {
      C((Q) => new Set(Q).add(M.id)), _(M.id), x == null || x(M.id);
    },
    [x]
  ), A = j(
    (M) => {
      ...
      }), _(M), x == null || x(Q ? void 0 : M);
    },
    [E, x]
  ), { listboxRef: S, activeId: O, handleKeyDown: W } = Ui({
    options: y,
    onOptionSelect: z
  }), K = j(
    (M) => {
      M.key === "Escape" ? (k && E.has(k) && (C((Q) => {
        const mt = new Set(Q);
...
function Xt({
  ...
  return /* @__PURE__ */ u(
    Pt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Pt.ItemIndicator, { children: /* @__PURE__ */ a(oa, { className: "tw:pointer-events-none" }) }) }),
...
function dp({
  ...
  const [i, s] = N("accept"), c = r ?? i, d = qs(), l = L(
    () => Zo(Lr(t.rejectedText ?? "")),
    [t.rejectedText]
  ), w = L(
    () => Zo(Lr(t.acceptedText ?? "")),
    [t.acceptedText]
  ), p = L(() => Lr(t.contents), [t.contents]);
  if (!(t.conflictType === Kd))
    return /* @__PURE__ */ a(
      "div",
      {
        className: Ca,
  ...
  const h = r !== void 0, m = (v) => {
    const E = v === "reject" ? "reject" : "accept";
    h || s(E), o == null || o(E);
  }, x = c === "reject" ? t.rejectedResultText : t.resultText;
  return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:gap-2", children: [
      ...
      /* @__PURE__ */ u(We, { value: c, onValueChange: m, disabled: !n, children: [
        /* @__PURE__ */ a(
          Je,
          {
    ...
    !!t.acceptedText && /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      /* @__PURE__ */ a("span", { className: "tw:font-medium", children: (e == null ? void 0 : e["%conflictNote_acceptedLabel%"]) ?? "Accepted" }),
      /* @__PURE__ */ a(
        "div",
        {
          className: Ca,
    ...
    !!t.rejectedText && /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      /* @__PURE__ */ a("span", { className: "tw:font-medium", children: (e == null ? void 0 : e["%conflictNote_rejectedLabel%"]) ?? "Rejected" }),
      /* @__PURE__ */ a(
        "div",
        {
          className: Ca,
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      ...
      /* @__PURE__ */ a("div", { "aria-live": "polite", "aria-labelledby": d, children: x ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: x }) : (
        ...
        /* @__PURE__ */ a("p", { className: "tw:italic tw:text-muted-foreground", children: (e == null ? void 0 : e["%conflictNote_resultEmpty%"]) ?? "The verse will be empty." })
      ) })
    ] })
  ] });
}
...
function Jd({
  ...
  var F;
  const [w, p] = N([]), [f, h] = N([]), [m, x] = N({}), [v, E] = N({}), C = L(() => e ?? [], [e]), k = Pn({
    data: C,
    columns: t,
    getCoreRowModel: Vn(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(te, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Sa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? I = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, k),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map(($) => /* @__PURE__ */ a(te, { children: fr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    V.id
    ...
    /* @__PURE__ */ u(ia, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : fr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function gp({
  ...
  return /* @__PURE__ */ u(ze, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(De, { id: i, className: g("tw:min-w-80 tw:max-w-96", n), children: [
...
function fp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(_e, { children: [
    ...
    /* @__PURE__ */ a(Ce, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(dn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][f],
...
const nw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(tt, { children: [
...
function iw({
  ...
  const m = (v) => {
    ...
    var E, C, k, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(_e, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
const sw = (t, e) => t === "f" ? /* @__PURE__ */ u(tt, { children: [
  /* @__PURE__ */ a(vn, {}),
  " ",
...
function lw({
  ...
  return /* @__PURE__ */ u(_e, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
      /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a("p", { children: cw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ce, { style: { zIndex: wn }, children: [
...
function xp({
  ...
  const [m, x] = N("generated"), [v, E] = N("generated"), [C, k] = N("*"), [_, I] = N("*"), [F, V] = N("f"), [$, y] = N(!1), [z, A] = N(!0), [S, O] = N(!1), W = q(!1), K = q(""), [M, Q] = N(!1), [mt, ct] = N(), [Bt, bt] = N(), [St, U] = N(), [rt, ot] = N(), nt = q(null), it = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Ar("note", H)) {
      ...
      let xt = "custom";
      ht === Va ? xt = "generated" : ht === La ? xt = "hidden" : ht && (k(ht), I(ht)), x(xt), E(xt), V(((at = H.insert.note) == null ? void 0 : at.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const vt = j(
    (P, H, st = !1) => {
      ...
      if (at && Ar("note", at)) {
        if (at.insert.note) {
          let gt;
          P === "custom" ? gt = H : P === "generated" ? gt = Va : gt = La, at.insert.note.caller = gt;
        }
  ...
  const Ot = () => {
    ...
    if (H && Ar("note", H)) {
      ...
      F !== "x" && P === "x" ? gt == null || gt.forEach((Ct) => hw(Ct)) : F === "x" && P !== "x" && (gt == null || gt.forEach((Ct) => gw(Ct))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, $t = (P) => {
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(tt, { children: mw(t.marker, c, o, l) })
      }
    )
  ] });
}
function kp({
  ...
  const w = d ?? is(r, void 0), p = (C, k) => {
    l == null || l(C, k, n);
  }, f = i ? r.findIndex((C) => C === i) : -1, [h, m] = N(f), x = (C, k, _) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
  ...
  return Y(() => {
    var C;
    h >= 0 && h < E.current.length && ((C = E.current[h]) == null || C.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function yw({
  ...
  return /* @__PURE__ */ u(ia, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(uo, { stickyHeader: !0, children: /* @__PURE__ */ u(ce, { children: [
    ...
    /* @__PURE__ */ a(sa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(te, { className: o, children: xw(c.text) })
        ]
      },
...
const kw = (t) => {
...
}, ca = (t, e, r) => /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
  /* @__PURE__ */ u(
    ae,
    {
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Dp = Object.freeze([
...
function Sp({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), C = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), _ = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = de(r, "%webView_inventory_no_results%"), [V, $] = N(!1), [y, z] = N("all"), [A, S] = N(""), [O, W] = N([]), K = L(() => {
    const U = t ?? [];
  ...
  }, [V, K]), Q = L(() => M.length === 0 ? [] : Cw(M, y, A), [M, y, A]), mt = L(() => {
    var ot, nt;
    if (!V) return d;
...
const yi = aa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Vs, { size: 35, className: g("tw:animate-spin", t), ...e, ref: r }));
...
function $p({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = L(
    () => t.filter((O) => !r || O.type === r).filter((O) => zw(O, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = Tw(h), E = L(
    () => Array.from(new Set(t.map((O) => O.bestLanguageName))).map((O) => ({
      label: O,
      value: O
    })),
    [t]
  ), C = p.length === 0 && f.length === 0 && h.length === 0, k = be(n, "%resourcePicker_title%"), _ = be(n, "%resourcePicker_search_placeholder%"), I = be(n, "%resourcePicker_language_filter_any%"), F = be(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = be(n, "%resourcePicker_section_installed%"), $ = be(
    n,
    "%resourcePicker_section_available_to_download%"
  ), y = be(n, "%resourcePicker_no_results%"), z = be(n, "%resourcePicker_showing_count%"), A = L(() => {
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      C && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: y }),
      !C && !e && /* @__PURE__ */ a(ia, { children: /* @__PURE__ */ u(sa, { children: [
        /* @__PURE__ */ a(Ta, { label: F, resources: p }),
        /* @__PURE__ */ a(Ta, { label: V, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          Ta,
          {
            label: $,
...
const Dw = "16rem", Sw = "3rem", ki = ut.createContext(void 0);
function da() {
...
function Ow({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), f = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = Ft() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Vw({
  ...
  const c = t ? ir.Root : "button", { state: d } = da(), l = /* @__PURE__ */ a(
    c,
    {
...
const $e = "scrBook", jw = "scrRef", qe = "source", Fw = "details", Bw = "Scripture Reference", Uw = "Scripture Book", _i = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Hp({
  ...
  const [l, w] = N([]), [p, f] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), x = L(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = x.find((S) => cn(S) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, x, c, E]);
  const C = n ?? Uw, k = i ?? _i, _ = [
  ...
  }, V = (y, z) => y.getIsGrouped() ? "" : g("banded-row", z % 2 === 0 ? "even" : "odd"), $ = (y, z, A) => {
    ...
    !e && /* @__PURE__ */ u(
      We,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ze, { position: "item-aligned", children: /* @__PURE__ */ a(Fd, { children: _.map((y) => /* @__PURE__ */ a(Xt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ia, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: E.getHeaderGroups().map((y) => /* @__PURE__ */ a(ce, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
      ...
      /* @__PURE__ */ a(sa, { children: E.getRowModel().rows.map((y, z) => {
        const A = Ft();
        return /* @__PURE__ */ a(
          ce,
          {
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a($a, {})),
                          " ",
...
function Hw({
  ...
  }, [x, v] = N(!1), [E, C] = N(""), k = q(void 0), _ = q(!1), I = L(
    () => Ni(t),
    [t]
  ), F = L(() => {
    if (!E.trim()) {
                ...
                Object.values(Z).map((S, O) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(yn, { children: [
                      ...
                      O < Object.values(Z).length - 1 && /* @__PURE__ */ a(un, {})
                    ] }, S);
                })
              ] })
            ]
...
function Wp({
  ...
  const _ = zt(
  ...
  ] }), rt = e ? St.filter((R) => e.includes(R.value)) : St, ot = m ?? ha, nt = w ?? ot, it = p ?? ot, It = () => {
    ...
    [r, n, m, i]
  ), at = rt.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? cs(nt, it, {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, T] = N(!1), [wt, pt] = N(void 0), [kt, Fe] = N(void 0), [Oe, cr] = N(void 0), [Be, lr] = N(void 0), [dr, zr] = N([]), Dr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
      selectedBookIds: Dr ? dr : n,
      onChangeSelectedBookIds: Dr ? zr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Zt = l === "dropdown" && wt === "range", tr = Zt ? cr : P, Mt = Zt ? lr : h ? H : It, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Wt, Ue] = N(null), [Sr, Mi] = N(null), [Or, Ri] = N(null), Ai = 200, [Pi, Ii] = N(!1);
  Y(() => {
    if (!Or || typeof ResizeObserver > "u") return;
    const R = new ResizeObserver(([X]) => {
      Ii(X.contentRect.width < Ai);
    });
    return R.observe(Or), () => R.disconnect();
  }, [Or]);
  const go = j(
    (R) => {
      Fe(R), cr(nt), lr(it), zr(n), T(!1), pt(R);
    },
    [nt, it, n]
  ), fo = j(() => {
    kt !== void 0 && (kt === "range" ? (Oe && (f == null || f(Oe)), Be && (h == null || h(Be))) : kt === "selectedBooks" && i(dr), st(kt), pt(void 0), Fe(void 0));
  }, [
    kt,
    Oe,
    Be,
  ...
  }, []), vo = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(_e, { open: Ct, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          Ce,
          {
            ...
            children: /* @__PURE__ */ u(wa, { container: Or, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: ur, id: Vi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
                        ...
                        children: /* @__PURE__ */ a(
                          fa,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(tt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ye(m ?? ha, "id") }),
                              /* @__PURE__ */ a(or, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Kn,
        {
          ...
          children: rt.map(({ value: R, label: X, scrRefSuffix: Lt, id: ur }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ba, { className: "tw:me-2", value: R, id: ur }),
    ...
    l === "radio" && t === "range" && _t,
    l === "dropdown" && yt && /* @__PURE__ */ a(ja, { open: wt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Mi,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(wa, { container: Sr, children: [
          ...
          /* @__PURE__ */ u($o, { children: [
            ...
            /* @__PURE__ */ a(B, { onClick: fo, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(ja, { open: wt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Ue,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(wa, { container: Wt, children: [
          /* @__PURE__ */ a(qr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Gr, { children: K }) }),
          _t,
          /* @__PURE__ */ u($o, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => $r(!1), children: ct }),
            /* @__PURE__ */ a(B, { ref: Se, onClick: fo, children: mt })
          ] })
        ] })
      }
    ) })
...
function Xp({
  ...
  return /* @__PURE__ */ u(
    We,
    {
      ...
      children: [
        /* @__PURE__ */ a(Je, { size: n, className: g("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          Xe,
          {
        ...
        /* @__PURE__ */ a(
          Ze,
          {
            ...
            style: { zIndex: ea },
            children: t.map((l) => /* @__PURE__ */ a(Xt, { value: `${l}`, children: c[xo(l)] }, `${l}`))
          }
        )
      ]
    }
...
function Ha({
  ...
  return /* @__PURE__ */ u(_e, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ce, { align: "start", style: { zIndex: ea }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(yn, { children: [
      /* @__PURE__ */ a(dn, { children: /* @__PURE__ */ a(ee, { children: Ti(e.groups, e.items, d, t) }) }),
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), hr(s, [f, h]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), hr(c, [f, h]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), hr(d, [f, h]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ea },
          children: /* @__PURE__ */ a(ee, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function nh({
  ...
  const l = du(
    ...
    var E, C, k, _, I, F;
    const v = x !== m ? ((C = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : C[x]) ?? ((_ = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : _.en) : void 0;
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(_e, { children: [
              /* @__PURE__ */ a(Ne, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
...
function kh({
  ...
  return /* @__PURE__ */ u(
    Dt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Dt.ItemIndicator, { children: /* @__PURE__ */ a(oa, {}) }) }),
        e
      ]
    }
  );
