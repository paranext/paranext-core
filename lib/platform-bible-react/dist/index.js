...
import { Slot as He, Dialog as fe, Popover as $r, Label as ps, RadioGroup as Ba, Tooltip as dr, ToggleGroup as In, Separator as gs, Avatar as io, DropdownMenu as Dt, Select as Vt, Checkbox as Po, Tabs as de, Menubar as _e, ContextMenu as $t, Progress as Lo, Slider as Ur, Switch as jo } from "radix-ui";
import { cva as Ne } from "class-variance-authority";
import { IconX as hs, IconCheck as or, IconSearch as fs, IconChevronRight as so, IconChevronDown as ms, IconChevronUp as vs, IconSelector as bs, IconLayoutSidebar as xs, IconLayoutSidebarRight as ys, IconLoader as ks, IconAlertOctagon as _s, IconAlertTriangle as Ns, IconInfoCircle as Cs, IconCircleCheck as Es } from "@tabler/icons-react";
import { Canon as ut } from "@sillsdev/scripture";
import { includes as Kr, Section as Q, getChaptersForBook as Ts, formatScrRef as De, getSectionForBook as Sr, formatRelativeDate as zs, formatReplacementString as Se, sanitizeHtml as Ss, DEFAULT_SCROLL_GROUP_LOCALIZED_STRINGS as Is, getLocalizeKeyForScrollGroupId as rt, NumberFormat as Ds, formatBytes as $s, getCurrentLocale as Os, usfmMarkers as Jr, getFormatCallerFunction as Rs, deepEqual as As, isString as Vo, compareScrRefs as Ga, scrRefToBBBCCCVVV as ya, defaultScrRef as ka, formatScrRefRange as Ms } from "platform-bible-utils";
import { Check as Ke, Clock as Bo, ChevronsLeft as Go, ChevronsRight as Fo, ChevronLeft as Fa, ChevronRight as Ua, ArrowLeft as Ps, ArrowRight as Dn, ChevronDown as er, BoldIcon as Ls, ItalicIcon as js, X as pa, AtSign as $n, Pencil as Vs, Trash2 as Bs, ArrowUp as On, MoreHorizontal as Gs, MailOpen as Fs, Mail as Us, ChevronUp as Ks, FilterIcon as qs, ArrowLeftIcon as Hs, ChevronLeftIcon as Ws, ChevronRightIcon as Ys, ArrowRightIcon as Xs, ChevronsUpDown as lo, Filter as Rn, Copy as An, User as Js, Link as Zs, CircleHelp as Qs, Star as tl, Undo as el, Redo as rl, SquareX as Mn, FunctionSquare as Pn, SquareSigma as Ln, Ban as al, AlertCircle as Ka, CircleCheckIcon as ol, CircleXIcon as nl, CircleHelpIcon as il, ArrowUpIcon as sl, ArrowDownIcon as ll, Search as cl, LoaderCircle as dl, ScrollText as wl, MenuIcon as ul, Menu as pl, EllipsisVertical as gl, MoreVertical as Uo } from "lucide-react";
import it, { forwardRef as Mr, useRef as F, useMemo as V, useState as z, useCallback as j, useEffect as X, useLayoutEffect as Zt, createContext as ga, useContext as co, Component as hl, createElement as Ko, Suspense as fl, Fragment as wo } from "react";
import { createEditor as jn, $getRoot as Re, $createParagraphNode as vr, $getSelection as Ut, HISTORY_MERGE_TAG as uo, ParagraphNode as Vn, TextNode as Bn, $isTokenOrSegmented as ml, $getCharacterOffsets as vl, $cloneWithPropertiesEphemeral as bl, $getPreviousSelection as xl, $isRangeSelection as me, $caretFromPoint as yl, $getSiblingCaret as Gn, $getChildCaret as kl, $getAdjacentChildCaret as _l, $isChildCaret as Nl, $normalizeCaret as Cl, $setSelectionFromCaretRange as El, $getCollapsedCaretRange as Tl, $getCaretInDirection as qo, $splitAtPointCaretNext as zl, $isTextPointCaret as Sl, $findMatchingParent as Fn, $isElementNode as $e, mergeRegister as Ae, getDOMTextNode as Il, isHTMLElement as Un, CLEAR_EDITOR_COMMAND as Kn, COMMAND_PRIORITY_EDITOR as po, shallowMergeConfig as Dl, defineExtension as ne, safeCast as nr, createState as $l, FORMAT_TEXT_COMMAND as qn, $isNodeSelection as Hn, COMMAND_PRIORITY_LOW as Wn, RootNode as Ol, LineBreakNode as Rl, TabNode as Al, $isEditorState as Ml, createCommand as Pl, CLICK_COMMAND as Ll, isDOMNode as jl, $getNodeFromDOMNode as Vl, $createNodeSelection as Bl, $setSelection as Gl, $getEditor as Fl, DecoratorNode as qa, $getState as Ul, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Kl, $setState as ql, addClassNamesToElement as Yn, $create as Hl, $getNodeByKey as Wl, removeClassNamesFromElement as Yl, KEY_TAB_COMMAND as Xl, $isBlockElementNode as ra, $createRangeSelection as Jl, $normalizeSelection__EXPERIMENTAL as Zl, OUTDENT_CONTENT_COMMAND as Ql, INDENT_CONTENT_COMMAND as Wo, INSERT_TAB_COMMAND as tc, COMMAND_PRIORITY_CRITICAL as go, $isDecoratorNode as ec, $isParagraphNode as rc, $isTextNode as aa, SELECTION_CHANGE_COMMAND as Xn, getRegisteredNode as ac, isDocumentFragment as Yo, isDOMDocumentNode as oc, ArtificialNode__DO_NOT_USE as Jn, $createLineBreakNode as Zn, $isRootOrShadowRoot as nc, isBlockDomNode as Xo, isInlineDomNode as Jo, $insertNodes as ic } from "lexical";
...
import { GENERATOR_NOTE_CALLER as Ha, HIDDEN_NOTE_CALLER as Wa, getDefaultViewOptions as vc, isInsertEmbedOpOfType as qr, Editorial as bc } from "@eten-tech-foundation/platform-editor";
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ u(
          Ce,
          {
            ...
            disabled: c,
            className: f(i, c && "tw:cursor-not-allowed tw:opacity-50"),
            children: [
              s && /* @__PURE__ */ a(
                Ke,
                {
...
const pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, qc = pi ? Zt : X, Hr = { tag: uo };
...
function pd(t, e, r) {
  ...
  return Sl(o) && ia(283), o.insert(t.isInline() ? vr().append(t) : t), qo(Gn(t.getLatest(), "next"), e.direction);
}
function gd(t) {
  const e = Ut();
  if (!me(e)) return !1;
...
let sa, Oe = 0, la = 0, md = 0, eo = 0, Qr = 0;
function nn(t) {
  if (at === void 0) return;
  let e = t.n;
...
const _o = 0, ao = 1, _i = 2, Sa = 3, Wr = 4, lr = 5, Ia = 6, Tr = 7;
function Da(t) {
  return t.id === _o;
}
function Ni(t) {
...
class Nd {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(l, d, c) {
      return Object.assign(l, { id: Wr, initResult: d, registerState: c });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== Wr && wt(307, String(r.id), String(lr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Wr;
    }(e) || wt(313, String(e.id), String(Wr)), e.initResult;
  }
  getInitPeer(e) {
...
function $d(t, e, r = Ci) {
  return Ae(t.registerCommand(Xl, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => ra(h) && h.canIndent()).length > 0) return !0;
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (me(m)) {
                ...
                if (aa(v) && c >= 0 && w >= 0 && (I = c, N = c + w, m.setTextNodeRange(v, I, v, N)), I === N && g === "" || (m.insertRawText(g), v = x.getNode()), aa(v)) {
                  I = h, N = h + p;
...
function Ai(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (l == null || !nc(l)) && (l != null && ra(l) || o);
...
function Ew({
  ...
  const mt = j(
    ...
    async (O) => {
      const pt = oe(y) ? da(y) : void 0, ht = O.status ? O.assignedUser : S ?? O.assignedUser, _t = await g({
        ...O,
        contents: pt,
        assignedUser: ht
      });
...
function Mw({
  ...
  return d ? k = Array.from({ length: 10 }).map((b, S) => `skeleton-row-${S}`).map((b) => /* @__PURE__ */ a(Ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Ue, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(oo, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((E = T.getRowModel().rows) == null ? void 0 : E.length) > 0 ? k = T.getRowModel().rows.map((D) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(fa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Io, { stickyHeader: i, children: T.getHeaderGroups().map((D) => /* @__PURE__ */ a(Ie, { children: D.headers.map((y) => /* @__PURE__ */ a(wa, { className: "tw:p-0", children: y.isPlaceholder ? void 0 : Ir(y.column.columnDef.header, y.getContext()) }, y.id)) }, D.id)) }),
      ...
      return /* @__PURE__ */ u(be, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          B,
          {
            ...
            children: /* @__PURE__ */ a(pa, { className: "tw:h-3 tw:w-3" })
          }
        ),
    ...
    return /* @__PURE__ */ u("div", { id: s, className: f("tw:relative", { "tw:w-full": o }, n), children: [
      ...
      t && /* @__PURE__ */ u(
        B,
        {
          ...
          children: [
            /* @__PURE__ */ a(pa, { className: "tw:h-4 tw:w-4" }),
...
const Ki = Mr(({ className: t, ...e }, r) => /* @__PURE__ */ a(dl, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Tg({
  ...
  return /* @__PURE__ */ u(tt, { children: [
    /* @__PURE__ */ a(oa, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(na, { children: T }) }),
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(fa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Io, { children: I.getHeaderGroups().map((b) => /* @__PURE__ */ a(Ie, { children: b.headers.filter((S) => S.column.columnDef.header).map((S) => (
        ...
        /* @__PURE__ */ a(wa, { colSpan: S.colSpan, className: "tw:sticky top-0", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
...
function Ug({
  ...
  ), kt = ot.find((P) => P.value === "selectedBooks"), mt = ot.find((P) => P.value === "range"), [Tt, O] = z(!1), [pt, ht] = z(void 0), [_t, Ye] = z(void 0), [Be, kr] = z(void 0), [Xe, _r] = z(void 0), [Nr, jr] = z([]), Vr = c === "dropdown" && pt === "selectedBooks", _ = /* @__PURE__ */ a(
    Gu,
    {
      availableBookInfo: o,
      selectedBookIds: Vr ? Nr : n,
  ...
  const [Jt, Je] = z(null), [Br, rs] = z(null), [Gr, as] = z(null), os = 200, [ns, is] = z(!1);
  X(() => {
    if (!Gr || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([J]) => {
      is(J.contentRect.width < os);
    });
    return P.observe(Gr), () => P.disconnect();
  }, [Gr]);
  const Oo = j(
    (P) => {
      Ye(P), kr(lt), _r(ct), jr(n), O(!1), ht(P);
    },
    [lt, ct, n]
  ), Ro = j(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      c === "dropdown" ? /* @__PURE__ */ u(xe, { open: Tt, onOpenChange: O, children: [
        ...
        /* @__PURE__ */ a(
          ke,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(_a, { container: Gr, children: [
    ...
    c === "radio" && t === "range" && Nt,
    c === "dropdown" && kt && /* @__PURE__ */ a(Xa, { open: pt === "selectedBooks", onOpenChange: Fr, children: /* @__PURE__ */ a(
      Ja,
      {
        ref: rs,
        onCloseAutoFocus: Ao,
        onEscapeKeyDown: (P) => {
          Br != null && Br.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(_a, { container: Br, children: [
          /* @__PURE__ */ a(oa, { className: "tw:pe-8", children: /* @__PURE__ */ a(na, { children: M }) }),
          _,
          /* @__PURE__ */ u(Zo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Fr(!1), children: Et }),
            /* @__PURE__ */ a(B, { onClick: Ro, children: gt })
          ] })
        ] })
      }
    ) }),
    c === "dropdown" && mt && /* @__PURE__ */ a(Xa, { open: pt === "range", onOpenChange: Fr, children: /* @__PURE__ */ a(
      Ja,
      {
        ref: Je,
        onCloseAutoFocus: Ao,
        ...
        children: /* @__PURE__ */ u(_a, { container: Jt, children: [
          /* @__PURE__ */ a(oa, { className: "tw:pe-8", children: /* @__PURE__ */ a(na, { children: q }) }),
          Nt,
          /* @__PURE__ */ u(Zo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Fr(!1), children: Et }),
