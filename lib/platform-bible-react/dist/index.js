...
import { formatScrRef as Ot, getChaptersForBook as Nr, NumberFormat as kr, formatBytes as Cr, deepEqual as ye, substring as Sr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as E } from "platform-bible-utils";
...
const ke = I.Trigger, nn = I.Group, Pr = I.Portal, Or = I.Sub, Zo = I.RadioGroup;
...
const ze = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), Qr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function ts({
  ...
  const o = $(), [i, w] = D(""), [s, p] = D(t.book), [u, m] = D(t.chapterNum ?? 0), [f, g] = D(t.book), [h, v] = D(!1), [x, y] = D(h), N = Z(void 0), C = Z(void 0), B = Z(void 0), j = tt(
    ...
    ea.forEach((k) => {
      const z = k.exec(i);
      if (z) {
        const [P, G = void 0, F = void 0] = z.slice(1), It = aa(P);
  ...
  return ct(() => {
    ...
    const k = setTimeout(() => {
      if (x && C.current && B.current && !i) {
        const P = B.current.offsetTop - ta;
      ...
      $t,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((k, z) => {
          ...
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: Qr[k] }),
...
const Oa = "16rem", Aa = "3rem", kn = c.createContext(void 0);
function ae() {
...
const Cn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(kn.Provider, { value: C, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (J === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(xr, {})),
                          " ",
...
const Dn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Pr, { children: /* @__PURE__ */ r(an, { children: Dn(
      t,
      e,
      Vn(t, s.id),
      a
