...
import { includes as cn, Section as X, getChaptersForBook as Ws, formatScrRef as xe, getSectionForBook as We, formatRelativeDate as Js, formatReplacementString as ve, sanitizeHtml as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, usfmMarkers as fn, getFormatCallerFunction as ni, deepEqual as ri, isString as zr, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as et } from "platform-bible-utils";
...
const nl = $t.Root, rl = $t.Portal, Ko = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Overlay,
  {
    ref: n,
    className: f(
...
ol.displayName = $t.Description.displayName;
...
te.displayName = Nt.Group.displayName;
...
Ht.displayName = Nt.Item.displayName;
...
const Wo = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), ye = Object.fromEntries(
  Wo.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function xr(t, e, n) {
...
const re = Ie.Root, ue = Ie.Trigger, sl = Ie.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ht();
...
function ar(t, e, n) {
  return `${t} ${ye[t]}${e ? ` ${vr(t, e)} ${Me(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function il({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(re, { open: w, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(te, { heading: i, children: t.map((m) => /* @__PURE__ */ d(
      Ht,
      {
        onSelect: () => p(m),
...
function pp({
  ...
  const c = ht(), [p, m] = R(!1), [h, u] = R(""), [g, x] = R(""), [v, y] = R("books"), [k, C] = R(void 0), [_, B] = R(!1), L = Y(void 0), S = Y(void 0), P = Y(void 0), E = Y(void 0), D = Y({}), A = U(
    (N) => {
      e(N), l && l(N);
    },
    [e, l]
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: z, isDigit: K } = qr(N.key);
      if (v === "chapters") {
        if (N.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        ...
        tt !== J && (N.preventDefault(), N.stopPropagation(), u(ar(q, a, tt)), setTimeout(() => {
    ...
    const { isLetter: z, isDigit: K } = qr(N.key);
    (z || K) && (N.preventDefault(), x((q) => q + N.key), S.current.focus(), B(!1));
  }, []);
  return Qt(() => {
    const N = setTimeout(() => {
    ...
    /* @__PURE__ */ r(Yt, { id: w, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      ee,
      {
        ref: L,
        onKeyDown: Ft,
        ...
        children: [
          ...
          !_ && /* @__PURE__ */ d(ne, { ref: P, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !M && Object.entries(W).map(([N, z]) => {
                if (z.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(te, { heading: fe(N), children: z.map((K) => /* @__PURE__ */ r(
                      Jo,
                      {
                        bookId: K,
                        onSelect: (q) => _t(q),
              ...
              M && Gt(M.book) > 1 && /* @__PURE__ */ d(lt, { children: [
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko.Root, { ref: n, className: f("pr-twp", dl(), t), ...e }));
ft.displayName = ko.Root.displayName;
...
function sr({
  ...
  const [k, C] = R(!1), _ = w ?? l, B = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], L = (S, P) => {
...
function fp({
  ...
  const p = Vn(c, "%webView_bookSelector_currentBook%"), m = Vn(c, "%webView_bookSelector_choose%"), h = Vn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = R(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), t(v);
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = ta ? Qt : H, pn = { tag: hr };
function gl({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: w } = t, c = fl(null, o), p = _o({ editable: t.editable, html: w, namespace: a, nodes: i, onError: (m) => s(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Lt() !== null || x !== null && x === m.getRootElement()) && g.select();
          }
        }, pn);
...
const Nr = {
  ...
  mark: "",
  markOverlap: ""
}, Ct = _e.Provider, Dt = _e.Root, Mt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  _e.Trigger,
  {
    ref: o,
...
Mt.displayName = _e.Trigger.displayName;
const Et = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(_e.Portal, { children: /* @__PURE__ */ r(
  _e.Content,
  {
    ref: o,
    sideOffset: e,
...
Et.displayName = _e.Content.displayName;
const kr = [
  Vi,
  Co,
  Eo,
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = Xt(), n = j(() => t(e), [e, t]), [o, a] = R(() => n.initialValueFn()), i = Y(o);
    return _l(() => {
...
function Tl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !oi(e) && o !== null) {
    ...
    if (c || p) {
      const [m, h] = ai(t), u = l.is(w), g = e.is(s ? w : l), x = e.is(s ? l : w);
      let v, y = 0;
...
function Dl(t) {
  const e = To(t, (n) => ie(n) && !n.isInline());
...
function Ml(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = To(i, (c) => ie(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Pl(t) {
  ...
  ra(this), Q = t, this.f &= -2, 8 & this.f && _r(this), Sn();
}
function De(t, e) {
...
vt.prototype.brand = Ol, vt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, oa(this), Wr(this), le++;
  const t = Q;
  return Q = this, Pl.bind(this, t);
...
function aa() {
  const t = we(), e = Lt(), n = Tn();
  t.clear(), t.append(n), e !== null && n.select(), ke(e) && (e.format = 0);
}
function sa(t, e = aa) {
  return t.registerCommand(Ro, (n) => (t.update(e), !0), So);
}
qt({ build: (t, e, n) => Dn(e), config: sn({ $onClear: aa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return de(() => sa(t, o.value));
} });
function $l(t) {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [ia], register: (t, e, n) => t.registerCommand(Do, (o) => {
  const a = Lt();
  if (Mo(a) || ke(a)) for (const i of a.getNodes()) Ll(i) && i.toggleFormat(o);
  return !1;
}, Oo) });
function la(t, e) {
  let n;
...
const lr = qt({ build: (t) => la(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function Vl(t) {
  return function(e) {
    return e.id === wr;
  }(t) || rt(305, String(t.id), String(wr)), Object.assign(t, { id: ca });
}
...
class zl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== un && rt(307, String(n.id), String(Se)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Fn;
    }(e) || rt(314, String(e.id), String(Fn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= He;
    }(e) || rt(316, String(e.id), String(He)), e;
  }
...
const Bl = qt({ config: sn({ setOptions: Jr, updateOptions: Jr }), init: ({ $initialEditorState: t = Fl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class Qe {
  ...
  static maybeFromEditor(e) {
    const n = e[Zr];
    return n && (n.PACKAGE_VERSION !== Gn && rt(292, n.PACKAGE_VERSION, Gn), n instanceof Qe || rt(293)), n;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Kn(i) || rt(300, s, a || "[unknown]"), Kn(l = i) || rt(304, String(l.id), String(Cr)), i = Object.assign(l, { id: wr }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: m } = p;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of $l(m)) {
        if (typeof h != "function") {
          const u = o.get(h.replace);
          u && rt(302, m.name, h.replace.name, u.extension.name), o.set(h.replace, p);
        }
        n.add(h);
      }
      if (m.html) {
...
const Gl = /* @__PURE__ */ new Set(), to = qt({ build(t, e, n) {
  const o = n.getDependency(lr).output, a = nn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = la(() => {
  }, () => de(() => {
    const s = i.peek(), { watchedNodeKeys: l } = a.value;
    let w, c = !1;
    o.value.read(() => {
      if (Lt()) for (const [p, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(p);
          continue;
        }
        const h = ki(p), u = h && h.isSelected() || !1;
        c = c || u !== (!!s && s.has(p)), u && (w = w || /* @__PURE__ */ new Set(), w.add(p));
      }
...
qt({ dependencies: [lr, to], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  ...
  return ce(t.registerCommand(mi, (s) => {
    if (fi(s.target)) {
      const l = hi(s.target);
      if (ql(l)) return function(w, c = !1) {
        const p = Lt(), m = w.isSelected(), h = w.getKey();
        let u;
        c && Mo(p) ? u = p : (u = gi(), bi(u)), m ? u.delete(h) : u.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
    ...
    Il(() => {
      ...
      for (const [p, m] of s.entries()) if (m === "destroyed") c.delete(p), w = !0;
      else {
        const h = c.get(p), u = t.getElementByKey(p);
        h ? h.domNode.value = u : (w = !0, c.set(p, { domNode: nn(u), selectedSignal: o(p) }));
      }
...
function Hl(t, e, n = ua) {
  return ce(t.registerCommand(Ci, (o) => {
    const a = Lt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => bn(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, w = s.focus, c = w.isBefore(l) ? w : l, p = c.getNode(), m = Dl(p);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Ei();
...
qt({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ua, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: i } = n.getOutput();
  return de(() => {
    if (!o.value) return Hl(t, a, i);
  });
} });
const Yl = qt({ name: "@lexical/react/ReactProvider" });
function Xl() {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (vn(v) && c >= 0 && p >= 0 && (y = c, k = c + p, g.setTextNodeRange(v, y, v, k)), y === k && m === "" || (g.insertRawText(m), v = x.getNode()), vn(v)) {
                  y = h, k = h + u;
...
qt({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => de(() => n.getOutput().disabled.value ? void 0 : fa(t)) });
function Zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Er = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
  ...
  return function(n, o) {
    ...
    return Er(() => n.registerDecoratorListener((s) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = r(o, { onError: (h) => n._onError(h), children: r(us, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && s.push(Bi(p, m, c));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
const ow = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function aw({ onClear: t }) {
  const [e] = Xt();
  return ow(() => sa(e, t), [e, t]), null;
}
const ha = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : H;
function sw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: k, tabIndex: C, "data-testid": _, ...B }, L) {
  const [S, P] = R(t.isEditable()), E = U((A) => {
  ...
  return ha(() => (P(t.isEditable()), t.registerEditableListener((A) => {
    P(A);
  })), [t]), r("div", { "aria-activedescendant": S ? e : void 0, "aria-autocomplete": S ? n : "none", "aria-controls": S ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": S && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": S ? m : void 0, "aria-readonly": !S || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: S, "data-testid": _, id: x, ref: D, role: v, spellCheck: y, style: k, tabIndex: C, ...B });
}
const iw = an(sw);
function no(t) {
  return t.getEditorState().read(ma(t.isComposing()));
...
function mw({
  ...
  const [e] = Xt(), [n, o] = R(e), [a, i] = R("paragraph"), [s, l] = uw(), w = () => {
  };
...
function gw() {
  const { activeEditor: t } = ba(), [e, n] = R([]), o = U((a) => {
    if (ke(a) || Ki(a)) {
      const i = [];
      ro.forEach(({ format: s }) => {
...
function ya(t, e, n, o = null) {
  ...
  const l = ie(s) ? s.getChildren() : [], w = Oi(t, s.getType());
  let c;
  ...
  if (a && !i) {
    if ((Ii(p) || Kr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(s, p);
...
function ka(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const u = (l == null || !Pi(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...ka(m[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), Gr(t) && (h = kw(t, h, u ? () => {
    const g = new Po();
    return n.push(g), g;
  ...
  }(t) && (s = s.concat($o())) : ie(l) && l.append(...h), s;
}
function kw(t, e, n) {
...
function hp({
  ...
  const [a, i] = R(Cw), [s, l] = R(void 0), [w, c] = R(!1), p = Y(void 0), m = Y(null);
  H(() => {
    let y = !0;
    const k = m.current;
    if (!k) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Sr(y) && (y.preventDefault(), y.stopPropagation(), Pt(a) && h());
        },
        onKeyDown: (y) => {
...
const gp = Object.freeze([
  ...
  const a = Y(null), [i, s] = R(void 0), [l, w] = R(void 0), c = U(
    (u) => {
      s(u);
    ...
    if (u.isContentEditable || Ew.includes(g)) return !0;
    ...
    (u) => {
      var S;
      const g = u.target, x = (P) => P ? document.getElementById(P) : void 0, v = x(l), y = x(i);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let D;
          u.key === "ArrowDown" ? D = Math.min(E + 1, P.length - 1) : D = Math.max(E - 1, 0), D !== E && (u.preventDefault(), u.stopPropagation(), (S = P[D]) == null || S.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          B = Math.min(_ + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          B = Math.max(_ - 1, 0), u.preventDefault();
          break;
        case "Home":
...
}), Ge = ot.Trigger, Da = ot.Group, Pw = ot.Portal, $w = ot.Sub, Lw = ot.RadioGroup;
...
me.displayName = ot.Content.displayName;
...
const Zt = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    ot.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Zt.displayName = ot.CheckboxItem.displayName;
...
Ue.displayName = ot.Separator.displayName;
...
function oo({
  ...
  const u = U(
    (_) => {
      _ && _.stopPropagation(), c(!1), m(void 0), s == null || s(!1);
    },
    [s]
  ), g = U(
    async (_) => {
    ...
    [t.user]
  ), k = j(() => Zs(t.contents), [t.contents]), C = j(() => {
    if (o && l)
      return /* @__PURE__ */ d(lt, { children: [
        /* @__PURE__ */ d(
          kn,
          {
            onClick: (_) => {
              _.stopPropagation(), c(!0), m(_w(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), u()) : Sr(_) && (_.preventDefault(), _.stopPropagation(), Pt(p) && g());
              },
              onKeyDown: (_) => {
                Rr(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
...
function jw({
  ...
  const [S, P] = R(ao), [E, D] = R(
    void 0
  ), A = o, [V, O] = R(!1), [I, W] = R(!1), [M, Z] = R(!1), [_t, Tt] = R(!1), [Ot, mt] = R(!1), [pt, G] = R(_), [nt, ut] = R(!1), it = Y(void 0), [xt, fe] = R(/* @__PURE__ */ new Map());
  H(() => {
    let T = !0;
    return (async () => {
    ...
    let T = !0;
    if (!o) {
      Tt(!1), fe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Rt = y ? await y(w) : !1;
      T && Tt(Rt);
    })(), () => {
      T = !1;
    };
  }, [o, w, y]);
  const zt = j(() => e.filter((T) => !T.deleted), [e]);
  H(() => {
    let T = !0;
    if (!o || !C) {
      fe(/* @__PURE__ */ new Map());
  ...
  const Wt = j(() => zt[0], [zt]), Re = Y(null), ae = Y(void 0), Ft = U(() => {
    var T;
    (T = ae.current) == null || T.call(ae), P(ao);
  }, []), $ = U(() => {
    const T = !pt;
  ...
  }, [i, n]), K = j(() => zt.slice(1), [zt]), q = j(() => K.length ?? 0, [K.length]), J = j(() => q > 0, [q]), ct = j(() => V || q <= 2 ? K : K.slice(-2), [K, q, V]), tt = j(() => V || q <= 2 ? 0 : q - 2, [q, V]), It = j(
    () => q === 1 ? N.singleReply : ve(N.multipleReplies, { count: q }),
    [q, N]
  ), yt = j(
    () => tt === 1 ? N.singleReply : ve(N.multipleReplies, { count: tt }),
    [tt, N]
  );
  H(() => {
    !o && I && J && W(!1);
  ...
  const At = U(
    async (T) => {
      ...
      gt && await m({ threadId: w, contents: gt }) && Ft();
    },
    [
      Ft,
      S,
    ...
    async (T) => {
      const gt = Pt(S) ? Nn(S) : void 0, Rt = await m({
        ...T,
        contents: gt,
        assignedUser: E ?? T.assignedUser
      });
      return Rt && gt && Ft(), Rt && E !== void 0 && D(void 0), Rt;
    },
    [Ft, S, m, E]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(Ta, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            z && /* @__PURE__ */ r(Pe, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: z }),
            /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
          ...
          /* @__PURE__ */ r(
            oo,
            {
              ...
              handleDeleteComment: u,
              onEditingChange: W,
              canEditOrDelete: (!I && xt.get(Wt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ d(lt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    V ? /* @__PURE__ */ r(go, {}) : /* @__PURE__ */ r(ze, {})
                  ] })
                ]
              }
            ),
            ct.map((T) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              oo,
              {
                comment: T,
                localizedStrings: n,
                ...
                handleDeleteComment: u,
                onEditingChange: W,
                canEditOrDelete: (!I && xt.get(T.id)) ?? !1
              }
            ) }, T.id)),
            v !== !1 && (!I || Pt(S)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Sr(T) && (T.preventDefault(), T.stopPropagation(), (Pt(S) || E !== void 0) && At());
                },
                onKeyDown: (T) => {
                  Rr(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    yn,
...
function vp({
  ...
  const [y, k] = R(/* @__PURE__ */ new Set()), [C, _] = R();
  H(() => {
  ...
  const B = n.filter(
    ...
    [y, x]
  ), { listboxRef: E, activeId: D, handleKeyDown: A } = Rw({
    options: L,
    onOptionSelect: S
  }), V = U(
    (O) => {
...
const Le = wt.Root, Fw = wt.Group, Ve = wt.Value, Bw = pe(
...
), Ce = b.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const i = ht();
  return /* @__PURE__ */ d(
    wt.Trigger,
    {
...
Ce.displayName = wt.Trigger.displayName;
...
Aa.displayName = wt.ScrollUpButton.displayName;
...
Pa.displayName = wt.ScrollDownButton.displayName;
const Ee = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const i = ht();
...
Ee.displayName = wt.Content.displayName;
...
const St = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  wt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(wt.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            /* @__PURE__ */ r(Ce, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ve, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Ee, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(St, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Zw({
  ...
  var L;
  const [p, m] = R([]), [h, u] = R([]), [g, x] = R({}), [v, y] = R({}), k = j(() => e ?? [], [e]), C = zo({
    data: k,
    columns: t,
    getCoreRowModel: Bo(),
  ...
  let B;
  return w ? B = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Jt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = C.getRowModel().rows) == null ? void 0 : L.length) > 0 ? B = C.getRowModel().rows.map((S) => /* @__PURE__ */ r(
    Jt,
    {
      onClick: () => s(S, C),
      "data-state": S.getIsSelected() && "selected",
      children: S.getVisibleCells().map((P) => /* @__PURE__ */ r(Ne, { children: Je(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    S.id
  )) : B = /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(zw, { table: C }),
    /* @__PURE__ */ d(Mn, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(Jt, { children: S.headers.map((P) => /* @__PURE__ */ r(on, { className: "tw-p-0", children: P.isPlaceholder ? void 0 : Je(P.column.columnDef.header, P.getContext()) }, P.id)) }, S.id)) }),
...
function Np({
  ...
  return /* @__PURE__ */ d(re, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Yt, { id: i, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function kp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Te, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Da, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Zt,
        {
          checked: o[p][h],
        ...
        Lw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Ia, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function rc({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(re, { open: P, onOpenChange: p ?? k, children: [
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ee, { children: [
      ...
      /* @__PURE__ */ d(ne, { children: [
        ...
        /* @__PURE__ */ r(te, { children: B.map((D) => /* @__PURE__ */ d(
          Ht,
          {
            value: D.label,
            onSelect: C,
...
function lc({
  ...
  const i = Y(null), s = Y(null), l = Y(!1), [w, c] = R(t), [p, m] = R(n), [h, u] = R(!1);
  H(() => {
    c(t);
  }, [t]), H(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    l.current = !1, u(v), v || (w !== "custom" || p ? (e(w), o(p)) : (c(t), m(n)));
  }, x = (v) => {
    var y, k, C, _;
  ...
  return /* @__PURE__ */ d(Te, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
...
function Tp({
  ...
  const p = Y(null), m = Y(null), h = Y(null), [u, g] = R("generated"), [x, v] = R("*"), [y, k] = R("f"), [C, _] = R(!1), [B, L] = R(!0), [S, P] = R(!1), E = Y(!1), D = Y(""), [A, V] = R(!1), [O, I] = R(), [W, M] = R(), [Z, _t] = R(), [Tt, Ot] = R(), mt = Y(null), pt = j(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (N && dn("note", N)) {
      ...
      let J = "custom";
      q === tr ? J = "generated" : q === er ? J = "hidden" : q && v(q), g(J), k(((K = N.insert.note) == null ? void 0 : K.style) ?? "f"), $ = setTimeout(() => {
        var ct;
  ...
  const nt = U(
    ($, N, z = !1) => {
      ...
      if (K && dn("note", K)) {
        if (K.insert.note) {
          let tt;
          $ === "custom" ? tt = N : $ === "generated" ? tt = tr : tt = er, K.insert.note.caller = tt;
        }
    ...
    nt(u, x, !0), o();
  }, [u, x, o, nt]), it = Y({ book: a.book, chapterNum: a.chapterNum });
  H(() => {
  ...
  const xt = () => {
    var N;
    const $ = (N = m.current) == null ? void 0 : N.getElementsByClassName("editor-input")[0];
    ...
    if (N && dn("note", N)) {
      ...
      y !== "x" && $ === "x" ? tt == null || tt.forEach((It) => hc(It)) : y === "x" && $ !== "x" && (tt == null || tt.forEach((It) => gc(It))), (ct = p.current) == null || ct.applyUpdate([N, { delete: 1 }]);
    }
  }, Re = ($) => {
    ...
    if (N && dn("note", N)) {
      ...
      if (It || _(!1), _(
        It === "x" ? !!(yt != null && yt.every((At) => {
          var T, gt;
          if (!((T = At.attributes) != null && T.char)) return !0;
      ...
      L(JSON.stringify(N) === D.current), nt(u, x);
    } else
      _(!1), L(!0);
  }, Ft = U(() => {
  ...
  return H(() => {
    ...
    var z;
    const $ = ((z = m.current) == null ? void 0 : z.querySelector(".editor-input")) ?? void 0, N = (K) => {
      !A && $ && document.activeElement === $ && K.key === l ? (K.preventDefault(), Ft()) : A && K.key === "Escape" && (K.preventDefault(), V(!1));
    };
    return document.addEventListener("keydown", N), () => {
      document.removeEventListener("keydown", N);
    };
  }, [A, Ft, l]), /* @__PURE__ */ d(lt, { children: [
    /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ d(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(sc, { editorRef: p, children: /* @__PURE__ */ r(
              Ji,
              {
                options: pt,
                onStateChange: ($) => Re($),
...
function Sp({
  ...
  const p = w ?? ni(n, void 0), m = (k, C) => {
    c == null || c(k, C, a);
  }, h = i ? n.findIndex((k) => k === i) : -1, [u, g] = R(h), x = (k, C, _) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
        ...
        "ul",
        {
          ...
          children: n.map((k, C) => {
            ...
            return /* @__PURE__ */ d(lt, { children: [
              ...
              C < n.length - 1 && o === "vertical" && /* @__PURE__ */ r($e, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
    ...
    /* @__PURE__ */ r(In, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      Jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { className: o, children: Nc(l.text) })
        ]
      },
...
function Lp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), k = Kt(n, "%webView_inventory_scope_chapter%"), C = Kt(n, "%webView_inventory_scope_verse%"), _ = Kt(n, "%webView_inventory_filter_text%"), B = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Kt(n, "%webView_inventory_no_results%"), [S, P] = R(!1), [E, D] = R("all"), [A, V] = R(""), [O, I] = R([]), W = j(() => {
    const G = t ?? [];
  ...
  }, [S, W]), Z = j(() => M.length === 0 ? [] : Tc(M, E, A), [M, E, A]), _t = j(() => {
    var ut, it;
    if (!S) return w;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Le,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(Ce, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(Le, { onValueChange: (G) => Ot(G), defaultValue: s, children: [
        /* @__PURE__ */ r(Ce, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Ee, { children: [
...
const Va = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(t), m = e ?? c, h = b.useCallback(
      (C) => {
        const _ = typeof C == "function" ? C(m) : C;
        n ? n(_) : p(_);
      },
      [n, m]
    ), u = b.useCallback(() => h((C) => !C), [h]), g = m ? "expanded" : "collapsed", y = ht() === "ltr" ? s : s === "primary" ? "secondary" : "primary", k = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    ja,
    {
      ...
      children: /* @__PURE__ */ d(Fa, { children: [
        /* @__PURE__ */ d(dr, { children: [
          ...
          /* @__PURE__ */ r(ur, { children: /* @__PURE__ */ r(Ba, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ka, { children: /* @__PURE__ */ r(
            Ga,
            {
              onClick: () => c(h),
              isActive: m(h),
...
const se = "scrBook", qc = "scrRef", be = "source", Hc = "details", Yc = "Scripture Reference", Xc = "Scripture Book", Ua = "Type", Wc = "Details";
function Jc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === se ? xe(a.start) : void 0;
      },
...
function jp({
  ...
  const [c, p] = R([]), [m, h] = R([{ id: se, desc: !1 }]), [u, g] = R({}), x = j(
  ...
  H(() => {
    if (l) {
      ...
      if (D.length === 1) {
        const A = x.find((V) => wo(V) === D[0]) || void 0;
        A && l(A);
      }
    }
  }, [u, x, l, y]);
  const k = a ?? Xc, C = i ?? Ua, _ = [
  ...
  }, S = (E, D) => E.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), P = (E, D, A) => {
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ce, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ve, {}) }),
          /* @__PURE__ */ r(Ee, { position: "item-aligned", children: /* @__PURE__ */ r(Fw, { children: _.map((E) => /* @__PURE__ */ r(St, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Jt, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ d(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ r(Oe, {}) : /* @__PURE__ */ r(Wn, {})),
                          " ",
...
function td({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, y] = R(!1), [k, C] = R(""), _ = Y(void 0), B = Y(!1);
  ...
  const L = j(() => dt.allBookIds.filter(
    ...
    P(I, B.current), B.current = !1;
  }, D = (I, W) => {
    I.preventDefault(), P(W, I.shiftKey);
  }, A = U(
    (I) => {
      const W = Ar(L, I).map((M) => M);
      n(
        qa(L, I, e) ? e.filter((M) => !W.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, L]
  ), V = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            ee,
            {
              shouldFilter: !1,
              onKeyDown: (I) => {
                I.key === "Enter" && (B.current = I.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ke,
                  ...
                  Object.values(X).map((I, W) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(po, { children: [
                        ...
                        W < Object.values(X).length - 1 && /* @__PURE__ */ r(Ho, {})
                      ] }, I);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Hn ? Hn : co
      ).map((I) => /* @__PURE__ */ r(Pe, { className: "hover:tw-bg-secondary", variant: "secondary", children: Me(I, a) }, I)),
      e.length > Hn && /* @__PURE__ */ r(
        Pe,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - co} ${m}`
        }
      )
    ] })
  ] });
...
function Bp({
  ...
  return /* @__PURE__ */ d(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ce, { size: a, className: f("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Ve,
          {
...
function mr({
  ...
  return /* @__PURE__ */ d(Te, { variant: i, children: [
    /* @__PURE__ */ r(Ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Ks, {}) }) }),
    /* @__PURE__ */ r(me, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(po, { children: [
...
const od = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    at.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(at.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
function id({
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ r(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(nd, { children: [
      /* @__PURE__ */ r(ts, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        rs,
        {
          className: "tw-z-[250]",
  ...
  return /* @__PURE__ */ d("div", { id: w, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      Le,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Ce, { children: /* @__PURE__ */ r(Ve, {}) }),
          /* @__PURE__ */ r(
            Ee,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(St, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
...
const eu = st.Root, nu = st.Trigger, ru = st.Group, ou = st.Portal, au = st.Sub, su = st.RadioGroup, fd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  st.SubTrigger,
  {
    ref: a,
    className: f(
...
const vd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  st.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(st.ItemIndicator, { children: /* @__PURE__ */ r(Ut, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
const iu = Vt.Trigger, Cd = Vt.Portal, lu = Vt.Close, ls = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Overlay,
  {
    ref: n,
...
ls.displayName = Vt.Overlay.displayName;
...
Sd.displayName = Vt.Title.displayName;
...
Dd.displayName = Vt.Description.displayName;
