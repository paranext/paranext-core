...
import { c as x, g as Ae, a as Vr, C as tr, L as Kn, t as ks, u as tn, T as Pt, b as kt, d as _t, e as Nt, f as Hn, A as ba, D as Be, h as Ee, i as Fe, j as cr, k as Ge, B as tt, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Xe, r as Re, p as Ts, q as qn, P as lr, s as Or, v as dr, w as wr, y as Oa, z as Da, E as Eo, F as ur, G as Ma, H as zt, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as Gn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Ss, Z as Rs, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as kr, a3 as Ro, a4 as Oo, a5 as ya, a6 as Do, a7 as Wn, a8 as Os, a9 as Ds, aa as Ms, ab as wo, ac as Yn, ad as Ia, ae as Is, af as Zn, ag as zs, ah as Ps, ai as As, aj as en, ak as $s, al as Vs, am as Ls, an as Xn, ao as Jn, ap as Mo, aq as Bs, ar as Qn, as as Ka, at as rn, au as Ha, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Ys, aE as Io, aF as zo, aG as Zs, aH as Xs } from "./resizable-CiXzUcYJ.js";
import { aI as xf, aJ as yf, aK as kf, aL as _f, aM as Nf, aN as Cf, aO as Ef, aP as Tf, aQ as Sf, aR as Rf, aS as Of, aT as Df, aU as Mf, aV as If, aW as zf, aX as Pf, aY as Af, aZ as $f, a_ as Vf, a$ as Lf, b0 as Bf, b1 as Ff, b2 as jf, b3 as Uf, b4 as Kf, b5 as Hf, b6 as qf, b7 as Gf, b8 as Wf, b9 as Yf, ba as Zf, bb as Xf, bc as Jf, bd as Qf, be as tm, bf as em, bg as rm, bh as am, bi as om, bj as nm, bk as im, bl as sm, bm as cm } from "./resizable-CiXzUcYJ.js";
...
import Xt, { useRef as A, useMemo as I, createContext as Gr, useContext as za, useEffect as Y, useState as N, useCallback as V, useId as _a, useImperativeHandle as Kc, useLayoutEffect as Jt, Fragment as Wr, Component as Hc, createElement as dn, Suspense as qc, forwardRef as Ao, memo as li } from "react";
...
import { Avatar as Bo, Select as Qt, Checkbox as hn, Slot as Zr, Tabs as ve, Menubar as Oe, ContextMenu as Ut, Progress as gn, Slider as oa, Switch as fn } from "radix-ui";
...
function pd({
  ...
  Di(), Y(() => {
    ...
    if (!z) return;
    const _ = (Z) => !!Z && Z.scrollWidth > Z.clientWidth, ot = () => {
      Hn() !== "pointer" && (L || _(h.current) || _(d.current)) && E(!0);
    }, D = () => E(!1);
...
function md({
  ...
  const [h, m] = N(!1), [v, y] = N(!1), g = _a(), T = A(!1), k = w !== void 0, E = k ? w : h, C = n === "" ? "" : ae(n, gd), P = ae(s, fd), L = (O) => {
...
function Ya({
  ...
  const L = Re(), j = ud(), [M, R] = N(!1), [O, G] = N(""), [W, z] = N(""), [_, ot] = N("books"), [D, H] = N(void 0), [Z, B] = N(
    void 0
  ...
  const U = V(() => {
    ...
    (b) => {
      const q = Z ?? (f == null ? void 0 : f.book), it = rt ?? (f == null ? void 0 : f.chapterNum);
      !q || !it || (Rt({
        book: q,
        chapterNum: it,
        verseNum: b
  ...
  const { otLong: ke, ntLong: rr, dcLong: ar, extraLong: Ue } = {
    ...
    (b) => {
      ...
      if (!(!!q && !!((Xo = Dt.current) != null && Xo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (b.key === "Tab") {
        const Lt = Dt.current ? Td(Dt.current) : [];
        if (Lt.length === 0) {
      ...
      const { isLetter: Bt, isDigit: qt } = mn(b.key);
      ...
      if (b.shiftKey || _ === "books" && q !== Et.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const Tt = (() => {
        const Lt = _ === "books" && f && Ot && f.chapterNum ? { bookId: f.book, chapterNum: f.chapterNum } : void 0, we = _ === "verses" ? { bookId: Z, chapterNum: rt } : Lt;
        if (we) {
      ...
      _ === "books" && Kt(!0), Tt.takeFocus && ((Jo = Dt.current) == null || Jo.focus());
      const re = Cd({
        current: Tt.current,
        key: b.key,
        max: Tt.max,
    ...
    const { isLetter: q, isDigit: it } = mn(b.key);
  ...
  Jt(() => {
    ...
    if (_ === "verses" && Z && rt !== void 0) {
      const b = Z === t.book && rt === t.chapterNum, q = b ? t.verseNum : 1;
      G(
        pa(Z, rt, q)
      ), setTimeout(() => {
        if (Ht.current)
            ...
            children: [
                ...
                /* @__PURE__ */ u(kt, { children: [
                  /* @__PURE__ */ a(_t, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Jr,
                      children: L === "ltr" ? /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Qs, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
              ...
              !st && /* @__PURE__ */ u(ur, { ref: Ht, children: [
                _ === "books" && /* @__PURE__ */ u(mt, { children: [
                  !f && Object.entries(Me).map(([b, q]) => {
                    if (q.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Xe, { heading: ze(b), children: q.map((it) => /* @__PURE__ */ a(
                          Si,
                          {
                            bookId: it,
                            onSelect: (Bt) => K(Bt),
                  ...
                  f && $ && /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ u(
                    tr,
                    {
                      value: hd,
                      onSelect: U,
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        children: /* @__PURE__ */ u(wr, { children: [
          ...
          /* @__PURE__ */ a(ur, { children: L(e) ? e.map((M) => /* @__PURE__ */ a(Xe, { heading: M.groupHeading, children: M.options.map((R) => j(R, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(Xe, { children: e.map((M) => j(M)) }) })
        ] })
      }
    )
  ] });
...
function bh({
  ...
  const w = Za(l, "%webView_bookSelector_currentBook%"), p = Za(l, "%webView_bookSelector_choose%"), h = Za(l, "%webView_bookSelector_chooseBooks%"), [m, v] = N(
    "current book"
    /* CurrentBook */
  ), y = (g) => {
    v(g), t(g);
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dd = zi ? Jt : Y, sa = { tag: $o };
...
const Id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Hd(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), m = jd(t, e);
    var v, y;
    ...
    w.read(() => {
      ...
      if ((L || j) && C !== null && P !== null) {
        const M = function(R, O, G, W, z, _, ot) {
          ...
          return D.setStart(...kn(O, G, W)), D.setEnd(...kn(z, _, ot)), D;
        }(t, h, v, C, m, T, P);
        d(), d = Hd(t, M, e);
      }
...
function or(t, e) {
  Zt.call(this, void 0), this.x = t, this.s = void 0, this.g = ga - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function rw(t, e) {
  return new or(t, e);
}
...
Zt.prototype.brand = Qd, Zt.prototype.h = function() {
  return !0;
...
const dw = pe({ config: pr({ setOptions: En, updateOptions: En }), init: ({ $initialEditorState: t = lw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Nr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      eo(s) || bt(300, i, n || "[unknown]"), eo(c = s) || bt(304, String(c.id), String(Ko)), s = Object.assign(c, { id: _o }), o.state = s;
...
const uw = /* @__PURE__ */ new Set(), Rn = pe({ build(t, e, r) {
  const o = r.getDependency(ko).output, n = Hr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ji(() => {
    ...
    o.value.read(() => {
      if (oe()) for (const [w, p] of c.entries()) {
        ...
        const h = Ml(w), m = h && h.isSelected() || !1;
...
pe({ dependencies: [ko, Rn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  ...
  return Le(t.registerCommand(pw, (i) => {
    ...
    if (_l(i.target)) {
      ...
      if (gw(c)) return function(d, l = !1) {
        ...
        let m;
        l && bi(w) ? m = w : (m = Cl(), El(m)), p ? m.delete(h) : m.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  ...
  return Le(t.registerCommand(zl, (o) => {
    ...
    const s = function(i) {
      ...
      if (p.canIndent()) {
        const h = p.getKey();
        let m = Al();
        if (m.anchor.set(h, 0, "element"), m.focus.set(h, 0, "element"), m = $l(m), m.anchor.is(l)) return !0;
      }
      return !1;
...
const mw = pe({ name: "@lexical/react/ReactProvider" });
function vw() {
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Nw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    qo(() => Le(Hl(n), Wi(n)), [n]);
  }(o), u(mt, { children: [t, a(Cw, { content: e }), a(_w, { editor: o, ErrorBoundary: r })] });
}
...
const Tw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Mw(t, e) {
  ...
  return u(mt, { children: [a(Ow, { editor: n, ...o, ref: e }), r != null && a(Iw, { editor: n, content: r })] });
}
...
function $w({
  ...
  const [e] = De(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = Aw(), d = () => {
  };
...
function Lw() {
  const { activeEditor: t } = Xi(), [e, r] = N([]), o = V((n) => {
    if (Te(n) || Wl(n)) {
      const s = [];
      Mn.forEach(({ format: i }) => {
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Md, { initialConfig: l, children: /* @__PURE__ */ u(Pt, { children: [
          /* @__PURE__ */ a(
            Fw,
            {
              placeholder: n,
...
const Kw = "verseText", xh = Object.freeze([
...
function yh({
  ...
  const [s, i] = N(qw), [c, d] = N(n), [l, w] = N(!1), p = A(void 0), h = A(null);
  Y(() => {
    let g = !0;
    const T = h.current;
    if (!T) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (g) => {
          g.key === "Escape" ? (g.preventDefault(), g.stopPropagation(), r()) : Wo(g) && (g.preventDefault(), g.stopPropagation(), se(s) && m());
        },
        onKeyDown: (g) => {
...
function Pn({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Zw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Xw, { className: "tw:text-xs tw:font-medium", children: j }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          v && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (z) => {
                z.key === "Escape" ? (z.preventDefault(), z.stopPropagation(), E()) : Wo(z) && (z.preventDefault(), z.stopPropagation(), se(h) && C());
              },
              onKeyDown: (z) => {
        ...
        G && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(nc, {}) }) }),
...
const Jw = {
  ...
  var gr;
  const [ot, D] = N({}), H = z ?? ot, Z = H.editorState ?? Jw, B = H.assignedUser, rt = _ !== void 0, ct = A(H);
  ct.current = H;
  const st = V(
    (S) => {
      const nt = { ...ct.current, ...S };
      ct.current = nt, rt || D(nt), _ == null || _(l, zn(nt) ? void 0 : nt);
    },
    [rt, _, l]
  ), Q = V(
    (S, nt) => {
  ...
  const U = I(() => f[0], [f]), X = A(null), K = A(void 0), at = V(() => {
    var S;
  ...
  const Ue = V(
    ...
    async (S) => {
      const nt = se(Z) ? Sa(Z) : void 0, dt = S.status ? S.assignedUser : B ?? S.assignedUser, Ot = await h({
        ...S,
        contents: nt,
        assignedUser: dt
      });
  ...
  const _e = !Et || !g || g.length === 0 || !g.includes(c), hr = !se(Z) && (B === void 0 || B === wt), Xr = /* @__PURE__ */ a(
    Pn,
    {
      comment: U,
      localizedStrings: o,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              tt,
              {
                ...
                children: Mt ? /* @__PURE__ */ a(ic, {}) : /* @__PURE__ */ a(sc, {})
              }
            ),
            G === void 0 ? (
          ...
          n && /* @__PURE__ */ u(mt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    Ct ? /* @__PURE__ */ a(ti, {}) : /* @__PURE__ */ a(sr, {})
                  ] })
                ]
              }
            ),
            ...
            T !== !1 && (!J || se(Z)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  Wo(S) && (S.preventDefault(), S.stopPropagation(), (se(Z) || B !== void 0 && B !== wt) && Ue());
                },
                onKeyDown: (S) => {
                ...
                children: /* @__PURE__ */ a(
                  Ta,
                  {
                    ...
                    actions: /* @__PURE__ */ u(mt, { children: [
                      B !== void 0 && (se(Z) || B !== wt) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                        ue(
                          "%comment_assigning_to%",
                          o,
...
function eu({
  ...
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", G = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), W = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : G, z = () => {
    ...
    const H = v === D.value, Z = `${l}-${D.value}`, B = _(D);
    return (
...
const iu = li(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: m, showResolveCheck: v } = nu({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
      ...
      children: G.map((B) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: B.type === "Conflict" ? /* @__PURE__ */ a(iu, { ...rt, conflictResolution: T }) : /* @__PURE__ */ a(is, { ...rt })
          },
          B.id
        );
      })
...
const yu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(mt, { children: [
...
function ku({
  ...
  return /* @__PURE__ */ u(Be, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(kt, { children: [
      /* @__PURE__ */ a(_t, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: yu(t, o, e) }) }) }),
...
const _u = (t, e) => t === "f" ? /* @__PURE__ */ u(mt, { children: [
  /* @__PURE__ */ a(ii, {}),
  " ",
...
function Cu({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Pt, { children: /* @__PURE__ */ u(kt, { children: [
      /* @__PURE__ */ a(_t, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: _u(t, r) }) }) }),
      /* @__PURE__ */ a(Nt, { children: /* @__PURE__ */ a("p", { children: Nu(t, r) }) })
    ] }) }),
...
function Bh({
  ...
  const [y, g] = N("generated"), [T, k] = N("generated"), [E, C] = N("*"), [P, L] = N("*"), [j, M] = N("f"), [R, O] = N(!1), [G, W] = N(!0), [z, _] = N(!1), ot = A(!1), D = A(""), [H, Z] = N(!1), B = A(void 0), rt = A(void 0), ct = A({
  ...
  const At = V(() => {
    var U, X, K;
    const f = (U = m.current) == null ? void 0 : U.querySelector(".editor-input"), $ = f == null ? void 0 : f.querySelector("span.note"), J = (K = (X = m.current) == null ? void 0 : X.ownerDocument.getSelection()) == null ? void 0 : K.anchorNode;
    return !!$ && !!J && $.contains(J);
  }, []);
  Y(() => {
    var X, K;
    ...
    if (U && Ir("note", U)) {
      const at = (X = U.insert.note) == null ? void 0 : X.caller;
      let lt = "custom";
  ...
  const ne = V(
    (f = !1) => {
      ...
      $ && Ir("note", $) && (r == null || r([$]), f && l && s && ((X = l.current) == null || X.replaceEmbedUpdate(s, [$])));
    },
    [s, r, p, l]
  ), Dt = V(
    (f, $) => {
      var X, K, at;
      const J = (K = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : K.at(0);
  ...
  const be = () => {
    ...
    if ($ && Ir("note", $)) {
      ...
      const lt = (K = (X = $.insert.note) == null ? void 0 : X.contents) == null ? void 0 : K.ops;
      j !== "x" && f === "x" ? lt == null || lt.forEach((ft) => Mu(ft)) : j === "x" && f !== "x" && (lt == null || lt.forEach((ft) => Iu(ft))), (at = h.current) == null || at.applyUpdate([$, { delete: 1 }]);
    }
  }, ce = (f) => {
    ...
    (f) => {
      ...
      if ($ && Ir("note", $)) {
        ...
        const lt = (X = $.insert.note) == null ? void 0 : X.style, ft = (at = (K = $.insert.note) == null ? void 0 : K.contents) == null ? void 0 : at.ops;
        if (lt || O(!1), O(
    ...
    Kt.length && f && f.rangeCount > 0 && (B.current = f.getRangeAt(0).cloneRange(), rt.current = void 0, ct.current.getBoundingClientRect(), Z(!0));
  }, [Kt]), he = A(() => {
  }), te = V(
    (f, $, J) => {
      ...
      Ps({
        ...
        clearSessionIfCurrent: (K) => en(gt, K),
        ...
        onShowError: (K) => {
          (!$c(K) || K.code !== Vc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Lc(K)}`
          );
        }
      });
    },
    ...
    (f) => {
      ...
      As(f, $, {
        ...
        commitTyped: (U) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedMarker(U);
        },
        commitTypedAndReopen: (U) => {
          var X;
          (X = h.current) == null || X.commitTypedMarker(U, { trailingSpace: !1 }), $t();
        },
        commitTypedCloser: (U) => {
          var X;
          return (X = h.current) == null ? void 0 : X.commitTypedCloser(U);
        },
        commitItem: (U) => {
          var K;
          const X = $.items.find((at) => at.marker === U);
          X && ((K = h.current) == null || K.applyMarkerMenuSelection(X, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const f = ($) => {
      var X, K;
      const J = (X = m.current) == null ? void 0 : X.querySelector(".editor-input");
    ...
    if (((J = St.view) == null ? void 0 : J.markerMode) === "editable") {
      ...
      return document.addEventListener("keydown", U, { capture: !0 }), document.addEventListener("paste", X, { capture: !0 }), () => {
        document.removeEventListener("keydown", U, { capture: !0 }), document.removeEventListener("paste", X, { capture: !0 });
      };
    }
    const $ = (U) => {
      const X = f();
      !H && X && document.activeElement === X && U.key === c ? (U.preventDefault(), le()) : H && U.key === "Escape" && (U.preventDefault(), Z(!1));
    };
    ...
    const f = () => {
      ...
      J && !J.isCollapsed || At() || ((X = h.current) == null || X.selectNote(0), (K = h.current) == null || K.focus());
    };
  ...
  return /* @__PURE__ */ u(mt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(mt, { children: Pu(t.marker, c, o, l) })
      }
    )
  ] });
}
...
function Zh({
  ...
  }, [j, ot]), H = I(() => D.length === 0 ? [] : Uu(D, R, G), [D, R, G]), Z = I(() => {
    var gt, xt;
    if (!j) return d;
...
const Hu = "16rem", qu = "3rem", cs = Xt.createContext(void 0);
function La() {
  const t = Xt.useContext(cs);
  if (!t)
...
function Gu({
  ...
  const [d, l] = Xt.useState(t), w = e ?? d, p = Xt.useCallback(
    ...
    [r, w]
  ), h = Xt.useCallback(() => p((E) => !E), [p]), m = w ? "expanded" : "collapsed", g = Re() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = Xt.useMemo(
    () => ({
      state: m,
      open: w,
      setOpen: p,
    ...
    Wu,
    {
      ...
      children: /* @__PURE__ */ u(Zu, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(Xu, { children: Object.entries(e).map(([g, T]) => /* @__PURE__ */ a(Ju, { children: /* @__PURE__ */ a(
            tp,
            {
              onClick: () => p(g),
              isActive: y(g),
...
function wg({
  ...
  Y(() => {
    if (c) {
      ...
      if (O.length === 1) {
        const G = y.find((W) => jn(W) === O[0]) || void 0;
        G && c(G);
      }
    }
  }, [m, y, c, T]);
  const k = n ?? np, E = s ?? ls, C = [
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(lu, { children: C.map((R) => /* @__PURE__ */ a(me, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
                    ...
                    children: W.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ a(Ec, {}) : /* @__PURE__ */ a(Tc, {})),
                          " ",
...
function pg({
  ...
  const L = Ft(
    ...
    [r, n, g, s]
  ), ee = xt.find((F) => F.value === t), Me = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? jc(St, Kt, {
  ...
  ), $ = xt.find((F) => F.value === "selectedBooks"), J = xt.find((F) => F.value === "range"), [U, X] = N(!1), [K, at] = N(void 0), [lt, ft] = N(void 0), [pt, yt] = N(void 0), [vt, ht] = N(void 0), [ye, Ie] = N([]), ke = p === "dropdown" && K === "selectedBooks", rr = /* @__PURE__ */ a(
    up,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: x(ar && ze), children: Z }),
      /* @__PURE__ */ a(
        Ya,
        {
  ...
  const ta = V(
    (F) => {
      ft(F), yt(St), ht(Kt), Ie(n), X(!1), at(F);
    },
    [St, Kt, n]
  ), ea = V(() => {
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(Be, { open: U, onOpenChange: X, children: [
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          Rr,
          {
            ...
            style: { zIndex: je },
            children: t.map((w) => /* @__PURE__ */ a(me, { value: `${w}`, children: d[cn(w)] }, `${w}`))
          }
        )
      ]
    }
...
function No({
  ...
  const l = _a(), w = gp(e), p = s && w.length > 1;
  Di();
  const h = A(null), m = () => js(h.current ?? void 0);
...
const vp = Object.freeze([520, 420, 340]), gs = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, vp), l = Oi() ?? d, w = l >= Br.MINIMUM;
...
const fs = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = Re();
  return /* @__PURE__ */ a(
    ve.Root,
    {
...
const ms = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ve.List,
  {
    ref: r,
    className: x(
...
const bp = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ve.Trigger,
  {
    ref: r,
    ...e,
...
)), vs = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ve.Content,
  {
    ref: r,
    className: x(
...
function pf(t) {
  const e = I(() => Uc(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Nf as CONTENT_ZOOM_CSS_VARIABLE_PREFIX,
  Cf as CONTENT_ZOOM_DEFAULT_CSS_VARIABLE,
  Ef as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  Tf as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  Gf as ResizablePanelGroup,
  Sg as ResultsCard,
  Wf as RetryableErrorView,
  ...
  tm as Z_INDEX_MODAL,
  em as Z_INDEX_MODAL_BACKDROP,
  rm as Z_INDEX_ONBOARDING_TOUR,
  am as Z_INDEX_OVERLAY,
  om as badgeVariants,
