...
const Po = gt.Portal, Fn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
    className: d(
...
function na(t, e, n, o) {
  const a = B(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const c = e[p - 1], u = Math.max(ft(c), 1);
        o({
          book: c,
          chapterNum: u,
          verseNum: 1
...
const Gt = K.Root, pa = K.Group, Ft = K.Value, ma = _t(
...
), vs = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
