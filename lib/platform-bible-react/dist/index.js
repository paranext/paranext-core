...
function oh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ...
    ot.bookNumberToId(t.bookNum)
  ), [p, f] = ut(!1), [w, g] = ut(p), v = ge(void 0), m = ge(void 0), h = ge(void 0), k = kt(
    (E) => fc(E).filter((j) => {
    ...
    if (c === o) {
      ...
      i + M <= 0 || i + M > tn(c) ? l(0) : M !== 0 && (l(i + M), E.preventDefault());
    }
  };
  return ae(() => {
        ...
        children: [
          ...
          na.map(
            (E, j) => k(E).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ s(Sn, { className: "tw-font-semibold tw-text-foreground/80", children: pc[E] }),
...
function Wr({
  ...
  const [m, h] = ut(!1);
  return /* @__PURE__ */ x(yc, { open: m, onOpenChange: h, ...v, children: [
    /* @__PURE__ */ s(xc, { asChild: !0, children: /* @__PURE__ */ x(
      gt,
      {
        ...
        "aria-expanded": m,
        id: t,
        className: N("tw-w-[200px] tw-justify-between", r ?? n),
        disabled: g,
        children: [
          /* @__PURE__ */ s("span", { className: "tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: a ? l(a) : c }),
          /* @__PURE__ */ s(Qs, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(gi, { className: N("tw-w-[200px] tw-p-0", o), dir: w, children: /* @__PURE__ */ x(vi, { children: [
      /* @__PURE__ */ s(yi, { dir: w, placeholder: d, className: "tw-text-inherit" }),
      /* @__PURE__ */ s(Ni, { children: p }),
      /* @__PURE__ */ s(xi, { children: e.map((k) => /* @__PURE__ */ x(
        ki,
        {
          value: l(k),
          onSelect: () => {
...
function Bc({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(ar, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ir, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ s(oe, { children: k.headers.map((A) => /* @__PURE__ */ s(bn, { children: A.isPlaceholder ? void 0 : cn(A.column.columnDef.header, A.getContext()) }, A.id)) }, k.id)) }),
      /* @__PURE__ */ s(sr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        oe,
        {
          onClick: () => i(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((A) => /* @__PURE__ */ s(Be, { children: cn(A.column.columnDef.cell, A.getContext()) }, A.id))
        },
        k.id
...
function ph({
  ...
  const f = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), v = Jt(n, "%webView_inventory_unknown%"), m = Jt(n, "%webView_inventory_scope_currentBook%"), h = Jt(n, "%webView_inventory_scope_chapter%"), k = Jt(n, "%webView_inventory_scope_verse%"), A = Jt(n, "%webView_inventory_filter_text%"), R = Jt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, b] = ut(!1), [$, z] = ut("all"), [H, C] = ut(""), [P, E] = ut([]), j = $t(() => l ? r instanceof RegExp ? Xc(
    l,
    t,
    a,
    i,
...
function fh({
  ...
  ae(() => {
    if (l) {
      const C = k.getSelectedRowModel().rowsById, P = Object.keys(C);
      if (P.length === 1) {
        const E = m.find((j) => aa(j) === P[0]) || void 0;
        E && l(E);
      }
    }
  }, [g, m, l, k]);
  const A = o ?? gd, R = a ?? Fi, S = [
  ...
  }, z = (C, P) => C.getIsGrouped() ? "" : N("banded-row", P % 2 === 0 ? "even" : "odd"), H = (C, P, E) => {
    if (!((C == null ? void 0 : C.length) === 0 || P.depth < E.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ x(
      hn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(je, { position: "item-aligned", children: /* @__PURE__ */ s($c, { children: S.map((C) => /* @__PURE__ */ s(Ut, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(ar, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ir, { children: k.getHeaderGroups().map((C) => /* @__PURE__ */ s(oe, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
      ...
      /* @__PURE__ */ s(sr, { children: k.getRowModel().rows.map((C, P) => /* @__PURE__ */ s(
        oe,
        {
                  ...
                  children: (() => E.getIsGrouped() ? /* @__PURE__ */ x(
                    gt,
                    {
                      ...
                      children: [
                        ...
                        " ",
                        cn(E.column.columnDef.cell, E.getContext()),
                        " (",
                        C.subRows.length,
                        ")"
                      ]
...
function Ed() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = v, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = f, it.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === f || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === h || b.$$typeof === k || b.$$typeof === A || b.$$typeof === m);
  }, it.typeOf = R, it;
}
var st = {};
/** @license React v16.13.1
...
function Sd() {
  return sa || (sa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function R(I) {
      ...
      I === r || I === d || I === a || I === o || I === f || I === w || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === g || I.$$typeof === i || I.$$typeof === l || I.$$typeof === p || I.$$typeof === h || I.$$typeof === k || I.$$typeof === A || I.$$typeof === m);
    }
    function S(I) {
    ...
    var b = c, $ = d, z = l, H = i, C = e, P = p, E = r, j = v, M = g, J = n, q = a, U = o, tt = f, at = !1;
    function rt(I) {
    ...
    st.AsyncMode = b, st.ConcurrentMode = $, st.ContextConsumer = z, st.ContextProvider = H, st.Element = C, st.ForwardRef = P, st.Fragment = E, st.Lazy = j, st.Memo = M, st.Portal = J, st.Profiler = q, st.StrictMode = U, st.Suspense = tt, st.isAsyncMode = rt, st.isConcurrentMode = y, st.isContextConsumer = O, st.isContextProvider = L, st.isElement = F, st.isForwardRef = V, st.isFragment = W, st.isLazy = X, st.isMemo = Y, st.isPortal = G, st.isProfiler = K, st.isStrictMode = Z, st.isSuspense = dt, st.isValidElementType = R, st.typeOf = S;
  }()), st;
}
var la;
function Hi() {
...
function jd() {
  return ha || (ha = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, m = !1, h = !1, k = !1, A = !1, R;
    R = Symbol.for("react.module.reference");
    function S(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === n || B === o || A || B === r || B === d || B === p || k || B === g || v || m || h || typeof B == "object" && B !== null && (B.$$typeof === w || B.$$typeof === f || B.$$typeof === a || B.$$typeof === i || B.$$typeof === c || // This needs to include all possible module reference object
    ...
    var $ = i, z = a, H = t, C = c, P = n, E = w, j = f, M = e, J = o, q = r, U = d, tt = p, at = !1, rt = !1;
    function y(B) {
...
function gu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const A = Pl(i, _({
      ...
      if (process.env.NODE_ENV !== "production") {
        let E;
        c && (E = `${c}${Wt(d || "")}`), E === void 0 && (E = `Styled(${zd(i)})`), P.displayName = E;
      }
...
function Gu(t, e) {
  ...
  const g = o / 14, v = f || ((k) => `${k / d * g}rem`), m = (k, A, R, S, b) => _({
    fontFamily: r,
    fontWeight: k,
    fontSize: v(A),
...
function Jw(t) {
  ...
  if (!(!a || !i)) {
    var f = Kw(o.padding, n), w = Io(a), g = c === "y" ? Tt : Ct, v = c === "y" ? Bt : Vt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = Pn(a), A = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, R = m / 2 - h / 2, S = f[g], b = A - w[p] - f[v], $ = A / 2 - w[p] / 2 + R, z = un(S, $, b), H = c;
...
function Ba(t) {
  ...
  g = h.x, m = h.y;
  var k = i.hasOwnProperty("x"), A = i.hasOwnProperty("y"), R = Ct, S = Tt, b = window;
  if (d) {
  ...
  if (g = j.x, m = j.y, c) {
    var M;
    return Object.assign({}, E, (M = {}, M[S] = A ? "0" : "", M[R] = k ? "0" : "", M.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", M));
  }
  return Object.assign({}, E, (e = {}, e[S] = A ? m + "px" : "", e[R] = k ? g + "px" : "", e.transform = "", e));
}
function nf(t) {
...
function Nn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? $w : l, d = n.rootBoundary, p = d === void 0 ? ms : d, f = n.elementContext, w = f === void 0 ? nn : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = ys(typeof h != "number" ? h : xs(h, _n)), A = w === nn ? Iw : nn, R = t.rects.popper, S = t.elements[v ? A : w], b = wf(ke(S) ? S : S.contextElement || le(t.elements.popper), c, p, i), $ = Ue(t.elements.reference), z = ks({
    reference: $,
    element: R,
    strategy: "absolute",
    placement: o
  }), H = ro(Object.assign({}, R, z)), C = w === nn ? H : $, P = {
    top: b.top - C.top + k.top,
    bottom: C.bottom - b.bottom + k.bottom,
    left: b.left - C.left + k.left,
    right: C.right - b.right + k.right
...
function hf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Xt(h), A = k === h, R = c || (A || !v ? [Xn(h)] : mf(h)), S = [h].concat(R).reduce(function(V, W) {
    ...
    }, []), b = e.rects.reference, $ = e.rects.popper, z = /* @__PURE__ */ new Map(), H = !0, C = S[0], P = 0; P < S.length; P++) {
      var E = S[P], j = Xt(E), M = Ge(E) === Le, J = [Tt, Bt].indexOf(j) >= 0, q = J ? "width" : "height", U = Nn(e, {
        placement: E,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function Tf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = Nn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Xt(e.placement), A = Ge(e.placement), R = !A, S = Ao(k), b = Sf(S), $ = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, C = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
    ...
    mainAxis: 0,
    altAxis: 0
  }, C), E = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, j = {
    x: 0,
    y: 0
  };
  if ($) {
    if (a) {
      var M, J = S === "y" ? Tt : Ct, q = S === "y" ? Bt : Vt, U = S === "y" ? "height" : "width", tt = $[S], at = tt + h[J], rt = tt - h[q], y = g ? -H[U] / 2 : 0, O = A === Le ? z[U] : H[U], L = A === Le ? -H[U] : -z[U], F = e.elements.arrow, V = g && F ? Io(F) : {
        width: 0,
        height: 0
      }, W = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : vs(), X = W[J], Y = W[q], G = un(0, z[U], V[U]), K = R ? z[U] / 2 - y - G - X - P.mainAxis : O - G - X - P.mainAxis, Z = R ? -z[U] / 2 + y + G + Y + P.mainAxis : L + G + Y + P.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), I = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, xt = (M = E == null ? void 0 : E[S]) != null ? M : 0, B = tt + K - xt - I, yt = tt + Z - xt, Lt = un(g ? Jn(at, B) : at, tt, g ? ve(rt, yt) : rt);
      $[S] = Lt, j[S] = Lt - tt;
    }
    if (l) {
      var ce, Et = S === "x" ? Tt : Ct, In = S === "x" ? Bt : Vt, Ft = $[b], Ee = b === "y" ? "height" : "width", de = Ft + h[Et], Se = Ft - h[In], Te = [Tt, Ct].indexOf(k) !== -1, Ce = (ce = E == null ? void 0 : E[b]) != null ? ce : 0, pe = Te ? de : Ft - z[Ee] - H[Ee] - Ce + P.altAxis, We = Te ? Ft + z[Ee] + H[Ee] - Ce - P.altAxis : Se, An = g && Te ? qw(pe, Ft, We) : un(g ? pe : de, Ft, g ? We : Se);
      $[b] = An, j[b] = An - Ft;
    }
    e.modifiersData[r] = j;
  }
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        return p.orderedModifiers = R.filter(function(S) {
          return S.enabled;
        }), v(), g.update();
      },
      ...
      forceUpdate: function() {
        if (!w) {
          var k = p.elements, A = k.reference, R = k.popper;
          if (Ga(A, R)) {
            p.rects = {
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var b = p.orderedModifiers[S], $ = b.fn, z = b.options, H = z === void 0 ? {} : z, C = b.name;
              typeof $ == "function" && (p = $({
                state: p,
                options: H,
                name: C,
    ...
    function v() {
      p.orderedModifiers.forEach(function(h) {
        var k = h.name, A = h.options, R = A === void 0 ? {} : A, S = h.effect;
...
const Gf = () => yo({
  ...
  } = e, h = Nt(e, zf), k = D.useRef(null), A = xe(k, n), R = D.useRef(null), S = xe(R, w), b = D.useRef(S);
  ze(() => {
    b.current = S;
  }, [S]), D.useImperativeHandle(w, () => R.current, []);
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, A = Nt(e, Lf), [R, S] = D.useState(!0), b = () => {
    S(!1);
  }, $ = () => {
    S(!0);
  };
...
const Qf = {
  ...
  const {
  ...
  } = e, k = Nt(e, Zf), A = an(), R = D.useRef(), S = Ts(), b = D.useRef(null), $ = xe(b, a.ref, n), z = (q) => (U) => {
    if (q) {
      const tt = b.current;
    ...
    let y;
    m === "auto" ? (y = S.transitions.getAutoHeightDuration(q.clientHeight), R.current = y) : y = tt, q.style.transition = [S.transitions.create("opacity", {
      duration: y,
      delay: at
    ...
    let rt;
    m === "auto" ? (rt = S.transitions.getAutoHeightDuration(q.clientHeight), R.current = rt) : rt = U, q.style.transition = [S.transitions.create("opacity", {
      duration: rt,
      delay: tt
    }), S.transitions.create("transform", {
...
const _s = /* @__PURE__ */ D.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, f, w, g, v, m, h, k, A, R, S, b;
  const $ = Ro({
    props: e,
    name: "MuiTooltip"
  }), {
...
`));
  ...
  E ? (Ke.title = !Kt && Tr && !M ? dt : null, Ke["aria-describedby"] = Kt ? kr : null) : (Ke["aria-label"] = Tr ? dt : null, Ke["aria-labelledby"] = Kt && !Tr ? kr : null);
...
`));
  const Ls = D.useMemo(() => {
    ...
    className: be(Cr.tooltip, (k = (A = K.tooltip) != null ? A : P.tooltip) == null ? void 0 : k.className)
  }), Ze), Hs = sn(Zo, _({}, (R = K.arrow) != null ? R : P.arrow, {
    className: be(Cr.arrow, (S = (b = K.arrow) != null ? b : P.arrow) == null ? void 0 : S.className)
  }), Ze);
...
function bm({
  ...
  ae(() => {
    if (c) {
      ...
      if (S) {
        const b = S.getBoundingClientRect(), $ = window.scrollY, z = window.scrollX, H = b.top + $ + S.clientHeight, C = b.left + z;
        h({ top: H, left: C });
      }
    }
  }, [c, o]);
