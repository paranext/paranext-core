...
var At = (t, e, r) => Ii(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Bt, Z as Vi, B, c as f, a as Li, C as Ae, P as Pe, b as Ke, d as Ie, e as qe, f as Ge, g as xe, h as Cr, i as ta, T as ie, S as or, j as se, k as ce, l as le, D as Je, m as yr, n as Me, o as Oe, p as $e, u as Fi, q as Er, s as Ze, t as je, v as za, w as cn, x as ji, y as Bi, z as ln, A as dn, E as Ui, F as Ki, G as qi, H as Gi, I as da, J as wa, K as wr, L as Hi, M as Yi, N as Wi, O as Xi, Q as Ji, R as Tr, U as Ga } from "./resizable-CUvCloPJ.js";
import { V as Gh, W as Hh, X as Yh, Y as Wh, _ as Xh, $ as Jh, a0 as Zh, a1 as Qh, a2 as tg } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as nt } from "react/jsx-runtime";
import { Canon as gt } from "@sillsdev/scripture";
import { includes as Rr, Section as et, getChaptersForBook as Zi, formatScrRef as Se, getSectionForBook as vr, formatRelativeDate as Qi, formatReplacementString as ze, sanitizeHtml as ts, NumberFormat as es, formatBytes as rs, getCurrentLocale as as, usfmMarkers as Fr, getFormatCallerFunction as os, deepEqual as ns, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as is, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as Be, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Da, ChevronRight as Ma, ArrowLeft as ss, ArrowRight as cs, ChevronDown as nr, BoldIcon as ls, ItalicIcon as ds, X as ea, AtSign as wn, Pencil as ws, Trash2 as us, ArrowUp as un, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as pn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, ChevronsUpDown as hn, Star as Es, Undo as Ts, Redo as zs, SquareX as gn, FunctionSquare as fn, SquareSigma as mn, Ban as Ss, AlertCircle as Oa, CircleCheckIcon as Ds, CircleXIcon as Ms, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as Rs, Search as As, LoaderCircle as Ps, ScrollText as Is, MenuIcon as Vs, Menu as Ls, EllipsisVertical as Fs, MoreVertical as ko } from "lucide-react";
import ft, { useRef as j, useMemo as F, useState as C, useCallback as L, useEffect as Y, useLayoutEffect as Ft, createContext as Ha, useContext as vn, Component as js, createElement as _o, Suspense as Bs, forwardRef as ra, Fragment as bn } from "react";
import { Dialog as ye, Label as Us, RadioGroup as $a, ToggleGroup as xn, Slot as ur, Avatar as Ya, Select as It, Checkbox as No, Tabs as fe, Menubar as Ne, ContextMenu as Ot, Progress as Co, Slider as Ar, Switch as Eo } from "radix-ui";
import { createEditor as yn, $getRoot as Ue, $createParagraphNode as zr, $getSelection as jt, HISTORY_MERGE_TAG as Wa, ParagraphNode as kn, TextNode as _n, $getPreviousSelection as Ks, $isRangeSelection as ke, $caretFromPoint as qs, $getSiblingCaret as Nn, $getChildCaret as Gs, $getAdjacentChildCaret as Hs, $isChildCaret as Ys, $normalizeCaret as Ws, $setSelectionFromCaretRange as Xs, $getCollapsedCaretRange as Js, $getCaretInDirection as To, $splitAtPointCaretNext as Zs, $isTextPointCaret as Qs, $findMatchingParent as Cn, $isElementNode as kr, mergeRegister as Re, getDOMTextNode as tc, isHTMLElement as ec, CLEAR_EDITOR_COMMAND as En, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as rc, defineExtension as de, safeCast as Qe, createState as ac, FORMAT_TEXT_COMMAND as Tn, $isNodeSelection as zn, COMMAND_PRIORITY_LOW as Sn, RootNode as oc, LineBreakNode as nc, TabNode as ic, $isEditorState as sc, createCommand as cc, CLICK_COMMAND as lc, isDOMNode as dc, $getNodeFromDOMNode as wc, $createNodeSelection as uc, $setSelection as pc, $getEditor as hc, DecoratorNode as Ra, $getState as gc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as fc, $setState as mc, addClassNamesToElement as Dn, $create as vc, $getNodeByKey as bc, removeClassNamesFromElement as xc, KEY_TAB_COMMAND as yc, $isBlockElementNode as kc, $createRangeSelection as _c, $normalizeSelection__EXPERIMENTAL as Nc, OUTDENT_CONTENT_COMMAND as Cc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Ec, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Tc, $isParagraphNode as zc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as Sc } from "lexical";
import { HeadingNode as Dc, QuoteNode as Mc, registerRichText as Oc } from "@lexical/rich-text";
import { flushSync as $c, createPortal as Rc } from "react-dom";
import { IconX as Ac, IconCheck as aa, IconChevronDown as Pc, IconChevronUp as Ic, IconSelector as Vc, IconLayoutSidebar as Lc, IconLayoutSidebarRight as Fc, IconChevronRight as On, IconLoader as jc, IconAlertOctagon as Bc, IconAlertTriangle as Uc, IconInfoCircle as Kc, IconCircleCheck as qc } from "@tabler/icons-react";
...
import { useReactTable as Rn, getFilteredRowModel as Wc, getSortedRowModel as An, getPaginationRowModel as Xc, getCoreRowModel as Pn, flexRender as br, getGroupedRowModel as Jc, getExpandedRowModel as Zc } from "@tanstack/react-table";
import Qc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as tl, isInsertEmbedOpOfType as Pr, Editorial as el, getMarkerMenuItems as rl, defaultStyleInfo as al } from "@eten-tech-foundation/platform-editor";
...
import { toast as rg } from "sonner";
function Va({ ...t }) {
  return /* @__PURE__ */ a(ye.Root, { "data-slot": "dialog", ...t });
}
function Uu({ ...t }) {
  return /* @__PURE__ */ a(ye.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function sl({ ...t }) {
  return /* @__PURE__ */ a(ye.Portal, { "data-slot": "dialog-portal", ...t });
}
function Ku({ ...t }) {
  return /* @__PURE__ */ a(ye.Close, { "data-slot": "dialog-close", ...t });
}
function cl({
  className: t,
  ...
  return /* @__PURE__ */ u(sl, { children: [
    ...
    /* @__PURE__ */ u(
      ye.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ye.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(B, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Ac, {}),
...
function Do({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ye.Close, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
const Vn = gt.allBookIds.filter(
  (t) => !gt.isObsolete(gt.bookIdToNumber(t))
), he = Object.fromEntries(
  Vn.map((t) => [t, gt.bookIdToEnglishName(t)])
);
function Qa(t, e, r) {
...
function dl({
  ...
  return /* @__PURE__ */ u(Pe, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Ie, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      Ae,
      {
        onSelect: () => h(g),
      ...
      if (s) {
        ...
        if (!w && d) {
          const g = ((m) => Object.keys(he).find(
            (k) => he[k].toLowerCase() === m.toLowerCase()
          ))(c);
          if (g && e.includes(g) && (w = g), !w && r) {
            const m = Array.from(r.entries()).find(
              ([, k]) => k.localizedName.toLowerCase() === c.toLowerCase()
            );
...
function gl(t, e, r, o) {
  const n = L(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const l = e[d - 1], w = Math.max(be(l), 1);
        o({
          book: l,
          chapterNum: w,
          verseNum: 1
...
function jn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function ga({
  ...
  const T = Bt(), [N, y] = C(!1), [I, K] = C(""), [V, O] = C(""), [_, z] = C("books"), [P, S] = C(void 0), [D, X] = C(
    void 0
  ), [q, R] = C(void 0), [at, ot] = C(!1), it = j(null), Ut = j(!1), yt = j(void 0), $t = j(void 0), U = j(void 0), lt = j(void 0), dt = j({}), wt = j({}), ut = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Kt = F(() => o ? o() : Vn, [o]), bt = F(() => ({
    [et.OT]: Kt.filter((G) => gt.isBookOT(G)),
    [et.NT]: Kt.filter((G) => gt.isBookNT(G)),
    [et.DC]: Kt.filter((G) => gt.isBookDC(G)),
    [et.Extra]: Kt.filter((G) => gt.extraBooks().includes(G))
  }), [Kt]), Jt = F(() => Object.values(bt).flat(), [bt]), Ct = F(() => {
    if (!V.trim()) return bt;
    const x = {
      [et.OT]: [],
      [et.NT]: [],
    ...
    return [et.OT, et.NT, et.DC, et.Extra].forEach((tt) => {
      x[tt] = bt[tt].filter((Et) => Qa(Et, V, n));
    }), x;
  }, [bt, V, n]), M = F(
    () => hl(V, Jt, n),
    [V, Jt, n]
  ...
  const xt = L(() => {
    if (M) {
      const x = M.chapterNum ?? 1, G = M.verseNum ?? 1;
      if (w && ha(M.book, x, G, w))
        return;
      ut({
        book: M.book,
        chapterNum: x,
    ...
    (x) => {
      const G = D ?? (M == null ? void 0 : M.book), tt = q ?? (M == null ? void 0 : M.chapterNum);
      !G || !tt || (ut({
        book: G,
        chapterNum: tt,
        verseNum: x
    ...
    (x) => {
      const G = _ === "chapters" ? P : M == null ? void 0 : M.book;
      if (G) {
        if (l && l(G, x) > 1) {
          X(G), R(x), z("verses"), K("");
          return;
    ...
    z("books"), S(void 0), X(void 0), R(void 0), setTimeout(() => {
      $t.current && $t.current.focus();
    }, 0);
  }, []), Gt = L(() => {
    const x = D;
    X(void 0), R(void 0), x ? (S(x), z("chapters"), K("")) : Qt();
  }, [D, Qt]), St = L((x) => {
    y(x), x && (z("books"), S(void 0), X(void 0), R(void 0), O(""));
  }, []), { otLong: Ht, ntLong: we, dcLong: te, extraLong: Ee } = {
    ...
    () => ul(V),
    [V]
  ), W = F(() => !l || !M || !M.chapterNum || !J ? !1 : l(M.book, M.chapterNum) > 0, [l, M, J]), H = L(
    (x) => w ? Mo(x, w) : !1,
    [w]
  ), ct = L(
    (x) => (G) => w ? pl(x, G, w) : !1,
    ...
    (x, G) => (tt) => w ? ha(x, G, tt, w) : !1,
    [w]
  ), pt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", mt = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Nt = L(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), xt());
    },
    [p, M, xt]
  ), Yt = L(
    (x) => {
      var ae, tr, hr;
      if (x.ctrlKey) return;
      const { isLetter: G, isDigit: tt } = Oo(x.key);
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        const Rt = x.target instanceof HTMLElement ? x.target : void 0;
        ...
        const Dt = (ae = yt.current) == null ? void 0 : ae.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Dt) {
          x.preventDefault(), x.stopPropagation(), Dt.click();
          return;
        }
      }
      if ((_ === "chapters" || _ === "verses") && (G || tt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (_ === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), Qt();
        return;
      }
      ...
      if (_ === "verses" && Et) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            vt !== 0 && (Wt = vt > 1 ? vt - 1 : Dt);
            break;
          case "ArrowRight":
            vt !== 0 && (Wt = vt < Dt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            Wt = vt === 0 ? Dt : Math.max(1, vt - Xt);
            break;
          case "ArrowDown":
            Wt = vt === 0 ? 1 : Math.min(Dt, vt + Xt);
            break;
          default:
            return;
        }
        Wt !== vt && (x.preventDefault(), x.stopPropagation(), K(
          `${Rt} ${he[Rt] || ""} ${kt}:${Wt}`
        ), setTimeout(() => {
          const Ye = wt.current[Wt];
          Ye && Ye.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((_ === "chapters" || _ === "books" && M) && Et) {
        const Rt = _ === "chapters" ? P : M == null ? void 0 : M.book;
        if (!Rt) return;
        _ === "chapters" && ((hr = yt.current) == null || hr.focus());
        const kt = (() => {
          if (!I) return 1;
          const Xt = I.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            kt !== 0 && (vt = kt > 1 ? kt - 1 : Dt);
            break;
          case "ArrowRight":
            kt !== 0 && (vt = kt < Dt ? kt + 1 : 1);
            break;
          case "ArrowUp":
            vt = kt === 0 ? Dt : Math.max(1, kt - Wt);
            break;
          case "ArrowDown":
            vt = kt === 0 ? 1 : Math.min(Dt, kt + Wt);
            break;
          default:
            return;
        }
        vt !== kt && (x.preventDefault(), x.stopPropagation(), K(
          `${Rt} ${he[Rt] || ""} ${vt}`
        ), setTimeout(() => {
          const Xt = dt.current[vt];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Et = $t.current) == null || Et.focus();
      return;
    }
    const { isLetter: G, isDigit: tt } = Oo(x.key);
    (G || tt) && (x.preventDefault(), O((ae) => ae + x.key), $t.current.focus(), ot(!1));
  }, []);
  return Ft(() => {
    const x = setTimeout(() => {
      if (N && _ === "books" && U.current && lt.current) {
        const G = U.current, tt = lt.current, Et = tt.offsetTop, ae = G.clientHeight, tr = tt.clientHeight, hr = Et - ae / 2 + tr / 2;
        G.scrollTo({
          top: Math.max(0, hr),
          behavior: "smooth"
        }), K(Fn(t.book));
    ...
    if (_ === "chapters" && P) {
      const x = P === t.book, G = x ? t.chapterNum : 1;
      K(
        `${P} ${he[P] || ""} ${G}`
      ), setTimeout(() => {
        if (U.current)
          if (x) {
            const tt = dt.current[t.chapterNum];
  ...
  }, [_, P, M, t.book, t.chapterNum]), Ft(() => {
    if (_ === "verses" && D && q !== void 0) {
      const x = D === t.book && q === t.chapterNum, G = x ? t.verseNum : 1;
      K(
        `${D} ${he[D] || ""} ${q}:${G}`
      ), setTimeout(() => {
        if (U.current)
          if (x) {
            const tt = wt.current[t.verseNum];
            tt && tt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            U.current.scrollTo({ top: 0 });
        yt.current && yt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Pe, { open: N, onOpenChange: St, modal: v, children: [
    /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(
      B,
      {
        ref: it,
        ...
        onClick: (x) => {
          Ut.current && (Ut.current = !1, x.preventDefault());
        },
        children: h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: $ })
      }
    ) }),
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: G } = x;
          N && it.current && G instanceof Node && it.current.contains(G) && (Ut.current = !0, St(!1));
        },
        onCloseAutoFocus: k,
        children: /* @__PURE__ */ u(
          qe,
          {
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Zt.map(({ onClick: x, disabled: G, title: tt, icon: Et }) => /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: _ === "verses" ? Gt : Qt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                _ === "chapters" && P && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Fe(P, n) }),
                _ === "verses" && D && q !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Fe(D, n)} ${q}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? mt : pt
                  }
                )
              ] }),
              !at && /* @__PURE__ */ u(Ge, { ref: U, children: [
                _ === "books" && /* @__PURE__ */ u(nt, { children: [
                  !M && Object.entries(Ct).map(([x, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: ue(x), children: G.map((tt) => /* @__PURE__ */ a(
                          Ln,
                          {
                            bookId: tt,
                            onSelect: (Et) => Vt(Et),
                            section: vr(tt),
                            commandValue: `${tt} ${he[tt]}`,
                            ref: tt === t.book ? lt : void 0,
                            localizedBookNames: n,
                            disabled: H(tt)
                          },
                          tt
                  ...
                  M && /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a(
                    Ae,
                    {
                      ...
                      children: Se(
                        ...
                        n ? Za(M.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  M && W && M.chapterNum && l && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Fe(M.book, n)} ${M.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Ro,
                      {
                        ...
                        endVerse: l(M.book, M.chapterNum),
                        scrRef: t,
                        onVerseSelect: qt,
                        setVerseRef: Q,
                        isVerseDisabled: rt(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !W && be(M.book) > 1 && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Fe(M.book, n) }),
                      /* @__PURE__ */ a("span", { children: pt })
                    ] }),
                    /* @__PURE__ */ a(
                      $o,
                      {
                ...
                _ === "chapters" && P && /* @__PURE__ */ a(
                  $o,
                  {
                    ...
                    onChapterSelect: zt,
                    setChapterRef: b,
                    isChapterDisabled: ct(P),
                    className: "tw:p-4"
                  }
                ),
                _ === "verses" && D && q !== void 0 && l && /* @__PURE__ */ a(
                  Ro,
                  {
                    bookId: D,
                    chapterNum: q,
...
function Ao({
  ...
  const [N, y] = C(!1), I = l ?? d, K = (O) => O.length > 0 && typeof O[0] == "object" && "options" in O[0], V = (O, _) => {
    const z = d(O), P = typeof O == "object" && "secondaryLabel" in O ? O.secondaryLabel : void 0, S = `${_ ?? ""}${z}${P ?? ""}`;
    return /* @__PURE__ */ u(
      Ae,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(Pe, { open: N, onOpenChange: y, ...T, children: [
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        children: /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a(Cr, { placeholder: h, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(ta, { children: g }),
          /* @__PURE__ */ a(Ge, { children: K(e) ? e.map((O) => /* @__PURE__ */ a(xe, { heading: O.groupHeading, children: O.options.map((_) => V(_, O.groupHeading)) }, O.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((O) => V(O)) }) })
        ] })
      }
    )
  ] });
...
function Xu({
  ...
  const w = fa(l, "%webView_bookSelector_currentBook%"), p = fa(l, "%webView_bookSelector_choose%"), h = fa(l, "%webView_bookSelector_chooseBooks%"), [g, m] = C(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    m(v), t(v);
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Kn ? Ft : Y, Ir = { tag: Wa };
function xl({ initialConfig: t, children: e }) {
  const r = F(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = vl(null, o), w = yn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = zr();
            g.append(m);
            const k = Kn ? document.activeElement : null;
            (jt() !== null || k !== null && k === p.getRootElement()) && m.select();
          }
        }, Ir);
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : Y;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : Y;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = Ce(), r = F(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = j(o);
    return Tl(() => {
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = qn && "documentMode" in document ? document.documentMode : null;
!(!qn || !("InputEvent" in window) || Ml) && "getTargetRanges" in new window.InputEvent("input");
function ve(t) {
  return `${t}px`;
}
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < g.length; E++) {
      const T = g[E], N = s[E] || document.createElement("div"), y = N.style;
      y.position !== "absolute" && (y.position = "absolute", v = !0);
      const I = ve(T.left - p);
      y.left !== I && (y.left = I, v = !0);
      const K = ve(T.top - h);
      y.top !== K && (N.style.top = K, v = !0);
      const V = ve(T.width);
      y.width !== V && (N.style.width = V, v = !0);
      const O = ve(T.height);
      y.height !== O && (N.style.height = O, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[E] = N;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!ec(g)) return l();
    l(), o = h, n = g, i = new MutationObserver((m) => {
      const k = t.getRootElement(), v = k && k.parentElement;
      if (k !== o || v !== n) return p();
      for (const E of m) if (!c.contains(E.target)) return d();
    }), i.observe(g, Ol), d();
  });
  return () => {
    w(), l();
...
function Al(t, e = Rl) {
  ...
  function l(w) {
    w.read(() => {
      const p = jt();
      if (!ke(p)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [h, g] = function(O) {
        const _ = O.getStartEndPoints();
        return O.isBackward() ? [_[1], _[0]] : _;
      }(p), m = h.getNode(), k = m.getKey(), v = h.offset, E = g.getNode(), T = E.getKey(), N = g.offset, y = t.getElementByKey(k), I = t.getElementByKey(T), K = r === null || y !== o || v !== n || k !== r.getKey(), V = i === null || I !== s || N !== c || T !== i.getKey();
      if ((K || V) && y !== null && I !== null) {
        const O = function(_, z, P, S, D, X, q) {
          const R = (_._window ? _._window.document : document).createRange();
          return R.setStart(...Po(z, P, S)), R.setEnd(...Po(D, X, q)), R;
        }(t, h, m, y, g, E, I);
        d(), d = $l(t, O, e);
      }
      r = m, o = y, n = v, i = E, s = I, c = N;
    });
  }
  return l(t.getEditorState()), Re(t.registerUpdateListener(({ editorState: w }) => l(w)), () => {
    d();
  });
}
function Pl(t, e) {
...
function Il(t) {
  const e = Cn(t, (r) => kr(r) && !r.isInline());
  return kr(e) || Hr(4, t.__key), e;
}
function Vl(t) {
  const e = jt() || Ks();
  let r;
  if (ke(e)) r = qs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Nn(c, "next"));
    }
    r = r || Gs(Ue(), "previous").getFlipped().insert(zr());
  }
  const o = Ll(t, r), n = Hs(o), i = Ys(n) ? Ws(n) : o;
  return Xs(Js(i)), t.getLatest();
}
function Ll(t, e, r) {
  let o = To(e, "next");
  for (let n = o; n; n = Zs(n, r)) o = n;
  return Qs(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), To(Nn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = jt();
  if (!ke(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Cn(i, (l) => kr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Yr, De = 0, Wr = 0, Ul = 0, Ba = 0, Br = 0;
function Vo(t) {
  if (st === void 0) return;
  let e = t.n;
...
function ql(t) {
  ...
  Hn(this), st = t, this.f &= -2, 8 & this.f && ro(this), oa();
}
function rr(t, e) {
...
Pt.prototype.brand = jl, Pt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      De !== 0 && Wr === 0 && e.l !== Ba && (e.l = Ba, Yr = { S: e, v: e.v, i: e.i, o: Yr });
    })(this), this.v = t, this.i++, Br++, De++;
    try {
  ...
  if (this.g = Br, this.f |= 1, this.i > 0 && !Gn(this)) return this.f &= -2, !0;
  const t = st;
  try {
    Lo(this), st = this;
    const e = this.x();
  ...
  return st = t, Hn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yn(this), Lo(this), De++;
  const t = st;
  return st = this, ql.bind(this, t);
...
de({ build: (t, e, r) => pr(e), config: Qe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Wn() {
  const t = Ue(), e = jt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), ke(e) && (e.format = 0);
}
function Xn(t, e = Wn) {
  return t.registerCommand(En, (r) => (t.update(e), !0), Xa);
}
de({ build: (t, e, r) => pr(e), config: Qe({ $onClear: Wn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return _e(() => Xn(t, o.value));
} });
function Gl(t) {
...
de({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Tn, (o) => {
  const n = jt();
  if (zn(n) || ke(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Sn) });
function Zn(t, e) {
  let r;
...
const Ua = de({ build: (t) => Zn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const ao = 0, Ka = 1, ti = 2, ba = 3, Vr = 4, er = 5, xa = 6, fr = 7;
function ya(t) {
  return t.id === ao;
}
function ei(t) {
...
function Yl(t) {
  return function(e) {
    return e.id === Ka;
  }(t) || ht(305, String(t.id), String(Ka)), Object.assign(t, { id: ti });
}
...
class Xl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && ht(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== xa && ht(310, String(r.id), String(xa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Vr;
    }(e) || ht(313, String(e.id), String(Vr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= ba;
    }(e) || ht(314, String(e.id), String(ba)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= fr;
    }(e) || ht(316, String(e.id), String(fr)), e;
  }
...
const Zl = de({ config: Qe({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [oc, _n, nc, ic, kn] }), jo = Symbol.for("@lexical/extension/LexicalBuilder");
function Bo() {
}
function Ql(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[jo];
    return r && (r.PACKAGE_VERSION !== ka && ht(292, r.PACKAGE_VERSION, ka), r instanceof ar || ht(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(yn({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [jo]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ya(i) || ht(300, s, n || "[unknown]"), ya(c = i) || ht(304, String(c.id), String(ao)), i = Object.assign(c, { id: Ka }), o.state = i;
...
const td = /* @__PURE__ */ new Set(), Uo = de({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Zn(() => {
  }, () => _e(() => {
    ...
    o.value.read(() => {
      if (jt()) for (const [w, p] of c.entries()) {
        ...
        const h = bc(w), g = h && h.isSelected() || !1;
...
}, dependencies: [Ua], name: "@lexical/extension/NodeSelection" }), ed = cc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends Ra {
  static getType() {
...
de({ dependencies: [Ua, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Uo).output, n = _r({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Re(t.registerCommand(ed, (s) => {
    const c = jt();
    if (!ke(c)) return !1;
    ...
    return !0;
  }, Xa), t.registerCommand(lc, (s) => {
    if (dc(s.target)) {
      const c = wc(s.target);
      if (ad(c)) return function(d, l = !1) {
        const w = jt(), p = d.isSelected(), h = d.getKey();
        let g;
        l && zn(w) ? g = w : (g = uc(), pc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Sn), t.registerMutationListener(ir, (s, c) => {
    Bl(() => {
      let d = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = g : (d = !0, l.set(w, { domNode: _r(g), selectedSignal: o(w) }));
      }
      d && (n.value = { nodeSelections: l });
    });
  }), _e(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(_e(() => {
      const l = c.value;
      l && (d.value ? Dn(l, i) : xc(l, i));
    }));
    return Re(...s);
  }));
} });
de({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Qe({ $getParentEditor: function() {
  const t = hc();
...
de({ build: (t, e, r) => pr(e), config: Qe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return _e(() => {
...
function od(t, e, r = ri) {
  return Re(t.registerCommand(yc, (o) => {
    const n = jt();
    if (!ke(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => kc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Il(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = _c();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Nc(g), g.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Cc : So : Ec;
...
de({ build: (t, e, r) => pr(e), config: Qe({ $canIndent: ri, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return _e(() => {
    if (!o.value) return od(t, n, i);
  });
} });
const nd = de({ name: "@lexical/react/ReactProvider" });
function id() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ke(m)) {
                const k = m.anchor;
                let v = k.getNode(), E = 0, T = 0;
                if (Aa(v) && l >= 0 && w >= 0 && (E = l, T = l + w, m.setTextNodeRange(v, E, v, T)), E === T && p === "" || (m.insertRawText(p), v = k.getNode()), Aa(v)) {
                  E = h, T = h + g;
                  const N = v.getTextContentSize();
                  E = E > N ? N : E, T = T > N ? N : T, m.setTextNodeRange(v, E, v, T);
                }
...
de({ build: (t, e, r) => pr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : oi(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const no = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : Y;
  ...
  return function(r, o) {
    ...
    return no(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (h) => r._onError(h), children: a(Bs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
        p !== null && s.push(Rc(w, p, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function ud({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    no(() => Re(Oc(n), oi(n)), [n]);
  }(o), u(nt, { children: [t, a(pd, { content: e }), a(wd, { editor: o, ErrorBoundary: r })] });
}
...
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : Y;
function fd({ onClear: t }) {
  const [e] = Ce();
  return gd(() => Xn(e, t), [e, t]), null;
}
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : Y;
function md({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: k, role: v = "textbox", spellCheck: E = !0, style: T, tabIndex: N, "data-testid": y, ...I }, K) {
  const [V, O] = C(t.isEditable()), _ = L((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? t.setRootElement(P) : t.setRootElement(null);
  }, [t]), z = F(() => /* @__PURE__ */ function(...P) {
    return (S) => {
      for (const D of P) typeof D == "function" ? D(S) : D != null && (D.current = S);
    };
  }(K, _), [_, K]);
  return ni(() => (O(t.isEditable()), t.registerEditableListener((P) => {
    O(P);
  })), [t]), a("div", { "aria-activedescendant": V ? e : void 0, "aria-autocomplete": V ? r : "none", "aria-controls": V ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": V && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": d, "aria-labelledby": l, "aria-multiline": w, "aria-owns": V ? p : void 0, "aria-readonly": !V || void 0, "aria-required": h, autoCapitalize: g, className: m, contentEditable: V, "data-testid": y, id: k, ref: z, role: v, spellCheck: E, style: T, tabIndex: N, ...I });
}
const vd = ra(md);
function qo(t) {
  return t.getEditorState().read(ai(t.isComposing()));
...
function xd(t, e) {
  ...
  return u(nt, { children: [a(vd, { editor: n, ...o, ref: e }), r != null && a(yd, { editor: n, content: r })] });
}
function yd({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return ni(() => {
      ...
      return l(), Re(s.registerUpdateListener(() => {
        l();
  ...
  if (Ft(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function Cd({
  ...
  const [e] = Ce(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function zd() {
  const { activeEditor: t } = si(), [e, r] = C([]), o = L((n) => {
    if (ke(n) || Gc(n)) {
      const i = [];
      Go.forEach(({ format: s }) => {
...
function hi({
  ...
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(
        B,
        {
          "aria-label": s,
          className: n,
      ...
      /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(ui, {}),
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
function Kr(t, e) {
...
function Zu({
  ...
  const [i, s] = C(Rd), [c, d] = C(n), [l, w] = C(!1), p = j(void 0), h = j(null);
  Y(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Pe, { open: l, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ie,
        {
          ...
          children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: t.map((v) => /* @__PURE__ */ a(
            Ae,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : co(v) && (v.preventDefault(), v.stopPropagation(), oe(i) && g());
        },
        onKeyDown: (v) => {
...
function Yo({
  ...
  const g = L(
    (y) => {
      y && y.stopPropagation(), l(!1), p(void 0), s == null || s(!1);
    },
    [s]
  ), m = L(
    async (y) => {
    ...
    const y = new Date(t.date), I = Qi(
      y,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), K = y.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = F(() => t.user, [t.user]), E = F(
    () => t.user.split(" ").map((y) => y[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), T = F(() => ts(t.contents), [t.contents]), N = F(() => {
    if (o && c)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          Je,
          {
            onClick: (y) => {
              y.stopPropagation(), l(!0), p(Od(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), g()) : co(y) && (y.preventDefault(), y.stopPropagation(), oe(w) && m());
              },
              onKeyDown: (y) => {
                io(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              onClick: (y) => {
                y.stopPropagation();
              },
        ...
        N && /* @__PURE__ */ u(Me, { children: [
          /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
          /* @__PURE__ */ a($e, { align: "end", children: N })
        ] })
      ]
    }
  );
...
function Ld({
  ...
  const [O, _] = C(Wo), [z, P] = C(), [S, D] = C(), X = o, [q, R] = C(!1), [at, ot] = C(!1), [it, Ut] = C(!1), [yt, $t] = C(!1), [U, lt] = C(!1), [dt, wt] = C(y), [ut, Kt] = C(!1), bt = j(void 0), [Jt, Ct] = C(/* @__PURE__ */ new Map());
  Y(() => {
    let b = !0;
    return (async () => {
      const J = T ? await T(d) : !1;
      b && lt(J);
    })(), () => {
      b = !1;
    };
    ...
    let b = !0;
    if (!o) {
      $t(!1), Ct(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const J = E ? await E(d) : !1;
      b && $t(J);
    })(), () => {
      b = !1;
    };
  ...
  Y(() => {
    if (!o) {
      M.current !== "idle" && (P(void 0), D(void 0), M.current = "idle");
      return;
    }
    M.current === "idle" && (M.current = "pending"), yt ? M.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (P(V), M.current = "auto-populated") : M.current === "auto-populated" && (P(void 0), M.current = "pending");
  }, [o, V, yt, i]);
  const Tt = F(() => e.filter((b) => !b.deleted), [e]);
  Y(() => {
    let b = !0;
    if (!o || !N) {
      Ct(/* @__PURE__ */ new Map());
  ...
  const xt = F(() => Tt[0], [Tt]), qt = j(null), Vt = j(void 0), zt = L(() => {
    var b;
    (b = Vt.current) == null || b.call(Vt), _(Wo);
  }, []), Ve = L(() => {
    const b = !dt;
    wt(b), Kt(!b), m == null || m(d, b);
  }, [dt, m, d]);
  Y(() => {
    R(!1);
  }, [o]), Y(() => {
    if (o && !dt && !ut) {
      ...
      return bt.current = b, () => clearTimeout(b);
    }
  ...
  }, [i, r]), Gt = F(() => Tt.slice(1), [Tt]), St = F(() => Gt.length ?? 0, [Gt.length]), Ht = F(() => St > 0, [St]), we = F(() => q || St <= 2 ? Gt : Gt.slice(-2), [Gt, St, q]), te = F(() => q || St <= 2 ? 0 : St - 2, [St, q]), Ee = F(
    () => St === 1 ? Zt.singleReply : ze(Zt.multipleReplies, { count: St }),
    [St, Zt]
  ), ue = F(
    () => te === 1 ? Zt.singleReply : ze(Zt.multipleReplies, { count: te }),
    [te, Zt]
  );
  Y(() => {
    !o && at && Ht && ot(!1);
  ...
  const ee = L(
    async (b) => {
      ...
      Q && await p({ threadId: d, contents: Q }) && zt();
    },
    [
      zt,
      O,
    ...
    async (b) => {
      const Q = oe(O) ? Jr(O) : void 0, J = b.status ? b.assignedUser : z ?? b.assignedUser, W = await p({
        ...b,
        contents: Q,
        assignedUser: J
      });
      return W && (J !== void 0 && D(J), Q && zt()), W;
    },
    [zt, O, p, z]
  );
  if (Tt.length !== 0)
        ...
        children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              Qt && /* @__PURE__ */ a(yr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Qt }),
              /* @__PURE__ */ a(
                B,
                {
                  variant: "ghost",
                  size: "icon",
                  onClick: (b) => {
                    b.stopPropagation(), Ve();
                  },
                  className: "tw:text-muted-foreground tw:transition tw:hover:text-foreground",
                  "aria-label": dt ? r["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : r["%comment_aria_mark_as_read%"] ?? "Mark as read",
                  children: dt ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(gs, {})
                }
              ),
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("span", { className: t, children: [
                    xt.contextBefore,
                    /* @__PURE__ */ a("span", { className: "tw:font-bold", children: xt.selectedText }),
                    xt.contextAfter
                  ] })
                ]
              }
            ...
            /* @__PURE__ */ a(
              Yo,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: ot,
                canEditOrDelete: (!at && Jt.get(xt.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(nt, { children: [
              te > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (b) => {
                    (b.key === "Enter" || b.key === " ") && (b.preventDefault(), b.stopPropagation(), R(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(or, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: ue }),
                      q ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(nr, {})
                    ] })
                  ]
                }
              ),
              we.map((b) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Yo,
                {
                  comment: b,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: g,
                  onEditingChange: ot,
                  canEditOrDelete: (!at && Jt.get(b.id)) ?? !1
                }
              ) }, b.id)),
              v !== !1 && (!at || oe(O)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (b) => {
                    co(b) && (b.preventDefault(), b.stopPropagation(), (oe(O) || z !== void 0 && z !== S) && ee());
                  },
                  onKeyDown: (b) => {
                    io(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Xr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (oe(O) || z !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ze(
                      ...
                      /* @__PURE__ */ u(Pe, { open: it, onOpenChange: Ut, children: [
                        /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ a(
                          B,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !yt || !k || k.length === 0 || !k.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          Ie,
                          {
                            ...
                            align: "end",
                            onKeyDown: (b) => {
                              b.key === "Escape" && (b.stopPropagation(), Ut(!1));
                            },
                            children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: k == null ? void 0 : k.map((b) => /* @__PURE__ */ a(
                              Ae,
                              {
                                onSelect: () => {
                                  P(b !== i ? b : void 0), M.current = "user-selected", D(void 0), Ut(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Kr(b, r) })
                              },
                              b || "unassigned"
                            )) }) })
                          }
...
function ip({
  ...
  const [E, T] = C(/* @__PURE__ */ new Set()), [N, y] = C(), [I, K] = C(), V = L(
    async (R) => {
      const at = await i(R);
      return at !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && K(R.assignedUser), at;
    },
    [i]
  );
  Y(() => {
    m && (T((R) => new Set(R).add(m)), y(m));
  }, [m]);
  const O = r.filter(
    (R) => R.comments.some((at) => !at.deleted)
  ), _ = O.map((R) => ({ id: R.id })), z = L(
    (R) => {
      T((at) => new Set(at).add(R.id)), y(R.id), k == null || k(R.id);
    },
    [k]
  ), P = L(
    (R) => {
      ...
      T((ot) => {
        const it = new Set(ot);
        return it.has(R) ? it.delete(R) : it.add(R), it;
      }), y(R), k == null || k(at ? void 0 : R);
    },
    [E, k]
  ), { listboxRef: S, activeId: D, handleKeyDown: X } = Fi({
    options: _,
    onOptionSelect: z
  }), q = L(
    (R) => {
      R.key === "Escape" ? (N && E.has(N) && (T((at) => {
        const ot = new Set(at);
        return ot.delete(N), ot;
      }), y(void 0), k == null || k(void 0)), R.preventDefault(), R.stopPropagation()) : X(R);
    },
    [N, E, X, k]
  );
  return /* @__PURE__ */ a(
...
function Fd({ table: t }) {
  return /* @__PURE__ */ u(Me, { children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(ms, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u($e, { align: "end", className: "tw:w-[150px]", children: [
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    It.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(It.Icon, { asChild: !0, children: /* @__PURE__ */ a(Vc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function pe({
  ...
  return /* @__PURE__ */ u(
    It.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(It.ItemIndicator, { children: /* @__PURE__ */ a(aa, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        sr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(dr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(pe, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Nr(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && qd(o)
  );
}
function na({
  className: t,
  ...
  const c = ft.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Yd(g, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Hd(c, k, w.key);
...
function Wd({
  ...
  var K;
  const [w, p] = C([]), [h, g] = C([]), [m, k] = C({}), [v, E] = C({}), T = F(() => e ?? [], [e]), N = Rn({
    data: T,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  }), y = N.getVisibleFlatColumns();
  let I;
  return d ? I = Array.from({ length: 10 }).map((_, z) => `skeleton-row-${z}`).map((_) => /* @__PURE__ */ a(ge, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ne, { colSpan: y.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, _)) : ((K = N.getRowModel().rows) == null ? void 0 : K.length) > 0 ? I = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ge,
    {
      onClick: () => s(V, N),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((O) => /* @__PURE__ */ a(ne, { children: br(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    V.id
  )) : I = /* @__PURE__ */ a(ge, { children: /* @__PURE__ */ a(ne, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Fd, { table: N }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(ge, { children: V.headers.map((O) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: O.isPlaceholder ? void 0 : br(O.column.columnDef.header, O.getContext()) }, O.id)) }, V.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(pn, {}) })
        ] }),
...
function pp({
  ...
  return /* @__PURE__ */ u(Pe, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ a(Ke, { asChild: !0, children: o }),
    /* @__PURE__ */ u(Ie, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
function hp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Me, { children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "default", children: [
      /* @__PURE__ */ a(ks, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(nr, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a($e, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Er, { children: l.label }),
      /* @__PURE__ */ a(cn, { children: l.itemType === 0 ? /* @__PURE__ */ a(nt, { children: l.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        je,
        {
          checked: o[w][h],
...
function fp({
  ...
  const s = F(() => rs(r), [r]), d = ((l) => {
    const w = new Intl.DisplayNames(as(), { type: "language" });
...
function gi({
  ...
  const [E, T] = C(!1), N = L(
    (z) => {
      var S;
      const P = (S = t.find((D) => D.label === z)) == null ? void 0 : S.value;
      P && r(
    ...
    if (!h) return t;
    const z = t.filter((S) => S.starred).sort((S, D) => S.label.localeCompare(D.label)), P = t.filter((S) => !S.starred).sort((S, D) => {
      const X = e.includes(S.value), q = e.includes(D.value);
      return X && !q ? -1 : !X && q ? 1 : S.label.localeCompare(D.label);
    });
    return [...z, ...P];
  }, [t, e, h]), K = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Pe, { open: O, onOpenChange: w ?? T, children: [
    /* @__PURE__ */ a(Ke, { asChild: !0, children: /* @__PURE__ */ u(
      B,
      {
        variant: k,
        ...
        children: [
          ...
          /* @__PURE__ */ a(hn, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(Ie, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(qe, { children: [
        ...
        /* @__PURE__ */ a(xe, { children: I.map((z) => /* @__PURE__ */ u(
          Ae,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Es, { className: "tw:h-4 tw:w-4" }),
...
function ew({
  ...
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      ...
      /* @__PURE__ */ a(le, { children: /* @__PURE__ */ u("p", { children: [
        l,
    ...
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(ui, {}),
    e && /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(
        B,
        {
          "aria-label": w,
  ...
  return Y(() => {
    ...
    const i = /Macintosh/i.test(navigator.userAgent), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      ...
      if (i) {
        ...
        if (!l.ctrlKey) return;
        !l.shiftKey && w === "z" ? (l.preventDefault(), r && ((g = e.current) == null || g.undo())) : (w === "y" || l.shiftKey && w === "z") && (l.preventDefault(), o && ((m = e.current) == null || m.redo()));
      }
    };
    return document.addEventListener("keydown", c), () => document.removeEventListener("keydown", c);
  }, [o, r, e]), /* @__PURE__ */ a("div", { ref: n, children: t });
}
const aw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(nt, { children: [
...
function ow({
  ...
  const i = j(null), s = j(null), c = j(!1), [d, l] = C(t), [w, p] = C(r), [h, g] = C(!1);
  Y(() => {
    l(t);
  }, [t]), Y(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var E, T, N, y;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((T = s.current) == null || T.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((y = s.current) == null || y.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Me, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: aw(t, n, r) }) }) }),
      /* @__PURE__ */ a(le, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      $e,
      {
...
function sw({
  ...
  return /* @__PURE__ */ u(Me, { children: [
    /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: nw(t, r) }) }) }),
      /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("p", { children: iw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u($e, { style: { zIndex: ln }, children: [
  ...
  return /* @__PURE__ */ u(
    Ae,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Ui, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function dw({
  ...
  const [n, i] = C(""), [s, c] = F(() => {
    ...
    const l = e.filter(
      (p) => {
        var h;
        return (h = p.marker) == null ? void 0 : h.toLowerCase().includes(d);
      }
    ), w = e.filter(
  ...
  return /* @__PURE__ */ u(qe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ge, { children: [
      ...
      /* @__PURE__ */ a(xe, { children: s.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          tn,
          {
...
function vp({
  ...
  var ue, ee;
  const h = j(null), g = j(null), m = j(null), k = j(null);
  Ft(() => {
    if (!k.current) return;
    const { width: $ } = k.current.getBoundingClientRect();
    $ > 0 && (k.current.style.width = `${$}px`);
  }, []);
  const [v, E] = C("generated"), [T, N] = C("generated"), [y, I] = C("*"), [K, V] = C("*"), [O, _] = C("f"), [z, P] = C(!1), [S, D] = C(!0), [X, q] = C(!1), R = j(!1), at = j(""), [ot, it] = C(!1), [Ut, yt] = C(), [$t, U] = C(), [lt, dt] = C(), [wt, ut] = C(), Kt = j(null), bt = j(void 0), Jt = j(0), Ct = F(
    () => ({
      ...c,
      ...
      markerMenuTrigger: d,
      hasExternalUI: !0,
      view: { ...c.view ?? tl(), noteMode: "expanded" }
    }),
    [c, d]
  ), M = j((ue = Ct.view) == null ? void 0 : ue.markerMode);
  Ft(() => {
    var $;
    M.current = ($ = Ct.view) == null ? void 0 : $.markerMode;
  });
  const Tt = F(
    () => ww(
      h,
  ...
  Y(() => {
    ...
    if (b && Pr("note", b)) {
      const W = (Q = b.insert.note) == null ? void 0 : Q.caller;
      let H = "custom";
      W === Pa ? H = "generated" : W === Ia ? H = "hidden" : W && (I(W), V(W)), E(H), N(H), _(((J = b.insert.note) == null ? void 0 : J.style) ?? "f"), $ = setTimeout(() => {
        var rt, pt, mt;
        const ct = M.current === "editable" ? [{ retain: fw }, b] : [b];
        (rt = h.current) == null || rt.applyUpdate(ct), s && ((pt = h.current) == null || pt.selectNote(0), (mt = h.current) == null || mt.focus());
      }, 0);
    }
    return () => {
      $ && clearTimeout($);
  ...
  const xt = L(
    ($, b, Q = !1) => {
      var W, H, ct;
      const J = (H = (W = h.current) == null ? void 0 : W.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (J && Pr("note", J)) {
        if (J.insert.note) {
          let rt;
          $ === "custom" ? rt = b : $ === "generated" ? rt = Pa : rt = Ia, J.insert.note.caller = rt;
        }
        r == null || r([J]), Q && w && i && ((ct = w.current) == null || ct.replaceEmbedUpdate(i, [J]));
      }
    },
    [i, r, w]
  ), qt = L(() => {
  ...
  const zt = j({ book: n.book, chapterNum: n.chapterNum });
  Ft(() => {
    (zt.current.book !== n.book || zt.current.chapterNum !== n.chapterNum) && (zt.current = { book: n.book, chapterNum: n.chapterNum }, Vt.current());
  }, [n.book, n.chapterNum]);
  const Ve = () => {
    var b;
    const $ = (b = g.current) == null ? void 0 : b.getElementsByClassName("editor-input")[0];
    ...
    var Q, J, W, H, ct;
    _($);
    const b = (J = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : J.at(0);
    if (b && Pr("note", b)) {
      b.insert.note && (b.insert.note.style = $);
      const rt = (H = (W = b.insert.note) == null ? void 0 : W.contents) == null ? void 0 : H.ops;
      O !== "x" && $ === "x" ? rt == null || rt.forEach((pt) => pw(pt)) : O === "x" && $ !== "x" && (rt == null || rt.forEach((pt) => hw(pt))), (ct = h.current) == null || ct.applyUpdate([b, { delete: 1 }]);
    }
  }, St = ($) => {
    ut($.contextMarker), q($.canRedo);
  }, Ht = L(
    ($) => {
      var Q, J, W, H, ct;
      const b = (J = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (b && Pr("note", b)) {
        $.content.length > 1 && setTimeout(() => {
          var mt;
          (mt = h.current) == null || mt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const rt = (W = b.insert.note) == null ? void 0 : W.style, pt = (ct = (H = b.insert.note) == null ? void 0 : H.contents) == null ? void 0 : ct.ops;
        if (rt || P(!1), P(
          rt === "x" ? !!(pt != null && pt.every((mt) => {
            var Yt, re;
            if (!((Yt = mt.attributes) != null && Yt.char)) return !0;
            const Nt = ((re = mt.attributes) == null ? void 0 : re.char).style;
          ...
          R.current = !0, at.current = JSON.stringify(b), D(!0);
          return;
        }
        D(JSON.stringify(b) === at.current), xt(v, y);
      } else
        P(!1), D(!0);
    },
    [v, y, xt]
    ...
    if (m.current && Tt.length && $ && $.rangeCount > 0) {
      const b = $.getRangeAt(0).getBoundingClientRect(), Q = m.current.getBoundingClientRect();
      yt(b.left - Q.left), U(b.top - Q.top), dt(b.height), it(!0);
    }
  }, [Tt, m]), te = L(
    ($, b, Q) => {
      const { anchorRect: J } = $;
      if (!p || !J) return;
      const { passive: W, literalPrefixLanded: H } = Q;
      Jt.current += 1;
      const ct = Jt.current;
      bt.current = W ? { token: ct, literalPrefixLanded: H, filter: "", items: b } : void 0, p.show(b.map(uw), J, W).then((rt) => {
        var pt, mt, Nt;
        if (en(bt, ct), rt !== void 0) {
          const Yt = b.find((re) => re.marker === rt);
          Yt && ((pt = h.current) == null || pt.applyMarkerMenuSelection(Yt, {
            trigger: "backslash",
            literalPrefixLanded: H
          })), (mt = h.current) == null || mt.focus();
        } else W || (Nt = h.current) == null || Nt.focus();
      }).catch(() => {
        var rt;
        en(bt, ct), W || (rt = h.current) == null || rt.focus();
      });
    },
    [p]
  );
  Y(() => {
    ...
    var $;
    ot && (($ = Kt.current) == null || $.focus());
  }, [ot]), Y(() => {
    var Q, J;
    const $ = ((Q = g.current) == null ? void 0 : Q.querySelector(".editor-input")) ?? void 0;
    if (((J = Ct.view) == null ? void 0 : J.markerMode) === "editable") {
      if (!p) return () => {
      };
      const W = (H) => {
        var Nt;
        ...
        const ct = bt.current;
        if (ct) {
          if (H.key === "Shift" || H.key === "Control" || H.key === "Alt" || H.key === "Meta")
            return;
          if (H.key === "ArrowDown" || H.key === "ArrowUp") {
            H.preventDefault(), p.update({ moveSelection: H.key === "ArrowDown" ? 1 : -1 });
            return;
          }
          if (H.key === "Enter") {
            H.preventDefault(), bt.current = void 0, p.commit();
            return;
          }
          if (H.key === "Escape") {
            H.preventDefault(), bt.current = void 0, p.dismiss();
            return;
          }
          if (H.key === " " || H.key === "*") {
            bt.current = void 0, p.dismiss();
            return;
          }
          if (H.key === "Backspace" || /^[a-z0-9+]$/.test(H.key)) {
            ct.filter = H.key === "Backspace" ? ct.filter.slice(0, -1) : ct.filter + H.key, p.update({ filterText: ct.filter });
            return;
          }
          bt.current = void 0, p.dismiss();
          return;
        ...
        if (H.key !== d) return;
        const rt = (Nt = h.current) == null ? void 0 : Nt.getMarkerMenuContext();
        if (!rt) return;
        const pt = rl(Ct.styleInfo ?? al, rt);
        if (pt.length === 0) return;
        const mt = !rt.hasTextSelection;
        mt || H.preventDefault(), te(rt, pt, { passive: mt, literalPrefixLanded: mt });
      };
    ...
    const b = (W) => {
      !ot && $ && document.activeElement === $ && W.key === d ? (W.preventDefault(), we()) : ot && W.key === "Escape" && (W.preventDefault(), it(!1));
    };
    ...
    we,
    d,
    (ee = Ct.view) == null ? void 0 : ee.markerMode,
    Ct.styleInfo,
    p,
    te
  ]);
  ...
  return /* @__PURE__ */ u(nt, { children: [
    /* @__PURE__ */ u("div", { ref: k, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(so, { children: [
          /* @__PURE__ */ a(
            ew,
            {
              onUndoClick: () => {
                var $;
                return ($ = h.current) == null ? void 0 : $.undo();
              },
              onRedoClick: () => {
                var $;
                return ($ = h.current) == null ? void 0 : $.redo();
              },
              canUndo: !S,
              canRedo: X,
              localizedStrings: l
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
              /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(
                B,
                {
                  "aria-label": Ee,
              ...
              /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("p", { children: Ee }) })
            ] }) }) })
          ]
        }
      )
    ...
    /* @__PURE__ */ u(Pe, { open: ot, children: [
      /* @__PURE__ */ a(
        Ki,
        {
          className: "tw:absolute",
...
function bw({
  ...
  /* @__PURE__ */ u("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    wo(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", k = f(h, g);
  return /* @__PURE__ */ u(nt, { children: [
    /* @__PURE__ */ u("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: [
      d,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: f(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(nt, { children: mw(t.marker, c, o, l) })
      }
    )
  ] });
}
function xp({
  ...
  const w = d ?? os(r, void 0), p = (T, N) => {
    l == null || l(T, N, n);
  }, h = i ? r.findIndex((T) => T === i) : -1, [g, m] = C(h), k = (T, N, y) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
          T.preventDefault(), l == null || l(N, y, n);
          break;
      }
  }, v = (T) => {
    if (r.length)
      switch (T.key) {
        case "ArrowDown":
          T.preventDefault(), m((N) => Math.min(N + 1, r.length - 1));
          break;
        case "ArrowUp":
          T.preventDefault(), m((N) => Math.max(N - 1, 0));
          break;
      }
  }, E = j([]);
  return Y(() => {
    var T;
    g >= 0 && g < E.current.length && ((T = E.current[g]) == null || T.focus());
  }, [g]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((T, N) => {
            ...
            return /* @__PURE__ */ u(nt, { children: [
              ...
              N < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(or, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function yw({
  ...
  return /* @__PURE__ */ u(na, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(lo, { stickyHeader: !0, children: /* @__PURE__ */ u(ge, { children: [
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ge,
      {
        ...
        children: [
          /* @__PURE__ */ a(ne, { children: Se(c.reference, "English") }),
          /* @__PURE__ */ a(ne, { className: o, children: xw(c.text) })
        ]
      },
...
const kw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
  /* @__PURE__ */ u(
    ce,
    {
  ...
  /* @__PURE__ */ a(le, { side: "bottom", children: e })
] }) }), yp = (t) => ({
  accessorKey: "item",
...
function zp({
  ...
  const g = me(r, "%webView_inventory_all%"), m = me(r, "%webView_inventory_approved%"), k = me(r, "%webView_inventory_unapproved%"), v = me(r, "%webView_inventory_unknown%"), E = me(r, "%webView_inventory_scope_currentBook%"), T = me(r, "%webView_inventory_scope_chapter%"), N = me(r, "%webView_inventory_scope_verse%"), y = me(r, "%webView_inventory_filter_text%"), I = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), K = me(r, "%webView_inventory_no_results%"), [V, O] = C(!1), [_, z] = C("all"), [P, S] = C(""), [D, X] = C([]), q = F(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : Ew(U, n, i);
  }, [t, n, i]), R = F(() => {
    if (V) return q;
    const U = [];
    return q.forEach((lt) => {
      const dt = lt.items[0], wt = U.find(
        (ut) => ut.items[0] === dt
      );
      wt ? (wt.count += lt.count, wt.occurrences = wt.occurrences.concat(lt.occurrences)) : U.push({
        items: [dt],
        count: lt.count,
  ...
  }, [V, q]), at = F(() => R.length === 0 ? [] : Cw(R, _, P), [R, _, P]), ot = F(() => {
    var dt, wt;
    if (!V) return d;
    const U = (dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt.length;
    if (!U) return d;
    const lt = [];
    for (let ut = 0; ut < U; ut++)
      lt.push(
        _w(
  ...
  Y(() => {
    at.length === 0 ? X([]) : at.length === 1 && X(at[0].items);
  }, [at]);
  const it = (U, lt) => {
    lt.setRowSelection(() => {
      const wt = {};
    ...
    const dt = U.original.items;
    X(dt), h && dt.length > 0 && h(dt[0]);
  }, Ut = (U) => {
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        sr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(dr, { children: [
              ...
              /* @__PURE__ */ a(pe, { value: "unapproved", children: k }),
              /* @__PURE__ */ a(pe, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(sr, { onValueChange: (U) => Ut(U), defaultValue: s, children: [
        /* @__PURE__ */ a(lr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(cr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(dr, { children: [
          /* @__PURE__ */ a(pe, { value: "book", children: E }),
          /* @__PURE__ */ a(pe, { value: "chapter", children: T }),
          /* @__PURE__ */ a(pe, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Dr,
      ...
      o && /* @__PURE__ */ a(ie, { children: /* @__PURE__ */ u(se, { children: [
        /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            mi,
            {
        ...
        /* @__PURE__ */ a(le, { children: (o == null ? void 0 : o.checkboxText) ?? I })
      ] }) })
    ] }),
...
const vi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ps, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
vi.displayName = "Spinner";
function Tw(t, e = 50) {
  const [r, o] = C(e), n = j(null);
  return Y(() => {
    o(e);
  }, [t, e]), Y(() => {
...
function Ca({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(nt, { children: [
      /* @__PURE__ */ a(ge, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(ne, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        ge,
        {
          ...
          children: [
            /* @__PURE__ */ a(ne, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(nt, { children: [
              /* @__PURE__ */ a(Be, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
              /* @__PURE__ */ a("span", { className: "tw:sr-only", children: t })
            ] }) }),
            /* @__PURE__ */ a(ne, { className: "tw:border-0 tw:py-1 tw:pr-2 tw:font-normal tw:whitespace-nowrap", children: o.displayName }),
            /* @__PURE__ */ a(ne, { className: "tw:border-0 tw:py-1 tw:pl-2", children: o.fullName }),
            /* @__PURE__ */ a(ne, { className: "tw:border-0 tw:py-1 tw:pl-4 tw:text-right tw:text-muted-foreground", children: o.bestLanguageName })
          ]
        },
        o.dblEntryUid
      ))
...
function Dp({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = F(
    () => t.filter((D) => !r || D.type === r).filter((D) => zw(D, s)).filter(
      (D) => d.length === 0 || d.includes(D.bestLanguageName)
    ),
    [t, r, s, d]
  ), p = F(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: k, hasMore: v } = Tw(g), E = F(
    () => Array.from(new Set(t.map((D) => D.bestLanguageName))).map((D) => ({
      label: D,
      value: D
    })),
    [t]
  ), T = p.length === 0 && h.length === 0 && g.length === 0, N = Te(n, "%resourcePicker_title%"), y = Te(n, "%resourcePicker_search_placeholder%"), I = Te(n, "%resourcePicker_language_filter_any%"), K = Te(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = Te(n, "%resourcePicker_section_installed%"), O = Te(
    n,
    "%resourcePicker_section_available_to_download%"
  ), _ = Te(n, "%resourcePicker_no_results%"), z = Te(n, "%resourcePicker_showing_count%"), P = F(() => {
    if (d.length === E.length || d.length === 0)
      return I;
    if (d.length === 1) {
      const D = E.find((X) => X.value === d[0]);
      if (D) return D.label;
    }
    return ze(
      Te(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
        selectCount: d.length
      }
    );
  }, [d, E, I, n]), S = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(nt, { children: [
    /* @__PURE__ */ a(qr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Gr, { children: N }) }),
    ...
    S && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ze(z, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(vi, {}) }),
      T && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: _ }),
      !T && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        /* @__PURE__ */ a(Ca, { label: K, resources: p }),
        /* @__PURE__ */ a(Ca, { label: V, resources: h, onSelect: i }),
        /* @__PURE__ */ a(
          Ca,
          {
            label: O,
        ...
        v && /* @__PURE__ */ a(ge, { className: "tw:border-0", children: /* @__PURE__ */ a(ne, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: k, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Sw = "16rem", Dw = "3rem", bi = ft.createContext(void 0);
function la() {
  const t = ft.useContext(bi);
  if (!t)
...
function Mw({
  ...
  const [d, l] = ft.useState(t), w = e ?? d, p = ft.useCallback(
    (N) => {
      const y = typeof N == "function" ? N(w) : N;
      r ? r(y) : l(y);
    },
    [r, w]
  ), h = ft.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", v = Bt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ft.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(bi.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Mp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    B,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Lc, {}) : /* @__PURE__ */ a(Fc, {}),
...
function Vw({
  ...
  const c = t ? ur.Root : "button", { state: d } = la(), l = /* @__PURE__ */ a(
    c,
    {
  ...
  return n ? /* @__PURE__ */ u(se, { children: [
    /* @__PURE__ */ a(ce, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      le,
      {
        side: "right",
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u(Rw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Aw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Pw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => l(g),
              isActive: h(g),
...
const Le = "scrBook", Fw = "scrRef", Xe = "source", jw = "details", Bw = "Scripture Reference", Uw = "Scripture Book", xi = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? gt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Le ? Se(n.start) : void 0;
      },
...
}, nn = (t) => `${Gw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qp({
  sources: t,
  ...
  const [l, w] = C([]), [p, h] = C([{ id: Le, desc: !1 }]), [g, m] = C({}), k = F(
    () => t.flatMap((_) => _.data.map((z) => ({
      ...z,
      source: _.source
    }))),
    [t]
  ...
  Y(() => {
    if (c) {
      const _ = E.getSelectedRowModel().rowsById, z = Object.keys(_);
      if (z.length === 1) {
        const P = k.find((S) => nn(S) === z[0]) || void 0;
        P && c(P);
      }
    }
  }, [g, k, c, E]);
  const T = n ?? Uw, N = i ?? xi, y = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${T}`, value: [Le] },
    ...
    !_.getIsGrouped() && !_.getIsSelected() && _.getToggleSelectedHandler()(z);
  }, V = (_, z) => _.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), O = (_, z, P) => {
    if (!((_ == null ? void 0 : _.length) === 0 || z.depth < P.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(jd, { children: y.map((_) => /* @__PURE__ */ a(pe, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: E.getHeaderGroups().map((_) => /* @__PURE__ */ a(ge, { children: _.headers.filter((z) => z.column.columnDef.header).map((z) => (
      ...
      /* @__PURE__ */ a(ia, { children: E.getRowModel().rows.map((_, z) => {
        const P = Bt();
        return /* @__PURE__ */ a(
          ge,
          {
            ...
            className: f(V(_, z)),
            onClick: (S) => K(_, S),
            children: _.getVisibleCells().map((S) => {
              if (!(S.getIsPlaceholder() || S.column.columnDef.enableGrouping && !S.getIsGrouped() && (S.column.columnDef.id !== Xe || !r)))
                return /* @__PURE__ */ a(
                  ne,
                  {
                    className: f(
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ a(nr, {}),
                          !_.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
...
const ki = (t, e, r) => uo(t, e).every((o) => r.includes(o));
function Hw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: m } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [k, v] = C(!1), [E, T] = C(""), N = j(void 0), y = j(!1), I = F(
    () => yi(t),
    [t]
  ), K = F(() => {
    if (!E.trim()) {
    ...
    (S, D = !1) => {
      if (!D || !N.current) {
        r(
          e.includes(S) ? e.filter((it) => it !== S) : [...e, S]
        ), N.current = S;
        return;
      }
      const X = I.findIndex((it) => it === N.current), q = I.findIndex((it) => it === S);
      if (X === -1 || q === -1) return;
      const [R, at] = [
        Math.min(X, q),
        Math.max(X, q)
      ], ot = I.slice(R, at + 1).map((it) => it);
      r(
        e.includes(S) ? e.filter((it) => !ot.includes(it)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, r, I]
  ), O = (S) => {
    V(S, y.current), y.current = !1;
  }, _ = (S, D) => {
    S.preventDefault(), V(D, S.shiftKey);
  }, z = () => {
    r(I.map((S) => S));
  }, P = () => {
    r([]);
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ie, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          qe,
          {
            shouldFilter: !1,
            onKeyDown: (S) => {
              S.key === "Enter" && (y.current = S.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                Cr,
              ...
              /* @__PURE__ */ u(Ge, { children: [
                ...
                Object.values(et).map((S, D) => {
                  const X = K[S];
                  if (X.length !== 0)
                    return /* @__PURE__ */ u(bn, { children: [
                      /* @__PURE__ */ a(
                        xe,
                        {
                          heading: In(S, p, h, g, m),
                          children: X.map((q) => /* @__PURE__ */ a(
                            Ln,
                            {
                              bookId: q,
                      ...
                      D < Object.values(et).length - 1 && /* @__PURE__ */ a(dn, {})
                    ] }, S);
                })
              ] })
            ]
...
function Yw({
  ...
  return /* @__PURE__ */ a(
    B,
    {
      ...
      onClick: () => o(t),
      className: f(
        ki(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: ll(
        t,
...
function Ww({
  ...
  const i = o["%webView_book_selector_more%"], s = F(
    ...
    (d) => {
      ...
      r(
        ki(s, d, e) ? e.filter((w) => !l.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...l])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ea ? Ea : sn
      ).map((d) => /* @__PURE__ */ a(yr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Fe(d, n) }, d)),
...
function Hp({
  ...
  const y = Mt(
    s,
    "%webView_scope_selector_selected_text%"
  ), I = Mt(s, "%webView_scope_selector_verse%"), K = Mt(s, "%webView_scope_selector_chapter%"), V = Mt(s, "%webView_scope_selector_book%"), O = Mt(
    s,
    "%webView_scope_selector_current_verse%"
  ), _ = Mt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = Mt(s, "%webView_scope_selector_current_book%"), P = Mt(s, "%webView_scope_selector_choose_books%"), S = Mt(s, "%webView_scope_selector_scope%"), D = Mt(s, "%webView_scope_selector_select_books%"), X = Mt(s, "%webView_scope_selector_range%"), q = Mt(s, "%webView_scope_selector_select_range%"), R = Mt(s, "%webView_scope_selector_range_start%"), at = Mt(s, "%webView_scope_selector_range_end%"), ot = Mt(s, "%webView_scope_selector_ok%"), it = Mt(s, "%webView_scope_selector_cancel%"), Ut = Mt(s, "%webView_scope_selector_navigate%"), yt = (A) => {
    if (!m) return;
  ...
  ], U = (A, Z, Lt = !1) => /* @__PURE__ */ u(nt, { children: [
    A,
    Z && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), lt = e ? $t.filter((A) => e.includes(A.value)) : $t, dt = m ?? pa, wt = w ?? dt, ut = p ?? dt, Kt = () => {
  }, bt = j(null), Jt = j(null), Ct = j(!1), M = j(null), Tt = j(!1), [xt, qt] = C(void 0), Vt = j(!1), zt = j(!1), Ve = j(null), Zt = L((A) => {
    if (A) {
      qt("start"), Vt.current = !1;
      return;
    }
    qt((Z) => Z === "start" ? void 0 : Z), Vt.current && (Vt.current = !1, requestAnimationFrame(() => {
      var Lt;
    ...
    (A) => {
      h == null || h(A), g == null || g(A), Vt.current = !0;
    },
    [h, g]
  ), St = L(
    (A) => {
      g == null || g(A), zt.current = !0;
    },
    [g]
  ), Ht = L(
    (A) => {
    ...
    [r, n, m, i]
  ), we = lt.find((A) => A.value === t), te = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? is(wt, ut, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : we ? U(we.label, we.scrRefSuffix) : t, Ee = lt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), ue = lt.find((A) => A.value === "selectedBooks"), ee = lt.find((A) => A.value === "range"), [$, b] = C(!1), [Q, J] = C(void 0), [W, H] = C(void 0), [ct, rt] = C(void 0), [pt, mt] = C(void 0), [Nt, Yt] = C([]), re = l === "dropdown" && Q === "selectedBooks", x = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
      selectedBookIds: re ? Nt : n,
      onChangeSelectedBookIds: re ? Yt : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), G = xt === "end", tt = xt === "start", Et = "tw:text-muted-foreground", ae = l === "dropdown" && Q === "range", tr = ae ? rt : Gt, Rt = ae ? mt : g ? St : Kt, kt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(G && Et), children: R }),
      /* @__PURE__ */ a(
        ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: bt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: f(tt && Et), children: at }),
      /* @__PURE__ */ a(
        ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: ae ? ct ?? wt : wt,
          onOpenChange: Qt,
          onCloseAutoFocus: (A) => {
            var Z;
            zt.current && (zt.current = !1, A.preventDefault(), (Z = Ve.current) == null || Z.focus());
          },
          className: f(tt && Et),
          modal: !0,
          align: "start"
  ...
  const [Xt, Ye] = C(null), [Mr, Di] = C(null), [Or, Mi] = C(null), Oi = 200, [$i, Ri] = C(!1);
  Y(() => {
    if (!Or || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([Z]) => {
      Ri(Z.contentRect.width < Oi);
    });
    return A.observe(Or), () => A.disconnect();
  }, [Or]);
  const po = L(
    (A) => {
      H(A), rt(wt), mt(ut), Yt(n), b(!1), J(A);
    },
    [wt, ut, n]
  ), ho = L(() => {
    W !== void 0 && (W === "range" ? (ct && (h == null || h(ct)), pt && (g == null || g(pt))) : W === "selectedBooks" && i(Nt), Ht(W), J(void 0), H(void 0));
  }, [
    W,
    ct,
    pt,
    ...
    var Z;
    A.preventDefault(), (Z = Wt.current) == null || Z.focus();
  }, []), fo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Be, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(_t, { children: S }),
      l === "dropdown" ? /* @__PURE__ */ u(Me, { open: $, onOpenChange: b, children: [
        ...
        /* @__PURE__ */ a(
          $e,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: Or, children: [
              Ee.map(({ value: A, label: Z, dropdownLabel: Lt, scrRefSuffix: gr, id: Ai }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: vt(A),
              ...
              k && /* @__PURE__ */ u(nt, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Ut }),
                /* @__PURE__ */ a(
                  Je,
                  {
                    ref: M,
                    ...
                    onSelect: (A) => {
                      ...
                      Tt.current || (Lt = (Z = Jt.current) == null ? void 0 : Z.querySelector("button")) == null || Lt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          Z != null && Z.closest("button") && (Ct.current = !0, requestAnimationFrame(() => {
                            Ct.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ga,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var Z;
                              A.preventDefault(), (Z = M.current) == null || Z.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(nt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Se(m ?? pa, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Bn,
        {
          ...
          children: lt.map(({ value: A, label: Z, scrRefSuffix: Lt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Fa, { className: "tw:me-2", value: A, id: gr }),
            /* @__PURE__ */ a(_t, { htmlFor: gr, children: U(Z, Lt) })
          ] }, gr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && kt,
    l === "dropdown" && ue && /* @__PURE__ */ a(Va, { open: Q === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Di,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (A) => {
          Mr != null && Mr.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(da, { container: Mr, children: [
          /* @__PURE__ */ a(qr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Gr, { children: P }) }),
          x,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => $r(!1), children: it }),
            /* @__PURE__ */ a(B, { onClick: ho, children: ot })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ee && /* @__PURE__ */ a(Va, { open: Q === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Ye,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (A) => {
          Xt != null && Xt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(da, { container: Xt, children: [
          /* @__PURE__ */ a(qr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Gr, { children: q }) }),
          kt,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => $r(!1), children: it }),
            /* @__PURE__ */ a(B, { ref: Ve, onClick: ho, children: ot })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: wr },
            children: t.map((l) => /* @__PURE__ */ a(pe, { value: `${l}`, children: c[vo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Ni = (t, e, r, o) => r ? Object.entries(t).filter(
  ([i, s]) => "column" in s && s.column === r || i === r
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(se, { children: [
  /* @__PURE__ */ a(ce, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Je,
    {
      onClick: () => {
        o(c);
    ...
    /* @__PURE__ */ a(Yi, { children: c.label }),
    /* @__PURE__ */ a(Wi, { children: /* @__PURE__ */ a(Xi, { children: Ni(
      t,
      e,
      _i(t, c.id),
      o
  ...
  c.tooltip && /* @__PURE__ */ a(le, { children: c.tooltip })
...
function qa({
  ...
  return /* @__PURE__ */ u(Me, { variant: i, children: [
    /* @__PURE__ */ a(Oe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a($e, { align: "start", style: { zIndex: wr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(bn, { children: [
      /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(ie, { children: Ni(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ze, {})
    ] }, d)) })
  ] });
}
const Ci = ft.forwardRef(
...
function Zp({
  ...
  return /* @__PURE__ */ u(Ci, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      qa,
      {
        onSelectMenuItem: t,
...
function Qp({
  ...
  return /* @__PURE__ */ a(Ci, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    qa,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Ei = ft.forwardRef(({ className: t, ...e }, r) => {
  const o = Bt();
  return /* @__PURE__ */ a(
    fe.Root,
    {
...
Ei.displayName = fe.List.displayName;
const Ti = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.List,
  {
    ref: r,
    className: f(
...
Ti.displayName = fe.List.displayName;
const Zw = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
)), zi = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Content,
  {
    ref: r,
    className: f(
...
zi.displayName = fe.Content.displayName;
function th({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ei, { children: [
      /* @__PURE__ */ a(Ti, { children: t.map((c) => /* @__PURE__ */ a(Zw, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(zi, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function Qw({
  ...
  return /* @__PURE__ */ a(Ji.Provider, { value: o, children: /* @__PURE__ */ a(
    Ne.Root,
    {
      "data-slot": "menubar",
      className: f(
...
const mr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(se, { children: [
      /* @__PURE__ */ a(ce, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ou,
        {
          onClick: () => {
            o(l);
      ...
      l.tooltip && /* @__PURE__ */ a(le, { children: l.tooltip })
...
function lu({
  ...
  const n = j(void 0), i = j(void 0), s = j(void 0), c = j(void 0), d = j(void 0), l = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), mr(i, [h, g]);
        break;
      case "alt+l":
        (k = s.current) == null || k.focus(), mr(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), mr(c, [h, g]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), mr(d, [h, g]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: wr },
          children: /* @__PURE__ */ a(ie, { children: Si(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ah({
  ...
  const l = du(
    ...
    var E, T, N, y, I, K;
    const v = k !== m ? ((T = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : T[k]) ?? ((y = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : y.en) : void 0;
    return v ? `${(I = t[m]) == null ? void 0 : I.autonym} (${v})` : (K = t[m]) == null ? void 0 : K.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: f("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: ze(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Me, { children: [
              /* @__PURE__ */ a(Oe, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
              /* @__PURE__ */ a($e, { align: "end", children: l })
            ] }) }),
...
function xh({
  ...
  return /* @__PURE__ */ u(
    Ot.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Ot.ItemIndicator, { children: /* @__PURE__ */ a(aa, {}) }) }),
        e
      ]
    }
  );
...
function Vh({
  ...
  return /* @__PURE__ */ a(
    fe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", fu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
bu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  ph as ContextMenuPortal,
  gh as ContextMenuRadioGroup,
  yh as ContextMenuRadioItem,
  _h as ContextMenuSeparator,
  Nh as ContextMenuShortcut,
  hh as ContextMenuSub,
  bh as ContextMenuSubContent,
  vh as ContextMenuSubTrigger,
  wh as ContextMenuTrigger,
  Wd as DataTable,
  Va as Dialog,
  Ku as DialogClose,
  La as DialogContent,
  ...
  Gh as DropdownMenuShortcut,
  Hi as DropdownMenuSub,
  Xi as DropdownMenuSubContent,
  Yi as DropdownMenuSubTrigger,
  ...
  Xh as ResizableHandle,
  Jh as ResizablePanel,
  Zh as ResizablePanelGroup,
  Dp as ResourcePickerDialog,
  nh as ResultsCard,
