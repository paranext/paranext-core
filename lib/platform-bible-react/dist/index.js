...
var Wt = (t, e, r) => Fi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Oe, a as qa, C as ze, A as he, P as Ve, b as er, B as X, d as Le, e as je, f as Fe, h as Te, i as Bi, k as Ui, j as Ki, E as qi, l as Ga, r as xe, m as Gi, n as un, o as ta, p as ea, L as St, R as Ha, q as Gr, D as Ea, s as Ta, t as Sa, u as za, T as pn, v as Vr, w as Bt, x as Ya, y as Ut, z as Kt, F as qt, G as hn, H as Wa, I as Ze, J as _r, K as Be, M as Ue, N as Ke, S as Nr, O as sr, Q as Hi, U as Tr, V as tr, W as Ie, Z as rr, X as $e, Y as cr, _ as Xa, $ as Ja, a0 as Hr, a1 as Za, a2 as gn, a3 as Yi, a4 as Wi, a5 as Xi, a6 as Ra, a7 as fn, a8 as ra, a9 as mn, aa as Ji, ab as Zi, ac as Qi, ad as ts, ae as vn, af as bn, ag as Qa, ah as es, ai as xn, aj as la, ak as ko, al as da, am as rs, an as as, ao as os, ap as ns, aq as is, ar as Sr, as as to, at as ss, au as cs } from "./resizable-DlO-uoQ8.js";
import { av as bg, aw as xg, ax as yg, ay as kg, az as _g, aA as Ng, aB as Cg, aC as Eg, aD as Tg, aE as Sg, aF as zg, aG as Rg, aH as Dg, aI as Mg, aJ as Og, aK as $g, aL as Ig, aM as Ag, aN as Pg, aO as Vg, aP as Lg, aQ as jg, aR as Fg, aS as Bg, aT as Ug } from "./resizable-DlO-uoQ8.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as It } from "@sillsdev/scripture";
import { Check as Ae, Clock as _o, ChevronsLeft as No, ChevronsRight as Co, ChevronLeft as Da, ChevronRight as Ma, ArrowLeft as ls, ArrowRight as ds, ChevronDown as wr, BoldIcon as ws, ItalicIcon as us, X as eo, AtSign as yn, Pencil as ps, Trash2 as hs, ArrowUp as kn, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as _n, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, Undo as Ss, Redo as zs, SquareX as Nn, FunctionSquare as Cn, SquareSigma as En, Ban as Rs, AlertCircle as Oa, CircleCheckIcon as Ds, CircleXIcon as Ms, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as Is, ScrollText as As, ChevronsUpDown as Ps, MenuIcon as Vs, Menu as Ls, EllipsisVertical as js, MoreVertical as Fs } from "lucide-react";
import { Section as wt, getChaptersForBook as Bs, formatScrRef as Ce, getSectionForBook as Lr, formatRelativeDate as Us, formatReplacementString as Qe, sanitizeHtml as ro, NumberFormat as Tn, formatBytes as Ks, getCurrentLocale as qs, MODIFIER_KEYS as Gs, usfmMarkers as jr, getFormatCallerFunction as Hs, deepEqual as Ys, isString as Eo, compareScrRefs as $a, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Ws, getLocalizeKeyForScrollGroupId as To, formatReplacementStringToArray as So, collectUsjMarkers as Xs } from "platform-bible-utils";
import Jt, { useRef as K, useMemo as A, useState as _, useCallback as j, useEffect as G, useImperativeHandle as Js, useLayoutEffect as oe, createContext as ao, useContext as Sn, Component as Zs, createElement as zo, Suspense as Qs, forwardRef as zn, useId as Ro, Fragment as aa } from "react";
import { IconSelector as Rn, IconCheck as oa, IconChevronDown as tc, IconChevronUp as ec, IconLayoutSidebar as rc, IconLayoutSidebarRight as ac, IconChevronRight as Dn, IconSearch as oc, IconLoader as nc, IconAlertOctagon as ic, IconAlertTriangle as sc, IconInfoCircle as cc, IconCircleCheck as lc } from "@tabler/icons-react";
import { createEditor as Mn, $getRoot as Pe, $createParagraphNode as zr, $getSelection as ee, HISTORY_MERGE_TAG as oo, ParagraphNode as On, TextNode as $n, $getPreviousSelection as dc, $isRangeSelection as ve, $caretFromPoint as wc, $getSiblingCaret as In, $getChildCaret as uc, $getAdjacentChildCaret as pc, $isChildCaret as hc, $normalizeCaret as gc, $setSelectionFromCaretRange as fc, $getCollapsedCaretRange as mc, $getCaretInDirection as Do, $splitAtPointCaretNext as vc, $isTextPointCaret as bc, $findMatchingParent as An, $isElementNode as Cr, mergeRegister as Se, getDOMTextNode as xc, isHTMLElement as yc, CLEAR_EDITOR_COMMAND as Pn, COMMAND_PRIORITY_EDITOR as no, shallowMergeConfig as kc, defineExtension as ce, safeCast as ar, createState as _c, FORMAT_TEXT_COMMAND as Vn, $isNodeSelection as Ln, COMMAND_PRIORITY_LOW as jn, RootNode as Nc, LineBreakNode as Cc, TabNode as Ec, $isEditorState as Tc, createCommand as Sc, CLICK_COMMAND as zc, isDOMNode as Rc, $getNodeFromDOMNode as Dc, $createNodeSelection as Mc, $setSelection as Oc, $getEditor as $c, DecoratorNode as Ia, $getState as Ic, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as Ac, $setState as Pc, addClassNamesToElement as Fn, $create as Vc, $getNodeByKey as Lc, removeClassNamesFromElement as jc, KEY_TAB_COMMAND as Fc, $isBlockElementNode as Bc, $createRangeSelection as Uc, $normalizeSelection__EXPERIMENTAL as Kc, OUTDENT_CONTENT_COMMAND as qc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Gc, COMMAND_PRIORITY_CRITICAL as io, $isDecoratorNode as Hc, $isParagraphNode as Yc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Bn, $insertNodes as Wc } from "lexical";
...
import { Avatar as so, Select as Zt, Checkbox as $o, Slot as Rr, Tabs as ge, Menubar as ye, ContextMenu as At, Progress as Io, Slider as Mr, Switch as Ao } from "radix-ui";
import { useReactTable as Kn, getFilteredRowModel as ol, getSortedRowModel as qn, getPaginationRowModel as nl, getCoreRowModel as Gn, flexRender as yr, getGroupedRowModel as il, getExpandedRowModel as sl } from "@tanstack/react-table";
import cl from "markdown-to-jsx";
import { filterAndRankItems as Po, GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as ll, isInsertEmbedOpOfType as Or, getMarkerMenuItems as dl, defaultStyleInfo as wl, Editorial as ul } from "@eten-tech-foundation/platform-editor";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        ze,
        {
          ...
          "aria-label": `${It.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
          disabled: w,
...
function fl({
  ...
  const [h, g] = _(!1), f = w !== void 0, b = f ? w : h, m = (N) => {
    f || g(N), p == null || p(N);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ve, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Le, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Te, { heading: i, children: t.map((N) => /* @__PURE__ */ u(
      ze,
      {
        onSelect: () => S(N),
...
function ha({
  ...
  const q = xe(), [T, I] = _(!1), [V, z] = _(""), [L, Z] = _(""), [R, nt] = _("books"), [O, rt] = _(void 0), [D, C] = _(
    void 0
  ), [H, st] = _(void 0), [xt, ht] = _(!1), Pt = K(null), J = K(!1), at = K(void 0), ct = K(void 0), ut = K(void 0), ft = K(void 0), Tt = K({}), zt = K({}), yt = j(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ), Rt = A(() => o ? o() : Gi, [o]), Mt = A(() => ({
    [wt.OT]: Rt.filter((W) => It.isBookOT(W)),
    [wt.NT]: Rt.filter((W) => It.isBookNT(W)),
    [wt.DC]: Rt.filter((W) => It.isBookDC(W)),
    [wt.Extra]: Rt.filter((W) => It.extraBooks().includes(W))
  }), [Rt]), kt = A(() => Object.values(Mt).flat(), [Mt]), Vt = A(() => {
    if (!L.trim()) return Mt;
    const y = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((ot) => {
      y[ot] = Mt[ot].filter((Yt) => Ga(Yt, L, n));
    }), y;
  }, [Mt, L, n]), $ = A(
    () => yl(L, kt, n),
    [L, kt, n]
  ...
  const Nt = j(() => {
    if ($) {
      const y = $.chapterNum ?? 1, W = $.verseNum ?? 1;
      if (w && pa($.book, y, W, w))
        return;
      yt({
        book: $.book,
    ...
    (y) => {
      const W = D ?? ($ == null ? void 0 : $.book), ot = H ?? ($ == null ? void 0 : $.chapterNum);
      !W || !ot || (yt({
        book: W,
        chapterNum: ot,
        verseNum: y
    ...
    (y) => {
      const W = R === "chapters" ? O : $ == null ? void 0 : $.book;
      if (W) {
        if (d && d(W, y) > 1) {
          C(W), st(y), nt("verses"), z("");
          return;
        }
        yt({
          book: W,
    ...
    nt("books"), rt(void 0), C(void 0), st(void 0), setTimeout(() => {
      ct.current && ct.current.focus();
    }, 0);
  }, []), Qt = j(() => {
    const y = D;
    C(void 0), st(void 0), y ? (rt(y), nt("chapters"), z("")) : Lt();
  }, [D, Lt]), Ct = j((y) => {
    I(y), y && (nt("books"), rt(void 0), C(void 0), st(void 0), Z(""));
  }, []);
  G(() => {
    M && Ct(!1);
  }, [M, Ct]);
  ...
  G(() => {
    var y;
    Dt !== 0 && ((y = ct.current) == null || y.focus());
  }, [Dt]), Js(
    k,
    () => ({
      open: () => {
  ...
  const { otLong: re, ntLong: Ht, dcLong: we, extraLong: E } = {
    ...
    () => bl(L),
    [L]
  ), et = A(() => !d || !$ || !$.chapterNum || !Y ? !1 : d($.book, $.chapterNum) > 0, [d, $, Y]), pt = j(
    (y) => w ? Vo(y, w) : !1,
    [w]
  ), mt = j(
    (y) => (W) => w ? xl(y, W, w) : !1,
    ...
    (y, W) => (ot) => w ? pa(y, W, ot, w) : !1,
    [w]
  ), Et = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ot = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", He = j(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), p && p.includes(y.key) && $ && $.chapterNum !== void 0 && $.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), Nt());
    },
    [p, $, Nt]
  ), _e = j(
    (y) => {
      var Ne, Ye, De;
      if (y.ctrlKey) return;
      const { isLetter: W, isDigit: ot } = Lo(y.key);
      if ((R === "chapters" || R === "verses") && (y.key === " " || y.key === "Enter")) {
        const jt = y.target instanceof HTMLElement ? y.target : void 0;
        if (!!(jt != null && jt.closest(
          'button, a, input, select, textarea, [role="button"]'
        ))) {
          y.stopPropagation();
          return;
        }
        const Ft = (Ne = at.current) == null ? void 0 : Ne.querySelector(
      ...
      if ((R === "chapters" || R === "verses") && (W || ot)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (R === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), Lt();
        return;
      }
      if (R === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), Qt();
        return;
      }
      const Yt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (R === "verses" && Yt) {
        const jt = D, bt = H;
        if (!jt || !bt || !d) return;
        const Ft = d(jt, bt);
        if (!Ft) return;
        (Ye = at.current) == null || Ye.focus();
        const gt = (() => {
          if (!V) return 1;
          const We = V.match(/:(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            gt !== 0 && (ie = gt > 1 ? gt - 1 : Ft);
            break;
          case "ArrowRight":
            gt !== 0 && (ie = gt < Ft ? gt + 1 : 1);
            break;
          case "ArrowUp":
            ie = gt === 0 ? Ft : Math.max(1, gt - ae);
            break;
          case "ArrowDown":
            ie = gt === 0 ? 1 : Math.min(Ft, gt + ae);
            break;
          default:
            return;
        }
        ie !== gt && (y.preventDefault(), y.stopPropagation(), z(
          `${jt} ${he[jt] || ""} ${bt}:${ie}`
        ), setTimeout(() => {
          const We = zt.current[ie];
          We && We.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((R === "chapters" || R === "books" && $) && Yt) {
        const jt = R === "chapters" ? O : $ == null ? void 0 : $.book;
        if (!jt) return;
        R === "chapters" && ((De = at.current) == null || De.focus());
        const bt = (() => {
          if (!V) return 1;
          const ae = V.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            bt !== 0 && (gt = bt > 1 ? bt - 1 : Ft);
            break;
          case "ArrowRight":
            bt !== 0 && (gt = bt < Ft ? bt + 1 : 1);
            break;
          case "ArrowUp":
            gt = bt === 0 ? Ft : Math.max(1, bt - ie);
            break;
          case "ArrowDown":
            gt = bt === 0 ? 1 : Math.min(Ft, bt + ie);
            break;
          default:
            return;
        }
        gt !== bt && (y.preventDefault(), y.stopPropagation(), z(
          `${jt} ${he[jt] || ""} ${gt}`
        ), setTimeout(() => {
          const ae = Tt.current[gt];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (Yt = ct.current) == null || Yt.focus();
      return;
    }
    const { isLetter: W, isDigit: ot } = Lo(y.key);
    (W || ot) && (y.preventDefault(), Z((Ne) => Ne + y.key), ct.current.focus(), ht(!1));
  }, []);
  return oe(() => {
    const y = setTimeout(() => {
      if (T && R === "books" && ut.current && ft.current) {
        const W = ut.current, ot = ft.current, Yt = ot.offsetTop, Ne = W.clientHeight, Ye = ot.clientHeight, De = Yt - Ne / 2 + Ye / 2;
        W.scrollTo({
          top: Math.max(0, De),
          behavior: "smooth"
        }), z(Yn(t.book));
    ...
    if (R === "chapters" && O) {
      const y = O === t.book, W = y ? t.chapterNum : 1;
      z(
        `${O} ${he[O] || ""} ${W}`
      ), setTimeout(() => {
        if (ut.current)
  ...
  }, [R, O, $, t.book, t.chapterNum]), oe(() => {
    if (R === "verses" && D && H !== void 0) {
      const y = D === t.book && H === t.chapterNum, W = y ? t.verseNum : 1;
      z(
        `${D} ${he[D] || ""} ${H}:${W}`
      ), setTimeout(() => {
        if (ut.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ve, { open: T, onOpenChange: Ct, modal: S, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        ...
        onClick: (y) => {
          J.current && (J.current = !1, y.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: F }),
          f && /* @__PURE__ */ a(
            Rn,
            {
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: W } = y;
          T && Pt.current && W instanceof Node && Pt.current.contains(W) && (J.current = !0, Ct(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          je,
            ...
            children: [
              R === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Ge.map(
                  ({ onClick: y, disabled: W, title: ot, icon: Yt }) => /* @__PURE__ */ a(
                    X,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: R === "verses" ? Qt : Lt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: q === "ltr" ? /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                R === "chapters" && O && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Oe(O, n) }),
                R === "verses" && D && H !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Oe(D, n)} ${H}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: R === "verses" ? Ot : Et
                  }
                )
              ] }),
              !xt && /* @__PURE__ */ u(Fe, { ref: ut, children: [
                R === "books" && /* @__PURE__ */ u(lt, { children: [
                  !$ && Object.entries(Vt).map(([y, W]) => {
                    if (W.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Te, { heading: U(y), children: W.map((ot) => /* @__PURE__ */ a(
                          Hn,
                          {
                            bookId: ot,
                            onSelect: (Yt) => Re(Yt),
                            section: Lr(ot),
                            commandValue: `${ot} ${he[ot]}`,
                            ref: ot === t.book ? ft : void 0,
                            localizedBookNames: n,
                            disabled: pt(ot)
                          },
                          ot
                  ...
                  $ && /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ a(
                    ze,
                    {
                      value: `${$.book} ${he[$.book]} ${$.chapterNum || ""}:${$.verseNum || ""})}`,
                      onSelect: Nt,
                      disabled: !!w && pa(
                        $.book,
                        $.chapterNum ?? 1,
                  ...
                  $ && et && $.chapterNum && d && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Oe($.book, n)} ${$.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: Ot })
                    ] }),
                    /* @__PURE__ */ a(
                      Fo,
                      {
                        ...
                        endVerse: d($.book, $.chapterNum),
                        scrRef: t,
                        onVerseSelect: Gt,
                        setVerseRef: B,
                        isVerseDisabled: vt($.book, $.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  $ && !et && lr($.book) > 1 && /* @__PURE__ */ u(lt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Oe($.book, n) }),
                      /* @__PURE__ */ a("span", { children: Et })
                    ] }),
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        setChapterRef: x,
                        isChapterDimmed: Q,
                        isChapterDisabled: mt($.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                R === "chapters" && O && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: O,
                    scrRef: t,
                    onChapterSelect: le,
                    setChapterRef: x,
                    isChapterDisabled: mt(O),
                    className: "tw:p-4"
                  }
                ),
                R === "verses" && D && H !== void 0 && d && /* @__PURE__ */ a(
                  Fo,
                  {
                    bookId: D,
                    chapterNum: H,
...
function Bo({
  ...
  const [k, M] = _(!1), q = d ?? l, T = (V) => V.length > 0 && typeof V[0] == "object" && "options" in V[0], I = (V, z) => {
    const L = l(V), Z = typeof V == "object" && "secondaryLabel" in V ? V.secondaryLabel : void 0, R = `${z ?? ""}${L}${Z ?? ""}`;
    return /* @__PURE__ */ u(
      ze,
      {
        value: L,
  ...
  return /* @__PURE__ */ u(Ve, { open: k, onOpenChange: M, ...N, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        children: /* @__PURE__ */ u(je, { children: [
          ...
          /* @__PURE__ */ a(Fe, { children: T(e) ? e.map((V) => /* @__PURE__ */ a(Te, { heading: V.groupHeading, children: V.options.map((z) => I(z, V.groupHeading)) }, V.groupHeading)) : /* @__PURE__ */ a(Te, { children: e.map((V) => I(V)) }) })
        ] })
      }
    )
  ] });
    ...
    Ha,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(St, { className: "tw:flex tw:items-center", children: o.map((m) => It.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            X,
            {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = Jn ? oe : G, Ir = { tag: oo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = zr();
            g.append(f);
            const b = Jn ? document.activeElement : null;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : G;
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : G;
function $l(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Il() {
  return function(t) {
    const [e] = ke(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = K(o);
    return Ol(() => {
...
const Zn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = Zn && "documentMode" in document ? document.documentMode : null;
!(!Zn || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function me(t) {
  return `${t}px`;
}
...
function Ll(t, e, r) {
  ...
  function l() {
    ...
    for (let S = 0; S < g.length; S++) {
      const N = g[S], k = s[S] || document.createElement("div"), M = k.style;
      M.position !== "absolute" && (M.position = "absolute", m = !0);
      const q = me(N.left - p);
      M.left !== q && (M.left = q, m = !0);
      const T = me(N.top - h);
      M.top !== T && (k.style.top = T, m = !0);
      const I = me(N.width);
      M.width !== I && (k.style.width = I, m = !0);
      const V = me(N.height);
      M.height !== V && (k.style.height = V, m = !0), k.parentNode !== c && (c.append(k), m = !0), s[S] = k;
    }
...
function Fl(t, e = jl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, S = g.getNode(), N = S.getKey(), k = g.offset, M = t.getElementByKey(b), q = t.getElementByKey(N), T = r === null || M !== o || m !== n || b !== r.getKey(), I = i === null || q !== s || k !== c || N !== i.getKey();
      if ((T || I) && M !== null && q !== null) {
        const V = function(z, L, Z, R, nt, O, rt) {
          const D = (z._window ? z._window.document : document).createRange();
          return D.setStart(...Uo(L, Z, R)), D.setEnd(...Uo(nt, O, rt)), D;
        }(t, h, f, M, g, S, q);
        l(), l = Ll(t, V, e);
      }
      r = f, o = M, n = m, i = S, s = q, c = k;
    });
  }
...
function Ul(t) {
  const e = An(t, (r) => Cr(r) && !r.isInline());
  return Cr(e) || Yr(4, t.__key), e;
}
function Kl(t) {
  const e = ee() || dc();
  let r;
  if (ve(e)) r = wc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = In(c, "next"));
    }
    r = r || uc(Pe(), "previous").getFlipped().insert(zr());
  }
...
function ql(t, e, r) {
  ...
  return bc(o) && Yr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(In(t.getLatest(), "next"), e.direction);
}
function Gl(t) {
  const e = ee();
  if (!ve(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = An(i, (d) => Cr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Wr, Ee = 0, Xr = 0, Wl = 0, ja = 0, Br = 0;
function qo(t) {
  if (it === void 0) return;
  let e = t.n;
...
function Xe(t, e) {
  Xt.call(this, void 0), this.x = t, this.s = void 0, this.g = Br - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Xl(t, e) {
  return new Xe(t, e);
}
...
function Jl(t) {
  ...
  ti(this), it = t, this.f &= -2, 8 & this.f && wo(this), ia();
}
function ir(t, e) {
...
Xt.prototype.brand = Hl, Xt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && Xr === 0 && e.l !== ja && (e.l = ja, Wr = { S: e, v: e.v, i: e.i, o: Wr });
...
} }), Xe.prototype = new Xt(), Xe.prototype.h = function() {
  ...
  return it = t, ti(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ei(this), Go(this), Ee++;
  const t = it;
  return it = this, Jl.bind(this, t);
...
ce({ build: (t, e, r) => mr(e), config: ar({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ri() {
  const t = Pe(), e = ee(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), ve(e) && (e.format = 0);
}
function ai(t, e = ri) {
  return t.registerCommand(Pn, (r) => (t.update(e), !0), no);
}
ce({ build: (t, e, r) => mr(e), config: ar({ $onClear: ri }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return be(() => ai(t, o.value));
} });
function Zl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ma = _c("format", { parse: (t) => typeof t == "number" ? t : 0 });
class oi extends Ia {
  $config() {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [oi], register: (t, e, r) => t.registerCommand(Vn, (o) => {
  const n = ee();
  if (Ln(n) || ve(n)) for (const i of n.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, jn) });
function ni(t, e) {
  let r;
...
const Fa = ce({ build: (t) => ni(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const uo = 0, Ba = 1, si = 2, va = 3, Ar = 4, nr = 5, ba = 6, br = 7;
function xa(t) {
  return t.id === uo;
}
function ci(t) {
...
function td(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || dt(305, String(t.id), String(Ba)), Object.assign(t, { id: si });
}
...
class rd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ar && dt(307, String(r.id), String(nr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== br && dt(309, String(o.id), String(br)), this.state = function(s) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= br;
    }(e) || dt(316, String(e.id), String(br)), e;
  }
...
const od = ce({ config: ar({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = ad }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Nc, $n, Cc, Ec, On] }), Yo = Symbol.for("@lexical/extension/LexicalBuilder");
function Wo() {
}
function nd(t) {
  throw t;
...
class dr {
  ...
  static maybeFromEditor(e) {
    const r = e[Yo];
    return r && (r.PACKAGE_VERSION !== ya && dt(292, r.PACKAGE_VERSION, ya), r instanceof dr || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || dt(300, s, n || "[unknown]"), xa(c = i) || dt(304, String(c.id), String(uo)), i = Object.assign(c, { id: Ba }), o.state = i;
...
const id = /* @__PURE__ */ new Set(), Xo = ce({ build(t, e, r) {
  const o = r.getDependency(Fa).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ni(() => {
  }, () => be(() => {
...
}, dependencies: [Fa], name: "@lexical/extension/NodeSelection" }), sd = Sc("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends Ia {
  static getType() {
...
ce({ dependencies: [Fa, Xo], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Xo).output, n = Er({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Se(t.registerCommand(sd, (s) => {
    const c = ee();
    if (!ve(c)) return !1;
    ...
    if (Rc(s.target)) {
      ...
      if (ld(c)) return function(l, d = !1) {
        ...
        let g;
        d && Ln(w) ? g = w : (g = Mc(), Oc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, jn), t.registerMutationListener(ur, (s, c) => {
    Yl(() => {
      let l = !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(be(() => {
      const d = c.value;
      d && (l.value ? Fn(d, i) : jc(d, i));
    }));
    return Se(...s);
  }));
} });
ce({ build: (t, e) => mr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: ar({ $getParentEditor: function() {
  const t = $c();
...
ce({ build: (t, e, r) => mr(e), config: ar({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return be(() => {
...
function dd(t, e, r = li) {
  return Se(t.registerCommand(Fc, (o) => {
    const n = ee();
    if (!ve(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? qc : Oo : Gc;
    return t.dispatchCommand(i, void 0);
  }, no), t.registerCommand(Oo, () => {
...
ce({ build: (t, e, r) => mr(e), config: ar({ $canIndent: li, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return be(() => {
    if (!o.value) return dd(t, n, i);
  });
} });
const wd = ce({ name: "@lexical/react/ReactProvider" });
function ud() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ve(f)) {
                const b = f.anchor;
                let m = b.getNode(), S = 0, N = 0;
                if (Aa(m) && d >= 0 && w >= 0 && (S = d, N = d + w, f.setTextNodeRange(m, S, m, N)), S === N && p === "" || (f.insertRawText(p), m = b.getNode()), Aa(m)) {
                  S = h, N = h + g;
                  const k = m.getTextContentSize();
                  S = S > k ? k : S, N = N > k ? k : N, f.setTextNodeRange(m, S, m, N);
                }
...
ce({ build: (t, e, r) => mr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => be(() => r.getOutput().disabled.value ? void 0 : wi(t)) });
function gd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : G;
...
function vd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    ho(() => Se(Zc(n), wi(n)), [n]);
  }(o), u(lt, { children: [t, a(bd, { content: e }), a(md, { editor: o, ErrorBoundary: r })] });
}
...
const yd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : G;
function kd({ onClear: t }) {
  const [e] = ke();
  return yd(() => ai(e, t), [e, t]), null;
}
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : G;
function _d({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: S = !0, style: N, tabIndex: k, "data-testid": M, ...q }, T) {
  const [I, V] = _(t.isEditable()), z = j((Z) => {
    Z && Z.ownerDocument && Z.ownerDocument.defaultView ? t.setRootElement(Z) : t.setRootElement(null);
  }, [t]), L = A(() => /* @__PURE__ */ function(...Z) {
    return (R) => {
      for (const nt of Z) typeof nt == "function" ? nt(R) : nt != null && (nt.current = R);
    };
  }(T, z), [z, T]);
  return ui(() => (V(t.isEditable()), t.registerEditableListener((Z) => {
    V(Z);
  })), [t]), a("div", { "aria-activedescendant": I ? e : void 0, "aria-autocomplete": I ? r : "none", "aria-controls": I ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": I && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": I ? p : void 0, "aria-readonly": !I || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: I, "data-testid": M, id: b, ref: L, role: m, spellCheck: S, style: N, tabIndex: k, ...q });
}
const Nd = zn(_d);
function Zo(t) {
  return t.getEditorState().read(di(t.isComposing()));
...
function Ed(t, e) {
  ...
  return u(lt, { children: [a(Nd, { editor: n, ...o, ref: e }), r != null && a(Td, { editor: n, content: r })] });
}
function Td({ content: t, editor: e }) {
  ...
  if (oe(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function Dd({
  ...
  const [e] = ke(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Rd(), l = () => {
  };
...
function Od() {
  const { activeEditor: t } = hi(), [e, r] = _([]), o = j((n) => {
    if (ve(n) || el(n)) {
      const i = [];
      Qo.forEach(({ format: s }) => {
...
function Id({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Dd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Od, {}) }) }),
...
function vi({
  ...
  return /* @__PURE__ */ u(Ya, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
...
const Vd = "verseText", up = Object.freeze([
...
function pp({
  ...
  const [i, s] = _(Ld), [c, l] = _(n), [d, w] = _(!1), p = K(void 0), h = K(null);
  G(() => {
    let m = !0;
    const S = h.current;
    if (!S) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ve, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Le,
        {
          ...
          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Fe, { children: t.map((m) => /* @__PURE__ */ a(
            ze,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: ka(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : fo(m) && (m.preventDefault(), m.stopPropagation(), se(i) && g());
        },
        onKeyDown: (m) => {
          go(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Jr,
          {
...
function en({
  ...
  }, [t.date, r]), m = A(() => t.user, [t.user]), S = A(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = A(() => ro(t.contents), [t.contents]), k = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), M = !!t.conflictResolutionAction && !k, q = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          Ze,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ud, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Kd, { className: "tw:text-xs tw:font-medium", children: S }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : fo(T) && (T.preventDefault(), T.stopPropagation(), se(w) && f());
              },
              onKeyDown: (T) => {
        ...
        q && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
          /* @__PURE__ */ a(Ke, { align: "end", children: q })
        ] })
      ]
    }
  );
...
function _i({
  ...
  const [R, nt] = _(rn), [O, rt] = _(), [D, C] = _(), H = o, [st, xt] = _(!1), [ht, Pt] = _(!1), [J, at] = _(!1), [ct, ut] = _(!1), [ft, Tt] = _(!1), [zt, yt] = _(M), [Rt, Mt] = _(!1), kt = K(void 0), [Vt, $] = _(/* @__PURE__ */ new Map());
  G(() => {
    let x = !0;
    return (async () => {
      const Y = N ? await N(l) : !1;
      x && Tt(Y);
    })(), () => {
      x = !1;
    };
    ...
    let x = !0;
    if (!o) {
      ut(!1), $(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Y = S ? await S(l) : !1;
      x && ut(Y);
    })(), () => {
      x = !1;
    };
  ...
  G(() => {
    if (!o) {
      _t.current !== "idle" && (rt(void 0), C(void 0), _t.current = "idle");
      return;
    }
    _t.current === "idle" && (_t.current = "pending"), ct ? _t.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (rt(I), _t.current = "auto-populated") : _t.current === "auto-populated" && (rt(void 0), _t.current = "pending");
  }, [o, I, ct, i]);
  const Nt = A(
  ...
  const Gt = A(() => Nt[0], [Nt]), Re = K(null), le = K(void 0), de = j(() => {
    var x;
    (x = le.current) == null || x.call(le), nt(rn);
  }, []), Ge = j(() => {
    const x = !zt;
    yt(x), Mt(!x), f == null || f(l, x);
  }, [zt, f, l]);
  G(() => {
    xt(!1);
  }, [o]), G(() => {
  ...
  }, [i, r]), Ct = A(() => Nt.slice(1), [Nt]), Dt = A(() => Ct.length ?? 0, [Ct.length]), ne = A(() => Dt > 0, [Dt]), re = A(() => st || Dt <= 2 ? Ct : Ct.slice(-2), [Ct, Dt, st]), Ht = A(() => st || Dt <= 2 ? 0 : Dt - 2, [Dt, st]), we = A(
    () => Dt === 1 ? Lt.singleReply : Qe(Lt.multipleReplies, { count: Dt }),
    [Dt, Lt]
  ), E = A(
    () => Ht === 1 ? Lt.singleReply : Qe(Lt.multipleReplies, { count: Ht }),
    [Ht, Lt]
  );
  G(() => {
    !o && ht && ne && Pt(!1);
  ...
  const U = j(
    async (x) => {
      ...
      B && await p({ threadId: l, contents: B }) && de();
    },
    [
      de,
      R,
    ...
    async (x) => {
      const B = se(R) ? Zr(R) : void 0, Y = x.status ? x.assignedUser : O ?? x.assignedUser, et = await p({
        ...x,
        contents: B,
        assignedUser: Y
      });
      return et && (Y !== void 0 && C(Y), B && de()), et;
    },
    [de, R, p, O]
  );
  ...
  const F = /* @__PURE__ */ a(
    en,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Pt,
      canEditOrDelete: (!ht && Vt.get(Gt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    Fd,
    {
      ...
      className: v(
        ...
        {
          "tw:bg-primary-foreground": !o && w !== "Resolved" && zt,
          "tw:bg-background": o && w !== "Resolved" && zt,
          "tw:bg-muted": w === "Resolved",
          "tw:bg-accent": !zt && !o && w !== "Resolved"
        }
      ),
      onClick: () => {
        c(l);
      ...
      children: /* @__PURE__ */ u(Bd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            Qt && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Qt }),
            /* @__PURE__ */ a(
              X,
              {
                variant: "ghost",
                ...
                "aria-label": zt ? r["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : r["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: zt ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(ms, {})
              }
            ),
            L === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: ft && w !== "Resolved",
                  onClick: () => Q({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(lt, { children: [
          ...
          !o && se(R) && /* @__PURE__ */ a(
            Jr,
            {
              ...
              onSerializedChange: (x) => nt(x),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(lt, { children: [
            Z && re.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Ht > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (x) => {
                  x.stopPropagation(), xt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (x) => {
                  (x.key === "Enter" || x.key === " ") && (x.preventDefault(), x.stopPropagation(), xt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: E }),
                    st ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            re.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              en,
              {
                comment: x,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Pt,
                canEditOrDelete: (!ht && Vt.get(x.id)) ?? !1
              }
            ) }, x.id)),
            m !== !1 && (!ht || se(R)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (x) => {
                  fo(x) && (x.preventDefault(), x.stopPropagation(), (se(R) || O !== void 0 && O !== D) && U());
                },
                onKeyDown: (x) => {
                  go(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Jr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    O !== void 0 && (se(R) || O !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Qe(
                    ...
                    /* @__PURE__ */ u(Ve, { open: J, onOpenChange: at, children: [
                      /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ a(
                        X,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !ct || !b || b.length === 0 || !b.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Le,
                        {
                          ...
                          align: "end",
                          onKeyDown: (x) => {
                            x.key === "Escape" && (x.stopPropagation(), at(!1));
                          },
                          children: /* @__PURE__ */ a(je, { children: /* @__PURE__ */ a(Fe, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                            ze,
                            {
                              onSelect: () => {
                                rt(x !== i ? x : void 0), _t.current = "user-selected", C(void 0), at(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Ur(x, r) })
                            },
                            x || "unassigned"
                          )) }) })
                        }
...
), Gd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Kr = (t) => Gd(ro(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Hd({
  ...
  const [s, c] = _("accept"), l = Ro(), d = Ro(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = A(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = A(
    () => Kr(t.acceptedText ?? ""),
    ...
    () => Kr(t.mergedText ?? ""),
    [t.mergedText]
  ), N = A(() => ro(t.contents), [t.contents]);
  if (!xi(t))
    return /* @__PURE__ */ a(qr, { html: N });
  const k = (D) => {
    c(D === "reject" || D === "merge" ? D : "accept");
  }, M = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", q = g ? [
    {
      value: "merge",
  ...
  const L = e["%conflict_note_no_result%"] ?? "No result preview available.", Z = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: L }), R = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : Z, nt = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: S }) : Z : R(D === "reject" ? t.rejectedResultText : t.resultText);
  }, O = (D) => p && D.value === "reject", rt = (D) => {
    const C = f === D.value, H = `${d}-${D.value}`, st = O(D);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: M }),
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          Ha,
          {
            ...
            children: T.map((D) => O(D) ? /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: rt(D) }),
              /* @__PURE__ */ a(qt, { children: M })
            ] }) }, D.value) : rt(D))
          }
        ),
        /* @__PURE__ */ a(Bt, { delayDuration: 0, children: /* @__PURE__ */ u(Ut, { children: [
    ...
    if (e === "Resolved") {
      for (let N = o.length - 1; N >= 0; N -= 1)
        if (o[N].status === "Resolved")
          return yi(o[N].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function kp({
  ...
  const [N, k] = _(/* @__PURE__ */ new Set()), [M, q] = _(), [T, I] = _(), V = j(
    async (C) => {
      const H = await i(C);
      return H !== void 0 && C.assignedUser !== void 0 && C.assignedUser !== "" && I(C.assignedUser), H;
    },
    [i]
  );
  G(() => {
    f && (k((C) => new Set(C).add(f)), q(f));
  }, [f]);
  const z = r.filter(
    (C) => C.comments.some((H) => !H.deleted)
  ), L = z.map((C) => ({ id: C.id })), Z = j(
    (C) => {
      k((H) => new Set(H).add(C.id)), q(C.id), b == null || b(C.id);
    },
    [b]
  ), R = j(
    (C) => {
      ...
      k((st) => {
        const xt = new Set(st);
        return xt.has(C) ? xt.delete(C) : xt.add(C), xt;
      }), q(C), b == null || b(H ? void 0 : C);
    },
    [N, b]
  ), { listboxRef: nt, activeId: O, handleKeyDown: rt } = Hi({
    options: L,
    onOptionSelect: Z
  }), D = j(
    (C) => {
      C.key === "Escape" ? (M && N.has(M) && (k((H) => {
        const st = new Set(H);
        return st.delete(M), st;
      }), q(void 0), b == null || b(void 0)), C.preventDefault(), C.stopPropagation()) : rt(C);
    },
    [M, N, rt, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map((C) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: C.type === "Conflict" ? /* @__PURE__ */ a(Zd, { ...H, conflictResolution: S }) : /* @__PURE__ */ a(_i, { ...H })
          },
          C.id
        );
      })
...
function gr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Zt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Zt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Rn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ u(
        pr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(fr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(pe, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ow({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [m, S] = _({}), N = A(() => e ?? [], [e]), k = Kn({
    data: N,
    columns: t,
    getCoreRowModel: Gn(),
  ...
  let q;
  return l ? q = Array.from({ length: 10 }).map((z, L) => `skeleton-row-${L}`).map((z) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? q = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => s(I, k),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((V) => /* @__PURE__ */ a(cr, { children: yr(V.column.columnDef.cell, V.getContext()) }, V.id))
    },
    I.id
  )) : q = /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Qd, { table: k }),
    /* @__PURE__ */ u(Xa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ja, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ a($e, { children: I.headers.map((V) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : yr(V.column.columnDef.header, V.getContext()) }, V.id)) }, I.id)) }),
      /* @__PURE__ */ a(Za, { children: q })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(_n, {}) })
        ] }),
...
function Tp({
  ...
  return /* @__PURE__ */ u(Ve, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Le, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Sp({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Be, { children: [
    ...
    /* @__PURE__ */ a(Ke, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: d.itemType === 0 ? /* @__PURE__ */ a(lt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ie,
        {
          checked: o[w][h],
...
function pw(t, e, r) {
  var n, i;
  const { kind: o } = e;
  if (o === "enter" || Ni(t) || Gs.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (ue(t), r.dismiss(), "ended") : (ue(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (r.dismiss(), "ended") : (ue(t), r.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (ue(t), r.dismiss(), "ended") : t.key === "Backspace" || Ci[o].test(t.key) ? (ue(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (o === "selection" && ue(t), r.dismiss(), "ended");
}
function _a(t, e) {
  var r;
...
function gw({
  ...
  return /* @__PURE__ */ u(Ya, { children: [
    ...
    e && /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
        X,
        {
          "aria-label": w,
...
function vw({
  ...
  const i = K(null), s = K(null), c = K(!1), [l, d] = _(t), [w, p] = _(r), [h, g] = _(!1);
  G(() => {
    d(t);
  }, [t]), G(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var S, N, k, M;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((S = i.current) == null || S.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((M = s.current) == null || M.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Be, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: mw(t, n, r) }) }) }),
...
const bw = (t, e) => t === "f" ? /* @__PURE__ */ u(lt, { children: [
  /* @__PURE__ */ a(Cn, {}),
  " ",
...
function yw({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: bw(t, r) }) }) }),
      /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ a("p", { children: xw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ke, { style: { zIndex: fn }, children: [
...
function _w({ icon: t, className: e }) {
...
function nn({
  ...
  return /* @__PURE__ */ u(
    ze,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(Nw, { state: t.selectionState }),
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(_w, { icon: t.icon }) }) }),
...
function Mp({
  ...
  oe(() => {
    if (!f.current) return;
    const { width: E } = f.current.getBoundingClientRect();
    E > 0 && (f.current.style.width = `${E}px`);
  }, []);
  const [b, m] = _("generated"), [S, N] = _("generated"), [k, M] = _("*"), [q, T] = _("*"), [I, V] = _("f"), [z, L] = _(!1), [Z, R] = _(!0), [nt, O] = _(!1), rt = K(!1), D = K(""), [C, H] = _(!1), [st, xt] = _(), [ht, Pt] = _(), [J, at] = _(), [ct, ut] = _(), ft = K(null), Tt = K(void 0), zt = K(0), yt = K(void 0), Rt = A(
    () => ({
      ...s,
  ...
  G(() => {
    var E;
    C || (E = p.current) == null || E.focus();
  }, [I, C]);
  const kt = j(() => {
    var F, x, B;
    const E = (F = h.current) == null ? void 0 : F.querySelector(".editor-input"), U = E == null ? void 0 : E.querySelector("span.note"), Q = (B = (x = h.current) == null ? void 0 : x.ownerDocument.getSelection()) == null ? void 0 : B.anchorNode;
    return !!U && !!Q && U.contains(Q);
  }, []);
  G(() => {
    var x, B;
    let E, U, Q;
    rt.current = !1, yt.current = void 0, R(!0);
    const F = e == null ? void 0 : e.at(0);
    if (F && Or("note", F)) {
      const Y = (x = F.insert.note) == null ? void 0 : x.caller;
      let et = "custom";
      Y === Pa ? et = "generated" : Y === Va ? et = "hidden" : Y && (M(Y), T(Y)), m(et), N(et), V(((B = F.insert.note) == null ? void 0 : B.style) ?? "f"), E = setTimeout(() => {
        var pt, mt, vt;
        (pt = p.current) == null || pt.applyUpdate([F]), (mt = p.current) == null || mt.selectNote(0), (vt = p.current) == null || vt.focus(), U = requestAnimationFrame(() => {
          Q = setTimeout(() => {
            var Et, Ot;
            kt() || ((Et = p.current) == null || Et.selectNote(0), (Ot = p.current) == null || Ot.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      E && clearTimeout(E), U !== void 0 && cancelAnimationFrame(U), Q !== void 0 && clearTimeout(Q);
    };
  }, [e, i, kt]);
  const Vt = j(
    (E, U, Q = !1) => {
      var x, B, Y;
      const F = (B = (x = p.current) == null ? void 0 : x.getNoteOps(0)) == null ? void 0 : B.at(0);
      if (F && Or("note", F)) {
        if (F.insert.note) {
          let et;
          E === "custom" ? et = U : E === "generated" ? et = Pa : et = Va, F.insert.note.caller = et;
        }
        r == null || r([F]), Q && d && i && ((Y = d.current) == null || Y.replaceEmbedUpdate(i, [F]));
      }
    },
    [i, r, d]
  ), $ = j(() => {
    var E;
    Tt.current || (E = p.current) == null || E.commitPendingMarkerEdits(), Vt(b, k, !0), o();
  }, [b, k, o, Vt]), _t = K($);
  oe(() => {
    _t.current = $;
  });
  const Nt = K({ book: n.book, chapterNum: n.chapterNum });
  oe(() => {
    (Nt.current.book !== n.book || Nt.current.chapterNum !== n.chapterNum) && (Nt.current = { book: n.book, chapterNum: n.chapterNum }, _t.current());
  }, [n.book, n.chapterNum]);
  const Gt = () => {
    var U;
    const E = (U = h.current) == null ? void 0 : U.getElementsByClassName("editor-input")[0];
    ...
    var Q, F, x, B, Y;
    V(E);
    const U = (F = (Q = p.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : F.at(0);
    if (U && Or("note", U)) {
      U.insert.note && (U.insert.note.style = E);
      const et = (B = (x = U.insert.note) == null ? void 0 : x.contents) == null ? void 0 : B.ops;
      I !== "x" && E === "x" ? et == null || et.forEach((pt) => Sw(pt)) : I === "x" && E !== "x" && (et == null || et.forEach((pt) => zw(pt))), (Y = p.current) == null || Y.applyUpdate([U, { delete: 1 }]);
    }
  }, Ge = (E) => {
    ut(E.contextMarker), O(E.canRedo);
  }, Lt = j(
    (E) => {
      var Q, F, x, B, Y;
      const U = (F = (Q = p.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : F.at(0);
      if (U && Or("note", U)) {
        E.content.length > 1 && setTimeout(() => {
          var mt;
          (mt = p.current) == null || mt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const et = (x = U.insert.note) == null ? void 0 : x.style, pt = (Y = (B = U.insert.note) == null ? void 0 : B.contents) == null ? void 0 : Y.ops;
        if (et || L(!1), L(
          et === "x" ? !!(pt != null && pt.every((mt) => {
            var Et, Ot;
            if (!((Et = mt.attributes) != null && Et.char)) return !0;
            const vt = ((Ot = mt.attributes) == null ? void 0 : Ot.char).style;
          ...
          rt.current = !0, D.current = JSON.stringify(U), R(!0);
          return;
        }
        R(JSON.stringify(U) === D.current), Vt(b, k);
      } else
        L(!1), R(!0);
    },
    [b, k, Vt]
    ...
    if (g.current && Mt.length && E && E.rangeCount > 0) {
      const U = E.getRangeAt(0).getBoundingClientRect(), Q = g.current.getBoundingClientRect();
      xt(U.left - Q.left), Pt(U.top - Q.top), at(U.height), H(!0);
    }
  }, [Mt, g]), Ct = K(() => {
  }), Dt = j(
    (E, U, Q) => {
      const { anchorRect: F } = E;
      if (!w || !F) return;
      const { passive: x } = Q;
      zt.current += 1;
      const B = zt.current;
      Tt.current = {
        kind: x ? "backslash" : "selection",
        token: B,
        filter: "",
        items: U
      }, w.show(U.map(Tw), F, x, {
        ...
        keys: uw(x ? "backslash" : "selection"),
        onKey: (Y) => Ct.current(Y)
      }).then((Y) => {
        var et, pt, mt, vt, Et, Ot;
        if (_a(Tt, B), Y !== void 0) {
          if (!((et = p.current) != null && et.getSelection())) {
            const _e = yt.current;
            _e ? (pt = p.current) == null || pt.setSelection(_e) : (mt = p.current) == null || mt.selectNote(0);
          }
          (vt = p.current) == null || vt.focus();
          const He = U.find((_e) => _e.marker === Y);
          He && ((Et = p.current) == null || Et.applyMarkerMenuSelection(He, {
            trigger: "backslash",
        ...
        } else x || (Ot = p.current) == null || Ot.focus();
      }).catch(() => {
        var Y;
        _a(Tt, B), x || (Y = p.current) == null || Y.focus();
      });
    },
    [w]
  ), ne = j(() => {
    var Q;
    const E = (Q = p.current) == null ? void 0 : Q.getMarkerMenuContext();
    if (!E) return !1;
    const U = dl(Rt.styleInfo ?? wl, E);
    return U.length === 0 ? !1 : (Dt(E, U, { passive: !E.hasTextSelection }), !0);
  }, [Dt, Rt.styleInfo]), re = j(
    (E) => {
      const U = Tt.current;
      if (!U || !w) return;
      pw(E, U, {
        ...
        commitTyped: (F) => {
          var x;
          return (x = p.current) == null ? void 0 : x.commitTypedMarker(F);
        },
        commitTypedAndReopen: (F) => {
          var x;
          (x = p.current) == null || x.commitTypedMarker(F, { trailingSpace: !1 }), ne();
        },
        commitTypedCloser: (F) => {
          var x;
          return (x = p.current) == null ? void 0 : x.commitTypedCloser(F);
        },
        commitItem: (F) => {
          var B;
          const x = U.items.find((Y) => Y.marker === F);
          x && ((B = p.current) == null || B.applyMarkerMenuSelection(x, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  G(() => {
    ...
    const E = (U) => {
      var x, B;
      const Q = (x = h.current) == null ? void 0 : x.querySelector(".editor-input");
      if (!Q || U.target !== Q) return;
      const F = (B = p.current) == null ? void 0 : B.getSelection();
      F && (yt.current = F);
    };
    ...
    var E;
    C && ((E = ft.current) == null || E.focus());
  }, [C]), G(() => {
    var Q;
    const E = () => {
      var F;
      return ((F = h.current) == null ? void 0 : F.querySelector(".editor-input")) ?? void 0;
    };
    if (((Q = Rt.view) == null ? void 0 : Q.markerMode) === "editable") {
      const F = (B) => {
        var pt, mt, vt, Et;
        if (Ni(B)) return;
        const Y = E();
        if (!Y || document.activeElement !== Y) return;
        if (Tt.current && w) {
          Ct.current(B);
          return;
        }
        if (B.key === "Enter" && !kt()) {
          B.preventDefault(), B.stopPropagation(), (pt = p.current) == null || pt.selectNote(0), (mt = p.current) == null || mt.focus();
          return;
        }
        if (w && B.key === c) {
          if (!kt()) {
            B.preventDefault(), B.stopPropagation(), (vt = p.current) == null || vt.selectNote(0), (Et = p.current) == null || Et.focus();
            return;
          }
          ne() && (B.preventDefault(), B.stopPropagation());
        }
      }, x = () => {
        var Y, et;
        const B = E();
        !B || document.activeElement !== B || kt() || ((Y = p.current) == null || Y.selectNote(0), (et = p.current) == null || et.focus());
      };
    ...
    const U = (F) => {
      const x = E();
      !C && x && document.activeElement === x && F.key === c ? (F.preventDefault(), Qt()) : C && F.key === "Escape" && (F.preventDefault(), H(!1));
    };
    ...
    Qt,
    c,
    (we = Rt.view) == null ? void 0 : we.markerMode,
    Rt.styleInfo,
    w,
    ne,
    kt
    ...
    const E = () => {
      var F, x, B;
      const U = ((F = h.current) == null ? void 0 : F.querySelector(".editor-input")) ?? void 0;
      if (!U || document.activeElement !== U) return;
      const Q = document.getSelection();
      Q && !Q.isCollapsed || kt() || ((x = p.current) == null || x.selectNote(0), (B = p.current) == null || B.focus());
    };
  ...
  const Ht = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(lt, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
                X,
                {
                  "aria-label": Ht,
              ...
              /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ a("p", { children: Ht }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(lt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(lt, { children: Dw(t.marker, c, o, d) })
      }
    )
  ] });
}
function $p({
  ...
  const w = l ?? Hs(r, void 0), p = (k, M) => {
    d == null || d(k, M, n);
  }, h = i ? r.findIndex((k) => k === i) : -1, [g, f] = _(h), b = (k, M, q) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), d == null || d(M, q, n);
          break;
      }
  }, m = (k) => {
    if (r.length)
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), f((M) => Math.min(M + 1, r.length - 1));
          break;
        case "ArrowUp":
          k.preventDefault(), f((M) => Math.max(M - 1, 0));
          break;
      }
  }, S = K([]);
  G(() => {
    var k;
    g >= 0 && g < S.current.length && ((k = S.current[g]) == null || k.focus());
  }, [g]);
  const N = i ? r.findIndex((k) => k === i) : -1;
  return G(() => {
    var k;
    N < 0 || N >= S.current.length || (k = S.current[N]) == null || k.scrollIntoView({ block: "nearest" });
  }, [N]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Ow,
                      {
                        footnote: k,
                        layout: o,
                        formatCaller: () => w(k.caller, M),
                        showMarkers: s
                      }
                    )
                  }
                ),
                M < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Nr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, T)
            );
          })
        }
...
function Iw({
  ...
  return /* @__PURE__ */ u(Xa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ja, { stickyHeader: !0, children: /* @__PURE__ */ u($e, { children: [
    ...
    /* @__PURE__ */ a(Za, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { className: o, children: $w(c.text) })
        ]
      },
...
const Aw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
  /* @__PURE__ */ u(
    Kt,
    {
  ...
  return e ? e[1] : "";
}, Vw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fp = Object.freeze([
...
function Bp({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), b = fe(r, "%webView_inventory_unapproved%"), m = fe(r, "%webView_inventory_unknown%"), S = fe(r, "%webView_inventory_scope_currentBook%"), N = fe(r, "%webView_inventory_scope_chapter%"), k = fe(r, "%webView_inventory_scope_verse%"), M = fe(r, "%webView_inventory_filter_text%"), q = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = fe(r, "%webView_inventory_no_results%"), [I, V] = _(!1), [z, L] = _("all"), [Z, R] = _(""), [nt, O] = _([]), rt = A(() => {
    const J = t ?? [];
    return J.length === 0 ? [] : jw(J, n, i);
  }, [t, n, i]), D = A(() => {
    if (I) return rt;
    const J = [];
    return rt.forEach((at) => {
      const ct = at.items[0], ut = J.find(
        (ft) => ft.items[0] === ct
      );
      ut ? (ut.count += at.count, ut.occurrences = ut.occurrences.concat(at.occurrences)) : J.push({
        items: [ct],
        count: at.count,
  ...
  }, [I, rt]), C = A(() => D.length === 0 ? [] : Lw(D, z, Z), [D, z, Z]), H = A(() => {
    var ct, ut;
    if (!I) return l;
    const J = (ct = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ct.length;
    if (!J) return l;
    const at = [];
    for (let ft = 0; ft < J; ft++)
      at.push(
        Pw(
          ((ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut[ft]) || "Additional Item",
          ft + 1
        )
      );
    return [...at, ...l];
  ...
  G(() => {
    C.length === 0 ? O([]) : C.length === 1 && O(C[0].items);
  }, [C]);
  const st = (J, at) => {
    at.setRowSelection(() => {
      const ut = {};
      return ut[J.index] = !0, ut;
    });
    const ct = J.original.items;
    O(ct), h && ct.length > 0 && h(ct[0]);
  }, xt = (J) => {
    ...
    if (D.length === 0 || nt.length === 0) return [];
    const J = D.filter((at) => Ys(
      I ? at.items : [at.items[0]],
      nt
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (J) => xt(J), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(fr, { children: [
          ...
          /* @__PURE__ */ a(pe, { value: "chapter", children: N }),
          /* @__PURE__ */ a(pe, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ra,
      ...
      o && /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
        /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(St, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? q })
        ] }) }),
        /* @__PURE__ */ a(qt, { children: (o == null ? void 0 : o.checkboxText) ?? q })
      ] }) })
    ] }),
...
const Fw = "16rem", Bw = "3rem", Ti = Jt.createContext(void 0);
function ca() {
  const t = Jt.useContext(Ti);
  if (!t)
...
function Uw({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    ...
    [r, w]
  ), h = Jt.useCallback(() => p((k) => !k), [p]), g = w ? "expanded" : "collapsed", m = xe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", S = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Ti.Provider, { value: S, children: /* @__PURE__ */ a(
    "div",
    {
...
function Up({ className: t, onClick: e, ...r }) {
...
function Xw({
  ...
  const c = t ? Rr.Root : "button", { state: l } = ca(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Ww({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Kw,
    {
      ...
      children: /* @__PURE__ */ u(Gw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Hw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Yw, { children: /* @__PURE__ */ a(
            Xw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Me = "scrBook", Zw = "scrRef", Je = "source", Qw = "details", tu = "Scripture Reference", eu = "Scripture Book", Si = "Type", ru = "Details";
function au(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Me,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? tu,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? It.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Me ? Ce(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Qw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? ru,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, dn = (t) => `${ou({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ah({
  sources: t,
  ...
  G(() => {
    if (c) {
      const z = S.getSelectedRowModel().rowsById, L = Object.keys(z);
      if (L.length === 1) {
        const Z = b.find((R) => dn(R) === L[0]) || void 0;
        Z && c(Z);
      }
    }
  }, [g, b, c, S]);
  const N = n ?? eu, k = i ?? Si, M = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(L);
  }, I = (z, L) => z.getIsGrouped() ? "" : v("banded-row", L % 2 === 0 ? "even" : "odd"), V = (z, L, Z) => {
    if (!((z == null ? void 0 : z.length) === 0 || L.depth < Z.column.getGroupedIndex())) {
      if (L.getIsGrouped())
        switch (L.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: M.map((z) => /* @__PURE__ */ a(pe, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Xa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ja, { children: S.getHeaderGroups().map((z) => /* @__PURE__ */ a($e, { children: z.headers.filter((L) => L.column.columnDef.header).map((L) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Hr, { colSpan: L.colSpan, className: "tw:sticky top-0", children: L.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          L.column.getCanGroup() ? /* @__PURE__ */ a(
            X,
            {
              variant: "ghost",
              title: `Toggle grouping by ${L.column.columnDef.header}`,
              onClick: L.column.getToggleGroupingHandler(),
              type: "button",
              children: L.column.getIsGrouped() ? "🛑" : "👊 "
            }
          ) : void 0,
          " ",
          yr(L.column.columnDef.header, L.getContext())
        ] }) }, L.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(Za, { children: S.getRowModel().rows.map((z, L) => {
        const Z = xe();
        return /* @__PURE__ */ a(
          $e,
          {
            ...
            className: v(I(z, L)),
            onClick: (R) => T(z, R),
            children: z.getVisibleCells().map((R) => {
              if (!(R.getIsPlaceholder() || R.column.columnDef.enableGrouping && !R.getIsGrouped() && (R.column.columnDef.id !== Je || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: v(
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (Z === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
                          yr(R.column.columnDef.cell, R.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function nu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, S] = _(!1), [N, k] = _(""), M = K(void 0), q = K(!1), T = A(
    () => bn(t),
    [t]
  ), I = A(() => {
    if (!N.trim()) {
    ...
    (O, rt = !1) => {
      if (!rt || !M.current) {
        r(
          e.includes(O) ? e.filter((ht) => ht !== O) : [...e, O]
        ), M.current = O;
        return;
      }
      const D = T.findIndex((ht) => ht === M.current), C = T.findIndex((ht) => ht === O);
      if (D === -1 || C === -1) return;
      const [H, st] = [
        Math.min(D, C),
        Math.max(D, C)
      ], xt = T.slice(H, st + 1).map((ht) => ht);
      r(
        e.includes(O) ? e.filter((ht) => !xt.includes(ht)) : [.../* @__PURE__ */ new Set([...e, ...xt])]
      );
    },
    [e, r, T]
  ), z = (O) => {
    V(O, q.current), q.current = !1;
  }, L = (O, rt) => {
    O.preventDefault(), V(rt, O.shiftKey);
  }, Z = () => {
    r(T.map((O) => O));
  }, R = () => {
    r([]);
  }, nt = A(
    () => Object.values(wt).filter(
      (O) => (i == null ? void 0 : i[O]) !== void 0 && Qa(T, O).length === 0
          ...
          Le,
          {
            ...
            children: /* @__PURE__ */ u(
              je,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (O) => {
                  O.key === "Enter" && (q.current = O.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(X, { variant: "ghost", size: "sm", onClick: R, children: w })
                  ] }),
                  /* @__PURE__ */ u(Fe, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(ea, { children: p }),
                    Object.values(wt).filter((O) => I[O].length > 0).map((O, rt) => {
                      const D = I[O];
                      return /* @__PURE__ */ u(aa, { children: [
                        rt > 0 && /* @__PURE__ */ a(mn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Te,
                          {
                            heading: un(O, h, g, f, b),
                  ...
                  nt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: nt.map(({ section: O, explanation: rt }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: rt }, O)) })
                ]
              }
            )
          }
...
function su({
  ...
  return /* @__PURE__ */ a(Bt, { children: /* @__PURE__ */ u(Ut, { children: [
    /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
      iu,
      {
        className: o,
    ...
    t && /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ a("p", { className: "tw:max-w-xs tw:whitespace-pre-line", children: e }) })
  ] }) });
}
function cu({
  section: t,
  ...
  const s = Qa(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    X,
    {
      variant: "outline",
      size: "sm",
      onClick: () => o(t),
      className: v(
        xn(e, t, r) && !s && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: s,
      children: es(
        t,
...
function lu({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(wt).map((d) => /* @__PURE__ */ a(
      cu,
      {
        section: d,
        availableBookIds: c,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ca ? Ca : wn
      ).map((d) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: Oe(d, n) }, d)),
      e.length > Ca && /* @__PURE__ */ a(
        _r,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - wn} ${s}`
        }
      )
    ] })
  ] });
...
function nh({
  ...
  const q = $t(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = $t(s, "%webView_scope_selector_verse%"), I = $t(s, "%webView_scope_selector_chapter%"), V = $t(s, "%webView_scope_selector_book%"), z = $t(
    s,
    "%webView_scope_selector_current_verse%"
  ), L = $t(
    s,
    "%webView_scope_selector_current_chapter%"
  ), Z = $t(s, "%webView_scope_selector_current_book%"), R = $t(s, "%webView_scope_selector_choose_books%"), nt = $t(s, "%webView_scope_selector_scope%"), O = $t(s, "%webView_scope_selector_select_books%"), rt = $t(s, "%webView_scope_selector_range%"), D = $t(s, "%webView_scope_selector_select_range%"), C = $t(s, "%webView_scope_selector_range_start%"), H = $t(s, "%webView_scope_selector_range_end%"), st = $t(s, "%webView_scope_selector_ok%"), xt = $t(s, "%webView_scope_selector_cancel%"), ht = $t(s, "%webView_scope_selector_navigate%"), Pt = (P) => {
    if (!b) return;
    ...
    },
    {
      ...
      label: V,
      dropdownLabel: Z,
      scrRefSuffix: Pt("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: R, id: "scope-selected" },
    { value: "range", label: rt, id: "scope-range" }
  ], at = (P, tt, te = !1) => /* @__PURE__ */ u(lt, { children: [
    P,
    tt && !te && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), ct = e ? J.filter((P) => e.includes(P.value)) : J, ut = b ?? ua, ft = p ?? ut, Tt = h ?? ut, zt = () => {
  }, yt = K(null), Rt = K(null), Mt = K(!1), kt = K(null), Vt = K(!1), [$, _t] = _(void 0), Nt = K(!1), Gt = K(!1), Re = K(null), le = j((P) => {
    if (P) {
      _t("start"), Nt.current = !1;
      return;
    }
    _t((tt) => tt === "start" ? void 0 : tt), Nt.current && (Nt.current = !1, requestAnimationFrame(() => {
      var te;
      const tt = (te = yt.current) == null ? void 0 : te.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), de = j((P) => {
    if (P) {
    ...
    _t((tt) => tt === "end" ? void 0 : tt);
  }, []), Ge = j(
    (P) => {
      g == null || g(P), f == null || f(P), Nt.current = !0;
    },
    [g, f]
  ), Lt = j(
    (P) => {
      f == null || f(P), Gt.current = !0;
    },
    [f]
  ), Qt = j(
    (P) => {
      r(P), P === "selectedBooks" && n.length === 0 && (b != null && b.book) && i([b.book]);
    },
    [r, n, b, i]
  ), Ct = ct.find((P) => P.value === t), Dt = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? Ws(ft, Tt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Ct ? at(Ct.label, Ct.scrRefSuffix) : t, ne = ct.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), re = ct.find((P) => P.value === "selectedBooks"), Ht = ct.find((P) => P.value === "range"), [we, E] = _(!1), [U, Q] = _(void 0), [F, x] = _(void 0), [B, Y] = _(void 0), [et, pt] = _(void 0), [mt, vt] = _([]), Et = w === "dropdown" && U === "selectedBooks", Ot = /* @__PURE__ */ a(
    lu,
    {
      availableBookInfo: o,
      selectedBookIds: Et ? mt : n,
      onChangeSelectedBookIds: Et ? vt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), He = $ === "end", _e = $ === "start", or = "tw:text-muted-foreground", y = w === "dropdown" && U === "range", W = y ? Y : Ge, Yt = y ? pt : f ? Lt : zt, Ne = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(St, { htmlFor: "scope-range-start", className: v(He && or), children: C }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: yt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(St, { htmlFor: "scope-range-end", className: v(_e && or), children: H }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
          ...
          localizedStrings: S,
          getEndVerse: N,
          disableReferencesUpTo: y ? B ?? ft : ft,
          onOpenChange: de,
          onCloseAutoFocus: (P) => {
            var tt;
            Gt.current && (Gt.current = !1, P.preventDefault(), (tt = Re.current) == null || tt.focus());
          },
          className: v(_e && or),
          modal: !0,
          align: "start"
  ...
  const [bt, Ft] = _(null), [gt, ie] = _(null), [ae, We] = _(null), Ai = 200, [Pi, Vi] = _(!1);
  G(() => {
    if (!ae || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([tt]) => {
      Vi(tt.contentRect.width < Ai);
    });
    return P.observe(ae), () => P.disconnect();
  }, [ae]);
  const vo = j(
    (P) => {
      x(P), Y(ft), pt(Tt), vt(n), E(!1), Q(P);
    },
    [ft, Tt, n]
  ), bo = j(() => {
    F !== void 0 && (F === "range" ? (B && (g == null || g(B)), et && (f == null || f(et))) : F === "selectedBooks" && i(mt), Qt(F), Q(void 0), x(void 0));
  }, [
    F,
    B,
    et,
    ...
    var tt;
    P.preventDefault(), (tt = jt.current) == null || tt.focus();
  }, []), yo = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(St, { children: nt }),
      w === "dropdown" ? /* @__PURE__ */ u(Be, { open: we, onOpenChange: E, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(la, { container: ae, children: [
              ne.map(({ value: P, label: tt, dropdownLabel: te, scrRefSuffix: vr, id: Li }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: De(P),
                  ...
                  children: [
                    t === P && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }),
                    at(te ?? tt, vr, Pi)
                  ]
                },
                Li
              ...
              m && /* @__PURE__ */ u(lt, { children: [
                /* @__PURE__ */ a(tr, {}),
                /* @__PURE__ */ a(Tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: ht }),
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ref: kt,
                    ...
                    onSelect: (P) => {
                      ...
                      Vt.current || (te = (tt = Rt.current) == null ? void 0 : tt.querySelector("button")) == null || te.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (P) => {
                          ...
                          tt != null && tt.closest("button") && (Mt.current = !0, requestAnimationFrame(() => {
                            Mt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var tt;
                              P.preventDefault(), (tt = kt.current) == null || tt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(b ?? ua, "id") }),
                              /* @__PURE__ */ a(wr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ha,
        {
          ...
          children: ct.map(({ value: P, label: tt, scrRefSuffix: te, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: P, id: vr }),
            /* @__PURE__ */ a(St, { htmlFor: vr, children: at(tt, te) })
          ] }, vr))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(St, { children: O }),
      Ot
    ] }),
    w === "radio" && t === "range" && Ne,
    w === "dropdown" && re && /* @__PURE__ */ a(Ea, { open: U === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: ie,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (P) => {
          gt != null && gt.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: gt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: R }) }),
          Ot,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => Dr(!1), children: xt }),
            /* @__PURE__ */ a(X, { onClick: bo, children: st })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Ht && /* @__PURE__ */ a(Ea, { open: U === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: Ft,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (P) => {
          bt != null && bt.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: bt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: D }) }),
          Ne,
          /* @__PURE__ */ u(ko, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => Dr(!1), children: xt }),
            /* @__PURE__ */ a(X, { ref: Re, onClick: bo, children: st })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: rr },
            children: t.map((w) => /* @__PURE__ */ a(pe, { value: `${w}`, children: l[To(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ri = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Kt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(os, { children: /* @__PURE__ */ a(ns, { children: Ri(
      t,
      e,
      zi(t, c.id),
      o
...
function Ka({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    /* @__PURE__ */ a(Ue, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(Ke, { align: "start", style: { zIndex: rr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(Bt, { children: Ri(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(tr, {})
    ] }, l)) })
  ] });
}
const Di = Jt.forwardRef(
...
function dh({
  ...
  return /* @__PURE__ */ u(Di, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ka,
      {
        onSelectMenuItem: t,
...
const Mi = Jt.forwardRef(({ className: t, ...e }, r) => {
  const o = xe();
  return /* @__PURE__ */ a(
    ge.Root,
    {
...
Mi.displayName = ge.List.displayName;
const Oi = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.List,
  {
    ref: r,
    className: v(
...
Oi.displayName = ge.List.displayName;
const uu = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.Trigger,
  {
    ref: r,
    ...e,
...
)), $i = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.Content,
  {
    ref: r,
    className: v(
...
function uh({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(uu, { value: c.value, children: c.value }, c.key)) }),
...
const xr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ut, { children: [
      ...
      ) : /* @__PURE__ */ u(xu, { children: [
        /* @__PURE__ */ a(yu, { children: d.label }),
        /* @__PURE__ */ a(ku, { children: Ii(
          t,
          e,
          zi(t, d.id),
          o
      ...
      d.tooltip && /* @__PURE__ */ a(qt, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), l = [...c];
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(bu, {}, `separator-${i}`)), l;
  });
};
function _u({
  menuData: t,
  ...
  if (pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (b = s.current) == null || b.focus(), xr(s, [h, g]);
        break;
      case "alt+n":
        (m = c.current) == null || m.focus(), xr(c, [h, g]);
        break;
      case "alt+h":
        (S = l.current) == null || S.focus(), xr(l, [h, g]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a(pu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(hu, { children: [
      /* @__PURE__ */ a(fu, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        mu,
        {
          style: { zIndex: rr },
          children: /* @__PURE__ */ a(Bt, { children: Ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function gh({
  ...
  const d = Nu(
    ...
    var S, N, k, M, q, T;
    const m = b !== f ? ((N = (S = t[f]) == null ? void 0 : S.uiNames) == null ? void 0 : N[b]) ?? ((M = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : M.en) : void 0;
    return m ? `${(q = t[f]) == null ? void 0 : q.autonym} (${m})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
...
function mh({
  ...
  return /* @__PURE__ */ u(je, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ss, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(cs, { children: /* @__PURE__ */ a(oc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Fe, { children: [
...
function bh({
  ...
  const c = t ? So(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Su(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Be, { children: [
                  /* @__PURE__ */ a(Ue, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    X,
                    {
...
function yh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function _h({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = A(() => {
    const c = new Tn(o);
    return (l) => c.format(l);
...
function hg(t) {
  const e = A(() => Xs(t).slice().sort().join(" "), [t]);
...
export {
  ...
  yp as AvatarImage,
  lp as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  hp as COMMENT_EDITOR_STRING_KEYS,
  jd as COMMENT_LIST_ELEMENT_ID,
  gp as COMMENT_LIST_STRING_KEYS,
  up as CONFLICT_NOTE_STRING_KEYS,
  ...
  pp as CommentEditor,
  kp as CommentList,
  Hd as ConflictNoteCard,
  Th as ContextMenu,
  Ph as ContextMenuCheckboxItem,
  ...
  Dh as ContextMenuSub,
  Ah as ContextMenuSubContent,
  ...
  za as DialogTitle,
  Ng as DialogTrigger,
  su as DisabledActionTooltip,
  iu as DisabledTooltipWrapper,
  Bh as Drawer,
  Kh as DrawerClose,
  qh as DrawerContent,
  ...
  Mg as ResizablePanelGroup,
  xh as ResultsCard,
  oh as SCOPE_SELECTOR_STRING_KEYS,
  du as SELECT_BOOKS_STRING_KEYS,
  nh as ScopeSelector,
  ah as ScriptureResultsViewer,
  ih as ScrollGroupSelector,
  vn as SearchBar,
  pr as Select,
  lu as SelectBooks,
  ...
  Nr as Separator,
  sh as SettingsList,
  lh as SettingsListHeader,
  ch as SettingsListItem,
  Jw as SettingsSidebar,
  rh as SettingsSidebarContentSearch,
  Kw as Sidebar,
  ...
  Zp as SidebarMenuSkeleton,
  Qp as SidebarMenuSub,
  eh as SidebarMenuSubButton,
  th as SidebarMenuSubItem,
  ...
  Ag as Z_INDEX_FIRST_RUN,
  fn as Z_INDEX_FOOTNOTE_EDITOR,
  Pg as Z_INDEX_MODAL,
  Vg as Z_INDEX_MODAL_BACKDROP,
  ts as Z_INDEX_OVERLAY,
  Lg as badgeVariants,
  jg as buttonGroupVariants,
  Fg as buttonVariants,
  _a as clearPaletteSessionIfCurrent,
  v as cn,
  lw as filterAndRankPaletteItems,
  jp as getBookIdFromUSFM,
  fp as getCommentThreadElementId,
  sa as getInventoryHeader,
  Vp as getLinesFromUSFM,
  uw as getMarkerPaletteClaimedKeys,
  Lp as getNumberFromUSFM,
  Vw as getStatusForItem,
  ph as getToolbarOSReservedSpaceClassName,
  pw as handleMarkerPaletteSessionKeyDown,
  Ap as inventoryCountColumn,
  Ip as inventoryItemColumn,
  Pp as inventoryStatusColumn,
  Wa as isMacOs,
  Bg as isWindows,
  Tw as markerMenuItemToPaletteItem,
  Au as pickTabIconUrl,
  qg as sonner,
  dg as useEvent,
  wg as useEventAsync,
  hg as useExtraValidMarkers,
  Hi as useListbox,
  ug as usePromise,
  cp as useRecentSearches,
  gg as useRunWhenVisible,
  ca as useSidebar,
  pg as useStylesheet,
  fg as useTabIconSelection,
  Ug as useTruncationTooltip,
  Iu as useViewVisibility
};
