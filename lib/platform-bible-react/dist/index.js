...
import b, { forwardRef as nn, useRef as Y, useMemo as F, useState as T, useCallback as K, useLayoutEffect as Wt, createContext as kn, useContext as pr, useEffect as q, Component as os, createElement as Pr, Suspense as as, Fragment as wo } from "react";
...
import { includes as ln, Section as U, getChaptersForBook as zs, formatScrRef as ge, getSectionForBook as Ue, formatRelativeDate as Fs, formatReplacementString as he, sanitizeHtml as Bs, NumberFormat as Ks, formatBytes as Gs, getCurrentLocale as qs, usfmMarkers as un, getFormatCallerFunction as Us, deepEqual as Hs, isString as jr, compareScrRefs as Xn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as No, $getRoot as se, $createParagraphNode as Cn, $getSelection as Jt, HISTORY_MERGE_TAG as ur, ParagraphNode as ko, TextNode as _o, $isTokenOrSegmented as Ys, $getCharacterOffsets as Xs, $cloneWithPropertiesEphemeral as Ws, $findMatchingParent as Js, $isElementNode as be, CLEAR_EDITOR_COMMAND as Co, COMMAND_PRIORITY_EDITOR as Eo, $isRangeSelection as Ze, mergeRegister as ie, shallowMergeConfig as Zs, defineExtension as Qt, safeCast as rn, RootNode as Qs, LineBreakNode as ti, TabNode as ei, $isEditorState as ni, createCommand as ri, CLICK_COMMAND as oi, isDOMNode as ai, $getNodeFromDOMNode as si, $isNodeSelection as ii, $createNodeSelection as li, $setSelection as wi, COMMAND_PRIORITY_LOW as ci, DecoratorNode as di, addClassNamesToElement as Ro, $create as pi, $getNodeByKey as ui, removeClassNamesFromElement as mi, KEY_TAB_COMMAND as fi, $isBlockElementNode as hn, $createRangeSelection as hi, $normalizeSelection__EXPERIMENTAL as gi, OUTDENT_CONTENT_COMMAND as bi, INDENT_CONTENT_COMMAND as zr, INSERT_TAB_COMMAND as vi, COMMAND_PRIORITY_CRITICAL as mr, $isDecoratorNode as xi, $isParagraphNode as yi, $isTextNode as gn, SELECTION_CHANGE_COMMAND as To, FORMAT_TEXT_COMMAND as Ni, getRegisteredNode as ki, isHTMLElement as _i, isDocumentFragment as Fr, isDOMDocumentNode as Ci, ArtificialNode__DO_NOT_USE as So, $createLineBreakNode as Do, $isRootOrShadowRoot as Ei, isBlockDomNode as Br, isInlineDomNode as Kr, $insertNodes as Ri } from "lexical";
...
Kt.displayName = kt.Item.displayName;
...
const ne = Te.Root, ce = Te.Trigger, Ji = Te.Anchor, Gt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
Gt.displayName = Te.Content.displayName;
function er(t, e, n) {
  return `${t} ${ve[t]}${e ? ` ${hr(t, e)} ${Ee(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Zi({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(ne, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Gt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(Zt, { heading: i, children: t.map((u) => /* @__PURE__ */ d(
      Kt,
      {
        onSelect: () => p(u),
...
function Jd({
  ...
  const w = ft(), [p, u] = T(!1), [h, f] = T(""), [g, x] = T(""), [v, y] = T("books"), [N, _] = T(void 0), [k, z] = T(!1), L = Y(void 0), R = Y(void 0), $ = Y(void 0), C = Y(void 0), S = Y({}), V = K(
    (E) => {
      e(E), l && l(E);
    },
    [e, l]
    ...
    (E) => {
      if (E.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Gr(E.key);
      if (v === "chapters") {
        if (E.key === "Backspace") {
  ...
  return Wt(() => {
    ...
    /* @__PURE__ */ r(Gt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      te,
      {
        ref: L,
        onKeyDown: gt,
...
br.displayName = Je.Root.displayName;
...
var rr = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(rr || {});
((t) => {
...
const Yo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sl = Yo ? Wt : q, cn = { tag: ur };
function il({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = al(null, o), p = No({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function wl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return ll(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(ur) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const vr = {
...
function hl() {
  return function(t) {
    const [e] = qt(), n = F(() => t(e), [e, t]), [o, a] = T(() => n.initialValueFn()), i = Y(o);
    return ml(() => {
...
const Xo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Xo && "documentMode" in document ? document.documentMode : null;
!(!Xo || !("InputEvent" in window) || vl) && "getTargetRanges" in new window.InputEvent("input");
function Ur(t) {
...
function kl(t) {
  ...
  Jo(this), J = t, this.f &= -2, 8 & this.f && yr(this), Rn();
}
function Ce(t, e) {
...
const ar = Qt({ build: (t) => ea(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Nr = 0, sr = 1, ra = 2, Vn = 3, dn = 4, _e = 5, jn = 6, Ke = 7;
function zn(t) {
  return t.id === Nr;
}
function oa(t) {
...
function Cl(t) {
  return function(e) {
    return e.id === sr;
  }(t) || et(305, String(t.id), String(sr)), Object.assign(t, { id: ra });
}
...
class Rl {
  ...
  register(e, n) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== Ke && et(309, String(o.id), String(Ke)), this.state = function(s) {
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= Ke;
    }(e) || et(316, String(e.id), String(Ke)), e;
  }
...
const Sl = Qt({ config: rn({ setOptions: Wr, updateOptions: Wr }), init: ({ $initialEditorState: t = Tl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class Xe {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      zn(i) || et(300, s, a || "[unknown]"), zn(l = i) || et(304, String(l.id), String(Nr)), i = Object.assign(l, { id: sr }), o.state = i;
...
const Ml = /* @__PURE__ */ new Set(), Qr = Qt({ build(t, e, n) {
  const o = n.getDependency(ar).output, a = Qe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ea(() => {
  }, () => le(() => {
...
Qt({ dependencies: [ar, Qr], name: "@lexical/extension/HorizontalRule", nodes: () => [Se], register(t, e, n) {
...
const kr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : q;
function zl({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, i] = T(() => n.getDecorators());
    return kr(() => n.registerDecoratorListener((s) => {
      Oi(() => {
        i(s);
      });
    }), [n]), q(() => {
...
function Bl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    kr(() => ie(Mi(a), ia(a)), [a]);
  }(o), d(ct, { children: [t, r(Kl, { content: e }), r(Fl, { editor: o, ErrorBoundary: n })] });
}
...
function Ul({ onClear: t }) {
  const [e] = qt();
  return ql(() => ta(e, t), [e, t]), null;
}
const la = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : q;
...
const pa = b.createContext({
  size: "default",
  variant: "default"
}), _r = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = ft();
  return /* @__PURE__ */ r(
    En.Root,
    {
...
function ow() {
  const { activeEditor: t } = ca(), [e, n] = T([]), o = K((a) => {
    if (Ze(a) || Ai(a)) {
      const i = [];
      no.forEach(({ format: s }) => {
...
function fa(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  return p != null && (h = p(h)), Br(t) && (h = cw(t, h, f ? () => {
    const g = new So();
    return n.push(g), g;
...
function ep({
  ...
  const [a, i] = T(pw), [s, l] = T(void 0), [c, w] = T(!1), p = Y(void 0), u = Y(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Er(y) && (y.preventDefault(), y.stopPropagation(), It(a) && h());
        },
        onKeyDown: (y) => {
          Cr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          vn,
          {
...
const np = Object.freeze([
  ...
  const a = Y(null), [i, s] = T(void 0), [l, c] = T(void 0), w = K(
    (f) => {
      s(f);
...
}), ze = ot.Trigger, Na = ot.Group, Nw = ot.Portal, kw = ot.Sub, _w = ot.RadioGroup;
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), f()) : Er(k) && (k.preventDefault(), k.stopPropagation(), It(p) && g());
              },
              onKeyDown: (k) => {
                Cr(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
...
function Ew({
  ...
  const [R, $] = T(oo), [C, S] = T(
    void 0
  ), V = o, [j, I] = T(!1), [A, H] = T(!1), [M, W] = T(!1), [Ct, Dt] = T(!1), [Mt, dt] = T(!1), [P, D] = T(k), [G, Z] = T(!1), Q = Y(void 0), [it, xt] = T(/* @__PURE__ */ new Map());
  q(() => {
    let O = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ d(ct, { children: [
            ...
            v !== !1 && (!A || It(R)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (O) => {
                  Er(O) && (O.preventDefault(), O.stopPropagation(), (It(R) || C !== void 0) && Or());
                },
                onKeyDown: (O) => {
                  Cr(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    vn,
...
function jw({
  ...
  var L;
  const [p, u] = T([]), [h, f] = T([]), [g, x] = T({}), [v, y] = T({}), N = F(() => e ?? [], [e]), _ = Ao({
    data: N,
    columns: t,
    getCoreRowModel: $o(),
  ...
  let z;
  return c ? z = Array.from({ length: 10 }).map((C, S) => `skeleton-row-${S}`).map((C) => /* @__PURE__ */ r(Yt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(xe, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ir, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((L = _.getRowModel().rows) == null ? void 0 : L.length) > 0 ? z = _.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    Yt,
    {
      onClick: () => s(R, _),
...
function ip({
  ...
  return /* @__PURE__ */ d(ne, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Gt, { id: i, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function Gw({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(ne, { open: $, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
...
function Hw({
  ...
  const i = Y(null), s = Y(null), l = Y(!1), [c, w] = T(t), [p, u] = T(n), [h, f] = T(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && u(n);
...
function pp({
  ...
  const w = Y(null), p = Y(null), u = Y(null), [h, f] = T("generated"), [g, x] = T("*"), [v, y] = T("f"), [N, _] = T(!1), [k, z] = T(!1), [L, R] = T(), [$, C] = T(), [S, V] = T(), [j, I] = T(), A = Y(null), H = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const W = K(() => {
    ...
    if (D && wn("note", D)) {
      ...
      v !== "x" && P === "x" ? pt == null || pt.forEach((yt) => ec(yt)) : v === "x" && P !== "x" && (pt == null || pt.forEach((yt) => nc(yt))), (xt = w.current) == null || xt.applyUpdate([D, { delete: 1 }]);
    }
  }, Mt = (P) => {
    var G, Z, Q, it, xt, pt;
    ...
    if (u.current && M.length && P && P.rangeCount > 0) {
      ...
      R(D.left - G.left), C(D.top - G.top), V(D.height), z(!0);
    }
  }, [M, u]);
  return q(() => {
    const P = () => {
...
Sr.displayName = Zn.Root.displayName;
const wc = (t) => {
  if (t === "asc")
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(_r, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        We,
        {
          onClick: (c) => {
            c.stopPropagation(), Kn(
              [l],
              "approved",
              e,
              n,
    ...
    Ma,
    {
      ...
      children: /* @__PURE__ */ d(Ia, { children: [
        /* @__PURE__ */ d(lr, { children: [
          ...
          /* @__PURE__ */ r(cr, { children: /* @__PURE__ */ r(Aa, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(Pa, { children: /* @__PURE__ */ r(
            $a,
            {
              onClick: () => w(h),
              isActive: u(h),
...
function _p({
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const V = x.find((j) => io(j) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [f, x, l, y]);
...
const Mr = (t, e) => t.filter((n) => {
  try {
    return Ue(n) === e;
  } catch {
    return !1;
  }
}), Va = (t, e, n) => Mr(t, e).every((o) => n.includes(o));
function Vc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Mr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    B,
    {
      variant: "outline",
...
function jc({
  ...
  }, [v, y] = T(!1), [N, _] = T(""), k = Y(void 0), z = Y(!1);
...
const za = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Pt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Nw, { children: /* @__PURE__ */ r(_a, { children: za(
      t,
      e,
      ja(t, l.id),
      o
...
Ka.displayName = _t.List.displayName;
...
function Ip({
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Ba, { children: [
      /* @__PURE__ */ r(Ka, { children: t.map((l) => /* @__PURE__ */ r(zc, { value: l.value, children: l.value }, l.key)) }),
...
const Kc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = jt();
  return /* @__PURE__ */ d(
    at.CheckboxItem,
    {
...
Kc.displayName = at.CheckboxItem.displayName;
  ...
  if (Ki(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Ge(i, [h, f]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Ge(s, [h, f]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ge(l, [h, f]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Ge(c, [h, f]);
        break;
    }
  }), q(() => {
...
const zp = st.Root, Fp = st.Trigger, Bp = st.Group, Kp = st.Portal, Gp = st.Sub, qp = st.RadioGroup, td = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  st.SubTrigger,
  {
    ref: a,
    className: m(
