import { jsx as r, jsxs as l, Fragment as Gt } from "react/jsx-runtime";
import m, { forwardRef as Je, useRef as nt, useMemo as H, useState as O, useCallback as B, useLayoutEffect as Cn, createContext as Yr, useContext as Kr, useEffect as It, Fragment as zn } from "react";
import { Command as it } from "cmdk";
import { X as We, Search as $n, Check as St, Clock as _n, ChevronsLeft as Sn, ChevronsRight as Rn, ChevronLeft as $e, ChevronRight as Ft, ArrowLeft as qr, ArrowRight as Jr, Circle as be, ChevronsUpDown as Ze, FilterIcon as Wr, ChevronDown as ve, ChevronUp as Zr, ArrowLeftIcon as Qr, ChevronLeftIcon as to, ChevronRightIcon as eo, ArrowRightIcon as no, Copy as ro, Filter as oo, User as ao, Link as so, CircleHelp as io, Star as wo, AlertCircle as je, CircleCheckIcon as lo, CircleXIcon as co, CircleHelpIcon as po, ArrowUpIcon as mo, ArrowDownIcon as uo, ArrowUpDownIcon as ho, PanelLeft as fo, PanelRight as go, ScrollText as bo, MenuIcon as vo, Menu as xo, EllipsisVertical as yo, LoaderCircle as No } from "lucide-react";
import { clsx as ko } from "clsx";
import { extendTailwindMerge as Co } from "tailwind-merge";
import * as vt from "@radix-ui/react-dialog";
import { includes as me, Section as M, getChaptersForBook as _o, formatScrRef as Bt, getSectionForBook as oe, NumberFormat as So, formatBytes as Ro, getCurrentLocale as To, getFormatCallerFunction as Eo, deepEqual as Qe, isString as Ve, compareScrRefs as Be, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Bn, getFilteredRowModel as Vo, getSortedRowModel as Ln, getPaginationRowModel as Mo, getCoreRowModel as Gn, flexRender as ae, getGroupedRowModel as Do, getExpandedRowModel as Io } from "@tanstack/react-table";
...
const ce = m.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r($n, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      it.Input,
      {
        ref: n,
...
const tr = $.allBookIds.filter(
  (t) => !$.isObsolete($.bookIdToNumber(t))
), Dt = Object.fromEntries(
  tr.map((t) => [t, $.bookIdToEnglishName(t)])
);
function on(t, e, n) {
...
const er = Je(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Yt : "button", { className: c(ra({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function oa({
  ...
  return /* @__PURE__ */ l(Zt, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(jt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Ot, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      $t,
      {
        onSelect: () => d(p),
...
function Si({
  ...
  const d = tt(), [p, f] = O(!1), [h, g] = O(""), [b, y] = O(""), [x, S] = O("books"), [N, C] = O(void 0), [j, W] = O(!1), L = nt(void 0), ot = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), Y = B(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
  ...
  }, [x, N, k, t.book, t.chapterNum]), /* @__PURE__ */ l(Zt, { open: p, onOpenChange: kt, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r(
      I,
      {
          ...
          x === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              I,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ r(qr, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Jr, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Lt(N, a) })
          ] }),
          !j && /* @__PURE__ */ l(Jt, { ref: pt, children: [
            x === "books" && /* @__PURE__ */ l(Gt, { children: [
              ...
              k && bt(k.book) > 1 && /* @__PURE__ */ l(Gt, { children: [
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(jn.Root, { ref: n, className: c("pr-twp", wa(), t), ...e }));
Q.displayName = jn.Root.displayName;
...
function He({
  ...
  const [x, S] = O(!1);
  return /* @__PURE__ */ l(Zt, { open: x, onOpenChange: S, ...y, children: [
...
function Ei({
  ...
  const p = Ie(d, "%webView_bookSelector_currentBook%"), f = Ie(d, "%webView_bookSelector_choose%"), h = Ie(d, "%webView_bookSelector_chooseBooks%"), [g, b] = O(
    "current book"
    /* CURRENT_BOOK */
  ), y = (x) => {
    b(x), t(x);
    ...
    an,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: o.map((x) => $.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
function fa({ table: t }) {
  return /* @__PURE__ */ l(wn, { children: [
    /* @__PURE__ */ r(Oo, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = U.Root, ga = U.Group, Ht = U.Value, ba = Rt(
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        Xt,
        {
          ...
          children: [
            /* @__PURE__ */ r(Pt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ht, { placeholder: t.getState().pagination.pageSize }) }),
...
function Ta({
  ...
  var S;
  const [u, d] = O([]), [p, f] = O([]), [h, g] = O({}), [b, y] = O({}), x = Bn({
    data: e,
    columns: t,
    getCoreRowModel: Gn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    ...
    /* @__PURE__ */ l(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(_t, { children: N.headers.map((C) => /* @__PURE__ */ r(le, { children: C.isPlaceholder ? void 0 : ae(C.column.columnDef.header, C.getContext()) }, C.id)) }, N.id)) }),
      /* @__PURE__ */ r(Se, { children: (S = x.getRowModel().rows) != null && S.length ? x.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        ...
        N.id
      )) : /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r(Ut, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Ii({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(wn, { children: [
    /* @__PURE__ */ r(nr, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(rr, { children: d.itemType === 0 ? /* @__PURE__ */ r(Gt, { children: d.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        ln,
        {
          checked: o[p][h],
        ...
        ua,
        {
          ...
          children: d.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(ir, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(ke, {})
    ] }, d.label)) })
...
function Da({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const u = new Date(w), d = new Date(a.getTime() - u.getTime()), p = d.getUTCFullYear() - 1970, f = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let g = "";
...
function Oa({
  ...
  return /* @__PURE__ */ r("div", { id: f, className: p, children: /* @__PURE__ */ l(Zt, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ l(
      I,
      {
        variant: "ghost",
...
function dr(t, e, n = !0, o = !0, a = []) {
  if (!(!e || e.length === 0))
    return e.map((s) => {
      let i = a.join("-");
      return typeof s == "string" ? (i += `-${s.slice(0, 10)}`, o ? /* @__PURE__ */ r("span", { children: s }, i) : /* @__PURE__ */ l(
        "span",
        {
...
function Aa(t, e, n, o = []) {
  ...
  return /* @__PURE__ */ l("span", { className: s, children: [
...
function Pa({
  ...
  formatCaller: n,
  showMarkers: o = !0,
  useUsfmFallbackStyles: a = !0
}) {
  const s = n ? n(e.caller) : e.caller, i = s !== e.caller;
  return /* @__PURE__ */ l(Gt, { children: [
    a && /* @__PURE__ */ r("style", { children: `
    ...
    /* @__PURE__ */ l(
      "p",
      {
        ...
        children: [
          ...
          s && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
          // specific class name in case styling is needed.
          /* @__PURE__ */ l(
            "span",
            {
              className: c("footnote-caller tw-text-xs tw-font-medium", { formatted: i }),
              children: [
                s,
                " "
              ]
...
function zi({
  ...
  selectedFootnote: o,
  showMarkers: a = !0,
  useUsfmFallbackStyles: s = !0,
  formatCaller: i,
  onFootnoteSelected: w
}) {
  const u = i ?? Eo(e, void 0), d = (p) => {
    w && w(p);
  };
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      className: c("tw-flex tw-flex-col tw-gap-1", t),
      children: e.map((p, f) => {
        const h = p === o, g = `${n}-${f}`;
        return /* @__PURE__ */ r(
          cr,
          {
            ...
            children: /* @__PURE__ */ r(
              Pa,
              {
                className: "tw-m-0",
                footnote: p,
                formatCaller: () => u(p.caller, f),
                showMarkers: a,
                useUsfmFallbackStyles: s
              }
            )
          },
          g
...
function Ga({
  ...
  return /* @__PURE__ */ l(Ce, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(_e, { stickyHeader: !0, children: /* @__PURE__ */ l(_t, { children: [
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(mo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(uo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }), $i = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(ur, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        ue,
        {
          onClick: (u) => {
...
function Hi({
  ...
  const p = yt(n, "%webView_inventory_all%"), f = yt(n, "%webView_inventory_approved%"), h = yt(n, "%webView_inventory_unapproved%"), g = yt(n, "%webView_inventory_unknown%"), b = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), x = yt(n, "%webView_inventory_scope_verse%"), S = yt(n, "%webView_inventory_filter_text%"), N = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = O(!1), [W, L] = O("all"), [ot, pt] = O(""), [_, E] = O([]), Y = H(() => t.length === 0 ? [] : Ya(t, a, s), [t, a, s]), A = H(() => {
    if (C) return Y;
    const T = [];
    return Y.forEach((Z) => {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        Xt,
        {
          ...
          defaultValue: W,
          children: [
            /* @__PURE__ */ r(Pt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ht, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l(Xt, { onValueChange: (T) => k(T), defaultValue: i, children: [
        /* @__PURE__ */ r(Pt, { className: "tw-m-1", children: /* @__PURE__ */ r(Ht, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(zt, { children: [
...
const fr = m.forwardRef(
  ({
    ...
    const [d, p] = m.useState(t), f = e ?? d, h = m.useCallback(
      (C) => {
        const j = typeof C == "function" ? C(f) : C;
        n ? n(j) : p(j);
      },
      [n, f]
...
function ds({
  ...
  return /* @__PURE__ */ r(
    gr,
    {
      ...
      children: /* @__PURE__ */ l(vr, { children: [
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? $.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Ct ? Bt(a.start) : void 0;
      },
...
function Yi({
  ...
  const [d, p] = O([]), [f, h] = O([{ id: Ct, desc: !1 }]), [g, b] = O({}), y = H(
  ...
  return /* @__PURE__ */ l("div", { id: u, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Pt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ht, {}) }),
          /* @__PURE__ */ r(zt, { position: "item-aligned", children: /* @__PURE__ */ r(ga, { children: j.map((_) => /* @__PURE__ */ r(mt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
...
function bs({
  ...
  const s = gn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], u = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
...
function vs({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], w = o["%webView_book_selector_search_books%"], u = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: g, dcLong: b, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, S] = O(!1), [N, C] = O(""), j = nt(void 0), W = nt(!1);
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(un, { children: [
  /* @__PURE__ */ r(hn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    sr,
    {
      onClick: () => {
        o(w);
...
function qe({
  ...
  return /* @__PURE__ */ l(wn, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, d]) => typeof u == "boolean" || typeof d == "boolean" ? 0 : u.order - d.order).map(([u], d, p) => /* @__PURE__ */ l(zn, { children: [
...
function tw({
  ...
  return /* @__PURE__ */ l(Rr, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      qe,
      {
        onSelectMenuItem: t,
...
const zr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
    className: c("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
zr.displayName = F.Separator.displayName;
const ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ l(un, { children: [
      /* @__PURE__ */ r(hn, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        Pr,
        {
          onClick: () => {
            o(d);
    ...
    return w.length > 0 && i < a.length - 1 && u.push(/* @__PURE__ */ r(zr, {}, `separator-${s}`)), u;
  });
};
function Ss({
  menuData: t,
  ...
  if (Po(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), ne(s, [h, g]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), ne(i, [h, g]);
        break;
      case "alt+n":
        (x = w.current) == null || x.focus(), ne(w, [h, g]);
        break;
      case "alt+h":
        (S = u.current) == null || S.focus(), ne(u, [h, g]);
        break;
    }
  }), It(() => {
    ...
    return /* @__PURE__ */ r(Mr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ l(ys, { children: [
      /* @__PURE__ */ r(Dr, { ref: d(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Ar,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(mn, { children: $r(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function aw({
  ...
  const d = Rs(
    ...
    var S, N, C, j, W, L;
    const x = y !== b ? ((N = (S = t[b]) == null ? void 0 : S.uiNames) == null ? void 0 : N[y]) ?? ((j = (C = t[b]) == null ? void 0 : C.uiNames) == null ? void 0 : j.en) : void 0;
  ...
  return /* @__PURE__ */ l("div", { id: u, className: c("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Xt,
      {
        ...
        onOpenChange: (b) => f(b),
        children: [
          /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r(Ht, {}) }),
          /* @__PURE__ */ r(
            zt,
            {
              className: "tw-z-[250]",
...
Os.displayName = Kt.Root.displayName;
...
As.displayName = Kt.Image.displayName;
...
Ps.displayName = Kt.Fallback.displayName;
const ww = X.Root, lw = X.Trigger, dw = X.Group, cw = X.Portal, pw = X.Sub, mw = X.RadioGroup, zs = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
zs.displayName = X.SubTrigger.displayName;
...
$s.displayName = X.SubContent.displayName;
const js = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: c(
...
js.displayName = X.Content.displayName;
...
const Ls = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  X.CheckboxItem,
  {
    ref: a,
    className: c(
...
const Gs = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ref: o,
    className: c(
...
ti.displayName = re.Root.displayName;
...
export {
  ...
  ji as inventoryCountColumn,
  $i as inventoryItemColumn,
