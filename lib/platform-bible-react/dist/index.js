...
var Qi = (t, e, r) => e in t ? Zi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Gt = (t, e, r) => Qi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as xe, a as Rr, C as Ie, u as Oo, T as jt, b as Ct, d as Et, e as Tt, A as he, P as Ke, f as sr, B as Q, h as He, i as qe, j as Ge, k as Me, x as ts, l as es, m as rs, I as as, n as lo, r as Ne, o as os, p as Cn, q as wa, s as ua, L as Pt, R as wo, t as aa, D as Ua, v as Ka, w as Ha, y as qa, z as En, E as Yr, F as uo, G as Tn, H as po, J as or, K as Or, M as Ye, N as We, O as Xe, S as Ir, Q as pr, U as ns, V as Vr, W as ir, X as Be, Z as cr, Y as Le, _ as hr, $ as ho, a0 as go, a1 as oa, a2 as fo, a3 as Sn, a4 as is, a5 as ss, a6 as cs, a7 as Ga, a8 as Rn, a9 as pa, aa as ls, ab as Dn, ac as ds, ad as ws, ae as us, af as Io, ag as ps, ah as hs, ai as gs, aj as zn, ak as Mn, al as mo, am as fs, an as On, ao as Ta, ap as $o, aq as Sa, ar as ms, as as vs, at as bs, au as xs, av as ys, aw as Lr, ax as vo, ay as ks, az as _s } from "./resizable-u_SwO6Mj.js";
import { aA as Dg, aB as zg, aC as Mg, aD as Og, aE as Ig, aF as $g, aG as Pg, aH as Ag, aI as Vg, aJ as Lg, aK as jg, aL as Bg, aM as Fg, aN as Ug, aO as Kg, aP as Hg, aQ as qg, aR as Gg, aS as Yg, aT as Wg, aU as Xg, aV as Jg, aW as Zg, aX as Qg, aY as tf, aZ as ef, a_ as rf, a$ as af, b0 as of, b1 as nf, b2 as sf, b3 as cf, b4 as lf, b5 as df, b6 as wf, b7 as uf, b8 as pf, b9 as hf } from "./resizable-u_SwO6Mj.js";
import { jsx as a, jsxs as u, Fragment as ut } from "react/jsx-runtime";
import { Canon as Lt } from "@sillsdev/scripture";
import { Check as Fe, Clock as Po, ChevronsLeft as Ao, ChevronsRight as Vo, ChevronLeft as Ya, ChevronRight as Wa, ArrowLeft as Ns, ArrowRight as Cs, ChevronDown as mr, BoldIcon as Es, ItalicIcon as Ts, X as In, AtSign as $n, Pencil as Ss, Trash2 as Lo, ArrowUp as Pn, MoreHorizontal as Rs, MailOpen as Ds, Mail as zs, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as An, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as Vn, FunctionSquare as Ln, SquareSigma as jn, Ban as Ks, AlertCircle as Xa, CircleCheckIcon as Hs, CircleXIcon as qs, CircleHelpIcon as Gs, ArrowUpIcon as Ys, ArrowDownIcon as Ws, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as $t, getChaptersForBook as rc, formatScrRef as De, formatReplacementString as je, getSectionForBook as Wr, formatRelativeDate as ac, sanitizeHtml as bo, NumberFormat as Bn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Xr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as jo, compareScrRefs as Ja, scrRefToBBBCCCVVV as Ra, defaultScrRef as Da, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as uc } from "platform-bible-utils";
import Wt, { useRef as B, useMemo as P, createContext as jr, useContext as ha, useState as k, useEffect as Z, useCallback as L, useImperativeHandle as pc, useLayoutEffect as Qt, Component as hc, createElement as Uo, Suspense as gc, forwardRef as Fn, memo as Un, useId as Ko, Fragment as ga } from "react";
import { IconSelector as Kn, IconCheck as fa, IconChevronDown as fc, IconChevronUp as mc, IconLayoutSidebar as vc, IconLayoutSidebarRight as bc, IconChevronRight as Hn, IconSearch as xc, IconLoader as yc, IconAlertOctagon as kc, IconAlertTriangle as _c, IconInfoCircle as Nc, IconCircleCheck as Cc } from "@tabler/icons-react";
import { createEditor as qn, $getRoot as Ue, $createParagraphNode as Br, $getSelection as te, HISTORY_MERGE_TAG as xo, ParagraphNode as Gn, TextNode as Yn, $getPreviousSelection as Ec, $isRangeSelection as ke, $caretFromPoint as Tc, $getSiblingCaret as Wn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as Dc, $normalizeCaret as zc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Ho, $splitAtPointCaretNext as Ic, $isTextPointCaret as $c, $findMatchingParent as Xn, $isElementNode as $r, mergeRegister as Oe, getDOMTextNode as Pc, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Jn, COMMAND_PRIORITY_EDITOR as yo, shallowMergeConfig as Vc, defineExtension as we, safeCast as lr, createState as Lc, FORMAT_TEXT_COMMAND as Zn, $isNodeSelection as Qn, COMMAND_PRIORITY_LOW as ti, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as qc, $getNodeFromDOMNode as Gc, $createNodeSelection as Yc, $setSelection as Wc, $getEditor as Xc, DecoratorNode as Za, $getState as Jc, toggleTextFormatType as qo, TEXT_TYPE_TO_FORMAT as Zc, $setState as Qc, addClassNamesToElement as ei, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as ko, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Qa, SELECTION_CHANGE_COMMAND as ri, $insertNodes as wl } from "lexical";
...
import { Avatar as _o, Select as Xt, Checkbox as Yo, Slot as Fr, Tabs as ge, Menubar as Ce, ContextMenu as Bt, Progress as Wo, Slider as Ur, Switch as Xo } from "radix-ui";
import { useReactTable as oi, getFilteredRowModel as xl, getSortedRowModel as ni, getPaginationRowModel as yl, getCoreRowModel as ii, flexRender as Dr, getGroupedRowModel as kl, getExpandedRowModel as _l } from "@tanstack/react-table";
import Nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as to, HIDDEN_NOTE_CALLER as eo, getDefaultViewOptions as Cl, isInsertEmbedOpOfType as Er, getMarkerMenuItems as El, defaultStyleInfo as Tl, Editorial as Sl } from "@eten-tech-foundation/platform-editor";
...
function ci({
  ...
  const g = B(!1), f = () => {
    ...
    () => Rr(e, d),
    [e, d]
  ), x = !!p && !w, C = `${m} (${R})`, _ = x ? h || `${C}, ${p}` : C, I = /* @__PURE__ */ u(
    Ie,
    {
      ref: t,
      value: l || `${e} ${Lt.bookIdToEnglishName(e)}`,
      onSelect: f,
      onMouseDown: b,
      role: "option",
      "aria-selected": r,
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: v(
        ...
        {
          "tw:border-s-red-200": s === $t.OT,
          "tw:border-s-purple-200": s === $t.NT,
          "tw:border-s-indigo-200": s === $t.DC,
          "tw:border-s-amber-200": s === $t.Extra
        }
      ),
      children: I
    }
...
function Il({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: b
  } = Oo(), [m, R] = k(!1), [x, C] = k(!1), _ = B(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), I = n && e !== void 0, j = s ?? (e !== void 0 && !n);
  Z(() => {
    var J;
    Ol();
    const O = (J = _.current) == null ? void 0 : J.closest('button, [role="combobox"], [tabindex]');
    if (!O) return;
    const N = (q) => !!q && q.scrollWidth > q.clientWidth, ot = () => {
      ro !== "pointer" && (j || N(h.current) || N(d.current)) && C(!0);
    }, z = () => C(!1);
    return O.addEventListener("focus", ot), O.addEventListener("blur", z), () => {
      O.removeEventListener("focus", ot), O.removeEventListener("blur", z);
    };
  }, [j, h, d]);
  const K = L(() => {
    j && R(!0), f(), I && w();
  ...
  const S = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), U = I ? (
...
function $l({
  ...
  const [h, g] = k(!1), f = w !== void 0, b = f ? w : h, m = (x) => {
    f || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ke, { open: b, onOpenChange: m, children: [
    /* @__PURE__ */ a(sr, { asChild: !0, children: /* @__PURE__ */ a(
      Q,
      {
        ...
        className: d,
        "aria-label": n,
        children: /* @__PURE__ */ a(Po, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ a(He, { id: i, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(Me, { heading: s, children: t.map((x) => /* @__PURE__ */ u(
      Ie,
      {
        onSelect: () => R(x),
        className: v("tw:flex tw:items-center", c),
        children: [
          /* @__PURE__ */ a(Po, { className: "tw:mr-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function Sp(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
  ...
  const o = Al.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && d) {
          const g = ((f) => Object.keys(he).find(
            (b) => he[b].toLowerCase() === f.toLowerCase()
          ))(c);
...
function ao(t) {
  return {
    [$t.OT]: t.filter((e) => Lt.isBookOT(e)),
    [$t.NT]: t.filter((e) => Lt.isBookNT(e)),
    [$t.DC]: t.filter((e) => Lt.isBookDC(e)),
    [$t.Extra]: t.filter((e) => Lt.extraBooks().includes(e))
  };
}
function Bl(t, e) {
  const r = new Set(t), o = e.filter((l) => !r.has(l)), n = new Set(o), s = n.size === 0 ? t : Lt.allBookIds.filter(
    (l) => r.has(l) || n.has(l)
  ), i = ao(s), c = Object.values(i).flat(), d = ao(t);
  return {
...
function ui({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
      ...
      return /* @__PURE__ */ a(
        Ie,
        {
          ...
          className: v(
            ...
            {
              "tw:bg-muted/50 tw:text-muted-foreground/50": ((s == null ? void 0 : s(d)) ?? !1) && !l
            },
...
function Ma({
  ...
  const j = Ne(), K = Ml(), [M, S] = k(!1), [U, Y] = k(""), [X, O] = k(""), [N, ot] = k("books"), [z, J] = k(void 0), [q, $] = k(
    void 0
  ), [rt, pt] = k(void 0), [gt, tt] = k(!1), [ht, bt] = k(!1), yt = B(null), vt = B(!1), _t = B(void 0), At = B(void 0), Ft = B(void 0), ce = B(void 0), zt = B({}), Jt = B({}), xt = L(
    (y) => {
      e(y), d && d(y);
    },
    [e, d]
    ...
    projectBooksBySection: St,
    reachableBooksBySection: re,
    reachableBooks: Ht,
    projectBooks: $e,
    booksOutsideProject: ae
  } = P(
    () => Bl(ee, le),
    [ee, le]
  ), Te = ae.has(t.book), Se = P(() => X.trim() ? ao(
    Ht.filter((y) => lo(y, X, s))
  ) : ht ? re : St, [
    St,
    re,
    Ht,
  ...
  const ue = L(() => {
    ...
    (y) => {
      const at = q ?? (D == null ? void 0 : D.book), it = rt ?? (D == null ? void 0 : D.chapterNum);
      !at || !it || (xt({
        book: at,
        chapterNum: it,
        verseNum: y
    ...
    (y) => {
      const at = N === "chapters" ? z : D == null ? void 0 : D.book;
      if (at) {
        if (w && w(at, y) > 1) {
          $(at), pt(y), ot("verses"), Y("");
          return;
    ...
    ot("books"), J(void 0), $(void 0), pt(void 0), setTimeout(() => {
      At.current && At.current.focus();
    }, 0);
  }, []), F = L(() => {
    const y = q;
    $(void 0), pt(void 0), y ? (J(y), ot("chapters"), Y("")) : E();
  }, [q, E]), G = L(
    (y) => {
      S(y), y && (ot("books"), J(void 0), $(void 0), pt(void 0), O(""), bt(Te));
    },
    [Te]
  );
  Z(() => {
  ...
  const { otLong: A, ntLong: nt, dcLong: st, extraLong: lt } = {
    ...
    () => K >= zr.TIGHT ? Rr(t.book, s) : xe(t.book, s),
    [t.book, s, K]
  ), Ze = `${t.chapterNum}:${t.verseNum}`, fe = L((y) => (at) => {
    zt.current[y] = at;
  }, []), me = L((y) => (at) => {
    Jt.current[y] = at;
  }, []), Qe = P(
    () => Vl(X),
    [X]
  ), T = P(() => !w || !D || !D.chapterNum || !Qe ? !1 : w(D.book, D.chapterNum) > 0, [w, D, Qe]), ct = N === "books" && !gt && !X.trim() && ae.size > 0, dt = L(
    (y) => p ? Zo(y, p) : !1,
    [p]
  ), qt = L(
    (y) => (at) => p ? Ll(y, at, p) : !1,
    ...
    (y, at) => (it) => p ? za(y, at, it, p) : !1,
    [p]
  ), Nr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", tr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) || "Select verse", ya = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", er = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ka = L(
    (y) => je(er, {
      book: `${xe(y, s)} (${Rr(
        y,
        s
    ...
    [er, s]
  ), dr = (i == null ? void 0 : i["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", _a = (i == null ? void 0 : i["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", Na = L(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), h && h.includes(y.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), ue());
    },
    [h, D, ue]
  ), Ca = L(
    (y) => {
      var Re, V, et;
      if (y.ctrlKey) return;
      const { isLetter: at, isDigit: it } = Qo(y.key);
      if ((N === "chapters" || N === "verses") && (y.key === " " || y.key === "Enter")) {
        const ft = y.target instanceof HTMLElement ? y.target : void 0;
        ...
        const Kt = (Re = _t.current) == null ? void 0 : Re.querySelector(
      ...
      const Zt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (N === "verses" && Zt) {
        const ft = q, kt = rt;
        if (!ft || !kt || !w) return;
        const Kt = w(ft, kt);
        ...
        switch (y.key) {
          case "ArrowLeft":
            Dt !== 0 && (ve = Dt > 1 ? Dt - 1 : Kt);
            break;
          case "ArrowRight":
            Dt !== 0 && (ve = Dt < Kt ? Dt + 1 : 1);
            break;
          case "ArrowUp":
            ve = Dt === 0 ? Kt : Math.max(1, Dt - Ae);
            break;
          case "ArrowDown":
            ve = Dt === 0 ? 1 : Math.min(Kt, Dt + Ae);
            break;
          default:
            return;
        }
        ve !== Dt && (y.preventDefault(), y.stopPropagation(), Y(
          `${ft} ${he[ft] || ""} ${kt}:${ve}`
        ), setTimeout(() => {
          const Cr = Jt.current[ve];
          Cr && Cr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((N === "chapters" || N === "books" && D) && Zt) {
        const ft = N === "chapters" ? z : D == null ? void 0 : D.book;
        if (!ft) return;
        N === "chapters" && ((et = _t.current) == null || et.focus());
        const kt = (() => {
          if (!U) return 1;
          const Ae = U.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            kt !== 0 && (Dt = kt > 1 ? kt - 1 : Kt);
            break;
          case "ArrowRight":
            kt !== 0 && (Dt = kt < Kt ? kt + 1 : 1);
            break;
          case "ArrowUp":
            Dt = kt === 0 ? Kt : Math.max(1, kt - ve);
            break;
          case "ArrowDown":
            Dt = kt === 0 ? 1 : Math.min(Kt, kt + ve);
            break;
          default:
            return;
        }
        Dt !== kt && (y.preventDefault(), y.stopPropagation(), Y(
          `${ft} ${he[ft] || ""} ${Dt}`
        ), setTimeout(() => {
          const Ae = zt.current[Dt];
    ...
    if (y.key === "ArrowUp" || y.key === "ArrowDown") {
      (Zt = At.current) == null || Zt.focus();
      return;
    }
    const { isLetter: at, isDigit: it } = Qo(y.key);
    (at || it) && (y.preventDefault(), O((Re) => Re + y.key), At.current.focus(), tt(!1));
  }, []);
  return Qt(() => {
    const y = setTimeout(() => {
      if (M && N === "books" && Ft.current && ce.current) {
        const at = Ft.current, it = ce.current, Zt = it.offsetTop, Re = at.clientHeight, V = it.clientHeight, et = Zt - Re / 2 + V / 2;
        at.scrollTo({
          top: Math.max(0, et),
          behavior: "smooth"
        }), Y(wi(t.book));
    ...
    if (N === "chapters" && z) {
      const y = z === t.book, at = y ? t.chapterNum : 1;
      Y(
        `${z} ${he[z] || ""} ${at}`
      ), setTimeout(() => {
        if (Ft.current)
          if (y) {
            const it = zt.current[t.chapterNum];
  ...
  }, [N, z, D, t.book, t.chapterNum]), Qt(() => {
    if (N === "verses" && q && rt !== void 0) {
      const y = q === t.book && rt === t.chapterNum, at = y ? t.verseNum : 1;
      Y(
        `${q} ${he[q] || ""} ${rt}:${at}`
      ), setTimeout(() => {
        if (Ft.current)
          if (y) {
            const it = Jt.current[t.verseNum];
            it && it.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Ft.current.scrollTo({ top: 0 });
        _t.current && _t.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ke, { open: M, onOpenChange: G, modal: x, children: [
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Il,
            {
              primary: Ut,
              secondary: Ze,
              showSecondary: K < zr.MINIMUM,
              isPartial: K >= zr.TIGHT,
              fullText: It
            }
          ),
          b && /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      He,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: at } = y;
          M && yt.current && at instanceof Node && yt.current.contains(at) && (vt.current = !0, G(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          qe,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                  ...
                  c && c.length > 0 && /* @__PURE__ */ a(
                    ...
                    {
                      recentSearches: c,
                      onSearchItemSelect: ne,
                      renderItem: (y) => De(y, "English"),
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ie.map(
                  ({ onClick: y, disabled: at, title: it, icon: Zt }) => /* @__PURE__ */ a(
                    Q,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  Q,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: N === "verses" ? F : E,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: j === "ltr" ? /* @__PURE__ */ a(Ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && z && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: xe(z, s) }),
                N === "verses" && q && rt !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${xe(q, s)} ${rt}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? tr : Nr
                  }
                )
              ] }),
              !gt && /* @__PURE__ */ u(Ge, { ref: Ft, children: [
                N === "books" && /* @__PURE__ */ u(ut, { children: [
                  !D && Object.entries(Se).map(([y, at]) => {
                    if (at.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Me, { heading: Nt(y), children: at.map((it) => /* @__PURE__ */ a(
                          ci,
                          {
                            bookId: it,
                            onSelect: (Zt) => Ot(Zt),
                            section: Wr(it),
                            commandValue: `${it} ${he[it]}`,
                            ref: it === t.book ? ce : void 0,
                            localizedBookNames: s,
                            disabled: dt(it),
                            dimmedReason: ae.has(it) ? ya : void 0,
                            dimmedDescription: ae.has(it) ? ka(it) : void 0
                          },
                          it
                        )) }, y)
                      );
                  }),
                  D && /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a(
                    Ie,
                    {
                      value: `${D.book} ${he[D.book]} ${D.chapterNum || ""}:${D.verseNum || ""})}`,
                      onSelect: ue,
                      disabled: !!p && za(
                        D.book,
                        D.chapterNum ?? 1,
                      ...
                      children: De(
                        ...
                        // one control.
                        s ? Rr(D.book, s) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  D && T && D.chapterNum && w && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${xe(D.book, s)} ${D.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: tr })
                    ] }),
                    /* @__PURE__ */ a(
                      en,
                      {
                        ...
                        onVerseSelect: oe,
                        setVerseRef: me,
                        isVerseDisabled: Pe(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !T && gr(D.book) > 1 && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: xe(D.book, s) }),
                      /* @__PURE__ */ a("span", { children: Nr })
                    ] }),
                    /* @__PURE__ */ a(
                      tn,
                      {
                        ...
                        setChapterRef: fe,
                        isChapterDimmed: Rt,
                        isChapterDisabled: qt(D.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                N === "chapters" && z && /* @__PURE__ */ a(
                  tn,
                  {
                    bookId: z,
                    scrRef: t,
                    onChapterSelect: de,
                    setChapterRef: fe,
                    isChapterDisabled: qt(z),
                    className: "tw:p-4"
                  }
                ),
                N === "verses" && q && rt !== void 0 && w && /* @__PURE__ */ a(
                  en,
                  {
                    bookId: q,
                    chapterNum: rt,
              ...
              ct && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                Q,
                {
                  variant: "ghost",
                  size: "sm",
...
function rn({
  ...
  const [C, _] = k(!1), I = l ?? d, j = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], K = (M, S) => {
    const U = d(M), Y = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, X = `${S ?? ""}${U}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Ie,
      {
        value: U,
  ...
  return /* @__PURE__ */ u(Ke, { open: C, onOpenChange: _, ...x, children: [
    /* @__PURE__ */ a(sr, { asChild: !0, children: /* @__PURE__ */ u(
      Q,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      He,
      {
        ...
        style: s,
        children: /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a(
            wa,
            {
              placeholder: h,
          ...
          /* @__PURE__ */ a(Ge, { children: j(e) ? e.map((M) => /* @__PURE__ */ a(Me, { heading: M.groupHeading, children: M.options.map((S) => K(S, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(Me, { children: e.map((M) => K(M)) }) })
        ] })
      }
    )
  ] });
...
function zp({
  ...
  const w = Oa(l, "%webView_bookSelector_currentBook%"), p = Oa(l, "%webView_bookSelector_choose%"), h = Oa(l, "%webView_bookSelector_chooseBooks%"), [g, f] = k(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
    ...
    wo,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Pt, { className: "tw:flex tw:items-center", children: o.map((m) => Lt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            Q,
            {
...
const hi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = hi ? Qt : Z, Hr = { tag: xo };
function ql({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: d } = t, l = Kl(null, o), w = qn({ editable: t.editable, html: d, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Br();
            g.append(f);
            const b = hi ? document.activeElement : null;
            (te() !== null || b !== null && b === p.getRootElement()) && f.select();
          }
        }, Hr);
...
const Gl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Z;
function Yl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Gl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: s, dirtyLeaves: i, prevEditorState: c, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(xo) || c.isEmpty() || r(n, o, d);
    });
  }, [o, t, e, r]), null;
}
const No = {
...
const Ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Z;
function td(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function ed() {
  return function(t) {
    const [e] = Ee(), r = P(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), s = B(o);
    return Ql(() => {
...
const gi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ad = gi && "documentMode" in document ? document.documentMode : null;
!(!gi || !("InputEvent" in window) || ad) && "getTargetRanges" in new window.InputEvent("input");
function ye(t) {
  return `${t}px`;
}
...
function nd(t, e, r) {
  ...
  function d() {
    ...
    for (let R = 0; R < g.length; R++) {
      const x = g[R], C = i[R] || document.createElement("div"), _ = C.style;
      _.position !== "absolute" && (_.position = "absolute", m = !0);
      const I = ye(x.left - p);
      _.left !== I && (_.left = I, m = !0);
      const j = ye(x.top - h);
      _.top !== j && (C.style.top = j, m = !0);
      const K = ye(x.width);
      _.width !== K && (C.style.width = K, m = !0);
      const M = ye(x.height);
      _.height !== M && (C.style.height = M, m = !0), C.parentNode !== c && (c.append(C), m = !0), i[R] = C;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!Ac(g)) return l();
    l(), o = h, n = g, s = new MutationObserver((f) => {
      const b = t.getRootElement(), m = b && b.parentElement;
      if (b !== o || m !== n) return p();
      for (const R of f) if (!c.contains(R.target)) return d();
    }), s.observe(g, od), d();
  });
  return () => {
    w(), l();
  ...
  function l(w) {
    w.read(() => {
      ...
      const [h, g] = function(M) {
        const S = M.getStartEndPoints();
        return M.isBackward() ? [S[1], S[0]] : S;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, R = g.getNode(), x = R.getKey(), C = g.offset, _ = t.getElementByKey(b), I = t.getElementByKey(x), j = r === null || _ !== o || m !== n || b !== r.getKey(), K = s === null || I !== i || C !== c || x !== s.getKey();
      if ((j || K) && _ !== null && I !== null) {
        const M = function(S, U, Y, X, O, N, ot) {
          const z = (S._window ? S._window.document : document).createRange();
          return z.setStart(...an(U, Y, X)), z.setEnd(...an(O, N, ot)), z;
        }(t, h, f, _, g, R, I);
        d(), d = nd(t, M, e);
      }
      r = f, o = _, n = m, s = R, i = I, c = C;
    });
  }
  return l(t.getEditorState()), Oe(t.registerUpdateListener(({ editorState: w }) => l(w)), () => {
    d();
  });
}
function cd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = sd(t, e));
  };
...
function ld(t) {
  const e = Xn(t, (r) => $r(r) && !r.isInline());
  return $r(e) || na(4, t.__key), e;
}
function dd(t) {
  const e = te() || Ec();
  let r;
  if (ke(e)) r = Tc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = Wn(c, "next"));
    }
    r = r || Sc(Ue(), "previous").getFlipped().insert(Br());
  }
  const o = wd(t, r), n = Rc(o), s = Dc(n) ? zc(n) : o;
  return Mc(Oc(s)), t.getLatest();
}
function wd(t, e, r) {
  let o = Ho(e, "next");
  for (let n = o; n; n = Ic(n, r)) o = n;
  return $c(o) && na(283), o.insert(t.isInline() ? Br().append(t) : t), Ho(Wn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = te();
  if (!ke(e)) return !1;
...
let ia, ze = 0, sa = 0, gd = 0, no = 0, Zr = 0;
function nn(t) {
  if (wt === void 0) return;
  let e = t.n;
...
function md(t) {
  ...
  mi(this), wt = t, this.f &= -2, 8 & this.f && Eo(this), va();
}
function ur(t, e) {
...
Yt.prototype.brand = pd, Yt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ze !== 0 && sa === 0 && e.l !== no && (e.l = no, ia = { S: e, v: e.v, i: e.i, o: ia });
    })(this), this.v = t, this.i++, Zr++, ze++;
    try {
...
} }), rr.prototype = new Yt(), rr.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Zr)) return !0;
  if (this.g = Zr, this.f |= 1, this.i > 0 && !fi(this)) return this.f &= -2, !0;
  const t = wt;
  try {
    sn(this), wt = this;
    const e = this.x();
...
}, Object.defineProperty(rr.prototype, "value", { get() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, vi(this), sn(this), ze++;
  const t = wt;
  return wt = this, md.bind(this, t);
...
we({ build: (t, e, r) => _r(e), config: lr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function bi() {
  const t = Ue(), e = te(), r = Br();
  t.clear(), t.append(r), e !== null && r.select(), ke(e) && (e.format = 0);
}
function xi(t, e = bi) {
  return t.registerCommand(Jn, (r) => (t.update(e), !0), yo);
}
we({ build: (t, e, r) => _r(e), config: lr({ $onClear: bi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return _e(() => xi(t, o.value));
} });
function vd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const $a = Lc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class yi extends Za {
  $config() {
    return this.config("decorator-text", { extends: Za, stateConfigs: [{ flat: !0, stateConfig: $a }] });
  }
  getFormat() {
    return Jc(this, $a);
  }
...
we({ name: "@lexical/extension/DecoratorText", nodes: () => [yi], register: (t, e, r) => t.registerCommand(Zn, (o) => {
  const n = te();
  if (Qn(n) || ke(n)) for (const s of n.getNodes()) bd(s) && s.toggleFormat(o);
  return !1;
}, ti) });
function ki(t, e) {
  let r;
...
const io = we({ build: (t) => ki(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const To = 0, so = 1, Ni = 2, Pa = 3, qr = 4, wr = 5, Aa = 6, Tr = 7;
function Va(t) {
  return t.id === To;
}
function Ci(t) {
...
function xd(t) {
  return function(e) {
    return e.id === so;
  }(t) || mt(305, String(t.id), String(so)), Object.assign(t, { id: Ni });
}
...
class kd {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(c, d, l) {
      return Object.assign(c, { config: d, id: Pa, registerState: l });
    }(r, this.mergeConfigs(), o);
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(e, s.config, o)), this.state = function(c, d, l) {
      return Object.assign(c, { id: qr, initResult: d, registerState: l });
    }(s, i, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== qr && mt(307, String(r.id), String(wr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, c) {
      return Object.assign(s, { id: wr, output: i, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== wr && mt(308, String(o.id), String(wr));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: Aa });
    }(o), () => {
      const s = this.state;
      s.id !== Tr && mt(309, String(o.id), String(Tr)), this.state = function(i) {
        return Object.assign(i, { id: wr });
      }(s), n && n();
    };
  }
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Aa && mt(310, String(r.id), String(Aa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= qr;
    }(e) || mt(313, String(e.id), String(qr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Pa;
    }(e) || mt(314, String(e.id), String(Pa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Tr;
    }(e) || mt(316, String(e.id), String(Tr)), e;
  }
...
const Nd = we({ config: lr({ setOptions: cn, updateOptions: cn }), init: ({ $initialEditorState: t = _d }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: s } = n;
    if (Uc(s)) t.setEditorState(s, r);
...
}, name: "@lexical/extension/InitialState", nodes: [jc, Yn, Bc, Fc, Gn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function Cd(t) {
  throw t;
...
class fr {
  ...
  static maybeFromEditor(e) {
    const r = e[ln];
    return r && (r.PACKAGE_VERSION !== La && mt(292, r.PACKAGE_VERSION, La), r instanceof fr || mt(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(qn({ ...o, ...r ? { onError: (s) => {
      r(s, n);
    } } : {} }), { [ln]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Va(s) || mt(300, i, n || "[unknown]"), Va(c = s) || mt(304, String(c.id), String(To)), s = Object.assign(c, { id: so }), o.state = s;
    ...
    for (const o of this.extensionNameMap.values()) Va(o.state) && r(o);
    ...
    for (const w of c) {
      ...
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of vd(p)) {
        if (typeof h != "function") {
          ...
          g && mt(302, p.name, h.replace.name, g.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const Ed = /* @__PURE__ */ new Set(), wn = we({ build(t, e, r) {
  const o = r.getDependency(io).output, n = Pr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ki(() => {
  }, () => _e(() => {
    const i = s.peek(), { watchedNodeKeys: c } = n.value;
    let d, l = !1;
    o.value.read(() => {
      if (te()) for (const [w, p] of c.entries()) {
        if (p.size === 0) {
          c.delete(w);
          continue;
        }
        const h = el(w), g = h && h.isSelected() || !1;
        l = l || g !== (!!i && i.has(w)), g && (d = d || /* @__PURE__ */ new Set(), d.add(w));
      }
    }), !l && d && i && d.size === i.size || (s.value = d);
  }));
  return { watchNodeKey: function(i) {
    const c = fd(() => (s.value || Ed).has(i)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(i);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(i, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [io], name: "@lexical/extension/NodeSelection" }), Td = Kc("INSERT_HORIZONTAL_RULE_COMMAND");
class vr extends Za {
  static getType() {
    return "horizontalrule";
  }
  static clone(e) {
    return new vr(e.__key);
  }
  static importJSON(e) {
...
we({ dependencies: [io, wn], name: "@lexical/extension/HorizontalRule", nodes: () => [vr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(wn).output, n = Pr({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Oe(t.registerCommand(Td, (i) => {
    const c = te();
    if (!ke(c)) return !1;
    ...
    return !0;
  }, yo), t.registerCommand(Hc, (i) => {
    if (qc(i.target)) {
      const c = Gc(i.target);
      if (Rd(c)) return function(d, l = !1) {
        const w = te(), p = d.isSelected(), h = d.getKey();
        let g;
        l && Qn(w) ? g = w : (g = Yc(), Wc(g)), p ? g.delete(h) : g.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
  }, ti), t.registerMutationListener(vr, (i, c) => {
    hd(() => {
      let d = !1;
      ...
      for (const [w, p] of i.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = g : (d = !0, l.set(w, { domNode: Pr(g), selectedSignal: o(w) }));
      }
      d && (n.value = { nodeSelections: l });
    });
  }), _e(() => {
    const i = [];
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) i.push(_e(() => {
      const l = c.value;
      l && (d.value ? ei(l, s) : rl(l, s));
    }));
    return Oe(...i);
  }));
} });
we({ build: (t, e) => _r({ inheritEditableFromParent: e.inheritEditableFromParent }), config: lr({ $getParentEditor: function() {
  const t = Xc();
...
we({ build: (t, e, r) => _r(e), config: lr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return _e(() => {
...
function Dd(t, e, r = Ei) {
  return Oe(t.registerCommand(al, (o) => {
    const n = te();
    if (!ke(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => ol(h) && h.canIndent()).length > 0) return !0;
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = ld(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = nl();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = il(g), g.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? sl : Go : cl;
    return t.dispatchCommand(s, void 0);
  }, yo), t.registerCommand(Go, () => {
    const o = typeof e == "number" ? e : e ? e.peek() : null, n = te();
    if (!ke(n)) return !1;
...
we({ build: (t, e, r) => _r(e), config: lr({ $canIndent: Ei, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return _e(() => {
    if (!o.value) return Dd(t, n, s);
  });
} });
const zd = we({ name: "@lexical/react/ReactProvider" });
function Md() {
...
function Id(t) {
  if (!Od(t, !1)) return !1;
  const e = Ue().getChildren(), r = e.length;
  if (r > 1) return !1;
  for (let o = 0; o < r; o++) {
    const n = e[o];
    if (ll(n)) return !1;
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ke(f)) {
                const b = f.anchor;
                let m = b.getNode(), R = 0, x = 0;
                if (Qa(m) && l >= 0 && w >= 0 && (R = l, x = l + w, f.setTextNodeRange(m, R, m, x)), R === x && p === "" || (f.insertRawText(p), m = b.getNode()), Qa(m)) {
                  R = h, x = h + g;
                  const C = m.getTextContentSize();
                  R = R > C ? C : R, x = x > C ? C : x, f.setTextNodeRange(m, R, m, x);
                }
...
we({ build: (t, e, r) => _r(e), config: lr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : Si(t)) });
function $d(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ro = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Z;
function Pd({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, s] = k(() => r.getDecorators());
    return Ro(() => r.registerDecoratorListener((i) => {
      gl(() => {
        s(i);
      });
    }), [r]), Z(() => {
...
function Ad({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(zd.name)) {
...
function Vd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Ro(() => Oe(hl(n), Si(n)), [n]);
  }(o), u(ut, { children: [t, a(Ld, { content: e }), a(Ad, { editor: o, ErrorBoundary: r })] });
}
...
const Bd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Z;
function Fd({ onClear: t }) {
  const [e] = Ee();
  return Bd(() => xi(e, t), [e, t]), null;
}
const Ri = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : Z;
function Ud({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: R = !0, style: x, tabIndex: C, "data-testid": _, ...I }, j) {
  const [K, M] = k(t.isEditable()), S = L((Y) => {
    Y && Y.ownerDocument && Y.ownerDocument.defaultView ? t.setRootElement(Y) : t.setRootElement(null);
  }, [t]), U = P(() => /* @__PURE__ */ function(...Y) {
    return (X) => {
      for (const O of Y) typeof O == "function" ? O(X) : O != null && (O.current = X);
    };
  }(j, S), [S, j]);
  return Ri(() => (M(t.isEditable()), t.registerEditableListener((Y) => {
    M(Y);
  })), [t]), a("div", { "aria-activedescendant": K ? e : void 0, "aria-autocomplete": K ? r : "none", "aria-controls": K ? o : void 0, "aria-describedby": n, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": K && m === "combobox" ? !!i : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": d, "aria-labelledby": l, "aria-multiline": w, "aria-owns": K ? p : void 0, "aria-readonly": !K || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: K, "data-testid": _, id: b, ref: U, role: m, spellCheck: R, style: x, tabIndex: C, ...I });
}
const Kd = Fn(Ud);
function pn(t) {
  return t.getEditorState().read(Ti(t.isComposing()));
...
function qd(t, e) {
  ...
  return u(ut, { children: [a(Kd, { editor: n, ...o, ref: e }), r != null && a(Gd, { editor: n, content: r })] });
}
function Gd({ content: t, editor: e }) {
  const r = function(i) {
    ...
    return Ri(() => {
      ...
      return l(), Oe(i.registerUpdateListener(() => {
        l();
  ...
  if (Qt(() => (n(e.isEditable()), e.registerEditableListener((i) => {
    n(i);
  })), [e]), !r) return null;
  let s = null;
...
function Wd({
  ...
  return /* @__PURE__ */ a(Di.Provider, { value: i, children: s });
}
function zi() {
  const t = ha(Di);
  if (!t)
...
function Xd() {
  const [t, e] = k(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Ua, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ka, { children: [
      /* @__PURE__ */ a(Ha, { children: /* @__PURE__ */ a(qa, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = L(
    (s, i, c = !1) => {
...
function Jd({
  ...
  const [e] = Ee(), [r, o] = k(e), [n, s] = k("paragraph"), [i, c] = Xd(), d = () => {
  };
...
function Qd() {
  const { activeEditor: t } = zi(), [e, r] = k([]), o = L((n) => {
    if (ke(n) || ml(n)) {
      const s = [];
      hn.forEach(({ format: i }) => {
  ...
  return Zd(o), /* @__PURE__ */ a(
    En,
    {
      ...
      variant: "outline",
      size: "sm",
      children: hn.map(({ format: n, icon: s, label: i }) => /* @__PURE__ */ a(
        Yr,
        {
          value: n,
          "aria-label": i,
      ...
      /* @__PURE__ */ a(
        Vd,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && n(i);
          }, children: /* @__PURE__ */ a(Yd, { placeholder: t }) }),
          ErrorBoundary: Zl
        }
      ),
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(ql, { initialConfig: l, children: /* @__PURE__ */ u(jt, { children: [
          /* @__PURE__ */ a(
            ew,
            {
              placeholder: n,
          ...
          /* @__PURE__ */ a(Yl, { ignoreSelectionChange: !0, onChange: w })
        ] }) })
      }
    )
  );
...
function Oi(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Oi(e.children)
  ) : !1;
}
function se(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Oi(t.root.children) : !1;
}
function aw(t) {
  if (!t || t.trim() === "")
...
function $i({
  ...
  const i = gn(o, "%cancelButton_tooltip%"), c = s ?? gn(o, "%acceptButton_tooltip%");
...
const ow = "verseText", Mp = Object.freeze([
...
function nw(t) {
  return t.editorState === void 0 && t.assignedUser === void 0 && !Qr(t.commentEdits);
}
const Pi = [
...
function Op({
  ...
  const [s, i] = k(sw), [c, d] = k(n), [l, w] = k(!1), p = B(void 0), h = B(null);
  Z(() => {
    let m = !0;
    const R = h.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ke, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(sr, { asChild: !0, children: /* @__PURE__ */ u(
        Q,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: ja(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        He,
        {
          ...
          children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: t.map((m) => /* @__PURE__ */ a(
            Ie,
            {
              onSelect: () => {
                d(m || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: ja(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : zo(m) && (m.preventDefault(), m.stopPropagation(), se(s) && g());
        },
        onKeyDown: (m) => {
...
function fn({
  ...
  const [w, p] = k(), h = d ?? w, f = h !== void 0 && o, b = l !== void 0, m = L(
    (O) => {
      b || p(O), l == null || l(O);
    },
    [b, l]
  ...
  const C = L(
    (O) => {
      O && O.stopPropagation(), m(void 0), i == null || i(!1);
    },
    [i, m]
  ), _ = L(
    async (O) => {
      if (O && O.stopPropagation(), !h || !n) return;
      await n(
        t.id,
        la(h)
      ) && (m(void 0), i == null || i(!1));
    ...
    const O = new Date(t.date), N = ac(
      O,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), ot = O.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), j = P(() => t.user, [t.user]), K = P(
    () => t.user.split(" ").map((O) => O[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), M = P(() => bo(t.contents), [t.contents]), S = P(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), U = !!t.conflictResolutionAction && !S, Y = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(ut, { children: [
        /* @__PURE__ */ u(
          or,
          {
            onClick: (O) => {
              O.stopPropagation(), x.current = !0;
              const N = t.contents.trim() !== "";
              m(N ? aw(t.contents) : iw), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u(
          ...
          {
            onClick: async (O) => {
              O.stopPropagation(), s && await s(t.id);
            },
            children: [
              /* @__PURE__ */ a(Lo, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(ww, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(uw, { className: "tw:text-xs tw:font-medium", children: K }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:font-medium", children: j }),
            /* @__PURE__ */ a("p", { className: "tw:text-xs tw:font-normal tw:text-muted-foreground", children: I }),
          ...
          f && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: R,
              onKeyDownCapture: (O) => {
                O.key === "Escape" ? (O.preventDefault(), O.stopPropagation(), C()) : zo(O) && (O.preventDefault(), O.stopPropagation(), se(h) && _());
              },
              onKeyDown: (O) => {
          ...
          !f && /* @__PURE__ */ u(ut, { children: [
            t.status === "Resolved" && !U && /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: r["%comment_status_resolved%"] }),
        ...
        Y && /* @__PURE__ */ u(Ye, { children: [
          /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(Q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Rs, {}) }) }),
          /* @__PURE__ */ a(Xe, { align: "end", children: Y })
        ] })
      ]
    }
  );
  ...
  if (t)
    return /* @__PURE__ */ a(
      Q,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const pw = {
  ...
  var Qe;
  const [ot, z] = k({}), J = O ?? ot, q = J.editorState ?? pw, $ = J.assignedUser, rt = N !== void 0, pt = B(J);
  pt.current = J;
  const gt = L(
    (T) => {
      const ct = { ...pt.current, ...T };
      pt.current = ct, rt || z(ct), N == null || N(l, nw(ct) ? void 0 : ct);
    },
    [rt, N, l]
  ), tt = L(
    (T, ct) => {
      const dt = { ...J.commentEdits };
      ct === void 0 ? delete dt[T] : dt[T] = ct, gt({
        commentEdits: Qr(dt) ? dt : void 0
      });
    },
    [J.commentEdits, gt]
  ), [ht, bt] = k(), yt = n, [vt, _t] = k(!1), [At, Ft] = k(!1), [ce, zt] = k(!1), [Jt, xt] = k(!1), [ee, le] = k(!1), [St, re] = k(I), [Ht, $e] = k(!1), ae = B(void 0), [Te, Se] = k(/* @__PURE__ */ new Map());
  Z(() => {
    let T = !0;
    return (async () => {
    ...
    let T = !0;
    if (!n) {
      xt(!1), Se(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const dt = x ? await x(l) : !1;
      T && xt(dt);
    })(), () => {
      T = !1;
    };
  ...
  Z(() => {
    if (!n) {
      D.current !== "idle" && (gt({ assignedUser: void 0 }), bt(void 0), D.current = "idle");
      return;
    }
    D.current === "idle" && (D.current = "pending"), Jt ? D.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (gt({ assignedUser: M }), D.current = "auto-populated") : D.current === "auto-populated" && (gt({ assignedUser: void 0 }), D.current = "pending");
  }, [n, M, Jt, i, gt]);
  const Mt = P(
    () => S ?? r.filter((T) => !T.deleted),
    [S, r]
  ), ue = P(() => {
    const { commentEdits: T } = J;
    if (!T) return T;
    const ct = new Set(Mt.map((qt) => qt.id)), dt = Object.fromEntries(
      Object.entries(T).filter(([qt]) => ct.has(qt))
    );
    return Qr(dt) ? dt : void 0;
  }, [J, Mt]), oe = At || Qr(ue);
  Z(() => {
    let T = !0;
    if (!n || !_) {
  ...
  const Ot = P(() => Mt[0], [Mt]), de = B(null), ne = B(void 0), ie = L(() => {
    var T;
    (T = ne.current) == null || T.call(ne), gt({ editorState: void 0 });
  }, [gt]), E = L(
    (T) => {
      gt({ editorState: se(T) ? T : void 0 });
    },
    [gt]
  ), F = L(() => {
    const T = !St;
    re(T), $e(!T), b == null || b(l, T);
  }, [St, b, l]);
  Z(() => {
    _t(!1);
  }, [n]), Z(() => {
    if (n && !St && !Ht) {
      ...
      return ae.current = T, () => clearTimeout(T);
    }
    ae.current && (clearTimeout(ae.current), ae.current = void 0);
  }, [n, St, Ht, j, l, b]);
  const G = P(
    () => ({
    ...
    const T = ta(i, o);
    return je(o["%comment_assigned_to%"], {
      assignedUser: T
    });
  }, [i, o]), W = P(() => Mt.slice(1), [Mt]), A = P(() => W.length ?? 0, [W.length]), nt = P(() => A > 0, [A]), st = P(() => {
    if (vt || A <= 2)
      return W;
    const T = new Set(W.slice(-2).map((ct) => ct.id));
    return W.filter(
      (ct) => {
        var dt;
        return T.has(ct.id) || ((dt = J.commentEdits) == null ? void 0 : dt[ct.id]) !== void 0;
      }
    );
  }, [W, A, vt, J.commentEdits]), lt = P(() => vt || A <= 2 ? 0 : A - st.length, [A, vt, st.length]), Nt = P(
    () => A === 1 ? G.singleReply : je(G.multipleReplies, { count: A }),
    [A, G]
  ), Rt = P(
    () => lt === 1 ? G.singleReply : je(G.multipleReplies, { count: lt }),
    [lt, G]
  );
  Z(() => {
    !n && oe && nt && Ft(!1);
  ...
  const It = L(
    async (T) => {
      ...
      ct && await h({ threadId: l, contents: ct }) && ie();
    },
    [
      ie,
      q,
    ...
    async (T) => {
      const ct = se(q) ? la(q) : void 0, dt = T.status ? T.assignedUser : $ ?? T.assignedUser, qt = await h({
        ...T,
        contents: ct,
        assignedUser: dt
      });
      return qt && (dt !== void 0 && bt(dt), ct && ie()), qt;
    },
    [ie, q, h, $]
  );
  if (Mt.length === 0) return;
  const Ze = !Jt || !m || m.length === 0 || !m.includes(c), fe = !se(q) && ($ === void 0 || $ === ht), me = /* @__PURE__ */ a(
    fn,
    {
      comment: Ot,
      localizedStrings: o,
      ...
      handleDeleteComment: f,
      onEditingChange: Ft,
      canEditOrDelete: (!oe && Te.get(Ot.id)) ?? !1,
      canUserResolveThread: ee,
      draftEditorState: (Qe = J.commentEdits) == null ? void 0 : Qe[Ot.id],
      onDraftEditorStateChange: (T) => tt(Ot.id, T)
    }
  );
  return /* @__PURE__ */ a(
    lw,
    {
      ...
      className: v(
        ...
        {
          "tw:bg-card": p !== "Resolved" && St,
          "tw:bg-muted": p === "Resolved",
          "tw:bg-accent": !St && p !== "Resolved"
        }
      ),
      onClick: () => {
        d(l);
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(dw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-2", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            H && /* @__PURE__ */ a(Or, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: H }),
            /* @__PURE__ */ a(
              Q,
              {
                variant: "ghost",
                ...
                "aria-label": St ? o["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : o["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: St ? /* @__PURE__ */ a(Ds, {}) : /* @__PURE__ */ a(zs, {})
              }
            ),
            Y === void 0 ? (
          ...
          /* @__PURE__ */ a("div", { className: "tw:flex tw:max-w-full tw:flex-wrap tw:items-baseline tw:gap-2", children: /* @__PURE__ */ u(
            "p",
            {
              ...
              className: v(
                ...
                {
                  "tw:overflow-visible tw:text-clip tw:whitespace-normal tw:break-words": yt
                },
                { "tw:whitespace-nowrap": !yt }
              ),
              children: [
                s && K ? /* @__PURE__ */ a(
                  Q,
        ...
        /* @__PURE__ */ u(ut, { children: [
          nt && !n && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          !n && se(q) && /* @__PURE__ */ a(
            ca,
            {
              ...
              onSerializedChange: E,
              placeholder: o["%comment_replyOrAssign%"]
            }
          ),
          n && /* @__PURE__ */ u(ut, { children: [
            ...
            lt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (T) => {
                  T.stopPropagation(), _t(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (T) => {
                  (T.key === "Enter" || T.key === " ") && (T.preventDefault(), T.stopPropagation(), _t(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Ir, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Rt }),
                    vt ? /* @__PURE__ */ a(Ms, {}) : /* @__PURE__ */ a(mr, {})
                  ] })
                ]
              }
            ),
            st.map((T) => {
              ...
              return /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                fn,
                {
                  ...
                  handleDeleteComment: f,
                  onEditingChange: Ft,
                  canEditOrDelete: (!oe && Te.get(T.id)) ?? !1,
                  draftEditorState: (ct = J.commentEdits) == null ? void 0 : ct[T.id],
                  onDraftEditorStateChange: (dt) => tt(T.id, dt)
                }
              ) }, T.id);
            }),
            R !== !1 && (!oe || se(q)) && /* @__PURE__ */ a(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (T) => {
                  zo(T) && (T.preventDefault(), T.stopPropagation(), (se(q) || $ !== void 0 && $ !== ht) && It());
                },
                onKeyDown: (T) => {
                  Do(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                },
                children: /* @__PURE__ */ a(
                  ca,
                  {
                    ...
                    actions: /* @__PURE__ */ u(ut, { children: [
                      $ !== void 0 && (se(q) || $ !== ht) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: je(
                      ...
                      /* @__PURE__ */ u(Ke, { open: ce, onOpenChange: zt, children: [
                        /* @__PURE__ */ u(Ct, { children: [
                          /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
                            Ar,
                            {
                              ...
                              children: /* @__PURE__ */ a(sr, { asChild: !0, children: /* @__PURE__ */ a(
                                Q,
                                {
                                  size: "icon-sm",
                                  variant: "outline",
                        ...
                        /* @__PURE__ */ a(
                          He,
                          {
                            ...
                            align: "end",
                            onKeyDown: (T) => {
                              T.key === "Escape" && (T.stopPropagation(), zt(!1));
                            },
                            children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(Ge, { children: m == null ? void 0 : m.map((T) => /* @__PURE__ */ a(
                              Ie,
                              {
                                onSelect: () => {
                                  gt({
                                    assignedUser: T !== i ? T : void 0
                                  }), D.current = "user-selected", bt(void 0), zt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: ta(T, o) })
                              },
                              T || "unassigned"
                            )) }) })
                          }
...
), gw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ea = (t) => gw(bo(t));
function ra({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function fw({
  ...
  const [i, c] = k("accept"), d = Ko(), l = Ko(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, b = P(
    () => ea(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = P(
    () => ea(t.acceptedText ?? ""),
    ...
    () => ea(t.mergedText ?? ""),
    [t.mergedText]
  ), x = P(() => bo(t.contents), [t.contents]);
  if (!Ai(t))
    return /* @__PURE__ */ a(ra, { html: x });
  const C = (z) => {
    c(z === "reject" || z === "merge" ? z : "accept");
  }, _ = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", I = g ? [
    {
      value: "merge",
  ...
  let S;
  K ? S = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : s || (S = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const U = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: U }), X = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : Y, O = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(ra, { html: R }) : Y : X(z === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (z) => p && z.value === "reject", ot = (z) => {
    const J = f === z.value, q = `${l}-${z.value}`, $ = N(z);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: d, className: "tw:sr-only", children: _ }),
            /* @__PURE__ */ a(ra, { html: z.html })
          ]
        },
        z.value
      )
      ...
      !w && !h && /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a(
          wo,
          {
            ...
            children: j.map((z) => N(z) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ct, { children: [
              /* @__PURE__ */ a(Et, { asChild: !0, children: ot(z) }),
              /* @__PURE__ */ a(Tt, { children: _ })
            ] }) }, z.value) : ot(z))
          }
        ),
    ...
    if (e === "Resolved") {
      for (let x = o.length - 1; x >= 0; x -= 1)
        if (o[x].status === "Resolved")
          return Vi(o[x].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? l;
  return { conflictOptions: s, isResolving: c, resolve: f, resolvedResolution: m, showResolveCheck: s !== "loading" && s !== "none" };
}
const yw = Un(function(e) {
  const {
    comments: r,
    localizedStrings: o,
    isSelected: n = !1,
  ...
  } = e, d = P(() => r.filter((x) => !x.deleted), [r]), l = P(
    () => d.find((x) => x.conflictType) ?? d[0],
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: g, showResolveCheck: f } = xw({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
...
function Fp({
  ...
  const [_, I] = k(/* @__PURE__ */ new Set()), [j, K] = k(), [M, S] = k(), U = L(
    async ($) => {
      const rt = await s($);
      return rt !== void 0 && $.assignedUser !== void 0 && $.assignedUser !== "" && S($.assignedUser), rt;
    },
    [s]
  );
  Z(() => {
    f && (I(($) => new Set($).add(f)), K(f));
  }, [f]);
  const Y = r.filter(
    ($) => $.comments.some((rt) => !rt.deleted)
  ), X = Y.map(($) => ({ id: $.id })), O = L(
    ($) => {
      I((rt) => new Set(rt).add($.id)), K($.id), b == null || b($.id);
    },
    [b]
  ), N = L(
    ($) => {
      ...
      I((pt) => {
        const gt = new Set(pt);
        return gt.has($) ? gt.delete($) : gt.add($), gt;
      }), K($), b == null || b(rt ? void 0 : $);
    },
    [_, b]
  ), { listboxRef: ot, activeId: z, handleKeyDown: J } = ns({
    options: X,
    onOptionSelect: O
  }), q = L(
    ($) => {
      $.key === "Escape" ? (j && _.has(j) && (I((rt) => {
        const pt = new Set(rt);
        return pt.delete(j), pt;
      }), K(void 0), b == null || b(void 0)), $.preventDefault(), $.stopPropagation()) : J($);
    },
    [j, _, J, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: Y.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(yw, { ...rt, conflictResolution: R }) : /* @__PURE__ */ a(ji, { ...rt })
          },
          $.id
        );
      })
...
function kw({ table: t }) {
  return /* @__PURE__ */ u(Ye, { children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(Q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function pe({
  ...
  return /* @__PURE__ */ u(
    Xt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Xt.ItemIndicator, { children: /* @__PURE__ */ a(fa, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        br,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(kr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(pe, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Tw({
  ...
  var j;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, R] = k({}), x = P(() => e ?? [], [e]), C = oi({
    data: x,
    columns: t,
    getCoreRowModel: ii(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((S, U) => `skeleton-row-${U}`).map((S) => /* @__PURE__ */ a(Le, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(hr, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(pr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((j = C.getRowModel().rows) == null ? void 0 : j.length) > 0 ? I = C.getRowModel().rows.map((K) => /* @__PURE__ */ a(
    Le,
    {
      onClick: () => i(K, C),
      "data-state": K.getIsSelected() && "selected",
      children: K.getVisibleCells().map((M) => /* @__PURE__ */ a(hr, { children: Dr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    K.id
  )) : I = /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(hr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(kw, { table: C }),
    /* @__PURE__ */ u(ho, { stickyHeader: s, children: [
      /* @__PURE__ */ a(go, { stickyHeader: s, children: C.getHeaderGroups().map((K) => /* @__PURE__ */ a(Le, { children: K.headers.map((M) => /* @__PURE__ */ a(oa, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : Dr(M.column.columnDef.header, M.getContext()) }, M.id)) }, K.id)) }),
      /* @__PURE__ */ a(fo, { children: I })
    ] }),
...
function Hp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(Nl, { options: s, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(Q, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(An, {}) })
        ] }),
...
function Gp({
  ...
  return /* @__PURE__ */ u(Ke, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(sr, { asChild: !0, children: o }),
    /* @__PURE__ */ u(He, { id: s, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Yp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ye, { children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(Q, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Xe, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Vr, { children: l.label }),
      /* @__PURE__ */ a(Sn, { children: l.itemType === 0 ? /* @__PURE__ */ a(ut, { children: l.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Be,
        {
          checked: o[w][h],
        ...
        is,
        {
          ...
          children: l.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(ss, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(ir, {})
    ] }, l.label)) })
...
function Xp({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(zw, { versionHistory: n }),
      ...
      return /* @__PURE__ */ u(Or, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          Q,
          {
            ...
            children: /* @__PURE__ */ a(In, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function Ow({
  ...
  const d = po(), l = vn(n, "%undoButton_tooltip%"), w = vn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(uo, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        Q,
      ...
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(ut, { children: [
          " ",
          /* @__PURE__ */ a(Ga, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(Tn, {}),
    e && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      ...
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(ut, { children: [
          " ",
          /* @__PURE__ */ a(Ga, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Iw({
  ...
  return Z(() => {
    var d;
    const s = po(), i = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      var p, h, g, f;
...
const $w = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ut, { children: [
...
function Pw({
  ...
  const n = B(null), s = B(null), i = B(!1), [c, d] = k(t), [l, w] = k(e), [p, h] = k(!1), g = B(!1), f = B(c);
  f.current = c;
  const b = B(l);
  b.current = l, Z(() => {
    d(t);
  ...
  const m = (x) => {
    if (i.current = !1, h(x), !x) {
      const C = f.current, _ = b.current;
      C !== "custom" || _ ? (C !== t || _ !== e) && r(C, _) : (d(t), w(e));
    }
  }, R = (x) => {
    var C, _, I, j;
    x.stopPropagation(), document.activeElement === s.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), i.current = !0) : document.activeElement === n.current && x.key === "ArrowUp" ? ((_ = s.current) == null || _.focus(), i.current = !1) : document.activeElement === n.current && x.key === "ArrowLeft" && ((I = n.current) == null ? void 0 : I.selectionStart) === 0 && ((j = s.current) == null || j.focus(), i.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && m(!1);
  };
  return /* @__PURE__ */ u(Ye, { open: p, onOpenChange: m, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(Q, { variant: "outline", className: "tw:h-6", children: $w(t, o, e) }) }) }),
          ...
          /* @__PURE__ */ a(
            Be,
            {
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a("span", { className: "tw:w-10 tw:text-center", children: to })
              ] })
            }
          ),
          /* @__PURE__ */ a(
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a(
                  pa,
                  {
                    tabIndex: 0,
                    onMouseDown: (x) => {
                      x.stopPropagation(), d("custom"), i.current = !0;
                    },
                    ref: n,
...
const Aw = (t, e) => t === "f" ? /* @__PURE__ */ u(ut, { children: [
  /* @__PURE__ */ a(Ln, {}),
  " ",
...
function Lw({
  ...
  return /* @__PURE__ */ u(Ye, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(Q, { variant: "outline", className: "tw:h-6", children: Aw(t, r) }) }) }),
      /* @__PURE__ */ a(Tt, { children: /* @__PURE__ */ a("p", { children: Vw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Xe, { style: { zIndex: Rn }, children: [
...
function Fw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(Fe, { size: 16 })
    }
  );
}
function bn({
...
function Uw({
  ...
  return /* @__PURE__ */ u(qe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      wa,
      {
    ...
    /* @__PURE__ */ u(Ge, { children: [
      ...
      /* @__PURE__ */ a(Me, { children: i.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          bn,
          {
...
function Zp({
  ...
  var ie;
  const h = B(null), g = B(null), f = B(null), b = B(null);
  Qt(() => {
    if (!b.current) return;
    const { width: E } = b.current.getBoundingClientRect();
    E > 0 && (b.current.style.width = `${E}px`);
  }, []);
  const [m, R] = k("generated"), [x, C] = k("generated"), [_, I] = k("*"), [j, K] = k("*"), [M, S] = k("f"), [U, Y] = k(!1), [X, O] = k(!0), [N, ot] = k(!1), z = B(!1), J = B(""), [q, $] = k(!1), [rt, pt] = k(), [gt, tt] = k(), [ht, bt] = k(), [yt, vt] = k(), _t = B(null), At = B(
    void 0
  ), Ft = B(0), ce = B(void 0), zt = P(
    () => ({
      ...i,
  ...
  Z(() => {
    var E;
    q || (E = h.current) == null || E.focus();
  }, [M, q]);
  const xt = L(() => {
    var H, W, A;
    const E = (H = g.current) == null ? void 0 : H.querySelector(".editor-input"), F = E == null ? void 0 : E.querySelector("span.note"), G = (A = (W = g.current) == null ? void 0 : W.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
    return !!F && !!G && F.contains(G);
  }, []);
  Z(() => {
    var W, A;
    let E, F, G;
    z.current = !1, ce.current = void 0, O(!0);
    const H = e == null ? void 0 : e.at(0);
    if (H && Er("note", H)) {
      const nt = (W = H.insert.note) == null ? void 0 : W.caller;
      let st = "custom";
      nt === to ? st = "generated" : nt === eo ? st = "hidden" : nt && (I(nt), K(nt)), R(st), C(st), S(((A = H.insert.note) == null ? void 0 : A.style) ?? "f"), E = setTimeout(() => {
        var lt, Nt, Rt;
        (lt = h.current) == null || lt.applyUpdate([H]), (Nt = h.current) == null || Nt.selectNote(0), (Rt = h.current) == null || Rt.focus(), F = requestAnimationFrame(() => {
          G = setTimeout(() => {
            var It, Ut;
            xt() || ((It = h.current) == null || It.selectNote(0), (Ut = h.current) == null || Ut.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      E && clearTimeout(E), F !== void 0 && cancelAnimationFrame(F), G !== void 0 && clearTimeout(G);
    };
  }, [e, s, xt]);
  const ee = L(
    (E = !1) => {
      var G, H, W;
      p == null || p();
      const F = (H = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : H.at(0);
      F && Er("note", F) && (r == null || r([F]), E && l && s && ((W = l.current) == null || W.replaceEmbedUpdate(s, [F])));
    },
    [s, r, p, l]
  ), le = L(
    (E, F) => {
      var W, A, nt;
      const G = (A = (W = h.current) == null ? void 0 : W.getNoteOps(0)) == null ? void 0 : A.at(0);
      if (!G || !Er("note", G) || !G.insert.note) return;
      let H;
      E === "custom" ? H = F : E === "generated" ? H = to : H = eo, G.insert.note.caller !== H && (G.insert.note.caller = H, (nt = h.current) == null || nt.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), St = L(() => {
    var E;
    At.current || (E = h.current) == null || E.commitPendingMarkerEdits(), ee(!0), o();
  }, [o, ee]), re = B(St);
  Qt(() => {
    re.current = St;
  });
  const Ht = B({ book: n.book, chapterNum: n.chapterNum });
  Qt(() => {
    (Ht.current.book !== n.book || Ht.current.chapterNum !== n.chapterNum) && (Ht.current = { book: n.book, chapterNum: n.chapterNum }, re.current());
  }, [n.book, n.chapterNum]);
  const $e = () => {
    var F;
    const E = (F = g.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    E != null && E.textContent && navigator.clipboard.writeText(E.textContent);
  }, ae = L(
    (E, F) => {
      p == null || p(), R(E), I(F), le(E, F);
    },
    [le, p]
  ), Te = (E) => {
    var G, H, W, A, nt;
    ...
    const F = (H = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : H.at(0);
    if (F && Er("note", F)) {
      F.insert.note && (F.insert.note.style = E);
      const st = (A = (W = F.insert.note) == null ? void 0 : W.contents) == null ? void 0 : A.ops;
      M !== "x" && E === "x" ? st == null || st.forEach((lt) => qw(lt)) : M === "x" && E !== "x" && (st == null || st.forEach((lt) => Gw(lt))), (nt = h.current) == null || nt.applyUpdate([F, { delete: 1 }]);
    }
  }, Se = (E) => {
    vt(E.contextMarker), ot(E.canRedo);
  }, D = L(
    (E) => {
      var G, H, W, A, nt;
      const F = (H = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (F && Er("note", F)) {
        ...
        const st = (W = F.insert.note) == null ? void 0 : W.style, lt = (nt = (A = F.insert.note) == null ? void 0 : A.contents) == null ? void 0 : nt.ops;
        if (st || Y(!1), Y(
          st === "x" ? !!(lt != null && lt.every((Nt) => {
            var It, Ut;
            if (!((It = Nt.attributes) != null && It.char)) return !0;
            const Rt = ((Ut = Nt.attributes) == null ? void 0 : Ut.char).style;
          ...
          z.current = !0, J.current = JSON.stringify(F), O(!0);
          return;
        }
        O(JSON.stringify(F) === J.current), ee();
      } else
        Y(!1), O(!0);
    },
    [ee]
    ...
    if (f.current && Jt.length && E && E.rangeCount > 0) {
      const F = E.getRangeAt(0).getBoundingClientRect(), G = f.current.getBoundingClientRect();
      pt(F.left - G.left), tt(F.top - G.top), bt(F.height), $(!0);
    }
  }, [Jt, f]), ue = B(() => {
  }), oe = L(
    (E, F, G) => {
      ...
      ws({
        ...
        sessionCounterRef: Ft,
        setSession: (A) => {
          At.current = A;
        },
        clearSessionIfCurrent: (A) => Io(At, A),
        ...
        restoreSelectionIfLost: () => {
          var A, nt, st;
          if (!((A = h.current) != null && A.getSelection())) {
            const lt = ce.current;
            lt ? (nt = h.current) == null || nt.setSelection(lt) : (st = h.current) == null || st.selectNote(0);
          }
        },
        focusEditor: () => {
          var A;
          return (A = h.current) == null ? void 0 : A.focus();
        },
        applyItem: (A) => {
          var nt;
          return (nt = h.current) == null ? void 0 : nt.applyMarkerMenuSelection(A, {
            trigger: "backslash",
        ...
        onShowError: (A) => {
          (!ic(A) || A.code !== sc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${cc(A)}`
          );
        }
      });
    },
    ...
    var G;
    const E = (G = h.current) == null ? void 0 : G.getMarkerMenuContext();
    if (!E) return !1;
    const F = El(zt.styleInfo ?? Tl, E);
    return F.length === 0 ? !1 : (oe(E, F, { passive: !E.hasTextSelection }), !0);
  }, [oe, zt.styleInfo]), de = L(
    (E) => {
      const F = At.current;
      if (!F || !w) return;
      us(E, F, {
        ...
        commitTypedAndReopen: (H) => {
          var W;
          (W = h.current) == null || W.commitTypedMarker(H, { trailingSpace: !1 }), Ot();
        },
        commitTypedCloser: (H) => {
          var W;
        ...
        commitItem: (H) => {
          var A;
          const W = F.items.find((nt) => nt.marker === H);
          W && ((A = h.current) == null || A.applyMarkerMenuSelection(W, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Z(() => {
    ...
    const E = (F) => {
      var W, A;
      const G = (W = g.current) == null ? void 0 : W.querySelector(".editor-input");
      if (!G || F.target !== G) return;
      const H = (A = h.current) == null ? void 0 : A.getSelection();
      H && (ce.current = H);
    };
    ...
    if (((G = zt.view) == null ? void 0 : G.markerMode) === "editable") {
      const H = (A) => {
        var lt, Nt, Rt, It;
        if (hs(A)) return;
        const nt = E();
        ...
        if (A.key === "Enter" && !xt()) {
          A.preventDefault(), A.stopPropagation(), (lt = h.current) == null || lt.selectNote(0), (Nt = h.current) == null || Nt.focus();
          return;
        }
        if (w && A.key === c) {
          if (!xt()) {
            A.preventDefault(), A.stopPropagation(), (Rt = h.current) == null || Rt.selectNote(0), (It = h.current) == null || It.focus();
            return;
          }
          Ot() && (A.preventDefault(), A.stopPropagation());
        }
      }, W = () => {
        var nt, st;
        const A = E();
        !A || document.activeElement !== A || xt() || ((nt = h.current) == null || nt.selectNote(0), (st = h.current) == null || st.focus());
      };
    ...
    const F = (H) => {
      const W = E();
      !q && W && document.activeElement === W && H.key === c ? (H.preventDefault(), Mt()) : q && H.key === "Escape" && (H.preventDefault(), $(!1));
    };
    ...
    Mt,
    c,
    (ie = zt.view) == null ? void 0 : ie.markerMode,
    zt.styleInfo,
    w,
    Ot,
    xt
    ...
    const E = () => {
      var H, W, A;
      const F = ((H = g.current) == null ? void 0 : H.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const G = document.getSelection();
      G && !G.isCollapsed || xt() || ((W = h.current) == null || W.selectNote(0), (A = h.current) == null || A.focus());
    };
  ...
  const ne = d["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(ut, { children: [
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Xa, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
...
function Jw({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Mo(t.marker, [i], o, !1),
    " "
  ] }), g = !!d, f = !!w, b = !!p, m = e === "horizontal" ? "horizontal" : "vertical", R = o ? "marker-visible" : "", x = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = v(m, R);
  return /* @__PURE__ */ u(ut, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ut, { children: Ww(t.marker, c, o, l) })
      }
    )
  ] });
}
function th({
  ...
  const p = l ?? lc(r, void 0), h = (_, I) => {
    w == null || w(_, I, n);
  }, g = s ? r.findIndex((_) => _ === s) : -1, [f, b] = k(g), m = (_, I, j) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), w == null || w(I, j, n);
          break;
      }
  }, R = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), b((I) => Math.min(I + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), b((I) => Math.max(I - 1, 0));
          break;
      }
  }, x = B([]);
  Z(() => {
    var _;
    f >= 0 && f < x.current.length && ((_ = x.current[f]) == null || _.focus());
  }, [f]);
  const C = s ? r.findIndex((_) => _ === s) : -1;
  return Z(() => {
    var _;
    C < 0 || C >= x.current.length || (_ = x.current[C]) == null || _.scrollIntoView({ block: "nearest" });
  }, [C, i]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Jw,
                      {
                        footnote: _,
                        layout: o,
                        formatCaller: () => p(_.caller, I),
                        showMarkers: c
                      }
                    )
                  }
                ),
                I < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Ir, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, K)
            );
          })
        }
...
function Qw({
  ...
  return /* @__PURE__ */ u(ho, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(go, { stickyHeader: !0, children: /* @__PURE__ */ u(Le, { children: [
      /* @__PURE__ */ a(oa, { children: n }),
      /* @__PURE__ */ a(oa, { children: s })
    ] }) }),
    /* @__PURE__ */ a(fo, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Le,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(hr, { children: De(c.reference, "English") }),
          /* @__PURE__ */ a(hr, { className: o, children: Zw(c.text) })
        ]
      },
...
const tu = (t) => {
...
}, ba = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ u(
    Et,
    {
  ...
  cell: ({ row: s }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(En, { value: i, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Yr,
          {
            onClick: (d) => {
  ...
  return e ? e[1] : "";
}, ru = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", sh = Object.freeze([
...
function ch({
  ...
  const g = be(r, "%webView_inventory_all%"), f = be(r, "%webView_inventory_approved%"), b = be(r, "%webView_inventory_unapproved%"), m = be(r, "%webView_inventory_unknown%"), R = be(r, "%webView_inventory_scope_currentBook%"), x = be(r, "%webView_inventory_scope_chapter%"), C = be(r, "%webView_inventory_scope_verse%"), _ = be(r, "%webView_inventory_filter_text%"), I = be(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = be(r, "%webView_inventory_no_results%"), [K, M] = k(!1), [S, U] = k("all"), [Y, X] = k(""), [O, N] = k([]), ot = P(() => {
    const tt = t ?? [];
    return tt.length === 0 ? [] : ou(tt, n, s);
  }, [t, n, s]), z = P(() => {
    if (K) return ot;
    const tt = [];
    return ot.forEach((ht) => {
      const bt = ht.items[0], yt = tt.find(
        (vt) => vt.items[0] === bt
      );
      yt ? (yt.count += ht.count, yt.occurrences = yt.occurrences.concat(ht.occurrences)) : tt.push({
        items: [bt],
        count: ht.count,
  ...
  }, [K, ot]), J = P(() => z.length === 0 ? [] : au(z, S, Y), [z, S, Y]), q = P(() => {
    var bt, yt;
    if (!K) return d;
    const tt = (bt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : bt.length;
    if (!tt) return d;
    const ht = [];
  ...
  Z(() => {
    J.length === 0 ? N([]) : J.length === 1 && N(J[0].items);
  }, [J]);
  const $ = (tt, ht) => {
    ht.setRowSelection(() => {
      const yt = {};
      return yt[tt.index] = !0, yt;
    });
    const bt = tt.original.items;
    N(bt), h && bt.length > 0 && h(bt[0]);
  }, rt = (tt) => {
    ...
    if (z.length === 0 || O.length === 0) return [];
    const tt = z.filter((ht) => dc(
      K ? ht.items : [ht.items[0]],
      O
    ));
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        br,
        {
          onValueChange: (tt) => pt(tt),
          defaultValue: S,
          children: [
            /* @__PURE__ */ a(yr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(xr, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(kr, { children: [
              /* @__PURE__ */ a(pe, { value: "all", children: g }),
              /* @__PURE__ */ a(pe, { value: "approved", children: f }),
              /* @__PURE__ */ a(pe, { value: "unapproved", children: b }),
              /* @__PURE__ */ a(pe, { value: "unknown", children: m })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(br, { onValueChange: (tt) => rt(tt), defaultValue: i, children: [
        ...
        /* @__PURE__ */ u(kr, { children: [
          ...
          /* @__PURE__ */ a(pe, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ct, { children: [
        /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Pt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? I })
        ] }) }),
...
const nu = "16rem", iu = "3rem", Fi = Wt.createContext(void 0);
function xa() {
  const t = Wt.useContext(Fi);
  if (!t)
...
function su({
  ...
  const [d, l] = Wt.useState(t), w = e ?? d, p = Wt.useCallback(
    (C) => {
      const _ = typeof C == "function" ? C(w) : C;
      r ? r(_) : l(_);
    },
    [r, w]
  ), h = Wt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", m = Ne() === "ltr" ? i : i === "primary" ? "secondary" : "primary", R = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function hu({
  ...
  const c = t ? Fr.Root : "button", { state: d } = xa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(pu({ variant: r, size: o }), s),
      ...i
    }
  );
  return n ? /* @__PURE__ */ u(Ct, { children: [
    /* @__PURE__ */ a(Et, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Tt,
      {
        side: "right",
...
function gu({
  ...
  return /* @__PURE__ */ a(
    cu,
    {
      ...
      children: /* @__PURE__ */ u(du, { children: [
        /* @__PURE__ */ u(xn, { children: [
          /* @__PURE__ */ a(yn, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(kn, { children: /* @__PURE__ */ a(wu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(uu, { children: /* @__PURE__ */ a(
            hu,
            {
              onClick: () => l(g),
              isActive: h(g),
...
const Ve = "scrBook", fu = "scrRef", ar = "source", mu = "details", vu = "Scripture Reference", bu = "Scripture Book", Ui = "Type", xu = "Details";
function yu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ve ? De(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: mu,
      header: (t == null ? void 0 : t.detailsColumnName) ?? xu,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const ku = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ja(t.start, t.end) === 0 ? `${Ra(t.start)}+${e}` : `${Ra(t.start)}+${e}-${Ra(t.end)}+${r}`;
}, _n = (t) => `${ku({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function _h({
  sources: t,
  ...
  const [l, w] = k([]), [p, h] = k([{ id: Ve, desc: !1 }]), [g, f] = k({}), b = P(
    () => t.flatMap((S) => S.data.map((U) => ({
      ...U,
      source: S.source
    }))),
    [t]
  ...
  Z(() => {
    if (c) {
      const S = R.getSelectedRowModel().rowsById, U = Object.keys(S);
      if (U.length === 1) {
        const Y = b.find((X) => _n(X) === U[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, R]);
  const x = n ?? bu, C = s ?? Ui, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Ve] },
    { label: `Group by ${C}`, value: [ar] },
    {
    ...
    !S.getIsGrouped() && !S.getIsSelected() && S.getToggleSelectedHandler()(U);
  }, K = (S, U) => S.getIsGrouped() ? "" : v("banded-row", U % 2 === 0 ? "even" : "odd"), M = (S, U, Y) => {
    if (!((S == null ? void 0 : S.length) === 0 || U.depth < Y.column.getGroupedIndex())) {
      if (U.getIsGrouped())
        switch (U.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      br,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(kr, { position: "item-aligned", children: /* @__PURE__ */ a(_w, { children: _.map((S) => /* @__PURE__ */ a(pe, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ho, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(go, { children: R.getHeaderGroups().map((S) => /* @__PURE__ */ a(Le, { children: S.headers.filter((U) => U.column.columnDef.header).map((U) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(oa, { colSpan: U.colSpan, className: "tw:sticky top-0", children: U.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Dr(U.column.columnDef.header, U.getContext())
        ] }) }, U.id)
      )) }, S.id)) }),
      /* @__PURE__ */ a(fo, { children: R.getRowModel().rows.map((S, U) => {
        const Y = Ne();
        return /* @__PURE__ */ a(
          Le,
          {
            ...
            className: v(K(S, U)),
            onClick: (X) => j(S, X),
            children: S.getVisibleCells().map((X) => {
              if (!(X.getIsPlaceholder() || X.column.columnDef.enableGrouping && !X.getIsGrouped() && (X.column.columnDef.id !== ar || !r)))
                return /* @__PURE__ */ a(
                  hr,
                  {
                    className: v(
                    ...
                    children: X.getIsGrouped() ? /* @__PURE__ */ u(
                      Q,
                      {
                        ...
                        type: "button",
                        children: [
                          S.getIsExpanded() && /* @__PURE__ */ a(mr, {}),
                          !S.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Wa, {}) : /* @__PURE__ */ a(Ya, {})),
                          " ",
                          Dr(X.column.columnDef.cell, X.getContext()),
                          " (",
                          S.subRows.length,
                          ")"
                        ]
...
function _u({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [m, R] = k(!1), [x, C] = k(""), _ = B(void 0), I = B(!1), j = P(
    () => Mn(t),
    [t]
  ), K = P(() => {
    if (!x.trim()) {
    ...
    (N, ot = !1) => {
      if (!ot || !_.current) {
        r(
          e.includes(N) ? e.filter((pt) => pt !== N) : [...e, N]
        ), _.current = N;
        return;
      }
      const z = j.findIndex((pt) => pt === _.current), J = j.findIndex((pt) => pt === N);
      if (z === -1 || J === -1) return;
      const [q, $] = [
        Math.min(z, J),
        Math.max(z, J)
      ], rt = j.slice(q, $ + 1).map((pt) => pt);
      r(
        e.includes(N) ? e.filter((pt) => !rt.includes(pt)) : [.../* @__PURE__ */ new Set([...e, ...rt])]
      );
    },
    [e, r, j]
  ), S = (N) => {
    M(N, I.current), I.current = !1;
  }, U = (N, ot) => {
    N.preventDefault(), M(ot, N.shiftKey);
  }, Y = () => {
    r(j.map((N) => N));
  }, X = () => {
    r([]);
    ...
    () => Object.values($t).filter(
      (N) => (s == null ? void 0 : s[N]) !== void 0 && mo(j, N).length === 0
          ...
          He,
          {
            ...
            children: /* @__PURE__ */ u(
              qe,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (N) => {
                  N.key === "Enter" && (I.current = N.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    wa,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(Q, { variant: "ghost", size: "sm", onClick: X, children: w })
                  ] }),
                  /* @__PURE__ */ u(Ge, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(ua, { children: p }),
                    Object.values($t).filter((N) => K[N].length > 0).map((N, ot) => {
                      const z = K[N];
                      return /* @__PURE__ */ u(ga, { children: [
                        ot > 0 && /* @__PURE__ */ a(Dn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Me,
                          {
                            heading: Cn(N, h, g, f, b),
                            children: z.map((J) => /* @__PURE__ */ a(
                              ci,
                              {
                                bookId: J,
                  ...
                  O.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: O.map(({ section: N, explanation: ot }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: ot }, N)) })
                ]
              }
            )
          }
...
function Eu({
  ...
  const i = o["%webView_book_selector_more%"], c = P(
    ...
    (l) => {
      ...
      r(
        On(c, l, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values($t).map((l) => /* @__PURE__ */ a(
      Cu,
      {
        section: l,
        availableBookIds: c,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Fa ? Fa : Nn
      ).map((l) => /* @__PURE__ */ a(Or, { className: "tw:hover:bg-secondary", variant: "secondary", children: xe(l, n) }, l)),
...
function Ch({
  ...
  const I = Vt(
    i,
    "%webView_scope_selector_selected_text%"
  ), j = Vt(i, "%webView_scope_selector_verse%"), K = Vt(i, "%webView_scope_selector_chapter%"), M = Vt(i, "%webView_scope_selector_book%"), S = Vt(
    i,
    "%webView_scope_selector_current_verse%"
  ), U = Vt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), Y = Vt(i, "%webView_scope_selector_current_book%"), X = Vt(i, "%webView_scope_selector_choose_books%"), O = Vt(i, "%webView_scope_selector_scope%"), N = Vt(i, "%webView_scope_selector_select_books%"), ot = Vt(i, "%webView_scope_selector_range%"), z = Vt(i, "%webView_scope_selector_select_range%"), J = Vt(i, "%webView_scope_selector_range_start%"), q = Vt(i, "%webView_scope_selector_range_end%"), $ = Vt(i, "%webView_scope_selector_ok%"), rt = Vt(i, "%webView_scope_selector_cancel%"), pt = Vt(i, "%webView_scope_selector_navigate%"), gt = (V) => {
    if (!b) return;
    const et = b.book.toUpperCase();
    switch (V) {
      case "verse":
        return De(b, "id");
      case "chapter":
        return `${et} ${b.chapterNum}`;
      case "book":
        return et;
      default:
        return;
    ...
    { value: "range", label: ot, id: "scope-range" }
  ], ht = (V, et, ft = !1) => /* @__PURE__ */ u(ut, { children: [
    V,
    et && !ft && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      et
    ] })
  ] }), bt = e ? tt.filter((V) => e.includes(V.value)) : tt, yt = b ?? Da, vt = p ?? yt, _t = h ?? yt, At = () => {
  }, Ft = B(null), ce = B(null), zt = B(!1), Jt = B(null), xt = B(!1), [ee, le] = k(void 0), St = B(!1), re = B(!1), Ht = B(null), $e = L((V) => {
    if (V) {
      le("start"), St.current = !1;
      return;
    }
    le((et) => et === "start" ? void 0 : et), St.current && (St.current = !1, requestAnimationFrame(() => {
      var ft;
      const et = (ft = Ft.current) == null ? void 0 : ft.querySelector("button");
      et == null || et.click();
    }));
  }, []), ae = L((V) => {
    if (V) {
    ...
    le((et) => et === "end" ? void 0 : et);
  }, []), Te = L(
    (V) => {
      g == null || g(V), f == null || f(V), St.current = !0;
    },
    [g, f]
  ), Se = L(
    (V) => {
      f == null || f(V), re.current = !0;
    },
    [f]
  ), D = L(
    (V) => {
      r(V), V === "selectedBooks" && n.length === 0 && (b != null && b.book) && s([b.book]);
    },
    [r, n, b, s]
  ), Mt = bt.find((V) => V.value === t), ue = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? wc(vt, _t, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Mt ? ht(Mt.label, Mt.scrRefSuffix) : t, oe = bt.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), Ot = bt.find((V) => V.value === "selectedBooks"), de = bt.find((V) => V.value === "range"), [ne, ie] = k(!1), [E, F] = k(void 0), [G, H] = k(void 0), [W, A] = k(void 0), [nt, st] = k(void 0), [lt, Nt] = k([]), Rt = w === "dropdown" && E === "selectedBooks", It = /* @__PURE__ */ a(
    Eu,
    {
      availableBookInfo: o,
      selectedBookIds: Rt ? lt : n,
      onChangeSelectedBookIds: Rt ? Nt : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: d
    }
  ), Ut = ee === "end", Ze = ee === "start", fe = "tw:text-muted-foreground", me = w === "dropdown" && E === "range", Qe = me ? A : Te, ct = me ? st : f ? Se : At, dt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-start", className: v(Ut && fe), children: J }),
      /* @__PURE__ */ a(
        Ma,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ft, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-end", className: v(Ze && fe), children: q }),
      /* @__PURE__ */ a(
        Ma,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: x,
          disableReferencesUpTo: me ? W ?? vt : vt,
          onOpenChange: ae,
          onCloseAutoFocus: (V) => {
            var et;
            re.current && (re.current = !1, V.preventDefault(), (et = Ht.current) == null || et.focus());
          },
          className: v(Ze && fe),
          modal: !0,
          align: "start"
  ...
  Z(() => {
    ...
    const et = requestAnimationFrame(() => {
      V = requestAnimationFrame(() => {
        var ft;
        (ft = qt.current[t]) == null || ft.focus();
      });
    });
    return () => {
      cancelAnimationFrame(et), V && cancelAnimationFrame(V);
    };
  }, [ne, t]);
  const [tr, ya] = k(null), [er, ka] = k(null), [dr, _a] = k(null), Na = 200, [Ca, Ea] = k(!1);
  Z(() => {
    if (!dr || typeof ResizeObserver > "u") return;
    const V = new ResizeObserver(([et]) => {
      Ea(et.contentRect.width < Na);
    });
    return V.observe(dr), () => V.disconnect();
  }, [dr]);
  const y = L(
    (V) => {
      H(V), A(vt), st(_t), Nt(n), ie(!1), F(V);
    },
    [vt, _t, n]
  ), at = L(() => {
    G !== void 0 && (G === "range" ? (W && (g == null || g(W)), nt && (f == null || f(nt))) : G === "selectedBooks" && s(lt), D(G), F(void 0), H(void 0));
  }, [
    G,
    W,
    nt,
    ...
    var et;
    V.preventDefault(), (et = Nr.current) == null || et.focus();
  }, []), Re = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Pt, { children: O }),
      w === "dropdown" ? /* @__PURE__ */ u(Ye, { open: ne, onOpenChange: ie, children: [
        ...
        /* @__PURE__ */ a(
          Xe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ta, { container: dr, children: [
              oe.map(({ value: V, label: et, dropdownLabel: ft, scrRefSuffix: kt, id: Kt }) => /* @__PURE__ */ u(
                or,
                {
                  ref: Pe(V),
                  ...
                  children: [
                    t === V && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }),
                    ht(ft ?? et, kt, Ca)
                  ]
                },
                Kt
              ...
              m && /* @__PURE__ */ u(ut, { children: [
                /* @__PURE__ */ a(ir, {}),
                /* @__PURE__ */ a(Vr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  or,
                  {
                    ref: Jt,
                    ...
                    onSelect: (V) => {
                      ...
                      xt.current || (ft = (et = ce.current) == null ? void 0 : et.querySelector("button")) == null || ft.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          const et = V.target instanceof HTMLElement ? V.target : void 0;
                          et != null && et.closest("button") && (zt.current = !0, requestAnimationFrame(() => {
                            zt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ma,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var et;
                              V.preventDefault(), (et = Jt.current) == null || et.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ut, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: De(b ?? Da, "id") }),
                              /* @__PURE__ */ a(mr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        wo,
        {
          ...
          children: bt.map(({ value: V, label: et, scrRefSuffix: ft, id: kt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(aa, { className: "tw:me-2", value: V, id: kt }),
            /* @__PURE__ */ a(Pt, { htmlFor: kt, children: ht(et, ft) })
          ] }, kt))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { children: N }),
      It
    ] }),
    w === "radio" && t === "range" && dt,
    w === "dropdown" && Ot && /* @__PURE__ */ a(Ua, { open: E === "selectedBooks", onOpenChange: it, children: /* @__PURE__ */ a(
      Ka,
      {
        ref: ka,
        onCloseAutoFocus: Zt,
        onEscapeKeyDown: (V) => {
          er != null && er.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(Ta, { container: er, children: [
          /* @__PURE__ */ a(Ha, { className: "tw:pe-8", children: /* @__PURE__ */ a(qa, { children: X }) }),
          It,
          /* @__PURE__ */ u($o, { children: [
            /* @__PURE__ */ a(Q, { variant: "outline", onClick: () => it(!1), children: rt }),
            /* @__PURE__ */ a(Q, { onClick: at, children: $ })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && de && /* @__PURE__ */ a(Ua, { open: E === "range", onOpenChange: it, children: /* @__PURE__ */ a(
      Ka,
      {
        ref: ya,
        onCloseAutoFocus: Zt,
        ...
        children: /* @__PURE__ */ u(Ta, { container: tr, children: [
          /* @__PURE__ */ a(Ha, { className: "tw:pe-8", children: /* @__PURE__ */ a(qa, { children: z }) }),
          dt,
          /* @__PURE__ */ u($o, { children: [
            /* @__PURE__ */ a(Q, { variant: "outline", onClick: () => it(!1), children: rt }),
            /* @__PURE__ */ a(Q, { ref: Ht, onClick: at, children: $ })
          ] })
        ] })
      }
    ) })
...
function Eh({
  ...
  return /* @__PURE__ */ u(
    br,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(yr, { size: n, className: v("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          xr,
          {
            placeholder: d[Bo(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ a(
          kr,
          {
            ...
            style: { zIndex: cr },
            children: t.map((w) => /* @__PURE__ */ a(pe, { value: `${w}`, children: d[Bo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Hi = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(bs, { children: /* @__PURE__ */ a(xs, { children: Hi(
      t,
      e,
      Ki(t, c.id),
      o
...
function co({
  ...
  return /* @__PURE__ */ u(Ye, { variant: s, children: [
    /* @__PURE__ */ a(We, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Q, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(Zs, {}) }) }),
    /* @__PURE__ */ a(Xe, { align: "start", style: { zIndex: cr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(ga, { children: [
      /* @__PURE__ */ a(Sn, { children: /* @__PURE__ */ a(jt, { children: Hi(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(ir, {})
    ] }, d)) })
  ] });
}
const Ru = 8;
...
const zu = Object.freeze([520, 420, 340]), Gi = Wt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    const [n, s] = k(void 0), i = B(o);
    i.current = o;
    const c = L((p) => {
      s(p ?? void 0);
      const h = i.current;
      typeof h == "function" ? h(p) : h && (h.current = p);
    }, []), d = qi(n, zu), l = di() ?? d, w = l >= zr.MINIMUM;
    return /* @__PURE__ */ a(ma.Provider, { value: l, children: /* @__PURE__ */ a(
      "div",
      {
        ref: c,
        className: v(
...
function Dh({
  ...
  return /* @__PURE__ */ u(Gi, { className: `tw:w-full tw:border-b ${s}`, id: n, children: [
    r && /* @__PURE__ */ a(
      co,
      {
        onSelectMenuItem: t,
...
const Yi = Wt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ne();
  return /* @__PURE__ */ a(
    ge.Root,
    {
...
Yi.displayName = ge.List.displayName;
const Wi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.List,
  {
    ref: r,
    className: v(
...
Wi.displayName = ge.List.displayName;
const Mu = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.Trigger,
  {
    ref: r,
    ...e,
...
)), Xi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ge.Content,
  {
    ref: r,
    className: v(
...
function Mh({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Yi, { children: [
      /* @__PURE__ */ a(Wi, { children: t.map((c) => /* @__PURE__ */ a(Mu, { value: c.value, children: c.value }, c.key)) }),
...
const Sr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    const c = e.filter((l) => l.group === s).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        Vu,
        {
          onClick: () => {
            o(l);
      ...
      ) : /* @__PURE__ */ u(ju, { children: [
        /* @__PURE__ */ a(Bu, { children: l.label }),
        /* @__PURE__ */ a(Fu, { children: Ji(
          t,
          e,
          Ki(t, l.id),
          o
      ...
      l.tooltip && /* @__PURE__ */ a(Tt, { children: l.tooltip })
    ] }, `tooltip-${l.label}-${"command" in l ? l.command : l.id}`)), d = [...c];
    return c.length > 0 && i < n.length - 1 && d.push(/* @__PURE__ */ a(Lu, {}, `separator-${s}`)), d;
  });
};
function Uu({
  menuData: t,
  ...
  const n = B(void 0), s = B(void 0), i = B(void 0), c = B(void 0), d = B(void 0), l = (w) => {
    switch (w) {
      case "platform.app":
        return s;
  ...
  if (Rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = s.current) == null || f.focus(), Sr(s, [h, g]);
        break;
      case "alt+l":
        (b = i.current) == null || b.focus(), Sr(i, [h, g]);
        break;
      case "alt+n":
        (m = c.current) == null || m.focus(), Sr(c, [h, g]);
        break;
      case "alt+h":
        (R = d.current) == null || R.focus(), Sr(d, [h, g]);
        break;
    }
  }), Z(() => {
    ...
    return /* @__PURE__ */ a(Ou, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Iu, { children: [
      /* @__PURE__ */ a(Pu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Au,
        {
          style: { zIndex: cr },
          children: /* @__PURE__ */ a(jt, { children: Ji(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function $h({
  ...
  const l = Hu(
    ...
    var R, x, C, _, I, j;
    const m = b !== f ? ((x = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : x[b]) ?? ((_ = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : _.en) : void 0;
    return m ? `${(I = t[f]) == null ? void 0 : I.autonym} (${m})` : (j = t[f]) == null ? void 0 : j.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Pt, { className: "tw:font-normal tw:text-muted-foreground", children: je(l, {
...
function Ah({
  ...
  const [i, c] = k(""), d = P(
    ...
    return d.filter(({ keywords: b }) => b.some((m) => m.toLowerCase().includes(f)));
  }, [d, i]), w = d.length > 1, p = o["%firstRun_language_search_placeholder%"] ?? "", h = o["%firstRun_language_noResults%"] ?? "", g = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(qe, { id: s, className: v("pr-twp", n), shouldFilter: !1, children: [
...
function Lh({
  ...
  const c = t ? Fo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Wu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
    ...
    /* @__PURE__ */ u(Ct, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        Tt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Fo(l, {
            key: /* @__PURE__ */ a(
              Ga,
              {
                className: v(
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(ga, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            l && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ye, { children: [
                  /* @__PURE__ */ a(We, { className: v(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    Q,
                    {
...
function Fh({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: i.map((c) => {
    let d = "upcoming";
    return c === s ? d = "active" : c < s && (d = "complete"), /* @__PURE__ */ u(ga, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: d === "complete" ? /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function Qh({
  ...
  return /* @__PURE__ */ u(
    Bt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Bt.ItemIndicator, { children: /* @__PURE__ */ a(fa, {}) }) }),
        e
      ]
    }
  );
...
function mg({
  ...
  return /* @__PURE__ */ a(
    ge.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Zu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const tp = (t, e, r = {}) => {
  ...
  const [e, r] = k(!1), [o, n] = k(!1), [s, i] = k(0), c = B(void 0), d = P(() => {
    if (!t) return;
    const h = async () => {
      try {
        const g = await t();
...
function Ng(t) {
  const e = P(() => uc(t).slice().sort().join(" "), [t]);
...
function Tg({ value: t, children: e }) {
  return /* @__PURE__ */ a(li.Provider, { value: t, children: /* @__PURE__ */ a(ma.Provider, { value: t, children: e }) });
}
function ap(t, e = "top") {
...
export {
  ...
  Q as Button,
  uo as ButtonGroup,
  Tn as ButtonGroupSeparator,
  Og as ButtonGroupText,
  Ii as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  Ip as COMMENT_EDITOR_STRING_KEYS,
  cw as COMMENT_LIST_ELEMENT_ID,
  $p as COMMENT_LIST_STRING_KEYS,
  Mp as CONFLICT_NOTE_STRING_KEYS,
  $i as CancelAcceptButtons,
  lw as Card,
  dw as CardContent,
  Lp as CardDescription,
  jp as CardFooter,
  Ap as CardHeader,
  Vp as CardTitle,
  ...
  Uh as ContextMenu,
  Qh as ContextMenuCheckboxItem,
  Wh as ContextMenuContent,
  Hh as ContextMenuGroup,
  Xh as ContextMenuItem,
  eg as ContextMenuLabel,
  qh as ContextMenuPortal,
  Yh as ContextMenuRadioGroup,
  tg as ContextMenuRadioItem,
  rg as ContextMenuSeparator,
  ag as ContextMenuShortcut,
  Gh as ContextMenuSub,
  Zh as ContextMenuSubContent,
  Jh as ContextMenuSubTrigger,
  Kh as ContextMenuTrigger,
  Tw as DataTable,
  Lh as DestructiveKeyConfirmation,
  Ua as Dialog,
  Ig as DialogClose,
  Ka as DialogContent,
  ...
  qa as DialogTitle,
  Vg as DialogTrigger,
  Nu as DisabledActionTooltip,
  Ar as DisabledTooltipWrapper,
  og as Drawer,
  ig as DrawerClose,
  sg as DrawerContent,
  ...
  Rw as ErrorDump,
  Gp as ErrorPopover,
  Qp as FOOTNOTE_EDITOR_STRING_KEYS,
  Jp as Filter,
  ...
  pa as Input,
  Ah as InterfaceLanguagePicker,
  ch as Inventory,
  Ga as Kbd,
  Gg as KbdGroup,
  Pt as Label,
  jw as MARKER_MENU_STRING_KEYS,
  ...
  Wg as PopoverHeader,
  Ta as PopoverPortalContainerProvider,
  Xg as PopoverTitle,
  ...
  $l as RecentSearches,
  Jg as ResizableHandle,
  Zg as ResizablePanel,
  Qg as ResizablePanelGroup,
  jh as ResultsCard,
  tf as RetryableErrorView,
  Nh as SCOPE_SELECTOR_STRING_KEYS,
  Tu as SELECT_BOOKS_STRING_KEYS,
  zr as SHRINK_STEP,
  Ch as ScopeSelector,
  _h as ScriptureResultsViewer,
  Eh as ScrollGroupSelector,
  zn as SearchBar,
  br as Select,
  Eu as SelectBooks,
  _u as SelectBooksPicker,
  kr as SelectContent,
  _w as SelectGroup,
  pe as SelectItem,
  Up as SelectLabel,
  Cw as SelectScrollDownButton,
  Nw as SelectScrollUpButton,
  ...
  gu as SettingsSidebar,
  kh as SettingsSidebarContentSearch,
  ma as ShrinkStepContext,
  Tg as ShrinkStepOverride,
  ...
  Mw as UNDO_REDO_BUTTONS_STRING_KEYS,
  $h as UiLanguageSelector,
  Ow as UndoRedoButtons,
  Yi as VerticalTabs,
  Xi as VerticalTabsContent,
  Wi as VerticalTabsList,
  Mu as VerticalTabsTrigger,
  Fh as WizardStepper,
  cr as Z_INDEX_ABOVE_DOCK,
  Rn as Z_INDEX_ABOVE_POPOVER,
  of as Z_INDEX_CONNECTION_LOST,
  nf as Z_INDEX_FIRST_RUN,
  sf as Z_INDEX_MODAL,
  cf as Z_INDEX_MODAL_BACKDROP,
  lf as Z_INDEX_ONBOARDING_TOUR,
  df as Z_INDEX_OVERLAY,
  wf as badgeVariants,
  uf as buttonGroupVariants,
  pf as buttonVariants,
  v as cn,
  ih as getBookIdFromUSFM,
  Pp as getCommentThreadElementId,
  ba as getInventoryHeader,
  oh as getLinesFromUSFM,
  nh as getNumberFromUSFM,
  ru as getStatusForItem,
  Oh as getToolbarOSReservedSpaceClassName,
  rh as inventoryCountColumn,
  eh as inventoryItemColumn,
  ah as inventoryStatusColumn,
  po as isMacOs,
  hf as isWindows,
  Hw as markerMenuItemToPaletteItem,
  rp as pickTabIconUrl,
  ff as sonner,
  xg as useEvent,
  yg as useEventAsync,
  Ng as useExtraValidMarkers,
  ns as useListbox,
  tp as usePromise,
  Sp as useRecentSearches,
  kg as useRetryablePromise,
  Cg as useRunWhenVisible,
  qi as useShrinkStep,
  di as useShrinkStepOverride,
  Ml as useShrinkStepValue,
  xa as useSidebar,
  _g as useStylesheet,
  Eg as useTabIconSelection,
  Oo as useTruncationTooltip,
  ep as useViewVisibility
};
