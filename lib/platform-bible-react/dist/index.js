...
function fv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = fe(""), [o, a] = fe(
    ...
    Hc.forEach((k) => {
      const R = n.match(k);
      if (R) {
        const [$, F = void 0, H = void 0] = R.slice(1), M = Xc($);
        ...
        children: [
          ...
          fa.map(
            (k, R) => x(k).length > 0 && /* @__PURE__ */ V("div", { children: [
              ...
              fa.length - 1 !== R ? /* @__PURE__ */ m(No, {}) : void 0
            ] }, k)
          )
        ]
      }
...
function np({
  ...
  return /* @__PURE__ */ V("div", { className: "pr-twp pr-font-sans", children: [
    ...
    /* @__PURE__ */ V(br, { stickyHeader: a, children: [
      /* @__PURE__ */ m(vr, { stickyHeader: a, children: u.getHeaderGroups().map((x) => /* @__PURE__ */ m(vt, { children: x.headers.map((C) => /* @__PURE__ */ m(Pn, { children: C.isPlaceholder ? void 0 : xn(C.column.columnDef.header, C.getContext()) }, C.id)) }, x.id)) }),
      /* @__PURE__ */ m(yr, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((x) => /* @__PURE__ */ m(
        vt,
        {
          ...
          children: x.getVisibleCells().map((C) => /* @__PURE__ */ m(Yt, { children: xn(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        x.id
...
function mv({
  ...
  const g = n["%webView_inventory_all%"], p = n["%webView_inventory_approved%"], h = n["%webView_inventory_unapproved%"], u = n["%webView_inventory_unknown%"], b = n["%webView_inventory_scope_book%"], x = n["%webView_inventory_scope_chapter%"], C = n["%webView_inventory_scope_verse%"], w = n["%webView_inventory_filter_text%"], [E, y] = fe([]), [N, S] = fe("all"), [_, D] = fe(""), [j, k] = fe(""), R = (M, z) => {
    y((O) => {
      let A = [];
      return M.forEach((G) => {
...
function wp() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, N = d, S = l, _ = i, D = t, j = f, k = r, R = h, $ = p, F = n, H = a, M = o, z = v, Q = !1;
    function Z(B) {
    ...
    pe.AsyncMode = y, pe.ConcurrentMode = N, pe.ContextConsumer = S, pe.ContextProvider = _, pe.Element = D, pe.ForwardRef = j, pe.Fragment = k, pe.Lazy = R, pe.Memo = $, pe.Portal = F, pe.Profiler = H, pe.StrictMode = M, pe.Suspense = z, pe.isAsyncMode = Z, pe.isConcurrentMode = O, pe.isContextConsumer = A, pe.isContextProvider = G, pe.isElement = X, pe.isForwardRef = W, pe.isFragment = q, pe.isLazy = K, pe.isMemo = J, pe.isPortal = Y, pe.isProfiler = ee, pe.isStrictMode = te, pe.isSuspense = ie, pe.isValidElementType = w, pe.typeOf = E;
  }()), pe;
}
var ya;
function Xi() {
...
function Ip() {
  return Sa || (Sa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var N = i, S = a, _ = e, D = c, j = n, k = g, R = v, $ = t, F = o, H = r, M = d, z = f, Q = !1, Z = !1;
    function O(I) {
    ...
    de.ContextConsumer = N, de.ContextProvider = S, de.Element = _, de.ForwardRef = D, de.Fragment = j, de.Lazy = k, de.Memo = R, de.Portal = $, de.Profiler = F, de.StrictMode = H, de.Suspense = M, de.SuspenseList = z, de.isAsyncMode = O, de.isConcurrentMode = A, de.isContextConsumer = G, de.isContextProvider = X, de.isElement = W, de.isForwardRef = q, de.isFragment = K, de.isLazy = J, de.isMemo = Y, de.isPortal = ee, de.isProfiler = te, de.isStrictMode = ie, de.isSuspense = B, de.isSuspenseList = ne, de.isValidElementType = E, de.typeOf = y;
  }()), de;
}
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return La(u, "light", C, r), La(u, "dark", w, r), u.contrastText || (u.contrastText = v(u.main)), u;
  }, p = {
    dark: Xr,
    light: ja
  };
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Ce(h.current), E = (S) => {
      ...
      if ((w.activeElement === d.current || w.activeElement === f.current) && (_ = a(h.current)), _.length > 0) {
        var D, j;
        const k = !!((D = b.current) != null && D.shiftKey && ((j = b.current) == null ? void 0 : j.key) === "Tab"), R = _[0], $ = _[_.length - 1];
...
function Ff(e) {
  const {
    ...
    open: f,
    rootRef: v
  } = e, g = T.useRef({}), p = T.useRef(null), h = T.useRef(null), u = Ge(h, v), [b, x] = T.useState(!f), C = jf(c);
  let w = !0;
...
function im(e) {
  ...
  if (!(!a || !i)) {
    var v = am(o.padding, n), g = Fo(a), p = c === "y" ? _e : Ie, h = c === "y" ? We : Xe, u = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = zn(a), C = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, E = v[p], y = C - g[f] - v[h], N = C / 2 - g[f] / 2 + w, S = Nn(E, N, y), _ = c;
...
function Ka(e) {
  ...
  p = b.x, u = b.y;
  var x = i.hasOwnProperty("x"), C = i.hasOwnProperty("y"), w = Ie, E = _e, y = window;
  if (d) {
...
function Tm(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, u = n.allowedAutoPlacements, b = t.options.placement, x = Ze(b), C = x === b, w = c || (C || !h ? [tr(b)] : km(b)), E = [b].concat(w).reduce(function(W, q) {
      ...
      var k = E[j], R = Ze(k), $ = tn(k) === Zt, F = [_e, We].indexOf(R) >= 0, H = F ? "width" : "height", M = An(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
      ...
      y[H] > N[H] && (z = tr(z));
      var Q = tr(z), Z = [];
      if (a && Z.push(M[R] <= 0), l && Z.push(M[z] <= 0, M[Q] <= 0), Z.every(function(W) {
        return W;
      })) {
        D = k, _ = !1;
        break;
...
function Im(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, h = n.tetherOffset, u = h === void 0 ? 0 : h, b = An(t, {
    ...
    padding: v,
    altBoundary: f
  }), x = Ze(t.placement), C = tn(t.placement), w = !C, E = Vo(x), y = _m(E), N = t.modifiersData.popperOffsets, S = t.rects.reference, _ = t.rects.popper, D = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, j = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (N) {
    if (a) {
      var $, F = E === "y" ? _e : Ie, H = E === "y" ? We : Xe, M = E === "y" ? "height" : "width", z = N[E], Q = z + b[F], Z = z - b[H], O = p ? -_[M] / 2 : 0, A = C === Zt ? S[M] : _[M], G = C === Zt ? -_[M] : -S[M], X = t.elements.arrow, W = p && X ? Fo(X) : {
        width: 0,
        height: 0
    ...
    var f = {
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (ni(C, w)) {
            f.rects = {
              reference: Lm(C, zn(w), f.options.strategy === "fixed"),
              popper: Fo(w)
...
const Zm = () => ut({
  ...
  } = t, b = he(t, qm), x = T.useRef(null), C = Ge(x, n), w = T.useRef(null), E = Ge(w, g), y = T.useRef(E);
  It(() => {
    y.current = E;
...
`));
  ...
  const R = Zm(), $ = (r = h.root) != null ? r : "div", F = Dt({
    elementType: $,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, C = he(t, Ym), [w, E] = T.useState(!0), y = () => {
    E(!1);
  }, N = () => {
    E(!0);
  };
...
const ah = {
  ...
  } = t, x = he(t, oh), C = vn(), w = T.useRef(), E = Hn(), y = T.useRef(null), N = Ge(y, a.ref, n), S = (H) => (M) => {
    if (H) {
      const z = y.current;
      M === void 0 ? H(z) : H(z, M);
    }
...
`));
  ...
  const ln = {};
  H || (ze.onTouchStart = El, ze.onTouchEnd = kl), $ || (ze.onMouseOver = Zn(ra, ze.onMouseOver), ze.onMouseLeave = Zn(oa, ze.onMouseLeave), ot || (ln.onMouseOver = ra, ln.onMouseLeave = oa)), R || (ze.onFocus = Zn(ta, ze.onFocus), ze.onBlur = Zn(ea, ze.onBlur), ot || (ln.onFocus = ta, ln.onBlur = ea)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Ol = T.useMemo(() => {
    var re;
    let je = [{
    ...
    className: Oe(Dr.tooltip, (x = (C = ee.tooltip) != null ? C : j.tooltip) == null ? void 0 : x.className)
...
const Fh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Vh = (e) => {
  ...
  const J = (r = (o = F == null ? void 0 : F.root) != null ? o : x.Root) != null ? r : zh, Y = (a = (i = F == null ? void 0 : F.backdrop) != null ? i : x.Backdrop) != null ? a : f, ee = (l = $ == null ? void 0 : $.root) != null ? l : C.root, te = (c = $ == null ? void 0 : $.backdrop) != null ? c : C.backdrop, ie = Dt({
    elementType: J,
  ...
  return !j && !R && (!X || G) ? null : /* @__PURE__ */ m(_n, {
    ref: O,
    container: u,
    disablePortal: N,
...
const eg = (e) => {
  ...
  } = i, j = he(i.TransitionProps, Jh), k = he(i, Zh), R = (r = E == null ? void 0 : E.paper) != null ? r : C, $ = T.useRef(), F = Ge($, R.ref), H = P({}, i, {
    anchorOrigin: d,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`)), b !== null && xe < b) {
  ...
  const K = h || (c ? Ce(nr(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : tg, Y = (a = w == null ? void 0 : w.paper) != null ? a : Ys, ee = Dt({
    ...
    ownerState: H,
    className: Oe(M.paper, R == null ? void 0 : R.className)
  }), te = Dt({
    elementType: J,
...
const og = ["onEntering"], ag = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], ig = {
  ...
  const a = dt({
    ...
    TransitionProps: E,
    variant: x
  }), D = lg(_), j = i && !d && g, k = T.useRef(null), R = (Z, O) => {
...
`)), Z.props.disabled || (x === "selectedMenu" && Z.props.selected || F === -1) && (F = O));
  ...
  const H = (r = C.paper) != null ? r : pg, M = (o = w.paper) != null ? o : p, z = Dt({
    elementType: C.root,
...
function yv({
  ...
  return /* @__PURE__ */ V("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    ...
    /* @__PURE__ */ V(br, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ m(vr, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ m(vt, { children: k.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ m(Pn, { colSpan: R.colSpan, className: "top-0 pr-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ V("div", { children: [
          ...
          " ",
          xn(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, k.id)) }),
      /* @__PURE__ */ m(yr, { children: w.getRowModel().rows.map((k, R) => /* @__PURE__ */ m(
        vt,
        {
...
function Mb(e, t = {}) {
  ...
  function r(p, h, ...u) {
    ...
    return n(function(x, C) {
      const w = eo(C, x);
      return w ? typeof w == "function" || typeof w == "object" && "render" in w ? w : eo(C, `${x}.component`, x) : x;
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, x) {
      ...
      if (C !== -1) {
        ...
        }(b.slice(C + 1).trim()), y = ui[w] || w, N = u[y] = function(S, _) {
...
` }, paragraph: { t: Cb, i: ae.LOW, l: Jr, h: (p, h, u) => r("p", { key: u.k }, h(p.v, u)) }, ref: { t: mt(Zg), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: Qr }, refImage: { t: ht(Qg), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => r("img", { key: u.k, alt: p.D, src: Gt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(eb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(tb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? r("a", { key: u.k, href: Gt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : r("span", { key: u.k }, h(p.Z, u)) }, table: { t: it(sl), i: ae.HIGH, l: Sb, h: (p, h, u) => r("table", { key: u.k }, r("thead", null, r("tr", null, p.L.map(function(b, x) {
    ...
    return r("tr", { key: x }, b.map(function(C, w) {
      return r("td", { key: w, style: gi(p, w) }, h(C, u));
    }));
  ...
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: gn(bo), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(bb), x = new RegExp(`^${b}`, "gm"), C = p[3].replace(x, ""), w = (E = C, Tb.some((_) => _.test(E)) ? Pb : rr);
    var E;
      ...
      for (; b; ) {
        ...
        for (; E < h.length; ) {
          ...
          if (S) {
            ...
            const D = N.l(S, u, x);
            D.type == null && (D.type = y), C.push(D), w = _;
            break;
          }
          E++;
        }
