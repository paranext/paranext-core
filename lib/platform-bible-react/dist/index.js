...
import { c as v, g as Ae, a as Lr, C as tr, L as Kn, t as _s, u as tn, T as At, b as _t, d as Nt, e as Ct, f as Hn, A as ba, r as oe, D as Be, h as Ee, i as Fe, j as cr, k as Ge, B as et, x as Ns, l as Cs, m as Es, I as Ts, n as Co, o as Xe, p as Re, q as Ss, s as qn, P as lr, v as Dr, w as dr, y as wr, z as Da, E as Oa, F as Eo, G as ur, H as Ma, J as Pt, R as To, K as xa, M as io, N as so, O as co, Q as lo, S as Gn, U as wa, V as So, W as Ur, X as Kr, Y as yr, Z as Rs, _ as Ds, $ as ir, a0 as Ze, a1 as je, a2 as We, a3 as kr, a4 as Ro, a5 as Do, a6 as ya, a7 as Oo, a8 as Wn, a9 as Os, aa as Ms, ab as Is, ac as wo, ad as Yn, ae as Ia, af as zs, ag as Zn, ah as Ps, ai as As, aj as $s, ak as en, al as Vs, am as Ls, an as Bs, ao as Fs, ap as Xn, aq as Jn, ar as Mo, as as js, at as Qn, au as Ka, av as rn, aw as Ha, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Ys, aE as Zs, aF as Xs, aG as Io, aH as zo, aI as Js, aJ as Qs } from "./resizable-B9nyCfWU.js";
import { aK as Ef, aL as Tf, aM as Sf, aN as Rf, aO as Df, aP as Of, aQ as Mf, aR as If, aS as zf, aT as Pf, aU as Af, aV as $f, aW as Vf, aX as Lf, aY as Bf, aZ as Ff, a_ as jf, a$ as Uf, b0 as Kf, b1 as Hf, b2 as qf, b3 as Gf, b4 as Wf, b5 as Yf, b6 as Zf, b7 as Xf, b8 as Jf, b9 as Qf, ba as tm, bb as em, bc as rm, bd as am, be as om, bf as nm, bg as im, bh as sm, bi as cm, bj as lm, bk as dm, bl as wm, bm as um, bn as pm, bo as hm, bp as gm, bq as fm } from "./resizable-B9nyCfWU.js";
import { jsx as a, jsxs as u, Fragment as ft } from "react/jsx-runtime";
import { Canon as Kt } from "@sillsdev/scripture";
import { Check as Je, Clock as an, ChevronsLeft as on, ChevronsRight as nn, ChevronUp as ti, ChevronDown as sr, ArrowLeft as tc, ArrowRight as ec, BoldIcon as rc, ItalicIcon as ac, X as ei, AtSign as ri, Pencil as oc, Trash2 as nc, Undo2 as ic, ArrowUp as ai, MoreHorizontal as sc, MailOpen as cc, Mail as lc, FilterIcon as dc, ArrowLeftIcon as wc, ChevronLeftIcon as uc, ChevronRightIcon as pc, ArrowRightIcon as hc, Copy as oi, Filter as gc, User as fc, Link as mc, CircleHelp as vc, Undo as bc, Redo as xc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as yc, AlertCircle as uo, CircleCheckIcon as kc, CircleXIcon as _c, CircleHelpIcon as Nc, ArrowUpIcon as Cc, ArrowDownIcon as Ec, ScrollText as Tc, ChevronRight as Sc, ChevronLeft as Rc, ChevronsUpDown as Dc, MenuIcon as Oc, Menu as Mc, EllipsisVertical as Ic, MoreVertical as zc } from "lucide-react";
import { Section as zt, compareScrRefs as ka, getChaptersForBook as Pc, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as ua, formatRelativeDate as Ac, sanitizeHtml as Po, NumberFormat as ci, formatBytes as $c, getCurrentLocale as Vc, usfmMarkers as Ar, isPlatformError as Lc, ABORTED as Bc, getErrorMessage as Fc, getFormatCallerFunction as jc, deepEqual as Uc, isString as sn, scrRefToBBBCCCVVV as qa, defaultScrRef as Ga, formatScrRefRange as Kc, getLocalizeKeyForScrollGroupId as cn, formatReplacementStringToArray as ln, collectUsjMarkers as Hc } from "platform-bible-utils";
import te, { useRef as A, useMemo as V, createContext as Wr, useContext as za, useEffect as J, useState as _, useCallback as L, useId as _a, useImperativeHandle as qc, useLayoutEffect as Ht, Fragment as Yr, Component as Gc, createElement as dn, Suspense as Wc, forwardRef as Ao, memo as li } from "react";
import { IconSelector as di, IconCheck as Pa, IconChevronDown as Yc, IconChevronUp as Zc, IconLayoutSidebar as Xc, IconLayoutSidebarRight as Jc, IconChevronRight as wi, IconSearch as Qc, IconLoader as tl, IconAlertOctagon as el, IconAlertTriangle as rl, IconInfoCircle as al, IconCircleCheck as ol } from "@tabler/icons-react";
import { createEditor as ui, $getRoot as Qe, $createParagraphNode as Zr, $getSelection as ne, HISTORY_MERGE_TAG as $o, ParagraphNode as pi, TextNode as hi, $getPreviousSelection as nl, $isRangeSelection as Te, $caretFromPoint as il, $getSiblingCaret as gi, $getChildCaret as sl, $getAdjacentChildCaret as cl, $isChildCaret as ll, $normalizeCaret as dl, $setSelectionFromCaretRange as wl, $getCollapsedCaretRange as ul, $getCaretInDirection as wn, $splitAtPointCaretNext as pl, $isTextPointCaret as hl, $findMatchingParent as fi, $isElementNode as Hr, mergeRegister as Le, getDOMTextNode as gl, isHTMLElement as fl, CLEAR_EDITOR_COMMAND as mi, COMMAND_PRIORITY_EDITOR as Vo, shallowMergeConfig as ml, defineExtension as he, safeCast as pr, createState as vl, FORMAT_TEXT_COMMAND as vi, $isNodeSelection as bi, COMMAND_PRIORITY_LOW as xi, RootNode as bl, LineBreakNode as xl, TabNode as yl, $isEditorState as kl, createCommand as _l, CLICK_COMMAND as Nl, isDOMNode as Cl, $getNodeFromDOMNode as El, $createNodeSelection as Tl, $setSelection as Sl, $getEditor as Rl, DecoratorNode as po, $getState as Dl, toggleTextFormatType as un, TEXT_TYPE_TO_FORMAT as Ol, $setState as Ml, addClassNamesToElement as yi, $create as Il, $getNodeByKey as zl, removeClassNamesFromElement as Pl, KEY_TAB_COMMAND as Al, $isBlockElementNode as $l, $createRangeSelection as Vl, $normalizeSelection__EXPERIMENTAL as Ll, OUTDENT_CONTENT_COMMAND as Bl, INDENT_CONTENT_COMMAND as pn, INSERT_TAB_COMMAND as Fl, COMMAND_PRIORITY_CRITICAL as Lo, $isDecoratorNode as jl, $isParagraphNode as Ul, $isTextNode as ho, SELECTION_CHANGE_COMMAND as ki, $insertNodes as Kl } from "lexical";
...
import { useReactTable as Ni, getFilteredRowModel as Ql, getSortedRowModel as Ci, getPaginationRowModel as td, getCoreRowModel as Ei, flexRender as Br, getGroupedRowModel as ed, getExpandedRowModel as rd } from "@tanstack/react-table";
import ad from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as go, HIDDEN_NOTE_CALLER as fo, getDefaultViewOptions as od, isInsertEmbedOpOfType as Ir, getMarkerMenuItems as nd, defaultStyleInfo as id, Editorial as sd } from "@eten-tech-foundation/platform-editor";
...
const gd = "top-match", fd = "Show recent searches", md = "Recent";
function vd({
  recentSearches: t,
  ...
  const [h, f] = _(!1), [b, x] = _(!1), g = _a(), C = A(!1), E = w !== void 0, S = E ? w : h, y = n === "" ? "" : oe(n, fd), z = oe(s, md), T = (I) => {
...
const Td = "a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]";
function Sd(t) {
  return Array.from(t.querySelectorAll(Td)).filter(
    (e) => e.tabIndex >= 0
  );
}
function Ya({
  ...
  const T = Re(), O = pd(), [M, D] = _(!1), [I, Y] = _(""), [X, B] = _(""), [k, ot] = _("books"), [$, q] = _(void 0), [Q, j] = _(
    void 0
  ...
  const { otLong: ke, ntLong: rr, dcLong: ar, extraLong: Ue } = {
    ...
    (m) => {
      ...
      if (!(!!W && !!((Xo = Rt.current) != null && Xo.contains(W))) && (W != null && W.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const Lt = Rt.current ? Sd(Rt.current) : [];
        if (Lt.length === 0) {
                ...
                /* @__PURE__ */ u(_t, { children: [
                  /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
                    et,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Qr,
                      children: T === "ltr" ? /* @__PURE__ */ a(tc, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ec, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Md = zi ? Ht : J, ca = { tag: $o };
function Id({ initialConfig: t, children: e }) {
  const r = V(() => {
...
const zd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : J;
function Pd({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Oe();
  return zd(() => {
...
class $d extends Gc {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Vd(e.resetKeys, n)) {
      var s, i;
...
function Ld({ children: t, onError: e }) {
  return a($d, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Bd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : J;
function Fd(t) {
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Kd = Pi && "documentMode" in document ? document.documentMode : null;
!(!Pi || !("InputEvent" in window) || Kd) && "getTargetRanges" in new window.InputEvent("input");
function Ce(t) {
  return `${t}px`;
}
const Hd = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function qd(t, e, r) {
  let o = null, n = null, s = null, i = [];
  const c = document.createElement("div");
  function d() {
    o === null && Na(182), n === null && Na(183);
    const { left: p, top: h } = n.getBoundingClientRect(), f = Ud(t, e);
    var b, x;
...
function Yd(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = Wd(t, e));
  };
...
function Xd(t) {
  const e = ne() || nl();
  let r;
  if (Te(e)) r = il(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = gi(c, "next"));
    }
    r = r || sl(Qe(), "previous").getFlipped().insert(Zr());
  }
  const o = Jd(t, r), n = cl(o), s = ll(n) ? dl(n) : o;
  return wl(ul(s)), t.getLatest();
}
function Jd(t, e, r) {
  let o = wn(e, "next");
  for (let n = o; n; n = pl(n, r)) o = n;
  return hl(o) && Na(283), o.insert(t.isInline() ? Zr().append(t) : t), wn(gi(t.getLatest(), "next"), e.direction);
}
function Qd(t) {
  const e = ne();
  if (!Te(e)) return !1;
...
let Ca, Ve = 0, Ea = 0, rw = 0, yo = 0, ga = 0;
function Nn(t) {
  if (pt === void 0) return;
  let e = t.n;
...
Qt.prototype.brand = tw, Qt.prototype.h = function() {
  return !0;
...
const Ja = vl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Fi extends po {
  $config() {
...
he({ name: "@lexical/extension/DecoratorText", nodes: () => [Fi], register: (t, e, r) => t.registerCommand(vi, (o) => {
  const n = ne();
  if (bi(n) || Te(n)) for (const s of n.getNodes()) iw(s) && s.toggleFormat(o);
  return !1;
}, xi) });
function ji(t, e) {
  let r;
...
class lw {
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || cw;
  }
  getPeerNameSet() {
...
const ww = he({ config: pr({ setOptions: En, updateOptions: En }), init: ({ $initialEditorState: t = dw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [bl, hi, xl, yl, pi] }), Tn = Symbol.for("@lexical/extension/LexicalBuilder");
function Sn() {
}
function uw(t) {
  throw t;
...
class Nr {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && vt(298, o.name), !n) {
      n = new lw(this, o), this.extensionNameMap.set(o.name, n);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of nw(p)) {
    ...
    return e.onError || (e.onError = uw), e;
  }
}
const pw = /* @__PURE__ */ new Set(), Rn = he({ build(t, e, r) {
  ...
  return { watchNodeKey: function(i) {
    const c = aw(() => (s.value || pw).has(i)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(i);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(i, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [ko], name: "@lexical/extension/NodeSelection" }), hw = _l("INSERT_HORIZONTAL_RULE_COMMAND");
class Cr extends po {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: gw, priority: 0 }) };
  }
  exportDOM() {
...
he({ dependencies: [ko, Rn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  ...
  return Le(t.registerCommand(hw, (i) => {
    const c = ne();
    if (!Te(c)) return !1;
    ...
    return !0;
  }, Vo), t.registerCommand(Nl, (i) => {
    if (Cl(i.target)) {
      const c = El(i.target);
      if (fw(c)) return function(d, l = !1) {
        const w = ne(), p = d.isSelected(), h = d.getKey();
        let f;
        l && bi(w) ? f = w : (f = Tl(), Sl(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
...
he({ build: (t, e, r) => Or(e), config: pr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Se(() => {
    if (!o.disabled.value) return Yd(t, o.onReposition.value);
  });
} });
function qi(t) {
  return t.canBeEmpty();
}
function mw(t, e, r = qi) {
  return Le(t.registerCommand(Al, (o) => {
    ...
    const s = function(i) {
      ...
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Zd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Vl();
...
he({ build: (t, e, r) => Or(e), config: pr({ $canIndent: qi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Se(() => {
    if (!o.value) return mw(t, n, s);
  });
} });
const vw = he({ name: "@lexical/react/ReactProvider" });
function bw() {
...
function Nw({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(vw.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && kw(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(_w, { editor: t, ErrorBoundary: e });
}
function Dn(t) {
  return t.getEditorState().read(Gi(t.isComposing()));
}
function Cw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Oe();
  return function(n) {
    qo(() => Le(Gl(n), Wi(n)), [n]);
  }(o), u(ft, { children: [t, a(Ew, { content: e }), a(Nw, { editor: o, ErrorBoundary: r })] });
}
...
function Iw(t, e) {
  ...
  return u(ft, { children: [a(Ow, { editor: n, ...o, ref: e }), r != null && a(zw, { editor: n, content: r })] });
}
function zw({ content: t, editor: e }) {
  const r = function(i) {
    const [c, d] = _(() => On(i));
    return Yi(() => {
      function l() {
...
function Vw({
  ...
  const [e] = Oe(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = $w(), d = () => {
  };
      ...
      /* @__PURE__ */ a(
        Cw,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && n(i);
          }, children: /* @__PURE__ */ a(Pw, { placeholder: t }) }),
          ErrorBoundary: Ld
        }
      ),
      e && /* @__PURE__ */ a(Tw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(Fw, { onClear: r }),
      /* @__PURE__ */ a(Rw, {})
    ] }),
    o && /* @__PURE__ */ a(
      "div",
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Id, { initialConfig: l, children: /* @__PURE__ */ u(At, { children: [
          /* @__PURE__ */ a(
            jw,
            {
              placeholder: n,
          ...
          /* @__PURE__ */ a(Pd, { ignoreSelectionChange: !0, onChange: w })
        ] }) })
      }
    )
  );
...
const Hw = "verseText", Ch = Object.freeze([
...
function as(t) {
  return (t == null ? void 0 : t.conflictType) === Hw;
}
function os(t) {
...
function Eh({
  ...
  const [s, i] = _(Gw), [c, d] = _(n), [l, w] = _(!1), p = A(void 0), h = A(null);
  J(() => {
    let g = !0;
    const C = h.current;
    if (!C) return;
...
function Pn({
        ...
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (B) => {
              ...
              g(k ? Kw(t.contents) : qw), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Xw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Jw, { className: "tw:text-xs tw:font-medium", children: O }) }),
        ...
        Y && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(sc, {}) }) }),
...
const Qw = {
  ...
  var gr;
  const [ot, $] = _({}), q = B ?? ot, Q = q.editorState ?? Qw, j = q.assignedUser, at = k !== void 0, wt = A(q);
  wt.current = q;
  const ct = L(
    (R) => {
  ...
  return /* @__PURE__ */ a(
    Yw,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(Zw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              et,
              {
                ...
                children: Mt ? /* @__PURE__ */ a(cc, {}) : /* @__PURE__ */ a(lc, {})
              }
            ),
            Y === void 0 ? (
...
), eu = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ma = (t) => eu(Po(t));
function va({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
const su = li(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: f, showResolveCheck: b } = iu({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
      ...
      children: Y.map((j) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: j.type === "Conflict" ? /* @__PURE__ */ a(su, { ...at, conflictResolution: C }) : /* @__PURE__ */ a(is, { ...at })
          },
          j.id
        );
      })
...
cu.displayName = "ContentZoomRoot";
function lu({ table: t }) {
...
function vu({ id: t, versionHistory: e }) {
...
function Uh({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(vu, { versionHistory: n }),
...
const Cu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ft, { children: [
...
function Eu({
  ...
  return /* @__PURE__ */ u(Be, { open: f, onOpenChange: E, children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Cu(t, o, e) }) }) }),
...
const Tu = (t, e) => t === "f" ? /* @__PURE__ */ u(ft, { children: [
  /* @__PURE__ */ a(ii, {}),
  " ",
...
function Ru({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: Tu(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: Su(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(
      Fe,
      {
...
function Vn({
  ...
  return /* @__PURE__ */ u(
    tr,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(Mu, { state: t.selectionState }),
...
function qh({
  ...
  const [x, g] = _("generated"), [C, E] = _("generated"), [S, y] = _("*"), [z, T] = _("*"), [O, M] = _("f"), [D, I] = _(!1), [Y, X] = _(!0), [B, k] = _(!1), ot = A(!1), $ = A(""), [q, Q] = _(!1), j = ku(), [at, wt] = _(), ct = A(null), tt = A(
    void 0
  ...
  const Mt = () => {
    ...
    if (F && Ir("note", F)) {
      ...
      O !== "x" && N === "x" ? nt == null || nt.forEach((kt) => Au(kt)) : O === "x" && N !== "x" && (nt == null || nt.forEach((kt) => $u(kt))), Rt(F);
    }
  }, xe = (N) => {
    ...
    (N, F, G) => {
      ...
      As({
        ...
        onShowError: (H) => {
          (!Lc(H) || H.code !== Bc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Fc(H)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ft, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ft, { children: Lu(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Oo, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      We,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(kr, { className: o, children: ju(c.text) })
        ]
      },
...
const Ku = (t) => {
  ...
  return e ? e[1] : "";
}, qu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", eg = Object.freeze([
...
function rg({
  ...
  }, [O, ot]), q = V(() => $.length === 0 ? [] : Gu($, D, Y), [$, D, Y]), Q = V(() => {
    var xt, gt;
    if (!O) return d;
...
const Yu = "16rem", Zu = "3rem", cs = te.createContext(void 0);
function La() {
...
function op({
  ...
  const c = t ? Xr.Root : "button", { state: d } = La(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(ap({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Ju,
    {
      ...
      children: /* @__PURE__ */ u(tp, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(ep, { children: Object.entries(e).map(([g, C]) => /* @__PURE__ */ a(rp, { children: /* @__PURE__ */ a(
            op,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const He = "scrBook", ip = "scrRef", nr = "source", sp = "details", cp = "Scripture Reference", lp = "Scripture Book", ls = "Type", dp = "Details";
function wp(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, jn = (t) => `${up({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function mg({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(du, { children: y.map((D) => /* @__PURE__ */ a(ve, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
                    ...
                    children: X.getIsGrouped() ? /* @__PURE__ */ u(
                      et,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Sc, {}) : /* @__PURE__ */ a(Rc, {})),
                          " ",
...
function bg({
  ...
  const T = Ut(
    ...
    [r, n, g, s]
  ), re = gt.find((K) => K.value === t), Me = () => t === "selectedBooks" && n.length > 0 ? n.map((K) => K.toUpperCase()).join(", ") : t === "range" ? Kc(St, Gt, {
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(_t, { children: [
  /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Ws, { children: /* @__PURE__ */ a(Ys, { children: ps(
      t,
      e,
      ds(t, c.id),
      o
...
function No({
  ...
  const l = _a(), w = bp(e), p = s && w.length > 1;
  Oi();
  const h = A(null), f = () => Ks(h.current ?? void 0);
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        style: { zIndex: je },
        onCloseAutoFocus: () => {
          Hn() === "pointer" && Zs(h.current ?? void 0);
        },
...
const kp = Object.freeze([520, 420, 340]), gs = te.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, kp), l = Di() ?? d, w = l >= Fr.MINIMUM;
...
const _p = te.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  be.Trigger,
  {
    ref: r,
    ...e,
...
function Eg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(fs, { children: [
      /* @__PURE__ */ a(ms, { children: t.map((c) => /* @__PURE__ */ a(_p, { value: c.value, children: c.value }, c.key)) }),
...
const Pr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
    ...
    return c.length > 0 && i < n.length - 1 && d.push(/* @__PURE__ */ a(Dp, {}, `separator-${s}`)), d;
  });
};
function Pp({
  menuData: t,
  ...
  if (cd(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Np, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ws(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Cp, { children: [
      /* @__PURE__ */ a(Tp, { ref: l(w), children: p.label }),
      /* @__PURE__ */ a(
        Sp,
        {
          style: { zIndex: je },
...
function uf({
  ...
  return /* @__PURE__ */ a(
    be.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Hp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function bf(t) {
  const e = V(() => Hc(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Mf as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  If as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  Eh as CommentEditor,
  Ph as CommentList,
  ru as ConflictNoteCard,
  Ds as ContentZoomAreaProvider,
  cu as ContentZoomRoot,
  $g as ContextMenu,
  ...
  gu as ERROR_DUMP_STRING_KEYS,
  Lh as ERROR_POPOVER_STRING_KEYS,
  yu as EditorKeyboardShortcuts,
  Lf as Empty,
  Bf as EmptyContent,
  ...
  ve as SelectItem,
  Ah as SelectLabel,
  uu as SelectScrollDownButton,
  wu as SelectScrollUpButton,
  ...
  Sg as Toolbar,
  hd as ToolbarCompoundLabel,
  _t as Tooltip,
  Ct as TooltipContent,
  At as TooltipProvider,
  Nt as TooltipTrigger,
  bu as UNDO_REDO_BUTTONS_STRING_KEYS,
  Rg as UiLanguageSelector,
  xu as UndoRedoButtons,
  fs as VerticalTabs,
  vs as VerticalTabsContent,
  ms as VerticalTabsList,
  _p as VerticalTabsTrigger,
  Ag as WizardStepper,
  je as Z_INDEX_ABOVE_DOCK,
  Yn as Z_INDEX_ABOVE_POPOVER,
  om as Z_INDEX_CONNECTION_LOST,
  nm as Z_INDEX_FIRST_RUN,
  im as Z_INDEX_MODAL,
  sm as Z_INDEX_MODAL_BACKDROP,
  cm as Z_INDEX_NESTED_MODAL,
  lm as Z_INDEX_NESTED_MODAL_BACKDROP,
  dm as Z_INDEX_ONBOARDING_TOUR,
  wm as Z_INDEX_OVERLAY,
  um as badgeVariants,
  pm as buttonGroupVariants,
  hm as buttonVariants,
  v as cn,
  ...
  Pu as markerMenuItemToPaletteItem,
  Hh as measureElement,
  _u as measureRange,
  Yp as pickTabIconUrl,
  vm as sonner,
  fm as useContentZoomArea,
  gf as useEvent,
  ff as useEventAsync,
  bf as useExtraValidMarkers,
  Rs as useListbox,
  ku as useLivePopoverAnchor,
  Gp as usePromise,
