...
var Ii = (t, e, r) => e in t ? $i(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Kt = (t, e, r) => Ii(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Me, e as Oe, f as $e, h as xe, i as Ai, k as Pi, j as Vi, E as ji, l as Ua, r as pe, X as Li, m as cn, n as Qr, o as ta, L as Nt, R as Ka, p as qr, D as Na, q as Ca, s as Ea, t as Ta, T as ln, u as Vr, v as Pt, w as qa, x as Vt, y as jt, z as Lt, F as dn, G as Ga, H as Ge, I as kr, J as Ie, K as Ae, M as Pe, S as _r, N as er, O as Bi, Q as Er, U as Ye, V as ze, Z as Xe, W as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as wn, a3 as Fi, a4 as Ui, a5 as Ki, a6 as za, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Gi, ac as Hi, ad as Yi, ae as hn, af as Wi, ag as ca, ah as bo, ai as la, aj as Xi, ak as Ji, al as Zi, am as Qi, an as ts, ao as Tr, ap as Xa, aq as es, ar as rs } from "./resizable-BXTCesWU.js";
import { as as ag, at as og, au as ng, av as ig, aw as sg, ax as cg, ay as lg, az as dg, aA as wg, aB as ug, aC as pg, aD as hg, aE as gg, aF as fg, aG as mg, aH as vg, aI as bg, aJ as xg, aK as yg, aL as kg, aM as _g, aN as Ng, aO as Cg, aP as Eg, aQ as Tg } from "./resizable-BXTCesWU.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Sa, ChevronRight as Ra, ArrowLeft as as, ArrowRight as os, ChevronDown as nr, BoldIcon as ns, ItalicIcon as is, X as Ja, AtSign as gn, Pencil as ss, Trash2 as cs, ArrowUp as fn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as us, FilterIcon as ps, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as mn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Ns, AlertCircle as Da, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Rs, ChevronsUpDown as Ds, MenuIcon as Ms, Menu as Os, EllipsisVertical as $s, MoreVertical as Is } from "lucide-react";
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as yn, formatBytes as Vs, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as _o, compareScrRefs as Ma, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as No, formatReplacementStringToArray as Co, collectUsjMarkers as Us } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Qa, useContext as kn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as _n, useId as To, Fragment as ra } from "react";
import { IconSelector as Nn, IconCheck as aa, IconChevronDown as Hs, IconChevronUp as Ys, IconLayoutSidebar as Ws, IconLayoutSidebarRight as Xs, IconChevronRight as Cn, IconSearch as Js, IconLoader as Zs, IconAlertOctagon as Qs, IconAlertTriangle as tc, IconInfoCircle as ec, IconCircleCheck as rc } from "@tabler/icons-react";
import { createEditor as En, $getRoot as Re, $createParagraphNode as zr, $getSelection as Xt, HISTORY_MERGE_TAG as to, ParagraphNode as Tn, TextNode as zn, $getPreviousSelection as ac, $isRangeSelection as we, $caretFromPoint as oc, $getSiblingCaret as Sn, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as zo, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Rn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as gc, defineExtension as re, safeCast as Je, createState as fc, FORMAT_TEXT_COMMAND as Mn, $isNodeSelection as On, COMMAND_PRIORITY_LOW as $n, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as Oa, $getState as zc, toggleTextFormatType as So, TEXT_TYPE_TO_FORMAT as Sc, $setState as Rc, addClassNamesToElement as In, $create as Dc, $getNodeByKey as Mc, removeClassNamesFromElement as Oc, KEY_TAB_COMMAND as $c, $isBlockElementNode as Ic, $createRangeSelection as Ac, $normalizeSelection__EXPERIMENTAL as Pc, OUTDENT_CONTENT_COMMAND as Vc, INDENT_CONTENT_COMMAND as Ro, INSERT_TAB_COMMAND as jc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Lc, $isParagraphNode as Bc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as An, $insertNodes as Fc } from "lexical";
...
import { Avatar as ao, Select as Gt, Checkbox as Do, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Mo, Slider as Mr, Switch as Oo } from "radix-ui";
import { useReactTable as Vn, getFilteredRowModel as Jc, getSortedRowModel as jn, getPaginationRowModel as Zc, getCoreRowModel as Ln, flexRender as xr, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Or, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
function pa({
  ...
  const { otLong: pt, ntLong: gt, dcLong: Ot, extraLong: zt } = {
    ...
    (x) => {
      var me, Ne, Fe;
      if (x.ctrlKey) return;
      const { isLetter: G, isDigit: rt } = Io(x.key);
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = qn ? Qt : H, Ir = { tag: to };
function ml({ initialConfig: t, children: e }) {
  const r = D(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = gl(null, o), w = En({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = Gn && "documentMode" in document ? document.documentMode : null;
!(!Gn || !("InputEvent" in window) || zl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
    ...
    w.read(() => {
      ...
      if ((z || I) && M !== null && B !== null) {
        const A = function(C, P, U, k, J, j, Y) {
          ...
          return T.setStart(...jo(P, U, k)), T.setEnd(...jo(J, j, Y)), T;
        }(t, h, f, M, g, E, B);
        l(), l = Rl(t, A, e);
      }
...
function Al(t, e, r) {
  ...
  return uc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), zo(Sn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Xt();
  if (!we(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Rn(i, (d) => Nr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
qt.prototype.brand = Vl, qt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Wn(this), Fo(this), be++;
  const t = nt;
...
re({ build: (t, e, r) => wr(e), config: Je({ $onClear: Xn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Xt();
  if (On(n) || we(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function Qn(t, e) {
  let r;
...
const ja = re({ build: (t) => Qn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, La = 1, ei = 2, ma = 3, Ar = 4, Qe = 5, va = 6, mr = 7;
function ba(t) {
  return t.id === so;
}
function ri(t) {
...
function ql(t) {
  return function(e) {
    return e.id === La;
  }(t) || lt(305, String(t.id), String(La)), Object.assign(t, { id: ei });
}
...
const Wl = re({ config: Je({ setOptions: Uo, updateOptions: Uo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [mc, zn, vc, bc, Tn] }), Ko = Symbol.for("@lexical/extension/LexicalBuilder");
function qo() {
}
function Xl(t) {
  throw t;
...
const Jl = /* @__PURE__ */ new Set(), Go = re({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Qn(() => {
  }, () => ue(() => {
...
re({ dependencies: [ja, Go], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Go).output, n = Cr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ye(t.registerCommand(Zl, (s) => {
    ...
    if (_c(s.target)) {
      ...
      if (td(c)) return function(l, d = !1) {
        ...
        let g;
        d && On(w) ? g = w : (g = Cc(), Ec(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
re({ build: (t, e, r) => wr(e), config: Je({ $canIndent: ai, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
re({ build: (t, e, r) => wr(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ue(() => r.getOutput().disabled.value ? void 0 : ni(t)) });
function id(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function mi({
  ...
  const [k, J] = _(Zo), [j, Y] = _(), [T, $] = _(), W = o, [Z, Dt] = _(!1), [Tt, Bt] = _(!1), [K, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(M), [Mt, Ft] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  const Zt = D(() => Ct[0], [Ct]), _e = F(null), te = F(void 0), V = L(() => {
    var S;
    (S = te.current) == null || S.call(te), J(Zo);
  }, []), Q = L(() => {
    const S = !ut;
...
function Vd({
  ...
  const [s, c] = _("accept"), l = To(), d = To(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => Ur(t.acceptedText ?? ""),
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Ud, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(mi, { ...W })
          },
          $.id
        );
      })
...
function Wd({
  ...
  var z;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, E] = _({}), y = D(() => e ?? [], [e]), N = Vn({
    data: y,
    columns: t,
    getCoreRowModel: Ln(),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(q, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(mn, {}) })
        ] }),
...
function up({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    ...
    /* @__PURE__ */ a(Pe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(wn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ze,
        {
          checked: o[w][h],
...
function fp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [M, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [P, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
    ...
    Sw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Mw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Ow, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ce = "scrBook", Pw = "scrRef", qe = "source", Vw = "details", jw = "Scripture Reference", Lw = "Scripture Book", yi = "Type", Bw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, nn = (t) => `${Uw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Bp({
  sources: t,
  ...
  H(() => {
    if (c) {
      ...
      if (P.length === 1) {
        const U = b.find((k) => nn(k) === P[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Lw, N = i ?? yi, M = [
  ...
  }, I = (C, P) => C.getIsGrouped() ? "" : m("banded-row", P % 2 === 0 ? "even" : "odd"), A = (C, P, U) => {
                ...
                Object.values(dt).map((k, J) => {
                  ...
                  if (j.length !== 0)
                    return /* @__PURE__ */ u(ra, { children: [
                      ...
                      J < Object.values(dt).length - 1 && /* @__PURE__ */ a(pn, {})
                    ] }, k);
                })
              ] })
            ]
...
function qw({
  ...
  const i = ho(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    q,
    {
      variant: "outline",
...
function Gw({
  ...
  const i = o["%webView_book_selector_more%"], s = D(
    ...
    (l) => {
      const d = ho(s, l).map((w) => w);
      r(
        _i(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
...
function Up({
  ...
  const M = St(
    ...
    [r, n, f, i]
  ), ot = tt.find((O) => O.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((O) => O.toUpperCase()).join(", ") : t === "range" ? Fs(at, mt, {
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Ue = 200, [Di, Mi] = _(!1);
  H(() => {
  ...
  }, []), vo = (O) => t === O ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Se, { className: "tw:h-4 tw:w-4" }) }) : void 0;
      ...
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: _t, children: [
          ...
          /* @__PURE__ */ u(bo, { children: [
            ...
            /* @__PURE__ */ a(q, { onClick: fo, children: W })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && pt && /* @__PURE__ */ a(Na, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: Et, children: [
          ...
          /* @__PURE__ */ u(bo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Z }),
            /* @__PURE__ */ a(q, { ref: Zt, onClick: fo, children: W })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[No(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Pe, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Pt, { children: Ci(e.groups, e.items, l, t) }) }),
