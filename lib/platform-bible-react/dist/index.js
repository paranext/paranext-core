...
import { useReactTable as Gn, getFilteredRowModel as Do, getSortedRowModel as Fn, getPaginationRowModel as Io, getCoreRowModel as Xn, flexRender as ae, getGroupedRowModel as Oo, getExpandedRowModel as Ao } from "@tanstack/react-table";
...
const Go = vt.Portal, Yn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Overlay,
  {
    ref: n,
    className: c(
...
Yn.displayName = vt.Overlay.displayName;
const Fo = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = tt();
...
Fo.displayName = vt.Content.displayName;
...
Xo.displayName = vt.Title.displayName;
const Ho = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Description,
  {
    ref: n,
...
Ho.displayName = vt.Description.displayName;
...
var Uo = Object.defineProperty, Yo = (t, e, n) => e in t ? Uo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, V = (t, e, n) => Yo(t, typeof e != "symbol" ? e + "" : e, n);
const Pt = [
  "GEN",
  "EXO",
  "LEV",
...
const rr = Ze(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Yt : "button", { className: c(aa({ variant: e, size: n, className: t })), ref: s, ...a })
);
I.displayName = "Button";
const Zt = se.Root, Qt = se.Trigger, Lt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = tt();
...
function la(t, e, n, o) {
  const a = L(() => {
    if (t.chapterNum > 1)
      ...
      if (u > 0) {
        const d = e[u - 1], p = Math.max(bt(d), 1);
        o({
          book: d,
          chapterNum: p,
          verseNum: 1
...
function In({
  ...
  if (t)
    return /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: bt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      $t,
      {
        value: `${t} ${It[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Ei({
  ...
  const d = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [$, W] = O(!1), B = nt(void 0), ot = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), Y = L(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
    ...
    (x) => {
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            at !== 0 && (xt = at > 1 ? at - 1 : Et);
            break;
          case "ArrowRight":
            at !== 0 && (xt = at < Et ? at + 1 : 1);
            break;
          case "ArrowUp":
            xt = at === 0 ? Et : Math.max(1, at - _n);
            break;
          case "ArrowDown":
            xt = at === 0 ? 1 : Math.min(Et, at + _n);
            break;
          default:
            return;
        }
        xt !== at && (x.preventDefault(), x.stopPropagation(), f(Xe(rt, a, xt)), setTimeout(() => {
  ...
  return Sn(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && pt.current && _.current) {
        const P = pt.current, J = _.current, rt = J.offsetTop, at = P.clientHeight, Et = J.clientHeight, xt = rt - at / 2 + Et / 2;
        P.scrollTo({
          top: Math.max(0, xt),
          behavior: "smooth"
        }), f(Xe(t.book));
      ...
      qt,
      {
        ...
        children: [
          ...
          !$ && /* @__PURE__ */ l(Jt, { ref: pt, children: [
            v === "books" && /* @__PURE__ */ l(Nt, { children: [
              ...
              k && bt(k.book) > 1 && /* @__PURE__ */ l(Nt, { children: [
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Bn.Root, { ref: n, className: c("pr-twp", da(), t), ...e }));
    ...
    wn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: o.map((v) => j.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
}), or = G.Trigger, ar = G.Group, ua = G.Portal, ha = G.Sub, fa = G.RadioGroup;
...
function ba({ table: t }) {
  return /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(Po, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = U.Root, va = U.Group, Ht = U.Value, xa = Tt(
...
ya.displayName = U.Label.displayName;
...
Na.displayName = U.Separator.displayName;
function ka({ table: t }) {
...
const _a = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
...
function Ii({ id: t, markdown: e, className: n, anchorTarget: o }) {
  const a = H(
    () => ({
      overrides: {
        a: {
...
function Pi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(dn, { children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(ar, { children: d.itemType === 0 ? /* @__PURE__ */ r(Nt, { children: d.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        cn,
        {
          checked: o[p][h],
...
function Pa({
  ...
  const [h, f] = O(!1), b = L(
    ...
    const S = t.filter((C) => C.starred).sort((C, $) => C.label.localeCompare($.label)), N = t.filter((C) => !C.starred).sort((C, $) => {
      const W = n.includes(C.value), B = n.includes($.value);
      return W && !B ? -1 : !W && B ? 1 : C.label.localeCompare($.label);
    });
    return [...S, ...N];
  }, [t, n, u]);
...
function ja({
  ...
  const u = o ? /* @__PURE__ */ r("span", { className: Ue, children: `\\${t.marker} ` }) : void 0, d = o ? /* @__PURE__ */ r("span", { className: Ue, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(Nt, { children: [
  ...
  return /* @__PURE__ */ l(Nt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: w && w.length > 0 && /* @__PURE__ */ l(Nt, { children: [
          Ye(t.marker, w, o, !0),
          d
        ] })
      }
...
function Li({
  ...
  const p = d ? Xa(d, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Vo(e, void 0), h = (f) => {
    u && u(f);
  };
  return /* @__PURE__ */ l(Nt, { children: [
  ...
  return /* @__PURE__ */ l(Ce, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Se, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      St,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ut, { children: `${j.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
), Ua = m.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Hn.Root,
  {
    ref: a,
...
Ua.displayName = Hn.Root.displayName;
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(uo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fo, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Bi = (t) => ({
  ...
  return e ? e[1] : "";
}, Ka = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Yi = Object.freeze([
...
function Ki({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), h = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), b = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), v = yt(n, "%webView_inventory_scope_verse%"), S = yt(n, "%webView_inventory_filter_text%"), N = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, $] = O(!1), [W, B] = O("all"), [ot, pt] = O(""), [_, E] = O([]), Y = H(() => t.length === 0 ? [] : Ja(t, a, s), [t, a, s]), A = H(() => {
    if (C) return Y;
    const T = [];
    return Y.forEach((Z) => {
...
const Wa = "16rem", Za = "3rem", fr = m.createContext(void 0);
function Ee() {
...
const Qa = m.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Ee();
  return /* @__PURE__ */ l(
    I,
    {
...
const as = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: o,
...
const is = m.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: a,
...
const ls = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const ps = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Yt : "a",
  {
    ref: s,
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? j.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === _t ? Bt(a.start) : void 0;
      },
...
}, zn = (t) => `${xs({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ji({
  sources: t,
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(va, { children: $.map((_) => /* @__PURE__ */ r(mt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ l(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r(je, {})),
                          " ",
...
function Ns({
  ...
  const B = H(() => j.allBookIds.filter(
    ...
    (R, et = !1) => {
      ...
      const k = B.findIndex((q) => q === $.current), K = B.findIndex((q) => q === R);
      if (k === -1 || K === -1) return;
      const [ft, T] = [
        Math.min(k, K),
        Math.max(k, K)
    ...
    (R) => {
      ...
      n(
        _r(B, R, e) ? e.filter((k) => !et.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, n, B]
  ), A = () => {
...
const Ss = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
...
const Rs = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ht();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
function ww({
  ...
  return /* @__PURE__ */ l("div", { id: u, className: c("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(Q, { className: "tw-text-muted-foreground", children: Mo(d, {
...
const Ds = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
const Ps = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
zs.displayName = Kt.Root.displayName;
...
js.displayName = Kt.Image.displayName;
...
const cw = X.Root, pw = X.Trigger, mw = X.Group, uw = X.Portal, hw = X.Sub, fw = X.RadioGroup, Ls = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
const Gs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: c(
...
const Xs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  X.CheckboxItem,
  {
    ref: a,
    className: c(
...
const Hs = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ref: o,
    className: c(
...
Ys.displayName = X.Separator.displayName;
...
const gw = ut.Trigger, Js = ut.Portal, bw = ut.Close, Br = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
...
const Ws = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = m.useContext(Lr), i = {
...
const ni = m.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: o,
    className: c(
...
ni.displayName = Ge.Root.displayName;
function vw({ ...t }) {
  return /* @__PURE__ */ r(
    $o,
    {
...
const xw = wt.Root, ai = m.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
...
ai.displayName = wt.List.displayName;
...
si.displayName = wt.Trigger.displayName;
...
ii.displayName = wt.Content.displayName;
const wi = m.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: c(
...
const di = (t, e, n = {}) => {
  ...
  const a = nt(null), [s, i] = O(void 0), [w, u] = O(void 0), d = L(
    (h) => {
      i(h);
...
export {
  ...
  ja as FootnoteItem,
  Li as FootnoteList,
  Yi as INVENTORY_STRING_KEYS,
  pe as Input,
  Ki as Inventory,
  Q as Label,
  Ii as MarkdownRenderer,
  zi as MoreInfo,
