...
var qt = (t, e, r) => is(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as we, a as Er, C as Le, L as $n, u as Ko, T as Mt, b as Nt, d as Ct, e as Et, A as la, D as Se, f as me, h as Re, i as mr, j as ze, B as J, x as ss, k as cs, l as ls, I as ds, m as fo, n as $e, r as xe, Z as ws, o as An, P as Xe, p as vr, q as Je, s as Ze, t as va, v as ba, w as mo, y as Qe, z as xa, E as Dt, R as vo, F as da, G as Xa, H as Ja, J as Za, K as Qa, M as Vn, N as Qr, O as bo, Q as Dr, S as Mr, U as lr, V as us, W as We, X as Pe, Y as tr, _ as Oe, $ as dr, a0 as xo, a1 as yo, a2 as wa, a3 as ko, a4 as Ln, a5 as ps, a6 as hs, a7 as gs, a8 as to, a9 as jn, aa as ya, ab as fs, ac as Bn, ad as ms, ae as vs, af as bs, ag as Ho, ah as xs, ai as ys, aj as ks, ak as _s, al as Fn, am as Un, an as _o, ao as Ns, ap as Kn, aq as Ia, ar as qo, as as Pa, at as Cs, au as Es, av as Ts, aw as Ss, ax as Rs, ay as Ir, az as No, aA as Ds, aB as Ms } from "./resizable-CIsSKl14.js";
import { aC as Qg, aD as tf, aE as ef, aF as rf, aG as af, aH as of, aI as nf, aJ as sf, aK as cf, aL as lf, aM as df, aN as wf, aO as uf, aP as pf, aQ as hf, aR as gf, aS as ff, aT as mf, aU as vf, aV as bf, aW as xf, aX as yf, aY as kf, aZ as _f } from "./resizable-CIsSKl14.js";
import { jsx as a, jsxs as u, Fragment as wt } from "react/jsx-runtime";
import { Canon as At } from "@sillsdev/scripture";
import { Check as Ae, Clock as Go, ChevronsLeft as Wo, ChevronsRight as Yo, ChevronUp as Hn, ChevronDown as Ye, ArrowLeft as zs, ArrowRight as Os, BoldIcon as Is, ItalicIcon as Ps, X as Co, AtSign as qn, Pencil as $s, Trash2 as As, ArrowUp as Gn, MoreHorizontal as Vs, MailOpen as Ls, Mail as js, FilterIcon as Bs, ArrowLeftIcon as Fs, ChevronLeftIcon as Us, ChevronRightIcon as Ks, ArrowRightIcon as Hs, Copy as Wn, Filter as qs, User as Gs, Link as Ws, CircleHelp as Ys, Undo as Xs, Redo as Js, SquareX as Yn, FunctionSquare as Xn, SquareSigma as Jn, Ban as Zs, AlertCircle as eo, CircleCheckIcon as Qs, CircleXIcon as tc, CircleHelpIcon as ec, ArrowUpIcon as rc, ArrowDownIcon as ac, ScrollText as oc, ChevronRight as nc, ChevronLeft as ic, ChevronsUpDown as sc, MenuIcon as cc, Menu as lc, EllipsisVertical as dc, MoreVertical as wc } from "lucide-react";
import { Section as Rt, getChaptersForBook as uc, formatScrRef as Ce, formatReplacementString as Ie, getSectionForBook as ta, formatRelativeDate as pc, sanitizeHtml as Eo, NumberFormat as Zn, formatBytes as hc, getCurrentLocale as gc, usfmMarkers as ea, isPlatformError as fc, ABORTED as mc, getErrorMessage as vc, getFormatCallerFunction as bc, deepEqual as xc, isString as Xo, compareScrRefs as ro, scrRefToBBBCCCVVV as $a, defaultScrRef as Aa, formatScrRefRange as yc, getLocalizeKeyForScrollGroupId as Jo, formatReplacementStringToArray as Zo, collectUsjMarkers as kc } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as A, createContext as ka, useContext as To, useState as _, useEffect as G, useCallback as j, useImperativeHandle as _c, useLayoutEffect as Yt, Fragment as Pr, Component as Nc, createElement as Qo, Suspense as Cc, forwardRef as Qn, useId as tn } from "react";
import { IconSelector as ti, IconCheck as _a, IconChevronDown as Ec, IconChevronUp as Tc, IconLayoutSidebar as Sc, IconLayoutSidebarRight as Rc, IconChevronRight as ei, IconSearch as Dc, IconLoader as Mc, IconAlertOctagon as zc, IconAlertTriangle as Oc, IconInfoCircle as Ic, IconCircleCheck as Pc } from "@tabler/icons-react";
import { createEditor as ri, $getRoot as Ve, $createParagraphNode as $r, $getSelection as re, HISTORY_MERGE_TAG as So, ParagraphNode as ai, TextNode as oi, $getPreviousSelection as $c, $isRangeSelection as ve, $caretFromPoint as Ac, $getSiblingCaret as ni, $getChildCaret as Vc, $getAdjacentChildCaret as Lc, $isChildCaret as jc, $normalizeCaret as Bc, $setSelectionFromCaretRange as Fc, $getCollapsedCaretRange as Uc, $getCaretInDirection as en, $splitAtPointCaretNext as Kc, $isTextPointCaret as Hc, $findMatchingParent as ii, $isElementNode as zr, mergeRegister as Te, getDOMTextNode as qc, isHTMLElement as Gc, CLEAR_EDITOR_COMMAND as si, COMMAND_PRIORITY_EDITOR as Ro, shallowMergeConfig as Wc, defineExtension as ce, safeCast as er, createState as Yc, FORMAT_TEXT_COMMAND as ci, $isNodeSelection as li, COMMAND_PRIORITY_LOW as di, RootNode as Xc, LineBreakNode as Jc, TabNode as Zc, $isEditorState as Qc, createCommand as tl, CLICK_COMMAND as el, isDOMNode as rl, $getNodeFromDOMNode as al, $createNodeSelection as ol, $setSelection as nl, $getEditor as il, DecoratorNode as ao, $getState as sl, toggleTextFormatType as rn, TEXT_TYPE_TO_FORMAT as cl, $setState as ll, addClassNamesToElement as wi, $create as dl, $getNodeByKey as wl, removeClassNamesFromElement as ul, KEY_TAB_COMMAND as pl, $isBlockElementNode as hl, $createRangeSelection as gl, $normalizeSelection__EXPERIMENTAL as fl, OUTDENT_CONTENT_COMMAND as ml, INDENT_CONTENT_COMMAND as an, INSERT_TAB_COMMAND as vl, COMMAND_PRIORITY_CRITICAL as Do, $isDecoratorNode as bl, $isParagraphNode as xl, $isTextNode as oo, SELECTION_CHANGE_COMMAND as ui, $insertNodes as yl } from "lexical";
...
import { Avatar as Mo, Select as Xt, Checkbox as on, Slot as Ar, Tabs as pe, Menubar as ye, ContextMenu as Vt, Progress as nn, Slider as qr, Switch as sn } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as no, HIDDEN_NOTE_CALLER as io, getDefaultViewOptions as Pl, isInsertEmbedOpOfType as _r, getMarkerMenuItems as $l, defaultStyleInfo as Al, Editorial as Vl } from "@eten-tech-foundation/platform-editor";
...
let so = "keyboard", ln = !1;
function Hl() {
  ln || typeof document > "u" || (ln = !0, document.addEventListener(
    "pointerdown",
    () => {
      so = "pointer";
    },
...
function ql({
  ...
  G(() => {
    ...
    if (!Q) return;
    const I = (q) => !!q && q.scrollWidth > q.clientWidth, et = () => {
      so !== "pointer" && (T || I(h.current) || I(l.current)) && N(!0);
    }, C = () => N(!1);
...
function Fp(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
...
const oa = {
  ...
  oa.BOOK_ONLY,
  oa.BOOK_CHAPTER,
  oa.BOOK_CHAPTER_VERSE
];
function Jl(t) {
  return oa.BOOK_CHAPTER_VERSE.test(t.trim());
}
function dn(t, e) {
  ...
  const o = Xl.reduce(
    (n, s) => {
      ...
      if (i) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(la).find(
            (y) => la[y].toLowerCase() === f.toLowerCase()
          ))(c);
...
function td(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : At.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), i = lo(s), c = Object.values(i).flat(), l = lo(t);
  return {
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        style: { gridTemplateColumns: `repeat(${vi}, minmax(0, 1fr))` },
...
function La({
  ...
  const B = xe(), V = Kl(), z = T ?? V, [H, W] = _(!1), [L, Q] = _(""), [I, et] = _(""), [C, M] = _("books"), [q, nt] = _(void 0), [ot, pt] = _(
    void 0
    ...
    () => td(Tt, jt),
    [Tt, jt]
  ), ne = Kt.has(t.book), Qt = A(() => I.trim() ? lo(
    Ut.filter((v) => fo(v, I, s))
  ) : ft ? de : le, [
    le,
    de,
    Ut,
    ...
    if (!R) return;
    const v = L.startsWith(`${R.book} `) ? L : "", X = Wr(v), at = Gr(v);
    return {
      book: R.book,
  ...
  const Ot = j(() => {
    ...
    (v) => {
      const X = C === "chapters" ? q : R == null ? void 0 : R.book;
      if (X) {
        if (w && w(X, v) > 1) {
          pt(X), Z(v), M("verses"), Q("");
          return;
  ...
  const { otLong: ht, ntLong: kt, dcLong: St, extraLong: Pt } = {
    ...
    () => z >= ra.TIGHT ? Er(t.book, s) : we(t.book, s),
    [t.book, s, z]
  ), Sa = `${t.chapterNum}:${t.verseNum}`, Ra = j((v) => (X) => {
    zt.current[v] = X;
  }, []), Lr = j((v) => (X) => {
    Ft.current[v] = X;
  }, []), xr = A(
    () => Jl(I),
    [I]
  ), he = A(() => !w || !R || !R.chapterNum || !xr ? !1 : w(R.book, R.chapterNum) > 0, [w, R, xr]), yr = C === "books" && !ct && !I.trim() && Kt.size > 0, jr = j(
    (v) => p ? dn(v, p) : !1,
    [p]
  ), Ne = j(
    (v) => (X) => p ? Zl(v, X, p) : !1,
    ...
    (v, X) => (at) => p ? Va(v, X, at, p) : !1,
    [p]
  ), Ue = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", Br = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) || "Select verse", Ke = C === "verses" ? (i == null ? void 0 : i["%webView_bookChapterControl_backToChapters%"]) || "Back to chapters" : (i == null ? void 0 : i["%webView_bookChapterControl_backToBooks%"]) || "Back to books", Da = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", Fr = (i == null ? void 0 : i["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", Ma = j(
    (v) => Ie(Fr, {
      book: `${we(v, s)} (${Er(
        v,
        s
    ...
    [Fr, s]
  ), za = (i == null ? void 0 : i["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", Ur = (i == null ? void 0 : i["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", Kr = j(
    (v) => {
    ...
    (v) => {
      var ir;
      if (v.ctrlKey) return;
      const { isLetter: X, isDigit: at } = cn(v.key);
      if ((C === "chapters" || C === "verses") && (v.key === " " || v.key === "Enter")) {
        ...
        const _t = (() => {
          if (C === "verses") {
            const Fo = ot, Uo = st, Oa = Wr(L);
            return !Fo || !Uo || Oa === void 0 ? void 0 : {
              isDisabled: ar(Fo, Uo)(Oa),
              activate: () => ae(Oa)
            };
          }
          const It = q, kr = Gr(L);
      ...
      if (v.key === "Backspace" && (C === "chapters" || C === "verses")) {
        v.preventDefault(), v.stopPropagation(), C === "verses" ? K() : x();
        return;
      }
      if (!Ul(v.key)) return;
      const xt = (() => {
        ...
        if (C === "chapters" || C === "books" && R && Me(R.book) > 1) {
          const _t = C === "chapters" ? q : R == null ? void 0 : R.book;
          return _t ? {
            max: Me(_t),
            current: Gr(L) ?? 0,
  ...
  Yt(() => {
    ...
    if (C === "chapters" && q) {
      const v = q === t.book, X = v ? t.chapterNum : 1;
      Q(Sr(q, X)), setTimeout(() => {
        if (bt.current)
          if (v) {
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            ql,
            {
              primary: Fe,
              secondary: Sa,
              showSecondary: z < ra.MINIMUM,
              isPartial: z >= ra.TIGHT,
              fullText: rr
            }
          ),
          y && /* @__PURE__ */ a(
          ...
          Ze,
          {
            ...
            children: [
              C === "books" ? /* @__PURE__ */ u("div", { className: m("tw:flex tw:items-end", ct && "tw:pb-1"), children: [
                ...
                /* @__PURE__ */ a(ba, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Y.map(
                  ({ onClick: v, disabled: X, title: at, icon: xt, group: te }, ie) => /* @__PURE__ */ u(Pr, { children: [
                    ie > 0 && te !== Y[ie - 1].group && /* @__PURE__ */ a(mo, {}),
                ...
                C === "chapters" && q && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: we(q, s) }),
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a($e, { heading: oe(v), children: X.map((at) => /* @__PURE__ */ a(
                          mi,
                          {
                            ...
                            localizedBookNames: s,
                            disabled: jr(at),
                            dimmedReason: Kt.has(at) ? Da : void 0,
                            dimmedDescription: Kt.has(at) ? Ma(at) : void 0
                          },
                          at
                        )) }, v)
                      );
...
var wo = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(wo || {});
((t) => {
...
function Hp({
  ...
  const w = ja(d, "%webView_bookSelector_currentBook%"), p = ja(d, "%webView_bookSelector_choose%"), h = ja(d, "%webView_bookSelector_chooseBooks%"), [g, f] = _(
    "current book"
    /* CurrentBook */
  ), y = (b) => {
    f(b), t(b);
...
const yi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, id = yi ? Yt : G, Xr = { tag: So };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          case "string": {
            ...
            p.setEditorState(g, Xr);
            break;
          }
          case "object":
            p.setEditorState(h, Xr);
            break;
          case "function":
            p.update(() => {
              Ve().isEmpty() && h(p);
...
const cd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function ld({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return cd(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: s, dirtyLeaves: i, prevEditorState: c, tags: l }) => {
      e && s.size === 0 && i.size === 0 || t && l.has(So) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const Oo = {
...
const hd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function gd(t) {
    ...
    w.read(() => {
      ...
      if ((T || B) && E !== null && P !== null) {
        const V = function(z, H, W, L, Q, I, et) {
          ...
          return C.setStart(...hn(H, W, L)), C.setEnd(...hn(Q, I, et)), C;
        }(t, h, f, E, g, D, P);
        l(), l = xd(t, V, e);
      }
...
function Cd(t) {
  ...
  if (ve(e)) r = Ac(e.focus, "next");
    ...
    r = r || Vc(Ve(), "previous").getFlipped().insert($r());
  }
...
function Ed(t, e, r) {
  ...
  return Hc(o) && ua(283), o.insert(t.isInline() ? $r().append(t) : t), en(ni(t.getLatest(), "next"), e.direction);
}
function Td(t) {
  const e = re();
  if (!ve(e)) return !1;
...
function Ca() {
  ...
  for (!function() {
    let r = pa;
    for (pa = void 0; r !== void 0; ) r.S.v === r.v && (r.S.i = r.i), r = r.o;
  }(); Rr !== void 0; ) {
    let r = Rr;
    for (Rr = void 0, ha++; r !== void 0; ) {
      const o = r.u;
...
let pa, Ee = 0, ha = 0, Dd = 0, uo = 0, na = 0;
function fn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function qe(t, e) {
  Gt.call(this, void 0), this.x = t, this.s = void 0, this.g = na - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Md(t, e) {
  return new qe(t, e);
}
...
function zd(t) {
  ...
  Ni(this), it = t, this.f &= -2, 8 & this.f && Po(this), Ca();
}
function cr(t, e) {
...
Gt.prototype.brand = Sd, Gt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    if (ha > 100) throw new Error("Cycle detected");
    (function(e) {
      Ee !== 0 && ha === 0 && e.l !== uo && (e.l = uo, pa = { S: e, v: e.v, i: e.i, o: pa });
    })(this), this.v = t, this.i++, na++, Ee++;
    try {
...
} }), qe.prototype = new Gt(), qe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === na)) return !0;
  if (this.g = na, this.f |= 1, this.i > 0 && !_i(this)) return this.f &= -2, !0;
  const t = it;
  try {
    mn(this), it = this;
    const e = this.x();
...
function Ti(t, e = Ei) {
  return t.registerCommand(si, (r) => (t.update(e), !0), Ro);
}
...
const Fa = Yc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Si extends ao {
  $config() {
    return this.config("decorator-text", { extends: ao, stateConfigs: [{ flat: !0, stateConfig: Fa }] });
  }
  getFormat() {
    return sl(this, Fa);
  }
...
const po = ce({ build: (t) => Ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const $o = 0, ho = 1, Mi = 2, Ua = 3, Jr = 4, sr = 5, Ka = 6, Nr = 7;
function Ha(t) {
  return t.id === $o;
}
function zi(t) {
...
function Pd(t) {
  return function(e) {
    return e.id === ho;
  }(t) || ut(305, String(t.id), String(ho)), Object.assign(t, { id: Mi });
}
...
class Ad {
  constructor(e, r) {
    ...
    qt(this, "state");
    qt(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: $o };
  }
  mergeConfigs() {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(c, l, d) {
      return Object.assign(c, { config: l, id: Ua, registerState: d });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Jr && ut(307, String(r.id), String(sr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ka && ut(310, String(r.id), String(Ka)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ua;
    }(e) || ut(314, String(e.id), String(Ua)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Ld = ce({ config: er({ setOptions: vn, updateOptions: vn }), init: ({ $initialEditorState: t = Vd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Xc, oi, Jc, Zc, ai] }), bn = Symbol.for("@lexical/extension/LexicalBuilder");
function xn() {
}
function jd(t) {
  throw t;
...
class wr {
  ...
  static fromExtensions(e) {
    const r = [Zr(Ld)];
    for (const o of e) r.push(Zr(o));
    return new wr(r);
  }
  static maybeFromEditor(e) {
    const r = e[bn];
    return r && (r.PACKAGE_VERSION !== qa && ut(292, r.PACKAGE_VERSION, qa), r instanceof wr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ha(s) || ut(300, i, n || "[unknown]"), Ha(c = s) || ut(304, String(c.id), String($o)), s = Object.assign(c, { id: ho }), o.state = s;
    ...
    for (const o of this.extensionNameMap.values()) Ha(o.state) && r(o);
...
const Bd = /* @__PURE__ */ new Set(), yn = ce({ build(t, e, r) {
  const o = r.getDependency(po).output, n = Or({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ri(() => {
  }, () => be(() => {
...
}, dependencies: [po], name: "@lexical/extension/NodeSelection" }), Fd = tl("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends ao {
  static getType() {
...
ce({ dependencies: [po, yn], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(yn).output, n = Or({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
...
function Hd(t, e, r = Oi) {
  return Te(t.registerCommand(pl, (o) => {
    ...
    const s = function(i) {
      ...
      return !1;
    }(n) ? o.shiftKey ? ml : an : vl;
    return t.dispatchCommand(s, void 0);
  }, Ro), t.registerCommand(an, () => {
...
const qd = ce({ name: "@lexical/react/ReactProvider" });
function Gd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ve(f)) {
                ...
                if (oo(b) && d >= 0 && w >= 0 && (D = d, k = d + w, f.setTextNodeRange(b, D, b, k)), D === k && p === "" || (f.insertRawText(p), b = y.getNode()), oo(b)) {
                  D = h, k = h + g;
...
const Vo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function Jd({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, s] = _(() => r.getDecorators());
    return Vo(() => r.registerDecoratorListener((i) => {
      Cl(() => {
        s(i);
      });
    }), [r]), G(() => {
...
const rw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
function aw({ onClear: t }) {
  const [e] = ke();
  return rw(() => Ti(e, t), [e, t]), null;
}
const $i = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Yt : G;
...
function ww() {
  const [t, e] = _(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Xa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ja, { children: [
      /* @__PURE__ */ a(Za, { children: /* @__PURE__ */ a(Qa, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = j(
    (s, i, c = !1) => {
...
function hw() {
  ...
  return pw(o), /* @__PURE__ */ a(
    Vn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: Nn.map(({ format: n, icon: s, label: i }) => /* @__PURE__ */ a(
        Qr,
        {
          value: n,
          "aria-label": i,
...
function Fi({
  ...
  const i = Cn(o, "%cancelButton_tooltip%"), c = s ?? Cn(o, "%acceptButton_tooltip%");
...
const bw = "verseText", qp = Object.freeze([
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
      ...
      /* @__PURE__ */ a(vr, { asChild: !0, children: /* @__PURE__ */ u(
        J,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Ga(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        Je,
        {
          ...
          children: /* @__PURE__ */ a(Ze, { children: /* @__PURE__ */ a(Qe, { children: t.map((b) => /* @__PURE__ */ a(
            Le,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: Ga(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : jo(b) && (b.preventDefault(), b.stopPropagation(), se(s) && g());
        },
        onKeyDown: (b) => {
          Lo(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ga,
          {
...
function En({
  ...
  const g = j(
    ...
    [t.user]
  ), k = A(() => Eo(t.contents), [t.contents]), N = A(
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : jo(T) && (T.preventDefault(), T.stopPropagation(), se(w) && f());
              },
              onKeyDown: (T) => {
...
function Gi({
  ...
  const [L, Q] = _(Tn), [I, et] = _(), [C, M] = _(), q = o, [nt, ot] = _(!1), [pt, st] = _(!1), [Z, ct] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Zt] = _(E), [Lt, bt] = _(!1), Bt = F(void 0), [zt, Ft] = _(/* @__PURE__ */ new Map());
  G(() => {
    let x = !0;
    return (async () => {
  ...
  const jt = A(() => Tt[0], [Tt]), le = F(null), de = F(void 0), Ut = j(() => {
    var x;
    (x = de.current) == null || x.call(de), Q(Tn);
  }, []), Be = j(() => {
    const x = !vt;
  ...
  const S = j(
    ...
    async (x) => {
      const K = se(L) ? fa(L) : void 0, O = x.status ? x.assignedUser : I ?? x.assignedUser, rt = await p({
        ...x,
        contents: K,
        assignedUser: O
      });
          ...
          o && /* @__PURE__ */ u(wt, { children: [
            ...
            b !== !1 && (!pt || se(L)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  jo(x) && (x.preventDefault(), x.stopPropagation(), (se(L) || I !== void 0 && I !== C) && S());
                },
                onKeyDown: (x) => {
                  Lo(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ga,
                        ...
                        Je,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ze, { children: /* @__PURE__ */ a(Qe, { children: y == null ? void 0 : y.map((x) => /* @__PURE__ */ a(
                            Le,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: ia(x, r) })
                            },
                            x || "unassigned"
                          )) }) })
                        }
...
), Tw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), sa = (t) => Tw(Eo(t));
function ca({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Sw({
  ...
  const [i, c] = _("accept"), l = tn(), d = tn(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : i, y = A(
    () => sa(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = A(
    () => sa(t.acceptedText ?? ""),
    ...
    () => sa(t.mergedText ?? ""),
    [t.mergedText]
  ), k = A(() => Eo(t.contents), [t.contents]);
  if (!Ki(t))
    return /* @__PURE__ */ a(ca, { html: k });
  const N = (C) => {
  ...
  const H = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: H }), L = (C) => C ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: C }) : W, Q = () => {
    const C = o ?? "accept";
    return C === "merged" ? t.mergedText ? /* @__PURE__ */ a(ca, { html: D }) : W : L(C === "reject" ? t.rejectedResultText : t.resultText);
  }, I = (C) => p && C.value === "reject", et = (C) => {
    const M = f === C.value, q = `${d}-${C.value}`, nt = I(C);
    return (
...
function rh({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [E, P] = _(), [T, B] = _(), V = j(
    async (M) => {
      const q = await s(M);
      return q !== void 0 && M.assignedUser !== void 0 && M.assignedUser !== "" && B(M.assignedUser), q;
    },
    [s]
  );
  G(() => {
  ...
  const z = r.filter(
    ...
    (M) => {
      N((q) => new Set(q).add(M.id)), P(M.id), y == null || y(M.id);
    },
    [y]
  ), L = j(
    (M) => {
      ...
      children: z.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(Ow, { ...q, conflictResolution: D }) : /* @__PURE__ */ a(Gi, { ...q })
          },
          M.id
        );
      })
...
function ue({
  ...
  return /* @__PURE__ */ u(
    Xt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Xt.ItemIndicator, { children: /* @__PURE__ */ a(_a, { className: "tw:pointer-events-none" }) }) }),
...
function Lw({
  ...
  return l ? P = Array.from({ length: 10 }).map((z, H) => `skeleton-row-${H}`).map((z) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(dr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(lr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = N.getRowModel().rows) == null ? void 0 : T.length) > 0 ? P = N.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(xo, { stickyHeader: s, children: [
      /* @__PURE__ */ a(yo, { stickyHeader: s, children: N.getHeaderGroups().map((B) => /* @__PURE__ */ a(Oe, { children: B.headers.map((V) => /* @__PURE__ */ a(wa, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : Tr(V.column.columnDef.header, V.getContext()) }, V.id)) }, B.id)) }),
      /* @__PURE__ */ a(ko, { children: P })
    ] }),
...
function Bw({
  ...
  const n = Sn(r, "%webView_error_dump_header%"), s = Sn(r, "%webView_error_dump_info_message%");
  function i() {
...
function ch({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Se, { children: [
    /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ u(J, { variant: "default", children: [
      /* @__PURE__ */ a(qs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
...
function Hw({
  ...
  const l = bo(), d = Rn(n, "%undoButton_tooltip%"), w = Rn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(ba, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
        J,
      ...
      /* @__PURE__ */ a(Et, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(to, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(mo, {}),
    e && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
      ...
      /* @__PURE__ */ a(Et, { children: /* @__PURE__ */ u("p", { children: [
        ...
        s && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(to, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function qw({
  ...
  return G(() => {
    var l;
    const s = bo(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const Gw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(wt, { children: [
...
function Ww({
  ...
  return /* @__PURE__ */ u(Se, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(me, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: Gw(t, o, e) }) }) }),
...
function eu({
  ...
  return /* @__PURE__ */ u(Ze, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Qe, { children: [
      /* @__PURE__ */ a(xa, { children: t["%markerMenu_noResults%"] }),
...
function ru(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, i]) => {
    s.push(
      ...i.map((c) => ({
        marker: c,
        title: r[ea[c].description] ?? ea[c].description,
        action: () => {
          var l;
...
function uh({
  ...
  const [b, D] = _("generated"), [k, N] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [V, z] = _("f"), [H, W] = _(!1), [L, Q] = _(!0), [I, et] = _(!1), C = F(!1), M = F(""), [q, nt] = _(!1), [ot, pt] = _(), [st, Z] = _(), [ct, gt] = _(), [ft, mt] = _(), Jt = F(null), vt = F(
    void 0
  ...
  G(() => {
    ...
    if (x && _r("note", x)) {
      ...
      let dt = "custom";
      rt === no ? dt = "generated" : rt === io ? dt = "hidden" : rt && (P(rt), B(rt)), D(dt), N(dt), z(((O = x.insert.note) == null ? void 0 : O.style) ?? "f"), S = setTimeout(() => {
        var ht, kt, St;
  ...
  const Ft = j(
    ...
    (S, U) => {
      ...
      let x;
      S === "custom" ? x = U : S === "generated" ? x = no : x = io, Y.insert.note.caller !== x && (Y.insert.note.caller = x, (rt = h.current) == null || rt.applyUpdate([Y, { delete: 1 }]));
    },
    []
  ), Tt = j(() => {
    var S;
  ...
  const de = () => {
    ...
    (S, U, Y) => {
      ...
      vs({
        ...
        clearSessionIfCurrent: (O) => Ho(vt, O),
  ...
  G(() => {
    ...
    const U = (x) => {
      const K = S();
      !q && K && document.activeElement === K && x.key === c ? (x.preventDefault(), Qt()) : q && x.key === "Escape" && (x.preventDefault(), nt(!1));
    };
...
const ph = Object.freeze([
  ...Zw,
  ...Object.entries(ea).map(([, t]) => t.description).filter((t) => !!t),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(eo, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
...
function wu({
  ...
  return /* @__PURE__ */ u(xo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(yo, { stickyHeader: !0, children: /* @__PURE__ */ u(Oe, { children: [
      /* @__PURE__ */ a(wa, { children: n }),
      /* @__PURE__ */ a(wa, { children: s })
    ] }) }),
    /* @__PURE__ */ a(ko, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        onClick: () => {
          e(c.reference);
...
const uu = (t) => {
...
}, Ea = (t, e, r) => /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
  /* @__PURE__ */ u(
    Ct,
    {
  ...
  header: ({ column: e }) => Ea(e, t)
}), pu = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (r) => r.items[e],
  header: ({ column: r }) => Ea(r, t)
}), fh = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Ea(e, t, "tw:justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => Ea(s, t, "tw:justify-center"),
  cell: ({ row: s }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(Vn, { value: i, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Qr,
          {
            onClick: (l) => {
  ...
  return e ? e[1] : "";
}, hu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", yh = Object.freeze([
  ...
  const n = Xo(o.key) ? o.key : o.key[0];
  return {
...
function kh({
  ...
  }, [B, et]), M = A(() => C.length === 0 ? [] : gu(C, z, W), [C, z, W]), q = A(() => {
    var gt, ft;
    if (!B) return l;
...
function _h({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Ta();
  return /* @__PURE__ */ u(
    J,
    {
...
function Eu({
  ...
  const c = t ? Ar.Root : "button", { state: l } = Ta(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    xu,
    {
      ...
      children: /* @__PURE__ */ u(ku, { children: [
        /* @__PURE__ */ u(Mn, { children: [
          /* @__PURE__ */ a(zn, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(On, { children: /* @__PURE__ */ a(_u, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Nu, { children: /* @__PURE__ */ a(
            Eu,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(Mn, { children: [
          /* @__PURE__ */ a(zn, { className: "tw:text-sm", children: i }),
...
const De = "scrBook", Su = "scrRef", Ge = "source", Ru = "details", Du = "Scripture Reference", Mu = "Scripture Book", Xi = "Type", zu = "Details";
function Ou(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      sortingFn: (o, n) => ro(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
...
const Iu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || ro(t.start, t.end) === 0 ? `${$a(t.start)}+${e}` : `${$a(t.start)}+${e}-${$a(t.end)}+${r}`;
}, In = (t) => `${Iu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ah({
  sources: t,
  ...
  G(() => {
    if (c) {
      ...
      if (H.length === 1) {
        const W = y.find((L) => In(L) === H[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, y, c, D]);
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(xo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(yo, { children: D.getHeaderGroups().map((z) => /* @__PURE__ */ a(Oe, { children: z.headers.filter((H) => H.column.columnDef.header).map((H) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(wa, { colSpan: H.colSpan, className: "tw:sticky top-0", children: H.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(ko, { children: D.getRowModel().rows.map((z, H) => {
        const W = xe();
        return /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: z.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== Ge || !r)))
                return /* @__PURE__ */ a(
                  dr,
                  {
                    className: m(
...
function Pu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
    ...
    () => Object.values(Rt).filter(
      (I) => (s == null ? void 0 : s[I]) !== void 0 && _o(T, I).length === 0
...
function Vu({
  ...
  const i = _o(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    J,
    {
      variant: "outline",
      size: "sm",
...
function Lh({
  ...
  const P = $t(
  ...
  ] }), gt = e ? Z.filter(($) => e.includes($.value)) : Z, ft = y ?? Aa, mt = p ?? ft, Jt = h ?? ft, vt = () => {
  ...
  ), oe = Ft === "end", Vr = Ft === "start", rr = "tw:text-muted-foreground", Fe = w === "dropdown" && S === "range", Sa = Fe ? O : Be, Lr = Fe ? dt : f ? Kt : vt, xr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Zt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Dt, { htmlFor: "scope-range-end", className: m(Vr && rr), children: q }),
      /* @__PURE__ */ a(
        La,
        {
          id: "scope-range-end",
  ...
  const [Ne, ar] = _(null), [Ue, Br] = _(null), [Ke, Da] = _(null), Fr = 200, [Ma, za] = _(!1);
  G(() => {
    if (!Ke || typeof ResizeObserver > "u") return;
    const $ = new ResizeObserver(([tt]) => {
      za(tt.contentRect.width < Fr);
    });
  ...
  const Ur = j(
    ...
    var tt;
    $.preventDefault(), (tt = jr.current) == null || tt.focus();
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Se, { open: ae, onOpenChange: _e, children: [
        ...
        /* @__PURE__ */ a(
          Re,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ia, { container: Ke, children: [
                        ...
                        children: /* @__PURE__ */ a(
                          La,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(wt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(y ?? Aa, "id") }),
                              /* @__PURE__ */ a(Ye, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        vo,
        {
          ...
          children: gt.map(({ value: $, label: tt, scrRefSuffix: v, id: X }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(da, { className: "tw:me-2", value: $, id: X }),
    ...
    w === "radio" && t === "range" && xr,
    w === "dropdown" && Ht && /* @__PURE__ */ a(Xa, { open: S === "selectedBooks", onOpenChange: or, children: /* @__PURE__ */ a(
      Ja,
      {
        ref: Br,
        onCloseAutoFocus: Hr,
        ...
        children: /* @__PURE__ */ u(Ia, { container: Ue, children: [
          /* @__PURE__ */ a(Za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Qa, { children: L }) }),
          Pt,
          /* @__PURE__ */ u(qo, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => or(!1), children: ot }),
            /* @__PURE__ */ a(J, { onClick: Kr, children: nt })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Ot && /* @__PURE__ */ a(Xa, { open: S === "range", onOpenChange: or, children: /* @__PURE__ */ a(
      Ja,
      {
        ref: ar,
        onCloseAutoFocus: Hr,
        ...
        children: /* @__PURE__ */ u(Ia, { container: Ne, children: [
          /* @__PURE__ */ a(Za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Qa, { children: C }) }),
          xr,
          /* @__PURE__ */ u(qo, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => or(!1), children: ot }),
            /* @__PURE__ */ a(J, { ref: le, onClick: Kr, children: nt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: tr },
            children: t.map((w) => /* @__PURE__ */ a(ue, { value: `${w}`, children: l[Jo(w)] }, `${w}`))
          }
        )
      ]
    }
...
function go({
  ...
  return /* @__PURE__ */ u(Se, { variant: s, children: [
    ...
    /* @__PURE__ */ a(Re, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Pr, { children: [
...
const Ku = Object.freeze([520, 420, 340]), ts = Wt.forwardRef(
  ({ id: t, className: e, children: r, shrinkStep: o }, n) => {
    ...
    return /* @__PURE__ */ a(zo.Provider, { value: w, children: /* @__PURE__ */ a(
      "div",
      {
        ref: l,
    ...
    const c = e.filter((d) => d.group === s).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Ju,
        {
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(ma, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(ma, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
...
function rp({
  ...
  if (Ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(qu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Gu, { children: [
...
function eg({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function mg({
  ...
  return /* @__PURE__ */ u(
    Vt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Vt.ItemIndicator, { children: /* @__PURE__ */ a(_a, {}) }) }),
        e
      ]
    }
  );
...
function Cg({
  ...
  const n = xe();
  return /* @__PURE__ */ u(dp, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(wp, {}),
    /* @__PURE__ */ u(
      je.Content,
      {
...
function Bg({
  ...
  return /* @__PURE__ */ a(
    pe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", pp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  dg as ContextMenuPortal,
  ug as ContextMenuRadioGroup,
  vg as ContextMenuRadioItem,
  xg as ContextMenuSeparator,
  yg as ContextMenuShortcut,
  wg as ContextMenuSub,
  fg as ContextMenuSubContent,
  gg as ContextMenuSubTrigger,
  cg as ContextMenuTrigger,
  Lw as DataTable,
  Qh as DestructiveKeyConfirmation,
  Xa as Dialog,
  tf as DialogClose,
  Ja as DialogContent,
  ...
  lu as FootnoteItem,
  hh as FootnoteList,
  Xh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  ...
  uf as ResizablePanel,
  pf as ResizablePanelGroup,
  tg as ResultsCard,
  Vh as SCOPE_SELECTOR_STRING_KEYS,
  ...
  Fh as SettingsListItem,
  Tu as SettingsSidebar,
  $h as SettingsSidebarContentSearch,
  ...
  zn as SidebarGroupLabel,
  Eh as SidebarHeader,
  Ch as SidebarInput,
  yu as SidebarInset,
  _u as SidebarMenu,
  Dh as SidebarMenuAction,
  Mh as SidebarMenuBadge,
  Eu as SidebarMenuButton,
  Nu as SidebarMenuItem,
  zh as SidebarMenuSkeleton,
  Oh as SidebarMenuSub,
  Ph as SidebarMenuSubButton,
  Ih as SidebarMenuSubItem,
  bu as SidebarProvider,
  Nh as SidebarRail,
  Sh as SidebarSeparator,
  _h as SidebarTrigger,
  lr as Skeleton,
  Vg as Slider,
  Ag as Sonner,
  hf as Spinner,
  Lg as Switch,
  go as TabDropdownMenu,
  Hh as TabFloatingMenu,
  Kh as TabToolbar,
  xo as Table,
  ko as TableBody,
  gf as TableCaption,
  ...
  Ea as getInventoryHeader,
  vh as getLinesFromUSFM,
  bh as getNumberFromUSFM,
