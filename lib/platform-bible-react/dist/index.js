...
import S, { forwardRef as Qn, useCallback as Et, useState as ut, useRef as be, useEffect as se, useLayoutEffect as sa, useMemo as Ct } from "react";
...
import { ChevronRight as oi, Check as En, Circle as ai, X as lo, Search as ii, ChevronsUpDown as si, FilterIcon as rl, ChevronDown as tr, ChevronUp as ol, ArrowLeftIcon as al, ChevronLeftIcon as il, ChevronRightIcon as sl, ArrowRightIcon as ll, CircleCheckIcon as cl, CircleXIcon as dl, CircleHelpIcon as pl, ArrowUpIcon as ul, ArrowDownIcon as wl, ArrowUpDownIcon as fl, Star as ml, PanelLeft as hl, PanelRight as gl, ChevronLeft as bl, LoaderCircle as vl, Download as yl, Filter as xl, User as Nl, Link as kl, CircleHelp as El } from "lucide-react";
import { getChaptersForBook as Sl, deepEqual as co, substring as Tl, formatScrRef as Or, compareScrRefs as Ur, scrRefToBBBCCCVVV as Rr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Cl, formatBytes as Ol } from "platform-bible-utils";
...
const po = ft.Root, gi = ft.Trigger, Wl = ft.Group, rh = ft.Portal, oh = ft.Sub, ah = ft.RadioGroup, Kl = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
const nr = S.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...r }, o) => {
  const a = xt();
...
nr.displayName = ft.Content.displayName;
...
const uo = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ x(
  ft.CheckboxItem,
  {
    ref: o,
    className: N(
...
uo.displayName = ft.CheckboxItem.displayName;
...
const rr = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  ft.Label,
  {
    ref: r,
...
rr.displayName = ft.Label.displayName;
const or = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.Separator,
  {
    ref: n,
...
or.displayName = ft.Separator.displayName;
...
function Ei(t) {
  const e = typeof t == "number" ? mo(t) : t;
  return fo(e) && !wo.includes(e);
}
function lc(t) {
  const e = typeof t == "number" ? mo(t) : t;
  return fo(e) && wo.includes(e);
...
const ho = ot.allBookIds.filter((t) => !ot.isObsolete(ot.bookIdToNumber(t))), wc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  const n = e ?? ho;
  return {
    OT: n.filter((o) => ot.isBookOT(o)),
    NT: n.filter((o) => ot.isBookNT(o)),
    DC: n.filter((o) => ot.isBookDC(o))
  }[t];
}, on = (t) => Sl(ot.bookIdToNumber(t));
function gc() {
  return ho.map((e) => ot.bookIdToEnglishName(e));
}
function bc(t) {
...
function vc(t) {
  ...
  if (bc(e))
    return ho.find((r) => ot.bookIdToEnglishName(r) === e);
}
function sh({ scrRef: t, handleSubmit: e, activeBookIds: n }) {
  const r = xt(), [o, a] = ut(""), [i, l] = ut(
    ...
    (P) => hc(P, n).filter((G) => {
      const j = ot.bookIdToEnglishName(G).toLowerCase(), V = o.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (P, G, j, V) => {
      if (d(
        ot.bookNumberToId(t.bookNum) !== P ? 1 : t.chapterNum
      ), G || on(P) === -1) {
        e({
          bookNum: ot.bookIdToNumber(P),
          chapterNum: j || 1,
          verseNum: V || 1
        }), g(!1), a("");
        return;
    ...
    mc.forEach((P) => {
      const G = o.match(P);
      if (G) {
        const [j, V = void 0, Y = void 0] = G.slice(1), nt = vc(j);
        (ot.isBookIdValid(j) || nt) && B(
          nt ?? j,
          !0,
          V ? parseInt(V, 10) : 1,
          Y ? parseInt(Y, 10) : 1
    ...
    if (p === i) {
      ...
      if (j)
        ...
        G === "ArrowDown" ? Y = 6 : G === "ArrowUp" && (Y = -6);
      c + Y <= 0 || c + Y > on(p) ? d(0) : Y !== 0 && (d(c + Y), P.preventDefault());
    }
  };
  return se(() => {
    ...
    const P = setTimeout(() => {
      if (v && k.current && T.current) {
        const j = T.current.offsetTop - fc;
  ...
  }, [v]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(po, { modal: !1, open: w, onOpenChange: I, children: [
    ...
    /* @__PURE__ */ s(
      nr,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: da.map(
          (P, G) => C(P).length > 0 && /* @__PURE__ */ x("div", { children: [
            /* @__PURE__ */ s(rr, { className: "tw-font-semibold tw-text-foreground/80", children: wc[P] }),
            C(P).map((j) => /* @__PURE__ */ s("div", { children: /* @__PURE__ */ s(
              pc,
              {
                bookId: j,
                ...
                children: /* @__PURE__ */ s(
                  uc,
                  {
                    ...
                    endChapter: on(j),
                    activeChapter: t.bookNum === ot.bookIdToNumber(j) ? t.chapterNum : 0,
            ...
            da.length - 1 !== G ? /* @__PURE__ */ s(or, {}) : void 0
          ] }, P)
        ) })
      }
    )
...
const yc = We(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? qe : "button", { className: N(yc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const xc = We(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Mt = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(li.Root, { ref: n, className: N("pr-twp", xc(), t), ...e }));
...
const Hr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  gn.Item,
  {
    ref: n,
    className: N(
...
Hr.displayName = gn.Item.displayName;
...
const Nc = qt.Portal, Ri = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  qt.Overlay,
  {
    ref: n,
    className: N(
...
const kc = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ x(Nc, { children: [
    /* @__PURE__ */ s(Ri, {}),
    /* @__PURE__ */ x(
      qt.Content,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ x(
            qt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ s(lo, { className: "tw-h-4 tw-w-4" }),
...
kc.displayName = qt.Content.displayName;
...
Ec.displayName = qt.Title.displayName;
...
Sc.displayName = qt.Description.displayName;
...
const Tc = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  _t.Separator,
  {
    ref: n,
...
Tc.displayName = _t.Separator.displayName;
...
var Rc = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Rc || {});
...
function _c({ table: t }) {
  return /* @__PURE__ */ x(po, { children: [
    ...
    /* @__PURE__ */ x(nr, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ s(rr, { children: "Toggle columns" }),
      /* @__PURE__ */ s(or, {}),
...
const Ve = bt.Root, Pc = bt.Group, ze = bt.Value, Ne = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ x(
    bt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ s(bt.Icon, { asChild: !0, children: /* @__PURE__ */ s(tr, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
$c.displayName = bt.Label.displayName;
...
Ic.displayName = bt.Separator.displayName;
function Ac({ table: t }) {
...
const ar = S.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s("div", { className: N("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ s(
  "table",
  {
    ref: r,
...
const ir = S.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s(
  "thead",
  {
    ref: r,
    className: N(
...
const sr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("tbody", { ref: n, className: N("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const Dc = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
function jc({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(_c, { table: m }),
    /* @__PURE__ */ x(ar, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ir, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ s(ie, { children: k.headers.map((T) => /* @__PURE__ */ s(vn, { children: T.isPlaceholder ? void 0 : wn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ s(sr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        ie,
        {
          onClick: () => i(k, m),
...
function Bc({
  ...
  return /* @__PURE__ */ x(ar, { stickyHeader: !0, children: [
    /* @__PURE__ */ s(ir, { stickyHeader: !0, children: /* @__PURE__ */ x(ie, { children: [
...
ko.displayName = Xr.Root.displayName;
const Vc = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), pa = (t) => {
...
}, Fc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ii = We(
...
), Lc = S.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  ui.Root,
  {
    ref: o,
...
Lc.displayName = ui.Root.displayName;
...
Mi.displayName = er.Root.displayName;
...
Gn.displayName = er.Item.displayName;
const lr = (t) => t === "asc" ? /* @__PURE__ */ s(ul, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(wl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(fl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), dh = (t) => ({
  ...
  return Vc(t).forEach((p) => {
    p.startsWith("\\id") && (i = zc(p), l = 0, c = 0), p.startsWith("\\c") && (l = pa(p), c = 0), p.startsWith("\\v") && (c = pa(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((h) => w.push(h));
      const g = f.index, v = a.find((h) => co(h.items, w)), m = {
        reference: {
...
function fh({
  ...
  const f = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), m = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [I, B] = ut("all"), [R, $] = ut(""), [L, M] = ut([]), Q = Ct(() => l ? r instanceof RegExp ? Xc(
    l,
    t,
    a,
    i,
    r
  ) : r(l, t, a, i) : [], [l, r, t, a, i]), P = Ct(() => {
    if (E)
      return Q;
    const y = [];
    return Q.forEach((O) => {
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ x(Ve, { onValueChange: (y) => Y(y), defaultValue: c, children: [
...
function mh({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(ji, { children: [
      /* @__PURE__ */ s(Bi, { children: t.map((i) => /* @__PURE__ */ s(Hc, { value: i.value, children: i.value }, i.key)) }),
...
const qc = Sn.Provider, Wc = Sn.Root, Kc = Sn.Trigger, zi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Sn.Content,
  {
    ref: r,
    sideOffset: e,
...
const Jc = "16rem", Zc = "3rem", Fi = S.createContext(void 0);
function cr() {
...
const Qc = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = cr();
  return /* @__PURE__ */ x(
    wt,
    {
...
const od = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Eo,
  {
    ref: n,
...
const Kr = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? qe : "div",
  {
    ref: r,
...
const ad = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? qe : "button",
  {
    ref: r,
...
const id = We(
  ...
  ({
    ...
    const c = t ? qe : "button", { state: d } = cr(), p = /* @__PURE__ */ s(
      c,
      {
        ref: l,
...
const sd = S.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? qe : "button",
  {
    ref: o,
...
const cd = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
const ud = S.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? qe : "a",
  {
    ref: a,
    ...
    Gi,
    {
      ...
      children: /* @__PURE__ */ x(Xi, { children: [
        /* @__PURE__ */ x(Wr, { children: [
          ...
          /* @__PURE__ */ s(Jr, { children: /* @__PURE__ */ s(Yi, { children: e.map((f) => /* @__PURE__ */ s(Hi, { children: /* @__PURE__ */ s(
            qi,
            {
              className: N(
...
const oe = "scrBook", fd = "scrRef", fe = "source", md = "details", hd = "Scripture Reference", gd = "Scripture Book", Wi = "Type", bd = "Details";
function vd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ot.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === oe ? Or(o.start) : void 0;
      },
...
}, wa = (t) => `${yd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function gh({
  sources: t,
  ...
  se(() => {
    if (l) {
      ...
      if ($.length === 1) {
        const L = v.find((M) => wa(M) === $[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, v, l, h]);
  const k = o ?? gd, T = a ?? Wi, C = [
  ...
  }, I = (R, $) => R.getIsGrouped() ? "" : N("banded-row", $ % 2 === 0 ? "even" : "odd"), B = (R, $, L) => {
    ...
    !e && /* @__PURE__ */ x(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(ke, { position: "item-aligned", children: /* @__PURE__ */ s(Pc, { children: C.map((R) => /* @__PURE__ */ s(Bt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(ar, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ir, { children: h.getHeaderGroups().map((R) => /* @__PURE__ */ s(ie, { children: R.headers.filter(($) => $.column.columnDef.header).map(($) => (
      ...
      /* @__PURE__ */ s(sr, { children: h.getRowModel().rows.map((R, $) => {
        const L = xt();
        return /* @__PURE__ */ s(
          ie,
          {
            ...
            children: R.getVisibleCells().map((M) => {
              if (!(M.getIsPlaceholder() || M.column.columnDef.enableGrouping && !M.getIsGrouped() && (M.column.columnDef.id !== fe || !n)))
                return /* @__PURE__ */ s(
                  Fe,
                  {
                    className: N(
                    ...
                    children: (() => M.getIsGrouped() ? /* @__PURE__ */ x(
                      wt,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          R.getIsExpanded() && /* @__PURE__ */ s(tr, {}),
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ s(oi, {}) : /* @__PURE__ */ s(bl, {})),
                          " ",
                          wn(M.column.columnDef.cell, M.getContext()),
                          " (",
                          R.subRows.length,
                          ")"
                        ]
...
function Sd() {
  return ma || (ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var b = c, I = d, B = l, R = i, $ = e, L = p, M = r, Q = v, P = g, G = n, j = a, V = o, Y = f, nt = !1;
    function at(A) {
      return nt || (nt = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), y(A) || E(A) === c;
    }
    function y(A) {
      return E(A) === d;
    }
    ...
    st.AsyncMode = b, st.ConcurrentMode = I, st.ContextConsumer = B, st.ContextProvider = R, st.Element = $, st.ForwardRef = L, st.Fragment = M, st.Lazy = Q, st.Memo = P, st.Portal = G, st.Profiler = j, st.StrictMode = V, st.Suspense = Y, st.isAsyncMode = at, st.isConcurrentMode = y, st.isContextConsumer = O, st.isContextProvider = U, st.isElement = X, st.isForwardRef = F, st.isFragment = K, st.isLazy = q, st.isMemo = W, st.isPortal = H, st.isProfiler = J, st.isStrictMode = Z, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = E;
  }()), st;
}
var ha;
function Zi() {
  return ha || (ha = 1, process.env.NODE_ENV === "production" ? Bn.exports = Ed() : Bn.exports = Sd()), Bn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Od() {
  if (xa)
    return Br;
  xa = 1;
  var t = Zi(), e = Td(), n = Co(), r = Qi(), o = Cd(), a = function() {
  };
  ...
  return Br = function(l, c) {
    ...
    function k(y) {
      function O(U, X, F, K, q, W) {
        var H = U[X], J = V(H);
        if (J !== y) {
          var Z = Y(H);
          return new m(
            "Invalid " + K + " `" + q + "` of type " + ("`" + Z + "` supplied to `" + F + "`, expected ") + ("`" + y + "`."),
            { expectedType: y }
          );
        }
        return null;
    ...
    function C(y) {
      function O(U, X, F, K, q) {
        if (typeof y != "function")
          return new m("Property `" + q + "` of component `" + F + "` has invalid PropType notation inside arrayOf.");
        var W = U[X];
        if (!Array.isArray(W)) {
          var H = V(W);
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected an array."));
        }
        for (var J = 0; J < W.length; J++) {
          var Z = y(W, J, F, K, q + "[" + J + "]", n);
    ...
    function E() {
      function y(O, U, X, F, K) {
        var q = O[U];
        if (!l(q)) {
          var W = V(q);
          return new m("Invalid " + F + " `" + K + "` of type " + ("`" + W + "` supplied to `" + X + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(y);
    ...
    function b() {
      function y(O, U, X, F, K) {
        ...
        if (!t.isValidElementType(q)) {
          var W = V(q);
          return new m("Invalid " + F + " `" + K + "` of type " + ("`" + W + "` supplied to `" + X + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(y);
    ...
    function I(y) {
      function O(U, X, F, K, q) {
        if (!(U[X] instanceof y)) {
          var W = y.name || w, H = at(U[X]);
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected ") + ("instance of `" + W + "`."));
        }
        return null;
      }
      return h(O);
    ...
    function B(y) {
      ...
      function O(U, X, F, K, q) {
        for (var W = U[X], H = 0; H < y.length; H++)
          if (v(W, y[H]))
            return null;
        ...
        return new m("Invalid " + K + " `" + q + "` of value `" + String(W) + "` " + ("supplied to `" + F + "`, expected one of " + J + "."));
      }
      return h(O);
    }
    function R(y) {
      function O(U, X, F, K, q) {
        if (typeof y != "function")
          return new m("Property `" + q + "` of component `" + F + "` has invalid PropType notation inside objectOf.");
        var W = U[X], H = V(W);
        if (H !== "object")
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + F + "`, expected an object."));
        for (var J in W)
          if (r(W, J)) {
            var Z = y(W, J, F, K, q + "." + J, n);
            if (Z instanceof Error)
    ...
    function $(y) {
      ...
      for (var O = 0; O < y.length; O++) {
        ...
        if (typeof U != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + nt(U) + " at index " + O + "."
          ), i;
      }
      function X(F, K, q, W, H) {
        for (var J = [], Z = 0; Z < y.length; Z++) {
          var dt = y[Z], A = dt(F, K, q, W, H, n);
          if (A == null)
            return null;
    ...
    function L() {
      function y(O, U, X, F, K) {
        return G(O[U]) ? null : new m("Invalid " + F + " `" + K + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return h(y);
    }
    function M(y, O, U, X, F) {
      return new m(
        (y || "React class") + ": " + O + " type `" + U + "." + X + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + F + "`."
      );
    }
    function Q(y) {
      function O(U, X, F, K, q) {
        var W = U[X], H = V(W);
        if (H !== "object")
          return new m("Invalid " + K + " `" + q + "` of type `" + H + "` " + ("supplied to `" + F + "`, expected `object`."));
        for (var J in y) {
          var Z = y[J];
          if (typeof Z != "function")
            return M(F, K, q, J, Y(Z));
          var dt = Z(W, J, F, K, q + "." + J, n);
          if (dt)
            return dt;
        }
        return null;
      ...
      function O(U, X, F, K, q) {
        ...
        for (var Z in J) {
          ...
          if (r(y, Z) && typeof dt != "function")
            return M(F, K, q, Z, Y(dt));
          if (!dt)
            return new m(
              "Invalid " + K + " `" + q + "` key `" + Z + "` supplied to `" + F + "`.\nBad object: " + JSON.stringify(U[X], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(y), null, "  ")
            );
          var A = dt(W, Z, F, K, q + "." + Z, n);
          if (A)
            return A;
        }
        return null;
    ...
    function V(y) {
      var O = typeof y;
      return Array.isArray(y) ? "array" : y instanceof RegExp ? "object" : j(O, y) ? "symbol" : O;
    }
    function Y(y) {
...
function jd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var I = i, B = a, R = t, $ = c, L = n, M = w, Q = f, P = e, G = o, j = r, V = d, Y = p, nt = !1, at = !1;
    function y(z) {
    ...
    ct.ContextConsumer = I, ct.ContextProvider = B, ct.Element = R, ct.ForwardRef = $, ct.Fragment = L, ct.Lazy = M, ct.Memo = Q, ct.Portal = P, ct.Profiler = G, ct.StrictMode = j, ct.Suspense = V, ct.SuspenseList = Y, ct.isAsyncMode = y, ct.isConcurrentMode = O, ct.isContextConsumer = U, ct.isContextProvider = X, ct.isElement = F, ct.isForwardRef = K, ct.isFragment = q, ct.isLazy = W, ct.isMemo = H, ct.isPortal = J, ct.isProfiler = Z, ct.isStrictMode = dt, ct.isSuspense = A, ct.isSuspenseList = Nt, ct.isValidElementType = E, ct.typeOf = b;
  }()), ct;
}
...
const Fd = u.oneOfType([u.func, u.object]), os = Fd;
function Wt(t) {
  if (typeof t != "string")
...
const qd = typeof window < "u" ? D.useLayoutEffect : D.useEffect, Ge = qd;
let Ca = 0;
function Wd(t) {
...
function up(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = kt(t, dp), a = pp(e), i = Object.keys(a);
  function l(w) {
...
const wp = {
  borderRadius: 4
}, fp = wp, mp = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, le = mp;
function fn(t, e) {
  return e ? Qt(t, e, {
    clone: !1
...
function ws(t, e) {
  const n = us(t.theme);
  return Object.keys(t).map((r) => Ep(t, e, r, n)).reduce(fn, {});
}
function ht(t) {
  return ws(t, wr);
}
ht.propTypes = process.env.NODE_ENV !== "production" ? wr.reduce((t, e) => (t[e] = le, t), {}) : {};
ht.filterProps = wr;
function gt(t) {
  return ws(t, fr);
}
gt.propTypes = process.env.NODE_ENV !== "production" ? fr.reduce((t, e) => (t[e] = le, t), {}) : {};
gt.filterProps = fr;
process.env.NODE_ENV !== "production" && Np.reduce((t, e) => (t[e] = le, t), {});
function Sp(t = 8) {
  if (t.mui)
    return t;
  const e = us({
...
const Tp = Gt("border", Vt), Cp = Gt("borderTop", Vt), Op = Gt("borderRight", Vt), Rp = Gt("borderBottom", Vt), _p = Gt("borderLeft", Vt), Pp = Gt("borderColor"), $p = Gt("borderTopColor"), Ip = Gt("borderRightColor"), Ap = Gt("borderBottomColor"), Mp = Gt("borderLeftColor"), Dp = Gt("outline", Vt), jp = Gt("outlineColor"), hr = (t) => {
...
mr(gr, br, vr, Bp, Vp, zp, Fp, Lp, Gp, Up, Xp, Yp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const Hp = vt({
...
function Io(t = {}, ...e) {
  ...
  return d.applyStyles = iu, d = e.reduce((p, f) => Qt(p, f), d), d.unstable_sxConfig = _({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return $o({
      sx: f,
      theme: this
    });
...
const mu = Io(), Ia = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Vn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function gu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = hu(Ia(d))
    } = l, g = kt(l, uu), v = p !== void 0 ? p : (
    ...
    let k = Un;
    d === "Root" || d === "root" ? k = r : d ? k = o : fu(i) && (k = void 0);
    const T = Il(i, _({
      shouldForwardProp: k,
      label: h
      ...
      if (process.env.NODE_ENV !== "production") {
        let M;
        c && (M = `${c}${Wt(d || "")}`), M === void 0 && (M = `Styled(${zd(i)})`), L.displayName = M;
      }
...
function Aa(t) {
  t = Se(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Se(xu(t)).values : t.values;
...
function gs(t, e) {
  return t = Se(t), e = Ao(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, yr(t);
}
function Nu(t, e) {
...
const Su = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Me = Iu, Au = ["mode", "contrastThreshold", "tonalOffset"], Da = {
...
function Fu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, Au), a = t.primary || Mu(e), i = t.secondary || Du(e), l = t.error || ju(e), c = t.info || Bu(e), d = t.success || Vu(e), p = t.warning || zu(e);
  function f(m) {
    const h = Ma(m, Fr.text.primary) >= n ? Fr.text.primary : Da.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ma(m, h);
...
const Lu = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function Gu(t) {
...
`));
  ...
  return d.unstable_sxConfig = _({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return $o({
      sx: f,
      theme: this
    });
...
const iw = (t) => Un(t) && t !== "classes", sw = gu({
  themeId: Do,
  defaultTheme: Mo,
...
const cw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], dw = (t) => {
  ...
  const r = jo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, cw), v = /* @__PURE__ */ D.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function bs(t, e) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${e}Icon`), n.muiName = Fa.muiName, /* @__PURE__ */ D.memo(/* @__PURE__ */ D.forwardRef(n));
}
const uw = {
  configure: (t) => {
...
var vs = So.default = void 0, gw = hw(mw()), bw = Qs;
vs = So.default = (0, gw.default)(/* @__PURE__ */ (0, bw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function vw(t) {
...
function Sw(t) {
  ...
  const i = kw(_({}, o, r)), l = Ga(r), c = Ga(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
const Kn = /* @__PURE__ */ D.forwardRef(function(e, n) {
  const {
    ...
    container: o,
    disablePortal: a = !1
  } = e, [i, l] = D.useState(null), c = Ee(/* @__PURE__ */ D.isValidElement(r) ? r.ref : null, n);
  if (Ge(() => {
...
var Ot = "top", Ft = "bottom", Lt = "right", Rt = "left", Vo = "auto", _n = [Ot, Ft, Lt, Rt], Ue = "start", Nn = "end", $w = "clippingParents", Ns = "viewport", sn = "popper", Iw = "reference", Ua = /* @__PURE__ */ _n.reduce(function(t, e) {
  return t.concat([e + "-" + Ue, e + "-" + Nn]);
}, []), ks = /* @__PURE__ */ [].concat(_n, [Vo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ue, e + "-" + Nn]);
}, []), Aw = "beforeRead", Mw = "read", Dw = "afterRead", jw = "beforeMain", Bw = "main", Vw = "afterMain", zw = "beforeWrite", Fw = "write", Lw = "afterWrite", Gw = [Aw, Mw, Dw, jw, Bw, Vw, zw, Fw, Lw];
function Kt(t) {
...
var ye = Math.max, Jn = Math.min, Xe = Math.round;
function no() {
...
function Pn(t) {
  for (var e = Dt(t), n = Xa(t); n && Hw(n) && ee(n).position === "static"; )
    n = Xa(n);
...
function Jw(t) {
  ...
  if (!(!a || !i)) {
    var f = Kw(o.padding, n), w = Fo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = Pn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], b = T - w[p] - f[v], I = T / 2 - w[p] / 2 + C, B = mn(E, I, b), R = c;
    n.modifiersData[r] = (e = {}, e[R] = B, e.centerOffset = B - I, e);
  }
}
function Zw(t) {
...
function Ya(t) {
  ...
  if (d) {
    var I = Pn(n), B = "clientHeight", R = "clientWidth";
    if (I === Dt(n) && (I = ce(n), ee(I).position !== "static" && l === "absolute" && (B = "scrollHeight", R = "scrollWidth")), I = I, o === Ot || (o === Rt || o === Lt) && a === Nn) {
      E = Ft;
      var $ = f && I === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        I[B]
      );
      m -= $ - r.height, m *= c ? 1 : -1;
    ...
    if (o === Rt || (o === Ot || o === Ft) && a === Nn) {
      C = Lt;
      var L = f && I === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        I[R]
      );
      g -= L - r.width, g *= c ? 1 : -1;
  ...
  if (g = Q.x, m = Q.y, c) {
    var P;
    return Object.assign({}, M, (P = {}, P[E] = T ? "0" : "", P[C] = k ? "0" : "", P.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", P));
  }
...
function Rs(t) {
  return ["html", "body", "#document"].indexOf(Kt(t)) >= 0 ? t.ownerDocument.body : zt(t) && Xo(t) ? t : Rs(xr(t));
}
function hn(t, e) {
  var n;
  e === void 0 && (e = []);
...
function qa(t, e, n) {
  return e === Ns ? ro(cf(t, n)) : Te(e) ? pf(e, n) : ro(df(ce(t)));
}
function uf(t) {
  var e = hn(xr(t)), n = ["absolute", "fixed"].indexOf(ee(t).position) >= 0, r = n && zt(t) ? Pn(t) : t;
...
function wf(t, e, n, r) {
  var o = e === "clippingParents" ? uf(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = qa(t, d, r);
    return c.top = ye(p.top, c.top), c.right = Jn(p.right, c.right), c.bottom = Jn(p.bottom, c.bottom), c.left = ye(p.left, c.left), c;
  }, qa(t, i, r));
...
function kn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? $w : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, f = n.elementContext, w = f === void 0 ? sn : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Cs(typeof h != "number" ? h : Os(h, _n)), T = w === sn ? Iw : sn, C = t.rects.popper, E = t.elements[v ? T : w], b = wf(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), I = Ye(t.elements.reference), B = _s({
    reference: I,
    element: C,
    strategy: "absolute",
    placement: o
  }), R = ro(Object.assign({}, C, B)), $ = w === sn ? R : I, L = {
    top: b.top - $.top + k.top,
  ...
  if (w === sn && M) {
    ...
    Object.keys(L).forEach(function(P) {
      var G = [Lt, Ft].indexOf(P) >= 0 ? 1 : -1, j = [Ot, Ft].indexOf(P) >= 0 ? "y" : "x";
      L[P] += Q[j] * G;
    });
  }
  return L;
...
function ff(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ks : c, p = He(r), f = p ? l ? Ua : Ua.filter(function(v) {
    return He(v) === p;
...
function hf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Ht(h), T = k === h, C = c || (T || !v ? [Yn(h)] : mf(h)), E = [h].concat(C).reduce(function(F, K) {
      return F.concat(Ht(K) === Vo ? ff(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
    ...
    }, []), b = e.rects.reference, I = e.rects.popper, B = /* @__PURE__ */ new Map(), R = !0, $ = E[0], L = 0; L < E.length; L++) {
      var M = E[L], Q = Ht(M), P = He(M) === Ue, G = [Ot, Ft].indexOf(Q) >= 0, j = G ? "width" : "height", V = kn(e, {
        placement: M,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
      ...
      b[j] > I[j] && (Y = Yn(Y));
      var nt = Yn(Y), at = [];
      if (a && at.push(V[Q] <= 0), l && at.push(V[Y] <= 0, V[nt] <= 0), at.every(function(F) {
        return F;
      })) {
        $ = M, R = !1;
        break;
...
function Tf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = kn(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Ht(e.placement), T = He(e.placement), C = !T, E = Lo(k), b = Sf(E), I = e.modifiersData.popperOffsets, B = e.rects.reference, R = e.rects.popper, $ = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (I) {
    if (a) {
      var P, G = E === "y" ? Ot : Rt, j = E === "y" ? Ft : Lt, V = E === "y" ? "height" : "width", Y = I[E], nt = Y + h[G], at = Y - h[j], y = g ? -R[V] / 2 : 0, O = T === Ue ? B[V] : R[V], U = T === Ue ? -R[V] : -B[V], X = e.elements.arrow, F = g && X ? Fo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ts(), q = K[G], W = K[j], H = mn(0, B[V], F[V]), J = C ? B[V] / 2 - y - H - q - L.mainAxis : O - H - q - L.mainAxis, Z = C ? -B[V] / 2 + y + H + W + L.mainAxis : U + H + W + L.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), A = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = (P = M == null ? void 0 : M[E]) != null ? P : 0, z = Y + J - Nt - A, yt = Y + Z - Nt, Ut = mn(g ? Jn(nt, z) : nt, Y, g ? ye(at, yt) : at);
      I[E] = Ut, Q[E] = Ut - Y;
    }
    if (l) {
      var de, St = E === "x" ? Ot : Rt, In = E === "x" ? Ft : Lt, Xt = I[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[St], Oe = Xt - h[In], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = M == null ? void 0 : M[b]) != null ? de : 0, ue = Re ? pe : Xt - B[Ce] - R[Ce] - _e + L.altAxis, Ze = Re ? Xt + B[Ce] + R[Ce] - _e - L.altAxis : Oe, An = g && Re ? Ww(ue, Xt, Ze) : mn(g ? ue : pe, Xt, g ? Ze : Oe);
      I[b] = An, Q[b] = An - Xt;
    }
    e.modifiersData[r] = Q;
  }
...
function Pf(t, e, n) {
  n === void 0 && (n = !1);
  var r = zt(e), o = zt(e) && _f(e), a = ce(e), i = Ye(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Xo(a)) && (l = Rf(e)), zt(e) ? (c = Ye(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Uo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = If(Mf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Za(T, C)) {
            p.rects = {
              reference: Pf(T, Pn(C), p.options.strategy === "fixed"),
              popper: Fo(C)
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var b = p.orderedModifiers[E], I = b.fn, B = b.options, R = B === void 0 ? {} : B, $ = b.name;
...
var jf = [af, Ef, rf, Yw, Nf, gf, Cf, Qw, vf], Bf = /* @__PURE__ */ Df({
  defaultModifiers: jf
});
const Ps = "Popper";
function Vf(t) {
...
_w(Ps, ["root"]);
const zf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Ff = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Lf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Uf = () => Oo({
  root: ["root"]
}, Nw(Vf)), Xf = {}, Yf = /* @__PURE__ */ D.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = kt(e, zf), k = D.useRef(null), T = Ee(k, n), C = D.useRef(null), E = Ee(C, w), b = D.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), D.useImperativeHandle(w, () => C.current, []);
  const I = Lf(p, i), [B, R] = D.useState(I), [$, L] = D.useState(Zn(o));
  D.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && $ && Nr($) && $.nodeType === 1) {
...
`));
  ...
  const Q = Uf(), P = (r = v.root) != null ? r : "div", G = Cw({
    elementType: P,
  ...
  return /* @__PURE__ */ s(P, _({}, G, {
    children: typeof a == "function" ? a(M) : a
  }));
}), $s = /* @__PURE__ */ D.forwardRef(function(e, n) {
  const {
    anchorEl: r,
    children: o,
    container: a,
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, T = kt(e, Ff), [C, E] = D.useState(!0), b = () => {
    E(!1);
  }, I = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const L = Zn(r);
    B = L && Nr(L) ? Hn(L).body : Hn(null).body;
  }
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || Gf(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
function Is() {
  const t = hs(Mo);
  return process.env.NODE_ENV !== "production" && D.useDebugValue(t), t[Do] || t;
}
function oo(t, e) {
...
var Wf = function(e) {
  return e.scrollTop;
}, un = "unmounted", me = "exited", he = "entering", je = "entered", ao = "exiting", re = /* @__PURE__ */ function(t) {
  Hf(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== he && i !== je && (a = he) : (i === he || i === je) && (a = ao);
    }
...
const Qf = {
...
}, Lr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Yo = /* @__PURE__ */ D.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = kt(e, Zf), T = dn(), C = D.useRef(), E = Is(), b = D.useRef(null), I = Ee(b, a.ref, n), B = (j) => (V) => {
    if (j) {
      const Y = b.current;
      V === void 0 ? j(Y) : j(Y, V);
    }
    ...
    let y;
    m === "auto" ? (y = E.transitions.getAutoHeightDuration(j.clientHeight), C.current = y) : y = Y, j.style.transition = [E.transitions.create("opacity", {
      duration: y,
      delay: nt
    ...
    let at;
    m === "auto" ? (at = E.transitions.getAutoHeightDuration(j.clientHeight), C.current = at) : at = V, j.style.transition = [E.transitions.create("opacity", {
      duration: at,
      delay: Y
    }), E.transitions.create("transform", {
      duration: Lr ? at : at * 0.666,
      delay: Lr ? Y : Y || at * 0.333,
      easing: nt
    })].join(","), j.style.opacity = 0, j.style.transform = io(0.75), f && f(j);
  }), P = B(w);
  return /* @__PURE__ */ s(h, _({
    ...
    onExiting: M,
    addEndListener: (j) => {
      m === "auto" && T.start(C.current || 0, j), r && r(b.current, j);
    },
...
Yo.muiSupportAuto = !0;
const ei = Yo, tm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], em = Rn($s, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), Ms = /* @__PURE__ */ D.forwardRef(function(e, n) {
  var r;
  const o = ms(), a = jo({
    props: e,
    name: "MuiPopper"
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, tm), I = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, B = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const rm = ps("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ae = rm, om = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function am(t) {
  return Math.round(t * 1e5) / 1e5;
}
const im = (t) => {
...
const js = /* @__PURE__ */ D.forwardRef(function(e, n) {
  ...
  const I = jo({
    ...
    TransitionProps: Nt
  } = I, z = kt(I, om), yt = /* @__PURE__ */ D.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
  }), Ut = Is(), de = Ut.direction === "rtl", [St, In] = D.useState(), [Xt, Ce] = D.useState(null), pe = D.useRef(!1), Oe = G || at, Re = dn(), _e = dn(), ue = dn(), Ze = dn(), [An, Ho] = is({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const qo = (tt) => {
    ...
    (tt) => {
      ni.start(800 + O, () => {
        Fn = !1;
      }), Ho(!1), X && Jt && X(tt), Re.start(Ut.transitions.duration.shortest, () => {
        pe.current = !1;
      });
    }
  ), Er = (tt) => {
    pe.current && tt.type !== "touchstart" || (St && St.removeAttribute("title"), _e.clear(), ue.clear(), V || Fn && Y ? _e.start(Fn ? Y : V, () => {
      qo(tt);
    }) : qo(tt));
  }, Wo = (tt) => {
    _e.clear(), ue.start(O, () => {
    ...
    onFocus: Ls,
    ref: Gs
  } = ss(), [, Jo] = D.useState(!1), Zo = (tt) => {
    Fs(tt), Ko.current === !1 && (Jo(!1), Wo(tt));
  }, Qo = (tt) => {
    St || In(tt.currentTarget), Ls(tt), Ko.current === !0 && (Jo(!0), Er(tt));
  }, ta = (tt) => {
    pe.current = !0;
    const $t = yt.props;
    $t.onTouchStart && $t.onTouchStart(tt);
  }, ea = Er, na = Wo, Us = (tt) => {
    ta(tt), ue.clear(), Re.clear(), Mn(), Qe.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Ze.start(nt, () => {
      document.body.style.WebkitUserSelect = Qe.current, Er(tt);
    });
  }, Xs = (tt) => {
    yt.props.onTouchEnd && yt.props.onTouchEnd(tt), Mn(), ue.start(U, () => {
      Dn(tt);
    });
  };
  D.useEffect(() => {
  ...
  !dt && dt !== 0 && (Jt = !1);
  const Sr = D.useRef(), Hs = (tt) => {
    const $t = yt.props;
    $t.onMouseMove && $t.onMouseMove(tt), ln = {
      x: tt.clientX,
      y: tt.clientY
    }, Sr.current && Sr.current.update();
  }, tn = {}, Tr = typeof dt == "string";
  M ? (tn.title = !Jt && Tr && !P ? dt : null, tn["aria-describedby"] = Jt ? kr : null) : (tn["aria-label"] = Tr ? dt : null, tn["aria-labelledby"] = Jt && !Tr ? kr : null);
  ...
  process.env.NODE_ENV !== "production" && (jt["data-mui-internal-clone-element"] = !0, D.useEffect(() => {
...
`));
  ...
  const en = {};
  j || (jt.onTouchStart = Us, jt.onTouchEnd = Xs), P || (jt.onMouseOver = Ln(ea, jt.onMouseOver), jt.onMouseLeave = Ln(na, jt.onMouseLeave), Oe || (en.onMouseOver = ea, en.onMouseLeave = na)), Q || (jt.onFocus = Ln(Qo, jt.onFocus), jt.onBlur = Ln(Zo, jt.onBlur), Oe || (en.onFocus = Qo, en.onBlur = Zo)), process.env.NODE_ENV !== "production" && yt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${yt.props.title}\` or the Tooltip component.`].join(`
`));
  const qs = D.useMemo(() => {
    var tt;
    let $t = [{
    ...
    touch: pe.current
  }), Cr = im(nn), ra = (r = (o = Z.popper) != null ? o : $.Popper) != null ? r : sm, oa = (a = (i = (l = Z.transition) != null ? l : $.Transition) != null ? i : A) != null ? a : ei, aa = (c = (d = Z.tooltip) != null ? d : $.Tooltip) != null ? c : lm, ia = (p = (f = Z.arrow) != null ? f : $.Arrow) != null ? p : cm, Ws = pn(ra, _({}, H, (w = J.popper) != null ? w : L.popper, {
    className: ve(Cr.popper, H == null ? void 0 : H.className, (g = (v = J.popper) != null ? v : L.popper) == null ? void 0 : g.className)
  }), nn), Ks = pn(oa, _({}, Nt, (m = J.transition) != null ? m : L.transition), nn), Js = pn(aa, _({}, (h = J.tooltip) != null ? h : L.tooltip, {
    className: ve(Cr.tooltip, (k = (T = J.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), nn), Zs = pn(ia, _({}, (C = J.arrow) != null ? C : L.arrow, {
    className: ve(Cr.arrow, (E = (b = J.arrow) != null ? b : L.arrow) == null ? void 0 : E.className)
  }), nn);
  return /* @__PURE__ */ x(D.Fragment, {
    children: [/* @__PURE__ */ D.cloneElement(yt, jt), /* @__PURE__ */ s(ra, _({
      as: W ?? Ds,
      placement: q,
      anchorEl: at ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(aa, _({}, Js, {
          children: [dt, B ? /* @__PURE__ */ s(ia, _({}, Zs, {
            ref: Ce
          })) : null]
        }))
      }))
...
function Bs(t) {
  ...
  return r ? /* @__PURE__ */ s(dm, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: k }) }) : k;
}
function Vs(t) {
...
function bm({
  ...
  se(() => {
    if (c) {
      ...
      if (E) {
        const b = E.getBoundingClientRect(), I = window.scrollY, B = window.scrollX, R = b.top + I + E.clientHeight, $ = b.left + B;
        h({ top: R, left: $ });
      }
    }
  }, [c, o]);
...
const $n = Qn(({ className: t, ...e }, n) => /* @__PURE__ */ s(vl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
), ym = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: N(vm({ variant: e }), t), ...n }));
...
const Nm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: N("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function Em({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: N("pr-twp", km({ variant: e }), t), ...n });
}
...
Pm.displayName = cn.Root.displayName;
const $m = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Yr.Root,
    {
...
$m.displayName = Yr.Root.displayName;
const Ch = Pt.Root, Im = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Pt.List,
    {
...
Im.displayName = Pt.List.displayName;
...
Am.displayName = Pt.Trigger.displayName;
...
function Ih({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(po, { children: [
    /* @__PURE__ */ s(gi, { asChild: !0, children: /* @__PURE__ */ s(Dm, {}) }),
    /* @__PURE__ */ s(nr, { children: e.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ s(rr, { children: n.label }),
      /* @__PURE__ */ s(Wl, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(uo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(vi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(or, {})
    ] }, n.label)) })
  ] }) });
}
function Ah({ id: t, message: e }) {
...
function jh({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ x(Em, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ s(lo, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
export {
  ...
  Ic as SelectSeparator,
  Ne as SelectTrigger,
  ze as SelectValue,
  Eo as Separator,
  vh as SettingsList,
  xh as SettingsListHeader,
