...
var mt = (e, t, n) => cs(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as en, useRef as Q, useMemo as $, useState as M, useCallback as z, useLayoutEffect as Lt, createContext as xn, useContext as fr, useEffect as Y, Component as ds, createElement as Lr, Suspense as ps, createRef as us, Fragment as ho } from "react";
import { Command as gt } from "cmdk";
import { X as nn, Search as fo, Check as Mt, Clock as Br, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as qn, ChevronRight as Ee, ArrowLeft as ms, ArrowRight as hs, Circle as yn, ChevronDown as fe, BoldIcon as fs, ItalicIcon as gs, UnderlineIcon as bs, StrikethroughIcon as vs, Pencil as xs, Trash2 as ys, ArrowUp as go, MoreHorizontal as bo, ChevronUp as Jn, AtSign as Ns, FilterIcon as ks, ArrowLeftIcon as _s, ChevronLeftIcon as Cs, ChevronRightIcon as Es, ArrowRightIcon as Ss, Copy as vo, Filter as Ts, User as Rs, Link as Ds, CircleHelp as Ms, ChevronsUpDown as xo, Star as Os, FunctionSquare as yo, SquareSigma as No, SquareX as Is, AlertCircle as Wn, CircleCheckIcon as As, CircleXIcon as Vs, CircleHelpIcon as Ps, ArrowUpIcon as $s, ArrowDownIcon as Ls, ArrowUpDownIcon as Bs, PanelLeft as js, PanelRight as zs, ScrollText as Fs, MenuIcon as Gs, Menu as Hs, EllipsisVertical as Xs, LoaderCircle as Ks, GripVertical as Us } from "lucide-react";
import { clsx as Ys } from "clsx";
import { extendTailwindMerge as qs } from "tailwind-merge";
import * as Ct from "@radix-ui/react-dialog";
import { includes as wn, Section as G, getChaptersForBook as Js, formatScrRef as de, getSectionForBook as Xe, formatRelativeDate as Ws, formatReplacementString as ce, sanitizeHtml as Zs, parseParatextHtml as Fr, hasCustomParatextTags as Qs, NumberFormat as ti, formatBytes as ei, getCurrentLocale as ni, getFormatCallerFunction as ri, deepEqual as ko, isString as Vn, compareScrRefs as Zn, scrRefToBBBCCCVVV as Pn, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
...
const nl = Ct.Root, rl = Ct.Portal, Bo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: h(
...
Bo.displayName = Ct.Overlay.displayName;
...
Ve.displayName = gt.Input.displayName;
...
ee.displayName = gt.List.displayName;
const an = b.forwardRef((e, t) => /* @__PURE__ */ o(gt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
an.displayName = gt.Empty.displayName;
...
jt.displayName = gt.Group.displayName;
...
Go.displayName = gt.Separator.displayName;
...
Ft.displayName = gt.Item.displayName;
...
const ft = class H {
  ...
  parse(t) {
    ...
    if (r.length !== 2 || W.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !H.isVerseParseable(r[1]))
      throw new ze("Invalid reference : " + t);
...
function Ce(e, t) {
  var r;
  return ((r = t == null ? void 0 : t.get(e)) == null ? void 0 : r.localizedName) ?? W.bookIdToEnglishName(e);
}
function kr(e, t) {
  var r;
  return ((r = t == null ? void 0 : t.get(e)) == null ? void 0 : r.localizedId) ?? e.toUpperCase();
}
const Zo = W.allBookIds.filter(
  (e) => !W.isObsolete(W.bookIdToNumber(e))
), ue = Object.fromEntries(
  Zo.map((e) => [e, W.bookIdToEnglishName(e)])
);
function _r(e, t, n) {
...
function vl({
  ...
  return /* @__PURE__ */ d(xe, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ o(ne, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: /* @__PURE__ */ o(jt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Ft,
      {
        onSelect: () => p(m),
...
function Jr({
  ...
  if (e)
    return /* @__PURE__ */ o(jt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Ft,
      {
        value: `${e} ${ue[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function mp({
  ...
  const w = ct(), [p, m] = M(!1), [f, u] = M(""), [g, N] = M(""), [v, T] = M("books"), [x, C] = M(void 0), [S, A] = M(!1), O = Q(void 0), _ = Q(void 0), R = Q(void 0), y = Q(void 0), E = Q({}), P = z(
    (D) => {
      t(D), l && l(D);
    },
    [t, l]
  ), j = $(() => r ? r() : Zo, [r]), q = $(() => ({
    [G.OT]: j.filter((k) => W.isBookOT(k)),
    [G.NT]: j.filter((k) => W.isBookNT(k)),
    [G.DC]: j.filter((k) => W.isBookDC(k)),
    [G.Extra]: j.filter((k) => W.extraBooks().includes(k))
  }), [j]), V = $(() => Object.values(q).flat(), [q]), X = $(() => {
    if (!g.trim()) return q;
    const D = {
      [G.OT]: [],
      [G.NT]: [],
    ...
    return [G.OT, G.NT, G.DC, G.Extra].forEach((K) => {
      D[K] = q[K].filter((st) => _r(st, g, a));
    }), D;
  }, [q, g, a]), I = $(
    () => yl(g, V, a),
    [g, V, a]
    ...
    (D) => {
      const k = v === "chapters" ? x : I == null ? void 0 : I.book;
      k && (P({
        book: k,
        chapterNum: D,
        verseNum: 1
    ...
    [v, B]
  ), { otLong: dt, ntLong: pt, dcLong: xt, extraLong: Ht } = {
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: k, isDigit: K } = qr(D.key);
      if (v === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (k || K) {
          if (D.preventDefault(), D.stopPropagation(), T("books"), C(void 0), K && x) {
            const st = ue[x];
            N(`${st} ${D.key}`);
          } else
            N(D.key);
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const st = v === "chapters" ? x : I == null ? void 0 : I.book;
        if (!st) return;
        const ut = (() => {
          if (!f) return 1;
          const je = f.match(/(\d+)$/);
        ...
        switch (D.key) {
          case "ArrowLeft":
            ut !== 0 && (At = ut > 1 ? ut - 1 : ae);
            break;
          case "ArrowRight":
            ut !== 0 && (At = ut < ae ? ut + 1 : 1);
            break;
          case "ArrowUp":
            At = ut === 0 ? ae : Math.max(1, ut - $r);
            break;
          case "ArrowDown":
            At = ut === 0 ? 1 : Math.min(ae, ut + $r);
            break;
          default:
            return;
        }
        At !== ut && (D.preventDefault(), D.stopPropagation(), u(or(st, a, At)), setTimeout(() => {
    ...
    const { isLetter: k, isDigit: K } = qr(D.key);
    (k || K) && (D.preventDefault(), N((st) => st + D.key), _.current.focus(), A(!1));
  }, []);
  return Lt(() => {
    const D = setTimeout(() => {
      if (p && v === "books" && R.current && y.current) {
        const k = R.current, K = y.current, st = K.offsetTop, ut = k.clientHeight, ae = K.clientHeight, At = st - ut / 2 + ae / 2;
        k.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(or(e.book));
    ...
    if (v === "chapters" && x) {
      ...
      setTimeout(() => {
        if (R.current)
          if (D) {
            const k = E.current[e.chapterNum];
  ...
  }, [v, x, I, e.book, e.chapterNum]), /* @__PURE__ */ d(xe, { open: p, onOpenChange: at, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: it.map(({ onClick: D, disabled: k, title: K, icon: st }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !S && /* @__PURE__ */ d(ee, { ref: R, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !I && Object.entries(X).map(([D, k]) => {
                if (k.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(jt, { heading: yt(D), children: k.map((K) => /* @__PURE__ */ o(
                      Qo,
                      {
                        bookId: K,
                        onSelect: (st) => kt(st),
              ...
              I && /* @__PURE__ */ o(jt, { children: /* @__PURE__ */ o(
                Ft,
                {
              ...
              I && Dt(I.book) > 1 && /* @__PURE__ */ d(lt, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(I.book, a) }),
                /* @__PURE__ */ o(
                  Jr,
                  {
                    bookId: I.book,
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(_o.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
wt.displayName = _o.Root.displayName;
...
function ar({
  ...
  const [x, C] = M(!1), S = c ?? l, A = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], O = (_, R) => {
    const y = l(_), E = typeof _ == "object" && "secondaryLabel" in _ ? _.secondaryLabel : void 0, P = `${R ?? ""}${y}${E ?? ""}`;
    return /* @__PURE__ */ d(
      Ft,
      {
        value: y,
    ...
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ o(ee, { children: A(t) ? t.map((_) => /* @__PURE__ */ o(jt, { heading: _.groupHeading, children: _.options.map((R) => O(R, _.groupHeading)) }, _.groupHeading)) : t.map((_) => O(_)) })
        ] })
      }
    )
  ] });
...
function gp({
  ...
  const p = Bn(w, "%webView_bookSelector_currentBook%"), m = Bn(w, "%webView_bookSelector_choose%"), f = Bn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), N = (v) => {
    g(v), e(v);
    ...
    Cr,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ o(wt, { className: "tw-flex tw-items-center", children: r.map((v) => W.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ o(
            L,
            {
...
const bp = [
  ...
  const a = Q(null), [s, i] = M(void 0), [l, c] = M(void 0), w = z(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (y === -1) return;
          let E;
          u.key === "ArrowDown" ? E = Math.min(y + 1, R.length - 1) : E = Math.max(y - 1, 0), E !== y && (u.preventDefault(), u.stopPropagation(), (_ = R[E]) == null || _.focus());
          return;
        }
        return;
      }
      const S = e.findIndex((R) => R.id === s);
      let A = S;
      switch (u.key) {
        case "ArrowDown":
          A = Math.min(S + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(S - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ea ? Lt : Y, cn = { tag: gr };
      ...
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Bt() !== null || N !== null && N === m.getRootElement()) && g.select();
          }
        }, cn);
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
...
const Er = {
  ...
  mark: "",
  markOverlap: ""
}, Pt = on.Provider, Ut = on.Root, me = on.Trigger, $t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  on.Content,
  {
    ref: r,
    sideOffset: t,
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = Ot(), n = $(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = Q(r);
    return Bl(() => {
...
function le(e, t) {
  ht.call(this, void 0), this.x = e, this.s = void 0, this.g = un - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function ql(e, t) {
  return new le(e, t);
}
...
function Jl(e) {
  ...
  sa(this), U = e, this.f &= -2, 8 & this.f && Tr(this), _n();
}
function _e(e, t) {
...
ht.prototype.brand = Ul, ht.prototype.h = function() {
  return !0;
...
} }), le.prototype = new ht(), le.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === un)) return !0;
  if (this.g = un, this.f |= 1, this.i > 0 && !aa(this)) return this.f &= -2, !0;
  const e = U;
  try {
    to(this), U = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), to(this), Yt++;
  const e = U;
  return U = this, Jl.bind(this, e);
...
zt({ build: (e, t, n) => Cn(t), config: rn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function la() {
  const e = Jt(), t = Bt(), n = Nn();
  e.clear(), e.append(n), t !== null && n.select(), We(t) && (t.format = 0);
}
function wa(e, t = la) {
  return e.registerCommand(To, (n) => (e.update(t), !0), Ro);
}
zt({ build: (e, t, n) => Cn(t), config: rn({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const ir = zt({ build: (e) => ca(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, pa = 2, zn = 3, dn = 4, ke = 5, Fn = 6, Fe = 7;
function Gn(e) {
  return e.id === Rr;
}
function ua(e) {
...
function Zl(e) {
  return function(t) {
    return t.id === lr;
  }(e) || Z(305, String(e.id), String(lr)), Object.assign(e, { id: pa });
}
...
class tw {
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== dn && Z(307, String(n.id), String(ke)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Fn && Z(310, String(n.id), String(Fn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= dn;
    }(t) || Z(313, String(t.id), String(dn)), t.initResult;
  }
  getInitPeer(t) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= zn;
    }(t) || Z(314, String(t.id), String(zn)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= Fe;
    }(t) || Z(316, String(t.id), String(Fe)), t;
  }
...
const nw = zt({ config: rn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = ew }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
class Ye {
  ...
  static maybeFromEditor(t) {
    const n = t[no];
    return n && (n.PACKAGE_VERSION !== Hn && Z(292, n.PACKAGE_VERSION, Hn), n instanceof Ye || Z(293)), n;
  }
  static fromEditor(t) {
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Gn(s) || Z(300, i, a || "[unknown]"), Gn(l = s) || Z(304, String(l.id), String(Rr)), s = Object.assign(l, { id: lr }), r.state = s;
    ...
    for (const p of l) {
      ...
      if (m.onError !== void 0 && (t.onError = m.onError), m.disableEvents !== void 0 && (t.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (t.parentEditor = m.parentEditor), m.editable !== void 0 && (t.editable = m.editable), m.namespace !== void 0 && (t.namespace = m.namespace), m.$initialEditorState !== void 0 && (t.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of Wl(m)) {
        if (typeof f != "function") {
          ...
          u && Z(302, m.name, f.replace.name, u.extension.name), r.set(f.replace, p);
        }
        n.add(f);
      }
      if (m.html) {
...
const ow = /* @__PURE__ */ new Set(), oo = zt({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = Ze({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ca(() => {
  }, () => Zt(() => {
...
zt({ dependencies: [ir, oo], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  ...
  return Wt(e.registerCommand(mi, (i) => {
    if (hi(i.target)) {
      ...
      if (sw(l)) return function(c, w = !1) {
        const p = Bt(), m = c.isSelected(), f = c.getKey();
        let u;
...
zt({ build: (e, t, n) => Cn(t), config: rn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: r, maxIndent: a } = n.getOutput();
  return Zt(() => {
    if (!r.value) return iw(e, a);
  });
} });
const lw = zt({ name: "@lexical/react/ReactProvider" });
function ww() {
...
zt({ build: (e, t, n) => Cn(t), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Zt(() => n.getOutput().disabled.value ? void 0 : fa(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function vw({ onClear: e }) {
  const [t] = Ot();
  return bw(() => wa(t, e), [t, e]), null;
}
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Y;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: N, role: v = "textbox", spellCheck: T = !0, style: x, tabIndex: C, "data-testid": S, ...A }, O) {
  const [_, R] = M(e.isEditable()), y = z((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? e.setRootElement(P) : e.setRootElement(null);
  }, [e]), E = $(() => /* @__PURE__ */ function(...P) {
    return (j) => {
      for (const q of P) typeof q == "function" ? q(j) : q != null && (q.current = j);
    };
  }(O, y), [y, O]);
  return ga(() => (R(e.isEditable()), e.registerEditableListener((P) => {
    R(P);
  })), [e]), o("div", { "aria-activedescendant": _ ? t : void 0, "aria-autocomplete": _ ? n : "none", "aria-controls": _ ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": _ && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": _ ? m : void 0, "aria-readonly": !_ || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: _, "data-testid": S, id: N, ref: E, role: v, spellCheck: T, style: x, tabIndex: C, ...A });
}
const yw = en(xw);
function so(e) {
  return e.getEditorState().read(ha(e.isComposing()));
...
function Tw({
  ...
  const [t] = Ot(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Sw(), c = () => {
  };
...
function Mw() {
  const { activeEditor: e } = va(), [t, n] = M([]), r = z((a) => {
    if (We(a) || Gi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function _a(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, N) {
    ...
    if (T !== void 0) for (const C of T) {
      const S = C(g);
      S !== null && (x === null || (x.priority || 0) <= (S.priority || 0)) && (x = S);
    }
...
}), $e = tt.Trigger, Da = tt.Group, Kw = tt.Portal, Uw = tt.Sub, Yw = tt.RadioGroup;
function Ne({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Or.Provider, { value: n, children: /* @__PURE__ */ o(tt.Root, { ...t }) });
}
...
Ma.displayName = tt.SubTrigger.displayName;
...
re.displayName = tt.Content.displayName;
...
bn.displayName = tt.Item.displayName;
const qt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    tt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(tt.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
...
const Ia = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    tt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(tt.ItemIndicator, { children: /* @__PURE__ */ o(yn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
sn.displayName = tt.Label.displayName;
...
function lo({
  ...
  const [m, f] = M(!1), [u, g] = M(), [N, v] = M(!1), T = Q(null);
  Y(() => {
    let y = !0;
    if (!r) {
      v(!1);
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ta, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ra, { className: "tw-text-xs tw-font-medium", children: O }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: S }),
...
function Jw({
  ...
  const [x, C] = M(wo), [S, A] = M(!1), [O, _] = M(!1), [R, y] = M(!1), [E, P] = M(!1), [j, q] = M(!1), [V, X] = M(void 0), [I, rt] = M(!1), [kt, It] = M(!1);
  Y(() => {
    let k = !0;
    if (!r) {
      rt(!1), It(!1);
  ...
  const _t = $(() => t.filter((k) => !k.deleted), [t]), it = $(() => _t[0], [_t]), B = Q(null), at = Q(void 0), dt = z(() => {
    var k;
    (k = at.current) == null || k.call(at), C(wo);
  }, []);
  Y(() => {
    const k = B.current;
    if (!k) return;
  ...
  const pt = $(
  ...
  }, [s, n]), Ht = $(() => _t.slice(1), [_t]), yt = $(() => Ht.length ?? 0, [Ht.length]), Mn = $(() => yt > 0, [yt]), On = $(() => R || yt <= 2 ? Ht : Ht.slice(-2), [Ht, yt, R]), oe = $(() => R || yt <= 2 ? 0 : yt - 2, [yt, R]), In = $(
    () => yt === 1 ? pt.singleReply : ce(pt.multipleReplies, { count: yt }),
    [yt, pt]
  ), An = $(
    () => oe === 1 ? pt.singleReply : ce(pt.multipleReplies, { count: oe }),
    [oe, pt]
  ), ln = z(async () => {
    const k = Xt(x) ? cr(x) : void 0;
    if (V !== void 0) {
      await p({
        threadId: c,
        contents: k,
    ...
    k && await p({ threadId: c, contents: k }) && dt();
  }, [dt, x, p, V, c]), D = z(
    async (k) => {
      const K = Xt(x) ? cr(x) : void 0, st = await p({
        ...k,
        contents: K,
        assignedUser: V ?? k.assignedUser
      });
      return st && K && dt(), st && V !== void 0 && X(void 0), st;
    },
    [dt, x, p, V]
  );
  return /* @__PURE__ */ o(
    Ea,
    {
      ...
      children: /* @__PURE__ */ d(Sa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          xt && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: xt }),
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            /* @__PURE__ */ d(
              "p",
              {
                ...
                className: h(
                  ...
                  {
                    "tw-overflow-visible tw-text-clip tw-whitespace-normal tw-break-words": S
                  },
                  { "tw-whitespace-nowrap": !S }
                ),
                children: [
                  a,
                  " ",
            ...
            O && /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (k) => {
                  k.stopPropagation(), A(!S);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": S ? "Collapse text" : "Expand text",
                children: S ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(fe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            ...
            g !== !1 && (!E || Xt(x)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (k) => {
                  k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), (Xt(x) || V !== void 0) && ln());
                },
                onKeyDown: (k) => {
                  Ca(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    wr,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    V !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ce(
                    ...
                    /* @__PURE__ */ d(xe, { open: j, onOpenChange: q, children: [
                      /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ o(
                        ne,
                        {
                          ...
                          align: "end",
                          onKeyDown: (k) => {
                            k.key === "Escape" && (k.stopPropagation(), q(!1));
                          },
...
function vp({
  ...
  const [u, g] = M(), N = n.filter(
    ...
    g(_);
  }, []), { listboxRef: C, activeId: S, handleKeyDown: A } = Rl({
    options: v,
    onOptionSelect: T
  }), O = z(
    (_) => {
      _.key === "Escape" ? (g(void 0), _.preventDefault(), _.stopPropagation()) : A(_);
    },
    [A]
  );
  return /* @__PURE__ */ o(
...
const Me = ot.Root, Zw = ot.Group, Oe = ot.Value, Qw = Qt(
...
Aa.displayName = ot.ScrollUpButton.displayName;
...
Va.displayName = ot.ScrollDownButton.displayName;
...
Nt.displayName = ot.Item.displayName;
...
function wc({
  ...
  var O;
  const [p, m] = M([]), [f, u] = M([]), [g, N] = M({}), [v, T] = M({}), x = $(() => t ?? [], [t]), C = Po({
    data: x,
    columns: e,
    getCoreRowModel: Lo(),
  ...
  let A;
  return c ? A = Array.from({ length: 10 }).map((y, E) => `skeleton-row-${E}`).map((y) => /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(he, { colSpan: S.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((O = C.getRowModel().rows) == null ? void 0 : O.length) > 0 ? A = C.getRowModel().rows.map((_) => /* @__PURE__ */ o(
    Vt,
    {
      onClick: () => i(_, C),
    ...
    _.id
  )) : A = /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: C }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: C.getHeaderGroups().map((_) => /* @__PURE__ */ o(Vt, { children: _.headers.map((R) => /* @__PURE__ */ o(tn, { children: R.isPlaceholder ? void 0 : Ke(R.column.columnDef.header, R.getContext()) }, R.id)) }, _.id)) }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    ...
    /* @__PURE__ */ o(re, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Da, { children: w.itemType === 0 ? /* @__PURE__ */ o(lt, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        qt,
        {
          checked: r[p][f],
...
function mc({
  ...
  const [T, x] = M(!1), C = z(
    (E) => {
      var j;
      const P = (j = e.find((q) => q.label === E)) == null ? void 0 : j.value;
      P && n(
        t.includes(P) ? t.filter((q) => q !== P) : [...t, P]
      );
    },
    [e, t, n]
  ), S = () => c || r, A = $(() => {
    if (!f) return e;
    const E = e.filter((j) => j.starred).sort((j, q) => j.label.localeCompare(q.label)), P = e.filter((j) => !j.starred).sort((j, q) => {
      const V = t.includes(j.value), X = t.includes(q.value);
      return V && !X ? -1 : !V && X ? 1 : j.label.localeCompare(q.label);
    });
    return [...E, ...P];
  }, [e, t, f]), O = () => {
    n(e.map((E) => E.value));
...
function fc({
  ...
  const s = Q(null), i = Q(null), l = Q(!1), [c, w] = M(e), [p, m] = M(n), [f, u] = M(!1);
  Y(() => {
    w(e);
  }, [e]), Y(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var T, x, C, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = s.current) == null || T.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((x = i.current) == null || x.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Ut, { children: [
...
function Sp({
  ...
  const c = Q(null), w = us(), [p, m] = M("generated"), [f, u] = M("*"), [g, N] = M("f"), v = $(
    () => ({
      ...i,
  ...
  Y(() => {
    ...
    if (A && $n("note", A)) {
      ...
      let y = "custom";
      R === Qn ? y = "generated" : R === tr ? y = "hidden" : R && u(R), m(y), N(((_ = A.insert.note) == null ? void 0 : _.style) ?? "f"), A.insert.note && (A.insert.note.caller = ""), S = setTimeout(() => {
        var E;
        (E = c.current) == null || E.applyUpdate([{ delete: 1 }, A]);
      }, 0);
    }
    return () => {
      S && clearTimeout(S);
  ...
  const T = z(() => {
    var A, O;
    const S = (O = (A = c.current) == null ? void 0 : A.getNoteOps(0)) == null ? void 0 : O.at(0);
    S && $n("note", S) && (S.insert.note && (p === "custom" ? S.insert.note.caller = f : S.insert.note.caller = p === "generated" ? Qn : tr), n([S]));
  }, [p, f, n]), x = () => {
    var A;
    const S = (A = w.current) == null ? void 0 : A.getElementsByClassName("editor-input")[0];
        ...
        /* @__PURE__ */ o(
          vc,
          {
            ...
            handleNoteTypeChange: (S) => {
              var O, _, R;
              N(S);
              const A = (_ = (O = c.current) == null ? void 0 : O.getNoteOps(0)) == null ? void 0 : _.at(0);
              A && $n("note", A) && (A.insert.note && (A.insert.note.style = S), (R = c.current) == null || R.applyUpdate([{ delete: 1 }, A]));
            },
            localizedStrings: l
          }
        ),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Ut, { children: [
...
function Rp({
  ...
  const p = c ?? ri(n, void 0), m = (x, C) => {
    w == null || w(x, C, a);
  }, f = s ? n.findIndex((x) => x === s) : -1, [u, g] = M(f), N = (x, C, S) => {
    if (n.length)
      switch (x.key) {
        case "Enter":
        case " ":
          x.preventDefault(), w == null || w(C, S, a);
          break;
      }
  }, v = (x) => {
    if (n.length)
...
function _c({
  ...
  return /* @__PURE__ */ d(En, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Sn, { stickyHeader: !0, children: /* @__PURE__ */ d(Vt, { children: [
      /* @__PURE__ */ o(tn, { children: a }),
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Dp = (e) => ({
  accessorKey: "item",
...
function $p({
  ...
  const f = Tt(n, "%webView_inventory_all%"), u = Tt(n, "%webView_inventory_approved%"), g = Tt(n, "%webView_inventory_unapproved%"), N = Tt(n, "%webView_inventory_unknown%"), v = Tt(n, "%webView_inventory_scope_currentBook%"), T = Tt(n, "%webView_inventory_scope_chapter%"), x = Tt(n, "%webView_inventory_scope_verse%"), C = Tt(n, "%webView_inventory_filter_text%"), S = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), A = Tt(n, "%webView_inventory_no_results%"), [O, _] = M(!1), [R, y] = M("all"), [E, P] = M(""), [j, q] = M([]), V = $(() => {
    const B = e ?? [];
    ...
    const B = [];
    return V.forEach((at) => {
      const dt = at.items[0], pt = B.find(
        (xt) => xt.items[0] === dt
      );
      pt ? (pt.count += at.count, pt.occurrences = pt.occurrences.concat(at.occurrences)) : B.push({
        items: [dt],
        count: at.count,
  ...
  }, [O, V]), I = $(() => X.length === 0 ? [] : Sc(X, R, E), [X, R, E]), rt = $(() => {
    var dt, pt;
    if (!O) return c;
    const B = (dt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : dt.length;
    if (!B) return c;
    const at = [];
    for (let xt = 0; xt < B; xt++)
      at.push(
        Cc(
          ((pt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : pt[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...at, ...c];
  }, [r == null ? void 0 : r.tableHeaders, c, O]);
  Y(() => {
  ...
  const kt = (B, at) => {
    ...
    if (X.length === 0 || j.length === 0) return [];
    const B = X.filter((at) => ko(
      O ? at.items : [at.items[0]],
      j
    ));
        ...
        Me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(ve, { children: [
              ...
              /* @__PURE__ */ o(Nt, { value: "approved", children: u }),
              /* @__PURE__ */ o(Nt, { value: "unapproved", children: g }),
              /* @__PURE__ */ o(Nt, { value: "unknown", children: N })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Me, { onValueChange: (B) => It(B), defaultValue: i, children: [
        /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Oe, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(Nt, { value: "book", children: v }),
          /* @__PURE__ */ o(Nt, { value: "chapter", children: T }),
          /* @__PURE__ */ o(Nt, { value: "verse", children: x })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Be,
...
function Bp({ localizedStrings: e, markerMenuItems: t }) {
  ...
  return /* @__PURE__ */ d(te, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(ee, { children: [
      ...
      /* @__PURE__ */ o(jt, { children: a.map((s) => /* @__PURE__ */ d(
        Ft,
        {
...
const Rc = "16rem", Dc = "3rem", $a = b.createContext(void 0);
function Dn() {
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), m = t ?? w, f = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => f((C) => !C), [f]), g = m ? "expanded" : "collapsed", T = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o($a.Provider, { value: x, children: /* @__PURE__ */ o(Pt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ d(za, { children: [
        /* @__PURE__ */ d(pr, { children: [
          ...
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Fa, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Ga, { children: /* @__PURE__ */ o(
            Ha,
            {
              onClick: () => w(f),
              isActive: m(f),
...
const Kt = "scrBook", Kc = "scrRef", we = "source", Uc = "details", Yc = "Scripture Reference", qc = "Scripture Book", Xa = "Type", Jc = "Details";
function Wc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? W.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Kt ? de(a.start) : void 0;
      },
      getGroupingValue: (r) => W.bookIdToNumber(r.start.book),
...
function zp({
  ...
  Y(() => {
    if (l) {
      const y = T.getSelectedRowModel().rowsById, E = Object.keys(y);
      if (E.length === 1) {
        const P = N.find((j) => uo(j) === E[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, N, l, T]);
  const x = a ?? qc, C = s ?? Xa, S = [
    ...
    !y.getIsGrouped() && !y.getIsSelected() && y.getToggleSelectedHandler()(E);
  }, _ = (y, E) => y.getIsGrouped() ? "" : h("banded-row", E % 2 === 0 ? "even" : "odd"), R = (y, E, P) => {
    if (!((y == null ? void 0 : y.length) === 0 || E.depth < P.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ve, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: S.map((y) => /* @__PURE__ */ o(Nt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: T.getHeaderGroups().map((y) => /* @__PURE__ */ o(Vt, { children: y.headers.filter((E) => E.column.columnDef.header).map((E) => (
      ...
      /* @__PURE__ */ o(Tn, { children: T.getRowModel().rows.map((y, E) => {
        const P = ct();
        return /* @__PURE__ */ o(
          Vt,
          {
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(qn, {})),
                          " ",
...
}), Ka = (e, t, n) => Pr(e, t).every((r) => n.includes(r));
function Qc({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function td({
  ...
  }, [v, T] = M(!1), [x, C] = M(""), S = Q(void 0), A = Q(!1);
  if (e.length !== W.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const O = $(() => W.allBookIds.filter(
    (V, X) => e[X] === "1" && !W.isObsolete(W.bookIdToNumber(V))
  ), [e]), _ = $(() => {
    if (!x.trim()) {
      const I = {
        [G.OT]: [],
    ...
    (V, X = !1) => {
      if (!X || !S.current) {
        n(
          t.includes(V) ? t.filter((it) => it !== V) : [...t, V]
        ), S.current = V;
        return;
      }
      const I = O.findIndex((it) => it === S.current), rt = O.findIndex((it) => it === V);
      if (I === -1 || rt === -1) return;
      const [kt, It] = [
        Math.min(I, rt),
        Math.max(I, rt)
      ], _t = O.slice(kt, It + 1).map((it) => it);
      n(
        t.includes(V) ? t.filter((it) => !_t.includes(it)) : [.../* @__PURE__ */ new Set([...t, ..._t])]
      );
    },
    [t, n, O]
  ), y = (V) => {
    R(V, A.current), A.current = !1;
  }, E = (V, X) => {
    V.preventDefault(), R(X, V.shiftKey);
  }, P = z(
    (V) => {
      const X = Pr(O, V).map((I) => I);
      n(
        Ka(O, V, t) ? t.filter((I) => !X.includes(I)) : [.../* @__PURE__ */ new Set([...t, ...X])]
      );
    },
    [t, n, O]
  ), j = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(G).map((V) => /* @__PURE__ */ o(
      Qc,
      {
        section: V,
        availableBookIds: O,
            ...
            te,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: q, children: w })
                ] }),
                /* @__PURE__ */ d(ee, { children: [
                  /* @__PURE__ */ o(an, { children: p }),
                  Object.values(G).map((V, X) => {
                    const I = _[V];
                    if (I.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        /* @__PURE__ */ o(
                          jt,
                          {
                            heading: Wo(V, f, u, g, N),
                            children: I.map((rt) => /* @__PURE__ */ o(
                              Qo,
                              {
                                bookId: rt,
                                isSelected: t.includes(rt),
                                onSelect: () => y(rt),
                                onMouseDown: (kt) => E(kt, rt),
                                section: Xe(rt),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: or(rt, a),
                                className: "tw-flex tw-items-center"
                              },
                              rt
                            ))
                        ...
                        X < Object.values(G).length - 1 && /* @__PURE__ */ o(Go, {})
                      ] }, V);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Kn ? Kn : mo
      ).map((V) => /* @__PURE__ */ o(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(V, a) }, V)),
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: T.map(({ value: x, label: C, id: S }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: x, id: S }),
            /* @__PURE__ */ o(wt, { htmlFor: S, children: C })
          ] }, S))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          ve,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(Nt, { value: `${w}`, children: l[J(w)] }, `${w}`))
          }
        )
      ]
    }
...
function hr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    ...
    /* @__PURE__ */ o(re, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
      /* @__PURE__ */ o(Da, { children: /* @__PURE__ */ o(Pt, { children: Ya(t.groups, t.items, c, e) }) }),
...
Ja.displayName = bt.List.displayName;
...
Wa.displayName = bt.List.displayName;
...
Za.displayName = bt.Content.displayName;
function Jp({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Ja, { children: [
      /* @__PURE__ */ o(Wa, { children: e.map((l) => /* @__PURE__ */ o(ed, { value: l.value, children: l.value }, l.key)) }),
...
Qa.displayName = et.Root.displayName;
...
es.displayName = et.SubTrigger.displayName;
...
ns.displayName = et.SubContent.displayName;
...
os.displayName = et.Item.displayName;
const od = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    et.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
...
const ad = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(yn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
as.displayName = et.Separator.displayName;
const Ge = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
...
function id({
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ o(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(nd, { children: [
      /* @__PURE__ */ o(ts, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        rs,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Pt, { children: ss(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function Qp({
  ...
  const w = ld(
    ...
    var T, x, C, S, A, O;
    const v = N !== g ? ((x = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : x[N]) ?? ((S = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : S.en) : void 0;
...
const ru = nt.Root, ou = nt.Trigger, au = nt.Group, su = nt.Portal, iu = nt.Sub, lu = nt.RadioGroup, hd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  nt.SubTrigger,
  {
    ref: a,
    className: h(
...
const wu = Et.Trigger, Cd = Et.Portal, cu = Et.Close, ls = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
const hu = bt.Root, Ad = b.forwardRef(({ className: e, ...t }, n) => {
  const r = ct();
  return /* @__PURE__ */ o(
    bt.List,
    {
...
Ad.displayName = bt.List.displayName;
...
Vd.displayName = bt.Trigger.displayName;
...
Pd.displayName = bt.Content.displayName;
...
jd(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
