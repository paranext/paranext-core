...
import b, { forwardRef as $e, useRef as et, useMemo as B, useState as D, useCallback as z, useLayoutEffect as Mt, createContext as zn, useContext as jn, useEffect as Y, Suspense as la, createRef as wa, Fragment as Sr } from "react";
import { Command as pt } from "cmdk";
import { X as Le, Search as Dr, Check as Tt, Clock as lr, ChevronsLeft as wr, ChevronsRight as cr, ChevronLeft as vn, ChevronRight as pe, ArrowLeft as ca, ArrowRight as da, Circle as We, ChevronDown as ee, BoldIcon as pa, ItalicIcon as ua, UnderlineIcon as ma, StrikethroughIcon as ha, Pencil as fa, Trash2 as ga, ArrowUp as Ir, MoreHorizontal as Or, ChevronUp as xn, AtSign as ba, FilterIcon as va, ArrowLeftIcon as xa, ChevronLeftIcon as ya, ChevronRightIcon as Na, ArrowRightIcon as ka, Copy as Mr, Filter as _a, User as Ca, Link as Ea, CircleHelp as Ta, ChevronsUpDown as Vr, Star as Ra, FunctionSquare as Ar, SquareSigma as Pr, SquareX as Sa, AlertCircle as yn, CircleCheckIcon as Da, CircleXIcon as Ia, CircleHelpIcon as Oa, ArrowUpIcon as Ma, ArrowDownIcon as Va, ArrowUpDownIcon as Aa, PanelLeft as Pa, PanelRight as $a, ScrollText as La, MenuIcon as Ba, Menu as za, EllipsisVertical as ja, LoaderCircle as Fa, GripVertical as Ga } from "lucide-react";
import { clsx as Ha } from "clsx";
import { extendTailwindMerge as Xa } from "tailwind-merge";
import * as yt from "@radix-ui/react-dialog";
import { includes as He, Section as H, getChaptersForBook as Ka, formatScrRef as ce, getSectionForBook as Se, formatRelativeDate as Ua, formatReplacementString as Wt, sanitizeHtml as Ya, parseParatextHtml as dr, hasCustomParatextTags as qa, NumberFormat as Ja, formatBytes as Wa, getCurrentLocale as Za, getFormatCallerFunction as Qa, deepEqual as $r, isString as cn, compareScrRefs as Nn, scrRefToBBBCCCVVV as dn, getLocalizeKeyForScrollGroupId as K } from "platform-bible-utils";
...
import { createEditor as ts, $getRoot as ne, $createParagraphNode as Fn, $getSelection as Ve, HISTORY_MERGE_TAG as Br, ParagraphNode as es, TextNode as ns, $isDecoratorNode as rs, $isElementNode as De, $isParagraphNode as os, $isTextNode as Ue, $isTokenOrSegmented as as, $getCharacterOffsets as ss, $isRangeSelection as Gn, CLEAR_EDITOR_COMMAND as zr, COMMAND_PRIORITY_EDITOR as is, SELECTION_CHANGE_COMMAND as jr, COMMAND_PRIORITY_CRITICAL as Fr, FORMAT_TEXT_COMMAND as ls, $cloneWithProperties as ws, getRegisteredNode as cs, isHTMLElement as ds, isDocumentFragment as pr, ArtificialNode__DO_NOT_USE as Gr, $createLineBreakNode as Hr, $isRootOrShadowRoot as ps, $isBlockElementNode as kn, isBlockDomNode as ur, isInlineDomNode as mr, $insertNodes as us } from "lexical";
import * as Be from "@radix-ui/react-tooltip";
import { TooltipTrigger as ms } from "@radix-ui/react-tooltip";
import { HeadingNode as hs, QuoteNode as fs, registerRichText as gs } from "@lexical/rich-text";
import { flushSync as bs, createPortal as vs } from "react-dom";
...
import { useReactTable as Yr, getFilteredRowModel as Ns, getSortedRowModel as qr, getPaginationRowModel as ks, getCoreRowModel as Jr, flexRender as Ie, getGroupedRowModel as _s, getExpandedRowModel as Cs } from "@tanstack/react-table";
import * as ot from "@radix-ui/react-select";
import Es from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as _n, HIDDEN_NOTE_CALLER as Cn, getDefaultViewOptions as Ts, isInsertEmbedOpOfType as pn, Editorial as Rs } from "@eten-tech-foundation/platform-editor";
import * as En from "@radix-ui/react-checkbox";
import * as ut from "@radix-ui/react-tabs";
import * as Q from "@radix-ui/react-menubar";
import { useHotkeys as Ss } from "react-hotkeys-hook";
...
import { Toaster as Ds } from "sonner";
import { toast as Sd } from "sonner";
import * as Re from "@radix-ui/react-slider";
import * as Rn from "@radix-ui/react-switch";
const Is = Xa({ prefix: "tw-" });
function u(...t) {
  return Is(Ha(t));
}
const Os = "layoutDirection";
function st() {
  const t = localStorage.getItem(Os);
  return t === "rtl" ? t : "ltr";
}
const Ms = yt.Root, Vs = yt.Portal, Wr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  yt.Overlay,
  {
    ref: n,
    className: u(
...
As.displayName = yt.Description.displayName;
...
Gt.displayName = pt.displayName;
const xe = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
...
xe.displayName = pt.Input.displayName;
...
Ht.displayName = pt.List.displayName;
...
const Vt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Group,
  {
    ref: n,
    className: u(
...
Vt.displayName = pt.Group.displayName;
...
At.displayName = pt.Item.displayName;
function no({ className: t, ...e }) {
  return /* @__PURE__ */ r(
    "span",
    {
      className: u("tw-ms-auto tw-text-xs tw-tracking-widest tw-text-muted-foreground", t),
      ...e
    }
  );
}
no.displayName = "CommandShortcut";
var Ps = Object.defineProperty, $s = (t, e, n) => e in t ? Ps(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, G = (t, e, n) => $s(t, typeof e != "symbol" ? e + "" : e, n);
const re = [
  "GEN",
  "EXO",
  "LEV",
...
function* js() {
  for (let t = 1; t <= re.length; t++) yield t;
}
const Fs = 1, ao = re.length;
function Gs() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function Un(t, e = "***") {
  const n = t - 1;
  return n < 0 || n >= re.length ? e : re[n];
}
function so(t) {
  return t <= 0 || t > ao ? "******" : ro[t - 1];
}
function Hs(t) {
  return so(ye(t));
}
...
function Ks(t) {
  return ro[t - 1].includes("*obsolete*");
}
function Us() {
  const t = {};
...
var lo = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(lo || {});
const dt = class X {
  constructor(e, n, o, a) {
    if (G(this, "firstChapter"), G(this, "lastChapter"), G(this, "lastVerse"), G(this, "hasSegmentsDefined"), G(this, "text"), G(this, "BBBCCCVVVS"), G(this, "longHashCode"), G(this, "versification"), G(this, "rtlMark", "‏"), G(this, "_bookNum", 0), G(this, "_chapterNum", 0), G(this, "_verseNum", 0), G(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof qt ? n : void 0;
        ...
        if (e != null && e instanceof X) {
          ...
          if (e == null) return;
          const s = e instanceof qt ? e : X.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let d;
    return i && (d = new qt(i)), n ? new X(n, o.toString(), l, d) : new X();
  }
  /**
  ...
  set versificationStr(e) {
    this.versification = this.versification != null ? new qt(e) : void 0;
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new qt(Ct[i]);
        } catch {
...
const co = U.allBookIds.filter(
  (t) => !U.isObsolete(U.bookIdToNumber(t))
), Zt = Object.fromEntries(
  co.map((t) => [t, U.bookIdToEnglishName(t)])
);
function qn(t, e, n) {
...
const po = $e(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? be : "button", { className: u(qs({ variant: e, size: n, className: t })), ref: s, ...a })
);
$.displayName = "Button";
const se = ue.Root, ie = ue.Trigger, xc = ue.Anchor, Xt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = st();
...
function Sn(t, e, n) {
  return `${t} ${Zt[t]}${e ? ` ${Yn(t, e)} ${de(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Js({
  recentSearches: t,
  ...
  return /* @__PURE__ */ c(se, { open: l, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ r(Xt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(Ht, { children: /* @__PURE__ */ r(Vt, { heading: s, children: t.map((p) => /* @__PURE__ */ c(
      At,
      {
        onSelect: () => w(p),
...
function yc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
  ...
  const o = Ws.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!p && d) {
          const m = ((g) => Object.keys(Zt).find(
            (y) => Zt[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function br({
  ...
  if (t)
    return /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r("div", { className: u("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Et(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      At,
      {
        value: `${t} ${Zt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Nc({
  ...
  const w = st(), [p, f] = D(!1), [h, m] = D(""), [g, y] = D(""), [k, S] = D("books"), [T, x] = D(void 0), [_, M] = D(!1), R = et(void 0), C = et(void 0), I = et(void 0), N = et(void 0), E = et({}), A = z(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    (v) => {
      const j = k === "chapters" ? T : O == null ? void 0 : O.book;
      j && (A({
        book: j,
        chapterNum: v,
        verseNum: 1
      }), f(!1), S("books"), x(void 0), y(""));
    },
    [A, k, T, O]
  ), mt = z(
    (v) => {
    ...
    (v) => {
      ...
      f(v), v && (S("books"), x(void 0), y(""));
    },
    [k, W]
  ), { otLong: it, ntLong: bt, dcLong: $t, extraLong: ht } = {
    ...
    (v) => {
      ...
      if (k === "chapters") {
        ...
        if (j || J) {
          if (v.preventDefault(), v.stopPropagation(), S("books"), x(void 0), J && T) {
            const lt = Zt[T];
            y(`${lt} ${v.key}`);
          } else
            y(v.key);
      ...
      if ((k === "chapters" || k === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const lt = k === "chapters" ? T : O == null ? void 0 : O.book;
        if (!lt) return;
        const ct = (() => {
          if (!h) return 1;
          const Ce = h.match(/(\d+)$/);
        ...
        switch (v.key) {
          case "ArrowLeft":
            ct !== 0 && (St = ct > 1 ? ct - 1 : Ut);
            break;
          case "ArrowRight":
            ct !== 0 && (St = ct < Ut ? ct + 1 : 1);
            break;
          case "ArrowUp":
            St = ct === 0 ? Ut : Math.max(1, ct - ir);
            break;
          case "ArrowDown":
            St = ct === 0 ? 1 : Math.min(Ut, ct + ir);
            break;
          default:
            return;
        }
        St !== ct && (v.preventDefault(), v.stopPropagation(), m(Sn(lt, a, St)), setTimeout(() => {
          const Ce = E.current[St];
    ...
    const { isLetter: j, isDigit: J } = gr(v.key);
    (j || J) && (v.preventDefault(), y((lt) => lt + v.key), C.current.focus(), M(!1));
  }, []);
  return Mt(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && I.current && N.current) {
        const j = I.current, J = N.current, lt = J.offsetTop, ct = j.clientHeight, Ut = J.clientHeight, St = lt - ct / 2 + Ut / 2;
        j.scrollTo({
          top: Math.max(0, St),
          behavior: "smooth"
        }), m(Sn(t.book));
    ...
    if (k === "chapters" && T) {
      ...
      setTimeout(() => {
        if (I.current)
          if (v) {
            const j = E.current[t.chapterNum];
  ...
  }, [k, T, O, t.book, t.chapterNum]), /* @__PURE__ */ c(se, { open: p, onOpenChange: wt, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
    ...
    /* @__PURE__ */ r(Xt, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      Gt,
      {
        ref: R,
        onKeyDown: Ge,
          ...
          k === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              $,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(ca, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(da, { className: "tw-h-4 tw-w-4" })
              }
            ),
            T && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: de(T, a) })
          ] }),
          !_ && /* @__PURE__ */ c(Ht, { ref: I, children: [
            k === "books" && /* @__PURE__ */ c(rt, { children: [
              !O && Object.entries(q).map(([v, j]) => {
                if (j.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Vt, { heading: on(v), children: j.map((J) => /* @__PURE__ */ r(
                      po,
                      {
                        bookId: J,
                        onSelect: (lt) => gt(lt),
              ...
              O && /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r(
                At,
                {
                  value: `${O.book} ${Zt[O.book]} ${O.chapterNum || ""}:${O.verseNum || ""})}`,
                  onSelect: nt,
...
), at = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Lr.Root, { ref: n, className: u("pr-twp", ti(), t), ...e }));
...
Jn.displayName = Me.Root.displayName;
const Ye = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Me.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Me.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(We, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Ye.displayName = Me.Item.displayName;
function ei(t) {
...
function Dn({
  ...
  const [T, x] = D(!1), _ = d ?? l, M = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], R = (C, I) => {
    const N = l(C), E = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, A = `${I ?? ""}${N}${E ?? ""}`;
    return /* @__PURE__ */ c(
      At,
      {
        value: N,
        ...
        children: [
          ...
          /* @__PURE__ */ c("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            N,
            E && /* @__PURE__ */ c("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              E
            ] })
          ] })
  ...
  return /* @__PURE__ */ c(se, { open: T, onOpenChange: x, ...S, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ee, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(
      Xt,
      {
        ...
        children: /* @__PURE__ */ c(Gt, { children: [
          ...
          /* @__PURE__ */ r(Ht, { children: M(e) ? e.map((C) => /* @__PURE__ */ r(Vt, { heading: C.groupHeading, children: C.options.map((I) => R(I, C.groupHeading)) }, C.groupHeading)) : e.map((C) => R(C)) })
        ] })
      }
    )
  ] });
...
var ri = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(ri || {});
    ...
    Jn,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(at, { className: "tw-flex tw-items-center", children: o.map((k) => U.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            $,
            {
...
const Ec = [
  ...
  "%no_comments%"
], oi = ["input", "select", "textarea", "button"], ai = ["button", "textbox"], si = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = et(null), [s, i] = D(void 0), [l, d] = D(void 0), w = z(
    (m) => {
      i(m);
      const g = t.find((k) => k.id === m);
      g && (e == null || e(g));
      const y = document.getElementById(m);
      y && (y.scrollIntoView({ block: "center" }), y.focus()), a.current && a.current.setAttribute("aria-activedescendant", m);
    },
    [e, t]
  ), p = z(
    (m) => {
      const g = t.find((y) => y.id === m);
      g && (d((y) => y === m ? void 0 : m), n == null || n(g));
    },
    [n, t]
  ), f = (m) => {
    if (!m) return !1;
    const g = m.tagName.toLowerCase();
    if (m.isContentEditable || oi.includes(g)) return !0;
    const y = m.getAttribute("role");
    if (y && ai.includes(y)) return !0;
    const k = m.getAttribute("tabindex");
    return k !== void 0 && k !== "-1";
  }, h = z(
    (m) => {
      var C;
      const g = m.target, y = (I) => I ? document.getElementById(I) : void 0, k = y(l), S = y(s);
      if (!!(k && g && k.contains(g) && g !== k) && f(g)) {
        if (m.key === "Escape" || m.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            m.preventDefault(), m.stopPropagation();
            const I = t.find((N) => N.id === l);
            I && w(I.id);
          }
          return;
        }
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          const N = I.findIndex((A) => A === g);
          if (N === -1) return;
          let E;
          m.key === "ArrowDown" ? E = Math.min(N + 1, I.length - 1) : E = Math.max(N - 1, 0), E !== N && (m.preventDefault(), m.stopPropagation(), (C = I[E]) == null || C.focus());
          return;
        }
        return;
      }
...
const mo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, li = mo ? Mt : Y, Xe = { tag: Br };
function wi({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = ii(null, o), p = ts({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: o });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (m.isEmpty()) {
            const g = Fn();
            m.append(g);
            const y = mo ? document.activeElement : null;
            (Ve() !== null || y !== null && y === f.getRootElement()) && g.select();
          }
        }, Xe);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const m = f.parseEditorState(h);
            f.setEditorState(m, Xe);
            break;
          }
          case "object":
            f.setEditorState(h, Xe);
            break;
          case "function":
            f.update(() => {
              ne().isEmpty() && h(f);
...
const Wn = {
  ...
  mark: "",
  markOverlap: ""
}, It = Be.Provider, zt = Be.Root, Qt = Be.Trigger, Ot = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Be.Content,
  {
    ref: o,
    sideOffset: e,
...
Ot.displayName = Be.Content.displayName;
const Zn = [
  hs,
  es,
  ns,
...
var vr = { error: null }, pi = function(t) {
  var e, n;
  function o() {
...
function ui({ children: t, onError: e }) {
  return r(pi, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const mi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function hi(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function fi() {
  return function(t) {
    const [e] = Rt(), n = B(() => t(e), [e, t]), [o, a] = D(() => n.initialValueFn()), s = et(o);
    return mi(() => {
...
function vi(t) {
  if (!bi(t, !1)) return !1;
  const e = ne().getChildren(), n = e.length;
  if (n > 1) return !1;
  for (let o = 0; o < n; o++) {
    const a = e[o];
    if (rs(a)) return !1;
...
function xi(t, e) {
  ...
  if (e.isSelected(t) && !as(e) && n !== null) {
    const [o, a] = n, s = t.isBackward(), i = o.getNode(), l = a.getNode(), d = e.is(i), w = e.is(l);
    if (d || w) {
      const [p, f] = ss(t), h = i.is(l), m = e.is(s ? l : i), g = e.is(s ? i : l);
      let y, k = 0;
      h ? (k = p > f ? f : p, y = p > f ? p : f) : m ? (k = s ? f : p, y = void 0) : g && (k = 0, y = s ? p : f), e.__text = e.__text.slice(k, y);
    }
  }
  return e;
}
const fo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yi = fo && "documentMode" in document ? document.documentMode : null;
!(!fo || !("InputEvent" in window) || yi) && "getTargetRanges" in new window.InputEvent("input");
function Qn(...t) {
  return () => {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Gn(y)) {
                const k = y.anchor;
                let S = k.getNode(), T = 0, x = 0;
                if (Ue(S) && w >= 0 && p >= 0 && (T = w, x = w + p, y.setTextNodeRange(S, T, S, x)), T === x && f === "" || (y.insertRawText(f), S = k.getNode()), Ue(S)) {
                  T = h, x = h + m;
                  const _ = S.getTextContentSize();
                  T = T > _ ? _ : T, x = x > _ ? _ : x, y.setTextNodeRange(S, T, S, x);
                }
...
function xr(t) {
  return t.getEditorState().read(ho(t.isComposing()));
}
function ki({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Rt(), a = function(s, i) {
    ...
    return On(() => s.registerDecoratorListener((w) => {
      ...
      for (let f = 0; f < p.length; f++) {
        const h = p[f], m = r(i, { onError: (y) => s._onError(y), children: r(la, { fallback: null, children: l[h] }) }), g = s.getElementByKey(h);
        g !== null && w.push(vs(m, g, h));
      }
      return w;
    }, [i, l, s]);
  }(o, n);
  return function(s) {
    On(() => Qn(gs(s), Ni(s)), [s]);
  }(o), c(rt, { children: [t, r(_i, { content: e }), a] });
}
function _i({ content: t }) {
...
function Ci({ defaultSelection: t }) {
  const [e] = Rt();
  return Y(() => {
    e.focus(() => {
...
const Ei = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function Ti({ onClear: t }) {
  const [e] = Rt();
  return Ei(() => e.registerCommand(zr, (n) => (e.update(() => {
    if (t == null) {
      const o = ne(), a = Ve(), s = Fn();
      o.clear(), o.append(s), a !== null && s.select(), Gn(a) && (a.format = 0);
    } else t();
  }), !0), is), [e, t]), null;
}
const go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : Y;
function Ri({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: m, className: g, id: y, role: k = "textbox", spellCheck: S = !0, style: T, tabIndex: x, "data-testid": _, ...M }, R) {
  const [C, I] = D(t.isEditable()), N = z((A) => {
    A && A.ownerDocument && A.ownerDocument.defaultView ? t.setRootElement(A) : t.setRootElement(null);
  }, [t]), E = B(() => /* @__PURE__ */ function(...A) {
    return (L) => {
      A.forEach((F) => {
  ...
  return go(() => (I(t.isEditable()), t.registerEditableListener((A) => {
    I(A);
  })), [t]), r("div", { "aria-activedescendant": C ? e : void 0, "aria-autocomplete": C ? n : "none", "aria-controls": C ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": C && k === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": C ? f : void 0, "aria-readonly": !C || void 0, "aria-required": h, autoCapitalize: m, className: g, contentEditable: C, "data-testid": _, id: y, ref: E, role: k, spellCheck: S, style: T, tabIndex: x, ...M });
}
const Si = $e(Ri);
function yr(t) {
  return t.getEditorState().read(ho(t.isComposing()));
...
function Ii(t, e) {
  ...
  return c(rt, { children: [r(Si, { editor: a, ...o, ref: e }), n != null && r(Oi, { editor: a, content: n })] });
}
function Oi({ content: t, editor: e }) {
  const n = function(i) {
    const [l, d] = D(() => yr(i));
    return go(() => {
      function w() {
...
function Vi({
  ...
  return /* @__PURE__ */ r(bo.Provider, { value: i, children: s });
}
function vo() {
  const t = jn(bo);
  if (!t)
...
function Ai() {
  const [t, e] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ r(Ms, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Zr, { children: [
...
function Pi({
  ...
  const [e] = Rt(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Ai(), d = () => {
  };
...
), Li = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Xr.Root,
  {
    ref: a,
    className: u(xo({ variant: e, size: n, className: t })),
    ...o
  }
));
Li.displayName = Xr.Root.displayName;
const yo = b.createContext({
  size: "default",
  variant: "default"
...
const Oe = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = b.useContext(yo);
  return /* @__PURE__ */ r(
    Ze.Item,
    {
      ref: s,
...
Oe.displayName = Ze.Item.displayName;
const Nr = [
  { format: "bold", icon: pa, label: "Bold" },
  { format: "italic", icon: ua, label: "Italic" },
  { format: "underline", icon: ma, label: "Underline" },
  { format: "strikethrough", icon: ha, label: "Strikethrough" }
];
function Bi() {
  const { activeEditor: t } = vo(), [e, n] = D([]), o = z((a) => {
    if (Gn(a) || xs(a)) {
      const s = [];
      Nr.forEach(({ format: i }) => {
...
function ji({
  ...
  return /* @__PURE__ */ c("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Pi, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Bi, {}) }) }),
      ...
      /* @__PURE__ */ r(
        ki,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Mi, { placeholder: t }) }),
          ErrorBoundary: ui
        }
      ),
      e && /* @__PURE__ */ r(Ci, { defaultSelection: "rootEnd" }),
  ...
  return /* @__PURE__ */ r("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ r(
    wi,
    {
      ...
      children: /* @__PURE__ */ c(It, { children: [
        /* @__PURE__ */ r(ji, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ r(
          di,
          {
...
function No(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = De(e) && e.excludeFromCopy("html");
  let i = e;
  if (o !== null) {
    let m = ws(e);
    m = Ue(m) && o !== null ? xi(o, m) : m, i = m;
  }
  const l = De(i) ? i.getChildren() : [], d = cs(t, i.getType());
  let w;
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], y = No(t, g, h, o);
    !a && De(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((ds(p) || pr(p)) && p.append(h), n.append(p), f) {
      const m = f.call(i, p);
...
const ko = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function _o(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (ko.has(t.nodeName)) return i;
  let l = null;
  const d = function(g, y) {
    const { nodeName: k } = g, S = y._htmlConversions.get(k.toLowerCase());
    let T = null;
    if (S !== void 0) for (const x of S) {
      const _ = x(g);
      _ !== null && (T === null || (T.priority || 0) <= (_.priority || 0)) && (T = _);
    }
  ...
  let h = [];
  const m = (l == null || !ps(l)) && (l != null && kn(l) || o);
  for (let g = 0; g < f.length; g++) h.push(..._o(f[g], e, n, m, new Map(a), l));
  return p != null && (h = p(h)), ur(t) && (h = Xi(t, h, m ? () => {
    const g = new Gr();
    return n.push(g), g;
  ...
  }(t) && (i = i.concat(Hr())) : De(l) && l.append(...h), i;
}
function Xi(t, e, n) {
...
function Ui(t) {
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(e, "text/html"), i = Gi(n, s);
      ne().clear(), us(i);
    },
    {
      discrete: !0
...
const Yi = Ft(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: u("pr-twp", Yi({ variant: e }), t), ...n })
);
...
const Wi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: u("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
To.displayName = ve.Root.displayName;
const Qi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ve.Image,
  {
    ref: n,
...
Qi.displayName = ve.Image.displayName;
...
Ro.displayName = ve.Fallback.displayName;
const nr = zn(void 0);
function kt() {
  const t = jn(nr);
  if (!t)
...
}), Ne = Z.Trigger, So = Z.Group, tl = Z.Portal, el = Z.Sub, nl = Z.RadioGroup;
function le({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(nr.Provider, { value: n, children: /* @__PURE__ */ r(Z.Root, { ...e }) });
}
const Do = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = kt();
  return /* @__PURE__ */ c(
    Z.SubTrigger,
    {
...
Do.displayName = Z.SubTrigger.displayName;
const Io = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Z.SubContent,
  {
    ref: n,
    className: u(
...
Io.displayName = Z.SubContent.displayName;
const Kt = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = st();
...
Kt.displayName = Z.Content.displayName;
...
qe.displayName = Z.Item.displayName;
...
jt.displayName = Z.CheckboxItem.displayName;
  ...
  return /* @__PURE__ */ c(
    Z.RadioItem,
    {
      ...
      className: u(
        "tw-relative tw-flex tw-cursor-default tw-select-none tw-items-center tw-rounded-sm tw-py-1.5 tw-pe-2 tw-ps-8 tw-text-sm tw-outline-none tw-transition-colors focus:tw-bg-accent focus:tw-text-accent-foreground data-[disabled]:tw-pointer-events-none data-[disabled]:tw-opacity-50",
        t,
        Pt({ variant: a.variant })
        // CUSTOM use context to add variants
      ),
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(We, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Oo.displayName = Z.RadioItem.displayName;
const je = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Z.Label,
  {
    ref: o,
...
je.displayName = Z.Label.displayName;
...
ke.displayName = Z.Separator.displayName;
...
function kr({
  ...
  const [f, h] = D(!1), [m, g] = D(), [y, k] = D(!1), S = et(null);
  Y(() => {
    let N = !0;
    if (!o) {
      k(!1);
  ...
  const T = z(() => {
    ...
    return Wt(n["%comment_dateAtTime%"], {
      date: E,
      time: A
    });
  }, [t.date, n]), M = B(() => t.user, [t.user]), R = B(
    ...
    if (o && y)
      return /* @__PURE__ */ c(rt, { children: [
        !qa(t.contents) && /* @__PURE__ */ c(
          qe,
          {
            onClick: () => {
              h(!0), g(Ui(dr(t.contents))), d == null || d(!0);
            },
            children: [
        ...
        /* @__PURE__ */ c(
          qe,
          {
            ...
            children: [
              /* @__PURE__ */ r(ga, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(To, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ro, { className: "tw-text-xs tw-font-medium", children: R }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: S,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), T()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Lt(m) && x());
              },
              onKeyDown: (N) => {
        ...
        o && p && !e && a !== "Resolved" && s && /* @__PURE__ */ r(
          $,
          {
            ...
            onClick: (N) => {
              N.stopPropagation(), s({ threadId: t.thread, status: "Resolved" });
            },
            children: /* @__PURE__ */ r(Tt, {})
          }
        ),
        I && /* @__PURE__ */ c(le, { children: [
          /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Or, {}) }) }),
          /* @__PURE__ */ r(Kt, { align: "end", children: I })
        ] })
      ]
    }
  );
...
function ol({
  ...
  const [S, T] = D(_r), [x, _] = D(!1), [M, R] = D(!1), [C, I] = D(!1), [N, E] = D(!1), [A, L] = D(!1), [F, V] = D(void 0), [q, O] = D(!1), [nt, gt] = D(!1);
  Y(() => {
    let v = !0;
    if (!n) {
      O(!1), gt(!1);
    ...
    return (async () => {
      ...
      if (!v) return;
      const lt = y ? await y(l) : !1;
      v && (O(J), gt(lt));
    })(), () => {
      v = !1;
    };
  }, [n, l, g, y]);
  const xt = B(() => t.filter((v) => !v.deleted), [t]), mt = B(() => xt[0], [xt]), P = et(null), W = et(void 0), wt = z(() => {
    var v;
    (v = W.current) == null || v.call(W), T(_r);
  }, []);
  Y(() => {
    const v = P.current;
    if (!v) return;
  ...
  const it = B(
    ...
    const v = Ke(a, e);
    return Wt(e["%comment_assigned_to%"], {
      assignedUser: v
    });
  }, [a, e]), $t = B(() => xt.slice(1), [xt]), ht = B(() => $t.length ?? 0, [$t.length]), on = B(() => ht > 0, [ht]), an = B(() => C || ht <= 2 ? $t : $t.slice(-2), [$t, ht, C]), we = B(() => C || ht <= 2 ? 0 : ht - 2, [ht, C]), Fe = B(
    () => ht === 1 ? it.singleReply : Wt(it.multipleReplies, { count: ht }),
    [ht, it]
  ), sn = B(
    () => we === 1 ? it.singleReply : Wt(it.multipleReplies, { count: we }),
    [we, it]
  ), Ge = z(async () => {
    const v = Lt(S) ? Vn(S) : void 0;
    if (F !== void 0) {
      await w({
        threadId: l,
        contents: v,
    ...
    async (v) => {
      const j = Lt(S) ? Vn(S) : void 0, J = await w({
        ...v,
        contents: j,
  ...
  return /* @__PURE__ */ r(
    er,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(Eo, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            M && /* @__PURE__ */ r(
              $,
              {
                ...
                size: "icon",
                onClick: (v) => {
                  v.stopPropagation(), _(!x);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": x ? "Collapse text" : "Expand text",
                children: x ? /* @__PURE__ */ r(xn, {}) : /* @__PURE__ */ r(ee, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
          ...
          n && /* @__PURE__ */ c(rt, { children: [
            ...
            m !== !1 && (!N || Lt(S)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Lt(S) || F !== void 0) && Ge());
                },
                onKeyDown: (v) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    F !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: Wt(
                    ...
                    /* @__PURE__ */ c(se, { open: A, onOpenChange: L, children: [
                      ...
                      /* @__PURE__ */ r(
                        Xt,
                        {
                          ...
                          children: /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(Ht, { children: h == null ? void 0 : h.map((v) => /* @__PURE__ */ r(
                            At,
                            {
                              onSelect: () => {
                                V(v !== a ? v : void 0), L(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ r("span", { children: Ke(v, e) })
                            },
                            v || "unassigned"
                          )) }) })
                        }
...
function Tc({
  ...
  const [h, m] = D(), g = e.filter(
    ...
    m(R);
  }, []), { listboxRef: T, activeId: x, handleKeyDown: _ } = si({
    options: y,
    onOptionSelect: k
  }), M = z(
    (R) => {
      R.key === "Escape" ? (m(void 0), R.preventDefault(), R.stopPropagation()) : _(R);
    },
    [_]
  );
  return /* @__PURE__ */ r(
...
function al({ table: t }) {
  return /* @__PURE__ */ c(le, { children: [
    /* @__PURE__ */ r(ys, { asChild: !0, children: /* @__PURE__ */ c($, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(va, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(Kt, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r(je, { children: "Toggle columns" }),
      /* @__PURE__ */ r(ke, {}),
...
const fe = ot.Root, sl = ot.Group, ge = ot.Value, il = Ft(
...
), oe = b.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = st();
  return /* @__PURE__ */ c(
    ot.Trigger,
    {
      className: u(il({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(ot.Icon, { asChild: !0, children: /* @__PURE__ */ r(ee, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
oe.displayName = ot.Trigger.displayName;
...
Mo.displayName = ot.ScrollUpButton.displayName;
...
Vo.displayName = ot.ScrollDownButton.displayName;
const ae = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = st();
...
ae.displayName = ot.Content.displayName;
...
ll.displayName = ot.Label.displayName;
...
wl.displayName = ot.Separator.displayName;
function cl({ table: t }) {
      ...
      /* @__PURE__ */ c(
        fe,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(ae, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(vt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Ae(i, '[tabindex]:not([tabindex="-1"])').forEach((p) => {
...
const pl = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? Ae(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
const Dt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      ) : [], g = m.indexOf(f), y = l.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), hl(m, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), ml(l, y, p.key);
...
function gl({
  ...
  var R;
  const [p, f] = D([]), [h, m] = D([]), [g, y] = D({}), [k, S] = D({}), T = B(() => e ?? [], [e]), x = Yr({
    data: T,
    columns: t,
    getCoreRowModel: Jr(),
    ...n && { getPaginationRowModel: ks() },
    onSortingChange: f,
  ...
  let M;
  return d ? M = Array.from({ length: 10 }).map((N, E) => `skeleton-row-${E}`).map((N) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(te, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(An, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((R = x.getRowModel().rows) == null ? void 0 : R.length) > 0 ? M = x.getRowModel().rows.map((C) => /* @__PURE__ */ r(
    Dt,
    {
      onClick: () => i(C, x),
      "data-state": C.getIsSelected() && "selected",
      children: C.getVisibleCells().map((I) => /* @__PURE__ */ r(te, { children: Ie(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    C.id
  )) : M = /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(te, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(al, { table: x }),
    /* @__PURE__ */ c(Qe, { stickyHeader: s, children: [
      /* @__PURE__ */ r(tn, { stickyHeader: s, children: x.getHeaderGroups().map((C) => /* @__PURE__ */ r(Dt, { children: C.headers.map((I) => /* @__PURE__ */ r(Pe, { children: I.isPlaceholder ? void 0 : Ie(I.column.columnDef.header, I.getContext()) }, I.id)) }, C.id)) }),
...
function Rc({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Es, { options: s, children: e })
    }
  );
}
...
function Dc({
  ...
  return /* @__PURE__ */ c(se, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(Xt, { id: s, className: u("tw-min-w-80 tw-max-w-96", a), children: [
...
var xl = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(xl || {});
function Ic({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(le, { children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ c($, { variant: "default", children: [
      /* @__PURE__ */ r(_a, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ee, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Kt, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      /* @__PURE__ */ r(je, { children: w.label }),
      /* @__PURE__ */ r(So, { children: w.itemType === 0 ? /* @__PURE__ */ r(rt, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        jt,
        {
          checked: o[p][h],
        ...
        nl,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Oo, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(ke, {})
    ] }, w.label)) })
...
function yl({ id: t, versionHistory: e }) {
...
function Mc({
  ...
  const i = B(() => Wa(n), [n]), d = ((w) => {
    const p = new Intl.DisplayNames(Za(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(yl, { versionHistory: a }),
...
function Nl({
  ...
  const [S, T] = D(!1), x = z(
    (E) => {
      var L;
      const A = (L = t.find((F) => F.label === E)) == null ? void 0 : L.value;
      A && n(
    ...
    if (!h) return t;
    const E = t.filter((L) => L.starred).sort((L, F) => L.label.localeCompare(F.label)), A = t.filter((L) => !L.starred).sort((L, F) => {
  ...
  return /* @__PURE__ */ r("div", { id: k, className: g, children: /* @__PURE__ */ c(se, { open: I, onOpenChange: p ?? T, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Xt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(Gt, { children: [
      ...
      /* @__PURE__ */ c(Ht, { children: [
        ...
        /* @__PURE__ */ r(Vt, { children: M.map((E) => /* @__PURE__ */ c(
          At,
          {
            value: E.label,
            onSelect: x,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(Ra, { className: "tw-h-4 tw-w-4" }),
...
const kl = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(rt, { children: [
...
function _l({
  ...
  const [s, i] = D(t), [l, d] = D(n);
  return Y(() => {
    i(t);
  }, [t]), Y(() => {
    l !== n && d(n);
  }, [n]), /* @__PURE__ */ c(le, { onOpenChange: (p) => {
    p || (s !== "custom" || l ? (e(s), o(l)) : (i(t), d(n)));
  }, children: [
    /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(zt, { children: [
      /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "outline", className: "tw-h-6", children: kl(t, a, n) }) }) }),
      /* @__PURE__ */ r(Ot, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ c(Kt, { className: "tw-z-[300]", children: [
      /* @__PURE__ */ r(je, { children: a["%footnoteEditor_callerDropdown_label%"] }),
      /* @__PURE__ */ r(ke, {}),
      /* @__PURE__ */ r(
        jt,
        {
...
const Cl = (t, e) => t === "f" ? /* @__PURE__ */ c(rt, { children: [
  /* @__PURE__ */ r(Ar, {}),
  " ",
  ...
  return t === "f" && (n = e["%footnoteEditor_noteType_footnote_label%"]), Wt(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function Tl({
  ...
  return /* @__PURE__ */ c(le, { children: [
    /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(zt, { children: [
      /* @__PURE__ */ r(ms, { asChild: !0, children: /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(
        $,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Ot, { children: /* @__PURE__ */ r("p", { children: El(t, n) }) })
    ] }) }),
    t !== "x" && /* @__PURE__ */ c(Kt, { className: "tw-z-[300]", children: [
      /* @__PURE__ */ r(je, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ r(ke, {}),
      /* @__PURE__ */ c(
        jt,
        {
...
function Ac({
  ...
  const l = et(null), d = wa(), [w, p] = D("generated"), [f, h] = D("*"), [m, g] = D("f"), y = B(
    () => ({
      ...s,
      markerMenuTrigger: s.markerMenuTrigger ?? "\\",
      hasExternalUI: !0,
      view: { ...s.view ?? Ts(), noteMode: "expanded" }
    }),
    [s]
  );
  Y(() => {
    ...
    if (_ && pn("note", _)) {
      const C = (M = _.insert.note) == null ? void 0 : M.caller;
      let I = "custom";
      C === _n ? I = "generated" : C === Cn ? I = "hidden" : C && h(C), p(I), g(((R = _.insert.note) == null ? void 0 : R.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), x = setTimeout(() => {
        var N;
        (N = l.current) == null || N.applyUpdate([{ delete: 1 }, _]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const k = z(() => {
    var _, M;
    const x = (M = (_ = l.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : M.at(0);
    x && pn("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? _n : Cn), e([x]));
  }, [w, f, e]), S = () => {
    var _;
    const x = (_ = d.current) == null ? void 0 : _.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ r(
          Tl,
          {
            ...
            handleNoteTypeChange: (x) => {
              var M, R, C;
              g(x);
              const _ = (R = (M = l.current) == null ? void 0 : M.getNoteOps(0)) == null ? void 0 : R.at(0);
              _ && pn("note", _) && (_.insert.note && (_.insert.note.style = x), (C = l.current) == null || C.applyUpdate([{ delete: 1 }, _]));
            },
            localizedStrings: i
          }
        ),
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(zt, { children: [
          /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Le, {}) }) }),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ r(Rs, { options: y, onScrRefChange: () => {
          }, scrRef: o, ref: l }),
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(zt, { children: [
            /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Mr, {}) }) }),
...
function Dl({
  ...
  return /* @__PURE__ */ c(rt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: u("textual-note-body tw-pr-0.5", m), children: l && l.length > 0 && /* @__PURE__ */ r(rt, { children: Rl(t.marker, l, o, w) }) })
  ] });
}
const $c = ["%webView_footnoteList_header%"], Il = (t, e) => t[e] ?? e;
function Lc({
  className: t,
  classNameForItems: e,
  footnotes: n,
  ...
  const f = p ? Il(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? Qa(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
  }, g = s ? n.findIndex((x) => x === s) : 0, [y, k] = D(g), S = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
          x.preventDefault(), k((_) => Math.min(_ + 1, n.length - 1));
          break;
        case "ArrowUp":
          x.preventDefault(), k((_) => Math.max(_ - 1, 0));
          break;
        case "Enter":
        case " ":
          x.preventDefault(), w == null || w(n[y], y, a);
          break;
      }
  }, T = et([]);
  return Y(() => {
    var x;
    y >= 0 && y < T.current.length && ((x = T.current[y]) == null || x.focus());
  }, [y]), /* @__PURE__ */ c(rt, { children: [
  ...
  return /* @__PURE__ */ c(Qe, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(en, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Dt,
      {
        ...
        children: [
          /* @__PURE__ */ r(te, { children: `${U.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(te, { children: Ol(i.text) })
        ]
      },
...
const nn = (t) => t === "asc" ? /* @__PURE__ */ r(Ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Va, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Aa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Bc = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Al = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Xc = Object.freeze([
...
function Kc({
  ...
  const f = _t(n, "%webView_inventory_all%"), h = _t(n, "%webView_inventory_approved%"), m = _t(n, "%webView_inventory_unapproved%"), g = _t(n, "%webView_inventory_unknown%"), y = _t(n, "%webView_inventory_scope_currentBook%"), k = _t(n, "%webView_inventory_scope_chapter%"), S = _t(n, "%webView_inventory_scope_verse%"), T = _t(n, "%webView_inventory_filter_text%"), x = _t(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = _t(n, "%webView_inventory_no_results%"), [M, R] = D(!1), [C, I] = D("all"), [N, E] = D(""), [A, L] = D([]), F = B(() => {
    const P = t ?? [];
    return P.length === 0 ? [] : $l(P, a, s);
  }, [t, a, s]), V = B(() => {
    if (M) return F;
    const P = [];
    return F.forEach((W) => {
      const wt = W.items[0], it = P.find(
        (bt) => bt.items[0] === wt
      );
      it ? (it.count += W.count, it.occurrences = it.occurrences.concat(W.occurrences)) : P.push({
        items: [wt],
        count: W.count,
  ...
  }, [M, F]), q = B(() => V.length === 0 ? [] : Pl(V, C, N), [V, C, N]), O = B(() => {
    var wt, it;
    if (!M) return d;
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ c(
        fe,
        {
          ...
          defaultValue: C,
          children: [
            /* @__PURE__ */ r(oe, { className: "tw-m-1", children: /* @__PURE__ */ r(ge, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ c(fe, { onValueChange: (P) => gt(P), defaultValue: i, children: [
        /* @__PURE__ */ r(oe, { className: "tw-m-1", children: /* @__PURE__ */ r(ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(ae, { children: [
          /* @__PURE__ */ r(vt, { value: "book", children: y }),
          /* @__PURE__ */ r(vt, { value: "chapter", children: k }),
          /* @__PURE__ */ r(vt, { value: "verse", children: S })
        ] })
      ] }),
      /* @__PURE__ */ r(
        _e,
...
function Yc({ localizedStrings: t, markerMenuItems: e }) {
  return /* @__PURE__ */ c(Gt, { className: "tw-bg-white", children: [
    /* @__PURE__ */ r(xe, { placeholder: t["%markerMenu_searchPlaceholder%"] }),
    /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ r(ze, { children: t["%markerMenu_noResults%"] }),
      /* @__PURE__ */ r(Vt, { children: e.map((n) => /* @__PURE__ */ c(
        At,
        {
          className: "tw-flex tw-gap-2 hover:tw-bg-accent",
          disabled: n.isDisallowed || n.isDeprecated,
          onSelect: n.action,
          children: [
            /* @__PURE__ */ r("div", { className: "tw-w-6", children: n.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: n.marker }) : /* @__PURE__ */ r("div", { children: n.icon }) }),
            /* @__PURE__ */ c("div", { children: [
              /* @__PURE__ */ r("p", { className: "tw-text-sm", children: n.title }),
              n.subtitle && /* @__PURE__ */ r("p", { className: "tw-text-xs tw-text-muted-foreground", children: n.subtitle })
            ] }),
            (n.isDisallowed || n.isDeprecated) && /* @__PURE__ */ r(no, { className: "tw-font-sans", children: n.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${n.title}`
      )) })
...
const Ll = "16rem", Bl = "3rem", Po = b.createContext(void 0);
function rn() {
...
const $o = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), f = e ?? w, h = b.useCallback(
      ...
      [n, f]
    ), m = b.useCallback(() => h((x) => !x), [h]), g = f ? "expanded" : "collapsed", S = st() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Po.Provider, { value: T, children: /* @__PURE__ */ r(It, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
$o.displayName = "SidebarProvider";
const Lo = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = rn();
...
const zl = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    $,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Pa, {}) : /* @__PURE__ */ r($a, {}),
...
Hl.displayName = "SidebarFooter";
const Xl = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  he,
  {
    ref: n,
...
Xl.displayName = "SidebarSeparator";
...
const Kl = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? be : "button",
  {
    ref: o,
...
Kl.displayName = "SidebarGroupAction";
...
Fo.displayName = "SidebarMenuItem";
const Ul = Ft(
  ...
  ({
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Qt, { asChild: !0, children: p }),
      /* @__PURE__ */ r(Ot, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
Go.displayName = "SidebarMenuButton";
const Yl = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? be : "button",
  {
    ref: a,
...
Yl.displayName = "SidebarMenuAction";
...
ql.displayName = "SidebarMenuBadge";
const Jl = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Jl.displayName = "SidebarMenuSkeleton";
...
Wl.displayName = "SidebarMenuSub";
const Zl = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Zl.displayName = "SidebarMenuSubItem";
const Ql = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? be : "a",
  {
    ref: s,
...
Ql.displayName = "SidebarMenuSubButton";
function tw({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    Lo,
    {
      ...
      children: /* @__PURE__ */ c(zo, { children: [
        /* @__PURE__ */ c(Pn, { children: [
          /* @__PURE__ */ r($n, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Ln, { children: /* @__PURE__ */ r(jo, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Fo, { children: /* @__PURE__ */ r(
            Go,
            {
              onClick: () => w(h),
              isActive: f(h),
    ...
    /* @__PURE__ */ c(
      $o,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bo, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Bt = "scrBook", ew = "scrRef", Jt = "source", nw = "details", rw = "Scripture Reference", ow = "Scripture Book", Ho = "Type", aw = "Details";
function sw(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? U.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Bt ? ce(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Jt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Ho : void 0,
    ...
    },
    {
      ...
      id: nw,
      header: (t == null ? void 0 : t.detailsColumnName) ?? aw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Tr = (t) => `${iw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jc({
  sources: t,
  ...
  const [w, p] = D([]), [f, h] = D([{ id: Bt, desc: !1 }]), [m, g] = D({}), y = B(
    () => t.flatMap((N) => N.data.map((E) => ({
      ...E,
      source: N.source
    }))),
    [t]
  ...
  const S = Yr({
    ...
    getExpandedRowModel: Cs(),
    getGroupedRowModel: _s(),
    getCoreRowModel: Jr(),
    getSortedRowModel: qr(),
    getRowId: Tr,
    autoResetExpanded: !1,
  ...
  Y(() => {
    if (l) {
      const N = S.getSelectedRowModel().rowsById, E = Object.keys(N);
      if (E.length === 1) {
        const A = y.find((L) => Tr(L) === E[0]) || void 0;
        A && l(A);
      }
    }
  }, [m, y, l, S]);
  const T = a ?? ow, x = s ?? Ho, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${T}`, value: [Bt] },
    { label: `Group by ${x}`, value: [Jt] },
    {
    ...
    !N.getIsGrouped() && !N.getIsSelected() && N.getToggleSelectedHandler()(E);
  }, C = (N, E) => N.getIsGrouped() ? "" : u("banded-row", E % 2 === 0 ? "even" : "odd"), I = (N, E, A) => {
    if (!((N == null ? void 0 : N.length) === 0 || E.depth < A.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ c(
      fe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ae, { position: "item-aligned", children: /* @__PURE__ */ r(sl, { children: _.map((N) => /* @__PURE__ */ r(vt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Qe, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(tn, { children: S.getHeaderGroups().map((N) => /* @__PURE__ */ r(Dt, { children: N.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Pe, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ r(en, { children: S.getRowModel().rows.map((N, E) => {
        const A = st();
        return /* @__PURE__ */ r(
          Dt,
          {
            ...
            children: N.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== Jt || !n)))
                return /* @__PURE__ */ r(
                  te,
                  {
                    className: u(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ c(
                      $,
                      {
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ r(ee, {}),
                          !N.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ r(pe, {}) : /* @__PURE__ */ r(vn, {})),
                          " ",
                          Ie(L.column.columnDef.cell, L.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
...
}), Xo = (t, e, n) => sr(t, e).every((o) => n.includes(o));
function lw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    $,
    {
      ...
      onClick: () => o(t),
      className: u(
        Xo(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Ys(
        t,
...
function ww({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: m, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [k, S] = D(!1), [T, x] = D(""), _ = et(void 0), M = et(!1);
  if (t.length !== U.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const R = B(() => U.allBookIds.filter(
    ...
    (V, q = !1) => {
      ...
      const O = R.findIndex((P) => P === _.current), nt = R.findIndex((P) => P === V);
      if (O === -1 || nt === -1) return;
      const [gt, xt] = [
        Math.min(O, nt),
        Math.max(O, nt)
      ], mt = R.slice(gt, xt + 1).map((P) => P);
      n(
    ...
    (V) => {
      const q = sr(R, V).map((O) => O);
      n(
        Xo(R, V, e) ? e.filter((O) => !q.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, R]
  ), L = () => {
    ...
    /* @__PURE__ */ c(
      se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Xt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            Gt,
            {
              shouldFilter: !1,
              onKeyDown: (V) => {
...
function Zc({
  ...
  const w = Yt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Yt(i, "%webView_scope_selector_current_book%"), m = Yt(i, "%webView_scope_selector_choose_books%"), g = Yt(i, "%webView_scope_selector_scope%"), y = Yt(i, "%webView_scope_selector_select_books%"), k = [
  ...
  ], S = e ? k.filter((T) => e.includes(T.value)) : k;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Jn,
        {
          ...
          children: S.map(({ value: T, label: x, id: _ }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Ye, { className: "tw-me-2", value: T, id: _ }),
...
function Qc({
  ...
  return /* @__PURE__ */ c(
    fe,
    {
      ...
      children: [
        /* @__PURE__ */ r(oe, { size: a, className: u("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          ge,
          {
            placeholder: l[K(e)] ?? e
          }
...
function Je({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const Uo = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(zt, { children: [
  /* @__PURE__ */ r(Qt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    qe,
    {
      onClick: () => {
        o(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(Je, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(Je, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ c(el, { children: [
    /* @__PURE__ */ r(Do, { children: l.label }),
    /* @__PURE__ */ r(tl, { children: /* @__PURE__ */ r(Io, { children: Uo(
      t,
      e,
      Ko(t, l.id),
      o
...
function Bn({
  ...
  return /* @__PURE__ */ c(le, { variant: s, children: [
    /* @__PURE__ */ r(Ne, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r($, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ba, {}) }) }),
    /* @__PURE__ */ r(Kt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(Sr, { children: [
      /* @__PURE__ */ r(So, { children: /* @__PURE__ */ r(It, { children: Uo(e.groups, e.items, d, t) }) }),
      w < p.length - 1 && /* @__PURE__ */ r(ke, {})
    ] }, d)) })
  ] });
}
...
function rd({
  ...
  return /* @__PURE__ */ c(Yo, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Bn,
      {
        onSelectMenuItem: t,
...
function od({
  ...
  return /* @__PURE__ */ r(Yo, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    Bn,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const qo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ut.Root,
    {
...
Jo.displayName = ut.List.displayName;
...
)), Wo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Content,
  {
    ref: n,
    className: u(
...
Wo.displayName = ut.Content.displayName;
function ad({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(qo, { children: [
      /* @__PURE__ */ r(Jo, { children: t.map((l) => /* @__PURE__ */ r(cw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Wo, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function dw({ ...t }) {
...
const Zo = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
Zo.displayName = Q.Root.displayName;
const Qo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = kt();
  return /* @__PURE__ */ r(
    Q.Trigger,
    {
      ...
      className: u(
        ...
        // CUSTOM
        "pr-twp",
        Pt({ variant: o.variant, className: t })
        // CUSTOM use context to add variants
      ),
      ...e
    }
...
Qo.displayName = Q.Trigger.displayName;
const ta = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = kt();
  return /* @__PURE__ */ c(
    Q.SubTrigger,
    {
      ...
      className: u(
        ...
        e && "tw-pl-8",
        Pt({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
ta.displayName = Q.SubTrigger.displayName;
const ea = b.forwardRef(({ className: t, ...e }, n) => {
  const o = kt();
  return /* @__PURE__ */ r(
    Q.SubContent,
    {
...
ea.displayName = Q.SubContent.displayName;
const na = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = kt();
...
na.displayName = Q.Content.displayName;
const ra = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = kt();
  return /* @__PURE__ */ r(
    Q.Item,
    {
      ...
      className: u(
        ...
        e && "tw-pl-8",
        Pt({ variant: a.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...n
...
ra.displayName = Q.Item.displayName;
const uw = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = kt();
  return /* @__PURE__ */ c(
    Q.CheckboxItem,
    {
...
uw.displayName = Q.CheckboxItem.displayName;
const mw = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(We, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
mw.displayName = Q.RadioItem.displayName;
const hw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Q.Label,
  {
    ref: o,
    className: u("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
hw.displayName = Q.Label.displayName;
...
oa.displayName = Q.Separator.displayName;
const Te = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(zt, { children: [
      /* @__PURE__ */ r(Qt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        ra,
        {
          onClick: () => {
            o(w);
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ r(Je, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ r(Je, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
        `menubar-item-${w.label}-${w.command}`
      ) : /* @__PURE__ */ c(pw, { children: [
        /* @__PURE__ */ r(ta, { children: w.label }),
        /* @__PURE__ */ r(ea, { children: aa(
          t,
          e,
          Ko(t, w.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(oa, {}, `separator-${s}`)), d;
  });
};
function fw({
  menuData: t,
  ...
  const a = et(void 0), s = et(void 0), i = et(void 0), l = et(void 0), d = et(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Ss(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var g, y, k, S;
    p.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Te(s, [h, m]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Te(i, [h, m]);
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), Te(l, [h, m]);
        break;
      case "alt+h":
        (S = d.current) == null || S.focus(), Te(d, [h, m]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(Zo, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(dw, { children: [
      /* @__PURE__ */ r(Qo, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        na,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(It, { children: aa(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function ld({
  ...
  const w = gw(
    ...
    a && a(g), o && o([g, ...n.filter((y) => y !== g)]), s && n.find((y) => y === g) && s([...n.filter((y) => y !== g)]), f(!1);
  }, m = (g, y) => {
    var S, T, x, _, M, R;
    const k = y !== g ? ((T = (S = t[g]) == null ? void 0 : S.uiNames) == null ? void 0 : T[y]) ?? ((_ = (x = t[g]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return k ? `${(M = t[g]) == null ? void 0 : M.autonym} (${k})` : (R = t[g]) == null ? void 0 : R.autonym;
  };
  return /* @__PURE__ */ c("div", { id: d, className: u("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(at, { className: "tw-font-normal tw-text-muted-foreground", children: Wt(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => m(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function bw({ item: t, createLabel: e, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ c(le, { children: [
              /* @__PURE__ */ r(Ne, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Or, {}) }) }),
              /* @__PURE__ */ r(Kt, { align: "end", children: l })
            ] })
          ] }),
...
const vw = $e(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fa, { size: 35, className: u("tw-animate-spin", t), ...e, ref: n }));
...
), yw = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Nw.displayName = "AlertTitle";
const kw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: u("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
kw.displayName = "AlertDescription";
const pd = tt.Root, ud = tt.Trigger, md = tt.Group, hd = tt.Portal, fd = tt.Sub, gd = tt.RadioGroup, _w = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  tt.SubTrigger,
  {
    ref: a,
    className: u(
...
_w.displayName = tt.SubTrigger.displayName;
const Cw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.SubContent,
  {
    ref: n,
...
Cw.displayName = tt.SubContent.displayName;
const Ew = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(tt.Portal, { children: /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: u(
...
Ew.displayName = tt.Content.displayName;
...
Tw.displayName = tt.Item.displayName;
const Rw = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ c(
  tt.CheckboxItem,
  {
    ref: a,
    className: u(
...
Rw.displayName = tt.CheckboxItem.displayName;
const Sw = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  tt.RadioItem,
  {
    ref: o,
    className: u(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(tt.ItemIndicator, { children: /* @__PURE__ */ r(We, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Sw.displayName = tt.RadioItem.displayName;
const Dw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: u(
...
Dw.displayName = tt.Label.displayName;
...
Iw.displayName = tt.Separator.displayName;
...
function Mw({
  ...
  return /* @__PURE__ */ r(sa.Provider, { value: o, children: /* @__PURE__ */ r(
    Nt.Root,
    {
...
Mw.displayName = "Drawer";
const bd = Nt.Trigger, Vw = Nt.Portal, vd = Nt.Close, ia = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Nt.Overlay,
  {
    ref: n,
...
ia.displayName = Nt.Overlay.displayName;
const Aw = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(sa), i = {
...
Lw.displayName = Nt.Title.displayName;
...
Bw.displayName = Nt.Description.displayName;
...
zw.displayName = Tn.Root.displayName;
function xd({
  className: t,
  ...e
}) {
...
function Nd({
  ...
  return /* @__PURE__ */ r(
    Hn.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Ga, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function kd({ ...t }) {
...
jw.displayName = Re.Root.displayName;
const Fw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    Rn.Root,
    {
...
Fw.displayName = Rn.Root.displayName;
const _d = ut.Root, Gw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ut.List,
    {
...
Gw.displayName = ut.List.displayName;
...
Hw.displayName = ut.Trigger.displayName;
...
Xw.displayName = ut.Content.displayName;
...
export {
  yw as Alert,
  kw as AlertDescription,
  Nw as AlertTitle,
  To as Avatar,
  Ro as AvatarFallback,
  Qi as AvatarImage,
  kc as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  _c as BOOK_SELECTOR_STRING_KEYS,
  me as Badge,
  Nc as BookChapterControl,
  ri as BookSelectionMode,
  Cc as BookSelector,
  $ as Button,
  Ec as COMMENT_LIST_STRING_KEYS,
  er as Card,
  Eo as CardContent,
  ...
  Tc as CommentList,
  pd as ContextMenu,
  Rw as ContextMenuCheckboxItem,
  Ew as ContextMenuContent,
  md as ContextMenuGroup,
  Tw as ContextMenuItem,
  Dw as ContextMenuLabel,
  hd as ContextMenuPortal,
  gd as ContextMenuRadioGroup,
  Sw as ContextMenuRadioItem,
  Iw as ContextMenuSeparator,
  Ow as ContextMenuShortcut,
  fd as ContextMenuSub,
  Cw as ContextMenuSubContent,
  _w as ContextMenuSubTrigger,
  ud as ContextMenuTrigger,
  gl as DataTable,
  Mw as Drawer,
  vd as DrawerClose,
  Aw as DrawerContent,
  Bw as DrawerDescription,
  $w as DrawerFooter,
  Pw as DrawerHeader,
  ia as DrawerOverlay,
  Vw as DrawerPortal,
  ...
  xl as DropdownMenuItemType,
  je as DropdownMenuLabel,
  tl as DropdownMenuPortal,
  nl as DropdownMenuRadioGroup,
  Oo as DropdownMenuRadioItem,
  ke as DropdownMenuSeparator,
  rl as DropdownMenuShortcut,
  el as DropdownMenuSub,
  Io as DropdownMenuSubContent,
  Do as DropdownMenuSubTrigger,
  Ne as DropdownMenuTrigger,
  bl as ERROR_DUMP_STRING_KEYS,
  Sc as ERROR_POPOVER_STRING_KEYS,
  vl as ErrorDump,
  Dc as ErrorPopover,
  Pc as FOOTNOTE_EDITOR_STRING_KEYS,
  $c as FOOTNOTE_LIST_STRING_KEYS,
  Vc as Filter,
  Ic as FilterDropdown,
  Mc as Footer,
  Ac as FootnoteEditor,
  Dl as FootnoteItem,
  Lc as FootnoteList,
  Xc as INVENTORY_STRING_KEYS,
  _e as Input,
  Kc as Inventory,
  at as Label,
  Uc as MARKER_MENU_STRING_KEYS,
  Rc as MarkdownRenderer,
  Yc as MarkerMenu,
  Oc as MoreInfo,
  Nl as MultiSelectComboBox,
  ad as NavigationContentSearch,
  se as Popover,
  xc as PopoverAnchor,
  ...
  Js as RecentSearches,
  Nd as ResizableHandle,
  yd as ResizablePanel,
  xd as ResizablePanelGroup,
  cd as ResultsCard,
  Wc as SCOPE_SELECTOR_STRING_KEYS,
  Zc as ScopeSelector,
  Jc as ScriptureResultsViewer,
  Qc as ScrollGroupSelector,
  ar as SearchBar,
  fe as Select,
  ae as SelectContent,
  sl as SelectGroup,
  ...
  he as Separator,
  td as SettingsList,
  nd as SettingsListHeader,
  ed as SettingsListItem,
  tw as SettingsSidebar,
  qc as SettingsSidebarContentSearch,
  Lo as Sidebar,
  zo as SidebarContent,
  Hl as SidebarFooter,
  Pn as SidebarGroup,
  Kl as SidebarGroupAction,
  ...
  Bo as SidebarInset,
  jo as SidebarMenu,
  Yl as SidebarMenuAction,
  ql as SidebarMenuBadge,
  Go as SidebarMenuButton,
  Fo as SidebarMenuItem,
  Jl as SidebarMenuSkeleton,
  Wl as SidebarMenuSub,
  ...
  Kw as Textarea,
  tr as ToggleGroup,
  Oe as ToggleGroupItem,
  id as Toolbar,
  zt as Tooltip,
  Ot as TooltipContent,
  It as TooltipProvider,
  Qt as TooltipTrigger,
  ld as UiLanguageSelector,
  qo as VerticalTabs,
  Wo as VerticalTabsContent,
  Jo as VerticalTabsList,
  cw as VerticalTabsTrigger,
  Yi as badgeVariants,
  qs as buttonVariants,
  u as cn,
  Hc as getBookIdFromUSFM,
  Fc as getLinesFromUSFM,
  Gc as getNumberFromUSFM,
  Al as getStatusForItem,
  sd as getToolbarOSReservedSpaceClassName,
  zc as inventoryCountColumn,
  Bc as inventoryItemColumn,
  jc as inventoryStatusColumn,
  il as selectTriggerVariants,
  Sd as sonner,
  Cd as useEvent,
  Ed as useEventAsync,
  si as useListbox,
  Yw as usePromise,
  yc as useRecentSearches,
  rn as useSidebar
};
