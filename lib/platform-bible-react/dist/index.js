...
import { c as v, g as ye, a as Wr, C as Ee, u as Li, T as zt, b as Rt, d as Dt, e as Ot, A as ce, P as $e, f as Ye, B as G, h as Ie, i as Ae, j as Pe, k as Ne, l as ji, m as Fi, n as Bi, E as Ui, o as Ya, r as fe, p as Ki, q as pn, s as aa, t as oa, L as Ct, R as Xa, v as Yr, D as Da, w as Oa, x as Ma, y as $a, z as hn, F as jr, G as Ja, H as gn, I as Za, J as He, K as kr, M as Ve, N as Le, O as je, S as _r, Q as er, U as qi, V as Er, W as We, X as De, Z as Xe, Y as Re, _ as rr, $ as Qa, a0 as to, a1 as Xr, a2 as eo, a3 as fn, a4 as Hi, a5 as Gi, a6 as Wi, a7 as Ia, a8 as mn, a9 as na, aa as vn, ab as Yi, ac as Xi, ad as Ji, ae as Zi, af as bn, ag as Qi, ah as ga, ai as No, aj as fa, ak as ts, al as es, am as rs, an as as, ao as os, ap as Tr, aq as ro, ar as ns, as as is } from "./resizable-TaQzxFXa.js";
import { at as hg, au as gg, av as fg, aw as mg, ax as vg, ay as bg, az as xg, aA as yg, aB as kg, aC as _g, aD as Ng, aE as Cg, aF as Eg, aG as Tg, aH as Sg, aI as zg, aJ as Rg, aK as Dg, aL as Og, aM as Mg, aN as $g, aO as Ig, aP as Ag, aQ as Pg } from "./resizable-TaQzxFXa.js";
...
import { Section as ut, getChaptersForBook as js, formatScrRef as ke, getSectionForBook as br, formatRelativeDate as Fs, formatReplacementString as Ge, sanitizeHtml as oo, NumberFormat as En, formatBytes as Bs, getCurrentLocale as Us, usfmMarkers as Fr, getFormatCallerFunction as Ks, deepEqual as qs, isString as So, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Hs, getLocalizeKeyForScrollGroupId as zo, formatReplacementStringToArray as Ro, collectUsjMarkers as Gs } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as O, createContext as ia, useContext as no, useState as k, useEffect as W, useCallback as j, useImperativeHandle as Ws, useLayoutEffect as Xt, Component as Ys, createElement as Do, Suspense as Xs, forwardRef as Tn, useId as Oo, Fragment as sa } from "react";
...
import { Avatar as lo, Select as qt, Checkbox as Ao, Slot as zr, Tabs as le, Menubar as me, ContextMenu as Mt, Progress as Po, Slider as $r, Switch as Vo } from "radix-ui";
...
function ul({
  ...
  W(() => {
    ...
    if (!N) return;
    const V = () => {
      const X = l.current, U = !!X && X.scrollWidth > X.clientWidth;
      (y || U) && b(!0);
    }, K = () => b(!1);
...
function xa({
  ...
  const T = fe(), L = wl(), A = F ?? L, [N, V] = k(!1), [K, E] = k(""), [X, U] = k(""), [$, M] = k("books"), [z, tt] = k(void 0), [q, kt] = k(
    void 0
  ), [lt, $t] = k(void 0), [Y, rt] = k(!1), ft = B(null), dt = B(!1), pt = B(void 0), Ht = B(void 0), nt = B(void 0), Zt = B(void 0), Gt = B({}), Qt = B({}), xt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), te = O(() => o ? o() : Ki, [o]), It = O(() => ({
    [ut.OT]: te.filter((H) => bt.isBookOT(H)),
    [ut.NT]: te.filter((H) => bt.isBookNT(H)),
    [ut.DC]: te.filter((H) => bt.isBookDC(H)),
    [ut.Extra]: te.filter((H) => bt.extraBooks().includes(H))
  ...
  const ee = j(() => {
    ...
    (x) => {
      const H = q ?? (R == null ? void 0 : R.book), Q = lt ?? (R == null ? void 0 : R.chapterNum);
      !H || !Q || (xt({
        book: H,
        chapterNum: Q,
        verseNum: x
    ...
    (x) => {
      const H = $ === "chapters" ? z : R == null ? void 0 : R.book;
      if (H) {
        if (d && d(H, x) > 1) {
          kt(H), $t(x), M("verses"), E("");
          return;
    ...
    V(x), x && (M("books"), tt(void 0), kt(void 0), $t(void 0), U(""));
  }, []);
  W(() => {
    D && st(!1);
  }, [D, st]);
  ...
  const { otLong: Et, ntLong: Lt, dcLong: Tt, extraLong: Te } = {
    ...
    [t.book, n, A]
  ), Be = `${t.chapterNum}:${t.verseNum}`, ur = j((x) => (H) => {
    Gt.current[x] = H;
  }, []), pr = j((x) => (H) => {
    Qt.current[x] = H;
  }, []), hr = O(
    ...
    (x) => {
      var ne, Ze, xe;
      if (x.ctrlKey) return;
      const { isLetter: H, isDigit: Q } = jo(x.key);
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Ft = Ht.current) == null || Ft.focus();
      return;
    }
    const { isLetter: H, isDigit: Q } = jo(x.key);
    (H || Q) && (x.preventDefault(), U((ne) => ne + x.key), Ht.current.focus(), rt(!1));
  }, []);
  return Xt(() => {
    const x = setTimeout(() => {
      if (N && $ === "books" && nt.current && Zt.current) {
        const H = nt.current, Q = Zt.current, Ft = Q.offsetTop, ne = H.clientHeight, Ze = Q.clientHeight, xe = Ft - ne / 2 + Ze / 2;
        H.scrollTo({
          top: Math.max(0, xe),
          behavior: "smooth"
        }), E(Hn(t.book));
    ...
    if ($ === "chapters" && z) {
      const x = z === t.book, H = x ? t.chapterNum : 1;
      E(
        `${z} ${ce[z] || ""} ${H}`
      ), setTimeout(() => {
        if (nt.current)
    ...
    if ($ === "verses" && q && lt !== void 0) {
      const x = q === t.book && lt === t.chapterNum, H = x ? t.verseNum : 1;
      E(
        `${q} ${ce[q] || ""} ${lt}:${H}`
      ), setTimeout(() => {
        if (nt.current)
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: H } = x;
          N && ft.current && H instanceof Node && ft.current.contains(H) && (dt.current = !0, st(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Ae,
            ...
            children: [
              $ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ht.map(
                  ({ onClick: x, disabled: H, title: Q, icon: Ft }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                $ === "verses" && q && lt !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ye(q, n)} ${lt}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !Y && /* @__PURE__ */ u(Pe, { ref: nt, children: [
                $ === "books" && /* @__PURE__ */ u(ct, { children: [
                  !R && Object.entries(At).map(([x, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ne, { heading: S(x), children: H.map((Q) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: Q,
                            onSelect: (Ft) => Z(Ft),
                ...
                $ === "verses" && q && lt !== void 0 && d && /* @__PURE__ */ a(
                  Bo,
                  {
                    bookId: q,
                    chapterNum: lt,
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Yn ? Xt : W, Pr = { tag: io };
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((T || L) && D !== null && F !== null) {
        const A = function(N, V, K, E, X, U, $) {
          const M = (N._window ? N._window.document : document).createRange();
          return M.setStart(...Ko(V, K, E)), M.setEnd(...Ko(X, U, $)), M;
        }(t, h, f, D, g, C, F);
        l(), l = Al(t, A, e);
      }
...
let Zr, _e = 0, Qr = 0, Hl = 0, qa = 0, Kr = 0;
function Ho(t) {
  if (ot === void 0) return;
  let e = t.n;
...
const Ha = oe({ build: (t) => ai(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const ed = oe({ config: Je({ setOptions: Wo, updateOptions: Wo }), init: ({ $initialEditorState: t = td }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const ad = /* @__PURE__ */ new Set(), Jo = oe({ build(t, e, r) {
  const o = r.getDependency(Ha).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ai(() => {
  }, () => ge(() => {
...
}, dependencies: [Ha], name: "@lexical/extension/NodeSelection" }), od = Cc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends ja {
  static getType() {
...
oe({ dependencies: [Ha, Jo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
...
function sp({
  ...
  const [i, s] = k(Ad), [c, l] = k(n), [d, w] = k(!1), p = B(void 0), h = B(null);
  W(() => {
    let m = !0;
    const C = h.current;
    if (!C) return;
...
function yi({
  ...
  const [E, X] = k(an), [U, $] = k(), [M, z] = k(), tt = o, [q, kt] = k(!1), [lt, $t] = k(!1), [Y, rt] = k(!1), [ft, dt] = k(!1), [pt, Ht] = k(!1), [nt, Zt] = k(D), [Gt, Qt] = k(!1), xt = B(void 0), [te, It] = k(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
  ...
  const R = O(() => At[0], [At]), be = B(null), ee = B(void 0), P = j(() => {
    var S;
  ...
  }, [i, r]), ht = O(() => At.slice(1), [At]), et = O(() => ht.length ?? 0, [ht.length]), gt = O(() => et > 0, [et]), st = O(() => q || et <= 2 ? ht : ht.slice(-2), [ht, et, q]), mt = O(() => q || et <= 2 ? 0 : et - 2, [et, q]), Vt = O(
  ...
  const Lt = j(
    ...
    async (S) => {
      const jt = ae(E) ? ea(E) : void 0, _t = S.status ? S.assignedUser : U ?? S.assignedUser, de = await p({
        ...S,
        contents: jt,
        assignedUser: _t
      });
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            m !== !1 && (!lt || ae(E)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  bo(S) && (S.preventDefault(), S.stopPropagation(), (ae(E) || U !== void 0 && U !== M) && Lt());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    U !== void 0 && (ae(E) || U !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
...
), Ud = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Hr = (t) => Ud(oo(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Kd({
  ...
  }, U = (M) => p && M.value === "reject", $ = (M) => {
    const z = f === M.value, tt = `${d}-${M.value}`, q = U(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Xa,
          {
            ...
            children: T.map((M) => U(M) ? /* @__PURE__ */ a(zt, { delayDuration: 0, children: /* @__PURE__ */ u(Rt, { children: [
...
function fp({
  ...
  const N = r.filter(
    ...
    [y, b]
  ), { listboxRef: X, activeId: U, handleKeyDown: $ } = qi({
    options: V,
    onOptionSelect: K
  }), M = j(
    (z) => {
      ...
      children: N.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(Yd, { ...tt, conflictResolution: C }) : /* @__PURE__ */ a(yi, { ...tt })
          },
          z.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    qt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(qt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Sn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ep({
  ...
  const [f, b] = k("generated"), [m, C] = k("generated"), [y, _] = k("*"), [D, F] = k("*"), [T, L] = k("f"), [A, N] = k(!1), [V, K] = k(!0), [E, X] = k(!1), U = B(!1), $ = B(""), [M, z] = k(!1), [tt, q] = k(), [kt, lt] = k(), [$t, Y] = k(), [rt, ft] = k(), dt = B(null), pt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const xt = () => {
    ...
    (P) => {
      ...
      if (Z && Ir("note", Z)) {
        ...
        if (st || N(!1), N(
          ...
          U.current = !0, $.current = JSON.stringify(Z), K(!0);
          return;
        }
    ...
    if (h.current && Ht.length && P && P.rangeCount > 0) {
      const Z = P.getRangeAt(0).getBoundingClientRect(), at = h.current.getBoundingClientRect();
      q(Z.left - at.left), lt(Z.top - at.top), Y(Z.height), z(!0);
    }
  }, [Ht, h]);
  W(() => {
    const P = () => {
...
function Ap({
  ...
  const g = ue(r, "%webView_inventory_all%"), f = ue(r, "%webView_inventory_approved%"), b = ue(r, "%webView_inventory_unapproved%"), m = ue(r, "%webView_inventory_unknown%"), C = ue(r, "%webView_inventory_scope_currentBook%"), y = ue(r, "%webView_inventory_scope_chapter%"), _ = ue(r, "%webView_inventory_scope_verse%"), D = ue(r, "%webView_inventory_filter_text%"), F = ue(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ue(r, "%webView_inventory_no_results%"), [L, A] = k(!1), [N, V] = k("all"), [K, E] = k(""), [X, U] = k([]), $ = O(() => {
    const Y = t ?? [];
  ...
  W(() => {
    z.length === 0 ? U([]) : z.length === 1 && U(z[0].items);
  }, [z]);
  const q = (Y, rt) => {
    rt.setRowSelection(() => {
      const dt = {};
...
const Ow = "16rem", Mw = "3rem", Ni = Yt.createContext(void 0);
function ua() {
  const t = Yt.useContext(Ni);
  if (!t)
...
function $w({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((_) => !_), [p]), g = w ? "expanded" : "collapsed", m = fe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
const ze = "scrBook", Uw = "scrRef", qe = "source", Kw = "details", qw = "Scripture Reference", Hw = "Scripture Book", Ci = "Type", Gw = "Details";
function Ww(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, wn = (t) => `${Yw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jp({
  sources: t,
        ...
        return /* @__PURE__ */ a(
          Re,
          {
            ...
            children: N.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== qe || !r)))
                return /* @__PURE__ */ a(
                  rr,
                  {
                    className: v(
...
function Xw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = k(!1), [C, y] = k(""), _ = B(void 0), D = B(!1), F = O(
    () => Ei(t),
    [t]
  ), T = O(() => {
    if (!C.trim()) {
    ...
    (E, X = !1) => {
      ...
      const U = F.findIndex((q) => q === _.current), $ = F.findIndex((q) => q === E);
      if (U === -1 || $ === -1) return;
      const [M, z] = [
        Math.min(U, $),
        Math.max(U, $)
      ], tt = F.slice(M, z + 1).map((q) => q);
      r(
        e.includes(E) ? e.filter((q) => !tt.includes(q)) : [.../* @__PURE__ */ new Set([...e, ...tt])]
      );
    },
    [e, r, F]
  ), A = (E) => {
...
function Qp({
  ...
  const D = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), E = St(s, "%webView_scope_selector_scope%"), X = St(s, "%webView_scope_selector_select_books%"), U = St(s, "%webView_scope_selector_range%"), $ = St(s, "%webView_scope_selector_select_range%"), M = St(s, "%webView_scope_selector_range_start%"), z = St(s, "%webView_scope_selector_range_end%"), tt = St(s, "%webView_scope_selector_ok%"), q = St(s, "%webView_scope_selector_cancel%"), kt = St(s, "%webView_scope_selector_navigate%"), lt = (I) => {
    if (!f) return;
  ...
  ], Y = (I, J, Wt = !1) => /* @__PURE__ */ u(ct, { children: [
    I,
    ...
    [r, n, f, i]
  ), it = rt.find((I) => I.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((I) => I.toUpperCase()).join(", ") : t === "range" ? Hs(dt, pt, {
  ...
  ), gr = te === "end", Rr = te === "start", Ue = "tw:text-muted-foreground", Se = d === "dropdown" && Et === "range", Dr = Se ? jt : P, ha = Se ? de : g ? Z : Ht, Or = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const re = j(
    ...
    var J;
    I.preventDefault(), (J = H.current) == null || J.focus();
      ...
      d === "dropdown" ? /* @__PURE__ */ u(Ve, { open: mt, onOpenChange: Vt, children: [
        ...
        /* @__PURE__ */ a(
          je,
          {
            ...
            children: /* @__PURE__ */ u(ga, { container: xe, children: [
              et.map(({ value: I, label: J, dropdownLabel: Wt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                He,
                {
                  ref: x(I),
        ...
        Xa,
        {
          ...
          children: rt.map(({ value: I, label: J, scrRefSuffix: Wt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(Ct, { htmlFor: fr, children: Y(J, Wt) })
          ] }, fr))
        }
      )
    ] }),
      ...
      Oa,
      {
        ...
        children: /* @__PURE__ */ u(ga, { container: ne, children: [
          ...
          /* @__PURE__ */ u(No, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => we(!1), children: q }),
...
const au = Object.freeze([520, 420, 340]), Di = Yt.forwardRef(
...
const Oi = Yt.forwardRef(({ className: t, ...e }, r) => {
  const o = fe();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
const Mi = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: v(
...
const ou = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
