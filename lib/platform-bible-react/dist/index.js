...
import { c as b, g as Re, a as Ir, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as ze, f as ke, h as Ie, i as kr, j as Be, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Ze, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ta, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Wn, al as Xn, am as Do, an as Os, ao as Jn, ap as Ba, aq as tn, ar as ja, as as zs, at as Is, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-DS23Qslu.js";
import { aB as rf, aC as af, aD as of, aE as nf, aF as sf, aG as cf, aH as lf, aI as df, aJ as wf, aK as uf, aL as pf, aM as hf, aN as gf, aO as ff, aP as mf, aQ as vf, aR as bf, aS as xf, aT as yf, aU as kf, aV as _f, aW as Nf, aX as Cf, aY as Ef, aZ as Tf, a_ as Sf, a$ as Rf, b0 as Df, b1 as Mf, b2 as Of, b3 as zf, b4 as If, b5 as Pf, b6 as Af, b7 as $f, b8 as Vf, b9 as Lf, ba as Bf } from "./resizable-DS23Qslu.js";
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [I, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, z] = _(void 0), [q, it] = _(
    void 0
    ...
    if (!A) return;
    const v = M.startsWith(`${A.book} `) ? M : "", H = ta(v), at = zr(v);
    return {
      book: A.book,
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Jt : W, ra = { tag: Io };
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...q })
          },
          z.id
        );
      })
...
function Nh({
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      I !== "x" && R === "x" ? nt == null || nt.forEach((ct) => mu(ct)) : I === "x" && R !== "x" && (nt == null || nt.forEach((ct) => vu(ct))), (et = h.current) == null || et.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (R) => {
...
function Ih({
  ...
  }, [B, rt]), z = V(() => O.length === 0 ? [] : Su(O, D, Y), [O, D, Y]), q = V(() => {
    var vt, pt;
    if (!B) return l;
    ...
    /* @__PURE__ */ u(
      Ou,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Iu, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
...
function Jh({
  ...
  ), Cr = Rt === "end", Er = Rt === "start", nr = "tw:text-muted-foreground", We = p === "dropdown" && K === "range", Ia = We ? et : Ut, Pa = We ? ct : x ? $e : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const Wr = j(
    ...
    y !== void 0 && (y === "range" ? ($ && (m == null || m($)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), It(y), X(void 0), G(void 0));
  }, [
    y,
    $,
    nt,
