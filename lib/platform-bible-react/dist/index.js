...
import { c as m, g as De, a as La, C as Me, A as ce, P as Ie, b as Ge, B as q, d as Ae, e as qe, f as He, h as ye, i as Pi, k as ji, j as Bi, E as Li, l as Fa, r as re, m as Fi, n as ln, o as Zr, p as Ua, L as kt, D as ka, q as _a, s as Na, t as Ca, T as Ft, u as Ka, v as Ut, w as Kt, x as Gt, y as dn, z as Ga, F as Fe, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ui, N as Nr, O as Ke, Q as Oe, Z as Ye, R as Re, U as tr, V as qa, W as Ha, X as Kr, Y as Ya, _ as wn, $ as Ki, a0 as Gi, a1 as qi, a2 as Ea, a3 as pn, a4 as Qr, a5 as un, a6 as Hi, a7 as Yi, a8 as Wi, a9 as Xi, aa as hn, ab as Ji, ac as na, ad as xo, ae as ia, af as Zi, ag as Qi, ah as ts, ai as es, aj as rs, ak as Cr, al as Wa } from "./resizable-31R2bzLZ.js";
import { am as Fh, an as Uh, ao as Kh, ap as Gh, aq as qh, ar as Hh, as as Yh, at as Wh, au as Xh, av as Jh, aw as Zh, ax as Qh, ay as tg, az as eg, aA as rg, aB as ag, aC as og, aD as ng, aE as ig, aF as sg, aG as cg, aH as lg, aI as dg, aJ as wg, aK as pg } from "./resizable-31R2bzLZ.js";
import { jsx as a, jsxs as p, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ar, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as as, ArrowRight as os, ChevronDown as or, BoldIcon as ns, ItalicIcon as is, X as Xa, AtSign as gn, Pencil as ss, Trash2 as cs, ArrowUp as fn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as ps, FilterIcon as us, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as mn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Ns, AlertCircle as Sa, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Ds, ChevronsUpDown as Rs, MenuIcon as Os, Menu as $s, EllipsisVertical as Ms, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as As, formatReplacementString as Ue, sanitizeHtml as Ja, NumberFormat as Vs, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as Vr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as sa, defaultScrRef as ca, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as Us, collectUsjMarkers as Ks } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as I, useState as _, useCallback as L, useEffect as W, useImperativeHandle as Gs, useLayoutEffect as Zt, createContext as Za, useContext as yn, Component as qs, createElement as To, Suspense as Hs, forwardRef as kn, useId as zo, Fragment as Qa } from "react";
import { RadioGroup as Ra, ToggleGroup as _n, Avatar as to, Select as Lt, Checkbox as So, Slot as Er, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as Do, Slider as Rr, Switch as Ro } from "radix-ui";
import { createEditor as Nn, $getRoot as $e, $createParagraphNode as Tr, $getSelection as Yt, HISTORY_MERGE_TAG as eo, ParagraphNode as Cn, TextNode as En, $getPreviousSelection as Ys, $isRangeSelection as ue, $caretFromPoint as Ws, $getSiblingCaret as Tn, $getChildCaret as Xs, $getAdjacentChildCaret as Js, $isChildCaret as Zs, $normalizeCaret as Qs, $setSelectionFromCaretRange as tc, $getCollapsedCaretRange as ec, $getCaretInDirection as Oo, $splitAtPointCaretNext as rc, $isTextPointCaret as ac, $findMatchingParent as zn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as oc, isHTMLElement as nc, CLEAR_EDITOR_COMMAND as Sn, COMMAND_PRIORITY_EDITOR as ro, shallowMergeConfig as ic, defineExtension as ae, safeCast as We, createState as sc, FORMAT_TEXT_COMMAND as Dn, $isNodeSelection as Rn, COMMAND_PRIORITY_LOW as On, RootNode as cc, LineBreakNode as lc, TabNode as dc, $isEditorState as wc, createCommand as pc, CLICK_COMMAND as uc, isDOMNode as hc, $getNodeFromDOMNode as gc, $createNodeSelection as fc, $setSelection as mc, $getEditor as vc, DecoratorNode as Oa, $getState as bc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as xc, $setState as yc, addClassNamesToElement as $n, $create as kc, $getNodeByKey as _c, removeClassNamesFromElement as Nc, KEY_TAB_COMMAND as Cc, $isBlockElementNode as Ec, $createRangeSelection as Tc, $normalizeSelection__EXPERIMENTAL as zc, OUTDENT_CONTENT_COMMAND as Sc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Dc, COMMAND_PRIORITY_CRITICAL as ao, $isDecoratorNode as Rc, $isParagraphNode as Oc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as $c } from "lexical";
...
import { useReactTable as An, getFilteredRowModel as Fc, getSortedRowModel as Vn, getPaginationRowModel as Uc, getCoreRowModel as Pn, flexRender as vr, getGroupedRowModel as Kc, getExpandedRowModel as Gc } from "@tanstack/react-table";
import { IconCheck as ea, IconChevronDown as qc, IconChevronUp as Hc, IconSelector as Yc, IconLayoutSidebar as Wc, IconLayoutSidebarRight as Xc, IconChevronRight as jn, IconLoader as Jc, IconAlertOctagon as Zc, IconAlertTriangle as Qc, IconInfoCircle as tl, IconCircleCheck as el } from "@tabler/icons-react";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as al, isInsertEmbedOpOfType as Or, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function cl({
  ...
  return /* @__PURE__ */ p(Ie, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((h) => /* @__PURE__ */ p(
      Me,
      {
        onSelect: () => g(h),
...
function Fp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function da({
  ...
  const A = re(), [B, T] = _(!1), [V, $] = _(""), [N, j] = _(""), [R, E] = _("books"), [Y, G] = _(void 0), [F, O] = _(
    void 0
  ), [S, Z] = _(void 0), [Q, _t] = _(!1), Nt = K(null), At = K(!1), U = K(void 0), tt = K(void 0), wt = K(void 0), st = K(void 0), vt = K({}), oe = K({}), at = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const { otLong: gt, ntLong: ut, dcLong: ft, extraLong: Dt } = {
    ...
    () => wl(N),
    [N]
  ), yt = I(() => !l || !D || !D.chapterNum || !$t ? !1 : l(D.book, D.chapterNum) > 0, [l, D, $t]), de = L(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), Te = L(
    (b) => (H) => w ? pl(b, H, w) : !1,
              ...
              R === "books" ? /* @__PURE__ */ p("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    ...
                    tabIndex: -1,
                    children: A === "ltr" ? /* @__PURE__ */ a(as, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(os, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
function jo({
  ...
  const [k, A] = _(!1), B = l ?? d, T = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, N) => {
  ...
  return /* @__PURE__ */ p(Ie, { open: k, onOpenChange: A, ...y, children: [
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        style: i,
        children: /* @__PURE__ */ p(qe, { children: [
...
function Gp({
  ...
  const w = wa(l, "%webView_bookSelector_currentBook%"), u = wa(l, "%webView_bookSelector_choose%"), g = wa(l, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Kn ? Zt : W, Mr = { tag: eo };
function vl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = fl(null, o), w = Nn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (u) => s(u, w), theme: o });
    return function(u, g) {
      if (g !== null) {
        if (g === void 0) u.update(() => {
          ...
          case "string": {
            ...
            u.setEditorState(h, Mr);
            break;
          }
          case "object":
            u.setEditorState(g, Mr);
            break;
          case "function":
            u.update(() => {
              $e().isEmpty() && g(u);
...
function Tl() {
  return function(t) {
    const [e] = fe(), r = I(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = K(o);
    return Cl(() => {
...
function Rl(t, e, r) {
  ...
  function d() {
    ...
    for (let C = 0; C < h.length; C++) {
      const y = h[C], k = s[C] || document.createElement("div"), A = k.style;
      A.position !== "absolute" && (A.position = "absolute", v = !0);
      const B = pe(y.left - u);
      A.left !== B && (A.left = B, v = !0);
      const T = pe(y.top - g);
      A.top !== T && (k.style.top = T, v = !0);
      const V = pe(y.width);
      A.width !== V && (k.style.width = V, v = !0);
      const $ = pe(y.height);
      A.height !== $ && (k.style.height = $, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[C] = k;
    }
...
function $l(t, e = Ol) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(u), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), k = h.offset, A = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || A !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || k !== c || y !== i.getKey();
      if ((T || V) && A !== null && B !== null) {
        const $ = function(N, j, R, E, Y, G, F) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Bo(j, R, E)), O.setEnd(...Bo(Y, G, F)), O;
        }(t, g, f, A, h, C, B);
        d(), d = Rl(t, $, e);
      }
      r = f, o = A, n = v, i = C, s = B, c = k;
    });
  }
...
function Al(t) {
  ...
  if (ue(e)) r = Ws(e.focus, "next");
    ...
    r = r || Xs($e(), "previous").getFlipped().insert(Tr());
  }
...
function Vl(t, e, r) {
  ...
  return ac(o) && qr(283), o.insert(t.isInline() ? Tr().append(t) : t), Oo(Tn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Yt();
  if (!ue(e)) return !1;
...
let Hr, xe = 0, Yr = 0, Ll = 0, Va = 0, jr = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ul(t) {
  ...
  Hn(this), nt = t, this.f &= -2, 8 & this.f && so(this), ra();
}
function Ze(t, e) {
...
Bt.prototype.brand = jl, Bt.prototype.h = function() {
  ...
  if (this.g = jr, this.f |= 1, this.i > 0 && !qn(this)) return this.f &= -2, !0;
  const t = nt;
  try {
    Uo(this), nt = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yn(this), Uo(this), xe++;
  const t = nt;
...
function Xn(t, e = Wn) {
  return t.registerCommand(Sn, (r) => (t.update(e), !0), ro);
}
...
const ua = sc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Jn extends Oa {
  $config() {
    return this.config("decorator-text", { extends: Oa, stateConfigs: [{ flat: !0, stateConfig: ua }] });
  }
  getFormat() {
    return bc(this, ua);
  }
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Dn, (o) => {
  const n = Yt();
  if (Rn(n) || ue(n)) for (const i of n.getNodes()) Gl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function Zn(t, e) {
  let r;
...
const Pa = ae({ build: (t) => Zn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, ja = 1, ti = 2, ha = 3, Ir = 4, Je = 5, ga = 6, gr = 7;
function fa(t) {
  return t.id === co;
}
function ei(t) {
...
function ql(t) {
  return function(e) {
    return e.id === ja;
  }(t) || lt(305, String(t.id), String(ja)), Object.assign(t, { id: ti });
}
...
const Xl = ae({ config: We({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [cc, En, lc, dc, Cn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function qo() {
}
function Jl(t) {
  throw t;
...
class rr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      fa(i) || lt(300, s, n || "[unknown]"), fa(c = i) || lt(304, String(c.id), String(co)), i = Object.assign(c, { id: ja }), o.state = i;
...
const Zl = /* @__PURE__ */ new Set(), Ho = ae({ build(t, e, r) {
  const o = r.getDependency(Pa).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Zn(() => {
  }, () => he(() => {
...
ae({ dependencies: [Pa, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Ho).output, n = _r({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ce(t.registerCommand(Ql, (s) => {
    ...
    return !0;
  }, ro), t.registerCommand(uc, (s) => {
    if (hc(s.target)) {
      const c = gc(s.target);
      if (ed(c)) return function(d, l = !1) {
        const w = Yt(), u = d.isSelected(), g = d.getKey();
        let h;
        l && Rn(w) ? h = w : (h = fc(), mc(h)), u ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
function kd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(ka, { open: !0, onOpenChange: r, children: /* @__PURE__ */ p(_a, { children: [
...
function _d({
  ...
  const [e] = fe(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = kd(), d = () => {
  };
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ a(
          vl,
          {
            ...
            children: /* @__PURE__ */ p(Ft, { children: [
...
function ui({
  ...
  return /* @__PURE__ */ p(Ka, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
...
const Rd = "verseText", qp = Object.freeze([
...
function Hp({
  ...
  const [i, s] = _(Od), [c, d] = _(n), [l, w] = _(!1), u = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ p(Ie, { open: l, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ae,
        {
          ...
          children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(He, { children: t.map((v) => /* @__PURE__ */ a(
            Me,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
...
function Zo({
  ...
  const h = L(
    ...
    [t.user]
  ), y = I(() => Ja(t.contents), [t.contents]), k = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), A = !!t.conflictResolutionAction && !k, B = I(() => {
    if (o && c)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          Fe,
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), u(Dd(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : uo(T) && (T.preventDefault(), T.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (T) => {
                po(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ p(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ls, {}) }) }),
...
function vi({
  ...
  const [E, Y] = _(Qo), [G, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, At] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, oe] = _(!1), [at, Vt] = _(A), [St, Wt] = _(!1), ne = K(void 0), [D, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  const Qt = I(() => Ct[0], [Ct]), me = K(null), ie = K(void 0), P = L(() => {
    var z;
    (z = ie.current) == null || z.call(ie), Y(Qo);
  }, []), X = L(() => {
    const z = !at;
  ...
  }, [i, r]), pt = I(() => Ct.slice(1), [Ct]), ct = I(() => pt.length ?? 0, [pt.length]), gt = I(() => ct > 0, [ct]), ut = I(() => Q || ct <= 2 ? pt : pt.slice(-2), [pt, ct, Q]), ft = I(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Dt = I(
          ...
          o && /* @__PURE__ */ p(it, { children: [
            ...
            v !== !1 && (!Nt || ee(E)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (z) => {
                  uo(z) && (z.preventDefault(), z.stopPropagation(), (ee(E) || G !== void 0 && G !== O) && qt());
                },
                onKeyDown: (z) => {
                    ...
                    /* @__PURE__ */ p(Ie, { open: U, onOpenChange: tt, children: [
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(He, { children: x == null ? void 0 : x.map((z) => /* @__PURE__ */ a(
                            Me,
                            {
                              onSelect: () => {
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Fr = (t) => jd(Ja(t));
function Ur({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Bd({
  ...
  const [s, c] = _("accept"), d = zo(), l = zo(), w = r === "loading", u = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = u ? "accept" : s, x = I(
    () => Fr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Fr(t.acceptedText ?? ""),
      ...
      !w && !g && /* @__PURE__ */ p(it, { children: [
        ...
        /* @__PURE__ */ a(
          oo,
          {
            ...
            children: T.map((O) => G(O) ? /* @__PURE__ */ a(Ft, { delayDuration: 0, children: /* @__PURE__ */ p(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: F(O) }),
              /* @__PURE__ */ a(Gt, { children: A })
            ] }) }, O.value) : F(O))
          }
        ),
        /* @__PURE__ */ a(Ft, { delayDuration: 0, children: /* @__PURE__ */ p(Ut, { children: [
...
function ru({
  ...
  const [y, k] = _(/* @__PURE__ */ new Set()), [A, B] = _(), [T, V] = _(), $ = L(
    async (S) => {
      const Z = await i(S);
  ...
  const N = r.filter(
    ...
    [y, x]
  ), { listboxRef: Y, activeId: G, handleKeyDown: F } = Ui({
    options: j,
    onOptionSelect: R
  }), O = L(
    (S) => {
      S.key === "Escape" ? (A && y.has(A) && (k((Z) => {
        const Q = new Set(Z);
        return Q.delete(A), Q;
      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Gd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(vi, { ...Z })
          },
          S.id
        );
      })
...
function Jd({
  ...
  var T;
  const [w, u] = _([]), [g, h] = _([]), [f, x] = _({}), [v, C] = _({}), y = I(() => e ?? [], [e]), k = An({
    data: y,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: A.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ p(qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(Re, { children: V.headers.map(($) => /* @__PURE__ */ a(Kr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : vr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function cu({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ p(ke, { children: [
    ...
    /* @__PURE__ */ a(Ne, { children: r.map((l, w) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ a(wn, { children: l.itemType === 0 ? /* @__PURE__ */ a(it, { children: l.items.map((u, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][g],
...
function aw({
  ...
  return /* @__PURE__ */ p(Ka, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
      ...
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ p("p", { children: [
        l,
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(Ea, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(dn, {}),
    e && /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ p("p", { children: [
        ...
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(Ea, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function iw({
  ...
  const f = (v) => {
    ...
    var C, y, k, A;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((A = s.current) == null || A.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ p(ke, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
function lw({
  ...
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: cw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ p(Ne, { style: { zIndex: pn }, children: [
...
function pw({
  ...
  return /* @__PURE__ */ p(qe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      Zr,
      {
...
function pu({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [A, B] = _("*"), [T, V] = _("f"), [$, N] = _(!1), [j, R] = _(!0), [E, Y] = _(!1), G = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [At, U] = _(), [tt, wt] = _(), st = K(null), vt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      pt === Ma ? ct = "generated" : pt === Ia ? ct = "hidden" : pt && (k(pt), B(pt)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const ne = () => {
    ...
    (P) => {
      ...
      if (X && Or("note", X)) {
        ...
        if (ut || N(!1), N(
          ut === "x" ? !!(ft != null && ft.every((Dt) => {
            var qt, Ot;
            if (!((qt = Dt.attributes) != null && qt.char)) return !0;
          ...
          G.current = !0, F.current = JSON.stringify(X), R(!0);
          return;
        }
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
                q,
                {
                  "aria-label": ie,
              ...
              /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: ie }) })
            ] }) }) })
          ]
        }
      )
...
function hu({
  ...
  const w = d ?? Bs(r, void 0), u = (y, k) => {
    l == null || l(y, k, n);
  }, g = i ? r.findIndex((y) => y === i) : -1, [h, f] = _(g), x = (y, k, A) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), l == null || l(k, A, n);
          break;
      }
  }, v = (y) => {
    if (r.length)
...
function yw({
  ...
  return /* @__PURE__ */ p(qa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ha, { stickyHeader: !0, children: /* @__PURE__ */ p(Re, { children: [
    ...
    /* @__PURE__ */ a(Ya, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ p(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(tr, { className: o, children: xw(c.text) })
        ]
      },
...
const kw = (t) => {
...
}, aa = (t, e, r) => /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
  /* @__PURE__ */ p(
    Kt,
    {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ p(li, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Br,
          {
            onClick: (d) => {
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", yu = Object.freeze([
...
function ku({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = _(!1), [N, j] = _("all"), [R, E] = _(""), [Y, G] = _([]), F = I(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = I(() => O.length === 0 ? [] : Cw(O, N, R), [O, N, R]), Z = I(() => {
    var wt, st;
    if (!V) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { children: [
        /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            xi,
            {
...
const Tw = "16rem", zw = "3rem", yi = Tt.createContext(void 0);
function oa() {
...
function Sw({
  ...
  const [d, l] = Tt.useState(t), w = e ?? d, u = Tt.useCallback(
    ...
    [r, w]
  ), g = Tt.useCallback(() => u((k) => !k), [u]), h = w ? "expanded" : "collapsed", v = re() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Tt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: u,
...
function _u({ className: t, onClick: e, ...r }) {
...
function Aw({
  ...
  return n ? /* @__PURE__ */ p(Ut, { children: [
    /* @__PURE__ */ a(Kt, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Gt,
      {
        side: "right",
...
function Vw({
  ...
  return /* @__PURE__ */ a(
    Dw,
    {
      ...
      children: /* @__PURE__ */ p(Ow, { children: [
        /* @__PURE__ */ p(an, { children: [
          /* @__PURE__ */ a(on, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a($w, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Aw,
            {
              onClick: () => l(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ p(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { className: "tw:pl-3", children: /* @__PURE__ */ p(
            "div",
            {
              className: m(
...
const Se = "scrBook", Pw = "scrRef", Le = "source", jw = "details", Bw = "Scripture Reference", Lw = "Scripture Book", ki = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
const Kw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Da(t.start, t.end) === 0 ? `${sa(t.start)}+${e}` : `${sa(t.start)}+${e}-${sa(t.end)}+${r}`;
...
function Vu({
  ...
  const [l, w] = _([]), [u, g] = _([{ id: Se, desc: !1 }]), [h, f] = _({}), x = I(
  ...
  W(() => {
    if (c) {
      ...
      if (j.length === 1) {
        const R = x.find((E) => sn(E) === j[0]) || void 0;
        R && c(R);
      }
    }
  }, [h, x, c, C]);
  const y = n ?? Lw, k = i ?? ki, A = [
    ...
    !e && /* @__PURE__ */ p(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: A.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(qa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ha, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ a(Re, { children: N.headers.filter((j) => j.column.columnDef.header).map((j) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Kr, { colSpan: j.colSpan, className: "tw:sticky top-0", children: j.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ p(
                      q,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (R === "ltr" ? /* @__PURE__ */ a(za, {}) : /* @__PURE__ */ a(Ta, {})),
                          " ",
...
function Gw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: u, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = _(!1), [C, y] = _(""), k = K(void 0), A = K(!1), B = I(
    () => _i(t),
    [t]
  ), T = I(() => {
    if (!C.trim()) {
    ...
    (E, Y = !1) => {
      ...
      const G = B.findIndex((Q) => Q === k.current), F = B.findIndex((Q) => Q === E);
      if (G === -1 || F === -1) return;
      const [O, S] = [
        Math.min(G, F),
        Math.max(G, F)
          ...
          qe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                ...
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: R, children: l })
              ] }),
              /* @__PURE__ */ p(He, { children: [
...
function ju({
  ...
  const A = Et(
  ...
  ], U = (M, J, Ht = !1) => /* @__PURE__ */ p(it, { children: [
    M,
    J && !Ht && /* @__PURE__ */ p("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? At.filter((M) => e.includes(M.value)) : At, wt = f ?? ca, st = w ?? wt, vt = u ?? wt, oe = () => {
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [D, Xt] = _(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L((M) => {
    if (M) {
    ...
    Xt((J) => J === "start" ? void 0 : J), xt.current && (xt.current = !1, requestAnimationFrame(() => {
      var Ht;
      const J = (Ht = at.current) == null ? void 0 : Ht.querySelector("button");
      J == null || J.click();
    }));
  }, []), ie = L((M) => {
    if (M) {
    ...
    [r, n, f, i]
  ), et = tt.find((M) => M.value === t), pt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Fs(st, vt, {
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), ut = tt.find((M) => M.value === "range"), [ft, Dt] = _(!1), [Rt, qt] = _(void 0), [Ot, Ee] = _(void 0), [z, $t] = _(void 0), [yt, de] = _(void 0), [Te, wr] = _([]), pr = l === "dropdown" && Rt === "selectedBooks", ur = /* @__PURE__ */ a(
    Hw,
    {
      availableBookInfo: o,
  ...
  ), zr = D === "end", Sr = D === "start", Xe = "tw:text-muted-foreground", b = l === "dropdown" && Rt === "range", H = b ? $t : P, Pt = b ? de : h ? X : oe, ve = /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [mt, It] = _(null), [ht, te] = _(null), [Jt, je] = _(null), Oi = 200, [$i, Mi] = _(!1);
  W(() => {
  ...
  const fo = L(
    (M) => {
      Ee(M), $t(st), de(vt), wr(n), Dt(!1), qt(M);
    },
    [st, vt, n]
  ), mo = L(() => {
    Ot !== void 0 && (Ot === "range" ? (z && (g == null || g(z)), yt && (h == null || h(yt))) : Ot === "selectedBooks" && i(Te), ot(Ot), qt(void 0), Ee(void 0));
  }, [
    Ot,
    z,
    yt,
    ...
    M || (qt(void 0), Ee(void 0));
  }, []), vo = L((M) => {
    var J;
    M.preventDefault(), (J = Mt.current) == null || J.focus();
  }, []), bo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(kt, { children: E }),
      l === "dropdown" ? /* @__PURE__ */ p(ke, { open: ft, onOpenChange: Dt, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(na, { container: Jt, children: [
              ct.map(({ value: M, label: J, dropdownLabel: Ht, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ p(
                Fe,
                {
                  ref: ze(M),
                ...
                /* @__PURE__ */ a(
                  Fe,
                  {
                    ...
                    onSelect: (M) => {
                      ...
                      ne.current || (Ht = (J = Vt.current) == null ? void 0 : J.querySelector("button")) == null || Ht.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
        ...
        oo,
        {
          ...
          children: tt.map(({ value: M, label: J, scrRefSuffix: Ht, id: hr }) => /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: M, id: hr }),
            /* @__PURE__ */ a(kt, { htmlFor: hr, children: U(J, Ht) })
          ] }, hr))
        }
      )
    ] }),
    ...
    l === "dropdown" && gt && /* @__PURE__ */ a(ka, { open: Rt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      _a,
      {
        ...
        children: /* @__PURE__ */ p(na, { container: ht, children: [
    ...
    l === "dropdown" && ut && /* @__PURE__ */ a(ka, { open: Rt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      _a,
      {
        ref: It,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ p(na, { container: mt, children: [
          /* @__PURE__ */ a(Na, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ca, { children: F }) }),
          ve,
          /* @__PURE__ */ p(xo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Q }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          lr,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((w) => /* @__PURE__ */ a(se, { value: `${w}`, children: d[Eo(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(Ut, { children: [
  /* @__PURE__ */ a(Kt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
    Fe,
    {
      onClick: () => {
        o(c);
...
function Ba({
  ...
  return /* @__PURE__ */ p(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Ft, { children: Ei(e.groups, e.items, d, t) }) }),
...
function Ku({
  ...
  return /* @__PURE__ */ p(Ti, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ba,
      {
        onSelectMenuItem: t,
...
const Xw = Tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
const fr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ p(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
        rp,
        {
          onClick: () => {
            o(l);
      ...
      ) : /* @__PURE__ */ p(op, { children: [
        /* @__PURE__ */ a(np, { children: l.label }),
        /* @__PURE__ */ a(ip, { children: Ri(
          t,
          e,
          Ci(t, l.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(ap, {}, `separator-${i}`)), d;
  });
};
function sp({
  menuData: t,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, u) => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w, u]) => /* @__PURE__ */ p(Zw, { children: [
      /* @__PURE__ */ a(tp, { ref: l(w), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ a(
        ep,
        {
          style: { zIndex: Ye },
...
function Wu({
  ...
  const l = cp(
    ...
    var C, y, k, A, B, T;
    const v = x !== f ? ((y = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : y[x]) ?? ((A = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : A.en) : void 0;
...
function Ju({
  ...
  return /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ p(Ut, { open: t, onOpenChange: () => {
  }, children: [
    /* @__PURE__ */ a(
      Kt,
      {
        ...
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ p(ke, { children: [
              /* @__PURE__ */ a(_e, { className: m(u && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
...
function Qu({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function kh({
  ...
  const n = re();
  return /* @__PURE__ */ p(pp, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(up, {}),
    /* @__PURE__ */ p(
      Ve.Content,
      {
...
function Oh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", hp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  qp as CONFLICT_NOTE_STRING_KEYS,
  ...
  ih as ContextMenuGroup,
  wh as ContextMenuItem,
  fh as ContextMenuLabel,
  sh as ContextMenuPortal,
  lh as ContextMenuRadioGroup,
  ...
  Jd as DataTable,
  Ju as DestructiveKeyConfirmation,
  ka as Dialog,
  Uh as DialogClose,
  _a as DialogContent,
  Kh as DialogDescription,
  xo as DialogFooter,
  Na as DialogHeader,
  Gh as DialogOverlay,
  qh as DialogPortal,
  ...
  iu as ERROR_POPOVER_STRING_KEYS,
  ow as EditorKeyboardShortcuts,
  Qu as EmptyState,
  Qd as ErrorDump,
  su as ErrorPopover,
  uu as FOOTNOTE_EDITOR_STRING_KEYS,
  wu as Filter,
  cu as FilterDropdown,
  du as Footer,
  pu as FootnoteEditor,
  bw as FootnoteItem,
  hu as FootnoteList,
  ...
  nu as MarkdownRenderer,
  pw as MarkerMenu,
  lu as MoreInfo,
  qi as MultiSelectComboBox,
  qu as NavigationContentSearch,
  Ie as Popover,
  Yi as PopoverAnchor,
  ...
  Ru as SidebarMenuBadge,
  Aw as SidebarMenuButton,
  Mw as SidebarMenuItem,
  Ou as SidebarMenuSkeleton,
  $u as SidebarMenuSub,
  Iu as SidebarMenuSubButton,
  Mu as SidebarMenuSubItem,
  Sw as SidebarProvider,
  Nu as SidebarRail,
  zu as SidebarSeparator,
  _u as SidebarTrigger,
  Qe as Skeleton,
  Sh as Slider,
  zh as Sonner,
  rg as Spinner,
