...
import { c as m, g as Se, a as Ka, C as Ce, A as ie, P as Me, b as Ye, B as K, d as $e, e as Ie, f as Ae, h as xe, i as Li, k as ji, j as Bi, E as Fi, l as qa, r as se, m as Ui, n as wn, o as ra, p as aa, L as Ct, R as Ga, q as Hr, D as Ea, s as Ta, t as za, u as Sa, T as un, v as jr, w as Ht, x as Ha, y as Yt, z as Wt, F as Xt, G as pn, H as Ya, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as tr, Q as Ki, U as Er, V as He, W as De, Z as We, X as Re, Y as er, _ as Wa, $ as Xa, a0 as Yr, a1 as Ja, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as ko, a7 as gn, a8 as oa, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as la, ah as _o, ai as da, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as Tr, ap as Za, aq as os, ar as ns, as as is } from "./resizable-C_uryyUe.js";
import { at as Qh, au as tg, av as eg, aw as rg, ax as ag, ay as og, az as ng, aA as ig, aB as sg, aC as cg, aD as lg, aE as dg, aF as wg, aG as ug, aH as pg, aI as hg, aJ as gg, aK as fg, aL as mg, aM as vg, aN as bg, aO as xg, aP as yg, aQ as kg, aR as _g } from "./resizable-C_uryyUe.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as or, Clock as No, ChevronsLeft as Co, ChevronsRight as Eo, ChevronLeft as Ra, ChevronRight as Da, ArrowLeft as ss, ArrowRight as cs, ChevronDown as nr, BoldIcon as ls, ItalicIcon as ds, X as Qa, AtSign as vn, Pencil as ws, Trash2 as us, ArrowUp as bn, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as xn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, Undo as Es, Redo as Ts, SquareX as yn, FunctionSquare as kn, SquareSigma as _n, Ban as zs, AlertCircle as Oa, CircleCheckIcon as Ss, CircleXIcon as Rs, CircleHelpIcon as Ds, ArrowUpIcon as Os, ArrowDownIcon as Ms, ScrollText as $s, ChevronsUpDown as Is, MenuIcon as As, Menu as Ps, EllipsisVertical as Vs, MoreVertical as To } from "lucide-react";
import { Section as dt, getChaptersForBook as Ls, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as js, formatReplacementString as Ge, sanitizeHtml as to, NumberFormat as Bs, formatBytes as Fs, getCurrentLocale as Us, usfmMarkers as Br, getFormatCallerFunction as Ks, deepEqual as qs, isString as zo, compareScrRefs as Ma, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as So, collectUsjMarkers as Hs } from "platform-bible-utils";
import qt, { useRef as F, useMemo as I, useState as _, useCallback as j, useEffect as G, useImperativeHandle as Ys, useLayoutEffect as Gt, createContext as eo, useContext as Nn, Component as Ws, createElement as Ro, Suspense as Xs, forwardRef as Cn, useId as Wr, Fragment as En } from "react";
import { IconSelector as Tn, IconCheck as na, IconChevronDown as Js, IconChevronUp as Zs, IconLayoutSidebar as Qs, IconLayoutSidebarRight as tc, IconChevronRight as zn, IconSearch as ec, IconLoader as rc, IconAlertOctagon as ac, IconAlertTriangle as oc, IconInfoCircle as nc, IconCircleCheck as ic } from "@tabler/icons-react";
import { createEditor as Sn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Jt, HISTORY_MERGE_TAG as ro, ParagraphNode as Rn, TextNode as Dn, $getPreviousSelection as sc, $isRangeSelection as ue, $caretFromPoint as cc, $getSiblingCaret as On, $getChildCaret as lc, $getAdjacentChildCaret as dc, $isChildCaret as wc, $normalizeCaret as uc, $setSelectionFromCaretRange as pc, $getCollapsedCaretRange as hc, $getCaretInDirection as Do, $splitAtPointCaretNext as gc, $isTextPointCaret as fc, $findMatchingParent as Mn, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as mc, isHTMLElement as vc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as ao, shallowMergeConfig as bc, defineExtension as re, safeCast as Xe, createState as xc, FORMAT_TEXT_COMMAND as In, $isNodeSelection as An, COMMAND_PRIORITY_LOW as Pn, RootNode as yc, LineBreakNode as kc, TabNode as _c, $isEditorState as Nc, createCommand as Cc, CLICK_COMMAND as Ec, isDOMNode as Tc, $getNodeFromDOMNode as zc, $createNodeSelection as Sc, $setSelection as Rc, $getEditor as Dc, DecoratorNode as $a, $getState as Oc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as Mc, $setState as $c, addClassNamesToElement as Vn, $create as Ic, $getNodeByKey as Ac, removeClassNamesFromElement as Pc, KEY_TAB_COMMAND as Vc, $isBlockElementNode as Lc, $createRangeSelection as jc, $normalizeSelection__EXPERIMENTAL as Bc, OUTDENT_CONTENT_COMMAND as Fc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Uc, COMMAND_PRIORITY_CRITICAL as oo, $isDecoratorNode as Kc, $isParagraphNode as qc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as Gc } from "lexical";
...
import { Avatar as no, Select as Ft, Checkbox as $o, Slot as Sr, Tabs as ce, Menubar as he, ContextMenu as Dt, Progress as Io, Slider as Or, Switch as Ao } from "radix-ui";
import { useReactTable as Bn, getFilteredRowModel as el, getSortedRowModel as Fn, getPaginationRowModel as rl, getCoreRowModel as Un, flexRender as xr, getGroupedRowModel as al, getExpandedRowModel as ol } from "@tanstack/react-table";
import nl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Pa, getDefaultViewOptions as il, isInsertEmbedOpOfType as Mr, Editorial as sl } from "@eten-tech-foundation/platform-editor";
...
function ha({
  ...
  const B = se(), [C, M] = _(!1), [$, T] = _(""), [P, q] = _(""), [y, Z] = _("books"), [L, W] = _(void 0), [S, E] = _(
    void 0
  ), [U, X] = _(void 0), [yt, zt] = _(!1), Pt = F(null), H = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), ae = F({}), ut = F({}), bt = j(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Ot = I(() => o ? o() : Ui, [o]), Vt = I(() => ({
    [dt.OT]: Ot.filter((Y) => vt.isBookOT(Y)),
    [dt.NT]: Ot.filter((Y) => vt.isBookNT(Y)),
    [dt.DC]: Ot.filter((Y) => vt.isBookDC(Y)),
    [dt.Extra]: Ot.filter((Y) => vt.extraBooks().includes(Y))
  }), [Ot]), Zt = I(() => Object.values(Vt).flat(), [Vt]), fe = I(() => {
    if (!P.trim()) return Vt;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = Vt[rt].filter((At) => qa(At, P, n));
    }), b;
  }, [Vt, P, n]), D = I(
    () => fl(P, Zt, n),
    [P, Zt, n]
  ...
  const Et = j(() => {
    if (D) {
      const b = D.chapterNum ?? 1, Y = D.verseNum ?? 1;
      if (w && pa(D.book, b, Y, w))
        return;
      bt({
        book: D.book,
        chapterNum: b,
    ...
    (b) => {
      const Y = S ?? (D == null ? void 0 : D.book), rt = U ?? (D == null ? void 0 : D.chapterNum);
      !Y || !rt || (bt({
        book: Y,
        chapterNum: rt,
        verseNum: b
    ...
    (b) => {
      const Y = y === "chapters" ? L : D == null ? void 0 : D.book;
      if (Y) {
        if (l && l(Y, b) > 1) {
          E(Y), X(b), Z("verses"), T("");
          return;
    ...
    Z("books"), W(void 0), E(void 0), X(void 0), setTimeout(() => {
      wt.current && wt.current.focus();
    }, 0);
  }, []), ot = j(() => {
    const b = S;
    E(void 0), X(void 0), b ? (W(b), Z("chapters"), T("")) : et();
  }, [S, et]), it = j((b) => {
    M(b), b && (Z("books"), W(void 0), E(void 0), X(void 0), q(""));
  }, []);
  G(() => {
    O && it(!1);
  }, [O, it]);
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: St } = {
    ...
    () => hl(P),
    [P]
  ), oe = I(() => !l || !D || !D.chapterNum || !xt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, xt]), Le = j(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), ur = j(
    (b) => (Y) => w ? gl(b, Y, w) : !1,
    ...
    (b, Y) => (rt) => w ? pa(b, Y, rt, w) : !1,
    [w]
  ), hr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", gr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Rr = j(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), Et());
    },
    [p, D, Et]
  ), Je = j(
    (b) => {
      var me, Te, Be;
      if (b.ctrlKey) return;
      const { isLetter: Y, isDigit: rt } = Vo(b.key);
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const Nt = (me = tt.current) == null ? void 0 : me.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Nt) {
          b.preventDefault(), b.stopPropagation(), Nt.click();
          return;
        }
      }
      ...
      if (y === "verses" && At) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (Lt = ft > 1 ? ft - 1 : Nt);
            break;
          case "ArrowRight":
            ft !== 0 && (Lt = ft < Nt ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Lt = ft === 0 ? Nt : Math.max(1, ft - le);
            break;
          case "ArrowDown":
            Lt = ft === 0 ? 1 : Math.min(Nt, ft + le);
            break;
          default:
            return;
        }
        Lt !== ft && (b.preventDefault(), b.stopPropagation(), T(
          `${Tt} ${ie[Tt] || ""} ${_t}:${Lt}`
        ), setTimeout(() => {
          const Fe = ut.current[Lt];
          Fe && Fe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && D) && At) {
        const Tt = y === "chapters" ? L : D == null ? void 0 : D.book;
        if (!Tt) return;
        ...
        switch (b.key) {
          case "ArrowLeft":
            _t !== 0 && (ft = _t > 1 ? _t - 1 : Nt);
            break;
          case "ArrowRight":
            _t !== 0 && (ft = _t < Nt ? _t + 1 : 1);
            break;
          case "ArrowUp":
            ft = _t === 0 ? Nt : Math.max(1, _t - Lt);
            break;
          case "ArrowDown":
            ft = _t === 0 ? 1 : Math.min(Nt, _t + Lt);
            break;
          default:
            return;
        }
        ft !== _t && (b.preventDefault(), b.stopPropagation(), T(
          `${Tt} ${ie[Tt] || ""} ${ft}`
        ), setTimeout(() => {
    ...
    const { isLetter: Y, isDigit: rt } = Vo(b.key);
    (Y || rt) && (b.preventDefault(), q((me) => me + b.key), wt.current.focus(), zt(!1));
  }, []);
  return Gt(() => {
    const b = setTimeout(() => {
      if (C && y === "books" && at.current && mt.current) {
        const Y = at.current, rt = mt.current, At = rt.offsetTop, me = Y.clientHeight, Te = rt.clientHeight, Be = At - me / 2 + Te / 2;
        Y.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), T(qn(t.book));
  ...
  }, [y, L, D, t.book, t.chapterNum]), Gt(() => {
    if (y === "verses" && S && U !== void 0) {
      const b = S === t.book && U === t.chapterNum, Y = b ? t.verseNum : 1;
      T(
        `${S} ${ie[S] || ""} ${U}:${Y}`
      ), setTimeout(() => {
        if (at.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Me, { open: C, onOpenChange: it, modal: z, children: [
    /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        ...
        onClick: (b) => {
          H.current && (H.current = !1, b.preventDefault());
        },
        children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: Y } = b;
          C && Pt.current && Y instanceof Node && Pt.current.contains(Y) && (H.current = !0, it(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Ie,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Q.map(
                  ({ onClick: b, disabled: Y, title: rt, icon: At }) => /* @__PURE__ */ a(
                    K,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  K,
                  {
                    ...
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && L && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Se(L, n) }),
                y === "verses" && S && U !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(S, n)} ${U}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !yt && /* @__PURE__ */ u(Ae, { ref: at, children: [
                y === "books" && /* @__PURE__ */ u(ct, { children: [
                  !D && Object.entries(fe).map(([b, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Ut(b), children: Y.map((rt) => /* @__PURE__ */ a(
                          Kn,
                          {
                            bookId: rt,
                            onSelect: (At) => Ee(At),
                  ...
                  D && /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a(
                    Ce,
                    {
                      value: `${D.book} ${ie[D.book]} ${D.chapterNum || ""}:${D.verseNum || ""})}`,
                      onSelect: Et,
                      disabled: !!w && pa(
                        D.book,
                        D.chapterNum ?? 1,
                  ...
                  D && oe && D.chapterNum && l && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Se(D.book, n)} ${D.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        onVerseSelect: Qt,
                        setVerseRef: It,
                        isVerseDisabled: pr(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !oe && rr(D.book) > 1 && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Se(D.book, n) }),
                ...
                y === "chapters" && L && /* @__PURE__ */ a(
                  Lo,
                  {
                    ...
                    onChapterSelect: te,
                    setChapterRef: R,
                    isChapterDisabled: ur(L),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && S && U !== void 0 && l && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: S,
                    chapterNum: U,
...
function Bo({
  ...
  const [N, O] = _(!1), B = l ?? d, C = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], M = ($, T) => {
    const P = d($), q = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, y = `${T ?? ""}${P}${q ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: P,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(ra, { placeholder: g, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(aa, { children: h }),
          /* @__PURE__ */ a(Ae, { children: C(e) ? e.map(($) => /* @__PURE__ */ a(xe, { heading: $.groupHeading, children: $.options.map((T) => M(T, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map(($) => M($)) }) })
        ] })
      }
    )
  ] });
...
function tp({
  ...
  const w = ga(l, "%webView_bookSelector_currentBook%"), p = ga(l, "%webView_bookSelector_choose%"), g = ga(l, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(Ct, { className: "tw:ms-1", children: g })
          ] }),
          /* @__PURE__ */ a(Ct, { className: "tw:flex tw:items-center", children: o.map((v) => vt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            K,
            {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Yn ? Gt : G, Ir = { tag: ro };
function yl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = bl(null, o), w = Sn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : G;
function _l({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return kl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: d }) => {
      e && i.size === 0 && s.size === 0 || t && d.has(ro) || c.isEmpty() || r(n, o, d);
    });
  }, [o, t, e, r]), null;
}
const so = {
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : G;
function Sl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Rl() {
  return function(t) {
    const [e] = ge(), r = I(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = F(o);
    return zl(() => {
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let z = 0; z < h.length; z++) {
      const k = h[z], N = s[z] || document.createElement("div"), O = N.style;
      O.position !== "absolute" && (O.position = "absolute", v = !0);
      const B = we(k.left - p);
      O.left !== B && (O.left = B, v = !0);
      const C = we(k.top - g);
      O.top !== C && (N.style.top = C, v = !0);
      const M = we(k.width);
      O.width !== M && (N.style.width = M, v = !0);
      const $ = we(k.height);
      O.height !== $ && (N.style.height = $, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[z] = N;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    l(), o = g, n = h, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return p();
      for (const z of f) if (!c.contains(z.target)) return d();
    }), i.observe(h, Ml), d();
  });
  return () => {
    w(), l();
...
function Al(t, e = Il) {
  ...
  function l(w) {
    w.read(() => {
      const p = Jt();
      if (!ue(p)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [g, h] = function($) {
        const T = $.getStartEndPoints();
        return $.isBackward() ? [T[1], T[0]] : T;
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, z = h.getNode(), k = z.getKey(), N = h.offset, O = t.getElementByKey(x), B = t.getElementByKey(k), C = r === null || O !== o || v !== n || x !== r.getKey(), M = i === null || B !== s || N !== c || k !== i.getKey();
      if ((C || M) && O !== null && B !== null) {
        const $ = function(T, P, q, y, Z, L, W) {
          const S = (T._window ? T._window.document : document).createRange();
          return S.setStart(...Fo(P, q, y)), S.setEnd(...Fo(Z, L, W)), S;
        }(t, g, f, O, h, z, B);
        d(), d = $l(t, $, e);
      }
      r = f, o = O, n = v, i = z, s = B, c = N;
    });
  }
...
function Ll(t) {
  ...
  if (ue(e)) r = cc(e.focus, "next");
    ...
    r = r || lc(Oe(), "previous").getFlipped().insert(zr());
  }
...
function jl(t, e, r) {
  ...
  return fc(o) && Xr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(On(t.getLatest(), "next"), e.direction);
}
function Bl(t) {
  const e = Jt();
  if (!ue(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Mn(i, (l) => Nr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Jr, be = 0, Zr = 0, Kl = 0, La = 0, Ur = 0;
function Ko(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Gl(t) {
  ...
  Jn(this), nt = t, this.f &= -2, 8 & this.f && lo(this), ia();
}
function Qe(t, e) {
...
Bt.prototype.brand = Fl, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Zr === 0 && e.l !== La && (e.l = La, Jr = { S: e, v: e.v, i: e.i, o: Jr });
    })(this), this.v = t, this.i++, Ur++, be++;
    try {
  ...
  return nt = t, Jn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zn(this), qo(this), be++;
  const t = nt;
...
function Qn() {
  const t = Oe(), e = Jt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), ue(e) && (e.format = 0);
}
function ti(t, e = Qn) {
  return t.registerCommand($n, (r) => (t.update(e), !0), ao);
}
re({ build: (t, e, r) => wr(e), config: Xe({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return pe(() => ti(t, o.value));
} });
function Hl(t) {
...
class ei extends $a {
  $config() {
    return this.config("decorator-text", { extends: $a, stateConfigs: [{ flat: !0, stateConfig: ma }] });
  }
  getFormat() {
    return Oc(this, ma);
  }
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = Jt();
  if (An(n) || ue(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ri(t, e) {
  let r;
...
const ja = re({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const wo = 0, Ba = 1, oi = 2, va = 3, Ar = 4, Ze = 5, ba = 6, mr = 7;
function xa(t) {
  return t.id === wo;
}
function ni(t) {
...
function Wl(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || lt(305, String(t.id), String(Ba)), Object.assign(t, { id: oi });
}
...
class Jl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: va, registerState: l });
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ba && lt(310, String(r.id), String(ba)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= va;
    }(e) || lt(314, String(e.id), String(va)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Ql = re({ config: Xe({ setOptions: Go, updateOptions: Go }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Ho];
    return r && (r.PACKAGE_VERSION !== ya && lt(292, r.PACKAGE_VERSION, ya), r instanceof ar || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || lt(300, s, n || "[unknown]"), xa(c = i) || lt(304, String(c.id), String(wo)), i = Object.assign(c, { id: Ba }), o.state = i;
...
const ed = /* @__PURE__ */ new Set(), Wo = re({ build(t, e, r) {
  const o = r.getDependency(ja).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => pe(() => {
...
}, dependencies: [ja], name: "@lexical/extension/NodeSelection" }), rd = Cc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends $a {
  static getType() {
...
re({ dependencies: [ja, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(rd, (s) => {
    ...
    return !0;
  }, ao), t.registerCommand(Ec, (s) => {
    if (Tc(s.target)) {
      const c = zc(s.target);
      if (od(c)) return function(d, l = !1) {
        const w = Jt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && An(w) ? h = w : (h = Sc(), Rc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Pn), t.registerMutationListener(ir, (s, c) => {
    Ul(() => {
      let d = !1;
  ...
  return Ne(t.registerCommand(Vc, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const g = p.getKey();
        let h = jc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Bc(h), h.anchor.is(l)) return !0;
      }
      return !1;
...
re({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                const x = f.anchor;
                let v = x.getNode(), z = 0, k = 0;
                if (Ia(v) && l >= 0 && w >= 0 && (z = l, k = l + w, f.setTextNodeRange(v, z, v, k)), z === k && p === "" || (f.insertRawText(p), v = x.getNode()), Ia(v)) {
                  z = g, k = g + h;
                  const N = v.getTextContentSize();
                  z = z > N ? N : z, k = k > N ? N : k, f.setTextNodeRange(v, z, v, k);
                }
...
re({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const po = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : G;
...
const fd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : G;
function md({ onClear: t }) {
  const [e] = ge();
  return fd(() => ti(e, t), [e, t]), null;
}
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : G;
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: z = !0, style: k, tabIndex: N, "data-testid": O, ...B }, C) {
  const [M, $] = _(t.isEditable()), T = j((q) => {
    q && q.ownerDocument && q.ownerDocument.defaultView ? t.setRootElement(q) : t.setRootElement(null);
  }, [t]), P = I(() => /* @__PURE__ */ function(...q) {
    return (y) => {
      for (const Z of q) typeof Z == "function" ? Z(y) : Z != null && (Z.current = y);
    };
  }(C, T), [T, C]);
  return li(() => ($(t.isEditable()), t.registerEditableListener((q) => {
    $(q);
  })), [t]), a("div", { "aria-activedescendant": M ? e : void 0, "aria-autocomplete": M ? r : "none", "aria-controls": M ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": M && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": d, "aria-labelledby": l, "aria-multiline": w, "aria-owns": M ? p : void 0, "aria-readonly": !M || void 0, "aria-required": g, autoCapitalize: h, className: f, contentEditable: M, "data-testid": O, id: x, ref: P, role: v, spellCheck: z, style: k, tabIndex: N, ...B });
}
const bd = Cn(vd);
function Jo(t) {
  return t.getEditorState().read(si(t.isComposing()));
...
function Ed({
  ...
  const [e] = ge(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Cd(), d = () => {
  };
...
function zd() {
  const { activeEditor: t } = wi(), [e, r] = _([]), o = j((n) => {
    if (ue(n) || Zc(n)) {
      const i = [];
      Zo.forEach(({ format: s }) => {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ a(
          yl,
          {
            ...
            children: /* @__PURE__ */ u(Ht, { children: [
...
function gi({
  ...
  return /* @__PURE__ */ u(Ha, { children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
        {
          "aria-label": s,
          className: n,
      ...
      /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(pn, {}),
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
...
const Md = "verseText", ep = Object.freeze([
...
function rp({
  ...
  const [i, s] = _($d), [c, d] = _(n), [l, w] = _(!1), p = F(void 0), g = F(null);
  G(() => {
    let v = !0;
    const z = g.current;
    if (!z) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : go(v) && (v.preventDefault(), v.stopPropagation(), ee(i) && h());
        },
        onKeyDown: (v) => {
...
function tn({
  ...
  const h = j(
    (C) => {
      C && C.stopPropagation(), l(!1), p(void 0), s == null || s(!1);
    },
    [s]
  ), f = j(
    async (C) => {
    ...
    [t.user]
  ), k = I(() => to(t.contents), [t.contents]), N = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), O = !!t.conflictResolutionAction && !N, B = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          qe,
          {
            onClick: (C) => {
              C.stopPropagation(), l(!0), p(Od(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Vd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ld, { className: "tw:text-xs tw:font-medium", children: z }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), h()) : go(C) && (C.preventDefault(), C.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (C) => {
                ho(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
...
function xi({
  ...
  const [y, Z] = _(en), [L, W] = _(), [S, E] = _(), U = o, [X, yt] = _(!1), [zt, Pt] = _(!1), [H, tt] = _(!1), [wt, at] = _(!1), [mt, ae] = _(!1), [ut, bt] = _(O), [Ot, Vt] = _(!1), Zt = F(void 0), [fe, D] = _(/* @__PURE__ */ new Map());
  G(() => {
    let R = !0;
    return (async () => {
  ...
  G(() => {
    if (!o) {
      kt.current !== "idle" && (W(void 0), E(void 0), kt.current = "idle");
      return;
    }
    kt.current === "idle" && (kt.current = "pending"), wt ? kt.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (W(M), kt.current = "auto-populated") : kt.current === "auto-populated" && (W(void 0), kt.current = "pending");
  }, [o, M, wt, i]);
  const Et = I(
  ...
  const Qt = I(() => Et[0], [Et]), Ee = F(null), te = F(void 0), V = j(() => {
    var R;
    (R = te.current) == null || R.call(te), Z(en);
  }, []), Q = j(() => {
    const R = !ut;
    bt(R), Vt(!R), f == null || f(d, R);
  }, [ut, f, d]);
  G(() => {
    yt(!1);
  }, [o]), G(() => {
    if (o && !ut && !Ot) {
      ...
      return Zt.current = R, () => clearTimeout(R);
    }
  ...
  }, [i, r]), it = I(() => Et.slice(1), [Et]), st = I(() => it.length ?? 0, [it.length]), ht = I(() => st > 0, [st]), pt = I(() => X || st <= 2 ? it : it.slice(-2), [it, st, X]), gt = I(() => X || st <= 2 ? 0 : st - 2, [st, X]), Mt = I(
  ...
  const Ut = j(
    async (R) => {
      ...
      It && await p({ threadId: d, contents: It }) && V();
    },
    [
      V,
      y,
    ...
    async (R) => {
      const It = ee(y) ? ta(y) : void 0, xt = R.status ? R.assignedUser : L ?? R.assignedUser, oe = await p({
        ...R,
        contents: It,
        assignedUser: xt
      });
      return oe && (xt !== void 0 && E(xt), It && V()), oe;
    },
    [V, y, p, L]
  );
  ...
  const Ve = /* @__PURE__ */ a(
    tn,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: Pt,
      canEditOrDelete: (!zt && fe.get(Qt.id)) ?? !1,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              K,
              {
                ...
                children: ut ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(gs, {})
              }
            ),
            P === void 0 ? (
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            gt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (R) => {
                  R.stopPropagation(), yt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (R) => {
                  (R.key === "Enter" || R.key === " ") && (R.preventDefault(), R.stopPropagation(), yt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(_r, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: St }),
                    X ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            pt.map((R) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              tn,
              {
                comment: R,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: Pt,
                canEditOrDelete: (!zt && fe.get(R.id)) ?? !1
              }
            ) }, R.id)),
            v !== !1 && (!zt || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (R) => {
                  go(R) && (R.preventDefault(), R.stopPropagation(), (ee(y) || L !== void 0 && L !== S) && Ut());
                },
                onKeyDown: (R) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    L !== void 0 && (ee(y) || L !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                    ...
                    /* @__PURE__ */ u(Me, { open: H, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ a(
                        K,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          align: "end",
                          onKeyDown: (R) => {
                            R.key === "Escape" && (R.stopPropagation(), tt(!1));
                          },
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: x == null ? void 0 : x.map((R) => /* @__PURE__ */ a(
                            Ce,
                            {
                              onSelect: () => {
                                W(R !== i ? R : void 0), kt.current = "user-selected", E(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Kr(R, r) })
                            },
                            R || "unassigned"
                          )) }) })
                        }
...
), Bd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => Bd(to(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Fd({
  ...
  const [s, c] = _("accept"), d = Wr(), l = Wr(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = I(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => qr(t.acceptedText ?? ""),
    ...
    () => qr(t.mergedText ?? ""),
    [t.mergedText]
  ), k = I(() => to(t.contents), [t.contents]);
  if (!mi(t))
    return /* @__PURE__ */ a(Gr, { html: k });
  const N = (S) => {
  ...
  let T;
  M ? T = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (T = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", q = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), y = (S) => S ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: S }) : q, Z = () => {
    const S = o ?? "accept";
    return S === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: z }) : q : y(S === "reject" ? t.rejectedResultText : t.resultText);
  }, L = (S) => p && S.value === "reject", W = (S) => {
    const E = f === S.value, U = `${l}-${S.value}`, X = L(S);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: d, className: "tw:sr-only", children: O }),
            /* @__PURE__ */ a(Gr, { html: S.html })
          ]
        },
        S.value
      )
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Ga,
          {
            ...
            children: C.map((S) => L(S) ? /* @__PURE__ */ a(Ht, { delayDuration: 0, children: /* @__PURE__ */ u(Yt, { children: [
              /* @__PURE__ */ a(Wt, { asChild: !0, children: W(S) }),
              /* @__PURE__ */ a(Xt, { children: O })
            ] }) }, S.value) : W(S))
          }
        ),
        /* @__PURE__ */ a(Ht, { delayDuration: 0, children: /* @__PURE__ */ u(Yt, { children: [
          /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex tw:self-start", children: /* @__PURE__ */ a(
            K,
            {
              size: "sm",
              disabled: $,
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return vi(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? l;
...
function Hd(t) {
  ...
  } = t, c = I(() => e.filter((z) => !z.deleted), [e]), d = I(
    () => c.find((z) => z.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = Gd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function wp({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [O, B] = _(), [C, M] = _(), $ = j(
    async (E) => {
      const U = await i(E);
      return U !== void 0 && E.assignedUser !== void 0 && E.assignedUser !== "" && M(E.assignedUser), U;
    },
    [i]
  );
  G(() => {
    f && (N((E) => new Set(E).add(f)), B(f));
  }, [f]);
  const T = r.filter(
    (E) => E.comments.some((U) => !U.deleted)
  ), P = T.map((E) => ({ id: E.id })), q = j(
    (E) => {
      N((U) => new Set(U).add(E.id)), B(E.id), x == null || x(E.id);
    },
    [x]
  ), y = j(
    (E) => {
      ...
      N((X) => {
        const yt = new Set(X);
        return yt.has(E) ? yt.delete(E) : yt.add(E), yt;
      }), B(E), x == null || x(U ? void 0 : E);
    },
    [k, x]
  ), { listboxRef: Z, activeId: L, handleKeyDown: W } = Ki({
    options: P,
    onOptionSelect: q
  }), S = j(
    (E) => {
      E.key === "Escape" ? (O && k.has(O) && (N((U) => {
        const X = new Set(U);
        return X.delete(O), X;
      }), B(void 0), x == null || x(void 0)), E.preventDefault(), E.stopPropagation()) : W(E);
    },
    [O, k, W, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: T.map((E) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: E.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...U, conflictResolution: z }) : /* @__PURE__ */ a(xi, { ...U })
          },
          E.id
        );
      })
...
function ne({
  ...
  return /* @__PURE__ */ u(
    Ft.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(na, { className: "tw:pointer-events-none" }) }) }),
...
function Qd({
  ...
  var C;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, z] = _({}), k = I(() => e ?? [], [e]), N = Bn({
    data: k,
    columns: t,
    getCoreRowModel: Un(),
  ...
  let B;
  return d ? B = Array.from({ length: 10 }).map((T, P) => `skeleton-row-${P}`).map((T) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, T)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? B = N.getRowModel().rows.map((M) => /* @__PURE__ */ a(
    Re,
    {
      onClick: () => s(M, N),
      "data-state": M.getIsSelected() && "selected",
      children: M.getVisibleCells().map(($) => /* @__PURE__ */ a(er, { children: xr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    M.id
    ...
    /* @__PURE__ */ u(Wa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Xa, { stickyHeader: i, children: N.getHeaderGroups().map((M) => /* @__PURE__ */ a(Re, { children: M.headers.map(($) => /* @__PURE__ */ a(Yr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : xr($.column.columnDef.header, $.getContext()) }, $.id)) }, M.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(K, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(xn, {}) })
        ] }),
...
function mp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ye, { children: [
    ...
    /* @__PURE__ */ a(_e, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(hn, { children: l.itemType === 0 ? /* @__PURE__ */ a(ct, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][g],
...
function nw({
  ...
  const d = Ya(), l = an(n, "%undoButton_tooltip%"), w = an(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ha, { children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
    ...
    e && /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
        {
          "aria-label": w,
...
function iw({
  ...
  return G(() => {
    var d;
    const i = Ya(), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      var p, g, h, f;
...
function cw({
  ...
  const f = (v) => {
    ...
    var z, k, N, O;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((z = i.current) == null || z.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((O = s.current) == null || O.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: sw(t, n, r) }) }) }),
      /* @__PURE__ */ a(Xt, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      _e,
      {
...
function ww({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: lw(t, r) }) }) }),
      /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ a("p", { children: dw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(_e, { style: { zIndex: gn }, children: [
...
function yp({
  ...
  const [f, x] = _("generated"), [v, z] = _("generated"), [k, N] = _("*"), [O, B] = _("*"), [C, M] = _("f"), [$, T] = _(!1), [P, q] = _(!0), [y, Z] = _(!1), L = F(!1), W = F(""), [S, E] = _(!1), [U, X] = _(), [yt, zt] = _(), [Pt, H] = _(), [tt, wt] = _(), at = F(null), mt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  G(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Aa ? st = "generated" : it === Pa ? st = "hidden" : it && (N(it), B(it)), x(st), z(st), M(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
  ...
  Gt(() => {
    (Vt.current.book !== n.book || Vt.current.chapterNum !== n.chapterNum) && (Vt.current = { book: n.book, chapterNum: n.chapterNum }, Ot.current());
  }, [n.book, n.chapterNum]);
  const Zt = () => {
    var Q;
    ...
    if (Q && Mr("note", Q)) {
      ...
      C !== "x" && V === "x" ? pt == null || pt.forEach((gt) => fw(gt)) : C === "x" && V !== "x" && (pt == null || pt.forEach((gt) => mw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Et = (V) => {
    wt(V.contextMarker), Z(V.canRedo);
  }, Qt = j(
    (V) => {
      var et, ot, it, st, ht;
      const Q = (ot = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (Q && Mr("note", Q)) {
        ...
        if (pt || T(!1), T(
          pt === "x" ? !!(gt != null && gt.every((Mt) => {
            var Ut, $t;
            if (!((Ut = Mt.attributes) != null && Ut.char)) return !0;
            const St = (($t = Mt.attributes) == null ? void 0 : $t.char).style;
          ...
          L.current = !0, W.current = JSON.stringify(Q), q(!0);
          return;
        }
        q(JSON.stringify(Q) === W.current), ut(f, k);
      } else
        T(!1), q(!0);
    },
    [f, k, ut]
    ...
    if (g.current && ae.length && V && V.rangeCount > 0) {
      ...
      X(Q.left - et.left), zt(Q.top - et.top), H(Q.height), E(!0);
    }
  }, [ae, g]);
  G(() => {
    const V = () => {
    ...
    var V;
    S && ((V = at.current) == null || V.focus());
  }, [S]), G(() => {
    var et;
    const V = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !S && V && document.activeElement === V && ot.key === c ? (ot.preventDefault(), Ee()) : S && ot.key === "Escape" && (ot.preventDefault(), E(!1));
    };
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
              /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ a(
                K,
                {
                  "aria-label": te,
              ...
              /* @__PURE__ */ a(Xt, { children: /* @__PURE__ */ a("p", { children: te }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: bw(t.marker, c, o, l) })
      }
    )
  ] });
}
function _p({
  ...
  const w = d ?? Ks(r, void 0), p = (k, N) => {
    ...
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), l == null || l(N, O, n);
          break;
      }
  }, v = (k) => {
    if (r.length)
  ...
  return G(() => {
    var k;
    h >= 0 && h < z.current.length && ((k = z.current[h]) == null || k.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function _w({
  ...
  return /* @__PURE__ */ u(Wa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Xa, { stickyHeader: !0, children: /* @__PURE__ */ u(Re, { children: [
...
const Nw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
  /* @__PURE__ */ u(
    Wt,
    {
  ...
  return e ? e[1] : "";
}, Ew = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rp = Object.freeze([
...
function Dp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), z = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), O = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = de(r, "%webView_inventory_no_results%"), [M, $] = _(!1), [T, P] = _("all"), [q, y] = _(""), [Z, L] = _([]), W = I(() => {
    const H = t ?? [];
    ...
    const H = [];
    return W.forEach((tt) => {
      const wt = tt.items[0], at = H.find(
        (mt) => mt.items[0] === wt
      );
      at ? (at.count += tt.count, at.occurrences = at.occurrences.concat(tt.occurrences)) : H.push({
        items: [wt],
        count: tt.count,
  ...
  }, [M, W]), E = I(() => S.length === 0 ? [] : Tw(S, T, q), [S, T, q]), U = I(() => {
    var wt, at;
    if (!M) return d;
  ...
  G(() => {
    E.length === 0 ? L([]) : E.length === 1 && L(E[0].items);
  }, [E]);
  const X = (H, tt) => {
    tt.setRowSelection(() => {
      const at = {};
      return at[H.index] = !0, at;
    });
    const wt = H.original.items;
    L(wt), g && wt.length > 0 && g(wt[0]);
  }, yt = (H) => {
    ...
    if (S.length === 0 || Z.length === 0) return [];
    const H = S.filter((tt) => qs(
      M ? tt.items : [tt.items[0]],
      Z
    ));
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u(Yt, { children: [
        /* @__PURE__ */ a(Wt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            ki,
            {
        ...
        /* @__PURE__ */ a(Xt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Sw = "16rem", Rw = "3rem", _i = qt.createContext(void 0);
function ca() {
  const t = qt.useContext(_i);
  if (!t)
...
function Dw({
  ...
  const [d, l] = qt.useState(t), w = e ?? d, p = qt.useCallback(
    ...
    [r, w]
  ), g = qt.useCallback(() => p((N) => !N), [p]), h = w ? "expanded" : "collapsed", v = se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = qt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Vw({
  ...
  const c = t ? Sr.Root : "button", { state: d } = ca(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(Pw({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(Yt, { children: [
    /* @__PURE__ */ a(Wt, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      Xt,
      {
        side: "right",
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u($w, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", jw = "scrRef", Ke = "source", Bw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", Ni = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
...
const Gw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ma(t.start, t.end) === 0 ? `${wa(t.start)}+${e}` : `${wa(t.start)}+${e}-${wa(t.end)}+${r}`;
}, ln = (t) => `${Gw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Gp({
  sources: t,
  ...
  const [l, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), x = I(
    () => t.flatMap((T) => T.data.map((P) => ({
      ...P,
      source: T.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const T = z.getSelectedRowModel().rowsById, P = Object.keys(T);
      if (P.length === 1) {
        const q = x.find((y) => ln(y) === P[0]) || void 0;
        q && c(q);
      }
    }
  }, [h, x, c, z]);
  const k = n ?? Uw, N = i ?? Ni, O = [
    ...
    !T.getIsGrouped() && !T.getIsSelected() && T.getToggleSelectedHandler()(P);
  }, M = (T, P) => T.getIsGrouped() ? "" : m("banded-row", P % 2 === 0 ? "even" : "odd"), $ = (T, P, q) => {
    if (!((T == null ? void 0 : T.length) === 0 || P.depth < q.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: O.map((T) => /* @__PURE__ */ a(ne, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Wa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Xa, { children: z.getHeaderGroups().map((T) => /* @__PURE__ */ a(Re, { children: T.headers.filter((P) => P.column.columnDef.header).map((P) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Yr, { colSpan: P.colSpan, className: "tw:sticky top-0", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Ja, { children: z.getRowModel().rows.map((T, P) => {
        const q = se();
        return /* @__PURE__ */ a(
          Re,
          {
                  ...
                  er,
                  {
                    ...
                    children: y.getIsGrouped() ? /* @__PURE__ */ u(
                      K,
                      {
                        ...
                        type: "button",
                        children: [
                          T.getIsExpanded() && /* @__PURE__ */ a(nr, {}),
                          !T.getIsExpanded() && (q === "ltr" ? /* @__PURE__ */ a(Da, {}) : /* @__PURE__ */ a(Ra, {})),
                          " ",
...
function Hw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = _(!1), [z, k] = _(""), N = F(void 0), O = F(!1), B = I(
    () => Ci(t),
    [t]
  ), C = I(() => {
    if (!z.trim()) {
    ...
    (y, Z = !1) => {
      if (!Z || !N.current) {
        r(
          e.includes(y) ? e.filter((X) => X !== y) : [...e, y]
        ), N.current = y;
        return;
      }
      const L = B.findIndex((X) => X === N.current), W = B.findIndex((X) => X === y);
      if (L === -1 || W === -1) return;
      const [S, E] = [
        Math.min(L, W),
        Math.max(L, W)
      ], U = B.slice(S, E + 1).map((X) => X);
      r(
        e.includes(y) ? e.filter((X) => !U.includes(X)) : [.../* @__PURE__ */ new Set([...e, ...U])]
      );
    },
    [e, r, B]
  ), $ = (y) => {
    M(y, O.current), O.current = !1;
  }, T = (y, Z) => {
    y.preventDefault(), M(Z, y.shiftKey);
  }, P = () => {
    r(B.map((y) => y));
  }, q = () => {
    r([]);
          ...
          Ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: P, children: d }),
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: q, children: l })
              ] }),
              /* @__PURE__ */ u(Ae, { children: [
                /* @__PURE__ */ a(aa, { children: w }),
                Object.values(dt).map((y, Z) => {
                  const L = C[y];
                  if (L.length !== 0)
                    return /* @__PURE__ */ u(En, { children: [
                      /* @__PURE__ */ a(
                        xe,
                        {
                          heading: wn(y, p, g, h, f),
                      ...
                      Z < Object.values(dt).length - 1 && /* @__PURE__ */ a(fn, {})
                    ] }, y);
                })
              ] })
            ]
...
function Yw({
  ...
  const i = mo(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], l = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    K,
    {
      variant: "outline",
...
function Yp({
  ...
  const O = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = Rt(s, "%webView_scope_selector_verse%"), C = Rt(s, "%webView_scope_selector_chapter%"), M = Rt(s, "%webView_scope_selector_book%"), $ = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), T = Rt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), P = Rt(s, "%webView_scope_selector_current_book%"), q = Rt(s, "%webView_scope_selector_choose_books%"), y = Rt(s, "%webView_scope_selector_scope%"), Z = Rt(s, "%webView_scope_selector_select_books%"), L = Rt(s, "%webView_scope_selector_range%"), W = Rt(s, "%webView_scope_selector_select_range%"), S = Rt(s, "%webView_scope_selector_range_start%"), E = Rt(s, "%webView_scope_selector_range_end%"), U = Rt(s, "%webView_scope_selector_ok%"), X = Rt(s, "%webView_scope_selector_cancel%"), yt = Rt(s, "%webView_scope_selector_navigate%"), zt = (A) => {
    if (!f) return;
    ...
    },
    {
      ...
      label: M,
      dropdownLabel: P,
      scrRefSuffix: zt("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: q, id: "scope-selected" },
    { value: "range", label: L, id: "scope-range" }
  ], H = (A, J, Kt = !1) => /* @__PURE__ */ u(ct, { children: [
    A,
    J && !Kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? Pt.filter((A) => e.includes(A.value)) : Pt, wt = f ?? ua, at = w ?? wt, mt = p ?? wt, ae = () => {
  }, ut = F(null), bt = F(null), Ot = F(!1), Vt = F(null), Zt = F(!1), [fe, D] = _(void 0), kt = F(!1), Et = F(!1), Qt = F(null), Ee = j((A) => {
    if (A) {
      D("start"), kt.current = !1;
      return;
    }
    D((J) => J === "start" ? void 0 : J), kt.current && (kt.current = !1, requestAnimationFrame(() => {
      var Kt;
      const J = (Kt = ut.current) == null ? void 0 : Kt.querySelector("button");
      J == null || J.click();
    }));
  }, []), te = j((A) => {
    if (A) {
    ...
    (A) => {
      g == null || g(A), h == null || h(A), kt.current = !0;
    },
    [g, h]
  ), Q = j(
    (A) => {
      h == null || h(A), Et.current = !0;
    },
    [h]
  ), et = j(
    (A) => {
    ...
    [r, n, f, i]
  ), ot = tt.find((A) => A.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Gs(at, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ot ? H(ot.label, ot.scrRefSuffix) : t, st = tt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), ht = tt.find((A) => A.value === "selectedBooks"), pt = tt.find((A) => A.value === "range"), [gt, Mt] = _(!1), [St, Ut] = _(void 0), [$t, Ve] = _(void 0), [R, It] = _(void 0), [xt, oe] = _(void 0), [Le, ur] = _([]), pr = l === "dropdown" && St === "selectedBooks", hr = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", je = l === "dropdown" && St === "range", b = je ? It : V, rt = je ? oe : h ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: m(gr && Je), children: S }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: m(Rr && Je), children: E }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: z,
          disableReferencesUpTo: je ? R ?? at : at,
          onOpenChange: te,
          onCloseAutoFocus: (A) => {
            var J;
            Et.current && (Et.current = !1, A.preventDefault(), (J = Qt.current) == null || J.focus());
          },
          className: m(Rr && Je),
          modal: !0,
          align: "start"
  ...
  const [Tt, _t] = _(null), [Nt, ft] = _(null), [Lt, le] = _(null), Fe = 200, [$i, Ii] = _(!1);
  G(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Ii(J.contentRect.width < Fe);
    });
    return A.observe(Lt), () => A.disconnect();
  }, [Lt]);
  const vo = j(
    (A) => {
      Ve(A), It(at), oe(mt), ur(n), Mt(!1), Ut(A);
    },
    [at, mt, n]
  ), bo = j(() => {
    $t !== void 0 && ($t === "range" ? (R && (g == null || g(R)), xt && (h == null || h(xt))) : $t === "selectedBooks" && i(Le), et($t), Ut(void 0), Ve(void 0));
  }, [
    $t,
    R,
    xt,
    ...
    A || (Ut(void 0), Ve(void 0));
  }, []), xo = j((A) => {
    var J;
    A.preventDefault(), (J = Be.current) == null || J.focus();
  }, []), yo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(or, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Ct, { children: y }),
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(la, { container: Lt, children: [
              st.map(({ value: A, label: J, dropdownLabel: Kt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te(A),
              ...
              x && /* @__PURE__ */ u(ct, { children: [
                /* @__PURE__ */ a(He, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: yt }),
                /* @__PURE__ */ a(
                  qe,
                  {
                    ref: Vt,
                    ...
                    onSelect: (A) => {
                      ...
                      Zt.current || (Kt = (J = bt.current) == null ? void 0 : J.querySelector("button")) == null || Kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          J != null && J.closest("button") && (Ot.current = !0, requestAnimationFrame(() => {
                            Ot.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var J;
                              A.preventDefault(), (J = Vt.current) == null || J.focus();
                            },
                            modal: !0,
        ...
        Ga,
        {
          ...
          children: tt.map(({ value: A, label: J, scrRefSuffix: Kt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Hr, { className: "tw:me-2", value: A, id: fr }),
            /* @__PURE__ */ a(Ct, { htmlFor: fr, children: H(J, Kt) })
          ] }, fr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { children: Z }),
      hr
    ] }),
    l === "radio" && t === "range" && At,
    l === "dropdown" && ht && /* @__PURE__ */ a(Ea, { open: St === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: ft,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (A) => {
          Nt != null && Nt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: Nt, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: q }) }),
          hr,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Dr(!1), children: X }),
            /* @__PURE__ */ a(K, { onClick: bo, children: U })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && pt && /* @__PURE__ */ a(Ea, { open: St === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: _t,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (A) => {
          Tt != null && Tt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: Tt, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: W }) }),
          At,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Dr(!1), children: X }),
            /* @__PURE__ */ a(K, { ref: Qt, onClick: bo, children: U })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: d[So(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(Yt, { children: [
  /* @__PURE__ */ a(Wt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    qe,
    {
      onClick: () => {
        o(c);
...
function Fa({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(As, {}) }) }),
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(En, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Ht, { children: zi(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const Si = qt.forwardRef(
...
const Ri = qt.forwardRef(({ className: t, ...e }, r) => {
  const o = se();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
const Di = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: m(
...
const Zw = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
...
)), Oi = qt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Content,
  {
    ref: r,
    className: m(
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Yt, { children: [
      /* @__PURE__ */ a(Wt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ou,
        {
          onClick: () => {
            o(l);
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (z = d.current) == null || z.focus(), vr(d, [g, h]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Ht, { children: Mi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function oh({
  ...
  const l = du(
    ...
    var z, k, N, O, B, C;
    const v = x !== f ? ((k = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : k[x]) ?? ((O = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : O.en) : void 0;
    return v ? `${(B = t[f]) == null ? void 0 : B.autonym} (${v})` : (C = t[f]) == null ? void 0 : C.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Ct, { className: "tw:font-normal tw:text-muted-foreground", children: Ge(l, {
...
function ih({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(os, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(ns, { children: /* @__PURE__ */ a(ec, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
...
function Nh({
  ...
  return /* @__PURE__ */ u(
    Dt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Dt.ItemIndicator, { children: /* @__PURE__ */ a(na, {}) }) }),
        e
      ]
    }
  );
...
const Ua = 288, ku = 176, Vr = 12, Lr = 6;
function _u(t) {
...
function Cu(t, e, r) {
  const o = (i) => Math.max(8, Math.min(i, window.innerWidth - Ua - 8)), n = (i) => Math.max(8, Math.min(i, window.innerHeight - r - 8));
  switch (e) {
    case "top":
      return {
        top: n(t.top - Vr - r),
    ...
    case "left":
      return { top: n(t.top), left: o(t.left - Ua - Vr) };
    case "right":
...
function Xh({
  ...
  const [l, w] = _([]), [p, g] = _(0), [h, f] = _(void 0), [x, v] = _(ku), z = F(null), k = F(null), N = F(void 0), O = Wr(), B = Wr();
  G(() => {
    e && (w(t.filter((E) => !!document.querySelector(E.target))), g(0));
  }, [e, t]);
  const C = l[p];
  G(() => {
    if (!e || !C) return;
    let E;
    const U = () => {
      const yt = _u(C.target);
      yt && f(yt);
    }, X = () => {
      E === void 0 && (E = requestAnimationFrame(() => {
        E = void 0, U();
      }));
    };
    return U(), window.addEventListener("resize", X), window.addEventListener("scroll", X, { capture: !0, passive: !0 }), () => {
      window.removeEventListener("resize", X), window.removeEventListener("scroll", X, { capture: !0 }), E !== void 0 && cancelAnimationFrame(E);
    };
  }, [e, C]), Gt(() => {
    var U;
    const E = (U = k.current) == null ? void 0 : U.offsetHeight;
    E && v((X) => X !== E ? E : X);
  }), G(() => {
    e ? N.current = document.activeElement ?? void 0 : N.current instanceof HTMLElement && (N.current.focus(), N.current = void 0);
  }, [e]), G(() => {
    var E;
    e && C && ((E = z.current) == null || E.focus());
  }, [e, C]);
  const M = p === l.length - 1, $ = p === 0, T = j(() => {
    M ? r() : g((E) => E + 1);
  }, [M, r]), P = j(() => {
    $ || g((E) => E - 1);
  }, [$]);
  if (G(() => {
    if (!e) return;
    const E = (U) => {
      U.key === "Escape" && (U.stopPropagation(), o());
    };
    return window.addEventListener("keydown", E, !0), () => window.removeEventListener("keydown", E, !0);
  }, [e, o]), !e || !C || !h) return null;
  const q = Nu(C.side ?? "bottom"), y = Cu(h, q, x), Z = h.left - Lr, L = h.top - Lr, W = h.width + Lr * 2, S = h.height + Lr * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
      ...
      children: [
        ...
        /* @__PURE__ */ u(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ u("mask", { id: O, children: [
                /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "white" }),
                /* @__PURE__ */ a("rect", { x: Z, y: L, width: W, height: S, rx: "6", fill: "black" })
              ] }) }),
              /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "rgba(0,0,0,0.55)", mask: `url(#${O})` })
            ]
          }
        ),
        /* @__PURE__ */ u(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: n ? n(p + 1, l.length) : `${p + 1} / ${l.length}` }),
              /* @__PURE__ */ a("h3", { className: "tw:text-sm tw:font-semibold", children: C.title }),
              /* @__PURE__ */ a("p", { id: B, className: "tw:text-sm tw:text-muted-foreground", children: C.description }),
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !$ && /* @__PURE__ */ a(K, { variant: "outline", size: "sm", onClick: P, children: s }),
                  /* @__PURE__ */ a(K, { ref: z, size: "sm", onClick: T, children: M ? d : i })
                ] })
              ] })
            ]
          }
