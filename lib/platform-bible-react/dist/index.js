...
function qd({
  ...
  }, [St, H, w]), vt = St && (Z == null ? void 0 : Z.conflictType) === "verseText" && !!(Z != null && Z.resultText), yt = q(null), ft = q(void 0), lt = j(() => {
    var b;
...
function Zp({
  ...
  const N = Rt(
    ...
    [r, n, m, i]
  ), nt = ot.find((M) => M.value === t), vt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? cs(ct, tt, {
