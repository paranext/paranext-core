...
import b, { forwardRef as tn, useRef as rt, useMemo as $, useState as D, useCallback as j, useLayoutEffect as $t, createContext as xn, useContext as fr, useEffect as q, Component as ds, createElement as Br, Suspense as ps, createRef as us, Fragment as fo } from "react";
...
const ta = tn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Me : "button", { className: m(bl({ variant: t, size: n, className: e })), ref: s, ...a })
);
...
function hp({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, N] = D(""), [k, C] = D("books"), [_, x] = D(void 0), [E, I] = D(!1), R = rt(void 0), S = rt(void 0), O = rt(void 0), y = rt(void 0), T = rt({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
      ...
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Nn();
            u.append(g);
            const N = na ? document.activeElement : null;
...
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: N, role: k = "textbox", spellCheck: C = !0, style: _, tabIndex: x, "data-testid": E, ...I }, R) {
    ...
    if (r && N)
      return /* @__PURE__ */ d(at, { children: [
        !Qs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g(Bw(Gr(e.contents))), c == null || c(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ d(
            "div",
            {
              ...
              onKeyDown: (y) => {
                Ea(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  wr,
...
function wc({
  ...
  var R;
  const [p, f] = D([]), [h, u] = D([]), [g, N] = D({}), [k, C] = D({}), _ = $(() => t ?? [], [t]), x = $o({
    data: _,
    columns: e,
    getCoreRowModel: Bo(),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Kt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
...
function Nc({
  ...
  return /* @__PURE__ */ d(at, { children: [
    ...
    /* @__PURE__ */ o("div", { className: m("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ o(at, { children: xc(e.marker, l, r, w) }) })
  ] });
}
...
function Op({
  ...
  const f = p ? kc(p, "%webView_footnoteList_header%") : "Footnotes", h = c ?? ri(n, void 0), u = (x, E) => {
    w == null || w(x, E, a);
...
function zp({ localizedStrings: e, markerMenuItems: t }) {
  const [n, r] = D(""), a = $(() => {
    ...
    return s ? t.filter(
      (i) => {
        var l;
        return i.marker ? (l = i.marker) == null ? void 0 : l.toLowerCase().includes(s) : i.title.toLowerCase().includes(s);
      }
    ) : t;
  }, [n, t]);
  ...
  ({
    ...
    const c = e ? Me : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      c,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: m(Bc({ variant: n, size: r }), s),
        ...i
      }
    );
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Pe, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
...
const dd = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ks, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
const hd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
