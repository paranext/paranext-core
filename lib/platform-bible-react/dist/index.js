...
function Fd({
  ...
  const B = (V) => {
    ...
    const V = i ?? "accept";
    return V === "merged" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      /* @__PURE__ */ a(Ta, { html: k }),
      /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: e["%conflict_note_outcome_combined%"] ?? "Combined both changes." })
    ] }) : V === "reject" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.rejectedResultText }),
      /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: e["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
    ] }) : /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-col tw:gap-1", children: /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.resultText }) });
  }, S = (V) => {
