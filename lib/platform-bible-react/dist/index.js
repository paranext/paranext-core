...
import b, { forwardRef as Qe, useRef as rt, useMemo as B, useState as D, useCallback as z, useLayoutEffect as $t, createContext as vn, useContext as fr, useEffect as q, Component as cs, createElement as Lr, Suspense as ds, createRef as ps, Fragment as ho } from "react";
import { Command as ft } from "cmdk";
import { X as tn, Search as fo, Check as Ot, Clock as Br, ChevronsLeft as zr, ChevronsRight as jr, ChevronLeft as qn, ChevronRight as Ce, ArrowLeft as us, ArrowRight as ms, Circle as xn, ChevronDown as de, BoldIcon as hs, ItalicIcon as fs, UnderlineIcon as gs, StrikethroughIcon as bs, Pencil as vs, Trash2 as xs, ArrowUp as go, MoreHorizontal as bo, ChevronUp as Jn, AtSign as ys, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as vo, Filter as Ss, User as Ts, Link as Rs, CircleHelp as Ds, ChevronsUpDown as xo, Star as Os, FunctionSquare as yo, SquareSigma as No, SquareX as Is, AlertCircle as Wn, CircleCheckIcon as Ms, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as Ps, ArrowDownIcon as $s, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as zs, ScrollText as js, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Ks } from "lucide-react";
import { clsx as Us } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as Ct from "@radix-ui/react-dialog";
import { includes as ln, Section as H, getChaptersForBook as qs, formatScrRef as ke, getSectionForBook as Ge, formatRelativeDate as Js, formatReplacementString as se, sanitizeHtml as Ws, parseParatextHtml as Fr, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as ko, isString as Vn, compareScrRefs as Zn, scrRefToBBBCCCVVV as Pn, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import { createEditor as Co, $getRoot as Ut, $createParagraphNode as yn, $getSelection as Lt, HISTORY_MERGE_TAG as gr, ParagraphNode as Eo, TextNode as So, $isTokenOrSegmented as ri, $getCharacterOffsets as oi, $cloneWithPropertiesEphemeral as ai, $findMatchingParent as si, $isElementNode as ie, CLEAR_EDITOR_COMMAND as To, COMMAND_PRIORITY_EDITOR as Ro, $isRangeSelection as qe, shallowMergeConfig as ii, defineExtension as Bt, safeCast as en, RootNode as li, LineBreakNode as wi, TabNode as ci, $isEditorState as di, createCommand as pi, CLICK_COMMAND as ui, isDOMNode as mi, $getNodeFromDOMNode as hi, $isNodeSelection as fi, $createNodeSelection as gi, $setSelection as bi, COMMAND_PRIORITY_LOW as vi, DecoratorNode as xi, $create as yi, $getNodeByKey as Ni, INDENT_CONTENT_COMMAND as Gr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as ki, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INSERT_TAB_COMMAND as Si, $isBlockElementNode as mn, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as hn, SELECTION_CHANGE_COMMAND as Do, FORMAT_TEXT_COMMAND as Di, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Hr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as Oo, $createLineBreakNode as Io, $isRootOrShadowRoot as Ai, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Vi } from "lexical";
...
import { useReactTable as Po, getFilteredRowModel as Hi, getSortedRowModel as $o, getPaginationRowModel as Xi, getCoreRowModel as Lo, flexRender as He, getGroupedRowModel as Ki, getExpandedRowModel as Ui } from "@tanstack/react-table";
...
const el = Ct.Root, nl = Ct.Portal, Bo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: m(
...
const Wo = Y.allBookIds.filter(
  (e) => !Y.isObsolete(Y.bookIdToNumber(e))
), le = Object.fromEntries(
  Wo.map((e) => [e, Y.bookIdToEnglishName(e)])
);
function _r(e, t, n) {
...
$.displayName = "Button";
const ge = Ee.Root, be = Ee.Trigger, dp = Ee.Anchor, Qt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
...
function up({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, N] = D(""), [k, C] = D("books"), [_, x] = D(void 0), [R, A] = D(!1), E = rt(void 0), T = rt(void 0), O = rt(void 0), y = rt(void 0), S = rt({}), V = z(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
  ...
  }), [L]), M = B(() => Object.values(F).flat(), [F]), W = B(() => {
    if (!g.trim()) return F;
    const v = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: j, isDigit: Z } = qr(v.key);
      if (k === "chapters") {
        if (v.key === "Backspace") {
      ...
      if ((k === "chapters" || k === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        ...
        switch (v.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Mt = mt === 0 ? ee : Math.max(1, mt - $r);
            break;
          case "ArrowDown":
            Mt = mt === 0 ? 1 : Math.min(ee, mt + $r);
            break;
          default:
            return;
        }
        Mt !== mt && (v.preventDefault(), v.stopPropagation(), u(or(ct, a, Mt)), setTimeout(() => {
          const Le = S.current[Mt];
    ...
    const { isLetter: j, isDigit: Z } = qr(v.key);
    (j || Z) && (v.preventDefault(), N((ct) => ct + v.key), T.current.focus(), A(!1));
  }, []);
  return $t(() => {
    const v = setTimeout(() => {
    ...
    /* @__PURE__ */ o(Qt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      he,
      {
        ...
        children: [
          ...
          !R && /* @__PURE__ */ d(fe, { ref: O, children: [
            k === "books" && /* @__PURE__ */ d(st, { children: [
              ...
              I && Dt(I.book) > 1 && /* @__PURE__ */ d(st, { children: [
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(_o.Root, { ref: n, className: m("pr-twp", Nl(), e), ...t }));
...
function ar({
  ...
  const [_, x] = D(!1), R = c ?? l, A = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], E = (T, O) => {
    const y = l(T), S = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${O ?? ""}${y}${S ?? ""}`;
    return /* @__PURE__ */ d(
      Zt,
      {
        value: y,
    ...
    /* @__PURE__ */ o(
      Qt,
      {
        ...
        children: /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ o(fe, { children: A(t) ? t.map((T) => /* @__PURE__ */ o(Yt, { heading: T.groupHeading, children: T.options.map((O) => E(O, T.groupHeading)) }, T.groupHeading)) : t.map((T) => E(T)) })
        ] })
      }
    )
  ] });
    ...
    (u) => {
      ...
      if (!!(k && g && k.contains(g) && g !== k) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (y === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(y + 1, O.length - 1) : S = Math.max(y - 1, 0), S !== y && (u.preventDefault(), u.stopPropagation(), (T = O[S]) == null || T.focus());
          return;
        }
        return;
      }
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = ta ? $t : q, wn = { tag: gr };
function Ol({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Rl(null, r), p = Co({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = ea && "documentMode" in document ? document.documentMode : null;
!(!ea || !("InputEvent" in window) || Gl) && "getTargetRanges" in new window.InputEvent("input");
function na(...e) {
  const t = [];
...
function ql(e) {
  ...
  aa(this), K = e, this.f &= -2, 8 & this.f && Tr(this), _n();
}
function Ne(e, t) {
...
ut.prototype.brand = Kl, ut.prototype.h = function() {
  ...
  if (this.g = pn, this.f |= 1, this.i > 0 && !oa(this)) return this.f &= -2, !0;
  const e = K;
  try {
    to(this), K = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, sa(this), to(this), Xt++;
  const e = K;
...
Bt({ build: (e, t, n) => Cn(t), config: en({ $onClear: ia }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Jt(() => la(e, r.value));
} });
function Jl(e) {
...
const ir = Bt({ build: (e) => wa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, da = 2, jn = 3, cn = 4, ye = 5, Fn = 6, ze = 7;
function Gn(e) {
  return e.id === Rr;
}
function pa(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === lr;
  }(e) || J(305, String(e.id), String(lr)), Object.assign(e, { id: da });
}
...
const ew = Bt({ config: en({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = tw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [li, So, wi, ci, Eo] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function nw(e) {
  throw e;
...
const rw = /* @__PURE__ */ new Set(), oo = Bt({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = wa(() => {
  }, () => Jt(() => {
...
Bt({ dependencies: [ir, oo], name: "@lexical/extension/HorizontalRule", nodes: [Se], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(oo).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
...
Bt({ build: (e, t, n) => Cn(t), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Jt(() => n.getOutput().disabled.value ? void 0 : ha(e)) });
function dw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
function mw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Dr(() => qt(Bi(a), ha(a)), [a]);
  }(r), d(st, { children: [e, o(hw, { content: t }), o(uw, { editor: r, ErrorBoundary: n })] });
}
...
function bw({ onClear: e }) {
  const [t] = It();
  return gw(() => la(t, e), [t, e]), null;
}
const fa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : q;
...
function Nw(e, t) {
  ...
  return d(st, { children: [o(xw, { editor: a, ...r, ref: t }), n != null && o(kw, { editor: a, content: n })] });
}
...
function Ew() {
  const [e, t] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(el, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(zo, { children: [
      /* @__PURE__ */ o(jo, { children: /* @__PURE__ */ o(Fo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
const va = Wt(
  ...
  {
    ref: a,
    className: m(va({ variant: t, size: n, className: e })),
    ...r
  }
));
Rw.displayName = Mo.Root.displayName;
...
function Dw() {
  const { activeEditor: e } = ba(), [t, n] = D([]), r = z((a) => {
    if (qe(a) || Fi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function ka(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < f.length; g++) h.push(...ka(f[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Xr(e) && (h = Pw(e, h, u ? () => {
    const g = new Oo();
    return n.push(g), g;
  } : yn)), l == null ? h.length > 0 ? i = i.concat(h) : Xr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Kr(g.nextSibling) && Kr(g.previousSibling);
  }(e) && (i = i.concat(Io())) : ie(l) && l.append(...h), i;
}
function Pw(e, t, n) {
...
function ve({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Ir.Provider, { value: n, children: /* @__PURE__ */ o(tt.Root, { ...t }) });
}
...
function lo({
  ...
  }, [e.date, n]), A = B(() => e.user, [e.user]), E = B(
    ...
    if (r && N)
      return /* @__PURE__ */ d(st, { children: [
        !Zs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g(Lw(Fr(e.contents))), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Sa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ta, { className: "tw-text-xs tw-font-medium", children: E }) }),
        ...
        O && /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
...
function qw({
  ...
  const [C, _] = D(wo), [x, R] = D(!1), [A, E] = D(!1), [T, O] = D(!1), [y, S] = D(!1), [V, L] = D(!1), [F, M] = D(void 0), [W, I] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      I(!1), yt(!1);
  ...
  const wt = B(
  ...
  }, [a, t]), jt = B(() => _t.slice(1), [_t]), vt = B(() => jt.length ?? 0, [jt.length]), On = B(() => vt > 0, [vt]), In = B(() => T || vt <= 2 ? jt : jt.slice(-2), [jt, vt, T]), xe = B(() => T || vt <= 2 ? 0 : vt - 2, [vt, T]), an = B(
    ...
    async (v) => {
      ...
      return Z && j && dt(), Z && F !== void 0 && M(void 0), Z;
    },
    [dt, C, w, F]
  );
  return /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ d(st, { children: [
            ...
            u !== !1 && (!y || Ft(C)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDown: (v) => {
                  _a(v), (v.key === "Enter" || v.key === " ") && v.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    wr,
...
function bp({
  ...
  const [h, u] = D(), g = t.filter(
    ...
    u(E);
  }, []), { listboxRef: _, activeId: x, handleKeyDown: R } = Tl({
    options: N,
    onOptionSelect: k
  }), A = z(
    (E) => {
...
const De = at.Root, Ww = at.Group, Oe = at.Value, Zw = Wt(
  ...
  return /* @__PURE__ */ d(
    at.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(de, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
ue.displayName = at.Trigger.displayName;
...
Ma.displayName = at.ScrollUpButton.displayName;
...
me.displayName = at.Content.displayName;
...
Qw.displayName = at.Label.displayName;
...
tc.displayName = at.Separator.displayName;
function ec({ table: e }) {
...
function lc({
  ...
  var E;
  const [p, f] = D([]), [h, u] = D([]), [g, N] = D({}), [k, C] = D({}), _ = B(() => t ?? [], [t]), x = Po({
    data: _,
    columns: e,
    getCoreRowModel: Lo(),
  ...
  let A;
  return c ? A = Array.from({ length: 10 }).map((y, S) => `skeleton-row-${S}`).map((y) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ce, { colSpan: R.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((E = x.getRowModel().rows) == null ? void 0 : E.length) > 0 ? A = x.getRowModel().rows.map((T) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(T, x),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((O) => /* @__PURE__ */ o(ce, { children: He(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    T.id
  )) : A = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ce, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Jw, { table: x }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: x.getHeaderGroups().map((T) => /* @__PURE__ */ o(At, { children: T.headers.map((O) => /* @__PURE__ */ o(Ze, { children: O.isPlaceholder ? void 0 : He(O.column.columnDef.header, O.getContext()) }, O.id)) }, T.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(vo, {}) })
        ] }),
...
function Np({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(ve, { children: [
    ...
    /* @__PURE__ */ o(te, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Ra, { children: w.itemType === 0 ? /* @__PURE__ */ o(st, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Kt,
        {
          checked: r[p][h],
...
function uc({
  ...
  const [C, _] = D(!1), x = z(
    (S) => {
      var L;
      const V = (L = e.find((F) => F.label === S)) == null ? void 0 : L.value;
      V && n(
    ...
    if (!h) return e;
    const S = e.filter((L) => L.starred).sort((L, F) => L.label.localeCompare(F.label)), V = e.filter((L) => !L.starred).sort((L, F) => {
      const M = t.includes(L.value), W = t.includes(F.value);
      return M && !W ? -1 : !M && W ? 1 : L.label.localeCompare(F.label);
    });
    return [...S, ...V];
  }, [e, t, h]), E = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: k, className: g, children: /* @__PURE__ */ d(ge, { open: O, onOpenChange: p ?? _, children: [
    ...
    /* @__PURE__ */ o(Qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(he, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: E, children: s }),
        /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: T, children: i })
      ] }),
...
$e.displayName = "Input";
const mc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(st, { children: [
...
const fc = (e, t) => e === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o(yo, {}),
  " ",
...
function Ep({
  ...
  q(() => {
    ...
    if (R && $n("note", R)) {
      ...
      let O = "custom";
      T === Qn ? O = "generated" : T === tr ? O = "hidden" : T && h(T), p(O), g(((E = R.insert.note) == null ? void 0 : E.style) ?? "f"), R.insert.note && (R.insert.note.caller = ""), x = setTimeout(() => {
        var y;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ht, { children: [
            /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o($, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
  ...
  return /* @__PURE__ */ d(st, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(st, { children: vc(e.marker, l, r, w) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      At,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ce, { children: Nc(i.text) })
        ]
      },
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Rp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, Cc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Vp = Object.freeze([
...
function Pp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), N = Tt(n, "%webView_inventory_scope_currentBook%"), k = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), x = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), R = Tt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [T, O] = D("all"), [y, S] = D(""), [V, L] = D([]), F = B(() => {
    const P = e ?? [];
  ...
  }, [A, F]), W = B(() => M.length === 0 ? [] : Ec(M, T, y), [M, T, y]), I = B(() => {
    var dt, wt;
    if (!A) return c;
...
const Tc = "16rem", Rc = "3rem", Pa = b.createContext(void 0);
function Dn() {
...
const Pc = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: r,
...
Pc.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const c = e ? Ie : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      c,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: m($c({ variant: n, size: r }), s),
        ...i
      }
    );
...
const Gt = "scrBook", Xc = "scrRef", ae = "source", Kc = "details", Uc = "Scripture Reference", Yc = "Scripture Book", Ha = "Type", qc = "Details";
function Jc(e, t) {
  const n = t ?? !1;
  return [
    {
...
}, uo = (e) => `${Wc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Lp({
  sources: e,
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const V = N.find((L) => uo(L) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, N, l, C]);
  const _ = a ?? Yc, x = s ?? Ha, R = [
  ...
  }, T = (y, S) => y.getIsGrouped() ? "" : m("banded-row", S % 2 === 0 ? "even" : "odd"), O = (y, S, V) => {
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(me, { position: "item-aligned", children: /* @__PURE__ */ o(Ww, { children: R.map((y) => /* @__PURE__ */ o(kt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: C.getHeaderGroups().map((y) => /* @__PURE__ */ o(At, { children: y.headers.filter((S) => S.column.columnDef.header).map((S) => (
        ...
        /* @__PURE__ */ o(Ze, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
...
}), Xa = (e, t, n) => Pr(e, t).every((r) => n.includes(r));
function Zc({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function Qc({
  ...
  const E = B(() => Y.allBookIds.filter(
    (M, W) => e[W] === "1" && !Y.isObsolete(Y.bookIdToNumber(M))
  ), [e]), T = B(() => {
    if (!_.trim()) {
      const I = {
        [H.OT]: [],
    ...
    (M, W = !1) => {
      if (!W || !R.current) {
        n(
          t.includes(M) ? t.filter((P) => P !== M) : [...t, M]
        ), R.current = M;
        return;
      }
      const I = E.findIndex((P) => P === R.current), ot = E.findIndex((P) => P === M);
      if (I === -1 || ot === -1) return;
      const [yt, _t] = [
        Math.min(I, ot),
        Math.max(I, ot)
      ...
      n(
        t.includes(M) ? t.filter((P) => !bt.includes(P)) : [.../* @__PURE__ */ new Set([...t, ...bt])]
      );
    },
    [t, n, E]
  ), y = (M) => {
    O(M, A.current), A.current = !1;
  }, S = (M, W) => {
    M.preventDefault(), O(W, M.shiftKey);
  }, V = z(
    (M) => {
      const W = Pr(E, M).map((I) => I);
      n(
        Xa(E, M, t) ? t.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, E]
  ), L = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(H).map((M) => /* @__PURE__ */ o(
      Zc,
      {
        section: M,
        availableBookIds: E,
        ...
        children: [
          ...
          /* @__PURE__ */ o(Qt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            he,
            {
              shouldFilter: !1,
              onKeyDown: (M) => {
                M.key === "Enter" && (A.current = M.shiftKey);
              },
              children: [
                /* @__PURE__ */ o(
                  rn,
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Kn ? Kn : mo
      ).map((M) => /* @__PURE__ */ o(Te, { className: "hover:tw-bg-secondary", variant: "secondary", children: _e(M, a) }, M)),
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: x, id: R }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(fn, { className: "tw-me-2", value: _, id: R }),
...
function hr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    ...
    /* @__PURE__ */ o(te, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
...
function Up({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(qa, { children: [
      /* @__PURE__ */ o(Ja, { children: e.map((l) => /* @__PURE__ */ o(td, { value: l.value, children: l.value }, l.key)) }),
...
function sd({
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    return /* @__PURE__ */ o(Za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ d(ed, { children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Ve, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
...
const wd = Qe(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
const tu = nt.Root, eu = nt.Trigger, nu = nt.Group, ru = nt.Portal, ou = nt.Sub, au = nt.RadioGroup, md = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
const bd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
const vd = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
const su = Et.Trigger, _d = Et.Portal, iu = Et.Close, is = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
Td.displayName = Et.Title.displayName;
...
Rd.displayName = Et.Description.displayName;
...
Dd.displayName = nr.Root.displayName;
function lu({
  className: e,
  ...t
}) {
...
Od.displayName = Fe.Root.displayName;
...
const pu = gt.Root, Md = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
