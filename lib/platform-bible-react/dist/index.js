...
import { c as m, g as De, a as Ba, C as $e, A as ce, P as Ae, b as qe, B as G, d as Ie, e as Ge, f as He, h as ye, i as ji, k as Bi, j as Li, E as Fi, l as La, r as re, m as Ui, n as ln, o as Zr, p as Fa, L as kt, D as ka, q as _a, s as Na, t as Ca, T as Kt, u as Ua, v as qt, w as Gt, x as Ht, y as dn, z as Ka, F as Fe, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ki, N as Nr, O as Ke, Q as Oe, Z as Ye, R as Re, U as tr, V as qa, W as Ga, X as Kr, Y as Ha, _ as wn, $ as qi, a0 as Gi, a1 as Hi, a2 as bo, a3 as un, a4 as Qr, a5 as pn, a6 as Yi, a7 as Wi, a8 as Xi, a9 as Ji, aa as hn, ab as Zi, ac as na, ad as xo, ae as ia, af as Qi, ag as ts, ah as es, ai as rs, aj as as, ak as Cr, al as Ya } from "./resizable-Rk1gjPJn.js";
import { am as Lh, an as Fh, ao as Uh, ap as Kh, aq as qh, ar as Gh, as as Hh, at as Yh, au as Wh, av as Xh, aw as Jh, ax as Zh, ay as Qh, az as tg, aA as eg, aB as rg, aC as ag, aD as og, aE as ng, aF as ig, aG as sg, aH as cg, aI as lg, aJ as dg, aK as wg } from "./resizable-Rk1gjPJn.js";
import { jsx as a, jsxs as u, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ar, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ea, ChevronRight as Ta, ArrowLeft as os, ArrowRight as ns, ChevronDown as or, BoldIcon as is, ItalicIcon as ss, X as Wa, AtSign as gn, Pencil as cs, Trash2 as ls, ArrowUp as fn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as mn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as vn, FunctionSquare as bn, SquareSigma as xn, Ban as Cs, AlertCircle as za, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Ds, ScrollText as Rs, ChevronsUpDown as Os, MenuIcon as Ms, Menu as $s, EllipsisVertical as As, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as Vs, formatReplacementString as Ue, sanitizeHtml as Xa, NumberFormat as yn, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as Vr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as Co, compareScrRefs as Sa, scrRefToBBBCCCVVV as sa, defaultScrRef as ca, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as Us } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as M, useState as _, useCallback as L, useEffect as W, useImperativeHandle as Ks, useLayoutEffect as Zt, createContext as Ja, useContext as kn, Component as qs, createElement as To, Suspense as Gs, forwardRef as _n, useId as zo, Fragment as Za } from "react";
import { RadioGroup as Da, ToggleGroup as Nn, Avatar as Qa, Select as Lt, Checkbox as So, Slot as Er, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as Do, Slider as Rr, Switch as Ro } from "radix-ui";
import { createEditor as Cn, $getRoot as Me, $createParagraphNode as Tr, $getSelection as Yt, HISTORY_MERGE_TAG as to, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Hs, $isRangeSelection as pe, $caretFromPoint as Ys, $getSiblingCaret as zn, $getChildCaret as Ws, $getAdjacentChildCaret as Xs, $isChildCaret as Js, $normalizeCaret as Zs, $setSelectionFromCaretRange as Qs, $getCollapsedCaretRange as tc, $getCaretInDirection as Oo, $splitAtPointCaretNext as ec, $isTextPointCaret as rc, $findMatchingParent as Sn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as ac, isHTMLElement as oc, CLEAR_EDITOR_COMMAND as Dn, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as nc, defineExtension as ae, safeCast as We, createState as ic, FORMAT_TEXT_COMMAND as Rn, $isNodeSelection as On, COMMAND_PRIORITY_LOW as Mn, RootNode as sc, LineBreakNode as cc, TabNode as lc, $isEditorState as dc, createCommand as wc, CLICK_COMMAND as uc, isDOMNode as pc, $getNodeFromDOMNode as hc, $createNodeSelection as gc, $setSelection as fc, $getEditor as mc, DecoratorNode as Ra, $getState as vc, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as bc, $setState as xc, addClassNamesToElement as $n, $create as yc, $getNodeByKey as kc, removeClassNamesFromElement as _c, KEY_TAB_COMMAND as Nc, $isBlockElementNode as Cc, $createRangeSelection as Ec, $normalizeSelection__EXPERIMENTAL as Tc, OUTDENT_CONTENT_COMMAND as zc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as Sc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Dc, $isParagraphNode as Rc, $isTextNode as Oa, SELECTION_CHANGE_COMMAND as An, $insertNodes as Oc } from "lexical";
import { HeadingNode as Mc, QuoteNode as $c, registerRichText as Ac } from "@lexical/rich-text";
...
import { useReactTable as Vn, getFilteredRowModel as Lc, getSortedRowModel as Pn, getPaginationRowModel as Fc, getCoreRowModel as jn, flexRender as vr, getGroupedRowModel as Uc, getExpandedRowModel as Kc } from "@tanstack/react-table";
import { IconCheck as ea, IconChevronDown as qc, IconChevronUp as Gc, IconSelector as Hc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Wc, IconChevronRight as Bn, IconLoader as Xc, IconAlertOctagon as Jc, IconAlertTriangle as Zc, IconInfoCircle as Qc, IconCircleCheck as tl } from "@tabler/icons-react";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as $a, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Or, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
function da({
  ...
  const I = re(), [B, T] = _(!1), [V, $] = _(""), [N, j] = _(""), [R, E] = _("books"), [Y, q] = _(void 0), [F, O] = _(
    void 0
  ), [S, Z] = _(void 0), [Q, _t] = _(!1), Nt = K(null), It = K(!1), U = K(void 0), tt = K(void 0), wt = K(void 0), st = K(void 0), vt = K({}), oe = K({}), at = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  }), [Vt]), Wt = M(() => Object.values(St).flat(), [St]), ne = M(() => {
    if (!N.trim()) return St;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Dt } = {
    ...
    () => dl(N),
    [N]
  ), yt = M(() => !l || !D || !D.chapterNum || !Mt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, Mt]), de = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), Te = L(
    (b) => (H) => w ? wl(b, H, w) : !1,
    ...
    [w]
  ), ur = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", pr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", zr = L(
    (b) => {
    ...
    (b) => {
      ...
      if ((R === "chapters" || R === "books" && D) && Pt) {
        const $t = R === "chapters" ? Y : D == null ? void 0 : D.book;
        if (!$t) return;
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = qn ? Zt : W, $r = { tag: to };
function ml({ initialConfig: t, children: e }) {
  const r = M(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = gl(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function El() {
  return function(t) {
    const [e] = fe(), r = M(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = K(o);
    return Nl(() => {
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((T || V) && I !== null && B !== null) {
        const $ = function(N, j, R, E, Y, q, F) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Bo(j, R, E)), O.setEnd(...Bo(Y, q, F)), O;
        }(t, g, f, I, h, C, B);
        d(), d = Dl(t, $, e);
      }
...
function Al(t) {
  ...
  if (pe(e)) r = Ys(e.focus, "next");
    ...
    r = r || Ws(Me(), "previous").getFlipped().insert(Tr());
  }
...
function Il(t, e, r) {
  ...
  return rc(o) && Gr(283), o.insert(t.isInline() ? Tr().append(t) : t), Oo(zn(t.getLatest(), "next"), e.direction);
}
function Vl(t) {
  const e = Yt();
  if (!pe(e)) return !1;
...
function Fl(t) {
  ...
  Yn(this), nt = t, this.f &= -2, 8 & this.f && io(this), ra();
}
function Ze(t, e) {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(Rn, (o) => {
  const n = Yt();
  if (On(n) || pe(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, Mn) });
function Qn(t, e) {
  let r;
...
const Va = ae({ build: (t) => Qn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const so = 0, Pa = 1, ei = 2, ha = 3, Ar = 4, Je = 5, ga = 6, gr = 7;
function fa(t) {
  return t.id === so;
}
function ri(t) {
...
const Wl = ae({ config: We({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [sc, Tn, cc, lc, En] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function Xl(t) {
  throw t;
...
class rr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      fa(i) || lt(300, s, n || "[unknown]"), fa(c = i) || lt(304, String(c.id), String(so)), i = Object.assign(c, { id: Pa }), o.state = i;
...
const Jl = /* @__PURE__ */ new Set(), Ho = ae({ build(t, e, r) {
  const o = r.getDependency(Va).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Qn(() => {
  }, () => he(() => {
...
ae({ dependencies: [Va, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(Zl, (s) => {
    ...
    if (pc(s.target)) {
      ...
      if (td(c)) return function(d, l = !1) {
        ...
        let h;
        l && On(w) ? h = w : (h = gc(), fc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function hd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: C = !0, style: y, tabIndex: k, "data-testid": I, ...B }, T) {
  ...
  }, [t]), j = M(() => /* @__PURE__ */ function(...R) {
    return (E) => {
      for (const Y of R) typeof Y == "function" ? Y(E) : Y != null && (Y.current = E);
    };
  }(T, N), [N, T]);
  return ii(() => ($(t.isEditable()), t.registerEditableListener((R) => {
    $(R);
...
function Zo({
  ...
  const h = L(
    ...
    [t.user]
  ), y = M(() => Xa(t.contents), [t.contents]), k = M(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), I = !!t.conflictResolutionAction && !k, B = M(() => {
    if (o && c)
      return /* @__PURE__ */ u(it, { children: [
        /* @__PURE__ */ u(
          Fe,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ad, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Id, { className: "tw:text-xs tw:font-medium", children: C }) }),
...
function bi({
  ...
  const [E, Y] = _(Qo), [q, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, It] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, oe] = _(!1), [at, Vt] = _(I), [St, Wt] = _(!1), ne = K(void 0), [D, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  const Qt = M(() => Ct[0], [Ct]), me = K(null), ie = K(void 0), P = L(() => {
    var z;
  ...
  }, [i, r]), ut = M(() => Ct.slice(1), [Ct]), ct = M(() => ut.length ?? 0, [ut.length]), gt = M(() => ct > 0, [ct]), pt = M(() => Q || ct <= 2 ? ut : ut.slice(-2), [ut, ct, Q]), ft = M(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Dt = M(
          ...
          o && /* @__PURE__ */ u(it, { children: [
            ...
            v !== !1 && (!Nt || ee(E)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (z) => {
                  uo(z) && (z.preventDefault(), z.stopPropagation(), (ee(E) || q !== void 0 && q !== O) && Ft());
                },
                onKeyDown: (z) => {
...
), Pd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Fr = (t) => Pd(Xa(t));
function Ur({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function ep({
  ...
  const [y, k] = _(/* @__PURE__ */ new Set()), [I, B] = _(), [T, V] = _(), $ = L(
    async (S) => {
      const Z = await i(S);
      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Kd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(bi, { ...Z })
          },
          S.id
        );
      })
...
function Xd({
  ...
  var T;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, C] = _({}), y = M(() => e ?? [], [e]), k = Vn({
    data: y,
    columns: t,
    getCoreRowModel: jn(),
...
function ww({
  ...
  return /* @__PURE__ */ u(Ge, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(He, { children: [
      /* @__PURE__ */ a(Fa, { children: t["%markerMenu_noResults%"] }),
...
function wp({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [I, B] = _("*"), [T, V] = _("f"), [$, N] = _(!1), [j, R] = _(!0), [E, Y] = _(!1), q = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [It, U] = _(), [tt, wt] = _(), st = K(null), vt = M(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      ut === Ma ? ct = "generated" : ut === $a ? ct = "hidden" : ut && (k(ut), B(ut)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const at = L(
    (P, X, ot = !1) => {
      ...
      if (et && Or("note", et)) {
        if (et.insert.note) {
          let pt;
          P === "custom" ? pt = X : P === "generated" ? pt = Ma : pt = $a, et.insert.note.caller = pt;
        }
      ...
      if (X && Or("note", X)) {
        ...
        if (pt || N(!1), N(
          pt === "x" ? !!(ft != null && ft.every((Dt) => {
            var Ft, Ot;
            if (!((Ft = Dt.attributes) != null && Ft.char)) return !0;
...
function yp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), I = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = _(!1), [N, j] = _("all"), [R, E] = _(""), [Y, q] = _([]), F = M(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = M(() => O.length === 0 ? [] : Nw(O, N, R), [O, N, R]), Z = M(() => {
    var wt, st;
    if (!V) return d;
...
const Ew = "16rem", Tw = "3rem", ki = Tt.createContext(void 0);
function oa() {
    ...
    Sw,
    {
      ...
      children: /* @__PURE__ */ u(Rw, { children: [
        /* @__PURE__ */ u(an, { children: [
          ...
          /* @__PURE__ */ a(nn, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Aw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Se = "scrBook", Vw = "scrRef", Le = "source", Pw = "details", jw = "Scripture Reference", Bw = "Scripture Book", _i = "Type", Lw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Ip({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: Se, desc: !1 }]), [h, f] = _({}), x = M(
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Gd, { children: I.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
...
function Kw({
  ...
  }, [x, v] = _(!1), [C, y] = _(""), k = K(void 0), I = K(!1), B = M(
    () => Ni(t),
    [t]
  ), T = M(() => {
    if (!C.trim()) {
...
function Pp({
  ...
  const I = Et(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), j = Et(s, "%webView_scope_selector_current_book%"), R = Et(s, "%webView_scope_selector_choose_books%"), E = Et(s, "%webView_scope_selector_scope%"), Y = Et(s, "%webView_scope_selector_select_books%"), q = Et(s, "%webView_scope_selector_range%"), F = Et(s, "%webView_scope_selector_select_range%"), O = Et(s, "%webView_scope_selector_range_start%"), S = Et(s, "%webView_scope_selector_range_end%"), Z = Et(s, "%webView_scope_selector_ok%"), Q = Et(s, "%webView_scope_selector_cancel%"), _t = Et(s, "%webView_scope_selector_navigate%"), Nt = (A) => {
    if (!f) return;
  ...
  ], U = (A, J, Ut = !1) => /* @__PURE__ */ u(it, { children: [
    A,
    J && !Ut && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? It.filter((A) => e.includes(A.value)) : It, wt = f ?? ca, st = w ?? wt, vt = p ?? wt, oe = () => {
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [D, Xt] = _(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L((A) => {
    if (A) {
    ...
    (A) => {
      g == null || g(A), h == null || h(A), xt.current = !0;
    },
    [g, h]
  ), X = L(
    (A) => {
      h == null || h(A), Ct.current = !0;
    },
    [h]
  ), ot = L(
    (A) => {
    ...
    [r, n, f, i]
  ), et = tt.find((A) => A.value === t), ut = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Fs(st, vt, {
  ...
  ), gt = tt.find((A) => A.value === "selectedBooks"), pt = tt.find((A) => A.value === "range"), [ft, Dt] = _(!1), [Rt, Ft] = _(void 0), [Ot, Ee] = _(void 0), [z, Mt] = _(void 0), [yt, de] = _(void 0), [Te, wr] = _([]), ur = l === "dropdown" && Rt === "selectedBooks", pr = /* @__PURE__ */ a(
    Gw,
    {
      availableBookInfo: o,
  ...
  ), zr = D === "end", Sr = D === "start", Xe = "tw:text-muted-foreground", b = l === "dropdown" && Rt === "range", H = b ? Mt : P, Pt = b ? de : h ? X : oe, ve = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        da,
        {
          ...
          onCloseAutoFocus: (A) => {
            var J;
            Ct.current && (Ct.current = !1, A.preventDefault(), (J = Qt.current) == null || J.focus());
          },
          className: m(Sr && Xe),
          modal: !0,
          align: "start"
  ...
  const [mt, At] = _(null), [ht, te] = _(null), [Jt, je] = _(null), Mi = 200, [$i, Ai] = _(!1);
  W(() => {
    if (!Jt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([J]) => {
      Ai(J.contentRect.width < Mi);
    });
    return A.observe(Jt), () => A.disconnect();
  }, [Jt]);
  const go = L(
    (A) => {
      Ee(A), Mt(st), de(vt), wr(n), Dt(!1), Ft(A);
    },
    [st, vt, n]
  ), fo = L(() => {
    ...
    A || (Ft(void 0), Ee(void 0));
  }, []), mo = L((A) => {
    var J;
    A.preventDefault(), (J = $t.current) == null || J.focus();
  }, []), vo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }) : void 0;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(ke, { open: ft, onOpenChange: Dt, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            children: /* @__PURE__ */ u(na, { container: Jt, children: [
              ct.map(({ value: A, label: J, dropdownLabel: Ut, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ u(
                Fe,
                {
                  ref: ze(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }),
                    U(Ut ?? J, hr, $i)
                  ]
                },
                Ii
        ...
        ao,
        {
          ...
          children: tt.map(({ value: A, label: J, scrRefSuffix: Ut, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(qr, { className: "tw:me-2", value: A, id: hr }),
...
const Di = Tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: m(
...
function qp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Si, { children: [
      /* @__PURE__ */ a(Di, { children: t.map((c) => /* @__PURE__ */ a(Ww, { value: c.value, children: c.value }, c.key)) }),
...
function Zp({ currentStep: t, totalSteps: e, locale: r = "en" }) {
  const o = r || "en", n = M(() => new yn(o), [o]), i = Math.min(Math.max(t, 1), e), s = M(
...
export {
  ...
  oh as ContextMenuTrigger,
  Xd as DataTable,
  ka as Dialog,
  Fh as DialogClose,
  _a as DialogContent,
  Uh as DialogDescription,
  xo as DialogFooter,
  Na as DialogHeader,
  Kh as DialogOverlay,
  qh as DialogPortal,
  ...
  $h as useEvent,
  Ah as useEventAsync,
  Vh as useExtraValidMarkers,
  Ki as useListbox,
  gu as usePromise,
  Lu as useRecentSearches,
  oa as useSidebar,
  Ih as useStylesheet,
  wg as useTruncationTooltip,
  Ph as useViewVisibility
};
