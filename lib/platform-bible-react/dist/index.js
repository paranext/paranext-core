...
import { Slot as fe, Dialog as qt, Popover as or, Tooltip as Pe, DropdownMenu as ht, Label as ui, RadioGroup as na, ToggleGroup as Ro, Separator as pi, Avatar as xa, Select as kt, Checkbox as Ka, Tabs as jt, Menubar as Wt, ContextMenu as ft, Progress as qa, Slider as gr, Switch as Ga } from "radix-ui";
...
import { useReactTable as en, getFilteredRowModel as pc, getSortedRowModel as rn, getPaginationRowModel as gc, getCoreRowModel as an, flexRender as rr, getGroupedRowModel as hc, getExpandedRowModel as fc } from "@tanstack/react-table";
import mc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as da, getDefaultViewOptions as vc, isInsertEmbedOpOfType as fr, Editorial as bc } from "@eten-tech-foundation/platform-editor";
...
const We = 250, on = 300, nn = 400, Ec = 450, zc = 500, sn = Yt(
  ...
  return /* @__PURE__ */ u(Dc, { children: [
    ...
    /* @__PURE__ */ u(
      qt.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(qt.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(gi, {}),
...
function Du({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(qt.Close, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
const Sa = "tw:data-selected:ring-3 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset", un = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), Ee = Object.fromEntries(
  un.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function Da(t, e, r) {
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ u(
          ...
          {
            ref: w,
            value: l || `${t} ${dt.bookIdToEnglishName(t)}`,
            onSelect: h,
            onMouseDown: p,
            role: "option",
            "aria-selected": e,
...
const Vc = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"];
function Fc(t) {
  return Vc.some((e) => e === t);
}
function Je(t) {
...
function Gc({ className: t, children: e, ...r }) {
  const o = lt();
  return /* @__PURE__ */ a(
    ht.SubContent,
    {
...
function Jc(t, e, r, o, n) {
  const i = B(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const w = e[d - 1], g = Math.max(Ft(w), 1);
        o({
          book: w,
          chapterNum: g,
          verseNum: 1
  ...
  if (t)
    return /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        children: Array.from({ length: Ft(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
          ve,
          {
            value: `${t} ${Ee[t] || ""} ${s}`,
            onSelect: () => r(s),
...
function Lu({
  ...
  const d = lt(), [w, g] = D(!1), [h, p] = D(""), [m, x] = D(""), [v, N] = D("books"), [y, _] = D(void 0), [k, P] = D(!1), $ = X(void 0), A = X(void 0), C = X(void 0), z = X(void 0), E = X({}), [O, V] = D(!1);
  Dt(() => {
  ...
  const G = B(
    ...
    [J.OT]: R.filter((M) => dt.isBookOT(M)),
    [J.NT]: R.filter((M) => dt.isBookNT(M)),
    [J.DC]: R.filter((M) => dt.isBookDC(M)),
    [J.Extra]: R.filter((M) => dt.extraBooks().includes(M))
  }), [R]), T = L(() => Object.values(H).flat(), [H]), K = L(() => {
    if (!m.trim()) return H;
    const b = {
      [J.OT]: [],
      [J.NT]: [],
    ...
    return [J.OT, J.NT, J.DC, J.Extra].forEach((j) => {
      b[j] = H[j].filter((W) => Da(W, m, n));
    }), b;
  }, [H, m, n]), F = L(
    () => Xc(m, T, n),
    [m, T, n]
    ...
    F && (G({
      book: F.book,
      chapterNum: F.chapterNum ?? 1,
      verseNum: F.verseNum ?? 1
    }), g(!1), x(""), p(""));
  }, [G, F]), Rt = B(
    (b) => {
      if (Ft(b) <= 1) {
    ...
    (b) => {
      const M = v === "chapters" ? y : F == null ? void 0 : F.book;
      M && (G({
        book: M,
        chapterNum: b,
        verseNum: 1
    ...
    e,
    i
  ), st = (i == null ? void 0 : i["%bookChapterControl_backToBooks%"]) ?? "Back to books", rt = B(() => {
    ...
    [v, rt]
  ), { otLong: Tt, ntLong: Zt, dcLong: mt, extraLong: Qt } = {
    ...
    if (F) {
      if (!h.includes(":")) {
        const b = h.match(/(\d+)$/);
        if (b) {
          const M = parseInt(b[1], 10), j = Ft(F.book);
          if (M >= 1 && (j <= 0 || M <= j)) return M;
        }
      }
      return F.chapterNum ?? 1;
    }
  }, [h, F]), te = L(
    () => Ce(
      t,
    ...
    var Q, Z;
    (Q = A.current) == null || Q.focus();
    const M = (Z = A.current) == null ? void 0 : Z.querySelectorAll(
      '[cmdk-item]:not([data-disabled="true"])'
    );
    if (!M || M.length === 0) return;
    const j = b === "first" ? M[0] : M[M.length - 1], W = j.getAttribute("data-value");
    W && p(W), setTimeout(() => {
    ...
    (b) => {
      ...
      (b.key === "ArrowUp" || b.key === "ArrowDown") && (b.preventDefault(), b.stopPropagation(), $t(b.key === "ArrowDown" ? "first" : "last"));
    },
    [$t]
  ), Pt = B(
    (b) => {
      var W, Q;
      if (b.ctrlKey) return;
      const { isLetter: M, isDigit: j } = Je(b.key);
      if (v === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), rt();
        return;
      }
      if (O && (M || j)) {
        b.preventDefault(), b.stopPropagation(), At(b.key);
        return;
      }
      if (O && v === "books" && b.key === "Backspace") {
        b.preventDefault(), V(!1), x((Z) => Z.slice(0, -1)), (W = $.current) == null || W.focus();
        return;
      }
      if (O && b.key === " ") {
        b.preventDefault();
        const Z = (Q = A.current) == null ? void 0 : Q.querySelector(
          '[cmdk-item][data-selected="true"]'
        );
        Z == null || Z.click();
        return;
      }
      if ((v === "chapters" || v === "books" && F) && Fc(b.key) && document.activeElement === A.current) {
        const Z = v === "chapters" ? y : F == null ? void 0 : F.book;
        if (!Z) return;
        const ct = (() => {
        ...
        S !== ct && (b.preventDefault(), b.stopPropagation(), p(tr(Z, n, S)), setTimeout(() => {
    ...
    (b) => {
      ...
      if (b.key === "Tab") {
        b.preventDefault(), b.stopPropagation(), y && p(tr(y, n, 1)), (Q = A.current) == null || Q.focus(), setTimeout(() => {
          var Z;
    ...
    (b) => {
      ...
      if (b.key === "ArrowUp" || b.key === "ArrowDown") {
        b.preventDefault(), b.stopPropagation(), P(!1), $t(b.key === "ArrowDown" ? "first" : "last");
        return;
      }
      const { isLetter: M, isDigit: j } = Je(b.key);
      (M || j) && (b.preventDefault(), x((W) => W + b.key), $.current.focus(), P(!1));
    },
    [$t]
  );
  return Dt(() => {
    const b = setTimeout(() => {
      if (w && v === "books" && A.current && C.current) {
        const M = A.current, j = C.current, W = j.offsetTop, Q = M.clientHeight, Z = j.clientHeight, ct = W - Q / 2 + Z / 2;
        M.scrollTo({
          top: Math.max(0, ct),
          behavior: "smooth"
        }), p(tr(t.book));
    ...
    v !== "chapters" || !y || (p(tr(y, n)), setTimeout(() => {
      A.current && A.current.scrollTo({ top: 0 }), z.current && z.current.focus();
    }, 0));
            ...
            children: [
              v === "books" ? /* @__PURE__ */ u("div", { className: f("tw:flex tw:items-end", k && "tw:pb-1"), children: [
                /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    onKeyDown: (b) => {
                      var W;
                      if (b.target === $.current && (b.key === "ArrowUp" || b.key === "ArrowDown")) {
                        b.preventDefault(), b.stopPropagation(), $t(b.key === "ArrowDown" ? "first" : "last");
                        return;
                      }
                      if (b.target === $.current || b.key === "Tab" || b.key === "Escape") return;
                      const { isLetter: M, isDigit: j } = Je(b.key);
                      (M || j) && (b.preventDefault(), b.stopPropagation(), x((Q) => Q + b.key), (W = $.current) == null || W.focus());
                    },
                    children: [
                      /* @__PURE__ */ a(
                        wr,
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:translate-y-px tw:items-center tw:pe-2", children: /* @__PURE__ */ a(_t, { children: q.map(({ onClick: b, disabled: M, title: j, icon: W }, Q) => /* @__PURE__ */ u(_a, { children: [
              ...
              !k && /* @__PURE__ */ u(
                Re,
                {
                  ...
                  tabIndex: 0,
                  onFocus: (b) => {
                    b.target === b.currentTarget && V(!0);
                  },
                  onBlur: (b) => {
                    b.target === b.currentTarget && V(!1);
                  },
                  ...
                  children: [
                    v === "books" && /* @__PURE__ */ u(nt, { children: [
                      !F && Object.entries(K).map(([b, M]) => {
                        if (M.length !== 0)
                          return (
                            // We are mapping over filteredBooksByType, which uses Section as key type
                            // eslint-disable-next-line no-type-assertion/no-type-assertion
                            /* @__PURE__ */ a(he, { heading: we(b), children: M.map((j) => /* @__PURE__ */ a(
                              pn,
                              {
                                bookId: j,
                                onSelect: (W) => Rt(W),
                      ...
                      F && /* @__PURE__ */ u(
                        ve,
                        {
                          value: `${F.book} ${Ee[F.book]} ${F.chapterNum ?? 1}:${F.verseNum ?? 1}`,
                          onSelect: zt,
                          className: f(
                            ...
                            /* @__PURE__ */ a("span", { className: "tw:flex-1", children: Ce(
                              {
                                book: F.book,
                                chapterNum: Mt ?? 1,
                                verseNum: Mt === F.chapterNum ? F.verseNum ?? 1 : 1
                              },
                              Le(F.book, n)
                            ) }),
                            /* @__PURE__ */ a("span", { className: "tw:font-normal tw:text-muted-foreground", children: Ta(F.book, n) })
                          ]
                        },
                        "top-match"
                      ),
                      F && Ft(F.book) > 1 && /* @__PURE__ */ a(
                        no,
                        {
                          bookId: F.book,
                          scrRef: t,
...
function pa({
  ...
  const [_, k] = D(!1), P = d ?? l, $ = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = l(C), O = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, V = `${z ?? ""}${E}${O ?? ""}`;
    return /* @__PURE__ */ u(
      ve,
      {
        value: E,
    ...
    /* @__PURE__ */ a(
      xe,
      {
        ...
        children: /* @__PURE__ */ u(De, { children: [
          ...
          /* @__PURE__ */ a(Re, { children: $(e) ? e.map((C) => /* @__PURE__ */ a(he, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map((C) => A(C)) }) })
        ] })
      }
    )
  ] });
...
function ju({
  ...
  const w = Gr(d, "%webView_bookSelector_currentBook%"), g = Gr(d, "%webView_bookSelector_choose%"), h = Gr(d, "%webView_bookSelector_chooseBooks%"), [p, m] = D(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
    ...
    fn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(gt, { className: "tw:flex tw:items-center", children: o.map((v) => dt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            U,
            {
...
const vn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, el = vn ? Dt : Y, mr = { tag: Na };
      ...
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            ...
            (St() !== null || x !== null && x === g.getRootElement()) && m.select();
          }
        }, mr);
...
const al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Dt : Y;
...
const ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Dt : Y;
function dl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function wl() {
  return function(t) {
    const [e] = Xt(), r = L(() => t(e), [e, t]), [o, n] = D(() => r.initialValueFn()), i = X(o);
    return ll(() => {
...
function pl(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !ms(e) && o !== null) {
    ...
    if (d || w) {
      const [g, h] = vs(t), p = s.is(l), m = e.is(c ? l : s), x = e.is(c ? s : l);
      let v, N = 0;
      p ? (N = g > h ? h : g, v = g > h ? g : h) : m ? (N = c ? h : g, v = void 0) : x && (N = 0, v = c ? g : h);
...
function fl(t, e, r) {
  ...
  function l() {
    ...
    var m, x;
    s.isConnected || (x = s, (m = n).insertBefore(x, m.firstChild));
    let v = !1;
    for (let N = 0; N < p.length; N++) {
      ...
      const $ = Kt(y.top - h);
      k.top !== $ && (_.style.top = $, v = !0);
      const A = Kt(y.width);
      k.width !== A && (_.style.width = A, v = !0);
      const C = Kt(y.height);
      k.height !== C && (_.style.height = C, v = !0), _.parentNode !== s && (s.append(_), v = !0), c[N] = _;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (x !== o || v !== n) return g();
      for (const N of m) if (!s.contains(N.target)) return l();
    }), i.observe(p, hl), l();
  });
  return () => {
    w(), d();
...
function vl(t, e = ml) {
  ...
  function d(w) {
    w.read(() => {
      const g = St();
      if (!Gt(g)) return r = null, n = null, i = null, s = null, l(), void (l = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), x = m.getKey(), v = h.offset, N = p.getNode(), y = N.getKey(), _ = p.offset, k = t.getElementByKey(x), P = t.getElementByKey(y), $ = r === null || k !== o || v !== n || x !== r.getKey(), A = i === null || P !== c || _ !== s || y !== i.getKey();
      if (($ || A) && k !== null && P !== null) {
        const C = function(z, E, O, V, G, R, H) {
          const T = (z._window ? z._window.document : document).createRange();
          return T.setStart(...io(E, O, V)), T.setEnd(...io(G, R, H)), T;
        }(t, h, m, k, p, N, P);
        l(), l = fl(t, C, e);
      }
      r = m, o = k, n = v, i = N, c = P, s = _;
    });
  }
...
function kl(t, e, r) {
  ...
  return Ss(o) && Tr(283), o.insert(t.isInline() ? He().append(t) : t), Qa(Uo(t.getLatest(), "next"), e.direction);
}
function _l(t) {
  const e = St();
  if (!Gt(e)) return !1;
...
let Sr, oe = 0, Dr = 0, El = 0, ha = 0, kr = 0;
function co(t) {
  if (tt === void 0) return;
  let e = t.n;
...
It({ build: (t, e, r) => Ye(e), config: Se({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
It({ build: (t, e, r) => Ye(e), config: Se({ $onClear: _n }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ht(() => Nn(t, o.value));
} });
function Sl(t) {
...
It({ name: "@lexical/extension/DecoratorText", nodes: () => [Cn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = St();
  if (Wo(n) || Gt(n)) for (const i of n.getNodes()) Dl(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function En(t, e) {
  let r;
...
const fa = It({ build: (t) => En(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
class $l {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (c = this.extension.init(e, i.config, o)), this.state = function(s, l, d) {
      return Object.assign(s, { id: vr, initResult: l, registerState: d });
    }(i, c, n);
  }
  build(e) {
    const r = this.state;
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== Ze && at(309, String(o.id), String(Ze)), this.state = function(c) {
...
const Ol = It({ config: Se({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = Al }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Ve {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && at(298, o.name), !n) {
      ...
      for (const c of o.conflictsWith || []) this.extensionNameMap.has(c) && at(299, o.name, c), this.conflicts.set(c, o.name);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var s;
      Jr(i) || at(300, c, n || "[unknown]"), Jr(s = i) || at(304, String(s.id), String(Oa)), i = Object.assign(s, { id: ma }), o.state = i;
...
const Pl = /* @__PURE__ */ new Set(), go = It({ build(t, e, r) {
...
It({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ie(t.registerCommand(Ll, (c) => {
    ...
    Cl(() => {
      ...
      for (const [w, g] of c.entries()) if (g === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = p : (l = !0, d.set(w, { domNode: nr(p), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Ht(() => {
    const c = [];
    for (const { domNode: s, selectedSignal: l } of n.value.nodeSelections.values()) c.push(Ht(() => {
      const d = s.value;
...
It({ build: (t, e) => Ye({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Se({ $getParentEditor: function() {
  const t = Us();
...
It({ build: (t, e, r) => Ye(e), config: Se({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ht(() => {
...
function jl(t, e, r = Dn) {
  return ie(t.registerCommand(Xs, (o) => {
    ...
    o.preventDefault();
    const i = function(c) {
      if (c.getNodes().filter((h) => Cr(h) && h.canIndent()).length > 0) return !0;
...
It({ build: (t, e, r) => Ye(e), config: Se({ $canIndent: Dn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Ht(() => {
    if (!o.value) return jl(t, n, i);
  });
} });
const Bl = It({ name: "@lexical/react/ReactProvider" });
function Ul() {
...
It({ build: (t, e, r) => Ye(e), config: Se({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ht(() => r.getOutput().disabled.value ? void 0 : Mn(t)) });
function Gl(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Pa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Dt : Y;
function Hl({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, i] = D(() => r.getDecorators());
...
function Yl({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Pa(() => ie(lc(n), Mn(n)), [n]);
  }(o), u(nt, { children: [t, a(Xl, { content: e }), a(Wl, { editor: o, ErrorBoundary: r })] });
}
...
function ad(t, e) {
  ...
  return u(nt, { children: [a(ed, { editor: n, ...o, ref: e }), r != null && a(od, { editor: n, content: r })] });
}
...
function cd({
  ...
  const [e] = Xt(), [r, o] = D(e), [n, i] = D("paragraph"), [c, s] = sd(), l = () => {
  };
...
function wd() {
  const { activeEditor: t } = On(), [e, r] = D([]), o = B((n) => {
    if (Gt(n) || uc(n)) {
      const i = [];
      mo.forEach(({ format: c }) => {
...
function Fn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  if (d !== null) {
    ...
    if (s = Array.isArray(m) ? m[m.length - 1] : m, s !== null) {
      ...
      s && c.push(...Array.isArray(m) ? m : [s]);
    }
    d.forChild != null && n.set(t.nodeName, d.forChild);
  }
  const g = t.childNodes;
  let h = [];
  const p = (s == null || !nc(s)) && (s != null && Cr(s) || o);
  for (let m = 0; m < g.length; m++) h.push(...Fn(g[m], e, r, p, new Map(n), s));
  return w != null && (h = w(h)), ao(t) && (h = md(t, h, p ? () => {
    const m = new Zo();
    return r.push(m), m;
  } : He)), s == null ? h.length > 0 ? c = c.concat(h) : ao(t) && function(m) {
...
function md(t, e, r) {
  ...
  for (let c = 0; c < e.length; c++) {
    const s = e[c];
    if (Cr(s)) o && !s.getFormat() && s.setFormat(o), n.push(s);
    else if (i.push(s), c === e.length - 1 || c < e.length - 1 && Cr(e[c + 1])) {
      const l = r();
...
function Uu({
  ...
  const [i, c] = D(xd), [s, l] = D(n), [d, w] = D(!1), g = X(void 0), h = X(null);
  Y(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
  ...
  const p = B(() => {
    ...
    const v = Mr(i);
    e(v, s);
  }, [i, e, s]), m = o["%commentEditor_placeholder%"] ?? "Type your comment here...", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
...
const Ku = Object.freeze([
  ...
  const n = X(null), [i, c] = D(void 0), [s, l] = D(void 0), d = B(
    (p) => {
      c(p);
    ...
    if (p.isContentEditable || yd.includes(m)) return !0;
    ...
    (p) => {
      var A;
      const m = p.target, x = (C) => C ? document.getElementById(C) : void 0, v = x(s), N = x(i);
      if (!!(v && m && v.contains(m) && m !== v) && g(m)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !m.isContentEditable) {
          if (s) {
            p.preventDefault(), p.stopPropagation();
            const C = t.find((z) => z.id === s);
            C && d(C.id);
          }
          return;
        }
...
function bo({
  ...
  const p = B(
    ...
    [t.user]
  ), y = L(() => Ti(t.contents), [t.contents]), _ = L(() => {
    if (o && s)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          zr,
    ...
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ u(se, { children: [
          /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Fi, {}) }) }),
...
function Sd({
  ...
  const [C, z] = D(xo), [E, O] = D(), [V, G] = D(), R = o, [H, T] = D(!1), [K, F] = D(!1), [zt, Rt] = D(!1), [wt, Jt] = D(!1), [q, st] = D(!1), [rt, ut] = D(k), [Tt, Zt] = D(!1), mt = X(void 0), [Qt, we] = D(/* @__PURE__ */ new Map());
  Y(() => {
    let S = !0;
    return (async () => {
  ...
  Y(() => {
    ...
    bt.current === "idle" && (bt.current = "pending"), wt ? bt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== i && (O(A), bt.current = "auto-populated") : bt.current === "auto-populated" && (O(void 0), bt.current = "pending");
  }, [o, A, wt, i]);
  const Mt = L(() => e.filter((S) => !S.deleted), [e]);
  Y(() => {
    let S = !0;
    if (!o || !_) {
      we(/* @__PURE__ */ new Map());
  ...
  const te = L(() => Mt[0], [Mt]), Ae = X(null), $t = X(void 0), At = B(() => {
    var S;
    (S = $t.current) == null || S.call($t), z(xo);
  }, []), Xe = B(() => {
    const S = !rt;
    ut(S), Zt(!S), m == null || m(l, S);
  }, [rt, m, l]);
  Y(() => {
    T(!1);
  }, [o]), Y(() => {
  ...
  }, [i, r]), I = L(() => Mt.slice(1), [Mt]), b = L(() => I.length ?? 0, [I.length]), M = L(() => b > 0, [b]), j = L(() => H || b <= 2 ? I : I.slice(-2), [I, b, H]), W = L(() => H || b <= 2 ? 0 : b - 2, [b, H]), Q = L(
    () => b === 1 ? Pt.singleReply : ee(Pt.multipleReplies, { count: b }),
    [b, Pt]
  ), Z = L(
    () => W === 1 ? Pt.singleReply : ee(Pt.multipleReplies, { count: W }),
    [W, Pt]
  );
  Y(() => {
    !o && K && M && F(!1);
  ...
  const ct = B(
    async (S) => {
      ...
      it && await g({ threadId: l, contents: it }) && At();
    },
    [
      At,
      C,
    ...
    async (S) => {
      const it = Ot(C) ? Mr(C) : void 0, pt = S.status ? S.assignedUser : E ?? S.assignedUser, Lt = await g({
        ...S,
        contents: it,
        assignedUser: pt
      });
      return Lt && (pt !== void 0 && G(pt), it && At()), Lt;
    },
    [At, C, g, E]
  );
  if (Mt.length !== 0)
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                U,
                {
                  ...
                  children: rt ? /* @__PURE__ */ a(ji, {}) : /* @__PURE__ */ a(Bi, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              bo,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: F,
                canEditOrDelete: (!K && Qt.get(te.id)) ?? !1,
                canUserResolveThread: q
              }
            )
          ] }),
          /* @__PURE__ */ u(nt, { children: [
            M && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            o && /* @__PURE__ */ u(nt, { children: [
              W > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (S) => {
                    (S.key === "Enter" || S.key === " ") && (S.preventDefault(), S.stopPropagation(), T(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(je, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Z }),
                      H ? /* @__PURE__ */ a(Mo, {}) : /* @__PURE__ */ a(cr, {})
                    ] })
                  ]
                }
              ),
              j.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                bo,
                {
                  comment: S,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: p,
                  onEditingChange: F,
                  canEditOrDelete: (!K && Qt.get(S.id)) ?? !1
                }
              ) }, S.id)),
              v !== !1 && (!K || Ot(C)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (S) => {
                    Fa(S) && (S.preventDefault(), S.stopPropagation(), (Ot(C) || E !== void 0 && E !== V) && ct());
                  },
                  onKeyDown: (S) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Ot(C) || E !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ee(
                      ...
                      /* @__PURE__ */ u(be, { open: zt, onOpenChange: Rt, children: [
                        /* @__PURE__ */ a(Me, { asChild: !0, children: /* @__PURE__ */ a(
                          U,
                          {
                            ...
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !wt || !x || x.length === 0 || !x.includes(c),
                        ...
                        /* @__PURE__ */ a(
                          xe,
                          {
                            ...
                            children: /* @__PURE__ */ a(De, { children: /* @__PURE__ */ a(Re, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                              ve,
                              {
                                onSelect: () => {
                                  O(S !== i ? S : void 0), bt.current = "user-selected", G(void 0), Rt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Nr(S, r) })
                              },
                              S || "unassigned"
                            )) }) })
                          }
...
function Ju({
  ...
  const [N, y] = D(/* @__PURE__ */ new Set()), [_, k] = D(), [P, $] = D(), A = B(
    async (T) => {
      const K = await i(T);
      return K !== void 0 && T.assignedUser !== void 0 && T.assignedUser !== "" && $(T.assignedUser), K;
    },
    [i]
  );
  Y(() => {
    m && (y((T) => new Set(T).add(m)), k(m));
  }, [m]);
  const C = r.filter(
    (T) => T.comments.some((K) => !K.deleted)
  ), z = C.map((T) => ({ id: T.id })), E = B(
    (T) => {
      y((K) => new Set(K).add(T.id)), k(T.id), x == null || x(T.id);
    },
    [x]
  ), O = B(
    (T) => {
      ...
      y((F) => {
        const zt = new Set(F);
        return zt.has(T) ? zt.delete(T) : zt.add(T), zt;
      }), k(T), x == null || x(K ? void 0 : T);
    },
    [N, x]
  ), { listboxRef: V, activeId: G, handleKeyDown: R } = _d({
    options: z,
    onOptionSelect: E
  }), H = B(
    (T) => {
      T.key === "Escape" ? (_ && N.has(_) && (y((K) => {
        const F = new Set(K);
        return F.delete(_), F;
      }), k(void 0), x == null || x(void 0)), T.preventDefault(), T.stopPropagation()) : R(T);
    },
    [_, N, R, x]
  );
  return /* @__PURE__ */ a(
...
function Dd({ table: t }) {
  return /* @__PURE__ */ u(se, { children: [
    /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        Ue,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(Ge, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Vt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  ot.useEffect(() => {
    ...
    const s = () => {
      requestAnimationFrame(() => {
        ir(c, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
    ...
    const r = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const n = t.current ? ir(t.current) : [], i = n.indexOf(document.activeElement), c = o.key === "ArrowRight" ? i + 1 : i - 1;
...
function Vd({
  ...
  var $;
  const [w, g] = D([]), [h, p] = D([]), [m, x] = D({}), [v, N] = D({}), y = L(() => e ?? [], [e]), _ = en({
    data: y,
    columns: t,
    getCoreRowModel: an(),
  ...
  let P;
  return l ? P = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ge, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(va, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : (($ = _.getRowModel().rows) == null ? void 0 : $.length) > 0 ? P = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    re,
    {
      onClick: () => c(A, _),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((C) => /* @__PURE__ */ a(ge, { children: rr(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    A.id
  )) : P = /* @__PURE__ */ a(re, { children: /* @__PURE__ */ a(ge, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: s, children: [
    n && /* @__PURE__ */ a(Dd, { table: _ }),
    /* @__PURE__ */ u(Vr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ja, { stickyHeader: i, children: _.getHeaderGroups().map((A) => /* @__PURE__ */ a(re, { children: A.headers.map((C) => /* @__PURE__ */ a($r, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : rr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
      /* @__PURE__ */ a(Fr, { children: P })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(U, { variant: "secondary", size: "icon", className: "size-8", onClick: () => c(), children: /* @__PURE__ */ a(Oo, {}) })
        ] }),
...
function np({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(se, { children: [
    /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(le, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: d.itemType === 0 ? /* @__PURE__ */ a(nt, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        Bc,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Uc, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(pr, {})
    ] }, d.label)) })
...
function Ud({ id: t, versionHistory: e }) {
  const [r, o] = D(!1), n = /* @__PURE__ */ new Date();
  function i(s) {
...
function Gn({
  ...
  const [N, y] = D(!1), _ = B(
    ...
    const E = t.filter((V) => V.starred).sort((V, G) => V.label.localeCompare(G.label)), O = t.filter((V) => !V.starred).sort((V, G) => {
      const R = e.includes(V.value), H = e.includes(G.value);
      return R && !H ? -1 : !R && H ? 1 : V.label.localeCompare(G.label);
    });
    return [...E, ...O];
  }, [t, e, h]), $ = () => {
    r(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(be, { open: C, onOpenChange: w ?? y, children: [
    ...
    /* @__PURE__ */ a(xe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(De, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: $, children: i }),
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: A, children: c })
      ] }),
      /* @__PURE__ */ u(Re, { children: [
        /* @__PURE__ */ a(Pr, { children: s }),
        /* @__PURE__ */ a(he, { children: P.map((E) => /* @__PURE__ */ u(
          ve,
          {
            value: E.label,
            onSelect: _,
...
function qd({
  ...
  const l = L(() => /Macintosh/i.test(navigator.userAgent), []), d = No(n, "%undoButton_tooltip%"), w = No(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Va, { children: [
    /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
        U,
...
const Hd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(nt, { children: [
...
function Wd({
  ...
  const i = X(null), c = X(null), s = X(!1), [l, d] = D(t), [w, g] = D(r), [h, p] = D(!1);
  Y(() => {
    d(t);
  }, [t]), Y(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    s.current = !1, p(v), v || (l !== "custom" || w ? (e(l), o(w)) : (d(t), g(r)));
  }, x = (v) => {
    var N, y, _, k;
    v.stopPropagation(), document.activeElement === c.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), s.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = c.current) == null || y.focus(), s.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = c.current) == null || k.focus(), s.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === c.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(se, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: Hd(t, n, r) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            pe,
            {
              ...
              onClick: (v) => {
                var N;
                v.stopPropagation(), s.current = !0, (N = i.current) == null || N.focus();
              },
...
const Yd = (t, e) => t === "f" ? /* @__PURE__ */ u(nt, { children: [
  /* @__PURE__ */ a(Lo, {}),
  " ",
...
function Jd({
  ...
  return /* @__PURE__ */ u(se, { children: [
    /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: Yd(t, r) }) }) }),
...
function ew(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, c]) => {
    i.push(
      ...c.map((s) => ({
        marker: s,
        title: r[yr[s].description] ?? yr[s].description,
        action: () => {
          var l;
...
function lp({
  ...
  const w = X(null), g = X(null), h = X(null), p = X(null);
  Dt(() => {
    if (!p.current) return;
    const { width: I } = p.current.getBoundingClientRect();
    I > 0 && (p.current.style.width = `${I}px`);
  }, []);
  const [m, x] = D("generated"), [v, N] = D("generated"), [y, _] = D("*"), [k, P] = D("*"), [$, A] = D("f"), [C, z] = D(!1), [E, O] = D(!0), [V, G] = D(!1), R = X(!1), H = X(""), [T, K] = D(!1), [F, zt] = D(), [Rt, wt] = D(), [Jt, q] = D(), [st, rt] = D(), ut = X(null), Tt = L(
    () => ({
      ...c,
      markerMenuTrigger: s,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (b && fr("note", b)) {
      const W = (M = b.insert.note) == null ? void 0 : M.caller;
      let Q = "custom";
      W === la ? Q = "generated" : W === da ? Q = "hidden" : W && (_(W), P(W)), x(Q), N(Q), A(((j = b.insert.note) == null ? void 0 : j.style) ?? "f"), I = setTimeout(() => {
        var Z;
  ...
  const mt = B(
    (I, b, M = !1) => {
      var W, Q, Z;
      const j = (Q = (W = w.current) == null ? void 0 : W.getNoteOps(0)) == null ? void 0 : Q.at(0);
      if (j && fr("note", j)) {
        if (j.insert.note) {
          let ct;
          I === "custom" ? ct = b : I === "generated" ? ct = la : ct = da, j.insert.note.caller = ct;
        }
        r == null || r([j]), M && d && i && ((Z = d.current) == null || Z.replaceEmbedUpdate(i, [j]));
      }
    },
    [i, r, d]
  ), Qt = B(() => {
  ...
  const bt = X({ book: n.book, chapterNum: n.chapterNum });
  Dt(() => {
  ...
  const Mt = () => {
    ...
    var M, j, W, Q, Z;
    A(I);
    const b = (j = (M = w.current) == null ? void 0 : M.getNoteOps(0)) == null ? void 0 : j.at(0);
    if (b && fr("note", b)) {
      b.insert.note && (b.insert.note.style = I);
      const ct = (Q = (W = b.insert.note) == null ? void 0 : W.contents) == null ? void 0 : Q.ops;
      $ !== "x" && I === "x" ? ct == null || ct.forEach((vt) => rw(vt)) : $ === "x" && I !== "x" && (ct == null || ct.forEach((vt) => aw(vt))), (Z = w.current) == null || Z.applyUpdate([b, { delete: 1 }]);
    }
  }, At = (I) => {
    rt(I.contextMarker), G(I.canRedo);
  }, Xe = B(
    (I) => {
      var M, j, W, Q, Z;
      const b = (j = (M = w.current) == null ? void 0 : M.getNoteOps(0)) == null ? void 0 : j.at(0);
      if (b && fr("note", b)) {
        ...
        const ct = (W = b.insert.note) == null ? void 0 : W.style, vt = (Z = (Q = b.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : Z.ops;
        if (ct || z(!1), z(
          ct === "x" ? !!(vt != null && vt.every((S) => {
            var pt, Lt;
            if (!((pt = S.attributes) != null && pt.char)) return !0;
            const it = ((Lt = S.attributes) == null ? void 0 : Lt.char).style;
          ...
          R.current = !0, H.current = JSON.stringify(b), O(!0);
          return;
        }
        O(JSON.stringify(b) === H.current), mt(m, y);
      } else
        z(!1), O(!0);
    },
    [m, y, mt]
    ...
    if (h.current && Zt.length && I && I.rangeCount > 0) {
      const b = I.getRangeAt(0).getBoundingClientRect(), M = h.current.getBoundingClientRect();
      zt(b.left - M.left), wt(b.top - M.top), q(b.height), K(!0);
    }
  }, [Zt, h]);
  Y(() => {
    const I = () => {
    ...
    var I;
    T && ((I = ut.current) == null || I.focus());
  }, [T]), Y(() => {
    var M;
    const I = ((M = g.current) == null ? void 0 : M.querySelector(".editor-input")) ?? void 0, b = (j) => {
      !T && I && document.activeElement === I && j.key === s ? (j.preventDefault(), Pt()) : T && j.key === "Escape" && (j.preventDefault(), K(!1));
    };
  ...
  return /* @__PURE__ */ u(nt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: s && s.length > 0 && /* @__PURE__ */ a(nt, { children: nw(t.marker, s, o, d) })
      }
    )
  ] });
}
function wp({
  ...
  const w = l ?? Mi(r, void 0), g = (y, _) => {
    d == null || d(y, _, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [p, m] = D(h), x = (y, _, k) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function lw({
  ...
  const n = r["%webView_inventory_occurrences_table_header_reference%"], i = r["%webView_inventory_occurrences_table_header_occurrence%"], c = L(() => {
  ...
  return /* @__PURE__ */ u(Vr, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Fr, { children: c.length > 0 && c.map((s) => /* @__PURE__ */ u(
      re,
      {
        onClick: () => {
          e(s.reference);
...
function bp({
  ...
  const p = Bt(r, "%webView_inventory_all%"), m = Bt(r, "%webView_inventory_approved%"), x = Bt(r, "%webView_inventory_unapproved%"), v = Bt(r, "%webView_inventory_unknown%"), N = Bt(r, "%webView_inventory_scope_currentBook%"), y = Bt(r, "%webView_inventory_scope_chapter%"), _ = Bt(r, "%webView_inventory_scope_verse%"), k = Bt(r, "%webView_inventory_filter_text%"), P = Bt(
    r,
    "%webView_inventory_show_additional_items%"
  ), $ = Bt(r, "%webView_inventory_no_results%"), [A, C] = D(!1), [z, E] = D("all"), [O, V] = D(""), [G, R] = D([]), H = L(() => {
    const q = t ?? [];
    return q.length === 0 ? [] : gw(q, n, i);
  }, [t, n, i]), T = L(() => {
    if (A) return H;
    const q = [];
    return H.forEach((st) => {
      const rt = st.items[0], ut = q.find(
        (Tt) => Tt.items[0] === rt
      );
      ut ? (ut.count += st.count, ut.occurrences = ut.occurrences.concat(st.occurrences)) : q.push({
        items: [rt],
        count: st.count,
  ...
  }, [A, H]), K = L(() => T.length === 0 ? [] : pw(T, z, O), [T, z, O]), F = L(() => {
    var rt, ut;
    if (!A) return l;
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        Ue,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(Ge, { children: [
              /* @__PURE__ */ a(Vt, { value: "all", children: p }),
              /* @__PURE__ */ a(Vt, { value: "approved", children: m }),
              /* @__PURE__ */ a(Vt, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(Vt, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(Ue, { onValueChange: (q) => Rt(q), defaultValue: c, children: [
        /* @__PURE__ */ a(qe, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Ke, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Ge, { children: [
          /* @__PURE__ */ a(Vt, { value: "book", children: N }),
          /* @__PURE__ */ a(Vt, { value: "chapter", children: y }),
          /* @__PURE__ */ a(Vt, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        dr,
      ...
      o && /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
        /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(gt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? P })
        ] }) }),
...
const Yn = lr(({ className: t, ...e }, r) => /* @__PURE__ */ a(cs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Yn.displayName = "Spinner";
function hw(t, e = 50) {
  const [r, o] = D(e), n = X(null);
  return Y(() => {
    o(e);
  }, [t, e]), Y(() => {
...
function yp({
  ...
  const [c, s] = D(""), [l, d] = D([]), w = L(
    () => t.filter((R) => !r || R.type === r).filter((R) => fw(R, c)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = hw(p), N = L(
    () => Array.from(new Set(t.map((R) => R.bestLanguageName))).map((R) => ({
      label: R,
      value: R
    })),
    [t]
  ), y = g.length === 0 && h.length === 0 && p.length === 0, _ = Ut(n, "%resourcePicker_title%"), k = Ut(n, "%resourcePicker_search_placeholder%"), P = Ut(n, "%resourcePicker_language_filter_any%"), $ = Ut(
    n,
    "%resourcePicker_section_already_selected%"
  ), A = Ut(n, "%resourcePicker_section_installed%"), C = Ut(
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = Ut(n, "%resourcePicker_button_use%"), E = Ut(n, "%resourcePicker_no_results%"), O = Ut(n, "%resourcePicker_showing_count%"), V = L(() => {
    if (l.length === N.length || l.length === 0)
      return P;
    if (l.length === 1) {
      const R = N.find((H) => H.value === l[0]);
      if (R) return R.label;
    }
    return ee(
  ...
  }, [l, N, P, n]), G = c.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(nt, { children: [
...
const mw = "16rem", vw = "3rem", Xn = ot.createContext(void 0);
function Ur() {
...
function bw({
  ...
  const [l, d] = ot.useState(t), w = e ?? l, g = ot.useCallback(
    (_) => {
      const k = typeof _ == "function" ? _(w) : _;
      r ? r(k) : d(k);
    },
    [r, w]
  ), h = ot.useCallback(() => g((_) => !_), [g]), p = w ? "expanded" : "collapsed", v = lt() === "ltr" ? c : c === "primary" ? "secondary" : "primary", N = ot.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
...
function Ew({
  ...
  const s = t ? fe.Root : "button", { state: l } = Ur(), d = /* @__PURE__ */ a(
    s,
    {
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ue ? Ce(n.start) : void 0;
      },
...
function Ip({
  ...
  const [d, w] = D([]), [g, h] = D([{ id: ue, desc: !1 }]), [p, m] = D({}), x = L(
    ...
    !e && /* @__PURE__ */ u(
      Ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ge, { position: "item-aligned", children: /* @__PURE__ */ a(Rd, { children: k.map((z) => /* @__PURE__ */ a(Vt, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
      ...
      /* @__PURE__ */ a(Fr, { children: N.getRowModel().rows.map((z, E) => {
        ...
        return /* @__PURE__ */ a(
          re,
          {
            ...
            className: f(A(z, E)),
            onClick: (V) => $(z, V),
            children: z.getVisibleCells().map((V) => {
                  ...
                  ge,
                  {
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        type: "button",
                        children: [
                          z.getIsExpanded() && /* @__PURE__ */ a(cr, {}),
                          !z.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ a(ds, {}) : /* @__PURE__ */ a(ws, {})),
                          " ",
                          rr(V.column.columnDef.cell, V.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function Iw({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], s = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: h, ntLong: p, dcLong: m, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = D(!1), [y, _] = D(""), k = X(void 0), P = X(!1);
  if (t.length !== dt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const $ = L(() => dt.allBookIds.filter(
    (R, H) => t[H] === "1" && !dt.isObsolete(dt.bookIdToNumber(R))
  ), [t]), A = L(() => {
    if (!y.trim()) {
      const T = {
        [J.OT]: [],
    ...
    (R, H = !1) => {
      if (!H || !k.current) {
        r(
          e.includes(R) ? e.filter((wt) => wt !== R) : [...e, R]
        ), k.current = R;
        return;
      }
      const T = $.findIndex((wt) => wt === k.current), K = $.findIndex((wt) => wt === R);
      if (T === -1 || K === -1) return;
      const [F, zt] = [
        Math.min(T, K),
        Math.max(T, K)
      ], Rt = $.slice(F, zt + 1).map((wt) => wt);
      r(
        e.includes(R) ? e.filter((wt) => !Rt.includes(wt)) : [.../* @__PURE__ */ new Set([...e, ...Rt])]
      );
    },
    [e, r, $]
  ), z = (R) => {
    C(R, P.current), P.current = !1;
  }, E = (R, H) => {
    R.preventDefault(), C(H, R.shiftKey);
  }, O = B(
    (R) => {
      const H = Ua($, R).map((T) => T);
      r(
        Zn($, R, e) ? e.filter((T) => !H.includes(T)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, $]
  ), V = () => {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(J).map((R) => /* @__PURE__ */ a(
      Ow,
      {
        section: R,
        availableBookIds: $,
            ...
            De,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: G, children: d })
                ] }),
                /* @__PURE__ */ u(Re, { children: [
                  /* @__PURE__ */ a(Pr, { children: w }),
                  Object.values(J).map((R, H) => {
                    const T = A[R];
                    if (T.length !== 0)
                      return /* @__PURE__ */ u(_a, { children: [
                        /* @__PURE__ */ a(
                          he,
                          {
                            heading: wn(R, h, p, m, x),
                            children: T.map((K) => /* @__PURE__ */ a(
                              pn,
                              {
                                bookId: K,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ra ? ra : Do
      ).map((R) => /* @__PURE__ */ a(Be, { className: "tw:hover:bg-secondary", variant: "secondary", children: Le(R, n) }, R)),
...
function Lp({
  ...
  const d = ke(
    ...
    c,
    "%webView_scope_selector_current_chapter%"
  ), h = ke(c, "%webView_scope_selector_current_book%"), p = ke(c, "%webView_scope_selector_choose_books%"), m = ke(c, "%webView_scope_selector_scope%"), x = ke(c, "%webView_scope_selector_select_books%"), v = [
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          Ge,
          {
            ...
            style: { zIndex: We },
            children: t.map((d) => /* @__PURE__ */ a(Vt, { value: `${d}`, children: s[et(d)] }, `${d}`))
          }
        )
      ]
    }
...
const ti = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in s ? /* @__PURE__ */ u(
    zr,
    {
      ...
      children: [
        s.iconPathBefore && /* @__PURE__ */ a(Ar, { icon: s.iconPathBefore, menuLabel: s.label, leading: !0 }),
        s.label,
        s.iconPathAfter && /* @__PURE__ */ a(Ar, { icon: s.iconPathAfter, menuLabel: s.label })
      ]
    },
    `dropdown-menu-item-${s.label}-${s.command}`
  ) : /* @__PURE__ */ u(Kc, { children: [
    /* @__PURE__ */ a(qc, { children: s.label }),
    /* @__PURE__ */ a(jc, { children: /* @__PURE__ */ a(Gc, { children: ti(
      t,
      e,
      Qn(t, s.id),
      o
...
function ba({
  ...
  return /* @__PURE__ */ u(se, { variant: i, children: [
    /* @__PURE__ */ a(ce, { "aria-label": r, className: n, asChild: !0, id: s, children: /* @__PURE__ */ a(U, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(us, {}) }) }),
...
ri.displayName = jt.List.displayName;
const ai = ot.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  jt.List,
  {
    ref: r,
    className: f(
...
ai.displayName = jt.List.displayName;
const Pw = ot.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  jt.Trigger,
  {
    ref: r,
    ...e,
...
oi.displayName = jt.Content.displayName;
function qp({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
function Ww({
  ...
  const n = X(void 0), i = X(void 0), c = X(void 0), s = X(void 0), l = X(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (xc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (v = s.current) == null || v.focus(), Qe(s, [h, p]);
        break;
      case "alt+h":
        (N = l.current) == null || N.focus(), Qe(l, [h, p]);
        break;
    }
  }), Y(() => {
...
function Wp({
  ...
  const d = Yw(
    ...
    return v ? `${(P = t[m]) == null ? void 0 : P.autonym} (${v})` : ($ = t[m]) == null ? void 0 : $.autonym;
  };
      ...
      Ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: We },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(Vt, { value: m, children: p(m, e) }, m))
            }
          )
        ]
      }
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(se, { children: [
              /* @__PURE__ */ a(ce, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ja, {}) }) }),
