...
import { c as b, g as $e, a as Vr, C as er, L as Un, t as ks, u as Qo, T as Vt, b as bt, d as xt, e as yt, f as Kn, A as ba, D as je, h as Te, i as Fe, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Ze, r as De, p as Ts, q as Hn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Ma, E as Eo, F as ur, G as Oa, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as Gn, S as da, U as So, V as Fr, W as Ur, X as yr, Y as Ss, Z as ir, _ as Je, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Mo, a6 as qn, a7 as Rs, a8 as Ds, a9 as Ms, aa as wo, ab as Wn, ac as Ia, ad as Os, ae as Yn, af as Is, ag as zs, ah as Ps, ai as tn, aj as As, ak as $s, al as Vs, am as Xn, an as Jn, ao as Oo, ap as Ls, aq as Zn, ar as Ka, as as en, at as Ha, au as Bs, av as js, aw as Fs, ax as Us, ay as Ks, az as Hs, aA as Gs, aB as qs, aC as Ws, aD as Io, aE as zo, aF as Ys, aG as Xs } from "./resizable-CmaQZKy4.js";
import { aH as vf, aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as jf, b3 as Ff, b4 as Uf, b5 as Kf, b6 as Hf, b7 as Gf, b8 as qf, b9 as Wf, ba as Yf, bb as Xf, bc as Jf, bd as Zf, be as Qf, bf as tm } from "./resizable-CmaQZKy4.js";
...
function Ya({
  ...
  const B = De(), U = wd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [q, $] = _(
    void 0
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dd = zi ? re : J, sa = { tag: Ao };
...
const Od = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : J;
...
const Vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : J;
function Ld(t) {
...
const lw = ge({ config: pr({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = cw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const ww = /* @__PURE__ */ new Set(), Sn = ge({ build(t, e, r) {
...
const Ew = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : J;
...
function Aw({
  ...
  const [e] = Oe(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Pw(), d = () => {
  };
        ...
        /* @__PURE__ */ u(
          We,
          {
            onClick: (z) => {
              ...
              g(k ? Fw(t.contents) : Kw), i == null || i(!0);
            },
            children: [
...
const Jw = {
  ...
  var gr;
  const [ot, I] = _({}), X = z ?? ot, q = X.editorState ?? Jw, $ = X.assignedUser, at = k !== void 0, ut = L(X);
  ut.current = X;
  const dt = V(
    (T) => {
...
const Vu = (t) => {
  ...
  return e ? e[1] : "";
}, Bu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qh = Object.freeze([
    ...
    Gu,
    {
      ...
      children: /* @__PURE__ */ u(Wu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Yu, { children: Object.entries(e).map(([g, E]) => /* @__PURE__ */ a(Xu, { children: /* @__PURE__ */ a(
            Zu,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => "command" in c ? /* @__PURE__ */ u(bt, { children: [
  /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ u(
    We,
    {
      onClick: () => {
...
] }, `tooltip-${c.label}-${c.command}`) : /* @__PURE__ */ u(Us, { children: [
  /* @__PURE__ */ u(bt, { children: [
    /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Ks, { children: c.label }) }),
    c.tooltip && /* @__PURE__ */ a(yt, { children: c.tooltip })
  ] }),
...
] }, `dropdown-menu-sub-${c.label}-${c.id}`))) : void 0;
function No({
  onSelectMenuItem: t,
  menuData: e,
  tabLabel: r,
