import { jsx as r, jsxs as l, Fragment as un } from "react/jsx-runtime";
import p, { forwardRef as De, createContext as pr, useContext as ur, useCallback as K, useState as j, useRef as J, useEffect as pt, useLayoutEffect as en, useMemo as at, Fragment as mn } from "react";
...
import { useReactTable as gn, getFilteredRowModel as Yr, getSortedRowModel as bn, getPaginationRowModel as Ur, getCoreRowModel as vn, flexRender as Gt, getGroupedRowModel as Kr, getExpandedRowModel as qr } from "@tanstack/react-table";
...
import * as _e from "@radix-ui/react-progress";
...
const Ie = F.Trigger, Nn = F.Group, na = F.Portal, ra = F.Sub, Vs = F.RadioGroup;
...
const kn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = wt();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
kn.displayName = F.SubTrigger.displayName;
...
Cn.displayName = F.SubContent.displayName;
...
const _n = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = wt();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
_n.displayName = F.RadioItem.displayName;
...
re.displayName = F.Label.displayName;
...
const va = 6, Le = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), On = Object.fromEntries(
...
function Ca(t) {
  const e = Le.find(
    (n) => On[n].toLowerCase() === t.toLowerCase()
  );
  if (e)
    return e;
}
function Os({
  ...
  const o = U(), [s, i] = j(
    ...
    (h) => {
      ...
      return {
        ...
        const z = On[_].toLowerCase(), H = w.replace(/[^a-zA-Z]/g, "").toLowerCase();
  ...
  return pt(() => {
  ...
  }, [x, R]), /* @__PURE__ */ l(ne, { modal: !1, open: S, onOpenChange: ot, children: [
    ...
    /* @__PURE__ */ r(
      Kt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: on.map((h, V) => {
          const _ = C(h);
          return _.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(re, { className: "tw-font-semibold tw-text-foreground/80", children: xa[h] }),
            ...
            on.length - 1 !== V ? /* @__PURE__ */ r(qt, {}) : void 0
          ] }, h);
        }) })
      }
    )
...
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(fn.Root, { ref: n, className: d("pr-twp", Sa(), t), ...e }));
Y.displayName = fn.Root.displayName;
...
const Ye = Ht.Root, Ue = Ht.Trigger, ae = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = U();
...
ae.displayName = Ht.Content.displayName;
const Ra = ut.Portal, Mn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
    className: d(
...
const se = p.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(hn, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      et.Input,
      {
        ref: n,
...
se.displayName = et.Input.displayName;
...
ie.displayName = et.List.displayName;
const we = p.forwardRef((t, e) => /* @__PURE__ */ r(et.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
we.displayName = et.Empty.displayName;
...
zn.displayName = et.Separator.displayName;
...
le.displayName = et.Item.displayName;
function Da(t) {
...
function zs({
  ...
  const f = be(u, "%webView_bookSelector_currentBook%"), v = be(u, "%webView_bookSelector_choose%"), g = be(u, "%webView_bookSelector_chooseBooks%"), [m, N] = j(
    "current book"
    /* CURRENT_BOOK */
  ), S = (y) => {
    N(y), t(y);
...
const Vt = $.Root, Ba = $.Group, Dt = $.Value, Pa = vt(
  ...
  return /* @__PURE__ */ l(
    $.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r($.Icon, { asChild: !0, children: /* @__PURE__ */ r(te, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
Bn.displayName = $.ScrollUpButton.displayName;
...
Pn.displayName = $.ScrollDownButton.displayName;
...
const de = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const pe = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Ga({
  ...
  var y;
  const [w, c] = j([]), [u, f] = j([]), [v, g] = j({}), [m, N] = j({}), S = gn({
    data: e,
    columns: t,
    getCoreRowModel: vn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(de, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ce, { stickyHeader: s, children: S.getHeaderGroups().map((x) => /* @__PURE__ */ r(bt, { children: x.headers.map((k) => /* @__PURE__ */ r(Yt, { children: k.isPlaceholder ? void 0 : Gt(k.column.columnDef.header, k.getContext()) }, k.id)) }, x.id)) }),
      /* @__PURE__ */ r(pe, { children: (y = S.getRowModel().rows) != null && y.length ? S.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        bt,
        {
          onClick: () => i(x, S),
...
function Ps({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ne, { children: [
    /* @__PURE__ */ r(Ie, { asChild: !0, children: /* @__PURE__ */ l(X, { variant: "default", children: [
      ...
      e,
      /* @__PURE__ */ r(te, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Kt, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(re, { children: a.label }),
      /* @__PURE__ */ r(Nn, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(Xe, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(_n, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(qt, {})
    ] }, a.label)) })
  ] }) });
}
...
function Ya({
  ...
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ l(Ye, { open: v, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ r(ae, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(oe, { children: [
...
function Ua({
  ...
  return /* @__PURE__ */ l(de, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(ce, { stickyHeader: !0, children: /* @__PURE__ */ l(bt, { children: [
      /* @__PURE__ */ r(Yt, { children: a }),
      /* @__PURE__ */ r(Yt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(pe, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      bt,
      {
        onClick: () => {
          e(i.reference);
...
qe.displayName = Ce.Root.displayName;
const An = vt(
  ...
  {
    ref: o,
    className: d(An({ variant: e, size: n, className: t })),
    ...a
  }
));
Ka.displayName = xn.Root.displayName;
const In = p.createContext({
  size: "default",
  variant: "default"
}), jn = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = U();
  return /* @__PURE__ */ r(
    ee.Root,
    {
...
const ue = (t) => t === "asc" ? /* @__PURE__ */ r(Dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Or, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Xs = (t) => ({
  accessorKey: "item",
...
Je.displayName = yn.Root.displayName;
...
const We = Ut.Provider, Ze = Ut.Root, Qe = Ut.Trigger, me = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Ut.Content,
  {
    ref: a,
    sideOffset: e,
...
me.displayName = Ut.Content.displayName;
const Qa = "16rem", to = "3rem", Xn = p.createContext(void 0);
function he() {
  const t = p.useContext(Xn);
  if (!t)
...
const Fn = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Xn.Provider, { value: k, children: /* @__PURE__ */ r(We, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Fn.displayName = "SidebarProvider";
const Gn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = he();
...
Yn.displayName = "SidebarMenuItem";
const wo = vt(
  ...
  ({
    ...
    const c = t ? Mt : "button", { state: u } = he(), f = /* @__PURE__ */ r(
      c,
      {
        ref: w,
...
Un.displayName = "SidebarMenuButton";
...
const po = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(wn, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          wn,
          {
...
function fo({
  ...
  return /* @__PURE__ */ r(
    Gn,
    {
      ...
      children: /* @__PURE__ */ l(Ln, { children: [
        /* @__PURE__ */ l(Te, { children: [
          /* @__PURE__ */ r(Ee, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Ve, { children: /* @__PURE__ */ r(Hn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(Yn, { children: /* @__PURE__ */ r(
            Un,
            {
              onClick: () => u(g),
              isActive: v(g),
        ...
        /* @__PURE__ */ l(Te, { children: [
          ...
          /* @__PURE__ */ r(Ve, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            Re,
            {
              buttonVariant: "ghost",
    ...
    /* @__PURE__ */ l(
      Fn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($n, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
...
const ko = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ke(t.start, t.end) === 0 ? `${ge(t.start)}+${e}` : `${ge(t.start)}+${e}-${ge(t.end)}+${n}`;
}, ln = (t) => `${ko({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qs({
  sources: t,
  ...
  pt(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const I = N.find((R) => ln(R) === b[0]) || void 0;
        I && w(I);
      }
    }
  }, [g, N, w, y]);
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(de, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(ce, { children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(bt, { children: C.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(pe, { children: y.getRowModel().rows.map((C, b) => {
        const I = U();
        return /* @__PURE__ */ r(
          bt,
          {
...
}), Jn = (t, e, n) => tn(t, e).every((a) => n.includes(a));
function So({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function Ro({
  ...
  const s = tn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], u = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    X,
    {
      variant: "outline",
...
function To({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
              ...
              Object.values(gt).map((b, I) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ l(mn, { children: [
                    ...
                    I < Object.values(gt).length - 1 && /* @__PURE__ */ r(zn, {})
                  ] }, b);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      ...
      e.length > xe && /* @__PURE__ */ r(
        Zt,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - dn} ${v}`
        }
      )
    ] })
  ] });
...
const Zn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Qe, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(kn, { children: w.label }),
    /* @__PURE__ */ r(na, { children: /* @__PURE__ */ r(Cn, { children: Zn(
      t,
      e,
      Wn(t, w.id),
      a
...
function cn({
  ...
  return /* @__PURE__ */ l(ne, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Kt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(mn, { children: [
      /* @__PURE__ */ r(Nn, { children: /* @__PURE__ */ r(We, { children: Zn(e.groups, e.items, w, t) }) }),
...
const Io = De(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fr, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function di({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = pn(n, "%webView_error_dump_header%"), o = pn(n, "%webView_error_dump_info_message%");
  function s() {
...
os.displayName = _e.Root.displayName;
function ui({ ...t }) {
  return /* @__PURE__ */ r(
    Zr,
    {
...
is.displayName = Se.Root.displayName;
