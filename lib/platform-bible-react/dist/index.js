...
import b, { forwardRef as tn, useRef as X, useMemo as j, useState as I, useCallback as G, useLayoutEffect as Ft, createContext as yn, useContext as dr, useEffect as q, Component as ns, createElement as Or, Suspense as rs, createRef as os, Fragment as io } from "react";
...
import { includes as sn, Section as U, getChaptersForBook as Fs, formatScrRef as ue, getSectionForBook as Ke, formatRelativeDate as Bs, formatReplacementString as pe, sanitizeHtml as Gs, NumberFormat as Ks, formatBytes as Us, getCurrentLocale as qs, getFormatCallerFunction as Hs, deepEqual as Ys, isString as $r, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as W, formatScrRefRange as Xs, formatScrRefWithOptionalParts as Ws } from "platform-bible-utils";
...
import { createEditor as xo, $getRoot as Zt, $createParagraphNode as kn, $getSelection as Bt, HISTORY_MERGE_TAG as cr, ParagraphNode as yo, TextNode as No, $isTokenOrSegmented as Js, $getCharacterOffsets as Zs, $cloneWithPropertiesEphemeral as Qs, $findMatchingParent as ti, $isElementNode as me, CLEAR_EDITOR_COMMAND as ko, COMMAND_PRIORITY_EDITOR as _o, $isRangeSelection as We, mergeRegister as Qt, shallowMergeConfig as ei, defineExtension as Kt, safeCast as en, RootNode as ni, LineBreakNode as ri, TabNode as oi, $isEditorState as ai, createCommand as si, CLICK_COMMAND as ii, isDOMNode as li, $getNodeFromDOMNode as wi, $isNodeSelection as di, $createNodeSelection as ci, $setSelection as pi, COMMAND_PRIORITY_LOW as ui, DecoratorNode as mi, addClassNamesToElement as Co, $create as fi, $getNodeByKey as hi, removeClassNamesFromElement as gi, KEY_TAB_COMMAND as bi, $isBlockElementNode as mn, $createRangeSelection as vi, $normalizeSelection__EXPERIMENTAL as xi, OUTDENT_CONTENT_COMMAND as yi, INDENT_CONTENT_COMMAND as Lr, INSERT_TAB_COMMAND as Ni, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as ki, $isParagraphNode as _i, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Eo, FORMAT_TEXT_COMMAND as Ci, getRegisteredNode as Ei, isHTMLElement as Ti, isDocumentFragment as Vr, isDOMDocumentNode as Ri, ArtificialNode__DO_NOT_USE as To, $createLineBreakNode as Ro, $isRootOrShadowRoot as Si, isBlockDomNode as jr, isInlineDomNode as zr, $insertNodes as Di } from "lexical";
...
import { DropdownMenuTrigger as Vi } from "@radix-ui/react-dropdown-menu";
import { useReactTable as Oo, getFilteredRowModel as ji, getSortedRowModel as Io, getPaginationRowModel as zi, getCoreRowModel as Ao, flexRender as Ue, getGroupedRowModel as Fi, getExpandedRowModel as Bi } from "@tanstack/react-table";
import * as rt from "@radix-ui/react-select";
import Gi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Xn, HIDDEN_NOTE_CALLER as Wn, getDefaultViewOptions as Ki, isInsertEmbedOpOfType as ln, Editorial as Ui } from "@eten-tech-foundation/platform-editor";
...
const Wi = Rt.Root, Ji = Rt.Portal, Po = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: m(
...
Zi.displayName = Rt.Description.displayName;
...
function fr(t, e, n) {
  ...
  return !!(sn(a.toLowerCase(), o) || sn(t.toLowerCase(), o) || (s ? sn(s.localizedName.toLowerCase(), o) || sn(s.localizedId.toLowerCase(), o) : !1));
}
const Go = tn(
  ({
    bookId: t,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: m(Ko({ variant: e, size: n, className: t })), ref: s, ...a })
);
V.displayName = "Button";
const ne = Ce.Root, re = Ce.Trigger, Wc = Ce.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = dt();
...
function tl({
  ...
  return /* @__PURE__ */ c(ne, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Gt, { heading: s, children: t.map((u) => /* @__PURE__ */ c(
      Pt,
      {
        onSelect: () => p(u),
...
function Jc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Br({
  ...
  if (t)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: At(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Pt,
      {
        value: `${t} ${fe[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Zc({
  ...
  }, [x, N, C, t.book, t.chapterNum]), /* @__PURE__ */ c(ne, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ r(re, { asChild: !0, children: /* @__PURE__ */ r(
      V,
      {
...
), wt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(vo.Root, { ref: n, className: m("pr-twp", ol(), t), ...e }));
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, wl = qo ? Ft : q, wn = { tag: cr };
function dl({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = ll(null, o), p = xo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
        if (h === void 0) u.update(() => {
          ...
          if (f.isEmpty()) {
            ...
            (Bt() !== null || v !== null && v === u.getRootElement()) && g.select();
          }
        }, wn);
...
const cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : q;
...
const gl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : q;
function bl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function vl() {
  return function(t) {
    const [e] = $t(), n = j(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = X(o);
    return gl(() => {
...
function xl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Js(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), d = s.getNode(), w = e.is(l), p = e.is(d);
    if (w || p) {
      const [u, h] = Zs(t), f = l.is(d), g = e.is(i ? d : l), v = e.is(i ? l : d);
      let x, y = 0;
      f ? (y = u > h ? h : u, x = u > h ? u : h) : g ? (y = i ? h : u, x = void 0) : v && (y = 0, x = i ? u : h);
      const N = e.__text.slice(y, x);
      N !== e.__text && (n === "clone" && (e = Qs(e)), e.__text = N);
    }
  }
  return e;
}
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Ho && "documentMode" in document ? document.documentMode : null;
!(!Ho || !("InputEvent" in window) || Nl) && "getTargetRanges" in new window.InputEvent("input");
function Gr(t) {
  const e = ti(t, (n) => me(n) && !n.isInline());
  return me(e) || yl(4, t.__key), e;
}
...
gt.prototype.brand = kl, gt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Wo(this), qr(this), Jt++;
  const t = Y;
...
Kt({ build: (t, e, n) => En(e), config: en({ $onClear: Jo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return te(() => Zo(t, o.value));
} });
function Tl(t) {
...
const rr = Kt({ build: (t) => Qo(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Ol = Kt({ config: en({ setOptions: Hr, updateOptions: Hr }), init: ({ $initialEditorState: t = Ml }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ni, No, ri, oi, yo] }), Yr = Symbol.for("@lexical/extension/LexicalBuilder");
function Xr() {
}
function Il(t) {
  throw t;
...
class He {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(xo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [Yr]: this });
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: u } = p;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const h of Tl(u)) {
...
const Al = /* @__PURE__ */ new Set(), Wr = Kt({ build(t, e, n) {
...
Kt({ dependencies: [rr, Wr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  ...
  return Qt(t.registerCommand(ii, (i) => {
    if (li(i.target)) {
      const l = wi(i.target);
      if ($l(l)) return function(d, w = !1) {
        const p = Bt(), u = d.isSelected(), h = d.getKey();
        let f;
        w && di(p) ? f = p : (f = ci(), pi(f)), u ? f.delete(h) : f.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, ui), t.registerMutationListener(Ee, (i, l) => {
    _l(() => {
      let d = !1;
    ...
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(te(() => {
      const w = l.value;
      w && (d.value ? Co(w, s) : gi(w, s));
    }));
    return Qt(...i);
  }));
} });
function Ll(t, e) {
  return Qt(t.registerCommand(bi, (n) => {
    const o = Bt();
    if (!We(o)) return !1;
    n.preventDefault();
    const a = function(s) {
      ...
      if (p.canIndent()) {
        const u = p.getKey();
        let h = vi();
        if (h.anchor.set(u, 0, "element"), h.focus.set(u, 0, "element"), h = xi(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(o) ? n.shiftKey ? yi : Lr : Ni;
    return t.dispatchCommand(a, void 0);
  }, _o), t.registerCommand(Lr, () => {
...
Kt({ build: (t, e, n) => En(e), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => te(() => n.getOutput().disabled.value ? void 0 : aa(t)) });
function Bl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
function Ul({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    yr(() => Qt(Ai(a), aa(a)), [a]);
  }(o), c(st, { children: [t, r(ql, { content: e }), r(Kl, { editor: o, ErrorBoundary: n })] });
}
...
const Yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : q;
function Xl({ onClear: t }) {
  const [e] = $t();
  return Yl(() => Zo(e, t), [e, t]), null;
}
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : q;
function Wl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: f, className: g, id: v, role: x = "textbox", spellCheck: y = !0, style: N, tabIndex: _, "data-testid": S, ...z }, L) {
  ...
  return sa(() => (R(t.isEditable()), t.registerEditableListener((P) => {
    R(P);
...
function Ql(t, e) {
  ...
  return c(st, { children: [r(Jl, { editor: a, ...o, ref: e }), n != null && r(tw, { editor: a, content: n })] });
}
...
function rw() {
  const [t, e] = I(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Wi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c($o, { children: [
...
function ow({
  ...
  const [e] = $t(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = rw(), d = () => {
  };
...
sw.displayName = So.Root.displayName;
...
function iw() {
  const { activeEditor: t } = la(), [e, n] = I([]), o = G((a) => {
    if (We(a) || Li(a)) {
      const s = [];
      Qr.forEach(({ format: i }) => {
...
function ca(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && fn(e) && (i = xl(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], d = Ei(t, i.getType());
  let w;
  ...
  for (let f = 0; f < l.length; f++) {
    const g = l[f], v = ca(t, g, h, o);
    !a && me(e) && v && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ti(p) || Vr(p)) && p.append(h), n.append(p), u) {
      const f = u.call(i, p);
...
function ua(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  let h = [];
  const f = (l == null || !Si(l)) && (l != null && mn(l) || o);
  for (let g = 0; g < u.length; g++) h.push(...ua(u[g], e, n, f, new Map(a), l));
  return p != null && (h = p(h)), jr(t) && (h = uw(t, h, f ? () => {
    const g = new To();
    return n.push(g), g;
  } : kn)), l == null ? h.length > 0 ? i = i.concat(h) : jr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : zr(g.nextSibling) && zr(g.previousSibling);
  }(t) && (i = i.concat(Ro())) : me(l) && l.append(...h), i;
}
function uw(t, e, n) {
...
function np({
  ...
  const [a, s] = I(fw), [i, l] = I(void 0), [d, w] = I(!1), p = X(void 0), u = X(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  const h = G(() => {
    ...
    const y = bn(a);
    e(y, i);
  }, [a, e, i]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", v = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
...
}), Le = tt.Trigger, xa = tt.Group, Cw = tt.Portal, Ew = tt.Sub, Tw = tt.RadioGroup;
...
function to({
  ...
  }, [t.date, n]), x = j(() => t.user, [t.user]), y = j(
    () => t.user.split(" ").map((S) => S[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), N = j(() => Gs(t.contents), [t.contents]), _ = j(() => {
    if (o && l)
      return /* @__PURE__ */ c(st, { children: [
        /* @__PURE__ */ c(
          vn,
          {
            onClick: () => {
              w(!0), u(mw(t.contents)), i == null || i(!0);
            },
            children: [
...
function Sw({
  ...
  const [k, R] = I(eo), E = o, [T, P] = I(!1), [$, M] = I(!1), [A, F] = I(!1), [C, K] = I(void 0), [ct, ut] = I(!1), [Lt, mt] = I(!1), [it, B] = I(S), [at, ft] = I(!1), lt = X(void 0), [yt, ze] = I(/* @__PURE__ */ new Map());
  q(() => {
    let D = !0;
    return (async () => {
  ...
  const ae = j(() => Xt[0], [Xt]), on = X(null), xe = X(void 0), se = G(() => {
    var D;
...
function ap({
  ...
  const z = n.filter(
    ...
    [y, v]
  ), { listboxRef: E, activeId: T, handleKeyDown: P } = bw({
    options: L,
    onOptionSelect: k
  }), $ = G(
    (M) => {
...
function Dw({ table: t }) {
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(Vi, { asChild: !0, children: /* @__PURE__ */ c(V, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Se = rt.Root, Mw = rt.Group, De = rt.Value, Ow = ee(
...
function Bw({
  ...
  var L;
  const [p, u] = I([]), [h, f] = I([]), [g, v] = I({}), [x, y] = I({}), N = j(() => e ?? [], [e]), _ = Oo({
    data: N,
    columns: t,
    getCoreRowModel: Ao(),
...
function sp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Gi, { options: s, children: e })
    }
  );
}
...
function Hw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ c(ne, { open: R, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(re, { asChild: !0, children: /* @__PURE__ */ c(
      V,
      {
        variant: v,
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(st, { children: [
...
function Xw({
  ...
  const s = X(null), i = X(null), l = X(!1), [d, w] = I(t), [p, u] = I(n), [h, f] = I(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && u(n);
  ...
  const g = (x) => {
    l.current = !1, f(x), x || (d !== "custom" || p ? (e(d), o(p)) : (w(t), u(n)));
  }, v = (x) => {
    var y, N, _, S;
  ...
  return /* @__PURE__ */ c(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
      /* @__PURE__ */ r(Tt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Yw(t, a, n) }) }) }),
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r(go, {}),
  " ",
...
function Zw({
  ...
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ c(Et, { children: [
      /* @__PURE__ */ r(Mi, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Ww(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: Jw(t, n) }) })
    ] }) }),
...
function up({
  ...
  const d = X(null), w = os(), [p, u] = I("generated"), [h, f] = I("*"), [g, v] = I("f"), [x, y] = I(!1), N = j(
    () => ({
      ...
      hasExternalUI: !0,
      view: { ...i.view ?? Ki(), noteMode: "expanded" }
    }),
    [i]
  );
  q(() => {
  ...
  const _ = G(() => {
    ...
    if (R && ln("note", R)) {
      ...
      g !== "x" && k === "x" ? A == null || A.forEach((F) => Qw(F)) : g === "x" && k !== "x" && (A == null || A.forEach((F) => td(F))), (M = d.current) == null || M.applyUpdate([R, { delete: 1 }]);
    }
  }, L = (k) => {
    var E, T, P, $, M;
    const R = (T = (E = d.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : T.at(0);
...
function od({
  ...
  /* @__PURE__ */ c("span", { className: m("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    Cr(t.marker, [i], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", f = o ? "marker-visible" : "", g = e === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", v = m(h, f);
  return /* @__PURE__ */ c(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: nd(t.marker, l, o, w) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ r(Sn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ c(
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(he, { className: o, children: ad(l.text) })
        ]
      },
...
const id = (t) => {
  ...
  accessorKey: "status",
  header: ({ column: s }) => Dn(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, wd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Np = Object.freeze([
...
function kp({
  ...
  const f = It(n, "%webView_inventory_all%"), g = It(n, "%webView_inventory_approved%"), v = It(n, "%webView_inventory_unapproved%"), x = It(n, "%webView_inventory_unknown%"), y = It(n, "%webView_inventory_scope_currentBook%"), N = It(n, "%webView_inventory_scope_chapter%"), _ = It(n, "%webView_inventory_scope_verse%"), S = It(n, "%webView_inventory_filter_text%"), z = It(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = It(n, "%webView_inventory_no_results%"), [k, R] = I(!1), [E, T] = I("all"), [P, $] = I(""), [M, A] = I([]), F = j(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : cd(B, a, s);
  }, [t, a, s]), C = j(() => {
    if (k) return F;
    const B = [];
    return F.forEach((at) => {
  ...
  }, [k, F]), K = j(() => C.length === 0 ? [] : dd(C, E, P), [C, E, P]), ct = j(() => {
    var ft, lt;
    if (!k) return d;
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(Se, { onValueChange: (B) => Lt(B), defaultValue: i, children: [
...
function pd({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Ds, { className: e, size: 16 });
}
function Cp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = I(""), a = j(() => {
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ c(
          Pt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(pd, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
...
const ud = "16rem", md = "3rem", Ta = b.createContext(void 0);
function Mn() {
...
const Sa = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Mn();
...
const fd = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Mn();
  return /* @__PURE__ */ c(
    V,
    {
...
const yd = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: o,
  ...
  ({
    ...
    const d = t ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      d,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(Nd({ variant: n, size: o }), s),
        ...i
      }
    );
...
const kd = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: a,
...
_d.displayName = "SidebarMenuBadge";
const Cd = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Rd = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
...
const Wt = "scrBook", Dd = "scrRef", ce = "source", Md = "details", Od = "Scripture Reference", Id = "Scripture Book", Pa = "Type", Ad = "Details";
function Pd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, oo = (t) => `${$d({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Tp({
  sources: t,
    ...
    !e && /* @__PURE__ */ c(
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(be, { position: "item-aligned", children: /* @__PURE__ */ r(Mw, { children: S.map((E) => /* @__PURE__ */ r(Nt, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
}), $a = (t, e, n) => Rr(t, e).every((o) => n.includes(o));
function Ld({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Rr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    V,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: m(
        $a(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Qi(
        t,
...
function Vd({
  ...
  const L = j(() => ot.allBookIds.filter(
    ...
    (A) => {
      ...
      n(
        $a(L, A, e) ? e.filter((C) => !F.includes(C)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, L]
  ), $ = () => {
                  ...
                  Object.values(U).map((A, F) => {
                    ...
                    if (C.length !== 0)
                      return /* @__PURE__ */ c(io, { children: [
                        ...
                        F < Object.values(U).length - 1 && /* @__PURE__ */ r(jo, {})
                      ] }, A);
                  })
                ] })
              ]
...
function Sp({
  ...
  const w = we(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = we(i, "%webView_scope_selector_current_book%"), f = we(i, "%webView_scope_selector_choose_books%"), g = we(i, "%webView_scope_selector_scope%"), v = we(i, "%webView_scope_selector_select_books%"), x = [
  ...
  ], y = e ? x.filter((N) => e.includes(N.value)) : x;
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          be,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(Nt, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Va = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Et, { children: [
  ...
  ) : /* @__PURE__ */ c(Ew, { children: [
    /* @__PURE__ */ r(ya, { children: l.label }),
    /* @__PURE__ */ r(Cw, { children: /* @__PURE__ */ r(Na, { children: Va(
      t,
      e,
      La(t, l.id),
      o
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    ...
    /* @__PURE__ */ r(oe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(io, { children: [
      /* @__PURE__ */ r(xa, { children: /* @__PURE__ */ r(kt, { children: Va(e.groups, e.items, d, t) }) }),
...
function $p({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(za, { children: [
      /* @__PURE__ */ r(Fa, { children: t.map((l) => /* @__PURE__ */ r(jd, { value: l.value, children: l.value }, l.key)) }),
...
const Ha = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Mt();
...
const Bd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Mt();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
Gd.displayName = et.RadioItem.displayName;
...
Kd.displayName = et.Label.displayName;
...
const Be = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Et, { children: [
  ...
  if (qi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Be(s, [h, f]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), Be(i, [h, f]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Be(l, [h, f]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(Ga, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ c(zd, { children: [
      /* @__PURE__ */ r(Ka, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        Ha,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(kt, { children: Wa(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function jp({
  ...
  const w = qd(
    ...
    var y, N, _, S, z, L;
    const x = v !== g ? ((N = (y = t[g]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((S = (_ = t[g]) == null ? void 0 : _.uiNames) == null ? void 0 : S.en) : void 0;
    return x ? `${(z = t[g]) == null ? void 0 : z.autonym} (${x})` : (L = t[g]) == null ? void 0 : L.autonym;
  };
...
function Hd({ item: t, createLabel: e, createComplexLabel: n }) {
...
function Yd({
  ...
  return /* @__PURE__ */ c("div", { className: "tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none", children: [
    /* @__PURE__ */ c(
      V,
      {
        variant: "link",
        ...
        children: [
          /* @__PURE__ */ r("span", { className: m({ "tw-me-2": i === "allText" }), children: e ? Xs(t, e, s) : Ws(t, s) }),
          i === "allText" && so(n, o)
        ]
      }
    ),
...
function Fp({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": e }), children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ r("div", { className: "tw-p-1", children: /* @__PURE__ */ c(ve, { children: [
...
const Xd = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ls, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
), Jd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Zd.displayName = "AlertTitle";
const Qd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Qd.displayName = "AlertDescription";
const Gp = nt.Root, Kp = nt.Trigger, Up = nt.Group, qp = nt.Portal, Hp = nt.Sub, Yp = nt.RadioGroup, tc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
tc.displayName = nt.SubTrigger.displayName;
...
ec.displayName = nt.SubContent.displayName;
const nc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(nt.Portal, { children: /* @__PURE__ */ r(
  nt.Content,
  {
    ref: n,
    className: m(
...
const rc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  nt.Item,
  {
    ref: o,
    className: m(
...
rc.displayName = nt.Item.displayName;
const oc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
oc.displayName = nt.CheckboxItem.displayName;
const ac = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: o,
    className: m(
...
ac.displayName = nt.RadioItem.displayName;
const sc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  nt.Label,
  {
    ref: o,
    className: m(
...
sc.displayName = nt.Label.displayName;
...
ic.displayName = nt.Separator.displayName;
...
lc.displayName = "ContextMenuShortcut";
...
wc.displayName = "Drawer";
const Xp = Dt.Trigger, dc = Dt.Portal, Wp = Dt.Close, Za = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: n,
...
const cc = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
mc.displayName = Dt.Title.displayName;
...
fc.displayName = Dt.Description.displayName;
const hc = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Zn.Root,
  {
    ref: o,
    className: m(
...
hc.displayName = Zn.Root.displayName;
function Jp({
  className: t,
  ...e
}) {
...
const gc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = dt();
  return /* @__PURE__ */ c(
    Ge.Root,
    {
...
gc.displayName = Ge.Root.displayName;
const bc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    Qn.Root,
    {
...
bc.displayName = Qn.Root.displayName;
const eu = xt.Root, vc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    xt.List,
    {
...
vc.displayName = xt.List.displayName;
...
xc.displayName = xt.Trigger.displayName;
...
yc.displayName = xt.Content.displayName;
...
export {
  ...
  _w as AvatarImage,
  Qc as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  tp as BOOK_SELECTOR_STRING_KEYS,
  Te as Badge,
  Zc as BookChapterControl,
  ...
  ap as CommentList,
  Gp as ContextMenu,
  oc as ContextMenuCheckboxItem,
  nc as ContextMenuContent,
  Up as ContextMenuGroup,
  rc as ContextMenuItem,
  sc as ContextMenuLabel,
  qp as ContextMenuPortal,
  Yp as ContextMenuRadioGroup,
  ac as ContextMenuRadioItem,
  ic as ContextMenuSeparator,
  lc as ContextMenuShortcut,
  Hp as ContextMenuSub,
  ec as ContextMenuSubContent,
  tc as ContextMenuSubTrigger,
  Kp as ContextMenuTrigger,
  Bw as DataTable,
  wc as Drawer,
  Wp as DrawerClose,
  cc as DrawerContent,
  fc as DrawerDescription,
  uc as DrawerFooter,
  pc as DrawerHeader,
  Za as DrawerOverlay,
  dc as DrawerPortal,
