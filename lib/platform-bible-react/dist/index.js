...
import { extendTailwindMerge as si, twMerge as ci } from "tailwind-merge";
import { Slot as ke, Dialog as qt, Popover as ar, Tooltip as Pe, Label as li, RadioGroup as oa, ToggleGroup as Do, Separator as di, Avatar as xa, DropdownMenu as mt, Select as _t, Checkbox as Ua, Tabs as Ft, Menubar as Wt, ContextMenu as vt, Progress as Ka, Slider as ur, Switch as qa } from "radix-ui";
...
import { useReactTable as tn, getFilteredRowModel as dc, getSortedRowModel as en, getPaginationRowModel as wc, getCoreRowModel as rn, flexRender as er, getGroupedRowModel as uc, getExpandedRowModel as pc } from "@tanstack/react-table";
import gc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ca, HIDDEN_NOTE_CALLER as la, getDefaultViewOptions as hc, isInsertEmbedOpOfType as gr, Editorial as fc } from "@eten-tech-foundation/platform-editor";
...
function kc(t, e) {
  ...
  const r = da(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = da(e), c = i.some((l) => l.startsWith("-tw-")), s = i.some((l) => l.startsWith("!tw-"));
  if (c && n.startsWith("-")) {
    const l = n.slice(1);
    return [...o, `-tw-${l}`].join(":");
  }
...
function f(...t) {
  ...
  }), ci(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? kc(l, d) : l;
  }).join(" ");
}
const We = 250, an = 300, _c = 400, Nc = 450, Cc = 500, on = Yt(
...
function dr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Rc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a($c, { children: /* @__PURE__ */ a(ui, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Pc({
  ...
  return /* @__PURE__ */ u(le, { open: w, onOpenChange: g, children: [
...
function Fc(t, e, r, o) {
  const n = B(() => {
    if (t.chapterNum > 1)
      ...
      if (l > 0) {
        const d = e[l - 1], w = Math.max(Vt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function oo({
  ...
  if (t)
    return /* @__PURE__ */ a(se, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Vt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      ce,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Mu({
  ...
  const d = lt(), [w, g] = R(!1), [h, p] = R(""), [m, b] = R(""), [v, C] = R("books"), [y, N] = R(void 0), [k, P] = R(!1), O = Y(void 0), A = Y(void 0), E = Y(void 0), T = Y(void 0), z = Y({}), [I, F] = R(!1);
  Rt(() => {
  ...
  }, [v, y, n]), /* @__PURE__ */ u(le, { open: w, onOpenChange: ct, children: [
                    ...
                    children: [
                      /* @__PURE__ */ a(
                        dr,
                        {
                          ...
                          onKeyDown: ge,
                          onFocus: () => P(!1),
                          className: c && c.length > 0 ? "tw:pr-8!" : ""
                        }
                      ),
...
function ua({
  ...
  const [N, k] = R(!1), P = d ?? l, O = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], A = (E, T) => {
    const z = l(E), I = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, F = `${T ?? ""}${z}${I ?? ""}`;
    return /* @__PURE__ */ u(
      ce,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(le, { open: N, onOpenChange: k, ...y, children: [
...
const gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Kc = gn ? Rt : X, hr = { tag: Na };
function qc({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: c, editorState: s, html: l } = t, d = Uc(null, o), w = Vo({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => c(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : X;
...
const Zc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : X;
function Qc(t) {
...
function rl(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !gs(e) && o !== null) {
    ...
    if (d || w) {
      const [g, h] = hs(t), p = s.is(l), m = e.is(c ? l : s), b = e.is(c ? s : l);
      let v, C = 0;
      p ? (C = g > h ? h : g, v = g > h ? g : h) : m ? (C = c ? h : g, v = void 0) : b && (C = 0, v = c ? g : h);
...
const hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, al = hn && "documentMode" in document ? document.documentMode : null;
!(!hn || !("InputEvent" in window) || al) && "getTargetRanges" in new window.InputEvent("input");
function Kt(t) {
  return `${t}px`;
}
...
function nl(t, e, r) {
  ...
  function l() {
    ...
    for (let C = 0; C < p.length; C++) {
      const y = p[C], N = c[C] || document.createElement("div"), k = N.style;
      ...
      const E = Kt(y.height);
      k.height !== E && (N.style.height = E, v = !0), N.parentNode !== s && (s.append(N), v = !0), c[C] = N;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (b !== o || v !== n) return g();
      for (const C of m) if (!s.contains(C.target)) return l();
    }), i.observe(p, ol), l();
  });
  return () => {
    w(), d();
...
function sl(t, e = il) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, C = p.getNode(), y = C.getKey(), N = p.offset, k = t.getElementByKey(b), P = t.getElementByKey(y), O = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || P !== c || N !== s || y !== i.getKey();
...
function cl(t, e) {
  ...
  const o = () => {
    ...
    i !== null && c !== null && c.contains(i) ? r !== null && (r(), r = null) : r === null && (r = sl(t, e));
  };
...
let Er, oe = 0, zr = 0, hl = 0, ga = 0, xr = 0;
function so(t) {
  if (et === void 0) return;
  let e = t.n;
...
kt.prototype.brand = pl, kt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, vn(this), co(this), oe++;
  const t = et;
  return et = this, ml.bind(this, t);
...
At({ name: "@lexical/extension/DecoratorText", nodes: () => [yn], register: (t, e, r) => t.registerCommand(Go, (o) => {
  const n = Dt();
  if (Ho(n) || Gt(n)) for (const i of n.getNodes()) bl(i) && i.toggleFormat(o);
  return !1;
}, Wo) });
function kn(t, e) {
  let r;
...
class kl {
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== Je && at(309, String(o.id), String(Je)), this.state = function(c) {
...
const Nl = At({ config: $e({ setOptions: lo, updateOptions: lo }), init: ({ $initialEditorState: t = _l }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Ve {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var s;
      Xr(i) || at(300, c, n || "[unknown]"), Xr(s = i) || at(304, String(s.id), String($a)), i = Object.assign(s, { id: fa }), o.state = i;
...
const El = /* @__PURE__ */ new Set(), po = At({ build(t, e, r) {
  ...
  return { watchNodeKey: function(c) {
    const s = fl(() => (i.value || El).has(c)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(c);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(s), w || (l.set(c, d), n.value = { watchedNodeKeys: l }), s;
  } };
}, dependencies: [ha], name: "@lexical/extension/NodeSelection" }), zl = As("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
At({ dependencies: [ha, po], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ie(t.registerCommand(zl, (c) => {
    const s = Dt();
    if (!Gt(s)) return !1;
    ...
    return !0;
  }, Ca), t.registerCommand(Os, (c) => {
    if (Is(c.target)) {
      const s = Ps(c.target);
      if (Sl(s)) return function(l, d = !1) {
        const w = Dt(), g = l.isSelected(), h = l.getKey();
        let p;
        d && Ho(w) ? p = w : (p = Ls(), Vs(p)), g ? p.delete(h) : p.add(h);
      }(s, c.shiftKey), !0;
    }
    return !1;
  }, Wo), t.registerMutationListener(Fe, (c, s) => {
    gl(() => {
      let l = !1;
...
function Dl(t, e, r = En) {
  return ie(t.registerCommand(Hs, (o) => {
    const n = Dt();
    if (!Gt(n)) return !1;
    o.preventDefault();
    const i = function(c) {
      if (c.getNodes().filter((h) => _r(h) && h.canIndent()).length > 0) return !0;
      const s = c.anchor, l = c.focus, d = l.isBefore(s) ? l : s, w = d.getNode(), g = ll(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Ws();
...
const Rl = At({ name: "@lexical/react/ReactProvider" });
function Ml() {
...
function Il({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    ...
    return Oa(() => r.registerDecoratorListener((c) => {
      sc(() => {
        i(c);
      });
    }), [r]), X(() => {
      ...
      for (let l = 0; l < s.length; l++) {
        const d = s[l], w = a(o, { onError: (h) => r._onError(h), children: a(ps, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && c.push(cc(w, g, d));
      }
      return c;
    }, [o, n, r]);
  }(t, e);
...
function Pl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Rl.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Ol(320, n);
      return !0;
    }
    return !1;
...
function Ll({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Oa(() => ie(ic(n), Tn(n)), [n]);
  }(o), u(it, { children: [t, a(Vl, { content: e }), a(Pl, { editor: o, ErrorBoundary: r })] });
}
...
const jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : X;
function Bl({ onClear: t }) {
  const [e] = Xt();
  return jl(() => xn(e, t), [e, t]), null;
}
const Sn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Rt : X;
function Ul({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: c, ariaInvalid: s, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: C = !0, style: y, tabIndex: N, "data-testid": k, ...P }, O) {
...
function Gl(t, e) {
  ...
  return u(it, { children: [a(Kl, { editor: n, ...o, ref: e }), r != null && a(Hl, { editor: n, content: r })] });
}
function Hl({ content: t, editor: e }) {
  ...
  if (Rt(() => (n(e.isEditable()), e.registerEditableListener((c) => {
    n(c);
  })), [e]), !r) return null;
  let i = null;
...
function Yl({
  ...
  return /* @__PURE__ */ a(Dn.Provider, { value: c, children: i });
}
function Rn() {
  const t = _a(Dn);
  if (!t)
...
function Jl({
  ...
  const [e] = Xt(), [r, o] = R(e), [n, i] = R("paragraph"), [c, s] = Xl(), l = () => {
  };
...
function td() {
  ...
  return Zl(o), /* @__PURE__ */ a(
    $n,
    {
      ...
      variant: "outline",
      size: "sm",
      children: fo.map(({ format: n, icon: i, label: c }) => /* @__PURE__ */ a(
        yr,
        {
          value: n,
          "aria-label": c,
        ...
        children: /* @__PURE__ */ a(
          qc,
          {
            ...
            children: /* @__PURE__ */ u(Nt, { children: [
              /* @__PURE__ */ a(rd, { placeholder: n, autoFocus: i, onClear: c }),
              /* @__PURE__ */ a(
                Hc,
                {
...
function od(t, e) {
  ...
  return function(i) {
    for (const c of i) c.getNextSibling() instanceof Jo && c.insertAfter(Zo());
    for (const c of i) {
...
function An(t, e, r, o = null) {
  ...
  let c = e;
  o !== null && Nr(e) && (c = rl(o, e, "clone"));
  const s = ae(c) ? c.getChildren() : [], l = tc(t, c.getType());
  let d;
...
function id(t, e, r) {
  ...
  for (let c = 0; c < e.length; c++) {
    ...
    else if (i.push(s), c === e.length - 1 || c < e.length - 1 && _r(e[c + 1])) {
      const l = r();
...
function jn({
  ...
  const c = mo(o, "%cancelButton_tooltip%"), s = i ?? mo(o, "%acceptButton_tooltip%");
...
function Pu({
  ...
  const [i, c] = R(ld), [s, l] = R(n), [d, w] = R(!1), g = Y(void 0), h = Y(null);
  X(() => {
    let v = !0;
    const C = h.current;
    if (!C) return;
    ...
    if (o && s)
      return /* @__PURE__ */ u(it, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(sd(t.contents)), c == null || c(!0);
            },
            children: [
...
function Nd({
  ...
  const [E, T] = R(bo), [z, I] = R(), [F, G] = R(), M = o, [H, S] = R(!1), [U, V] = R(!1), [Tt, Mt] = R(!1), [wt, Jt] = R(!1), [K, nt] = R(!1), [ct, gt] = R(k), [St, Zt] = R(!1), bt = Y(void 0), [ue, pe] = R(/* @__PURE__ */ new Map());
  X(() => {
    let D = !0;
    return (async () => {
      const st = y ? await y(l) : !1;
      D && nt(st);
    })(), () => {
      D = !1;
    };
  ...
  const Q = B(
    async (D) => {
      ...
      pt && await g({ threadId: l, contents: pt }) && te();
    },
    [
      te,
      E,
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                j,
                {
                  ...
                  children: ct ? /* @__PURE__ */ a(Li, {}) : /* @__PURE__ */ a(Vi, {})
                }
              ),
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      ...
                      /* @__PURE__ */ u(le, { open: Tt, onOpenChange: Mt, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          j,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !wt || !b || b.length === 0 || !b.includes(c),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => c(), children: /* @__PURE__ */ a(Ao, {}) })
        ] }),
...
function Qu({
  ...
  return /* @__PURE__ */ u(le, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(de, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
      c && r["%webView_error_dump_copied_message%"] && /* @__PURE__ */ a(ft, { children: r["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ a(
        Id,
        {
          errorDetails: t,
...
function Un({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(le, { open: E, onOpenChange: w ?? y, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
      j,
      {
        variant: b,
...
function Fd({
  ...
  const l = L(() => /Macintosh/i.test(navigator.userAgent), []), d = _o(n, "%undoButton_tooltip%"), w = _o(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Pa, { children: [
    /* @__PURE__ */ a(Nt, { children: /* @__PURE__ */ u(Ct, { children: [
      /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
        j,
      ...
      /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(it, { children: [
          " ",
          /* @__PURE__ */ a(ko, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Nt, { children: /* @__PURE__ */ u(Ct, { children: [
      ...
      /* @__PURE__ */ a(zt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(it, { children: [
          " ",
          /* @__PURE__ */ a(ko, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Ud({
  ...
  const m = (v) => {
    ...
    var C, y, N, k;
    v.stopPropagation(), document.activeElement === c.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), s.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = c.current) == null || y.focus(), s.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((k = c.current) == null || k.focus(), s.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === c.current || document.activeElement === i.current) && m(!1);
  };
  ...
  return /* @__PURE__ */ u(Ne, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ce, { children: [
      ...
      c.length > 0 && /* @__PURE__ */ u(it, { children: [
        ...
        /* @__PURE__ */ a(se, { children: c.map((s) => {
          var l;
          return /* @__PURE__ */ a(
            No,
            {
...
function op({
  ...
  const [m, b] = R("generated"), [v, C] = R("generated"), [y, N] = R("*"), [k, P] = R("*"), [O, A] = R("f"), [E, T] = R(!1), [z, I] = R(!0), [F, G] = R(!1), M = Y(!1), H = Y(""), [S, U] = R(!1), [V, Tt] = R(), [Mt, wt] = R(), [Jt, K] = R(), [nt, ct] = R(), gt = Y(null), St = L(
    () => ({
      ...c,
      markerMenuTrigger: s,
      hasExternalUI: !0,
      view: { ...c.view ?? hc(), noteMode: "expanded" }
    }),
    [c, s]
  ), Zt = L(
    () => Xd(
  ...
  X(() => {
    ...
    if ($ && gr("note", $)) {
      ...
      let tt = "custom";
      W === ca ? tt = "generated" : W === la ? tt = "hidden" : W && (N(W), P(W)), b(tt), C(tt), A(((Z = $.insert.note) == null ? void 0 : Z.style) ?? "f"), _ = setTimeout(() => {
        var ut;
  ...
  const bt = B(
    (_, $, q = !1) => {
      ...
      if (Z && gr("note", Z)) {
        if (Z.insert.note) {
          let Q;
          _ === "custom" ? Q = $ : _ === "generated" ? Q = ca : Q = la, Z.insert.note.caller = Q;
        }
  ...
  const Ot = () => {
    ...
    ct(_.contextMarker), G(_.canRedo);
  }, Xe = B(
    (_) => {
      var q, Z, W, tt, ut;
      const $ = (Z = (q = w.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : Z.at(0);
  ...
  const x = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(it, { children: [
...
function ow({
  ...
  return /* @__PURE__ */ u(Pr, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Lr, { children: c.length > 0 && c.map((s) => /* @__PURE__ */ u(
      re,
      {
        onClick: () => {
          e(s.reference);
...
const nw = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ u($n, { value: c, variant: "outline", type: "single", className: "tw:gap-0", children: [
      /* @__PURE__ */ a(
        yr,
        {
          onClick: (l) => {
            l.stopPropagation(), Qr(
              [s],
              "approved",
              e,
              r,
...
function gp({
  ...
  }, [A, H]), U = L(() => S.length === 0 ? [] : cw(S, T, I), [S, T, I]), V = L(() => {
    var ct, gt;
    if (!A) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ue, { onValueChange: (K) => Mt(K), defaultValue: c, children: [
...
const Gn = cr(({ className: t, ...e }, r) => /* @__PURE__ */ a(ns, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function fp({
  ...
  const [c, s] = R(""), [l, d] = R([]), w = L(
    () => t.filter((M) => !r || M.type === r).filter((M) => ww(M, c)).filter(
  ...
  }, [l, C, P, n]), G = c.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(it, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      y && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: z }),
      e && /* @__PURE__ */ a(Gn, {}),
...
function gw({
  ...
  const [l, d] = ot.useState(t), w = e ?? l, g = ot.useCallback(
    ...
    [r, w]
  ), h = ot.useCallback(() => g((N) => !N), [g]), p = w ? "expanded" : "collapsed", v = lt() === "ltr" ? c : c === "primary" ? "secondary" : "primary", C = ot.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
...
function yw({
  ...
  const s = t ? ke.Root : "button", { state: l } = jr(), d = /* @__PURE__ */ a(
    s,
    {
  ...
  return /* @__PURE__ */ a(
    hw,
    {
      ...
      children: /* @__PURE__ */ u(mw, { children: [
        ...
        /* @__PURE__ */ u(Co, { children: [
          /* @__PURE__ */ a(Eo, { className: "tw:text-sm", children: c }),
                    ...
                    children: F.getIsGrouped() ? /* @__PURE__ */ u(
                      j,
                      {
                        ...
                        children: [
                          ...
                          !T.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ a(ss, {}) : /* @__PURE__ */ a(cs, {})),
                          " ",
...
function Dw({
  ...
  const i = Ba(e, t).length === 0, c = n["%scripture_section_ot_short%"], s = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    j,
    {
      variant: "outline",
...
function Rw({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], s = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: h, ntLong: p, dcLong: m, extraLong: b } = {
            ...
            Ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: F, children: l }),
                  ...
                  Object.values(J).map((M, H) => {
                    ...
                    if (S.length !== 0)
                      return /* @__PURE__ */ u(ka, { children: [
                        ...
                        H < Object.values(J).length - 1 && /* @__PURE__ */ a(cn, {})
                      ] }, M);
                  })
                ] })
              ]
...
function $p({
  ...
  const d = ze(
    ...
    c,
    "%webView_scope_selector_current_chapter%"
  ), h = ze(c, "%webView_scope_selector_current_book%"), p = ze(c, "%webView_scope_selector_choose_books%"), m = ze(c, "%webView_scope_selector_scope%"), b = ze(c, "%webView_scope_selector_select_books%"), v = [
...
).sort(([, i], [, c]) => i.order - c.order).flatMap(([i]) => e.filter((s) => s.group === i).sort((s, l) => s.order - l.order).map((s) => /* @__PURE__ */ u(Ct, { children: [
...
function ba({
  ...
  return /* @__PURE__ */ u(ve, { variant: i, children: [
    /* @__PURE__ */ a(be, { "aria-label": r, className: n, asChild: !0, id: s, children: /* @__PURE__ */ a(j, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(ls, {}) }) }),
    /* @__PURE__ */ a(xe, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ka, { children: [
      /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Nt, { children: Jn(e.groups, e.items, l, t) }) }),
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], c) => {
    ...
    return s.length > 0 && c < n.length - 1 && l.push(/* @__PURE__ */ a(Vw, {}, `separator-${i}`)), l;
  });
};
function Uw({
  menuData: t,
  ...
  if (mc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (b = c.current) == null || b.focus(), Ze(c, [h, p]);
        break;
      case "alt+n":
        (v = s.current) == null || v.focus(), Ze(s, [h, p]);
        break;
      case "alt+h":
        (C = l.current) == null || C.focus(), Ze(l, [h, p]);
        break;
    }
  }), X(() => {
