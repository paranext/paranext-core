...
import c, { forwardRef as Ut, useCallback as tt, useState as B, useRef as Z, useEffect as lt, useLayoutEffect as je, useMemo as Q, Fragment as Un } from "react";
...
import { useReactTable as Ke, getFilteredRowModel as Sr, getSortedRowModel as We, getPaginationRowModel as Rr, getCoreRowModel as Ze, flexRender as Ot, getGroupedRowModel as Tr, getExpandedRowModel as _r } from "@tanstack/react-table";
...
const Kt = I.Root, Ne = I.Trigger, en = I.Group, Br = I.Portal, Or = I.Sub, Ko = I.RadioGroup, nn = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  I.SubTrigger,
  {
    ref: o,
    className: l(
...
nn.displayName = I.SubTrigger.displayName;
const rn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  I.SubContent,
  {
    ref: n,
    className: l(
...
rn.displayName = I.SubContent.displayName;
...
Ft.displayName = I.Content.displayName;
...
ke.displayName = I.Item.displayName;
const Ce = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ d(
  I.CheckboxItem,
  {
    ref: o,
    className: l(
    ...
    ...a,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(I.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Ce.displayName = I.CheckboxItem.displayName;
const an = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  I.RadioItem,
  {
    ref: a,
    className: l(
...
an.displayName = I.RadioItem.displayName;
...
Gt.displayName = I.Separator.displayName;
...
var Pr = Object.defineProperty, Xr = (t, e, n) => e in t ? Pr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, S = (t, e, n) => Xr(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
const H = class T {
    ...
    if (S(this, "firstChapter"), S(this, "lastChapter"), S(this, "lastVerse"), S(this, "hasSegmentsDefined"), S(this, "text"), S(this, "BBBCCCVVVS"), S(this, "longHashCode"), S(this, "versification"), S(this, "rtlMark", "‏"), S(this, "_bookNum", 0), S(this, "_chapterNum", 0), S(this, "_verseNum", 0), S(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof T) {
          ...
          if (e == null) return;
          const i = e instanceof pt ? e : T.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return w && (p = new pt(w)), n ? new T(n, a.toString(), s, p) : new T();
  }
  /**
...
const _e = D.allBookIds.filter((t) => !D.isObsolete(D.bookIdToNumber(t))), Zr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], Qr = 96, ta = [
...
function Zo({
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, v] = B(!1), [x, y] = B(h), N = Z(void 0), k = Z(void 0), A = Z(void 0), j = tt(
    ...
    ta.forEach((C) => {
      const z = i.match(C);
      if (z) {
        const [O, G = void 0, F = void 0] = z.slice(1), Mt = ra(O);
        (D.isBookIdValid(O) || Mt) && b(
          Mt ?? O,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
  ...
  return lt(() => {
    ...
    const C = setTimeout(() => {
      if (x && k.current && A.current) {
        const O = A.current.offsetTop - Qr;
  ...
  }, [x]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ d(Kt, { modal: !1, open: h, onOpenChange: zt, children: [
    ...
    /* @__PURE__ */ r(
      Ft,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((C, z) => {
          const O = j(C);
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Wt, { className: "tw-font-semibold tw-text-foreground/80", children: Zr[C] }),
            ...
            $e.length - 1 !== z ? /* @__PURE__ */ r(Gt, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Je.Root, { ref: n, className: l("pr-twp", oa(), t), ...e }));
Y.displayName = Je.Root.displayName;
...
pn.displayName = At.Root.displayName;
...
const un = Pt.Root, mn = Pt.Trigger, ze = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const i = $();
...
ze.displayName = Pt.Content.displayName;
const sa = nt.Portal, hn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Overlay,
  {
    ref: n,
    className: l(
...
hn.displayName = nt.Overlay.displayName;
...
ia.displayName = nt.Content.displayName;
...
wa.displayName = nt.Title.displayName;
...
la.displayName = nt.Description.displayName;
...
Me.displayName = U.Input.displayName;
...
const Ve = c.forwardRef((t, e) => /* @__PURE__ */ r(U.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
gn.displayName = U.Group.displayName;
...
da.displayName = U.Separator.displayName;
...
De.displayName = U.Item.displayName;
function ca(t) {
...
function me({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ d(un, { open: y, onOpenChange: N, ...x, children: [
...
function ma({ table: t }) {
  return /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(Kn, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const xt = X.Root, ha = X.Group, yt = X.Value, ht = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
  return /* @__PURE__ */ d(
    X.Trigger,
    {
...
ga.displayName = X.Label.displayName;
...
fa.displayName = X.Separator.displayName;
function ba({ table: t }) {
...
function ya({
  ...
  var y;
  const [s, p] = B([]), [u, m] = B([]), [f, g] = B({}), [h, v] = B({}), x = Ke({
    data: e,
    columns: t,
    getCoreRowModel: Ze(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ma, { table: x }),
    /* @__PURE__ */ d(Zt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Qt, { stickyHeader: i, children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(wt, { children: N.headers.map((k) => /* @__PURE__ */ r(Xt, { children: k.isPlaceholder ? void 0 : Ot(k.column.columnDef.header, k.getContext()) }, k.id)) }, N.id)) }),
    ...
    n && a && /* @__PURE__ */ r(ba, { table: x })
  ] });
}
const $t = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(rr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
var ka = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(ka || {});
function ss({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(Na, {}) }),
...
function Ca({ id: t, versionHistory: e }) {
...
function ls({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Ca, { versionHistory: o }),
...
const Sa = ft(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", Sa({ variant: e }), t), ...n })
);
...
function Ra({
  ...
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(un, { open: m, onOpenChange: f, children: [
    /* @__PURE__ */ r(mn, { asChild: !0, children: /* @__PURE__ */ d(
      M,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ze, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Ee, { children: [
      ...
      /* @__PURE__ */ d(Ie, { children: [
        ...
        /* @__PURE__ */ r(gn, { children: v.map((x) => {
          ...
          return /* @__PURE__ */ d(
            De,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: x.starred && /* @__PURE__ */ r(lr, { className: "tw-h-4 tw-w-4" }) }),
...
function Ta({
  ...
  return /* @__PURE__ */ d(Zt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Qt, { stickyHeader: !0, children: /* @__PURE__ */ d(wt, { children: [
...
Be.displayName = ce.Root.displayName;
const xn = ft(
...
_a.displayName = Qe.Root.displayName;
...
Nn.displayName = Jt.Root.displayName;
...
const ee = (t) => t === "asc" ? /* @__PURE__ */ r(ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), cs = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ia = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ms = Object.freeze([
  ...
  return Ea(t).forEach((m) => {
    m.startsWith("\\id") && (w = Ma(m), s = 0, p = 0), m.startsWith("\\c") && (s = Ye(m), p = 0), m.startsWith("\\v") && (p = Ye(m), s === 0 && (s = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const h = f.index, v = i.find((y) => ye(y.items, g)), x = {
        ...
        text: Cr(m, Math.max(0, h - 25), Math.min(h + 25, m.length))
      };
      if (v)
...
function hs({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, _] = B(""), [K, P] = B([]), Et = Q(() => s ? a instanceof RegExp ? Da(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), dt = Q(() => {
    if (j) return Et;
    const R = [];
    return Et.forEach((L) => {
      const st = L.items[0], ct = R.find(
        (vt) => vt.items[0] === st
      );
      ct ? (ct.count += L.count, ct.occurrences = ct.occurrences.concat(L.occurrences)) : R.push({
        items: [st],
        count: L.count,
  ...
  }, [j, Et]), C = Q(() => Va(dt, rt, b), [dt, rt, b]), z = Q(() => {
    var st, ct;
    if (!j) return m;
...
Oe.displayName = tn.Root.displayName;
...
const Ae = jt.Provider, Pe = jt.Root, Xe = jt.Trigger, ne = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  jt.Content,
  {
    ref: a,
    sideOffset: e,
...
ne.displayName = jt.Content.displayName;
const Ba = "16rem", Oa = "3rem", kn = c.createContext(void 0);
function re() {
...
const Aa = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = re();
  return /* @__PURE__ */ d(
    M,
    {
...
const Ya = ft(
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = re(), m = /* @__PURE__ */ r(
      p,
      {
        ref: s,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Xe, { asChild: !0, children: m }),
      /* @__PURE__ */ r(ne, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : m;
  }
);
En.displayName = "SidebarMenuButton";
const La = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? St : "button",
  {
    ref: o,
...
const Ka = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, i) => /* @__PURE__ */ r(
  t ? St : "a",
  {
    ref: i,
    ...
    Sn,
    {
      ...
      children: /* @__PURE__ */ d(Tn, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(_n, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(zn, { children: /* @__PURE__ */ r(
            En,
            {
              onClick: () => u(g),
              isActive: f(g),
...
const it = "scrBook", Za = "scrRef", ut = "source", Qa = "details", to = "Scripture Reference", eo = "Scripture Book", In = "Type", no = "Details";
function ro(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? D.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === it ? ae(o.start) : void 0;
      },
...
}, He = (t) => `${ao({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function fs({
  sources: t,
  ...
  lt(() => {
    if (s) {
      ...
      if (_.length === 1) {
        const K = v.find((P) => He(P) === _[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, v, s, y]);
  const N = o ?? eo, k = i ?? In, A = [
  ...
  }, rt = (b, _) => b.getIsGrouped() ? "" : l("banded-row", _ % 2 === 0 ? "even" : "odd"), zt = (b, _, K) => {
    ...
    !e && /* @__PURE__ */ d(
      xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(gt, { position: "item-aligned", children: /* @__PURE__ */ r(ha, { children: A.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Zt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Qt, { children: y.getHeaderGroups().map((b) => /* @__PURE__ */ r(wt, { children: b.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Xt, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(vr, {})),
                          " ",
...
const Dn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(nn, { children: s.label }),
    /* @__PURE__ */ r(Br, { children: /* @__PURE__ */ r(rn, { children: Dn(
      t,
      e,
      Vn(t, s.id),
      a
...
function Ns({
  ...
  return /* @__PURE__ */ d(Kt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, s]) => typeof w == "boolean" || typeof s == "boolean" ? 0 : w.order - s.order).map(([w], s, p) => /* @__PURE__ */ d(Un, { children: [
      /* @__PURE__ */ r(en, { children: /* @__PURE__ */ r(Ae, { children: Dn(e.groups, e.items, w, t) }) }),
...
function ks({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Bn, { children: [
      /* @__PURE__ */ r(On, { children: t.map((w) => /* @__PURE__ */ r(oo, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(An, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
const Pn = c.createContext(void 0);
function bt() {
  const t = c.useContext(Pn);
  if (!t)
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([i], w) => {
    const s = e.filter((u) => u.group === i).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ d(Pe, { children: [
...
function po({
  ...
  if (Er(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    return /* @__PURE__ */ r(Xn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(so, { children: [
...
_o.displayName = Bt.Root.displayName;
...
zo.displayName = pe.Root.displayName;
...
export {
  ...
  l as cn,
  Ma as getBookIdFromUSFM,
  Ea as getLinesFromUSFM,
