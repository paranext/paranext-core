import cs, { jsxs as de, jsx as x, Fragment as Hn } from "react/jsx-runtime";
import * as k from "react";
import me, { forwardRef as Si, useCallback as Pe, useState as Ee, useRef as gt, useEffect as Ft, useLayoutEffect as ko, useMemo as hn } from "react";
import { getChaptersForBook as Ci, offsetBook as To, FIRST_SCR_BOOK_NUM as ps, offsetChapter as Oo, FIRST_SCR_CHAPTER_NUM as us, offsetVerse as So, FIRST_SCR_VERSE_NUM as ds } from "platform-bible-utils";
import * as fe from "@radix-ui/react-dropdown-menu";
import { ChevronRight as fs, Check as hs, Circle as ms, History as gs, ArrowDownWideNarrow as bs, Clock as vs, Bookmark as ys } from "lucide-react";
import ke, { clsx as ws } from "clsx";
...
import { Autocomplete as ks, TextField as Ts, FormControlLabel as Co, FormLabel as Os, Checkbox as Ss, MenuItem as Cs, ListItemText as Ns, ListItemIcon as Pi, Menu as Ps, Grid as Ri, List as Rs, IconButton as $i, Drawer as $s, Slider as Ms, Snackbar as Is, Switch as _s, AppBar as As, Toolbar as Ds } from "@mui/material";
...
const tl = fe.Root, nl = fe.Trigger, zh = fe.Group, Uh = fe.Portal, Hh = fe.Sub, Wh = fe.RadioGroup, rl = me.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  fe.SubTrigger,
  {
    ref: o,
    className: ue(
    ...
    children: [
      n,
      /* @__PURE__ */ x(fs, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
rl.displayName = fe.SubTrigger.displayName;
const ol = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  fe.SubContent,
  {
    ref: n,
    className: ue(
...
ol.displayName = fe.SubContent.displayName;
const Li = me.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ x(fe.Portal, { children: /* @__PURE__ */ x(
  fe.Content,
  {
    ref: r,
    sideOffset: t,
...
const Fi = me.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ x(
  fe.Item,
  {
    ref: r,
    className: ue(
...
const il = me.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  fe.CheckboxItem,
  {
    ref: o,
    className: ue(
    ...
    ...r,
    children: [
      /* @__PURE__ */ x("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ x(fe.ItemIndicator, { children: /* @__PURE__ */ x(hs, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
il.displayName = fe.CheckboxItem.displayName;
const al = me.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  fe.RadioItem,
  {
    ref: r,
    className: ue(
    ...
    ...n,
    children: [
      /* @__PURE__ */ x("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ x(fe.ItemIndicator, { children: /* @__PURE__ */ x(ms, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
al.displayName = fe.RadioItem.displayName;
const Lr = me.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ x(
  fe.Label,
  {
    ref: r,
    className: ue("pr-px-2 pr-py-1.5 pr-text-sm pr-font-semibold", t && "pr-pl-8", e),
    ...n
  }
));
Lr.displayName = fe.Label.displayName;
const Vi = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  fe.Separator,
  {
    ref: n,
    className: ue("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
    ...t
  }
));
...
function sl({ className: e, ...t }) {
  return /* @__PURE__ */ x(
    "span",
    {
      className: ue("pr-ml-auto pr-text-xs pr-tracking-widest pr-opacity-60", e),
      ...t
    }
  );
}
sl.displayName = "DropdownMenuShortcut";
...
function cl({
  ...
  return /* @__PURE__ */ x("div", { className: ue("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: i.map((l) => /* @__PURE__ */ x(
    "div",
    {
      className: ue(
...
const pl = Si(
  ({
    ...
    Fi,
    {
      ref: l,
      textValue: e,
      className: ue("pr-font-normal pr-text-slate-700", {
...
function ul({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ de(Lr, { className: "pr-flex pr-justify-between", children: [
...
const rn = ce.allBookIds, dl = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ro = ["OT", "NT", "DC"], fl = 32 + 32 + 32, hl = [
  /^(\w+)$/i,
...
function qh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, i] = Ee(
    ...
    ce.bookNumberToId(e.bookNum)
  ), [u, f] = Ee(!1), [d, g] = Ee(u), v = gt(void 0), b = gt(void 0), h = gt(void 0), E = Pe(
    (C) => ml(C).filter((R) => {
    ...
    hl.forEach((C) => {
      const R = n.match(C);
      if (R) {
        const [$, j = void 0, D = void 0] = R.slice(1), M = vl($);
    ...
    (C) => {
      ...
      // eslint-disable-next-line no-null/no-null
      b.current !== null && b.current.focus(), C.preventDefault()) : f(!0);
    },
    [u]
  ), B = (C) => {
    const { key: R } = C;
  ...
  }, [d]), /* @__PURE__ */ x("div", { className: "pr-flex", children: /* @__PURE__ */ de(tl, { modal: !1, open: u, onOpenChange: w, children: [
    /* @__PURE__ */ x(nl, { asChild: !0, children: /* @__PURE__ */ x(
      ll,
      {
        ref: v,
        value: n,
    ...
    /* @__PURE__ */ de(
      Li,
      {
        ...
        children: [
          ...
          Ro.map(
            (C, R) => E(C).length > 0 && /* @__PURE__ */ de("div", { children: [
              /* @__PURE__ */ x(Lr, { className: "pr-font-semibold pr-text-slate-700", children: dl[C] }),
              ...
              Ro.length - 1 !== R ? /* @__PURE__ */ x(Vi, {}) : void 0
            ] }, C)
          )
        ]
      }
...
const yl = Ni(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ x(r ? Es : "button", { className: ue(yl({ variant: t, size: n, className: e })), ref: i, ...o })
);
...
function Xh({
  ...
  return /* @__PURE__ */ de(Hn, { children: [
    /* @__PURE__ */ x(
      Co,
      {
...
function zi({
  ...
  let f;
  if (n) {
    const d = r === $t.Before || r === $t.Above, g = /* @__PURE__ */ x("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === $t.Before || r === $t.After, b = v ? g : /* @__PURE__ */ x("div", { children: g }), h = v ? u : /* @__PURE__ */ x("div", { children: u });
    f = /* @__PURE__ */ de(
      Os,
      {
...
function El() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = p, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = u, ie.Fragment = r, ie.Lazy = v, ie.Memo = g, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    return w(m) || y(m) === c;
...
function kl() {
  return Mo || (Mo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = c, S = p, N = l, L = s, B = t, F = u, C = r, R = v, $ = g, j = n, D = i, M = o, V = f, Q = !1;
    function Z(_) {
...
var Io;
function Ui() {
  return Io || (Io = 1, process.env.NODE_ENV === "production" ? Sn.exports = El() : Sn.exports = kl()), Sn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Sl() {
  if (Bo)
    return dr;
  Bo = 1;
  var e = Ui(), t = Tl(), n = Vr(), r = Hi(), o = Ol(), i = function() {
  };
  ...
  return dr = function(l, c) {
    ...
    function h(O) {
      ...
      function G(H, q, X, W, Y, K, ne) {
        ...
        return q[X] == null ? H ? q[X] === null ? new b("The " + Y + " `" + K + "` is marked as required " + ("in `" + W + "`, but its value is `null`.")) : new b("The " + Y + " `" + K + "` is marked as required in " + ("`" + W + "`, but its value is `undefined`.")) : null : O(q, X, W, Y, K);
      }
      var z = G.bind(null, !1);
    ...
    function w() {
      function O(A, U, G, z, H) {
        ...
        if (!l(q)) {
          var X = M(q);
          return new b("Invalid " + z + " `" + H + "` of type " + ("`" + X + "` supplied to `" + G + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(O);
    ...
    function m() {
      function O(A, U, G, z, H) {
        ...
        if (!e.isValidElementType(q)) {
          var X = M(q);
          return new b("Invalid " + z + " `" + H + "` of type " + ("`" + X + "` supplied to `" + G + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(O);
    ...
    function N(O) {
      ...
      function A(U, G, z, H, q) {
        ...
        return new b("Invalid " + H + " `" + q + "` of value `" + String(X) + "` " + ("supplied to `" + z + "`, expected one of " + Y + "."));
      }
      return h(A);
    }
    function L(O) {
    ...
    function F() {
      function O(A, U, G, z, H) {
        return j(A[U]) ? null : new b("Invalid " + z + " `" + H + "` supplied to " + ("`" + G + "`, expected a ReactNode."));
      }
      return h(O);
    }
...
function Ze(e, t, n = {
  ...
  return mt(e) && mt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (mt(t[o]) && o in e && mt(e[o]) ? r[o] = Ze(e[o], t[o], n) : n.clone ? r[o] = mt(t[o]) ? Wi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function $l(e) {
  const {
...
const Xi = zt(a.element, qi);
Xi.isRequired = zt(a.element.isRequired, qi);
const mn = Xi;
function Ml(e) {
  const {
    prototype: t = {}
...
const _l = zt(a.elementType, Il), Al = "exact-prop: ​";
function Gi(e) {
...
function jl() {
  return Vo || (Vo = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), p = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, b = !1, h = !1, E = !1, I = !1, y;
...
process.env.NODE_ENV === "production" ? Or.exports = Dl() : Or.exports = jl();
var An = Or.exports;
...
const Vl = a.oneOfType([a.func, a.object]), zr = Vl;
function qe(e) {
  if (typeof e != "string")
...
const Wl = typeof window < "u" ? k.useLayoutEffect : k.useEffect, yt = Wl;
let Uo = 0;
function ql(e) {
...
function en() {
  const e = Gl(gn.create).current;
  return Kl(e.disposeEffect), e;
}
let Wn = !0, Cr = !1;
const Jl = new gn(), Zl = {
  text: !0,
...
function nc(e) {
  e.addEventListener("keydown", ec, !0), e.addEventListener("mousedown", hr, !0), e.addEventListener("pointerdown", hr, !0), e.addEventListener("touchstart", hr, !0), e.addEventListener("visibilitychange", tc, !0);
}
function rc(e) {
  const {
    target: t
...
function Qi() {
  ...
  function n() {
    return t.current ? (Cr = !0, Jl.start(100, () => {
      Cr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
function na(e, t, ...n) {
  return e[t] === void 0 ? null : ta(e, t, ...n);
}
function Nr() {
  return null;
}
na.isRequired = ta;
Nr.isRequired = Nr;
const ra = process.env.NODE_ENV === "production" ? Nr : na;
function oa(e, t) {
  const n = T({}, t);
...
function tn(e, t, n) {
  return e === void 0 || sa(e) ? t : T({}, t, {
    ownerState: T({}, t.ownerState, n)
  });
}
const pc = {
  disableDefaultClasses: !1
}, uc = /* @__PURE__ */ k.createContext(pc);
function dc(e) {
  const {
...
function hc(e) {
  ...
  const s = la(T({}, o, r)), l = Xo(r), c = Xo(o), p = t(s), u = ke(p == null ? void 0 : p.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = T({}, p == null ? void 0 : p.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = T({}, p, n, c, l);
...
`)), v.current.setAttribute("tabIndex", "-1")), g.current && v.current.focus()), () => {
  ...
  const E = (y) => {
    f.current === null && (f.current = y.relatedTarget), g.current = !0, d.current = y.target;
...
process.env.NODE_ENV !== "production" && (jn["propTypes"] = Gi(jn.propTypes));
function Oc(e) {
...
process.env.NODE_ENV !== "production" && (pn["propTypes"] = Gi(pn.propTypes));
function Sc(e) {
  const t = Te(e);
...
function _c(e) {
  const {
    ...
    open: u,
    rootRef: f
  } = e, d = k.useRef({}), g = k.useRef(null), v = k.useRef(null), b = Ve(v, f), [h, E] = k.useState(!u), I = Mc(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const w = () => Te(g.current), m = () => (d.current.modalRef = v.current, d.current.mount = g.current, d.current), S = () => {
    o.mount(m(), {
      disableScrollLock: r
    ...
    g.current = M, M && (u && L() ? S() : v.current && on(v.current, y));
  }), F = k.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  k.useEffect(() => () => {
...
var Re = "top", ze = "bottom", Ue = "right", $e = "left", Ur = "auto", bn = [Re, ze, Ue, $e], Dt = "start", un = "end", Ac = "clippingParents", ua = "viewport", Kt = "popper", Dc = "reference", Ko = /* @__PURE__ */ bn.reduce(function(e, t) {
  return e.concat([t + "-" + Dt, t + "-" + un]);
}, []), da = /* @__PURE__ */ [].concat(bn, [Ur]).reduce(function(e, t) {
...
var bt = Math.max, Bn = Math.min, jt = Math.round;
function Pr() {
...
function Bt(e, t, n) {
  ...
  var s = xt(e) ? je(e) : window, l = s.visualViewport, c = !fa() && n, p = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, d = r.height / i;
  return {
    width: f,
    height: d,
    top: u,
...
function vn(e) {
  for (var t = je(e), n = Jo(e); n && Kc(n) && et(n).position === "static"; )
    n = Jo(n);
  return n && (Xe(n) === "html" || Xe(n) === "body" && et(n).position === "static") ? t : n || Jc(e) || t;
}
function qr(e) {
...
var Qc = function(t, n) {
  ...
  })) : t, ga(typeof t != "number" ? t : ba(t, bn));
};
function ep(e) {
  ...
  if (!(!i || !s)) {
    var f = Qc(o.padding, n), d = Wr(i), g = c === "y" ? Re : $e, v = c === "y" ? ze : Ue, b = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], E = vn(i), I = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = b / 2 - h / 2, w = f[g], m = I - d[u] - f[v], S = I / 2 - d[u] / 2 + y, N = an(w, S, m), L = c;
...
function Zo(e) {
  ...
  g = h.x, b = h.y;
  var E = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), y = $e, w = Re, m = window;
  if (p) {
  ...
  if (g = R.x, b = R.y, c) {
    var $;
    return Object.assign({}, C, ($ = {}, $[w] = I ? "0" : "", $[y] = E ? "0" : "", $.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + b + "px)" : "translate3d(" + g + "px, " + b + "px, 0)", $));
  }
  return Object.assign({}, C, (t = {}, t[w] = I ? b + "px" : "", t[y] = E ? g + "px" : "", t.transform = "", t));
}
function ip(e) {
...
function dp(e) {
  var t, n = lt(e), r = Xr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = bt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = bt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Gr(e), c = -r.scrollTop;
  return et(o || n).direction === "rtl" && (l += bt(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: s,
    x: l,
    y: c
...
function va(e) {
  return ["html", "body", "#document"].indexOf(Xe(e)) >= 0 ? e.ownerDocument.body : Fe(e) && Yr(e) ? e : va(qn(e));
}
function sn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = va(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = je(r), s = o ? [i].concat(i.visualViewport || [], Yr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function ei(e, t, n) {
  return t === ua ? Rr(up(e, n)) : xt(t) ? fp(t, n) : Rr(dp(lt(e)));
}
function hp(e) {
  var t = sn(qn(e)), n = ["absolute", "fixed"].indexOf(et(e).position) >= 0, r = n && Fe(e) ? vn(e) : e;
  return xt(r) ? t.filter(function(o) {
    return xt(o) && ha(o, r) && Xe(o) !== "body";
  }) : [];
}
function mp(e, t, n, r) {
  var o = t === "clippingParents" ? hp(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, p) {
    var u = ei(e, p, r);
    return c.top = bt(u.top, c.top), c.right = Bn(u.right, c.right), c.bottom = Bn(u.bottom, c.bottom), c.left = bt(u.left, c.left), c;
  }, ei(e, s, r));
...
function dn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Ac : l, p = n.rootBoundary, u = p === void 0 ? ua : p, f = n.elementContext, d = f === void 0 ? Kt : f, g = n.altBoundary, v = g === void 0 ? !1 : g, b = n.padding, h = b === void 0 ? 0 : b, E = ga(typeof h != "number" ? h : ba(h, bn)), I = d === Kt ? Dc : Kt, y = e.rects.popper, w = e.elements[v ? I : d], m = mp(xt(w) ? w : w.contextElement || lt(e.elements.popper), c, u, s), S = Bt(e.elements.reference), N = ya({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function gp(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, p = c === void 0 ? da : c, u = Lt(r), f = u ? l ? Ko : Ko.filter(function(v) {
    return Lt(v) === u;
...
function vp(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, p = n.padding, u = n.boundary, f = n.rootBoundary, d = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, b = n.allowedAutoPlacements, h = t.options.placement, E = We(h), I = E === h, y = c || (I || !v ? [$n(h)] : bp(h)), w = [h].concat(y).reduce(function(z, H) {
      return z.concat(We(H) === Ur ? gp(t, {
        placement: H,
        boundary: u,
        rootBoundary: f,
        padding: p,
    ...
    }, []), m = t.rects.reference, S = t.rects.popper, N = /* @__PURE__ */ new Map(), L = !0, B = w[0], F = 0; F < w.length; F++) {
      var C = w[F], R = We(C), $ = Lt(C) === Dt, j = [Re, ze].indexOf(R) >= 0, D = j ? "width" : "height", M = dn(t, {
        placement: C,
        boundary: u,
        rootBoundary: f,
        altBoundary: d,
...
function kp(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, i = o === void 0 ? [0, 0] : o, s = da.reduce(function(u, f) {
    return u[f] = Ep(f, t.rects, i), u;
...
function Np(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, p = n.rootBoundary, u = n.altBoundary, f = n.padding, d = n.tether, g = d === void 0 ? !0 : d, v = n.tetherOffset, b = v === void 0 ? 0 : v, h = dn(t, {
    boundary: c,
    rootBoundary: p,
    padding: f,
    altBoundary: u
  }), E = We(t.placement), I = Lt(t.placement), y = !I, w = qr(E), m = Cp(w), S = t.modifiersData.popperOffsets, N = t.rects.reference, L = t.rects.popper, B = typeof b == "function" ? b(Object.assign({}, t.rects, {
    placement: t.placement
  })) : b, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (S) {
    if (i) {
      var $, j = w === "y" ? Re : $e, D = w === "y" ? ze : Ue, M = w === "y" ? "height" : "width", V = S[w], Q = V + h[j], Z = V - h[D], O = g ? -L[M] / 2 : 0, A = I === Dt ? N[M] : L[M], U = I === Dt ? -L[M] : -N[M], G = t.elements.arrow, z = g && G ? Wr(G) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ma(), q = H[j], X = H[D], W = an(0, N[M], z[M]), Y = y ? N[M] / 2 - O - W - q - F.mainAxis : A - W - q - F.mainAxis, K = y ? -N[M] / 2 + O + W + X + F.mainAxis : U + W + X + F.mainAxis, ne = t.elements.arrow && vn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[w]) != null ? $ : 0, P = V + Y - J - _, re = V + K - J, we = an(g ? Bn(Q, P) : Q, V, g ? bt(Z, re) : Z);
      S[w] = we, R[w] = we - V;
    }
    if (l) {
      var Se, ve = w === "x" ? Re : $e, pt = w === "x" ? ze : Ue, Ce = S[m], Ye = m === "y" ? "height" : "width", Ie = Ce + h[ve], Ke = Ce - h[pt], xe = [Re, $e].indexOf(E) !== -1, kt = (Se = C == null ? void 0 : C[m]) != null ? Se : 0, ut = xe ? Ie : Ce - N[Ye] - L[Ye] - kt + F.altAxis, Ut = xe ? Ce + N[Ye] + L[Ye] - kt - F.altAxis : Ke, En = g && xe ? Zc(ut, Ce, Ut) : an(g ? ut : Ie, Ce, g ? Ut : Ke);
      S[m] = En, R[m] = En - Ce;
    }
    t.modifiersData[r] = R;
  }
...
function Ip(e, t, n) {
  n === void 0 && (n = !1);
  var r = Fe(t), o = Fe(t) && Mp(t), i = lt(t), s = Bt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Yr(i)) && (l = $p(t)), Fe(t) ? (c = Bt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Gr(i))), {
    ...
    var u = {
      ...
      setOptions: function(E) {
        ...
        b(), u.options = Object.assign({}, i, u.options, I), u.scrollParents = {
          reference: xt(l) ? sn(l) : l.contextElement ? sn(l.contextElement) : [],
          popper: sn(c)
        };
        var y = Ap(jp([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!d) {
          ...
          if (oi(I, y)) {
            u.rects = {
              reference: Ip(I, vn(y), u.options.strategy === "fixed"),
              popper: Wr(y)
            ...
            for (var w = 0; w < u.orderedModifiers.length; w++) {
              ...
              var m = u.orderedModifiers[w], S = m.fn, N = m.options, L = N === void 0 ? {} : N, B = m.name;
...
var Lp = [lp, Sp, ap, Yc, Tp, yp, Pp, np, xp], Fp = /* @__PURE__ */ Bp({
  defaultModifiers: Lp
});
const wa = "Popper";
function Vp(e) {
...
vc(wa, ["root"]);
const zp = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Up = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Hp(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const qp = () => nt({
  root: ["root"]
}, dc(Vp)), Xp = {}, Gp = /* @__PURE__ */ k.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, h = pe(t, zp), E = k.useRef(null), I = Ve(E, n), y = k.useRef(null), w = Ve(y, d), m = k.useRef(w);
  yt(() => {
    m.current = w;
  }, [w]), k.useImperativeHandle(d, () => y.current, []);
  const S = Hp(u, s), [N, L] = k.useState(S), [B, F] = k.useState(Ln(o));
  k.useEffect(() => {
...
`));
  ...
  b !== null && (C.TransitionProps = b);
  const R = qp(), $ = (r = v.root) != null ? r : "div", j = wt({
    elementType: $,
  ...
  const {
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, I = pe(t, Up), [y, w] = k.useState(!0), m = () => {
    w(!1);
  }, S = () => {
    w(!0);
  };
  ...
  const L = !u && c && (!b || y) ? "none" : void 0, B = b ? {
    in: u,
    onEnter: m,
    onExited: S
  } : void 0;
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || Wp(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const Yp = ["values", "unit", "step"], Kp = (e) => {
...
function Jp(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = pe(e, Yp), i = Kp(t), s = Object.keys(i);
  function l(d) {
...
const Zp = {
  borderRadius: 4
}, Qp = Zp, eu = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, ct = eu;
function ln(e, t) {
  return t ? Ze(e, t, {
    clone: !1
...
function cu(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = au(n), i = lu(o, r), s = e[n];
  return tt(e, s, i);
}
function ka(e, t) {
  const n = Ea(e.theme);
  return Object.keys(e).map((r) => cu(e, t, r, n)).reduce(ln, {});
}
function ge(e) {
  return ka(e, Yn);
}
...
be.filterProps = Kn;
process.env.NODE_ENV !== "production" && su.reduce((e, t) => (e[t] = ct, e), {});
function pu(e = 8) {
  if (e.mui)
    return e;
  const t = Ea({
...
const uu = He("border", Le), du = He("borderTop", Le), fu = He("borderRight", Le), hu = He("borderBottom", Le), mu = He("borderLeft", Le), gu = He("borderColor"), bu = He("borderTopColor"), vu = He("borderRightColor"), yu = He("borderBottomColor"), wu = He("borderLeftColor"), xu = He("outline", Le), Eu = He("outlineColor"), Zn = (e) => {
...
Jn(uu, du, fu, hu, mu, gu, bu, vu, yu, wu, Zn, xu, Eu);
const Qn = (e) => {
...
Jn(Qn, er, tr, ku, Tu, Ou, Su, Cu, Nu, Pu, Ru, $u);
function It(e, t) {
  return t === "grey" ? t : e;
}
const Mu = ye({
...
function Hu() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : tt(s, r, (v) => {
      let b = Fn(d, u, v);
      return v === b && typeof v == "string" && (b = Fn(d, u, `${n}${v === "default" ? "" : qe(v)}`, v)), c === !1 ? b : {
        [c]: b
      };
    });
  }
  function t(n) {
    ...
    function l(c) {
      ...
      if (!p)
        return null;
      const u = tu(i.breakpoints), f = Object.keys(u);
      let d = u;
...
function eo(e = {}, ...t) {
  ...
  return p.applyStyles = Wu, p = t.reduce((u, f) => Ze(u, f), p), p.unstable_sxConfig = T({}, Zr, s == null ? void 0 : s.unstable_sxConfig), p.unstable_sx = function(f) {
    return Qr({
      sx: f,
      theme: this
    });
...
const Yu = ["ownerState"], Ku = ["variants"], Ju = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Zu(e) {
  return Object.keys(e).length === 0;
}
function Qu(e) {
...
const ed = eo(), si = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Nn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function nd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: d = td(si(p))
    } = l, g = pe(l, Ju), v = u !== void 0 ? u : (
    ...
    let E = Mn;
    p === "Root" || p === "root" ? E = r : p ? E = o : Qu(s) && (E = void 0);
    const I = js(s, T({
      shouldForwardProp: E,
      label: h
    }, g)), y = (m) => typeof m == "function" && m.__emotion_real !== m || mt(m) ? (S) => In(m, T({}, S, {
      theme: Nn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${qe(p || "")}`), C === void 0 && (C = `Styled(${Fl(s)})`), F.displayName = C;
      }
...
function li(e) {
  e = Et(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Et(ad(e)).values : e.values;
...
function Vn(e, t) {
  return e = Et(e), t = to(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, nr(e);
}
function sd(e, t) {
  if (e = Et(e), t = to(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const pd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Nt = vd, yd = ["mode", "contrastThreshold", "tonalOffset"], pi = {
...
function Sd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = pe(e, yd), i = e.primary || wd(t), s = e.secondary || xd(t), l = e.error || Ed(t), c = e.info || kd(t), p = e.success || Td(t), u = e.warning || Od(t);
  function f(b) {
    const h = ci(b, gr.text.primary) >= n ? gr.text.primary : pi.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ci(b, h);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return ui(b, "light", I, r), ui(b, "dark", y, r), b.contrastText || (b.contrastText = f(b.main)), b;
  }, g = {
    dark: gr,
    light: pi
  };
  return process.env.NODE_ENV !== "production" && (g[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), Ze(T({
...
function Pd(e, t) {
  ...
  const g = o / 14, v = f || ((E) => `${E / p * g}rem`), b = (E, I, y, w, m) => T({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(I),
    ...
    button: b(l, 14, 1.75, 0.4, di),
    caption: b(s, 12, 1.66, 0.4),
    overline: b(s, 12, 2.66, 1, di),
...
const Id = ["none", he(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), he(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), he(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), he(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), he(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), he(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), he(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), he(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), he(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), he(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), he(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), he(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), he(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), he(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), he(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), he(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), he(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), he(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), he(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), he(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), he(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), he(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), he(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), he(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], _d = Id, Ad = ["duration", "easing", "delay"], Dd = {
...
function Ld(e) {
  const t = T({}, Dd, e.easing), n = T({}, jd, e.duration);
  return T({
...
const Hd = Ud(), no = Hd, ro = "$$material", Ca = (e) => Mn(e) && e !== "classes", Wd = nd({
  themeId: ro,
  defaultTheme: no,
...
var Xd = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.shape({
  enter: a.number,
  exit: a.number,
  appear: a.number
}).isRequired]) : null;
...
const Na = me.createContext(null);
var Gd = function(t) {
  return t.scrollTop;
}, nn = "unmounted", ft = "exited", ht = "entering", Mt = "entered", Mr = "exiting", ot = /* @__PURE__ */ function(e) {
  qd(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = ft, i.appearStatus = ht) : c = Mt : r.unmountOnExit || r.mountOnEnter ? c = nn : c = ft, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ht && s !== Mt && (i = ht) : (s === ht || s === Mt) && (i = Mr);
    }
    ...
    return (
      ...
      /* @__PURE__ */ me.createElement(Na.Provider, {
        value: null
...
const Yd = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function Ir(e) {
  return `scale(${e}, ${e ** 2})`;
}
const Kd = {
  ...
  const {
  ...
  } = t, E = pe(t, Yd), I = en(), y = k.useRef(), w = xn(), m = k.useRef(null), S = Ve(m, i.ref, n), N = (D) => (M) => {
    if (D) {
      const V = m.current;
      M === void 0 ? D(V) : D(V, M);
    }
    ...
    let O;
    b === "auto" ? (O = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = O) : O = V, D.style.transition = [w.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Z;
    b === "auto" ? (Z = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = Z) : Z = M, D.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: V
    }), w.transitions.create("transform", {
  ...
  return /* @__PURE__ */ x(h, T({
    ...
    onExiting: C,
    addEndListener: (D) => {
      b === "auto" && I.start(y.current || 0, D), r && r(m.current, D);
    },
...
const _r = oo, Jd = (e) => {
...
}, gi = Jd, Zd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qd = Oe(xa, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Oa(), i = rt({
    ...
    slots: y,
    slotProps: w
  } = i, m = pe(i, Zd), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, N = T({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: d,
...
const tf = st("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), at = tf, nf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function rf(e) {
  return Math.round(e * 1e5) / 1e5;
}
const of = (e) => {
...
const Ia = /* @__PURE__ */ k.forwardRef(function(t, n) {
  var r, o, i, s, l, c, p, u, f, d, g, v, b, h, E, I, y, w, m;
  const S = rt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = S, P = pe(S, nf), re = /* @__PURE__ */ k.isValidElement(L) ? L : /* @__PURE__ */ x("span", {
    children: L
  }), we = xn(), Se = we.direction === "rtl", [ve, pt] = k.useState(), [Ce, Ye] = k.useState(null), Ie = k.useRef(!1), Ke = j || Z, xe = en(), kt = en(), ut = en(), Ut = en(), [En, lo] = Zi({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const rr = Ji(O), Ht = k.useRef(), kn = cn(() => {
  ...
  const co = (ee) => {
    ...
    Ie.current && ee.type !== "touchstart" || (ve && ve.removeAttribute("title"), kt.clear(), ut.clear(), M || Pn && V ? kt.start(Pn ? V : M, () => {
      co(ee);
    }) : co(ee));
  }, po = (ee) => {
    kt.clear(), ut.start(A, () => {
    ...
    onFocus: Za,
    ref: Qa
  } = Qi(), [, fo] = k.useState(!1), ho = (ee) => {
    Ja(ee), uo.current === !1 && (fo(!1), po(ee));
  }, mo = (ee) => {
    ve || pt(ee.currentTarget), Za(ee), uo.current === !0 && (fo(!0), or(ee));
  }, go = (ee) => {
    Ie.current = !0;
    const _e = re.props;
  ...
  const ns = Ve(re.ref, Qa, pt, n);
  !ne && ne !== 0 && (Je = !1);
  const ir = k.useRef(), rs = (ee) => {
    const _e = re.props;
...
`));
  const os = k.useMemo(() => {
    ...
    touch: Ie.current
  }), sr = of(Xt), yo = (r = (o = K.popper) != null ? o : B.Popper) != null ? r : af, wo = (i = (s = (l = K.transition) != null ? l : B.Transition) != null ? s : _) != null ? i : _r, xo = (c = (p = K.tooltip) != null ? p : B.Tooltip) != null ? c : sf, Eo = (u = (f = K.arrow) != null ? f : B.Arrow) != null ? u : lf, is = tn(yo, T({}, W, (d = Y.popper) != null ? d : F.popper, {
    className: ke(sr.popper, W == null ? void 0 : W.className, (g = (v = Y.popper) != null ? v : F.popper) == null ? void 0 : g.className)
  }), Xt), as = tn(wo, T({}, J, (b = Y.transition) != null ? b : F.transition), Xt), ss = tn(xo, T({}, (h = Y.tooltip) != null ? h : F.tooltip, {
    className: ke(sr.tooltip, (E = (I = Y.tooltip) != null ? I : F.tooltip) == null ? void 0 : E.className)
  }), Xt), ls = tn(Eo, T({}, (y = Y.arrow) != null ? y : F.arrow, {
    className: ke(sr.arrow, (w = (m = Y.arrow) != null ? m : F.arrow) == null ? void 0 : w.className)
  }), Xt);
  return /* @__PURE__ */ de(k.Fragment, {
    children: [/* @__PURE__ */ k.cloneElement(re, Be), /* @__PURE__ */ x(yo, T({
      as: X ?? Ma,
      placement: q,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(xo, T({}, ss, {
          children: [ne, N ? /* @__PURE__ */ x(Eo, T({}, ls, {
            ref: Ye
          })) : null]
        }))
      }))
...
const df = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ff = (e) => {
  ...
  const r = rt({
    ...
    titleAccess: f,
    viewBox: d = "0 0 24 24"
  } = r, g = pe(r, df), v = /* @__PURE__ */ k.isValidElement(o) && o.type === "svg", b = T({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
var Da = io.default = void 0, wf = yf(vf()), xf = cs;
Da = io.default = (0, wf.default)(/* @__PURE__ */ (0, xf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function wi(e, t, n) {
  return e ? /* @__PURE__ */ x(Pi, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ x("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function ja(e) {
  const {
    onClick: t,
    ...
    Cs,
    {
      ...
      onClick: t,
      id: b,
      children: n ? /* @__PURE__ */ de(Hn, { children: [
        wi(i, n, !0),
        /* @__PURE__ */ x(Ns, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ x(Pi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ x(Da, {}) }) : wi(s, n, !1)
      ] }) : h
    }
  );
  return r ? /* @__PURE__ */ x(cf, { title: r, placement: "right", children: /* @__PURE__ */ x("div", { children: E }) }) : E;
}
function Ba(e) {
...
function Ef(e) {
  const [t, n] = Ee(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (p) => {
    ...
    let p = Ba(i).filter((u) => "menuItem" in u.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return p = p.filter(
      (u) => "menuItem" in u.group && u.group.menuItem === r.id
    ), /* @__PURE__ */ x(so, { ...e, includedGroups: p });
  };
  return /* @__PURE__ */ de(Hn, { children: [
    /* @__PURE__ */ x(ja, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ x(
      Ps,
      {
        anchorEl: t,
...
function so(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = hn(() => {
    const u = o && o.length > 0 ? o : (
      ...
      Ba(t).filter((v) => !("menuItem" in v.group))
  ...
  return /* @__PURE__ */ x("div", { role: "menu", "aria-label": p, children: i.map((u, f) => {
...
function Tf(e) {
  ...
  )), /* @__PURE__ */ x(so, { ...e, includedGroups: i });
}
function Of({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ de(
    Ri,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x(Rs, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ x(
          Tf,
          {
            commandHandler: e,
            menuDefinition: t,
...
const La = /* @__PURE__ */ k.createContext({});
process.env.NODE_ENV !== "production" && (La.displayName = "ListContext");
const Cf = La;
function Nf(e) {
  return Ge("MuiList", e);
}
st("MuiList", ["root", "padding", "dense", "subheader"]);
const Pf = ["children", "className", "component", "dense", "disablePadding", "subheader"], Rf = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
  ...
  paddingTop: 0
})), Fa = /* @__PURE__ */ k.forwardRef(function(t, n) {
  const r = rt({
    props: t,
    name: "MuiList"
  }), {
  ...
  return /* @__PURE__ */ x(Cf.Provider, {
    value: f,
    children: /* @__PURE__ */ de($f, T({
      as: s,
...
const Mf = Fa, If = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function yr(e, t, n) {
...
function Qt(e, t, n, r, o, i) {
  ...
  for (; l; ) {
    ...
    if (!l.hasAttribute("tabindex") || !Va(l, i) || c)
      l = o(e, l, n);
    else
      return l.focus(), !0;
  }
...
const za = /* @__PURE__ */ k.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  } = t, d = pe(t, If), g = k.useRef(null), v = k.useRef({
    keys: [],
    repeating: !0,
  ...
  yt(() => {
    ...
    adjustStyleForScrollbar: (y, w) => {
      ...
      if (y.clientHeight < g.current.clientHeight && m) {
        const S = `${ea(Te(y))}px`;
        g.current.style[w.direction === "rtl" ? "paddingLeft" : "paddingRight"] = S, g.current.style.width = `calc(100% + ${S})`;
      }
      return g.current;
    }
  }), []);
  const b = (y) => {
    const w = g.current, m = y.key, S = Te(w).activeElement;
    if (m === "ArrowDown")
      y.preventDefault(), Qt(w, S, p, c, yr);
    else if (m === "ArrowUp")
      y.preventDefault(), Qt(w, S, p, c, xi);
    else if (m === "Home")
      y.preventDefault(), Qt(w, null, p, c, yr);
    else if (m === "End")
      y.preventDefault(), Qt(w, null, p, c, xi);
    else if (m.length === 1) {
      ...
      const F = S && !N.repeating && Va(S, N);
      N.previousKeyMatched && (F || Qt(w, S, !1, c, yr, N)) ? y.preventDefault() : N.previousKeyMatched = !1;
    }
    u && u(y);
  }, h = Ve(g, n);
  let E = -1;
...
const _f = za, Af = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Df = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  } = t, y = pe(t, Af), w = k.useRef(null), m = Ve(w, l.ref, n), S = (j) => (D) => {
    if (j) {
      const M = w.current;
      D === void 0 ? j(M) : j(M, D);
    }
...
const Lf = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Ff = (e) => {
  ...
  return /* @__PURE__ */ x(h, T({
    ...
    children: /* @__PURE__ */ x(Vf, T({
      "aria-hidden": !0
    }, m, {
      as: (o = (i = b.root) != null ? i : u.Root) != null ? o : p,
      className: ke(w.root, c, m == null ? void 0 : m.className),
...
const Hf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Wf = (e) => {
  ...
  const X = (r = (o = j == null ? void 0 : j.root) != null ? o : E.Root) != null ? r : qf, W = (i = (s = j == null ? void 0 : j.backdrop) != null ? s : E.Backdrop) != null ? i : u, Y = (l = $ == null ? void 0 : $.root) != null ? l : I.root, K = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, ne = wt({
    elementType: X,
    externalSlotProps: Y,
  ...
  return !F && !R && (!G || U) ? null : /* @__PURE__ */ x(pn, {
    ref: O,
    container: b,
    disablePortal: S,
    children: /* @__PURE__ */ de(X, T({}, ne, {
      children: [!B && u ? /* @__PURE__ */ x(W, T({}, _)) : null, /* @__PURE__ */ x(jn, {
        disableEnforceFocus: w,
        disableAutoFocus: y,
        disableRestoreFocus: N,
        isEnabled: A,
...
const Kf = ["className", "component", "elevation", "square", "variant"], Jf = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
...
const oh = (e) => {
  ...
  outline: 0
}), Ga = /* @__PURE__ */ k.forwardRef(function(t, n) {
  var r, o, i;
  const s = rt({
    props: t,
    name: "MuiPopover"
  ...
  } = s, F = pe(s.TransitionProps, th), C = pe(s, nh), R = (r = w == null ? void 0 : w.paper) != null ? r : I, $ = k.useRef(), j = Ve($, R.ref), D = T({}, s, {
    anchorOrigin: p,
    anchorReference: f,
    elevation: b,
    marginThreshold: h,
...
`)), h !== null && ve < h) {
  ...
  const q = v || (c ? Te(_n(c)).body : void 0), X = (o = y == null ? void 0 : y.root) != null ? o : ih, W = (i = y == null ? void 0 : y.paper) != null ? i : Xa, Y = wt({
    elementType: W,
  ...
  return /* @__PURE__ */ x(X, T({}, _, !sa(X) && {
    slotProps: ne,
    disableScrollLock: B
  }, {
    children: /* @__PURE__ */ x(S, T({
      appear: !0,
      in: E,
      onEntering: G,
      onExited: z,
...
const lh = ["onEntering"], ch = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], ph = {
  vertical: "top",
  horizontal: "right"
}, uh = {
  vertical: "top",
  ...
  const i = rt({
    ...
    slots: I = {},
    slotProps: y = {}
  } = i, w = pe(i.TransitionProps, lh), m = pe(i, ch), S = xn(), N = S.direction === "rtl", L = T({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), B = dh(L), F = s && !p && d, C = k.useRef(null), R = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || j === -1) && (j = O));
  ...
  const D = (r = I.paper) != null ? r : hh, M = (o = y.paper) != null ? o : g, V = wt({
    elementType: I.root,
  ...
  return /* @__PURE__ */ x(fh, T({
    onClose: f,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: N ? "right" : "left"
    },
    transformOrigin: N ? ph : uh,
    slots: {
      paper: D,
      root: I.root
    },
...
function yh({
  ...
  Ft(() => {
    if (c) {
      ...
      if (w) {
        const m = w.getBoundingClientRect(), S = window.scrollY, N = window.scrollX, L = m.top + S + w.clientHeight, B = m.left + N;
        h({ top: L, left: B });
      }
    }
  }, [c, o]);
...
), Ka = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(Mi.Root, { ref: n, className: ue(wh(), e), ...t }));
Ka.displayName = Mi.Root.displayName;
function Un({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
  ...
  return /* @__PURE__ */ de("div", { className: ue("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": r }), children: [
    /* @__PURE__ */ x(
      Ka,
      {
        htmlFor: e,
    ...
    /* @__PURE__ */ x(
      Fr,
      {
        ...
        placeholder: s,
        required: l,
        className: ue(c, { "pr-border-red-600": n }),
        defaultValue: p,
        value: u,
        onChange: f,
        onFocus: d,
    ...
    /* @__PURE__ */ x("p", { className: ue({ "pr-hidden": !o }), children: o })
  ] });
}
let wr;
...
function Jh({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ de("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ x(
      ...
      {
        onClick: () => t(Oo(e, 1)),
        disabled: e.chapterNum >= Ci(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ x(
    ...
    /* @__PURE__ */ x(
      ...
      {
        onClick: () => t(So(e, -1)),
        disabled: e.verseNum <= ds,
        children: "<"
      }
    ),
    /* @__PURE__ */ x(dt, { onClick: () => t(So(e, 1)), children: ">" })
  ] });
}
...
function Oi({ onRowChange: e, row: t, column: n }) {
  ...
  return (
    ...
    // eslint-disable-next-line no-type-assertion/no-type-assertion
    /* @__PURE__ */ x(Un, { defaultValue: t[n.key], onChange: r })
  );
}
const xh = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ x(
  zi,
  {
    ...r,
    isChecked: n,
...
function rm({
  ...
  const i = gt(void 0);
  return /* @__PURE__ */ x("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ x(As, { position: "static", id: r, children: /* @__PURE__ */ de(Ds, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ x(
      yh,
      {
        commandHandler: t,
...
}, am = Me.Root, Eh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.List,
  {
    ref: n,
    className: ue(
...
Eh.displayName = Me.List.displayName;
const kh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Trigger,
  {
    ref: n,
    className: ue(
...
kh.displayName = Me.Trigger.displayName;
const Th = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Content,
  {
    ref: n,
    className: ue(
...
Th.displayName = Me.Content.displayName;
const Oh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Root,
  {
    orientation: "vertical",
    ref: n,
    className: ue("pr-flex pr-gap-1 pr-rounded-md pr-text-muted-foreground", e),
    ...t
  }
));
Oh.displayName = Me.List.displayName;
const Sh = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.List,
  {
    ref: n,
    className: ue(
...
const sm = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Trigger,
  {
    ref: n,
    ...t,
...
)), Ch = me.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  Me.Content,
  {
    ref: n,
    className: ue(
...
Ch.displayName = Me.Content.displayName;
function Nh(e, t = "top") {
...
export {
  ...
  Yh as ContextMenu,
  tl as DropdownMenu,
  il as DropdownMenuCheckboxItem,
  ...
  rm as Toolbar,
  Oh as VerticalTabs,
  Ch as VerticalTabsContent,
  Sh as VerticalTabsList,
  sm as VerticalTabsTrigger,
