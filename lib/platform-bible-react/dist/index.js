...
import Nt, { forwardRef as ts, useState as Xe, useRef as Nn, useCallback as Fe, useMemo as Bt, useEffect as Vn } from "react";
import { getChaptersForBook as yi, offsetBook as vo, FIRST_SCR_BOOK_NUM as ns, offsetChapter as yo, FIRST_SCR_CHAPTER_NUM as rs, offsetVerse as xo, FIRST_SCR_VERSE_NUM as os } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { ChevronRight as is, Check as as, Circle as ss, History as ls, Tally1 as cs } from "lucide-react";
import xe, { clsx as us } from "clsx";
import { twMerge as ds } from "tailwind-merge";
import { Button as ps, Autocomplete as fs, TextField as xi, FormControlLabel as wo, FormLabel as hs, Checkbox as ms, MenuItem as gs, ListItemText as bs, ListItemIcon as wi, Menu as vs, Grid as Ei, List as ys, IconButton as Ti, Drawer as xs, Paper as ws, Slider as Es, Snackbar as Ts, Switch as ks, AppBar as Os, Toolbar as Ss } from "@mui/material";
import Cs, { ThemeContext as Ps, internal_processStyles as Rs } from "@mui/styled-engine";
...
const Ws = ge.Root, qs = ge.Trigger, Gs = w.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ de(
  ge.SubTrigger,
  {
    ref: o,
    className: Qe(
...
const Xs = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.SubContent,
  {
    ref: n,
    className: Qe(
...
Xs.displayName = ge.SubContent.displayName;
const Ni = w.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ T(ge.Portal, { children: /* @__PURE__ */ T(
  ge.Content,
  {
    ref: r,
    sideOffset: t,
...
const $i = w.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ T(
  ge.Item,
  {
    ref: r,
    className: Qe(
...
const Ks = w.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ de(
  ge.CheckboxItem,
  {
    ref: o,
    className: Qe(
...
Ks.displayName = ge.CheckboxItem.displayName;
const Ys = w.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ de(
  ge.RadioItem,
  {
    ref: r,
    className: Qe(
...
const _i = w.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ T(
  ge.Separator,
  {
    ref: n,
...
const Js = ts(
  ({ handleSearch: e, ...t }, n) => /* @__PURE__ */ de("div", { className: "input-container", children: [
    /* @__PURE__ */ T(
      Ii,
      {
        ...t,
  ...
  return /* @__PURE__ */ de("div", { children: [
    /* @__PURE__ */ T(
      $i,
      {
        ...
        children: /* @__PURE__ */ de("div", { children: [
          /* @__PURE__ */ T(cs, { className: `book-color-label ${r.toLowerCase()}` }),
...
function gh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = me, [r, o] = Xe(""), [i, s] = Xe(""), l = Nn(void 0), c = Fe(
    ...
    o(b);
  }, f = Fe((b) => yi(me.bookIdToNumber(b)), []), p = (b) => {
    s(i !== b ? b : ""), f(b) === -1 && t({
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Ws, { children: [
    ...
    /* @__PURE__ */ T(Ni, { className: "menu-content", children: tl.map((b) => /* @__PURE__ */ de("div", { children: [
      /* @__PURE__ */ T(Mi, { className: "menu-label", children: el[b] }),
      ...
      b === "OT" || b === "NT" ? /* @__PURE__ */ T(_i, {}) : void 0
    ] }, b)) })
  ] }) });
}
function xt({
...
function cl() {
  if ($o)
    return cr;
  $o = 1;
  var e = Ai(), t = sl(), n = Dr(), r = Di(), o = ll(), i = function() {
  };
...
function Ke(e, t, n = {
  ...
  return pt(e) && pt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (pt(t[o]) && o in e && pt(e[o]) ? r[o] = Ke(e[o], t[o], n) : n.clone ? r[o] = pt(t[o]) ? ji(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function hl(e) {
  const {
...
process.env.NODE_ENV === "production" ? Er.exports = yl() : Er.exports = xl();
var $n = Er.exports;
...
const kl = a.oneOfType([a.func, a.object]), jr = kl;
function ze(e) {
  if (typeof e != "string")
...
const Pl = typeof window < "u" ? w.useLayoutEffect : w.useEffect, mt = Pl;
let Do = 0;
function Rl(e) {
...
function Ll(e) {
  e.addEventListener("keydown", jl, !0), e.addEventListener("mousedown", dr, !0), e.addEventListener("pointerdown", dr, !0), e.addEventListener("touchstart", dr, !0), e.addEventListener("visibilitychange", Bl, !0);
}
function Fl(e) {
  const {
    target: t
...
function Wi() {
  ...
  function n() {
    return t.current ? (kr = !0, Il.start(100, () => {
      kr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
}, Xl = /* @__PURE__ */ w.createContext(Gl);
function Kl(e) {
  const {
...
process.env.NODE_ENV !== "production" && (_n["propTypes"] = Fi(_n.propTypes));
function lc(e) {
...
function bc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), v = w.useRef(null), b = w.useRef(null), h = De(b, f), [m, E] = w.useState(!d), $ = mc(c);
  let y = !0;
...
var Se = "top", je = "bottom", Be = "right", Ce = "left", Br = "auto", pn = [Se, je, Be, Ce], It = "start", sn = "end", vc = "clippingParents", ra = "viewport", Gt = "popper", yc = "reference", Uo = /* @__PURE__ */ pn.reduce(function(e, t) {
  return e.concat([t + "-" + It, t + "-" + sn]);
}, []), oa = /* @__PURE__ */ [].concat(pn, [Br]).reduce(function(e, t) {
  return e.concat([t, t + "-" + It, t + "-" + sn]);
}, []), xc = "beforeRead", wc = "read", Ec = "afterRead", Tc = "beforeMain", kc = "main", Oc = "afterMain", Sc = "beforeWrite", Cc = "write", Pc = "afterWrite", Rc = [xc, wc, Ec, Tc, kc, Oc, Sc, Cc, Pc];
function Ue(e) {
...
function fn(e) {
  for (var t = Me(e), n = Ho(e); n && _c(n) && Je(n).position === "static"; )
    n = Ho(n);
  return n && (Ue(n) === "html" || Ue(n) === "body" && Je(n).position === "static") ? t : n || Ic(e) || t;
}
function Vr(e) {
...
function jc(e) {
  ...
  if (!(!i || !s)) {
    var f = Dc(o.padding, n), p = Fr(i), v = c === "y" ? Se : Ce, b = c === "y" ? je : Be, h = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = fn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = h / 2 - m / 2, x = f[v], g = $ - p[d] - f[b], S = $ / 2 - p[d] / 2 + y, C = tn(x, S, g), A = c;
...
function ua(e) {
  return ["html", "body", "#document"].indexOf(Ue(e)) >= 0 ? e.ownerDocument.body : Ae(e) && Hr(e) ? e : ua(Un(e));
}
function nn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ua(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Me(r), s = o ? [i].concat(i.visualViewport || [], Hr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function ln(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? vc : l, u = n.rootBoundary, d = u === void 0 ? ra : u, f = n.elementContext, p = f === void 0 ? Gt : f, v = n.altBoundary, b = v === void 0 ? !1 : v, h = n.padding, m = h === void 0 ? 0 : h, E = la(typeof m != "number" ? m : ca(m, pn)), $ = p === Gt ? yc : Gt, y = e.rects.popper, x = e.elements[b ? $ : p], g = Zc(bt(x) ? x : x.contextElement || at(e.elements.popper), c, d, s), S = Dt(e.elements.reference), C = da({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function Qc(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? oa : c, d = jt(r), f = d ? l ? Uo : Uo.filter(function(b) {
    return jt(b) === d;
...
function tu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, v = n.flipVariations, b = v === void 0 ? !0 : v, h = n.allowedAutoPlacements, m = t.options.placement, E = Ve(m), $ = E === m, y = c || ($ || !b ? [Sn(m)] : eu(m)), x = [m].concat(y).reduce(function(F, U) {
      return F.concat(Ve(U) === Br ? Qc(t, {
        placement: U,
        boundary: d,
        rootBoundary: f,
        padding: u,
...
function ru(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = ln(t, {
    ...
    altBoundary: !0
  }), c = Xo(s, r), u = Xo(l, o, i), d = Ko(c), f = Ko(u);
  t.modifiersData[n] = {
...
function du(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, v = p === void 0 ? !0 : p, b = n.tetherOffset, h = b === void 0 ? 0 : b, m = ln(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Ve(t.placement), $ = jt(t.placement), y = !$, x = Vr(E), g = uu(x), S = t.modifiersData.popperOffsets, C = t.rects.reference, A = t.rects.popper, I = typeof h == "function" ? h(Object.assign({}, t.rects, {
    placement: t.placement
  })) : h, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (S) {
    if (i) {
      var G, L = x === "y" ? Se : Ce, _ = x === "y" ? je : Be, R = x === "y" ? "height" : "width", j = S[x], Q = j + m[L], Z = j - m[_], O = v ? -A[R] / 2 : 0, M = $ === It ? C[R] : A[R], V = $ === It ? -A[R] : -C[R], X = t.elements.arrow, F = v && X ? Fr(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var Te, he = x === "x" ? Se : Ce, lt = x === "x" ? je : Be, ke = S[g], We = g === "y" ? "height" : "width", Pe = ke + m[he], qe = ke - m[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[g]) != null ? Te : 0, ct = ye ? Pe : ke - C[We] - A[We] - yt + D.altAxis, Vt = ye ? ke + C[We] + A[We] - yt - D.altAxis : qe, bn = v && ye ? Ac(ct, ke, Vt) : tn(v ? ct : Pe, ke, v ? Vt : qe);
      S[g] = bn, z[g] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function gu(e, t, n) {
  ...
  Hr(i)) && (l = hu(t)), Ae(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Ur(i))), {
...
const Ru = () => et({
  root: ["root"]
}, Kl(ku)), Nu = {}, $u = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = ce(t, Ou), E = w.useRef(null), $ = De(E, n), y = w.useRef(null), x = De(y, p), g = w.useRef(x);
  mt(() => {
    g.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const S = Cu(d, s), [C, A] = w.useState(S), [I, D] = w.useState(An(o));
  w.useEffect(() => {
...
`));
  ...
  const z = Ru(), G = (r = b.root) != null ? r : "div", L = gt({
    elementType: G,
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || Pu(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const Xu = Le("border", Ie), Ku = Le("borderTop", Ie), Yu = Le("borderRight", Ie), Ju = Le("borderBottom", Ie), Zu = Le("borderLeft", Ie), Qu = Le("borderColor"), ed = Le("borderTopColor"), td = Le("borderRightColor"), nd = Le("borderBottomColor"), rd = Le("borderLeftColor"), od = Le("outline", Ie), id = Le("outlineColor"), Kn = (e) => {
...
Xn(Xu, Ku, Yu, Ju, Zu, Qu, ed, td, nd, rd, Kn, od, id);
const Yn = (e) => {
...
Xn(Yn, Jn, Zn, ad, sd, ld, cd, ud, dd, pd, fd, hd);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const md = be({
...
function Kr(e = {}, ...t) {
  ...
  return u.applyStyles = Pd, u = t.reduce((d, f) => Ke(d, f), u), u.unstable_sxConfig = k({}, Gr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Xr({
      sx: f,
      theme: this
    });
...
function Ld(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Rs(s, (g) => g.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    const $ = Cs(s, k({
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${ze(u || "")}`), B === void 0 && (B = `Styled(${Tl(s)})`), D.displayName = B;
      }
...
function jn(e, t) {
  return e = vt(e), t = Yr(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Qn(e);
}
function Hd(e, t) {
...
function cp(e) {
  ...
  function f(h) {
    const m = ni(h, fr.text.primary) >= n ? fr.text.primary : ri.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ni(h, m);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return oi(h, "light", $, r), oi(h, "dark", y, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, v = {
    dark: fr,
    light: ri
  };
...
function pp(e, t) {
  ...
  const v = o / 14, b = f || ((E) => `${E / u * v}rem`), h = (E, $, y, x, g) => k({
    ...
    button: h(l, 14, 1.75, 0.4, ii),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, ii),
...
const Cp = Sp(), Jr = Cp, Zr = "$$material", ya = (e) => Cn(e) && e !== "classes", Pp = Ld({
  themeId: Zr,
  defaultTheme: Jr,
...
const _p = {
...
}, hr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Qr = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, E = ce(t, Mp), $ = Jt(), y = w.useRef(), x = gn(), g = w.useRef(null), S = De(g, i.ref, n), C = (_) => (R) => {
    if (_) {
      const j = g.current;
      R === void 0 ? _(j) : _(j, R);
    }
...
})({}), Ta = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const o = ba(), i = tt({
    props: t,
    name: "MuiPopper"
    ...
    slots: y,
    slotProps: x
  } = i, g = ce(i, Ap), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, C = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Oa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  const S = tt({
    ...
    TransitionProps: J
  } = S, P = ce(S, Lp), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
  }), ve = gn(), Te = ve.direction === "rtl", [he, lt] = w.useState(), [ke, We] = w.useState(null), Pe = w.useRef(!1), qe = L || Z, ye = Jt(), yt = Jt(), ct = Jt(), Vt = Jt(), [bn, ro] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oo = (ee) => {
    ...
    onFocus: Ua,
    ref: Ha
  } = Wi(), [, so] = w.useState(!1), lo = (ee) => {
    za(ee), ao.current === !1 && (so(!1), io(ee));
  }, co = (ee) => {
    he || lt(ee.currentTarget), Ua(ee), ao.current === !0 && (so(!0), tr(ee));
  }, uo = (ee) => {
    Pe.current = !0;
    const Re = re.props;
...
`));
  const Ka = w.useMemo(() => {
    ...
    touch: Pe.current
  }), or = Vp(Wt), ho = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : zp, mo = (i = (s = (l = Y.transition) != null ? l : I.Transition) != null ? s : N) != null ? i : $r, go = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : Up, bo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : Hp, Ya = Zt(ho, k({}, H, (p = K.popper) != null ? p : D.popper, {
    className: xe(or.popper, H == null ? void 0 : H.className, (v = (b = K.popper) != null ? b : D.popper) == null ? void 0 : v.className)
  }), Wt), Ja = Zt(mo, k({}, J, (h = K.transition) != null ? h : D.transition), Wt), Za = Zt(go, k({}, (m = K.tooltip) != null ? m : D.tooltip, {
    className: xe(or.tooltip, (E = ($ = K.tooltip) != null ? $ : D.tooltip) == null ? void 0 : E.className)
  }), Wt), Qa = Zt(bo, k({}, (y = K.arrow) != null ? y : D.arrow, {
  ...
  return /* @__PURE__ */ de(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, _e), /* @__PURE__ */ T(ho, k({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ de(go, k({}, Za, {
          children: [ne, C ? /* @__PURE__ */ T(bo, k({}, Qa, {
            ref: We
          })) : null]
        }))
      }))
...
const Xp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Kp = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, v = ce(r, Xp), b = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", h = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Ca(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = di.muiName, /* @__PURE__ */ w.memo(/* @__PURE__ */ w.forwardRef(n));
}
const Jp = {
  configure: (e) => {
...
var Pa = eo.default = void 0, nf = tf(ef()), rf = es;
Pa = eo.default = (0, nf.default)(/* @__PURE__ */ (0, rf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function fi(e, t, n) {
  ...
  const {
    ...
    gs,
    {
      ...
      children: n ? /* @__PURE__ */ de(Fn, { children: [
        ...
        f ? /* @__PURE__ */ T(wi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Pa, {}) }) : fi(s, n, !1)
      ] }) : m
    }
  );
...
const $a = /* @__PURE__ */ w.createContext({});
...
const pf = ["children", "className", "component", "dense", "disablePadding", "subheader"], ff = (e) => {
  ...
  paddingTop: 0
})), Ma = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = tt({
    props: t,
    name: "MuiList"
  }), {
...
const Ia = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  } = t, p = ce(t, gf), v = w.useRef(null), b = w.useRef({
    keys: [],
    repeating: !0,
  ...
  const h = (y) => {
    ...
    if (g === "ArrowDown")
      ...
      y.preventDefault(), Yt(x, S, u, c, hi);
    else if (g === "Home")
      y.preventDefault(), Yt(x, null, u, c, gr);
    else if (g === "End")
      y.preventDefault(), Yt(x, null, u, c, hi);
    else if (g.length === 1) {
...
const bf = Ia, vf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], yf = {
...
}, Aa = /* @__PURE__ */ w.forwardRef(function(t, n) {
  const r = gn(), o = {
  ...
  } = t, y = ce(t, vf), x = w.useRef(null), g = De(x, l.ref, n), S = (L) => (_) => {
    if (L) {
      const R = x.current;
      _ === void 0 ? L(R) : L(R, _);
    }
...
const Ef = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Tf = (e) => {
  ...
  const s = tt({
    ...
    component: u,
    invisible: p
  }), x = Tf(y), g = (r = b.root) != null ? r : f.root;
  return /* @__PURE__ */ T(m, k({
    in: v,
    timeout: E
  }, $, {
...
const Cf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Pf = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Rf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, K = (l = G == null ? void 0 : G.root) != null ? l : $.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : $.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: K,
...
const _f = ["className", "component", "elevation", "square", "variant"], If = (e) => {
  ...
  return k({
    ...
    backgroundImage: `linear-gradient(${jn("#fff", ci(t.elevation))}, ${jn("#fff", ci(t.elevation))})`
  }, e.vars && {
...
const Vf = (e) => {
  ...
  } = s, D = ce(s.TransitionProps, Bf), B = ce(s, Lf), z = (r = x == null ? void 0 : x.paper) != null ? r : $, G = w.useRef(), L = De(G, z.ref), _ = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: h,
    marginThreshold: m,
...
`));
    ...
    vertical: mi(J, g.vertical),
    horizontal: gi(J, g.horizontal)
...
`)), m !== null && he < m) {
  ...
  const W = b || (c ? we(Rn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : zf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, K = gt({
    elementType: H,
...
const Wf = ["onEntering"], qf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Gf = {
  ...
  const i = tt({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, Wf), g = ce(i, qf), S = gn(), C = S.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: E
  }), I = Kf(A), D = s && !u && p, B = w.useRef(null), z = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const _ = (r = $.paper) != null ? r : Jf, R = (o = y.paper) != null ? o : v, j = gt({
    elementType: $.root,
...
function wh({ onSearch: e, placeholder: t, isFullWidth: n }) {
  ...
  return /* @__PURE__ */ T(ws, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ T(
    Ln,
    {
      isFullWidth: n,
...
const rh = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ T(
  nl,
  {
    ...r,
    isChecked: n,
...
function Sh({
  ...
  const i = Nn(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T(Os, { position: "static", id: r, children: /* @__PURE__ */ de(Ss, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      nh,
      {
        commandHandler: t,
