...
import { c as b, g as $e, a as Vr, C as er, L as Un, t as ks, u as Qo, T as Vt, b as bt, d as xt, e as yt, f as Kn, A as ba, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Je, r as Oe, p as Ts, q as Hn, P as lr, s as Or, v as dr, w as wr, y as Oa, z as Da, E as Eo, F as ur, G as Ma, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Ss, Z as ir, _ as Ze, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Oo, a4 as ya, a5 as Do, a6 as Gn, a7 as Rs, a8 as Os, a9 as Ds, aa as wo, ab as Wn, ac as Ia, ad as Ms, ae as Yn, af as Is, ag as zs, ah as Ps, ai as tn, aj as As, ak as $s, al as Vs, am as Xn, an as Zn, ao as Mo, ap as Ls, aq as Jn, ar as Ka, as as en, at as Ha, au as Bs, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Io, aE as zo, aF as Ys, aG as Xs } from "./resizable-CtvKBoK1.js";
import { aH as vf, aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Of, aU as Df, aV as Mf, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as Ff, b3 as jf, b4 as Uf, b5 as Kf, b6 as Hf, b7 as qf, b8 as Gf, b9 as Wf, ba as Yf, bb as Xf, bc as Zf, bd as Jf, be as Qf, bf as tm, bg as em, bh as rm, bi as am, bj as om, bk as nm, bl as im, bm as sm } from "./resizable-CtvKBoK1.js";
...
import ee, { useRef as L, useMemo as P, createContext as Gr, useContext as za, useEffect as Z, useState as _, useCallback as V, useId as _a, useImperativeHandle as Uc, useLayoutEffect as re, Fragment as Wr, Component as Kc, createElement as ln, Suspense as Hc, forwardRef as ci, memo as li } from "react";
...
import { Avatar as Lo, Select as ae, Checkbox as pn, Slot as Xr, Tabs as ke, Menubar as De, ContextMenu as Ht, Progress as hn, Slider as oa, Switch as gn } from "radix-ui";
...
function ud({
  ...
  const S = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), O = A ? (
...
function fd({
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = _a(), E = L(!1), y = w !== void 0, C = y ? w : h, N = n === "" ? "" : se(n, hd), A = se(s, gd), B = (O) => {
...
function Ya({
  ...
  const B = Oe(), U = wd(), [M, S] = _(!1), [O, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    void 0
  ), [at, ut] = _(void 0), [dt, tt] = _(!1), [pt, kt] = _(!1), [mt, Rt] = _(!1), [Ft, Pt] = _(!1), fe = L(null), we = L(!1), _t = L(void 0), Nt = L(void 0), Et = L(void 0), oe = L(void 0), me = L({}), Ot = L({}), Dt = V(
    (v) => {
      e(v), d && d(v);
    },
    [e, d]
    ...
    if (!D) return;
    const v = O.startsWith(`${D.book} `) ? O : "", q = na(v), lt = Ar(v);
    return {
      book: D.book,
      chapterNum: lt ?? D.chapterNum ?? 1,
  ...
  const It = V(() => {
    ...
    (v) => {
      const q = G ?? (D == null ? void 0 : D.book), lt = at ?? (D == null ? void 0 : D.chapterNum);
      !q || !lt || (Dt({
        book: q,
        chapterNum: lt,
        verseNum: v
    ...
    (v) => {
      const q = k === "chapters" ? I : D == null ? void 0 : D.book;
      if (q) {
        if (w && w(q, v) > 1) {
          $(q), ut(v), ot("verses"), W("");
          return;
  ...
  const { otLong: Tt, ntLong: Gt, dcLong: ar, extraLong: Ke } = {
    ...
    () => bd(Y),
    [Y]
  ), zt = P(() => !w || !D || !D.chapterNum || !wt ? !1 : w(D.book, D.chapterNum) > 0, [w, D, wt]), He = k === "books" && !dt && !Y.trim() && Xt.size > 0, Ba = V(
    (v) => p ? mn(v, p) : !1,
    [p]
  ), Ae = V(
    (v) => (q) => p ? xd(v, q, p) : !1,
    ...
    (v) => {
      ...
      if (!(!!q && !!((Xo = _t.current) != null && Xo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
      ...
      const { isLetter: jt, isDigit: Wt } = fn(v.key);
      ...
      if (k === "books" && D && !dt && v.key === "Enter" && !(q !== Nt.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (v.shiftKey || k === "books" && q !== Nt.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const St = (() => {
        const Bt = k === "books" && D && zt && D.chapterNum ? { bookId: D.book, chapterNum: D.chapterNum } : void 0, pe = k === "verses" ? { bookId: G, chapterNum: at } : Bt;
        if (pe) {
        ...
        if (k === "chapters" || k === "books" && D && Ge(D.book) > 1) {
          const Jt = k === "chapters" ? I : D == null ? void 0 : D.book;
          return Jt ? {
            max: Ge(Jt),
            current: Ar(O) ?? 0,
    ...
    const { isLetter: q, isDigit: lt } = fn(v.key);
  ...
  re(() => {
    ...
    if (k === "verses" && G && at !== void 0) {
      ...
      W(
        ...
        if (Et.current)
          if (v) {
            const lt = Ot.current[t.verseNum];
            lt && lt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Et.current.scrollTo({ top: 0 });
        _t.current && _t.current.focus();
  ...
  const rt = D ? `${D.book} ${D.chapterNum ?? ""} ${D.verseNum ?? ""} ${zt}` : "", Lt = L(""), ue = L(""), be = P(() => {
    if (k !== "books" || !D || dt) return;
    const { book: v, chapterNum: q, verseNum: lt } = D;
    if (zt && q && w)
      return {
        max: w(v, q),
  ...
  }, [k, D, be, rt, O]), /* @__PURE__ */ u(lr, { open: M, onOpenChange: it, modal: y, children: [
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Da, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Q.map(
              ...
              !dt && /* @__PURE__ */ u(ur, { ref: Et, children: [
                k === "books" && /* @__PURE__ */ u(gt, { children: [
                  ...
                  D && Mt && /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ u(
                    er,
                    {
                      value: pd,
                      onSelect: It,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Vr(D.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  D && zt && D.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  /* @__PURE__ */ a(
                    bn,
                    {
                      ...
                      onVerseSelect: R,
                      setVerseRef: ct,
                      isVerseDisabled: fr(D.book, D.chapterNum),
                      suppressKeyboardHighlight: mt,
                      className: "tw:px-4 tw:pb-4"
                    }
                  ),
                  D && !zt && Ge(D.book) > 1 && // No heading here either, for the same reason as the verse preview above:
...
function xn({
  ...
  const [C, N] = _(!1), A = l ?? d, B = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], U = (M, S) => {
    const O = d(M), W = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, Y = `${S ?? ""}${O}${W ?? ""}`;
    return /* @__PURE__ */ u(
      er,
      {
        value: O,
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Od = zi ? re : Z, sa = { tag: Ao };
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((B || U) && N !== null && A !== null) {
        const M = function(S, O, W, Y, z, k, ot) {
          const I = (S._window ? S._window.document : document).createRange();
          return I.setStart(...yn(O, W, Y)), I.setEnd(...yn(z, k, ot)), I;
        }(t, h, m, N, f, E, A);
        d(), d = Kd(t, M, e);
      }
...
function rw(t) {
  ...
  $i(this), ht = t, this.f &= -2, 8 & this.f && jo(this), $a();
}
function xr(t, e) {
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (g) => {
          g.key === "Escape" ? (g.preventDefault(), g.stopPropagation(), r()) : Go(g) && (g.preventDefault(), g.stopPropagation(), de(s) && f());
        },
        onKeyDown: (g) => {
...
function zn({
  ...
  const C = V(
    ...
    [t.contents]
  ), O = !!t.conflictResolutionAction && !S, W = P(() => {
    if (o && c)
      return /* @__PURE__ */ u(gt, { children: [
        /* @__PURE__ */ u(
          We,
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          m && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: E,
              onKeyDownCapture: (z) => {
                z.key === "Escape" ? (z.preventDefault(), z.stopPropagation(), C()) : Go(z) && (z.preventDefault(), z.stopPropagation(), de(h) && N());
              },
              onKeyDown: (z) => {
...
const Zw = {
  ...
  const dt = V(
    ...
    [X.commentEdits, dt]
  ), [pt, kt] = _(), mt = n, [Rt, Ft] = _(!1), [Pt, fe] = _(!1), [we, _t] = _(!1), [Nt, Et] = _(!1), [oe, me] = _(!1), [Ot, Dt] = _(A), [ne, _e] = _(!1), ve = L(void 0), [Ie, le] = _(/* @__PURE__ */ new Map());
  Z(() => {
    let T = !0;
    return (async () => {
  ...
  const D = P(
    ...
    if (!T) return T;
    const ct = new Set(D.map((zt) => zt.id)), wt = Object.fromEntries(
  ...
  const It = P(() => D[0], [D]), R = L(null), K = L(void 0), J = V(() => {
    var T;
  ...
  }, [i, o]), st = P(() => D.slice(1), [D]), it = P(() => st.length ?? 0, [st.length]), vt = P(() => it > 0, [it]), Ct = P(() => {
    if (Rt || it <= 2)
      return st;
  ...
  return /* @__PURE__ */ a(
    Gw,
    {
      ...
      className: b(
        ...
        {
          "tw:bg-card": p !== "Resolved" && Ot,
          "tw:bg-muted": p === "Resolved",
          "tw:bg-accent": !Ot && p !== "Resolved"
        }
      ),
      onClick: () => {
        d(l);
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              et,
              {
                ...
                "aria-label": Ot ? o["%comment_aria_mark_as_unread%"] ?? "Mark as unread" : o["%comment_aria_mark_as_read%"] ?? "Mark as read",
                children: Ot ? /* @__PURE__ */ a(nc, {}) : /* @__PURE__ */ a(ic, {})
              }
            ),
            W === void 0 ? (
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            E !== !1 && (!qt || de(G)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Go(T) && (T.preventDefault(), T.stopPropagation(), (de(G) || $ !== void 0 && $ !== pt) && Ke());
                },
                onKeyDown: (T) => {
...
function tu({
  ...
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), Y = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : W, z = () => {
    const I = o ?? "accept";
...
function Sh({
  ...
  const [N, A] = _(/* @__PURE__ */ new Set()), [B, U] = _(), [M, S] = _(), O = V(
    async ($) => {
      const at = await s($);
...
function wu({
  ...
  return d ? A = Array.from({ length: 10 }).map((S, O) => `skeleton-row-${O}`).map((S) => /* @__PURE__ */ a(Ye, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(kr, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(yr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((B = C.getRowModel().rows) == null ? void 0 : B.length) > 0 ? A = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Oo, { stickyHeader: s, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(Ye, { children: U.headers.map((M) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : Lr(M.column.columnDef.header, M.getContext()) }, M.id)) }, U.id)) }),
...
function zh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Fe, { children: [
    ...
    /* @__PURE__ */ a(je, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Gn, { children: l.itemType === 0 ? /* @__PURE__ */ a(gt, { children: l.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ze,
        {
          checked: o[w][h],
...
function Vh({
  ...
  const [g, E] = _("generated"), [y, C] = _("generated"), [N, A] = _("*"), [B, U] = _("*"), [M, S] = _("f"), [O, W] = _(!1), [Y, z] = _(!0), [k, ot] = _(!1), I = L(!1), X = L(""), [G, $] = _(!1), [at, ut] = _(), [dt, tt] = _(), [pt, kt] = _(), [mt, Rt] = _(), Ft = L(null), Pt = L(
    void 0
  ...
  re(() => {
    (ne.current.book !== n.book || ne.current.chapterNum !== n.chapterNum) && (ne.current = { book: n.book, chapterNum: n.chapterNum }, Dt.current());
  }, [n.book, n.chapterNum]);
  const _e = () => {
    var K;
    ...
    if (K && Ir("note", K)) {
      ...
      M !== "x" && R === "x" ? st == null || st.forEach((it) => Ou(it)) : M === "x" && R !== "x" && (st == null || st.forEach((it) => Du(it))), (nt = h.current) == null || nt.applyUpdate([K, { delete: 1 }]);
    }
  }, le = (R) => {
    ...
    (R, K, J) => {
      ...
      zs({
        ...
        clearSessionIfCurrent: (F) => tn(Pt, F),
    ...
    (R) => {
      ...
      Ps(R, K, {
        ...
        commitTypedAndReopen: (H) => {
          var Q;
          (Q = h.current) == null || Q.commitTypedMarker(H, { trailingSpace: !1 }), D();
        },
        commitTypedCloser: (H) => {
          var Q;
    ...
    if (((J = _t.view) == null ? void 0 : J.markerMode) === "editable") {
      const H = (F) => {
        ...
        if (w && F.key === c) {
          ...
          D() && (F.preventDefault(), F.stopPropagation());
        }
      }, Q = () => {
        var nt, st;
        const F = R();
  ...
  return /* @__PURE__ */ u(gt, { children: [
    /* @__PURE__ */ u("div", { ref: x, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ u("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Da, { children: [
          /* @__PURE__ */ a(
            mu,
            {
              onUndoClick: () => {
...
function Wh({
  ...
  const f = Ce(r, "%webView_inventory_all%"), m = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), E = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), C = Ce(r, "%webView_inventory_scope_verse%"), N = Ce(r, "%webView_inventory_filter_text%"), A = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), B = Ce(r, "%webView_inventory_no_results%"), [U, M] = _(!1), [S, O] = _("all"), [W, Y] = _(""), [z, k] = _([]), ot = P(() => {
    const tt = t ?? [];
...
function Hu({
  ...
  const [d, l] = ee.useState(t), w = e ?? d, p = ee.useCallback(
    ...
    [r, w]
  ), h = ee.useCallback(() => p((C) => !C), [p]), f = w ? "expanded" : "collapsed", g = Oe() === "ltr" ? i : i === "primary" ? "secondary" : "primary", E = ee.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
...
function lg({
  ...
  Z(() => {
    if (c) {
      const S = E.getSelectedRowModel().rowsById, O = Object.keys(S);
      if (O.length === 1) {
        const W = x.find((Y) => Fn(Y) === O[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, E]);
  const y = n ?? ap, C = s ?? ls, N = [
    ...
    !S.getIsGrouped() && !S.getIsSelected() && S.getToggleSelectedHandler()(O);
  }, U = (S, O) => S.getIsGrouped() ? "" : b("banded-row", O % 2 === 0 ? "even" : "odd"), M = (S, O, W) => {
    if (!((S == null ? void 0 : S.length) === 0 || O.depth < W.column.getGroupedIndex())) {
      if (O.getIsGrouped())
        switch (O.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Oo, { children: E.getHeaderGroups().map((S) => /* @__PURE__ */ a(Ye, { children: S.headers.filter((O) => O.column.columnDef.header).map((O) => (
      ...
      /* @__PURE__ */ a(Do, { children: E.getRowModel().rows.map((S, O) => {
        const W = Oe();
        return /* @__PURE__ */ a(
          Ye,
          {
...
function wg({
  ...
  const B = Ut(
    i,
    "%webView_scope_selector_selected_text%"
  ), U = Ut(i, "%webView_scope_selector_verse%"), M = Ut(i, "%webView_scope_selector_chapter%"), S = Ut(i, "%webView_scope_selector_book%"), O = Ut(
    i,
    "%webView_scope_selector_current_verse%"
  ), W = Ut(
    i,
  ...
  }, we = L(null), _t = L(null), Nt = L(!1), Et = L(null), oe = L(!1), [me, Ot] = _(void 0), Dt = L(!1), ne = L(!1), _e = L(null), ve = V((j) => {
    if (j) {
      Ot("start"), Dt.current = !1;
      return;
    }
    Ot((rt) => rt === "start" ? void 0 : rt), Dt.current && (Dt.current = !1, requestAnimationFrame(() => {
      var Lt;
    ...
    Ot((rt) => rt === "end" ? void 0 : rt);
  }, []), le = V(
    (j) => {
      m == null || m(j), x == null || x(j), Dt.current = !0;
    },
    [m, x]
  ), Yt = V(
    (j) => {
    ...
    repeatBookName: !0
  }) : Zt ? kt(Zt.label, Zt.scrRefSuffix) : t, D = mt.filter(
        ...
        /* @__PURE__ */ a(
          je,
          {
            ...
            children: /* @__PURE__ */ u(Ka, { container: mr, children: [
              D.map(({ value: j, label: rt, dropdownLabel: Lt, scrRefSuffix: ue, id: be }) => {
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        children: w.map(({ columnKey: m, label: x }, g) => {
          const E = `${l}-${m}`;
          return /* @__PURE__ */ u(Wr, { children: [
            /* @__PURE__ */ u(Gn, { "aria-labelledby": p ? E : void 0, children: [
