...
import g, { forwardRef as Ve, useRef as et, useMemo as L, useState as M, useCallback as B, useLayoutEffect as It, createContext as Dn, useContext as In, useEffect as q, Suspense as la, createRef as Nr, Fragment as kr } from "react";
import { Command as dt } from "cmdk";
import { X as Me, Search as _r, Check as _t, Clock as er, ChevronsLeft as nr, ChevronsRight as rr, ChevronLeft as dn, ChevronRight as ae, ArrowLeft as wa, ArrowRight as da, Circle as Xe, ChevronDown as Yt, BoldIcon as ca, ItalicIcon as pa, UnderlineIcon as ua, StrikethroughIcon as ma, Pencil as ha, Trash2 as fa, ArrowUp as Cr, MoreHorizontal as Er, ChevronUp as cn, AtSign as ga, FilterIcon as ba, ArrowLeftIcon as va, ChevronLeftIcon as xa, ChevronRightIcon as ya, ArrowRightIcon as Na, Copy as Tr, Filter as ka, User as _a, Link as Ca, CircleHelp as Ea, ChevronsUpDown as Rr, Star as Ta, FunctionSquare as Sr, SquareSigma as Dr, SquareX as Ra, AlertCircle as pn, CircleCheckIcon as Sa, CircleXIcon as Da, CircleHelpIcon as Ia, ArrowUpIcon as Oa, ArrowDownIcon as Va, ArrowUpDownIcon as Ma, PanelLeft as Aa, PanelRight as Pa, ScrollText as $a, MenuIcon as La, Menu as za, EllipsisVertical as Ba, LoaderCircle as ja, GripVertical as Fa } from "lucide-react";
import { clsx as Ga } from "clsx";
import { extendTailwindMerge as Ha } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { includes as Le, Section as F, getChaptersForBook as Xa, formatScrRef as ne, getSectionForBook as _e, formatRelativeDate as Ua, formatReplacementString as re, sanitizeHtml as Ka, parseParatextHtml as or, hasCustomParatextTags as Ya, NumberFormat as qa, formatBytes as Ja, getCurrentLocale as Wa, getFormatCallerFunction as Za, deepEqual as Ir, isString as tn, compareScrRefs as un, scrRefToBBBCCCVVV as en, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import { createEditor as Qa, $getRoot as qt, $createParagraphNode as On, $getSelection as Se, HISTORY_MERGE_TAG as Vr, ParagraphNode as ts, TextNode as es, $isDecoratorNode as ns, $isElementNode as Ce, $isParagraphNode as rs, $isTextNode as je, $isTokenOrSegmented as os, $getCharacterOffsets as as, $isRangeSelection as Vn, CLEAR_EDITOR_COMMAND as Mr, COMMAND_PRIORITY_EDITOR as ss, SELECTION_CHANGE_COMMAND as Ar, COMMAND_PRIORITY_CRITICAL as Pr, FORMAT_TEXT_COMMAND as is, $cloneWithProperties as ls, getRegisteredNode as ws, isHTMLElement as ds, isDocumentFragment as ar, ArtificialNode__DO_NOT_USE as $r, $createLineBreakNode as Lr, $isRootOrShadowRoot as cs, $isBlockElementNode as mn, isBlockDomNode as sr, isInlineDomNode as ir, $insertNodes as ps } from "lexical";
...
import { useReactTable as Fr, getFilteredRowModel as ys, getSortedRowModel as Gr, getPaginationRowModel as Ns, getCoreRowModel as Hr, flexRender as Ee, getGroupedRowModel as ks, getExpandedRowModel as _s } from "@tanstack/react-table";
...
const Os = ft.Root, Vs = ft.Portal, Xr = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: u(
...
Xr.displayName = ft.Overlay.displayName;
const Ur = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
...
Yr.displayName = ft.Title.displayName;
...
qr.displayName = dt.Separator.displayName;
...
Qt.displayName = dt.Item.displayName;
...
const ro = K.allBookIds.filter(
  (t) => !K.isObsolete(K.bookIdToNumber(t))
), Xt = Object.fromEntries(
  ro.map((t) => [t, K.bookIdToEnglishName(t)])
);
function zn(t, e, n) {
...
$.displayName = "Button";
const he = se.Root, fe = se.Trigger, vd = se.Anchor, te = g.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = st();
...
function xn(t, e, n) {
  return `${t} ${Xt[t]}${e ? ` ${Ln(t, e)} ${oe(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function qs({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(he, { open: l, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ r(te, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: /* @__PURE__ */ r($t, { heading: s, children: t.map((c) => /* @__PURE__ */ d(
      Qt,
      {
        onSelect: () => w(c),
  ...
  return It(() => {
    ...
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: oa })
      }
    ) }),
    /* @__PURE__ */ r(te, { id: p, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      pe,
      {
        ref: C,
        onKeyDown: sa,
              ...
              !V && Object.entries(J).map(([D, X]) => {
                if (X.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r($t, { heading: na(D), children: X.map((ot) => /* @__PURE__ */ r(
                      oo,
                      {
                        bookId: ot,
                        onSelect: (it) => ht(it),
                        section: _e(ot),
                        commandValue: `${ot} ${Xt[ot]}`,
...
), at = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Or.Root, { ref: n, className: u("pr-twp", Qs(), t), ...e }));
at.displayName = Or.Root.displayName;
...
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = so ? It : q, ze = { tag: Vr };
...
function di({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return wi(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: p }) => {
      e && s.size === 0 && i.size === 0 || t && p.has(Vr) || l.isEmpty() || n(a, o, p);
    });
  }, [o, t, e, n]), null;
}
const jn = {
  ...
  mark: "",
  markOverlap: ""
}, St = Ae.Provider, At = Ae.Root, Ut = Ae.Trigger, Dt = g.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Ae.Content,
  {
    ref: o,
    sideOffset: e,
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xi = lo && "documentMode" in document ? document.documentMode : null;
!(!lo || !("InputEvent" in window) || xi) && "getTargetRanges" in new window.InputEvent("input");
function Gn(...t) {
  return () => {
  ...
  const [o] = Ct(), a = function(s, i) {
    ...
    return kn(() => s.registerDecoratorListener((w) => {
      ...
      for (let f = 0; f < c.length; f++) {
        const h = c[f], m = r(i, { onError: (v) => s._onError(v), children: r(la, { fallback: null, children: l[h] }) }), b = s.getElementByKey(h);
...
function Ei({ onClear: t }) {
  const [e] = Ct();
  return Ci(() => e.registerCommand(Mr, (n) => (e.update(() => {
    if (t == null) {
      const o = qt(), a = Se(), s = On();
...
function Ti({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: p, ariaLabelledBy: w, ariaMultiline: c, ariaOwns: f, ariaRequired: h, autoCapitalize: m, className: b, id: v, role: y = "textbox", spellCheck: O = !0, style: N, tabIndex: x, "data-testid": _, ...A }, C) {
  ...
  return wo(() => (S(t.isEditable()), t.registerEditableListener((P) => {
    S(P);
...
function Mi() {
  const [t, e] = M(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Os, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ur, { children: [
      /* @__PURE__ */ r(Kr, { children: /* @__PURE__ */ r(Yr, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
$i.displayName = zr.Root.displayName;
...
function Li() {
  const { activeEditor: t } = po(), [e, n] = M([]), o = B((a) => {
    if (Vn(a) || vs(a)) {
      const s = [];
      hr.forEach(({ format: i }) => {
...
function go(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  }(t) && (i = i.concat(Lr())) : Ce(l) && l.append(...h), i;
}
function Hi(t, e, n) {
...
yo.displayName = ce.Root.displayName;
...
const No = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ce.Fallback,
  {
    ref: n,
    className: u(
...
No.displayName = ce.Fallback.displayName;
const Un = Dn(void 0);
function bt() {
  const t = In(Un);
  if (!t)
...
}), ge = Z.Trigger, ko = Z.Group, Qi = Z.Portal, tl = Z.Sub, el = Z.RadioGroup;
...
const _o = g.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Z.SubTrigger,
    {
...
_o.displayName = Z.SubTrigger.displayName;
const Co = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Z.SubContent,
  {
    ref: n,
    className: u(
...
Co.displayName = Z.SubContent.displayName;
...
const Eo = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ d(
    Z.RadioItem,
    {
...
Eo.displayName = Z.RadioItem.displayName;
...
function fr({
  ...
  }, [t.date, o]), N = L(() => t.user, [t.user]), x = L(
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(yo, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(No, { className: "tw-text-xs tw-font-medium", children: x }) }),
        ...
        A && /* @__PURE__ */ d(ee, { children: [
          /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Er, {}) }) }),
...
function rl({
  ...
  const P = L(
    ...
    () => I === 1 ? P.singleReply : re(P.multipleReplies, { count: I }),
    [I, P]
  ), Vt = L(
    ...
    var Y;
    await c(l, bo(m)) && ((Y = R.current) == null || Y.call(R), b(gr));
  }, [m, c, l]);
  return /* @__PURE__ */ r(
    Xn,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ d(xo, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            O && /* @__PURE__ */ r(
              $,
              {
                ...
                children: v ? /* @__PURE__ */ r(cn, {}) : /* @__PURE__ */ r(Yt, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
          ...
          n && /* @__PURE__ */ d(rt, { children: [
            ...
            (!A || Ht(m)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDown: (k) => {
                  vo(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    _n,
...
const le = nt.Root, al = nt.Group, we = nt.Value, sl = Lt(
  ...
  return /* @__PURE__ */ d(
    nt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(nt.Icon, { asChild: !0, children: /* @__PURE__ */ r(Yt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Wt.displayName = nt.Trigger.displayName;
...
To.displayName = nt.ScrollUpButton.displayName;
const Ro = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.ScrollDownButton,
  {
    ref: n,
    className: u("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
Ro.displayName = nt.ScrollDownButton.displayName;
...
Zt.displayName = nt.Content.displayName;
      ...
      /* @__PURE__ */ d(
        le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Zt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(mt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Kt = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function fl({
  ...
  var C;
  const [c, f] = M([]), [h, m] = M([]), [b, v] = M({}), [y, O] = M({}), N = L(() => e ?? [], [e]), x = Fr({
    data: N,
    columns: t,
    getCoreRowModel: Hr(),
  ...
  let A;
  return p ? A = Array.from({ length: 10 }).map((T, R) => `skeleton-row-${R}`).map((T) => /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Kt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(Cn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, T)) : ((C = x.getRowModel().rows) == null ? void 0 : C.length) > 0 ? A = x.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Rt,
    {
      onClick: () => i(E, x),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((S) => /* @__PURE__ */ r(Kt, { children: Ee(S.column.columnDef.cell, S.getContext()) }, S.id))
    },
    E.id
  )) : A = /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Kt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Tr, {}) })
        ] }),
...
function Dd({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ee, { children: [
    ...
    /* @__PURE__ */ r(zt, { children: n.map((w, c) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(ko, { children: w.itemType === 0 ? /* @__PURE__ */ r(rt, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Pt,
        {
          checked: o[c][h],
        ...
        el,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Eo, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(be, {})
    ] }, w.label)) })
...
function kl({
  ...
  const s = Nr(), [i, l] = M(t), [p, w] = M(n);
  return q(() => {
    l(t);
  }, [t]), q(() => {
    p !== n && w(n);
  }, [n]), /* @__PURE__ */ d(ee, { onOpenChange: (f) => {
    f || (i !== "custom" || p ? (e(i), o(p)) : (l(t), w(n)));
  }, children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "outline", className: "tw-h-6", children: Nl(t, a, n) }) }) }),
...
function Md({
  ...
  const l = et(null), p = Nr(), [w, c] = M("generated"), [f, h] = M("*"), [m, b] = M("f"), v = L(
    () => ({
      ...s,
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Tr, {}) }) }),
  ...
  return /* @__PURE__ */ d(Ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Je, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      Rt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Kt, { children: `${K.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(Kt, { children: Il(i.text) })
        ]
      },
...
const $l = "16rem", Ll = "3rem", Do = g.createContext(void 0);
function Ze() {
  const t = g.useContext(Do);
  if (!t)
    throw new Error("useSidebar must be used within a SidebarProvider.");
  return t;
}
const Io = g.forwardRef(
  ({
    defaultOpen: t = !0,
    open: e,
    onOpenChange: n,
    ...
    return /* @__PURE__ */ r(Do.Provider, { value: N, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
Io.displayName = "SidebarProvider";
const Oo = g.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Ze();
...
Ao.displayName = "SidebarMenu";
const Po = g.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "li",
    {
      ref: n,
...
Po.displayName = "SidebarMenuItem";
const Ul = Lt(
  ...
  ({
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Ut, { asChild: !0, children: c }),
...
function Ql({
  ...
  return /* @__PURE__ */ r(
    Oo,
    {
      ...
      children: /* @__PURE__ */ d(Mo, { children: [
        /* @__PURE__ */ d(En, { children: [
          /* @__PURE__ */ r(Tn, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Rn, { children: /* @__PURE__ */ r(Ao, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Po, { children: /* @__PURE__ */ r(
            $o,
            {
              onClick: () => w(h),
              isActive: f(h),
    ...
    /* @__PURE__ */ d(
      Io,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Vo, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Mt = "scrBook", tw = "scrRef", Gt = "source", ew = "details", nw = "Scripture Reference", rw = "Scripture Book", Lo = "Type", ow = "Details";
function aw(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? K.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Mt ? ne(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Gt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Lo : void 0,
    ...
    !e && /* @__PURE__ */ d(
      le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Zt, { position: "item-aligned", children: /* @__PURE__ */ r(al, { children: _.map((T) => /* @__PURE__ */ r(mt, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
...
}), zo = (t, e, n) => Jn(t, e).every((o) => n.includes(o));
function iw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    $,
    {
      ...
      onClick: () => o(t),
      className: u(
        zo(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Ks(
        t,
...
function lw({
  ...
  const C = L(() => K.allBookIds.filter(
    ...
    (I) => {
      ...
      n(
        zo(C, I, e) ? e.filter((V) => !J.includes(V)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, C]
  ), z = () => {
                  ...
                  Object.values(F).map((I, J) => {
                    ...
                    if (V.length !== 0)
                      return /* @__PURE__ */ d(kr, { children: [
                        ...
                        J < Object.values(F).length - 1 && /* @__PURE__ */ r(qr, {})
                      ] }, I);
                  })
                ] })
              ]
...
const jo = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Ut, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(_o, { children: l.label }),
    /* @__PURE__ */ r(Qi, { children: /* @__PURE__ */ r(Co, { children: jo(
      t,
      e,
      Bo(t, l.id),
      o
...
function Sn({
  ...
  return /* @__PURE__ */ d(ee, { variant: s, children: [
    ...
    /* @__PURE__ */ r(zt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, w]) => typeof p == "boolean" || typeof w == "boolean" ? 0 : p.order - w.order).map(([p], w, c) => /* @__PURE__ */ d(kr, { children: [
      /* @__PURE__ */ r(ko, { children: /* @__PURE__ */ r(St, { children: jo(e.groups, e.items, p, t) }) }),
      w < c.length - 1 && /* @__PURE__ */ r(be, {})
    ] }, p)) })
  ] });
}
const Fo = g.forwardRef(
...
function tc({
  ...
  return /* @__PURE__ */ d(Fo, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Sn,
      {
        onSelectMenuItem: t,
...
function ec({
  ...
  return /* @__PURE__ */ r(Fo, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    Sn,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Go = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.Root,
    {
...
const Ho = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.List,
  {
    ref: n,
    className: u(
...
Ho.displayName = ct.List.displayName;
...
)), Xo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: u(
...
Xo.displayName = ct.Content.displayName;
function nc({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Go, { children: [
      /* @__PURE__ */ r(Ho, { children: t.map((l) => /* @__PURE__ */ r(ww, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Xo, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function dw({ ...t }) {
...
const Uo = g.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = g.useMemo(
    () => ({
      variant: e
    }),
...
Uo.displayName = Q.Root.displayName;
...
const Yo = g.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Q.SubTrigger,
    {
...
Yo.displayName = Q.SubTrigger.displayName;
const qo = g.forwardRef(({ className: t, ...e }, n) => {
  const o = bt();
  return /* @__PURE__ */ r(
    Q.SubContent,
    {
...
qo.displayName = Q.SubContent.displayName;
const Jo = g.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = bt();
...
Jo.displayName = Q.Content.displayName;
const Wo = g.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ r(
    Q.Item,
    {
...
Wo.displayName = Q.Item.displayName;
...
const Zo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Q.Separator,
  {
    ref: n,
    className: u("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
Zo.displayName = Q.Separator.displayName;
const Ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ut, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        Wo,
        {
          onClick: () => {
            o(w);
        ...
        /* @__PURE__ */ r(Yo, { children: w.label }),
        /* @__PURE__ */ r(qo, { children: Qo(
          t,
          e,
          Bo(t, w.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(Zo, {}, `separator-${s}`)), p;
  });
};
function hw({
  menuData: t,
  ...
  if (Rs(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    ...
    return /* @__PURE__ */ r(Uo, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, f]) => typeof c == "boolean" || typeof f == "boolean" ? 0 : c.order - f.order).map(([c, f]) => /* @__PURE__ */ d(dw, { children: [
      /* @__PURE__ */ r(Ko, { ref: w(c), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Jo,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(St, { children: Qo(t.groups, t.items, c, e) })
        }
      )
    ] }, c)) });
}
...
function ac({
  ...
  return /* @__PURE__ */ d("div", { id: p, className: u("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(at, { className: "tw-font-normal tw-text-muted-foreground", children: re(w, {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ee, { children: [
              /* @__PURE__ */ r(ge, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Er, {}) }) }),
...
function Ow({
  ...
  return /* @__PURE__ */ r(ta.Provider, { value: o, children: /* @__PURE__ */ r(
    gt.Root,
    {
...
const hc = gt.Trigger, Vw = gt.Portal, fc = gt.Close, ea = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
...
ea.displayName = gt.Overlay.displayName;
const Mw = g.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = g.useContext(ta), i = {
...
export {
  ...
  mt as SelectItem,
  il as SelectLabel,
  Ro as SelectScrollDownButton,
  To as SelectScrollUpButton,
  ...
  Go as VerticalTabs,
  Xo as VerticalTabsContent,
  Ho as VerticalTabsList,
