...
import { Avatar as $o, Select as Zt, Checkbox as un, Slot as qr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
...
function qa({
  ...
  const T = Ce(), B = rd(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    ...
    if (!A) return;
    const v = M.startsWith(`${A.book} `) ? M : "", H = ta(v), at = Ir(v);
    return {
      book: A.book,
      chapterNum: at ?? A.chapterNum ?? 1,
  ...
  const Qt = j(() => {
    ...
    (v) => {
      const H = q ?? (A == null ? void 0 : A.book), at = ot ?? (A == null ? void 0 : A.chapterNum);
      !H || !at || (ft({
        book: H,
        chapterNum: at,
        verseNum: v
    ...
    (v) => {
      const H = N === "chapters" ? O : A == null ? void 0 : A.book;
      if (H) {
        if (w && w(H, v) > 1) {
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => A ? !!A.chapterNum && !v.toString().includes(A.chapterNum.toString()) : !1,
    [A]
  ), Pa = V(
    () => De(
      t,
    ...
    () => B >= Ar.TIGHT ? zr(t.book, s) : Re(t.book, s),
    [t.book, s, B]
  ), Aa = `${t.chapterNum}:${t.verseNum}`, Tr = j((v) => (H) => {
    Rt.current[v] = H;
  }, []), Sr = j((v) => (H) => {
    Nt.current[v] = H;
  }, []), sr = V(
    () => wd(U),
    [U]
  ), be = V(() => !w || !A || !A.chapterNum || !sr ? !1 : w(A.book, A.chapterNum) > 0, [w, A, sr]), cr = N === "books" && !St && !U.trim() && zt.size > 0, $a = j(
    (v) => p ? mn(v, p) : !1,
    [p]
  ), Se = j(
    (v) => (H) => p ? ud(v, H, p) : !1,
    ...
    (v) => {
      (v.key === "Home" || v.key === "End") && v.stopPropagation(), h && h.includes(v.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (v.preventDefault(), v.stopPropagation(), Qt());
    },
    [h, A, Qt]
  ), Zr = j(
    (v) => {
      ...
      if (!(!!H && !!((Yo = bt.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const $t = bt.current ? vd(bt.current) : [];
        if ($t.length === 0) {
          v.preventDefault(), v.stopPropagation();
          return;
        }
        const de = $t[$t.length - 1], Gt = v.shiftKey ? $t[0] : de;
        document.activeElement === Gt && (v.preventDefault(), v.stopPropagation(), (v.shiftKey ? de : $t[0]).focus());
        return;
      }
      ...
      if (N === "books" && A && !St && v.key === "Enter" && !(H !== gt.current && !!(H != null && H.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (N === "books" && !Ht && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const $t = H === gt.current ? gt.current : void 0, de = ($t == null ? void 0 : $t.selectionStart) ?? 0, Gt = ($t == null ? void 0 : $t.selectionEnd) ?? 0, he = T === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!$t && (de !== Gt || (he ? de > 0 : Gt < $t.value.length))) return;
      }
      if (v.shiftKey || N === "books" && H !== gt.current && (H != null && H.closest('button, a, [role="button"]')))
        return;
      const yt = (() => {
        const $t = N === "books" && A && be && A.chapterNum ? { bookId: A.book, chapterNum: A.chapterNum } : void 0, de = N === "verses" ? { bookId: q, chapterNum: ot } : $t;
        if (de) {
        ...
        if (N === "chapters" || N === "books" && A && Le(A.book) > 1) {
          const Gt = N === "chapters" ? O : A == null ? void 0 : A.book;
          return Gt ? {
            max: Le(Gt),
            current: Ir(M) ?? 0,
  ...
  const Q = A ? `${A.book} ${A.chapterNum ?? ""} ${A.verseNum ?? ""} ${be}` : "", At = F(""), le = F(""), pe = V(() => {
    if (N !== "books" || !A || St) return;
    const { book: v, chapterNum: H, verseNum: at } = A;
    if (be && H && w)
      return {
        max: w(v, H),
  ...
  }, [N, A, pe, Q, M]), /* @__PURE__ */ u(er, { open: z, onOpenChange: ct, modal: k, children: [
        ...
        children: [
          f ?? /* @__PURE__ */ a(
            od,
            {
              primary: Go,
              secondary: Aa,
              showSecondary: B < Ar.MINIMUM,
              isPartial: B >= Ar.TIGHT,
              fullText: Pa
            }
          ),
          x && /* @__PURE__ */ a(
            ...
            children: [
              ...
              !St && /* @__PURE__ */ u(or, { ref: xt, children: [
                N === "books" && /* @__PURE__ */ u(ht, { children: [
                  ...
                  A && mt && /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ u(
                    Ge,
                    {
                      value: nd,
                      onSelect: Qt,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: zr(A.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  A && be && A.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  /* @__PURE__ */ a(
                    bn,
                    {
                      ...
                      onVerseSelect: R,
                      setVerseRef: Sr,
                      isVerseDisabled: lr(A.book, A.chapterNum),
                      suppressKeyboardHighlight: pt,
                      className: "tw:px-4 tw:pb-4"
                    }
                  ),
                  A && !be && Le(A.book) > 1 && // No heading here either, for the same reason as the verse preview above:
...
ue({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ae();
...
function dh({
  ...
  const [s, i] = _(Aw), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  Y(() => {
    let g = !0;
    const S = h.current;
    if (!S) return;
...
function rs({
  ...
  }, [s, r]), zt = V(() => Nt.slice(1), [Nt]), kt = V(() => zt.length ?? 0, [zt.length]), ve = V(() => kt > 0, [kt]), A = V(() => it || kt <= 2 ? zt : zt.slice(-2), [zt, kt, it]), mt = V(() => it || kt <= 2 ? 0 : kt - 2, [kt, it]), ce = V(
  ...
  const R = j(
    ...
    async (y) => {
      const G = we(U) ? _a(U) : void 0, $ = y.status ? y.assignedUser : N ?? y.assignedUser, et = await p({
        ...y,
        contents: G,
        assignedUser: $
      });
      return et && ($ !== void 0 && I($), G && se()), et;
    },
    [se, U, p, N]
  );
      ...
      children: /* @__PURE__ */ u(Lw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            $e && /* @__PURE__ */ a(Vr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: $e }),
            /* @__PURE__ */ a(
              J,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ u(ht, { children: [
          ...
          o && /* @__PURE__ */ u(ht, { children: [
            W && A.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
            ...
            A.map((y) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              In,
              {
                comment: y,
                localizedStrings: r,
...
function Rh({
  ...
  const xt = j(() => {
    var y, G, $;
    const R = (y = f.current) == null ? void 0 : y.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), X = ($ = (G = f.current) == null ? void 0 : G.ownerDocument.getSelection()) == null ? void 0 : $.anchorNode;
  ...
  Y(() => {
    ...
    if (y && Dr("note", y)) {
      ...
      let nt = "custom";
      et === uo ? nt = "generated" : et === po ? nt = "hidden" : et && (P(et), B(et)), S(nt), C(nt), D((($ = y.insert.note) == null ? void 0 : $.style) ?? "f"), R = setTimeout(() => {
        var ct, _t, Pt;
  ...
  const qt = j(
    ...
    (R, K) => {
      var G, $, et;
      const X = ($ = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : $.at(0);
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      const nt = ($ = (G = K.insert.note) == null ? void 0 : G.contents) == null ? void 0 : $.ops;
    ...
    (R) => {
      ...
      if (K && Dr("note", K)) {
        ...
        const nt = (G = K.insert.note) == null ? void 0 : G.style, ct = (et = ($ = K.insert.note) == null ? void 0 : $.contents) == null ? void 0 : et.ops;
        if (nt || W(!1), W(
    ...
    (R, K, X) => {
      ...
      Rs({
        ...
        applyItem: ($) => {
          var et;
          return (et = h.current) == null ? void 0 : et.applyMarkerMenuSelection($, {
            trigger: "backslash",
    ...
    (R) => {
      ...
      Ds(R, K, {
        ...
        commitTypedAndReopen: (y) => {
          var G;
          (G = h.current) == null || G.commitTypedMarker(y, { trailingSpace: !1 }), A();
        },
        commitTypedCloser: (y) => {
          var G;
        ...
        commitItem: (y) => {
          ...
          G && (($ = h.current) == null || $.applyMarkerMenuSelection(G, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    if (((X = bt.view) == null ? void 0 : X.markerMode) === "editable") {
      const y = ($) => {
        ...
        if ($.key === "Enter" && !xt()) {
          $.preventDefault(), $.stopPropagation(), (ct = h.current) == null || ct.selectNote(0), (_t = h.current) == null || _t.focus();
          return;
        }
        if (w && $.key === c) {
          if (!xt()) {
            $.preventDefault(), $.stopPropagation(), (Pt = h.current) == null || Pt.selectNote(0), (Vt = h.current) == null || Vt.focus();
            return;
          }
        ...
        var et, nt;
        const $ = R();
        !$ || document.activeElement !== $ || xt() || ((et = h.current) == null || et.selectNote(0), (nt = h.current) == null || nt.focus());
      };
    ...
    const R = () => {
      ...
      X && !X.isCollapsed || xt() || ((G = h.current) == null || G.selectNote(0), ($ = h.current) == null || $.focus());
    };
...
function rg({
  ...
  const T = Bt(
  ...
  ], vt = (L, Q, At = !1) => /* @__PURE__ */ u(ht, { children: [
    L,
    ...
    Nt((Q) => Q === "start" ? void 0 : Q), ft.current && (ft.current = !1, requestAnimationFrame(() => {
      var At;
      const Q = (At = oe.current) == null ? void 0 : At.querySelector("button");
      Q == null || Q.click();
    }));
  }, []), Ae = j((L) => {
    if (L) {
    ...
    repeatBookName: !0
  }) : kt ? vt(kt.label, kt.scrRefSuffix) : t, A = pt.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, R] = _(!1), [K, X] = _(void 0), [y, G] = _(void 0), [$, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    ep,
    {
      availableBookInfo: o,
  ...
  ), Cr = Rt === "end", Er = Rt === "start", ir = "tw:text-muted-foreground", Ye = p === "dropdown" && K === "range", Pa = Ye ? et : Ut, Aa = Ye ? ct : x ? $e : me, Tr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: oe, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        qa,
        {
          ...
          localizedStrings: k,
          getEndVerse: C,
          disableReferencesUpTo: Ye ? $ ?? Ht : Ht,
          onOpenChange: Ae,
          onCloseAutoFocus: (L) => {
            var Q;
  ...
  const [cr, $a] = _(null), [Se, lr] = _(null), [dr, Va] = _(null), Gr = 200, [La, Wr] = _(!1);
  Y(() => {
  ...
  const Yr = j(
    ...
    y !== void 0 && (y === "range" ? ($ && (m == null || m($)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), G(void 0));
  }, [
    y,
    $,
    nt,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(Ie, { open: Qt, onOpenChange: R, children: [
        ...
        /* @__PURE__ */ a(
          ze,
          {
            ...
            children: /* @__PURE__ */ u(ja, { container: dr, children: [
              A.map(({ value: L, label: Q, dropdownLabel: At, scrRefSuffix: le, id: pe }) => {
                  ...
                  Be,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ u("span", { className: "tw:flex tw:min-w-0 tw:flex-col tw:gap-0.5", children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex tw:items-center tw:gap-1.5", children: vt(At ?? Q, le, La) }),
                ...
                /* @__PURE__ */ a(
                  Be,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      qt.current || (At = (Q = bt.current) == null ? void 0 : Q.querySelector("button")) == null || At.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
        ...
        Co,
        {
          ...
          children: pt.map(({ value: L, label: Q, scrRefSuffix: At, id: le }) => {
            ...
            return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-0.5", children: [
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                ...
                /* @__PURE__ */ a(Mt, { htmlFor: le, children: vt(Q, At) })
              ] }),
...
const sp = Object.freeze([520, 420, 340]), ws = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = ds(n, sp), d = Ti() ?? l, w = d >= Ar.MINIMUM;
