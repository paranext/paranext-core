...
import { getChaptersForBook as Vl, deepEqual as _o, substring as zl, formatScrRef as Gr, compareScrRefs as so, scrRefToBBBCCCVVV as Xr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Fl, formatBytes as Ll } from "platform-bible-utils";
...
import { useReactTable as Ri, getFilteredRowModel as Ul, getSortedRowModel as Oi, getPaginationRowModel as Gl, getCoreRowModel as _i, flexRender as Nn, getGroupedRowModel as Xl, getExpandedRowModel as Yl } from "@tanstack/react-table";
...
var Gi = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Gi || {});
const Rt = class ot {
  constructor(e, n, r, o) {
  ...
  const o = kt(), [a, s] = ut(""), [l, c] = ut(
    ...
    (j) => {
      ...
      return {
        ...
        const U = at.bookIdToEnglishName(A).toLowerCase(), H = a.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return U.includes(H) || // Match book name
    ...
    Cc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, U = void 0, H = void 0] = M.slice(1), rt = _c(A);
    ...
    if (m === l) {
      ...
      const A = M === "ArrowRight" && !o || M === "ArrowRight" && o === "ltr" || M === "ArrowLeft" && o === "rtl", U = M === "ArrowLeft" && !o || M === "ArrowLeft" && o === "ltr" || M === "ArrowRight" && o === "rtl";
      let H = 0;
      if (A)
        if (d < pn(m))
          H = 1;
      ...
      gr,
      {
        ...
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: Ra.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ y("div", { children: [
            ...
            A.map((U) => /* @__PURE__ */ i("div", { children: /* @__PURE__ */ i(
              kc,
              {
                bookId: U,
                handleSelectBook: () => R(U, !1),
                isSelected: l === U,
                handleHighlightBook: () => w(U),
                handleKeyDown: J,
                bookType: j,
                ref: (H) => {
                  l === U && (C.current = H);
                ...
                children: /* @__PURE__ */ i(
                  Ec,
                  {
                    ...
                    endChapter: pn(U),
                    activeChapter: t.bookNum === at.bookIdToNumber(U) ? t.chapterNum : 0,
...
Uc.displayName = yt.Label.displayName;
...
const Uo = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  lo.Root,
  {
    ref: n,
    className: x(
...
Uo.displayName = lo.Root.displayName;
...
function sh({
  ...
  const m = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), h = ne(n, "%webView_inventory_unapproved%"), b = ne(n, "%webView_inventory_unknown%"), f = ne(n, "%webView_inventory_scope_currentBook%"), g = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), T = ne(n, "%webView_inventory_filter_text%"), C = ne(
    ...
    var G, X;
    if (!S) return p;
    const N = (G = o == null ? void 0 : o.tableHeaders) == null ? void 0 : G.length;
    if (!N) return p;
    const O = [];
    for (let z = 0; z < N; z++)
      O.push(
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ y(Xe, { onValueChange: (N) => U(N), defaultValue: c, children: [
...
const Go = E.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  Ii.Root,
  {
    ref: o,
    decorative: n,
...
Go.displayName = Ii.Root.displayName;
  ...
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? at.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === le ? Gr(o.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => Gr(r.start),
      id: Sd,
      header: void 0,
      cell: (r) => {
        const o = r.row.original;
        return r.row.getIsGrouped() ? void 0 : Gr(o.start);
      },
      sortingFn: (r, o) => so(r.original.start, o.original.start),
      enableGrouping: !1
    },
...
function Ad() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var v = c, P = d, F = l, R = s, I = e, L = p, D = r, tt = b, J = h, j = n, M = a, A = o, U = m, H = !1;
    function rt($) {
    ...
    st.AsyncMode = v, st.ConcurrentMode = P, st.ContextConsumer = F, st.ContextProvider = R, st.Element = I, st.ForwardRef = L, st.Fragment = D, st.Lazy = tt, st.Memo = J, st.Portal = j, st.Profiler = M, st.StrictMode = A, st.Suspense = U, st.isAsyncMode = rt, st.isConcurrentMode = N, st.isContextConsumer = O, st.isContextProvider = G, st.isElement = X, st.isForwardRef = z, st.isFragment = K, st.isLazy = q, st.isMemo = W, st.isPortal = Y, st.isProfiler = Z, st.isStrictMode = Q, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = S;
  }()), st;
}
var Aa;
function gs() {
...
function Bd() {
  ...
  return eo = function(l, c) {
    ...
    function F(N) {
      ...
      function O(G, X, z, K, q) {
        for (var W = G[X], Y = 0; Y < N.length; Y++)
          if (b(W, N[Y]))
            return null;
    ...
    function I(N) {
      ...
      for (var O = 0; O < N.length; O++) {
        ...
        if (typeof G != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + H(G) + " at index " + O + "."
          ), s;
      }
    ...
    function L() {
      function N(O, G, X, z, K) {
        return j(O[G]) ? null : new f("Invalid " + z + " `" + K + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return g(N);
    }
    function D(N, O, G, X, z) {
      return new f(
        (N || "React class") + ": " + O + " type `" + G + "." + X + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + z + "`."
      );
    }
    function tt(N) {
      function O(G, X, z, K, q) {
...
function Yd() {
  return Ga || (Ga = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var P = s, F = a, R = t, I = c, L = n, D = w, tt = m, J = e, j = o, M = r, A = d, U = p, H = !1, rt = !1;
    function N(V) {
...
_r(Ir, $r, Mr, Up, Gp, Xp, Yp, Hp, qp, Wp, Kp, Jp);
function Ge(t, e) {
  return e === "grey" ? e : t;
}
const Zp = xt({
...
const Fu = 0.2, Lu = 0.14, Uu = 0.12;
function ht(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${Fu})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${Lu})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${Uu})`].join(",");
}
...
var _t = "top", Ut = "bottom", Gt = "right", Pt = "left", ra = "auto", Bn = [_t, Ut, Gt, Pt], Ke = "start", Pn = "end", Ew = "clippingParents", Ds = "viewport", fn = "popper", Sw = "reference", pi = /* @__PURE__ */ Bn.reduce(function(t, e) {
...
function Uw(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Kt(n.placement), c = ia(l), d = [Pt, Gt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !s)) {
    var m = Lw(o.padding, n), w = aa(a), h = c === "y" ? _t : Pt, b = c === "y" ? Ut : Gt, f = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Vn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - g / 2, S = m[h], v = T - w[p] - m[b], P = T / 2 - w[p] / 2 + C, F = En(S, P, v), R = c;
...
function wi(t) {
  ...
  if (d) {
    ...
    if (P === Bt(n) && (P = we(n), ae(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === _t || (o === Pt || o === Gt) && a === Pn) {
      S = Ut;
...
function Us(t) {
  return ["html", "body", "#document"].indexOf(Qt(t)) >= 0 ? t.ownerDocument.body : Lt(t) && ca(t) ? t : Us(jr(t));
}
function Sn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Us(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Bt(r), s = o ? [a].concat(a.visualViewport || [], ca(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function In(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Ew : l, d = n.rootBoundary, p = d === void 0 ? Ds : d, m = n.elementContext, w = m === void 0 ? fn : m, h = n.altBoundary, b = h === void 0 ? !1 : h, f = n.padding, g = f === void 0 ? 0 : f, k = Fs(typeof g != "number" ? g : Ls(g, Bn)), T = w === fn ? Sw : fn, C = t.rects.popper, S = t.elements[b ? T : w], v = of(_e(S) ? S : S.contextElement || we(t.elements.popper), c, p, s), P = Ze(t.elements.reference), F = Gs({
    reference: P,
    element: C,
    placement: o
  ...
  if (w === fn && D) {
    ...
    Object.keys(L).forEach(function(J) {
      var j = [Gt, Ut].indexOf(J) >= 0 ? 1 : -1, M = [_t, Ut].indexOf(J) >= 0 ? "y" : "x";
      L[J] += tt[M] * j;
    });
  }
  return L;
...
function lf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, m = n.rootBoundary, w = n.altBoundary, h = n.flipVariations, b = h === void 0 ? !0 : h, f = n.allowedAutoPlacements, g = e.options.placement, k = Kt(g), T = k === g, C = c || (T || !b ? [or(g)] : sf(g)), S = [g].concat(C).reduce(function(z, K) {
      ...
      var D = S[L], tt = Kt(D), J = Qe(D) === Ke, j = [_t, Ut].indexOf(tt) >= 0, M = j ? "width" : "height", A = In(e, {
        placement: D,
        boundary: p,
        rootBoundary: m,
        altBoundary: w,
      ...
      v[M] > P[M] && (U = or(U));
      var H = or(U), rt = [];
      if (a && rt.push(A[tt] <= 0), l && rt.push(A[U] <= 0, A[H] <= 0), rt.every(function(z) {
        return z;
      })) {
        I = D, R = !1;
        break;
...
function bf(t) {
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? _t : Pt, M = S === "y" ? Ut : Gt, A = S === "y" ? "height" : "width", U = P[S], H = U + g[j], rt = U - g[M], N = h ? -R[A] / 2 : 0, O = T === Ke ? F[A] : R[A], G = T === Ke ? -R[A] : -F[A], X = e.elements.arrow, z = h && X ? aa(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : zs(), q = K[j], W = K[M], Y = En(0, F[A], z[A]), Z = C ? F[A] / 2 - N - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + N + Y + W + L.mainAxis : G + Y + W + L.mainAxis, dt = e.elements.arrow && Vn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Et = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = U + Z - Et - $, Nt = U + Q - Et, Yt = En(h ? pr(H, V) : H, U, h ? Ee(rt, Nt) : rt);
      P[S] = Yt, tt[S] = Yt - U;
    }
    if (l) {
      var fe, Ct = S === "x" ? _t : Pt, Ln = S === "x" ? Ut : Gt, Ht = P[v], $e = v === "y" ? "height" : "width", me = Ht + g[Ct], Me = Ht - g[Ln], Ae = [_t, Pt].indexOf(k) !== -1, De = (fe = D == null ? void 0 : D[v]) != null ? fe : 0, he = Ae ? me : Ht - F[$e] - R[$e] - De + L.altAxis, on = Ae ? Ht + F[$e] + R[$e] - De - L.altAxis : Me, Un = h && Ae ? Fw(he, Ht, on) : En(h ? he : me, Ht, h ? on : Me);
      P[v] = Un, tt[v] = Un - Ht;
    }
...
`));
    ...
    const U = _f(I, k.current, _({
      placement: P
    }, m, {
      modifiers: A
    }));
    return v.current(U), () => {
      U.destroy(), v.current(null);
    };
  }, [I, l, c, d, m, P]);
  const D = {
    placement: F
...
var Lf = function(e) {
  return e.scrollTop;
}, vn = "unmounted", ve = "exited", ye = "entering", Ue = "entered", xo = "exiting", ie = /* @__PURE__ */ function(t) {
  zf(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = ve, a.appearStatus = ye) : c = Ue : r.unmountOnExit || r.mountOnEnter ? c = vn : c = ve, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ye && s !== Ue && (a = ye) : (s === ye || s === Ue) && (a = xo);
    }
...
const Xf = {
  ...
  const {
  ...
  } = e, k = St(e, Gf), T = gn(), C = B.useRef(), S = Ys(), v = B.useRef(null), P = Re(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const U = v.current;
      A === void 0 ? M(U) : M(U, A);
    }
    ...
    let N;
    f === "auto" ? (N = S.transitions.getAutoHeightDuration(M.clientHeight), C.current = N) : N = U, M.style.transition = [S.transitions.create("opacity", {
      duration: N,
      delay: H
...
const qs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = na({
    ...
    children: R
  }), Yt = Ys(), fe = Yt.direction === "rtl", [Ct, Ln] = B.useState(), [Ht, $e] = B.useState(null), me = B.useRef(!1), Me = j || rt, Ae = gn(), De = gn(), he = gn(), on = gn(), [Un, pa] = ks({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Vr = Ns(N), an = B.useRef(), Gn = ho(() => {
  ...
  const ua = (et) => {
    ...
    me.current && et.type !== "touchstart" || (Ct && Ct.removeAttribute("title"), De.clear(), he.clear(), A || Zn && U ? De.start(Zn ? U : A, () => {
      ua(et);
    }) : ua(et));
  }, wa = (et) => {
    De.clear(), he.start(O, () => {
    ...
    ba(et), he.clear(), Ae.clear(), Gn(), an.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", on.start(H, () => {
      document.body.style.WebkitUserSelect = an.current, zr(et);
    });
  }, ol = (et) => {
    Nt.props.onTouchEnd && Nt.props.onTouchEnd(et), Gn(), he.start(G, () => {
      Xn(et);
    });
  };
  B.useEffect(() => {
...
`));
  const sl = B.useMemo(() => {
    ...
    touch: me.current
  }), Ur = Jf(cn), xa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Zf, Na = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : wr, ka = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Qf, Ea = (p = (m = Q.arrow) != null ? m : I.Arrow) != null ? p : tm, ll = bn(xa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ke(Ur.popper, Y == null ? void 0 : Y.className, (h = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : h.className)
  }), cn), cl = bn(Na, _({}, Et, (f = Z.transition) != null ? f : L.transition), cn), dl = bn(ka, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ke(Ur.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), cn), pl = bn(Ea, _({}, (C = Z.arrow) != null ? C : L.arrow, {
    className: ke(Ur.arrow, (S = (v = Z.arrow) != null ? v : L.arrow) == null ? void 0 : S.className)
  }), cn);
...
function vh({
  ...
  return /* @__PURE__ */ i(
    "div",
    {
      className: x("tw-border tw-px-4 tw-text-foreground", n),
      ref: c,
...
const xh = $t.Root, Tm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = kt();
  return /* @__PURE__ */ i(
    $t.List,
    {
...
export {
  ...
  bh as getToolbarOSReservedSpaceClassName,
