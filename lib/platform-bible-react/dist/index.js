...
), gt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Eo.Root, { ref: n, className: h("pr-twp", ml(), t), ...e }));
gt.displayName = Eo.Root.displayName;
    ...
    kr,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(gt, { className: "tw-flex tw-items-center", children: o.map((v) => ut.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
function Sp({
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      y !== "x" && _ === "x" ? ct == null || ct.forEach((Dt) => bc(Dt)) : y === "x" && _ !== "x" && (ct == null || ct.forEach((Dt) => vc(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
...
function Qp({
  ...
  return /* @__PURE__ */ p("div", { id: w, className: h("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(gt, { className: "tw-font-normal tw-text-muted-foreground", children: ve(c, {
