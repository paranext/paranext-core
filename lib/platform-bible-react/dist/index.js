...
import { c as m, g as ge, a as _r, C as Se, u as Mo, T as Mt, b as Ot, d as It, e as $t, A as le, P as Ve, f as Qe, B as X, h as Le, i as je, j as Be, k as Ee, x as Xi, l as Ji, m as Zi, I as Qi, n as io, r as be, o as ts, p as Nn, q as ia, s as sa, L as Tt, R as so, t as Zr, D as ja, v as Ba, w as Fa, y as Ua, z as Cn, E as Ur, F as co, G as En, H as lo, J as Je, K as Er, M as Fe, N as Ue, O as Ke, S as Tr, Q as ir, U as es, V as zr, W as Ze, X as $e, Z as tr, Y as Oe, _ as sr, $ as wo, a0 as uo, a1 as Qr, a2 as po, a3 as Tn, a4 as rs, a5 as as, a6 as os, a7 as Ka, a8 as Sn, a9 as ca, aa as ns, ab as Rn, ac as is, ad as ss, ae as cs, af as Oo, ag as ls, ah as ds, ai as ws, aj as us, ak as zn, al as Dn, am as ho, an as ps, ao as Mn, ap as Na, aq as Io, ar as Ca, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Dr, ay as go, az as bs, aA as xs } from "./resizable-4xR82Dua.js";
...
import { Section as Et, getChaptersForBook as tc, formatScrRef as Ne, formatReplacementString as Ie, getSectionForBook as Kr, formatRelativeDate as ec, sanitizeHtml as mo, NumberFormat as Ln, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as qr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as Vo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as Lo, formatReplacementStringToArray as jo, collectUsjMarkers as dc } from "platform-bible-utils";
import Gt, { useRef as U, useMemo as V, createContext as Mr, useContext as la, useState as _, useEffect as Y, useCallback as B, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Bo, Suspense as pc, forwardRef as jn, useId as Fo, Fragment as da } from "react";
...
import { Avatar as yo, Select as Wt, Checkbox as Ho, Slot as Ir, Tabs as de, Menubar as xe, ContextMenu as Pt, Progress as Go, Slider as Vr, Switch as Wo } from "radix-ui";
...
function Ra({
  ...
  const { otLong: $, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    () => F >= Hr.TIGHT ? _r(t.book, i) : ge(t.book, i),
    [t.book, i, F]
  ), $r = `${t.chapterNum}:${t.verseNum}`, He = B((k) => (rt) => {
    St.current[k] = rt;
  }, []), ze = B((k) => (rt) => {
    Ft.current[k] = rt;
  }, []), Pr = V(
    () => Pl(L),
    [L]
  ), fa = V(() => !w || !P || !P.chapterNum || !Pr ? !1 : w(P.book, P.chapterNum) > 0, [w, P, Pr]), ma = N === "books" && !jt && !L.trim() && Jt.size > 0, Ar = B(
    (k) => p ? Xo(k, p) : !1,
    [p]
  ), mr = B(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
        ...
        children: [
          g ?? /* @__PURE__ */ a(
            Ml,
            {
              primary: ae,
              secondary: $r,
              showSecondary: F < Hr.MINIMUM,
              isPartial: F >= Hr.TIGHT,
              fullText: Vt
            }
          ),
          b && /* @__PURE__ */ a(
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ul = di ? te : Y, jr = { tag: vo };
...
function sd(t) {
  const e = Gn(t, (r) => Sr(r) && !r.isInline());
...
function cd(t) {
  ...
  if (me(e)) r = Cc(e.focus, "next");
    ...
    r = r || Ec(Ae(), "previous").getFlipped().insert(Or());
  }
...
function ld(t, e, r) {
  ...
  return Oc(o) && ta(283), o.insert(t.isInline() ? Or().append(t) : t), Uo(Hn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = ee();
  if (!me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Gn(i, (d) => Sr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
const Eo = 0, oo = 1, xi = 2, Oa = 3, Br = 4, or = 5, Ia = 6, yr = 7;
function $a(t) {
  return t.id === Eo;
}
function yi(t) {
...
class xd {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(c, l, d) {
      return Object.assign(c, { id: Br, initResult: l, registerState: d });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
    let o;
    r.id !== Br && wt(307, String(r.id), String(or)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Br;
    }(e) || wt(313, String(e.id), String(Br)), e.initResult;
  }
  getInitPeer(e) {
...
const Nd = /* @__PURE__ */ new Set(), ln = ie({ build(t, e, r) {
  const o = r.getDependency(ao).output, n = Rr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = vi(() => {
  }, () => ve(() => {
...
ie({ dependencies: [ao, ln], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(ln).output, n = Rr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
      ...
      children: /* @__PURE__ */ u(iw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            P && /* @__PURE__ */ a(Er, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: P }),
            /* @__PURE__ */ a(
              X,
              {
                variant: "ghost",
          ...
          children: r.map((T, I) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Gt.Fragment, { children: [
                ...
                I < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Tr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, F)
            );
          })
        }
...
function lu({
  ...
  const c = t ? Ir.Root : "button", { state: l } = ga(), d = /* @__PURE__ */ a(
    c,
    {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === La ? La : _n
      ).map((d) => /* @__PURE__ */ a(Er, { className: "tw:hover:bg-secondary", variant: "secondary", children: ge(d, n) }, d)),
...
function yh({
  ...
  const I = zt(
  ...
  ), ae = Yt === "end", $r = Yt === "start", He = "tw:text-muted-foreground", ze = w === "dropdown" && S === "range", Pr = ze ? $ : Re, ma = ze ? ct : f ? oe : ht, Ar = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Bt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-end", className: m($r && He), children: H }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
          ...
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: ar, children: [
              ...
              v && /* @__PURE__ */ u(dt, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(zr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: ut }),
                /* @__PURE__ */ a(
                  Je,
                  {
                    ref: Ft,
...
const Tu = Object.freeze([520, 420, 340]), Ui = Gt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    const c = B((w) => {
      i(w ?? void 0);
      const p = s.current;
      typeof p == "function" ? p(w) : p && (p.current = w);
    }, []), l = Fi(n, Tu), d = ii() ?? l;
