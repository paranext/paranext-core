...
import { c as m, g as Te, a as Fa, C as Ne, A as se, P as Me, b as He, B as K, d as Oe, e as $e, f as Ie, h as ke, i as Vi, k as Pi, j as ji, E as Li, l as Ua, r as pe, m as Bi, n as cn, o as Qr, p as ta, L as _t, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as ln, v as Pr, w as $t, x as qa, y as It, z as At, F as Vt, G as dn, H as Ga, I as Ke, J as yr, K as Ae, M as Ve, N as Pe, S as kr, O as er, Q as Fi, U as Cr, V as Ge, W as Se, Z as Ye, X as ze, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as wn, a3 as Ui, a4 as Ki, a5 as qi, a6 as za, a7 as un, a8 as ea, a9 as pn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as hn, af as Xi, ag as ca, ah as bo, ai as la, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Er, ap as Xa, aq as rs, ar as as } from "./resizable-BwezOpOQ.js";
import { as as og, at as ng, au as ig, av as sg, aw as cg, ax as lg, ay as dg, az as wg, aA as ug, aB as pg, aC as hg, aD as gg, aE as fg, aF as mg, aG as vg, aH as bg, aI as xg, aJ as yg, aK as kg, aL as _g, aM as Ng, aN as Cg, aO as Eg, aP as Tg, aQ as zg } from "./resizable-BwezOpOQ.js";
...
import { useReactTable as Pn, getFilteredRowModel as Zc, getSortedRowModel as jn, getPaginationRowModel as Qc, getCoreRowModel as Ln, flexRender as br, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
...
function pa({
  ...
  const B = pe(), [T, I] = _(!1), [A, C] = _(""), [V, q] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [z, $] = _(
    void 0
  ), [W, Z] = _(void 0), [Et, Pt] = _(!1), Dt = F(null), G = F(!1), tt = F(void 0), ct = F(void 0), lt = F(void 0), gt = F(void 0), jt = F({}), ht = F({}), bt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((et) => {
      x[et] = Tt[et].filter((Ut) => Ua(Ut, V, n));
    }), x;
  }, [Tt, V, n]), R = D(
    () => pl(V, Zt, n),
    [V, Zt, n]
  ...
  const { otLong: ut, ntLong: ft, dcLong: zt, extraLong: Bt } = {
    ...
    const { isLetter: U, isDigit: et } = Io(x.key);
    (U || et) && (x.preventDefault(), q((be) => be + x.key), ct.current.focus(), Pt(!1));
  }, []);
  return ee(() => {
    const x = setTimeout(() => {
...
function Po({
  ...
  const [N, M] = _(!1), B = d ?? l, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
    const V = l(A), q = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, k = `${C ?? ""}${V}${q ?? ""}`;
    return /* @__PURE__ */ u(
      Ne,
      {
        value: V,
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((T || I) && M !== null && B !== null) {
        const A = function(C, V, q, k, J, j, Y) {
          const z = (C._window ? C._window.document : document).createRange();
          return z.setStart(...jo(V, q, k)), z.setEnd(...jo(J, j, Y)), z;
        }(t, g, f, M, h, E, B);
        l(), l = Dl(t, A, e);
      }
...
function Al(t) {
  ...
  const o = Vl(t, r), n = sc(o), i = cc(n) ? lc(n) : o;
...
let Yr, ye = 0, Wr = 0, Bl = 0, Pa = 0, Br = 0;
function Bo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
qt.prototype.brand = jl, qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ye !== 0 && Wr === 0 && e.l !== Pa && (e.l = Pa, Yr = { S: e, v: e.v, i: e.i, o: Yr });
  ...
  return _e(t.registerCommand(Ic, (o) => {
    ...
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Vc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Pc(h), h.anchor.is(d)) return !0;
      }
      return !1;
    ...
    "div",
    {
      ...
      children: [
        ...
        B && /* @__PURE__ */ u(Ae, { children: [
          /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ds, {}) }) }),
...
function mi({
  ...
  const [k, J] = _(Zo), [j, Y] = _(), [z, $] = _(), W = o, [Z, Et] = _(!1), [Pt, Dt] = _(!1), [G, tt] = _(!1), [ct, lt] = _(!1), [gt, jt] = _(!1), [ht, bt] = _(M), [Ht, Tt] = _(!1), Zt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  const Lt = D(() => Nt[0], [Nt]), me = F(null), re = F(void 0), P = L(() => {
    var S;
  ...
  const Ft = L(
    async (S) => {
      ...
      kt && await p({ threadId: l, contents: kt }) && P();
    },
    [
      P,
      k,
    ...
    async (S) => {
      ...
      return Qt && (Ct !== void 0 && $(Ct), kt && P()), Qt;
    },
    [P, k, p, j]
  );
  ...
  const ve = /* @__PURE__ */ a(
    Jo,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: Dt,
      canEditOrDelete: (!Pt && fe.get(Lt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ u(st, { children: [
            ...
            ut.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Jo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: Dt,
                canEditOrDelete: (!Pt && fe.get(S.id)) ?? !1
              }
            ) }, S.id)),
            v !== !1 && (!Pt || oe(k)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
...
), Pd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Pd(Za(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function jd({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", q = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), k = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : q, J = () => {
    const z = o ?? "accept";
...
function qd({ table: t }) {
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Xd({
  ...
  var T;
  const [w, p] = _([]), [g, h] = _([]), [f, b] = _({}), [v, E] = _({}), y = D(() => e ?? [], [e]), N = Pn({
    data: y,
    columns: t,
    getCoreRowModel: Ln(),
...
function hp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "default", children: [
...
function nw({
  ...
  return /* @__PURE__ */ u(Ae, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: ow(t, n, r) }) }) }),
...
function cw({
  ...
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(At, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: iw(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: sw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Pe, { style: { zIndex: un }, children: [
...
function vp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [M, B] = _("*"), [T, I] = _("f"), [A, C] = _(!1), [V, q] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [z, $] = _(!1), [W, Z] = _(), [Et, Pt] = _(), [Dt, G] = _(), [tt, ct] = _(), lt = F(null), gt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Or("note", Q)) {
      ...
      let it = "custom";
      ot === Ia ? it = "generated" : ot === Aa ? it = "hidden" : ot && (N(ot), B(ot)), b(it), E(it), I(((rt = Q.insert.note) == null ? void 0 : rt.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const ht = L(
    (P, Q, at = !1) => {
      ...
      if (rt && Or("note", rt)) {
        if (rt.insert.note) {
          let ut;
          P === "custom" ? ut = Q : P === "generated" ? ut = Ia : ut = Aa, rt.insert.note.caller = ut;
        }
  ...
  const Zt = () => {
    ...
    if (Q && Or("note", Q)) {
      ...
      T !== "x" && P === "x" ? ut == null || ut.forEach((ft) => hw(ft)) : T === "x" && P !== "x" && (ut == null || ut.forEach((ft) => gw(ft))), (yt = w.current) == null || yt.applyUpdate([Q, { delete: 1 }]);
    }
  }, Nt = (P) => {
    ct(P.contextMarker), J(P.canRedo);
  }, Lt = L(
    (P) => {
      var at, rt, ot, it, yt;
      const Q = (rt = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : rt.at(0);
    ...
    if (g.current && jt.length && P && P.rangeCount > 0) {
      const Q = P.getRangeAt(0).getBoundingClientRect(), at = g.current.getBoundingClientRect();
      Z(Q.left - at.left), Pt(Q.top - at.top), G(Q.height), $(!0);
    }
  }, [jt, g]);
  H(() => {
    const P = () => {
    ...
    var P;
    z && ((P = lt.current) == null || P.focus());
  }, [z]), H(() => {
    var at;
    const P = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, Q = (rt) => {
      !z && P && document.activeElement === P && rt.key === c ? (rt.preventDefault(), me()) : z && rt.key === "Escape" && (rt.preventDefault(), $(!1));
    };
...
function zp({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), M = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = le(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, V] = _("all"), [q, k] = _(""), [J, j] = _([]), Y = D(() => {
    const G = t ?? [];
...
const Ee = "scrBook", Pw = "scrRef", Ue = "source", jw = "details", Lw = "Scripture Reference", Bw = "Scripture Book", yi = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Up({
  ...
  H(() => {
    if (c) {
      const C = E.getSelectedRowModel().rowsById, V = Object.keys(C);
      if (V.length === 1) {
        const q = b.find((k) => nn(k) === V[0]) || void 0;
        q && c(q);
      }
    }
  }, [h, b, c, E]);
  ...
  }, I = (C, V) => C.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), A = (C, V, q) => {
    if (!((C == null ? void 0 : C.length) === 0 || V.depth < q.column.getGroupedIndex())) {
      if (V.getIsGrouped())
        switch (V.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(ze, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
        ...
        /* @__PURE__ */ a(Gr, { colSpan: V.colSpan, className: "tw:sticky top-0", children: V.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          br(V.column.columnDef.header, V.getContext())
        ] }) }, V.id)
      )) }, C.id)) }),
      /* @__PURE__ */ a(Wa, { children: E.getRowModel().rows.map((C, V) => {
        const q = pe();
        return /* @__PURE__ */ a(
          ze,
          {
...
function qp({
  ...
  const B = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), q = St(s, "%webView_scope_selector_current_book%"), k = St(s, "%webView_scope_selector_choose_books%"), J = St(s, "%webView_scope_selector_scope%"), j = St(s, "%webView_scope_selector_select_books%"), Y = St(s, "%webView_scope_selector_range%"), z = St(s, "%webView_scope_selector_select_range%"), $ = St(s, "%webView_scope_selector_range_start%"), W = St(s, "%webView_scope_selector_range_end%"), Z = St(s, "%webView_scope_selector_ok%"), Et = St(s, "%webView_scope_selector_cancel%"), Pt = St(s, "%webView_scope_selector_navigate%"), Dt = (O) => {
    if (!b) return;
          ...
          Pe,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: te, children: [
              ...
              v && /* @__PURE__ */ u(st, { children: [
                /* @__PURE__ */ a(Ge, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Pt }),
                /* @__PURE__ */ a(
                  Ke,
                  {
                    ref: Zt,
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ae, { variant: i, children: [
    /* @__PURE__ */ a(Ve, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
    /* @__PURE__ */ a(Pe, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
            ...
            d && (e || g && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ae, { children: [
                  /* @__PURE__ */ a(Ve, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    K,
                    {
...
export {
  ...
  yg as Z_INDEX_FIRST_RUN,
  un as Z_INDEX_FOOTNOTE_EDITOR,
  kg as Z_INDEX_MODAL,
  _g as Z_INDEX_MODAL_BACKDROP,
  Wi as Z_INDEX_OVERLAY,
  Ng as badgeVariants,
  Cg as buttonGroupVariants,
