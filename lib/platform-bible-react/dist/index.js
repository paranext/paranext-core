...
function Wp({
  ...
  const Ft = j(
    ...
    (S, B) => {
      ...
      let b;
      S === "custom" ? b = B : S === "generated" ? b = Ja : b = Za, G.insert.note.caller !== b && (G.insert.note.caller = b, (et = h.current) == null || et.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var S;
...
function yh({
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, B] = _(void 0), [G, b] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
