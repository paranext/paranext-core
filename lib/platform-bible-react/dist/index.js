...
var Lt = (t, e, r) => Gi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Wt, Z as Hi, B as K, c as f, a as Yi, g as Ve, b as Ja, C as Re, A as le, P as Oe, d as Be, e as $e, f as Ue, h as Ke, i as ge, m as Wi, j as Za, k as Xi, l as fn, n as zr, o as ia, T as Kt, S as nr, p as qt, q as Gt, s as Ht, D as Xe, t as Nr, u as Te, v as ze, w as Se, x as rr, y as Ji, z as Sr, E as Je, F as Le, G as mn, H as Zi, I as Qi, J as vn, K as bn, L as ts, M as es, N as rs, O as as, Q as os, R as ma, Y as va, U as ur, V as ns, W as is, X as ss, _ as cs, $ as ls, a0 as Dr, a1 as Qa } from "./resizable-DC8lKmyJ.js";
import { a2 as gg, a3 as fg, a4 as mg, a5 as vg, a6 as bg, a7 as xg, a8 as yg, a9 as kg, aa as _g } from "./resizable-DC8lKmyJ.js";
import { jsx as a, jsxs as u, Fragment as nt } from "react/jsx-runtime";
import { Canon as ft } from "@sillsdev/scripture";
import { Check as je, Clock as Co, ChevronsLeft as Eo, ChevronsRight as To, ChevronLeft as Aa, ChevronRight as Pa, ArrowLeft as ds, ArrowRight as ws, ChevronDown as ir, BoldIcon as us, ItalicIcon as ps, X as sa, AtSign as xn, Pencil as hs, Trash2 as gs, ArrowUp as yn, MoreHorizontal as fs, MailOpen as ms, Mail as vs, ChevronUp as bs, FilterIcon as xs, ArrowLeftIcon as ys, ChevronLeftIcon as ks, ChevronRightIcon as _s, ArrowRightIcon as Ns, Copy as kn, Filter as Cs, User as Es, Link as Ts, CircleHelp as zs, ChevronsUpDown as _n, Star as Ss, Undo as Ds, Redo as Rs, SquareX as Nn, FunctionSquare as Cn, SquareSigma as En, Ban as Os, AlertCircle as Ia, CircleCheckIcon as $s, CircleXIcon as Ms, CircleHelpIcon as As, ArrowUpIcon as Ps, ArrowDownIcon as Is, Search as Vs, LoaderCircle as Ls, ScrollText as js, MenuIcon as Fs, Menu as Bs, EllipsisVertical as Us, MoreVertical as zo } from "lucide-react";
import { Section as dt, getChaptersForBook as Ks, formatScrRef as Ce, getSectionForBook as yr, formatRelativeDate as qs, formatReplacementString as Ne, sanitizeHtml as to, NumberFormat as Gs, formatBytes as Hs, getCurrentLocale as Ys, usfmMarkers as Ur, getFormatCallerFunction as Ws, deepEqual as Xs, isString as So, compareScrRefs as Va, scrRefToBBBCCCVVV as ba, defaultScrRef as xa, formatScrRefRange as Js, getLocalizeKeyForScrollGroupId as Do, collectUsjMarkers as Zs } from "platform-bible-utils";
import ut, { useRef as H, useMemo as $, useState as _, useCallback as U, useEffect as W, useImperativeHandle as Qs, useLayoutEffect as Qt, createContext as eo, useContext as Tn, Component as tc, createElement as Ro, Suspense as ec, forwardRef as ca, useId as Oo, Fragment as zn } from "react";
import { Dialog as fe, Label as rc, RadioGroup as La, ToggleGroup as Sn, Slot as pr, Avatar as ro, Select as Ft, Checkbox as $o, Tabs as we, Menubar as be, ContextMenu as zt, Progress as Mo, Slider as Ir, Switch as Ao } from "radix-ui";
import { createEditor as Dn, $getRoot as Fe, $createParagraphNode as Rr, $getSelection as Yt, HISTORY_MERGE_TAG as ao, ParagraphNode as Rn, TextNode as On, $getPreviousSelection as ac, $isRangeSelection as me, $caretFromPoint as oc, $getSiblingCaret as $n, $getChildCaret as nc, $getAdjacentChildCaret as ic, $isChildCaret as sc, $normalizeCaret as cc, $setSelectionFromCaretRange as lc, $getCollapsedCaretRange as dc, $getCaretInDirection as Po, $splitAtPointCaretNext as wc, $isTextPointCaret as uc, $findMatchingParent as Mn, $isElementNode as Cr, mergeRegister as De, getDOMTextNode as pc, isHTMLElement as hc, CLEAR_EDITOR_COMMAND as An, COMMAND_PRIORITY_EDITOR as oo, shallowMergeConfig as gc, defineExtension as oe, safeCast as Ze, createState as fc, FORMAT_TEXT_COMMAND as Pn, $isNodeSelection as In, COMMAND_PRIORITY_LOW as Vn, RootNode as mc, LineBreakNode as vc, TabNode as bc, $isEditorState as xc, createCommand as yc, CLICK_COMMAND as kc, isDOMNode as _c, $getNodeFromDOMNode as Nc, $createNodeSelection as Cc, $setSelection as Ec, $getEditor as Tc, DecoratorNode as ja, $getState as zc, toggleTextFormatType as Io, TEXT_TYPE_TO_FORMAT as Sc, $setState as Dc, addClassNamesToElement as Ln, $create as Rc, $getNodeByKey as Oc, removeClassNamesFromElement as $c, KEY_TAB_COMMAND as Mc, $isBlockElementNode as Ac, $createRangeSelection as Pc, $normalizeSelection__EXPERIMENTAL as Ic, OUTDENT_CONTENT_COMMAND as Vc, INDENT_CONTENT_COMMAND as Vo, INSERT_TAB_COMMAND as Lc, COMMAND_PRIORITY_CRITICAL as no, $isDecoratorNode as jc, $isParagraphNode as Fc, $isTextNode as Fa, SELECTION_CHANGE_COMMAND as jn, $insertNodes as Bc } from "lexical";
...
import { IconX as Yc, IconCheck as la, IconChevronDown as Wc, IconChevronUp as Xc, IconSelector as Jc, IconLayoutSidebar as Zc, IconLayoutSidebarRight as Qc, IconChevronRight as Fn, IconLoader as tl, IconAlertOctagon as el, IconAlertTriangle as rl, IconInfoCircle as al, IconCircleCheck as ol } from "@tabler/icons-react";
...
import { $generateHtmlFromNodes as il, $generateNodesFromDOM as sl } from "@lexical/html";
import { useReactTable as Un, getFilteredRowModel as cl, getSortedRowModel as Kn, getPaginationRowModel as ll, getCoreRowModel as qn, flexRender as kr, getGroupedRowModel as dl, getExpandedRowModel as wl } from "@tanstack/react-table";
import ul from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ba, HIDDEN_NOTE_CALLER as Ua, getDefaultViewOptions as pl, isInsertEmbedOpOfType as Vr, Editorial as hl } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as gl } from "react-hotkeys-hook";
...
function qa({
  ...
  const s = Wt();
  return /* @__PURE__ */ u(vl, { children: [
    /* @__PURE__ */ a(bl, { className: o }),
    /* @__PURE__ */ u(
      fe.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(fe.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(K, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Yc, {}),
...
function Lo({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(fe.Close, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function $r({ className: t, type: e, ...r }) {
  return /* @__PURE__ */ a(
    "input",
    {
      type: e,
...
function xl({
  ...
  return /* @__PURE__ */ u(Oe, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(ge, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Re,
      {
        onSelect: () => g(h),
...
function pp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function yl(t, e, r) {
  ...
  const i = da(o, e, "previous");
  if (i)
    return {
      book: i,
      chapterNum: Math.max(io(i), 1),
      verseNum: 1
    };
}
function kl(t, e, r) {
  const { book: o, chapterNum: n } = t;
  if (e.includes(o) && n < io(o))
    return { book: o, chapterNum: n + 1, verseNum: 1 };
  const i = da(o, e, "next");
  if (i)
...
function _l(t, e, r) {
  ...
  if (e === void 0) return;
  const s = da(o, e, "previous");
  if (!s) return;
  const c = Math.max(io(s), 1);
...
function Yn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ge, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function ka({
  ...
  const P = Wt(), [j, T] = _(!1), [I, M] = _(""), [E, D] = _(""), [z, N] = _("books"), [R, q] = _(void 0), [B, V] = _(
    void 0
  ), [O, Z] = _(void 0), [Q, Nt] = _(!1), Ct = H(null), Pt = H(!1), G = H(void 0), tt = H(void 0), wt = H(void 0), st = H(void 0), xt = H({}), ne = H({}), at = U(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), It = $(() => o ? o() : Xi, [o]), St = $(() => ({
    [dt.OT]: It.filter((Y) => ft.isBookOT(Y)),
    [dt.NT]: It.filter((Y) => ft.isBookNT(Y)),
    [dt.DC]: It.filter((Y) => ft.isBookDC(Y)),
    [dt.Extra]: It.filter((Y) => ft.extraBooks().includes(Y))
  }), [It]), Xt = $(() => Object.values(St).flat(), [St]), ie = $(() => {
    if (!E.trim()) return St;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = St[rt].filter((Vt) => Za(Vt, E, n));
    }), b;
  }, [St, E, n]), A = $(
    () => Sl(E, Xt, n),
    [E, Xt, n]
  ...
  const yt = U(() => {
    if (A) {
      const b = A.chapterNum ?? 1, Y = A.verseNum ?? 1;
      if (w && ya(A.book, b, Y, w))
        return;
      at({
        book: A.book,
        chapterNum: b,
    ...
    (b) => {
      const Y = B ?? (A == null ? void 0 : A.book), rt = O ?? (A == null ? void 0 : A.chapterNum);
      !Y || !rt || (at({
        book: Y,
        chapterNum: rt,
        verseNum: b
    ...
    (b) => {
      const Y = z === "chapters" ? R : A == null ? void 0 : A.book;
      if (Y) {
        if (d && d(Y, b) > 1) {
          V(Y), Z(b), N("verses"), M("");
          return;
    ...
    N("books"), q(void 0), V(void 0), Z(void 0), setTimeout(() => {
      tt.current && tt.current.focus();
    }, 0);
  }, []), ot = U(() => {
    const b = B;
    V(void 0), Z(void 0), b ? (q(b), N("chapters"), M("")) : X();
  }, [B, X]), et = U((b) => {
    T(b), b && (N("books"), q(void 0), V(void 0), Z(void 0), D(""));
  }, []);
  W(() => {
    k && et(!1);
  }, [k, et]);
  ...
  W(() => {
    var b;
    pt !== 0 && ((b = tt.current) == null || b.focus());
  }, [pt]), Qs(
    y,
    () => ({
      open: () => {
  ...
  const { otLong: mt, ntLong: ht, dcLong: vt, extraLong: Dt } = {
    ...
    () => Tl(E),
    [E]
  ), kt = $(() => !d || !A || !A.chapterNum || !$t ? !1 : d(A.book, A.chapterNum) > 0, [d, A, $t]), ue = U(
    (b) => w ? jo(b, w) : !1,
    [w]
  ), Ae = U(
    (b) => (Y) => w ? zl(b, Y, w) : !1,
    ...
    (b, Y) => (rt) => w ? ya(b, Y, rt, w) : !1,
    [w]
  ), fr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", mr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Mr = U(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), yt());
    },
    [p, A, yt]
  ), Ar = U(
    (b) => {
      var ke, Ge, Pe;
      if (b.ctrlKey) return;
      const { isLetter: Y, isDigit: rt } = Fo(b.key);
      if ((z === "chapters" || z === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const At = (ke = G.current) == null ? void 0 : ke.querySelector(
      ...
      if ((z === "chapters" || z === "verses") && (Y || rt)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (z === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), X();
        return;
      }
      if (z === "verses" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), ot();
        return;
      }
      const Vt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(b.key);
      if (z === "verses" && Vt) {
        const Mt = B, bt = O;
        if (!Mt || !bt || !d) return;
        const At = d(Mt, bt);
        if (!At) return;
        (Ge = G.current) == null || Ge.focus();
        const gt = (() => {
          if (!I) return 1;
          const He = I.match(/:(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            gt !== 0 && (ee = gt > 1 ? gt - 1 : At);
            break;
          case "ArrowRight":
            gt !== 0 && (ee = gt < At ? gt + 1 : 1);
            break;
          case "ArrowUp":
            ee = gt === 0 ? At : Math.max(1, gt - Zt);
            break;
          case "ArrowDown":
            ee = gt === 0 ? 1 : Math.min(At, gt + Zt);
            break;
          default:
            return;
        }
        ee !== gt && (b.preventDefault(), b.stopPropagation(), M(
          `${Mt} ${le[Mt] || ""} ${bt}:${ee}`
        ), setTimeout(() => {
          const He = ne.current[ee];
          He && He.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((z === "chapters" || z === "books" && A) && Vt) {
        const Mt = z === "chapters" ? R : A == null ? void 0 : A.book;
        if (!Mt) return;
        z === "chapters" && ((Pe = G.current) == null || Pe.focus());
        const bt = (() => {
          if (!I) return 1;
          const Zt = I.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            bt !== 0 && (gt = bt > 1 ? bt - 1 : At);
            break;
          case "ArrowRight":
            bt !== 0 && (gt = bt < At ? bt + 1 : 1);
            break;
          case "ArrowUp":
            gt = bt === 0 ? At : Math.max(1, bt - ee);
            break;
          case "ArrowDown":
            gt = bt === 0 ? 1 : Math.min(At, bt + ee);
            break;
          default:
            return;
        }
        gt !== bt && (b.preventDefault(), b.stopPropagation(), M(
          `${Mt} ${le[Mt] || ""} ${gt}`
        ), setTimeout(() => {
          const Zt = xt.current[gt];
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (Vt = tt.current) == null || Vt.focus();
      return;
    }
    const { isLetter: Y, isDigit: rt } = Fo(b.key);
    (Y || rt) && (b.preventDefault(), D((ke) => ke + b.key), tt.current.focus(), Nt(!1));
  }, []);
  return Qt(() => {
    const b = setTimeout(() => {
      if (j && z === "books" && wt.current && st.current) {
        const Y = wt.current, rt = st.current, Vt = rt.offsetTop, ke = Y.clientHeight, Ge = rt.clientHeight, Pe = Vt - ke / 2 + Ge / 2;
        Y.scrollTo({
          top: Math.max(0, Pe),
          behavior: "smooth"
        }), M(Hn(t.book));
    ...
    if (z === "chapters" && R) {
      const b = R === t.book, Y = b ? t.chapterNum : 1;
      M(
        `${R} ${le[R] || ""} ${Y}`
      ), setTimeout(() => {
        if (wt.current)
          if (b) {
            const rt = xt.current[t.chapterNum];
  ...
  }, [z, R, A, t.book, t.chapterNum]), Qt(() => {
    if (z === "verses" && B && O !== void 0) {
      const b = B === t.book && O === t.chapterNum, Y = b ? t.verseNum : 1;
      M(
        `${B} ${le[B] || ""} ${O}:${Y}`
      ), setTimeout(() => {
        if (wt.current)
          if (b) {
            const rt = ne.current[t.verseNum];
            rt && rt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            wt.current.scrollTo({ top: 0 });
        G.current && G.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Oe, { open: j, onOpenChange: et, modal: v, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
      K,
      {
        ref: Ct,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: Y } = b;
          j && Ct.current && Y instanceof Node && Ct.current.contains(Y) && (Pt.current = !0, et(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Ue,
            ...
            children: [
              z === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: F.map(
                  ({ onClick: b, disabled: Y, title: rt, icon: Vt }) => /* @__PURE__ */ a(
                    K,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  K,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: z === "verses" ? ot : X,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: P === "ltr" ? /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ws, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                z === "chapters" && R && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(R, n) }),
                z === "verses" && B && O !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ve(B, n)} ${O}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: z === "verses" ? mr : fr
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(Ke, { ref: wt, children: [
                z === "books" && /* @__PURE__ */ u(nt, { children: [
                  !A && Object.entries(ie).map(([b, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ge, { heading: Rt(b), children: Y.map((rt) => /* @__PURE__ */ a(
                          Gn,
                          {
                            bookId: rt,
                            onSelect: (Vt) => te(Vt),
                            section: yr(rt),
                            commandValue: `${rt} ${le[rt]}`,
                  ...
                  A && /* @__PURE__ */ a(ge, { children: /* @__PURE__ */ a(
                    Re,
                    {
                      ...
                      children: Ce(
                        ...
                        n ? Ja(A.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  A && kt && A.chapterNum && d && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ve(A.book, n)} ${A.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Uo,
                      {
                        ...
                        endVerse: d(A.book, A.chapterNum),
                        scrRef: t,
                        onVerseSelect: Et,
                        setVerseRef: S,
                        isVerseDisabled: gr(A.book, A.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  A && !kt && ar(A.book) > 1 && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ve(A.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Bo,
                      {
                        ...
                        setChapterRef: Me,
                        isChapterDimmed: Bt,
                        isChapterDisabled: Ae(A.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                z === "chapters" && R && /* @__PURE__ */ a(
                  Bo,
                  {
                    bookId: R,
                    scrRef: t,
                    onChapterSelect: ye,
                    setChapterRef: Me,
                    isChapterDisabled: Ae(R),
                    className: "tw:p-4"
                  }
                ),
                z === "verses" && B && O !== void 0 && d && /* @__PURE__ */ a(
                  Uo,
                  {
                    bookId: B,
                    chapterNum: O,
...
function Ko({
  ...
  const [k, P] = _(!1), j = d ?? l, T = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], I = (M, E) => {
    const D = l(M), z = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, N = `${E ?? ""}${D}${z ?? ""}`;
    return /* @__PURE__ */ u(
      Re,
      {
        value: D,
  ...
  return /* @__PURE__ */ u(Oe, { open: k, onOpenChange: P, ...y, children: [
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ue, { children: [
          ...
          /* @__PURE__ */ a(Ke, { children: T(e) ? e.map((M) => /* @__PURE__ */ a(ge, { heading: M.groupHeading, children: M.options.map((E) => I(E, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(ge, { children: e.map((M) => I(M)) }) })
        ] })
      }
    )
  ] });
...
function fp({
  ...
  const w = _a(d, "%webView_bookSelector_currentBook%"), p = _a(d, "%webView_bookSelector_choose%"), g = _a(d, "%webView_bookSelector_chooseBooks%"), [h, m] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(_t, { className: "tw:ms-1", children: g })
          ] }),
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = Xn ? Qt : W, jr = { tag: ao };
function Ml({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Ol(null, o), w = Dn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
        if (g === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            ...
            (Yt() !== null || x !== null && x === p.getRootElement()) && m.select();
          }
        }, jr);
...
const Al = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
...
function jl({ children: t, onError: e }) {
  return a(Vl, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
function Bl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ul() {
  return function(t) {
    const [e] = xe(), r = $(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = H(o);
    return Fl(() => {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ql = Jn && "documentMode" in document ? document.documentMode : null;
!(!Jn || !("InputEvent" in window) || ql) && "getTargetRanges" in new window.InputEvent("input");
function he(t) {
  return `${t}px`;
}
...
function Hl(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: g } = n.getBoundingClientRect(), h = Kl(t, e);
    var m, x;
    c.isConnected || (x = c, (m = n).insertBefore(x, m.firstChild));
    let v = !1;
    for (let C = 0; C < h.length; C++) {
      const y = h[C], k = s[C] || document.createElement("div"), P = k.style;
      P.position !== "absolute" && (P.position = "absolute", v = !0);
      const j = he(y.left - p);
      P.left !== j && (P.left = j, v = !0);
      const T = he(y.top - g);
      P.top !== T && (k.style.top = T, v = !0);
      const I = he(y.width);
      P.width !== I && (k.style.width = I, v = !0);
      const M = he(y.height);
      P.height !== M && (k.style.height = M, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[C] = k;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    if (!hc(h)) return d();
    d(), o = g, n = h, i = new MutationObserver((m) => {
      const x = t.getRootElement(), v = x && x.parentElement;
      if (x !== o || v !== n) return p();
      for (const C of m) if (!c.contains(C.target)) return l();
    }), i.observe(h, Gl), l();
  });
  return () => {
    w(), d();
...
function Wl(t, e = Yl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [g, h] = function(M) {
        const E = M.getStartEndPoints();
        return M.isBackward() ? [E[1], E[0]] : E;
      }(p), m = g.getNode(), x = m.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), k = h.offset, P = t.getElementByKey(x), j = t.getElementByKey(y), T = r === null || P !== o || v !== n || x !== r.getKey(), I = i === null || j !== s || k !== c || y !== i.getKey();
      if ((T || I) && P !== null && j !== null) {
        const M = function(E, D, z, N, R, q, B) {
          const V = (E._window ? E._window.document : document).createRange();
          return V.setStart(...qo(D, z, N)), V.setEnd(...qo(R, q, B)), V;
        }(t, g, m, P, h, C, j);
        l(), l = Hl(t, M, e);
      }
      r = m, o = P, n = v, i = C, s = j, c = k;
    });
  }
...
function Jl(t) {
  ...
  return Cr(e) || Qr(4, t.__key), e;
}
function Zl(t) {
  const e = Yt() || ac();
  let r;
  if (me(e)) r = oc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = $n(c, "next"));
    }
    r = r || nc(Fe(), "previous").getFlipped().insert(Rr());
  }
  const o = Ql(t, r), n = ic(o), i = sc(n) ? cc(n) : o;
  return lc(dc(i)), t.getLatest();
}
function Ql(t, e, r) {
  let o = Po(e, "next");
  for (let n = o; n; n = wc(n, r)) o = n;
  return uc(o) && Qr(283), o.insert(t.isInline() ? Rr().append(t) : t), Po($n(t.getLatest(), "next"), e.direction);
}
function td(t) {
  const e = Yt();
  if (!me(e)) return !1;
...
let ta, Ee = 0, ea = 0, ad = 0, Ha = 0, qr = 0;
function Ho(t) {
  if (it === void 0) return;
  let e = t.n;
...
function Ye(t, e) {
  jt.call(this, void 0), this.x = t, this.s = void 0, this.g = qr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function od(t, e) {
  return new Ye(t, e);
}
...
function nd(t) {
  ...
  Qn(this), it = t, this.f &= -2, 8 & this.f && wo(this), wa();
}
function er(t, e) {
...
jt.prototype.brand = ed, jt.prototype.h = function() {
  return !0;
}, jt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Go(() => {
    var r;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && Go(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && ea === 0 && e.l !== Ha && (e.l = Ha, ta = { S: e, v: e.v, i: e.i, o: ta });
    })(this), this.v = t, this.i++, qr++, Ee++;
    try {
...
} }), Ye.prototype = new jt(), Ye.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === qr)) return !0;
  if (this.g = qr, this.f |= 1, this.i > 0 && !Zn(this)) return this.f &= -2, !0;
  const t = it;
  try {
    Yo(this), it = this;
    const e = this.x();
  ...
  return it = t, Qn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ti(this), Yo(this), Ee++;
  const t = it;
  return it = this, nd.bind(this, t);
...
oe({ build: (t, e, r) => hr(e), config: Ze({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ei() {
  const t = Fe(), e = Yt(), r = Rr();
  t.clear(), t.append(r), e !== null && r.select(), me(e) && (e.format = 0);
}
function ri(t, e = ei) {
  return t.registerCommand(An, (r) => (t.update(e), !0), oo);
}
oe({ build: (t, e, r) => hr(e), config: Ze({ $onClear: ei }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ve(() => ri(t, o.value));
} });
function id(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ca = fc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ai extends ja {
  $config() {
    return this.config("decorator-text", { extends: ja, stateConfigs: [{ flat: !0, stateConfig: Ca }] });
  }
  getFormat() {
    return zc(this, Ca);
  }
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [ai], register: (t, e, r) => t.registerCommand(Pn, (o) => {
  const n = Yt();
  if (In(n) || me(n)) for (const i of n.getNodes()) sd(i) && i.toggleFormat(o);
  return !1;
}, Vn) });
function oi(t, e) {
  let r;
...
const Ya = oe({ build: (t) => oi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const uo = 0, Wa = 1, ii = 2, Ea = 3, Fr = 4, tr = 5, Ta = 6, br = 7;
function za(t) {
  return t.id === uo;
}
function si(t) {
...
function cd(t) {
  return function(e) {
    return e.id === Wa;
  }(t) || lt(305, String(t.id), String(Wa)), Object.assign(t, { id: ii });
}
...
class dd {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : gc;
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Fr && lt(307, String(r.id), String(tr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ta && lt(310, String(r.id), String(Ta)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Fr;
    }(e) || lt(313, String(e.id), String(Fr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ea;
    }(e) || lt(314, String(e.id), String(Ea)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= br;
    }(e) || lt(316, String(e.id), String(br)), e;
  }
...
const ud = oe({ config: Ze({ setOptions: Wo, updateOptions: Wo }), init: ({ $initialEditorState: t = wd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [mc, On, vc, bc, Rn] }), Xo = Symbol.for("@lexical/extension/LexicalBuilder");
function Jo() {
}
function pd(t) {
  throw t;
...
class or {
  ...
  static maybeFromEditor(e) {
    const r = e[Xo];
    return r && (r.PACKAGE_VERSION !== Sa && lt(292, r.PACKAGE_VERSION, Sa), r instanceof or || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      za(i) || lt(300, s, n || "[unknown]"), za(c = i) || lt(304, String(c.id), String(uo)), i = Object.assign(c, { id: Wa }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of id(p)) {
    ...
    return e.onError || (e.onError = pd), e;
  }
}
const hd = /* @__PURE__ */ new Set(), Zo = oe({ build(t, e, r) {
  const o = r.getDependency(Ya).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = oi(() => {
  }, () => ve(() => {
...
class sr extends ja {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: fd, priority: 0 }) };
  }
  exportDOM() {
...
oe({ dependencies: [Ya, Zo], name: "@lexical/extension/HorizontalRule", nodes: () => [sr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Zo).output, n = Er({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return De(t.registerCommand(gd, (s) => {
    const c = Yt();
    if (!me(c)) return !1;
    ...
    return !0;
  }, oo), t.registerCommand(kc, (s) => {
    if (_c(s.target)) {
      const c = Nc(s.target);
      if (md(c)) return function(l, d = !1) {
        const w = Yt(), p = l.isSelected(), g = l.getKey();
        let h;
        d && In(w) ? h = w : (h = Cc(), Ec(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Vn), t.registerMutationListener(sr, (s, c) => {
    rd(() => {
      let l = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        g ? g.domNode.value = h : (l = !0, d.set(w, { domNode: Er(h), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(ve(() => {
      const d = c.value;
      d && (l.value ? Ln(d, i) : $c(d, i));
    }));
    return De(...s);
  }));
} });
oe({ build: (t, e) => hr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ze({ $getParentEditor: function() {
  const t = Tc();
...
oe({ build: (t, e, r) => hr(e), config: Ze({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ve(() => {
    if (!o.disabled.value) return Xl(t, o.onReposition.value);
  });
} });
function ci(t) {
  return t.canBeEmpty();
}
function vd(t, e, r = ci) {
  return De(t.registerCommand(Mc, (o) => {
    const n = Yt();
    if (!me(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => Ac(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Jl(w);
      if (p.canIndent()) {
        const g = p.getKey();
        let h = Pc();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Ic(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Vc : Vo : Lc;
    return t.dispatchCommand(i, void 0);
  }, oo), t.registerCommand(Vo, () => {
...
oe({ build: (t, e, r) => hr(e), config: Ze({ $canIndent: ci, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ve(() => {
    if (!o.value) return vd(t, n, i);
  });
} });
const bd = oe({ name: "@lexical/react/ReactProvider" });
function xd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (me(m)) {
                ...
                if (Fa(v) && d >= 0 && w >= 0 && (C = d, y = d + w, m.setTextNodeRange(v, C, v, y)), C === y && p === "" || (m.insertRawText(p), v = x.getNode()), Fa(v)) {
                  C = g, y = g + h;
                  const k = v.getTextContentSize();
                  C = C > k ? k : C, y = y > k ? k : y, m.setTextNodeRange(v, C, v, y);
                }
...
oe({ build: (t, e, r) => hr(e), config: Ze({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ve(() => r.getOutput().disabled.value ? void 0 : di(t)) });
function _d(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : W;
  ...
  return function(r, o) {
    ...
    return ho(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (g) => r._onError(g), children: a(ec, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(Hc(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Cd({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(bd.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && _d(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Nd, { editor: t, ErrorBoundary: e });
}
function Qo(t) {
  return t.getEditorState().read(li(t.isComposing()));
}
function Ed({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = xe();
  return function(n) {
    ho(() => De(qc(n), di(n)), [n]);
  }(o), u(nt, { children: [t, a(Td, { content: e }), a(Cd, { editor: o, ErrorBoundary: r })] });
}
...
function Md(t, e) {
  ...
  return u(nt, { children: [a(Od, { editor: n, ...o, ref: e }), r != null && a(Ad, { editor: n, content: r })] });
}
...
function Vd() {
  const [t, e] = _(void 0), r = U(() => {
    e(void 0);
  }, []), o = $(() => {
    if (t === void 0)
      return;
    const { title: i, content: s } = t;
    return /* @__PURE__ */ a(Ka, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(qa, { children: [
      /* @__PURE__ */ a(Xr, { children: /* @__PURE__ */ a(Jr, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = U(
    (i, s, c = !1) => {
...
function Ld({
  ...
  const [e] = xe(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Vd(), l = () => {
  };
...
function Bd() {
  const { activeEditor: t } = pi(), [e, r] = _([]), o = U((n) => {
    if (me(n) || nl(n)) {
      const i = [];
      en.forEach(({ format: s }) => {
...
function Kd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Ld, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Bd, {}) }) }),
...
const Yd = "verseText", vp = Object.freeze([
...
function ki(t) {
  return (t == null ? void 0 : t.conflictType) === Yd;
}
function _i(t) {
...
function bp({
  ...
  const [i, s] = _(Wd), [c, l] = _(n), [d, w] = _(!1), p = H(void 0), g = H(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Oe, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
        K,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: Da(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        $e,
        {
          ...
          children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: t.map((v) => /* @__PURE__ */ a(
            Re,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: Da(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : mo(v) && (v.preventDefault(), v.stopPropagation(), re(i) && h());
        },
        onKeyDown: (v) => {
...
function an({
  ...
  const h = U(
    ...
    const T = new Date(t.date), I = qs(
      T,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), M = T.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = $(() => t.user, [t.user]), C = $(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = $(() => to(t.contents), [t.contents]), k = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), P = !!t.conflictResolutionAction && !k, j = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          Xe,
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Gd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Zd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Qd, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : mo(T) && (T.preventDefault(), T.stopPropagation(), re(w) && m());
              },
              onKeyDown: (T) => {
                go(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(nt, { children: [
            ...
            P ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: _i(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: f(
        ...
        j && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(fs, {}) }) }),
          /* @__PURE__ */ a(Se, { align: "end", children: j })
        ] })
      ]
    }
  );
...
function Ci({
  ...
  const [N, R] = _(on), [q, B] = _(), [V, O] = _(), Z = o, [Q, Nt] = _(!1), [Ct, Pt] = _(!1), [G, tt] = _(!1), [wt, st] = _(!1), [xt, ne] = _(!1), [at, It] = _(P), [St, Xt] = _(!1), ie = H(void 0), [A, Jt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
      const kt = y ? await y(l) : !1;
      S && ne(kt);
    })(), () => {
      S = !1;
    };
    ...
    let S = !0;
    if (!o) {
      st(!1), Jt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const kt = C ? await C(l) : !1;
      S && st(kt);
    })(), () => {
      S = !1;
    };
  ...
  W(() => {
    if (!o) {
      yt.current !== "idle" && (B(void 0), O(void 0), yt.current = "idle");
      return;
    }
    yt.current === "idle" && (yt.current = "pending"), wt ? yt.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (B(I), yt.current = "auto-populated") : yt.current === "auto-populated" && (B(void 0), yt.current = "pending");
  }, [o, I, wt, i]);
  const Et = $(
    () => M ?? e.filter((S) => !S.deleted),
    [M, e]
  );
  W(() => {
    let S = !0;
  ...
  const te = $(() => Et[0], [Et]), ye = H(null), se = H(void 0), F = U(() => {
    var S;
    (S = se.current) == null || S.call(se), R(on);
  }, []), X = U(() => {
    const S = !at;
    It(S), Xt(!S), m == null || m(l, S);
  }, [at, m, l]);
  W(() => {
    Nt(!1);
  }, [o]), W(() => {
    if (o && !at && !St) {
      ...
      return ie.current = S, () => clearTimeout(S);
    }
  ...
  }, [i, r]), pt = $(() => Et.slice(1), [Et]), ct = $(() => pt.length ?? 0, [pt.length]), mt = $(() => ct > 0, [ct]), ht = $(() => Q || ct <= 2 ? pt : pt.slice(-2), [pt, ct, Q]), vt = $(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Dt = $(
    () => ct === 1 ? ot.singleReply : Ne(ot.multipleReplies, { count: ct }),
    [ct, ot]
  ), Rt = $(
    () => vt === 1 ? ot.singleReply : Ne(ot.multipleReplies, { count: vt }),
    [vt, ot]
  );
  W(() => {
    !o && Ct && mt && Pt(!1);
  ...
  const Bt = U(
    async (S) => {
      ...
      $t && await p({ threadId: l, contents: $t }) && F();
    },
    [
      F,
      N,
    ...
    async (S) => {
      const $t = re(N) ? aa(N) : void 0, kt = S.status ? S.assignedUser : q ?? S.assignedUser, ue = await p({
        ...S,
        contents: $t,
        assignedUser: kt
      });
      return ue && (kt !== void 0 && O(kt), $t && F()), ue;
    },
    [F, N, p, q]
  );
  ...
  const Me = /* @__PURE__ */ a(
    an,
    {
      ...
      handleDeleteComment: h,
      onEditingChange: Pt,
      canEditOrDelete: (!Ct && A.get(te.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Jd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            et && /* @__PURE__ */ a(Nr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: et }),
            /* @__PURE__ */ a(
              K,
              {
                variant: "ghost",
                ...
                children: at ? /* @__PURE__ */ a(ms, {}) : /* @__PURE__ */ a(vs, {})
              }
            ),
            D === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: xt && w !== "Resolved",
                  onClick: () => Ot({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(nt, { children: [
          ...
          o && /* @__PURE__ */ u(nt, { children: [
            z && ht.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            vt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    Q ? /* @__PURE__ */ a(bs, {}) : /* @__PURE__ */ a(ir, {})
                  ] })
                ]
              }
            ),
            ht.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              an,
              {
                comment: S,
                localizedStrings: r,
                ...
                handleDeleteComment: h,
                onEditingChange: Pt,
                canEditOrDelete: (!Ct && A.get(S.id)) ?? !1
              }
            ) }, S.id)),
            v !== !1 && (!Ct || re(N)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (S) => {
                  mo(S) && (S.preventDefault(), S.stopPropagation(), (re(N) || q !== void 0 && q !== V) && Bt());
                },
                onKeyDown: (S) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    q !== void 0 && (re(N) || q !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ne(
                    ...
                    /* @__PURE__ */ u(Oe, { open: G, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
                        K,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          align: "end",
                          onKeyDown: (S) => {
                            S.key === "Escape" && (S.stopPropagation(), tt(!1));
                          },
                          children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                            Re,
                            {
                              onSelect: () => {
                                B(S !== i ? S : void 0), yt.current = "user-selected", O(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), ew = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Yr = (t) => ew(to(t));
function Wr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function rw({
  ...
  const [s, c] = _("accept"), l = Oo(), d = Oo(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", m = p ? "accept" : s, x = $(
    () => Yr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = $(
    () => Yr(t.acceptedText ?? ""),
    ...
    () => Yr(t.mergedText ?? ""),
    [t.mergedText]
  ), y = $(() => to(t.contents), [t.contents]);
  if (!ki(t))
    return /* @__PURE__ */ a(Wr, { html: y });
  const k = (V) => {
    c(V === "reject" || V === "merge" ? V : "accept");
  }, P = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", j = h ? [
    {
      value: "merge",
  ...
  let E;
  I ? E = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (E = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", z = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), N = (V) => V ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: V }) : z, R = () => {
    const V = o ?? "accept";
    return V === "merged" ? t.mergedText ? /* @__PURE__ */ a(Wr, { html: C }) : z : N(V === "reject" ? t.rejectedResultText : t.resultText);
  }, q = (V) => p && V.value === "reject", B = (V) => {
    const O = m === V.value, Z = `${d}-${V.value}`, Q = q(V);
    return (
      ...
      !w && !g && /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a(
          so,
          {
            ...
            children: T.map((V) => q(V) ? /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ u(qt, { children: [
              /* @__PURE__ */ a(Gt, { asChild: !0, children: B(V) }),
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return _i(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function sw(t) {
  ...
  } = t, c = $(() => e.filter((C) => !C.deleted), [e]), l = $(
    () => c.find((C) => C.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: g, showResolveCheck: h } = iw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function Tp({
  ...
  const [y, k] = _(/* @__PURE__ */ new Set()), [P, j] = _(), [T, I] = _(), M = U(
    async (O) => {
      const Z = await i(O);
      return Z !== void 0 && O.assignedUser !== void 0 && O.assignedUser !== "" && I(O.assignedUser), Z;
    },
    [i]
  );
  W(() => {
    m && (k((O) => new Set(O).add(m)), j(m));
  }, [m]);
  const E = r.filter(
    (O) => O.comments.some((Z) => !Z.deleted)
  ), D = E.map((O) => ({ id: O.id })), z = U(
    (O) => {
      k((Z) => new Set(Z).add(O.id)), j(O.id), x == null || x(O.id);
    },
    [x]
  ), N = U(
    (O) => {
      ...
      k((Q) => {
        const Nt = new Set(Q);
        return Nt.has(O) ? Nt.delete(O) : Nt.add(O), Nt;
      }), j(O), x == null || x(Z ? void 0 : O);
    },
    [y, x]
  ), { listboxRef: R, activeId: q, handleKeyDown: B } = Ji({
    options: D,
    onOptionSelect: z
  }), V = U(
    (O) => {
      O.key === "Escape" ? (P && y.has(P) && (k((Z) => {
        const Q = new Set(Z);
        return Q.delete(P), Q;
      }), j(void 0), x == null || x(void 0)), O.preventDefault(), O.stopPropagation()) : B(O);
    },
    [P, y, B, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: E.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(sw, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(Ci, { ...Z })
          },
          O.id
        );
      })
...
function cw({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(xs, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Se, { align: "end", className: "tw:w-[150px]", children: [
...
function dr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(Jc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ce({
  ...
  return /* @__PURE__ */ u(
    Ft.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(la, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        cr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(wr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ce, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  ut.useEffect(() => {
    ...
    const c = () => {
      requestAnimationFrame(() => {
        Tr(s, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
    ...
    const r = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const n = t.current ? Tr(t.current) : [], i = n.indexOf(document.activeElement), s = o.key === "ArrowRight" ? i + 1 : i - 1;
  ...
  const c = ut.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), fw(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), gw(c, x, w.key);
...
function mw({
  ...
  var T;
  const [w, p] = _([]), [g, h] = _([]), [m, x] = _({}), [v, C] = _({}), y = $(() => e ?? [], [e]), k = Un({
    data: y,
    columns: t,
    getCoreRowModel: qn(),
  ...
  }), P = k.getVisibleFlatColumns();
  let j;
  return l ? j = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ a(de, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ae, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(rr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? j = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    de,
    {
      onClick: () => s(I, k),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((M) => /* @__PURE__ */ a(ae, { children: kr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    I.id
  )) : j = /* @__PURE__ */ a(de, { children: /* @__PURE__ */ a(ae, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(cw, { table: k }),
    /* @__PURE__ */ u(ua, { stickyHeader: i, children: [
      /* @__PURE__ */ a(vo, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ a(de, { children: I.headers.map((M) => /* @__PURE__ */ a(oa, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : kr(M.column.columnDef.header, M.getContext()) }, M.id)) }, I.id)) }),
      /* @__PURE__ */ a(pa, { children: j })
    ] }),
...
function bw({
  ...
  const n = sn(r, "%webView_error_dump_header%"), i = sn(r, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(K, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(kn, {}) })
        ] }),
...
function Mp({
  ...
  return /* @__PURE__ */ u(Oe, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: o }),
    /* @__PURE__ */ u($e, { id: i, className: f("tw:min-w-80 tw:max-w-96", n), children: [
...
var xw = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(xw || {});
function Ap({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(K, { variant: "default", children: [
      /* @__PURE__ */ a(Cs, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(ir, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Se, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Sr, { children: d.label }),
      /* @__PURE__ */ a(mn, { children: d.itemType === 0 ? /* @__PURE__ */ a(nt, { children: d.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Le,
        {
          checked: o[w][g],
        ...
        Zi,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Qi, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Je, {})
    ] }, d.label)) })
...
function Ip({
  ...
  const s = $(() => Hs(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Ys(), { type: "language" });
...
function Ei({
  ...
  const [C, y] = _(!1), k = U(
    (D) => {
      var N;
      const z = (N = t.find((R) => R.label === D)) == null ? void 0 : N.value;
      z && r(
        e.includes(z) ? e.filter((R) => R !== z) : [...e, z]
      );
    },
    [t, e, r]
  ), P = () => l || o, j = $(() => {
    if (!g) return t;
    const D = t.filter((N) => N.starred).sort((N, R) => N.label.localeCompare(R.label)), z = t.filter((N) => !N.starred).sort((N, R) => {
      const q = e.includes(N.value), B = e.includes(R.value);
      return q && !B ? -1 : !q && B ? 1 : N.label.localeCompare(R.label);
    });
    return [...D, ...z];
  }, [t, e, g]), T = () => {
    r(t.map((D) => D.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Oe, { open: M, onOpenChange: w ?? y, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
      K,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ a(_n, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a($e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ue, { children: [
      /* @__PURE__ */ a(zr, { placeholder: `Search ${o.toLowerCase()}...` }),
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: T, children: i }),
        /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: I, children: s })
      ] }),
      /* @__PURE__ */ u(Ke, { children: [
        /* @__PURE__ */ a(ia, { children: c }),
        /* @__PURE__ */ a(ge, { children: j.map((D) => /* @__PURE__ */ u(
          Re,
          {
            value: D.label,
            onSelect: k,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ a(Ss, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ a("div", { className: "tw:flex-grow", children: D.label }),
              D.secondaryLabel && /* @__PURE__ */ a("div", { className: "tw:text-end tw:text-muted-foreground", children: D.secondaryLabel })
            ]
          },
          D.label
        )) })
      ...
      return /* @__PURE__ */ u(Nr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          K,
          {
            ...
            children: /* @__PURE__ */ a(sa, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function _w({
  ...
  const l = $(() => /Macintosh/i.test(navigator.userAgent), []), d = ln(n, "%undoButton_tooltip%"), w = ln(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(fo, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(
        K,
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(nt, { children: [
          " ",
          /* @__PURE__ */ a(cn, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(vi, {}),
    e && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(nt, { children: [
          " ",
          /* @__PURE__ */ a(cn, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const Cw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(nt, { children: [
...
function Ew({
  ...
  const i = H(null), s = H(null), c = H(!1), [l, d] = _(t), [w, p] = _(r), [g, h] = _(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var C, y, k, P;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((P = s.current) == null || P.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Te, { open: g, onOpenChange: m, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: Cw(t, n, r) }) }) }),
...
const Tw = (t, e) => t === "f" ? /* @__PURE__ */ u(nt, { children: [
  /* @__PURE__ */ a(Cn, {}),
  " ",
...
function Sw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: Tw(t, r) }) }) }),
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: zw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Se, { style: { zIndex: vn }, children: [
...
function Rw({ icon: t, className: e }) {
...
function dn({
  ...
  return /* @__PURE__ */ u(
    Re,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Rw, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function Ow({
  ...
  return /* @__PURE__ */ u(Ue, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ke, { children: [
      ...
      /* @__PURE__ */ a(ge, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          dn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a(ge, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            dn,
            {
...
function jp({
  ...
  const w = H(null), p = H(null), g = H(null), h = H(null);
  Qt(() => {
    if (!h.current) return;
    const { width: F } = h.current.getBoundingClientRect();
    F > 0 && (h.current.style.width = `${F}px`);
  }, []);
  const [m, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [P, j] = _("*"), [T, I] = _("f"), [M, E] = _(!1), [D, z] = _(!0), [N, R] = _(!1), q = H(!1), B = H(""), [V, O] = _(!1), [Z, Q] = _(), [Nt, Ct] = _(), [Pt, G] = _(), [tt, wt] = _(), st = H(null), xt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Vr("note", X)) {
      const pt = (ot = X.insert.note) == null ? void 0 : ot.caller;
      let ct = "custom";
      pt === Ba ? ct = "generated" : pt === Ua ? ct = "hidden" : pt && (k(pt), j(pt)), x(ct), C(ct), I(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), F = setTimeout(() => {
        var mt;
        (mt = w.current) == null || mt.applyUpdate([X]);
      }, 0);
    }
    return () => {
      F && clearTimeout(F);
  ...
  const at = U(
    (F, X, ot = !1) => {
      var pt, ct, mt;
      const et = (ct = (pt = w.current) == null ? void 0 : pt.getNoteOps(0)) == null ? void 0 : ct.at(0);
      if (et && Vr("note", et)) {
        if (et.insert.note) {
          let ht;
          F === "custom" ? ht = X : F === "generated" ? ht = Ba : ht = Ua, et.insert.note.caller = ht;
        }
        r == null || r([et]), ot && d && i && ((mt = d.current) == null || mt.replaceEmbedUpdate(i, [et]));
      }
    },
    [i, r, d]
  ), It = U(() => {
  ...
  const Xt = H({ book: n.book, chapterNum: n.chapterNum });
  Qt(() => {
    (Xt.current.book !== n.book || Xt.current.chapterNum !== n.chapterNum) && (Xt.current = { book: n.book, chapterNum: n.chapterNum }, St.current());
  }, [n.book, n.chapterNum]);
  const ie = () => {
    var X;
    const F = (X = p.current) == null ? void 0 : X.getElementsByClassName("editor-input")[0];
    ...
    if (X && Vr("note", X)) {
      X.insert.note && (X.insert.note.style = F);
      const ht = (ct = (pt = X.insert.note) == null ? void 0 : pt.contents) == null ? void 0 : ct.ops;
      T !== "x" && F === "x" ? ht == null || ht.forEach((vt) => Mw(vt)) : T === "x" && F !== "x" && (ht == null || ht.forEach((vt) => Aw(vt))), (mt = w.current) == null || mt.applyUpdate([X, { delete: 1 }]);
    }
  }, Et = (F) => {
    wt(F.contextMarker), R(F.canRedo);
  }, te = U(
    (F) => {
      var ot, et, pt, ct, mt;
      const X = (et = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (X && Vr("note", X)) {
        ...
        const ht = (pt = X.insert.note) == null ? void 0 : pt.style, vt = (mt = (ct = X.insert.note) == null ? void 0 : ct.contents) == null ? void 0 : mt.ops;
        if (ht || E(!1), E(
          ht === "x" ? !!(vt != null && vt.every((Dt) => {
            var Bt, Ot;
            if (!((Bt = Dt.attributes) != null && Bt.char)) return !0;
          ...
          q.current = !0, B.current = JSON.stringify(X), z(!0);
          return;
        }
        z(JSON.stringify(X) === B.current), at(m, y);
      } else
        E(!1), z(!0);
    },
    [m, y, at]
    ...
    if (g.current && ne.length && F && F.rangeCount > 0) {
      const X = F.getRangeAt(0).getBoundingClientRect(), ot = g.current.getBoundingClientRect();
      Q(X.left - ot.left), Ct(X.top - ot.top), G(X.height), O(!0);
    }
  }, [ne, g]);
  W(() => {
    const F = () => {
    ...
    var F;
    V && ((F = st.current) == null || F.focus());
  }, [V]), W(() => {
    var ot;
    const F = ((ot = p.current) == null ? void 0 : ot.querySelector(".editor-input")) ?? void 0, X = (et) => {
      !V && F && document.activeElement === F && et.key === c ? (et.preventDefault(), ye()) : V && et.key === "Escape" && (et.preventDefault(), O(!1));
    };
    return document.addEventListener("keydown", X), () => {
      document.removeEventListener("keydown", X);
    };
  }, [V, ye, c]);
  const se = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(fo, { children: [
          /* @__PURE__ */ a(
            _w,
            {
              onUndoClick: () => {
                var F;
                return (F = w.current) == null ? void 0 : F.undo();
              },
              onRedoClick: () => {
                var F;
                return (F = w.current) == null ? void 0 : F.redo();
              },
              canUndo: !D,
              canRedo: N,
              localizedStrings: l
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
              ...
              /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: se }) })
            ] }) }) })
          ]
        }
      )
...
function Lw({
  ...
  /* @__PURE__ */ u("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    bo(t.marker, [s], o, !1),
    " "
  ] }), g = e === "horizontal" ? "horizontal" : "vertical", h = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", x = f(g, h);
  return /* @__PURE__ */ u(nt, { children: [
    /* @__PURE__ */ u("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", x), children: [
      l,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: f("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", x), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: f(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(nt, { children: Iw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Bp({
  ...
  const w = l ?? Ws(r, void 0), p = (y, k) => {
    d == null || d(y, k, n);
  }, g = i ? r.findIndex((y) => y === i) : -1, [h, m] = _(g), x = (y, k, P) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(k, P, n);
          break;
      }
  }, v = (y) => {
    if (r.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), m((k) => Math.min(k + 1, r.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), m((k) => Math.max(k - 1, 0));
          break;
      }
  }, C = H([]);
  return W(() => {
...
function Fw({
  ...
  return /* @__PURE__ */ u(ua, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(vo, { stickyHeader: !0, children: /* @__PURE__ */ u(de, { children: [
    ...
    /* @__PURE__ */ a(pa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      de,
      {
        ...
        children: [
          /* @__PURE__ */ a(ae, { children: Ce(c.reference, "English") }),
          /* @__PURE__ */ a(ae, { className: o, children: jw(c.text) })
        ]
      },
...
const Bw = (t) => {
...
}, ha = (t, e, r) => /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
  /* @__PURE__ */ u(
    Gt,
    {
  ...
  return e ? e[1] : "";
}, Kw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Wp = Object.freeze([
...
function Xp({
  ...
  const h = pe(r, "%webView_inventory_all%"), m = pe(r, "%webView_inventory_approved%"), x = pe(r, "%webView_inventory_unapproved%"), v = pe(r, "%webView_inventory_unknown%"), C = pe(r, "%webView_inventory_scope_currentBook%"), y = pe(r, "%webView_inventory_scope_chapter%"), k = pe(r, "%webView_inventory_scope_verse%"), P = pe(r, "%webView_inventory_filter_text%"), j = pe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = pe(r, "%webView_inventory_no_results%"), [I, M] = _(!1), [E, D] = _("all"), [z, N] = _(""), [R, q] = _([]), B = $(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Gw(G, n, i);
  }, [t, n, i]), V = $(() => {
    if (I) return B;
    const G = [];
    return B.forEach((tt) => {
      const wt = tt.items[0], st = G.find(
        (xt) => xt.items[0] === wt
      );
      st ? (st.count += tt.count, st.occurrences = st.occurrences.concat(tt.occurrences)) : G.push({
        items: [wt],
        count: tt.count,
  ...
  }, [I, B]), O = $(() => V.length === 0 ? [] : qw(V, E, z), [V, E, z]), Z = $(() => {
    var wt, st;
    if (!I) return l;
    const G = (wt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : wt.length;
    if (!G) return l;
    const tt = [];
    for (let xt = 0; xt < G; xt++)
      tt.push(
        Uw(
          ((st = o == null ? void 0 : o.tableHeaders) == null ? void 0 : st[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...tt, ...l];
  ...
  W(() => {
    O.length === 0 ? q([]) : O.length === 1 && q(O[0].items);
  }, [O]);
  const Q = (G, tt) => {
    tt.setRowSelection(() => {
      const st = {};
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
        /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? j })
        ] }) }),
        /* @__PURE__ */ a(Ht, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
        ...
        children: [
          ...
          t && /* @__PURE__ */ u(
            K,
            {
              ...
              children: [
                /* @__PURE__ */ a(sa, { className: "tw:h-4 tw:w-4" }),
...
const Si = ca(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ls, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
Si.displayName = "Spinner";
function Hw(t, e = 50) {
  const [r, o] = _(e), n = H(null);
  return W(() => {
    o(e);
  }, [t, e]), W(() => {
...
function Oa({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(nt, { children: [
      /* @__PURE__ */ a(de, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(ae, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        de,
        {
          ...
          children: [
            /* @__PURE__ */ a(ae, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(nt, { children: [
              /* @__PURE__ */ a(je, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
              /* @__PURE__ */ a("span", { className: "tw:sr-only", children: t })
            ] }) }),
            /* @__PURE__ */ a(ae, { className: "tw:border-0 tw:py-1 tw:pr-2 tw:font-normal tw:whitespace-nowrap", children: o.displayName }),
            /* @__PURE__ */ a(ae, { className: "tw:border-0 tw:py-1 tw:pl-2", children: o.fullName }),
            /* @__PURE__ */ a(ae, { className: "tw:border-0 tw:py-1 tw:pl-4 tw:text-right tw:text-muted-foreground", children: o.bestLanguageName })
          ]
        },
        o.dblEntryUid
      ))
...
function Zp({
  ...
  const [s, c] = _(""), [l, d] = _([]), w = $(
    () => t.filter((R) => !r || R.type === r).filter((R) => Yw(R, s)).filter(
      (R) => l.length === 0 || l.includes(R.bestLanguageName)
    ),
    [t, r, s, l]
  ), p = $(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = Hw(h), C = $(
    () => Array.from(new Set(t.map((R) => R.bestLanguageName))).map((R) => ({
      label: R,
      value: R
    })),
    [t]
  ), y = p.length === 0 && g.length === 0 && h.length === 0, k = _e(n, "%resourcePicker_title%"), P = _e(n, "%resourcePicker_search_placeholder%"), j = _e(n, "%resourcePicker_language_filter_any%"), T = _e(
    n,
    "%resourcePicker_section_already_selected%"
  ), I = _e(n, "%resourcePicker_section_installed%"), M = _e(
    n,
    "%resourcePicker_section_available_to_download%"
  ), E = _e(n, "%resourcePicker_no_results%"), D = _e(n, "%resourcePicker_showing_count%"), z = $(() => {
    if (l.length === C.length || l.length === 0)
      return j;
    if (l.length === 1) {
      const R = C.find((q) => q.value === l[0]);
      if (R) return R.label;
    }
    return Ne(
  ...
  }, [l, C, j, n]), N = s.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(nt, { children: [
    /* @__PURE__ */ a(Xr, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Jr, { children: k }) }),
    ...
    N && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: Ne(D, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Si, {}) }),
      y && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: E }),
      !y && !e && /* @__PURE__ */ a(ua, { children: /* @__PURE__ */ u(pa, { children: [
        /* @__PURE__ */ a(Oa, { label: T, resources: p }),
        /* @__PURE__ */ a(Oa, { label: I, resources: g, onSelect: i }),
        /* @__PURE__ */ a(
          Oa,
          {
            label: M,
        ...
        v && /* @__PURE__ */ a(de, { className: "tw:border-0", children: /* @__PURE__ */ a(ae, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: x, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Ww = "16rem", Xw = "3rem", Di = ut.createContext(void 0);
function fa() {
  const t = ut.useContext(Di);
  if (!t)
...
function Jw({
  ...
  const [l, d] = ut.useState(t), w = e ?? l, p = ut.useCallback(
    (k) => {
      const P = typeof k == "function" ? k(w) : k;
      r ? r(P) : d(P);
    },
    [r, w]
  ), g = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = Wt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Di.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
...
function Qp({ className: t, onClick: e, ...r }) {
...
function ou({
  ...
  const c = t ? pr.Root : "button", { state: l } = fa(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(au({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Zw,
    {
      ...
      children: /* @__PURE__ */ u(tu, { children: [
        /* @__PURE__ */ u(wn, { children: [
          ...
          /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(eu, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a(ru, { children: /* @__PURE__ */ a(
            ou,
            {
              onClick: () => d(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ u(
      Jw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Qw, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Ie = "scrBook", iu = "scrRef", We = "source", su = "details", cu = "Scripture Reference", lu = "Scripture Book", Ri = "Type", du = "Details";
function wu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? cu,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? ft.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Ce(n.start) : void 0;
      },
      getGroupingValue: (o) => ft.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => Va(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: We,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Ri : void 0,
    ...
    },
    {
      ...
      id: su,
      header: (t == null ? void 0 : t.detailsColumnName) ?? du,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const uu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Va(t.start, t.end) === 0 ? `${ba(t.start)}+${e}` : `${ba(t.start)}+${e}-${ba(t.end)}+${r}`;
}, hn = (t) => `${uu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ph({
  sources: t,
  ...
  const [d, w] = _([]), [p, g] = _([{ id: Ie, desc: !1 }]), [h, m] = _({}), x = $(
  ...
  W(() => {
    if (c) {
      const E = C.getSelectedRowModel().rowsById, D = Object.keys(E);
      if (D.length === 1) {
        const z = x.find((N) => hn(N) === D[0]) || void 0;
        z && c(z);
      }
    }
  }, [h, x, c, C]);
  const y = n ?? lu, k = i ?? Ri, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Ie] },
    { label: `Group by ${k}`, value: [We] },
    {
  ...
  }, I = (E, D) => E.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), M = (E, D, z) => {
    if (!((E == null ? void 0 : E.length) === 0 || D.depth < z.column.getGroupedIndex())) {
      if (D.getIsGrouped())
        switch (D.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wr, { position: "item-aligned", children: /* @__PURE__ */ a(lw, { children: P.map((E) => /* @__PURE__ */ a(ce, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ua, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(vo, { children: C.getHeaderGroups().map((E) => /* @__PURE__ */ a(de, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(oa, { colSpan: D.colSpan, className: "tw:sticky top-0", children: D.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(pa, { children: C.getRowModel().rows.map((E, D) => {
        const z = Wt();
        return /* @__PURE__ */ a(
          de,
          {
            ...
            children: E.getVisibleCells().map((N) => {
              if (!(N.getIsPlaceholder() || N.column.columnDef.enableGrouping && !N.getIsGrouped() && (N.column.columnDef.id !== We || !r)))
                return /* @__PURE__ */ a(
                  ae,
                  {
                    className: f(
                    ...
                    children: N.getIsGrouped() ? /* @__PURE__ */ u(
                      K,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (z === "ltr" ? /* @__PURE__ */ a(Pa, {}) : /* @__PURE__ */ a(Aa, {})),
                          " ",
                          kr(N.column.columnDef.cell, N.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
const $i = (t, e, r) => xo(t, e).every((o) => r.includes(o));
function pu({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: m } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, v] = _(!1), [C, y] = _(""), k = H(void 0), P = H(!1), j = $(
    () => Oi(t),
    [t]
  ), T = $(() => {
    if (!C.trim()) {
    ...
    (N, R = !1) => {
      if (!R || !k.current) {
        r(
          e.includes(N) ? e.filter((Q) => Q !== N) : [...e, N]
        ), k.current = N;
        return;
      }
      const q = j.findIndex((Q) => Q === k.current), B = j.findIndex((Q) => Q === N);
      if (q === -1 || B === -1) return;
      const [V, O] = [
        Math.min(q, B),
        Math.max(q, B)
      ], Z = j.slice(V, O + 1).map((Q) => Q);
      r(
        e.includes(N) ? e.filter((Q) => !Z.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...Z])]
      );
    },
    [e, r, j]
  ), M = (N) => {
    I(N, P.current), P.current = !1;
  }, E = (N, R) => {
    N.preventDefault(), I(R, N.shiftKey);
  }, D = () => {
    r(j.map((N) => N));
  }, z = () => {
    r([]);
  ...
  return /* @__PURE__ */ u(
    Oe,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a($e, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ue,
          {
            shouldFilter: !1,
            onKeyDown: (N) => {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: D, children: l }),
                /* @__PURE__ */ a(K, { variant: "ghost", size: "sm", onClick: z, children: d })
              ] }),
              /* @__PURE__ */ u(Ke, { children: [
                /* @__PURE__ */ a(ia, { children: w }),
                Object.values(dt).map((N, R) => {
                  const q = T[N];
                  if (q.length !== 0)
                    return /* @__PURE__ */ u(zn, { children: [
                      /* @__PURE__ */ a(
                        ge,
                        {
                          heading: fn(N, p, g, h, m),
                          children: q.map((B) => /* @__PURE__ */ a(
                            Gn,
                            {
                              bookId: B,
                      ...
                      R < Object.values(dt).length - 1 && /* @__PURE__ */ a(bn, {})
                    ] }, N);
                })
              ] })
            ]
...
function hu({
  ...
  const i = xo(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    K,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        $i(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: os(
        t,
...
function gu({
  ...
  const i = o["%webView_book_selector_more%"], s = $(
    ...
    (l) => {
      const d = xo(s, l).map((w) => w);
      r(
        $i(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(dt).map((l) => /* @__PURE__ */ a(
      hu,
      {
        section: l,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === $a ? $a : gn
      ).map((l) => /* @__PURE__ */ a(Nr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(l, n) }, l)),
      e.length > $a && /* @__PURE__ */ a(
        Nr,
        {
...
function gh({
  ...
  const P = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Tt(s, "%webView_scope_selector_verse%"), T = Tt(s, "%webView_scope_selector_chapter%"), I = Tt(s, "%webView_scope_selector_book%"), M = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Tt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), D = Tt(s, "%webView_scope_selector_current_book%"), z = Tt(s, "%webView_scope_selector_choose_books%"), N = Tt(s, "%webView_scope_selector_scope%"), R = Tt(s, "%webView_scope_selector_select_books%"), q = Tt(s, "%webView_scope_selector_range%"), B = Tt(s, "%webView_scope_selector_select_range%"), V = Tt(s, "%webView_scope_selector_range_start%"), O = Tt(s, "%webView_scope_selector_range_end%"), Z = Tt(s, "%webView_scope_selector_ok%"), Q = Tt(s, "%webView_scope_selector_cancel%"), Nt = Tt(s, "%webView_scope_selector_navigate%"), Ct = (L) => {
    if (!m) return;
  ...
  ], G = (L, J, Ut = !1) => /* @__PURE__ */ u(nt, { children: [
    L,
    J && !Ut && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? Pt.filter((L) => e.includes(L.value)) : Pt, wt = m ?? xa, st = w ?? wt, xt = p ?? wt, ne = () => {
  }, at = H(null), It = H(null), St = H(!1), Xt = H(null), ie = H(!1), [A, Jt] = _(void 0), yt = H(!1), Et = H(!1), te = H(null), ye = U((L) => {
    if (L) {
      Jt("start"), yt.current = !1;
      return;
    }
    Jt((J) => J === "start" ? void 0 : J), yt.current && (yt.current = !1, requestAnimationFrame(() => {
      var Ut;
    ...
    (L) => {
      g == null || g(L), h == null || h(L), yt.current = !0;
    },
    [g, h]
  ), X = U(
    (L) => {
      h == null || h(L), Et.current = !0;
    },
    [h]
  ), ot = U(
    (L) => {
    ...
    [r, n, m, i]
  ), et = tt.find((L) => L.value === t), pt = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Js(st, xt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : et ? G(et.label, et.scrRefSuffix) : t, ct = tt.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), mt = tt.find((L) => L.value === "selectedBooks"), ht = tt.find((L) => L.value === "range"), [vt, Dt] = _(!1), [Rt, Bt] = _(void 0), [Ot, Me] = _(void 0), [S, $t] = _(void 0), [kt, ue] = _(void 0), [Ae, gr] = _([]), fr = d === "dropdown" && Rt === "selectedBooks", mr = /* @__PURE__ */ a(
    gu,
    {
      availableBookInfo: o,
      selectedBookIds: fr ? Ae : n,
      onChangeSelectedBookIds: fr ? gr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), Mr = A === "end", Ar = A === "start", Qe = "tw:text-muted-foreground", b = d === "dropdown" && Rt === "range", Y = b ? $t : F, Vt = b ? ue : h ? X : ne, ke = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: f(Mr && Qe), children: V }),
      /* @__PURE__ */ a(
        ka,
        {
    ...
    /* @__PURE__ */ u("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: f(Ar && Qe), children: O }),
      /* @__PURE__ */ a(
        ka,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: C,
          disableReferencesUpTo: b ? S ?? st : st,
          onOpenChange: se,
          onCloseAutoFocus: (L) => {
            var J;
            Et.current && (Et.current = !1, L.preventDefault(), (J = te.current) == null || J.focus());
          },
          className: f(Ar && Qe),
          modal: !0,
          align: "start"
  ...
  W(() => {
    ...
    const J = requestAnimationFrame(() => {
      L = requestAnimationFrame(() => {
        var Ut;
        (Ut = Ge.current[t]) == null || Ut.focus();
      });
    });
    return () => {
      cancelAnimationFrame(J), L && cancelAnimationFrame(L);
    };
  }, [vt, t]);
  const [bt, At] = _(null), [gt, ee] = _(null), [Zt, He] = _(null), Fi = 200, [Bi, Ui] = _(!1);
  W(() => {
    if (!Zt || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([J]) => {
      Ui(J.contentRect.width < Fi);
    });
    return L.observe(Zt), () => L.disconnect();
  }, [Zt]);
  const yo = U(
    (L) => {
      Me(L), $t(st), ue(xt), gr(n), Dt(!1), Bt(L);
    },
    [st, xt, n]
  ), ko = U(() => {
    Ot !== void 0 && (Ot === "range" ? (S && (g == null || g(S)), kt && (h == null || h(kt))) : Ot === "selectedBooks" && i(Ae), ot(Ot), Bt(void 0), Me(void 0));
  }, [
    Ot,
    S,
    kt,
    ...
    L || (Bt(void 0), Me(void 0));
  }, []), _o = U((L) => {
    var J;
    L.preventDefault(), (J = Mt.current) == null || J.focus();
  }, []), No = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(_t, { children: N }),
      d === "dropdown" ? /* @__PURE__ */ u(Te, { open: vt, onOpenChange: Dt, children: [
        ...
        /* @__PURE__ */ a(
          Se,
          {
            ...
            children: /* @__PURE__ */ u(ma, { container: Zt, children: [
              ct.map(({ value: L, label: J, dropdownLabel: Ut, scrRefSuffix: vr, id: Ki }) => /* @__PURE__ */ u(
                Xe,
                {
                  ref: Pe(L),
              ...
              x && /* @__PURE__ */ u(nt, { children: [
                /* @__PURE__ */ a(Je, {}),
                /* @__PURE__ */ a(Sr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Nt }),
                /* @__PURE__ */ a(
                  Xe,
                  {
                    ref: Xt,
                    ...
                    onSelect: (L) => {
                      ...
                      ie.current || (Ut = (J = It.current) == null ? void 0 : J.querySelector("button")) == null || Ut.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (L) => {
                          const J = L.target instanceof HTMLElement ? L.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          ka,
                          {
                            ...
                            onCloseAutoFocus: (L) => {
                              var J;
                              L.preventDefault(), (J = Xt.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(nt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(m ?? xa, "id") }),
                              /* @__PURE__ */ a(ir, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        so,
        {
          ...
          children: tt.map(({ value: L, label: J, scrRefSuffix: Ut, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: L, id: vr }),
            /* @__PURE__ */ a(_t, { htmlFor: vr, children: G(J, Ut) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && ke,
    d === "dropdown" && mt && /* @__PURE__ */ a(Ka, { open: Rt === "selectedBooks", onOpenChange: Pr, children: /* @__PURE__ */ a(
      qa,
      {
        ref: ee,
        onCloseAutoFocus: _o,
        onEscapeKeyDown: (L) => {
          gt != null && gt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ma, { container: gt, children: [
          /* @__PURE__ */ a(Xr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Jr, { children: z }) }),
          mr,
          /* @__PURE__ */ u(Lo, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Pr(!1), children: Q }),
            /* @__PURE__ */ a(K, { onClick: ko, children: Z })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && ht && /* @__PURE__ */ a(Ka, { open: Rt === "range", onOpenChange: Pr, children: /* @__PURE__ */ a(
      qa,
      {
        ref: At,
        onCloseAutoFocus: _o,
        onEscapeKeyDown: (L) => {
          bt != null && bt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ma, { container: bt, children: [
          /* @__PURE__ */ a(Xr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Jr, { children: B }) }),
          ke,
          /* @__PURE__ */ u(Lo, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Pr(!1), children: Q }),
            /* @__PURE__ */ a(K, { ref: te, onClick: ko, children: Z })
          ] })
        ] })
      }
    ) })
...
function fh({
  ...
  return /* @__PURE__ */ u(
    cr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(dr, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          lr,
          {
        ...
        /* @__PURE__ */ a(
          wr,
          {
            ...
            style: { zIndex: ur },
            children: t.map((w) => /* @__PURE__ */ a(ce, { value: `${w}`, children: l[Do(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ai = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Gt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(is, { children: c.label }),
    /* @__PURE__ */ a(ss, { children: /* @__PURE__ */ a(cs, { children: Ai(
      t,
      e,
      Mi(t, c.id),
      o
...
function Xa({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(K, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Fs, {}) }) }),
    /* @__PURE__ */ a(Se, { align: "start", style: { zIndex: ur }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(zn, { children: [
      /* @__PURE__ */ a(mn, { children: /* @__PURE__ */ a(Kt, { children: Ai(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(Je, {})
    ] }, l)) })
  ] });
}
const Pi = ut.forwardRef(
...
function xh({
  ...
  return /* @__PURE__ */ u(Pi, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Xa,
      {
        onSelectMenuItem: t,
...
function yh({
  ...
  return /* @__PURE__ */ a(Pi, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    Xa,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Ii = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = Wt();
  return /* @__PURE__ */ a(
    we.Root,
    {
...
Ii.displayName = we.List.displayName;
const Vi = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.List,
  {
    ref: r,
    className: f(
...
Vi.displayName = we.List.displayName;
const vu = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Trigger,
  {
    ref: r,
    ...e,
...
)), Li = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Content,
  {
    ref: r,
    className: f(
...
Li.displayName = we.Content.displayName;
function kh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ii, { children: [
      /* @__PURE__ */ a(Vi, { children: t.map((c) => /* @__PURE__ */ a(vu, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(Li, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function bu({
...
function Su({
  ...
  if (gl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var m, x, v, C;
    w.preventDefault();
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), xr(i, [g, h]);
        break;
      case "alt+l":
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = l.current) == null || C.focus(), xr(l, [g, h]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(bu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(xu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ur },
          children: /* @__PURE__ */ a(Kt, { children: ji(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Ch({
  ...
  const d = Du(
    ...
    var C, y, k, P, j, T;
    const v = x !== m ? ((y = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : y[x]) ?? ((P = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${(j = t[m]) == null ? void 0 : j.autonym} (${v})` : (T = t[m]) == null ? void 0 : T.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: f("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: Ne(d, {
      fallbackLanguages: (r == null ? void 0 : r.length) > 0 ? r.map((m) => h(m, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Ru({ item: t, createLabel: e, createComplexLabel: r }) {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(K, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(zo, {}) }) }),
              /* @__PURE__ */ a(Se, { align: "end", children: d })
            ] }) }),
...
function Bh({
  ...
  return /* @__PURE__ */ u(
    zt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(zt.ItemIndicator, { children: /* @__PURE__ */ a(la, {}) }) }),
        e
      ]
    }
  );
...
function ig({
  ...
  return /* @__PURE__ */ a(
    we.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Pu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function ug(t) {
  const e = $(() => Zs(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
function Lu(t, e = "top") {
...
export {
  ...
  mp as ButtonGroupText,
  bi as CANCEL_ACCEPT_BUTTONS_STRING_KEYS,
  xp as COMMENT_EDITOR_STRING_KEYS,
  ...
  bw as ErrorDump,
  Mp as ErrorPopover,
  Fp as FOOTNOTE_EDITOR_STRING_KEYS,
  Vp as Filter,
  ...
  eg as Progress,
  Jp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  so as RadioGroup,
  ...
  Zp as ResourcePickerDialog,
  Th as ResultsCard,
  hh as SCOPE_SELECTOR_STRING_KEYS,
  fu as SELECT_BOOKS_STRING_KEYS,
  gh as ScopeSelector,
  ph as ScriptureResultsViewer,
  fh as ScrollGroupSelector,
  ga as SearchBar,
  cr as Select,
  gu as SelectBooks,
  ...
  nu as SettingsSidebar,
  uh as SettingsSidebarContentSearch,
  Zw as Sidebar,
  tu as SidebarContent,
  ah as SidebarFooter,
  wn as SidebarGroup,
  nh as SidebarGroupAction,
  ...
  sh as SidebarMenuBadge,
  ou as SidebarMenuButton,
  ru as SidebarMenuItem,
  ch as SidebarMenuSkeleton,
  lh as SidebarMenuSub,
  wh as SidebarMenuSubButton,
  dh as SidebarMenuSubItem,
  Jw as SidebarProvider,
  th as SidebarRail,
  oh as SidebarSeparator,
  Qp as SidebarTrigger,
  rr as Skeleton,
  ag as Slider,
  rg as Sonner,
  Si as Spinner,
  ...
  _h as getToolbarOSReservedSpaceClassName,
