...
import u, { forwardRef as Je, useRef as nt, useMemo as H, useState as O, useCallback as L, useLayoutEffect as _n, createContext as Kr, useContext as qr, useEffect as Ot, Fragment as $n } from "react";
import { Command as it } from "cmdk";
import { X as We, Search as jn, Check as Rt, Clock as Sn, ChevronsLeft as Rn, ChevronsRight as Tn, ChevronLeft as $e, ChevronRight as Ft, ArrowLeft as Jr, ArrowRight as Wr, Circle as be, ChevronsUpDown as Ze, FilterIcon as Zr, ChevronDown as ve, ChevronUp as Qr, ArrowLeftIcon as to, ChevronLeftIcon as eo, ChevronRightIcon as no, ArrowRightIcon as ro, Copy as oo, Filter as ao, User as so, Link as io, CircleHelp as wo, Star as lo, AlertCircle as je, CircleCheckIcon as co, CircleXIcon as po, CircleHelpIcon as mo, ArrowUpIcon as uo, ArrowDownIcon as ho, ArrowUpDownIcon as fo, PanelLeft as go, PanelRight as bo, ScrollText as vo, MenuIcon as xo, Menu as yo, EllipsisVertical as No, LoaderCircle as ko } from "lucide-react";
import { clsx as Co } from "clsx";
import { extendTailwindMerge as _o } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as me, Section as M, getChaptersForBook as So, formatScrRef as Bt, getSectionForBook as oe, NumberFormat as Ro, formatBytes as To, getCurrentLocale as Eo, getFormatCallerFunction as Vo, deepEqual as Qe, isString as Ve, compareScrRefs as Le, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Bn, getFilteredRowModel as Mo, getSortedRowModel as Gn, getPaginationRowModel as Do, getCoreRowModel as Fn, flexRender as ae, getGroupedRowModel as Io, getExpandedRowModel as Oo } from "@tanstack/react-table";
...
const Lo = "layoutDirection";
function tt() {
  const t = localStorage.getItem(Lo);
  return t === "rtl" ? t : "ltr";
}
const Bo = xt.Portal, Un = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xt.Overlay,
  {
    ref: n,
    className: c(
...
const Go = u.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = tt();
...
const Yn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  it.Separator,
  {
    ref: n,
...
Yn.displayName = it.Separator.displayName;
const jt = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  it.Item,
  {
    ref: n,
...
const st = class D {
  ...
  static fromJSON(e) {
    ...
    let m;
    return i && (m = new Mt(i)), n ? new D(n, o.toString(), w, m) : new D();
  }
  /**
...
const er = $.allBookIds.filter(
  (t) => !$.isObsolete($.bookIdToNumber(t))
), It = Object.fromEntries(
  er.map((t) => [t, $.bookIdToEnglishName(t)])
);
function on(t, e, n) {
...
function Xe(t, e, n) {
  return `${t} ${It[t]}${e ? ` ${rn(t, e)} ${Gt(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function aa({
  recentSearches: t,
  ...
  return /* @__PURE__ */ l(Zt, { open: w, onOpenChange: m, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r(
      I,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ r(Sn, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ r(Lt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(At, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      jt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Sn, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function Ei({
  ...
  const d = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [j, W] = O(!1), B = nt(void 0), ot = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), Y = L(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
    ...
    [v, dt]
  ), { otLong: vn, ntLong: xn, dcLong: yn, extraLong: Nn } = {
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: P, isDigit: J } = Mn(x.key);
      if (v === "chapters") {
        if (x.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            yt = at === 0 ? Et : Math.max(1, at - Cn);
            break;
          case "ArrowDown":
            yt = at === 0 ? 1 : Math.min(Et, at + Cn);
            break;
          default:
            return;
        }
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ln.Root, { ref: n, className: c("pr-twp", la(), t), ...e }));
...
}), rr = G.Trigger, or = G.Group, ma = G.Portal, ua = G.Sub, ha = G.RadioGroup;
...
sr.displayName = G.SubContent.displayName;
const Ne = u.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = tt();
...
const ir = u.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = tt(), s = ht();
  return /* @__PURE__ */ r(
    G.Item,
    {
...
const ln = u.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const wr = u.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ht();
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
...
wr.displayName = G.RadioItem.displayName;
const dn = u.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: o,
...
const lr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.ScrollUpButton,
  {
    ref: n,
...
lr.displayName = U.ScrollUpButton.displayName;
...
const Ce = u.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
...
const _e = u.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: c(
...
const Ta = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function Ea({
  ...
  var S;
  const [m, d] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Bn({
    data: e,
    columns: t,
    getCoreRowModel: Fn(),
...
function Ma({
  ...
  const a = On(n, "%webView_error_dump_header%"), s = On(n, "%webView_error_dump_info_message%");
  function i() {
...
function Pi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(wn, { children: [
    /* @__PURE__ */ r(rr, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(or, { children: d.itemType === 0 ? /* @__PURE__ */ r(bt, { children: d.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        ln,
        {
          checked: o[p][h],
        ...
        ha,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(wr, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(ke, {})
    ] }, d.label)) })
...
function Pa(t, e, n = !0, o = void 0) {
  if (!e || e.length === 0) return;
  const a = [], s = [];
  let i = [];
  return e.forEach((w) => {
    typeof w != "string" && w.marker === "fp" ? (i.length > 0 && s.push(i), i = [w]) : i.push(w);
  }), i.length > 0 && s.push(i), s.map((w, m) => {
    const d = m === s.length - 1;
...
function $a({
  ...
  const m = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, d = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
  ...
  return /* @__PURE__ */ l(bt, { children: [
    /* @__PURE__ */ l(
      "div",
      {
        className: c(
          ...
          o ? "marker-visible tw-pr-[10px]" : "tw-pr-[22px]"
        ),
        children: [
          m,
          p
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: w && w.length > 0 && /* @__PURE__ */ r(bt, { children: Pa(t.marker, w, o, d) })
      }
    )
  ] });
}
...
const pn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: n,
    className: c(
...
pn.displayName = Be.Root.displayName;
...
function Ki({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = O(!1), [W, B] = O("all"), [ot, pt] = O(""), [_, E] = O([]), Y = H(() => t.length === 0 ? [] : Ja(t, a, s), [t, a, s]), A = H(() => {
    if (C) return Y;
    const T = [];
    return Y.forEach((Z) => {
    ...
    return [...Z, ...m];
  }, [o == null ? void 0 : o.tableHeaders, m, C]);
  Ot(() => {
...
const mn = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Hn.Root,
  {
    ref: a,
    decorative: n,
...
mn.displayName = Hn.Root.displayName;
...
const un = de.Provider, hn = de.Root, fn = de.Trigger, Te = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: o,
    sideOffset: e,
...
const gr = u.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(fr.Provider, { value: N, children: /* @__PURE__ */ r(un, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ye = u.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Yt : "div",
  {
    ref: o,
...
const ss = Tt(
  ...
  ({
    ...
    const m = t ? Yt : "button", { state: d } = Ee(), p = /* @__PURE__ */ r(
      m,
      {
        ref: w,
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(fn, { asChild: !0, children: p }),
    ...
    br,
    {
      ...
      children: /* @__PURE__ */ l(xr, { children: [
        /* @__PURE__ */ l(Ue, { children: [
          ...
          /* @__PURE__ */ r(Ke, { children: /* @__PURE__ */ r(yr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(Nr, { children: /* @__PURE__ */ r(
            kr,
            {
              onClick: () => d(h),
              isActive: g(h),
...
}, Pn = (t) => `${xs({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ji({
  sources: t,
  ...
  Ot(() => {
    if (w) {
      ...
      if (E.length === 1) {
        const Y = y.find((A) => Pn(A) === E[0]) || void 0;
        Y && w(Y);
      }
    }
  }, [f, y, w, S]);
  const N = a ?? gs, C = s ?? Cr, j = [
...
const bn = (t, e) => t.filter((n) => {
  try {
    return oe(n) === e;
  } catch {
    return !1;
  }
}), _r = (t, e, n) => bn(t, e).every((o) => n.includes(o));
function ys({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = bn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], m = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
                  ...
                  Object.values(M).map((R, et) => {
                    ...
                    if (k.length !== 0)
                      return /* @__PURE__ */ l($n, { children: [
                        ...
                        et < Object.values(M).length - 1 && /* @__PURE__ */ r(Yn, {})
                      ] }, R);
                  })
                ] })
              ]
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, m) => w.order - m.order).map((w) => /* @__PURE__ */ l(hn, { children: [
  /* @__PURE__ */ r(fn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ir,
    {
      onClick: () => {
        o(w);
    ...
    /* @__PURE__ */ r(ar, { children: w.label }),
    /* @__PURE__ */ r(ma, { children: /* @__PURE__ */ r(sr, { children: Rr(
      t,
      e,
      Sr(t, w.id),
      o
...
function qe({
  ...
  return /* @__PURE__ */ l(wn, { variant: s, children: [
    /* @__PURE__ */ r(rr, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(xo, {}) }) }),
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, d]) => typeof m == "boolean" || typeof d == "boolean" ? 0 : m.order - d.order).map(([m], d, p) => /* @__PURE__ */ l($n, { children: [
      /* @__PURE__ */ r(or, { children: /* @__PURE__ */ r(un, { children: Rr(e.groups, e.items, m, t) }) }),
...
const Ir = u.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    F.Trigger,
    {
...
const Or = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
const ne = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ l(hn, { children: [
      /* @__PURE__ */ r(fn, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        zr,
        {
          onClick: () => {
            o(d);
...
function Es({
  ...
  const a = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), m = nt(void 0), d = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (zo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    ...
    return /* @__PURE__ */ r(Dr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(Cs, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(un, { children: jr(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
const Ds = Je(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
), Os = u.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
js.displayName = Kt.Fallback.displayName;
const cw = X.Root, pw = X.Trigger, mw = X.Group, uw = X.Portal, hw = X.Sub, fw = X.RadioGroup, Ls = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
const gw = ut.Trigger, Js = ut.Portal, bw = ut.Close, Br = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
...
const xw = wt.Root, ai = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
...
const di = (t, e, n = {}) => {
  ...
  const a = nt(null), [s, i] = O(void 0), [w, m] = O(void 0), d = L(
    (h) => {
      i(h);
