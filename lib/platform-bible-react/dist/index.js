...
import u, { forwardRef as Ze, useRef as nt, useMemo as H, useState as O, useCallback as B, useLayoutEffect as Rn, createContext as qr, useContext as Jr, useEffect as Ot, Fragment as Bn } from "react";
import { Command as it } from "cmdk";
import { X as Qe, Search as Ln, Check as Rt, Clock as Tn, ChevronsLeft as En, ChevronsRight as Vn, ChevronLeft as je, ChevronRight as Ft, ArrowLeft as Wr, ArrowRight as Zr, Circle as be, ChevronsUpDown as tn, FilterIcon as Qr, ChevronDown as ve, ChevronUp as ta, ArrowLeftIcon as ea, ChevronLeftIcon as na, ChevronRightIcon as ra, ArrowRightIcon as aa, Copy as oa, Filter as sa, User as ia, Link as wa, CircleHelp as la, Star as da, AlertCircle as $e, CircleCheckIcon as ca, CircleXIcon as pa, CircleHelpIcon as ua, ArrowUpIcon as ma, ArrowDownIcon as ha, ArrowUpDownIcon as fa, PanelLeft as ga, PanelRight as ba, ScrollText as va, MenuIcon as xa, Menu as ya, EllipsisVertical as Na, LoaderCircle as ka, GripVertical as Ca } from "lucide-react";
import { clsx as _a } from "clsx";
import { extendTailwindMerge as Sa } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as ue, Section as M, getChaptersForBook as Ra, formatScrRef as Lt, getSectionForBook as ae, NumberFormat as Ta, formatBytes as Ea, getCurrentLocale as Va, getFormatCallerFunction as Ma, deepEqual as en, isString as Ve, compareScrRefs as Be, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Fn, getFilteredRowModel as Da, getSortedRowModel as Xn, getPaginationRowModel as Ia, getCoreRowModel as Hn, flexRender as oe, getGroupedRowModel as Oa, getExpandedRowModel as Aa } from "@tanstack/react-table";
...
import * as nn from "react-resizable-panels";
...
const Ga = xt.Portal, Kn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xt.Overlay,
  {
    ref: n,
    className: c(
...
const Fa = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = tt();
...
Xa.displayName = xt.Title.displayName;
...
const ye = u.forwardRef((t, e) => /* @__PURE__ */ r(it.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
$t.displayName = it.Item.displayName;
...
const st = class D {
  ...
  static fromJSON(e) {
    ...
    let m;
    return i && (m = new Mt(i)), n ? new D(n, a.toString(), w, m) : new D();
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || j.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !D.isVerseParseable(a[1]))
      throw new ee("Invalid reference : " + e);
...
const ar = Ze(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        className: c(
          ...
          {
            "tw-border-s-red-200": o === M.OT,
            "tw-border-s-purple-200": o === M.NT,
            "tw-border-s-indigo-200": o === M.DC,
            "tw-border-s-amber-200": o === M.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          $t,
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ut : "button", { className: c(oo({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const Zt = se.Root, Qt = se.Trigger, Bt = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = tt();
...
function Xe(t, e, n) {
  return `${t} ${It[t]}${e ? ` ${sn(t, e)} ${Gt(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function so({
  recentSearches: t,
...
function Ei(t, e, n = (o, s) => o === s, a = 15) {
  return (o) => {
    const s = t.filter(
      (w) => !n(w, o)
    ), i = [o, ...s.slice(0, a - 1)];
...
function Vi({
  ...
  const d = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [$, W] = O(!1), L = nt(void 0), at = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), U = B(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: P, isDigit: J } = In(x.key);
      if (v === "chapters") {
        if (x.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            ot !== 0 && (yt = ot > 1 ? ot - 1 : Et);
            break;
          case "ArrowRight":
            ot !== 0 && (yt = ot < Et ? ot + 1 : 1);
            break;
          case "ArrowUp":
            yt = ot === 0 ? Et : Math.max(1, ot - Sn);
            break;
          case "ArrowDown":
            yt = ot === 0 ? 1 : Math.min(Et, ot + Sn);
            break;
          default:
            return;
        }
        yt !== ot && (x.preventDefault(), x.stopPropagation(), f(Xe(rt, o, yt)), setTimeout(() => {
  ...
  return Rn(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && pt.current && _.current) {
        const P = pt.current, J = _.current, rt = J.offsetTop, ot = P.clientHeight, Et = J.clientHeight, yt = rt - ot / 2 + Et / 2;
        P.scrollTo({
          top: Math.max(0, yt),
          behavior: "smooth"
        }), f(Xe(t.book));
    ...
    /* @__PURE__ */ r(Bt, { id: m, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      qt,
      {
        ref: L,
        onKeyDown: Ur,
          ...
          v === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              I,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ r(Wr, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Zr, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Gt(N, o) })
          ] }),
          !$ && /* @__PURE__ */ l(Jt, { ref: pt, children: [
              ...
              !k && Object.entries(et).map(([x, P]) => {
                if (P.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(At, { heading: Fr(x), children: P.map((J) => /* @__PURE__ */ r(
                      ar,
                      {
                        bookId: J,
                        onSelect: (rt) => ft(rt),
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gn.Root, { ref: n, className: c("pr-twp", co(), t), ...e }));
Q.displayName = Gn.Root.displayName;
    ...
    ln,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: a.map((v) => j.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
}), or = G.Trigger, sr = G.Group, ho = G.Portal, fo = G.Sub, go = G.RadioGroup;
function cn({ variant: t = "default", ...e }) {
  const n = u.useMemo(
    () => ({
      variant: t
    }),
...
const ir = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.SubTrigger,
    {
...
ir.displayName = G.SubTrigger.displayName;
...
wr.displayName = G.SubContent.displayName;
...
const lr = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = tt(), s = ht();
  return /* @__PURE__ */ r(
    G.Item,
    {
...
lr.displayName = G.Item.displayName;
const pn = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const dr = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
...
dr.displayName = G.RadioItem.displayName;
const un = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: a,
...
un.displayName = G.Label.displayName;
...
function vo({ table: t }) {
  return /* @__PURE__ */ l(cn, { children: [
    /* @__PURE__ */ r(Pa, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = Y.Root, xo = Y.Group, Ht = Y.Value, yo = Tt(
  ...
  return /* @__PURE__ */ l(
    Y.Trigger,
    {
      className: c(yo({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
pr.displayName = Y.ScrollDownButton.displayName;
const jt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = tt();
...
const ut = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  Y.Item,
  {
    ref: a,
    className: c(
...
const Ce = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
...
const Se = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: c("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const St = u.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
  ...
  const w = u.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Eo(f, b, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), To(w, y, p.key);
...
function Mo({
  ...
  var S;
  const [m, d] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Fn({
    data: e,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    ...
    n && a && /* @__PURE__ */ r(Co, { table: v })
  ] });
}
function Oi({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = H(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: c("pr-twp tw-prose", n), children: /* @__PURE__ */ r(za, { options: o, children: e }) });
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(I, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(oa, {}) })
        ] }),
...
function Pi({
  ...
  return /* @__PURE__ */ l(Zt, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ l(Bt, { id: s, className: c("tw-min-w-80 tw-max-w-96", o), children: [
...
function zi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(cn, { children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(un, { children: d.label }),
      /* @__PURE__ */ r(sr, { children: d.itemType === 0 ? /* @__PURE__ */ r(bt, { children: d.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        pn,
        {
          checked: a[p][h],
        ...
        go,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(dr, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(ke, {})
    ] }, d.label)) })
...
function Ao({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const m = new Date(w), d = new Date(o.getTime() - m.getTime()), p = d.getUTCFullYear() - 1970, g = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let f = "";
...
const Po = Tt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: c("pr-twp", Po({ variant: e }), t), ...n })
);
...
function zo({
  ...
  const [h, f] = O(!1), b = B(
    (S) => {
      var C;
      const N = (C = t.find(($) => $.label === S)) == null ? void 0 : C.value;
      N && a(
        n.includes(N) ? n.filter(($) => $ !== N) : [...n, N]
      );
    },
    [t, n, a]
  ), y = () => i || o, v = H(() => {
    if (!m) return t;
    const S = t.filter((C) => C.starred).sort((C, $) => C.label.localeCompare($.label)), N = t.filter((C) => !C.starred).sort((C, $) => {
      const W = n.includes(C.value), L = n.includes($.value);
      return W && !L ? -1 : !W && L ? 1 : C.label.localeCompare($.label);
    });
    return [...S, ...N];
  }, [t, n, m]);
          ...
          return /* @__PURE__ */ l(
            $t,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: S.starred && /* @__PURE__ */ r(da, { className: "tw-h-4 tw-w-4" }) }),
...
const Ye = c("marker", "marker-visible'}");
function Ue(t, e, n = !0, a = !0, o = []) {
  if (!(!e || e.length === 0))
    return e.map((s) => {
      let i = o.join("-");
      if (typeof s == "string") {
      ...
      return i += `-${s.marker ?? "unknown"}`, jo(s, i, n, [
        ...o,
        t ?? "unknown"
      ]);
    });
...
function jo(t, e, n, a = []) {
  ...
  return /* @__PURE__ */ l("span", { children: [
    o ? n && /* @__PURE__ */ r("span", { className: Ye, children: `\\${o} ` }) : /* @__PURE__ */ r(
      $e,
      {
...
function $o({
  ...
  const m = a ? /* @__PURE__ */ r("span", { className: Ye, children: `\\${t.marker} ` }) : void 0, d = a ? /* @__PURE__ */ r("span", { className: Ye, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
...
const Go = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Go.displayName = "CardDescription";
...
function Li({
  ...
  const p = d ? Ho(d, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Ma(e, void 0), h = (f) => {
    m && m(f);
  };
  return /* @__PURE__ */ l(bt, { children: [
...
const mn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Le.Root,
  {
    ref: n,
    className: c(
...
Uo.displayName = Yn.Root.displayName;
const hr = u.createContext({
  size: "default",
  variant: "default"
}), fr = u.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = tt();
  return /* @__PURE__ */ r(
    xe.Root,
    {
...
const me = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ha, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Gi = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, qo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ki = Object.freeze([
...
function qi({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, $] = O(!1), [W, L] = O("all"), [at, pt] = O(""), [_, E] = O([]), U = H(() => t.length === 0 ? [] : Wo(t, o, s), [t, o, s]), A = H(() => {
    if (C) return U;
    const T = [];
    return U.forEach((Z) => {
    ...
    return [...Z, ...m];
  }, [a == null ? void 0 : a.tableHeaders, m, C]);
  Ot(() => {
  ...
  return /* @__PURE__ */ l("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(Q, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? N })
      ] })
    ] }),
...
const hn = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Un.Root,
  {
    ref: o,
    decorative: n,
...
const fn = de.Provider, gn = de.Root, bn = de.Trigger, Te = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: a,
    sideOffset: e,
...
const Zo = "16rem", Qo = "3rem", gr = u.createContext(void 0);
function Ee() {
...
const br = u.forwardRef(
  ({
    ...
    const [d, p] = u.useState(t), g = e ?? d, h = u.useCallback(
      (C) => {
        const $ = typeof C == "function" ? C(g) : C;
        n ? n($) : p($);
      },
      [n, g]
    ), f = u.useCallback(() => h((C) => !C), [h]), b = g ? "expanded" : "collapsed", S = tt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = u.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(gr.Provider, { value: N, children: /* @__PURE__ */ r(fn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const vr = u.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Ee();
...
const ts = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Ee();
  return /* @__PURE__ */ l(
    I,
    {
...
const qe = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ut : "div",
  {
    ref: a,
...
const ss = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ut : "button",
  {
    ref: a,
...
const is = Tt(
  ...
  ({
    ...
    const m = t ? Ut : "button", { state: d } = Ee(), p = /* @__PURE__ */ r(
      m,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: c(is({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Te, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
Cr.displayName = "SidebarMenuButton";
const ws = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Ut : "button",
  {
    ref: o,
...
const ds = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
cs.displayName = "SidebarMenuSub";
const ps = u.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
ps.displayName = "SidebarMenuSubItem";
const us = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ut : "a",
  {
    ref: s,
    ...
    vr,
    {
      ...
      children: /* @__PURE__ */ l(yr, { children: [
        /* @__PURE__ */ l(Ke, { children: [
          ...
          /* @__PURE__ */ r(Je, { children: /* @__PURE__ */ r(Nr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(kr, { children: /* @__PURE__ */ r(
            Cr,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const _t = "scrBook", hs = "scrRef", Dt = "source", fs = "details", gs = "Scripture Reference", bs = "Scripture Book", _r = "Type", vs = "Details";
function xs(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? j.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === _t ? Lt(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => Lt(a.start),
      id: hs,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : Lt(o.start);
      },
      sortingFn: (a, o) => Be(a.original.start, o.original.start),
      enableGrouping: !1
    },
...
}, jn = (t) => `${ys({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wi({
  sources: t,
  ...
  }, at = (_, E) => _.getIsGrouped() ? "" : c("banded-row", E % 2 === 0 ? "even" : "odd"), pt = (_, E, U) => {
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(xo, { children: $.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ l(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r(je, {})),
                          " ",
...
function Ns({
  ...
  const s = xn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], m = o["%scripture_section_dc_short%"], d = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
...
function ks({
  ...
  }, [v, S] = O(!1), [N, C] = O(""), $ = nt(void 0), W = nt(!1);
  ...
  const L = H(() => j.allBookIds.filter(
    ...
    (R, et = !1) => {
      ...
      const k = L.findIndex((q) => q === $.current), K = L.findIndex((q) => q === R);
      if (k === -1 || K === -1) return;
      const [ft, T] = [
        Math.min(k, K),
        Math.max(k, K)
    ...
    (R) => {
      const et = xn(L, R).map((k) => k);
      n(
        Sr(L, R, e) ? e.filter((k) => !et.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, n, L]
  ), A = () => {
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(I, { variant: "ghost", size: "sm", onClick: A, children: m }),
                  ...
                  Object.values(M).map((R, et) => {
                    ...
                    if (k.length !== 0)
                      return /* @__PURE__ */ l(Bn, { children: [
                        ...
                        et < Object.values(M).length - 1 && /* @__PURE__ */ r(qn, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        ln,
        {
          ...
          children: S.map(({ value: N, label: C, id: $ }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(he, { className: "tw-me-2", value: N, id: $ }),
            /* @__PURE__ */ r(Q, { htmlFor: $, children: C })
          ] }, $))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((d) => /* @__PURE__ */ r(ut, { value: `${d}`, children: w[z(d)] }, `${d}`))
          }
        )
      ]
    }
...
const Tr = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(bn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(ho, { children: /* @__PURE__ */ r(wr, { children: Tr(
      t,
      e,
      Rr(t, w.id),
      a
...
function We({
  ...
  return /* @__PURE__ */ l(cn, { variant: s, children: [
    /* @__PURE__ */ r(or, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: i, size: "icon", children: a ?? /* @__PURE__ */ r(xa, {}) }) }),
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, d]) => typeof m == "boolean" || typeof d == "boolean" ? 0 : m.order - d.order).map(([m], d, p) => /* @__PURE__ */ l(Bn, { children: [
      /* @__PURE__ */ r(sr, { children: /* @__PURE__ */ r(fn, { children: Tr(e.groups, e.items, m, t) }) }),
...
const Ir = u.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = u.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(dn.Provider, { value: o, children: /* @__PURE__ */ r(
    F.Root,
    {
      ref: a,
      className: c(
...
Ir.displayName = F.Root.displayName;
...
const Ar = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    F.SubTrigger,
    {
...
const zr = u.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ht();
...
const jr = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
jr.displayName = F.Item.displayName;
...
const Ts = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
Ts.displayName = F.RadioItem.displayName;
...
Es.displayName = F.Label.displayName;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ l(gn, { children: [
      /* @__PURE__ */ r(bn, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        ...
        /* @__PURE__ */ r(Ar, { children: d.label }),
    ...
    return w.length > 0 && i < o.length - 1 && m.push(/* @__PURE__ */ r($r, {}, `separator-${s}`)), m;
  });
};
function Vs({
  menuData: t,
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), m = nt(void 0), d = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (ja(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (S = m.current) == null || S.focus(), ne(m, [h, f]);
        break;
    }
  }), Ot(() => {
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(_s, { children: [
      /* @__PURE__ */ r(Or, { ref: d(p), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        zr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(fn, { children: Br(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function lw({
  ...
  const d = Ms(
    ...
    var S, N, C, $, W, L;
    const v = y !== b ? ((N = (S = t[b]) == null ? void 0 : S.uiNames) == null ? void 0 : N[y]) ?? (($ = (C = t[b]) == null ? void 0 : C.uiNames) == null ? void 0 : $.en) : void 0;
...
const Is = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(ka, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
), As = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r(
  "div",
  {
    ref: a,
    role: "alert",
...
const zs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: c("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
$s.displayName = Kt.Image.displayName;
...
const pw = X.Root, uw = X.Trigger, mw = X.Group, hw = X.Portal, fw = X.Sub, gw = X.RadioGroup, Ls = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: o,
    className: c(
...
Gs.displayName = X.SubContent.displayName;
const Fs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: c(
...
Fs.displayName = X.Content.displayName;
const Xs = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Item,
  {
    ref: a,
    className: c(
...
Xs.displayName = X.Item.displayName;
const Hs = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  X.CheckboxItem,
  {
    ref: o,
    className: c(
...
const Ys = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ref: a,
    className: c(
...
const Us = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
    className: c(
...
const bw = mt.Trigger, Ws = mt.Portal, vw = mt.Close, Gr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
...
const Zs = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
...
ei.displayName = mt.Title.displayName;
...
ni.displayName = mt.Description.displayName;
const ri = u.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: a,
    className: c(
...
ri.displayName = Ge.Root.displayName;
function xw({
  className: t,
  ...e
}) {
...
ai.displayName = re.Root.displayName;
...
si.displayName = wt.List.displayName;
...
ii.displayName = wt.Trigger.displayName;
...
const ci = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = O(void 0), [w, m] = O(void 0), d = B(
    (h) => {
      i(h);
