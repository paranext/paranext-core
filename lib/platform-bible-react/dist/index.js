...
var re = (t, e, r) => ys(t, typeof e != "symbol" ? e + "" : e, r);
import { c as x, g as je, a as Br, C as sr, L as Un, u as Jo, T as $t, b as Dt, d as Ot, e as Mt, A as xa, D as He, f as Oe, h as qe, i as hr, j as tr, B as tt, x as ks, k as _s, l as Ns, I as Cs, m as Co, n as or, r as ze, o as Es, p as Kn, P as gr, q as Ir, s as fr, t as mr, v as Oa, w as Ma, y as Eo, z as vr, E as Ia, F as At, R as To, G as ya, H as io, J as so, K as co, M as lo, N as Hn, O as wa, Q as So, S as Kr, U as Hr, V as Nr, W as Ts, X as wr, Y as ar, Z as Ge, _ as er, $ as Cr, a0 as Ro, a1 as Do, a2 as ka, a3 as Oo, a4 as qn, a5 as Ss, a6 as Rs, a7 as Ds, a8 as wo, a9 as Gn, aa as za, ab as Os, ac as Wn, ad as Ms, ae as Is, af as zs, ag as Qo, ah as Ps, ai as As, aj as $s, ak as Yn, al as Xn, am as Mo, an as Vs, ao as Zn, ap as Ua, aq as tn, ar as Ka, as as Ls, at as Bs, au as js, av as Fs, aw as Us, ax as Ks, ay as Wr, az as Io, aA as Hs, aB as qs } from "./resizable-B4e5BhTX.js";
import { aC as xf, aD as yf, aE as kf, aF as _f, aG as Nf, aH as Cf, aI as Ef, aJ as Tf, aK as Sf, aL as Rf, aM as Df, aN as Of, aO as Mf, aP as If, aQ as zf, aR as Pf, aS as Af, aT as $f, aU as Vf, aV as Lf, aW as Bf, aX as jf, aY as Ff, aZ as Uf, a_ as Kf, a$ as Hf, b0 as qf, b1 as Gf, b2 as Wf, b3 as Yf, b4 as Xf, b5 as Zf, b6 as Jf, b7 as Qf, b8 as tm, b9 as em, ba as rm } from "./resizable-B4e5BhTX.js";
import { jsx as a, jsxs as u, Fragment as mt } from "react/jsx-runtime";
import { Canon as Ht } from "@sillsdev/scripture";
import { Check as nr, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Jn, ChevronDown as ur, ArrowLeft as Gs, ArrowRight as Ws, BoldIcon as Ys, ItalicIcon as Xs, X as zo, AtSign as Qn, Pencil as Zs, Trash2 as Js, ArrowUp as ti, MoreHorizontal as Qs, MailOpen as tc, Mail as ec, FilterIcon as rc, ArrowLeftIcon as ac, ChevronLeftIcon as oc, ChevronRightIcon as nc, ArrowRightIcon as ic, Copy as ei, Filter as sc, User as cc, Link as lc, CircleHelp as dc, Undo as wc, Redo as uc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as pc, AlertCircle as hc, CircleCheckIcon as gc, CircleXIcon as fc, CircleHelpIcon as mc, ArrowUpIcon as vc, ArrowDownIcon as bc, ScrollText as xc, ChevronRight as yc, ChevronLeft as kc, ChevronsUpDown as _c, MenuIcon as Nc, Menu as Cc, EllipsisVertical as Ec, MoreVertical as Tc } from "lucide-react";
import { Section as Pt, compareScrRefs as _a, getChaptersForBook as Sc, formatScrRef as Fe, formatReplacementString as rr, getSectionForBook as ua, formatRelativeDate as Rc, sanitizeHtml as Po, NumberFormat as ni, formatBytes as Dc, getCurrentLocale as Oc, usfmMarkers as pa, deepEqual as ii, isPlatformError as Mc, ABORTED as Ic, getErrorMessage as zc, getFormatCallerFunction as Pc, isString as on, scrRefToBBBCCCVVV as Ha, defaultScrRef as qa, formatScrRefRange as Ac, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as $c } from "platform-bible-utils";
import de, { useRef as B, useMemo as V, createContext as Yr, useContext as Pa, useState as _, useEffect as W, useCallback as L, useId as Na, useImperativeHandle as si, useLayoutEffect as Xt, Fragment as pr, Component as Vc, createElement as cn, Suspense as Lc, forwardRef as ci } from "react";
...
import { createEditor as wi, $getRoot as ir, $createParagraphNode as Xr, $getSelection as we, HISTORY_MERGE_TAG as Ao, ParagraphNode as ui, TextNode as pi, $getPreviousSelection as Xc, $isRangeSelection as Me, $caretFromPoint as Zc, $getSiblingCaret as hi, $getChildCaret as Jc, $getAdjacentChildCaret as Qc, $isChildCaret as tl, $normalizeCaret as el, $setSelectionFromCaretRange as rl, $getCollapsedCaretRange as al, $getCaretInDirection as ln, $splitAtPointCaretNext as ol, $isTextPointCaret as nl, $findMatchingParent as gi, $isElementNode as qr, mergeRegister as Ke, getDOMTextNode as il, isHTMLElement as sl, CLEAR_EDITOR_COMMAND as fi, COMMAND_PRIORITY_EDITOR as $o, shallowMergeConfig as cl, defineExtension as ke, safeCast as br, createState as ll, FORMAT_TEXT_COMMAND as mi, $isNodeSelection as vi, COMMAND_PRIORITY_LOW as bi, RootNode as dl, LineBreakNode as wl, TabNode as ul, $isEditorState as pl, createCommand as hl, CLICK_COMMAND as gl, isDOMNode as fl, $getNodeFromDOMNode as ml, $createNodeSelection as vl, $setSelection as bl, $getEditor as xl, DecoratorNode as uo, $getState as yl, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as kl, $setState as _l, addClassNamesToElement as xi, $create as Nl, $getNodeByKey as Cl, removeClassNamesFromElement as El, KEY_TAB_COMMAND as Tl, $isBlockElementNode as Sl, $createRangeSelection as Rl, $normalizeSelection__EXPERIMENTAL as Dl, OUTDENT_CONTENT_COMMAND as Ol, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as Ml, COMMAND_PRIORITY_CRITICAL as Vo, $isDecoratorNode as Il, $isParagraphNode as zl, $isTextNode as po, SELECTION_CHANGE_COMMAND as yi, $insertNodes as Pl } from "lexical";
...
import { useReactTable as _i, getFilteredRowModel as Kl, getSortedRowModel as Ni, getPaginationRowModel as Hl, getCoreRowModel as Ci, flexRender as jr, getGroupedRowModel as ql, getExpandedRowModel as Gl } from "@tanstack/react-table";
import Wl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ho, HIDDEN_NOTE_CALLER as go, getDefaultViewOptions as Yl, isInsertEmbedOpOfType as Ar, getMarkerMenuItems as Xl, defaultStyleInfo as Zl, Editorial as Jl } from "@eten-tech-foundation/platform-editor";
...
function Ti({
  ...
  const v = B(!1), f = () => {
    ...
    () => Br(e, l),
    [e, l]
  ), E = !!h && !p, P = `${N} (${k})`, K = E ? m || `${P}, ${h}` : P, C = /* @__PURE__ */ u(
    sr,
    {
      ref: t,
...
function sd({
  ...
  const {
    ...
    onPointerEnter: v,
    onPointerLeave: f
  } = Jo(), [g, N] = _(!1), [k, E] = _(!1), P = B(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), K = n && e !== void 0, C = s ?? (e !== void 0 && !n);
  W(() => {
    var R;
    id();
    ...
    const y = (Y) => !!Y && Y.scrollWidth > Y.clientWidth, et = () => {
      fo !== "pointer" && (C || y(h.current) || y(l.current)) && E(!0);
    }, I = () => E(!1);
...
function wd({
  ...
  const [h, m] = _(!1), [v, f] = _(!1), g = Na(), N = B(!1), k = w !== void 0, E = k ? w : h, P = n === "" ? "" : le(n, ld), K = le(s, dd), C = (D) => {
    D || (N.current = !0, f(!1)), k || m(D), p == null || p(D);
  }, j = (D) => {
    if (D && N.current) {
      N.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(He, { open: E, onOpenChange: C, modal: !1, children: [
    /* @__PURE__ */ a($t, { children: P ? /* @__PURE__ */ u(Dt, { open: v, onOpenChange: j, children: [
...
function Wa({
  ...
  const C = ze(), j = nd(), [$, O] = _(!1), [D, T] = _(""), [M, X] = _(""), [y, et] = _("books"), [I, R] = _(void 0), [Y, st] = _(
    void 0
  ...
  const { otLong: We, ntLong: Ye, dcLong: Xe, extraLong: Ze } = {
    ...
    (b) => {
      ...
      if (!(!!q && !!((Yo = Bt.current) != null && Yo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (b.key === "Tab") {
        const Lt = Bt.current ? yd(Bt.current) : [];
        if (Lt.length === 0) {
      ...
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const xe = (() => {
          if (y === "verses") {
            const Pr = Y, Zo = ot, Fa = na(D);
            return !Pr || !Zo || Fa === void 0 ? void 0 : {
              isDisabled: te(Pr, Zo)(Fa),
              activate: () => Qt(Fa)
            };
          }
          const ee = I, Ce = Lr(D);
      ...
      if (!ad(b.key) || Ct) return;
      if (y === "books" && !ne && (b.key === "ArrowLeft" || b.key === "ArrowRight")) {
        const Lt = q === xt.current ? xt.current : void 0, xe = (Lt == null ? void 0 : Lt.selectionStart) ?? 0, ee = (Lt == null ? void 0 : Lt.selectionEnd) ?? 0, Ce = C === "rtl" ? b.key === "ArrowRight" : b.key === "ArrowLeft";
  ...
  }, [y, z, Ne, rt, D]), /* @__PURE__ */ u(gr, { open: $, onOpenChange: ge, modal: k, children: [
              ...
              y === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Ma, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: zt.map(
                ...
                /* @__PURE__ */ u(Dt, { children: [
                  /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Jr,
                      children: C === "ltr" ? /* @__PURE__ */ a(Gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ws, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                ...
                /* @__PURE__ */ a(
                  "span",
                  {
                    ...
                    children: y === "verses" ? xr : Be
                  }
                )
              ] }),
              !Ct && /* @__PURE__ */ u(vr, { ref: Gt, children: [
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a(or, { heading: S(b), children: q.map((at) => /* @__PURE__ */ a(
                          Ti,
                          {
                            ...
                            localizedBookNames: s,
                            disabled: Ft(at),
                            dimmedReason: kt.has(at) ? ja : void 0,
...
function xn({
  ...
  const [E, P] = _(!1), K = d ?? l, C = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], j = ($, O) => {
  ...
  return /* @__PURE__ */ u(gr, { open: E, onOpenChange: P, ...k, children: [
    /* @__PURE__ */ a(Ir, { asChild: !0, children: /* @__PURE__ */ u(
      tt,
      {
        variant: v,
    ...
    /* @__PURE__ */ a(
      fr,
      {
        ...
        children: /* @__PURE__ */ u(mr, { children: [
          ...
          /* @__PURE__ */ a(vr, { children: C(e) ? e.map(($) => /* @__PURE__ */ a(or, { heading: $.groupHeading, children: $.options.map((O) => j(O, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(or, { children: e.map(($) => j($)) }) })
        ] })
      }
    )
  ] });
...
const Mi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cd = Mi ? Xt : W, sa = { tag: Ao };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (m.isEmpty()) {
            ...
            (we() !== null || f !== null && f === p.getRootElement()) && v.select();
          }
        }, sa);
...
const Id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
function zd(t) {
...
function Ld(t, e, r) {
  ...
  function l() {
    ...
    for (let N = 0; N < m.length; N++) {
      const k = m[N], E = i[N] || document.createElement("div"), P = E.style;
      P.position !== "absolute" && (P.position = "absolute", g = !0);
      const K = De(k.left - p);
      P.left !== K && (P.left = K, g = !0);
      const C = De(k.top - h);
      P.top !== C && (E.style.top = C, g = !0);
      const j = De(k.width);
      P.width !== j && (E.style.width = j, g = !0);
      const $ = De(k.height);
      P.height !== $ && (E.style.height = $, g = !0), E.parentNode !== c && (c.append(E), g = !0), i[N] = E;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = m, s = new MutationObserver((v) => {
      ...
      if (f !== o || g !== n) return p();
      for (const N of v) if (!c.contains(N.target)) return l();
    }), s.observe(m, Vd), l();
  });
  return () => {
    w(), d();
...
function jd(t, e = Bd) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), v = h.getNode(), f = v.getKey(), g = h.offset, N = m.getNode(), k = N.getKey(), E = m.offset, P = t.getElementByKey(f), K = t.getElementByKey(k), C = r === null || P !== o || g !== n || f !== r.getKey(), j = s === null || K !== i || E !== c || k !== s.getKey();
      if ((C || j) && P !== null && K !== null) {
...
function Ud(t) {
  ...
  return qr(e) || Ca(4, t.__key), e;
}
function Kd(t) {
  const e = we() || Xc();
  let r;
  if (Me(e)) r = Zc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = hi(c, "next"));
    }
    r = r || Jc(ir(), "previous").getFlipped().insert(Xr());
  }
...
function Hd(t, e, r) {
  ...
  return nl(o) && Ca(283), o.insert(t.isInline() ? Xr().append(t) : t), ln(hi(t.getLatest(), "next"), e.direction);
}
function qd(t) {
  const e = we();
  if (!Me(e)) return !1;
...
function Zd(t) {
  ...
  Pi(this), dt = t, this.f &= -2, 8 & this.f && Fo(this), Va();
}
function _r(t, e) {
...
ae.prototype.brand = Gd, ae.prototype.h = function() {
  return !0;
...
ke({ build: (t, e, r) => zr(e), config: br({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
ke({ build: (t, e, r) => zr(e), config: br({ $onClear: $i }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ke({ name: "@lexical/extension/DecoratorText", nodes: () => [Li], register: (t, e, r) => t.registerCommand(mi, (o) => {
  const n = we();
  if (vi(n) || Me(n)) for (const s of n.getNodes()) Qd(s) && s.toggleFormat(o);
  return !1;
}, bi) });
function Bi(t, e) {
  let r;
...
const Uo = 0, _o = 1, Fi = 2, Ja = 3, ca = 4, kr = 5, Qa = 6, $r = 7;
function to(t) {
  return t.id === Uo;
}
function Ui(t) {
...
class rw {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== ca && pt(307, String(r.id), String(kr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== kr && pt(308, String(o.id), String(kr));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Qa && pt(310, String(r.id), String(Qa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ja;
    }(e) || pt(314, String(e.id), String(Ja)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const ow = ke({ config: br({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = aw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Tr {
  ...
  static maybeFromEditor(e) {
    const r = e[En];
    return r && (r.PACKAGE_VERSION !== eo && pt(292, r.PACKAGE_VERSION, eo), r instanceof Tr || pt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      to(s) || pt(300, i, n || "[unknown]"), to(c = s) || pt(304, String(c.id), String(Uo)), s = Object.assign(c, { id: _o }), o.state = s;
    ...
    for (const w of c) {
      ...
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Jd(p)) {
        if (typeof h != "function") {
          ...
          m && pt(302, p.name, h.replace.name, m.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const iw = /* @__PURE__ */ new Set(), Sn = ke({ build(t, e, r) {
...
ke({ dependencies: [ko, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [Sr], register(t, e, r) {
  ...
  return Ke(t.registerCommand(sw, (i) => {
    ...
    return !1;
  }, bi), t.registerMutationListener(Sr, (i, c) => {
    Wd(() => {
      let l = !1;
      ...
      for (const [w, p] of i.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = m : (l = !0, d.set(w, { domNode: Gr(m), selectedSignal: o(w) }));
      }
...
ke({ build: (t, e) => zr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: br({ $getParentEditor: function() {
  const t = xl();
...
ke({ build: (t, e, r) => zr(e), config: br({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ie(() => {
...
ke({ build: (t, e, r) => zr(e), config: br({ $canIndent: Ki, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: s } = r.getOutput();
  return Ie(() => {
    if (!o.value) return dw(t, n, s);
  });
} });
const ww = ke({ name: "@lexical/react/ReactProvider" });
function uw() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Me(v)) {
                const f = v.anchor;
                let g = f.getNode(), N = 0, k = 0;
                if (po(g) && d >= 0 && w >= 0 && (N = d, k = d + w, v.setTextNodeRange(g, N, g, k)), N === k && p === "" || (v.insertRawText(p), g = f.getNode()), po(g)) {
                  N = h, k = h + m;
                  const E = g.getTextContentSize();
                  N = N > E ? E : N, k = k > E ? E : k, v.setTextNodeRange(g, N, g, k);
                }
...
ke({ build: (t, e, r) => zr(e), config: br({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ie(() => r.getOutput().disabled.value ? void 0 : qi(t)) });
function gw(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function vw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Ho(() => Ke(Vl(n), qi(n)), [n]);
  }(o), u(mt, { children: [t, a(bw, { content: e }), a(mw, { editor: o, ErrorBoundary: r })] });
}
...
const yw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
...
function Ew(t, e) {
  ...
  return u(mt, { children: [a(Nw, { editor: n, ...o, ref: e }), r != null && a(Tw, { editor: n, content: r })] });
}
...
function Ow({
  ...
  const [e] = Ae(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Dw(), l = () => {
  };
...
const Vw = "verseText", xh = Object.freeze([
...
function yh({
  ...
  const [s, i] = _(Lw), [c, l] = _(n), [d, w] = _(!1), p = B(void 0), h = B(null);
  W(() => {
    let g = !0;
    const N = h.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(gr, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ir, { asChild: !0, children: /* @__PURE__ */ u(
        tt,
        {
          variant: "outline",
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (g) => {
          g.key === "Escape" ? (g.preventDefault(), g.stopPropagation(), r()) : Go(g) && (g.preventDefault(), g.stopPropagation(), ye(s) && m());
        },
        onKeyDown: (g) => {
...
function In({
  ...
  const m = L(
    (C) => {
      C && C.stopPropagation(), d(!1), p(void 0), i == null || i(!1);
    },
    [i]
  ), v = L(
    async (C) => {
  ...
  }, [t.date, r]), g = V(() => t.user, [t.user]), N = V(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = V(() => Po(t.contents), [t.contents]), E = V(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), P = !!t.conflictResolutionAction && !E, K = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(mt, { children: [
        /* @__PURE__ */ u(
          tr,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), p($w(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Uw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Kw, { className: "tw:text-xs tw:font-medium", children: N }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : Go(C) && (C.preventDefault(), C.stopPropagation(), ye(w) && v());
              },
              onKeyDown: (C) => {
                qo(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        K && /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Qs, {}) }) }),
...
function os({
  ...
  const Qt = L(
    ...
    async (A) => {
      const zt = ye(M) ? Ra(M) : void 0, _t = A.status ? A.assignedUser : y ?? A.assignedUser, Wt = await p({
        ...A,
        contents: zt,
        assignedUser: _t
      });
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              tt,
              {
                ...
                children: bt ? /* @__PURE__ */ a(tc, {}) : /* @__PURE__ */ a(ec, {})
              }
            ),
            D === void 0 ? (
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ u(gr, { open: J, onOpenChange: ct, children: [
                      ...
                      /* @__PURE__ */ a(
                        fr,
                        {
                          ...
                          children: /* @__PURE__ */ a(mr, { children: /* @__PURE__ */ a(vr, { children: f == null ? void 0 : f.map((A) => /* @__PURE__ */ a(
                            sr,
                            {
                              onSelect: () => {
...
function Gw({
  ...
  }, P = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", K = m ? [
    {
      value: "merge",
  ...
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", T = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), M = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : T, X = () => {
    const I = o ?? "accept";
    return I === "merged" ? t.mergedText ? /* @__PURE__ */ a(ba, { html: N }) : T : M(I === "reject" ? t.rejectedResultText : t.resultText);
  }, y = (I) => p && I.value === "reject", et = (I) => {
    const R = v === I.value, Y = `${d}-${I.value}`, st = y(I);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(mt, { children: [
        ...
        /* @__PURE__ */ a(
          To,
          {
            ...
            children: C.map((I) => y(I) ? /* @__PURE__ */ a($t, { delayDuration: 0, children: /* @__PURE__ */ u(Dt, { children: [
...
function Jw(t) {
  ...
  } = t, c = V(() => e.filter((N) => !N.deleted), [e]), l = V(
...
function Dh({
  ...
  const [k, E] = _(/* @__PURE__ */ new Set()), [P, K] = _(), [C, j] = _(), $ = L(
    async (R) => {
      const Y = await s(R);
  ...
  W(() => {
    v && (E((R) => new Set(R).add(v)), K(v));
  }, [v]);
  const O = r.filter(
    (R) => R.comments.some((Y) => !Y.deleted)
  ), D = O.map((R) => ({ id: R.id })), T = L(
    (R) => {
      E((Y) => new Set(Y).add(R.id)), K(R.id), f == null || f(R.id);
    },
    [f]
  ), M = L(
    (R) => {
    ...
    [k, f]
  ), { listboxRef: X, activeId: y, handleKeyDown: et } = Ts({
    options: D,
    onOptionSelect: T
  }), I = L(
    (R) => {
      R.key === "Escape" ? (P && k.has(P) && (E((Y) => {
        const st = new Set(Y);
      ...
      children: O.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(Jw, { ...Y, conflictResolution: N }) : /* @__PURE__ */ a(os, { ...Y })
          },
          R.id
        );
      })
...
function Ee({
  ...
  return /* @__PURE__ */ u(
    oe.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(oe.ItemIndicator, { children: /* @__PURE__ */ a(Aa, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        Rr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(Mr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Ee, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ou({
  ...
  var C;
  const [w, p] = _([]), [h, m] = _([]), [v, f] = _({}), [g, N] = _({}), k = V(() => e ?? [], [e]), E = _i({
    data: k,
    columns: t,
    getCoreRowModel: Ci(),
  ...
  let K;
  return l ? K = Array.from({ length: 10 }).map((O, D) => `skeleton-row-${D}`).map((O) => /* @__PURE__ */ a(er, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Cr, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((C = E.getRowModel().rows) == null ? void 0 : C.length) > 0 ? K = E.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    er,
    {
      onClick: () => i(j, E),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map(($) => /* @__PURE__ */ a(Cr, { children: jr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    j.id
  )) : K = /* @__PURE__ */ a(er, { children: /* @__PURE__ */ a(Cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Qw, { table: E }),
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Do, { stickyHeader: s, children: E.getHeaderGroups().map((j) => /* @__PURE__ */ a(er, { children: j.headers.map(($) => /* @__PURE__ */ a(ka, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : jr($.column.columnDef.header, $.getContext()) }, $.id)) }, j.id)) }),
...
function Ph({
  ...
  return /* @__PURE__ */ u(gr, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(fr, { id: s, className: x("tw:min-w-80 tw:max-w-96", n), children: [
...
function Ah({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(He, { children: [
    ...
    /* @__PURE__ */ a(qe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(hr, { children: d.label }),
...
const fu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(mt, { children: [
...
function mu({
  ...
  const n = B(null), s = B(null), i = B(!1), [c, l] = _(t), [d, w] = _(e), [p, h] = _(!1), m = B(!1), v = B(c);
  v.current = c;
  const f = B(d);
  f.current = d, W(() => {
    l(t);
  ...
  const g = (k) => {
    if (i.current = !1, h(k), !k) {
      const E = v.current, P = f.current;
      E !== "custom" || P ? (E !== t || P !== e) && r(E, P) : (l(t), w(e));
    }
  }, N = (k) => {
    var E, P, K, C;
    k.stopPropagation(), document.activeElement === s.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((E = n.current) == null || E.focus(), i.current = !0) : document.activeElement === n.current && k.key === "ArrowUp" ? ((P = s.current) == null || P.focus(), i.current = !1) : document.activeElement === n.current && k.key === "ArrowLeft" && ((K = n.current) == null ? void 0 : K.selectionStart) === 0 && ((C = s.current) == null || C.focus(), i.current = !1), c === "custom" && k.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
  return /* @__PURE__ */ u(He, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: fu(t, o, e) }) }) }),
...
const vu = (t, e) => t === "f" ? /* @__PURE__ */ u(mt, { children: [
  /* @__PURE__ */ a(ai, {}),
  " ",
...
function xu({
  ...
  return /* @__PURE__ */ u(He, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "outline", className: "tw:h-6", children: vu(t, r) }) }) }),
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: bu(t, r) }) })
    ] }) }),
...
function Bh({
  ...
  var Ze;
  const f = B(null), g = B(null), N = B(null), k = B(null), E = B(s);
  W(() => {
    E.current = s;
  }, [s]);
  const P = B(h);
  ...
  const [C, j] = _("generated"), [$, O] = _("generated"), [D, T] = _(ao), [M, X] = _(ao), [y, et] = _("f"), [I, R] = _(!1), [Y, st] = _(!0), [ot, ut] = _(!1), Ct = B(!1), J = B(""), ct = B(!1), ht = B(void 0), [nt, Et] = _(!1), [ne, bt] = _(), [Se, _e] = _(), [Bt, xt] = _(), [Gt, fe] = _(), It = B(null), gt = B(
    void 0
  ...
  const Zt = L(() => {
    var G, Q, H;
    const S = (G = g.current) == null ? void 0 : G.querySelector(".editor-input"), F = S == null ? void 0 : S.querySelector("span.note"), Z = (H = (Q = g.current) == null ? void 0 : Q.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
    ...
    (S = !1) => {
      ...
      if (F && Ar("note", F) && (r == null || r([F]), S && d && E.current)) {
        if (w && ii(F, ht.current)) return;
        ht.current = F, (Q = d.current) == null || Q.replaceEmbedUpdate(E.current, [F]);
      }
    },
    [w, r, v, d]
  ), $e = L(
    ...
    if (ht.current = G, G && Ar("note", G)) {
      ...
      T(lt), X(lt), j(wt), O(wt), et(((H = G.insert.note) == null ? void 0 : H.style) ?? "f"), S = setTimeout(() => {
        ...
        (te = f.current) == null || te.applyUpdate(Rt ? [G, { delete: 1 }] : [G]), K(), (Be = f.current) == null || Be.focus(), F = requestAnimationFrame(() => {
          Z = setTimeout(() => {
            var xr;
            Zt() || (K(), (xr = f.current) == null || xr.focus());
          }, 0);
        });
      }, 0);
    }
  ...
  const Jt = L(() => {
    var S, F;
    if (!gt.current) {
      const Z = (S = g.current) == null ? void 0 : S.querySelector(".editor-input");
  ...
  const ve = () => {
    var F;
    const S = (F = g.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    S != null && S.textContent && navigator.clipboard.writeText(S.textContent);
  }, A = L(
    (S, F) => {
      v == null || v(), j(S), T(F), $e(S, F), w && z();
    },
    [$e, z, w, v]
  ), zt = (S) => {
    var Z, G, Q, H, it;
    ...
    if (F && Ar("note", F)) {
      ...
      y !== "x" && S === "x" ? wt == null || wt.forEach((lt) => Tu(lt)) : y === "x" && S !== "x" && (wt == null || wt.forEach((lt) => Su(lt))), (it = f.current) == null || it.applyUpdate([F, { delete: 1 }]);
    }
  }, _t = (S) => {
    ...
    if (N.current && ie.length && S && S.rangeCount > 0) {
      const F = S.getRangeAt(0).getBoundingClientRect(), Z = N.current.getBoundingClientRect();
    ...
    (S, F, Z) => {
      ...
      Is({
        ...
        onShowError: (H) => {
          (!Mc(H) || H.code !== Ic) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${zc(H)}`
          );
        }
      });
    },
  ...
  W(() => {
    ...
    const S = () => {
      var G;
      return ((G = g.current) == null ? void 0 : G.querySelector(".editor-input")) ?? void 0;
    };
    ...
    const S = () => {
      var G, Q, H;
      const F = ((G = g.current) == null ? void 0 : G.querySelector(".editor-input")) ?? void 0;
  ...
  return /* @__PURE__ */ u(mt, { children: [
    ...
    /* @__PURE__ */ u(gr, { open: nt, children: [
      /* @__PURE__ */ a(
        Ps,
        {
          className: "tw:absolute",
...
function Iu(t, e, r = !0, o = void 0, n = void 0) {
  const s = [];
  let i = [];
  (e ?? []).forEach((l) => {
  ...
  return c || s.push([]), s.map((l, d) => {
    ...
    return (
      ...
      /* @__PURE__ */ u("p", { className: "notetext", children: [
        w && !c && /* @__PURE__ */ a("span", { className: "note-placeholder", children: Ou }),
        w && n,
        is(t, l, r),
        p && o
      ] }, `${t ?? "note"}-p${d}`)
...
function is(t, e, r = !0, o = !1) {
  if (!(!e || e.length === 0))
    return e.map((n, s) => {
      const i = `${t ?? "note"}-${s}`;
      return typeof n == "string" ? /* @__PURE__ */ a("span", { className: x(`usfm_${t}`), children: n }, i) : zu(n, i, r, o);
    });
}
function zu(t, e, r, o = !1) {
  ...
  return /* @__PURE__ */ u("span", { children: [
    ...
    n && r && Mu(t) && /* @__PURE__ */ a("span", { className: "marker", children: `\\${s}*` })
  ] }, e);
}
function Pu({
  footnote: t,
...
function Fh({
  ...
  const f = w ?? Pc(o, void 0), g = v ? m : void 0, N = B([]), k = (T, M, X) => {
    if (h) {
      const y = N.current[M], et = y ? uu(X.clientX, X.clientY, y) : "end";
      h(T, M, s, et);
      return;
    }
    p == null || p(T, M, s);
  }, E = i ? o.findIndex((T) => T === i) : -1, [P, K] = _(E), C = (T) => {
    var M;
    K(T), T >= 0 && T < N.current.length && ((M = N.current[T]) == null || M.focus());
  }, j = (T, M, X) => {
    if (o.length)
      switch (T.key) {
        case "Enter":
  ...
  return W(() => {
    var T;
    D < 0 || D >= N.current.length || (T = N.current[D]) == null || T.scrollIntoView({ block: "nearest" });
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: o.map((T, M) => {
            const X = T === i, y = M === m && !!v, et = y ? Au : `${s}-${M}`, I = M < o.length - 1 && n === "vertical" && /* @__PURE__ */ a(Hr, { tabIndex: -1, className: "tw:col-span-2" });
  ...
  return /* @__PURE__ */ u(Ro, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Oo, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      er,
      {
        ...
        children: [
          /* @__PURE__ */ a(Cr, { children: Fe(c.reference, "English") }),
          /* @__PURE__ */ a(Cr, { className: o, children: $u(c.text) })
        ]
      },
...
const Lu = (t) => {
...
}, La = (t, e, r) => /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Dt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
  ...
  return e ? e[1] : "";
}, ju = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Yh = Object.freeze([
...
function Xh({
  ...
  const m = Re(r, "%webView_inventory_all%"), v = Re(r, "%webView_inventory_approved%"), f = Re(r, "%webView_inventory_unapproved%"), g = Re(r, "%webView_inventory_unknown%"), N = Re(r, "%webView_inventory_scope_currentBook%"), k = Re(r, "%webView_inventory_scope_chapter%"), E = Re(r, "%webView_inventory_scope_verse%"), P = Re(r, "%webView_inventory_filter_text%"), K = Re(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = Re(r, "%webView_inventory_no_results%"), [j, $] = _(!1), [O, D] = _("all"), [T, M] = _(""), [X, y] = _([]), et = V(() => {
    const J = t ?? [];
    return J.length === 0 ? [] : Uu(J, n, s);
  }, [t, n, s]), I = V(() => {
    if (j) return et;
    const J = [];
  ...
  }, [j, et]), R = V(() => I.length === 0 ? [] : Fu(I, O, T), [I, O, T]), Y = V(() => {
    var ht, nt;
    if (!j) return l;
...
const Ku = "16rem", Hu = "3rem", cs = de.createContext(void 0);
function Ba() {
...
function qu({
  ...
  const [l, d] = de.useState(t), w = e ?? l, p = de.useCallback(
    ...
    [r, w]
  ), h = de.useCallback(() => p((E) => !E), [p]), m = w ? "expanded" : "collapsed", g = ze() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = de.useMemo(
    () => ({
      state: m,
      open: w,
      setOpen: p,
...
function Qu({
  ...
  const c = t ? Zr.Root : "button", { state: l } = Ba(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: x(Ju({ variant: r, size: o }), s),
      ...i
    }
  );
...
function tp({
  ...
  const p = L(
    ...
    (g) => {
      const N = r.find((k) => k.projectId === g);
    ...
    Gu,
    {
      ...
      children: /* @__PURE__ */ u(Yu, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a(Xu, { children: Object.entries(e).map(([g, N]) => /* @__PURE__ */ a(Zu, { children: /* @__PURE__ */ a(
            Qu,
            {
              onClick: () => p(g),
              isActive: f(g),
...
const Je = "scrBook", ep = "scrRef", dr = "source", rp = "details", ap = "Scripture Reference", op = "Scripture Book", ls = "Type", np = "Details";
function ip(t, e) {
  const r = e ?? !1;
  return [
    {
...
function wg({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Je, desc: !1 }]), [m, v] = _({}), f = V(
  ...
  const k = n ?? op, E = s ?? ls, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Je] },
    { label: `Group by ${E}`, value: [dr] },
    {
    ...
    !e && /* @__PURE__ */ u(
      Rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Mr, { position: "item-aligned", children: /* @__PURE__ */ a(tu, { children: P.map((O) => /* @__PURE__ */ a(Ee, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Do, { children: N.getHeaderGroups().map((O) => /* @__PURE__ */ a(er, { children: O.headers.filter((D) => D.column.columnDef.header).map((D) => (
      ...
      /* @__PURE__ */ a(Oo, { children: N.getRowModel().rows.map((O, D) => {
        const T = ze();
        return /* @__PURE__ */ a(
          er,
          {
                    ...
                    children: M.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (T === "ltr" ? /* @__PURE__ */ a(yc, {}) : /* @__PURE__ */ a(kc, {})),
                          " ",
...
function cp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: m, dcLong: v, extraLong: f } = {
  ...
  }, [g, N] = _(!1), [k, E] = _(""), P = B(void 0), K = B(!1), C = V(
    () => Xn(t),
    [t]
  ), j = V(() => {
    if (!k.trim()) {
    ...
    (y, et = !1) => {
      ...
      const I = C.findIndex((ut) => ut === P.current), R = C.findIndex((ut) => ut === y);
      if (I === -1 || R === -1) return;
      const [Y, st] = [
        Math.min(I, R),
        Math.max(I, R)
      ], ot = C.slice(Y, st + 1).map((ut) => ut);
      r(
    ...
    () => Object.values(Pt).filter(
      (y) => (s == null ? void 0 : s[y]) !== void 0 && Mo(C, y).length === 0
...
function pg({
  ...
  const C = Kt(
  ...
  ] }), nt = e ? ct.filter((U) => e.includes(U.value)) : ct, Et = g ?? qa, ne = h ?? Et, bt = m ?? Et, Se = () => {
    ...
    (U) => {
      v == null || v(U), f == null || f(U), vt.current = !0;
    },
    [v, f]
  ), $e = L(
    (U) => {
    ...
    [r, n, g, s]
  ), Tt = nt.find((U) => U.value === t), se = () => t === "selectedBooks" && n.length > 0 ? n.map((U) => U.toUpperCase()).join(", ") : t === "range" ? Ac(ne, bt, {
  ...
  const [Rt, Ft] = _(null), [St, te] = _(null), [Be, xr] = _(null), Jr = 200, [ja, Qr] = _(!1);
  W(() => {
  ...
  const ta = L(
    ...
    A !== void 0 && (A === "range" ? (_t && (v == null || v(_t)), he && (f == null || f(he))) : A === "selectedBooks" && s(Ve), kt(A), ve(void 0), zt(void 0));
  }, [
    A,
    _t,
    he,
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(He, { open: Jt, onOpenChange: Qt, children: [
        ...
        /* @__PURE__ */ a(
          qe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Ua, { container: Be, children: [
                  ...
                  tr,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ u("span", { className: "tw:flex tw:min-w-0 tw:flex-col tw:gap-0.5", children: [
                        /* @__PURE__ */ a("span", { className: "tw:flex tw:items-center tw:gap-1.5", children: ht(Vt ?? rt, be, ja) }),
              ...
              N && /* @__PURE__ */ u(mt, { children: [
                /* @__PURE__ */ a(wr, {}),
                /* @__PURE__ */ a(hr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Ct }),
                /* @__PURE__ */ a(
                  tr,
                  {
                    ref: Gt,
    ...
    p === "radio" && t === "range" && H,
    p === "dropdown" && ft && /* @__PURE__ */ a(io, { open: pe === "selectedBooks", onOpenChange: yr, children: /* @__PURE__ */ a(
      so,
      {
        ref: te,
        onCloseAutoFocus: ra,
        ...
        children: /* @__PURE__ */ u(Ua, { container: St, children: [
          /* @__PURE__ */ a(co, { className: "tw:pe-8", children: /* @__PURE__ */ a(lo, { children: X }) }),
          Ye,
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(tt, { variant: "outline", onClick: () => yr(!1), children: ut }),
            /* @__PURE__ */ a(tt, { onClick: ea, children: ot })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && me && /* @__PURE__ */ a(io, { open: pe === "range", onOpenChange: yr, children: /* @__PURE__ */ a(
      so,
      {
        ref: Ft,
        onCloseAutoFocus: ra,
        ...
        children: /* @__PURE__ */ u(Ua, { container: Rt, children: [
...
function hg({
  ...
  return /* @__PURE__ */ u(
    Rr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(Or, { size: n, className: x("pr-twp tw:w-auto", s), children: /* @__PURE__ */ a(
          Dr,
          {
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Dt, { children: [
...
function No({
  ...
  const d = Na(), w = gp(e), p = s && w.length > 1;
  return /* @__PURE__ */ u(He, { variant: i, children: [
    /* @__PURE__ */ a(Oe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(tt, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(Nc, {}) }) }),
    /* @__PURE__ */ a(qe, { align: "start", style: { zIndex: Ge }, children: w.map(({ columnKey: h, label: m }, v) => {
      ...
      return /* @__PURE__ */ u(pr, { children: [
        /* @__PURE__ */ u(qn, { "aria-labelledby": p ? f : void 0, children: [
          p && /* @__PURE__ */ a(hr, { id: f, children: m }),
          /* @__PURE__ */ a($t, { children: ps(e.groups, e.items, h, t) })
        ] }),
        v < w.length - 1 && /* @__PURE__ */ a(wr, {})
      ] }, h);
    }) })
  ] });
}
...
const vp = Object.freeze([520, 420, 340]), gs = de.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = hs(n, vp), d = Ri() ?? l, w = d >= Fr.MINIMUM;
...
const fs = de.forwardRef(({ className: t, ...e }, r) => {
  const o = ze();
  return /* @__PURE__ */ a(
    Te.Root,
    {
...
const ms = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.List,
  {
    ref: r,
    className: x(
...
const bp = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Trigger,
  {
    ref: r,
    ...e,
...
)), vs = de.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Te.Content,
  {
    ref: r,
    className: x(
...
function xg({
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(fs, { children: [
      /* @__PURE__ */ a(ms, { children: t.map((c) => /* @__PURE__ */ a(bp, { value: c.value, children: c.value }, c.key)) }),
...
const Vr = (t, e) => {
  ...
  return n.flatMap(([s], i) => {
      ...
      /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Cp,
        {
          ...
          children: [
            ...
            d.shortcut && /* @__PURE__ */ a(Tp, { children: d.shortcut })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(Sp, { children: [
        /* @__PURE__ */ a(Rp, { children: d.label }),
        /* @__PURE__ */ a(Dp, { children: bs(
          t,
          e,
          ds(t, d.id),
          o
    ...
    return c.length > 0 && i < n.length - 1 && l.push(/* @__PURE__ */ a(Ep, {}, `separator-${s}`)), l;
  });
};
function Op({
  menuData: t,
  ...
  if (Ql(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (v = s.current) == null || v.focus(), Vr(s, [h, m]);
        break;
      case "alt+l":
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (N = l.current) == null || N.focus(), Vr(l, [h, m]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(xp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ws(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(yp, { children: [
      /* @__PURE__ */ a(_p, { ref: d(w), children: p.label }),
      /* @__PURE__ */ a(
        Np,
        {
          style: { zIndex: Ge },
          children: /* @__PURE__ */ a($t, { children: bs(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function _g({
  ...
  const d = Ip(
    ...
    var N, k, E, P, K, C;
    const g = f !== v ? ((k = (N = t[v]) == null ? void 0 : N.uiNames) == null ? void 0 : k[f]) ?? ((P = (E = t[v]) == null ? void 0 : E.uiNames) == null ? void 0 : P.en) : void 0;
    return g ? `${(K = t[v]) == null ? void 0 : K.autonym} (${g})` : (C = t[v]) == null ? void 0 : C.autonym;
  };
...
function Cg({
  ...
  return /* @__PURE__ */ u(mr, { id: s, className: x("pr-twp", n), shouldFilter: !1, children: [
...
function Dg({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = V(() => {
    const c = new ni(o);
    return (l) => c.format(l);
...
function jg({
  ...
  return /* @__PURE__ */ u(
    qt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(qt.ItemIndicator, { children: /* @__PURE__ */ a(Aa, {}) }) }),
        e
      ]
    }
  );
...
function nf({
  ...
  return /* @__PURE__ */ a(
    Te.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: x("pr-twp", Bp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function ff({ value: t, children: e }) {
...
export {
  ...
  Vg as ContextMenuItem,
  Ug as ContextMenuLabel,
  zg as ContextMenuPortal,
  Ag as ContextMenuRadioGroup,
  Fg as ContextMenuRadioItem,
  Kg as ContextMenuSeparator,
  Hg as ContextMenuShortcut,
  Pg as ContextMenuSub,
  Bg as ContextMenuSubContent,
  Lg as ContextMenuSubTrigger,
  Mg as ContextMenuTrigger,
  ou as DataTable,
  Tg as DestructiveKeyConfirmation,
  io as Dialog,
  Nf as DialogClose,
  so as DialogContent,
  ...
  lo as DialogTitle,
  Sf as DialogTrigger,
  dp as DisabledActionTooltip,
  lp as DisabledTooltipWrapper,
  qg as Drawer,
  Wg as DrawerClose,
  Yg as DrawerContent,
  Qg as DrawerDescription,
  Zg as DrawerFooter,
  Xg as DrawerHeader,
  Lp as DrawerOverlay,
  Vp as DrawerPortal,
  ...
  zh as ERROR_POPOVER_STRING_KEYS,
  ...
  za as Input,
  Cg as InterfaceLanguagePicker,
  Xh as Inventory,
  wo as Kbd,
  Af as KbdGroup,
  At as Label,
  yu as MARKER_MENU_STRING_KEYS,
  Ih as MarkdownRenderer,
  Nu as MarkerMenu,
  $h as MoreInfo,
  Ds as MultiSelectComboBox,
  xg as NavigationContentSearch,
  gr as Popover,
  Ps as PopoverAnchor,
  ...
  Ff as ResizablePanelGroup,
  Sg as ResultsCard,
  Uf as RetryableErrorView,
  ug as SCOPE_SELECTOR_STRING_KEYS,
  pp as SELECT_BOOKS_STRING_KEYS,
  Fr as SHRINK_STEP,
  pg as ScopeSelector,
  wg as ScriptureResultsViewer,
  hg as ScrollGroupSelector,
  Yn as SearchBar,
  Rr as Select,
  up as SelectBooks,
  ...
  Kf as Spinner,
  af as Switch,
  mf as TOOLTIP_DELAY_MS,
  No as TabDropdownMenu,
  bg as TabFloatingMenu,
  vg as TabToolbar,
  Ro as Table,
  Oo as TableBody,
  Hf as TableCaption,
  ...
  _g as UiLanguageSelector,
  hu as UndoRedoButtons,
  fs as VerticalTabs,
  vs as VerticalTabsContent,
  ms as VerticalTabsList,
  bp as VerticalTabsTrigger,
  Dg as WizardStepper,
  Ge as Z_INDEX_ABOVE_DOCK,
  Gn as Z_INDEX_ABOVE_POPOVER,
  Gf as Z_INDEX_CONNECTION_LOST,
  Wf as Z_INDEX_FIRST_RUN,
  Yf as Z_INDEX_MODAL,
  Xf as Z_INDEX_MODAL_BACKDROP,
  Zf as Z_INDEX_ONBOARDING_TOUR,
  Jf as Z_INDEX_OVERLAY,
  Qf as badgeVariants,
  tm as buttonGroupVariants,
  em as buttonVariants,
  x as cn,
  ...
  Gh as getNumberFromUSFM,
  ju as getStatusForItem,
  yg as getToolbarOSReservedSpaceClassName,
  Kh as inventoryCountColumn,
  Uh as inventoryItemColumn,
  ...
  lf as useEvent,
  df as useEventAsync,
  pf as useExtraValidMarkers,
  Ts as useListbox,
  Fp as usePromise,
  fh as useRecentSearches,
  wf as useRetryablePromise,
  hf as useRunWhenVisible,
  hs as useShrinkStep,
  Ri as useShrinkStepOverride,
  nd as useShrinkStepValue,
  Ba as useSidebar,
  uf as useStylesheet,
  gf as useTabIconSelection,
