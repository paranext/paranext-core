...
var li = (t, e, r) => e in t ? ci(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var xt = (t, e, r) => li(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Check as sr, Clock as Wa, ChevronsLeft as Ya, ChevronsRight as Xa, ChevronUp as Mo, ChevronDown as cr, ArrowLeft as Oi, ArrowRight as Ii, BoldIcon as Pi, ItalicIcon as Li, X as Or, AtSign as $o, Pencil as Vi, Trash2 as Fi, ArrowUp as Ao, MoreHorizontal as ji, MailOpen as Bi, Mail as Ui, FilterIcon as Ki, ArrowLeftIcon as Gi, ChevronLeftIcon as qi, ChevronRightIcon as Hi, ArrowRightIcon as Wi, Copy as Oo, Filter as Yi, User as Xi, Link as Ji, CircleHelp as Zi, ChevronsUpDown as Io, Star as Qi, Undo as ts, Redo as es, SquareX as Po, FunctionSquare as Lo, SquareSigma as Vo, Ban as rs, AlertCircle as sa, CircleCheckIcon as as, CircleXIcon as os, CircleHelpIcon as ns, ArrowUpIcon as is, ArrowDownIcon as ss, Search as cs, LoaderCircle as ls, ScrollText as ds, ChevronRight as ws, ChevronLeft as us, MenuIcon as ps, Menu as gs, EllipsisVertical as hs, MoreVertical as Ja } from "lucide-react";
import ot, { forwardRef as lr, useRef as Y, useMemo as L, createContext as Ir, useContext as ka, useState as S, useCallback as B, useLayoutEffect as St, Fragment as _a, useEffect as W, Component as fs, createElement as Za, Suspense as ms } from "react";
import { createEditor as Fo, $getRoot as ne, $createParagraphNode as He, $getSelection as Tt, HISTORY_MERGE_TAG as Na, ParagraphNode as jo, TextNode as Bo, $isTokenOrSegmented as vs, $getCharacterOffsets as bs, $cloneWithPropertiesEphemeral as xs, $getPreviousSelection as ys, $isRangeSelection as Gt, $caretFromPoint as ks, $getSiblingCaret as Uo, $getChildCaret as _s, $getAdjacentChildCaret as Ns, $isChildCaret as Cs, $normalizeCaret as Es, $setSelectionFromCaretRange as zs, $getCollapsedCaretRange as Ts, $getCaretInDirection as Qa, $splitAtPointCaretNext as Ss, $isTextPointCaret as Ds, $findMatchingParent as Ko, $isElementNode as ae, mergeRegister as ie, getDOMTextNode as Rs, isHTMLElement as Go, CLEAR_EDITOR_COMMAND as qo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Ms, defineExtension as At, safeCast as Se, createState as $s, FORMAT_TEXT_COMMAND as Ho, $isNodeSelection as Wo, COMMAND_PRIORITY_LOW as Yo, RootNode as As, LineBreakNode as Os, TabNode as Is, $isEditorState as Ps, createCommand as Ls, CLICK_COMMAND as Vs, isDOMNode as Fs, $getNodeFromDOMNode as js, $createNodeSelection as Bs, $setSelection as Us, $getEditor as Ks, DecoratorNode as ca, $getState as Gs, toggleTextFormatType as to, TEXT_TYPE_TO_FORMAT as qs, $setState as Hs, addClassNamesToElement as Xo, $create as Ws, $getNodeByKey as Ys, removeClassNamesFromElement as Xs, KEY_TAB_COMMAND as Js, $isBlockElementNode as Cr, $createRangeSelection as Zs, $normalizeSelection__EXPERIMENTAL as Qs, OUTDENT_CONTENT_COMMAND as tc, INDENT_CONTENT_COMMAND as eo, INSERT_TAB_COMMAND as ec, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as rc, $isParagraphNode as ac, $isTextNode as Er, SELECTION_CHANGE_COMMAND as Jo, getRegisteredNode as oc, isDocumentFragment as ro, isDOMDocumentNode as nc, ArtificialNode__DO_NOT_USE as Zo, $createLineBreakNode as Qo, $isRootOrShadowRoot as ic, isBlockDomNode as ao, isInlineDomNode as oo, $insertNodes as sc } from "lexical";
import { HeadingNode as cc, QuoteNode as lc, registerRichText as dc } from "@lexical/rich-text";
import { flushSync as wc, createPortal as uc } from "react-dom";
import { $isTableSelection as pc } from "@lexical/table";
import { createHeadlessEditor as tn } from "@lexical/headless";
import { useReactTable as en, getFilteredRowModel as gc, getSortedRowModel as rn, getPaginationRowModel as hc, getCoreRowModel as an, flexRender as rr, getGroupedRowModel as fc, getExpandedRowModel as mc } from "@tanstack/react-table";
import vc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as da, getDefaultViewOptions as bc, isInsertEmbedOpOfType as fr, Editorial as xc } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as yc } from "react-hotkeys-hook";
import { Drawer as me } from "vaul";
import * as za from "react-resizable-panels";
import { useTheme as kc } from "next-themes";
import { Toaster as _c } from "sonner";
import { toast as Ug } from "sonner";
const Nc = wi({ prefix: "tw" });
function wa(t) {
  const e = [];
  let r = "", o = 0;
...
function Ec(t, e) {
  ...
  const r = wa(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = wa(e), s = i.some((l) => l.startsWith("-tw-")), c = i.some((l) => l.startsWith("!tw-"));
  if (s && n.startsWith("-")) {
    const l = n.slice(1);
    return [...o, `-tw-${l}`].join(":");
  }
...
function f(...t) {
  const e = di(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return Nc(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((l) => {
    const d = Cc(l);
    o.set(d.normalized, d.original), n.push(d.normalized);
  }), ui(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? Ec(l, d) : l;
  }).join(" ");
}
const We = 250, on = 300, nn = 400, zc = 450, Tc = 500, sn = Wt(
...
function wr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Ac, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        ze.Input,
        {
      ...
      /* @__PURE__ */ a(Ic, { children: /* @__PURE__ */ a(fi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ u(
          ...
          {
            ref: w,
            value: l || `${t} ${wt.bookIdToEnglishName(t)}`,
            onSelect: h,
            onMouseDown: p,
            role: "option",
            "aria-selected": e,
...
const Fc = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"];
function jc(t) {
  return Fc.some((e) => e === t);
}
function Je(t) {
...
function Hc({ className: t, children: e, ...r }) {
  const o = dt();
  return /* @__PURE__ */ a(
    ht.SubContent,
    {
...
function Wc({
  ...
  return /* @__PURE__ */ u(se, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ u(le, { id: s, align: "start", style: { zIndex: nn }, children: [
  ...
  if (t)
    return /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
      "div",
      {
        ...
        children: Array.from({ length: Lt(t) }, (c, l) => l + 1).map((c) => /* @__PURE__ */ a(
          ve,
          {
            value: `${t} ${Ee[t] || ""} ${c}`,
            onSelect: () => r(c),
            ...
            className: f(
              ...
              s && Sa,
              {
                ...
                "tw:text-muted-foreground/50": ((n == null ? void 0 : n(c)) ?? !1) && !(t === e.book && c === e.chapterNum)
              },
              {
                ...
                "tw:bg-primary tw:text-primary-foreground tw:data-selected:bg-primary tw:data-selected:text-primary-foreground tw:hover:bg-primary": t === e.book && c === e.chapterNum
              }
            ),
            children: c
          },
...
function ju({
  ...
  const K = B(
    ...
    e,
    i
  ), ct = (i == null ? void 0 : i["%bookChapterControl_backToBooks%"]) ?? "Back to books", rt = B(() => {
    ...
    (b) => {
      ...
      if ((v === "chapters" || v === "books" && j) && jc(b.key) && document.activeElement === M.current) {
        ...
        T !== lt && (b.preventDefault(), b.stopPropagation(), p(tr(Z, n, T)), setTimeout(() => {
  ...
  return St(() => {
    const b = setTimeout(() => {
      if (w && v === "books" && M.current && C.current) {
        const $ = M.current, F = C.current, H = F.offsetTop, Q = $.clientHeight, Z = F.clientHeight, lt = H - Q / 2 + Z / 2;
        $.scrollTo({
          top: Math.max(0, lt),
          behavior: "smooth"
        }), p(tr(t.book));
...
function pa({
  ...
  const [_, k] = S(!1), A = d ?? l, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], M = (C, z) => {
...
const vn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, rl = vn ? St : W, mr = { tag: Na };
function al({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = el(null, o), w = Fo({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : W;
...
const dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : W;
function wl(t) {
...
const bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = bn && "documentMode" in document ? document.documentMode : null;
!(!bn || !("InputEvent" in window) || hl) && "getTargetRanges" in new window.InputEvent("input");
function Ut(t) {
  return `${t}px`;
}
...
function ml(t, e, r) {
  ...
  function l() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = pl(t, e);
    var m, x;
...
function bl(t, e = vl) {
  ...
  function d(w) {
    w.read(() => {
      const g = Tt();
      if (!Gt(g)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), x = m.getKey(), v = h.offset, N = p.getNode(), y = N.getKey(), _ = p.offset, k = t.getElementByKey(x), A = t.getElementByKey(y), V = r === null || k !== o || v !== n || x !== r.getKey(), M = i === null || A !== s || _ !== c || y !== i.getKey();
...
function kl(t) {
  ...
  const o = _l(t, r), n = Ns(o), i = Cs(n) ? Es(n) : o;
...
function Nl(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Ko(i, (d) => ae(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
const Cl = Symbol.for("preact-signals");
function Lr() {
...
let Sr, oe = 0, Dr = 0, zl = 0, ha = 0, kr = 0;
function co(t) {
  if (tt === void 0) return;
  let e = t.n;
...
yt.prototype.brand = Cl, yt.prototype.h = function() {
  return !0;
...
At({ name: "@lexical/extension/DecoratorText", nodes: () => [Cn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = Tt();
  if (Wo(n) || Gt(n)) for (const i of n.getNodes()) Rl(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function En(t, e) {
  let r;
...
class Al {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, l, d) {
      return Object.assign(c, { config: l, id: Yr, registerState: d });
...
const Il = At({ config: Se({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = Ol }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Ve {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && at(298, o.name), !n) {
      n = new Al(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Jr(i) || at(300, s, n || "[unknown]"), Jr(c = i) || at(304, String(c.id), String(Oa)), i = Object.assign(c, { id: ma }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = Ml(i), o.state = i, e.push(o);
    };
...
const Ll = /* @__PURE__ */ new Set(), go = At({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = Tl(() => (i.value || Ll).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(s, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Vl = Ls("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends ca {
  static getType() {
...
At({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ie(t.registerCommand(Vl, (s) => {
    const c = Tt();
    if (!Gt(c)) return !1;
    ...
    if (Fs(s.target)) {
      const c = js(s.target);
      if (jl(c)) return function(l, d = !1) {
        const w = Tt(), g = l.isSelected(), h = l.getKey();
        let p;
...
function Bl(t, e, r = Dn) {
  return ie(t.registerCommand(Js, (o) => {
    ...
    const i = function(s) {
      ...
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), g = yl(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Zs();
...
At({ build: (t, e, r) => Ye(e), config: Se({ $canIndent: Dn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return qt(() => {
    if (!o.value) return Bl(t, n, i);
  });
} });
const Ul = At({ name: "@lexical/react/ReactProvider" });
function Kl() {
  ...
  return function(r, o) {
    ...
    return Pa(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(ms, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(uc(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
}
function Yl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    const o = Ve.maybeFromEditor(r);
    if (o && o.hasExtensionByName(Ul.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Hl(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Wl, { editor: t, ErrorBoundary: e });
}
function ho(t) {
  return t.getEditorState().read(Rn(t.isComposing()));
}
function Xl({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Yt();
  return function(n) {
    Pa(() => ie(dc(n), Mn(n)), [n]);
  }(o), u(nt, { children: [t, a(Jl, { content: e }), a(Yl, { editor: o, ErrorBoundary: r })] });
}
...
function Zl({ defaultSelection: t }) {
  const [e] = Yt();
  return W(() => {
    e.focus(() => {
...
const Ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? St : W;
function td({ onClear: t }) {
  const [e] = Yt();
  return Ql(() => Nn(e, t), [e, t]), null;
}
...
function cd() {
  const [t, e] = S(void 0), r = B(() => {
    ...
    return /* @__PURE__ */ a(Dc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u($c, { children: [
...
function ld({
  ...
  const [e] = Yt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, c] = cd(), l = () => {
  };
...
function gd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(ld, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(ud, {}) }) }),
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
      ...
      e && /* @__PURE__ */ a(Zl, { defaultSelection: "rootEnd" }),
...
function fd(t, e) {
  const r = nc(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function Ln(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && Er(e) && (s = gl(o, e, "clone"));
  const c = ae(s) ? s.getChildren() : [], l = oc(t, s.getType());
  let d;
...
function Fn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (c == null || !ic(c)) && (c != null && Cr(c) || o);
  for (let m = 0; m < g.length; m++) h.push(...Fn(g[m], e, r, p, new Map(n), c));
  return w != null && (h = w(h)), ao(t) && (h = vd(t, h, p ? () => {
    const m = new Zo();
    return r.push(m), m;
  } : He)), c == null ? h.length > 0 ? s = s.concat(h) : ao(t) && function(m) {
    return m.nextSibling == null || m.previousSibling == null ? !1 : oo(m.nextSibling) && oo(m.previousSibling);
  }(t) && (s = s.concat(Qo())) : ae(c) && c.append(...h), s;
}
function vd(t, e, r) {
...
function qu({
  ...
  const [i, s] = S(yd), [c, l] = S(n), [d, w] = S(!1), g = Y(void 0), h = Y(null);
  W(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
...
const Hu = Object.freeze([
  ...
  const n = Y(null), [i, s] = S(void 0), [c, l] = S(void 0), d = B(
    (p) => {
      s(p);
    ...
    "div",
    {
      ...
      children: [
        ...
        _ && /* @__PURE__ */ u(se, { children: [
          /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ji, {}) }) }),
...
function Dd({
  ...
  const [C, z] = S(xo), [E, O] = S(), [D, K] = S(), P = o, [G, R] = S(!1), [J, j] = S(!1), [st, Xt] = S(!1), [Ft, Jt] = S(!1), [q, ct] = S(!1), [rt, ut] = S(k), [zt, Zt] = S(!1), mt = Y(void 0), [Qt, we] = S(/* @__PURE__ */ new Map());
  W(() => {
    let T = !0;
    return (async () => {
  ...
  const lt = B(
    async (T) => {
      ...
      it && await g({ threadId: l, contents: it }) && Mt();
    },
    [
      Mt,
      C,
            ...
            o && /* @__PURE__ */ u(nt, { children: [
              ...
              v !== !1 && (!J || $t(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    Fa(T) && (T.preventDefault(), T.stopPropagation(), ($t(C) || E !== void 0 && E !== D) && lt());
                  },
                  onKeyDown: (T) => {
...
function Fd({
  ...
  return l ? A = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ge, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(va, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? A = _.getRowModel().rows.map((M) => /* @__PURE__ */ a(
    ...
    M.id
  )) : A = /* @__PURE__ */ a(re, { children: /* @__PURE__ */ a(ge, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function np({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(vc, { options: i, children: e })
    }
  );
}
    ...
    /* @__PURE__ */ a(le, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: d.itemType === 0 ? /* @__PURE__ */ a(nt, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        Uc,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Kc, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(pr, {})
    ] }, d.label)) })
...
function Yd({
  ...
  const i = Y(null), s = Y(null), c = Y(!1), [l, d] = S(t), [w, g] = S(r), [h, p] = S(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var N, y, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(se, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: Wd(t, n, r) }) }) }),
...
function Zd({
  ...
  return /* @__PURE__ */ u(se, { children: [
    /* @__PURE__ */ a(_t, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(ce, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: Xd(t, r) }) }) }),
...
function up({
  ...
  const [m, x] = S("generated"), [v, N] = S("generated"), [y, _] = S("*"), [k, A] = S("*"), [V, M] = S("f"), [C, z] = S(!1), [E, O] = S(!0), [D, K] = S(!1), P = Y(!1), G = Y(""), [R, J] = S(!1), [j, st] = S(), [Xt, Ft] = S(), [Jt, q] = S(), [ct, rt] = S(), ut = Y(null), zt = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? bc(), noteMode: "expanded" }
    }),
    [s, c]
  ), Zt = L(
    () => rw(
  ...
  W(() => {
    ...
    if (b && fr("note", b)) {
      ...
      let Q = "custom";
      H === la ? Q = "generated" : H === da ? Q = "hidden" : H && (_(H), A(H)), x(Q), N(Q), M(((F = b.insert.note) == null ? void 0 : F.style) ?? "f"), I = setTimeout(() => {
        var Z;
  ...
  const mt = B(
    (I, b, $ = !1) => {
      ...
      if (F && fr("note", F)) {
        if (F.insert.note) {
          let lt;
          I === "custom" ? lt = b : I === "generated" ? lt = la : lt = da, F.insert.note.caller = lt;
        }
  ...
  const Dt = () => {
    ...
    if (b && fr("note", b)) {
      ...
      const lt = (Q = (H = b.insert.note) == null ? void 0 : H.contents) == null ? void 0 : Q.ops;
      V !== "x" && I === "x" ? lt == null || lt.forEach((vt) => aw(vt)) : V === "x" && I !== "x" && (lt == null || lt.forEach((vt) => ow(vt))), (Z = w.current) == null || Z.applyUpdate([b, { delete: 1 }]);
    }
  }, Mt = (I) => {
    ...
    (I) => {
      ...
      if (b && fr("note", b)) {
        ...
        const lt = (H = b.insert.note) == null ? void 0 : H.style, vt = (Z = (Q = b.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : Z.ops;
        if (lt || z(!1), z(
          lt === "x" ? !!(vt != null && vt.every((T) => {
            var pt, It;
  ...
  W(() => {
    ...
    const I = (($ = g.current) == null ? void 0 : $.querySelector(".editor-input")) ?? void 0, b = (F) => {
      !R && I && document.activeElement === I && F.key === c ? (F.preventDefault(), Ot()) : R && F.key === "Escape" && (F.preventDefault(), J(!1));
    };
...
function dw({
  ...
  return /* @__PURE__ */ u(Vr, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Fr, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      re,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(ge, { children: Ce(c.reference, "English") }),
          /* @__PURE__ */ a(ge, { className: o, children: lw(c.text) })
        ]
      },
...
function kp({
  ...
  const p = jt(r, "%webView_inventory_all%"), m = jt(r, "%webView_inventory_approved%"), x = jt(r, "%webView_inventory_unapproved%"), v = jt(r, "%webView_inventory_unknown%"), N = jt(r, "%webView_inventory_scope_currentBook%"), y = jt(r, "%webView_inventory_scope_chapter%"), _ = jt(r, "%webView_inventory_scope_verse%"), k = jt(r, "%webView_inventory_filter_text%"), A = jt(
    ...
    const q = [];
    return G.forEach((ct) => {
      const rt = ct.items[0], ut = q.find(
        (zt) => zt.items[0] === rt
      );
      ut ? (ut.count += ct.count, ut.occurrences = ut.occurrences.concat(ct.occurrences)) : q.push({
        items: [rt],
        count: ct.count,
  ...
  const st = (q, ct) => {
    ...
    const q = R.filter((ct) => Ai(
      M ? ct.items : [ct.items[0]],
      K
    ));
...
const Yn = lr(({ className: t, ...e }, r) => /* @__PURE__ */ a(ls, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Np({
  ...
  const [s, c] = S(""), [l, d] = S([]), w = L(
    () => t.filter((P) => !r || P.type === r).filter((P) => mw(P, s)).filter(
      (P) => l.length === 0 || l.includes(P.bestLanguageName)
    ),
    [t, r, s, l]
  ), g = L(
  ...
  }, [l, N, A, n]), K = s.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(nt, { children: [
...
function zw({
  ...
  const c = t ? fe.Root : "button", { state: l } = Ur(), d = /* @__PURE__ */ a(
    c,
    {
...
function Pw({
  ...
  const i = Ua(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    U,
    {
      variant: "outline",
...
function Lw({
  ...
  const i = o["%webView_book_selector_more%"], s = L(
    ...
    (l) => {
      const d = Ua(s, l).map((w) => w);
      r(
        Qn(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(X).map((l) => /* @__PURE__ */ a(
      Pw,
      {
        section: l,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ra ? ra : Do
      ).map((l) => /* @__PURE__ */ a(Be, { className: "tw:hover:bg-secondary", variant: "secondary", children: Le(l, n) }, l)),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          qe,
          {
            ...
            style: { zIndex: We },
            children: t.map((d) => /* @__PURE__ */ a(Pt, { value: `${d}`, children: c[et(d)] }, `${d}`))
          }
        )
      ]
    }
...
const ei = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Nt, { children: [
  /* @__PURE__ */ a(Ct, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    zr,
    {
      ...
      children: [
        c.iconPathBefore && /* @__PURE__ */ a(Ar, { icon: c.iconPathBefore, menuLabel: c.label, leading: !0 }),
        c.label,
        c.iconPathAfter && /* @__PURE__ */ a(Ar, { icon: c.iconPathAfter, menuLabel: c.label })
      ]
    },
    `dropdown-menu-item-${c.label}-${c.command}`
  ) : /* @__PURE__ */ u(Gc, { children: [
    /* @__PURE__ */ a(qc, { children: c.label }),
    /* @__PURE__ */ a(Bc, { children: /* @__PURE__ */ a(Hc, { children: ei(
      t,
      e,
      ti(t, c.id),
      o
...
function ba({
  ...
  return /* @__PURE__ */ u(se, { variant: i, children: [
    /* @__PURE__ */ a(ce, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ps, {}) }) }),
    /* @__PURE__ */ a(le, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(_a, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(_t, { children: ei(e.groups, e.items, l, t) }) }),
...
function Wp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ai, { children: [
      /* @__PURE__ */ a(oi, { children: t.map((c) => /* @__PURE__ */ a(Fw, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(ni, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function jw({
...
const Qe = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Nt, { children: [
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Hw, {}, `separator-${i}`)), l;
  });
};
function Jw({
  menuData: t,
  ...
  const n = Y(void 0), i = Y(void 0), s = Y(void 0), c = Y(void 0), l = Y(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (yc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, x, v, N;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), Qe(c, [h, p]);
        break;
      case "alt+h":
...
iu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
