...
const qc = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.SubContent,
  {
    ref: r,
    className: V(
...
const Ar = G.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ge.Label,
  {
    ref: n,
        ...
        children: [
          ...
          xa.map(
            (k, S) => x(k).length > 0 && /* @__PURE__ */ _("div", { children: [
              /* @__PURE__ */ d(Ar, { className: "pr-font-semibold pr-text-slate-700", children: Qc[k] }),
...
const ip = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? hc : "button", { className: V(ip({ variant: t, size: r, className: e })), ref: a, ...o })
);
...
function sp({ table: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    ...
    /* @__PURE__ */ _(vn, { align: "end", className: "pr-w-[150px]", children: [
      /* @__PURE__ */ d(Ar, { children: "Toggle columns" }),
      /* @__PURE__ */ d(yn, {}),
...
const Fi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.ScrollUpButton,
  {
    ref: r,
...
const cp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.Label,
  {
    ref: r,
...
const pp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.Separator,
  {
    ref: r,
    className: V("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
    ...
    /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
      ...
      /* @__PURE__ */ _(
        on,
        {
          ...
          children: [
            /* @__PURE__ */ d(Sr, { className: "pr-h-8 pr-w-[70px]", children: /* @__PURE__ */ d(an, { placeholder: e.getState().pagination.pageSize }) }),
...
const xn = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("thead", { ref: r, className: V("[&_tr]:pr-border-b", e), ...t }));
xn.displayName = "TableHeader";
const En = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: V("[&_tr:last-child]:pr-border-0", e), ...t }));
...
function mp({
  ...
  return /* @__PURE__ */ _("div", { children: [
    ...
    r && n && /* @__PURE__ */ d(dp, { table: h })
  ] });
}
const hp = Cr.Root, gp = Cr.Trigger, Ui = G.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d(Cr.Portal, { children: /* @__PURE__ */ d(
  Cr.Content,
  {
    ref: o,
    align: t,
...
const bp = Qe.Portal, Hi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Overlay,
  {
    ref: r,
    className: V(
...
const yp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Title,
  {
    ref: r,
...
const wp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Description,
  {
    ref: r,
...
function Ea({
  ...
  return /* @__PURE__ */ _(hp, { open: m, onOpenChange: v, children: [
    /* @__PURE__ */ d(gp, { asChild: !0, children: /* @__PURE__ */ _(
      ve,
      {
        variant: u,
        role: "combobox",
...
function Rp() {
  return Na || (Na = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, C = u, T = l, A = i, j = t, L = m, k = n, S = h, $ = p, F = r, H = a, M = o, z = v, te = !1;
    function Q(B) {
...
function Up() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var C = i, T = a, A = e, j = c, L = r, k = g, S = v, $ = t, F = o, H = n, M = u, z = m, te = !1, Q = !1;
    function O(D) {
...
function ke(e) {
  const {
    ...
    return ct(i, l, (v) => {
      let g = cn(u, o, v);
      return v === g && typeof v == "string" && (g = cn(u, o, `${t}${v === "default" ? "" : et(v)}`, v)), r === !1 ? g : {
        [r]: g
      };
    });
  };
...
function Bo(e = {}, ...t) {
  ...
  return u.applyStyles = uu, u = t.reduce((m, v) => st(m, v), u), u.unstable_sxConfig = R({}, Do, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return jo({
      sx: v,
      theme: this
    });
...
function ku(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    ...
    const P = Oc(i, R({
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${et(u || "")}`), k === void 0 && (k = `Styled(${Wp(i)})`), L.displayName = k;
      }
...
function Mm(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, u = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, f = r.allowedAutoPlacements, b = t.options.placement, x = Ze(b), P = x === b, w = c || (P || !h ? [tn(b)] : _m(b)), E = [b].concat(w).reduce(function(W, X) {
...
var uh = function(t) {
  ...
  return r.componentDidMount = function() {
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Wr.findDOMNode(this), l], u = c[0], m = c[1], v = this.getTimeouts(), g = l ? v.appear : v.enter;
    if (!o && !i || ci.disabled) {
      this.safeSetState({
        status: Xt
      }, function() {
...
const Us = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const C = ut({
    ...
    TransitionProps: re
  } = C, D = he(C, wh), le = /* @__PURE__ */ N.isValidElement(A) ? A : /* @__PURE__ */ d("span", {
    children: A
...
`));
  const $l = N.useMemo(() => {
    ...
    touch: je.current
  }), Ln = Eh(lr), pa = (n = (o = ee.popper) != null ? o : j.Popper) != null ? n : kh, da = (a = (i = (l = ee.transition) != null ? l : j.Transition) != null ? i : B) != null ? a : vo, ua = (c = (u = ee.tooltip) != null ? u : j.Tooltip) != null ? c : Nh, fa = (m = (v = ee.arrow) != null ? v : j.Arrow) != null ? m : Th, _l = vr(pa, R({}, q, (g = Z.popper) != null ? g : L.popper, {
  ...
  const {
    ...
    vc,
    {
      ...
      children: r ? /* @__PURE__ */ _(yt, { children: [
        ui(a, r, !0),
        /* @__PURE__ */ d(yc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Oi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(Es, {}) }) : ui(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d(Ch, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: x }) }) : x;
}
function Gs(e) {
  ...
  return /* @__PURE__ */ _(
    Ri,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(xc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          Rh,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Yh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Kh = (e) => {
  ...
  return !L && !S && (!Y || U) ? null : /* @__PURE__ */ d(_r, {
    ...
    children: /* @__PURE__ */ _(J, R({}, se, {
      children: [!j && m ? /* @__PURE__ */ d(q, R({}, B)) : null, /* @__PURE__ */ d(dn, {
        disableEnforceFocus: E,
        disableAutoFocus: w,
        disableRestoreFocus: T,
        isEnabled: I,
...
const fg = ["onEntering"], mg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], hg = {
  ...
  const a = ut({
    ...
    TransitionProps: E,
    variant: x
  }), j = bg(A), L = i && !u && g, k = N.useRef(null), S = (Q, O) => {
  ...
  return /* @__PURE__ */ _("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    !t && /* @__PURE__ */ _(
      on,
      {
        ...
        children: [
          /* @__PURE__ */ d(Sr, { className: "pr-mb-1 pr-mt-2", children: /* @__PURE__ */ d(an, {}) }),
          /* @__PURE__ */ d(Or, { position: "item-aligned", children: /* @__PURE__ */ d(lp, { children: C.map((k) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
), ol = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d($i.Root, { ref: r, className: V($g(), e), ...t }));
...
function Bv({
  ...
  const a = $t(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Cc, { position: "static", id: n, children: /* @__PURE__ */ _(Sc, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ d(
      Ng,
      {
        commandHandler: t,
...
const Lv = De.Root, Mg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: V(
...
const Ig = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    className: V(
...
const Ag = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: V(
...
const Vv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    ...t,
...
)), Bg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: V(
...
const Zr = (e) => e === "asc" ? /* @__PURE__ */ d(Zl, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(Ql, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(ec, { className: "pr-ml-2 pr-h-4 pr-w-4" }), Lg = (e, t, r, n, o) => [
  {
    ...
    /* @__PURE__ */ _("div", { className: "pr-flex", children: [
      /* @__PURE__ */ _(
        on,
        {
          ...
          defaultValue: T,
          children: [
            /* @__PURE__ */ d(Sr, { children: /* @__PURE__ */ d(an, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ _(on, { onValueChange: (M) => C(M), defaultValue: y, children: [
        /* @__PURE__ */ d(Sr, { children: /* @__PURE__ */ d(an, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ _(Or, { children: [
  ...
  return /* @__PURE__ */ d(
    ve,
    {
      ...
      children: e ? /* @__PURE__ */ d(gn, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ _(yt, { children: [
        /* @__PURE__ */ d(tc, { size: 25, className: V("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
function xi(e, t) {
  ...
  return { t(i, l, c) {
    ...
    const u = r ? +i[2] : void 0, m = i[0].replace(Xg, `
`).match(o);
    let v = !1;
...
function Gb(e, t = {}) {
  ...
  function o(p) {
    ...
    const f = m(u(h ? p : `${p.trimEnd().replace(Rb, "")}
...
function Wv({ markdown: e }) {
  return /* @__PURE__ */ d("div", { className: "pr-prose", children: /* @__PURE__ */ d(Wb, { children: e }) });
}
...
function Xv({ groups: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(Bi, { asChild: !0, children: /* @__PURE__ */ d(Xb, {}) }),
    /* @__PURE__ */ d(vn, { children: e.map((t) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ d(Ar, { children: t.label }),
      /* @__PURE__ */ d(Wc, { children: t.items.map((r) => /* @__PURE__ */ d("div", { children: r.itemType === 0 ? /* @__PURE__ */ d(Po, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ d(Vi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ d(yn, {})
    ] }, t.label)) })
  ] });
}
function qv({ message: e }) {
  return /* @__PURE__ */ d("div", { className: "pr-mb-20 pr-mt-20 pr-flex pr-items-center pr-justify-center", children: /* @__PURE__ */ d("div", { className: "pr-w-3/4 pr-rounded-lg pr-bg-gray-100 pr-p-8 pr-text-center", children: /* @__PURE__ */ d("p", { className: "pr-text-lg pr-text-gray-800", children: e }) }) });
}
function Yv({ category: e, downloads: t, languages: r, moreInfoUrl: n }) {
  const o = () => {
    window.scrollTo(0, document.body.scrollHeight);
  };
  return /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-wrap pr-items-start pr-space-x-4 pr-border-b pr-border-t pr-bg-white pr-pb-4 pr-pt-4", children: [
    /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
      /* @__PURE__ */ d("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: /* @__PURE__ */ d("span", { className: "pr-text-xs pr-font-semibold pr-text-gray-700", children: e }) }),
    ...
    /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
      /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
        ...
        /* @__PURE__ */ d("span", { className: "pr-text-xs pr-font-semibold pr-text-gray-700", children: Object.values(t).reduce((a, i) => a + i, 0) })
      ] }),
      /* @__PURE__ */ d("span", { className: "pr-text-xs pr-text-gray-500", children: "USERS" })
    ] }),
    /* @__PURE__ */ d("div", { className: "pr-mx-2 pr-h-10 pr-border-l pr-border-gray-300" }),
    /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
      /* @__PURE__ */ d("div", { className: "pr-flex pr-items-center", children: r.slice(0, 3).map((a) => /* @__PURE__ */ d(
        "span",
        {
...
function Yb({ versionHistory: e }) {
  const [t, r] = ie(!1), n = /* @__PURE__ */ new Date();
  function o(i) {
    const l = new Date(i), c = new Date(n.getTime() - l.getTime()), u = c.getUTCFullYear() - 1970, m = c.getUTCMonth(), v = c.getUTCDate() - 1;
    let g = "";
    return u > 0 ? g = `${u.toString()} year${u === 1 ? "" : "s"} ago` : m > 0 ? g = `${m.toString()} month${m === 1 ? "" : "s"} ago` : v === 0 ? g = "today" : g = `${v.toString()} day${v === 1 ? "" : "s"} ago`, g;
  }
  const a = Object.entries(e).sort((i, l) => l[0].localeCompare(i[0]));
  return /* @__PURE__ */ _("div", { children: [
    /* @__PURE__ */ d("h3", { className: "pr-text-md pr-font-semibold", children: "Version History" }),
    " ",
    /* @__PURE__ */ d("h5", { className: "pr-ml-2 pr-text-xs pr-text-gray-400", children: "WHAT`S NEW" }),
    /* @__PURE__ */ d("ul", { className: "pr-list-disc pr-pl-5 pr-pr-4 pr-text-xs pr-text-gray-600", children: (t ? a : a.slice(0, 5)).map((i) => /* @__PURE__ */ _("div", { className: "pr-mt-3 pr-flex pr-justify-between", children: [
      /* @__PURE__ */ d("div", { className: "pr-text-gray-600", children: /* @__PURE__ */ d("li", { className: "pr-prose pr-text-xs", children: /* @__PURE__ */ d("span", { children: i[1].description }) }) }),
      /* @__PURE__ */ _("div", { className: "pr-justify-end pr-text-right", children: [
        /* @__PURE__ */ _("div", { children: [
          "Version ",
          i[0]
        ] }),
        /* @__PURE__ */ d("div", { children: o(i[1].date) })
      ] })
    ] }, i[0])) }),
    a.length > 5 && /* @__PURE__ */ d(
      "button",
      {
        type: "button",
        onClick: () => r(!t),
...
function Kv({
  ...
  const a = ((i) => {
    ...
    return i.map((c) => l.of(c));
  })(r);
  return /* @__PURE__ */ d("div", { className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(Yb, { versionHistory: n }),
    ...
    /* @__PURE__ */ _("div", { className: "pr-md:mt-0 pr-mt-4 pr-flex-1 pr-space-y-3", children: [
      ...
      /* @__PURE__ */ _("div", { className: "pr-flex pr-items-start pr-justify-between pr-pr-4 pr-text-xs pr-text-gray-600", children: [
        /* @__PURE__ */ _("p", { className: "pr-flex pr-flex-col pr-justify-start", children: [
          ...
          /* @__PURE__ */ d("span", { className: "pr-font-semibold", children: e }),
        ...
        /* @__PURE__ */ d("div", { className: "pr-flex pr-w-3/4 pr-items-center pr-justify-between pr-text-xs pr-text-gray-600", children: /* @__PURE__ */ _("p", { className: "pr-flex pr-flex-col pr-justify-start", children: [
          ...
          /* @__PURE__ */ d("span", { className: "pr-font-semibold", children: a.join(", ") })
        ] }) })
      ] })
    ] })
  ] }) });
...
const Qb = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: V("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
), nv = G.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: V(rv({ variant: t }), e), ...r }));
...
const av = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: V("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
...
const sv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  io.Root,
  {
    className: V(
