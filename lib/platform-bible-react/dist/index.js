...
function Xv({ id: e, groups: t, className: r, ...n }) {
  return /* @__PURE__ */ u("div", { id: e, children: /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ u(Bi, { asChild: !0, children: /* @__PURE__ */ u(Xb, {}) }),
    /* @__PURE__ */ u(vn, { className: r, ...n, children: t.map((o) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ u(Ar, { children: o.label }),
      /* @__PURE__ */ u(Wc, { children: o.items.map((a) => /* @__PURE__ */ u("div", { children: a.itemType === 0 ? /* @__PURE__ */ u(Po, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ u(Vi, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ u(yn, {})
    ] }, o.label)) })
  ] }) });
}
