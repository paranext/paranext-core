...
import E, { forwardRef as pr, useCallback as Tt, useState as ut, useRef as Ne, useEffect as pe, useLayoutEffect as Ea, useMemo as Rt } from "react";
...
import { ChevronRight as So, Check as Qe, Circle as To, X as Co, Search as yi, ChevronsUpDown as xi, FilterIcon as ul, ChevronDown as ur, ChevronUp as wl, ArrowLeftIcon as fl, ChevronLeftIcon as ml, ChevronRightIcon as hl, ArrowRightIcon as gl, CircleCheckIcon as bl, CircleXIcon as vl, CircleHelpIcon as yl, ArrowUpIcon as xl, ArrowDownIcon as Nl, ArrowUpDownIcon as kl, Star as El, PanelLeft as Sl, PanelRight as Tl, ChevronLeft as Cl, LoaderCircle as Ol, Download as Rl, Filter as Pl, User as _l, Link as Il, CircleHelp as $l } from "lucide-react";
import { getChaptersForBook as Ml, deepEqual as Oo, substring as Al, formatScrRef as Fr, compareScrRefs as ro, scrRefToBBBCCCVVV as Lr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Dl, formatBytes as jl } from "platform-bible-utils";
...
import { MenuItem as Xl, ListItemText as Yl, ListItemIcon as Oi, Menu as Hl, Grid as Ri, List as Wl, IconButton as Pi, Drawer as ql } from "@mui/material";
...
const Ro = mt.Root, _i = mt.Trigger, nc = mt.Group, Ym = mt.Portal, Hm = mt.Sub, Wm = mt.RadioGroup, rc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ v(
  mt.SubTrigger,
  {
    ref: o,
    className: x(
...
function Km({ scrRef: t, handleSubmit: e, className: n, getActiveBookIds: r }) {
  ...
  }, [m]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ v(Ro, { modal: !1, open: g, onOpenChange: F, children: [
...
const Tc = en(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? tn : "button", { className: x(Tc({ variant: e, size: n, className: t })), ref: a, ...o })
);
...
const Oc = Jt.Portal, Gi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Jt.Overlay,
  {
    ref: n,
    className: x(
...
const Rc = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ v(Oc, { children: [
    /* @__PURE__ */ i(Gi, {}),
    /* @__PURE__ */ v(
      Jt.Content,
      {
...
Rc.displayName = Jt.Content.displayName;
...
const Ue = yt.Root, jc = yt.Group, Xe = yt.Value, Te = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ v(
    yt.Trigger,
    {
...
const Ye = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  "td",
  {
    ref: n,
    ...
    /* @__PURE__ */ v(gr, { stickyHeader: a, children: [
      ...
      /* @__PURE__ */ i(vr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        de,
        {
          ...
          children: k.getVisibleCells().map((T) => /* @__PURE__ */ i(Ye, { children: xn(T.column.columnDef.cell, T.getContext()) }, T.id))
        },
        k.id
      )) : /* @__PURE__ */ i(de, { children: /* @__PURE__ */ i(Ye, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
  ...
  return /* @__PURE__ */ v(gr, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ i(vr, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ v(
      de,
      {
        ...
        children: [
          /* @__PURE__ */ i(Ye, { children: `${at.bookNumberToEnglishName(s.reference.bookNum)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
          /* @__PURE__ */ i(Ye, { children: s.text })
        ]
      },
...
}, Hc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Hi = en(
...
const yr = (t) => t === "asc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(kl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Qm = (t) => ({
  ...
  return Xc(t).forEach((p) => {
    p.startsWith("\\id") && (s = Yc(p), l = 0, c = 0), p.startsWith("\\c") && (l = Oa(p), c = 0), p.startsWith("\\v") && (c = Oa(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((h) => w.push(h));
      const g = f.index, y = a.find((h) => Oo(h.items, w)), m = {
        reference: {
...
function rh({
  ...
  const f = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), g = ne(n, "%webView_inventory_unapproved%"), y = ne(n, "%webView_inventory_unknown%"), m = ne(n, "%webView_inventory_scope_currentBook%"), h = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), T = ne(n, "%webView_inventory_filter_text%"), C = ne(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, b] = ut(!1), [_, F] = ut("all"), [O, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? Jc(
    l,
    t,
    a,
    s,
  ...
  return /* @__PURE__ */ v("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ v("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ v(Ue, { onValueChange: (N) => G(N), defaultValue: c, children: [
...
const ud = en(
  ...
  ({
    ...
    const c = t ? tn : "button", { state: d } = xr(), p = /* @__PURE__ */ i(
      c,
      {
        ref: l,
...
const md = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ v(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ i(Ra, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ i(
          Ra,
          {
...
function ih({
  ...
  const [c, d] = ut([]), [p, f] = ut([{ id: le, desc: !1 }]), [w, g] = ut({}), y = Rt(
  ...
  pe(() => {
    if (l) {
      const O = h.getSelectedRowModel().rowsById, I = Object.keys(O);
      if (I.length === 1) {
  ...
  }, _ = (O, I) => O.getIsGrouped() ? "" : x("banded-row", I % 2 === 0 ? "even" : "odd"), F = (O, I, L) => {
    if (!((O == null ? void 0 : O.length) === 0 || I.depth < L.column.getGroupedIndex())) {
      if (I.getIsGrouped())
        switch (I.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ v(
      Ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ce, { position: "item-aligned", children: /* @__PURE__ */ i(jc, { children: C.map((O) => /* @__PURE__ */ i(zt, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ v(gr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(br, { children: h.getHeaderGroups().map((O) => /* @__PURE__ */ i(de, { children: O.headers.filter((I) => I.column.columnDef.header).map((I) => (
      ...
      /* @__PURE__ */ i(vr, { children: h.getRowModel().rows.map((O, I) => {
        const L = kt();
        return /* @__PURE__ */ i(
          de,
          {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ v(
                      ft,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(So, {}) : /* @__PURE__ */ i(Cl, {})),
                          " ",
...
function _d() {
  return Ia || (Ia = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var b = c, _ = d, F = l, O = s, I = e, L = p, D = r, tt = y, J = g, j = n, M = a, A = o, G = f, H = !1;
    function rt($) {
    ...
    st.AsyncMode = b, st.ConcurrentMode = _, st.ContextConsumer = F, st.ContextProvider = O, st.Element = I, st.ForwardRef = L, st.Fragment = D, st.Lazy = tt, st.Memo = J, st.Portal = j, st.Profiler = M, st.StrictMode = A, st.Suspense = G, st.isAsyncMode = rt, st.isConcurrentMode = N, st.isContextConsumer = R, st.isContextProvider = U, st.isElement = X, st.isForwardRef = z, st.isFragment = K, st.isLazy = W, st.isMemo = q, st.isPortal = Y, st.isProfiler = Z, st.isStrictMode = Q, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = S;
  }()), st;
}
var $a;
function us() {
...
function Md() {
  ...
  return Jr = function(l, c) {
    ...
    function I(N) {
      ...
      for (var R = 0; R < N.length; R++) {
        ...
        if (typeof U != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + H(U) + " at index " + R + "."
          ), s;
      }
    ...
    function L() {
      function N(R, U, X, z, K) {
        return j(R[U]) ? null : new m("Invalid " + z + " `" + K + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return h(N);
    }
    function D(N, R, U, X, z) {
      return new m(
        (N || "React class") + ": " + R + " type `" + U + "." + X + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + z + "`."
      );
    }
    function tt(N) {
      function R(U, X, z, K, W) {
...
Valid keys: ` + JSON.stringify(Object.keys(N), null, "  ")
    ...
    function A(N) {
      var R = typeof N;
      return Array.isArray(N) ? "array" : N instanceof RegExp ? "object" : M(R, N) ? "symbol" : R;
    }
    function G(N) {
...
function Gd() {
  return Fa || (Fa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var _ = s, F = a, O = t, I = c, L = n, D = w, tt = f, J = e, j = o, M = r, A = d, G = p, H = !1, rt = !1;
    function N(V) {
...
const Cp = Xt("border", Ft), Op = Xt("borderTop", Ft), Rp = Xt("borderRight", Ft), Pp = Xt("borderBottom", Ft), _p = Xt("borderLeft", Ft), Ip = Xt("borderColor"), $p = Xt("borderTopColor"), Mp = Xt("borderRightColor"), Ap = Xt("borderBottomColor"), Dp = Xt("borderLeftColor"), jp = Xt("outline", Ft), Bp = Xt("outlineColor"), Or = (t) => {
...
Cr(Cp, Op, Rp, Pp, _p, Ip, $p, Mp, Ap, Dp, Or, jp, Bp);
const Rr = (t) => {
...
Cr(Rr, Pr, _r, Vp, zp, Fp, Lp, Gp, Up, Xp, Yp, Hp);
function Ge(t, e) {
  return e === "grey" ? e : t;
}
const Wp = xt({
...
function Ja(t) {
  t = Re(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Re(xu(t)).values : t.values;
...
function Os(t, e) {
  return t = Re(t), e = Zo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, $r(t);
}
function Nu(t, e) {
  if (t = Re(t), e = Zo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
function $u(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Tu), a = t.primary || Cu(e), s = t.secondary || Ou(e), l = t.error || Ru(e), c = t.info || Pu(e), d = t.success || _u(e), p = t.warning || Iu(e);
  function f(m) {
...
}, Symbol.toStringTag, { value: "Module" })), nw = /* @__PURE__ */ Od(ew);
var oi;
function rw() {
...
function mw(t) {
  ...
  const {
    ...
    externalSlotProps: l
  })), p = Oe(d, l == null ? void 0 : l.ref, (e = t.additionalProps) == null ? void 0 : e.ref);
  return gn(n, P({}, c, {
    ref: p
  }), o);
}
...
var Pt = "top", Gt = "bottom", Ut = "right", _t = "left", na = "auto", jn = [Pt, Gt, Ut, _t], qe = "start", Pn = "end", yw = "clippingParents", Is = "viewport", wn = "popper", xw = "reference", ii = /* @__PURE__ */ jn.reduce(function(t, e) {
  return t.concat([e + "-" + qe, e + "-" + Pn]);
}, []), $s = /* @__PURE__ */ [].concat(jn, [na]).reduce(function(t, e) {
  return t.concat([e, e + "-" + qe, e + "-" + Pn]);
}, []), Nw = "beforeRead", kw = "read", Ew = "afterRead", Sw = "beforeMain", Tw = "main", Cw = "afterMain", Ow = "beforeWrite", Rw = "write", Pw = "afterWrite", _w = [Nw, kw, Ew, Sw, Tw, Cw, Ow, Rw, Pw];
function Qt(t) {
...
var Ee = Math.max, lr = Math.min, Ke = Math.round;
function ho() {
...
function Vw(t) {
  ...
  if (!(!a || !s)) {
    var f = Bw(o.padding, n), w = oa(a), g = c === "y" ? Pt : _t, y = c === "y" ? Gt : Ut, m = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], k = Bn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, S = f[g], b = T - w[p] - f[y], _ = T / 2 - w[p] / 2 + C, F = kn(S, _, b), O = c;
    n.modifiersData[r] = (e = {}, e[O] = F, e.centerOffset = F - _, e);
  }
}
function zw(t) {
...
function li(t) {
  ...
  if (d) {
    var _ = Bn(n), F = "clientHeight", O = "clientWidth";
    if (_ === Bt(n) && (_ = we(n), ae(_).position !== "static" && l === "absolute" && (F = "scrollHeight", O = "scrollWidth")), _ = _, o === Pt || (o === _t || o === Ut) && a === Pn) {
      S = Gt;
...
function sa(t) {
  return Je(we(t)).left + ia(t).scrollLeft;
}
function Kw(t, e) {
...
function _n(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? yw : l, d = n.rootBoundary, p = d === void 0 ? Is : d, f = n.elementContext, w = f === void 0 ? wn : f, g = n.altBoundary, y = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = js(typeof h != "number" ? h : Bs(h, jn)), T = w === wn ? xw : wn, C = t.rects.popper, S = t.elements[y ? T : w], b = tf(Pe(S) ? S : S.contextElement || we(t.elements.popper), c, p, s), _ = Je(t.elements.reference), F = zs({
    reference: _,
    element: C,
    placement: o
  }), O = go(Object.assign({}, C, F)), I = w === wn ? O : _, L = {
...
function ef(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? $s : c, p = Ze(r), f = p ? l ? ii : ii.filter(function(y) {
    return Ze(y) === p;
...
function rf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    ...
    }, []), b = e.rects.reference, _ = e.rects.popper, F = /* @__PURE__ */ new Map(), O = !0, I = S[0], L = 0; L < S.length; L++) {
      var D = S[L], tt = Kt(D), J = Ze(D) === qe, j = [Pt, Gt].indexOf(tt) >= 0, M = j ? "width" : "height", A = _n(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function ff(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, y = n.tetherOffset, m = y === void 0 ? 0 : y, h = _n(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Kt(e.placement), T = Ze(e.placement), C = !T, S = aa(k), b = wf(S), _ = e.modifiersData.popperOffsets, F = e.rects.reference, O = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (_) {
    if (a) {
      var J, j = S === "y" ? Pt : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = _[S], H = G + h[j], rt = G - h[M], N = g ? -O[A] / 2 : 0, R = T === qe ? F[A] : O[A], U = T === qe ? -O[A] : -F[A], X = e.elements.arrow, z = g && X ? oa(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ds(), W = K[j], q = K[M], Y = kn(0, F[A], z[A]), Z = C ? F[A] / 2 - N - Y - W - L.mainAxis : R - Y - W - L.mainAxis, Q = C ? -F[A] / 2 + N + Y + q + L.mainAxis : U + Y + q + L.mainAxis, dt = e.elements.arrow && Bn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Et = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - Et - $, Nt = G + Q - Et, Yt = kn(g ? lr(H, V) : H, G, g ? Ee(rt, Nt) : rt);
      _[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var fe, Ct = S === "x" ? Pt : _t, Fn = S === "x" ? Gt : Ut, Ht = _[b], Ie = b === "y" ? "height" : "width", me = Ht + h[Ct], $e = Ht - h[Fn], Me = [Pt, _t].indexOf(k) !== -1, Ae = (fe = D == null ? void 0 : D[b]) != null ? fe : 0, he = Me ? me : Ht - F[Ie] - O[Ie] - Ae + L.altAxis, on = Me ? Ht + F[Ie] + O[Ie] - Ae - L.altAxis : $e, Ln = g && Me ? jw(he, Ht, on) : kn(g ? he : me, Ht, g ? on : $e);
      _[b] = Ln, tt[b] = Ln - Ht;
    }
...
function vf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Lt(e), o = Lt(e) && bf(e), a = we(e), s = Je(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  la(a)) && (l = gf(e)), Lt(e) ? (c = Je(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = sa(a))), {
        ...
        if (!w) {
          ...
          if (fi(T, C)) {
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var b = p.orderedModifiers[S], _ = b.fn, F = b.options, O = F === void 0 ? {} : F, I = b.name;
...
const Rf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Pf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function _f(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const $f = () => Ho({
  root: ["root"]
}, dw(Of)), Mf = {}, Af = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = St(e, Rf), k = B.useRef(null), T = Oe(k, n), C = B.useRef(null), S = Oe(C, w), b = B.useRef(S);
  We(() => {
    b.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const _ = _f(p, s), [F, O] = B.useState(_), [I, L] = B.useState(cr(o));
  B.useEffect(() => {
...
`));
  ...
  const O = !p && c && (!m || C) ? "none" : void 0, I = m ? {
    in: p,
    onEnter: b,
    onExited: _
  } : void 0;
...
process.env.NODE_ENV !== "production" && (Fs.propTypes = {
   ...
   */
  anchorEl: Uo(u.oneOfType([On, u.object, u.func]), (t) => {
    if (t.open) {
...
var Bf = function(e) {
  return e.scrollTop;
}, bn = "unmounted", ve = "exited", ye = "entering", Le = "entered", vo = "exiting", ie = /* @__PURE__ */ function(t) {
  Df(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ye && s !== Le && (a = ye) : (s === ye || s === Le) && (a = vo);
    }
...
const Ff = {
  ...
  } = e, k = St(e, zf), T = hn(), C = B.useRef(), S = Ls(), b = B.useRef(null), _ = Oe(b, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = b.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
const Us = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const _ = ea({
    ...
    TransitionProps: Et
  } = _, V = St(_, Xf), Nt = /* @__PURE__ */ B.isValidElement(O) ? O : /* @__PURE__ */ i("span", {
    children: O
  }), Yt = Ls(), fe = Yt.direction === "rtl", [Ct, Fn] = B.useState(), [Ht, Ie] = B.useState(null), me = B.useRef(!1), $e = j || rt, Me = hn(), Ae = hn(), he = hn(), on = hn(), [Ln, da] = bs({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const pa = (et) => {
    ...
    (et) => {
      gi.start(800 + R, () => {
        qn = !1;
      }), da(!1), X && ee && X(et), Me.start(Yt.transitions.duration.shortest, () => {
        me.current = !1;
      });
    }
  ), jr = (et) => {
    me.current && et.type !== "touchstart" || (Ct && Ct.removeAttribute("title"), Ae.clear(), he.clear(), A || qn && G ? Ae.start(qn ? G : A, () => {
      pa(et);
    }) : pa(et));
  }, ua = (et) => {
    Ae.clear(), he.start(R, () => {
    ...
    ga(et), he.clear(), Me.clear(), Gn(), an.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", on.start(H, () => {
...
`));
  ...
  const ln = {};
  M || (Vt.onTouchStart = Qs, Vt.onTouchEnd = tl), J || (Vt.onMouseOver = Kn(ba, Vt.onMouseOver), Vt.onMouseLeave = Kn(va, Vt.onMouseLeave), $e || (ln.onMouseOver = ba, ln.onMouseLeave = va)), tt || (Vt.onFocus = Kn(ha, Vt.onFocus), Vt.onBlur = Kn(ma, Vt.onBlur), $e || (ln.onFocus = ha, ln.onBlur = ma)), process.env.NODE_ENV !== "production" && Nt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${Nt.props.title}\` or the Tooltip component.`].join(`
`));
  const rl = B.useMemo(() => {
    var et;
    let Mt = [{
...
function bi(t, e, n) {
  return t ? /* @__PURE__ */ i(Oi, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ i("img", { src: t, alt: `${n ? "Leading" : "Trailing"} icon for ${e}` }) }) : void 0;
}
function Xs(t) {
  const {
    onClick: e,
    ...
    Xl,
    {
      ...
      children: n ? /* @__PURE__ */ v(te, { children: [
        ...
        f ? /* @__PURE__ */ i(Oi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(Ps, {}) }) : bi(s, n, !1)
      ] }) : h
    }
  );
...
function om({
  ...
  pe(() => {
    if (c) {
      ...
      if (S) {
        const b = S.getBoundingClientRect(), _ = window.scrollY, F = window.scrollX, O = b.top + _ + S.clientHeight, I = b.left + F;
        h({ top: O, left: I });
      }
    }
  }, [c, o]);
...
const Vn = pr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Ol, { size: 35, className: x("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ i(
    ft,
    {
      ...
      children: t ? /* @__PURE__ */ i(Vn, { size: 15 }) : /* @__PURE__ */ v(te, { children: [
        /* @__PURE__ */ i(Rl, { size: 25, className: x("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Nh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ v(Ro, { children: [
