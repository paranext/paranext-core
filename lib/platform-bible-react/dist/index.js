...
var ui = (t, e, n) => e in t ? pi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var Kt = (t, e, n) => ui(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as at } from "react/jsx-runtime";
import b, { forwardRef as Ln, useRef as H, useMemo as z, useState as O, useCallback as G, useEffect as J, useLayoutEffect as Jt, createContext as cr, useContext as so, Component as mi, createElement as Oo, Suspense as fi, Fragment as io } from "react";
import { Command as Yt } from "cmdk";
import { X as hn, Search as fa, Check as Qt, Clock as Mo, ChevronsLeft as Ao, ChevronsRight as Po, ChevronLeft as Vr, ChevronRight as dn, ArrowLeft as hi, ArrowRight as ha, Circle as dr, ChevronDown as Se, BoldIcon as gi, ItalicIcon as bi, AtSign as ga, Pencil as vi, Trash2 as xi, ArrowUp as ba, MoreHorizontal as yi, MailOpen as Ni, Mail as ki, ChevronUp as va, FilterIcon as _i, ArrowLeftIcon as Ci, ChevronLeftIcon as Ei, ChevronRightIcon as Ti, ArrowRightIcon as Si, Copy as xa, Filter as ya, User as Ri, Link as Ii, CircleHelp as Di, ChevronsUpDown as lo, Star as Oi, Undo as Mi, Redo as Ai, SquareX as Na, FunctionSquare as ka, SquareSigma as _a, Ban as Pi, AlertCircle as Br, CircleCheckIcon as $i, CircleXIcon as ji, CircleHelpIcon as Li, ArrowUpIcon as Vi, ArrowDownIcon as Bi, PanelLeft as Gi, PanelRight as Fi, ScrollText as zi, MenuIcon as Ki, Menu as qi, EllipsisVertical as Hi, MoreVertical as $o, LoaderCircle as Ui, GripVertical as Yi } from "lucide-react";
import { clsx as Xi } from "clsx";
import { extendTailwindMerge as Wi } from "tailwind-merge";
import * as Zt from "@radix-ui/react-dialog";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Fn, Section as Q, getChaptersForBook as Ji, formatScrRef as Ce, getSectionForBook as Rn, formatRelativeDate as Zi, formatReplacementString as Ue, sanitizeHtml as Qi, NumberFormat as tl, formatBytes as el, getCurrentLocale as nl, usfmMarkers as Un, getFormatCallerFunction as rl, deepEqual as ol, isString as jo, compareScrRefs as Gr, scrRefToBBBCCCVVV as xr, defaultScrRef as yr, formatScrRefRange as al, getLocalizeKeyForScrollGroupId as ot } from "platform-bible-utils";
...
import { createEditor as Ea, $getRoot as Re, $createParagraphNode as bn, $getSelection as Ut, HISTORY_MERGE_TAG as co, ParagraphNode as Ta, TextNode as Sa, $isTokenOrSegmented as sl, $getCharacterOffsets as il, $cloneWithPropertiesEphemeral as ll, $getPreviousSelection as cl, $isRangeSelection as he, $caretFromPoint as dl, $getSiblingCaret as Ra, $getChildCaret as wl, $getAdjacentChildCaret as pl, $isChildCaret as ul, $normalizeCaret as ml, $setSelectionFromCaretRange as fl, $getCollapsedCaretRange as hl, $getCaretInDirection as Lo, $splitAtPointCaretNext as gl, $isTextPointCaret as bl, $findMatchingParent as Ia, $isElementNode as Ee, mergeRegister as Ie, getDOMTextNode as vl, isHTMLElement as Da, CLEAR_EDITOR_COMMAND as Oa, COMMAND_PRIORITY_EDITOR as wo, shallowMergeConfig as xl, defineExtension as oe, safeCast as Qe, createState as yl, FORMAT_TEXT_COMMAND as Ma, $isNodeSelection as Aa, COMMAND_PRIORITY_LOW as Pa, RootNode as Nl, LineBreakNode as kl, TabNode as _l, $isEditorState as Cl, createCommand as El, CLICK_COMMAND as Tl, isDOMNode as Sl, $getNodeFromDOMNode as Rl, $createNodeSelection as Il, $setSelection as Dl, $getEditor as Ol, DecoratorNode as Fr, $getState as Ml, toggleTextFormatType as Vo, TEXT_TYPE_TO_FORMAT as Al, $setState as Pl, addClassNamesToElement as $a, $create as $l, $getNodeByKey as jl, removeClassNamesFromElement as Ll, KEY_TAB_COMMAND as Vl, $isBlockElementNode as Jn, $createRangeSelection as Bl, $normalizeSelection__EXPERIMENTAL as Gl, OUTDENT_CONTENT_COMMAND as Fl, INDENT_CONTENT_COMMAND as Bo, INSERT_TAB_COMMAND as zl, COMMAND_PRIORITY_CRITICAL as po, $isDecoratorNode as Kl, $isParagraphNode as ql, $isTextNode as Zn, SELECTION_CHANGE_COMMAND as ja, getRegisteredNode as Hl, isDocumentFragment as Go, isDOMDocumentNode as Ul, ArtificialNode__DO_NOT_USE as La, $createLineBreakNode as Va, $isRootOrShadowRoot as Yl, isBlockDomNode as Fo, isInlineDomNode as zo, $insertNodes as Xl } from "lexical";
import * as We from "@radix-ui/react-tooltip";
import { TooltipTrigger as Wl } from "@radix-ui/react-tooltip";
import { HeadingNode as Jl, QuoteNode as Zl, registerRichText as Ql } from "@lexical/rich-text";
import { flushSync as tc, createPortal as ec } from "react-dom";
import { $isTableSelection as nc } from "@lexical/table";
...
import { useReactTable as za, getFilteredRowModel as oc, getSortedRowModel as Ka, getPaginationRowModel as ac, getCoreRowModel as qa, flexRender as In, getGroupedRowModel as sc, getExpandedRowModel as ic } from "@tanstack/react-table";
import * as kt from "@radix-ui/react-select";
import lc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as zr, HIDDEN_NOTE_CALLER as Kr, getDefaultViewOptions as cc, isInsertEmbedOpOfType as zn, Editorial as dc } from "@eten-tech-foundation/platform-editor";
...
import * as Sn from "@radix-ui/react-slider";
import * as Ur from "@radix-ui/react-switch";
const uc = Wi({ prefix: "tw-" });
function f(...t) {
  return uc(Xi(t));
}
const Vn = 250, Ha = 300, mo = 400, mc = 450, fc = 500, hc = 550, gc = "layoutDirection";
function Ct() {
  const t = localStorage.getItem(gc);
  return t === "rtl" ? t : "ltr";
}
const Yr = Zt.Root, Hu = Zt.Trigger, bc = Zt.Portal, Uu = Zt.Close, Ua = b.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  Zt.Overlay,
  {
    ref: o,
    className: f(
...
Ua.displayName = Zt.Overlay.displayName;
const Qn = b.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = Ct();
  return /* @__PURE__ */ p(bc, { children: [
...
Qn.displayName = Zt.Content.displayName;
...
er.displayName = Zt.Title.displayName;
...
vc.displayName = Zt.Description.displayName;
...
const tn = b.forwardRef(({ className: t, onKeyDown: e, ...n }, o) => {
...
tn.displayName = Yt.Input.displayName;
...
ye.displayName = Yt.List.displayName;
const xn = b.forwardRef((t, e) => /* @__PURE__ */ r(Yt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
xn.displayName = Yt.Empty.displayName;
...
re.displayName = Yt.Group.displayName;
const pr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Yt.Separator,
  {
    ref: n,
...
pr.displayName = Yt.Separator.displayName;
...
ae.displayName = Yt.Item.displayName;
...
const Wa = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), ie = Object.fromEntries(
  Wa.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function ho(t, e, n) {
...
const Ja = Ln(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? gn : "button", { className: f(Za({ variant: e, size: n, className: t })), ref: s, ...a })
);
F.displayName = "Button";
const Ne = wn.Root, Me = wn.Trigger, yc = wn.Anchor, Qa = b.createContext(null);
function Nr({
  container: t,
  children: e
}) {
...
const we = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
...
we.displayName = wn.Content.displayName;
function ts(t, e, n) {
  return `${t} ${ie[t]}${e ? ` ${fo(t, e)} ${Ve(t, e)}` : ""}`;
}
function Nc({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(Ne, { open: w, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(we, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(xe, { children: /* @__PURE__ */ r(ye, { children: /* @__PURE__ */ r(re, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      ae,
      {
        onSelect: () => h(u),
...
function Yu(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
const Yn = {
  ...
  Yn.BOOK_ONLY,
  Yn.BOOK_CHAPTER,
  Yn.BOOK_CHAPTER_VERSE
];
function _c(t) {
  return Yn.BOOK_CHAPTER_VERSE.test(t.trim());
}
function Ko(t, e) {
  return dt.bookIdToNumber(t) < dt.bookIdToNumber(e.book);
}
function Cc(t, e, n) {
  const o = dt.bookIdToNumber(t) - dt.bookIdToNumber(n.book);
  return o < 0 ? !0 : o > 0 ? !1 : e < n.chapterNum;
}
function kr(t, e, n, o) {
  const a = dt.bookIdToNumber(t) - dt.bookIdToNumber(o.book);
  ...
  const o = kc.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!w && d) {
          const u = ((g) => Object.keys(ie).find(
            (y) => ie[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function Tc(t, e, n, o) {
  const a = G(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const c = e[d - 1], w = Math.max(fe(c), 1);
        o({
          book: c,
          chapterNum: w,
          verseNum: 1
...
function Ho({
  ...
  if (t)
    return /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: fe(t) }, (l, d) => d + 1).map((l) => {
...
function Uo({
  ...
  if (!(!t || n <= 0))
    return /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", d), children: Array.from({ length: n }, (c, w) => w + 1).map((c) => {
...
function _r({
  ...
  const R = Ct(), [I, S] = O(!1), [V, _] = O(""), [T, C] = O(""), [v, E] = O("books"), [$, L] = O(void 0), [A, j] = O(
    void 0
  ), [U, X] = O(void 0), [tt, St] = O(!1), Ht = H(null), Rt = H(!1), lt = H(void 0), pt = H(void 0), K = H(void 0), st = H(void 0), rt = H({}), wt = H({}), ut = G(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ), jt = z(() => o ? o() : Wa, [o]), Dt = z(() => ({
    [Q.OT]: jt.filter((Y) => dt.isBookOT(Y)),
    [Q.NT]: jt.filter((Y) => dt.isBookNT(Y)),
    [Q.DC]: jt.filter((Y) => dt.isBookDC(Y)),
    [Q.Extra]: jt.filter((Y) => dt.extraBooks().includes(Y))
  }), [jt]), Ot = z(() => Object.values(Dt).flat(), [Dt]), Pe = z(() => {
    if (!T.trim()) return Dt;
    const k = {
      [Q.OT]: [],
      [Q.NT]: [],
  ...
  const te = G(() => {
    ...
    (k) => {
      const Y = A ?? (P == null ? void 0 : P.book), Z = U ?? (P == null ? void 0 : P.chapterNum);
      !Y || !Z || (ut({
        book: Y,
        chapterNum: Z,
        verseNum: k
    ...
    const k = A;
    j(void 0), X(void 0), k ? (L(k), E("chapters"), _("")) : gt();
  }, [A, gt]), _t = G((k) => {
    S(k), k && (E("books"), L(void 0), j(void 0), X(void 0), C(""));
  }, []), { otLong: vt, ntLong: It, dcLong: Lt, extraLong: M } = {
    ...
    () => _c(T),
    [T]
  ), en = z(() => !c || !P || !P.chapterNum || !kn ? !1 : c(P.book, P.chapterNum) > 0, [c, P, kn]), Bn = G(
    (k) => w ? Ko(k, w) : !1,
    [w]
  ), _n = G(
    (k) => (Y) => w ? Cc(k, Y, w) : !1,
    ...
    (k, Y) => (Z) => w ? kr(k, Y, Z, w) : !1,
    [w]
  ), Cn = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", nn = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Gn = G(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), m && m.includes(k.key) && P && P.chapterNum !== void 0 && P.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), te());
    },
    [m, P, te]
  ), rn = G(
    (k) => {
      var je, on, an;
      if (k.ctrlKey) return;
      const { isLetter: Y, isDigit: Z } = qo(k.key);
      if ((v === "chapters" || v === "verses") && (k.key === " " || k.key === "Enter")) {
        const Vt = k.target instanceof HTMLElement ? k.target : void 0;
        ...
        const At = (je = lt.current) == null ? void 0 : je.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (At) {
          k.preventDefault(), k.stopPropagation(), At.click();
          return;
        }
      }
      if ((v === "chapters" || v === "verses") && (Y || Z)) {
        k.preventDefault(), k.stopPropagation();
        return;
      }
      if (v === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), gt();
        return;
      }
      ...
      if (v === "verses" && zt) {
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            q = D === 0 ? At : Math.max(1, D - Nt);
            break;
          case "ArrowDown":
            q = D === 0 ? 1 : Math.min(At, D + Nt);
            break;
          default:
            return;
        }
        q !== D && (k.preventDefault(), k.stopPropagation(), _(
          `${Vt} ${ie[Vt] || ""} ${Et}:${q}`
        ), setTimeout(() => {
          const se = wt.current[q];
          se && se.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((v === "chapters" || v === "books" && P) && zt) {
        const Vt = v === "chapters" ? $ : P == null ? void 0 : P.book;
        if (!Vt) return;
        v === "chapters" && ((an = lt.current) == null || an.focus());
        const Et = (() => {
          if (!V) return 1;
          const Nt = V.match(/(\d+)$/);
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            D = Et === 0 ? At : Math.max(1, Et - q);
            break;
          case "ArrowDown":
            D = Et === 0 ? 1 : Math.min(At, Et + q);
            break;
          default:
            return;
        }
        D !== Et && (k.preventDefault(), k.stopPropagation(), _(
          `${Vt} ${ie[Vt] || ""} ${D}`
        ), setTimeout(() => {
          const Nt = rt.current[D];
    ...
    if (k.key === "ArrowUp" || k.key === "ArrowDown") {
      (zt = pt.current) == null || zt.focus();
      return;
    }
    const { isLetter: Y, isDigit: Z } = qo(k.key);
    (Y || Z) && (k.preventDefault(), C((je) => je + k.key), pt.current.focus(), St(!1));
  }, []);
  return Jt(() => {
    const k = setTimeout(() => {
      if (I && v === "books" && K.current && st.current) {
        const Y = K.current, Z = st.current, zt = Z.offsetTop, je = Y.clientHeight, on = Z.clientHeight, an = zt - je / 2 + on / 2;
        Y.scrollTo({
          top: Math.max(0, an),
          behavior: "smooth"
        }), _(ts(t.book));
    ...
    if (v === "chapters" && $) {
      ...
      _(
        ...
        if (K.current)
          if (k) {
            const Z = rt.current[t.chapterNum];
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ p(Ne, { open: I, onOpenChange: _t, modal: x, children: [
    /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
        ref: Ht,
    ...
    /* @__PURE__ */ r(
      we,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: Y } = k;
          Ht.current && Y instanceof Node && Ht.current.contains(Y) && (Rt.current = !0, _t(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ p(
          xe,
          {
            ...
            children: [
              v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: it.map(({ onClick: k, disabled: Y, title: Z, icon: zt }) => /* @__PURE__ */ r(
                  F,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ r(
                  F,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: v === "verses" ? bt : gt,
                    className: "tw-mr-2 tw-h-6 tw-w-6 tw-p-0",
                    children: R === "ltr" ? /* @__PURE__ */ r(hi, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ha, { className: "tw-h-4 tw-w-4" })
                  }
                ),
                v === "chapters" && $ && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ve($, a) }),
                v === "verses" && A && U !== void 0 && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: `${Ve(A, a)} ${U}` }),
                /* @__PURE__ */ r(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw-ms-auto tw-text-sm tw-font-medium tw-text-muted-foreground",
                    children: v === "verses" ? nn : Cn
                  }
                )
              ] }),
              !tt && /* @__PURE__ */ p(ye, { ref: K, children: [
                v === "books" && /* @__PURE__ */ p(at, { children: [
                  !P && Object.entries(Pe).map(([k, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ r(re, { heading: xt(k), children: Y.map((Z) => /* @__PURE__ */ r(
                          Ja,
                          {
                            bookId: Z,
                            onSelect: (zt) => B(zt),
                  ...
                  P && /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(
                    ae,
                    {
                      value: `${P.book} ${ie[P.book]} ${P.chapterNum || ""}:${P.verseNum || ""})}`,
                      onSelect: te,
                      disabled: !!w && kr(
                        P.book,
                        P.chapterNum ?? 1,
                  ...
                  P && en && P.chapterNum && c && /* @__PURE__ */ p(at, { children: [
                    /* @__PURE__ */ p("div", { className: "tw-mb-2 tw-flex tw-items-center tw-justify-between tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: [
                      /* @__PURE__ */ r("span", { children: `${Ve(P.book, a)} ${P.chapterNum}` }),
                      /* @__PURE__ */ r("span", { children: nn })
                    ] }),
                    /* @__PURE__ */ r(
                      Uo,
                      {
                        ...
                        onVerseSelect: Mt,
                        setVerseRef: Ke,
                        isVerseDisabled: $e(P.book, P.chapterNum),
                        className: "tw-px-4 tw-pb-4"
                      }
                    )
                  ] }),
                  P && !en && fe(P.book) > 1 && /* @__PURE__ */ p(at, { children: [
                    /* @__PURE__ */ p("div", { className: "tw-mb-2 tw-flex tw-items-center tw-justify-between tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: [
                      /* @__PURE__ */ r("span", { children: Ve(P.book, a) }),
                      /* @__PURE__ */ r("span", { children: Cn })
                    ] }),
                    /* @__PURE__ */ r(
                      Ho,
                      {
...
), Tt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ca.Root, { ref: n, className: f("pr-twp", Sc(), t), ...e }));
Tt.displayName = Ca.Root.displayName;
...
go.displayName = Mn.Root.displayName;
const nr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mn.Item,
  {
    ref: n,
    className: f(
    ...
    ...e,
    children: /* @__PURE__ */ r(Mn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(dr, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
nr.displayName = Mn.Item.displayName;
function Rc(t) {
...
function Wr({
  ...
  const [I, S] = O(!1), V = c ?? d, _ = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], T = (C, v) => {
  ...
  return /* @__PURE__ */ p(Ne, { open: I, onOpenChange: S, ...R, children: [
    ...
    /* @__PURE__ */ r(
      we,
      {
        ...
        style: s,
        children: /* @__PURE__ */ p(xe, { children: [
          /* @__PURE__ */ r(tn, { placeholder: h, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(xn, { children: u }),
          /* @__PURE__ */ r(ye, { children: _(e) ? e.map((C) => /* @__PURE__ */ r(re, { heading: C.groupHeading, children: C.options.map((v) => T(v, C.groupHeading)) }, C.groupHeading)) : e.map((C) => T(C)) })
        ] })
      }
    )
  ] });
...
function Ju({
  ...
  const w = Cr(c, "%webView_bookSelector_currentBook%"), m = Cr(c, "%webView_bookSelector_choose%"), h = Cr(c, "%webView_bookSelector_chooseBooks%"), [u, g] = O(
    "current book"
    /* CurrentBook */
  ), y = (x) => {
    g(x), t(x);
    ...
    go,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Tt, { className: "tw-flex tw-items-center", children: o.map((x) => dt.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
const ns = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Oc = ns ? Jt : J, Kn = { tag: co };
function Mc({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, c = Dc(null, o), w = Ea({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, w), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          case "string": {
            ...
            m.setEditorState(u, Kn);
            break;
          }
          case "object":
            m.setEditorState(h, Kn);
            break;
          case "function":
            m.update(() => {
              Re().isEmpty() && h(m);
...
const Ac = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : J;
function Pc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = ke();
  return Ac(() => {
...
const bo = {
  ...
  mark: "",
  markOverlap: ""
}, Pt = We.Provider, Gt = We.Root, Ft = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  We.Trigger,
  {
    ref: o,
    className: e ? f(Za({ variant: e }), t) : t,
    ...n
  }
));
Ft.displayName = We.Trigger.displayName;
const $t = b.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(We.Portal, { children: /* @__PURE__ */ r(
  We.Content,
  {
    ref: a,
    sideOffset: e,
...
$t.displayName = We.Content.displayName;
const vo = [
  Jl,
  Ta,
  Sa,
...
class jc extends mi {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Lc(e.resetKeys, a)) {
      var s, i;
...
function Vc({ children: t, onError: e }) {
  return r(jc, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Bc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : J;
function Gc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Fc() {
  return function(t) {
    const [e] = ke(), n = z(() => t(e), [e, t]), [o, a] = O(() => n.initialValueFn()), s = H(o);
    return Bc(() => {
...
function zc(t, e) {
  ...
  for (let c = 0; c < d; c++) {
    const w = i[c], m = l && l.top <= w.top && l.top + l.height > w.top && l.left + l.width > w.left, h = w.width + s === o.width;
    m || h ? (i.splice(c--, 1), d--) : l = w;
  }
  return i;
}
function Kc(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !sl(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), d = s.getNode(), c = e.is(l), w = e.is(d);
    if (c || w) {
      const [m, h] = il(t), u = l.is(d), g = e.is(i ? d : l), y = e.is(i ? l : d);
      let x, N = 0;
      u ? (N = m > h ? h : m, x = m > h ? m : h) : g ? (N = i ? h : m, x = void 0) : y && (N = 0, x = i ? m : h);
      const R = e.__text.slice(N, x);
      R !== e.__text && (n === "clone" && (e = ll(e)), e.__text = R);
    }
  }
  return e;
}
...
const rs = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, qc = rs && "documentMode" in document ? document.documentMode : null;
!(!rs || !("InputEvent" in window) || qc) && "getTargetRanges" in new window.InputEvent("input");
function me(t) {
  return `${t}px`;
}
const Hc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Uc(t, e, n) {
  let o = null, a = null, s = null, i = [];
  const l = document.createElement("div");
  function d() {
    o === null && rr(182), a === null && rr(183);
    const { left: m, top: h } = a.getBoundingClientRect(), u = zc(t, e);
    var g, y;
...
function Yo(t, e, n) {
  ...
  return [vl(n) || n, t.offset];
}
function Yc(t) {
  for (const e of t) {
    const n = e.style;
    n.background !== "Highlight" && (n.background = "Highlight"), n.color !== "HighlightText" && (n.color = "HighlightText"), n.marginTop !== me(-1.5) && (n.marginTop = me(-1.5)), n.paddingTop !== me(4) && (n.paddingTop = me(4)), n.paddingBottom !== me(0) && (n.paddingBottom = me(0));
  }
}
function Xc(t, e = Yc) {
  ...
  function c(w) {
    w.read(() => {
      const m = Ut();
      if (!he(m)) return n = null, a = null, s = null, l = null, d(), void (d = () => {
      });
      const [h, u] = function(C) {
        const v = C.getStartEndPoints();
        return C.isBackward() ? [v[1], v[0]] : v;
      }(m), g = h.getNode(), y = g.getKey(), x = h.offset, N = u.getNode(), R = N.getKey(), I = u.offset, S = t.getElementByKey(y), V = t.getElementByKey(R), _ = n === null || S !== o || x !== a || y !== n.getKey(), T = s === null || V !== i || I !== l || R !== s.getKey();
...
function Wc(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = Xc(t, e));
  };
...
function Jc(t) {
  ...
  return Ee(e) || rr(4, t.__key), e;
}
function Zc(t) {
  const e = Ut() || cl();
  let n;
  if (he(e)) n = dl(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = Ra(l, "next"));
    }
    n = n || wl(Re(), "previous").getFlipped().insert(bn());
  }
  const o = Qc(t, n), a = pl(o), s = ul(a) ? ml(a) : o;
  return fl(hl(s)), t.getLatest();
}
function Qc(t, e, n) {
  let o = Lo(e, "next");
  for (let a = o; a; a = gl(a, n)) o = a;
  return bl(o) && rr(283), o.insert(t.isInline() ? bn().append(t) : t), Lo(Ra(t.getLatest(), "next"), e.direction);
}
function td(t) {
  const e = Ut();
  if (!he(e)) return !1;
...
const ed = Symbol.for("preact-signals");
function ur() {
  if (Te > 1) return void Te--;
  let t, e = !1;
  for (!function() {
    let n = or;
    for (or = void 0; n !== void 0; ) n.S.v === n.v && (n.S.i = n.i), n = n.o;
  }(); Dn !== void 0; ) {
    let n = Dn;
    for (Dn = void 0, ar++; n !== void 0; ) {
      const o = n.u;
...
let or, Te = 0, ar = 0, rd = 0, Zr = 0, Xn = 0;
function Wo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function qe(t, e) {
  qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Xn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function od(t, e) {
  return new qe(t, e);
}
...
function ad(t) {
  ...
  as(this), nt = t, this.f &= -2, 8 & this.f && xo(this), ur();
}
function ln(t, e) {
...
qt.prototype.brand = ed, qt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Te !== 0 && ar === 0 && e.l !== Zr && (e.l = Zr, or = { S: e, v: e.v, i: e.i, o: or });
    })(this), this.v = t, this.i++, Xn++, Te++;
    try {
  ...
  if (this.g = Xn, this.f |= 1, this.i > 0 && !os(this)) return this.f &= -2, !0;
  const t = nt;
  try {
    Jo(this), nt = this;
    const e = this.x();
  ...
  return nt = t, as(this), this.f &= -2, !0;
  ...
  const t = nt;
  return nt = this, ad.bind(this, t);
}, ln.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = Dn, Dn = this);
}, ln.prototype.d = function() {
  this.f |= 8, 1 & this.f || xo(this);
}, ln.prototype.dispose = function() {
  this.d();
};
oe({ build: (t, e, n) => yn(e), config: Qe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
  return ge(() => o.disabled.value ? void 0 : t.registerRootListener((a) => {
    t.focus(() => {
...
oe({ build: (t, e, n) => yn(e), config: Qe({ $onClear: is }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ge(() => ls(t, o.value));
} });
function sd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Tr = yl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class cs extends Fr {
  $config() {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [cs], register: (t, e, n) => t.registerCommand(Ma, (o) => {
  const a = Ut();
  if (Aa(a) || he(a)) for (const s of a.getNodes()) id(s) && s.toggleFormat(o);
  return !1;
}, Pa) });
function ds(t, e) {
  let n;
...
const Qr = oe({ build: (t) => ds(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const yo = 0, to = 1, ps = 2, Sr = 3, qn = 4, sn = 5, Rr = 6, En = 7;
function Ir(t) {
  return t.id === yo;
}
function us(t) {
...
function ld(t) {
  return function(e) {
    return e.id === to;
  }(t) || ct(305, String(t.id), String(to)), Object.assign(t, { id: ps });
}
...
class dd {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : xl;
    for (const o of this.configs) e = n(e, o);
    return e;
  }
  init(e) {
    const n = this.state;
    us(n) || ct(306, String(n.id));
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== qn && ct(307, String(n.id), String(sn)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Rr && ct(310, String(n.id), String(Rr)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
      return Object.assign(a, { id: En });
    }(n), o;
  }
  getSignal() {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= qn;
    }(e) || ct(313, String(e.id), String(qn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Sr;
    }(e) || ct(314, String(e.id), String(Sr)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= En;
    }(e) || ct(316, String(e.id), String(En)), e;
  }
...
const pd = oe({ config: Qe({ setOptions: Zo, updateOptions: Zo }), init: ({ $initialEditorState: t = wd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (Cl(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Nl, Sa, kl, _l, Ta] }), Qo = Symbol.for("@lexical/extension/LexicalBuilder");
function ta() {
}
function ud(t) {
  throw t;
...
class cn {
  ...
  static maybeFromEditor(e) {
    const n = e[Qo];
    return n && (n.PACKAGE_VERSION !== Dr && ct(292, n.PACKAGE_VERSION, Dr), n instanceof cn || ct(293)), n;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && ct(298, o.name), !a) {
      a = new dd(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Ir(s) || ct(300, i, a || "[unknown]"), Ir(l = s) || ct(304, String(l.id), String(yo)), s = Object.assign(l, { id: to }), o.state = s;
      const d = this.outgoingConfigEdges.get(i);
      if (d) for (const c of d.keys()) {
        const w = this.extensionNameMap.get(c);
        w && n(w, i);
      }
      s = ld(s), o.state = s, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of l) {
      const { extension: m } = w;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of sd(m)) {
        if (typeof h != "function") {
          const u = o.get(h.replace);
          u && ct(302, m.name, h.replace.name, u.extension.name), o.set(h.replace, w);
        }
        n.add(h);
      }
      if (m.html) {
...
const md = /* @__PURE__ */ new Set(), ea = oe({ build(t, e, n) {
  const o = n.getDependency(Qr).output, a = An({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ds(() => {
  }, () => ge(() => {
...
oe({ dependencies: [Qr, ea], name: "@lexical/extension/HorizontalRule", nodes: () => [pn], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(ea).output, a = An({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Ie(t.registerCommand(fd, (i) => {
    const l = Ut();
    if (!he(l)) return !1;
    ...
    return !0;
  }, wo), t.registerCommand(Tl, (i) => {
    if (Sl(i.target)) {
      const l = Rl(i.target);
      if (gd(l)) return function(d, c = !1) {
        const w = Ut(), m = d.isSelected(), h = d.getKey();
        let u;
        c && Aa(w) ? u = w : (u = Il(), Dl(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    nd(() => {
      ...
      for (const [w, m] of i.entries()) if (m === "destroyed") c.delete(w), d = !0;
        ...
        const h = c.get(w), u = t.getElementByKey(w);
        h ? h.domNode.value = u : (d = !0, c.set(w, { domNode: An(u), selectedSignal: o(w) }));
      }
      d && (a.value = { nodeSelections: c });
    });
  }), ge(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ge(() => {
      const c = l.value;
      c && (d.value ? $a(c, s) : Ll(c, s));
    }));
    return Ie(...i);
  }));
} });
oe({ build: (t, e) => yn({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Qe({ $getParentEditor: function() {
  const t = Ol();
  return cn.fromEditor(t), t;
}, inheritEditableFromParent: !1 }), init: (t, e, n) => {
  const o = e.$getParentEditor();
  t.parentEditor = o, t.theme = t.theme || o._config.theme;
}, name: "@lexical/extension/NestedEditor", register: (t, e, n) => ge(() => {
...
oe({ build: (t, e, n) => yn(e), config: Qe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return ge(() => {
    if (!o.disabled.value) return Wc(t, o.onReposition.value);
  });
} });
function ms(t) {
  return t.canBeEmpty();
}
function bd(t, e, n = ms) {
  return Ie(t.registerCommand(Vl, (o) => {
    const a = Ut();
    if (!he(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => Jn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, d = i.focus, c = d.isBefore(l) ? d : l, w = c.getNode(), m = Jc(w);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Bl();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Gl(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Fl : Bo : zl;
...
oe({ build: (t, e, n) => yn(e), config: Qe({ $canIndent: ms, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return ge(() => {
    if (!o.value) return bd(t, a, s);
  });
} });
const vd = oe({ name: "@lexical/react/ReactProvider" });
function xd() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (he(g)) {
                ...
                if (Zn(x) && c >= 0 && w >= 0 && (N = c, R = c + w, g.setTextNodeRange(x, N, x, R)), N === R && m === "" || (g.insertRawText(m), x = y.getNode()), Zn(x)) {
                  N = h, R = h + u;
...
oe({ build: (t, e, n) => yn(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ge(() => n.getOutput().disabled.value ? void 0 : hs(t)) });
function kd(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : J;
function _d({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, s] = O(() => n.getDecorators());
    return ko(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const c = l[d], w = r(o, { onError: (h) => n._onError(h), children: r(fi, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(ec(w, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Cd({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(vd.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && kd(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(_d, { editor: t, ErrorBoundary: e });
}
function na(t) {
  return t.getEditorState().read(fs(t.isComposing()));
}
function Ed({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = ke();
  return function(a) {
    ko(() => Ie(Ql(a), hs(a)), [a]);
  }(o), p(at, { children: [t, r(Td, { content: e }), r(Cd, { editor: o, ErrorBoundary: n })] });
}
function Td({ content: t }) {
  const [e] = ke(), n = function(a) {
    const [s, i] = O(() => na(a));
    return ko(() => {
      function l() {
        const d = na(a);
...
function Sd({ defaultSelection: t }) {
  const [e] = ke();
  return J(() => {
    e.focus(() => {
...
const Rd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : J;
function Id({ onClear: t }) {
  const [e] = ke();
  return Rd(() => ls(e, t), [e, t]), null;
}
const gs = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : J;
function Dd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: w, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: N = !0, style: R, tabIndex: I, "data-testid": S, ...V }, _) {
  const [T, C] = O(t.isEditable()), v = G(($) => {
...
const Md = Ln(Ad);
function Ad(t, e) {
  const { placeholder: n, ...o } = t, [a] = ke();
  return p(at, { children: [r(Od, { editor: a, ...o, ref: e }), n != null && r(Pd, { editor: a, content: n })] });
}
function Pd({ content: t, editor: e }) {
  ...
  if (Jt(() => (a(e.isEditable()), e.registerEditableListener((i) => {
    a(i);
  })), [e]), !n) return null;
  let s = null;
...
function Ld() {
  const [t, e] = O(void 0), n = G(() => {
    e(void 0);
  }, []), o = z(() => {
    if (t === void 0)
      return;
    const { title: s, content: i } = t;
    return /* @__PURE__ */ r(Yr, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Qn, { children: [
      /* @__PURE__ */ r(tr, { children: /* @__PURE__ */ r(er, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = G(
    (s, i, l = !1) => {
...
function Vd({
  ...
  const [e] = ke(), [n, o] = O(e), [a, s] = O("paragraph"), [i, l] = Ld(), d = () => {
  };
...
), Gd = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Ba.Root,
  {
    ref: a,
    className: f(xs({ variant: e, size: n, className: t })),
    ...o
  }
));
Gd.displayName = Ba.Root.displayName;
...
_o.displayName = wr.Root.displayName;
const On = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
...
On.displayName = wr.Item.displayName;
const oa = [
...
function Fd() {
  const { activeEditor: t } = vs(), [e, n] = O([]), o = G((a) => {
    if (he(a) || nc(a)) {
      const s = [];
      oa.forEach(({ format: i }) => {
...
function Kd({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Vd, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Fd, {}) }) }),
      ...
      /* @__PURE__ */ r(
        Ed,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r($d, { placeholder: t }) }),
          ErrorBoundary: Vc
        }
      ),
      e && /* @__PURE__ */ r(Sd, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(zd, { onClear: n }),
      /* @__PURE__ */ r(Id, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          Mc,
          {
            ...
            children: /* @__PURE__ */ p(Pt, { children: [
              /* @__PURE__ */ r(Kd, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Pc,
                {
...
function Ns(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && Zn(e) && (i = Kc(o, e, "clone"));
  const l = Ee(i) ? i.getChildren() : [], d = Hl(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Ns(t, g, h, o);
    !a && Ee(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Da(w) || Go(w)) && w.append(h), n.append(w), m) {
      const u = m.call(i, w);
...
function _s(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Yl(l)) && (l != null && Jn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(..._s(m[g], e, n, u, new Map(a), l));
  return w != null && (h = w(h)), Fo(t) && (h = Yd(t, h, u ? () => {
    const g = new La();
    return n.push(g), g;
  } : bn)), l == null ? h.length > 0 ? i = i.concat(h) : Fo(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : zo(g.nextSibling) && zo(g.previousSibling);
  }(t) && (i = i.concat(Va())) : Ee(l) && l.append(...h), i;
}
function Yd(t, e, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    const l = e[i];
    if (Jn(l)) o && !l.getFormat() && l.setFormat(o), a.push(l);
    else if (s.push(l), i === e.length - 1 || i < e.length - 1 && Jn(e[i + 1])) {
      const d = n();
...
function Xd(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = Hd(e, a);
      Re().clear(), Xl(s);
    },
    {
      discrete: !0
...
function Zu({
  ...
  const [a, s] = O(Wd), [i, l] = O(void 0), [d, c] = O(!1), w = H(void 0), m = H(null);
  J(() => {
    let N = !0;
    const R = m.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
          /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(hn, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(Ne, { open: d, onOpenChange: c, children: [
      /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        we,
        {
          ...
          children: /* @__PURE__ */ r(xe, { children: /* @__PURE__ */ r(ye, { children: t.map((N) => /* @__PURE__ */ r(
            ae,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Eo(N) && (N.preventDefault(), N.stopPropagation(), le(a) && h());
        },
        onKeyDown: (N) => {
...
const Qu = Object.freeze([
...
], Jd = ["input", "select", "textarea", "button"], Zd = ["button", "textbox"], Qd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = H(null), [s, i] = O(void 0), [l, d] = O(void 0), c = G(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Jd.includes(g)) return !0;
    const y = u.getAttribute("role");
    if (y && Zd.includes(y)) return !0;
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", tw({ variant: e }), t), ...n })
);
...
nw.displayName = "CardTitle";
const rw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
aw.displayName = vn.Image.displayName;
...
}), De = mt.Trigger, Ds = mt.Group, sw = mt.Portal, iw = mt.Sub, lw = mt.RadioGroup;
function ve({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(To.Provider, { value: n, children: /* @__PURE__ */ r(mt.Root, { ...e }) });
}
...
Os.displayName = mt.SubTrigger.displayName;
...
Ms.displayName = mt.SubContent.displayName;
const ce = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = Ct();
...
ce.displayName = mt.Content.displayName;
...
Ye.displayName = mt.Item.displayName;
const ne = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Ct(), i = pe();
  return /* @__PURE__ */ p(
    mt.CheckboxItem,
    {
      ...
      dir: s,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(mt.ItemIndicator, { children: /* @__PURE__ */ r(Qt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
ne.displayName = mt.CheckboxItem.displayName;
const As = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    mt.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(mt.ItemIndicator, { children: /* @__PURE__ */ r(dr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
As.displayName = mt.RadioItem.displayName;
const Be = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  mt.Label,
  {
    ref: o,
...
Be.displayName = mt.Label.displayName;
...
Oe.displayName = mt.Separator.displayName;
...
function aa({
  ...
  const u = G(
    ...
    [t.user]
  ), R = z(() => Qi(t.contents), [t.contents]), I = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(at, { children: [
        /* @__PURE__ */ p(
          Ye,
          {
            onClick: (S) => {
              S.stopPropagation(), c(!0), m(Xd(t.contents)), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p(
          Ye,
          {
            ...
            children: [
              /* @__PURE__ */ r(xi, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : Eo(S) && (S.preventDefault(), S.stopPropagation(), le(w) && g());
              },
              onKeyDown: (S) => {
        ...
        I && /* @__PURE__ */ p(ve, { children: [
          /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(yi, {}) }) }),
          /* @__PURE__ */ r(ce, { align: "end", children: I })
        ] })
      ]
    }
  );
...
function dw({
  ...
  const [T, C] = O(sa), [v, E] = O(
    void 0
  ), $ = o, [L, A] = O(!1), [j, U] = O(!1), [X, tt] = O(!1), [St, Ht] = O(!1), [Rt, lt] = O(!1), [pt, K] = O(S), [st, rt] = O(!1), wt = H(void 0), [ut, jt] = O(/* @__PURE__ */ new Map());
  J(() => {
    let M = !0;
    return (async () => {
      const yt = R ? await R(d) : !1;
      M && lt(yt);
    })(), () => {
      M = !1;
    };
    ...
    let M = !0;
    if (!o) {
      Ht(!1), jt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const yt = N ? await N(d) : !1;
      M && Ht(yt);
    })(), () => {
      M = !1;
    };
  }, [o, d, N]);
  const Dt = z(() => e.filter((M) => !M.deleted), [e]);
  J(() => {
    let M = !0;
    if (!o || !I) {
      jt(/* @__PURE__ */ new Map());
  ...
  const Ot = z(() => Dt[0], [Dt]), Pe = H(null), P = H(void 0), Wt = G(() => {
    var M;
    (M = P.current) == null || M.call(P), C(sa);
  }, []), te = G(() => {
    const M = !pt;
    K(M), rt(!M), g == null || g(d, M);
  }, [pt, g, d]);
  J(() => {
    A(!1);
  }, [o]), J(() => {
    if (o && !pt && !st) {
      ...
      return wt.current = M, () => clearTimeout(M);
    }
  ...
  }, [s, n]), W = z(() => Dt.slice(1), [Dt]), et = z(() => W.length ?? 0, [W.length]), it = z(() => et > 0, [et]), gt = z(() => L || et <= 2 ? W : W.slice(-2), [W, et, L]), bt = z(() => L || et <= 2 ? 0 : et - 2, [et, L]), _t = z(
    () => et === 1 ? Mt.singleReply : Ue(Mt.multipleReplies, { count: et }),
    [et, Mt]
  ), vt = z(
    () => bt === 1 ? Mt.singleReply : Ue(Mt.multipleReplies, { count: bt }),
    [bt, Mt]
  );
  J(() => {
    !o && j && it && U(!1);
  ...
  const It = G(
    async (M) => {
      ...
      xt && await m({ threadId: d, contents: xt }) && Wt();
    },
    [
      Wt,
      T,
    ...
    async (M) => {
      const xt = le(T) ? ir(T) : void 0, yt = await m({
        ...M,
        contents: xt,
        assignedUser: v ?? M.assignedUser
      });
      return yt && xt && Wt(), yt && v !== void 0 && E(void 0), yt;
    },
    [Wt, T, m, v]
  );
  if (Ot)
        ...
        children: /* @__PURE__ */ p(Ss, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              B && /* @__PURE__ */ r(be, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: B }),
              /* @__PURE__ */ r(
                F,
                {
                  variant: "ghost",
                  ...
                  children: pt ? /* @__PURE__ */ r(Ni, {}) : /* @__PURE__ */ r(ki, {})
                }
              ),
            ...
            /* @__PURE__ */ r(
              aa,
              {
                ...
                handleDeleteComment: u,
                onEditingChange: U,
                canEditOrDelete: (!j && ut.get(Ot.id)) ?? !1,
            ...
            o && /* @__PURE__ */ p(at, { children: [
              ...
              x !== !1 && (!j || le(T)) && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  onKeyDownCapture: (M) => {
                    Eo(M) && (M.preventDefault(), M.stopPropagation(), (le(T) || v !== void 0) && It());
                  },
                  onKeyDown: (M) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      v !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: Ue(
                      ...
                      /* @__PURE__ */ p(Ne, { open: X, onOpenChange: tt, children: [
                        /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ r(
                          F,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ r(
                          we,
                          {
                            ...
                            children: /* @__PURE__ */ r(xe, { children: /* @__PURE__ */ r(ye, { children: y == null ? void 0 : y.map((M) => /* @__PURE__ */ r(
                              ae,
                              {
                                onSelect: () => {
                                  E(M !== s ? M : void 0), tt(!1);
                                ...
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: Wn(M, n) })
                              },
                              M || "unassigned"
                            )) }) })
                          }
...
function em({
  ...
  const [N, R] = O(/* @__PURE__ */ new Set()), [I, S] = O();
  J(() => {
  ...
  const V = n.filter(
    ...
    [N, y]
  ), { listboxRef: v, activeId: E, handleKeyDown: $ } = Qd({
    options: _,
    onOptionSelect: T
  }), L = G(
    (A) => {
...
function ww({ table: t }) {
  return /* @__PURE__ */ p(ve, { children: [
    /* @__PURE__ */ r(rc, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(_i, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ p(ce, { align: "end", className: "tw-w-[150px]", children: [
...
const mn = kt.Root, pw = kt.Group, fn = kt.Value, uw = Ge(
...
), Je = b.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = Ct();
  return /* @__PURE__ */ p(
    kt.Trigger,
    {
      className: f(uw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(kt.Icon, { asChild: !0, children: /* @__PURE__ */ r(Se, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Je.displayName = kt.Trigger.displayName;
...
Ps.displayName = kt.ScrollUpButton.displayName;
...
$s.displayName = kt.ScrollDownButton.displayName;
const Ze = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = Ct();
...
Ze.displayName = kt.Content.displayName;
...
mw.displayName = kt.Label.displayName;
const ee = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  kt.Item,
  {
    ref: o,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(kt.ItemIndicator, { children: /* @__PURE__ */ r(Qt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(kt.ItemText, { children: e })
    ]
  }
));
ee.displayName = kt.Item.displayName;
...
fw.displayName = kt.Separator.displayName;
function hw({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        mn,
        {
          ...
          children: [
            /* @__PURE__ */ r(Je, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(fn, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Ze, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(ee, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const mr = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Pn(i, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
...
const fr = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: f(
...
const hr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? Pn(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = b.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), yw(u, g, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), xw(l, y, w.key);
...
const $n = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: f(
...
function kw({
  ...
  var _;
  const [w, m] = O([]), [h, u] = O([]), [g, y] = O({}), [x, N] = O({}), R = z(() => e ?? [], [e]), I = za({
    data: R,
    columns: t,
    getCoreRowModel: qa(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((v, E) => `skeleton-row-${E}`).map((v) => /* @__PURE__ */ r(_e, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Xe, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(eo, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, v)) : ((_ = I.getRowModel().rows) == null ? void 0 : _.length) > 0 ? V = I.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    _e,
    {
      onClick: () => i(T, I),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((C) => /* @__PURE__ */ r(Xe, { children: In(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    T.id
  )) : V = /* @__PURE__ */ r(_e, { children: /* @__PURE__ */ r(Xe, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(ww, { table: I }),
    /* @__PURE__ */ p(mr, { stickyHeader: s, children: [
      /* @__PURE__ */ r(fr, { stickyHeader: s, children: I.getHeaderGroups().map((T) => /* @__PURE__ */ r(_e, { children: T.headers.map((C) => /* @__PURE__ */ r($n, { className: "tw-p-0", children: C.isPlaceholder ? void 0 : In(C.column.columnDef.header, C.getContext()) }, C.id)) }, T.id)) }),
      /* @__PURE__ */ r(hr, { children: V })
    ] }),
...
function nm({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(lc, { options: s, children: e })
    }
  );
}
...
function om({
  ...
  return /* @__PURE__ */ p(Ne, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ r(Me, { asChild: !0, children: o }),
    /* @__PURE__ */ p(we, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function am({ id: t, label: e, groups: n }) {
  const [o, a] = O(
    Object.fromEntries(
      n.map(
    ...
    i((h) => (h[c] = w, { ...h }));
    const m = n[c].items.find((h) => h.id === w);
    m ? m.onUpdate(w) : console.error(`Could not find dropdown radio item with id '${w}'!`);
  };
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ve, { children: [
    ...
    /* @__PURE__ */ r(ce, { children: n.map((c, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(Be, { children: c.label }),
      /* @__PURE__ */ r(Ds, { children: c.itemType === 0 ? /* @__PURE__ */ r(at, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        ne,
        {
          checked: o[w][h],
        ...
        (a || i) && /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          a && /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ p(
            F,
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ r(Ii, { className: "tw-h-4 tw-w-4" })
              ]
            }
          ) }),
...
function Tw({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const d = new Date(l), c = new Date(a.getTime() - d.getTime()), w = c.getUTCFullYear() - 1970, m = c.getUTCMonth(), h = c.getUTCDate() - 1;
    let u = "";
    return w > 0 ? u = `${w.toString()} year${w === 1 ? "" : "s"} ago` : m > 0 ? u = `${m.toString()} month${m === 1 ? "" : "s"} ago` : h === 0 ? u = "today" : u = `${h.toString()} day${h === 1 ? "" : "s"} ago`, u;
  }
...
function im({
  ...
  const i = z(() => el(n), [n]), d = ((c) => {
    const w = new Intl.DisplayNames(nl(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(Tw, { versionHistory: a }),
...
function Sw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ p(Ne, { open: C, onOpenChange: w ?? R, children: [
    /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(we, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(xe, { children: [
      ...
      /* @__PURE__ */ p(ye, { children: [
        /* @__PURE__ */ r(xn, { children: l }),
        /* @__PURE__ */ r(re, { children: V.map((E) => /* @__PURE__ */ p(
          ae,
          {
            value: E.label,
            onSelect: I,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(Oi, { className: "tw-h-4 tw-w-4" }),
...
function Iw({
  ...
  return /* @__PURE__ */ p(at, { children: [
    ...
    e && /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(
        F,
        {
          "aria-label": "Redo",
...
function Dw({ children: t, editorRef: e }) {
  const n = H(null);
  return J(() => {
    var i;
...
const Ow = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(at, { children: [
...
function Mw({
  ...
  const s = H(null), i = H(null), l = H(!1), [d, c] = O(t), [w, m] = O(n), [h, u] = O(!1);
  J(() => {
    c(t);
  }, [t]), J(() => {
    w !== n && m(n);
  ...
  return /* @__PURE__ */ p(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Ow(t, a, n) }) }) }),
    ...
    /* @__PURE__ */ p(
      ce,
      {
        ...
        children: [
          /* @__PURE__ */ r(Be, { children: a["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ r(Oe, {}),
          /* @__PURE__ */ r(
            ne,
            {
...
const Aw = (t, e) => t === "f" ? /* @__PURE__ */ p(at, { children: [
  /* @__PURE__ */ r(ka, {}),
  " ",
...
function $w({
  ...
  return /* @__PURE__ */ p(ve, { children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(Wl, { asChild: !0, children: /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Aw(t, n) }) }) }),
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r("p", { children: Pw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ce, { style: { zIndex: Ha }, children: [
      /* @__PURE__ */ r(Be, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ r(Oe, {}),
      /* @__PURE__ */ p(
        ne,
        {
...
function Lw({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Pi, { className: e, size: 16 });
}
function da({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ p(
    ae,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Lw, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function Vw({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = O(""), [s, i] = z(() => {
  ...
  return /* @__PURE__ */ p(xe, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      tn,
      {
    ...
    /* @__PURE__ */ p(ye, { children: [
      /* @__PURE__ */ r(xn, { children: t["%markerMenu_noResults%"] }),
      ...
      i.length > 0 && /* @__PURE__ */ p(at, { children: [
        s.length > 0 && /* @__PURE__ */ r(pr, { alwaysRender: !0 }),
...
function cm({
  ...
  const w = H(null), m = H(null), h = H(null), u = H(null);
  Jt(() => {
    if (!u.current) return;
    const { width: B } = u.current.getBoundingClientRect();
    B > 0 && (u.current.style.width = `${B}px`);
  }, []);
  const [g, y] = O("generated"), [x, N] = O("*"), [R, I] = O("f"), [S, V] = O(!1), [_, T] = O(!0), [C, v] = O(!1), E = H(!1), $ = H(""), [L, A] = O(!1), [j, U] = O(), [X, tt] = O(), [St, Ht] = O(), [Rt, lt] = O(), pt = H(null), K = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  J(() => {
    ...
    if (W && zn("note", W)) {
      const gt = (et = W.insert.note) == null ? void 0 : et.caller;
      let bt = "custom";
      gt === zr ? bt = "generated" : gt === Kr ? bt = "hidden" : gt && N(gt), y(bt), I(((it = W.insert.note) == null ? void 0 : it.style) ?? "f"), B = setTimeout(() => {
        var _t;
        (_t = w.current) == null || _t.applyUpdate([W]);
      }, 0);
    }
    return () => {
      B && clearTimeout(B);
  ...
  const rt = G(
    (B, W, et = !1) => {
      var gt, bt, _t;
      const it = (bt = (gt = w.current) == null ? void 0 : gt.getNoteOps(0)) == null ? void 0 : bt.at(0);
      if (it && zn("note", it)) {
        if (it.insert.note) {
          let vt;
          B === "custom" ? vt = W : B === "generated" ? vt = zr : vt = Kr, it.insert.note.caller = vt;
        }
        n == null || n([it]), et && c && s && ((_t = c.current) == null || _t.replaceEmbedUpdate(s, [it]));
      }
    },
    [s, n, c]
  ), wt = G(() => {
  ...
  const jt = H({ book: a.book, chapterNum: a.chapterNum });
  Jt(() => {
    (jt.current.book !== a.book || jt.current.chapterNum !== a.chapterNum) && (jt.current = { book: a.book, chapterNum: a.chapterNum }, ut.current());
  }, [a.book, a.chapterNum]);
  const Dt = () => {
    var W;
    ...
    var et, it, gt, bt, _t;
    I(B);
    const W = (it = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : it.at(0);
    if (W && zn("note", W)) {
      W.insert.note && (W.insert.note.style = B);
      const vt = (bt = (gt = W.insert.note) == null ? void 0 : gt.contents) == null ? void 0 : bt.ops;
      R !== "x" && B === "x" ? vt == null || vt.forEach((It) => Gw(It)) : R === "x" && B !== "x" && (vt == null || vt.forEach((It) => Fw(It))), (_t = w.current) == null || _t.applyUpdate([W, { delete: 1 }]);
    }
  }, Wt = (B) => {
    ...
    (B) => {
      ...
      if (W && zn("note", W)) {
        ...
        const vt = (gt = W.insert.note) == null ? void 0 : gt.style, It = (_t = (bt = W.insert.note) == null ? void 0 : bt.contents) == null ? void 0 : _t.ops;
        if (vt || V(!1), V(
          vt === "x" ? !!(It != null && It.every((Lt) => {
            var xt, yt;
            if (!((xt = Lt.attributes) != null && xt.char)) return !0;
            const M = ((yt = Lt.attributes) == null ? void 0 : yt.char).style;
        ...
        T(JSON.stringify(W) === $.current), rt(g, x);
      } else
        V(!1), T(!0);
    },
    [g, x, rt]
    ...
    if (h.current && st.length && B && B.rangeCount > 0) {
      const W = B.getRangeAt(0).getBoundingClientRect(), et = h.current.getBoundingClientRect();
      U(W.left - et.left), tt(W.top - et.top), Ht(W.height), A(!0);
    }
  }, [st, h]);
  return J(() => {
    const B = () => {
    ...
    var B;
    L && ((B = pt.current) == null || B.focus());
  }, [L]), J(() => {
    var et;
    const B = ((et = m.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, W = (it) => {
      !L && B && document.activeElement === B && it.key === l ? (it.preventDefault(), Mt()) : L && it.key === "Escape" && (it.preventDefault(), A(!1));
    };
    return document.addEventListener("keydown", W), () => {
      document.removeEventListener("keydown", W);
    };
  }, [L, Mt, l]), /* @__PURE__ */ p(at, { children: [
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
            /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(hn, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(Dw, { editorRef: w, children: /* @__PURE__ */ r(
              dc,
              {
                options: K,
                onStateChange: Wt,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
              /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(
                F,
                {
                  onClick: Dt,
  ...
  return /* @__PURE__ */ p(at, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(at, { children: Kw(t.marker, l, o, c) })
      }
    )
  ] });
}
function wm({
  ...
  const w = d ?? rl(n, void 0), m = (R, I) => {
    c == null || c(R, I, a);
  }, h = s ? n.findIndex((R) => R === s) : -1, [u, g] = O(h), y = (R, I, S) => {
    if (n.length)
      switch (R.key) {
        case "Enter":
        case " ":
...
function Yw({
  ...
  return /* @__PURE__ */ p(mr, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(fr, { stickyHeader: !0, children: /* @__PURE__ */ p(_e, { children: [
      /* @__PURE__ */ r($n, { children: a }),
      /* @__PURE__ */ r($n, { children: s })
    ] }) }),
    /* @__PURE__ */ r(hr, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      _e,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(Xe, { children: Ce(l.reference, "English") }),
          /* @__PURE__ */ r(Xe, { className: o, children: Uw(l.text) })
        ]
      },
...
const Xw = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Vi, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(Bi, { className: "tw-h-4 tw-w-4" });
}, gr = (t, e, n) => /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
  /* @__PURE__ */ p(
    Ft,
    {
  ...
  header: ({ column: e }) => gr(e, t)
}), Ww = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (n) => n.items[e],
  header: ({ column: n }) => gr(n, t)
}), um = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => gr(e, t, "tw-justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => gr(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, Jw = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bm = Object.freeze([
...
function vm({
  ...
  const u = ue(n, "%webView_inventory_all%"), g = ue(n, "%webView_inventory_approved%"), y = ue(n, "%webView_inventory_unapproved%"), x = ue(n, "%webView_inventory_unknown%"), N = ue(n, "%webView_inventory_scope_currentBook%"), R = ue(n, "%webView_inventory_scope_chapter%"), I = ue(n, "%webView_inventory_scope_verse%"), S = ue(n, "%webView_inventory_filter_text%"), V = ue(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = ue(n, "%webView_inventory_no_results%"), [T, C] = O(!1), [v, E] = O("all"), [$, L] = O(""), [A, j] = O([]), U = z(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : Qw(K, a, s);
  }, [t, a, s]), X = z(() => {
    if (T) return U;
    const K = [];
    return U.forEach((st) => {
      const rt = st.items[0], wt = K.find(
        (ut) => ut.items[0] === rt
      );
      wt ? (wt.count += st.count, wt.occurrences = wt.occurrences.concat(st.occurrences)) : K.push({
        items: [rt],
        count: st.count,
  ...
  }, [T, U]), tt = z(() => X.length === 0 ? [] : Zw(X, v, $), [X, v, $]), St = z(() => {
    var rt, wt;
    if (!T) return d;
    ...
    for (let ut = 0; ut < K; ut++)
      st.push(
        Ww(
          ((wt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : wt[ut]) || "Additional Item",
          ut + 1
        )
      );
    return [...st, ...d];
  ...
  const Ht = (K, st) => {
    ...
    const K = X.filter((st) => ol(
      T ? st.items : [st.items[0]],
      A
    ));
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        mn,
        {
          ...
          defaultValue: v,
          children: [
            /* @__PURE__ */ r(Je, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(fn, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ p(Ze, { children: [
              /* @__PURE__ */ r(ee, { value: "all", children: u }),
              /* @__PURE__ */ r(ee, { value: "approved", children: g }),
              /* @__PURE__ */ r(ee, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(ee, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(mn, { onValueChange: (K) => Rt(K), defaultValue: i, children: [
        /* @__PURE__ */ r(Je, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(fn, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Ze, { children: [
          /* @__PURE__ */ r(ee, { value: "book", children: N }),
          /* @__PURE__ */ r(ee, { value: "chapter", children: R }),
          /* @__PURE__ */ r(ee, { value: "verse", children: I })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Nn,
      ...
      o && /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Gt, { children: [
        /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          /* @__PURE__ */ r(
            Ro,
            {
...
function ap({ scrollGroupId: t, isBoundButClosed: e }) {
  const n = jn(t);
  return e ? /* @__PURE__ */ r(
    be,
    {
  ...
  ) : /* @__PURE__ */ r(be, { variant: "secondary", children: n });
}
function sp({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  const s = !!(t.language || t.languageCode), i = /* @__PURE__ */ r(Qt, { className: f("tw-h-4 tw-w-4", t.isSelected ? "tw-opacity-100" : "tw-opacity-0") });
  let l = null;
  e === "project" ? t.openGroups.length > 0 && (l = /* @__PURE__ */ r("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-gap-1", children: t.openGroups.map((m) => /* @__PURE__ */ r(be, { variant: "secondary", children: jn(m) }, m)) })) : t.scrollGroupId !== void 0 && (l = /* @__PURE__ */ p("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-items-center tw-gap-2", children: [
    /* @__PURE__ */ r(
      ap,
      {
  ...
  ), c = t.scrollGroupId !== void 0 ? jn(t.scrollGroupId) : void 0, w = t.isBoundButClosed && c ? n.boundButClosedTooltip.replace("{group}", c) : void 0;
  return /* @__PURE__ */ p(Gt, { delayDuration: 200, children: [
    /* @__PURE__ */ r(Ft, { asChild: !0, children: d }),
    /* @__PURE__ */ p(
      $t,
      {
        side: "right",
...
function ip({
  ...
  return /* @__PURE__ */ p(ve, { children: [
    ...
    /* @__PURE__ */ p(ce, { align: "end", className: "tw-w-56", style: { zIndex: mo }, children: [
      /* @__PURE__ */ r(Be, { children: a.groupSectionLabel }),
      /* @__PURE__ */ r(
        ne,
        {
          checked: t,
      ...
      o && /* @__PURE__ */ p(at, { children: [
        /* @__PURE__ */ r(Oe, {}),
        /* @__PURE__ */ r(Be, { children: a.filterSectionLabel }),
        /* @__PURE__ */ r(
          ne,
          {
            checked: !!n,
...
function xm(t) {
  const [e, n] = O(!1), [o, a] = O(""), [s, i] = O(t.defaultGroupByOpenTabs ?? !0), [l, d] = O(!1), c = rp(t.localizedStrings), w = z(() => t.mode === "project" ? Ar({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const C = T.map(
          ({ project: E, scrollGroupId: $ }) => $ === void 0 ? E.shortName : `${E.shortName} (${jn($)})`
        ).join(", ");
        if (T.length === 1) return { node: C, title: C };
        const v = T.length.toString();
        return {
          node: /* @__PURE__ */ p(at, { children: [
            /* @__PURE__ */ r(be, { variant: "muted", className: "tw-shrink-0", children: v }),
  ...
  return /* @__PURE__ */ p(Ne, { open: e, onOpenChange: n, children: [
    /* @__PURE__ */ r(Me, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
    ...
    /* @__PURE__ */ r(
      we,
      {
        ...
        children: /* @__PURE__ */ r(Pt, { delayDuration: 200, children: /* @__PURE__ */ p(xe, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ p(ye, { children: [
            /* @__PURE__ */ r(xn, { children: t.commandEmptyMessage ?? "No projects found" }),
            h.map((_, T) => /* @__PURE__ */ p(io, { children: [
              /* @__PURE__ */ r(re, { heading: lp(_, c), children: _.rows.map((C) => /* @__PURE__ */ r(
                sp,
                {
                  row: C,
                  mode: t.mode,
...
const cp = "16rem", dp = "3rem", Ls = b.createContext(void 0);
function br() {
...
const Vs = b.forwardRef(
  ({
    ...
    const [c, w] = b.useState(t), m = e ?? c, h = b.useCallback(
      (I) => {
        const S = typeof I == "function" ? I(m) : I;
        n ? n(S) : w(S);
      },
      [n, m]
    ), u = b.useCallback(() => h((I) => !I), [h]), g = m ? "expanded" : "collapsed", N = Ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", R = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ls.Provider, { value: R, children: /* @__PURE__ */ r(Pt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const wp = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = br();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Gi, {}) : /* @__PURE__ */ r(Fi, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
wp.displayName = "SidebarTrigger";
const pp = b.forwardRef(
  ({ className: t, ...e }, n) => {
    const { toggleSidebar: o } = br();
    return /* @__PURE__ */ r(
      "button",
      {
        type: "button",
...
up.displayName = "SidebarInput";
const mp = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
mp.displayName = "SidebarHeader";
const fp = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
fp.displayName = "SidebarFooter";
const hp = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  un,
  {
    ref: n,
...
hp.displayName = "SidebarSeparator";
...
const gp = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? gn : "button",
  {
    ref: o,
...
gp.displayName = "SidebarGroupAction";
...
const bp = Ge(
  ...
  ({
    ...
    const d = t ? gn : "button", { state: c } = br(), w = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(bp({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Ft, { asChild: !0, children: w }),
      /* @__PURE__ */ r($t, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : w;
  }
);
qs.displayName = "SidebarMenuButton";
const vp = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? gn : "button",
  {
    ref: a,
...
vp.displayName = "SidebarMenuAction";
...
xp.displayName = "SidebarMenuBadge";
const yp = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
yp.displayName = "SidebarMenuSkeleton";
const Np = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "ul",
    {
      ref: n,
...
Np.displayName = "SidebarMenuSub";
const kp = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
kp.displayName = "SidebarMenuSubItem";
const _p = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? gn : "a",
  {
    ref: s,
...
_p.displayName = "SidebarMenuSubButton";
function Cp({
  id: t,
  extensionLabels: e,
  projectInfo: n,
    ...
    Bs,
    {
      ...
      children: /* @__PURE__ */ p(Fs, { children: [
        /* @__PURE__ */ p(no, { children: [
          ...
          /* @__PURE__ */ r(oo, { children: /* @__PURE__ */ r(zs, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ks, { children: /* @__PURE__ */ r(
            qs,
            {
              onClick: () => c(h),
              isActive: m(h),
...
const Le = "scrBook", Ep = "scrRef", He = "source", Tp = "details", Sp = "Scripture Reference", Rp = "Scripture Book", Hs = "Type", Ip = "Details";
function Dp(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Le ? Ce(a.start) : void 0;
      },
...
}, ua = (t) => `${Op({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Nm({
  sources: t,
  ...
  const [c, w] = O([]), [m, h] = O([{ id: Le, desc: !1 }]), [u, g] = O({}), y = z(
  ...
  const R = a ?? Rp, I = s ?? Hs, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${R}`, value: [Le] },
    { label: `Group by ${I}`, value: [He] },
    {
  ...
  }, T = (v, E) => v.getIsGrouped() ? "" : f("banded-row", E % 2 === 0 ? "even" : "odd"), C = (v, E, $) => {
  ...
  return /* @__PURE__ */ p("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      mn,
      {
        ...
        children: [
          /* @__PURE__ */ r(Je, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(fn, {}) }),
          /* @__PURE__ */ r(Ze, { position: "item-aligned", children: /* @__PURE__ */ r(pw, { children: S.map((v) => /* @__PURE__ */ r(ee, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(mr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(fr, { children: N.getHeaderGroups().map((v) => /* @__PURE__ */ r(_e, { children: v.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r($n, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          In(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(hr, { children: N.getRowModel().rows.map((v, E) => {
        const $ = Ct();
        return /* @__PURE__ */ r(
          _e,
          {
            ...
            children: v.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== He || !n)))
                return /* @__PURE__ */ r(
                  Xe,
                  {
                    className: f(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ p(
                      F,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          In(L.column.columnDef.cell, L.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
function Ap({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, N] = O(!1), [R, I] = O(""), S = H(void 0), V = H(!1);
  if (t.length !== dt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const _ = z(() => dt.allBookIds.filter(
    (j, U) => t[U] === "1" && !dt.isObsolete(dt.bookIdToNumber(j))
  ), [t]), T = z(() => {
    if (!R.trim()) {
      const X = {
        [Q.OT]: [],
    ...
    (j, U = !1) => {
      if (!U || !S.current) {
        n(
          e.includes(j) ? e.filter((lt) => lt !== j) : [...e, j]
        ), S.current = j;
        return;
      }
      const X = _.findIndex((lt) => lt === S.current), tt = _.findIndex((lt) => lt === j);
      if (X === -1 || tt === -1) return;
      const [St, Ht] = [
        Math.min(X, tt),
        Math.max(X, tt)
      ], Rt = _.slice(St, Ht + 1).map((lt) => lt);
      n(
        e.includes(j) ? e.filter((lt) => !Rt.includes(lt)) : [.../* @__PURE__ */ new Set([...e, ...Rt])]
      );
    },
    [e, n, _]
  ), v = (j) => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ p(
      Ne,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(we, { className: "tw-w-[500px] tw-max-w-[calc(100vw-2rem)] tw-p-0", align: "start", children: /* @__PURE__ */ p(
            xe,
            {
              shouldFilter: !1,
              onKeyDown: (j) => {
                    ...
                    if (X.length !== 0)
                      return /* @__PURE__ */ p(io, { children: [
                        /* @__PURE__ */ r(
                          re,
                          {
                            heading: Xa(j, h, u, g, y),
                            children: X.map((tt) => /* @__PURE__ */ r(
                              Ja,
                              {
                                bookId: tt,
                        ...
                        U < Object.values(Q).length - 1 && /* @__PURE__ */ r(pr, {})
                      ] }, j);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === $r ? $r : ma
      ).map((j) => /* @__PURE__ */ r(be, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ve(j, a) }, j)),
...
function _m({
  ...
  const S = Bt(
    i,
    "%webView_scope_selector_selected_text%"
  ), V = Bt(i, "%webView_scope_selector_verse%"), _ = Bt(i, "%webView_scope_selector_chapter%"), T = Bt(i, "%webView_scope_selector_book%"), C = Bt(
    i,
    "%webView_scope_selector_current_verse%"
  ), v = Bt(
    i,
    "%webView_scope_selector_current_chapter%"
  ), E = Bt(i, "%webView_scope_selector_current_book%"), $ = Bt(i, "%webView_scope_selector_choose_books%"), L = Bt(i, "%webView_scope_selector_scope%"), A = Bt(i, "%webView_scope_selector_select_books%"), j = Bt(i, "%webView_scope_selector_range%"), U = Bt(i, "%webView_scope_selector_select_range%"), X = Bt(i, "%webView_scope_selector_range_start%"), tt = Bt(i, "%webView_scope_selector_range_end%"), St = Bt(i, "%webView_scope_selector_ok%"), Ht = Bt(i, "%webView_scope_selector_navigate%"), Rt = (D) => {
    if (!g) return;
    ...
    },
    {
      ...
      label: T,
      dropdownLabel: E,
      scrRefSuffix: Rt("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: $, id: "scope-selected" },
    { value: "range", label: j, id: "scope-range" }
  ], pt = (D, q, Nt = !1) => /* @__PURE__ */ p(at, { children: [
    D,
    q && !Nt && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
      ": ",
      q
    ] })
  ] }), K = e ? lt.filter((D) => e.includes(D.value)) : lt, st = g ?? yr, rt = w ?? st, wt = m ?? st, ut = () => {
  }, jt = H(null), Dt = H(null), Ot = H(!1), Pe = H(null), P = H(!1), [Wt, te] = O(void 0), Mt = H(!1), B = H(!1), W = H(null), et = G((D) => {
    if (D) {
      te("start"), Mt.current = !1;
      return;
    }
    te((q) => q === "start" ? void 0 : q), Mt.current && (Mt.current = !1, requestAnimationFrame(() => {
      var Nt;
      const q = (Nt = jt.current) == null ? void 0 : Nt.querySelector("button");
      q == null || q.click();
    }));
  }, []), it = G((D) => {
    if (D) {
    ...
    (D) => {
      h == null || h(D), u == null || u(D), Mt.current = !0;
    },
    [h, u]
  ), bt = G(
    (D) => {
      u == null || u(D), B.current = !0;
    },
    [u]
  ), _t = G(
    (D) => {
      n(D), D === "selectedBooks" && a.length === 0 && (g != null && g.book) && s([g.book]);
    },
    [n, a, g, s]
  ), vt = K.find((D) => D.value === t), It = () => t === "selectedBooks" && a.length > 0 ? a.map((D) => D.toUpperCase()).join(", ") : t === "range" ? al(rt, wt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : vt ? pt(vt.label, vt.scrRefSuffix) : t, Lt = K.filter(
    (D) => D.value !== "selectedBooks" && D.value !== "range"
  ), M = K.find((D) => D.value === "selectedBooks"), xt = K.find((D) => D.value === "range"), yt = /* @__PURE__ */ r(
    Ap,
    {
      availableBookInfo: o,
      selectedBookIds: a,
  ...
  ), Fe = Wt === "end", ze = Wt === "start", Ke = "tw-text-muted-foreground", kn = /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-wrap tw-items-end tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(Tt, { htmlFor: "scope-range-start", className: f(Fe && Ke), children: X }),
      /* @__PURE__ */ r(
        _r,
        {
    ...
    /* @__PURE__ */ p("div", { ref: jt, className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(Tt, { htmlFor: "scope-range-end", className: f(ze && Ke), children: tt }),
      /* @__PURE__ */ r(
        _r,
        {
          id: "scope-range-end",
          scrRef: wt,
          handleSubmit: u ? bt : ut,
          localizedBookNames: l,
          localizedStrings: x,
          getEndVerse: N,
          disableReferencesUpTo: rt,
          onOpenChange: it,
          onCloseAutoFocus: (D) => {
            var q;
            B.current && (B.current = !1, D.preventDefault(), (q = W.current) == null || q.focus());
          },
          className: f(ze && Ke),
          modal: !0,
          align: "start"
  ...
  ] }), [en, Bn] = O(!1), [_n, $e] = O(void 0), Cn = H({}), nn = G(
    (D) => (q) => {
      Cn.current[D] = q;
    },
    []
  ...
  J(() => {
    ...
    const q = requestAnimationFrame(() => {
      D = requestAnimationFrame(() => {
        var Nt;
        (Nt = Cn.current[t]) == null || Nt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(q), D && cancelAnimationFrame(D);
    };
  }, [en, t]);
  const [rn, vr] = O(null), [k, Y] = O(null), [Z, zt] = O(null), je = 200, [on, an] = O(!1);
  J(() => {
    if (!Z || typeof ResizeObserver > "u") return;
    const D = new ResizeObserver(([q]) => {
      an(q.contentRect.width < je);
    });
    return D.observe(Z), () => D.disconnect();
  }, [Z]);
  const Vt = G(
    (D) => {
      _t(D), Bn(!1), $e(D);
    ...
    var q;
    D.preventDefault(), (q = Gn.current) == null || q.focus();
  }, []), At = (D) => t === D ? /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Qt, { className: "tw-h-4 tw-w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw-grid tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      !R && /* @__PURE__ */ r(Tt, { children: L }),
      c === "dropdown" ? /* @__PURE__ */ p(ve, { open: en, onOpenChange: Bn, children: [
        /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ p(
          F,
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { className: "tw-min-w-0 tw-flex-1 tw-truncate tw-text-start", children: It() }),
              /* @__PURE__ */ r(Se, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ r(
          ce,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(Nr, { container: Z, children: [
              Lt.map(({ value: D, label: q, dropdownLabel: Nt, scrRefSuffix: se, id: di }) => /* @__PURE__ */ r(
                ne,
                {
                  ref: nn(D),
                  checked: t === D,
              ...
              M && /* @__PURE__ */ p(
                Ye,
                {
                  ref: nn("selectedBooks"),
                  className: f("tw-relative tw-ps-8 focus:tw-text-accent-foreground"),
                  onSelect: () => Vt("selectedBooks"),
              ...
              y && /* @__PURE__ */ p(at, { children: [
                /* @__PURE__ */ r(Oe, {}),
                /* @__PURE__ */ r(Be, { className: "tw-px-2 tw-py-1.5 tw-text-xs tw-font-medium tw-text-muted-foreground", children: Ht }),
                /* @__PURE__ */ r(
                  Ye,
                  {
                    ref: Pe,
                    ...
                    onSelect: (D) => {
                      var q, Nt;
                      if (D.preventDefault(), Ot.current) {
                        Ot.current = !1;
                        return;
                      }
                      P.current || (Nt = (q = Dt.current) == null ? void 0 : q.querySelector("button")) == null || Nt.click();
                    },
                    children: /* @__PURE__ */ r(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (D) => {
                          const q = D.target instanceof HTMLElement ? D.target : void 0;
                          q != null && q.closest("button") && (Ot.current = !0, requestAnimationFrame(() => {
                            Ot.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ r(
        ...
        go,
        {
          ...
          children: K.map(({ value: D, label: q, scrRefSuffix: Nt, id: se }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(nr, { className: "tw-me-2", value: D, id: se }),
            /* @__PURE__ */ r(Tt, { htmlFor: se, children: pt(q, Nt) })
          ] }, se))
        }
      )
    ] }),
    c === "radio" && t === "selectedBooks" && /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(Tt, { children: A }),
      yt
    ] }),
    c === "radio" && t === "range" && kn,
    c === "dropdown" && M && /* @__PURE__ */ r(
      Yr,
      {
        open: _n === "selectedBooks",
        onOpenChange: (D) => {
          D || $e(void 0);
        },
        children: /* @__PURE__ */ r(
          Qn,
          {
            ...
            onCloseAutoFocus: Et,
            onEscapeKeyDown: (D) => {
              k != null && k.querySelector('[data-state="open"]') && D.preventDefault();
            },
            children: /* @__PURE__ */ p(Nr, { container: k, children: [
              /* @__PURE__ */ r(tr, { className: "tw-pe-8", children: /* @__PURE__ */ r(er, { children: $ }) }),
              yt,
              /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(F, { onClick: () => $e(void 0), children: St }) })
            ] })
          }
        )
      }
    ),
    c === "dropdown" && xt && /* @__PURE__ */ r(
      Yr,
      {
        open: _n === "range",
        onOpenChange: (D) => {
        ...
        children: /* @__PURE__ */ r(
          Qn,
          {
            ...
            onCloseAutoFocus: Et,
            onEscapeKeyDown: (D) => {
              rn != null && rn.querySelector('[data-state="open"]') && D.preventDefault();
            },
            children: /* @__PURE__ */ p(Nr, { container: rn, children: [
              /* @__PURE__ */ r(tr, { className: "tw-pe-8", children: /* @__PURE__ */ r(er, { children: U }) }),
              kn,
              /* @__PURE__ */ r(Xr, { children: /* @__PURE__ */ r(F, { ref: W, onClick: () => $e(void 0), children: St }) })
            ] })
          }
        )
      }
...
function Cm({
  ...
  return /* @__PURE__ */ p(
    mn,
    {
      ...
      children: [
        /* @__PURE__ */ r(Je, { size: a, className: f("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          fn,
          {
            placeholder: l[ot(e)] ?? e
          }
        ) }),
        /* @__PURE__ */ r(
          Ze,
          {
            ...
            style: { zIndex: Vn },
            children: t.map((c) => /* @__PURE__ */ r(ee, { value: `${c}`, children: l[ot(c)] }, `${c}`))
          }
        )
      ]
    }
...
function lr({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ p(Gt, { children: [
  /* @__PURE__ */ r(Ft, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    Ye,
    {
      onClick: () => {
        o(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(lr, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(lr, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ p(iw, { children: [
    /* @__PURE__ */ r(Os, { children: l.label }),
    /* @__PURE__ */ r(sw, { children: /* @__PURE__ */ r(Ms, { children: Xs(
      t,
      e,
      Ys(t, l.id),
      o
...
function ao({
  ...
  return /* @__PURE__ */ p(ve, { variant: s, children: [
    /* @__PURE__ */ r(De, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ki, {}) }) }),
    /* @__PURE__ */ r(ce, { align: "start", style: { zIndex: Vn }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, w) => /* @__PURE__ */ p(io, { children: [
      /* @__PURE__ */ r(Ds, { children: /* @__PURE__ */ r(Pt, { children: Xs(e.groups, e.items, d, t) }) }),
...
const $p = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Xt.Trigger,
  {
    ref: n,
    ...e,
...
function Dm({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Js, { children: [
      /* @__PURE__ */ r(Zs, { children: t.map((l) => /* @__PURE__ */ r($p, { value: l.value, children: l.value }, l.key)) }),
...
ti.displayName = ft.Root.displayName;
...
ei.displayName = ft.Trigger.displayName;
...
ni.displayName = ft.SubTrigger.displayName;
...
ri.displayName = ft.SubContent.displayName;
...
const Vp = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = pe();
  return /* @__PURE__ */ p(
    ft.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ft.ItemIndicator, { children: /* @__PURE__ */ r(Qt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Vp.displayName = ft.CheckboxItem.displayName;
const Bp = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = pe();
  return /* @__PURE__ */ p(
    ft.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ft.ItemIndicator, { children: /* @__PURE__ */ r(dr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Bp.displayName = ft.RadioItem.displayName;
const Gp = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ft.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Gp.displayName = ft.Label.displayName;
...
si.displayName = ft.Separator.displayName;
const Tn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, w) => c.order - w.order).map((c) => /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(Ft, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        ai,
        {
          onClick: () => {
            o(c);
          ...
          children: [
            c.iconPathBefore && /* @__PURE__ */ r(lr, { icon: c.iconPathBefore, menuLabel: c.label, leading: !0 }),
            c.label,
            c.iconPathAfter && /* @__PURE__ */ r(lr, { icon: c.iconPathAfter, menuLabel: c.label })
          ]
        },
        `menubar-item-${c.label}-${c.command}`
      ) : /* @__PURE__ */ p(Lp, { children: [
...
function Fp({
  ...
  if (wc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    var g, y, x, N;
    w.preventDefault();
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Tn(s, [h, u]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Tn(i, [h, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Tn(l, [h, u]);
        break;
      case "alt+h":
        (N = d.current) == null || N.focus(), Tn(d, [h, u]);
        break;
    }
  }), J(() => {
    ...
    return /* @__PURE__ */ r(ti, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(jp, { children: [
      /* @__PURE__ */ r(ei, { ref: c(w), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        oi,
        {
          style: { zIndex: Vn },
          children: /* @__PURE__ */ r(Pt, { children: ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Am({
  ...
  return /* @__PURE__ */ p("div", { id: d, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      mn,
      {
        name: "uiLanguage",
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Je, { children: /* @__PURE__ */ r(fn, {}) }),
          /* @__PURE__ */ r(
            Ze,
            {
              style: { zIndex: Vn },
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(ee, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(Tt, { className: "tw-font-normal tw-text-muted-foreground", children: Ue(c, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Kp({ item: t, createLabel: e, createComplexLabel: n }) {
...
function $m({
  ...
  return n ? /* @__PURE__ */ r(Pt, { delayDuration: 0, children: /* @__PURE__ */ p(Gt, { children: [
    /* @__PURE__ */ r(Ft, { asChild: !0, children: i }),
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ve, { children: [
              /* @__PURE__ */ r(De, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r($o, {}) }) }),
              /* @__PURE__ */ r(ce, { align: "end", children: c })
            ] }) }),
            e && c && /* @__PURE__ */ p(ve, { children: [
              /* @__PURE__ */ r(De, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r($o, {}) }) }),
              /* @__PURE__ */ r(ce, { align: "end", children: c })
            ] })
          ] }),
...
const qp = Ln(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ui, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
qp.displayName = "Spinner";
function Lm({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), Up = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Xp = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Xp.displayName = "AlertDescription";
const Vm = ht.Root, Bm = ht.Trigger, Gm = ht.Group, Fm = ht.Portal, zm = ht.Sub, Km = ht.RadioGroup, Wp = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ht.SubTrigger,
  {
    ref: a,
    className: f(
...
Wp.displayName = ht.SubTrigger.displayName;
...
Jp.displayName = ht.SubContent.displayName;
const Zp = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ht.Portal, { children: /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    className: f(
...
Zp.displayName = ht.Content.displayName;
...
Qp.displayName = ht.Item.displayName;
const tu = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ht.CheckboxItem,
  {
    ref: a,
    className: f(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ht.ItemIndicator, { children: /* @__PURE__ */ r(Qt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
tu.displayName = ht.CheckboxItem.displayName;
const eu = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ht.RadioItem,
  {
    ref: o,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ht.ItemIndicator, { children: /* @__PURE__ */ r(dr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
eu.displayName = ht.RadioItem.displayName;
...
nu.displayName = ht.Label.displayName;
const ru = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ht.Separator,
  {
    ref: n,
...
ru.displayName = ht.Separator.displayName;
...
ou.displayName = "ContextMenuShortcut";
...
const qm = de.Trigger, su = de.Portal, Hm = de.Close, ci = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  de.Overlay,
  {
    ref: n,
...
ci.displayName = de.Overlay.displayName;
const iu = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
du.displayName = de.Title.displayName;
const wu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  de.Description,
  {
    ref: n,
    className: f("tw-text-sm tw-text-muted-foreground", t),
...
wu.displayName = de.Description.displayName;
const pu = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Hr.Root,
  {
    ref: o,
    className: f(
...
pu.displayName = Hr.Root.displayName;
function Um({
  className: t,
  ...e
}) {
...
function Xm({
  ...
  return /* @__PURE__ */ r(
    uo.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Yi, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Wm({ ...t }) {
...
const uu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Ct();
  return /* @__PURE__ */ p(
    Sn.Root,
    {
      ...
      dir: o,
      children: [
        /* @__PURE__ */ r(Sn.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ r(Sn.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ r(Sn.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
uu.displayName = Sn.Root.displayName;
const mu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Ct();
  return /* @__PURE__ */ r(
    Ur.Root,
    {
...
mu.displayName = Ur.Root.displayName;
const Jm = Xt.Root, fu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Ct();
  return /* @__PURE__ */ r(
    Xt.List,
    {
...
fu.displayName = Xt.List.displayName;
const hu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Xt.Trigger,
  {
    ref: n,
    className: f(
...
hu.displayName = Xt.Trigger.displayName;
const gu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Xt.Content,
  {
    ref: n,
    className: f(
...
gu.displayName = Xt.Content.displayName;
const bu = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: f(
...
const xu = (t, e, n = {}) => {
  ...
  o.current = e;
  const a = H(n);
  a.current = vu(a.current);
  const [s, i] = O(() => o.current), [l, d] = O(!0);
  return J(() => {
    let c = !0;
    return d(!!t), (async () => {
      if (t) {
...
export {
  ...
  tm as COMMENT_LIST_STRING_KEYS,
  Ts as Card,
  Ss as CardContent,
  rw as CardDescription,
  ow as CardFooter,
  ew as CardHeader,
  nw as CardTitle,
  ...
  Zp as ContextMenuContent,
  Gm as ContextMenuGroup,
  Qp as ContextMenuItem,
  nu as ContextMenuLabel,
  Fm as ContextMenuPortal,
  Km as ContextMenuRadioGroup,
  eu as ContextMenuRadioItem,
  ru as ContextMenuSeparator,
  ou as ContextMenuShortcut,
  zm as ContextMenuSub,
  Jp as ContextMenuSubContent,
  Wp as ContextMenuSubTrigger,
  Bm as ContextMenuTrigger,
  kw as DataTable,
  Yr as Dialog,
  Uu as DialogClose,
  Qn as DialogContent,
  vc as DialogDescription,
  Xr as DialogFooter,
  tr as DialogHeader,
  Ua as DialogOverlay,
  bc as DialogPortal,
  ...
  rm as ERROR_POPOVER_STRING_KEYS,
  Dw as EditorKeyboardShortcuts,
  Cw as ErrorDump,
  om as ErrorPopover,
  dm as FOOTNOTE_EDITOR_STRING_KEYS,
  lm as Filter,
  am as FilterDropdown,
  im as Footer,
  ...
  vm as Inventory,
  Tt as Label,
  $m as LinkedScrRefButton,
  jw as MARKER_MENU_STRING_KEYS,
  nm as MarkdownRenderer,
  Vw as MarkerMenu,
  sm as MoreInfo,
  Sw as MultiSelectComboBox,
  Dm as NavigationContentSearch,
  Ne as Popover,
  yc as PopoverAnchor,
  ...
  pu as Progress,
  xm as ProjectSelector,
  go as RadioGroup,
  nr as RadioGroupItem,
  Nc as RecentSearches,
  Xm as ResizableHandle,
  Ym as ResizablePanel,
  Um as ResizablePanelGroup,
  jm as ResultsCard,
  km as SCOPE_SELECTOR_STRING_KEYS,
  _m as ScopeSelector,
  Nm as ScriptureResultsViewer,
  Cm as ScrollGroupSelector,
  Io as SearchBar,
  mn as Select,
  Ze as SelectContent,
  pw as SelectGroup,
  ...
  fw as SelectSeparator,
  Je as SelectTrigger,
  fn as SelectValue,
  un as Separator,
  Em as SettingsList,
  Sm as SettingsListHeader,
  Tm as SettingsListItem,
  ...
  Am as UiLanguageSelector,
  Iw as UndoRedoButtons,
  Js as VerticalTabs,
  Qs as VerticalTabsContent,
  Zs as VerticalTabsList,
  $p as VerticalTabsTrigger,
  Vn as Z_INDEX_ABOVE_DOCK,
  Ha as Z_INDEX_FOOTNOTE_EDITOR,
  fc as Z_INDEX_MODAL,
  mc as Z_INDEX_MODAL_BACKDROP,
  mo as Z_INDEX_OVERLAY,
  tw as badgeVariants,
  Za as buttonVariants,
  f as cn,
  Ar as computeRows,
  gm as getBookIdFromUSFM,
  gr as getInventoryHeader,
  fm as getLinesFromUSFM,
  hm as getNumberFromUSFM,
  Jw as getStatusForItem,
  Om as getToolbarOSReservedSpaceClassName,
  um as inventoryCountColumn,
  pm as inventoryItemColumn,
  mm as inventoryStatusColumn,
  ep as partitionAndSort,
  jn as scrollGroupLetter,
  uw as selectTriggerVariants,
  rf as sonner,
  Zm as useEvent,
  Qm as useEventAsync,
  Qd as useListbox,
