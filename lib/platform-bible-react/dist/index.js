...
function Np({
  ...
  const w = mt(), [d, m] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, j] = S(!1), z = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
    ...
    [v, pt]
  ), { otLong: at, ntLong: st, dcLong: ct, extraLong: xt } = {
...
function ir({
  ...
  const [k, C] = S(!1), j = w ?? c, z = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
...
function Cp({
  ...
  const d = jn(w, "%webView_bookSelector_currentBook%"), m = jn(w, "%webView_bookSelector_choose%"), h = jn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
function kl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = yl(null, o), d = Ro({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
...
function Ol(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ci(e) && o !== null) {
    ...
    if (w || d) {
      const [m, h] = wi(t), u = l.is(c), g = e.is(i ? c : l), x = e.is(i ? l : c);
      let v, y = 0;
...
function Ll(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Mo(s, (w) => le(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const wr = qt({ build: (t) => pa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
class ql {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, c, w) {
      return Object.assign(l, { config: c, id: Bn, registerState: w });
...
const Wl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(wr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
  }, () => pe(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = zl(() => (s.value || Wl).has(i)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(i);
    const d = w !== void 0;
...
qt({ dependencies: [wr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  ...
  return de(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      const l = yi(i.target);
      if (Zl(l)) return function(c, w = !1) {
        const d = Vt(), m = c.isSelected(), h = c.getKey();
        let u;
        w && Po(d) ? u = d : (u = Ni(), ki(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    const i = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(pe(() => {
      const w = l.value;
      w && (c.value ? Lo(w, s) : Si(w, s));
    }));
    return de(...i);
  }));
} });
...
function Ql(t, e, n = ga) {
  return de(t.registerCommand(Di, (o) => {
    ...
    const s = function(i) {
      ...
      const l = i.anchor, c = i.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), m = $l(d);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Mi();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Ii(u), u.anchor.is(w)) return !0;
      }
      return !1;
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (xn(v) && w >= 0 && d >= 0 && (y = w, N = w + d, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), xn(v)) {
                  y = h, N = h + u;
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (h) => n._onError(h), children: r(gs, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Hi(d, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
}
function sc({ editor: t, ErrorBoundary: e }) {
  return function(n) {
...
function ic({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => de(Ui(a), va(a)), [a]);
  }(o), p(lt, { children: [t, r(lc, { content: e }), r(sc, { editor: o, ErrorBoundary: n })] });
}
...
const wc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function dc({ onClear: t }) {
  const [e] = Xt();
  return wc(() => wa(e, t), [e, t]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function pc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...j }, z) {
...
function hc({ content: t, editor: e }) {
  const n = function(i) {
    ...
    return xa(() => {
      ...
      return w(), de(i.registerUpdateListener(() => {
        w();
...
function xc({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = vc(), c = () => {
  };
        ...
        children: /* @__PURE__ */ r(
          kl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(Cc, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Cl,
                {
...
function Ca(t, e, n, o = null) {
  ...
  const l = le(i) ? i.getChildren() : [], c = Li(t, i.getType());
  let w;
...
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  return d != null && (h = d(h)), Yr(t) && (h = Sc(t, h, u ? () => {
    const g = new jo();
    return n.push(g), g;
...
function Dc(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = Tc(e, a);
      we().clear(), Fi(s);
    },
    {
      discrete: !0
...
function Ep({
  ...
  const [a, s] = S(Mc), [i, l] = S(void 0), [c, w] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(oe, { open: c, onOpenChange: w, children: [
      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
...
const Tp = Object.freeze([
  ...
  const a = H(null), [s, i] = S(void 0), [l, c] = S(void 0), w = K(
    (u) => {
      i(u);
    ...
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), w(!0), m(Dc(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_s, {}) }) }),
...
function Uc({
  ...
  const [A, M] = S(co), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [St, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), ct = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Jt = B(() => Bt[0], [Bt]), Re = H(null), se = H(void 0), Zt = K(() => {
    var T;
    (T = se.current) == null || T.call(se), M(co);
  }, []), He = K(() => {
    const T = !pt;
    G(T), st(!T), g == null || g(c, T);
  }, [pt, g, c]);
  Y(() => {
    O(!1);
  }, [o]), Y(() => {
...
function qc({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Xi, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = dt.Root, Hc = dt.Group, Ve = dt.Value, Yc = me(
...
Xc.displayName = dt.Label.displayName;
...
Wc.displayName = dt.Separator.displayName;
function Jc({ table: t }) {
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), nw(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), ew(l, x, d.key);
...
function ow({
  ...
  return c ? j = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ...
    A.id
  )) : j = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(No, {}) })
        ] }),
...
function Op({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Aa, { children: w.itemType === 0 ? /* @__PURE__ */ r(lt, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
        ...
        Kc,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(La, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, w.label)) })
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(oe, { open: M, onOpenChange: d ?? N, children: [
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: z, children: s }),
...
function pw({ children: t, editorRef: e }) {
  const n = H(null);
  return Y(() => {
    var i;
...
const uw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function mw({
  ...
  const s = H(null), i = H(null), l = H(!1), [c, w] = S(t), [d, m] = S(n), [h, u] = S(!1);
  Y(() => {
    w(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  const g = (v) => {
    ...
    var y, N, k, C;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((k = s.current) == null ? void 0 : k.selectionStart) === 0 && ((C = i.current) == null || C.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ p(ue, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: uw(t, a, n) }) }) }),
...
const fw = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function gw({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: fw(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: hw(t, n) }) })
    ] }) }),
...
function mo({
  ...
  return /* @__PURE__ */ p(
    Ht,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(vw, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function xw({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = S(""), [s, i] = B(() => {
...
function Lp({
  ...
  const st = K(
    (_, L, U = !1) => {
      ...
      if (q && pn("note", q)) {
        ...
        n == null || n([q]), U && w && s && ((bt = w.current) == null || bt.replaceEmbedUpdate(s, [q]));
      }
    },
    [s, n, w]
  ), ct = K(() => {
  ...
  const Bt = () => {
    ...
    if (L && pn("note", L)) {
      ...
      N !== "x" && _ === "x" ? wt == null || wt.forEach((Dt) => Nw(Dt)) : N === "x" && _ !== "x" && (wt == null || wt.forEach((Dt) => kw(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    (_) => {
      ...
      if (L && pn("note", L)) {
        ...
        const wt = (it = L.insert.note) == null ? void 0 : it.style, Dt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (wt || j(!1), j(
          wt === "x" ? !!(Dt != null && Dt.every(($t) => {
            var vt, ft;
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(pw, { editorRef: d, children: /* @__PURE__ */ r(
              nl,
              {
                options: G,
                onStateChange: Zt,
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Cw(t.marker, l, o, w) })
      }
    )
  ] });
}
  ...
  const d = c ?? ii(n, void 0), m = (N, k) => {
    ...
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), w == null || w(k, C, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
    ...
    /* @__PURE__ */ r(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { className: o, children: Rw(l.text) })
        ]
      },
...
const Dw = (t) => {
  ...
  return e ? e[1] : "";
}, Iw = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qp = Object.freeze([
...
function Hp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), j = Kt(
    ...
    const G = t ?? [];
    return G.length === 0 ? [] : Aw(G, a, s);
  }, [t, a, s]), I = B(() => {
    if (A) return W;
    const G = [];
    return W.forEach((at) => {
      const st = at.items[0], ct = G.find(
        (xt) => xt.items[0] === st
      );
  ...
  }, [A, W]), J = B(() => I.length === 0 ? [] : Ow(I, E, V), [I, E, V]), St = B(() => {
    var st, ct;
    if (!A) return c;
...
const Pw = "16rem", $w = "3rem", Fa = b.createContext(void 0);
function $n() {
...
const Ba = b.forwardRef(
  ({
    ...
    const [w, d] = b.useState(t), m = e ?? w, h = b.useCallback(
      (k) => {
...
const Lw = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    F,
    {
...
Bw.displayName = "SidebarSeparator";
...
const Kw = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: o,
...
Kw.displayName = "SidebarGroupAction";
...
const Gw = me(
  ...
  ({
    ...
    const c = t ? Fe : "button", { state: w } = $n(), d = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(Gw({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Uw = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: a,
...
Uw.displayName = "SidebarMenuAction";
...
qw.displayName = "SidebarMenuBadge";
const Hw = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Yw.displayName = "SidebarMenuSub";
const Xw = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Xw.displayName = "SidebarMenuSubItem";
const Ww = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: s,
...
Ww.displayName = "SidebarMenuSubButton";
function Jw({
  id: t,
  extensionLabels: e,
  projectInfo: n,
...
const ie = "scrBook", Zw = "scrRef", be = "source", Qw = "details", td = "Scripture Reference", ed = "Scripture Book", Xa = "Type", nd = "Details";
function rd(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Xp({
  ...
  const [w, d] = S([]), [m, h] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = B(
...
function ad({
  ...
  const s = Lr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function sd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Te,
          {
            ...
            style: { zIndex: Ge },
            children: t.map((w) => /* @__PURE__ */ r(Ot, { value: `${w}`, children: l[Q(w)] }, `${w}`))
          }
        )
      ]
    }
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ys, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(go, { children: [
...
es.displayName = Rt.List.displayName;
...
ns.displayName = Rt.Content.displayName;
function ou({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
cs.displayName = rt.Separator.displayName;
const Xe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    ...
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(cs, {}, `separator-${s}`)), c;
  });
};
function ud({
  menuData: t,
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    return /* @__PURE__ */ r(rs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(ld, { children: [
      /* @__PURE__ */ r(os, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        is,
        {
          style: { zIndex: Ge },
...
function iu({
  ...
  return /* @__PURE__ */ p("div", { id: c, className: f("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(ht, { className: "tw-font-normal tw-text-muted-foreground", children: ve(w, {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
...
const ku = Rt.Root, zd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
zd.displayName = Rt.List.displayName;
...
Fd.displayName = Rt.Trigger.displayName;
