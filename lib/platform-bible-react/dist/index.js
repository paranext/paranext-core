...
import { c as v, g as Re, a as zr, C as Ge, L as jn, u as Jo, t as Fn, T as Ot, b as Ct, d as Et, e as Tt, f as Un, A as pa, D as Ie, h as ke, i as ze, j as kr, k as Be, B as J, x as fs, l as ms, m as vs, I as bs, n as yo, o as Ke, r as Ce, p as xs, q as Kn, P as tr, s as _r, v as er, w as rr, y as _a, z as Na, E as ko, F as ar, G as Ca, H as Mt, R as _o, J as ha, K as eo, M as ro, N as ao, O as oo, Q as Hn, S as oa, U as No, V as Vr, W as Lr, X as pr, Y as ys, Z as Ze, _ as Ue, $ as Pe, a0 as je, a1 as hr, a2 as Co, a3 as Eo, a4 as ga, a5 as To, a6 as qn, a7 as ks, a8 as _s, a9 as Ns, aa as no, ab as Gn, ac as Ea, ad as Cs, ae as Yn, af as Es, ag as Ts, ah as Ss, ai as Zo, aj as Rs, ak as Ds, al as Ms, am as Wn, an as Xn, ao as So, ap as Os, aq as Jn, ar as La, as as Qo, at as Ba, au as Is, av as zs, aw as Ps, ax as As, ay as $s, az as Vs, aA as Ls, aB as Bs, aC as Ro, aD as Do, aE as js, aF as Fs } from "./resizable-DXhZ3iOr.js";
import { aG as of, aH as nf, aI as sf, aJ as cf, aK as lf, aL as df, aM as wf, aN as uf, aO as pf, aP as hf, aQ as gf, aR as ff, aS as mf, aT as vf, aU as bf, aV as xf, aW as yf, aX as kf, aY as _f, aZ as Nf, a_ as Cf, a$ as Ef, b0 as Tf, b1 as Sf, b2 as Rf, b3 as Df, b4 as Mf, b5 as Of, b6 as If, b7 as zf, b8 as Pf, b9 as Af, ba as $f, bb as Vf, bc as Lf, bd as Bf, be as jf, bf as Ff } from "./resizable-DXhZ3iOr.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as tn, ChevronsLeft as en, ChevronsRight as rn, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Us, ArrowRight as Ks, BoldIcon as Hs, ItalicIcon as qs, X as Mo, AtSign as Qn, Pencil as Gs, Trash2 as Ys, ArrowUp as ti, MoreHorizontal as Ws, MailOpen as Xs, Mail as Js, FilterIcon as Zs, ArrowLeftIcon as Qs, ChevronLeftIcon as tc, ChevronRightIcon as ec, ArrowRightIcon as rc, Copy as ei, Filter as ac, User as oc, Link as nc, CircleHelp as ic, Undo as sc, Redo as cc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as lc, AlertCircle as io, CircleCheckIcon as dc, CircleXIcon as wc, CircleHelpIcon as uc, ArrowUpIcon as pc, ArrowDownIcon as hc, ScrollText as gc, ChevronRight as fc, ChevronLeft as mc, ChevronsUpDown as vc, MenuIcon as bc, Menu as xc, EllipsisVertical as yc, MoreVertical as kc } from "lucide-react";
import { Section as Dt, compareScrRefs as fa, getChaptersForBook as _c, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as na, formatRelativeDate as Nc, sanitizeHtml as Oo, NumberFormat as ni, formatBytes as Cc, getCurrentLocale as Ec, usfmMarkers as ia, isPlatformError as Tc, ABORTED as Sc, getErrorMessage as Rc, getFormatCallerFunction as Dc, deepEqual as Mc, isString as an, scrRefToBBBCCCVVV as ja, defaultScrRef as Fa, formatScrRefRange as Oc, getLocalizeKeyForScrollGroupId as on, formatReplacementStringToArray as nn, collectUsjMarkers as Ic } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Fr, useContext as Ta, useState as _, useEffect as W, useCallback as j, useId as so, useImperativeHandle as zc, useLayoutEffect as Jt, Fragment as Ur, Component as Pc, createElement as sn, Suspense as Ac, forwardRef as ii } from "react";
import { IconSelector as si, IconCheck as Sa, IconChevronDown as $c, IconChevronUp as Vc, IconLayoutSidebar as Lc, IconLayoutSidebarRight as Bc, IconChevronRight as ci, IconSearch as jc, IconLoader as Fc, IconAlertOctagon as Uc, IconAlertTriangle as Kc, IconInfoCircle as Hc, IconCircleCheck as qc } from "@tabler/icons-react";
import { createEditor as li, $getRoot as qe, $createParagraphNode as Kr, $getSelection as ae, HISTORY_MERGE_TAG as Io, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Gc, $isRangeSelection as _e, $caretFromPoint as Yc, $getSiblingCaret as ui, $getChildCaret as Wc, $getAdjacentChildCaret as Xc, $isChildCaret as Jc, $normalizeCaret as Zc, $setSelectionFromCaretRange as Qc, $getCollapsedCaretRange as tl, $getCaretInDirection as cn, $splitAtPointCaretNext as el, $isTextPointCaret as rl, $findMatchingParent as pi, $isElementNode as Br, mergeRegister as Oe, getDOMTextNode as al, isHTMLElement as ol, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as zo, shallowMergeConfig as nl, defineExtension as ue, safeCast as or, createState as il, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as sl, LineBreakNode as cl, TabNode as ll, $isEditorState as dl, createCommand as wl, CLICK_COMMAND as ul, isDOMNode as pl, $getNodeFromDOMNode as hl, $createNodeSelection as gl, $setSelection as fl, $getEditor as ml, DecoratorNode as co, $getState as vl, toggleTextFormatType as ln, TEXT_TYPE_TO_FORMAT as bl, $setState as xl, addClassNamesToElement as vi, $create as yl, $getNodeByKey as kl, removeClassNamesFromElement as _l, KEY_TAB_COMMAND as Nl, $isBlockElementNode as Cl, $createRangeSelection as El, $normalizeSelection__EXPERIMENTAL as Tl, OUTDENT_CONTENT_COMMAND as Sl, INDENT_CONTENT_COMMAND as dn, INSERT_TAB_COMMAND as Rl, COMMAND_PRIORITY_CRITICAL as Po, $isDecoratorNode as Dl, $isParagraphNode as Ml, $isTextNode as lo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Ol } from "lexical";
...
import { GENERATOR_NOTE_CALLER as wo, HIDDEN_NOTE_CALLER as uo, getDefaultViewOptions as ql, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as Gl, defaultStyleInfo as Yl, Editorial as Wl } from "@eten-tech-foundation/platform-editor";
...
import { toast as Kf } from "sonner";
...
function ad({
  ...
  W(() => {
    ...
    const N = (q) => !!q && q.scrollWidth > q.clientWidth, rt = () => {
      Un() !== "pointer" && (T || N(h.current) || N(l.current)) && C(!0);
    }, O = () => C(!1);
...
function sd({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = so(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : re(n, nd), P = re(s, id), T = (M) => {
...
function Ka({
  ...
  const T = Ce(), B = rd(), [z, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (m) => {
      ...
      if (!(!!H && !!((Yo = bt.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const $t = bt.current ? md(bt.current) : [];
        if ($t.length === 0) {
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yd = Di ? Jt : W, ea = { tag: Io };
...
function Bd(t) {
  const e = ae() || Gc();
  let r;
  if (_e(e)) r = Yc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || Wc(qe(), "previous").getFlipped().insert(Kr());
  }
...
function jd(t, e, r) {
  ...
  return rl(o) && ma(283), o.insert(t.isInline() ? Kr().append(t) : t), cn(ui(t.getLatest(), "next"), e.direction);
}
function Fd(t) {
  const e = ae();
  if (!_e(e)) return !1;
...
let va, Me = 0, ba = 0, Hd = 0, mo = 0, la = 0;
function yn(t) {
  if (st === void 0) return;
  let e = t.n;
...
Wt.prototype.brand = Ud, Wt.prototype.h = function() {
  return !0;
...
function Ai(t, e = Pi) {
  return t.registerCommand(hi, (r) => (t.update(e), !0), zo);
}
...
const Ga = il("format", { parse: (t) => typeof t == "number" ? t : 0 });
class $i extends co {
  $config() {
...
ue({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ae();
  if (fi(n) || _e(n)) for (const s of n.getNodes()) Wd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const tw = ue({ config: or({ setOptions: _n, updateOptions: _n }), init: ({ $initialEditorState: t = Qd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [sl, wi, cl, ll, di] }), Nn = Symbol.for("@lexical/extension/LexicalBuilder");
function Cn() {
}
function ew(t) {
  throw t;
...
const rw = /* @__PURE__ */ new Set(), En = ue({ build(t, e, r) {
...
}, dependencies: [vo], name: "@lexical/extension/NodeSelection" }), aw = wl("INSERT_HORIZONTAL_RULE_COMMAND");
class mr extends co {
  static getType() {
...
), Fw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), wa = (t) => Fw(Oo(t));
function ua({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Yw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...q })
          },
          I.id
        );
      })
    ...
    /* @__PURE__ */ a(To, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      je,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { className: o, children: Cu(c.text) })
        ]
      },
...
function Ah({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Du(O, D, Y), [O, D, Y]), q = V(() => {
    var vt, pt;
    if (!B) return l;
    ...
    Pu,
    {
      ...
      children: /* @__PURE__ */ u($u, { children: [
        /* @__PURE__ */ u(An, { children: [
          ...
          /* @__PURE__ */ a(Vn, { children: /* @__PURE__ */ a(Vu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Lu, { children: /* @__PURE__ */ a(
            ju,
            {
              onClick: () => d(g),
              isActive: h(g),
...
}, Ln = (t) => `${Wu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jh({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      vr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(yr, { position: "item-aligned", children: /* @__PURE__ */ a(Xw, { children: E.map((D) => /* @__PURE__ */ a(ge, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(fc, {}) : /* @__PURE__ */ a(mc, {})),
                          " ",
...
const ss = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a($s, { children: /* @__PURE__ */ a(Vs, { children: ss(
      t,
      e,
      is(t, c.id),
      o
...
function xo({
  ...
  Fn();
  const l = F(null), d = () => zs(l.current ?? void 0);
  return /* @__PURE__ */ u(Ie, { variant: s, children: [
    ...
    /* @__PURE__ */ a(
      ze,
      {
        ...
        style: { zIndex: Pe },
        onCloseAutoFocus: () => {
          Un() === "pointer" && Ls(l.current ?? void 0);
        },
        children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w], p, h) => /* @__PURE__ */ u(Ur, { children: [
          /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(Ot, { children: ss(e.groups, e.items, w, t) }) }),
...
const np = Object.freeze([520, 420, 340]), ls = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = cs(n, np), d = Ti() ?? l, w = d >= Ar.MINIMUM;
...
const ip = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Trigger,
  {
    ref: r,
    ...e,
...
export {
  ...
  If as Z_INDEX_CONNECTION_LOST,
  zf as Z_INDEX_FIRST_RUN,
  Pf as Z_INDEX_MODAL,
  Af as Z_INDEX_MODAL_BACKDROP,
  $f as Z_INDEX_ONBOARDING_TOUR,
  Vf as Z_INDEX_OVERLAY,
  Lf as badgeVariants,
  Bf as buttonGroupVariants,
