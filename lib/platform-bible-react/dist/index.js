...
function va({ endChapter: e, activeChapter: t, handleSelectChapter: n }) {
  const r = Array.from({ length: e }, (o, i) => i + 1);
  return /* @__PURE__ */ S("div", { className: "chapter-select", children: r.map((o) => (
...
var wo;
function Ei() {
  return wo || (wo = 1, process.env.NODE_ENV === "production" ? yn.exports = wa() : yn.exports = Ta()), yn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Sa() {
  if (Po)
    return sr;
  Po = 1;
  var e = Ei(), t = Oa(), n = $r(), r = wi(), o = ka(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var Ca = Ei(), Ra = !0;
  yr.exports = Sa()(Ca.isElement, Ra);
} else
  yr.exports = Pa()();
var Na = yr.exports;
const s = /* @__PURE__ */ xa(Na);
function jt(e, t) {
...
process.env.NODE_ENV === "production" ? xr.exports = Da() : xr.exports = ja();
var Cn = xr.exports;
...
const Wa = typeof window < "u" ? w.useLayoutEffect : w.useEffect, pt = Wa;
let Mo = 0;
function qa(e) {
...
function $i() {
  ...
  function n() {
    return t.current ? (wr = !0, Ja.start(100, () => {
      wr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
}, dl = /* @__PURE__ */ w.createContext(ul);
function pl(e) {
  const {
...
function Il(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), b = w.useRef(null), v = w.useRef(null), g = Ie(v, f), [m, E] = w.useState(!d), $ = Ml(c);
  let y = !0;
...
var Oe = "top", Ae = "bottom", De = "right", ke = "left", _r = "auto", un = [Oe, Ae, De, ke], Mt = "start", on = "end", Al = "clippingParents", Ui = "viewport", Ht = "popper", Dl = "reference", Lo = /* @__PURE__ */ un.reduce(function(e, t) {
...
function ec(e) {
  ...
  if (!(!i || !a)) {
    var f = Ql(o.padding, n), p = Ar(i), b = c === "y" ? Oe : ke, v = c === "y" ? Ae : De, g = n.rects.reference[d] + n.rects.reference[c] - a[c] - n.rects.popper[d], m = a[c] - n.rects.reference[c], E = dn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, x = f[b], h = $ - p[d] - f[v], k = $ / 2 - p[d] / 2 + y, P = Qt(x, k, h), A = c;
...
function Uo(e, t, n) {
  return t === Ui ? kr(dc(e, n)) : ht(t) ? fc(t, n) : kr(pc(rt(e)));
}
function hc(e) {
...
function sn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, a = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Al : l, u = n.rootBoundary, d = u === void 0 ? Ui : u, f = n.elementContext, p = f === void 0 ? Ht : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = Xi(typeof m != "number" ? m : Ki(m, un)), $ = p === Ht ? Dl : Ht, y = e.rects.popper, x = e.elements[v ? $ : p], h = mc(ht(x) ? x : x.contextElement || rt(e.elements.popper), c, d, a), k = It(e.elements.reference), P = Ji({
    reference: k,
    element: y,
    strategy: "absolute",
    placement: o
...
function vc(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Le(m), $ = E === m, y = c || ($ || !v ? [On(m)] : bc(m)), x = [m].concat(y).reduce(function(F, U) {
    ...
    }, []), h = t.rects.reference, k = t.rects.popper, P = /* @__PURE__ */ new Map(), A = !0, I = x[0], D = 0; D < x.length; D++) {
...
function Cc(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = sn(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Le(t.placement), $ = At(t.placement), y = !$, x = Dr(E), h = Pc(x), k = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, I = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (k) {
    if (i) {
      var G, L = x === "y" ? Oe : ke, _ = x === "y" ? Ae : De, R = x === "y" ? "height" : "width", j = k[x], Q = j + m[L], Z = j - m[_], O = b ? -A[R] / 2 : 0, M = $ === Mt ? P[R] : A[R], V = $ === Mt ? -A[R] : -P[R], X = t.elements.arrow, F = b && X ? Ar(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var Ee, fe = x === "x" ? Oe : ke, it = x === "x" ? Ae : De, we = k[h], Ue = h === "y" ? "height" : "width", Se = we + m[fe], He = we - m[it], ge = [Oe, ke].indexOf(E) !== -1, bt = (Ee = B == null ? void 0 : B[h]) != null ? Ee : 0, st = ge ? Se : we - P[Ue] - A[Ue] - bt + D.altAxis, Lt = ge ? we + P[Ue] + A[Ue] - bt - D.altAxis : He, mn = b && ge ? Zl(st, we, Lt) : Qt(b ? st : Se, we, b ? Lt : He);
      k[h] = mn, z[h] = mn - we;
    }
    t.modifiersData[r] = z;
  }
        ...
        if (!p) {
          ...
          if (Go($, y)) {
            ...
            for (var x = 0; x < d.orderedModifiers.length; x++) {
              ...
              var h = d.orderedModifiers[x], k = h.fn, P = h.options, A = P === void 0 ? {} : P, I = h.name;
...
var Lc = [lc, Sc, sc, Kl, Oc, yc, Rc, nc, Ec], Fc = /* @__PURE__ */ Bc({
  defaultModifiers: Lc
});
const Zi = "Popper";
function Vc(e) {
...
const qc = () => Ye({
  root: ["root"]
}, pl(Vc)), Gc = {}, Xc = /* @__PURE__ */ w.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = ce(t, zc), E = w.useRef(null), $ = Ie(E, n), y = w.useRef(null), x = Ie(y, p), h = w.useRef(x);
  pt(() => {
    h.current = x;
  }, [x]), w.useImperativeHandle(p, () => y.current, []);
  const k = Hc(d, a), [P, A] = w.useState(k), [I, D] = w.useState(Mn(o));
  w.useEffect(() => {
...
const du = je("border", Me), pu = je("borderTop", Me), fu = je("borderRight", Me), hu = je("borderBottom", Me), mu = je("borderLeft", Me), gu = je("borderColor"), bu = je("borderTopColor"), vu = je("borderRightColor"), yu = je("borderBottomColor"), xu = je("borderLeftColor"), Eu = je("outline", Me), wu = je("outlineColor"), qn = (e) => {
...
Wn(du, pu, fu, hu, mu, gu, bu, vu, yu, xu, qn, Eu, wu);
const Gn = (e) => {
...
Wn(Gn, Xn, Kn, Tu, Ou, ku, Su, Pu, Cu, Ru, Nu, $u);
function Rt(e, t) {
  return t === "grey" ? t : e;
}
const Mu = he({
...
function Hr(e = {}, ...t) {
  ...
  return u.applyStyles = Wu, u = t.reduce((d, f) => qe(d, f), u), u.unstable_sxConfig = T({}, zr, a == null ? void 0 : a.unstable_sxConfig), u.unstable_sx = function(f) {
    return Ur({
      sx: f,
      theme: this
    });
...
function nd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ...
    let E = kn;
    u === "Root" || u === "root" ? E = r : u ? E = o : Qu(a) && (E = void 0);
    const $ = la(a, T({
      shouldForwardProp: E,
      label: m
...
const ud = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Tt = vd, yd = ["mode", "contrastThreshold", "tonalOffset"], Qo = {
...
function Sd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ce(e, yd), i = e.primary || xd(t), a = e.secondary || Ed(t), l = e.error || wd(t), c = e.info || Td(t), u = e.success || Od(t), d = e.warning || kd(t);
  function f(g) {
...
const Hd = Ud(), qr = Hd, Gr = "$$material", is = (e) => kn(e) && e !== "classes", Wd = nd({
  themeId: Gr,
  defaultTheme: qr,
...
const Yd = {
  ...
  } = t, E = ce(t, Kd), $ = Kt(), y = w.useRef(), x = hn(), h = w.useRef(null), k = Ie(h, i.ref, n), P = (_) => (R) => {
    if (_) {
      const j = h.current;
      R === void 0 ? _(j) : _(j, R);
    }
...
const Rr = Xr, Jd = (e) => {
...
}, ii = Jd, Zd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qd = xe(Qi, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = rs(), i = Je({
    ...
    slots: y,
    slotProps: x
  } = i, h = ce(i, Zd), k = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = T({
    anchorEl: a,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const ds = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  const k = Je({
    ...
    TransitionProps: J
  } = k, C = ce(k, np), re = /* @__PURE__ */ w.isValidElement(A) ? A : /* @__PURE__ */ S("span", {
    children: A
...
`));
  const Vs = w.useMemo(() => {
    ...
    touch: Se.current
  }), tr = op(Ut), po = (r = (o = Y.popper) != null ? o : I.Popper) != null ? r : ip, fo = (i = (a = (l = Y.transition) != null ? l : I.Transition) != null ? a : N) != null ? i : Rr, ho = (c = (u = Y.tooltip) != null ? u : I.Tooltip) != null ? c : sp, mo = (d = (f = Y.arrow) != null ? f : I.Arrow) != null ? d : ap, zs = Yt(po, T({}, H, (p = K.popper) != null ? p : D.popper, {
  ...
  return /* @__PURE__ */ ye(w.Fragment, {
    children: [/* @__PURE__ */ w.cloneElement(re, $e), /* @__PURE__ */ S(po, T({
      as: q ?? us,
      placement: W,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ye(ho, T({}, Hs, {
          children: [ne, P ? /* @__PURE__ */ S(mo, T({}, Ws, {
            ref: Ue
          })) : null]
        }))
      }))
...
const dp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], pp = (e) => {
  ...
  const r = Je({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, dp), v = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", g = T({}, r, {
    color: a,
    component: l,
    fontSize: c,
...
`)), ji.configure(e);
  ...
  useForkRef: Ie,
  useIsFocusVisible: $i
}, Symbol.toStringTag, { value: "Module" })), gp = /* @__PURE__ */ Ea(mp);
var li;
function bp() {
...
var hs = Kr.default = void 0, yp = vp(bp()), xp = qs;
hs = Kr.default = (0, yp.default)(/* @__PURE__ */ (0, xp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function ci(e, t, n) {
  ...
  const {
    ...
    Js,
    {
      ...
      children: n ? /* @__PURE__ */ ye(jn, { children: [
        ...
        f ? /* @__PURE__ */ S(vi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ S(hs, {}) }) : ci(a, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ S(lp, { title: r, placement: "right", children: /* @__PURE__ */ S("div", { children: E }) }) : E;
}
function gs(e) {
...
const wp = (e, t) => t.filter((o) => o.group === e).sort((o, i) => (o.order || 0) - (i.order || 0));
function Jr(e) {
...
const Cp = ["children", "className", "component", "dense", "disablePadding", "subheader"], Rp = (e) => {
  ...
  return /* @__PURE__ */ S(Sp.Provider, {
    value: f,
    children: /* @__PURE__ */ ye(Np, T({
      as: a,
...
const xs = /* @__PURE__ */ w.forwardRef(function(t, n) {
  ...
  } = t, p = ce(t, Mp), b = w.useRef(null), v = w.useRef({
    keys: [],
    repeating: !0,
  ...
  const g = (y) => {
    ...
    if (h === "ArrowDown")
      ...
      const D = k && !P.repeating && ys(k, P);
      P.previousKeyMatched && (D || Gt(x, k, !1, c, fr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, m = Ie(b, n);
  let E = -1;
...
const _p = xs, Ip = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ap = {
  ...
  } = t, y = ce(t, Ip), x = w.useRef(null), h = Ie(x, l.ref, n), k = (L) => (_) => {
    if (L) {
      const R = x.current;
      _ === void 0 ? L(R) : L(R, _);
    }
...
const Bp = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Lp = (e) => {
  ...
  const a = Je({
    ...
    component: u,
    invisible: p
  }), x = Lp(y), h = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ S(m, T({
    in: b,
    timeout: E
  }, $, {
    children: /* @__PURE__ */ S(Fp, T({
      "aria-hidden": !0
    }, h, {
...
const Up = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Hp = (e) => {
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Wp, H = (i = (a = L == null ? void 0 : L.backdrop) != null ? a : E.Backdrop) != null ? i : d, K = (l = G == null ? void 0 : G.root) != null ? l : $.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : $.backdrop, ne = ft({
    elementType: q,
    externalSlotProps: K,
  ...
  return !D && !z && (!X || V) ? null : /* @__PURE__ */ S(rn, {
    ...
    children: /* @__PURE__ */ ye(q, T({}, ne, {
      children: [!I && d ? /* @__PURE__ */ S(H, T({}, N)) : null, /* @__PURE__ */ S(Nn, {
        disableEnforceFocus: x,
        disableAutoFocus: y,
        disableRestoreFocus: P,
        isEnabled: M,
...
const rf = (e) => {
  ...
  } = a, D = ce(a.TransitionProps, ef), B = ce(a, tf), z = (r = x == null ? void 0 : x.paper) != null ? r : $, G = w.useRef(), L = Ie(G, z.ref), _ = T({}, a, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
...
`)), m !== null && fe < m) {
  ...
  const W = v || (c ? ve(Pn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : of, H = (i = y == null ? void 0 : y.paper) != null ? i : ks, K = ft({
    elementType: H,
  ...
  return /* @__PURE__ */ S(q, T({}, N, !Li(q) && {
    slotProps: ne,
    disableScrollLock: I
  }, {
    children: /* @__PURE__ */ S(k, T({
      appear: !0,
      in: E,
      onEntering: X,
      onExited: F,
...
const lf = ["onEntering"], cf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], uf = {
  ...
  const i = Je({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, x = ce(i.TransitionProps, lf), h = ce(i, cf), k = hn(), P = k.direction === "rtl", A = T({}, i, {
    autoFocus: a,
    ...
    TransitionProps: x,
    variant: E
  }), I = pf(A), D = a && !u && p, B = w.useRef(null), z = (Z, O) => {
...
function yf({
  ...
  Bn(() => {
    if (c) {
      ...
      if (x) {
        const h = x.getBoundingClientRect(), k = window.scrollY, P = window.scrollX, A = h.top + k + x.clientHeight, I = h.left + P;
        m({ top: A, left: I });
      }
    }
  }, [c, o]);
...
var xf = Object.defineProperty, Ef = (e, t, n) => t in e ? xf(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => (Ef(e, typeof t != "symbol" ? t + "" : t, n), n);
const gt = [
  "GEN",
  "EXO",
  "LEV",
...
function Xf({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = ut(""), i = (a) => {
    o(a), e(a);
  };
