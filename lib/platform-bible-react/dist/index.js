import rc, { jsx as p, jsxs as $, Fragment as mt } from "react/jsx-runtime";
...
), lt = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(Ai.Root, { ref: r, className: M("pr-twp", _p(), e), ...t }));
...
const Ap = et.Portal, ts = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  et.Overlay,
  {
    ref: r,
    className: M(
...
function Jp({
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ $(Rn, { stickyHeader: a, children: [
      /* @__PURE__ */ p(Pn, { stickyHeader: a, children: f.getHeaderGroups().map((w) => /* @__PURE__ */ p(Et, { children: w.headers.map((O) => /* @__PURE__ */ p(Dr, { children: O.isPlaceholder ? void 0 : Sr(O.column.columnDef.header, O.getContext()) }, O.id)) }, w.id)) }),
      /* @__PURE__ */ p($n, { children: (g = f.getRowModel().rows) != null && g.length ? f.getRowModel().rows.map((w) => /* @__PURE__ */ p(
        ...
        w.id
      )) : /* @__PURE__ */ p(Et, { children: /* @__PURE__ */ p(tr, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }),
...
function Qp({
  ...
  return Qe(
    ...
    /* @__PURE__ */ p(Pn, { stickyHeader: !0, children: /* @__PURE__ */ $(Et, { children: [
...
function a0({
  ...
  const b = vt(r, "%webView_inventory_all%"), d = vt(r, "%webView_inventory_approved%"), h = vt(r, "%webView_inventory_unapproved%"), f = vt(r, "%webView_inventory_unknown%"), g = vt(r, "%webView_platformScripture_currentBook%"), w = vt(r, "%webView_inventory_scope_chapter%"), O = vt(r, "%webView_inventory_scope_verse%"), x = vt(r, "%webView_inventory_filter_text%"), [k, y] = he([]), [T, S] = he("all"), [I, R] = he(""), [_, N] = he(""), A = Ce(
    (F, C) => {
      y((Y) => {
        let H = [];
        return F.forEach((K) => {
...
const xt = "scrBook", ad = "scrRef", Pt = "source", id = "details", sd = "Scripture Reference", ld = "Scripture Book", hs = "Type", cd = "Details";
function pd(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      cell: (n) => {
        ...
        return n.row.getIsGrouped() ? fe.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === xt ? qn(o.start) : void 0;
      },
...
function p0({
  ...
  const [u, m] = he([]), [v, b] = he([{ id: xt, desc: !1 }]), [d, h] = he({}), f = pt(
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    ...
    /* @__PURE__ */ $(Rn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ p(Pn, { children: w.getHeaderGroups().map((R) => /* @__PURE__ */ p(Et, { children: R.headers.filter((_) => _.column.columnDef.header).map((_) => (
...
function g0({
  listItems: e,
  selectedListItems: t,
  handleSelectListItem: r,
  createLabel: n
}) {
  return /* @__PURE__ */ p(mt, { children: e.map((o) => /* @__PURE__ */ $("div", { className: "pr-m-2 pr-flex pr-items-center", children: [
    /* @__PURE__ */ p(
      bs,
      {
        className: "pr-mr-2 pr-align-middle",
        checked: t.includes(o),
        onCheckedChange: (a) => r(o, a)
      },
      o
    ),
    /* @__PURE__ */ p(lt, { children: n ? n(o) : o })
  ] })) });
}
function ud(e) {
...
function wh(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, u = r.padding, m = r.boundary, v = r.rootBoundary, b = r.altBoundary, d = r.flipVariations, h = d === void 0 ? !0 : d, f = r.allowedAutoPlacements, g = t.options.placement, w = Ze(g), O = w === g, x = c || (O || !h ? [dn(g)] : yh(g)), k = [g].concat(x).reduce(function(H, K) {
      ...
      var N = k[_], A = Ze(N), B = sr(N) === or, z = [Me, Xe].indexOf(A) >= 0, G = z ? "width" : "height", j = Fr(t, {
        placement: N,
        boundary: m,
        rootBoundary: v,
        altBoundary: b,
...
function Ph(e) {
  ...
  if (T) {
    ...
    if (l) {
      var $e, ke = k === "x" ? Me : Ae, Ct = k === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", je = _e + g[ke], at = _e - g[Ct], Se = [Me, Ae].indexOf(w) !== -1, zt = ($e = N == null ? void 0 : N[y]) != null ? $e : 0, Ot = Se ? je : _e - S[ot] - I[ot] - zt + _.altAxis, pr = Se ? _e + S[ot] + I[ot] - zt - _.altAxis : at, Zr = d && Se ? eh(Ot, _e, pr) : Pr(d ? Ot : je, _e, d ? pr : at);
      T[y] = Zr, A[y] = Zr - _e;
    }
    t.modifiersData[n] = A;
  }
...
var Qh = function(t) {
  return t.scrollTop;
}, Tr = "unmounted", $t = "exited", _t = "entering", Jt = "entered", Ro = "exiting", bt = /* @__PURE__ */ function(e) {
  Jh(t, e);
  function t(n, o) {
    var a;
...
const ig = Nt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), kt = ig, sg = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function lg(e) {
  return Math.round(e * 1e5) / 1e5;
}
const cg = (e) => {
  ...
  [`&[data-popper-placement*="right"] .${kt.arrow}`]: P({}, t.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${kt.arrow}`]: P({}, t.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${kt.popper}[data-popper-placement*="left"] &`]: P({
  ...
  [`.${kt.popper}[data-popper-placement*="right"] &`]: P({
  ...
  [`.${kt.popper}[data-popper-placement*="top"] &`]: P({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, t.touch && {
    marginBottom: "24px"
  }),
  [`.${kt.popper}[data-popper-placement*="bottom"] &`]: P({
...
const dl = /* @__PURE__ */ E.forwardRef(function(t, r) {
  ...
  const T = gt({
    ...
    children: I
  }), Te = Kr(), $e = Te.direction === "rtl", [ke, Ct] = E.useState(), [_e, ot] = E.useState(null), je = E.useRef(!1), at = z || F, Se = Er(), zt = Er(), Ot = Er(), pr = Er(), [Zr, pa] = Os({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  N ? (ur.title = !it && Xn && !B ? ie : null, ur["aria-describedby"] = it ? Hn : null) : (ur["aria-label"] = Xn ? ie : null, ur["aria-labelledby"] = it && !Xn ? Hn : null);
...
`));
  ...
  const fr = {};
  G || (Ue.onTouchStart = Xl, Ue.onTouchEnd = Yl), B || (Ue.onMouseOver = sn(va, Ue.onMouseOver), Ue.onMouseLeave = sn(ya, Ue.onMouseLeave), at || (fr.onMouseOver = va, fr.onMouseLeave = ya)), A || (Ue.onFocus = sn(ga, Ue.onFocus), Ue.onBlur = sn(ha, Ue.onBlur), at || (fr.onFocus = ga, fr.onBlur = ha)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Jl = E.useMemo(() => {
    var ne;
    let Le = [{
...
function ul(e) {
  const {
    ...
    zc,
    {
      ...
      onClick: t,
      id: f,
      children: r ? /* @__PURE__ */ $(mt, { children: [
        xi(a, r, !0),
...
`));
    ...
    const Ct = $e + D.height, _e = ke + D.width, ot = nr(un(c)), je = ot.innerHeight - g, at = ot.innerWidth - g;
    if (g !== null && $e < g) {
      const Se = $e - g;
      $e -= Se, se.vertical += Se;
...
const bb = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ p(
    ...
    {
      ref: r,
      className: M("pr-twp pr-flex pr-flex-col pr-space-y-1.5 pr-p-6", e),
      ...t
    }
  )
);
...
const yb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p("p", { ref: r, className: M("pr-twp pr-text-sm pr-text-muted-foreground", e), ...t }));
yb.displayName = "CardDescription";
const wb = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ p("div", { ref: r, className: M("pr-twp pr-p-6 pr-pt-0", e), ...t })
);
...
const xb = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ p(
    ...
    {
      ref: r,
      className: M("pr-twp pr-flex pr-items-center pr-p-6 pr-pt-0", e),
      ...t
    }
  )
);
...
function S0({
  ...
  return /* @__PURE__ */ p(
    Ne,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ p(Jr, { size: 15 }) : /* @__PURE__ */ $(mt, { children: [
...
function C0({
  ...
  return /* @__PURE__ */ p(
    Ne,
    {
      ...
      onClick: t,
      ...n,
      children: e ? /* @__PURE__ */ $(mt, { children: [
...
`, { _: h }));
  ...
  const i = [], l = {}, c = { blockQuote: { t: st(Tl), i: ae.HIGH, l: (d, h, f) => ({ v: h(d[0].replace(_b, ""), f) }), h: (d, h, f) => n("blockquote", { key: f.k }, h(d.v, f)) }, breakLine: { t: xr(Ib), i: ae.HIGH, l: fo, h: (d, h, f) => n("br", { key: f.k }) }, breakThematic: { t: st(Mb), i: ae.HIGH, l: fo, h: (d, h, f) => n("hr", { key: f.k }) }, codeBlock: { t: st(Cl), i: ae.MAX, l: (d) => ({ v: d[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (d, h, f) => n("pre", { key: f.k }, n("code", Mt({}, d.O, { className: d.M ? `lang-${d.M}` : "" }), d.v)) }, codeFenced: { t: st(Sl), i: ae.MAX, l: (d) => ({ O: a(d[3] || ""), v: d[4], M: d[2] || void 0, type: "codeBlock" }) }, codeInline: { t: wt(Ab), i: ae.LOW, l: (d) => ({ v: d[2] }), h: (d, h, f) => n("code", { key: f.k }, d.v) }, footnote: { t: st(jb), i: ae.MAX, l: (d) => (i.push({ I: d[2], j: d[1] }), {}), h: mo }, footnoteReference: { t: yt(Lb), i: ae.HIGH, l: (d) => ({ v: d[1], B: `#${t.slugify(d[1])}` }), h: (d, h, f) => n("a", { key: f.k, href: qt(d.B) }, n("sup", { key: f.k }, d.v)) }, gfmTask: { t: yt(Fb), i: ae.HIGH, l: (d) => ({ R: d[1].toLowerCase() === "x" }), h: (d, h, f) => n("input", { checked: d.R, key: f.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? Rl : Ol), i: ae.HIGH, l: (d, h, f) => ({ v: fn(h, d[2], f), T: t.slugify(d[2]), C: d[1].length }), h: (d, h, f) => n(`h${d.C}`, { id: d.T, key: f.k }, h(d.v, f)) }, headingSetext: { t: st(Pl), i: ae.MAX, l: (d, h, f) => ({ v: fn(h, d[1], f), C: d[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: xr($l), i: ae.HIGH, l: () => ({}), h: mo }, image: { t: wt(wv), i: ae.HIGH, l: (d) => ({ D: d[1], B: _i(d[2]), F: d[3] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D || void 0, title: d.F || void 0, src: qt(d.B) }) }, link: { t: yt(yv), i: ae.LOW, l: (d, h, f) => ({ v: Sv(h, d[1], f), B: _i(d[2]), F: d[3] }), h: (d, h, f) => n("a", { key: f.k, href: qt(d.B), title: d.F }, h(d.v, f)) }, linkAngleBraceStyleDetector: { t: yt(Xb), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], type: "link" }) }, linkBareUrlDetector: { t: (d, h) => h.N ? null : yt(Gb)(d, h), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: yt(Wb), i: ae.MAX, l(d) {
    let h = d[1], f = d[1];
...
` }, paragraph: { t: Tv, i: ae.LOW, l: uo, h: (d, h, f) => n("p", { key: f.k }, h(d.v, f)) }, ref: { t: yt(qb), i: ae.MAX, l: (d) => (l[d[1]] = { B: d[2], F: d[4] }, {}), h: mo }, refImage: { t: wt(Kb), i: ae.MAX, l: (d) => ({ D: d[1] || void 0, P: d[2] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D, src: qt(l[d.P].B), title: l[d.P].F }) }, refLink: { t: yt(Jb), i: ae.MAX, l: (d, h, f) => ({ v: h(d[1], f), Z: h(d[0].replace(Zb, "\\$1"), f), P: d[2] }), h: (d, h, f) => l[d.P] ? n("a", { key: f.k, href: qt(l[d.P].B), title: l[d.P].F }, h(d.v, f)) : n("span", { key: f.k }, h(d.Z, f)) }, table: { t: st(_l), i: ae.HIGH, l: Nv, h: (d, h, f) => n("table", { key: f.k }, n("thead", null, n("tr", null, d.L.map(function(g, w) {
  ...
  }, h: () => " | " }, text: { t: xr(uv), i: ae.MIN, l: (d) => ({ v: d[0].replace(zb, (h, f) => t.namedCodesToUnicode[f] ? t.namedCodesToUnicode[f] : h) }), h: (d) => d.v }, textBolded: { t: wt(sv), i: ae.MED, l: (d, h, f) => ({ v: h(d[2], f) }), h: (d, h, f) => n("strong", { key: f.k }, h(d.v, f)) }, textEmphasized: { t: wt(lv), i: ae.LOW, l: (d, h, f) => ({ v: h(d[2], f) }), h: (d, h, f) => n("em", { key: f.k }, h(d.v, f)) }, textEscaped: { t: wt(dv), i: ae.HIGH, l: (d) => ({ v: d[1], type: "text" }) }, textMarked: { t: wt(cv), i: ae.LOW, l: uo, h: (d, h, f) => n("mark", { key: f.k }, h(d.v, f)) }, textStrikethroughed: { t: wt(pv), i: ae.LOW, l: uo, h: (d, h, f) => n("del", { key: f.k }, h(d.v, f)) } };
