...
import p, { forwardRef as Ht, createContext as Un, useContext as qn, useCallback as tt, useState as P, useRef as K, useEffect as wt, useLayoutEffect as Xe, useMemo as W, Fragment as Jn } from "react";
import { clsx as Kn } from "clsx";
import { extendTailwindMerge as Wn } from "tailwind-merge";
import { cva as lt } from "class-variance-authority";
import * as V from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Zn } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as be, Check as Ct, Circle as ve, X as xe, Search as Ue, ChevronsUpDown as qe, FilterIcon as Qn, ChevronDown as Ut, ChevronUp as tr, ArrowLeftIcon as er, ChevronLeftIcon as nr, ChevronRightIcon as rr, ArrowRightIcon as ar, LoaderCircle as or, Download as sr, Filter as ir, User as wr, Link as lr, CircleHelp as dr, Star as cr, CircleCheckIcon as pr, CircleXIcon as ur, CircleHelpIcon as mr, ArrowUpIcon as hr, ArrowDownIcon as gr, ArrowUpDownIcon as fr, PanelLeft as br, PanelRight as vr, ScrollText as xr, ChevronLeft as yr, MenuIcon as Nr, Menu as kr, EllipsisVertical as Cr } from "lucide-react";
import { formatScrRef as ht, getChaptersForBook as Sr, NumberFormat as Rr, formatBytes as Tr, deepEqual as ye, isString as ae, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
import { useReactTable as Ke, getFilteredRowModel as _r, getSortedRowModel as We, getPaginationRowModel as zr, getCoreRowModel as Ze, flexRender as Mt, getGroupedRowModel as Er, getExpandedRowModel as Dr } from "@tanstack/react-table";
import * as X from "@radix-ui/react-select";
import * as Qe from "@radix-ui/react-separator";
import Ir from "markdown-to-jsx";
...
const Br = Wn({ prefix: "tw-" });
function d(...t) {
  return Br(Kn(t));
}
const Tt = p.forwardRef(
...
const ke = V.Trigger, en = V.Group, Pr = V.Portal, jr = V.Sub, es = V.RadioGroup;
...
const nn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ l(
    V.SubTrigger,
    {
...
nn.displayName = V.SubTrigger.displayName;
...
rn.displayName = V.SubContent.displayName;
const jt = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = F();
...
const an = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ l(
    V.RadioItem,
    {
...
const Kt = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  V.Label,
  {
    ref: a,
...
Xt.displayName = V.Separator.displayName;
...
var Fr = Object.defineProperty, Gr = (t, e, n) => e in t ? Fr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => Gr(t, typeof e != "symbol" ? e + "" : e, n);
const gt = [
  "GEN",
  "EXO",
  "LEV",
...
const Y = class z {
    ...
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof z) {
          ...
          if (e == null) return;
          const s = e instanceof ut ? e : z.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new ut(i)), n ? new z(n, a.toString(), w, c) : new z();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new ut(nt[i]);
        } catch {
  ...
  allVerses(e = !1, n = z.verseRangeSeparators, a = z.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = Ge(this._verse, a);
    for (const i of s.map((w) => Ge(w, n))) {
      const w = this.clone();
      w.verse = i[0];
      const c = w.verseNum;
...
R(Y, "defaultVersification", ut.English), R(Y, "verseRangeSeparator", "-"), R(Y, "verseSequenceIndicator", ","), R(Y, "verseRangeSeparators", [Y.verseRangeSeparator]), R(Y, "verseSequenceIndicators", [Y.verseSequenceIndicator]), R(Y, "chapterDigitShifter", 1e3), R(Y, "bookDigitShifter", Y.chapterDigitShifter * Y.chapterDigitShifter), R(Y, "bcvMaxValue", Y.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
R(Y, "ValidStatusType", cn);
...
const ze = j.allBookIds.filter((t) => !j.isObsolete(j.bookIdToNumber(t))), ea = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], na = 96, ra = [
...
], Et = (t) => Sr(j.bookIdToNumber(t));
function aa() {
  return ze.map((e) => j.bookIdToEnglishName(e));
}
function oa(t) {
...
function sa(t) {
  ...
  if (oa(e))
    return ze.find((a) => j.bookIdToEnglishName(a) === e);
}
function rs({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = F(), [s, i] = P(""), [w, c] = P(t.book), [u, g] = P(t.chapterNum ?? 0), [b, h] = P(t.book), [m, f] = P(!1), [k, C] = P(m), y = K(void 0), x = K(void 0), E = K(void 0), $ = tt(
    (S) => {
      const D = a ? a() : ze;
      return {
        OT: D.filter((O) => j.isBookOT(O)),
        NT: D.filter((O) => j.isBookNT(O)),
        DC: D.filter((O) => j.isBookDC(O))
      }[S].filter((O) => {
        const v = j.bookIdToEnglishName(O).toLowerCase(), _ = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return v.includes(_) || // Match book name
        O.toLowerCase().includes(_);
      });
    },
    [s, a]
    ...
    ra.forEach((S) => {
      const D = S.exec(s);
      if (D) {
        const [O, v = void 0, _ = void 0] = D.slice(1), Z = sa(O);
        (j.isBookIdValid(O) || Z) && N(
          Z ?? O,
          !0,
          v ? parseInt(v, 10) : 1,
          _ ? parseInt(_, 10) : 1
  ...
  return wt(() => {
    w === b ? w === t.book ? g(t.chapterNum) : g(1) : g(0);
  }, [b, t.book, t.chapterNum, w]), Xe(() => {
    C(m);
  }, [m]), Xe(() => {
    const S = setTimeout(() => {
  ...
  }, [k, s]), /* @__PURE__ */ l(Jt, { modal: !1, open: m, onOpenChange: ct, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          c(t.book), h(t.book), g(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), i(ht(t, "English")), y.current.focus();
        },
        onFocus: () => {
          dt.current = !0;
        },
      ...
      jt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((S, D) => {
          ...
          return O.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(Kt, { className: "tw-font-semibold tw-text-foreground/80", children: ea[S] }),
            O.map((v) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Qr,
              {
                bookId: v,
                handleSelectBook: () => N(v, !1),
                isSelected: w === v,
                handleHighlightBook: () => h(v),
                handleKeyDown: re,
                bookType: S,
                ref: (_) => {
                  w === v && (E.current = _);
            ...
            $e.length - 1 !== D ? /* @__PURE__ */ r(Xt, {}) : void 0
          ] }, S);
        }) })
      }
    )
...
const ia = lt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? St : "button", { className: d(ia({ variant: e, size: n, className: t })), ref: s, ...o })
);
M.displayName = "Button";
const wa = lt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Je.Root, { ref: n, className: d("pr-twp", wa(), t), ...e }));
G.displayName = Je.Root.displayName;
const pn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    Vt.Root,
    {
...
pn.displayName = Vt.Root.displayName;
...
const un = Bt.Root, mn = Bt.Trigger, Ee = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
const la = rt.Portal, hn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: d(
...
hn.displayName = rt.Overlay.displayName;
...
da.displayName = rt.Content.displayName;
...
ca.displayName = rt.Title.displayName;
...
pa.displayName = rt.Description.displayName;
...
const Ie = p.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(Ue, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      H.Input,
      {
        ref: n,
...
const Ve = p.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
gn.displayName = H.Group.displayName;
...
function me({
  ...
  const [C, y] = P(!1);
  return /* @__PURE__ */ l(un, { open: C, onOpenChange: y, ...k, children: [
    /* @__PURE__ */ r(mn, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: h,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Ee,
      {
        ...
        children: /* @__PURE__ */ l(De, { children: [
          ...
          /* @__PURE__ */ r(Me, { children: e.map((x) => /* @__PURE__ */ l(
            Be,
            {
              value: w(x),
              onSelect: () => {
...
function os({
  ...
  const g = se(u, "%webView_bookSelector_currentBook%"), b = se(u, "%webView_bookSelector_choose%"), h = se(u, "%webView_bookSelector_chooseBooks%"), [m, f] = P(
    "current book"
    /* CURRENT_BOOK */
  ), k = (C) => {
    f(C), t(C);
    ...
    pn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(G, { className: "tw-flex tw-items-center", children: a.map((C) => j.bookIdToEnglishName(C)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
function fa({ table: t }) {
  return /* @__PURE__ */ l(Jt, { children: [
    /* @__PURE__ */ r(Zn, { asChild: !0, children: /* @__PURE__ */ l(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Qn, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ l(jt, { align: "end", className: "tw-w-[150px]", children: [
...
const yt = X.Root, ba = X.Group, Nt = X.Value, va = lt(
...
), ft = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = F();
  return /* @__PURE__ */ l(
    X.Trigger,
    {
      className: d(va({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
fn.displayName = X.ScrollUpButton.displayName;
...
bn.displayName = X.ScrollDownButton.displayName;
...
xa.displayName = X.Label.displayName;
const Q = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  X.Item,
  {
    ref: a,
    className: d(
...
Q.displayName = X.Item.displayName;
...
ya.displayName = X.Separator.displayName;
function Na({ table: t }) {
      ...
      /* @__PURE__ */ l(
        yt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(bt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Q, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function At(t) {
  return Array.from(t.querySelectorAll(ka)).filter(
    (e) => !e.hasAttribute("disabled") && !e.getAttribute("aria-hidden") && Ca(e)
  );
}
const Ft = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
...
const Wt = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: d(
...
const Gt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? At(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
...
const at = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a, ...o }, s) => {
...
function _a({
  ...
  var C;
  const [w, c] = P([]), [u, g] = P([]), [b, h] = P({}), [m, f] = P({}), k = Ke({
    data: e,
    columns: t,
    getCoreRowModel: Ze(),
    ...n && { getPaginationRowModel: zr() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(fa, { table: k }),
    /* @__PURE__ */ l(Ft, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Wt, { stickyHeader: s, children: k.getHeaderGroups().map((y) => /* @__PURE__ */ r(at, { children: y.headers.map((x) => /* @__PURE__ */ r(Ot, { children: x.isPlaceholder ? void 0 : Mt(x.column.columnDef.header, x.getContext()) }, x.id)) }, y.id)) }),
      /* @__PURE__ */ r(Gt, { children: (C = k.getRowModel().rows) != null && C.length ? k.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        at,
        {
          ...
          children: y.getVisibleCells().map((x) => /* @__PURE__ */ r(vt, { children: Mt(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        y.id
      )) : /* @__PURE__ */ r(at, { children: /* @__PURE__ */ r(vt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(Na, { table: k })
  ] });
}
const Zt = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Qe.Root,
  {
    ref: o,
    decorative: n,
...
Zt.displayName = Qe.Root.displayName;
function ss({
  dictionaryEntry: t,
  backToListButton: e,
  definitionLabel: n,
  ...
  return /* @__PURE__ */ l("div", { className: "tw-p-4", children: [
    /* @__PURE__ */ r("div", { className: "tw-mb-4 tw-flex tw-items-center tw-justify-between", children: e }),
    /* @__PURE__ */ l("div", { className: "tw-mb-4", children: [
      /* @__PURE__ */ l("div", { className: "tw-flex tw-items-baseline tw-gap-2", children: [
        ...
        /* @__PURE__ */ r("span", { className: "tw-ml-auto tw-rounded tw-bg-accent tw-px-2 tw-py-0.5 tw-text-sm tw-accent-foreground", children: t.strongsNumber })
      ] }),
      /* @__PURE__ */ r("div", { className: "tw-text-sm tw-italic tw-text-muted-foreground", children: t.partOfSpeech })
    ] }),
    /* @__PURE__ */ r(Zt, { className: "tw-my-3" }),
    /* @__PURE__ */ l("div", { className: "tw-mb-4", children: [
    ...
    /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r("ul", { className: "tw-list-inside tw-list-disc", children: t.usage.map((o) => /* @__PURE__ */ r(
        "li",
        {
          className: "tw-py-0.5 tw-text-sm",
          children: ht(o, "English")
        },
        `${t.id}-${ht(o, "English")}`
      )) })
    ] })
...
function vn({ dictionaryEntry: t, handleEntryClick: e }) {
  return /* @__PURE__ */ r(
    at,
    {
      onClick: () => e(t),
      ...
      children: /* @__PURE__ */ l(vt, { colSpan: 100, className: "tw-p-2", children: [
        /* @__PURE__ */ l("div", { className: "tw-flex tw-items-baseline tw-gap-2", children: [
          ...
          /* @__PURE__ */ r("span", { className: "tw-rounded tw-bg-accent tw-px-1.5 tw-py-0.5 tw-text-xs", children: t.strongsNumber })
        ] }),
...
vn.displayName = "DictionaryListItem";
function is({ dictionaryData: t, handleEntryClick: e }) {
  return /* @__PURE__ */ r(Ft, { stickyHeader: !0, children: /* @__PURE__ */ r(Gt, { children: t.map((n) => /* @__PURE__ */ r(
    vn,
    {
      dictionaryEntry: n,
      handleEntryClick: e
...
const $t = Ht(({ className: t, ...e }, n) => /* @__PURE__ */ r(or, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function ws({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ l(kt, { children: [
        /* @__PURE__ */ r(sr, { size: 25, className: d("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function ls({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: d(
      ...
      onClick: e,
      ...a,
      children: t ? /* @__PURE__ */ l(kt, { children: [
...
function cs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: d(
...
function ps({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = W(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Ir, { options: o, children: e }) });
}
const za = Ht((t, e) => /* @__PURE__ */ l(
  M,
  {
    ref: e,
...
function us({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Jt, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(za, {}) }),
    /* @__PURE__ */ r(jt, { children: e.map((n) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(Kt, { children: n.label }),
      /* @__PURE__ */ r(en, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Se, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(an, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Xt, {})
    ] }, n.label)) })
  ] }) });
}
function ms({ id: t, message: e }) {
...
function hs({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new Rr("en", {
    notation: "compact",
...
function Da({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const c = new Date(w), u = new Date(o.getTime() - c.getTime()), g = u.getUTCFullYear() - 1970, b = u.getUTCMonth(), h = u.getUTCDate() - 1;
    let m = "";
    return g > 0 ? m = `${g.toString()} year${g === 1 ? "" : "s"} ago` : b > 0 ? m = `${b.toString()} month${b === 1 ? "" : "s"} ago` : h === 0 ? m = "today" : m = `${h.toString()} day${h === 1 ? "" : "s"} ago`, m;
  }
...
const Ia = lt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", Ia({ variant: e }), t), ...n })
);
...
function Ma({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(un, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(mn, { asChild: !0, children: /* @__PURE__ */ l(
      M,
      {
        variant: "ghost",
          ...
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              "div",
              {
                ...
                children: /* @__PURE__ */ r("div", { className: "tw-font-normal", children: f() })
              }
            )
          ] }),
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(De, { children: [
      /* @__PURE__ */ r(Ie, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(Me, { children: [
        /* @__PURE__ */ r(Ve, { children: s }),
        /* @__PURE__ */ r(gn, { children: k.map((C) => {
          const y = e ? e(C) : void 0;
          return /* @__PURE__ */ l(
            Be,
            {
              value: C.label,
...
function fs({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((h) => {
      var m;
      return /* @__PURE__ */ l(xn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          M,
          {
            variant: "ghost",
            ...
            onClick: () => a(n.filter((f) => f !== h)),
            children: /* @__PURE__ */ r(xe, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (m = t.find((f) => f.value === h)) == null ? void 0 : m.label
      ] }, h);
...
function Va({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = W(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((c) => ye(c, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ l(Ft, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Wt, { stickyHeader: !0, children: /* @__PURE__ */ l(at, { children: [
      /* @__PURE__ */ r(Ot, { children: a }),
      /* @__PURE__ */ r(Ot, { children: o })
    ] }) }),
    /* @__PURE__ */ r(Gt, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      at,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ r(vt, { children: `${j.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(vt, { children: i.text })
        ]
      },
...
), Ba = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  tn.Root,
  {
    ref: o,
    className: d(yn({ variant: e, size: n, className: t })),
    ...a
  }
));
Ba.displayName = tn.Root.displayName;
const Nn = p.createContext({
  size: "default",
  variant: "default"
}), kn = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = F();
  return /* @__PURE__ */ r(
    qt.Root,
    {
...
const Qt = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), bs = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-center", children: [
      /* @__PURE__ */ l(kn, { value: i, variant: "outline", type: "single", children: [
        /* @__PURE__ */ r(
          Lt,
          {
            onClick: (c) => {
      ...
      /* @__PURE__ */ r(M, { variant: "ghost", children: "Hello World" })
    ] });
  }
}), ys = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Ns = (t) => {
  ...
  return e ? e[1] : "";
}, Oa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Cs = Object.freeze([
...
function Ss({
  ...
  const u = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), b = st(n, "%webView_inventory_unapproved%"), h = st(n, "%webView_inventory_unknown%"), m = st(n, "%webView_inventory_scope_currentBook%"), f = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_filter_text%"), C = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, x] = P(!1), [E, $] = P("all"), [q, dt] = P(""), [ct, N] = P([]), T = W(() => t.length === 0 ? [] : ja(t, o, s), [t, o, s]), L = W(() => {
    if (y) return T;
    const v = [];
    return T.forEach((_) => {
      const Z = _.items[0], pt = v.find(
        (xt) => xt.items[0] === Z
      );
      pt ? (pt.count += _.count, pt.occurrences = pt.occurrences.concat(_.occurrences)) : v.push({
        items: [Z],
        count: _.count,
    ...
    for (let xt = 0; xt < v; xt++)
      _.push(
        Aa(
          ((pt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : pt[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [..._, ...c];
  ...
  wt(() => {
    A.length === 0 ? N([]) : A.length === 1 && N(A[0].items);
  }, [A]);
  const re = (v, _) => {
    _.setRowSelection(() => {
      const Z = {};
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        yt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(bt, { children: [
              ...
              /* @__PURE__ */ r(Q, { value: "approved", children: g }),
              /* @__PURE__ */ r(Q, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(Q, { value: "unknown", children: h })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l(yt, { onValueChange: (v) => S(v), defaultValue: i, children: [
        /* @__PURE__ */ r(ft, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(bt, { children: [
          /* @__PURE__ */ r(Q, { value: "book", children: m }),
          /* @__PURE__ */ r(Q, { value: "chapter", children: f })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Tt,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(G, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? C })
      ] })
    ] }),
...
const Oe = Pt.Provider, Pe = Pt.Root, je = Pt.Trigger, te = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Pt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Xa = "16rem", Fa = "3rem", Cn = p.createContext(void 0);
function ee() {
...
const Sn = p.forwardRef(
  ({
    ...
    const [u, g] = p.useState(t), b = e ?? u, h = p.useCallback(
      (E) => {
        const $ = typeof E == "function" ? E(b) : E;
        n ? n($) : g($);
      },
      [n, b]
    ), m = p.useCallback(() => h((E) => !E), [h]), f = b ? "expanded" : "collapsed", y = F() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = p.useMemo(
      () => ({
        state: f,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: x, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Rn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = ee();
...
const Ga = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = ee();
  return /* @__PURE__ */ l(
    M,
    {
...
Ga.displayName = "SidebarTrigger";
const $a = p.forwardRef(
  ({ className: t, ...e }, n) => {
...
Ua.displayName = "SidebarSeparator";
...
const qa = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? St : "button",
  {
    ref: a,
...
const Ja = lt(
  ...
  ({
    ...
    const c = t ? St : "button", { state: u } = ee(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Ja({ variant: n, size: a }), s),
        ...i
      }
    );
...
const Ka = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? St : "button",
  {
    ref: o,
...
Ka.displayName = "SidebarMenuAction";
...
Wa.displayName = "SidebarMenuBadge";
const Za = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
Za.displayName = "SidebarMenuSkeleton";
...
to.displayName = "SidebarMenuSubItem";
...
function no({
  ...
  const u = tt(
    ...
    (h) => {
      const m = n.find((f) => f.projectId === h);
  ...
  return /* @__PURE__ */ r(
    Rn,
    {
      ...
      children: /* @__PURE__ */ l(_n, { children: [
        /* @__PURE__ */ l(he, { children: [
          /* @__PURE__ */ r(ge, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(En, { children: /* @__PURE__ */ r(
            Dn,
            {
              onClick: () => u(h),
              isActive: b(h),
...
const it = "scrBook", ro = "scrRef", mt = "source", ao = "details", oo = "Scripture Reference", so = "Scripture Book", Mn = "Type", io = "Details";
function wo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? j.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === it ? ht(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => ht(a.start),
      id: ro,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : ht(o.start);
      },
      sortingFn: (a, o) => de(a.original.start, o.original.start),
      enableGrouping: !1
    },
...
}, Ye = (t) => `${lo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ts({
  sources: t,
  ...
  const [c, u] = P([]), [g, b] = P([{ id: it, desc: !1 }]), [h, m] = P({}), f = W(
  ...
  wt(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const L = f.find((A) => Ye(A) === T[0]) || void 0;
        L && w(L);
      }
    }
  }, [h, f, w, C]);
  const y = o ?? so, x = s ?? Mn, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [it] },
    { label: `Group by ${x}`, value: [mt] },
    {
  ...
  }, dt = (N, T) => N.getIsGrouped() ? "" : d("banded-row", T % 2 === 0 ? "even" : "odd"), ct = (N, T, L) => {
    ...
    !e && /* @__PURE__ */ l(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(ba, { children: E.map((N) => /* @__PURE__ */ r(Q, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ft, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Wt, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(at, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        /* @__PURE__ */ r(Ot, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          Mt(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, N.id)) }),
      /* @__PURE__ */ r(Gt, { children: C.getRowModel().rows.map((N, T) => {
        ...
        return /* @__PURE__ */ r(
          at,
          {
            ...
            className: d(dt(N, T)),
            onClick: (A) => q(N, A),
            children: N.getVisibleCells().map((A) => {
              if (!(A.getIsPlaceholder() || A.column.columnDef.enableGrouping && !A.getIsGrouped() && (A.column.columnDef.id !== mt || !n)))
                return /* @__PURE__ */ r(
                  vt,
                  {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(yr, {})),
                          " ",
                          Mt(A.column.columnDef.cell, A.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
...
function _s({
  ...
  return /* @__PURE__ */ l(
    yt,
    {
      ...
      children: [
        /* @__PURE__ */ r(ft, { size: o, className: d("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Nt,
          {
            placeholder: i[I(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(Q, { value: `${c}`, children: i[I(c)] }, `${c}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ l(Pe, { children: [
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    Ce,
    {
      onClick: () => {
        a(w);
      ...
      children: [
        w.iconPathBefore && /* @__PURE__ */ r(Yt, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
        w.label,
        w.iconPathAfter && /* @__PURE__ */ r(Yt, { icon: w.iconPathAfter, menuLabel: w.label })
      ]
    },
    `dropdown-menu-item-${w.label}-${w.command}`
  ) : /* @__PURE__ */ l(jr, { children: [
    /* @__PURE__ */ r(nn, { children: w.label }),
    /* @__PURE__ */ r(Pr, { children: /* @__PURE__ */ r(rn, { children: Bn(
      t,
      e,
      Vn(t, w.id),
      a
...
function He({
  ...
  return /* @__PURE__ */ l(Jt, { variant: s, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(M, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Nr, {}) }) }),
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(Jn, { children: [
      /* @__PURE__ */ r(en, { children: /* @__PURE__ */ r(Oe, { children: Bn(e.groups, e.items, w, t) }) }),
...
On.displayName = U.List.displayName;
...
function Ms({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(An, { children: [
      /* @__PURE__ */ r(On, { children: t.map((i) => /* @__PURE__ */ r(co, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(Pn, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function po({ ...t }) {
...
jn.displayName = B.Root.displayName;
const Xn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    B.Trigger,
    {
...
Xn.displayName = B.Trigger.displayName;
const Fn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ l(
    B.SubTrigger,
    {
...
const $n = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = et();
...
const mo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    B.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
mo.displayName = B.CheckboxItem.displayName;
const ho = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ l(
    B.RadioItem,
    {
...
ho.displayName = B.RadioItem.displayName;
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, g) => u.order - g.order).map((u) => /* @__PURE__ */ l(Pe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in u ? /* @__PURE__ */ l(
        Ln,
        {
          onClick: () => {
            a(u);
    ...
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(Yn, {}, `separator-${s}`)), c;
  });
};
function fo({
  menuData: t,
  ...
  const o = K(void 0), s = K(void 0), i = K(void 0), w = K(void 0), c = K(void 0), u = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (Mr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    ...
    switch (b.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Dt(i, [h, m]);
        break;
      case "alt+n":
        (C = w.current) == null || C.focus(), Dt(w, [h, m]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Dt(c, [h, m]);
        break;
    }
  }), wt(() => {
    ...
    const g = new MutationObserver((m) => {
      m.forEach((f) => {
        if (f.attributeName === "data-state" && f.target instanceof HTMLElement) {
          const k = f.target.getAttribute("data-state");
          n(k === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ l(po, { children: [
      /* @__PURE__ */ r(Xn, { ref: u(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        $n,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Hn(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
      ...
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((m) => /* @__PURE__ */ r(Q, { value: m, children: h(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ l(kt, { children: [
      /* @__PURE__ */ r(G, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ l(G, { children: [
        "Currently:",
        " ",
        (n == null ? void 0 : n.length) > 0 ? `${n.map((m) => h(m, e)).join(", ")}` : `default (${t.en.autonym})`
      ] }) })
    ] })
  ] });
}
function vo({ item: t, createLabel: e, createComplexLabel: n }) {
...
), yo = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(xo({ variant: e }), t), ...n }));
...
No.displayName = "AlertTitle";
const ko = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Co.displayName = Rt.Root.displayName;
...
So.displayName = Rt.Image.displayName;
...
Ro.displayName = Rt.Fallback.displayName;
const To = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
...
const Eo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Mo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ l(
    It.Root,
    {
...
Mo.displayName = It.Root.displayName;
...
Vo.displayName = pe.Root.displayName;
const Xs = U.Root, Bo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Bo.displayName = U.List.displayName;
...
Ao.displayName = U.Trigger.displayName;
...
Oo.displayName = U.Content.displayName;
const Fs = (t, e) => {
  wt(() => {
    if (!t) return () => {
    };
...
export {
  ...
  So as AvatarImage,
  as as BOOK_SELECTOR_STRING_KEYS,
  xn as Badge,
  rs as BookChapterControl,
  ...
  me as ComboBox,
  _a as DataTable,
  ss as DictionaryEntryDisplay,
  vn as DictionaryListItem,
  is as DictionaryTable,
  ds as DisableButton,
  Jt as DropdownMenu,
  ...
  rn as DropdownMenuSubContent,
  nn as DropdownMenuSubTrigger,
  ke as DropdownMenuTrigger,
  ls as EnableButton,
  fs as Filter,
  za as FilterButton,
  us as FilterDropdown,
  gs as Footer,
  Cs as INVENTORY_STRING_KEYS,
  Tt as Input,
  ws as InstallButton,
  Ss as Inventory,
  G as Label,
  ...
  ms as NoExtensionsFound,
  un as Popover,
  Ee as PopoverContent,
  mn as PopoverTrigger,
  pn as RadioGroup,
  ue as RadioGroupItem,
  Ts as ScriptureResultsViewer,
  _s as ScrollGroupSelector,
  In as SearchBar,
  yt as Select,
  bt as SelectContent,
  ba as SelectGroup,
  ...
  Zt as Separator,
  zs as SettingsList,
  Ds as SettingsListHeader,
  Es as SettingsListItem,
  no as SettingsSidebar,
  Rs as SettingsSidebarContentSearch,
  Mo as Slider,
  js as Sonner,
  $t as Spinner,
  Vo as Switch,
  He as TabDropdownMenu,
  Is as TabToolbar,
  Ft as Table,
  Gt as TableBody,
  Ta as TableCaption,
  ...
  d as cn,
  ks as getBookIdFromUSFM,
  ys as getLinesFromUSFM,
  Ns as getNumberFromUSFM,
  Oa as getStatusForItem,
  Vs as getToolbarOSReservedSpaceClassName,
  vs as inventoryCountColumn,
  bs as inventoryItemColumn,
  xs as inventoryStatusColumn,
