...
import $t, { forwardRef as Ti, useCallback as Se, useState as Me, useRef as ft, useEffect as fn, useLayoutEffect as xo, useMemo as Lt } from "react";
...
function rl({
  ...
  const i = Array.from({ length: t }, (l, c) => c + 1), s = Se(
    (l) => {
      o(l);
    },
    [o]
  );
  return /* @__PURE__ */ T("div", { className: _e("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: i.map((l) => /* @__PURE__ */ T(
    "div",
    {
      className: _e(
...
const nn = ce.allBookIds, al = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, sl = ["OT", "NT"], ll = 32 + 32 + 32, cl = [
  /^(\w+)$/i,
...
function Pm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Me(""), [o, i] = Me(
  ...
  ), [s, l] = Me(e.chapterNum ?? 0), [c, u] = Me(
    ce.bookNumberToId(e.bookNum)
  ), [d, f] = Me(!1), [p, b] = Me(d), v = ft(void 0), g = ft(void 0), m = ft(void 0), E = Se(
    (C) => ul(C).filter((N) => {
      const A = ce.bookIdToEnglishName(N).toLowerCase(), F = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    cl.forEach((C) => {
      const N = n.match(C);
      if (N) {
        const [A, F = void 0, D = void 0] = N.slice(1), $ = fl(A);
        (ce.isBookIdValid(A) || $) && h(
          $ ?? A,
          !0,
          F ? parseInt(F, 10) : 1,
          D ? parseInt(D, 10) : 1
    ...
    const { key: N } = C;
    N === "ArrowRight" || N === "ArrowLeft" || N === "ArrowDown" || N === "ArrowUp" || N === "Enter" || (v.current.dispatchEvent(new KeyboardEvent("keydown", { key: N })), v.current.focus());
  }, L = (C) => {
    const { key: N } = C;
    if (c === o) {
      if (N === "Enter") {
      ...
      s + A <= 0 || s + A > Kt(c) ? l(0) : A !== 0 && (l(s + A), C.preventDefault());
    }
  };
  return fn(() => {
    ...
    const C = setTimeout(() => {
      if (p && g.current && m.current) {
        const A = m.current.offsetTop - ll;
        g.current.scrollTo({ top: A, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(C);
    };
  }, [p]), /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Ys, { modal: !1, open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ de(
      Ai,
      {
        ...
        children: [
          ...
          sl.map(
            (C) => E(C).length > 0 && /* @__PURE__ */ de("div", { children: [
              /* @__PURE__ */ T(Br, { className: "pr-font-semibold pr-text-slate-700", children: al[C] }),
              E(C).map((N) => /* @__PURE__ */ T("div", { children: /* @__PURE__ */ T(
                ol,
                {
                  bookId: N,
                  handleSelectBook: () => h(N, !1),
                  isSelected: o === N,
                  ...
                  children: /* @__PURE__ */ T(
                    rl,
                    {
                      ...
                      endChapter: Kt(N),
                      activeChapter: e.bookNum === ce.bookIdToNumber(N) ? e.chapterNum : 0,
...
function ml({
  ...
  let f;
  if (n) {
    const p = r === Nt.Before || r === Nt.Above, b = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Nt.Before || r === Nt.After, g = v ? b : /* @__PURE__ */ T("div", { children: b }), m = v ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ de(
      ys,
      {
...
function vl() {
  return No || (No = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(I) {
      ...
      I === r || I === u || I === i || I === o || I === f || I === p || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === b || I.$$typeof === s || I.$$typeof === l || I.$$typeof === d || I.$$typeof === m || I.$$typeof === E || I.$$typeof === M || I.$$typeof === g);
    }
    function w(I) {
    ...
    var h = c, S = u, P = l, B = s, j = t, L = d, C = r, N = v, A = b, F = n, D = i, $ = o, V = f, Q = !1;
    function Z(I) {
    ...
    ae.AsyncMode = h, ae.ConcurrentMode = S, ae.ContextConsumer = P, ae.ContextProvider = B, ae.Element = j, ae.ForwardRef = L, ae.Fragment = C, ae.Lazy = N, ae.Memo = A, ae.Portal = F, ae.Profiler = D, ae.StrictMode = $, ae.Suspense = V, ae.isAsyncMode = Z, ae.isConcurrentMode = O, ae.isContextConsumer = _, ae.isContextProvider = U, ae.isElement = K, ae.isForwardRef = z, ae.isFragment = H, ae.isLazy = q, ae.isMemo = G, ae.isPortal = W, ae.isProfiler = X, ae.isStrictMode = Y, ae.isSuspense = ne, ae.isValidElementType = y, ae.typeOf = w;
  }()), ae;
}
var Ro;
function Li() {
...
function xl() {
  ...
  return dr = function(l, c) {
    ...
    function j(O) {
      ...
      for (var _ = 0; _ < O.length; _++) {
        ...
        if (typeof U != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + Q(U) + " at index " + _ + "."
          ), s;
      }
    ...
    function L() {
      function O(_, U, K, z, H) {
        return F(_[U]) ? null : new g("Invalid " + z + " `" + H + "` supplied to " + ("`" + K + "`, expected a ReactNode."));
      }
      return m(O);
    }
    function C(O, _, U, K, z) {
      return new g(
        (O || "React class") + ": " + _ + " type `" + U + "." + K + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + z + "`."
      );
    }
    function N(O) {
      function _(U, K, z, H, q) {
...
function Ml() {
  return Bo || (Bo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === n || R === o || M || R === r || R === u || R === d || E || R === b || v || g || m || typeof R == "object" && R !== null && (R.$$typeof === p || R.$$typeof === f || R.$$typeof === i || R.$$typeof === s || R.$$typeof === c || // This needs to include all possible module reference object
    ...
    var S = s, P = i, B = e, j = c, L = n, C = p, N = f, A = t, F = o, D = r, $ = u, V = d, Q = !1, Z = !1;
    function O(R) {
    ...
    le.ContextConsumer = S, le.ContextProvider = P, le.Element = B, le.ForwardRef = j, le.Fragment = L, le.Lazy = C, le.Memo = N, le.Portal = A, le.Profiler = F, le.StrictMode = D, le.Suspense = $, le.SuspenseList = V, le.isAsyncMode = O, le.isConcurrentMode = _, le.isContextConsumer = U, le.isContextProvider = K, le.isElement = z, le.isForwardRef = H, le.isFragment = q, le.isLazy = G, le.isMemo = W, le.isPortal = X, le.isProfiler = Y, le.isStrictMode = ne, le.isSuspense = I, le.isSuspenseList = J, le.isValidElementType = w, le.typeOf = h;
  }()), le;
}
...
const Fl = typeof window < "u" ? x.useLayoutEffect : x.useEffect, gt = Fl;
let Fo = 0;
function Vl(e) {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (B = i(v.current)), B.length > 0) {
        var j, L;
        const C = !!((j = m.current) != null && j.shiftKey && ((L = m.current) == null ? void 0 : L.key) === "Tab"), N = B[0], A = B[B.length - 1];
        typeof N != "string" && typeof A != "string" && (C ? A.focus() : N.focus());
      } else
        P.focus();
    };
    ...
    return () => {
      clearInterval(S), y.removeEventListener("focusin", h), y.removeEventListener("keydown", w, !0);
    };
  }, [n, r, o, s, l, i]);
  const E = (y) => {
...
function Nc(e) {
  ...
  const w = () => xe(b.current), h = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), S = () => {
    o.mount(h(), {
      disableScrollLock: r
    ...
    const $ = Sc(t) || w().body;
    o.add(h(), $), v.current && S();
  }), B = x.useCallback(() => o.isTopModal(h()), [o]), j = ln(($) => {
    b.current = $, $ && (d && B() ? S() : v.current && rn(v.current, y));
  }), L = x.useCallback(() => {
    o.remove(h(), y);
  }, [y, o]);
  x.useEffect(() => () => {
  ...
  const C = ($) => (V) => {
    var Q;
    (Q = $.onKeyDown) == null || Q.call($, V), !(V.key !== "Escape" || V.which === 229 || // Wait until IME is settled.
    !B()) && (n || (V.stopPropagation(), u && u(V, "escapeKeyDown")));
  }, N = ($) => (V) => {
    var Q;
    (Q = $.onClick) == null || Q.call($, V), V.target === V.currentTarget && u && u(V, "backdropClick");
  };
  return {
    getRootProps: ($ = {}) => {
      const V = oa(e);
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: Or($, c == null ? void 0 : c.props.onEnter),
...
var mt = Math.max, jn = Math.min, Dt = Math.round;
function Pr() {
...
function jt(e, t, n) {
  ...
  var s = vt(e) ? Ae(e) : window, l = s.visualViewport, c = !ca() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, d = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, p = r.height / i;
  return {
    width: f,
    height: p,
    top: d,
...
function Xc(e) {
  ...
  if (!(!i || !s)) {
    var f = Kc(o.padding, n), p = Ur(i), b = c === "y" ? Ce : Pe, v = c === "y" ? Fe : Ve, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], m = s[c] - n.rects.reference[c], E = bn(i), M = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - m / 2, w = f[b], h = M - p[d] - f[v], S = M / 2 - p[d] / 2 + y, P = on(w, S, h), B = c;
...
function Xo(e) {
  ...
  if (u) {
    var S = bn(n), P = "clientHeight", B = "clientWidth";
    if (S === Ae(n) && (S = at(n), Ze(S).position !== "static" && l === "absolute" && (P = "scrollHeight", B = "scrollWidth")), S = S, o === Ce || (o === Pe || o === Ve) && i === un) {
      w = Fe;
      var j = f && S === h && h.visualViewport ? h.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        S[P]
      );
    ...
    if (o === Pe || (o === Ce || o === Fe) && i === un) {
      y = Ve;
      var L = f && S === h && h.visualViewport ? h.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        S[B]
      );
      b -= L - r.width, b *= c ? 1 : -1;
  ...
  if (b = N.x, g = N.y, c) {
    var A;
    return Object.assign({}, C, (A = {}, A[w] = M ? "0" : "", A[y] = E ? "0" : "", A.transform = (h.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", A));
  }
  return Object.assign({}, C, (t = {}, t[w] = M ? g + "px" : "", t[y] = E ? b + "px" : "", t.transform = "", t));
}
function eu(e) {
...
function su(e) {
  var t, n = at(e), r = Wr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = mt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = mt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + qr(e), c = -r.scrollTop;
...
function Jo(e, t, n) {
  return t === sa ? Nr(au(e, n)) : vt(t) ? lu(t, n) : Nr(su(at(e)));
}
function cu(e) {
  var t = an(Wn(e)), n = ["absolute", "fixed"].indexOf(Ze(e).position) >= 0, r = n && Be(e) ? bn(e) : e;
  return vt(r) ? t.filter(function(o) {
    return vt(o) && ua(o, r) && We(o) !== "body";
  }) : [];
}
function uu(e, t, n, r) {
  var o = t === "clippingParents" ? cu(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, u) {
    var d = Jo(e, u, r);
    return c.top = mt(d.top, c.top), c.right = jn(d.right, c.right), c.bottom = jn(d.bottom, c.bottom), c.left = mt(d.left, c.left), c;
  }, Jo(e, s, r));
...
function dn(e, t) {
  ...
  if (p === Xt && C) {
    ...
    Object.keys(L).forEach(function(A) {
      var F = [Ve, Fe].indexOf(A) >= 0 ? 1 : -1, D = [Ce, Fe].indexOf(A) >= 0 ? "y" : "x";
      L[A] += N[D] * F;
    });
  }
  return L;
...
function fu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), M = E === m, y = c || (M || !v ? [Rn(m)] : pu(m)), w = [m].concat(y).reduce(function(z, H) {
    ...
    }, []), h = t.rects.reference, S = t.rects.popper, P = /* @__PURE__ */ new Map(), B = !0, j = w[0], L = 0; L < w.length; L++) {
      var C = w[L], N = Ue(C), A = Bt(C) === At, F = [Ce, Fe].indexOf(N) >= 0, D = F ? "width" : "height", $ = dn(t, {
        placement: C,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
      ...
      h[D] > S[D] && (V = Rn(V));
      var Q = Rn(V), Z = [];
      if (i && Z.push($[N] <= 0), l && Z.push($[V] <= 0, $[Q] <= 0), Z.every(function(z) {
        return z;
      })) {
        j = C, B = !1;
        break;
...
function Tu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = dn(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), M = Bt(t.placement), y = !M, w = Hr(E), h = Eu(w), S = t.modifiersData.popperOffsets, P = t.rects.reference, B = t.rects.popper, j = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, L = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
    ...
    mainAxis: 0,
    altAxis: 0
  }, j), C = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, N = {
    x: 0,
    y: 0
  };
  if (S) {
    if (i) {
      var A, F = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, $ = w === "y" ? "height" : "width", V = S[w], Q = V + m[F], Z = V - m[D], O = b ? -B[$] / 2 : 0, _ = M === At ? P[$] : B[$], U = M === At ? -B[$] : -P[$], K = t.elements.arrow, z = b && K ? Ur(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : da(), q = H[F], G = H[D], W = on(0, P[$], z[$]), X = y ? P[$] / 2 - O - W - q - L.mainAxis : _ - W - q - L.mainAxis, Y = y ? -P[$] / 2 + O + W + G + L.mainAxis : U + W + G + L.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), I = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (A = C == null ? void 0 : C[w]) != null ? A : 0, R = V + X - J - I, re = V + Y - J, ve = on(b ? jn(Q, R) : Q, V, b ? mt(Z, re) : Z);
      S[w] = ve, N[w] = ve - V;
    }
    if (l) {
      var Te, he = w === "x" ? Ce : Pe, lt = w === "x" ? Fe : Ve, ke = S[h], Ge = h === "y" ? "height" : "width", Ne = ke + m[he], Ke = ke - m[lt], ye = [Ce, Pe].indexOf(E) !== -1, wt = (Te = C == null ? void 0 : C[h]) != null ? Te : 0, ct = ye ? Ne : ke - P[Ge] - B[Ge] - wt + L.altAxis, zt = ye ? ke + P[Ge] + B[Ge] - wt - L.altAxis : Ke, xn = b && ye ? Gc(ct, ke, zt) : on(b ? ct : Ne, ke, b ? zt : Ke);
      S[h] = xn, N[h] = xn - ke;
    }
    t.modifiersData[r] = N;
  }
        ...
        if (!p) {
          ...
          if (ti(M, y)) {
            ...
            for (var w = 0; w < d.orderedModifiers.length; w++) {
              ...
              var h = d.orderedModifiers[w], S = h.fn, P = h.options, B = P === void 0 ? {} : P, j = h.name;
...
const Vu = () => et({
  ...
  } = t, m = ue(t, ju), E = x.useRef(null), M = Le(E, n), y = x.useRef(null), w = Le(y, p), h = x.useRef(w);
  gt(() => {
    h.current = w;
  }, [w]), x.useImperativeHandle(p, () => y.current, []);
  const S = Lu(d, s), [P, B] = x.useState(S), [j, L] = x.useState(Bn(o));
  x.useEffect(() => {
...
`));
  ...
  const N = Vu(), A = (r = v.root) != null ? r : "div", F = bt({
    elementType: A,
  ...
  const {
    ...
    slotProps: m = {},
    slots: E = {}
  } = t, M = ue(t, Bu), [y, w] = x.useState(!0), h = () => {
    w(!1);
  }, S = () => {
    w(!0);
  };
  ...
  if (i)
    ...
    const L = Bn(r);
    P = L && qn(L) ? xe(L).body : xe(null).body;
  }
...
function qu(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = ue(e, Hu), i = Wu(t), s = Object.keys(i);
  function l(p) {
...
function Jd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    _s(s, (h) => h.filter((S) => !(S != null && S.__mui_systemSx)));
    const {
      name: c,
      slot: u,
    ...
    const M = Ms(s, k({
      shouldForwardProp: E,
      label: m
    }, b)), y = (h) => typeof h == "function" && h.__emotion_real !== h || pt(h) ? (S) => Mn(h, k({}, S, {
      theme: Cn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
      ...
      c && p && B.push((C) => {
        ...
        if (!N.components || !N.components[c] || !N.components[c].styleOverrides)
          return null;
        const A = N.components[c].styleOverrides, F = {};
        ...
        const A = Cn(k({}, C, {
          defaultTheme: n,
          themeId: t
        })), F = A == null || (N = A.components) == null || (N = N[c]) == null ? void 0 : N.variants;
        return Mn({
          variants: F
        }, k({}, C, {
          theme: A
      ...
      if (Array.isArray(h) && j > 0) {
        const C = new Array(j).fill("");
        P = [...h, ...C], P.raw = [...h.raw, ...C];
      }
      const L = M(P, ...B);
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${He(u || "")}`), C === void 0 && (C = `Styled(${Al(s)})`), L.displayName = C;
      }
...
function ii(e) {
  e = yt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? yt(tp(e)).values : e.values;
...
function Fn(e, t) {
  return e = yt(e), t = Qr(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, tr(e);
}
function np(e, t) {
  if (e = yt(e), t = Qr(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const ip = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, St = fp, mp = ["mode", "contrastThreshold", "tonalOffset"], si = {
...
function xp(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ue(e, mp), i = e.primary || hp(t), s = e.secondary || gp(t), l = e.error || bp(t), c = e.info || vp(t), u = e.success || yp(t), d = e.warning || wp(t);
  function f(g) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return li(g, "light", M, r), li(g, "dark", y, r), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: hr,
    light: si
  };
...
var Up = function(t) {
  return t.scrollTop;
}, tn = "unmounted", ut = "exited", dt = "entering", Rt = "entered", $r = "exiting", nt = /* @__PURE__ */ function(e) {
  Vp(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = ut, i.appearStatus = dt) : c = Rt : r.unmountOnExit || r.mountOnEnter ? c = tn : c = ut, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== dt && s !== Rt && (i = dt) : (s === dt || s === Rt) && (i = $r);
    }
    ...
    return (
      ...
      /* @__PURE__ */ $t.createElement(ka.Provider, {
        value: null
...
const Wp = {
  ...
  const {
  ...
  } = t, E = ue(t, Hp), M = Qt(), y = x.useRef(), w = wn(), h = x.useRef(null), S = Le(h, i.ref, n), P = (D) => ($) => {
    if (D) {
      const V = h.current;
      $ === void 0 ? D(V) : D(V, $);
    }
    ...
    let Z;
    g === "auto" ? (Z = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = Z) : Z = $, D.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: V
    }), w.transitions.create("transform", {
  ...
  return /* @__PURE__ */ T(m, k({
    ...
    children: (D, $) => /* @__PURE__ */ x.cloneElement(i, k({
      style: k({
        opacity: 0,
        transform: Mr(0.75),
...
const Ir = no, qp = (e) => {
  ...
  const o = xa(), i = tt({
    ...
    slots: y,
    slotProps: w
  } = i, h = ue(i, Gp), S = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Na = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const S = tt({
    ...
    TransitionProps: J
  } = S, R = ue(S, Jp), re = /* @__PURE__ */ x.isValidElement(B) ? B : /* @__PURE__ */ T("span", {
    children: B
  }), ve = wn(), Te = ve.direction === "rtl", [he, lt] = x.useState(), [ke, Ge] = x.useState(null), Ne = x.useRef(!1), Ke = F || Z, ye = Qt(), wt = Qt(), ct = Qt(), zt = Qt(), [xn, ao] = Ki({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const so = (ee) => {
    ...
    Ne.current && ee.type !== "touchstart" || (he && he.removeAttribute("title"), wt.clear(), ct.clear(), $ || Pn && V ? wt.start(Pn ? V : $, () => {
      so(ee);
    }) : so(ee));
  }, lo = (ee) => {
    wt.clear(), ct.start(_, () => {
  ...
  C ? (Ht.title = !Xe && ir && !A ? ne : null, Ht["aria-describedby"] = Xe ? nr : null) : (Ht["aria-label"] = ir ? ne : null, Ht["aria-labelledby"] = Xe && !ir ? nr : null);
...
`));
  ...
  const Wt = {};
  D || (De.onTouchStart = Xa, De.onTouchEnd = Ya), A || (De.onMouseOver = Nn(ho, De.onMouseOver), De.onMouseLeave = Nn(go, De.onMouseLeave), Ke || (Wt.onMouseOver = ho, Wt.onMouseLeave = go)), N || (De.onFocus = Nn(fo, De.onFocus), De.onBlur = Nn(po, De.onBlur), Ke || (Wt.onFocus = fo, Wt.onBlur = po)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Qa = x.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Ne.current
  }), ar = Qp(qt), bo = (r = (o = Y.popper) != null ? o : j.Popper) != null ? r : ef, vo = (i = (s = (l = Y.transition) != null ? l : j.Transition) != null ? s : I) != null ? i : Ir, yo = (c = (u = Y.tooltip) != null ? u : j.Tooltip) != null ? c : tf, wo = (d = (f = Y.arrow) != null ? f : j.Arrow) != null ? d : nf, es = en(bo, k({}, W, (p = X.popper) != null ? p : L.popper, {
    className: we(ar.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : L.popper) == null ? void 0 : b.className)
  }), qt), ts = en(vo, k({}, J, (g = X.transition) != null ? g : L.transition), qt), ns = en(yo, k({}, (m = X.tooltip) != null ? m : L.tooltip, {
    className: we(ar.tooltip, (E = (M = X.tooltip) != null ? M : L.tooltip) == null ? void 0 : E.className)
  }), qt), rs = en(wo, k({}, (y = X.arrow) != null ? y : L.arrow, {
    className: we(ar.arrow, (w = (h = X.arrow) != null ? h : L.arrow) == null ? void 0 : w.className)
  }), qt);
  return /* @__PURE__ */ de(x.Fragment, {
...
const sf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], lf = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ue(r, sf), v = /* @__PURE__ */ x.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
const Ba = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  } = t, p = ue(t, Pf), b = x.useRef(null), v = x.useRef({
    keys: [],
    repeating: !0,
  ...
  const g = (y) => {
    const w = b.current, h = y.key, S = xe(w).activeElement;
    if (h === "ArrowDown")
      y.preventDefault(), Zt(w, S, u, c, vr);
    else if (h === "ArrowUp")
      y.preventDefault(), Zt(w, S, u, c, vi);
    else if (h === "Home")
      ...
      const L = S && !P.repeating && ja(S, P);
      P.previousKeyMatched && (L || Zt(w, S, !1, c, vr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, m = Le(b, n);
  let E = -1;
...
const Nf = Ba, Rf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], $f = {
  ...
  const r = wn(), o = {
    ...
    // eslint-disable-next-line react/prop-types
    TransitionComponent: M = Oa
  } = t, y = ue(t, Rf), w = x.useRef(null), h = Le(w, l.ref, n), S = (F) => (D) => {
    if (F) {
      const $ = w.current;
      D === void 0 ? F($) : F($, D);
    }
    ...
    F.style.webkitTransition = r.transitions.create("opacity", $), F.style.transition = r.transitions.create("opacity", $), d && d(F, D);
  }), j = S(f), L = S(g), C = S((F) => {
    const D = Vn({
      style: m,
      timeout: E,
...
const Lf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Ff = (e) => {
  ...
  const G = (r = (o = F == null ? void 0 : F.root) != null ? o : E.Root) != null ? r : Vf, W = (i = (s = F == null ? void 0 : F.backdrop) != null ? s : E.Backdrop) != null ? i : d, X = (l = A == null ? void 0 : A.root) != null ? l : M.root, Y = (c = A == null ? void 0 : A.backdrop) != null ? c : M.backdrop, ne = bt({
    elementType: G,
    externalSlotProps: X,
...
const Qf = (e) => {
  ...
  const s = tt({
  ...
  } = s, L = ue(s.TransitionProps, Yf), C = ue(s, Jf), N = (r = w == null ? void 0 : w.paper) != null ? r : M, A = x.useRef(), F = Le(A, N.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
    ...
    TransitionProps: L
  }), $ = Qf(D), V = x.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = In(c), R = J && J.nodeType === 1 ? J : xe(A.current).body, re = R.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`)), m !== null && he < m) {
  ...
  }, [c, f, V, Q, m]), [O, _] = x.useState(E), U = x.useCallback(() => {
    const J = A.current;
    if (!J)
      return;
    const R = Z(J);
  ...
  const q = v || (c ? xe(In(c)).body : void 0), G = (o = y == null ? void 0 : y.root) != null ? o : em, W = (i = y == null ? void 0 : y.paper) != null ? i : Ua, X = bt({
    elementType: W,
    externalSlotProps: k({}, N, {
      style: O ? N.style : k({}, N.style, {
        opacity: 0
      })
    }),
    additionalProps: {
    ...
    ownerState: D,
    className: we($.paper, N == null ? void 0 : N.className)
  }), Y = bt({
    elementType: G,
...
const rm = ["onEntering"], om = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], im = {
  ...
  const i = tt({
    ...
    slots: M = {},
    slotProps: y = {}
  } = i, w = ue(i.TransitionProps, rm), h = ue(i, om), S = wn(), P = S.direction === "rtl", B = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), j = sm(B), L = s && !u && p, C = x.useRef(null), N = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || F === -1) && (F = O));
  ...
  const D = (r = M.paper) != null ? r : cm, $ = (o = y.paper) != null ? o : b, V = bt({
    elementType: M.root,
...
function Rm({
  ...
  var u;
  const [o, i] = $t.useState(void 0), s = Se(
    (d) => {
      d.preventDefault(), i(
        o === void 0 ? {
          mouseX: d.clientX + 2,
...
function mm({
  ...
  fn(() => {
    if (c) {
      ...
      if (w) {
        const h = w.getBoundingClientRect(), S = window.scrollY, P = window.scrollX, B = h.top + S + w.clientHeight, j = h.left + P;
        m({ top: B, left: j });
      }
    }
  }, [c, o]);
