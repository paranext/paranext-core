...
function kp({
  ...
  const w = ct(), [p, m] = M(!1), [f, u] = M(""), [g, N] = M(""), [v, S] = M("books"), [k, E] = M(void 0), [$, P] = M(!1), A = et(void 0), x = et(void 0), C = et(void 0), y = et(void 0), _ = et({}), O = z(
    (D) => {
      t(D), l && l(D);
    },
    [t, l]
    ...
    const { isLetter: K, isDigit: q } = Zr(D.key);
    (K || q) && (D.preventDefault(), N((dt) => dt + D.key), x.current.focus(), P(!1));
  }, []);
  return jt(() => {
    const D = setTimeout(() => {
      if (p && v === "books" && C.current && y.current) {
        const K = C.current, q = y.current, dt = q.offsetTop, ut = K.clientHeight, kt = q.clientHeight, Ct = dt - ut / 2 + kt / 2;
        K.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(lr(e.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if (C.current)
          if (D) {
            const K = _.current[e.chapterNum];
...
function wr({
  ...
  const [k, E] = M(!1), $ = c ?? l, P = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], A = (x, C) => {
    const y = l(x), _ = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, O = `${C ?? ""}${y}${_ ?? ""}`;
    return /* @__PURE__ */ d(
      Ht,
      {
        value: y,
    ...
    /* @__PURE__ */ o(
      ae,
      {
        ...
        children: /* @__PURE__ */ d(re, { children: [
          ...
          /* @__PURE__ */ o(oe, { children: P(t) ? t.map((x) => /* @__PURE__ */ o(Ft, { heading: x.groupHeading, children: x.options.map((C) => A(C, x.groupHeading)) }, x.groupHeading)) : t.map((x) => A(x)) })
        ] })
      }
    )
  ] });
...
const Sp = [
  ...
  const a = et(null), [s, i] = M(void 0), [l, c] = M(void 0), w = z(
    ...
    (u) => {
      var x;
      const g = u.target, N = (C) => C ? document.getElementById(C) : void 0, v = N(l), S = N(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const y = C.findIndex((O) => O === g);
          if (y === -1) return;
          let _;
          u.key === "ArrowDown" ? _ = Math.min(y + 1, C.length - 1) : _ = Math.max(y - 1, 0), _ !== y && (u.preventDefault(), u.stopPropagation(), (x = C[_]) == null || x.focus());
          return;
        }
        return;
      }
      const $ = e.findIndex((C) => C.id === s);
      let P = $;
      switch (u.key) {
        case "ArrowDown":
          P = Math.min($ + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          P = Math.max($ - 1, 0), u.preventDefault();
          break;
        case "Home":
...
function Ta(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, N) {
    ...
    if (S !== void 0) for (const E of S) {
      const $ = E(g);
      $ !== null && (k === null || (k.priority || 0) <= ($.priority || 0)) && (k = $);
    }
...
function po({
  ...
  const k = z(() => {
    ...
    const y = new Date(e.date), _ = oi(
      y,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), O = y.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, n]), P = B(() => e.user, [e.user]), A = B(
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-font-medium", children: P }),
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: $ }),
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: S,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), k()) : y.key === "Enter" && y.shiftKey && (y.preventDefault(), y.stopPropagation(), qt(u) && E());
              },
              onKeyDown: (y) => {
                Ra(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  ur,
...
function rc({
  ...
  const [P, A] = M(uo), [x, C] = M(!1), [y, _] = M(!1), [O, V] = M(!1), [H, I] = M(!1), [F, T] = M(!1), [G, it] = M(void 0), [Kt, At] = M(!1), [pt, j] = M(!1), [nt, ft] = M(E), [xt, Nt] = M(!1), ie = et(void 0);
  J(() => {
    let R = !0;
    if (!r) {
      At(!1), j(!1);
  ...
  const Ut = B(
    ...
    async (R) => {
      const Vt = qt(P) ? mr(P) : void 0, Ke = await p({
        ...R,
        contents: Vt,
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            y && /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (R) => {
                  R.stopPropagation(), C(!x);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": x ? "Collapse text" : "Expand text",
                children: x ? /* @__PURE__ */ o(tr, {}) : /* @__PURE__ */ o(ye, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            ...
            N !== !1 && (!H || qt(P)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (R) => {
                  R.key === "Enter" && R.shiftKey && (R.preventDefault(), R.stopPropagation(), (qt(P) || G !== void 0) && Yt());
                },
                onKeyDown: (R) => {
...
function Tp({
  ...
  const [u, g] = M(), N = n.filter(
    ...
    g(x);
  }, []), { listboxRef: E, activeId: $, handleKeyDown: P } = Pl({
    options: v,
    onOptionSelect: S
  }), A = z(
    (x) => {
      x.key === "Escape" ? (g(void 0), x.preventDefault(), x.stopPropagation()) : P(x);
    },
    [P]
  );
  return /* @__PURE__ */ o(
...
function fc({
  ...
  let P;
  return c ? P = Array.from({ length: 10 }).map((y, _) => `skeleton-row-${_}`).map((y) => /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(xe, { colSpan: $.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(hr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((A = E.getRowModel().rows) == null ? void 0 : A.length) > 0 ? P = E.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    Pt,
    {
      onClick: () => i(x, E),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((C) => /* @__PURE__ */ o(xe, { children: Ze(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    x.id
  )) : P = /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(xe, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(oc, { table: E }),
    /* @__PURE__ */ d(An, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Vn, { stickyHeader: s, children: E.getHeaderGroups().map((x) => /* @__PURE__ */ o(Pt, { children: x.headers.map((C) => /* @__PURE__ */ o(sn, { children: C.isPlaceholder ? void 0 : Ze(C.column.columnDef.header, C.getContext()) }, C.id)) }, x.id)) }),
...
function yc({
  ...
  const [S, k] = M(!1), E = z(
    (_) => {
      var V;
      const O = (V = e.find((H) => H.label === _)) == null ? void 0 : V.value;
      O && n(
    ...
    if (!f) return e;
    const _ = e.filter((V) => V.starred).sort((V, H) => V.label.localeCompare(H.label)), O = e.filter((V) => !V.starred).sort((V, H) => {
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(Ce, { open: C, onOpenChange: p ?? k, children: [
    ...
    /* @__PURE__ */ o(ae, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(re, { children: [
      ...
      /* @__PURE__ */ d(oe, { children: [
        ...
        /* @__PURE__ */ o(Ft, { children: P.map((_) => /* @__PURE__ */ d(
          Ht,
          {
            value: _.label,
            onSelect: E,
            ...
            children: [
              ...
              _.starred && /* @__PURE__ */ o(js, { className: "tw-h-4 tw-w-4" }),
...
function kc({
  ...
  const g = (v) => {
    ...
    var S, k, E, $;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((S = s.current) == null || S.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((k = i.current) == null || k.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((E = s.current) == null ? void 0 : E.selectionStart) === 0 && (($ = i.current) == null || $.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function Pp({
  ...
  J(() => {
    ...
    if (C && gn("note", C)) {
      const O = (y = C.insert.note) == null ? void 0 : y.caller;
      let V = "custom";
      O === rr ? V = "generated" : O === or ? V = "hidden" : O && u(O), m(V), N(((_ = C.insert.note) == null ? void 0 : _.style) ?? "f"), x = setTimeout(() => {
        var H;
        (H = c.current) == null || H.applyUpdate([{ delete: 1 }, C]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const E = z(() => {
    ...
    x && gn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = f : x.insert.note.caller = p === "generated" ? rr : or), n([x]));
  }, [p, f, n]), $ = () => {
    var C;
    ...
    var y, _, O, V, H;
    N(x);
    const C = (_ = (y = c.current) == null ? void 0 : y.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (C && gn("note", C)) {
      C.insert.note && (C.insert.note.style = x);
      const I = (V = (O = C.insert.note) == null ? void 0 : O.contents) == null ? void 0 : V.ops;
      g !== "x" && x === "x" ? I == null || I.forEach((F) => Sc(F)) : g === "x" && x !== "x" && (I == null || I.forEach((F) => Tc(F))), (H = c.current) == null || H.applyUpdate([{ delete: 1 }, C]);
    }
  }, A = () => {
    var C, y, _, O, V;
    const x = (y = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : y.at(0);
    if (x && gn("note", x)) {
      const H = (_ = x.insert.note) == null ? void 0 : _.style, I = (V = (O = x.insert.note) == null ? void 0 : O.contents) == null ? void 0 : V.ops;
      H || S(!1), S(
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Wt, { children: [
            /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: $, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(No, {}) }) }),
...
function Lp({
  ...
  const p = c ?? ci(n, void 0), m = (k, E) => {
    w == null || w(k, E, a);
  }, f = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(f), N = (k, E, $) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), w == null || w(E, $, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
...
function Kp({
  ...
  const f = Rt(n, "%webView_inventory_all%"), u = Rt(n, "%webView_inventory_approved%"), g = Rt(n, "%webView_inventory_unapproved%"), N = Rt(n, "%webView_inventory_unknown%"), v = Rt(n, "%webView_inventory_scope_currentBook%"), S = Rt(n, "%webView_inventory_scope_chapter%"), k = Rt(n, "%webView_inventory_scope_verse%"), E = Rt(n, "%webView_inventory_filter_text%"), $ = Rt(
    n,
    "%webView_inventory_show_additional_items%"
  ), P = Rt(n, "%webView_inventory_no_results%"), [A, x] = M(!1), [C, y] = M("all"), [_, O] = M(""), [V, H] = M([]), I = B(() => {
    const j = e ?? [];
  ...
  }, [A, I]), T = B(() => F.length === 0 ? [] : Pc(F, C, _), [F, C, _]), G = B(() => {
    var ft, xt;
    if (!A) return c;
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? $ })
      ] })
    ] }),
...
function Jp({
  ...
  J(() => {
    if (l) {
      const y = S.getSelectedRowModel().rowsById, _ = Object.keys(y);
      if (_.length === 1) {
        const O = N.find((V) => fo(V) === _[0]) || void 0;
        O && l(O);
      }
    }
  }, [u, N, l, S]);
  ...
  }, x = (y, _) => y.getIsGrouped() ? "" : h("banded-row", _ % 2 === 0 ? "even" : "odd"), C = (y, _, O) => {
    if (!((y == null ? void 0 : y.length) === 0 || _.depth < O.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(_e, { position: "item-aligned", children: /* @__PURE__ */ o(ac, { children: $.map((y) => /* @__PURE__ */ o(_t, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(An, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Vn, { children: S.getHeaderGroups().map((y) => /* @__PURE__ */ o(Pt, { children: y.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(sn, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ze(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, y.id)) }),
      /* @__PURE__ */ o(Pn, { children: S.getRowModel().rows.map((y, _) => {
        const O = ct();
        return /* @__PURE__ */ o(
          Pt,
          {
                  ...
                  xe,
                  {
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ o(ye, {}),
                          !y.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ o(Oe, {}) : /* @__PURE__ */ o(Qn, {})),
                          " ",
...
function wd({
  ...
  }, [v, S] = M(!1), [k, E] = M(""), $ = et(void 0), P = et(!1);
  ...
  const A = B(() => Q.allBookIds.filter(
    ...
    (I, F = !1) => {
      ...
      const T = A.findIndex((pt) => pt === $.current), G = A.findIndex((pt) => pt === I);
      if (T === -1 || G === -1) return;
      const [it, Kt] = [
        Math.min(T, G),
        Math.max(T, G)
    ...
    C(I, P.current), P.current = !1;
  }, _ = (I, F) => {
    I.preventDefault(), C(F, I.shiftKey);
  }, O = z(
    (I) => {
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Rr,
        {
          ...
          children: S.map(({ value: k, label: E, id: $ }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(Cn, { className: "tw-me-2", value: k, id: $ }),
            /* @__PURE__ */ o(wt, { htmlFor: $, children: E })
          ] }, $))
        }
      )
    ] }),
...
function lu({
  ...
  const w = gd(
    ...
    var S, k, E, $, P, A;
    const v = N !== g ? ((k = (S = e[g]) == null ? void 0 : S.uiNames) == null ? void 0 : k[N]) ?? (($ = (E = e[g]) == null ? void 0 : E.uiNames) == null ? void 0 : $.en) : void 0;
    return v ? `${(P = e[g]) == null ? void 0 : P.autonym} (${v})` : (A = e[g]) == null ? void 0 : A.autonym;
  };
