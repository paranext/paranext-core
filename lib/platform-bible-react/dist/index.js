...
import { r as jt, Z as Ii, B, c as g, a as Vi, C as Te, P as ze, b as Ie, d as Se, e as Ve, f as Le, g as pe, h as _r, i as ta, T as te, S as Qe, j as ee, k as re, l as ae, D as Ge, m as br, n as _e, o as Ne, p as Ce, u as Li, q as Nr, s as He, t as Re, v as za, w as sn, x as Fi, y as ji, z as cn, A as ln, E as Bi, F as Ui, G as Ki, H as qi, I as da, J as wa, K as ir, L as Gi, M as Hi, N as Yi, O as Wi, Q as Xi, R as Cr, U as Ga } from "./resizable-CUvCloPJ.js";
import { V as Uh, W as Kh, X as qh, Y as Gh, _ as Hh, $ as Yh, a0 as Wh, a1 as Xh, a2 as Jh } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as tt } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Rr, Section as Z, getChaptersForBook as Ji, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as Zi, formatReplacementString as xe, sanitizeHtml as Qi, NumberFormat as ts, formatBytes as es, getCurrentLocale as rs, usfmMarkers as Fr, getFormatCallerFunction as as, deepEqual as os, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as ns, getLocalizeKeyForScrollGroupId as vo, collectUsjMarkers as is } from "platform-bible-utils";
import { Check as Ae, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as ss, ArrowRight as cs, ChevronDown as tr, BoldIcon as ls, ItalicIcon as ds, X as ea, AtSign as dn, Pencil as ws, Trash2 as us, ArrowUp as wn, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as un, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, ChevronsUpDown as pn, Star as Es, Undo as Ts, Redo as zs, SquareX as hn, FunctionSquare as gn, SquareSigma as fn, Ban as Ss, AlertCircle as $a, CircleCheckIcon as Ds, CircleXIcon as Os, CircleHelpIcon as $s, ArrowUpIcon as Ms, ArrowDownIcon as Rs, Search as As, LoaderCircle as Ps, ScrollText as Is, MenuIcon as Vs, Menu as Ls, EllipsisVertical as Fs, MoreVertical as ko } from "lucide-react";
import ut, { useRef as q, useMemo as L, useState as N, useCallback as F, useEffect as Y, useLayoutEffect as Xt, createContext as Ha, useContext as mn, Component as js, createElement as _o, Suspense as Bs, forwardRef as ra, Fragment as vn } from "react";
import { Dialog as he, Label as Us, RadioGroup as Ma, ToggleGroup as bn, Slot as sr, Avatar as Ya, Select as Pt, Checkbox as No, Tabs as le, Menubar as me, ContextMenu as St, Progress as Co, Slider as Ar, Switch as Eo } from "radix-ui";
import { createEditor as xn, $getRoot as Pe, $createParagraphNode as Er, $getSelection as Ft, HISTORY_MERGE_TAG as Wa, ParagraphNode as yn, TextNode as kn, $getPreviousSelection as Ks, $isRangeSelection as ge, $caretFromPoint as qs, $getSiblingCaret as _n, $getChildCaret as Gs, $getAdjacentChildCaret as Hs, $isChildCaret as Ys, $normalizeCaret as Ws, $setSelectionFromCaretRange as Xs, $getCollapsedCaretRange as Js, $getCaretInDirection as To, $splitAtPointCaretNext as Zs, $isTextPointCaret as Qs, $findMatchingParent as Nn, $isElementNode as xr, mergeRegister as Ee, getDOMTextNode as tc, isHTMLElement as ec, CLEAR_EDITOR_COMMAND as Cn, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as rc, defineExtension as oe, safeCast as Ye, createState as ac, FORMAT_TEXT_COMMAND as En, $isNodeSelection as Tn, COMMAND_PRIORITY_LOW as zn, RootNode as oc, LineBreakNode as nc, TabNode as ic, $isEditorState as sc, createCommand as cc, CLICK_COMMAND as lc, isDOMNode as dc, $getNodeFromDOMNode as wc, $createNodeSelection as uc, $setSelection as pc, $getEditor as hc, DecoratorNode as Ra, $getState as gc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as fc, $setState as mc, addClassNamesToElement as Sn, $create as vc, $getNodeByKey as bc, removeClassNamesFromElement as xc, KEY_TAB_COMMAND as yc, $isBlockElementNode as kc, $createRangeSelection as _c, $normalizeSelection__EXPERIMENTAL as Nc, OUTDENT_CONTENT_COMMAND as Cc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Ec, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Tc, $isParagraphNode as zc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Dn, $insertNodes as Sc } from "lexical";
import { HeadingNode as Dc, QuoteNode as Oc, registerRichText as $c } from "@lexical/rich-text";
import { flushSync as Mc, createPortal as Rc } from "react-dom";
...
import { useReactTable as Mn, getFilteredRowModel as Wc, getSortedRowModel as Rn, getPaginationRowModel as Xc, getCoreRowModel as An, flexRender as mr, getGroupedRowModel as Jc, getExpandedRowModel as Zc } from "@tanstack/react-table";
import Qc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as tl, isInsertEmbedOpOfType as Pr, Editorial as el } from "@eten-tech-foundation/platform-editor";
...
const In = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), se = Object.fromEntries(
  In.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function Qa(t, e, r) {
...
function cl({
  ...
  return /* @__PURE__ */ u(ze, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Se, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(pe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Te,
      {
        onSelect: () => f(h),
...
function Fn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a("div", { className: g("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function ga({
  ...
  const C = jt(), [k, _] = N(!1), [I, j] = N(""), [V, $] = N(""), [x, z] = N("books"), [A, D] = N(void 0), [O, W] = N(
    void 0
  ), [K, M] = N(void 0), [Q, mt] = N(!1), ct = q(null), Bt = q(!1), bt = q(void 0), Dt = q(void 0), U = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = F(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const Vt = F(() => {
    ...
    () => dl(V),
    [V]
  ), kt = L(() => !l || !S || !S.chapterNum || !pt ? !1 : l(S.book, S.chapterNum) > 0, [l, S, pt]), je = F(
    (b) => w ? Oo(b, w) : !1,
    [w]
  ), Oe = F(
    (b) => (G) => w ? wl(b, G, w) : !1,
    ...
    [w]
  ), Be = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", dr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", wr = F(
    (b) => {
    ...
    (b) => {
      var Jt, We, ur;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: J } = $o(b.key);
      ...
      if ((x === "chapters" || x === "books" && S) && Et) {
        const Mt = x === "chapters" ? A : S == null ? void 0 : S.book;
        if (!Mt) return;
  ...
  return Xt(() => {
    const b = setTimeout(() => {
      if (k && x === "books" && U.current && rt.current) {
        const G = U.current, J = rt.current, Et = J.offsetTop, Jt = G.clientHeight, We = J.clientHeight, ur = Et - Jt / 2 + We / 2;
        G.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), j(Ln(t.book));
              ...
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    ...
                    tabIndex: -1,
                    children: C === "ltr" ? /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                ...
                x === "books" && /* @__PURE__ */ u(tt, { children: [
                  ...
                  S && kt && S.chapterNum && l && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Me(S.book, n)} ${S.chapterNum}` }),
                  ...
                  S && !kt && ue(S.book) > 1 && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Me(S.book, n) }),
...
function Ao({
  ...
  const [k, _] = N(!1), I = l ?? d, j = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, x) => {
    ...
    /* @__PURE__ */ a(
      Se,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: j(e) ? e.map(($) => /* @__PURE__ */ a(pe, { heading: $.groupHeading, children: $.options.map((x) => V(x, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(pe, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
function Gu({
  ...
  const w = fa(l, "%webView_bookSelector_currentBook%"), p = fa(l, "%webView_bookSelector_choose%"), f = fa(l, "%webView_bookSelector_chooseBooks%"), [h, m] = N(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    m(v), t(v);
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(Nt, { className: "tw:ms-1", children: f })
          ] }),
...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Un ? Xt : Y, Ir = { tag: Wa };
function vl({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = fl(null, o), w = xn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, f) {
      if (f !== null) {
        if (f === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            const m = Er();
            h.append(m);
            const y = Un ? document.activeElement : null;
            (Ft() !== null || y !== null && y === p.getRootElement()) && m.select();
          }
        }, Ir);
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
const Cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function El(t) {
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Sl = Kn && "documentMode" in document ? document.documentMode : null;
!(!Kn || !("InputEvent" in window) || Sl) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Ol(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: f } = n.getBoundingClientRect(), h = zl(t, e);
    var m, y;
...
function Ml(t, e = $l) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = f.getNode(), y = m.getKey(), v = f.offset, T = h.getNode(), C = T.getKey(), k = h.offset, _ = t.getElementByKey(y), I = t.getElementByKey(C), j = r === null || _ !== o || v !== n || y !== r.getKey(), V = i === null || I !== s || k !== c || C !== i.getKey();
      if ((j || V) && _ !== null && I !== null) {
        const $ = function(x, z, A, D, O, W, K) {
          const M = (x._window ? x._window.document : document).createRange();
          return M.setStart(...Po(z, A, D)), M.setEnd(...Po(O, W, K)), M;
        }(t, f, m, _, h, T, I);
        d(), d = Ol(t, $, e);
      }
...
function Pl(t) {
  const e = Ft() || Ks();
  let r;
  if (ge(e)) r = qs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = _n(c, "next"));
    }
    r = r || Gs(Pe(), "previous").getFlipped().insert(Er());
  }
  const o = Il(t, r), n = Hs(o), i = Ys(n) ? Ws(n) : o;
  return Xs(Js(i)), t.getLatest();
}
function Il(t, e, r) {
  let o = To(e, "next");
  for (let n = o; n; n = Zs(n, r)) o = n;
  return Qs(o) && Hr(283), o.insert(t.isInline() ? Er().append(t) : t), To(_n(t.getLatest(), "next"), e.direction);
}
function Vl(t) {
  const e = Ft();
  if (!ge(e)) return !1;
...
let Yr, ke = 0, Wr = 0, jl = 0, Ba = 0, Br = 0;
function Vo(t) {
  if (et === void 0) return;
  let e = t.n;
...
function Ul(t) {
  ...
  Gn(this), et = t, this.f &= -2, 8 & this.f && ro(this), oa();
}
function Je(t, e) {
...
At.prototype.brand = Ll, At.prototype.h = function() {
  return !0;
  ...
  return et = t, Gn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Hn(this), Lo(this), ke++;
  const t = et;
  return et = this, Ul.bind(this, t);
...
function Yn() {
  const t = Pe(), e = Ft(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function Wn(t, e = Yn) {
  return t.registerCommand(Cn, (r) => (t.update(e), !0), Xa);
}
oe({ build: (t, e, r) => cr(e), config: Ye({ $onClear: Yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return fe(() => Wn(t, o.value));
} });
function Kl(t) {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [Xn], register: (t, e, r) => t.registerCommand(En, (o) => {
  const n = Ft();
  if (Tn(n) || ge(n)) for (const i of n.getNodes()) ql(i) && i.toggleFormat(o);
  return !1;
}, zn) });
function Jn(t, e) {
  let r;
...
const Ua = oe({ build: (t) => Jn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function Gl(t) {
  return function(e) {
    return e.id === Ka;
  }(t) || lt(305, String(t.id), String(Ka)), Object.assign(t, { id: Qn });
}
...
const Xl = oe({ config: Ye({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [oc, kn, nc, ic, yn] }), jo = Symbol.for("@lexical/extension/LexicalBuilder");
function Bo() {
}
function Jl(t) {
  throw t;
...
class Ze {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const f of Kl(p)) {
...
const Zl = /* @__PURE__ */ new Set(), Uo = oe({ build(t, e, r) {
...
oe({ dependencies: [Ua, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [er], register(t, e, r) {
  ...
  return Ee(t.registerCommand(Ql, (s) => {
    const c = Ft();
    if (!ge(c)) return !1;
    ...
    if (dc(s.target)) {
      ...
      if (ed(c)) return function(d, l = !1) {
        const w = Ft(), p = d.isSelected(), f = d.getKey();
        let h;
        l && Tn(w) ? h = w : (h = uc(), pc(h)), p ? h.delete(f) : h.add(f);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function rd(t, e, r = ei) {
  return Ee(t.registerCommand(yc, (o) => {
    const n = Ft();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      if (p.canIndent()) {
        const f = p.getKey();
        let h = _c();
        if (h.anchor.set(f, 0, "element"), h.focus.set(f, 0, "element"), h = Nc(h), h.anchor.is(l)) return !0;
      }
      return !1;
...
oe({ build: (t, e, r) => cr(e), config: Ye({ $canIndent: ei, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return fe(() => {
    if (!o.value) return rd(t, n, i);
  });
} });
const ad = oe({ name: "@lexical/react/ReactProvider" });
function od() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(m)) {
                ...
                if (Aa(v) && l >= 0 && w >= 0 && (T = l, C = l + w, m.setTextNodeRange(v, T, v, C)), T === C && p === "" || (m.insertRawText(p), v = y.getNode()), Aa(v)) {
                  T = f, C = f + h;
...
oe({ build: (t, e, r) => cr(e), config: Ye({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : ai(t)) });
function sd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return no(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (f) => r._onError(f), children: a(Bs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function dd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    no(() => Ee($c(n), ai(n)), [n]);
  }(o), u(tt, { children: [t, a(wd, { content: e }), a(ld, { editor: o, ErrorBoundary: r })] });
}
...
function gd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: f, autoCapitalize: h, className: m, id: y, role: v = "textbox", spellCheck: T = !0, style: C, tabIndex: k, "data-testid": _, ...I }, j) {
  ...
  return oi(() => ($(t.isEditable()), t.registerEditableListener((A) => {
    $(A);
...
function vd(t, e) {
  ...
  return u(tt, { children: [a(fd, { editor: n, ...o, ref: e }), r != null && a(bd, { editor: n, content: r })] });
}
...
function _d({
  ...
  const [e] = ve(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = kd(), d = () => {
  };
...
function Ed() {
  const { activeEditor: t } = ii(), [e, r] = N([]), o = F((n) => {
    if (ge(n) || Gc(n)) {
      const i = [];
      Go.forEach(({ format: s }) => {
...
function Yu({
  ...
  const [i, s] = N($d), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), f = q(null);
  Y(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
...
function Yo({
  ...
  const h = F(
    ...
    [t.user]
  ), C = L(() => Qi(t.contents), [t.contents]), k = L(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
          {
            onClick: (_) => {
              _.stopPropagation(), l(!0), p(Dd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ad, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Pd, { className: "tw:text-xs tw:font-medium", children: T }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), h()) : co(_) && (_.preventDefault(), _.stopPropagation(), Zt(w) && m());
              },
              onKeyDown: (_) => {
        ...
        k && /* @__PURE__ */ u(_e, { children: [
          /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
...
function Id({
  ...
  const [$, x] = N(Wo), [z, A] = N(), [D, O] = N(), W = o, [K, M] = N(!1), [Q, mt] = N(!1), [ct, Bt] = N(!1), [bt, Dt] = N(!1), [U, rt] = N(!1), [ot, nt] = N(_), [it, It] = N(!1), vt = q(void 0), [Ut, Kt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let E = !0;
    return (async () => {
  ...
  const Vt = L(() => Ot[0], [Ot]), ne = q(null), qt = q(void 0), $t = F(() => {
    var E;
    (E = qt.current) == null || E.call(qt), x(Wo);
  }, []), De = F(() => {
    const E = !ot;
  ...
  const gt = F(
    ...
    async (E) => {
      const wt = Zt($) ? Jr($) : void 0, pt = E.status ? E.assignedUser : z ?? E.assignedUser, kt = await p({
        ...E,
        contents: wt,
        assignedUser: pt
      });
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                B,
                {
                  ...
                  children: ot ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(gs, {})
                }
              ),
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ...
              v !== !1 && (!Q || Zt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (E) => {
                    co(E) && (E.preventDefault(), E.stopPropagation(), (Zt($) || z !== void 0 && z !== D) && gt());
                  },
                  onKeyDown: (E) => {
                    io(E), (E.key === "Enter" || E.key === " ") && E.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Xr,
                        ...
                        /* @__PURE__ */ a(
                          Se,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: y == null ? void 0 : y.map((E) => /* @__PURE__ */ a(
                              ...
                              {
                                onSelect: () => {
                                  A(E !== i ? E : void 0), S.current = "user-selected", O(void 0), Bt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function rp({
  ...
  const [T, C] = N(/* @__PURE__ */ new Set()), [k, _] = N(), [I, j] = N(), V = F(
    async (M) => {
      const Q = await i(M);
  ...
  const $ = r.filter(
    ...
    [T, y]
  ), { listboxRef: D, activeId: O, handleKeyDown: W } = Li({
    options: x,
    onOptionSelect: z
  }), K = F(
    (M) => {
...
function or({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Pt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Pt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Vc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
  ...
  const c = ut.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Gd(h, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), qd(c, y, w.key);
...
function Hd({
  ...
  var j;
  const [w, p] = N([]), [f, h] = N([]), [m, y] = N({}), [v, T] = N({}), C = L(() => e ?? [], [e]), k = Mn({
    data: C,
    columns: t,
    getCoreRowModel: An(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((x, z) => `skeleton-row-${z}`).map((x) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Qt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? I = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, k),
    ...
    n && /* @__PURE__ */ a(Vd, { table: k }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : mr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(un, {}) })
        ] }),
...
function lp({
  ...
  return /* @__PURE__ */ u(ze, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Se, { id: i, className: g("tw:min-w-80 tw:max-w-96", n), children: [
...
function dp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(_e, { children: [
    ...
    /* @__PURE__ */ a(Ce, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(sn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][f],
...
function hi({
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(ze, { open: $, onOpenChange: w ?? C, children: [
    ...
    /* @__PURE__ */ a(Se, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ve, { children: [
...
function Qd({
  ...
  const d = L(() => /Macintosh/i.test(navigator.userAgent), []), l = Qo(n, "%undoButton_tooltip%"), w = Qo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
const ew = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(tt, { children: [
...
function rw({
  ...
  return /* @__PURE__ */ u(_e, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: ew(t, n, r) }) }) }),
...
const aw = (t, e) => t === "f" ? /* @__PURE__ */ u(tt, { children: [
  /* @__PURE__ */ a(gn, {}),
  " ",
...
function nw({
  ...
  return /* @__PURE__ */ u(_e, { children: [
    /* @__PURE__ */ a(te, { children: /* @__PURE__ */ u(ee, { children: [
      /* @__PURE__ */ a(re, { asChild: !0, children: /* @__PURE__ */ a(Ne, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: aw(t, r) }) }) }),
      /* @__PURE__ */ a(ae, { children: /* @__PURE__ */ a("p", { children: ow(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ce, { style: { zIndex: cn }, children: [
...
function tn({
  ...
  return /* @__PURE__ */ u(
    Te,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(sw, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
...
function hp({
  ...
  const [m, y] = N("generated"), [v, T] = N("generated"), [C, k] = N("*"), [_, I] = N("*"), [j, V] = N("f"), [$, x] = N(!1), [z, A] = N(!0), [D, O] = N(!1), W = q(!1), K = q(""), [M, Q] = N(!1), [mt, ct] = N(), [Bt, bt] = N(), [Dt, U] = N(), [rt, ot] = N(), nt = q(null), it = L(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Pr("note", H)) {
      ...
      let xt = "custom";
      ht === Pa ? xt = "generated" : ht === Ia ? xt = "hidden" : ht && (k(ht), I(ht)), y(xt), T(xt), V(((at = H.insert.note) == null ? void 0 : at.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const Ot = () => {
    ...
    if (H && Pr("note", H)) {
      ...
      j !== "x" && P === "x" ? gt == null || gt.forEach((Ct) => dw(Ct)) : j === "x" && P !== "x" && (gt == null || gt.forEach((Ct) => ww(Ct))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, $t = (P) => {
    ...
    if (f.current && It.length && P && P.rangeCount > 0) {
      const H = P.getRangeAt(0).getBoundingClientRect(), st = f.current.getBoundingClientRect();
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(tt, { children: pw(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Qt, { className: o, children: fw(c.text) })
        ]
      },
...
const vw = (t) => {
  ...
  return e ? e[1] : "";
}, xw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", _p = Object.freeze([
...
function Np({
  ...
  const h = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), y = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), C = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), _ = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = de(r, "%webView_inventory_no_results%"), [V, $] = N(!1), [x, z] = N("all"), [A, D] = N(""), [O, W] = N([]), K = L(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : kw(U, n, i);
  }, [t, n, i]), M = L(() => {
    if (V) return K;
    const U = [];
    return K.forEach((rt) => {
  ...
  }, [V, K]), Q = L(() => M.length === 0 ? [] : yw(M, x, A), [M, x, A]), mt = L(() => {
    var ot, nt;
    if (!V) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(rr, { onValueChange: (U) => Bt(U), defaultValue: s, children: [
...
const mi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ps, { size: 35, className: g("tw:animate-spin", t), ...e, ref: r }));
...
function Ep({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = L(
    () => t.filter((O) => !r || O.type === r).filter((O) => Nw(O, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = _w(h), T = L(
    () => Array.from(new Set(t.map((O) => O.bestLanguageName))).map((O) => ({
      label: O,
      value: O
    })),
    [t]
  ), C = p.length === 0 && f.length === 0 && h.length === 0, k = be(n, "%resourcePicker_title%"), _ = be(n, "%resourcePicker_search_placeholder%"), I = be(n, "%resourcePicker_language_filter_any%"), j = be(
    n,
    "%resourcePicker_section_already_selected%"
  ...
  }, [d, T, I, n]), D = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !C && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        ...
        /* @__PURE__ */ a(Ca, { label: V, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          Ca,
          {
            label: $,
        ...
        v && /* @__PURE__ */ a(ce, { className: "tw:border-0", children: /* @__PURE__ */ a(Qt, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: y, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
...
function Tw({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), f = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = jt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Rw({
  ...
  const c = t ? sr.Root : "button", { state: d } = la(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: g(Mw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    zw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(en, { children: [
          ...
          /* @__PURE__ */ a(an, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ a($w, { children: /* @__PURE__ */ a(
            Rw,
            {
              onClick: () => l(h),
              isActive: f(h),
...
const $e = "scrBook", Pw = "scrRef", qe = "source", Iw = "details", Vw = "Scripture Reference", Lw = "Scripture Book", bi = "Type", Fw = "Details";
function jw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, on = (t) => `${Bw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function jp({
  sources: t,
  ...
  const [l, w] = N([]), [p, f] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), y = L(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = y.find((D) => on(D) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [h, y, c, T]);
  const C = n ?? Lw, k = i ?? bi, _ = [
  ...
  }, V = (x, z) => x.getIsGrouped() ? "" : g("banded-row", z % 2 === 0 ? "even" : "odd"), $ = (x, z, A) => {
    ...
    !e && /* @__PURE__ */ u(
      rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(nr, { position: "item-aligned", children: /* @__PURE__ */ a(Ld, { children: _.map((x) => /* @__PURE__ */ a(ie, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: T.getHeaderGroups().map((x) => /* @__PURE__ */ a(ce, { children: x.headers.filter((z) => z.column.columnDef.header).map((z) => (
                  ...
                  Qt,
                  {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        type: "button",
                        children: [
                          x.getIsExpanded() && /* @__PURE__ */ a(tr, {}),
                          !x.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a(Oa, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
...
function Uw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
    ...
    (D, O = !1) => {
      ...
      const W = I.findIndex((ct) => ct === k.current), K = I.findIndex((ct) => ct === D);
      if (W === -1 || K === -1) return;
      const [M, Q] = [
        Math.min(W, K),
        Math.max(W, K)
  ...
  return /* @__PURE__ */ u(
    ze,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Se, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ve,
          {
            shouldFilter: !1,
            onKeyDown: (D) => {
                ...
                Object.values(Z).map((D, O) => {
                  ...
                  if (W.length !== 0)
                    return /* @__PURE__ */ u(vn, { children: [
                      ...
                      O < Object.values(Z).length - 1 && /* @__PURE__ */ a(ln, {})
                    ] }, D);
                })
              ] })
            ]
...
function Up({
  ...
  const _ = zt(
  ...
  }, vt = q(null), Ut = q(null), Kt = q(!1), S = q(null), Ot = q(!1), [Vt, ne] = N(void 0), qt = q(!1), $t = q(!1), De = q(null), Gt = F((R) => {
    if (R) {
    ...
    (R) => {
      f == null || f(R), h == null || h(R), qt.current = !0;
    },
    [f, h]
  ), H = F(
    (R) => {
    ...
    [r, n, m, i]
  ), at = rt.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? ns(nt, it, {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, E] = N(!1), [wt, pt] = N(void 0), [kt, je] = N(void 0), [Oe, lr] = N(void 0), [Be, dr] = N(void 0), [wr, Sr] = N([]), Dr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    qw,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: g(G && Et), children: M }),
      /* @__PURE__ */ a(
        ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: g(J && Et), children: Q }),
      /* @__PURE__ */ a(
        ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: T,
          disableReferencesUpTo: Jt ? Oe ?? nt : nt,
          onOpenChange: Ht,
          onCloseAutoFocus: (R) => {
            var X;
            $t.current && ($t.current = !1, R.preventDefault(), (X = De.current) == null || X.focus());
          },
          className: g(J && Et),
          modal: !0,
          align: "start"
  ...
  const [Wt, Ue] = N(null), [Or, Si] = N(null), [$r, Di] = N(null), Oi = 200, [$i, Mi] = N(!1);
  Y(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const R = new ResizeObserver(([X]) => {
      Mi(X.contentRect.width < Oi);
    });
    return R.observe($r), () => R.disconnect();
  }, [$r]);
  const po = F(
    (R) => {
      je(R), lr(nt), dr(it), Sr(n), E(!1), pt(R);
    },
    [nt, it, n]
  ), ho = F(() => {
    kt !== void 0 && (kt === "range" ? (Oe && (f == null || f(Oe)), Be && (h == null || h(Be))) : kt === "selectedBooks" && i(wr), st(kt), pt(void 0), je(void 0));
  }, [
    kt,
    Oe,
    Be,
  ...
  }, []), fo = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ae, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Nt, { children: D }),
        ...
        /* @__PURE__ */ a(
          Ce,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: $r, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: pr, id: Ri }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
      ...
      La,
      {
        ...
        children: /* @__PURE__ */ u(da, { container: Or, children: [
          ...
          /* @__PURE__ */ u(Do, { children: [
            ...
            /* @__PURE__ */ a(B, { onClick: ho, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(Va, { open: wt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ...
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Mr(!1), children: ct }),
            /* @__PURE__ */ a(B, { ref: De, onClick: ho, children: mt })
          ] })
        ] })
      }
    ) })
...
function qa({
  ...
  return /* @__PURE__ */ u(_e, { variant: i, children: [
    /* @__PURE__ */ a(Ne, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(Ce, { align: "start", style: { zIndex: ir }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(vn, { children: [
      /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(te, { children: _i(e.groups, e.items, d, t) }) }),
...
Ei.displayName = le.List.displayName;
...
Ti.displayName = le.Content.displayName;
function Xp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), gr(s, [f, h]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ a(Ww, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Xw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ir },
          children: /* @__PURE__ */ a(te, { children: zi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(_e, { children: [
              /* @__PURE__ */ a(Ne, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
...
function Rh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: g("pr-twp", uu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Fh(t) {
  const e = L(() => is(t).slice().sort().join(" "), [t]);
...
gu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
