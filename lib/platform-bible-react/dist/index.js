...
import { c as m, g as Ae, a as Ua, C as De, A as de, P as Le, b as Qe, B as q, d as je, e as Be, f as Fe, h as Ee, i as Li, k as ji, j as Bi, E as Fi, l as Ka, r as be, m as Ui, n as wn, o as ea, p as ra, L as Et, R as qa, q as Hr, D as Ca, s as Ea, t as Ta, u as Sa, T as un, v as jr, w as Kt, x as Ga, y as qt, z as Gt, F as Ht, G as pn, H as Ha, I as We, J as _r, K as Te, M as Se, N as ze, S as Nr, O as nr, Q as Ki, U as Tr, V as Je, W as Pe, Z as tr, X as Ie, Y as ir, _ as Ya, $ as Wa, a0 as Yr, a1 as Xa, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as za, a7 as gn, a8 as aa, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as ca, ah as yo, ai as la, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as Sr, ap as Ja, aq as os, ar as ns } from "./resizable-C2eEiE_z.js";
...
import Jt, { useRef as F, useMemo as $, useState as k, useCallback as L, useEffect as K, useImperativeHandle as Gs, useLayoutEffect as Zt, createContext as to, useContext as Cn, Component as Hs, createElement as zo, Suspense as Ys, forwardRef as En, useId as Ro, Fragment as dr } from "react";
import { IconSelector as Tn, IconCheck as oa, IconChevronDown as Ws, IconChevronUp as Xs, IconLayoutSidebar as Js, IconLayoutSidebarRight as Zs, IconChevronRight as Sn, IconSearch as Qs, IconLoader as tc, IconAlertOctagon as ec, IconAlertTriangle as rc, IconInfoCircle as ac, IconCircleCheck as oc } from "@tabler/icons-react";
import { createEditor as zn, $getRoot as Ve, $createParagraphNode as zr, $getSelection as Qt, HISTORY_MERGE_TAG as eo, ParagraphNode as Rn, TextNode as Dn, $getPreviousSelection as nc, $isRangeSelection as me, $caretFromPoint as ic, $getSiblingCaret as On, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as Do, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as Mn, $isElementNode as Cr, mergeRegister as Re, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as ro, shallowMergeConfig as mc, defineExtension as ie, safeCast as er, createState as vc, FORMAT_TEXT_COMMAND as An, $isNodeSelection as In, COMMAND_PRIORITY_LOW as Pn, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as Sc, $getEditor as zc, DecoratorNode as $a, $getState as Rc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as Dc, $setState as Oc, addClassNamesToElement as Vn, $create as Mc, $getNodeByKey as $c, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Ic, $isBlockElementNode as Pc, $createRangeSelection as Vc, $normalizeSelection__EXPERIMENTAL as Lc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Bc, COMMAND_PRIORITY_CRITICAL as ao, $isDecoratorNode as Fc, $isParagraphNode as Uc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as Kc } from "lexical";
...
function pa({
  ...
  const B = be(), [S, _] = k(!1), [T, N] = k(""), [M, U] = k(""), [y, Y] = k("books"), [j, W] = k(void 0), [O, V] = k(
    void 0
  ...
  const { otLong: oe, ntLong: Wt, dcLong: pe, extraLong: A } = {
    ...
    (x) => {
      ...
      if (y === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), re();
        return;
      }
...
function Bo({
  ...
  const [R, P] = k(!1), B = d ?? l, S = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], _ = (T, N) => {
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        children: /* @__PURE__ */ u(Be, { children: [
          ...
          /* @__PURE__ */ a(Fe, { children: S(e) ? e.map((T) => /* @__PURE__ */ a(Ee, { heading: T.groupHeading, children: T.options.map((N) => _(N, T.groupHeading)) }, T.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((T) => _(T)) }) })
        ] })
      }
    )
  ] });
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Yn ? Zt : K, Ir = { tag: eo };
...
function $l(t, e = Ml) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, z = g.getNode(), C = z.getKey(), R = g.offset, P = t.getElementByKey(b), B = t.getElementByKey(C), S = r === null || P !== o || v !== n || b !== r.getKey(), _ = i === null || B !== s || R !== c || C !== i.getKey();
      if ((S || _) && P !== null && B !== null) {
...
function Vl(t, e, r) {
  ...
  return hc(o) && Wr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(On(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Qt();
  if (!me(e)) return !1;
...
const ja = ie({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
ie({ dependencies: [ja, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (me(f)) {
                const b = f.anchor;
                let v = b.getNode(), z = 0, C = 0;
                if (Aa(v) && d >= 0 && w >= 0 && (z = d, C = d + w, f.setTextNodeRange(v, z, v, C)), z === C && p === "" || (f.insertRawText(p), v = b.getNode()), Aa(v)) {
                  z = h, C = h + g;
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ho(v) && (v.preventDefault(), v.stopPropagation(), ne(i) && g());
        },
        onKeyDown: (v) => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), g()) : ho(S) && (S.preventDefault(), S.stopPropagation(), ne(w) && f());
              },
              onKeyDown: (S) => {
                po(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
              },
              onClick: (S) => {
                S.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ u(Te, { children: [
          ...
          /* @__PURE__ */ a(ze, { align: "end", children: B })
        ] })
      ]
    }
  );
...
function xi({
  ...
  const Mt = $(() => dt[0], [dt]), Oe = F(null), te = F(void 0), ee = L(() => {
    var E;
  ...
  }, [i, r]), $t = $(() => dt.slice(1), [dt]), Rt = $(() => $t.length ?? 0, [$t.length]), ae = $(() => Rt > 0, [Rt]), oe = $(() => Q || Rt <= 2 ? $t : $t.slice(-2), [$t, Rt, Q]), Wt = $(() => Q || Rt <= 2 ? 0 : Rt - 2, [Rt, Q]), pe = $(
  ...
  const J = L(
    ...
    async (E) => {
      const ot = ne(y) ? Qr(y) : void 0, et = E.status ? E.assignedUser : j ?? E.assignedUser, st = await p({
        ...E,
        contents: ot,
        assignedUser: et
      });
          ...
          o && /* @__PURE__ */ u(lt, { children: [
            ...
            v !== !1 && (!yt || ne(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (E) => {
                  ho(E) && (E.preventDefault(), E.stopPropagation(), (ne(y) || j !== void 0 && j !== O) && J());
                },
                onKeyDown: (E) => {
...
function wp({
  ...
  const [C, R] = k(/* @__PURE__ */ new Set()), [P, B] = k(), [S, _] = k(), T = L(
    async (V) => {
      const X = await i(V);
...
function Jd({
  ...
  var S;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [v, z] = k({}), C = $(() => e ?? [], [e]), R = Bn({
    data: C,
    columns: t,
    getCoreRowModel: Un(),
  ...
  let B;
  return l ? B = Array.from({ length: 10 }).map((N, M) => `skeleton-row-${M}`).map((N) => /* @__PURE__ */ a(Ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((S = R.getRowModel().rows) == null ? void 0 : S.length) > 0 ? B = R.getRowModel().rows.map((_) => /* @__PURE__ */ a(
    Ie,
    {
      onClick: () => s(_, R),
...
function sw({
  ...
  return /* @__PURE__ */ u(Te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
function dw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
...
function fw(t) {
  const e = t.querySelector(":scope > .char");
  if (!e) return;
...
function yp({
  ...
  const [C, R] = k("generated"), [P, B] = k("generated"), [S, _] = k("*"), [T, N] = k("*"), [M, U] = k("f"), [y, Y] = k(!1), [j, W] = k(!0), [O, V] = k(!1), X = F(!1), Q = F(""), [pt, yt] = k(!1), [Pt, G] = k(), [tt, ht] = k(), [at, mt] = k(), [ue, Tt] = k(), kt = F(null), Vt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const gt = L(
    ...
    [r, d]
  ), Yt = F(void 0), D = F({ callerType: C, customCaller: S });
  K(() => {
...
const Tw = (t) => {
  ...
  return e ? e[1] : "";
}, zw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rp = Object.freeze([
...
function Dp({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), b = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), z = ge(r, "%webView_inventory_scope_currentBook%"), C = ge(r, "%webView_inventory_scope_chapter%"), R = ge(r, "%webView_inventory_scope_verse%"), P = ge(r, "%webView_inventory_filter_text%"), B = ge(
    r,
    "%webView_inventory_show_additional_items%"
...
const Ow = "16rem", Mw = "3rem", _i = Jt.createContext(void 0);
function sa() {
...
function Gp({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ya, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Wa, { children: z.getHeaderGroups().map((N) => /* @__PURE__ */ a(Ie, { children: N.headers.filter((M) => M.column.columnDef.header).map((M) => (
      ...
      /* @__PURE__ */ a(Xa, { children: z.getRowModel().rows.map((N, M) => {
        const U = be();
        return /* @__PURE__ */ a(
          Ie,
          {
...
function Xw({
  ...
  }, [b, v] = k(!1), [z, C] = k(""), R = F(void 0), P = F(!1), B = $(
    () => Ci(t),
    [t]
  ), S = $(() => {
    if (!z.trim()) {
...
function Yp({
  ...
  const P = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = Dt(s, "%webView_scope_selector_verse%"), S = Dt(s, "%webView_scope_selector_chapter%"), _ = Dt(s, "%webView_scope_selector_book%"), T = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), N = Dt(
    s,
  ...
  ], G = (I, Z, Xt = !1) => /* @__PURE__ */ u(lt, { children: [
    I,
  ...
  ), ce = Yt === "end", Dr = Yt === "start", rr = "tw:text-muted-foreground", Ke = d === "dropdown" && A === "range", x = Ke ? ot : ee, rt = Ke ? st : g ? ke : ue, It = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    ...
    d === "radio" && t === "range" && It,
    d === "dropdown" && ae && /* @__PURE__ */ a(Ca, { open: A === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: ft,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Ct, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: U }) }),
          se,
    ...
    d === "dropdown" && oe && /* @__PURE__ */ a(Ca, { open: A === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: Nt,
        onCloseAutoFocus: bo,
...
const eu = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Trigger,
  {
    ref: r,
    ...e,
...
function oh({
  ...
  const d = pu(
    ...
    var z, C, R, P, B, S;
    const v = b !== f ? ((C = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : C[b]) ?? ((P = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${(B = t[f]) == null ? void 0 : B.autonym} (${v})` : (S = t[f]) == null ? void 0 : S.autonym;
  };
