import { jsx as r, jsxs as l, Fragment as ae } from "react/jsx-runtime";
import p, { useState as I, useRef as K, useMemo as H, useCallback as j, useLayoutEffect as fn, createContext as Er, useContext as Vr, useEffect as At, forwardRef as Tn, Fragment as Rn } from "react";
import { formatScrRef as ne, getChaptersForBook as Dr, NumberFormat as Mr, formatBytes as Or, deepEqual as Je, isString as Me, compareScrRefs as $e, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
import { X as Ke, Search as En, ChevronsLeft as gn, ChevronsRight as bn, ChevronLeft as Xe, ChevronRight as oe, ArrowLeft as zr, Circle as We, ChevronsUpDown as Ze, Check as $t, FilterIcon as Br, ChevronDown as ye, ChevronUp as Ar, ArrowLeftIcon as Pr, ChevronLeftIcon as Ir, ChevronRightIcon as jr, ArrowRightIcon as $r, Copy as Xr, Filter as Fr, User as Lr, Link as Gr, CircleHelp as Hr, Star as Yr, CircleCheckIcon as Ur, CircleXIcon as qr, CircleHelpIcon as Jr, ArrowUpIcon as Kr, ArrowDownIcon as Wr, ArrowUpDownIcon as Zr, PanelLeft as Qr, PanelRight as ta, ScrollText as ea, MenuIcon as na, Menu as ra, EllipsisVertical as aa, LoaderCircle as oa } from "lucide-react";
import { Slot as Yt } from "@radix-ui/react-slot";
import { cva as Rt } from "class-variance-authority";
import { clsx as sa } from "clsx";
import { extendTailwindMerge as ia } from "tailwind-merge";
...
import { useReactTable as Dn, getFilteredRowModel as wa, getSortedRowModel as Mn, getPaginationRowModel as la, getCoreRowModel as On, flexRender as re, getGroupedRowModel as da, getExpandedRowModel as ca } from "@tanstack/react-table";
...
var fa = Object.defineProperty, ga = (t, e, n) => e in t ? fa(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => ga(t, typeof e != "symbol" ? e + "" : e, n);
const Pt = [
  "GEN",
  "EXO",
  "LEV",
...
const et = class M {
    ...
    if (E(this, "firstChapter"), E(this, "lastChapter"), E(this, "lastVerse"), E(this, "hasSegmentsDefined"), E(this, "text"), E(this, "BBBCCCVVVS"), E(this, "longHashCode"), E(this, "versification"), E(this, "rtlMark", "‏"), E(this, "_bookNum", 0), E(this, "_chapterNum", 0), E(this, "_verseNum", 0), E(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof M) {
          ...
          if (e == null) return;
          const s = e instanceof Ot ? e : M.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Ot(i)), n ? new M(n, a.toString(), w, u) : new M();
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || O.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !M.isVerseParseable(a[1]))
      throw new Qt("Invalid reference : " + e);
...
*/
E(et, "ValidStatusType", Xn);
class Qt extends Error {
}
const Ra = ia({ prefix: "tw-" });
function d(...t) {
  return Ra(sa(t));
}
const Ea = Rt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Yt : "button", { className: d(Ea({ variant: e, size: n, className: t })), ref: s, ...o })
);
z.displayName = "Button";
const Va = "layoutDirection";
function q() {
  const t = localStorage.getItem(Va);
  return t === "rtl" ? t : "ltr";
}
const Da = ft.Portal, Fn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
const Ma = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = q();
  return /* @__PURE__ */ l(Da, { children: [
    /* @__PURE__ */ r(Fn, {}),
    /* @__PURE__ */ l(
      ft.Content,
      {
...
Ma.displayName = ft.Content.displayName;
...
Oa.displayName = ft.Title.displayName;
...
za.displayName = ft.Description.displayName;
...
ce.displayName = rt.displayName;
const pe = p.forwardRef(({ className: t, ...e }, n) => {
  const a = q();
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(En, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      rt.Input,
      {
        ref: n,
...
pe.displayName = rt.Input.displayName;
...
ue.displayName = rt.List.displayName;
const ke = p.forwardRef((t, e) => /* @__PURE__ */ r(rt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ke.displayName = rt.Empty.displayName;
const Bt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Group,
  {
    ref: n,
    className: d(
...
Bt.displayName = rt.Group.displayName;
...
Ln.displayName = rt.Separator.displayName;
const _t = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Item,
  {
    ref: n,
    className: d(
...
_t.displayName = rt.Item.displayName;
const me = se.Root, he = se.Trigger, Jt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = q();
...
Jt.displayName = se.Content.displayName;
const Gn = O.allBookIds.filter(
  ...
  ze.BOOK_ONLY,
  ze.BOOK_CHAPTER,
  ze.BOOK_CHAPTER_VERSE
];
function Dt(t) {
  return Dr(O.bookIdToNumber(t));
}
function qs({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = q(), [s, i] = I(!1), [w, u] = I(""), [c, m] = I(""), [b, h] = I("books"), [f, x] = I(void 0), _ = K(void 0), N = K(void 0), S = K(void 0), C = K({}), D = H(() => a ? a() : Gn, [a]), B = H(() => ({
    OT: D.filter((k) => O.isBookOT(k)),
    NT: D.filter((k) => O.isBookNT(k)),
    DC: D.filter((k) => O.isBookDC(k)),
    Extra: D.filter((k) => O.extraBooks().includes(k))
  }), [D]), T = H(() => Object.values(B).flat(), [B]), gt = H(() => {
    if (!c.trim()) return B;
    const g = c.toLowerCase(), k = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((Y) => {
      k[Y] = B[Y].filter((Q) => nt[Q].toLowerCase().includes(g) || Q.toLowerCase().includes(g));
    }), k;
  }, [B, c]), kt = j(
    (g) => {
      if (!g.trim()) return;
      const k = Aa.reduce(
        (P, Y) => {
          if (P) return P;
          const Q = Y.exec(g.trim());
          if (Q) {
            const [tt, vt = void 0, ut = void 0] = Q.slice(1);
            let wt;
            const Zt = ((ot) => Object.keys(nt).find(
              (mt) => nt[mt].toLowerCase() === ot.toLowerCase()
            ))(tt);
            if (Zt && T.includes(Zt) && (wt = Zt), !wt && O.isBookIdValid(tt)) {
              const ot = tt.toUpperCase();
              T.includes(ot) && (wt = ot);
            }
            if (!wt) {
              const ot = tt.toLowerCase(), mt = T.filter((Vt) => nt[Vt].toLowerCase().includes(ot) || Vt.toLowerCase().includes(ot));
              mt.length === 1 && ([wt] = mt);
            }
            if (wt) {
              const ot = vt ? parseInt(vt, 10) : void 0;
              if (ot && ot > Dt(wt)) return;
              const mt = ut ? parseInt(ut, 10) : void 0;
              return {
                book: wt,
                chapterNum: ot,
                verseNum: mt
    ...
    (g, k) => {
      if (!k) return 1;
      const P = k.toLowerCase(), Y = g.toLowerCase();
      return v && (Y.includes(v.book.toLowerCase()) && Y.includes(nt[v.book].toLowerCase()) || g.includes(v.book) && g.includes(nt[v.book])) || Y.includes(P) ? 1 : 0;
    },
    [v]
  ), F = j(() => {
    v && (e({
    ...
    (g) => {
      const k = b === "chapters" ? f : v == null ? void 0 : v.book;
      k && (e({
        book: k,
        chapterNum: g,
        verseNum: 1
      }), i(!1), h("books"), x(void 0), m(""));
    },
    [e, b, f, v]
  ), bt = j(() => {
    h("books"), x(void 0), setTimeout(() => {
    ...
    if (t.chapterNum > 1)
      ...
      const g = T.indexOf(t.book);
      if (g > 0) {
        const k = T[g - 1], P = Math.max(Dt(k), 1);
        e({
          book: k,
          chapterNum: P,
          verseNum: 1
    ...
    {
      onClick: Z,
      disabled: T.indexOf(t.book) === 0,
      title: "Previous Book",
      icon: o === "ltr" ? gn : bn
    },
    {
      onClick: Xt,
      disabled: t.chapterNum === 1 && T.indexOf(t.book) === 0,
      title: "Previous Chapter",
      icon: o === "ltr" ? Xe : oe
    },
    {
      onClick: Et,
      disabled: (t.chapterNum === Dt(t.book) || Dt(t.book) === -1) && T.indexOf(t.book) === T.length - 1,
      title: "Next Chapter",
      icon: o === "ltr" ? oe : Xe
    },
    {
      onClick: Kt,
      disabled: T.indexOf(t.book) === T.length - 1,
      title: "Next Book",
      icon: o === "ltr" ? bn : gn
    }
  ], [
    ...
    (g) => {
      ...
      i(g), g && (h("books"), x(void 0), m(""));
    },
    [b, bt]
  ), it = j(
    (g) => v ? !!v.chapterNum && !g.toString().includes(v.chapterNum.toString()) : !1,
    [v]
  ), pt = H(() => ne(t, "English"), [t]), L = H(() => {
    const g = f ?? (v == null ? void 0 : v.book);
    if (!g) return;
    const k = Dt(g), P = nt[g];
    return {
      endChapter: k,
      bookName: P,
      selectedChapter: t.book === g ? t.chapterNum : 0
    };
  }, [f, v == null ? void 0 : v.book, t.book, t.chapterNum]), Wt = j((g, k) => `${g} ${nt[g]}${k ? ` ${k}` : ""}`, []), hn = j((g) => (k) => {
    C.current[g] = k;
  }, []), Tr = j((g) => {
    (g.key === "Home" || g.key === "End") && g.stopPropagation();
  }, []), Rr = j(
    (g) => {
      const k = /^[a-zA-Z]$/.test(g.key), P = /^[0-9]$/.test(g.key);
      if (b === "chapters") {
        if (g.key === "Backspace") {
          g.preventDefault(), g.stopPropagation(), bt();
          return;
        }
        if (k || P) {
          if (g.preventDefault(), g.stopPropagation(), h("books"), x(void 0), P && f) {
            const Y = nt[f];
            m(`${Y} ${g.key}`);
          } else
            m(g.key);
      ...
      if (b === "books" && (k || P)) {
        g.preventDefault(), g.stopPropagation(), m((Y) => Y + g.key), setTimeout(() => {
          _.current && _.current.focus();
        }, 0);
        return;
      }
      if ((b === "chapters" || b === "books" && v) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(g.key)) {
        const Y = b === "chapters" ? f : v == null ? void 0 : v.book;
        if (!Y) return;
        const Q = (() => {
          if (!w) return 1;
          const xt = w.match(/(\d+)$/);
          return xt ? parseInt(xt[1], 10) : 1;
        })(), tt = L == null ? void 0 : L.endChapter;
        if (!tt) return;
        const vt = (xt, Zt, ot) => {
          for (let mt = 1; mt <= ot; mt++) {
            const Vt = xt + Zt * mt;
            if (Vt < 1 || Vt > tt) break;
            if (!it(Vt))
              return Vt;
        ...
        ut !== Q && (g.preventDefault(), g.stopPropagation(), u(Wt(Y, ut)), setTimeout(() => {
          const xt = C.current[ut];
  ...
  return fn(() => {
    const g = setTimeout(() => {
      if (s && b === "books" && N.current && S.current) {
        const k = N.current, P = S.current, Y = P.offsetTop, Q = k.clientHeight, tt = P.clientHeight, vt = Y - Q / 2 + tt / 2;
        k.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), u(Wt(t.book));
  ...
  }, [s, b, c, v, t.book, Wt]), fn(() => {
    if (b === "chapters" && f) {
      const g = f === t.book;
      setTimeout(() => {
        if (N.current)
          if (g) {
            const k = C.current[t.chapterNum];
    ...
    t.book,
    t.chapterNum
  ]), /* @__PURE__ */ l(me, { open: s, onOpenChange: W, children: [
    /* @__PURE__ */ r(he, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
        ...
        role: "combobox",
        "aria-expanded": s,
        className: d("tw-h-8 tw-min-w-48", n),
        children: pt
      }
    ) }),
    /* @__PURE__ */ r(Jt, { className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      ce,
      {
        onKeyDown: Rr,
        loop: !0,
        ...
        filter: y,
        children: [
          b === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            /* @__PURE__ */ r(
              pe,
              {
                ref: _,
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: R.map(({ onClick: g, disabled: k, title: P, icon: Y }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r("span", { className: "tw-text-sm tw-font-medium", children: L == null ? void 0 : L.bookName })
          ] }),
          /* @__PURE__ */ l(ue, { ref: N, children: [
            b === "books" && /* @__PURE__ */ l(ae, { children: [
              !v && Object.entries(gt).map(([g, k]) => {
                if (k.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses BookType as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Bt, { heading: Ba[g], children: k.map((P) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: d(
                          "tw-mx-1 tw-my-1 tw-border-b-0 tw-border-e-0 tw-border-s-2 tw-border-t-0 tw-border-solid",
                          {
                            "tw-border-s-red-200": g.toLowerCase() === "ot",
                            "tw-border-s-purple-200": g.toLowerCase() === "nt",
                            "tw-border-s-indigo-200": g.toLowerCase() === "dc",
                            "tw-border-s-amber-200": g.toLowerCase() === "extra"
                          }
                        ),
                        children: /* @__PURE__ */ r(
                          _t,
              ...
              v && /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r(
                _t,
                {
                  value: `${v.book} ${nt[v.book]} ${v.chapterNum || ""}:${v.verseNum || ""})}`,
                  onSelect: F,
              ...
              v && L && L.endChapter > 1 && /* @__PURE__ */ l(ae, { children: [
                /* @__PURE__ */ l("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: [
                  L.bookName,
                  " - Select Chapter"
                ] }),
                /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-px-4 tw-pb-4", children: Array.from({ length: L.endChapter }, (g, k) => k + 1).map(
                  (g) => /* @__PURE__ */ r(
                    _t,
                    {
                      value: `${v.book} ${nt[v.book]} ${g}`,
                      onSelect: () => J(g),
                      ref: hn(g),
                      className: d(
                        "tw-h-8 tw-w-8 tw-cursor-pointer tw-justify-center tw-rounded-md tw-text-center tw-text-sm",
                        {
                          "tw-bg-primary tw-text-primary-foreground": g === L.selectedChapter
                        }
                      ),
                      disabled: it(g),
                      children: g
            ...
            b === "chapters" && /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-p-4", children: L && Array.from({ length: L.endChapter }, (g, k) => k + 1).map(
              (g) => /* @__PURE__ */ r(
                _t,
                {
                  value: `${f || ""} ${nt[f || ""] || ""} ${g}`,
...
), U = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vn.Root, { ref: n, className: d("pr-twp", Pa(), t), ...e }));
U.displayName = Vn.Root.displayName;
const nn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = q();
  return /* @__PURE__ */ r(
    ie.Root,
    {
...
nn.displayName = ie.Root.displayName;
const be = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ie.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(ie.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(We, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
be.displayName = ie.Item.displayName;
function Ia(t) {
...
function He({
  ...
  const [N, S] = I(!1);
  return /* @__PURE__ */ l(me, { open: N, onOpenChange: S, ..._, children: [
...
var $a = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))($a || {});
...
function Ks({
  ...
  const m = Be(c, "%webView_bookSelector_currentBook%"), b = Be(c, "%webView_bookSelector_choose%"), h = Be(c, "%webView_bookSelector_chooseBooks%"), [f, x] = I(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (N) => {
    x(N), t(N);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(U, { className: "tw-ms-1", children: m })
          ] }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(U, { className: "tw-flex tw-items-center", children: a.map((N) => O.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Hn = $.Trigger, Yn = $.Group, Xa = $.Portal, Fa = $.Sub, La = $.RadioGroup;
function an({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(rn.Provider, { value: n, children: /* @__PURE__ */ r($.Root, { ...e }) });
}
const Un = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    $.SubTrigger,
    {
...
qn.displayName = $.SubContent.displayName;
const Ce = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = q();
...
Ce.displayName = $.Content.displayName;
const Jn = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = q(), s = ct();
  return /* @__PURE__ */ r(
    $.Item,
    {
...
Jn.displayName = $.Item.displayName;
const on = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    $.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r($t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
on.displayName = $.CheckboxItem.displayName;
const Kn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ct();
  return /* @__PURE__ */ l(
    $.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(We, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const sn = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: a,
...
sn.displayName = $.Label.displayName;
const _e = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $.Separator,
  {
    ref: n,
...
_e.displayName = $.Separator.displayName;
...
function Ha({ table: t }) {
  return /* @__PURE__ */ l(an, { children: [
    /* @__PURE__ */ r(pa, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Br, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ l(Ce, { align: "end", className: "tw-w-[150px]", children: [
...
const Lt = G.Root, Ya = G.Group, Gt = G.Value, Ua = Rt(
...
), It = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = q();
  return /* @__PURE__ */ l(
    G.Trigger,
    {
      className: d(Ua({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(G.Icon, { asChild: !0, children: /* @__PURE__ */ r(ye, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
It.displayName = G.Trigger.displayName;
...
Wn.displayName = G.ScrollUpButton.displayName;
const Zn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.ScrollDownButton,
  {
    ref: n,
    className: d("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
...
Zn.displayName = G.ScrollDownButton.displayName;
const jt = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = q();
...
qa.displayName = G.Label.displayName;
const lt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  G.Item,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r($t, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(G.ItemText, { children: e })
    ]
  }
));
lt.displayName = G.Item.displayName;
      ...
      /* @__PURE__ */ l(
        Lt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(jt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(lt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function we(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (a) => !a.hasAttribute("disabled") && !a.getAttribute("aria-hidden") && Wa(a)
  );
}
const Se = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        we(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
...
const Re = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const Tt = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
...
function ro({
  ...
  var N;
  const [w, u] = I([]), [c, m] = I([]), [b, h] = I({}), [f, x] = I({}), _ = Dn({
    data: e,
    columns: t,
    getCoreRowModel: On(),
    ...n && { getPaginationRowModel: la() },
    onSortingChange: u,
    getSortedRowModel: Mn(),
    onColumnFiltersChange: m,
    getFilteredRowModel: wa(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Ha, { table: _ }),
    /* @__PURE__ */ l(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: _.getHeaderGroups().map((S) => /* @__PURE__ */ r(Tt, { children: S.headers.map((C) => /* @__PURE__ */ r(le, { children: C.isPlaceholder ? void 0 : re(C.column.columnDef.header, C.getContext()) }, C.id)) }, S.id)) }),
      /* @__PURE__ */ r(Re, { children: (N = _.getRowModel().rows) != null && N.length ? _.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Tt,
        {
          onClick: () => i(S, _),
          "data-state": S.getIsSelected() && "selected",
          children: S.getVisibleCells().map((C) => /* @__PURE__ */ r(Ht, { children: re(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        S.id
      )) : /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r(Ht, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(Ka, { table: _ })
  ] });
}
function Ws({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = H(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(ua, { options: o, children: e }) });
}
const Zs = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), Nn = (t, e) => t[e] ?? e;
function ao({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = Nn(n, "%webView_error_dump_header%"), o = Nn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Xr, {}) })
    ] }),
...
function Qs({
  ...
  return /* @__PURE__ */ l(me, { children: [
    /* @__PURE__ */ r(he, { children: a }),
    /* @__PURE__ */ r(Jt, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      ao,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function ti({ id: t, label: e, groups: n }) {
  const [a, o] = I(
    ...
    i((h) => (h[c] = m, { ...h }));
    const b = n[c].items.find((h) => h.id === m);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(an, { children: [
    /* @__PURE__ */ r(Hn, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
      /* @__PURE__ */ r(Fr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ye, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Ce, { children: n.map((c, m) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(sn, { children: c.label }),
      /* @__PURE__ */ r(Yn, { children: c.itemType === 0 ? /* @__PURE__ */ r(ae, { children: c.items.map((b, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        on,
        {
          checked: a[m][h],
        ...
        {
          value: s[m],
          onValueChange: (b) => u(m, b),
          children: c.items.map((b) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Kn, { value: b.id, children: b.label }) }, b.id))
        }
      ) }),
      /* @__PURE__ */ r(_e, {})
    ] }, c.label)) })
...
function so({ id: t, versionHistory: e }) {
  const [n, a] = I(!1), o = /* @__PURE__ */ new Date();
  function s(w) {
    const u = new Date(w), c = new Date(o.getTime() - u.getTime()), m = c.getUTCFullYear() - 1970, b = c.getUTCMonth(), h = c.getUTCDate() - 1;
    let f = "";
    return m > 0 ? f = `${m.toString()} year${m === 1 ? "" : "s"} ago` : b > 0 ? f = `${b.toString()} month${b === 1 ? "" : "s"} ago` : h === 0 ? f = "today" : f = `${h.toString()} day${h === 1 ? "" : "s"} ago`, f;
  }
...
function ni({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    /* @__PURE__ */ r(so, { versionHistory: o }),
...
const io = Rt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", io({ variant: e }), t), ...n })
);
...
function wo({
  ...
  const [b, h] = I(!1), f = j(
    (N) => {
      var C;
      const S = (C = t.find((D) => D.label === N)) == null ? void 0 : C.value;
      S && a(
        n.includes(S) ? n.filter((D) => D !== S) : [...n, S]
      );
    },
    [t, n, a]
  ), x = () => i || o, _ = H(() => {
    if (!u) return t;
    const N = t.filter((C) => C.starred).sort((C, D) => C.label.localeCompare(D.label)), S = t.filter((C) => !C.starred).sort((C, D) => {
      const B = n.includes(C.value), T = n.includes(D.value);
      return B && !T ? -1 : !B && T ? 1 : C.label.localeCompare(D.label);
    });
    return [...N, ...S];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(me, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(he, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Jt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ce, { children: [
      /* @__PURE__ */ r(pe, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(ue, { children: [
        /* @__PURE__ */ r(ke, { children: s }),
        /* @__PURE__ */ r(Bt, { children: _.map((N) => {
          const S = e ? e(N) : void 0;
          return /* @__PURE__ */ l(
            _t,
            {
              value: N.label,
...
function lo({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = H(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((u) => Je(u, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ l(Se, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Te, { stickyHeader: !0, children: /* @__PURE__ */ l(Tt, { children: [
    ...
    /* @__PURE__ */ r(Re, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Tt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ht, { children: `${O.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
  ...
  Fe.Root,
  {
    ...
    children: /* @__PURE__ */ r(
      Fe.Indicator,
      {
        ...
        children: /* @__PURE__ */ r($t, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
wn.displayName = Fe.Root.displayName;
...
), co = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  zn.Root,
  {
    ref: o,
...
co.displayName = zn.Root.displayName;
const tr = p.createContext({
  size: "default",
  variant: "default"
}), er = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = q();
  return /* @__PURE__ */ r(
    Ne.Root,
    {
...
er.displayName = Ne.Root.displayName;
const ge = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(tr);
  return /* @__PURE__ */ r(
    Ne.Item,
    {
      ref: s,
...
ge.displayName = Ne.Item.displayName;
const Ee = (t) => t === "asc" ? /* @__PURE__ */ r(Kr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ai = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, uo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", di = Object.freeze([
...
function ci({
  ...
  const c = yt(n, "%webView_inventory_all%"), m = yt(n, "%webView_inventory_approved%"), b = yt(n, "%webView_inventory_unapproved%"), h = yt(n, "%webView_inventory_unknown%"), f = yt(n, "%webView_inventory_scope_currentBook%"), x = yt(n, "%webView_inventory_scope_chapter%"), _ = yt(n, "%webView_inventory_scope_verse%"), N = yt(n, "%webView_inventory_filter_text%"), S = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, D] = I(!1), [B, T] = I("all"), [gt, kt] = I(""), [v, y] = I([]), F = H(() => t.length === 0 ? [] : ho(t, o, s), [t, o, s]), V = H(() => {
    if (C) return F;
    const R = [];
    return F.forEach((W) => {
      const it = W.items[0], pt = R.find(
        (L) => L.items[0] === it
      );
      pt ? (pt.count += W.count, pt.occurrences = pt.occurrences.concat(W.occurrences)) : R.push({
        items: [it],
        count: W.count,
  ...
  }, [C, F]), J = H(() => mo(V, B, gt), [V, B, gt]), bt = H(() => {
    var it, pt;
    if (!C) return u;
    const R = (it = a == null ? void 0 : a.tableHeaders) == null ? void 0 : it.length;
    if (!R) return u;
    const W = [];
    for (let L = 0; L < R; L++)
      W.push(
        po(
          ((pt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : pt[L]) || "Additional Item",
          L + 1
        )
      );
    return [...W, ...u];
  }, [a == null ? void 0 : a.tableHeaders, u, C]);
  At(() => {
    J.length === 0 ? y([]) : J.length === 1 && y(J[0].items);
  }, [J]);
  const Xt = (R, W) => {
    W.setRowSelection(() => {
      const it = {};
      return it[R.index] = !0, it;
    }), y(R.original.items);
  }, Et = (R) => {
    ...
    if (V.length === 0 || v.length === 0) return [];
    const R = V.filter((W) => Je(
      C ? W.items : [W.items[0]],
      v
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Lt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l(jt, { children: [
              /* @__PURE__ */ r(lt, { value: "all", children: c }),
              /* @__PURE__ */ r(lt, { value: "approved", children: m }),
              /* @__PURE__ */ r(lt, { value: "unapproved", children: b }),
              /* @__PURE__ */ r(lt, { value: "unknown", children: h })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ l(Lt, { onValueChange: (R) => Et(R), defaultValue: i, children: [
        /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Gt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(jt, { children: [
          /* @__PURE__ */ r(lt, { value: "book", children: f }),
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(U, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? S })
      ] })
    ] }),
    ...
    Kt.length > 0 && /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      lo,
      {
        occurrenceData: Kt,
        setScriptureReference: e,
...
const ln = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Bn.Root,
  {
    ref: o,
    decorative: n,
...
ln.displayName = Bn.Root.displayName;
...
const dn = de.Provider, cn = de.Root, pn = de.Trigger, Ve = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: a,
    sideOffset: e,
...
Ve.displayName = de.Content.displayName;
const fo = "16rem", go = "3rem", nr = p.createContext(void 0);
function De() {
  const t = p.useContext(nr);
  if (!t)
...
const rr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), b = e ?? c, h = p.useCallback(
      (D) => {
        const B = typeof D == "function" ? D(b) : D;
        n ? n(B) : m(B);
      },
      [n, b]
    ), f = p.useCallback(() => h((D) => !D), [h]), x = b ? "expanded" : "collapsed", S = q() === "ltr" ? i : i === "primary" ? "secondary" : "primary", C = p.useMemo(
      () => ({
        state: x,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(nr.Provider, { value: C, children: /* @__PURE__ */ r(dn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ar = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = De();
...
const bo = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = De();
  return /* @__PURE__ */ l(
    z,
    {
...
bo.displayName = "SidebarTrigger";
const vo = p.forwardRef(
  ({ className: t, ...e }, n) => {
...
ko.displayName = "SidebarSeparator";
...
const Ue = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Yt : "div",
  {
    ref: a,
...
const Co = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: a,
...
Co.displayName = "SidebarGroupAction";
...
const _o = Rt(
  ...
  ({
    ...
    const u = t ? Yt : "button", { state: c } = De(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(_o({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ l(cn, { children: [
      /* @__PURE__ */ r(pn, { asChild: !0, children: m }),
      /* @__PURE__ */ r(Ve, { side: "right", align: "center", hidden: c !== "collapsed", ...o })
    ] })) : m;
  }
);
lr.displayName = "SidebarMenuButton";
const So = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: o,
...
So.displayName = "SidebarMenuAction";
...
To.displayName = "SidebarMenuBadge";
const Ro = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
Eo.displayName = "SidebarMenuSub";
const Vo = p.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Vo.displayName = "SidebarMenuSubItem";
const Do = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Yt : "a",
  {
    ref: s,
...
Do.displayName = "SidebarMenuSubButton";
function Mo({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  const c = j(
    ...
    (h) => {
      const f = n.find((x) => x.projectId === h);
    ...
    ar,
    {
      ...
      children: /* @__PURE__ */ l(sr, { children: [
        /* @__PURE__ */ l(Ye, { children: [
          ...
          /* @__PURE__ */ r(qe, { children: /* @__PURE__ */ r(ir, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(
            lr,
            {
              onClick: () => c(h),
              isActive: b(h),
...
const Ct = "scrBook", Oo = "scrRef", zt = "source", zo = "details", Bo = "Scripture Reference", Ao = "Scripture Book", dr = "Type", Po = "Details";
function Io(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Ct,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Bo,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? O.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Ct ? ne(o.start) : void 0;
      },
      getGroupingValue: (a) => O.bookIdToNumber(a.start.book),
      sortingFn: (a, o) => $e(a.original.start, o.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (a) => ne(a.start),
      id: Oo,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : ne(o.start);
      },
      sortingFn: (a, o) => $e(a.original.start, o.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: zo,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Po,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
const jo = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || $e(t.start, t.end) === 0 ? `${Oe(t.start)}+${e}` : `${Oe(t.start)}+${e}-${Oe(t.end)}+${n}`;
}, Cn = (t) => `${jo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ui({
  sources: t,
  ...
  const [u, c] = I([]), [m, b] = I([{ id: Ct, desc: !1 }]), [h, f] = I({}), x = H(
    () => t.flatMap((v) => v.data.map((y) => ({
      ...y,
      source: v.source
    }))),
    [t]
  ...
  const N = Dn({
    ...
    getExpandedRowModel: ca(),
    getGroupedRowModel: da(),
    getCoreRowModel: On(),
    getSortedRowModel: Mn(),
    getRowId: Cn,
    autoResetExpanded: !1,
  ...
  At(() => {
    if (w) {
      const v = N.getSelectedRowModel().rowsById, y = Object.keys(v);
      if (y.length === 1) {
        const F = x.find((V) => Cn(V) === y[0]) || void 0;
        F && w(F);
      }
    }
  }, [h, x, w, N]);
  const S = o ?? Ao, C = s ?? dr, D = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${S}`, value: [Ct] },
    { label: `Group by ${C}`, value: [zt] },
    {
    ...
    !v.getIsGrouped() && !v.getIsSelected() && v.getToggleSelectedHandler()(y);
  }, gt = (v, y) => v.getIsGrouped() ? "" : d("banded-row", y % 2 === 0 ? "even" : "odd"), kt = (v, y, F) => {
    if (!((v == null ? void 0 : v.length) === 0 || y.depth < F.column.getGroupedIndex())) {
      if (y.getIsGrouped())
        switch (y.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      Lt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(Ya, { children: D.map((v) => /* @__PURE__ */ r(lt, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: N.getHeaderGroups().map((v) => /* @__PURE__ */ r(Tt, { children: v.headers.filter((y) => y.column.columnDef.header).map((y) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(le, { colSpan: y.colSpan, className: "top-0 tw-sticky", children: y.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          y.column.getCanGroup() ? /* @__PURE__ */ r(
            z,
            {
              variant: "ghost",
      ...
      /* @__PURE__ */ r(Re, { children: N.getRowModel().rows.map((v, y) => {
        const F = q();
        return /* @__PURE__ */ r(
          Tt,
          {
            ...
            className: d(gt(v, y)),
            onClick: (V) => T(v, V),
            children: v.getVisibleCells().map((V) => {
              if (!(V.getIsPlaceholder() || V.column.columnDef.enableGrouping && !V.getIsGrouped() && (V.column.columnDef.id !== zt || !n)))
                return /* @__PURE__ */ r(
                  Ht,
                  {
                    className: d(
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ l(
                      z,
                      {
                        ...
                        type: "button",
                        children: [
                          v.getIsExpanded() && /* @__PURE__ */ r(ye, {}),
                          !v.getIsExpanded() && (F === "ltr" ? /* @__PURE__ */ r(oe, {}) : /* @__PURE__ */ r(Xe, {})),
                          " ",
                          re(V.column.columnDef.cell, V.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
var St = /* @__PURE__ */ ((t) => (t.OT = "OT", t.NT = "NT", t.DC = "DC", t.Extra = "Extra", t))(St || {});
const $o = (t, e, n, a, o) => {
  switch (t) {
    case "OT":
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": Ft(t) === St.OT,
                "tw-border-s-purple-200": Ft(t) === St.NT,
                "tw-border-s-indigo-200": Ft(t) === St.DC,
                "tw-border-s-yellow-200": Ft(t) === St.Extra
              }
            ),
...
function Lo({
  ...
  const s = mn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Go({
  ...
  const B = H(() => O.allBookIds.filter(
    ...
    (y, F = !1) => {
      ...
      const V = B.findIndex((Z) => Z === C.current), J = B.findIndex((Z) => Z === y);
      if (V === -1 || J === -1) return;
      const [bt, Xt] = [
        Math.min(V, J),
        Math.max(V, J)
      ], Et = B.slice(bt, Xt + 1).map((Z) => Z);
      n(
        e.includes(y) ? e.filter((Z) => !Et.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...Et])]
      );
    },
    [e, n, B]
  ), gt = j(
    (y) => {
      const F = mn(B, y).map((V) => V);
      n(
        cr(B, y, e) ? e.filter((V) => !F.includes(V)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, B]
  ), kt = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(St).map((y) => /* @__PURE__ */ r(
      Lo,
      {
        section: y,
        availableBookIds: B,
    ...
    /* @__PURE__ */ l(me, { open: N, onOpenChange: S, children: [
      /* @__PURE__ */ r(he, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Jt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        ce,
        {
          onKeyDown: (y) => {
          ...
          children: [
            /* @__PURE__ */ r(pe, { placeholder: w }),
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: kt, children: u }),
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: v, children: c })
            ] }),
            /* @__PURE__ */ l(ue, { children: [
              /* @__PURE__ */ r(ke, { children: m }),
              Object.values(St).map((y, F) => {
                const V = B.filter(
                  (J) => Ft(J) === y
                );
                if (V.length !== 0)
                  return /* @__PURE__ */ l(Rn, { children: [
                    ...
                    F < Object.values(St).length - 1 && /* @__PURE__ */ r(Ln, {})
                  ] }, y);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var F;
        return /* @__PURE__ */ r(ve, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((F = o.get(y)) == null ? void 0 : F.localizedName) || O.bookIdToEnglishName(y) || y }, y);
      }),
...
function hi({
  ...
  const u = Mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Mt(i, "%webView_scope_selector_current_book%"), h = Mt(i, "%webView_scope_selector_choose_books%"), f = Mt(i, "%webView_scope_selector_scope%"), x = Mt(i, "%webView_scope_selector_select_books%"), _ = [
  ...
  ], N = e ? _.filter((S) => e.includes(S.value)) : _;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        nn,
        {
          ...
          children: N.map(({ value: S, label: C, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(be, { className: "tw-me-2", value: S, id: D }),
            /* @__PURE__ */ r(U, { htmlFor: D, children: C })
          ] }, D))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(U, { children: x }),
      /* @__PURE__ */ r(
        Go,
        {
          availableBookInfo: a,
...
function fi({
  ...
  return /* @__PURE__ */ l(
    Lt,
    {
      ...
      children: [
        /* @__PURE__ */ r(It, { size: o, className: d("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Gt,
          {
            placeholder: i[A(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(lt, { value: `${u}`, children: i[A(u)] }, `${u}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(cn, { children: [
  /* @__PURE__ */ r(pn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    Jn,
    {
      onClick: () => {
        a(w);
    ...
    /* @__PURE__ */ r(Xa, { children: /* @__PURE__ */ r(qn, { children: ur(
      t,
      e,
      pr(t, w.id),
      a
...
function Sn({
  ...
  return /* @__PURE__ */ l(an, { variant: s, children: [
    /* @__PURE__ */ r(Hn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(na, {}) }) }),
    /* @__PURE__ */ r(Ce, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(Rn, { children: [
      /* @__PURE__ */ r(Yn, { children: /* @__PURE__ */ r(dn, { children: ur(e.groups, e.items, w, t) }) }),
      u < c.length - 1 && /* @__PURE__ */ r(_e, {})
    ] }, w)) })
  ] });
}
function xi({
...
const mr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = q();
  return /* @__PURE__ */ r(
    at.Root,
    {
...
const hr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.List,
  {
    ref: n,
    className: d(
...
)), fr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: d(
...
function yi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(mr, { children: [
      /* @__PURE__ */ r(hr, { children: t.map((i) => /* @__PURE__ */ r(Ho, { value: i.value, children: i.value }, i.key)) }),
...
const gr = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(rn.Provider, { value: o, children: /* @__PURE__ */ r(
    X.Root,
    {
      ref: a,
      className: d(
...
gr.displayName = X.Root.displayName;
const br = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ct();
  return /* @__PURE__ */ r(
    X.Trigger,
    {
...
br.displayName = X.Trigger.displayName;
const vr = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    X.SubTrigger,
    {
...
vr.displayName = X.SubTrigger.displayName;
const xr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ct();
  return /* @__PURE__ */ r(
    X.SubContent,
    {
...
xr.displayName = X.SubContent.displayName;
const yr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ct();
...
yr.displayName = X.Content.displayName;
...
const qo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    X.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r($t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
qo.displayName = X.CheckboxItem.displayName;
const Jo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    X.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(We, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Jo.displayName = X.RadioItem.displayName;
...
Ko.displayName = X.Label.displayName;
const kr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  X.Separator,
  {
    ref: n,
    className: d("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
kr.displayName = X.Separator.displayName;
const te = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(cn, { children: [
      /* @__PURE__ */ r(pn, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        Nr,
        {
          onClick: () => {
            a(c);
      ...
      c.tooltip && /* @__PURE__ */ r(Ve, { children: c.tooltip })
    ] }, `tooltip-${c.label}-${"command" in c ? c.command : c.id}`)), u = [...w];
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(kr, {}, `separator-${s}`)), u;
  });
};
function Wo({
  menuData: t,
  ...
  const o = K(void 0), s = K(void 0), i = K(void 0), w = K(void 0), u = K(void 0), c = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (ma(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, b) => {
    var x, _, N, S;
    m.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (x = s.current) == null || x.focus(), te(s, [h, f]);
        break;
      case "alt+l":
        (_ = i.current) == null || _.focus(), te(i, [h, f]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), te(w, [h, f]);
        break;
      case "alt+h":
        (S = u.current) == null || S.focus(), te(u, [h, f]);
        break;
    }
  }), At(() => {
    ...
    const m = new MutationObserver((f) => {
      f.forEach((x) => {
        if (x.attributeName === "data-state" && x.target instanceof HTMLElement) {
          const _ = x.target.getAttribute("data-state");
          n(_ === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, b]) => typeof m == "boolean" || typeof b == "boolean" ? 0 : m.order - b.order).map(([m, b]) => /* @__PURE__ */ l(Yo, { children: [
      /* @__PURE__ */ r(br, { ref: c(m), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        yr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(dn, { children: Cr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Ci({
  ...
  const u = Zo(
    ...
    o && o(f), a && a([f, ...n.filter((x) => x !== f)]), s && n.find((x) => x === f) && s([...n.filter((x) => x !== f)]), m(!1);
  }, h = (f, x) => {
    var N, S, C, D, B, T;
    const _ = x !== f ? ((S = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : S[x]) ?? ((D = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : D.en) : void 0;
    return _ ? `${(B = t[f]) == null ? void 0 : B.autonym} (${_})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
      ...
      Lt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((f) => /* @__PURE__ */ r(lt, { value: f, children: h(f, e) }, f))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ l(ae, { children: [
      /* @__PURE__ */ r(U, { className: "tw-ms-3", children: u }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ l(U, { children: [
        "Currently:",
        " ",
...
function Qo({ item: t, createLabel: e, createComplexLabel: n }) {
...
const ts = Tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(oa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), ns = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(es({ variant: e }), t), ...n }));
...
const as = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
os.displayName = Ut.Root.displayName;
...
ss.displayName = Ut.Image.displayName;
...
is.displayName = Ut.Fallback.displayName;
...
ms.displayName = "Drawer";
const Ti = dt.Trigger, hs = dt.Portal, Ri = dt.Close, Sr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Overlay,
  {
    ref: n,
...
Sr.displayName = dt.Overlay.displayName;
const fs = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = p.useContext(_r), i = {
...
vs.displayName = dt.Title.displayName;
...
xs.displayName = dt.Description.displayName;
const ys = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Le.Root,
  {
    ref: a,
    className: d(
...
Ns.displayName = ee.Root.displayName;
const ks = p.forwardRef(({ className: t, ...e }, n) => {
  const a = q();
  return /* @__PURE__ */ r(
    Ge.Root,
    {
...
ks.displayName = Ge.Root.displayName;
const Vi = at.Root, Cs = p.forwardRef(({ className: t, ...e }, n) => {
  const a = q();
  return /* @__PURE__ */ r(
    at.List,
    {
...
Cs.displayName = at.List.displayName;
const _s = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Trigger,
  {
    ref: n,
    className: d(
...
_s.displayName = at.Trigger.displayName;
const Ss = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
...
Ss.displayName = at.Content.displayName;
...
const Es = (t, e, n = {}) => {
  ...
  const o = K(null), [s, i] = I(void 0), [w, u] = I(void 0), c = j(
    (h) => {
      i(h);
      const f = t.find((_) => _.id === h);
      f && (e == null || e(f));
      const x = document.getElementById(h);
      x && (x.scrollIntoView({ block: "center" }), x.focus()), o.current && o.current.setAttribute("aria-activedescendant", h);
    },
    [e, t]
  ), m = j(
    (h) => {
      const f = t.find((x) => x.id === h);
      f && (u((x) => x === h ? void 0 : h), n == null || n(f));
    },
    [n, t]
  ), b = j(
    (h) => {
      ...
      switch (h.key) {
        case "ArrowDown":
          x = Math.min(f + 1, t.length - 1), h.preventDefault();
          break;
        case "ArrowUp":
          x = Math.max(f - 1, 0), h.preventDefault();
          break;
        case "Home":
          x = 0, h.preventDefault();
          break;
        case "End":
          x = t.length - 1, h.preventDefault();
          break;
        case " ":
        case "Enter":
...
export {
  ...
  ss as AvatarImage,
  Js as BOOK_SELECTOR_STRING_KEYS,
  ve as Badge,
  qs as BookChapterControl,
