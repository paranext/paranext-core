...
import b, { forwardRef as nn, useRef as Y, useMemo as F, useState as T, useCallback as K, useLayoutEffect as Wt, createContext as kn, useContext as dr, useEffect as q, Component as rs, createElement as Ar, Suspense as os, Fragment as lo } from "react";
...
import { includes as ln, Section as U, getChaptersForBook as js, formatScrRef as ge, getSectionForBook as Ue, formatRelativeDate as zs, formatReplacementString as he, sanitizeHtml as Fs, NumberFormat as Bs, formatBytes as Ks, getCurrentLocale as Gs, usfmMarkers as un, getFormatCallerFunction as qs, deepEqual as Us, isString as Vr, compareScrRefs as Xn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
function Ww({
  ...
  return /* @__PURE__ */ d(ke, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ri, { asChild: !0, children: /* @__PURE__ */ r(ze, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Yw(t, n) }) }) }),
...
const mc = "16rem", fc = "3rem", Ta = b.createContext(void 0);
function In() {
...
const oe = "scrBook", Mc = "scrRef", fe = "source", Oc = "details", Ic = "Scripture Reference", Ac = "Scripture Book", $a = "Type", Pc = "Details";
function $c(t, e) {
  const n = e ?? !1;
  return [
    {
...
Ga.displayName = at.Root.displayName;
...
function Uc({
  ...
  if (Bi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(Ga, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(Fc, { children: [
...
const Xc = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ps, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const Up = Vt.Trigger, cd = Vt.Portal, Hp = Vt.Close, Qa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Overlay,
  {
    ref: n,
