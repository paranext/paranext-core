...
import { c as m, g as De, a as Ba, C as Me, A as ce, P as Ae, b as qe, B as G, d as Ie, e as Ge, f as He, h as ye, i as Pi, k as ji, j as Bi, E as Li, l as La, r as re, m as Fi, n as cn, o as Zr, p as Fa, L as kt, D as ka, q as _a, s as Na, t as Ca, T as Kt, u as Ua, v as qt, w as Gt, x as Ht, y as ln, z as Ka, F as Fe, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ui, N as Nr, O as Ke, Q as Oe, Z as Ye, R as Re, U as tr, V as qa, W as Ga, X as Kr, Y as Ha, _ as dn, $ as Ki, a0 as qi, a1 as Gi, a2 as vo, a3 as wn, a4 as Qr, a5 as un, a6 as Hi, a7 as Yi, a8 as Wi, a9 as Xi, aa as pn, ab as Ji, ac as na, ad as bo, ae as ia, af as Zi, ag as Qi, ah as ts, ai as es, aj as rs, ak as Cr, al as Ya } from "./resizable-DQRM0ASL.js";
import { am as Bh, an as Lh, ao as Fh, ap as Uh, aq as Kh, ar as qh, as as Gh, at as Hh, au as Yh, av as Wh, aw as Xh, ax as Jh, ay as Zh, az as Qh, aA as tg, aB as eg, aC as rg, aD as ag, aE as og, aF as ng, aG as ig, aH as sg, aI as cg, aJ as lg } from "./resizable-DQRM0ASL.js";
...
import Tt, { useRef as K, useMemo as A, useState as _, useCallback as L, useEffect as W, useImperativeHandle as Ks, useLayoutEffect as Zt, createContext as Ja, useContext as xn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as yn, useId as To, Fragment as kn } from "react";
...
import { useReactTable as In, getFilteredRowModel as Lc, getSortedRowModel as Vn, getPaginationRowModel as Fc, getCoreRowModel as Pn, flexRender as vr, getGroupedRowModel as Uc, getExpandedRowModel as Kc } from "@tanstack/react-table";
...
function da({
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Dt } = {
    ...
    () => dl(N),
    [N]
  ), yt = A(() => !l || !D || !D.chapterNum || !$t ? !1 : l(D.book, D.chapterNum) > 0, [l, D, $t]), de = L(
    (b) => w ? Mo(b, w) : !1,
    [w]
  ), Te = L(
    (b) => (H) => w ? wl(b, H, w) : !1,
...
function vi({
  ...
  const [E, Y] = _(Zo), [q, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, It] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, oe] = _(!1), [at, Vt] = _(I), [St, Wt] = _(!1), ne = K(void 0), [D, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  const Qt = A(() => Ct[0], [Ct]), me = K(null), ie = K(void 0), P = L(() => {
    var z;
...
function wp({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [I, B] = _("*"), [T, V] = _("f"), [$, N] = _(!1), [j, R] = _(!0), [E, Y] = _(!1), q = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [It, U] = _(), [tt, wt] = _(), st = K(null), vt = A(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function yp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), I = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = _(!1), [N, j] = _("all"), [R, E] = _(""), [Y, q] = _([]), F = A(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = A(() => O.length === 0 ? [] : Nw(O, N, R), [O, N, R]), Z = A(() => {
    var wt, st;
    if (!V) return d;
