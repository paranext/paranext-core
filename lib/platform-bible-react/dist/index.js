import { jsx as r, jsxs as d, Fragment as ln } from "react/jsx-runtime";
import p, { forwardRef as Ee, createContext as wr, useContext as lr, useCallback as U, useState as A, useRef as q, useEffect as it, useLayoutEffect as Qe, useMemo as et, Fragment as dn } from "react";
...
import { ChevronRight as De, Check as _t, Circle as Ve, X as Me, Search as cn, ChevronsUpDown as ze, FilterIcon as ur, ChevronDown as Zt, ChevronUp as mr, ArrowLeftIcon as hr, ChevronLeftIcon as fr, ChevronRightIcon as gr, ArrowRightIcon as br, Filter as vr, User as xr, Link as yr, CircleHelp as Nr, Star as kr, CircleCheckIcon as Cr, CircleXIcon as _r, CircleHelpIcon as Sr, ArrowUpIcon as Tr, ArrowDownIcon as Rr, ArrowUpDownIcon as Er, PanelLeft as Dr, PanelRight as Vr, ScrollText as Mr, ChevronLeft as zr, MenuIcon as Or, Menu as Br, EllipsisVertical as Ir, LoaderCircle as Pr } from "lucide-react";
import { formatScrRef as Tt, MODIFIER_KEYS as Ar, getChaptersForBook as Xr, NumberFormat as jr, formatBytes as Fr, deepEqual as Oe, isString as me, compareScrRefs as ye, scrRefToBBBCCCVVV as he, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
import { useReactTable as un, getFilteredRowModel as Gr, getSortedRowModel as mn, getPaginationRowModel as $r, getCoreRowModel as hn, flexRender as Ft, getGroupedRowModel as Lr, getExpandedRowModel as Yr } from "@tanstack/react-table";
...
const Ie = j.Trigger, bn = j.Group, Qr = j.Portal, ta = j.Sub, Es = j.RadioGroup;
...
ee.displayName = j.Label.displayName;
...
const fa = 6, Ge = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ga = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, nn = ["OT", "NT", "DC"], ba = 96, va = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), xa = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', At = (t) => Xr(M.bookIdToNumber(t));
function ya() {
...
function Vs({
  ...
  const o = H(), [s, i] = A(
    ...
    i(Tt(t, "English")), c(""), f(t.book), N(t.book);
  }, [t]), P = U((h) => {
    if (k.current) {
      k.current = !1;
      return;
    ...
    (h, V, C, O) => {
      if (g(t.book !== h ? 1 : t.chapterNum), V || At(h) === -1) {
        e({
          book: h,
          chapterNum: C ?? 1,
          verseNum: O ?? 1
  ...
  }, [x, b]), /* @__PURE__ */ d(te, { modal: !1, open: T, onOpenChange: P, children: [
      ...
      Ht,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: nn.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(ee, { className: "tw-font-semibold tw-text-foreground/80", children: ga[h] }),
...
const Ca = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Vt : "button", { className: l(Ca({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
Jt.displayName = Gt.Item.displayName;
const Le = $t.Root, Ye = $t.Trigger, ne = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = H();
    ...
    /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(re, { children: [
          ...
          /* @__PURE__ */ r(oe, { children: e.map((_) => /* @__PURE__ */ d(
            ie,
            {
              value: w(_),
              onSelect: () => {
...
function zs({
  ...
  const f = fe(u, "%webView_bookSelector_currentBook%"), v = fe(u, "%webView_bookSelector_choose%"), g = fe(u, "%webView_bookSelector_chooseBooks%"), [m, N] = A(
    "current book"
    /* CURRENT_BOOK */
  ), T = (y) => {
    N(y), t(y);
...
function za({ table: t }) {
  return /* @__PURE__ */ d(te, { children: [
    /* @__PURE__ */ r(pr, { asChild: !0, children: /* @__PURE__ */ d(X, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ur, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Rt = G.Root, Oa = G.Group, Et = G.Value, Ba = ft(
...
const we = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const de = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Fa({
  ...
  var y;
  const [w, c] = A([]), [u, f] = A([]), [v, g] = A({}), [m, N] = A({}), T = un({
    data: e,
    columns: t,
    getCoreRowModel: hn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(we, { stickyHeader: s, children: [
      /* @__PURE__ */ r(le, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(ht, { children: x.headers.map((_) => /* @__PURE__ */ r(Lt, { children: _.isPlaceholder ? void 0 : Ft(_.column.columnDef.header, _.getContext()) }, _.id)) }, x.id)) }),
      /* @__PURE__ */ r(de, { children: (y = T.getRowModel().rows) != null && y.length ? T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        ht,
        {
          onClick: () => i(x, T),
          "data-state": x.getIsSelected() && "selected",
          children: x.getVisibleCells().map((_) => /* @__PURE__ */ r(Dt, { children: Ft(_.column.columnDef.cell, _.getContext()) }, _.id))
        },
        x.id
...
function Os({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp", n), children: /* @__PURE__ */ r(Hr, { options: o, children: e }) });
}
...
function Bs({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(te, { children: [
    /* @__PURE__ */ r(Ie, { asChild: !0, children: /* @__PURE__ */ d(X, { variant: "default", children: [
      /* @__PURE__ */ r(vr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(Zt, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Ht, { children: n.map((a) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(ee, { children: a.label }),
      /* @__PURE__ */ r(bn, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(Ae, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(yn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Ut, {})
    ] }, a.label)) })
  ] }) });
}
...
const La = ft(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", La({ variant: e }), t), ...n })
);
...
function Ya({
  ...
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ d(Le, { open: v, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ye, { asChild: !0, children: /* @__PURE__ */ d(
      X,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(re, { children: [
...
function As({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      var m;
      return /* @__PURE__ */ d(Kt, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          X,
          {
            variant: "ghost",
...
function Ha({
  ...
  return /* @__PURE__ */ d(we, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(le, { stickyHeader: !0, children: /* @__PURE__ */ d(ht, { children: [
      /* @__PURE__ */ r(Lt, { children: a }),
      /* @__PURE__ */ r(Lt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(de, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      ht,
      {
        onClick: () => {
          e(i.reference);
...
On.displayName = Qt.Root.displayName;
const qt = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
qt.displayName = Qt.Item.displayName;
const ce = (t) => t === "asc" ? /* @__PURE__ */ r(Tr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Er, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Xs = (t) => ({
  accessorKey: "item",
...
function Hs({
  ...
  const u = pt(n, "%webView_inventory_all%"), f = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), g = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = A(!1), [S, z] = A("all"), [$, gt] = A(""), [lt, k] = A([]), b = et(() => t.length === 0 ? [] : Wa(t, o, s), [t, o, s]), P = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Rt, { onValueChange: (D) => It(D), defaultValue: i, children: [
...
const Je = Yt.Provider, Ke = Yt.Root, We = Yt.Trigger, pe = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Yt.Content,
  {
    ref: a,
    sideOffset: e,
...
pe.displayName = Yt.Content.displayName;
...
const In = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Bn.Provider, { value: _, children: /* @__PURE__ */ r(Je, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Te = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Vt : "div",
  {
    ref: a,
  ...
  ({
    ...
    const c = t ? Vt : "button", { state: u } = ue(), f = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(io({ variant: n, size: a }), s),
        ...i
      }
    );
...
function ho({
  ...
  return /* @__PURE__ */ r(
    Pn,
    {
      ...
      children: /* @__PURE__ */ d(Xn, { children: [
        /* @__PURE__ */ d(Se, { children: [
          /* @__PURE__ */ r(Te, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Re, { children: /* @__PURE__ */ r(jn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(Fn, { children: /* @__PURE__ */ r(
            Gn,
            {
              onClick: () => u(g),
              isActive: v(g),
...
const ut = "scrBook", fo = "scrRef", xt = "source", go = "details", bo = "Scripture Reference", vo = "Scripture Book", Ln = "Type", xo = "Details";
function yo(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, on = (t) => `${No({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qs({
  sources: t,
  ...
  it(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const P = N.find((R) => on(R) === b[0]) || void 0;
        P && w(P);
      }
    }
  }, [g, N, w, y]);
  const x = o ?? vo, _ = s ?? Ln, S = [
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(we, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(le, { children: y.getHeaderGroups().map((k) => /* @__PURE__ */ r(ht, { children: k.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(de, { children: y.getRowModel().rows.map((k, b) => {
        const P = H();
        return /* @__PURE__ */ r(
          ht,
          {
                  ...
                  Dt,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ d(
                      X,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(Zt, {}),
                          !k.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(De, {}) : /* @__PURE__ */ r(zr, {})),
                          " ",
...
}), Yn = (t, e, n) => Ze(t, e).every((a) => n.includes(a));
function _o({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function To({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ d(Le, { open: y, onOpenChange: x, children: [
      ...
      /* @__PURE__ */ r(ne, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
        re,
        {
          onKeyDown: (b) => {
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var P;
        return /* @__PURE__ */ r(Kt, { variant: "secondary", children: o && ((P = o.get(b)) == null ? void 0 : P.localizedName) || M.bookIdToEnglishName(b) || b }, b);
      }),
      e.length > be && /* @__PURE__ */ r(Kt, { variant: "secondary", children: `+${e.length - sn} ${v}` })
    ] })
  ] });
}
...
function wn({
  ...
  return /* @__PURE__ */ d(te, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(X, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Or, {}) }) }),
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ d(dn, { children: [
      /* @__PURE__ */ r(bn, { children: /* @__PURE__ */ r(Je, { children: Un(e.groups, e.items, w, t) }) }),
...
function ni({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(qn, { children: [
      /* @__PURE__ */ r(Jn, { children: t.map((i) => /* @__PURE__ */ r(Ro, { value: i.value, children: i.value }, i.key)) }),
...
const Vo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    F.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const Xt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, f) => u.order - f.order).map((u) => /* @__PURE__ */ d(Ke, { children: [
...
function Oo({
  ...
  if (Ur(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, v) => {
    var N, T, y, x;
    f.preventDefault();
    ...
    switch (v.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (T = i.current) == null || T.focus(), Xt(i, [g, m]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(Wn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, v]) => typeof f == "boolean" || typeof v == "boolean" ? 0 : f.order - v.order).map(([f, v]) => /* @__PURE__ */ d(Eo, { children: [
      /* @__PURE__ */ r(Zn, { ref: u(f), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        er,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Je, { children: ar(t.groups, t.items, f, e) })
        }
      )
    ] }, f)) });
}
...
function Io({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Po = Ee(({ className: t, ...e }, n) => /* @__PURE__ */ r(Pr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
), Xo = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(Ao({ variant: e }), t), ...n }));
...
Go.displayName = Mt.Root.displayName;
...
$o.displayName = Mt.Image.displayName;
...
Lo.displayName = Mt.Fallback.displayName;
...
const wi = at.Trigger, Zo = at.Portal, li = at.Close, sr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
sr.displayName = at.Overlay.displayName;
...
as.displayName = ke.Root.displayName;
const ir = p.forwardRef(({ className: t, orientation: e = "vertical", ...n }, a) => /* @__PURE__ */ r(
...
ir.displayName = yt.ScrollAreaScrollbar.displayName;
const os = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  yt.Root,
  {
    ref: a,
...
ss.displayName = jt.Root.displayName;
...
is.displayName = Ce.Root.displayName;
const ci = Q.Root, ws = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
ws.displayName = Q.List.displayName;
...
ls.displayName = Q.Trigger.displayName;
...
ds.displayName = Q.Content.displayName;
const pi = Jr.Root, ui = (t, e) => {
  it(() => {
    if (!t) return () => {
    };
    const n = t(e);
