...
function Yp({
  ...
  const Ft = j(
    ...
    (S, B) => {
      ...
      let b;
      S === "custom" ? b = B : S === "generated" ? b = Za : b = Qa, q.insert.note.caller !== b && (q.insert.note.caller = b, (et = h.current) == null || et.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var S;
...
function kh({
  ...
  const [Ge, Vr] = _(null), [qe, xa] = _(null), [We, ya] = _(null), ka = 200, [_a, Na] = _(!1);
  W(() => {
