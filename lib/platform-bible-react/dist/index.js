...
import { c as v, g as Se, a as Ga, C as ke, A as ie, P as Oe, b as Je, B as G, d as $e, e as Ie, f as Ae, h as xe, i as Bi, k as Fi, j as Ui, E as Ki, l as Ha, r as se, m as qi, n as pn, o as aa, p as oa, L as Et, R as Ya, q as Yr, D as Sa, s as za, t as Ra, u as Da, T as hn, v as Br, w as Lt, x as Wa, y as jt, z as Bt, F as Ft, G as gn, H as Xa, I as Ye, J as Cr, K as Pe, M as Ve, N as Le, S as Er, O as ar, Q as Gi, U as zr, V as Xe, W as Re, Z as Ze, X as ze, Y as or, _ as Ja, $ as Za, a0 as Wr, a1 as Qa, a2 as fn, a3 as Hi, a4 as Yi, a5 as Wi, a6 as Ma, a7 as mn, a8 as na, a9 as vn, aa as Xi, ab as Ji, ac as Zi, ad as Qi, ae as bn, af as ts, ag as wa, ah as No, ai as ua, aj as es, ak as rs, al as as, am as os, an as ns, ao as Rr, ap as to, aq as is, ar as ss, as as cs } from "./resizable-DxCHLVMU.js";
import { at as sg, au as cg, av as lg, aw as dg, ax as wg, ay as ug, az as pg, aA as hg, aB as gg, aC as fg, aD as mg, aE as vg, aF as bg, aG as xg, aH as yg, aI as kg, aJ as _g, aK as Ng, aL as Cg, aM as Eg, aN as Tg, aO as Sg, aP as zg, aQ as Rg, aR as Dg } from "./resizable-DxCHLVMU.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as De, Clock as Co, ChevronsLeft as Eo, ChevronsRight as To, ChevronLeft as Oa, ChevronRight as $a, ArrowLeft as ls, ArrowRight as ds, ChevronDown as sr, BoldIcon as ws, ItalicIcon as us, X as eo, AtSign as xn, Pencil as ps, Trash2 as hs, ArrowUp as yn, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as kn, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, Undo as Ss, Redo as zs, SquareX as _n, FunctionSquare as Nn, SquareSigma as Cn, Ban as Rs, AlertCircle as Ia, CircleCheckIcon as Ds, CircleXIcon as Ms, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as Is, ScrollText as As, ChevronsUpDown as Ps, MenuIcon as Vs, Menu as Ls, EllipsisVertical as js, MoreVertical as Bs } from "lucide-react";
import { Section as pt, getChaptersForBook as Fs, formatScrRef as ve, getSectionForBook as kr, formatRelativeDate as Us, formatReplacementString as We, sanitizeHtml as ro, NumberFormat as En, formatBytes as Ks, getCurrentLocale as qs, usfmMarkers as Fr, getFormatCallerFunction as Gs, deepEqual as Hs, isString as So, compareScrRefs as Aa, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as Ys, getLocalizeKeyForScrollGroupId as zo, formatReplacementStringToArray as Ro, collectUsjMarkers as Ws } from "platform-bible-utils";
import Jt, { useRef as K, useMemo as I, useState as N, useCallback as F, useEffect as q, useImperativeHandle as Xs, useLayoutEffect as Ht, createContext as ao, useContext as Tn, Component as Js, createElement as Do, Suspense as Zs, forwardRef as Sn, useId as Xr, Fragment as ia } from "react";
import { IconSelector as zn, IconCheck as sa, IconChevronDown as Qs, IconChevronUp as tc, IconLayoutSidebar as ec, IconLayoutSidebarRight as rc, IconChevronRight as Rn, IconSearch as ac, IconLoader as oc, IconAlertOctagon as nc, IconAlertTriangle as ic, IconInfoCircle as sc, IconCircleCheck as cc } from "@tabler/icons-react";
import { createEditor as Dn, $getRoot as Me, $createParagraphNode as Dr, $getSelection as Zt, HISTORY_MERGE_TAG as oo, ParagraphNode as Mn, TextNode as On, $getPreviousSelection as lc, $isRangeSelection as ue, $caretFromPoint as dc, $getSiblingCaret as $n, $getChildCaret as wc, $getAdjacentChildCaret as uc, $isChildCaret as pc, $normalizeCaret as hc, $setSelectionFromCaretRange as gc, $getCollapsedCaretRange as fc, $getCaretInDirection as Mo, $splitAtPointCaretNext as mc, $isTextPointCaret as vc, $findMatchingParent as In, $isElementNode as Tr, mergeRegister as ye, getDOMTextNode as bc, isHTMLElement as xc, CLEAR_EDITOR_COMMAND as An, COMMAND_PRIORITY_EDITOR as no, shallowMergeConfig as yc, defineExtension as ae, safeCast as Qe, createState as kc, FORMAT_TEXT_COMMAND as Pn, $isNodeSelection as Vn, COMMAND_PRIORITY_LOW as Ln, RootNode as _c, LineBreakNode as Nc, TabNode as Cc, $isEditorState as Ec, createCommand as Tc, CLICK_COMMAND as Sc, isDOMNode as zc, $getNodeFromDOMNode as Rc, $createNodeSelection as Dc, $setSelection as Mc, $getEditor as Oc, DecoratorNode as Pa, $getState as $c, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as Ic, $setState as Ac, addClassNamesToElement as jn, $create as Pc, $getNodeByKey as Vc, removeClassNamesFromElement as Lc, KEY_TAB_COMMAND as jc, $isBlockElementNode as Bc, $createRangeSelection as Fc, $normalizeSelection__EXPERIMENTAL as Uc, OUTDENT_CONTENT_COMMAND as Kc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as qc, COMMAND_PRIORITY_CRITICAL as io, $isDecoratorNode as Gc, $isParagraphNode as Hc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as Bn, $insertNodes as Yc } from "lexical";
...
import { Avatar as so, Select as Yt, Checkbox as Io, Slot as Mr, Tabs as ce, Menubar as he, ContextMenu as Ot, Progress as Ao, Slider as Ir, Switch as Po } from "radix-ui";
import { useReactTable as Un, getFilteredRowModel as al, getSortedRowModel as Kn, getPaginationRowModel as ol, getCoreRowModel as qn, flexRender as _r, getGroupedRowModel as nl, getExpandedRowModel as il } from "@tanstack/react-table";
...
function pl({
  ...
  const [h, g] = N(!1), f = w !== void 0, b = f ? w : h, m = (y) => {
    f || g(y), p == null || p(y);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Oe, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      ke,
      {
        onSelect: () => E(y),
...
function fa({
  ...
  const j = se(), [T, A] = N(!1), [P, _] = N(""), [O, U] = N(""), [k, Z] = N("books"), [B, X] = N(void 0), [S, $] = N(
    void 0
  ), [H, tt] = N(void 0), [Tt, kt] = N(!1), Rt = K(null), R = K(!1), Y = K(void 0), rt = K(void 0), J = K(void 0), nt = K(void 0), gt = K({}), wt = K({}), xt = F(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), $t = I(() => o ? o() : qi, [o]), Ut = I(() => ({
    [pt.OT]: $t.filter((W) => bt.isBookOT(W)),
    [pt.NT]: $t.filter((W) => bt.isBookNT(W)),
    [pt.DC]: $t.filter((W) => bt.isBookDC(W)),
    [pt.Extra]: $t.filter((W) => bt.extraBooks().includes(W))
  }), [$t]), Qt = I(() => Object.values(Ut).flat(), [Ut]), fe = I(() => {
    if (!O.trim()) return Ut;
    const x = {
      [pt.OT]: [],
      [pt.NT]: [],
    ...
    return [pt.OT, pt.NT, pt.DC, pt.Extra].forEach((ot) => {
      x[ot] = Ut[ot].filter((Vt) => Ha(Vt, O, n));
    }), x;
  }, [Ut, O, n]), D = I(
    () => vl(O, Qt, n),
    [O, Qt, n]
  ...
  const St = F(() => {
    if (D) {
      const x = D.chapterNum ?? 1, W = D.verseNum ?? 1;
      if (w && ga(D.book, x, W, w))
        return;
      xt({
        book: D.book,
        chapterNum: x,
    ...
    (x) => {
      const W = S ?? (D == null ? void 0 : D.book), ot = H ?? (D == null ? void 0 : D.chapterNum);
      !W || !ot || (xt({
        book: W,
        chapterNum: ot,
        verseNum: x
    ...
    (x) => {
      const W = k === "chapters" ? B : D == null ? void 0 : D.book;
      if (W) {
        if (d && d(W, x) > 1) {
          $(W), tt(x), Z("verses"), _("");
          return;
    ...
    Z("books"), X(void 0), $(void 0), tt(void 0), setTimeout(() => {
      rt.current && rt.current.focus();
    }, 0);
  }, []), it = F(() => {
    const x = S;
    $(void 0), tt(void 0), x ? (X(x), Z("chapters"), _("")) : at();
  }, [S, at]), ct = F((x) => {
    A(x), x && (Z("books"), X(void 0), $(void 0), tt(void 0), U(""));
  }, []);
  q(() => {
    M && ct(!1);
  }, [M, ct]);
  ...
  q(() => {
    var x;
    lt !== 0 && ((x = rt.current) == null || x.focus());
  }, [lt]), Xs(
    C,
    () => ({
      open: () => {
  ...
  const { otLong: ht, ntLong: mt, dcLong: It, extraLong: Dt } = {
    ...
    () => fl(O),
    [O]
  ), oe = I(() => !d || !D || !D.chapterNum || !yt ? !1 : d(D.book, D.chapterNum) > 0, [d, D, yt]), Fe = F(
    (x) => w ? Vo(x, w) : !1,
    [w]
  ), hr = F(
    (x) => (W) => w ? ml(x, W, w) : !1,
    ...
    (x, W) => (ot) => w ? ga(x, W, ot, w) : !1,
    [w]
  ), fr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", mr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Or = F(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), St());
    },
    [p, D, St]
  ), tr = F(
    (x) => {
      var me, Ne, Ke;
      if (x.ctrlKey) return;
      const { isLetter: W, isDigit: ot } = Lo(x.key);
      if ((k === "chapters" || k === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const Ct = (me = Y.current) == null ? void 0 : me.querySelector(
      ...
      if (k === "verses" && Vt) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            vt !== 0 && (Kt = vt > 1 ? vt - 1 : Ct);
            break;
          case "ArrowRight":
            vt !== 0 && (Kt = vt < Ct ? vt + 1 : 1);
            break;
          case "ArrowUp":
            Kt = vt === 0 ? Ct : Math.max(1, vt - le);
            break;
          case "ArrowDown":
            Kt = vt === 0 ? 1 : Math.min(Ct, vt + le);
            break;
          default:
            return;
        }
        Kt !== vt && (x.preventDefault(), x.stopPropagation(), _(
          `${zt} ${ie[zt] || ""} ${Nt}:${Kt}`
        ), setTimeout(() => {
          const qe = wt.current[Kt];
          qe && qe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((k === "chapters" || k === "books" && D) && Vt) {
        const zt = k === "chapters" ? B : D == null ? void 0 : D.book;
        if (!zt) return;
        k === "chapters" && ((Ke = Y.current) == null || Ke.focus());
        const Nt = (() => {
          if (!P) return 1;
          const le = P.match(/(\d+)$/);
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            vt = Nt === 0 ? Ct : Math.max(1, Nt - Kt);
            break;
          case "ArrowDown":
            vt = Nt === 0 ? 1 : Math.min(Ct, Nt + Kt);
            break;
          default:
            return;
        }
        vt !== Nt && (x.preventDefault(), x.stopPropagation(), _(
          `${zt} ${ie[zt] || ""} ${vt}`
        ), setTimeout(() => {
          const le = gt.current[vt];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Vt = rt.current) == null || Vt.focus();
      return;
    }
    const { isLetter: W, isDigit: ot } = Lo(x.key);
    (W || ot) && (x.preventDefault(), U((me) => me + x.key), rt.current.focus(), kt(!1));
  }, []);
  return Ht(() => {
    const x = setTimeout(() => {
      if (T && k === "books" && J.current && nt.current) {
        const W = J.current, ot = nt.current, Vt = ot.offsetTop, me = W.clientHeight, Ne = ot.clientHeight, Ke = Vt - me / 2 + Ne / 2;
        W.scrollTo({
          top: Math.max(0, Ke),
          behavior: "smooth"
        }), _(Hn(t.book));
    ...
    if (k === "chapters" && B) {
      const x = B === t.book, W = x ? t.chapterNum : 1;
      _(
        `${B} ${ie[B] || ""} ${W}`
      ), setTimeout(() => {
        if (J.current)
          if (x) {
            const ot = gt.current[t.chapterNum];
  ...
  }, [k, B, D, t.book, t.chapterNum]), Ht(() => {
    if (k === "verses" && S && H !== void 0) {
      const x = S === t.book && H === t.chapterNum, W = x ? t.verseNum : 1;
      _(
        `${S} ${ie[S] || ""} ${H}:${W}`
      ), setTimeout(() => {
        if (J.current)
          if (x) {
            const ot = wt.current[t.verseNum];
            ot && ot.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            J.current.scrollTo({ top: 0 });
        Y.current && Y.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Oe, { open: T, onOpenChange: ct, modal: E, children: [
    /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        ...
        onClick: (x) => {
          R.current && (R.current = !1, x.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Be }),
          f && /* @__PURE__ */ a(
            zn,
            {
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: W } = x;
          T && Rt.current && W instanceof Node && Rt.current.contains(W) && (R.current = !0, ct(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Ie,
          {
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: et.map(
                  ({ onClick: x, disabled: W, title: ot, icon: Vt }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: k === "verses" ? it : at,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: j === "ltr" ? /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                k === "chapters" && B && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Se(B, n) }),
                k === "verses" && S && H !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(S, n)} ${H}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: k === "verses" ? mr : fr
                  }
                )
              ] }),
              !Tt && /* @__PURE__ */ u(Ae, { ref: J, children: [
                k === "books" && /* @__PURE__ */ u(dt, { children: [
                  !D && Object.entries(fe).map(([x, W]) => {
                    if (W.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Wt(x), children: W.map((ot) => /* @__PURE__ */ a(
                          Gn,
                          {
                            bookId: ot,
                            onSelect: (Vt) => _e(Vt),
                            section: kr(ot),
                            commandValue: `${ot} ${ie[ot]}`,
                            ref: ot === t.book ? nt : void 0,
                            localizedBookNames: n,
                            disabled: Fe(ot)
                          },
                          ot
                  ...
                  D && /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a(
                    ke,
                    {
                      ...
                      children: ve(
                        ...
                        n ? Ga(D.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  D && oe && D.chapterNum && d && /* @__PURE__ */ u(dt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Bo,
                      {
                        ...
                        onVerseSelect: te,
                        setVerseRef: Pt,
                        isVerseDisabled: gr(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !oe && nr(D.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        setChapterRef: z,
                        isChapterDimmed: At,
                        isChapterDisabled: hr(D.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                k === "chapters" && B && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: B,
                    scrRef: t,
                    onChapterSelect: ee,
                    setChapterRef: z,
                    isChapterDisabled: hr(B),
                    className: "tw:p-4"
                  }
                ),
                k === "verses" && S && H !== void 0 && d && /* @__PURE__ */ a(
                  Bo,
                  {
                    bookId: S,
                    chapterNum: H,
...
function Fo({
  ...
  const [C, M] = N(!1), j = d ?? l, T = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], A = (P, _) => {
    const O = l(P), U = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, k = `${_ ?? ""}${O}${U ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: O,
  ...
  return /* @__PURE__ */ u(Oe, { open: C, onOpenChange: M, ...y, children: [
    /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Ae, { children: T(e) ? e.map((P) => /* @__PURE__ */ a(xe, { heading: P.groupHeading, children: P.options.map((_) => A(_, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((P) => A(P)) }) })
        ] })
      }
    )
  ] });
...
function np({
  ...
  const w = ma(d, "%webView_bookSelector_currentBook%"), p = ma(d, "%webView_bookSelector_choose%"), h = ma(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), b = (m) => {
    f(m), t(m);
    ...
    Ya,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Et, { className: "tw:flex tw:items-center", children: o.map((m) => bt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            G,
            {
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Xn ? Ht : q, Vr = { tag: oo };
function _l({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = yl(null, o), w = Dn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
...
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function Dl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ml() {
  return function(t) {
    const [e] = ge(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = K(o);
    return Rl(() => {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = Jn && "documentMode" in document ? document.documentMode : null;
!(!Jn || !("InputEvent" in window) || $l) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Al(t, e, r) {
  ...
  function l() {
    ...
    for (let E = 0; E < g.length; E++) {
      const y = g[E], C = s[E] || document.createElement("div"), M = C.style;
      M.position !== "absolute" && (M.position = "absolute", m = !0);
      const j = we(y.left - p);
      M.left !== j && (M.left = j, m = !0);
      const T = we(y.top - h);
      M.top !== T && (C.style.top = T, m = !0);
      const A = we(y.width);
      M.width !== A && (C.style.width = A, m = !0);
      const P = we(y.height);
      M.height !== P && (C.style.height = P, m = !0), C.parentNode !== c && (c.append(C), m = !0), s[E] = C;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(P) {
        const _ = P.getStartEndPoints();
        return P.isBackward() ? [_[1], _[0]] : _;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), C = g.offset, M = t.getElementByKey(b), j = t.getElementByKey(y), T = r === null || M !== o || m !== n || b !== r.getKey(), A = i === null || j !== s || C !== c || y !== i.getKey();
      if ((T || A) && M !== null && j !== null) {
        const P = function(_, O, U, k, Z, B, X) {
          const S = (_._window ? _._window.document : document).createRange();
          return S.setStart(...Uo(O, U, k)), S.setEnd(...Uo(Z, B, X)), S;
        }(t, h, f, M, g, E, j);
        l(), l = Al(t, P, e);
      }
      r = f, o = M, n = m, i = E, s = j, c = C;
    });
  }
...
function jl(t) {
  const e = In(t, (r) => Tr(r) && !r.isInline());
...
function Bl(t) {
  ...
  if (ue(e)) r = dc(e.focus, "next");
    ...
    r = r || wc(Me(), "previous").getFlipped().insert(Dr());
  }
...
function Fl(t, e, r) {
  ...
  return vc(o) && Jr(283), o.insert(t.isInline() ? Dr().append(t) : t), Mo($n(t.getLatest(), "next"), e.direction);
}
function Ul(t) {
  const e = Zt();
  if (!ue(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = In(i, (d) => Tr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function Yl(t) {
  ...
  Qn(this), st = t, this.f &= -2, 8 & this.f && uo(this), ca();
}
function rr(t, e) {
...
Gt.prototype.brand = Kl, Gt.prototype.h = function() {
  ...
  return st = t, Qn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ti(this), Go(this), be++;
  const t = st;
  return st = this, Yl.bind(this, t);
...
ae({ build: (t, e, r) => pr(e), config: Qe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ei() {
  const t = Me(), e = Zt(), r = Dr();
  t.clear(), t.append(r), e !== null && r.select(), ue(e) && (e.format = 0);
}
function ri(t, e = ei) {
  return t.registerCommand(An, (r) => (t.update(e), !0), no);
}
ae({ build: (t, e, r) => pr(e), config: Qe({ $onClear: ei }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [ai], register: (t, e, r) => t.registerCommand(Pn, (o) => {
  const n = Zt();
  if (Vn(n) || ue(n)) for (const i of n.getNodes()) Xl(i) && i.toggleFormat(o);
  return !1;
}, Ln) });
function oi(t, e) {
  let r;
...
const Ua = ae({ build: (t) => oi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const po = 0, Ka = 1, ii = 2, xa = 3, Lr = 4, er = 5, ya = 6, br = 7;
function ka(t) {
  return t.id === po;
}
function si(t) {
...
function Jl(t) {
  return function(e) {
    return e.id === Ka;
  }(t) || ut(305, String(t.id), String(Ka)), Object.assign(t, { id: ii });
}
...
const ed = ae({ config: Qe({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = td }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [_c, On, Nc, Cc, Mn] }), Yo = Symbol.for("@lexical/extension/LexicalBuilder");
function Wo() {
}
function rd(t) {
  throw t;
...
const ad = /* @__PURE__ */ new Set(), Xo = ae({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = Sr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = oi(() => {
  }, () => pe(() => {
...
ae({ dependencies: [Ua, Xo], name: "@lexical/extension/HorizontalRule", nodes: () => [cr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Xo).output, n = Sr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ye(t.registerCommand(od, (s) => {
    const c = Zt();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, no), t.registerCommand(Sc, (s) => {
    if (zc(s.target)) {
      const c = Rc(s.target);
      if (id(c)) return function(l, d = !1) {
        const w = Zt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Vn(w) ? g = w : (g = Dc(), Mc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(pe(() => {
      const d = c.value;
      d && (l.value ? jn(d, i) : Lc(d, i));
    }));
    return ye(...s);
  }));
} });
ae({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Qe({ $getParentEditor: function() {
  const t = Oc();
...
ae({ build: (t, e, r) => pr(e), config: Qe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return pe(() => {
...
function sd(t, e, r = ci) {
  return ye(t.registerCommand(jc, (o) => {
    const n = Zt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Kc : $o : qc;
    return t.dispatchCommand(i, void 0);
  }, no), t.registerCommand($o, () => {
...
ae({ build: (t, e, r) => pr(e), config: Qe({ $canIndent: ci, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return pe(() => {
    if (!o.value) return sd(t, n, i);
  });
} });
const cd = ae({ name: "@lexical/react/ReactProvider" });
function ld() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                ...
                if (Va(m) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(m, E, m, y)), E === y && p === "" || (f.insertRawText(p), m = b.getNode()), Va(m)) {
                  E = h, y = h + g;
...
ae({ build: (t, e, r) => pr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : di(t)) });
function ud(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
...
const vd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function bd({ onClear: t }) {
  const [e] = ge();
  return vd(() => ri(e, t), [e, t]), null;
}
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : q;
function xd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: E = !0, style: y, tabIndex: C, "data-testid": M, ...j }, T) {
  const [A, P] = N(t.isEditable()), _ = F((U) => {
    U && U.ownerDocument && U.ownerDocument.defaultView ? t.setRootElement(U) : t.setRootElement(null);
  }, [t]), O = I(() => /* @__PURE__ */ function(...U) {
    return (k) => {
      for (const Z of U) typeof Z == "function" ? Z(k) : Z != null && (Z.current = k);
    };
  }(T, _), [_, T]);
  return wi(() => (P(t.isEditable()), t.registerEditableListener((U) => {
    P(U);
  })), [t]), a("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? r : "none", "aria-controls": A ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? p : void 0, "aria-readonly": !A || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: A, "data-testid": M, id: b, ref: O, role: m, spellCheck: E, style: y, tabIndex: C, ...j });
}
const yd = Sn(xd);
function Zo(t) {
  return t.getEditorState().read(li(t.isComposing()));
...
function Sd({
  ...
  const [e] = ge(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Td(), l = () => {
  };
...
function Rd() {
  const { activeEditor: t } = pi(), [e, r] = N([]), o = F((n) => {
    if (ue(n) || tl(n)) {
      const i = [];
      Qo.forEach(({ format: s }) => {
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Oe, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        $e,
        {
          ...
          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: t.map((m) => /* @__PURE__ */ a(
            ke,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: Na(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
...
function en({
  ...
  const g = F(
    ...
    [t.user]
  ), y = I(() => ro(t.contents), [t.contents]), C = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), M = !!t.conflictResolutionAction && !C, j = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Ye,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(jd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Bd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : mo(T) && (T.preventDefault(), T.stopPropagation(), re(w) && f());
              },
              onKeyDown: (T) => {
        ...
        j && /* @__PURE__ */ u(Pe, { children: [
          /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
          /* @__PURE__ */ a(Le, { align: "end", children: j })
        ] })
      ]
    }
  );
  ...
  if (t)
    return /* @__PURE__ */ a(
      G,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(De, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const rn = {
...
function ki({
  ...
  const [k, Z] = N(rn), [B, X] = N(), [S, $] = N(), H = o, [tt, Tt] = N(!1), [kt, Rt] = N(!1), [R, Y] = N(!1), [rt, J] = N(!1), [nt, gt] = N(!1), [wt, xt] = N(M), [$t, Ut] = N(!1), Qt = K(void 0), [fe, D] = N(/* @__PURE__ */ new Map());
  q(() => {
    let z = !0;
    return (async () => {
      const yt = y ? await y(l) : !1;
      z && gt(yt);
    })(), () => {
      z = !1;
    };
    ...
    let z = !0;
    if (!o) {
      J(!1), D(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const yt = E ? await E(l) : !1;
      z && J(yt);
    })(), () => {
      z = !1;
    };
  ...
  q(() => {
    if (!o) {
      _t.current !== "idle" && (X(void 0), $(void 0), _t.current = "idle");
      return;
    }
    _t.current === "idle" && (_t.current = "pending"), rt ? _t.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== i && (X(A), _t.current = "auto-populated") : _t.current === "auto-populated" && (X(void 0), _t.current = "pending");
  }, [o, A, rt, i]);
  const St = I(
    () => P ?? e.filter((z) => !z.deleted),
    [P, e]
  );
  q(() => {
    let z = !0;
  ...
  const te = I(() => St[0], [St]), _e = K(null), ee = K(void 0), L = F(() => {
    var z;
    (z = ee.current) == null || z.call(ee), Z(rn);
  }, []), et = F(() => {
    const z = !wt;
    xt(z), Ut(!z), f == null || f(l, z);
  }, [wt, f, l]);
  q(() => {
    Tt(!1);
  }, [o]), q(() => {
  ...
  }, [i, r]), ct = I(() => St.slice(1), [St]), lt = I(() => ct.length ?? 0, [ct.length]), ft = I(() => lt > 0, [lt]), ht = I(() => tt || lt <= 2 ? ct : ct.slice(-2), [ct, lt, tt]), mt = I(() => tt || lt <= 2 ? 0 : lt - 2, [lt, tt]), It = I(
    () => lt === 1 ? at.singleReply : We(at.multipleReplies, { count: lt }),
    [lt, at]
  ), Dt = I(
    () => mt === 1 ? at.singleReply : We(at.multipleReplies, { count: mt }),
    [mt, at]
  );
  q(() => {
    !o && kt && ft && Rt(!1);
  ...
  const Wt = F(
    async (z) => {
      ...
      Pt && await p({ threadId: l, contents: Pt }) && L();
    },
    [
      L,
      k,
    ...
    async (z) => {
      const Pt = re(k) ? ea(k) : void 0, yt = z.status ? z.assignedUser : B ?? z.assignedUser, oe = await p({
        ...z,
        contents: Pt,
        assignedUser: yt
      });
      return oe && (yt !== void 0 && $(yt), Pt && L()), oe;
    },
    [L, k, p, B]
  );
  ...
  const Be = /* @__PURE__ */ a(
    en,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Rt,
      canEditOrDelete: (!kt && fe.get(te.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Ld, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            it && /* @__PURE__ */ a(Cr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: it }),
            /* @__PURE__ */ a(
              G,
              {
                variant: "ghost",
            ...
            O === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: nt && w !== "Resolved",
                  onClick: () => At({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(dt, { children: [
          ...
          !o && re(k) && /* @__PURE__ */ a(
            ta,
            {
              ...
              onSerializedChange: (z) => Z(z),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(dt, { children: [
            U && ht.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (z) => {
                  z.stopPropagation(), Tt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (z) => {
                  (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), Tt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Er, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Dt }),
                    tt ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(sr, {})
                  ] })
                ]
              }
            ),
            ht.map((z) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              en,
              {
                comment: z,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Rt,
                canEditOrDelete: (!kt && fe.get(z.id)) ?? !1
              }
            ) }, z.id)),
            m !== !1 && (!kt || re(k)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (z) => {
                  mo(z) && (z.preventDefault(), z.stopPropagation(), (re(k) || B !== void 0 && B !== S) && Wt());
                },
                onKeyDown: (z) => {
                  fo(z), (z.key === "Enter" || z.key === " ") && z.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    B !== void 0 && (re(k) || B !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: We(
                    ...
                    /* @__PURE__ */ u(Oe, { open: R, onOpenChange: Y, children: [
                      /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          align: "end",
                          onKeyDown: (z) => {
                            z.key === "Escape" && (z.stopPropagation(), Y(!1));
                          },
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Ae, { children: b == null ? void 0 : b.map((z) => /* @__PURE__ */ a(
                            ke,
                            {
                              onSelect: () => {
                                X(z !== i ? z : void 0), _t.current = "user-selected", $(void 0), Y(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Kd({
  ...
  const [s, c] = N("accept"), l = Xr(), d = Xr(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = I(
    () => Gr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = I(
    () => Gr(t.acceptedText ?? ""),
  ...
  let _;
  A ? _ = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (_ = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), k = (S) => S ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: S }) : U, Z = () => {
    const S = o ?? "accept";
    return S === "merged" ? t.mergedText ? /* @__PURE__ */ a(Hr, { html: E }) : U : k(S === "reject" ? t.rejectedResultText : t.resultText);
  }, B = (S) => p && S.value === "reject", X = (S) => {
    const $ = f === S.value, H = `${d}-${S.value}`, tt = B(S);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          Ya,
          {
            ...
            children: T.map((S) => B(S) ? /* @__PURE__ */ a(Lt, { delayDuration: 0, children: /* @__PURE__ */ u(jt, { children: [
              /* @__PURE__ */ a(Bt, { asChild: !0, children: X(S) }),
...
function fp({
  ...
  const [y, C] = N(/* @__PURE__ */ new Set()), [M, j] = N(), [T, A] = N(), P = F(
    async ($) => {
      const H = await i($);
      return H !== void 0 && $.assignedUser !== void 0 && $.assignedUser !== "" && A($.assignedUser), H;
    },
    [i]
  );
  q(() => {
    f && (C(($) => new Set($).add(f)), j(f));
  }, [f]);
  const _ = r.filter(
    ($) => $.comments.some((H) => !H.deleted)
  ), O = _.map(($) => ({ id: $.id })), U = F(
    ($) => {
      C((H) => new Set(H).add($.id)), j($.id), b == null || b($.id);
    },
    [b]
  ), k = F(
    ($) => {
      ...
      C((tt) => {
        const Tt = new Set(tt);
        return Tt.has($) ? Tt.delete($) : Tt.add($), Tt;
      }), j($), b == null || b(H ? void 0 : $);
    },
    [y, b]
  ), { listboxRef: Z, activeId: B, handleKeyDown: X } = Gi({
    options: O,
    onOptionSelect: U
  }), S = F(
    ($) => {
      $.key === "Escape" ? (M && y.has(M) && (C((H) => {
        const tt = new Set(H);
        return tt.delete(M), tt;
      }), j(void 0), b == null || b(void 0)), $.preventDefault(), $.stopPropagation()) : X($);
    },
    [M, y, X, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: _.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Wd, { ...H, conflictResolution: E }) : /* @__PURE__ */ a(ki, { ...H })
          },
          $.id
        );
      })
...
function Xd({ table: t }) {
  return /* @__PURE__ */ u(Pe, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function wr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Yt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Yt.Icon, { asChild: !0, children: /* @__PURE__ */ a(zn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ne({
  ...
  return /* @__PURE__ */ u(
    Yt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Yt.ItemIndicator, { children: /* @__PURE__ */ a(sa, { className: "tw:pointer-events-none" }) }) }),
...
function ew({
  ...
  var T;
  const [w, p] = N([]), [h, g] = N([]), [f, b] = N({}), [m, E] = N({}), y = I(() => e ?? [], [e]), C = Un({
    data: y,
    columns: t,
    getCoreRowModel: qn(),
  ...
  }), M = C.getVisibleFlatColumns();
  let j;
  return l ? j = Array.from({ length: 10 }).map((_, O) => `skeleton-row-${O}`).map((_) => /* @__PURE__ */ a(ze, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(or, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, _)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? j = C.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ze,
    {
      onClick: () => s(A, C),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((P) => /* @__PURE__ */ a(or, { children: _r(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    A.id
  )) : j = /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a(or, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Xd, { table: C }),
    /* @__PURE__ */ u(Ja, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Za, { stickyHeader: i, children: C.getHeaderGroups().map((A) => /* @__PURE__ */ a(ze, { children: A.headers.map((P) => /* @__PURE__ */ a(Wr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : _r(P.column.columnDef.header, P.getContext()) }, P.id)) }, A.id)) }),
      /* @__PURE__ */ a(Qa, { children: j })
    ] }),
...
function yp({
  ...
  return /* @__PURE__ */ u(Oe, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u($e, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Pe, { children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Le, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(fn, { children: d.itemType === 0 ? /* @__PURE__ */ a(dt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][h],
...
function sw({
  ...
  const l = Xa(), d = on(n, "%undoButton_tooltip%"), w = on(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Wa, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(
        G,
...
function dw({
  ...
  const f = (m) => {
    ...
    var E, y, C, M;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((C = i.current) == null ? void 0 : C.selectionStart) === 0 && ((M = s.current) == null || M.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Pe, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Pe, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
      /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ a("p", { children: uw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Le, { style: { zIndex: mn }, children: [
...
function fw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(De, { size: 16 })
    }
  );
}
function nn({
...
function Ep({
  ...
  Ht(() => {
    if (!g.current) return;
    const { width: L } = g.current.getBoundingClientRect();
    L > 0 && (g.current.style.width = `${L}px`);
  }, []);
  const [f, b] = N("generated"), [m, E] = N("generated"), [y, C] = N("*"), [M, j] = N("*"), [T, A] = N("f"), [P, _] = N(!1), [O, U] = N(!0), [k, Z] = N(!1), B = K(!1), X = K(""), [S, $] = N(!1), [H, tt] = N(), [Tt, kt] = N(), [Rt, R] = N(), [Y, rt] = N(), J = K(null), nt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  q(() => {
    ...
    let L;
    B.current = !1, U(!0);
    const et = e == null ? void 0 : e.at(0);
    if (et && Ar("note", et)) {
      const ct = (at = et.insert.note) == null ? void 0 : at.caller;
      let lt = "custom";
      ct === La ? lt = "generated" : ct === ja ? lt = "hidden" : ct && (C(ct), j(ct)), b(lt), E(lt), A(((it = et.insert.note) == null ? void 0 : it.style) ?? "f"), L = setTimeout(() => {
        var ft;
        (ft = w.current) == null || ft.applyUpdate([et]);
      }, 0);
    }
    return () => {
      L && clearTimeout(L);
  ...
  const wt = F(
    (L, et, at = !1) => {
      var ct, lt, ft;
      const it = (lt = (ct = w.current) == null ? void 0 : ct.getNoteOps(0)) == null ? void 0 : lt.at(0);
      if (it && Ar("note", it)) {
        if (it.insert.note) {
          let ht;
          L === "custom" ? ht = et : L === "generated" ? ht = La : ht = ja, it.insert.note.caller = ht;
        }
        r == null || r([it]), at && d && i && ((ft = d.current) == null || ft.replaceEmbedUpdate(i, [it]));
      }
    },
    [i, r, d]
  ), xt = F(() => {
  ...
  const Ut = K({ book: n.book, chapterNum: n.chapterNum });
  Ht(() => {
    (Ut.current.book !== n.book || Ut.current.chapterNum !== n.chapterNum) && (Ut.current = { book: n.book, chapterNum: n.chapterNum }, $t.current());
  }, [n.book, n.chapterNum]);
  const Qt = () => {
    var et;
    const L = (et = p.current) == null ? void 0 : et.getElementsByClassName("editor-input")[0];
    ...
    var at, it, ct, lt, ft;
    A(L);
    const et = (it = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : it.at(0);
    if (et && Ar("note", et)) {
      et.insert.note && (et.insert.note.style = L);
      const ht = (lt = (ct = et.insert.note) == null ? void 0 : ct.contents) == null ? void 0 : lt.ops;
      T !== "x" && L === "x" ? ht == null || ht.forEach((mt) => bw(mt)) : T === "x" && L !== "x" && (ht == null || ht.forEach((mt) => xw(mt))), (ft = w.current) == null || ft.applyUpdate([et, { delete: 1 }]);
    }
  }, St = (L) => {
    rt(L.contextMarker), Z(L.canRedo);
  }, te = F(
    (L) => {
      var at, it, ct, lt, ft;
      const et = (it = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : it.at(0);
      if (et && Ar("note", et)) {
        L.content.length > 1 && setTimeout(() => {
          var It;
          (It = w.current) == null || It.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ht = (ct = et.insert.note) == null ? void 0 : ct.style, mt = (ft = (lt = et.insert.note) == null ? void 0 : lt.contents) == null ? void 0 : ft.ops;
        if (ht || _(!1), _(
          ht === "x" ? !!(mt != null && mt.every((It) => {
            var Wt, At;
            if (!((Wt = It.attributes) != null && Wt.char)) return !0;
            const Dt = ((At = It.attributes) == null ? void 0 : At.char).style;
          ...
          B.current = !0, X.current = JSON.stringify(et), U(!0);
          return;
        }
        U(JSON.stringify(et) === X.current), wt(f, y);
      } else
        _(!1), U(!0);
    },
    [f, y, wt]
    ...
    if (h.current && gt.length && L && L.rangeCount > 0) {
      const et = L.getRangeAt(0).getBoundingClientRect(), at = h.current.getBoundingClientRect();
      tt(et.left - at.left), kt(et.top - at.top), R(et.height), $(!0);
    }
  }, [gt, h]);
  q(() => {
    const L = () => {
    ...
    var L;
    S && ((L = J.current) == null || L.focus());
  }, [S]), q(() => {
    var at;
    const L = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, et = (it) => {
      !S && L && document.activeElement === L && it.key === c ? (it.preventDefault(), _e()) : S && it.key === "Escape" && (it.preventDefault(), $(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
              ...
              /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ a("p", { children: ee }) })
            ] }) }) })
          ]
        }
      )
...
function Sp({
  ...
  const w = l ?? Gs(r, void 0), p = (y, C) => {
    d == null || d(y, C, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = N(h), b = (y, C, M) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(C, M, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
        ...
        "ul",
        {
          ...
          children: r.map((y, C) => {
            ...
            return /* @__PURE__ */ u(dt, { children: [
              ...
              C < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Er, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Ew({
  ...
  return /* @__PURE__ */ u(Ja, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Za, { stickyHeader: !0, children: /* @__PURE__ */ u(ze, { children: [
...
}, la = (t, e, r) => /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
  /* @__PURE__ */ u(
    Bt,
    {
...
function Ap({
  ...
  const g = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), b = de(r, "%webView_inventory_unapproved%"), m = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), y = de(r, "%webView_inventory_scope_chapter%"), C = de(r, "%webView_inventory_scope_verse%"), M = de(r, "%webView_inventory_filter_text%"), j = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = de(r, "%webView_inventory_no_results%"), [A, P] = N(!1), [_, O] = N("all"), [U, k] = N(""), [Z, B] = N([]), X = I(() => {
    const R = t ?? [];
    return R.length === 0 ? [] : Dw(R, n, i);
  }, [t, n, i]), S = I(() => {
    if (A) return X;
    const R = [];
    return X.forEach((Y) => {
      const rt = Y.items[0], J = R.find(
        (nt) => nt.items[0] === rt
      );
      J ? (J.count += Y.count, J.occurrences = J.occurrences.concat(Y.occurrences)) : R.push({
        items: [rt],
        count: Y.count,
  ...
  }, [A, X]), $ = I(() => S.length === 0 ? [] : Rw(S, _, U), [S, _, U]), H = I(() => {
    var rt, J;
    if (!A) return l;
    const R = (rt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : rt.length;
    if (!R) return l;
    const Y = [];
    for (let nt = 0; nt < R; nt++)
      Y.push(
        Sw(
          ((J = o == null ? void 0 : o.tableHeaders) == null ? void 0 : J[nt]) || "Additional Item",
          nt + 1
        )
      );
    return [...Y, ...l];
  ...
  q(() => {
    $.length === 0 ? B([]) : $.length === 1 && B($[0].items);
  }, [$]);
  const tt = (R, Y) => {
    Y.setRowSelection(() => {
      const J = {};
      return J[R.index] = !0, J;
    });
    const rt = R.original.items;
    B(rt), h && rt.length > 0 && h(rt[0]);
  }, Tt = (R) => {
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(lr, { onValueChange: (R) => Tt(R), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(ur, { children: [
          ...
          /* @__PURE__ */ a(ne, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ a(
        na,
      ...
      o && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(jt, { children: [
        ...
        /* @__PURE__ */ a(Ft, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const Mw = "16rem", Ow = "3rem", Ci = Jt.createContext(void 0);
function da() {
...
function $w({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    (C) => {
      const M = typeof C == "function" ? C(w) : C;
      r ? r(M) : d(M);
    },
    [r, w]
  ), h = Jt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", m = se() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Bw({
  ...
  const c = t ? Mr.Root : "button", { state: l } = da(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    Iw,
    {
      ...
      children: /* @__PURE__ */ u(Pw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Vw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Lw, { children: /* @__PURE__ */ a(
            Bw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Te = "scrBook", Uw = "scrRef", He = "source", Kw = "details", qw = "Scripture Reference", Gw = "Scripture Book", Ei = "Type", Hw = "Details";
function Yw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? bt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Te ? ve(n.start) : void 0;
      },
...
}, dn = (t) => `${Ww({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jp({
  sources: t,
  ...
  const [d, w] = N([]), [p, h] = N([{ id: Te, desc: !1 }]), [g, f] = N({}), b = I(
    () => t.flatMap((_) => _.data.map((O) => ({
      ...O,
      source: _.source
    }))),
    [t]
  ...
  q(() => {
    if (c) {
      const _ = E.getSelectedRowModel().rowsById, O = Object.keys(_);
      if (O.length === 1) {
        const U = b.find((k) => dn(k) === O[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Gw, C = i ?? Ei, M = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Te] },
    { label: `Group by ${C}`, value: [He] },
    {
    ...
    !_.getIsGrouped() && !_.getIsSelected() && _.getToggleSelectedHandler()(O);
  }, A = (_, O) => _.getIsGrouped() ? "" : v("banded-row", O % 2 === 0 ? "even" : "odd"), P = (_, O, U) => {
    if (!((_ == null ? void 0 : _.length) === 0 || O.depth < U.column.getGroupedIndex())) {
      if (O.getIsGrouped())
        switch (O.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ur, { position: "item-aligned", children: /* @__PURE__ */ a(Jd, { children: M.map((_) => /* @__PURE__ */ a(ne, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ja, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Za, { children: E.getHeaderGroups().map((_) => /* @__PURE__ */ a(ze, { children: _.headers.filter((O) => O.column.columnDef.header).map((O) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Wr, { colSpan: O.colSpan, className: "tw:sticky top-0", children: O.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          _r(O.column.columnDef.header, O.getContext())
        ] }) }, O.id)
      )) }, _.id)) }),
      /* @__PURE__ */ a(Qa, { children: E.getRowModel().rows.map((_, O) => {
        const U = se();
        return /* @__PURE__ */ a(
          ze,
          {
            ...
            className: v(A(_, O)),
            onClick: (k) => T(_, k),
            children: _.getVisibleCells().map((k) => {
              if (!(k.getIsPlaceholder() || k.column.columnDef.enableGrouping && !k.getIsGrouped() && (k.column.columnDef.id !== He || !r)))
                return /* @__PURE__ */ a(
                  or,
                  {
                    className: v(
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ a(sr, {}),
                          !_.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a($a, {}) : /* @__PURE__ */ a(Oa, {})),
                          " ",
                          _r(k.column.columnDef.cell, k.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
function Xw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = N(!1), [E, y] = N(""), C = K(void 0), M = K(!1), j = I(
    () => Ti(t),
    [t]
  ), T = I(() => {
    if (!E.trim()) {
    ...
    (k, Z = !1) => {
      if (!Z || !C.current) {
        r(
          e.includes(k) ? e.filter((tt) => tt !== k) : [...e, k]
        ), C.current = k;
        return;
      }
      const B = j.findIndex((tt) => tt === C.current), X = j.findIndex((tt) => tt === k);
      if (B === -1 || X === -1) return;
      const [S, $] = [
        Math.min(B, X),
        Math.max(B, X)
      ], H = j.slice(S, $ + 1).map((tt) => tt);
      r(
        e.includes(k) ? e.filter((tt) => !H.includes(tt)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, j]
  ), P = (k) => {
    ...
    k.preventDefault(), A(Z, k.shiftKey);
  }, O = () => {
    r(j.map((k) => k));
  }, U = () => {
    r([]);
          ...
          Ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: O, children: l }),
                /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: U, children: d })
              ] }),
              /* @__PURE__ */ u(Ae, { children: [
                /* @__PURE__ */ a(oa, { children: w }),
                Object.values(pt).map((k, Z) => {
                  const B = T[k];
                  if (B.length !== 0)
                    return /* @__PURE__ */ u(ia, { children: [
                      ...
                      Z < Object.values(pt).length - 1 && /* @__PURE__ */ a(vn, {})
                    ] }, k);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ea ? Ea : wn
      ).map((l) => /* @__PURE__ */ a(Cr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Se(l, n) }, l)),
...
function Qp({
  ...
  const M = Mt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Mt(s, "%webView_scope_selector_verse%"), T = Mt(s, "%webView_scope_selector_chapter%"), A = Mt(s, "%webView_scope_selector_book%"), P = Mt(
    s,
    "%webView_scope_selector_current_verse%"
  ), _ = Mt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), O = Mt(s, "%webView_scope_selector_current_book%"), U = Mt(s, "%webView_scope_selector_choose_books%"), k = Mt(s, "%webView_scope_selector_scope%"), Z = Mt(s, "%webView_scope_selector_select_books%"), B = Mt(s, "%webView_scope_selector_range%"), X = Mt(s, "%webView_scope_selector_select_range%"), S = Mt(s, "%webView_scope_selector_range_start%"), $ = Mt(s, "%webView_scope_selector_range_end%"), H = Mt(s, "%webView_scope_selector_ok%"), tt = Mt(s, "%webView_scope_selector_cancel%"), Tt = Mt(s, "%webView_scope_selector_navigate%"), kt = (V) => {
    if (!f) return;
  ...
  ], R = (V, Q, Xt = !1) => /* @__PURE__ */ u(dt, { children: [
    V,
    Q && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Q
    ] })
  ] }), Y = e ? Rt.filter((V) => e.includes(V.value)) : Rt, rt = f ?? ha, J = w ?? rt, nt = p ?? rt, gt = () => {
  }, wt = K(null), xt = K(null), $t = K(!1), Ut = K(null), Qt = K(!1), [fe, D] = N(void 0), _t = K(!1), St = K(!1), te = K(null), _e = F((V) => {
    if (V) {
      D("start"), _t.current = !1;
      return;
    }
    D((Q) => Q === "start" ? void 0 : Q), _t.current && (_t.current = !1, requestAnimationFrame(() => {
      var Xt;
      const Q = (Xt = wt.current) == null ? void 0 : Xt.querySelector("button");
      Q == null || Q.click();
    }));
  }, []), ee = F((V) => {
    if (V) {
    ...
    (V) => {
      h == null || h(V), g == null || g(V), _t.current = !0;
    },
    [h, g]
  ), et = F(
    (V) => {
      g == null || g(V), St.current = !0;
    },
    [g]
  ), at = F(
    (V) => {
      r(V), V === "selectedBooks" && n.length === 0 && (f != null && f.book) && i([f.book]);
    },
    [r, n, f, i]
  ), it = Y.find((V) => V.value === t), ct = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? Ys(J, nt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : it ? R(it.label, it.scrRefSuffix) : t, lt = Y.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), ft = Y.find((V) => V.value === "selectedBooks"), ht = Y.find((V) => V.value === "range"), [mt, It] = N(!1), [Dt, Wt] = N(void 0), [At, Be] = N(void 0), [z, Pt] = N(void 0), [yt, oe] = N(void 0), [Fe, hr] = N([]), gr = d === "dropdown" && Dt === "selectedBooks", fr = /* @__PURE__ */ a(
    Zw,
    {
      availableBookInfo: o,
  ...
  ), mr = fe === "end", Or = fe === "start", tr = "tw:text-muted-foreground", Ue = d === "dropdown" && Dt === "range", x = Ue ? Pt : L, ot = Ue ? oe : g ? et : gt, Vt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: v(mr && tr), children: S }),
      /* @__PURE__ */ a(
        fa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: wt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: v(Or && tr), children: $ }),
      /* @__PURE__ */ a(
        fa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: E,
          disableReferencesUpTo: Ue ? z ?? J : J,
          onOpenChange: ee,
          onCloseAutoFocus: (V) => {
            var Q;
            St.current && (St.current = !1, V.preventDefault(), (Q = te.current) == null || Q.focus());
          },
          className: v(Or && tr),
          modal: !0,
          align: "start"
  ...
  const [zt, Nt] = N(null), [Ct, vt] = N(null), [Kt, le] = N(null), qe = 200, [Ai, Pi] = N(!1);
  q(() => {
    if (!Kt || typeof ResizeObserver > "u") return;
    const V = new ResizeObserver(([Q]) => {
      Pi(Q.contentRect.width < qe);
    });
    return V.observe(Kt), () => V.disconnect();
  }, [Kt]);
  const xo = F(
    (V) => {
      Be(V), Pt(J), oe(nt), hr(n), It(!1), Wt(V);
    },
    [J, nt, n]
  ), yo = F(() => {
    At !== void 0 && (At === "range" ? (z && (h == null || h(z)), yt && (g == null || g(yt))) : At === "selectedBooks" && i(Fe), at(At), Wt(void 0), Be(void 0));
  }, [
    At,
    z,
    yt,
    ...
    V || (Wt(void 0), Be(void 0));
  }, []), ko = F((V) => {
    var Q;
    V.preventDefault(), (Q = Ke.current) == null || Q.focus();
  }, []), _o = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(De, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(Et, { children: k }),
      d === "dropdown" ? /* @__PURE__ */ u(Pe, { open: mt, onOpenChange: It, children: [
        ...
        /* @__PURE__ */ a(
          Le,
          {
            ...
            children: /* @__PURE__ */ u(wa, { container: Kt, children: [
              lt.map(({ value: V, label: Q, dropdownLabel: Xt, scrRefSuffix: vr, id: Vi }) => /* @__PURE__ */ u(
                Ye,
                {
                  ref: Ne(V),
                  ...
                  children: [
                    t === V && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(De, { className: "tw:h-4 tw:w-4" }) }),
                    R(Xt ?? Q, vr, Ai)
                  ]
                },
                Vi
              ...
              b && /* @__PURE__ */ u(dt, { children: [
                /* @__PURE__ */ a(Xe, {}),
                /* @__PURE__ */ a(zr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Tt }),
                /* @__PURE__ */ a(
                  Ye,
                  {
                    ref: Ut,
                    ...
                    onSelect: (V) => {
                      var Q, Xt;
                      if (V.preventDefault(), $t.current) {
                        $t.current = !1;
                        return;
                      }
                      Qt.current || (Xt = (Q = xt.current) == null ? void 0 : Q.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          ...
                          Q != null && Q.closest("button") && ($t.current = !0, requestAnimationFrame(() => {
                            $t.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          fa,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var Q;
                              V.preventDefault(), (Q = Ut.current) == null || Q.focus();
                            },
                            modal: !0,
        ...
        Ya,
        {
          ...
          children: Y.map(({ value: V, label: Q, scrRefSuffix: Xt, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Yr, { className: "tw:me-2", value: V, id: vr }),
            /* @__PURE__ */ a(Et, { htmlFor: vr, children: R(Q, Xt) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && Vt,
    d === "dropdown" && ft && /* @__PURE__ */ a(Sa, { open: Dt === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      za,
      {
        ref: vt,
        onCloseAutoFocus: ko,
        onEscapeKeyDown: (V) => {
          Ct != null && Ct.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(wa, { container: Ct, children: [
          /* @__PURE__ */ a(Ra, { className: "tw:pe-8", children: /* @__PURE__ */ a(Da, { children: U }) }),
          fr,
          /* @__PURE__ */ u(No, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => $r(!1), children: tt }),
            /* @__PURE__ */ a(G, { onClick: yo, children: H })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && ht && /* @__PURE__ */ a(Sa, { open: Dt === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      za,
      {
        ref: Nt,
        onCloseAutoFocus: ko,
        onEscapeKeyDown: (V) => {
          zt != null && zt.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(wa, { container: zt, children: [
          /* @__PURE__ */ a(Ra, { className: "tw:pe-8", children: /* @__PURE__ */ a(Da, { children: X }) }),
          Vt,
          /* @__PURE__ */ u(No, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => $r(!1), children: tt }),
            /* @__PURE__ */ a(G, { ref: te, onClick: yo, children: H })
          ] })
        ] })
      }
    ) })
...
function qa({
  ...
  return /* @__PURE__ */ u(Pe, { variant: i, children: [
    /* @__PURE__ */ a(Ve, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(Le, { align: "start", style: { zIndex: Ze }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ia, { children: [
      /* @__PURE__ */ a(fn, { children: /* @__PURE__ */ a(Lt, { children: Ri(e.groups, e.items, l, t) }) }),
...
function ih({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(eu, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (dl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(ru, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(au, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ze },
          children: /* @__PURE__ */ a(Lt, { children: Ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function lh({
  ...
  const d = pu(
    ...
    var E, y, C, M, j, T;
    const m = b !== f ? ((y = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? ((M = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : M.en) : void 0;
    return m ? `${(j = t[f]) == null ? void 0 : j.autonym} (${m})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: We(d, {
    ...
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(ia, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(De, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
const yr = 288, Tu = 176, Ce = 12, Su = 6;
function un(t) {
...
function Ru(t, e, r) {
  const o = (l) => Math.max(
    Ee,
    Math.min(l, window.innerWidth - yr - Ee)
  ), n = (l) => Math.max(
    Ee,
    Math.min(l, window.innerHeight - r - Ee)
  ), i = {
    top: t.top - Ce - r >= Ee,
    bottom: t.top + t.height + Ce + r <= window.innerHeight - Ee,
    left: t.left - yr - Ce >= Ee,
    right: t.left + t.width + Ce + yr <= window.innerWidth - Ee
  ...
  switch (!i[e] && i[s[e]] ? s[e] : e) {
    ...
    case "left":
      return { top: n(t.top), left: o(t.left - yr - Ce) };
    case "right":
      return { top: n(t.top), left: o(t.left + t.width + Ce) };
    default:
      return { top: n(t.top + t.height + Ce), left: o(t.left) };
  }
}
function og({
  steps: t,
  ...
  const [d, w] = N([]), [p, h] = N(0), [g, f] = N(void 0), [b, m] = N(!1), [E, y] = N(Tu), C = K(null), M = K(null), j = K(void 0), T = K(o);
  q(() => {
    T.current = o;
  });
  const A = Xr(), P = Xr();
  Ht(() => {
    ...
    w(t.filter((R) => un(R.target) !== void 0)), h(0), m(!0);
  }, [e]);
  const _ = d[p], O = g && g.step === _ ? g.rect : void 0, U = O !== void 0;
  q(() => {
    if (!e || !_) return;
    let R, Y = !1;
    const rt = () => {
      const nt = un(_.target);
      if (!nt) {
        Y || w((gt) => gt.filter((wt) => wt !== _));
        return;
      }
      Y = !0, f(
        (gt) => gt && gt.step === _ && gt.rect.top === nt.top && gt.rect.left === nt.left && gt.rect.width === nt.width && gt.rect.height === nt.height ? gt : { step: _, rect: nt }
      );
    }, J = () => {
    ...
    return rt(), window.addEventListener("resize", J), window.addEventListener("scroll", J, { capture: !0, passive: !0 }), () => {
      window.removeEventListener("resize", J), window.removeEventListener("scroll", J, { capture: !0 }), R !== void 0 && cancelAnimationFrame(R);
    };
  }, [e, _]), q(() => {
    d.length > 0 && p >= d.length && h(d.length - 1);
  }, [d, p]), q(() => {
    e && b && d.length === 0 && T.current();
  }, [e, b, d.length]), Ht(() => {
    var Y;
    const R = (Y = M.current) == null ? void 0 : Y.offsetHeight;
    R && y((rt) => rt !== R ? R : rt);
  }, [e, p, U]), q(() => {
    e ? j.current = document.activeElement ?? void 0 : (j.current instanceof HTMLElement || j.current instanceof SVGElement) && (j.current.isConnected && j.current.focus(), j.current = void 0);
  }, [e]), q(() => {
    var R;
    e && _ && U && ((R = C.current) == null || R.focus());
  }, [e, _, U]);
  const k = p === d.length - 1, Z = p === 0, B = F(() => {
    k ? r() : h((R) => R + 1);
  }, [k, r]), X = F(() => {
    Z || h((R) => R - 1);
  }, [Z]);
  if (q(() => {
    ...
    if (!e || !_ || !U) return;
    const R = Array.from(
      ((rt = M.current) == null ? void 0 : rt.querySelectorAll("button:not([disabled])")) ?? []
    ), Y = (J) => {
      if (J.key !== "Tab" || R.length === 0) return;
      const nt = R[0], gt = R[R.length - 1];
      J.shiftKey ? document.activeElement === nt && (J.preventDefault(), gt.focus()) : document.activeElement === gt && (J.preventDefault(), nt.focus());
    };
    return document.addEventListener("keydown", Y, !0), () => document.removeEventListener("keydown", Y, !0);
  }, [e, _, U]), !e || !_ || !O) return null;
  const S = zu(_.side ?? "bottom"), $ = Ru(O, S, E), H = _.spotlightPadding ?? Su, tt = O.left - H, Tt = O.top - H, kt = O.width + H * 2, Rt = O.height + H * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
      ...
      children: [
        ...
        /* @__PURE__ */ u(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ u("mask", { id: A, children: [
              ...
              /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "rgba(0,0,0,0.55)", mask: `url(#${A})` })
            ]
          }
        ),
        /* @__PURE__ */ u(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a("h3", { className: "tw:text-sm tw:font-semibold", children: _.title }),
              /* @__PURE__ */ a("p", { id: P, className: "tw:text-sm tw:text-muted-foreground", children: _.description }),
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: o, children: c }),
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !Z && /* @__PURE__ */ a(G, { variant: "outline", size: "sm", onClick: X, children: s }),
                  /* @__PURE__ */ a(G, { ref: C, size: "sm", onClick: B, children: k ? l : i })
                ] })
              ] })
            ]
          }
