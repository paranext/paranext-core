...
function du({
  ...
  const w = gt(), [d, u] = I(!1), [m, f] = I(""), [h, v] = I(""), [b, y] = I("books"), [N, _] = I(void 0), [k, $] = I(!1), j = G(void 0), A = G(void 0), R = G(void 0), C = G(void 0), E = G({}), T = K(
    (L) => {
      e(L), l && l(L);
    },
    [e, l]
          ...
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              U,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(As, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
function ur({
  ...
  const [_, k] = I(!1), $ = w ?? c, j = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], A = (R, C) => {
...
function mu({
  ...
  const d = Un(w, "%webView_bookSelector_currentBook%"), u = Un(w, "%webView_bookSelector_choose%"), m = Un(w, "%webView_bookSelector_chooseBooks%"), [f, h] = I(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    h(b), t(b);
...
function Wl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = Yl(null, o), d = zo({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, d), theme: o });
    return function(u, m) {
      if (m !== null) {
  ...
  const o = n.getDependency(hr).output, a = ln({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Ta(() => {
    ...
    o.value.read(() => {
      if (Dt()) for (const [d, u] of l.entries()) {
        ...
        const m = el(d), f = m && m.isSelected() || !1;
  ...
  return we(t.registerCommand(Mc, (s) => {
    ...
    if (qi(s.target)) {
      ...
      if (Ac(l)) return function(c, w = !1) {
        ...
        let f;
        w && Xo(d) ? f = d : (f = Yi(), Xi(f)), u ? f.delete(m) : f.add(m);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
function Pc(t, e, n = Ia) {
  return we(t.registerCommand(rl, (o) => {
    ...
    const i = function(s) {
      ...
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), u = mc(d);
      if (u.canIndent()) {
        const m = u.getKey();
        let f = ol();
        if (f.anchor.set(m, 0, "element"), f.focus.set(m, 0, "element"), f = al(f), f.anchor.is(w)) return !0;
      }
      return !1;
  ...
  return function(n, o) {
    ...
    return $r(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (m) => n._onError(m), children: r(Os, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
        u !== null && s.push(vl(d, u, w));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function Kc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    $r(() => we(gl(a), Oa(a)), [a]);
  }(o), p(at, { children: [t, r(Uc, { content: e }), r(Bc, { editor: o, ErrorBoundary: n })] });
}
...
function Yc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: u, ariaRequired: m, autoCapitalize: f, className: h, id: v, role: b = "textbox", spellCheck: y = !0, style: N, tabIndex: _, "data-testid": k, ...$ }, j) {
...
function Jc(t, e) {
  ...
  return p(at, { children: [r(Xc, { editor: a, ...o, ref: e }), n != null && r(Zc, { editor: a, content: n })] });
}
...
function ja(t, e, n, o = null) {
  ...
  if (a && !i) {
    if ((qo(d) || oo(d)) && d.append(m), n.append(d), u) {
      const f = u.call(s, d);
      f && (oo(d) ? d.replaceChildren(f) : d.replaceWith(f));
    }
  } else n.append(m);
  return a;
}
...
function za(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  return d != null && (m = d(m)), ao(t) && (m = dw(t, m, f ? () => {
    const h = new Qo();
    return n.push(h), h;
...
function fu({
  ...
  const [a, i] = I(uw), [s, l] = I(void 0), [c, w] = I(!1), d = G(void 0), u = G(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
    ...
    if (o && l)
      return /* @__PURE__ */ p(at, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (k) => {
              k.stopPropagation(), w(!0), u(pw(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: m,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), f()) : Fr(k) && (k.preventDefault(), k.stopPropagation(), jt(d) && h());
              },
              onKeyDown: (k) => {
...
function Ew({
  ...
  const [A, R] = I(No), [C, E] = I(
    void 0
  ), T = o, [S, M] = I(!1), [V, W] = I(!1), [P, tt] = I(!1), [Et, B] = I(!1), [st, J] = I(!1), [Z, H] = I(k), [wt, dt] = I(!1), ut = G(void 0), [Tt, re] = I(/* @__PURE__ */ new Map());
  q(() => {
    let O = !0;
    return (async () => {
  ...
  const Gt = z(() => e.filter((O) => !O.deleted), [e]);
  q(() => {
    let O = !0;
    if (!o || !_) {
      re(/* @__PURE__ */ new Map());
  ...
  }, [i, n]), F = z(() => Gt.slice(1), [Gt]), Y = z(() => F.length ?? 0, [F.length]), X = z(() => Y > 0, [Y]), pt = z(() => S || Y <= 2 ? F : F.slice(-2), [F, Y, S]), rt = z(() => S || Y <= 2 ? 0 : Y - 2, [Y, S]), _t = z(
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            ...
            /* @__PURE__ */ r(
              yo,
              {
                ...
                handleDeleteComment: f,
                onEditingChange: W,
                canEditOrDelete: (!V && Tt.get(qt.id)) ?? !1,
  ...
  const l = x.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), $w(f, h, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), Lw(l, v, d.key);
...
function _u({
  ...
  const s = z(() => xi(n), [n]), c = ((w) => {
    const d = new Intl.DisplayNames(yi(), { type: "language" });
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(at, { children: [
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ p(at, { children: [
  /* @__PURE__ */ r(Vo, {}),
  " ",
...
function Eu({
  ...
  const [h, v] = I("generated"), [b, y] = I("*"), [N, _] = I("f"), [k, $] = I(!1), [j, A] = I(!0), [R, C] = I(!1), E = G(!1), T = G(""), [S, M] = I(!1), [V, W] = I(), [P, tt] = I(), [Et, B] = I(), [st, J] = I(), Z = G(null), H = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Gt = () => {
    ...
    if (F && hn("note", F)) {
      ...
      N !== "x" && D === "x" ? mt == null || mt.forEach((Ot) => rd(Ot)) : N === "x" && D !== "x" && (mt == null || mt.forEach((Ot) => od(Ot))), (_t = d.current) == null || _t.applyUpdate([F, { delete: 1 }]);
    }
  }, oe = (D) => {
    ...
    /* @__PURE__ */ p("div", { ref: f, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(Hw, { editorRef: d, children: /* @__PURE__ */ r(
              Rl,
              {
                options: H,
                onStateChange: oe,
  ...
  return /* @__PURE__ */ p(at, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(at, { children: sd(t.marker, l, o, w) })
      }
    )
  ] });
}
...
function Lu({
  ...
  const f = Ht(n, "%webView_inventory_all%"), h = Ht(n, "%webView_inventory_approved%"), v = Ht(n, "%webView_inventory_unapproved%"), b = Ht(n, "%webView_inventory_unknown%"), y = Ht(n, "%webView_inventory_scope_currentBook%"), N = Ht(n, "%webView_inventory_scope_chapter%"), _ = Ht(n, "%webView_inventory_scope_verse%"), k = Ht(n, "%webView_inventory_filter_text%"), $ = Ht(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Ht(n, "%webView_inventory_no_results%"), [A, R] = I(!1), [C, E] = I("all"), [T, S] = I(""), [M, V] = I([]), W = z(() => {
    const H = t ?? [];
...
const Cd = ve(
  ...
  ({
    ...
    const c = t ? Ue : "button", { state: w } = zn(), d = /* @__PURE__ */ r(
      c,
      {
        ref: l,
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ p(
                      U,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (T === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r(rr, {})),
                          " ",
...
function Fd({
  ...
  const i = qr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    U,
    {
      variant: "outline",
...
function zd({
  ...
  const j = z(() => ht.allBookIds.filter(
    ...
    (V, W = !1) => {
      ...
      n(
        e.includes(V) ? e.filter((J) => !st.includes(J)) : [.../* @__PURE__ */ new Set([...e, ...st])]
      );
    },
    [e, n, j]
  ), C = (V) => {
            ...
            pe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(U, { variant: "ghost", size: "sm", onClick: M, children: w })
                ] }),
                /* @__PURE__ */ p(ue, { children: [
...
function Yd({
  ...
  if (Sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, u) => {
    var h, v, b, y;
    d.preventDefault();
    ...
    return /* @__PURE__ */ r(gs, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, u]) => typeof d == "boolean" || typeof u == "boolean" ? 0 : d.order - u.order).map(([d, u]) => /* @__PURE__ */ p(Kd, { children: [
...
function Es({
  ...
  return /* @__PURE__ */ r("ul", { className: g("tw-space-y-0.5", { "tw-ml-3": a.length > 0 }), children: t.map((l) => {
    const c = [...a, l], w = l.id === n, d = l.children && l.children.length > 0, m = Cs(l, n) && l.id !== n, f = l.id === n;
    return /* @__PURE__ */ r(
      ap,
      {
        domain: l,
...
const pm = Kt.Trigger, Np = Kt.Portal, um = Kt.Close, Rs = x.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Overlay,
  {
    ref: n,
...
Rs.displayName = Kt.Overlay.displayName;
