import es, { jsxs as de, jsx as T, Fragment as Vn } from "react/jsx-runtime";
import * as x from "react";
import Rt, { forwardRef as ts, useCallback as Se, useState as je, useRef as an, useEffect as Mt, useMemo as Lt } from "react";
...
function el({
  ...
  const s = Array.from({ length: t }, (l, u) => u + 1), c = Se(
    (l) => {
      i(l), console.log("new highlighted chapter: ", l);
    },
    [i]
  );
...
function yh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = ue, [r, o] = je(""), [i, s] = je(""), [c, l] = je(0), [u, d] = je(""), [f, p] = je(!1), b = an(void 0), v = an(void 0), g = Se(
    (S) => ({
      OT: n.filter((M) => ue.isBookOT(M)),
      NT: n.filter((M) => ue.isBookNT(M)),
      DC: n.filter((M) => ue.isBookDC(M))
    })[S],
    [n]
  ), h = Se(
    (S) => g(S).filter(
    ...
    o(S);
  }, $ = Se((S) => wi(ue.bookIdToNumber(S)), []), y = (S) => {
    l(ue.bookNumberToId(e.bookNum) !== S ? 1 : e.chapterNum), s(i !== S ? S : ""), $(S) === -1 && (t({
    ...
    if (u === i) {
      ...
      if (N === "ArrowRight")
        ...
        N === "ArrowDown" ? M = 6 : N === "ArrowUp" && (M = -6);
      c + M <= 0 || c + M > $(u) ? l(0) : (l(c + M), S.preventDefault());
    }
  };
  return Mt(() => {
    i === u ? i === ue.bookNumberToId(e.bookNum) ? l(e.chapterNum) : l(1) : l(0);
  }, [u, e.bookNum, e.chapterNum, i]), Mt(() => {
    f && (s(ue.bookNumberToId(e.bookNum)), l(e.chapterNum));
  }, [f, e.bookNum, e.chapterNum]), /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Gs, { modal: !1, open: f, onOpenChange: m, children: [
    /* @__PURE__ */ T(Ks, { asChild: !0, children: /* @__PURE__ */ T(
      Qs,
      {
        ...
        handleKeyDown: C,
        handleOnClick: () => {
          s(ue.bookNumberToId(e.bookNum)), l(e.chapterNum > 0 ? e.chapterNum : 0);
        },
    ...
    /* @__PURE__ */ de(
      $i,
      {
        ...
        children: [
          ...
          ol.map(
            (S) => h(S).length > 0 && /* @__PURE__ */ de("div", { children: [
              /* @__PURE__ */ T(Dr, { className: "pr-font-semibold pr-text-slate-700", children: rl[S] }),
              h(S).map((N) => /* @__PURE__ */ T("div", { children: /* @__PURE__ */ T(
                tl,
                {
                  bookId: N,
...
function il({
  ...
  let f;
  if (n) {
    const p = r === Pt.Before || r === Pt.Above, b = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${l ?? ""}`, children: n }), v = r === Pt.Before || r === Pt.After, g = v ? b : /* @__PURE__ */ T("div", { children: b }), h = v ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ de(
      gs,
      {
...
function ll() {
  ...
  return ie.AsyncMode = l, ie.ConcurrentMode = u, ie.ContextConsumer = c, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    return w(m) || y(m) === l;
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === p || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === s || m.$$typeof === c || m.$$typeof === d || m.$$typeof === h || m.$$typeof === E || m.$$typeof === $ || m.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function cl() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(_) {
      ...
      _ === r || _ === u || _ === i || _ === o || _ === f || _ === p || typeof _ == "object" && _ !== null && (_.$$typeof === v || _.$$typeof === b || _.$$typeof === s || _.$$typeof === c || _.$$typeof === d || _.$$typeof === h || _.$$typeof === E || _.$$typeof === $ || _.$$typeof === g);
    }
    function w(_) {
    ...
    var m = l, C = u, P = c, j = s, S = t, N = d, M = r, z = v, G = b, L = n, D = i, I = o, B = f, Q = !1;
    function Z(_) {
      return Q || (Q = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), O(_) || w(_) === l;
    }
    function O(_) {
      return w(_) === u;
    }
...
function pl() {
  ...
  return cr = function(c, l) {
    ...
    function S(O) {
      ...
      for (var A = 0; A < O.length; A++) {
        ...
        if (typeof V != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + Q(V) + " at index " + A + "."
          ), s;
      }
      function K(F, U, W, q, H) {
        for (var X = [], Y = 0; Y < O.length; Y++) {
          var ne = O[Y], _ = ne(F, U, W, q, H, n);
          if (_ == null)
            return null;
    ...
    function N() {
      function O(A, V, K, F, U) {
        return L(A[V]) ? null : new g("Invalid " + F + " `" + U + "` supplied to " + ("`" + K + "`, expected a ReactNode."));
      }
      return h(O);
    }
    function M(O, A, V, K, F) {
      return new g(
        (O || "React class") + ": " + A + " type `" + V + "." + K + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + F + "`."
      );
    }
    function z(O) {
      function A(V, K, F, U, W) {
...
function Bi(e, t, n, r, o) {
  ...
  let c;
  const l = i.type;
  return typeof l == "function" && !bl(l) && (c = "Did you accidentally use a plain function component for an element instead?"), c !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${c} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Li = Vt(a.element, Bi);
Li.isRequired = Vt(a.element.isRequired, Bi);
const pn = Li;
function vl(e) {
  const {
    prototype: t = {}
...
function yl(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let c;
  return typeof i == "function" && !vl(i) && (c = "Did you accidentally provide a plain function component instead?"), c !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${c} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function El() {
  ...
  return se.ContextConsumer = s, se.ContextProvider = i, se.Element = e, se.ForwardRef = l, se.Fragment = n, se.Lazy = p, se.Memo = f, se.Portal = t, se.Profiler = o, se.StrictMode = r, se.Suspense = u, se.SuspenseList = d, se.isAsyncMode = function() {
    return !1;
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === u || h === d || h === b || typeof h == "object" && h !== null && (h.$$typeof === p || h.$$typeof === f || h.$$typeof === i || h.$$typeof === s || h.$$typeof === l || h.$$typeof === v || h.getModuleId !== void 0);
  }, se.typeOf = g, se;
}
var le = {};
/**
...
function Tl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === n || R === o || $ || R === r || R === u || R === d || E || R === b || v || g || h || typeof R == "object" && R !== null && (R.$$typeof === p || R.$$typeof === f || R.$$typeof === i || R.$$typeof === s || R.$$typeof === l || // This needs to include all possible module reference object
    ...
    var C = s, P = i, j = e, S = l, N = n, M = p, z = f, G = t, L = o, D = r, I = u, B = d, Q = !1, Z = !1;
    function O(R) {
    ...
    le.ContextConsumer = C, le.ContextProvider = P, le.Element = j, le.ForwardRef = S, le.Fragment = N, le.Lazy = M, le.Memo = z, le.Portal = G, le.Profiler = L, le.StrictMode = D, le.Suspense = I, le.SuspenseList = B, le.isAsyncMode = O, le.isConcurrentMode = A, le.isContextConsumer = V, le.isContextProvider = K, le.isElement = F, le.isForwardRef = U, le.isFragment = W, le.isLazy = q, le.isMemo = H, le.isPortal = X, le.isProfiler = Y, le.isStrictMode = ne, le.isSuspense = _, le.isSuspenseList = J, le.isValidElementType = w, le.typeOf = m;
  }()), le;
}
...
function Rl(e, t) {
  ...
  return (o) => (i, s, c, l, u, ...d) => {
    const f = u || s, p = n == null ? void 0 : n[f];
    if (p) {
      const b = p(i, s, c, l, u, ...d);
      if (b)
        return b;
    }
...
function ec(e) {
  ...
  const s = ea(k({}, o, r)), c = Vo(r), l = Vo(o), u = t(s), d = we(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), p = k({}, u, n, l, c);
...
function gt(e) {
  ...
  } = e, s = ce(e, tc), c = i ? {} : Ql(r, o), {
    props: l,
    internalRef: u
  } = ec(k({}, s, {
    externalSlotProps: c
  })), d = Le(u, c == null ? void 0 : c.ref, (t = e.additionalProps) == null ? void 0 : t.ref);
  return Qt(n, k({}, l, {
    ref: d
  }), o);
}
...
function _n(e) {
  const {
    ...
    isEnabled: s = uc,
    open: c
  } = e, l = x.useRef(!1), u = x.useRef(null), d = x.useRef(null), f = x.useRef(null), p = x.useRef(null), b = x.useRef(!1), v = x.useRef(null), g = Le(t.ref, v), h = x.useRef(null);
  x.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      h.current = P, !(r || !s() || P.key !== "Tab") && y.activeElement === v.current && P.shiftKey && (l.current = !0, d.current && d.current.focus());
    }, m = () => {
      const P = v.current;
      if (P === null)
        return;
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (j = i(v.current)), j.length > 0) {
        var S, N;
        const M = !!((S = h.current) != null && S.shiftKey && ((N = h.current) == null ? void 0 : N.key) === "Tab"), z = j[0], G = j[j.length - 1];
        typeof z != "string" && typeof G != "string" && (M ? G.focus() : z.focus());
      } else
        P.focus();
    };
...
const ln = /* @__PURE__ */ x.forwardRef(function(t, n) {
  const {
    children: r,
    container: o,
    disablePortal: i = !1
  } = t, [s, c] = x.useState(null), l = Le(/* @__PURE__ */ x.isValidElement(r) ? r.ref : null, n);
  if (mt(() => {
    i || c(dc(o) || document.body);
  }, [o, i]), mt(() => {
    if (s && !i)
      return In(n, s), () => {
        In(n, null);
...
process.env.NODE_ENV !== "production" && (ln["propTypes"] = Fi(ln.propTypes));
function pc(e) {
  const t = xe(e);
...
function hc(e, t) {
  ...
  if (!t.disableScrollLock) {
    if (pc(r)) {
      ...
      const c = xe(r).querySelectorAll(".mui-fixed");
      [].forEach.call(c, (l) => {
        n.push({
          value: l.style.paddingRight,
          property: "padding-right",
          el: l
        }), l.style.paddingRight = `${zo(l) + s}px`;
      });
    }
    let i;
    if (r.parentNode instanceof DocumentFragment)
      ...
      const s = r.parentElement, c = _t(r);
...
function wc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = x.useRef({}), b = x.useRef(null), v = x.useRef(null), g = Le(v, f), [h, E] = x.useState(!d), $ = vc(l);
  let y = !0;
  ...
  const w = () => xe(b.current), m = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), C = () => {
    ...
    const I = bc(t) || w().body;
    o.add(m(), I), v.current && C();
  }), j = x.useCallback(() => o.isTopModal(m()), [o]), S = sn((I) => {
    b.current = I, I && (d && j() ? C() : v.current && tn(v.current, y));
  }), N = x.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  x.useEffect(() => () => {
  ...
  const M = (I) => (B) => {
    var Q;
    (Q = I.onKeyDown) == null || Q.call(I, B), !(B.key !== "Escape" || B.which === 229 || // Wait until IME is settled.
    !j()) && (n || (B.stopPropagation(), u && u(B, "escapeKeyDown")));
  }, z = (I) => (B) => {
    var Q;
    (Q = I.onClick) == null || Q.call(I, B), B.target === B.currentTarget && u && u(B, "backdropClick");
  };
  return {
    getRootProps: (I = {}) => {
      const B = ea(e);
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: Tr(I, l == null ? void 0 : l.props.onEnter),
        onExited: Tr(B, l == null ? void 0 : l.props.onExited)
      };
    },
    rootRef: g,
    portalRef: S,
...
var Ce = "top", Fe = "bottom", Ve = "right", Pe = "left", Lr = "auto", hn = [Ce, Fe, Ve, Pe], At = "start", cn = "end", xc = "clippingParents", ra = "viewport", Kt = "popper", Ec = "reference", Ho = /* @__PURE__ */ hn.reduce(function(e, t) {
  return e.concat([t + "-" + At, t + "-" + cn]);
}, []), oa = /* @__PURE__ */ [].concat(hn, [Lr]).reduce(function(e, t) {
  return e.concat([t, t + "-" + At, t + "-" + cn]);
...
function _c(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !Be(o) || !We(o) || (Object.assign(o.style, c), Object.keys(i).forEach(function(l) {
        o.removeAttribute(l);
      }));
    });
  };
...
function jt(e, t, n) {
  ...
  var s = bt(e) ? _e(e) : window, c = s.visualViewport, l = !ia() && n, u = (r.left + (l && c ? c.offsetLeft : 0)) / o, d = (r.top + (l && c ? c.offsetTop : 0)) / i, f = r.width / o, p = r.height / i;
  return {
    width: f,
    height: p,
    top: d,
...
var Lc = function(t, n) {
  ...
  })) : t, la(typeof t != "number" ? t : ca(t, hn));
};
function Fc(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, c = Ue(n.placement), l = zr(c), u = [Pe, Ve].indexOf(c) >= 0, d = u ? "height" : "width";
  if (!(!i || !s)) {
    var f = Lc(o.padding, n), p = Vr(i), b = l === "y" ? Ce : Pe, v = l === "y" ? Fe : Ve, g = n.rects.reference[d] + n.rects.reference[l] - s[l] - n.rects.popper[d], h = s[l] - n.rects.reference[l], E = mn(i), $ = E ? l === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - h / 2, w = f[b], m = $ - p[d] - f[v], C = $ / 2 - p[d] / 2 + y, P = nn(w, C, m), j = l;
...
function qo(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, c = e.position, l = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, p = s.x, b = p === void 0 ? 0 : p, v = s.y, g = v === void 0 ? 0 : v, h = typeof d == "function" ? d({
    x: b,
    y: g
  }) : {
    x: b,
  ...
  b = h.x, g = h.y;
  var E = s.hasOwnProperty("x"), $ = s.hasOwnProperty("y"), y = Pe, w = Ce, m = window;
  if (u) {
    var C = mn(n), P = "clientHeight", j = "clientWidth";
    if (C === _e(n) && (C = at(n), Ze(C).position !== "static" && c === "absolute" && (P = "scrollHeight", j = "scrollWidth")), C = C, o === Ce || (o === Pe || o === Ve) && i === cn) {
      w = Fe;
  ...
  if (b = z.x, g = z.y, l) {
    var G;
    return Object.assign({}, M, (G = {}, G[w] = $ ? "0" : "", G[y] = E ? "0" : "", G.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", G));
  }
  return Object.assign({}, M, (t = {}, t[w] = $ ? g + "px" : "", t[y] = E ? b + "px" : "", t.transform = "", t));
}
function Wc(e) {
...
function Gc(e) {
  var t = e.state, n = e.instance, r = e.options, o = r.scroll, i = o === void 0 ? !0 : o, s = r.resize, c = s === void 0 ? !0 : s, l = _e(t.elements.popper), u = [].concat(t.scrollParents.reference, t.scrollParents.popper);
  return i && u.forEach(function(d) {
    d.addEventListener("scroll", n.update, kn);
  }), c && l.addEventListener("resize", n.update, kn), function() {
    i && u.forEach(function(d) {
      d.removeEventListener("scroll", n.update, kn);
    }), c && l.removeEventListener("resize", n.update, kn);
  };
}
const Kc = {
  name: "eventListeners",
...
function Jc(e, t) {
  var n = _e(e), r = at(e), o = n.visualViewport, i = r.clientWidth, s = r.clientHeight, c = 0, l = 0;
  if (o) {
...
function Zc(e) {
  var t, n = at(e), r = Ur(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = ft(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = ft(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), c = -r.scrollLeft + Hr(e), l = -r.scrollTop;
  return Ze(o || n).direction === "rtl" && (c += ft(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: s,
    x: c,
    y: l
...
function ua(e) {
  return ["html", "body", "#document"].indexOf(We(e)) >= 0 ? e.ownerDocument.body : Be(e) && Wr(e) ? e : ua(Un(e));
}
function rn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ua(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = _e(r), s = o ? [i].concat(i.visualViewport || [], Wr(r) ? r : []) : r, c = t.concat(s);
  return o ? c : (
...
function tu(e, t, n, r) {
  var o = t === "clippingParents" ? eu(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], c = i.reduce(function(l, u) {
    var d = Ko(e, u, r);
    return l.top = ft(d.top, l.top), l.right = An(d.right, l.right), l.bottom = An(d.bottom, l.bottom), l.left = ft(d.left, l.left), l;
  }, Ko(e, s, r));
  return c.width = c.right - c.left, c.height = c.bottom - c.top, c.x = c.left, c.y = c.top, c;
}
function da(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? Ue(r) : null, i = r ? Bt(r) : null, s = t.x + t.width / 2 - n.width / 2, c = t.y + t.height / 2 - n.height / 2, l;
  switch (o) {
    case Ce:
      l = {
        x: s,
...
function un(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, c = n.boundary, l = c === void 0 ? xc : c, u = n.rootBoundary, d = u === void 0 ? ra : u, f = n.elementContext, p = f === void 0 ? Kt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, h = g === void 0 ? 0 : g, E = la(typeof h != "number" ? h : ca(h, hn)), $ = p === Kt ? Ec : Kt, y = e.rects.popper, w = e.elements[v ? $ : p], m = tu(bt(w) ? w : w.contextElement || at(e.elements.popper), l, d, s), C = jt(e.elements.reference), P = da({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
  }), j = Cr(Object.assign({}, y, P)), S = p === Kt ? j : C, N = {
  ...
  if (p === Kt && M) {
    ...
    Object.keys(N).forEach(function(G) {
      var L = [Ve, Fe].indexOf(G) >= 0 ? 1 : -1, D = [Ce, Fe].indexOf(G) >= 0 ? "y" : "x";
      N[G] += z[D] * L;
    });
  }
  return N;
...
function nu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, c = n.flipVariations, l = n.allowedAutoPlacements, u = l === void 0 ? oa : l, d = Bt(r), f = d ? c ? Ho : Ho.filter(function(v) {
    return Bt(v) === d;
...
function ou(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, c = s === void 0 ? !0 : s, l = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, E = Ue(h), $ = E === h, y = l || ($ || !v ? [Pn(h)] : ru(h)), w = [h].concat(y).reduce(function(F, U) {
      ...
      var M = w[N], z = Ue(M), G = Bt(M) === At, L = [Ce, Fe].indexOf(z) >= 0, D = L ? "width" : "height", I = un(t, {
        placement: M,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
      ...
      m[D] > C[D] && (B = Pn(B));
      var Q = Pn(B), Z = [];
      if (i && Z.push(I[z] <= 0), c && Z.push(I[B] <= 0, I[Q] <= 0), Z.every(function(F) {
        return F;
      })) {
        S = M, j = !1;
        break;
...
function au(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = un(t, {
    ...
    altBoundary: !0
  }), l = Xo(s, r), u = Xo(c, o, i), d = Yo(l), f = Yo(u);
  t.modifiersData[n] = {
...
function lu(e, t, n) {
  ...
  return s = s || 0, c = (c || 0) * o, [Pe, Ve].indexOf(r) >= 0 ? {
    x: c,
    y: s
  } : {
    x: s,
...
function hu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, c = s === void 0 ? !1 : s, l = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = un(t, {
    boundary: l,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), $ = Bt(t.placement), y = !$, w = zr(E), m = fu(w), C = t.modifiersData.popperOffsets, P = t.rects.reference, j = t.rects.popper, S = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, N = typeof S == "number" ? {
    mainAxis: S,
    altAxis: S
    ...
    mainAxis: 0,
    altAxis: 0
  }, S), M = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, z = {
    x: 0,
    y: 0
  };
  if (C) {
    if (i) {
      var G, L = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, I = w === "y" ? "height" : "width", B = C[w], Q = B + h[L], Z = B - h[D], O = b ? -j[I] / 2 : 0, A = $ === At ? P[I] : j[I], V = $ === At ? -j[I] : -P[I], K = t.elements.arrow, F = b && K ? Vr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sa(), W = U[L], q = U[D], H = nn(0, P[I], F[I]), X = y ? P[I] / 2 - O - H - W - N.mainAxis : A - H - W - N.mainAxis, Y = y ? -P[I] / 2 + O + H + q + N.mainAxis : V + H + q + N.mainAxis, ne = t.elements.arrow && mn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = M == null ? void 0 : M[w]) != null ? G : 0, R = B + X - J - _, re = B + Y - J, ve = nn(b ? An(Q, R) : Q, B, b ? ft(Z, re) : Z);
      C[w] = ve, z[w] = ve - B;
    }
    if (c) {
      var Te, me = w === "x" ? Ce : Pe, lt = w === "x" ? Fe : Ve, ke = C[m], Ge = m === "y" ? "height" : "width", Ne = ke + h[me], Ke = ke - h[lt], ye = [Ce, Pe].indexOf(E) !== -1, yt = (Te = M == null ? void 0 : M[m]) != null ? Te : 0, ct = ye ? Ne : ke - P[Ge] - j[Ge] - yt + N.altAxis, zt = ye ? ke + P[Ge] + j[Ge] - yt - N.altAxis : Ke, yn = b && ye ? Bc(ct, ke, zt) : nn(b ? ct : Ne, ke, b ? zt : Ke);
      C[m] = yn, z[m] = yn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function yu(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && vu(t), i = at(t), s = jt(e, o, n), c = {
    scrollLeft: 0,
    scrollTop: 0
  }, l = {
    x: 0,
  ...
  Wr(i)) && (c = bu(t)), Be(t) ? (l = jt(t, !0), l.x += t.clientLeft, l.y += t.clientTop) : i && (l.x = Hr(i))), {
    ...
    var d = {
      ...
      setOptions: function(E) {
        ...
        g(), d.options = Object.assign({}, i, d.options, $), d.scrollParents = {
          reference: bt(c) ? rn(c) : c.contextElement ? rn(c.contextElement) : [],
          popper: rn(l)
        };
...
const Mu = () => et({
  ...
  } = t, h = ce(t, Pu), E = x.useRef(null), $ = Le(E, n), y = x.useRef(null), w = Le(y, p), m = x.useRef(w);
  mt(() => {
    m.current = w;
  }, [w]), x.useImperativeHandle(p, () => y.current, []);
  const C = Ru(d, s), [P, j] = x.useState(C), [S, N] = x.useState(Dn(o));
  x.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && S && Hn(S) && S.nodeType === 1) {
...
`));
  ...
  if (i)
    ...
    const N = Dn(r);
    P = N && Hn(N) ? xe(N).body : xe(null).body;
  }
  const j = !d && l && (!g || y) ? "none" : void 0, S = g ? {
    in: d,
    onEnter: m,
    onExited: C
  } : void 0;
...
function ju(e) {
  ...
  function f(p) {
    const b = s.indexOf(p);
    return b === 0 ? c(s[1]) : b === s.length - 1 ? l(s[b]) : u(p, s[s.indexOf(p) + 1]).replace("@media", "@media not all and");
  }
  return k({
    keys: s,
    values: i,
...
function be(e) {
  const {
    ...
    if (s[t] == null)
      return null;
    const c = s[t], l = s.theme, u = Wn(l, r) || {};
    return Qe(s, c, (f) => {
      let p = jn(u, o, f);
...
function Rd() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : Qe(s, r, (v) => {
      let g = jn(p, d, v);
      return v === g && typeof v == "string" && (g = jn(p, d, `${n}${v === "default" ? "" : He(v)}`, v)), l === !1 ? g : {
        [l]: g
      };
    });
  }
...
function Rn(e, t) {
  ...
  if (o && typeof o == "object" && Array.isArray(o.variants)) {
    ...
    return i.forEach((l) => {
      let u = !0;
      typeof l.props == "function" ? u = l.props(k({
        ownerState: n
      }, r, n)) : Object.keys(l.props).forEach((d) => {
        (n == null ? void 0 : n[d]) !== l.props[d] && r[d] !== l.props[d] && (u = !1);
      }), u && (Array.isArray(c) || (c = [c]), c.push(typeof l.style == "function" ? l.style(k({
        ownerState: n
      }, r, n)) : l.style));
    }), c;
  }
...
function zd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, c = {}) => {
    $s(s, (m) => m.filter((C) => !(C != null && C.__mui_systemSx)));
    const {
      name: l,
      slot: u,
    ...
    } = c, b = ce(c, jd), v = d !== void 0 ? d : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      u && u !== "Root" && u !== "root" || !1
    ), g = f || !1;
    let h;
    process.env.NODE_ENV !== "production" && l && (h = `${l}-${ti(u || "Root")}`);
    let E = Nn;
    u === "Root" || u === "root" ? E = r : u ? E = o : Ld(s) && (E = void 0);
    const $ = Ns(s, k({
      shouldForwardProp: E,
      label: h
    }, b)), y = (m) => typeof m == "function" && m.__emotion_real !== m || pt(m) ? (C) => Rn(m, k({}, C, {
      theme: On({
        theme: C.theme,
        defaultTheme: n,
        themeId: t
      ...
      l && p && j.push((M) => {
        ...
        if (!z.components || !z.components[l] || !z.components[l].styleOverrides)
          return null;
        const G = z.components[l].styleOverrides, L = {};
        return Object.entries(G).forEach(([D, I]) => {
          L[D] = Rn(I, k({}, M, {
            theme: z
          }));
        }), p(M, L);
        ...
        const G = On(k({}, M, {
          defaultTheme: n,
          themeId: t
        })), L = G == null || (z = G.components) == null || (z = z[l]) == null ? void 0 : z.variants;
        return Rn({
          variants: L
        }, k({}, M, {
          theme: G
      ...
      if (process.env.NODE_ENV !== "production") {
        let M;
        l && (M = `${l}${He(u || "")}`), M === void 0 && (M = `Styled(${Sl(s)})`), N.displayName = M;
      }
...
function qd(e) {
  ...
  return e.type === "hsla" && (c += "a", l.push(t[3])), Qn({
    type: c,
    values: l
  });
}
...
function pp(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = ce(e, ip), i = e.primary || ap(t), s = e.secondary || sp(t), c = e.error || lp(t), l = e.info || cp(t), u = e.success || up(t), d = e.warning || dp(t);
  function f(g) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return ii(g, "light", $, r), ii(g, "dark", y, r), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: fr,
    light: oi
  };
...
`)), Object.keys(u).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(u).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((d) => `${d} ${typeof s == "string" ? s : li(s)} ${c} ${typeof l == "string" ? l : li(l)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
const Rp = Np(), Zr = Rp, Qr = "$$material", ya = (e) => Nn(e) && e !== "classes", $p = zd({
  themeId: Qr,
  defaultTheme: Zr,
...
var _p = function(t) {
  ...
  function t(r, o) {
    ...
    return i.appearStatus = null, r.in ? c ? (l = ut, i.appearStatus = dt) : l = Nt : r.unmountOnExit || r.mountOnEnter ? l = en : l = ut, i.state = {
      status: l
  ...
  return n.componentDidMount = function() {
    ...
    var i = this, s = this.props.enter, c = this.context ? this.context.isMounting : o, l = this.props.nodeRef ? [c] : [En.findDOMNode(this), c], u = l[0], d = l[1], f = this.getTimeouts(), p = c ? f.appear : f.enter;
    if (!o && !s || ci.disabled) {
      this.safeSetState({
        status: Nt
      }, function() {
    ...
    var o = this, i = this.props.exit, s = this.getTimeouts(), c = this.props.nodeRef ? void 0 : En.findDOMNode(this);
    if (!i || ci.disabled) {
      this.safeSetState({
        status: ut
      }, function() {
    ...
    var s = this.props.nodeRef ? this.props.nodeRef.current : En.findDOMNode(this), c = o == null && !this.props.addEndListener;
    if (!s || c) {
...
const Dp = {
  ...
  } = t, E = ce(t, Ap), $ = Zt(), y = x.useRef(), w = vn(), m = x.useRef(null), C = Le(m, i.ref, n), P = (D) => (I) => {
    if (D) {
      const B = m.current;
      I === void 0 ? D(B) : D(B, I);
    }
...
const $r = eo, jp = (e) => {
  ...
  const o = ba(), i = tt({
    ...
    slots: y,
    slotProps: w
  } = i, m = ce(i, Bp), C = (r = y == null ? void 0 : y.root) != null ? r : l == null ? void 0 : l.Root, P = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Oa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, c, l, u, d, f, p, b, v, g, h, E, $, y, w, m;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    slots: Y = {},
    title: ne,
    TransitionComponent: _ = $r,
    TransitionProps: J
  } = C, R = ce(C, zp), re = /* @__PURE__ */ x.isValidElement(j) ? j : /* @__PURE__ */ T("span", {
    children: j
  }), ve = vn(), Te = ve.direction === "rtl", [me, lt] = x.useState(), [ke, Ge] = x.useState(null), Ne = x.useRef(!1), Ke = L || Z, ye = Zt(), yt = Zt(), ct = Zt(), zt = Zt(), [yn, oo] = Hi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const io = (ee) => {
    ...
    Ne.current && ee.type !== "touchstart" || (me && me.removeAttribute("title"), yt.clear(), ct.clear(), I || Sn && B ? yt.start(Sn ? B : I, () => {
      io(ee);
    }) : io(ee));
  }, ao = (ee) => {
    yt.clear(), ct.start(A, () => {
    ...
    re.props.onTouchEnd && re.props.onTouchEnd(ee), wn(), ct.start(V, () => {
      xn(ee);
    });
  };
  x.useEffect(() => {
  ...
  M ? (Ht.title = !Xe && rr && !G ? ne : null, Ht["aria-describedby"] = Xe ? er : null) : (Ht["aria-label"] = rr ? ne : null, Ht["aria-labelledby"] = Xe && !rr ? er : null);
...
`));
  const Xa = x.useMemo(() => {
    ...
    touch: Ne.current
  }), or = Hp(qt), mo = (r = (o = Y.popper) != null ? o : S.Popper) != null ? r : Wp, go = (i = (s = (c = Y.transition) != null ? c : S.Transition) != null ? s : _) != null ? i : $r, bo = (l = (u = Y.tooltip) != null ? u : S.Tooltip) != null ? l : qp, vo = (d = (f = Y.arrow) != null ? f : S.Arrow) != null ? d : Gp, Ya = Qt(mo, k({}, H, (p = X.popper) != null ? p : N.popper, {
    className: we(or.popper, H == null ? void 0 : H.className, (b = (v = X.popper) != null ? v : N.popper) == null ? void 0 : b.className)
  }), qt), Ja = Qt(go, k({}, J, (g = X.transition) != null ? g : N.transition), qt), Za = Qt(bo, k({}, (h = X.tooltip) != null ? h : N.tooltip, {
    className: we(or.tooltip, (E = ($ = X.tooltip) != null ? $ : N.tooltip) == null ? void 0 : E.className)
  }), qt), Qa = Qt(vo, k({}, (y = X.arrow) != null ? y : N.arrow, {
    className: we(or.arrow, (w = (m = X.arrow) != null ? m : N.arrow) == null ? void 0 : w.className)
  }), qt);
  return /* @__PURE__ */ de(x.Fragment, {
...
const Jp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Zp = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, Jp), v = /* @__PURE__ */ x.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: c,
    fontSize: l,
  ...
  const {
    ...
    vs,
    {
      ...
      children: n ? /* @__PURE__ */ de(Vn, { children: [
        ...
        f ? /* @__PURE__ */ T(Ei, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ T(Pa, {}) }) : hi(s, n, !1)
      ] }) : h
    }
  );
...
function ro(e) {
  ...
  }, [o, t]), c = ({ item: d, isLastItemInGroup: f }) => ({
...
function uf(e) {
  ...
  let i = Object.entries(t.groups).map(([s, c]) => ({ id: s, group: c })).filter((s) => "column" in s.group);
  ...
  const { columns: o } = n, i = Lt(() => {
    ...
    return Object.getOwnPropertyNames(o).forEach((c) => {
      if (c === "isExtensible")
        return;
      const l = c, u = o[l];
      typeof u == "object" && typeof u.order == "number" && !Number.isNaN(u.order) ? s.set(u.order, { id: l, metadata: u }) : console.warn(
        `Property ${c} (${typeof u}) on menu ${r} is not a valid column and is being ignored. This might indicate data corruption`
      );
    }), Array.from(s.values()).sort((c, l) => (c.metadata.order || 0) - (l.metadata.order || 0));
  }, [o, r]);
  return /* @__PURE__ */ T(
    Ti,
    {
...
function Jt(e, t, n, r, o, i) {
  ...
  for (; c; ) {
    ...
    if (!c.hasAttribute("tabindex") || !Ia(c, i) || l)
      c = o(e, c, n);
    else
      return c.focus(), !0;
  }
...
const _a = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const g = (y) => {
    ...
    if (m === "ArrowDown")
      y.preventDefault(), Jt(w, C, u, l, gr);
    else if (m === "ArrowUp")
      y.preventDefault(), Jt(w, C, u, l, mi);
    else if (m === "Home")
      y.preventDefault(), Jt(w, null, u, l, gr);
    else if (m === "End")
      y.preventDefault(), Jt(w, null, u, l, mi);
    else if (m.length === 1) {
      ...
      const N = C && !P.repeating && Ia(C, P);
      P.previousKeyMatched && (N || Jt(w, C, !1, l, gr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, h = Le(b, n);
  let E = -1;
...
const wf = _a, xf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ef = {
  ...
  const r = vn(), o = {
  ...
  } = t, y = ce(t, xf), w = x.useRef(null), m = Le(w, c.ref, n), C = (L) => (D) => {
    if (L) {
      const I = w.current;
      D === void 0 ? L(I) : L(I, D);
    }
    ...
    L.style.webkitTransition = r.transitions.create("opacity", I), L.style.transition = r.transitions.create("opacity", I), d && d(L, D);
  }), S = C(f), N = C(g), M = C((L) => {
    const D = Ln({
      style: h,
      timeout: E,
  ...
  return /* @__PURE__ */ T($, k({
    ...
    children: (L, D) => /* @__PURE__ */ x.cloneElement(c, k({
      style: k({
        opacity: 0,
        visibility: L === "exited" && !u ? "hidden" : void 0
      }, Ef[L], h, c.props.style),
      ref: m
    }, D))
  }));
});
...
const Of = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Sf = (e) => {
  ...
  return /* @__PURE__ */ T(h, k({
    ...
    children: /* @__PURE__ */ T(Cf, k({
      ...
      className: we(w.root, l, m == null ? void 0 : m.className),
...
const Rf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], $f = (e) => {
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Mf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, X = (c = G == null ? void 0 : G.root) != null ? c : $.root, Y = (l = G == null ? void 0 : G.backdrop) != null ? l : $.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: X,
...
const Hf = (e) => {
  ...
  const s = tt({
  ...
  } = s, N = ce(s.TransitionProps, Vf), M = ce(s, zf), z = (r = w == null ? void 0 : w.paper) != null ? r : $, G = x.useRef(), L = Le(G, z.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: h,
    ...
    TransitionProps: N
  }), I = Hf(D), B = x.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = $n(l), R = J && J.nodeType === 1 ? J : xe(G.current).body, re = R.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
  ...
  }, [l, u.horizontal, u.vertical, d, f]), Q = x.useCallback((J) => ({
    ...
    const lt = Te + R.height, ke = me + R.width, Ge = _t($n(l)), Ne = Ge.innerHeight - h, Ke = Ge.innerWidth - h;
    if (h !== null && Te < h) {
      const ye = Te - h;
...
`)), h !== null && me < h) {
  ...
  }, [l, f, B, Q, h]), [O, A] = x.useState(E), V = x.useCallback(() => {
    const J = G.current;
    if (!J)
      return;
    const R = Z(J);
  ...
  x.useEffect(() => (S && window.addEventListener("scroll", V), () => window.removeEventListener("scroll", V)), [l, S, V]);
  const K = (J, R) => {
    j && j(J, R), V();
  }, F = () => {
    A(!1);
  ...
  const W = v || (l ? xe($n(l)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Wf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, X = gt({
    elementType: H,
    ...
    ownerState: D,
    className: we(I.paper, z == null ? void 0 : z.className)
  }), Y = gt({
    elementType: q,
...
const Kf = ["onEntering"], Xf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Yf = {
  ...
  const i = tt({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, w = ce(i.TransitionProps, Kf), m = ce(i, Xf), C = vn(), P = C.direction === "rtl", j = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), S = Zf(j), N = s && !u && p, M = x.useRef(null), z = (Z, O) => {
    M.current && M.current.adjustStyleForScrollbar(Z, C), h && h(Z, O);
  }, G = (Z) => {
    Z.key === "Tab" && (Z.preventDefault(), f && f(Z, "tabKeyDown"));
  };
  let L = -1;
  x.Children.map(c, (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const D = (r = $.paper) != null ? r : eh, I = (o = y.paper) != null ? o : b, B = gt({
    elementType: $.root,
...
function ih({
  ...
  const [E] = Mr(
    Se(async () => (e == null ? void 0 : e(!1)) ?? t, [e, t, l]),
    t
  ), [$] = Mr(
    Se(async () => (e == null ? void 0 : e(!0)) ?? n ?? E, [e, n, E, l]),
    n ?? E
  ), y = d && $ ? $ : E;
  return /* @__PURE__ */ de(Vn, { children: [
    /* @__PURE__ */ T(
...
function Ph({
  ...
  return /* @__PURE__ */ T(
    Is,
    {
      ...
      className: `papi-table ${M ?? "rdg-light"}`,
      "data-testid": z
    }
  );
}
