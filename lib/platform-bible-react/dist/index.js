...
import { c as b, g as $e, a as Vr, C as er, L as Un, u as Qo, t as Kn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, D as je, h as Te, i as Fe, j as cr, k as We, B as et, x as ks, l as _s, m as Ns, I as Cs, n as Co, o as Ze, r as De, p as Es, q as Gn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Ma, E as Eo, F as ur, G as Oa, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as Fr, W as Ur, X as yr, Y as Ts, Z as ir, _ as Je, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Mo, a6 as Wn, a7 as Ss, a8 as Rs, a9 as Ds, aa as wo, ab as Yn, ac as Ia, ad as Ms, ae as Xn, af as Os, ag as Is, ah as zs, ai as tn, aj as Ps, ak as As, al as $s, am as Jn, an as Zn, ao as Oo, ap as Vs, aq as Qn, ar as Ka, as as en, at as Ha, au as Ls, av as Bs, aw as js, ax as Fs, ay as Us, az as Ks, aA as Hs, aB as Gs, aC as qs, aD as Io, aE as zo, aF as Ws, aG as Ys } from "./resizable-sNmPgyNY.js";
import { aH as mf, aI as vf, aJ as bf, aK as xf, aL as yf, aM as kf, aN as _f, aO as Nf, aP as Cf, aQ as Ef, aR as Tf, aS as Sf, aT as Rf, aU as Df, aV as Mf, aW as Of, aX as If, aY as zf, aZ as Pf, a_ as Af, a$ as $f, b0 as Vf, b1 as Lf, b2 as Bf, b3 as jf, b4 as Ff, b5 as Uf, b6 as Kf, b7 as Hf, b8 as Gf, b9 as qf, ba as Wf, bb as Yf, bc as Xf, bd as Jf, be as Zf, bf as Qf } from "./resizable-sNmPgyNY.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as Kt } from "@sillsdev/scripture";
import { Check as Qe, Clock as rn, ChevronsLeft as an, ChevronsRight as on, ChevronUp as ti, ChevronDown as sr, ArrowLeft as Xs, ArrowRight as Js, BoldIcon as Zs, ItalicIcon as Qs, X as ei, AtSign as ri, Pencil as tc, Trash2 as ec, Undo2 as rc, ArrowUp as ai, MoreHorizontal as ac, MailOpen as oc, Mail as nc, FilterIcon as ic, ArrowLeftIcon as sc, ChevronLeftIcon as cc, ChevronRightIcon as lc, ArrowRightIcon as dc, Copy as oi, Filter as wc, User as uc, Link as pc, CircleHelp as hc, Undo as gc, Redo as fc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as mc, AlertCircle as uo, CircleCheckIcon as vc, CircleXIcon as bc, CircleHelpIcon as xc, ArrowUpIcon as yc, ArrowDownIcon as kc, ScrollText as _c, ChevronRight as Nc, ChevronLeft as Cc, ChevronsUpDown as Ec, MenuIcon as Tc, Menu as Sc, EllipsisVertical as Rc, MoreVertical as Dc } from "lucide-react";
import { Section as At, compareScrRefs as ka, getChaptersForBook as Mc, formatScrRef as Ve, formatReplacementString as Xe, getSectionForBook as wa, formatRelativeDate as Oc, sanitizeHtml as Po, NumberFormat as ci, formatBytes as Ic, getCurrentLocale as zc, usfmMarkers as ua, isPlatformError as Pc, ABORTED as Ac, getErrorMessage as $c, getFormatCallerFunction as Vc, deepEqual as Lc, isString as nn, scrRefToBBBCCCVVV as Ga, defaultScrRef as qa, formatScrRefRange as Bc, getLocalizeKeyForScrollGroupId as sn, formatReplacementStringToArray as cn, collectUsjMarkers as jc } from "platform-bible-utils";
import ee, { useRef as L, useMemo as P, createContext as qr, useContext as za, useState as _, useEffect as Z, useCallback as V, useId as _a, useImperativeHandle as Fc, useLayoutEffect as re, Fragment as Wr, Component as Uc, createElement as ln, Suspense as Kc, forwardRef as li, memo as di } from "react";
import { IconSelector as wi, IconCheck as Pa, IconChevronDown as Hc, IconChevronUp as Gc, IconLayoutSidebar as qc, IconLayoutSidebarRight as Wc, IconChevronRight as ui, IconSearch as Yc, IconLoader as Xc, IconAlertOctagon as Jc, IconAlertTriangle as Zc, IconInfoCircle as Qc, IconCircleCheck as tl } from "@tabler/icons-react";
import { createEditor as pi, $getRoot as tr, $createParagraphNode as Yr, $getSelection as ce, HISTORY_MERGE_TAG as Ao, ParagraphNode as hi, TextNode as gi, $getPreviousSelection as el, $isRangeSelection as Se, $caretFromPoint as rl, $getSiblingCaret as fi, $getChildCaret as al, $getAdjacentChildCaret as ol, $isChildCaret as nl, $normalizeCaret as il, $setSelectionFromCaretRange as sl, $getCollapsedCaretRange as cl, $getCaretInDirection as dn, $splitAtPointCaretNext as ll, $isTextPointCaret as dl, $findMatchingParent as mi, $isElementNode as Kr, mergeRegister as Be, getDOMTextNode as wl, isHTMLElement as ul, CLEAR_EDITOR_COMMAND as vi, COMMAND_PRIORITY_EDITOR as $o, shallowMergeConfig as pl, defineExtension as ge, safeCast as pr, createState as hl, FORMAT_TEXT_COMMAND as bi, $isNodeSelection as xi, COMMAND_PRIORITY_LOW as yi, RootNode as gl, LineBreakNode as fl, TabNode as ml, $isEditorState as vl, createCommand as bl, CLICK_COMMAND as xl, isDOMNode as yl, $getNodeFromDOMNode as kl, $createNodeSelection as _l, $setSelection as Nl, $getEditor as Cl, DecoratorNode as po, $getState as El, toggleTextFormatType as wn, TEXT_TYPE_TO_FORMAT as Tl, $setState as Sl, addClassNamesToElement as ki, $create as Rl, $getNodeByKey as Dl, removeClassNamesFromElement as Ml, KEY_TAB_COMMAND as Ol, $isBlockElementNode as Il, $createRangeSelection as zl, $normalizeSelection__EXPERIMENTAL as Pl, OUTDENT_CONTENT_COMMAND as Al, INDENT_CONTENT_COMMAND as un, INSERT_TAB_COMMAND as $l, COMMAND_PRIORITY_CRITICAL as Vo, $isDecoratorNode as Vl, $isParagraphNode as Ll, $isTextNode as ho, SELECTION_CHANGE_COMMAND as _i, $insertNodes as Bl } from "lexical";
...
import { $generateHtmlFromNodes as ql, $generateNodesFromDOM as Wl } from "@lexical/html";
...
import { useReactTable as Ci, getFilteredRowModel as Yl, getSortedRowModel as Ei, getPaginationRowModel as Xl, getCoreRowModel as Ti, flexRender as Lr, getGroupedRowModel as Jl, getExpandedRowModel as Zl } from "@tanstack/react-table";
import Ql from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as go, HIDDEN_NOTE_CALLER as fo, getDefaultViewOptions as td, isInsertEmbedOpOfType as Ir, getMarkerMenuItems as ed, defaultStyleInfo as rd, Editorial as ad } from "@eten-tech-foundation/platform-editor";
...
function wd({
  ...
  Z(() => {
    ...
    const k = (q) => !!q && q.scrollWidth > q.clientWidth, ot = () => {
      Hn() !== "pointer" && (B || k(h.current) || k(d.current)) && C(!0);
    }, I = () => C(!1);
                ...
                /* @__PURE__ */ u(bt, { children: [
                  /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(
                    et,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Zr,
                      children: B === "ltr" ? /* @__PURE__ */ a(Xs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rd = zi ? re : Z, sa = { tag: Ao };
function Dd({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: d } = t, l = Sd(null, o), w = pi({ editable: t.editable, html: d, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Md = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
const $d = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
function Vd(t) {
...
function Wd(t) {
  const e = ce() || el();
  let r;
  if (Se(e)) r = rl(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = fi(c, "next"));
    }
    r = r || al(tr(), "previous").getFlipped().insert(Yr());
  }
  const o = Yd(t, r), n = ol(o), s = nl(n) ? il(n) : o;
  return sl(cl(s)), t.getLatest();
}
function Yd(t, e, r) {
  let o = dn(e, "next");
  for (let n = o; n; n = ll(n, r)) o = n;
  return dl(o) && Na(283), o.insert(t.isInline() ? Yr().append(t) : t), dn(fi(t.getLatest(), "next"), e.direction);
}
function Xd(t) {
  const e = ce();
  if (!Se(e)) return !1;
...
function Bi(t, e = Li) {
  return t.registerCommand(vi, (r) => (t.update(e), !0), $o);
}
...
const Za = hl("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ji extends po {
  $config() {
...
ge({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = ce();
  if (xi(n) || Se(n)) for (const s of n.getNodes()) aw(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Fi(t, e) {
  let r;
...
}, name: "@lexical/extension/InitialState", nodes: [gl, gi, fl, ml, hi] }), En = Symbol.for("@lexical/extension/LexicalBuilder");
function Tn() {
}
function lw(t) {
  throw t;
...
}, dependencies: [ko], name: "@lexical/extension/NodeSelection" }), ww = bl("INSERT_HORIZONTAL_RULE_COMMAND");
class Cr extends po {
  static getType() {
...
ge({ dependencies: [ko, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  ...
  return Be(t.registerCommand(ww, (i) => {
    ...
    return !0;
  }, $o), t.registerCommand(xl, (i) => {
    if (yl(i.target)) {
      const c = kl(i.target);
      if (pw(c)) return function(d, l = !1) {
        const w = ce(), p = d.isSelected(), h = d.getKey();
        let f;
        l && xi(w) ? f = w : (f = _l(), Nl(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
...
function hw(t, e, r = Gi) {
  return Be(t.registerCommand(Ol, (o) => {
    const n = ce();
    if (!Se(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
const Cw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
    ...
    "div",
    {
      ...
      children: [
        ...
        W && /* @__PURE__ */ u(je, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ac, {}) }) }),
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              et,
              {
                ...
                children: Dt ? /* @__PURE__ */ a(oc, {}) : /* @__PURE__ */ a(nc, {})
              }
            ),
            W === void 0 ? (
...
function du({
  ...
  var B;
  const [w, p] = _([]), [h, f] = _([]), [m, x] = _({}), [g, E] = _({}), y = P(() => e ?? [], [e]), C = Ci({
    data: y,
    columns: t,
    getCoreRowModel: Ti(),
...
function $h({
  ...
  const oe = V(
    ...
    (R, K) => {
      ...
      let H;
      R === "custom" ? H = K : R === "generated" ? H = go : H = fo, J.insert.note.caller !== H && (J.insert.note.caller = H, (nt = h.current) == null || nt.applyUpdate([J, { delete: 1 }]));
    },
    []
  ), Dt = V(() => {
    var R;
  ...
  const _e = () => {
    ...
    (R, K, J) => {
      ...
      Is({
        ...
        onShowError: (j) => {
          (!Pc(j) || j.code !== Ac) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${$c(j)}`
          );
        }
      });
    },
...
function Wh({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    et,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(qc, {}) : /* @__PURE__ */ a(Wc, {}),
                    ...
                    children: Y.getIsGrouped() ? /* @__PURE__ */ u(
                      et,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Nc, {}) : /* @__PURE__ */ a(Cc, {})),
                          " ",
...
function dg({
  ...
  const B = Ut(
    ...
    [r, n, g, s]
  ), Jt = mt.find((F) => F.value === t), ze = () => t === "selectedBooks" && n.length > 0 ? n.map((F) => F.toUpperCase()).join(", ") : t === "range" ? Bc(jt, Pt, {
  ...
  ), Ot = mt.find((F) => F.value === "selectedBooks"), Gt = mt.find((F) => F.value === "range"), [It, R] = _(!1), [K, J] = _(void 0), [H, Q] = _(void 0), [j, nt] = _(void 0), [st, it] = _(void 0), [vt, Ct] = _([]), Tt = p === "dropdown" && K === "selectedBooks", qt = /* @__PURE__ */ a(
    lp,
    {
      availableBookInfo: o,
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(bt, { children: [
  /* @__PURE__ */ a(xt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Ks, { children: /* @__PURE__ */ a(Hs, { children: ps(
      t,
      e,
      ds(t, c.id),
      o
...
function No({
  ...
  Kn();
  const h = L(null), f = () => Bs(h.current ?? void 0);
  return /* @__PURE__ */ u(je, { variant: i, children: [
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        style: { zIndex: Ue },
        onCloseAutoFocus: () => {
          Hn() === "pointer" && Gs(h.current ?? void 0);
        },
...
const gp = Object.freeze([520, 420, 340]), gs = ee.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, gp), l = Mi() ?? d, w = l >= Br.MINIMUM;
