...
var Kt = (t, e, r) => ji(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Se, a as Ha, C as Ne, A as se, P as $e, b as We, B as H, d as Ae, e as Ie, f as Pe, h as ke, i as Fi, k as Bi, j as Ui, E as Ki, l as qa, r as ce, m as Gi, n as un, o as aa, p as oa, L as Ct, R as Ya, q as Yr, D as za, s as Sa, t as Ra, u as Da, T as pn, v as jr, w as It, x as Wa, y as Pt, z as Vt, F as Lt, G as hn, H as Xa, I as He, J as _r, K as Ve, M as Le, N as je, S as Nr, O as ar, Q as Hi, U as Tr, V as Ye, W as De, Z as Xe, X as Re, Y as or, _ as Ja, $ as Za, a0 as Wr, a1 as Qa, a2 as gn, a3 as qi, a4 as Yi, a5 as Wi, a6 as Ma, a7 as fn, a8 as na, a9 as mn, aa as Xi, ab as Ji, ac as Zi, ad as Qi, ae as vn, af as bn, ag as to, ah as ts, ai as xn, aj as ua, ak as _o, al as pa, am as es, an as rs, ao as as, ap as os, aq as ns, ar as zr, as as eo, at as is, au as ss, av as cs } from "./resizable-DxYWGvfC.js";
import { aw as gg, ax as fg, ay as mg, az as vg, aA as bg, aB as xg, aC as yg, aD as kg, aE as _g, aF as Ng, aG as Cg, aH as Eg, aI as Tg, aJ as zg, aK as Sg, aL as Rg, aM as Dg, aN as Mg, aO as Og, aP as $g, aQ as Ag, aR as Ig, aS as Pg, aT as Vg, aU as Lg } from "./resizable-DxYWGvfC.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as Mt } from "@sillsdev/scripture";
import { Check as Me, Clock as No, ChevronsLeft as Co, ChevronsRight as Eo, ChevronLeft as Oa, ChevronRight as $a, ArrowLeft as ls, ArrowRight as ds, ChevronDown as sr, BoldIcon as ws, ItalicIcon as us, X as ro, AtSign as yn, Pencil as ps, Trash2 as hs, ArrowUp as kn, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as _n, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, Undo as zs, Redo as Ss, SquareX as Nn, FunctionSquare as Cn, SquareSigma as En, Ban as Rs, AlertCircle as Aa, CircleCheckIcon as Ds, CircleXIcon as Ms, CircleHelpIcon as Os, ArrowUpIcon as $s, ArrowDownIcon as As, ScrollText as Is, ChevronsUpDown as Ps, MenuIcon as Vs, Menu as Ls, EllipsisVertical as js, MoreVertical as Fs } from "lucide-react";
import { Section as ht, getChaptersForBook as Bs, formatScrRef as xe, getSectionForBook as Fr, formatRelativeDate as Us, formatReplacementString as qe, sanitizeHtml as ao, NumberFormat as Tn, formatBytes as Ks, getCurrentLocale as Gs, usfmMarkers as Br, getFormatCallerFunction as Hs, deepEqual as qs, isString as To, compareScrRefs as Ia, scrRefToBBBCCCVVV as ha, defaultScrRef as ga, formatScrRefRange as Ys, getLocalizeKeyForScrollGroupId as zo, formatReplacementStringToArray as So, collectUsjMarkers as Ws } from "platform-bible-utils";
import Jt, { useRef as B, useMemo as I, useState as _, useCallback as F, useEffect as G, useImperativeHandle as Xs, useLayoutEffect as Ht, createContext as oo, useContext as zn, Component as Js, createElement as Ro, Suspense as Zs, forwardRef as Sn, useId as Xr, Fragment as ia } from "react";
...
import { createEditor as Mn, $getRoot as Oe, $createParagraphNode as Sr, $getSelection as Zt, HISTORY_MERGE_TAG as no, ParagraphNode as On, TextNode as $n, $getPreviousSelection as lc, $isRangeSelection as ue, $caretFromPoint as dc, $getSiblingCaret as An, $getChildCaret as wc, $getAdjacentChildCaret as uc, $isChildCaret as pc, $normalizeCaret as hc, $setSelectionFromCaretRange as gc, $getCollapsedCaretRange as fc, $getCaretInDirection as Do, $splitAtPointCaretNext as mc, $isTextPointCaret as vc, $findMatchingParent as In, $isElementNode as Cr, mergeRegister as _e, getDOMTextNode as bc, isHTMLElement as xc, CLEAR_EDITOR_COMMAND as Pn, COMMAND_PRIORITY_EDITOR as io, shallowMergeConfig as yc, defineExtension as ne, safeCast as Je, createState as kc, FORMAT_TEXT_COMMAND as Vn, $isNodeSelection as Ln, COMMAND_PRIORITY_LOW as jn, RootNode as _c, LineBreakNode as Nc, TabNode as Cc, $isEditorState as Ec, createCommand as Tc, CLICK_COMMAND as zc, isDOMNode as Sc, $getNodeFromDOMNode as Rc, $createNodeSelection as Dc, $setSelection as Mc, $getEditor as Oc, DecoratorNode as Pa, $getState as $c, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as Ac, $setState as Ic, addClassNamesToElement as Fn, $create as Pc, $getNodeByKey as Vc, removeClassNamesFromElement as Lc, KEY_TAB_COMMAND as jc, $isBlockElementNode as Fc, $createRangeSelection as Bc, $normalizeSelection__EXPERIMENTAL as Uc, OUTDENT_CONTENT_COMMAND as Kc, INDENT_CONTENT_COMMAND as Oo, INSERT_TAB_COMMAND as Gc, COMMAND_PRIORITY_CRITICAL as so, $isDecoratorNode as Hc, $isParagraphNode as qc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as Bn, $insertNodes as Yc } from "lexical";
...
import { Avatar as co, Select as qt, Checkbox as $o, Slot as Rr, Tabs as le, Menubar as he, ContextMenu as Ot, Progress as Ao, Slider as $r, Switch as Io } from "radix-ui";
import { useReactTable as Kn, getFilteredRowModel as al, getSortedRowModel as Gn, getPaginationRowModel as ol, getCoreRowModel as Hn, flexRender as yr, getGroupedRowModel as nl, getExpandedRowModel as il } from "@tanstack/react-table";
...
function pl({
  ...
  return /* @__PURE__ */ u($e, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(ke, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      Ne,
      {
        onSelect: () => S(y),
...
function Wn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ke, { children: /* @__PURE__ */ a("div", { className: v("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function ma({
  ...
  const U = ce(), [C, V] = _(!1), [P, k] = _(""), [A, K] = _(""), [T, et] = _("books"), [R, J] = _(void 0), [E, z] = _(
    void 0
  ), [q, nt] = _(void 0), [bt, ut] = _(!1), Et = B(null), M = B(!1), W = B(void 0), Z = B(void 0), Q = B(void 0), rt = B(void 0), wt = B({}), gt = B({}), yt = F(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Yt = I(() => o ? o() : Gi, [o]), St = I(() => ({
    [ht.OT]: Yt.filter((Y) => Mt.isBookOT(Y)),
    [ht.NT]: Yt.filter((Y) => Mt.isBookNT(Y)),
    [ht.DC]: Yt.filter((Y) => Mt.isBookDC(Y)),
    [ht.Extra]: Yt.filter((Y) => Mt.extraBooks().includes(Y))
  }), [Yt]), Qt = I(() => Object.values(St).flat(), [St]), fe = I(() => {
    if (!A.trim()) return St;
    const x = {
      [ht.OT]: [],
      [ht.NT]: [],
    ...
    return [ht.OT, ht.NT, ht.DC, ht.Extra].forEach((at) => {
      x[at] = St[at].filter((Ut) => qa(Ut, A, n));
    }), x;
  }, [St, A, n]), O = I(
    () => vl(A, Qt, n),
    [A, Qt, n]
  ...
  const Tt = F(() => {
    if (O) {
      const x = O.chapterNum ?? 1, Y = O.verseNum ?? 1;
      if (w && fa(O.book, x, Y, w))
        return;
      yt({
        book: O.book,
        chapterNum: x,
    ...
    (x) => {
      const Y = E ?? (O == null ? void 0 : O.book), at = q ?? (O == null ? void 0 : O.chapterNum);
      !Y || !at || (yt({
        book: Y,
        chapterNum: at,
        verseNum: x
    ...
    (x) => {
      const Y = T === "chapters" ? R : O == null ? void 0 : O.book;
      if (Y) {
        if (d && d(Y, x) > 1) {
          z(Y), nt(x), et("verses"), k("");
          return;
        }
        yt({
          book: Y,
    ...
    et("books"), J(void 0), z(void 0), nt(void 0), setTimeout(() => {
      Z.current && Z.current.focus();
    }, 0);
  }, []), ot = F(() => {
    const x = E;
    z(void 0), nt(void 0), x ? (J(x), et("chapters"), k("")) : it();
  }, [E, it]), st = F((x) => {
    V(x), x && (et("books"), J(void 0), z(void 0), nt(void 0), K(""));
  }, []);
  G(() => {
    $ && st(!1);
  }, [$, st]);
  ...
  const { otLong: ft, ntLong: vt, dcLong: Rt, extraLong: Ft } = {
    ...
    () => fl(A),
    [A]
  ), te = I(() => !d || !O || !O.chapterNum || !zt ? !1 : d(O.book, O.chapterNum) > 0, [d, O, zt]), Ze = F(
    (x) => w ? Po(x, w) : !1,
    [w]
  ), Qe = F(
    (x) => (Y) => w ? ml(x, Y, w) : !1,
    ...
    (x, Y) => (at) => w ? fa(x, Y, at, w) : !1,
    [w]
  ), gr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", fr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Dr = F(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && O && O.chapterNum !== void 0 && O.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), Tt());
    },
    [p, O, Tt]
  ), Mr = F(
    (x) => {
      var be, Be, Ce;
      if (x.ctrlKey) return;
      const { isLetter: Y, isDigit: at } = Vo(x.key);
      if ((T === "chapters" || T === "verses") && (x.key === " " || x.key === "Enter")) {
        const $t = x.target instanceof HTMLElement ? x.target : void 0;
        if (!!($t != null && $t.closest(
        ...
        const At = (be = W.current) == null ? void 0 : be.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (At) {
          x.preventDefault(), x.stopPropagation(), At.click();
          return;
        }
      }
      if ((T === "chapters" || T === "verses") && (Y || at)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (T === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), it();
        return;
      }
      if (T === "verses" && x.key === "Backspace") {
      ...
      if (T === "verses" && Ut) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            mt !== 0 && (ae = mt > 1 ? mt - 1 : At);
            break;
          case "ArrowRight":
            mt !== 0 && (ae = mt < At ? mt + 1 : 1);
            break;
          case "ArrowUp":
            ae = mt === 0 ? At : Math.max(1, mt - ee);
            break;
          case "ArrowDown":
            ae = mt === 0 ? 1 : Math.min(At, mt + ee);
            break;
          default:
            return;
        }
        ae !== mt && (x.preventDefault(), x.stopPropagation(), k(
          `${$t} ${se[$t] || ""} ${xt}:${ae}`
        ), setTimeout(() => {
          const Ue = gt.current[ae];
          Ue && Ue.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((T === "chapters" || T === "books" && O) && Ut) {
        const $t = T === "chapters" ? R : O == null ? void 0 : O.book;
        if (!$t) return;
        T === "chapters" && ((Ce = W.current) == null || Ce.focus());
        const xt = (() => {
          if (!P) return 1;
          const ee = P.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            xt !== 0 && (mt = xt > 1 ? xt - 1 : At);
            break;
          case "ArrowRight":
            xt !== 0 && (mt = xt < At ? xt + 1 : 1);
            break;
          case "ArrowUp":
            mt = xt === 0 ? At : Math.max(1, xt - ae);
            break;
          case "ArrowDown":
            mt = xt === 0 ? 1 : Math.min(At, xt + ae);
            break;
          default:
            return;
        }
        mt !== xt && (x.preventDefault(), x.stopPropagation(), k(
          `${$t} ${se[$t] || ""} ${mt}`
        ), setTimeout(() => {
          const ee = wt.current[mt];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Ut = Z.current) == null || Ut.focus();
      return;
    }
    const { isLetter: Y, isDigit: at } = Vo(x.key);
    (Y || at) && (x.preventDefault(), K((be) => be + x.key), Z.current.focus(), ut(!1));
  }, []);
  return Ht(() => {
    const x = setTimeout(() => {
      if (C && T === "books" && Q.current && rt.current) {
        const Y = Q.current, at = rt.current, Ut = at.offsetTop, be = Y.clientHeight, Be = at.clientHeight, Ce = Ut - be / 2 + Be / 2;
        Y.scrollTo({
          top: Math.max(0, Ce),
          behavior: "smooth"
        }), k(Yn(t.book));
    ...
    if (T === "chapters" && R) {
      const x = R === t.book, Y = x ? t.chapterNum : 1;
      k(
        `${R} ${se[R] || ""} ${Y}`
      ), setTimeout(() => {
        if (Q.current)
          if (x) {
            const at = wt.current[t.chapterNum];
  ...
  }, [T, R, O, t.book, t.chapterNum]), Ht(() => {
    if (T === "verses" && E && q !== void 0) {
      const x = E === t.book && q === t.chapterNum, Y = x ? t.verseNum : 1;
      k(
        `${E} ${se[E] || ""} ${q}:${Y}`
      ), setTimeout(() => {
        if (Q.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u($e, { open: C, onOpenChange: st, modal: S, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      H,
      {
        ...
        onClick: (x) => {
          M.current && (M.current = !1, x.preventDefault());
        },
        children: [
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: Y } = x;
          C && Et.current && Y instanceof Node && Et.current.contains(Y) && (M.current = !0, st(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Ie,
            ...
            children: [
              T === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: tt.map(
                  ({ onClick: x, disabled: Y, title: at, icon: Ut }) => /* @__PURE__ */ a(
                    H,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  H,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: T === "verses" ? ot : it,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: U === "ltr" ? /* @__PURE__ */ a(ls, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ds, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                T === "chapters" && R && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Se(R, n) }),
                T === "verses" && E && q !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(E, n)} ${q}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: T === "verses" ? fr : gr
                  }
                )
              ] }),
              !bt && /* @__PURE__ */ u(Pe, { ref: Q, children: [
                T === "books" && /* @__PURE__ */ u(dt, { children: [
                  !O && Object.entries(fe).map(([x, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ke, { heading: Bt(x), children: Y.map((at) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: at,
                            onSelect: (Ut) => me(Ut),
                            section: Fr(at),
                            commandValue: `${at} ${se[at]}`,
                            ref: at === t.book ? rt : void 0,
                            localizedBookNames: n,
                            disabled: Ze(at)
                          },
                          at
                  ...
                  O && /* @__PURE__ */ a(ke, { children: /* @__PURE__ */ a(
                    Ne,
                    {
                      ...
                      children: xe(
                        ...
                        n ? Ha(O.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  O && te && O.chapterNum && d && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Se(O.book, n)} ${O.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        onVerseSelect: jt,
                        setVerseRef: Nt,
                        isVerseDisabled: hr(O.book, O.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  O && !te && nr(O.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Se(O.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        setChapterRef: D,
                        isChapterDimmed: Wt,
                        isChapterDisabled: Qe(O.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                T === "chapters" && R && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: R,
                    scrRef: t,
                    onChapterSelect: re,
                    setChapterRef: D,
                    isChapterDisabled: Qe(R),
                    className: "tw:p-4"
                  }
                ),
                T === "verses" && E && q !== void 0 && d && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: E,
                    chapterNum: q,
...
function Fo({
  ...
  const [N, $] = _(!1), U = d ?? l, C = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], V = (P, k) => {
    const A = l(P), K = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, T = `${k ?? ""}${A}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ne,
      {
        value: A,
  ...
  return /* @__PURE__ */ u($e, { open: N, onOpenChange: $, ...y, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      H,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: C(e) ? e.map((P) => /* @__PURE__ */ a(ke, { heading: P.groupHeading, children: P.options.map((k) => V(k, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(ke, { children: e.map((P) => V(P)) }) })
        ] })
      }
    )
  ] });
...
var Fa = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(Fa || {});
((t) => {
    ...
    Ya,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Ct, { className: "tw:flex tw:items-center", children: o.map((m) => Mt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            H,
            {
...
const Jn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, kl = Jn ? Ht : G, Pr = { tag: no };
function _l({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = yl(null, o), w = Mn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : G;
function Cl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Nl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(no) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const lo = {
...
const Rl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : G;
function Dl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ml() {
  return function(t) {
    const [e] = ge(), r = I(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = B(o);
    return Rl(() => {
...
function Il(t, e, r) {
  ...
  function l() {
    ...
    for (let S = 0; S < g.length; S++) {
      const y = g[S], N = s[S] || document.createElement("div"), $ = N.style;
      ...
      const P = we(y.height);
      $.height !== P && (N.style.height = P, m = !0), N.parentNode !== c && (c.append(N), m = !0), s[S] = N;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(P) {
        const k = P.getStartEndPoints();
        return P.isBackward() ? [k[1], k[0]] : k;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, S = g.getNode(), y = S.getKey(), N = g.offset, $ = t.getElementByKey(b), U = t.getElementByKey(y), C = r === null || $ !== o || m !== n || b !== r.getKey(), V = i === null || U !== s || N !== c || y !== i.getKey();
      if ((C || V) && $ !== null && U !== null) {
        const P = function(k, A, K, T, et, R, J) {
          const E = (k._window ? k._window.document : document).createRange();
          return E.setStart(...Bo(A, K, T)), E.setEnd(...Bo(et, R, J)), E;
        }(t, h, f, $, g, S, U);
        l(), l = Il(t, P, e);
      }
      r = f, o = $, n = m, i = S, s = U, c = N;
    });
  }
...
function jl(t) {
  const e = In(t, (r) => Cr(r) && !r.isInline());
  return Cr(e) || Jr(4, t.__key), e;
}
function Fl(t) {
  const e = Zt() || lc();
  let r;
  if (ue(e)) r = dc(e.focus, "next");
    ...
    r = r || wc(Oe(), "previous").getFlipped().insert(Sr());
  }
  const o = Bl(t, r), n = uc(o), i = pc(n) ? hc(n) : o;
  return gc(fc(i)), t.getLatest();
}
function Bl(t, e, r) {
  let o = Do(e, "next");
  for (let n = o; n; n = mc(n, r)) o = n;
  return vc(o) && Jr(283), o.insert(t.isInline() ? Sr().append(t) : t), Do(An(t.getLatest(), "next"), e.direction);
}
function Ul(t) {
  const e = Zt();
  if (!ue(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = In(i, (d) => Cr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Zr, ye = 0, Qr = 0, Hl = 0, Ba = 0, Kr = 0;
function Ko(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function Ke(t, e) {
  Gt.call(this, void 0), this.x = t, this.s = void 0, this.g = Kr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ql(t, e) {
  return new Ke(t, e);
}
...
function Yl(t) {
  ...
  ti(this), ct = t, this.f &= -2, 8 & this.f && uo(this), la();
}
function rr(t, e) {
...
Gt.prototype.brand = Kl, Gt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ye !== 0 && Qr === 0 && e.l !== Ba && (e.l = Ba, Zr = { S: e, v: e.v, i: e.i, o: Zr });
  ...
  return ct = t, ti(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ei(this), Go(this), ye++;
  const t = ct;
...
ne({ build: (t, e, r) => pr(e), config: Je({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ri() {
  const t = Oe(), e = Zt(), r = Sr();
  t.clear(), t.append(r), e !== null && r.select(), ue(e) && (e.format = 0);
}
function ai(t, e = ri) {
  return t.registerCommand(Pn, (r) => (t.update(e), !0), io);
}
ne({ build: (t, e, r) => pr(e), config: Je({ $onClear: ri }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const xa = kc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class oi extends Pa {
  $config() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [oi], register: (t, e, r) => t.registerCommand(Vn, (o) => {
  const n = Zt();
...
const Ua = ne({ build: (t) => ni(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const po = 0, Ka = 1, si = 2, ya = 3, Vr = 4, er = 5, ka = 6, vr = 7;
function _a(t) {
  return t.id === po;
}
function ci(t) {
...
function Jl(t) {
  return function(e) {
    return e.id === Ka;
  }(t) || pt(305, String(t.id), String(Ka)), Object.assign(t, { id: si });
}
...
class Ql {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && pt(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ka && pt(310, String(r.id), String(ka)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Vr;
    }(e) || pt(313, String(e.id), String(Vr)), e.initResult;
  }
  getInitPeer(e) {
...
const ed = ne({ config: Je({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = td }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [_c, $n, Nc, Cc, On] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Yo() {
}
function rd(t) {
  throw t;
...
class ir {
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== Na && pt(292, r.PACKAGE_VERSION, Na), r instanceof ir || pt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      _a(i) || pt(300, s, n || "[unknown]"), _a(c = i) || pt(304, String(c.id), String(po)), i = Object.assign(c, { id: Ka }), o.state = i;
...
const ad = /* @__PURE__ */ new Set(), Wo = ne({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ni(() => {
  }, () => pe(() => {
  ...
  return { watchNodeKey: function(s) {
    const c = ql(() => (i.value || ad).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
...
ne({ dependencies: [Ua, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [cr], register(t, e, r) {
  ...
  return _e(t.registerCommand(od, (s) => {
    const c = Zt();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, io), t.registerCommand(zc, (s) => {
    if (Sc(s.target)) {
      const c = Rc(s.target);
      if (id(c)) return function(l, d = !1) {
        const w = Zt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Ln(w) ? g = w : (g = Dc(), Mc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(pe(() => {
      const d = c.value;
      d && (l.value ? Fn(d, i) : Lc(d, i));
    }));
    return _e(...s);
  }));
} });
ne({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Je({ $getParentEditor: function() {
  const t = Oc();
...
ne({ build: (t, e, r) => pr(e), config: Je({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return pe(() => {
...
function sd(t, e, r = li) {
  return _e(t.registerCommand(jc, (o) => {
    const n = Zt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Kc : Oo : Gc;
    return t.dispatchCommand(i, void 0);
  }, io), t.registerCommand(Oo, () => {
...
ne({ build: (t, e, r) => pr(e), config: Je({ $canIndent: li, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return pe(() => {
    if (!o.value) return sd(t, n, i);
  });
} });
const cd = ne({ name: "@lexical/react/ReactProvider" });
function ld() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                const b = f.anchor;
                let m = b.getNode(), S = 0, y = 0;
                if (Va(m) && d >= 0 && w >= 0 && (S = d, y = d + w, f.setTextNodeRange(m, S, m, y)), S === y && p === "" || (f.insertRawText(p), m = b.getNode()), Va(m)) {
                  S = h, y = h + g;
                  const N = m.getTextContentSize();
                  S = S > N ? N : S, y = y > N ? N : y, f.setTextNodeRange(m, S, m, y);
                }
...
ne({ build: (t, e, r) => pr(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : wi(t)) });
function ud(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : G;
...
function gd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    go(() => _e(Jc(n), wi(n)), [n]);
  }(o), u(dt, { children: [t, a(fd, { content: e }), a(hd, { editor: o, ErrorBoundary: r })] });
}
...
function _d(t, e) {
  ...
  return u(dt, { children: [a(yd, { editor: n, ...o, ref: e }), r != null && a(Nd, { editor: n, content: r })] });
}
...
function Rd() {
  const { activeEditor: t } = hi(), [e, r] = _([]), o = F((n) => {
    if (ue(n) || tl(n)) {
      const i = [];
      Zo.forEach(({ format: s }) => {
...
function vi({
  ...
  return /* @__PURE__ */ u(Wa, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a(
        H,
        {
          "aria-label": s,
          className: n,
...
const Ad = "verseText", sp = Object.freeze([
...
function cp({
  ...
  const [i, s] = _(Id), [c, l] = _(n), [d, w] = _(!1), p = B(void 0), h = B(null);
  G(() => {
    let m = !0;
    const S = h.current;
    if (!S) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u($e, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ae,
        {
          ...
          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: t.map((m) => /* @__PURE__ */ a(
            Ne,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: Ca(m, o) })
            },
            m || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : mo(m) && (m.preventDefault(), m.stopPropagation(), oe(i) && g());
        },
        onKeyDown: (m) => {
          fo(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ta,
          {
...
function tn({
  ...
  const g = F(
    ...
    [t.user]
  ), y = I(() => ao(t.contents), [t.contents]), N = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), $ = !!t.conflictResolutionAction && !N, U = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          He,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(jd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Fd, { className: "tw:text-xs tw:font-medium", children: S }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : mo(C) && (C.preventDefault(), C.stopPropagation(), oe(w) && f());
              },
              onKeyDown: (C) => {
        ...
        U && /* @__PURE__ */ u(Ve, { children: [
          /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
  ...
  if (t)
    return /* @__PURE__ */ a(
      H,
      {
        ...
        "aria-label": o,
        children: /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" })
      }
    );
}
const en = {
...
function _i({
  ...
  const [T, et] = _(en), [R, J] = _(), [E, z] = _(), q = o, [nt, bt] = _(!1), [ut, Et] = _(!1), [M, W] = _(!1), [Z, Q] = _(!1), [rt, wt] = _(!1), [gt, yt] = _($), [Yt, St] = _(!1), Qt = B(void 0), [fe, O] = _(/* @__PURE__ */ new Map());
  G(() => {
    let D = !0;
    return (async () => {
    ...
    let D = !0;
    if (!o) {
      Q(!1), O(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const zt = S ? await S(l) : !1;
      D && Q(zt);
    })(), () => {
      D = !1;
    };
  ...
  G(() => {
    if (!o) {
      kt.current !== "idle" && (J(void 0), z(void 0), kt.current = "idle");
      return;
    }
    kt.current === "idle" && (kt.current = "pending"), Z ? kt.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (J(V), kt.current = "auto-populated") : kt.current === "auto-populated" && (J(void 0), kt.current = "pending");
  }, [o, V, Z, i]);
  const Tt = I(
    () => P ?? e.filter((D) => !D.deleted),
    [P, e]
  );
  G(() => {
    let D = !0;
  ...
  const jt = I(() => Tt[0], [Tt]), me = B(null), re = B(void 0), j = F(() => {
    var D;
    (D = re.current) == null || D.call(re), et(en);
  }, []), tt = F(() => {
    const D = !gt;
    yt(D), St(!D), f == null || f(l, D);
  }, [gt, f, l]);
  G(() => {
    bt(!1);
  }, [o]), G(() => {
    if (o && !gt && !Yt) {
      ...
      return Qt.current = D, () => clearTimeout(D);
    }
  ...
  }, [i, r]), st = I(() => Tt.slice(1), [Tt]), lt = I(() => st.length ?? 0, [st.length]), _t = I(() => lt > 0, [lt]), ft = I(() => nt || lt <= 2 ? st : st.slice(-2), [st, lt, nt]), vt = I(() => nt || lt <= 2 ? 0 : lt - 2, [lt, nt]), Rt = I(
    () => lt === 1 ? it.singleReply : qe(it.multipleReplies, { count: lt }),
    [lt, it]
  ), Ft = I(
    () => vt === 1 ? it.singleReply : qe(it.multipleReplies, { count: vt }),
    [vt, it]
  );
  G(() => {
    !o && ut && _t && Et(!1);
  ...
  const Bt = F(
    async (D) => {
      ...
      Nt && await p({ threadId: l, contents: Nt }) && j();
    },
    [
      j,
      T,
    ...
    async (D) => {
      const Nt = oe(T) ? ea(T) : void 0, zt = D.status ? D.assignedUser : R ?? D.assignedUser, te = await p({
        ...D,
        contents: Nt,
        assignedUser: zt
      });
      return te && (zt !== void 0 && z(zt), Nt && j()), te;
    },
    [j, T, p, R]
  );
  ...
  const ve = /* @__PURE__ */ a(
    tn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: Wt,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: Et,
      canEditOrDelete: (!ut && fe.get(jt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Ld, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ot && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: ot }),
            /* @__PURE__ */ a(
              H,
              {
                variant: "ghost",
            ...
            A === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: rt && w !== "Resolved",
                  onClick: () => Wt({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(dt, { children: [
          _t && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            K && ft.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            vt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    nt ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(sr, {})
                  ] })
                ]
              }
            ),
            ft.map((D) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              tn,
              {
                comment: D,
                localizedStrings: r,
            ...
            m !== !1 && (!ut || oe(T)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (D) => {
                  mo(D) && (D.preventDefault(), D.stopPropagation(), (oe(T) || R !== void 0 && R !== E) && Bt());
                },
                onKeyDown: (D) => {
                  fo(D), (D.key === "Enter" || D.key === " ") && D.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ta,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    R !== void 0 && (oe(T) || R !== E) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: qe(
                    ...
                    /* @__PURE__ */ u($e, { open: M, onOpenChange: W, children: [
                      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
                        H,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !Z || !b || b.length === 0 || !b.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          align: "end",
                          onKeyDown: (D) => {
                            D.key === "Escape" && (D.stopPropagation(), W(!1));
                          },
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: b == null ? void 0 : b.map((D) => /* @__PURE__ */ a(
                            Ne,
                            {
                              onSelect: () => {
                                J(D !== i ? D : void 0), kt.current = "user-selected", z(void 0), W(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), Ud = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Hr = (t) => Ud(ao(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Kd({
  ...
  const [s, c] = _("accept"), l = Xr(), d = Xr(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = I(
    () => Hr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = I(
    () => Hr(t.acceptedText ?? ""),
    ...
    () => Hr(t.mergedText ?? ""),
    [t.mergedText]
  ), y = I(() => ao(t.contents), [t.contents]);
  if (!xi(t))
    return /* @__PURE__ */ a(qr, { html: y });
  const N = (E) => {
    c(E === "reject" || E === "merge" ? E : "accept");
  }, $ = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", U = g ? [
    {
      value: "merge",
  ...
  let k;
  V ? k = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (k = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const A = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: A }), T = (E) => E ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: E }) : K, et = () => {
    const E = o ?? "accept";
    return E === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: S }) : K : T(E === "reject" ? t.rejectedResultText : t.resultText);
  }, R = (E) => p && E.value === "reject", J = (E) => {
    const z = f === E.value, q = `${d}-${E.value}`, nt = R(E);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          Ya,
          {
            ...
            children: C.map((E) => R(E) ? /* @__PURE__ */ a(It, { delayDuration: 0, children: /* @__PURE__ */ u(Pt, { children: [
              /* @__PURE__ */ a(Vt, { asChild: !0, children: J(E) }),
              /* @__PURE__ */ a(Lt, { children: $ })
            ] }) }, E.value) : J(E))
          }
        ),
        /* @__PURE__ */ a(It, { delayDuration: 0, children: /* @__PURE__ */ u(Pt, { children: [
          /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex tw:self-start", children: /* @__PURE__ */ a(
            H,
            {
              size: "sm",
              disabled: P,
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return yi(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function mp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [$, U] = _(), [C, V] = _(), P = F(
    async (z) => {
      const q = await i(z);
      return q !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && V(z.assignedUser), q;
    },
    [i]
  );
  G(() => {
    f && (N((z) => new Set(z).add(f)), U(f));
  }, [f]);
  const k = r.filter(
    (z) => z.comments.some((q) => !q.deleted)
  ), A = k.map((z) => ({ id: z.id })), K = F(
    (z) => {
      N((q) => new Set(q).add(z.id)), U(z.id), b == null || b(z.id);
    },
    [b]
  ), T = F(
    (z) => {
      ...
      }), U(z), b == null || b(q ? void 0 : z);
    },
    [y, b]
  ), { listboxRef: et, activeId: R, handleKeyDown: J } = Hi({
    options: A,
    onOptionSelect: K
  }), E = F(
    (z) => {
      z.key === "Escape" ? ($ && y.has($) && (N((q) => {
        const nt = new Set(q);
        return nt.delete($), nt;
      }), U(void 0), b == null || b(void 0)), z.preventDefault(), z.stopPropagation()) : J(z);
    },
    [$, y, J, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: k.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(Wd, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(_i, { ...q })
          },
          z.id
        );
      })
...
function Xd({ table: t }) {
  return /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function wr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    qt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(qt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Rn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ie({
  ...
  return /* @__PURE__ */ u(
    qt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(qt.ItemIndicator, { children: /* @__PURE__ */ a(sa, { className: "tw:pointer-events-none" }) }) }),
...
function ew({
  ...
  var C;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [m, S] = _({}), y = I(() => e ?? [], [e]), N = Kn({
    data: y,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  let U;
  return l ? U = Array.from({ length: 10 }).map((k, A) => `skeleton-row-${A}`).map((k) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(or, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, k)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? U = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Re,
    {
      onClick: () => s(V, N),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((P) => /* @__PURE__ */ a(or, { children: yr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    V.id
  )) : U = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(or, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Xd, { table: N }),
    /* @__PURE__ */ u(Ja, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Za, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(Re, { children: V.headers.map((P) => /* @__PURE__ */ a(Wr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : yr(P.column.columnDef.header, P.getContext()) }, P.id)) }, V.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(H, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(_n, {}) })
        ] }),
...
function _p({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(je, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: d.itemType === 0 ? /* @__PURE__ */ a(dt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][h],
...
function Cp({
  ...
  const s = I(() => Ks(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(Gs(), { type: "language" });
      ...
      return /* @__PURE__ */ u(_r, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          H,
          {
            ...
            children: /* @__PURE__ */ a(ro, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function sw({
  ...
  const l = Xa(), d = an(n, "%undoButton_tooltip%"), w = an(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Wa, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a(
        H,
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(dt, { children: [
          " ",
          /* @__PURE__ */ a(Ma, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      ...
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(dt, { children: [
          " ",
          /* @__PURE__ */ a(Ma, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function dw({
  ...
  const f = (m) => {
    ...
    var S, y, N, $;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((S = i.current) == null || S.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && (($ = s.current) == null || $.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Ve, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
      /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: uw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(je, { style: { zIndex: fn }, children: [
...
function fw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: t !== "none" && /* @__PURE__ */ a(Me, { size: 16 })
    }
  );
}
function on({
...
function Tp({
  ...
  Ht(() => {
    if (!g.current) return;
    const { width: j } = g.current.getBoundingClientRect();
    j > 0 && (g.current.style.width = `${j}px`);
  }, []);
  const [f, b] = _("generated"), [m, S] = _("generated"), [y, N] = _("*"), [$, U] = _("*"), [C, V] = _("f"), [P, k] = _(!1), [A, K] = _(!0), [T, et] = _(!1), R = B(!1), J = B(""), [E, z] = _(!1), [q, nt] = _(), [bt, ut] = _(), [Et, M] = _(), [W, Z] = _(), Q = B(null), rt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  G(() => {
    ...
    if (tt && Ar("note", tt)) {
      const st = (it = tt.insert.note) == null ? void 0 : it.caller;
      let lt = "custom";
      st === La ? lt = "generated" : st === ja ? lt = "hidden" : st && (N(st), U(st)), b(lt), S(lt), V(((ot = tt.insert.note) == null ? void 0 : ot.style) ?? "f"), j = setTimeout(() => {
        var _t;
        (_t = w.current) == null || _t.applyUpdate([tt]);
      }, 0);
    }
    return () => {
      j && clearTimeout(j);
  ...
  const gt = F(
    (j, tt, it = !1) => {
      var st, lt, _t;
      const ot = (lt = (st = w.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : lt.at(0);
      if (ot && Ar("note", ot)) {
        if (ot.insert.note) {
          let ft;
          j === "custom" ? ft = tt : j === "generated" ? ft = La : ft = ja, ot.insert.note.caller = ft;
        }
        r == null || r([ot]), it && d && i && ((_t = d.current) == null || _t.replaceEmbedUpdate(i, [ot]));
      }
    },
    [i, r, d]
  ), yt = F(() => {
  ...
  const St = B({ book: n.book, chapterNum: n.chapterNum });
  Ht(() => {
    (St.current.book !== n.book || St.current.chapterNum !== n.chapterNum) && (St.current = { book: n.book, chapterNum: n.chapterNum }, Yt.current());
  }, [n.book, n.chapterNum]);
  const Qt = () => {
    var tt;
    const j = (tt = p.current) == null ? void 0 : tt.getElementsByClassName("editor-input")[0];
    ...
    var it, ot, st, lt, _t;
    V(j);
    const tt = (ot = (it = w.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : ot.at(0);
    if (tt && Ar("note", tt)) {
      tt.insert.note && (tt.insert.note.style = j);
      const ft = (lt = (st = tt.insert.note) == null ? void 0 : st.contents) == null ? void 0 : lt.ops;
      C !== "x" && j === "x" ? ft == null || ft.forEach((vt) => bw(vt)) : C === "x" && j !== "x" && (ft == null || ft.forEach((vt) => xw(vt))), (_t = w.current) == null || _t.applyUpdate([tt, { delete: 1 }]);
    }
  }, Tt = (j) => {
    Z(j.contextMarker), et(j.canRedo);
  }, jt = F(
    (j) => {
      var it, ot, st, lt, _t;
      const tt = (ot = (it = w.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (tt && Ar("note", tt)) {
        j.content.length > 1 && setTimeout(() => {
          var Rt;
          (Rt = w.current) == null || Rt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ft = (st = tt.insert.note) == null ? void 0 : st.style, vt = (_t = (lt = tt.insert.note) == null ? void 0 : lt.contents) == null ? void 0 : _t.ops;
        if (ft || k(!1), k(
          ft === "x" ? !!(vt != null && vt.every((Rt) => {
            var Bt, Wt;
            if (!((Bt = Rt.attributes) != null && Bt.char)) return !0;
            const Ft = ((Wt = Rt.attributes) == null ? void 0 : Wt.char).style;
          ...
          R.current = !0, J.current = JSON.stringify(tt), K(!0);
          return;
        }
        K(JSON.stringify(tt) === J.current), gt(f, y);
      } else
        k(!1), K(!0);
    },
    [f, y, gt]
    ...
    if (h.current && wt.length && j && j.rangeCount > 0) {
      const tt = j.getRangeAt(0).getBoundingClientRect(), it = h.current.getBoundingClientRect();
      nt(tt.left - it.left), ut(tt.top - it.top), M(tt.height), z(!0);
    }
  }, [wt, h]);
  G(() => {
    const j = () => {
    ...
    var j;
    E && ((j = Q.current) == null || j.focus());
  }, [E]), G(() => {
    var it;
    const j = ((it = p.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0, tt = (ot) => {
      !E && j && document.activeElement === j && ot.key === c ? (ot.preventDefault(), me()) : E && ot.key === "Escape" && (ot.preventDefault(), z(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
              ...
              /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ a("p", { children: re }) })
            ] }) }) })
          ]
        }
      )
...
function Sp({
  ...
  const w = l ?? Hs(r, void 0), p = (y, N) => {
    d == null || d(y, N, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = _(h), b = (y, N, $) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
  ...
  return G(() => {
    var y;
    g >= 0 && g < S.current.length && ((y = S.current[g]) == null || y.focus());
  }, [g]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function Ew({
  ...
  return /* @__PURE__ */ u(Ja, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Za, { stickyHeader: !0, children: /* @__PURE__ */ u(Re, { children: [
    ...
    /* @__PURE__ */ a(Qa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Re,
      {
        ...
        children: [
          /* @__PURE__ */ a(or, { children: xe(c.reference, "English") }),
...
}, da = (t, e, r) => /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
  /* @__PURE__ */ u(
    Vt,
    {
...
function Pp({
  ...
  const g = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), b = de(r, "%webView_inventory_unapproved%"), m = de(r, "%webView_inventory_unknown%"), S = de(r, "%webView_inventory_scope_currentBook%"), y = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), $ = de(r, "%webView_inventory_filter_text%"), U = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = de(r, "%webView_inventory_no_results%"), [V, P] = _(!1), [k, A] = _("all"), [K, T] = _(""), [et, R] = _([]), J = I(() => {
    const M = t ?? [];
    return M.length === 0 ? [] : Dw(M, n, i);
  }, [t, n, i]), E = I(() => {
    if (V) return J;
    const M = [];
    return J.forEach((W) => {
      const Z = W.items[0], Q = M.find(
        (rt) => rt.items[0] === Z
      );
      Q ? (Q.count += W.count, Q.occurrences = Q.occurrences.concat(W.occurrences)) : M.push({
        items: [Z],
        count: W.count,
  ...
  }, [V, J]), z = I(() => E.length === 0 ? [] : Rw(E, k, K), [E, k, K]), q = I(() => {
    var Z, Q;
    if (!V) return l;
    const M = (Z = o == null ? void 0 : o.tableHeaders) == null ? void 0 : Z.length;
    if (!M) return l;
    const W = [];
    for (let rt = 0; rt < M; rt++)
      W.push(
        zw(
          ((Q = o == null ? void 0 : o.tableHeaders) == null ? void 0 : Q[rt]) || "Additional Item",
          rt + 1
        )
      );
    return [...W, ...l];
  ...
  const nt = (M, W) => {
    W.setRowSelection(() => {
      const Q = {};
      return Q[M.index] = !0, Q;
    });
    const Z = M.original.items;
    R(Z), h && Z.length > 0 && h(Z[0]);
  }, bt = (M) => {
    if (M === "book" || M === "chapter" || M === "verse")
      c(M);
    else
      throw new Error(`Invalid scope value: ${M}`);
  }, ut = (M) => {
    if (M === "all" || M === "approved" || M === "unapproved" || M === "unknown")
      A(M);
    else
      throw new Error(`Invalid status filter value: ${M}`);
  }, Et = I(() => {
    if (E.length === 0 || et.length === 0) return [];
    const M = E.filter((W) => qs(
      V ? W.items : [W.items[0]],
      et
    ));
    if (M.length > 1) throw new Error("Selected item is not unique");
    return M.length === 0 ? [] : M[0].occurrences;
  }, [et, V, E]);
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
        /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            Ci,
            {
          ...
          /* @__PURE__ */ a(Ct, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? U })
        ] }) }),
...
const Mw = "16rem", Ow = "3rem", Ei = Jt.createContext(void 0);
function wa() {
  const t = Jt.useContext(Ei);
  if (!t)
...
function $w({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    ...
    [r, w]
  ), h = Jt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", m = ce() === "ltr" ? s : s === "primary" ? "secondary" : "primary", S = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(Ei.Provider, { value: S, children: /* @__PURE__ */ a(
    "div",
    {
...
function Fw({
  ...
  const c = t ? Rr.Root : "button", { state: l } = wa(), d = /* @__PURE__ */ a(
    c,
    {
  ...
  return n ? /* @__PURE__ */ u(Pt, { children: [
    /* @__PURE__ */ a(Vt, { asChild: !0, children: d }),
    /* @__PURE__ */ a(
      Lt,
      {
        side: "right",
...
const ze = "scrBook", Uw = "scrRef", Ge = "source", Kw = "details", Gw = "Scripture Reference", Hw = "Scripture Book", Ti = "Type", qw = "Details";
function Yw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Mt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ze ? xe(n.start) : void 0;
      },
...
const Ww = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ia(t.start, t.end) === 0 ? `${ha(t.start)}+${e}` : `${ha(t.start)}+${e}-${ha(t.end)}+${r}`;
...
function Zp({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: ze, desc: !1 }]), [g, f] = _({}), b = I(
    () => t.flatMap((k) => k.data.map((A) => ({
      ...A,
      source: k.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const k = S.getSelectedRowModel().rowsById, A = Object.keys(k);
      if (A.length === 1) {
        const K = b.find((T) => ln(T) === A[0]) || void 0;
        K && c(K);
      }
    }
  }, [g, b, c, S]);
  const y = n ?? Hw, N = i ?? Ti, $ = [
    ...
    !k.getIsGrouped() && !k.getIsSelected() && k.getToggleSelectedHandler()(A);
  }, V = (k, A) => k.getIsGrouped() ? "" : v("banded-row", A % 2 === 0 ? "even" : "odd"), P = (k, A, K) => {
    if (!((k == null ? void 0 : k.length) === 0 || A.depth < K.column.getGroupedIndex())) {
      if (A.getIsGrouped())
        switch (A.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ur, { position: "item-aligned", children: /* @__PURE__ */ a(Jd, { children: $.map((k) => /* @__PURE__ */ a(ie, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ja, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Za, { children: S.getHeaderGroups().map((k) => /* @__PURE__ */ a(Re, { children: k.headers.filter((A) => A.column.columnDef.header).map((A) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Wr, { colSpan: A.colSpan, className: "tw:sticky top-0", children: A.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          yr(A.column.columnDef.header, A.getContext())
        ] }) }, A.id)
      )) }, k.id)) }),
      /* @__PURE__ */ a(Qa, { children: S.getRowModel().rows.map((k, A) => {
        const K = ce();
        return /* @__PURE__ */ a(
          Re,
          {
            ...
            className: v(V(k, A)),
            onClick: (T) => C(k, T),
            children: k.getVisibleCells().map((T) => {
              if (!(T.getIsPlaceholder() || T.column.columnDef.enableGrouping && !T.getIsGrouped() && (T.column.columnDef.id !== Ge || !r)))
                return /* @__PURE__ */ a(
                  or,
                  {
                    className: v(
                    ...
                    children: T.getIsGrouped() ? /* @__PURE__ */ u(
                      H,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ a(sr, {}),
                          !k.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a($a, {}) : /* @__PURE__ */ a(Oa, {})),
                          " ",
                          yr(T.column.columnDef.cell, T.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
function Xw({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, S] = _(!1), [y, N] = _(""), $ = B(void 0), U = B(!1), C = I(
    () => bn(t),
    [t]
  ), V = I(() => {
    if (!y.trim()) {
    ...
    (R, J = !1) => {
      ...
      const E = C.findIndex((ut) => ut === $.current), z = C.findIndex((ut) => ut === R);
      if (E === -1 || z === -1) return;
      const [q, nt] = [
        Math.min(E, z),
        Math.max(E, z)
      ], bt = C.slice(q, nt + 1).map((ut) => ut);
      r(
    ...
    P(R, U.current), U.current = !1;
  }, A = (R, J) => {
    R.preventDefault(), P(J, R.shiftKey);
  }, K = () => {
    r(C.map((R) => R));
  }, T = () => {
    r([]);
  }, et = I(
    () => Object.values(ht).filter(
      (R) => (i == null ? void 0 : i[R]) !== void 0 && to(C, R).length === 0
              ...
              Ie,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(H, { variant: "ghost", size: "sm", onClick: T, children: w })
                  ] }),
                  /* @__PURE__ */ u(Pe, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(oa, { children: p }),
                    Object.values(ht).filter((R) => V[R].length > 0).map((R, J) => {
                      const E = V[R];
                      return /* @__PURE__ */ u(ia, { children: [
                        J > 0 && /* @__PURE__ */ a(mn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          ke,
                          {
                            heading: un(R, h, g, f, b),
                            children: E.map((z) => /* @__PURE__ */ a(
                              qn,
                              {
                                bookId: z,
                  ...
                  et.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: et.map(({ section: R, explanation: J }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: J }, R)) })
                ]
              }
            )
          }
...
function Zw({
  ...
  return /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
    /* @__PURE__ */ a(Vt, { asChild: !0, children: /* @__PURE__ */ a(
      Jw,
      {
        className: o,
...
function Qw({
  ...
  const s = to(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    H,
    {
      variant: "outline",
      size: "sm",
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ta ? Ta : dn
      ).map((d) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: Se(d, n) }, d)),
...
function th({
  ...
  const U = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Dt(s, "%webView_scope_selector_verse%"), V = Dt(s, "%webView_scope_selector_chapter%"), P = Dt(s, "%webView_scope_selector_book%"), k = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), A = Dt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), K = Dt(s, "%webView_scope_selector_current_book%"), T = Dt(s, "%webView_scope_selector_choose_books%"), et = Dt(s, "%webView_scope_selector_scope%"), R = Dt(s, "%webView_scope_selector_select_books%"), J = Dt(s, "%webView_scope_selector_range%"), E = Dt(s, "%webView_scope_selector_select_range%"), z = Dt(s, "%webView_scope_selector_range_start%"), q = Dt(s, "%webView_scope_selector_range_end%"), nt = Dt(s, "%webView_scope_selector_ok%"), bt = Dt(s, "%webView_scope_selector_cancel%"), ut = Dt(s, "%webView_scope_selector_navigate%"), Et = (L) => {
    if (!b) return;
    ...
    { value: "selectedBooks", label: T, id: "scope-selected" },
    { value: "range", label: J, id: "scope-range" }
  ], W = (L, X, Xt = !1) => /* @__PURE__ */ u(dt, { children: [
    L,
    X && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), Z = e ? M.filter((L) => e.includes(L.value)) : M, Q = b ?? ga, rt = p ?? Q, wt = h ?? Q, gt = () => {
  }, yt = B(null), Yt = B(null), St = B(!1), Qt = B(null), fe = B(!1), [O, kt] = _(void 0), Tt = B(!1), jt = B(!1), me = B(null), re = F((L) => {
    if (L) {
      kt("start"), Tt.current = !1;
      return;
    }
    kt((X) => X === "start" ? void 0 : X), Tt.current && (Tt.current = !1, requestAnimationFrame(() => {
      var Xt;
      const X = (Xt = yt.current) == null ? void 0 : Xt.querySelector("button");
      X == null || X.click();
    }));
  }, []), j = F((L) => {
    if (L) {
    ...
    [r, n, b, i]
  ), st = Z.find((L) => L.value === t), lt = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Ys(rt, wt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : st ? W(st.label, st.scrRefSuffix) : t, _t = Z.filter(
    (L) => L.value !== "selectedBooks" && L.value !== "range"
  ), ft = Z.find((L) => L.value === "selectedBooks"), vt = Z.find((L) => L.value === "range"), [Rt, Ft] = _(!1), [Bt, Wt] = _(void 0), [ve, D] = _(void 0), [Nt, zt] = _(void 0), [te, Ze] = _(void 0), [Qe, hr] = _([]), gr = w === "dropdown" && Bt === "selectedBooks", fr = /* @__PURE__ */ a(
    tu,
    {
      availableBookInfo: o,
      selectedBookIds: gr ? Qe : n,
      onChangeSelectedBookIds: gr ? hr : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Dr = O === "end", Mr = O === "start", tr = "tw:text-muted-foreground", x = w === "dropdown" && Bt === "range", Y = x ? zt : tt, Ut = x ? Ze : f ? it : gt, be = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: v(Dr && tr), children: z }),
      /* @__PURE__ */ a(
        ma,
        {
    ...
    /* @__PURE__ */ u("div", { ref: yt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: v(Mr && tr), children: q }),
      /* @__PURE__ */ a(
        ma,
        {
          id: "scope-range-end",
          ...
          localizedStrings: S,
          getEndVerse: y,
          disableReferencesUpTo: x ? Nt ?? rt : rt,
          onOpenChange: j,
          onCloseAutoFocus: (L) => {
            var X;
            jt.current && (jt.current = !1, L.preventDefault(), (X = me.current) == null || X.focus());
          },
          className: v(Mr && tr),
          modal: !0,
          align: "start"
  ...
  const [xt, At] = _(null), [mt, ae] = _(null), [ee, Ue] = _(null), Ai = 200, [Ii, Pi] = _(!1);
  G(() => {
    if (!ee || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([X]) => {
      Pi(X.contentRect.width < Ai);
    });
    return L.observe(ee), () => L.disconnect();
  }, [ee]);
  const bo = F(
    (L) => {
      D(L), zt(rt), Ze(wt), hr(n), Ft(!1), Wt(L);
    },
    [rt, wt, n]
  ), xo = F(() => {
    ve !== void 0 && (ve === "range" ? (Nt && (g == null || g(Nt)), te && (f == null || f(te))) : ve === "selectedBooks" && i(Qe), ot(ve), Wt(void 0), D(void 0));
  }, [
    ve,
    Nt,
    te,
    ...
    L || (Wt(void 0), D(void 0));
  }, []), yo = F((L) => {
    var X;
    L.preventDefault(), (X = $t.current) == null || X.focus();
  }, []), ko = (L) => t === L ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(Ct, { children: et }),
      w === "dropdown" ? /* @__PURE__ */ u(Ve, { open: Rt, onOpenChange: Ft, children: [
        ...
        /* @__PURE__ */ a(
          je,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ua, { container: ee, children: [
              _t.map(({ value: L, label: X, dropdownLabel: Xt, scrRefSuffix: mr, id: Vi }) => /* @__PURE__ */ u(
                He,
                {
                  ref: Ce(L),
                  ...
                  children: [
                    t === L && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" }) }),
                    W(Xt ?? X, mr, Ii)
                  ]
                },
                Vi
                ...
                /* @__PURE__ */ a(
                  He,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      fe.current || (Xt = (X = Yt.current) == null ? void 0 : X.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ma,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: xe(b ?? ga, "id") }),
                              /* @__PURE__ */ a(sr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ya,
        {
          ...
          children: Z.map(({ value: L, label: X, scrRefSuffix: Xt, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Yr, { className: "tw:me-2", value: L, id: mr }),
            /* @__PURE__ */ a(Ct, { htmlFor: mr, children: W(X, Xt) })
          ] }, mr))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { children: R }),
      fr
    ] }),
    w === "radio" && t === "range" && be,
    w === "dropdown" && ft && /* @__PURE__ */ a(za, { open: Bt === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Sa,
      {
        ref: ae,
        onCloseAutoFocus: yo,
        onEscapeKeyDown: (L) => {
          mt != null && mt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: mt, children: [
          /* @__PURE__ */ a(Ra, { className: "tw:pe-8", children: /* @__PURE__ */ a(Da, { children: T }) }),
          fr,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Or(!1), children: bt }),
            /* @__PURE__ */ a(H, { onClick: xo, children: nt })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && vt && /* @__PURE__ */ a(za, { open: Bt === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Sa,
      {
        ref: At,
        onCloseAutoFocus: yo,
        onEscapeKeyDown: (L) => {
          xt != null && xt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: xt, children: [
          /* @__PURE__ */ a(Ra, { className: "tw:pe-8", children: /* @__PURE__ */ a(Da, { children: E }) }),
          be,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Or(!1), children: bt }),
            /* @__PURE__ */ a(H, { ref: me, onClick: xo, children: nt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          ur,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ie, { value: `${w}`, children: l[zo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Si = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Vt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    He,
    {
      onClick: () => {
        o(c);
...
function Ga({
  ...
  return /* @__PURE__ */ u(Ve, { variant: i, children: [
    /* @__PURE__ */ a(Le, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(H, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(je, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ia, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(It, { children: Si(e.groups, e.items, l, t) }) }),
...
Oi.displayName = le.Content.displayName;
function sh({
  tabList: t,
  searchValue: e,
  onSearch: r,
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Vt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        lu,
        {
          onClick: () => {
            o(d);
  ...
  if (dl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(ou, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(nu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(It, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function dh({
  ...
  const d = gu(
    ...
    var S, y, N, $, U, C;
    const m = b !== f ? ((y = (S = t[f]) == null ? void 0 : S.uiNames) == null ? void 0 : y[b]) ?? (($ = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : $.en) : void 0;
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Ct, { className: "tw:font-normal tw:text-muted-foreground", children: qe(d, {
...
function uh({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(is, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(ss, { children: /* @__PURE__ */ a(ac, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Pe, { children: [
    ...
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(ia, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function lg(t) {
  const e = I(() => Ws(t).slice().sort().join(" "), [t]);
...
const xr = 288, zu = 176, Ee = 12, Su = 6;
function wn(t) {
...
function Du(t, e, r) {
  const o = (l) => Math.max(
    Te,
    Math.min(l, window.innerWidth - xr - Te)
  ), n = (l) => Math.max(
    Te,
    Math.min(l, window.innerHeight - r - Te)
  ), i = {
    top: t.top - Ee - r >= Te,
    bottom: t.top + t.height + Ee + r <= window.innerHeight - Te,
    left: t.left - xr - Ee >= Te,
    right: t.left + t.width + Ee + xr <= window.innerWidth - Te
  ...
  switch (!i[e] && i[s[e]] ? s[e] : e) {
    ...
    case "left":
      return { top: n(t.top), left: o(t.left - xr - Ee) };
    case "right":
      return { top: n(t.top), left: o(t.left + t.width + Ee) };
    default:
      return { top: n(t.top + t.height + Ee), left: o(t.left) };
  }
}
function ug({
  steps: t,
  ...
  const [d, w] = _([]), [p, h] = _(0), [g, f] = _(void 0), [b, m] = _(!1), [S, y] = _(zu), N = B(null), $ = B(null), U = B(void 0), C = B(o);
  G(() => {
    C.current = o;
  });
  const V = Xr(), P = Xr();
  Ht(() => {
    ...
    w(t.filter((M) => wn(M.target) !== void 0)), h(0), m(!0);
  }, [e]);
  const k = d[p], A = g && g.step === k ? g.rect : void 0, K = A !== void 0;
  G(() => {
    if (!e || !k) return;
    let M, W = !1;
    const Z = () => {
      const rt = wn(k.target);
      if (!rt) {
        W || w((wt) => wt.filter((gt) => gt !== k));
        return;
      }
      W = !0, f(
        (wt) => wt && wt.step === k && wt.rect.top === rt.top && wt.rect.left === rt.left && wt.rect.width === rt.width && wt.rect.height === rt.height ? wt : { step: k, rect: rt }
      );
    }, Q = () => {
      M === void 0 && (M = requestAnimationFrame(() => {
        M = void 0, Z();
      }));
    };
    return Z(), window.addEventListener("resize", Q), window.addEventListener("scroll", Q, { capture: !0, passive: !0 }), () => {
      window.removeEventListener("resize", Q), window.removeEventListener("scroll", Q, { capture: !0 }), M !== void 0 && cancelAnimationFrame(M);
    };
  }, [e, k]), G(() => {
    d.length > 0 && p >= d.length && h(d.length - 1);
  }, [d, p]), G(() => {
    e && b && d.length === 0 && C.current();
  }, [e, b, d.length]), Ht(() => {
    var W;
    const M = (W = $.current) == null ? void 0 : W.offsetHeight;
    M && y((Z) => Z !== M ? M : Z);
  }, [e, p, K]), G(() => {
    e ? U.current = document.activeElement ?? void 0 : (U.current instanceof HTMLElement || U.current instanceof SVGElement) && (U.current.isConnected && U.current.focus(), U.current = void 0);
  }, [e]), G(() => {
    var M;
    e && k && K && ((M = N.current) == null || M.focus());
  }, [e, k, K]);
  const T = p === d.length - 1, et = p === 0, R = F(() => {
    T ? r() : h((M) => M + 1);
  }, [T, r]), J = F(() => {
    et || h((M) => M - 1);
  }, [et]);
  if (G(() => {
    ...
    if (!e || !k || !K) return;
    const M = Array.from(
      ((Z = $.current) == null ? void 0 : Z.querySelectorAll("button:not([disabled])")) ?? []
    ), W = (Q) => {
      if (Q.key !== "Tab" || M.length === 0) return;
      const rt = M[0], wt = M[M.length - 1];
      Q.shiftKey ? document.activeElement === rt && (Q.preventDefault(), wt.focus()) : document.activeElement === wt && (Q.preventDefault(), rt.focus());
    };
    return document.addEventListener("keydown", W, !0), () => document.removeEventListener("keydown", W, !0);
  }, [e, k, K]), !e || !k || !A) return null;
  const E = Ru(k.side ?? "bottom"), z = Du(A, E, S), q = k.spotlightPadding ?? Su, nt = A.left - q, bt = A.top - q, ut = A.width + q * 2, Et = A.height + q * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
      ...
      children: [
        ...
        /* @__PURE__ */ u(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ a("defs", { children: /* @__PURE__ */ u("mask", { id: V, children: [
              ...
              /* @__PURE__ */ a("rect", { width: "100%", height: "100%", fill: "rgba(0,0,0,0.55)", mask: `url(#${V})` })
            ]
          }
        ),
        /* @__PURE__ */ u(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a("h3", { className: "tw:text-sm tw:font-semibold", children: k.title }),
              /* @__PURE__ */ a("p", { id: P, className: "tw:text-sm tw:text-muted-foreground", children: k.description }),
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                /* @__PURE__ */ a(H, { variant: "ghost", size: "sm", onClick: o, children: c }),
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !et && /* @__PURE__ */ a(H, { variant: "outline", size: "sm", onClick: J, children: s }),
                  /* @__PURE__ */ a(H, { ref: N, size: "sm", onClick: R, children: T ? l : i })
                ] })
              ] })
            ]
          }
...
export {
  ...
  Da as DialogTitle,
  xg as DialogTrigger,
  Zw as DisabledActionTooltip,
  Jw as DisabledTooltipWrapper,
  Ph as Drawer,
  Lh as DrawerClose,
  jh as DrawerContent,
