...
import { c as m, g as ge, a as _r, C as Se, u as Do, T as Mt, b as Ot, d as It, e as $t, A as le, P as Ve, f as Qe, B as X, h as Le, i as je, j as Be, k as Ee, x as Xi, l as Zi, m as Ji, I as Qi, n as io, r as be, o as ts, p as _n, q as ia, s as sa, L as Tt, R as so, t as Jr, D as ja, v as Ba, w as Fa, y as Ua, z as Nn, E as Kr, F as co, G as Cn, H as lo, J as Ze, K as Tr, M as Fe, N as Ue, O as Ke, S as Sr, Q as ir, U as es, V as Dr, W as Je, X as $e, Z as tr, Y as Oe, _ as sr, $ as wo, a0 as uo, a1 as Qr, a2 as po, a3 as En, a4 as rs, a5 as as, a6 as os, a7 as Ka, a8 as Tn, a9 as ca, aa as ns, ab as Sn, ac as is, ad as ss, ae as cs, af as Mo, ag as ls, ah as ds, ai as ws, aj as us, ak as Rn, al as zn, am as ho, an as ps, ao as Dn, ap as Na, aq as Oo, ar as Ca, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Mr, ay as go, az as bs, aA as xs } from "./resizable-BYFGyHY4.js";
import { aB as Eg, aC as Tg, aD as Sg, aE as Rg, aF as zg, aG as Dg, aH as Mg, aI as Og, aJ as Ig, aK as $g, aL as Pg, aM as Ag, aN as Vg, aO as Lg, aP as jg, aQ as Bg, aR as Fg, aS as Ug, aT as Kg, aU as Hg, aV as qg, aW as Gg, aX as Wg, aY as Yg, aZ as Xg, a_ as Zg, a$ as Jg, b0 as Qg, b1 as tf, b2 as ef, b3 as rf, b4 as af, b5 as of, b6 as nf, b7 as sf, b8 as cf, b9 as lf, ba as df } from "./resizable-BYFGyHY4.js";
import { jsx as a, jsxs as u, Fragment as dt } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Pe, Clock as Io, ChevronsLeft as $o, ChevronsRight as Po, ChevronLeft as Ha, ChevronRight as qa, ArrowLeft as ys, ArrowRight as ks, ChevronDown as dr, BoldIcon as _s, ItalicIcon as Ns, X as fo, AtSign as Mn, Pencil as Cs, Trash2 as Es, ArrowUp as On, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as In, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as $n, FunctionSquare as Pn, SquareSigma as An, Ban as Fs, AlertCircle as Ga, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as qs, ArrowDownIcon as Gs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Zs, EllipsisVertical as Js, MoreVertical as Qs } from "lucide-react";
...
import { GENERATOR_NOTE_CALLER as Za, HIDDEN_NOTE_CALLER as Ja, getDefaultViewOptions as _l, isInsertEmbedOpOfType as xr, getMarkerMenuItems as Nl, defaultStyleInfo as Cl, Editorial as El } from "@eten-tech-foundation/platform-editor";
...
function Ra({
  ...
  const E = be(), F = zl(), [O, z] = _(!1), [K, W] = _(""), [j, Q] = _(""), [N, et] = _("books"), [D, M] = _(void 0), [q, nt] = _(
    void 0
  ), [ot, ut] = _(void 0), [jt, Z] = _(!1), [st, ft] = _(!1), mt = U(null), vt = U(!1), _t = U(void 0), ht = U(void 0), Bt = U(void 0), re = U(void 0), St = U({}), Ft = U({}), gt = L(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Ll(Yt, xt),
    [Yt, xt]
  ), Re = Zt.has(t.book), oe = A(() => j.trim() ? to(
  ...
  const { otLong: $, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    () => Pl(j),
    [j]
  ), fa = A(() => !w || !P || !P.chapterNum || !Ar ? !1 : w(P.book, P.chapterNum) > 0, [w, P, Ar]), ma = N === "books" && !jt && !j.trim() && Zt.size > 0, Vr = L(
    (k) => p ? Yo(k, p) : !1,
    [p]
  ), mr = L(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
    ...
    (k) => {
      ...
      if ((N === "chapters" || N === "books" && P) && Qt) {
        ...
        if (!lt) return;
        N === "chapters" && ((J = _t.current) == null || J.focus());
        const bt = (() => {
          if (!K) return 1;
          const De = K.match(/(\d+)$/);
    ...
    const { isLetter: rt, isDigit: at } = Xo(k.key);
    (rt || at) && (k.preventDefault(), Q((_e) => _e + k.key), ht.current.focus(), Z(!1));
  }, []);
  return te(() => {
    const k = setTimeout(() => {
      if (O && N === "books" && Bt.current && re.current) {
        const rt = Bt.current, at = re.current, Qt = at.offsetTop, _e = rt.clientHeight, V = at.clientHeight, J = Qt - _e / 2 + V / 2;
        rt.scrollTo({
          top: Math.max(0, J),
          behavior: "smooth"
        }), W(si(t.book));
...
const Zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : Y;
function Jl(t) {
...
function Pi({
  ...
  const [j, Q] = _(hn), [N, et] = _(), [D, M] = _(), q = o, [nt, ot] = _(!1), [ut, jt] = _(!1), [Z, st] = _(!1), [ft, mt] = _(!1), [vt, _t] = _(!1), [ht, Bt] = _(T), [re, St] = _(!1), Ft = U(void 0), [gt, Yt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const $ = y ? await y(l) : !1;
  ...
  const At = A(() => Nt[0], [Nt]), Xt = U(null), we = U(void 0), Zt = L(() => {
    var x;
  ...
  }, [i, r]), Ut = A(() => Nt.slice(1), [Nt]), yt = A(() => Ut.length ?? 0, [Ut.length]), se = A(() => yt > 0, [yt]), Jt = A(() => nt || yt <= 2 ? Ut : Ut.slice(-2), [Ut, yt, nt]), Kt = A(() => nt || yt <= 2 ? 0 : yt - 2, [yt, nt]), ue = A(
      ...
      children: /* @__PURE__ */ u(iw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(dt, { children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            W && Jt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Kt > 0 && /* @__PURE__ */ u(
              "div",
              {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ u(Ve, { open: Z, onOpenChange: st, children: [
                      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                        X,
                        {
                          size: "icon",
...
function ww({
  ...
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), j = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : W, Q = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(Zr, { html: R }) : W : j(D === "reject" ? t.rejectedResultText : t.resultText);
...
function Wp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [T, I] = _("*"), [E, F] = _("*"), [O, z] = _("f"), [K, W] = _(!1), [j, Q] = _(!0), [N, et] = _(!1), D = U(!1), M = U(""), [q, nt] = _(!1), [ot, ut] = _(), [jt, Z] = _(), [st, ft] = _(), [mt, vt] = _(), _t = U(null), ht = U(
    void 0
  ...
  Y(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let ct = "custom";
      tt === Za ? ct = "generated" : tt === Ja ? ct = "hidden" : tt && (I(tt), F(tt)), R(ct), C(ct), z((($ = x.insert.note) == null ? void 0 : $.style) ?? "f"), S = setTimeout(() => {
        var pt, Ct, Rt;
  ...
  const Yt = L(
    ...
    (S, B) => {
      ...
      let x;
      S === "custom" ? x = B : S === "generated" ? x = Za : x = Ja, G.insert.note.caller !== x && (G.insert.note.caller = x, (tt = h.current) == null || tt.applyUpdate([G, { delete: 1 }]));
    },
    []
  ), Nt = L(() => {
    var S;
  ...
  const we = () => {
    ...
    if (f.current && Ft.length && S && S.rangeCount > 0) {
      ...
      ut(B.left - G.left), Z(B.top - G.top), ft(B.height), nt(!0);
    }
  }, [Ft, f]), yt = U(() => {
  }), se = L(
    (S, B, G) => {
    ...
    (S) => {
      ...
      cs(S, B, {
        ...
        commitTypedAndReopen: (x) => {
          var H;
          (H = h.current) == null || H.commitTypedMarker(x, { trailingSpace: !1 }), Jt();
        },
        commitTypedCloser: (x) => {
          var H;
    ...
    if (((G = St.view) == null ? void 0 : G.markerMode) === "editable") {
      const x = ($) => {
        ...
        if (w && $.key === c) {
          ...
          Jt() && ($.preventDefault(), $.stopPropagation());
        }
      }, H = () => {
        var tt, ct;
        const $ = S();
...
function oh({
  ...
  const g = he(r, "%webView_inventory_all%"), f = he(r, "%webView_inventory_approved%"), b = he(r, "%webView_inventory_unapproved%"), v = he(r, "%webView_inventory_unknown%"), R = he(r, "%webView_inventory_scope_currentBook%"), y = he(r, "%webView_inventory_scope_chapter%"), C = he(r, "%webView_inventory_scope_verse%"), T = he(r, "%webView_inventory_filter_text%"), I = he(
    ...
    return et.forEach((st) => {
      const ft = st.items[0], mt = Z.find(
        (vt) => vt.items[0] === ft
      );
      mt ? (mt.count += st.count, mt.occurrences = mt.occurrences.concat(st.occurrences)) : Z.push({
        items: [ft],
        count: st.count,
...
function yh({
  ...
  ], st = (V, J, lt = !1) => /* @__PURE__ */ u(dt, { children: [
    V,
    J && !lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), ft = e ? Z.filter((V) => e.includes(V.value)) : Z, mt = b ?? Ta, vt = p ?? mt, _t = h ?? mt, ht = () => {
  }, Bt = U(null), re = U(null), St = U(!1), Ft = U(null), gt = U(!1), [Yt, xt] = _(void 0), Nt = U(!1), At = U(!1), Xt = U(null), we = L((V) => {
    if (V) {
      xt("start"), Nt.current = !1;
      return;
    }
    xt((J) => J === "start" ? void 0 : J), Nt.current && (Nt.current = !1, requestAnimationFrame(() => {
      var lt;
      const J = (lt = Bt.current) == null ? void 0 : lt.querySelector("button");
      J == null || J.click();
    }));
  }, []), Zt = L((V) => {
    if (V) {
  ...
  ), Jt = ft.find((V) => V.value === "selectedBooks"), Kt = ft.find((V) => V.value === "range"), [ue, ke] = _(!1), [S, B] = _(void 0), [G, x] = _(void 0), [H, $] = _(void 0), [tt, ct] = _(void 0), [pt, Ct] = _([]), Rt = w === "dropdown" && S === "selectedBooks", Vt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { ref: Bt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        Ra,
        {
          ...
          onCloseAutoFocus: (V) => {
            var J;
            At.current && (At.current = !1, V.preventDefault(), (J = Xt.current) == null || J.focus());
          },
          className: m(Pr && qe),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    return () => {
      cancelAnimationFrame(J), V && cancelAnimationFrame(V);
    };
  }, [ue, t]);
  ...
  const k = L(
    ...
    var J;
    V.preventDefault(), (J = vr.current) == null || J.focus();
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Fe, { open: ue, onOpenChange: ke, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: ar, children: [
              se.map(({ value: V, label: J, dropdownLabel: lt, scrRefSuffix: bt, id: Lt }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: rr(V),
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (V) => {
                      ...
                      gt.current || (lt = (J = re.current) == null ? void 0 : J.querySelector("button")) == null || lt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          const J = V.target instanceof HTMLElement ? V.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var J;
                              V.preventDefault(), (J = Ft.current) == null || J.focus();
                            },
                            modal: !0,
        ...
        so,
        {
          ...
          children: ft.map(({ value: V, label: J, scrRefSuffix: lt, id: bt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Jr, { className: "tw:me-2", value: V, id: bt }),
            /* @__PURE__ */ a(Tt, { htmlFor: bt, children: st(J, lt) })
          ] }, bt))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Vr,
    w === "dropdown" && Jt && /* @__PURE__ */ a(ja, { open: S === "selectedBooks", onOpenChange: at, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: Qt,
...
export {
  ...
  af as Z_INDEX_NESTED_MODAL,
  of as Z_INDEX_NESTED_MODAL_BACKDROP,
