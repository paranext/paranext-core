...
function Uc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function sl({ initialConfig: t, children: e }) {
  const n = V(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = ol(null, o), p = xo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function hl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Hs(e) && o !== null) {
    ...
    if (w || p) {
      const [u, h] = Ys(t), f = l.is(d), g = e.is(i ? d : l), x = e.is(i ? l : d);
      let v, y = 0;
...
const Dl = /* @__PURE__ */ new Set(), Jr = qt({ build(t, e, n) {
  ...
  return { watchNodeKey: function(i) {
    const l = yl(() => (s.value || Dl).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
qt({ dependencies: [rr, Jr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  ...
  return te(t.registerCommand(ri, (i) => {
    if (oi(i.target)) {
      const l = ai(i.target);
    ...
    return !1;
  }, wi), t.registerMutationListener(Ee, (i, l) => {
    xl(() => {
      let d = !1;
...
function tw({
  ...
  const [e] = Lt(), [n, o] = A(e), [a, s] = A("paragraph"), [i, l] = Ql(), d = () => {
  };
...
function ca(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && fn(e) && (i = hl(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], d = Ni(t, i.getType());
  let w;
...
function Jc({
  ...
  const [a, s] = A(cw), [i, l] = A(void 0), [d, w] = A(!1), p = W(void 0), u = W(null);
  U(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
const Zc = Object.freeze([
  ...
  const a = W(null), [s, i] = A(void 0), [l, d] = A(void 0), w = G(
    ...
    (f) => {
      var k;
      const g = f.target, x = (T) => T ? document.getElementById(T) : void 0, v = x(l), y = x(s);
    ...
    if (o && l)
      return /* @__PURE__ */ c(st, { children: [
        /* @__PURE__ */ c(
          ...
          {
            onClick: (E) => {
              E.stopPropagation(), w(!0), u(dw(t.contents)), i == null || i(!0);
            },
            children: [
...
function Cw({
  ...
  }, [s, n]), Z = V(() => Wt.slice(1), [Wt]), Q = V(() => Z.length ?? 0, [Z.length]), wt = V(() => Q > 0, [Q]), jt = V(() => $ || Q <= 2 ? Z : Z.slice(-2), [Z, Q, $]), bt = V(() => $ || Q <= 2 ? 0 : Q - 2, [Q, $]), an = V(
...
function ep({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(ji, { options: s, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(mo, {}) })
        ] }),
...
function qw({
  ...
  const s = W(null), i = W(null), l = W(!1), [d, w] = A(t), [p, u] = A(n), [h, f] = A(!1);
  U(() => {
    w(t);
  }, [t]), U(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    ...
    var y, N, C, E;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((E = i.current) == null || E.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function dp({
  ...
  const p = d ?? qs(n, void 0), u = (N, C) => {
    w == null || w(N, C, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [f, g] = A(h), x = (N, C, E) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
      ...
      /* @__PURE__ */ r(Kt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ c(
          $t,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(ld, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
  ...
  ({
    ...
    const d = t ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      d,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(bd({ variant: n, size: o }), s),
        ...i
      }
    );
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(j, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Os, {}) }) }),
