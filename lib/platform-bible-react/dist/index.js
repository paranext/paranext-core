...
var pt = (e, t, n) => ps(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as W, useMemo as L, useState as D, useCallback as z, useLayoutEffect as Pt, createContext as xn, useContext as fr, useEffect as q, Component as us, createElement as Lr, Suspense as ms, createRef as hs, Fragment as fo } from "react";
import { Command as ft } from "cmdk";
import { X as en, Search as go, Check as Mt, Clock as Br, ChevronsLeft as zr, ChevronsRight as jr, ChevronLeft as qn, ChevronRight as Ce, ArrowLeft as fs, ArrowRight as gs, Circle as yn, ChevronDown as me, BoldIcon as bs, ItalicIcon as vs, UnderlineIcon as xs, StrikethroughIcon as ys, Pencil as Ns, Trash2 as ks, ArrowUp as bo, MoreHorizontal as vo, ChevronUp as Jn, AtSign as _s, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ss, ChevronRightIcon as Ts, ArrowRightIcon as Rs, Copy as xo, Filter as Ds, User as Ms, Link as Os, CircleHelp as Is, ChevronsUpDown as yo, Star as As, FunctionSquare as No, SquareSigma as ko, SquareX as Vs, AlertCircle as Wn, CircleCheckIcon as $s, CircleXIcon as Ps, CircleHelpIcon as Ls, ArrowUpIcon as Bs, ArrowDownIcon as zs, ArrowUpDownIcon as js, PanelLeft as Gs, PanelRight as Fs, ScrollText as Hs, MenuIcon as Xs, Menu as Ks, EllipsisVertical as Us, LoaderCircle as Ys, GripVertical as qs } from "lucide-react";
import { clsx as Js } from "clsx";
import { extendTailwindMerge as Ws } from "tailwind-merge";
import * as Ct from "@radix-ui/react-dialog";
import { includes as wn, Section as H, getChaptersForBook as Zs, formatScrRef as Kt, getSectionForBook as He, formatRelativeDate as Qs, formatReplacementString as we, sanitizeHtml as ti, parseParatextHtml as Gr, hasCustomParatextTags as ei, NumberFormat as ni, formatBytes as ri, getCurrentLocale as oi, getFormatCallerFunction as ai, deepEqual as _o, isString as Vn, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import { createEditor as Eo, $getRoot as Jt, $createParagraphNode as Nn, $getSelection as Lt, HISTORY_MERGE_TAG as gr, ParagraphNode as So, TextNode as To, $isTokenOrSegmented as si, $getCharacterOffsets as ii, $cloneWithPropertiesEphemeral as li, $findMatchingParent as wi, $isElementNode as ce, CLEAR_EDITOR_COMMAND as Ro, COMMAND_PRIORITY_EDITOR as Do, $isRangeSelection as Je, shallowMergeConfig as ci, defineExtension as zt, safeCast as nn, RootNode as di, LineBreakNode as pi, TabNode as ui, $isEditorState as mi, createCommand as hi, CLICK_COMMAND as fi, isDOMNode as gi, $getNodeFromDOMNode as bi, $isNodeSelection as vi, $createNodeSelection as xi, $setSelection as yi, COMMAND_PRIORITY_LOW as Ni, DecoratorNode as ki, $create as _i, $getNodeByKey as Ci, INDENT_CONTENT_COMMAND as Fr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as Ei, $createRangeSelection as Si, $normalizeSelection__EXPERIMENTAL as Ti, OUTDENT_CONTENT_COMMAND as Ri, INSERT_TAB_COMMAND as Di, $isBlockElementNode as hn, $isDecoratorNode as Mi, $isParagraphNode as Oi, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Mo, FORMAT_TEXT_COMMAND as Ii, getRegisteredNode as Ai, isHTMLElement as Vi, isDocumentFragment as Hr, isDOMDocumentNode as $i, ArtificialNode__DO_NOT_USE as Oo, $createLineBreakNode as Io, $isRootOrShadowRoot as Pi, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Li } from "lexical";
import * as rn from "@radix-ui/react-tooltip";
import { TooltipTrigger as Bi } from "@radix-ui/react-tooltip";
import { HeadingNode as zi, QuoteNode as ji, registerRichText as Gi } from "@lexical/rich-text";
import { flushSync as Fi, createPortal as Hi } from "react-dom";
import { $isTableSelection as Xi } from "@lexical/table";
...
import { useReactTable as Po, getFilteredRowModel as Ui, getSortedRowModel as Lo, getPaginationRowModel as Yi, getCoreRowModel as Bo, flexRender as Xe, getGroupedRowModel as qi, getExpandedRowModel as Ji } from "@tanstack/react-table";
import * as at from "@radix-ui/react-select";
import Wi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Qn, HIDDEN_NOTE_CALLER as tr, getDefaultViewOptions as Zi, isInsertEmbedOpOfType as Pn, Editorial as Qi } from "@eten-tech-foundation/platform-editor";
...
const ol = Ct.Root, al = Ct.Portal, zo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: m(
...
Fo.displayName = Ct.Title.displayName;
...
sl.displayName = Ct.Description.displayName;
...
ee.displayName = ft.List.displayName;
...
function* pl() {
  for (let e = 1; e <= he.length; e++) yield e;
}
const ul = 1, Yo = he.length;
function ml() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function Nr(e, t = "***") {
  const n = e - 1;
  return n < 0 || n >= he.length ? t : he[n];
}
function qo(e) {
...
const ht = class X {
  constructor(t, n, r, a) {
    if (F(this, "firstChapter"), F(this, "lastChapter"), F(this, "lastVerse"), F(this, "hasSegmentsDefined"), F(this, "text"), F(this, "BBBCCCVVVS"), F(this, "longHashCode"), F(this, "versification"), F(this, "rtlMark", "‏"), F(this, "_bookNum", 0), F(this, "_chapterNum", 0), F(this, "_verseNum", 0), F(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        const s = t, i = n != null && n instanceof se ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (t != null && typeof t == "number") {
        const s = n != null && n instanceof se ? n : void 0;
        ...
        if (t != null && t instanceof X) {
          ...
          if (t == null) return;
          const s = t instanceof se ? t : X.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new se(i)), n ? new X(n, r.toString(), l, c) : new X();
  }
  /**
  ...
  set versificationStr(t) {
    this.versification = this.versification != null ? new se(t) : void 0;
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new se(Rt[i]);
        } catch {
...
F(ht, "defaultVersification", se.English), F(ht, "verseRangeSeparator", "-"), F(ht, "verseSequenceIndicator", ","), F(ht, "verseRangeSeparators", [ht.verseRangeSeparator]), F(ht, "verseSequenceIndicators", [ht.verseSequenceIndicator]), F(ht, "chapterDigitShifter", 1e3), F(ht, "bookDigitShifter", ht.chapterDigitShifter * ht.chapterDigitShifter), F(ht, "bcvMaxValue", ht.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
F(ht, "ValidStatusType", Wo);
...
const ta = tn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Oe : "button", { className: m(xl({ variant: t, size: n, className: e })), ref: s, ...a })
);
P.displayName = "Button";
const be = Ee.Root, ve = Ee.Trigger, gp = Ee.Anchor, ne = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
...
function or(e, t, n) {
  return `${e} ${de[e]}${t ? ` ${kr(e, t)} ${_e(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function yl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ d(be, { open: l, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ o(ne, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: /* @__PURE__ */ o(Bt, { heading: s, children: e.map((p) => /* @__PURE__ */ d(
      jt,
      {
        onSelect: () => w(p),
...
function bp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
      ...
      if (i) {
        ...
        if (!p && c) {
          const u = ((g) => Object.keys(de).find(
            (y) => de[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function Jr({
  ...
  if (e)
    return /* @__PURE__ */ o(Bt, { children: /* @__PURE__ */ o("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      jt,
      {
        value: `${e} ${de[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function vp({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, y] = D(""), [x, C] = D("books"), [_, N] = D(void 0), [R, A] = D(!1), E = W(void 0), T = W(void 0), M = W(void 0), k = W(void 0), S = W({}), V = z(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
  ), B = L(() => r ? r() : Qo, [r]), G = L(() => ({
    [H.OT]: B.filter((j) => Y.isBookOT(j)),
    [H.NT]: B.filter((j) => Y.isBookNT(j)),
    [H.DC]: B.filter((j) => Y.isBookDC(j)),
    [H.Extra]: B.filter((j) => Y.extraBooks().includes(j))
  }), [B]), I = L(() => Object.values(G).flat(), [G]), Z = L(() => {
    if (!g.trim()) return G;
    const v = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    return [H.OT, H.NT, H.DC, H.Extra].forEach((Q) => {
      v[Q] = G[Q].filter((ct) => _r(ct, g, a));
    }), v;
  }, [G, g, a]), O = L(
    () => kl(g, I, a),
    [g, I, a]
    ...
    (v) => {
      const j = x === "chapters" ? _ : O == null ? void 0 : O.book;
      j && (V({
        book: j,
        chapterNum: v,
        verseNum: 1
      }), f(!1), C("books"), N(void 0), y(""));
    },
    [V, x, _, O]
  ), bt = z(
    (v) => {
    ...
    (v) => {
      ...
      f(v), v && (C("books"), N(void 0), y(""));
    },
    [x, tt]
  ), { otLong: wt, ntLong: Nt, dcLong: Ft, extraLong: vt } = {
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: j, isDigit: Q } = qr(v.key);
      if (x === "chapters") {
        if (v.key === "Backspace") {
        ...
        if (j || Q) {
          if (v.preventDefault(), v.stopPropagation(), C("books"), N(void 0), Q && _) {
            const ct = de[_];
            y(`${ct} ${v.key}`);
          } else
            y(v.key);
      ...
      if ((x === "chapters" || x === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ct = x === "chapters" ? _ : O == null ? void 0 : O.book;
        if (!ct) return;
        const mt = (() => {
          if (!h) return 1;
          const Be = h.match(/(\d+)$/);
        ...
        switch (v.key) {
          case "ArrowLeft":
            mt !== 0 && (It = mt > 1 ? mt - 1 : oe);
            break;
          case "ArrowRight":
            mt !== 0 && (It = mt < oe ? mt + 1 : 1);
            break;
          case "ArrowUp":
            It = mt === 0 ? oe : Math.max(1, mt - Pr);
            break;
          case "ArrowDown":
            It = mt === 0 ? 1 : Math.min(oe, mt + Pr);
            break;
          default:
            return;
        }
        It !== mt && (v.preventDefault(), v.stopPropagation(), u(or(ct, a, It)), setTimeout(() => {
          const Be = S.current[It];
    ...
    const { isLetter: j, isDigit: Q } = qr(v.key);
    (j || Q) && (v.preventDefault(), y((ct) => ct + v.key), T.current.focus(), A(!1));
  }, []);
  return Pt(() => {
    const v = setTimeout(() => {
      if (p && x === "books" && M.current && k.current) {
        const j = M.current, Q = k.current, ct = Q.offsetTop, mt = j.clientHeight, oe = Q.clientHeight, It = ct - mt / 2 + oe / 2;
        j.scrollTo({
          top: Math.max(0, It),
          behavior: "smooth"
        }), u(or(e.book));
    ...
    if (x === "chapters" && _) {
      ...
      setTimeout(() => {
        if (M.current)
          if (v) {
            const j = S.current[e.chapterNum];
  ...
  }, [x, _, O, e.book, e.chapterNum]), /* @__PURE__ */ d(be, { open: p, onOpenChange: dt, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      P,
      {
        ...
        children: /* @__PURE__ */ o("span", { className: "tw-truncate", children: ye })
      }
    ) }),
      ...
      te,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: v, disabled: j, title: Q, icon: ct }) => /* @__PURE__ */ o(
              P,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              P,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ o(fs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(gs, { className: "tw-h-4 tw-w-4" })
              }
            ),
            _ && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: _e(_, a) })
          ] }),
          !R && /* @__PURE__ */ d(ee, { ref: M, children: [
            x === "books" && /* @__PURE__ */ d(st, { children: [
              !O && Object.entries(Z).map(([v, j]) => {
                if (j.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Bt, { heading: Mn(v), children: j.map((Q) => /* @__PURE__ */ o(
                      ta,
                      {
                        bookId: Q,
                        onSelect: (ct) => yt(ct),
              ...
              O && /* @__PURE__ */ o(Bt, { children: /* @__PURE__ */ o(
                jt,
                {
                  ...
                  children: Kt(
                    ...
                    a ? kr(O.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              O && Dt(O.book) > 1 && /* @__PURE__ */ d(st, { children: [
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Co.Root, { ref: n, className: m("pr-twp", Cl(), e), ...t }));
...
function ar({
  ...
  const [_, N] = D(!1), R = c ?? l, A = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], E = (T, M) => {
    const k = l(T), S = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${M ?? ""}${k}${S ?? ""}`;
    return /* @__PURE__ */ d(
      jt,
      {
        value: k,
  ...
  return /* @__PURE__ */ d(be, { open: _, onOpenChange: N, ...C, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ d(
      P,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ o(me, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ o(on, { children: h }),
          /* @__PURE__ */ o(ee, { children: A(t) ? t.map((T) => /* @__PURE__ */ o(Bt, { heading: T.groupHeading, children: T.options.map((M) => E(M, T.groupHeading)) }, T.groupHeading)) : t.map((T) => E(T)) })
        ] })
      }
    )
  ] });
...
const kp = [
  ...
  "%no_comments%"
], Rl = ["input", "select", "textarea", "button"], Dl = ["button", "textbox"], Ml = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
}) => {
  const a = W(null), [s, i] = D(void 0), [l, c] = D(void 0), w = z(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Rl.includes(g)) return !0;
    const y = u.getAttribute("role");
    if (y && Dl.includes(y)) return !0;
    const x = u.getAttribute("tabindex");
    return x !== void 0 && x !== "-1";
  }, h = z(
    (u) => {
      var T;
      const g = u.target, y = (M) => M ? document.getElementById(M) : void 0, x = y(l), C = y(s);
      if (!!(x && g && x.contains(g) && g !== x) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const k = M.findIndex((V) => V === g);
          if (k === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(k + 1, M.length - 1) : S = Math.max(k - 1, 0), S !== k && (u.preventDefault(), u.stopPropagation(), (T = M[S]) == null || T.focus());
          return;
        }
        return;
      }
      const R = e.findIndex((M) => M.id === s);
      let A = R;
      switch (u.key) {
        case "ArrowDown":
          A = Math.min(R + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(R - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = na ? Pt : q, cn = { tag: gr };
function Al({ initialConfig: e, children: t }) {
  const n = L(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Ol(null, r), p = Eo({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Nn();
            u.append(g);
            const y = na ? document.activeElement : null;
            (Lt() !== null || y !== null && y === f.getRootElement()) && g.select();
          }
        }, cn);
...
const Vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function $l({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  const [r] = Ot();
  return Vl(() => {
...
const Er = {
  ...
  mark: "",
  markOverlap: ""
}, Vt = rn.Provider, Ut = rn.Root, pe = rn.Trigger, $t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  rn.Content,
  {
    ref: r,
    sideOffset: t,
...
$t.displayName = rn.Content.displayName;
const Sr = [
  zi,
  So,
  To,
...
class Ll extends us {
  ...
  componentDidUpdate(t, n) {
    ...
    if (r && n.error !== null && Bl(t.resetKeys, a)) {
      var s, i;
...
function zl({ children: e, onError: t }) {
  return o(Ll, { fallback: o("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
const jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function Gl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Fl() {
  return function(e) {
    const [t] = Ot(), n = L(() => e(t), [t, e]), [r, a] = D(() => n.initialValueFn()), s = W(r);
    return jl(() => {
...
function Hl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !si(t) && r !== null) {
    ...
    if (w || p) {
      const [f, h] = ii(e), u = l.is(c), g = t.is(i ? c : l), y = t.is(i ? l : c);
      let x, C = 0;
      u ? (C = f > h ? h : f, x = f > h ? f : h) : g ? (C = i ? h : f, x = void 0) : y && (C = 0, x = i ? f : h);
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Kl = ra && "documentMode" in document ? document.documentMode : null;
!(!ra || !("InputEvent" in window) || Kl) && "getTargetRanges" in new window.InputEvent("input");
function oa(...e) {
  const t = [];
...
function Wr(e) {
  const t = wi(e, (n) => ce(n) && !n.isInline());
  return ce(t) || Xl(4, e.__key), t;
}
function Yl(e, t) {
  const n = [];
...
ut.prototype.brand = ql, ut.prototype.h = function() {
  return !0;
...
} }), ie.prototype = new ut(), ie.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), to(this), Yt++;
  const e = K;
  return K = this, Zl.bind(this, e);
...
function wa() {
  const e = Jt(), t = Lt(), n = Nn();
  e.clear(), e.append(n), t !== null && n.select(), Je(t) && (t.format = 0);
}
function ca(e, t = wa) {
  return e.registerCommand(Ro, (n) => (e.update(t), !0), Do);
}
zt({ build: (e, t, n) => Cn(t), config: nn({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const ir = zt({ build: (e) => da(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, ua = 2, jn = 3, dn = 4, Ne = 5, Gn = 6, je = 7;
function Fn(e) {
  return e.id === Rr;
}
function ma(e) {
...
class nw {
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== dn && J(307, String(n.id), String(Ne)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Gn && J(310, String(n.id), String(Gn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= je;
    }(t) || J(316, String(t.id), String(je)), t;
  }
...
const ow = zt({ config: nn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = rw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [di, To, pi, ui, So] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function aw(e) {
  throw e;
...
class Ue {
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== r && J(298, r.name), !a) {
      a = new nw(this, r), this.extensionNameMap.set(r.name, a);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Fn(s) || J(300, i, a || "[unknown]"), Fn(l = s) || J(304, String(l.id), String(Rr)), s = Object.assign(l, { id: lr }), r.state = s;
      const c = this.outgoingConfigEdges.get(i);
      if (c) for (const w of c.keys()) {
        const p = this.extensionNameMap.get(w);
        p && n(p, i);
      }
      s = tw(s), r.state = s, t.push(r);
    };
  ...
  buildCreateEditorArgs() {
    ...
    return t.onError || (t.onError = aw), t;
  }
}
const sw = /* @__PURE__ */ new Set(), oo = zt({ build(e, t, n) {
...
class Se extends ki {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: iw, priority: 0 }) };
  }
  exportDOM() {
...
zt({ dependencies: [ir, oo], name: "@lexical/extension/HorizontalRule", nodes: [Se], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(oo).output, a = We({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return Wt(e.registerCommand(fi, (i) => {
    if (gi(i.target)) {
      const l = bi(i.target);
      if (lw(l)) return function(c, w = !1) {
        const p = Lt(), f = c.isSelected(), h = c.getKey();
        let u;
        w && vi(p) ? u = p : (u = xi(), yi(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Ni), e.registerMutationListener(Se, (i, l) => {
    Jl(() => {
      let c = !1;
      ...
      for (const [p, f] of i.entries()) if (f === "destroyed") w.delete(p), c = !0;
        ...
        h ? h.domNode.value = u : (c = !0, w.set(p, { domNode: We(u), selectedSignal: r(p) }));
      }
    ...
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(Zt(() => {
      const w = l.value;
      w && (c.value ? aa(w, s) : Ul(w, s));
    }));
    return Wt(...i);
  }));
} });
function ww(e, t) {
  return Wt(e.registerCommand(Ei, (n) => {
    const r = Lt();
    if (!Je(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      const i = s.getNodes();
      if (Yl(i, (h) => hn(h) && h.canIndent() ? h : null).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), f = Wr(p);
      if (f.canIndent()) {
        const h = f.getKey();
        let u = Si();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Ti(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Ri : Fr : Di;
    return e.dispatchCommand(a, void 0);
  }, Do), e.registerCommand(Fr, () => {
...
zt({ build: (e, t, n) => Cn(t), config: nn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  ...
  return Zt(() => {
    if (!r.value) return ww(e, a);
  });
} });
const cw = zt({ name: "@lexical/react/ReactProvider" });
function dw() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                const y = g.anchor;
                let x = y.getNode(), C = 0, _ = 0;
                if (fn(x) && w >= 0 && p >= 0 && (C = w, _ = w + p, g.setTextNodeRange(x, C, x, _)), C === _ && f === "" || (g.insertRawText(f), x = y.getNode()), fn(x)) {
                  C = h, _ = h + u;
                  const N = x.getTextContentSize();
                  C = C > N ? N : C, _ = _ > N ? N : _, g.setTextNodeRange(x, C, x, _);
                }
...
zt({ build: (e, t, n) => Cn(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Zt(() => n.getOutput().disabled.value ? void 0 : ga(e)) });
function mw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function hw({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (h) => n._onError(h), children: o(ms, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
        f !== null && i.push(Hi(p, f, w));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
}
function fw({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    const r = Ue.maybeFromEditor(n);
    if (r && r.hasExtensionByName(cw.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) r.hasExtensionByName(a) && mw(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : o(hw, { editor: e, ErrorBoundary: t });
}
function ao(e) {
  return e.getEditorState().read(fa(e.isComposing()));
}
function gw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = Ot();
  return function(a) {
    Dr(() => Wt(Gi(a), ga(a)), [a]);
  }(r), d(st, { children: [e, o(bw, { content: t }), o(fw, { editor: r, ErrorBoundary: n })] });
}
function bw({ content: e }) {
...
function vw({ defaultSelection: e }) {
  const [t] = Ot();
  return q(() => {
    t.focus(() => {
...
const xw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function yw({ onClear: e }) {
  const [t] = Ot();
  return xw(() => ca(t, e), [t, e]), null;
}
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : q;
function Nw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: C = !0, style: _, tabIndex: N, "data-testid": R, ...A }, E) {
  const [T, M] = D(e.isEditable()), k = z((V) => {
    V && V.ownerDocument && V.ownerDocument.defaultView ? e.setRootElement(V) : e.setRootElement(null);
  }, [e]), S = L(() => /* @__PURE__ */ function(...V) {
    return (B) => {
      for (const G of V) typeof G == "function" ? G(B) : G != null && (G.current = B);
    };
  }(E, k), [k, E]);
  return ba(() => (M(e.isEditable()), e.registerEditableListener((V) => {
    M(V);
  })), [e]), o("div", { "aria-activedescendant": T ? t : void 0, "aria-autocomplete": T ? n : "none", "aria-controls": T ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": T && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": T ? f : void 0, "aria-readonly": !T || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: T, "data-testid": R, id: y, ref: S, role: x, spellCheck: C, style: _, tabIndex: N, ...A });
}
const kw = tn(Nw);
function so(e) {
  return e.getEditorState().read(fa(e.isComposing()));
...
function Cw(e, t) {
  ...
  return d(st, { children: [o(kw, { editor: a, ...r, ref: t }), n != null && o(Ew, { editor: a, content: n })] });
}
function Ew({ content: e, editor: t }) {
  ...
  if (Pt(() => (a(t.isEditable()), t.registerEditableListener((i) => {
    a(i);
  })), [t]), !n) return null;
  let s = null;
...
function Rw() {
  const [e, t] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(jo, { children: [
      /* @__PURE__ */ o(Go, { children: /* @__PURE__ */ o(Fo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Dw({
  ...
  const [t] = Ot(), [n, r] = D(t), [a, s] = D("paragraph"), [i, l] = Rw(), c = () => {
  };
...
), Ow = b.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  Ao.Root,
  {
    ref: a,
    className: m(ya({ variant: t, size: n, className: e })),
    ...r
  }
));
Ow.displayName = Ao.Root.displayName;
...
Mr.displayName = kn.Root.displayName;
...
const io = [
  ...
  { format: "underline", icon: xs, label: "Underline" },
  { format: "strikethrough", icon: ys, label: "Strikethrough" }
];
function Iw() {
  const { activeEditor: e } = xa(), [t, n] = D([]), r = z((a) => {
    if (Je(a) || Xi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function Vw({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Dw, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Iw, {}) }) }),
      ...
      /* @__PURE__ */ o(
        gw,
        {
          contentEditable: /* @__PURE__ */ o("div", { ref: (s) => {
            s !== void 0 && r(s);
          }, children: /* @__PURE__ */ o(Sw, { placeholder: e }) }),
          ErrorBoundary: zl
        }
      ),
      t && /* @__PURE__ */ o(vw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ o(Aw, { onClear: n }),
      /* @__PURE__ */ o(yw, {})
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Al,
    {
      ...
      children: /* @__PURE__ */ d(Vt, { children: [
        /* @__PURE__ */ o(Vw, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ o(
          $l,
          {
...
function Pw(e, t) {
  const n = $i(t) ? t.body.childNodes : t.childNodes;
  let r = [];
  const a = [];
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Oo && i.insertAfter(Io());
    for (const i of s) {
...
function ka(e, t, n, r = null) {
  ...
  const s = ce(t) && t.excludeFromCopy("html");
  let i = t;
  r !== null && fn(t) && (i = Hl(r, t, "clone"));
  const l = ce(i) ? i.getChildren() : [], c = Ai(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = ka(e, g, h, r);
    !a && ce(t) && y && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(p) || Hr(p)) && p.append(h), n.append(p), f) {
      const u = f.call(i, p);
...
function Ca(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, y) {
    const { nodeName: x } = g, C = y._htmlConversions.get(x.toLowerCase());
    let _ = null;
    if (C !== void 0) for (const N of C) {
      const R = N(g);
      R !== null && (_ === null || (_.priority || 0) <= (R.priority || 0)) && (_ = R);
    }
  ...
  let h = [];
  const u = (l == null || !Pi(l)) && (l != null && hn(l) || r);
  for (let g = 0; g < f.length; g++) h.push(...Ca(f[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Xr(e) && (h = Bw(e, h, u ? () => {
    const g = new Oo();
    return n.push(g), g;
  } : Nn)), l == null ? h.length > 0 ? i = i.concat(h) : Xr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Kr(g.nextSibling) && Kr(g.previousSibling);
  }(e) && (i = i.concat(Io())) : ce(l) && l.append(...h), i;
}
function Bw(e, t, n) {
...
function jw(e) {
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(t, "text/html"), i = Pw(n, s);
      Jt().clear(), Li(i);
    },
    {
      discrete: !0
...
const Gw = Qt(
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: m("pr-twp", Gw({ variant: t }), e), ...n })
);
...
const Xw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
Re.displayName = $o.Root.displayName;
...
Ra.displayName = Ie.Root.displayName;
...
Uw.displayName = Ie.Image.displayName;
...
Da.displayName = Ie.Fallback.displayName;
const Or = xn(void 0);
function St() {
  const e = fr(Or);
  if (!e)
...
}), $e = et.Trigger, Ma = et.Group, Yw = et.Portal, qw = et.Sub, Jw = et.RadioGroup;
function xe({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Or.Provider, { value: n, children: /* @__PURE__ */ o(et.Root, { ...t }) });
}
...
Ia.displayName = et.SubContent.displayName;
...
Pe.displayName = et.Separator.displayName;
...
function lo({
  ...
  const [f, h] = D(!1), [u, g] = D(), [y, x] = D(!1), C = W(null);
  q(() => {
    let k = !0;
    if (!r) {
      x(!1);
  ...
  const _ = z(() => {
    ...
    return we(n["%comment_dateAtTime%"], {
      date: S,
      time: V
    });
  }, [e.date, n]), A = L(() => e.user, [e.user]), E = L(
    () => e.user.split(" ").map((k) => k[0]).join("").toUpperCase().slice(0, 2),
    [e.user]
  ), T = L(
    () => ti(Gr(e.contents)),
    [e.contents]
    ...
    if (r && y)
      return /* @__PURE__ */ d(st, { children: [
        !ei(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g(jw(Gr(e.contents))), c == null || c(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d(
          bn,
          {
            ...
            children: [
              /* @__PURE__ */ o(ks, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ra, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Da, { className: "tw-text-xs tw-font-medium", children: E }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-font-medium", children: A }),
          ...
          f && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: C,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), _()) : k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), Ht(u) && N());
              },
              onKeyDown: (k) => {
        ...
        r && p && !t && a !== "Resolved" && s && /* @__PURE__ */ o(
          P,
          {
            ...
            onClick: (k) => {
              k.stopPropagation(), s({ threadId: e.thread, status: "Resolved" });
            },
            children: /* @__PURE__ */ o(Mt, {})
          }
        ),
        M && /* @__PURE__ */ d(xe, { children: [
          /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(P, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
          /* @__PURE__ */ o(re, { align: "end", children: M })
        ] })
      ]
    }
  );
...
function Zw({
  ...
  const [C, _] = D(wo), [N, R] = D(!1), [A, E] = D(!1), [T, M] = D(!1), [k, S] = D(!1), [V, B] = D(!1), [G, I] = D(void 0), [Z, O] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      O(!1), yt(!1);
  ...
  const _t = L(() => e.filter((v) => !v.deleted), [e]), bt = L(() => _t[0], [_t]), $ = W(null), tt = W(void 0), dt = z(() => {
    var v;
    (v = tt.current) == null || v.call(tt), _(wo);
  }, []);
  q(() => {
    const v = $.current;
    if (!v) return;
  ...
  const wt = L(
    ...
    const v = mn(a, t);
    return we(t["%comment_assigned_to%"], {
      assignedUser: v
    });
  }, [a, t]), Ft = L(() => _t.slice(1), [_t]), vt = L(() => Ft.length ?? 0, [Ft.length]), Mn = L(() => vt > 0, [vt]), On = L(() => T || vt <= 2 ? Ft : Ft.slice(-2), [Ft, vt, T]), ye = L(() => T || vt <= 2 ? 0 : vt - 2, [vt, T]), sn = L(
    () => vt === 1 ? wt.singleReply : we(wt.multipleReplies, { count: vt }),
    [vt, wt]
  ), In = L(
    () => ye === 1 ? wt.singleReply : we(wt.multipleReplies, { count: ye }),
    [ye, wt]
  ), ln = z(async () => {
    const v = Ht(C) ? cr(C) : void 0;
    if (G !== void 0) {
      await w({
        threadId: l,
        contents: v,
    ...
    async (v) => {
      const j = Ht(C) ? cr(C) : void 0, Q = await w({
        ...v,
        contents: j,
        assignedUser: G ?? v.assignedUser
      });
      return Q && j && dt(), Q && G !== void 0 && I(void 0), Q;
    },
    [dt, C, w, G]
  );
  return /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            /* @__PURE__ */ d(
              "p",
              {
                ...
                className: m(
                  ...
                  {
                    "tw-overflow-visible tw-text-clip tw-whitespace-normal tw-break-words": N
                  },
                  { "tw-whitespace-nowrap": !N }
                ),
                children: [
                  r,
                  " ",
            ...
            A && /* @__PURE__ */ o(
              P,
              {
                ...
                size: "icon",
                onClick: (v) => {
                  v.stopPropagation(), R(!N);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": N ? "Collapse text" : "Expand text",
                children: N ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(me, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ d(st, { children: [
            ye > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (v) => {
                  (v.key === "Enter" || v.key === " ") && (v.preventDefault(), v.stopPropagation(), M(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(Re, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    T ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(me, {})
                  ] })
                ]
              }
            ),
            On.map((v) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              lo,
              {
                comment: v,
                localizedStrings: t,
            ...
            u !== !1 && (!k || Ht(C)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Ht(C) || G !== void 0) && ln());
                },
                onKeyDown: (v) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    G !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: we(
                    ...
                    /* @__PURE__ */ d(be, { open: V, onOpenChange: B, children: [
                      /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
                        P,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !Z || !h || h.length === 0 || !h.includes(s),
                      ...
                      /* @__PURE__ */ o(
                        ne,
                        {
                          ...
                          children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: h == null ? void 0 : h.map((v) => /* @__PURE__ */ o(
                            jt,
                            {
                              onSelect: () => {
                                I(v !== a ? v : void 0), B(!1);
...
function _p({
  ...
  const [h, u] = D(), g = t.filter(
    ...
    u(E);
  }, []), { listboxRef: _, activeId: N, handleKeyDown: R } = Ml({
    options: y,
    onOptionSelect: x
  }), A = z(
    (E) => {
      E.key === "Escape" ? (u(void 0), E.preventDefault(), E.stopPropagation()) : R(E);
    },
    [R]
  );
  return /* @__PURE__ */ o(
...
function Qw({ table: e }) {
  return /* @__PURE__ */ d(xe, { children: [
    /* @__PURE__ */ o(Ki, { asChild: !0, children: /* @__PURE__ */ d(P, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Cs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const De = at.Root, tc = at.Group, Me = at.Value, ec = Qt(
...
), fe = b.forwardRef(({ className: e, children: t, size: n, ...r }, a) => {
  const s = lt();
  return /* @__PURE__ */ d(
    at.Trigger,
    {
      className: m(ec({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(me, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
fe.displayName = at.Trigger.displayName;
...
Va.displayName = at.ScrollUpButton.displayName;
const $a = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.ScrollDownButton,
  {
    ...
    className: m("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ o(me, { className: "tw-h-4 tw-w-4" })
  }
));
$a.displayName = at.ScrollDownButton.displayName;
const ge = b.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = lt();
...
ge.displayName = at.Content.displayName;
...
nc.displayName = at.Label.displayName;
const kt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  at.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(at.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
...
rc.displayName = at.Separator.displayName;
function oc({ table: e }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        De,
        {
          ...
          children: [
            /* @__PURE__ */ o(fe, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Me, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(ge, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(kt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
function Ze(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ac(r)
  );
}
...
const ue = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "td",
  {
    ref: n,
...
const cc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "caption",
  {
    ref: n,
...
function dc({
  ...
  var E;
  const [p, f] = D([]), [h, u] = D([]), [g, y] = D({}), [x, C] = D({}), _ = L(() => t ?? [], [t]), N = Po({
    data: _,
    columns: e,
    getCoreRowModel: Bo(),
  ...
  let A;
  return c ? A = Array.from({ length: 10 }).map((k, S) => `skeleton-row-${S}`).map((k) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ue, { colSpan: R.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((E = N.getRowModel().rows) == null ? void 0 : E.length) > 0 ? A = N.getRowModel().rows.map((T) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(T, N),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((M) => /* @__PURE__ */ o(ue, { children: Xe(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    T.id
  )) : A = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(ue, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Qw, { table: N }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: N.getHeaderGroups().map((T) => /* @__PURE__ */ o(At, { children: T.headers.map((M) => /* @__PURE__ */ o(Qe, { children: M.isPlaceholder ? void 0 : Xe(M.column.columnDef.header, M.getContext()) }, M.id)) }, T.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(P, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(xo, {}) })
        ] }),
...
function Sp({
  ...
  return /* @__PURE__ */ d(be, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: r }),
    /* @__PURE__ */ d(ne, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function Tp({ id: e, label: t, groups: n }) {
  const [r, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(xe, { children: [
    /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ d(P, { variant: "default", children: [
      /* @__PURE__ */ o(Ds, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(me, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(re, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ o(an, { children: w.label }),
      /* @__PURE__ */ o(Ma, { children: w.itemType === 0 ? /* @__PURE__ */ o(st, { children: w.items.map((f, h) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        qt,
        {
          checked: r[p][h],
        ...
        Jw,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Aa, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ o(Pe, {})
    ] }, w.label)) })
...
function Dp({
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(hc, { versionHistory: a }),
...
function fc({
  ...
  const [C, _] = D(!1), N = z(
    (S) => {
      var B;
      const V = (B = e.find((G) => G.label === S)) == null ? void 0 : B.value;
      V && n(
        t.includes(V) ? t.filter((G) => G !== V) : [...t, V]
      );
    },
    [e, t, n]
  ), R = () => c || r, A = L(() => {
    if (!h) return e;
    const S = e.filter((B) => B.starred).sort((B, G) => B.label.localeCompare(G.label)), V = e.filter((B) => !B.starred).sort((B, G) => {
      const I = t.includes(B.value), Z = t.includes(G.value);
      return I && !Z ? -1 : !I && Z ? 1 : B.label.localeCompare(G.label);
    });
    return [...S, ...V];
  }, [e, t, h]), E = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: x, className: g, children: /* @__PURE__ */ d(be, { open: M, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ d(
      P,
      {
        variant: y,
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: E, children: s }),
        /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: T, children: i })
      ] }),
        ...
        /* @__PURE__ */ o(Bt, { children: A.map((S) => /* @__PURE__ */ d(
          jt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(As, { className: "tw-h-4 tw-w-4" }),
...
const gc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(st, { children: [
...
function bc({
  ...
  const s = W(null), i = W(null), l = W(!1), [c, w] = D(e), [p, f] = D(n), [h, u] = D(!1);
  q(() => {
    w(e);
  }, [e]), q(() => {
    p !== n && f(n);
  ...
  const g = (x) => {
    ...
    var C, _, N, R;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((C = s.current) == null || C.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((_ = i.current) == null || _.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((N = s.current) == null ? void 0 : N.selectionStart) === 0 && ((R = i.current) == null || R.focus(), l.current = !1), c === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(xe, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ut, { children: [
      /* @__PURE__ */ o(pe, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(P, { variant: "outline", className: "tw-h-6", children: gc(e, a, n) }) }) }),
...
const vc = (e, t) => e === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o(No, {}),
  " ",
  ...
  return e === "f" && (n = t["%footnoteEditor_noteType_footnote_label%"]), we(t["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function yc({
  ...
  return /* @__PURE__ */ d(xe, { children: [
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ut, { children: [
      /* @__PURE__ */ o(Bi, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(
        P,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: xc(e, n) }) })
    ] }) }),
...
function Op({
  ...
  const l = W(null), c = hs(), [w, p] = D("generated"), [f, h] = D("*"), [u, g] = D("f"), y = L(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (R && Pn("note", R)) {
      const T = (A = R.insert.note) == null ? void 0 : A.caller;
      let M = "custom";
      T === Qn ? M = "generated" : T === tr ? M = "hidden" : T && h(T), p(M), g(((E = R.insert.note) == null ? void 0 : E.style) ?? "f"), R.insert.note && (R.insert.note.caller = ""), N = setTimeout(() => {
        var k;
        (k = l.current) == null || k.applyUpdate([{ delete: 1 }, R]);
      }, 0);
    }
    return () => {
      N && clearTimeout(N);
  ...
  const x = z(() => {
    var R, A;
    const N = (A = (R = l.current) == null ? void 0 : R.getNoteOps(0)) == null ? void 0 : A.at(0);
    N && Pn("note", N) && (N.insert.note && (w === "custom" ? N.insert.note.caller = f : N.insert.note.caller = w === "generated" ? Qn : tr), t([N]));
  }, [w, f, t]), C = () => {
    var R;
    const N = (R = c.current) == null ? void 0 : R.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ o(
          yc,
          {
            ...
            handleNoteTypeChange: (N) => {
              var A, E, T;
              g(N);
              const R = (E = (A = l.current) == null ? void 0 : A.getNoteOps(0)) == null ? void 0 : E.at(0);
              R && Pn("note", R) && (R.insert.note && (R.insert.note.style = N), (T = l.current) == null || T.applyUpdate([{ delete: 1 }, R]));
            },
            localizedStrings: i
          }
        ),
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ut, { children: [
          /* @__PURE__ */ o(pe, { asChild: !0, children: /* @__PURE__ */ o(P, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(en, {}) }) }),
          /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: i["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ut, { children: [
          /* @__PURE__ */ o(pe, { asChild: !0, children: /* @__PURE__ */ o(
            P,
            {
              onClick: x,
          ...
          /* @__PURE__ */ o($t, { children: i["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o(Qi, { options: y, onScrRefChange: () => {
          }, scrRef: r, ref: l }),
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ d(Ut, { children: [
            /* @__PURE__ */ o(pe, { asChild: !0, children: /* @__PURE__ */ o(P, { onClick: C, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(xo, {}) }) }),
            /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: i["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
...
function _c({
  ...
  /* @__PURE__ */ d("span", { className: m("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), f = i && /* @__PURE__ */ d(st, { children: [
    Ir(e.marker, [i], r, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = r ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = m(h, u);
  return /* @__PURE__ */ d(st, { children: [
    /* @__PURE__ */ d("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      c,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: m("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: f }),
    /* @__PURE__ */ o(
      "div",
      {
        className: m(
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(st, { children: Nc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Ap({
  ...
  const p = c ?? ai(n, void 0), f = (_, N) => {
    w == null || w(_, N, a);
  }, h = s ? n.findIndex((_) => _ === s) : -1, [u, g] = D(h), y = (_, N, R) => {
    if (n.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), w == null || w(N, R, a);
          break;
      }
  }, x = (_) => {
    if (n.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), g((N) => Math.min(N + 1, n.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), g((N) => Math.max(N - 1, 0));
          break;
      }
  }, C = W([]);
  return q(() => {
    var _;
    u >= 0 && u < C.current.length && ((_ = C.current[u]) == null || _.focus());
  }, [u]), /* @__PURE__ */ o(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((_, N) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              N < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Re, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
  ...
  return /* @__PURE__ */ d(En, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      At,
      {
        ...
        children: [
          /* @__PURE__ */ o(ue, { children: `${Y.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ o(ue, { children: Cc(i.text) })
        ]
      },
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(zs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Vp = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => /* @__PURE__ */ d(P, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] })
}), Sc = (e, t) => ({
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ d(P, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ d(P, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    Rn(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
...
function Gp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), y = Tt(n, "%webView_inventory_scope_currentBook%"), x = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), N = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), R = Tt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [T, M] = D("all"), [k, S] = D(""), [V, B] = D([]), G = L(() => {
    const $ = e ?? [];
    return $.length === 0 ? [] : Dc($, a, s);
  }, [e, a, s]), I = L(() => {
    if (A) return G;
    const $ = [];
    return G.forEach((tt) => {
      const dt = tt.items[0], wt = $.find(
        (Nt) => Nt.items[0] === dt
      );
      wt ? (wt.count += tt.count, wt.occurrences = wt.occurrences.concat(tt.occurrences)) : $.push({
        items: [dt],
        count: tt.count,
  ...
  }, [A, G]), Z = L(() => I.length === 0 ? [] : Rc(I, T, k), [I, T, k]), O = L(() => {
    var dt, wt;
    if (!A) return c;
    const $ = (dt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : dt.length;
    if (!$) return c;
    const tt = [];
    for (let Nt = 0; Nt < $; Nt++)
      tt.push(
  ...
  const ot = ($, tt) => {
    ...
    if (I.length === 0 || V.length === 0) return [];
    const $ = I.filter((tt) => _o(
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        De,
        {
          ...
          defaultValue: T,
          children: [
            /* @__PURE__ */ o(fe, { className: "tw-m-1", children: /* @__PURE__ */ o(Me, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(De, { onValueChange: ($) => yt($), defaultValue: i, children: [
        /* @__PURE__ */ o(fe, { className: "tw-m-1", children: /* @__PURE__ */ o(Me, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ge, { children: [
          /* @__PURE__ */ o(kt, { value: "book", children: y }),
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(it, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? N })
      ] })
    ] }),
...
const Mc = "16rem", Oc = "3rem", La = b.createContext(void 0);
function Dn() {
...
const Ba = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), f = t ?? w, h = b.useCallback(
      (N) => {
        const R = typeof N == "function" ? N(f) : N;
        n ? n(R) : p(R);
      },
      [n, f]
    ), u = b.useCallback(() => h((N) => !N), [h]), g = f ? "expanded" : "collapsed", C = lt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", _ = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ o(La.Provider, { value: _, children: /* @__PURE__ */ o(Vt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const za = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Dn();
...
const Ic = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    P,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(Gs, {}) : /* @__PURE__ */ o(Fs, {}),
...
const zc = Qt(
  ...
  ({
    ...
    const c = e ? Oe : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: m(zc({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(pe, { asChild: !0, children: p }),
...
Gc.displayName = "SidebarMenuBadge";
...
function Uc({
  ...
  return /* @__PURE__ */ o(
    za,
    {
      ...
      children: /* @__PURE__ */ d(Ga, { children: [
        /* @__PURE__ */ d(pr, { children: [
          /* @__PURE__ */ o(ur, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Fa, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Ha, { children: /* @__PURE__ */ o(
            Xa,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const Xt = "scrBook", Yc = "scrRef", le = "source", qc = "details", Jc = "Scripture Reference", Wc = "Scripture Book", Ka = "Type", Zc = "Details";
function Qc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? Y.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Xt ? Kt(a.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => Kt(r.start),
      id: Yc,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : Kt(a.start);
      },
      sortingFn: (r, a) => Zn(r.original.start, a.original.start),
      enableGrouping: !1
    },
...
function Kp({
  ...
  const [w, p] = D([]), [f, h] = D([{ id: Xt, desc: !1 }]), [u, g] = D({}), y = L(
  ...
  q(() => {
    if (l) {
      const k = C.getSelectedRowModel().rowsById, S = Object.keys(k);
      if (S.length === 1) {
        const V = y.find((B) => uo(B) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, y, l, C]);
  const _ = a ?? Wc, N = s ?? Ka, R = [
  ...
  }, T = (k, S) => k.getIsGrouped() ? "" : m("banded-row", S % 2 === 0 ? "even" : "odd"), M = (k, S, V) => {
    if (!((k == null ? void 0 : k.length) === 0 || S.depth < V.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          /* @__PURE__ */ o(fe, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Me, {}) }),
          /* @__PURE__ */ o(ge, { position: "item-aligned", children: /* @__PURE__ */ o(tc, { children: R.map((k) => /* @__PURE__ */ o(kt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: C.getHeaderGroups().map((k) => /* @__PURE__ */ o(At, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Qe, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Tn, { children: C.getRowModel().rows.map((k, S) => {
        const V = lt();
        return /* @__PURE__ */ o(
          At,
          {
            ...
            children: k.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== le || !n)))
                return /* @__PURE__ */ o(
                  ue,
                  {
                    className: m(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ d(
                      P,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ o(me, {}),
                          !k.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ o(Ce, {}) : /* @__PURE__ */ o(qn, {})),
                          " ",
...
}), Ua = (e, t, n) => $r(e, t).every((r) => n.includes(r));
function ed({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function nd({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], c = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
  ...
  }, [x, C] = D(!1), [_, N] = D(""), R = W(void 0), A = W(!1);
  if (e.length !== Y.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const E = L(() => Y.allBookIds.filter(
    ...
    (I, Z = !1) => {
      if (!Z || !R.current) {
        n(
          t.includes(I) ? t.filter(($) => $ !== I) : [...t, I]
        ), R.current = I;
        return;
      }
      const O = E.findIndex(($) => $ === R.current), ot = E.findIndex(($) => $ === I);
      if (O === -1 || ot === -1) return;
      const [yt, _t] = [
        Math.min(O, ot),
        Math.max(O, ot)
      ], bt = E.slice(yt, _t + 1).map(($) => $);
      n(
        t.includes(I) ? t.filter(($) => !bt.includes($)) : [.../* @__PURE__ */ new Set([...t, ...bt])]
      );
    },
    [t, n, E]
  ), k = (I) => {
    M(I, A.current), A.current = !1;
  }, S = (I, Z) => {
    I.preventDefault(), M(Z, I.shiftKey);
  }, V = z(
    (I) => {
      const Z = $r(E, I).map((O) => O);
      n(
        Ua(E, I, t) ? t.filter((O) => !Z.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...Z])]
      );
    },
    [t, n, E]
  ), B = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
            ...
            te,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: B, children: c }),
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ d(fo, { children: [
                        /* @__PURE__ */ o(
                          Bt,
                          {
                            heading: Zo(I, h, u, g, y),
                            children: O.map((ot) => /* @__PURE__ */ o(
                              ta,
                              {
                                bookId: ot,
                                isSelected: t.includes(ot),
                                onSelect: () => k(ot),
                                onMouseDown: (yt) => S(yt, ot),
                                section: He(ot),
                                showCheck: !0,
                                localizedBookNames: a,
                        ...
                        Z < Object.values(H).length - 1 && /* @__PURE__ */ o(Ho, {})
                      ] }, I);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Kn ? Kn : mo
      ).map((I) => /* @__PURE__ */ o(Te, { className: "hover:tw-bg-secondary", variant: "secondary", children: _e(I, a) }, I)),
      t.length > Kn && /* @__PURE__ */ o(
        Te,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${t.length - mo} ${f}`
        }
      )
    ] })
  ] });
...
function Yp({
  ...
  const w = ae(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ae(i, "%webView_scope_selector_current_book%"), u = ae(i, "%webView_scope_selector_choose_books%"), g = ae(i, "%webView_scope_selector_scope%"), y = ae(i, "%webView_scope_selector_select_books%"), x = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: C.map(({ value: _, label: N, id: R }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: _, id: R }),
            /* @__PURE__ */ o(it, { htmlFor: R, children: N })
          ] }, R))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(it, { children: y }),
      /* @__PURE__ */ o(
        nd,
        {
          availableBookInfo: r,
...
function qp({
  ...
  return /* @__PURE__ */ d(
    De,
    {
      ...
      children: [
        /* @__PURE__ */ o(fe, { size: a, className: m("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Me,
          {
            placeholder: l[U(t)] ?? t
          }
...
const qa = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(pe, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    bn,
    {
      onClick: () => {
        r(l);
    ...
    /* @__PURE__ */ o(Yw, { children: /* @__PURE__ */ o(Ia, { children: qa(
      e,
      t,
      Ya(e, l.id),
      r
...
function hr({
  ...
  return /* @__PURE__ */ d(xe, { variant: s, children: [
    /* @__PURE__ */ o($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(P, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Xs, {}) }) }),
    /* @__PURE__ */ o(re, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(fo, { children: [
      /* @__PURE__ */ o(Ma, { children: /* @__PURE__ */ o(Vt, { children: qa(t.groups, t.items, c, e) }) }),
...
const ts = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  ...
  return /* @__PURE__ */ o(Or.Provider, { value: a, children: /* @__PURE__ */ o(
    nt.Root,
    {
      ref: r,
      className: m(
  ...
  return /* @__PURE__ */ o(
    nt.Trigger,
    {
      ...
      className: m(
        ...
        // CUSTOM
        "pr-twp",
        Gt({ variant: r.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...t
    }
  ...
  return /* @__PURE__ */ d(
    nt.SubTrigger,
    {
      ...
      className: m(
        ...
        t && "tw-pl-8",
        Gt({ variant: s.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...r,
  ...
  return /* @__PURE__ */ o(
    nt.Item,
    {
      ...
      className: m(
        ...
        t && "tw-pl-8",
        Gt({ variant: a.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...n
...
const Ge = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(Ut, { children: [
      /* @__PURE__ */ o(pe, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        as,
        {
          onClick: () => {
            r(w);
...
function wd({
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var g, y, x, C;
    p.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ge(s, [h, u]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Ge(i, [h, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Ge(l, [h, u]);
        break;
      case "alt+h":
        (C = c.current) == null || C.focus(), Ge(c, [h, u]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ o(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ d(od, { children: [
      /* @__PURE__ */ o(es, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ o(
        os,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Vt, { children: is(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function ou({
  ...
  const w = cd(
    ...
    a && a(g), r && r([g, ...n.filter((y) => y !== g)]), s && n.find((y) => y === g) && s([...n.filter((y) => y !== g)]), f(!1);
  }, u = (g, y) => {
    var C, _, N, R, A, E;
    const x = y !== g ? ((_ = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : _[y]) ?? ((R = (N = e[g]) == null ? void 0 : N.uiNames) == null ? void 0 : R.en) : void 0;
    return x ? `${(A = e[g]) == null ? void 0 : A.autonym} (${x})` : (E = e[g]) == null ? void 0 : E.autonym;
  };
  return /* @__PURE__ */ d("div", { id: c, className: m("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      De,
      {
        ...
        onOpenChange: (g) => f(g),
        children: [
          /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(Me, {}) }),
          /* @__PURE__ */ o(
            ge,
            {
              className: "tw-z-[250]",
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(it, { className: "tw-font-normal tw-text-muted-foreground", children: we(w, {
...
function ls(e, t) {
  var r;
  const n = (r = t == null ? void 0 : t.localizedBookNames) == null ? void 0 : r.get(e.book);
...
function pd(e, t) {
  return Kt(
    ...
    t == null ? void 0 : t.bookChapterSeparator
  );
}
function ud(e, t, n) {
  return Kt(
    ...
    n == null ? void 0 : n.chapterVerseSeparator,
    n == null ? void 0 : n.bookChapterSeparator
  ...
  return /* @__PURE__ */ d("div", { className: m("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ d(
      P,
      {
        ...
        onClick: a,
        className: m("tw-me-2 tw-inline tw-h-4 tw-p-0 tw-text-start", r),
        children: [
          /* @__PURE__ */ o("span", { className: m({ "tw-me-2": i === "allText" }), children: t ? ud(e, t, s) : pd(e, s) }),
          i === "allText" && ho(n, r)
        ]
      }
    ),
...
function su({
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      onClick: n,
      onMouseDown: (y) => {
        y.detail > 1 && y.preventDefault();
      },
      onDoubleClick: p,
      onKeyDown: (y) => {
        document.activeElement === (u == null ? void 0 : u.current) && (y.key === "Enter" || y.key === " ") && (y.preventDefault(), n == null || n());
      },
      ref: u,
      role: "button",
      tabIndex: 0,
      ...
      children: [
        /* @__PURE__ */ d("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": t }), children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
                ...
                children: [
                  /* @__PURE__ */ o(
                    md,
                    {
                      ...
                      onClick: (y) => {
                        y == null || y.stopPropagation(), n(), p == null || p();
                      },
                      className: "tw-whitespace-normal tw-rounded-sm tw-text-xs tw-font-medium"
                    }
                  ),
                  h && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-2 tw-whitespace-normal tw-break-words", children: h }),
                  i && /* @__PURE__ */ o(
                    "div",
                    {
                      className: m(
            ...
            t && l && /* @__PURE__ */ o("div", { className: "tw-p-1", children: /* @__PURE__ */ d(xe, { children: [
              /* @__PURE__ */ o($e, { className: w, asChild: !0, children: /* @__PURE__ */ o(P, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
              /* @__PURE__ */ o(re, { align: "end", children: l })
            ] }) })
          ] }),
          t && c && /* @__PURE__ */ o("div", { className: "tw-ms-1 tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden tw-break-words", children: c })
        ] }),
        w && /* @__PURE__ */ o(
          "div",
          {
...
const hd = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ys, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
), gd = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const vd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
vd.displayName = "AlertDescription";
const lu = rt.Root, wu = rt.Trigger, cu = rt.Group, du = rt.Portal, pu = rt.Sub, uu = rt.RadioGroup, xd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  rt.SubTrigger,
  {
    ref: a,
    className: m(
...
xd.displayName = rt.SubTrigger.displayName;
...
yd.displayName = rt.SubContent.displayName;
const Nd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ o(
  rt.Content,
  {
    ref: n,
    className: m(
...
Nd.displayName = rt.Content.displayName;
...
kd.displayName = rt.Item.displayName;
const _d = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ref: a,
    className: m(
...
const Cd = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  rt.RadioItem,
  {
    ref: r,
    className: m(
...
const Ed = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  rt.Label,
  {
    ref: r,
    className: m(
...
const Sd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  rt.Separator,
  {
    ref: n,
...
Sd.displayName = rt.Separator.displayName;
...
Td.displayName = "ContextMenuShortcut";
...
function Rd({
  ...
  return /* @__PURE__ */ o(ws.Provider, { value: r, children: /* @__PURE__ */ o(
    Et.Root,
    {
...
const mu = Et.Trigger, Dd = Et.Portal, hu = Et.Close, cs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
cs.displayName = Et.Overlay.displayName;
const Md = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Ad.displayName = Et.Title.displayName;
...
Vd.displayName = Et.Description.displayName;
const $d = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  nr.Root,
  {
    ref: r,
    className: m(
...
$d.displayName = nr.Root.displayName;
function fu({
  className: e,
  ...t
}) {
...
Pd.displayName = Fe.Root.displayName;
...
Ld.displayName = rr.Root.displayName;
const xu = gt.Root, Bd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Bd.displayName = gt.List.displayName;
...
zd.displayName = gt.Trigger.displayName;
...
jd.displayName = gt.Content.displayName;
...
export {
  ...
  du as ContextMenuPortal,
  uu as ContextMenuRadioGroup,
  Cd as ContextMenuRadioItem,
  Sd as ContextMenuSeparator,
  Td as ContextMenuShortcut,
  pu as ContextMenuSub,
  ...
  nu as getToolbarOSReservedSpaceClassName,
