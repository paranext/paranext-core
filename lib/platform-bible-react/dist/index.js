...
import { Check as $e, Clock as Io, ChevronsLeft as $o, ChevronsRight as Po, ChevronLeft as Ka, ChevronRight as Ha, ArrowLeft as ys, ArrowRight as ks, ChevronDown as dr, BoldIcon as _s, ItalicIcon as Ns, X as go, AtSign as Mn, Pencil as Cs, Trash2 as Es, ArrowUp as On, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as In, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as $n, FunctionSquare as Pn, SquareSigma as An, Ban as Fs, AlertCircle as qa, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as qs, ArrowDownIcon as Gs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Js, EllipsisVertical as Zs, MoreVertical as Qs } from "lucide-react";
import { Section as Nt, getChaptersForBook as tc, formatScrRef as _e, formatReplacementString as Oe, getSectionForBook as Gr, formatRelativeDate as ec, sanitizeHtml as fo, NumberFormat as Vn, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as Wr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as Ao, compareScrRefs as Ga, scrRefToBBBCCCVVV as Ca, defaultScrRef as Ea, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as Vo, formatReplacementStringToArray as Lo, collectUsjMarkers as dc } from "platform-bible-utils";
import Gt, { useRef as U, useMemo as A, createContext as $r, useContext as wa, useState as _, useEffect as Y, useCallback as j, useImperativeHandle as wc, useLayoutEffect as Zt, Component as uc, createElement as jo, Suspense as pc, forwardRef as Ln, useId as Bo, Fragment as ua } from "react";
import { IconSelector as jn, IconCheck as pa, IconChevronDown as hc, IconChevronUp as gc, IconLayoutSidebar as fc, IconLayoutSidebarRight as mc, IconChevronRight as Bn, IconSearch as vc, IconLoader as bc, IconAlertOctagon as xc, IconAlertTriangle as yc, IconInfoCircle as kc, IconCircleCheck as _c } from "@tabler/icons-react";
import { createEditor as Fn, $getRoot as Pe, $createParagraphNode as Pr, $getSelection as Qt, HISTORY_MERGE_TAG as mo, ParagraphNode as Un, TextNode as Kn, $getPreviousSelection as Nc, $isRangeSelection as me, $caretFromPoint as Cc, $getSiblingCaret as Hn, $getChildCaret as Ec, $getAdjacentChildCaret as Tc, $isChildCaret as Sc, $normalizeCaret as Rc, $setSelectionFromCaretRange as zc, $getCollapsedCaretRange as Dc, $getCaretInDirection as Fo, $splitAtPointCaretNext as Mc, $isTextPointCaret as Oc, $findMatchingParent as qn, $isElementNode as Dr, mergeRegister as Ee, getDOMTextNode as Ic, isHTMLElement as $c, CLEAR_EDITOR_COMMAND as Gn, COMMAND_PRIORITY_EDITOR as vo, shallowMergeConfig as Pc, defineExtension as ne, safeCast as Qe, createState as Ac, FORMAT_TEXT_COMMAND as Wn, $isNodeSelection as Yn, COMMAND_PRIORITY_LOW as Xn, RootNode as Vc, LineBreakNode as Lc, TabNode as jc, $isEditorState as Bc, createCommand as Fc, CLICK_COMMAND as Uc, isDOMNode as Kc, $getNodeFromDOMNode as Hc, $createNodeSelection as qc, $setSelection as Gc, $getEditor as Wc, DecoratorNode as Wa, $getState as Yc, toggleTextFormatType as Uo, TEXT_TYPE_TO_FORMAT as Xc, $setState as Jc, addClassNamesToElement as Jn, $create as Zc, $getNodeByKey as Qc, removeClassNamesFromElement as tl, KEY_TAB_COMMAND as el, $isBlockElementNode as rl, $createRangeSelection as al, $normalizeSelection__EXPERIMENTAL as ol, OUTDENT_CONTENT_COMMAND as nl, INDENT_CONTENT_COMMAND as Ko, INSERT_TAB_COMMAND as il, COMMAND_PRIORITY_CRITICAL as bo, $isDecoratorNode as sl, $isParagraphNode as cl, $isTextNode as Ya, SELECTION_CHANGE_COMMAND as Zn, $insertNodes as ll } from "lexical";
import { HeadingNode as dl, QuoteNode as wl, registerRichText as ul } from "@lexical/rich-text";
import { flushSync as pl, createPortal as hl } from "react-dom";
import { $isTableSelection as gl } from "@lexical/table";
import { createHeadlessEditor as Qn } from "@lexical/headless";
import { $generateHtmlFromNodes as fl, $generateNodesFromDOM as ml } from "@lexical/html";
...
import { useReactTable as ti, getFilteredRowModel as vl, getSortedRowModel as ei, getPaginationRowModel as bl, getCoreRowModel as ri, flexRender as Er, getGroupedRowModel as xl, getExpandedRowModel as yl } from "@tanstack/react-table";
import kl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Xa, HIDDEN_NOTE_CALLER as Ja, getDefaultViewOptions as _l, isInsertEmbedOpOfType as kr, getMarkerMenuItems as Nl, defaultStyleInfo as Cl, Editorial as El } from "@eten-tech-foundation/platform-editor";
...
import { useTheme as Sl } from "next-themes";
...
function Sa({
  ...
  const E = be(), B = zl(), [I, z] = _(!1), [K, W] = _(""), [F, Q] = _(""), [C, tt] = _("books"), [D, M] = _(void 0), [H, it] = _(
    void 0
              ...
              C === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  J,
                  {
                    ...
                    tabIndex: -1,
                    children: E === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ul = di ? Zt : Y, Ur = { tag: mo };
function Kl({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Fl(null, o), w = Fn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Jl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
function Zl(t) {
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ed = wi && "documentMode" in document ? document.documentMode : null;
!(!wi || !("InputEvent" in window) || ed) && "getTargetRanges" in new window.InputEvent("input");
function fe(t) {
  return `${t}px`;
}
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), g = td(t, e);
    var f, x;
...
function cd(t) {
  const e = Qt() || Nc();
  let r;
  if (me(e)) r = Cc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Hn(c, "next"));
    }
    r = r || Ec(Pe(), "previous").getFlipped().insert(Pr());
  }
  const o = ld(t, r), n = Tc(o), i = Sc(n) ? Rc(n) : o;
  return zc(Dc(i)), t.getLatest();
}
function ld(t, e, r) {
  let o = Fo(e, "next");
  for (let n = o; n; n = Mc(n, r)) o = n;
  return Oc(o) && ra(283), o.insert(t.isInline() ? Pr().append(t) : t), Fo(Hn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = Qt();
  if (!me(e)) return !1;
...
let aa, Ne = 0, oa = 0, pd = 0, eo = 0, Xr = 0;
function rn(t) {
  if (ct === void 0) return;
  let e = t.n;
...
qt.prototype.brand = wd, qt.prototype.h = function() {
  return !0;
...
const Da = Ac("format", { parse: (t) => typeof t == "number" ? t : 0 });
class mi extends Wa {
  $config() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Wn, (o) => {
  const n = Qt();
  if (Yn(n) || me(n)) for (const i of n.getNodes()) md(i) && i.toggleFormat(o);
  return !1;
}, Xn) });
function vi(t, e) {
  let r;
...
const kd = ne({ config: Qe({ setOptions: on, updateOptions: on }), init: ({ $initialEditorState: t = yd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (Bc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [Vc, Kn, Lc, jc, Un] }), nn = Symbol.for("@lexical/extension/LexicalBuilder");
function sn() {
}
function _d(t) {
  throw t;
...
class lr {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of fd(p)) {
...
const Nd = /* @__PURE__ */ new Set(), cn = ne({ build(t, e, r) {
...
ne({ dependencies: [ro, cn], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  ...
  return Ee(t.registerCommand(Cd, (s) => {
    const c = Qt();
    if (!me(c)) return !1;
    ...
    return !0;
  }, vo), t.registerCommand(Uc, (s) => {
    if (Kc(s.target)) {
      const c = Hc(s.target);
      if (Td(c)) return function(l, d = !1) {
        const w = Qt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Yn(w) ? g = w : (g = qc(), Gc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Sd(t, e, r = ki) {
  return Ee(t.registerCommand(el, (o) => {
    const n = Qt();
    if (!me(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => rl(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = sd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = al();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = ol(g), g.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? nl : Ko : il;
...
const Rd = ne({ name: "@lexical/react/ReactProvider" });
function zd() {
...
function $d({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Rd.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Od(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Id, { editor: t, ErrorBoundary: e });
}
function ln(t) {
...
function Pd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Eo(() => Ee(ul(n), Ni(n)), [n]);
  }(o), u(wt, { children: [t, a(Ad, { content: e }), a($d, { editor: o, ErrorBoundary: r })] });
}
function Ad({ content: t }) {
...
const Ld = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
function jd({ onClear: t }) {
  const [e] = ye();
  return Ld(() => fi(e, t), [e, t]), null;
}
...
function Kd(t, e) {
  ...
  return u(wt, { children: [a(Fd, { editor: n, ...o, ref: e }), r != null && a(Hd, { editor: n, content: r })] });
}
...
function Yd({
  ...
  const [e] = ye(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Wd(), l = () => {
  };
...
function Qd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Yd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Jd, {}) }) }),
...
function ew(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = ml(e, n);
      Pe().clear(), ll(i);
    },
    {
      discrete: !0
...
const rw = "verseText", Tp = Object.freeze([
...
function Oi(t) {
  return (t == null ? void 0 : t.conflictType) === rw;
}
function Ii(t) {
...
function Sp({
  ...
  const [i, s] = _(aw), [c, l] = _(n), [d, w] = _(!1), p = U(void 0), h = U(null);
  Y(() => {
    let m = !0;
    const R = h.current;
    if (!R) return;
...
function pn({
    ...
    if (o && c)
      return /* @__PURE__ */ u(wt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (E) => {
              E.stopPropagation(), d(!0), p(ew(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(sw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(cw, { className: "tw:text-xs tw:font-medium", children: R }) }),
        ...
        $ && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ts, {}) }) }),
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: lt ? /* @__PURE__ */ a(Ss, {}) : /* @__PURE__ */ a(Rs, {})
              }
            ),
            K === void 0 ? (
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    it ? /* @__PURE__ */ a(zs, {}) : /* @__PURE__ */ a(dr, {})
                  ] })
                ]
              }
            ),
...
), dw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Zr = (t) => dw(fo(t));
function Qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: z.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...H, conflictResolution: R }) : /* @__PURE__ */ a(Pi, { ...H })
          },
          M.id
        );
      })
...
function Up({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ u(J, { variant: "default", children: [
      /* @__PURE__ */ a(Ps, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
...
function Dw({
  ...
  return /* @__PURE__ */ u(Be, { open: p, onOpenChange: m, children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: zw(t, o, e) }) }) }),
...
const Mw = (t, e) => t === "f" ? /* @__PURE__ */ u(wt, { children: [
  /* @__PURE__ */ a(Pn, {}),
  " ",
...
function Iw({
  ...
  return /* @__PURE__ */ u(Be, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Fe, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: Mw(t, r) }) }) }),
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: Ow(t, r) }) })
    ] }) }),
...
function Pw({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Fs, { className: e, size: 16 });
}
function Aw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
...
function mn({
  ...
  return /* @__PURE__ */ u(
    Te,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(Aw, { state: t.selectionState }),
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Pw, { icon: t.icon }) }) }),
...
function Gp({
  ...
  const ie = () => {
    ...
    if (L && kr("note", L)) {
      ...
      I !== "x" && S === "x" ? st == null || st.forEach((mt) => Bw(mt)) : I === "x" && S !== "x" && (st == null || st.forEach((mt) => Fw(mt))), (rt = h.current) == null || rt.applyUpdate([L, { delete: 1 }]);
    }
  }, ae = (S) => {
    ...
    (S, L, X) => {
      ...
      cs({
        ...
        onShowError: (O) => {
          (!oc(O) || O.code !== nc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${ic(O)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(wt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(wt, { children: Kw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(uo, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(sr, { className: o, children: Gw(c.text) })
        ]
      },
...
const Yw = (t) => {
  ...
  return e ? e[1] : "";
}, Jw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", rh = Object.freeze([
...
function ah({
  ...
  }, [B, tt]), M = A(() => D.length === 0 ? [] : Zw(D, z, W), [D, z, W]), H = A(() => {
    var vt, ht;
    if (!B) return l;
...
const tu = "16rem", eu = "3rem", Vi = Gt.createContext(void 0);
function ma() {
...
function oh({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    J,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(fc, {}) : /* @__PURE__ */ a(mc, {}),
...
function lu({
  ...
  const c = t ? Ar.Root : "button", { state: l } = ma(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(cu({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    au,
    {
      ...
      children: /* @__PURE__ */ u(nu, { children: [
        /* @__PURE__ */ u(vn, { children: [
          ...
          /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(iu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(su, { children: /* @__PURE__ */ a(
            lu,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(vn, { children: [
          ...
          /* @__PURE__ */ a(xn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(Ws, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  us,
                  {
                    mode: "project",
...
const De = "scrBook", wu = "scrRef", We = "source", uu = "details", pu = "Scripture Reference", hu = "Scripture Book", Li = "Type", gu = "Details";
function fu(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, yn = (t) => `${mu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function vh({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(vw, { children: T.map((z) => /* @__PURE__ */ a(de, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
        ...
        /* @__PURE__ */ a(Je, { asChild: !0, children: /* @__PURE__ */ u(
          J,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(Ys, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
...
function xh({
  ...
  const E = zt(
    ...
    [r, n, m, i]
  ), bt = ht.find((P) => P.value === t), se = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? lc(xt, lt, {
...
function oo({
  ...
  return /* @__PURE__ */ u(Be, { variant: i, children: [
    /* @__PURE__ */ a(Fe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(J, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Xs, {}) }) }),
...
const Eu = Object.freeze([520, 420, 340]), Ki = Gt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = Ui(n, Eu), d = ii() ?? l, w = d >= Tr.MINIMUM;
...
function Th({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Hi, { children: [
      /* @__PURE__ */ a(qi, { children: t.map((c) => /* @__PURE__ */ a(Tu, { value: c.value, children: c.value }, c.key)) }),
...
function Vu({
  ...
  if (Tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var f, x, m, R;
    w.preventDefault();
...
function Mh({
  ...
  return /* @__PURE__ */ u(Le, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(bs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(xs, { children: /* @__PURE__ */ a(vc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(je, { children: [
...
function cg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    Rl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(_c, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(kc, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(yc, { className: "tw:size-4" }),
...
function bg(t) {
  const e = A(() => dc(t).slice().sort().join(" "), [t]);
