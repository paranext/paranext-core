...
import { jsx as r, jsxs as d, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as rn, useRef as Z, useMemo as L, useState as D, useCallback as z, useLayoutEffect as Gt, createContext as kn, useContext as gr, useEffect as U, Component as ms, createElement as zr, Suspense as hs, createRef as fs, Fragment as bo } from "react";
import { Command as ft } from "cmdk";
import { X as Ie, Search as vo, Check as Dt, Clock as Fr, ChevronsLeft as Gr, ChevronsRight as Hr, ChevronLeft as Zn, ChevronRight as Ee, ArrowLeft as gs, ArrowRight as bs, Circle as _n, ChevronDown as fe, BoldIcon as vs, ItalicIcon as xs, UnderlineIcon as ys, StrikethroughIcon as Ns, Pencil as ks, Trash2 as _s, ArrowUp as xo, MoreHorizontal as yo, ChevronUp as Qn, AtSign as No, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ss, ChevronRightIcon as Ts, ArrowRightIcon as Rs, Copy as ko, Filter as Ds, User as Ms, Link as Os, CircleHelp as Is, ChevronsUpDown as _o, Star as As, FunctionSquare as Co, SquareSigma as Eo, SquareX as Vs, AlertCircle as tr, CircleCheckIcon as Ps, CircleXIcon as $s, CircleHelpIcon as Ls, ArrowUpIcon as Bs, ArrowDownIcon as js, ArrowUpDownIcon as zs, PanelLeft as Fs, PanelRight as Gs, ScrollText as Hs, MenuIcon as Ks, Menu as Xs, EllipsisVertical as Us, LoaderCircle as Ys, GripVertical as qs } from "lucide-react";
import { clsx as Js } from "clsx";
import { extendTailwindMerge as Ws } from "tailwind-merge";
import * as Rt from "@radix-ui/react-dialog";
import { includes as cn, Section as H, getChaptersForBook as Zs, formatScrRef as _e, getSectionForBook as Ue, formatRelativeDate as Qs, formatReplacementString as pe, sanitizeHtml as ti, parseParatextHtml as Kr, hasCustomParatextTags as ei, NumberFormat as ni, formatBytes as ri, getCurrentLocale as oi, getFormatCallerFunction as ai, deepEqual as So, isString as $n, compareScrRefs as er, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
...
import { createEditor as Ro, $getRoot as te, $createParagraphNode as Cn, $getSelection as Ht, HISTORY_MERGE_TAG as br, ParagraphNode as Do, TextNode as Mo, $isTokenOrSegmented as si, $getCharacterOffsets as ii, $cloneWithPropertiesEphemeral as li, $findMatchingParent as wi, $isElementNode as ue, CLEAR_EDITOR_COMMAND as Oo, COMMAND_PRIORITY_EDITOR as Io, $isRangeSelection as Qe, shallowMergeConfig as ci, defineExtension as Xt, safeCast as on, RootNode as di, LineBreakNode as pi, TabNode as ui, $isEditorState as mi, createCommand as hi, CLICK_COMMAND as fi, isDOMNode as gi, $getNodeFromDOMNode as bi, $isNodeSelection as vi, $createNodeSelection as xi, $setSelection as yi, COMMAND_PRIORITY_LOW as Ni, DecoratorNode as ki, $create as _i, $getNodeByKey as Ci, INDENT_CONTENT_COMMAND as Xr, COMMAND_PRIORITY_CRITICAL as vr, KEY_TAB_COMMAND as Ei, $createRangeSelection as Si, $normalizeSelection__EXPERIMENTAL as Ti, OUTDENT_CONTENT_COMMAND as Ri, INSERT_TAB_COMMAND as Di, $isBlockElementNode as fn, $isDecoratorNode as Mi, $isParagraphNode as Oi, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Ao, FORMAT_TEXT_COMMAND as Ii, getRegisteredNode as Ai, isHTMLElement as Vi, isDocumentFragment as Ur, isDOMDocumentNode as Pi, ArtificialNode__DO_NOT_USE as Vo, $createLineBreakNode as Po, $isRootOrShadowRoot as $i, isBlockDomNode as Yr, isInlineDomNode as qr, $insertNodes as Li } from "lexical";
...
const ol = Rt.Root, al = Rt.Portal, Go = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: f(
...
Pe.displayName = ft.Input.displayName;
...
const Kt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  ft.Group,
  {
    ref: n,
    className: f(
...
const Uo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  ft.Separator,
  {
    ref: n,
...
Uo.displayName = ft.Separator.displayName;
...
const ht = class K {
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new we(i)), n ? new K(n, o.toString(), l, c) : new K();
  }
  /**
...
const na = W.allBookIds.filter(
  (e) => !W.isObsolete(W.bookIdToNumber(e))
), me = Object.fromEntries(
  na.map((e) => [e, W.bookIdToEnglishName(e)])
);
function Cr(e, t, n) {
...
$.displayName = "Button";
const oe = Se.Root, ae = Se.Trigger, hp = Se.Anchor, qt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ct();
...
function yl({
  ...
  return /* @__PURE__ */ d(oe, { open: l, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ r(qt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Yt, { children: /* @__PURE__ */ r(Kt, { heading: s, children: e.map((p) => /* @__PURE__ */ d(
      $t,
      {
        onSelect: () => w(p),
...
function fp(e, t, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Qr({
  ...
  if (e)
    return /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Vt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      $t,
      {
        value: `${e} ${me[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function gp({
  ...
  const w = ct(), [p, h] = D(!1), [m, u] = D(""), [g, N] = D(""), [v, x] = D("books"), [E, y] = D(void 0), [S, A] = D(!1), P = Z(void 0), _ = Z(void 0), M = Z(void 0), k = Z(void 0), T = Z({}), j = z(
    (R) => {
      t(R), l && l(R);
    },
    [t, l]
  ), B = L(() => o ? o() : na, [o]), F = L(() => ({
    [H.OT]: B.filter((X) => W.isBookOT(X)),
    [H.NT]: B.filter((X) => W.isBookNT(X)),
    [H.DC]: B.filter((X) => W.isBookDC(X)),
    [H.Extra]: B.filter((X) => W.extraBooks().includes(X))
  }), [B]), V = L(() => Object.values(F).flat(), [F]), tt = L(() => {
    if (!g.trim()) return F;
    const R = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    return [H.OT, H.NT, H.DC, H.Extra].forEach((C) => {
      R[C] = F[C].filter((et) => Cr(et, g, a));
    }), R;
  }, [F, g, a]), O = L(
    () => kl(g, V, a),
    [g, V, a]
    ...
    (R) => {
      const X = v === "chapters" ? E : O == null ? void 0 : O.book;
      X && (j({
        book: X,
        chapterNum: R,
        verseNum: 1
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: X, isDigit: C } = Zr(R.key);
      if (v === "chapters") {
        if (R.key === "Backspace") {
        ...
        if (X || C) {
          if (R.preventDefault(), R.stopPropagation(), x("books"), y(void 0), C && E) {
            const et = me[E];
            N(`${et} ${R.key}`);
          } else
            N(R.key);
      ...
      if ((v === "chapters" || v === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(R.key)) {
        const et = v === "chapters" ? E : O == null ? void 0 : O.book;
        if (!et) return;
        const at = (() => {
          if (!m) return 1;
          const Fe = m.match(/(\d+)$/);
        ...
        switch (R.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Ct = at === 0 ? Nt : Math.max(1, at - jr);
            break;
          case "ArrowDown":
            Ct = at === 0 ? 1 : Math.min(Nt, at + jr);
            break;
          default:
            return;
        }
    ...
    const { isLetter: X, isDigit: C } = Zr(R.key);
    (X || C) && (R.preventDefault(), N((et) => et + R.key), _.current.focus(), A(!1));
  }, []);
  return Gt(() => {
    const R = setTimeout(() => {
      if (p && v === "books" && M.current && k.current) {
        const X = M.current, C = k.current, et = C.offsetTop, at = X.clientHeight, Nt = C.clientHeight, Ct = et - at / 2 + Nt / 2;
        X.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(ir(e.book));
  ...
  }, [v, E, O, e.book, e.chapterNum]), /* @__PURE__ */ d(oe, { open: p, onOpenChange: bt, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
      ...
      Ut,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: I.map(({ onClick: R, disabled: X, title: C, icon: et }) => /* @__PURE__ */ r(
              $,
              {
                variant: "ghost",
                size: "sm",
            ...
            E && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ce(E, a) })
          ] }),
          !S && /* @__PURE__ */ d(Yt, { ref: M, children: [
            v === "books" && /* @__PURE__ */ d(it, { children: [
              !O && Object.entries(tt).map(([R, X]) => {
                if (X.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Kt, { heading: ie(R), children: X.map((C) => /* @__PURE__ */ r(
                      ra,
                      {
                        bookId: C,
                        onSelect: (et) => xt(et),
              ...
              O && /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r(
                $t,
                {
              ...
              O && Vt(O.book) > 1 && /* @__PURE__ */ d(it, { children: [
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: f("pr-twp", Cl(), e), ...t }));
...
function lr({
  ...
  const [E, y] = D(!1), S = c ?? l, A = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], P = (_, M) => {
    const k = l(_), T = typeof _ == "object" && "secondaryLabel" in _ ? _.secondaryLabel : void 0, j = `${M ?? ""}${k}${T ?? ""}`;
    return /* @__PURE__ */ d(
      $t,
      {
        value: k,
  ...
  return /* @__PURE__ */ d(oe, { open: E, onOpenChange: y, ...x, children: [
    ...
    /* @__PURE__ */ r(
      qt,
      {
        ...
        children: /* @__PURE__ */ d(Ut, { children: [
          /* @__PURE__ */ r(Pe, { placeholder: h, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(sn, { children: m }),
          /* @__PURE__ */ r(Yt, { children: A(t) ? t.map((_) => /* @__PURE__ */ r(Kt, { heading: _.groupHeading, children: _.options.map((M) => P(M, _.groupHeading)) }, _.groupHeading)) : t.map((_) => P(_)) })
        ] })
      }
    )
  ] });
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && h(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (k === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(k + 1, M.length - 1) : T = Math.max(k - 1, 0), T !== k && (u.preventDefault(), u.stopPropagation(), (_ = M[T]) == null || _.focus());
          return;
        }
        return;
      }
...
const aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = aa ? Gt : U, dn = { tag: br };
function Al({ initialConfig: e, children: t }) {
  const n = L(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Ol(null, o), p = Ro({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (h) => i(h, p), theme: o });
    return function(h, m) {
      if (m !== null) {
        if (m === void 0) h.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Ht() !== null || N !== null && N === h.getRootElement()) && g.select();
          }
        }, dn);
  ...
  }, []), r(oa.Provider, { value: n, children: t });
}
const Vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : U;
function Pl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  const [o] = Lt();
  return Vl(() => {
...
const Sr = {
  ...
  mark: "",
  markOverlap: ""
}, St = an.Provider, Pt = an.Root, Ft = an.Trigger, Tt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ r(
  an.Content,
  {
    ref: o,
    sideOffset: t,
...
class Ll extends ms {
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && Bl(t.resetKeys, a)) {
      var s, i;
...
function jl({ children: e, onError: t }) {
  return r(Ll, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : U;
function Fl(e) {
...
function Hl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !si(t) && o !== null) {
    ...
    if (w || p) {
      ...
      const E = t.__text.slice(x, v);
      E !== t.__text && (n === "clone" && (t = li(t)), t.__text = E);
    }
  }
  return t;
}
...
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Xl = sa && "documentMode" in document ? document.documentMode : null;
!(!sa || !("InputEvent" in window) || Xl) && "getTargetRanges" in new window.InputEvent("input");
function ia(...e) {
  const t = [];
...
function Zl(e) {
  ...
  ca(this), Y = e, this.f &= -2, 8 & this.f && Rr(this), Sn();
}
function ke(e, t) {
...
mt.prototype.brand = ql, mt.prototype.h = function() {
  return !0;
  ...
  if (this.g = mn, this.f |= 1, this.i > 0 && !wa(this)) return this.f &= -2, !0;
  const e = Y;
  try {
    ro(this), Y = this;
    const t = this.x();
...
function pa() {
  const e = te(), t = Ht(), n = Cn();
  e.clear(), e.append(n), t !== null && n.select(), Qe(t) && (t.format = 0);
}
function ua(e, t = pa) {
  return e.registerCommand(Oo, (n) => (e.update(t), !0), Io);
}
Xt({ build: (e, t, n) => Tn(t), config: on({ $onClear: pa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: o } = n.getOutput();
  return ne(() => ua(e, o.value));
} });
function Ql(e) {
...
const cr = Xt({ build: (e) => ma(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Dr = 0, dr = 1, fa = 2, Gn = 3, pn = 4, Ne = 5, Hn = 6, He = 7;
function Kn(e) {
  return e.id === Dr;
}
function ga(e) {
...
function tw(e) {
  return function(t) {
    return t.id === dr;
  }(e) || Q(305, String(e.id), String(dr)), Object.assign(e, { id: fa });
}
...
class nw {
  ...
  register(t, n) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== He && Q(309, String(o.id), String(He)), this.state = function(i) {
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= He;
    }(t) || Q(316, String(t.id), String(He)), t;
  }
...
const ow = Xt({ config: on({ setOptions: oo, updateOptions: oo }), init: ({ $initialEditorState: e = rw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [di, Mo, pi, ui, Do] }), ao = Symbol.for("@lexical/extension/LexicalBuilder");
function so() {
}
function aw(e) {
  throw e;
...
class Je {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Ro({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [ao]: this });
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== o && Q(298, o.name), !a) {
      a = new nw(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (o, a) => {
      ...
      var l;
      Kn(s) || Q(300, i, a || "[unknown]"), Kn(l = s) || Q(304, String(l.id), String(Dr)), s = Object.assign(l, { id: dr }), o.state = s;
      const c = this.outgoingConfigEdges.get(i);
      if (c) for (const w of c.keys()) {
        const p = this.extensionNameMap.get(w);
        p && n(p, i);
      }
      s = tw(s), o.state = s, t.push(o);
    };
...
const sw = /* @__PURE__ */ new Set(), io = Xt({ build(e, t, n) {
  const o = n.getDependency(cr).output, a = tn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ma(() => {
  }, () => ne(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    o.value.read(() => {
      if (Ht()) for (const [p, h] of l.entries()) {
        if (h.size === 0) {
          l.delete(p);
          continue;
        }
...
Xt({ dependencies: [cr, io], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  const { watchNodeKey: o } = n.getDependency(io).output, a = tn({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return ee(e.registerCommand(fi, (i) => {
    if (gi(i.target)) {
      const l = bi(i.target);
      if (lw(l)) return function(c, w = !1) {
        const p = Ht(), h = c.isSelected(), m = c.getKey();
        let u;
...
function ww(e, t) {
  return ee(e.registerCommand(Ei, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Yl(i, (m) => fn(m) && m.canIndent() ? m : null).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), h = to(p);
      if (h.canIndent()) {
        const m = h.getKey();
        let u = Si();
    ...
    const o = Ht();
    if (!Qe(o)) return !1;
    const a = o.getNodes().map((s) => to(s).getIndent());
...
Xt({ build: (e, t, n) => Tn(t), config: on({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  ...
  return ne(() => {
    if (!o.value) return ww(e, a);
  });
} });
const cw = Xt({ name: "@lexical/react/ReactProvider" });
function dw() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (Qe(g)) {
                const N = g.anchor;
                let v = N.getNode(), x = 0, E = 0;
                if (gn(v) && w >= 0 && p >= 0 && (x = w, E = w + p, g.setTextNodeRange(v, x, v, E)), x === E && h === "" || (g.insertRawText(h), v = N.getNode()), gn(v)) {
                  x = m, E = m + u;
                  const y = v.getTextContentSize();
                  x = x > y ? y : x, E = E > y ? y : E, g.setTextNodeRange(v, x, v, E);
                }
...
Xt({ build: (e, t, n) => Tn(t), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => ne(() => n.getOutput().disabled.value ? void 0 : xa(e)) });
function mw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", e);
  for (const a of t) o.append("v", a);
...
function fw({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(cw.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && mw(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : r(hw, { editor: e, ErrorBoundary: t });
}
function lo(e) {
...
function gw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Mr(() => ee(Fi(a), xa(a)), [a]);
  }(o), d(it, { children: [e, r(bw, { content: t }), r(fw, { editor: o, ErrorBoundary: n })] });
}
...
const xw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : U;
function yw({ onClear: e }) {
  const [t] = Lt();
  return xw(() => ua(t, e), [t, e]), null;
}
const ya = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : U;
function Nw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: h, ariaRequired: m, autoCapitalize: u, className: g, id: N, role: v = "textbox", spellCheck: x = !0, style: E, tabIndex: y, "data-testid": S, ...A }, P) {
  const [_, M] = D(e.isEditable()), k = z((j) => {
  ...
  return ya(() => (M(e.isEditable()), e.registerEditableListener((j) => {
    M(j);
  })), [e]), r("div", { "aria-activedescendant": _ ? t : void 0, "aria-autocomplete": _ ? n : "none", "aria-controls": _ ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": _ && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": _ ? h : void 0, "aria-readonly": !_ || void 0, "aria-required": m, autoCapitalize: u, className: g, contentEditable: _, "data-testid": S, id: N, ref: T, role: v, spellCheck: x, style: E, tabIndex: y, ...A });
}
const kw = rn(Nw);
function wo(e) {
  return e.getEditorState().read(va(e.isComposing()));
...
function Cw(e, t) {
  ...
  return d(it, { children: [r(kw, { editor: a, ...o, ref: t }), n != null && r(Ew, { editor: a, content: n })] });
}
...
function Rw() {
  const [e, t] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ r(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ho, { children: [
      /* @__PURE__ */ r(Ko, { children: /* @__PURE__ */ r(Xo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Dw({
  ...
  const [t] = Lt(), [n, o] = D(t), [a, s] = D("paragraph"), [i, l] = Rw(), c = () => {
  };
...
), Ow = b.forwardRef(({ className: e, variant: t, size: n, ...o }, a) => /* @__PURE__ */ r(
  $o.Root,
  {
    ref: a,
    className: f(_a({ variant: t, size: n, className: e })),
    ...o
  }
));
Ow.displayName = $o.Root.displayName;
...
function Iw() {
  const { activeEditor: e } = ka(), [t, n] = D([]), o = z((a) => {
    if (Qe(a) || Ki(a)) {
      const s = [];
      co.forEach(({ format: i }) => {
...
function Vw({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Dw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Iw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        gw,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Sw, { placeholder: e }) }),
          ErrorBoundary: jl
        }
      ),
      t && /* @__PURE__ */ r(vw, { defaultSelection: "rootEnd" }),
  ...
  return /* @__PURE__ */ r("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ r(
    Al,
    {
      ...
      children: /* @__PURE__ */ d(St, { children: [
        /* @__PURE__ */ r(Vw, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ r(
          Pl,
          {
...
function $w(e, t) {
  const n = Pi(t) ? t.body.childNodes : t.childNodes;
  let o = [];
  const a = [];
...
function Ea(e, t, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], N = Ea(e, g, m, o);
    !a && ue(t) && N && t.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(p) || Ur(p)) && p.append(m), n.append(p), h) {
      const u = h.call(i, p);
...
function Ta(e, t, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  const c = function(g, N) {
    ...
    if (x !== void 0) for (const y of x) {
      const S = y(g);
      S !== null && (E === null || (E.priority || 0) <= (S.priority || 0)) && (E = S);
    }
  ...
  for (let g = 0; g < h.length; g++) m.push(...Ta(h[g], t, n, u, new Map(a), l));
  return p != null && (m = p(m)), Yr(e) && (m = Bw(e, m, u ? () => {
    const g = new Vo();
    return n.push(g), g;
  } : Cn)), l == null ? m.length > 0 ? i = i.concat(m) : Yr(e) && function(g) {
...
const zw = re(
  ...
  ({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", zw({ variant: t }), e), ...n })
);
...
De.displayName = Bo.Root.displayName;
...
Xw.displayName = Ve.Image.displayName;
...
}), Le = nt.Trigger, Ia = nt.Group, Uw = nt.Portal, Yw = nt.Sub, qw = nt.RadioGroup;
function xe({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ r(Vr.Provider, { value: n, children: /* @__PURE__ */ r(nt.Root, { ...t }) });
}
...
Va.displayName = nt.SubContent.displayName;
...
const Pa = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
    ...
    if (o && w)
      return /* @__PURE__ */ d(it, { children: [
        !ei(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              m(!0), g(jw(Kr(e.contents))), c == null || c(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          h && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: N,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), v()) : _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), Et(u) && x());
              },
              onKeyDown: (_) => {
                Ir(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  vn,
        ...
        P && /* @__PURE__ */ d(xe, { children: [
          ...
          /* @__PURE__ */ r(se, { align: "end", children: P })
        ] })
      ]
    }
  );
...
function Ww({
  ...
  const [x, E] = D(uo), [y, S] = D(!1), [A, P] = D(!1), [_, M] = D(!1), [k, T] = D(!1), [j, B] = D(!1), [F, V] = D(void 0), [tt, O] = D(!1), [st, xt] = D(!1), [Bt, _t] = D(/* @__PURE__ */ new Map());
  U(() => {
    let C = !0;
    if (!n) {
  ...
  const I = L(() => e.filter((C) => !C.deleted), [e]);
  U(() => {
    let C = !0;
    if (!n || !v) {
      _t(/* @__PURE__ */ new Map());
  ...
  const q = L(() => I[0], [I]), bt = Z(null), dt = Z(void 0), pt = z(() => {
    var C;
    (C = dt.current) == null || C.call(dt), E(uo);
  }, []);
  U(() => {
    const C = bt.current;
    if (!C) return;
  ...
  const jt = L(
  ...
  }, [a, t]), ie = L(() => I.slice(1), [I]), yt = L(() => ie.length ?? 0, [ie.length]), An = L(() => yt > 0, [yt]), wn = L(() => _ || yt <= 2 ? ie : ie.slice(-2), [ie, yt, _]), ye = L(() => _ || yt <= 2 ? 0 : yt - 2, [yt, _]), Vn = L(
    ...
    C && await w({ threadId: l, contents: C }) && pt();
  }, [pt, x, w, F, l]), X = z(
    async (C) => {
      const et = Et(x) ? xn(x) : void 0, at = await w({
        ...C,
        contents: et,
        assignedUser: F ?? C.assignedUser
      });
      return at && et && pt(), at && F !== void 0 && V(void 0), at;
    },
    [pt, x, w, F]
  );
  return /* @__PURE__ */ r(
          ...
          n && /* @__PURE__ */ d(it, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    _ ? /* @__PURE__ */ r(Qn, {}) : /* @__PURE__ */ r(fe, {})
                  ] })
                ]
              }
            ),
            wn.map((C) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              po,
              {
                comment: C,
                localizedStrings: t,
            ...
            u !== !1 && (!k || Et(x)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (C) => {
                  C.key === "Enter" && C.shiftKey && (C.preventDefault(), C.stopPropagation(), (Et(x) || F !== void 0) && R());
                },
                onKeyDown: (C) => {
                    ...
                    /* @__PURE__ */ d(oe, { open: j, onOpenChange: B, children: [
                      ...
                      /* @__PURE__ */ r(
                        qt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (C) => {
                            C.key === "Escape" && (C.stopPropagation(), B(!1));
                          },
                          children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Yt, { children: m == null ? void 0 : m.map((C) => /* @__PURE__ */ r(
                            $t,
                            {
                              onSelect: () => {
                                V(C !== a ? C : void 0), B(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ r("span", { children: hn(C, t) })
                            },
                            C || "unassigned"
                          )) }) })
                        }
...
function Np({
  ...
  const x = t.filter(
    ...
    [u]
  ), { listboxRef: A, activeId: P, handleKeyDown: _ } = Ml({
    options: E,
    onOptionSelect: y
  }), M = z(
    (k) => {
      k.key === "Escape" ? (N(void 0), u == null || u(void 0), k.preventDefault(), k.stopPropagation()) : _(k);
    },
    [_, u]
  );
  return /* @__PURE__ */ r(
...
const Me = lt.Root, Qw = lt.Group, Oe = lt.Value, tc = re(
  ...
  return /* @__PURE__ */ d(
    lt.Trigger,
    {
      className: f(tc({ size: n, className: e })),
      ref: a,
      ...o,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ r(lt.Icon, { asChild: !0, children: /* @__PURE__ */ r(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
be.displayName = lt.Trigger.displayName;
...
ve.displayName = lt.Content.displayName;
...
ec.displayName = lt.Label.displayName;
const kt = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ d(
  lt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(lt.ItemIndicator, { children: /* @__PURE__ */ r(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(lt.ItemText, { children: t })
    ]
  }
));
kt.displayName = lt.Item.displayName;
...
nc.displayName = lt.Separator.displayName;
function rc({ table: e }) {
...
const ac = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), lc(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), ic(l, N, p.key);
...
const wc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function cc({
  ...
  var P;
  const [p, h] = D([]), [m, u] = D([]), [g, N] = D({}), [v, x] = D({}), E = L(() => t ?? [], [t]), y = jo({
    data: E,
    columns: e,
    getCoreRowModel: Fo(),
  ...
  let A;
  return c ? A = Array.from({ length: 10 }).map((k, T) => `skeleton-row-${T}`).map((k) => /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(he, { colSpan: S.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((P = y.getRowModel().rows) == null ? void 0 : P.length) > 0 ? A = y.getRowModel().rows.map((_) => /* @__PURE__ */ r(
    zt,
    {
      onClick: () => i(_, y),
      "data-state": _.getIsSelected() && "selected",
      children: _.getVisibleCells().map((M) => /* @__PURE__ */ r(he, { children: Ye(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    _.id
  )) : A = /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Zw, { table: y }),
    /* @__PURE__ */ d(Rn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Dn, { stickyHeader: s, children: y.getHeaderGroups().map((_) => /* @__PURE__ */ r(zt, { children: _.headers.map((M) => /* @__PURE__ */ r(nn, { children: M.isPlaceholder ? void 0 : Ye(M.column.columnDef.header, M.getContext()) }, M.id)) }, _.id)) }),
...
var uc = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(uc || {});
function Ep({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: e, children: /* @__PURE__ */ d(xe, { children: [
    ...
    /* @__PURE__ */ r(se, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Ia, { children: w.itemType === 0 ? /* @__PURE__ */ r(it, { children: w.items.map((h, m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[p][m],
        ...
        qw,
        {
          ...
          children: w.items.map((h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Pa, { value: h.id, children: h.label }) }, h.id))
        }
      ) }),
      /* @__PURE__ */ r(Be, {})
    ] }, w.label)) })
...
function mc({ id: e, versionHistory: t }) {
...
function hc({
  ...
  const [x, E] = D(!1), y = z(
    ...
    const T = e.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), j = e.filter((B) => !B.starred).sort((B, F) => {
      const V = t.includes(B.value), tt = t.includes(F.value);
      return V && !tt ? -1 : !V && tt ? 1 : B.label.localeCompare(F.label);
    });
    return [...T, ...j];
  }, [e, t, m]), P = () => {
    n(e.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(oe, { open: M, onOpenChange: p ?? E, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ d(
      $,
      {
        variant: N,
    ...
    /* @__PURE__ */ r(qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Ut, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: P, children: s }),
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: _, children: i })
      ] }),
      /* @__PURE__ */ d(Yt, { children: [
        /* @__PURE__ */ r(sn, { children: l }),
        /* @__PURE__ */ r(Kt, { children: A.map((T) => /* @__PURE__ */ d(
          $t,
          {
            value: T.label,
            onSelect: y,
...
const fc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(it, { children: [
...
function gc({
  ...
  const g = (v) => {
    ...
    var x, E, y, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((x = s.current) == null || x.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((E = i.current) == null || E.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((y = s.current) == null ? void 0 : y.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(xe, { open: m, onOpenChange: g, children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "outline", className: "tw-h-6", children: fc(e, a, n) }) }) }),
...
const bc = (e, t) => e === "f" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function xc({
  ...
  return /* @__PURE__ */ d(xe, { children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Pt, { children: [
      ...
      /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r("p", { children: vc(e, n) }) })
    ] }) }),
...
function Dp({
  ...
  U(() => {
    ...
    if (S && Bn("note", S)) {
      const _ = (A = S.insert.note) == null ? void 0 : A.caller;
      let M = "custom";
      _ === nr ? M = "generated" : _ === rr ? M = "hidden" : _ && m(_), p(M), g(((P = S.insert.note) == null ? void 0 : P.style) ?? "f"), S.insert.note && (S.insert.note.caller = ""), y = setTimeout(() => {
        var k;
  ...
  const v = z(() => {
    var S, A;
    const y = (A = (S = l.current) == null ? void 0 : S.getNoteOps(0)) == null ? void 0 : A.at(0);
        ...
        /* @__PURE__ */ r(
          xc,
          {
            ...
            handleNoteTypeChange: (y) => {
              var A, P, _;
              g(y);
              const S = (P = (A = l.current) == null ? void 0 : A.getNoteOps(0)) == null ? void 0 : P.at(0);
              S && Bn("note", S) && (S.insert.note && (S.insert.note.style = y), (_ = l.current) == null || _.applyUpdate([{ delete: 1 }, S]));
            },
            localizedStrings: i
          }
        ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Pt, { children: [
            /* @__PURE__ */ r(Ft, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: x, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ko, {}) }) }),
...
function kc({
  ...
  const c = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, p = /* @__PURE__ */ d(it, { children: [
    a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
    // specific class name in case styling is needed.
    /* @__PURE__ */ d("span", { className: f("note-caller", { formatted: s }), children: [
      a,
      " "
    ] }),
    i && /* @__PURE__ */ d(it, { children: [
      Pr(e.marker, [i], o, !1),
      " "
    ] })
  ] }), u = f(t === "horizontal" ? "horizontal tw-table-cell" : "vertical", o ? "marker-visible" : "");
  return /* @__PURE__ */ d(it, { children: [
    /* @__PURE__ */ d("div", { className: f("textual-note-header tw-text-nowrap tw-pr-2", u), children: [
      c,
      p
    ] }),
    /* @__PURE__ */ r("div", { className: f("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ r(it, { children: yc(e.marker, l, o, w) }) })
  ] });
}
const Op = ["%webView_footnoteList_header%"], _c = (e, t) => e[t] ?? t;
function Ip({
  className: e,
  classNameForItems: t,
  footnotes: n,
  ...
  const h = p ? _c(p, "%webView_footnoteList_header%") : "Footnotes", m = c ?? ai(n, void 0), u = (y, S) => {
    w == null || w(y, S, a);
  }, g = s ? n.findIndex((y) => y === s) : 0, [N, v] = D(g), x = (y) => {
    if (n.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), v((S) => Math.min(S + 1, n.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), v((S) => Math.max(S - 1, 0));
          break;
        case "Enter":
        case " ":
  ...
  return U(() => {
    ...
    o === "vertical" && /* @__PURE__ */ r("h2", { className: "tw-mb-1 tw-font-semibold", children: h }),
    /* @__PURE__ */ r(
      "div",
      {
        role: "listbox",
          ...
          "div",
          {
            ...
            children: n.map((y, S) => {
              ...
              return /* @__PURE__ */ d(it, { children: [
                ...
                S < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(De, {})
              ] });
            })
          }
        )
...
function Ap({
  ...
  const [a, s] = D(Cc), [i, l] = D(void 0), [c, w] = D(!1), p = Z(void 0), h = Z(null);
  U(() => {
    let x = !0;
    const E = h.current;
    if (!E) return;
    ...
    /* @__PURE__ */ r(Mn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      zt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(he, { children: Ec(i.text) })
        ]
      },
...
$r.displayName = or.Root.displayName;
const On = (e) => e === "asc" ? /* @__PURE__ */ r(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ r(js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(zs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Pp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, Rc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Fp = Object.freeze([
...
function Gp({
  ...
  const h = It(n, "%webView_inventory_all%"), m = It(n, "%webView_inventory_approved%"), u = It(n, "%webView_inventory_unapproved%"), g = It(n, "%webView_inventory_unknown%"), N = It(n, "%webView_inventory_scope_currentBook%"), v = It(n, "%webView_inventory_scope_chapter%"), x = It(n, "%webView_inventory_scope_verse%"), E = It(n, "%webView_inventory_filter_text%"), y = It(
    n,
    "%webView_inventory_show_additional_items%"
  ), S = It(n, "%webView_inventory_no_results%"), [A, P] = D(!1), [_, M] = D("all"), [k, T] = D(""), [j, B] = D([]), F = L(() => {
    const I = e ?? [];
    return I.length === 0 ? [] : Mc(I, a, s);
  }, [e, a, s]), V = L(() => {
    if (A) return F;
    const I = [];
    return F.forEach((q) => {
  ...
  }, [A, F]), tt = L(() => V.length === 0 ? [] : Dc(V, _, k), [V, _, k]), O = L(() => {
    var bt, dt;
    if (!A) return c;
  ...
  const st = (I, q) => {
    ...
    if (V.length === 0 || j.length === 0) return [];
    const I = V.filter((q) => So(
      A ? q.items : [q.items[0]],
      j
    ));
      ...
      /* @__PURE__ */ r(Kt, { children: a.map((s) => /* @__PURE__ */ d(
        $t,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Yo, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const Oc = "16rem", Ic = "3rem", ja = b.createContext(void 0);
function In() {
...
const za = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), h = t ?? w, m = b.useCallback(
      ...
      [n, h]
    ), u = b.useCallback(() => m((y) => !y), [m]), g = h ? "expanded" : "collapsed", x = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", E = b.useMemo(
      () => ({
        state: g,
        open: h,
        setOpen: m,
    ...
    return /* @__PURE__ */ r(ja.Provider, { value: E, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ac = b.forwardRef(({ className: e, onClick: t, ...n }, o) => {
  const a = In();
  return /* @__PURE__ */ d(
    $,
    {
...
const jc = b.forwardRef(({ className: e, asChild: t = !1, ...n }, o) => /* @__PURE__ */ r(
  t ? Ae : "button",
  {
    ref: o,
  ...
  ({
    ...
    const c = e ? Ae : "button", { state: w } = In(), p = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": o,
        "data-active": t,
        className: f(zc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Fc = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  t ? Ae : "button",
  {
    ref: a,
...
const Hc = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, o) => {
...
const Uc = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  e ? Ae : "a",
  {
    ref: s,
    ...
    Fa,
    {
      ...
      children: /* @__PURE__ */ d(Ha, { children: [
        /* @__PURE__ */ d(ur, { children: [
          ...
          /* @__PURE__ */ r(hr, { children: /* @__PURE__ */ r(Ka, { children: Object.entries(t).map(([m, u]) => /* @__PURE__ */ r(Xa, { children: /* @__PURE__ */ r(
            Ua,
            {
              onClick: () => w(m),
              isActive: h(m),
...
const Wt = "scrBook", qc = "scrRef", de = "source", Jc = "details", Wc = "Scripture Reference", Zc = "Scripture Book", Ya = "Type", Qc = "Details";
function td(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: Wt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Wc,
      cell: (o) => {
...
}, fo = (e) => `${ed({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Up({
  sources: e,
  ...
  U(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const j = N.find((B) => fo(B) === T[0]) || void 0;
        j && l(j);
      }
    }
  }, [u, N, l, x]);
  const E = a ?? Zc, y = s ?? Ya, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${E}`, value: [Wt] },
  ...
  }, _ = (k, T) => k.getIsGrouped() ? "" : f("banded-row", T % 2 === 0 ? "even" : "odd"), M = (k, T, j) => {
    ...
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ve, { position: "item-aligned", children: /* @__PURE__ */ r(Qw, { children: S.map((k) => /* @__PURE__ */ r(kt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
...
function rd({
  ...
  }, [v, x] = D(!1), [E, y] = D(""), S = Z(void 0), A = Z(!1);
  if (e.length !== W.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const P = L(() => W.allBookIds.filter(
    (V, tt) => e[tt] === "1" && !W.isObsolete(W.bookIdToNumber(V))
  ), [e]), _ = L(() => {
    if (!E.trim()) {
      const O = {
        [H.OT]: [],
    ...
    (V, tt = !1) => {
      if (!tt || !S.current) {
        n(
          t.includes(V) ? t.filter((I) => I !== V) : [...t, V]
        ), S.current = V;
        return;
      }
      const O = P.findIndex((I) => I === S.current), st = P.findIndex((I) => I === V);
      if (O === -1 || st === -1) return;
      const [xt, Bt] = [
        Math.min(O, st),
        Math.max(O, st)
      ], _t = P.slice(xt, Bt + 1).map((I) => I);
      n(
        t.includes(V) ? t.filter((I) => !_t.includes(I)) : [.../* @__PURE__ */ new Set([...t, ..._t])]
      );
    },
    [t, n, P]
  ), k = (V) => {
    M(V, A.current), A.current = !1;
  }, T = (V, tt) => {
    V.preventDefault(), M(tt, V.shiftKey);
  }, j = z(
    (V) => {
      const tt = Br(P, V).map((O) => O);
      n(
        qa(P, V, t) ? t.filter((O) => !tt.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...tt])]
      );
    },
    [t, n, P]
  ), B = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
                  ...
                  Object.values(H).map((V, tt) => {
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ d(bo, { children: [
                        ...
                        tt < Object.values(H).length - 1 && /* @__PURE__ */ r(Uo, {})
                      ] }, V);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === qn ? qn : go
      ).map((V) => /* @__PURE__ */ r(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(V, a) }, V)),
      t.length > qn && /* @__PURE__ */ r(
        Re,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${t.length - go} ${h}`
        }
      )
    ] })
  ] });
...
function qp({
  ...
  ], x = t ? v.filter((E) => t.includes(E.value)) : v;
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Er,
        {
          ...
          children: x.map(({ value: E, label: y, id: S }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(bn, { className: "tw-me-2", value: E, id: S }),
...
const Wa = (e, t, n, o) => n ? Object.entries(e).filter(
  ...
  ) : /* @__PURE__ */ d(Yw, { children: [
    /* @__PURE__ */ r(Aa, { children: l.label }),
    /* @__PURE__ */ r(Uw, { children: /* @__PURE__ */ r(Va, { children: Wa(
      e,
      t,
      Ja(e, l.id),
      o
...
function fr({
  ...
  return /* @__PURE__ */ d(xe, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r($, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ks, {}) }) }),
    /* @__PURE__ */ r(se, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(bo, { children: [
...
function nu({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qa, { children: [
      /* @__PURE__ */ r(ts, { children: e.map((l) => /* @__PURE__ */ r(od, { value: l.value, children: l.value }, l.key)) }),
...
const id = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    rt.CheckboxItem,
    {
...
id.displayName = rt.CheckboxItem.displayName;
const ld = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    rt.RadioItem,
    {
...
ld.displayName = rt.RadioItem.displayName;
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, h) => {
    ...
    switch (h.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ke(s, [m, u]);
        break;
      case "alt+l":
        (N = i.current) == null || N.focus(), Ke(i, [m, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ke(l, [m, u]);
        break;
      case "alt+h":
        (x = c.current) == null || x.focus(), Ke(c, [m, u]);
        break;
    }
  }), U(() => {
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, h]) => typeof p == "boolean" || typeof h == "boolean" ? 0 : p.order - h.order).map(([p, h]) => /* @__PURE__ */ d(ad, { children: [
...
function au({
  ...
  const w = dd(
    ...
    var x, E, y, S, A, P;
    const v = N !== g ? ((E = (x = e[g]) == null ? void 0 : x.uiNames) == null ? void 0 : E[N]) ?? ((S = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : S.en) : void 0;
    return v ? `${(A = e[g]) == null ? void 0 : A.autonym} (${v})` : (P = e[g]) == null ? void 0 : P.autonym;
  };
...
function pd({ item: e, createLabel: t, createComplexLabel: n }) {
...
const ud = rn(({ className: e, ...t }, n) => /* @__PURE__ */ r(Ys, { size: 35, className: f("tw-animate-spin", e), ...t, ref: n }));
...
), hd = b.forwardRef(({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const gd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
gd.displayName = "AlertDescription";
const wu = ot.Root, cu = ot.Trigger, du = ot.Group, pu = ot.Portal, uu = ot.Sub, mu = ot.RadioGroup, bd = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => /* @__PURE__ */ d(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
bd.displayName = ot.SubTrigger.displayName;
...
vd.displayName = ot.SubContent.displayName;
const xd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
xd.displayName = ot.Content.displayName;
const yd = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  ot.Item,
  {
    ref: o,
    className: f(
...
yd.displayName = ot.Item.displayName;
...
Nd.displayName = ot.CheckboxItem.displayName;
const kd = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ d(
  ot.RadioItem,
  {
    ref: o,
    className: f(
...
kd.displayName = ot.RadioItem.displayName;
const _d = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
    className: f(
...
_d.displayName = ot.Label.displayName;
const Cd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  ot.Separator,
  {
    ref: n,
...
Cd.displayName = ot.Separator.displayName;
...
const hu = Mt.Trigger, Td = Mt.Portal, fu = Mt.Close, ds = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
...
const Rd = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...o }, a) => {
...
Od.displayName = Mt.Title.displayName;
...
Id.displayName = Mt.Description.displayName;
const Ad = b.forwardRef(({ className: e, value: t, ...n }, o) => /* @__PURE__ */ r(
  ar.Root,
  {
    ref: o,
    className: f(
...
Ad.displayName = ar.Root.displayName;
function gu({
  className: e,
  ...t
}) {
...
const yu = gt.Root, $d = b.forwardRef(({ className: e, ...t }, n) => {
  const o = ct();
  return /* @__PURE__ */ r(
    gt.List,
    {
...
$d.displayName = gt.List.displayName;
