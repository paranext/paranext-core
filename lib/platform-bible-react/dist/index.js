...
import { ChevronRight as Co, Check as tn, Circle as Ro, X as Oo, Search as Si, ChevronsUpDown as Ti, FilterIcon as hl, ChevronDown as mr, ChevronUp as gl, ArrowLeftIcon as bl, ChevronLeftIcon as vl, ChevronRightIcon as yl, ArrowRightIcon as xl, CircleCheckIcon as Nl, CircleXIcon as kl, CircleHelpIcon as El, ArrowUpIcon as Sl, ArrowDownIcon as Tl, ArrowUpDownIcon as Cl, Star as Rl, PanelLeft as Ol, PanelRight as Pl, ScrollText as _l, ChevronLeft as Il, LoaderCircle as $l, Download as Ml, Filter as Al, User as Dl, Link as jl, CircleHelp as Bl } from "lucide-react";
import { getChaptersForBook as Vl, deepEqual as Po, substring as zl, formatScrRef as Ur, compareScrRefs as so, scrRefToBBBCCCVVV as Xr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Fl, formatBytes as Ll } from "platform-bible-utils";
...
import { useReactTable as Ri, getFilteredRowModel as Gl, getSortedRowModel as Oi, getPaginationRowModel as Ul, getCoreRowModel as Pi, flexRender as Nn, getGroupedRowModel as Xl, getExpandedRowModel as Yl } from "@tanstack/react-table";
...
const _o = mt.Root, Di = mt.Trigger, sc = mt.Group, Km = mt.Portal, Jm = mt.Sub, Zm = mt.RadioGroup, lc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ y(
  mt.SubTrigger,
  {
    ref: o,
    className: x(
...
function th({
  ...
  const o = kt(), [a, s] = ut(""), [l, c] = ut(
    ...
    Cc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, G = void 0, H = void 0] = M.slice(1), rt = Pc(A);
  ...
  }, [f]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ y(_o, { modal: !1, open: h, onOpenChange: F, children: [
...
const _c = _e(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? en : "button", { className: x(_c({ variant: e, size: n, className: t })), ref: a, ...o })
);
...
}, Zc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Zi = _e(
...
Qc.displayName = _i.Root.displayName;
...
const kr = (t) => t === "asc" ? /* @__PURE__ */ i(Sl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Tl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Cl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), rh = (t) => ({
  ...
  return Kc(t).forEach((p) => {
    ...
    for (; m; ) {
      ...
      const h = m.index, b = a.find((g) => Po(g.items, w)), f = {
        reference: {
...
function sh({
  ...
  const m = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), h = ne(n, "%webView_inventory_unapproved%"), b = ne(n, "%webView_inventory_unknown%"), f = ne(n, "%webView_inventory_scope_currentBook%"), g = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), T = ne(n, "%webView_inventory_filter_text%"), C = ne(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [_, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Ot(() => l ? r instanceof RegExp ? nd(
    l,
    t,
    a,
    s,
...
}, _a = (t) => `${_d({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function dh({
  sources: t,
  ...
  pe(() => {
    if (l) {
      ...
      if (I.length === 1) {
        const L = b.find((D) => _a(D) === I[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, b, l, g]);
...
function Ad() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var v = c, _ = d, F = l, R = s, I = e, L = p, D = r, tt = b, J = h, j = n, M = a, A = o, G = m, H = !1;
    function rt($) {
...
function Yd() {
  return Ua || (Ua = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var _ = s, F = a, R = t, I = c, L = n, D = w, tt = m, J = e, j = o, M = r, A = d, G = p, H = !1, rt = !1;
    function N(V) {
...
const _p = Xt("border", Ft), Ip = Xt("borderTop", Ft), $p = Xt("borderRight", Ft), Mp = Xt("borderBottom", Ft), Ap = Xt("borderLeft", Ft), Dp = Xt("borderColor"), jp = Xt("borderTopColor"), Bp = Xt("borderRightColor"), Vp = Xt("borderBottomColor"), zp = Xt("borderLeftColor"), Fp = Xt("outline", Ft), Lp = Xt("outlineColor"), _r = (t) => {
...
Pr(_p, Ip, $p, Mp, Ap, Dp, jp, Bp, Vp, zp, _r, Fp, Lp);
const Ir = (t) => {
...
Pr(Ir, $r, Mr, Gp, Up, Xp, Yp, Hp, qp, Wp, Kp, Jp);
function Ue(t, e) {
  return e === "grey" ? e : t;
}
const Zp = xt({
...
function Zo(t = {}, ...e) {
  ...
  return d.applyStyles = du, d = e.reduce((p, m) => re(p, m), d), d.unstable_sxConfig = P({}, Jo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Ar({
      sx: m,
      theme: this
    });
...
function xu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Wl(s, (v) => v.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const T = Hl(s, P({
      shouldForwardProp: k,
      label: g
    }, h)), C = (v) => typeof v == "function" && v.__emotion_real !== v || xe(v) ? (_) => rr(v, P({}, _, {
      theme: Kn({
        theme: _.theme,
        defaultTheme: n,
        themeId: e
...
const Pn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Pu = ["mode", "contrastThreshold", "tonalOffset"], ri = {
...
function ju(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Pu), a = t.primary || _u(e), s = t.secondary || Iu(e), l = t.error || $u(e), c = t.info || Mu(e), d = t.success || Au(e), p = t.warning || Du(e);
  function m(f) {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (h[e] || console.error(`MUI: The palette mode \`${e}\` is not supported.`)), re(P({
...
function zu(t, e) {
  ...
  const h = o / 14, b = m || ((k) => `${k / d * h}rem`), f = (k, T, C, S, v) => P({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(T),
...
function Wu(t) {
  const e = P({}, Yu, t.easing), n = P({}, Hu, t.duration);
  return P({
...
`));
  ...
  return d.unstable_sxConfig = P({}, Jo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Ar({
      sx: m,
      theme: this
    });
...
const ew = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], nw = (t) => {
  ...
  const r = na({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, h = St(r, ew), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", f = P({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function gw(t) {
  ...
  if (!e) {
    const h = ke(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = P({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = P({}, n, o, r);
    return h.length > 0 && (f.className = h), Object.keys(b).length > 0 && (f.style = b), {
      props: f,
      internalRef: void 0
    };
  }
  const s = mw(P({}, o, r)), l = di(r), c = di(o), d = e(s), p = ke(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
var Pt = "top", Gt = "bottom", Ut = "right", _t = "left", ra = "auto", Bn = [Pt, Gt, Ut, _t], Ke = "start", _n = "end", Ew = "clippingParents", Ds = "viewport", fn = "popper", Sw = "reference", pi = /* @__PURE__ */ Bn.reduce(function(t, e) {
  return t.concat([e + "-" + Ke, e + "-" + _n]);
}, []), js = /* @__PURE__ */ [].concat(Bn, [ra]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ke, e + "-" + _n]);
}, []), Tw = "beforeRead", Cw = "read", Rw = "afterRead", Ow = "beforeMain", Pw = "main", _w = "afterMain", Iw = "beforeWrite", $w = "write", Mw = "afterWrite", Aw = [Tw, Cw, Rw, Ow, Pw, _w, Iw, $w, Mw];
function Qt(t) {
...
function Ze(t, e, n) {
  ...
  var s = Pe(t) ? Bt(t) : window, l = s.visualViewport, c = !Bs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: p,
...
function Gw(t) {
  ...
  if (!(!a || !s)) {
    var m = Lw(o.padding, n), w = aa(a), h = c === "y" ? Pt : _t, b = c === "y" ? Gt : Ut, f = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Vn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - g / 2, S = m[h], v = T - w[p] - m[b], _ = T / 2 - w[p] / 2 + C, F = En(S, _, v), R = c;
...
function wi(t) {
  ...
  h = g.x, f = g.y;
  var k = s.hasOwnProperty("x"), T = s.hasOwnProperty("y"), C = _t, S = Pt, v = window;
  if (d) {
    ...
    if (_ === Bt(n) && (_ = we(n), ae(_).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), _ = _, o === Pt || (o === _t || o === Ut) && a === _n) {
      S = Gt;
      var I = m && _ === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[F]
      );
    ...
    if (o === _t || (o === Pt || o === Gt) && a === _n) {
      C = Ut;
      var L = m && _ === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        _[R]
      );
      h -= L - r.width, h *= c ? 1 : -1;
...
function mi(t, e, n) {
  return e === Ds ? vo(tf(t, n)) : Pe(e) ? nf(e, n) : vo(ef(we(t)));
}
function rf(t) {
...
function In(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Ew : l, d = n.rootBoundary, p = d === void 0 ? Ds : d, m = n.elementContext, w = m === void 0 ? fn : m, h = n.altBoundary, b = h === void 0 ? !1 : h, f = n.padding, g = f === void 0 ? 0 : f, k = Fs(typeof g != "number" ? g : Ls(g, Bn)), T = w === fn ? Sw : fn, C = t.rects.popper, S = t.elements[b ? T : w], v = of(Pe(S) ? S : S.contextElement || we(t.elements.popper), c, p, s), _ = Ze(t.elements.reference), F = Us({
    reference: _,
    element: C,
    placement: o
...
function lf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    ...
    }, []), v = e.rects.reference, _ = e.rects.popper, F = /* @__PURE__ */ new Map(), R = !0, I = S[0], L = 0; L < S.length; L++) {
...
function bf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, m = n.padding, w = n.tether, h = w === void 0 ? !0 : w, b = n.tetherOffset, f = b === void 0 ? 0 : b, g = In(e, {
    ...
    padding: m,
    altBoundary: p
  }), k = Kt(e.placement), T = Qe(e.placement), C = !T, S = ia(k), v = gf(S), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (_) {
    if (a) {
      var J, j = S === "y" ? Pt : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = _[S], H = G + g[j], rt = G - g[M], N = h ? -R[A] / 2 : 0, O = T === Ke ? F[A] : R[A], U = T === Ke ? -R[A] : -F[A], X = e.elements.arrow, z = h && X ? aa(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var fe, Ct = S === "x" ? Pt : _t, Ln = S === "x" ? Gt : Ut, Ht = _[v], $e = v === "y" ? "height" : "width", me = Ht + g[Ct], Me = Ht - g[Ln], Ae = [Pt, _t].indexOf(k) !== -1, De = (fe = D == null ? void 0 : D[v]) != null ? fe : 0, he = Ae ? me : Ht - F[$e] - R[$e] - De + L.altAxis, on = Ae ? Ht + F[$e] + R[$e] - De - L.altAxis : Me, Gn = h && Ae ? Fw(he, Ht, on) : En(h ? he : me, Ht, h ? on : Me);
      _[v] = Gn, tt[v] = Gn - Ht;
    }
        ...
        if (!w) {
          ...
          if (vi(T, C)) {
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var v = p.orderedModifiers[S], _ = v.fn, F = v.options, R = F === void 0 ? {} : F, I = v.name;
...
var Of = [Jw, hf, Ww, Bw, ff, cf, vf, Xw, pf], Pf = /* @__PURE__ */ Rf({
  defaultModifiers: Of
});
const _f = "Popper";
function If(t) {
...
const jf = () => qo({
  ...
  const _ = Af(p, s), [F, R] = B.useState(_), [I, L] = B.useState(ur(o));
  B.useEffect(() => {
...
const Xf = {
  ...
  } = e, k = St(e, Uf), T = gn(), C = B.useRef(), S = Ys(), v = B.useRef(null), _ = Re(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
const Yf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Hf = jn(Xs, {
  ...
  const o = _s(), a = na({
    ...
    slots: C,
    slotProps: S
  } = a, v = St(a, Yf), _ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = P({
    anchorEl: s,
    container: p,
    disablePortal: m,
    keepMounted: w,
...
const qs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const _ = na({
    ...
    TransitionProps: Et
  } = _, V = St(_, Wf), Nt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
...
`));
  const sl = B.useMemo(() => {
    ...
    touch: me.current
  }), Gr = Jf(cn), xa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Zf, Na = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : wr, ka = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Qf, Ea = (p = (m = Q.arrow) != null ? m : I.Arrow) != null ? p : tm, ll = bn(xa, P({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ke(Gr.popper, Y == null ? void 0 : Y.className, (h = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : h.className)
  }), cn), cl = bn(Na, P({}, Et, (f = Z.transition) != null ? f : L.transition), cn), dl = bn(ka, P({}, (g = Z.tooltip) != null ? g : L.tooltip, {
...
function lm({
  ...
  const [c, d] = ut(!1), [p, m] = ut(!1), w = Tt(() => {
    ...
    S.stopPropagation(), d((v) => {
      const _ = !v;
      return _ && S.shiftKey ? m(!0) : _ || m(!1), _;
    });
  }, []), b = Tt(
    (S) => (w(), r(S)),
    [r, w]
  ...
  pe(() => {
    if (c) {
      ...
      if (S) {
        const v = S.getBoundingClientRect(), _ = window.scrollY, F = window.scrollX, R = v.top + _ + S.clientHeight, I = v.left + F;
        g({ top: R, left: I });
      }
    }
  }, [c, o]);
...
function Th({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ y(_o, { children: [
