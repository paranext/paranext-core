...
import b, { forwardRef as Qe, useRef as W, useMemo as j, useState as I, useCallback as G, useLayoutEffect as Ft, createContext as yn, useContext as cr, useEffect as q, Component as es, createElement as Or, Suspense as ns, createRef as rs, Fragment as so } from "react";
import { Command as vt } from "cmdk";
import { X as Me, Search as io, Check as Tt, Clock as Ir, ChevronsLeft as Ar, ChevronsRight as Pr, ChevronLeft as qn, ChevronRight as _e, ArrowLeft as os, ArrowRight as as, Circle as Nn, ChevronDown as Oe, BoldIcon as ss, ItalicIcon as is, UnderlineIcon as ls, StrikethroughIcon as ws, AtSign as lo, Pencil as cs, Trash2 as ds, ArrowUp as wo, MoreHorizontal as co, MailOpen as ps, Mail as us, ChevronUp as po, FilterIcon as ms, ArrowLeftIcon as fs, ChevronLeftIcon as hs, ChevronRightIcon as gs, ArrowRightIcon as bs, Copy as uo, Filter as vs, User as xs, Link as ys, CircleHelp as Ns, ChevronsUpDown as mo, Star as ks, SquareX as fo, FunctionSquare as ho, SquareSigma as go, AlertCircle as Hn, CircleCheckIcon as _s, CircleXIcon as Cs, CircleHelpIcon as Es, ArrowUpIcon as Ts, ArrowDownIcon as Rs, ArrowUpDownIcon as Ss, Ban as Ds, PanelLeft as Ms, PanelRight as Os, ScrollText as Is, MenuIcon as As, Menu as Ps, EllipsisVertical as $s, LoaderCircle as Ls, GripVertical as Vs } from "lucide-react";
...
import { includes as sn, Section as U, getChaptersForBook as Fs, formatScrRef as ue, getSectionForBook as Ge, formatRelativeDate as Bs, formatReplacementString as pe, sanitizeHtml as Gs, NumberFormat as Ks, formatBytes as Us, getCurrentLocale as qs, getFormatCallerFunction as Hs, deepEqual as Ys, isString as $r, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { createEditor as vo, $getRoot as Zt, $createParagraphNode as kn, $getSelection as Bt, HISTORY_MERGE_TAG as dr, ParagraphNode as xo, TextNode as yo, $isTokenOrSegmented as Xs, $getCharacterOffsets as Ws, $cloneWithPropertiesEphemeral as Js, $findMatchingParent as Zs, $isElementNode as me, CLEAR_EDITOR_COMMAND as No, COMMAND_PRIORITY_EDITOR as ko, $isRangeSelection as Xe, shallowMergeConfig as Qs, defineExtension as Kt, safeCast as tn, RootNode as ti, LineBreakNode as ei, TabNode as ni, $isEditorState as ri, createCommand as oi, CLICK_COMMAND as ai, isDOMNode as si, $getNodeFromDOMNode as ii, $isNodeSelection as li, $createNodeSelection as wi, $setSelection as ci, COMMAND_PRIORITY_LOW as di, DecoratorNode as pi, $create as ui, $getNodeByKey as mi, INDENT_CONTENT_COMMAND as Lr, COMMAND_PRIORITY_CRITICAL as pr, KEY_TAB_COMMAND as fi, $createRangeSelection as hi, $normalizeSelection__EXPERIMENTAL as gi, OUTDENT_CONTENT_COMMAND as bi, INSERT_TAB_COMMAND as vi, $isBlockElementNode as mn, $isDecoratorNode as xi, $isParagraphNode as yi, $isTextNode as fn, SELECTION_CHANGE_COMMAND as _o, FORMAT_TEXT_COMMAND as Ni, getRegisteredNode as ki, isHTMLElement as _i, isDocumentFragment as Vr, isDOMDocumentNode as Ci, ArtificialNode__DO_NOT_USE as Co, $createLineBreakNode as Eo, $isRootOrShadowRoot as Ei, isBlockDomNode as jr, isInlineDomNode as zr, $insertNodes as Ti } from "lexical";
...
import { useReactTable as Do, getFilteredRowModel as $i, getSortedRowModel as Mo, getPaginationRowModel as Li, getCoreRowModel as Oo, flexRender as Ke, getGroupedRowModel as Vi, getExpandedRowModel as ji } from "@tanstack/react-table";
...
const Hi = Et.Root, Yi = Et.Portal, Io = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Overlay,
  {
    ref: n,
    className: f(
...
Io.displayName = Et.Overlay.displayName;
...
Ao.displayName = Et.Content.displayName;
...
$o.displayName = Et.Title.displayName;
...
Lo.displayName = vt.Separator.displayName;
...
const Fo = Qe(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: f(Ji({ variant: e, size: n, className: t })), ref: s, ...a })
);
V.displayName = "Button";
const ne = Ce.Root, re = Ce.Trigger, Yd = Ce.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ct();
...
function Br({
  ...
  if (t)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Ot(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      At,
      {
        value: `${t} ${fe[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Wd({
  ...
  const w = ct(), [p, m] = I(!1), [h, u] = I(""), [g, x] = I(""), [v, y] = I("books"), [N, _] = I(void 0), [S, z] = I(!1), L = W(void 0), k = W(void 0), R = W(void 0), E = W(void 0), T = W({}), P = G(
    (O) => {
      e(O), l && l(O);
    },
    [e, l]
    ...
    (O) => {
      ...
      if ((v === "chapters" || v === "books" && C) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        ...
        bt !== pt && (O.preventDefault(), O.stopPropagation(), u(tr(Q, a, bt)), setTimeout(() => {
...
), wt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(bo.Root, { ref: n, className: f("pr-twp", nl(), t), ...e }));
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, il = Go ? Ft : q, wn = { tag: dr };
function ll({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = sl(null, o), p = vo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          case "string": {
            ...
            m.setEditorState(u, wn);
            break;
          }
          case "object":
            m.setEditorState(h, wn);
            break;
          case "function":
            m.update(() => {
              Zt().isEmpty() && h(m);
...
function gl() {
  return function(t) {
    const [e] = Pt(), n = j(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = W(o);
    return fl(() => {
...
function bl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Xs(e) && o !== null) {
    ...
    if (w || p) {
      const [m, h] = Ws(t), u = l.is(c), g = e.is(i ? c : l), x = e.is(i ? l : c);
      let v, y = 0;
      u ? (y = m > h ? h : m, v = m > h ? m : h) : g ? (y = i ? h : m, v = void 0) : x && (y = 0, v = i ? m : h);
      const N = e.__text.slice(y, v);
      N !== e.__text && (n === "clone" && (e = Js(e)), e.__text = N);
    }
  }
  return e;
}
...
function Gr(t) {
  const e = Zs(t, (n) => me(n) && !n.isInline());
...
Kt({ build: (t, e, n) => En(e), config: tn({ $onClear: Wo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const xr = 0, or = 1, ta = 2, Ln = 3, cn = 4, ye = 5, Vn = 6, ze = 7;
function jn(t) {
  return t.id === xr;
}
function ea(t) {
...
const Ol = Kt({ config: tn({ setOptions: Hr, updateOptions: Hr }), init: ({ $initialEditorState: t = Ml }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ti, yo, ei, ni, xo] }), Yr = Symbol.for("@lexical/extension/LexicalBuilder");
function Xr() {
}
function Il(t) {
  throw t;
...
const Al = /* @__PURE__ */ new Set(), Wr = Kt({ build(t, e, n) {
  const o = n.getDependency(rr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Zo(() => {
  }, () => te(() => {
...
Kt({ dependencies: [rr, Wr], name: "@lexical/extension/HorizontalRule", nodes: [Ee], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Wr).output, a = We({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Qt(t.registerCommand(ai, (i) => {
    if (si(i.target)) {
      const l = ii(i.target);
    ...
    return !1;
  }, di), t.registerMutationListener(Ee, (i, l) => {
    _l(() => {
      let c = !1;
    ...
    const i = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(te(() => {
      const w = l.value;
      w && (c.value ? qo(w, s) : yl(w, s));
    }));
    return Qt(...i);
  }));
} });
function Ll(t, e) {
  return Qt(t.registerCommand(fi, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Nl(i, (h) => mn(h) && h.canIndent() ? h : null).length > 0) return !0;
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Xe(g)) {
                ...
                if (fn(v) && w >= 0 && p >= 0 && (y = w, N = w + p, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), fn(v)) {
                  y = h, N = h + u;
...
Kt({ build: (t, e, n) => En(e), config: tn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => te(() => n.getOutput().disabled.value ? void 0 : oa(t)) });
function Bl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return yr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(ns, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Ii(p, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Ul({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    yr(() => Qt(Mi(a), oa(a)), [a]);
  }(o), d(st, { children: [t, r(ql, { content: e }), r(Kl, { editor: o, ErrorBoundary: n })] });
}
...
function Ql(t, e) {
  ...
  return d(st, { children: [r(Jl, { editor: a, ...o, ref: e }), n != null && r(tw, { editor: a, content: n })] });
}
...
function rw() {
  const [t, e] = I(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Hi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ao, { children: [
...
function ow({
  ...
  const [e] = Pt(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = rw(), c = () => {
  };
...
const la = ee(
  ...
  {
    ref: a,
    className: f(la({ variant: e, size: n, className: t })),
    ...o
  }
));
sw.displayName = To.Root.displayName;
...
function ca(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && fn(e) && (i = bl(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], c = ki(t, i.getType());
  let w;
...
function pa(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Ei(l)) && (l != null && mn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...pa(m[g], e, n, u, new Map(a), l));
  ...
  }(t) && (i = i.concat(Eo())) : me(l) && l.append(...h), i;
}
function uw(t, e, n) {
...
function tp({
  ...
  const [a, s] = I(fw), [i, l] = I(void 0), [c, w] = I(!1), p = W(void 0), m = W(null);
  q(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
      ...
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          if (y.key === "Escape")
            ...
            (N && y.metaKey || !N && y.ctrlKey) && (y.preventDefault(), y.stopPropagation(), kt(a) && h());
          }
        },
        onKeyDown: (y) => {
...
const ep = Object.freeze([
  ...
  const a = W(null), [s, i] = I(void 0), [l, c] = I(void 0), w = G(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      switch (u.key) {
        case "ArrowDown":
          z = Math.min(S + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          z = Math.max(S - 1, 0), u.preventDefault();
          break;
        case "Home":
...
Re.displayName = So.Root.displayName;
...
ga.displayName = Ae.Root.displayName;
...
ba.displayName = Ae.Fallback.displayName;
const _r = yn(void 0);
function St() {
  const t = cr(_r);
  if (!t)
...
}), $e = tt.Trigger, va = tt.Group, Cw = tt.Portal, Ew = tt.Sub, Tw = tt.RadioGroup;
    ...
    if (o && l)
      return /* @__PURE__ */ d(st, { children: [
        /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              w(!0), m(mw(t.contents)), i == null || i(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : S.key === "Enter" && S.shiftKey && (S.preventDefault(), S.stopPropagation(), kt(p) && g());
              },
              onKeyDown: (S) => {
...
function Sw({
  ...
  const O = j(
  ...
  }, [s, n]), Z = j(() => Xt.slice(1), [Xt]), Q = j(() => Z.length ?? 0, [Z.length]), pt = j(() => Q > 0, [Q]), Lt = j(() => T || Q <= 2 ? Z : Z.slice(-2), [Z, Q, T]), bt = j(() => T || Q <= 2 ? 0 : Q - 2, [Q, T]), an = j(
    ...
    D && await m({ threadId: c, contents: D }) && se();
  }, [se, k, m, C, c]), Dr = G(
    async (D) => {
      const le = kt(k) ? bn(k) : void 0, Dt = await m({
        ...D,
        contents: le,
                    ...
                    /* @__PURE__ */ d(ne, { open: A, onOpenChange: F, children: [
                      /* @__PURE__ */ r(re, { asChild: !0, children: /* @__PURE__ */ r(
                        V,
                        {
                          ...
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !dt || !x || x.length === 0 || !x.includes(i),
...
const Se = rt.Root, Mw = rt.Group, De = rt.Value, Ow = ee(
  ...
  return /* @__PURE__ */ d(
    rt.Trigger,
    {
      className: f(Ow({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const Sn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Bw({
  ...
  var L;
  const [p, m] = I([]), [h, u] = I([]), [g, x] = I({}), [v, y] = I({}), N = j(() => e ?? [], [e]), _ = Do({
    data: N,
    columns: t,
    getCoreRowModel: Oo(),
  ...
  return c ? z = Array.from({ length: 10 }).map((E, T) => `skeleton-row-${T}`).map((E) => /* @__PURE__ */ r(Vt, { children: /* @__PURE__ */ r(he, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = _.getRowModel().rows) == null ? void 0 : L.length) > 0 ? z = _.getRowModel().rows.map((k) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ d(Tn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Rn, { stickyHeader: s, children: _.getHeaderGroups().map((k) => /* @__PURE__ */ r(Vt, { children: k.headers.map((R) => /* @__PURE__ */ r(Ze, { children: R.isPlaceholder ? void 0 : Ke(R.column.columnDef.header, R.getContext()) }, R.id)) }, k.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(uo, {}) })
        ] }),
...
function ip({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ve, { children: [
    ...
    /* @__PURE__ */ r(oe, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(va, { children: w.itemType === 0 ? /* @__PURE__ */ r(st, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        zt,
        {
          checked: o[p][h],
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(st, { children: [
...
function Xw({
  ...
  const s = W(null), i = W(null), l = W(!1), [c, w] = I(t), [p, m] = I(n), [h, u] = I(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var y, N, _, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((_ = s.current) == null ? void 0 : _.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ d(It, { children: [
      /* @__PURE__ */ r(jt, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Yw(t, a, n) }) }) }),
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ r(ho, {}),
  " ",
...
function Zw({
  ...
  return /* @__PURE__ */ d(ve, { children: [
    /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ d(It, { children: [
      /* @__PURE__ */ r(Ri, { asChild: !0, children: /* @__PURE__ */ r($e, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Ww(t, n) }) }) }),
      /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r("p", { children: Jw(t, n) }) })
    ] }) }),
...
function dp({
  ...
  const c = W(null), w = rs(), [p, m] = I("generated"), [h, u] = I("*"), [g, x] = I("f"), [v, y] = I(!1), N = j(
    () => ({
      ...i,
  ...
  q(() => {
    ...
    if (R && ln("note", R)) {
      ...
      let $ = "custom";
      P === Xn ? $ = "generated" : P === Wn ? $ = "hidden" : P && u(P), m($), x(((T = R.insert.note) == null ? void 0 : T.style) ?? "f"), k = setTimeout(() => {
        var M;
  ...
  const _ = G(() => {
    ...
    if (R && ln("note", R)) {
      ...
      g !== "x" && k === "x" ? A == null || A.forEach((F) => Qw(F)) : g === "x" && k !== "x" && (A == null || A.forEach((F) => tc(F))), (M = c.current) == null || M.applyUpdate([R, { delete: 1 }]);
    }
  }, L = (k) => {
    var E, T, P, $, M;
    const R = (T = (E = c.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : T.at(0);
  ...
  return /* @__PURE__ */ d(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: nc(t.marker, l, o, w) })
      }
    )
  ] });
}
function up({
  ...
  const p = c ?? Hs(n, void 0), m = (N, _) => {
    w == null || w(N, _, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [u, g] = I(h), x = (N, _, S) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function sc({
  ...
  return /* @__PURE__ */ d(Tn, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Sn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Vt,
      {
        onClick: () => {
          e(l.reference);
...
const Dn = (t) => t === "asc" ? /* @__PURE__ */ r(Ts, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Rs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ss, { className: "tw-ms-2 tw-h-4 tw-w-4" }), mp = (t) => ({
  accessorKey: "item",
...
function yp({
  ...
  const u = Mt(n, "%webView_inventory_all%"), g = Mt(n, "%webView_inventory_approved%"), x = Mt(n, "%webView_inventory_unapproved%"), v = Mt(n, "%webView_inventory_unknown%"), y = Mt(n, "%webView_inventory_scope_currentBook%"), N = Mt(n, "%webView_inventory_scope_chapter%"), _ = Mt(n, "%webView_inventory_scope_verse%"), S = Mt(n, "%webView_inventory_filter_text%"), z = Mt(
    n,
    "%webView_inventory_show_additional_items%"
  ...
  }, [k, F]), K = j(() => C.length === 0 ? [] : wc(C, E, P), [C, E, P]), dt = j(() => {
    var ft, lt;
    if (!k) return c;
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(Se, { onValueChange: (B) => $t(B), defaultValue: i, children: [
...
function dc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Ds, { className: e, size: 16 });
}
function kp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = I(""), a = j(() => {
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ d(
          At,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(dc, { icon: s.icon }) }) }),
              /* @__PURE__ */ d("div", { children: [
...
const pc = "16rem", uc = "3rem", Ea = b.createContext(void 0);
function Mn() {
...
const Ta = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), m = e ?? w, h = b.useCallback(
      (_) => {
        const S = typeof _ == "function" ? _(m) : _;
        n ? n(S) : p(S);
      },
      [n, m]
    ), u = b.useCallback(() => h((_) => !_), [h]), g = m ? "expanded" : "collapsed", y = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ea.Provider, { value: N, children: /* @__PURE__ */ r(_t, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ra = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Mn();
...
const Nc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: a,
...
Nc.displayName = "SidebarMenuAction";
...
const _c = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
_c.displayName = "SidebarMenuSkeleton";
...
Cc.displayName = "SidebarMenuSub";
const Ec = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Ec.displayName = "SidebarMenuSubItem";
const Tc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
    ...
    Ra,
    {
      ...
      children: /* @__PURE__ */ d(Da, { children: [
        /* @__PURE__ */ d(sr, { children: [
          ...
          /* @__PURE__ */ r(lr, { children: /* @__PURE__ */ r(Ma, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Oa, { children: /* @__PURE__ */ r(
            Ia,
            {
              onClick: () => w(h),
              isActive: m(h),
...
const Wt = "scrBook", Sc = "scrRef", de = "source", Dc = "details", Mc = "Scripture Reference", Oc = "Scripture Book", Aa = "Type", Ic = "Details";
function Ac(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Wt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Mc,
      cell: (o) => {
...
}, oo = (t) => `${Pc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Cp({
  sources: t,
  ...
  const [w, p] = I([]), [m, h] = I([{ id: Wt, desc: !1 }]), [u, g] = I({}), x = j(
...
function $c({
  ...
  return /* @__PURE__ */ r(
    V,
    {
      ...
      onClick: () => o(t),
      className: f(
        Pa(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Wi(
        t,
                  ...
                  Object.values(U).map((A, F) => {
                    ...
                    if (C.length !== 0)
                      return /* @__PURE__ */ d(so, { children: [
                        ...
                        F < Object.values(U).length - 1 && /* @__PURE__ */ r(Lo, {})
                      ] }, A);
                  })
                ] })
              ]
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ d(It, { children: [
...
function wr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    /* @__PURE__ */ r($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(As, {}) }) }),
    /* @__PURE__ */ r(oe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(so, { children: [
      /* @__PURE__ */ r(va, { children: /* @__PURE__ */ r(_t, { children: La(e.groups, e.items, c, t) }) }),
...
function Op({
  ...
  return /* @__PURE__ */ d(Va, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: t,
...
function Ap({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(ja, { children: [
      /* @__PURE__ */ r(za, { children: t.map((l) => /* @__PURE__ */ r(Vc, { value: l.value, children: l.value }, l.key)) }),
...
const qa = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = St();
...
const Fc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = St();
  return /* @__PURE__ */ d(
    et.CheckboxItem,
    {
...
Fc.displayName = et.CheckboxItem.displayName;
const Bc = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = St();
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
...
Bc.displayName = et.RadioItem.displayName;
const Gc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  et.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Gc.displayName = et.Label.displayName;
const Ya = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  et.Separator,
  {
    ref: n,
...
const Fe = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(It, { children: [
...
function Kc({
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ r(Ba, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(jc, { children: [
      /* @__PURE__ */ r(Ga, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        qa,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(_t, { children: Xa(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
      ...
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(Nt, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ r($e, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(V, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
...
const Hc = Qe(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ls, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), Xc = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Jc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Jc.displayName = "AlertDescription";
const Fp = nt.Root, Bp = nt.Trigger, Gp = nt.Group, Kp = nt.Portal, Up = nt.Sub, qp = nt.RadioGroup, Zc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  nt.SubTrigger,
  {
    ref: a,
    className: f(
...
Zc.displayName = nt.SubTrigger.displayName;
...
Qc.displayName = nt.SubContent.displayName;
const td = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(nt.Portal, { children: /* @__PURE__ */ r(
  nt.Content,
  {
    ref: n,
    className: f(
...
td.displayName = nt.Content.displayName;
...
ed.displayName = nt.Item.displayName;
const nd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  nt.CheckboxItem,
  {
    ref: a,
    className: f(
...
nd.displayName = nt.CheckboxItem.displayName;
const rd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  nt.RadioItem,
  {
    ref: o,
    className: f(
...
rd.displayName = nt.RadioItem.displayName;
...
od.displayName = nt.Label.displayName;
...
ad.displayName = nt.Separator.displayName;
...
const Hp = Rt.Trigger, ld = Rt.Portal, Yp = Rt.Close, Ja = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
...
Ja.displayName = Rt.Overlay.displayName;
const wd = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
pd.displayName = Rt.Title.displayName;
...
ud.displayName = Rt.Description.displayName;
...
const Qp = xt.Root, gd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ct();
  return /* @__PURE__ */ r(
    xt.List,
    {
