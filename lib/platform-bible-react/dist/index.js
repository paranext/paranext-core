...
import { jsx as r, jsxs as d, Fragment as wt } from "react/jsx-runtime";
import b, { forwardRef as wn, useRef as Z, useMemo as B, useState as M, useCallback as z, useLayoutEffect as Kt, createContext as On, useContext as Nr, useEffect as Y, Component as ks, createElement as Kr, Suspense as _s, createRef as Cs, Fragment as yo } from "react";
import { Command as bt } from "cmdk";
import { X as je, Search as No, Check as Dt, Clock as Ur, ChevronsLeft as Xr, ChevronsRight as Hr, ChevronLeft as rr, ChevronRight as Ie, ArrowLeft as Es, ArrowRight as Ts, Circle as In, ChevronDown as _e, BoldIcon as Ss, ItalicIcon as Rs, UnderlineIcon as Ds, StrikethroughIcon as Ms, AtSign as ko, Pencil as Os, Trash2 as Is, ArrowUp as _o, MoreHorizontal as Co, MailOpen as As, Mail as Ps, ChevronUp as or, FilterIcon as Vs, ArrowLeftIcon as $s, ChevronLeftIcon as Ls, ChevronRightIcon as Bs, ArrowRightIcon as js, Copy as Eo, Filter as zs, User as Fs, Link as Gs, CircleHelp as qs, ChevronsUpDown as To, Star as Ks, SquareX as So, FunctionSquare as Ro, SquareSigma as Do, AlertCircle as ar, CircleCheckIcon as Us, CircleXIcon as Xs, CircleHelpIcon as Hs, ArrowUpIcon as Ys, ArrowDownIcon as Js, ArrowUpDownIcon as Ws, PanelLeft as Zs, PanelRight as Qs, ScrollText as ti, MenuIcon as ei, Menu as ni, EllipsisVertical as ri, LoaderCircle as oi, GripVertical as ai } from "lucide-react";
import { clsx as si } from "clsx";
import { extendTailwindMerge as ii } from "tailwind-merge";
import * as Rt from "@radix-ui/react-dialog";
import { includes as bn, Section as X, getChaptersForBook as li, formatScrRef as xe, getSectionForBook as Qe, formatRelativeDate as ci, formatReplacementString as ve, sanitizeHtml as wi, NumberFormat as di, formatBytes as pi, getCurrentLocale as ui, getFormatCallerFunction as mi, deepEqual as Mo, isString as Gn, compareScrRefs as sr, scrRefToBBBCCCVVV as qn, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as Io, $getRoot as oe, $createParagraphNode as An, $getSelection as Ut, HISTORY_MERGE_TAG as kr, ParagraphNode as Ao, TextNode as Po, $isTokenOrSegmented as fi, $getCharacterOffsets as hi, $cloneWithPropertiesEphemeral as gi, $findMatchingParent as bi, $isElementNode as ye, CLEAR_EDITOR_COMMAND as Vo, COMMAND_PRIORITY_EDITOR as $o, $isRangeSelection as an, shallowMergeConfig as vi, defineExtension as Ht, safeCast as dn, RootNode as xi, LineBreakNode as yi, TabNode as Ni, $isEditorState as ki, createCommand as _i, CLICK_COMMAND as Ci, isDOMNode as Ei, $getNodeFromDOMNode as Ti, $isNodeSelection as Si, $createNodeSelection as Ri, $setSelection as Di, COMMAND_PRIORITY_LOW as Mi, DecoratorNode as Oi, $create as Ii, $getNodeByKey as Ai, INDENT_CONTENT_COMMAND as Yr, COMMAND_PRIORITY_CRITICAL as _r, KEY_TAB_COMMAND as Pi, $createRangeSelection as Vi, $normalizeSelection__EXPERIMENTAL as $i, OUTDENT_CONTENT_COMMAND as Li, INSERT_TAB_COMMAND as Bi, $isBlockElementNode as Cn, $isDecoratorNode as ji, $isParagraphNode as zi, $isTextNode as En, SELECTION_CHANGE_COMMAND as Lo, FORMAT_TEXT_COMMAND as Fi, getRegisteredNode as Gi, isHTMLElement as qi, isDocumentFragment as Jr, isDOMDocumentNode as Ki, ArtificialNode__DO_NOT_USE as Bo, $createLineBreakNode as jo, $isRootOrShadowRoot as Ui, isBlockDomNode as Wr, isInlineDomNode as Zr, $insertNodes as Xi } from "lexical";
...
import { useReactTable as qo, getFilteredRowModel as nl, getSortedRowModel as Ko, getPaginationRowModel as rl, getCoreRowModel as Uo, flexRender as tn, getGroupedRowModel as ol, getExpandedRowModel as al } from "@tanstack/react-table";
...
const ul = Rt.Root, ml = Rt.Portal, Xo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: f(
...
Xo.displayName = Rt.Overlay.displayName;
const Ho = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = pt();
...
const fl = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Rt.Description,
  {
    ref: n,
...
fl.displayName = Rt.Description.displayName;
...
Ge.displayName = bt.Input.displayName;
...
Jt.displayName = bt.List.displayName;
const un = b.forwardRef((e, t) => /* @__PURE__ */ r(bt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
un.displayName = bt.Empty.displayName;
...
Xt.displayName = bt.Group.displayName;
const Wo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  bt.Separator,
  {
    ref: n,
...
Wo.displayName = bt.Separator.displayName;
const Lt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  bt.Item,
  {
    ref: n,
    className: f(
...
Lt.displayName = bt.Item.displayName;
...
var hl = Object.defineProperty, gl = (e, t, n) => t in e ? hl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, U = (e, t, n) => gl(e, typeof t != "symbol" ? t + "" : t, n);
const Ce = [
  "GEN",
  "EXO",
  "LEV",
...
function bl(e) {
  const t = typeof e == "string" ? qe(e) : e;
  return t >= 40 && t <= 66;
}
function vl(e) {
  return (typeof e == "string" ? qe(e) : e) <= 39;
}
function ta(e) {
  return e <= 66;
}
...
const yt = class {
  ...
  constructor(t) {
    if (U(this, "name"), U(this, "fullPath"), U(this, "isPresent"), U(this, "hasVerseSegments"), U(this, "isCustomized"), U(this, "baseVersification"), U(this, "scriptureBooks"), U(this, "_type"), t == null)
...
U(yt, "Original", new yt(Pt.Original)), U(yt, "Septuagint", new yt(Pt.Septuagint)), U(yt, "Vulgate", new yt(Pt.Vulgate)), U(yt, "English", new yt(Pt.English)), U(yt, "RussianProtestant", new yt(Pt.RussianProtestant)), U(yt, "RussianOrthodox", new yt(Pt.RussianOrthodox));
let he = yt;
function to(e, t) {
  const n = t[0];
...
const gt = class H {
  constructor(t, n, o, a) {
    if (U(this, "firstChapter"), U(this, "lastChapter"), U(this, "lastVerse"), U(this, "hasSegmentsDefined"), U(this, "text"), U(this, "BBBCCCVVVS"), U(this, "longHashCode"), U(this, "versification"), U(this, "rtlMark", "‏"), U(this, "_bookNum", 0), U(this, "_chapterNum", 0), U(this, "_verseNum", 0), U(this, "_verse"), o == null && a == null)
...
U(gt, "defaultVersification", he.English), U(gt, "verseRangeSeparator", "-"), U(gt, "verseSequenceIndicator", ","), U(gt, "verseRangeSeparators", [gt.verseRangeSeparator]), U(gt, "verseSequenceIndicators", [gt.verseSequenceIndicator]), U(gt, "chapterDigitShifter", 1e3), U(gt, "bookDigitShifter", gt.chapterDigitShifter * gt.chapterDigitShifter), U(gt, "bcvMaxValue", gt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
U(gt, "ValidStatusType", oa);
...
const le = Ae.Root, ce = Ae.Trigger, Cp = Ae.Anchor, Wt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...o }, a) => {
  const s = pt();
...
Wt.displayName = Ae.Content.displayName;
function pr(e, t, n) {
...
function Dl({
  ...
  return /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ r(Wt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Yt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Xt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Lt,
      {
        onSelect: () => p(m),
...
function Ep(e, t, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function no({
  ...
  if (e)
    return /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Vt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Lt,
      {
        value: `${e} ${Ne[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Tp({
  ...
  const c = pt(), [p, m] = M(!1), [h, u] = M(""), [g, y] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [V, $] = M(!1), P = Z(void 0), x = Z(void 0), E = Z(void 0), _ = Z(void 0), S = Z({}), C = z(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ), A = B(() => o ? o() : sa, [o]), q = B(() => ({
    [X.OT]: A.filter((K) => Q.isBookOT(K)),
    [X.NT]: A.filter((K) => Q.isBookNT(K)),
    [X.DC]: A.filter((K) => Q.isBookDC(K)),
    [X.Extra]: A.filter((K) => Q.extraBooks().includes(K))
  }), [A]), I = B(() => Object.values(q).flat(), [q]), F = B(() => {
    if (!g.trim()) return q;
    const O = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    [v, j]
  ), { otLong: ht, ntLong: xt, dcLong: Nt, extraLong: de } = {
    ...
    (O) => {
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        ...
        switch (O.key) {
          case "ArrowLeft":
            nt !== 0 && (Ct = nt > 1 ? nt - 1 : zt);
            break;
          case "ArrowRight":
            nt !== 0 && (Ct = nt < zt ? nt + 1 : 1);
            break;
          case "ArrowUp":
            Ct = nt === 0 ? zt : Math.max(1, nt - ue);
            break;
          case "ArrowDown":
            Ct = nt === 0 ? 1 : Math.min(zt, nt + ue);
            break;
          default:
            return;
        }
        Ct !== nt && (O.preventDefault(), O.stopPropagation(), u(pr(lt, a, Ct)), setTimeout(() => {
          const me = S.current[Ct];
    ...
    const { isLetter: K, isDigit: st } = eo(O.key);
    (K || st) && (O.preventDefault(), y((lt) => lt + O.key), x.current.focus(), $(!1));
  }, []);
  return Kt(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const K = E.current, st = _.current, lt = st.offsetTop, nt = K.clientHeight, zt = st.clientHeight, Ct = lt - nt / 2 + zt / 2;
        K.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(pr(e.book));
    ...
    /* @__PURE__ */ r(Wt, { id: w, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      Yt,
      {
        ref: P,
        onKeyDown: Re,
        ...
        children: [
          ...
          !V && /* @__PURE__ */ d(Jt, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(wt, { children: [
              !D && Object.entries(F).map(([O, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Xt, { heading: fn(O), children: K.map((st) => /* @__PURE__ */ r(
                      ia,
                      {
                        bookId: st,
                        onSelect: (lt) => ct(lt),
              ...
              D && /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(
                Lt,
                {
              ...
              D && Vt(D.book) > 1 && /* @__PURE__ */ d(wt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Oe(D.book, a) }),
                /* @__PURE__ */ r(
                  no,
                  {
                    bookId: D.book,
...
function ur({
  ...
  const [k, T] = M(!1), V = w ?? l, $ = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], P = (x, E) => {
    ...
    /* @__PURE__ */ r(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(Yt, { children: [
          ...
          /* @__PURE__ */ r(un, { children: h }),
          /* @__PURE__ */ r(Jt, { children: $(t) ? t.map((x) => /* @__PURE__ */ r(Xt, { heading: x.groupHeading, children: x.options.map((E) => P(E, x.groupHeading)) }, x.groupHeading)) : t.map((x) => P(x)) })
        ] })
      }
    )
  ] });
...
function Dp({
  ...
  const p = Un(c, "%webView_bookSelector_currentBook%"), m = Un(c, "%webView_bookSelector_choose%"), h = Un(c, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    g(v), e(v);
...
const ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Bl = ca ? Kt : Y, xn = { tag: kr };
      ...
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = An();
            u.append(g);
            const y = ca ? document.activeElement : null;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Fl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return zl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: w }) => {
      t && s.size === 0 && i.size === 0 || e && w.has(kr) || l.isEmpty() || n(a, o, w);
    });
  }, [o, e, t, n]), null;
}
const Or = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = pn.Provider, $t = pn.Root, Gt = pn.Trigger, St = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ r(
  pn.Content,
  {
    ref: o,
    sideOffset: t,
...
St.displayName = pn.Content.displayName;
const Ir = [
  Yi,
  Ao,
  Po,
...
class ql extends ks {
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && Kl(t.resetKeys, a)) {
      var s, i;
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Hl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Yl() {
  return function(e) {
    const [t] = Bt(), n = B(() => e(t), [t, e]), [o, a] = M(() => n.initialValueFn()), s = Z(o);
    return Xl(() => {
...
Ht({ build: (e, t, n) => $n(t), config: dn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const o = n.getOutput();
  return se(() => o.disabled.value ? void 0 : e.registerRootListener((a) => {
    e.focus(() => {
...
function ha() {
  const e = oe(), t = Ut(), n = An();
  e.clear(), e.append(n), t !== null && n.select(), an(t) && (t.format = 0);
}
function ga(e, t = ha) {
  return e.registerCommand(Vo, (n) => (e.update(t), !0), $o);
}
Ht({ build: (e, t, n) => $n(t), config: dn({ $onClear: ha }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: o } = n.getOutput();
  return se(() => ga(e, o.value));
} });
function ac(e) {
...
const fr = Ht({ build: (e) => ba(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const wc = Ht({ config: dn({ setOptions: io, updateOptions: io }), init: ({ $initialEditorState: e = cc }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, o) {
...
const pc = /* @__PURE__ */ new Set(), wo = Ht({ build(e, t, n) {
  const o = n.getDependency(fr).output, a = sn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ba(() => {
  }, () => se(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let w, c = !1;
    o.value.read(() => {
      if (Ut()) for (const [p, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(p);
          continue;
        }
...
Ht({ dependencies: [fr, wo], name: "@lexical/extension/HorizontalRule", nodes: [Pe], register(e, t, n) {
  const { watchNodeKey: o } = n.getDependency(wo).output, a = sn({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return ae(e.registerCommand(Ci, (i) => {
    if (Ei(i.target)) {
      const l = Ti(i.target);
      if (mc(l)) return function(w, c = !1) {
        const p = Ut(), m = w.isSelected(), h = w.getKey();
        let u;
...
function fc(e, t) {
  return ae(e.registerCommand(Pi, (n) => {
    const o = Ut();
    if (!an(o)) return !1;
    n.preventDefault();
    const a = function(s) {
    ...
    const o = Ut();
    if (!an(o)) return !1;
    const a = o.getNodes().map((s) => ro(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, _r));
}
Ht({ build: (e, t, n) => $n(t), config: dn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return se(() => {
    if (!o.value) return fc(e, a);
  });
} });
const hc = Ht({ name: "@lexical/react/ReactProvider" });
function gc() {
...
Ht({ build: (e, t, n) => $n(t), config: dn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => se(() => n.getOutput().disabled.value ? void 0 : _a(e)) });
function xc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", e);
  for (const a of t) o.append("v", a);
...
const Vr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
...
const Ec = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Tc({ onClear: e }) {
  const [t] = Bt();
  return Ec(() => ga(t, e), [t, e]), null;
}
const Ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Sc({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: T, "data-testid": V, ...$ }, P) {
  const [x, E] = M(e.isEditable()), _ = z((C) => {
    C && C.ownerDocument && C.ownerDocument.defaultView ? e.setRootElement(C) : e.setRootElement(null);
  }, [e]), S = B(() => /* @__PURE__ */ function(...C) {
    return (A) => {
      for (const q of C) typeof q == "function" ? q(A) : q != null && (q.current = A);
    };
  }(P, _), [_, P]);
  return Ca(() => (E(e.isEditable()), e.registerEditableListener((C) => {
    E(C);
  })), [e]), r("div", { "aria-activedescendant": x ? t : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: x, "data-testid": V, id: y, ref: S, role: v, spellCheck: N, style: k, tabIndex: T, ...$ });
}
const Rc = wn(Sc);
function uo(e) {
  return e.getEditorState().read(ka(e.isComposing()));
...
const Dc = wn(Mc);
function Mc(e, t) {
  const { placeholder: n, ...o } = e, [a] = Bt();
  return d(wt, { children: [r(Rc, { editor: a, ...o, ref: t }), n != null && r(Oc, { editor: a, content: n })] });
}
...
function Vc({
  ...
  const [t] = Bt(), [n, o] = M(t), [a, s] = M("paragraph"), [i, l] = Pc(), w = () => {
  };
...
function Da(e, t, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Da(e, g, h, o);
    !a && ye(t) && y && t.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
...
function Oa(e, t, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Ui(l)) && (l != null && Cn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Oa(m[g], t, n, u, new Map(a), l));
...
function Mp({
  ...
  const h = z(() => {
    ...
    const N = Rn(a);
    t(N, i);
  }, [a, t, i]), u = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", y = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", v = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ r(Gt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
          /* @__PURE__ */ r(St, { children: /* @__PURE__ */ r("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
      ...
      /* @__PURE__ */ r(
        Wt,
        {
          ...
          children: /* @__PURE__ */ r(Yt, { children: /* @__PURE__ */ r(Jt, { children: e.map((N) => /* @__PURE__ */ r(
            Lt,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Et(a) && h());
        },
        onKeyDown: (N) => {
...
const Op = Object.freeze([
  ...
  const a = Z(null), [s, i] = M(void 0), [l, w] = M(void 0), c = z(
    ...
    if (u.isContentEditable || Hc.includes(g)) return !0;
...
const $e = b.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Go.Root,
  {
    ref: a,
    decorative: n,
...
const ja = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    rt.SubTrigger,
    {
...
const Dn = b.forwardRef(({ className: e, inset: t, ...n }, o) => {
  const a = pt(), s = Ot();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
const Fa = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    rt.RadioItem,
    {
...
const Ue = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  rt.Separator,
  {
    ref: n,
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              onKeyDown: (x) => {
                Lr(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  Sn,
...
function iw({
  ...
  const [$, P] = M(ho), [x, E] = M(!1), [_, S] = M(!1), [C, A] = M(!1), [q, I] = M(!1), [F, D] = M(!1), [G, ct] = M(void 0), [Qt, jt] = M(!1), [ut, j] = M(!1), [et, ht] = M(T), [xt, Nt] = M(!1), de = Z(void 0), [fn, He] = M(/* @__PURE__ */ new Map());
  Y(() => {
    let R = !0;
    if (!o) {
      jt(!1), j(!1), He(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
  ...
  const _t = B(() => te[0], [te]), hn = Z(null), Re = Z(void 0), pe = z(() => {
    var R;
    (R = Re.current) == null || R.call(Re), P(ho);
  }, []), O = z(() => {
    const R = !et;
    ht(R), Nt(!R), u == null || u(w, R);
  }, [et, u, w]);
  Y(() => {
    const R = hn.current;
    if (!R)
    ...
    return It(), window.addEventListener("resize", It), () => window.removeEventListener("resize", It);
  }, [_t == null ? void 0 : _t.verse]), Y(() => {
    A(!1);
  }, [o]), Y(() => {
    if (o && !et && !xt) {
      const R = setTimeout(() => {
  ...
  const K = B(
  ...
  }, [s, n]), lt = B(() => te.slice(1), [te]), nt = B(() => lt.length ?? 0, [lt.length]), zt = B(() => nt > 0, [nt]), Ct = B(() => C || nt <= 2 ? lt : lt.slice(-2), [lt, nt, C]), ue = B(() => C || nt <= 2 ? 0 : nt - 2, [nt, C]), me = B(
    () => nt === 1 ? K.singleReply : ve(K.multipleReplies, { count: nt }),
    [nt, K]
  ), bs = B(
    () => ue === 1 ? K.singleReply : ve(K.multipleReplies, { count: ue }),
    [ue, K]
  ), qr = z(async () => {
    const R = Et($) ? Rn($) : void 0;
    if (G !== void 0) {
      await p({
        threadId: w,
        contents: R,
    ...
    async (R) => {
      const It = Et($) ? Rn($) : void 0, ee = await p({
        ...R,
        contents: It,
        assignedUser: G ?? R.assignedUser
      });
      return ee && It && pe(), ee && G !== void 0 && ct(void 0), ee;
    },
    [pe, $, p, G]
  );
  return /* @__PURE__ */ r(
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("span", { className: e, children: [
                    _t.contextBefore,
                    /* @__PURE__ */ r("span", { className: "tw-font-bold", children: _t.selectedText }),
                    _t.contextAfter
                  ] })
                ]
              }
            ...
            _ && /* @__PURE__ */ r(
              L,
              {
                ...
                children: x ? /* @__PURE__ */ r(or, {}) : /* @__PURE__ */ r(_e, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
            fo,
            {
              ...
              handleDeleteComment: h,
              onEditingChange: I,
              canEditOrDelete: fn.get(_t.id) ?? !1,
              canUserResolveThread: ut
            }
          )
        ] }),
        /* @__PURE__ */ d(wt, { children: [
          zt && !o && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          o && /* @__PURE__ */ d(wt, { children: [
            ue > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r($e, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: bs }),
                    C ? /* @__PURE__ */ r(or, {}) : /* @__PURE__ */ r(_e, {})
                  ] })
                ]
              }
            ),
            ...
            y !== !1 && (!q || Et($)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (R) => {
                  R.key === "Enter" && R.shiftKey && (R.preventDefault(), R.stopPropagation(), (Et($) || G !== void 0) && qr());
                },
                onKeyDown: (R) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    G !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ve(
                    ...
                    /* @__PURE__ */ d(le, { open: F, onOpenChange: D, children: [
                      /* @__PURE__ */ r(ce, { asChild: !0, children: /* @__PURE__ */ r(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !Qt || !g || g.length === 0 || !g.includes(i),
                      ...
                      /* @__PURE__ */ r(
                        Wt,
                        {
                          ...
                          children: /* @__PURE__ */ r(Yt, { children: /* @__PURE__ */ r(Jt, { children: g == null ? void 0 : g.map((R) => /* @__PURE__ */ r(
                            Lt,
                            {
                              onSelect: () => {
                                ct(R !== s ? R : void 0), D(!1);
...
const qa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  it.ScrollDownButton,
  {
    ref: n,
    className: f("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
qa.displayName = it.ScrollDownButton.displayName;
const Te = b.forwardRef(({ className: e, children: t, position: n = "popper", ...o }, a) => {
  const s = pt();
...
dw.displayName = it.Label.displayName;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            /* @__PURE__ */ r(Ee, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Be, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Te, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ r(kt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const cn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: f(
...
function xw({
  ...
  var P;
  const [p, m] = M([]), [h, u] = M([]), [g, y] = M({}), [v, N] = M({}), k = B(() => t ?? [], [t]), T = qo({
    data: k,
    columns: e,
    getCoreRowModel: Uo(),
  ...
  let $;
  return w ? $ = Array.from({ length: 10 }).map((_, S) => `skeleton-row-${S}`).map((_) => /* @__PURE__ */ r(Ft, { children: /* @__PURE__ */ r(ke, { colSpan: V.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(gr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((P = T.getRowModel().rows) == null ? void 0 : P.length) > 0 ? $ = T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
    Ft,
    {
      onClick: () => i(x, T),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((E) => /* @__PURE__ */ r(ke, { children: tn(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    x.id
  )) : $ = /* @__PURE__ */ r(Ft, { children: /* @__PURE__ */ r(ke, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(lw, { table: T }),
    /* @__PURE__ */ d(Ln, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Bn, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(Ft, { children: x.headers.map((E) => /* @__PURE__ */ r(cn, { children: E.isPlaceholder ? void 0 : tn(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
...
function Lp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: e, children: /* @__PURE__ */ d(Se, { children: [
    ...
    /* @__PURE__ */ r(we, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(mn, { children: c.label }),
      /* @__PURE__ */ r(Ba, { children: c.itemType === 0 ? /* @__PURE__ */ r(wt, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        qt,
        {
          checked: o[p][h],
...
function Cw({
  ...
  const [N, k] = M(!1), T = z(
    (S) => {
      var A;
      const C = (A = e.find((q) => q.label === S)) == null ? void 0 : A.value;
      C && n(
        t.includes(C) ? t.filter((q) => q !== C) : [...t, C]
      );
    },
    [e, t, n]
  ), V = () => w || o, $ = B(() => {
    if (!h) return e;
    const S = e.filter((A) => A.starred).sort((A, q) => A.label.localeCompare(q.label)), C = e.filter((A) => !A.starred).sort((A, q) => {
      const I = t.includes(A.value), F = t.includes(q.value);
      return I && !F ? -1 : !I && F ? 1 : A.label.localeCompare(q.label);
    });
    return [...S, ...C];
  }, [e, t, h]), P = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(le, { open: E, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ r(ce, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Yt, { children: [
...
function Tw({
  ...
  return /* @__PURE__ */ d(Se, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ r(Gt, { asChild: !0, children: /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: Ew(e, a, n) }) }) }),
...
function Dw({
  ...
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ r(Hi, { asChild: !0, children: /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: Sw(e, n) }) }) }),
      /* @__PURE__ */ r(St, { children: /* @__PURE__ */ r("p", { children: Rw(e, n) }) })
    ] }) }),
...
function Fp({
  ...
  const w = Z(null), c = Cs(), [p, m] = M("generated"), [h, u] = M("*"), [g, y] = M("f"), [v, N] = M(!1), k = B(
    () => ({
      ...i,
  ...
  Y(() => {
    ...
    if (E && vn("note", E)) {
      ...
      let A = "custom";
      C === ir ? A = "generated" : C === lr ? A = "hidden" : C && u(C), m(A), y(((S = E.insert.note) == null ? void 0 : S.style) ?? "f"), x = setTimeout(() => {
        var q;
        (q = w.current) == null || q.applyUpdate([{ delete: 1 }, E]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const T = z(() => {
    ...
    x && vn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = h : x.insert.note.caller = p === "generated" ? ir : lr), n([x]));
  }, [p, h, n]), V = () => {
    var E;
    ...
    if (E && vn("note", E)) {
      ...
      g !== "x" && x === "x" ? I == null || I.forEach((F) => Mw(F)) : g === "x" && x !== "x" && (I == null || I.forEach((F) => Ow(F))), (q = w.current) == null || q.applyUpdate([{ delete: 1 }, E]);
    }
  }, P = () => {
    var E, _, S, C, A;
    const x = (_ = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (x && vn("note", x)) {
      const q = (S = x.insert.note) == null ? void 0 : S.style, I = (A = (C = x.insert.note) == null ? void 0 : C.contents) == null ? void 0 : A.ops;
      q || N(!1), N(
        q === "x" ? !!(I != null && I.every((F) => {
          var G, ct;
          if (!((G = F.attributes) != null && G.char)) return !0;
          const D = ((ct = F.attributes) == null ? void 0 : ct.char).style;
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ r(Gt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ d($t, { children: [
            /* @__PURE__ */ r(Gt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: V, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Eo, {}) }) }),
...
function Pw({
  ...
  /* @__PURE__ */ d("span", { className: f("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    jr(e.marker, [i], o, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = o ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", y = f(h, u);
  return /* @__PURE__ */ d(wt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(wt, { children: Iw(e.marker, l, o, c) })
      }
    )
  ] });
}
function qp({
  ...
  const p = w ?? mi(n, void 0), m = (k, T) => {
    c == null || c(k, T, a);
  }, h = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(h), y = (k, T, V) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
...
function $w({
  ...
  return /* @__PURE__ */ d(Ln, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Bn, { stickyHeader: !0, children: /* @__PURE__ */ d(Ft, { children: [
      /* @__PURE__ */ r(cn, { children: a }),
      /* @__PURE__ */ r(cn, { children: s })
    ] }) }),
    /* @__PURE__ */ r(jn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Ft,
      {
        onClick: () => {
          t(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(ke, { children: xe(l.reference, "English") }),
          /* @__PURE__ */ r(ke, { className: o, children: Vw(l.text) })
        ]
      },
...
const zn = (e) => e === "asc" ? /* @__PURE__ */ r(Ys, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ r(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ws, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Kp = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, Bw = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Wp = Object.freeze([
...
function Zp({
  ...
  const h = At(n, "%webView_inventory_all%"), u = At(n, "%webView_inventory_approved%"), g = At(n, "%webView_inventory_unapproved%"), y = At(n, "%webView_inventory_unknown%"), v = At(n, "%webView_inventory_scope_currentBook%"), N = At(n, "%webView_inventory_scope_chapter%"), k = At(n, "%webView_inventory_scope_verse%"), T = At(n, "%webView_inventory_filter_text%"), V = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = At(n, "%webView_inventory_no_results%"), [P, x] = M(!1), [E, _] = M("all"), [S, C] = M(""), [A, q] = M([]), I = B(() => {
    const j = e ?? [];
    return j.length === 0 ? [] : zw(j, a, s);
  }, [e, a, s]), F = B(() => {
    if (P) return I;
    const j = [];
    return I.forEach((et) => {
      const ht = et.items[0], xt = j.find(
        (Nt) => Nt.items[0] === ht
      );
      xt ? (xt.count += et.count, xt.occurrences = xt.occurrences.concat(et.occurrences)) : j.push({
        items: [ht],
        count: et.count,
  ...
  }, [P, I]), D = B(() => F.length === 0 ? [] : jw(F, E, S), [F, E, S]), G = B(() => {
    var ht, xt;
    if (!P) return w;
    ...
    for (let Nt = 0; Nt < j; Nt++)
      et.push(
        Lw(
          ((xt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : xt[Nt]) || "Additional Item",
          Nt + 1
        )
      );
    return [...et, ...w];
  }, [o == null ? void 0 : o.tableHeaders, w, P]);
  Y(() => {
    D.length === 0 ? q([]) : D.length === 1 && q(D[0].items);
  }, [D]);
  const ct = (j, et) => {
    et.setRowSelection(() => {
      const ht = {};
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Te, { children: [
              ...
              /* @__PURE__ */ r(kt, { value: "approved", children: u }),
              /* @__PURE__ */ r(kt, { value: "unapproved", children: g }),
              /* @__PURE__ */ r(kt, { value: "unknown", children: y })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Le, { onValueChange: (j) => Qt(j), defaultValue: i, children: [
        /* @__PURE__ */ r(Ee, { className: "tw-m-1", children: /* @__PURE__ */ r(Be, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Te, { children: [
          /* @__PURE__ */ r(kt, { value: "book", children: v }),
          /* @__PURE__ */ r(kt, { value: "chapter", children: N }),
          /* @__PURE__ */ r(kt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Xe,
...
function tu({ localizedStrings: e, markerMenuItems: t }) {
  const [n, o] = M(""), a = B(() => {
  ...
  return /* @__PURE__ */ d(Yt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(Jt, { children: [
      /* @__PURE__ */ r(un, { children: e["%markerMenu_noResults%"] }),
...
const Fw = "16rem", Gw = "3rem", Ua = b.createContext(void 0);
function Fn() {
...
const Xa = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ua.Provider, { value: k, children: /* @__PURE__ */ r(Tt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const qw = b.forwardRef(({ className: e, onClick: t, ...n }, o) => {
  const a = Fn();
  return /* @__PURE__ */ d(
    L,
    {
...
Hw.displayName = "SidebarFooter";
const Yw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  $e,
  {
    ref: n,
...
Yw.displayName = "SidebarSeparator";
...
const Jw = b.forwardRef(({ className: e, asChild: t = !1, ...n }, o) => /* @__PURE__ */ r(
  t ? ze : "button",
  {
    ref: o,
...
Jw.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const w = e ? ze : "button", { state: c } = Fn(), p = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": t,
        className: f(Ww({ variant: n, size: o }), s),
        ...i
      }
    );
...
const td = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, o) => {
...
td.displayName = "SidebarMenuSkeleton";
...
const rd = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  e ? ze : "a",
  {
    ref: s,
...
const ne = "scrBook", ad = "scrRef", be = "source", sd = "details", id = "Scripture Reference", ld = "Scripture Book", ts = "Type", cd = "Details";
function wd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: ne,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? id,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? Q.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === ne ? xe(a.start) : void 0;
      },
...
const dd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || sr(e.start, e.end) === 0 ? `${qn(e.start)}+${t}` : `${qn(e.start)}+${t}-${qn(e.end)}+${n}`;
}, vo = (e) => `${dd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function nu({
  sources: e,
  ...
  const [c, p] = M([]), [m, h] = M([{ id: ne, desc: !1 }]), [u, g] = M({}), y = B(
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ee, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Be, {}) }),
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(cw, { children: V.map((_) => /* @__PURE__ */ r(kt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ln, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ r(Bn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ft, { children: _.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ r(jn, { children: N.getRowModel().rows.map((_, S) => {
        const C = pt();
        return /* @__PURE__ */ r(
          Ft,
          {
                  ...
                  ke,
                  {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ r(_e, {}),
                          !_.getIsExpanded() && (C === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(rr, {})),
                          " ",
...
}), es = (e, t, n) => Gr(e, t).every((o) => n.includes(o));
function pd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function ud({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
  ...
  const P = B(() => Q.allBookIds.filter(
    ...
    (I, F = !1) => {
      ...
      const D = P.findIndex((ut) => ut === V.current), G = P.findIndex((ut) => ut === I);
      if (D === -1 || G === -1) return;
      const [ct, Qt] = [
        Math.min(D, G),
        Math.max(D, G)
      ], jt = P.slice(ct, Qt + 1).map((ut) => ut);
      n(
        t.includes(I) ? t.filter((ut) => !jt.includes(ut)) : [.../* @__PURE__ */ new Set([...t, ...jt])]
      );
    },
    [t, n, P]
  ), _ = (I) => {
    E(I, $.current), $.current = !1;
  }, S = (I, F) => {
    I.preventDefault(), E(F, I.shiftKey);
  }, C = z(
    (I) => {
      const F = Gr(P, I).map((D) => D);
      n(
        es(P, I, t) ? t.filter((D) => !F.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...F])]
      );
    },
    [t, n, P]
  ), A = () => {
            ...
            Yt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: A, children: w }),
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: q, children: c })
                ] }),
                /* @__PURE__ */ d(Jt, { children: [
                  /* @__PURE__ */ r(un, { children: p }),
                  Object.values(X).map((I, F) => {
                    const D = x[I];
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(yo, { children: [
                        /* @__PURE__ */ r(
                          Xt,
                          {
                            heading: aa(I, h, u, g, y),
                            children: D.map((G) => /* @__PURE__ */ r(
                              ia,
                              {
                                bookId: G,
                                isSelected: t.includes(G),
                                onSelect: () => _(G),
                                onMouseDown: (ct) => S(ct, G),
                                section: Qe(G),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: pr(G, a),
                        ...
                        F < Object.values(X).length - 1 && /* @__PURE__ */ r(Wo, {})
                      ] }, I);
                  })
                ] })
              ]
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Te,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((c) => /* @__PURE__ */ r(kt, { value: `${c}`, children: l[W(c)] }, `${c}`))
          }
        )
      ]
    }
...
function yr({
  ...
  return /* @__PURE__ */ d(Se, { variant: s, children: [
    /* @__PURE__ */ r(Ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(L, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(ei, {}) }) }),
    /* @__PURE__ */ r(we, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(yo, { children: [
      /* @__PURE__ */ r(Ba, { children: /* @__PURE__ */ r(Tt, { children: rs(t.groups, t.items, w, e) }) }),
...
as.displayName = vt.List.displayName;
...
ss.displayName = vt.List.displayName;
...
)), is = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  vt.Content,
  {
    ref: n,
    className: f(
...
is.displayName = vt.Content.displayName;
function du({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(as, { children: [
      /* @__PURE__ */ r(ss, { children: e.map((l) => /* @__PURE__ */ r(md, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ r(is, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function fd({ ...e }) {
...
const ws = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    ot.SubTrigger,
    {
...
const ps = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ot();
...
const us = b.forwardRef(({ className: e, inset: t, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ r(
    ot.Item,
    {
...
const gd = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    ot.CheckboxItem,
    {
...
gd.displayName = ot.CheckboxItem.displayName;
const bd = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    ot.RadioItem,
    {
...
bd.displayName = ot.RadioItem.displayName;
const vd = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
vd.displayName = ot.Label.displayName;
const ms = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  ot.Separator,
  {
    ref: n,
    className: f("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
function xd({
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ r(ls, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(fd, { children: [
      /* @__PURE__ */ r(cs, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        ps,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Tt, { children: fs(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function mu({
  ...
  const c = yd(
    ...
    var N, k, T, V, $, P;
    const v = y !== g ? ((k = (N = e[g]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((V = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : V.en) : void 0;
...
function Nd({ item: e, createLabel: t, createComplexLabel: n }) {
  return t ? /* @__PURE__ */ r(dt, { children: t(e) }) : n ? /* @__PURE__ */ r(dt, { children: n(e) }) : /* @__PURE__ */ r(dt, { children: e });
}
function fu({
  id: e,
  className: t,
...
const kd = wn(({ className: e, ...t }, n) => /* @__PURE__ */ r(oi, { size: 35, className: f("tw-animate-spin", e), ...t, ref: n }));
...
), Cd = b.forwardRef(({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Ed.displayName = "AlertTitle";
const Td = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Td.displayName = "AlertDescription";
const bu = at.Root, vu = at.Trigger, xu = at.Group, yu = at.Portal, Nu = at.Sub, ku = at.RadioGroup, Sd = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => /* @__PURE__ */ d(
  at.SubTrigger,
  {
    ref: a,
    className: f(
...
Sd.displayName = at.SubTrigger.displayName;
...
Rd.displayName = at.SubContent.displayName;
const Dd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(at.Portal, { children: /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: f(
...
Dd.displayName = at.Content.displayName;
const Md = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  at.Item,
  {
    ref: o,
    className: f(
...
Md.displayName = at.Item.displayName;
const Od = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => /* @__PURE__ */ d(
  at.CheckboxItem,
  {
    ref: a,
    className: f(
...
const Id = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ d(
  at.RadioItem,
  {
    ref: o,
    className: f(
...
Id.displayName = at.RadioItem.displayName;
const Ad = b.forwardRef(({ className: e, inset: t, ...n }, o) => /* @__PURE__ */ r(
  at.Label,
  {
    ref: o,
    className: f(
...
Ad.displayName = at.Label.displayName;
...
Pd.displayName = at.Separator.displayName;
...
const _u = Mt.Trigger, Ld = Mt.Portal, Cu = Mt.Close, gs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
...
gs.displayName = Mt.Overlay.displayName;
const Bd = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...o }, a) => {
...
const Fd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Mt.Title,
  {
    ref: n,
    className: f("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight", e),
...
Fd.displayName = Mt.Title.displayName;
const Gd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Mt.Description,
  {
    ref: n,
    className: f("tw-text-sm tw-text-muted-foreground", e),
...
Gd.displayName = Mt.Description.displayName;
const qd = b.forwardRef(({ className: e, value: t, ...n }, o) => /* @__PURE__ */ r(
  wr.Root,
  {
    ref: o,
    className: f(
...
qd.displayName = wr.Root.displayName;
function Eu({
  className: e,
  ...t
}) {
...
Kd.displayName = Ze.Root.displayName;
const Ud = b.forwardRef(({ className: e, ...t }, n) => {
  const o = pt();
  return /* @__PURE__ */ r(
    dr.Root,
    {
...
Ud.displayName = dr.Root.displayName;
const Du = vt.Root, Xd = b.forwardRef(({ className: e, ...t }, n) => {
  const o = pt();
  return /* @__PURE__ */ r(
    vt.List,
    {
...
Xd.displayName = vt.List.displayName;
...
Yd.displayName = vt.Content.displayName;
...
export {
  ...
  Zp as Inventory,
  dt as Label,
  Qp as MARKER_MENU_STRING_KEYS,
  Pp as MarkdownRenderer,
  tu as MarkerMenu,
  Bp as MoreInfo,
  Cw as MultiSelectComboBox,
  du as NavigationContentSearch,
  le as Popover,
  Cp as PopoverAnchor,
  ...
  ed as SidebarMenuSub,
  rd as SidebarMenuSubButton,
  nd as SidebarMenuSubItem,
  Xa as SidebarProvider,
  Kw as SidebarRail,
  Yw as SidebarSeparator,
  qw as SidebarTrigger,
  gr as Skeleton,
  Kd as Slider,
  Ru as Sonner,
  kd as Spinner,
