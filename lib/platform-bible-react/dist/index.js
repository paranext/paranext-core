...
var sn = (e, t, n) => (yl(e, typeof t != "symbol" ? t + "" : t, n), n);
import xl, { jsxs as ie, jsx as x, Fragment as lr } from "react/jsx-runtime";
import * as C from "react";
import ve, { forwardRef as ps, useCallback as Te, useState as Ce, useRef as Rt, useEffect as mt, useLayoutEffect as ai, useMemo as Jt } from "react";
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Bt(pt[s]);
        } catch {
...
function pv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ce(""), [o, i] = Ce(
    ...
    ku.forEach((N) => {
      const R = n.match(N);
      if (R) {
        const [k, _ = void 0, A = void 0] = R.slice(1), I = Nu(k);
        ...
        children: [
          ...
          gi.map(
            (N, R) => w(N).length > 0 && /* @__PURE__ */ ie("div", { children: [
              ...
              gi.length - 1 !== R ? /* @__PURE__ */ x(Os, {}) : void 0
            ] }, N)
          )
        ]
      }
...
const As = Qt(l.element, Is);
As.isRequired = Qt(l.element.isRequired, Is);
const On = As;
function Gu(e) {
  const {
    prototype: t = {}
...
const qu = Qt(l.elementType, Uu), Wu = "exact-prop: ​";
function Ds(e) {
...
function qc(e) {
  const {
    ...
    open: d,
    rootRef: g
  } = e, p = C.useRef({}), f = C.useRef(null), h = C.useRef(null), m = qe(h, g), [v, w] = C.useState(!d), P = Gc(u);
  let y = !0;
...
var Ie = "top", We = "bottom", Xe = "right", Ae = "left", Ro = "auto", $n = [Ie, We, Xe, Ae], Wt = "start", kn = "end", Wc = "clippingParents", Qs = "viewport", un = "popper", Xc = "reference", Ii = /* @__PURE__ */ $n.reduce(function(e, t) {
...
var kt = Math.max, nr = Math.min, Xt = Math.round;
function oo() {
...
function pd(e) {
  ...
  if (!(!i || !s)) {
    var g = dd(o.padding, n), p = To(i), f = u === "y" ? Ie : Ae, h = u === "y" ? We : Xe, m = n.rects.reference[d] + n.rects.reference[u] - s[u] - n.rects.popper[d], v = s[u] - n.rects.reference[u], w = _n(i), P = w ? u === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, y = m / 2 - v / 2, S = g[f], b = P - p[d] - g[h], E = P / 2 - p[d] / 2 + y, $ = yn(S, E, b), D = u;
...
function Di(e) {
  ...
  if (c) {
    ...
    if (E === je(n) && (E = bt(n), at(E).position !== "static" && a === "absolute" && ($ = "scrollHeight", D = "scrollWidth")), E = E, o === Ie || (o === Ae || o === Xe) && i === kn) {
      S = We;
...
function Tn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, u = a === void 0 ? Wc : a, c = n.rootBoundary, d = c === void 0 ? Qs : c, g = n.elementContext, p = g === void 0 ? un : g, f = n.altBoundary, h = f === void 0 ? !1 : f, m = n.padding, v = m === void 0 ? 0 : m, w = oa(typeof v != "number" ? v : ia(v, $n)), P = p === un ? Xc : un, y = e.rects.popper, S = e.elements[h ? P : p], b = Td(Nt(S) ? S : S.contextElement || bt(e.elements.popper), u, d, s), E = Yt(e.elements.reference), $ = aa({
    reference: E,
    element: y,
    strategy: "absolute",
    placement: o
  }), D = io(Object.assign({}, y, $)), F = p === un ? D : E, B = {
...
function Pd(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, a = n.flipVariations, u = n.allowedAutoPlacements, c = u === void 0 ? ea : u, d = Kt(r), g = d ? a ? Ii : Ii.filter(function(h) {
    return Kt(h) === d;
...
function Nd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !0 : s, u = n.fallbackPlacements, c = n.padding, d = n.boundary, g = n.rootBoundary, p = n.altBoundary, f = n.flipVariations, h = f === void 0 ? !0 : f, m = n.allowedAutoPlacements, v = t.options.placement, w = Je(v), P = w === v, y = u || (P || !h ? [Xn(v)] : Od(v)), S = [v].concat(y).reduce(function(z, G) {
...
function Bd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, c = n.rootBoundary, d = n.altBoundary, g = n.padding, p = n.tether, f = p === void 0 ? !0 : p, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = Tn(t, {
    ...
    padding: g,
    altBoundary: d
  }), w = Je(t.placement), P = Kt(t.placement), y = !P, S = Po(w), b = Ld(S), E = t.modifiersData.popperOffsets, $ = t.rects.reference, D = t.rects.popper, F = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, B = typeof F == "number" ? {
    mainAxis: F,
    altAxis: F
  ...
  if (E) {
    if (i) {
      var k, _ = S === "y" ? Ie : Ae, A = S === "y" ? We : Xe, I = S === "y" ? "height" : "width", j = E[S], ne = j + v[_], Q = j - v[A], O = f ? -D[I] / 2 : 0, L = P === Wt ? $[I] : D[I], H = P === Wt ? -D[I] : -$[I], X = t.elements.arrow, z = f && X ? To(X) : {
        width: 0,
        height: 0
      }, G = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ra(), q = G[_], W = G[A], U = yn(0, $[I], z[I]), Y = y ? $[I] / 2 - O - U - q - B.mainAxis : L - U - q - B.mainAxis, Z = y ? -$[I] / 2 + O + U + W + B.mainAxis : H + U + W + B.mainAxis, se = t.elements.arrow && _n(t.elements.arrow), V = se ? S === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, te = (k = N == null ? void 0 : N[S]) != null ? k : 0, M = j + Y - te - V, ae = j + Z - te, Ee = yn(f ? nr(ne, M) : ne, j, f ? kt(Q, ae) : Q);
      E[S] = Ee, R[S] = Ee - j;
    }
    if (a) {
      var $e, xe = S === "x" ? Ie : Ae, yt = S === "x" ? We : Xe, _e = E[b], tt = b === "y" ? "height" : "width", Fe = _e + v[xe], nt = _e - v[yt], Re = [Ie, Ae].indexOf(w) !== -1, _t = ($e = N == null ? void 0 : N[b]) != null ? $e : 0, xt = Re ? Fe : _e - $[tt] - D[tt] - _t + B.altAxis, en = Re ? _e + $[tt] + D[tt] - _t - B.altAxis : nt, Dn = f && Re ? cd(xt, _e, en) : yn(f ? xt : Fe, _e, f ? en : nt);
      E[b] = Dn, R[b] = Dn - _e;
    }
    t.modifiersData[r] = R;
  }
...
function Ud(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ue(t), o = Ue(t) && Gd(t), i = bt(t), s = Yt(e, o, n), a = {
    scrollLeft: 0,
    scrollTop: 0
  }, u = {
    x: 0,
  ...
  $o(i)) && (a = Hd(t)), Ue(t) ? (u = Yt(t, !0), u.x += t.clientLeft, u.y += t.clientTop) : i && (u.x = No(i))), {
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (zi(P, y)) {
            d.rects = {
              reference: Ud(P, _n(y), d.options.strategy === "fixed"),
              popper: To(y)
...
const op = () => ut({
  ...
  } = t, v = ge(t, ep), w = C.useRef(null), P = qe(w, n), y = C.useRef(null), S = qe(y, p), b = C.useRef(S);
  Pt(() => {
    b.current = S;
  }, [S]), C.useImperativeHandle(p, () => y.current, []);
  const E = np(d, s), [$, D] = C.useState(E), [F, B] = C.useState(rr(o));
  C.useEffect(() => {
...
`));
  ...
  const R = op(), k = (r = h.root) != null ? r : "div", _ = Ot({
    elementType: k,
  ...
  const {
    ...
    slotProps: v = {},
    slots: w = {}
  } = t, P = ge(t, tp), [y, S] = C.useState(!0), b = () => {
    S(!1);
  }, E = () => {
    S(!0);
  };
...
process.env.NODE_ENV !== "production" && (ua.propTypes = {
   ...
   */
  anchorEl: Qt(l.oneOfType([st, l.object, l.func]), (e) => {
    if (e.open) {
...
function mf(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, a = {}) => {
    Jl(s, (b) => b.filter((E) => !(E != null && E.__mui_systemSx)));
    const {
      name: u,
      slot: c,
    ...
    const P = Yl(s, T({
      shouldForwardProp: w,
      label: v
    }, f)), y = (b) => typeof b == "function" && b.__emotion_real !== b || Et(b) ? (E) => Kn(b, T({}, E, {
      theme: zn({
        theme: E.theme,
        defaultTheme: n,
        themeId: t
...
const Cf = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Vt = $f, _f = ["mode", "contrastThreshold", "tonalOffset"], Xi = {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Yi(m, "light", P, r), Yi(m, "dark", y, r), m.contrastText || (m.contrastText = g(m.main)), m;
  }, f = {
    dark: Dr,
    light: Xi
  };
...
var ag = function(t) {
  return t.scrollTop;
}, hn = "unmounted", St = "exited", Ct = "entering", zt = "entered", ao = "exiting", dt = /* @__PURE__ */ function(e) {
  ig(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, a = s && !s.isMounting ? r.enter : r.appear, u;
    return i.appearStatus = null, r.in ? a ? (u = St, i.appearStatus = Ct) : u = zt : r.unmountOnExit || r.mountOnEnter ? u = hn : u = St, i.state = {
      status: u
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== Ct && s !== zt && (i = Ct) : (s === Ct || s === zt) && (i = ao);
    }
...
const ug = {
  ...
  const {
  ...
  } = t, w = ge(t, lg), P = gn(), y = C.useRef(), S = An(), b = C.useRef(null), E = qe(b, i.ref, n), $ = (A) => (I) => {
    if (A) {
      const j = b.current;
      I === void 0 ? A(j) : A(j, I);
    }
    ...
    m === "auto" ? (Q = S.transitions.getAutoHeightDuration(A.clientHeight), y.current = Q) : Q = I, A.style.transition = [S.transitions.create("opacity", {
      ...
      duration: Fr ? Q : Q * 0.666,
      delay: Fr ? j : j || Q * 0.333,
      easing: ne
...
const uo = Bo, cg = (e) => {
  ...
  const o = fa(), i = ct({
    ...
    slots: y,
    slotProps: S
  } = i, b = ge(i, dg), E = (r = y == null ? void 0 : y.root) != null ? r : u == null ? void 0 : u.Root, $ = T({
    anchorEl: s,
    container: d,
    disablePortal: g,
    keepMounted: p,
...
const xa = /* @__PURE__ */ C.forwardRef(function(t, n) {
  ...
  const E = ct({
    ...
    TransitionProps: te
  } = E, M = ge(E, mg), ae = /* @__PURE__ */ C.isValidElement(D) ? D : /* @__PURE__ */ x("span", {
    children: D
  }), Ee = An(), $e = Ee.direction === "rtl", [xe, yt] = C.useState(), [_e, tt] = C.useState(null), Fe = C.useRef(!1), nt = _ || Q, Re = gn(), _t = gn(), xt = gn(), en = gn(), [Dn, Wo] = Bs({
    controlled: G,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Sr = Ls(O), tn = C.useRef(), Fn = En(() => {
  ...
  const Xo = (re) => {
    ...
    ei(re), xt.clear(), Re.clear(), Fn(), tn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(ne, () => {
      document.body.style.WebkitUserSelect = tn.current, Cr(re);
    });
  }, dl = (re) => {
  ...
  }, nn = {}, Rr = typeof se == "string";
  N ? (nn.title = !rt && Rr && !k ? se : null, nn["aria-describedby"] = rt ? Sr : null) : (nn["aria-label"] = Rr ? se : null, nn["aria-labelledby"] = rt && !Rr ? Sr : null);
...
`));
  const gl = C.useMemo(() => {
    ...
    touch: Fe.current
  }), kr = vg(on), ri = (r = (o = Z.popper) != null ? o : F.Popper) != null ? r : bg, oi = (i = (s = (a = Z.transition) != null ? a : F.Transition) != null ? s : V) != null ? i : uo, ii = (u = (c = Z.tooltip) != null ? c : F.Tooltip) != null ? u : wg, si = (d = (g = Z.arrow) != null ? g : F.Arrow) != null ? d : yg, ml = mn(ri, T({}, U, (p = Y.popper) != null ? p : B.popper, {
    className: Pe(kr.popper, U == null ? void 0 : U.className, (f = (h = Y.popper) != null ? h : B.popper) == null ? void 0 : f.className)
  }), on), hl = mn(oi, T({}, te, (m = Y.transition) != null ? m : B.transition), on), vl = mn(ii, T({}, (v = Y.tooltip) != null ? v : B.tooltip, {
    className: Pe(kr.tooltip, (w = (P = Y.tooltip) != null ? P : B.tooltip) == null ? void 0 : w.className)
  }), on), bl = mn(si, T({}, (y = Y.arrow) != null ? y : B.arrow, {
...
const Na = /* @__PURE__ */ C.forwardRef(function(t, n) {
  ...
  const m = (y) => {
    ...
    if (b === "ArrowDown")
      y.preventDefault(), pn(S, E, c, u, Lr);
    else if (b === "ArrowUp")
      y.preventDefault(), pn(S, E, c, u, is);
    else if (b === "Home")
      ...
      const B = E && !$.repeating && Oa(E, $);
      $.previousKeyMatched && (B || pn(S, E, !1, u, Lr, $)) ? y.preventDefault() : $.previousKeyMatched = !1;
    }
    d && d(y);
  }, v = qe(f, n);
  let w = -1;
...
const qg = Na, Wg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Xg = {
  ...
  } = t, y = ge(t, Wg), S = C.useRef(null), b = qe(S, a.ref, n), E = (_) => (A) => {
    if (_) {
      const I = S.current;
      A === void 0 ? _(I) : _(I, A);
    }
...
const nm = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], rm = (e) => {
  ...
  const W = (r = (o = _ == null ? void 0 : _.root) != null ? o : w.Root) != null ? r : om, U = (i = (s = _ == null ? void 0 : _.backdrop) != null ? s : w.Backdrop) != null ? i : d, Y = (a = k == null ? void 0 : k.root) != null ? a : P.root, Z = (u = k == null ? void 0 : k.backdrop) != null ? u : P.backdrop, se = Ot({
    elementType: W,
    externalSlotProps: Y,
...
const hm = (e) => {
  ...
  const s = ct({
  ...
  } = s, B = ge(s.TransitionProps, fm), N = ge(s, gm), R = (r = S == null ? void 0 : S.paper) != null ? r : P, k = C.useRef(), _ = qe(k, R.ref), A = T({}, s, {
    anchorOrigin: c,
    anchorReference: g,
    elevation: m,
    marginThreshold: v,
    ...
    const te = Jn(u), M = te && te.nodeType === 1 ? te : Oe(k.current).body, ae = M.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
  ...
  }, [u, c.horizontal, c.vertical, d, g]), ne = C.useCallback((te) => ({
    vertical: ss(te, b.vertical),
    horizontal: as(te, b.horizontal)
  }), [b.horizontal, b.vertical]), Q = C.useCallback((te) => {
    const M = {
    ...
    const yt = $e + M.height, _e = xe + M.width, tt = qt(Jn(u)), Fe = tt.innerHeight - v, nt = tt.innerWidth - v;
    if (v !== null && $e < v) {
      const Re = $e - v;
      $e -= Re, ae.vertical += Re;
...
process.env.NODE_ENV !== "production" && (Da.propTypes = {
   ...
   */
  anchorEl: Qt(l.oneOfType([st, l.func]), (e) => {
...
const ym = ["onEntering"], xm = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Sm = {
  ...
  const i = ct({
    ...
    slots: P = {},
    slotProps: y = {}
  } = i, S = ge(i.TransitionProps, ym), b = ge(i, xm), E = An(), $ = E.direction === "rtl", D = T({}, i, {
    autoFocus: s,
    ...
    TransitionProps: S,
    variant: w
  }), F = Em(D), B = s && !c && p, N = C.useRef(null), R = (Q, O) => {
  ...
  C.Children.map(a, (Q, O) => {
    /* @__PURE__ */ C.isValidElement(Q) && (process.env.NODE_ENV !== "production" && Qn.isFragment(Q) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Q.props.disabled || (w === "selectedMenu" && Q.props.selected || _ === -1) && (_ = O));
  });
  const A = (r = P.paper) != null ? r : km, I = (o = y.paper) != null ? o : f, j = Ot({
    elementType: P.root,
...
function vv({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ ie("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ x(Mt, { onClick: () => t(ci(e, 1)), children: ">" })
  ] });
}
class Mm {
  constructor() {
...
class bv {
  ...
  constructor(t, n) {
    ...
    this.src = t, this.data = n, this.resultsUpdated = new Mm();
  }
  /**
    ...
    e.getSize = () => {
      ...
      return (i) => {
        if (!r || !o || (i.persist == null || i.persist(), Ur(i) && i.touches && i.touches.length > 1))
          return;
        const s = e.getSize(), a = e ? e.getLeafHeaders().map((w) => [w.column.id, w.column.getSize()]) : [[r.id, r.getSize()]], u = Ur(i) ? Math.round(i.touches[0].clientX) : i.clientX, c = {}, d = (w, P) => {
  ...
  return (e) => K(() => [e.getState().grouping, e.getPreGroupedRowModel()], (t, n) => {
    ...
    const r = t.filter((u) => e.getColumn(u)), o = [], i = {}, s = function(u, c, d) {
      ...
      return Array.from(p.entries()).map((h, m) => {
        let [v, w] = h, P = `${g}:${v}`;
        P = d ? `${d}>${P}` : P;
        const y = s(w, c + 1, P), S = c ? La(w, (E) => E.subRows) : w, b = Ba(e, P, S[0].original, m, c, void 0, d);
...
const Ht = "scrBook", Ih = "scrRef", vn = "source", Ah = "details", Dh = "Scripture Reference", Fh = "Scripture Book", sl = "Type", Vh = "Details";
function Lh(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ue.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === Ht ? Tr(o.start) : void 0;
      },
    ...
    !t && /* @__PURE__ */ ie(
      Th,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ x(Qa, { position: "item-aligned", children: /* @__PURE__ */ x(Ph, { children: $.map((R) => /* @__PURE__ */ x(el, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ ie(tl, { className: "pr-p-0", children: [
      t && /* @__PURE__ */ x(nl, { children: S.getHeaderGroups().map((R) => /* @__PURE__ */ x(vo, { children: R.headers.filter((k) => k.column.columnDef.header).map((k) => /* @__PURE__ */ x(ol, { colSpan: k.colSpan, children: k.isPlaceholder ? void 0 : /* @__PURE__ */ ie("div", { children: [
      ...
      /* @__PURE__ */ x(rl, { children: S.getRowModel().rows.map((R, k) => /* @__PURE__ */ x(
        vo,
        {
