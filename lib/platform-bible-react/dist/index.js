...
import { c as v, g as ye, a as Wr, C as Ee, u as No, T as zt, b as Rt, d as Dt, e as Ot, A as ce, P as $e, f as Ye, B as Y, h as Ie, i as Ae, j as Pe, k as Ne, l as Bi, m as Ui, n as Ki, E as Hi, o as Xa, r as fe, p as qi, q as gn, s as aa, t as oa, L as Nt, R as Ja, v as Yr, D as Da, w as Oa, x as Ma, y as $a, z as fn, F as Lr, G as Za, H as mn, I as Qa, J as qe, K as yr, M as Ve, N as Le, O as je, S as kr, Q as er, U as Gi, V as Cr, W as We, X as De, Z as Xe, Y as Re, _ as rr, $ as to, a0 as eo, a1 as Xr, a2 as ro, a3 as vn, a4 as Wi, a5 as Yi, a6 as Xi, a7 as Ia, a8 as bn, a9 as na, aa as xn, ab as Ji, ac as Zi, ad as Qi, ae as ts, af as yn, ag as kn, ah as _n, ai as es, aj as Nn, ak as ga, al as Co, am as fa, an as rs, ao as as, ap as os, aq as ns, ar as is, as as Er, at as ao, au as ss, av as cs } from "./resizable-CqDIffSo.js";
import { aw as mg, ax as vg, ay as bg, az as xg, aA as yg, aB as kg, aC as _g, aD as Ng, aE as Cg, aF as Eg, aG as Tg, aH as Sg, aI as zg, aJ as Rg, aK as Dg, aL as Og, aM as Mg, aN as $g, aO as Ig, aP as Ag, aQ as Pg, aR as Vg, aS as Lg, aT as jg } from "./resizable-CqDIffSo.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as St } from "@sillsdev/scripture";
import { Check as Oe, Clock as Eo, ChevronsLeft as To, ChevronsRight as So, ChevronLeft as Aa, ChevronRight as Pa, ArrowLeft as ls, ArrowRight as ds, ChevronDown as nr, BoldIcon as ws, ItalicIcon as us, X as oo, AtSign as Cn, Pencil as ps, Trash2 as hs, ArrowUp as En, MoreHorizontal as gs, MailOpen as fs, Mail as ms, ChevronUp as vs, FilterIcon as bs, ArrowLeftIcon as xs, ChevronLeftIcon as ys, ChevronRightIcon as ks, ArrowRightIcon as _s, Copy as Tn, Filter as Ns, User as Cs, Link as Es, CircleHelp as Ts, Undo as Ss, Redo as zs, SquareX as Sn, FunctionSquare as zn, SquareSigma as Rn, Ban as Rs, AlertCircle as Va, CircleCheckIcon as Ds, CircleXIcon as Os, CircleHelpIcon as Ms, ArrowUpIcon as $s, ArrowDownIcon as Is, ScrollText as As, ChevronsUpDown as Ps, MenuIcon as Vs, Menu as Ls, EllipsisVertical as js, MoreVertical as Fs } from "lucide-react";
import { Section as ut, getChaptersForBook as Bs, formatScrRef as ke, getSectionForBook as jr, formatRelativeDate as Us, formatReplacementString as Ge, sanitizeHtml as no, NumberFormat as Dn, formatBytes as Ks, getCurrentLocale as Hs, usfmMarkers as Fr, getFormatCallerFunction as qs, deepEqual as Gs, isString as zo, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Ws, getLocalizeKeyForScrollGroupId as Ro, formatReplacementStringToArray as Do, collectUsjMarkers as Ys } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as $, createContext as ia, useContext as io, useState as k, useEffect as W, useCallback as j, useImperativeHandle as Xs, useLayoutEffect as Xt, Component as Js, createElement as Oo, Suspense as Zs, forwardRef as On, useId as Mo, Fragment as sa } from "react";
import { IconSelector as Mn, IconCheck as ca, IconChevronDown as Qs, IconChevronUp as tc, IconLayoutSidebar as ec, IconLayoutSidebarRight as rc, IconChevronRight as $n, IconSearch as ac, IconLoader as oc, IconAlertOctagon as nc, IconAlertTriangle as ic, IconInfoCircle as sc, IconCircleCheck as cc } from "@tabler/icons-react";
import { createEditor as In, $getRoot as Me, $createParagraphNode as Tr, $getSelection as Jt, HISTORY_MERGE_TAG as so, ParagraphNode as An, TextNode as Pn, $getPreviousSelection as lc, $isRangeSelection as he, $caretFromPoint as dc, $getSiblingCaret as Vn, $getChildCaret as wc, $getAdjacentChildCaret as uc, $isChildCaret as pc, $normalizeCaret as hc, $setSelectionFromCaretRange as gc, $getCollapsedCaretRange as fc, $getCaretInDirection as $o, $splitAtPointCaretNext as mc, $isTextPointCaret as vc, $findMatchingParent as Ln, $isElementNode as _r, mergeRegister as Ce, getDOMTextNode as bc, isHTMLElement as xc, CLEAR_EDITOR_COMMAND as jn, COMMAND_PRIORITY_EDITOR as co, shallowMergeConfig as yc, defineExtension as oe, safeCast as Je, createState as kc, FORMAT_TEXT_COMMAND as Fn, $isNodeSelection as Bn, COMMAND_PRIORITY_LOW as Un, RootNode as _c, LineBreakNode as Nc, TabNode as Cc, $isEditorState as Ec, createCommand as Tc, CLICK_COMMAND as Sc, isDOMNode as zc, $getNodeFromDOMNode as Rc, $createNodeSelection as Dc, $setSelection as Oc, $getEditor as Mc, DecoratorNode as ja, $getState as $c, toggleTextFormatType as Io, TEXT_TYPE_TO_FORMAT as Ic, $setState as Ac, addClassNamesToElement as Kn, $create as Pc, $getNodeByKey as Vc, removeClassNamesFromElement as Lc, KEY_TAB_COMMAND as jc, $isBlockElementNode as Fc, $createRangeSelection as Bc, $normalizeSelection__EXPERIMENTAL as Uc, OUTDENT_CONTENT_COMMAND as Kc, INDENT_CONTENT_COMMAND as Ao, INSERT_TAB_COMMAND as Hc, COMMAND_PRIORITY_CRITICAL as lo, $isDecoratorNode as qc, $isParagraphNode as Gc, $isTextNode as Fa, SELECTION_CHANGE_COMMAND as Hn, $insertNodes as Wc } from "lexical";
...
import { Avatar as wo, Select as Ht, Checkbox as Po, Slot as Sr, Tabs as le, Menubar as me, ContextMenu as Mt, Progress as Vo, Slider as Mr, Switch as Lo } from "radix-ui";
import { useReactTable as Gn, getFilteredRowModel as al, getSortedRowModel as Wn, getPaginationRowModel as ol, getCoreRowModel as Yn, flexRender as br, getGroupedRowModel as nl, getExpandedRowModel as il } from "@tanstack/react-table";
import sl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ba, HIDDEN_NOTE_CALLER as Ua, getDefaultViewOptions as cl, isInsertEmbedOpOfType as $r, Editorial as ll } from "@eten-tech-foundation/platform-editor";
...
function xa({
  ...
  const T = fe(), L = pl(), A = F ?? L, [E, V] = k(!1), [K, C] = k(""), [G, U] = k(""), [M, D] = k("books"), [S, Z] = k(void 0), [H, yt] = k(
    void 0
  ), [lt, $t] = k(void 0), [X, rt] = k(!1), ft = B(null), dt = B(!1), pt = B(void 0), qt = B(void 0), nt = B(void 0), Zt = B(void 0), Gt = B({}), Qt = B({}), bt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), te = $(() => o ? o() : qi, [o]), It = $(() => ({
    [ut.OT]: te.filter((q) => St.isBookOT(q)),
    [ut.NT]: te.filter((q) => St.isBookNT(q)),
    [ut.DC]: te.filter((q) => St.isBookDC(q)),
    [ut.Extra]: te.filter((q) => St.extraBooks().includes(q))
  }), [te]), xt = $(() => Object.values(It).flat(), [It]), At = $(() => {
    if (!G.trim()) return It;
    const x = {
      [ut.OT]: [],
      [ut.NT]: [],
  ...
  const ee = j(() => {
    ...
    D("books"), Z(void 0), yt(void 0), $t(void 0), setTimeout(() => {
      qt.current && qt.current.focus();
    }, 0);
  }, []), gt = j(() => {
    const x = H;
    yt(void 0), $t(void 0), x ? (Z(x), D("chapters"), C("")) : et();
  }, [H, et]), st = j((x) => {
    V(x), x && (D("books"), Z(void 0), yt(void 0), $t(void 0), U(""));
  }, []);
  W(() => {
    O && st(!1);
  }, [O, st]);
  ...
  const { otLong: Ct, ntLong: Lt, dcLong: Et, extraLong: Te } = {
    ...
    () => bl(G),
    [G]
  ), gr = $(() => !d || !R || !R.chapterNum || !hr ? !1 : d(R.book, R.chapterNum) > 0, [d, R, hr]), zr = j(
    (x) => w ? Fo(x, w) : !1,
    [w]
  ), Ue = j(
    (x) => (q) => w ? xl(x, q, w) : !1,
    ...
    [w]
  ), Rr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", pa = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", ha = j(
    (x) => {
    ...
    (x) => {
      var ne, Ze, xe;
      if (x.ctrlKey) return;
      const { isLetter: q, isDigit: tt } = Bo(x.key);
      ...
      if ((M === "chapters" || M === "books" && R) && Ft) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            _t !== 0 && (vt = _t > 1 ? _t - 1 : Pt);
            break;
          case "ArrowRight":
            _t !== 0 && (vt = _t < Pt ? _t + 1 : 1);
            break;
          case "ArrowUp":
            vt = _t === 0 ? Pt : Math.max(1, _t - re);
            break;
          case "ArrowDown":
            vt = _t === 0 ? 1 : Math.min(Pt, _t + re);
            break;
          default:
            return;
        }
        vt !== _t && (x.preventDefault(), x.stopPropagation(), C(
          `${Bt} ${ce[Bt] || ""} ${vt}`
        ), setTimeout(() => {
    ...
    Ja,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:flex tw:items-center", children: o.map((m) => St.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            Y,
            {
...
const ti = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = ti ? Xt : W, Ar = { tag: so };
function El({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Nl(null, o), w = In({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Tr();
            g.append(f);
            const b = ti ? document.activeElement : null;
...
const ei = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = ei && "documentMode" in document ? document.documentMode : null;
!(!ei || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function pe(t) {
  return `${t}px`;
}
    ...
    w.read(() => {
      ...
      if ((T || L) && O !== null && F !== null) {
        const A = function(E, V, K, C, G, U, M) {
          ...
          return D.setStart(...qo(V, K, C)), D.setEnd(...qo(G, U, M)), D;
        }(t, h, f, O, g, N, F);
        l(), l = Ll(t, A, e);
      }
...
function Ul(t) {
  const e = Ln(t, (r) => _r(r) && !r.isInline());
  return _r(e) || Jr(4, t.__key), e;
}
function Kl(t) {
  const e = Jt() || lc();
  let r;
  if (he(e)) r = dc(e.focus, "next");
    ...
    r = r || wc(Me(), "previous").getFlipped().insert(Tr());
  }
...
function Hl(t, e, r) {
  ...
  return vc(o) && Jr(283), o.insert(t.isInline() ? Tr().append(t) : t), $o(Vn(t.getLatest(), "next"), e.direction);
}
function ql(t) {
  const e = Jt();
  if (!he(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Ln(i, (d) => _r(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function da() {
  ...
  for (!function() {
    ...
    let r = xr;
    for (xr = void 0, Qr++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && ri(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
function Jl(t) {
  ...
  ai(this), ot = t, this.f &= -2, 8 & this.f && go(this), da();
}
function tr(t, e) {
...
Kt.prototype.brand = Gl, Kt.prototype.h = function() {
  ...
  if (this.g = Kr, this.f |= 1, this.i > 0 && !ri(this)) return this.f &= -2, !0;
  const t = ot;
  try {
    Yo(this), ot = this;
    const e = this.x();
  ...
  return ot = t, ai(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, oi(this), Yo(this), _e++;
  const t = ot;
...
function ni() {
  const t = Me(), e = Jt(), r = Tr();
  t.clear(), t.append(r), e !== null && r.select(), he(e) && (e.format = 0);
}
function ii(t, e = ni) {
  return t.registerCommand(jn, (r) => (t.update(e), !0), co);
}
oe({ build: (t, e, r) => wr(e), config: Je({ $onClear: ni }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ge(() => ii(t, o.value));
} });
function Zl(t) {
...
oe({ name: "@lexical/extension/DecoratorText", nodes: () => [si], register: (t, e, r) => t.registerCommand(Fn, (o) => {
  const n = Jt();
  if (Bn(n) || he(n)) for (const i of n.getNodes()) Ql(i) && i.toggleFormat(o);
  return !1;
}, Un) });
function ci(t, e) {
  let r;
...
const Ga = oe({ build: (t) => ci(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const fo = 0, Wa = 1, di = 2, Na = 3, Pr = 4, Qe = 5, Ca = 6, mr = 7;
function Ea(t) {
  return t.id === fo;
}
function wi(t) {
...
function td(t) {
  return function(e) {
    return e.id === Wa;
  }(t) || wt(305, String(t.id), String(Wa)), Object.assign(t, { id: di });
}
...
class rd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && wt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
...
const od = oe({ config: Je({ setOptions: Xo, updateOptions: Xo }), init: ({ $initialEditorState: t = ad }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [_c, Pn, Nc, Cc, An] }), Jo = Symbol.for("@lexical/extension/LexicalBuilder");
function Zo() {
}
function nd(t) {
  throw t;
...
class or {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(In({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [Jo]: this });
...
const id = /* @__PURE__ */ new Set(), Qo = oe({ build(t, e, r) {
  const o = r.getDependency(Ga).output, n = Nr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ci(() => {
  }, () => ge(() => {
...
oe({ dependencies: [Ga, Qo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ce(t.registerCommand(sd, (s) => {
    ...
    if (zc(s.target)) {
      ...
      if (ld(c)) return function(l, d = !1) {
        ...
        let g;
        d && Bn(w) ? g = w : (g = Dc(), Oc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Un), t.registerMutationListener(ir, (s, c) => {
    Wl(() => {
      let l = !1;
...
oe({ build: (t, e, r) => wr(e), config: Je({ $canIndent: ui, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
oe({ build: (t, e, r) => wr(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ge(() => r.getOutput().disabled.value ? void 0 : hi(t)) });
function gd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function _d({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: N = !0, style: y, tabIndex: _, "data-testid": O, ...F }, T) {
  ...
  return gi(() => (A(t.isEditable()), t.registerEditableListener((K) => {
    A(K);
...
function zd({
  ...
  return /* @__PURE__ */ a(fi.Provider, { value: s, children: i });
}
function mi() {
  const t = io(fi);
  if (!t)
...
function Md() {
  const { activeEditor: t } = mi(), [e, r] = k([]), o = j((n) => {
    if (he(n) || tl(n)) {
      const i = [];
      rn.forEach(({ format: s }) => {
  ...
  return Od(o), /* @__PURE__ */ a(
    fn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: rn.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        Lr,
        {
          value: n,
          "aria-label": s,
          onClick: () => {
            t.dispatchCommand(Fn, n);
          },
...
function yi({
  ...
  const s = an(o, "%cancelButton_tooltip%"), c = i ?? an(o, "%acceptButton_tooltip%");
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u($e, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ u(
        Y,
        {
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(Cn, { className: "tw:h-4 tw:w-4" }),
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          !l && /* @__PURE__ */ u(ct, { children: [
            ...
            O ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: Ni(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: v(
...
function Ei({
  ...
  const [C, G] = k(nn), [U, M] = k(), [D, S] = k(), Z = o, [H, yt] = k(!1), [lt, $t] = k(!1), [X, rt] = k(!1), [ft, dt] = k(!1), [pt, qt] = k(!1), [nt, Zt] = k(O), [Gt, Qt] = k(!1), bt = B(void 0), [te, It] = k(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      xt.current !== "idle" && (M(void 0), S(void 0), xt.current = "idle");
      return;
    }
    xt.current === "idle" && (xt.current = "pending"), ft ? xt.current === "pending" && L !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    L !== i && (M(L), xt.current = "auto-populated") : xt.current === "auto-populated" && (M(void 0), xt.current = "pending");
  }, [o, L, ft, i]);
  const At = $(
  ...
  const R = $(() => At[0], [At]), be = B(null), ee = B(void 0), P = j(() => {
    var z;
    (z = ee.current) == null || z.call(ee), G(nn);
  }, []), Q = j(() => {
    const z = !nt;
  ...
  W(() => {
    ...
    if (o && !nt && !Gt) {
      ...
      return bt.current = z, () => clearTimeout(z);
    }
  ...
  const Lt = j(
    ...
    async (z) => {
      const jt = ae(C) ? ea(C) : void 0, kt = z.status ? z.assignedUser : U ?? z.assignedUser, de = await p({
        ...z,
        contents: jt,
        assignedUser: kt
      });
      return de && (kt !== void 0 && S(kt), jt && P()), de;
    },
    [P, C, p, U]
  );
      ...
      children: /* @__PURE__ */ u(Bd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            it && /* @__PURE__ */ a(yr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: it }),
            /* @__PURE__ */ a(
              Y,
              {
                variant: "ghost",
            ...
            V === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: pt && w !== "Resolved",
                  onClick: () => Et({ threadId: l, status: "Resolved" }),
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            mt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (z) => {
                  z.stopPropagation(), yt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (z) => {
                  (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), yt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(kr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Ct }),
                      ...
                      /* @__PURE__ */ a(
                        Ie,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Pe, { children: b == null ? void 0 : b.map((z) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                M(z !== i ? z : void 0), xt.current = "user-selected", S(void 0), rt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Gd({
  ...
  const [s, c] = k("accept"), l = Mo(), d = Mo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = $(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = $(
    () => qr(t.acceptedText ?? ""),
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return Ni(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function bp({
  ...
  const E = r.filter(
    ...
    (S) => {
      ...
      _((H) => {
        const yt = new Set(H);
        return yt.has(S) ? yt.delete(S) : yt.add(S), yt;
      ...
      children: E.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Zd, { ...Z, conflictResolution: N }) : /* @__PURE__ */ a(Ei, { ...Z })
          },
          S.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ht.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ht.Icon, { asChild: !0, children: /* @__PURE__ */ a(Mn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ow({
  ...
  var T;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, N] = k({}), y = $(() => e ?? [], [e]), _ = Gn({
    data: y,
    columns: t,
    getCoreRowModel: Yn(),
  ...
  return l ? F = Array.from({ length: 10 }).map((E, V) => `skeleton-row-${V}`).map((E) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? F = _.getRowModel().rows.map((L) => /* @__PURE__ */ a(
    Re,
    {
      ...
      children: L.getVisibleCells().map((A) => /* @__PURE__ */ a(rr, { children: br(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    L.id
    ...
    /* @__PURE__ */ u(to, { stickyHeader: i, children: [
      /* @__PURE__ */ a(eo, { stickyHeader: i, children: _.getHeaderGroups().map((L) => /* @__PURE__ */ a(Re, { children: L.headers.map((A) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : br(A.column.columnDef.header, A.getContext()) }, A.id)) }, L.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(Y, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Tn, {}) })
        ] }),
...
function Cp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ve, { children: [
    ...
    /* @__PURE__ */ a(je, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(vn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ct, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        De,
        {
          checked: o[w][h],
...
function fw({
  ...
  return /* @__PURE__ */ u(Ve, { children: [
    ...
    /* @__PURE__ */ u(je, { style: { zIndex: bn }, children: [
  ...
  return /* @__PURE__ */ u(Ae, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Pe, { children: [
      ...
      c.length > 0 && /* @__PURE__ */ u(ct, { children: [
        s.length > 0 && /* @__PURE__ */ a(xn, { alwaysRender: !0 }),
...
function zp({
  ...
  const [f, b] = k("generated"), [m, N] = k("generated"), [y, _] = k("*"), [O, F] = k("*"), [T, L] = k("f"), [A, E] = k(!1), [V, K] = k(!0), [C, G] = k(!1), U = B(!1), M = B(""), [D, S] = k(!1), [Z, H] = k(), [yt, lt] = k(), [$t, X] = k(), [rt, ft] = k(), dt = B(null), pt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      ...
      if (Q && $r("note", Q)) {
        ...
        if (st || E(!1), E(
          st === "x" ? !!(mt != null && mt.every((Vt) => {
            ...
            const Ct = ((Et = Vt.attributes) == null ? void 0 : Et.char).style;
...
const Rw = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(fn, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Lr,
          {
            onClick: (l) => {
...
function Lp({
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(sr, { onValueChange: (X) => yt(X), defaultValue: s, children: [
...
const Iw = "16rem", Aw = "3rem", zi = Yt.createContext(void 0);
function ua() {
...
function Pw({
  ...
  return /* @__PURE__ */ a(zi.Provider, { value: N, children: /* @__PURE__ */ a(
    "div",
    {
...
function Kw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = ua(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    Vw,
    {
      ...
      children: /* @__PURE__ */ u(jw, { children: [
        /* @__PURE__ */ u(dn, { children: [
          ...
          /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Fw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Bw, { children: /* @__PURE__ */ a(
            Kw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const ze = "scrBook", qw = "scrRef", He = "source", Gw = "details", Ww = "Scripture Reference", Yw = "Scripture Book", Ri = "Type", Xw = "Details";
function Jw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? St.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ze ? ke(n.start) : void 0;
      },
...
}, pn = (t) => `${Zw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function th({
  sources: t,
  ...
  W(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const K = b.find((C) => pn(C) === V[0]) || void 0;
        K && c(K);
      }
    }
  }, [g, b, c, N]);
  const y = n ?? Yw, _ = i ?? Ri, O = [
                    ...
                    children: C.getIsGrouped() ? /* @__PURE__ */ u(
                      Y,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          br(C.column.columnDef.cell, C.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
                    ...
                    Object.values(ut).map((C, G) => {
                      ...
                      if (U.length !== 0)
                        return /* @__PURE__ */ u(sa, { children: [
                          ...
                          G < Object.values(ut).length - 1 && /* @__PURE__ */ a(xn, {})
                        ] }, C);
                    })
                  ] })
                ]
...
function tu({
  ...
  const i = _n(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    Y,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: v(
        Nn(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: es(
        t,
...
function eu({
  ...
  const i = o["%webView_book_selector_more%"], s = $(
    ...
    (l) => {
      const d = _n(s, l).map((w) => w);
      r(
        Nn(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ra ? Ra : hn
      ).map((l) => /* @__PURE__ */ a(yr, { className: "tw:hover:bg-secondary", variant: "secondary", children: ye(l, n) }, l)),
...
function rh({
  ...
  const O = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), F = Tt(s, "%webView_scope_selector_verse%"), T = Tt(s, "%webView_scope_selector_chapter%"), L = Tt(s, "%webView_scope_selector_book%"), A = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Tt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = Tt(s, "%webView_scope_selector_current_book%"), K = Tt(s, "%webView_scope_selector_choose_books%"), C = Tt(s, "%webView_scope_selector_scope%"), G = Tt(s, "%webView_scope_selector_select_books%"), U = Tt(s, "%webView_scope_selector_range%"), M = Tt(s, "%webView_scope_selector_select_range%"), D = Tt(s, "%webView_scope_selector_range_start%"), S = Tt(s, "%webView_scope_selector_range_end%"), Z = Tt(s, "%webView_scope_selector_ok%"), H = Tt(s, "%webView_scope_selector_cancel%"), yt = Tt(s, "%webView_scope_selector_navigate%"), lt = (I) => {
    if (!f) return;
  ...
  }, nt = B(null), Zt = B(null), Gt = B(!1), Qt = B(null), bt = B(!1), [te, It] = k(void 0), xt = B(!1), At = B(!1), R = B(null), be = j((I) => {
    if (I) {
      It("start"), xt.current = !1;
      return;
    }
    It((J) => J === "start" ? void 0 : J), xt.current && (xt.current = !1, requestAnimationFrame(() => {
      var Wt;
    ...
    (I) => {
      h == null || h(I), g == null || g(I), xt.current = !0;
    },
    [h, g]
  ), Q = j(
    (I) => {
  ...
  ), gt = rt.find((I) => I.value === "selectedBooks"), st = rt.find((I) => I.value === "range"), [mt, Vt] = k(!1), [Ct, Lt] = k(void 0), [Et, Te] = k(void 0), [z, jt] = k(void 0), [kt, de] = k(void 0), [Be, ur] = k([]), pr = d === "dropdown" && Ct === "selectedBooks", hr = /* @__PURE__ */ a(
    eu,
    {
      availableBookInfo: o,
  ...
  ), gr = te === "end", zr = te === "start", Ue = "tw:text-muted-foreground", Se = d === "dropdown" && Ct === "range", Rr = Se ? jt : P, ha = Se ? de : g ? Q : qt, Dr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(gr && Ue), children: D }),
      /* @__PURE__ */ a(
        xa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: nt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: v(zr && Ue), children: S }),
      /* @__PURE__ */ a(
        xa,
        {
          id: "scope-range-end",
  ...
  const [tt, Ft] = k(null), [ne, Ze] = k(null), [xe, Bt] = k(null), _t = 200, [Pt, vt] = k(!1);
  W(() => {
    if (!xe || typeof ResizeObserver > "u") return;
    const I = new ResizeObserver(([J]) => {
      vt(J.contentRect.width < _t);
    });
  ...
  const re = j(
    ...
    Et !== void 0 && (Et === "range" ? (z && (h == null || h(z)), kt && (g == null || g(kt))) : Et === "selectedBooks" && i(Be), at(Et), Lt(void 0), Te(void 0));
  }, [
    Et,
    z,
    kt,
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(Ve, { open: mt, onOpenChange: Vt, children: [
          ...
          je,
          {
            ...
            children: /* @__PURE__ */ u(ga, { container: xe, children: [
              ...
              b && /* @__PURE__ */ u(ct, { children: [
                /* @__PURE__ */ a(We, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: yt }),
                /* @__PURE__ */ a(
                  qe,
                  {
                    ref: Qt,
                    ...
                    onSelect: (I) => {
                      ...
                      bt.current || (Wt = (J = Zt.current) == null ? void 0 : J.querySelector("button")) == null || Wt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
        ...
        Ja,
        {
          ...
          children: rt.map(({ value: I, label: J, scrRefSuffix: Wt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(Nt, { htmlFor: fr, children: X(J, Wt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && Dr,
    d === "dropdown" && gt && /* @__PURE__ */ a(Da, { open: Ct === "selectedBooks", onOpenChange: we, children: /* @__PURE__ */ a(
      Oa,
      {
        ref: Ze,
        onCloseAutoFocus: ko,
    ...
    d === "dropdown" && st && /* @__PURE__ */ a(Da, { open: Ct === "range", onOpenChange: we, children: /* @__PURE__ */ a(
      Oa,
      {
        ref: Ft,
        onCloseAutoFocus: ko,
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ve, { variant: i, children: [
    ...
    /* @__PURE__ */ a(je, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(sa, { children: [
      /* @__PURE__ */ a(vn, { children: /* @__PURE__ */ a(zt, { children: Oi(e.groups, e.items, l, t) }) }),
