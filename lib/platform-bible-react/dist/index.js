...
var ut = (e, t, n) => ws(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as c, Fragment as at } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as rt, useMemo as z, useState as M, useCallback as j, useLayoutEffect as Lt, createContext as bn, useContext as pr, useEffect as Q, Component as ds, createElement as $r, Suspense as cs, createRef as ps, Fragment as po } from "react";
import { Command as gt } from "cmdk";
import { X as en, Search as uo, Check as Ot, Clock as Pr, ChevronsLeft as Lr, ChevronsRight as Br, ChevronLeft as Hn, ChevronRight as Ee, ArrowLeft as us, ArrowRight as ms, Circle as vn, ChevronDown as pe, BoldIcon as hs, ItalicIcon as fs, UnderlineIcon as gs, StrikethroughIcon as bs, Pencil as vs, Trash2 as xs, ArrowUp as mo, MoreHorizontal as ho, ChevronUp as Xn, AtSign as ys, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as fo, Filter as Ss, User as Ts, Link as Rs, CircleHelp as Ds, ChevronsUpDown as go, Star as Os, FunctionSquare as bo, SquareSigma as vo, SquareX as Is, AlertCircle as Un, CircleCheckIcon as Ms, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as $s, ArrowDownIcon as Ps, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as zs, ScrollText as js, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Us } from "lucide-react";
import { clsx as Ks } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as _t from "@radix-ui/react-dialog";
import { includes as sn, Section as G, getChaptersForBook as qs, formatScrRef as _e, getSectionForBook as He, formatRelativeDate as Js, formatReplacementString as ie, sanitizeHtml as Ws, parseParatextHtml as zr, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as xo, isString as Dn, compareScrRefs as Kn, scrRefToBBBCCCVVV as On, getLocalizeKeyForScrollGroupId as Y } from "platform-bible-utils";
...
import { createEditor as No, $getRoot as Yt, $createParagraphNode as xn, $getSelection as Bt, HISTORY_MERGE_TAG as ur, ParagraphNode as ko, TextNode as _o, $isTokenOrSegmented as ri, $getCharacterOffsets as oi, $cloneWithPropertiesEphemeral as ai, $findMatchingParent as si, $isElementNode as le, CLEAR_EDITOR_COMMAND as Co, COMMAND_PRIORITY_EDITOR as Eo, $isRangeSelection as Je, shallowMergeConfig as ii, defineExtension as zt, safeCast as nn, RootNode as li, LineBreakNode as wi, TabNode as di, $isEditorState as ci, createCommand as pi, CLICK_COMMAND as ui, isDOMNode as mi, $getNodeFromDOMNode as hi, $isNodeSelection as fi, $createNodeSelection as gi, $setSelection as bi, COMMAND_PRIORITY_LOW as vi, DecoratorNode as xi, $create as yi, $getNodeByKey as Ni, INDENT_CONTENT_COMMAND as jr, COMMAND_PRIORITY_CRITICAL as mr, KEY_TAB_COMMAND as ki, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INSERT_TAB_COMMAND as Si, $isBlockElementNode as un, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as mn, SELECTION_CHANGE_COMMAND as So, FORMAT_TEXT_COMMAND as Di, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Fr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as To, $createLineBreakNode as Ro, $isRootOrShadowRoot as Ai, isBlockDomNode as Gr, isInlineDomNode as Hr, $insertNodes as Vi } from "lexical";
import * as rn from "@radix-ui/react-tooltip";
import { TooltipTrigger as $i } from "@radix-ui/react-tooltip";
import { HeadingNode as Pi, QuoteNode as Li, registerRichText as Bi } from "@lexical/rich-text";
import { flushSync as zi, createPortal as ji } from "react-dom";
import { $isTableSelection as Fi } from "@lexical/table";
import * as yn from "@radix-ui/react-toggle-group";
...
import { useReactTable as Mo, getFilteredRowModel as Hi, getSortedRowModel as Ao, getPaginationRowModel as Xi, getCoreRowModel as Vo, flexRender as Xe, getGroupedRowModel as Ui, getExpandedRowModel as Ki } from "@tanstack/react-table";
import * as st from "@radix-ui/react-select";
import Yi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Yn, HIDDEN_NOTE_CALLER as qn, getDefaultViewOptions as qi, isInsertEmbedOpOfType as In, Editorial as Ji } from "@eten-tech-foundation/platform-editor";
...
import * as Wn from "@radix-ui/react-progress";
...
import * as Zn from "@radix-ui/react-switch";
...
const el = _t.Root, nl = _t.Portal, $o = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  _t.Overlay,
  {
    ref: n,
    className: h(
...
$o.displayName = _t.Overlay.displayName;
const Po = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = dt();
  return /* @__PURE__ */ c(nl, { children: [
    /* @__PURE__ */ o($o, {}),
    /* @__PURE__ */ c(
      _t.Content,
      {
...
Po.displayName = _t.Content.displayName;
...
const Bo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  _t.Title,
  {
    ref: n,
...
Bo.displayName = _t.Title.displayName;
...
rl.displayName = _t.Description.displayName;
...
fe.displayName = gt.displayName;
const on = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ o(uo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ o(
      gt.Input,
      {
        ref: n,
...
on.displayName = gt.Input.displayName;
...
ge.displayName = gt.List.displayName;
const Nn = b.forwardRef((e, t) => /* @__PURE__ */ o(gt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
Nn.displayName = gt.Empty.displayName;
...
qt.displayName = gt.Group.displayName;
...
zo.displayName = gt.Separator.displayName;
const Qt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Item,
  {
    ref: n,
...
var ol = Object.defineProperty, al = (e, t, n) => t in e ? ol(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, F = (e, t, n) => al(e, typeof t != "symbol" ? t + "" : t, n);
const ue = [
  "GEN",
  "EXO",
  "LEV",
...
function Ve(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Xr ? Xr[e] : 0;
}
function gr(e) {
  return Ve(e) > 0;
}
...
function* wl() {
  for (let e = 1; e <= ue.length; e++) yield e;
}
const dl = 1, Go = ue.length;
function cl() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function br(e, t = "***") {
  const n = e - 1;
  return n < 0 || n >= ue.length ? t : ue[n];
}
function Ho(e) {
  return e <= 0 || e > Go ? "******" : jo[e - 1];
}
function pl(e) {
  return Ho(Ve(e));
}
...
function ml(e) {
  return jo[e - 1].includes("*obsolete*");
}
function hl() {
  const e = {};
...
F(xt, "Original", new xt(Rt.Original)), F(xt, "Septuagint", new xt(Rt.Septuagint)), F(xt, "Vulgate", new xt(Rt.Vulgate)), F(xt, "English", new xt(Rt.English)), F(xt, "RussianProtestant", new xt(Rt.RussianProtestant)), F(xt, "RussianOrthodox", new xt(Rt.RussianOrthodox));
let oe = xt;
function Ur(e, t) {
  const n = t[0];
...
var Uo = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(Uo || {});
const ft = class H {
  constructor(t, n, r, a) {
    if (F(this, "firstChapter"), F(this, "lastChapter"), F(this, "lastVerse"), F(this, "hasSegmentsDefined"), F(this, "text"), F(this, "BBBCCCVVVS"), F(this, "longHashCode"), F(this, "versification"), F(this, "rtlMark", "‏"), F(this, "_bookNum", 0), F(this, "_chapterNum", 0), F(this, "_verseNum", 0), F(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        const s = t, i = n != null && n instanceof oe ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (t != null && typeof t == "number") {
        const s = n != null && n instanceof oe ? n : void 0;
        ...
        if (t != null && t instanceof H) {
          ...
          if (t == null) return;
          const s = t instanceof oe ? t : H.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let d;
    return i && (d = new oe(i)), n ? new H(n, r.toString(), l, d) : new H();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new oe(Rt[i]);
        } catch {
          throw new ze("Invalid reference : " + t);
        }
    }
    ...
    if (r.length !== 2 || q.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !H.isVerseParseable(r[1]))
      throw new ze("Invalid reference : " + t);
  ...
  allVerses(t = !1, n = H.verseRangeSeparators, r = H.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = Ur(this._verse, r);
    for (const i of s.map((l) => Ur(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const d = l.verseNum;
...
const Yo = q.allBookIds.filter(
  (e) => !q.isObsolete(q.bookIdToNumber(e))
), we = Object.fromEntries(
  Yo.map((e) => [e, q.bookIdToEnglishName(e)])
);
function xr(e, t, n) {
  const r = t.trim().toLowerCase();
  if (!r) return !1;
  const a = q.bookIdToEnglishName(e), s = n == null ? void 0 : n.get(e);
  return !!(sn(a.toLowerCase(), r) || sn(e.toLowerCase(), r) || (s ? sn(s.localizedName.toLowerCase(), r) || sn(s.localizedId.toLowerCase(), r) : !1));
}
const qo = tn(
  ({
    bookId: e,
    ...
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        children: /* @__PURE__ */ c(
          ...
          {
            ref: w,
            value: d || `${e} ${q.bookIdToEnglishName(e)}`,
            onSelect: f,
            onMouseDown: m,
            role: "option",
            "aria-selected": t,
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Me : "button", { className: h(gl({ variant: t, size: n, className: e })), ref: s, ...a })
);
B.displayName = "Button";
const be = Se.Root, ve = Se.Trigger, pp = Se.Anchor, te = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ o(Se.Portal, { children: /* @__PURE__ */ o(
    Se.Content,
    {
      ref: a,
      align: t,
...
function Qn(e, t, n) {
  return `${e} ${we[e]}${t ? ` ${vr(e, t)} ${Ce(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function bl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ c(be, { open: l, onOpenChange: d, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      B,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Pr, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(te, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: /* @__PURE__ */ o(qt, { heading: s, children: e.map((p) => /* @__PURE__ */ c(
      Qt,
      {
        onSelect: () => w(p),
        className: "tw-flex tw-items-center",
        children: [
          /* @__PURE__ */ o(Pr, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
  ...
  const r = vl.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!p && d) {
          const u = ((g) => Object.keys(we).find(
            (x) => we[x].toLowerCase() === g.toLowerCase()
          ))(l);
...
function yl(e, t, n, r) {
  const a = j(() => {
    if (e.chapterNum > 1)
      ...
      if (d > 0) {
        const w = t[d - 1], p = Math.max(Dt(w), 1);
        r({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function Yr({
  ...
  if (e)
    return /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Qt,
      {
        value: `${e} ${we[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function mp({
  ...
  const w = dt(), [p, f] = M(!1), [m, u] = M(""), [g, x] = M(""), [y, R] = M("books"), [N, v] = M(void 0), [C, V] = M(!1), _ = rt(void 0), E = rt(void 0), D = rt(void 0), k = rt(void 0), S = rt({}), L = j(
    (T) => {
      t(T), l && l(T);
    },
    [t, l]
  ), P = z(() => r ? r() : Yo, [r]), J = z(() => ({
    [G.OT]: P.filter((K) => q.isBookOT(K)),
    [G.NT]: P.filter((K) => q.isBookNT(K)),
    [G.DC]: P.filter((K) => q.isBookDC(K)),
    [G.Extra]: P.filter((K) => q.extraBooks().includes(K))
  }), [P]), O = z(() => Object.values(J).flat(), [J]), X = z(() => {
    if (!g.trim()) return J;
    const T = {
      [G.OT]: [],
      [G.NT]: [],
    ...
    return [G.OT, G.NT, G.DC, G.Extra].forEach((lt) => {
      T[lt] = J[lt].filter((pt) => xr(pt, g, a));
    }), T;
  }, [J, g, a]), A = z(
    () => xl(g, O, a),
    [g, O, a]
    ...
    (T) => {
      const K = y === "chapters" ? N : A == null ? void 0 : A.book;
      K && (L({
        book: K,
        chapterNum: T,
        verseNum: 1
      }), f(!1), R("books"), v(void 0), x(""));
    },
    [L, y, N, A]
  ), Mt = j(
    (T) => {
    ...
    (T) => {
      ...
      f(T), T && (R("books"), v(void 0), x(""));
    },
    [y, ot]
  ), { otLong: vt, ntLong: kt, dcLong: I, extraLong: ct } = {
    ...
    (T) => A ? !!A.chapterNum && !T.toString().includes(A.chapterNum.toString()) : !1,
    [A]
  ), os = z(
    () => _e(
      e,
    ...
    (T) => {
      if (T.ctrlKey) return;
      const { isLetter: K, isDigit: lt } = Kr(T.key);
      if (y === "chapters") {
        if (T.key === "Backspace") {
          T.preventDefault(), T.stopPropagation(), ot();
          return;
        }
        if (K || lt) {
          if (T.preventDefault(), T.stopPropagation(), R("books"), v(void 0), lt && N) {
            const pt = we[N];
            x(`${pt} ${T.key}`);
          } else
            x(T.key);
      ...
      if ((y === "chapters" || y === "books" && A) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(T.key)) {
        const pt = y === "chapters" ? N : A == null ? void 0 : A.book;
        if (!pt) return;
        const ht = (() => {
          if (!m) return 1;
          const Be = m.match(/(\d+)$/);
        ...
        switch (T.key) {
          case "ArrowLeft":
            ht !== 0 && (At = ht > 1 ? ht - 1 : ne);
            break;
          case "ArrowRight":
            ht !== 0 && (At = ht < ne ? ht + 1 : 1);
            break;
          case "ArrowUp":
            At = ht === 0 ? ne : Math.max(1, ht - Vr);
            break;
          case "ArrowDown":
            At = ht === 0 ? 1 : Math.min(ne, ht + Vr);
            break;
          default:
            return;
        }
        At !== ht && (T.preventDefault(), T.stopPropagation(), u(Qn(pt, a, At)), setTimeout(() => {
          const Be = S.current[At];
    ...
    if (T.shiftKey || T.key === "Tab" || T.key === " ") return;
    const { isLetter: K, isDigit: lt } = Kr(T.key);
    (K || lt) && (T.preventDefault(), x((pt) => pt + T.key), E.current.focus(), V(!1));
  }, []);
  return Lt(() => {
    const T = setTimeout(() => {
      if (p && y === "books" && D.current && k.current) {
        const K = D.current, lt = k.current, pt = lt.offsetTop, ht = K.clientHeight, ne = lt.clientHeight, At = pt - ht / 2 + ne / 2;
        K.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(Qn(e.book));
  ...
  }, [y, N, A, e.book, e.chapterNum]), /* @__PURE__ */ c(be, { open: p, onOpenChange: yt, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      B,
      {
    ...
    /* @__PURE__ */ o(te, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      fe,
      {
        ref: _,
        onKeyDown: ss,
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            /* @__PURE__ */ c("div", { className: "tw-relative tw-flex-1", children: [
              ...
              i && i.length > 0 && /* @__PURE__ */ o(
                bl,
                {
                  ...
                  renderItem: (T) => _e(T, "English"),
                  getItemKey: (T) => `${T.book}-${T.chapterNum}-${T.verseNum}`,
                  ariaLabel: s == null ? void 0 : s["%history_recentSearches_ariaLabel%"],
                  groupHeading: s == null ? void 0 : s["%history_recent%"]
                }
              )
            ] }),
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: T, disabled: K, title: lt, icon: pt }) => /* @__PURE__ */ o(
              B,
              {
                variant: "ghost",
                size: "sm",
            ...
            N && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ce(N, a) })
          ] }),
          !C && /* @__PURE__ */ c(ge, { ref: D, children: [
            y === "books" && /* @__PURE__ */ c(at, { children: [
              !A && Object.entries(X).map(([T, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(qt, { heading: St(T), children: K.map((lt) => /* @__PURE__ */ o(
                      qo,
                      {
                        bookId: lt,
                        onSelect: (pt) => it(pt),
                        section: He(lt),
                        commandValue: `${lt} ${we[lt]}`,
                        ref: lt === e.book ? k : void 0,
                        localizedBookNames: a
                      },
                      lt
                    )) }, T)
              ...
              A && /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(
                Qt,
                {
                  value: `${A.book} ${we[A.book]} ${A.chapterNum || ""}:${A.verseNum || ""})}`,
                  onSelect: W,
                  ...
                  children: _e(
                    ...
                    a ? vr(A.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              A && Dt(A.book) > 1 && /* @__PURE__ */ c(at, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(A.book, a) }),
                /* @__PURE__ */ o(
                  Yr,
                  {
                    bookId: A.book,
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(yo.Root, { ref: n, className: h("pr-twp", Nl(), e), ...t }));
wt.displayName = yo.Root.displayName;
const yr = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    qe.Root,
    {
...
yr.displayName = qe.Root.displayName;
const hn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  qe.Item,
  {
    ref: n,
    className: h(
    ...
    ...t,
    children: /* @__PURE__ */ o(qe.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(vn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
hn.displayName = qe.Item.displayName;
function kl(e) {
...
function tr({
  ...
  const [N, v] = M(!1), C = d ?? l, V = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], _ = (E, D) => {
    const k = l(E), S = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, L = `${D ?? ""}${k}${S ?? ""}`;
    return /* @__PURE__ */ c(
      Qt,
      {
        value: k,
        ...
        children: [
          ...
          /* @__PURE__ */ c("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            k,
            S && /* @__PURE__ */ c("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              S
            ] })
          ] })
  ...
  return /* @__PURE__ */ c(be, { open: N, onOpenChange: v, ...R, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ c(
      B,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ o(
      te,
      {
        ...
        children: /* @__PURE__ */ c(fe, { children: [
          /* @__PURE__ */ o(on, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ o(Nn, { children: m }),
          /* @__PURE__ */ o(ge, { children: V(t) ? t.map((E) => /* @__PURE__ */ o(qt, { heading: E.groupHeading, children: E.options.map((D) => _(D, E.groupHeading)) }, E.groupHeading)) : t.map((E) => _(E)) })
        ] })
      }
    )
  ] });
...
function gp({
  ...
  const p = An(w, "%webView_bookSelector_currentBook%"), f = An(w, "%webView_bookSelector_choose%"), m = An(w, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    g(y), e(y);
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(wt, { className: "tw-ms-1", children: m })
          ] }),
          /* @__PURE__ */ o(wt, { className: "tw-flex tw-items-center", children: r.map((y) => q.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ o(
            B,
            {
...
const bp = [
  ...
  const a = rt(null), [s, i] = M(void 0), [l, d] = M(void 0), w = j(
    (u) => {
      i(u);
      const g = e.find((y) => y.id === u);
      g && (t == null || t(g));
    ...
    (u) => {
      var E;
      const g = u.target, x = (D) => D ? document.getElementById(D) : void 0, y = x(l), R = x(s);
      if (!!(y && g && y.contains(g) && g !== y) && f(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const D = e.find((k) => k.id === l);
            D && w(D.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const k = D.findIndex((L) => L === g);
          if (k === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(k + 1, D.length - 1) : S = Math.max(k - 1, 0), S !== k && (u.preventDefault(), u.stopPropagation(), (E = D[S]) == null || E.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          V = Math.min(C + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          V = Math.max(C - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const Wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = Wo ? Lt : Q, ln = { tag: ur };
function Ol({ initialConfig: e, children: t }) {
  const n = z(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Rl(null, r), p = No({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, m) {
      if (m !== null) {
        if (m === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = xn();
            u.append(g);
            const x = Wo ? document.activeElement : null;
  ...
  }, []), o(Jo.Provider, { value: n, children: t });
}
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function Ml({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Il(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      t && s.size === 0 && i.size === 0 || e && d.has(ur) || l.isEmpty() || n(a, r, d);
    });
  }, [r, e, t, n]), null;
}
const Nr = {
  ...
  mark: "",
  markOverlap: ""
}, $t = rn.Provider, Xt = rn.Root, de = rn.Trigger, Pt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  rn.Content,
  {
    ref: r,
    sideOffset: t,
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function Bl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = It(), n = z(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = rt(r);
    return Ll(() => {
...
function jl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ri(t) && r !== null) {
    const [a, s] = r, i = e.isBackward(), l = a.getNode(), d = s.getNode(), w = t.is(l), p = t.is(d);
    if (w || p) {
      const [f, m] = oi(e), u = l.is(d), g = t.is(i ? d : l), x = t.is(i ? l : d);
      let y, R = 0;
      u ? (R = f > m ? m : f, y = f > m ? f : m) : g ? (R = i ? m : f, y = void 0) : x && (R = 0, y = i ? f : m);
      const N = t.__text.slice(R, y);
...
const Zo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = Zo && "documentMode" in document ? document.documentMode : null;
!(!Zo || !("InputEvent" in window) || Gl) && "getTargetRanges" in new window.InputEvent("input");
function Qo(...e) {
  const t = [];
...
function qr(e) {
  const t = si(e, (n) => le(n) && !n.isInline());
  return le(t) || Fl(4, e.__key), t;
}
function Xl(e, t) {
  const n = [];
...
function kn() {
  ...
  for (; Ue !== void 0; ) {
    let n = Ue;
    for (Ue = void 0, er++; n !== void 0; ) {
      const r = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && ea(n)) try {
        n.c();
      } catch (a) {
        t || (e = a, t = !0);
      }
...
function Wr(e) {
  if (U === void 0) return;
  let t = e.n;
  return t === void 0 || t.t !== U ? (t = { i: 0, S: e, p: U.s, n: void 0, t: U, e: void 0, x: void 0, r: t }, U.s !== void 0 && (U.s.n = t), U.s = t, e.n = t, 32 & U.f && e.S(t), t) : t.i === -1 ? (t.i = 0, t.n !== void 0 && (t.n.p = t.p, t.p !== void 0 && (t.p.n = t.n), t.p = U.s, t.n = void 0, U.s.n = t, U.s = t), t) : void 0;
}
function mt(e, t) {
...
function ae(e, t) {
  mt.call(this, void 0), this.x = e, this.s = void 0, this.g = pn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function Yl(e, t) {
  return new ae(e, t);
}
...
function _r(e) {
  ...
  e.x = void 0, e.s = void 0, ra(e);
}
function ql(e) {
  if (U !== this) throw new Error("Out-of-order effect");
  na(this), U = e, this.f &= -2, 8 & this.f && _r(this), kn();
}
function ke(e, t) {
...
mt.prototype.brand = Ul, mt.prototype.h = function() {
  return !0;
}, mt.prototype.S = function(e) {
  const t = this.t;
  t !== e && e.e === void 0 && (e.x = t, this.t = e, t !== void 0 ? t.e = e : Jr(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const t = e.e, n = e.x;
    t !== void 0 && (t.x = n, e.e = void 0), n !== void 0 && (n.e = t, e.x = void 0), e === this.t && (this.t = n, n === void 0 && Jr(() => {
      var r;
  ...
  if (e !== this.v) {
    if (er > 100) throw new Error("Cycle detected");
    this.v = e, this.i++, pn++, Ut++;
    try {
...
} }), ae.prototype = new mt(), ae.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === pn)) return !0;
  if (this.g = pn, this.f |= 1, this.i > 0 && !ea(this)) return this.f &= -2, !0;
  const e = U;
  try {
    Zr(this), U = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ra(this), Zr(this), Ut++;
  const e = U;
  return U = this, ql.bind(this, e);
...
zt({ build: (e, t, n) => _n(t), config: nn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function oa() {
  const e = Yt(), t = Bt(), n = xn();
  e.clear(), e.append(n), t !== null && n.select(), Je(t) && (t.format = 0);
}
function aa(e, t = oa) {
  return e.registerCommand(Co, (n) => (e.update(t), !0), Eo);
}
zt({ build: (e, t, n) => _n(t), config: nn({ $onClear: oa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Wt(() => aa(e, r.value));
} });
function Jl(e) {
...
const nr = zt({ build: (e) => sa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function ia(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = ia(n[a], r[a]);
    return e;
  }
  return t;
}
const Cr = 0, rr = 1, la = 2, $n = 3, wn = 4, Ne = 5, Pn = 6, je = 7;
function Ln(e) {
  return e.id === Cr;
}
function wa(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === rr;
  }(e) || Z(305, String(e.id), String(rr)), Object.assign(e, { id: la });
}
...
class Ql {
  constructor(t, n) {
    ...
    ut(this, "state");
    ut(this, "_signal");
    this.builder = t, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Cr };
  }
  mergeConfigs() {
  ...
  init(t) {
    ...
    const r = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...r, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, d, w) {
      return Object.assign(l, { config: d, id: $n, registerState: w });
    }(n, this.mergeConfigs(), r);
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(t, s.config, r)), this.state = function(l, d, w) {
      return Object.assign(l, { id: wn, initResult: d, registerState: w });
    }(s, i, a);
  }
  build(t) {
    const n = this.state;
    let r;
    n.id !== wn && Z(307, String(n.id), String(Ne)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  register(t, n) {
    this._signal = n;
    const r = this.state;
    r.id !== Ne && Z(308, String(r.id), String(Ne));
    const a = this.extension.register && this.extension.register(t, r.config, r.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: Pn });
    }(r), () => {
      const s = this.state;
      s.id !== je && Z(309, String(r.id), String(je)), this.state = function(i) {
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Pn && Z(310, String(n.id), String(Pn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= wn;
    }(t) || Z(313, String(t.id), String(wn)), t.initResult;
  }
  getInitPeer(t) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= $n;
    }(t) || Z(314, String(t.id), String($n)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
  ...
  getInitDependency(t) {
    ...
    return n === void 0 && Z(315, this.extension.name, t.name), n.getExtensionInitDependency();
  }
  getDependency(t) {
    const n = this.builder.getExtensionRep(t);
    return n === void 0 && Z(315, this.extension.name, t.name), n.getExtensionDependency();
  }
  getState() {
    const t = this.state;
    return function(n) {
      return n.id >= je;
    }(t) || Z(316, String(t.id), String(je)), t;
  }
  ...
  getExtensionDependency() {
    if (!this._dependency) {
      ...
      (function(n) {
        return n.id >= Ne;
      })(t) || Z(317, this.extension.name), this._dependency = { config: t.config, init: t.initResult, output: t.output };
    }
...
function tw() {
  const e = Yt();
  e.isEmpty() && e.append(xn());
}
const ew = zt({ config: nn({ setOptions: Qr, updateOptions: Qr }), init: ({ $initialEditorState: e = tw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [li, _o, wi, di, ko] }), to = Symbol.for("@lexical/extension/LexicalBuilder");
function eo() {
}
function nw(e) {
  throw e;
...
class Ke {
  constructor(t) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Bn, this.roots = t;
  ...
  static maybeFromEditor(t) {
    const n = t[to];
    return n && (n.PACKAGE_VERSION !== Bn && Z(292, n.PACKAGE_VERSION, Bn), n instanceof Ke || Z(293)), n;
  }
  static fromEditor(t) {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(No({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [to]: this });
  ...
  getExtensionRep(t) {
    ...
    if (n) return n.extension !== t && Z(295, t.name), n;
  }
  addEdge(t, n, r) {
  ...
  addExtension(t) {
    ...
    const n = dn(t), [r] = n;
    typeof r.name != "string" && Z(297, typeof r.name);
    let a = this.extensionNameMap.get(r.name);
    if (a !== void 0 && a.extension !== r && Z(298, r.name), !a) {
      a = new Ql(this, r), this.extensionNameMap.set(r.name, a);
      const s = this.conflicts.get(r.name);
      typeof s == "string" && Z(299, r.name, s);
      for (const i of r.conflictsWith || []) this.extensionNameMap.has(i) && Z(299, r.name, i), this.conflicts.set(i, r.name);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Ln(s) || Z(300, i, a || "[unknown]"), Ln(l = s) || Z(304, String(l.id), String(Cr)), s = Object.assign(l, { id: rr }), r.state = s;
    ...
    for (const r of this.extensionNameMap.values()) Ln(r.state) && n(r);
...
const rw = /* @__PURE__ */ new Set(), no = zt({ build(e, t, n) {
  const r = n.getDependency(nr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = sa(() => {
  }, () => Wt(() => {
    ...
    r.value.read(() => {
      if (Bt()) for (const [p, f] of l.entries()) {
        ...
        const m = Ni(p), u = m && m.isSelected() || !1;
        w = w || u !== (!!i && i.has(p)), u && (d = d || /* @__PURE__ */ new Set(), d.add(p));
      }
  ...
  return { watchNodeKey: function(i) {
    ...
    let w = d.get(i);
    const p = w !== void 0;
    return w = w || /* @__PURE__ */ new Set(), w.add(l), p || (d.set(i, w), a.value = { watchedNodeKeys: d }), l;
  } };
}, dependencies: [nr], name: "@lexical/extension/NodeSelection" });
...
zt({ dependencies: [nr, no], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(no).output, a = We({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return Jt(e.registerCommand(ui, (i) => {
    if (mi(i.target)) {
      const l = hi(i.target);
      if (aw(l)) return function(d, w = !1) {
        const p = Bt(), f = d.isSelected(), m = d.getKey();
        let u;
        w && fi(p) ? u = p : (u = gi(), bi(u)), f ? u.delete(m) : u.add(m);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, vi), e.registerMutationListener(Te, (i, l) => {
    Kl(() => {
      let d = !1;
      const { nodeSelections: w } = a.peek();
      for (const [p, f] of i.entries()) if (f === "destroyed") w.delete(p), d = !0;
      else {
        const m = w.get(p), u = e.getElementByKey(p);
        m ? m.domNode.value = u : (d = !0, w.set(p, { domNode: We(u), selectedSignal: r(p) }));
      }
      d && (a.value = { nodeSelections: w });
    });
  }), Wt(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(Wt(() => {
      const w = l.value;
      w && (d.value ? ta(w, s) : Hl(w, s));
    }));
    return Jt(...i);
  }));
} });
function sw(e, t) {
  return Jt(e.registerCommand(ki, (n) => {
    const r = Bt();
    if (!Je(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      const i = s.getNodes();
      if (Xl(i, (m) => un(m) && m.canIndent() ? m : null).length > 0) return !0;
      const l = s.anchor, d = s.focus, w = d.isBefore(l) ? d : l, p = w.getNode(), f = qr(p);
      if (f.canIndent()) {
        const m = f.getKey();
        let u = _i();
        if (u.anchor.set(m, 0, "element"), u.focus.set(m, 0, "element"), u = Ci(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Ei : jr : Si;
    return e.dispatchCommand(a, void 0);
  }, Eo), e.registerCommand(jr, () => {
...
zt({ build: (e, t, n) => _n(t), config: nn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: r, maxIndent: a } = n.getOutput();
  return Wt(() => {
    if (!r.value) return sw(e, a);
  });
} });
const iw = zt({ name: "@lexical/react/ReactProvider" });
function lw() {
  return Yt().getTextContent();
}
function ww(e, t = !0) {
  if (e) return !1;
  let n = lw();
...
function dw(e) {
  if (!ww(e, !1)) return !1;
  const t = Yt().getChildren(), n = t.length;
  if (n > 1) return !1;
  for (let r = 0; r < n; r++) {
    const a = t[r];
    if (Ti(a)) return !1;
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            e.update(() => {
              ...
              if (Je(g)) {
                const x = g.anchor;
                let y = x.getNode(), R = 0, N = 0;
                if (mn(y) && w >= 0 && p >= 0 && (R = w, N = w + p, g.setTextNodeRange(y, R, y, N)), R === N && f === "" || (g.insertRawText(f), y = x.getNode()), mn(y)) {
                  R = m, N = m + u;
                  const v = y.getTextContentSize();
                  R = R > v ? v : R, N = N > v ? v : N, g.setTextNodeRange(y, R, y, N);
                }
...
zt({ build: (e, t, n) => _n(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : pa(e)) });
function cw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Er = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function pw({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    const [a, s] = M(() => n.getDecorators());
    return Er(() => n.registerDecoratorListener((i) => {
      zi(() => {
        s(i);
      });
    }), [n]), Q(() => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = o(r, { onError: (m) => n._onError(m), children: o(cs, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
...
function ro(e) {
  return e.getEditorState().read(ca(e.isComposing()));
}
function mw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = It();
  return function(a) {
    Er(() => Jt(Bi(a), pa(a)), [a]);
  }(r), c(at, { children: [e, o(hw, { content: t }), o(uw, { editor: r, ErrorBoundary: n })] });
}
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function bw({ onClear: e }) {
  const [t] = It();
  return gw(() => aa(t, e), [t, e]), null;
}
const ua = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function vw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: g, id: x, role: y = "textbox", spellCheck: R = !0, style: N, tabIndex: v, "data-testid": C, ...V }, _) {
  const [E, D] = M(e.isEditable()), k = j((L) => {
    L && L.ownerDocument && L.ownerDocument.defaultView ? e.setRootElement(L) : e.setRootElement(null);
  }, [e]), S = z(() => /* @__PURE__ */ function(...L) {
    return (P) => {
      for (const J of L) typeof J == "function" ? J(P) : J != null && (J.current = P);
    };
  }(_, k), [k, _]);
  return ua(() => (D(e.isEditable()), e.registerEditableListener((L) => {
    D(L);
  })), [e]), o("div", { "aria-activedescendant": E ? t : void 0, "aria-autocomplete": E ? n : "none", "aria-controls": E ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": E && y === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": E ? f : void 0, "aria-readonly": !E || void 0, "aria-required": m, autoCapitalize: u, className: g, contentEditable: E, "data-testid": C, id: x, ref: S, role: y, spellCheck: R, style: N, tabIndex: v, ...V });
}
const xw = tn(vw);
function oo(e) {
  return e.getEditorState().read(ca(e.isComposing()));
...
function Nw(e, t) {
  ...
  return c(at, { children: [o(xw, { editor: a, ...r, ref: t }), n != null && o(kw, { editor: a, content: n })] });
}
function kw({ content: e, editor: t }) {
  ...
  if (Lt(() => (a(t.isEditable()), t.registerEditableListener((i) => {
    a(i);
  })), [t]), !n) return null;
  let s = null;
...
function Cw({
  ...
  return /* @__PURE__ */ o(ma.Provider, { value: i, children: s });
}
function ha() {
  const e = pr(ma);
  if (!e)
...
function Ew() {
  const [e, t] = M(void 0), n = j(() => {
    t(void 0);
  }, []), r = z(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(el, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Po, { children: [
      /* @__PURE__ */ o(Lo, { children: /* @__PURE__ */ o(Bo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = j(
    (s, i, l = !1) => {
...
function Sw({
  ...
  const [t] = It(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Ew(), d = () => {
  };
...
const fa = Zt(
  ...
  {
    ref: a,
    className: h(fa({ variant: t, size: n, className: e })),
    ...r
  }
));
...
const ga = b.createContext({
  size: "default",
  variant: "default"
}), Sr = b.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = dt();
  return /* @__PURE__ */ o(
    yn.Root,
    {
...
Ye.displayName = yn.Item.displayName;
const ao = [
...
function Dw() {
  const { activeEditor: e } = ha(), [t, n] = M([]), r = j((a) => {
    if (Je(a) || Fi(a)) {
      const s = [];
      ao.forEach(({ format: i }) => {
  ...
  return Tw(r), /* @__PURE__ */ o(
    Sr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: ao.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        Ye,
        {
          value: a,
          "aria-label": i,
...
function or({
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Ol,
    {
      ...
      children: /* @__PURE__ */ c($t, { children: [
...
function Aw(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof To && i.insertAfter(Ro());
    for (const i of s) {
...
function Vw(e, t) {
  ...
  const n = document.createElement("div"), r = Yt().getChildren();
...
function ba(e, t, n, r = null) {
  ...
  const s = le(t) && t.excludeFromCopy("html");
  let i = t;
  r !== null && mn(t) && (i = jl(r, t, "clone"));
  const l = le(i) ? i.getChildren() : [], d = Oi(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = ba(e, g, m, r);
    !a && le(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || Fr(p)) && p.append(m), n.append(p), f) {
      const u = f.call(i, p);
      u && (Fr(p) ? p.replaceChildren(u) : p.replaceWith(u));
    }
  } else n.append(m);
  return a;
}
const va = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function xa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (va.has(e.nodeName)) return i;
  let l = null;
  const d = function(g, x) {
    const { nodeName: y } = g, R = x._htmlConversions.get(y.toLowerCase());
    let N = null;
    if (R !== void 0) for (const v of R) {
      const C = v(g);
  ...
  let m = [];
  const u = (l == null || !Ai(l)) && (l != null && un(l) || r);
  for (let g = 0; g < f.length; g++) m.push(...xa(f[g], t, n, u, new Map(a), l));
  return p != null && (m = p(m)), Gr(e) && (m = $w(e, m, u ? () => {
    const g = new To();
    return n.push(g), g;
  } : xn)), l == null ? m.length > 0 ? i = i.concat(m) : Gr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Hr(g.nextSibling) && Hr(g.previousSibling);
  }(e) && (i = i.concat(Ro())) : le(l) && l.append(...m), i;
}
function $w(e, t, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    const l = t[i];
    if (un(l)) r && !l.getFormat() && l.setFormat(r), a.push(l);
...
function Lw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Oo({
...
const Bw = Zt(
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: h("pr-twp", Bw({ variant: t }), e), ...n })
);
...
const Fw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
Fw.displayName = "CardDescription";
const Na = b.forwardRef(
...
const De = b.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, a) => /* @__PURE__ */ o(
  Io.Root,
  {
    ref: a,
    decorative: n,
...
De.displayName = Io.Root.displayName;
const ka = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ae.Root,
  {
    ref: n,
    className: h(
...
ka.displayName = Ae.Root.displayName;
...
Hw.displayName = Ae.Image.displayName;
...
_a.displayName = Ae.Fallback.displayName;
const Rr = bn(void 0);
function Et() {
  const e = pr(Rr);
  if (!e)
...
}), $e = tt.Trigger, Ca = tt.Group, Xw = tt.Portal, Uw = tt.Sub, Kw = tt.RadioGroup;
function xe({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Rr.Provider, { value: n, children: /* @__PURE__ */ o(tt.Root, { ...t }) });
}
const Ea = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Et();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ o(Ee, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
Ea.displayName = tt.SubTrigger.displayName;
...
Sa.displayName = tt.SubContent.displayName;
const ee = b.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = dt();
...
ee.displayName = tt.Content.displayName;
const fn = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = dt(), s = Et();
  return /* @__PURE__ */ o(
    tt.Item,
    {
...
const Ta = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Et();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(tt.ItemIndicator, { children: /* @__PURE__ */ o(vn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
Ta.displayName = tt.RadioItem.displayName;
...
an.displayName = tt.Label.displayName;
...
function so({
  ...
  const x = j(() => {
  ...
  }, [e.date, r]), N = z(() => e.user, [e.user]), v = z(
    ...
    if (a && n)
      return /* @__PURE__ */ c(at, { children: [
        !Zs(e.contents) && /* @__PURE__ */ c(
          fn,
          {
            onClick: () => {
              f(!0), u(Lw(zr(e.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(ka, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(_a, { className: "tw-text-xs tw-font-medium", children: v }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: R }),
            /* @__PURE__ */ o("div", { className: "tw-flex-1" }),
            t && e.assignedUser !== void 0 && /* @__PURE__ */ c(Re, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              sr(e.assignedUser, r)
            ] })
          ] }),
          p && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), x()) : _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), Gt(m) && y());
              },
              onKeyDown: (_) => {
                ya(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  or,
        ...
        a && !t && s !== "Resolved" && i && /* @__PURE__ */ o(
          B,
          {
            ...
            onClick: (_) => {
              _.stopPropagation(), i({ threadId: e.thread, status: "Resolved" });
            },
            children: /* @__PURE__ */ o(Ot, {})
          }
        ),
        V && /* @__PURE__ */ c(xe, { children: [
          /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ho, {}) }) }),
          /* @__PURE__ */ o(ee, { align: "end", children: V })
        ] })
      ]
    }
  );
...
function qw({
  ...
  const [u, g] = M(cn), [x, y] = M(!1), [R, N] = M(!1), [v, C] = M(!1), [V, _] = M(!1), [E, D] = M(!1), [k, S] = M(void 0), L = z(() => e.filter((I) => !I.deleted), [e]), P = z(() => L[0], [L]), J = rt(null), O = rt(void 0);
  Q(() => {
    const I = J.current;
    if (!I) return;
    const ct = () => {
    ...
    return ct(), window.addEventListener("resize", ct), () => window.removeEventListener("resize", ct);
  }, [P == null ? void 0 : P.verse]), Q(() => {
    C(!1);
  }, [n]);
  const X = z(
    () => ({
    ...
    const I = sr(a, t);
    return ie(t["%comment_assigned_to%"], {
      assignedUser: I
    });
  }, [a, t]), W = z(() => L.slice(1), [L]), it = z(() => W.length ?? 0, [W.length]), Ft = z(() => it > 0, [it]), Mt = z(() => v || it <= 2 ? W : W.slice(-2), [W, it, v]), $ = z(() => v || it <= 2 ? 0 : it - 2, [it, v]), ot = z(
    () => it === 1 ? X.singleReply : ie(X.multipleReplies, { count: it }),
    [it, X]
  ), yt = z(
    () => $ === 1 ? X.singleReply : ie(X.multipleReplies, { count: $ }),
    [$, X]
  ), vt = j(async () => {
    var ct, St;
    const I = Gt(u) ? ar(u) : void 0;
    if (k !== void 0) {
      await w({
        threadId: l,
        contents: I,
        assignedUser: k
      }) && (S(void 0), I && ((ct = O.current) == null || ct.call(O), g(cn)));
      return;
    }
    I && await w({ threadId: l, contents: I }) && ((St = O.current) == null || St.call(O), g(cn));
  }, [u, w, k, l]), kt = j(
    async (I) => {
      var ye;
      const ct = Gt(u) ? ar(u) : void 0, St = await w({
        ...I,
        contents: ct,
        assignedUser: k
      });
      return St && ct && ((ye = O.current) == null || ye.call(O), g(cn)), St && k !== void 0 && S(void 0), St;
    },
    [u, w, k]
  );
  return /* @__PURE__ */ o(
    Tr,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(Na, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          A && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: A }),
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            R && /* @__PURE__ */ o(
              B,
              {
                ...
                size: "icon",
                onClick: (I) => {
                  I.stopPropagation(), y(!x);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": x ? "Collapse text" : "Expand text",
                children: x ? /* @__PURE__ */ o(Xn, {}) : /* @__PURE__ */ o(pe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
            so,
            {
              ...
              isThreadExpanded: n,
              threadStatus: d,
              isEditable: L.length === 1 && (P == null ? void 0 : P.user) === s,
        ...
        /* @__PURE__ */ c(at, { children: [
          Ft && !n && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: ot })
          ] }),
          !n && Gt(u) && /* @__PURE__ */ o(
            or,
            {
              editorSerializedState: u,
              onSerializedChange: (I) => g(I),
              placeholder: t["%comment_replyOrAssign%"]
            }
          ),
          n && /* @__PURE__ */ c(at, { children: [
            $ > 0 && /* @__PURE__ */ c(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (I) => {
                  (I.key === "Enter" || I.key === " ") && (I.preventDefault(), I.stopPropagation(), C(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    v ? /* @__PURE__ */ o(Xn, {}) : /* @__PURE__ */ o(pe, {})
                  ] })
                ]
              }
            ),
            Mt.map((I) => {
              const St = I.id === W[W.length - 1].id && I.user === s;
            ...
            (!V || Gt(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (I) => {
                  I.key === "Enter" && I.shiftKey && (I.preventDefault(), I.stopPropagation(), (Gt(u) || k !== void 0) && vt());
                },
                onKeyDown: (I) => {
                  ya(I), (I.key === "Enter" || I.key === " ") && I.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    or,
                    {
                      editorSerializedState: u,
                      onSerializedChange: (I) => g(I),
                      placeholder: d === "Resolved" ? t["%comment_reopenResolved%"] : t["%comment_replyOrAssign%"],
                      autoFocus: !0,
                      onClear: (I) => {
                        O.current = I;
                      }
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    k !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ie(
                    ...
                    /* @__PURE__ */ c(be, { open: E, onOpenChange: D, children: [
                      /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
                        B,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !m || m.length === 0 || !m.includes(s),
                      ...
                      /* @__PURE__ */ o(
                        te,
                        {
                          ...
                          align: "end",
                          onKeyDown: (I) => {
                            I.key === "Escape" && (I.stopPropagation(), D(!1));
                          },
                          children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: m == null ? void 0 : m.map((I) => {
                            let ct = I;
                            return I === "" ? ct = t["%comment_assign_unassigned%"] ?? "Unassigned" : I === "Team" && (ct = t["%comment_assign_team%"] ?? "Team"), /* @__PURE__ */ o(
                              Qt,
                              {
                                onSelect: () => {
                                  S(I !== a ? I : void 0), D(!1);
                                ...
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ o("span", { children: ct })
                              },
                              I || "unassigned"
                            );
                          }) }) })
...
function vp({
  ...
  const [d, w] = M(), p = t.filter(
    ...
    w(N);
  }, []), { listboxRef: g, activeId: x, handleKeyDown: y } = Tl({
    options: f,
    onOptionSelect: m
  }), R = j(
    (N) => {
...
function Jw({ table: e }) {
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o(Gi, { asChild: !0, children: /* @__PURE__ */ c(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Ns, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(ee, { align: "end", className: "tw-w-[150px]", children: [
...
const Oe = st.Root, Ww = st.Group, Ie = st.Value, Zw = Zt(
...
), me = b.forwardRef(({ className: e, children: t, size: n, ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ c(
    st.Trigger,
    {
      className: h(Zw({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ o(st.Icon, { asChild: !0, children: /* @__PURE__ */ o(pe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
me.displayName = st.Trigger.displayName;
const Ra = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(Xn, { className: "tw-h-4 tw-w-4" })
  }
));
Ra.displayName = st.ScrollUpButton.displayName;
const Da = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollDownButton,
  {
    ref: n,
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
Da.displayName = st.ScrollDownButton.displayName;
const he = b.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ o(st.Portal, { children: /* @__PURE__ */ c(
    st.Content,
    {
      ref: a,
      className: h(
...
he.displayName = st.Content.displayName;
...
const Nt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  st.Item,
  {
    ref: r,
    className: h(
...
Nt.displayName = st.Item.displayName;
...
td.displayName = st.Separator.displayName;
function ed({ table: e }) {
  return /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-justify-between tw-px-2 tw-pb-3 tw-pt-3", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-space-x-6 lg:tw-space-x-8", children: [
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ c(
        Oe,
        {
          ...
          children: [
            /* @__PURE__ */ o(me, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Ie, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(he, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(Nt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Cn = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => {
...
const En = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ o(
  "thead",
  {
    ref: r,
    className: h(
...
const Sn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", e), ...t }));
...
const Vt = b.forwardRef(({ className: e, onKeyDown: t, onSelect: n, setFocusAlsoRunsSelect: r = !1, ...a }, s) => {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), sd(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), ad(l, x, p.key);
...
function ld({
  ...
  var _;
  const [p, f] = M([]), [m, u] = M([]), [g, x] = M({}), [y, R] = M({}), N = z(() => t ?? [], [t]), v = Mo({
    data: N,
    columns: e,
    getCoreRowModel: Vo(),
  ...
  }), C = v.getVisibleFlatColumns();
  let V;
  return d ? V = Array.from({ length: 10 }).map((k, S) => `skeleton-row-${S}`).map((k) => /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(ce, { colSpan: C.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(ir, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((_ = v.getRowModel().rows) == null ? void 0 : _.length) > 0 ? V = v.getRowModel().rows.map((E) => /* @__PURE__ */ o(
    Vt,
    {
      onClick: () => i(E, v),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((D) => /* @__PURE__ */ o(ce, { children: Xe(D.column.columnDef.cell, D.getContext()) }, D.id))
    },
    E.id
  )) : V = /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(ce, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Jw, { table: v }),
    /* @__PURE__ */ c(Cn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(En, { stickyHeader: s, children: v.getHeaderGroups().map((E) => /* @__PURE__ */ o(Vt, { children: E.headers.map((D) => /* @__PURE__ */ o(Qe, { children: D.isPlaceholder ? void 0 : Xe(D.column.columnDef.header, D.getContext()) }, D.id)) }, E.id)) }),
      /* @__PURE__ */ o(Sn, { children: V })
    ] }),
...
function dd({
  ...
  const a = lo(n, "%webView_error_dump_header%"), s = lo(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(fo, {}) })
        ] }),
...
function Np({
  ...
  return /* @__PURE__ */ c(be, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: r }),
    /* @__PURE__ */ c(te, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ c(B, { variant: "default", children: [
      /* @__PURE__ */ o(Ss, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(pe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(ee, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      /* @__PURE__ */ o(an, { children: w.label }),
      /* @__PURE__ */ o(Ca, { children: w.itemType === 0 ? /* @__PURE__ */ o(at, { children: w.items.map((f, m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Kt,
        {
          checked: r[p][m],
        ...
        Kw,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Ta, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ o(Pe, {})
    ] }, w.label)) })
...
function _p({
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        t && /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-1", children: [
        ...
        (a || i) && /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          a && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ c(
            B,
            {
              onClick: () => s(),
              variant: "link",
          ...
          i && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ c(
            B,
            {
              onClick: () => l(),
              variant: "link",
...
function pd({ id: e, versionHistory: t }) {
  ...
  function s(l) {
    const d = new Date(l), w = new Date(a.getTime() - d.getTime()), p = w.getUTCFullYear() - 1970, f = w.getUTCMonth(), m = w.getUTCDate() - 1;
    let u = "";
  ...
  return /* @__PURE__ */ c("div", { className: "pr-twp", id: e, children: [
    /* @__PURE__ */ o("h3", { className: "tw-text-md tw-font-semibold", children: "What`s New" }),
    /* @__PURE__ */ o("ul", { className: "tw-list-disc tw-pl-5 tw-pr-4 tw-text-xs tw-text-foreground", children: (n ? i : i.slice(0, 5)).map((l) => /* @__PURE__ */ c("div", { className: "tw-mt-3 tw-flex tw-justify-between", children: [
...
function Cp({
  ...
  const i = z(() => ti(n), [n]), d = ((w) => {
    const p = new Intl.DisplayNames(ei(), { type: "language" });
    return w.map((f) => p.of(f));
  })(r);
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-py-2", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-items-start tw-justify-between tw-text-xs tw-text-foreground", children: [
        ...
        /* @__PURE__ */ o("div", { className: "tw-flex tw-w-3/4 tw-items-center tw-justify-between tw-text-xs tw-text-foreground", children: /* @__PURE__ */ c("p", { className: "tw-flex tw-flex-col tw-justify-start tw-gap-1", children: [
...
function ud({
  ...
  const [R, N] = M(!1), v = j(
    (S) => {
      var P;
      const L = (P = e.find((J) => J.label === S)) == null ? void 0 : P.value;
      L && n(
        t.includes(L) ? t.filter((J) => J !== L) : [...t, L]
      );
    },
    [e, t, n]
  ), C = () => d || r, V = z(() => {
    if (!m) return e;
    const S = e.filter((P) => P.starred).sort((P, J) => P.label.localeCompare(J.label)), L = e.filter((P) => !P.starred).sort((P, J) => {
      const O = t.includes(P.value), X = t.includes(J.value);
      return O && !X ? -1 : !O && X ? 1 : P.label.localeCompare(J.label);
    });
    return [...S, ...L];
  }, [e, t, m]), _ = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: y, className: g, children: /* @__PURE__ */ c(be, { open: D, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ c(
      B,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ o(go, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(fe, { children: [
      /* @__PURE__ */ o(on, { placeholder: `Search ${r.toLowerCase()}...` }),
      a && /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: _, children: s }),
        /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: E, children: i })
      ] }),
      /* @__PURE__ */ c(ge, { children: [
        /* @__PURE__ */ o(Nn, { children: l }),
        /* @__PURE__ */ o(qt, { children: V.map((S) => /* @__PURE__ */ c(
          Qt,
          {
            value: S.label,
            onSelect: v,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Os, { className: "tw-h-4 tw-w-4" }),
...
function Ep({
  ...
  return /* @__PURE__ */ c("div", { id: f, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    t.length > 0 ? /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: t.map((m) => {
      var u;
      return /* @__PURE__ */ c(Re, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ o(
          B,
          {
            variant: "ghost",
...
const md = (e, t, n) => e === "generated" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o("p", { children: "-" }),
  " ",
...
function hd({
  ...
  const [s, i] = M(e), [l, d] = M(n);
  return Q(() => {
    i(e);
  }, [e]), Q(() => {
    l !== n && d(n);
  }, [n]), /* @__PURE__ */ c(xe, { onOpenChange: (p) => {
    p || (s !== "custom" || l ? (t(s), r(l)) : (i(e), d(n)));
  }, children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Xt, { children: [
      /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "outline", className: "tw-h-6", children: md(e, a, n) }) }) }),
      /* @__PURE__ */ o(Pt, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ c(ee, { className: "tw-z-[300]", children: [
      ...
      /* @__PURE__ */ o(
        Kt,
        {
          ...
          children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
            ...
            /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: Yn })
          ] })
        }
      ),
      /* @__PURE__ */ o(
...
const fd = (e, t) => e === "f" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o(bo, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o(vo, {}),
  " ",
  ...
  return e === "f" && (n = t["%footnoteEditor_noteType_footnote_label%"]), ie(t["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function bd({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Xt, { children: [
      /* @__PURE__ */ o($i, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(
        B,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o("p", { children: gd(e, n) }) })
    ] }) }),
    e !== "x" && /* @__PURE__ */ c(ee, { className: "tw-z-[300]", children: [
...
function Sp({
  ...
  const l = rt(null), d = ps(), [w, p] = M("generated"), [f, m] = M("*"), [u, g] = M("f"), x = z(
    () => ({
      ...s,
  ...
  Q(() => {
    ...
    var V, _;
    let v;
    const C = e == null ? void 0 : e.at(0);
    if (C && In("note", C)) {
      const E = (V = C.insert.note) == null ? void 0 : V.caller;
      let D = "custom";
      E === Yn ? D = "generated" : E === qn ? D = "hidden" : E && m(E), p(D), g(((_ = C.insert.note) == null ? void 0 : _.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), v = setTimeout(() => {
        var k;
        (k = l.current) == null || k.applyUpdate([{ delete: 1 }, C]);
      }, 0);
    }
    return () => {
      v && clearTimeout(v);
  ...
  const y = j(() => {
    var C, V;
    const v = (V = (C = l.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : V.at(0);
    v && In("note", v) && (v.insert.note && (w === "custom" ? v.insert.note.caller = f : v.insert.note.caller = w === "generated" ? Yn : qn), t([v]));
  }, [w, f, t]), R = () => {
    var C;
    const v = (C = d.current) == null ? void 0 : C.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ o(
          bd,
          {
            ...
            handleNoteTypeChange: (v) => {
              var V, _, E;
              g(v);
              const C = (_ = (V = l.current) == null ? void 0 : V.getNoteOps(0)) == null ? void 0 : _.at(0);
              C && In("note", C) && (C.insert.note && (C.insert.note.style = v), (E = l.current) == null || E.applyUpdate([{ delete: 1 }, C]));
            },
            localizedStrings: i
          }
        ),
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Xt, { children: [
          /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(en, {}) }) }),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Xt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: R, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(fo, {}) }) }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ c(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(Un, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function yd({
  ...
  const d = r ? /* @__PURE__ */ o("span", { className: "marker", children: `\\${e.marker} ` }) : void 0, w = r ? /* @__PURE__ */ o("span", { className: "marker", children: ` \\${e.marker}*` }) : void 0, p = /* @__PURE__ */ c(at, { children: [
    a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
    // specific class name in case styling is needed.
    /* @__PURE__ */ c("span", { className: h("note-caller", { formatted: s }), children: [
      a,
      " "
    ] }),
    i && /* @__PURE__ */ c(at, { children: [
      Dr(e.marker, [i], r, !1),
      " "
    ] })
  ] }), u = h(t === "horizontal" ? "horizontal tw-table-cell" : "vertical", r ? "marker-visible" : "");
  return /* @__PURE__ */ c(at, { children: [
    /* @__PURE__ */ c("div", { className: h("textual-note-header tw-text-nowrap tw-pr-2", u), children: [
      d,
      p
    ] }),
    /* @__PURE__ */ o("div", { className: h("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ o(at, { children: vd(e.marker, l, r, w) }) })
  ] });
}
...
function Dp({
  ...
  const f = p ? Nd(p, "%webView_footnoteList_header%") : "Footnotes", m = d ?? ni(n, void 0), u = (v, C) => {
    w == null || w(v, C, a);
  }, g = s ? n.findIndex((v) => v === s) : 0, [x, y] = M(g), R = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
          v.preventDefault(), y((C) => Math.min(C + 1, n.length - 1));
          break;
        case "ArrowUp":
          v.preventDefault(), y((C) => Math.max(C - 1, 0));
          break;
        case "Enter":
        case " ":
          ...
          "div",
          {
            ...
            children: n.map((v, C) => {
              ...
              return /* @__PURE__ */ c(at, { children: [
                ...
                C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(De, {})
              ] });
            })
          }
        )
...
function _d({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], a = n["%webView_inventory_occurrences_table_header_occurrence%"], s = z(() => {
  ...
  return /* @__PURE__ */ c(Cn, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(En, { stickyHeader: !0, children: /* @__PURE__ */ c(Vt, { children: [
      /* @__PURE__ */ o(Qe, { children: r }),
      /* @__PURE__ */ o(Qe, { children: a })
    ] }) }),
    /* @__PURE__ */ o(Sn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Vt,
      {
        onClick: () => {
          t(i.reference);
        ...
        children: [
          /* @__PURE__ */ o(ce, { children: `${q.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ o(ce, { children: kd(i.text) })
        ]
      },
...
const Or = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Jn.Root,
  {
    ref: n,
    className: h(
...
Or.displayName = Jn.Root.displayName;
const Tn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Op = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => /* @__PURE__ */ c(B, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Tn(t.getIsSorted())
  ] })
}), Cd = (e, t) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ c(B, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    e,
    Tn(n.getIsSorted())
  ] })
}), Ip = (e) => ({
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(B, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Tn(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(B, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    Tn(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ c(Sr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        Ye,
        {
          onClick: (d) => {
  ...
  return e.forEach((a) => {
    const s = r.find(
      (i) => xo(
        i.items,
        Dn(a.inventoryText) ? [a.inventoryText] : a.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: Dn(a.inventoryText) ? [a.inventoryText] : a.inventoryText,
        count: 1,
        status: Ed(
          Dn(a.inventoryText) ? a.inventoryText : a.inventoryText[0],
          t,
          n
        ),
        occurrences: [
...
function Lp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), y = Tt(n, "%webView_inventory_scope_chapter%"), R = Tt(n, "%webView_inventory_scope_verse%"), N = Tt(n, "%webView_inventory_filter_text%"), v = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), C = Tt(n, "%webView_inventory_no_results%"), [V, _] = M(!1), [E, D] = M("all"), [k, S] = M(""), [L, P] = M([]), J = z(() => {
    const $ = e ?? [];
    return $.length === 0 ? [] : Td($, a, s);
  }, [e, a, s]), O = z(() => {
    if (V) return J;
    const $ = [];
    return J.forEach((ot) => {
      const yt = ot.items[0], vt = $.find(
        (kt) => kt.items[0] === yt
      );
      vt ? (vt.count += ot.count, vt.occurrences = vt.occurrences.concat(ot.occurrences)) : $.push({
        items: [yt],
        count: ot.count,
  ...
  }, [V, J]), X = z(() => O.length === 0 ? [] : Sd(O, E, k), [O, E, k]), A = z(() => {
    var yt, vt;
    if (!V) return d;
    const $ = (yt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : yt.length;
    if (!$) return d;
    const ot = [];
    for (let kt = 0; kt < $; kt++)
      ot.push(
        Cd(
          ((vt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : vt[kt]) || "Additional Item",
          kt + 1
        )
      );
    return [...ot, ...d];
  ...
  Q(() => {
    X.length === 0 ? P([]) : X.length === 1 && P(X[0].items);
  }, [X]);
  const W = ($, ot) => {
    ot.setRowSelection(() => {
      const yt = {};
      return yt[$.index] = !0, yt;
    }), P($.original.items);
  }, it = ($) => {
    ...
    const $ = O.filter((ot) => xo(
      V ? ot.items : [ot.items[0]],
      L
    ));
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ c(
        Oe,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ o(me, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ c(he, { children: [
              /* @__PURE__ */ o(Nt, { value: "all", children: f }),
              /* @__PURE__ */ o(Nt, { value: "approved", children: m }),
              /* @__PURE__ */ o(Nt, { value: "unapproved", children: u }),
              /* @__PURE__ */ o(Nt, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(Oe, { onValueChange: ($) => it($), defaultValue: i, children: [
        /* @__PURE__ */ o(me, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(he, { children: [
          /* @__PURE__ */ o(Nt, { value: "book", children: x }),
          /* @__PURE__ */ o(Nt, { value: "chapter", children: y }),
          /* @__PURE__ */ o(Nt, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Le,
      ...
      r && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        /* @__PURE__ */ o(
          Or,
          {
            className: "tw-m-1",
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? v })
      ] })
    ] }),
    ...
    Mt.length > 0 && /* @__PURE__ */ o("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ o(
      _d,
      {
        occurrenceData: Mt,
        setScriptureReference: t,
...
const Rd = "16rem", Dd = "3rem", Ia = b.createContext(void 0);
function Rn() {
  const e = b.useContext(Ia);
  if (!e)
...
const Ma = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), f = t ?? w, m = b.useCallback(
      (v) => {
        const C = typeof v == "function" ? v(f) : v;
        n ? n(C) : p(C);
      },
      [n, f]
    ), u = b.useCallback(() => m((v) => !v), [m]), g = f ? "expanded" : "collapsed", R = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: m,
    ...
    return /* @__PURE__ */ o(Ia.Provider, { value: N, children: /* @__PURE__ */ o($t, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Aa = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Rn();
...
Aa.displayName = "Sidebar";
const Od = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Rn();
  return /* @__PURE__ */ c(
    B,
    {
...
const wr = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Me : "div",
  {
    ref: r,
...
const Pd = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Me : "button",
  {
    ref: r,
...
const Ld = Zt(
  ...
  ({
    ...
    const d = e ? Me : "button", { state: w } = Rn(), p = /* @__PURE__ */ o(
      d,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: h(Ld({ variant: n, size: r }), s),
        ...i
      }
    );
...
Ba.displayName = "SidebarMenuButton";
const Bd = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Me : "button",
  {
    ref: a,
...
zd.displayName = "SidebarMenuBadge";
const jd = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      ...n,
      children: [
        t && /* @__PURE__ */ o(ir, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ o(
          ir,
          {
...
const Hd = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? Me : "a",
  {
    ref: s,
  ...
  return /* @__PURE__ */ o(
    Aa,
    {
      ...
      children: /* @__PURE__ */ c($a, { children: [
        /* @__PURE__ */ c(lr, { children: [
          /* @__PURE__ */ o(wr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(dr, { children: /* @__PURE__ */ o(Pa, { children: Object.entries(t).map(([m, u]) => /* @__PURE__ */ o(La, { children: /* @__PURE__ */ o(
            Ba,
            {
              onClick: () => w(m),
              isActive: f(m),
        ...
        /* @__PURE__ */ c(lr, { children: [
          /* @__PURE__ */ o(wr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ o(dr, { className: "tw-pl-3", children: /* @__PURE__ */ o(
            tr,
            {
              buttonVariant: "ghost",
...
const Ir = tn(
  ({ value: e, onSearch: t, placeholder: n, isFullWidth: r, className: a, isDisabled: s = !1, id: i }, l) => {
    const d = dt();
    return /* @__PURE__ */ c("div", { id: i, className: h("tw-relative", { "tw-w-full": r }, a), children: [
      /* @__PURE__ */ o(
        uo,
        {
          className: h(
    ...
    /* @__PURE__ */ c(
      Ma,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Va, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const Ht = "scrBook", Ud = "scrRef", se = "source", Kd = "details", Yd = "Scripture Reference", qd = "Scripture Book", za = "Type", Jd = "Details";
function Wd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Ht ? _e(a.start) : void 0;
      },
      getGroupingValue: (r) => q.bookIdToNumber(r.start.book),
      sortingFn: (r, a) => Kn(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (r) => _e(r.start),
      id: Ud,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : _e(a.start);
      },
      sortingFn: (r, a) => Kn(r.original.start, a.original.start),
      enableGrouping: !1
    },
    {
      ...
      id: se,
      header: n ? (e == null ? void 0 : e.typeColumnName) ?? za : void 0,
...
const Zd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Kn(e.start, e.end) === 0 ? `${On(e.start)}+${t}` : `${On(e.start)}+${t}-${On(e.end)}+${n}`;
}, wo = (e) => `${Zd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function zp({
  sources: e,
  ...
  const [w, p] = M([]), [f, m] = M([{ id: Ht, desc: !1 }]), [u, g] = M({}), x = z(
    () => e.flatMap((k) => k.data.map((S) => ({
      ...S,
      source: k.source
    }))),
    [e]
  ...
  Q(() => {
    if (l) {
      const k = R.getSelectedRowModel().rowsById, S = Object.keys(k);
      if (S.length === 1) {
        const L = x.find((P) => wo(P) === S[0]) || void 0;
        L && l(L);
      }
    }
  }, [u, x, l, R]);
  const N = a ?? qd, v = s ?? za, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Ht] },
    { label: `Group by ${v}`, value: [se] },
    {
  ...
  }, E = (k, S) => k.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), D = (k, S, L) => {
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ c(
      Oe,
      {
        ...
        children: [
          /* @__PURE__ */ o(me, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Ie, {}) }),
          /* @__PURE__ */ o(he, { position: "item-aligned", children: /* @__PURE__ */ o(Ww, { children: C.map((k) => /* @__PURE__ */ o(Nt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Cn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(En, { children: R.getHeaderGroups().map((k) => /* @__PURE__ */ o(Vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(Qe, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ o(Sn, { children: R.getRowModel().rows.map((k, S) => {
        const L = dt();
        return /* @__PURE__ */ o(
          Vt,
          {
            ...
            children: k.getVisibleCells().map((P) => {
              if (!(P.getIsPlaceholder() || P.column.columnDef.enableGrouping && !P.getIsGrouped() && (P.column.columnDef.id !== se || !n)))
                return /* @__PURE__ */ o(
                  ce,
                  {
                    className: h(
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ c(
                      B,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ o(pe, {}),
                          !k.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(Hn, {})),
                          " ",
                          Xe(P.column.columnDef.cell, P.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
}), ja = (e, t, n) => Mr(e, t).every((r) => n.includes(r));
function Qd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Mr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    B,
    {
      variant: "outline",
...
function tc({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], d = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], f = r["%webView_book_selector_more%"], { otLong: m, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  }, [y, R] = M(!1), [N, v] = M(""), C = rt(void 0), V = rt(!1);
  if (e.length !== q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const _ = z(() => q.allBookIds.filter(
    (O, X) => e[X] === "1" && !q.isObsolete(q.bookIdToNumber(O))
  ), [e]), E = z(() => {
    if (!N.trim()) {
      const A = {
        [G.OT]: [],
    ...
    (O, X = !1) => {
      if (!X || !C.current) {
        n(
          t.includes(O) ? t.filter(($) => $ !== O) : [...t, O]
        ), C.current = O;
        return;
      }
      const A = _.findIndex(($) => $ === C.current), W = _.findIndex(($) => $ === O);
      if (A === -1 || W === -1) return;
      const [it, Ft] = [
        Math.min(A, W),
        Math.max(A, W)
      ], Mt = _.slice(it, Ft + 1).map(($) => $);
      n(
        t.includes(O) ? t.filter(($) => !Mt.includes($)) : [.../* @__PURE__ */ new Set([...t, ...Mt])]
      );
    },
    [t, n, _]
  ), k = (O) => {
    D(O, V.current), V.current = !1;
  }, S = (O, X) => {
    O.preventDefault(), D(X, O.shiftKey);
  }, L = j(
    (O) => {
      const X = Mr(_, O).map((A) => A);
      n(
        ja(_, O, t) ? t.filter((A) => !X.includes(A)) : [.../* @__PURE__ */ new Set([...t, ...X])]
      );
    },
    [t, n, _]
  ), P = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(G).map((O) => /* @__PURE__ */ o(
      Qd,
      {
        section: O,
        availableBookIds: _,
    ...
    /* @__PURE__ */ c(
      be,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(te, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            fe,
            {
              shouldFilter: !1,
              onKeyDown: (O) => {
                O.key === "Enter" && (V.current = O.shiftKey);
              },
              children: [
                /* @__PURE__ */ o(
                  on,
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: P, children: d }),
                  /* @__PURE__ */ o(B, { variant: "ghost", size: "sm", onClick: J, children: w })
                ] }),
                /* @__PURE__ */ c(ge, { children: [
                  /* @__PURE__ */ o(Nn, { children: p }),
                  Object.values(G).map((O, X) => {
                    const A = E[O];
                    if (A.length !== 0)
                      return /* @__PURE__ */ c(po, { children: [
                        /* @__PURE__ */ o(
                          qt,
                          {
                            heading: Ko(O, m, u, g, x),
                            children: A.map((W) => /* @__PURE__ */ o(
                              qo,
                              {
                                bookId: W,
                                isSelected: t.includes(W),
                                onSelect: () => k(W),
                                onMouseDown: (it) => S(it, W),
                                section: He(W),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: Qn(W, a),
                        ...
                        X < Object.values(G).length - 1 && /* @__PURE__ */ o(zo, {})
                      ] }, O);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === jn ? jn : co
      ).map((O) => /* @__PURE__ */ o(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(O, a) }, O)),
      t.length > jn && /* @__PURE__ */ o(
        Re,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${t.length - co} ${f}`
        }
      )
    ] })
  ] });
...
function Fp({
  ...
  const w = re(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), m = re(i, "%webView_scope_selector_current_book%"), u = re(i, "%webView_scope_selector_choose_books%"), g = re(i, "%webView_scope_selector_scope%"), x = re(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], R = t ? y.filter((N) => t.includes(N.value)) : y;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        yr,
        {
          ...
          children: R.map(({ value: N, label: v, id: C }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(hn, { className: "tw-me-2", value: N, id: C }),
            /* @__PURE__ */ o(wt, { htmlFor: C, children: v })
          ] }, C))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
...
function Gp({
  ...
  return /* @__PURE__ */ c(
    Oe,
    {
      ...
      children: [
        /* @__PURE__ */ o(me, { size: a, className: h("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Ie,
          {
            placeholder: l[Y(t)] ?? t
          }
        ...
        /* @__PURE__ */ o(
          he,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(Nt, { value: `${w}`, children: l[Y(w)] }, `${w}`))
          }
        )
      ]
    }
...
function gn({ icon: e, menuLabel: t, leading: n }) {
  return e ? /* @__PURE__ */ o(
    "img",
    {
...
const Ga = (e, t, n, r) => n ? Object.entries(e).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Xt, { children: [
  /* @__PURE__ */ o(de, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    fn,
    {
      onClick: () => {
        r(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ o(gn, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ o(gn, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ c(Uw, { children: [
    /* @__PURE__ */ o(Ea, { children: l.label }),
    /* @__PURE__ */ o(Xw, { children: /* @__PURE__ */ o(Sa, { children: Ga(
      e,
      t,
      Fa(e, l.id),
      r
...
function cr({
  ...
  return /* @__PURE__ */ c(xe, { variant: s, children: [
    /* @__PURE__ */ o($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(B, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Fs, {}) }) }),
    /* @__PURE__ */ o(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(po, { children: [
      /* @__PURE__ */ o(Ca, { children: /* @__PURE__ */ o($t, { children: Ga(t.groups, t.items, d, e) }) }),
...
function Kp({
  ...
  return /* @__PURE__ */ c(Ha, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ o(
      cr,
      {
        onSelectMenuItem: e,
...
function Yp({
  ...
  return /* @__PURE__ */ o(Ha, { className: "tw-pointer-events-none", id: n, children: t && /* @__PURE__ */ o(
    cr,
    {
      onSelectMenuItem: e,
      menuData: t,
...
const Xa = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    bt.Root,
    {
...
Xa.displayName = bt.List.displayName;
...
Ua.displayName = bt.List.displayName;
...
)), Ka = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  bt.Content,
  {
    ref: n,
    className: h(
...
Ka.displayName = bt.Content.displayName;
function qp({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Xa, { children: [
      /* @__PURE__ */ o(Ua, { children: e.map((l) => /* @__PURE__ */ o(ec, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(Ka, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function nc({ ...e }) {
...
const Ya = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ o(Rr.Provider, { value: a, children: /* @__PURE__ */ o(
    et.Root,
    {
      ref: r,
      className: h(
...
Ya.displayName = et.Root.displayName;
  ...
  return /* @__PURE__ */ o(
    et.Trigger,
    {
      ...
      className: h(
        ...
        // CUSTOM
        "pr-twp",
        jt({ variant: r.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...t
    }
...
Ja.displayName = et.SubTrigger.displayName;
...
Wa.displayName = et.SubContent.displayName;
const Za = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = Et();
...
Za.displayName = et.Content.displayName;
const Qa = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = Et();
  return /* @__PURE__ */ o(
    et.Item,
    {
...
const oc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Et();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
const ac = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Et();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(vn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
const sc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
const ts = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  et.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
ts.displayName = et.Separator.displayName;
const Fe = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Xt, { children: [
      /* @__PURE__ */ o(de, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        Qa,
        {
          onClick: () => {
            r(w);
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ o(gn, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ o(gn, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
        `menubar-item-${w.label}-${w.command}`
      ) : /* @__PURE__ */ c(rc, { children: [
        /* @__PURE__ */ o(Ja, { children: w.label }),
        /* @__PURE__ */ o(Wa, { children: es(
          e,
          t,
          Fa(e, w.id),
          r
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ o(ts, {}, `separator-${s}`)), d;
  });
};
function ic({
  menuData: e,
  ...
  const a = rt(void 0), s = rt(void 0), i = rt(void 0), l = rt(void 0), d = rt(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Fe(i, [m, u]);
        break;
      case "alt+n":
        (y = l.current) == null || y.focus(), Fe(l, [m, u]);
        break;
      case "alt+h":
        (R = d.current) == null || R.focus(), Fe(d, [m, u]);
        break;
    }
  }), Q(() => {
    ...
    return /* @__PURE__ */ o(Ya, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(nc, { children: [
      /* @__PURE__ */ o(qa, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ o(
        Za,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o($t, { children: es(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ c(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ o("div", { className: "tw-flex tw-grow tw-basis-0", children: /* @__PURE__ */ c(
              "div",
              {
                className: "tw-flex tw-items-center tw-gap-2",
...
function Zp({
  ...
  const w = lc(
    ...
    a && a(g), r && r([g, ...n.filter((x) => x !== g)]), s && n.find((x) => x === g) && s([...n.filter((x) => x !== g)]), f(!1);
  }, u = (g, x) => {
    var R, N, v, C, V, _;
    const y = x !== g ? ((N = (R = e[g]) == null ? void 0 : R.uiNames) == null ? void 0 : N[x]) ?? ((C = (v = e[g]) == null ? void 0 : v.uiNames) == null ? void 0 : C.en) : void 0;
    return y ? `${(V = e[g]) == null ? void 0 : V.autonym} (${y})` : (_ = e[g]) == null ? void 0 : _.autonym;
  };
  return /* @__PURE__ */ c("div", { id: d, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ c(
      Oe,
      {
        name: "uiLanguage",
        ...
        onOpenChange: (g) => f(g),
        children: [
          /* @__PURE__ */ o(me, { children: /* @__PURE__ */ o(Ie, {}) }),
          /* @__PURE__ */ o(
            he,
            {
              className: "tw-z-[250]",
              children: Object.keys(e).map((g) => /* @__PURE__ */ o(Nt, { value: g, children: u(g, t) }, g))
            }
          )
        ]
      }
    ),
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(wt, { className: "tw-font-normal tw-text-muted-foreground", children: ie(w, {
...
function Qp({
  ...
  return /* @__PURE__ */ o("div", { id: e, className: t, children: n.map((l) => /* @__PURE__ */ c("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ o(
      Or,
      {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ c(xe, { children: [
              /* @__PURE__ */ o($e, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ho, {}) }) }),
              /* @__PURE__ */ o(ee, { align: "end", children: l })
            ] })
          ] }),
...
const dc = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
function eu({
  ...
  return /* @__PURE__ */ c("div", { className: h("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": r }), children: [
    /* @__PURE__ */ o(
      wt,
      {
        htmlFor: e,
...
), pc = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const mc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
mc.displayName = "AlertDescription";
const nu = nt.Root, ru = nt.Trigger, ou = nt.Group, au = nt.Portal, su = nt.Sub, iu = nt.RadioGroup, hc = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: h(
...
const gc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: h(
...
const bc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Item,
  {
    ref: r,
    className: h(
...
const vc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: h(
...
const xc = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: r,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(vn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
xc.displayName = nt.RadioItem.displayName;
const yc = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: h(
...
function _c({
  ...
  return /* @__PURE__ */ o(ns.Provider, { value: r, children: /* @__PURE__ */ o(
    Ct.Root,
    {
...
const lu = Ct.Trigger, Cc = Ct.Portal, wu = Ct.Close, rs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
...
rs.displayName = Ct.Overlay.displayName;
const Ec = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Rc.displayName = Ct.Title.displayName;
...
Dc.displayName = Ct.Description.displayName;
const Oc = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  Wn.Root,
  {
    ref: r,
    className: h(
...
Oc.displayName = Wn.Root.displayName;
function du({
  className: e,
  ...t
}) {
...
const Ic = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ c(
    Ge.Root,
    {
...
Ic.displayName = Ge.Root.displayName;
...
Mc.displayName = Zn.Root.displayName;
const mu = bt.Root, Ac = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    bt.List,
    {
...
Ac.displayName = bt.List.displayName;
...
Vc.displayName = bt.Trigger.displayName;
...
$c.displayName = bt.Content.displayName;
...
export {
  ...
  Va as SidebarInset,
  Pa as SidebarMenu,
  Bd as SidebarMenuAction,
  zd as SidebarMenuBadge,
  Ba as SidebarMenuButton,
  ...
  Xa as VerticalTabs,
  Ka as VerticalTabsContent,
  Ua as VerticalTabsList,
