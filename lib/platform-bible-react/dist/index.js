import ll, { jsx as i, jsxs as y, Fragment as se } from "react/jsx-runtime";
import * as j from "react";
import S, { forwardRef as sr, useCallback as Rt, useState as st, useRef as xe, useEffect as oe, useLayoutEffect as da, useMemo as St } from "react";
import { History as cl, ChevronRight as di, Check as Sn, Circle as ui, ArrowDownWideNarrow as dl, Clock as ul, Bookmark as pl, X as uo, Search as po, ChevronsUpDown as wo, FilterIcon as wl, ChevronDown as Cn, ChevronUp as pi, ArrowLeftIcon as fl, ChevronLeftIcon as ml, ChevronRightIcon as hl, ArrowRightIcon as gl, CircleCheckIcon as bl, CircleXIcon as vl, CircleHelpIcon as yl, ArrowUpIcon as xl, ArrowDownIcon as Nl, ArrowUpDownIcon as kl, Star as El, PanelLeft as Tl, ChevronLeft as Sl, LoaderCircle as Cl, Download as Ol, Filter as Rl, User as _l, Link as Pl, CircleHelp as $l, BookOpen as ua, Shapes as Il, Globe as Al, Ellipsis as Ml } from "lucide-react";
import Ne, { clsx as Dl } from "clsx";
...
import { getChaptersForBook as Vl, deepEqual as fo, substring as zl, formatScrRef as _r, compareScrRefs as Xr, scrRefToBBBCCCVVV as Pr, getLocalizeKeyForScrollGroupId as ft, NumberFormat as Ll, formatBytes as Fl, getErrorMessage as Ul } from "platform-bible-utils";
...
import { useReactTable as fi, getCoreRowModel as mi, getPaginationRowModel as Gl, getSortedRowModel as hi, getFilteredRowModel as Hl, flexRender as mn, getExpandedRowModel as Xl, getGroupedRowModel as Yl } from "@tanstack/react-table";
...
import { MenuItem as Jl, ListItemText as Zl, ListItemIcon as vi, Menu as Ql, Grid as yi, List as tc, IconButton as xi, Drawer as ec, AppBar as nc, Toolbar as rc } from "@mui/material";
...
function* fc() {
  for (let t = 1; t <= Ee.length; t++)
    yield t;
}
const mc = 1, Ei = Ee.length;
function hc() {
...
function Si(t) {
  const e = typeof t == "number" ? go(t) : t;
  return ho(e) && !mo.includes(e);
}
function bc(t) {
  const e = typeof t == "number" ? go(t) : t;
  return ho(e) && mo.includes(e);
...
rt(Bt, "Original", new Bt(qt.Original)), rt(Bt, "Septuagint", new Bt(qt.Septuagint)), rt(Bt, "Vulgate", new Bt(qt.Vulgate)), rt(Bt, "English", new Bt(qt.English)), rt(Bt, "RussianProtestant", new Bt(qt.RussianProtestant)), rt(Bt, "RussianOrthodox", new Bt(qt.RussianOrthodox));
let he = Bt;
function wa(t, e) {
  const n = e[0];
...
const _t = class it {
  constructor(e, n, r, o) {
    if (rt(this, "firstChapter"), rt(this, "lastChapter"), rt(this, "lastVerse"), rt(this, "hasSegmentsDefined"), rt(this, "text"), rt(this, "BBBCCCVVVS"), rt(this, "longHashCode"), rt(this, "versification"), rt(this, "rtlMark", "‏"), rt(this, "_bookNum", 0), rt(this, "_chapterNum", 0), rt(this, "_verseNum", 0), rt(this, "_verse"), r == null && o == null)
      if (e != null && typeof e == "string") {
        const a = e, s = n != null && n instanceof he ? n : void 0;
        ...
        if (e != null && e instanceof it) {
          ...
          if (e == null)
            return;
          const a = e instanceof he ? e : it.defaultVersification;
          this.setEmpty(a);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return s && (c = new he(s)), n ? new it(n, r.toString(), l, c) : new it();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = a[0], a.length > 1)
        try {
          const s = +a[1].trim();
          this.versification = new he(qt[s]);
        } catch {
...
rt(_t, "defaultVersification", he.English), rt(_t, "verseRangeSeparator", "-"), rt(_t, "verseSequenceIndicator", ","), rt(_t, "verseRangeSeparators", [_t.verseRangeSeparator]), rt(_t, "verseSequenceIndicators", [_t.verseSequenceIndicator]), rt(_t, "chapterDigitShifter", 1e3), rt(_t, "bookDigitShifter", _t.chapterDigitShifter * _t.chapterDigitShifter), rt(_t, "bcvMaxValue", _t.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
rt(_t, "ValidStatusType", Ci);
class an extends Error {
}
const cr = ht.Root, bo = ht.Trigger, xc = ht.Group, mh = ht.Portal, hh = ht.Sub, gh = ht.RadioGroup, Nc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ y(
  ht.SubTrigger,
  {
    ref: o,
    className: N(
...
const vo = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ y(
  ht.CheckboxItem,
  {
    ref: o,
    className: N(
...
vo.displayName = ht.CheckboxItem.displayName;
...
Oi.displayName = ht.RadioItem.displayName;
...
function Sc({
  ...
  const a = Array.from({ length: e }, (l, c) => c + 1), s = Rt(
    (l) => {
      o(l);
    },
    [o]
...
function bh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = st(""), [o, a] = st(
    ...
    ct.bookNumberToId(t.bookNum)
  ), [u, m] = st(!1), [w, g] = st(u), b = xe(void 0), f = xe(void 0), h = xe(void 0), k = Rt(
    (T) => Pc(T).filter((D) => {
    ...
    _c.forEach((T) => {
      const D = n.match(T);
      if (D) {
        const [M, Q = void 0, K = void 0] = D.slice(1), U = Ac(M);
  ...
  return oe(() => {
    ...
    /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(
      lc,
      {
        ref: b,
        value: n,
...
const Mc = Ze(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Je : "button", { className: N(Mc({ variant: e, size: n, className: t })), ref: a, ...o })
);
mt.displayName = "Button";
const Dc = Ze(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Ct = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(wi.Root, { ref: n, className: N("pr-twp", Dc(), t), ...e }));
Ct.displayName = wi.Root.displayName;
...
const _i = xn.Root, Pi = xn.Trigger, yo = S.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ i(xn.Portal, { children: /* @__PURE__ */ i(
  xn.Content,
  {
    ref: o,
    align: e,
...
yo.displayName = xn.Content.displayName;
const Bc = Zt.Portal, $i = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Zt.Overlay,
  {
    ref: n,
    className: N(
...
const No = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ i(po, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ i(
    It.Input,
    {
      ref: n,
...
No.displayName = It.Input.displayName;
...
ko.displayName = It.List.displayName;
const Eo = S.forwardRef((t, e) => /* @__PURE__ */ i(It.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Eo.displayName = It.Empty.displayName;
...
Ii.displayName = It.Group.displayName;
...
Lc.displayName = It.Separator.displayName;
...
To.displayName = It.Item.displayName;
function Fc(t) {
      ...
      children: /* @__PURE__ */ y("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ y("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Ct, { className: "tw-ml-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ y("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Ct, { className: "tw-ml-1", children: w })
          ] }),
...
const Ue = yt.Root, Xc = yt.Group, Ge = yt.Value, Te = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  yt.Trigger,
  {
    ref: r,
    className: N(
...
const Ai = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  yt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(pi, { className: "tw-h-4 tw-w-4" })
  }
));
Ai.displayName = yt.ScrollUpButton.displayName;
...
Mi.displayName = yt.ScrollDownButton.displayName;
const Se = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(yt.Portal, { children: /* @__PURE__ */ y(
  yt.Content,
  {
    ref: o,
    className: N(
...
Se.displayName = yt.Content.displayName;
...
const Ft = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  yt.Item,
  {
    ref: r,
    className: N(
    ...
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ y(
        Ue,
        {
          ...
          children: [
            /* @__PURE__ */ i(Te, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ i(Ge, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ i(Se, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ i(Ft, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Zc({
  ...
  var h;
  const [l, c] = st([]), [d, u] = st([]), [m, w] = st({}), [g, b] = st({}), f = fi({
    data: e,
    columns: t,
    getCoreRowModel: mi(),
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y($n, { stickyHeader: a, children: [
      /* @__PURE__ */ i(In, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ i(Kt, { children: k.headers.map((_) => /* @__PURE__ */ i(ue, { children: _.isPlaceholder ? void 0 : mn(_.column.columnDef.header, _.getContext()) }, _.id)) }, k.id)) }),
      /* @__PURE__ */ i(An, { children: (h = f.getRowModel().rows) != null && h.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Kt,
        {
          onClick: () => s(k, f),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((_) => /* @__PURE__ */ i(jt, { children: mn(_.column.columnDef.cell, _.getContext()) }, _.id))
        },
        k.id
      )) : /* @__PURE__ */ i(Kt, { children: /* @__PURE__ */ i(jt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Qc({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = St(() => {
    const s = [];
    return t.forEach((l) => {
  ...
  return /* @__PURE__ */ y($n, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(In, { stickyHeader: !0, children: /* @__PURE__ */ y(Kt, { children: [
      /* @__PURE__ */ i(ue, { children: r }),
      /* @__PURE__ */ i(ue, { children: o })
    ] }) }),
    /* @__PURE__ */ i(An, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ y(
      Kt,
      {
        ...
        children: [
          /* @__PURE__ */ i(jt, { children: `${ct.bookNumberToEnglishName(s.reference.bookNum)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
...
So.displayName = Yr.Root.displayName;
...
}, nd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Di = Ze(
...
ji.displayName = lr.Root.displayName;
...
const dr = (t) => t === "asc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(kl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), xh = (t) => ({
  ...
  return td(t).forEach((u) => {
    ...
    for (; m; ) {
      ...
      const g = m.index, b = a.find((h) => fo(h.items, w)), f = {
        reference: {
...
function Th({
  ...
  const m = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), g = ne(n, "%webView_inventory_unapproved%"), b = ne(n, "%webView_inventory_unknown%"), f = ne(n, "%webView_inventory_scope_currentBook%"), h = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), _ = ne(n, "%webView_inventory_filter_text%"), C = ne(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, v] = st(!1), [P, z] = st("all"), [Y, O] = st(""), [$, T] = st([]), D = St(() => l ? r instanceof RegExp ? id(
    l,
    t,
    a,
    s,
    r
  ) : r(l, t, a, s) : [], [l, r, t, a, s]), M = St(() => {
    if (E)
      return D;
    const x = [];
    return D.forEach((R) => {
    ...
    /* @__PURE__ */ y("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ y(
        Ue,
        {
          ...
          defaultValue: P,
          children: [
            /* @__PURE__ */ i(Te, { className: "tw-m-1", children: /* @__PURE__ */ i(Ge, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ y(Se, { children: [
              /* @__PURE__ */ i(Ft, { value: "all", children: m }),
              /* @__PURE__ */ i(Ft, { value: "approved", children: w }),
              /* @__PURE__ */ i(Ft, { value: "unapproved", children: g }),
              /* @__PURE__ */ i(Ft, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ y(Ue, { onValueChange: (x) => tt(x), defaultValue: c, children: [
        /* @__PURE__ */ i(Te, { className: "tw-m-1", children: /* @__PURE__ */ i(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ y(Se, { children: [
          /* @__PURE__ */ i(Ft, { value: "book", children: f }),
          /* @__PURE__ */ i(Ft, { value: "chapter", children: h }),
          /* @__PURE__ */ i(Ft, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ i(
        _e,
...
function Vi({
  ...
  return /* @__PURE__ */ y("div", { className: "tw-relative", children: [
    /* @__PURE__ */ i(po, { className: "tw-absolute tw-left-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-opacity-50" }),
    /* @__PURE__ */ i(
      _e,
      {
        className: N(
...
zi.displayName = At.List.displayName;
...
Li.displayName = At.List.displayName;
...
Fi.displayName = At.Content.displayName;
function Sh({
  tabList: t,
  onSearch: e,
  searchPlaceholder: n,
...
Co.displayName = bi.Root.displayName;
...
const xd = Ze(
  ...
  ({
    ...
    const c = t ? Je : "button", { state: d } = ur(), u = /* @__PURE__ */ i(
      c,
      {
        ref: l,
...
const ce = "scrBook", Rd = "scrRef", ge = "source", _d = "details", Pd = "Scripture Reference", $d = "Scripture Book", Zi = "Type", Id = "Details";
function Ad(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ct.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === ce ? _r(o.start) : void 0;
      },
...
function Oh({
  ...
  const [d, u] = st([]), [m, w] = st([{ id: ce, desc: !1 }]), [g, b] = st({}), f = St(
  ...
  oe(() => {
    if (l) {
      ...
      if ($.length === 1) {
        const T = f.find((D) => ga(D) === $[0]) || void 0;
        T && l(T);
      }
    }
  }, [g, f, l, k]);
  const _ = o ?? $d, C = a ?? Zi, E = [
  ...
  }, z = (O, $) => O.getIsGrouped() ? "" : N("banded-row", $ % 2 === 0 ? "even" : "odd"), Y = (O, $, T) => {
    if (!((O == null ? void 0 : O.length) === 0 || $.depth < T.column.getGroupedIndex())) {
      if ($.getIsGrouped())
        switch ($.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ y(
      Ue,
      {
        ...
        children: [
          /* @__PURE__ */ i(Te, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ i(Ge, {}) }),
          /* @__PURE__ */ i(Se, { position: "item-aligned", children: /* @__PURE__ */ i(Xc, { children: E.map((O) => /* @__PURE__ */ i(Ft, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ y($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(In, { children: k.getHeaderGroups().map((O) => /* @__PURE__ */ i(Kt, { children: O.headers.filter(($) => $.column.columnDef.header).map(($) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(ue, { colSpan: $.colSpan, className: "top-0 tw-sticky", children: $.isPlaceholder ? void 0 : /* @__PURE__ */ y("div", { children: [
          ...
          " ",
          mn($.column.columnDef.header, $.getContext())
        ] }) }, $.id)
      )) }, O.id)) }),
      /* @__PURE__ */ i(An, { children: k.getRowModel().rows.map((O, $) => /* @__PURE__ */ i(
        Kt,
        {
          ...
          children: O.getVisibleCells().map((T) => {
            if (!(T.getIsPlaceholder() || T.column.columnDef.enableGrouping && !T.getIsGrouped() && (T.column.columnDef.id !== ge || !n)))
              return /* @__PURE__ */ i(
                jt,
                {
                  className: N(
...
function Rh({
  ...
  return /* @__PURE__ */ y(
    Ue,
    {
      ...
      children: [
        /* @__PURE__ */ i(Te, { className: "pr-twp tw-w-auto", children: /* @__PURE__ */ i(
          Ge,
          {
        ...
        /* @__PURE__ */ i(
          ...
          {
            style: { zIndex: 250 },
            children: t.map((a) => /* @__PURE__ */ i(Ft, { value: `${a}`, children: o[ft(a)] }, `${a}`))
          }
        )
      ]
    }
...
function re(t, e, n = {
  ...
  return ye(t) && ye(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ye(e[o]) && o in t && ye(t[o]) ? r[o] = re(t[o], e[o], n) : n.clone ? r[o] = ye(e[o]) ? ts(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function zd() {
  return va || (va = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(A) {
      ...
      A === r || A === d || A === a || A === o || A === m || A === w || typeof A == "object" && A !== null && (A.$$typeof === b || A.$$typeof === g || A.$$typeof === s || A.$$typeof === l || A.$$typeof === u || A.$$typeof === h || A.$$typeof === k || A.$$typeof === _ || A.$$typeof === f);
    }
    function E(A) {
    ...
    var v = c, P = d, z = l, Y = s, O = e, $ = u, T = r, D = b, M = g, Q = n, K = a, U = o, tt = m, ot = !1;
    function at(A) {
      return ot || (ot = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), x(A) || E(A) === c;
    }
    function x(A) {
      return E(A) === d;
    }
    ...
    ut.AsyncMode = v, ut.ConcurrentMode = P, ut.ContextConsumer = z, ut.ContextProvider = Y, ut.Element = O, ut.ForwardRef = $, ut.Fragment = T, ut.Lazy = D, ut.Memo = M, ut.Portal = Q, ut.Profiler = K, ut.StrictMode = U, ut.Suspense = tt, ut.isAsyncMode = at, ut.isConcurrentMode = x, ut.isContextConsumer = R, ut.isContextProvider = L, ut.isElement = F, ut.isForwardRef = V, ut.isFragment = J, ut.isLazy = X, ut.isMemo = W, ut.isPortal = G, ut.isProfiler = Z, ut.isStrictMode = H, ut.isSuspense = lt, ut.isValidElementType = C, ut.typeOf = E;
  }()), ut;
}
var ya;
function es() {
...
function Ud() {
  ...
  return zr = function(l, c) {
      ...
      function F(J, X, W, G, Z, H, lt) {
        if (G = G || w, H = H || W, lt !== n) {
          if (c) {
            ...
            var kt = G + ":" + W;
            !R[kt] && // Avoid spamming the console because they are often not actionable except for lib authors
            L < 3 && (a(
        ...
        return X[W] == null ? J ? X[W] === null ? new f("The " + Z + " `" + H + "` is marked as required " + ("in `" + G + "`, but its value is `null`.")) : new f("The " + Z + " `" + H + "` is marked as required in " + ("`" + G + "`, but its value is `undefined`.")) : null : x(X, W, G, Z, H);
      }
      var V = F.bind(null, !1);
      return V.isRequired = F.bind(null, !0), V;
    }
    function k(x) {
      function R(L, F, V, J, X, W) {
        var G = L[F], Z = U(G);
        if (Z !== x) {
          var H = tt(G);
          return new f(
            "Invalid " + J + " `" + X + "` of type " + ("`" + H + "` supplied to `" + V + "`, expected ") + ("`" + x + "`."),
            { expectedType: x }
          );
        }
        return null;
    ...
    function C(x) {
      function R(L, F, V, J, X) {
        if (typeof x != "function")
          return new f("Property `" + X + "` of component `" + V + "` has invalid PropType notation inside arrayOf.");
        var W = L[F];
        if (!Array.isArray(W)) {
          var G = U(W);
          return new f("Invalid " + J + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected an array."));
        }
        for (var Z = 0; Z < W.length; Z++) {
          var H = x(W, Z, V, J, X + "[" + Z + "]", n);
    ...
    function E() {
      function x(R, L, F, V, J) {
        var X = R[L];
        if (!l(X)) {
          var W = U(X);
          return new f("Invalid " + V + " `" + J + "` of type " + ("`" + W + "` supplied to `" + F + "`, expected a single ReactElement."));
        }
        return null;
      }
      return h(x);
    ...
    function v() {
      function x(R, L, F, V, J) {
        ...
        if (!t.isValidElementType(X)) {
          var W = U(X);
          return new f("Invalid " + V + " `" + J + "` of type " + ("`" + W + "` supplied to `" + F + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return h(x);
    ...
    function P(x) {
      function R(L, F, V, J, X) {
        if (!(L[F] instanceof x)) {
          ...
          return new f("Invalid " + J + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected ") + ("instance of `" + W + "`."));
        }
        return null;
      }
      return h(R);
    ...
    function z(x) {
      ...
      function R(L, F, V, J, X) {
        for (var W = L[F], G = 0; G < x.length; G++)
          if (b(W, x[G]))
            return null;
        var Z = JSON.stringify(x, function(lt, A) {
          var kt = tt(A);
          return kt === "symbol" ? String(A) : A;
        });
        return new f("Invalid " + J + " `" + X + "` of value `" + String(W) + "` " + ("supplied to `" + V + "`, expected one of " + Z + "."));
      }
      return h(R);
    }
    function Y(x) {
      function R(L, F, V, J, X) {
        ...
        var W = L[F], G = U(W);
        if (G !== "object")
          return new f("Invalid " + J + " `" + X + "` of type " + ("`" + G + "` supplied to `" + V + "`, expected an object."));
        for (var Z in W)
          if (r(W, Z)) {
            var H = x(W, Z, V, J, X + "." + Z, n);
            if (H instanceof Error)
    ...
    function O(x) {
      ...
      function F(V, J, X, W, G) {
        for (var Z = [], H = 0; H < x.length; H++) {
          var lt = x[H], A = lt(V, J, X, W, G, n);
          if (A == null)
            return null;
          A.data && r(A.data, "expectedType") && Z.push(A.data.expectedType);
        }
        var kt = Z.length > 0 ? ", expected one of type [" + Z.join(", ") + "]" : "";
        return new f("Invalid " + W + " `" + G + "` supplied to " + ("`" + X + "`" + kt + "."));
      }
      return h(F);
    }
    function $() {
      function x(R, L, F, V, J) {
        return Q(R[L]) ? null : new f("Invalid " + V + " `" + J + "` supplied to " + ("`" + F + "`, expected a ReactNode."));
      }
      return h(x);
    }
    ...
    function D(x) {
      function R(L, F, V, J, X) {
        var W = L[F], G = U(W);
        if (G !== "object")
          return new f("Invalid " + J + " `" + X + "` of type `" + G + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var Z in x) {
          var H = x[Z];
          if (typeof H != "function")
            return T(V, J, X, Z, tt(H));
          var lt = H(W, Z, V, J, X + "." + Z, n);
          if (lt)
            return lt;
        }
        return null;
    ...
    function M(x) {
      function R(L, F, V, J, X) {
        ...
        for (var H in Z) {
          var lt = x[H];
          if (r(x, H) && typeof lt != "function")
            return T(V, J, X, H, tt(lt));
          if (!lt)
            return new f(
              "Invalid " + J + " `" + X + "` key `" + H + "` supplied to `" + V + "`.\nBad object: " + JSON.stringify(L[F], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(x), null, "  ")
            );
          var A = lt(W, H, V, J, X + "." + H, n);
          if (A)
            return A;
        }
        return null;
...
function Zd() {
  return Oa || (Oa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(B) {
      return !!(typeof B == "string" || typeof B == "function" || B === n || B === o || _ || B === r || B === d || B === u || k || B === g || b || f || h || typeof B == "object" && B !== null && (B.$$typeof === w || B.$$typeof === m || B.$$typeof === a || B.$$typeof === s || B.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = s, z = a, Y = t, O = c, $ = n, T = w, D = m, M = e, Q = o, K = r, U = d, tt = u, ot = !1, at = !1;
    function x(B) {
    ...
    wt.ContextConsumer = P, wt.ContextProvider = z, wt.Element = Y, wt.ForwardRef = O, wt.Fragment = $, wt.Lazy = T, wt.Memo = D, wt.Portal = M, wt.Profiler = Q, wt.StrictMode = K, wt.Suspense = U, wt.SuspenseList = tt, wt.isAsyncMode = x, wt.isConcurrentMode = R, wt.isContextConsumer = L, wt.isContextProvider = F, wt.isElement = V, wt.isForwardRef = J, wt.isFragment = X, wt.isLazy = W, wt.isMemo = G, wt.isPortal = Z, wt.isProfiler = H, wt.isStrictMode = lt, wt.isSuspense = A, wt.isSuspenseList = kt, wt.isValidElementType = E, wt.typeOf = v;
  }()), wt;
}
...
const cu = typeof window < "u" ? j.useLayoutEffect : j.useEffect, Xe = cu;
let Pa = 0;
function du(t) {
...
const Ou = {
  borderRadius: 4
}, Ru = Ou, _u = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.string, p.object, p.array]) : {}, pe = _u;
function gn(t, e) {
  return e ? re(t, e, {
    clone: !1
...
function Nt(t) {
  const {
    ...
    return ae(s, l, (m) => {
      let w = rr(d, o, m);
      return m === w && typeof m == "string" && (w = rr(d, o, `${e}${m === "default" ? "" : Qt(m)}`, m)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
bt.propTypes = process.env.NODE_ENV !== "production" ? mr.reduce((t, e) => (t[e] = pe, t), {}) : {};
bt.filterProps = mr;
function vt(t) {
  return hs(t, hr);
}
vt.propTypes = process.env.NODE_ENV !== "production" ? hr.reduce((t, e) => (t[e] = pe, t), {}) : {};
vt.filterProps = hr;
process.env.NODE_ENV !== "production" && Bu.reduce((t, e) => (t[e] = pe, t), {});
function zu(t = 8) {
  if (t.mui)
    return t;
  const e = ms({
...
const Lu = Yt("border", Ut), Fu = Yt("borderTop", Ut), Uu = Yt("borderRight", Ut), Gu = Yt("borderBottom", Ut), Hu = Yt("borderLeft", Ut), Xu = Yt("borderColor"), Yu = Yt("borderTopColor"), Wu = Yt("borderRightColor"), qu = Yt("borderBottomColor"), Ku = Yt("borderLeftColor"), Ju = Yt("outline", Ut), Zu = Yt("outlineColor"), br = (t) => {
  if (t.borderRadius !== void 0 && t.borderRadius !== null) {
    const e = Dn(t.theme, "shape.borderRadius", 4, "borderRadius"), n = (r) => ({
      borderRadius: Bn(e, r)
    });
    return ae(t, t.borderRadius, n);
  }
  return null;
};
...
function yp() {
  function t(n, r, o, a) {
    ...
    const w = fr(o, d) || {};
    return m ? m(s) : ae(s, r, (b) => {
      let f = rr(w, u, b);
      return b === f && typeof b == "string" && (f = rr(w, u, `${n}${b === "default" ? "" : Qt(b)}`, b)), c === !1 ? f : {
        [c]: f
      };
    });
  }
...
function Do(t = {}, ...e) {
  ...
  return d.applyStyles = xp, d = e.reduce((u, m) => re(u, m), d), d.unstable_sxConfig = I({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Mo({
      sx: m,
      theme: this
    });
...
function $p(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Kl(s, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const _ = Wl(s, I({
      shouldForwardProp: k,
      label: h
    }, g)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ye(v) ? (P) => Zn(v, I({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      c && w && Y.push((T) => {
        ...
        return Object.entries(M).forEach(([K, U]) => {
          Q[K] = Zn(U, I({}, T, {
            theme: D
          }));
        }), w(T, Q);
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${Qt(d || "")}`), T === void 0 && (T = `Styled(${eu(s)})`), $.displayName = T;
      }
...
function ja(t) {
  t = Oe(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Oe(Dp(t)).values : t.values;
...
function ys(t, e) {
  return t = Oe(t), e = Bo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Nr(t);
}
function Bp(t, e) {
  if (t = Oe(t), e = Bo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const zp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ve = Wp, qp = ["mode", "contrastThreshold", "tonalOffset"], za = {
...
`));
  ...
  const w = ({
    ...
    if (f = I({}, f), !f.main && f[k] && (f.main = f[k]), !f.hasOwnProperty("main"))
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return La(f, "light", _, r), La(f, "dark", C, r), f.contrastText || (f.contrastText = m(f.main)), f;
  }, g = {
    dark: Ur,
    light: za
  };
  return process.env.NODE_ENV !== "production" && (g[e] || console.error(`MUI: The palette mode \`${e}\` is not supported.`)), re(I({
...
function aw(t, e) {
  ...
  const g = o / 14, b = m || ((k) => `${k / d * g}rem`), f = (k, _, C, E, v) => I({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(_),
...
function mw(t) {
  const e = I({}, pw, t.easing), n = I({}, ww, t.duration);
  return I({
...
function vw(t = {}, ...e) {
  ...
  if (d = re(d, s), d = e.reduce((u, m) => re(u, m), d), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return d.unstable_sxConfig = I({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Mo({
      sx: m,
      theme: this
    });
...
const Ew = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Tw = (t) => {
  ...
  const r = zo({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, g = Ot(r, Ew), b = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", f = I({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  u || (h.viewBox = w);
  const k = Tw(f);
  return /* @__PURE__ */ y(Sw, I({
    as: l,
    className: Ne(k.root, a),
    focusable: "false",
    color: d,
...
function zw(t) {
  ...
  if (!e) {
    const g = Ne(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = I({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = I({}, n, o, r);
    return g.length > 0 && (f.className = g), Object.keys(b).length > 0 && (f.style = b), {
      props: f,
      internalRef: void 0
    };
  }
  const s = jw(I({}, o, r)), l = Ya(r), c = Ya(o), d = e(s), u = Ne(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = I({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = I({}, d, n, c, l);
...
function Fw(t) {
  ...
  const {
    ...
    externalSlotProps: l
  })), u = Ce(d, l == null ? void 0 : l.ref, (e = t.additionalProps) == null ? void 0 : e.ref);
  return wn(n, I({}, c, {
    ref: u
  }), o);
}
...
const or = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
  } = e, [s, l] = j.useState(null), c = Ce(/* @__PURE__ */ j.isValidElement(r) ? r.ref : null, n);
  if (Xe(() => {
...
var Pt = "top", Ht = "bottom", Xt = "right", $t = "left", Fo = "auto", Vn = [Pt, Ht, Xt, $t], Ye = "start", En = "end", Yw = "clippingParents", Ts = "viewport", cn = "popper", Ww = "reference", Wa = /* @__PURE__ */ Vn.reduce(function(t, e) {
...
function af(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !Gt(a) || !te(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function sf(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Gt(o) || !te(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
var ke = Math.max, ar = Math.min, We = Math.round;
function oo() {
...
function qe(t, e, n) {
  ...
  e && Gt(t) && (o = t.offsetWidth > 0 && We(r.width) / t.offsetWidth || 1, a = t.offsetHeight > 0 && We(r.height) / t.offsetHeight || 1);
  var s = Re(t) ? zt(t) : window, l = s.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: u,
...
function qa(t) {
  return !Gt(t) || // https://github.com/popperjs/popper-core/issues/837
...
function df(t) {
  ...
  var o = kr(t);
  for (Uo(o) && (o = o.host); Gt(o) && ["html", "body"].indexOf(te(o)) < 0; ) {
    var a = ie(o);
...
function zn(t) {
  for (var e = zt(t), n = qa(t); n && cf(n) && ie(n).position === "static"; )
    n = qa(n);
  return n && (te(n) === "html" || te(n) === "body" && ie(n).position === "static") ? e : n || df(t) || e;
}
function Ho(t) {
...
function wf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Jt(n.placement), c = Ho(l), d = [$t, Xt].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var m = pf(o.padding, n), w = Go(a), g = c === "y" ? Pt : $t, b = c === "y" ? Ht : Xt, f = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = zn(a), _ = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - h / 2, E = m[g], v = _ - w[u] - m[b], P = _ / 2 - w[u] / 2 + C, z = bn(E, P, v), Y = c;
    n.modifiersData[r] = (e = {}, e[Y] = z, e.centerOffset = z - P, e);
  }
}
function ff(t) {
...
function Ka(t) {
  ...
  g = h.x, f = h.y;
  var k = s.hasOwnProperty("x"), _ = s.hasOwnProperty("y"), C = $t, E = Pt, v = window;
  if (d) {
    var P = zn(n), z = "clientHeight", Y = "clientWidth";
    if (P === zt(n) && (P = we(n), ie(P).position !== "static" && l === "absolute" && (z = "scrollHeight", Y = "scrollWidth")), P = P, o === Pt || (o === $t || o === Xt) && a === En) {
      E = Ht;
  ...
  if (g = D.x, f = D.y, c) {
    var M;
    return Object.assign({}, T, (M = {}, M[E] = _ ? "0" : "", M[C] = k ? "0" : "", M.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + f + "px)" : "translate3d(" + g + "px, " + f + "px, 0)", M));
  }
...
function yf(t) {
  var e = t.state, n = t.instance, r = t.options, o = r.scroll, a = o === void 0 ? !0 : o, s = r.resize, l = s === void 0 ? !0 : s, c = zt(e.elements.popper), d = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Xo(t) {
  var e = zt(t), n = e.pageXOffset, r = e.pageYOffset;
  return {
    scrollLeft: n,
    scrollTop: r
  };
...
function Yo(t) {
  return qe(we(t)).left + Xo(t).scrollLeft;
}
function Ef(t, e) {
  var n = zt(t), r = we(t), o = n.visualViewport, a = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function Tf(t) {
  var e, n = we(t), r = Xo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = ke(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = ke(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Yo(t), c = -r.scrollTop;
  return ie(o || n).direction === "rtl" && (l += ke(n.clientWidth, o ? o.clientWidth : 0) - a), {
    width: a,
    height: s,
    x: l,
    y: c
...
function Wo(t) {
  var e = ie(t), n = e.overflow, r = e.overflowX, o = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(n + o + r);
}
function $s(t) {
  return ["html", "body", "#document"].indexOf(te(t)) >= 0 ? t.ownerDocument.body : Gt(t) && Wo(t) ? t : $s(kr(t));
}
function vn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = $s(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = zt(r), s = o ? [a].concat(a.visualViewport || [], Wo(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function Za(t, e, n) {
  return e === Ts ? ao(Ef(t, n)) : Re(e) ? Sf(e, n) : ao(Tf(we(t)));
}
function Cf(t) {
  var e = vn(kr(t)), n = ["absolute", "fixed"].indexOf(ie(t).position) >= 0, r = n && Gt(t) ? zn(t) : t;
  return Re(r) ? e.filter(function(o) {
    return Re(o) && Os(o, r) && te(o) !== "body";
  }) : [];
}
function Of(t, e, n, r) {
  var o = e === "clippingParents" ? Cf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var u = Za(t, d, r);
    return c.top = ke(u.top, c.top), c.right = ar(u.right, c.right), c.bottom = ar(u.bottom, c.bottom), c.left = ke(u.left, c.left), c;
  }, Za(t, s, r));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function Is(t) {
  var e = t.reference, n = t.element, r = t.placement, o = r ? Jt(r) : null, a = r ? Ke(r) : null, s = e.x + e.width / 2 - n.width / 2, l = e.y + e.height / 2 - n.height / 2, c;
  switch (o) {
    case Pt:
      c = {
        x: s,
...
function Tn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Yw : l, d = n.rootBoundary, u = d === void 0 ? Ts : d, m = n.elementContext, w = m === void 0 ? cn : m, g = n.altBoundary, b = g === void 0 ? !1 : g, f = n.padding, h = f === void 0 ? 0 : f, k = _s(typeof h != "number" ? h : Ps(h, Vn)), _ = w === cn ? Ww : cn, C = t.rects.popper, E = t.elements[b ? _ : w], v = Of(Re(E) ? E : E.contextElement || we(t.elements.popper), c, u, s), P = qe(t.elements.reference), z = Is({
    reference: P,
    element: C,
    strategy: "absolute",
    placement: o
  }), Y = ao(Object.assign({}, C, z)), O = w === cn ? Y : P, $ = {
  ...
  if (w === cn && T) {
    ...
    Object.keys($).forEach(function(M) {
      var Q = [Xt, Ht].indexOf(M) >= 0 ? 1 : -1, K = [Pt, Ht].indexOf(M) >= 0 ? "y" : "x";
      $[M] += D[K] * Q;
    });
  }
  return $;
...
function Rf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ss : c, u = Ke(r), m = u ? l ? Wa : Wa.filter(function(b) {
    return Ke(b) === u;
...
function Pf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, m = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, h = e.options.placement, k = Jt(h), _ = k === h, C = c || (_ || !b ? [Qn(h)] : _f(h)), E = [h].concat(C).reduce(function(V, J) {
      return V.concat(Jt(J) === Fo ? Rf(e, {
        placement: J,
        boundary: u,
        rootBoundary: m,
        padding: d,
    ...
    }, []), v = e.rects.reference, P = e.rects.popper, z = /* @__PURE__ */ new Map(), Y = !0, O = E[0], $ = 0; $ < E.length; $++) {
      var T = E[$], D = Jt(T), M = Ke(T) === Ye, Q = [Pt, Ht].indexOf(D) >= 0, K = Q ? "width" : "height", U = Tn(e, {
        placement: T,
        boundary: u,
        rootBoundary: m,
        altBoundary: w,
    ...
    if (Y)
      for (var x = b ? 3 : 1, R = function(J) {
        var X = E.find(function(W) {
          var G = z.get(W);
          if (G)
            return G.slice(0, J).every(function(Z) {
              return Z;
            });
        });
        if (X)
...
function ti(t) {
  return [Pt, Xt, Ht, $t].some(function(e) {
    return t[e] >= 0;
  });
}
function If(t) {
...
function Mf(t, e, n) {
  var r = Jt(t), o = [$t, Pt].indexOf(r) >= 0 ? -1 : 1, a = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, s = a[0], l = a[1];
  return s = s || 0, l = (l || 0) * o, [$t, Xt].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function Lf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, m = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, f = b === void 0 ? 0 : b, h = Tn(e, {
    ...
    padding: m,
    altBoundary: u
  }), k = Jt(e.placement), _ = Ke(e.placement), C = !_, E = Ho(k), v = zf(E), P = e.modifiersData.popperOffsets, z = e.rects.reference, Y = e.rects.popper, O = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, $ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (P) {
    if (a) {
      var M, Q = E === "y" ? Pt : $t, K = E === "y" ? Ht : Xt, U = E === "y" ? "height" : "width", tt = P[E], ot = tt + h[Q], at = tt - h[K], x = g ? -Y[U] / 2 : 0, R = _ === Ye ? z[U] : Y[U], L = _ === Ye ? -Y[U] : -z[U], F = e.elements.arrow, V = g && F ? Go(F) : {
        width: 0,
        height: 0
      }, J = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Rs(), X = J[Q], W = J[K], G = bn(0, z[U], V[U]), Z = C ? z[U] / 2 - x - G - X - $.mainAxis : R - G - X - $.mainAxis, H = C ? -z[U] / 2 + x + G + W + $.mainAxis : L + G + W + $.mainAxis, lt = e.elements.arrow && zn(e.elements.arrow), A = lt ? E === "y" ? lt.clientTop || 0 : lt.clientLeft || 0 : 0, kt = (M = T == null ? void 0 : T[E]) != null ? M : 0, B = tt + Z - kt - A, xt = tt + H - kt, Mt = bn(g ? ar(ot, B) : ot, tt, g ? ke(at, xt) : at);
      P[E] = Mt, D[E] = Mt - tt;
    }
    if (l) {
      var q, et = E === "x" ? Pt : $t, Et = E === "x" ? Ht : Xt, Tt = P[v], Wt = v === "y" ? "height" : "width", fe = Tt + h[et], $e = Tt - h[Et], Ie = [Pt, $t].indexOf(k) !== -1, Ae = (q = T == null ? void 0 : T[v]) != null ? q : 0, me = Ie ? fe : Tt - z[Wt] - Y[Wt] - Ae + $.altAxis, tn = Ie ? Tt + z[Wt] + Y[Wt] - Ae - $.altAxis : $e, Ln = g && Ie ? uf(me, Tt, tn) : bn(g ? me : fe, Tt, g ? tn : $e);
      P[v] = Ln, D[v] = Ln - Tt;
    }
    e.modifiersData[r] = D;
  }
...
function Xf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Gt(e), o = Gt(e) && Hf(e), a = we(e), s = qe(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wo(a)) && (l = Gf(e)), Gt(e) ? (c = qe(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Yo(a))), {
    ...
    var u = {
      ...
      setOptions: function(k) {
        ...
        f(), u.options = Object.assign({}, a, u.options, _), u.scrollParents = {
          reference: Re(l) ? vn(l) : l.contextElement ? vn(l.contextElement) : [],
          popper: vn(c)
        };
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (ni(_, C)) {
            u.rects = {
              reference: Xf(_, zn(C), u.options.strategy === "fixed"),
              popper: Go(C)
            ...
            for (var E = 0; E < u.orderedModifiers.length; E++) {
              ...
              var v = u.orderedModifiers[E], P = v.fn, z = v.options, Y = z === void 0 ? {} : z, O = v.name;
...
const am = () => Po({
  ...
  } = e, h = Ot(e, em), k = j.useRef(null), _ = Ce(k, n), C = j.useRef(null), E = Ce(C, w), v = j.useRef(E);
  Xe(() => {
    v.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const P = rm(u, s), [z, Y] = j.useState(P), [O, $] = j.useState(ir(o));
  j.useEffect(() => {
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, _ = Ot(e, nm), [C, E] = j.useState(!0), v = () => {
    E(!1);
  }, P = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const $ = ir(r);
    z = $ && Er($) ? er($).body : er(null).body;
  }
  const Y = !u && c && (!f || C) ? "none" : void 0, O = f ? {
    in: u,
    onEnter: v,
    onExited: P
  } : void 0;
...
var dm = function(e) {
  return e.scrollTop;
}, fn = "unmounted", be = "exited", ve = "entering", Le = "entered", so = "exiting", le = /* @__PURE__ */ function(t) {
  lm(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = be, a.appearStatus = ve) : c = Le : r.unmountOnExit || r.mountOnEnter ? c = fn : c = be, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ve && s !== Le && (a = ve) : (s === ve || s === Le) && (a = so);
    }
    ...
    if (o === void 0 && (o = !1), a !== null)
      ...
      this.props.unmountOnExit && this.state.status === be && this.setState({
        status: fn
      });
...
const fm = {
...
}, Gr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), qo = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = Ot(e, wm), _ = pn(), C = j.useRef(), E = Ds(), v = j.useRef(null), P = Ce(v, a.ref, n), z = (K) => (U) => {
    if (K) {
      const tt = v.current;
      U === void 0 ? K(tt) : K(tt, U);
    }
  }, Y = z(u), O = z((K, U) => {
    pm(K);
    const {
    ...
    let x;
    f === "auto" ? (x = E.transitions.getAutoHeightDuration(K.clientHeight), C.current = x) : x = tt, K.style.transition = [E.transitions.create("opacity", {
      duration: x,
      delay: ot
    ...
    let at;
    f === "auto" ? (at = E.transitions.getAutoHeightDuration(K.clientHeight), C.current = at) : at = U, K.style.transition = [E.transitions.create("opacity", {
      duration: at,
      delay: tt
    }), E.transitions.create("transform", {
      ...
      easing: ot
    })].join(","), K.style.opacity = 0, K.style.transform = lo(0.75), m && m(K);
  }), M = z(w);
  return /* @__PURE__ */ i(h, I({
    ...
    onExiting: T,
    addEndListener: (K) => {
      f === "auto" && _.start(C.current || 0, K), r && r(v.current, K);
    },
    timeout: f === "auto" ? null : f
  }, k, {
    children: (K, U) => /* @__PURE__ */ j.cloneElement(a, I({
      style: I({
        opacity: 0,
        transform: lo(0.75),
        visibility: K === "exited" && !l ? "hidden" : void 0
      }, fm[K], b, a.props.style),
      ref: P
    }, U))
  }));
});
...
const ai = qo, mm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], hm = jn(Ms, {
  ...
  const o = bs(), a = zo({
    ...
    slots: C,
    slotProps: E
  } = a, v = Ot(a, mm), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, z = I({
    anchorEl: s,
    container: u,
    disablePortal: m,
    keepMounted: w,
...
const bm = fs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), de = bm, vm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function ym(t) {
  return Math.round(t * 1e5) / 1e5;
}
const xm = (t) => {
  ...
  [`&[data-popper-placement*="bottom"] .${de.arrow}`]: {
    top: 0,
    marginTop: "-0.71em",
    "&::before": {
  ...
  [`&[data-popper-placement*="top"] .${de.arrow}`]: {
    bottom: 0,
    marginBottom: "-0.71em",
    "&::before": {
  ...
  [`&[data-popper-placement*="right"] .${de.arrow}`]: I({}, e.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${de.arrow}`]: I({}, e.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${de.popper}[data-popper-placement*="left"] &`]: I({
  ...
  [`.${de.popper}[data-popper-placement*="right"] &`]: I({
  ...
  [`.${de.popper}[data-popper-placement*="top"] &`]: I({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, e.touch && {
    marginBottom: "24px"
  }),
  [`.${de.popper}[data-popper-placement*="bottom"] &`]: I({
...
const zs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const P = zo({
    ...
    slots: H = {},
    title: lt,
    TransitionComponent: A = ai,
    TransitionProps: kt
  } = P, B = Ot(P, vm), xt = /* @__PURE__ */ j.isValidElement(Y) ? Y : /* @__PURE__ */ i("span", {
    children: Y
  }), Mt = Ds(), q = Mt.direction === "rtl", [et, Et] = j.useState(), [Tt, Wt] = j.useState(null), fe = j.useRef(!1), $e = Q || at, Ie = pn(), Ae = pn(), me = pn(), tn = pn(), [Ln, Ko] = cs({
    controlled: J,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    j.useEffect(() => {
      et && et.disabled && !nt && lt !== "" && et.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [lt, et, nt]);
  }
  const Tr = ls(x), en = j.useRef(), Fn = no(() => {
    en.current !== void 0 && (document.body.style.WebkitUserSelect = en.current, en.current = void 0), tn.clear();
  });
  j.useEffect(() => Fn, [Fn]);
  const Jo = (nt) => {
    ii.clear(), Wn = !0, Ko(!0), V && !ee && V(nt);
  }, Un = no(
    /**
    ...
    (nt) => {
      ii.start(800 + R, () => {
        Wn = !1;
      }), Ko(!1), F && ee && F(nt), Ie.start(Mt.transitions.duration.shortest, () => {
        fe.current = !1;
      });
    }
  ), Sr = (nt) => {
    fe.current && nt.type !== "touchstart" || (et && et.removeAttribute("title"), Ae.clear(), me.clear(), U || Wn && tt ? Ae.start(Wn ? tt : U, () => {
      Jo(nt);
    }) : Jo(nt));
  }, Zo = (nt) => {
    Ae.clear(), me.start(R, () => {
    ...
    onFocus: Js,
    ref: Zs
  } = ds(), [, ta] = j.useState(!1), ea = (nt) => {
    Ks(nt), Qo.current === !1 && (ta(!1), Zo(nt));
  }, na = (nt) => {
    et || Et(nt.currentTarget), Js(nt), Qo.current === !0 && (ta(!0), Sr(nt));
  }, ra = (nt) => {
    fe.current = !0;
    const Dt = xt.props;
    Dt.onTouchStart && Dt.onTouchStart(nt);
  }, oa = Sr, aa = Zo, Qs = (nt) => {
    ra(nt), me.clear(), Ie.clear(), Fn(), en.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", tn.start(ot, () => {
      document.body.style.WebkitUserSelect = en.current, Sr(nt);
    });
  }, tl = (nt) => {
    xt.props.onTouchEnd && xt.props.onTouchEnd(nt), Fn(), me.start(L, () => {
      Un(nt);
    });
  };
  j.useEffect(() => {
    if (!ee)
      return;
    function nt(Dt) {
      (Dt.key === "Escape" || Dt.key === "Esc") && Un(Dt);
    }
    return document.addEventListener("keydown", nt), () => {
      document.removeEventListener("keydown", nt);
    };
  }, [Un, ee]);
  const el = Ce(xt.ref, Zs, Et, n);
  !lt && lt !== 0 && (ee = !1);
  const Cr = j.useRef(), nl = (nt) => {
    const Dt = xt.props;
    Dt.onMouseMove && Dt.onMouseMove(nt), dn = {
      x: nt.clientX,
      y: nt.clientY
    }, Cr.current && Cr.current.update();
  }, nn = {}, Or = typeof lt == "string";
  T ? (nn.title = !ee && Or && !M ? lt : null, nn["aria-describedby"] = ee ? Tr : null) : (nn["aria-label"] = Or ? lt : null, nn["aria-labelledby"] = ee && !Or ? Tr : null);
  const Lt = I({}, nn, B, xt.props, {
    className: Ne(B.className, xt.props.className),
    onTouchStart: ra,
    ref: el
  }, at ? {
    onMouseMove: nl
  } : {});
  process.env.NODE_ENV !== "production" && (Lt["data-mui-internal-clone-element"] = !0, j.useEffect(() => {
...
`));
  ...
  const rn = {};
  K || (Lt.onTouchStart = Qs, Lt.onTouchEnd = tl), M || (Lt.onMouseOver = qn(oa, Lt.onMouseOver), Lt.onMouseLeave = qn(aa, Lt.onMouseLeave), $e || (rn.onMouseOver = oa, rn.onMouseLeave = aa)), D || (Lt.onFocus = qn(na, Lt.onFocus), Lt.onBlur = qn(ea, Lt.onBlur), $e || (rn.onFocus = na, rn.onBlur = ea)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const rl = j.useMemo(() => {
    var nt;
    let Dt = [{
    ...
    return (nt = G.popperOptions) != null && nt.modifiers && (Dt = Dt.concat(G.popperOptions.modifiers)), I({}, G.popperOptions, {
      modifiers: Dt
    });
  }, [Tt, G]), on = I({}, P, {
    isRtl: q,
    ...
    touch: fe.current
  }), Rr = xm(on), ia = (r = (o = H.popper) != null ? o : O.Popper) != null ? r : Nm, sa = (a = (s = (l = H.transition) != null ? l : O.Transition) != null ? s : A) != null ? a : ai, la = (c = (d = H.tooltip) != null ? d : O.Tooltip) != null ? c : km, ca = (u = (m = H.arrow) != null ? m : O.Arrow) != null ? u : Em, ol = wn(ia, I({}, G, (w = Z.popper) != null ? w : $.popper, {
    className: Ne(Rr.popper, G == null ? void 0 : G.className, (g = (b = Z.popper) != null ? b : $.popper) == null ? void 0 : g.className)
  }), on), al = wn(sa, I({}, kt, (f = Z.transition) != null ? f : $.transition), on), il = wn(la, I({}, (h = Z.tooltip) != null ? h : $.tooltip, {
    className: Ne(Rr.tooltip, (k = (_ = Z.tooltip) != null ? _ : $.tooltip) == null ? void 0 : k.className)
  }), on), sl = wn(ca, I({}, (C = Z.arrow) != null ? C : $.arrow, {
    className: Ne(Rr.arrow, (E = (v = Z.arrow) != null ? v : $.arrow) == null ? void 0 : E.className)
  }), on);
  return /* @__PURE__ */ y(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(xt, Lt), /* @__PURE__ */ i(ia, I({
      as: W ?? Vs,
      placement: X,
      anchorEl: at ? {
      ...
      children: ({
        ...
        timeout: Mt.transitions.duration.shorter
      }, nt, al, {
        children: /* @__PURE__ */ y(la, I({}, il, {
          children: [lt, z ? /* @__PURE__ */ i(ca, I({}, sl, {
            ref: Wt
          })) : null]
        }))
      }))
...
function Ls(t) {
  const {
    ...
    Jl,
    {
      ...
      onClick: e,
      id: f,
      children: n ? /* @__PURE__ */ y(se, { children: [
        si(a, n, !0),
        /* @__PURE__ */ i(Zl, { primary: n, inset: !a && o }),
        m ? /* @__PURE__ */ i(vi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(Ns, {}) }) : si(s, n, !1)
      ] }) : h
    }
  );
...
function Us(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: s } = St(() => {
...
function Im({
  ...
  const [c, d] = st(!1), [u, m] = st(!1), w = Rt(() => {
    c && d(!1), m(!1);
  }, [c]), g = Rt((E) => {
    E.stopPropagation(), d((v) => {
      const P = !v;
      return P && E.shiftKey ? m(!0) : P || m(!1), P;
    });
  }, []), b = Rt(
    (E) => (w(), r(E)),
    [r, w]
  ...
  oe(() => {
    if (c) {
      ...
      if (E) {
        const v = E.getBoundingClientRect(), P = window.scrollY, z = window.scrollX, Y = v.top + P + E.clientHeight, O = v.left + z;
        h({ top: Y, left: O });
      }
    }
  }, [c, o]);
  const [k] = co(
    Rt(async () => (t == null ? void 0 : t(!1)) ?? e, [t, e, c]),
    e
  ), [_] = co(
    Rt(async () => (t == null ? void 0 : t(!0)) ?? n ?? k, [t, n, k, c]),
    n ?? k
  ), C = u && _ ? _ : k;
  return /* @__PURE__ */ y(se, { children: [
    /* @__PURE__ */ i(
...
const jh = At.Root, Fm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  At.List,
  {
    ref: n,
    className: N(
...
Fm.displayName = At.List.displayName;
...
Um.displayName = At.Trigger.displayName;
...
Gm.displayName = At.Content.displayName;
function Vh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    mt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(Pe, { size: 15 }) : /* @__PURE__ */ y(se, { children: [
...
function zh({
  ...
  return /* @__PURE__ */ i(
    mt,
    {
      ...
      onClick: e,
      ...r,
      children: t ? /* @__PURE__ */ y(se, { children: [
...
function Gh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ y(cr, { children: [
    /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(Hm, {}) }),
    /* @__PURE__ */ i(Rn, { children: e.map((n) => /* @__PURE__ */ y("div", { children: [
      /* @__PURE__ */ i(_n, { children: n.label }),
      /* @__PURE__ */ i(xc, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(vo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(Oi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(Pn, {})
    ] }, n.label)) })
  ] }) });
}
...
}, ci = (t, e, n) => /* @__PURE__ */ i(mt, { variant: "outline", onClick: () => n(t.dblEntryUid, "install"), children: e }), qm = (t, e, n, r, o, a) => e.includes(t.dblEntryUid) ? /* @__PURE__ */ i(mt, { variant: "outline", children: /* @__PURE__ */ i(Pe, { className: "tw-h-5 tw-py-[1px]" }) }) : t.installed ? t.updateAvailable ? ci(t, r, a) : /* @__PURE__ */ i(Ct, { className: "tw-my-2 tw-flex tw-h-6 tw-items-center", children: o }) : ci(t, n, a);
function qh({
  localizedStrings: t,
  resources: e,
  ...
  const m = t["%resources_action%"], w = t["%resources_any%"], g = t["%resources_dialog_subtitle%"], b = t["%resources_dialog_title%"], f = t["%resources_filterInput%"], h = t["%resources_filterBy%"], k = t["%resources_fullName%"], _ = t["%resources_get%"], C = t["%resources_installed%"], E = t["%resources_language%"], v = t["%resources_languages%"], P = t["%resources_loadingResources%"], z = t["%resources_noResults%"], Y = t["%resources_open%"], O = t["%resources_remove%"], $ = t["%resources_results%"], T = t["%resources_showing%"], D = t["%resources_size%"], M = t["%resources_type%"], Q = t["%resources_types%"], K = t["%resources_type_DBL%"], U = t["%resources_type_ER%"], tt = t["%resources_type_SLR%"], ot = t["%resources_type_XR%"], at = t["%resources_type_unknown%"], x = t["%resources_update%"], [R, L] = st([]), F = (q, et) => {
    if (!c || !d)
      return;
    const Et = {
      dblEntryUid: q,
      action: et === "install" ? "installing" : "removing"
    };
    L((Wt) => [...Wt, Et]), (et === "install" ? c : d)(q).catch((Wt) => {
      console.debug(Ul(Wt));
    });
  };
  oe(() => {
    L(
      (q) => q.filter((et) => {
        const Et = e.find((Tt) => Tt.dblEntryUid === et.dblEntryUid);
        return Et ? !(et.action === "installing" && Et.installed || et.action === "removing" && !Et.installed) : !0;
      })
    );
  }, [e]);
  const [V, J] = st(""), X = St(() => e.filter((q) => {
    const et = V.toLowerCase();
    return q.displayName.toLowerCase().includes(et) || q.fullName.toLowerCase().includes(et) || q.bestLanguageName.toLowerCase().includes(et);
  }), [e, V]), W = St(() => [
    { value: "DBLResource", label: K },
    { value: "EnhancedResource", label: U },
    { value: "SourceLanguageResource", label: tt },
    { value: "XmlResource", label: ot }
  ], [K, U, tt, ot]), G = St(() => r.length === 0 ? X : X.filter((q) => r.includes(q.type)), [X, r]), Z = St(() => a.length === 0 ? G : G.filter((q) => a.includes(q.bestLanguageName)), [a, G]), [H, lt] = st({
    key: "bestLanguageName",
    direction: "ascending"
  }), A = St(() => [...Z].sort((q, et) => {
    let Et, Tt;
    return H.key === "action" ? (Et = (q.installed ? 10 : 0) + (q.updateAvailable ? 1 : 0), Tt = (et.installed ? 10 : 0) + (et.updateAvailable ? 1 : 0)) : (Et = q[H.key], Tt = et[H.key]), Et < Tt ? H.direction === "ascending" ? -1 : 1 : Et > Tt ? H.direction === "ascending" ? 1 : -1 : 0;
  }), [H.direction, H.key, Z]), kt = (q) => {
    const et = { key: q, direction: "ascending" };
    H.key === q && H.direction === "ascending" && (et.direction = "descending"), lt(et);
  }, B = (q, et) => /* @__PURE__ */ i(ue, { onClick: () => kt(q), children: /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
    et,
    H.key !== q && /* @__PURE__ */ i(wo, { className: "tw-pl-1", size: 16 }),
    H.key === q && (H.direction === "ascending" ? /* @__PURE__ */ i(pi, { className: "tw-pl-1", size: 16 }) : /* @__PURE__ */ i(Cn, { className: "tw-pl-1", size: 16 }))
  ] }) }), xt = (q) => e.filter((et) => et.type === q.value).length ?? 0, Mt = (q) => e.filter((et) => et.bestLanguageName === q.value).length ?? 0;
  return /* @__PURE__ */ i("div", { className: u, children: /* @__PURE__ */ y(Gs, { className: "tw-flex tw-h-screen tw-flex-col tw-rounded-none tw-border-0", children: [
    /* @__PURE__ */ i(Hs, { className: "tw-flex-shrink-0", children: /* @__PURE__ */ y("div", { className: "tw-flex", children: [
      /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-pr-4", children: [
        ...
        /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-gap-2", children: [
          ...
          /* @__PURE__ */ i("div", { className: "tw-mb-1 tw-flex tw-gap-1", children: /* @__PURE__ */ y("div", { className: "tw-relative", children: [
            /* @__PURE__ */ i(
              _e,
              {
                type: "text",
            ...
            /* @__PURE__ */ i(po, { className: "tw-absolute tw-right-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-text-muted-foreground" })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-gap-2", children: [
        /* @__PURE__ */ i(Ct, { className: "tw-mb-2", children: h }),
        /* @__PURE__ */ i(
          li,
          {
            entries: W,
    ...
    /* @__PURE__ */ i(Ws, { className: "tw-flex-grow tw-overflow-auto", children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      ...
      /* @__PURE__ */ i(Pe, {})
    ] }) : /* @__PURE__ */ i("div", { children: A.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-justify-center", children: /* @__PURE__ */ i(Ct, { children: z }) }) : /* @__PURE__ */ y($n, { stickyHeader: !0, children: [
      /* @__PURE__ */ i(In, { className: "tw-bg-none", stickyHeader: !0, children: /* @__PURE__ */ y(Kt, { children: [
        /* @__PURE__ */ i(ue, {}),
        /* @__PURE__ */ i(ue, {}),
        B("fullName", k),
        B("bestLanguageName", E),
        B("type", M),
        B("size", D),
        B("action", m)
      ] }) }),
      /* @__PURE__ */ i(An, { children: A.map((q) => {
        var et;
        return /* @__PURE__ */ y(Kt, { children: [
          /* @__PURE__ */ i(jt, { children: /* @__PURE__ */ i(ua, { className: "tw-pr-0", size: 18 }) }),
          /* @__PURE__ */ i(jt, { children: q.displayName }),
          /* @__PURE__ */ i(jt, { className: "tw-font-medium", children: q.fullName }),
          /* @__PURE__ */ i(jt, { children: q.bestLanguageName }),
          /* @__PURE__ */ i(jt, { children: ((et = W.find((Et) => Et.value === q.type)) == null ? void 0 : et.label) ?? at }),
          /* @__PURE__ */ i(jt, { children: q.size }),
          /* @__PURE__ */ i(jt, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-justify-between", children: [
            qm(
              q,
              R.map((Et) => Et.dblEntryUid),
              _,
              x,
              C,
              F
            ),
            q.installed && /* @__PURE__ */ y(cr, { children: [
              /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(mt, { variant: "ghost", children: /* @__PURE__ */ i(Ml, { className: "tw-w-4" }) }) }),
              /* @__PURE__ */ y(Rn, { align: "start", children: [
                /* @__PURE__ */ i(
                  tr,
                  {
                    onClick: () => l(q.projectId),
                    children: /* @__PURE__ */ i("span", { children: Y })
                  }
                ),
                /* @__PURE__ */ i(Pn, {}),
                /* @__PURE__ */ i(
                  tr,
                  {
                    onClick: () => F(q.dblEntryUid, "remove"),
        ...
        ] }, q.displayName + q.fullName);
      }) })
    ] }) }) }),
    /* @__PURE__ */ i(qs, { className: "tw-flex-shrink-0 tw-justify-center tw-border-t tw-p-4", children: A.length > 0 && /* @__PURE__ */ i(Ct, { children: `${T} ${A.length} ${$}` }) })
  ] }) });
}
const Km = (t, e) => t[e] ?? e;
function Kh({
  ...
  const d = Km(
    ...
    return h ? `${(v = t[b]) == null ? void 0 : v.autonym} (${h})` : (P = t[b]) == null ? void 0 : P.autonym;
  };
  return /* @__PURE__ */ y("div", { className: N("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ y(
      Ue,
      {
        ...
        dir: c,
        children: [
          /* @__PURE__ */ i(Te, { children: /* @__PURE__ */ i(Ge, {}) }),
          /* @__PURE__ */ i(
            Se,
            {
              className: "tw-z-[250]",
              dir: c,
              children: Object.keys(t).map((b) => /* @__PURE__ */ i(Ft, { value: b, children: g(b, e) }, b))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ y(se, { children: [
      /* @__PURE__ */ i(Ct, { className: "tw-ms-3", children: d }),
