...
import c, { forwardRef as qt, createContext as qn, useContext as Jn, useCallback as et, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Kn } from "react";
...
import { formatScrRef as Ot, getChaptersForBook as Cr, NumberFormat as Sr, formatBytes as Rr, deepEqual as ye, substring as Tr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as M } from "platform-bible-utils";
...
const Ee = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), ea = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function aa() {
  return Ee.map((e) => O.bookIdToEnglishName(e));
}
function oa(t) {
...
function sa(t) {
  ...
  if (oa(e))
    return Ee.find((a) => O.bookIdToEnglishName(a) === e);
}
function as({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = $(), [i, w] = B(""), [s, p] = B(t.book), [m, u] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, b] = B(!1), [k, v] = B(h), N = Z(void 0), x = Z(void 0), _ = Z(void 0), j = et(
    (C) => {
      const z = a ? a() : Ee;
      return {
        OT: z.filter((A) => O.isBookOT(A)),
        NT: z.filter((A) => O.isBookNT(A)),
        DC: z.filter((A) => O.isBookDC(A))
      }[C].filter((A) => {
    ...
    ra.forEach((C) => {
      const z = C.exec(i);
      if (z) {
        const [A, G = void 0, F = void 0] = z.slice(1), It = sa(A);
        (O.isBookIdValid(A) || It) && y(
          It ?? A,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (C) => {
      h ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (_ != null && _.current ? _.current.focus() : x.current && x.current.focus(), C.preventDefault()) : b(!0);
    },
    [h]
  ), Mt = (C) => {
    const { key: z } = C;
  ...
  return ct(() => {
    ...
    const C = setTimeout(() => {
      if (k && x.current && _.current && !i) {
        const A = _.current.offsetTop - na;
  ...
  }, [k, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Wt, { modal: !1, open: h, onOpenChange: zt, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: P,
        handleOnClick: () => {
          p(t.book), g(t.book), u(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), w(Ot(t, "English")), N.current.focus();
        },
        onFocus: () => {
          ot.current = !0;
        },
...
function me({
  ...
  const [v, N] = B(!1);
  return /* @__PURE__ */ d(hn, { open: v, onOpenChange: N, ...k, children: [
...
function ss({
  ...
  const u = se(m, "%webView_bookSelector_currentBook%"), f = se(m, "%webView_bookSelector_choose%"), g = se(m, "%webView_bookSelector_chooseBooks%"), [h, b] = B(
    "current book"
    /* CURRENT_BOOK */
  ), k = (v) => {
    b(v), t(v);
    ...
    mn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((v) => O.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
const Qt = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full"), children: /* @__PURE__ */ r(
  "table",
  {
    ref: n,
  ...
  ({ className: t, onKeyDown: e, onSelect: n, ...a }, o) => {
    ...
    const w = (u, f) => {
      ...
      for (let v = h + 1; v < f.length; v++) {
        const N = f[v];
        if (!(g != null && g.contains(N))) {
          N.focus(), b = !0;
          break;
        }
      }
      b || (k = f[0]) == null || k.focus();
    }, s = (u, f, g) => {
      let h;
      ...
      if (Ca(f) === "tbody") {
        if (u.preventDefault(), h === g.length - 1 || g.length === 0) {
          const _ = (N = (v = f.parentElement) == null ? void 0 : v.parentElement) == null ? void 0 : N.querySelector('tfoot tr[tabindex="0"]');
          _ ? _.focus() : w(f, b);
        }
        (x = g[h + 1]) == null || x.focus();
      }
    };
    return /* @__PURE__ */ r(
      "tr",
      {
        ...
        onKeyDown: (u) => {
          ...
          ), h = g.indexOf(f), b = Ye(document.body), k = Ye(f), v = k.indexOf(
...
function Ta({
  ...
  var v;
  const [s, p] = B([]), [m, u] = B([]), [f, g] = B({}), [h, b] = B({}), k = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(te, { stickyHeader: i, children: k.getHeaderGroups().map((N) => /* @__PURE__ */ r(dt, { children: N.headers.map((x) => /* @__PURE__ */ r(Ft, { children: x.isPlaceholder ? void 0 : Pt(x.column.columnDef.header, x.getContext()) }, x.id)) }, N.id)) }),
      /* @__PURE__ */ r(ee, { children: (v = k.getRowModel().rows) != null && v.length ? k.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => w(N, k),
          "data-state": N.getIsSelected() && "selected",
          children: N.getVisibleCells().map((x) => /* @__PURE__ */ r(kt, { children: Pt(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        N.id
...
function Ia({
  ...
  const [f, g] = B(!1), h = et(
    (v) => {
      var x;
      const N = (x = t.find((_) => _.label === v)) == null ? void 0 : x.value;
      N && a(
        n.includes(N) ? n.filter((_) => _ !== N) : [...n, N]
      );
    },
    [t, n, a]
  ), b = () => w || o, k = Q(() => {
    if (!p) return t;
    const v = t.filter((x) => x.starred).sort((x, _) => x.label.localeCompare(_.label)), N = t.filter((x) => !x.starred).sort((x, _) => {
      const j = n.includes(x.value), tt = n.includes(_.value);
      return j && !tt ? -1 : !j && tt ? 1 : x.label.localeCompare(_.label);
    });
    return [...v, ...N];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(hn, { open: f, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ r(ze, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Me, { children: [
      ...
      /* @__PURE__ */ d(De, { children: [
        ...
        /* @__PURE__ */ r(bn, { children: k.map((v) => {
          const N = e ? e(v) : void 0;
          return /* @__PURE__ */ d(
            Be,
            {
              value: v.label,
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: v.starred && /* @__PURE__ */ r(pr, { className: "tw-h-4 tw-w-4" }) }),
                /* @__PURE__ */ r("div", { className: "tw-flex-grow", children: v.label }),
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), fs = (t) => ({
  ...
  return Aa(t).forEach((u) => {
    ...
    for (; f; ) {
      const g = [];
      f.forEach((v) => g.push(v));
      const h = f.index, b = i.find((v) => ye(v.items, g)), k = {
        reference: {
          book: w !== void 0 ? w : "",
      ...
      if (b)
        b.count += 1, b.occurrences.push(k);
      else {
        const v = {
          items: g,
          count: 1,
...
function ys({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), k = st(n, "%webView_inventory_scope_currentBook%"), v = st(n, "%webView_inventory_scope_chapter%"), N = st(n, "%webView_inventory_scope_verse%"), x = st(n, "%webView_inventory_filter_text%"), _ = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, zt] = B("all"), [y, E] = B(""), [K, P] = B([]), Mt = Q(() => s ? a instanceof RegExp ? ja(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((Y) => {
  ...
  }, [j, Mt]), C = Q(() => Xa(pt, ot, y), [pt, ot, y]), z = Q(() => {
    var wt, ut;
    if (!j) return u;
  ...
  ct(() => {
    C.length === 0 ? P([]) : C.length === 1 && P(C[0].items);
  }, [C]);
  const A = (R, Y) => {
    Y.setRowSelection(() => {
      const wt = {};
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(yt, { onValueChange: (R) => G(R), defaultValue: p, children: [
        ...
        /* @__PURE__ */ d(bt, { children: [
          /* @__PURE__ */ r(W, { value: "book", children: k }),
          /* @__PURE__ */ r(W, { value: "chapter", children: v }),
...
const Rn = c.forwardRef(
  ({
    ...
    const [m, u] = c.useState(t), f = e ?? m, g = c.useCallback(
      ...
      [n, f]
    ), h = c.useCallback(() => g((_) => !_), [g]), b = f ? "expanded" : "collapsed", N = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", x = c.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: g,
...
function ks({
  ...
  const [p, m] = B([]), [u, f] = B([{ id: lt, desc: !1 }]), [g, h] = B({}), b = Q(
  ...
  ct(() => {
    if (s) {
      const y = v.getSelectedRowModel().rowsById, E = Object.keys(y);
      if (E.length === 1) {
        const K = b.find((P) => qe(P) === E[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, b, s, v]);
  const N = o ?? io, x = i ?? Vn, _ = [
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(Qt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(te, { children: v.getHeaderGroups().map((y) => /* @__PURE__ */ r(dt, { children: y.headers.filter((E) => E.column.columnDef.header).map((E) => (
      ...
      /* @__PURE__ */ r(ee, { children: v.getRowModel().rows.map((y, E) => {
        const K = $();
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            className: l(ot(y, E)),
            onClick: (P) => tt(y, P),
            children: y.getVisibleCells().map((P) => {
    ...
    const s = e.filter((m) => m.group === i).sort((m, u) => m.order - u.order).map((m) => /* @__PURE__ */ d(Xe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in m ? /* @__PURE__ */ d(
        Yn,
        {
          ...
          children: [
            m.iconPathBefore && /* @__PURE__ */ r(Ut, { icon: m.iconPathBefore, menuLabel: m.label, leading: !0 }),
            m.label,
            m.iconPathAfter && /* @__PURE__ */ r(Ut, { icon: m.iconPathAfter, menuLabel: m.label })
          ]
        },
...
function bo({
  ...
  if (Dr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, f) => {
    var b, k, v, N;
    u.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (k = w.current) == null || k.focus(), Bt(w, [g, h]);
        break;
      case "alt+n":
        (v = s.current) == null || v.focus(), Bt(s, [g, h]);
        break;
      case "alt+h":
    ...
    const u = new MutationObserver((h) => {
      h.forEach((b) => {
        if (b.attributeName === "data-state" && b.target instanceof HTMLElement) {
          const k = b.target.getAttribute("data-state");
          n(k === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, f]) => typeof u == "boolean" || typeof f == "boolean" ? 0 : u.order - f.order).map(([u, f]) => /* @__PURE__ */ d(uo, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Pe, { children: Un(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Is({
  ...
  const p = vo(
    ...
    o && o(h), a && a([h, ...n.filter((b) => b !== h)]), i && n.find((b) => b === h) && i([...n.filter((b) => b !== h)]), u(!1);
  }, g = (h, b) => {
    var v, N, x, _, j, tt;
    const k = b !== h ? ((N = (v = t[h]) == null ? void 0 : v.uiNames) == null ? void 0 : N[b]) ?? ((_ = (x = t[h]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return k ? `${(j = t[h]) == null ? void 0 : j.autonym} (${k})` : (tt = t[h]) == null ? void 0 : tt.autonym;
  };
