import { jsx as r, jsxs as c, Fragment as nt } from "react/jsx-runtime";
import * as Qe from "react";
import b, { forwardRef as Me, useRef as W, useMemo as z, useState as V, useCallback as j, useLayoutEffect as It, createContext as On, useContext as Vn, useEffect as q, Suspense as sa, createRef as ia, Fragment as Nr } from "react";
import { Command as pt } from "cmdk";
import { X as Ae, Search as kr, Check as Ct, Clock as nr, ChevronsLeft as rr, ChevronsRight as or, ChevronLeft as dn, ChevronRight as ae, ArrowLeft as la, ArrowRight as wa, Circle as Xe, ChevronDown as Yt, BoldIcon as ca, ItalicIcon as da, UnderlineIcon as pa, StrikethroughIcon as ua, Pencil as ma, Trash2 as ha, ArrowUp as _r, MoreHorizontal as Cr, ChevronUp as pn, AtSign as fa, FilterIcon as ga, ArrowLeftIcon as ba, ChevronLeftIcon as va, ChevronRightIcon as xa, ArrowRightIcon as ya, Copy as Er, Filter as Na, User as ka, Link as _a, CircleHelp as Ca, ChevronsUpDown as Tr, Star as Ea, FunctionSquare as Rr, SquareSigma as Sr, SquareX as Ta, AlertCircle as un, CircleCheckIcon as Ra, CircleXIcon as Sa, CircleHelpIcon as Da, ArrowUpIcon as Ia, ArrowDownIcon as Oa, ArrowUpDownIcon as Va, PanelLeft as Ma, PanelRight as Aa, ScrollText as Pa, MenuIcon as $a, Menu as La, EllipsisVertical as za, LoaderCircle as Ba, GripVertical as ja } from "lucide-react";
import { clsx as Fa } from "clsx";
import { extendTailwindMerge as Ga } from "tailwind-merge";
import * as bt from "@radix-ui/react-dialog";
import { includes as ze, Section as G, getChaptersForBook as Ha, formatScrRef as ne, getSectionForBook as Ce, formatRelativeDate as Xa, formatReplacementString as re, sanitizeHtml as Ka, parseParatextHtml as ar, hasCustomParatextTags as Ua, NumberFormat as Ya, formatBytes as qa, getCurrentLocale as Ja, getFormatCallerFunction as Wa, deepEqual as Dr, isString as tn, compareScrRefs as mn, scrRefToBBBCCCVVV as en, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import { createEditor as Za, $getRoot as qt, $createParagraphNode as Mn, $getSelection as De, HISTORY_MERGE_TAG as Or, ParagraphNode as Qa, TextNode as ts, $isDecoratorNode as es, $isElementNode as Ee, $isParagraphNode as ns, $isTextNode as je, $isTokenOrSegmented as rs, $getCharacterOffsets as os, $isRangeSelection as An, CLEAR_EDITOR_COMMAND as Vr, COMMAND_PRIORITY_EDITOR as as, SELECTION_CHANGE_COMMAND as Mr, COMMAND_PRIORITY_CRITICAL as Ar, FORMAT_TEXT_COMMAND as ss, $cloneWithProperties as is, getRegisteredNode as ls, isHTMLElement as ws, isDocumentFragment as sr, ArtificialNode__DO_NOT_USE as Pr, $createLineBreakNode as $r, $isRootOrShadowRoot as cs, $isBlockElementNode as hn, isBlockDomNode as ir, isInlineDomNode as lr, $insertNodes as ds } from "lexical";
...
import { useReactTable as jr, getFilteredRowModel as xs, getSortedRowModel as Fr, getPaginationRowModel as ys, getCoreRowModel as Gr, flexRender as Te, getGroupedRowModel as Ns, getExpandedRowModel as ks } from "@tanstack/react-table";
...
import { toast as Cd } from "sonner";
...
const Is = bt.Root, Os = bt.Portal, Hr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  bt.Overlay,
  {
    ref: n,
    className: m(
...
Hr.displayName = bt.Overlay.displayName;
...
Xr.displayName = bt.Content.displayName;
...
Ur.displayName = bt.Title.displayName;
...
const Ue = b.forwardRef((t, e) => /* @__PURE__ */ r(pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ue.displayName = pt.Empty.displayName;
const Lt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Group,
  {
    ref: n,
    className: m(
...
Yr.displayName = pt.Separator.displayName;
...
const dt = class X {
  ...
  static fromJSON(e) {
    ...
    let d;
    return i && (d = new Gt(i)), n ? new X(n, o.toString(), l, d) : new X();
  }
  /**
  ...
  allVerses(e = !1, n = X.verseRangeSeparators, o = X.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = cr(this._verse, o);
    for (const i of s.map((l) => cr(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const d = l.verseNum;
...
F(dt, "defaultVersification", Gt.English), F(dt, "verseRangeSeparator", "-"), F(dt, "verseSequenceIndicator", ","), F(dt, "verseRangeSeparators", [dt.verseRangeSeparator]), F(dt, "verseSequenceIndicators", [dt.verseSequenceIndicator]), F(dt, "chapterDigitShifter", 1e3), F(dt, "bookDigitShifter", dt.chapterDigitShifter * dt.chapterDigitShifter), F(dt, "bcvMaxValue", dt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
F(dt, "ValidStatusType", to);
...
const no = Y.allBookIds.filter(
  (t) => !Y.isObsolete(Y.bookIdToNumber(t))
), Xt = Object.fromEntries(
  no.map((t) => [t, Y.bookIdToEnglishName(t)])
);
function jn(t, e, n) {
...
const ro = Me(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ c(
          ...
          {
            ref: w,
            value: d || `${t} ${Y.bookIdToEnglishName(t)}`,
            onSelect: f,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? ce : "button", { className: m(Us({ variant: e, size: n, className: t })), ref: s, ...a })
);
L.displayName = "Button";
const he = se.Root, fe = se.Trigger, bc = se.Anchor, te = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = it();
...
function Ys({
  ...
  return /* @__PURE__ */ c(he, { open: l, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ r(te, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: /* @__PURE__ */ r(Lt, { heading: s, children: t.map((p) => /* @__PURE__ */ c(
      Qt,
      {
        onSelect: () => w(p),
...
function vc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Ws(t, e, n, o) {
  const a = j(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const w = e[d - 1], p = Math.max(_t(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function pr({
  ...
  if (t)
    return /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: _t(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Qt,
      {
        value: `${t} ${Xt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function xc({
  ...
  const w = it(), [p, f] = V(!1), [h, u] = V(""), [g, v] = V(""), [x, O] = V("books"), [N, y] = V(void 0), [k, A] = V(!1), _ = W(void 0), C = W(void 0), R = W(void 0), E = W(void 0), T = W({}), P = j(
    (S) => {
      e(S), l && l(S);
    },
    [e, l]
    ...
    (S) => {
      const K = x === "chapters" ? N : M == null ? void 0 : M.book;
      K && (P({
        book: K,
        chapterNum: S,
        verseNum: 1
      }), f(!1), O("books"), y(void 0), v(""));
    },
    [P, x, N, M]
  ), yt = j(
    (S) => {
    ...
    (S) => M ? !!M.chapterNum && !S.toString().includes(M.chapterNum.toString()) : !1,
    [M]
  ), na = z(
    () => ne(
      t,
    ...
    (S) => {
      if (S.ctrlKey) return;
      const { isLetter: K, isDigit: at } = dr(S.key);
      if (x === "chapters") {
        if (S.key === "Backspace") {
        ...
        if (K || at) {
          if (S.preventDefault(), S.stopPropagation(), O("books"), y(void 0), at && N) {
            const wt = Xt[N];
            v(`${wt} ${S.key}`);
          } else
            v(S.key);
      ...
      if ((x === "chapters" || x === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(S.key)) {
        const wt = x === "chapters" ? N : M == null ? void 0 : M.book;
        if (!wt) return;
        const ct = (() => {
          if (!h) return 1;
          const ye = h.match(/(\d+)$/);
        ...
        switch (S.key) {
          case "ArrowLeft":
            ct !== 0 && (Tt = ct > 1 ? ct - 1 : jt);
            break;
          case "ArrowRight":
            ct !== 0 && (Tt = ct < jt ? ct + 1 : 1);
            break;
          case "ArrowUp":
            Tt = ct === 0 ? jt : Math.max(1, ct - er);
            break;
          case "ArrowDown":
            Tt = ct === 0 ? 1 : Math.min(jt, ct + er);
            break;
          default:
            return;
        }
        Tt !== ct && (S.preventDefault(), S.stopPropagation(), u(yn(wt, a, Tt)), setTimeout(() => {
  ...
  return It(() => {
    const S = setTimeout(() => {
      if (p && x === "books" && R.current && E.current) {
        const K = R.current, at = E.current, wt = at.offsetTop, ct = K.clientHeight, jt = at.clientHeight, Tt = wt - ct / 2 + jt / 2;
        K.scrollTo({
          top: Math.max(0, Tt),
          behavior: "smooth"
        }), u(yn(t.book));
  ...
  }, [x, N, M, t.book, t.chapterNum]), /* @__PURE__ */ c(he, { open: p, onOpenChange: ot, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      L,
      {
    ...
    /* @__PURE__ */ r(te, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      pe,
      {
        ref: _,
        onKeyDown: oa,
        ...
        children: [
          ...
          !k && /* @__PURE__ */ c(ue, { ref: R, children: [
            x === "books" && /* @__PURE__ */ c(nt, { children: [
              !M && Object.entries(J).map(([S, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Lt, { heading: ta(S), children: K.map((at) => /* @__PURE__ */ r(
                      ro,
                      {
                        bookId: at,
                        onSelect: (wt) => gt(wt),
              ...
              M && /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r(
                Qt,
                {
                  value: `${M.book} ${Xt[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                  onSelect: Z,
                  ...
                  children: ne(
                    ...
                    a ? Bn(M.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              M && _t(M.book) > 1 && /* @__PURE__ */ c(nt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: oe(M.book, a) }),
                /* @__PURE__ */ r(
                  pr,
                  {
                    bookId: M.book,
...
), st = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ir.Root, { ref: n, className: m("pr-twp", Zs(), t), ...e }));
st.displayName = Ir.Root.displayName;
const Fn = b.forwardRef(({ className: t, ...e }, n) => {
  const o = it();
  return /* @__PURE__ */ r(
    Se.Root,
    {
...
function Nn({
  ...
  const [N, y] = V(!1), k = d ?? l, A = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], _ = (C, R) => {
  ...
  return /* @__PURE__ */ c(he, { open: N, onOpenChange: y, ...O, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      te,
      {
        ...
        children: /* @__PURE__ */ c(pe, { children: [
...
function kc({
  ...
  const p = on(w, "%webView_bookSelector_currentBook%"), f = on(w, "%webView_bookSelector_choose%"), h = on(w, "%webView_bookSelector_chooseBooks%"), [u, g] = V(
    "current book"
    /* CURRENT_BOOK */
  ), v = (x) => {
    g(x), t(x);
    ...
    Fn,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(st, { className: "tw-flex tw-items-center", children: o.map((x) => Y.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            L,
            {
...
const _c = [
  ...
  const a = W(null), [s, i] = V(void 0), [l, d] = V(void 0), w = j(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      g && (d((v) => v === u ? void 0 : u), n == null || n(g));
    },
    [n, t]
  ), f = (u) => {
    if (!u) return !1;
    const g = u.tagName.toLowerCase();
    if (u.isContentEditable || ni.includes(g)) return !0;
    ...
    (u) => {
      var C;
      const g = u.target, v = (R) => R ? document.getElementById(R) : void 0, x = v(l), O = v(s);
      if (!!(x && g && x.contains(g) && g !== x) && f(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(E + 1, R.length - 1) : T = Math.max(E - 1, 0), T !== E && (u.preventDefault(), u.stopPropagation(), (C = R[T]) == null || C.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          A = Math.min(k + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(k - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const ao = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, si = ao ? It : q, Be = { tag: Or };
function ii({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = ai(null, o), p = Za({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: o });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (De() !== null || v !== null && v === f.getRootElement()) && g.select();
          }
        }, Be);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const u = f.parseEditorState(h);
            f.setEditorState(u, Be);
            break;
          }
          case "object":
...
function wi({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return li(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(Or) || l.isEmpty() || n(a, o, d);
    });
  }, [o, t, e, n]), null;
}
const Gn = {
  ...
  mark: "",
  markOverlap: ""
}, St = Pe.Provider, Pt = Pe.Root, Kt = Pe.Trigger, Dt = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Pe.Content,
  {
    ref: o,
    sideOffset: e,
...
var ur = { error: null }, ci = function(t) {
  var e, n;
  function o() {
  ...
  return a.reset = function() {
    ...
    f !== null && i.error !== null && ((w = s.resetKeys) === void 0 && (w = []), (p = h) === void 0 && (p = []), w.length !== p.length || w.some(function(u, g) {
      return !Object.is(u, p[g]);
    ...
    if (s !== null) {
      ...
      if (d) return Qe.createElement(d, p);
      throw new Error("react-error-boundary requires either a fallback, fallbackRender, or FallbackComponent prop");
    }
    return this.props.children;
  }, o;
}(Qe.Component);
function di({ children: t, onError: e }) {
...
function mi() {
  return function(t) {
    const [e] = Et(), n = z(() => t(e), [e, t]), [o, a] = V(() => n.initialValueFn()), s = W(o);
    return pi(() => {
...
function bi(t, e) {
  ...
  if (e.isSelected(t) && !rs(e) && n !== null) {
    ...
    if (d || w) {
      const [p, f] = os(t), h = i.is(l), u = e.is(s ? l : i), g = e.is(s ? i : l);
      let v, x = 0;
      h ? (x = p > f ? f : p, v = p > f ? p : f) : u ? (x = s ? f : p, v = void 0) : g && (x = 0, v = s ? p : f), e.__text = e.__text.slice(x, v);
    }
  }
  return e;
}
const io = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vi = io && "documentMode" in document ? document.documentMode : null;
!(!io || !("InputEvent" in window) || vi) && "getTargetRanges" in new window.InputEvent("input");
function Xn(...t) {
  return () => {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (An(v)) {
                const x = v.anchor;
                let O = x.getNode(), N = 0, y = 0;
                if (je(O) && w >= 0 && p >= 0 && (N = w, y = w + p, v.setTextNodeRange(O, N, O, y)), N === y && f === "" || (v.insertRawText(f), O = x.getNode()), je(O)) {
                  N = h, y = h + u;
                  const k = O.getTextContentSize();
                  N = N > k ? k : N, y = y > k ? k : y, v.setTextNodeRange(O, N, O, y);
                }
...
function yi({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Et(), a = function(s, i) {
    ...
    return _n(() => s.registerDecoratorListener((w) => {
      ...
      for (let f = 0; f < p.length; f++) {
        const h = p[f], u = r(i, { onError: (v) => s._onError(v), children: r(sa, { fallback: null, children: l[h] }) }), g = s.getElementByKey(h);
        g !== null && w.push(gs(u, g, h));
      }
      return w;
    }, [i, l, s]);
  }(o, n);
  return function(s) {
    _n(() => Xn(hs(s), xi(s)), [s]);
  }(o), c(nt, { children: [t, r(Ni, { content: e }), a] });
}
...
function Ci({ onClear: t }) {
  const [e] = Et();
  return _i(() => e.registerCommand(Vr, (n) => (e.update(() => {
    if (t == null) {
...
function Ei({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: v, role: x = "textbox", spellCheck: O = !0, style: N, tabIndex: y, "data-testid": k, ...A }, _) {
  const [C, R] = V(t.isEditable()), E = j((P) => {
  ...
  return lo(() => (R(t.isEditable()), t.registerEditableListener((P) => {
    R(P);
  })), [t]), r("div", { "aria-activedescendant": C ? e : void 0, "aria-autocomplete": C ? n : "none", "aria-controls": C ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": C && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": C ? f : void 0, "aria-readonly": !C || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: C, "data-testid": k, id: v, ref: T, role: x, spellCheck: O, style: N, tabIndex: y, ...A });
}
const Ti = Me(Ei);
function hr(t) {
  return t.getEditorState().read(so(t.isComposing()));
...
function Si(t, e) {
  ...
  return c(nt, { children: [r(Ti, { editor: a, ...o, ref: e }), n != null && r(Di, { editor: a, content: n })] });
}
...
function Vi() {
  const [t, e] = V(void 0), n = j(() => {
    e(void 0);
  }, []), o = z(() => {
    if (t === void 0)
      return;
    const { title: s, content: i } = t;
    return /* @__PURE__ */ r(Is, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Xr, { children: [
      /* @__PURE__ */ r(Kr, { children: /* @__PURE__ */ r(Ur, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = j(
    (s, i, l = !1) => {
...
function Mi({
  ...
  const [e] = Et(), [n, o] = V(e), [a, s] = V("paragraph"), [i, l] = Vi(), d = () => {
  };
...
), Pi = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Lr.Root,
  {
    ref: a,
    className: m(po({ variant: e, size: n, className: t })),
    ...o
  }
));
Pi.displayName = Lr.Root.displayName;
const uo = b.createContext({
  size: "default",
  variant: "default"
}), Kn = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = it();
  return /* @__PURE__ */ r(
    Ke.Root,
    {
...
const Re = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
...
function Cn({
  ...
  return /* @__PURE__ */ r("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ r(
    ii,
    {
      ...
      children: /* @__PURE__ */ c(St, { children: [
...
function mo(t, e, n, o = null) {
  ...
  if (o !== null) {
    let u = is(e);
    u = je(u) && o !== null ? bi(o, u) : u, i = u;
  }
  const l = Ee(i) ? i.getChildren() : [], d = ls(t, i.getType());
  let w;
...
function fo(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !cs(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < f.length; g++) h.push(...fo(f[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), ir(t) && (h = Gi(t, h, u ? () => {
    const g = new Pr();
    return n.push(g), g;
  } : Mn)), l == null ? h.length > 0 ? i = i.concat(h) : ir(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : lr(g.nextSibling) && lr(g.previousSibling);
  }(t) && (i = i.concat($r())) : Ee(l) && l.append(...h), i;
}
function Gi(t, e, n) {
...
const Ki = zt(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: m("pr-twp", Ki({ variant: e }), t), ...n })
);
...
const qi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
vo.displayName = de.Root.displayName;
const Wi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  de.Image,
  {
    ref: n,
...
Wi.displayName = de.Image.displayName;
...
xo.displayName = de.Fallback.displayName;
const Yn = On(void 0);
function xt() {
  const t = Vn(Yn);
  if (!t)
...
}), ge = Q.Trigger, yo = Q.Group, Zi = Q.Portal, Qi = Q.Sub, tl = Q.RadioGroup;
function ee({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Yn.Provider, { value: n, children: /* @__PURE__ */ r(Q.Root, { ...e }) });
}
const No = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = xt();
  return /* @__PURE__ */ c(
    Q.SubTrigger,
    {
...
No.displayName = Q.SubTrigger.displayName;
const ko = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Q.SubContent,
  {
    ref: n,
    className: m(
...
ko.displayName = Q.SubContent.displayName;
const Bt = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = it();
...
Ge.displayName = Q.Item.displayName;
const $t = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = xt();
  return /* @__PURE__ */ c(
    Q.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
$t.displayName = Q.CheckboxItem.displayName;
const _o = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = xt();
  return /* @__PURE__ */ c(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(Xe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
_o.displayName = Q.RadioItem.displayName;
const Le = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Q.Label,
  {
    ref: o,
...
Le.displayName = Q.Label.displayName;
...
be.displayName = Q.Separator.displayName;
...
function gr({
  ...
  const v = j(() => {
  ...
  }, [t.date, o]), N = z(() => t.user, [t.user]), y = z(
    ...
    if (a && n)
      return /* @__PURE__ */ c(nt, { children: [
        !Ua(t.contents) && /* @__PURE__ */ c(
          Ge,
          {
            onClick: () => {
              f(!0), u(Xi(ar(t.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(vo, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(xo, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          p && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), v()) : _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), Mt(h) && x());
              },
              onKeyDown: (_) => {
                go(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  Cn,
        ...
        A && /* @__PURE__ */ c(ee, { children: [
          /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
...
function nl({
  ...
  const [u, g] = V(an), [v, x] = V(!1), [O, N] = V(!1), [y, k] = V(!1), [A, _] = V(!1), C = z(() => t.filter((I) => !I.deleted), [t]), R = z(() => C[0], [C]), E = W(null), T = W(void 0);
  q(() => {
    const I = E.current;
    if (!I) return;
    const ot = () => {
  ...
  const P = z(
    ...
    [a, e]
  ), H = z(() => C.slice(1), [C]), D = z(() => H.length ?? 0, [H.length]), J = z(() => D > 0, [D]), M = z(() => y || D <= 2 ? H : H.slice(-2), [H, D, y]), Z = z(() => y || D <= 2 ? 0 : D - 2, [D, y]), gt = z(
    () => D === 1 ? P.singleReply : re(P.multipleReplies, { count: D }),
    [D, P]
  ), Vt = z(
    () => Z === 1 ? P.singleReply : re(P.multipleReplies, { count: Z }),
    [Z, P]
  ), yt = j(async () => {
    var ot;
    await p(l, En(u)) && ((ot = T.current) == null || ot.call(T), g(an));
  }, [u, p, l]), $ = j(
    async (I, ot) => {
      var xe;
      if (!w) return !1;
      const lt = Mt(u) ? En(u) : void 0, ht = await w(I, ot, lt);
      return ht && lt && ((xe = T.current) == null || xe.call(T), g(an)), ht;
    },
    [u, w]
  );
  return /* @__PURE__ */ r(
    Un,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(bo, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        ...
        /* @__PURE__ */ c(nt, { children: [
          J && !n && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          n && /* @__PURE__ */ c(nt, { children: [
            ...
            (!A || Mt(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (I) => {
                  I.key === "Enter" && I.shiftKey && (I.preventDefault(), I.stopPropagation(), Mt(u) && yt());
                },
                onKeyDown: (I) => {
                  go(I), (I.key === "Enter" || I.key === " ") && I.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    Cn,
...
function Cc({
  ...
  const [d, w] = V(), p = e.filter(
    (N) => N.comments.some((y) => !y.deleted)
  ), f = p.map((N) => ({
    id: N.id
  })), h = j((N) => {
    w(N.id);
    ...
    w(N);
  }, []), { listboxRef: g, activeId: v, handleKeyDown: x } = oi({
    options: f,
    onOptionSelect: h
  }), O = j(
    (N) => {
      N.key === "Escape" ? (w(void 0), N.preventDefault(), N.stopPropagation()) : x(N);
    },
    [x]
  );
  return /* @__PURE__ */ r(
...
function rl({ table: t }) {
  return /* @__PURE__ */ c(ee, { children: [
    /* @__PURE__ */ r(vs, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ga, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(Bt, { align: "end", className: "tw-w-[150px]", children: [
...
const le = rt.Root, ol = rt.Group, we = rt.Value, al = zt(
  ...
  return /* @__PURE__ */ c(
    rt.Trigger,
    {
      className: m(al({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const Co = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.ScrollUpButton,
  {
    ref: n,
...
Co.displayName = rt.ScrollUpButton.displayName;
...
Eo.displayName = rt.ScrollDownButton.displayName;
...
const ft = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  rt.Item,
  {
    ref: o,
    className: m(
...
const Je = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: m("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const ml = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function hl({
  ...
  var _;
  const [p, f] = V([]), [h, u] = V([]), [g, v] = V({}), [x, O] = V({}), N = z(() => e ?? [], [e]), y = jr({
    data: N,
    columns: t,
    getCoreRowModel: Gr(),
  ...
  }), k = y.getVisibleFlatColumns();
  let A;
  return d ? A = Array.from({ length: 10 }).map((E, T) => `skeleton-row-${T}`).map((E) => /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Ut, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(Tn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((_ = y.getRowModel().rows) == null ? void 0 : _.length) > 0 ? A = y.getRowModel().rows.map((C) => /* @__PURE__ */ r(
    Rt,
    {
      onClick: () => i(C, y),
    ...
    C.id
  )) : A = /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Ut, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(rl, { table: y }),
    /* @__PURE__ */ c(Ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(qe, { stickyHeader: s, children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(Rt, { children: C.headers.map((R) => /* @__PURE__ */ r(Ve, { children: R.isPlaceholder ? void 0 : Te(R.column.columnDef.header, R.getContext()) }, R.id)) }, C.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Er, {}) })
        ] }),
...
function Rc({
  ...
  return /* @__PURE__ */ c(he, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
...
function Sc({ id: t, label: e, groups: n }) {
  const [o, a] = V(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(ee, { children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "default", children: [
      /* @__PURE__ */ r(Na, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(Yt, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Bt, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      /* @__PURE__ */ r(Le, { children: w.label }),
      /* @__PURE__ */ r(yo, { children: w.itemType === 0 ? /* @__PURE__ */ r(nt, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        $t,
        {
          checked: o[p][h],
...
function vl({ id: t, versionHistory: e }) {
  const [n, o] = V(!1), a = /* @__PURE__ */ new Date();
  function s(l) {
...
function xl({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ c(he, { open: R, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: v,
    ...
    /* @__PURE__ */ r(te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(pe, { children: [
      ...
      /* @__PURE__ */ c(ue, { children: [
        ...
        /* @__PURE__ */ r(Lt, { children: A.map((T) => /* @__PURE__ */ c(
          Qt,
          {
            value: T.label,
            onSelect: y,
...
function Oc({
  ...
  return /* @__PURE__ */ c("div", { id: f, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((h) => {
      var u;
      return /* @__PURE__ */ c(Ie, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          L,
          {
            variant: "ghost",
...
const yl = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(nt, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ c(nt, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function Nl({
  ...
  const s = W(null), i = W(null), l = W(!1), [d, w] = V(t), [p, f] = V(n), [h, u] = V(!1);
  q(() => {
    const x = () => {
      l.current && (l.current = !1);
    };
    return globalThis.addEventListener("click", x), () => {
      globalThis.removeEventListener("click", x);
    };
  }, []), q(() => {
    w(t);
  }, [t]), q(() => {
  ...
  const g = (x) => {
    u(x), x || (d !== "custom" || p ? (e(d), o(p)) : (w(t), f(n)));
  }, v = (x) => {
    var O, N, y, k;
    (x.key === "ArrowDown" || x.key === "ArrowRight") && document.activeElement === i.current ? (O = s.current) == null || O.focus() : x.key === "ArrowUp" && document.activeElement === s.current ? (N = i.current) == null || N.focus() : x.key === "ArrowLeft" && document.activeElement === s.current && ((y = s.current) == null ? void 0 : y.selectionStart) === 0 && ((k = i.current) == null || k.focus()), d === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ c(ee, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ c(Pt, { children: [
...
const kl = (t, e) => t === "f" ? /* @__PURE__ */ c(nt, { children: [
  /* @__PURE__ */ r(Rr, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ c(nt, { children: [
  /* @__PURE__ */ r(Sr, {}),
  " ",
...
function Cl({
  ...
  return /* @__PURE__ */ c(ee, { children: [
    ...
    t !== "x" && /* @__PURE__ */ c(Bt, { className: "tw-z-[300]", children: [
...
function Vc({
  ...
  const l = W(null), d = ia(), [w, p] = V("generated"), [f, h] = V("*"), [u, g] = V("f"), v = z(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (k && nn("note", k)) {
      ...
      let R = "custom";
      C === fn ? R = "generated" : C === gn ? R = "hidden" : C && h(C), p(R), g(((_ = k.insert.note) == null ? void 0 : _.style) ?? "f"), k.insert.note && (k.insert.note.caller = ""), y = setTimeout(() => {
        var E;
  ...
  const x = j(() => {
    var k, A;
    const y = (A = (k = l.current) == null ? void 0 : k.getNoteOps(0)) == null ? void 0 : A.at(0);
    y && nn("note", y) && (y.insert.note && (w === "custom" ? y.insert.note.caller = f : y.insert.note.caller = w === "generated" ? fn : gn), e([y]));
  }, [w, f, e]), O = () => {
    var k;
    const y = (k = d.current) == null ? void 0 : k.getElementsByClassName("editor-input")[0];
        ...
        /* @__PURE__ */ r(
          Cl,
          {
            ...
            handleNoteTypeChange: (y) => {
              ...
              k && nn("note", k) && (k.insert.note && (k.insert.note.style = y), (C = l.current) == null || C.applyUpdate([{ delete: 1 }, k]));
            },
            localizedStrings: i
          }
        ),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ c(Pt, { children: [
            /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Er, {}) }) }),
...
function Rl({
  ...
  const d = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ c(nt, { children: [
    ...
    i && /* @__PURE__ */ c(nt, { children: [
      qn(t.marker, [i], o, !1),
      " "
    ] })
  ] }), u = m(e === "horizontal" ? "horizontal tw-table-cell" : "vertical", o ? "marker-visible" : "");
  return /* @__PURE__ */ c(nt, { children: [
    /* @__PURE__ */ c("div", { className: m("textual-note-header tw-text-nowrap tw-pr-2", u), children: [
      d,
      p
    ] }),
    /* @__PURE__ */ r("div", { className: m("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ r(nt, { children: El(t.marker, l, o, w) }) })
  ] });
}
const Ac = ["%webView_footnoteList_header%"], Sl = (t, e) => t[e] ?? e;
function Pc({
  className: t,
  classNameForItems: e,
  footnotes: n,
  ...
  const f = p ? Sl(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? Wa(n, void 0), u = (y, k) => {
    w == null || w(y, k, a);
  }, g = s ? n.findIndex((y) => y === s) : 0, [v, x] = V(g), O = (y) => {
    if (n.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), x((k) => Math.min(k + 1, n.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), x((k) => Math.max(k - 1, 0));
          break;
        case "Enter":
        case " ":
          y.preventDefault(), w == null || w(n[v], v, a);
          break;
      }
  }, N = W([]);
  return q(() => {
    var y;
    v >= 0 && v < N.current.length && ((y = N.current[v]) == null || y.focus());
  }, [v]), /* @__PURE__ */ c(nt, { children: [
...
function Il({
  ...
  return /* @__PURE__ */ c(Ye, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(qe, { stickyHeader: !0, children: /* @__PURE__ */ c(Rt, { children: [
      /* @__PURE__ */ r(Ve, { children: o }),
      /* @__PURE__ */ r(Ve, { children: a })
    ] }) }),
    /* @__PURE__ */ r(Je, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Rt,
      {
        onClick: () => {
          e(i.reference);
...
const We = (t) => t === "asc" ? /* @__PURE__ */ r(Ia, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Oa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Va, { className: "tw-ms-2 tw-h-4 tw-w-4" }), $c = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ c(Kn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Re,
        {
          onClick: (d) => {
            d.stopPropagation(), sn(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, Vl = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Gc = Object.freeze([
...
function Hc({
  ...
  const f = Nt(n, "%webView_inventory_all%"), h = Nt(n, "%webView_inventory_approved%"), u = Nt(n, "%webView_inventory_unapproved%"), g = Nt(n, "%webView_inventory_unknown%"), v = Nt(n, "%webView_inventory_scope_currentBook%"), x = Nt(n, "%webView_inventory_scope_chapter%"), O = Nt(n, "%webView_inventory_scope_verse%"), N = Nt(n, "%webView_inventory_filter_text%"), y = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), k = Nt(n, "%webView_inventory_no_results%"), [A, _] = V(!1), [C, R] = V("all"), [E, T] = V(""), [P, B] = V([]), H = z(() => {
    const $ = t ?? [];
  ...
  }, [A, H]), J = z(() => D.length === 0 ? [] : Ml(D, C, E), [D, C, E]), M = z(() => {
    var ot, lt;
    if (!A) return d;
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ c(Zt, { children: [
              ...
              /* @__PURE__ */ r(ft, { value: "unapproved", children: u }),
              /* @__PURE__ */ r(ft, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(le, { onValueChange: ($) => gt($), defaultValue: i, children: [
        /* @__PURE__ */ r(Wt, { className: "tw-m-1", children: /* @__PURE__ */ r(we, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(Zt, { children: [
          /* @__PURE__ */ r(ft, { value: "book", children: v }),
          /* @__PURE__ */ r(ft, { value: "chapter", children: x }),
      ...
      o && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(st, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? y })
      ] })
    ] }),
...
const Pl = "16rem", $l = "3rem", Ro = b.createContext(void 0);
function Ze() {
...
const So = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), f = e ?? w, h = b.useCallback(
      (y) => {
        const k = typeof y == "function" ? y(f) : y;
        n ? n(k) : p(k);
      },
      [n, f]
    ), u = b.useCallback(() => h((y) => !y), [h]), g = f ? "expanded" : "collapsed", O = it() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
...
const Do = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Ze();
...
const Ll = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Ze();
  return /* @__PURE__ */ c(
    L,
    {
...
const Sn = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? ce : "div",
  {
    ref: o,
...
const Hl = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? ce : "button",
  {
    ref: o,
...
const Xl = zt(
  ...
  ({
    ...
    const d = t ? ce : "button", { state: w } = Ze(), p = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: m(Xl({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Yl = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Wl = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? ce : "a",
  {
    ref: s,
...
function Zl({
  ...
  return /* @__PURE__ */ r(
    Do,
    {
      ...
      children: /* @__PURE__ */ c(Oo, { children: [
        /* @__PURE__ */ c(Rn, { children: [
          /* @__PURE__ */ r(Sn, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Dn, { children: /* @__PURE__ */ r(Vo, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Mo, { children: /* @__PURE__ */ r(
            Ao,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const At = "scrBook", Ql = "scrRef", Ht = "source", tw = "details", ew = "Scripture Reference", nw = "Scripture Book", Po = "Type", rw = "Details";
function ow(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Kc({
  ...
  const [w, p] = V([]), [f, h] = V([{ id: At, desc: !1 }]), [u, g] = V({}), v = z(
  ...
  const N = a ?? nw, y = s ?? Po, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [At] },
    { label: `Group by ${y}`, value: [Ht] },
    {
  ...
  }, C = (E, T) => E.getIsGrouped() ? "" : m("banded-row", T % 2 === 0 ? "even" : "odd"), R = (E, T, P) => {
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ c(Ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(qe, { children: O.getHeaderGroups().map((E) => /* @__PURE__ */ r(Rt, { children: E.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        /* @__PURE__ */ r(Ve, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ c(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(ae, {}) : /* @__PURE__ */ r(dn, {})),
                          " ",
...
}), $o = (t, e, n) => Zn(t, e).every((o) => n.includes(o));
function sw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Zn(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    L,
    {
      variant: "outline",
...
function iw({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [x, O] = V(!1), [N, y] = V(""), k = W(void 0), A = W(!1);
  ...
  const _ = z(() => Y.allBookIds.filter(
    ...
    (D, J = !1) => {
      ...
      const M = _.findIndex(($) => $ === k.current), Z = _.findIndex(($) => $ === D);
      if (M === -1 || Z === -1) return;
      const [gt, Vt] = [
        Math.min(M, Z),
        Math.max(M, Z)
    ...
    (D) => {
      const J = Zn(_, D).map((M) => M);
      n(
        $o(_, D, e) ? e.filter((M) => !J.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, _]
  ), B = () => {
    ...
    /* @__PURE__ */ c(
      he,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(te, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            pe,
            {
              shouldFilter: !1,
              onKeyDown: (D) => {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: B, children: d }),
                ...
                /* @__PURE__ */ c(ue, { children: [
                  ...
                  Object.values(G).map((D, J) => {
                    const M = C[D];
                    if (M.length !== 0)
                      return /* @__PURE__ */ c(Nr, { children: [
                        /* @__PURE__ */ r(
                          Lt,
                          {
                            heading: eo(D, h, u, g, v),
                        ...
                        J < Object.values(G).length - 1 && /* @__PURE__ */ r(Yr, {})
                      ] }, D);
                  })
                ] })
              ]
...
function Yc({
  ...
  const w = Ft(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Ft(i, "%webView_scope_selector_current_book%"), u = Ft(i, "%webView_scope_selector_choose_books%"), g = Ft(i, "%webView_scope_selector_scope%"), v = Ft(i, "%webView_scope_selector_select_books%"), x = [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Fn,
        {
          ...
          children: O.map(({ value: N, label: y, id: k }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Fe, { className: "tw-me-2", value: N, id: k }),
            /* @__PURE__ */ r(st, { htmlFor: k, children: y })
          ] }, k))
        }
      )
    ] }),
...
function qc({
  ...
  return /* @__PURE__ */ c(
    le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Wt, { size: a, className: m("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          we,
          {
            placeholder: l[U(e)] ?? e
          }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Pt, { children: [
  /* @__PURE__ */ r(Kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    Ge,
    {
      onClick: () => {
        o(l);
...
function In({
  ...
  return /* @__PURE__ */ c(ee, { variant: s, children: [
    /* @__PURE__ */ r(ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(L, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r($a, {}) }) }),
    /* @__PURE__ */ r(Bt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(Nr, { children: [
      /* @__PURE__ */ r(yo, { children: /* @__PURE__ */ r(St, { children: zo(e.groups, e.items, d, t) }) }),
...
function Qc({
  ...
  return /* @__PURE__ */ c(Bo, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      In,
      {
        onSelectMenuItem: t,
...
const jo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = it();
  return /* @__PURE__ */ r(
    ut.Root,
    {
...
const Fo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.List,
  {
    ref: n,
    className: m(
...
)), Go = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Content,
  {
    ref: n,
    className: m(
...
Go.displayName = ut.Content.displayName;
function ed({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
const Ho = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
Ho.displayName = tt.Root.displayName;
const Xo = b.forwardRef(({ className: t, ...e }, n) => {
  const o = xt();
  return /* @__PURE__ */ r(
    tt.Trigger,
    {
...
Xo.displayName = tt.Trigger.displayName;
...
Ko.displayName = tt.SubTrigger.displayName;
...
Uo.displayName = tt.SubContent.displayName;
const Yo = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = xt();
...
Yo.displayName = tt.Content.displayName;
const qo = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = xt();
  return /* @__PURE__ */ r(
    tt.Item,
    {
...
qo.displayName = tt.Item.displayName;
...
dw.displayName = tt.CheckboxItem.displayName;
...
pw.displayName = tt.RadioItem.displayName;
const uw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
uw.displayName = tt.Label.displayName;
...
Jo.displayName = tt.Separator.displayName;
const ke = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Pt, { children: [
      /* @__PURE__ */ r(Kt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        qo,
        {
          onClick: () => {
            o(w);
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(Jo, {}, `separator-${s}`)), d;
  });
};
function mw({
  menuData: t,
  ...
  if (Ts(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), ke(s, [h, u]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), ke(i, [h, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), ke(l, [h, u]);
        break;
      case "alt+h":
        (O = d.current) == null || O.focus(), ke(d, [h, u]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ r(Ho, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(ww, { children: [
      /* @__PURE__ */ r(Xo, { ref: w(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Yo,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(St, { children: Wo(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function od({
  ...
  const w = hw(
    ...
    var O, N, y, k, A, _;
    const x = v !== g ? ((N = (O = t[g]) == null ? void 0 : O.uiNames) == null ? void 0 : N[v]) ?? ((k = (y = t[g]) == null ? void 0 : y.uiNames) == null ? void 0 : k.en) : void 0;
    return x ? `${(A = t[g]) == null ? void 0 : A.autonym} (${x})` : (_ = t[g]) == null ? void 0 : _.autonym;
  };
      ...
      le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(ft, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ c(ee, { children: [
              /* @__PURE__ */ r(ge, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
...
const gw = Me(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ba, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const yw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
yw.displayName = "AlertDescription";
const ld = et.Root, wd = et.Trigger, cd = et.Group, dd = et.Portal, pd = et.Sub, ud = et.RadioGroup, Nw = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  et.SubTrigger,
  {
    ref: a,
    className: m(
...
Nw.displayName = et.SubTrigger.displayName;
...
kw.displayName = et.SubContent.displayName;
const _w = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(et.Portal, { children: /* @__PURE__ */ r(
  et.Content,
  {
    ref: n,
    className: m(
...
_w.displayName = et.Content.displayName;
const Cw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  et.Item,
  {
    ref: o,
    className: m(
...
Cw.displayName = et.Item.displayName;
const Ew = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ c(
  et.CheckboxItem,
  {
    ref: a,
    className: m(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(et.ItemIndicator, { children: /* @__PURE__ */ r(Ct, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Ew.displayName = et.CheckboxItem.displayName;
const Tw = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  et.RadioItem,
  {
    ref: o,
    className: m(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(et.ItemIndicator, { children: /* @__PURE__ */ r(Xe, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Tw.displayName = et.RadioItem.displayName;
const Rw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  et.Label,
  {
    ref: o,
    className: m(
...
Rw.displayName = et.Label.displayName;
...
Sw.displayName = et.Separator.displayName;
...
const md = vt.Trigger, Ow = vt.Portal, hd = vt.Close, Qo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Overlay,
  {
    ref: n,
...
Qo.displayName = vt.Overlay.displayName;
const Vw = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(Zo), i = {
...
const xd = ut.Root, jw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = it();
  return /* @__PURE__ */ r(
    ut.List,
    {
...
export {
  ...
  Nc as BOOK_SELECTOR_STRING_KEYS,
  Ie as Badge,
  xc as BookChapterControl,
  ei as BookSelectionMode,
  kc as BookSelector,
  L as Button,
  _c as COMMENT_LIST_STRING_KEYS,
  Un as Card,
  bo as CardContent,
  ...
  Tc as ERROR_POPOVER_STRING_KEYS,
  gl as ErrorDump,
  Rc as ErrorPopover,
  Mc as FOOTNOTE_EDITOR_STRING_KEYS,
  Ac as FOOTNOTE_LIST_STRING_KEYS,
  Oc as Filter,
  Sc as FilterDropdown,
  Ic as Footer,
  Vc as FootnoteEditor,
  Rl as FootnoteItem,
  Pc as FootnoteList,
  Gc as INVENTORY_STRING_KEYS,
  ve as Input,
  Hc as Inventory,
  st as Label,
  Ec as MarkdownRenderer,
  Dc as MoreInfo,
  xl as MultiSelectComboBox,
  ed as NavigationContentSearch,
  he as Popover,
  bc as PopoverAnchor,
  ...
  sd as ResultsCard,
  Uc as SCOPE_SELECTOR_STRING_KEYS,
  Yc as ScopeSelector,
  Kc as ScriptureResultsViewer,
  ...
  ie as Separator,
  Jc as SettingsList,
  Zc as SettingsListHeader,
  Wc as SettingsListItem,
  ...
  m as cn,
  Fc as getBookIdFromUSFM,
  Bc as getLinesFromUSFM,
  jc as getNumberFromUSFM,
  Vl as getStatusForItem,
  nd as getToolbarOSReservedSpaceClassName,
  Lc as inventoryCountColumn,
  $c as inventoryItemColumn,
