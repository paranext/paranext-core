import dl, { jsx as i, jsxs as N, Fragment as ae } from "react/jsx-runtime";
import * as B from "react";
import E, { forwardRef as cr, useCallback as St, useState as ut, useRef as Ft, useEffect as ne, useLayoutEffect as ga, useMemo as Ot } from "react";
import ye, { clsx as pl } from "clsx";
...
import { ChevronRight as vo, Check as Je, Circle as yo, X as xo, Search as hi, ChevronsUpDown as gi, FilterIcon as fl, ChevronDown as dr, ChevronUp as ml, ArrowLeftIcon as hl, ChevronLeftIcon as gl, ChevronRightIcon as bl, ArrowRightIcon as vl, LoaderCircle as yl, Download as xl, Filter as Nl, User as kl, Link as El, CircleHelp as Sl, Star as Tl, CircleCheckIcon as Cl, CircleXIcon as Rl, CircleHelpIcon as Ol, ArrowUpIcon as _l, ArrowDownIcon as Pl, ArrowUpDownIcon as Il, PanelLeft as $l, PanelRight as Ml, ScrollText as Al, ChevronLeft as Dl } from "lucide-react";
import { getChaptersForBook as jl, NumberFormat as Bl, formatBytes as Vl, deepEqual as No, substring as zl, formatScrRef as Vr, compareScrRefs as no, scrRefToBBBCCCVVV as zr, getLocalizeKeyForScrollGroupId as pt } from "platform-bible-utils";
...
import { useReactTable as vi, getFilteredRowModel as Fl, getSortedRowModel as yi, getPaginationRowModel as Ll, getCoreRowModel as xi, flexRender as vn, getGroupedRowModel as Gl, getExpandedRowModel as Ul } from "@tanstack/react-table";
...
import * as ki from "@radix-ui/react-separator";
...
import { MenuItem as Kl, ListItemText as Jl, ListItemIcon as Ei, Menu as Zl, Grid as Si, List as Ql, IconButton as Ti, Drawer as tc } from "@mui/material";
...
const ko = ft.Root, Ci = ft.Trigger, ic = ft.Group, rh = ft.Portal, oh = ft.Sub, ah = ft.RadioGroup, sc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
...
sc.displayName = ft.SubTrigger.displayName;
...
lc.displayName = ft.SubContent.displayName;
...
const Ri = E.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ i(
    ft.Item,
    {
...
Ri.displayName = ft.Item.displayName;
...
Eo.displayName = ft.CheckboxItem.displayName;
const Oi = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  ft.RadioItem,
  {
    ref: r,
    className: y(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ i(ft.ItemIndicator, { children: /* @__PURE__ */ i(yo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
cc.displayName = "DropdownMenuShortcut";
var dc = Object.defineProperty, pc = (t, e, n) => e in t ? dc(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, nt = (t, e, n) => pc(t, typeof e != "symbol" ? e + "" : e, n);
const Ne = [
  "GEN",
  "EXO",
  "LEV",
...
function en(t, e = !0) {
  return e && (t = t.toUpperCase()), t in ba ? ba[t] : 0;
}
function To(t) {
  return en(t) > 0;
}
...
function $i(t) {
  return t <= 0 || t > Ii ? "******" : _i[t - 1];
}
function bc(t) {
  return $i(en(t));
}
function Mi(t) {
  const e = typeof t == "number" ? Co(t) : t;
  return To(e) && !So.includes(e);
}
function vc(t) {
  const e = typeof t == "number" ? Co(t) : t;
  return To(e) && So.includes(e);
...
function yc(t) {
  return _i[t - 1].includes("*obsolete*");
}
function xc() {
  const t = {};
...
var Ai = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(Ai || {});
const Rt = class ot {
  constructor(e, n, r, o) {
  ...
  allVerses(e = !1, n = ot.verseRangeSeparators, r = ot.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], a = va(this._verse, r);
    for (const s of a.map((l) => va(l, n))) {
      const l = this.clone();
      l.verse = s[0];
      const c = l.verseNum;
...
const Ro = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), Ec = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ya = ["OT", "NT", "DC"], Sc = 96, Tc = [
  /^(\w+)$/i,
...
], cn = (t) => jl(at.bookIdToNumber(t));
function Cc() {
  return Ro.map((e) => at.bookIdToEnglishName(e));
}
function Rc(t) {
...
function Oc(t) {
  ...
  if (Rc(e))
    return Ro.find((r) => at.bookIdToEnglishName(r) === e);
}
function sh({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = Nt(), [a, s] = ut(""), [l, c] = ut(
    ...
    Tc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, G = void 0, H = void 0] = M.slice(1), rt = Oc(A);
  ...
  return ne(() => {
  ...
  }, [f, t.bookNum, t.chapterNum, l]), ga(() => {
    g(m);
  }, [m]), ga(() => {
    const j = setTimeout(() => {
      if (h && T.current && C.current) {
        const A = C.current.offsetTop - Sc;
    ...
    /* @__PURE__ */ i(Ci, { asChild: !0, children: /* @__PURE__ */ i(
      oc,
      {
        ref: k,
        value: a,
    ...
    /* @__PURE__ */ i(
      ur,
      {
        ...
        ref: T,
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: ya.map((j, M) => {
          const A = S(j);
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ i(wr, { className: "tw-font-semibold tw-text-foreground/80", children: Ec[j] }),
            ...
            ya.length - 1 !== M ? /* @__PURE__ */ i(fr, {}) : void 0
          ] }, j);
        }) })
      }
    )
...
const _c = Re(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Ze : "button", { className: y(_c({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Pc = Re(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Tt = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(bi.Root, { ref: n, className: y("pr-twp", Pc(), t), ...e }));
Tt.displayName = bi.Root.displayName;
const Di = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    kn.Root,
    {
...
Di.displayName = kn.Root.displayName;
...
const ji = En.Root, Bi = En.Trigger, Oo = E.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = Nt();
...
const Ic = Kt.Portal, Vi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Kt.Overlay,
  {
    ref: n,
    className: y(
...
Vi.displayName = Kt.Overlay.displayName;
const $c = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(Ic, { children: [
    /* @__PURE__ */ i(Vi, {}),
    /* @__PURE__ */ N(
      Kt.Content,
      {
...
$c.displayName = Kt.Content.displayName;
...
Mc.displayName = Kt.Title.displayName;
...
Ac.displayName = Kt.Description.displayName;
...
const Po = E.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ i(hi, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ i(
      It.Input,
      {
        ref: n,
...
Po.displayName = It.Input.displayName;
...
Io.displayName = It.List.displayName;
const $o = E.forwardRef((t, e) => /* @__PURE__ */ i(It.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
$o.displayName = It.Empty.displayName;
...
zi.displayName = It.Group.displayName;
...
Dc.displayName = It.Separator.displayName;
...
Mo.displayName = It.Item.displayName;
function jc(t) {
...
function io({
  ...
  const [g, k] = ut(!1);
  return /* @__PURE__ */ N(ji, { open: g, onOpenChange: k, ...h, children: [
    /* @__PURE__ */ i(Bi, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: w,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ i(gi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(
      Oo,
      {
        ...
        children: /* @__PURE__ */ N(_o, { children: [
          ...
          /* @__PURE__ */ i(Io, { children: e.map((T) => /* @__PURE__ */ N(
            Mo,
            {
              value: l(T),
              onSelect: () => {
...
var Vc = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Vc || {});
...
function ch({
  ...
  const p = Fr(d, "%webView_bookSelector_currentBook%"), f = Fr(d, "%webView_bookSelector_choose%"), w = Fr(d, "%webView_bookSelector_chooseBooks%"), [m, b] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), h = (g) => {
    b(g), t(g);
      ...
      children: /* @__PURE__ */ N("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Tt, { className: "tw-ms-1", children: p })
          ] }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Tt, { className: "tw-ms-1", children: w })
          ] }),
          /* @__PURE__ */ i(Tt, { className: "tw-flex tw-items-center", children: r.map((g) => at.bookIdToEnglishName(g)).join(", ") }),
          /* @__PURE__ */ i(
            wt,
            {
...
function zc({ table: t }) {
  return /* @__PURE__ */ N(ko, { children: [
    /* @__PURE__ */ i(wl, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = vt.Root, Fc = vt.Group, Ge = vt.Value, ke = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(
    vt.Trigger,
    {
...
const Fi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  vt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(ml, { className: "tw-h-4 tw-w-4" })
  }
));
Fi.displayName = vt.ScrollUpButton.displayName;
...
Li.displayName = vt.ScrollDownButton.displayName;
...
Lc.displayName = vt.Label.displayName;
...
Gc.displayName = vt.Separator.displayName;
function Uc({ table: t }) {
...
function Hc({
  ...
  var g;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [m, b] = ut({}), h = vi({
    data: e,
    columns: t,
    getCoreRowModel: xi(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(zc, { table: h }),
    /* @__PURE__ */ N(mr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(hr, { stickyHeader: a, children: h.getHeaderGroups().map((k) => /* @__PURE__ */ i(ce, { children: k.headers.map((T) => /* @__PURE__ */ i(Sn, { children: T.isPlaceholder ? void 0 : vn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
    ...
    n && r && /* @__PURE__ */ i(Uc, { table: h })
  ] });
}
const Pn = cr(({ className: t, ...e }, n) => /* @__PURE__ */ i(yl, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ i(Pn, { size: 15 }) : /* @__PURE__ */ N(ae, { children: [
        /* @__PURE__ */ i(xl, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function fh({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: y("pr-twp tw-prose", n), children: /* @__PURE__ */ i(Xl, { options: o, children: e }) });
}
const qc = cr((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ref: e,
...
function mh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ N(ko, { children: [
    /* @__PURE__ */ i(Ci, { asChild: !0, children: /* @__PURE__ */ i(qc, {}) }),
    /* @__PURE__ */ i(ur, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ i(wr, { children: n.label }),
      /* @__PURE__ */ i(ic, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(Eo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(Oi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(fr, {})
    ] }, n.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(kl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          ...
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ i(Sl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Kc({ id: t, versionHistory: e }) {
...
function bh({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ N("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ i(Kc, { versionHistory: o }),
...
function Zc({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: y("pr-twp", Jc({ variant: e }), t), ...n });
}
function Qc({
  entries: t,
  ...
  return /* @__PURE__ */ i("div", { className: d, children: /* @__PURE__ */ N(ji, { open: p, onOpenChange: f, children: [
    /* @__PURE__ */ i(Bi, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ i(gi, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(Oo, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ N(_o, { children: [
      ...
      /* @__PURE__ */ N(Io, { children: [
        ...
        /* @__PURE__ */ i(zi, { children: b.map((h) => {
          ...
          return /* @__PURE__ */ N(
            Mo,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: h.starred && /* @__PURE__ */ i(Tl, { className: "tw-h-4 tw-w-4" }) }),
...
function vh({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ i("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ N(Zc, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ i(
          wt,
          {
            variant: "ghost",
...
const ed = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), xa = (t) => {
...
}, rd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Gi = Re(
  ...
  {
    ref: o,
    className: y(Gi({ variant: e, size: n, className: t })),
    ...r
  }
));
od.displayName = Ni.Root.displayName;
const Ui = E.createContext({
  size: "default",
  variant: "default"
}), Xi = E.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => {
  const s = Nt();
  return /* @__PURE__ */ i(
    pr.Root,
    {
...
const br = (t) => t === "asc" ? /* @__PURE__ */ i(_l, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Il, { className: "tw-ms-2 tw-h-4 tw-w-4" }), yh = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ N(Xi, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        Jn,
        {
          onClick: () => Lr(
  ...
  return ed(t).forEach((p) => {
    p.startsWith("\\id") && (s = nd(p), l = 0, c = 0), p.startsWith("\\c") && (l = xa(p), c = 0), p.startsWith("\\v") && (c = xa(p), l === 0 && (l = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const m = f.index, b = a.find((g) => No(g.items, w)), h = {
        ...
        text: zl(p, Math.max(0, m - 25), Math.min(m + 25, p.length))
      };
      if (b)
...
function Eh({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), m = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), h = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), T = te(n, "%webView_inventory_filter_text%"), C = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Ot(() => l ? r instanceof RegExp ? sd(
    l,
    t,
    a,
    s,
...
Do.displayName = ki.Root.displayName;
...
const ld = _n.Provider, cd = _n.Root, dd = _n.Trigger, Yi = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  _n.Content,
  {
    ref: r,
    sideOffset: e,
...
Yi.displayName = _n.Content.displayName;
const pd = "16rem", ud = "3rem", Hi = E.createContext(void 0);
function vr() {
...
const qi = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(Hi.Provider, { value: T, children: /* @__PURE__ */ i(ld, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const Wi = E.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: r, ...o }, a) => {
  const s = vr();
...
const wd = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i($l, {}) : /* @__PURE__ */ i(Ml, {}),
...
const yd = Re(
  ...
  ({
    ...
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ N(cd, { children: [
      /* @__PURE__ */ i(dd, { asChild: !0, children: p }),
      /* @__PURE__ */ i(Yi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
...
const kd = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ i(Na, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ i(
          Na,
          {
...
const Td = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? Ze : "a",
  {
    ref: a,
    ...
    Wi,
    {
      ...
      children: /* @__PURE__ */ N(Ji, { children: [
        /* @__PURE__ */ N(so, { children: [
          ...
          /* @__PURE__ */ i(co, { children: /* @__PURE__ */ i(Zi, { children: Object.entries(e).map(([w, m]) => /* @__PURE__ */ i(Qi, { children: /* @__PURE__ */ i(
            ts,
            {
              className: y(
    ...
    /* @__PURE__ */ N(
      qi,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ki, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const se = "scrBook", Rd = "scrRef", he = "source", Od = "details", _d = "Scripture Reference", Pd = "Scripture Book", ns = "Type", Id = "Details";
function $d(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? at.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === se ? Vr(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: he,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? ns : void 0,
...
}, ka = (t) => `${Md({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Th({
  sources: t,
  ...
  const [c, d] = ut([]), [p, f] = ut([{ id: se, desc: !1 }]), [w, m] = ut({}), b = Ot(
  ...
  ne(() => {
    if (l) {
      ...
      if (I.length === 1) {
        const L = b.find((D) => ka(D) === I[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, b, l, g]);
  const k = o ?? Pd, T = a ?? ns, C = [
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(Fc, { children: C.map((R) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(vo, {}) : /* @__PURE__ */ i(Dl, {})),
                          " ",
...
const rs = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    $t.Root,
    {
...
const os = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  $t.List,
  {
    ref: n,
    className: y(
...
os.displayName = $t.List.displayName;
...
)), as = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  $t.Content,
  {
    ref: n,
    className: y(
...
as.displayName = $t.Content.displayName;
function Ph({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(rs, { children: [
      /* @__PURE__ */ i(os, { children: t.map((s) => /* @__PURE__ */ i(Ad, { value: s.value, children: s.value }, s.key)) }),
      t.map((s) => /* @__PURE__ */ i(as, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const is = E.createContext(void 0);
function Oe() {
...
const ss = E.forwardRef(({ className: t, variant: e = "default", ...n }, r) => {
  const o = E.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ i(is.Provider, { value: o, children: /* @__PURE__ */ i(
    mt.Root,
    {
      ref: r,
      className: y(
...
ss.displayName = mt.Root.displayName;
...
ls.displayName = mt.Trigger.displayName;
const cs = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.SubTrigger,
    {
...
cs.displayName = mt.SubTrigger.displayName;
const ds = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ i(
    mt.SubContent,
    {
...
ds.displayName = mt.SubContent.displayName;
const ps = E.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: r = 8, ...o }, a) => {
  const s = Oe();
...
ps.displayName = mt.Content.displayName;
const us = E.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ i(
    mt.Item,
    {
...
us.displayName = mt.Item.displayName;
...
Bd.displayName = mt.CheckboxItem.displayName;
const Vd = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    mt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(mt.ItemIndicator, { children: /* @__PURE__ */ i(yo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Vd.displayName = mt.RadioItem.displayName;
...
zd.displayName = mt.Label.displayName;
  ...
  return o.flatMap(([a], s) => {
    const l = e.filter((d) => d.group === a).sort((d, p) => d.order - p.order).map(
      (d) => "command" in d ? /* @__PURE__ */ i(
        ...
        /* @__PURE__ */ i(cs, { children: d.label }),
        /* @__PURE__ */ i(ds, { children: fs(
          t,
          e,
          Fd(t, d.id),
          r
...
function Ld({
  ...
  if (Yl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var b, h, g, k;
    p.preventDefault();
    ...
    return /* @__PURE__ */ i(ss, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ N(Dd, { children: [
      /* @__PURE__ */ i(ls, { ref: d(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ i(
        ps,
        {
          className: "tw-z-[250]",
          children: fs(t.groups, t.items, p, e)
        }
      )
    ] }, p)) });
}
...
function Mh({
  ...
  return /* @__PURE__ */ N("div", { className: y("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ N(ae, { children: [
      /* @__PURE__ */ i(Tt, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ i("div", { className: "tw-ms-3", children: /* @__PURE__ */ N(Tt, { children: [
        "Currently:",
        " ",
...
function Ud({ item: t, createLabel: e, createComplexLabel: n }) {
  return e ? /* @__PURE__ */ i(Tt, { children: e(t) }) : n ? /* @__PURE__ */ i(Tt, { children: n(t) }) : /* @__PURE__ */ i(Tt, { children: t });
}
function Ah({
  id: t,
  className: e,
  ...
  return /* @__PURE__ */ i("div", { id: t, className: e, children: n.map((l) => /* @__PURE__ */ N("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ i(
      Ao,
      {
...
function ee(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = ee(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? hs(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
var Un = { exports: {} }, Xn = { exports: {} }, it = {};
...
var Ca;
function gs() {
  return Ca || (Ca = 1, process.env.NODE_ENV === "production" ? Xn.exports = Hd() : Xn.exports = qd()), Xn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var qr, _a;
function bs() {
  return _a || (_a = 1, qr = Function.call.bind(Object.prototype.hasOwnProperty)), qr;
}
var Wr, Pa;
function Kd() {
  if (Pa) return Wr;
  ...
  if (process.env.NODE_ENV !== "production") {
    var e = /* @__PURE__ */ Bo(), n = {}, r = /* @__PURE__ */ bs();
    t = function(a) {
      var s = "Warning: " + a;
...
function Jd() {
  if (Ia) return Kr;
  Ia = 1;
  var t = gs(), e = Wd(), n = /* @__PURE__ */ Bo(), r = /* @__PURE__ */ bs(), o = /* @__PURE__ */ Kd(), a = function() {
  };
...
var Ma;
function Qd() {
  if (Ma) return Un.exports;
  if (Ma = 1, process.env.NODE_ENV !== "production") {
    var t = gs(), e = !0;
    Un.exports = /* @__PURE__ */ Jd()(t.isElement, e);
  } else
    Un.exports = /* @__PURE__ */ Zd()();
  return Un.exports;
}
var tp = /* @__PURE__ */ Qd();
const u = /* @__PURE__ */ ms(tp);
function ep(t) {
  const {
    prototype: e = {}
  } = t;
...
function vs(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !ep(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Vo = jo(u.element, vs);
Vo.isRequired = jo(u.element.isRequired, vs);
const np = "exact-prop: ​";
function rp(t) {
...
var ja;
function ip() {
  return ja || (ja = 1, process.env.NODE_ENV === "production" ? Yn.exports = op() : Yn.exports = ap()), Yn.exports;
}
var Ba = ip();
...
function ys(t, e = "") {
  return t.displayName || t.name || lp(t) || e;
}
function Va(t, e, n) {
  const r = ys(e);
...
function hn() {
  const t = bp($n.create).current;
  return yp(t.disposeEffect), t;
}
let yr = !0, uo = !1;
const xp = new $n(), Np = {
  text: !0,
...
function Tp(t) {
  t.addEventListener("keydown", Ep, !0), t.addEventListener("mousedown", Zr, !0), t.addEventListener("pointerdown", Zr, !0), t.addEventListener("touchstart", Zr, !0), t.addEventListener("visibilitychange", Sp, !0);
}
function Cp(t) {
  const {
    target: e
...
function Es() {
  ...
  function n() {
    return e.current ? (uo = !0, xp.start(100, () => {
      uo = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function Ip(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Et(t, _p), a = Pp(e), s = Object.keys(a);
  function l(w) {
...
const jp = {
  ...
  if (t.length > 2)
    if (Xa[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = jp[e], o = Bp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), kr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Er = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], zp = [...kr, ...Er];
function Mn(t, e, n, r) {
  var o;
...
function Lp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = Vp(n), a = Fp(o, r), s = t[n];
  return re(t, s, a);
}
function _s(t, e) {
  const n = Os(t.theme);
  return Object.keys(t).map((r) => Lp(t, e, r, n)).reduce(yn, {});
}
function gt(t) {
  return _s(t, kr);
}
...
bt.filterProps = Er;
process.env.NODE_ENV !== "production" && zp.reduce((t, e) => (t[e] = de, t), {});
function Gp(t = 8) {
  if (t.mui)
    return t;
  const e = Os({
...
const Up = Xt("border", zt), Xp = Xt("borderTop", zt), Yp = Xt("borderRight", zt), Hp = Xt("borderBottom", zt), qp = Xt("borderLeft", zt), Wp = Xt("borderColor"), Kp = Xt("borderTopColor"), Jp = Xt("borderRightColor"), Zp = Xt("borderBottomColor"), Qp = Xt("borderLeftColor"), tu = Xt("outline", zt), eu = Xt("outlineColor"), Tr = (t) => {
...
Sr(Up, Xp, Yp, Hp, qp, Wp, Kp, Jp, Zp, Qp, Tr, tu, eu);
const Cr = (t) => {
...
Sr(Cr, Rr, Or, nu, ru, ou, au, iu, su, lu, cu, du);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const pu = yt({
...
const fu = yt({
  ...
  if (t.maxWidth !== void 0 && t.maxWidth !== null) {
    const e = (n) => {
      var r, o;
      const a = ((r = t.theme) == null || (r = r.breakpoints) == null || (r = r.values) == null ? void 0 : r[n]) || Fo[n];
...
function Nu() {
  ...
  function e(n) {
    ...
    if (!o)
      return null;
    const s = (r = a.unstable_sxConfig) != null ? r : Go;
    function l(c) {
      let d = c;
...
const Eu = ["breakpoints", "palette", "spacing", "shape"];
function Uo(t = {}, ...e) {
  const {
    breakpoints: n = {},
    palette: r = {},
  ...
  return d.applyStyles = ku, d = e.reduce((p, f) => ee(p, f), d), d.unstable_sxConfig = _({}, Go, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return _r({
      sx: f,
      theme: this
    });
...
const Cu = ["ownerState"], Ru = ["variants"], Ou = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function _u(t) {
  return Object.keys(t).length === 0;
}
function Pu(t) {
...
const Iu = Uo(), Ya = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Hn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function Mu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = $u(Ya(d))
    } = l, m = Et(l, Ou), b = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), h = f || !1;
    let g;
    process.env.NODE_ENV !== "production" && c && (g = `${c}-${Ya(d || "Root")}`);
    let k = Zn;
    d === "Root" || d === "root" ? k = r : d ? k = o : Pu(s) && (k = void 0);
    const T = Hl(s, _({
      shouldForwardProp: k,
      label: g
    }, m)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Qn(v, _({}, P, {
      theme: Hn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Jt(d || "")}`), D === void 0 && (D = `Styled(${cp(s)})`), L.displayName = D;
      }
...
function $s(t, e) {
  return t = Te(t), e = Xo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Pr(t);
}
function Vu(t, e) {
  if (t = Te(t), e = Xo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const Cn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Gu = ["mode", "contrastThreshold", "tonalOffset"], Wa = {
...
function Ka(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = zu(t.main, o) : e === "dark" && (t.dark = Vu(t.main, a)));
}
function Uu(t = "light") {
  return t === "dark" ? {
    main: De[200],
...
function Ku(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Et(t, Gu), a = t.primary || Uu(e), s = t.secondary || Xu(e), l = t.error || Yu(e), c = t.info || Hu(e), d = t.success || qu(e), p = t.warning || Wu(e);
  function f(h) {
    const g = qa(h, Qr.text.primary) >= n ? Qr.text.primary : Wa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = qa(h, g);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ka(h, "light", T, r), Ka(h, "dark", C, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, m = {
    dark: Qr,
    light: Wa
  };
...
function Qu(t, e) {
  ...
  const m = o / 14, b = f || ((k) => `${k / d * m}rem`), h = (k, T, C, S, v) => _({
    ...
    button: h(l, 14, 1.75, 0.4, Ja),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, Ja),
...
const tw = 0.2, ew = 0.14, nw = 0.12;
function ht(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${tw})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${ew})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${nw})`].join(",");
}
const rw = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], ow = ["duration", "easing", "delay"], aw = {
...
function lw(t) {
  const e = _({}, aw, t.easing), n = _({}, iw, t.duration);
  return _({
...
const cw = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, dw = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function pw(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
...
`));
  ...
  return d.unstable_sxConfig = _({}, Go, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return _r({
      sx: f,
      theme: this
    });
...
const uw = (t) => Zn(t) && t !== "classes", Dn = Mu({
  themeId: Ho,
  defaultTheme: Yo,
  rootShouldForwardProp: uw
});
function ww(t) {
...
const fw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], mw = (t) => {
  ...
  const r = qo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, m = Et(r, fw), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", h = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), vw = /* @__PURE__ */ Xd(bw);
var ti;
function yw() {
...
function xw() {
  ...
  var e = t(/* @__PURE__ */ yw()), n = dl;
  return pn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), pn;
}
var Nw = /* @__PURE__ */ xw();
const kw = /* @__PURE__ */ ms(Nw);
function Ew(t) {
  return typeof t == "string";
}
function gn(t, e, n) {
  return t === void 0 || Ew(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const Sw = {
  disableDefaultClasses: !1
}, Tw = /* @__PURE__ */ B.createContext(Sw);
function Cw(t) {
  const {
...
function _w(t) {
  ...
  const s = Rw(_({}, o, r)), l = ni(r), c = ni(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (ar.propTypes = rp(ar.propTypes));
var _t = "top", Gt = "bottom", Ut = "right", Pt = "left", Wo = "auto", jn = [_t, Gt, Ut, Pt], He = "start", Rn = "end", jw = "clippingParents", Ds = "viewport", wn = "popper", Bw = "reference", ri = /* @__PURE__ */ jn.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Rn]);
}, []), js = /* @__PURE__ */ [].concat(jn, [Wo]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Rn]);
}, []), Vw = "beforeRead", zw = "read", Fw = "afterRead", Lw = "beforeMain", Gw = "main", Uw = "afterMain", Xw = "beforeWrite", Yw = "write", Hw = "afterWrite", qw = [Vw, zw, Fw, Lw, Gw, Uw, Xw, Yw, Hw];
function Zt(t) {
...
function We(t, e, n) {
  ...
  var s = Ce(t) ? jt(t) : window, l = s.visualViewport, c = !Bs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function Ir(t) {
  return Zt(t) === "html" ? t : (
    ...
    (Ko(t) ? t.host : null) || // ShadowRoot detected
...
function Qw(t) {
  ...
  var o = Ir(t);
  for (Ko(o) && (o = o.host); Lt(o) && ["html", "body"].indexOf(Zt(o)) < 0; ) {
    var a = oe(o);
...
function Bn(t) {
  for (var e = jt(t), n = oi(t); n && Zw(n) && oe(n).position === "static"; )
    n = oi(n);
  return n && (Zt(n) === "html" || Zt(n) === "body" && oe(n).position === "static") ? e : n || Qw(t) || e;
}
function Zo(t) {
...
var ef = function(e, n) {
  ...
  })) : e, Fs(typeof e != "number" ? e : Ls(e, jn));
};
function nf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Wt(n.placement), c = Zo(l), d = [Pt, Ut].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = ef(o.padding, n), w = Jo(a), m = c === "y" ? _t : Pt, b = c === "y" ? Gt : Ut, h = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Bn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = h / 2 - g / 2, S = f[m], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = xn(S, P, v), R = c;
...
function ai(t) {
  ...
  if (d) {
    ...
    if (P === jt(n) && (P = pe(n), oe(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === _t || (o === Pt || o === Ut) && a === Rn) {
      S = Gt;
...
function ta(t) {
  return We(pe(t)).left + Qo(t).scrollLeft;
}
function ff(t, e) {
...
function mf(t) {
  var e, n = pe(t), r = Qo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = xe(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = xe(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + ta(t), c = -r.scrollTop;
...
function Gs(t) {
  return ["html", "body", "#document"].indexOf(Zt(t)) >= 0 ? t.ownerDocument.body : Lt(t) && ea(t) ? t : Gs(Ir(t));
}
function Nn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Gs(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = jt(r), s = o ? [a].concat(a.visualViewport || [], ea(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function si(t, e, n) {
  return e === Ds ? fo(ff(t, n)) : Ce(e) ? hf(e, n) : fo(mf(pe(t)));
}
function gf(t) {
  var e = Nn(Ir(t)), n = ["absolute", "fixed"].indexOf(oe(t).position) >= 0, r = n && Lt(t) ? Bn(t) : t;
  return Ce(r) ? e.filter(function(o) {
    return Ce(o) && Vs(o, r) && Zt(o) !== "body";
  }) : [];
}
function bf(t, e, n, r) {
  var o = e === "clippingParents" ? gf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var p = si(t, d, r);
...
function On(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? jw : l, d = n.rootBoundary, p = d === void 0 ? Ds : d, f = n.elementContext, w = f === void 0 ? wn : f, m = n.altBoundary, b = m === void 0 ? !1 : m, h = n.padding, g = h === void 0 ? 0 : h, k = Fs(typeof g != "number" ? g : Ls(g, jn)), T = w === wn ? Bw : wn, C = t.rects.popper, S = t.elements[b ? T : w], v = bf(Ce(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = Us({
    reference: P,
    element: C,
    placement: o
  }), R = fo(Object.assign({}, C, F)), I = w === wn ? R : P, L = {
...
function vf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? js : c, p = Ke(r), f = p ? l ? ri : ri.filter(function(b) {
    return Ke(b) === p;
...
function xf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, m = n.flipVariations, b = m === void 0 ? !0 : m, h = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), T = k === g, C = c || (T || !b ? [tr(g)] : yf(g)), S = [g].concat(C).reduce(function(z, K) {
      return z.concat(Wt(K) === Wo ? vf(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var D = S[L], tt = Wt(D), J = Ke(D) === He, j = [_t, Gt].indexOf(tt) >= 0, M = j ? "width" : "height", A = On(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function Sf(t, e, n) {
  var r = Wt(t), o = [Pt, _t].indexOf(r) >= 0 ? -1 : 1, a = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, s = a[0], l = a[1];
...
function Pf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, m = w === void 0 ? !0 : w, b = n.tetherOffset, h = b === void 0 ? 0 : b, g = On(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), T = Ke(e.placement), C = !T, S = Zo(k), v = _f(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof h == "function" ? h(Object.assign({}, e.rects, {
    placement: e.placement
  })) : h, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? _t : Pt, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = m ? -R[A] / 2 : 0, O = T === He ? F[A] : R[A], U = T === He ? -R[A] : -F[A], X = e.elements.arrow, z = m && X ? Jo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : zs(), q = K[j], W = K[M], Y = xn(0, F[A], z[A]), Z = C ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Bn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Yt = xn(m ? ir(H, V) : H, G, m ? xe(rt, xt) : rt);
      P[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var ue, Ct = S === "x" ? _t : Pt, Vn = S === "x" ? Gt : Ut, Ht = P[v], _e = v === "y" ? "height" : "width", we = Ht + g[Ct], Pe = Ht - g[Vn], Ie = [_t, Pt].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Ht - F[_e] - R[_e] - $e + L.altAxis, nn = Ie ? Ht + F[_e] + R[_e] - $e - L.altAxis : Pe, zn = m && Ie ? tf(fe, Ht, nn) : xn(m ? fe : we, Ht, m ? nn : Pe);
      P[v] = zn, tt[v] = zn - Ht;
    }
...
function Df(t, e, n) {
  n === void 0 && (n = !1);
  var r = Lt(e), o = Lt(e) && Af(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  ea(a)) && (l = Mf(e)), Lt(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = ta(a))), {
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (pi(T, C)) {
            p.rects = {
              reference: Df(T, Bn(C), p.options.strategy === "fixed"),
              popper: Jo(C)
...
var Lf = [pf, Of, cf, Jw, Cf, Nf, If, of, Ef], Gf = /* @__PURE__ */ Ff({
  defaultModifiers: Lf
});
const Uf = "Popper";
function Xf(t) {
...
const Yf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Hf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function qf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Kf = () => zo({
  root: ["root"]
}, Cw(Xf)), Jf = {}, Zf = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = Et(e, Yf), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const P = qf(p, s), [F, R] = B.useState(P), [I, L] = B.useState(sr(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = Kf(), J = (r = b.root) != null ? r : "div", j = Iw({
    elementType: J,
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = Et(e, Hf), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
process.env.NODE_ENV !== "production" && (Xs.propTypes = {
   ...
   */
  anchorEl: jo(u.oneOfType([Tn, u.object, u.func]), (t) => {
    if (t.open) {
...
function Ys() {
  const t = Is(Yo);
  return process.env.NODE_ENV !== "production" && B.useDebugValue(t), t[Ho] || t;
}
function mo(t, e) {
...
var tm = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const om = {
  ...
  } = e, k = Et(e, rm), T = hn(), C = B.useRef(), S = Ys(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
lr.muiSupportAuto = !0;
const am = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], im = Dn(Xs, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), na = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const o = Ps(), a = qo({
    props: e,
    name: "MuiPopper"
    ...
    slots: C,
    slotProps: S
  } = a, v = Et(a, am), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const le = Rs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), lm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function cm(t) {
  return Math.round(t * 1e5) / 1e5;
}
const dm = (t) => {
...
const qs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = qo({
    ...
    TransitionProps: kt
  } = P, V = Et(P, lm), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
  }), Yt = Ys(), ue = Yt.direction === "rtl", [Ct, Vn] = B.useState(), [Ht, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = hn(), $e = hn(), fe = hn(), nn = hn(), [zn, ra] = ks({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const oa = (et) => {
    ...
    (et) => {
        ...
        Wn = !1;
      }), ra(!1), X && Qt && X(et), Ie.start(Yt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Ar = (et) => {
    ...
    onFocus: Qs,
    ref: tl
  } = Es(), [, sa] = B.useState(!1), la = (et) => {
    Zs(et), ia.current === !1 && (sa(!1), aa(et));
  }, ca = (et) => {
    Ct || Vn(et.currentTarget), Qs(et), ia.current === !0 && (sa(!0), Ar(et));
  }, da = (et) => {
    we.current = !0;
    const Mt = xt.props;
    Mt.onTouchStart && Mt.onTouchStart(et);
  }, pa = Ar, ua = aa, el = (et) => {
    da(et), fe.clear(), Ie.clear(), Fn(), rn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", nn.start(H, () => {
  ...
  B.useEffect(() => {
    if (!Qt)
      return;
    function et(Mt) {
      (Mt.key === "Escape" || Mt.key === "Esc") && Ln(Mt);
    }
    return document.addEventListener("keydown", et), () => {
      document.removeEventListener("keydown", et);
    };
  }, [Ln, Qt]);
  const rl = Se(xt.ref, tl, Vn, n);
  !dt && dt !== 0 && (Qt = !1);
  const Dr = B.useRef(), ol = (et) => {
    const Mt = xt.props;
    Mt.onMouseMove && Mt.onMouseMove(et), fn = {
      x: et.clientX,
      y: et.clientY
    }, Dr.current && Dr.current.update();
  }, on = {}, jr = typeof dt == "string";
  D ? (on.title = !Qt && jr && !J ? dt : null, on["aria-describedby"] = Qt ? Mr : null) : (on["aria-label"] = jr ? dt : null, on["aria-labelledby"] = Qt && !jr ? Mr : null);
...
`));
  ...
  const an = {};
  M || (Bt.onTouchStart = el, Bt.onTouchEnd = nl), J || (Bt.onMouseOver = Kn(pa, Bt.onMouseOver), Bt.onMouseLeave = Kn(ua, Bt.onMouseLeave), Pe || (an.onMouseOver = pa, an.onMouseLeave = ua)), tt || (Bt.onFocus = Kn(ca, Bt.onFocus), Bt.onBlur = Kn(la, Bt.onBlur), Pe || (an.onFocus = ca, an.onBlur = la)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const al = B.useMemo(() => {
    var et;
    let Mt = [{
    ...
    touch: we.current
  }), Br = dm(sn), wa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : pm, fa = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : lr, ma = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : um, ha = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : wm, il = gn(wa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(Br.popper, Y == null ? void 0 : Y.className, (m = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : m.className)
  }), sn), sl = gn(fa, _({}, kt, (h = Z.transition) != null ? h : L.transition), sn), ll = gn(ma, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ye(Br.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), sn), cl = gn(ha, _({}, (C = Z.arrow) != null ? C : L.arrow, {
    className: ye(Br.arrow, (S = (v = Z.arrow) != null ? v : L.arrow) == null ? void 0 : S.className)
  }), sn);
  return /* @__PURE__ */ N(B.Fragment, {
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ i(wa, _({
      as: W ?? na,
      placement: q,
      anchorEl: rt ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(ma, _({}, ll, {
          children: [dt, F ? /* @__PURE__ */ i(ha, _({}, cl, {
            ref: _e
          })) : null]
        }))
      }))
...
function mi(t, e, n) {
  return t ? /* @__PURE__ */ i(Ei, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ i("img", { src: t, alt: `${n ? "Leading" : "Trailing"} icon for ${e}` }) }) : void 0;
}
function Ws(t) {
  const {
    onClick: e,
    ...
    Kl,
    {
      ...
      children: n ? /* @__PURE__ */ N(ae, { children: [
        ...
        f ? /* @__PURE__ */ i(Ei, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(kw, {}) }) : mi(s, n, !1)
      ] }) : g
    }
  );
...
const mm = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function Js(t) {
...
), Nm = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: y(xm({ variant: e }), t), ...n }));
...
km.displayName = "AlertTitle";
const Em = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Sm.displayName = Qe.Root.displayName;
const Tm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Qe.Image,
  {
    ref: n,
...
Tm.displayName = Qe.Image.displayName;
...
const Pm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Mm.displayName = mn.Root.displayName;
const Am = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    oo.Root,
    {
...
Am.displayName = oo.Root.displayName;
const zh = $t.Root, Dm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    $t.List,
    {
...
Dm.displayName = $t.List.displayName;
...
jm.displayName = $t.Trigger.displayName;
const Bm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  $t.Content,
  {
    ref: n,
    className: y(
...
Bm.displayName = $t.Content.displayName;
const Fh = (t, e) => {
  ne(() => {
    if (!t) return () => {
    };
...
export {
  ...
  dd as TooltipTrigger,
  Mh as UiLanguageSelector,
  wh as UpdateButton,
  Kc as VersionHistory,
  rs as VerticalTabs,
