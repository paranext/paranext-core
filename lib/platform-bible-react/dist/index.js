...
const Is = bt.Root, Os = bt.Portal, Hr = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  bt.Overlay,
  {
    ref: n,
    className: u(
...
const ct = class X {
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new Gt(i)), n ? new X(n, o.toString(), l, p) : new X();
  }
  /**
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: p || `${t} ${Y.bookIdToEnglishName(t)}`,
            onSelect: f,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
function Ys({
  ...
  return /* @__PURE__ */ d(he, { open: l, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ r(te, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: /* @__PURE__ */ r(Lt, { heading: s, children: t.map((c) => /* @__PURE__ */ d(
      Qt,
      {
        onSelect: () => w(c),
...
function Ws(t, e, n, o) {
  const a = j(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const w = e[p - 1], c = Math.max(_t(w), 1);
        o({
          book: w,
          chapterNum: c,
          verseNum: 1
...
function xd({
  ...
  const w = it(), [c, f] = M(!1), [h, m] = M(""), [b, v] = M(""), [N, O] = M("books"), [y, x] = M(void 0), [k, A] = M(!1), _ = et(void 0), C = et(void 0), R = et(void 0), E = et(void 0), T = et({}), P = j(
    (S) => {
      e(S), l && l(S);
    },
    [e, l]
  ...
  return It(() => {
    const S = setTimeout(() => {
      if (c && N === "books" && R.current && E.current) {
  ...
  }, [N, y, V, t.book, t.chapterNum]), /* @__PURE__ */ d(he, { open: c, onOpenChange: ot, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      L,
      {
...
), st = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ir.Root, { ref: n, className: u("pr-twp", Zs(), t), ...e }));
...
function Nn({
  ...
  const [y, x] = M(!1), k = p ?? l, A = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], _ = (C, R) => {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(st, { className: "tw-ms-1", children: c })
          ] }),
...
const _d = [
  ...
  const a = et(null), [s, i] = M(void 0), [l, p] = M(void 0), w = j(
    (m) => {
      i(m);
...
function bi(t, e) {
  ...
  if (e.isSelected(t) && !rs(e) && n !== null) {
    ...
    if (p || w) {
      ...
      let v, N = 0;
      h ? (N = c > f ? f : c, v = c > f ? c : f) : m ? (N = s ? f : c, v = void 0) : b && (N = 0, v = s ? c : f), e.__text = e.__text.slice(N, v);
    }
  }
  return e;
}
          ...
          if (p) {
            ...
            t.update(() => {
              ...
              if (An(v)) {
                ...
                if (je(O) && w >= 0 && c >= 0 && (y = w, x = w + c, v.setTextNodeRange(O, y, O, x)), y === x && f === "" || (v.insertRawText(f), O = N.getNode()), je(O)) {
                  y = h, x = h + m;
...
function Vi() {
  const [t, e] = M(void 0), n = j(() => {
    ...
    return /* @__PURE__ */ r(Is, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Xr, { children: [
...
function Mi({
  ...
  const [e] = Et(), [n, o] = M(e), [a, s] = M("paragraph"), [i, l] = Vi(), p = () => {
  };
...
function $i() {
  const { activeEditor: t } = co(), [e, n] = M([]), o = j((a) => {
    if (An(a) || bs(a)) {
      const s = [];
      fr.forEach(({ format: i }) => {
...
function mo(t, e, n, o = null) {
  ...
  const l = Ee(i) ? i.getChildren() : [], p = ls(t, i.getType());
  let w;
  ...
  if (a && !s) {
    if ((ws(c) || sr(c)) && c.append(h), n.append(c), f) {
      const m = f.call(i, c);
      m && (sr(c) ? c.replaceChildren(m) : c.replaceWith(m));
    }
  } else n.append(h);
  return a;
}
...
function fo(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  return c != null && (h = c(h)), ir(t) && (h = Gi(t, h, m ? () => {
    const b = new Pr();
    return n.push(b), b;
...
function nl({
  ...
  const P = z(
    ...
    var ot;
    await c(l, En(m)) && ((ot = T.current) == null || ot.call(T), b(an));
  }, [m, c, l]), $ = j(
    async (I, ot) => {
      var xe;
      if (!w) return !1;
  ...
  return /* @__PURE__ */ r(
    Un,
    {
      ...
      className: u(
        ...
        {
          "tw-bg-primary-foreground": !n && p !== "Resolved",
          "tw-bg-background": n && p !== "Resolved",
                ...
                children: [
                  /* @__PURE__ */ r(
                    Cn,
                    {
                      editorSerializedState: m,
                      onSerializedChange: (I) => b(I),
                      placeholder: p === "Resolved" ? e["%comment_reopenResolved%"] : e["%comment_replyOrAssign%"],
                      autoFocus: !0,
                      onClear: (I) => {
                        T.current = I;
                      }
  ...
  g.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Oe(i, '[tabindex]:not([tabindex="-1"])').forEach((c) => {
...
function hl({
  ...
  var _;
  const [c, f] = M([]), [h, m] = M([]), [b, v] = M({}), [N, O] = M({}), y = z(() => e ?? [], [e]), x = jr({
    data: y,
    columns: t,
    getCoreRowModel: Gr(),
...
function Sd({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ee, { children: [
    ...
    /* @__PURE__ */ r(Bt, { children: n.map((w, c) => /* @__PURE__ */ d("div", { children: [
...
function xl({
  ...
  return /* @__PURE__ */ r("div", { id: N, className: b, children: /* @__PURE__ */ d(he, { open: R, onOpenChange: c ?? y, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: v,
...
function Vd({
  ...
  const l = et(null), p = ia(), [w, c] = M("generated"), [f, h] = M("*"), [m, b] = M("f"), v = z(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (k && nn("note", k)) {
      ...
      let R = "custom";
      C === fn ? R = "generated" : C === gn ? R = "hidden" : C && h(C), c(R), b(((_ = k.insert.note) == null ? void 0 : _.style) ?? "f"), k.insert.note && (k.insert.note.caller = ""), x = setTimeout(() => {
        var E;
  ...
  const N = j(() => {
    ...
    var k;
    const x = (k = p.current) == null ? void 0 : k.getElementsByClassName("editor-input")[0];
...
function Rl({
  ...
  const p = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, c = /* @__PURE__ */ d(nt, { children: [
...
function Pd({
  ...
  const f = c ? Sl(c, "%webView_footnoteList_header%") : "Footnotes", h = p ?? Wa(n, void 0), m = (x, k) => {
    w == null || w(x, k, a);
...
const So = g.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ro.Provider, { value: y, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    Do,
    {
      ...
      children: /* @__PURE__ */ d(Oo, { children: [
        /* @__PURE__ */ d(Rn, { children: [
          ...
          /* @__PURE__ */ r(Dn, { children: /* @__PURE__ */ r(Vo, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Mo, { children: /* @__PURE__ */ r(
            Ao,
            {
              onClick: () => w(h),
              isActive: f(h),
...
function Kd({
  ...
  const [w, c] = M([]), [f, h] = M([{ id: At, desc: !1 }]), [m, b] = M({}), v = z(
...
function sw({
  ...
  const s = Zn(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], p = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    L,
    {
      variant: "outline",
...
function iw({
  ...
  const _ = z(() => Y.allBookIds.filter(
    ...
    (D) => {
      ...
      n(
        $o(_, D, e) ? e.filter((V) => !J.includes(V)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, _]
  ), B = () => {
            ...
            pe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: B, children: p }),
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: H, children: w })
                ] }),
                /* @__PURE__ */ d(ue, { children: [
                  /* @__PURE__ */ r(Ue, { children: c }),
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, p) => l.order - p.order).map((l) => /* @__PURE__ */ d(Pt, { children: [
...
function In({
  ...
  return /* @__PURE__ */ d(ee, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Bt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, w]) => typeof p == "boolean" || typeof w == "boolean" ? 0 : p.order - w.order).map(([p], w, c) => /* @__PURE__ */ d(Nr, { children: [
...
const ke = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ d(Pt, { children: [
  ...
  if (Ts(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (O = p.current) == null || O.focus(), ke(p, [h, m]);
        break;
    }
  }), q(() => {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ee, { children: [
              /* @__PURE__ */ r(ge, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
...
const mc = vt.Trigger, Ow = vt.Portal, hc = vt.Close, Qo = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Overlay,
  {
    ref: n,
...
Uw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
