...
import { c as m, g as we, a as Er, C as Le, L as Pn, u as Uo, T as Mt, b as Nt, d as Ct, e as Et, A as ca, D as Se, f as me, h as Re, i as mr, j as ze, B as J, x as ss, k as cs, l as ls, I as ds, m as go, n as $e, r as xe, Z as ws, o as $n, P as Xe, p as vr, q as Je, s as Ze, t as ma, v as Qe, w as va, y as Dt, R as fo, z as la, E as Ya, F as Xa, G as Ja, H as Za, J as An, K as Zr, M as mo, N as Vn, O as vo, Q as Dr, S as Mr, U as lr, V as us, W as We, X as Pe, Y as tr, _ as Oe, $ as dr, a0 as bo, a1 as xo, a2 as da, a3 as yo, a4 as Ln, a5 as ps, a6 as hs, a7 as gs, a8 as Qa, a9 as jn, aa as ba, ab as fs, ac as Bn, ad as ms, ae as vs, af as bs, ag as Ko, ah as xs, ai as ys, aj as ks, ak as _s, al as Fn, am as Un, an as ko, ao as Ns, ap as Kn, aq as Oa, ar as Ho, as as Ia, at as Cs, au as Es, av as Ts, aw as Ss, ax as Rs, ay as Ir, az as _o, aA as Ds, aB as Ms } from "./resizable-CygigFec.js";
import { aC as Qg, aD as tf, aE as ef, aF as rf, aG as af, aH as of, aI as nf, aJ as sf, aK as cf, aL as lf, aM as df, aN as wf, aO as uf, aP as pf, aQ as hf, aR as gf, aS as ff, aT as mf, aU as vf, aV as bf, aW as xf, aX as yf, aY as kf, aZ as _f } from "./resizable-CygigFec.js";
import { jsx as a, jsxs as u, Fragment as wt } from "react/jsx-runtime";
import { Canon as At } from "@sillsdev/scripture";
import { Check as Ae, Clock as Go, ChevronsLeft as qo, ChevronsRight as Wo, ChevronUp as Hn, ChevronDown as Ye, ArrowLeft as zs, ArrowRight as Os, BoldIcon as Is, ItalicIcon as Ps, X as No, AtSign as Gn, Pencil as $s, Trash2 as As, ArrowUp as qn, MoreHorizontal as Vs, MailOpen as Ls, Mail as js, FilterIcon as Bs, ArrowLeftIcon as Fs, ChevronLeftIcon as Us, ChevronRightIcon as Ks, ArrowRightIcon as Hs, Copy as Wn, Filter as Gs, User as qs, Link as Ws, CircleHelp as Ys, Undo as Xs, Redo as Js, SquareX as Yn, FunctionSquare as Xn, SquareSigma as Jn, Ban as Zs, AlertCircle as to, CircleCheckIcon as Qs, CircleXIcon as tc, CircleHelpIcon as ec, ArrowUpIcon as rc, ArrowDownIcon as ac, ScrollText as oc, ChevronRight as nc, ChevronLeft as ic, ChevronsUpDown as sc, MenuIcon as cc, Menu as lc, EllipsisVertical as dc, MoreVertical as wc } from "lucide-react";
import { Section as Rt, getChaptersForBook as uc, formatScrRef as Ce, formatReplacementString as Ie, getSectionForBook as Qr, formatRelativeDate as pc, sanitizeHtml as Co, NumberFormat as Zn, formatBytes as hc, getCurrentLocale as gc, usfmMarkers as ta, isPlatformError as fc, ABORTED as mc, getErrorMessage as vc, getFormatCallerFunction as bc, deepEqual as xc, isString as Yo, compareScrRefs as eo, scrRefToBBBCCCVVV as Pa, defaultScrRef as $a, formatScrRefRange as yc, getLocalizeKeyForScrollGroupId as Xo, formatReplacementStringToArray as Jo, collectUsjMarkers as kc } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as A, createContext as xa, useContext as Eo, useState as _, useEffect as q, useCallback as j, useImperativeHandle as _c, useLayoutEffect as Yt, Component as Nc, createElement as Zo, Suspense as Cc, forwardRef as Qn, useId as Qo, Fragment as ya } from "react";
...
import { createEditor as ri, $getRoot as Ve, $createParagraphNode as Pr, $getSelection as re, HISTORY_MERGE_TAG as To, ParagraphNode as ai, TextNode as oi, $getPreviousSelection as $c, $isRangeSelection as ve, $caretFromPoint as Ac, $getSiblingCaret as ni, $getChildCaret as Vc, $getAdjacentChildCaret as Lc, $isChildCaret as jc, $normalizeCaret as Bc, $setSelectionFromCaretRange as Fc, $getCollapsedCaretRange as Uc, $getCaretInDirection as tn, $splitAtPointCaretNext as Kc, $isTextPointCaret as Hc, $findMatchingParent as ii, $isElementNode as zr, mergeRegister as Te, getDOMTextNode as Gc, isHTMLElement as qc, CLEAR_EDITOR_COMMAND as si, COMMAND_PRIORITY_EDITOR as So, shallowMergeConfig as Wc, defineExtension as ce, safeCast as er, createState as Yc, FORMAT_TEXT_COMMAND as ci, $isNodeSelection as li, COMMAND_PRIORITY_LOW as di, RootNode as Xc, LineBreakNode as Jc, TabNode as Zc, $isEditorState as Qc, createCommand as tl, CLICK_COMMAND as el, isDOMNode as rl, $getNodeFromDOMNode as al, $createNodeSelection as ol, $setSelection as nl, $getEditor as il, DecoratorNode as ro, $getState as sl, toggleTextFormatType as en, TEXT_TYPE_TO_FORMAT as cl, $setState as ll, addClassNamesToElement as wi, $create as dl, $getNodeByKey as wl, removeClassNamesFromElement as ul, KEY_TAB_COMMAND as pl, $isBlockElementNode as hl, $createRangeSelection as gl, $normalizeSelection__EXPERIMENTAL as fl, OUTDENT_CONTENT_COMMAND as ml, INDENT_CONTENT_COMMAND as rn, INSERT_TAB_COMMAND as vl, COMMAND_PRIORITY_CRITICAL as Ro, $isDecoratorNode as bl, $isParagraphNode as xl, $isTextNode as ao, SELECTION_CHANGE_COMMAND as ui, $insertNodes as yl } from "lexical";
...
import { Avatar as Do, Select as Xt, Checkbox as an, Slot as $r, Tabs as pe, Menubar as ye, ContextMenu as Vt, Progress as on, Slider as Hr, Switch as nn } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as oo, HIDDEN_NOTE_CALLER as no, getDefaultViewOptions as Pl, isInsertEmbedOpOfType as _r, getMarkerMenuItems as $l, defaultStyleInfo as Al, Editorial as Vl } from "@eten-tech-foundation/platform-editor";
import { cva as _a } from "class-variance-authority";
...
function Gl({
  ...
  q(() => {
    ...
    const I = (G) => !!G && G.scrollWidth > G.clientWidth, et = () => {
      io !== "pointer" && (T || I(h.current) || I(l.current)) && N(!0);
    }, C = () => N(!1);
...
function td(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), s = n.size === 0 ? t : At.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), i = co(s), c = Object.values(i).flat(), l = co(t);
  return {
...
function Va({
  ...
  const B = xe(), V = Kl(), z = T ?? V, [H, W] = _(!1), [L, Q] = _(""), [I, et] = _(""), [C, M] = _("books"), [G, nt] = _(void 0), [ot, pt] = _(
    ...
    () => td(Tt, jt),
    [Tt, jt]
  ), ne = Kt.has(t.book), Qt = A(() => I.trim() ? co(
    Ut.filter((v) => go(v, I, s))
  ) : ft ? de : le, [
    le,
    de,
    Ut,
  ...
  const { otLong: ht, ntLong: kt, dcLong: St, extraLong: Pt } = {
    ...
    [t.book, s, z]
  ), Ta = `${t.chapterNum}:${t.verseNum}`, Sa = j((v) => (X) => {
    zt.current[v] = X;
  }, []), Vr = j((v) => (X) => {
    Ft.current[v] = X;
  }, []), xr = A(
    ...
    [Br, s]
  ), Ma = (i == null ? void 0 : i["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", Fr = (i == null ? void 0 : i["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", Ur = j(
    (v) => {
    ...
    (v) => {
      ...
      if ((C === "chapters" || C === "verses") && (v.key === " " || v.key === "Enter")) {
        ...
        const _t = (() => {
          if (C === "verses") {
            const Bo = ot, Fo = st, za = qr(L);
            return !Bo || !Fo || za === void 0 ? void 0 : {
              isDisabled: ar(Bo, Fo)(za),
              activate: () => ae(za)
            };
          }
          const It = G, kr = Gr(L);
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a($e, { heading: oe(v), children: X.map((at) => /* @__PURE__ */ a(
                          mi,
                          {
                            ...
                            localizedBookNames: s,
                            disabled: Lr(at),
                            dimmedReason: Kt.has(at) ? Ra : void 0,
                            dimmedDescription: Kt.has(at) ? Da(at) : void 0
                          },
                          at
                        )) }, v)
                      );
...
function Hp({
  ...
  const w = La(d, "%webView_bookSelector_currentBook%"), p = La(d, "%webView_bookSelector_choose%"), h = La(d, "%webView_bookSelector_chooseBooks%"), [g, f] = _(
    "current book"
    /* CurrentBook */
  ), y = (b) => {
    f(b), t(b);
...
const yi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, id = yi ? Yt : q, Yr = { tag: To };
...
function ld({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return cd(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: s, dirtyLeaves: i, prevEditorState: c, tags: l }) => {
      e && s.size === 0 && i.size === 0 || t && l.has(To) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const zo = {
...
let ua, Ee = 0, pa = 0, Dd = 0, wo = 0, oa = 0;
function gn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function zd(t) {
  ...
  Ni(this), it = t, this.f &= -2, 8 & this.f && Io(this), Na();
}
function cr(t, e) {
...
qt.prototype.brand = Sd, qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ee !== 0 && pa === 0 && e.l !== wo && (e.l = wo, ua = { S: e, v: e.v, i: e.i, o: ua });
...
function Ti(t, e = Ei) {
  return t.registerCommand(si, (r) => (t.update(e), !0), So);
}
...
const Ba = Yc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Si extends ro {
  $config() {
    return this.config("decorator-text", { extends: ro, stateConfigs: [{ flat: !0, stateConfig: Ba }] });
  }
  getFormat() {
    return sl(this, Ba);
  }
...
const uo = ce({ build: (t) => Ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Po = 0, po = 1, Mi = 2, Fa = 3, Xr = 4, sr = 5, Ua = 6, Nr = 7;
function Ka(t) {
  return t.id === Po;
}
function zi(t) {
...
function Pd(t) {
  return function(e) {
    return e.id === po;
  }(t) || ut(305, String(t.id), String(po)), Object.assign(t, { id: Mi });
}
...
class Ad {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ua && ut(310, String(r.id), String(Ua)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Fa;
    }(e) || ut(314, String(e.id), String(Fa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
class wr {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Ha, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[vn];
    return r && (r.PACKAGE_VERSION !== Ha && ut(292, r.PACKAGE_VERSION, Ha), r instanceof wr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ka(s) || ut(300, i, n || "[unknown]"), Ka(c = s) || ut(304, String(c.id), String(Po)), s = Object.assign(c, { id: po }), o.state = s;
...
const Bd = /* @__PURE__ */ new Set(), xn = ce({ build(t, e, r) {
  const o = r.getDependency(uo).output, n = Or({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Ri(() => {
  }, () => be(() => {
...
}, dependencies: [uo], name: "@lexical/extension/NodeSelection" }), Fd = tl("INSERT_HORIZONTAL_RULE_COMMAND");
class ur extends ro {
  static getType() {
...
ce({ dependencies: [uo, xn], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ve(f)) {
                ...
                if (ao(b) && d >= 0 && w >= 0 && (D = d, k = d + w, f.setTextNodeRange(b, D, b, k)), D === k && p === "" || (f.insertRawText(p), b = y.getNode()), ao(b)) {
                  D = h, k = h + g;
...
function ww() {
  const [t, e] = _(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Ya, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Xa, { children: [
      /* @__PURE__ */ a(Ja, { children: /* @__PURE__ */ a(Za, { children: s }) }),
      i
    ] }) });
  }, [t, r]), n = j(
    (s, i, c = !1) => {
...
const bw = "verseText", Gp = Object.freeze([
...
function Cn({
  ...
  const g = j(
    ...
    [t.user]
  ), k = A(() => Co(t.contents), [t.contents]), N = A(
...
), Tw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ia = (t) => Tw(Co(t));
function sa({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Lw({
  ...
  return l ? P = Array.from({ length: 10 }).map((z, H) => `skeleton-row-${H}`).map((z) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(dr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(lr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = N.getRowModel().rows) == null ? void 0 : T.length) > 0 ? P = N.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(bo, { stickyHeader: s, children: [
      /* @__PURE__ */ a(xo, { stickyHeader: s, children: N.getHeaderGroups().map((B) => /* @__PURE__ */ a(Oe, { children: B.headers.map((V) => /* @__PURE__ */ a(da, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : Tr(V.column.columnDef.header, V.getContext()) }, V.id)) }, B.id)) }),
      /* @__PURE__ */ a(yo, { children: P })
    ] }),
...
function Hw({
  ...
  const l = vo(), d = Sn(n, "%undoButton_tooltip%"), w = Sn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(mo, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
        J,
...
function Gw({
  ...
  return q(() => {
    var l;
    const s = vo(), i = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
function uh({
  ...
  q(() => {
    ...
    if (x && _r("note", x)) {
      ...
      let dt = "custom";
      rt === oo ? dt = "generated" : rt === no ? dt = "hidden" : rt && (P(rt), B(rt)), D(dt), N(dt), z(((O = x.insert.note) == null ? void 0 : O.style) ?? "f"), S = setTimeout(() => {
        var ht, kt, St;
  ...
  const Ft = j(
    ...
    (S, U) => {
      ...
      let x;
      S === "custom" ? x = U : S === "generated" ? x = oo : x = no, Y.insert.note.caller !== x && (Y.insert.note.caller = x, (rt = h.current) == null || rt.applyUpdate([Y, { delete: 1 }]));
    },
    []
  ), Tt = j(() => {
    var S;
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(to, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
...
function wu({
  ...
  return /* @__PURE__ */ u(bo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(xo, { stickyHeader: !0, children: /* @__PURE__ */ u(Oe, { children: [
      /* @__PURE__ */ a(da, { children: n }),
      /* @__PURE__ */ a(da, { children: s })
    ] }) }),
    /* @__PURE__ */ a(yo, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        onClick: () => {
          e(c.reference);
...
const uu = (t) => {
...
}, Ca = (t, e, r) => /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Nt, { children: [
  /* @__PURE__ */ u(
    Ct,
    {
  ...
  accessorKey: "status",
  header: ({ column: s }) => Ca(s, t, "tw:justify-center"),
  cell: ({ row: s }) => {
...
function _h({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Ea();
  return /* @__PURE__ */ u(
    J,
    {
...
function Eu({
  ...
  const c = t ? $r.Root : "button", { state: l } = Ea(), d = /* @__PURE__ */ a(
    c,
    {
...
const Iu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || eo(t.start, t.end) === 0 ? `${Pa(t.start)}+${e}` : `${Pa(t.start)}+${e}-${Pa(t.end)}+${r}`;
...
function Ah({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(bo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(xo, { children: D.getHeaderGroups().map((z) => /* @__PURE__ */ a(Oe, { children: z.headers.filter((H) => H.column.columnDef.header).map((H) => (
      ...
      /* @__PURE__ */ a(yo, { children: D.getRowModel().rows.map((z, H) => {
        const W = xe();
        return /* @__PURE__ */ a(
          Oe,
          {
...
function Pu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
    ...
    () => Object.values(Rt).filter(
      (I) => (s == null ? void 0 : s[I]) !== void 0 && ko(T, I).length === 0
...
function Vu({
  ...
  const i = ko(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    J,
    {
      variant: "outline",
      size: "sm",
...
function Lh({
  ...
  ] }), gt = e ? Z.filter(($) => e.includes($.value)) : Z, ft = y ?? $a, mt = p ?? ft, Jt = h ?? ft, vt = () => {
  ...
  ), oe = Ft === "end", Ar = Ft === "start", rr = "tw:text-muted-foreground", Fe = w === "dropdown" && S === "range", Ta = Fe ? O : Be, Vr = Fe ? dt : f ? Kt : vt, xr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Ne, ar] = _(null), [Ue, jr] = _(null), [Ke, Ra] = _(null), Br = 200, [Da, Ma] = _(!1);
  q(() => {
    if (!Ke || typeof ResizeObserver > "u") return;
    const $ = new ResizeObserver(([tt]) => {
      Ma(tt.contentRect.width < Br);
    });
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Se, { open: ae, onOpenChange: _e, children: [
        ...
        /* @__PURE__ */ a(
          Re,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(Oa, { container: Ke, children: [
                        ...
                        children: /* @__PURE__ */ a(
                          Va,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(wt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ce(y ?? $a, "id") }),
                              /* @__PURE__ */ a(Ye, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
    ...
    w === "radio" && t === "range" && xr,
    w === "dropdown" && Ht && /* @__PURE__ */ a(Ya, { open: S === "selectedBooks", onOpenChange: or, children: /* @__PURE__ */ a(
      Xa,
      {
        ref: jr,
        onCloseAutoFocus: Kr,
        ...
        children: /* @__PURE__ */ u(Oa, { container: Ue, children: [
          /* @__PURE__ */ a(Ja, { className: "tw:pe-8", children: /* @__PURE__ */ a(Za, { children: L }) }),
          Pt,
    ...
    w === "dropdown" && Ot && /* @__PURE__ */ a(Ya, { open: S === "range", onOpenChange: or, children: /* @__PURE__ */ a(
      Xa,
      {
        ref: ar,
        onCloseAutoFocus: Kr,
        ...
        children: /* @__PURE__ */ u(Oa, { container: Ne, children: [
          /* @__PURE__ */ a(Ja, { className: "tw:pe-8", children: /* @__PURE__ */ a(Za, { children: C }) }),
          xr,
          /* @__PURE__ */ u(Ho, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => or(!1), children: ot }),
...
export {
  ...
  Gp as CONFLICT_NOTE_STRING_KEYS,
