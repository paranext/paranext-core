...
function a0({
  ...
  const b = bt(r, "%webView_inventory_all%"), d = bt(r, "%webView_inventory_approved%"), h = bt(r, "%webView_inventory_unapproved%"), f = bt(r, "%webView_inventory_unknown%"), g = bt(r, "%webView_inventory_scope_currentBook%"), w = bt(r, "%webView_inventory_scope_chapter%"), O = bt(r, "%webView_inventory_scope_verse%"), x = bt(r, "%webView_inventory_filter_text%"), [k, y] = he([]), [T, S] = he("all"), [I, R] = he(""), [_, N] = he(""), A = Ce(
    (F, C) => {
      y((Y) => {
        let H = [];
        return F.forEach((K) => {
...
function g0({
  ...
  return /* @__PURE__ */ p("div", { id: e, className: t, children: r.map((i) => /* @__PURE__ */ $("div", { className: "pr-m-2 pr-flex pr-items-center", children: [
    /* @__PURE__ */ p(
      bs,
      {
    ...
    /* @__PURE__ */ p(lt, { children: a ? a(i) : i })
  ] }, i)) });
}
function ud(e) {
