...
import { Slot as ke, Dialog as Yt, Popover as rr, Label as li, RadioGroup as ra, Tooltip as Le, ToggleGroup as Ro, Separator as di, Avatar as ya, DropdownMenu as vt, Select as Et, Checkbox as Ua, Tabs as Kt, Menubar as Zt, ContextMenu as bt, Progress as Ka, Slider as dr, Switch as Ga } from "radix-ui";
...
function f(...t) {
  const e = ii(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return bc(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((d) => {
    const l = xc(d);
    o.set(l.normalized, l.original), n.push(l.normalized);
  }), ci(n.join(" ")).split(" ").filter(Boolean).map((d) => {
    const l = o.get(d);
    return l ? yc(d, l) : d;
  }).join(" ");
}
const Ye = 250, on = 300, kc = 400, _c = 450, Nc = 500, nn = Qt(
...
const Cc = "layoutDirection";
function st() {
  const t = localStorage.getItem(Cc);
  return t === "rtl" ? t : "ltr";
}
function Ec({ ...t }) {
...
function Vc(t, e, r, o) {
  const n = F(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const l = e[d - 1], w = Math.max(Wt(l), 1);
        o({
          book: l,
          chapterNum: w,
          verseNum: 1
...
function no({
  ...
  if (t)
    return /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Wt(t) }, (s, c) => c + 1).map((s) => /* @__PURE__ */ a(
      de,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function $u({
  ...
  const l = st(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, C] = T("books"), [y, _] = T(void 0), [k, P] = T(!1), M = q(void 0), A = q(void 0), N = q(void 0), z = q(void 0), E = q({}), $ = F(
    (R) => {
      e(R), c && c(R);
    },
    [e, c]
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              j,
              {
                ...
                tabIndex: -1,
                children: l === "ltr" ? /* @__PURE__ */ a(Ri, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a($i, { className: "tw:h-4 tw:w-4" })
              }
            ),
              ...
              !x && Object.entries(W).map(([R, H]) => {
                if (H.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(le, { heading: ge(R), children: H.map((Z) => /* @__PURE__ */ a(
                      un,
                      {
                        bookId: Z,
                        onSelect: (ut) => lt(ut),
...
function pa({
  ...
  const [_, k] = T(!1), P = l ?? d, M = (N) => N.length > 0 && typeof N[0] == "object" && "options" in N[0], A = (N, z) => {
    ...
    /* @__PURE__ */ a(
      ue,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: M(e) ? e.map((N) => /* @__PURE__ */ a(le, { heading: N.groupHeading, children: N.options.map((z) => A(z, N.groupHeading)) }, N.groupHeading)) : e.map((N) => A(N)) })
        ] })
      }
    )
  ] });
...
function Au({
  ...
  const w = Ur(l, "%webView_bookSelector_currentBook%"), g = Ur(l, "%webView_bookSelector_choose%"), h = Ur(l, "%webView_bookSelector_chooseBooks%"), [p, m] = T(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    m(v), t(v);
...
const hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Uc = hn ? At : G, pr = { tag: Na };
function Kc({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = Bc(null, o), w = jo({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : G;
function qc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return Gc(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: d }) => {
      e && i.size === 0 && s.size === 0 || t && d.has(Na) || c.isEmpty() || r(n, o, d);
    });
  }, [o, t, e, r]), null;
}
const Da = {
...
class Wc extends ws {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Yc(e.resetKeys, n)) {
      var i, s;
...
function Xc({ children: t, onError: e }) {
  return a(Wc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, rl = fn && "documentMode" in document ? document.documentMode : null;
!(!fn || !("InputEvent" in window) || rl) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
...
function ol(t, e, r) {
  ...
  function d() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = tl(t, e);
    var m, b;
    ...
    for (let C = 0; C < p.length; C++) {
      ...
      const N = Ht(y.height);
      k.height !== N && (_.style.height = N, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[C] = _;
    }
...
function il(t, e = nl) {
  ...
  function l(w) {
    w.read(() => {
      const g = Tt();
      if (!Xt(g)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [h, p] = function(N) {
        const z = N.getStartEndPoints();
        return N.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, C = p.getNode(), y = C.getKey(), _ = p.offset, k = t.getElementByKey(b), P = t.getElementByKey(y), M = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || P !== s || _ !== c || y !== i.getKey();
...
function ll(t) {
  ...
  const o = dl(t, r), n = bs(o), i = xs(n) ? ys(n) : o;
...
function wl(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Ko(i, (l) => ne(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Nr, ie = 0, Cr = 0, gl = 0, ha = 0, vr = 0;
function co(t) {
  if (X === void 0) return;
  let e = t.n;
...
Ct.prototype.brand = ul, Ct.prototype.h = function() {
  return !0;
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [kn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = Tt();
  if (Wo(n) || Xt(n)) for (const i of n.getNodes()) vl(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function _n(t, e) {
  let r;
...
class yl {
  ...
  init(e) {
    ...
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(c, d, l) {
      return Object.assign(c, { id: gr, initResult: d, registerState: l });
    }(i, s, n);
  }
  build(e) {
    const r = this.state;
...
const _l = jt({ config: Oe({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = kl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const Cl = /* @__PURE__ */ new Set(), go = jt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = hl(() => (i.value || Cl).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(s, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), El = Ms("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: zl, priority: 0 }) };
  }
  exportDOM() {
...
jt({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ce(t.registerCommand(El, (s) => {
    const c = Tt();
    if (!Xt(c)) return !1;
    ...
    if (As(s.target)) {
      const c = Is(s.target);
      if (Tl(c)) return function(d, l = !1) {
        const w = Tt(), g = d.isSelected(), h = d.getKey();
        let p;
        l && Wo(w) ? p = w : (p = Ps(), Ls(p)), g ? p.delete(h) : p.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
    ...
    pl(() => {
      ...
      for (const [w, g] of s.entries()) if (g === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = p : (d = !0, l.set(w, { domNode: ar(p), selectedSignal: o(w) }));
      }
      d && (n.value = { nodeSelections: l });
    });
  }), Jt(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(Jt(() => {
      const l = c.value;
      l && (d.value ? Xo(l, i) : Gs(l, i));
    }));
    return ce(...s);
  }));
} });
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Jt(() => {
    if (!o.disabled.value) return sl(t, o.onReposition.value);
  });
} });
function zn(t) {
  return t.canBeEmpty();
}
function Sl(t, e, r = zn) {
  return ce(t.registerCommand(qs, (o) => {
    const n = Tt();
    if (!Xt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => yr(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), g = cl(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Hs();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Ws(p), p.anchor.is(l)) return !0;
      }
      return !1;
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: zn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Jt(() => {
    if (!o.value) return Sl(t, n, i);
  });
} });
const Dl = jt({ name: "@lexical/react/ReactProvider" });
function Rl() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Xt(m)) {
                ...
                if (kr(v) && l >= 0 && w >= 0 && (C = l, y = l + w, m.setTextNodeRange(v, C, v, y)), C === y && g === "" || (m.insertRawText(g), v = b.getNode()), kr(v)) {
                  C = h, y = h + p;
  ...
  return function(r, o) {
    ...
    return Aa(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (h) => r._onError(h), children: a(us, { fallback: null, children: n[l] }) }), g = r.getElementByKey(l);
        g !== null && s.push(sc(w, g, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Il({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    return !1;
  }(t) ? null : a(Al, { editor: t, ErrorBoundary: e });
}
function ho(t) {
  return t.getEditorState().read(Tn(t.isComposing()));
}
function Pl({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = te();
  return function(n) {
    Aa(() => ce(nc(n), Sn(n)), [n]);
  }(o), u(et, { children: [t, a(Ll, { content: e }), a(Il, { editor: o, ErrorBoundary: r })] });
}
...
function Gl(t, e) {
  ...
  return u(et, { children: [a(Ul, { editor: n, ...o, ref: e }), r != null && a(ql, { editor: n, content: r })] });
}
...
function Yl() {
  const [t, e] = T(void 0), r = F(() => {
    ...
    return /* @__PURE__ */ a(Ec, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Sc, { children: [
...
function Xl({
  ...
  const [e] = te(), [r, o] = T(e), [n, i] = T("paragraph"), [s, c] = Yl(), d = () => {
  };
...
function ed({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Xl, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Ql, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Pl,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Hl, { placeholder: t }) }),
          ErrorBoundary: Xc
        }
      ),
      e && /* @__PURE__ */ a(Vl, { defaultSelection: "rootEnd" }),
...
function ad(t, e) {
  const r = tc(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function An(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && kr(e) && (s = el(o, e, "clone"));
  const c = ne(s) ? s.getChildren() : [], d = Qs(t, s.getType());
  let l;
...
function Pn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (c == null || !ec(c)) && (c != null && yr(c) || o);
...
function Pu({
  ...
  const [i, s] = T(cd), [c, d] = T(n), [l, w] = T(!1), g = q(void 0), h = q(null);
  G(() => {
    let v = !0;
    const C = h.current;
    if (!C) return;
...
], ld = ["input", "select", "textarea", "button"], dd = ["button", "textbox"], wd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
}) => {
  const n = q(null), [i, s] = T(void 0), [c, d] = T(void 0), l = F(
    (p) => {
      s(p);
    ...
    if (p.isContentEditable || ld.includes(m)) return !0;
    ...
    (p) => {
      var A;
      const m = p.target, b = (N) => N ? document.getElementById(N) : void 0, v = b(c), C = b(i);
      if (!!(v && m && v.contains(m) && m !== v) && g(m)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !m.isContentEditable) {
          if (c) {
            p.preventDefault(), p.stopPropagation();
            const N = t.find((z) => z.id === c);
            N && l(N.id);
          }
          return;
        }
    ...
    if (o && c)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (k) => {
              k.stopPropagation(), l(!0), g(id(t.contents)), s == null || s(!0);
            },
            children: [
...
function _d({
  ...
  const [N, z] = T(xo), [E, $] = T(), [L, I] = T(), O = o, [W, x] = T(!1), [B, lt] = T(!1), [xt, Mt] = T(!1), [dt, St] = T(!1), [K, nt] = T(!1), [at, wt] = T(k), [zt, ge] = T(!1), yt = q(void 0), [he, ee] = T(/* @__PURE__ */ new Map());
  G(() => {
    let S = !0;
    return (async () => {
...
function Md({
  ...
  return d ? P = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((M = _.getRowModel().rows) == null ? void 0 : M.length) > 0 ? P = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    A.id
  )) : P = /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function Ju({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(pc, { options: i, children: e })
    }
  );
}
...
function tp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(be, { children: [
    ...
    /* @__PURE__ */ a(ye, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ a(Ar, { children: l.label }),
      /* @__PURE__ */ a(Un, { children: l.itemType === 0 ? /* @__PURE__ */ a(et, { children: l.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        me,
        {
          checked: o[w][h],
        ...
        vd,
        {
          ...
          children: l.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(bd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(lr, {})
    ] }, l.label)) })
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(we, { open: N, onOpenChange: w ?? y, children: [
    ...
    /* @__PURE__ */ a(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        ...
        /* @__PURE__ */ a(le, { children: P.map((E) => /* @__PURE__ */ u(
          de,
          {
            value: E.label,
            onSelect: _,
...
function Vd({
  ...
  const d = V(() => /Macintosh/i.test(navigator.userAgent), []), l = No(n, "%undoButton_tooltip%"), w = No(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Pa, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(
        j,
...
function Bd({
  ...
  const i = q(null), s = q(null), c = q(!1), [d, l] = T(t), [w, g] = T(r), [h, p] = T(!1);
  G(() => {
    l(t);
  }, [t]), G(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var C, y, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  ...
  return /* @__PURE__ */ u(
    de,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Mc, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
...
function op({
  ...
  const [m, b] = T("generated"), [v, C] = T("generated"), [y, _] = T("*"), [k, P] = T("*"), [M, A] = T("f"), [N, z] = T(!1), [E, $] = T(!0), [L, I] = T(!1), O = q(!1), W = q(""), [x, B] = T(!1), [lt, xt] = T(), [Mt, dt] = T(), [St, K] = T(), [nt, at] = T(), wt = q(null), zt = V(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? gc(), noteMode: "expanded" }
    }),
    [s, c]
  ), ge = V(
    () => Yd(
  ...
  G(() => {
    ...
    if (U && ur("note", U)) {
      ...
      let _t = "custom";
      pt === ca ? _t = "generated" : pt === la ? _t = "hidden" : pt && (_(pt), P(pt)), b(_t), C(_t), A(((it = U.insert.note) == null ? void 0 : it.style) ?? "f"), D = setTimeout(() => {
        var Rt;
  ...
  const yt = F(
    (D, U, rt = !1) => {
      ...
      if (it && ur("note", it)) {
        if (it.insert.note) {
          let mt;
          D === "custom" ? mt = U : D === "generated" ? mt = ca : mt = la, it.insert.note.caller = mt;
        }
  ...
  G(() => {
    ...
    const D = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, U = (it) => {
      !x && D && document.activeElement === D && it.key === c ? (it.preventDefault(), ot()) : x && it.key === "Escape" && (it.preventDefault(), B(!1));
    };
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(et, { children: Qd(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Pr, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: rw(c.text) })
        ]
      },
...
function gp({
  ...
  }, [A, W]), B = V(() => x.length === 0 ? [] : sw(x, z, $), [x, z, $]), lt = V(() => {
    var at, wt;
    if (!A) return d;
...
function fp({
  ...
  const [i, s] = T(""), [c, d] = T([]), l = V(
    () => t.filter((I) => !e || I.type === e).filter((I) => dw(I, i)).filter(
      (I) => c.length === 0 || c.includes(I.bestLanguageName)
    ),
    [t, e, i, c]
  ), w = V(
    () => l.filter((I) => r == null ? void 0 : r.includes(I.dblEntryUid)),
    [l, r]
  ), g = V(
    () => l.filter((I) => I.installed && !(r != null && r.includes(I.dblEntryUid))),
    [l, r]
  ), h = V(
    () => l.filter(
    ...
    [l, r]
  ), { visibleItems: p, sentinelRef: m, hasMore: b } = lw(h), v = V(
  ...
  }, [c, v, k, o]), L = i.length > 0 || c.length > 0;
  return /* @__PURE__ */ u(et, { children: [
    /* @__PURE__ */ a(sn, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(cn, { children: y }) }),
...
function xw({
  ...
  const c = t ? ke.Root : "button", { state: d } = jr(), l = /* @__PURE__ */ a(
    c,
    {
...
function Rp({
  ...
  const [l, w] = T([]), [g, h] = T([{ id: fe, desc: !1 }]), [p, m] = T({}), b = V(
...
function Sw({
  ...
  const i = Ba(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], l = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    j,
    {
      variant: "outline",
...
function Dw({
  ...
  const M = V(() => ct.allBookIds.filter(
            ...
            Ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(j, { variant: "ghost", size: "sm", onClick: I, children: l })
                ] }),
                /* @__PURE__ */ u(Ce, { children: [
...
const Jn = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Lt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(yd, { children: c.label }),
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ss, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Vo, { children: [
      /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(It, { children: Jn(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(lr, {})
    ] }, d)) })
  ] });
}
...
function jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Qn, { children: [
      /* @__PURE__ */ a(ti, { children: t.map((c) => /* @__PURE__ */ a(Rw, { value: c.value, children: c.value }, c.key)) }),
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(jw, { children: l.label }),
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(Lw, {}, `separator-${i}`)), d;
  });
};
function Bw({
  menuData: t,
  ...
  if (fc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, C;
    w.preventDefault();
...
function Up({
  ...
  return /* @__PURE__ */ u("div", { id: d, className: f("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(ft, { className: "tw:font-normal tw:text-muted-foreground", children: ae(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              ...
              /* @__PURE__ */ a(ye, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Xa, {}) }) }),
              /* @__PURE__ */ a(ye, { align: "end", children: l })
            ] })
          ] }),
...
export {
  ...
  Nc as Z_INDEX_MODAL,
  _c as Z_INDEX_MODAL_BACKDROP,
  kc as Z_INDEX_OVERLAY,
  ud as badgeVariants,
