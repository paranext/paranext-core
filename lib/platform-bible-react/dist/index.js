...
function gt(e, n) {
  const { menuDefinition: t, onClick: r, commandHandler: o } = e;
  ((n == null ? void 0 : n.length) ?? !0) && (n = $r(t).filter((f) => !("menuItem" in f.group)));
  const i = Object.values(n).sort(
  ...
  return /* @__PURE__ */ O("div", { role: "menu", "aria-label": d, children: (() => {
    ...
    return s.forEach((p, y) => {
      ...
      if ("command" in b) {
        ...
        f.push(/* @__PURE__ */ O(Xo, { parentMenuItem: b, ...e }, d + b.id));
    }), f;
  })() }, d);
}
function Jo(e) {
...
function ti() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var M = s, _ = i, K = e, Z = l, R = t, G = p, q = f, ee = n, I = o, N = r, $ = u, j = d, ie = !1, Q = !1;
    function v(S) {
...
function oi() {
  return Ut || (Ut = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = l, M = u, _ = c, K = s, Z = n, R = d, G = r, q = b, ee = y, I = t, N = i, $ = o, j = f, ie = !1;
    function Q(C) {
  ...
  return Yn = function(c, l) {
    ...
    function h(v) {
      ...
      function z(V, L, F, W, X, U, de) {
        ...
        return L[F] == null ? V ? L[F] === null ? new g("The " + X + " `" + U + "` is marked as required " + ("in `" + W + "`, but its value is `null`.")) : new g("The " + X + " `" + U + "` is marked as required in " + ("`" + W + "`, but its value is `undefined`.")) : null : v(L, F, W, X, U);
      }
      var D = z.bind(null, !1);
    ...
    function E(v) {
      function P(A, z, D, V, L) {
        ...
        if (!Array.isArray(F)) {
          var W = $(F);
          return new g("Invalid " + V + " `" + L + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected an array."));
        }
    ...
    function M(v) {
      function P(A, z, D, V, L) {
        if (!(A[z] instanceof v)) {
          var F = v.name || p, W = Q(A[z]);
          return new g("Invalid " + V + " `" + L + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected ") + ("instance of `" + F + "`."));
        }
        return null;
      }
      return h(P);
    ...
    function K(v) {
      function P(A, z, D, V, L) {
        ...
        var F = A[z], W = $(F);
        if (W !== "object")
          return new g("Invalid " + V + " `" + L + "` of type " + ("`" + W + "` supplied to `" + D + "`, expected an object."));
        for (var X in F)
          if (r(F, X)) {
            var U = v(F, X, D, V, L + "." + X, t);
            if (U instanceof Error)
    ...
    function Z(v) {
      ...
      function z(D, V, L, F, W) {
        ...
        return new g("Invalid " + F + " `" + W + "` supplied to " + ("`" + L + "`" + H + "."));
      }
      return h(z);
    }
    function R() {
    ...
    function q(v) {
      function P(A, z, D, V, L) {
        var F = A[z], W = $(F);
        if (W !== "object")
          return new g("Invalid " + V + " `" + L + "` of type `" + W + "` " + ("supplied to `" + D + "`, expected `object`."));
        for (var X in v) {
          var U = v[X];
...
function _s() {
  ...
  function n(t) {
    ...
    function c(l) {
      ...
      if (!u)
        return null;
      const d = zi(i.breakpoints), f = Object.keys(d);
      let p = d;
...
function qs(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, c = {}) => {
    Lo(s, (x) => x.filter((m) => !(m != null && m.__mui_systemSx)));
    const {
      name: l,
      slot: u,
      ...
      overridesResolver: p = Hs(sr(u))
    } = c, y = ae(c, Bs), b = d !== void 0 ? d : (
...
const oo = /* @__PURE__ */ w.forwardRef(function(n, t) {
  ...
  } = n, p = ae(n, Va), y = w.useRef(null), b = w.useRef({
    keys: [],
    repeating: !0,
...
function oc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = w.useRef({}), y = w.useRef(null), b = w.useRef(null), g = Ie(b, f), [h, T] = w.useState(!d), B = tc(l);
  let E = !0;
...
const lc = {
  ...
  } = n, T = ae(n, cc), B = w.useRef(), E = w.useRef(), x = qn(), m = w.useRef(null), M = Ie(m, i.ref, t), _ = (N) => ($) => {
    if (N) {
      const j = m.current;
      $ === void 0 ? N(j) : N(j, $);
    }
...
const uc = Ot, dc = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], fc = {
  ...
  } = n, E = ae(n, dc), x = w.useRef(null), m = Ie(x, c.ref, t), M = (I) => (N) => {
    if (I) {
      const $ = x.current;
      N === void 0 ? I($) : I($, N);
    }
...
const mc = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], gc = (e) => {
  ...
  const s = Ue({
    ...
    component: u,
    invisible: p
  }), x = gc(E), m = (r = b.root) != null ? r : f.root;
...
`)), h !== null && He < h) {
  ...
  const L = b || (l ? be(Sn(l)).body : void 0), F = (o = E == null ? void 0 : E.root) != null ? o : Dc, W = (i = E == null ? void 0 : E.paper) != null ? i : po, X = rn({
    elementType: W,
...
const Lc = ["onEntering"], Fc = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Vc = {
  ...
  const i = Ue({
    ...
    slots: B = {},
    slotProps: E = {}
  } = i, x = ae(i.TransitionProps, Lc), m = ae(i, Fc), M = qn(), _ = M.direction === "rtl", K = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: T
  }), Z = Uc(K), R = s && !u && p, G = w.useRef(null), q = (Q, v) => {
...
`)), Q.props.disabled || (T === "selectedMenu" && Q.props.selected || I === -1) && (I = v));
  ...
  const N = (r = B.paper) != null ? r : qc, $ = (o = E.paper) != null ? o : y, j = rn({
    elementType: B.root,
...
const cl = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ll = (e) => {
  ...
  const r = Ue({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, y = ae(r, cl), b = /* @__PURE__ */ w.isValidElement(o) && o.type === "svg", g = k({}, r, {
    color: s,
    component: c,
    fontSize: l,
...
function $l({
  ...
  return /* @__PURE__ */ O("div", { ref: f, style: { position: "relative" }, children: /* @__PURE__ */ O(Mo, { position: "static", id: r, children: /* @__PURE__ */ ye(Ao, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    g ? /* @__PURE__ */ O(
      _r,
      {
        edge: "start",
