...
import rt, { useRef as G, useMemo as F, useState as I, useCallback as P, useEffect as X, useLayoutEffect as ee, createContext as ca, useContext as to, Component as is, createElement as Oo, Suspense as ss, forwardRef as da, Fragment as eo } from "react";
import { Command as tr } from "cmdk";
import { clsx as ls } from "clsx";
import { extendTailwindMerge as cs, twMerge as ds } from "tailwind-merge";
import { Slot as Ge, Dialog as pe, Popover as Sr, Label as ws, RadioGroup as Ra, Tooltip as sr, ToggleGroup as Tn, Separator as us, Avatar as ro, DropdownMenu as It, Select as Lt, Checkbox as Mo, Tabs as le, Menubar as xe, ContextMenu as Dt, Progress as Ao, Slider as Br, Switch as Po } from "radix-ui";
import { cva as ye } from "class-variance-authority";
import { IconX as ps, IconSearch as gs, IconCheck as er, IconChevronRight as ao, IconChevronDown as hs, IconChevronUp as fs, IconSelector as ms, IconLayoutSidebar as vs, IconLayoutSidebarRight as bs, IconLoader as xs, IconAlertOctagon as ys, IconAlertTriangle as ks, IconInfoCircle as Ns, IconCircleCheck as _s } from "@tabler/icons-react";
...
import { GENERATOR_NOTE_CALLER as Va, HIDDEN_NOTE_CALLER as Ba, getDefaultViewOptions as pc, isInsertEmbedOpOfType as Gr, Editorial as gc } from "@eten-tech-foundation/platform-editor";
...
const Rr = 250, ei = 300, co = 400, yc = 450, kc = 500, Nc = 550, ri = ye(
...
function ba({
  ...
  const E = bt(), [T, C] = I(!1), [j, O] = I(""), [k, x] = I(""), [b, _] = I("books"), [S, V] = I(void 0), [K, L] = I(
    void 0
  ), [q, D] = I(void 0), [W, pt] = I(!1), _t = G(null), $t = G(!1), tt = G(void 0), Rt = G(void 0), U = G(void 0), ot = G(void 0), it = G({}), st = G({}), lt = P(
    (N) => {
      e(N), l && l(N);
    },
    [e, l]
  ...
  }), [Vt]), Wt = F(() => Object.values(vt).flat(), [vt]), Yt = F(() => {
    if (!k.trim()) return vt;
    const N = {
      [Q.OT]: [],
      [Q.NT]: [],
  ...
  const Bt = P(() => {
    if (R) {
      const N = R.chapterNum ?? 1, H = R.verseNum ?? 1;
      if (w && va(R.book, N, H, w))
        return;
      lt({
        book: R.book,
        chapterNum: N,
    ...
    (N) => {
      const H = K ?? (R == null ? void 0 : R.book), Z = q ?? (R == null ? void 0 : R.chapterNum);
      !H || !Z || (lt({
        book: H,
        chapterNum: Z,
        verseNum: N
    ...
    _("books"), V(void 0), L(void 0), D(void 0), setTimeout(() => {
      Rt.current && Rt.current.focus();
    }, 0);
  }, []), A = P(() => {
    const N = K;
    L(void 0), D(void 0), N ? (V(N), _("chapters"), O("")) : Zt();
  }, [K, Zt]), Y = P((N) => {
    C(N), N && (_("books"), V(void 0), L(void 0), D(void 0), x(""));
    ...
    (N) => R ? !!R.chapterNum && !N.toString().includes(R.chapterNum.toString()) : !1,
    [R]
  ), Ct = F(
    () => Ee(
      t,
    ...
    () => Mc(k),
    [k]
  ), kt = F(() => !c || !R || !R.chapterNum || !gt ? !1 : c(R.book, R.chapterNum) > 0, [c, R, gt]), Ke = P(
    (N) => w ? Xo(N, w) : !1,
    [w]
  ), Pe = P(
    (N) => (H) => w ? Ac(N, H, w) : !1,
    ...
    (N, H) => (Z) => w ? va(N, H, Z, w) : !1,
    [w]
  ), qe = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", xr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", yr = P(
    (N) => {
      (N.key === "Home" || N.key === "End") && N.stopPropagation(), g && g.includes(N.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (N.preventDefault(), N.stopPropagation(), Bt());
    },
    [g, R, Bt]
  ), Ar = P(
    (N) => {
      var re, or, kr;
      if (N.ctrlKey) return;
      const { isLetter: H, isDigit: Z } = Jo(N.key);
      if ((b === "chapters" || b === "verses") && (N.key === " " || N.key === "Enter")) {
        const At = N.target instanceof HTMLElement ? N.target : void 0;
        ...
        if (Tt) {
          N.preventDefault(), N.stopPropagation(), Tt.click();
          return;
        }
      }
      ...
      if (b === "chapters" && N.key === "Backspace") {
        N.preventDefault(), N.stopPropagation(), Zt();
        return;
      }
      if (b === "verses" && N.key === "Backspace") {
        N.preventDefault(), N.stopPropagation(), A();
        return;
      }
      const zt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key);
      if (b === "verses" && zt) {
        const At = K, Nt = q;
        if (!At || !Nt || !c) return;
        const Tt = c(At, Nt);
        ...
        Qt !== mt && (N.preventDefault(), N.stopPropagation(), O(
          `${At} ${se[At] || ""} ${Nt}:${Qt}`
        ), setTimeout(() => {
      ...
      if ((b === "chapters" || b === "books" && R) && zt) {
        ...
        mt !== Nt && (N.preventDefault(), N.stopPropagation(), O(
          `${At} ${se[At] || ""} ${mt}`
        ), setTimeout(() => {
    ...
    const { isLetter: H, isDigit: Z } = Jo(N.key);
    (H || Z) && (N.preventDefault(), x((re) => re + N.key), Rt.current.focus(), pt(!1));
  }, []);
  return ee(() => {
    const N = setTimeout(() => {
      if (T && b === "books" && U.current && ot.current) {
        const H = U.current, Z = ot.current, zt = Z.offsetTop, re = H.clientHeight, or = Z.clientHeight, kr = zt - re / 2 + or / 2;
        H.scrollTo({
          top: Math.max(0, kr),
          behavior: "smooth"
        }), O(si(t.book));
    ...
    if (b === "chapters" && S) {
      const N = S === t.book, H = N ? t.chapterNum : 1;
      O(
        `${S} ${se[S] || ""} ${H}`
      ), setTimeout(() => {
        if (U.current)
    ...
    if (b === "verses" && K && q !== void 0) {
      const N = K === t.book && q === t.chapterNum, H = N ? t.verseNum : 1;
      O(
        `${K} ${se[K] || ""} ${q}:${H}`
      ), setTimeout(() => {
        if (U.current)
    ...
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(
      B,
      {
        ...
        onClick: (N) => {
          $t.current && ($t.current = !1, N.preventDefault());
        },
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        onPointerDownOutside: (N) => {
          const { target: H } = N;
          T && _t.current && H instanceof Node && _t.current.contains(H) && ($t.current = !0, Y(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          $e,
          {
            ...
            children: [
              b === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Jt.map(({ onClick: N, disabled: H, title: Z, icon: zt }) => /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  B,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: b === "verses" ? A : Zt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: E === "ltr" ? /* @__PURE__ */ a(Os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Sn, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                b === "chapters" && S && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Le(S, n) }),
              ...
              !W && /* @__PURE__ */ u(Re, { ref: U, children: [
                b === "books" && /* @__PURE__ */ u(at, { children: [
                  !R && Object.entries(Yt).map(([N, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(he, { heading: yt(N), children: H.map((Z) => /* @__PURE__ */ a(
                          ni,
                          {
                            bookId: Z,
                            onSelect: (zt) => Xt(zt),
                  ...
                  R && /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
                    ke,
                    {
                      ...
                      children: Ee(
                        ...
                        n ? uo(R.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  R && kt && R.chapterNum && c && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Le(R.book, n)} ${R.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Qo,
                      {
                        ...
                        endVerse: c(R.book, R.chapterNum),
                        scrRef: t,
                        onVerseSelect: ne,
                        setVerseRef: ut,
                        isVerseDisabled: br(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !kt && we(R.book) > 1 && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Le(R.book, n) }),
...
function tn({
  ...
  const [T, C] = I(!1), j = c ?? d, O = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], k = (x, b) => {
    const _ = d(x), S = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, V = `${b ?? ""}${_}${S ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: _,
  ...
  return /* @__PURE__ */ u(Ne, { open: T, onOpenChange: C, ...E, children: [
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        children: /* @__PURE__ */ u($e, { children: [
          ...
          /* @__PURE__ */ a(Re, { children: O(e) ? e.map((x) => /* @__PURE__ */ a(he, { heading: x.groupHeading, children: x.options.map((b) => k(b, x.groupHeading)) }, x.groupHeading)) : e.map((x) => k(x)) })
        ] })
      }
    )
  ] });
...
function Fp({
  ...
  const w = xa(c, "%webView_bookSelector_currentBook%"), g = xa(c, "%webView_bookSelector_choose%"), m = xa(c, "%webView_bookSelector_chooseBooks%"), [p, f] = I(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    f(v), t(v);
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fc = wi ? ee : X, Ur = { tag: no };
function Gc({ initialConfig: t, children: e }) {
  const r = F(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: d } = t, c = Bc(null, o), w = Pn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, m) {
      if (m !== null) {
...
const Uc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : X;
function Kc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Ce();
  return Uc(() => {
...
const Xc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : X;
function Jc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Zc() {
  return function(t) {
    const [e] = Ce(), r = F(() => t(e), [e, t]), [o, n] = I(() => r.initialValueFn()), i = G(o);
    return Xc(() => {
...
function td(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !ul(e) && o !== null) {
    const [n, i] = o, s = t.isBackward(), l = n.getNode(), d = i.getNode(), c = e.is(l), w = e.is(d);
    if (c || w) {
      const [g, m] = pl(t), p = l.is(d), f = e.is(s ? d : l), y = e.is(s ? l : d);
      let v, z = 0;
      p ? (z = g > m ? m : g, v = g > m ? g : m) : f ? (z = s ? m : g, v = void 0) : y && (z = 0, v = s ? g : m);
      const E = e.__text.slice(z, v);
      E !== e.__text && (r === "clone" && (e = gl(e)), e.__text = E);
    }
  }
  return e;
}
...
function ad(t, e, r) {
  ...
  function d() {
    ...
    const { left: g, top: m } = n.getBoundingClientRect(), p = Qc(t, e);
    var f, y;
    l.isConnected || (y = l, (f = n).insertBefore(y, f.firstChild));
    let v = !1;
    for (let z = 0; z < p.length; z++) {
      const E = p[z], T = s[z] || document.createElement("div"), C = T.style;
      C.position !== "absolute" && (C.position = "absolute", v = !0);
      const j = de(E.left - g);
      C.left !== j && (C.left = j, v = !0);
      const O = de(E.top - m);
      C.top !== O && (T.style.top = O, v = !0);
      const k = de(E.width);
      C.width !== k && (T.style.width = k, v = !0);
      const x = de(E.height);
      C.height !== x && (T.style.height = x, v = !0), T.parentNode !== l && (l.append(T), v = !0), s[z] = T;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    c(), o = m, n = p, i = new MutationObserver((f) => {
      ...
      if (y !== o || v !== n) return g();
      for (const z of f) if (!l.contains(z.target)) return d();
    }), i.observe(p, rd), d();
  });
  return () => {
    w(), c();
...
function nd(t, e = od) {
  ...
  function c(w) {
    w.read(() => {
      ...
      }(g), f = m.getNode(), y = f.getKey(), v = m.offset, z = p.getNode(), E = z.getKey(), T = p.offset, C = t.getElementByKey(y), j = t.getElementByKey(E), O = r === null || C !== o || v !== n || y !== r.getKey(), k = i === null || j !== s || T !== l || E !== i.getKey();
      if ((O || k) && C !== null && j !== null) {
        const x = function(b, _, S, V, K, L, q) {
          const D = (b._window ? b._window.document : document).createRange();
          return D.setStart(...en(_, S, V)), D.setEnd(...en(K, L, q)), D;
        }(t, m, f, C, p, z, j);
        d(), d = ad(t, x, e);
      }
      r = f, o = C, n = v, i = z, s = j, l = T;
    });
  }
...
function cd(t, e, r) {
  ...
  return _l(o) && ra(283), o.insert(t.isInline() ? fr().append(t) : t), Go(Vn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = Gt();
  if (!ge(e)) return !1;
...
const mo = 0, Ja = 1, yi = 2, Na = 3, Kr = 4, nr = 5, _a = 6, _r = 7;
function Ca(t) {
  return t.id === mo;
}
function ki(t) {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(f)) {
                ...
                if (ea(v) && c >= 0 && w >= 0 && (z = c, E = c + w, f.setTextNodeRange(v, z, v, E)), z === E && g === "" || (f.insertRawText(g), v = y.getNode()), ea(v)) {
                  z = m, E = m + p;
                  const T = v.getTextContentSize();
                  z = z > T ? T : z, E = E > T ? T : E, f.setTextNodeRange(v, z, v, E);
                }
...
function Yd({
  ...
  const [e] = Ce(), [r, o] = I(e), [n, i] = I("paragraph"), [s, l] = Wd(), d = () => {
  };
...
function Zd() {
  const { activeEditor: t } = Ti(), [e, r] = I([]), o = P((n) => {
    if (ge(n) || sc(n)) {
      const i = [];
      un.forEach(({ format: s }) => {
...
function Ri(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  const d = function(f, y) {
    const { nodeName: v } = f, z = y._htmlConversions.get(v.toLowerCase());
    let E = null;
    if (z !== void 0) for (const T of z) {
      const C = T(f);
      C !== null && (E === null || (E.priority || 0) <= (C.priority || 0)) && (E = C);
    }
  ...
  let m = [];
  const p = (l == null || !tc(l)) && (l != null && ta(l) || o);
...
function Up({
  ...
  const [i, s] = I(sw), [l, d] = I(n), [c, w] = I(!1), g = G(void 0), m = G(null);
  X(() => {
    let v = !0;
    const z = m.current;
    if (!z) return;
...
const Kp = Object.freeze([
  ...
  const n = G(null), [i, s] = I(void 0), [l, d] = I(void 0), c = P(
    (p) => {
      s(p);
    ...
    if (p.isContentEditable || lw.includes(f)) return !0;
    ...
    (p) => {
      var k;
      const f = p.target, y = (x) => x ? document.getElementById(x) : void 0, v = y(l), z = y(i);
      ...
      switch (p.key) {
        case "ArrowDown":
          j = Math.min(C + 1, t.length - 1), p.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(C - 1, 0), p.preventDefault();
          break;
        case "Home":
...
function gn({
  ...
  const p = P(
    ...
    const C = new Date(t.date), j = Es(
      C,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), O = C.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = F(() => t.user, [t.user]), z = F(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), E = F(() => zs(t.contents), [t.contents]), T = F(() => {
    if (o && l)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          Je,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), g(nw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(gw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(hw, { className: "tw:text-xs tw:font-medium", children: z }) }),
        ...
        T && /* @__PURE__ */ u(me, { children: [
          /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ls, {}) }) }),
...
function kw({
  ...
  const [x, b] = I(hn), [_, S] = I(), [V, K] = I(), L = o, [q, D] = I(!1), [W, pt] = I(!1), [_t, $t] = I(!1), [tt, Rt] = I(!1), [U, ot] = I(!1), [it, st] = I(C), [lt, Vt] = I(!1), vt = G(void 0), [Wt, Yt] = I(/* @__PURE__ */ new Map());
  X(() => {
    let $ = !0;
    return (async () => {
  ...
  X(() => {
    if (!o) {
      R.current !== "idle" && (S(void 0), K(void 0), R.current = "idle");
      return;
    }
    R.current === "idle" && (R.current = "pending"), tt ? R.current === "pending" && k !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    k !== i && (S(k), R.current = "auto-populated") : R.current === "auto-populated" && (S(void 0), R.current = "pending");
  }, [o, k, tt, i]);
  const Ot = F(() => e.filter(($) => !$.deleted), [e]);
  X(() => {
    let $ = !0;
    if (!o || !T) {
      Yt(/* @__PURE__ */ new Map());
  ...
  const Bt = F(() => Ot[0], [Ot]), ne = G(null), Xt = G(void 0), Mt = P(() => {
    var $;
  ...
  }, [i, r]), A = F(() => Ot.slice(1), [Ot]), Y = F(() => A.length ?? 0, [A.length]), ct = F(() => Y > 0, [Y]), nt = F(() => q || Y <= 2 ? A : A.slice(-2), [A, Y, q]), ht = F(() => q || Y <= 2 ? 0 : Y - 2, [Y, q]), xt = F(
  ...
  const ft = P(
    ...
    async ($) => {
      const ut = ae(x) ? ia(x) : void 0, gt = $.status ? $.assignedUser : _ ?? $.assignedUser, kt = await g({
        ...$,
        contents: ut,
        assignedUser: gt
      });
            ...
            o && /* @__PURE__ */ u(at, { children: [
              ...
              v !== !1 && (!W || ae(x)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: ($) => {
                    ko($) && ($.preventDefault(), $.stopPropagation(), (ae(x) || _ !== void 0 && _ !== V) && ft());
                  },
                  onKeyDown: ($) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      _ !== void 0 && (ae(x) || _ !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Xe(
                      ...
                      /* @__PURE__ */ u(Ne, { open: _t, onOpenChange: $t, children: [
                        /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(
                          B,
                          {
                            ...
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !tt || !y || y.length === 0 || !y.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          _e,
                          {
                            ...
                            children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Re, { children: y == null ? void 0 : y.map(($) => /* @__PURE__ */ a(
                              ke,
                              {
                                onSelect: () => {
                                  S($ !== i ? $ : void 0), R.current = "user-selected", K(void 0), $t(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function Qp({
  ...
  const [z, E] = I(/* @__PURE__ */ new Set()), [T, C] = I(), [j, O] = I(), k = P(
    async (D) => {
      const W = await i(D);
      return W !== void 0 && D.assignedUser !== void 0 && D.assignedUser !== "" && O(D.assignedUser), W;
    },
    [i]
  );
  X(() => {
    f && (E((D) => new Set(D).add(f)), C(f));
  }, [f]);
  const x = r.filter(
    (D) => D.comments.some((W) => !W.deleted)
  ), b = x.map((D) => ({ id: D.id })), _ = P(
    (D) => {
      E((W) => new Set(W).add(D.id)), C(D.id), y == null || y(D.id);
    },
    [y]
  ), S = P(
    (D) => {
    ...
    [z, y]
  ), { listboxRef: V, activeId: K, handleKeyDown: L } = dw({
    options: b,
    onOptionSelect: _
  }), q = P(
    (D) => {
      D.key === "Escape" ? (T && z.has(T) && (E((W) => {
        const pt = new Set(W);
        return pt.delete(T), pt;
      }), C(void 0), y == null || y(void 0)), D.preventDefault(), D.stopPropagation()) : L(D);
    },
    [T, z, L, y]
  );
  return /* @__PURE__ */ a(
...
function Nw({ table: t }) {
  return /* @__PURE__ */ u(me, { children: [
    /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function $w({
  ...
  var O;
  const [w, g] = I([]), [m, p] = I([]), [f, y] = I({}), [v, z] = I({}), E = F(() => e ?? [], [e]), T = Zn({
    data: E,
    columns: t,
    getCoreRowModel: ti(),
    ...r && { getPaginationRowModel: cc() },
    onSortingChange: g,
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((b, _) => `skeleton-row-${_}`).map((b) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((O = T.getRowModel().rows) == null ? void 0 : O.length) > 0 ? j = T.getRowModel().rows.map((k) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(k, T),
      "data-state": k.getIsSelected() && "selected",
      children: k.getVisibleCells().map((x) => /* @__PURE__ */ a(cr, { children: zr(x.column.columnDef.cell, x.getContext()) }, x.id))
    },
    k.id
  )) : j = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: c }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Nw, { table: T }),
...
function Lw({ row: t, mode: e, strings: r, onClick: o, onOpen: n, selectedRowRef: i }) {
  const [s, l] = I(!1), d = G(null), c = !!(t.language || t.languageCode), w = c || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, g = P(() => {
    if (w) {
      l(!0);
      return;
    }
    const z = d.current;
    z && z.scrollWidth > z.clientWidth && l(!0);
  }, [w]), m = /* @__PURE__ */ a(Be, { className: h("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let p;
  e === "project" ? t.openGroups.length > 0 && (p = /* @__PURE__ */ a("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((z) => /* @__PURE__ */ a(De, { variant: "secondary", children: $r(z) }, z)) })) : t.scrollGroupId !== void 0 && (p = /* @__PURE__ */ u("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ a(
      jw,
      {
  ...
  ), y = t.scrollGroupId !== void 0 ? $r(t.scrollGroupId) : void 0, v = t.isBoundButClosed && y ? r.boundButClosedTooltip.replace("{group}", y) : void 0;
...
function Bw(t) {
  const [e, r] = I(!1), [o, n] = I(""), [i, s] = I(t.defaultGroupByOpenTabs ?? !0), [l, d] = I(!1), c = G(null), w = P((k) => {
    r(k), k || n("");
  }, []);
  X(() => {
    if (!e) return;
  ...
  const g = Aw(t.localizedStrings), m = F(() => t.mode === "project" ? Ta({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), p = F(() => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const x = [];
        if (k.forEach((S) => {
          const V = t.projects.find((K) => K.id === S.projectId);
          V && x.push({ project: V, scrollGroupId: S.scrollGroupId });
        }), x.length === 0) {
          const S = t.buttonPlaceholder ?? "";
          return { node: S, title: S };
        }
        ...
        const b = x.map(
          ({ project: S, scrollGroupId: V }) => V === void 0 ? S.shortName : `${S.shortName} (${$r(V)})`
        ).join(", ");
        if (x.length === 1) return { node: b, title: b };
        const _ = x.length.toString();
        return {
          node: /* @__PURE__ */ u(at, { children: [
            /* @__PURE__ */ a(De, { variant: "muted", className: "tw:shrink-0", children: _ }),
      ...
      case "projectScrollGroup": {
        ...
        const b = `${k.shortName} · ${$r(x)}`;
        return { node: b, title: b };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t]), j = t.mode === "project-multi" ? /* @__PURE__ */ a(oo, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : /* @__PURE__ */ a(Ze, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }), O = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? v : void 0;
      ...
      _e,
      {
        ...
        children: /* @__PURE__ */ a(Ut, { delayDuration: 400, children: /* @__PURE__ */ u($e, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: E, children: `${g.selectAll} (${y.length.toString()})` }),
            /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: T, children: `${g.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ u(Re, { children: [
            /* @__PURE__ */ a(Mr, { children: t.commandEmptyMessage ?? "No projects found" }),
            f.map((k, x) => /* @__PURE__ */ u(eo, { children: [
              /* @__PURE__ */ a(he, { heading: Fw(k, g), children: k.rows.map((b) => /* @__PURE__ */ a(
                Lw,
                {
                  row: b,
                  mode: t.mode,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Rn, {}) })
        ] }),
...
function sg({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(me, { children: [
    /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ u(B, { variant: "default", children: [
...
function Hw({
  ...
  const [z, E] = I(!1), T = P(
    (_) => {
      var V;
      const S = (V = t.find((K) => K.label === _)) == null ? void 0 : V.value;
      S && r(
        e.includes(S) ? e.filter((K) => K !== S) : [...e, S]
      );
    },
    [t, e, r]
  ), C = () => d || o, j = F(() => {
    if (!m) return t;
    const _ = t.filter((V) => V.starred).sort((V, K) => V.label.localeCompare(K.label)), S = t.filter((V) => !V.starred).sort((V, K) => {
      const L = e.includes(V.value), q = e.includes(K.value);
      return L && !q ? -1 : !L && q ? 1 : V.label.localeCompare(K.label);
    });
    return [..._, ...S];
  }, [t, e, m]), O = () => {
    r(t.map((_) => _.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: f, children: /* @__PURE__ */ u(Ne, { open: x, onOpenChange: w ?? E, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(
      B,
      {
        variant: y,
    ...
    /* @__PURE__ */ a(_e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u($e, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: O, children: i }),
        /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: k, children: s })
      ] }),
      /* @__PURE__ */ u(Re, { children: [
        /* @__PURE__ */ a(Mr, { children: l }),
        /* @__PURE__ */ a(he, { children: j.map((_) => /* @__PURE__ */ u(
          ke,
          {
            value: _.label,
            onSelect: T,
            ...
            children: [
              ...
              _.starred && /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" }),
...
function Yw({
  ...
  const d = F(() => /Macintosh/i.test(navigator.userAgent), []), c = yn(n, "%undoButton_tooltip%"), w = yn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(yo, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
function Zw({
  ...
  const i = G(null), s = G(null), l = G(!1), [d, c] = I(t), [w, g] = I(r), [m, p] = I(!1);
  X(() => {
    c(t);
  }, [t]), X(() => {
    w !== r && g(r);
  ...
  const f = (v) => {
    ...
    var z, E, T, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((z = i.current) == null || z.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((E = s.current) == null || E.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((T = i.current) == null ? void 0 : T.selectionStart) === 0 && ((C = s.current) == null || C.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(me, { open: m, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: Jw(t, n, r) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ue,
            {
              ...
              onClick: (v) => {
                var z;
                v.stopPropagation(), l.current = !0, (z = i.current) == null || z.focus();
              },
...
function eu({
  ...
  return /* @__PURE__ */ u(me, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(B, { variant: "outline", className: "tw:h-6", children: Qw(t, r) }) }) }),
...
function wg({
  ...
  const w = G(null), g = G(null), m = G(null), p = G(null);
  ee(() => {
    if (!p.current) return;
    const { width: A } = p.current.getBoundingClientRect();
    A > 0 && (p.current.style.width = `${A}px`);
  }, []);
  const [f, y] = I("generated"), [v, z] = I("generated"), [E, T] = I("*"), [C, j] = I("*"), [O, k] = I("f"), [x, b] = I(!1), [_, S] = I(!0), [V, K] = I(!1), L = G(!1), q = G(""), [D, W] = I(!1), [pt, _t] = I(), [$t, tt] = I(), [Rt, U] = I(), [ot, it] = I(), st = G(null), lt = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  X(() => {
    ...
    if (Y && Gr("note", Y)) {
      ...
      let xt = "custom";
      ht === Va ? xt = "generated" : ht === Ba ? xt = "hidden" : ht && (T(ht), j(ht)), y(xt), z(xt), k(((nt = Y.insert.note) == null ? void 0 : nt.style) ?? "f"), A = setTimeout(() => {
        var yt;
  ...
  const vt = P(
    (A, Y, ct = !1) => {
      ...
      if (nt && Gr("note", nt)) {
        if (nt.insert.note) {
          let ft;
          A === "custom" ? ft = Y : A === "generated" ? ft = Va : ft = Ba, nt.insert.note.caller = ft;
        }
  ...
  const R = G({ book: n.book, chapterNum: n.chapterNum });
  ee(() => {
    (R.current.book !== n.book || R.current.chapterNum !== n.chapterNum) && (R.current = { book: n.book, chapterNum: n.chapterNum }, Yt.current());
  }, [n.book, n.chapterNum]);
  const Ot = () => {
    var Y;
    const A = (Y = g.current) == null ? void 0 : Y.getElementsByClassName("editor-input")[0];
    ...
    if (Y && Gr("note", Y)) {
      ...
      O !== "x" && A === "x" ? ft == null || ft.forEach((Ct) => iu(Ct)) : O === "x" && A !== "x" && (ft == null || ft.forEach((Ct) => su(Ct))), (yt = w.current) == null || yt.applyUpdate([Y, { delete: 1 }]);
    }
  }, Mt = (A) => {
    it(A.contextMarker), K(A.canRedo);
  }, Ae = P(
    (A) => {
      var ct, nt, ht, xt, yt;
      const Y = (nt = (ct = w.current) == null ? void 0 : ct.getNoteOps(0)) == null ? void 0 : nt.at(0);
      if (Y && Gr("note", Y)) {
        ...
        if (ft || b(!1), b(
          ...
          L.current = !0, q.current = JSON.stringify(Y), S(!0);
          return;
        }
        S(JSON.stringify(Y) === q.current), vt(f, E);
      } else
        b(!1), S(!0);
    },
    [f, E, vt]
    ...
    if (m.current && Vt.length && A && A.rangeCount > 0) {
      const Y = A.getRangeAt(0).getBoundingClientRect(), ct = m.current.getBoundingClientRect();
      _t(Y.left - ct.left), tt(Y.top - ct.top), U(Y.height), W(!0);
    }
  }, [Vt, m]);
  X(() => {
    const A = () => {
    ...
    var A;
    D && ((A = st.current) == null || A.focus());
  }, [D]), X(() => {
    var ct;
    const A = ((ct = g.current) == null ? void 0 : ct.querySelector(".editor-input")) ?? void 0, Y = (nt) => {
      !D && A && document.activeElement === A && nt.key === l ? (nt.preventDefault(), Jt()) : D && nt.key === "Escape" && (nt.preventDefault(), W(!1));
    };
...
function pg({
  ...
  const w = d ?? Ds(r, void 0), g = (E, T) => {
    c == null || c(E, T, n);
  }, m = i ? r.findIndex((E) => E === i) : -1, [p, f] = I(m), y = (E, T, C) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
          E.preventDefault(), c == null || c(T, C, n);
          break;
      }
  }, v = (E) => {
    if (r.length)
      switch (E.key) {
        case "ArrowDown":
          E.preventDefault(), f((T) => Math.min(T + 1, r.length - 1));
          break;
        case "ArrowUp":
  ...
  return X(() => {
    var E;
    p >= 0 && p < z.current.length && ((E = z.current[p]) == null || E.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((E, T) => {
            ...
            return /* @__PURE__ */ u(at, { children: [
              ...
              T < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(wr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function yg({
  ...
  const p = ce(r, "%webView_inventory_all%"), f = ce(r, "%webView_inventory_approved%"), y = ce(r, "%webView_inventory_unapproved%"), v = ce(r, "%webView_inventory_unknown%"), z = ce(r, "%webView_inventory_scope_currentBook%"), E = ce(r, "%webView_inventory_scope_chapter%"), T = ce(r, "%webView_inventory_scope_verse%"), C = ce(r, "%webView_inventory_filter_text%"), j = ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), O = ce(r, "%webView_inventory_no_results%"), [k, x] = I(!1), [b, _] = I("all"), [S, V] = I(""), [K, L] = I([]), q = F(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : vu(U, n, i);
  }, [t, n, i]), D = F(() => {
    if (k) return q;
    const U = [];
    return q.forEach((ot) => {
      const it = ot.items[0], st = U.find(
        (lt) => lt.items[0] === it
      );
      st ? (st.count += ot.count, st.occurrences = st.occurrences.concat(ot.occurrences)) : U.push({
        items: [it],
        count: ot.count,
  ...
  }, [k, q]), W = F(() => D.length === 0 ? [] : mu(D, b, S), [D, b, S]), pt = F(() => {
    var it, st;
    if (!k) return d;
    const U = (it = o == null ? void 0 : o.tableHeaders) == null ? void 0 : it.length;
    if (!U) return d;
    const ot = [];
  ...
  return /* @__PURE__ */ a("div", { id: c, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (U) => $t(U), defaultValue: s, children: [
        /* @__PURE__ */ a(gr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(pr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(hr, { children: [
          /* @__PURE__ */ a(ie, { value: "book", children: z }),
          /* @__PURE__ */ a(ie, { value: "chapter", children: E }),
...
function yu({
  ...
  const [d, c] = rt.useState(t), w = e ?? d, g = rt.useCallback(
    (T) => {
      const C = typeof T == "function" ? T(w) : T;
      r ? r(C) : c(C);
    },
    [r, w]
  ), m = rt.useCallback(() => g((T) => !T), [g]), p = w ? "expanded" : "collapsed", v = bt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = rt.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
...
function Ag({
  ...
  const [c, w] = I([]), [g, m] = I([{ id: je, desc: !1 }]), [p, f] = I({}), y = F(
  ...
  X(() => {
    if (l) {
      const b = z.getSelectedRowModel().rowsById, _ = Object.keys(b);
      if (_.length === 1) {
        const S = y.find((V) => En(V) === _[0]) || void 0;
        S && l(S);
      }
    }
  }, [p, y, l, z]);
  const E = n ?? Ru, T = i ?? Gi, C = [
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(_w, { children: C.map((b) => /* @__PURE__ */ a(ie, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(_o, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Co, { children: z.getHeaderGroups().map((b) => /* @__PURE__ */ a(Ve, { children: b.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(sa, { colSpan: _.colSpan, className: "tw:sticky top-0", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Eo, { children: z.getRowModel().rows.map((b, _) => {
        const S = bt();
        return /* @__PURE__ */ a(
          Ve,
          {
            ...
            children: b.getVisibleCells().map((V) => {
              if (!(V.getIsPlaceholder() || V.column.columnDef.enableGrouping && !V.getIsGrouped() && (V.column.columnDef.id !== Ye || !r)))
                return /* @__PURE__ */ a(
                  cr,
                  {
                    className: h(
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ u(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (S === "ltr" ? /* @__PURE__ */ a(Pa, {}) : /* @__PURE__ */ a(Aa, {})),
                          " ",
                          zr(V.column.columnDef.cell, V.getContext()),
                          " (",
                          b.subRows.length,
                          ")"
                        ]
...
function ju({
  ...
  }, [v, z] = I(!1), [E, T] = I(""), C = G(void 0), j = G(!1);
  if (t.length !== wt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const O = F(() => wt.allBookIds.filter(
    ...
    (L, q = !1) => {
      ...
      const D = O.findIndex((tt) => tt === C.current), W = O.findIndex((tt) => tt === L);
      if (D === -1 || W === -1) return;
      const [pt, _t] = [
        Math.min(D, W),
        Math.max(D, W)
      ], $t = O.slice(pt, _t + 1).map((tt) => tt);
      r(
    ...
    x(L, j.current), j.current = !1;
  }, _ = (L, q) => {
    L.preventDefault(), x(q, L.shiftKey);
  }, S = P(
    (L) => {
      const q = So(O, L).map((D) => D);
      r(
        Ui(O, L, e) ? e.filter((D) => !q.includes(D)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, r, O]
  ), V = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ a(_e, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
            $e,
            {
              shouldFilter: !1,
              onKeyDown: (L) => {
                L.key === "Enter" && (j.current = L.shiftKey);
              },
              children: [
                /* @__PURE__ */ a(
                  mr,
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: V, children: d }),
...
function jg({
  ...
  const C = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = St(s, "%webView_scope_selector_verse%"), O = St(s, "%webView_scope_selector_chapter%"), k = St(s, "%webView_scope_selector_book%"), x = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), b = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), _ = St(s, "%webView_scope_selector_current_book%"), S = St(s, "%webView_scope_selector_choose_books%"), V = St(s, "%webView_scope_selector_scope%"), K = St(s, "%webView_scope_selector_select_books%"), L = St(s, "%webView_scope_selector_range%"), q = St(s, "%webView_scope_selector_select_range%"), D = St(s, "%webView_scope_selector_range_start%"), W = St(s, "%webView_scope_selector_range_end%"), pt = St(s, "%webView_scope_selector_ok%"), _t = St(s, "%webView_scope_selector_cancel%"), $t = St(s, "%webView_scope_selector_navigate%"), tt = (M) => {
    if (!f) return;
  ...
  ], U = (M, J, Ft = !1) => /* @__PURE__ */ u(at, { children: [
    M,
    J && !Ft && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), ot = e ? Rt.filter((M) => e.includes(M.value)) : Rt, it = f ?? fa, st = w ?? it, lt = g ?? it, Vt = () => {
  }, vt = G(null), Wt = G(null), Yt = G(!1), R = G(null), Ot = G(!1), [Bt, ne] = I(void 0), Xt = G(!1), Mt = G(!1), Ae = G(null), Jt = P((M) => {
    if (M) {
    ...
    (M) => {
      m == null || m(M), p == null || p(M), Xt.current = !0;
    },
    [m, p]
  ), Y = P(
    (M) => {
      p == null || p(M), Mt.current = !0;
    },
    [p]
  ), ct = P(
    (M) => {
    ...
    [r, n, f, i]
  ), nt = ot.find((M) => M.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Rs(st, lt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : nt ? U(nt.label, nt.scrRefSuffix) : t, xt = ot.filter(
    (M) => M.value !== "selectedBooks" && M.value !== "range"
  ), yt = ot.find((M) => M.value === "selectedBooks"), ft = ot.find((M) => M.value === "range"), [Ct, $] = I(!1), [ut, gt] = I(void 0), [kt, Ke] = I(void 0), [Pe, br] = I(void 0), [qe, xr] = I(void 0), [yr, Ar] = I([]), Pr = c === "dropdown" && ut === "selectedBooks", N = /* @__PURE__ */ a(
    ju,
    {
      availableBookInfo: o,
  ...
  ), H = Bt === "end", Z = Bt === "start", zt = "tw:text-muted-foreground", re = c === "dropdown" && ut === "range", or = re ? br : A, At = re ? xr : p ? Y : Vt, Nt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ba,
        {
          ...
          onCloseAutoFocus: (M) => {
            var J;
            Mt.current && (Mt.current = !1, M.preventDefault(), (J = Ae.current) == null || J.focus());
          },
          className: h(Z && zt),
          modal: !0,
          align: "start"
  ...
  const [te, He] = I(null), [jr, Zi] = I(null), [Lr, Qi] = I(null), ts = 200, [es, rs] = I(!1);
  X(() => {
    if (!Lr || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([J]) => {
      rs(J.contentRect.width < ts);
    });
    return M.observe(Lr), () => M.disconnect();
  }, [Lr]);
  const Io = P(
    (M) => {
      Ke(M), br(st), xr(lt), Ar(n), $(!1), gt(M);
    },
    [st, lt, n]
  ), Do = P(() => {
    ...
    M || (gt(void 0), Ke(void 0));
  }, []), $o = P((M) => {
    var J;
    M.preventDefault(), (J = Qt.current) == null || J.focus();
  }, []), Ro = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Be, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Et, { children: V }),
      c === "dropdown" ? /* @__PURE__ */ u(me, { open: Ct, onOpenChange: $, children: [
        ...
        /* @__PURE__ */ a(
          be,
          {
            ...
            children: /* @__PURE__ */ u(ma, { container: Lr, children: [
              xt.map(({ value: M, label: J, dropdownLabel: Ft, scrRefSuffix: Nr, id: as }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: mt(M),
                  ...
                  children: [
                    t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Be, { className: "tw:h-4 tw:w-4" }) }),
                    U(Ft ?? J, Nr, es)
                  ]
                },
                as
              ...
              y && /* @__PURE__ */ u(at, { children: [
                ...
                /* @__PURE__ */ a(
                  Je,
                  {
                    ...
                    onSelect: (M) => {
                      var J, Ft;
                      if (M.preventDefault(), Yt.current) {
                        Yt.current = !1;
                        return;
                      }
        ...
        ci,
        {
          ...
          children: ot.map(({ value: M, label: J, scrRefSuffix: Ft, id: Nr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ha, { className: "tw:me-2", value: M, id: Nr }),
            /* @__PURE__ */ a(Et, { htmlFor: Nr, children: U(J, Ft) })
          ] }, Nr))
        }
      )
    ] }),
    ...
    c === "radio" && t === "range" && Nt,
    c === "dropdown" && yt && /* @__PURE__ */ a(Ga, { open: ut === "selectedBooks", onOpenChange: Vr, children: /* @__PURE__ */ a(
      Ua,
      {
        ref: Zi,
        onCloseAutoFocus: $o,
        onEscapeKeyDown: (M) => {
          jr != null && jr.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ma, { container: jr, children: [
          ...
          /* @__PURE__ */ u(Yo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Vr(!1), children: _t }),
            /* @__PURE__ */ a(B, { onClick: Do, children: pt })
          ] })
        ] })
      }
    ) }),
    c === "dropdown" && ft && /* @__PURE__ */ a(Ga, { open: ut === "range", onOpenChange: Vr, children: /* @__PURE__ */ a(
      Ua,
      {
        ref: He,
        onCloseAutoFocus: $o,
        onEscapeKeyDown: (M) => {
          te != null && te.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ma, { container: te, children: [
          ...
          /* @__PURE__ */ u(Yo, { children: [
            /* @__PURE__ */ a(B, { variant: "outline", onClick: () => Vr(!1), children: _t }),
            /* @__PURE__ */ a(B, { ref: Ae, onClick: Do, children: pt })
          ] })
        ] })
      }
    ) })
...
const qi = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(qt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
    Je,
    {
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ a(la, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ a(la, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
...
function Qa({
  ...
  return /* @__PURE__ */ u(me, { variant: i, children: [
    /* @__PURE__ */ a(ve, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ll, {}) }) }),
    /* @__PURE__ */ a(be, { align: "start", style: { zIndex: Rr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, w) => /* @__PURE__ */ u(eo, { children: [
  ...
  if (hc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (z = d.current) == null || z.focus(), Cr(d, [m, p]);
        break;
    }
  }), X(() => {
...
function Wg({
  ...
  const c = Zu(
    ...
    var z, E, T, C, j, O;
    const v = y !== f ? ((E = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : E[y]) ?? ((C = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : C.en) : void 0;
    return v ? `${(j = t[f]) == null ? void 0 : j.autonym} (${v})` : (O = t[f]) == null ? void 0 : O.autonym;
  };
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && m && c && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(me, { children: [
              /* @__PURE__ */ a(ve, { className: h(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Fo, {}) }) }),
...
const tp = da(({ className: t, ...e }, r) => /* @__PURE__ */ a(wl, { size: 35, className: h("tw:animate-spin", t), ...e, ref: r }));
