...
import b, { forwardRef as rn, useRef as H, useMemo as K, useState as T, useCallback as z, useLayoutEffect as Qt, createContext as En, useContext as gr, useEffect as G, Component as Rs, createElement as Xr, Suspense as Ss, Fragment as _o } from "react";
import { Command as kt } from "cmdk";
import { X as $e, Search as Co, Check as Vt, Clock as Wr, ChevronsLeft as Jr, ChevronsRight as Zr, ChevronLeft as Jn, ChevronRight as Me, ArrowLeft as Ds, ArrowRight as Ms, Circle as Tn, ChevronDown as Ve, BoldIcon as Os, ItalicIcon as Is, AtSign as Eo, Pencil as As, Trash2 as Ps, ArrowUp as To, MoreHorizontal as Ro, MailOpen as Ls, Mail as $s, ChevronUp as So, FilterIcon as Vs, ArrowLeftIcon as js, ChevronLeftIcon as zs, ChevronRightIcon as Fs, ArrowRightIcon as Bs, Copy as Do, Filter as Ks, User as Gs, Link as Us, CircleHelp as Hs, ChevronsUpDown as Mo, Star as qs, SquareX as Oo, FunctionSquare as Io, SquareSigma as Ao, Ban as Ys, AlertCircle as Zn, CircleCheckIcon as Xs, CircleXIcon as Ws, CircleHelpIcon as Js, ArrowUpIcon as Zs, ArrowDownIcon as Qs, PanelLeft as ti, PanelRight as ei, ScrollText as ni, MenuIcon as ri, Menu as oi, EllipsisVertical as ai, LoaderCircle as si, GripVertical as ii } from "lucide-react";
import { clsx as li } from "clsx";
import { extendTailwindMerge as ci } from "tailwind-merge";
import * as Dt from "@radix-ui/react-dialog";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as wn, Section as q, getChaptersForBook as di, formatScrRef as ve, getSectionForBook as qe, formatRelativeDate as wi, formatReplacementString as be, sanitizeHtml as pi, NumberFormat as ui, formatBytes as mi, getCurrentLocale as fi, usfmMarkers as hn, getFormatCallerFunction as hi, deepEqual as gi, isString as Qr, compareScrRefs as Qn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import { createEditor as Lo, $getRoot as le, $createParagraphNode as Rn, $getSelection as $t, HISTORY_MERGE_TAG as br, ParagraphNode as $o, TextNode as Vo, $isTokenOrSegmented as bi, $getCharacterOffsets as vi, $cloneWithPropertiesEphemeral as xi, $findMatchingParent as jo, $isElementNode as se, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as zo, COMMAND_PRIORITY_EDITOR as Fo, mergeRegister as ce, shallowMergeConfig as yi, defineExtension as Ht, safeCast as on, createState as Ni, FORMAT_TEXT_COMMAND as Bo, $isNodeSelection as Ko, COMMAND_PRIORITY_LOW as Go, RootNode as ki, LineBreakNode as _i, TabNode as Ci, $isEditorState as Ei, createCommand as Ti, CLICK_COMMAND as Ri, isDOMNode as Si, $getNodeFromDOMNode as Di, $createNodeSelection as Mi, $setSelection as Oi, DecoratorNode as tr, $getState as Ii, toggleTextFormatType as to, TEXT_TYPE_TO_FORMAT as Ai, $setState as Pi, addClassNamesToElement as Uo, $create as Li, $getNodeByKey as $i, removeClassNamesFromElement as Vi, KEY_TAB_COMMAND as ji, $isBlockElementNode as xn, $createRangeSelection as zi, $normalizeSelection__EXPERIMENTAL as Fi, OUTDENT_CONTENT_COMMAND as Bi, INDENT_CONTENT_COMMAND as eo, INSERT_TAB_COMMAND as Ki, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Gi, $isParagraphNode as Ui, $isTextNode as yn, SELECTION_CHANGE_COMMAND as Ho, getRegisteredNode as Hi, isHTMLElement as qi, isDocumentFragment as no, isDOMDocumentNode as Yi, ArtificialNode__DO_NOT_USE as qo, $createLineBreakNode as Yo, $isRootOrShadowRoot as Xi, isBlockDomNode as ro, isInlineDomNode as oo, $insertNodes as Wi } from "lexical";
...
import { useReactTable as Zo, getFilteredRowModel as al, getSortedRowModel as Qo, getPaginationRowModel as sl, getCoreRowModel as ta, flexRender as Ye, getGroupedRowModel as il, getExpandedRowModel as ll } from "@tanstack/react-table";
import * as ct from "@radix-ui/react-select";
import cl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as er, HIDDEN_NOTE_CALLER as nr, getDefaultViewOptions as dl, isInsertEmbedOpOfType as pn, Editorial as wl } from "@eten-tech-foundation/platform-editor";
...
const ea = Dt.Root, na = Dt.Portal, yr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: n,
    className: m(
...
oa.displayName = kt.Separator.displayName;
...
aa.displayName = "CommandShortcut";
const sa = (t, e, n, o, a) => {
  switch (t) {
    case q.OT:
...
const la = rn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? je : "button", { className: m(ca({ variant: e, size: n, className: t })), ref: s, ...a })
);
F.displayName = "Button";
const sn = 250, da = 300, Rr = 400, gl = 450, bl = 500, Yt = Ne.Root, pe = Ne.Trigger, wa = Ne.Anchor, zt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = wt();
          ...
          v === "books" ? /* @__PURE__ */ w("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(Ds, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ms, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Po.Root, { ref: n, className: m("pr-twp", kl(), t), ...e }));
ft.displayName = Po.Root.displayName;
...
function Rl({ initialConfig: t, children: e }) {
  const n = K(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, c = El(null, o), p = Lo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function Vl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !bi(e) && o !== null) {
    ...
    if (c || p) {
      const [u, h] = vi(t), f = l.is(d), g = e.is(i ? d : l), x = e.is(i ? l : d);
      let v, y = 0;
...
function Hl(t) {
  ...
  ha(this), J = t, this.f &= -2, 8 & this.f && Or(this), Dn();
}
function Se(t, e) {
...
vt.prototype.brand = Kl, vt.prototype.h = function() {
  ...
  if (this.g = gn, this.f |= 1, this.i > 0 && !fa(this)) return this.f &= -2, !0;
  const t = J;
  try {
    co(this), J = this;
    const e = this.x();
...
function va(t, e = ba) {
  return t.registerCommand(zo, (n) => (t.update(e), !0), Fo);
}
Ht({ build: (t, e, n) => Mn(e), config: on({ $onClear: ba }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const dr = Ht({ build: (t) => ya(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Ql = Ht({ config: on({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class We {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Gn(s) || nt(300, i, a || "[unknown]"), Gn(l = s) || nt(304, String(l.id), String(Ir)), s = Object.assign(l, { id: wr }), o.state = s;
...
const ec = /* @__PURE__ */ new Set(), mo = Ht({ build(t, e, n) {
  const o = n.getDependency(dr).output, a = Qe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ya(() => {
  }, () => de(() => {
...
Ht({ dependencies: [dr, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Oe], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(mo).output, a = Qe({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ce(t.registerCommand(Ri, (i) => {
    if (Si(i.target)) {
      ...
      if (rc(l)) return function(d, c = !1) {
        ...
        let f;
        c && Ko(p) ? f = p : (f = Mi(), Oi(f)), u ? f.delete(h) : f.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Go), t.registerMutationListener(Oe, (i, l) => {
    Gl(() => {
      let d = !1;
  ...
  return ce(t.registerCommand(ji, (o) => {
    ...
    const s = function(i) {
      ...
      if (u.canIndent()) {
        const h = u.getKey();
        let f = zi();
        if (f.anchor.set(h, 0, "element"), f.focus.set(h, 0, "element"), f = Fi(f), f.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Bi : eo : Ki;
    return t.dispatchCommand(s, void 0);
  }, Fo), t.registerCommand(eo, () => {
...
function _c() {
  const [t, e] = T(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ r(ea, { open: !0, onOpenChange: n, children: /* @__PURE__ */ w(ra, { children: [
...
const Oa = we(
  ...
  {
    ref: a,
    className: m(Oa({ variant: e, size: n, className: t })),
    ...o
  }
));
...
Pr.displayName = Sn.Root.displayName;
...
function Oc(t, e) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof qo && i.insertAfter(Yo());
    for (const i of s) {
...
function Aa(t, e, n, o = null) {
  ...
  const l = se(i) ? i.getChildren() : [], d = Hi(t, i.getType());
  let c;
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : $r(y) && (y.preventDefault(), y.stopPropagation(), At(a) && h());
        },
        onKeyDown: (y) => {
          ...
          o && /* @__PURE__ */ w(et, { children: [
            ...
            v !== !1 && (!A || At(R)) && /* @__PURE__ */ w(
              "div",
              {
                ...
                onKeyDownCapture: (O) => {
                  $r(O) && (O.preventDefault(), O.stopPropagation(), (At(R) || C !== void 0) && Hr());
                },
                onKeyDown: (O) => {
...
Ya.displayName = ct.ScrollUpButton.displayName;
...
Xa.displayName = ct.ScrollDownButton.displayName;
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ w("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Do, {}) })
        ] }),
...
function hd({
  ...
  return /* @__PURE__ */ w(ue, { children: [
    ...
    /* @__PURE__ */ w(oe, { style: { zIndex: da }, children: [
        ...
        return /* @__PURE__ */ w(
          qt,
          {
            ...
            children: [
              ...
              (i.isDisallowed || i.isDeprecated) && /* @__PURE__ */ r(aa, { className: "tw-font-sans", children: i.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
const Za = "OK", $d = "Cancel", Vd = "Alert", jd = "Confirm", zd = "Dialog";
function Fd({
  options: t,
  onOk: e
}) {
...
function wu({
  ...
  return /* @__PURE__ */ r(ea, { open: !0, onOpenChange: l, children: /* @__PURE__ */ w(na, { children: [
    /* @__PURE__ */ r(
      yr,
      {
    ...
    /* @__PURE__ */ w(
      Dt.Content,
      {
        ...
        children: [
          /* @__PURE__ */ r(Nr, { children: /* @__PURE__ */ r(_r, { children: c }) }),
          Ud(t, e, s, i)
        ]
      }
    )
...
function pu({
  ...
  return /* @__PURE__ */ w(Yt, { open: !0, onOpenChange: d, children: [
    /* @__PURE__ */ r(wa, { asChild: !0, children: /* @__PURE__ */ r(
      "div",
      {
...
function Cw({
  ...
  const s = Ur(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function Ew({
  ...
  const $ = K(() => dt.allBookIds.filter(
    ...
    (A) => {
      const Y = Ur($, A).map((M) => M);
      n(
        ls($, A, e) ? e.filter((M) => !Y.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...Y])]
      );
    },
    [e, n, $]
  ), j = () => {
                  ...
                  Object.values(q).map((A, Y) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ w(_o, { children: [
                        ...
                        Y < Object.values(q).length - 1 && /* @__PURE__ */ r(oa, {})
                      ] }, A);
                  })
                ] })
              ]
...
const Ue = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(ys, {}, `separator-${s}`)), d;
  });
};
function Iw({
  menuData: t,
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ w(ue, { children: [
              /* @__PURE__ */ r(Ee, { className: m(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Ro, {}) }) }),
