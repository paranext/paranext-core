import { jsx as O, jsxs as ve, Fragment as pt } from "react/jsx-runtime";
import { Button as Eo, Autocomplete as xo, TextField as Cr, FormControlLabel as At, FormLabel as To, Checkbox as ko, MenuItem as Pr, ListItemText as So, ListItemIcon as wo, Menu as Oo, Grid as Rr, List as Co, IconButton as Nr, Paper as Po, Slider as Ro, Snackbar as No, Switch as $o, AppBar as _o, Toolbar as Io, Drawer as Mo } from "@mui/material";
import * as S from "react";
import en, { useMemo as ht, useState as De, useCallback as Tn, useRef as ot, useEffect as In } from "react";
...
function Sl({
  ...
  return /* @__PURE__ */ ve(pt, { children: [
    /* @__PURE__ */ O(
      At,
      {
...
function Wo(e) {
  ...
  return /* @__PURE__ */ O(
    Pr,
    {
      ...
      onClick: n,
      id: b,
      children: t ? /* @__PURE__ */ ve(pt, { children: [
        Lt(o, t, !0),
...
function Jo({
  ...
  const a = Array.from(i.values()).sort((c, l) => (c.metadata.order || 0) - (l.metadata.order || 0));
  return /* @__PURE__ */ O(
    Rr,
    {
      container: !0,
...
function ei() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var _ = a, N = i, H = e, J = l, Y = t, q = f, W = p, ee = n, A = o, R = r, $ = u, D = d, ie = !1, Z = !1;
    function v(k) {
    ...
    te.ContextConsumer = _, te.ContextProvider = N, te.Element = H, te.ForwardRef = J, te.Fragment = Y, te.Lazy = q, te.Memo = W, te.Portal = ee, te.Profiler = A, te.StrictMode = R, te.Suspense = $, te.SuspenseList = D, te.isAsyncMode = v, te.isConcurrentMode = P, te.isContextConsumer = I, te.isContextProvider = V, te.isElement = M, te.isForwardRef = F, te.isFragment = j, te.isLazy = L, te.isMemo = G, te.isPortal = K, te.isProfiler = z, te.isStrictMode = de, te.isSuspense = C, te.isSuspenseList = U, te.isValidElementType = w, te.typeOf = m;
  }()), te;
}
process.env.NODE_ENV === "production" ? st.exports = Qo() : st.exports = ei();
var On = st.exports, at = { exports: {} }, En = { exports: {} }, re = {};
...
function ti() {
  return Ut || (Ut = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = l, _ = u, N = c, H = a, J = n, Y = d, q = r, W = y, ee = b, A = t, R = i, $ = o, D = p, ie = !1;
    function Z(C) {
    ...
    oe.AsyncMode = m, oe.ConcurrentMode = _, oe.ContextConsumer = N, oe.ContextProvider = H, oe.Element = J, oe.ForwardRef = Y, oe.Fragment = q, oe.Lazy = W, oe.Memo = ee, oe.Portal = A, oe.Profiler = R, oe.StrictMode = $, oe.Suspense = D, oe.isAsyncMode = Z, oe.isConcurrentMode = v, oe.isContextConsumer = P, oe.isContextProvider = I, oe.isElement = V, oe.isForwardRef = M, oe.isFragment = F, oe.isLazy = j, oe.isMemo = L, oe.isPortal = G, oe.isProfiler = K, oe.isStrictMode = z, oe.isSuspense = de, oe.isValidElementType = E, oe.typeOf = w;
  }()), oe;
}
var Ht;
function _r() {
  return Ht || (Ht = 1, process.env.NODE_ENV === "production" ? En.exports = ni() : En.exports = ti()), En.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function ri() {
  ...
  return qn = o() ? Object.assign : function(i, a) {
...
var Gn, Gt;
function Ir() {
  return Gt || (Gt = 1, Gn = Function.call.bind(Object.prototype.hasOwnProperty)), Gn;
}
var Kn, Kt;
function oi() {
  if (Kt)
...
Valid keys: ` + JSON.stringify(Object.keys(v), null, "  ")
    ...
    function $(v) {
      var P = typeof v;
      return Array.isArray(v) ? "array" : v instanceof RegExp ? "object" : R(P, v) ? "symbol" : P;
    }
    function D(v) {
...
const Br = gn(s.element, Dr);
Br.isRequired = gn(s.element.isRequired, Dr);
const Mn = Br;
function di(e) {
  const {
    prototype: n = {}
...
const pi = gn(s.elementType, fi), hi = "exact-prop: ​";
function jr(e) {
...
const xi = typeof window < "u" ? S.useLayoutEffect : S.useEffect, Cn = xi;
function Qt(e) {
  const n = S.useRef(e);
  return Cn(() => {
    n.current = e;
...
zr.isRequired = Vr;
lt.isRequired = lt;
const Ur = process.env.NODE_ENV === "production" ? lt : zr;
function Hr(e, n) {
  const t = x({}, n);
...
function Pn(e, n, t, r = t) {
  let o;
  return typeof e == "function" ? o = e(t) : Array.isArray(e) ? o = e[t] || r : o = An(e, t) || r, n && (o = n(o, r, e)), o;
}
function ue(e) {
  const {
    prop: n,
    ...
    if (a[n] == null)
      return null;
    const c = a[n], l = a.theme, u = An(l, r) || {};
    return Ce(a, c, (p) => {
      let f = Pn(u, o, p);
      return p === f && typeof p == "string" && (f = Pn(u, o, `${n}${p === "default" ? "" : Be(p)}`, p)), t === !1 ? f : {
        [t]: f
      };
    });
  };
...
}), Dn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Bn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Yi = [...Dn, ...Bn];
function bn(e, n, t, r) {
  var o;
  const i = (o = An(e, n, !1)) != null ? o : t;
...
function Xr(e, n) {
  const t = Kr(e.theme);
  return Object.keys(e).map((r) => Zi(e, n, r, t)).reduce(dn, {});
}
function ce(e) {
  return Xr(e, Dn);
}
ce.propTypes = process.env.NODE_ENV !== "production" ? Dn.reduce((e, n) => (e[n] = _e, e), {}) : {};
ce.filterProps = Dn;
function le(e) {
  return Xr(e, Bn);
}
le.propTypes = process.env.NODE_ENV !== "production" ? Bn.reduce((e, n) => (e[n] = _e, e), {}) : {};
le.filterProps = Bn;
...
const es = Ee("border", be), ns = Ee("borderTop", be), ts = Ee("borderRight", be), rs = Ee("borderBottom", be), os = Ee("borderLeft", be), is = Ee("borderColor"), ss = Ee("borderTopColor"), as = Ee("borderRightColor"), cs = Ee("borderBottomColor"), ls = Ee("borderLeftColor"), us = Ee("outline", be), ds = Ee("outlineColor"), Ln = (e) => {
...
jn(es, ns, ts, rs, os, is, ss, as, cs, ls, Ln, us, ds);
const Fn = (e) => {
...
jn(Fn, Vn, zn, fs, ps, hs, ms, gs, bs, ys, vs, Es);
function nn(e, n) {
  return n === "grey" ? n : e;
}
const xs = ue({
...
function Is() {
  function e(t, r, o, i) {
    ...
    return p ? p(a) : Ce(a, r, (y) => {
      let g = Pn(f, d, y);
      return y === g && typeof y == "string" && (g = Pn(f, d, `${t}${y === "default" ? "" : Be(y)}`, y)), l === !1 ? g : {
        [l]: g
      };
    });
  }
...
function Ws(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, c = {}) => {
    ...
    const B = Ao(a, x({
      shouldForwardProp: T,
      label: h
    }, b)), E = (m) => typeof m == "function" && m.__emotion_real !== m || Ae(m) ? (_) => Sn(m, x({}, _, {
      theme: xn({
        theme: _.theme,
        defaultTheme: t,
        themeId: n
      ...
      l && f && H.push((q) => {
        ...
        return Object.entries(ee).forEach(([R, $]) => {
          A[R] = Sn($, x({}, q, {
            theme: W
          }));
        }), f(q, A);
...
function Ys(e) {
  ...
  return e.type === "hsla" && (c += "a", l.push(n[3])), Un({
    type: c,
    values: l
  });
}
...
function lr(e, n) {
  return e = je(e), n = kt(n), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${n}` : e.values[3] = n, Un(e);
}
function Js(e, n) {
...
function ga(e) {
  ...
  function p(g) {
    const h = cr(g, Jn.text.primary) >= t ? Jn.text.primary : ur.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const T = cr(g, h);
...
const Na = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, $a = Na, _a = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Ia(e = {}, ...n) {
  const {
    mixins: t = {},
    palette: r = {},
...
const Ma = Ia(), St = Ma, wt = "$$material", Zr = (e) => kn(e) && e !== "classes", Aa = Ws({
  themeId: wt,
  defaultTheme: St,
...
const to = /* @__PURE__ */ S.forwardRef(function(n, t) {
  ...
  const g = (E) => {
    ...
    if (m === "ArrowDown")
      E.preventDefault(), cn(w, _, u, l, Zn);
    else if (m === "ArrowUp")
      E.preventDefault(), cn(w, _, u, l, mr);
    else if (m === "Home")
      E.preventDefault(), cn(w, null, u, l, Zn);
    else if (m === "End")
      E.preventDefault(), cn(w, null, u, l, mr);
    else if (m.length === 1) {
      const N = y.current, H = m.toLowerCase(), J = performance.now();
      N.keys.length > 0 && (J - N.lastTime > 500 ? (N.keys = [], N.repeating = !0, N.previousKeyMatched = !0) : N.repeating && H !== N.keys[0] && (N.repeating = !1)), N.lastTime = J, N.keys.push(H);
      const Y = _ && !N.repeating && no(_, N);
      N.previousKeyMatched && (Y || cn(w, _, !1, l, Zn, N)) ? E.preventDefault() : N.previousKeyMatched = !1;
    }
    d && d(E);
  }, h = $e(b, t);
  let T = -1;
...
`)), y.current.setAttribute("tabIndex", "-1")), b.current && y.current.focus()), () => {
    ...
    if (!c || !y.current)
      return;
    const E = ye(y.current), w = (N) => {
      h.current = N, !(r || !a() || N.key !== "Tab") && E.activeElement === y.current && N.shiftKey && (l.current = !0, d.current && d.current.focus());
    }, m = () => {
      const N = y.current;
      if (N === null)
        return;
      ...
      if (N.contains(E.activeElement) || r && E.activeElement !== u.current && E.activeElement !== d.current)
        return;
...
const Nn = /* @__PURE__ */ S.forwardRef(function(n, t) {
  const {
    children: r,
    container: o,
    disablePortal: i = !1
...
class nc {
  ...
  add(n, t) {
    ...
    const i = Qn(this.containers, (a) => a.container === t);
  ...
  mount(n, t) {
    const r = Qn(this.containers, (i) => i.modals.indexOf(n) !== -1), o = this.containers[r];
  ...
  remove(n, t = !0) {
    ...
    if (r === -1)
      return r;
    const o = Qn(this.containers, (a) => a.modals.indexOf(n) !== -1), i = this.containers[o];
    if (i.modals.splice(i.modals.indexOf(n), 1), this.modals.splice(r, 1), i.modals.length === 0)
      i.restore && i.restore(), n.modalRef && fn(n.modalRef, t), br(i.container, n.mount, n.modalRef, i.hiddenSiblings, !1), this.containers.splice(o, 1);
    else {
...
function ic(e) {
  ...
  const w = () => ye(b.current), m = () => (f.current.modalRef = y.current, f.current.mount = b.current, f.current), _ = () => {
    ...
    b.current = $, $ && (d && H() ? _() : y.current && fn(y.current, E));
  }), Y = S.useCallback(() => {
    o.remove(m(), E);
  }, [E, o]);
  S.useEffect(() => () => {
...
var cc = function(n) {
  return n.scrollTop;
}, un = "unmounted", Ie = "exited", Me = "entering", Ze = "entered", dt = "exiting", Re = /* @__PURE__ */ function(e) {
  sc(n, e);
  function n(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var a = o, c = a && !a.isMounting ? r.enter : r.appear, l;
    return i.appearStatus = null, r.in ? c ? (l = Ie, i.appearStatus = Me) : l = Ze : r.unmountOnExit || r.mountOnEnter ? l = un : l = Ie, i.state = {
      status: l
  ...
  return t.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? a !== Me && a !== Ze && (i = Me) : (a === Me || a === Ze) && (i = dt);
    }
...
const uc = {
...
}, et = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Ot = /* @__PURE__ */ S.forwardRef(function(n, t) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = n, T = ae(n, lc), B = wi(), E = S.useRef(), w = Hn(), m = S.useRef(null), _ = $e(m, i.ref, t), N = (R) => ($) => {
    if (R) {
      const D = m.current;
      $ === void 0 ? R(D) : R(D, $);
    }
    ...
    let v;
    g === "auto" ? (v = w.transitions.getAutoHeightDuration(R.clientHeight), E.current = v) : v = D, R.style.transition = [w.transitions.create("opacity", {
      duration: v,
      delay: ie
    }), w.transitions.create("transform", {
      duration: et ? v : v * 0.666,
      delay: ie,
      easing: Z
    })].join(","), l && l(R, $);
  }), Y = N(u), q = N(b), W = N((R) => {
    ...
    let Z;
    g === "auto" ? (Z = w.transitions.getAutoHeightDuration(R.clientHeight), E.current = Z) : Z = $, R.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: D
    }), w.transitions.create("transform", {
      duration: et ? Z : Z * 0.666,
      delay: et ? D : D || Z * 0.333,
      easing: ie
    })].join(","), R.style.opacity = 0, R.style.transform = ft(0.75), p && p(R);
  }), ee = N(f);
  return /* @__PURE__ */ O(h, x({
    ...
    onExiting: q,
    addEndListener: (R) => {
      g === "auto" && B.start(E.current || 0, R), r && r(m.current, R);
    },
    timeout: g === "auto" ? null : g
  }, T, {
    children: (R, $) => /* @__PURE__ */ S.cloneElement(i, x({
      style: x({
        opacity: 0,
        transform: ft(0.75),
        visibility: R === "exited" && !c ? "hidden" : void 0
      }, uc[R], y, i.props.style),
      ref: _
    }, $))
  }));
});
...
const dc = Ot, fc = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], pc = {
  ...
  const r = Hn(), o = {
  ...
  } = n, E = ae(n, fc), w = S.useRef(null), m = $e(w, c.ref, t), _ = (A) => (R) => {
    if (A) {
      const $ = w.current;
      R === void 0 ? A($) : A($, R);
    }
    ...
    A.style.webkitTransition = r.transitions.create("opacity", $), A.style.transition = r.transitions.create("opacity", $), d && d(A, R);
  }), J = _(p), Y = _(g), q = _((A) => {
    const R = $n({
      style: h,
      timeout: T,
    ...
    A.style.webkitTransition = r.transitions.create("opacity", R), A.style.transition = r.transitions.create("opacity", R), b && b(A);
  }), W = _(y);
  return /* @__PURE__ */ O(B, x({
    ...
    children: (A, R) => /* @__PURE__ */ S.cloneElement(c, x({
      style: x({
        opacity: 0,
...
const xc = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Tc = (e) => {
  ...
  const L = (r = (o = A == null ? void 0 : A.root) != null ? o : T.Root) != null ? r : kc, G = (i = (a = A == null ? void 0 : A.backdrop) != null ? a : T.Backdrop) != null ? i : d, K = (c = ee == null ? void 0 : ee.root) != null ? c : B.root, z = (l = ee == null ? void 0 : ee.backdrop) != null ? l : B.backdrop, de = rn({
    elementType: L,
    externalSlotProps: K,
  ...
  return !Y && !W && (!V || I) ? null : /* @__PURE__ */ O(Nn, {
    ref: v,
    container: g,
    disablePortal: _,
...
const Pc = ["className", "component", "elevation", "square", "variant"], Rc = (e) => {
  const {
    square: n,
    elevation: t,
    variant: r,
...
const Dc = (e) => {
  ...
  const a = ze({
  ...
  } = a, Y = ae(a.TransitionProps, Ic), q = ae(a, Mc), W = (r = w == null ? void 0 : w.paper) != null ? r : B, ee = S.useRef(), A = $e(ee, W.ref), R = x({}, a, {
    anchorOrigin: u,
    anchorReference: p,
    elevation: g,
    marginThreshold: h,
    ...
    TransitionProps: Y
  }), $ = Dc(R), D = S.useCallback(() => {
    if (p === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const U = wn(l), k = U && U.nodeType === 1 ? U : ye(ee.current).body, fe = k.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const $t = Se + k.height, _t = Ue + k.width, It = hn(wn(l)), sn = It.innerHeight - h, Mt = It.innerWidth - h;
    if (h !== null && Se < h) {
      const xe = Se - h;
    ...
    if (process.env.NODE_ENV !== "production" && k.height > sn && k.height && sn && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${k.height - sn}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), h !== null && Ue < h) {
      const xe = Ue - h;
  ...
  let F = N;
  N === "auto" && !_.muiSupportAuto && (F = void 0);
  const j = y || (l ? ye(wn(l)).body : void 0), L = (o = E == null ? void 0 : E.root) != null ? o : Bc, G = (i = E == null ? void 0 : E.paper) != null ? i : uo, K = rn({
    elementType: G,
...
const Fc = ["onEntering"], Vc = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], zc = {
  ...
  const i = ze({
    ...
    slots: B = {},
    slotProps: E = {}
  } = i, w = ae(i.TransitionProps, Fc), m = ae(i, Vc), _ = Hn(), N = _.direction === "rtl", H = x({}, i, {
    autoFocus: a,
  ...
  S.Children.map(c, (Z, v) => {
    /* @__PURE__ */ S.isValidElement(Z) && (process.env.NODE_ENV !== "production" && On.isFragment(Z) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), Z.props.disabled || (T === "selectedMenu" && Z.props.selected || A === -1) && (A = v));
  });
  const R = (r = B.paper) != null ? r : Wc, $ = (o = E.paper) != null ? o : b, D = rn({
    elementType: B.root,
...
function Ol(e) {
  var u;
  const { className: n, commandHandler: t, menuDefinition: r, children: o } = e, [i, a] = en.useState(void 0), c = (d) => {
    d.preventDefault(), a(
      i === void 0 ? {
        mouseX: d.clientX + 2,
        mouseY: d.clientY - 6
  ...
  return (((u = r == null ? void 0 : r.items) == null ? void 0 : u.length) ?? 0) === 0 || !o ? o : /* @__PURE__ */ ve(
    "div",
    {
...
X(he, "Original", new he(Ne.Original)), X(he, "Septuagint", new he(Ne.Septuagint)), X(he, "Vulgate", new he(Ne.Vulgate)), X(he, "English", new he(Ne.English)), X(he, "RussianProtestant", new he(Ne.RussianProtestant)), X(he, "RussianOrthodox", new he(Ne.RussianOrthodox));
let Qe = he;
function Sr(e, n) {
  const t = n[0];
  ...
  parse(n) {
    if (n = n.replace(this.rtlMark, ""), n.includes("/")) {
      ...
      if (n = i[0], i.length > 1)
        try {
          const a = +i[1].trim();
          this.versification = new Qe(Ne[a]);
        } catch {
          throw new ln("Invalid reference : " + n);
        }
    }
...
let nt;
const tt = () => (nt || (nt = ke.allBookIds.map((e) => ({
  bookId: e,
...
function Pl({ scrRef: e, handleSubmit: n, id: t }) {
  ...
  return /* @__PURE__ */ ve("span", { id: t, children: [
    ...
    /* @__PURE__ */ O(
      ...
      {
        onClick: () => r(Dt(e, 1)),
        isDisabled: e.bookNum >= tt().length,
        children: ">"
      }
    ),
    /* @__PURE__ */ O(
...
function Rl({ onSearch: e, placeholder: n, isFullWidth: t }) {
  const [r, o] = De(""), i = (a) => {
    o(a), e(a);
  };
...
function wr({ onRowChange: e, row: n, column: t }) {
  ...
  return /* @__PURE__ */ O(_n, { defaultValue: n[t.key], onChange: r });
}
...
function Il({
  ...
  const ee = ht(() => {
    const A = e.map((R) => typeof R.editable == "function" ? {
      ...R,
      editable: (D) => !!R.editable(D),
      renderEditCell: R.renderEditCell || wr
    } : R.editable && !R.renderEditCell ? { ...R, renderEditCell: wr } : R.renderEditCell && !R.editable ? { ...R, editable: !1 } : R);
...
}), Nt = /* @__PURE__ */ S.forwardRef(function(n, t) {
  const r = ze({
    props: n,
    name: "MuiSvgIcon"
  }), {
