...
import c, { forwardRef as Yt, createContext as Jn, useContext as Kn, useCallback as tt, useState as O, useRef as K, useEffect as lt, useLayoutEffect as Fe, useMemo as W, Fragment as Wn } from "react";
...
import { DropdownMenuTrigger as tr } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as be, Check as St, Circle as ve, X as xe, Search as qe, ChevronsUpDown as Je, FilterIcon as er, ChevronDown as Ht, ChevronUp as nr, ArrowLeftIcon as rr, ChevronLeftIcon as ar, ChevronRightIcon as or, ArrowRightIcon as sr, LoaderCircle as ir, Download as wr, Filter as lr, User as dr, Link as cr, CircleHelp as pr, Star as ur, CircleCheckIcon as mr, CircleXIcon as hr, CircleHelpIcon as gr, ArrowUpIcon as fr, ArrowDownIcon as br, ArrowUpDownIcon as vr, PanelLeft as xr, PanelRight as yr, ScrollText as Nr, ChevronLeft as kr, MenuIcon as Cr, Menu as Sr, EllipsisVertical as Rr } from "lucide-react";
import { formatScrRef as Vt, getChaptersForBook as Tr, NumberFormat as _r, formatBytes as zr, deepEqual as ye, isString as ae, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
import { useReactTable as We, getFilteredRowModel as Er, getSortedRowModel as Ze, getPaginationRowModel as Dr, getCoreRowModel as Qe, flexRender as Bt, getGroupedRowModel as Ir, getExpandedRowModel as Mr } from "@tanstack/react-table";
import * as j from "@radix-ui/react-select";
import Vr from "markdown-to-jsx";
import * as ce from "@radix-ui/react-checkbox";
import * as Ut from "@radix-ui/react-toggle-group";
...
import { useHotkeys as Br } from "react-hotkeys-hook";
import * as Tt from "@radix-ui/react-avatar";
import { Drawer as et } from "vaul";
import * as gt from "@radix-ui/react-scroll-area";
import { Toaster as Pr } from "sonner";
import { toast as Qs } from "sonner";
import * as Mt from "@radix-ui/react-slider";
import * as pe from "@radix-ui/react-switch";
const Ar = Qn({ prefix: "tw-" });
function w(...t) {
  return Ar(Zn(t));
}
...
const ke = V.Trigger, nn = V.Group, jr = V.Portal, Fr = V.Sub, ls = V.RadioGroup;
function qt({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ne.Provider, { value: n, children: /* @__PURE__ */ r(V.Root, { ...e }) });
}
...
rn.displayName = V.SubTrigger.displayName;
...
an.displayName = V.SubContent.displayName;
const jt = c.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = F();
...
jt.displayName = V.Content.displayName;
...
Ce.displayName = V.Item.displayName;
const Se = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    V.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(V.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Se.displayName = V.CheckboxItem.displayName;
const on = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    V.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(V.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
on.displayName = V.RadioItem.displayName;
const Jt = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  V.Label,
  {
    ref: a,
...
Jt.displayName = V.Label.displayName;
...
var $r = Object.defineProperty, Lr = (t, e, n) => e in t ? $r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, S = (t, e, n) => Lr(t, typeof e != "symbol" ? e + "" : e, n);
const ft = [
  "GEN",
  "EXO",
  "LEV",
...
const Y = class _ {
  constructor(e, n, a, o) {
    if (S(this, "firstChapter"), S(this, "lastChapter"), S(this, "lastVerse"), S(this, "hasSegmentsDefined"), S(this, "text"), S(this, "BBBCCCVVVS"), S(this, "longHashCode"), S(this, "versification"), S(this, "rtlMark", "‏"), S(this, "_bookNum", 0), S(this, "_chapterNum", 0), S(this, "_verseNum", 0), S(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, l = n != null && n instanceof mt ? n : void 0;
        ...
        if (e != null && e instanceof _) {
          ...
          if (e == null) return;
          const s = e instanceof mt ? e : _.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return l && (p = new mt(l)), n ? new _(n, a.toString(), i, p) : new _();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const l = +s[1].trim();
          this.versification = new mt(rt[l]);
        } catch {
          throw new Et("Invalid reference : " + e);
        }
    }
  ...
  allVerses(e = !1, n = _.verseRangeSeparators, a = _.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = $e(this._verse, a);
    for (const l of s.map((i) => $e(i, n))) {
      const i = this.clone();
      i.verse = l[0];
      const p = i.verseNum;
...
S(Y, "defaultVersification", mt.English), S(Y, "verseRangeSeparator", "-"), S(Y, "verseSequenceIndicator", ","), S(Y, "verseRangeSeparators", [Y.verseRangeSeparator]), S(Y, "verseSequenceIndicators", [Y.verseSequenceIndicator]), S(Y, "chapterDigitShifter", 1e3), S(Y, "bookDigitShifter", Y.chapterDigitShifter * Y.chapterDigitShifter), S(Y, "bcvMaxValue", Y.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
S(Y, "ValidStatusType", pn);
...
const ze = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), ra = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Le = ["OT", "NT", "DC"], aa = 96, oa = [
  /^(\w+)$/i,
...
], Dt = (t) => Tr(X.bookIdToNumber(t));
function sa() {
  return ze.map((e) => X.bookIdToEnglishName(e));
}
function ia(t) {
...
function wa(t) {
  ...
  if (ia(e))
    return ze.find((a) => X.bookIdToEnglishName(a) === e);
}
function cs({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = F(), [s, l] = O(""), [i, p] = O(t.book), [u, h] = O(t.chapterNum ?? 0), [b, g] = O(t.book), [m, y] = O(!1), [z, k] = O(m), x = K(void 0), N = K(void 0), E = K(void 0), $ = tt(
    (C) => {
      const D = a ? a() : ze;
      return {
        OT: D.filter((A) => X.isBookOT(A)),
        NT: D.filter((A) => X.isBookNT(A)),
        DC: D.filter((A) => X.isBookDC(A))
      }[C].filter((A) => {
        const f = X.bookIdToEnglishName(A).toLowerCase(), T = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (C, D, A, f) => {
      if (h(t.book !== C ? 1 : t.chapterNum), D || Dt(C) === -1) {
        e({
          book: C,
          chapterNum: A ?? 1,
          verseNum: f ?? 1
    ...
    oa.forEach((C) => {
      const D = C.exec(s);
      if (D) {
        const [A, f = void 0, T = void 0] = D.slice(1), Z = wa(A);
        (X.isBookIdValid(A) || Z) && v(
          Z ?? A,
          !0,
          f ? parseInt(f, 10) : 1,
          T ? parseInt(T, 10) : 1
    ...
    const { key: D } = C;
    D === "ArrowRight" || D === "ArrowLeft" || D === "ArrowDown" || D === "ArrowUp" || D === "Enter" || x.current.dispatchEvent(new KeyboardEvent("keydown", { key: D }));
  }, re = (C) => {
    const { key: D } = C;
    if (b === i) {
      if (D === "Enter") {
      ...
      const A = D === "ArrowRight" && !o || D === "ArrowRight" && o === "ltr" || D === "ArrowLeft" && o === "rtl", f = D === "ArrowLeft" && !o || D === "ArrowLeft" && o === "ltr" || D === "ArrowRight" && o === "rtl";
      let T = 0;
      if (A)
        if (u < Dt(b))
          T = 1;
      ...
      else D === "ArrowDown" ? T = 6 : D === "ArrowUp" && (T = -6);
      u + T <= 0 || u + T > Dt(b) ? h(0) : T !== 0 && (h(u + T), C.preventDefault());
    }
  };
  return lt(() => {
    i === b ? i === t.book ? h(t.chapterNum) : h(1) : h(0);
  }, [b, t.book, t.chapterNum, i]), Fe(() => {
    k(m);
  }, [m]), Fe(() => {
    const C = setTimeout(() => {
      if (z && N.current && E.current && !s) {
        const A = E.current.offsetTop - aa;
        N.current.scrollTo({ top: A, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(C);
    };
  }, [z, s]), /* @__PURE__ */ d(qt, { modal: !1, open: m, onOpenChange: pt, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Or,
      {
        ...
        handleKeyDown: P,
        handleOnClick: () => {
          p(t.book), g(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), y(!0), l(Vt(t, "English")), x.current.focus();
        },
        onFocus: () => {
          ct.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      jt,
      {
        ...
        ref: N,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Le.map((C, D) => {
          const A = $(C);
          return A.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Jt, { className: "tw-font-semibold tw-text-foreground/80", children: ra[C] }),
            A.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ea,
              {
                bookId: f,
            ...
            Le.length - 1 !== D ? /* @__PURE__ */ r(Ft, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
const la = dt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Rt : "button", { className: w(la({ variant: e, size: n, className: t })), ref: s, ...o })
);
M.displayName = "Button";
const da = dt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ke.Root, { ref: n, className: w("pr-twp", da(), t), ...e }));
G.displayName = Ke.Root.displayName;
...
un.displayName = Pt.Root.displayName;
const ue = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Pt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Pt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ve, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ue.displayName = Pt.Item.displayName;
const mn = At.Root, hn = At.Trigger, Ee = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
Ee.displayName = At.Content.displayName;
const ca = at.Portal, gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
    className: w(
...
gn.displayName = at.Overlay.displayName;
const pa = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
  return /* @__PURE__ */ d(ca, { children: [
    /* @__PURE__ */ r(gn, {}),
    /* @__PURE__ */ d(
      at.Content,
      {
...
pa.displayName = at.Content.displayName;
...
ua.displayName = at.Title.displayName;
...
ma.displayName = at.Description.displayName;
...
Ie.displayName = H.Input.displayName;
...
const Ve = c.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ve.displayName = H.Empty.displayName;
...
fn.displayName = H.Group.displayName;
...
ha.displayName = H.Separator.displayName;
...
function me({
  ...
  const [k, x] = O(!1);
  return /* @__PURE__ */ d(mn, { open: k, onOpenChange: x, ...z, children: [
...
function us({
  ...
  const h = se(u, "%webView_bookSelector_currentBook%"), b = se(u, "%webView_bookSelector_choose%"), g = se(u, "%webView_bookSelector_chooseBooks%"), [m, y] = O(
    "current book"
    /* CURRENT_BOOK */
  ), z = (k) => {
    y(k), t(k);
...
function va({ table: t }) {
  return /* @__PURE__ */ d(qt, { children: [
    /* @__PURE__ */ r(tr, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(er, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ d(jt, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r(Jt, { children: "Toggle columns" }),
      /* @__PURE__ */ r(Ft, {}),
...
const yt = j.Root, xa = j.Group, Nt = j.Value, ya = dt(
...
), bt = c.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = F();
  return /* @__PURE__ */ d(
    j.Trigger,
    {
      className: w(ya({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(j.Icon, { asChild: !0, children: /* @__PURE__ */ r(Ht, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
bt.displayName = j.Trigger.displayName;
...
bn.displayName = j.ScrollUpButton.displayName;
const vn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  j.ScrollDownButton,
  {
    ...
    className: w("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ r(Ht, { className: "tw-h-4 tw-w-4" })
  }
));
vn.displayName = j.ScrollDownButton.displayName;
const vt = c.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = F();
...
vt.displayName = j.Content.displayName;
const Na = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: n,
...
Na.displayName = j.Label.displayName;
const Q = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  j.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
...
ka.displayName = j.Separator.displayName;
function Ca({ table: t }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        yt,
        {
          ...
          children: [
            /* @__PURE__ */ r(bt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Nt, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(vt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Q, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Kt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: w("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const Zt = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: w("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Ta({
  ...
  var k;
  const [i, p] = O([]), [u, h] = O([]), [b, g] = O({}), [m, y] = O({}), z = We({
    data: e,
    columns: t,
    getCoreRowModel: Qe(),
    ...n && { getPaginationRowModel: Dr() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(va, { table: z }),
    /* @__PURE__ */ d(Kt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Wt, { stickyHeader: s, children: z.getHeaderGroups().map((x) => /* @__PURE__ */ r(wt, { children: x.headers.map((N) => /* @__PURE__ */ r(Ot, { children: N.isPlaceholder ? void 0 : Bt(N.column.columnDef.header, N.getContext()) }, N.id)) }, x.id)) }),
      /* @__PURE__ */ r(Zt, { children: (k = z.getRowModel().rows) != null && k.length ? z.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        wt,
        {
          onClick: () => l(x, z),
          "data-state": x.getIsSelected() && "selected",
          children: x.getVisibleCells().map((N) => /* @__PURE__ */ r(kt, { children: Bt(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        x.id
    ...
    n && a && /* @__PURE__ */ r(Ca, { table: z })
  ] });
}
const Gt = Yt(({ className: t, ...e }, n) => /* @__PURE__ */ r(ir, { size: 35, className: w("tw-animate-spin", t), ...e, ref: n }));
...
function ms({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Gt, { size: 15 }) : /* @__PURE__ */ d(Ct, { children: [
        /* @__PURE__ */ r(wr, { size: 25, className: w("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function hs({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: w(
      ...
      children: t ? /* @__PURE__ */ d(Ct, { children: [
        /* @__PURE__ */ r(Gt, { size: 15, className: "tw-mr-1 tw-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function gs({
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      ...a,
      children: t ? /* @__PURE__ */ d(Ct, { children: [
        /* @__PURE__ */ r(Gt, { size: 15, className: "tw-mr-1 tw-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
}
function fs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: w(
...
function bs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: w("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Vr, { options: o, children: e }) });
}
const _a = Yt((t, e) => /* @__PURE__ */ d(
  M,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ r(lr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ r(
        Ht,
        {
...
function vs({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(qt, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(_a, {}) }),
    /* @__PURE__ */ r(jt, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(Jt, { children: n.label }),
...
function ys({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new _r("en", {
    notation: "compact",
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ r(dr, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          ...
          /* @__PURE__ */ d(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ r(pr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Ea({ id: t, versionHistory: e }) {
...
function Ns({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Ea, { versionHistory: o }),
...
const Da = dt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: w("pr-twp", Da({ variant: e }), t), ...n })
);
...
function Ia({
  ...
  return /* @__PURE__ */ r("div", { className: h, children: /* @__PURE__ */ d(mn, { open: b, onOpenChange: g, children: [
    /* @__PURE__ */ r(hn, { asChild: !0, children: /* @__PURE__ */ d(
      M,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(De, { children: [
      /* @__PURE__ */ r(Ie, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ d(Me, { children: [
        /* @__PURE__ */ r(Ve, { children: s }),
        /* @__PURE__ */ r(fn, { children: z.map((k) => {
          ...
          return /* @__PURE__ */ d(
            Be,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: k.starred && /* @__PURE__ */ r(ur, { className: "tw-h-4 tw-w-4" }) }),
...
function ks({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      var m;
      return /* @__PURE__ */ d(xn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          M,
          {
            variant: "ghost",
...
function Ma({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = W(() => {
    const l = [];
    return t.forEach((i) => {
      l.some((p) => ye(p, i)) || l.push(i);
    }), l;
  }, [t]);
  return /* @__PURE__ */ d(Kt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Wt, { stickyHeader: !0, children: /* @__PURE__ */ d(wt, { children: [
      /* @__PURE__ */ r(Ot, { children: a }),
      /* @__PURE__ */ r(Ot, { children: o })
    ] }) }),
    /* @__PURE__ */ r(Zt, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      wt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(kt, { children: `${X.bookIdToEnglishName(l.reference.book)} ${l.reference.chapterNum}:${l.reference.verseNum}` }),
          /* @__PURE__ */ r(kt, { children: l.text })
        ]
      },
...
Pe.displayName = ce.Root.displayName;
const yn = dt(
  ...
  {
    ref: o,
    className: w(yn({ variant: e, size: n, className: t })),
    ...a
  }
));
Va.displayName = tn.Root.displayName;
const Nn = c.createContext({
  size: "default",
  variant: "default"
}), kn = c.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const l = F();
  return /* @__PURE__ */ r(
    Ut.Root,
    {
...
kn.displayName = Ut.Root.displayName;
const $t = c.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const l = c.useContext(Nn);
  return /* @__PURE__ */ r(
    Ut.Item,
    {
      ref: s,
...
$t.displayName = Ut.Item.displayName;
const Qt = (t) => t === "asc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(vr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Cs = (t) => ({
  accessorKey: "item",
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ d(M, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Qt(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const l = s.getValue("status"), i = s.getValue("item");
    return /* @__PURE__ */ d(kn, { value: l, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        $t,
        {
          onClick: (p) => {
  ...
  return e ? e[1] : "";
}, Pa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Es = Object.freeze([
...
function Ds({
  ...
  const u = st(n, "%webView_inventory_all%"), h = st(n, "%webView_inventory_approved%"), b = st(n, "%webView_inventory_unapproved%"), g = st(n, "%webView_inventory_unknown%"), m = st(n, "%webView_inventory_scope_currentBook%"), y = st(n, "%webView_inventory_scope_chapter%"), z = st(n, "%webView_inventory_filter_text%"), k = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, N] = O(!1), [E, $] = O("all"), [q, ct] = O(""), [pt, v] = O([]), R = W(() => t.length === 0 ? [] : Oa(t, o, s), [t, o, s]), L = W(() => {
    if (x) return R;
    const f = [];
    return R.forEach((T) => {
      const Z = T.items[0], ut = f.find(
        (xt) => xt.items[0] === Z
      );
      ut ? (ut.count += T.count, ut.occurrences = ut.occurrences.concat(T.occurrences)) : f.push({
        items: [Z],
        count: T.count,
    ...
    for (let xt = 0; xt < f; xt++)
      T.push(
        Ba(
          ((ut = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ut[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...T, ...p];
  ...
  const re = (f, T) => {
    ...
    if (L.length === 0 || pt.length === 0) return [];
    const f = L.filter((T) => ye(
      x ? T.items : [T.items[0]],
      pt
    ));
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        yt,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(bt, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(yt, { onValueChange: (f) => C(f), defaultValue: l, children: [
        /* @__PURE__ */ r(bt, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(vt, { children: [
...
const Ae = c.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  en.Root,
  {
    ref: o,
    decorative: n,
...
Ae.displayName = en.Root.displayName;
...
const Oe = Xt.Provider, Xe = Xt.Root, je = Xt.Trigger, te = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Xt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Xa = "16rem", ja = "3rem", Cn = c.createContext(void 0);
function ee() {
  const t = c.useContext(Cn);
  if (!t)
...
const Sn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: N, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Sn.displayName = "SidebarProvider";
const Rn = c.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const l = ee();
...
const Fa = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = ee();
  return /* @__PURE__ */ d(
    M,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(xr, {}) : /* @__PURE__ */ r(yr, {}),
...
Tn.displayName = "SidebarInset";
const $a = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  _t,
  {
    ref: n,
    "data-sidebar": "input",
...
const Ua = c.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Rt : "button",
  {
    ref: a,
...
En.displayName = "SidebarMenuItem";
const qa = dt(
  ...
  ({
    ...
    const p = t ? Rt : "button", { state: u } = ee(), h = /* @__PURE__ */ r(
      p,
      {
        ref: i,
        ...
        "data-size": a,
        "data-active": e,
        className: w(qa({ variant: n, size: a }), s),
        ...l
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(je, { asChild: !0, children: h }),
      /* @__PURE__ */ r(te, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : h;
  }
);
Dn.displayName = "SidebarMenuButton";
const Ja = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Rt : "button",
  {
    ref: o,
...
Ja.displayName = "SidebarMenuAction";
...
const Wa = c.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
Wa.displayName = "SidebarMenuSkeleton";
...
Za.displayName = "SidebarMenuSub";
const Qa = c.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Qa.displayName = "SidebarMenuSubItem";
const to = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Rt : "a",
  {
    ref: s,
    ...
    Rn,
    {
      ...
      children: /* @__PURE__ */ d(_n, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(En, { children: /* @__PURE__ */ r(
            Dn,
            {
              onClick: () => u(g),
              isActive: b(g),
        ...
        /* @__PURE__ */ d(he, { children: [
          /* @__PURE__ */ r(ge, { className: "tw-text-sm", children: l }),
    ...
    /* @__PURE__ */ d(
      Sn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Tn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const it = "scrBook", no = "scrRef", ht = "source", ro = "details", ao = "Scripture Reference", oo = "Scripture Book", Mn = "Type", so = "Details";
function io(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: it,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? ao,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? X.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === it ? Vt(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => Vt(a.start),
      id: no,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : Vt(o.start);
      },
      sortingFn: (a, o) => de(a.original.start, o.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: ro,
      header: (t == null ? void 0 : t.detailsColumnName) ?? so,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, He = (t) => `${wo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ms({
  sources: t,
  ...
  const [p, u] = O([]), [h, b] = O([{ id: it, desc: !1 }]), [g, m] = O({}), y = W(
  ...
  lt(() => {
    if (i) {
      ...
      if (R.length === 1) {
        const L = y.find((P) => He(P) === R[0]) || void 0;
        L && i(L);
      }
    }
  }, [g, y, i, k]);
  const x = o ?? oo, N = s ?? Mn, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [it] },
  ...
  }, ct = (v, R) => v.getIsGrouped() ? "" : w("banded-row", R % 2 === 0 ? "even" : "odd"), pt = (v, R, L) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          /* @__PURE__ */ r(bt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Nt, {}) }),
          /* @__PURE__ */ r(vt, { position: "item-aligned", children: /* @__PURE__ */ r(xa, { children: E.map((v) => /* @__PURE__ */ r(Q, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Kt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Wt, { children: k.getHeaderGroups().map((v) => /* @__PURE__ */ r(wt, { children: v.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ot, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Bt(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(Zt, { children: k.getRowModel().rows.map((v, R) => {
        const L = F();
        return /* @__PURE__ */ r(
          wt,
          {
                  ...
                  kt,
                  {
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        type: "button",
                        children: [
                          v.getIsExpanded() && /* @__PURE__ */ r(Ht, {}),
                          !v.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(kr, {})),
                          " ",
                          Bt(P.column.columnDef.cell, P.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
function Vs({
  ...
  return /* @__PURE__ */ d(
    yt,
    {
      ...
      children: [
        /* @__PURE__ */ r(bt, { size: o, className: w("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Nt,
          {
            placeholder: l[I(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          vt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((p) => /* @__PURE__ */ r(Q, { value: `${p}`, children: l[I(p)] }, `${p}`))
          }
        )
      ]
    }
...
function Lt({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const Bn = (t, e, n, a) => n ? Object.entries(t).filter(
...
).sort(([, s], [, l]) => s.order - l.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map((i) => /* @__PURE__ */ d(Xe, { children: [
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    Ce,
    {
      onClick: () => {
        a(i);
      ...
      children: [
        i.iconPathBefore && /* @__PURE__ */ r(Lt, { icon: i.iconPathBefore, menuLabel: i.label, leading: !0 }),
        i.label,
        i.iconPathAfter && /* @__PURE__ */ r(Lt, { icon: i.iconPathAfter, menuLabel: i.label })
      ]
    },
    `dropdown-menu-item-${i.label}-${i.command}`
  ) : /* @__PURE__ */ d(Fr, { children: [
    /* @__PURE__ */ r(rn, { children: i.label }),
    /* @__PURE__ */ r(jr, { children: /* @__PURE__ */ r(an, { children: Bn(
      t,
      e,
      Vn(t, i.id),
      a
  ...
  i.tooltip && /* @__PURE__ */ r(te, { children: i.tooltip })
...
function Ue({
  ...
  return /* @__PURE__ */ d(qt, { variant: s, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: l, children: /* @__PURE__ */ r(M, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Cr, {}) }) }),
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, p]) => typeof i == "boolean" || typeof p == "boolean" ? 0 : i.order - p.order).map(([i], p, u) => /* @__PURE__ */ d(Wn, { children: [
      /* @__PURE__ */ r(nn, { children: /* @__PURE__ */ r(Oe, { children: Bn(e.groups, e.items, i, t) }) }),
      p < u.length - 1 && /* @__PURE__ */ r(Ft, {})
    ] }, i)) })
  ] });
}
function Os({
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[2] tw-flex-row tw-flex-wrap tw-items-start tw-gap-2 tw-overflow-clip tw-@container/tab-toolbar-start", children: l }),
...
Pn.displayName = U.List.displayName;
const An = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.List,
  {
    ref: n,
...
const lo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Trigger,
  {
    ref: n,
    ...e,
...
function Xs({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Pn, { children: [
      /* @__PURE__ */ r(An, { children: t.map((l) => /* @__PURE__ */ r(lo, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(On, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function co({ ...t }) {
...
const Xn = c.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = c.useMemo(
    () => ({
      variant: e
    }),
...
Xn.displayName = B.Root.displayName;
...
const Fn = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = nt();
  return /* @__PURE__ */ d(
    B.SubTrigger,
    {
...
Fn.displayName = B.SubTrigger.displayName;
const Gn = c.forwardRef(({ className: t, ...e }, n) => {
  const a = nt();
  return /* @__PURE__ */ r(
    B.SubContent,
    {
...
Gn.displayName = B.SubContent.displayName;
const $n = c.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const l = nt();
...
$n.displayName = B.Content.displayName;
const Ln = c.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = nt();
  return /* @__PURE__ */ r(
    B.Item,
    {
...
Ln.displayName = B.Item.displayName;
const uo = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = nt();
  return /* @__PURE__ */ d(
    B.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
uo.displayName = B.CheckboxItem.displayName;
const mo = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = nt();
  return /* @__PURE__ */ d(
    B.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
mo.displayName = B.RadioItem.displayName;
const ho = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  B.Label,
  {
    ref: a,
    className: w("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
ho.displayName = B.Label.displayName;
...
Yn.displayName = B.Separator.displayName;
const It = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], l) => {
    const i = e.filter((u) => u.group === s).sort((u, h) => u.order - h.order).map((u) => /* @__PURE__ */ d(Xe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        Ln,
        {
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ r(Lt, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }),
            u.label,
            u.iconPathAfter && /* @__PURE__ */ r(Lt, { icon: u.iconPathAfter, menuLabel: u.label })
          ]
        },
        `menubar-item-${u.label}-${u.command}`
      ) : /* @__PURE__ */ d(po, { children: [
        /* @__PURE__ */ r(Fn, { children: u.label }),
        /* @__PURE__ */ r(Gn, { children: Hn(
          t,
          e,
          Vn(t, u.id),
          a
      ...
      u.tooltip && /* @__PURE__ */ r(te, { children: u.tooltip })
    ] }, `tooltip-${u.label}-${"command" in u ? u.command : u.id}`)), p = [...i];
    return i.length > 0 && l < o.length - 1 && p.push(/* @__PURE__ */ r(Yn, {}, `separator-${s}`)), p;
  });
};
function go({
  menuData: t,
  ...
  if (Br(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (h, b) => {
    var y, z, k, x;
    h.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (y = s.current) == null || y.focus(), It(s, [g, m]);
        break;
      case "alt+l":
        (z = l.current) == null || z.focus(), It(l, [g, m]);
        break;
      case "alt+n":
        (k = i.current) == null || k.focus(), It(i, [g, m]);
        break;
      case "alt+h":
        (x = p.current) == null || x.focus(), It(p, [g, m]);
        break;
    }
  }), lt(() => {
    ...
    return /* @__PURE__ */ r(Xn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, h]) => typeof h == "object").sort(([, h], [, b]) => typeof h == "boolean" || typeof b == "boolean" ? 0 : h.order - b.order).map(([h, b]) => /* @__PURE__ */ d(co, { children: [
      /* @__PURE__ */ r(jn, { ref: u(h), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        $n,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Hn(t.groups, t.items, h, e) })
        }
      )
    ] }, h)) });
}
  ...
  return /* @__PURE__ */ d("div", { className: w("pr-twp tw-max-w-sm", i), children: [
    /* @__PURE__ */ d(
      yt,
      {
        ...
        onOpenChange: (m) => h(m),
        children: [
          /* @__PURE__ */ r(bt, { children: /* @__PURE__ */ r(Nt, {}) }),
          /* @__PURE__ */ r(
            vt,
            {
              className: "tw-z-[250]",
...
), xo = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: w(vo({ variant: e }), t), ...n }));
...
yo.displayName = "AlertTitle";
const No = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: w("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
No.displayName = "AlertDescription";
...
ko.displayName = Tt.Root.displayName;
...
Co.displayName = Tt.Image.displayName;
...
So.displayName = Tt.Fallback.displayName;
...
const zo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: w("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function Io({
  ...
  return /* @__PURE__ */ r(et.Root, { shouldScaleBackground: t, ...e });
}
Io.displayName = "Drawer";
const Ys = et.Trigger, Mo = et.Portal, Hs = et.Close, Un = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  et.Overlay,
  {
    ref: n,
    className: w("tw-fixed tw-inset-0 tw-z-50 tw-bg-black/80", t),
    ...e
  }
));
Un.displayName = et.Overlay.displayName;
const Vo = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(Mo, { children: [
  /* @__PURE__ */ r(Un, {}),
  /* @__PURE__ */ d(
    et.Content,
    {
...
Vo.displayName = "DrawerContent";
function Bo({ className: t, ...e }) {
  return /* @__PURE__ */ r(
    "div",
    {
      className: w("tw-grid tw-gap-1.5 tw-p-4 tw-text-center sm:tw-text-left", t),
      ...e
    }
  );
}
Bo.displayName = "DrawerHeader";
function Po({ className: t, ...e }) {
  return /* @__PURE__ */ r("div", { className: w("tw-mt-auto tw-flex tw-flex-col tw-gap-2 tw-p-4", t), ...e });
}
Po.displayName = "DrawerFooter";
...
Ao.displayName = et.Title.displayName;
...
Oo.displayName = et.Description.displayName;
const qn = c.forwardRef(({ className: t, orientation: e = "vertical", ...n }, a) => /* @__PURE__ */ r(
  gt.ScrollAreaScrollbar,
  {
    ...
    ...n,
    children: /* @__PURE__ */ r(gt.ScrollAreaThumb, { className: "tw-relative tw-flex-1 tw-rounded-full tw-bg-border" })
  }
));
qn.displayName = gt.ScrollAreaScrollbar.displayName;
const Xo = c.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  gt.Root,
  {
    ref: a,
    className: w("tw-relative tw-overflow-hidden", t),
    ...n,
    children: [
      /* @__PURE__ */ r(gt.Viewport, { className: "tw-h-full tw-w-full tw-rounded-[inherit]", children: e }),
      /* @__PURE__ */ r(qn, {}),
      /* @__PURE__ */ r(gt.Corner, {})
    ]
  }
));
Xo.displayName = gt.Root.displayName;
function Us({ ...t }) {
  return /* @__PURE__ */ r(
    Pr,
    {
...
const jo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ d(
    Mt.Root,
    {
...
jo.displayName = Mt.Root.displayName;
const Fo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    pe.Root,
    {
...
Fo.displayName = pe.Root.displayName;
const qs = U.Root, Go = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Go.displayName = U.List.displayName;
const $o = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Trigger,
  {
    ref: n,
    className: w(
...
$o.displayName = U.Trigger.displayName;
const Lo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
...
Lo.displayName = U.Content.displayName;
const Js = (t, e) => {
  lt(() => {
    if (!t) return () => {
    };
...
const Ho = (t, e, n = {}) => {
  ...
  a.current = e;
  const o = K(n);
  o.current = Yo(o.current);
  const [s, l] = O(() => a.current), [i, p] = O(!0);
  return lt(() => {
    let u = !0;
    return p(!!t), (async () => {
      if (t) {
...
export {
  ...
  yo as AlertTitle,
  ko as Avatar,
  So as AvatarFallback,
  Co as AvatarImage,
  ps as BOOK_SELECTOR_STRING_KEYS,
  xn as Badge,
  cs as BookChapterControl,
  ...
  ys as MoreInfo,
  Ia as MultiSelectComboBox,
  Xs as NavigationContentSearch,
  xs as NoExtensionsFound,
  mn as Popover,
  ...
  Ae as Separator,
  Bs as SettingsList,
  As as SettingsListHeader,
  Ps as SettingsListItem,
  eo as SettingsSidebar,
  Is as SettingsSidebarContentSearch,
  jo as Slider,
  Us as Sonner,
  Gt as Spinner,
  Fo as Switch,
  Ue as TabDropdownMenu,
  Os as TabToolbar,
  Kt as Table,
  Zt as TableBody,
  Ra as TableCaption,
  ...
  w as cn,
  zs as getBookIdFromUSFM,
  Ts as getLinesFromUSFM,
  _s as getNumberFromUSFM,
  Pa as getStatusForItem,
  js as getToolbarOSReservedSpaceClassName,
  Ss as inventoryCountColumn,
  Cs as inventoryItemColumn,
  Rs as inventoryStatusColumn,
