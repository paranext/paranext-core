...
import { c as v, g as Re, a as Or, C as Ge, L as Un, u as Zo, T as Ot, b as Tt, d as St, e as Rt, A as pa, D as Oe, f as ye, h as Ie, i as yr, j as Le, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ue, r as Ne, o as xs, p as Kn, P as tr, q as kr, s as er, t as rr, v as _a, w as Na, y as No, z as ar, E as Ca, F as zt, R as Co, G as ha, H as ro, J as ao, K as oo, M as no, N as Hn, O as oa, Q as Eo, S as $r, U as Vr, V as ur, W as ys, X as Ze, Y as Fe, Z as Pe, _ as Be, $ as pr, a0 as To, a1 as So, a2 as ga, a3 as Ro, a4 as Gn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as qn, aa as Ea, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as zs, al as Wn, am as Xn, an as Do, ao as Os, ap as Jn, aq as Ba, ar as tn, as as ja, at as Is, au as Ps, av as As, aw as $s, ax as Vs, ay as jr, az as Mo, aA as Ls, aB as Bs } from "./resizable-uIOEXf2e.js";
import { aC as af, aD as of, aE as nf, aF as sf, aG as cf, aH as lf, aI as df, aJ as wf, aK as uf, aL as pf, aM as hf, aN as gf, aO as ff, aP as mf, aQ as vf, aR as bf, aS as xf, aT as yf, aU as kf, aV as _f, aW as Nf, aX as Cf, aY as Ef, aZ as Tf, a_ as Sf, a$ as Rf, b0 as Df, b1 as Mf, b2 as zf, b3 as Of, b4 as If, b5 as Pf, b6 as Af, b7 as $f, b8 as Vf } from "./resizable-uIOEXf2e.js";
import { jsx as a, jsxs as u, Fragment as ut } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as Ke, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as js, ArrowRight as Fs, BoldIcon as Us, ItalicIcon as Ks, X as zo, AtSign as Qn, Pencil as Hs, Trash2 as Gs, ArrowUp as ti, MoreHorizontal as qs, MailOpen as Ys, Mail as Ws, FilterIcon as Xs, ArrowLeftIcon as Js, ChevronLeftIcon as Zs, ChevronRightIcon as Qs, ArrowRightIcon as tc, Copy as ei, Filter as ec, User as rc, Link as ac, CircleHelp as oc, Undo as nc, Redo as ic, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as sc, AlertCircle as so, CircleCheckIcon as cc, CircleXIcon as lc, CircleHelpIcon as dc, ArrowUpIcon as wc, ArrowDownIcon as uc, ScrollText as pc, ChevronRight as hc, ChevronLeft as gc, ChevronsUpDown as fc, MenuIcon as mc, Menu as vc, EllipsisVertical as bc, MoreVertical as xc } from "lucide-react";
import { Section as Mt, compareScrRefs as fa, getChaptersForBook as yc, formatScrRef as De, formatReplacementString as je, getSectionForBook as na, formatRelativeDate as kc, sanitizeHtml as Oo, NumberFormat as ni, formatBytes as _c, getCurrentLocale as Nc, usfmMarkers as ia, isPlatformError as Cc, ABORTED as Ec, getErrorMessage as Tc, getFormatCallerFunction as Sc, deepEqual as Rc, isString as on, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Dc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Mc } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as $, createContext as Fr, useContext as Ta, useState as _, useEffect as W, useCallback as j, useId as co, useImperativeHandle as zc, useLayoutEffect as Xt, Fragment as Ur, Component as Oc, createElement as cn, Suspense as Ic, forwardRef as ii } from "react";
import { IconSelector as si, IconCheck as Sa, IconChevronDown as Pc, IconChevronUp as Ac, IconLayoutSidebar as $c, IconLayoutSidebarRight as Vc, IconChevronRight as ci, IconSearch as Lc, IconLoader as Bc, IconAlertOctagon as jc, IconAlertTriangle as Fc, IconInfoCircle as Uc, IconCircleCheck as Kc } from "@tabler/icons-react";
import { createEditor as li, $getRoot as He, $createParagraphNode as Kr, $getSelection as ee, HISTORY_MERGE_TAG as Io, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Hc, $isRangeSelection as ke, $caretFromPoint as Gc, $getSiblingCaret as ui, $getChildCaret as qc, $getAdjacentChildCaret as Yc, $isChildCaret as Wc, $normalizeCaret as Xc, $setSelectionFromCaretRange as Jc, $getCollapsedCaretRange as Zc, $getCaretInDirection as ln, $splitAtPointCaretNext as Qc, $isTextPointCaret as tl, $findMatchingParent as pi, $isElementNode as Lr, mergeRegister as ze, getDOMTextNode as el, isHTMLElement as rl, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as Po, shallowMergeConfig as al, defineExtension as le, safeCast as or, createState as ol, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as nl, LineBreakNode as il, TabNode as sl, $isEditorState as cl, createCommand as ll, CLICK_COMMAND as dl, isDOMNode as wl, $getNodeFromDOMNode as ul, $createNodeSelection as pl, $setSelection as hl, $getEditor as gl, DecoratorNode as lo, $getState as fl, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as ml, $setState as vl, addClassNamesToElement as vi, $create as bl, $getNodeByKey as xl, removeClassNamesFromElement as yl, KEY_TAB_COMMAND as kl, $isBlockElementNode as _l, $createRangeSelection as Nl, $normalizeSelection__EXPERIMENTAL as Cl, OUTDENT_CONTENT_COMMAND as El, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as Tl, COMMAND_PRIORITY_CRITICAL as Ao, $isDecoratorNode as Sl, $isParagraphNode as Rl, $isTextNode as wo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Dl } from "lexical";
import { HeadingNode as Ml, QuoteNode as zl, registerRichText as Ol } from "@lexical/rich-text";
...
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Kl, isInsertEmbedOpOfType as Rr, getMarkerMenuItems as Hl, defaultStyleInfo as Gl, Editorial as ql } from "@eten-tech-foundation/platform-editor";
...
function rd({
  ...
  W(() => {
    var O;
    ed();
    const tt = (O = E.current) == null ? void 0 : O.closest('button, [role="combobox"], [tabindex]');
    if (!tt) return;
    const N = (q) => !!q && q.scrollWidth > q.clientWidth, rt = () => {
      ho !== "pointer" && (T || N(h.current) || N(l.current)) && C(!0);
    }, z = () => C(!1);
    return tt.addEventListener("focus", rt), tt.addEventListener("blur", z), () => {
      tt.removeEventListener("focus", rt), tt.removeEventListener("blur", z);
    };
  }, [T, h, l]);
  const L = j(() => {
    T && R(!0), f(), A && w();
...
function id({
  ...
  const [h, g] = _(!1), [f, x] = _(!1), b = co(), R = F(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : te(n, od), A = te(s, nd), T = (M) => {
  ...
  return /* @__PURE__ */ u(Oe, { open: C, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(Ot, { children: E ? /* @__PURE__ */ u(Tt, { open: f, onOpenChange: L, children: [
...
function Ha({
  ...
  const T = Ne(), L = td(), [P, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [z, O] = _(void 0), [q, nt] = _(
    void 0
    ...
    if (!I) return;
    const m = M.startsWith(`${I.book} `) ? M : "", G = Qr(m), at = zr(m);
    return {
      book: I.book,
      chapterNum: at ?? I.chapterNum ?? 1,
  ...
  const oe = j(() => {
    ...
    (m) => {
      const G = q ?? (I == null ? void 0 : I.book), at = ot ?? (I == null ? void 0 : I.chapterNum);
      !G || !at || (gt({
        book: G,
        chapterNum: at,
        verseNum: m
    ...
    (m) => {
      const G = N === "chapters" ? z : I == null ? void 0 : I.book;
      if (G) {
        if (w && w(G, m) > 1) {
    ...
    rt("books"), O(void 0), nt(void 0), wt(void 0), bt(!1), setTimeout(() => {
      var m;
      (m = xt.current) == null || m.focus();
    }, 0);
  }, []), it = j(() => {
    const m = q;
    nt(void 0), wt(void 0), m ? (O(m), rt("chapters"), Y("")) : Q();
  }, [q, Q]), st = j(
    (m) => {
      D(m), m && (rt("books"), O(void 0), nt(void 0), wt(void 0), tt(""), bt(!1), vt(!1), pt(Dt));
    },
    [Dt]
  );
  W(() => {
  ...
  const { otLong: Vt, ntLong: Zt, dcLong: Nr, extraLong: Ye } = {
    ...
    () => L >= Pr.TIGHT ? Or(t.book, s) : Re(t.book, s),
    [t.book, s, L]
    ...
    () => ld(U),
    [U]
  ), ie = $(() => !w || !I || !I.chapterNum || !Er ? !1 : w(I.book, I.chapterNum) > 0, [w, I, Er]), Pa = N === "books" && !_t && !U.trim() && $t.size > 0, ir = j(
    (m) => p ? mn(m, p) : !1,
    [p]
  ), sr = j(
    (m) => (G) => p ? dd(m, G, p) : !1,
    ...
    (m) => {
      (m.key === "Home" || m.key === "End") && m.stopPropagation(), h && h.includes(m.key) && I && I.chapterNum !== void 0 && I.verseNum !== void 0 && (m.preventDefault(), m.stopPropagation(), oe());
    },
    [h, I, oe]
  ), B = j(
    (m) => {
      ...
      if (!(!!G && !!((Wo = ht.current) != null && Wo.contains(G))) && (G != null && G.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        const At = ht.current ? fd(ht.current) : [];
        if (At.length === 0) {
      ...
      if (N === "books" && I && !_t && m.key === "Enter" && !(G !== xt.current && !!(G != null && G.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (m.shiftKey || N === "books" && G !== xt.current && (G != null && G.closest('button, a, [role="button"]')))
        return;
      const kt = (() => {
        const At = N === "books" && I && ie && I.chapterNum ? { bookId: I.book, chapterNum: I.chapterNum } : void 0, se = N === "verses" ? { bookId: q, chapterNum: ot } : At;
        if (se) {
        ...
        if (N === "chapters" || N === "books" && I && Ve(I.book) > 1) {
          const Gt = N === "chapters" ? z : I == null ? void 0 : I.book;
          return Gt ? {
            max: Ve(Gt),
            current: zr(M) ?? 0,
  ...
  Xt(() => {
    ...
    if (N === "chapters" && z) {
      const m = z === t.book, G = m ? t.chapterNum : 1;
      Y(hr(z, G)), setTimeout(() => {
        if (yt.current)
          if (m) {
  ...
  const Pt = I ? `${I.book} ${I.chapterNum ?? ""} ${I.verseNum ?? ""} ${ie}` : "", Se = F(""), lr = F(""), Jr = $(() => {
    if (N !== "books" || !I || _t) return;
    const { book: m, chapterNum: G, verseNum: at } = I;
    if (ie && G && w)
      return {
        max: w(m, G),
  ...
  }, [N, I, Jr, Pt, M]), /* @__PURE__ */ u(tr, { open: P, onOpenChange: st, modal: k, children: [
          ...
          rr,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u(
                ...
                N === "chapters" && z && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(z, s) }),
              ...
              !_t && /* @__PURE__ */ u(ar, { ref: yt, children: [
                N === "books" && /* @__PURE__ */ u(ut, { children: [
                  ...
                  I && ft && /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ u(
                    Ge,
                    {
                      value: ad,
                      onSelect: oe,
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ a("span", { className: "tw:ms-2 tw:shrink-0 tw:text-xs tw:text-muted-foreground", children: Or(I.book, s) })
                      ]
                    },
                    "top-match"
                  ) }),
                  I && ie && I.chapterNum && w && // No heading over this grid: the top-match row sits directly above it and
                  ...
                  /* @__PURE__ */ a(
                    bn,
                    {
                      ...
                      onVerseSelect: S,
                      setVerseRef: nr,
                      isVerseDisabled: Te(I.book, I.chapterNum),
                      suppressKeyboardHighlight: mt,
                      className: "tw:px-4 tw:pb-4"
                    }
                  ),
                  I && !ie && Ve(I.book) > 1 && // No heading here either, for the same reason as the verse preview above:
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xd = Di ? Xt : W, ea = { tag: Io };
...
const kd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
...
const Sd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
function Rd(t) {
    ...
    w.read(() => {
      ...
      if ((T || L) && E !== null && A !== null) {
        const P = function(D, M, Y, U, tt, N, rt) {
          const z = (D._window ? D._window.document : document).createRange();
          return z.setStart(...yn(M, Y, U)), z.setEnd(...yn(tt, N, rt)), z;
        }(t, h, f, E, g, R, A);
        l(), l = Id(t, P, e);
      }
...
function Ld(t) {
  const e = ee() || Hc();
  let r;
  if (ke(e)) r = Gc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || qc(He(), "previous").getFlipped().insert(Kr());
  }
...
function Bd(t, e, r) {
  ...
  return tl(o) && ma(283), o.insert(t.isInline() ? Kr().append(t) : t), ln(ui(t.getLatest(), "next"), e.direction);
}
function jd(t) {
  const e = ee();
  if (!ke(e)) return !1;
...
let va, Me = 0, ba = 0, Kd = 0, bo = 0, la = 0;
function _n(t) {
  if (ct === void 0) return;
  let e = t.n;
...
function Gd(t) {
  ...
  Oi(this), ct = t, this.f &= -2, 8 & this.f && Bo(this), Da();
}
function wr(t, e) {
...
Yt.prototype.brand = Fd, Yt.prototype.h = function() {
  return !0;
  ...
  if (this.g = la, this.f |= 1, this.i > 0 && !zi(this)) return this.f &= -2, !0;
  const t = ct;
  try {
    Nn(this), ct = this;
    const e = this.x();
  ...
  return ct = t, Oi(this), this.f &= -2, !0;
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ee();
  if (fi(n) || ke(n)) for (const s of n.getNodes()) Yd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const Qd = le({ config: or({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = Zd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const ew = /* @__PURE__ */ new Set(), Sn = le({ build(t, e, r) {
...
le({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [fr], register(t, e, r) {
  ...
  return ze(t.registerCommand(rw, (i) => {
    const c = ee();
    if (!ke(c)) return !1;
...
function nw(t, e, r = Fi) {
  return ze(t.registerCommand(kl, (o) => {
    const n = ee();
    if (!ke(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
const iw = le({ name: "@lexical/react/ReactProvider" });
function sw() {
...
function pw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Uo(() => ze(Ol(n), Ki(n)), [n]);
  }(o), u(ut, { children: [t, a(hw, { content: e }), a(uw, { editor: o, ErrorBoundary: r })] });
}
...
const fw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : W;
...
function yw(t, e) {
  ...
  return u(ut, { children: [a(bw, { editor: n, ...o, ref: e }), r != null && a(kw, { editor: n, content: r })] });
}
function kw({ content: t, editor: e }) {
  const r = function(i) {
    ...
    return Hi(() => {
      ...
      return d(), ze(i.registerUpdateListener(() => {
        d();
...
function Ew({
  ...
  const [e] = Ee(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Cw(), l = () => {
  };
...
function Ji({
  ...
  return /* @__PURE__ */ u(Na, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
      /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(
        J,
        {
          "aria-label": i,
...
function On({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Vw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Lw, { className: "tw:text-xs tw:font-medium", children: R }) }),
        ...
        A && /* @__PURE__ */ u(Oe, { children: [
          /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(qs, {}) }) }),
          /* @__PURE__ */ a(Ie, { align: "end", children: A })
        ] })
      ]
    }
  );
...
function rs({
  ...
  const [U, tt] = _(In), [N, rt] = _(), [z, O] = _(), q = o, [nt, ot] = _(!1), [wt, _t] = _(!1), [Z, lt] = _(!1), [pt, mt] = _(!1), [vt, re] = _(!1), [bt, de] = _(E), [ae, ht] = _(!1), xt = F(void 0), [yt, Ht] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      Nt.current !== "idle" && (rt(void 0), O(void 0), Nt.current = "idle");
      return;
    }
  ...
  const gt = $(() => Ct[0], [Ct]), we = F(null), ue = F(void 0), ne = j(() => {
    var y;
    (y = ue.current) == null || y.call(ue), tt(In);
  }, []), Ae = j(() => {
    const y = !bt;
  ...
  }, [s, r]), $t = $(() => Ct.slice(1), [Ct]), Dt = $(() => $t.length ?? 0, [$t.length]), ve = $(() => Dt > 0, [Dt]), I = $(() => nt || Dt <= 2 ? $t : $t.slice(-2), [$t, Dt, nt]), ft = $(() => nt || Dt <= 2 ? 0 : Dt - 2, [Dt, nt]), he = $(
      ...
      children: /* @__PURE__ */ u($w, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: bt ? /* @__PURE__ */ a(Ys, {}) : /* @__PURE__ */ a(Ws, {})
              }
            ),
            M === void 0 ? (
        ...
        /* @__PURE__ */ u(ut, { children: [
          ...
          o && /* @__PURE__ */ u(ut, { children: [
            Y && I.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ u(
              "div",
              {
            ...
            I.map((y) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              On,
              {
                comment: y,
                localizedStrings: r,
            ...
            b !== !1 && (!wt || ce(U)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  Ho(y) && (y.preventDefault(), y.stopPropagation(), (ce(U) || N !== void 0 && N !== z) && S());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && (ce(U) || N !== z) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: je(
                      ...
                      /* @__PURE__ */ a(
                        er,
                        {
                          ...
                          children: /* @__PURE__ */ a(rr, { children: /* @__PURE__ */ a(ar, { children: x == null ? void 0 : x.map((y) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                rt(y !== s ? y : void 0), Nt.current = "user-selected", O(void 0), lt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), jw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), wa = (t) => jw(Oo(t));
function ua({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Fw({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : Y, tt = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(ua, { html: R }) : Y : U(z === "reject" ? t.rejectedResultText : t.resultText);
  }, N = (z) => p && z.value === "reject", rt = (z) => {
    const O = f === z.value, q = `${d}-${z.value}`, nt = N(z);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a(
          Co,
          {
            ...
            children: T.map((z) => N(z) ? /* @__PURE__ */ a(Ot, { delayDuration: 0, children: /* @__PURE__ */ u(Tt, { children: [
              /* @__PURE__ */ a(St, { asChild: !0, children: rt(z) }),
              /* @__PURE__ */ a(Rt, { children: E })
            ] }) }, z.value) : rt(z))
          }
        ),
        /* @__PURE__ */ a(Ot, { delayDuration: 0, children: /* @__PURE__ */ u(Tt, { children: [
...
function gh({
  ...
  const [k, C] = _(/* @__PURE__ */ new Set()), [E, A] = _(), [T, L] = _(), P = j(
    async (O) => {
      const q = await s(O);
      return q !== void 0 && O.assignedUser !== void 0 && O.assignedUser !== "" && L(O.assignedUser), q;
    },
    [s]
  );
  W(() => {
    f && (C((O) => new Set(O).add(f)), A(f));
  }, [f]);
  const D = r.filter(
    (O) => O.comments.some((q) => !q.deleted)
  ), M = D.map((O) => ({ id: O.id })), Y = j(
    (O) => {
      C((q) => new Set(q).add(O.id)), A(O.id), x == null || x(O.id);
    },
    [x]
  ), U = j(
    (O) => {
    ...
    (O) => {
      O.key === "Escape" ? (E && k.has(E) && (C((q) => {
        const nt = new Set(q);
        return nt.delete(E), nt;
      }), A(void 0), x == null || x(void 0)), O.preventDefault(), O.stopPropagation()) : rt(O);
    },
    [E, k, rt, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: D.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...q })
          },
          O.id
        );
      })
...
function Qw({
  ...
  return l ? A = Array.from({ length: 10 }).map((D, M) => `skeleton-row-${M}`).map((D) => /* @__PURE__ */ a(Be, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(pr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ur, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? A = C.getRowModel().rows.map((L) => /* @__PURE__ */ a(
    Be,
    {
      ...
      children: L.getVisibleCells().map((P) => /* @__PURE__ */ a(pr, { children: Ir(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    L.id
    ...
    /* @__PURE__ */ u(To, { stickyHeader: s, children: [
      /* @__PURE__ */ a(So, { stickyHeader: s, children: C.getHeaderGroups().map((L) => /* @__PURE__ */ a(Be, { children: L.headers.map((P) => /* @__PURE__ */ a(ga, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : Ir(P.column.columnDef.header, P.getContext()) }, P.id)) }, L.id)) }),
...
function yh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Oe, { children: [
...
function nu({
  ...
  return /* @__PURE__ */ u(Na, { children: [
    ...
    e && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
      /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(
        J,
        {
          "aria-label": w,
...
const su = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ut, { children: [
...
function cu({
  ...
  return /* @__PURE__ */ u(Oe, { open: p, onOpenChange: b, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
      /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: su(t, o, e) }) }) }),
...
const lu = (t, e) => t === "f" ? /* @__PURE__ */ u(ut, { children: [
  /* @__PURE__ */ a(ai, {}),
  " ",
...
function wu({
  ...
  return /* @__PURE__ */ u(Oe, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
      /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(ye, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: lu(t, r) }) }) }),
      /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ a("p", { children: du(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ie, { style: { zIndex: qn }, children: [
...
function Ch({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, A] = _("*"), [T, L] = _("*"), [P, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), z = F(!1), O = F(""), [q, nt] = _(!1), [ot, wt] = _(), [_t, Z] = _(), [lt, pt] = _(), [mt, vt] = _(), re = F(null), bt = F(
    void 0
  ...
  W(() => {
    var H, V;
    let S, K, X;
    z.current = !1, ae.current = void 0, tt(!0);
    ...
    if (y && Rr("note", y)) {
      ...
      Q === uo ? it = "generated" : Q === po ? it = "hidden" : Q && (A(Q), L(Q)), R(it), C(it), D(((V = y.insert.note) == null ? void 0 : V.style) ?? "f"), S = setTimeout(() => {
        var st, Et, It;
        (st = h.current) == null || st.applyUpdate([y]), (Et = h.current) == null || Et.selectNote(0), (It = h.current) == null || It.focus(), K = requestAnimationFrame(() => {
          X = setTimeout(() => {
            var Vt, Zt;
  ...
  const ue = () => {
    ...
    if (K && Rr("note", K)) {
      ...
      P !== "x" && S === "x" ? it == null || it.forEach((st) => vu(st)) : P === "x" && S !== "x" && (it == null || it.forEach((st) => bu(st))), (Q = h.current) == null || Q.applyUpdate([K, { delete: 1 }]);
    }
  }, Ut = (S) => {
      ...
      if (K && Rr("note", K)) {
        ...
        if (it || Y(!1), Y(
          it === "x" ? !!(st != null && st.every((Et) => {
            ...
            const It = ((Zt = Et.attributes) == null ? void 0 : Zt.char).style;
          ...
          z.current = !0, O.current = JSON.stringify(K), tt(!0);
          return;
        }
        tt(JSON.stringify(K) === O.current), Ht();
      } else
        Y(!1), tt(!0);
    },
    [Ht]
    ...
    (S, K, X) => {
      ...
      Ts({
        ...
        onShowError: (V) => {
          (!Cc(V) || V.code !== Ec) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Tc(V)}`
          );
        }
      });
    },
    ...
    (S) => {
      ...
      Ss(S, K, {
        ...
        commitTypedAndReopen: (y) => {
          var H;
          (H = h.current) == null || H.commitTypedMarker(y, { trailingSpace: !1 }), I();
        },
        commitTypedCloser: (y) => {
          var H;
  ...
  W(() => {
    ...
    if (((X = ht.view) == null ? void 0 : X.markerMode) === "editable") {
      const y = (V) => {
        ...
        if (w && V.key === c) {
          if (!yt()) {
            V.preventDefault(), V.stopPropagation(), (It = h.current) == null || It.selectNote(0), (Vt = h.current) == null || Vt.focus();
            return;
          }
          I() && (V.preventDefault(), V.stopPropagation());
        }
      }, H = () => {
        var Q, it;
        const V = S();
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
              /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(
                J,
                {
                  "aria-label": he,
  ...
  return /* @__PURE__ */ u(ut, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ut, { children: yu(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ro, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      Be,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(pr, { className: o, children: Nu(c.text) })
        ]
      },
...
}, Ma = (t, e, r) => /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
  /* @__PURE__ */ u(
    St,
    {
...
function Ph({
  ...
  }, [L, rt]), O = $(() => z.length === 0 ? [] : Ru(z, D, Y), [z, D, Y]), q = $(() => {
    var pt, mt;
    if (!L) return l;
  ...
  W(() => {
    O.length === 0 ? N([]) : O.length === 1 && N(O[0].items);
  }, [O]);
  const nt = (Z, lt) => {
    lt.setRowSelection(() => {
      const mt = {};
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
        /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? A })
        ] }) }),
...
const Mu = "16rem", zu = "3rem", os = Wt.createContext(void 0);
function za() {
    ...
    Iu,
    {
      ...
      children: /* @__PURE__ */ u(Au, { children: [
        /* @__PURE__ */ u(Vn, { children: [
          ...
          /* @__PURE__ */ a(Bn, { children: /* @__PURE__ */ a($u, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Vu, { children: /* @__PURE__ */ a(
            Bu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const $e = "scrBook", Fu = "scrRef", Je = "source", Uu = "details", Ku = "Scripture Reference", Hu = "Scripture Book", ns = "Type", Gu = "Details";
function qu(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      mr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(xr, { position: "item-aligned", children: /* @__PURE__ */ a(Ww, { children: E.map((D) => /* @__PURE__ */ a(fe, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(Be, { children: D.headers.filter((M) => M.column.columnDef.header).map((M) => (
        ...
        /* @__PURE__ */ a(ga, { colSpan: M.colSpan, className: "tw:sticky top-0", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Ir(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, D.id)) }),
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          Ir(U.column.columnDef.cell, U.getContext()),
                          " (",
                          D.subRows.length,
                          ")"
                        ]
...
function Wu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
    ...
    (N, rt = !1) => {
      ...
      const z = T.findIndex((wt) => wt === E.current), O = T.findIndex((wt) => wt === N);
      if (z === -1 || O === -1) return;
      const [q, nt] = [
        Math.min(z, O),
        Math.max(z, O)
...
function Ju({
  ...
  return /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Tt, { children: [
    /* @__PURE__ */ a(St, { asChild: !0, children: /* @__PURE__ */ a(
      Xu,
      {
        className: o,
...
function Zh({
  ...
  const A = Bt(
    ...
    [r, n, x, s]
  ), $t = pt.find((B) => B.value === t), Dt = () => t === "selectedBooks" && n.length > 0 ? n.map((B) => B.toUpperCase()).join(", ") : t === "range" ? Dc(vt, re, {
  ...
  ), I = pt.find((B) => B.value === "selectedBooks"), ft = pt.find((B) => B.value === "range"), [he, oe] = _(!1), [S, K] = _(void 0), [X, y] = _(void 0), [H, V] = _(void 0), [Q, it] = _(void 0), [st, Et] = _([]), It = w === "dropdown" && S === "selectedBooks", Vt = /* @__PURE__ */ a(
    Qu,
    {
      availableBookInfo: o,
      selectedBookIds: It ? st : n,
      onChangeSelectedBookIds: It ? Et : s,
      localizedStrings: i,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Zt = Ht === "end", Nr = Ht === "start", Ye = "tw:text-muted-foreground", We = w === "dropdown" && S === "range", Oa = We ? V : Ae, Ia = We ? it : f ? Ut : bt, Gr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: v(Zt && Ye), children: O }),
      /* @__PURE__ */ a(
        Ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: de, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-end", className: v(Nr && Ye), children: q }),
      /* @__PURE__ */ a(
        Ha,
        {
          id: "scope-range-end",
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Oe, { open: he, onOpenChange: oe, children: [
        ...
        Co,
        {
          ...
          children: pt.map(({ value: B, label: et, scrRefSuffix: Pt, id: Se }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            ...
            /* @__PURE__ */ a(zt, { htmlFor: Se, children: lt(et, Pt) })
          ] }, Se))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Gr,
    w === "dropdown" && I && /* @__PURE__ */ a(ro, { open: S === "selectedBooks", onOpenChange: cr, children: /* @__PURE__ */ a(
      ao,
      {
        ref: sr,
        onCloseAutoFocus: Wr,
...
function ko({
  ...
  return /* @__PURE__ */ u(Oe, { variant: s, children: [
    /* @__PURE__ */ a(ye, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(J, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(mc, {}) }) }),
    /* @__PURE__ */ a(Ie, { align: "start", style: { zIndex: Pe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Ur, { children: [
...
const op = Object.freeze([520, 420, 340]), ls = Wt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = cs(n, op), d = Ti() ?? l, w = d >= Pr.MINIMUM;
...
const np = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  me.Trigger,
  {
    ref: r,
    ...e,
...
function cg({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(zt, { className: "tw:font-normal tw:text-muted-foreground", children: je(d, {
...
function Jg(t) {
  const e = $(() => Mc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Sp = () => {
  const [t, e] = _(
