...
import { c as m, g as De, a as Ba, C as Ee, A as ce, P as Ie, b as He, B as G, d as Ae, e as Ve, f as Pe, h as ye, i as Pi, k as ji, j as Li, E as Bi, l as Fa, r as re, m as Fi, n as cn, o as Zr, p as Qr, L as kt, D as _a, q as Na, s as Ca, t as Ea, T as Kt, u as Ua, v as qt, w as Gt, x as Ht, y as ln, z as Ka, F as Ke, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ui, N as Nr, O as Ge, Q as $e, Z as Ye, R as Oe, U as tr, V as qa, W as Ga, X as Kr, Y as Ha, _ as dn, $ as Ki, a0 as qi, a1 as Gi, a2 as vo, a3 as wn, a4 as ta, a5 as un, a6 as Hi, a7 as Yi, a8 as Wi, a9 as Xi, aa as pn, ab as Ji, ac as ia, ad as bo, ae as sa, af as Zi, ag as Qi, ah as ts, ai as es, aj as rs, ak as Cr, al as Ya, am as as, an as os } from "./resizable-Ds9c_6hc.js";
...
import { Check as ar, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as ns, ArrowRight as is, ChevronDown as or, BoldIcon as ss, ItalicIcon as cs, X as Wa, AtSign as hn, Pencil as ls, Trash2 as ds, ArrowUp as gn, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as fn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as mn, FunctionSquare as vn, SquareSigma as bn, Ban as Es, AlertCircle as Sa, CircleCheckIcon as Ts, CircleXIcon as zs, CircleHelpIcon as Ss, ArrowUpIcon as Rs, ArrowDownIcon as Ds, ScrollText as Os, ChevronsUpDown as $s, MenuIcon as Ms, Menu as Is, EllipsisVertical as As, MoreVertical as _o } from "lucide-react";
import { Section as dt, getChaptersForBook as Vs, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as Ps, formatReplacementString as qe, sanitizeHtml as Xa, NumberFormat as js, formatBytes as Ls, getCurrentLocale as Bs, usfmMarkers as Vr, getFormatCallerFunction as Fs, deepEqual as Us, isString as No, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Co, collectUsjMarkers as qs } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as $, useState as k, useCallback as B, useEffect as W, useImperativeHandle as Gs, useLayoutEffect as Zt, createContext as Ja, useContext as xn, Component as Hs, createElement as Eo, Suspense as Ys, forwardRef as yn, useId as To, Fragment as kn } from "react";
import { RadioGroup as Da, ToggleGroup as _n, Avatar as Za, Select as Bt, Checkbox as zo, Slot as Er, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as So, Slider as Dr, Switch as Ro } from "radix-ui";
import { createEditor as Nn, $getRoot as Me, $createParagraphNode as Tr, $getSelection as Yt, HISTORY_MERGE_TAG as Qa, ParagraphNode as Cn, TextNode as En, $getPreviousSelection as Ws, $isRangeSelection as pe, $caretFromPoint as Xs, $getSiblingCaret as Tn, $getChildCaret as Js, $getAdjacentChildCaret as Zs, $isChildCaret as Qs, $normalizeCaret as tc, $setSelectionFromCaretRange as ec, $getCollapsedCaretRange as rc, $getCaretInDirection as Do, $splitAtPointCaretNext as ac, $isTextPointCaret as oc, $findMatchingParent as zn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as nc, isHTMLElement as ic, CLEAR_EDITOR_COMMAND as Sn, COMMAND_PRIORITY_EDITOR as to, shallowMergeConfig as sc, defineExtension as ae, safeCast as We, createState as cc, FORMAT_TEXT_COMMAND as Rn, $isNodeSelection as Dn, COMMAND_PRIORITY_LOW as On, RootNode as lc, LineBreakNode as dc, TabNode as wc, $isEditorState as uc, createCommand as pc, CLICK_COMMAND as hc, isDOMNode as gc, $getNodeFromDOMNode as fc, $createNodeSelection as mc, $setSelection as vc, $getEditor as bc, DecoratorNode as Oa, $getState as xc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as yc, $setState as kc, addClassNamesToElement as $n, $create as _c, $getNodeByKey as Nc, removeClassNamesFromElement as Cc, KEY_TAB_COMMAND as Ec, $isBlockElementNode as Tc, $createRangeSelection as zc, $normalizeSelection__EXPERIMENTAL as Sc, OUTDENT_CONTENT_COMMAND as Rc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as Dc, COMMAND_PRIORITY_CRITICAL as eo, $isDecoratorNode as Oc, $isParagraphNode as $c, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as Mc } from "lexical";
...
import { useReactTable as An, getFilteredRowModel as Uc, getSortedRowModel as Vn, getPaginationRowModel as Kc, getCoreRowModel as Pn, flexRender as vr, getGroupedRowModel as qc, getExpandedRowModel as Gc } from "@tanstack/react-table";
import { IconCheck as ra, IconChevronDown as Hc, IconChevronUp as Yc, IconSelector as Wc, IconLayoutSidebar as Xc, IconLayoutSidebarRight as Jc, IconChevronRight as jn, IconSearch as Zc, IconLoader as Qc, IconAlertOctagon as tl, IconAlertTriangle as el, IconInfoCircle as rl, IconCircleCheck as al } from "@tabler/icons-react";
import ol from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as Ia, getDefaultViewOptions as nl, isInsertEmbedOpOfType as Or, Editorial as il } from "@eten-tech-foundation/platform-editor";
...
function wa({
  ...
  const A = re(), [L, T] = k(!1), [V, M] = k(""), [C, j] = k(""), [D, E] = k("books"), [Y, q] = k(void 0), [F, O] = k(
    void 0
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = St[rt].filter((Pt) => Fa(Pt, C, n));
    }), b;
  }, [St, C, n]), R = $(
    () => gl(C, Wt, n),
    [C, Wt, n]
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Rt } = {
    ...
    (b) => {
      var ve, Le, Se;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: rt } = Io(b.key);
...
function Po({
  ...
  const [_, A] = k(!1), L = l ?? d, T = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], V = (M, C) => {
    const j = d(M), D = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, E = `${C ?? ""}${j}${D ?? ""}`;
    return /* @__PURE__ */ u(
      Ee,
      {
        value: j,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: T(e) ? e.map((M) => /* @__PURE__ */ a(ye, { heading: M.groupHeading, children: M.options.map((C) => V(C, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(ye, { children: e.map((M) => V(M)) }) })
        ] })
      }
    )
  ] });
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Kn ? Zt : W, Mr = { tag: Qa };
function xl({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = vl(null, o), w = Nn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let N = 0; N < h.length; N++) {
      const y = h[N], _ = s[N] || document.createElement("div"), A = _.style;
      ...
      const M = ue(y.height);
      A.height !== M && (_.style.height = M, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[N] = _;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    l(), o = g, n = h, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return p();
      for (const N of f) if (!c.contains(N.target)) return d();
    }), i.observe(h, Ol), d();
  });
  return () => {
    w(), l();
  ...
  function l(w) {
    w.read(() => {
      ...
      const [g, h] = function(M) {
        const C = M.getStartEndPoints();
        return M.isBackward() ? [C[1], C[0]] : C;
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, N = h.getNode(), y = N.getKey(), _ = h.offset, A = t.getElementByKey(x), L = t.getElementByKey(y), T = r === null || A !== o || v !== n || x !== r.getKey(), V = i === null || L !== s || _ !== c || y !== i.getKey();
      if ((T || V) && A !== null && L !== null) {
        const M = function(C, j, D, E, Y, q, F) {
          const O = (C._window ? C._window.document : document).createRange();
          return O.setStart(...jo(j, D, E)), O.setEnd(...jo(Y, q, F)), O;
        }(t, g, f, A, h, N, L);
        d(), d = $l(t, M, e);
      }
      r = f, o = A, n = v, i = N, s = L, c = _;
    });
  }
...
function Pl(t) {
  ...
  if (pe(e)) r = Xs(e.focus, "next");
    ...
    r = r || Js(Me(), "previous").getFlipped().insert(Tr());
  }
...
function jl(t, e, r) {
  ...
  return oc(o) && Gr(283), o.insert(t.isInline() ? Tr().append(t) : t), Do(Tn(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Yt();
  if (!pe(e)) return !1;
...
function ql(t) {
  ...
  Hn(this), nt = t, this.f &= -2, 8 & this.f && no(this), aa();
}
function Ze(t, e) {
...
Lt.prototype.brand = Bl, Lt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yn(this), Fo(this), xe++;
  const t = nt;
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Rn, (o) => {
  const n = Yt();
  if (Dn(n) || pe(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function Zn(t, e) {
  let r;
...
const io = 0, ja = 1, ti = 2, ga = 3, Ir = 4, Je = 5, fa = 6, gr = 7;
function ma(t) {
  return t.id === io;
}
function ei(t) {
...
const Zl = ae({ config: We({ setOptions: Uo, updateOptions: Uo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [lc, En, dc, wc, Cn] }), Ko = Symbol.for("@lexical/extension/LexicalBuilder");
function qo() {
}
function Ql(t) {
  throw t;
...
const td = /* @__PURE__ */ new Set(), Go = ae({ build(t, e, r) {
...
ae({ dependencies: [Pa, Go], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(ed, (s) => {
    ...
    return !0;
  }, to), t.registerCommand(hc, (s) => {
    if (gc(s.target)) {
      const c = fc(s.target);
      if (ad(c)) return function(d, l = !1) {
        const w = Yt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && Dn(w) ? h = w : (h = mc(), vc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (pe(f)) {
                ...
                if ($a(v) && l >= 0 && w >= 0 && (N = l, y = l + w, f.setTextNodeRange(v, N, v, y)), N === y && p === "" || (f.insertRawText(p), v = x.getNode()), $a(v)) {
                  N = g, y = g + h;
                  const _ = v.getTextContentSize();
                  N = N > _ ? _ : N, y = y > _ ? _ : y, f.setTextNodeRange(v, N, v, y);
                }
...
function Xu({
  ...
  const [i, s] = k(Md), [c, d] = k(n), [l, w] = k(!1), p = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const N = g.current;
    if (!N) return;
...
function Jo({
  ...
  }, [t.date, r]), v = $(() => t.user, [t.user]), N = $(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = $(() => Xa(t.contents), [t.contents]), _ = $(
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Pd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(jd, { className: "tw:text-xs tw:font-medium", children: N }) }),
...
function vi({
  ...
  const [E, Y] = k(Zo), [q, F] = k(), [O, S] = k(), Z = o, [Q, _t] = k(!1), [Nt, At] = k(!1), [U, tt] = k(!1), [wt, st] = k(!1), [vt, oe] = k(!1), [at, Vt] = k(A), [St, Wt] = k(!1), ne = K(void 0), [R, Xt] = k(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(it, { children: [
            ...
            v !== !1 && (!Nt || ee(E)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (z) => {
                  wo(z) && (z.preventDefault(), z.stopPropagation(), (ee(E) || q !== void 0 && q !== O) && Ft());
                },
                onKeyDown: (z) => {
...
function Fd({
  ...
  const [s, c] = k("accept"), d = To(), l = To(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = $(
    () => Fr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = $(
    () => Fr(t.acceptedText ?? ""),
  ...
  let C;
  V ? C = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (C = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const j = e["%conflict_note_no_result%"] ?? "No result preview available.", D = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: j }), E = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : D, Y = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Ur, { html: N }) : D : E(O === "reject" ? t.rejectedResultText : t.resultText);
      ...
      children: C.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...Z, conflictResolution: N }) : /* @__PURE__ */ a(vi, { ...Z })
          },
          S.id
        );
      })
...
function Qd({
  ...
  var T;
  const [w, p] = k([]), [g, h] = k([]), [f, x] = k({}), [v, N] = k({}), y = $(() => e ?? [], [e]), _ = An({
    data: y,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  let L;
  return d ? L = Array.from({ length: 10 }).map((C, j) => `skeleton-row-${j}`).map((C) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: A.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? L = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(V, _),
    ...
    /* @__PURE__ */ u(qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ga, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(Oe, { children: V.headers.map((M) => /* @__PURE__ */ a(Kr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : vr(M.column.columnDef.header, M.getContext()) }, M.id)) }, V.id)) }),
...
function cw({
  ...
  const f = (v) => {
    ...
    var N, y, _, A;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((A = s.current) == null || A.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function gp({
  ...
  const [f, x] = k("generated"), [v, N] = k("generated"), [y, _] = k("*"), [A, L] = k("*"), [T, V] = k("f"), [M, C] = k(!1), [j, D] = k(!0), [E, Y] = k(!1), q = K(!1), F = K(""), [O, S] = k(!1), [Z, Q] = k(), [_t, Nt] = k(), [At, U] = k(), [tt, wt] = k(), st = K(null), vt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      ut === Ma ? ct = "generated" : ut === Ia ? ct = "hidden" : ut && (_(ut), L(ut)), x(ct), N(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const at = B(
    (P, X, ot = !1) => {
      ...
      if (et && Or("note", et)) {
        if (et.insert.note) {
          let pt;
          P === "custom" ? pt = X : P === "generated" ? pt = Ma : pt = Ia, et.insert.note.caller = pt;
        }
...
function mp({
  ...
  return W(() => {
    var y;
    h >= 0 && h < N.current.length && ((y = N.current[h]) == null || y.focus());
  }, [h]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function Cp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), N = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), L = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, M] = k(!1), [C, j] = k("all"), [D, E] = k(""), [Y, q] = k([]), F = $(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = $(() => O.length === 0 ? [] : Tw(O, C, D), [O, C, D]), Z = $(() => {
    var wt, st;
    if (!V) return d;
...
const Sw = "16rem", Rw = "3rem", yi = Tt.createContext(void 0);
function na() {
...
function Dw({
  ...
  const [d, l] = Tt.useState(t), w = e ?? d, p = Tt.useCallback(
    ...
    [r, w]
  ), g = Tt.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = re() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = Tt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(yi.Provider, { value: N, children: /* @__PURE__ */ a(
    "div",
    {
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u(Mw, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Pw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Re = "scrBook", Lw = "scrRef", Ue = "source", Bw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", ki = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Lp({
  ...
  W(() => {
    if (c) {
      const C = N.getSelectedRowModel().rowsById, j = Object.keys(C);
      if (j.length === 1) {
        const D = x.find((E) => nn(E) === j[0]) || void 0;
        D && c(D);
      }
    }
  }, [h, x, c, N]);
  const y = n ?? Uw, _ = i ?? ki, A = [
    ...
    !C.getIsGrouped() && !C.getIsSelected() && C.getToggleSelectedHandler()(j);
  }, V = (C, j) => C.getIsGrouped() ? "" : m("banded-row", j % 2 === 0 ? "even" : "odd"), M = (C, j, D) => {
    if (!((C == null ? void 0 : C.length) === 0 || j.depth < D.column.getGroupedIndex())) {
      if (j.getIsGrouped())
        switch (j.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: A.map((C) => /* @__PURE__ */ a(se, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(qa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ga, { children: N.getHeaderGroups().map((C) => /* @__PURE__ */ a(Oe, { children: C.headers.filter((j) => j.column.columnDef.header).map((j) => (
      ...
      /* @__PURE__ */ a(Ha, { children: N.getRowModel().rows.map((C, j) => {
        const D = re();
        return /* @__PURE__ */ a(
          Oe,
          {
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (D === "ltr" ? /* @__PURE__ */ a(za, {}) : /* @__PURE__ */ a(Ta, {})),
                          " ",
...
function Hw({
  ...
  }, [x, v] = k(!1), [N, y] = k(""), _ = K(void 0), A = K(!1), L = $(
    () => _i(t),
    [t]
  ), T = $(() => {
    if (!N.trim()) {
...
function Fp({
  ...
  ), gt = tt.find((I) => I.value === "selectedBooks"), pt = tt.find((I) => I.value === "range"), [ft, Rt] = k(!1), [Dt, Ft] = k(void 0), [Ot, Te] = k(void 0), [z, $t] = k(void 0), [yt, de] = k(void 0), [ze, wr] = k([]), ur = l === "dropdown" && Dt === "selectedBooks", pr = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  const ho = B(
    (I) => {
      Te(I), $t(st), de(vt), wr(n), Rt(!1), Ft(I);
    },
    [st, vt, n]
  ), go = B(() => {
  ...
  }, []), mo = (I) => t === I ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }) : void 0;
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: Jt, children: [
              ct.map(({ value: I, label: J, dropdownLabel: Ut, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ u(
                Ke,
                {
                  ref: Se(I),
...
function Wp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(zi, { children: [
      /* @__PURE__ */ a(Si, { children: t.map((c) => /* @__PURE__ */ a(Zw, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (N = d.current) == null || N.focus(), fr(d, [g, h]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Kt, { children: Di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Zp({
  ...
  const l = du(
    ...
    var N, y, _, A, L, T;
    const v = x !== f ? ((y = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : y[x]) ?? ((A = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : A.en) : void 0;
      ...
      l.map(({ tag: f, info: x, keywords: v }) => {
        ...
        return /* @__PURE__ */ u(
          Ee,
          {
            ...
            "data-checked": N ? "true" : void 0,
            onSelect: () => r(f),
            children: [
              /* @__PURE__ */ a("span", { dir: "auto", children: x.autonym }),
              N && /* @__PURE__ */ a("span", { className: "tw:sr-only", children: h })
            ]
          },
          f
        );
