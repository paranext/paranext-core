...
import { c as v, g as Ae, a as jr, C as tr, L as Gn, u as an, T as zt, b as kt, d as _t, e as Nt, A as _a, D as Be, f as Se, h as je, i as cr, j as Ge, B as tt, x as Cs, k as Es, l as Ts, I as Ss, m as Ro, n as Xe, r as Oe, o as Rs, p as Wn, P as lr, q as Rr, s as dr, t as wr, v as za, w as Pa, y as Do, z as ur, E as Aa, F as It, R as Oo, G as Na, H as co, J as lo, K as wo, M as uo, N as Yn, O as ha, Q as Mo, S as Hr, U as qr, V as xr, W as Ds, X as ir, Y as Ze, Z as Fe, _ as We, $ as yr, a0 as Io, a1 as zo, a2 as Ca, a3 as Po, a4 as Zn, a5 as Os, a6 as Ms, a7 as Is, a8 as po, a9 as Xn, aa as $a, ab as zs, ac as Jn, ad as Ps, ae as As, af as $s, ag as on, ah as Vs, ai as Ls, aj as Bs, ak as Qn, al as ti, am as Ao, an as js, ao as ei, ap as qa, aq as nn, ar as Ga, as as Fs, at as Us, au as Ks, av as Hs, aw as qs, ax as Gs, ay as Zr, az as $o, aA as Ws, aB as Ys } from "./resizable-DOlm3N_b.js";
...
import Zt, { useRef as V, useMemo as z, createContext as Dr, useContext as Xr, useState as N, useEffect as J, useCallback as $, useId as Ta, useImperativeHandle as Fc, useLayoutEffect as Xt, Fragment as Jr, Component as Uc, createElement as go, Suspense as Kc, forwardRef as Lo, memo as wi } from "react";
...
import { Avatar as Uo, Select as Jt, Checkbox as fn, Slot as ta, Tabs as be, Menubar as Me, ContextMenu as Ft, Progress as mn, Slider as ca, Switch as vn } from "radix-ui";
...
function Xa({
  ...
  const B = Oe(), U = dd(), [I, O] = N(!1), [R, W] = N(""), [Y, at] = N(""), [y, et] = N("books"), [Z, A] = N(void 0), [X, F] = N(
    ...
    if (!_) return;
    const m = R.startsWith(`${_.book} `) ? R : "", q = la(m), it = Lr(m);
    return {
      book: _.book,
  ...
  const { otLong: _e, ntLong: Ne, dcLong: rr, extraLong: ar } = {
    ...
    () => bd(Y),
    [Y]
  ), st = z(() => !w || !_ || !_.chapterNum || !nt ? !1 : w(_.book, _.chapterNum) > 0, [w, _, nt]), Ht = y === "books" && !mt && !Y.trim() && Tt.size > 0, zr = $(
    (m) => p ? yn(m, p) : !1,
    [p]
  ), Pe = $(
    (m) => (q) => p ? xd(m, q, p) : !1,
...
function Zd(t, e, r) {
  ...
  return dl(o) && Sa(283), o.insert(t.isInline() ? Qr().append(t) : t), pn(mi(t.getLatest(), "next"), e.direction);
}
function Xd(t) {
  const e = ae();
  if (!Re(e)) return !1;
...
const Go = 0, To = 1, Hi = 2, eo = 3, ua = 4, vr = 5, ro = 6, $r = 7;
function ao(t) {
  return t.id === Go;
}
function qi(t) {
...
function Vn({
  ...
  const w = ea(), [p, h] = N(), f = d ?? p, x = f !== void 0 && o, g = l !== void 0, T = $(
    (y) => {
      g || h(y), l == null || l(y);
    },
    [g, l]
...
const Xw = {
  ...
  var Ke;
  const et = ea(), [Z, A] = N({}), X = at ?? Z, F = X.editorState ?? Xw, G = X.assignedUser, ut = y !== void 0, mt = V(X);
  mt.current = X;
  const K = $(
    (S) => {
  ...
  const hr = !Ut || !g || g.length === 0 || !g.includes(c), Mr = !ie(F) && (G === void 0 || G === vt), Ir = /* @__PURE__ */ a(
    Vn,
    {
      comment: ot,
      localizedStrings: o,
...
function tu({
  ...
  const [i, c] = N("accept"), d = Ta(), l = Ta(), w = ea(), p = r === "loading", h = r === "accept", f = r === "none", b = r === "acceptRejectOrMerge", x = h ? "accept" : i, g = z(
    () => ya(t.rejectedText ?? ""),
    [t.rejectedText]
  ), T = z(
    () => ya(t.acceptedText ?? ""),
...
function uu({
  ...
  return d ? P = Array.from({ length: 10 }).map((O, R) => `skeleton-row-${R}`).map((O) => /* @__PURE__ */ a(We, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(yr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(xr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((B = C.getRowModel().rows) == null ? void 0 : B.length) > 0 ? P = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    We,
    {
      ...
      children: U.getVisibleCells().map((I) => /* @__PURE__ */ a(yr, { children: Fr(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    U.id
    ...
    /* @__PURE__ */ u(Io, { stickyHeader: s, children: [
      /* @__PURE__ */ a(zo, { stickyHeader: s, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(We, { children: U.headers.map((I) => /* @__PURE__ */ a(Ca, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Fr(I.column.columnDef.header, I.getContext()) }, I.id)) }, U.id)) }),
...
function Kh({
  ...
  const Ot = $(
    (D = !1) => {
      ...
      H && Ar("note", H) && (r == null || r([H]), D && l && s && ((Q = l.current) == null || Q.replaceEmbedUpdate(s, [H])));
    },
    [s, r, p, l]
  ), xe = $(
    (D, H) => {
          ...
          children: r.map((E, P) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Zt.Fragment, { children: [
                ...
                P < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(qr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, U)
            );
          })
        }
    ...
    /* @__PURE__ */ u(Io, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(zo, { children: T.getHeaderGroups().map((O) => /* @__PURE__ */ a(We, { children: O.headers.filter((R) => R.column.columnDef.header).map((R) => (
        ...
        /* @__PURE__ */ a(Ca, { colSpan: R.colSpan, className: "tw:sticky top-0", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Fr(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, O.id)) }),
                    ...
                    children: Y.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          Fr(Y.column.columnDef.cell, Y.getContext()),
                          " (",
                          O.subRows.length,
                          ")"
                        ]
...
function mg({
  ...
  const [Ht, zr] = N(null), [Pe, gr] = N(null), [fr, Ua] = N(null), ra = 200, [Ka, aa] = N(!1);
  J(() => {
  ...
  if (od(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Vr(s, [h, f]);
        break;
      case "alt+l":
