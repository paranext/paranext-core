...
function Ii({
  ...
  const c = at(), [p, f] = A(!1), [h, g] = A(""), [b, y] = A(""), [N, V] = A("books"), [x, _] = A(void 0), [X, z] = A(!1), P = nt(void 0), F = nt(void 0), H = nt(void 0), R = nt(void 0), C = nt({}), B = G(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
...
function Io({
  ...
  return u ? z = Array.from({ length: 10 }).map((R, C) => `skeleton-row-${C}`).map((R) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Pt, { colSpan: X.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(qe, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, R)) : ((P = _.getRowModel().rows) == null ? void 0 : P.length) > 0 ? z = _.getRowModel().rows.map((F) => /* @__PURE__ */ r(
    ...
    F.id
  )) : z = /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Pt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    o && /* @__PURE__ */ r(yo, { table: _ }),
    /* @__PURE__ */ l(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: _.getHeaderGroups().map((F) => /* @__PURE__ */ r(Ct, { children: F.headers.map((H) => /* @__PURE__ */ r(de, { children: H.isPlaceholder ? void 0 : ie(H.column.columnDef.header, H.getContext()) }, H.id)) }, F.id)) }),
...
function Go({
  ...
  return /* @__PURE__ */ l(kt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: d("textual-note-body tw-pr-0.5", g), children: w && w.length > 0 && /* @__PURE__ */ r(kt, { children: jo(t.marker, w, a, c) }) })
  ] });
}
...
function Fi({
  ...
  const p = c ? Ko(c, "%webView_footnoteList_header%") : "Footnotes", f = w ?? Ma(e, void 0), h = (x, _) => {
    u == null || u(x, _, a);
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ut, { onValueChange: (T) => xt(T), defaultValue: i, children: [
        ...
        /* @__PURE__ */ l(jt, { children: [
          ...
          /* @__PURE__ */ r(dt, { value: "verse", children: V })
        ] })
      ] }),
      /* @__PURE__ */ r(
        he,
...
function tw({
  ...
  const [c, p] = A([]), [f, h] = A([{ id: Rt, desc: !1 }]), [g, b] = A({}), y = J(
    ...
    !e && /* @__PURE__ */ l(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: X.map((R) => /* @__PURE__ */ r(dt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(dt, { value: `${c}`, children: w[L(c)] }, `${c}`))
          }
        )
      ]
    }
...
const mi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = A(void 0), [w, u] = A(void 0), c = G(
    (h) => {
      i(h);
