...
import { getChaptersForBook as br, NumberFormat as vr, formatBytes as xr, deepEqual as xe, substring as yr, formatScrRef as re, compareScrRefs as le, scrRefToBBBCCCVVV as ae, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
import { useHotkeys as Tr } from "react-hotkeys-hook";
...
const Jt = V.Root, ye = V.Trigger, tn = V.Group, Mr = V.Portal, Vr = V.Sub, Jo = V.RadioGroup, en = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  V.SubTrigger,
  {
    ref: o,
    className: l(
...
const Te = _.allBookIds.filter((t) => !_.isObsolete(_.bookIdToNumber(t))), Jr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function Wo({
  ...
  const o = $(), [s, w] = B(""), [i, p] = B(
    ...
    Wr.forEach((C) => {
      const E = s.match(C);
      if (E) {
        const [O, G = void 0, F = void 0] = E.slice(1), It = ta(O);
...
const ea = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? St : "button", { className: l(ea({ variant: e, size: n, className: t })), ref: s, ...o })
);
M.displayName = "Button";
const na = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), J = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: l("pr-twp", na(), t), ...e }));
...
function ca({ table: t }) {
  return /* @__PURE__ */ d(Jt, { children: [
    /* @__PURE__ */ r(Un, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function es({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: l(
...
function rs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    M,
    {
      className: l(
  ...
  return /* @__PURE__ */ d(Wt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Qt, { children: s.length > 0 && s.map((w) => /* @__PURE__ */ d(
      wt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Nt, { children: `${_.bookNumberToEnglishName(w.reference.bookNum)} ${w.reference.chapterNum}:${w.reference.verseNum}` }),
...
}, _a = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bn = ft(
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(pr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ds = (t) => ({
  accessorKey: "item",
  ...
  return Ra(t).forEach((m) => {
    m.startsWith("\\id") && (w = Ta(m), i = 0, p = 0), m.startsWith("\\c") && (i = $e(m), p = 0), m.startsWith("\\v") && (p = $e(m), i === 0 && (i = e.chapterNum));
...
function ms({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, z] = B(""), [K, P] = B([]), Et = Q(() => i ? a instanceof RegExp ? Ma(
    i,
    t,
    s,
    w,
    a
  ) : a(i, t, s, w) : [], [i, a, t, s, w]), dt = Q(() => {
    if (j) return Et;
    const R = [];
    return Et.forEach((Y) => {
      const st = Y.items[0], ct = R.find(
        (vt) => vt.items[0] === st
      );
      ct ? (ct.count += Y.count, ct.occurrences = ct.occurrences.concat(Y.occurrences)) : R.push({
        items: [st],
        count: Y.count,
  ...
  }, [j, Et]), C = Q(() => Ia(dt, rt, b), [dt, rt, b]), E = Q(() => {
    var st, ct;
    if (!j) return m;
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = ne(), m = /* @__PURE__ */ r(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(Ga({ variant: n, size: a }), s),
        ...w
      }
    );
...
function gs({
  ...
  }, rt = (b, z) => b.getIsGrouped() ? "" : l("banded-row", z % 2 === 0 ? "even" : "odd"), zt = (b, z, K) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(Wt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Zt, { children: y.getHeaderGroups().map((b) => /* @__PURE__ */ r(wt, { children: b.headers.filter((z) => z.column.columnDef.header).map((z) => (
        ...
        /* @__PURE__ */ r(Xt, { colSpan: z.colSpan, className: "top-0 tw-sticky", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
...
const ro = (t, e) => {
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map((i) => /* @__PURE__ */ d(Ae, { children: [
  ...
  ] }, `dropdown-menu-sub-${i.label}`) }),
  i.tooltip && /* @__PURE__ */ r(ee, { children: i.tooltip })
] }, `tooltip-${i.label}`))) : void 0;
function ys({
  commandHandler: t,
  menuData: e,
  tabLabel: n,
  ...
  return /* @__PURE__ */ d(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, i]) => typeof w == "boolean" || typeof i == "boolean" ? 0 : w.order - i.order).map(([w], i, p) => /* @__PURE__ */ d(Yn, { children: [
...
io.displayName = D.CheckboxItem.displayName;
...
wo.displayName = D.RadioItem.displayName;
...
lo.displayName = D.Label.displayName;
const Gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  D.Separator,
  {
    ref: n,
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((u) => u.group === s).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ d(Ae, { children: [
    ...
    return i.length > 0 && w < o.length - 1 && p.push(/* @__PURE__ */ r(Gn, {}, `separator-${s}`)), p;
  });
};
function po({
  menuData: t,
  ...
  if (Tr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    var v, x, y, N;
    m.preventDefault();
...
), ho = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(mo({ variant: e }), t), ...n }));
...
go.displayName = "AlertTitle";
const fo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
bo.displayName = Rt.Root.displayName;
...
vo.displayName = Rt.Image.displayName;
...
xo.displayName = Rt.Fallback.displayName;
...
const Co = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const zs = U.Root, zo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Eo.displayName = U.Trigger.displayName;
...
export {
  ...
  vo as AvatarImage,
  Zo as BOOK_SELECTOR_STRING_KEYS,
  ka as Badge,
  Wo as BookChapterControl,
