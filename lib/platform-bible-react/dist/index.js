import ul, { jsx as i, jsxs as v, Fragment as te } from "react/jsx-runtime";
...
import { ChevronRight as Co, Check as tn, Circle as Ro, X as Oo, Search as Si, ChevronsUpDown as Ti, FilterIcon as hl, ChevronDown as mr, ChevronUp as gl, ArrowLeftIcon as bl, ChevronLeftIcon as vl, ChevronRightIcon as yl, ArrowRightIcon as xl, CircleCheckIcon as Nl, CircleXIcon as kl, CircleHelpIcon as El, ArrowUpIcon as Sl, ArrowDownIcon as Tl, ArrowUpDownIcon as Cl, Star as Rl, PanelLeft as Ol, PanelRight as Pl, ChevronLeft as _l, LoaderCircle as Il, Download as $l, Filter as Ml, User as Al, Link as Dl, CircleHelp as jl } from "lucide-react";
import { getChaptersForBook as Bl, deepEqual as Po, substring as Vl, formatScrRef as Ur, compareScrRefs as so, scrRefToBBBCCCVVV as Xr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as zl, formatBytes as Fl } from "platform-bible-utils";
...
import { useReactTable as Ri, getFilteredRowModel as Ll, getSortedRowModel as Oi, getPaginationRowModel as Gl, getCoreRowModel as Pi, flexRender as Nn, getGroupedRowModel as Ul, getExpandedRowModel as Xl } from "@tanstack/react-table";
...
import * as _i from "@radix-ui/react-toggle";
...
import { MenuItem as Wl, ListItemText as Kl, ListItemIcon as $i, Menu as Jl, Grid as Mi, List as Zl, IconButton as Ai, Drawer as Ql } from "@mui/material";
...
const _o = mt.Root, Di = mt.Trigger, ic = mt.Group, Wm = mt.Portal, Km = mt.Sub, Jm = mt.RadioGroup, sc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ v(
  mt.SubTrigger,
  {
    ref: o,
    className: x(
...
sc.displayName = mt.SubTrigger.displayName;
...
lc.displayName = mt.SubContent.displayName;
...
const Io = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ v(
  mt.CheckboxItem,
  {
    ref: o,
    className: x(
...
const Bi = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ v(
  mt.RadioItem,
  {
    ref: r,
    className: x(
...
const Do = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), Ec = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ra = ["OT", "NT", "DC"], Sc = 96, Tc = [
  /^(\w+)$/i,
...
function Qm({
  ...
  }, [m]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ v(_o, { modal: !1, open: g, onOpenChange: F, children: [
      ...
      gr,
      {
        ...
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: Ra.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ v("div", { children: [
            /* @__PURE__ */ i(br, { className: "tw-font-semibold tw-text-foreground/80", children: Ec[j] }),
...
), jt = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(Ci.Root, { ref: n, className: x("pr-twp", _c(), t), ...e }));
...
const Ic = Jt.Portal, qi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Jt.Overlay,
  {
    ref: n,
    className: x(
...
$c.displayName = Jt.Content.displayName;
...
Mc.displayName = Jt.Title.displayName;
...
Ac.displayName = Jt.Description.displayName;
...
function uo({
  ...
  const [h, k] = ut(!1);
  return /* @__PURE__ */ v(Yi, { open: h, onOpenChange: k, ...m, children: [
    /* @__PURE__ */ i(Hi, { asChild: !0, children: /* @__PURE__ */ v(
      ft,
      {
        variant: w,
        role: "combobox",
    ...
    /* @__PURE__ */ i(
      jo,
      {
        ...
        children: /* @__PURE__ */ v(Bo, { children: [
          /* @__PURE__ */ i(Vo, { placeholder: p, className: "tw-text-inherit" }),
          /* @__PURE__ */ i(Fo, { children: f }),
          /* @__PURE__ */ i(zo, { children: e.map((T) => /* @__PURE__ */ v(
            Lo,
            {
              value: l(T),
              onSelect: () => {
...
function eh({
  ...
  const p = Yr(d, "%webView_bookSelector_currentBook%"), f = Yr(d, "%webView_bookSelector_choose%"), w = Yr(d, "%webView_bookSelector_chooseBooks%"), [g, y] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    y(h), t(h);
...
function zc({ table: t }) {
  return /* @__PURE__ */ v(_o, { children: [
    /* @__PURE__ */ i(ml, { asChild: !0, children: /* @__PURE__ */ v(ft, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ i(hl, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ v(gr, { align: "end", className: "tw-w-[150px]", children: [
...
const Xe = yt.Root, Fc = yt.Group, Ye = yt.Value, Te = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = kt();
  return /* @__PURE__ */ v(
    yt.Trigger,
    {
...
Lc.displayName = yt.Label.displayName;
...
Gc.displayName = yt.Separator.displayName;
function Uc({ table: t }) {
...
function Hc({
  ...
  var h;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [g, y] = ut({}), m = Ri({
    data: e,
    columns: t,
    getCoreRowModel: Pi(),
  ...
  return /* @__PURE__ */ v("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(zc, { table: m }),
    /* @__PURE__ */ v(yr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(xr, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(de, { children: k.headers.map((T) => /* @__PURE__ */ i(Rn, { children: T.isPlaceholder ? void 0 : Nn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ i(Nr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        de,
        {
          onClick: () => s(k, m),
...
function qc({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = Ot(() => {
    const s = [];
    return t.forEach((l) => {
      s.some((c) => Po(c, l)) || s.push(l);
    }), s;
  }, [t]);
  return /* @__PURE__ */ v(yr, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(xr, { stickyHeader: !0, children: /* @__PURE__ */ v(de, { children: [
      /* @__PURE__ */ i(Rn, { children: r }),
      /* @__PURE__ */ i(Rn, { children: o })
    ] }) }),
    /* @__PURE__ */ i(Nr, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ v(
      de,
      {
        onClick: () => {
          e(s.reference);
...
}, Jc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Zi = _e(
...
), Zc = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  _i.Root,
  {
    ref: o,
...
Zc.displayName = _i.Root.displayName;
...
const kr = (t) => t === "asc" ? /* @__PURE__ */ i(Sl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Tl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Cl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), nh = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ v(ts, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        er,
        {
          onClick: () => Hr(
  ...
  return Wc(t).forEach((p) => {
    p.startsWith("\\id") && (s = Kc(p), l = 0, c = 0), p.startsWith("\\c") && (l = Oa(p), c = 0), p.startsWith("\\v") && (c = Oa(p), l === 0 && (l = e.chapterNum));
...
function ih({
  ...
  const f = ne(n, "%webView_inventory_all%"), w = ne(n, "%webView_inventory_approved%"), g = ne(n, "%webView_inventory_unapproved%"), y = ne(n, "%webView_inventory_unknown%"), m = ne(n, "%webView_inventory_scope_currentBook%"), h = ne(n, "%webView_inventory_scope_chapter%"), k = ne(n, "%webView_inventory_scope_verse%"), T = ne(n, "%webView_inventory_filter_text%"), C = ne(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, b] = ut(!1), [_, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Ot(() => l ? r instanceof RegExp ? ed(
    l,
    t,
    a,
    s,
...
function nd({
  ...
  return /* @__PURE__ */ i("div", { className: d, children: /* @__PURE__ */ v(Yi, { open: p, onOpenChange: f, children: [
    /* @__PURE__ */ i(Hi, { asChild: !0, children: /* @__PURE__ */ v(
      ft,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ i(jo, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ v(Bo, { children: [
      /* @__PURE__ */ i(Vo, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ v(zo, { children: [
        /* @__PURE__ */ i(Fo, { children: a }),
        /* @__PURE__ */ i(Wi, { children: y.map((m) => {
          ...
          return /* @__PURE__ */ v(
            Lo,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: m.starred && /* @__PURE__ */ i(Rl, { className: "tw-h-4 tw-w-4" }) }),
...
const rd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  $t.Trigger,
  {
    ref: n,
    ...e,
...
function sh({
  ...
  return /* @__PURE__ */ v("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ v(ns, { children: [
      /* @__PURE__ */ i(rs, { children: t.map((s) => /* @__PURE__ */ i(rd, { value: s.value, children: s.value }, s.key)) }),
...
const od = $n.Provider, ad = $n.Root, id = $n.Trigger, as = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  $n.Content,
  {
    ref: r,
    sideOffset: e,
...
const sd = "16rem", ld = "3rem", is = E.createContext(void 0);
function Er() {
...
const ss = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(is.Provider, { value: T, children: /* @__PURE__ */ i(od, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const cd = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = Er();
  return /* @__PURE__ */ v(
    ft,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i(Ol, {}) : /* @__PURE__ */ i(Pl, {}),
...
const pd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  nn,
  {
    ref: n,
    "data-sidebar": "input",
...
fd.displayName = "SidebarSeparator";
...
const md = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? en : "button",
  {
    ref: r,
  ...
  ({
    ...
    const c = t ? en : "button", { state: d } = Er(), p = /* @__PURE__ */ i(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: x(hd({ variant: n, size: r }), a),
        ...s
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ v(ad, { children: [
      /* @__PURE__ */ i(id, { asChild: !0, children: p }),
      /* @__PURE__ */ i(as, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ws.displayName = "SidebarMenuButton";
const gd = E.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ i(
  e ? en : "button",
  {
    ref: o,
...
gd.displayName = "SidebarMenuAction";
...
const vd = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ v(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ i(Pa, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ i(
          Pa,
          {
...
vd.displayName = "SidebarMenuSkeleton";
...
const Nd = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? en : "a",
  {
    ref: a,
...
function kd({
  ...
  return /* @__PURE__ */ i(
    ls,
    {
      ...
      children: /* @__PURE__ */ v(ds, { children: [
        /* @__PURE__ */ v(wo, { children: [
          /* @__PURE__ */ i(fo, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ i(mo, { children: /* @__PURE__ */ i(ps, { children: e.map((f) => /* @__PURE__ */ i(us, { children: /* @__PURE__ */ i(
            ws,
            {
              className: x(
...
function lh({
  ...
  return /* @__PURE__ */ v("div", { className: "tw-box-border tw-flex tw-h-full tw-flex-col tw-p-3", children: [
    ...
    /* @__PURE__ */ v(ss, { id: t, className: "tw-h-full tw-flex-1 tw-gap-4 tw-overflow-auto", children: [
      /* @__PURE__ */ i(
        kd,
        {
          extensionLabels: e,
      ...
      /* @__PURE__ */ i(cs, { className: "tw-overflow-y-auto", children: r })
    ] })
  ] });
}
const le = "scrBook", Ed = "scrRef", be = "source", Sd = "details", Td = "Scripture Reference", Cd = "Scripture Book", fs = "Type", Rd = "Details";
function Od(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, _a = (t) => `${Pd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ch({
  sources: t,
  ...
  pe(() => {
    if (l) {
      ...
      if (I.length === 1) {
        const L = y.find((D) => _a(D) === I[0]) || void 0;
        L && l(L);
      }
    }
  }, [w, y, l, h]);
  const k = o ?? Cd, T = a ?? fs, C = [
    ...
    !e && /* @__PURE__ */ v(
      Xe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ce, { position: "item-aligned", children: /* @__PURE__ */ i(Fc, { children: C.map((R) => /* @__PURE__ */ i(zt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ v(yr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(xr, { children: h.getHeaderGroups().map((R) => /* @__PURE__ */ i(de, { children: R.headers.filter((I) => I.column.columnDef.header).map((I) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(Rn, { colSpan: I.colSpan, className: "top-0 tw-sticky", children: I.isPlaceholder ? void 0 : /* @__PURE__ */ v("div", { children: [
      ...
      /* @__PURE__ */ i(Nr, { children: h.getRowModel().rows.map((R, I) => {
        const L = kt();
        return /* @__PURE__ */ i(
          de,
          {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ v(
                      ft,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(Co, {}) : /* @__PURE__ */ i(_l, {})),
                          " ",
...
var Aa;
function gs() {
  return Aa || (Aa = 1, process.env.NODE_ENV === "production" ? qn.exports = $d() : qn.exports = Md()), qn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function jd() {
  if (za) return eo;
  za = 1;
  var t = gs(), e = Ad(), n = /* @__PURE__ */ Yo(), r = /* @__PURE__ */ bs(), o = /* @__PURE__ */ Dd(), a = function() {
  };
  ...
  return eo = function(l, c) {
    ...
    function h(N) {
      ...
      function X(K, q, W, Y, Z, Q, dt) {
        ...
        return q[W] == null ? K ? q[W] === null ? new m("The " + Z + " `" + Q + "` is marked as required " + ("in `" + Y + "`, but its value is `null`.")) : new m("The " + Z + " `" + Q + "` is marked as required in " + ("`" + Y + "`, but its value is `undefined`.")) : null : N(q, W, Y, Z, Q);
      }
      var z = X.bind(null, !1);
    ...
    function I(N) {
      ...
      function X(z, K, q, W, Y) {
        ...
        return new m("Invalid " + W + " `" + Y + "` supplied to " + ("`" + q + "`" + Et + "."));
      }
      return h(X);
    }
    function L() {
...
function Vd() {
  ...
  if (La = 1, process.env.NODE_ENV !== "production") {
    var t = gs(), e = !0;
    Hn.exports = /* @__PURE__ */ jd()(t.isElement, e);
  } else
    Hn.exports = /* @__PURE__ */ Bd()();
  return Hn.exports;
}
var zd = /* @__PURE__ */ Vd();
const u = /* @__PURE__ */ ms(zd);
function Fd(t) {
  const {
    prototype: e = {}
  } = t;
...
function vs(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Fd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
var Xa;
function Yd() {
  return Xa || (Xa = 1, process.env.NODE_ENV === "production" ? Wn.exports = Ud() : Wn.exports = Xd()), Wn.exports;
}
var Ya = Yd();
...
function gn() {
  const t = op(Mn.create).current;
  return ip(t.disposeEffect), t;
}
let Sr = !0, go = !1;
const sp = new Mn(), lp = {
  text: !0,
...
function cp(t) {
  ...
  return !!(n === "INPUT" && lp[e] && !t.readOnly || n === "TEXTAREA" && !t.readOnly || t.isContentEditable);
}
function dp(t) {
...
function up(t) {
  t.addEventListener("keydown", dp, !0), t.addEventListener("mousedown", ro, !0), t.addEventListener("pointerdown", ro, !0), t.addEventListener("touchstart", ro, !0), t.addEventListener("visibilitychange", pp, !0);
}
function wp(t) {
  const {
    target: e
...
function Es() {
  ...
  function n() {
    return e.current ? (go = !0, sp.start(100, () => {
      go = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
    return wp(o) ? (e.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: e,
    onFocus: r,
...
function bp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = St(t, hp), a = gp(e), s = Object.keys(a);
  function l(w) {
...
function xt(t) {
  const {
    ...
    return oe(s, l, (f) => {
      let w = lr(d, o, f);
      return f === w && typeof f == "string" && (w = lr(d, o, `${e}${f === "default" ? "" : Zt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const kp = {
  ...
  if (t.length > 2)
    if (Qa[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = kp[e], o = Ep[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), Rr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Or = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Tp = [...Rr, ...Or];
function An(t, e, n, r) {
  var o;
...
function Rp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = Sp(n), a = Cp(o, r), s = t[n];
  return oe(t, s, a);
}
function Ps(t, e) {
  const n = Os(t.theme);
  return Object.keys(t).map((r) => Rp(t, e, r, n)).reduce(kn, {});
}
function bt(t) {
  return Ps(t, Rr);
}
...
vt.filterProps = Or;
process.env.NODE_ENV !== "production" && Tp.reduce((t, e) => (t[e] = ue, t), {});
function Op(t = 8) {
  if (t.mui)
    return t;
  const e = Os({
...
const Pp = Xt("border", Ft), _p = Xt("borderTop", Ft), Ip = Xt("borderRight", Ft), $p = Xt("borderBottom", Ft), Mp = Xt("borderLeft", Ft), Ap = Xt("borderColor"), Dp = Xt("borderTopColor"), jp = Xt("borderRightColor"), Bp = Xt("borderBottomColor"), Vp = Xt("borderLeftColor"), zp = Xt("outline", Ft), Fp = Xt("outlineColor"), _r = (t) => {
...
Pr(Pp, _p, Ip, $p, Mp, Ap, Dp, jp, Bp, Vp, _r, zp, Fp);
const Ir = (t) => {
...
Pr(Ir, $r, Mr, Lp, Gp, Up, Xp, Yp, Hp, qp, Wp, Kp);
function Ue(t, e) {
  return e === "grey" ? e : t;
}
const Jp = xt({
...
function lu() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : oe(s, r, (y) => {
      let m = lr(w, p, y);
      return y === m && typeof y == "string" && (m = lr(w, p, `${n}${y === "default" ? "" : Zt(y)}`, y)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = yp(a.breakpoints), f = Object.keys(p);
      let w = p;
...
function Zo(t = {}, ...e) {
  ...
  return d.applyStyles = cu, d = e.reduce((p, f) => re(p, f), d), d.unstable_sxConfig = P({}, Jo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Ar({
      sx: f,
      theme: this
    });
...
const wu = ["ownerState"], fu = ["variants"], mu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function hu(t) {
  return Object.keys(t).length === 0;
}
function gu(t) {
...
const bu = Zo(), ti = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Kn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function yu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ql(s, (b) => b.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = vu(ti(d))
    } = l, g = St(l, mu), y = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), m = f || !1;
    let h;
    process.env.NODE_ENV !== "production" && c && (h = `${c}-${ti(d || "Root")}`);
    let k = nr;
    d === "Root" || d === "root" ? k = r : d ? k = o : gu(s) && (k = void 0);
    const T = Yl(s, P({
      shouldForwardProp: k,
      label: h
    }, g)), C = (b) => typeof b == "function" && b.__emotion_real !== b || xe(b) ? (_) => rr(b, P({}, _, {
      theme: Kn({
        theme: _.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Zt(d || "")}`), D === void 0 && (D = `Styled(${Wd(s)})`), L.displayName = D;
      }
...
function ei(t) {
  t = Oe(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Oe(Eu(t)).values : t.values;
...
const Pn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Ou = ["mode", "contrastThreshold", "tonalOffset"], ri = {
...
function oi(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = Tu(t.main, o) : e === "dark" && (t.dark = Su(t.main, a)));
}
function Pu(t = "light") {
  return t === "dark" ? {
    main: Ve[200],
...
function Du(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Ou), a = t.primary || Pu(e), s = t.secondary || _u(e), l = t.error || Iu(e), c = t.info || $u(e), d = t.success || Mu(e), p = t.warning || Au(e);
  function f(m) {
    const h = ni(m, oo.text.primary) >= n ? oo.text.primary : ri.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = ni(m, h);
...
The color object needs to have a \`main\` property or a \`${k}\` property.` : qe(11, h ? ` (${h})` : "", k));
...
} });` : qe(12, h ? ` (${h})` : "", JSON.stringify(m.main)));
    return oi(m, "light", T, r), oi(m, "dark", C, r), m.contrastText || (m.contrastText = f(m.main)), m;
  }, g = {
    dark: oo,
    light: ri
  };
...
const zu = 0.2, Fu = 0.14, Lu = 0.12;
function ht(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${zu})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${Fu})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${Lu})`].join(",");
}
const Gu = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Uu = ["duration", "easing", "delay"], Xu = {
...
function qu(t) {
  const e = P({}, Xu, t.easing), n = P({}, Yu, t.duration);
  return P({
...
const Wu = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Ku = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Ju(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
...
`));
  ...
  return d.unstable_sxConfig = P({}, Jo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Ar({
      sx: f,
      theme: this
    });
...
const Zu = (t) => nr(t) && t !== "classes", jn = yu({
  themeId: ea,
  defaultTheme: ta,
...
const tw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], ew = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = na({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = St(r, tw), y = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", m = P({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), aw = /* @__PURE__ */ _d(ow);
var li;
function iw() {
...
function sw() {
  ...
  var e = t(/* @__PURE__ */ iw()), n = ul;
  return un.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), un;
}
var lw = /* @__PURE__ */ sw();
const cw = /* @__PURE__ */ ms(lw);
function dw(t) {
  return typeof t == "string";
}
function bn(t, e, n) {
  return t === void 0 || dw(t) ? e : P({}, e, {
    ownerState: P({}, e.ownerState, n)
  });
}
const pw = {
  disableDefaultClasses: !1
}, uw = /* @__PURE__ */ B.createContext(pw);
function ww(t) {
  const {
...
function hw(t) {
  ...
  const s = fw(P({}, o, r)), l = di(r), c = di(o), d = e(s), p = ke(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (dr.propTypes = Gd(dr.propTypes));
var Pt = "top", Gt = "bottom", Ut = "right", _t = "left", ra = "auto", Bn = [Pt, Gt, Ut, _t], Ke = "start", _n = "end", kw = "clippingParents", Ds = "viewport", fn = "popper", Ew = "reference", pi = /* @__PURE__ */ Bn.reduce(function(t, e) {
  return t.concat([e + "-" + Ke, e + "-" + _n]);
}, []), js = /* @__PURE__ */ [].concat(Bn, [ra]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ke, e + "-" + _n]);
}, []), Sw = "beforeRead", Tw = "read", Cw = "afterRead", Rw = "beforeMain", Ow = "main", Pw = "afterMain", _w = "beforeWrite", Iw = "write", $w = "afterWrite", Mw = [Sw, Tw, Cw, Rw, Ow, Pw, _w, Iw, $w];
function Qt(t) {
...
function Ze(t, e, n) {
  ...
  var s = Pe(t) ? Bt(t) : window, l = s.visualViewport, c = !Bs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function Vn(t) {
  for (var e = Bt(t), n = ui(t); n && Bw(n) && ae(n).position === "static"; )
    n = ui(n);
  return n && (Qt(n) === "html" || Qt(n) === "body" && ae(n).position === "static") ? e : n || Vw(t) || e;
}
function ia(t) {
...
function Lw(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Kt(n.placement), c = ia(l), d = [_t, Ut].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = Fw(o.padding, n), w = aa(a), g = c === "y" ? Pt : _t, y = c === "y" ? Gt : Ut, m = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], k = Vn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, S = f[g], b = T - w[p] - f[y], _ = T / 2 - w[p] / 2 + C, F = En(S, _, b), R = c;
...
function wi(t) {
  ...
  if (d) {
    var _ = Vn(n), F = "clientHeight", R = "clientWidth";
    if (_ === Bt(n) && (_ = we(n), ae(_).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), _ = _, o === Pt || (o === _t || o === Ut) && a === _n) {
      S = Gt;
...
function mi(t, e, n) {
  return e === Ds ? vo(Qw(t, n)) : Pe(e) ? ef(e, n) : vo(tf(we(t)));
}
function nf(t) {
  var e = Sn(jr(t)), n = ["absolute", "fixed"].indexOf(ae(t).position) >= 0, r = n && Lt(t) ? Vn(t) : t;
  return Pe(r) ? e.filter(function(o) {
    return Pe(o) && Vs(o, r) && Qt(o) !== "body";
  }) : [];
}
function rf(t, e, n, r) {
  var o = e === "clippingParents" ? nf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var p = mi(t, d, r);
...
function In(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? kw : l, d = n.rootBoundary, p = d === void 0 ? Ds : d, f = n.elementContext, w = f === void 0 ? fn : f, g = n.altBoundary, y = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Fs(typeof h != "number" ? h : Ls(h, Bn)), T = w === fn ? Ew : fn, C = t.rects.popper, S = t.elements[y ? T : w], b = rf(Pe(S) ? S : S.contextElement || we(t.elements.popper), c, p, s), _ = Ze(t.elements.reference), F = Us({
    reference: _,
    element: C,
    placement: o
  }), R = vo(Object.assign({}, C, F)), I = w === fn ? R : _, L = {
...
function of(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? js : c, p = Qe(r), f = p ? l ? pi : pi.filter(function(y) {
    return Qe(y) === p;
...
function sf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, y = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Kt(h), T = k === h, C = c || (T || !y ? [or(h)] : af(h)), S = [h].concat(C).reduce(function(z, K) {
      return z.concat(Kt(K) === ra ? of(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var D = S[L], tt = Kt(D), J = Qe(D) === Ke, j = [Pt, Gt].indexOf(tt) >= 0, M = j ? "width" : "height", A = In(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function cf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = In(e, {
    ...
    altBoundary: !0
  }), c = hi(s, r), d = hi(l, o, a), p = gi(c), f = gi(d);
  e.modifiersData[n] = {
...
function gf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, y = n.tetherOffset, m = y === void 0 ? 0 : y, h = In(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: p
  }), k = Kt(e.placement), T = Qe(e.placement), C = !T, S = ia(k), b = hf(S), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (_) {
    if (a) {
      var J, j = S === "y" ? Pt : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = _[S], H = G + h[j], rt = G - h[M], N = g ? -R[A] / 2 : 0, O = T === Ke ? F[A] : R[A], U = T === Ke ? -R[A] : -F[A], X = e.elements.arrow, z = g && X ? aa(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : zs(), q = K[j], W = K[M], Y = En(0, F[A], z[A]), Z = C ? F[A] / 2 - N - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + N + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Vn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Et = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - Et - $, Nt = G + Q - Et, Yt = En(g ? pr(H, V) : H, G, g ? Ee(rt, Nt) : rt);
      _[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var fe, Ct = S === "x" ? Pt : _t, Ln = S === "x" ? Gt : Ut, Ht = _[b], $e = b === "y" ? "height" : "width", me = Ht + h[Ct], Me = Ht - h[Ln], Ae = [Pt, _t].indexOf(k) !== -1, De = (fe = D == null ? void 0 : D[b]) != null ? fe : 0, he = Ae ? me : Ht - F[$e] - R[$e] - De + L.altAxis, on = Ae ? Ht + F[$e] + R[$e] - De - L.altAxis : Me, Gn = g && Ae ? zw(he, Ht, on) : En(g ? he : me, Ht, g ? on : Me);
      _[b] = Gn, tt[b] = Gn - Ht;
    }
...
function Nf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Lt(e), o = Lt(e) && xf(e), a = we(e), s = Ze(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  ca(a)) && (l = yf(e)), Lt(e) ? (c = Ze(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = la(a))), {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        m(), p.options = Object.assign({}, a, p.options, T), p.scrollParents = {
          reference: Pe(l) ? Sn(l) : l.contextElement ? Sn(l.contextElement) : [],
          popper: Sn(c)
        };
        var C = Ef(Tf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (vi(T, C)) {
            p.rects = {
              reference: Nf(T, Vn(C), p.options.strategy === "fixed"),
              popper: aa(C)
...
var Rf = [Kw, mf, qw, jw, wf, lf, bf, Uw, df], Of = /* @__PURE__ */ Cf({
  defaultModifiers: Rf
});
const Pf = "Popper";
function _f(t) {
...
const If = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], $f = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Mf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Df = () => qo({
  root: ["root"]
}, ww(_f)), jf = {}, Bf = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = St(e, If), k = B.useRef(null), T = Re(k, n), C = B.useRef(null), S = Re(C, w), b = B.useRef(S);
  We(() => {
    b.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const _ = Mf(p, s), [F, R] = B.useState(_), [I, L] = B.useState(ur(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = Df(), J = (r = y.root) != null ? r : "div", j = bw({
    elementType: J,
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || Af(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
const Uf = {
  ...
  const {
  ...
  } = e, k = St(e, Gf), T = gn(), C = B.useRef(), S = Ys(), b = B.useRef(null), _ = Re(b, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = b.current;
      A === void 0 ? M(G) : M(G, A);
    }
    ...
    m === "auto" ? (rt = S.transitions.getAutoHeightDuration(M.clientHeight), C.current = rt) : rt = A, M.style.transition = [S.transitions.create("opacity", {
      ...
      easing: H
    })].join(","), M.style.opacity = 0, M.style.transform = No(0.75), f && f(M);
  }), J = F(w);
...
wr.muiSupportAuto = !0;
const Xf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Yf = jn(Xs, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = _s(), a = na({
    ...
    slots: C,
    slotProps: S
  } = a, b = St(a, Xf), _ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = P({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const ce = Rs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), qf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Wf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Kf = (t) => {
...
const qs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const _ = na({
    ...
    TransitionProps: Et
  } = _, V = St(_, qf), Nt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
...
`));
  const sl = B.useMemo(() => {
    ...
    touch: me.current
  }), Gr = Kf(cn), xa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Jf, Na = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : wr, ka = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Zf, Ea = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : Qf, ll = bn(xa, P({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ke(Gr.popper, Y == null ? void 0 : Y.className, (g = (y = Z.popper) != null ? y : L.popper) == null ? void 0 : g.className)
  }), cn), cl = bn(Na, P({}, Et, (m = Z.transition) != null ? m : L.transition), cn), dl = bn(ka, P({}, (h = Z.tooltip) != null ? h : L.tooltip, {
    className: ke(Gr.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), cn), pl = bn(Ea, P({}, (C = Z.arrow) != null ? C : L.arrow, {
    className: ke(Gr.arrow, (S = (b = Z.arrow) != null ? b : L.arrow) == null ? void 0 : S.className)
  }), cn);
  return /* @__PURE__ */ v(B.Fragment, {
    children: [/* @__PURE__ */ B.cloneElement(Nt, Vt), /* @__PURE__ */ i(xa, P({
      as: W ?? da,
      placement: q,
      anchorEl: rt ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ v(ka, P({}, dl, {
          children: [dt, F ? /* @__PURE__ */ i(Ea, P({}, pl, {
            ref: $e
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Wl,
    {
      ...
      children: n ? /* @__PURE__ */ v(te, { children: [
        ...
        f ? /* @__PURE__ */ i($i, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(cw, {}) }) : ki(s, n, !1)
      ] }) : h
    }
  );
...
function Js(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: s } = Ot(() => {
    const p = o && o.length > 0 ? o : (
      ...
      Ks(e).filter((y) => !("menuItem" in y.group))
...
const zn = fr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Il, { size: 35, className: x("tw-animate-spin", t), ...e, ref: n }));
...
const cm = E.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ i(
  wt.Label,
  {
    ref: r,
    className: x("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
cm.displayName = wt.Label.displayName;
...
function dm({ variant: t }) {
  return /* @__PURE__ */ v(Qs, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: t, children: [
    ...
    /* @__PURE__ */ v(tr, { children: [
      ...
      /* @__PURE__ */ v(xn, { children: [
        /* @__PURE__ */ v(lm, { value: "benoit", children: [
...
), um = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: x(pm({ variant: e }), t), ...n }));
...
const fm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: x("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function hm({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: x("pr-twp", mm({ variant: e }), t), ...n });
}
...
const ym = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: x("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
km.displayName = hn.Root.displayName;
...
Em.displayName = co.Root.displayName;
const vh = $t.Root, Sm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = kt();
  return /* @__PURE__ */ i(
    $t.List,
    {
...
Sm.displayName = $t.List.displayName;
...
Tm.displayName = $t.Trigger.displayName;
...
Cm.displayName = $t.Content.displayName;
function yh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    ft,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(zn, { size: 15 }) : /* @__PURE__ */ v(te, { children: [
        /* @__PURE__ */ i($l, { size: 25, className: x("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Eh({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: x("pr-twp tw-prose", n), children: /* @__PURE__ */ i(nc, { options: o, children: e }) });
}
const Rm = fr((t, e) => /* @__PURE__ */ v(
  ft,
  {
    ref: e,
...
function Sh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ v(_o, { children: [
    /* @__PURE__ */ i(Di, { asChild: !0, children: /* @__PURE__ */ i(Rm, {}) }),
    /* @__PURE__ */ i(gr, { children: e.map((n) => /* @__PURE__ */ v("div", { children: [
      /* @__PURE__ */ i(br, { children: n.label }),
      /* @__PURE__ */ i(ic, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(Io, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(Bi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(vr, {})
    ] }, n.label)) })
  ] }) });
}
function Th({ id: t, message: e }) {
      ...
      children: [
        ...
        /* @__PURE__ */ v("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ v("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(Al, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ v("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ v(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ i(Dl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ v(
...
function Oh({
  ...
  return /* @__PURE__ */ v("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ i("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ v(hm, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ i(
          ft,
          {
            variant: "ghost",
...
export {
  ...
  wm as AlertTitle,
  th as BOOK_SELECTOR_STRING_KEYS,
  hm as Badge,
  Qm as BookChapterControl,
