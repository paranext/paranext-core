...
import U, { forwardRef as kn, useCallback as Ce, useState as he, useRef as At, useEffect as Qe, useLayoutEffect as Na, useMemo as pt } from "react";
...
import * as _r from "@radix-ui/react-popover";
import { Command as De } from "cmdk";
import * as et from "@radix-ui/react-dialog";
import * as Ai from "@radix-ui/react-label";
import * as Ir from "@radix-ui/react-radio-group";
import { useReactTable as Di, getCoreRowModel as ji, getPaginationRowModel as Dc, getSortedRowModel as Bi, getFilteredRowModel as jc, flexRender as Sr, getExpandedRowModel as Bc, getGroupedRowModel as Lc } from "@tanstack/react-table";
...
function Yi(e) {
  const t = typeof e == "number" ? jo(e) : e;
...
const Bo = be.Root, Ki = be.Trigger, bp = be.Group, Zv = be.Portal, Qv = be.Sub, e0 = be.RadioGroup, vp = U.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: M(
...
function t0({ scrRef: e, handleSubmit: t }) {
  const [r, n] = he(""), [o, a] = he(
    ...
    (N) => Cp(N).filter((A) => {
      const j = fe.bookIdToEnglishName(A).toLowerCase(), z = r.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    Sp.forEach((N) => {
      const A = r.match(N);
      if (A) {
        const [j, z = void 0, G = void 0] = A.slice(1), B = Pp(j);
        (fe.isBookIdValid(j) || B) && y(
          B ?? j,
          !0,
          z ? parseInt(z, 10) : 1,
          G ? parseInt(G, 10) : 1
    ...
    if (c === o) {
      ...
      i + j <= 0 || i + j > gr(c) ? l(0) : j !== 0 && (l(i + j), N.preventDefault());
    }
  };
  return Qe(() => {
    ...
    const N = setTimeout(() => {
      if (b && f.current && g.current) {
        const j = g.current.offsetTop - Tp;
  ...
  }, [b]), /* @__PURE__ */ p("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ $(Bo, { modal: !1, open: m, onOpenChange: k, children: [
                ...
                xp,
                {
                  ...
                  children: /* @__PURE__ */ p(
                    kp,
                    {
                      ...
                      endChapter: gr(j),
                      activeChapter: e.bookNum === fe.bookIdToNumber(j) ? e.chapterNum : 0,
...
const _p = _r.Root, Ip = _r.Trigger, Qi = U.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ p(_r.Portal, { children: /* @__PURE__ */ p(
  _r.Content,
  {
    ref: o,
    align: t,
...
Qi.displayName = _r.Content.displayName;
const Mp = et.Portal, es = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  et.Overlay,
  {
    ref: r,
    className: M(
...
const Ap = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(Mp, { children: [
  /* @__PURE__ */ p(es, {}),
  /* @__PURE__ */ $(
    et.Content,
    {
...
const ns = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  De.List,
  {
    ref: r,
...
const os = U.forwardRef((e, t) => /* @__PURE__ */ p(De.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
function Oa({
  ...
  const [d, h] = he(!1);
  return /* @__PURE__ */ $(_p, { open: d, onOpenChange: h, ...b, children: [
    /* @__PURE__ */ p(Ip, { asChild: !0, children: /* @__PURE__ */ $(
      Ne,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ p(Qi, { className: "pr-w-[200px] pr-p-0", dir: m, children: /* @__PURE__ */ $(ts, { children: [
      /* @__PURE__ */ p(rs, { dir: m, placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ p(os, { children: c }),
      /* @__PURE__ */ p(ns, { children: t.map((f) => /* @__PURE__ */ $(
        as,
        {
          value: a(f),
          onSelect: () => {
...
), lt = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  Ai.Root,
  {
    ref: r,
    className: M("pr-twp pr-font-sans", Fp(), e),
    ...t
  }
));
lt.displayName = Ai.Root.displayName;
function zp({
  startChapter: e,
  endChapter: t,
  ...
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ p(lt, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ p(
      Oa,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ p(lt, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ p(
      Oa,
      {
        isDisabled: o,
...
is.displayName = Ir.Root.displayName;
const wo = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  Ir.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ p(Ir.Indicator, { className: "pr-flex pr-items-center pr-justify-center", children: /* @__PURE__ */ p(Mi, { className: "pr-h-2.5 pr-w-2.5 pr-fill-current pr-text-current" }) })
  }
));
wo.displayName = Ir.Item.displayName;
...
function n0({
  ...
  return /* @__PURE__ */ p(
    is,
    {
      ...
      value: d,
      onValueChange: (g) => f(g),
      children: /* @__PURE__ */ $("div", { className: "pr-grid pr-grid-cols-3 pr-gap-4", children: [
        /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center", children: [
          /* @__PURE__ */ p(wo, {
            value: "current book"
            /* CURRENT_BOOK */
          }),
          /* @__PURE__ */ p(lt, { className: "pr-ml-1", children: `${m}:` })
        ] }),
        /* @__PURE__ */ p(lt, { className: "pr-flex pr-items-center", children: t }),
        /* @__PURE__ */ p("div", { className: "pr-flex pr-items-center", children: /* @__PURE__ */ p(
          zp,
          {
        ...
        /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center", children: [
          ...
          /* @__PURE__ */ p(lt, { className: "pr-ml-1", children: `${b}:` })
        ] }),
        /* @__PURE__ */ p(lt, { className: "pr-flex pr-items-center", children: n.map((g) => fe.bookIdToEnglishName(g)).join(", ") }),
        /* @__PURE__ */ p(
          Ne,
          {
...
us.displayName = je.List.displayName;
...
fs.displayName = je.List.displayName;
...
ms.displayName = je.Content.displayName;
function c0({
  tabList: e,
  onSearch: t,
  searchPlaceholder: r,
...
function g0({
  ...
  return /* @__PURE__ */ $("fieldset", { id: e, className: t, children: [
    ...
    n.map((l) => /* @__PURE__ */ $("div", { className: "pr-m-2 pr-flex pr-items-center", children: [
      ...
      /* @__PURE__ */ p(lt, { children: i ? i(l) : l })
    ] }))
  ] });
}
function ud(e) {
...
function gd() {
  return Ia || (Ia = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = u, S = l, I = i, R = t, _ = m, N = n, A = h, j = d, z = r, G = a, B = o, W = v, te = !1;
    function F(V) {
...
var ro, ja;
function xs() {
  return ja || (ja = 1, ro = Function.call.bind(Object.prototype.hasOwnProperty)), ro;
}
var no, Ba;
function vd() {
  if (Ba)
...
function Pd() {
  return za || (za = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var T = i, S = a, I = e, R = c, _ = r, N = b, A = v, j = t, z = o, G = n, B = u, W = m, te = !1, F = !1;
    function C(D) {
...
const Bd = typeof window < "u" ? E.useLayoutEffect : E.useEffect, Bt = Bd;
let Ha = 0;
function Ld(e) {
...
const yu = qe("border", He), wu = qe("borderTop", He), xu = qe("borderRight", He), ku = qe("borderBottom", He), Eu = qe("borderLeft", He), Nu = qe("borderColor"), Tu = qe("borderTopColor"), Su = qe("borderRightColor"), Cu = qe("borderBottomColor"), Ou = qe("borderLeftColor"), Ru = qe("outline", He), Pu = qe("outlineColor"), jn = (e) => {
...
Dn(yu, wu, xu, ku, Eu, Nu, Tu, Su, Cu, Ou, jn, Ru, Pu);
const Bn = (e) => {
...
Dn(Bn, Ln, Vn, $u, _u, Iu, Mu, Au, Du, ju, Bu, Lu);
function Zt(e, t) {
  return t === "grey" ? t : e;
}
const Vu = Ee({
...
function Zu() {
  function e(r, n, o, a) {
    ...
    return v ? v(i) : ut(i, n, (h) => {
      let f = gn(b, m, h);
      return h === f && typeof h == "string" && (f = gn(b, m, `${r}${h === "default" ? "" : tt(h)}`, h)), c === !1 ? f : {
        [c]: f
      };
    });
  }
    ...
    const O = Zc(i, P({
      ...
      c && b && I.push((N) => {
        ...
        if (!A.components || !A.components[c] || !A.components[c].styleOverrides)
          return null;
        const j = A.components[c].styleOverrides, z = {};
        ...
        const j = nn(P({}, N, {
          defaultTheme: r,
          themeId: t
        })), z = j == null || (A = j.components) == null || (A = A[c]) == null ? void 0 : A.variants;
        return pn({
          variants: z
        }, P({}, N, {
          theme: j
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${tt(u || "")}`), N === void 0 && (N = `Styled(${Id(i)})`), _.displayName = N;
      }
...
function Dm(e) {
  ...
  }), I = E.useCallback(() => o.isTopModal(y()), [o]), R = jr((B) => {
    d.current = B, B && (m && I() ? T() : h.current && Rr(h.current, x));
  }), _ = E.useCallback(() => {
    o.remove(y(), x);
  }, [x, o]);
  E.useEffect(() => () => {
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: Eo(B, c == null ? void 0 : c.props.onEnter),
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Qo = "auto", Yr = [Me, Xe, Ye, Ae], or = "start", Vr = "end", jm = "clippingParents", qs = "viewport", vr = "popper", Bm = "reference", ci = /* @__PURE__ */ Yr.reduce(function(e, t) {
...
function Qm(e) {
  ...
  var o = zn(e);
  for (ea(o) && (o = o.host); Ge(o) && ["html", "body"].indexOf(rt(o)) < 0; ) {
    var a = ft(o);
...
function qr(e) {
  for (var t = ze(e), r = pi(e); r && Zm(r) && ft(r).position === "static"; )
    r = pi(r);
  return r && (rt(r) === "html" || rt(r) === "body" && ft(r).position === "static") ? t : r || Qm(e) || t;
}
function ra(e) {
...
function rh(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Ze(r.placement), c = ra(l), u = [Ae, Ye].indexOf(l) >= 0, m = u ? "height" : "width";
  if (!(!a || !i)) {
...
function di(e) {
  ...
  if (d = A.x, f = A.y, c) {
    var j;
    return Object.assign({}, N, (j = {}, j[k] = O ? "0" : "", j[x] = w ? "0" : "", j.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + d + "px, " + f + "px)" : "translate3d(" + d + "px, " + f + "px, 0)", j));
  }
...
function rl(e) {
  return ["html", "body", "#document"].indexOf(rt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && aa(e) ? e : rl(zn(e));
}
function $r(e, t) {
  var r;
  t === void 0 && (t = []);
...
function nl(e) {
  var t = e.reference, r = e.element, n = e.placement, o = n ? Ze(n) : null, a = n ? sr(n) : null, i = t.x + t.width / 2 - r.width / 2, l = t.y + t.height / 2 - r.height / 2, c;
  switch (o) {
    case Me:
      c = {
        x: i,
...
function Fr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? jm : l, u = r.rootBoundary, m = u === void 0 ? qs : u, v = r.elementContext, b = v === void 0 ? vr : v, d = r.altBoundary, h = d === void 0 ? !1 : d, f = r.padding, g = f === void 0 ? 0 : f, w = el(typeof g != "number" ? g : tl(g, Yr)), O = b === vr ? Bm : vr, x = e.rects.popper, k = e.elements[h ? O : b], y = bh(Ft(k) ? k : k.contextElement || St(e.elements.popper), c, m, i), T = ir(e.elements.reference), S = nl({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
...
function wh(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, u = r.padding, m = r.boundary, v = r.rootBoundary, b = r.altBoundary, d = r.flipVariations, h = d === void 0 ? !0 : d, f = r.allowedAutoPlacements, g = t.options.placement, w = Ze(g), O = w === g, x = c || (O || !h ? [dn(g)] : yh(g)), k = [g].concat(x).reduce(function(H, K) {
      return H.concat(Ze(K) === Qo ? vh(t, {
        placement: K,
        boundary: m,
        rootBoundary: v,
        padding: u,
      ...
      var N = k[_], A = Ze(N), j = sr(N) === or, z = [Me, Xe].indexOf(A) >= 0, G = z ? "width" : "height", B = Fr(t, {
        placement: N,
        boundary: m,
        rootBoundary: v,
        altBoundary: b,
      ...
      y[G] > T[G] && (W = dn(W));
      var te = dn(W), F = [];
      if (a && F.push(B[A] <= 0), l && F.push(B[W] <= 0, B[te] <= 0), F.every(function(H) {
        return H;
      })) {
        R = N, I = !1;
        break;
...
function Ph(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, u = r.rootBoundary, m = r.altBoundary, v = r.padding, b = r.tether, d = b === void 0 ? !0 : b, h = r.tetherOffset, f = h === void 0 ? 0 : h, g = Fr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Ze(t.placement), O = sr(t.placement), x = !O, k = ra(w), y = Rh(k), T = t.modifiersData.popperOffsets, S = t.rects.reference, I = t.rects.popper, R = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
  ...
  if (T) {
    if (a) {
      var j, z = k === "y" ? Me : Ae, G = k === "y" ? Xe : Ye, B = k === "y" ? "height" : "width", W = T[k], te = W + g[z], F = W - g[G], C = d ? -I[B] / 2 : 0, L = O === or ? S[B] : I[B], X = O === or ? -I[B] : -S[B], Y = t.elements.arrow, H = d && Y ? ta(Y) : {
        width: 0,
        height: 0
      }, K = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Qs(), q = K[z], Z = K[G], J = Pr(0, S[B], H[B]), Q = x ? S[B] / 2 - C - J - q - _.mainAxis : L - J - q - _.mainAxis, ee = x ? -S[B] / 2 + C + J + Z + _.mainAxis : X + J + Z + _.mainAxis, ie = t.elements.arrow && qr(t.elements.arrow), V = ie ? k === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (j = N == null ? void 0 : N[k]) != null ? j : 0, D = W + Q - re - V, se = W + ee - re, Te = Pr(d ? yn(te, D) : te, W, d ? Dt(F, se) : F);
      T[k] = Te, A[k] = Te - W;
    }
    if (l) {
      var $e, ke = k === "x" ? Me : Ae, Ct = k === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + g[ke], at = _e - g[Ct], Se = [Me, Ae].indexOf(w) !== -1, zt = ($e = N == null ? void 0 : N[y]) != null ? $e : 0, Ot = Se ? Be : _e - S[ot] - I[ot] - zt + _.altAxis, pr = Se ? _e + S[ot] + I[ot] - zt - _.altAxis : at, Zr = d && Se ? eh(Ot, _e, pr) : Pr(d ? Ot : Be, _e, d ? pr : at);
      T[y] = Zr, A[y] = Zr - _e;
    }
    t.modifiersData[n] = A;
  }
  ...
  return function(l, c, u) {
    ...
    var m = {
      ...
      setOptions: function(w) {
        ...
        var x = jh(Lh([].concat(n, m.options.modifiers)));
...
`));
  ...
  const A = Yh(), j = (n = h.root) != null ? n : "div", z = Vt({
    elementType: j,
...
const tg = {
  ...
  const {
  ...
  } = t, w = ge(t, eg), O = Er(), x = E.useRef(), k = Kr(), y = E.useRef(null), T = We(y, a.ref, r), S = (G) => (B) => {
    if (G) {
      const W = y.current;
      B === void 0 ? G(W) : G(W, B);
    }
    ...
    let F;
    f === "auto" ? (F = k.transitions.getAutoHeightDuration(G.clientHeight), x.current = F) : F = B, G.style.transition = [k.transitions.create("opacity", {
      duration: F,
      delay: W
    }), k.transitions.create("transform", {
  ...
  return /* @__PURE__ */ p(g, P({
    ...
    children: (G, B) => /* @__PURE__ */ E.cloneElement(a, P({
      style: P({
        opacity: 0,
        transform: Po(0.75),
...
const dl = /* @__PURE__ */ E.forwardRef(function(t, r) {
  ...
  const T = ht({
    ...
    children: I
  }), Te = Kr(), $e = Te.direction === "rtl", [ke, Ct] = E.useState(), [_e, ot] = E.useState(null), Be = E.useRef(!1), at = z || F, Se = Er(), zt = Er(), Ot = Er(), pr = Er(), [Zr, pa] = Os({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const da = (ne) => {
    ...
    (ne) => {
      wi.start(800 + L, () => {
        an = !1;
      }), pa(!1), Y && it && Y(ne), Se.start(Te.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), Gn = (ne) => {
    Be.current && ne.type !== "touchstart" || (ke && ke.removeAttribute("title"), zt.clear(), Ot.clear(), B || an && W ? zt.start(an ? W : B, () => {
      da(ne);
    }) : da(ne));
  }, ua = (ne) => {
    zt.clear(), Ot.start(L, () => {
  ...
  N ? (ur.title = !it && Xn && !j ? ie : null, ur["aria-describedby"] = it ? Hn : null) : (ur["aria-label"] = Xn ? ie : null, ur["aria-labelledby"] = it && !Xn ? Hn : null);
...
`));
  ...
  const fr = {};
  G || (Ue.onTouchStart = Xl, Ue.onTouchEnd = Yl), j || (Ue.onMouseOver = sn(va, Ue.onMouseOver), Ue.onMouseLeave = sn(ya, Ue.onMouseLeave), at || (fr.onMouseOver = va, fr.onMouseLeave = ya)), A || (Ue.onFocus = sn(ga, Ue.onFocus), Ue.onBlur = sn(ha, Ue.onBlur), at || (fr.onFocus = ga, fr.onBlur = ha)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Jl = E.useMemo(() => {
    var ne;
    let Le = [{
...
const Dg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], jg = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  const Z = (n = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? n : Bg, J = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : m, Q = (l = j == null ? void 0 : j.root) != null ? l : O.root, ee = (c = j == null ? void 0 : j.backdrop) != null ? c : O.backdrop, ie = Vt({
    elementType: Z,
    externalSlotProps: Q,
    externalForwardedProps: G,
    getSlotProps: W,
...
const Kg = (e) => {
  ...
  const i = ht({
  ...
  } = i, _ = ge(i.TransitionProps, Xg), N = ge(i, Yg), A = (n = k == null ? void 0 : k.paper) != null ? n : O, j = E.useRef(), z = We(j, A.ref), G = P({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: f,
    marginThreshold: g,
    ...
    const re = un(c), D = re && re.nodeType === 1 ? re : Re(j.current).body, se = D.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const Ct = $e + D.height, _e = ke + D.width, ot = nr(un(c)), Be = ot.innerHeight - g, at = ot.innerWidth - g;
    if (g !== null && $e < g) {
      const Se = $e - g;
      $e -= Se, se.vertical += Se;
...
`)), F.props.disabled || (w === "selectedMenu" && F.props.selected || z === -1) && (z = C));
  ...
  const G = (n = O.paper) != null ? n : ib, B = (o = x.paper) != null ? o : d, W = Vt({
    elementType: O.root,
...
const T0 = je.Root, Nb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.List,
  {
    ref: r,
    className: M(
...
Nb.displayName = je.List.displayName;
...
Tb.displayName = je.Trigger.displayName;
...
Sb.displayName = je.Content.displayName;
function S0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
...
function Ri(e, t) {
  const r = t === 1, n = r ? Fl : zl, o = r ? Bl : Ll, a = r ? bv : vv;
  return { t(i, l, c) {
    const u = gv.exec(c);
...
const yv = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, wv = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Ul = [Tl, Sl, Cl, Ol, Pl, Rl, $l, _l, Bl, Fl, Ll, zl], xv = [...Ul, /^[^\n]+(?:  \n|\n{2,})/, Io, Mo];
function kv(e) {
...
`, { _: h }));
  ...
  const i = [], l = {}, c = { blockQuote: { t: st(Tl), i: ae.HIGH, l: (d, h, f) => ({ v: h(d[0].replace(_b, ""), f) }), h: (d, h, f) => n("blockquote", { key: f.k }, h(d.v, f)) }, breakLine: { t: xr(Ib), i: ae.HIGH, l: fo, h: (d, h, f) => n("br", { key: f.k }) }, breakThematic: { t: st(Mb), i: ae.HIGH, l: fo, h: (d, h, f) => n("hr", { key: f.k }) }, codeBlock: { t: st(Cl), i: ae.MAX, l: (d) => ({ v: d[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (d, h, f) => n("pre", { key: f.k }, n("code", Mt({}, d.O, { className: d.M ? `lang-${d.M}` : "" }), d.v)) }, codeFenced: { t: st(Sl), i: ae.MAX, l: (d) => ({ O: a(d[3] || ""), v: d[4], M: d[2] || void 0, type: "codeBlock" }) }, codeInline: { t: yt(Ab), i: ae.LOW, l: (d) => ({ v: d[2] }), h: (d, h, f) => n("code", { key: f.k }, d.v) }, footnote: { t: st(Bb), i: ae.MAX, l: (d) => (i.push({ I: d[2], j: d[1] }), {}), h: mo }, footnoteReference: { t: vt(Lb), i: ae.HIGH, l: (d) => ({ v: d[1], B: `#${t.slugify(d[1])}` }), h: (d, h, f) => n("a", { key: f.k, href: qt(d.B) }, n("sup", { key: f.k }, d.v)) }, gfmTask: { t: vt(Fb), i: ae.HIGH, l: (d) => ({ R: d[1].toLowerCase() === "x" }), h: (d, h, f) => n("input", { checked: d.R, key: f.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? Rl : Ol), i: ae.HIGH, l: (d, h, f) => ({ v: fn(h, d[2], f), T: t.slugify(d[2]), C: d[1].length }), h: (d, h, f) => n(`h${d.C}`, { id: d.T, key: f.k }, h(d.v, f)) }, headingSetext: { t: st(Pl), i: ae.MAX, l: (d, h, f) => ({ v: fn(h, d[1], f), C: d[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: xr($l), i: ae.HIGH, l: () => ({}), h: mo }, image: { t: yt(wv), i: ae.HIGH, l: (d) => ({ D: d[1], B: _i(d[2]), F: d[3] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D || void 0, title: d.F || void 0, src: qt(d.B) }) }, link: { t: vt(yv), i: ae.LOW, l: (d, h, f) => ({ v: Sv(h, d[1], f), B: _i(d[2]), F: d[3] }), h: (d, h, f) => n("a", { key: f.k, href: qt(d.B), title: d.F }, h(d.v, f)) }, linkAngleBraceStyleDetector: { t: vt(Xb), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], type: "link" }) }, linkBareUrlDetector: { t: (d, h) => h.N ? null : vt(Gb)(d, h), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: vt(Wb), i: ae.MAX, l(d) {
    let h = d[1], f = d[1];
    return Pb.test(f) || (f = "mailto:" + f), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: f, type: "link" };
  } }, orderedList: Ri(n, 1), unorderedList: Ri(n, 2), newlineCoalescer: { t: st(Db), i: ae.LOW, l: fo, h: () => `
` }, paragraph: { t: Tv, i: ae.LOW, l: uo, h: (d, h, f) => n("p", { key: f.k }, h(d.v, f)) }, ref: { t: vt(qb), i: ae.MAX, l: (d) => (l[d[1]] = { B: d[2], F: d[4] }, {}), h: mo }, refImage: { t: yt(Kb), i: ae.MAX, l: (d) => ({ D: d[1] || void 0, P: d[2] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D, src: qt(l[d.P].B), title: l[d.P].F }) }, refLink: { t: vt(Jb), i: ae.MAX, l: (d, h, f) => ({ v: h(d[1], f), Z: h(d[0].replace(Zb, "\\$1"), f), P: d[2] }), h: (d, h, f) => l[d.P] ? n("a", { key: f.k, href: qt(l[d.P].B), title: l[d.P].F }, h(d.v, f)) : n("span", { key: f.k }, h(d.Z, f)) }, table: { t: st(_l), i: ae.HIGH, l: Nv, h: (d, h, f) => n("table", { key: f.k }, n("thead", null, n("tr", null, d.L.map(function(g, w) {
...
function $0({ id: e, groups: t }) {
  return /* @__PURE__ */ p("div", { id: e, children: /* @__PURE__ */ $(Bo, { children: [
