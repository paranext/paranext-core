...
function wa({
  ...
  const mt = L(() => {
    if (S) {
      const b = S.chapterNum ?? 1, W = S.verseNum ?? 1;
      if (w && da(S.book, b, W, w))
        return;
      st({
        book: S.book,
        chapterNum: b,
    ...
    (b) => {
      const W = F ?? (S == null ? void 0 : S.book), nt = R ?? (S == null ? void 0 : S.chapterNum);
      !W || !nt || (st({
        book: W,
        chapterNum: nt,
        verseNum: b
    ...
    (b) => {
      const W = O === "chapters" ? H : S == null ? void 0 : S.book;
      if (W) {
        if (l && l(W, b) > 1) {
          V(W), Z(b), T("verses"), $("");
          return;
  ...
  const { otLong: qt, ntLong: re, dcLong: Gt, extraLong: D } = {
    ...
    () => hl(E),
    [E]
  ), q = I(() => !l || !S || !S.chapterNum || !et ? !1 : l(S.book, S.chapterNum) > 0, [l, S, et]), lt = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), ut = L(
    (b) => (W) => w ? gl(b, W, w) : !1,
    ...
    (b) => {
      ...
      if ((O === "chapters" || O === "books" && S) && jt) {
        const At = O === "chapters" ? H : S == null ? void 0 : S.book;
        if (!At) return;
    ...
    const { isLetter: W, isDigit: nt } = Io(b.key);
    (W || nt) && (b.preventDefault(), B((_e) => _e + b.key), ot.current.focus(), Tt(!1));
  }, []);
  return Yt(() => {
    const b = setTimeout(() => {
      if (j && O === "books" && gt.current && wt.current) {
        const W = gt.current, nt = wt.current, jt = nt.offsetTop, _e = W.clientHeight, Ue = nt.clientHeight, Me = jt - _e / 2 + Ue / 2;
        W.scrollTo({
          top: Math.max(0, Me),
          behavior: "smooth"
        }), $(Un(t.book));
          ...
          Je,
          {
            ...
            children: [
              O === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                O === "chapters" && H && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Oe(H, n) }),
              ...
              !rt && /* @__PURE__ */ u(Ze, { ref: gt, children: [
                O === "books" && /* @__PURE__ */ u(dt, { children: [
                  !S && Object.entries(te).map(([b, W]) => {
                    if (W.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ee, { heading: X(b), children: W.map((nt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: nt,
                            onSelect: (jt) => Kt(jt),
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        children: /* @__PURE__ */ u(Je, { children: [
          ...
          /* @__PURE__ */ a(Ze, { children: z(e) ? e.map(($) => /* @__PURE__ */ a(Ee, { heading: $.groupHeading, children: $.options.map((E) => P(E, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map(($) => P($)) }) })
        ] })
      }
    )
  ] });
    ...
    "div",
    {
      ...
      children: [
        ...
        j && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
...
function xi({
  ...
  const [T, H] = _(Qo), [Y, F] = _(), [V, R] = _(), Z = o, [rt, Tt] = _(!1), [St, Pt] = _(!1), [K, ot] = _(!1), [gt, wt] = _(!1), [xt, he] = _(!1), [st, Ut] = _(M), [yt, oe] = _(!1), te = U(void 0), [S, _t] = _(/* @__PURE__ */ new Map());
  J(() => {
    let x = !0;
    return (async () => {
  ...
  }, [i, r]), ee = I(() => zt.slice(1), [zt]), Rt = I(() => ee.length ?? 0, [ee.length]), qt = I(() => Rt > 0, [Rt]), re = I(() => rt || Rt <= 2 ? ee : ee.slice(-2), [ee, Rt, rt]), Gt = I(() => rt || Rt <= 2 ? 0 : Rt - 2, [Rt, rt]), D = I(
      ...
      children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        ...
        /* @__PURE__ */ u(dt, { children: [
          qt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: D })
          ] }),
          !o && ie(T) && /* @__PURE__ */ a(
            Xr,
            {
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    rt ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(lr, {})
                  ] })
                ]
              }
            ),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    Y !== void 0 && (ie(T) || Y !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                    ...
                    /* @__PURE__ */ u(je, { open: K, onOpenChange: ot, children: [
                      /* @__PURE__ */ a(Xe, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
...
function Yd({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Qd({
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((E, B) => `skeleton-row-${B}`).map((E) => /* @__PURE__ */ a(Ae, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(nr, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(or, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    Ae,
    {
      onClick: () => s(P, k),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "default", children: [
...
function dw({
  ...
  return /* @__PURE__ */ u(Te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
...
function mp({
  ...
  Yt(() => {
    var D;
    oe.current = (D = yt.view) == null ? void 0 : D.markerMode;
  });
  const te = I(
    () => mw(
      h,
  ...
  const S = L(() => {
    var tt, at, x;
    const D = (tt = g.current) == null ? void 0 : tt.querySelector(".editor-input"), X = D == null ? void 0 : D.querySelector("span.note"), it = (x = (at = g.current) == null ? void 0 : at.ownerDocument.getSelection()) == null ? void 0 : x.anchorNode;
  ...
  J(() => {
    ...
    if (tt && $r("note", tt)) {
      ...
      let q = "custom";
      et === Oa ? q = "generated" : et === Aa ? q = "hidden" : et && (j(et), P(et)), C(q), k(q), E(((x = tt.insert.note) == null ? void 0 : x.style) ?? "f"), D = setTimeout(() => {
        var ut, vt, Nt;
        const lt = oe.current === "editable" ? [{ retain: kw }, tt] : [tt];
        (ut = h.current) == null || ut.applyUpdate(lt), (vt = h.current) == null || vt.selectNote(0), (Nt = h.current) == null || Nt.focus(), X = requestAnimationFrame(() => {
          it = setTimeout(() => {
            var Ct, fe;
    ...
    return () => {
      D && clearTimeout(D), X !== void 0 && cancelAnimationFrame(X), it !== void 0 && clearTimeout(it);
    };
  }, [e, i, s, S]);
  const _t = L(
    (D, X, it = !1) => {
      ...
      if (tt && $r("note", tt)) {
        if (tt.insert.note) {
          let q;
          D === "custom" ? q = X : D === "generated" ? q = Oa : q = Aa, tt.insert.note.caller = q;
        }
    ...
    var D;
    st.current || (D = h.current) == null || D.commitPendingMarkerEdits(), _t(v, M, !0), o();
  }, [v, M, o, _t]), zt = U(mt);
  Yt(() => {
    zt.current = mt;
  });
  ...
  const Re = () => {
    var X;
    const D = (X = g.current) == null ? void 0 : X.getElementsByClassName("editor-input")[0];
    ...
    if (X && $r("note", X)) {
      X.insert.note && (X.insert.note.style = D);
      const q = (x = (at = X.insert.note) == null ? void 0 : at.contents) == null ? void 0 : x.ops;
      $ !== "x" && D === "x" ? q == null || q.forEach((lt) => bw(lt)) : $ === "x" && D !== "x" && (q == null || q.forEach((lt) => xw(lt))), (et = h.current) == null || et.applyUpdate([X, { delete: 1 }]);
    }
  }, Dt = (D) => {
    xt(D.contextMarker), F(D.canRedo);
  }, Vt = L(
    (D) => {
      var it, tt, at, x, et;
      const X = (tt = (it = h.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : tt.at(0);
    ...
    if (f.current && te.length && D && D.rangeCount > 0) {
      const X = D.getRangeAt(0).getBoundingClientRect(), it = f.current.getBoundingClientRect();
      St(X.left - it.left), K(X.top - it.top), gt(X.height), rt(!0);
    }
  }, [te, f]), Rt = L(
    (D, X, it) => {
      const { anchorRect: tt } = D;
      if (!p || !tt) return;
  ...
  J(() => {
    ...
    var D;
    Z && ((D = he.current) == null || D.focus());
  }, [Z]), J(() => {
    var it, tt;
    const D = ((it = g.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0;
    ...
    const X = (at) => {
      !Z && D && document.activeElement === D && at.key === d ? (at.preventDefault(), ee()) : Z && at.key === "Escape" && (at.preventDefault(), rt(!1));
    };
...
function Tp({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), y = me(r, "%webView_inventory_unapproved%"), v = me(r, "%webView_inventory_unknown%"), C = me(r, "%webView_inventory_scope_currentBook%"), N = me(r, "%webView_inventory_scope_chapter%"), k = me(r, "%webView_inventory_scope_verse%"), M = me(r, "%webView_inventory_filter_text%"), j = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = me(r, "%webView_inventory_no_results%"), [P, $] = _(!1), [E, B] = _("all"), [O, T] = _(""), [H, Y] = _([]), F = I(() => {
    const K = t ?? [];
...
function Kp({
  ...
  ), qt = ot.find((A) => A.value === "selectedBooks"), re = ot.find((A) => A.value === "range"), [Gt, D] = _(!1), [X, it] = _(void 0), [tt, at] = _(void 0), [x, et] = _(void 0), [q, lt] = _(void 0), [ut, vt] = _([]), Nt = l === "dropdown" && X === "selectedBooks", Ct = /* @__PURE__ */ a(
    Qw,
    {
      availableBookInfo: o,
  ...
  ), fe = S === "end", Fe = S === "start", tr = "tw:text-muted-foreground", b = l === "dropdown" && X === "range", W = b ? et : le, jt = b ? lt : g ? de : he, _e = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const go = L(
    (A) => {
      at(A), et(wt), lt(xt), vt(n), D(!1), it(A);
    },
    [wt, xt, n]
  ), fo = L(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(Te, { open: Gt, onOpenChange: D, children: [
        ...
        /* @__PURE__ */ a(
          Se,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: ae, children: [
              Rt.map(({ value: A, label: Q, dropdownLabel: Ht, scrRefSuffix: mr, id: Pi }) => /* @__PURE__ */ u(
                He,
                {
                  ref: Me(A),
        ...
        ao,
        {
          ...
          children: ot.map(({ value: A, label: Q, scrRefSuffix: Ht, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: mr }),
            /* @__PURE__ */ a(Et, { htmlFor: mr, children: K(Q, Ht) })
          ] }, mr))
        }
      )
    ] }),
...
function Ba({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(ze, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(G, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
