import p, { forwardRef as Nt, createContext as ya, useContext as Ca, useCallback as ae, useState as Y, useRef as se, useEffect as De, useLayoutEffect as Ln, useMemo as fe, Fragment as rr } from "react";
...
import { ChevronRight as ln, Check as ze, Circle as mn, X as dn, Search as ar, ChevronsUpDown as un, FilterIcon as Pa, ChevronDown as Dt, ChevronUp as ja, ArrowLeftIcon as Ga, ChevronLeftIcon as Ua, ChevronRightIcon as _a, ArrowRightIcon as Sa, LoaderCircle as Ra, Download as Ta, Filter as Oa, User as Ma, Link as za, CircleHelp as Ia, Star as Aa, CircleCheckIcon as Ba, CircleXIcon as Fa, CircleHelpIcon as Xa, ArrowUpIcon as $a, ArrowDownIcon as La, ArrowUpDownIcon as Ya, PanelLeft as Ha, PanelRight as Ja, ScrollText as qa, ChevronLeft as Ka, MenuIcon as Wa, Menu as Za, EllipsisVertical as Qa } from "lucide-react";
import { formatScrRef as Fe, MODIFIER_KEYS as eo, getChaptersForBook as to, NumberFormat as no, formatBytes as ro, deepEqual as pn, isString as Ht, compareScrRefs as en, scrRefToBBBCCCVVV as Jt, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { useReactTable as sr, getFilteredRowModel as ao, getSortedRowModel as ir, getPaginationRowModel as oo, getCoreRowModel as cr, flexRender as nt, getGroupedRowModel as so, getExpandedRowModel as io } from "@tanstack/react-table";
...
import * as nn from "@radix-ui/react-progress";
import { Toaster as mo } from "sonner";
import { toast as Vc } from "sonner";
import * as tt from "@radix-ui/react-slider";
...
function uo() {
  ...
  return wt.Fragment = e, wt.jsxDEV = void 0, wt;
}
var ft = {};
/**
 * @license React
...
function po() {
  return Hn || (Hn = 1, process.env.NODE_ENV !== "production" && function() {
    var e = p, n = Symbol.for("react.element"), r = Symbol.for("react.portal"), a = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), i = Symbol.for("react.profiler"), c = Symbol.for("react.provider"), l = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), x = Symbol.for("react.suspense_list"), N = Symbol.for("react.memo"), h = Symbol.for("react.lazy"), w = Symbol.for("react.offscreen"), E = Symbol.iterator, G = "@@iterator";
    function C(s) {
    ...
    var M = !1, q = !1, Ce = !1, he = !1, V = !1, v;
    v = Symbol.for("react.module.reference");
    function $(s) {
      return !!(typeof s == "string" || typeof s == "function" || s === a || s === i || V || s === o || s === u || s === x || he || s === w || M || q || Ce || typeof s == "object" && s !== null && (s.$$typeof === h || s.$$typeof === N || s.$$typeof === c || s.$$typeof === l || s.$$typeof === d || // This needs to include all possible module reference object
    ...
    var zt = y.ReactCurrentDispatcher, It;
    function mt(s, b, g) {
      {
        if (It === void 0)
          try {
...
` + It + s;
    ...
    function _n(s, b) {
      ...
      var L;
      L = zt.current, zt.current = null, Zr();
      try {
        if (b) {
          var z = function() {
            throw Error();
...
` + T[Z].replace(" at new ", " at ");
        ...
        At = !1, zt.current = L, Qr(), Error.prepareStackTrace = B;
      }
      var Ae = s ? s.displayName || s.name : "", Ue = Ae ? mt(Ae) : "";
      return typeof s == "function" && dt.set(s, Ue), Ue;
    }
    function ta(s, b, g) {
      return _n(s, !1);
    }
    ...
    var Ke = Object.prototype.hasOwnProperty, Sn = {}, Rn = y.ReactDebugCurrentFrame;
    function pt(s) {
      if (s) {
        var b = s._owner, g = ut(s.type, s._source, b ? b.type : null);
        Rn.setExtraStackFrame(g);
      } else
        Rn.setExtraStackFrame(null);
    }
    function ra(s, b, g, j, B) {
      {
    ...
    function On(s) {
      if (sa(s))
        return D("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", oa(s)), Tn(s);
    }
    var We = y.ReactCurrentOwner, ia = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ma(s, b) {
      if (typeof s.ref == "string" && We.current && b && We.current.stateNode !== b) {
        var g = oe(We.current.type);
        Ft[g] || (D('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', oe(We.current.type), s.ref), Ft[g] = !0);
      }
    }
    function da(s, b) {
      {
        var g = function() {
          Mn || (Mn = !0, D("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", b));
        };
    ...
    function ua(s, b) {
      {
        var g = function() {
          zn || (zn = !0, D("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", b));
        };
    ...
    function ba(s, b, g, j, B) {
      {
        var L, z = {}, T = null, le = null;
        g !== void 0 && (On(g), T = "" + g), la(b) && (On(b.key), T = "" + b.key), ca(b) && (le = b.ref, ma(b, B));
        for (L in b)
          Ke.call(b, L) && !ia.hasOwnProperty(L) && (z[L] = b[L]);
        if (s && s.defaultProps) {
        ...
        return pa(s, T, le, B, j, We.current, z);
      }
    }
    var Xt = y.ReactCurrentOwner, In = y.ReactDebugCurrentFrame;
    function Ie(s) {
      if (s) {
        var b = s._owner, g = ut(s.type, s._source, b ? b.type : null);
    ...
    function Fn(s, b) {
      {
        ...
        Bn[g] = !0;
        var j = "";
        s && s._owner && s._owner !== Xt.current && (j = " It was passed a child from " + oe(s._owner.type) + "."), Ie(s), D('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', g, j), Ie(null);
      }
    }
    function Xn(s, b) {
      {
    ...
    function ha(s) {
      {
        for (var b = Object.keys(s.props), g = 0; g < b.length; g++) {
          var j = b[g];
          if (j !== "children" && j !== "key") {
            Ie(s), D("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", j), Ie(null);
            break;
          }
        }
        s.ref !== null && (Ie(s), D("Invalid attribute `ref` supplied to `React.Fragment`."), Ie(null));
      }
    }
    var $n = {};
    function va(s, b, g, j, B, L) {
      {
        var z = $(s);
        if (!z) {
          var T = "";
          ...
          le ? T += le : T += An();
          var Z;
          s === null ? Z = "null" : Bt(s) ? Z = "array" : s !== void 0 && s.$$typeof === n ? (Z = "<" + (oe(s.type) || "Unknown") + " />", T = " Did you accidentally export a JSX literal instead of a component?") : Z = typeof s, D("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Z, T);
        }
        var Q = ba(s, b, g, B, L);
        if (Q == null)
          return Q;
        ...
        if (Ke.call(b, "key")) {
          var Ue = oe(s), me = Object.keys(b).filter(function(Da) {
            return Da !== "key";
          }), Yt = me.length > 0 ? "{key: someKey, " + me.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!$n[Ue + Yt]) {
            var Na = me.length > 0 ? "{" + me.join(": ..., ") + ": ...}" : "{}";
            D(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Yt, Ue, Na, Ue), $n[Ue + Yt] = !0;
          }
        }
        return s === a ? ha(Q) : xa(Q), Q;
      }
    }
    var ga = va;
    ft.Fragment = a, ft.jsxDEV = ga;
  }()), ft;
}
var Jn;
function bo() {
  return Jn || (Jn = 1, process.env.NODE_ENV === "production" ? bt.exports = uo() : bt.exports = po()), bt.exports;
}
var t = bo();
const wo = ka({ prefix: "tw-" });
function m(...e) {
  return wo(Ea(e));
}
...
const wn = H.Trigger, dr = H.Group, ho = H.Portal, vo = H.Sub, Mi = H.RadioGroup;
function Ct({ variant: e = "default", ...n }) {
  const r = p.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ t.jsxDEV(bn.Provider, { value: r, children: /* @__PURE__ */ t.jsxDEV(H.Root, { ...n }, void 0, !1, {
...
const ur = p.forwardRef(({ className: e, inset: n, children: r, ...a }, o) => {
  const i = ge();
  return /* @__PURE__ */ t.jsxDEV(
    H.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ t.jsxDEV(ln, { className: "tw-ml-auto tw-h-4 tw-w-4" }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/dropdown-menu.tsx",
          lineNumber: 143,
          columnNumber: 7
        }, void 0)
...
const pr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  H.SubContent,
  {
    ref: r,
    className: m(
...
const it = p.forwardRef(({ className: e, sideOffset: n = 4, children: r, ...a }, o) => {
  const i = te();
...
it.displayName = H.Content.displayName;
const fn = p.forwardRef(({ className: e, inset: n, ...r }, a) => {
  const o = te(), i = ge();
  return /* @__PURE__ */ t.jsxDEV(
    H.Item,
    {
...
const xn = p.forwardRef(({ className: e, children: n, checked: r, ...a }, o) => {
  const i = ge();
  return /* @__PURE__ */ t.jsxDEV(
    H.CheckboxItem,
    {
...
const br = p.forwardRef(({ className: e, children: n, ...r }, a) => {
  const o = ge();
  return /* @__PURE__ */ t.jsxDEV(
    H.RadioItem,
    {
...
br.displayName = H.RadioItem.displayName;
const Et = p.forwardRef(({ className: e, inset: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  H.Label,
  {
    ref: a,
...
const ct = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  H.Separator,
  {
    ref: r,
...
go.displayName = "DropdownMenuShortcut";
var No = Object.defineProperty, Do = (e, n, r) => n in e ? No(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[n] = r, O = (e, n, r) => Do(e, typeof n != "symbol" ? n + "" : n, r);
const Te = [
  "GEN",
  "EXO",
  "LEV",
...
function yo(e) {
  const n = typeof e == "string" ? qe(e) : e;
  return n >= 40 && n <= 66;
}
function Co(e) {
...
function* ko() {
  for (let e = 1; e <= Te.length; e++) yield e;
}
const Vo = 1, xr = Te.length;
function Po() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function gn(e, n = "***") {
  const r = e - 1;
  return r < 0 || r >= Te.length ? n : Te[r];
}
function hr(e) {
  return e <= 0 || e > xr ? "******" : wr[e - 1];
}
function jo(e) {
  return hr(qe(e));
}
...
function Uo(e) {
  return wr[e - 1].includes("*obsolete*");
}
function _o() {
  const e = {};
...
const we = class {
  ...
  constructor(n) {
    ...
    typeof n == "string" ? (this.name = n, this._type = Ne[n]) : (this._type = n, this.name = Ne[n]);
  }
  get type() {
    return this._type;
  }
...
O(we, "Original", new we(Ne.Original)), O(we, "Septuagint", new we(Ne.Septuagint)), O(we, "Vulgate", new we(Ne.Vulgate)), O(we, "English", new we(Ne.English)), O(we, "RussianProtestant", new we(Ne.RussianProtestant)), O(we, "RussianOrthodox", new we(Ne.RussianOrthodox));
let Se = we;
function Kn(e, n) {
  const r = n[0];
...
const de = class A {
  constructor(n, r, a, o) {
    if (O(this, "firstChapter"), O(this, "lastChapter"), O(this, "lastVerse"), O(this, "hasSegmentsDefined"), O(this, "text"), O(this, "BBBCCCVVVS"), O(this, "longHashCode"), O(this, "versification"), O(this, "rtlMark", "‏"), O(this, "_bookNum", 0), O(this, "_chapterNum", 0), O(this, "_verseNum", 0), O(this, "_verse"), a == null && o == null)
      if (n != null && typeof n == "string") {
        const i = n, c = r != null && r instanceof Se ? r : void 0;
        this.setEmpty(c), this.parse(i);
      } else if (n != null && typeof n == "number") {
        const i = r != null && r instanceof Se ? r : void 0;
        ...
        if (n != null && n instanceof A) {
          ...
          if (n == null) return;
          const i = n instanceof Se ? n : A.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  static fromJSON(n) {
    ...
    let d;
    return c && (d = new Se(c)), r ? new A(r, a.toString(), l, d) : new A();
  }
  /**
  ...
  set versificationStr(n) {
    this.versification = this.versification != null ? new Se(n) : void 0;
  }
  /**
  ...
  parse(n) {
    if (n = n.replace(this.rtlMark, ""), n.includes("/")) {
      ...
      if (n = i[0], i.length > 1)
        try {
          const c = +i[1].trim();
          this.versification = new Se(Ne[c]);
        } catch {
          throw new Ze("Invalid reference : " + n);
        }
    }
...
O(de, "defaultVersification", Se.English), O(de, "verseRangeSeparator", "-"), O(de, "verseSequenceIndicator", ","), O(de, "verseRangeSeparators", [de.verseRangeSeparator]), O(de, "verseSequenceIndicators", [de.verseSequenceIndicator]), O(de, "chapterDigitShifter", 1e3), O(de, "bookDigitShifter", de.chapterDigitShifter * de.chapterDigitShifter), O(de, "bcvMaxValue", de.chapterDigitShifter - 1), /**
...
const To = 6, Nn = I.allBookIds.filter((e) => !I.isObsolete(I.bookIdToNumber(e))), Oo = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Wn = ["OT", "NT", "DC"], Mo = 96, zo = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), Io = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', Qe = (e) => to(I.bookIdToNumber(e));
function Ao() {
  return Nn.map((n) => I.bookIdToEnglishName(n));
}
function Bo(e) {
...
function Fo(e) {
  ...
  if (Bo(n))
    return Nn.find((a) => I.bookIdToEnglishName(a) === n);
}
function Ii({
  scrRef: e,
  handleSubmit: n,
  ...
  const o = te(), [i, c] = Y(
    () => Fe(e, "English")
  ), [l, d] = Y(""), [u, x] = Y(e.book), [N, h] = Y(e.chapterNum ?? 0), [w, E] = Y(e.book), [G, C] = Y(!1), [y, D] = Y(G), P = se(void 0), M = se(void 0), q = se(void 0), Ce = ae(
    (f) => {
      const S = a ? a() : Nn;
      return {
    ...
    c(Fe(e, "English")), d(""), x(e.book), E(e.book);
  }, [e]), $ = ae((f) => {
    if (V.current) {
      V.current = !1;
      return;
    ...
    (f, S, k, R) => {
      if (h(e.book !== f ? 1 : e.chapterNum), S || Qe(f) === -1) {
        n({
          book: f,
          chapterNum: k ?? 1,
          verseNum: R ?? 1
    ...
    zo.forEach((f) => {
      const S = f.exec(l);
      if (S) {
        const [k, R = void 0, re = void 0] = S.slice(1), K = Fo(k);
    ...
    (f) => {
      const { key: S } = f;
      Zn.has(S) || (ce(f), f.preventDefault());
    },
    [ce]
  ), _ = ae(
    (f, S) => {
      ...
      if (Zn.has(k)) {
        if (w === u) {
          ...
          else k === "ArrowDown" ? K = To : k === "ArrowUp" && (K = -6);
          if (N + K <= 0 || N + K > Qe(w))
            h(0);
          else if (K !== 0) {
  ...
  return De(() => {
    u === w ? u === e.book ? h(e.chapterNum) : h(1) : h(0);
  }, [w, e.book, e.chapterNum, u]), De(() => {
    v();
  }, [v]), De(() => {
  }, [G, v]), Ln(() => {
    D(G);
    ...
    const f = setTimeout(() => {
      ...
      if (y && M.current && q.current) {
        const re = q.current.offsetTop - Mo;
  ...
  }, [y, v]), /* @__PURE__ */ t.jsxDEV(Ct, { modal: !1, open: G, onOpenChange: $, children: [
    /* @__PURE__ */ t.jsxDEV(wn, { asChild: !0, children: /* @__PURE__ */ t.jsxDEV(
      fo,
      {
        ref: P,
        value: i,
      ...
      it,
      {
        ...
        children: /* @__PURE__ */ t.jsxDEV("div", { className: "rtl:tw-ps-2", children: Wn.map((f, S) => {
          ...
          return k.length > 0 && /* @__PURE__ */ t.jsxDEV("div", { children: [
            /* @__PURE__ */ t.jsxDEV(Et, { className: "tw-font-semibold tw-text-foreground/80", children: Oo[f] }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/book-chapter-control/book-chapter-control.component.tsx",
              lineNumber: 566,
              columnNumber: 19
            }, this),
...
const Xo = Ge(
  ...
  ({ className: e, variant: n, size: r, asChild: a = !1, ...o }, i) => {
    const c = a ? Ye : "button";
    return /* @__PURE__ */ t.jsxDEV(c, { className: m(Xo({ variant: n, size: r, className: e })), ref: i, ...o }, void 0, !1, {
...
), ee = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(or.Root, { ref: r, className: m("pr-twp", $o(), e), ...n }, void 0, !1, {
...
const Dn = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
  return /* @__PURE__ */ t.jsxDEV(
    rt.Root,
    {
...
Dn.displayName = rt.Root.displayName;
const ht = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  rt.Item,
  {
    ref: r,
    className: m(
    ...
    ...n,
    children: /* @__PURE__ */ t.jsxDEV(rt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ t.jsxDEV(mn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/radio-group.tsx",
      lineNumber: 47,
      columnNumber: 9
    }, void 0) }, void 0, !1, {
...
ht.displayName = rt.Item.displayName;
const yn = at.Root, Cn = at.Trigger, kt = p.forwardRef(({ className: e, align: n = "center", sideOffset: r = 4, ...a }, o) => {
  const i = te();
  return /* @__PURE__ */ t.jsxDEV(at.Portal, { children: /* @__PURE__ */ t.jsxDEV(
    at.Content,
    {
      ref: o,
      align: n,
...
kt.displayName = at.Content.displayName;
const Lo = ye.Portal, Nr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ye.Overlay,
  {
    ref: r,
    className: m(
...
Nr.displayName = ye.Overlay.displayName;
const Yo = p.forwardRef(({ className: e, children: n, ...r }, a) => {
  const o = te();
  return /* @__PURE__ */ t.jsxDEV(Lo, { children: [
...
Yo.displayName = ye.Content.displayName;
const Ho = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ye.Title,
  {
    ref: r,
...
Ho.displayName = ye.Title.displayName;
const Jo = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ye.Description,
  {
    ref: r,
...
Jo.displayName = ye.Description.displayName;
const Vt = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ue,
  {
    ref: r,
    className: m(
...
Vt.displayName = ue.displayName;
const Pt = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
...
Pt.displayName = ue.Input.displayName;
const jt = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ue.List,
  {
    ref: r,
...
jt.displayName = ue.List.displayName;
const Gt = p.forwardRef((e, n) => /* @__PURE__ */ t.jsxDEV(ue.Empty, { ref: n, className: "tw-py-6 tw-text-center tw-text-sm", ...e }, void 0, !1, {
  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/command.tsx",
  lineNumber: 78,
  columnNumber: 3
}, void 0));
Gt.displayName = ue.Empty.displayName;
const En = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ue.Group,
  {
    ref: r,
    className: m(
...
const Dr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ue.Separator,
  {
    ref: r,
...
const Ut = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  ue.Item,
  {
    ref: r,
    className: m(
...
Ut.displayName = ue.Item.displayName;
function qo(e) {
  ...
  return /* @__PURE__ */ t.jsxDEV(yn, { open: C, onOpenChange: y, ...G, children: [
      ...
      F,
      {
        ...
        children: [
          /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ t.jsxDEV("span", { className: m("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: i ? l(i) : u }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/basics/combo-box.component.tsx",
              lineNumber: 107,
              columnNumber: 13
            }, this)
    ...
    /* @__PURE__ */ t.jsxDEV(
      kt,
      {
        ...
        children: /* @__PURE__ */ t.jsxDEV(Vt, { children: [
          /* @__PURE__ */ t.jsxDEV(Pt, { placeholder: x, className: "tw-text-inherit" }, void 0, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/basics/combo-box.component.tsx",
            lineNumber: 120,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ t.jsxDEV(Gt, { children: N }, void 0, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/basics/combo-box.component.tsx",
            lineNumber: 121,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ t.jsxDEV(jt, { children: n.map((D) => /* @__PURE__ */ t.jsxDEV(
            Ut,
            {
              value: l(D),
              onSelect: () => {
...
var Wo = /* @__PURE__ */ ((e) => (e.CURRENT_BOOK = "current book", e.CHOOSE_BOOKS = "choose books", e))(Wo || {});
...
function Bi({
  ...
  const x = qt(u, "%webView_bookSelector_currentBook%"), N = qt(u, "%webView_bookSelector_choose%"), h = qt(u, "%webView_bookSelector_chooseBooks%"), [w, E] = Y(
    "current book"
    /* CURRENT_BOOK */
  ), G = (C) => {
    E(C), e(C);
...
function Zo({ table: e }) {
  return /* @__PURE__ */ t.jsxDEV(Ct, { children: [
    /* @__PURE__ */ t.jsxDEV(Va, { asChild: !0, children: /* @__PURE__ */ t.jsxDEV(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ t.jsxDEV(Pa, { className: "tw-mr-2 tw-h-4 tw-w-4" }, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(it, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ t.jsxDEV(Et, { children: "Toggle columns" }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table-column-toggle.component.tsx",
        lineNumber: 28,
        columnNumber: 9
      }, this),
...
const Xe = W.Root, Qo = W.Group, $e = W.Value, es = Ge(
...
), Oe = p.forwardRef(({ className: e, children: n, size: r, ...a }, o) => {
  const i = te();
  return /* @__PURE__ */ t.jsxDEV(
    W.Trigger,
    {
      className: m(es({ size: r, className: e })),
      ref: o,
      ...a,
      dir: i,
      children: [
        n,
        /* @__PURE__ */ t.jsxDEV(W.Icon, { asChild: !0, children: /* @__PURE__ */ t.jsxDEV(Dt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }, void 0, !1, {
...
Oe.displayName = W.Trigger.displayName;
const yr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  W.ScrollUpButton,
  {
    ref: r,
    className: m("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...n,
    children: /* @__PURE__ */ t.jsxDEV(ja, { className: "tw-h-4 tw-w-4" }, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/select.tsx",
      lineNumber: 89,
      columnNumber: 5
    }, void 0)
...
const Cr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  W.ScrollDownButton,
  {
    ref: r,
    className: m("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...n,
    children: /* @__PURE__ */ t.jsxDEV(Dt, { className: "tw-h-4 tw-w-4" }, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/select.tsx",
      lineNumber: 104,
      columnNumber: 5
    }, void 0)
...
const Me = p.forwardRef(({ className: e, children: n, position: r = "popper", ...a }, o) => {
  const i = te();
...
Me.displayName = W.Content.displayName;
const ts = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  W.Label,
  {
    ref: r,
...
ts.displayName = W.Label.displayName;
const ve = p.forwardRef(({ className: e, children: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  W.Item,
  {
    ref: a,
    className: m(
...
const ns = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  W.Separator,
  {
    ref: r,
    className: m("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
ns.displayName = W.Separator.displayName;
function rs({ table: e }) {
    ...
    /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ t.jsxDEV(
        Xe,
        {
          ...
          children: [
            /* @__PURE__ */ t.jsxDEV(Oe, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ t.jsxDEV($e, { placeholder: e.getState().pagination.pageSize }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table-pagination.component.tsx",
              lineNumber: 34,
              columnNumber: 15
            }, this) }, void 0, !1, {
            ...
            /* @__PURE__ */ t.jsxDEV(Me, { side: "top", children: [10, 20, 30, 40, 50].map((n) => /* @__PURE__ */ t.jsxDEV(ve, { value: `${n}`, children: n }, n, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table-pagination.component.tsx",
              lineNumber: 38,
              columnNumber: 17
            }, this)) }, void 0, !1, {
      ...
      /* @__PURE__ */ t.jsxDEV(
        F,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ t.jsxDEV(Ga, { className: "tw-h-4 tw-w-4" }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table-pagination.component.tsx",
              lineNumber: 57,
              columnNumber: 13
            }, this)
      ...
      /* @__PURE__ */ t.jsxDEV(
        F,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ t.jsxDEV(Ua, { className: "tw-h-4 tw-w-4" }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table-pagination.component.tsx",
              lineNumber: 67,
              columnNumber: 13
            }, this)
...
const _t = p.forwardRef(({ className: e, stickyHeader: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV("div", { className: m("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !n }), children: /* @__PURE__ */ t.jsxDEV(
  "table",
  {
    ref: a,
...
const St = p.forwardRef(({ className: e, stickyHeader: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  "thead",
  {
    ref: a,
    className: m(
...
const Rt = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV("tbody", { ref: r, className: m("[&_tr:last-child]:tw-border-0", e), ...n }, void 0, !1, {
  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/table.tsx",
  lineNumber: 45,
  columnNumber: 3
}, void 0));
Rt.displayName = "TableBody";
const as = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  "tfoot",
  {
    ref: r,
...
const ot = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  "th",
  {
    ref: r,
    className: m(
...
const Le = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  "td",
  {
    ref: r,
...
const os = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  "caption",
  {
    ref: r,
...
function ss({
  ...
  var C;
  const [l, d] = Y([]), [u, x] = Y([]), [N, h] = Y({}), [w, E] = Y({}), G = sr({
    data: n,
    columns: e,
    getCoreRowModel: cr(),
    ...r && { getPaginationRowModel: oo() },
    onSortingChange: d,
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ t.jsxDEV(Zo, { table: G }, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(_t, { stickyHeader: i, children: [
      /* @__PURE__ */ t.jsxDEV(St, { stickyHeader: i, children: G.getHeaderGroups().map((y) => /* @__PURE__ */ t.jsxDEV(je, { children: y.headers.map((D) => /* @__PURE__ */ t.jsxDEV(ot, { children: D.isPlaceholder ? void 0 : nt(D.column.columnDef.header, D.getContext()) }, D.id, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table.component.tsx",
        lineNumber: 94,
        columnNumber: 19
      }, this)) }, y.id, !1, {
      ...
      /* @__PURE__ */ t.jsxDEV(Rt, { children: (C = G.getRowModel().rows) != null && C.length ? G.getRowModel().rows.map((y) => /* @__PURE__ */ t.jsxDEV(
        je,
        {
          onClick: () => c(y, G),
          "data-state": y.getIsSelected() && "selected",
          children: y.getVisibleCells().map((D) => /* @__PURE__ */ t.jsxDEV(Le, { children: nt(D.column.columnDef.cell, D.getContext()) }, D.id, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table.component.tsx",
            lineNumber: 113,
            columnNumber: 19
          }, this))
        ...
        this
      )) : /* @__PURE__ */ t.jsxDEV(je, { children: /* @__PURE__ */ t.jsxDEV(Le, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: "No results." }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table.component.tsx",
        lineNumber: 121,
        columnNumber: 15
      }, this) }, void 0, !1, {
    ...
    r && a && /* @__PURE__ */ t.jsxDEV(rs, { table: G }, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/data-table/data-table.component.tsx",
      lineNumber: 148,
      columnNumber: 54
    }, this)
...
const lt = Nt(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(Ra, { size: 35, className: m("tw-animate-spin", e), ...n, ref: r }, void 0, !1, {
...
function Fi({
  ...
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
      ...
      onClick: n,
      ...o,
      children: e ? /* @__PURE__ */ t.jsxDEV(lt, { size: 15 }, void 0, !1, {
        ...
        /* @__PURE__ */ t.jsxDEV(Ta, { size: 25, className: m("tw-h-4 tw-w-4", { "tw-mr-1": r }) }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/buttons/install-button.component.tsx",
          lineNumber: 48,
          columnNumber: 11
        }, this),
...
function Xi({ isEnabling: e, handleClick: n, className: r, ...a }) {
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
      className: m(
      ...
      children: e ? /* @__PURE__ */ t.jsxDEV(t.Fragment, { children: [
        /* @__PURE__ */ t.jsxDEV(lt, { size: 15, className: "tw-mr-1 tw-text-white" }, void 0, !1, {
...
function $i({
  ...
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
      ...
      ...a,
      children: e ? /* @__PURE__ */ t.jsxDEV(t.Fragment, { children: [
        /* @__PURE__ */ t.jsxDEV(lt, { size: 15, className: "tw-mr-1 tw-text-black" }, void 0, !1, {
...
function Li({ isUpdating: e, handleClick: n, className: r, ...a }) {
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
      className: m(
...
function Yi({ id: e, markdown: n, className: r, anchorTarget: a }) {
  const o = fe(
    () => ({
      overrides: {
        a: {
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { id: e, className: m("pr-twp tw-prose", r), children: /* @__PURE__ */ t.jsxDEV(co, { options: o, children: n }, void 0, !1, {
...
const is = Nt((e, n) => /* @__PURE__ */ t.jsxDEV(
  F,
  {
    ref: n,
    ...
    ...e,
    children: [
      /* @__PURE__ */ t.jsxDEV(Oa, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }, void 0, !1, {
...
var cs = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(cs || {});
function Hi({ id: e, groups: n }) {
  return /* @__PURE__ */ t.jsxDEV("div", { id: e, children: /* @__PURE__ */ t.jsxDEV(Ct, { children: [
    /* @__PURE__ */ t.jsxDEV(wn, { asChild: !0, children: /* @__PURE__ */ t.jsxDEV(is, {}, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(it, { children: n.map((r) => /* @__PURE__ */ t.jsxDEV("div", { children: [
      /* @__PURE__ */ t.jsxDEV(Et, { children: r.label }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/filter-dropdown.component.tsx",
        lineNumber: 63,
        columnNumber: 15
      }, this),
      /* @__PURE__ */ t.jsxDEV(dr, { children: r.items.map((a) => /* @__PURE__ */ t.jsxDEV("div", { children: a.itemType === 0 ? /* @__PURE__ */ t.jsxDEV(xn, { onClick: a.onClick, children: a.label }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/filter-dropdown.component.tsx",
        lineNumber: 68,
        columnNumber: 23
      }, this) : /* @__PURE__ */ t.jsxDEV(br, { onClick: a.onClick, value: a.label, children: a.label }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/filter-dropdown.component.tsx",
        lineNumber: 72,
        columnNumber: 23
      }, this) }, a.label, !1, {
      ...
      children: [
        ...
        /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ t.jsxDEV(Ma, { className: "tw-mr-1 tw-h-4 tw-w-4" }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/more-info.component.tsx",
              lineNumber: 59,
              columnNumber: 11
            }, this),
        ...
        /* @__PURE__ */ t.jsxDEV("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ t.jsxDEV(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ t.jsxDEV(za, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" }, void 0, !1, {
                  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/more-info.component.tsx",
                  lineNumber: 95,
                  columnNumber: 11
                }, this)
          ...
          /* @__PURE__ */ t.jsxDEV(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ t.jsxDEV(Ia, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" }, void 0, !1, {
                  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/extension-marketplace/more-info.component.tsx",
                  lineNumber: 104,
                  columnNumber: 11
                }, this)
...
function ls({ id: e, versionHistory: n }) {
  const [r, a] = Y(!1), o = /* @__PURE__ */ new Date();
  function i(l) {
    const d = new Date(l), u = new Date(o.getTime() - d.getTime()), x = u.getUTCFullYear() - 1970, N = u.getUTCMonth(), h = u.getUTCDate() - 1;
    let w = "";
...
function Ki({
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { id: e, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ t.jsxDEV("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ t.jsxDEV(ls, { versionHistory: o }, void 0, !1, {
...
function ds({
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: x, children: /* @__PURE__ */ t.jsxDEV(yn, { open: N, onOpenChange: h, children: [
      ...
      F,
      {
        ...
        children: [
          /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ t.jsxDEV("div", { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50", children: /* @__PURE__ */ t.jsxDEV("span", { className: "tw-flex tw-h-full tw-w-full tw-items-center tw-justify-center", children: u }, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(kt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ t.jsxDEV(Vt, { children: [
      /* @__PURE__ */ t.jsxDEV(Pt, { placeholder: `Search ${o.toLowerCase()}...` }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/multi-select-combo-box.component.tsx",
        lineNumber: 138,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ t.jsxDEV(jt, { children: [
        /* @__PURE__ */ t.jsxDEV(Gt, { children: i }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/multi-select-combo-box.component.tsx",
          lineNumber: 140,
          columnNumber: 15
        }, this),
...
function us({
  ...
  const a = r["%webView_inventory_occurrences_table_header_reference%"], o = r["%webView_inventory_occurrences_table_header_occurrence%"], i = fe(() => {
    const c = [];
    return e.forEach((l) => {
      c.some((d) => pn(d, l)) || c.push(l);
    }), c;
  }, [e]);
  return /* @__PURE__ */ t.jsxDEV(_t, { stickyHeader: !0, children: [
    /* @__PURE__ */ t.jsxDEV(St, { stickyHeader: !0, children: /* @__PURE__ */ t.jsxDEV(je, { children: [
      /* @__PURE__ */ t.jsxDEV(ot, { children: a }, void 0, !1, {
      ...
      /* @__PURE__ */ t.jsxDEV(ot, { children: o }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/inventory/occurrences-table.component.tsx",
        lineNumber: 59,
        columnNumber: 11
      }, this)
    ...
    /* @__PURE__ */ t.jsxDEV(Rt, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ t.jsxDEV(
      je,
      {
        onClick: () => {
          n(c.reference);
        ...
        children: [
          /* @__PURE__ */ t.jsxDEV(Le, { children: `${I.bookIdToEnglishName(c.reference.book)} ${c.reference.chapterNum}:${c.reference.verseNum}` }, void 0, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/inventory/occurrences-table.component.tsx",
            lineNumber: 73,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ t.jsxDEV(Le, { children: c.text }, void 0, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/inventory/occurrences-table.component.tsx",
            lineNumber: 74,
            columnNumber: 15
          }, this)
...
const kn = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  tn.Root,
  {
    ref: r,
    className: m(
...
kn.displayName = tn.Root.displayName;
const Er = Ge(
...
), ps = p.forwardRef(({ className: e, variant: n, size: r, ...a }, o) => /* @__PURE__ */ t.jsxDEV(
  lr.Root,
  {
    ref: o,
...
ps.displayName = lr.Root.displayName;
const kr = p.createContext({
  size: "default",
  variant: "default"
}), Vr = p.forwardRef(({ className: e, variant: n, size: r, children: a, ...o }, i) => {
  const c = te();
  return /* @__PURE__ */ t.jsxDEV(
    yt.Root,
    {
...
Vr.displayName = yt.Root.displayName;
const xt = p.forwardRef(({ className: e, children: n, variant: r, size: a, ...o }, i) => {
  const c = p.useContext(kr);
  return /* @__PURE__ */ t.jsxDEV(
    yt.Item,
    {
      ref: i,
...
xt.displayName = yt.Item.displayName;
const Tt = (e) => e === "asc" ? /* @__PURE__ */ t.jsxDEV($a, { className: "tw-ms-2 tw-h-4 tw-w-4" }, void 0, !1, {
  ...
  let c = [...r];
  e.forEach((d) => {
    n === "approved" ? c.includes(d) || c.push(d) : c = c.filter((u) => u !== d);
  }), a(c);
  let l = [...o];
  e.forEach((d) => {
    n === "unapproved" ? l.includes(d) || l.push(d) : l = l.filter((u) => u !== d);
  }), i(l);
}, ec = (e, n, r, a, o) => ({
  accessorKey: "status",
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ t.jsxDEV(Vr, { value: c, variant: "outline", type: "single", children: [
      /* @__PURE__ */ t.jsxDEV(
        xt,
        {
          onClick: (d) => {
            d.stopPropagation(), Kt(
              [l],
              "approved",
              n,
              r,
  ...
  return n ? n[1] : "";
}, ws = (e, n, r) => r.includes(e) ? "unapproved" : n.includes(e) ? "approved" : "unknown", ac = Object.freeze([
  ...
  return e.forEach((o) => {
    const i = a.find(
      (c) => pn(
        c.items,
        Ht(o.inventoryText) ? [o.inventoryText] : o.inventoryText
      )
    );
    if (i)
      ...
      const c = {
        items: Ht(o.inventoryText) ? [o.inventoryText] : o.inventoryText,
        count: 1,
        status: ws(
          Ht(o.inventoryText) ? o.inventoryText : o.inventoryText[0],
          n,
          r
        ),
        occurrences: [
...
function oc({
  ...
  const u = ke(r, "%webView_inventory_all%"), x = ke(r, "%webView_inventory_approved%"), N = ke(r, "%webView_inventory_unapproved%"), h = ke(r, "%webView_inventory_unknown%"), w = ke(r, "%webView_inventory_scope_currentBook%"), E = ke(r, "%webView_inventory_scope_chapter%"), G = ke(r, "%webView_inventory_filter_text%"), C = ke(
    r,
    "%webView_inventory_show_additional_items%"
  ), [y, D] = Y(!1), [P, M] = Y("all"), [q, Ce] = Y(""), [he, V] = Y([]), v = fe(() => e.length === 0 ? [] : xs(e, o, i), [e, o, i]), $ = fe(() => {
    if (y) return v;
    const _ = [];
    return v.forEach((f) => {
    ...
    /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ t.jsxDEV(
        Xe,
        {
          ...
          defaultValue: P,
          children: [
            /* @__PURE__ */ t.jsxDEV(Oe, { className: "tw-m-1", children: /* @__PURE__ */ t.jsxDEV($e, { placeholder: "Select filter" }, void 0, !1, {
            ...
            /* @__PURE__ */ t.jsxDEV(Me, { children: [
              /* @__PURE__ */ t.jsxDEV(ve, { value: "all", children: u }, void 0, !1, {
                fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/inventory/inventory.component.tsx",
                lineNumber: 367,
                columnNumber: 13
              }, this),
      ...
      /* @__PURE__ */ t.jsxDEV(Xe, { onValueChange: (_) => be(_), defaultValue: c, children: [
        /* @__PURE__ */ t.jsxDEV(Oe, { className: "tw-m-1", children: /* @__PURE__ */ t.jsxDEV($e, { placeholder: "Select scope" }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/inventory/inventory.component.tsx",
          lineNumber: 375,
          columnNumber: 13
        }, this) }, void 0, !1, {
...
const Vn = p.forwardRef(({ className: e, orientation: n = "horizontal", decorative: r = !0, ...a }, o) => /* @__PURE__ */ t.jsxDEV(
  mr.Root,
  {
    ref: o,
    decorative: r,
...
const Pn = st.Provider, jn = st.Root, Gn = st.Trigger, Ot = p.forwardRef(({ className: e, sideOffset: n = 4, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  st.Content,
  {
    ref: a,
    sideOffset: n,
...
Ot.displayName = st.Content.displayName;
const hs = "16rem", vs = "3rem", Pr = p.createContext(void 0);
function Mt() {
  const e = p.useContext(Pr);
  if (!e)
...
const jr = p.forwardRef(
  ({
    ...
    const [u, x] = p.useState(e), N = n ?? u, h = p.useCallback(
      (P) => {
        const M = typeof P == "function" ? P(N) : P;
        r ? r(M) : x(M);
      },
      [r, N]
    ), w = p.useCallback(() => h((P) => !P), [h]), E = N ? "expanded" : "collapsed", y = te() === "ltr" ? c : c === "primary" ? "secondary" : "primary", D = p.useMemo(
      () => ({
        state: E,
        open: N,
        setOpen: h,
...
const Gr = p.forwardRef(({ variant: e = "sidebar", collapsible: n = "offcanvas", className: r, children: a, ...o }, i) => {
  const c = Mt();
...
const gs = p.forwardRef(({ className: e, onClick: n, ...r }, a) => {
  const o = Mt();
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
...
const Ds = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  Je,
  {
    ref: r,
    "data-sidebar": "input",
...
const Es = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  Vn,
  {
    ref: r,
...
on.displayName = "SidebarGroup";
const sn = p.forwardRef(({ className: e, asChild: n = !1, ...r }, a) => {
  const o = n ? Ye : "div";
  return /* @__PURE__ */ t.jsxDEV(
    o,
    {
...
const ks = p.forwardRef(({ className: e, asChild: n = !1, ...r }, a) => {
  const o = n ? Ye : "button";
  return /* @__PURE__ */ t.jsxDEV(
    o,
    {
...
cn.displayName = "SidebarGroupContent";
...
const Vs = Ge(
  ...
  ({
    ...
    const d = e ? Ye : "button", { state: u } = Mt(), x = /* @__PURE__ */ t.jsxDEV(
      d,
      {
        ref: l,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ t.jsxDEV(Ot, { side: "right", align: "center", hidden: u !== "collapsed", ...o }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/sidebar.tsx",
        lineNumber: 543,
        columnNumber: 9
      }, void 0)
...
const Ps = p.forwardRef(({ className: e, asChild: n = !1, showOnHover: r = !1, ...a }, o) => {
  const i = n ? Ye : "button";
  return /* @__PURE__ */ t.jsxDEV(
    i,
    {
...
const Gs = p.forwardRef(({ className: e, showIcon: n = !1, ...r }, a) => {
...
const Ss = p.forwardRef(({ asChild: e = !1, size: n = "md", isActive: r, className: a, ...o }, i) => {
  const c = e ? Ye : "a";
  return /* @__PURE__ */ t.jsxDEV(
    c,
    {
  ...
  return /* @__PURE__ */ t.jsxDEV(
    Gr,
    {
      ...
      children: /* @__PURE__ */ t.jsxDEV(_r, { children: [
        /* @__PURE__ */ t.jsxDEV(on, { children: [
          /* @__PURE__ */ t.jsxDEV(sn, { className: "tw-text-sm", children: i }, void 0, !1, {
          ...
          /* @__PURE__ */ t.jsxDEV(cn, { children: /* @__PURE__ */ t.jsxDEV(Sr, { children: Object.entries(n).map(([h, w]) => /* @__PURE__ */ t.jsxDEV(Rr, { children: /* @__PURE__ */ t.jsxDEV(
            Tr,
            {
              onClick: () => u(h),
              isActive: N(h),
        ...
        /* @__PURE__ */ t.jsxDEV(on, { children: [
          /* @__PURE__ */ t.jsxDEV(sn, { className: "tw-text-sm", children: c }, void 0, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/settings-components/settings-sidebar.component.tsx",
            lineNumber: 117,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ t.jsxDEV(cn, { className: "tw-pl-3", children: /* @__PURE__ */ t.jsxDEV(
            an,
            {
              buttonVariant: "ghost",
...
const Ve = "scrBook", Ts = "scrRef", Re = "source", Os = "details", Ms = "Scripture Reference", zs = "Scripture Book", Mr = "Type", Is = "Details";
function As(e, n) {
  const r = n ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? I.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Ve ? Fe(o.start) : void 0;
      },
      getGroupingValue: (a) => I.bookIdToNumber(a.start.book),
      sortingFn: (a, o) => en(a.original.start, o.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (a) => Fe(a.start),
      id: Ts,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : Fe(o.start);
      },
      sortingFn: (a, o) => en(a.original.start, o.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: Os,
      header: (e == null ? void 0 : e.detailsColumnName) ?? Is,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
const Bs = (e) => {
  ...
  let r = 0;
  return e.end && ({ offset: r } = e.end), !e.end || en(e.start, e.end) === 0 ? `${Jt(e.start)}+${n}` : `${Jt(e.start)}+${n}-${Jt(e.end)}+${r}`;
...
function ic({
  ...
  const [d, u] = Y([]), [x, N] = Y([{ id: Ve, desc: !1 }]), [h, w] = Y({}), E = fe(
  ...
  De(() => {
    if (l) {
      ...
      if (v.length === 1) {
        const $ = E.find((U) => er(U) === v[0]) || void 0;
        $ && l($);
      }
    }
  }, [h, E, l, C]);
  const y = o ?? zs, D = i ?? Mr, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Ve] },
    { label: `Group by ${D}`, value: [Re] },
    {
  ...
  }, Ce = (V, v) => V.getIsGrouped() ? "" : m("banded-row", v % 2 === 0 ? "even" : "odd"), he = (V, v, $) => {
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !n && /* @__PURE__ */ t.jsxDEV(
      Xe,
      {
        ...
        children: [
          /* @__PURE__ */ t.jsxDEV(Oe, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ t.jsxDEV($e, {}, void 0, !1, {
          ...
          /* @__PURE__ */ t.jsxDEV(Me, { position: "item-aligned", children: /* @__PURE__ */ t.jsxDEV(Qo, { children: P.map((V) => /* @__PURE__ */ t.jsxDEV(ve, { value: JSON.stringify(V.value), children: V.label }, V.label, !1, {
            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scripture-results-viewer/scripture-results-viewer.component.tsx",
            lineNumber: 385,
            columnNumber: 17
          }, this)) }, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(_t, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      n && /* @__PURE__ */ t.jsxDEV(St, { children: C.getHeaderGroups().map((V) => /* @__PURE__ */ t.jsxDEV(je, { children: V.headers.filter((v) => v.column.columnDef.header).map((v) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ t.jsxDEV(ot, { colSpan: v.colSpan, className: "top-0 tw-sticky", children: v.isPlaceholder ? void 0 : /* @__PURE__ */ t.jsxDEV("div", { children: [
          ...
          " ",
          nt(v.column.columnDef.header, v.getContext())
        ] }, void 0, !0, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scripture-results-viewer/scripture-results-viewer.component.tsx",
          lineNumber: 404,
          columnNumber: 25
      ...
      /* @__PURE__ */ t.jsxDEV(Rt, { children: C.getRowModel().rows.map((V, v) => {
        const $ = te();
        return /* @__PURE__ */ t.jsxDEV(
          je,
          {
            ...
            children: V.getVisibleCells().map((U) => {
              if (!(U.getIsPlaceholder() || U.column.columnDef.enableGrouping && !U.getIsGrouped() && (U.column.columnDef.id !== Re || !r)))
                return /* @__PURE__ */ t.jsxDEV(
                  Le,
                  {
                    className: m(
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ t.jsxDEV(
                      F,
                      {
                        ...
                        type: "button",
                        children: [
                          V.getIsExpanded() && /* @__PURE__ */ t.jsxDEV(Dt, {}, void 0, !1, {
                            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scripture-results-viewer/scripture-results-viewer.component.tsx",
                            lineNumber: 464,
                            columnNumber: 55
                          }, this),
                          !V.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ t.jsxDEV(ln, {}, void 0, !1, {
                            fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scripture-results-viewer/scripture-results-viewer.component.tsx",
                            lineNumber: 466,
                            columnNumber: 50
                          ...
                          " ",
                          nt(U.column.columnDef.cell, U.getContext()),
                          " (",
                          V.subRows.length,
                          ")"
                        ]
...
}), zr = (e, n, r) => Un(e, n).every((a) => r.includes(a));
function $s({
  bookId: e,
  selectedBookIds: n,
  toggleBook: r,
  ...
  return /* @__PURE__ */ t.jsxDEV(
    Ut,
    {
      ...
      onMouseDown: (u) => {
        u.preventDefault(), i.current = !0, r(e, u.shiftKey);
      },
      role: "option",
        ...
        /* @__PURE__ */ t.jsxDEV(
          "span",
          {
            className: m(
              ...
              {
                "tw-border-s-red-200": Be(e) === Pe.OT,
                "tw-border-s-purple-200": Be(e) === Pe.NT,
                "tw-border-s-indigo-200": Be(e) === Pe.DC,
                "tw-border-s-yellow-200": Be(e) === Pe.Extra
              }
            ),
...
function Ls({
  ...
  const i = Un(n, e).length === 0, c = o["%scripture_section_ot_short%"], l = o["%scripture_section_nt_short%"], d = o["%scripture_section_dc_short%"], u = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ t.jsxDEV(
    F,
    {
      variant: "outline",
      ...
      onClick: () => a(e),
      className: m(
        zr(n, e, r) && !i && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: i,
      children: Xs(
        e,
...
function Ys({
  ...
  const M = fe(() => I.allBookIds.filter(
    ...
    (v) => {
      const $ = Un(M, v).map((U) => U);
      r(
        zr(M, v, n) ? n.filter((U) => !$.includes(U)) : [.../* @__PURE__ */ new Set([...n, ...$])]
      );
    },
    [n, r, M]
  ), he = () => {
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(Pe).map((v) => /* @__PURE__ */ t.jsxDEV(
      Ls,
      {
        section: v,
        availableBookIds: M,
    ...
    /* @__PURE__ */ t.jsxDEV(yn, { open: C, onOpenChange: y, children: [
      ...
      /* @__PURE__ */ t.jsxDEV(kt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ t.jsxDEV(
        Vt,
        {
          onKeyDown: (v) => {
          ...
          children: [
            /* @__PURE__ */ t.jsxDEV(Pt, { placeholder: l }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
              lineNumber: 184,
              columnNumber: 13
            }, this),
            /* @__PURE__ */ t.jsxDEV("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ t.jsxDEV(F, { variant: "ghost", size: "sm", onClick: V, children: u }, void 0, !1, {
                fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
                lineNumber: 189,
                columnNumber: 15
              }, this)
            ...
            /* @__PURE__ */ t.jsxDEV(jt, { children: [
              /* @__PURE__ */ t.jsxDEV(Gt, { children: x }, void 0, !1, {
                fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
                lineNumber: 194,
                columnNumber: 15
              }, this),
              Object.values(Pe).map((v, $) => {
                const U = M.filter(
                  (ie) => Be(ie) === v
                );
                if (U.length !== 0)
                  return /* @__PURE__ */ t.jsxDEV(rr, { children: [
                    ...
                    $ < Object.values(Pe).length - 1 && /* @__PURE__ */ t.jsxDEV(Dr, {}, void 0, !1, {
                      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
                      lineNumber: 224,
                      columnNumber: 67
                    }, this)
    ...
    n.length > 0 && /* @__PURE__ */ t.jsxDEV("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      n.slice(
        ...
        var $;
        return /* @__PURE__ */ t.jsxDEV(vt, { variant: "secondary", children: o && (($ = o.get(v)) == null ? void 0 : $.localizedName) || I.bookIdToEnglishName(v) || v }, v, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
          lineNumber: 243,
          columnNumber: 15
        }, this);
      }),
      n.length > Wt && /* @__PURE__ */ t.jsxDEV(vt, { variant: "secondary", children: `+${n.length - tr} ${N}` }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/scope-selector/book-selector.component.tsx",
        lineNumber: 250,
        columnNumber: 13
      }, this)
...
function lc({
  ...
  const d = _e(
    ...
    c,
    "%webView_scope_selector_current_chapter%"
  ), N = _e(c, "%webView_scope_selector_current_book%"), h = _e(c, "%webView_scope_selector_choose_books%"), w = _e(c, "%webView_scope_selector_scope%"), E = _e(c, "%webView_scope_selector_select_books%"), G = [
...
function mc({
  ...
  return /* @__PURE__ */ t.jsxDEV(
    Xe,
    {
      ...
      children: [
        /* @__PURE__ */ t.jsxDEV(Oe, { size: o, className: m("pr-twp tw-w-auto", i), children: /* @__PURE__ */ t.jsxDEV(
          $e,
          {
            placeholder: c[X(n)] ?? n
          },
...
const Ar = (e, n, r, a) => r ? Object.entries(e).filter(
...
).sort(([, i], [, c]) => i.order - c.order).flatMap(([i]) => n.filter((l) => l.group === i).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ t.jsxDEV(jn, { children: [
  /* @__PURE__ */ t.jsxDEV(Gn, { asChild: !0, children: "command" in l ? /* @__PURE__ */ t.jsxDEV(
    fn,
    {
      onClick: () => {
        a(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ t.jsxDEV(gt, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }, void 0, !1, {
        ...
        l.label,
        l.iconPathAfter && /* @__PURE__ */ t.jsxDEV(gt, { icon: l.iconPathAfter, menuLabel: l.label }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
          lineNumber: 70,
          columnNumber: 21
        }, void 0)
    ...
    void 0
  ) : /* @__PURE__ */ t.jsxDEV(vo, { children: [
    /* @__PURE__ */ t.jsxDEV(ur, { children: l.label }, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
      lineNumber: 75,
      columnNumber: 19
    }, void 0),
    /* @__PURE__ */ t.jsxDEV(ho, { children: /* @__PURE__ */ t.jsxDEV(pr, { children: Ar(
      e,
      n,
      Ir(e, l.id),
      a
  ...
  l.tooltip && /* @__PURE__ */ t.jsxDEV(Ot, { children: l.tooltip }, void 0, !1, {
    fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
    lineNumber: 90,
    columnNumber: 30
  }, void 0)
...
function nr({
  ...
  return /* @__PURE__ */ t.jsxDEV(Ct, { variant: i, children: [
    /* @__PURE__ */ t.jsxDEV(wn, { "aria-label": r, className: o, asChild: !0, id: c, children: /* @__PURE__ */ t.jsxDEV(F, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ t.jsxDEV(Wa, {}, void 0, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
      lineNumber: 142,
      columnNumber: 20
    }, this) }, void 0, !1, {
    ...
    /* @__PURE__ */ t.jsxDEV(it, { align: "start", className: "tw-z-[250]", children: Object.entries(n.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, u) => /* @__PURE__ */ t.jsxDEV(rr, { children: [
      /* @__PURE__ */ t.jsxDEV(dr, { children: /* @__PURE__ */ t.jsxDEV(Pn, { children: Ar(n.groups, n.items, l, e) }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
        lineNumber: 155,
        columnNumber: 17
      }, this) }, void 0, !1, {
      ...
      d < u.length - 1 && /* @__PURE__ */ t.jsxDEV(ct, {}, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/tab-dropdown-menu.component.tsx",
        lineNumber: 160,
        columnNumber: 44
      }, this)
...
const Br = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
  return /* @__PURE__ */ t.jsxDEV(
    pe.Root,
    {
...
const Fr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  pe.List,
  {
    ref: r,
    className: m(
...
const Hs = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  pe.Trigger,
  {
    ref: r,
    ...n,
  ...
  void 0
)), Xr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  pe.Content,
  {
    ref: r,
    className: m(
...
function wc({
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ t.jsxDEV(Br, { children: [
      /* @__PURE__ */ t.jsxDEV(Fr, { children: e.map((c) => /* @__PURE__ */ t.jsxDEV(Hs, { value: c.value, children: c.value }, c.key, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/tab-navigation-content-search.component.tsx",
        lineNumber: 74,
        columnNumber: 13
      }, this)) }, void 0, !1, {
      ...
      e.map((c) => /* @__PURE__ */ t.jsxDEV(Xr, { value: c.value, children: c.content }, c.key, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/tab-navigation-content-search.component.tsx",
        lineNumber: 80,
        columnNumber: 11
      }, this))
...
const $r = p.forwardRef(({ className: e, variant: n = "default", ...r }, a) => {
  const o = p.useMemo(
    () => ({
      variant: n
    }),
  ...
  return /* @__PURE__ */ t.jsxDEV(bn.Provider, { value: o, children: /* @__PURE__ */ t.jsxDEV(
    J.Root,
    {
      ref: a,
      className: m(
...
const Lr = p.forwardRef(({ className: e, ...n }, r) => {
  const a = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.Trigger,
    {
      ...
      className: m(
        ...
        // CUSTOM
        Ee({ variant: a.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...n
    },
...
const Yr = p.forwardRef(({ className: e, inset: n, children: r, ...a }, o) => {
  const i = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.SubTrigger,
    {
      ...
      className: m(
        ...
        n && "tw-pl-8",
        Ee({ variant: i.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...a,
...
const Hr = p.forwardRef(({ className: e, ...n }, r) => {
  const a = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.SubContent,
    {
...
const Jr = p.forwardRef(({ className: e, align: n = "start", alignOffset: r = -4, sideOffset: a = 8, ...o }, i) => {
  const c = ge();
...
const qr = p.forwardRef(({ className: e, inset: n, ...r }, a) => {
  const o = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.Item,
    {
      ...
      className: m(
        ...
        n && "tw-pl-8",
        Ee({ variant: o.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...r
...
const Ks = p.forwardRef(({ className: e, children: n, checked: r, ...a }, o) => {
  const i = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.CheckboxItem,
    {
...
const Ws = p.forwardRef(({ className: e, children: n, ...r }, a) => {
  const o = ge();
  return /* @__PURE__ */ t.jsxDEV(
    J.RadioItem,
    {
...
const Zs = p.forwardRef(({ className: e, inset: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  J.Label,
  {
    ref: a,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", n && "tw-pl-8", e),
...
const Kr = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  J.Separator,
  {
    ref: r,
    className: m("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
const et = (e, n) => {
  ...
  return o.flatMap(([i], c) => {
    const l = n.filter((u) => u.group === i).sort((u, x) => u.order - x.order).map((u) => /* @__PURE__ */ t.jsxDEV(jn, { children: [
      /* @__PURE__ */ t.jsxDEV(Gn, { asChild: !0, children: "command" in u ? /* @__PURE__ */ t.jsxDEV(
        qr,
        {
          onClick: () => {
            a(u);
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ t.jsxDEV(gt, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }, void 0, !1, {
            ...
            u.label,
            u.iconPathAfter && /* @__PURE__ */ t.jsxDEV(gt, { icon: u.iconPathAfter, menuLabel: u.label }, void 0, !1, {
              fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
              lineNumber: 83,
              columnNumber: 21
            }, void 0)
        ...
        /* @__PURE__ */ t.jsxDEV(Yr, { children: u.label }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
          lineNumber: 88,
          columnNumber: 19
        }, void 0),
      ...
      u.tooltip && /* @__PURE__ */ t.jsxDEV(Ot, { children: u.tooltip }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
        lineNumber: 100,
        columnNumber: 30
      }, void 0)
    ] }, `tooltip-${u.label}-${"command" in u ? u.command : u.id}`, !0, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
      lineNumber: 67,
      columnNumber: 11
    }, void 0)), d = [...l];
    return l.length > 0 && c < o.length - 1 && d.push(/* @__PURE__ */ t.jsxDEV(Kr, {}, `separator-${i}`, !1, {
      fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
      lineNumber: 107,
      columnNumber: 31
    }, void 0)), d;
...
function Qs({
  ...
  const o = se(void 0), i = se(void 0), c = se(void 0), l = se(void 0), d = se(void 0), u = (x) => {
    switch (x) {
      case "platform.app":
        return i;
  ...
  if (lo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (x, N) => {
    var E, G, C, y;
    x.preventDefault();
    ...
    switch (N.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (E = i.current) == null || E.focus(), et(i, [h, w]);
        break;
      case "alt+l":
        (G = c.current) == null || G.focus(), et(c, [h, w]);
        break;
      case "alt+n":
        (C = l.current) == null || C.focus(), et(l, [h, w]);
        break;
      case "alt+h":
        (y = d.current) == null || y.focus(), et(d, [h, w]);
        break;
    }
  }), De(() => {
    ...
    return /* @__PURE__ */ t.jsxDEV($r, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(e.columns).filter(([, x]) => typeof x == "object").sort(([, x], [, N]) => typeof x == "boolean" || typeof N == "boolean" ? 0 : x.order - N.order).map(([x, N]) => /* @__PURE__ */ t.jsxDEV(Js, { children: [
      /* @__PURE__ */ t.jsxDEV(Lr, { ref: u(x), children: typeof N == "object" && "label" in N && N.label }, void 0, !1, {
        fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/advanced/menus/platform-menubar.component.tsx",
        lineNumber: 237,
        columnNumber: 13
      }, this),
  ...
  return /* @__PURE__ */ t.jsxDEV("div", { className: m("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ t.jsxDEV(
      Xe,
      {
        ...
        onOpenChange: (w) => x(w),
        children: [
          /* @__PURE__ */ t.jsxDEV(Oe, { children: /* @__PURE__ */ t.jsxDEV($e, {}, void 0, !1, {
...
), ri = p.forwardRef(({ className: e, variant: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV("div", { ref: a, role: "alert", className: m(ni({ variant: n }), e), ...r }, void 0, !1, {
  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/alert.tsx",
  lineNumber: 40,
  columnNumber: 3
}, void 0));
ri.displayName = "Alert";
const ai = p.forwardRef(
  ({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
    "h5",
    {
      ref: r,
...
ai.displayName = "AlertTitle";
const oi = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV("div", { ref: r, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...n }, void 0, !1, {
  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/alert.tsx",
  lineNumber: 64,
  columnNumber: 3
}, void 0));
oi.displayName = "AlertDescription";
const si = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  He.Root,
  {
    ref: r,
    className: m(
...
const ii = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  He.Image,
  {
    ref: r,
...
ii.displayName = He.Image.displayName;
const ci = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  He.Fallback,
  {
    ref: r,
    className: m(
...
ci.displayName = He.Fallback.displayName;
const li = p.forwardRef(
  ({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
    "div",
    {
      ref: r,
...
const ui = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV("p", { ref: r, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...n }, void 0, !1, {
  fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/card.tsx",
  lineNumber: 58,
  columnNumber: 3
}, void 0));
...
const wi = p.forwardRef(({ className: e, value: n, ...r }, a) => /* @__PURE__ */ t.jsxDEV(
  nn.Root,
  {
    ref: a,
    className: m(
...
wi.displayName = nn.Root.displayName;
function Nc({ ...e }) {
  return /* @__PURE__ */ t.jsxDEV(
    mo,
    {
...
const fi = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
  return /* @__PURE__ */ t.jsxDEV(
    tt.Root,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ t.jsxDEV(tt.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ t.jsxDEV(tt.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }, void 0, !1, {
        ...
        /* @__PURE__ */ t.jsxDEV(tt.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" }, void 0, !1, {
          fileName: "C:/Users/Paratext/Documents/Git/paranext-core/lib/platform-bible-react/src/components/shadcn-ui/slider.tsx",
          lineNumber: 32,
          columnNumber: 7
        }, void 0)
...
fi.displayName = tt.Root.displayName;
const xi = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
  return /* @__PURE__ */ t.jsxDEV(
    rn.Root,
    {
...
xi.displayName = rn.Root.displayName;
const Dc = pe.Root, hi = p.forwardRef(({ className: e, ...n }, r) => {
  const a = te();
  return /* @__PURE__ */ t.jsxDEV(
    pe.List,
    {
...
const vi = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  pe.Trigger,
  {
    ref: r,
    className: m(
...
const gi = p.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ t.jsxDEV(
  pe.Content,
  {
    ref: r,
    className: m(
...
const Di = (e, n, r = {}) => {
  ...
  return De(() => {
    ...
    return d(!!e), (async () => {
      ...
      u = !1, o.current.preserveValue || c(() => a.current);
    };
  }, [e]), [i, l];
}, Qt = () => !1, Cc = (e, n) => {
  const [r] = Di(
...
export {
  ...
  Wi as Filter,
  is as FilterButton,
  Hi as FilterDropdown,
  Ki as Footer,
  ac as INVENTORY_STRING_KEYS,
  Je as Input,
  Fi as InstallButton,
  oc as Inventory,
  ee as Label,
  Yi as MarkdownRenderer,
  qi as MoreInfo,
  ds as MultiSelectComboBox,
  wc as NavigationContentSearch,
  Ji as NoExtensionsFound,
  yn as Popover,
  ...
  cc as SCOPE_SELECTOR_STRING_KEYS,
  lc as ScopeSelector,
  ic as ScriptureResultsViewer,
  mc as ScrollGroupSelector,
  Or as SearchBar,
  Xe as Select,
  Me as SelectContent,
  Qo as SelectGroup,
  ...
  Vn as Separator,
  dc as SettingsList,
  pc as SettingsListHeader,
  uc as SettingsListItem,
  Rs as SettingsSidebar,
  sc as SettingsSidebarContentSearch,
  Qn as Skeleton,
  fi as Slider,
  Nc as Sonner,
  lt as Spinner,
  ...
  hc as UiLanguageSelector,
  Li as UpdateButton,
  ls as VersionHistory,
  Br as VerticalTabs,
  ...
  m as cn,
  rc as getBookIdFromUSFM,
  tc as getLinesFromUSFM,
  nc as getNumberFromUSFM,
  ws as getStatusForItem,
  fc as getToolbarOSReservedSpaceClassName,
  Qi as inventoryCountColumn,
  Zi as inventoryItemColumn,
  ec as inventoryStatusColumn,
  es as selectTriggerVariants,
  Vc as sonner,
  yc as useEvent,
  Cc as useEventAsync,
  Di as usePromise
