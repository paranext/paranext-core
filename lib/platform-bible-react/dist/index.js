      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(vi, { ...Z })
          },
          S.id
        );
      })
...
function gp({
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      ut === Ma ? ct = "generated" : ut === Ia ? ct = "hidden" : ut && (_(ut), L(ut)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
...
function Cp({
  ...
  }, [V, F]), S = $(() => O.length === 0 ? [] : Tw(O, N, D), [O, N, D]), Z = $(() => {
    var wt, st;
    if (!V) return d;
