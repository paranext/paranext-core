...
import Yt, { useRef as K, useMemo as V, createContext as ua, useContext as bo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
function ii({
  ...
  const g = K(!1), f = () => {
    ...
    () => _r(e, l),
    [e, l]
  ), y = !!p && !w, T = `${v} (${R})`, C = y ? h || `${T}, ${p}` : T, $ = /* @__PURE__ */ u(
    Se,
    {
      ref: t,
...
function Ml({
  ...
  W(() => {
    ...
    const I = (H) => !!H && H.scrollWidth > H.clientWidth, tt = () => {
      to !== "pointer" && (E || I(h.current) || I(l.current)) && T(!0);
    }, N = () => T(!1);
...
function za({
  ...
  const F = ye(), A = zl(), D = E ?? A, [U, Y] = _(!1), [q, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [H, nt] = _(void 0), [at, pt] = _(
    void 0
...
function rn({
  ...
  const [T, C] = _(!1), $ = d ?? l, E = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], F = (A, D) => {
  ...
  return /* @__PURE__ */ u(Pe, { open: T, onOpenChange: C, ...y, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: E(e) ? e.map((A) => /* @__PURE__ */ a(Ee, { heading: A.groupHeading, children: A.options.map((D) => F(D, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((A) => F(A)) }) })
        ] })
      }
    )
  ] });
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      const y = g[R], T = s[R] || document.createElement("div"), C = T.style;
      ...
      const F = ve(y.width);
      C.width !== F && (T.style.width = F, v = !0);
      const A = ve(y.height);
      C.height !== A && (T.style.height = A, v = !0), T.parentNode !== c && (c.append(T), v = !0), s[R] = T;
    }
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), x = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), T = g.offset, C = t.getElementByKey(x), $ = t.getElementByKey(y), E = r === null || C !== o || v !== n || x !== r.getKey(), F = i === null || $ !== s || T !== c || y !== i.getKey();
      if ((E || F) && C !== null && $ !== null) {
...
function fn({
  ...
  const g = j(
    ...
    [t.user]
  ), y = V(() => vo(t.contents), [t.contents]), T = V(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), C = !!t.conflictResolutionAction && !T, $ = V(() => {
    if (o && c)
      return /* @__PURE__ */ u(lt, { children: [
        /* @__PURE__ */ u(
          Je,
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (E) => {
                E.key === "Escape" ? (E.preventDefault(), E.stopPropagation(), g()) : Mo(E) && (E.preventDefault(), E.stopPropagation(), oe(w) && f());
              },
              onKeyDown: (E) => {
...
function Pi({
  ...
  const [q, Q] = _(mn), [I, tt] = _(), [N, z] = _(), H = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(C), [At, bt] = _(!1), Bt = K(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
...
function ww({
  ...
  }, C = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", $ = g ? [
    {
      value: "merge",
      ...
      !w && !h && /* @__PURE__ */ u(lt, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: E.map((N) => I(N) ? /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: tt(N) }),
              /* @__PURE__ */ a(It, { children: C })
            ] }) }, N.value) : tt(N))
          }
        ),
...
function Lp({
  ...
  const [y, T] = _(/* @__PURE__ */ new Set()), [C, $] = _(), [E, F] = _(), A = j(
    async (z) => {
      const H = await i(z);
  ...
  W(() => {
    f && (T((z) => new Set(z).add(f)), $(f));
  }, [f]);
  const D = r.filter(
    (z) => z.comments.some((H) => !H.deleted)
  ), U = D.map((z) => ({ id: z.id })), Y = j(
    (z) => {
      T((H) => new Set(H).add(z.id)), $(z.id), x == null || x(z.id);
    },
    [x]
  ), q = j(
    (z) => {
...
function kw({
  ...
  var E;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [v, R] = _({}), y = V(() => e ?? [], [e]), T = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
  ...
  let $;
  return l ? $ = Array.from({ length: 10 }).map((D, U) => `skeleton-row-${U}`).map((D) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((E = T.getRowModel().rows) == null ? void 0 : E.length) > 0 ? $ = T.getRowModel().rows.map((F) => /* @__PURE__ */ a(
    De,
    {
      onClick: () => s(F, T),
    ...
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: T.getHeaderGroups().map((F) => /* @__PURE__ */ a(De, { children: F.headers.map((A) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : Nr(A.column.columnDef.header, A.getContext()) }, A.id)) }, F.id)) }),
...
function Dw({
  ...
  const v = (y) => {
    if (s.current = !1, h(y), !y) {
      const T = f.current, C = x.current;
      T !== "custom" || C ? (T !== t || C !== e) && r(T, C) : (l(t), w(e));
    }
  }, R = (y) => {
    var T, C, $, E;
    y.stopPropagation(), document.activeElement === i.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((T = n.current) == null || T.focus(), s.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((C = i.current) == null || C.focus(), s.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && (($ = n.current) == null ? void 0 : $.selectionStart) === 0 && ((E = i.current) == null || E.focus(), s.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && v(!1);
  };
...
function Yp({
  ...
  const [v, R] = _("generated"), [y, T] = _("generated"), [C, $] = _("*"), [E, F] = _("*"), [A, D] = _("f"), [U, Y] = _(!1), [q, Q] = _(!0), [I, tt] = _(!1), N = K(!1), z = K(""), [H, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = K(null), vt = K(
    void 0
  ...
  W(() => {
    ...
    if (b && xr("note", b)) {
      ...
      let st = "custom";
      et === Za ? st = "generated" : et === Qa ? st = "hidden" : et && ($(et), F(et)), R(st), T(st), D(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
...
function Hw({
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    Oo(t.marker, [s], o, !1),
    " "
  ] }), g = e === "horizontal" ? "horizontal" : "vertical", f = o ? "marker-visible" : "", x = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", v = m(g, f);
  return /* @__PURE__ */ u(lt, { children: [
...
function Jp({
  ...
  const p = d ?? sc(r, void 0), h = (C, $) => {
    w == null || w(C, $, n);
  }, g = i ? r.findIndex((C) => C === i) : -1, [f, x] = _(g), v = (C, $, E) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
          C.preventDefault(), w == null || w($, E, n);
          break;
      }
  }, R = (C) => {
    if (r.length)
      switch (C.key) {
        case "ArrowDown":
          C.preventDefault(), x(($) => Math.min($ + 1, r.length - 1));
          break;
        case "ArrowUp":
          C.preventDefault(), x(($) => Math.max($ - 1, 0));
          break;
      }
  }, y = K([]);
  W(() => {
    var C;
    f >= 0 && f < y.current.length && ((C = y.current[f]) == null || C.focus());
  }, [f]);
  const T = i ? r.findIndex((C) => C === i) : -1;
  return W(() => {
    var C;
    T < 0 || T >= y.current.length || (C = y.current[T]) == null || C.scrollIntoView({ block: "nearest" });
  }, [T, s]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function nh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), x = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), R = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), T = fe(r, "%webView_inventory_scope_verse%"), C = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = fe(r, "%webView_inventory_no_results%"), [F, A] = _(!1), [D, U] = _("all"), [Y, q] = _(""), [Q, I] = _([]), tt = V(() => {
    const J = t ?? [];
...
function ru({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((T) => !T), [p]), g = w ? "expanded" : "collapsed", v = ye() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
    ...
    !e && /* @__PURE__ */ u(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(vw, { children: C.map((D) => /* @__PURE__ */ a(le, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((U) => U.column.columnDef.header).map((U) => (
      ...
      /* @__PURE__ */ a(ho, { children: R.getRowModel().rows.map((D, U) => {
        const Y = ye();
        return /* @__PURE__ */ a(
          De,
          {
...
function vu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
  ...
  }, [v, R] = _(!1), [y, T] = _(""), C = K(void 0), $ = K(!1), E = V(
    () => On(t),
    [t]
  ), F = V(() => {
    if (!y.trim()) {
    ...
    (I, tt = !1) => {
      ...
      const N = E.findIndex((pt) => pt === C.current), z = E.findIndex((pt) => pt === I);
      if (N === -1 || z === -1) return;
      const [H, nt] = [
        Math.min(N, z),
        Math.max(N, z)
      ], at = E.slice(H, nt + 1).map((pt) => pt);
      r(
    ...
    () => Object.values(Ct).filter(
      (I) => (i == null ? void 0 : i[I]) !== void 0 && go(E, I).length === 0
...
function kh({
  ...
  const $ = Rt(
    s,
    "%webView_scope_selector_selected_text%"
  ), E = Rt(s, "%webView_scope_selector_verse%"), F = Rt(s, "%webView_scope_selector_chapter%"), A = Rt(s, "%webView_scope_selector_book%"), D = Rt(
    s,
    "%webView_scope_selector_current_verse%"
  ), U = Rt(
    s,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    ...
    w === "dropdown" && qt && /* @__PURE__ */ a(Ba, { open: S === "range", onOpenChange: k, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Vr,
        onCloseAutoFocus: rt,
...
function Mh({
  ...
  const d = Bu(
    ...
    var R, y, T, C, $, E;
    const v = x !== f ? ((y = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : y[x]) ?? ((C = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : C.en) : void 0;
