...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Un ? Xt : Y, Ir = { tag: Wa };
...
function Al(t) {
  ...
  if (ge(e)) r = Ks(e.focus, "next");
    ...
    r = r || qs(Pe(), "previous").getFlipped().insert(Er());
  }
