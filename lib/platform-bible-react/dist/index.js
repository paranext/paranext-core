...
import { useReactTable as Xn, getFilteredRowModel as Ia, getSortedRowModel as Fn, getPaginationRowModel as Oa, getCoreRowModel as Hn, flexRender as oe, getGroupedRowModel as Aa, getExpandedRowModel as Pa } from "@tanstack/react-table";
...
const Xa = vt.Portal, Kn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Overlay,
  {
    ref: n,
    className: d(
...
const Zt = se.Root, Qt = se.Trigger, Lt = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = tt();
...
function co(t, e, n, a) {
  const o = L(() => {
    if (t.chapterNum > 1)
      ...
      if (m > 0) {
        const c = e[m - 1], p = Math.max(bt(c), 1);
        a({
          book: c,
          chapterNum: p,
          verseNum: 1
...
function Mi({
  ...
  const c = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [$, W] = O(!1), B = nt(void 0), at = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), U = L(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            xt = ot === 0 ? Et : Math.max(1, ot - Sn);
            break;
          case "ArrowDown":
            xt = ot === 0 ? 1 : Math.min(Et, ot + Sn);
            break;
          default:
            return;
        }
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gn.Root, { ref: n, className: d("pr-twp", po(), t), ...e }));
...
}), or = G.Trigger, sr = G.Group, fo = G.Portal, go = G.Sub, bo = G.RadioGroup;
...
function xo({ table: t }) {
  return /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(za, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function Do({
  ...
  var S;
  const [m, c] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Xn({
    data: e,
    columns: t,
    getCoreRowModel: Hn(),
...
function ji({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(dn, { children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((c, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(sr, { children: c.itemType === 0 ? /* @__PURE__ */ r(Nt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        pn,
        {
          checked: a[p][h],
...
function Ue(t, e, n = !0, a = !0, o = []) {
  if (!(!e || e.length === 0))
    return e.map((s) => {
      ...
      return i += `-${s.marker ?? "unknown"}`, $o(s, i, n, [
        ...o,
        t ?? "unknown"
      ]);
    });
...
function Lo({
  ...
  const m = a ? /* @__PURE__ */ r("span", { className: Ye, children: `\\${t.marker} ` }) : void 0, c = a ? /* @__PURE__ */ r("span", { className: Ye, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(Nt, { children: [
...
const Xo = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function Gi({
  ...
  const p = c ? Yo(c, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Ma(e, void 0), h = (f) => {
    m && m(f);
  };
  return /* @__PURE__ */ l(Nt, { children: [
...
Ko.displayName = Yn.Root.displayName;
...
function Ji({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), h = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), b = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), v = yt(n, "%webView_inventory_scope_verse%"), S = yt(n, "%webView_inventory_filter_text%"), N = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, $] = O(!1), [W, B] = O("all"), [at, pt] = O(""), [_, E] = O([]), U = H(() => t.length === 0 ? [] : Zo(t, o, s), [t, o, s]), A = H(() => {
    if (C) return U;
    const T = [];
    return U.forEach((Z) => {
  ...
  return /* @__PURE__ */ l("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ft, { onValueChange: (T) => k(T), defaultValue: i, children: [
...
const Qo = "16rem", ts = "3rem", gr = u.createContext(void 0);
function Ee() {
...
const es = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Ee();
  return /* @__PURE__ */ l(
    I,
    {
...
const is = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ut : "button",
  {
    ref: a,
...
const ls = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Ut : "button",
  {
    ref: o,
...
const ms = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ut : "a",
  {
    ref: s,
...
const _t = "scrBook", fs = "scrRef", Dt = "source", gs = "details", bs = "Scripture Reference", vs = "Scripture Book", _r = "Type", xs = "Details";
function ys(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, jn = (t) => `${Ns({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Zi({
  sources: t,
    ...
    !e && /* @__PURE__ */ l(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(yo, { children: $.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ l(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ r(Xt, {}) : /* @__PURE__ */ r(je, {})),
                          " ",
...
const Tr = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(bn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(fo, { children: /* @__PURE__ */ r(wr, { children: Tr(
      t,
      e,
      Rr(t, w.id),
      a
...
function We({
  ...
  return /* @__PURE__ */ l(dn, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, c]) => typeof m == "boolean" || typeof c == "boolean" ? 0 : m.order - c.order).map(([m], c, p) => /* @__PURE__ */ l(Ln, { children: [
...
function iw({
  ...
  return /* @__PURE__ */ l("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Vr, { children: [
      /* @__PURE__ */ r(Mr, { children: t.map((w) => /* @__PURE__ */ r(_s, { value: w.value, children: w.value }, w.key)) }),
...
jr.displayName = X.Item.displayName;
const Ts = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ht();
  return /* @__PURE__ */ l(
    X.CheckboxItem,
    {
...
const Es = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ht();
  return /* @__PURE__ */ l(
    X.RadioItem,
    {
...
const Vs = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
$r.displayName = X.Separator.displayName;
const ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
...
function Ms({
  ...
  if ($a(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    var b, y, v, S;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(Ss, { children: [
...
function cw({
  ...
  return /* @__PURE__ */ l("div", { id: m, className: d("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(Q, { className: "tw-font-normal tw-text-muted-foreground", children: Da(c, {
...
const Os = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(ka, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), Ps = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r(
  "div",
  {
    ref: a,
    role: "alert",
...
const js = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
$s.displayName = Kt.Root.displayName;
...
const uw = F.Root, mw = F.Trigger, hw = F.Group, fw = F.Portal, gw = F.Sub, bw = F.RadioGroup, Gs = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  F.SubTrigger,
  {
    ref: o,
    className: d(
...
const Xs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.SubContent,
  {
    ref: n,
    className: d(
...
const Fs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(F.Portal, { children: /* @__PURE__ */ r(
  F.Content,
  {
    ref: n,
    className: d(
...
const Hs = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Item,
  {
    ref: a,
    className: d(
...
const Ys = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  F.CheckboxItem,
  {
    ref: o,
    className: d(
...
const Us = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  F.RadioItem,
  {
    ref: a,
    className: d(
...
const Ks = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: a,
    className: d(
...
const qs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  F.Separator,
  {
    ref: n,
...
const vw = mt.Trigger, Zs = mt.Portal, xw = mt.Close, Gr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
...
const Qs = u.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
...
const ri = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Description,
  {
    ref: n,
    className: d("tw-text-sm tw-text-muted-foreground", t),
...
const ai = u.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: a,
    className: d(
...
const si = u.forwardRef(({ className: t, ...e }, n) => {
  const a = tt();
  return /* @__PURE__ */ r(
    Xe.Root,
    {
...
const _w = wt.Root, ii = u.forwardRef(({ className: t, ...e }, n) => {
  const a = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
...
const li = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Content,
  {
    ref: n,
    className: d(
...
const pi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = O(void 0), [w, m] = O(void 0), c = L(
    (h) => {
      i(h);
...
export {
  ...
  Ls as AvatarImage,
  Di as BOOK_CHAPTER_CONTROL_STRING_KEYS,
