import ll, { jsx as i, jsxs as N, Fragment as Qt } from "react/jsx-runtime";
import * as B from "react";
import E, { forwardRef as lr, useCallback as Et, useState as ut, useRef as Ht, useEffect as ce, useLayoutEffect as ma, useMemo as Rt } from "react";
...
import { ChevronRight as go, Check as Je, Circle as bo, X as vo, Search as fi, ChevronsUpDown as mi, FilterIcon as ul, ChevronDown as cr, ChevronUp as wl, ArrowLeftIcon as fl, ChevronLeftIcon as ml, ChevronRightIcon as hl, ArrowRightIcon as gl, CircleCheckIcon as bl, CircleXIcon as vl, CircleHelpIcon as yl, ArrowUpIcon as xl, ArrowDownIcon as Nl, ArrowUpDownIcon as kl, Star as El, PanelLeft as Sl, PanelRight as Tl, ScrollText as Cl, ChevronLeft as Rl, LoaderCircle as Ol, Download as _l, Filter as Pl, User as Il, Link as $l, CircleHelp as Ml } from "lucide-react";
import { getChaptersForBook as Al, deepEqual as yo, substring as Dl, formatScrRef as Br, compareScrRefs as eo, scrRefToBBBCCCVVV as Vr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as jl, formatBytes as Bl } from "platform-bible-utils";
...
import Gl, { ThemeContext as Ul, internal_processStyles as Xl } from "@mui/styled-engine";
import { MenuItem as Yl, ListItemText as Hl, ListItemIcon as Ni, Menu as ql, Grid as ki, List as Wl, IconButton as Ei, Drawer as Kl } from "@mui/material";
...
import tc from "markdown-to-jsx";
...
function eh({
  ...
  const o = Nt(), [a, s] = ut(""), [l, c] = ut(
    ...
    at.bookNumberToId(t.bookNum)
  ), [m, b] = ut(!1), [h, g] = ut(m), k = Ht(void 0), T = Ht(void 0), C = Ht(void 0), S = Et(
    (j) => {
      const M = r ? r() : To;
      return {
  ...
  }, [h]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ N(xo, { modal: !1, open: m, onOpenChange: F, children: [
      ...
      pr,
      {
        ...
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: ba.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ i(ur, { className: "tw-font-semibold tw-text-foreground/80", children: Nc[j] }),
...
function ao({
  ...
  const [g, k] = ut(!1);
  return /* @__PURE__ */ N(Ai, { open: g, onOpenChange: k, ...h, children: [
...
function Xc({
  ...
  var g;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [m, b] = ut({}), h = gi({
    data: e,
    columns: t,
    getCoreRowModel: vi(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(Bc, { table: h }),
    /* @__PURE__ */ N(fr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(mr, { stickyHeader: a, children: h.getHeaderGroups().map((k) => /* @__PURE__ */ i(le, { children: k.headers.map((T) => /* @__PURE__ */ i(kn, { children: T.isPlaceholder ? void 0 : gn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
...
}, Wc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fi = Re(
...
), Kc = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  yi.Root,
  {
    ref: o,
...
Kc.displayName = yi.Root.displayName;
...
const gr = (t) => t === "asc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(kl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), oh = (t) => ({
  accessorKey: "item",
  ...
  return Hc(t).forEach((p) => {
    p.startsWith("\\id") && (s = qc(p), l = 0, c = 0), p.startsWith("\\c") && (l = va(p), c = 0), p.startsWith("\\v") && (c = va(p), l === 0 && (l = e.chapterNum));
    let f = o.exec(p) ?? void 0;
    for (; f; ) {
      const w = [];
      f.forEach((g) => w.push(g));
      const m = f.index, b = a.find((g) => yo(g.items, w)), h = {
        reference: {
          bookNum: s !== void 0 ? s : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: Dl(p, Math.max(0, m - 25), Math.min(m + 25, p.length))
      };
      if (b)
...
function lh({
  ...
  const f = ee(n, "%webView_inventory_all%"), w = ee(n, "%webView_inventory_approved%"), m = ee(n, "%webView_inventory_unapproved%"), b = ee(n, "%webView_inventory_unknown%"), h = ee(n, "%webView_inventory_scope_currentBook%"), g = ee(n, "%webView_inventory_scope_chapter%"), k = ee(n, "%webView_inventory_scope_verse%"), T = ee(n, "%webView_inventory_filter_text%"), C = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? Qc(
    l,
    t,
    a,
    s,
  ...
  return /* @__PURE__ */ i("div", { className: d, children: /* @__PURE__ */ N(Ai, { open: p, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ i(Co, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ N(Ro, { children: [
      ...
      /* @__PURE__ */ N(_o, { children: [
        ...
        /* @__PURE__ */ i(Bi, { children: b.map((h) => {
          ...
          return /* @__PURE__ */ N(
            Io,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: h.starred && /* @__PURE__ */ i(El, { className: "tw-h-4 tw-w-4" }) }),
...
function ch({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(Xi, { children: [
      /* @__PURE__ */ i(Yi, { children: t.map((s) => /* @__PURE__ */ i(ed, { value: s.value, children: s.value }, s.key)) }),
...
const nd = Rn.Provider, rd = Rn.Root, od = Rn.Trigger, qi = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  Rn.Content,
  {
    ref: r,
    sideOffset: e,
...
const ad = "16rem", id = "3rem", Wi = E.createContext(void 0);
function br() {
...
const Ki = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(Wi.Provider, { value: T, children: /* @__PURE__ */ i(nd, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const sd = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = br();
  return /* @__PURE__ */ N(
    wt,
    {
...
const cd = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Qe,
  {
    ref: n,
    "data-sidebar": "input",
...
const wd = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: r,
...
wd.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const c = t ? Ze : "button", { state: d } = br(), p = /* @__PURE__ */ i(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: y(fd({ variant: n, size: r }), a),
        ...s
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ i(od, { asChild: !0, children: p }),
      /* @__PURE__ */ i(qi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ns.displayName = "SidebarMenuButton";
const md = E.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: o,
...
hd.displayName = "SidebarMenuBadge";
const gd = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
gd.displayName = "SidebarMenuSkeleton";
...
bd.displayName = "SidebarMenuSub";
const vd = E.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ i("li", { ref: e, ...t })
);
vd.displayName = "SidebarMenuSubItem";
const yd = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? Ze : "a",
  {
    ref: a,
    ...
    Ji,
    {
      ...
      children: /* @__PURE__ */ N(Qi, { children: [
        /* @__PURE__ */ N(io, { children: [
          ...
          /* @__PURE__ */ i(lo, { children: /* @__PURE__ */ i(ts, { children: Object.entries(e).map(([w, m]) => /* @__PURE__ */ i(es, { children: /* @__PURE__ */ i(
            ns,
            {
              className: y(
...
const ie = "scrBook", Nd = "scrRef", he = "source", kd = "details", Ed = "Scripture Reference", Sd = "Scripture Book", rs = "Type", Td = "Details";
function Cd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Ed,
      cell: (r) => {
...
}, xa = (t) => `${Rd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ph({
  sources: t,
  ...
  const [c, d] = ut([]), [p, f] = ut([{ id: ie, desc: !1 }]), [w, m] = ut({}), b = Rt(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(go, {}) : /* @__PURE__ */ i(Rl, {})),
                          " ",
...
var Sa;
function is() {
  return Sa || (Sa = 1, process.env.NODE_ENV === "production" ? Gn.exports = Pd() : Gn.exports = Id()), Gn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ad() {
  if (_a) return Wr;
  _a = 1;
  var t = is(), e = $d(), n = /* @__PURE__ */ Do(), r = /* @__PURE__ */ ss(), o = /* @__PURE__ */ Md(), a = function() {
  };
...
function jd() {
  ...
  if (Ia = 1, process.env.NODE_ENV !== "production") {
    var t = is(), e = !0;
    Ln.exports = /* @__PURE__ */ Ad()(t.isElement, e);
  } else
    Ln.exports = /* @__PURE__ */ Dd()();
  return Ln.exports;
}
var Bd = /* @__PURE__ */ jd();
const u = /* @__PURE__ */ os(Bd);
function Vd(t) {
  const {
    prototype: e = {}
  } = t;
...
var Aa;
function Ud() {
  return Aa || (Aa = 1, process.env.NODE_ENV === "production" ? Un.exports = Ld() : Un.exports = Gd()), Un.exports;
}
var Da = Ud();
...
function cs(t, e = "") {
  return t.displayName || t.name || Yd(t) || e;
}
function ja(t, e, n) {
  const r = cs(e);
...
function dp(t) {
  t.addEventListener("keydown", lp, !0), t.addEventListener("mousedown", Jr, !0), t.addEventListener("pointerdown", Jr, !0), t.addEventListener("touchstart", Jr, !0), t.addEventListener("visibilitychange", cp, !0);
}
function pp(t) {
  const {
    target: e
...
function ws() {
  ...
  function n() {
    return e.current ? (po = !0, ap.start(100, () => {
      po = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function wp(t, e = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const fp = ["values", "unit", "step"], mp = (t) => {
...
function hp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = St(t, fp), a = mp(e), s = Object.keys(a);
  function l(w) {
...
const xp = {
  ...
  if (t.length > 2)
    if (Ga[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = xp[e], o = Np[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), Nr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], kr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Ep = [...Nr, ...kr];
function _n(t, e, n, r) {
  var o;
...
function Tp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = kp(n), a = Sp(o, r), s = t[n];
  return re(t, s, a);
}
function vs(t, e) {
  const n = bs(t.theme);
  return Object.keys(t).map((r) => Tp(t, e, r, n)).reduce(bn, {});
}
function gt(t) {
  return vs(t, Nr);
}
...
bt.filterProps = kr;
process.env.NODE_ENV !== "production" && Ep.reduce((t, e) => (t[e] = de, t), {});
function Cp(t = 8) {
  if (t.mui)
    return t;
  const e = bs({
...
const Rp = Ut("border", zt), Op = Ut("borderTop", zt), _p = Ut("borderRight", zt), Pp = Ut("borderBottom", zt), Ip = Ut("borderLeft", zt), $p = Ut("borderColor"), Mp = Ut("borderTopColor"), Ap = Ut("borderRightColor"), Dp = Ut("borderBottomColor"), jp = Ut("borderLeftColor"), Bp = Ut("outline", zt), Vp = Ut("outlineColor"), Sr = (t) => {
...
Er(Rp, Op, _p, Pp, Ip, $p, Mp, Ap, Dp, jp, Sr, Bp, Vp);
const Tr = (t) => {
...
Er(Tr, Cr, Rr, zp, Fp, Lp, Gp, Up, Xp, Yp, Hp, qp);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const Wp = yt({
...
function iu() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : re(s, r, (b) => {
      let h = er(w, p, b);
      return b === h && typeof b == "string" && (h = er(w, p, `${n}${b === "default" ? "" : Jt(b)}`, b)), c === !1 ? h : {
        [c]: h
      };
    });
  }
...
function Lo(t = {}, ...e) {
  ...
  return d.applyStyles = su, d = e.reduce((p, f) => ne(p, f), d), d.unstable_sxConfig = _({}, Fo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Or({
      sx: f,
      theme: this
    });
...
const hu = Lo(), Ua = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Xn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function bu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Xl(s, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = gu(Ua(d))
    } = l, m = St(l, wu), b = p !== void 0 ? p : (
    ...
    let k = Kn;
    d === "Root" || d === "root" ? k = r : d ? k = o : mu(s) && (k = void 0);
    const T = Gl(s, _({
      shouldForwardProp: k,
      label: g
    }, m)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Jn(v, _({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Jt(d || "")}`), D === void 0 && (D = `Styled(${Hd(s)})`), L.displayName = D;
      }
...
function Go(t, e = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (t < e || t > n) && console.error(`MUI: The value provided ${t} is out of range [${e}, ${n}].`), wp(t, e, n);
}
function xu(t) {
  t = t.slice(1);
...
function Xa(t) {
  t = Te(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Te(Nu(t)).values : t.values;
...
const Sn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Cu = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function Mu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Cu), a = t.primary || Ru(e), s = t.secondary || Ou(e), l = t.error || _u(e), c = t.info || Pu(e), d = t.success || Iu(e), p = t.warning || $u(e);
  function f(h) {
    const g = Ya(h, Zr.text.primary) >= n ? Zr.text.primary : Ha.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ya(h, g);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return qa(h, "light", T, r), qa(h, "dark", C, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, m = {
    dark: Zr,
    light: Ha
  };
...
function ju(t, e) {
  ...
  const m = o / 14, b = f || ((k) => `${k / d * m}rem`), h = (k, T, C, S, v) => _({
    ...
    button: h(l, 14, 1.75, 0.4, Wa),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, Wa),
...
const Bu = 0.2, Vu = 0.14, zu = 0.12;
function ht(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${Bu})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${Vu})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${zu})`].join(",");
}
const Fu = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Lu = ["duration", "easing", "delay"], Gu = {
...
function Yu(t) {
  const e = _({}, Gu, t.easing), n = _({}, Uu, t.duration);
  return _({
...
const Hu = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, qu = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Wu(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
...
const Ku = (t) => Kn(t) && t !== "classes", In = bu({
  themeId: Xo,
  defaultTheme: Uo,
...
const Zu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Qu = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  ...
  const r = Yo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, m = St(r, Zu), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", h = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), rw = /* @__PURE__ */ Od(nw);
var Za;
function ow() {
...
function aw() {
  ...
  var e = t(/* @__PURE__ */ ow()), n = ll;
  return cn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), cn;
}
var iw = /* @__PURE__ */ aw();
const sw = /* @__PURE__ */ os(iw);
function lw(t) {
  return typeof t == "string";
}
function mn(t, e, n) {
  return t === void 0 || lw(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const cw = {
  disableDefaultClasses: !1
}, dw = /* @__PURE__ */ B.createContext(cw);
function pw(t) {
  const {
...
function fw(t) {
  ...
  const s = uw(_({}, o, r)), l = ti(r), c = ti(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
  return p.length > 0 && (w.className = p), Object.keys(f).length > 0 && (w.style = f), {
    props: w,
    internalRef: d.ref
  };
}
const mw = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function hw(t) {
  var e;
  const {
    elementType: n,
...
process.env.NODE_ENV !== "production" && (rr.propTypes = Fd(rr.propTypes));
var Ot = "top", Lt = "bottom", Gt = "right", _t = "left", Ho = "auto", $n = [Ot, Lt, Gt, _t], He = "start", Tn = "end", xw = "clippingParents", Ss = "viewport", pn = "popper", Nw = "reference", ei = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Tn]);
}, []), Ts = /* @__PURE__ */ [].concat($n, [Ho]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Tn]);
}, []), kw = "beforeRead", Ew = "read", Sw = "afterRead", Tw = "beforeMain", Cw = "main", Rw = "afterMain", Ow = "beforeWrite", _w = "write", Pw = "afterWrite", Iw = [kw, Ew, Sw, Tw, Cw, Rw, Ow, _w, Pw];
function Zt(t) {
...
function Mn(t) {
  for (var e = jt(t), n = ni(t); n && Dw(n) && oe(n).position === "static"; )
    n = ni(n);
...
function zw(t) {
  ...
  if (!(!a || !s)) {
    var f = Vw(o.padding, n), w = Wo(a), m = c === "y" ? Ot : _t, b = c === "y" ? Lt : Gt, h = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Mn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = h / 2 - g / 2, S = f[m], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = vn(S, P, v), R = c;
...
function ai(t, e, n) {
  return e === Ss ? wo(Jw(t, n)) : Ce(e) ? Qw(e, n) : wo(Zw(pe(t)));
}
function tf(t) {
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? xw : l, d = n.rootBoundary, p = d === void 0 ? Ss : d, f = n.elementContext, w = f === void 0 ? pn : f, m = n.altBoundary, b = m === void 0 ? !1 : m, h = n.padding, g = h === void 0 ? 0 : h, k = _s(typeof g != "number" ? g : Ps(g, $n)), T = w === pn ? Nw : pn, C = t.rects.popper, S = t.elements[b ? T : w], v = ef(Ce(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = $s({
    reference: P,
    element: C,
    placement: o
...
function of(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, m = n.flipVariations, b = m === void 0 ? !0 : m, h = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), T = k === g, C = c || (T || !b ? [Zn(g)] : rf(g)), S = [g].concat(C).reduce(function(z, K) {
      return z.concat(Wt(K) === Ho ? nf(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
...
function mf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, m = w === void 0 ? !0 : w, b = n.tetherOffset, h = b === void 0 ? 0 : b, g = Cn(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), T = Ke(e.placement), C = !T, S = Ko(k), v = ff(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof h == "function" ? h(Object.assign({}, e.rects, {
    placement: e.placement
  })) : h, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? Ot : _t, M = S === "y" ? Lt : Gt, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = m ? -R[A] / 2 : 0, O = T === He ? F[A] : R[A], U = T === He ? -R[A] : -F[A], X = e.elements.arrow, z = m && X ? Wo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Os(), q = K[j], W = K[M], Y = vn(0, F[A], z[A]), Z = C ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Mn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Xt = vn(m ? or(H, V) : H, G, m ? xe(rt, xt) : rt);
      P[S] = Xt, tt[S] = Xt - G;
    }
    if (l) {
      var ue, Tt = S === "x" ? Ot : _t, jn = S === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", we = Yt + g[Tt], Pe = Yt - g[jn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Yt - F[_e] - R[_e] - $e + L.altAxis, en = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Bn = m && Ie ? Bw(fe, Yt, en) : vn(m ? fe : we, Yt, m ? en : Pe);
      P[v] = Bn, tt[v] = Bn - Yt;
    }
...
function yf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && vf(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Qo(a)) && (l = bf(e)), Ft(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Zo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = Nf(Ef([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (ci(T, C)) {
            p.rects = {
              reference: yf(T, Mn(C), p.options.strategy === "fixed"),
              popper: Wo(C)
...
var Tf = [qw, wf, Yw, Aw, pf, af, hf, Lw, lf], Cf = /* @__PURE__ */ Sf({
  defaultModifiers: Tf
});
const Rf = "Popper";
function Of(t) {
...
const _f = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Pf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function If(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Mf = () => Bo({
  root: ["root"]
}, pw(Of)), Af = {}, Df = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = St(e, _f), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const P = If(p, s), [F, R] = B.useState(P), [I, L] = B.useState(ar(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = Mf(), J = (r = b.root) != null ? r : "div", j = hw({
    elementType: J,
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = St(e, Pf), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || $f(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
var Bf = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const Ff = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function ho(t) {
  return `scale(${t}, ${t ** 2})`;
}
const Lf = {
  ...
  } = e, k = St(e, Ff), T = fn(), C = B.useRef(), S = As(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
ir.muiSupportAuto = !0;
const Gf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Uf = In(Ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ys(), a = Yo({
    ...
    slots: C,
    slotProps: S
  } = a, v = St(a, Gf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const se = gs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Yf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Hf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const qf = (t) => {
...
const js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Yo({
    ...
    TransitionProps: kt
  } = P, V = St(P, Yf), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
...
`));
  ...
  const na = (et) => {
    ...
    Tt || jn(et.currentTarget), Js(et), oa.current === !0 && (aa(!0), Mr(et));
  }, la = (et) => {
    we.current = !0;
    const $t = xt.props;
...
`));
  const rl = B.useMemo(() => {
    ...
    touch: we.current
  }), jr = qf(an), pa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Wf, ua = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : ir, wa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Kf, fa = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : Jf, ol = mn(pa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(jr.popper, Y == null ? void 0 : Y.className, (m = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : m.className)
  }), an), al = mn(ua, _({}, kt, (h = Z.transition) != null ? h : L.transition), an), il = mn(wa, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
  ...
  const {
    ...
    Yl,
    {
      ...
      children: n ? /* @__PURE__ */ N(Qt, { children: [
        wi(a, n, !0),
        /* @__PURE__ */ i(Hl, { primary: n, inset: !a && o }),
        f ? /* @__PURE__ */ i(Ni, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(sw, {}) }) : wi(s, n, !1)
      ] }) : g
    }
  );
...
const Qf = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function zs(t) {
...
const An = lr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Ol, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
const sm = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.CheckboxItem,
    {
...
const lm = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ N(
    mt.RadioItem,
    {
...
const qs = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  mt.Separator,
  {
    ref: n,
    className: y("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
const dm = (t, e) => {
  ...
  return o.flatMap(([a], s) => {
    ...
    return l.length > 0 && s < o.length - 1 && c.push(/* @__PURE__ */ i(qs, {}, `${a}-separator`)), c;
  });
};
function pm({
  menuProvider: t,
  ...
  const [r] = sr(
    ...
    void 0
  ), o = Ht(void 0), a = Ht(void 0), s = Ht(void 0), l = Ht(void 0), c = (p) => {
    switch (p) {
    ...
    setTimeout(() => {
      f.forEach((w) => {
        var m;
        (m = p.current) == null || m.dispatchEvent(new KeyboardEvent("keydown", w));
      });
    }, 0);
  };
  if (Zl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    var b, h, g, k;
    p.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = o.current) == null || b.focus(), d(o, [w, m]);
        break;
      case "alt+l":
        (h = a.current) == null || h.focus(), d(a, [w, m]);
        break;
      case "alt+n":
        (g = s.current) == null || g.focus(), d(s, [w, m]);
        break;
      case "alt+h":
        (k = l.current) == null || k.focus(), d(l, [w, m]);
        break;
    }
  }), !!r)
    return /* @__PURE__ */ i(Ls, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(r.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ N(am, { children: [
      /* @__PURE__ */ i(Gs, { ref: c(p), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ i(Ys, { children: Ws(r.groups, r.items, p, e) })
    ] }, p)) });
}
function yh({
  menuProvider: t,
          ...
          children: [
            ...
            /* @__PURE__ */ i("div", { className: "tw-flex tw-grow tw-basis-0", children: /* @__PURE__ */ i(
              "div",
              {
                ...
                style: { WebkitAppRegion: "no-drag" },
                children: t ? /* @__PURE__ */ i(Qt, { children: /* @__PURE__ */ i(
                  pm,
                  {
                    menuProvider: t,
                    commandHandler: e,
...
), wm = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: y(um({ variant: e }), t), ...n }));
...
const mm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function gm({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: y("pr-twp", hm({ variant: e }), t), ...n });
}
...
const xm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Em.displayName = wn.Root.displayName;
...
Sm.displayName = ro.Root.displayName;
const Nh = It.Root, Tm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    It.List,
    {
...
Tm.displayName = It.List.displayName;
...
Cm.displayName = It.Trigger.displayName;
...
Rm.displayName = It.Content.displayName;
function kh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      children: t ? /* @__PURE__ */ i(An, { size: 15 }) : /* @__PURE__ */ N(Qt, { children: [
        /* @__PURE__ */ i(_l, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Ch({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: y("pr-twp tw-prose", n), children: /* @__PURE__ */ i(tc, { options: o, children: e }) });
}
const Om = lr((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ref: e,
...
function Rh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ i(Si, { asChild: !0, children: /* @__PURE__ */ i(Om, {}) }),
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(Il, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
...
function Ih({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ i("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ N(gm, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ i(
          wt,
          {
            variant: "ghost",
...
export {
  ...
  Ih as Filter,
  Om as FilterButton,
  Rh as FilterDropdown,
  Ph as Footer,
  nm as GridMenu,
  gh as HamburgerMenuButton,
  ...
  dh as SettingsSidebarContentSearch,
  Em as Slider,
  xh as Sonner,
  An as Spinner,
  Sm as Switch,
  ...
  Hc as getLinesFromUSFM,
  va as getNumberFromUSFM,
  Wc as getStatusForItem,
  ah as inventoryCountColumn,
