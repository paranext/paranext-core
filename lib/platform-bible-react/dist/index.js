...
import { c as v, g as Re, a as Ir, C as qe, L as Un, u as Zo, T as It, b as Tt, d as St, e as Rt, A as pa, D as Ie, f as ye, h as ze, i as yr, j as Le, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ue, r as Ne, o as xs, p as Kn, P as tr, q as kr, s as er, t as rr, v as _a, w as Na, y as No, z as ar, E as Ca, F as Ot, R as Co, G as ha, H as ro, J as ao, K as oo, M as no, N as Hn, O as oa, Q as Eo, S as $r, U as Vr, V as ur, W as ys, X as Ze, Y as Fe, Z as Pe, _ as Be, $ as pr, a0 as To, a1 as So, a2 as ga, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ea, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Wn, al as Xn, am as Do, an as Os, ao as Jn, ap as Ba, aq as tn, ar as ja, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as jr, ay as Mo, az as Vs, aA as Ls } from "./resizable-s4-Avg1I.js";
import { aB as rf, aC as af, aD as of, aE as nf, aF as sf, aG as cf, aH as lf, aI as df, aJ as wf, aK as uf, aL as pf, aM as hf, aN as gf, aO as ff, aP as mf, aQ as vf, aR as bf, aS as xf, aT as yf, aU as kf, aV as _f, aW as Nf, aX as Cf, aY as Ef, aZ as Tf, a_ as Sf, a$ as Rf, b0 as Df, b1 as Mf, b2 as Of, b3 as If, b4 as zf, b5 as Pf, b6 as Af, b7 as $f, b8 as Vf, b9 as Lf, ba as Bf } from "./resizable-s4-Avg1I.js";
...
function Ha({
  ...
  const T = Ne(), L = Ql(), [P, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [G, nt] = _(
    void 0
    ...
    if (!z) return;
    const m = M.startsWith(`${z.book} `) ? M : "", q = Qr(m), at = Or(m);
    return {
      book: z.book,
  ...
  const oe = j(() => {
    ...
    (m) => {
      const q = G ?? (z == null ? void 0 : z.book), at = ot ?? (z == null ? void 0 : z.chapterNum);
      !q || !at || (gt({
        book: q,
        chapterNum: at,
        verseNum: m
    ...
    (m) => {
      const q = N === "chapters" ? O : z == null ? void 0 : z.book;
      if (q) {
        if (w && w(q, m) > 1) {
          nt(q), wt(m), rt("verses"), Y("");
          return;
        }
        gt({
          book: q,
  ...
  const { otLong: Vt, ntLong: Zt, dcLong: Nr, extraLong: Ye } = {
    ...
    [t.book, s, L]
  ), qr = `${t.chapterNum}:${t.verseNum}`, Cr = j((m) => (q) => {
    Nt.current[m] = q;
  }, []), nr = j((m) => (q) => {
    Ct.current[m] = q;
  }, []), Er = $(
    ...
    (m) => {
      ...
      if (!(!!q && !!((Wo = ht.current) != null && Wo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (m.key === "Tab") {
        ...
        const se = At[At.length - 1], qt = m.shiftKey ? At[0] : se;
        document.activeElement === qt && (m.preventDefault(), m.stopPropagation(), (m.shiftKey ? se : At[0]).focus());
        return;
      }
      ...
      if (N === "books" && z && !_t && m.key === "Enter" && !(q !== xt.current && !!(q != null && q.closest('button, a, input, select, textarea, [role="button"]')))) {
      ...
      if (N === "books" && !re && (m.key === "ArrowLeft" || m.key === "ArrowRight")) {
        const At = q === xt.current ? xt.current : void 0, se = (At == null ? void 0 : At.selectionStart) ?? 0, qt = (At == null ? void 0 : At.selectionEnd) ?? 0, ge = T === "rtl" ? m.key === "ArrowRight" : m.key === "ArrowLeft";
        if (!!At && (se !== qt || (ge ? se > 0 : qt < At.value.length))) return;
      }
      if (m.shiftKey || N === "books" && q !== xt.current && (q != null && q.closest('button, a, [role="button"]')))
        return;
      const kt = (() => {
        const At = N === "books" && z && ie && z.chapterNum ? { bookId: z.book, chapterNum: z.chapterNum } : void 0, se = N === "verses" ? { bookId: G, chapterNum: ot } : At;
        if (se) {
          const { bookId: qt, chapterNum: ge } = se;
          return !qt || !ge || !w ? void 0 : {
            max: w(qt, ge),
            current: Qr(M) ?? 0,
            buildValue: (Sr) => sa(qt, ge, Sr),
            refs: Ct,
        ...
        if (N === "chapters" || N === "books" && z && Ve(z.book) > 1) {
          const qt = N === "chapters" ? O : z == null ? void 0 : z.book;
          return qt ? {
            max: Ve(qt),
            current: Or(M) ?? 0,
            buildValue: (ge) => hr(qt, ge),
            refs: Nt,
    ...
    const { isLetter: q, isDigit: at } = gn(m.key);
    (q || at) && (m.preventDefault(), tt((kt) => kt + m.key), (Kt = xt.current) == null || Kt.focus(), Z(!1));
  }, []);
  Xt(() => {
    const m = setTimeout(() => {
      if (P && N === "books" && yt.current && Ht.current) {
        const q = yt.current, at = Ht.current, Lt = at.offsetTop, Kt = q.clientHeight, kt = at.clientHeight, Qt = Lt - Kt / 2 + kt / 2;
        q.scrollTo({
          top: Math.max(0, Qt),
          behavior: "smooth"
        }), Y(go(t.book));
    ...
    if (N === "chapters" && O) {
      const m = O === t.book, q = m ? t.chapterNum : 1;
      Y(hr(O, q)), setTimeout(() => {
        if (yt.current)
          if (m) {
  ...
  const Pt = z ? `${z.book} ${z.chapterNum ?? ""} ${z.verseNum ?? ""} ${ie}` : "", Se = F(""), lr = F(""), Jr = $(() => {
    ...
    const { book: m, chapterNum: q, verseNum: at } = z;
    if (ie && q && w)
      return {
        max: w(m, q),
        initial: at ?? (m === t.book && q === t.chapterNum ? t.verseNum : 1),
        parse: Qr,
        buildValue: (Kt) => sa(m, q, Kt)
      };
    const Lt = Ve(m);
    if (!(Lt <= 1))
      return {
  ...
  return Xt(() => {
    ...
    const { max: m, initial: q, parse: at, buildValue: Lt } = Jr, Kt = (kt) => {
      const Qt = at(kt);
      return Qt !== void 0 && Qt >= 1 && Qt <= m && kt === Lt(Qt) ? Qt : void 0;
    };
    if (Se.current !== Pt) {
      Se.current = Pt;
      const kt = Lt(Math.min(Math.max(q, 1), m));
      lr.current = kt, Y(kt);
      return;
    }
    if (Kt(M) !== void 0) {
    ...
    Y(
      Kt(lr.current) !== void 0 ? lr.current : Lt(Math.min(Math.max(q, 1), m))
    );
    ...
    /* @__PURE__ */ a(
      er,
      {
        ...
        onPointerDownOutside: (m) => {
          const { target: q } = m;
          P && de.current && q instanceof Node && de.current.contains(q) && (ae.current = !0, st(!1));
        },
        onCloseAutoFocus: R,
            ...
            children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Na, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: H.map(
                      ({ onClick: m, disabled: q, title: at, icon: Lt, group: Kt }, kt) => {
                        const Qt = /* @__PURE__ */ a(
                          J,
                          {
                            variant: "ghost",
              ...
              !_t && /* @__PURE__ */ u(ar, { ref: yt, children: [
                N === "books" && /* @__PURE__ */ u(ut, { children: [
                  !z && Object.entries(ve).map(([m, q]) => {
                    if (q.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ue, { heading: We(m), children: q.map((at) => /* @__PURE__ */ a(
                          Ci,
                          {
                            bookId: at,
                            onSelect: (Lt) => K(Lt),
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = ee();
  if (fi(n) || ke(n)) for (const s of n.getNodes()) Gd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
function rs({
  ...
  const [U, tt] = _(zn), [N, rt] = _(), [O, I] = _(), G = o, [nt, ot] = _(!1), [wt, _t] = _(!1), [Z, lt] = _(!1), [pt, mt] = _(!1), [vt, re] = _(!1), [bt, de] = _(E), [ae, ht] = _(!1), xt = F(void 0), [yt, Ht] = _(/* @__PURE__ */ new Map());
  W(() => {
    let y = !0;
    return (async () => {
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: bt ? /* @__PURE__ */ a(Gs, {}) : /* @__PURE__ */ a(Ys, {})
              }
            ),
            M === void 0 ? (
...
function jw({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : Y, tt = () => {
    ...
    const I = f === O.value, G = `${d}-${O.value}`, nt = N(O);
    return (
...
function hh({
  ...
  const [k, C] = _(/* @__PURE__ */ new Set()), [E, A] = _(), [T, L] = _(), P = j(
    async (I) => {
      const G = await s(I);
      return G !== void 0 && I.assignedUser !== void 0 && I.assignedUser !== "" && L(I.assignedUser), G;
    },
    [s]
  );
  W(() => {
  ...
  const D = r.filter(
    ...
    (I) => {
      C((G) => new Set(G).add(I.id)), A(I.id), x == null || x(I.id);
    },
    [x]
  ), U = j(
    (I) => {
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
...
function Nh({
  ...
  const [b, R] = _("generated"), [k, C] = _("generated"), [E, A] = _("*"), [T, L] = _("*"), [P, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [G, nt] = _(!1), [ot, wt] = _(), [_t, Z] = _(), [lt, pt] = _(), [mt, vt] = _(), re = F(null), bt = F(
    void 0
  ...
  W(() => {
    ...
    const K = (y) => {
      const H = S();
      !G && H && document.activeElement === H && y.key === c ? (y.preventDefault(), $t()) : G && y.key === "Escape" && (y.preventDefault(), nt(!1));
    };
...
function zh({
  ...
  }, [L, rt]), I = $(() => O.length === 0 ? [] : Su(O, D, Y), [O, D, Y]), G = $(() => {
    var pt, mt;
    if (!L) return l;
...
function Jh({
  ...
  const A = Bt(
  ...
  ), Zt = Ht === "end", Nr = Ht === "start", Ye = "tw:text-muted-foreground", We = w === "dropdown" && S === "range", Ia = We ? V : Ae, za = We ? it : f ? Ut : bt, qr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: de, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ot, { htmlFor: "scope-range-end", className: v(Nr && Ye), children: G }),
      /* @__PURE__ */ a(
        Ha,
        {
          id: "scope-range-end",
  ...
  const [ie, Pa] = _(null), [ir, sr] = _(null), [Te, Aa] = _(null), $a = 200, [Gr, Va] = _(!1);
  W(() => {
...
function ko({
  ...
  return /* @__PURE__ */ u(Ie, { variant: s, children: [
    ...
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: Pe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Ur, { children: [
      /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(It, { children: ss(e.groups, e.items, l, t) }) }),
