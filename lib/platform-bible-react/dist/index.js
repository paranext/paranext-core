...
var cs = (t, e, n) => e in t ? ws(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var bt = (t, e, n) => cs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as ct } from "react/jsx-runtime";
import b, { forwardRef as nn, useRef as Y, useMemo as F, useState as R, useCallback as K, useLayoutEffect as Zt, createContext as kn, useContext as ur, useEffect as q, Component as ds, createElement as $r, Suspense as ps, Fragment as co } from "react";
import { Command as kt } from "cmdk";
import { X as Pe, Search as po, Check as Vt, Clock as Lr, ChevronsLeft as Vr, ChevronsRight as jr, ChevronLeft as Yn, ChevronRight as Re, ArrowLeft as us, ArrowRight as ms, Circle as _n, ChevronDown as $e, BoldIcon as fs, ItalicIcon as hs, AtSign as uo, Pencil as gs, Trash2 as bs, ArrowUp as mo, MoreHorizontal as fo, MailOpen as vs, Mail as xs, ChevronUp as ho, FilterIcon as ys, ArrowLeftIcon as Ns, ChevronLeftIcon as ks, ChevronRightIcon as _s, ArrowRightIcon as Cs, Copy as go, Filter as Es, User as Ts, Link as Rs, CircleHelp as Ss, ChevronsUpDown as bo, Star as Ds, SquareX as vo, FunctionSquare as xo, SquareSigma as yo, Ban as Ms, AlertCircle as Xn, CircleCheckIcon as Os, CircleXIcon as Is, CircleHelpIcon as As, ArrowUpIcon as Ps, ArrowDownIcon as $s, PanelLeft as Ls, PanelRight as Vs, ScrollText as js, MenuIcon as zs, Menu as Fs, EllipsisVertical as Bs, LoaderCircle as Ks, GripVertical as Gs } from "lucide-react";
...
import { includes as ln, Section as U, getChaptersForBook as Hs, formatScrRef as be, getSectionForBook as He, formatRelativeDate as Ys, formatReplacementString as ge, sanitizeHtml as Xs, NumberFormat as Ws, formatBytes as Js, getCurrentLocale as Zs, usfmMarkers as un, getFormatCallerFunction as Qs, deepEqual as ti, isString as zr, compareScrRefs as Wn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import * as No from "@radix-ui/react-label";
import * as Ze from "@radix-ui/react-radio-group";
import { createEditor as ko, $getRoot as ie, $createParagraphNode as Cn, $getSelection as Lt, HISTORY_MERGE_TAG as mr, ParagraphNode as _o, TextNode as Co, $isTokenOrSegmented as ei, $getCharacterOffsets as ni, $cloneWithPropertiesEphemeral as ri, $findMatchingParent as Eo, $isElementNode as ae, $isRangeSelection as ye, CLEAR_EDITOR_COMMAND as To, COMMAND_PRIORITY_EDITOR as Ro, mergeRegister as le, shallowMergeConfig as oi, defineExtension as Gt, safeCast as rn, createState as ai, FORMAT_TEXT_COMMAND as So, $isNodeSelection as Do, COMMAND_PRIORITY_LOW as Mo, RootNode as si, LineBreakNode as ii, TabNode as li, $isEditorState as wi, createCommand as ci, CLICK_COMMAND as di, isDOMNode as pi, $getNodeFromDOMNode as ui, $createNodeSelection as mi, $setSelection as fi, DecoratorNode as Jn, $getState as hi, toggleTextFormatType as Fr, TEXT_TYPE_TO_FORMAT as gi, $setState as bi, addClassNamesToElement as Oo, $create as vi, $getNodeByKey as xi, removeClassNamesFromElement as yi, KEY_TAB_COMMAND as Ni, $isBlockElementNode as hn, $createRangeSelection as ki, $normalizeSelection__EXPERIMENTAL as _i, OUTDENT_CONTENT_COMMAND as Ci, INDENT_CONTENT_COMMAND as Br, INSERT_TAB_COMMAND as Ei, COMMAND_PRIORITY_CRITICAL as fr, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Io, getRegisteredNode as Si, isHTMLElement as Di, isDocumentFragment as Kr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as Ao, $createLineBreakNode as Po, $isRootOrShadowRoot as Oi, isBlockDomNode as Gr, isInlineDomNode as qr, $insertNodes as Ii } from "lexical";
import * as Ve from "@radix-ui/react-tooltip";
import { TooltipTrigger as Ai } from "@radix-ui/react-tooltip";
import { HeadingNode as Pi, QuoteNode as $i, registerRichText as Li } from "@lexical/rich-text";
import { flushSync as Vi, createPortal as ji } from "react-dom";
...
import { useReactTable as jo, getFilteredRowModel as Bi, getSortedRowModel as zo, getPaginationRowModel as Ki, getCoreRowModel as Fo, flexRender as Ye, getGroupedRowModel as Gi, getExpandedRowModel as qi } from "@tanstack/react-table";
import * as lt from "@radix-ui/react-select";
import Ui from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Zn, HIDDEN_NOTE_CALLER as Qn, getDefaultViewOptions as Hi, isInsertEmbedOpOfType as wn, Editorial as Yi } from "@eten-tech-foundation/platform-editor";
import * as tr from "@radix-ui/react-checkbox";
import * as _t from "@radix-ui/react-tabs";
import * as at from "@radix-ui/react-menubar";
import { useHotkeys as Xi } from "react-hotkeys-hook";
...
const Ji = Us({ prefix: "tw-" });
function f(...t) {
  return Ji(qs(t));
}
const Zi = "layoutDirection";
function ft() {
  const t = localStorage.getItem(Zi);
  return t === "rtl" ? t : "ltr";
}
const Qi = $t.Root, tl = $t.Portal, Bo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Overlay,
  {
    ref: n,
    className: f(
...
Bo.displayName = $t.Overlay.displayName;
const Ko = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ft();
  return /* @__PURE__ */ d(tl, { children: [
    /* @__PURE__ */ r(Bo, {}),
    /* @__PURE__ */ d(
      $t.Content,
      {
...
Ko.displayName = $t.Content.displayName;
...
qo.displayName = $t.Title.displayName;
const el = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Description,
  {
    ref: n,
...
el.displayName = $t.Description.displayName;
...
ze.displayName = kt.Input.displayName;
...
const Uo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.Separator,
  {
    ref: n,
...
Uo.displayName = kt.Separator.displayName;
const qt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.Item,
  {
    ref: n,
...
const Xo = wt.allBookIds.filter(
  (t) => !wt.isObsolete(wt.bookIdToNumber(t))
), ve = Object.fromEntries(
  Xo.map((t) => [t, wt.bookIdToEnglishName(t)])
);
function br(t, e, n) {
...
const Wo = nn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Le : "button", { className: f(Jo({ variant: e, size: n, className: t })), ref: i, ...a })
);
B.displayName = "Button";
const ne = Se.Root, de = Se.Trigger, rl = Se.Anchor, Ut = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
Ut.displayName = Se.Content.displayName;
function rr(t, e, n) {
  return `${t} ${ve[t]}${e ? ` ${gr(t, e)} ${Te(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function ol({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(ne, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Ut, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: /* @__PURE__ */ r(Qt, { heading: i, children: t.map((u) => /* @__PURE__ */ d(
      qt,
      {
        onSelect: () => p(u),
...
function sp(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function Hr({
  ...
  if (t)
    return /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Kt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      qt,
      {
        value: `${t} ${ve[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function ip({
  ...
  const w = ft(), [p, u] = R(!1), [h, m] = R(""), [g, x] = R(""), [v, y] = R("books"), [N, _] = R(void 0), [k, z] = R(!1), L = Y(void 0), T = Y(void 0), $ = Y(void 0), C = Y(void 0), S = Y({}), V = K(
    (E) => {
      e(E), l && l(E);
    },
    [e, l]
  ), j = F(() => o ? o() : Xo, [o]), I = F(() => ({
    [U.OT]: j.filter((X) => wt.isBookOT(X)),
    [U.NT]: j.filter((X) => wt.isBookNT(X)),
    [U.DC]: j.filter((X) => wt.isBookDC(X)),
    [U.Extra]: j.filter((X) => wt.extraBooks().includes(X))
    ...
    (E) => {
      if (E.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Ur(E.key);
      if (v === "chapters") {
        if (E.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(E.key)) {
        ...
        switch (E.key) {
          case "ArrowLeft":
            ut !== 0 && (Nt = ut > 1 ? ut - 1 : Xt);
            break;
          case "ArrowRight":
            ut !== 0 && (Nt = ut < Xt ? ut + 1 : 1);
            break;
          case "ArrowUp":
            Nt = ut === 0 ? Xt : Math.max(1, ut - sn);
            break;
          case "ArrowDown":
            Nt = ut === 0 ? 1 : Math.min(Xt, ut + sn);
            break;
          default:
            return;
        }
        Nt !== ut && (E.preventDefault(), E.stopPropagation(), m(rr(rt, a, Nt)), setTimeout(() => {
          const ue = S.current[Nt];
  ...
  return Zt(() => {
    const E = setTimeout(() => {
      if (p && v === "books" && $.current && C.current) {
        const X = $.current, nt = C.current, rt = nt.offsetTop, ut = X.clientHeight, Xt = nt.clientHeight, Nt = rt - ut / 2 + Xt / 2;
        X.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), m(rr(t.book));
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: dt.map(({ onClick: E, disabled: X, title: nt, icon: rt }) => /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              B,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(us, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ms, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Te(N, a) })
          ] }),
...
), mt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(No.Root, { ref: n, className: f("pr-twp", ll(), t), ...e }));
mt.displayName = No.Root.displayName;
...
vr.displayName = Ze.Root.displayName;
...
function or({
  ...
  const [N, _] = R(!1), k = c ?? l, z = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], L = (T, $) => {
    const C = l(T), S = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, V = `${$ ?? ""}${C}${S ?? ""}`;
    return /* @__PURE__ */ d(
      qt,
      {
        value: C,
  ...
  return /* @__PURE__ */ d(ne, { open: N, onOpenChange: _, ...y, children: [
    /* @__PURE__ */ r(de, { asChild: !0, children: /* @__PURE__ */ d(
      B,
      {
        variant: m,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Ut,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          /* @__PURE__ */ r(ze, { placeholder: u, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(on, { children: h }),
          /* @__PURE__ */ r(ee, { children: z(e) ? e.map((T) => /* @__PURE__ */ r(Qt, { heading: T.groupHeading, children: T.options.map(($) => L($, T.groupHeading)) }, T.groupHeading)) : e.map((T) => L(T)) })
        ] })
      }
    )
  ] });
...
var dl = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(dl || {});
...
function cp({
  ...
  const p = $n(w, "%webView_bookSelector_currentBook%"), u = $n(w, "%webView_bookSelector_choose%"), h = $n(w, "%webView_bookSelector_chooseBooks%"), [m, g] = R(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), t(v);
...
const Qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ul = Qo ? Zt : q, cn = { tag: mr };
function ml({ initialConfig: t, children: e }) {
  const n = F(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = pl(null, o), p = ko({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
        if (h === void 0) u.update(() => {
          ...
          if (m.isEmpty()) {
            const g = Cn();
            m.append(g);
            const x = Qo ? document.activeElement : null;
            (Lt() !== null || x !== null && x === u.getRootElement()) && g.select();
          }
        }, cn);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const m = u.parseEditorState(h);
            u.setEditorState(m, cn);
            break;
          }
          case "object":
  ...
  }, []), r(Zo.Provider, { value: n, children: e });
}
const fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : q;
function hl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Ht();
  return fl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(mr) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const xr = {
  ...
  mark: "",
  markOverlap: ""
}, Rt = Ve.Provider, At = Ve.Root, Pt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Ve.Trigger,
  {
    ref: o,
...
Pt.displayName = Ve.Trigger.displayName;
...
St.displayName = Ve.Content.displayName;
const yr = [
  Pi,
  _o,
  Co,
...
class bl extends ds {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && vl(e.resetKeys, a)) {
      var i, s;
...
function xl({ children: t, onError: e }) {
  return r(bl, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : q;
function Nl(t) {
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, El = ta && "documentMode" in document ? document.documentMode : null;
!(!ta || !("InputEvent" in window) || El) && "getTargetRanges" in new window.InputEvent("input");
function Tl(t) {
  const e = Eo(t, (n) => ae(n) && !n.isInline());
  return ae(e) || Cl(4, t.__key), e;
}
function Rl(t) {
  const e = Lt();
  if (!ye(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Eo(i, (w) => ae(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function Nr(t) {
  ...
  t.x = void 0, t.s = void 0, ra(t);
}
function Ol(t) {
  if (J !== this) throw new Error("Out-of-order effect");
  na(this), J = t, this.f &= -2, 8 & this.f && Nr(this), Tn();
}
function Ee(t, e) {
...
vt.prototype.brand = Sl, vt.prototype.h = function() {
  return !0;
}, vt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Yr(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && Yr(() => {
      var o;
...
} }), fe.prototype = new vt(), fe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === mn)) return !0;
  if (this.g = mn, this.f |= 1, this.i > 0 && !ea(this)) return this.f &= -2, !0;
  const t = J;
  try {
    Wr(this), J = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ra(this), Wr(this), se++;
  const t = J;
  return J = this, Ol.bind(this, t);
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function oa() {
  const t = ie(), e = Lt(), n = Cn();
  t.clear(), t.append(n), e !== null && n.select(), ye(e) && (e.format = 0);
}
function aa(t, e = oa) {
  return t.registerCommand(To, (n) => (t.update(e), !0), Ro);
}
Gt({ build: (t, e, n) => Rn(e), config: rn({ $onClear: oa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return we(() => aa(t, o.value));
} });
function Il(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Vn = ai("format", { parse: (t) => typeof t == "number" ? t : 0 });
class sa extends Jn {
  $config() {
    return this.config("decorator-text", { extends: Jn, stateConfigs: [{ flat: !0, stateConfig: Vn }] });
  }
  getFormat() {
    return hi(this, Vn);
  }
  getFormatFlags(e, n) {
    return Fr(this.getFormat(), e, n);
  }
  hasFormat(e) {
    const n = gi[e];
  ...
  toggleFormat(e) {
    const n = this.getFormat(), o = Fr(n, e, null);
...
Gt({ name: "@lexical/extension/DecoratorText", nodes: () => [sa], register: (t, e, n) => t.registerCommand(So, (o) => {
  const a = Lt();
  if (Do(a) || ye(a)) for (const i of a.getNodes()) Al(i) && i.toggleFormat(o);
  return !1;
}, Mo) });
function ia(t, e) {
  let n;
...
const sr = Gt({ build: (t) => ia(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function la(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = la(n[a], o[a]);
    return t;
  }
  return e;
}
const kr = 0, ir = 1, wa = 2, jn = 3, dn = 4, Ce = 5, zn = 6, Ge = 7;
function Fn(t) {
  return t.id === kr;
}
function ca(t) {
...
function Pl(t) {
  return function(e) {
    return e.id === ir;
  }(t) || et(305, String(t.id), String(ir)), Object.assign(t, { id: wa });
}
...
class Ll {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : oi;
    for (const o of this.configs) e = n(e, o);
    return e;
  }
  init(e) {
    const n = this.state;
    ca(n) || et(306, String(n.id));
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== dn && et(307, String(n.id), String(Ce)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== zn && et(310, String(n.id), String(zn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= jn;
    }(e) || et(314, String(e.id), String(jn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || $l;
  }
  getPeerNameSet() {
...
const jl = Gt({ config: rn({ setOptions: Jr, updateOptions: Jr }), init: ({ $initialEditorState: t = Vl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [si, Co, ii, li, _o] }), Zr = Symbol.for("@lexical/extension/LexicalBuilder");
function Qr() {
}
function zl(t) {
  throw t;
...
class We {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Bn, this.roots = e;
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && et(298, o.name), !a) {
      a = new Ll(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Fn(i) || et(300, s, a || "[unknown]"), Fn(l = i) || et(304, String(l.id), String(kr)), i = Object.assign(l, { id: ir }), o.state = i;
      const c = this.outgoingConfigEdges.get(s);
      if (c) for (const w of c.keys()) {
        const p = this.extensionNameMap.get(w);
        p && n(p, s);
      }
      i = Pl(i), o.state = i, e.push(o);
    };
...
const Fl = /* @__PURE__ */ new Set(), to = Gt({ build(t, e, n) {
  const o = n.getDependency(sr).output, a = Qe({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ia(() => {
  }, () => we(() => {
    const s = i.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    o.value.read(() => {
      if (Lt()) for (const [p, u] of l.entries()) {
        if (u.size === 0) {
          l.delete(p);
          continue;
        }
        const h = xi(p), m = h && h.isSelected() || !1;
        w = w || m !== (!!s && s.has(p)), m && (c = c || /* @__PURE__ */ new Set(), c.add(p));
      }
    }), !w && c && s && c.size === s.size || (i.value = c);
  }));
  return { watchNodeKey: function(s) {
    const l = Ml(() => (i.value || Fl).has(s)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(s);
    const p = w !== void 0;
...
Gt({ dependencies: [sr, to], name: "@lexical/extension/HorizontalRule", nodes: () => [De], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(to).output, a = Qe({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return le(t.registerCommand(di, (s) => {
    if (pi(s.target)) {
      const l = ui(s.target);
      if (Kl(l)) return function(c, w = !1) {
        const p = Lt(), u = c.isSelected(), h = c.getKey();
        let m;
        w && Do(p) ? m = p : (m = mi(), fi(m)), u ? m.delete(h) : m.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Mo), t.registerMutationListener(De, (s, l) => {
    Dl(() => {
      let c = !1;
      const { nodeSelections: w } = a.peek();
      for (const [p, u] of s.entries()) if (u === "destroyed") w.delete(p), c = !0;
      else {
        const h = w.get(p), m = t.getElementByKey(p);
        h ? h.domNode.value = m : (c = !0, w.set(p, { domNode: Qe(m), selectedSignal: o(p) }));
      }
      c && (a.value = { nodeSelections: w });
    });
  }), we(() => {
    const s = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) s.push(we(() => {
      const w = l.value;
      w && (c.value ? Oo(w, i) : yi(w, i));
    }));
    return le(...s);
  }));
} });
...
function Gl(t, e, n = pa) {
  return le(t.registerCommand(Ni, (o) => {
    const a = Lt();
    if (!ye(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => hn(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), u = Tl(p);
      if (u.canIndent()) {
        const h = u.getKey();
        let m = ki();
        if (m.anchor.set(h, 0, "element"), m.focus.set(h, 0, "element"), m = _i(m), m.anchor.is(w)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Ci : Br : Ei;
    return t.dispatchCommand(i, void 0);
  }, Ro), t.registerCommand(Br, () => {
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ $canIndent: pa, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: i } = n.getOutput();
  return we(() => {
    if (!o.value) return Gl(t, a, i);
  });
} });
const ql = Gt({ name: "@lexical/react/ReactProvider" });
function Ul() {
...
Gt({ build: (t, e, n) => Rn(e), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => we(() => n.getOutput().disabled.value ? void 0 : ma(t)) });
function Xl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const _r = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : q;
  ...
  return function(n, o) {
    ...
    return _r(() => n.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(ps, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
        u !== null && s.push(ji(p, u, w));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function Jl({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(ql.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && Xl(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(Wl, { editor: t, ErrorBoundary: e });
}
function eo(t) {
  return t.getEditorState().read(ua(t.isComposing()));
}
function Zl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Ht();
  return function(a) {
    _r(() => le(Li(a), ma(a)), [a]);
  }(o), d(ct, { children: [t, r(Ql, { content: e }), r(Jl, { editor: o, ErrorBoundary: n })] });
}
function Ql({ content: t }) {
  const [e] = Ht(), n = function(a) {
    ...
    return _r(() => {
      ...
      return l(), le(a.registerUpdateListener(() => {
        l();
...
function tw({ defaultSelection: t }) {
  const [e] = Ht();
  return q(() => {
    e.focus(() => {
...
const ew = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : q;
function nw({ onClear: t }) {
  const [e] = Ht();
  return ew(() => aa(e, t), [e, t]), null;
}
const fa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : q;
function rw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: m, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: _, "data-testid": k, ...z }, L) {
  ...
  return fa(() => ($(t.isEditable()), t.registerEditableListener((V) => {
    $(V);
...
function sw(t, e) {
  ...
  return d(ct, { children: [r(ow, { editor: a, ...o, ref: e }), n != null && r(iw, { editor: a, content: n })] });
}
function iw({ content: t, editor: e }) {
  const n = function(s) {
    ...
    return fa(() => {
      ...
      return w(), le(s.registerUpdateListener(() => {
        w();
...
function ww({
  ...
  return /* @__PURE__ */ r(ha.Provider, { value: s, children: i });
}
function ga() {
  const t = ur(ha);
  if (!t)
...
function cw() {
  const [t, e] = R(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(Qi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ko, { children: [
      /* @__PURE__ */ r(Go, { children: /* @__PURE__ */ r(qo, { children: i }) }),
      s
    ] }) });
  }, [t, n]), a = K(
    (i, s, l = !1) => {
...
function dw({
  ...
  const [e] = Ht(), [n, o] = R(e), [a, i] = R("paragraph"), [s, l] = cw(), c = () => {
  };
...
), uw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  $o.Root,
  {
    ref: a,
    className: f(ba({ variant: e, size: n, className: t })),
    ...o
  }
));
uw.displayName = $o.Root.displayName;
const va = b.createContext({
  size: "default",
  variant: "default"
...
function mw() {
  const { activeEditor: t } = ga(), [e, n] = R([]), o = K((a) => {
    if (ye(a) || zi(a)) {
      const i = [];
      ro.forEach(({ format: s }) => {
  ...
  return pw(o), /* @__PURE__ */ r(
    Cr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: ro.map(({ format: a, icon: i, label: s }) => /* @__PURE__ */ r(
        Je,
        {
          value: a,
          "aria-label": s,
...
function hw({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(dw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(mw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        Zl,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ r(lw, { placeholder: t }) }),
          ErrorBoundary: xl
        }
      ),
      e && /* @__PURE__ */ r(tw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(fw, { onClear: n }),
      /* @__PURE__ */ r(nw, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          ml,
          {
            ...
            children: /* @__PURE__ */ d(Rt, { children: [
              /* @__PURE__ */ r(hw, { placeholder: a, autoFocus: i, onClear: s }),
              /* @__PURE__ */ r(
                hl,
                {
...
function bw(t, e) {
  const n = Mi(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const i of n) if (!ya.has(i.nodeName)) {
    const s = Na(i, t, a, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Ao && s.insertAfter(Po());
    for (const s of i) {
...
function xa(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const i = ae(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && gn(e) && (s = _l(o, e, "clone"));
  const l = ae(s) ? s.getChildren() : [], c = Si(t, s.getType());
  let w;
  ...
  for (let m = 0; m < l.length; m++) {
    const g = l[m], x = xa(t, g, h, o);
    !a && ae(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Di(p) || Kr(p)) && p.append(h), n.append(p), u) {
      const m = u.call(s, p);
      m && (Kr(p) ? p.replaceChildren(m) : p.replaceWith(m));
    }
  } else n.append(h);
  return a;
}
const ya = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Na(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (ya.has(t.nodeName)) return s;
  let l = null;
  ...
  let h = [];
  const m = (l == null || !Oi(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < u.length; g++) h.push(...Na(u[g], e, n, m, new Map(a), l));
  return p != null && (h = p(h)), Gr(t) && (h = xw(t, h, m ? () => {
    const g = new Ao();
    return n.push(g), g;
  } : Cn)), l == null ? h.length > 0 ? s = s.concat(h) : Gr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : qr(g.nextSibling) && qr(g.previousSibling);
  }(t) && (s = s.concat(Po())) : ae(l) && l.append(...h), s;
}
function xw(t, e, n) {
...
function _a(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : _a(e.children)
  ) : !1;
}
function It(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? _a(t.root.children) : !1;
}
function yw(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), i = bw(e, a);
      ie().clear(), Ii(i);
    },
    {
      discrete: !0
...
function dp({
  ...
  const [a, i] = R(Nw), [s, l] = R(void 0), [c, w] = R(!1), p = Y(void 0), u = Y(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(Pt, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Pe, {}) }) }),
        ...
        Ut,
        {
          ...
          children: /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(ee, { children: t.map((y) => /* @__PURE__ */ r(
            qt,
            {
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: Kn(y, o) })
            },
            y || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Tr(y) && (y.preventDefault(), y.stopPropagation(), It(a) && h());
        },
        onKeyDown: (y) => {
...
const pp = Object.freeze([
...
], kw = ["input", "select", "textarea", "button"], _w = ["button", "textbox"], Cw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = Y(null), [i, s] = R(void 0), [l, c] = R(void 0), w = K(
    ...
    if (m.isContentEditable || kw.includes(g)) return !0;
    const x = m.getAttribute("role");
    if (x && _w.includes(x)) return !0;
    const v = m.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = K(
    (m) => {
      var T;
      const g = m.target, x = ($) => $ ? document.getElementById($) : void 0, v = x(l), y = x(i);
      if (!!(v && g && v.contains(g) && g !== v) && u(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (C === -1) return;
          let S;
          m.key === "ArrowDown" ? S = Math.min(C + 1, $.length - 1) : S = Math.max(C - 1, 0), S !== C && (m.preventDefault(), m.stopPropagation(), (T = $[S]) == null || T.focus());
          return;
        }
        return;
      }
      ...
      switch (m.key) {
        case "ArrowDown":
          z = Math.min(k + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          z = Math.max(k - 1, 0), m.preventDefault();
          break;
        case "Home":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", Ew({ variant: e }), t), ...n })
);
...
const Sw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Sw.displayName = "CardDescription";
...
Oe.displayName = Vo.Root.displayName;
...
Ta.displayName = je.Root.displayName;
...
Mw.displayName = je.Image.displayName;
...
Ra.displayName = je.Fallback.displayName;
const Rr = kn(void 0);
function zt() {
  const t = ur(Rr);
  if (!t)
...
}), Fe = ot.Trigger, Sa = ot.Group, Ow = ot.Portal, Iw = ot.Sub, Aw = ot.RadioGroup;
function _e({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Rr.Provider, { value: n, children: /* @__PURE__ */ r(ot.Root, { ...e }) });
}
const Da = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = zt();
  return /* @__PURE__ */ d(
    ot.SubTrigger,
    {
...
Da.displayName = ot.SubTrigger.displayName;
...
Ma.displayName = ot.SubContent.displayName;
const pe = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const i = ft();
...
pe.displayName = ot.Content.displayName;
...
Oa.displayName = ot.RadioItem.displayName;
...
Pw.displayName = "DropdownMenuShortcut";
function oo({
  comment: t,
  isReply: e = !1,
  localizedStrings: n,
  ...
  const m = K(
    ...
    [t.user]
  ), N = F(() => Xs(t.contents), [t.contents]), _ = F(() => {
    if (o && l)
      return /* @__PURE__ */ d(ct, { children: [
        /* @__PURE__ */ d(
          yn,
          {
            onClick: (k) => {
              k.stopPropagation(), w(!0), u(yw(t.contents)), s == null || s(!0);
            },
            children: [
              /* @__PURE__ */ r(gs, { className: "tw-me-2 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ d(
          yn,
          {
            ...
            children: [
              /* @__PURE__ */ r(bs, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ta, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ra, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ d(Me, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              fn(t.assignedUser, n)
            ] })
          ] }),
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), m()) : Tr(k) && (k.preventDefault(), k.stopPropagation(), It(p) && g());
              },
              onKeyDown: (k) => {
                Er(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ d(_e, { children: [
          /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(fo, {}) }) }),
          /* @__PURE__ */ r(pe, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function $w({
  ...
  const [T, $] = R(ao), [C, S] = R(
    void 0
  ), V = o, [j, I] = R(!1), [A, H] = R(!1), [M, W] = R(!1), [Ct, Dt] = R(!1), [Mt, dt] = R(!1), [P, D] = R(k), [G, Z] = R(!1), Q = Y(void 0), [it, xt] = R(/* @__PURE__ */ new Map());
  q(() => {
    let O = !0;
    return (async () => {
  ...
  const yt = F(() => pt[0], [pt]), Ot = Y(null), ht = Y(void 0), gt = K(() => {
    var O;
    (O = ht.current) == null || O.call(ht), $(ao);
  }, []), Yt = K(() => {
    const O = !P;
  ...
  const E = F(
    ...
    () => rt === 1 ? E.singleReply : ge(E.multipleReplies, { count: rt }),
    [rt, E]
  ), ue = F(
    () => Nt === 1 ? E.singleReply : ge(E.multipleReplies, { count: Nt }),
    [Nt, E]
  );
  q(() => {
    !o && A && ut && H(!1);
  ...
  const Ir = K(
    async (O) => {
      ...
      Ft && await u({ threadId: c, contents: Ft }) && gt();
    },
    [
      gt,
      T,
    ...
    async (O) => {
      const Ft = It(T) ? xn(T) : void 0, Et = await u({
        ...O,
        contents: Ft,
        assignedUser: C ?? O.assignedUser
      });
      return Et && Ft && gt(), Et && C !== void 0 && S(void 0), Et;
    },
    [gt, T, u, C]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(Ea, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            X && /* @__PURE__ */ r(Me, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: X }),
            /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                size: "icon",
                onClick: (O) => {
                  O.stopPropagation(), Yt();
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": P ? "Mark as unread" : "Mark as read",
                children: P ? /* @__PURE__ */ r(vs, {}) : /* @__PURE__ */ r(xs, {})
              }
            ),
          ...
          o && /* @__PURE__ */ d(ct, { children: [
            Nt > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Oe, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: ue }),
                    j ? /* @__PURE__ */ r(ho, {}) : /* @__PURE__ */ r($e, {})
                  ] })
                ]
              }
            ),
            ...
            v !== !1 && (!A || It(T)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (O) => {
                  Tr(O) && (O.preventDefault(), O.stopPropagation(), (It(T) || C !== void 0) && Ir());
                },
                onKeyDown: (O) => {
                  Er(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    vn,
...
function mp({
  ...
  const z = n.filter(
    ...
    [y, x]
  ), { listboxRef: C, activeId: S, handleKeyDown: V } = Cw({
    options: L,
    onOptionSelect: T
  }), j = K(
    (I) => {
...
function Lw({ table: t }) {
  return /* @__PURE__ */ d(_e, { children: [
    /* @__PURE__ */ r(Fi, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ys, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ d(pe, { align: "end", className: "tw-w-[150px]", children: [
...
const Ie = lt.Root, Vw = lt.Group, Ae = lt.Value, jw = ce(
  ...
  return /* @__PURE__ */ d(
    lt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(lt.Icon, { asChild: !0, children: /* @__PURE__ */ r($e, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Ne.displayName = lt.Trigger.displayName;
...
Ia.displayName = lt.ScrollUpButton.displayName;
...
Aa.displayName = lt.ScrollDownButton.displayName;
const ke = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const i = ft();
...
ke.displayName = lt.Content.displayName;
...
zw.displayName = lt.Label.displayName;
...
Fw.displayName = lt.Separator.displayName;
function Bw({ table: t }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Ie,
        {
          ...
          children: [
            /* @__PURE__ */ r(Ne, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ae, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(ke, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(Tt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function tn(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Kw(o)
  );
}
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Hw(m, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Uw(l, x, p.key);
...
function Xw({
  ...
  var L;
  const [p, u] = R([]), [h, m] = R([]), [g, x] = R({}), [v, y] = R({}), N = F(() => e ?? [], [e]), _ = jo({
    data: N,
    columns: t,
    getCoreRowModel: Fo(),
  ...
  let z;
  return c ? z = Array.from({ length: 10 }).map((C, S) => `skeleton-row-${S}`).map((C) => /* @__PURE__ */ r(Wt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(xe, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(lr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((L = _.getRowModel().rows) == null ? void 0 : L.length) > 0 ? z = _.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    Wt,
    {
      onClick: () => s(T, _),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map(($) => /* @__PURE__ */ r(xe, { children: Ye($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    T.id
  )) : z = /* @__PURE__ */ r(Wt, { children: /* @__PURE__ */ r(xe, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Lw, { table: _ }),
...
function fp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Ui, { options: i, children: e })
    }
  );
}
...
function Jw({
  ...
  const a = io(n, "%webView_error_dump_header%"), i = io(n, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(go, {}) })
        ] }),
...
function gp({
  ...
  return /* @__PURE__ */ d(ne, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Ut, { id: i, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function bp({ id: t, label: e, groups: n }) {
  const [o, a] = R(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(_e, { children: [
    /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "default", children: [
      /* @__PURE__ */ r(Es, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r($e, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(pe, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(an, { children: w.label }),
      /* @__PURE__ */ r(Sa, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Jt,
        {
          checked: o[p][h],
        ...
        Aw,
        {
          ...
          children: w.items.map((u) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Oa, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ r(Be, {})
    ] }, w.label)) })
...
function xp({
  ...
  const s = F(() => Js(n), [n]), c = ((w) => {
    const p = new Intl.DisplayNames(Zs(), { type: "language" });
    ...
    /* @__PURE__ */ r(de, { asChild: !0, children: /* @__PURE__ */ d(
      B,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bo, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Ut, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
        ...
        /* @__PURE__ */ r(Qt, { children: z.map((S) => /* @__PURE__ */ d(
          qt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(Ds, { className: "tw-h-4 tw-w-4" }),
...
function ec({ children: t, editorRef: e }) {
  const n = Y(null);
  return q(() => {
    var s;
...
const nc = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(ct, { children: [
...
function rc({
  ...
  const i = Y(null), s = Y(null), l = Y(!1), [c, w] = R(t), [p, u] = R(n), [h, m] = R(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    l.current = !1, m(v), v || (c !== "custom" || p ? (e(c), o(p)) : (w(t), u(n)));
  }, x = (v) => {
    var y, N, _, k;
  ...
  return /* @__PURE__ */ d(_e, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Pt, { asChild: !0, children: /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: nc(t, a, n) }) }) }),
...
const oc = (t, e) => t === "f" ? /* @__PURE__ */ d(ct, { children: [
  /* @__PURE__ */ r(xo, {}),
  " ",
...
function sc({
  ...
  return /* @__PURE__ */ d(_e, { children: [
    /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ai, { asChild: !0, children: /* @__PURE__ */ r(Fe, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: oc(t, n) }) }) }),
      /* @__PURE__ */ r(St, { children: /* @__PURE__ */ r("p", { children: ac(t, n) }) })
    ] }) }),
    /* @__PURE__ */ d(pe, { className: "tw-z-[300]", children: [
...
function lc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Ms, { className: e, size: 16 });
}
function wc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = R(""), i = F(() => {
      ...
      /* @__PURE__ */ r(Qt, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ d(
          qt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(lc, { icon: s.icon }) }) }),
              /* @__PURE__ */ d("div", { children: [
              ...
              (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Ho, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
function Np({
  ...
  const w = Y(null), p = Y(null), u = Y(null), [h, m] = R("generated"), [g, x] = R("*"), [v, y] = R("f"), [N, _] = R(!1), [k, z] = R(!1), [L, T] = R(), [$, C] = R(), [S, V] = R(), [j, I] = R(), A = Y(null), H = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...s.view ?? Hi(), noteMode: "expanded" }
    }),
    [s, l]
  ), M = F(
    () => cc(
  ...
  q(() => {
    ...
    if (D && wn("note", D)) {
      ...
      let it = "custom";
      Q === Zn ? it = "generated" : Q === Qn ? it = "hidden" : Q && x(Q), m(it), y(((Z = D.insert.note) == null ? void 0 : Z.style) ?? "f"), P = setTimeout(() => {
        var xt;
  ...
  const W = K(() => {
    var D, G;
    const P = (G = (D = w.current) == null ? void 0 : D.getNoteOps(0)) == null ? void 0 : G.at(0);
    P && wn("note", P) && (P.insert.note && (h === "custom" ? P.insert.note.caller = g : P.insert.note.caller = h === "generated" ? Zn : Qn), n([P]));
  }, [h, g, n]), Ct = () => {
    var D;
    ...
    if (D && wn("note", D)) {
      ...
      v !== "x" && P === "x" ? pt == null || pt.forEach((yt) => dc(yt)) : v === "x" && P !== "x" && (pt == null || pt.forEach((yt) => pc(yt))), (xt = w.current) == null || xt.applyUpdate([D, { delete: 1 }]);
    }
  }, Mt = (P) => {
    var G, Z, Q, it, xt, pt;
    ...
    if (u.current && M.length && P && P.rangeCount > 0) {
      const D = P.getRangeAt(0).getBoundingClientRect(), G = u.current.getBoundingClientRect();
  ...
  return q(() => {
    ...
    var G;
    const P = ((G = p.current) == null ? void 0 : G.querySelector(".editor-input")) ?? void 0, D = (Z) => {
    ...
    /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ d(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(ec, { editorRef: w, children: /* @__PURE__ */ r(
              Yi,
              {
                options: H,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ d(At, { children: [
              /* @__PURE__ */ r(Pt, { asChild: !0, children: /* @__PURE__ */ r(
                B,
                {
                  onClick: Ct,
  ...
  return /* @__PURE__ */ d(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: mc(t.marker, l, o, w) })
      }
    )
  ] });
}
function _p({
  ...
  const p = c ?? Qs(n, void 0), u = (N, _) => {
    w == null || w(N, _, a);
  }, h = i ? n.findIndex((N) => N === i) : -1, [m, g] = R(h), x = (N, _, k) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function bc({
  ...
  return /* @__PURE__ */ d(Sn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Dn, { stickyHeader: !0, children: /* @__PURE__ */ d(Wt, { children: [
    ...
    /* @__PURE__ */ r(Mn, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ d(
      Wt,
      {
        ...
        children: [
          /* @__PURE__ */ r(xe, { children: be(l.reference, "English") }),
          /* @__PURE__ */ r(xe, { className: o, children: gc(l.text) })
        ]
      },
...
const vc = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r($s, { className: "tw-h-4 tw-w-4" });
  ...
  return e ? e[1] : "";
}, yc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Mp = Object.freeze([
...
function Op({
  ...
  const m = Bt(n, "%webView_inventory_all%"), g = Bt(n, "%webView_inventory_approved%"), x = Bt(n, "%webView_inventory_unapproved%"), v = Bt(n, "%webView_inventory_unknown%"), y = Bt(n, "%webView_inventory_scope_currentBook%"), N = Bt(n, "%webView_inventory_scope_chapter%"), _ = Bt(n, "%webView_inventory_scope_verse%"), k = Bt(n, "%webView_inventory_filter_text%"), z = Bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Bt(n, "%webView_inventory_no_results%"), [T, $] = R(!1), [C, S] = R("all"), [V, j] = R(""), [I, A] = R([]), H = F(() => {
    const D = t ?? [];
    return D.length === 0 ? [] : kc(D, a, i);
  }, [t, a, i]), M = F(() => {
    if (T) return H;
    const D = [];
    return H.forEach((G) => {
      const Z = G.items[0], Q = D.find(
        (it) => it.items[0] === Z
      );
      Q ? (Q.count += G.count, Q.occurrences = Q.occurrences.concat(G.occurrences)) : D.push({
        items: [Z],
        count: G.count,
  ...
  }, [T, H]), W = F(() => M.length === 0 ? [] : Nc(M, C, V), [M, C, V]), Ct = F(() => {
    var Z, Q;
    if (!T) return c;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Ie,
        {
          ...
          defaultValue: C,
          children: [
            /* @__PURE__ */ r(Ne, { className: "tw-m-1", children: /* @__PURE__ */ r(Ae, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(Ie, { onValueChange: (D) => Mt(D), defaultValue: s, children: [
        /* @__PURE__ */ r(Ne, { className: "tw-m-1", children: /* @__PURE__ */ r(Ae, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ke, { children: [
...
const _c = "16rem", Cc = "3rem", $a = b.createContext(void 0);
function In() {
  const t = b.useContext($a);
  if (!t)
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), u = e ?? w, h = b.useCallback(
      ...
      [n, u]
    ), m = b.useCallback(() => h((_) => !_), [h]), g = u ? "expanded" : "collapsed", y = ft() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
    ...
    return /* @__PURE__ */ r($a.Provider, { value: N, children: /* @__PURE__ */ r(Rt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Va = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = In();
...
Va.displayName = "Sidebar";
const Ec = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = In();
  return /* @__PURE__ */ d(
    B,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Ls, {}) : /* @__PURE__ */ r(Vs, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Ec.displayName = "SidebarTrigger";
...
Mc.displayName = "SidebarSeparator";
...
const Oc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Le : "button",
  {
    ref: o,
...
Oc.displayName = "SidebarGroupAction";
...
Ba.displayName = "SidebarMenuItem";
const Ic = ce(
  ...
  ({
    ...
    const c = t ? Le : "button", { state: w } = In(), p = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(Ic({ variant: n, size: o }), i),
        ...s
      }
    );
...
Ka.displayName = "SidebarMenuButton";
const Ac = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Le : "button",
  {
    ref: a,
...
Ac.displayName = "SidebarMenuAction";
...
Pc.displayName = "SidebarMenuBadge";
const $c = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
$c.displayName = "SidebarMenuSkeleton";
...
Lc.displayName = "SidebarMenuSub";
const Vc = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Vc.displayName = "SidebarMenuSubItem";
const jc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Le : "a",
  {
    ref: i,
    ...
    Va,
    {
      ...
      children: /* @__PURE__ */ d(za, { children: [
        /* @__PURE__ */ d(wr, { children: [
          ...
          /* @__PURE__ */ r(dr, { children: /* @__PURE__ */ r(Fa, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Ba, { children: /* @__PURE__ */ r(
            Ka,
            {
              onClick: () => w(h),
              isActive: u(h),
    ...
    /* @__PURE__ */ d(
      La,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ja, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const oe = "scrBook", Fc = "scrRef", he = "source", Bc = "details", Kc = "Scripture Reference", Gc = "Scripture Book", Ga = "Type", qc = "Details";
function Uc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: oe,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Kc,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? wt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === oe ? be(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: he,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Ga : void 0,
    ...
    },
    {
      ...
      id: Bc,
      header: (t == null ? void 0 : t.detailsColumnName) ?? qc,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, lo = (t) => `${Hc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ap({
  sources: t,
  ...
  const [w, p] = R([]), [u, h] = R([{ id: oe, desc: !1 }]), [m, g] = R({}), x = F(
  ...
  q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const V = x.find((j) => lo(j) === S[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, y]);
  const N = a ?? Gc, _ = i ?? Ga, k = [
  ...
  }, T = (C, S) => C.getIsGrouped() ? "" : f("banded-row", S % 2 === 0 ? "even" : "odd"), $ = (C, S, V) => {
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      Ie,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ne, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ae, {}) }),
          /* @__PURE__ */ r(ke, { position: "item-aligned", children: /* @__PURE__ */ r(Vw, { children: k.map((C) => /* @__PURE__ */ r(Tt, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Dn, { children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(Wt, { children: C.headers.filter((S) => S.column.columnDef.header).map((S) => (
        ...
        return /* @__PURE__ */ r(
          Wt,
          {
            ...
            children: C.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== he || !n)))
                return /* @__PURE__ */ r(
                  xe,
                  {
                    className: f(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ d(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Re, {}) : /* @__PURE__ */ r(Yn, {})),
                          " ",
...
}), qa = (t, e, n) => Or(t, e).every((o) => n.includes(o));
function Yc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Or(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    B,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        qa(e, t, n) && !i && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: i,
      children: nl(
        t,
...
function Xc({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: h, ntLong: m, dcLong: g, extraLong: x } = {
  ...
  const L = F(() => wt.allBookIds.filter(
    ...
    (A) => {
      const H = Or(L, A).map((M) => M);
      n(
        qa(L, A, e) ? e.filter((M) => !H.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, L]
  ), j = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
                  ...
                  Object.values(U).map((A, H) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(co, { children: [
                        ...
                        H < Object.values(U).length - 1 && /* @__PURE__ */ r(Uo, {})
                      ] }, A);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === qn ? qn : wo
      ).map((A) => /* @__PURE__ */ r(Me, { className: "hover:tw-bg-secondary", variant: "secondary", children: Te(A, a) }, A)),
      e.length > qn && /* @__PURE__ */ r(
        Me,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - wo} ${u}`
        }
      )
    ] })
  ] });
...
function $p({
  ...
  const w = me(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = me(s, "%webView_scope_selector_current_book%"), m = me(s, "%webView_scope_selector_choose_books%"), g = me(s, "%webView_scope_selector_scope%"), x = me(s, "%webView_scope_selector_select_books%"), v = [
...
function Lp({
  ...
  return /* @__PURE__ */ d(
    Ie,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ne, { size: a, className: f("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Ae,
          {
        ...
        /* @__PURE__ */ r(
          ke,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(Tt, { value: `${w}`, children: l[tt(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ha = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ d(Iw, { children: [
    /* @__PURE__ */ r(Da, { children: l.label }),
    /* @__PURE__ */ r(Ow, { children: /* @__PURE__ */ r(Ma, { children: Ha(
      t,
      e,
      Ua(t, l.id),
      o
...
function pr({
  ...
  return /* @__PURE__ */ d(_e, { variant: i, children: [
    /* @__PURE__ */ r(Fe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(zs, {}) }) }),
    /* @__PURE__ */ r(pe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(co, { children: [
      /* @__PURE__ */ r(Sa, { children: /* @__PURE__ */ r(Rt, { children: Ha(e.groups, e.items, c, t) }) }),
...
function Fp({
  ...
  return /* @__PURE__ */ d(Ya, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      pr,
      {
        onSelectMenuItem: t,
...
function Bp({
  ...
  return /* @__PURE__ */ r(Ya, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    pr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Xa = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    _t.Root,
    {
...
Xa.displayName = _t.List.displayName;
...
Wa.displayName = _t.List.displayName;
...
Ja.displayName = _t.Content.displayName;
function Kp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Xa, { children: [
      /* @__PURE__ */ r(Wa, { children: t.map((l) => /* @__PURE__ */ r(Wc, { value: l.value, children: l.value }, l.key)) }),
...
Za.displayName = at.Root.displayName;
...
const ts = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = zt();
  return /* @__PURE__ */ d(
    at.SubTrigger,
    {
...
ts.displayName = at.SubTrigger.displayName;
...
es.displayName = at.SubContent.displayName;
const ns = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = zt();
...
ns.displayName = at.Content.displayName;
const rs = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ r(
    at.Item,
    {
...
const Qc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = zt();
  return /* @__PURE__ */ d(
    at.CheckboxItem,
    {
...
Qc.displayName = at.CheckboxItem.displayName;
const td = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ d(
    at.RadioItem,
    {
...
td.displayName = at.RadioItem.displayName;
...
os.displayName = at.Separator.displayName;
const qe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((w) => w.group === i).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(At, { children: [
      ...
      ) : /* @__PURE__ */ d(Zc, { children: [
        /* @__PURE__ */ r(ts, { children: w.label }),
        /* @__PURE__ */ r(es, { children: as(
          t,
          e,
          Ua(t, w.id),
          o
    ...
    return l.length > 0 && s < a.length - 1 && c.push(/* @__PURE__ */ r(os, {}, `separator-${i}`)), c;
  });
};
function nd({
  menuData: t,
  ...
  if (Xi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    var g, x, v, y;
    p.preventDefault();
    ...
    switch (u.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), qe(i, [h, m]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), qe(s, [h, m]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), qe(l, [h, m]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), qe(c, [h, m]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ r(Za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(Jc, { children: [
      /* @__PURE__ */ r(Qa, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        ns,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Rt, { children: as(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
  ...
  return /* @__PURE__ */ d("div", { id: c, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      Ie,
      {
        ...
        onOpenChange: (g) => u(g),
        children: [
          /* @__PURE__ */ r(Ne, { children: /* @__PURE__ */ r(Ae, {}) }),
          /* @__PURE__ */ r(
            ke,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(mt, { className: "tw-font-normal tw-text-muted-foreground", children: ge(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => m(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function od({ item: t, createLabel: e, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(_e, { children: [
              /* @__PURE__ */ r(Fe, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(fo, {}) }) }),
              /* @__PURE__ */ r(pe, { align: "end", children: l })
            ] })
          ] }),
...
const ad = nn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ks, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), id = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const wd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
wd.displayName = "AlertDescription";
const Wp = st.Root, Jp = st.Trigger, Zp = st.Group, Qp = st.Portal, tu = st.Sub, eu = st.RadioGroup, cd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  st.SubTrigger,
  {
    ref: a,
    className: f(
...
dd.displayName = st.SubContent.displayName;
const pd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(st.Portal, { children: /* @__PURE__ */ r(
  st.Content,
  {
    ref: n,
    className: f(
...
pd.displayName = st.Content.displayName;
const ud = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Item,
  {
    ref: o,
    className: f(
...
ud.displayName = st.Item.displayName;
const md = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  st.CheckboxItem,
  {
    ref: a,
    className: f(
...
const fd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  st.RadioItem,
  {
    ref: o,
    className: f(
...
fd.displayName = st.RadioItem.displayName;
...
hd.displayName = st.Label.displayName;
...
gd.displayName = st.Separator.displayName;
...
bd.displayName = "ContextMenuShortcut";
...
const nu = jt.Trigger, xd = jt.Portal, ru = jt.Close, is = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Overlay,
  {
    ref: n,
...
is.displayName = jt.Overlay.displayName;
const yd = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: i = "bottom" } = b.useContext(ss), s = {
...
_d.displayName = jt.Title.displayName;
...
Cd.displayName = jt.Description.displayName;
const Ed = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  er.Root,
  {
    ref: o,
    className: f(
...
Ed.displayName = er.Root.displayName;
function ou({
  className: t,
  ...e
}) {
...
function su({
  ...
  return /* @__PURE__ */ r(
    hr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Gs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function iu({ ...t }) {
...
const Td = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ d(
    Ue.Root,
    {
...
Td.displayName = Ue.Root.displayName;
...
Rd.displayName = nr.Root.displayName;
const lu = _t.Root, Sd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ft();
  return /* @__PURE__ */ r(
    _t.List,
    {
...
Sd.displayName = _t.List.displayName;
const Dd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  _t.Trigger,
  {
    ref: n,
...
Dd.displayName = _t.Trigger.displayName;
...
Md.displayName = _t.Content.displayName;
...
export {
  ...
  pd as ContextMenuContent,
  Zp as ContextMenuGroup,
  ud as ContextMenuItem,
  hd as ContextMenuLabel,
  Qp as ContextMenuPortal,
  eu as ContextMenuRadioGroup,
  fd as ContextMenuRadioItem,
  gd as ContextMenuSeparator,
  bd as ContextMenuShortcut,
  tu as ContextMenuSub,
  ...
  su as ResizableHandle,
  au as ResizablePanel,
  ou as ResizablePanelGroup,
  Yp as ResultsCard,
