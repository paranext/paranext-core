...
import T, { forwardRef as ur, useCallback as Tt, useState as it, useRef as ye, useEffect as Jt, useLayoutEffect as pa, useMemo as Nt } from "react";
import { History as ll, ChevronRight as di, Check as Rn, Circle as pi, ArrowDownWideNarrow as cl, Clock as dl, Bookmark as pl, X as ui, Search as ho, ChevronsUpDown as nr, FilterIcon as ul, ChevronDown as Ue, ChevronUp as Jr, ArrowLeftIcon as wl, ChevronLeftIcon as fl, ChevronRightIcon as ml, ArrowRightIcon as hl, CircleCheckIcon as gl, CircleXIcon as bl, CircleHelpIcon as vl, ArrowUpIcon as yl, ArrowDownIcon as xl, ArrowUpDownIcon as Nl, Star as kl, PanelLeft as El, PanelRight as Tl, ChevronLeft as Sl, LoaderCircle as Cl, Download as Ol, Filter as Rl, User as _l, Link as Pl, CircleHelp as $l, BookOpen as ua, Loader as Il, Ellipsis as Al } from "lucide-react";
...
import { getChaptersForBook as jl, deepEqual as go, substring as Vl, formatScrRef as Mr, compareScrRefs as Zr, scrRefToBBBCCCVVV as Dr, getLocalizeKeyForScrollGroupId as ut, NumberFormat as zl, formatBytes as Ll, getErrorMessage as Fl } from "platform-bible-utils";
  ...
  return Jt(() => {
    ...
    /* @__PURE__ */ i(rr, { asChild: !0, children: /* @__PURE__ */ i(
      lc,
      {
        ...
        handleKeyDown: I,
        handleOnClick: () => {
          s(st.bookNumberToId(t.bookNum)), p(st.bookNumberToId(t.bookNum)), c(t.chapterNum > 0 ? t.chapterNum : 0), w(!0), m.current.focus();
        },
        onFocus: () => {
          E.current = !0;
        },
...
const eo = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Nn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(Nn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ i(pi, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
    ...
    /* @__PURE__ */ i(
      xo,
      {
        ...
        children: /* @__PURE__ */ y(No, { children: [
          /* @__PURE__ */ i(ko, { placeholder: p, className: "tw-text-inherit" }),
...
function vh({
  ...
  const p = Br(d, "%webView_bookSelector_currentBook%"), f = Br(d, "%webView_bookSelector_choose%"), w = Br(d, "%webView_bookSelector_chooseBooks%"), [g, b] = it(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    b(h), t(h);
      ...
      children: /* @__PURE__ */ y("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ y("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(St, { className: "tw-ms-1", children: p })
          ] }),
...
function Zc({
  ...
  var h;
  const [l, c] = it([]), [d, p] = it([]), [f, w] = it({}), [g, b] = it({}), m = fi({
    data: e,
    columns: t,
    getCoreRowModel: mi(),
...
const mr = (t) => t === "asc" ? /* @__PURE__ */ i(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), yh = (t) => ({
  ...
  return td(t).forEach((p) => {
    p.startsWith("\\id") && (s = ed(p), l = 0, c = 0), p.startsWith("\\c") && (l = ha(p), c = 0), p.startsWith("\\v") && (c = ha(p), l === 0 && (l = e.chapterNum));
...
function Th({
  ...
  return /* @__PURE__ */ y(_i, { open: d, onOpenChange: p, children: [
    /* @__PURE__ */ i(Pi, { asChild: !0, children: /* @__PURE__ */ y(
      wt,
      {
        variant: "outline",
...
const pd = "16rem", ud = "3rem", Gi = T.createContext(void 0);
function hr() {
...
const Xi = T.forwardRef(
  ({
    ...
    const [d, p] = T.useState(t), f = e ?? d, w = T.useCallback(
      (C) => {
...
const yd = tn(
  ...
  ({
    ...
    const c = t ? Qe : "button", { state: d } = hr(), p = /* @__PURE__ */ i(
      c,
      {
        ref: l,
...
function Oh({
  ...
  const [c, d] = it([]), [p, f] = it([{ id: le, desc: !1 }]), [w, g] = it({}), b = Nt(
      ...
      children: [
        ...
        /* @__PURE__ */ i(
          Te,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((s) => /* @__PURE__ */ i(Vt, { value: `${s}`, children: o[ut(s)] }, `${s}`))
          }
        )
      ]
    }
...
function jd() {
  ...
  return lt.AsyncMode = c, lt.ConcurrentMode = d, lt.ContextConsumer = l, lt.ContextProvider = s, lt.Element = e, lt.ForwardRef = p, lt.Fragment = r, lt.Lazy = b, lt.Memo = g, lt.Portal = n, lt.Profiler = a, lt.StrictMode = o, lt.Suspense = f, lt.isAsyncMode = function(v) {
    return E(v) || C(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === f || v === w || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === g || v.$$typeof === s || v.$$typeof === l || v.$$typeof === p || v.$$typeof === h || v.$$typeof === k || v.$$typeof === P || v.$$typeof === m);
  }, lt.typeOf = C, lt;
}
var ct = {};
/** @license React v16.13.1
...
function Vd() {
  return ya || (ya = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(S) {
      ...
      S === r || S === d || S === a || S === o || S === f || S === w || typeof S == "object" && S !== null && (S.$$typeof === b || S.$$typeof === g || S.$$typeof === s || S.$$typeof === l || S.$$typeof === p || S.$$typeof === h || S.$$typeof === k || S.$$typeof === P || S.$$typeof === m);
    }
    function E(S) {
    ...
    var v = c, $ = d, X = l, _ = s, I = e, U = p, B = r, M = b, D = g, K = n, H = a, z = o, tt = f, rt = !1;
    function ot(S) {
...
const os = _o(u.element, rs);
os.isRequired = _o(u.element.isRequired, rs);
...
function Kd() {
  ...
  return dt.ContextConsumer = s, dt.ContextProvider = a, dt.Element = t, dt.ForwardRef = c, dt.Fragment = n, dt.Lazy = w, dt.Memo = f, dt.Portal = e, dt.Profiler = o, dt.StrictMode = r, dt.Suspense = d, dt.SuspenseList = p, dt.isAsyncMode = function() {
    return !1;
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === d || h === p || h === g || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === f || h.$$typeof === a || h.$$typeof === s || h.$$typeof === c || h.$$typeof === b || h.getModuleId !== void 0);
  }, dt.typeOf = m, dt;
}
var pt = {};
/**
...
function Jd() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), b = !1, m = !1, h = !1, k = !1, P = !1, C;
    C = Symbol.for("react.module.reference");
    function E(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || P || V === r || V === d || V === p || k || V === g || b || m || h || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === f || V.$$typeof === a || V.$$typeof === s || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var $ = s, X = a, _ = t, I = c, U = n, B = w, M = f, D = e, K = o, H = r, z = d, tt = p, rt = !1, ot = !1;
    function x(V) {
    ...
    pt.ContextConsumer = $, pt.ContextProvider = X, pt.Element = _, pt.ForwardRef = I, pt.Fragment = U, pt.Lazy = B, pt.Memo = M, pt.Portal = D, pt.Profiler = K, pt.StrictMode = H, pt.Suspense = z, pt.SuspenseList = tt, pt.isAsyncMode = x, pt.isConcurrentMode = R, pt.isContextConsumer = W, pt.isContextProvider = Y, pt.isElement = G, pt.isForwardRef = J, pt.isFragment = L, pt.isLazy = Z, pt.isMemo = q, pt.isPortal = Q, pt.isProfiler = O, pt.isStrictMode = F, pt.isSuspense = S, pt.isSuspenseList = ft, pt.isValidElementType = E, pt.typeOf = v;
  }()), pt;
}
...
const ep = u.oneOfType([u.func, u.object]), ss = ep;
function Qt(t) {
  if (typeof t != "string")
...
const lp = typeof window < "u" ? j.useLayoutEffect : j.useEffect, We = lp;
let $a = 0;
function cp(t) {
...
function vp(t) {
  t.addEventListener("keydown", gp, !0), t.addEventListener("mousedown", Yr, !0), t.addEventListener("pointerdown", Yr, !0), t.addEventListener("touchstart", Yr, !0), t.addEventListener("visibilitychange", bp, !0);
}
function yp(t) {
  const {
    target: e
...
function ds() {
  ...
  function n() {
    return e.current ? (lo = !0, fp.start(100, () => {
      lo = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
    return yp(o) ? (e.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: e,
    onFocus: r,
...
function kp(t, e = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
const Ep = ["values", "unit", "step"], Tp = (t) => {
...
function Sp(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = Et(t, Ep), a = Tp(e), s = Object.keys(a);
  function l(w) {
...
const Cp = {
  borderRadius: 4
}, Op = Cp, Rp = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, de = Rp;
function vn(t, e) {
  return e ? re(t, e, {
    clone: !1
...
const Ip = {
  ...
  if (t.length > 2)
    if (Ba[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = Ip[e], o = Ap[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), yr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], xr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Dp = [...yr, ...xr];
function Bn(t, e, n, r) {
  var o;
...
function jp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = Mp(n), a = Bp(o, r), s = t[n];
  return oe(t, s, a);
}
function hs(t, e) {
  const n = ms(t.theme);
  return Object.keys(t).map((r) => jp(t, e, r, n)).reduce(vn, {});
}
function gt(t) {
  return hs(t, yr);
}
...
bt.filterProps = xr;
process.env.NODE_ENV !== "production" && Dp.reduce((t, e) => (t[e] = de, t), {});
function Vp(t = 8) {
  if (t.mui)
    return t;
  const e = ms({
...
const zp = Xt("border", Lt), Lp = Xt("borderTop", Lt), Fp = Xt("borderRight", Lt), Up = Xt("borderBottom", Lt), Gp = Xt("borderLeft", Lt), Xp = Xt("borderColor"), Hp = Xt("borderTopColor"), Yp = Xt("borderRightColor"), Wp = Xt("borderBottomColor"), qp = Xt("borderLeftColor"), Kp = Xt("outline", Lt), Jp = Xt("outlineColor"), kr = (t) => {
...
Nr(zp, Lp, Fp, Up, Gp, Xp, Hp, Yp, Wp, qp, kr, Kp, Jp);
const Er = (t) => {
...
Nr(Er, Tr, Sr, Zp, Qp, tu, eu, nu, ru, ou, au, iu);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const su = yt({
...
function vu() {
  function t(n, r, o, a) {
    ...
    return f ? f(s) : oe(s, r, (b) => {
      let m = lr(w, p, b);
      return b === m && typeof b == "string" && (m = lr(w, p, `${n}${b === "default" ? "" : Qt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = _p(a.breakpoints), f = Object.keys(p);
      let w = p;
...
function Bo(t = {}, ...e) {
  ...
  return d.applyStyles = yu, d = e.reduce((p, f) => re(p, f), d), d.unstable_sxConfig = A({}, Mo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(f) {
    return Do({
      sx: f,
      theme: this
    });
...
const Eu = ["ownerState"], Tu = ["variants"], Su = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Cu(t) {
  return Object.keys(t).length === 0;
}
function Ou(t) {
...
const Ru = Bo(), ja = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Wn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function Pu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = _u(ja(d))
    } = l, g = Et(l, Su), b = p !== void 0 ? p : (
    ...
    const P = Yl(s, A({
      ...
      if (process.env.NODE_ENV !== "production") {
        let B;
        c && (B = `${c}${Qt(d || "")}`), B === void 0 && (B = `Styled(${tp(s)})`), U.displayName = B;
      }
...
function jo(t, e = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (t < e || t > n) && console.error(`MUI: The value provided ${t} is out of range [${e}, ${n}].`), kp(t, e, n);
}
function Au(t) {
  t = t.slice(1);
...
function Va(t) {
  t = Ce(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Ce(Mu(t)).values : t.values;
...
const Vu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ve = Yu, Wu = ["mode", "contrastThreshold", "tonalOffset"], La = {
...
function Fa(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = Bu(t.main, o) : e === "dark" && (t.dark = Du(t.main, a)));
}
function qu(t = "light") {
  return t === "dark" ? {
    main: Be[200],
...
function ew(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = Et(t, Wu), a = t.primary || qu(e), s = t.secondary || Ku(e), l = t.error || Ju(e), c = t.info || Zu(e), d = t.success || Qu(e), p = t.warning || tw(e);
  function f(m) {
...
function fw(t) {
  const e = A({}, pw, t.easing), n = A({}, uw, t.duration);
  return A({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof s == "string" ? s : Xa(s)} ${l} ${typeof c == "string" ? c : Xa(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
const yw = (t) => Qn(t) && t !== "classes", xw = Pu({
  themeId: zo,
  defaultTheme: Vo,
...
function Vw(t) {
  ...
  const s = Bw(A({}, o, r)), l = Wa(r), c = Wa(o), d = e(s), p = xe(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = A({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = A({}, d, n, c, l);
...
var Rt = "top", Ut = "bottom", Gt = "right", _t = "left", Uo = "auto", zn = [Rt, Ut, Gt, _t], qe = "start", Cn = "end", Hw = "clippingParents", Ts = "viewport", pn = "popper", Yw = "reference", qa = /* @__PURE__ */ zn.reduce(function(t, e) {
...
function Je(t, e, n) {
  ...
  var s = Oe(t) ? Bt(t) : window, l = s.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function uf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Kt(n.placement), c = Ho(l), d = [_t, Gt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !s)) {
    var f = pf(o.padding, n), w = Xo(a), g = c === "y" ? Rt : _t, b = c === "y" ? Ut : Gt, m = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], k = Ln(a), P = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], v = P - w[p] - f[b], $ = P / 2 - w[p] / 2 + C, X = yn(E, $, v), _ = c;
...
function Ja(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, s = t.offsets, l = t.position, c = t.gpuAcceleration, d = t.adaptive, p = t.roundOffsets, f = t.isFixed, w = s.x, g = w === void 0 ? 0 : w, b = s.y, m = b === void 0 ? 0 : b, h = typeof p == "function" ? p({
    x: g,
    y: m
  }) : {
    x: g,
  ...
  if (d) {
    ...
    if ($ === Bt(n) && ($ = pe(n), ae($).position !== "static" && l === "absolute" && (X = "scrollHeight", _ = "scrollWidth")), $ = $, o === Rt || (o === _t || o === Gt) && a === Cn) {
      E = Ut;
...
function Wo(t) {
  return Je(pe(t)).left + Yo(t).scrollLeft;
}
function kf(t, e) {
  var n = Bt(t), r = pe(t), o = n.visualViewport, a = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function Ef(t) {
  var e, n = pe(t), r = Yo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = Ne(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = Ne(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Wo(t), c = -r.scrollTop;
...
function Qa(t, e, n) {
  return e === Ts ? po(kf(t, n)) : Oe(e) ? Tf(e, n) : po(Ef(pe(t)));
}
function Sf(t) {
...
function Cf(t, e, n, r) {
  var o = e === "clippingParents" ? Sf(t) : [].concat(e), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var p = Qa(t, d, r);
    return c.top = Ne(p.top, c.top), c.right = dr(p.right, c.right), c.bottom = dr(p.bottom, c.bottom), c.left = Ne(p.left, c.left), c;
  }, Qa(t, s, r));
...
function On(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Hw : l, d = n.rootBoundary, p = d === void 0 ? Ts : d, f = n.elementContext, w = f === void 0 ? pn : f, g = n.altBoundary, b = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = _s(typeof h != "number" ? h : Ps(h, zn)), P = w === pn ? Yw : pn, C = t.rects.popper, E = t.elements[b ? P : w], v = Cf(Oe(E) ? E : E.contextElement || pe(t.elements.popper), c, p, s), $ = Je(t.elements.reference), X = Is({
    reference: $,
    element: C,
    strategy: "absolute",
    placement: o
...
function Of(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ss : c, p = Ze(r), f = p ? l ? qa : qa.filter(function(b) {
    return Ze(b) === p;
...
function _f(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, b = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Kt(h), P = k === h, C = c || (P || !b ? [er(h)] : Rf(h)), E = [h].concat(C).reduce(function(G, J) {
...
function $f(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = On(e, {
    ...
    altBoundary: !0
  }), c = ti(s, r), d = ti(l, o, a), p = ei(c), f = ei(d);
  e.modifiersData[n] = {
...
function Mf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = Ss.reduce(function(p, f) {
    return p[f] = Af(f, e.rects, a), p;
...
function zf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, h = On(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: p
  ...
  if ($) {
    ...
    if (l) {
      var ue, Ct = E === "x" ? Rt : _t, Fn = E === "x" ? Ut : Gt, Yt = $[v], Pe = v === "y" ? "height" : "width", we = Yt + h[Ct], $e = Yt - h[Fn], Ie = [Rt, _t].indexOf(k) !== -1, Ae = (ue = B == null ? void 0 : B[v]) != null ? ue : 0, fe = Ie ? we : Yt - X[Pe] - _[Pe] - Ae + U.altAxis, nn = Ie ? Yt + X[Pe] + _[Pe] - Ae - U.altAxis : $e, Un = g && Ie ? df(fe, Yt, nn) : yn(g ? fe : we, Yt, g ? nn : $e);
      $[v] = Un, M[v] = Un - Yt;
    }
    e.modifiersData[r] = M;
  }
...
function Xf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && Gf(e), a = pe(e), s = Je(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = Yf(qf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          var k = p.elements, P = k.reference, C = k.popper;
          if (ri(P, C)) {
            p.rects = {
              reference: Xf(P, Ln(C), p.options.strategy === "fixed"),
              popper: Xo(C)
            }, p.reset = !1, p.placement = p.options.placement, p.orderedModifiers.forEach(function(U) {
              return p.modifiersData[U.name] = Object.assign({}, U.data);
            });
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var v = p.orderedModifiers[E], $ = v.fn, X = v.options, _ = X === void 0 ? {} : X, I = v.name;
              typeof $ == "function" && (p = $({
                state: p,
                options: _,
                name: I,
...
const om = () => $o({
  ...
  const $ = nm(p, s), [X, _] = j.useState($), [I, U] = j.useState(pr(o));
  j.useEffect(() => {
...
`));
  ...
  const _ = !p && c && (!m || C) ? "none" : void 0, I = m ? {
    in: p,
    onEnter: v,
    onExited: $
  } : void 0;
...
process.env.NODE_ENV !== "production" && (Ms.propTypes = {
   ...
   */
  anchorEl: _o(u.oneOfType([Tn, u.object, u.func]), (t) => {
    if (t.open) {
...
var lm = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const wm = {
  ...
  } = e, k = Et(e, um), P = fn(), C = j.useRef(), E = Ds(), v = j.useRef(null), $ = Se(v, a.ref, n), X = (H) => (z) => {
    if (H) {
      const tt = v.current;
...
const zs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, p, f, w, g, b, m, h, k, P, C, E, v;
  const $ = Lo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    children: _
  }), Ht = Ds(), ue = Ht.direction === "rtl", [Ct, Fn] = j.useState(), [Yt, Pe] = j.useState(null), we = j.useRef(!1), $e = K || ot, Ie = fn(), Ae = fn(), fe = fn(), nn = fn(), [Un, Jo] = cs({
    controlled: J,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const $r = j.useRef(), el = (et) => {
    const It = xt.props;
    It.onMouseMove && It.onMouseMove(et), un = {
      x: et.clientX,
      y: et.clientY
...
`));
  const nl = j.useMemo(() => {
    ...
    touch: we.current
  }), Ar = ym(sn), sa = (r = (o = O.popper) != null ? o : I.Popper) != null ? r : xm, la = (a = (s = (l = O.transition) != null ? l : I.Transition) != null ? s : S) != null ? a : ii, ca = (c = (d = O.tooltip) != null ? d : I.Tooltip) != null ? c : Nm, da = (p = (f = O.arrow) != null ? f : I.Arrow) != null ? p : km, rl = mn(sa, A({}, q, (w = Q.popper) != null ? w : U.popper, {
...
function Tm(t) {
  const [e, n] = it(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, s = (d) => {
    ...
    let d = Fs(a).filter((p) => "menuItem" in p.group);
    if (!(r != null && r.id))
...
const _e = ur(({ className: t, ...e }, n) => /* @__PURE__ */ i(Cl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
    ...
    /* @__PURE__ */ i(Ws, { children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      ...
      q.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-w-full tw-justify-center", children: /* @__PURE__ */ i(St, { children: E }) }) : /* @__PURE__ */ y(In, { stickyHeader: !0, children: [
        /* @__PURE__ */ i(An, { className: "tw-bg-none", stickyHeader: !0, children: /* @__PURE__ */ y(qt, { children: [
          ...
          /* @__PURE__ */ i(zt, { children: p })
        ] }) }),
        /* @__PURE__ */ i(Mn, { children: q.map((O) => {
          var F;
          return /* @__PURE__ */ y(qt, { children: [
            /* @__PURE__ */ i(Mt, { children: /* @__PURE__ */ i(ua, { className: "tw-pr-0", size: 18 }) }),
...
function Jh({
  ...
  const c = qm(
    ...
    o && o(g), r && r([g, ...n.filter((b) => b !== g)]), a && n.find((b) => b === g) && a([...n.filter((b) => b !== g)]), p(!1);
  }, w = (g, b) => {
    var h, k, P, C, E, v;
