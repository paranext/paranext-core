...
import Mt, { forwardRef as Oi, useCallback as Ce, useState as Ie, useRef as ht, useEffect as fn, useLayoutEffect as Eo, useMemo as it } from "react";
...
import xe, { clsx as ws } from "clsx";
  ...
  constructor(t, n, r, o) {
    if (te(this, "firstChapter"), te(this, "lastChapter"), te(this, "lastVerse"), te(this, "hasSegmentsDefined"), te(this, "text"), te(this, "BBBCCCVVVS"), te(this, "longHashCode"), te(this, "versification"), te(this, "rtlMark", "‏"), te(this, "_bookNum", 0), te(this, "_chapterNum", 0), te(this, "_verseNum", 0), te(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        const i = t, s = n != null && n instanceof Nt ? n : void 0;
        this.setEmpty(s), this.parse(i);
      } else if (t != null && typeof t == "number") {
        const i = n != null && n instanceof Nt ? n : void 0;
        ...
        if (t != null && t instanceof oe) {
          ...
          if (t == null)
            return;
          const i = t instanceof Nt ? t : oe.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Nt(rt[s]);
        } catch {
...
te(Se, "defaultVersification", Nt.English), te(Se, "verseRangeSeparator", "-"), te(Se, "verseSequenceIndicator", ","), te(Se, "verseRangeSeparators", [Se.verseRangeSeparator]), te(Se, "verseSequenceIndicators", [Se.verseSequenceIndicator]), te(Se, "chapterDigitShifter", 1e3), te(Se, "bookDigitShifter", Se.chapterDigitShifter * Se.chapterDigitShifter), te(Se, "bcvMaxValue", Se.chapterDigitShifter - 1), /**
...
function Dh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ie(""), [o, i] = Ie(
    ...
    ce.bookNumberToId(e.bookNum)
  ), [p, f] = Ie(!1), [d, b] = Ie(p), v = ht(void 0), g = ht(void 0), h = ht(void 0), T = Ce(
    (C) => ml(C).filter((R) => {
...
function jh({
  ...
  const o = it(
    () => Array.from({ length: r }, (u, p) => p + 1),
    [r]
  ), i = it(() => o[0], [o]), s = it(() => o[r - 1], [r, o]), l = (u, p) => {
    e(p), p > s && t(p);
  }, c = (u, p) => {
    t(p), p < i && e(p);
  };
...
function zi({
  ...
  let f;
  if (n) {
    const d = r === Rt.Before || r === Rt.Above, b = /* @__PURE__ */ E("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Rt.Before || r === Rt.After, g = v ? b : /* @__PURE__ */ E("div", { children: b }), h = v ? p : /* @__PURE__ */ E("div", { children: p });
    f = /* @__PURE__ */ pe(
      Os,
      {
...
function Ye(e, t, n = {
  ...
  return ft(e) && ft(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (ft(t[o]) && o in e && ft(e[o]) ? r[o] = Ye(e[o], t[o], n) : n.clone ? r[o] = ft(t[o]) ? Wi(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function $l(e) {
  const {
...
const Gi = Vt(a.element, qi);
Gi.isRequired = Vt(a.element.isRequired, qi);
const hn = Gi;
function Ml(e) {
  const {
    prototype: t = {}
...
const Wl = typeof window < "u" ? x.useLayoutEffect : x.useEffect, bt = Wl;
let zo = 0;
function ql(e) {
...
function hc(e) {
  ...
  const s = la(k({}, o, r)), l = qo(r), c = qo(o), u = t(s), p = xe(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = k({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = k({}, u, n, c, l);
...
process.env.NODE_ENV !== "production" && (cn["propTypes"] = Ki(cn.propTypes));
function Sc(e) {
  const t = Ee(e);
...
var Pe = "top", Fe = "bottom", Ve = "right", Ne = "left", zr = "auto", gn = [Pe, Fe, Ve, Ne], Dt = "start", un = "end", Ac = "clippingParents", pa = "viewport", Xt = "popper", Dc = "reference", Xo = /* @__PURE__ */ gn.reduce(function(e, t) {
...
var mt = Math.max, jn = Math.min, jt = Math.round;
function Pr() {
...
function Bt(e, t, n) {
  ...
  var s = yt(e) ? Ae(e) : window, l = s.visualViewport, c = !fa() && n, u = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, d = r.height / i;
  return {
    width: f,
    height: d,
    top: p,
...
function eu(e) {
  ...
  if (!(!i || !s)) {
    var f = Qc(o.padding, n), d = Hr(i), b = c === "y" ? Pe : Ne, v = c === "y" ? Fe : Ve, g = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], T = bn(i), I = T ? c === "y" ? T.clientHeight || 0 : T.clientWidth || 0 : 0, y = g / 2 - h / 2, w = f[b], m = I - d[p] - f[v], S = I / 2 - d[p] / 2 + y, P = on(w, S, m), L = c;
...
function Jo(e) {
  ...
  b = h.x, g = h.y;
  var T = s.hasOwnProperty("x"), I = s.hasOwnProperty("y"), y = Ne, w = Pe, m = window;
  if (u) {
    var S = bn(n), P = "clientHeight", L = "clientWidth";
    if (S === Ae(n) && (S = st(n), Ze(S).position !== "static" && l === "absolute" && (P = "scrollHeight", L = "scrollWidth")), S = S, o === Pe || (o === Ne || o === Ve) && i === un) {
      w = Fe;
...
function Gr(e) {
  return Bt(st(e)).left + qr(e).scrollLeft;
}
function pu(e, t) {
  var n = Ae(e), r = st(e), o = n.visualViewport, i = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function du(e) {
  var t, n = st(e), r = qr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = mt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = mt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Gr(e), c = -r.scrollTop;
...
function Qo(e, t, n) {
  return t === pa ? Nr(pu(e, n)) : yt(t) ? fu(t, n) : Nr(du(st(e)));
}
function hu(e) {
  var t = an(Wn(e)), n = ["absolute", "fixed"].indexOf(Ze(e).position) >= 0, r = n && Be(e) ? bn(e) : e;
  return yt(r) ? t.filter(function(o) {
    return yt(o) && ha(o, r) && We(o) !== "body";
  }) : [];
}
function mu(e, t, n, r) {
  var o = t === "clippingParents" ? hu(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, u) {
    var p = Qo(e, u, r);
    return c.top = mt(p.top, c.top), c.right = jn(p.right, c.right), c.bottom = jn(p.bottom, c.bottom), c.left = mt(p.left, c.left), c;
  }, Qo(e, s, r));
...
function pn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Ac : l, u = n.rootBoundary, p = u === void 0 ? pa : u, f = n.elementContext, d = f === void 0 ? Xt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, h = g === void 0 ? 0 : g, T = ga(typeof h != "number" ? h : ba(h, gn)), I = d === Xt ? Dc : Xt, y = e.rects.popper, w = e.elements[v ? I : d], m = mu(yt(w) ? w : w.contextElement || st(e.elements.popper), c, p, s), S = Bt(e.elements.reference), P = ya({
    reference: S,
    element: y,
    strategy: "absolute",
    placement: o
...
function gu(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? da : c, p = Lt(r), f = p ? l ? Xo : Xo.filter(function(v) {
    return Lt(v) === p;
...
function vu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, p = n.boundary, f = n.rootBoundary, d = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, T = Ue(h), I = T === h, y = c || (I || !v ? [Rn(h)] : bu(h)), w = [h].concat(y).reduce(function(z, H) {
      ...
      var C = w[F], R = Ue(C), $ = Lt(C) === Dt, j = [Pe, Fe].indexOf(R) >= 0, D = j ? "width" : "height", M = pn(t, {
        placement: C,
        boundary: p,
        rootBoundary: f,
        altBoundary: d,
...
function Pu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, p = n.altBoundary, f = n.padding, d = n.tether, b = d === void 0 ? !0 : d, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = pn(t, {
    ...
    padding: f,
    altBoundary: p
  }), T = Ue(t.placement), I = Lt(t.placement), y = !I, w = Wr(T), m = Cu(w), S = t.modifiersData.popperOffsets, P = t.rects.reference, L = t.rects.popper, B = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (S) {
    if (i) {
      var $, j = w === "y" ? Pe : Ne, D = w === "y" ? Fe : Ve, M = w === "y" ? "height" : "width", V = S[w], Q = V + h[j], Z = V - h[D], O = b ? -L[M] / 2 : 0, A = I === Dt ? P[M] : L[M], U = I === Dt ? -L[M] : -P[M], K = t.elements.arrow, z = b && K ? Hr(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ma(), q = H[j], G = H[D], W = on(0, P[M], z[M]), X = y ? P[M] / 2 - O - W - q - F.mainAxis : A - W - q - F.mainAxis, Y = y ? -P[M] / 2 + O + W + G + F.mainAxis : U + W + G + F.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[w]) != null ? $ : 0, N = V + X - J - _, re = V + Y - J, ve = on(b ? jn(Q, N) : Q, V, b ? mt(Z, re) : Z);
      S[w] = ve, R[w] = ve - V;
    }
    if (l) {
      var ke, me = w === "x" ? Pe : Ne, ct = w === "x" ? Fe : Ve, Oe = S[m], Ge = m === "y" ? "height" : "width", Re = Oe + h[me], Ke = Oe - h[ct], we = [Pe, Ne].indexOf(T) !== -1, xt = (ke = C == null ? void 0 : C[m]) != null ? ke : 0, ut = we ? Re : Oe - P[Ge] - L[Ge] - xt + F.altAxis, zt = we ? Oe + P[Ge] + L[Ge] - xt - F.altAxis : Ke, xn = b && we ? Zc(ut, Oe, zt) : on(b ? ut : Re, Oe, b ? zt : Ke);
      S[m] = xn, R[m] = xn - Oe;
    }
    t.modifiersData[r] = R;
  }
...
function Iu(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && Mu(t), i = st(t), s = Bt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Kr(i)) && (l = $u(t)), Be(t) ? (c = Bt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Gr(i))), {
    ...
    var p = {
      ...
      setOptions: function(T) {
        ...
        g(), p.options = Object.assign({}, i, p.options, I), p.scrollParents = {
          reference: yt(l) ? an(l) : l.contextElement ? an(l.contextElement) : [],
          popper: an(c)
        };
...
`));
  ...
  const R = qu(), $ = (r = v.root) != null ? r : "div", j = vt({
    elementType: $,
...
const Zu = {
  borderRadius: 4
}, Qu = Zu, ep = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, lt = ep;
function sn(e, t) {
  return t ? Ye(e, t, {
    clone: !1
...
fe.propTypes = process.env.NODE_ENV !== "production" ? Kn.reduce((e, t) => (e[t] = lt, e), {}) : {};
fe.filterProps = Kn;
function he(e) {
  return Ta(e, Xn);
}
he.propTypes = process.env.NODE_ENV !== "production" ? Xn.reduce((e, t) => (e[t] = lt, e), {}) : {};
he.filterProps = Xn;
process.env.NODE_ENV !== "production" && sp.reduce((e, t) => (e[t] = lt, e), {});
function up(e = 8) {
  if (e.mui)
    return e;
  const t = Ea({
...
function nd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const I = Bs(s, k({
      shouldForwardProp: T,
      label: h
    }, b)), y = (m) => typeof m == "function" && m.__emotion_real !== m || ft(m) ? (S) => Mn(m, k({}, S, {
      theme: Cn({
        theme: S.theme,
        defaultTheme: n,
        themeId: t
...
function si(e) {
  e = wt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? wt(ad(e)).values : e.values;
...
function Fn(e, t) {
  return e = wt(e), t = eo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, tr(e);
}
function sd(e, t) {
  if (e = wt(e), t = eo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const ud = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ct = vd, yd = ["mode", "contrastThreshold", "tonalOffset"], ci = {
...
The color object needs to have a \`main\` property or a \`${T}\` property.` : _t(11, h ? ` (${h})` : "", T));
...
const Pa = Mt.createContext(null);
var Kd = function(t) {
  return t.scrollTop;
}, tn = "unmounted", pt = "exited", dt = "entering", $t = "entered", $r = "exiting", nt = /* @__PURE__ */ function(e) {
  qd(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = pt, i.appearStatus = dt) : c = $t : r.unmountOnExit || r.mountOnEnter ? c = tn : c = pt, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== dt && s !== $t && (i = dt) : (s === dt || s === $t) && (i = $r);
    }
    ...
    return (
      ...
      /* @__PURE__ */ Mt.createElement(Pa.Provider, {
        value: null
      }, typeof s == "function" ? s(o, l) : Mt.cloneElement(Mt.Children.only(s), l))
    );
  }, t;
}(Mt.Component);
nt.contextType = Pa;
...
const Yd = {
  ...
  } = t, T = ue(t, Xd), I = Qt(), y = x.useRef(), w = wn(), m = x.useRef(null), S = Le(m, i.ref, n), P = (D) => (M) => {
    if (D) {
      const V = m.current;
      M === void 0 ? D(V) : D(V, M);
    }
...
}, mi = Jd, Zd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qd = Te(xa, {
  name: "MuiPopper",
  slot: "Root",
...
const tf = at("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ot = tf, nf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function rf(e) {
  return Math.round(e * 1e5) / 1e5;
}
const of = (e) => {
...
const Ia = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const S = tt({
    ...
    children: L
  }), ve = wn(), ke = ve.direction === "rtl", [me, ct] = x.useState(), [Oe, Ge] = x.useState(null), Re = x.useRef(!1), Ke = j || Z, we = Qt(), xt = Qt(), ut = Qt(), zt = Qt(), [xn, so] = Zi({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const nr = Ji(O), Ut = x.useRef(), En = ln(() => {
  ...
  const lo = (ee) => {
    ...
    Re.current && ee.type !== "touchstart" || (me && me.removeAttribute("title"), xt.clear(), ut.clear(), M || Pn && V ? xt.start(Pn ? V : M, () => {
      lo(ee);
    }) : lo(ee));
  }, co = (ee) => {
    xt.clear(), ut.start(A, () => {
    ...
    me || ct(ee.currentTarget), Za(ee), uo.current === !0 && (po(!0), rr(ee));
  }, mo = (ee) => {
    Re.current = !0;
    const $e = re.props;
    $e.onTouchStart && $e.onTouchStart(ee);
  }, go = rr, bo = co, es = (ee) => {
    mo(ee), ut.clear(), we.clear(), En(), Ut.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", zt.start(Q, () => {
      document.body.style.WebkitUserSelect = Ut.current, rr(ee);
    });
  }, ts = (ee) => {
    re.props.onTouchEnd && re.props.onTouchEnd(ee), En(), ut.start(U, () => {
      Tn(ee);
    });
  };
  x.useEffect(() => {
...
`));
  const os = x.useMemo(() => {
    ...
    touch: Re.current
  }), ar = of(qt), vo = (r = (o = Y.popper) != null ? o : B.Popper) != null ? r : af, yo = (i = (s = (l = Y.transition) != null ? l : B.Transition) != null ? s : _) != null ? i : Ir, wo = (c = (u = Y.tooltip) != null ? u : B.Tooltip) != null ? c : sf, xo = (p = (f = Y.arrow) != null ? f : B.Arrow) != null ? p : lf, is = en(vo, k({}, W, (d = X.popper) != null ? d : F.popper, {
    className: xe(ar.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : F.popper) == null ? void 0 : b.className)
  }), qt), as = en(yo, k({}, J, (g = X.transition) != null ? g : F.transition), qt), ss = en(wo, k({}, (h = X.tooltip) != null ? h : F.tooltip, {
    className: xe(ar.tooltip, (T = (I = X.tooltip) != null ? I : F.tooltip) == null ? void 0 : T.className)
  }), qt), ls = en(xo, k({}, (y = X.arrow) != null ? y : F.arrow, {
...
function ao(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = it(() => {
...
const Hf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Wf = (e) => {
  ...
  const G = (r = (o = j == null ? void 0 : j.root) != null ? o : T.Root) != null ? r : qf, W = (i = (s = j == null ? void 0 : j.backdrop) != null ? s : T.Backdrop) != null ? i : p, X = (l = $ == null ? void 0 : $.root) != null ? l : I.root, Y = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, ne = vt({
    elementType: G,
    externalSlotProps: X,
  ...
  return !F && !R && (!K || U) ? null : /* @__PURE__ */ E(cn, {
    ref: O,
    container: g,
    disablePortal: S,
...
`));
    ...
    const ct = ke + N.height, Oe = me + N.width, Ge = At(In(c)), Re = Ge.innerHeight - h, Ke = Ge.innerWidth - h;
    if (h !== null && ke < h) {
      const we = ke - h;
      ke -= we, re.vertical += we;
    } else if (h !== null && ct > Re) {
      const we = ct - Re;
      ke -= we, re.vertical += we;
    }
...
`)), h !== null && me < h) {
  ...
  const q = v || (c ? Ee(In(c)).body : void 0), G = (o = y == null ? void 0 : y.root) != null ? o : ih, W = (i = y == null ? void 0 : y.paper) != null ? i : Ga, X = vt({
    elementType: W,
...
`)), Z.props.disabled || (T === "selectedMenu" && Z.props.selected || j === -1) && (j = O));
  ...
  const D = (r = I.paper) != null ? r : hh, M = (o = y.paper) != null ? o : b, V = vt({
    elementType: I.root,
...
function Lh({
  ...
  var u;
  const [o, i] = Mt.useState(void 0), s = Ce(
    (p) => {
      p.preventDefault(), i(
        o === void 0 ? {
          mouseX: p.clientX + 2,
...
function yh({
  ...
  const [T] = _r(
    ...
    Ce(async () => (e == null ? void 0 : e(!0)) ?? n ?? T, [e, n, T, c]),
    n ?? T
  ), y = p && I ? I : T;
  return /* @__PURE__ */ pe(Un, { children: [
    /* @__PURE__ */ E(
...
function Vh({ scrRef: e, handleSubmit: t, id: n }) {
  ...
  return /* @__PURE__ */ pe("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ E(Et, { onClick: () => t(Oo(e, 1)), children: ">" })
  ] });
}
