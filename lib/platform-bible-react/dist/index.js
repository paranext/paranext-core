...
import { includes as cn, Section as X, getChaptersForBook as ti, formatScrRef as xe, getSectionForBook as We, formatRelativeDate as ei, formatReplacementString as ve, sanitizeHtml as ni, NumberFormat as ri, formatBytes as oi, getCurrentLocale as ai, usfmMarkers as fn, getFormatCallerFunction as si, deepEqual as ii, isString as Kr, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as Q, formatScrRefRange as li, formatScrRefWithOptionalParts as wi } from "platform-bible-utils";
import { getLocalizedBookName as Cu } from "platform-bible-utils";
...
import { createEditor as Ro, $getRoot as ce, $createParagraphNode as Tn, $getSelection as Vt, HISTORY_MERGE_TAG as gr, ParagraphNode as So, TextNode as Do, $isTokenOrSegmented as ci, $getCharacterOffsets as di, $cloneWithPropertiesEphemeral as pi, $findMatchingParent as Mo, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Oo, COMMAND_PRIORITY_EDITOR as Io, mergeRegister as de, shallowMergeConfig as ui, defineExtension as qt, safeCast as sn, createState as mi, FORMAT_TEXT_COMMAND as Ao, $isNodeSelection as Po, COMMAND_PRIORITY_LOW as $o, RootNode as fi, LineBreakNode as hi, TabNode as gi, $isEditorState as bi, createCommand as vi, CLICK_COMMAND as xi, isDOMNode as yi, $getNodeFromDOMNode as Ni, $createNodeSelection as ki, $setSelection as _i, DecoratorNode as Qn, $getState as Ci, toggleTextFormatType as Gr, TEXT_TYPE_TO_FORMAT as Ei, $setState as Ti, addClassNamesToElement as Lo, $create as Ri, $getNodeByKey as Si, removeClassNamesFromElement as Di, KEY_TAB_COMMAND as Mi, $isBlockElementNode as bn, $createRangeSelection as Oi, $normalizeSelection__EXPERIMENTAL as Ii, OUTDENT_CONTENT_COMMAND as Ai, INDENT_CONTENT_COMMAND as Ur, INSERT_TAB_COMMAND as Pi, COMMAND_PRIORITY_CRITICAL as br, $isDecoratorNode as $i, $isParagraphNode as Li, $isTextNode as vn, SELECTION_CHANGE_COMMAND as Vo, getRegisteredNode as Vi, isHTMLElement as ji, isDocumentFragment as qr, isDOMDocumentNode as zi, ArtificialNode__DO_NOT_USE as jo, $createLineBreakNode as zo, $isRootOrShadowRoot as Fi, isBlockDomNode as Hr, isInlineDomNode as Yr, $insertNodes as Bi } from "lexical";
import * as _e from "@radix-ui/react-tooltip";
import { TooltipTrigger as Ki } from "@radix-ui/react-tooltip";
import { HeadingNode as Gi, QuoteNode as Ui, registerRichText as qi } from "@lexical/rich-text";
import { flushSync as Hi, createPortal as Yi } from "react-dom";
...
import { useReactTable as Go, getFilteredRowModel as Ji, getSortedRowModel as Uo, getPaginationRowModel as Zi, getCoreRowModel as qo, flexRender as Je, getGroupedRowModel as Qi, getExpandedRowModel as tl } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as tr, HIDDEN_NOTE_CALLER as er, getDefaultViewOptions as nl, isInsertEmbedOpOfType as dn, Editorial as rl } from "@eten-tech-foundation/platform-editor";
...
const ll = Lt.Root, wl = Lt.Portal, Ho = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
    className: m(
...
cl.displayName = Lt.Description.displayName;
...
xr.displayName = Ct.Separator.displayName;
...
const ta = an(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Fe : "button", { className: m(ea({ variant: e, size: n, className: t })), ref: s, ...a })
);
z.displayName = "Button";
const oe = Ie.Root, fe = Ie.Trigger, pl = Ie.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ht();
...
function bp({
  ...
  const c = ht(), [d, f] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, N] = S("books"), [y, k] = S(void 0), [C, F] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: m("pr-twp", gl(), t), ...e }));
...
function sr({
  ...
  const [y, k] = S(!1), C = w ?? l, F = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], j = (R, $) => {
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: F(e) ? e.map((R) => /* @__PURE__ */ r(Ut, { heading: R.groupHeading, children: R.options.map(($) => j($, R.groupHeading)) }, R.groupHeading)) : e.map((R) => j(R)) })
        ] })
      }
    )
  ] });
...
function yp({
  ...
  const d = Vn(c, "%webView_bookSelector_currentBook%"), f = Vn(c, "%webView_bookSelector_choose%"), h = Vn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = ra ? It : Y, pn = { tag: gr };
function Nl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = xl(null, o), d = Ro({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (f) => i(f, d), theme: o });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          case "string": {
            ...
            f.setEditorState(u, pn);
            break;
          }
          case "object":
            f.setEditorState(h, pn);
            break;
          case "function":
            f.update(() => {
              ce().isEmpty() && h(f);
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
...
const _r = {
  ...
  {
    ref: o,
    className: e ? m(ea({ variant: e }), t) : t,
    ...n
  }
));
...
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function Dl(t) {
...
function Ol(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ci(e) && o !== null) {
    ...
    if (c || d) {
      const [f, h] = di(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, N = 0;
      u ? (N = f > h ? h : f, v = f > h ? f : h) : g ? (N = i ? h : f, v = void 0) : x && (N = 0, v = i ? f : h);
      const y = e.__text.slice(N, v);
      y !== e.__text && (n === "clone" && (e = pi(e)), e.__text = y);
    }
  }
  return e;
}
...
function zl(t) {
  ...
  sa(this), Z = t, this.f &= -2, 8 & this.f && Er(this), Sn();
}
function De(t, e) {
...
function wa(t, e = la) {
  return t.registerCommand(Oo, (n) => (t.update(e), !0), Io);
}
...
const zn = mi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ca extends Qn {
  $config() {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [ca], register: (t, e, n) => t.registerCommand(Ao, (o) => {
  const a = Vt();
  if (Po(a) || ke(a)) for (const s of a.getNodes()) Bl(s) && s.toggleFormat(o);
  return !1;
}, $o) });
function da(t, e) {
  let n;
...
const Tr = 0, cr = 1, ua = 2, Fn = 3, un = 4, Se = 5, Bn = 6, He = 7;
function Kn(t) {
  return t.id === Tr;
}
function ma(t) {
...
const Hl = qt({ config: sn({ setOptions: to, updateOptions: to }), init: ({ $initialEditorState: t = ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [fi, Do, hi, gi, So] }), eo = Symbol.for("@lexical/extension/LexicalBuilder");
function no() {
}
function Yl(t) {
  throw t;
...
class Qe {
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: f } = d;
      if (f.onError !== void 0 && (e.onError = f.onError), f.disableEvents !== void 0 && (e.disableEvents = f.disableEvents), f.parentEditor !== void 0 && (e.parentEditor = f.parentEditor), f.editable !== void 0 && (e.editable = f.editable), f.namespace !== void 0 && (e.namespace = f.namespace), f.$initialEditorState !== void 0 && (e.$initialEditorState = f.$initialEditorState), f.nodes) for (const h of Fl(f)) {
...
const Xl = /* @__PURE__ */ new Set(), ro = qt({ build(t, e, n) {
...
vi("INSERT_HORIZONTAL_RULE_COMMAND");
class Ae extends Qn {
  static getType() {
...
qt({ dependencies: [wr, ro], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  ...
  return de(t.registerCommand(xi, (i) => {
    if (yi(i.target)) {
      const l = Ni(i.target);
      if (Jl(l)) return function(w, c = !1) {
        const d = Vt(), f = w.isSelected(), h = w.getKey();
        let u;
        c && Po(d) ? u = d : (u = ki(), _i(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
...
function Zl(t, e, n = ha) {
  return de(t.registerCommand(Mi, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => bn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), f = Pl(d);
      if (f.canIndent()) {
        const h = f.getKey();
        let u = Oi();
...
qt({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ha, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  ...
  return pe(() => {
    if (!o.value) return Zl(t, a, s);
  });
} });
const Ql = qt({ name: "@lexical/react/ReactProvider" });
function tw() {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (vn(v) && c >= 0 && d >= 0 && (N = c, y = c + d, g.setTextNodeRange(v, N, v, y)), N === y && f === "" || (g.insertRawText(f), v = x.getNode()), vn(v)) {
                  N = h, y = h + u;
...
qt({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : ba(t)) });
function rw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return Rr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (h) => n._onError(h), children: r(hs, { fallback: null, children: a[c] }) }), f = n.getElementByKey(c);
        f !== null && i.push(Yi(d, f, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function sw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Rr(() => de(qi(a), ba(a)), [a]);
  }(o), p(lt, { children: [t, r(iw, { content: e }), r(aw, { editor: o, ErrorBoundary: n })] });
}
...
const ww = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function cw({ onClear: t }) {
  const [e] = Xt();
  return ww(() => wa(e, t), [e, t]), null;
}
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function dw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: N = !0, style: y, tabIndex: k, "data-testid": C, ...F }, j) {
  ...
  return va(() => ($(t.isEditable()), t.registerEditableListener((V) => {
    $(V);
  })), [t]), r("div", { "aria-activedescendant": R ? e : void 0, "aria-autocomplete": R ? n : "none", "aria-controls": R ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": R && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": d, "aria-owns": R ? f : void 0, "aria-readonly": !R || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: R, "data-testid": C, id: x, ref: D, role: v, spellCheck: N, style: y, tabIndex: k, ...F });
}
const pw = an(dw);
function ao(t) {
  return t.getEditorState().read(ga(t.isComposing()));
...
function mw(t, e) {
  ...
  return p(lt, { children: [r(pw, { editor: a, ...o, ref: e }), n != null && r(fw, { editor: a, content: n })] });
}
...
function bw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(ll, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Yo, { children: [
...
function vw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = bw(), w = () => {
  };
...
const Na = me(
  ...
  {
    ref: a,
    className: m(Na({ variant: e, size: n, className: t })),
    ...o
  }
));
yw.displayName = Fo.Root.displayName;
        ...
        children: /* @__PURE__ */ r(
          Nl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(_w, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                _l,
                {
...
function Ew(t, e) {
  const n = zi(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function _a(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && vn(e) && (i = Ol(o, e, "clone"));
  const l = le(i) ? i.getChildren() : [], w = Vi(t, i.getType());
  let c;
  ...
  if (a && !s) {
    if ((ji(d) || qr(d)) && d.append(h), n.append(d), f) {
      const u = f.call(i, d);
...
function Ea(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Fi(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < f.length; g++) h.push(...Ea(f[g], e, n, u, new Map(a), l));
  return d != null && (h = d(h)), Hr(t) && (h = Rw(t, h, u ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Tn)), l == null ? h.length > 0 ? i = i.concat(h) : Hr(t) && function(g) {
...
function Sw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = Ew(e, a);
      ce().clear(), Bi(s);
    },
    {
      discrete: !0
...
function Np({
  ...
  const [a, s] = S(Dw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), f = H(null);
  Y(() => {
    let N = !0;
    const y = f.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Mr(N) && (N.preventDefault(), N.stopPropagation(), $t(a) && h());
        },
        onKeyDown: (N) => {
...
const kp = Object.freeze([
...
], Mw = ["input", "select", "textarea", "button"], Ow = ["button", "textbox"], Iw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = H(null), [s, i] = S(void 0), [l, w] = S(void 0), c = K(
    ...
    (u) => {
      var R;
      const g = u.target, x = ($) => $ ? document.getElementById($) : void 0, v = x(l), N = x(s);
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: m("pr-twp", Aw({ variant: e }), t), ...n })
);
...
const Lw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
}), Ce = nt.Trigger, Ia = nt.Group, zw = nt.Portal, Fw = nt.Sub, Bw = nt.RadioGroup;
...
function io({
  ...
  const u = K(
    ...
    [t.user]
  ), y = B(() => ni(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          kn,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), f(Sw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ma, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Oa, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Mr(C) && (C.preventDefault(), C.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (C) => {
...
function Gw({
  ...
  const [R, $] = S(lo), [E, D] = S(
    void 0
  ), V = o, [P, I] = S(!1), [A, W] = S(!1), [O, J] = S(!1), [Tt, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  }, [s, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), it = B(() => P || U <= 2 ? L : L.slice(-2), [L, U, P]), tt = B(() => P || U <= 2 ? 0 : U - 2, [U, P]), bt = B(
  ...
  const Rt = K(
    ...
    async (T) => {
      const vt = $t(R) ? Nn(R) : void 0, mt = await f({
        ...T,
        contents: vt,
          ...
          o && /* @__PURE__ */ p(lt, { children: [
            ...
            v !== !1 && (!A || $t(R)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Mr(T) && (T.preventDefault(), T.stopPropagation(), ($t(R) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
...
function Cp({
  ...
  const F = n.filter(
    ...
    [N, x]
  ), { listboxRef: E, activeId: D, handleKeyDown: V } = Iw({
    options: j,
    onOptionSelect: R
  }), P = K(
    (I) => {
...
function Uw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Wi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = dt.Root, qw = dt.Group, Ve = dt.Value, Hw = me(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: m(Hw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
function rc({
  ...
  var j;
  const [d, f] = S([]), [h, u] = S([]), [g, x] = S({}), [v, N] = S({}), y = B(() => e ?? [], [e]), k = Go({
    data: y,
    columns: t,
    getCoreRowModel: qo(),
...
function Ep({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(el, { options: s, children: e })
    }
  );
}
...
function Sp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Ia, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
...
const pc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
const mc = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function hc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Ki, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: mc(t, n) }) }) }),
...
function uo({
  ...
  return /* @__PURE__ */ p(
    Ht,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(bc, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
...
function Ip({
  ...
  const [g, x] = S("generated"), [v, N] = S("*"), [y, k] = S("f"), [C, F] = S(!1), [j, R] = S(!0), [$, E] = S(!1), D = H(!1), V = H(""), [P, I] = S(!1), [A, W] = S(), [O, J] = S(), [Tt, At] = S(), [Mt, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? nl(), noteMode: "expanded" }
    }),
    [i, l]
  ), at = B(
    () => xc(
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      y !== "x" && _ === "x" ? ct == null || ct.forEach((Rt) => yc(Rt)) : y === "x" && _ !== "x" && (ct == null || ct.forEach((Rt) => Nc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: _c(t.marker, l, o, c) })
      }
    )
  ] });
}
...
const Sc = (t) => {
  ...
  return e ? e[1] : "";
}, Mc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Bp = Object.freeze([
...
function Kp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), N = Kt(n, "%webView_inventory_scope_currentBook%"), y = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), F = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Kt(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [E, D] = S("all"), [V, P] = S(""), [I, A] = S([]), W = B(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Ic(G, a, s);
  }, [t, a, s]), O = B(() => {
    if (R) return W;
    const G = [];
    return W.forEach((at) => {
  ...
  }, [R, W]), J = B(() => O.length === 0 ? [] : Oc(O, E, V), [O, E, V]), Tt = B(() => {
    var st, wt;
    if (!R) return w;
...
const Fa = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), f = e ?? c, h = b.useCallback(
      ...
      [n, f]
    ), u = b.useCallback(() => h((k) => !k), [h]), g = f ? "expanded" : "collapsed", N = ht() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = Pn(), d = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(Kc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Xc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: s,
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ p(Ga, { children: [
        /* @__PURE__ */ p(pr, { children: [
          ...
          /* @__PURE__ */ r(mr, { children: /* @__PURE__ */ r(Ua, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(qa, { children: /* @__PURE__ */ r(
            Ha,
            {
              onClick: () => c(h),
              isActive: f(h),
...
}, mo = (t) => `${rd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Up({
  sources: t,
  ...
  }, R = (E, D) => E.getIsGrouped() ? "" : m("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (E, D, V) => {
...
function ad({
  ...
  }, [v, N] = S(!1), [y, k] = S(""), C = H(void 0), F = H(!1);
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (A) => {
      ...
      n(
        Xa(j, A, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), P = () => {
...
function fr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Hs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(go, { children: [
      /* @__PURE__ */ r(Ia, { children: /* @__PURE__ */ r(kt, { children: Ja(e.groups, e.items, w, t) }) }),
...
function pd({
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, f) => {
    var g, x, v, N;
    d.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Ye(w, [h, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, f]) => typeof d == "boolean" || typeof f == "boolean" ? 0 : d.order - f.order).map(([d, f]) => /* @__PURE__ */ p(id, { children: [
  ...
  return /* @__PURE__ */ p("div", { className: "tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none", children: [
    /* @__PURE__ */ p(
      z,
      {
        ...
        children: [
          /* @__PURE__ */ r("span", { className: m({ "tw-me-2": i === "allText" }), children: e ? li(t, e, s) : wi(t, s) }),
          i === "allText" && ho(n, o)
        ]
      }
    ),
        ...
        /* @__PURE__ */ p("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": e }), children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: m(f && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Br, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] }) }),
            e && c && /* @__PURE__ */ r("div", { className: "tw-p-1", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f, asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Br, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] }) })
          ] }),
...
const hd = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ws, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
