...
import { formatScrRef as Ot, MODIFIER_KEYS as gn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Je, isString as Ee, compareScrRefs as Ie, scrRefToBBBCCCVVV as De, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
import * as Pe from "@radix-ui/react-progress";
...
const ya = He(
  ({
    ...
    return /* @__PURE__ */ w("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Lt,
        {
          ...
          className: d(
            ...
            l && (s ? "focus-visible:tw-ring-green-600" : i && "focus-visible:tw-ring-destructive"),
            o
          ),
      ...
      g && l && (s ? /* @__PURE__ */ r(_t, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : i && /* @__PURE__ */ r(zr, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), We = Or(void 0);
function ct() {
...
const Ze = G.Trigger, An = G.Group, ka = G.Portal, Ca = G.Sub, qs = G.RadioGroup;
function pe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(We.Provider, { value: n, children: /* @__PURE__ */ r(G.Root, { ...e }) });
}
const Pn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ w(
    G.SubTrigger,
    {
...
Pn.displayName = G.SubTrigger.displayName;
...
Fn.displayName = G.SubContent.displayName;
...
const Qe = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ w(
    G.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const jn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ w(
    G.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(Ue, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
jn.displayName = G.RadioItem.displayName;
...
var Sa = Object.defineProperty, Ta = (t, e, n) => e in t ? Sa(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, D = (t, e, n) => Ta(t, typeof e != "symbol" ? e + "" : e, n);
const Mt = [
  "GEN",
  "EXO",
  "LEV",
...
D(at, "Original", new at(ut.Original)), D(at, "Septuagint", new at(ut.Septuagint)), D(at, "Vulgate", new at(ut.Vulgate)), D(at, "English", new at(ut.English)), D(at, "RussianProtestant", new at(ut.RussianProtestant)), D(at, "RussianOrthodox", new at(ut.RussianOrthodox));
let Dt = at;
function vn(t, e) {
  const n = e[0];
...
const tt = class O {
  constructor(e, n, a, o) {
    if (D(this, "firstChapter"), D(this, "lastChapter"), D(this, "lastVerse"), D(this, "hasSegmentsDefined"), D(this, "text"), D(this, "BBBCCCVVVS"), D(this, "longHashCode"), D(this, "versification"), D(this, "rtlMark", "‏"), D(this, "_bookNum", 0), D(this, "_chapterNum", 0), D(this, "_verseNum", 0), D(this, "_verse"), a == null && o == null)
   ...
   */
  static fromJSON(e) {
    const { book: n, chapterNum: a, verseNum: o, verse: s, versificationStr: i } = e, l = s || o.toString();
    let c;
    return i && (c = new Dt(i)), n ? new O(n, a.toString(), l, c) : new O();
  }
  /**
...
D(tt, "defaultVersification", Dt.English), D(tt, "verseRangeSeparator", "-"), D(tt, "verseSequenceIndicator", ","), D(tt, "verseRangeSeparators", [tt.verseRangeSeparator]), D(tt, "verseSequenceIndicators", [tt.verseSequenceIndicator]), D(tt, "chapterDigitShifter", 1e3), D(tt, "bookDigitShifter", tt.chapterDigitShifter * tt.chapterDigitShifter), D(tt, "bcvMaxValue", tt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
D(tt, "ValidStatusType", Yn);
...
function Fa({
  ...
  const i = Array.from({ length: e }, (c, p) => p + 1), l = U(
    (c) => {
      o(c);
    },
    [o]
...
const xn = 6, rn = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), Un = Object.fromEntries(
  ...
  "ArrowRight",
  "Enter"
]), $a = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', Ut = (t) => da(M.bookIdToNumber(t));
function kn(t) {
  const e = rn.find(
...
function Ws({
  ...
  const o = W(), [s, i] = P(
    () => Ot(t, "English")
  ), [l, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, C] = P(t.book), [T, k] = P(!1), [y, S] = P(T), [V, I] = P(!1), [z, gt] = P(void 0), L = Q(void 0), x = Q(void 0), b = Q(void 0), B = Q(void 0), R = U(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (E, N) => {
            ...
            const j = N.exec(m);
            if (j) {
              const [F, pt = void 0, ae = void 0] = j.slice(1), it = kn(F) ?? (M.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (it) {
                const ht = pt ? parseInt(pt, 10) : void 0, xt = ae ? parseInt(ae, 10) : void 0;
                return {
                  bookId: it,
                  chapterNum: ht,
                  verseNum: xt
    ...
    if (!(!z || !z.chapterNum))
      return z.verseNum ? [z.chapterNum] : Array.from({ length: Ut(h) }, (m, E) => E + 1).filter(
        (m) => {
          var E;
          return (z == null ? void 0 : z.chapterNum) && m.toString().includes((E = z == null ? void 0 : z.chapterNum) == null ? void 0 : E.toString());
        }
      );
  }, [h, z]), st = q(() => {
    const m = R(s.trim());
    return m ? m.bookId !== t.book || (m.chapterNum ?? 0) !== t.chapterNum || (m.verseNum ?? 0) !== t.verseNum : !0;
  }, [s, t, R]), bt = q(
    () => !!z && st,
    [z, st]
  ), Tt = U(
    (m) => {
      ...
      return {
        ...
        const j = Un[N].toLowerCase(), F = l.replace(/[^\da-zA-Z]/g, "").toLowerCase();
        return bt ? j === F || // Match full book name
        N.toLowerCase() === F : j.includes(F) || // Match partial book name
    ...
    () => Z.reduce((m, E) => m + E.books.length, 0),
    [Z]
  ), Y = U(
    (m) => {
      i(m), c(m.trim()), gt(R(m.trim()));
    },
    [R]
  ), ot = Q(!1), rt = U(() => {
    ...
    (m, E, N, j) => {
      if (f(t.book !== m ? 1 : t.chapterNum), E || Ut(m) === -1) {
        e({
          book: m,
          chapterNum: N ?? 1,
          verseNum: j ?? 1
    ...
    yn.forEach((m) => {
      const E = m.exec(l);
      if (E) {
        const [N, j = void 0, F = void 0] = E.slice(1), pt = kn(N);
        (M.isBookIdValid(N) || pt) && It(
          pt ?? N,
          !0,
          j ? parseInt(j, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (m) => {
      if (T ? m.key === "ArrowDown" ? (B != null && B.current ? B.current.focus() : b != null && b.current ? b.current.focus() : x.current && x.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === L.current && (k(!1), m.preventDefault(), m.stopPropagation()) : m.key !== "Tab" && m.key !== "Escape" && k(!0), document.activeElement === L.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (Y(st ? l + m.key : m.key), I(!0), m.preventDefault()), !V) {
          if (/^\d$/.test(m.key)) {
            const N = s.match(
      ...
      if (m.key === "Tab") {
        if (m.shiftKey)
          ...
          const E = [
            ...
            (j) => {
              var F, pt;
              return j instanceof HTMLElement && ((j.offsetWidth > 0 || j.offsetHeight > 0) && !((F = x.current) != null && F.contains(j)) && !((pt = L.current) != null && pt.contains(j)) || j === m.target);
            }
    ...
    (m) => {
      const { key: E } = m;
      Nn.has(E) || (re(m), m.preventDefault());
    },
    [re]
  ), Dr = U((m) => {
    const { key: E } = m;
    ...
    (m, E) => {
      ...
      if (Nn.has(N)) {
        if (h === p || _ === 1) {
          const F = _ === 1 ? h : p;
          if (N === "Enter") {
            m.preventDefault(), It(F, !0, v);
            return;
          }
          const pt = N === "ArrowRight" && !o || N === "ArrowRight" && o === "ltr" || N === "ArrowLeft" && o === "rtl", ae = N === "ArrowLeft" && !o || N === "ArrowLeft" && o === "ltr" || N === "ArrowRight" && o === "rtl", Te = Array.from(
            { length: Ut(h) },
            (oe, Rt) => Rt + 1
          ), it = p !== h || _ === 1 ? K ?? Te : Te, ht = it.indexOf(v);
          let xt = v;
          if (pt)
            if (ht >= 0 && ht < it.length - 1)
              xt = it[ht + 1];
            else {
              m.preventDefault();
              return;
            ...
            const oe = it[ht] + xn, Rt = it.find((Re) => Re >= oe);
            Rt !== void 0 && (xt = Rt);
          } else if (N === "ArrowUp") {
            const oe = it[ht] - xn, Rt = it.slice().reverse().find((Re) => Re <= oe);
            Rt !== void 0 && (xt = Rt);
          }
          if (xt !== v) {
            f(xt), m.preventDefault();
            return;
          }
        }
        if (E === 0 && N === "ArrowUp" && !bt) {
          m.preventDefault(), L.current.focus();
          return;
        }
        return;
      }
  ...
  return lt(() => {
    _ === 1 ? f(1) : p === h ? p === t.book ? f(t.chapterNum) : f(1) : f(0);
  }, [h, t.book, t.chapterNum, p, _]), lt(() => {
    if (!K || _ > 1) return;
    K.indexOf(v) === -1 && f(K[0]);
  }, [h, v, p, K, _]), lt(() => {
    rt();
    ...
    const m = setTimeout(() => {
      ...
      if (y && x.current && b.current) {
        const F = b.current.offsetTop - Ga;
        x.current.scrollTo({ top: F, behavior: "instant" }), L.current.focus();
      }
      !y && document.activeElement !== L.current && !((E = L.current) != null && E.contains(document.activeElement)) && document.activeElement !== x.current && !((N = x.current) != null && N.contains(document.activeElement)) && rt();
    }, 10);
    return () => {
      clearTimeout(m);
    };
  }, [y, rt]), /* @__PURE__ */ w(pe, { modal: !1, open: T, onOpenChange: vt, children: [
    /* @__PURE__ */ r(Ze, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), C(t.book), f(t.chapterNum > 0 ? t.chapterNum : 0), L.current.focus();
        },
        onFocus: () => {
          ot.current = !0, I(!1), gt(R(s));
        },
        handleSubmit: hn,
    ...
    _ > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ w("div", { className: "rtl:tw-ps-2", children: [
          ...
          Z.map((m, E) => /* @__PURE__ */ w("div", { children: [
            ...
            m.books.map((N, j) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ...
              {
                bookId: N,
                handleSelectBook: () => It(N, !1),
                shouldExpandChildren: p.toLowerCase() === N.toLowerCase() || _ === 1,
                handleHighlightBook: () => C(N),
                handleKeyDown: (F) => Vr(F, j),
                bookType: m.bookType,
                ref: (F) => {
                  p === N && (b.current = F);
                },
                children: /* @__PURE__ */ r(
                  Fa,
                  {
                    ...
                    highlightedChapter: p === h || _ === 1 ? v : 0,
                    handleHighlightedChapter: (F) => {
                      f(F);
                    },
                    matchingChapters: st ? K : void 0
                  }
                )
              }
            ) }, N)),
            E < Z.length - 1 && /* @__PURE__ */ r(Pt, {})
          ] }, m.bookType))
        ] })
      }
    )
...
const La = St(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Gt : "button", { className: d(La({ variant: e, size: n, className: t })), ref: s, ...o })
);
X.displayName = "Button";
const Ha = St(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), J = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vn.Root, { ref: n, className: d("pr-twp", Ha(), t), ...e }));
...
const on = Qt.Root, sn = Qt.Trigger, he = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = W();
...
const Ya = mt.Portal, Kn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
    className: d(
...
Ua.displayName = mt.Content.displayName;
...
Ka.displayName = mt.Title.displayName;
...
qa.displayName = mt.Description.displayName;
...
ge.displayName = et.Input.displayName;
...
be.displayName = et.List.displayName;
const ve = u.forwardRef((t, e) => /* @__PURE__ */ r(et.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ve.displayName = et.Empty.displayName;
...
wn.displayName = et.Group.displayName;
...
qn.displayName = et.Separator.displayName;
...
xe.displayName = et.Item.displayName;
function Ja(t) {
...
function je({
  ...
  const [k, y] = P(!1);
  return /* @__PURE__ */ w(on, { open: k, onOpenChange: y, ...T, children: [
    /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ w(
      X,
      {
        variant: f,
        role: "combobox",
        ...
        children: [
          /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? l(s) : p })
          ] }),
    ...
    /* @__PURE__ */ r(
      he,
      {
        ...
        children: /* @__PURE__ */ w(fe, { children: [
          ...
          /* @__PURE__ */ r(be, { children: e.map((S) => /* @__PURE__ */ w(
            xe,
            {
              value: l(S),
              onSelect: () => {
    ...
    an,
    {
      ...
      children: /* @__PURE__ */ w("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(J, { className: "tw-flex tw-items-center", children: a.map((k) => M.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            X,
            {
...
function Qa({ table: t }) {
  return /* @__PURE__ */ w(pe, { children: [
    /* @__PURE__ */ r(la, { asChild: !0, children: /* @__PURE__ */ w(X, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Ft = H.Root, to = H.Group, jt = H.Value, eo = St(
  ...
  return /* @__PURE__ */ w(
    H.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(H.Icon, { asChild: !0, children: /* @__PURE__ */ r(de, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
Jn.displayName = H.ScrollUpButton.displayName;
const Wn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  H.ScrollDownButton,
  {
    ref: n,
...
Wn.displayName = H.ScrollDownButton.displayName;
const Bt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = W();
  return /* @__PURE__ */ r(H.Portal, { children: /* @__PURE__ */ w(
    H.Content,
    {
      ref: o,
      className: d(
...
no.displayName = H.Label.displayName;
const wt = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ w(
  H.Item,
  {
    ref: a,
    className: d(
...
ro.displayName = H.Separator.displayName;
function ao({ table: t }) {
    ...
    /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ w(
        Ft,
        {
          ...
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(jt, { placeholder: t.getState().pagination.pageSize }) }),
...
const ye = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const Xt = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function io({
  ...
  var k;
  const [l, c] = P([]), [p, g] = P([]), [v, f] = P({}), [h, C] = P({}), T = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: s, children: T.getHeaderGroups().map((y) => /* @__PURE__ */ r(Ct, { children: y.headers.map((S) => /* @__PURE__ */ r(te, { children: S.isPlaceholder ? void 0 : Jt(S.column.columnDef.header, S.getContext()) }, S.id)) }, y.id)) }),
      /* @__PURE__ */ r(ke, { children: (k = T.getRowModel().rows) != null && k.length ? T.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(y, T),
          "data-state": y.getIsSelected() && "selected",
          children: y.getVisibleCells().map((S) => /* @__PURE__ */ r(Xt, { children: Jt(S.column.columnDef.cell, S.getContext()) }, S.id))
        },
        y.id
      )) : /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Xt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function ei({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ w(pe, { children: [
    /* @__PURE__ */ r(Ze, { asChild: !0, children: /* @__PURE__ */ w(X, { variant: "default", children: [
      /* @__PURE__ */ r(Xr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(de, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ne, { children: n.map((a) => /* @__PURE__ */ w("div", { children: [
      /* @__PURE__ */ r(me, { children: a.label }),
      /* @__PURE__ */ r(An, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(Qe, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(jn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Pt, {})
    ] }, a.label)) })
  ] }) });
}
function ni({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new ca("en", {
    notation: "compact",
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-1 tw-ps-4", children: [
          /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-2", children: a.slice(0, 3).map((l) => /* @__PURE__ */ r("span", { className: "tw-text-xs tw-font-semibold tw-text-foreground", children: l.toUpperCase() }, l)) }),
...
function lo({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const c = new Date(l), p = new Date(o.getTime() - c.getTime()), g = p.getUTCFullYear() - 1970, v = p.getUTCMonth(), f = p.getUTCDate() - 1;
    let h = "";
...
function ri({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    /* @__PURE__ */ r(lo, { versionHistory: o }),
    /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-py-2", children: [
      ...
      /* @__PURE__ */ w("div", { className: "tw-flex tw-items-start tw-justify-between tw-text-xs tw-text-foreground", children: [
        ...
        /* @__PURE__ */ r("div", { className: "tw-flex tw-w-3/4 tw-items-center tw-justify-between tw-text-xs tw-text-foreground", children: /* @__PURE__ */ w("p", { className: "tw-flex tw-flex-col tw-justify-start tw-gap-1", children: [
          ...
          /* @__PURE__ */ r("span", { className: "tw-font-semibold", children: l.join(", ") })
        ] }) })
      ] })
    ] })
  ] }) });
...
const co = St(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", co({ variant: e }), t), ...n })
);
...
function po({
  ...
  const [v, f] = P(!1), h = U(
    (k) => {
      var S;
      const y = (S = t.find((V) => V.label === k)) == null ? void 0 : S.value;
      y && a(
        n.includes(y) ? n.filter((V) => V !== y) : [...n, y]
      );
    },
    [t, n, a]
  ), C = () => i || o, T = q(() => {
    if (!c) return t;
    const k = t.filter((S) => S.starred).sort((S, V) => S.label.localeCompare(V.label)), y = t.filter((S) => !S.starred).sort((S, V) => {
      const I = n.includes(S.value), z = n.includes(V.value);
      return I && !z ? -1 : !I && z ? 1 : S.label.localeCompare(V.label);
    });
    return [...k, ...y];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ w(on, { open: v, onOpenChange: f, children: [
    /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ w(
      X,
      {
        variant: "ghost",
          ...
          return /* @__PURE__ */ w(
            xe,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: k.starred && /* @__PURE__ */ r(Hr, { className: "tw-h-4 tw-w-4" }) }),
...
function uo({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = q(() => {
    const i = [];
    return t.forEach((l) => {
      i.some((c) => Je(c, l)) || i.push(l);
    }), i;
  }, [t]);
  return /* @__PURE__ */ w(ye, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ne, { stickyHeader: !0, children: /* @__PURE__ */ w(Ct, { children: [
    ...
    /* @__PURE__ */ r(ke, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ w(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(Xt, { children: `${M.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
ln.displayName = Ae.Root.displayName;
const Zn = St(
...
mo.displayName = Bn.Root.displayName;
...
tr.displayName = ce.Root.displayName;
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), oi = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ w(X, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ce(e.getIsSorted())
  ] })
}), ho = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ w(X, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Ce(n.getIsSorted())
  ] })
}), si = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ w(X, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ce(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ w(X, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Ce(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ w(tr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        se,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, fo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ci = Object.freeze([
...
function pi({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), v = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), h = yt(n, "%webView_inventory_scope_currentBook%"), C = yt(n, "%webView_inventory_scope_chapter%"), T = yt(n, "%webView_inventory_filter_text%"), k = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, S] = P(!1), [V, I] = P("all"), [z, gt] = P(""), [L, x] = P([]), b = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), B = q(() => {
    if (y) return b;
    const _ = [];
    return b.forEach((Y) => {
      const ot = Y.items[0], rt = _.find(
        (vt) => vt.items[0] === ot
      );
      rt ? (rt.count += Y.count, rt.occurrences = rt.occurrences.concat(Y.occurrences)) : _.push({
        items: [ot],
        count: Y.count,
  ...
  }, [y, b]), R = q(() => go(B, V, z), [B, V, z]), K = q(() => {
    var ot, rt;
    if (!y) return c;
    const _ = (ot = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ot.length;
    if (!_) return c;
    const Y = [];
    for (let vt = 0; vt < _; vt++)
      Y.push(
        ho(
          ((rt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : rt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...Y, ...c];
  ...
  lt(() => {
    R.length === 0 ? x([]) : R.length === 1 && x(R[0].items);
  }, [R]);
  const st = (_, Y) => {
    Y.setRowSelection(() => {
      const ot = {};
      return ot[_.index] = !0, ot;
    }), x(_.original.items);
  }, bt = (_) => {
    if (_ === "book" || _ === "chapter")
      l(_);
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ w("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ w(
        Ft,
        {
          onValueChange: (_) => Tt(_),
          defaultValue: V,
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(jt, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ w(Bt, { children: [
              /* @__PURE__ */ r(wt, { value: "all", children: p }),
              /* @__PURE__ */ r(wt, { value: "approved", children: g }),
              /* @__PURE__ */ r(wt, { value: "unapproved", children: v }),
              /* @__PURE__ */ r(wt, { value: "unknown", children: f })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ w(Ft, { onValueChange: (_) => bt(_), defaultValue: i, children: [
        /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(jt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ w(Bt, { children: [
          /* @__PURE__ */ r(wt, { value: "book", children: h }),
          /* @__PURE__ */ r(wt, { value: "chapter", children: C })
        ] })
      ] }),
      /* @__PURE__ */ r(
        Lt,
      ...
      a && /* @__PURE__ */ w("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(J, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? k })
      ] })
    ] }),
...
const cn = ee.Provider, pn = ee.Root, un = ee.Trigger, _e = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ee.Content,
  {
    ref: a,
    sideOffset: e,
...
const vo = "16rem", xo = "3rem", er = u.createContext(void 0);
function Se() {
...
const nr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, f = u.useCallback(
      (V) => {
        const I = typeof V == "function" ? V(v) : V;
        n ? n(I) : g(I);
      },
      [n, v]
    ), h = u.useCallback(() => f((V) => !V), [f]), C = v ? "expanded" : "collapsed", y = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", S = u.useMemo(
      () => ({
        state: C,
        open: v,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(er.Provider, { value: S, children: /* @__PURE__ */ r(cn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ge = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Gt : "div",
  {
    ref: a,
...
const Ro = St(
  ...
  ({
    ...
    const c = t ? Gt : "button", { state: p } = Se(), g = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Ro({ variant: n, size: a }), s),
        ...i
      }
    );
...
const Vo = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
Oo.displayName = "SidebarMenuSub";
const Mo = u.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Mo.displayName = "SidebarMenuSubItem";
const zo = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Gt : "a",
  {
    ref: s,
...
zo.displayName = "SidebarMenuSubButton";
function Bo({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    rr,
    {
      ...
      children: /* @__PURE__ */ w(or, { children: [
        /* @__PURE__ */ w(Xe, { children: [
          /* @__PURE__ */ r(Ge, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r($e, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([f, h]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => p(f),
              isActive: v(f),
...
const Nt = "scrBook", Io = "scrRef", Vt = "source", Ao = "details", Po = "Scripture Reference", Fo = "Scripture Book", dr = "Type", jo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? M.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === Nt ? Ot(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Ao,
      header: (t == null ? void 0 : t.detailsColumnName) ?? jo,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, _n = (t) => `${Go({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function mi({
  sources: t,
  ...
  const [c, p] = P([]), [g, v] = P([{ id: Nt, desc: !1 }]), [f, h] = P({}), C = q(
  ...
  lt(() => {
    if (l) {
      const x = k.getSelectedRowModel().rowsById, b = Object.keys(x);
      if (b.length === 1) {
  ...
  }, gt = (x, b) => x.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), L = (x, b, B) => {
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ w(
      Ft,
      {
        ...
        children: [
          /* @__PURE__ */ r(zt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(jt, {}) }),
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(to, { children: V.map((x) => /* @__PURE__ */ r(wt, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ w(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: k.getHeaderGroups().map((x) => /* @__PURE__ */ r(Ct, { children: x.headers.filter((b) => b.column.columnDef.header).map((b) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(te, { colSpan: b.colSpan, className: "top-0 tw-sticky", children: b.isPlaceholder ? void 0 : /* @__PURE__ */ w("div", { children: [
      ...
      /* @__PURE__ */ r(ke, { children: k.getRowModel().rows.map((x, b) => {
        const B = W();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            className: d(gt(x, b)),
            onClick: (R) => z(x, R),
            children: x.getVisibleCells().map((R) => {
              if (!(R.getIsPlaceholder() || R.column.columnDef.enableGrouping && !R.getIsGrouped() && (R.column.columnDef.id !== Vt || !n)))
                return /* @__PURE__ */ r(
                  Xt,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ w(
                      X,
                      {
                        variant: "link",
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": At(t) === kt.OT,
                "tw-border-s-purple-200": At(t) === kt.NT,
                "tw-border-s-indigo-200": At(t) === kt.DC,
                "tw-border-s-yellow-200": At(t) === kt.Extra
              }
            ),
            children: o && ((l = o.get(t)) == null ? void 0 : l.localizedName) || M.bookIdToEnglishName(t)
          }
        ),
...
function Yo({
  ...
  const s = mn(e, t).length === 0, i = o["%scripture_section_ot_short%"], l = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], p = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    X,
    {
      variant: "outline",
...
function Uo({
  ...
  const I = q(() => M.allBookIds.filter(
    ...
    (b, B = !1) => {
      ...
      const R = I.findIndex((Z) => Z === S.current), K = I.findIndex((Z) => Z === b);
      if (R === -1 || K === -1) return;
      const [st, bt] = [
        Math.min(R, K),
        Math.max(R, K)
      ], Tt = I.slice(st, bt + 1).map((Z) => Z);
      n(
        e.includes(b) ? e.filter((Z) => !Tt.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, I]
  ), gt = U(
    (b) => {
      const B = mn(I, b).map((R) => R);
      n(
        cr(I, b, e) ? e.filter((R) => !B.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...B])]
      );
    },
    [e, n, I]
  ), L = () => {
  ...
  return /* @__PURE__ */ w("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(kt).map((b) => /* @__PURE__ */ r(
      Yo,
      {
        section: b,
        availableBookIds: I,
    ...
    /* @__PURE__ */ w(on, { open: k, onOpenChange: y, children: [
      /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ w(
        X,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(he, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ w(
        ...
        {
          onKeyDown: (b) => {
            b.key === "Enter" && (V.current = b.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(ge, { placeholder: l }),
            /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(X, { variant: "ghost", size: "sm", onClick: L, children: c }),
              /* @__PURE__ */ r(X, { variant: "ghost", size: "sm", onClick: x, children: p })
            ] }),
            /* @__PURE__ */ w(be, { children: [
              ...
              Object.values(kt).map((b, B) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ w(En, { children: [
                    ...
                    B < Object.values(kt).length - 1 && /* @__PURE__ */ r(qn, {})
                  ] }, b);
              })
            ] })
          ]
...
function fi({
  ...
  ], k = e ? T.filter((y) => e.includes(y.value)) : T;
    ...
    /* @__PURE__ */ w("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        an,
        {
          ...
          children: k.map(({ value: y, label: S, id: V }) => /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(ie, { className: "tw-me-2", value: y, id: V }),
            /* @__PURE__ */ r(J, { htmlFor: V, children: S })
          ] }, V))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(wt, { value: `${c}`, children: i[A(c)] }, `${c}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ w(pn, { children: [
  /* @__PURE__ */ r(un, { asChild: !0, children: "command" in l ? /* @__PURE__ */ w(
    ue,
    {
      onClick: () => {
        a(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(le, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(le, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ w(Ca, { children: [
    /* @__PURE__ */ r(Pn, { children: l.label }),
...
function Tn({
  ...
  return /* @__PURE__ */ w(pe, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, c]) => typeof l == "boolean" || typeof c == "boolean" ? 0 : l.order - c.order).map(([l], c, p) => /* @__PURE__ */ w(En, { children: [
      /* @__PURE__ */ r(An, { children: /* @__PURE__ */ r(cn, { children: ur(e.groups, e.items, l, t) }) }),
      c < p.length - 1 && /* @__PURE__ */ r(Pt, {})
    ] }, l)) })
  ] });
}
function yi({
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-basis-0 tw-flex-row tw-flex-wrap tw-items-start tw-justify-center tw-gap-2 tw-overflow-clip tw-@container/tab-toolbar-center @sm:tw-grow @sm:tw-basis-auto", children: l }),
...
mr.displayName = nt.List.displayName;
...
hr.displayName = nt.List.displayName;
const Ko = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Trigger,
  {
    ref: n,
...
fr.displayName = nt.Content.displayName;
function Ni({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(mr, { children: [
      /* @__PURE__ */ r(hr, { children: t.map((i) => /* @__PURE__ */ r(Ko, { value: i.value, children: i.value }, i.key)) }),
...
gr.displayName = $.Root.displayName;
  ...
  return /* @__PURE__ */ r(
    $.Trigger,
    {
      ...
      className: d(
        ...
        // CUSTOM
        ft({ variant: a.variant, className: t })
        // CUSTOM use context to add variants
      ),
      ...e
    }
...
br.displayName = $.Trigger.displayName;
  ...
  return /* @__PURE__ */ w(
    $.SubTrigger,
    {
      ...
      className: d(
        ...
        e && "tw-pl-8",
        ft({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...a,
...
vr.displayName = $.SubTrigger.displayName;
...
xr.displayName = $.SubContent.displayName;
...
yr.displayName = $.Content.displayName;
  ...
  return /* @__PURE__ */ r(
    $.Item,
    {
      ...
      className: d(
        ...
        e && "tw-pl-8",
        ft({ variant: o.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...n
...
Nr.displayName = $.Item.displayName;
const Wo = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ w(
    $.CheckboxItem,
    {
...
Wo.displayName = $.CheckboxItem.displayName;
const Zo = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ct();
  return /* @__PURE__ */ w(
    $.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(Ue, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Zo.displayName = $.RadioItem.displayName;
...
kr.displayName = $.Separator.displayName;
const Kt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const l = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ w(pn, { children: [
      /* @__PURE__ */ r(un, { asChild: !0, children: "command" in p ? /* @__PURE__ */ w(
        Nr,
        {
          onClick: () => {
            a(p);
    ...
    return l.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(kr, {}, `separator-${s}`)), c;
  });
};
function ts({
  menuData: t,
  ...
  const o = Q(void 0), s = Q(void 0), i = Q(void 0), l = Q(void 0), c = Q(void 0), p = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (k = l.current) == null || k.focus(), Kt(l, [f, h]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Kt(c, [f, h]);
        break;
    }
  }), lt(() => {
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ w(qo, { children: [
...
function _i({
  ...
  const c = es(
    ...
    var k, y, S, V, I, z;
    const T = C !== h ? ((y = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : y[C]) ?? ((V = (S = t[h]) == null ? void 0 : S.uiNames) == null ? void 0 : V.en) : void 0;
    return T ? `${(I = t[h]) == null ? void 0 : I.autonym} (${T})` : (z = t[h]) == null ? void 0 : z.autonym;
  };
  return /* @__PURE__ */ w("div", { className: d("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ w(
      Ft,
      {
        ...
        onOpenChange: (h) => g(h),
        children: [
          /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(jt, {}) }),
          /* @__PURE__ */ r(
            Bt,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(wt, { value: h, children: f(h, e) }, h))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ w(Le, { children: [
      /* @__PURE__ */ r(J, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ w(J, { children: [
        "Currently:",
        " ",
...
function ns({ item: t, createLabel: e, createComplexLabel: n }) {
...
const rs = He(({ className: t, ...e }, n) => /* @__PURE__ */ r(oa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function Ei({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ w("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ w("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(sa, {}) })
    ] }),
...
), os = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(as({ variant: e }), t), ...n }));
...
const is = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
ws.displayName = $t.Root.displayName;
...
ls.displayName = $t.Image.displayName;
...
ds.displayName = $t.Fallback.displayName;
...
const ms = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
ms.displayName = "CardDescription";
...
gs.displayName = "Drawer";
const Di = dt.Trigger, bs = dt.Portal, Vi = dt.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Overlay,
  {
    ref: n,
...
const vs = u.forwardRef(({ className: t, children: e, ...n }, a) => {
...
Ns.displayName = dt.Title.displayName;
...
ks.displayName = dt.Description.displayName;
...
Cs.displayName = Pe.Root.displayName;
function Oi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
_s.displayName = qt.Root.displayName;
...
Ss.displayName = Fe.Root.displayName;
const Mi = nt.Root, Ts = u.forwardRef(({ className: t, ...e }, n) => {
  const a = W();
  return /* @__PURE__ */ r(
    nt.List,
    {
...
Rs.displayName = nt.Trigger.displayName;
...
Es.displayName = nt.Content.displayName;
