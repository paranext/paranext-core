...
import S, { forwardRef as lr, useCallback as Et, useState as it, useRef as ve, useEffect as Kt, useLayoutEffect as da, useMemo as Nt } from "react";
import { History as ll, ChevronRight as di, Check as Sn, Circle as ui, ArrowDownWideNarrow as cl, Clock as dl, Bookmark as ul, X as pi, Search as wo, ChevronsUpDown as tr, FilterIcon as pl, ChevronDown as Fe, ChevronUp as Yr, ArrowLeftIcon as wl, ChevronLeftIcon as fl, ChevronRightIcon as ml, ArrowRightIcon as hl, CircleCheckIcon as gl, CircleXIcon as bl, CircleHelpIcon as vl, ArrowUpIcon as yl, ArrowDownIcon as xl, ArrowUpDownIcon as Nl, Star as kl, PanelLeft as El, ChevronLeft as Tl, LoaderCircle as Sl, Download as Cl, Filter as Ol, User as Rl, Link as _l, CircleHelp as Pl, BookOpen as ua, Shapes as $l, Globe as Il, Ellipsis as Al } from "lucide-react";
...
import { getChaptersForBook as jl, deepEqual as fo, substring as Vl, formatScrRef as Pr, compareScrRefs as Wr, scrRefToBBBCCCVVV as $r, getLocalizeKeyForScrollGroupId as pt, NumberFormat as zl, formatBytes as Ll, getErrorMessage as Fl } from "platform-bible-utils";
...
const dr = ft.Root, bo = ft.Trigger, yc = ft.Group, wh = ft.Portal, fh = ft.Sub, mh = ft.RadioGroup, xc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ y(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
vo.displayName = ft.CheckboxItem.displayName;
const Oi = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ y(
  ft.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(ft.ItemIndicator, { children: /* @__PURE__ */ i(ui, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
function hh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = it(""), [o, a] = it(
    st.bookNumberToId(t.bookNum)
  ), [s, l] = it(t.chapterNum ?? 0), [c, d] = it(
    st.bookNumberToId(t.bookNum)
  ), [u, m] = it(!1), [w, b] = it(u), g = ve(void 0), f = ve(void 0), h = ve(void 0), k = Et(
    (E) => _c(E).filter((B) => {
    ...
    (E) => {
      ...
      // eslint-disable-next-line no-null/no-null
      f.current !== null && f.current.focus(), E.preventDefault()) : m(!0);
    },
    [u]
  ), O = (E) => {
    const { key: B } = E;
    B === "ArrowRight" || B === "ArrowLeft" || B === "ArrowDown" || B === "ArrowUp" || B === "Enter" || (g.current.dispatchEvent(new KeyboardEvent("keydown", { key: B })), g.current.focus());
  }, _ = (E) => {
    const { key: B } = E;
    if (c === o) {
      if (B === "Enter") {
      ...
      s + D <= 0 || s + D > sn(c) ? l(0) : D !== 0 && (l(s + D), E.preventDefault());
    }
  };
  return Kt(() => {
  ...
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ y(dr, { modal: !1, open: u, onOpenChange: T, children: [
    /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(
      sc,
      {
        ...
        handleKeyDown: W,
        handleOnClick: () => {
          a(st.bookNumberToId(t.bookNum)), d(st.bookNumberToId(t.bookNum)), l(t.chapterNum > 0 ? t.chapterNum : 0), m(!0), g.current.focus();
        },
        onFocus: () => {
          C.current = !0;
        },
        ...
        children: [
          ...
          fa.map(
            (E, B) => k(E).length > 0 && /* @__PURE__ */ y("div", { children: [
              /* @__PURE__ */ i(Rn, { className: "tw-font-semibold tw-text-foreground/80", children: Cc[E] }),
              ...
              fa.length - 1 !== B ? /* @__PURE__ */ i(_n, {}) : void 0
            ] }, E)
          )
        ]
      }
...
const No = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ y("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ i(wo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ i(
    _t.Input,
    {
      ref: n,
...
function Zr({
  ...
  const [k, $] = it(!1);
  return /* @__PURE__ */ y(_i, { open: k, onOpenChange: $, ...h, children: [
    ...
    /* @__PURE__ */ i(
      yo,
      {
        ...
        children: /* @__PURE__ */ y(xo, { children: [
          /* @__PURE__ */ i(No, { dir: g, placeholder: u, className: "tw-text-inherit" }),
...
function bh({
  ...
  const u = Ir(d, "%webView_bookSelector_currentBook%"), m = Ir(d, "%webView_bookSelector_choose%"), w = Ir(d, "%webView_bookSelector_chooseBooks%"), [b, g] = it(
    "current book"
    /* CURRENT_BOOK */
  ), f = (h) => {
    g(h), t(h);
...
function Jc({
  ...
  var h;
  const [l, c] = it([]), [d, u] = it([]), [m, w] = it({}), [b, g] = it({}), f = fi({
    data: e,
    columns: t,
    getCoreRowModel: mi(),
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y(Pn, { stickyHeader: a, children: [
      /* @__PURE__ */ i($n, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ i(Wt, { children: k.headers.map(($) => /* @__PURE__ */ i(Vt, { children: $.isPlaceholder ? void 0 : mn($.column.columnDef.header, $.getContext()) }, $.id)) }, k.id)) }),
      /* @__PURE__ */ i(In, { children: (h = f.getRowModel().rows) != null && h.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        Wt,
        {
          onClick: () => s(k, f),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map(($) => /* @__PURE__ */ i(At, { children: mn($.column.columnDef.cell, $.getContext()) }, $.id))
        },
        k.id
...
So.displayName = qr.Root.displayName;
...
const ur = (t) => t === "asc" ? /* @__PURE__ */ i(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), vh = (t) => ({
  accessorKey: "item",
  ...
  return Qc(t).forEach((u) => {
    u.startsWith("\\id") && (s = td(u), l = 0, c = 0), u.startsWith("\\c") && (l = ma(u), c = 0), u.startsWith("\\v") && (c = ma(u), l === 0 && (l = e.chapterNum));
    let m = o.exec(u) ?? void 0;
    for (; m; ) {
      const w = [];
      m.forEach((h) => w.push(h));
      const b = m.index, g = a.find((h) => fo(h.items, w)), f = {
        reference: {
      ...
      if (g)
        g.count += 1, g.occurrences.push(f);
      else {
        const h = {
          items: w,
          count: 1,
...
function kh({
  ...
  const m = ee(n, "%webView_inventory_all%"), w = ee(n, "%webView_inventory_approved%"), b = ee(n, "%webView_inventory_unapproved%"), g = ee(n, "%webView_inventory_unknown%"), f = ee(n, "%webView_inventory_scope_currentBook%"), h = ee(n, "%webView_inventory_scope_chapter%"), k = ee(n, "%webView_inventory_scope_verse%"), $ = ee(n, "%webView_inventory_filter_text%"), C = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [T, v] = it(!1), [P, L] = it("all"), [W, O] = it(""), [_, E] = it([]), B = Nt(() => l ? r instanceof RegExp ? ad(
    l,
    t,
    a,
    s,
        ...
        Ue,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ y(Ee, { children: [
              ...
              /* @__PURE__ */ i(jt, { value: "unapproved", children: b }),
              /* @__PURE__ */ i(jt, { value: "unknown", children: g })
            ] })
          ]
        }
      ),
...
function ha({
  ...
  const [d, u] = it(!1), m = Et(
    (g) => {
      r(
        n.includes(g) ? n.filter((f) => f !== g) : [...n, g]
      );
    },
    [n, r]
  ), w = () => s || o, b = Nt(() => {
    if (!l)
      return t;
    const g = t.filter((h) => h.starred).sort((h, k) => h.label.localeCompare(k.label)), f = t.filter((h) => !h.starred).sort((h, k) => {
      const $ = n.includes(h.value), C = n.includes(k.value);
      return $ && !C ? -1 : !$ && C ? 1 : h.label.localeCompare(k.label);
    });
    return [...g, ...f];
  }, [t, n, l]);
  return /* @__PURE__ */ y(_i, { open: d, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ i(yo, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ y(xo, { children: [
      ...
      /* @__PURE__ */ y(ko, { children: [
        ...
        /* @__PURE__ */ i(Ii, { children: b.map((g) => {
          const f = e ? e(g) : void 0;
          return /* @__PURE__ */ y(
            To,
            {
              value: g.value,
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: g.starred && /* @__PURE__ */ i(kl, { className: "tw-h-4 tw-w-4" }) }),
                /* @__PURE__ */ i("div", { className: "tw-flex-grow", children: g.label }),
                e && /* @__PURE__ */ i("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: f })
              ]
            },
            g.value
          );
...
function Vi({
  ...
  return /* @__PURE__ */ y("div", { className: "tw-relative", children: [
    /* @__PURE__ */ i(wo, { className: "tw-absolute tw-left-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-opacity-50" }),
    /* @__PURE__ */ i(
      Oe,
      {
        className: N(
...
const Hi = S.forwardRef(
  ({
    ...
    const [c, d] = S.useState(t), u = e ?? c, m = S.useCallback(
      ...
      [n, u]
    ), w = S.useCallback(() => m((f) => !f), [m]), b = u ? "expanded" : "collapsed", g = S.useMemo(
      () => ({
        state: b,
        open: u,
        setOpen: m,
    ...
    return /* @__PURE__ */ i(Gi.Provider, { value: g, children: /* @__PURE__ */ i(sd, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const to = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Je : "div",
  {
    ref: r,
...
function Sd({
  ...
  const c = Et(
    ...
    (m) => {
      const w = n.find((b) => b.projectId === m);
  ...
  return /* @__PURE__ */ i(
    Xi,
    {
      ...
      children: /* @__PURE__ */ y(Wi, { children: [
        /* @__PURE__ */ y(Qr, { children: [
          /* @__PURE__ */ i(to, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ i(eo, { children: /* @__PURE__ */ i(qi, { children: e.map((m) => /* @__PURE__ */ i(Ki, { children: /* @__PURE__ */ i(
            Ji,
            {
              className: N(
        ...
        /* @__PURE__ */ y(Qr, { children: [
          /* @__PURE__ */ i(to, { className: "tw-text-sm tw-text-gray-400", children: s }),
          /* @__PURE__ */ i(eo, { className: "tw-pl-3", children: /* @__PURE__ */ i(
            Zr,
            {
...
}, ba = (t) => `${Id({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Sh({
  sources: t,
  ...
  const [d, u] = it([]), [m, w] = it([{ id: se, desc: !1 }]), [b, g] = it({}), f = Nt(
    () => t.flatMap((O) => O.data.map((_) => ({
      ..._,
      source: O.source
    }))),
    [t]
  ...
  Kt(() => {
    if (l) {
      const O = k.getSelectedRowModel().rowsById, _ = Object.keys(O);
      if (_.length === 1) {
        const E = f.find((B) => ba(B) === _[0]) || void 0;
        E && l(E);
      }
    }
  }, [b, f, l, k]);
  const $ = o ?? _d, C = a ?? Zi, T = [
    ...
    !O.getIsGrouped() && !O.getIsSelected() && O.getToggleSelectedHandler()(_);
  }, L = (O, _) => O.getIsGrouped() ? "" : N("banded-row", _ % 2 === 0 ? "even" : "odd"), W = (O, _, E) => {
    if (!((O == null ? void 0 : O.length) === 0 || _.depth < E.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ y(
      Ue,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(Hc, { children: T.map((O) => /* @__PURE__ */ i(jt, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ y(Pn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i($n, { children: k.getHeaderGroups().map((O) => /* @__PURE__ */ i(Wt, { children: O.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(Vt, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ y("div", { children: [
          _.column.getCanGroup() ? /* @__PURE__ */ i(
            wt,
            {
              variant: "ghost",
          ...
          " ",
          mn(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, O.id)) }),
      /* @__PURE__ */ i(In, { children: k.getRowModel().rows.map((O, _) => /* @__PURE__ */ i(
        Wt,
        {
                  ...
                  children: (() => E.getIsGrouped() ? /* @__PURE__ */ y(
                    wt,
                    {
                      ...
                      children: [
                        ...
                        !O.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(di, {}) : /* @__PURE__ */ i(Tl, {})),
                        " ",
                        mn(E.column.columnDef.cell, E.getContext()),
                        " (",
                        O.subRows.length,
                        ")"
                      ]
...
function Bd() {
  ...
  return lt.AsyncMode = c, lt.ConcurrentMode = d, lt.ContextConsumer = l, lt.ContextProvider = s, lt.Element = e, lt.ForwardRef = u, lt.Fragment = r, lt.Lazy = g, lt.Memo = b, lt.Portal = n, lt.Profiler = a, lt.StrictMode = o, lt.Suspense = m, lt.isAsyncMode = function(v) {
    return T(v) || C(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === m || v === w || typeof v == "object" && v !== null && (v.$$typeof === g || v.$$typeof === b || v.$$typeof === s || v.$$typeof === l || v.$$typeof === u || v.$$typeof === h || v.$$typeof === k || v.$$typeof === $ || v.$$typeof === f);
  }, lt.typeOf = C, lt;
}
var ct = {};
/** @license React v16.13.1
...
function jd() {
  return ya || (ya = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(I) {
      ...
      I === r || I === d || I === a || I === o || I === m || I === w || typeof I == "object" && I !== null && (I.$$typeof === g || I.$$typeof === b || I.$$typeof === s || I.$$typeof === l || I.$$typeof === u || I.$$typeof === h || I.$$typeof === k || I.$$typeof === $ || I.$$typeof === f);
    }
    function T(I) {
    ...
    var v = c, P = d, L = l, W = s, O = e, _ = u, E = r, B = g, D = b, Z = n, J = a, X = o, tt = m, ot = !1;
    function rt(I) {
      return ot || (ot = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), x(I) || T(I) === c;
    }
    function x(I) {
      return T(I) === d;
    }
    ...
    ct.AsyncMode = v, ct.ConcurrentMode = P, ct.ContextConsumer = L, ct.ContextProvider = W, ct.Element = O, ct.ForwardRef = _, ct.Fragment = E, ct.Lazy = B, ct.Memo = D, ct.Portal = Z, ct.Profiler = J, ct.StrictMode = X, ct.Suspense = tt, ct.isAsyncMode = rt, ct.isConcurrentMode = x, ct.isContextConsumer = R, ct.isContextProvider = G, ct.isElement = H, ct.isForwardRef = V, ct.isFragment = z, ct.isLazy = q, ct.isMemo = K, ct.isPortal = Y, ct.isProfiler = M, ct.isStrictMode = F, ct.isSuspense = Q, ct.isValidElementType = C, ct.typeOf = T;
  }()), ct;
}
var xa;
function es() {
  return xa || (xa = 1, process.env.NODE_ENV === "production" ? Hn.exports = Bd() : Hn.exports = jd()), Hn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ld() {
  if (Sa)
    return Lr;
  Sa = 1;
  var t = es(), e = Vd(), n = _o(), r = ns(), o = zd(), a = function() {
  };
...
function qd() {
  ...
  return dt.ContextConsumer = s, dt.ContextProvider = a, dt.Element = t, dt.ForwardRef = c, dt.Fragment = n, dt.Lazy = w, dt.Memo = m, dt.Portal = e, dt.Profiler = o, dt.StrictMode = r, dt.Suspense = d, dt.SuspenseList = u, dt.isAsyncMode = function() {
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === d || h === u || h === b || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === m || h.$$typeof === a || h.$$typeof === s || h.$$typeof === c || h.$$typeof === g || h.getModuleId !== void 0);
  }, dt.typeOf = f, dt;
}
var ut = {};
/**
...
function Kd() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), m = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), g = !1, f = !1, h = !1, k = !1, $ = !1, C;
    C = Symbol.for("react.module.reference");
    function T(U) {
      return !!(typeof U == "string" || typeof U == "function" || U === n || U === o || $ || U === r || U === d || U === u || k || U === b || g || f || h || typeof U == "object" && U !== null && (U.$$typeof === w || U.$$typeof === m || U.$$typeof === a || U.$$typeof === s || U.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = s, L = a, W = t, O = c, _ = n, E = w, B = m, D = e, Z = o, J = r, X = d, tt = u, ot = !1, rt = !1;
    function x(U) {
    ...
    ut.ContextConsumer = P, ut.ContextProvider = L, ut.Element = W, ut.ForwardRef = O, ut.Fragment = _, ut.Lazy = E, ut.Memo = B, ut.Portal = D, ut.Profiler = Z, ut.StrictMode = J, ut.Suspense = X, ut.SuspenseList = tt, ut.isAsyncMode = x, ut.isConcurrentMode = R, ut.isContextConsumer = G, ut.isContextProvider = H, ut.isElement = V, ut.isForwardRef = z, ut.isFragment = q, ut.isLazy = K, ut.isMemo = Y, ut.isPortal = M, ut.isProfiler = F, ut.isStrictMode = Q, ut.isSuspense = I, ut.isSuspenseList = vt, ut.isValidElementType = T, ut.typeOf = v;
  }()), ut;
}
process.env.NODE_ENV === "production" ? ro.exports = qd() : ro.exports = Kd();
var _a = ro.exports;
...
function ds() {
  ...
  function n() {
    return e.current ? (ao = !0, wu.start(100, () => {
      ao = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function Tu(t) {
  ...
  function d(w, b) {
    const g = s.indexOf(b);
    return `@media (min-width:${typeof e[w] == "number" ? e[w] : w}${n}) and (max-width:${(g !== -1 && typeof e[s[g]] == "number" ? e[s[g]] : b) - r / 100}${n})`;
  }
  function u(w) {
...
function bp() {
  function t(n, r, o, a) {
    ...
    const w = mr(o, d) || {};
    return m ? m(s) : re(s, r, (g) => {
      let f = or(w, u, g);
      return g === f && typeof g == "string" && (f = or(w, u, `${n}${g === "default" ? "" : Zt(g)}`, g)), c === !1 ? f : {
        [c]: f
      };
    });
  }
...
function Do(t = {}, ...e) {
  ...
  return d.applyStyles = vp, d = e.reduce((u, m) => ne(u, m), d), d.unstable_sxConfig = A({}, Ao, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return Mo({
      sx: m,
      theme: this
    });
...
const Op = Do(), ja = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Xn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function _p(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: w = Rp(ja(d))
    } = l, b = kt(l, Tp), g = u !== void 0 ? u : (
    ...
    const $ = Yl(s, A({
      shouldForwardProp: k,
      label: h
    }, b)), C = (v) => typeof v == "function" && v.__emotion_real !== v || be(v) ? (P) => Zn(v, A({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let E;
        c && (E = `${c}${Zt(d || "")}`), E === void 0 && (E = `Styled(${Qd(s)})`), _.displayName = E;
      }
...
function ys(t, e) {
  return t = Se(t), e = Bo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, kr(t);
}
function Mp(t, e) {
...
const jp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, je = Xp, Yp = ["mode", "contrastThreshold", "tonalOffset"], La = {
...
function tw(t) {
  ...
  function m(f) {
    const h = za(f, Gr.text.primary) >= n ? Gr.text.primary : La.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = za(f, h);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Fa(f, "light", $, r), Fa(f, "dark", C, r), f.contrastText || (f.contrastText = m(f.main)), f;
  }, b = {
    dark: Gr,
    light: La
  };
  return process.env.NODE_ENV !== "production" && (b[e] || console.error(`MUI: The palette mode \`${e}\` is not supported.`)), ne(A({
...
function rw(t, e) {
  ...
  const b = o / 14, g = m || ((k) => `${k / d * b}rem`), f = (k, $, C, T, v) => A({
    fontFamily: r,
    fontWeight: k,
    fontSize: g($),
...
function gw(t = {}, ...e) {
  ...
  if (d = ne(d, s), d = e.reduce((u, m) => ne(u, m), d), process.env.NODE_ENV !== "production") {
    const u = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], m = (w, b) => {
      ...
      for (g in w) {
        const f = w[g];
        if (u.indexOf(g) !== -1 && Object.keys(f).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const h = fr("", g);
            console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${g}\` internal state.`, "You can not override it like this: ", JSON.stringify(w, null, 2), "", `Instead, you need to use the '&.${h}' syntax:`, JSON.stringify({
              root: {
                [`&.${h}`]: f
              }
...
const Nw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], kw = (t) => {
  ...
  return {
    ...
    color: (m = (w = (t.vars || t).palette) == null || (w = w[e.color]) == null ? void 0 : w.main) != null ? m : {
      action: (b = (t.vars || t).palette) == null || (b = b.action) == null ? void 0 : b.active,
  ...
  const r = zo({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, b = kt(r, Nw), g = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", f = A({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ y(Ew, A({
    ...
    ownerState: f,
    children: [g ? o.props.children : o, m ? /* @__PURE__ */ i("title", {
      children: m
    }) : null]
  }));
});
...
var Ns = Oo.default = void 0, _w = Rw(Ow()), Pw = sl;
Ns = Oo.default = (0, _w.default)(/* @__PURE__ */ (0, Pw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function $w(t) {
...
function jw(t) {
  ...
  if (!e) {
    const b = ye(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), g = A({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = A({}, n, o, r);
    return b.length > 0 && (f.className = b), Object.keys(g).length > 0 && (f.style = g), {
      props: f,
      internalRef: void 0
    };
  }
  const s = Dw(A({}, o, r)), l = Wa(r), c = Wa(o), d = e(s), u = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = A({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = A({}, d, n, c, l);
...
var Ot = "top", Ft = "bottom", Ut = "right", Rt = "left", Fo = "auto", jn = [Ot, Ft, Ut, Rt], Ye = "start", En = "end", Hw = "clippingParents", Ts = "viewport", cn = "popper", Xw = "reference", qa = /* @__PURE__ */ jn.reduce(function(t, e) {
  return t.concat([e + "-" + Ye, e + "-" + En]);
}, []), Ss = /* @__PURE__ */ [].concat(jn, [Fo]).reduce(function(t, e) {
...
function Vn(t) {
  for (var e = Dt(t), n = Ka(t); n && sf(n) && oe(n).position === "static"; )
    n = Ka(n);
...
function uf(t) {
  ...
  if (!(!a || !s)) {
    var m = df(o.padding, n), w = Go(a), b = c === "y" ? Ot : Rt, g = c === "y" ? Ft : Ut, f = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], k = Vn(a), $ = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - h / 2, T = m[b], v = $ - w[u] - m[g], P = $ / 2 - w[u] / 2 + C, L = bn(T, P, v), W = c;
    n.modifiersData[r] = (e = {}, e[W] = L, e.centerOffset = L - P, e);
  }
}
function pf(t) {
...
function Ja(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, s = t.offsets, l = t.position, c = t.gpuAcceleration, d = t.adaptive, u = t.roundOffsets, m = t.isFixed, w = s.x, b = w === void 0 ? 0 : w, g = s.y, f = g === void 0 ? 0 : g, h = typeof u == "function" ? u({
    x: b,
    y: f
  }) : {
    x: b,
  ...
  b = h.x, f = h.y;
  var k = s.hasOwnProperty("x"), $ = s.hasOwnProperty("y"), C = Rt, T = Ot, v = window;
  if (d) {
    var P = Vn(n), L = "clientHeight", W = "clientWidth";
    if (P === Dt(n) && (P = de(n), oe(P).position !== "static" && l === "absolute" && (L = "scrollHeight", W = "scrollWidth")), P = P, o === Ot || (o === Rt || o === Ut) && a === En) {
      T = Ft;
    ...
    if (o === Rt || (o === Ot || o === Ft) && a === En) {
      C = Ut;
      var _ = m && P === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        P[W]
      );
      b -= _ - r.width, b *= c ? 1 : -1;
  ...
  if (b = B.x, f = B.y, c) {
    var D;
    return Object.assign({}, E, (D = {}, D[T] = $ ? "0" : "", D[C] = k ? "0" : "", D.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + f + "px)" : "translate3d(" + b + "px, " + f + "px, 0)", D));
  }
  return Object.assign({}, E, (e = {}, e[T] = $ ? f + "px" : "", e[C] = k ? b + "px" : "", e.transform = "", e));
}
function hf(t) {
...
function Yo(t) {
  return qe(de(t)).left + Xo(t).scrollLeft;
}
function Nf(t, e) {
...
function $s(t) {
  return ["html", "body", "#document"].indexOf(Qt(t)) >= 0 ? t.ownerDocument.body : Lt(t) && Wo(t) ? t : $s(Er(t));
}
function vn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = $s(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Dt(r), s = o ? [a].concat(a.visualViewport || [], Wo(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function Qa(t, e, n) {
  return e === Ts ? so(Nf(t, n)) : Ce(e) ? Ef(e, n) : so(kf(de(t)));
}
function Tf(t) {
...
function Tn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Hw : l, d = n.rootBoundary, u = d === void 0 ? Ts : d, m = n.elementContext, w = m === void 0 ? cn : m, b = n.altBoundary, g = b === void 0 ? !1 : b, f = n.padding, h = f === void 0 ? 0 : f, k = _s(typeof h != "number" ? h : Ps(h, jn)), $ = w === cn ? Xw : cn, C = t.rects.popper, T = t.elements[g ? $ : w], v = Sf(Ce(T) ? T : T.contextElement || de(t.elements.popper), c, u, s), P = qe(t.elements.reference), L = Is({
    reference: P,
    element: C,
    strategy: "absolute",
    placement: o
  }), W = so(Object.assign({}, C, L)), O = w === cn ? W : P, _ = {
...
function Cf(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ss : c, u = Ke(r), m = u ? l ? qa : qa.filter(function(g) {
    return Ke(g) === u;
  }) : jn, w = m.filter(function(g) {
    return d.indexOf(g) >= 0;
  });
  w.length === 0 && (w = m);
  var b = w.reduce(function(g, f) {
    return g[f] = Tn(t, {
      placement: f,
      boundary: o,
      rootBoundary: a,
  ...
  return Object.keys(b).sort(function(g, f) {
    return b[g] - b[f];
  });
}
function Of(t) {
...
function Rf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, m = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, g = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, h = e.options.placement, k = qt(h), $ = k === h, C = c || ($ || !g ? [Qn(h)] : Of(h)), T = [h].concat(C).reduce(function(V, z) {
      return V.concat(qt(z) === Fo ? Cf(e, {
        placement: z,
        boundary: u,
        rootBoundary: m,
        padding: d,
    ...
    }, []), v = e.rects.reference, P = e.rects.popper, L = /* @__PURE__ */ new Map(), W = !0, O = T[0], _ = 0; _ < T.length; _++) {
      var E = T[_], B = qt(E), D = Ke(E) === Ye, Z = [Ot, Ft].indexOf(B) >= 0, J = Z ? "width" : "height", X = Tn(e, {
        placement: E,
        boundary: u,
        rootBoundary: m,
        altBoundary: w,
    ...
    if (W)
      for (var x = g ? 3 : 1, R = function(z) {
        var q = T.find(function(K) {
          var Y = L.get(K);
          if (Y)
...
function Pf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = Tn(e, {
    ...
    altBoundary: !0
  }), c = ti(s, r), d = ti(l, o, a), u = ei(c), m = ei(d);
  e.modifiersData[n] = {
...
function Vf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, m = n.padding, w = n.tether, b = w === void 0 ? !0 : w, g = n.tetherOffset, f = g === void 0 ? 0 : g, h = Tn(e, {
    boundary: c,
    rootBoundary: d,
    padding: m,
    altBoundary: u
  }), k = qt(e.placement), $ = Ke(e.placement), C = !$, T = Ho(k), v = jf(T), P = e.modifiersData.popperOffsets, L = e.rects.reference, W = e.rects.popper, O = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, _ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
    ...
    mainAxis: 0,
    altAxis: 0
  }, O), E = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, B = {
    x: 0,
    y: 0
  };
  if (P) {
    if (a) {
      var D, Z = T === "y" ? Ot : Rt, J = T === "y" ? Ft : Ut, X = T === "y" ? "height" : "width", tt = P[T], ot = tt + h[Z], rt = tt - h[J], x = b ? -W[X] / 2 : 0, R = $ === Ye ? L[X] : W[X], G = $ === Ye ? -W[X] : -L[X], H = e.elements.arrow, V = b && H ? Go(H) : {
        width: 0,
        height: 0
      }, z = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Rs(), q = z[Z], K = z[J], Y = bn(0, L[X], V[X]), M = C ? L[X] / 2 - x - Y - q - _.mainAxis : R - Y - q - _.mainAxis, F = C ? -L[X] / 2 + x + Y + K + _.mainAxis : G + Y + K + _.mainAxis, Q = e.elements.arrow && Vn(e.elements.arrow), I = Q ? T === "y" ? Q.clientTop || 0 : Q.clientLeft || 0 : 0, vt = (D = E == null ? void 0 : E[T]) != null ? D : 0, U = tt + M - vt - I, xt = tt + F - vt, Ht = bn(b ? ir(ot, U) : ot, tt, b ? xe(rt, xt) : rt);
      P[T] = Ht, B[T] = Ht - tt;
    }
    if (l) {
      var ue, St = T === "x" ? Ot : Rt, zn = T === "x" ? Ft : Ut, Xt = P[v], _e = v === "y" ? "height" : "width", pe = Xt + h[St], Pe = Xt - h[zn], $e = [Ot, Rt].indexOf(k) !== -1, Ie = (ue = E == null ? void 0 : E[v]) != null ? ue : 0, we = $e ? pe : Xt - L[_e] - W[_e] - Ie + _.altAxis, tn = $e ? Xt + L[_e] + W[_e] - Ie - _.altAxis : Pe, Ln = b && $e ? cf(we, Xt, tn) : bn(b ? we : pe, Xt, b ? tn : Pe);
      P[v] = Ln, B[v] = Ln - Xt;
    }
    e.modifiersData[r] = B;
  }
...
function Gf(t, e, n) {
  ...
  Wo(a)) && (l = Ff(e)), Lt(e) ? (c = qe(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Yo(a))), {
  ...
  return function(l, c, d) {
    ...
    var u = {
      ...
      setOptions: function(k) {
        var $ = typeof k == "function" ? k(u.options) : k;
        f(), u.options = Object.assign({}, a, u.options, $), u.scrollParents = {
      ...
      forceUpdate: function() {
        if (!w) {
          var k = u.elements, $ = k.reference, C = k.popper;
          if (ri($, C)) {
            u.rects = {
              reference: Gf($, Vn(C), u.options.strategy === "fixed"),
              popper: Go(C)
            ...
            for (var T = 0; T < u.orderedModifiers.length; T++) {
              ...
              var v = u.orderedModifiers[T], P = v.fn, L = v.options, W = L === void 0 ? {} : L, O = v.name;
    ...
    function g() {
      u.orderedModifiers.forEach(function(h) {
        var k = h.name, $ = h.options, C = $ === void 0 ? {} : $, T = h.effect;
        if (typeof T == "function") {
          var v = T({
            state: u,
            name: k,
...
const rm = () => Po({
  ...
  } = e, h = kt(e, Qf), k = j.useRef(null), $ = Te(k, n), C = j.useRef(null), T = Te(C, w), v = j.useRef(T);
  Xe(() => {
    v.current = T;
  }, [T]), j.useImperativeHandle(w, () => C.current, []);
  const P = em(u, s), [L, W] = j.useState(P), [O, _] = j.useState(sr(o));
  j.useEffect(() => {
...
`));
  ...
  f !== null && (E.TransitionProps = f);
  const B = rm(), D = (r = g.root) != null ? r : "div", Z = zw({
    elementType: D,
  ...
  if (a)
    ...
    const _ = sr(r);
    L = _ && Tr(_) ? nr(_).body : nr(null).body;
  }
...
var lm = function(e) {
  return e.scrollTop;
}, fn = "unmounted", he = "exited", ge = "entering", ze = "entered", co = "exiting", ie = /* @__PURE__ */ function(t) {
  im(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== ge && s !== ze && (a = ge) : (s === ge || s === ze) && (a = co);
    }
...
const pm = {
...
}, Hr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), qo = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = kt(e, um), $ = pn(), C = j.useRef(), T = Ds(), v = j.useRef(null), P = Te(v, a.ref, n), L = (J) => (X) => {
    if (J) {
      const tt = v.current;
    ...
    let x;
    f === "auto" ? (x = T.transitions.getAutoHeightDuration(J.clientHeight), C.current = x) : x = tt, J.style.transition = [T.transitions.create("opacity", {
      duration: x,
      delay: ot
    ...
    let rt;
    f === "auto" ? (rt = T.transitions.getAutoHeightDuration(J.clientHeight), C.current = rt) : rt = X, J.style.transition = [T.transitions.create("opacity", {
      duration: rt,
      delay: tt
    }), T.transitions.create("transform", {
      ...
      easing: ot
    })].join(","), J.style.opacity = 0, J.style.transform = uo(0.75), m && m(J);
  }), D = L(w);
  return /* @__PURE__ */ i(h, A({
    ...
    onExiting: E,
    addEndListener: (J) => {
      f === "auto" && $.start(C.current || 0, J), r && r(v.current, J);
    },
...
qo.muiSupportAuto = !0;
const ii = qo, wm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], fm = Bn(Ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = bs(), a = zo({
    ...
    slots: C,
    slotProps: T
  } = a, v = kt(a, wm), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, L = A({
    anchorEl: s,
    container: u,
    disablePortal: m,
    keepMounted: w,
...
const zs = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, u, m, w, b, g, f, h, k, $, C, T, v;
  const P = zo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    slots: F = {},
    title: Q,
    TransitionComponent: I = ii,
    TransitionProps: vt
  } = P, U = kt(P, gm), xt = /* @__PURE__ */ j.isValidElement(W) ? W : /* @__PURE__ */ i("span", {
    children: W
  }), Ht = Ds(), ue = Ht.direction === "rtl", [St, zn] = j.useState(), [Xt, _e] = j.useState(null), pe = j.useRef(!1), Pe = Z || rt, $e = pn(), Ie = pn(), we = pn(), tn = pn(), [Ln, Ko] = cs({
    controlled: z,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Jo = (et) => {
    ...
    (et) => {
      si.start(800 + R, () => {
        Wn = !1;
      }), Ko(!1), H && te && H(et), $e.start(Ht.transitions.duration.shortest, () => {
        pe.current = !1;
      });
    }
  ), Cr = (et) => {
    ...
    qs(et), Qo.current === !1 && (ta(!1), Zo(et));
  }, na = (et) => {
    St || zn(et.currentTarget), Ks(et), Qo.current === !0 && (ta(!0), Cr(et));
  }, ra = (et) => {
    pe.current = !0;
    const $t = xt.props;
    $t.onTouchStart && $t.onTouchStart(et);
  }, oa = Cr, aa = Zo, Zs = (et) => {
    ra(et), we.clear(), $e.clear(), Fn(), en.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", tn.start(ot, () => {
  ...
  E ? (nn.title = !te && Rr && !D ? Q : null, nn["aria-describedby"] = te ? Sr : null) : (nn["aria-label"] = Rr ? Q : null, nn["aria-labelledby"] = te && !Rr ? Sr : null);
...
`));
  ...
  const rn = {};
  J || (Bt.onTouchStart = Zs, Bt.onTouchEnd = Qs), D || (Bt.onMouseOver = qn(oa, Bt.onMouseOver), Bt.onMouseLeave = qn(aa, Bt.onMouseLeave), Pe || (rn.onMouseOver = oa, rn.onMouseLeave = aa)), B || (Bt.onFocus = qn(na, Bt.onFocus), Bt.onBlur = qn(ea, Bt.onBlur), Pe || (rn.onFocus = na, rn.onBlur = ea)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const nl = j.useMemo(() => {
    var et;
    let $t = [{
    ...
    touch: pe.current
  }), _r = vm(on), ia = (r = (o = F.popper) != null ? o : O.Popper) != null ? r : ym, sa = (a = (s = (l = F.transition) != null ? l : O.Transition) != null ? s : I) != null ? a : ii, la = (c = (d = F.tooltip) != null ? d : O.Tooltip) != null ? c : xm, ca = (u = (m = F.arrow) != null ? m : O.Arrow) != null ? u : Nm, rl = wn(ia, A({}, Y, (w = M.popper) != null ? w : _.popper, {
    className: ye(_r.popper, Y == null ? void 0 : Y.className, (b = (g = M.popper) != null ? g : _.popper) == null ? void 0 : b.className)
  }), on), ol = wn(sa, A({}, vt, (f = M.transition) != null ? f : _.transition), on), al = wn(la, A({}, (h = M.tooltip) != null ? h : _.tooltip, {
    className: ye(_r.tooltip, (k = ($ = M.tooltip) != null ? $ : _.tooltip) == null ? void 0 : k.className)
  }), on), il = wn(ca, A({}, (C = M.arrow) != null ? C : _.arrow, {
    className: ye(_r.arrow, (T = (v = M.arrow) != null ? v : _.arrow) == null ? void 0 : T.className)
  }), on);
  return /* @__PURE__ */ y(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(xt, Bt), /* @__PURE__ */ i(ia, A({
      as: K ?? Vs,
      placement: q,
      anchorEl: rt ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ y(la, A({}, al, {
          children: [Q, L ? /* @__PURE__ */ i(ca, A({}, il, {
            ref: _e
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Kl,
    {
      ...
      children: n ? /* @__PURE__ */ y(ae, { children: [
        ...
        m ? /* @__PURE__ */ i(vi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(Ns, {}) }) : li(s, n, !1)
      ] }) : h
    }
  );
...
function Us(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: s } = Nt(() => {
    const u = o && o.length > 0 ? o : (
      ...
      Fs(e).filter((g) => !("menuItem" in g.group))
    ), m = Object.values(u).sort(
      (g, f) => (g.group.order || 0) - (f.group.order || 0)
    ), w = [];
    m.forEach((g) => {
      Tm(g.id, e.items).forEach(
...
function Pm({
  ...
  const [c, d] = it(!1), [u, m] = it(!1), w = Et(() => {
    ...
    T.stopPropagation(), d((v) => {
      const P = !v;
      return P && T.shiftKey ? m(!0) : P || m(!1), P;
    });
  }, []), g = Et(
    (T) => (w(), r(T)),
    [r, w]
  ...
  Kt(() => {
    if (c) {
      ...
      if (T) {
        const v = T.getBoundingClientRect(), P = window.scrollY, L = window.scrollX, W = v.top + P + T.clientHeight, O = v.left + L;
        h({ top: W, left: O });
      }
    }
  }, [c, o]);
...
function Mh({ className: t, variant: e, ...n }) {
...
const jm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ y(
  un.Root,
  {
    ref: n,
    className: N(
...
jm.displayName = un.Root.displayName;
...
Vm.displayName = Kr.Root.displayName;
const Bh = Pt.Root, zm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Pt.List,
  {
    ref: n,
    className: N(
...
zm.displayName = Pt.List.displayName;
...
Lm.displayName = Pt.Trigger.displayName;
...
function Uh({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ y(dr, { children: [
    /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(Um, {}) }),
    /* @__PURE__ */ i(On, { children: e.map((n) => /* @__PURE__ */ y("div", { children: [
      /* @__PURE__ */ i(Rn, { children: n.label }),
      /* @__PURE__ */ i(yc, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(vo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(Oi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(_n, {})
    ] }, n.label)) })
  ] }) });
}
...
const Yh = [
  ...
  const n = Array.from(
    new Set(
      t.map((o) => ({ value: o.bestLanguageName, label: o.bestLanguageName }))
    )
  ), r = new Set(
    e.concat(
  ...
  return n.sort((o, a) => {
    const s = r.has(o.label), l = r.has(a.label);
    return s && l ? o.label.localeCompare(a.label) : s ? -1 : l ? 1 : o.label.localeCompare(a.label);
  });
}, ci = (t, e, n) => /* @__PURE__ */ i(wt, { variant: "outline", onClick: () => n(t.dblEntryUid, "install"), children: e }), Ym = (t, e, n, r, o, a) => e.includes(t.dblEntryUid) ? /* @__PURE__ */ i(wt, { variant: "outline", children: /* @__PURE__ */ i(Re, { className: "tw-h-5 tw-py-[1px]" }) }) : t.installed ? t.updateAvailable ? ci(t, r, a) : /* @__PURE__ */ i(Tt, { className: "tw-my-2 tw-flex tw-h-6 tw-items-center", children: o }) : ci(t, n, a);
function Wh({
  localizedStrings: t,
  resources: e,
  ...
  const u = t["%resources_action%"], m = t["%resources_dialog_subtitle%"], w = t["%resources_dialog_title%"], b = t["%resources_filterInput%"], g = t["%resources_fullName%"], f = t["%resources_get%"], h = t["%resources_installed%"], k = t["%resources_language%"], $ = t["%resources_languages%"], C = t["%resources_loadingResources%"], T = t["%resources_noResults%"], v = t["%resources_open%"], P = t["%resources_remove%"], L = t["%resources_size%"], W = t["%resources_type%"], O = t["%resources_types%"], _ = t["%resources_type_DBL%"], E = t["%resources_type_ER%"], B = t["%resources_type_SLR%"], D = t["%resources_type_XR%"], Z = t["%resources_type_unknown%"], J = t["%resources_update%"], [X, tt] = it([]), ot = (M, F) => {
    if (!c || !d)
      return;
    const Q = {
      dblEntryUid: M,
  ...
  const [rt, x] = it(""), R = Nt(() => e.filter((M) => {
    ...
    { value: "DBLResource", label: _ },
    { value: "EnhancedResource", label: E },
    { value: "SourceLanguageResource", label: B },
    { value: "XmlResource", label: D }
  ], [_, E, B, D]), H = Nt(() => R.filter((M) => r.includes(M.type)), [R, r]);
  Kt(() => {
    a.length === 0 && s(
    ...
    /* @__PURE__ */ i(Ws, { children: n || !e ? /* @__PURE__ */ y("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-2", children: [
      ...
      /* @__PURE__ */ y("div", { className: "tw-mb-1 tw-flex tw-gap-1", children: [
        /* @__PURE__ */ y("div", { className: "tw-relative", children: [
          ...
          /* @__PURE__ */ i(wo, { className: "tw-absolute tw-right-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-text-muted-foreground" })
        ] }),
        /* @__PURE__ */ i(
          ha,
          {
      ...
      K.length === 0 ? /* @__PURE__ */ i("div", { className: "tw-m-4 tw-flex tw-w-full tw-justify-center", children: /* @__PURE__ */ i(Tt, { children: T }) }) : /* @__PURE__ */ y(Pn, { stickyHeader: !0, children: [
          ...
          return /* @__PURE__ */ y(Wt, { children: [
            ...
            /* @__PURE__ */ i(At, { children: /* @__PURE__ */ y("div", { className: "tw-flex tw-justify-between", children: [
              ...
              M.installed && /* @__PURE__ */ y(dr, { children: [
                /* @__PURE__ */ i(bo, { asChild: !0, children: /* @__PURE__ */ i(wt, { variant: "ghost", children: /* @__PURE__ */ i(Al, { className: "tw-w-4" }) }) }),
...
function qh({
  ...
  const d = Wm(
    ...
    o && o(g), r && r([g, ...n.filter((f) => f !== g)]), a && n.find((f) => f === g) && a([...n.filter((f) => f !== g)]), m(!1);
  }, b = (g, f) => {
    var k, $, C, T, v, P;
    const h = f !== g ? (($ = (k = t[g]) == null ? void 0 : k.uiNames) == null ? void 0 : $[f]) ?? ((T = (C = t[g]) == null ? void 0 : C.uiNames) == null ? void 0 : T.en) : void 0;
    return h ? `${(v = t[g]) == null ? void 0 : v.autonym} (${h})` : (P = t[g]) == null ? void 0 : P.autonym;
  };
  return /* @__PURE__ */ y("div", { className: N("pr-twp tw-max-w-sm", l), children: [
        ...
        children: [
          ...
          /* @__PURE__ */ i(
            Ee,
            {
              className: "tw-z-[250]",
              dir: c,
              children: Object.keys(t).map((g) => /* @__PURE__ */ i(jt, { value: g, children: b(g, e) }, g))
            }
          )
        ]
      }
    ...
    e !== "en" && /* @__PURE__ */ y(ae, { children: [
      ...
      /* @__PURE__ */ i("div", { className: "tw-ms-3", children: /* @__PURE__ */ y(Tt, { children: [
        "Currently:",
        " ",
        (n == null ? void 0 : n.length) > 0 ? `${n.map((g) => b(g, e)).join(", ")}` : `default (${t.en.autonym})`
      ] }) })
    ] })
  ] });
}
...
export {
  ...
  Vh as EnableButton,
  Yh as FILTERABLE_RESOURCE_LIST_STRING_KEYS,
  Um as FilterButton,
  Uh as FilterDropdown,
  Wh as FilterableResourceList,
  Xh as Footer,
  Om as GridMenu,
