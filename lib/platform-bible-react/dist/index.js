...
import p, { forwardRef as Lt, createContext as Un, useContext as qn, useCallback as tt, useState as O, useRef as K, useEffect as wt, useLayoutEffect as Xe, useMemo as W, Fragment as Jn } from "react";
...
import { ChevronRight as fe, Check as kt, Circle as be, X as ve, Search as qe, ChevronsUpDown as Je, FilterIcon as Qn, ChevronDown as Yt, ChevronUp as tr, ArrowLeftIcon as er, ChevronLeftIcon as nr, ChevronRightIcon as rr, ArrowRightIcon as ar, LoaderCircle as or, Download as sr, Filter as ir, User as wr, Link as lr, CircleHelp as dr, Star as cr, CircleCheckIcon as pr, CircleXIcon as ur, CircleHelpIcon as mr, ArrowUpIcon as hr, ArrowDownIcon as gr, ArrowUpDownIcon as fr, PanelLeft as br, PanelRight as vr, ScrollText as xr, ChevronLeft as yr, MenuIcon as Nr, Menu as kr, EllipsisVertical as Cr } from "lucide-react";
import { formatScrRef as Dt, getChaptersForBook as Sr, NumberFormat as Rr, formatBytes as Tr, deepEqual as xe, isString as re, compareScrRefs as le, scrRefToBBBCCCVVV as ae, getLocalizeKeyForScrollGroupId as D } from "platform-bible-utils";
...
import { useReactTable as We, getFilteredRowModel as _r, getSortedRowModel as Ze, getPaginationRowModel as zr, getCoreRowModel as Qe, flexRender as It, getGroupedRowModel as Er, getExpandedRowModel as Mr } from "@tanstack/react-table";
...
const Ne = V.Trigger, nn = V.Group, Or = V.Portal, jr = V.Sub, ts = V.RadioGroup;
function Ut({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(ye.Provider, { value: n, children: /* @__PURE__ */ r(V.Root, { ...e }) });
}
const rn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ d(
    V.SubTrigger,
    {
...
const ke = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = F(), s = et();
  return /* @__PURE__ */ r(
    V.Item,
    {
...
ke.displayName = V.Item.displayName;
const Ce = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ d(
    V.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(V.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Ce.displayName = V.CheckboxItem.displayName;
const on = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ d(
    V.RadioItem,
    {
...
qt.displayName = V.Label.displayName;
...
const _e = j.allBookIds.filter((t) => !j.isObsolete(j.bookIdToNumber(t))), ea = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], na = 96, ra = [
...
], zt = (t) => Sr(j.bookIdToNumber(t));
function aa() {
  return _e.map((e) => j.bookIdToEnglishName(e));
}
function oa(t) {
...
function sa(t) {
  ...
  if (oa(e))
    return _e.find((a) => j.bookIdToEnglishName(a) === e);
}
function ns({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = F(), [s, i] = O(""), [w, c] = O(t.book), [u, g] = O(t.chapterNum ?? 0), [b, h] = O(t.book), [m, f] = O(!1), [k, C] = O(m), y = K(void 0), x = K(void 0), E = K(void 0), $ = tt(
    (S) => {
      const M = a ? a() : _e;
      return {
        OT: M.filter((P) => j.isBookOT(P)),
        NT: M.filter((P) => j.isBookNT(P)),
        DC: M.filter((P) => j.isBookDC(P))
      }[S].filter((P) => {
        const v = j.bookIdToEnglishName(P).toLowerCase(), _ = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (S, M, P, v) => {
      if (g(t.book !== S ? 1 : t.chapterNum), M || zt(S) === -1) {
        e({
          book: S,
          chapterNum: P ?? 1,
          verseNum: v ?? 1
    ...
    ra.forEach((S) => {
      const M = S.exec(s);
      if (M) {
        const [P, v = void 0, _ = void 0] = M.slice(1), Z = sa(P);
        (j.isBookIdValid(P) || Z) && N(
          Z ?? P,
          !0,
          v ? parseInt(v, 10) : 1,
          _ ? parseInt(_, 10) : 1
    ...
    const { key: M } = S;
    M === "ArrowRight" || M === "ArrowLeft" || M === "ArrowDown" || M === "ArrowUp" || M === "Enter" || y.current.dispatchEvent(new KeyboardEvent("keydown", { key: M }));
  }, ne = (S) => {
    const { key: M } = S;
    if (b === w) {
      if (M === "Enter") {
      ...
      const P = M === "ArrowRight" && !o || M === "ArrowRight" && o === "ltr" || M === "ArrowLeft" && o === "rtl", v = M === "ArrowLeft" && !o || M === "ArrowLeft" && o === "ltr" || M === "ArrowRight" && o === "rtl";
      let _ = 0;
      if (P)
        if (u < zt(b))
          _ = 1;
      ...
      else M === "ArrowDown" ? _ = 6 : M === "ArrowUp" && (_ = -6);
      u + _ <= 0 || u + _ > zt(b) ? g(0) : _ !== 0 && (g(u + _), S.preventDefault());
    }
  };
  return wt(() => {
    ...
    const S = setTimeout(() => {
      if (k && x.current && E.current && !s) {
        const P = E.current.offsetTop - na;
        x.current.scrollTo({ top: P, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(S);
    };
  }, [k, s]), /* @__PURE__ */ d(Ut, { modal: !1, open: m, onOpenChange: ct, children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          c(t.book), h(t.book), g(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), i(Dt(t, "English")), y.current.focus();
        },
        onFocus: () => {
          dt.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      jt,
      {
        ...
        ref: x,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((S, M) => {
          const P = $(S);
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(qt, { className: "tw-font-semibold tw-text-foreground/80", children: ea[S] }),
            P.map((v) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Qr,
              {
                bookId: v,
            ...
            $e.length - 1 !== M ? /* @__PURE__ */ r(Xt, {}) : void 0
          ] }, S);
        }) })
      }
    )
...
const ia = lt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ct : "button", { className: l(ia({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const wa = lt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ke.Root, { ref: n, className: l("pr-twp", wa(), t), ...e }));
...
un.displayName = Vt.Root.displayName;
const pe = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Vt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(be, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
pe.displayName = Vt.Item.displayName;
const mn = Bt.Root, hn = Bt.Trigger, ze = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
const la = rt.Portal, gn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: l(
...
const Ee = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  H,
  {
    ref: n,
    className: l(
...
Me.displayName = H.Input.displayName;
...
De.displayName = H.List.displayName;
const Ie = p.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
function ue({
  ...
  const [C, y] = O(!1);
  return /* @__PURE__ */ d(mn, { open: C, onOpenChange: y, ...k, children: [
    ...
    /* @__PURE__ */ r(
      ze,
      {
        ...
        children: /* @__PURE__ */ d(Ee, { children: [
          ...
          /* @__PURE__ */ r(De, { children: e.map((x) => /* @__PURE__ */ d(
            Ve,
            {
              value: w(x),
              onSelect: () => {
...
function as({
  ...
  const g = oe(u, "%webView_bookSelector_currentBook%"), b = oe(u, "%webView_bookSelector_choose%"), h = oe(u, "%webView_bookSelector_chooseBooks%"), [m, f] = O(
    "current book"
    /* CURRENT_BOOK */
  ), k = (C) => {
    f(C), t(C);
...
function fa({ table: t }) {
  return /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(Zn, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const vt = X.Root, ba = X.Group, xt = X.Value, va = lt(
  ...
  return /* @__PURE__ */ d(
    X.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(X.Icon, { asChild: !0, children: /* @__PURE__ */ r(Yt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
gt.displayName = X.Trigger.displayName;
...
ft.displayName = X.Content.displayName;
...
const Q = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  X.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(kt, { className: "tw-h-4 tw-w-4" }) }) }),
...
const Jt = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        At(i, '[tabindex]:not([tabindex="-1"])').forEach((g) => {
...
const it = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a, ...o }, s) => {
...
function Ta({
  ...
  var C;
  const [w, c] = O([]), [u, g] = O([]), [b, h] = O({}), [m, f] = O({}), k = We({
    data: e,
    columns: t,
    getCoreRowModel: Qe(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Jt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Kt, { stickyHeader: s, children: k.getHeaderGroups().map((y) => /* @__PURE__ */ r(it, { children: y.headers.map((x) => /* @__PURE__ */ r(Pt, { children: x.isPlaceholder ? void 0 : It(x.column.columnDef.header, x.getContext()) }, x.id)) }, y.id)) }),
      /* @__PURE__ */ r(Wt, { children: (C = k.getRowModel().rows) != null && C.length ? k.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        it,
        {
          onClick: () => i(y, k),
          "data-state": y.getIsSelected() && "selected",
          children: y.getVisibleCells().map((x) => /* @__PURE__ */ r(yt, { children: It(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        y.id
...
const Ft = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(or, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function os({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Ft, { size: 15 }) : /* @__PURE__ */ d(Nt, { children: [
...
function ss({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
      ...
      children: t ? /* @__PURE__ */ d(Nt, { children: [
        /* @__PURE__ */ r(Ft, { size: 15, className: "tw-mr-1 tw-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function is({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      ...a,
      children: t ? /* @__PURE__ */ d(Nt, { children: [
        /* @__PURE__ */ r(Ft, { size: 15, className: "tw-mr-1 tw-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
}
function ws({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function ls({ id: t, markdown: e, className: n, anchorTarget: a }) {
  const o = W(
    () => ({
      overrides: {
        a: {
...
function ds({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(_a, {}) }),
    /* @__PURE__ */ r(jt, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(qt, { children: n.label }),
      /* @__PURE__ */ r(nn, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Ce, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(on, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Xt, {})
    ] }, n.label)) })
  ] }) });
}
function cs({ id: t, message: e }) {
...
function ps({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new Rr("en", {
    notation: "compact",
...
function Da({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ d(mn, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(hn, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ze, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Ee, { children: [
      ...
      /* @__PURE__ */ d(De, { children: [
        ...
        /* @__PURE__ */ r(fn, { children: k.map((C) => {
...
function Ia({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = W(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((c) => xe(c, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ d(Jt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Kt, { stickyHeader: !0, children: /* @__PURE__ */ d(it, { children: [
      /* @__PURE__ */ r(Pt, { children: a }),
      /* @__PURE__ */ r(Pt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(Wt, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      it,
      {
        onClick: () => {
          e(i.reference);
...
Be.displayName = de.Root.displayName;
const yn = lt(
...
kn.displayName = Ht.Root.displayName;
...
const Zt = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), hs = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-center", children: [
      /* @__PURE__ */ d(kn, { value: i, variant: "outline", type: "single", children: [
        /* @__PURE__ */ r(
          Gt,
          {
            onClick: (c) => {
  ...
  return e ? e[1] : "";
}, Aa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ys = Object.freeze([
...
function Ns({
  ...
  const u = ot(n, "%webView_inventory_all%"), g = ot(n, "%webView_inventory_approved%"), b = ot(n, "%webView_inventory_unapproved%"), h = ot(n, "%webView_inventory_unknown%"), m = ot(n, "%webView_inventory_scope_currentBook%"), f = ot(n, "%webView_inventory_scope_chapter%"), k = ot(n, "%webView_inventory_filter_text%"), C = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, x] = O(!1), [E, $] = O("all"), [q, dt] = O(""), [ct, N] = O([]), T = W(() => t.length === 0 ? [] : Oa(t, o, s), [t, o, s]), L = W(() => {
    if (y) return T;
    const v = [];
    return T.forEach((_) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(vt, { onValueChange: (v) => S(v), defaultValue: i, children: [
...
const Pe = Ot.Provider, Oe = Ot.Root, je = Ot.Trigger, Qt = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Ot.Content,
  {
    ref: a,
    sideOffset: e,
...
const ja = "16rem", Xa = "3rem", Cn = p.createContext(void 0);
function te() {
...
const Sn = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: x, children: /* @__PURE__ */ r(Pe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Fa = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = te();
  return /* @__PURE__ */ d(
    I,
    {
...
const $a = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt,
  {
    ref: n,
    "data-sidebar": "input",
...
const Ua = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Ct : "button",
  {
    ref: a,
  ...
  ({
    ...
    const c = t ? Ct : "button", { state: u } = te(), g = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: l(qa({ variant: n, size: a }), s),
        ...i
      }
    );
...
const Ja = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Ct : "button",
  {
    ref: o,
...
const Wa = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const to = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ct : "a",
  {
    ref: s,
    ...
    Rn,
    {
      ...
      children: /* @__PURE__ */ d(_n, { children: [
        /* @__PURE__ */ d(me, { children: [
          ...
          /* @__PURE__ */ r(ge, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(En, { children: /* @__PURE__ */ r(
            Mn,
            {
              onClick: () => u(h),
              isActive: b(h),
...
const st = "scrBook", no = "scrRef", mt = "source", ro = "details", ao = "Scripture Reference", oo = "Scripture Book", In = "Type", so = "Details";
function io(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? j.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === st ? Dt(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => Dt(a.start),
      id: no,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : Dt(o.start);
      },
      sortingFn: (a, o) => le(a.original.start, o.original.start),
      enableGrouping: !1
    },
...
function Cs({
  ...
  const [c, u] = O([]), [g, b] = O([{ id: st, desc: !1 }]), [h, m] = O({}), f = W(
  ...
  wt(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const L = f.find((A) => He(A) === T[0]) || void 0;
        L && w(L);
      }
    }
  }, [h, f, w, C]);
  const y = o ?? oo, x = s ?? In, E = [
  ...
  }, dt = (N, T) => N.getIsGrouped() ? "" : l("banded-row", T % 2 === 0 ? "even" : "odd"), ct = (N, T, L) => {
    ...
    !e && /* @__PURE__ */ d(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ft, { position: "item-aligned", children: /* @__PURE__ */ r(ba, { children: E.map((N) => /* @__PURE__ */ r(Q, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Jt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Kt, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(it, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(Wt, { children: C.getRowModel().rows.map((N, T) => {
        const L = F();
        return /* @__PURE__ */ r(
          it,
          {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          It(A.column.columnDef.cell, A.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          ft,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(Q, { value: `${c}`, children: i[D(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Bn = (t, e, n, a) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ d(Oe, { children: [
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    ke,
    {
      onClick: () => {
        a(w);
      ...
      children: [
        w.iconPathBefore && /* @__PURE__ */ r($t, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
        w.label,
        w.iconPathAfter && /* @__PURE__ */ r($t, { icon: w.iconPathAfter, menuLabel: w.label })
      ]
    },
    `dropdown-menu-item-${w.label}-${w.command}`
  ) : /* @__PURE__ */ d(jr, { children: [
    /* @__PURE__ */ r(rn, { children: w.label }),
    /* @__PURE__ */ r(Or, { children: /* @__PURE__ */ r(an, { children: Bn(
      t,
      e,
      Vn(t, w.id),
      a
  ...
  w.tooltip && /* @__PURE__ */ r(Qt, { children: w.tooltip })
...
function Ue({
  ...
  return /* @__PURE__ */ d(Ut, { variant: s, children: [
    /* @__PURE__ */ r(Ne, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(I, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Nr, {}) }) }),
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ d(Jn, { children: [
      /* @__PURE__ */ r(nn, { children: /* @__PURE__ */ r(Pe, { children: Bn(e.groups, e.items, w, t) }) }),
...
)), On = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
    className: l(
...
function Es({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(An, { children: [
      /* @__PURE__ */ r(Pn, { children: t.map((i) => /* @__PURE__ */ r(lo, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(On, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function co({ ...t }) {
...
const jn = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  ...
  return /* @__PURE__ */ r(ye.Provider, { value: o, children: /* @__PURE__ */ r(
    B.Root,
    {
      ref: a,
      className: l(
...
const mo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    B.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(be, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const ho = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  B.Label,
  {
    ref: a,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
const Et = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, g) => u.order - g.order).map((u) => /* @__PURE__ */ d(Oe, { children: [
...
function go({
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var f, k, C, y;
    g.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = s.current) == null || f.focus(), Et(s, [h, m]);
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Et(i, [h, m]);
        break;
      case "alt+n":
        (C = w.current) == null || C.focus(), Et(w, [h, m]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Et(c, [h, m]);
        break;
    }
  }), wt(() => {
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(co, { children: [
      /* @__PURE__ */ r(Xn, { ref: u(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        $n,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Pe, { children: Hn(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
), xo = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(vo({ variant: e }), t), ...n }));
...
const No = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
ko.displayName = St.Root.displayName;
...
Co.displayName = St.Image.displayName;
...
So.displayName = St.Fallback.displayName;
...
const zo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Do = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ d(
    Mt.Root,
    {
...
const Io = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    ce.Root,
    {
...
Io.displayName = ce.Root.displayName;
const Ps = U.Root, Vo = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Vo.displayName = U.List.displayName;
...
Ao.displayName = U.Content.displayName;
const Os = (t, e) => {
  wt(() => {
    if (!t) return () => {
    };
...
export {
  ...
  Ae as Separator,
  Rs as SettingsList,
  _s as SettingsListHeader,
  Ts as SettingsListItem,
  ...
  l as cn,
  xs as getBookIdFromUSFM,
  bs as getLinesFromUSFM,
  vs as getNumberFromUSFM,
  Aa as getStatusForItem,
  Ms as getToolbarOSReservedSpaceClassName,
  gs as inventoryCountColumn,
  hs as inventoryItemColumn,
  fs as inventoryStatusColumn,
