...
function $m({
  ...
  const [c, d] = ue(!1), p = $e(
    (g) => {
      t.includes(g) && t.length === 1 || n(
        t.includes(g) ? t.filter((v) => v !== g) : [...t, g]
      );
    },
    [t, n]
  ), h = () => t.length === 0 ? r : i && t.length === e.length ? "All types" : o || `${t.length} ${r.toLowerCase().split(" ")[1]}`, w = Te(() => {
    if (!a)
      return e;
    const g = e.filter((f) => f.starred).sort((f, m) => f.label.localeCompare(m.label)), v = e.filter((f) => !f.starred).sort((f, m) => {
      const N = t.includes(f.value), I = t.includes(m.value);
  ...
  return /* @__PURE__ */ x(bi, { open: c, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ s(so, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      /* @__PURE__ */ s(co, { placeholder: `Search ${r.toLowerCase()}...` }),
      /* @__PURE__ */ x(po, { children: [
        /* @__PURE__ */ s(uo, { children: "No item found." }),
        /* @__PURE__ */ s(xi, { children: w.map((g) => /* @__PURE__ */ x(
          wo,
          {
            value: g.value,
            onSelect: p,
            ...
            children: [
              /* @__PURE__ */ s("div", { className: "w-4", children: /* @__PURE__ */ s(
                xn,
                {
                  className: T(
                    "tw-h-4 tw-w-4",
                    t.includes(g.value) ? "tw-opacity-100" : "tw-opacity-0"
                  )
                }
              ) }),
              /* @__PURE__ */ s("div", { className: "tw-w-4", children: g.starred && /* @__PURE__ */ s(Zs, { className: "tw-h-4 tw-w-4 tw-text-yellow-500" }) }),
              g.label
            ]
          },
          g.value
