      ...
      /* @__PURE__ */ r(Kt, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ c(
          $t,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(ld, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
