...
import { c as b, g as $e, a as Vr, C as er, L as Kn, t as ks, u as tn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, r as se, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Je, p as De, q as Ts, s as Gn, P as lr, v as Dr, w as dr, y as wr, z as Da, E as Ma, F as Eo, G as ur, H as Oa, J as $t, R as To, K as xa, M as io, N as so, O as co, Q as lo, S as qn, U as da, V as So, W as jr, X as Ur, Y as yr, Z as Ss, _ as ir, $ as Ze, a0 as Ue, a1 as Ye, a2 as kr, a3 as Ro, a4 as Do, a5 as ya, a6 as Mo, a7 as Wn, a8 as Rs, a9 as Ds, aa as Ms, ab as wo, ac as Yn, ad as Ia, ae as Os, af as Xn, ag as Is, ah as zs, ai as Ps, aj as en, ak as As, al as $s, am as Vs, an as Zn, ao as Jn, ap as Oo, aq as Ls, ar as Qn, as as Ka, at as rn, au as Ha, av as Bs, aw as Fs, ax as js, ay as Us, az as Ks, aA as Hs, aB as Gs, aC as qs, aD as Ws, aE as Io, aF as zo, aG as Ys, aH as Xs } from "./resizable-SDHmUfye.js";
import { aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as Ff, b3 as jf, b4 as Uf, b5 as Kf, b6 as Hf, b7 as Gf, b8 as qf, b9 as Wf, ba as Yf, bb as Xf, bc as Zf, bd as Jf, be as Qf, bf as tm, bg as em, bh as rm, bi as am } from "./resizable-SDHmUfye.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as Kt } from "@sillsdev/scripture";
import { Check as Qe, Clock as an, ChevronsLeft as on, ChevronsRight as nn, ChevronUp as ti, ChevronDown as sr, ArrowLeft as Zs, ArrowRight as Js, BoldIcon as Qs, ItalicIcon as tc, X as ei, AtSign as ri, Pencil as ec, Trash2 as rc, Undo2 as ac, ArrowUp as ai, MoreHorizontal as oc, MailOpen as nc, Mail as ic, FilterIcon as sc, ArrowLeftIcon as cc, ChevronLeftIcon as lc, ChevronRightIcon as dc, ArrowRightIcon as wc, Copy as oi, Filter as uc, User as pc, Link as hc, CircleHelp as gc, Undo as fc, Redo as mc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as vc, AlertCircle as uo, CircleCheckIcon as bc, CircleXIcon as xc, CircleHelpIcon as yc, ArrowUpIcon as kc, ArrowDownIcon as _c, ScrollText as Nc, ChevronRight as Cc, ChevronLeft as Ec, ChevronsUpDown as Tc, MenuIcon as Sc, Menu as Rc, EllipsisVertical as Dc, MoreVertical as Mc } from "lucide-react";
import { Section as At, compareScrRefs as ka, getChaptersForBook as Oc, formatScrRef as Ve, formatReplacementString as Xe, getSectionForBook as wa, formatRelativeDate as Ic, sanitizeHtml as Po, NumberFormat as ci, formatBytes as zc, getCurrentLocale as Pc, usfmMarkers as ua, isPlatformError as Ac, ABORTED as $c, getErrorMessage as Vc, getFormatCallerFunction as Lc, deepEqual as Bc, isString as sn, scrRefToBBBCCCVVV as Ga, defaultScrRef as qa, formatScrRefRange as Fc, getLocalizeKeyForScrollGroupId as cn, formatReplacementStringToArray as ln, collectUsjMarkers as jc } from "platform-bible-utils";
import ee, { useRef as L, useMemo as P, createContext as qr, useContext as za, useEffect as Z, useState as _, useCallback as V, useId as _a, useImperativeHandle as Uc, useLayoutEffect as re, Fragment as Wr, Component as Kc, createElement as dn, Suspense as Hc, forwardRef as Ao, memo as li } from "react";
...
import { createEditor as ui, $getRoot as tr, $createParagraphNode as Yr, $getSelection as ce, HISTORY_MERGE_TAG as $o, ParagraphNode as pi, TextNode as hi, $getPreviousSelection as rl, $isRangeSelection as Se, $caretFromPoint as al, $getSiblingCaret as gi, $getChildCaret as ol, $getAdjacentChildCaret as nl, $isChildCaret as il, $normalizeCaret as sl, $setSelectionFromCaretRange as cl, $getCollapsedCaretRange as ll, $getCaretInDirection as wn, $splitAtPointCaretNext as dl, $isTextPointCaret as wl, $findMatchingParent as fi, $isElementNode as Kr, mergeRegister as Be, getDOMTextNode as ul, isHTMLElement as pl, CLEAR_EDITOR_COMMAND as mi, COMMAND_PRIORITY_EDITOR as Vo, shallowMergeConfig as hl, defineExtension as ge, safeCast as pr, createState as gl, FORMAT_TEXT_COMMAND as vi, $isNodeSelection as bi, COMMAND_PRIORITY_LOW as xi, RootNode as fl, LineBreakNode as ml, TabNode as vl, $isEditorState as bl, createCommand as xl, CLICK_COMMAND as yl, isDOMNode as kl, $getNodeFromDOMNode as _l, $createNodeSelection as Nl, $setSelection as Cl, $getEditor as El, DecoratorNode as po, $getState as Tl, toggleTextFormatType as un, TEXT_TYPE_TO_FORMAT as Sl, $setState as Rl, addClassNamesToElement as yi, $create as Dl, $getNodeByKey as Ml, removeClassNamesFromElement as Ol, KEY_TAB_COMMAND as Il, $isBlockElementNode as zl, $createRangeSelection as Pl, $normalizeSelection__EXPERIMENTAL as Al, OUTDENT_CONTENT_COMMAND as $l, INDENT_CONTENT_COMMAND as pn, INSERT_TAB_COMMAND as Vl, COMMAND_PRIORITY_CRITICAL as Lo, $isDecoratorNode as Ll, $isParagraphNode as Bl, $isTextNode as ho, SELECTION_CHANGE_COMMAND as ki, $insertNodes as Fl } from "lexical";
...
import { Avatar as Bo, Select as ae, Checkbox as hn, Slot as Xr, Tabs as ke, Menubar as Me, ContextMenu as Ht, Progress as gn, Slider as oa, Switch as fn } from "radix-ui";
...
function gd({
  ...
  return /* @__PURE__ */ u(Fe, { open: C, onOpenChange: B, modal: !1, children: [
...
function Ya({
  ...
  const B = De(), U = dd(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [q, $] = _(
    void 0
  ), [at, ut] = _(void 0), [dt, tt] = _(!1), [pt, kt] = _(!1), [mt, Rt] = _(!1), [Ft, Pt] = _(!1), fe = L(null), we = L(!1), _t = L(void 0), Nt = L(void 0), Et = L(void 0), oe = L(void 0), me = L({}), Dt = L({}), Mt = V(
    (v) => {
      e(v), d && d(v);
    },
    [e, d]
    ...
    () => yd(ne, _e),
    [ne, _e]
  ), Zt = Xt.has(t.book), ze = P(() => Y.trim() ? vo(
  ...
  const It = V(() => {
    ...
    (v) => {
      S(v), v && (ot("books"), X(void 0), $(void 0), ut(void 0), z(""), Pt(!1), Rt(!1), kt(Zt));
    },
    [Zt]
  );
  Z(() => {
  ...
  const { otLong: Tt, ntLong: qt, dcLong: ar, extraLong: Ke } = {
    ...
    (v) => {
      ...
      if (!(!!G && !!((Zo = _t.current) != null && Zo.contains(G))) && (G != null && G.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        ...
        const pe = Bt[Bt.length - 1], Jt = v.shiftKey ? Bt[0] : pe;
        document.activeElement === Jt && (v.preventDefault(), v.stopPropagation(), (v.shiftKey ? pe : Bt[0]).focus());
        return;
      }
      const { isLetter: jt, isDigit: Wt } = mn(v.key);
      ...
      if (k === "books" && !Ft && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const Bt = G === Nt.current ? Nt.current : void 0, pe = (Bt == null ? void 0 : Bt.selectionStart) ?? 0, Jt = (Bt == null ? void 0 : Bt.selectionEnd) ?? 0, xe = B === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!Bt && (pe !== Jt || (xe ? pe > 0 : Jt < Bt.value.length))) return;
      }
      ...
      const St = (() => {
        ...
        if (pe) {
          const { bookId: Jt, chapterNum: xe } = pe;
          return !Jt || !xe || !w ? void 0 : {
            max: w(Jt, xe),
            current: na(D) ?? 0,
            buildValue: (Or) => pa(Jt, xe, Or),
            refs: Dt,
        ...
        if (k === "chapters" || k === "books" && M && qe(M.book) > 1) {
          const Jt = k === "chapters" ? I : M == null ? void 0 : M.book;
          return Jt ? {
            max: qe(Jt),
            current: Ar(D) ?? 0,
    ...
    const { isLetter: G, isDigit: lt } = mn(v.key);
    (G || lt) && (v.preventDefault(), z((St) => St + v.key), (Wt = Nt.current) == null || Wt.focus(), tt(!1));
  }, []);
  re(() => {
    const v = setTimeout(() => {
      if (O && k === "books" && Et.current && oe.current) {
        const G = Et.current, lt = oe.current, jt = lt.offsetTop, Wt = G.clientHeight, St = lt.clientHeight, ie = jt - Wt / 2 + St / 2;
        G.scrollTo({
          top: Math.max(0, ie),
          behavior: "smooth"
        }), W(mo(t.book));
  ...
  return re(() => {
    ...
    const { max: v, initial: G, parse: lt, buildValue: jt } = be, Wt = (St) => {
      const ie = lt(St);
      return ie !== void 0 && ie >= 1 && ie <= v && St === jt(ie) ? ie : void 0;
    };
    if (Lt.current !== rt) {
      Lt.current = rt;
      const St = jt(Math.min(Math.max(G, 1), v));
      ue.current = St, W(St);
      return;
    }
    if (Wt(D) !== void 0) {
    ...
    W(
      Wt(ue.current) !== void 0 ? ue.current : jt(Math.min(Math.max(G, 1), v))
    );
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Ma, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: Q.map(
                      ({ onClick: v, disabled: G, title: lt, icon: jt, group: Wt }, St) => {
                        const ie = /* @__PURE__ */ a(
                          et,
                          {
                            variant: "ghost",
                ...
                /* @__PURE__ */ u(bt, { children: [
                  /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(
                    et,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Jr,
                      children: B === "ltr" ? /* @__PURE__ */ a(Zs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
                  ...
                  !M && Object.entries(ze).map(([v, G]) => {
                    if (G.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Je, { heading: Pe(v), children: G.map((lt) => /* @__PURE__ */ a(
                          Si,
                          {
                            bookId: lt,
                            onSelect: (jt) => K(jt),
                            ...
                            localizedBookNames: s,
                            disabled: Ba(lt),
                            dimmedReason: Xt.has(lt) ? ja : void 0,
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rd = zi ? re : Z, sa = { tag: $o };
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Fd = Pi && "documentMode" in document ? document.documentMode : null;
!(!Pi || !("InputEvent" in window) || Fd) && "getTargetRanges" in new window.InputEvent("input");
function Ee(t) {
  return `${t}px`;
}
    ...
    w.read(() => {
      ...
      if ((B || U) && N !== null && A !== null) {
        const O = function(S, D, W, Y, z, k, ot) {
          ...
          return I.setStart(...kn(D, W, Y)), I.setEnd(...kn(z, k, ot)), I;
        }(t, h, m, N, f, E, A);
        d(), d = Ud(t, O, e);
      }
...
function Yd(t, e, r) {
  ...
  return wl(o) && Na(283), o.insert(t.isInline() ? Yr().append(t) : t), wn(gi(t.getLatest(), "next"), e.direction);
}
function Xd(t) {
  const e = ce();
  if (!Se(e)) return !1;
...
const cw = ge({ config: pr({ setOptions: En, updateOptions: En }), init: ({ $initialEditorState: t = sw }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [fl, hi, ml, vl, pi] }), Tn = Symbol.for("@lexical/extension/LexicalBuilder");
function Sn() {
}
function lw(t) {
  throw t;
...
const dw = /* @__PURE__ */ new Set(), Rn = ge({ build(t, e, r) {
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
...
function $w() {
  const { activeEditor: t } = Zi(), [e, r] = _([]), o = V((n) => {
    if (Se(n) || ql(n)) {
      const s = [];
      On.forEach(({ format: i }) => {
...
const jw = "verseText", vh = Object.freeze([
        ...
        /* @__PURE__ */ u(
          We,
          {
            onClick: (z) => {
              ...
              g(k ? Fw(t.contents) : Uw), i == null || i(!0);
            },
            children: [
...
const Xw = {
  ...
  const dt = V(
    (T) => {
      ...
      ut.current = ct, at || I(ct), k == null || k(l, zn(ct) ? void 0 : ct);
    },
    [at, k, l]
  ), tt = V(
    (T, ct) => {
    ...
    [X.commentEdits, dt]
  ), [pt, kt] = _(), mt = n, [Rt, Ft] = _(!1), [Pt, fe] = _(!1), [we, _t] = _(!1), [Nt, Et] = _(!1), [oe, me] = _(!1), [Dt, Mt] = _(A), [ne, _e] = _(!1), ve = L(void 0), [Ie, le] = _(/* @__PURE__ */ new Map());
  Z(() => {
    let T = !0;
    return (async () => {
  ...
  ze.current = l, Z(() => () => {
    var ct;
    const { current: T } = ut;
    T.assignedUser !== void 0 && T.assignedUser === Xt.current && T.editorState === void 0 && !$r(T.commentEdits) && ((ct = Zt.current) == null || ct.call(Zt, ze.current, void 0));
  }, []);
  const M = P(
  ...
  const F = P(
    ...
    () => it === 1 ? F.singleReply : Xe(F.multipleReplies, { count: it }),
    [it, F]
  ), ar = P(
    () => Tt === 1 ? F.singleReply : Xe(F.multipleReplies, { count: Tt }),
    [Tt, F]
  );
  Z(() => {
    !n && Gt && vt && fe(!1);
  ...
  const Ne = !Nt || !g || g.length === 0 || !g.includes(c), hr = !de(q) && ($ === void 0 || $ === pt), Zr = /* @__PURE__ */ a(
    Pn,
    {
      comment: It,
      localizedStrings: o,
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            Tt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (T) => {
                  T.stopPropagation(), Ft(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (T) => {
                  (T.key === "Enter" || T.key === " ") && (T.preventDefault(), T.stopPropagation(), Ft(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Ur, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            E !== !1 && (!Gt || de(q)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Wo(T) && (T.preventDefault(), T.stopPropagation(), (de(q) || $ !== void 0 && $ !== pt) && Ke());
                },
                onKeyDown: (T) => {
...
), Jw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), ma = (t) => Jw(Po(t));
function va({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
const Rh = "data-platform-content-zoom-root", nu = Ao(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(
      "div",
      {
...
nu.displayName = "ContentZoomRoot";
function iu({ table: t }) {
...
function Ph({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
...
const bu = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(gt, { children: [
...
function xu({
  ...
  return /* @__PURE__ */ u(Fe, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: bu(t, o, e) }) }) }),
...
const yu = (t, e) => t === "f" ? /* @__PURE__ */ u(gt, { children: [
  /* @__PURE__ */ a(ii, {}),
  " ",
...
function _u({
  ...
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: yu(t, r) }) }) }),
...
function Lh({
  ...
  const [g, E] = _("generated"), [y, C] = _("generated"), [N, A] = _("*"), [B, U] = _("*"), [O, S] = _("f"), [D, W] = _(!1), [Y, z] = _(!0), [k, ot] = _(!1), I = L(!1), X = L(""), [q, $] = _(!1), [at, ut] = _(), [dt, tt] = _(), [pt, kt] = _(), [mt, Rt] = _(), Ft = L(null), Pt = L(
    void 0
  ...
  const Et = V(() => {
    var H, Q, F;
    const R = (H = f.current) == null ? void 0 : H.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), J = (F = (Q = f.current) == null ? void 0 : Q.ownerDocument.getSelection()) == null ? void 0 : F.anchorNode;
  ...
  Z(() => {
    ...
    if (H && Ir("note", H)) {
      ...
      let st = "custom";
      nt === go ? st = "generated" : nt === fo ? st = "hidden" : nt && (A(nt), U(nt)), E(st), C(st), S(((F = H.insert.note) == null ? void 0 : F.style) ?? "f"), R = setTimeout(() => {
        var it, vt, Ct;
  ...
  const oe = V(
    ...
    (R, K) => {
      var Q, F, nt;
      const J = (F = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : F.at(0);
  ...
  const _e = () => {
    ...
    if (K && Ir("note", K)) {
      ...
      const st = (F = (Q = K.insert.note) == null ? void 0 : Q.contents) == null ? void 0 : F.ops;
      O !== "x" && R === "x" ? st == null || st.forEach((it) => Du(it)) : O === "x" && R !== "x" && (st == null || st.forEach((it) => Mu(it))), (nt = h.current) == null || nt.applyUpdate([K, { delete: 1 }]);
    }
  }, le = (R) => {
    ...
    (R) => {
      ...
      if (K && Ir("note", K)) {
        ...
        const st = (Q = K.insert.note) == null ? void 0 : Q.style, it = (nt = (F = K.insert.note) == null ? void 0 : F.contents) == null ? void 0 : nt.ops;
        if (st || W(!1), W(
    ...
    (R, K, J) => {
      ...
      zs({
        ...
        clearSessionIfCurrent: (F) => en(Pt, F),
        ...
        applyItem: (F) => {
          var nt;
          return (nt = h.current) == null ? void 0 : nt.applyMarkerMenuSelection(F, {
            trigger: "backslash",
        ...
        onShowError: (F) => {
          (!Ac(F) || F.code !== $c) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Vc(F)}`
          );
        }
      });
    },
  ...
  Z(() => {
    ...
    const R = (K) => {
      ...
      const H = (F = h.current) == null ? void 0 : F.getSelection();
      H && (we.current = H);
    };
    ...
    if (((J = _t.view) == null ? void 0 : J.markerMode) === "editable") {
      const H = (F) => {
        ...
        if (F.key === "Enter" && !Et()) {
          F.preventDefault(), F.stopPropagation(), (it = h.current) == null || it.selectNote(0), (vt = h.current) == null || vt.focus();
          return;
        }
        if (w && F.key === c) {
          if (!Et()) {
            F.preventDefault(), F.stopPropagation(), (Ct = h.current) == null || Ct.selectNote(0), (Tt = h.current) == null || Tt.focus();
            return;
          }
          M() && (F.preventDefault(), F.stopPropagation());
        }
      }, Q = () => {
        var nt, st;
        const F = R();
        !F || document.activeElement !== F || Et() || ((nt = h.current) == null || nt.selectNote(0), (st = h.current) == null || st.focus());
      };
    ...
    const R = () => {
      ...
      J && !J.isCollapsed || Et() || ((Q = h.current) == null || Q.selectNote(0), (F = h.current) == null || F.focus());
    };
  ...
  return /* @__PURE__ */ u(gt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(gt, { children: Iu(t.marker, c, o, l) })
      }
    )
  ] });
}
...
const Vu = (t) => {
  ...
  return e ? e[1] : "";
}, Bu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Wh = Object.freeze([
...
function Yh({
  ...
  }, [U, ot]), X = P(() => I.length === 0 ? [] : Fu(I, S, W), [I, S, W]), q = P(() => {
    var kt, mt;
    if (!U) return d;
...
function Xh({ className: t, onClick: e, ...r }) {
...
function Ju({
  ...
  const c = t ? Xr.Root : "button", { state: d } = La(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: b(Zu({ variant: r, size: o }), s),
      ...i
    }
  );
    ...
    Gu,
    {
      ...
      children: /* @__PURE__ */ u(Wu, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(Yu, { children: Object.entries(e).map(([g, E]) => /* @__PURE__ */ a(Xu, { children: /* @__PURE__ */ a(
            Ju,
            {
              onClick: () => p(g),
              isActive: x(g),
    ...
    /* @__PURE__ */ u(
      Hu,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(qu, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
...
}, jn = (t) => `${ip({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function dg({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(su, { children: N.map((S) => /* @__PURE__ */ a(ye, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
...
function ug({
  ...
  const B = Ut(
  ...
  ], kt = (j, rt, Lt = !1) => /* @__PURE__ */ u(gt, { children: [
    j,
    rt && !Lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      rt
    ] })
  ] }), mt = e ? pt.filter((j) => e.includes(j.value)) : pt, Rt = g ?? qa, Ft = h ?? Rt, Pt = f ?? Rt, fe = () => {
  }, we = L(null), _t = L(null), Nt = L(!1), Et = L(null), oe = L(!1), [me, Dt] = _(void 0), Mt = L(!1), ne = L(!1), _e = L(null), ve = V((j) => {
    if (j) {
    ...
    (j) => {
      m == null || m(j), x == null || x(j), Mt.current = !0;
    },
    [m, x]
  ), Yt = V(
    (j) => {
      x == null || x(j), ne.current = !0;
    },
    [x]
  ), Xt = V(
    (j) => {
    ...
    [r, n, g, s]
  ), Zt = mt.find((j) => j.value === t), ze = () => t === "selectedBooks" && n.length > 0 ? n.map((j) => j.toUpperCase()).join(", ") : t === "range" ? Fc(Ft, Pt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Zt ? kt(Zt.label, Zt.scrRefSuffix) : t, M = mt.filter(
    (j) => j.value !== "selectedBooks" && j.value !== "range"
  ), Ot = mt.find((j) => j.value === "selectedBooks"), Gt = mt.find((j) => j.value === "range"), [It, R] = _(!1), [K, J] = _(void 0), [H, Q] = _(void 0), [F, nt] = _(void 0), [st, it] = _(void 0), [vt, Ct] = _([]), Tt = p === "dropdown" && K === "selectedBooks", qt = /* @__PURE__ */ a(
    dp,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { ref: we, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        Ya,
        {
          ...
          localizedStrings: y,
          getEndVerse: C,
          disableReferencesUpTo: Ne ? F ?? Ft : Ft,
          onOpenChange: Ie,
          onCloseAutoFocus: (j) => {
            var rt;
            ne.current && (ne.current = !1, j.preventDefault(), (rt = _e.current) == null || rt.focus());
          },
          className: b(Ke && Pe),
          modal: !0,
          align: "start"
  ...
  const [He, Ba] = _(null), [Ae, fr] = _(null), [mr, Fa] = _(null), Jr = 200, [ja, Qr] = _(!1);
  Z(() => {
  ...
  const ta = V(
    (j) => {
      Q(j), nt(Ft), it(Pt), Ct(n), R(!1), J(j);
    },
    [Ft, Pt, n]
  ), ea = V(() => {
    H !== void 0 && (H === "range" ? (F && (m == null || m(F)), st && (x == null || x(st))) : H === "selectedBooks" && s(vt), Xt(H), J(void 0), Q(void 0));
  }, [
    H,
    F,
    st,
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(Fe, { open: It, onOpenChange: R, children: [
        ...
        /* @__PURE__ */ a(
          je,
          {
            ...
            children: /* @__PURE__ */ u(Ka, { container: mr, children: [
              M.map(({ value: j, label: rt, dropdownLabel: Lt, scrRefSuffix: ue, id: be }) => {
              ...
              E && /* @__PURE__ */ u(gt, { children: [
                ...
                /* @__PURE__ */ a(
                  We,
                  {
                    ...
                    onSelect: (j) => {
                      var rt, Lt;
                      if (j.preventDefault(), Nt.current) {
                        Nt.current = !1;
                        return;
                      }
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          Ya,
                          {
                            ...
                            onCloseAutoFocus: (j) => {
                              var rt;
                              j.preventDefault(), (rt = Et.current) == null || rt.focus();
                            },
                            modal: !0,
        ...
        To,
        {
          ...
          children: mt.map(({ value: j, label: rt, scrRefSuffix: Lt, id: ue }) => {
    ...
    p === "dropdown" && Ot && /* @__PURE__ */ a(io, { open: K === "selectedBooks", onOpenChange: vr, children: /* @__PURE__ */ a(
      so,
      {
        ...
        onCloseAutoFocus: ra,
        onEscapeKeyDown: (j) => {
          Ae != null && Ae.querySelector('[data-state="open"]') && j.preventDefault();
        },
    ...
    p === "dropdown" && Gt && /* @__PURE__ */ a(io, { open: K === "range", onOpenChange: vr, children: /* @__PURE__ */ a(
      so,
      {
        ...
        onCloseAutoFocus: ra,
        onEscapeKeyDown: (j) => {
          He != null && He.querySelector('[data-state="open"]') && j.preventDefault();
        },
...
const fp = Object.freeze([520, 420, 340]), gs = ee.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), d = hs(n, fp), l = Di() ?? d, w = l >= Br.MINIMUM;
...
function gf({ value: t, children: e }) {
...
export {
  ...
  Rh as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  nu as ContentZoomRoot,
  Dg as ContextMenu,
  Bg as ContextMenuCheckboxItem,
  Ag as ContextMenuContent,
  ...
  wu as DataTable,
  Eg as DestructiveKeyConfirmation,
  io as Dialog,
  _f as DialogClose,
  so as DialogContent,
  ...
  Ih as ERROR_POPOVER_STRING_KEYS,
  vu as EditorKeyboardShortcuts,
  Sf as Empty,
  Rf as EmptyContent,
  Df as EmptyDescription,
  Mf as EmptyHeader,
  Of as EmptyMedia,
  If as EmptyState,
  zf as EmptyTitle,
  ...
  $h as Footer,
  Lh as FootnoteEditor,
  Pu as FootnoteItem,
  Fh as FootnoteList,
  _g as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Wh as INVENTORY_STRING_KEYS,
  Ia as Input,
  Ng as InterfaceLanguagePicker,
  Yh as Inventory,
  wo as Kbd,
  Pf as KbdGroup,
  $t as Label,
  ...
  gg as SettingsListItem,
  Qu as SettingsSidebar,
  lg as SettingsSidebarContentSearch,
  Aa as ShrinkStepContext,
  gf as ShrinkStepOverride,
  ...
  ng as SidebarMenuSkeleton,
  ig as SidebarMenuSub,
  cg as SidebarMenuSubButton,
  sg as SidebarMenuSubItem,
  Hu as SidebarProvider,
  Zh as SidebarRail,
  eg as SidebarSeparator,
  Xh as SidebarTrigger,
  yr as Skeleton,
  ef as Slider,
  tf as Sonner,
  Uf as Spinner,
  ...
  Wf as Z_INDEX_MODAL,
  Yf as Z_INDEX_MODAL_BACKDROP,
  Xf as Z_INDEX_NESTED_MODAL,
  Zf as Z_INDEX_NESTED_MODAL_BACKDROP,
  ...
  cf as useEvent,
  lf as useEventAsync,
  uf as useExtraValidMarkers,
  Ss as useListbox,
  Bp as usePromise,
  hh as useRecentSearches,
  df as useRetryablePromise,
