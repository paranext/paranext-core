...
import { c as m, g as De, a as Ba, C as Me, A as ce, P as Ie, b as qe, B as G, d as Ae, e as Ge, f as He, h as ye, i as Pi, k as ji, j as Bi, E as Li, l as La, r as re, m as Fi, n as cn, o as Zr, p as Fa, L as kt, D as ka, q as _a, s as Na, t as Ca, T as Kt, u as Ua, v as qt, w as Gt, x as Ht, y as ln, z as Ka, F as Fe, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ui, N as Nr, O as Ke, Q as Oe, Z as Ye, R as Re, U as tr, V as qa, W as Ga, X as Kr, Y as Ha, _ as dn, $ as Ki, a0 as qi, a1 as Gi, a2 as vo, a3 as wn, a4 as Qr, a5 as un, a6 as Hi, a7 as Yi, a8 as Wi, a9 as Xi, aa as pn, ab as Ji, ac as na, ad as bo, ae as ia, af as Zi, ag as Qi, ah as ts, ai as es, aj as rs, ak as Cr, al as Ya } from "./resizable-JZpwvayK.js";
import { am as Fh, an as Uh, ao as Kh, ap as qh, aq as Gh, ar as Hh, as as Yh, at as Wh, au as Xh, av as Jh, aw as Zh, ax as Qh, ay as tg, az as eg, aA as rg, aB as ag, aC as og, aD as ng, aE as ig, aF as sg, aG as cg, aH as lg, aI as dg, aJ as wg, aK as ug } from "./resizable-JZpwvayK.js";
...
import { Section as dt, getChaptersForBook as Is, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as As, formatReplacementString as Ue, sanitizeHtml as Xa, NumberFormat as Vs, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as Vr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as No, compareScrRefs as Sa, scrRefToBBBCCCVVV as sa, defaultScrRef as ca, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Co, collectUsjMarkers as Us } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as I, useState as k, useCallback as L, useEffect as Y, useImperativeHandle as Ks, useLayoutEffect as Zt, createContext as Ja, useContext as xn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as yn, useId as To, Fragment as kn } from "react";
import { RadioGroup as Da, ToggleGroup as _n, Avatar as Za, Select as Lt, Checkbox as zo, Slot as Er, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as So, Slider as Rr, Switch as Do } from "radix-ui";
...
function sl({
  ...
  return /* @__PURE__ */ u(Ie, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Me,
      {
        onSelect: () => g(h),
...
function da({
  ...
  const A = re(), [B, T] = k(!1), [V, $] = k(""), [N, j] = k(""), [R, E] = k("books"), [W, q] = k(void 0), [F, O] = k(
    void 0
  ...
  const xt = L(() => {
    ...
    (b) => {
      const H = R === "chapters" ? W : D == null ? void 0 : D.book;
      if (H) {
        if (l && l(H, b) > 1) {
          O(H), Z(b), E("verses"), $("");
          return;
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Dt } = {
    ...
    (b) => {
      ...
      if ((R === "chapters" || R === "books" && D) && Pt) {
        const Mt = R === "chapters" ? W : D == null ? void 0 : D.book;
        if (!Mt) return;
  ...
  return Zt(() => {
    ...
    if (R === "chapters" && W) {
      const b = W === t.book, H = b ? t.chapterNum : 1;
      $(
        `${W} ${ce[W] || ""} ${H}`
      ), setTimeout(() => {
        if (wt.current)
          ...
          Ge,
          {
            ...
            children: [
              R === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                R === "chapters" && W && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: De(W, n) }),
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Kn ? Zt : Y, Mr = { tag: Qa };
...
const vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
function Cl(t) {
...
function Ol(t, e = Rl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), _ = h.offset, A = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || A !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || _ !== c || y !== i.getKey();
      if ((T || V) && A !== null && B !== null) {
        const $ = function(N, j, R, E, W, q, F) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...jo(j, R, E)), O.setEnd(...jo(W, q, F)), O;
        }(t, g, f, A, h, C, B);
        d(), d = Dl(t, $, e);
      }
...
let Hr, xe = 0, Yr = 0, Bl = 0, Aa = 0, jr = 0;
function Lo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Bt.prototype.brand = Pl, Bt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && Yr === 0 && e.l !== Aa && (e.l = Aa, Hr = { S: e, v: e.v, i: e.i, o: Hr });
...
const io = 0, Pa = 1, ti = 2, ha = 3, Ir = 4, Je = 5, ga = 6, gr = 7;
function fa(t) {
  return t.id === io;
}
function ei(t) {
...
const co = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
...
const ud = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
function pd({ onClear: t }) {
  const [e] = fe();
  return ud(() => Xn(e, t), [e, t]), null;
}
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : Y;
...
function Cd() {
  const { activeEditor: t } = si(), [e, r] = k([]), o = L((n) => {
    if (pe(n) || Pc(n)) {
      const i = [];
      Wo.forEach(({ format: s }) => {
...
const Dd = "verseText", Gu = Object.freeze([
...
function Jo({
  ...
  const h = L(
    ...
    [t.user]
  ), y = I(() => Xa(t.contents), [t.contents]), _ = I(
...
function vi({
  ...
  const [E, W] = k(Zo), [q, F] = k(), [O, S] = k(), Z = o, [Q, _t] = k(!1), [Nt, At] = k(!1), [U, tt] = k(!1), [wt, st] = k(!1), [vt, oe] = k(!1), [at, Vt] = k(A), [St, Wt] = k(!1), ne = K(void 0), [D, Xt] = k(/* @__PURE__ */ new Map());
  Y(() => {
    let z = !0;
    return (async () => {
  ...
  const Qt = I(() => Ct[0], [Ct]), me = K(null), ie = K(void 0), P = L(() => {
    var z;
    (z = ie.current) == null || z.call(ie), W(Zo);
  }, []), X = L(() => {
    const z = !at;
  ...
  }, [i, r]), ut = I(() => Ct.slice(1), [Ct]), ct = I(() => ut.length ?? 0, [ut.length]), gt = I(() => ct > 0, [ct]), pt = I(() => Q || ct <= 2 ? ut : ut.slice(-2), [ut, ct, Q]), ft = I(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Dt = I(
...
function jd({
  ...
  const [s, c] = k("accept"), d = To(), l = To(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = I(
    () => Fr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Fr(t.acceptedText ?? ""),
  ...
  const j = e["%conflict_note_no_result%"] ?? "No result preview available.", R = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: j }), E = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : R, W = () => {
    const O = o ?? "accept";
...
function rp({
  ...
  const N = r.filter(
    ...
    [y, x]
  ), { listboxRef: W, activeId: q, handleKeyDown: F } = Ui({
    options: j,
    onOptionSelect: R
  }), O = L(
    (S) => {
...
function Xd({
  ...
  var T;
  const [w, p] = k([]), [g, h] = k([]), [f, x] = k({}), [v, C] = k({}), y = I(() => e ?? [], [e]), _ = An({
    data: y,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: A.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ga, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(Re, { children: V.headers.map(($) => /* @__PURE__ */ a(Kr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : vr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function up({
  ...
  const [f, x] = k("generated"), [v, C] = k("generated"), [y, _] = k("*"), [A, B] = k("*"), [T, V] = k("f"), [$, N] = k(!1), [j, R] = k(!0), [E, W] = k(!1), q = K(!1), F = K(""), [O, S] = k(!1), [Z, Q] = k(), [_t, Nt] = k(), [At, U] = k(), [tt, wt] = k(), st = K(null), vt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      ut === $a ? ct = "generated" : ut === Ma ? ct = "hidden" : ut && (_(ut), B(ut)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const ne = () => {
    ...
    wt(P.contextMarker), W(P.canRedo);
  }, Qt = L(
    (P) => {
      var ot, et, ut, ct, gt;
      const X = (et = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : et.at(0);
...
function kp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = k(!1), [N, j] = k("all"), [R, E] = k(""), [W, q] = k([]), F = I(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = I(() => O.length === 0 ? [] : Nw(O, N, R), [O, N, R]), Z = I(() => {
    var wt, st;
    if (!V) return d;
  ...
  const Q = (U, tt) => {
    ...
    if (O.length === 0 || W.length === 0) return [];
...
const Se = "scrBook", Vw = "scrRef", Le = "source", Pw = "details", jw = "Scripture Reference", Bw = "Scripture Book", ki = "Type", Lw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Vp({
  ...
  const [l, w] = k([]), [p, g] = k([{ id: Se, desc: !1 }]), [h, f] = k({}), x = I(
...
function Kw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
    ...
    (E, W = !1) => {
      ...
      const q = B.findIndex((Q) => Q === _.current), F = B.findIndex((Q) => Q === E);
      if (q === -1 || F === -1) return;
      const [O, S] = [
        Math.min(q, F),
        Math.max(q, F)
    ...
    E.preventDefault(), V(W, E.shiftKey);
  }, j = () => {
    r(B.map((E) => E));
  }, R = () => {
    r([]);
                ...
                Object.values(dt).map((E, W) => {
                  ...
                  if (q.length !== 0)
                    return /* @__PURE__ */ u(kn, { children: [
                      ...
                      W < Object.values(dt).length - 1 && /* @__PURE__ */ a(un, {})
                    ] }, E);
                })
              ] })
            ]
...
function jp({
  ...
  const A = Et(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), j = Et(s, "%webView_scope_selector_current_book%"), R = Et(s, "%webView_scope_selector_choose_books%"), E = Et(s, "%webView_scope_selector_scope%"), W = Et(s, "%webView_scope_selector_select_books%"), q = Et(s, "%webView_scope_selector_range%"), F = Et(s, "%webView_scope_selector_select_range%"), O = Et(s, "%webView_scope_selector_range_start%"), S = Et(s, "%webView_scope_selector_range_end%"), Z = Et(s, "%webView_scope_selector_ok%"), Q = Et(s, "%webView_scope_selector_cancel%"), _t = Et(s, "%webView_scope_selector_navigate%"), Nt = (M) => {
    if (!f) return;
  ...
  ] }), tt = e ? At.filter((M) => e.includes(M.value)) : At, wt = f ?? ca, st = w ?? wt, vt = p ?? wt, oe = () => {
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [D, Xt] = k(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L((M) => {
    if (M) {
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [ft, Dt] = k(!1), [Rt, Ft] = k(void 0), [Ot, Ee] = k(void 0), [z, $t] = k(void 0), [yt, de] = k(void 0), [Te, wr] = k([]), ur = l === "dropdown" && Rt === "selectedBooks", pr = /* @__PURE__ */ a(
    Gw,
    {
      availableBookInfo: o,
  ...
  const [mt, It] = k(null), [ht, te] = k(null), [Jt, je] = k(null), Oi = 200, [$i, Mi] = k(!1);
  Y(() => {
  ...
  const ho = L(
    (M) => {
      Ee(M), $t(st), de(vt), wr(n), Dt(!1), Ft(M);
    },
    [st, vt, n]
  ), go = L(() => {
...
function Zp({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function jh(t, e) {
  ...
  return Y(() => {
    const n = () => {
      try {
        const { frameElement: c } = window;
        return c instanceof HTMLElement ? !!c.offsetParent : void 0;
      } catch {
        return;
      }
    }, i = () => o((c) => {
    ...
    i();
    const s = window.setInterval(i, 500);
