import { jsx as k, jsxs as ze, Fragment as Vr } from "react/jsx-runtime";
import { Button as Fr, Autocomplete as Lr, TextField as vr, FormControlLabel as jn, FormLabel as Ur, Checkbox as Wr, MenuItem as Gr, Grid as wr, IconButton as xr, Paper as Hr, Slider as qr, Snackbar as Xr, Switch as Yr, AppBar as Kr, Toolbar as Jr, Drawer as Zr } from "@mui/material";
import * as Le from "react";
import { useMemo as Cn, useState as Pe, useCallback as Xe, useRef as xn, useEffect as nn } from "react";
import { offsetBook as Vn, FIRST_SCR_BOOK_NUM as Qr, offsetChapter as Fn, FIRST_SCR_CHAPTER_NUM as et, getChaptersForBook as nt, offsetVerse as Ln, FIRST_SCR_VERSE_NUM as rt } from "platform-bible-utils";
import tt, { SelectColumn as ot } from "react-data-grid";
import it from "clsx";
import at, { ThemeContext as st, internal_processStyles as ct } from "@mui/styled-engine";
function lt({ endChapter: e, activeChapter: n, handleSelectChapter: r }) {
  const t = Array.from({ length: e }, (o, i) => i + 1);
  return /* @__PURE__ */ k("div", { className: "chapter-select", children: t.map((o) => (
...
function ma({
  ...
  return /* @__PURE__ */ ze(Vr, { children: [
    /* @__PURE__ */ k(
      jn,
      {
...
function ft({ commandHandler: e, name: n, className: r, items: t, id: o }) {
  return /* @__PURE__ */ ze(wr, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
...
function pt({ commandHandler: e, className: n, columns: r, id: t }) {
  return /* @__PURE__ */ k(
    wr,
    {
      container: !0,
...
var ht = Object.defineProperty, gt = (e, n, r) => n in e ? ht(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[n] = r, A = (e, n, r) => (gt(e, typeof n != "symbol" ? n + "" : n, r), r);
const Se = [
  "GEN",
  "EXO",
  "LEV",
...
let ie = ke;
A(ie, "Original", new ke(ye.Original)), A(ie, "Septuagint", new ke(ye.Septuagint)), A(ie, "Vulgate", new ke(ye.Vulgate)), A(ie, "English", new ke(ye.English)), A(ie, "RussianProtestant", new ke(ye.RussianProtestant)), A(ie, "RussianOrthodox", new ke(ye.RussianOrthodox));
function Wn(e, n) {
  const r = n[0];
  ...
  constructor(e, n, r, t) {
    if (A(this, "firstChapter"), A(this, "lastChapter"), A(this, "lastVerse"), A(this, "hasSegmentsDefined"), A(this, "text"), A(this, "BBBCCCVVVS"), A(this, "longHashCode"), A(this, "versification"), A(this, "rtlMark", "‏"), A(this, "_bookNum", 0), A(this, "_chapterNum", 0), A(this, "_verseNum", 0), A(this, "_verse"), r == null && t == null)
      if (e != null && typeof e == "string") {
        const o = e, i = n != null && n instanceof ie ? n : void 0;
        this.setEmpty(i), this.parse(o);
      } else if (e != null && typeof e == "number") {
        const o = n != null && n instanceof ie ? n : void 0;
        ...
        if (e != null && e instanceof N) {
          ...
          if (e == null)
            return;
          const o = e instanceof ie ? e : N.defaultVersification;
          this.setEmpty(o);
        }
      else
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = o[0], o.length > 1)
        try {
          const i = +o[1].trim();
          this.versification = new ie(ye[i]);
        } catch {
          throw new je("Invalid reference : " + e);
        }
    }
...
function ya({ scrRef: e, handleSubmit: n, id: r }) {
  const t = (c) => {
    n(c);
  }, o = (c, s) => {
  ...
  return /* @__PURE__ */ ze("span", { id: r, children: [
    /* @__PURE__ */ k(
      kn,
      {
        title: "Book",
    ...
    /* @__PURE__ */ k(
      ...
      {
        onClick: () => n(Fn(e, 1)),
        isDisabled: e.chapterNum >= nt(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ k(
...
function va({ onSearch: e, placeholder: n, isFullWidth: r }) {
  const [t, o] = Pe(""), i = (a) => {
    o(a), e(a);
  };
  return /* @__PURE__ */ k(Hr, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ k(
    Je,
    {
      isFullWidth: r,
...
const Tt = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ k(
  ut,
  {
    ...t,
    isChecked: r,
...
function Sa({
  ...
  const J = Cn(() => {
    const re = e.map((U) => typeof U.editable == "function" ? {
      ...U,
      editable: (Q) => !!U.editable(Q),
      renderEditCell: U.renderEditCell || Gn
    } : U.editable && !U.renderEditCell ? { ...U, renderEditCell: Gn } : U.renderEditCell && !U.editable ? { ...U, editable: !1 } : U);
    return u ? [{ ...ot, minWidth: p }, ...re] : re;
  }, [e, u, p]);
  return /* @__PURE__ */ k(
    tt,
    {
...
function ue(e, n, r = {
  ...
  return ve(e) && ve(n) && Object.keys(n).forEach((o) => {
    o !== "__proto__" && (ve(n[o]) && o in e && ve(e[o]) ? t[o] = ue(e[o], n[o], r) : r.clone ? t[o] = ve(n[o]) ? Or(n[o]) : n[o] : t[o] = n[o]);
  }), t;
}
function _t(e) {
...
function $t() {
  return qn || (qn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var g = c, Z = s, ne = l, de = a, ce = n, T = u, H = t, J = b, re = v, U = r, le = i, Q = o, pe = p, xe = !1;
    function Ee(y) {
    ...
    V.AsyncMode = g, V.ConcurrentMode = Z, V.ContextConsumer = ne, V.ContextProvider = de, V.Element = ce, V.ForwardRef = T, V.Fragment = H, V.Lazy = J, V.Memo = re, V.Portal = U, V.Profiler = le, V.StrictMode = Q, V.Suspense = pe, V.isAsyncMode = Ee, V.isConcurrentMode = m, V.isContextConsumer = w, V.isContextProvider = R, V.isElement = O, V.isForwardRef = E, V.isFragment = P, V.isLazy = _, V.isMemo = $, V.isPortal = I, V.isProfiler = D, V.isStrictMode = M, V.isSuspense = ee, V.isValidElementType = z, V.typeOf = C;
  }()), V;
}
var Xn;
function $r() {
  return Xn || (Xn = 1, process.env.NODE_ENV === "production" ? qe.exports = Ot() : qe.exports = $t()), qe.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function At() {
  if (Qn)
    return bn;
  Qn = 1;
  var e = $r(), n = Rt(), r = $n(), t = Rr(), o = Nt(), i = function() {
  };
  ...
  return bn = function(l, c) {
    ...
    function ce(m) {
      ...
      function O(E, P, _, $, I) {
        ...
        return new h("Invalid " + $ + " `" + I + "` supplied to " + ("`" + _ + "`" + oe + "."));
      }
      return f(O);
    }
    function T() {
      function m(w, R, O, E, P) {
        return U(w[R]) ? null : new h("Invalid " + E + " `" + P + "` supplied to " + ("`" + O + "`, expected a ReactNode."));
      }
      return f(m);
    }
    function H(m, w, R, O, E) {
      return new h(
...
Valid keys: ` + JSON.stringify(Object.keys(m), null, "  ")
    ...
    function Q(m) {
      var w = typeof m;
      return Array.isArray(m) ? "array" : m instanceof RegExp ? "object" : le(w, m) ? "symbol" : w;
    }
    function pe(m) {
...
if (process.env.NODE_ENV !== "production") {
  var It = $r(), Mt = !0;
  Sn.exports = At()(It.isElement, Mt);
} else
  Sn.exports = Pt()();
var Bt = Sn.exports;
const W = /* @__PURE__ */ _t(Bt);
function Me(e) {
...
function Dt() {
  return rr || (rr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var Z = a, ne = i, de = e, ce = c, T = r, H = d, J = p, re = n, U = o, le = t, Q = s, pe = u, xe = !1, Ee = !1;
    function m(x) {
    ...
    L.ContextConsumer = Z, L.ContextProvider = ne, L.Element = de, L.ForwardRef = ce, L.Fragment = T, L.Lazy = H, L.Memo = J, L.Portal = re, L.Profiler = U, L.StrictMode = le, L.Suspense = Q, L.SuspenseList = pe, L.isAsyncMode = m, L.isConcurrentMode = w, L.isContextConsumer = R, L.isContextProvider = O, L.isElement = E, L.isForwardRef = P, L.isFragment = _, L.isLazy = $, L.isMemo = I, L.isPortal = D, L.isProfiler = M, L.isStrictMode = ee, L.isSuspense = y, L.isSuspenseList = oe, L.isValidElementType = C, L.typeOf = g;
  }()), L;
}
process.env.NODE_ENV === "production" ? En.exports = zt() : En.exports = Dt();
var tr = En.exports;
...
function Xt(e, n = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
const Zt = {
  borderRadius: 4
}, Qt = Zt, eo = process.env.NODE_ENV !== "production" ? W.oneOfType([W.number, W.string, W.object, W.array]) : {}, we = eo;
function Fe(e, n) {
  return n ? ue(e, n, {
    clone: !1
...
function Y(e) {
  const {
    ...
    return me(a, l, (p) => {
      let d = Ze(s, o, p);
      return p === d && typeof p == "string" && (d = Ze(s, o, `${n}${p === "default" ? "" : fe(p)}`, p)), r === !1 ? d : {
        [r]: d
      };
    });
  };
...
function Ir(e, n) {
  const r = Pr(e.theme);
  return Object.keys(e).map((t) => lo(e, n, t, r)).reduce(Fe, {});
}
function q(e) {
  return Ir(e, tn);
}
...
function an(...e) {
  const n = e.reduce((t, o) => (o.filterProps.forEach((i) => {
    t[i] = o;
  }), t), {}), r = (t) => Object.keys(t).reduce((o, i) => n[i] ? Fe(o, n[i](t)) : o, {});
...
const fo = se("border", ae), po = se("borderTop", ae), ho = se("borderRight", ae), go = se("borderBottom", ae), mo = se("borderLeft", ae), bo = se("borderColor"), yo = se("borderTopColor"), vo = se("borderRightColor"), wo = se("borderBottomColor"), xo = se("borderLeftColor"), ko = se("outline", ae), So = se("outlineColor"), sn = (e) => {
...
an(fo, po, ho, go, mo, bo, yo, vo, wo, xo, sn, ko, So);
const cn = (e) => {
...
function Go() {
  function e(r, t, o, i) {
    ...
    return p ? p(a) : me(a, t, (b) => {
      let h = Ze(d, u, b);
      return b === h && typeof b == "string" && (h = Ze(d, u, `${r}${b === "default" ? "" : fe(b)}`, b)), c === !1 ? h : {
        [c]: h
      };
    });
  }
...
const Mr = Go();
Mr.filterProps = ["sx"];
const In = Mr, Ho = ["breakpoints", "palette", "spacing", "shape"];
function Mn(e = {}, ...n) {
  const {
    breakpoints: r = {},
    palette: t = {},
  ...
  return s = n.reduce((u, p) => ue(u, p), s), s.unstable_sxConfig = B({}, Pn, a == null ? void 0 : a.unstable_sxConfig), s.unstable_sx = function(p) {
    return In({
      sx: p,
      theme: this
    });
...
function Br(e) {
  ...
  return Object.keys(r).sort().forEach((o) => {
    o === "color" ? t += cr(t) ? e[o] : fe(e[o]) : t += `${cr(t) ? o : fe(o)}${fe(e[o].toString())}`;
  }), t;
}
...
const ni = (e, n) => n.components && n.components[e] && n.components[e].styleOverrides ? n.components[e].styleOverrides : null, Qe = (e) => {
  ...
  return e && e.forEach((t) => {
    let o = "";
    typeof t.props == "function" ? (o = `callback${n}`, n += 1) : o = Br(t.props), r[o] = t.style;
  }), r;
}, ri = (e, n) => {
  let r = [];
  ...
  return r && r.forEach((a) => {
    ...
    l && (typeof a.props == "function" ? o.push(n[`callback${i}`]) : o.push(n[Br(a.props)])), typeof a.props == "function" && (i += 1);
  }), o;
}, ti = (e, n, r, t) => {
  var o;
...
function ai(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ct(a, (C) => C.filter((g) => !(g != null && g.__mui_systemSx)));
    const {
      name: c,
      slot: s,
    ...
    let S = Ye;
    s === "Root" || s === "root" ? S = t : s ? S = o : ei(a) && (S = void 0);
    const K = at(a, B({
      shouldForwardProp: S,
      label: f
    }, v)), z = (C, ...g) => {
      const Z = g ? g.map((T) => {
        ...
        if (ve(T)) {
          let H = T, J;
          return T && T.variants && (J = T.variants, delete H.variants, H = (re) => {
            let U = T;
            return en(re, Qe(J), J).forEach((Q) => {
              U = ue(U, Q);
            }), U;
          }), H;
        }
      ...
      if (ve(C)) {
        let T;
        C && C.variants && (T = C.variants, delete ne.variants, ne = (H) => {
          let J = C;
          return en(H, Qe(T), T).forEach((U) => {
            J = ue(J, U);
          }), J;
        });
      } else
      ...
      c && d && Z.push((T) => {
        ...
        if (J) {
          const re = {};
          return Object.entries(J).forEach(([U, le]) => {
            re[U] = typeof le == "function" ? le(B({}, T, {
              theme: H
            })) : le;
          }), d(T, re);
        }
        ...
        return ti(T, ri(c, H), H, c);
      }), h || Z.push(i);
      const de = Z.length - g.length;
      if (Array.isArray(C) && de > 0) {
        const T = new Array(de).fill("");
        ne = [...C, ...T], ne.raw = [...C.raw, ...T];
      }
      const ce = K(ne, ...Z);
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${fe(s || "")}`), T === void 0 && (T = `Styled(${Ft(a)})`), ce.displayName = T;
      }
...
function zr(e, n = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < n || e > r) && console.error(`MUI: The value provided ${e} is out of range [${n}, ${r}].`), Xt(e, n, r);
}
function li(e) {
  e = e.slice(1);
...
function di(e, n) {
  if (e = Be(e), n = zr(n), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - n;
...
const hi = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ne = ki, Si = ["mode", "contrastThreshold", "tonalOffset"], pr = {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (v[n] || console.error(`MUI: The palette mode \`${n}\` is not supported.`)), ue(B({
...
const zi = ["none", G(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), G(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), G(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), G(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), G(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), G(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), G(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), G(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), G(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), G(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), G(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), G(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), G(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), G(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), G(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), G(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), G(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), G(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), G(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), G(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), G(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), G(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), G(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), G(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Di = zi, ji = ["duration", "easing", "delay"], Vi = {
...
function Ui(e) {
  const n = B({}, Vi, e.easing), r = B({}, Fi, e.duration);
  return B({
...
const Wi = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Gi = Wi, Hi = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function qi(e = {}, ...n) {
  const {
    mixins: r = {},
    palette: t = {},
  ...
  if (s = ue(s, a), s = n.reduce((u, p) => ue(u, p), s), process.env.NODE_ENV !== "production") {
...
const ea = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], na = (e) => {
  const {
    ...
    root: ["root", n !== "inherit" && `color${fe(n)}`, `fontSize${fe(r)}`]
  };
  return Lt(o, Qi, t);
}, ra = Zi("svg", {
  name: "MuiSvgIcon",
  ...
  overridesResolver: (e, n) => {
    ...
    return [n.root, r.color !== "inherit" && n[`color${fe(r.color)}`], n[`fontSize${fe(r.fontSize)}`]];
  }
})(({
  theme: e,
  ownerState: n
...
}), zn = /* @__PURE__ */ Le.forwardRef(function(n, r) {
  const t = Yi({
    props: n,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: p,
    viewBox: d = "0 0 24 24"
  } = t, v = be(t, ea), b = /* @__PURE__ */ Le.isValidElement(o) && o.type === "svg", h = B({}, t, {
    color: a,
    component: l,
    fontSize: c,
  ...
  u || (f.viewBox = d);
  const S = na(h);
  return /* @__PURE__ */ ze(ra, B({
    as: l,
    className: it(S.root, i),
    focusable: "false",
    color: s,
...
function ta(e, n) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${n}Icon`), r.muiName = yr.muiName, /* @__PURE__ */ Le.memo(/* @__PURE__ */ Le.forwardRef(r));
}
const oa = ta(/* @__PURE__ */ k("path", {
...
function Ea({
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ k("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ k(Kr, { position: "static", id: o, children: /* @__PURE__ */ ze(Jr, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ k(
      xr,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ k(
      Zr,
      {
        ...
        children: /* @__PURE__ */ k(pt, { commandHandler: h, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
