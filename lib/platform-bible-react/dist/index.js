...
import c, { forwardRef as qt, createContext as Un, useContext as qn, useCallback as tt, useState as D, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Jn } from "react";
...
import { formatScrRef as Ot, getChaptersForBook as kr, NumberFormat as Cr, formatBytes as Sr, deepEqual as ye, substring as Rr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as E } from "platform-bible-utils";
...
const ke = I.Trigger, nn = I.Group, Or = I.Portal, Ar = I.Sub, Zo = I.RadioGroup;
...
S(K, "Original", new K(nt.Original)), S(K, "Septuagint", new K(nt.Septuagint)), S(K, "Vulgate", new K(nt.Vulgate)), S(K, "English", new K(nt.English)), S(K, "RussianProtestant", new K(nt.RussianProtestant)), S(K, "RussianOrthodox", new K(nt.RussianOrthodox));
let mt = K;
function $e(t, e) {
  const n = e[0];
...
function ts({
  ...
  const o = $(), [i, w] = D(""), [s, p] = D(t.book), [u, m] = D(t.chapterNum ?? 0), [f, g] = D(t.book), [h, v] = D(!1), [x, y] = D(h), N = Z(void 0), C = Z(void 0), B = Z(void 0), j = tt(
    (k) => {
      const z = a ? a() : ze;
      return {
    ...
    (k, z, P, G) => {
      if (m(t.book !== k ? 1 : t.chapterNum), z || Dt(k) === -1) {
        e({
          book: k,
          chapterNum: P ?? 1,
          verseNum: G ?? 1
    ...
    (k) => {
      h ? (k.key === "ArrowDown" || k.key === "ArrowUp") && (B != null && B.current ? B.current.focus() : C.current && C.current.focus(), k.preventDefault()) : v(!0);
    },
    [h]
  ), Mt = (k) => {
    const { key: z } = k;
    ...
    if (f === s) {
      ...
      u + F <= 0 || u + F > Dt(f) ? m(0) : F !== 0 && (m(u + F), k.preventDefault());
    }
  };
  return ct(() => {
    ...
    const k = setTimeout(() => {
      if (x && C.current && B.current && !i) {
        const P = B.current.offsetTop - ea;
        C.current.scrollTo({ top: P, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(k);
    };
  }, [x, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Wt, { modal: !1, open: h, onOpenChange: Et, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Br,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          p(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), v(!0), w(Ot(t, "English")), N.current.focus();
        },
        onFocus: () => {
          at.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      $t,
      {
        ...
        ref: C,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((k, z) => {
          const P = j(k);
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: ta[k] }),
    ...
    /* @__PURE__ */ r(
      Ee,
      {
        ...
        children: /* @__PURE__ */ d(Me, { children: [
          ...
          /* @__PURE__ */ r(Ve, { children: e.map((C) => /* @__PURE__ */ d(
            Be,
            {
              value: s(C),
              onSelect: () => {
    ...
    un,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Y, { className: "tw-flex tw-items-center", children: a.map((y) => O.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
function ka({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Qt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(te, { stickyHeader: i, children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(dt, { children: N.headers.map((C) => /* @__PURE__ */ r(Ft, { children: C.isPlaceholder ? void 0 : At(C.column.columnDef.header, C.getContext()) }, C.id)) }, N.id)) }),
      /* @__PURE__ */ r(ee, { children: (y = x.getRowModel().rows) != null && y.length ? x.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        dt,
        {
          ...
          children: N.getVisibleCells().map((C) => /* @__PURE__ */ r(kt, { children: At(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        N.id
...
function Ta({
  ...
  const [m, f] = D(!1), g = tt(
    (x) => {
      var N;
      const y = (N = t.find((C) => C.label === x)) == null ? void 0 : N.value;
      y && a(
    ...
    if (!s) return t;
    const x = t.filter((N) => N.starred).sort((N, C) => N.label.localeCompare(C.label)), y = t.filter((N) => !N.starred).sort((N, C) => {
      const B = n.includes(N.value), j = n.includes(C.value);
      return B && !j ? -1 : !B && j ? 1 : N.label.localeCompare(C.label);
    });
    return [...x, ...y];
  }, [t, n, s]);
...
function fs({
  ...
  const f = ot(n, "%webView_inventory_all%"), g = ot(n, "%webView_inventory_approved%"), h = ot(n, "%webView_inventory_unapproved%"), v = ot(n, "%webView_inventory_unknown%"), x = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), N = ot(n, "%webView_inventory_scope_verse%"), C = ot(n, "%webView_inventory_filter_text%"), B = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, it] = D(!1), [at, Et] = D("all"), [b, T] = D(""), [J, A] = D([]), Mt = Q(() => s ? a instanceof RegExp ? Pa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
  ...
  }, [j, Mt]), k = Q(() => Ba(pt, at, b), [pt, at, b]), z = Q(() => {
    var wt, ut;
    if (!j) return m;
  ...
  const P = (R, L) => {
    ...
    if (pt.length === 0 || J.length === 0) return [];
...
const Sn = c.forwardRef(
  ({
    ...
    const [u, m] = c.useState(t), f = e ?? u, g = c.useCallback(
      ...
      [n, f]
    ), h = c.useCallback(() => g((B) => !B), [g]), v = f ? "expanded" : "collapsed", N = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", C = c.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: C, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
function vs({
  ...
  ct(() => {
    if (s) {
      ...
      if (T.length === 1) {
        const J = v.find((A) => Ue(A) === T[0]) || void 0;
        J && s(J);
      }
    }
  }, [g, v, s, y]);
  const N = o ?? ro, C = i ?? Vn, B = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [lt] },
    { label: `Group by ${C}`, value: [ht] },
    {
  ...
  }, at = (b, T) => b.getIsGrouped() ? "" : l("banded-row", T % 2 === 0 ? "even" : "odd"), Et = (b, T, J) => {
    if (!((b == null ? void 0 : b.length) === 0 || T.depth < J.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: B.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (J === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(yr, {})),
                          " ",
...
function Ts({
  ...
  const p = ho(
    ...
    var y, N, C, B, j, it;
    const x = v !== h ? ((N = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((B = (C = t[h]) == null ? void 0 : C.uiNames) == null ? void 0 : B.en) : void 0;
