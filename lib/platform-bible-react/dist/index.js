import { jsxs as ae, jsx as b, Fragment as Xr } from "react/jsx-runtime";
import * as ie from "react";
import { forwardRef as Yr, useState as we, useRef as Qe, useCallback as ve, useMemo as _n, useEffect as on } from "react";
...
import { Button as st, Autocomplete as ct, TextField as kr, FormControlLabel as Gn, FormLabel as lt, Checkbox as ut, MenuItem as dt, Grid as Sr, IconButton as Er, Paper as ft, Slider as pt, Snackbar as ht, Switch as mt, AppBar as gt, Toolbar as bt, Drawer as yt } from "@mui/material";
...
let ye = I;
P(ye, "defaultVersification", le.English), P(ye, "verseRangeSeparator", "-"), P(ye, "verseSequenceIndicator", ","), P(ye, "verseRangeSeparators", [I.verseRangeSeparator]), P(ye, "verseSequenceIndicators", [I.verseSequenceIndicator]), P(ye, "chapterDigitShifter", 1e3), P(ye, "bookDigitShifter", I.chapterDigitShifter * I.chapterDigitShifter), P(ye, "bcvMaxValue", I.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
P(ye, "ValidStatusType", $r);
class Ue extends Error {
}
function ke(...e) {
  return it(at(e));
}
const Bt = K.Root, Dt = K.Trigger, zt = ie.forwardRef(({ className: e, inset: n, children: r, ...t }, o) => /* @__PURE__ */ ae(
  K.SubTrigger,
  {
    ref: o,
    className: ke(
...
const jt = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ b(
  K.SubContent,
  {
    ref: r,
    className: ke(
...
const Rr = ie.forwardRef(({ className: e, sideOffset: n = 4, ...r }, t) => /* @__PURE__ */ b(K.Portal, { children: /* @__PURE__ */ b(
  K.Content,
  {
    ref: t,
    sideOffset: n,
...
const Ar = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ b(
  K.Item,
  {
    ref: t,
    className: ke(
...
const Vt = ie.forwardRef(({ className: e, children: n, checked: r, ...t }, o) => /* @__PURE__ */ ae(
  K.CheckboxItem,
  {
    ref: o,
    className: ke(
...
const Ir = ie.forwardRef(({ className: e, inset: n, ...r }, t) => /* @__PURE__ */ b(
  K.Label,
  {
    ref: t,
    className: ke("pr-px-2 pr-py-1.5 pr-text-sm pr-font-semibold", n && "pr-pl-8", e),
    ...r
  }
));
Ir.displayName = K.Label.displayName;
const Pr = ie.forwardRef(({ className: e, ...n }, r) => /* @__PURE__ */ b(
  K.Separator,
  {
    ref: r,
    className: ke("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
    ...n
  }
));
Pr.displayName = K.Separator.displayName;
const Mr = ie.forwardRef(
...
const Lt = Yr(
  ({ handleSearch: e, handleKeyDown: n, ...r }, t) => /* @__PURE__ */ ae("div", { className: "input-container", children: [
    /* @__PURE__ */ b(
      Mr,
      {
        ...r,
    ...
    /* @__PURE__ */ b("div", { className: "history-icon-container", children: /* @__PURE__ */ b(
      rt,
      {
        size: 16,
        onClick: () => {
...
function Ut({ endChapter: e, activeChapter: n, handleSelectChapter: r }) {
  ...
  return /* @__PURE__ */ b("div", { className: "chapter-select", children: t.map((o) => (
...
function Gt({
  ...
  return /* @__PURE__ */ ae("div", { children: [
    /* @__PURE__ */ b(
      ...
      {
        textValue: e,
        className: `menu-item ${r && "selected"}`,
        onSelect: (a) => {
          a.preventDefault(), n(e);
        },
        children: /* @__PURE__ */ ae("div", { children: [
          /* @__PURE__ */ b(tt, { className: `book-color-label ${t.toLowerCase()}` }),
...
function Li({ scrRef: e, handleSubmit: n }) {
  const { allBookIds: r } = Z, [t, o] = we(""), [a, i] = we(""), [u, c] = we(!1), s = Qe(void 0), l = ve(
    (C) => ({
    ...
    o(C);
  }, v = ve((C) => xr(Z.bookIdToNumber(C)), []), y = (C) => {
    i(a !== C ? C : ""), v(C) === -1 && n({
    ...
    !C && document.activeElement === s.current ? (console.log("trying to keep the menu open"), c(!0)) : (console.log("controlling menu state"), c(C));
  }, []), S = ve(() => s.current.focus(), []);
  return /* @__PURE__ */ b("div", { children: /* @__PURE__ */ ae(Bt, { modal: !1, open: u, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ b(Rr, { className: "menu-content", onKeyDown: S, children: Ht.map((C) => /* @__PURE__ */ ae("div", { children: [
      /* @__PURE__ */ b(Ir, { className: "menu-label", children: Wt[C] }),
      p(C).map((T) => /* @__PURE__ */ b("div", { children: /* @__PURE__ */ b(
        Gt,
        {
          bookId: T,
...
function qt({
  ...
  let p;
  if (r) {
    const d = t === ze.Before || t === ze.Above, v = /* @__PURE__ */ b("span", { className: `papi-checkbox-label ${u ? "error" : ""} ${c ?? ""}`, children: r }), y = t === ze.Before || t === ze.After, h = y ? v : /* @__PURE__ */ b("div", { children: v }), f = y ? l : /* @__PURE__ */ b("div", { children: l });
    p = /* @__PURE__ */ ae(
      lt,
      {
...
function Yt({ commandHandler: e, name: n, className: r, items: t, id: o }) {
  return /* @__PURE__ */ ae(Sr, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
...
function Wi({ scrRef: e, handleSubmit: n, id: r }) {
  const t = (c) => {
    ...
    const p = { bookNum: Z.bookIdToNumber(s.bookId), chapterNum: 1, verseNum: 1 };
    t(p);
  }, a = (c) => {
...
function Hi({ onSearch: e, placeholder: n, isFullWidth: r }) {
  const [t, o] = we(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ b(ft, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ b(
    en,
    {
      isFullWidth: r,
...
function he(e, n, r = {
  ...
  return Ce(e) && Ce(n) && Object.keys(n).forEach((o) => {
    o !== "__proto__" && (Ce(n[o]) && o in e && Ce(e[o]) ? t[o] = he(e[o], n[o], r) : r.clone ? t[o] = Ce(n[o]) ? Br(n[o]) : n[o] : t[o] = n[o]);
  }), t;
}
function Zt(e) {
...
function Qt() {
  ...
  return V.AsyncMode = c, V.ConcurrentMode = s, V.ContextConsumer = u, V.ContextProvider = i, V.Element = n, V.ForwardRef = l, V.Fragment = t, V.Lazy = y, V.Memo = v, V.Portal = r, V.Profiler = a, V.StrictMode = o, V.Suspense = p, V.isAsyncMode = function(m) {
    return E(m) || T(m) === c;
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === s || m === a || m === o || m === p || m === d || typeof m == "object" && m !== null && (m.$$typeof === y || m.$$typeof === v || m.$$typeof === i || m.$$typeof === u || m.$$typeof === l || m.$$typeof === f || m.$$typeof === S || m.$$typeof === C || m.$$typeof === h);
  }, V.typeOf = T, V;
}
var F = {};
/** @license React v16.13.1
...
function eo() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function T(w) {
      ...
      w === t || w === s || w === a || w === o || w === p || w === d || typeof w == "object" && w !== null && (w.$$typeof === y || w.$$typeof === v || w.$$typeof === i || w.$$typeof === u || w.$$typeof === l || w.$$typeof === f || w.$$typeof === S || w.$$typeof === C || w.$$typeof === h);
    }
    function E(w) {
    ...
    var m = c, ee = s, te = u, me = i, fe = n, N = l, q = t, Q = y, oe = v, G = r, pe = a, ne = o, be = p, _e = !1;
    function $e(w) {
      return _e || (_e = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), g(w) || E(w) === c;
    }
    function g(w) {
      return E(w) === s;
    }
    ...
    F.AsyncMode = m, F.ConcurrentMode = ee, F.ContextConsumer = te, F.ContextProvider = me, F.Element = fe, F.ForwardRef = N, F.Fragment = q, F.Lazy = Q, F.Memo = oe, F.Portal = G, F.Profiler = pe, F.StrictMode = ne, F.Suspense = be, F.isAsyncMode = $e, F.isConcurrentMode = g, F.isContextConsumer = x, F.isContextProvider = A, F.isElement = $, F.isForwardRef = _, F.isFragment = M, F.isLazy = O, F.isMemo = R, F.isPortal = B, F.isProfiler = j, F.isStrictMode = D, F.isSuspense = re, F.isValidElementType = T, F.typeOf = E;
  }()), F;
}
var Kn;
function Dr() {
...
function no() {
  ...
  return gn = o() ? Object.assign : function(a, i) {
    for (var u, c = t(a), s, l = 1; l < arguments.length; l++) {
...
Valid keys: ` + JSON.stringify(Object.keys(g), null, "  ")
    ...
    function ne(g) {
      var x = typeof g;
      return Array.isArray(g) ? "array" : g instanceof RegExp ? "object" : pe(x, g) ? "symbol" : x;
    }
    function be(g) {
...
function co() {
  ...
  return L.ContextConsumer = i, L.ContextProvider = a, L.Element = e, L.ForwardRef = c, L.Fragment = r, L.Lazy = d, L.Memo = p, L.Portal = n, L.Profiler = o, L.StrictMode = t, L.Suspense = s, L.SuspenseList = l, L.isAsyncMode = function() {
    return !1;
    ...
    return typeof f == "string" || typeof f == "function" || f === r || f === o || f === t || f === s || f === l || f === v || typeof f == "object" && f !== null && (f.$$typeof === d || f.$$typeof === p || f.$$typeof === a || f.$$typeof === i || f.$$typeof === c || f.$$typeof === y || f.getModuleId !== void 0);
  }, L.typeOf = h, L;
}
var U = {};
/**
...
function lo() {
  return or || (or = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), n = Symbol.for("react.portal"), r = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), u = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), s = Symbol.for("react.suspense"), l = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), y = !1, h = !1, f = !1, S = !1, C = !1, T;
    T = Symbol.for("react.module.reference");
    function E(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === r || k === o || C || k === t || k === s || k === l || S || k === v || y || h || f || typeof k == "object" && k !== null && (k.$$typeof === d || k.$$typeof === p || k.$$typeof === a || k.$$typeof === i || k.$$typeof === c || // This needs to include all possible module reference object
    ...
    var ee = i, te = a, me = e, fe = c, N = r, q = d, Q = p, oe = n, G = o, pe = t, ne = s, be = l, _e = !1, $e = !1;
    function g(k) {
    ...
    U.ContextConsumer = ee, U.ContextProvider = te, U.Element = me, U.ForwardRef = fe, U.Fragment = N, U.Lazy = q, U.Memo = Q, U.Portal = oe, U.Profiler = G, U.StrictMode = pe, U.Suspense = ne, U.SuspenseList = be, U.isAsyncMode = g, U.isConcurrentMode = x, U.isContextConsumer = A, U.isContextProvider = $, U.isElement = _, U.isForwardRef = M, U.isFragment = O, U.isLazy = R, U.isMemo = B, U.isPortal = j, U.isProfiler = D, U.isStrictMode = re, U.isSuspense = w, U.isSuspenseList = ce, U.isValidElementType = E, U.typeOf = m;
  }()), U;
}
...
function jr(e, n = "") {
  return e.displayName || e.name || fo(e) || n;
}
function ir(e, n, r) {
  const t = jr(n);
...
function So(e) {
  ...
  function p(d) {
    const v = i.indexOf(d);
    return v === 0 ? u(i[1]) : v === i.length - 1 ? c(i[v]) : s(d, i[i.indexOf(d) + 1]).replace("@media", "@media not all and");
  }
  return z({
    keys: i,
    values: a,
...
const Eo = {
  borderRadius: 4
}, Co = Eo, To = process.env.NODE_ENV !== "production" ? W.oneOfType([W.number, W.string, W.object, W.array]) : {}, Te = To;
function We(e, n) {
  return n ? he(e, n, {
    clone: !1
...
function xe(e, n, r) {
  ...
  if (Array.isArray(n)) {
    ...
    return n.reduce((i, u, c) => (i[a.up(a.keys[c])] = r(n[c]), i), {});
  }
  if (typeof n == "object") {
    const a = t.breakpoints || cr;
...
function J(e) {
  const {
    ...
    if (i[n] == null)
      return null;
    const u = i[n], c = i.theme, s = an(c, t) || {};
    return xe(i, u, (p) => {
      let d = nn(s, o, p);
      return p === d && typeof p == "string" && (d = nn(s, o, `${n}${p === "default" ? "" : ge(p)}`, p)), r === !1 ? d : {
        [r]: d
      };
    });
  };
...
function Lr(e, n) {
  const r = Fr(e.theme);
  return Object.keys(e).map((t) => Mo(e, n, t, r)).reduce(We, {});
}
function X(e) {
  return Lr(e, sn);
}
...
const Do = de("border", ue), zo = de("borderTop", ue), jo = de("borderRight", ue), Vo = de("borderBottom", ue), Fo = de("borderLeft", ue), Lo = de("borderColor"), Uo = de("borderTopColor"), Go = de("borderRightColor"), Wo = de("borderBottomColor"), Ho = de("borderLeftColor"), qo = de("outline", ue), Xo = de("outlineColor"), un = (e) => {
...
ln(Do, zo, jo, Vo, Fo, Lo, Uo, Go, Wo, Ho, un, qo, Xo);
const dn = (e) => {
...
ln(dn, fn, pn, Yo, Ko, Jo, Zo, Qo, ea, na, ra, ta);
function je(e, n) {
  return n === "grey" ? n : e;
}
const oa = J({
...
function ga() {
  function e(r, t, o, a) {
    ...
    const d = an(o, s) || {};
    return p ? p(i) : xe(i, t, (y) => {
      let h = nn(d, l, y);
      return y === h && typeof y == "string" && (h = nn(d, l, `${r}${y === "default" ? "" : ge(y)}`, y)), c === !1 ? h : {
        [c]: h
      };
    });
  }
  function n(r) {
    ...
    function u(c) {
      ...
      if (!s)
        return null;
      const l = _o(a.breakpoints), p = Object.keys(l);
      let d = l;
...
function Dn(e = {}, ...n) {
  ...
  return s = n.reduce((l, p) => he(l, p), s), s.unstable_sxConfig = z({}, Mn, i == null ? void 0 : i.unstable_sxConfig), s.unstable_sx = function(p) {
    return Bn({
      sx: p,
      theme: this
    });
...
function Gr(e) {
  ...
  return Object.keys(r).sort().forEach((o) => {
    o === "color" ? t += ur(t) ? e[o] : ge(e[o]) : t += `${ur(t) ? o : ge(o)}${ge(e[o].toString())}`;
  }), t;
}
  ...
  return r && r.forEach((i) => {
    ...
    if (typeof i.props == "function") {
      ...
      Object.keys(i.props).forEach((c) => {
        t[c] !== i.props[c] && e[c] !== i.props[c] && (u = !1);
      });
...
function Ra(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, u = {}) => {
    ...
    let S = Je;
    s === "Root" || s === "root" ? S = t : s ? S = o : Ca(i) && (S = void 0);
    const C = xt(i, z({
      shouldForwardProp: S,
      label: f
    }, v)), T = (E, ...m) => {
      ...
      c && d && ee.push((N) => {
        ...
        if (Q) {
          const oe = {};
          return Object.entries(Q).forEach(([G, pe]) => {
            oe[G] = typeof pe == "function" ? pe(z({}, N, {
              theme: q
            })) : pe;
          }), d(N, oe);
        }
        ...
        return Na(N, _a(c, q), q, c);
      }), h || ee.push(a);
      const me = ee.length - m.length;
      if (Array.isArray(E) && me > 0) {
        const N = new Array(me).fill("");
        te = [...E, ...N], te.raw = [...E.raw, ...N];
      }
      const fe = C(te, ...ee);
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${ge(s || "")}`), N === void 0 && (N = `Styled(${po(i)})`), fe.displayName = N;
      }
...
function Ma(e) {
  ...
  const {
    values: n
  } = e, r = n[0], t = n[1] / 100, o = n[2] / 100, a = t * Math.min(o, 1 - o), i = (s, l = (s + r / 30) % 12) => o - a * Math.max(Math.min(l - 3, 9 - l, 1), -1);
  let u = "rgb";
  const c = [Math.round(i(0) * 255), Math.round(i(8) * 255), Math.round(i(4) * 255)];
  return e.type === "hsla" && (u += "a", c.push(n[3])), zn({
    type: u,
    values: c
  });
}
...
function ni(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = Se(e, Xa), a = e.primary || Ya(n), i = e.secondary || Ka(n), u = e.error || Ja(n), c = e.info || Za(n), s = e.success || Qa(n), l = e.warning || ei(n);
  function p(h) {
    const f = hr(h, kn.text.primary) >= r ? kn.text.primary : mr.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = hr(h, f);
...
} });` : Ve(12, f ? ` (${f})` : "", JSON.stringify(h.main)));
    return gr(h, "light", C, t), gr(h, "dark", T, t), h.contrastText || (h.contrastText = p(h.main)), h;
  }, v = {
    dark: kn,
    light: mr
  };
  return process.env.NODE_ENV !== "production" && (v[n] || console.error(`MUI: The palette mode \`${n}\` is not supported.`)), he(z({
...
function oi(e, n) {
  ...
  const v = o / 14, y = p || ((S) => `${S / s * v}rem`), h = (S, C, T, E, m) => z({
    fontFamily: t,
    fontWeight: S,
    fontSize: y(C),
...
const ci = ["none", H(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), H(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), H(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), H(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), H(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), H(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), H(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), H(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), H(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), H(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), H(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), H(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), H(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), H(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), H(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), H(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), H(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), H(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), H(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), H(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), H(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), H(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), H(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), H(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], li = ci, ui = ["duration", "easing", "delay"], di = {
...
function hi(e) {
  const n = z({}, di, e.easing), r = z({}, fi, e.duration);
  return z({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        ...
        !l(o) && !Array.isArray(o) && console.error('MUI: Argument "props" must be a string or Array.'), !p(i) && !l(i) && console.error(`MUI: Argument "duration" must be a number or a string but found ${i}.`), l(u) || console.error('MUI: Argument "easing" must be a string.'), !p(c) && !l(c) && console.error('MUI: Argument "delay" must be a number or a string.'), typeof a != "object" && console.error(["MUI: Secong argument of transition.create must be an object.", "Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)), Object.keys(s).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(s).join(",")}].`);
      }
      return (Array.isArray(o) ? o : [o]).map((l) => `${l} ${typeof i == "string" ? i : vr(i)} ${u} ${typeof c == "string" ? c : vr(c)}`).join(",");
    }
  }, e, {
    easing: n,
    duration: r
...
function yi(e = {}, ...n) {
  ...
  if (s = he(s, i), s = n.reduce((l, p) => he(l, p), s), process.env.NODE_ENV !== "production") {
    const l = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], p = (d, v) => {
      ...
      for (y in d) {
        ...
        if (l.indexOf(y) !== -1 && Object.keys(h).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const f = An("", y);
            console.error([`MUI: The \`${v}\` component increases the CSS specificity of the \`${y}\` internal state.`, "You can not override it like this: ", JSON.stringify(d, null, 2), "", `Instead, you need to use the '&.${f}' syntax:`, JSON.stringify({
              root: {
                [`&.${f}`]: h
              }
...
const Ci = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ti = (e) => {
  ...
  const t = wi({
    ...
    titleAccess: p,
    viewBox: d = "0 0 24 24"
  } = t, v = Se(t, Ci), y = /* @__PURE__ */ ie.isValidElement(o) && o.type === "svg", h = z({}, t, {
    color: i,
    component: u,
    fontSize: c,
  ...
  return /* @__PURE__ */ ae(_i, z({
    ...
    ownerState: h,
    children: [y ? o.props.children : o, p ? /* @__PURE__ */ b("title", {
      children: p
    }) : null]
  }));
});
...
function Ni(e, n) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${n}Icon`), r.muiName = wr.muiName, /* @__PURE__ */ ie.memo(/* @__PURE__ */ ie.forwardRef(r));
}
...
function Ji({
  ...
  const [i, u] = we(!1), [c, s] = we(!1), l = ve(() => {
    i && u(!1), s(!1);
  }, [i]), p = ve((S) => {
    S.stopPropagation(), u((C) => {
      const T = !C;
      return T && S.shiftKey ? s(!0) : T || s(!1), T;
    });
  }, []), d = Qe(void 0), [v, y] = we(0);
  on(() => {
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ b("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ b(gt, { position: "static", id: o, children: /* @__PURE__ */ ae(bt, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ b(
      Er,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ b(
      yt,
      {
        ...
        children: /* @__PURE__ */ b(Kt, { commandHandler: h, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
...
const Ri = (e, n, r = {}) => {
  ...
  const [a, i] = we(() => t.current), [u, c] = we(!0);
  return on(() => {
    let s = !0;
    return c(!!e), (async () => {
      if (e) {
