...
import { formatScrRef as Ot, MODIFIER_KEYS as bn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as Me, compareScrRefs as je, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
const yn = 6, on = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), Un = Object.fromEntries(
...
function Ws({
  ...
  const o = Z(), [s, i] = B(
    () => Ot(t, "English")
  ), [w, c] = B(""), [p, g] = B(t.book), [v, m] = B(t.chapterNum ?? 0), [h, x] = B(t.book), [C, N] = B(!1), [S, y] = B(C), [O, z] = B(!1), [I, mt] = B(), K = q(void 0), k = q(void 0), b = q(void 0), P = q(void 0), R = $(
    (f) => {
      if (f.trim())
        return Nn.reduce(
          (D, _) => {
            ...
            const Y = _.exec(f);
            if (Y) {
              const [F, Rt = void 0, oe = void 0] = Y.slice(1), it = Cn(F) ?? (M.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (it) {
                const dt = Rt ? parseInt(Rt, 10) : void 0;
                if (dt && dt > At(it)) return;
    ...
    if (!(!I || !I.chapterNum))
      return I.verseNum ? [I.chapterNum] : Array.from({ length: At(h) }, (f, D) => D + 1).filter(
        (f) => {
          var D;
          return (I == null ? void 0 : I.chapterNum) && f.toString().includes((D = I == null ? void 0 : I.chapterNum) == null ? void 0 : D.toString());
        }
      );
  }, [h, I]), lt = J(() => {
    const f = R(s.trim());
    ...
    (f) => {
      ...
      return {
        ...
        const Y = Un[_].toLowerCase(), F = w.length > 0 && /^\d/.test(w) ? (
        ...
        return xt ? Y === F || // Match full book name
        _.toLowerCase() === F : Y.includes(F) || // Match partial book name
        _.toLowerCase().includes(F);
      });
    },
    [a, xt, w]
    ...
    () => Q.reduce((f, D) => f + D.books.length, 0),
    [Q]
  ), T = $(
    (f) => {
      i(f), c(f), mt(R(f.trim()));
    ...
    i(Ot(t, "English")), c(""), g(t.book), x(t.book);
  }, [t]), gt = $((f) => {
    if (U.current) {
      U.current = !1;
      return;
    ...
    (f, D, _, Y) => {
      if (m(t.book !== f ? 1 : t.chapterNum), D || At(f) === -1) {
        e({
          book: f,
          chapterNum: _ ?? 1,
          verseNum: Y ?? 1
    ...
    Nn.forEach((f) => {
      const D = f.exec(w);
      if (D) {
        const [_, Y = void 0, F = void 0] = D.slice(1), Rt = Cn(_);
    ...
    (f) => {
      if (!C)
        f.key !== "Tab" && f.key !== "Escape" && N(!0);
      else if (f.key === "Tab") {
        f.preventDefault(), f.stopPropagation();
        return;
      } else f.key === "ArrowDown" ? (P != null && P.current ? P.current.focus() : b != null && b.current ? b.current.focus() : k.current && k.current.focus(), f.preventDefault()) : f.key === "Escape" && document.activeElement === K.current && (N(!1), f.preventDefault(), f.stopPropagation());
      if (document.activeElement === K.current) {
        if (/^[a-zA-Z]$/.test(f.key) && (T(lt ? w + f.key : f.key), z(!0), f.preventDefault()), /^\d$/.test(f.key)) {
          const D = s;
          if (O)
            T(w + f.key);
          else {
        ...
        if (!O && f.key === ":") {
          ...
          if (_) {
            const Y = _[1], F = Y.endsWith(":") ? `${Y}` : `${Y}:`;
            T(F), z(!0), f.preventDefault();
          }
        }
        bn.has(f.key) || z(!0);
      }
    ...
    bn.has(f.key) || (f.key === "Tab" && f.shiftKey && (K.current.focus(), f.preventDefault()), f.stopPropagation(), K.current.focus(), K.current.dispatchEvent(new KeyboardEvent("keydown", { ...f, view: void 0 })));
  }, []), Er = $(
    (f) => {
      const { key: D } = f;
      kn.has(D) || (ae(f), f.preventDefault());
    },
    [ae]
  ), Dr = $((f) => {
    const { key: D } = f;
    D === "ArrowUp" && (f.preventDefault(), K.current.focus());
  }, []), Vr = $(
    (f, D) => {
      const { key: _ } = f;
      if (kn.has(_)) {
        if (h === p || tt === 1) {
          const F = tt === 1 ? h : p;
          if (_ === "Enter") {
            f.preventDefault(), ot(F, !0, v);
            return;
          }
          const Rt = _ === "ArrowRight" && !o || _ === "ArrowRight" && o === "ltr" || _ === "ArrowLeft" && o === "rtl", oe = _ === "ArrowLeft" && !o || _ === "ArrowLeft" && o === "ltr" || _ === "ArrowRight" && o === "rtl", De = Array.from(
            { length: At(h) },
            (se, Et) => Et + 1
          ), it = p !== h || tt === 1 ? L ?? De : De, dt = it.indexOf(v);
          let yt = v;
          if (Rt)
            ...
            const se = it[dt] + yn, Et = it.find((Ve) => Ve >= se);
            Et !== void 0 && (yt = Et);
          } else if (_ === "ArrowUp") {
            const se = it[dt] - yn, Et = it.slice().reverse().find((Ve) => Ve <= se);
            Et !== void 0 && (yt = Et);
          }
          if (yt !== v) {
            m(yt), f.preventDefault();
            return;
          }
        }
        if (D === 0 && _ === "ArrowUp" && !xt) {
          f.preventDefault(), K.current.focus();
          return;
        }
        return;
      }
  ...
  return ct(() => {
    tt === 1 ? m(1) : p === h ? p === t.book ? m(t.chapterNum) : m(1) : m(0);
    ...
    const f = setTimeout(() => {
      var D, _;
      if (S && k.current && b.current) {
        const F = b.current.offsetTop - Ga;
        k.current.scrollTo({ top: F, behavior: "instant" }), K.current.focus();
      }
      !S && document.activeElement !== K.current && !((D = K.current) != null && D.contains(document.activeElement)) && document.activeElement !== k.current && !((_ = k.current) != null && _.contains(document.activeElement)) && et();
    }, 10);
    return () => {
      clearTimeout(f);
    };
  }, [S, et]), /* @__PURE__ */ l(me, { modal: !1, open: C, onOpenChange: gt, children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), x(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), K.current.focus();
        },
        onFocus: () => {
          U.current = !0, z(!1), mt(R(s));
        },
        onBlur: () => {
          tt === 0 && et();
        },
    ...
    tt > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((f, D) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(fe, { className: "tw-font-semibold tw-text-foreground/80", children: Fa[f.bookType] }),
            f.books.map((_, Y) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Pa,
              {
                bookId: _,
                handleSelectBook: () => ot(_, !1),
                shouldExpandChildren: p.toLowerCase() === _.toLowerCase() || tt === 1,
                handleHighlightBook: () => x(_),
                handleKeyDown: (F) => Vr(F, Y),
                bookType: f.bookType,
                ref: (F) => {
                  p === _ && (b.current = F);
                },
...
const Ha = ft.Portal, qn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
qn.displayName = ft.Overlay.displayName;
...
Ua.displayName = ft.Description.displayName;
...
Jn.displayName = rt.Separator.displayName;
...
function $e({
  ...
  const [N, S] = B(!1);
  return /* @__PURE__ */ l(ge, { open: N, onOpenChange: S, ...C, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l(ve, { children: [
          ...
          /* @__PURE__ */ r(ye, { children: e.map((y) => /* @__PURE__ */ l(
            ke,
            {
              value: w(y),
              onSelect: () => {
    ...
    sn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(W, { className: "tw-flex tw-items-center", children: a.map((N) => M.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            j,
            {
...
const Ft = H.Root, Qa = H.Group, Xt = H.Value, to = St(
  ...
  return /* @__PURE__ */ l(
    H.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(H.Icon, { asChild: !0, children: /* @__PURE__ */ r(pe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const It = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = Z();
...
eo.displayName = H.Label.displayName;
...
no.displayName = H.Separator.displayName;
function ro({ table: t }) {
      ...
      /* @__PURE__ */ l(
        Ft,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(It, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(wt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function so({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(Ct, { children: S.headers.map((y) => /* @__PURE__ */ r(te, { children: y.isPlaceholder ? void 0 : Jt(y.column.columnDef.header, y.getContext()) }, y.id)) }, S.id)) }),
      /* @__PURE__ */ r(Se, { children: (N = C.getRowModel().rows) != null && N.length ? C.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(S, C),
          "data-state": S.getIsSelected() && "selected",
          children: S.getVisibleCells().map((y) => /* @__PURE__ */ r(Gt, { children: Jt(y.column.columnDef.cell, y.getContext()) }, y.id))
        },
        S.id
...
function po({
  ...
  const [v, m] = B(!1), h = $(
    (N) => {
      var y;
      const S = (y = t.find((O) => O.label === N)) == null ? void 0 : y.value;
      S && a(
        n.includes(S) ? n.filter((O) => O !== S) : [...n, S]
      );
    },
    [t, n, a]
  ), x = () => i || o, C = J(() => {
    if (!c) return t;
    const N = t.filter((y) => y.starred).sort((y, O) => y.label.localeCompare(O.label)), S = t.filter((y) => !y.starred).sort((y, O) => {
      const z = n.includes(y.value), I = n.includes(O.value);
      return z && !I ? -1 : !z && I ? 1 : y.label.localeCompare(O.label);
    });
    return [...N, ...S];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(ge, { open: v, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ve, { children: [
      ...
      /* @__PURE__ */ l(ye, { children: [
        ...
        /* @__PURE__ */ r(wn, { children: C.map((N) => {
...
function mi({
  ...
  const p = bt(n, "%webView_inventory_all%"), g = bt(n, "%webView_inventory_approved%"), v = bt(n, "%webView_inventory_unapproved%"), m = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), x = bt(n, "%webView_inventory_scope_chapter%"), C = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), S = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, O] = B(!1), [z, I] = B("all"), [mt, K] = B(""), [k, b] = B([]), P = J(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), R = J(() => {
    if (y) return P;
    const T = [];
    return P.forEach((U) => {
      const et = U.items[0], gt = T.find(
        (ot) => ot.items[0] === et
      );
      gt ? (gt.count += U.count, gt.occurrences = gt.occurrences.concat(U.occurrences)) : T.push({
        items: [et],
        count: U.count,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ft, { onValueChange: (T) => Tt(T), defaultValue: i, children: [
...
const rr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, m = u.useCallback(
      (O) => {
        const z = typeof O == "function" ? O(v) : O;
        n ? n(z) : g(z);
      },
      [n, v]
    ), h = u.useCallback(() => m((O) => !O), [m]), x = v ? "expanded" : "collapsed", S = Z() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = u.useMemo(
      () => ({
        state: x,
        open: v,
        setOpen: m,
    ...
    return /* @__PURE__ */ r(nr.Provider, { value: y, children: /* @__PURE__ */ r(cn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Nt = "scrBook", Io = "scrRef", Mt = "source", Ao = "details", Po = "Scripture Reference", jo = "Scripture Book", dr = "Type", Fo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
function fi({
  ...
  const [c, p] = B([]), [g, v] = B([{ id: Nt, desc: !1 }]), [m, h] = B({}), x = J(
  ...
  ct(() => {
    if (w) {
      const k = N.getSelectedRowModel().rowsById, b = Object.keys(k);
      if (b.length === 1) {
        const P = x.find((R) => Tn(R) === b[0]) || void 0;
        P && w(P);
      }
    }
  }, [m, x, w, N]);
  const S = o ?? jo, y = s ?? dr, O = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${S}`, value: [Nt] },
    { label: `Group by ${y}`, value: [Mt] },
    {
  ...
  }, mt = (k, b) => k.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), K = (k, b, P) => {
    ...
    !e && /* @__PURE__ */ l(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(It, { position: "item-aligned", children: /* @__PURE__ */ r(Qa, { children: O.map((k) => /* @__PURE__ */ r(wt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ce, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(_e, { children: N.getHeaderGroups().map((k) => /* @__PURE__ */ r(Ct, { children: k.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(Se, { children: N.getRowModel().rows.map((k, b) => {
        const P = Z();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: k.getVisibleCells().map((R) => {
              if (!(R.getIsPlaceholder() || R.column.columnDef.enableGrouping && !R.getIsGrouped() && (R.column.columnDef.id !== Mt || !n)))
                return /* @__PURE__ */ r(
                  Gt,
                  {
                    className: d(
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      j,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(Ue, {}) : /* @__PURE__ */ r(na, {})),
                          " ",
...
function Ko({
  ...
  const z = J(() => M.allBookIds.filter(
    ...
    (b, P = !1) => {
      ...
      const R = z.findIndex((Q) => Q === y.current), L = z.findIndex((Q) => Q === b);
      if (R === -1 || L === -1) return;
      const [lt, xt] = [
        Math.min(R, L),
        Math.max(R, L)
    ...
    (b) => {
      const P = hn(z, b).map((R) => R);
      n(
        cr(z, b, e) ? e.filter((R) => !P.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...P])]
      );
    },
    [e, n, z]
  ), K = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(ge, { open: N, onOpenChange: S, children: [
      /* @__PURE__ */ r(be, { asChild: !0, children: /* @__PURE__ */ l(
        j,
        {
          variant: "outline",
              ...
              Object.values(kt).map((b, P) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ l(Dn, { children: [
                    ...
                    P < Object.values(kt).length - 1 && /* @__PURE__ */ r(Jn, {})
                  ] }, b);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var P;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((P = o.get(b)) == null ? void 0 : P.localizedName) || M.bookIdToEnglishName(b) || b }, b);
      }),
...
function bi({
  ...
  const c = Dt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Dt(i, "%webView_scope_selector_current_book%"), m = Dt(i, "%webView_scope_selector_choose_books%"), h = Dt(i, "%webView_scope_selector_scope%"), x = Dt(i, "%webView_scope_selector_select_books%"), C = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: N.map(({ value: S, label: y, id: O }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: S, id: O }),
            /* @__PURE__ */ r(W, { htmlFor: O, children: y })
          ] }, O))
        }
      )
    ] }),
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Ut(w, [m, h]);
        break;
      case "alt+h":
        (S = c.current) == null || S.focus(), Ut(c, [m, h]);
        break;
    }
  }), ct(() => {
...
function Ti({
  ...
  const c = es(
    ...
    var N, S, y, O, z, I;
    const C = x !== h ? ((S = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : S[x]) ?? ((O = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : O.en) : void 0;
    return C ? `${(z = t[h]) == null ? void 0 : z.autonym} (${C})` : (I = t[h]) == null ? void 0 : I.autonym;
  };
...
const Di = pt.Trigger, bs = pt.Portal, Vi = pt.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Oi = at.Root, Ts = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Z();
  return /* @__PURE__ */ r(
    at.List,
    {
...
export {
  ...
  Vo as SidebarMenuSkeleton,
  Mo as SidebarMenuSub,
  zo as SidebarMenuSubButton,
  Oo as SidebarMenuSubItem,
