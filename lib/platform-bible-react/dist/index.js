...
import { c as b, g as Ae, a as Vr, C as tr, L as Kn, t as ks, u as tn, T as At, b as xt, d as yt, e as kt, f as Hn, A as ba, D as Be, h as Te, i as Fe, j as cr, k as Ge, B as tt, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Xe, r as Oe, p as Ts, q as qn, P as lr, s as Or, v as dr, w as wr, y as Oa, z as Da, E as Eo, F as ur, G as Ma, H as Pt, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as Gn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Ss, Z as Rs, _ as ir, $ as Ze, a0 as je, a1 as We, a2 as kr, a3 as Ro, a4 as Oo, a5 as ya, a6 as Do, a7 as Wn, a8 as Os, a9 as Ds, aa as Ms, ab as wo, ac as Yn, ad as Ia, ae as Is, af as Zn, ag as zs, ah as Ps, ai as As, aj as en, ak as $s, al as Vs, am as Ls, an as Xn, ao as Jn, ap as Mo, aq as Bs, ar as Qn, as as Ka, at as rn, au as Ha, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Ys, aE as Io, aF as zo, aG as Zs, aH as Xs } from "./resizable-CRV5w5Mp.js";
import { aI as _f, aJ as Nf, aK as Cf, aL as Ef, aM as Tf, aN as Sf, aO as Rf, aP as Of, aQ as Df, aR as Mf, aS as If, aT as zf, aU as Pf, aV as Af, aW as $f, aX as Vf, aY as Lf, aZ as Bf, a_ as Ff, a$ as jf, b0 as Uf, b1 as Kf, b2 as Hf, b3 as qf, b4 as Gf, b5 as Wf, b6 as Yf, b7 as Zf, b8 as Xf, b9 as Jf, ba as Qf, bb as tm, bc as em, bd as rm, be as am, bf as om, bg as nm, bh as im, bi as sm, bj as cm, bk as lm, bl as dm, bm as wm } from "./resizable-CRV5w5Mp.js";
import { jsx as a, jsxs as u, Fragment as gt } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as Je, Clock as an, ChevronsLeft as on, ChevronsRight as nn, ChevronUp as ti, ChevronDown as sr, ArrowLeft as Js, ArrowRight as Qs, BoldIcon as tc, ItalicIcon as ec, X as ei, AtSign as ri, Pencil as rc, Trash2 as ac, Undo2 as oc, ArrowUp as ai, MoreHorizontal as nc, MailOpen as ic, Mail as sc, FilterIcon as cc, ArrowLeftIcon as lc, ChevronLeftIcon as dc, ChevronRightIcon as wc, ArrowRightIcon as uc, Copy as oi, Filter as pc, User as hc, Link as gc, CircleHelp as fc, Undo as mc, Redo as vc, SquareX as ni, FunctionSquare as ii, SquareSigma as si, Ban as bc, AlertCircle as uo, CircleCheckIcon as xc, CircleXIcon as yc, CircleHelpIcon as kc, ArrowUpIcon as _c, ArrowDownIcon as Nc, ScrollText as Cc, ChevronRight as Ec, ChevronLeft as Tc, ChevronsUpDown as Sc, MenuIcon as Rc, Menu as Oc, EllipsisVertical as Dc, MoreVertical as Mc } from "lucide-react";
import { Section as zt, compareScrRefs as ka, getChaptersForBook as Ic, formatScrRef as $e, formatReplacementString as Ye, getSectionForBook as wa, formatRelativeDate as zc, sanitizeHtml as Po, NumberFormat as ci, formatBytes as Pc, getCurrentLocale as Ac, usfmMarkers as ua, isPlatformError as $c, ABORTED as Vc, getErrorMessage as Lc, getFormatCallerFunction as Bc, deepEqual as Fc, isString as sn, scrRefToBBBCCCVVV as qa, defaultScrRef as Ga, formatScrRefRange as jc, getLocalizeKeyForScrollGroupId as cn, formatReplacementStringToArray as ln, collectUsjMarkers as Uc } from "platform-bible-utils";
import Jt, { useRef as $, useMemo as z, createContext as Gr, useContext as za, useEffect as X, useState as N, useCallback as B, useId as _a, useImperativeHandle as Kc, useLayoutEffect as Qt, Fragment as Wr, Component as Hc, createElement as dn, Suspense as qc, forwardRef as Ao, memo as li } from "react";
import { IconSelector as di, IconCheck as Pa, IconChevronDown as Gc, IconChevronUp as Wc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Zc, IconChevronRight as wi, IconSearch as Xc, IconLoader as Jc, IconAlertOctagon as Qc, IconAlertTriangle as tl, IconInfoCircle as el, IconCircleCheck as rl } from "@tabler/icons-react";
import { createEditor as ui, $getRoot as Qe, $createParagraphNode as Yr, $getSelection as oe, HISTORY_MERGE_TAG as $o, ParagraphNode as pi, TextNode as hi, $getPreviousSelection as al, $isRangeSelection as Se, $caretFromPoint as ol, $getSiblingCaret as gi, $getChildCaret as nl, $getAdjacentChildCaret as il, $isChildCaret as sl, $normalizeCaret as cl, $setSelectionFromCaretRange as ll, $getCollapsedCaretRange as dl, $getCaretInDirection as wn, $splitAtPointCaretNext as wl, $isTextPointCaret as ul, $findMatchingParent as fi, $isElementNode as Kr, mergeRegister as Le, getDOMTextNode as pl, isHTMLElement as hl, CLEAR_EDITOR_COMMAND as mi, COMMAND_PRIORITY_EDITOR as Vo, shallowMergeConfig as gl, defineExtension as ge, safeCast as pr, createState as fl, FORMAT_TEXT_COMMAND as vi, $isNodeSelection as bi, COMMAND_PRIORITY_LOW as xi, RootNode as ml, LineBreakNode as vl, TabNode as bl, $isEditorState as xl, createCommand as yl, CLICK_COMMAND as kl, isDOMNode as _l, $getNodeFromDOMNode as Nl, $createNodeSelection as Cl, $setSelection as El, $getEditor as Tl, DecoratorNode as po, $getState as Sl, toggleTextFormatType as un, TEXT_TYPE_TO_FORMAT as Rl, $setState as Ol, addClassNamesToElement as yi, $create as Dl, $getNodeByKey as Ml, removeClassNamesFromElement as Il, KEY_TAB_COMMAND as zl, $isBlockElementNode as Pl, $createRangeSelection as Al, $normalizeSelection__EXPERIMENTAL as $l, OUTDENT_CONTENT_COMMAND as Vl, INDENT_CONTENT_COMMAND as pn, INSERT_TAB_COMMAND as Ll, COMMAND_PRIORITY_CRITICAL as Lo, $isDecoratorNode as Bl, $isParagraphNode as Fl, $isTextNode as ho, SELECTION_CHANGE_COMMAND as ki, $insertNodes as jl } from "lexical";
...
import { $generateHtmlFromNodes as Yl, $generateNodesFromDOM as Zl } from "@lexical/html";
import { Avatar as Bo, Select as te, Checkbox as hn, Slot as Zr, Tabs as xe, Menubar as De, ContextMenu as Ut, Progress as gn, Slider as oa, Switch as fn } from "radix-ui";
import { useReactTable as Ni, getFilteredRowModel as Xl, getSortedRowModel as Ci, getPaginationRowModel as Jl, getCoreRowModel as Ei, flexRender as Lr, getGroupedRowModel as Ql, getExpandedRowModel as td } from "@tanstack/react-table";
...
function Si({
  ...
  const m = $(!1), x = () => {
    ...
    () => Vr(e, d),
    [e, d]
  ), E = !!h && !p, C = `${T} (${y})`, A = E ? f || `${C}, ${h}` : C, j = /* @__PURE__ */ u(
    tr,
    {
      ref: t,
...
function pd({
  ...
  Di(), X(() => {
    ...
    const _ = (J) => !!J && J.scrollWidth > J.clientWidth, at = () => {
      Hn() !== "pointer" && (j || _(h.current) || _(d.current)) && E(!0);
    }, M = () => E(!1);
...
function md({
  ...
  const [h, f] = N(!1), [m, x] = N(!1), g = _a(), T = $(!1), y = w !== void 0, E = y ? w : h, C = n === "" ? "" : ae(n, gd), A = ae(s, fd), j = (D) => {
...
function bh(t, e, r = (n, s) => n === s, o = 15) {
  return (n) => {
    const s = t.filter(
      (c) => !r(c, n)
    ), i = [n, ...s.slice(0, o - 1)];
...
function Ya({
  ...
  const j = Oe(), K = ud(), [I, O] = N(!1), [D, W] = N(""), [Y, P] = N(""), [_, at] = N("books"), [M, H] = N(void 0), [J, F] = N(
    void 0
  ), [rt, wt] = N(void 0), [ct, Q] = N(!1), [ut, vt] = N(!1), [pt, _t] = N(!1), [Nt, Lt] = N(!1), se = $(null), ce = $(!1), Mt = $(void 0), Ct = $(void 0), qt = $(void 0), fe = $(void 0), ye = $({}), It = $({}), St = B(
    (v) => {
      e(v), d && d(v);
    },
    [e, d]
    ...
    () => _d(ne, le),
    [ne, le]
  ), R = Gt.has(t.book), G = z(() => Y.trim() ? vo(
    ee.filter((v) => Co(v, Y, s))
  ) : ut ? we : de, [
    de,
    we,
    ee,
    ...
    if (!k) return;
    const v = D.startsWith(`${k.book} `) ? D : "", q = na(v), it = Ar(v);
    return {
      book: k.book,
  ...
  const L = B(() => {
    ...
    (v) => {
      const q = J ?? (k == null ? void 0 : k.book), it = rt ?? (k == null ? void 0 : k.chapterNum);
      !q || !it || (St({
        book: q,
        chapterNum: it,
        verseNum: v
    ...
    at("books"), H(void 0), F(void 0), wt(void 0), Lt(!1), setTimeout(() => {
      var v;
      (v = Ct.current) == null || v.focus();
    }, 0);
  }, []), Wt = B(() => {
    const v = J;
    F(void 0), wt(void 0), v ? (H(v), at("chapters"), W("")) : Rt();
  }, [J, Rt]), Ot = B(
    (v) => {
      O(v), v && (at("books"), H(void 0), F(void 0), wt(void 0), P(""), Lt(!1), _t(!1), vt(R));
    },
    [R]
  );
  X(() => {
  ...
  const { otLong: _e, ntLong: rr, dcLong: ar, extraLong: Ue } = {
    ...
    [t.book, s, K]
  ), gr = `${t.chapterNum}:${t.verseNum}`, S = B((v) => (q) => {
    ye.current[v] = q;
  }, []), nt = B((v) => (q) => {
    It.current[v] = q;
  }, []), dt = z(
    () => xd(Y),
    [Y]
  ), Dt = z(() => !w || !k || !k.chapterNum || !dt ? !1 : w(k.book, k.chapterNum) > 0, [w, k, dt]), Ke = _ === "books" && !ct && !Y.trim() && Gt.size > 0, Ba = B(
    (v) => p ? vn(v, p) : !1,
    [p]
  ), Pe = B(
    (v) => (q) => p ? yd(v, q, p) : !1,
    ...
    (v) => {
      (v.key === "Home" || v.key === "End") && v.stopPropagation(), h && h.includes(v.key) && k && k.chapterNum !== void 0 && k.verseNum !== void 0 && (v.preventDefault(), v.stopPropagation(), L());
    },
    [h, k, L]
  ), aa = B(
    (v) => {
      ...
      if (!(!!q && !!((Xo = Mt.current) != null && Xo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
      ...
      const { isLetter: Bt, isDigit: Ht } = mn(v.key);
      ...
      if (!dd(v.key) || ct) return;
      if (_ === "books" && !Nt && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const Vt = q === Ct.current ? Ct.current : void 0, pe = (Vt == null ? void 0 : Vt.selectionStart) ?? 0, Yt = (Vt == null ? void 0 : Vt.selectionEnd) ?? 0, ve = j === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
    ...
    const { isLetter: q, isDigit: it } = mn(v.key);
    (q || it) && (v.preventDefault(), P((Tt) => Tt + v.key), (Ht = Ct.current) == null || Ht.focus(), Q(!1));
  }, []);
  Qt(() => {
    const v = setTimeout(() => {
    ...
    if (_ === "verses" && J && rt !== void 0) {
      const v = J === t.book && rt === t.chapterNum, q = v ? t.verseNum : 1;
      W(
        pa(J, rt, q)
      ), setTimeout(() => {
        if (qt.current)
  ...
  const et = k ? `${k.book} ${k.chapterNum ?? ""} ${k.verseNum ?? ""} ${Dt}` : "", $t = $(""), ue = $(""), me = z(() => {
            ...
            children: [
                      ...
                      ({ onClick: v, disabled: q, title: it, icon: Bt, group: Ht }, Tt) => {
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Wr, { children: [
                            Tt > 0 && Ht !== Et[Tt - 1].group && /* @__PURE__ */ a(Eo, {}),
                            q ? (
                ...
                /* @__PURE__ */ u(xt, { children: [
                  /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(
                    tt,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Jr,
                      children: j === "ltr" ? /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Qs, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
              ...
              !ct && /* @__PURE__ */ u(ur, { ref: qt, children: [
                _ === "books" && /* @__PURE__ */ u(gt, { children: [
                  ...
                  k && V && /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ u(
                    tr,
                    {
                      value: hd,
                      onSelect: L,
...
function yn({
  ...
  const [E, C] = N(!1), A = l ?? d, j = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], K = (I, O) => {
    ...
    /* @__PURE__ */ a(
      dr,
      {
        ...
        children: /* @__PURE__ */ u(wr, { children: [
          ...
          /* @__PURE__ */ a(ur, { children: j(e) ? e.map((I) => /* @__PURE__ */ a(Xe, { heading: I.groupHeading, children: I.options.map((O) => K(O, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(Xe, { children: e.map((I) => K(I)) }) })
        ] })
      }
    )
  ] });
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dd = zi ? Qt : X, sa = { tag: $o };
...
const Id = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : X;
...
const Ld = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : X;
function Bd(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Fd() {
  return function(t) {
    const [e] = Me(), r = z(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), s = $(o);
    return Ld(() => {
...
function Hd(t, e, r) {
  ...
  function d() {
    ...
    for (let T = 0; T < f.length; T++) {
      const y = f[T], E = i[T] || document.createElement("div"), C = E.style;
      ...
      const I = Ee(y.height);
      C.height !== I && (E.style.height = I, g = !0), E.parentNode !== c && (c.append(E), g = !0), i[T] = E;
    }
...
function Gd(t, e = qd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = h.getNode(), x = m.getKey(), g = h.offset, T = f.getNode(), y = T.getKey(), E = f.offset, C = t.getElementByKey(x), A = t.getElementByKey(y), j = r === null || C !== o || g !== n || x !== r.getKey(), K = s === null || A !== i || E !== c || y !== s.getKey();
      if ((j || K) && C !== null && A !== null) {
        const I = function(O, D, W, Y, P, _, at) {
          const M = (O._window ? O._window.document : document).createRange();
          return M.setStart(...kn(D, W, Y)), M.setEnd(...kn(P, _, at)), M;
        }(t, h, m, C, f, T, A);
        d(), d = Hd(t, I, e);
      }
      r = m, o = C, n = g, s = T, i = A, c = E;
    });
  }
...
function Zd(t) {
  ...
  if (Se(e)) r = ol(e.focus, "next");
    ...
    r = r || nl(Qe(), "previous").getFlipped().insert(Yr());
  }
...
Xt.prototype.brand = Qd, Xt.prototype.h = function() {
  return !0;
...
}, dependencies: [ko], name: "@lexical/extension/NodeSelection" }), pw = yl("INSERT_HORIZONTAL_RULE_COMMAND");
class Cr extends po {
  static getType() {
...
function fw(t, e, r = qi) {
  return Le(t.registerCommand(zl, (o) => {
    const n = oe();
    if (!Se(n)) return !1;
    o.preventDefault();
    const s = function(i) {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Se(m)) {
                ...
                if (ho(g) && l >= 0 && w >= 0 && (T = l, y = l + w, m.setTextNodeRange(g, T, g, y)), T === y && p === "" || (m.insertRawText(p), g = x.getNode()), ho(g)) {
                  T = h, y = h + f;
                  const E = g.getTextContentSize();
                  T = T > E ? E : T, y = y > E ? E : y, m.setTextNodeRange(g, T, g, y);
                }
...
const qo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : X;
...
function Lw() {
  const { activeEditor: t } = Xi(), [e, r] = N([]), o = B((n) => {
    if (Se(n) || Wl(n)) {
      const s = [];
      Mn.forEach(({ format: i }) => {
...
function Uw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), s = Zl(e, n);
      Qe().clear(), jl(s);
    },
    {
      discrete: !0
...
const Kw = "verseText", _h = Object.freeze([
...
function Nh({
  ...
  const [s, i] = N(qw), [c, d] = N(n), [l, w] = N(!1), p = $(void 0), h = $(null);
  X(() => {
    let g = !0;
    const T = h.current;
    if (!T) return;
...
function Pn({
  ...
  const [w, p] = N(), h = d ?? w, m = h !== void 0 && o, x = l !== void 0, g = B(
    (P) => {
      x || p(P), l == null || l(P);
    },
    [x, l]
  ...
  }, [t.date, r]), j = z(() => t.user, [t.user]), K = z(
    () => t.user.split(" ").map((P) => P[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), I = z(() => Po(t.contents), [t.contents]), O = z(
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Zw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Xw, { className: "tw:text-xs tw:font-medium", children: K }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          m && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (P) => {
                P.key === "Escape" ? (P.preventDefault(), P.stopPropagation(), E()) : Wo(P) && (P.preventDefault(), P.stopPropagation(), ie(h) && C());
              },
              onKeyDown: (P) => {
                Go(P), (P.key === "Enter" || P.key === " ") && P.stopPropagation();
              },
              onClick: (P) => {
                P.stopPropagation();
              },
        ...
        W && /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(tt, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(nc, {}) }) }),
...
const Jw = {
  ...
  var gr;
  const [at, M] = N({}), H = P ?? at, J = H.editorState ?? Jw, F = H.assignedUser, rt = _ !== void 0, wt = $(H);
  wt.current = H;
  const ct = B(
    (S) => {
      const nt = { ...wt.current, ...S };
      wt.current = nt, rt || M(nt), _ == null || _(l, zn(nt) ? void 0 : nt);
    },
    [rt, _, l]
  ), Q = B(
    (S, nt) => {
    ...
    [H.commentEdits, ct]
  ), [ut, vt] = N(), pt = n, [_t, Nt] = N(!1), [Lt, se] = N(!1), [ce, Mt] = N(!1), [Ct, qt] = N(!1), [fe, ye] = N(!1), [It, St] = N(A), [ne, le] = N(!1), de = $(void 0), [we, ee] = N(/* @__PURE__ */ new Map());
  X(() => {
    let S = !0;
    return (async () => {
  ...
  G.current = l, X(() => () => {
    var nt;
    const { current: S } = wt;
    S.assignedUser !== void 0 && S.assignedUser === Gt.current && S.editorState === void 0 && !$r(S.commentEdits) && ((nt = R.current) == null || nt.call(R, G.current, void 0));
  }, []);
  const k = z(
  ...
  const L = z(() => k[0], [k]), ot = $(null), lt = $(void 0), st = B(() => {
    var S;
  ...
  const mt = z(
    ...
    if (_t || Ot <= 2)
      return Wt;
    const S = new Set(Wt.slice(-2).map((nt) => nt.id));
    return Wt.filter(
      (nt) => {
        var dt;
  ...
  const Ue = B(
    ...
    async (S) => {
      const nt = ie(J) ? Sa(J) : void 0, dt = S.status ? S.assignedUser : F ?? S.assignedUser, Dt = await h({
        ...S,
        contents: nt,
        assignedUser: dt
      });
  ...
  const Ne = !Ct || !g || g.length === 0 || !g.includes(c), hr = !ie(J) && (F === void 0 || F === ut), Xr = /* @__PURE__ */ a(
    Pn,
    {
      comment: L,
      localizedStrings: o,
      ...
      handleDeleteComment: m,
      onEditingChange: se,
      canEditOrDelete: (!Z && we.get(L.id)) ?? !1,
      canUserResolveThread: fe,
      draftEditorState: (gr = H.commentEdits) == null ? void 0 : gr[L.id],
      onDraftEditorStateChange: (S) => Q(L.id, S)
    }
  );
  return /* @__PURE__ */ a(
    Ww,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              tt,
              {
                ...
                children: It ? /* @__PURE__ */ a(ic, {}) : /* @__PURE__ */ a(sc, {})
              }
            ),
            W === void 0 ? (
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("span", { className: e, children: [
                  L.contextBefore,
                  /* @__PURE__ */ a("span", { className: "tw:font-bold", children: L.selectedText }),
                  L.contextAfter
                ] })
              ]
            }
          ...
          n && /* @__PURE__ */ u(gt, { children: [
            ...
            T !== !1 && (!Z || ie(J)) && /* @__PURE__ */ a(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  Wo(S) && (S.preventDefault(), S.stopPropagation(), (ie(J) || F !== void 0 && F !== ut) && Ue());
                },
                onKeyDown: (S) => {
                ...
                children: /* @__PURE__ */ a(
                  Ta,
                  {
                    ...
                    actions: /* @__PURE__ */ u(gt, { children: [
                      F !== void 0 && (ie(J) || F !== ut) ? /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ye(
                        he(
                          "%comment_assigning_to%",
                          o,
...
function eu({
  ...
  const [i, c] = N("accept"), d = _a(), l = _a(), w = r === "loading", p = r === "accept", h = r === "none", f = r === "acceptRejectOrMerge", m = p ? "accept" : i, x = z(
    () => ma(t.rejectedText ?? ""),
    [t.rejectedText]
  ), g = z(
    () => ma(t.acceptedText ?? ""),
  ...
  const D = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: D }), Y = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : W, P = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(va, { html: T }) : W : Y(M === "reject" ? t.rejectedResultText : t.resultText);
  }, _ = (M) => p && M.value === "reject", at = (M) => {
    const H = m === M.value, J = `${l}-${M.value}`, F = _(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(gt, { children: [
        ...
        /* @__PURE__ */ a(
          To,
          {
            ...
            children: j.map((M) => _(M) ? /* @__PURE__ */ a(At, { delayDuration: 0, children: /* @__PURE__ */ u(xt, { children: [
...
const iu = li(function(e) {
  const {
    ...
    [d]
  ), { conflictOptions: w, isResolving: p, resolve: h, resolvedResolution: f, showResolveCheck: m } = nu({
    threadId: s,
    threadStatus: i,
    isSelected: n,
    activeComments: d,
...
function Ih({
  ...
  const [C, A] = N(/* @__PURE__ */ new Set()), [j, K] = N(), [I, O] = N(), D = B(
    async (F) => {
      const rt = await s(F);
      return rt !== void 0 && F.assignedUser !== void 0 && F.assignedUser !== "" && O(F.assignedUser), rt;
    },
    [s]
  );
  X(() => {
    m && (A((F) => new Set(F).add(m)), K(m));
  }, [m]);
  const W = r.filter(
    (F) => F.comments.some((rt) => !rt.deleted)
  ), Y = W.map((F) => ({ id: F.id })), P = B(
    (F) => {
      A((rt) => new Set(rt).add(F.id)), K(F.id), x == null || x(F.id);
    },
    [x]
  ), _ = B(
    (F) => {
      ...
      }), K(F), x == null || x(rt ? void 0 : F);
    },
    [C, x]
  ), { listboxRef: at, activeId: M, handleKeyDown: H } = Ss({
    options: Y,
    onOptionSelect: P
  }), J = B(
    (F) => {
      F.key === "Escape" ? (j && C.has(j) && (A((rt) => {
        const wt = new Set(rt);
        return wt.delete(j), wt;
      }), K(void 0), x == null || x(void 0)), F.preventDefault(), F.stopPropagation()) : H(F);
    },
    [j, C, H, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: W.map((F) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: F.type === "Conflict" ? /* @__PURE__ */ a(iu, { ...rt, conflictResolution: T }) : /* @__PURE__ */ a(is, { ...rt })
          },
          F.id
        );
      })
...
const su = Ao(
  function({ area: e, ...r }, o) {
    return /* @__PURE__ */ a(Rs, { area: e, children: /* @__PURE__ */ a(
      "div",
      {
        ref: o,
        ...r,
...
function pu({
  ...
  var j;
  const [w, p] = N([]), [h, f] = N([]), [m, x] = N({}), [g, T] = N({}), y = z(() => e ?? [], [e]), E = Ni({
    data: y,
    columns: t,
    getCoreRowModel: Ei(),
  ...
  return d ? A = Array.from({ length: 10 }).map((O, D) => `skeleton-row-${D}`).map((O) => /* @__PURE__ */ a(We, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(kr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(yr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, O)) : ((j = E.getRowModel().rows) == null ? void 0 : j.length) > 0 ? A = E.getRowModel().rows.map((K) => /* @__PURE__ */ a(
    ...
    n && /* @__PURE__ */ a(cu, { table: E }),
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Oo, { stickyHeader: s, children: E.getHeaderGroups().map((K) => /* @__PURE__ */ a(We, { children: K.headers.map((I) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Lr(I.column.columnDef.header, I.getContext()) }, I.id)) }, K.id)) }),
      /* @__PURE__ */ a(Do, { children: A })
    ] }),
...
function Cu({
  ...
  const n = $(null), s = $(null), i = $(!1), [c, d] = N(t), [l, w] = N(e), [p, h] = N(!1), f = $(!1), m = $(c);
  m.current = c;
  const x = $(l);
  x.current = l, X(() => {
    d(t);
  ...
  const g = (y) => {
    ...
    var E, C, A, j;
    y.stopPropagation(), document.activeElement === s.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((E = n.current) == null || E.focus(), i.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), i.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((A = n.current) == null ? void 0 : A.selectionStart) === 0 && ((j = s.current) == null || j.focus(), i.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
...
function Uh({
  ...
  var Gt;
  const h = $(null), f = $(null), m = $(null);
  Qt(() => {
    if (!m.current) return;
    const R = parseFloat(getComputedStyle(m.current).width);
    R > 0 && (m.current.style.width = `${R}px`);
  }, []);
  const [x, g] = N("generated"), [T, y] = N("generated"), [E, C] = N("*"), [A, j] = N("*"), [K, I] = N("f"), [O, D] = N(!1), [W, Y] = N(!0), [P, _] = N(!1), at = $(!1), M = $(""), [H, J] = N(!1), F = yu(), [rt, wt] = N(), ct = $(null), Q = $(
    void 0
  ), ut = $(0), vt = $(void 0), pt = z(
    () => ({
      ...i,
  ...
  const Nt = B(() => {
    var V, Z, L;
    const R = (V = f.current) == null ? void 0 : V.querySelector(".editor-input"), G = R == null ? void 0 : R.querySelector("span.note"), k = (L = (Z = f.current) == null ? void 0 : Z.ownerDocument.getSelection()) == null ? void 0 : L.anchorNode;
  ...
  X(() => {
    ...
    if (V && Ir("note", V)) {
      const ot = (Z = V.insert.note) == null ? void 0 : Z.caller;
      let lt = "custom";
      ot === go ? lt = "generated" : ot === fo ? lt = "hidden" : ot && (C(ot), j(ot)), g(lt), y(lt), I(((L = V.insert.note) == null ? void 0 : L.style) ?? "f"), R = setTimeout(() => {
        var st, bt, Et;
        (st = h.current) == null || st.applyUpdate([V]), (bt = h.current) == null || bt.selectNote(0), (Et = h.current) == null || Et.focus(), G = requestAnimationFrame(() => {
          k = setTimeout(() => {
            var mt, Rt;
  ...
  const Lt = B(
    (R = !1) => {
      var k, V, Z;
      p == null || p();
      const G = (V = (k = h.current) == null ? void 0 : k.getNoteOps(0)) == null ? void 0 : V.at(0);
    ...
    (R, G) => {
      var Z, L, ot;
      const k = (L = (Z = h.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : L.at(0);
      if (!k || !Ir("note", k) || !k.insert.note) return;
      let V;
      R === "custom" ? V = G : R === "generated" ? V = go : V = fo, k.insert.note.caller !== V && (k.insert.note.caller = V, (ot = h.current) == null || ot.applyUpdate([k, { delete: 1 }]));
    },
    []
  ), ce = B(() => {
    var R;
    Q.current || (R = h.current) == null || R.commitPendingMarkerEdits(), Lt(!0), o();
  }, [o, Lt]), Mt = $(ce);
  Qt(() => {
    Mt.current = ce;
  });
  ...
  const qt = () => {
    ...
    if (G && Ir("note", G)) {
      ...
      const lt = (L = (Z = G.insert.note) == null ? void 0 : Z.contents) == null ? void 0 : L.ops;
      K !== "x" && R === "x" ? lt == null || lt.forEach((st) => Pu(st)) : K === "x" && R !== "x" && (lt == null || lt.forEach((st) => Au(st))), (ot = h.current) == null || ot.applyUpdate([G, { delete: 1 }]);
    }
  }, It = (R) => {
    ...
    (R) => {
      ...
      if (G && Ir("note", G)) {
        ...
        const lt = (Z = G.insert.note) == null ? void 0 : Z.style, st = (ot = (L = G.insert.note) == null ? void 0 : L.contents) == null ? void 0 : ot.ops;
        if (lt || D(!1), D(
    ...
    (R, G, k) => {
      ...
      Ps({
        ...
        clearSessionIfCurrent: (L) => en(Q, L),
        ...
        restoreSelectionIfLost: () => {
          var L, ot, lt;
          if (!((L = h.current) != null && L.getSelection())) {
            const st = vt.current;
        ...
        applyItem: (L) => {
          var ot;
          return (ot = h.current) == null ? void 0 : ot.applyMarkerMenuSelection(L, {
            trigger: "backslash",
        ...
        onShowError: (L) => {
          (!$c(L) || L.code !== Vc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Lc(L)}`
          );
        }
      });
    },
    ...
    (R) => {
      ...
      As(R, G, {
        ...
        commitTyped: (V) => {
          var Z;
          return (Z = h.current) == null ? void 0 : Z.commitTypedMarker(V);
        },
        commitTypedAndReopen: (V) => {
          var Z;
          (Z = h.current) == null || Z.commitTypedMarker(V, { trailingSpace: !1 }), we();
        },
        commitTypedCloser: (V) => {
          var Z;
          return (Z = h.current) == null ? void 0 : Z.commitTypedCloser(V);
        },
        commitItem: (V) => {
          var L;
          const Z = G.items.find((ot) => ot.marker === V);
          Z && ((L = h.current) == null || L.applyMarkerMenuSelection(Z, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  X(() => {
    ...
    const R = (G) => {
      ...
      const V = (L = h.current) == null ? void 0 : L.getSelection();
      V && (vt.current = V);
    };
    ...
    const R = () => {
      var V;
      return ((V = f.current) == null ? void 0 : V.querySelector(".editor-input")) ?? void 0;
    };
    if (((k = pt.view) == null ? void 0 : k.markerMode) === "editable") {
      const V = (L) => {
        ...
        if (L.key === "Enter" && !Nt()) {
          L.preventDefault(), L.stopPropagation(), (st = h.current) == null || st.selectNote(0), (bt = h.current) == null || bt.focus();
          return;
        }
        if (w && L.key === c) {
          if (!Nt()) {
            L.preventDefault(), L.stopPropagation(), (Et = h.current) == null || Et.selectNote(0), (mt = h.current) == null || mt.focus();
            return;
          }
          we() && (L.preventDefault(), L.stopPropagation());
        }
      }, Z = () => {
        var ot, lt;
        const L = R();
        !L || document.activeElement !== L || Nt() || ((ot = h.current) == null || ot.selectNote(0), (lt = h.current) == null || lt.focus());
      };
      return document.addEventListener("keydown", V, { capture: !0 }), document.addEventListener("paste", Z, { capture: !0 }), () => {
        document.removeEventListener("keydown", V, { capture: !0 }), document.removeEventListener("paste", Z, { capture: !0 });
      };
    }
    const G = (V) => {
      const Z = R();
      !H && Z && document.activeElement === Z && V.key === c ? (V.preventDefault(), ne()) : H && V.key === "Escape" && (V.preventDefault(), J(!1));
    };
    ...
    const R = () => {
      var V, Z, L;
      const G = ((V = f.current) == null ? void 0 : V.querySelector(".editor-input")) ?? void 0;
      if (!G || document.activeElement !== G) return;
      const k = document.getSelection();
      k && !k.isCollapsed || Nt() || ((Z = h.current) == null || Z.selectNote(0), (L = h.current) == null || L.focus());
    };
  ...
  return /* @__PURE__ */ u(gt, { children: [
    ...
    /* @__PURE__ */ u(lr, { open: H, children: [
      /* @__PURE__ */ a($s, { virtualRef: F.virtualRef }),
      /* @__PURE__ */ a(
        dr,
        {
...
function Bu({
  ...
  /* @__PURE__ */ a("span", { className: b("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Yo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, m = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", T = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", E = b(g, T);
  return /* @__PURE__ */ u(gt, { children: [
...
function Hh({
  ...
  const p = l ?? Bc(r, void 0), h = (C, A) => {
    w == null || w(C, A, n);
  }, f = s ? r.findIndex((C) => C === s) : -1, [m, x] = N(f), g = (C, A, j) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
...
const Uu = (t) => {
  ...
  return e ? e[1] : "";
}, Hu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Jh = Object.freeze([
...
function Qh({
  ...
  const f = Ce(r, "%webView_inventory_all%"), m = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), T = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), E = Ce(r, "%webView_inventory_scope_verse%"), C = Ce(r, "%webView_inventory_filter_text%"), A = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), j = Ce(r, "%webView_inventory_no_results%"), [K, I] = N(!1), [O, D] = N("all"), [W, Y] = N(""), [P, _] = N([]), at = z(() => {
    const Q = t ?? [];
    return Q.length === 0 ? [] : Gu(Q, n, s);
  }, [t, n, s]), M = z(() => {
    if (K) return at;
    const Q = [];
  ...
  }, [K, at]), H = z(() => M.length === 0 ? [] : qu(M, O, W), [M, O, W]), J = z(() => {
    var vt, pt;
    if (!K) return d;
...
const Wu = "16rem", Yu = "3rem", cs = Jt.createContext(void 0);
function La() {
...
function Zu({
  ...
  const [d, l] = Jt.useState(t), w = e ?? d, p = Jt.useCallback(
    ...
    [r, w]
  ), h = Jt.useCallback(() => p((E) => !E), [p]), f = w ? "expanded" : "collapsed", g = Oe() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = Jt.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
...
function tg({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    tt,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Yc, {}) : /* @__PURE__ */ a(Zc, {}),
...
function ap({
  ...
  const c = t ? Zr.Root : "button", { state: d } = La(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: b(rp({ variant: r, size: o }), s),
      ...i
    }
  );
...
function hg({
  ...
  X(() => {
    if (c) {
      const O = T.getSelectedRowModel().rowsById, D = Object.keys(O);
      if (D.length === 1) {
        const W = x.find((Y) => jn(Y) === D[0]) || void 0;
        W && c(W);
      }
    }
  }, [f, x, c, T]);
  const y = n ?? cp, E = s ?? ls, C = [
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(lu, { children: C.map((O) => /* @__PURE__ */ a(be, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Oo, { children: T.getHeaderGroups().map((O) => /* @__PURE__ */ a(We, { children: O.headers.filter((D) => D.column.columnDef.header).map((D) => (
      ...
      /* @__PURE__ */ a(Do, { children: T.getRowModel().rows.map((O, D) => {
        const W = Oe();
        return /* @__PURE__ */ a(
          We,
          {
                    ...
                    children: Y.getIsGrouped() ? /* @__PURE__ */ u(
                      tt,
                      {
                        ...
                        children: [
                          ...
                          !O.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Ec, {}) : /* @__PURE__ */ a(Tc, {})),
                          " ",
...
function up({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: m, extraLong: x } = {
  ...
  }, [g, T] = N(!1), [y, E] = N(""), C = $(void 0), A = $(!1), j = z(
    () => Jn(t),
    [t]
  ), K = z(() => {
    if (!y.trim()) {
    ...
    (_, at = !1) => {
      ...
      const M = j.findIndex((wt) => wt === C.current), H = j.findIndex((wt) => wt === _);
      if (M === -1 || H === -1) return;
      const [J, F] = [
        Math.min(M, H),
        Math.max(M, H)
      ], rt = j.slice(J, F + 1).map((wt) => wt);
      r(
    ...
    () => Object.values(zt).filter(
      (_) => (s == null ? void 0 : s[_]) !== void 0 && Mo(j, _).length === 0
...
function fg({
  ...
  const j = Ft(
  ...
  ] }), pt = e ? ut.filter((U) => e.includes(U.value)) : ut, _t = g ?? Ga, Nt = h ?? _t, Lt = f ?? _t, se = () => {
  }, ce = $(null), Mt = $(null), Ct = $(!1), qt = $(null), fe = $(!1), [ye, It] = N(void 0), St = $(!1), ne = $(!1), le = $(null), de = B((U) => {
    if (U) {
    ...
    [r, n, g, s]
  ), R = pt.find((U) => U.value === t), G = () => t === "selectedBooks" && n.length > 0 ? n.map((U) => U.toUpperCase()).join(", ") : t === "range" ? jc(Nt, Lt, {
  ...
  ), V = pt.find((U) => U.value === "selectedBooks"), Z = pt.find((U) => U.value === "range"), [L, ot] = N(!1), [lt, st] = N(void 0), [bt, Et] = N(void 0), [mt, Rt] = N(void 0), [Wt, Ot] = N(void 0), [ke, Ie] = N([]), _e = p === "dropdown" && lt === "selectedBooks", rr = /* @__PURE__ */ a(
    gp,
    {
      availableBookInfo: o,
  ...
  ), ar = ye === "end", Ue = ye === "start", ze = "tw:text-muted-foreground", Ne = p === "dropdown" && lt === "range", hr = Ne ? Rt : ee, gr = Ne ? Ot : x ? Kt : se, S = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-start", className: b(ar && ze), children: J }),
      /* @__PURE__ */ a(
        Ya,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ce, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Pt, { htmlFor: "scope-range-end", className: b(Ue && ze), children: F }),
      /* @__PURE__ */ a(
        Ya,
        {
          id: "scope-range-end",
  ...
  }, []), aa = (U) => t === U ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Pt, { children: _ }),
      p === "dropdown" ? /* @__PURE__ */ u(Be, { open: L, onOpenChange: ot, children: [
    ...
    p === "radio" && t === "range" && S,
    p === "dropdown" && V && /* @__PURE__ */ a(io, { open: lt === "selectedBooks", onOpenChange: vr, children: /* @__PURE__ */ a(
      so,
      {
        ref: fr,
        onCloseAutoFocus: ra,
...
function No({
  ...
  Di();
  const h = $(null), f = () => js(h.current ?? void 0);
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        children: w.map(({ columnKey: m, label: x }, g) => {
          const T = `${l}-${m}`;
          return /* @__PURE__ */ u(Wr, { children: [
            /* @__PURE__ */ u(Wn, { "aria-labelledby": p ? T : void 0, children: [
              p && /* @__PURE__ */ a(cr, { id: T, children: x }),
              /* @__PURE__ */ a(At, { children: ps(e.groups, e.items, m, t) })
            ] }),
...
const yp = Object.freeze([520, 420, 340]), gs = Jt.forwardRef(
...
const kp = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  xe.Trigger,
  {
    ref: r,
    ...e,
...
function Eg({
  ...
  const l = Ap(
    ...
    var T, y, E, C, A, j;
    const g = x !== m ? ((y = (T = t[m]) == null ? void 0 : T.uiNames) == null ? void 0 : y[x]) ?? ((C = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : C.en) : void 0;
    return g ? `${(A = t[m]) == null ? void 0 : A.autonym} (${g})` : (j = t[m]) == null ? void 0 : j.autonym;
  };
...
function Og({
  ...
  const c = t ? ln(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = Bp(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: i });
...
function Ig({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = z(() => {
    const c = new ci(o);
    return (d) => c.format(d);
...
function lf({
  ...
  return /* @__PURE__ */ a(
    xe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: b("pr-twp", Up({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
const Hp = (t, e, r = {}) => {
  ...
  const [e, r] = N(!1), [o, n] = N(!1), [s, i] = N(0), c = $(void 0), d = z(() => {
    if (!t) return;
    const h = async () => {
      try {
        const f = await t();
...
function ff(t) {
  const e = z(() => Uc(t).slice().sort().join(" "), [t]);
...
function bf({ value: t, children: e }) {
...
Wp(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Mh as AvatarImage,
  xh as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  ...
  Tf as CONTENT_ZOOM_CSS_VARIABLE_PREFIX,
  Sf as CONTENT_ZOOM_DEFAULT_CSS_VARIABLE,
  Rf as CONTENT_ZOOM_POPUP_ATTRIBUTE,
  Of as CONTENT_ZOOM_ROOT_ATTRIBUTE,
  ...
  Fh as Footer,
  Uh as FootnoteEditor,
  Bu as FootnoteItem,
  Hh as FootnoteList,
  Tg as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Jh as INVENTORY_STRING_KEYS,
  Ia as Input,
  Sg as InterfaceLanguagePicker,
  Qh as Inventory,
  wo as Kbd,
  Uf as KbdGroup,
  Pt as Label,
  Kf as MAIN_CONTENT_ZOOM_AREA_ID,
  Ru as MARKER_MENU_STRING_KEYS,
  Ah as MarkdownRenderer,
  Mu as MarkerMenu,
  Bh as MoreInfo,
  Ms as MultiSelectComboBox,
  _g as NavigationContentSearch,
  lr as Popover,
  $s as PopoverAnchor,
  ...
  Zf as ResizablePanelGroup,
  Dg as ResultsCard,
  Xf as RetryableErrorView,
  gg as SCOPE_SELECTOR_STRING_KEYS,
  fp as SELECT_BOOKS_STRING_KEYS,
  Br as SHRINK_STEP,
  fg as ScopeSelector,
  hg as ScriptureResultsViewer,
  mg as ScrollGroupSelector,
  Xn as SearchBar,
  Er as Select,
  gp as SelectBooks,
  ...
  pg as SettingsSidebarContentSearch,
  Aa as ShrinkStepContext,
  bf as ShrinkStepOverride,
  Ri as ShrinkStepOverrideContext,
  Xu as Sidebar,
  Qu as SidebarContent,
  og as SidebarFooter,
  Ln as SidebarGroup,
  ig as SidebarGroupAction,
  ...
  dg as SidebarMenuSub,
  ug as SidebarMenuSubButton,
  wg as SidebarMenuSubItem,
  Zu as SidebarProvider,
  eg as SidebarRail,
  ng as SidebarSeparator,
  tg as SidebarTrigger,
  yr as Skeleton,
  nf as Slider,
  of as Sonner,
  Jf as Spinner,
  sf as Switch,
  xf as TOOLTIP_DELAY_MS,
  ...
  pm as sonner,
  wm as useContentZoomArea,
  uf as useEvent,
  pf as useEventAsync,
  ff as useExtraValidMarkers,
  Ss as useListbox,
  yu as useLivePopoverAnchor,
  Hp as usePromise,
  bh as useRecentSearches,
  hf as useRetryablePromise,
  mf as useRunWhenVisible,
  hs as useShrinkStep,
  Oi as useShrinkStepOverride,
  ud as useShrinkStepValue,
  La as useSidebar,
  gf as useStylesheet,
  vf as useTabIconSelection,
