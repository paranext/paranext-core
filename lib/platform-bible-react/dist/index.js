import { jsx as r, jsxs as l, Fragment as ee } from "react/jsx-runtime";
import p, { useState as A, useRef as U, useMemo as H, useCallback as I, useLayoutEffect as hn, createContext as Rr, useContext as Er, useEffect as Mt, forwardRef as Sn, Fragment as Tn } from "react";
import { formatScrRef as Qt, getChaptersForBook as Vr, NumberFormat as Dr, formatBytes as Mr, deepEqual as Ue, isString as Ve, compareScrRefs as Ie, scrRefToBBBCCCVVV as De, getLocalizeKeyForScrollGroupId as B } from "platform-bible-utils";
import { X as qe, Search as Rn, ChevronLeft as je, ChevronRight as ne, ChevronsLeft as fn, ChevronsRight as gn, ArrowLeft as zr, Circle as Je, ChevronsUpDown as Ke, Check as At, FilterIcon as Or, ChevronDown as be, ChevronUp as Br, ArrowLeftIcon as Ar, ChevronLeftIcon as Pr, ChevronRightIcon as Ir, ArrowRightIcon as jr, Copy as $r, Filter as Xr, User as Fr, Link as Gr, CircleHelp as Lr, Star as Hr, CircleCheckIcon as Yr, CircleXIcon as Ur, CircleHelpIcon as qr, ArrowUpIcon as Jr, ArrowDownIcon as Kr, ArrowUpDownIcon as Wr, PanelLeft as Zr, PanelRight as Qr, ScrollText as ta, MenuIcon as ea, Menu as na, EllipsisVertical as ra, LoaderCircle as aa } from "lucide-react";
...
import { useReactTable as Vn, getFilteredRowModel as ia, getSortedRowModel as Dn, getPaginationRowModel as wa, getCoreRowModel as Mn, flexRender as te, getGroupedRowModel as la, getExpandedRowModel as da } from "@tanstack/react-table";
...
import pa from "markdown-to-jsx";
...
import * as Zt from "@radix-ui/react-slider";
import * as Fe from "@radix-ui/react-switch";
var ha = Object.defineProperty, fa = (t, e, n) => e in t ? ha(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => fa(t, typeof e != "symbol" ? e + "" : e, n);
const zt = [
  "GEN",
  "EXO",
  "LEV",
...
const M = {
  ...
  extraBooks: Na,
  bookNumberToId: Qe,
  bookNumberToEnglishName: In,
  bookIdToEnglishName: ka,
  isCanonical: jn,
  isExtraMaterial: Ca,
  isObsolete: _a
};
...
R(ot, "Original", new ot(ht.Original)), R(ot, "Septuagint", new ot(ht.Septuagint)), R(ot, "Vulgate", new ot(ht.Vulgate)), R(ot, "English", new ot(ht.English)), R(ot, "RussianProtestant", new ot(ht.RussianProtestant)), R(ot, "RussianOrthodox", new ot(ht.RussianOrthodox));
let Et = ot;
function vn(t, e) {
  const n = e[0];
...
const nt = class V {
    ...
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof V) {
          ...
          if (e == null) return;
          const s = e instanceof Et ? e : V.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Et(i)), n ? new V(n, a.toString(), w, u) : new V();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Et(ht[i]);
        } catch {
...
R(nt, "defaultVersification", Et.English), R(nt, "verseRangeSeparator", "-"), R(nt, "verseSequenceIndicator", ","), R(nt, "verseRangeSeparators", [nt.verseRangeSeparator]), R(nt, "verseSequenceIndicators", [nt.verseSequenceIndicator]), R(nt, "chapterDigitShifter", 1e3), R(nt, "bookDigitShifter", nt.chapterDigitShifter * nt.chapterDigitShifter), R(nt, "bcvMaxValue", nt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
R(nt, "ValidStatusType", $n);
class Kt extends Error {
}
const Ta = sa({ prefix: "tw-" });
function d(...t) {
  return Ta(oa(t));
}
const Ra = _t(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Gt : "button", { className: d(Ra({ variant: e, size: n, className: t })), ref: s, ...o })
);
z.displayName = "Button";
const Ea = "layoutDirection";
function J() {
  const t = localStorage.getItem(Ea);
  return t === "rtl" ? t : "ltr";
}
const Va = ft.Portal, Xn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
Xn.displayName = ft.Overlay.displayName;
...
Da.displayName = ft.Content.displayName;
...
Ma.displayName = ft.Title.displayName;
...
le.displayName = rt.Input.displayName;
...
de.displayName = rt.List.displayName;
const xe = p.forwardRef((t, e) => /* @__PURE__ */ r(rt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
xe.displayName = rt.Empty.displayName;
...
Dt.displayName = rt.Group.displayName;
...
Fn.displayName = rt.Separator.displayName;
const Nt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Item,
  {
    ref: n,
    className: d(
...
const ce = re.Root, pe = re.Trigger, Yt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = J();
...
const Gn = M.allBookIds.filter(
  (t) => !M.isObsolete(M.bookIdToNumber(t))
), wt = Object.fromEntries(
  Gn.map((t) => [t, M.bookIdToEnglishName(t)])
), Oa = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
...
function qs({
  ...
  const o = J(), [s, i] = A(!1), [w, u] = A(""), [c, m] = A(""), [b, h] = A("books"), [f, x] = A(void 0), k = U(void 0), y = U(void 0), _ = U(void 0), N = U(void 0), D = U({}), O = H(() => a ? a() : Gn, [a]), K = H(() => ({
    OT: O.filter((C) => M.isBookOT(C)),
    NT: O.filter((C) => M.isBookNT(C)),
    DC: O.filter((C) => M.isBookDC(C)),
    Extra: O.filter((C) => M.extraBooks().includes(C))
  }), [O]), G = H(() => Object.values(K).flat(), [K]), St = H(() => {
    if (!c.trim()) return K;
    const v = c.toLowerCase(), C = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((Q) => {
      C[Q] = K[Q].filter((Y) => wt[Y].toLowerCase().includes(v) || Y.toLowerCase().includes(v));
    }), C;
  }, [K, c]), S = I(
    (v) => {
      if (!v.trim()) return;
      const C = Ba.reduce(
        (P, Q) => {
          if (P) return P;
          const Y = Q.exec(v.trim());
          if (Y) {
            const [dt, st = void 0, Jt = void 0] = Y.slice(1);
            let tt;
            const Ee = ((it) => Object.keys(wt).find(
              (It) => wt[It].toLowerCase() === it.toLowerCase()
            ))(dt);
            if (Ee && G.includes(Ee) && (tt = Ee), !tt && M.isBookIdValid(dt)) {
              const it = dt.toUpperCase();
              G.includes(it) && (tt = it);
            }
            if (!tt) {
              const it = dt.toLowerCase(), It = G.filter((mn) => wt[mn].toLowerCase().includes(it) || mn.toLowerCase().includes(it));
              It.length === 1 && ([tt] = It);
            }
            if (tt) {
              let it = st ? parseInt(st, 10) : void 0;
              it && it > bt(tt) && (it = Math.max(bt(tt), 1));
              const It = Jt ? parseInt(Jt, 10) : void 0;
              return {
                book: tt,
                chapterNum: it,
                verseNum: It
    ...
    g && (e({
      book: g.book,
      chapterNum: g.chapterNum ?? 1,
      verseNum: g.verseNum ?? 1
    }), i(!1), m(""), u(""));
  }, [e, g]), E = I(
    (v) => {
      if (bt(v) <= 1) {
    ...
    (v) => {
      const C = b === "chapters" ? f : g == null ? void 0 : g.book;
      C && (e({
        book: C,
        chapterNum: v,
        verseNum: 1
    ...
    if (t.chapterNum > 1)
      ...
      const v = G.indexOf(t.book);
      if (v > 0) {
        const C = G[v - 1], P = Math.max(bt(C), 1);
        e({
          book: C,
          chapterNum: P,
          verseNum: 1
    ...
    {
      onClick: Pt,
      disabled: t.chapterNum === 1 && G.indexOf(t.book) === 0,
      title: "Previous chapter",
      icon: o === "ltr" ? je : ne
    },
    {
      onClick: et,
      disabled: t.verseNum === 0,
    ...
    {
      onClick: Tt,
      disabled: (t.chapterNum === bt(t.book) || bt(t.book) === -1) && G.indexOf(t.book) === G.length - 1,
      title: "Next chapter",
      icon: o === "ltr" ? ne : je
    }
  ], [
    ...
    (v) => {
      ...
      i(v), v && (h("books"), x(void 0), m(""));
    },
    [b, gt]
  ), ut = I(
    (v) => g ? !!g.chapterNum && !v.toString().includes(g.chapterNum.toString()) : !1,
    [g]
  ), mt = H(() => Qt(t, "English"), [t]), F = H(() => {
    const v = f ?? (g == null ? void 0 : g.book);
    if (!v) return;
    const C = bt(v), P = wt[v];
    return {
      endChapter: C,
      bookName: P,
      selectedChapter: t.book === v ? t.chapterNum : 0
    };
  }, [f, g == null ? void 0 : g.book, t.book, t.chapterNum]), qt = I((v, C) => `${v} ${wt[v]}${C ? ` ${C}` : ""}`, []), un = I((v) => (C) => {
    D.current[v] = C;
  }, []), Sr = I((v) => {
    ...
    (v) => {
      if (v.ctrlKey) return;
      const C = /^[a-zA-Z]$/.test(v.key), P = /^[0-9]$/.test(v.key);
      if (b === "chapters") {
        if (v.key === "Backspace") {
          v.preventDefault(), v.stopPropagation(), gt();
          return;
        }
        if (C || P) {
          if (v.preventDefault(), v.stopPropagation(), h("books"), x(void 0), P && f) {
            const Q = wt[f];
            m(`${Q} ${v.key}`);
          } else
            m(v.key);
      ...
      if (b === "books" && (C || P)) {
        v.preventDefault(), v.stopPropagation(), m((Q) => Q + v.key), setTimeout(() => {
          k.current && k.current.focus();
        }, 0);
        return;
      }
      if ((b === "chapters" || b === "books" && g) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const Q = b === "chapters" ? f : g == null ? void 0 : g.book;
        if (!Q) return;
        const Y = (() => {
          if (!w) return 1;
          const tt = w.match(/(\d+)$/);
          return tt ? parseInt(tt[1], 10) : 0;
        })(), dt = F == null ? void 0 : F.endChapter;
        if (!dt) return;
        let st = Y;
        const Jt = 6;
        switch (v.key) {
          case "ArrowLeft":
            Y !== 0 && (st = Math.max(1, Y - 1));
            break;
          case "ArrowRight":
            Y !== 0 && (st = Math.min(dt, Y + 1));
            break;
          case "ArrowUp":
            st = Y === 0 ? bt(Q) : Math.max(1, Y - Jt);
            break;
          case "ArrowDown":
            st = Y === 0 ? 1 : Math.min(dt, Y + Jt);
            break;
          default:
            return;
        }
        st !== Y && (v.preventDefault(), v.stopPropagation(), u(qt(Q, st)), setTimeout(() => {
          const tt = D.current[st];
          tt && tt.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
      }
    },
    [
  ...
  return hn(() => {
    const v = setTimeout(() => {
      if (s && b === "books" && _.current && N.current) {
        const C = _.current, P = N.current, Q = P.offsetTop, Y = C.clientHeight, dt = P.clientHeight, st = Q - Y / 2 + dt / 2;
        C.scrollTo({
          top: Math.max(0, st),
          behavior: "smooth"
        }), u(qt(t.book));
  ...
  }, [s, b, c, g, t.book, qt]), hn(() => {
    if (b === "chapters" && f) {
      const v = f === t.book;
      setTimeout(() => {
        if (_.current)
          if (v) {
            const C = D.current[t.chapterNum];
    ...
    t.book,
    t.chapterNum
  ]), /* @__PURE__ */ l(ce, { open: s, onOpenChange: Z, children: [
    ...
    /* @__PURE__ */ r(Yt, { forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      we,
      {
        ref: y,
        onKeyDown: Tr,
        ...
        children: [
          b === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: T.map(({ onClick: v, disabled: C, title: P, icon: Q }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: F == null ? void 0 : F.bookName })
          ] }),
          /* @__PURE__ */ l(de, { ref: _, children: [
            b === "books" && /* @__PURE__ */ l(ee, { children: [
              !g && Object.entries(St).map(([v, C]) => {
                if (C.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses BookType as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Dt, { heading: Oa[v], children: C.map((P) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: d(
                          "tw-mx-1 tw-my-1 tw-border-b-0 tw-border-e-0 tw-border-s-2 tw-border-t-0 tw-border-solid",
                          {
                            "tw-border-s-red-200": v.toLowerCase() === "ot",
                            "tw-border-s-purple-200": v.toLowerCase() === "nt",
                            "tw-border-s-indigo-200": v.toLowerCase() === "dc",
                            "tw-border-s-amber-200": v.toLowerCase() === "extra"
                          }
                        ),
                        children: /* @__PURE__ */ r(
                          Nt,
              ...
              g && /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(
                Nt,
                {
                  value: `${g.book} ${wt[g.book]} ${g.chapterNum || ""}:${g.verseNum || ""})}`,
                  onSelect: X,
              ...
              g && F && F.endChapter > 1 && /* @__PURE__ */ l(ee, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: F.bookName }),
                /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-px-4 tw-pb-4", children: Array.from({ length: F.endChapter }, (v, C) => C + 1).map(
                  (v) => /* @__PURE__ */ r(
                    Nt,
                    {
                      value: `${g.book} ${wt[g.book]} ${v}`,
                      onSelect: () => W(v),
                      ref: un(v),
                      className: d(
                        "tw-h-8 tw-w-8 tw-cursor-pointer tw-justify-center tw-rounded-md tw-text-center tw-text-sm",
                        {
                          "tw-bg-primary tw-text-primary-foreground": v === F.selectedChapter
                        },
                        {
                          "tw-bg-muted/50 tw-text-muted-foreground/50": ut(v)
                        }
                      ),
                      children: v
                    },
            ...
            b === "chapters" && /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-p-4", children: F && Array.from({ length: F.endChapter }, (v, C) => C + 1).map(
              (v) => /* @__PURE__ */ r(
                Nt,
                {
                  value: `${f || ""} ${wt[f || ""] || ""} ${v}`,
...
), q = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(En.Root, { ref: n, className: d("pr-twp", Aa(), t), ...e }));
q.displayName = En.Root.displayName;
const tn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ r(
    ae.Root,
    {
...
const he = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ae.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(ae.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Je, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
he.displayName = ae.Item.displayName;
function Pa(t) {
...
function Ge({
  ...
  const [y, _] = A(!1);
  return /* @__PURE__ */ l(ce, { open: y, onOpenChange: _, ...k, children: [
    /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        variant: h,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ l(we, { children: [
          /* @__PURE__ */ r(le, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(xe, { children: b }),
          /* @__PURE__ */ r(de, { children: e.map((N) => /* @__PURE__ */ l(
            Nt,
            {
              value: w(N),
              onSelect: () => {
...
var ja = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(ja || {});
...
function Ks({
  ...
  const m = ze(c, "%webView_bookSelector_currentBook%"), b = ze(c, "%webView_bookSelector_choose%"), h = ze(c, "%webView_bookSelector_chooseBooks%"), [f, x] = A(
    "current book"
    /* CURRENT_BOOK */
  ), k = (y) => {
    x(y), t(y);
    ...
    tn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(q, { className: "tw-flex tw-items-center", children: a.map((y) => M.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Ln = j.Trigger, Hn = j.Group, $a = j.Portal, Xa = j.Sub, Fa = j.RadioGroup;
function nn({ variant: t = "default", ...e }) {
  const n = p.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ r(en.Provider, { value: n, children: /* @__PURE__ */ r(j.Root, { ...e }) });
}
const Yn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = pt();
  return /* @__PURE__ */ l(
    j.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(ne, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
Yn.displayName = j.SubTrigger.displayName;
const Un = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  j.SubContent,
  {
    ref: n,
    className: d(
...
const ye = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = J();
...
ye.displayName = j.Content.displayName;
const qn = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = J(), s = pt();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
qn.displayName = j.Item.displayName;
const rn = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = pt();
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(At, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
rn.displayName = j.CheckboxItem.displayName;
const Jn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = pt();
  return /* @__PURE__ */ l(
    j.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(Je, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Jn.displayName = j.RadioItem.displayName;
const an = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
...
an.displayName = j.Label.displayName;
...
Ne.displayName = j.Separator.displayName;
...
function La({ table: t }) {
  return /* @__PURE__ */ l(nn, { children: [
    /* @__PURE__ */ r(ca, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Or, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const $t = L.Root, Ha = L.Group, Xt = L.Value, Ya = _t(
...
), Ot = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = J();
  return /* @__PURE__ */ l(
    L.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(L.Icon, { asChild: !0, children: /* @__PURE__ */ r(be, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Ot.displayName = L.Trigger.displayName;
...
const Bt = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = J();
...
const lt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  L.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(At, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(L.ItemText, { children: e })
    ]
  }
));
lt.displayName = L.Item.displayName;
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        $t,
        {
          ...
          children: [
            /* @__PURE__ */ r(Ot, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Xt, { placeholder: t.getState().pagination.pageSize }) }),
...
const ke = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        oe(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
...
const Ce = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: d(
...
const _e = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
_e.displayName = "TableBody";
const Wa = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? oe(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
...
const Ct = p.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a = !1, ...o }, s) => {
...
const Ft = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function no({
  ...
  var y;
  const [w, u] = A([]), [c, m] = A([]), [b, h] = A({}), [f, x] = A({}), k = Vn({
    data: e,
    columns: t,
    getCoreRowModel: Mn(),
    ...n && { getPaginationRowModel: wa() },
    onSortingChange: u,
    getSortedRowModel: Dn(),
    onColumnFiltersChange: m,
    getFilteredRowModel: ia(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(La, { table: k }),
    /* @__PURE__ */ l(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: k.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.map((N) => /* @__PURE__ */ r(se, { children: N.isPlaceholder ? void 0 : te(N.column.columnDef.header, N.getContext()) }, N.id)) }, _.id)) }),
      /* @__PURE__ */ r(_e, { children: (y = k.getRowModel().rows) != null && y.length ? k.getRowModel().rows.map((_) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(_, k),
          "data-state": _.getIsSelected() && "selected",
          children: _.getVisibleCells().map((N) => /* @__PURE__ */ r(Ft, { children: te(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        _.id
      )) : /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Ft, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Ws({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(pa, { options: o, children: e }) });
}
...
function ro({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = yn(n, "%webView_error_dump_header%"), o = yn(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r($r, {}) })
    ] }),
...
function Qs({
  ...
  return /* @__PURE__ */ l(ce, { children: [
    ...
    /* @__PURE__ */ r(Yt, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      ro,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function ti({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(nn, { children: [
    /* @__PURE__ */ r(Ln, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ye, { children: n.map((c, m) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(an, { children: c.label }),
      /* @__PURE__ */ r(Hn, { children: c.itemType === 0 ? /* @__PURE__ */ r(ee, { children: c.items.map((b, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        rn,
        {
          checked: a[m][h],
...
function io({
  ...
  const [b, h] = A(!1), f = I(
    (y) => {
      var N;
      const _ = (N = t.find((D) => D.label === y)) == null ? void 0 : N.value;
      _ && a(
    ...
    if (!u) return t;
    const y = t.filter((N) => N.starred).sort((N, D) => N.label.localeCompare(D.label)), _ = t.filter((N) => !N.starred).sort((N, D) => {
      const O = n.includes(N.value), K = n.includes(D.value);
      return O && !K ? -1 : !O && K ? 1 : N.label.localeCompare(D.label);
    });
    return [...y, ..._];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(ce, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(we, { children: [
      /* @__PURE__ */ r(le, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(de, { children: [
        /* @__PURE__ */ r(xe, { children: s }),
        /* @__PURE__ */ r(Dt, { children: k.map((y) => {
          const _ = e ? e(y) : void 0;
          return /* @__PURE__ */ l(
            Nt,
            {
              value: y.label,
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: y.starred && /* @__PURE__ */ r(Hr, { className: "tw-h-4 tw-w-4" }) }),
...
function wo({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = H(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((u) => Ue(u, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ l(ke, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ce, { stickyHeader: !0, children: /* @__PURE__ */ l(Ct, { children: [
    ...
    /* @__PURE__ */ r(_e, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ft, { children: `${M.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(Ft, { children: i.text })
        ]
      },
  ...
  $e.Root,
  {
    ...
    children: /* @__PURE__ */ r(
      $e.Indicator,
      {
        ...
        children: /* @__PURE__ */ r(At, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
on.displayName = $e.Root.displayName;
...
lo.displayName = zn.Root.displayName;
const Qn = p.createContext({
  size: "default",
  variant: "default"
}), tr = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = J();
  return /* @__PURE__ */ r(
    ve.Root,
    {
...
tr.displayName = ve.Root.displayName;
const me = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(Qn);
  return /* @__PURE__ */ r(
    ve.Item,
    {
      ref: s,
...
const Se = (t) => t === "asc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Kr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ai = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, po = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", di = Object.freeze([
...
function ci({
  ...
  const c = vt(n, "%webView_inventory_all%"), m = vt(n, "%webView_inventory_approved%"), b = vt(n, "%webView_inventory_unapproved%"), h = vt(n, "%webView_inventory_unknown%"), f = vt(n, "%webView_inventory_scope_currentBook%"), x = vt(n, "%webView_inventory_scope_chapter%"), k = vt(n, "%webView_inventory_scope_verse%"), y = vt(n, "%webView_inventory_filter_text%"), _ = vt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, D] = A(!1), [O, K] = A("all"), [G, St] = A(""), [S, g] = A([]), X = H(() => t.length === 0 ? [] : mo(t, o, s), [t, o, s]), E = H(() => {
    if (N) return X;
    const T = [];
    return X.forEach((Z) => {
      const ut = Z.items[0], mt = T.find(
        (F) => F.items[0] === ut
      );
      mt ? (mt.count += Z.count, mt.occurrences = mt.occurrences.concat(Z.occurrences)) : T.push({
        items: [ut],
        count: Z.count,
  ...
  }, [N, X]), W = H(() => uo(E, O, G), [E, O, G]), gt = H(() => {
    var ut, mt;
    if (!N) return u;
    const T = (ut = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ut.length;
    if (!T) return u;
    const Z = [];
    for (let F = 0; F < T; F++)
      Z.push(
        co(
          ((mt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : mt[F]) || "Additional Item",
          F + 1
        )
      );
    return [...Z, ...u];
  ...
  Mt(() => {
    W.length === 0 ? g([]) : W.length === 1 && g(W[0].items);
  }, [W]);
  const Pt = (T, Z) => {
    Z.setRowSelection(() => {
      const ut = {};
      return ut[T.index] = !0, ut;
    }), g(T.original.items);
  }, Tt = (T) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        $t,
        {
          onValueChange: (T) => et(T),
          defaultValue: O,
          children: [
            /* @__PURE__ */ r(Ot, { className: "tw-m-1", children: /* @__PURE__ */ r(Xt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l($t, { onValueChange: (T) => Tt(T), defaultValue: i, children: [
        /* @__PURE__ */ r(Ot, { className: "tw-m-1", children: /* @__PURE__ */ r(Xt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(Bt, { children: [
          /* @__PURE__ */ r(lt, { value: "book", children: f }),
          /* @__PURE__ */ r(lt, { value: "chapter", children: x }),
          /* @__PURE__ */ r(lt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        ue,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(q, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? _ })
      ] })
    ] }),
...
const sn = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  On.Root,
  {
    ref: o,
    decorative: n,
...
sn.displayName = On.Root.displayName;
...
const wn = ie.Provider, ln = ie.Root, dn = ie.Trigger, Te = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ie.Content,
  {
    ref: a,
    sideOffset: e,
...
Te.displayName = ie.Content.displayName;
const ho = "16rem", fo = "3rem", er = p.createContext(void 0);
function Re() {
...
const nr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), b = e ?? c, h = p.useCallback(
      (D) => {
        const O = typeof D == "function" ? D(b) : D;
        n ? n(O) : m(O);
      },
      [n, b]
    ), f = p.useCallback(() => h((D) => !D), [h]), x = b ? "expanded" : "collapsed", _ = J() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = p.useMemo(
      () => ({
        state: x,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(er.Provider, { value: N, children: /* @__PURE__ */ r(wn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const rr = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Re();
...
const He = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Gt : "div",
  {
    ref: a,
...
const Co = _t(
  ...
  ({
    ...
    const u = t ? Gt : "button", { state: c } = Re(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Co({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ l(ln, { children: [
      /* @__PURE__ */ r(dn, { asChild: !0, children: m }),
...
const Vo = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Gt : "a",
  {
    ref: s,
    ...
    rr,
    {
      ...
      children: /* @__PURE__ */ l(or, { children: [
        /* @__PURE__ */ l(Le, { children: [
          ...
          /* @__PURE__ */ r(Ye, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => c(h),
              isActive: b(h),
...
const yt = "scrBook", Mo = "scrRef", Vt = "source", zo = "details", Oo = "Scripture Reference", Bo = "Scripture Book", lr = "Type", Ao = "Details";
function Po(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? M.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === yt ? Qt(o.start) : void 0;
      },
...
const Io = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Ie(t.start, t.end) === 0 ? `${De(t.start)}+${e}` : `${De(t.start)}+${e}-${De(t.end)}+${n}`;
}, kn = (t) => `${Io({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ui({
  sources: t,
  ...
  const [u, c] = A([]), [m, b] = A([{ id: yt, desc: !1 }]), [h, f] = A({}), x = H(
    () => t.flatMap((S) => S.data.map((g) => ({
      ...g,
      source: S.source
    }))),
    [t]
  ...
  const y = Vn({
    ...
    getExpandedRowModel: da(),
    getGroupedRowModel: la(),
    getCoreRowModel: Mn(),
    getSortedRowModel: Dn(),
    getRowId: kn,
    autoResetExpanded: !1,
  ...
  Mt(() => {
    if (w) {
      const S = y.getSelectedRowModel().rowsById, g = Object.keys(S);
      if (g.length === 1) {
        const X = x.find((E) => kn(E) === g[0]) || void 0;
        X && w(X);
      }
    }
  }, [h, x, w, y]);
  const _ = o ?? Bo, N = s ?? lr, D = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${_}`, value: [yt] },
    { label: `Group by ${N}`, value: [Vt] },
    {
    ...
    !S.getIsGrouped() && !S.getIsSelected() && S.getToggleSelectedHandler()(g);
  }, G = (S, g) => S.getIsGrouped() ? "" : d("banded-row", g % 2 === 0 ? "even" : "odd"), St = (S, g, X) => {
    if (!((S == null ? void 0 : S.length) === 0 || g.depth < X.column.getGroupedIndex())) {
      if (g.getIsGrouped())
        switch (g.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      $t,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ot, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Xt, {}) }),
          /* @__PURE__ */ r(Bt, { position: "item-aligned", children: /* @__PURE__ */ r(Ha, { children: D.map((S) => /* @__PURE__ */ r(lt, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(ke, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ce, { children: y.getHeaderGroups().map((S) => /* @__PURE__ */ r(Ct, { children: S.headers.filter((g) => g.column.columnDef.header).map((g) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(se, { colSpan: g.colSpan, className: "top-0 tw-sticky", children: g.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          g.column.getCanGroup() ? /* @__PURE__ */ r(
            z,
            {
              variant: "ghost",
              title: `Toggle grouping by ${g.column.columnDef.header}`,
              onClick: g.column.getToggleGroupingHandler(),
              type: "button",
              children: g.column.getIsGrouped() ? "🛑" : "👊 "
            }
          ) : void 0,
          " ",
      ...
      /* @__PURE__ */ r(_e, { children: y.getRowModel().rows.map((S, g) => {
        const X = J();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            className: d(G(S, g)),
            onClick: (E) => K(S, E),
            children: S.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== Vt || !n)))
                return /* @__PURE__ */ r(
                  Ft,
                  {
                    className: d(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ l(
                      z,
                      {
                        ...
                        children: [
                          ...
                          !S.getIsExpanded() && (X === "ltr" ? /* @__PURE__ */ r(ne, {}) : /* @__PURE__ */ r(je, {})),
                          " ",
                          te(E.column.columnDef.cell, E.getContext()),
                          " (",
                          S.subRows.length,
                          ")"
                        ]
...
}), dr = (t, e, n) => pn(t, e).every((a) => n.includes(a));
function Xo({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": jt(t) === kt.OT,
                "tw-border-s-purple-200": jt(t) === kt.NT,
                "tw-border-s-indigo-200": jt(t) === kt.DC,
                "tw-border-s-yellow-200": jt(t) === kt.Extra
              }
            ),
...
function Fo({
  ...
  const s = pn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Go({
  ...
  const s = a["%webView_book_selector_books_selected%"], i = a["%webView_book_selector_select_books%"], w = a["%webView_book_selector_search_books%"], u = a["%webView_book_selector_select_all%"], c = a["%webView_book_selector_clear_all%"], m = a["%webView_book_selector_no_book_found%"], b = a["%webView_book_selector_more%"], h = a["%scripture_section_ot_long%"], f = a["%scripture_section_nt_long%"], x = a["%scripture_section_dc_long%"], k = a["%scripture_section_extra_long%"], [y, _] = A(!1), N = U(void 0), D = U(!1);
  if (t.length !== M.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const O = H(() => M.allBookIds.filter(
    (g, X) => t[X] === "1" && !M.isObsolete(M.bookIdToNumber(g))
  ), [t]), K = I(
    (g, X = !1) => {
      if (!X || !N.current) {
        n(
          e.includes(g) ? e.filter((et) => et !== g) : [...e, g]
        ), N.current = g;
        return;
      }
      const E = O.findIndex((et) => et === N.current), W = O.findIndex((et) => et === g);
      if (E === -1 || W === -1) return;
      const [gt, Pt] = [
        Math.min(E, W),
        Math.max(E, W)
      ], Tt = O.slice(gt, Pt + 1).map((et) => et);
      n(
        e.includes(g) ? e.filter((et) => !Tt.includes(et)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, O]
  ), G = I(
    (g) => {
      const X = pn(O, g).map((E) => E);
      n(
        dr(O, g, e) ? e.filter((E) => !X.includes(E)) : [.../* @__PURE__ */ new Set([...e, ...X])]
      );
    },
    [e, n, O]
  ), St = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(kt).map((g) => /* @__PURE__ */ r(
      Fo,
      {
        section: g,
        availableBookIds: O,
    ...
    /* @__PURE__ */ l(ce, { open: y, onOpenChange: _, children: [
      /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        we,
        {
          onKeyDown: (g) => {
            g.key === "Enter" && (D.current = g.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(le, { placeholder: w }),
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: St, children: u }),
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: S, children: c })
            ] }),
            /* @__PURE__ */ l(de, { children: [
              /* @__PURE__ */ r(xe, { children: m }),
              Object.values(kt).map((g, X) => {
                const E = O.filter(
                  (W) => jt(W) === g
                );
                if (E.length !== 0)
                  return /* @__PURE__ */ l(Tn, { children: [
                    /* @__PURE__ */ r(
                      Dt,
                      {
                        heading: jo(
                    ...
                    X < Object.values(kt).length - 1 && /* @__PURE__ */ r(Fn, {})
                  ] }, g);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var X;
        return /* @__PURE__ */ r(fe, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((X = o.get(g)) == null ? void 0 : X.localizedName) || M.bookIdToEnglishName(g) || g }, g);
      }),
...
function hi({
  ...
  const u = Rt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Rt(i, "%webView_scope_selector_current_book%"), h = Rt(i, "%webView_scope_selector_choose_books%"), f = Rt(i, "%webView_scope_selector_scope%"), x = Rt(i, "%webView_scope_selector_select_books%"), k = [
  ...
  ], y = e ? k.filter((_) => e.includes(_.value)) : k;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        tn,
        {
          ...
          children: y.map(({ value: _, label: N, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(he, { className: "tw-me-2", value: _, id: D }),
            /* @__PURE__ */ r(q, { htmlFor: D, children: N })
          ] }, D))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(q, { children: x }),
      /* @__PURE__ */ r(
        Go,
        {
          availableBookInfo: a,
...
function fi({
  ...
  return /* @__PURE__ */ l(
    $t,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ot, { size: o, className: d("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Xt,
          {
            placeholder: i[B(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          Bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(lt, { value: `${u}`, children: i[B(u)] }, `${u}`))
          }
        )
      ]
    }
...
const pr = (t, e, n, a) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(ln, { children: [
  /* @__PURE__ */ r(dn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    qn,
    {
      onClick: () => {
        a(w);
  ...
  ) : /* @__PURE__ */ l(Xa, { children: [
    /* @__PURE__ */ r(Yn, { children: w.label }),
    /* @__PURE__ */ r($a, { children: /* @__PURE__ */ r(Un, { children: pr(
      t,
      e,
      cr(t, w.id),
      a
...
function _n({
  ...
  return /* @__PURE__ */ l(nn, { variant: s, children: [
    /* @__PURE__ */ r(Ln, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(ea, {}) }) }),
    /* @__PURE__ */ r(ye, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(Tn, { children: [
      /* @__PURE__ */ r(Hn, { children: /* @__PURE__ */ r(wn, { children: pr(e.groups, e.items, w, t) }) }),
      u < c.length - 1 && /* @__PURE__ */ r(Ne, {})
    ] }, w)) })
  ] });
}
function xi({
...
ur.displayName = at.List.displayName;
const mr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.List,
  {
    ref: n,
    className: d(
...
)), hr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: d(
...
hr.displayName = at.Content.displayName;
function yi({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ur, { children: [
      /* @__PURE__ */ r(mr, { children: t.map((i) => /* @__PURE__ */ r(Lo, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(hr, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function Ho({ ...t }) {
...
const fr = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(en.Provider, { value: o, children: /* @__PURE__ */ r(
    $.Root,
    {
      ref: a,
      className: d(
...
fr.displayName = $.Root.displayName;
...
gr.displayName = $.Trigger.displayName;
const br = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = pt();
  return /* @__PURE__ */ l(
    $.SubTrigger,
    {
...
br.displayName = $.SubTrigger.displayName;
const vr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = pt();
  return /* @__PURE__ */ r(
    $.SubContent,
    {
...
vr.displayName = $.SubContent.displayName;
const xr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = pt();
...
xr.displayName = $.Content.displayName;
const yr = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = pt();
  return /* @__PURE__ */ r(
    $.Item,
    {
...
yr.displayName = $.Item.displayName;
const Uo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    $.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r($.ItemIndicator, { children: /* @__PURE__ */ r(At, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
qo.displayName = $.RadioItem.displayName;
const Jo = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Jo.displayName = $.Label.displayName;
...
Nr.displayName = $.Separator.displayName;
const Wt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(ln, { children: [
      /* @__PURE__ */ r(dn, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        yr,
        {
          onClick: () => {
            a(c);
        ...
        /* @__PURE__ */ r(br, { children: c.label }),
        /* @__PURE__ */ r(vr, { children: kr(
          t,
          e,
          cr(t, c.id),
          a
    ...
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(Nr, {}, `separator-${s}`)), u;
  });
};
function Ko({
  menuData: t,
  ...
  const o = U(void 0), s = U(void 0), i = U(void 0), w = U(void 0), u = U(void 0), c = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (ua(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, b) => {
    var x, k, y, _;
    m.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (x = s.current) == null || x.focus(), Wt(s, [h, f]);
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Wt(i, [h, f]);
        break;
      case "alt+n":
        (y = w.current) == null || y.focus(), Wt(w, [h, f]);
        break;
      case "alt+h":
        (_ = u.current) == null || _.focus(), Wt(u, [h, f]);
        break;
    }
  }), Mt(() => {
    ...
    const m = new MutationObserver((f) => {
      f.forEach((x) => {
        if (x.attributeName === "data-state" && x.target instanceof HTMLElement) {
          const k = x.target.getAttribute("data-state");
          n(k === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(fr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, b]) => typeof m == "boolean" || typeof b == "boolean" ? 0 : m.order - b.order).map(([m, b]) => /* @__PURE__ */ l(Ho, { children: [
      /* @__PURE__ */ r(gr, { ref: c(m), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        xr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(wn, { children: kr(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Ci({
  ...
  const u = Wo(
    ...
    var y, _, N, D, O, K;
    const k = x !== f ? ((_ = (y = t[f]) == null ? void 0 : y.uiNames) == null ? void 0 : _[x]) ?? ((D = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : D.en) : void 0;
    return k ? `${(O = t[f]) == null ? void 0 : O.autonym} (${k})` : (K = t[f]) == null ? void 0 : K.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      $t,
      {
        ...
        onOpenChange: (f) => m(f),
        children: [
          /* @__PURE__ */ r(Ot, { children: /* @__PURE__ */ r(Xt, {}) }),
          /* @__PURE__ */ r(
            Bt,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ l(ee, { children: [
      /* @__PURE__ */ r(q, { className: "tw-ms-3", children: u }),
...
const Qo = Sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(aa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
as.displayName = Lt.Root.displayName;
...
os.displayName = Lt.Image.displayName;
...
ss.displayName = Lt.Fallback.displayName;
...
const Ti = ct.Trigger, ms = ct.Portal, Ri = ct.Close, _r = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Overlay,
  {
    ref: n,
...
_r.displayName = ct.Overlay.displayName;
const hs = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = p.useContext(Cr), i = {
...
const bs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Title,
  {
    ref: n,
    className: d("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight", t),
...
bs.displayName = ct.Title.displayName;
...
vs.displayName = ct.Description.displayName;
const xs = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Xe.Root,
  {
    ref: a,
    className: d(
...
xs.displayName = Xe.Root.displayName;
function Ei({ ...t }) {
  return /* @__PURE__ */ r(
    ma,
    {
...
const ys = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ l(
    Zt.Root,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r(Zt.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ r(Zt.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ r(Zt.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
ys.displayName = Zt.Root.displayName;
...
Ns.displayName = Fe.Root.displayName;
const Vi = at.Root, ks = p.forwardRef(({ className: t, ...e }, n) => {
  const a = J();
  return /* @__PURE__ */ r(
    at.List,
    {
...
ks.displayName = at.List.displayName;
const Cs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Trigger,
  {
    ref: n,
    className: d(
...
Cs.displayName = at.Trigger.displayName;
...
_s.displayName = at.Content.displayName;
...
const Rs = (t, e, n = {}) => {
  ...
  const o = U(null), [s, i] = A(void 0), [w, u] = A(void 0), c = I(
    (h) => {
      i(h);
...
export {
  ...
  Ti as DrawerTrigger,
  nn as DropdownMenu,
  rn as DropdownMenuCheckboxItem,
  ...
  Un as DropdownMenuSubContent,
  Yn as DropdownMenuSubTrigger,
  Ln as DropdownMenuTrigger,
