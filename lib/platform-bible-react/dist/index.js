...
const Vo = ft.Portal, jn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
const Nt = "scrBook", Ya = "scrRef", Et = "source", Ka = "details", qa = "Scripture Reference", Ja = "Scripture Book", mr = "Type", Wa = "Details";
function Za(t, e) {
  const n = e ?? !1;
  return [
    {
