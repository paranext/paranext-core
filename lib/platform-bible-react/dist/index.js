...
var $i = (t, e, r) => e in t ? Mi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Pt = (t, e, r) => $i(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as De, a as Pa, C as $e, A as se, P as Ae, b as qe, B as G, d as Ie, e as Ge, f as He, h as ye, i as Ai, k as Ii, j as Vi, E as Pi, l as ja, r as he, m as ji, n as sn, o as Zr, p as Ba, L as kt, R as La, q as Kr, D as ya, s as ka, t as _a, u as Na, T as cn, v as Vr, w as Kt, x as Fa, y as qt, z as Gt, F as Ht, G as ln, H as Ua, I as Fe, J as xr, K as ke, M as _e, N as Ne, S as yr, O as Qe, Q as Bi, U as Nr, V as Ke, W as Oe, Z as Ye, X as Re, Y as tr, _ as Ka, $ as qa, a0 as qr, a1 as Ga, a2 as dn, a3 as Li, a4 as Fi, a5 as Ui, a6 as mo, a7 as wn, a8 as Qr, a9 as pn, aa as Ki, ab as qi, ac as Gi, ad as Hi, ae as un, af as Yi, ag as oa, ah as vo, ai as na, aj as Wi, ak as Xi, al as Ji, am as Zi, an as Qi, ao as Cr, ap as Ha } from "./resizable-D73WuxyG.js";
import { aq as Ih, ar as Vh, as as Ph, at as jh, au as Bh, av as Lh, aw as Fh, ax as Uh, ay as Kh, az as qh, aA as Gh, aB as Hh, aC as Yh, aD as Wh, aE as Xh, aF as Jh, aG as Zh, aH as Qh, aI as tg, aJ as eg, aK as rg, aL as ag, aM as og, aN as ng, aO as ig } from "./resizable-D73WuxyG.js";
import { jsx as a, jsxs as p, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ar, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Ca, ChevronRight as Ea, ArrowLeft as ts, ArrowRight as es, ChevronDown as or, BoldIcon as rs, ItalicIcon as as, X as Ya, AtSign as hn, Pencil as os, Trash2 as ns, ArrowUp as gn, MoreHorizontal as is, MailOpen as ss, Mail as cs, ChevronUp as ls, FilterIcon as ds, ArrowLeftIcon as ws, ChevronLeftIcon as ps, ChevronRightIcon as us, ArrowRightIcon as hs, Copy as fn, Filter as gs, User as fs, Link as ms, CircleHelp as vs, Undo as bs, Redo as xs, SquareX as mn, FunctionSquare as vn, SquareSigma as bn, Ban as ys, AlertCircle as Ta, CircleCheckIcon as ks, CircleXIcon as _s, CircleHelpIcon as Ns, ArrowUpIcon as Cs, ArrowDownIcon as Es, ScrollText as Ts, ChevronsUpDown as zs, MenuIcon as Ss, Menu as Ds, EllipsisVertical as Rs, MoreVertical as ko } from "lucide-react";
import { Section as dt, getChaptersForBook as Os, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as Ms, formatReplacementString as Ue, sanitizeHtml as Wa, NumberFormat as $s, formatBytes as As, getCurrentLocale as Is, usfmMarkers as Pr, getFormatCallerFunction as Vs, deepEqual as Ps, isString as _o, compareScrRefs as za, scrRefToBBBCCCVVV as ia, defaultScrRef as sa, formatScrRefRange as js, getLocalizeKeyForScrollGroupId as No, collectUsjMarkers as Bs } from "platform-bible-utils";
import Ut, { useRef as K, useMemo as A, useState as _, useCallback as L, useEffect as W, useImperativeHandle as Ls, useLayoutEffect as Zt, createContext as Xa, useContext as xn, Component as Fs, createElement as Co, Suspense as Us, forwardRef as yn, useId as Eo, Fragment as kn } from "react";
import { createEditor as _n, $getRoot as Me, $createParagraphNode as Er, $getSelection as Yt, HISTORY_MERGE_TAG as Ja, ParagraphNode as Nn, TextNode as Cn, $getPreviousSelection as Ks, $isRangeSelection as pe, $caretFromPoint as qs, $getSiblingCaret as En, $getChildCaret as Gs, $getAdjacentChildCaret as Hs, $isChildCaret as Ys, $normalizeCaret as Ws, $setSelectionFromCaretRange as Xs, $getCollapsedCaretRange as Js, $getCaretInDirection as To, $splitAtPointCaretNext as Zs, $isTextPointCaret as Qs, $findMatchingParent as Tn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as tc, isHTMLElement as ec, CLEAR_EDITOR_COMMAND as zn, COMMAND_PRIORITY_EDITOR as Za, shallowMergeConfig as rc, defineExtension as re, safeCast as We, createState as ac, FORMAT_TEXT_COMMAND as Sn, $isNodeSelection as Dn, COMMAND_PRIORITY_LOW as Rn, RootNode as oc, LineBreakNode as nc, TabNode as ic, $isEditorState as sc, createCommand as cc, CLICK_COMMAND as lc, isDOMNode as dc, $getNodeFromDOMNode as wc, $createNodeSelection as pc, $setSelection as uc, $getEditor as hc, DecoratorNode as Sa, $getState as gc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as fc, $setState as mc, addClassNamesToElement as On, $create as vc, $getNodeByKey as bc, removeClassNamesFromElement as xc, KEY_TAB_COMMAND as yc, $isBlockElementNode as kc, $createRangeSelection as _c, $normalizeSelection__EXPERIMENTAL as Nc, OUTDENT_CONTENT_COMMAND as Cc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Ec, COMMAND_PRIORITY_CRITICAL as Qa, $isDecoratorNode as Tc, $isParagraphNode as zc, $isTextNode as Da, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as Sc } from "lexical";
import { HeadingNode as Dc, QuoteNode as Rc, registerRichText as Oc } from "@lexical/rich-text";
import { flushSync as Mc, createPortal as $c } from "react-dom";
import { $isTableSelection as Ac } from "@lexical/table";
import { createHeadlessEditor as $n } from "@lexical/headless";
import { $generateHtmlFromNodes as Ic, $generateNodesFromDOM as Vc } from "@lexical/html";
import { Avatar as to, Select as Bt, Checkbox as Do, Slot as Tr, Tabs as ce, Menubar as ge, ContextMenu as Tt, Progress as Ro, Slider as Rr, Switch as Oo } from "radix-ui";
import { useReactTable as An, getFilteredRowModel as Pc, getSortedRowModel as In, getPaginationRowModel as jc, getCoreRowModel as Vn, flexRender as vr, getGroupedRowModel as Bc, getExpandedRowModel as Lc } from "@tanstack/react-table";
import { IconCheck as ta, IconChevronDown as Fc, IconChevronUp as Uc, IconSelector as Kc, IconLayoutSidebar as qc, IconLayoutSidebarRight as Gc, IconChevronRight as Pn, IconLoader as Hc, IconAlertOctagon as Yc, IconAlertTriangle as Wc, IconInfoCircle as Xc, IconCircleCheck as Jc } from "@tabler/icons-react";
import Zc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ra, HIDDEN_NOTE_CALLER as Oa, getDefaultViewOptions as Qc, isInsertEmbedOpOfType as Or, Editorial as tl } from "@eten-tech-foundation/platform-editor";
...
function ol({
  ...
  return /* @__PURE__ */ p(Ae, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ a(Ie, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((h) => /* @__PURE__ */ p(
      $e,
      {
        onSelect: () => g(h),
...
function Vp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function la({
  ...
  const I = he(), [B, T] = _(!1), [V, M] = _(""), [N, j] = _(""), [R, E] = _("books"), [Y, q] = _(void 0), [F, O] = _(
    void 0
  ), [S, Z] = _(void 0), [Q, _t] = _(!1), Nt = K(null), At = K(!1), U = K(void 0), tt = K(void 0), wt = K(void 0), st = K(void 0), vt = K({}), ae = K({}), at = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), It = A(() => o ? o() : ji, [o]), zt = A(() => ({
    [dt.OT]: It.filter((H) => bt.isBookOT(H)),
    [dt.NT]: It.filter((H) => bt.isBookNT(H)),
    [dt.DC]: It.filter((H) => bt.isBookDC(H)),
    [dt.Extra]: It.filter((H) => bt.extraBooks().includes(H))
  }), [It]), Wt = A(() => Object.values(zt).flat(), [zt]), oe = A(() => {
    if (!N.trim()) return zt;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = zt[rt].filter((Vt) => ja(Vt, N, n));
    }), b;
  }, [zt, N, n]), D = A(
    () => ll(N, Wt, n),
    [N, Wt, n]
  ...
  const xt = L(() => {
    ...
    (b) => {
      const H = F ?? (D == null ? void 0 : D.book), rt = S ?? (D == null ? void 0 : D.chapterNum);
      !H || !rt || (at({
        book: H,
        chapterNum: rt,
        verseNum: b
    ...
    const b = F;
    O(void 0), Z(void 0), b ? (q(b), E("chapters"), M("")) : X();
  }, [F, X]), et = L((b) => {
  ...
  const { otLong: gt, ntLong: ut, dcLong: ft, extraLong: St } = {
    ...
    () => sl(N),
    [N]
  ), yt = A(() => !l || !D || !D.chapterNum || !Ot ? !1 : l(D.book, D.chapterNum) > 0, [l, D, Ot]), le = L(
    (b) => w ? Mo(b, w) : !1,
    [w]
  ), Te = L(
    (b) => (H) => w ? cl(b, H, w) : !1,
    ...
    (b, H) => (rt) => w ? ca(b, H, rt, w) : !1,
    [w]
  ), pr = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", ur = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", zr = L(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), u && u.includes(b.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), xt());
    },
    [u, D, xt]
  ), Sr = L(
    (b) => {
      var ve, Pe, ze;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: rt } = $o(b.key);
      if ((R === "chapters" || R === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const $t = (ve = U.current) == null ? void 0 : ve.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if ($t) {
          b.preventDefault(), b.stopPropagation(), $t.click();
          return;
        }
      }
      ...
      if (R === "verses" && Vt) {
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            te = ht === 0 ? $t : Math.max(1, ht - Jt);
            break;
          case "ArrowDown":
            te = ht === 0 ? 1 : Math.min($t, ht + Jt);
            break;
          default:
            return;
        }
        te !== ht && (b.preventDefault(), b.stopPropagation(), M(
          `${Mt} ${se[Mt] || ""} ${mt}:${te}`
        ), setTimeout(() => {
          const je = ae.current[te];
          je && je.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((R === "chapters" || R === "books" && D) && Vt) {
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            ht = mt === 0 ? $t : Math.max(1, mt - te);
            break;
          case "ArrowDown":
            ht = mt === 0 ? 1 : Math.min($t, mt + te);
            break;
          default:
            return;
        }
        ht !== mt && (b.preventDefault(), b.stopPropagation(), M(
          `${Mt} ${se[Mt] || ""} ${ht}`
        ), setTimeout(() => {
  ...
  return Zt(() => {
    const b = setTimeout(() => {
      if (B && R === "books" && wt.current && st.current) {
        const H = wt.current, rt = st.current, Vt = rt.offsetTop, ve = H.clientHeight, Pe = rt.clientHeight, ze = Vt - ve / 2 + Pe / 2;
        H.scrollTo({
          top: Math.max(0, ze),
          behavior: "smooth"
        }), M(Bn(t.book));
    ...
    if (R === "verses" && F && S !== void 0) {
      ...
      M(
        ...
        if (wt.current)
          if (b) {
            const rt = ae.current[t.verseNum];
            rt && rt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            wt.current.scrollTo({ top: 0 });
        U.current && U.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ p(Ae, { open: B, onOpenChange: et, modal: v, children: [
    /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ a(
      G,
      {
        ref: Nt,
        ...
        children: g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Rt })
      }
    ) }),
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        children: /* @__PURE__ */ p(
          Ge,
          {
            ...
            shouldFilter: !1,
            children: [
              R === "books" ? /* @__PURE__ */ p("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: P.map(
                  ({ onClick: b, disabled: H, title: rt, icon: Vt }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    ...
                    tabIndex: -1,
                    children: I === "ltr" ? /* @__PURE__ */ a(ts, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(es, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                R === "chapters" && Y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: De(Y, n) }),
                R === "verses" && F && S !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${De(F, n)} ${S}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: R === "verses" ? ur : pr
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ p(He, { ref: wt, children: [
                R === "books" && /* @__PURE__ */ p(it, { children: [
                  !D && Object.entries(oe).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                  ...
                  D && /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a(
                    $e,
                    {
                      ...
                      children: be(
                        ...
                        n ? Pa(D.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  D && yt && D.chapterNum && l && /* @__PURE__ */ p(it, { children: [
                  ...
                  D && !yt && er(D.book) > 1 && /* @__PURE__ */ p(it, { children: [
                    /* @__PURE__ */ p("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                ...
                R === "verses" && F && S !== void 0 && l && /* @__PURE__ */ a(
                  Io,
                  {
                    bookId: F,
                    chapterNum: S,
...
function Vo({
  ...
  const [k, I] = _(!1), B = l ?? d, T = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], V = (M, N) => {
    const j = d(M), R = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, E = `${N ?? ""}${j}${R ?? ""}`;
    return /* @__PURE__ */ p(
      $e,
      {
        value: j,
        ...
        children: [
          ...
          /* @__PURE__ */ p("span", { className: "tw:flex-1 tw:overflow-hidden tw:text-ellipsis tw:whitespace-nowrap", children: [
            j,
            R && /* @__PURE__ */ p("span", { className: "tw:text-muted-foreground", children: [
              " · ",
              R
            ] })
          ] })
  ...
  return /* @__PURE__ */ p(Ae, { open: k, onOpenChange: I, ...y, children: [
    /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ p(
      G,
      {
        variant: f,
        role: "combobox",
    ...
    /* @__PURE__ */ a(
      Ie,
      {
        ...
        children: /* @__PURE__ */ p(Ge, { children: [
          ...
          /* @__PURE__ */ a(Ba, { children: h }),
          /* @__PURE__ */ a(He, { children: T(e) ? e.map((M) => /* @__PURE__ */ a(ye, { heading: M.groupHeading, children: M.options.map((N) => V(N, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(ye, { children: e.map((M) => V(M)) }) })
        ] })
      }
    )
  ] });
...
function Bp({
  ...
  const w = da(l, "%webView_bookSelector_currentBook%"), u = da(l, "%webView_bookSelector_choose%"), g = da(l, "%webView_bookSelector_chooseBooks%"), [h, f] = _(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ul = Un ? Zt : W, $r = { tag: Ja };
function hl({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = pl(null, o), w = _n({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (u) => s(u, w), theme: o });
    return function(u, g) {
      if (g !== null) {
        if (g === void 0) u.update(() => {
          ...
          case "string": {
            ...
            u.setEditorState(h, $r);
            break;
          }
          case "object":
            u.setEditorState(g, $r);
            break;
          case "function":
            u.update(() => {
              Me().isEmpty() && g(u);
  ...
  }, []), a(Fn.Provider, { value: r, children: e });
}
const gl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function fl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = fe();
  return gl(() => {
...
class vl extends Fs {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && bl(e.resetKeys, n)) {
      var i, s;
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = Kn && "documentMode" in document ? document.documentMode : null;
!(!Kn || !("InputEvent" in window) || Cl) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
const El = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Tl(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const c = document.createElement("div");
  function d() {
    o === null && Gr(182), n === null && Gr(183);
    const { left: u, top: g } = n.getBoundingClientRect(), h = Nl(t, e);
    var f, x;
    ...
    for (let C = 0; C < h.length; C++) {
      ...
      const M = we(y.height);
      I.height !== M && (k.style.height = M, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[C] = k;
    }
...
function Sl(t, e = zl) {
  ...
  function l(w) {
    w.read(() => {
      const u = Yt();
      if (!pe(u)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [g, h] = function(M) {
        const N = M.getStartEndPoints();
        return M.isBackward() ? [N[1], N[0]] : N;
      }(u), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), k = h.offset, I = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || I !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || k !== c || y !== i.getKey();
      if ((T || V) && I !== null && B !== null) {
        const M = function(N, j, R, E, Y, q, F) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Po(j, R, E)), O.setEnd(...Po(Y, q, F)), O;
        }(t, g, f, I, h, C, B);
        d(), d = Tl(t, M, e);
      }
...
function Dl(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = Sl(t, e));
  };
...
function Rl(t) {
  const e = Tn(t, (r) => kr(r) && !r.isInline());
...
function Ol(t) {
  ...
  if (pe(e)) r = qs(e.focus, "next");
    ...
    r = r || Gs(Me(), "previous").getFlipped().insert(Er());
  }
  const o = Ml(t, r), n = Hs(o), i = Ys(n) ? Ws(n) : o;
  return Xs(Js(i)), t.getLatest();
}
function Ml(t, e, r) {
  let o = To(e, "next");
  for (let n = o; n; n = Zs(n, r)) o = n;
  return Qs(o) && Gr(283), o.insert(t.isInline() ? Er().append(t) : t), To(En(t.getLatest(), "next"), e.direction);
}
function $l(t) {
  const e = Yt();
  if (!pe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Tn(i, (l) => kr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Hr, xe = 0, Yr = 0, Vl = 0, $a = 0, Br = 0;
function Bo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function jl(t) {
  ...
  Gn(this), nt = t, this.f &= -2, 8 & this.f && oo(this), ea();
}
function Ze(t, e) {
...
jt.prototype.brand = Al, jt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && Yr === 0 && e.l !== $a && (e.l = $a, Hr = { S: e, v: e.v, i: e.i, o: Hr });
    })(this), this.v = t, this.i++, Br++, xe++;
    try {
...
} }), Be.prototype = new jt(), Be.prototype.h = function() {
  ...
  return nt = t, Gn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Hn(this), Lo(this), xe++;
  const t = nt;
...
function Yn() {
  const t = Me(), e = Yt(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), pe(e) && (e.format = 0);
}
function Wn(t, e = Yn) {
  return t.registerCommand(zn, (r) => (t.update(e), !0), Za);
}
re({ build: (t, e, r) => dr(e), config: We({ $onClear: Yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ue(() => Wn(t, o.value));
} });
function Bl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const pa = ac("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Xn extends Sa {
  $config() {
    return this.config("decorator-text", { extends: Sa, stateConfigs: [{ flat: !0, stateConfig: pa }] });
  }
  getFormat() {
    return gc(this, pa);
  }
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [Xn], register: (t, e, r) => t.registerCommand(Sn, (o) => {
  const n = Yt();
  if (Dn(n) || pe(n)) for (const i of n.getNodes()) Ll(i) && i.toggleFormat(o);
  return !1;
}, Rn) });
function Jn(t, e) {
  let r;
...
const Aa = re({ build: (t) => Jn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const no = 0, Ia = 1, Qn = 2, ua = 3, Ar = 4, Je = 5, ha = 6, gr = 7;
function ga(t) {
  return t.id === no;
}
function ti(t) {
...
function Fl(t) {
  return function(e) {
    return e.id === Ia;
  }(t) || lt(305, String(t.id), String(Ia)), Object.assign(t, { id: Qn });
}
...
class Kl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: ua, registerState: l });
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ha && lt(310, String(r.id), String(ha)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= ua;
    }(e) || lt(314, String(e.id), String(ua)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const Gl = re({ config: We({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [oc, Cn, nc, ic, Nn] }), Uo = Symbol.for("@lexical/extension/LexicalBuilder");
function Ko() {
}
function Hl(t) {
  throw t;
...
class rr {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = fa, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[Uo];
    return r && (r.PACKAGE_VERSION !== fa && lt(292, r.PACKAGE_VERSION, fa), r instanceof rr || lt(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && lt(298, o.name), !n) {
      n = new Kl(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ga(i) || lt(300, s, n || "[unknown]"), ga(c = i) || lt(304, String(c.id), String(no)), i = Object.assign(c, { id: Ia }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: u } = w;
      if (u.onError !== void 0 && (e.onError = u.onError), u.disableEvents !== void 0 && (e.disableEvents = u.disableEvents), u.parentEditor !== void 0 && (e.parentEditor = u.parentEditor), u.editable !== void 0 && (e.editable = u.editable), u.namespace !== void 0 && (e.namespace = u.namespace), u.$initialEditorState !== void 0 && (e.$initialEditorState = u.$initialEditorState), u.nodes) for (const g of Bl(u)) {
...
const Yl = /* @__PURE__ */ new Set(), qo = re({ build(t, e, r) {
  const o = r.getDependency(Aa).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Jn(() => {
  }, () => ue(() => {
...
class nr extends Sa {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: Xl, priority: 0 }) };
  }
  exportDOM() {
...
re({ dependencies: [Aa, qo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(Wl, (s) => {
    const c = Yt();
    if (!pe(c)) return !1;
    ...
    return !0;
  }, Za), t.registerCommand(lc, (s) => {
    if (dc(s.target)) {
      const c = wc(s.target);
      if (Jl(c)) return function(d, l = !1) {
        const w = Yt(), u = d.isSelected(), g = d.getKey();
        let h;
        l && Dn(w) ? h = w : (h = pc(), uc(h)), u ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Rn), t.registerMutationListener(nr, (s, c) => {
    Il(() => {
      let d = !1;
...
re({ build: (t, e, r) => dr(e), config: We({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ue(() => {
    if (!o.disabled.value) return Dl(t, o.onReposition.value);
  });
} });
function ei(t) {
  return t.canBeEmpty();
}
function Zl(t, e, r = ei) {
  return Ce(t.registerCommand(yc, (o) => {
    const n = Yt();
    if (!pe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((g) => kc(g) && g.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), u = Rl(w);
      if (u.canIndent()) {
        const g = u.getKey();
        let h = _c();
        if (h.anchor.set(g, 0, "element"), h.focus.set(g, 0, "element"), h = Nc(h), h.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Cc : So : Ec;
    return t.dispatchCommand(i, void 0);
  }, Za), t.registerCommand(So, () => {
...
re({ build: (t, e, r) => dr(e), config: We({ $canIndent: ei, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ue(() => {
    if (!o.value) return Zl(t, n, i);
  });
} });
const Ql = re({ name: "@lexical/react/ReactProvider" });
function td() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (pe(f)) {
                ...
                if (Da(v) && l >= 0 && w >= 0 && (C = l, y = l + w, f.setTextNodeRange(v, C, v, y)), C === y && u === "" || (f.insertRawText(u), v = x.getNode()), Da(v)) {
                  C = g, y = g + h;
...
re({ build: (t, e, r) => dr(e), config: We({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ue(() => r.getOutput().disabled.value ? void 0 : ai(t)) });
function ad(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const so = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
  ...
  return function(r, o) {
    ...
    return so(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (g) => r._onError(g), children: a(Us, { fallback: null, children: n[l] }) }), u = r.getElementByKey(l);
        u !== null && s.push($c(w, u, l));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function id({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = fe();
  return function(n) {
    so(() => Ce(Oc(n), ai(n)), [n]);
  }(o), p(it, { children: [t, a(sd, { content: e }), a(nd, { editor: o, ErrorBoundary: r })] });
}
...
const ld = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function dd({ onClear: t }) {
  const [e] = fe();
  return ld(() => Wn(e, t), [e, t]), null;
}
const oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
function wd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: u, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: C = !0, style: y, tabIndex: k, "data-testid": I, ...B }, T) {
  const [V, M] = _(t.isEditable()), N = L((R) => {
  ...
  return oi(() => (M(t.isEditable()), t.registerEditableListener((R) => {
    M(R);
...
function hd(t, e) {
  ...
  return p(it, { children: [a(pd, { editor: n, ...o, ref: e }), r != null && a(gd, { editor: n, content: r })] });
}
...
function vd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(ya, { open: !0, onOpenChange: r, children: /* @__PURE__ */ p(ka, { children: [
      /* @__PURE__ */ a(_a, { children: /* @__PURE__ */ a(Na, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function bd({
  ...
  const [e] = fe(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = vd(), d = () => {
  };
...
function yd() {
  const { activeEditor: t } = ii(), [e, r] = _([]), o = L((n) => {
    if (pe(n) || Ac(n)) {
      const i = [];
      Yo.forEach(({ format: s }) => {
...
function _d({
  ...
  return /* @__PURE__ */ p("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(bd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(yd, {}) }) }),
      ...
      /* @__PURE__ */ a(
        id,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(fd, { placeholder: t }) }),
          ErrorBoundary: xl
        }
      ),
      e && /* @__PURE__ */ a(cd, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ a(
          hl,
          {
            ...
            children: /* @__PURE__ */ p(Kt, { children: [
              /* @__PURE__ */ a(_d, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                fl,
                {
...
function ci(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : ci(e.children)
  ) : !1;
}
function ee(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? ci(t.root.children) : !1;
}
function Cd(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Vc(e, n);
      Me().clear(), Sc(i);
    },
    {
      discrete: !0
...
const Ed = "verseText", Lp = Object.freeze([
...
function pi(t) {
  return (t == null ? void 0 : t.conflictType) === Ed;
}
function ui(t) {
...
function Fp({
  ...
  const [i, s] = _(Td), [c, d] = _(n), [l, w] = _(!1), u = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ p(Ae, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ p(
        G,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { children: ma(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        Ie,
        {
          ...
          children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(He, { children: t.map((v) => /* @__PURE__ */ a(
            $e,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: ma(v, o) })
            },
            v || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : lo(v) && (v.preventDefault(), v.stopPropagation(), ee(i) && h());
        },
        onKeyDown: (v) => {
...
function Xo({
  ...
  const h = L(
    ...
    [t.user]
  ), y = A(() => Wa(t.contents), [t.contents]), k = A(
    ...
    if (o && c)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), u(Cd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Rd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Od, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:w-full tw:flex-row tw:flex-wrap tw:items-baseline tw:gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p(xr, { variant: "secondary", className: "tw:text-xs tw:font-normal", children: [
              "→ ",
              Lr(t.assignedUser, r)
            ] })
          ] }),
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: g,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), h()) : lo(T) && (T.preventDefault(), T.stopPropagation(), ee(w) && f());
              },
              onKeyDown: (T) => {
                co(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
        ...
        B && /* @__PURE__ */ p(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(is, {}) }) }),
...
function gi({
  ...
  const [E, Y] = _(Jo), [q, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, At] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, ae] = _(!1), [at, It] = _(I), [zt, Wt] = _(!1), oe = K(void 0), [D, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  const Qt = A(() => Ct[0], [Ct]), me = K(null), ne = K(void 0), P = L(() => {
    var z;
    (z = ne.current) == null || z.call(ne), Y(Jo);
  }, []), X = L(() => {
    const z = !at;
    It(z), Wt(!z), f == null || f(d, z);
  }, [at, f, d]);
  W(() => {
    _t(!1);
  }, [o]), W(() => {
    if (o && !at && !zt) {
      ...
      return oe.current = z, () => clearTimeout(z);
    }
  ...
  }, [i, r]), pt = A(() => Ct.slice(1), [Ct]), ct = A(() => pt.length ?? 0, [pt.length]), gt = A(() => ct > 0, [ct]), ut = A(() => Q || ct <= 2 ? pt : pt.slice(-2), [pt, ct, Q]), ft = A(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), St = A(
  ...
  const Lt = L(
    async (z) => {
      ...
      Ot && await u({ threadId: d, contents: Ot }) && P();
    },
    [
      P,
      E,
    ...
    async (z) => {
      const Ot = ee(E) ? Xr(E) : void 0, yt = z.status ? z.assignedUser : q ?? z.assignedUser, le = await u({
        ...z,
        contents: Ot,
        assignedUser: yt
      });
      return le && (yt !== void 0 && S(yt), Ot && P()), le;
    },
    [P, E, u, q]
  );
  ...
  return /* @__PURE__ */ a(
    Sd,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ p(Dd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            j === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: vt && w !== "Resolved",
                  onClick: () => Rt({ threadId: d, status: "Resolved" }),
        ...
        /* @__PURE__ */ p(it, { children: [
          ...
          o && /* @__PURE__ */ p(it, { children: [
            R && ut.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ p(
              "div",
              {
            ...
            v !== !1 && (!Nt || ee(E)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (z) => {
                  lo(z) && (z.preventDefault(), z.stopPropagation(), (ee(E) || q !== void 0 && q !== O) && Lt());
                },
                onKeyDown: (z) => {
                  co(z), (z.key === "Enter" || z.key === " ") && z.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Wr,
                  ...
                  /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ p(Ae, { open: U, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(qe, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
                        ...
                        Ie,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ge, { children: /* @__PURE__ */ a(He, { children: x == null ? void 0 : x.map((z) => /* @__PURE__ */ a(
                            $e,
                            {
                              ...
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Lr(z, r) })
                            },
                            z || "unassigned"
                          )) }) })
                        }
...
), $d = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Fr = (t) => $d(Wa(t));
function Ur({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Ad({
  ...
  const [s, c] = _("accept"), d = Eo(), l = Eo(), w = r === "loading", u = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = u ? "accept" : s, x = A(
    () => Fr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Fr(t.acceptedText ?? ""),
      ...
      !w && !g && /* @__PURE__ */ p(it, { children: [
        ...
        /* @__PURE__ */ a(
          La,
          {
            ...
            children: T.map((O) => q(O) ? /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ p(qt, { children: [
...
function jd({
  ...
  const [i, s] = _("loading"), [c, d] = _(!1), [l, w] = _(), u = n == null ? void 0 : n.getOptions, g = n == null ? void 0 : n.resolve;
  W(() => {
    let y = !0;
    if (!r) {
      s("loading");
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return ui(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? l;
...
function Bd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: l, isResolving: w, resolve: u, resolvedResolution: g, showResolveCheck: h } = jd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function Jp({
  ...
  const [y, k] = _(/* @__PURE__ */ new Set()), [I, B] = _(), [T, V] = _(), M = L(
    async (S) => {
      const Z = await i(S);
  ...
  const N = r.filter(
    ...
    [y, x]
  ), { listboxRef: Y, activeId: q, handleKeyDown: F } = Bi({
    options: j,
    onOptionSelect: R
  }), O = L(
    (S) => {
      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Bd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(gi, { ...Z })
          },
          S.id
        );
      })
...
function Ld({ table: t }) {
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ p(G, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function cr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ p(
    Bt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Bt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Kc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
function lr({
  ...
  const s = he();
  return /* @__PURE__ */ a(Bt.Portal, { children: /* @__PURE__ */ p(
    Bt.Content,
    {
...
function ie({
  ...
  return /* @__PURE__ */ p(
    Bt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Bt.ItemIndicator, { children: /* @__PURE__ */ a(ta, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ p(
        ir,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(lr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ie, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Gd({
  ...
  var T;
  const [w, u] = _([]), [g, h] = _([]), [f, x] = _({}), [v, C] = _({}), y = A(() => e ?? [], [e]), k = An({
    data: y,
    columns: t,
    getCoreRowModel: Vn(),
  ...
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: I.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    Re,
    {
      ...
      children: V.getVisibleCells().map((M) => /* @__PURE__ */ a(tr, { children: vr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    V.id
  )) : B = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(tr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Ld, { table: k }),
    /* @__PURE__ */ p(Ka, { stickyHeader: i, children: [
      /* @__PURE__ */ a(qa, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(Re, { children: V.headers.map((M) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : vr(M.column.columnDef.header, M.getContext()) }, M.id)) }, V.id)) }),
      /* @__PURE__ */ a(Ga, { children: B })
    ] }),
...
function ru({
  ...
  return /* @__PURE__ */ p(Ae, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(qe, { asChild: !0, children: o }),
    /* @__PURE__ */ p(Ie, { id: i, className: m("tw:min-w-80 tw:max-w-96", n), children: [
...
function au({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ p(G, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(Ne, { children: r.map((l, w) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ a(dn, { children: l.itemType === 0 ? /* @__PURE__ */ a(it, { children: l.items.map((u, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][g],
        ...
        Li,
        {
          ...
          children: l.items.map((u) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Fi, { value: u.id, children: u.label }) }, u.id))
        }
      ) }),
      /* @__PURE__ */ a(Ke, {})
    ] }, l.label)) })
...
function iu({
  ...
  return /* @__PURE__ */ p("div", { id: u, className: "tw:flex tw:items-center tw:gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((g) => {
      var h;
      return /* @__PURE__ */ p(xr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          G,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ a(Ya, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function Zd({
  ...
  const d = Ua(), l = Qo(n, "%undoButton_tooltip%"), w = Qo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ p(Fa, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(
        G,
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ p("p", { children: [
        ...
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(mo, { children: d ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      ...
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ p("p", { children: [
        ...
        i && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ a(mo, { children: d ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Qd({
  ...
  return W(() => {
    var d;
    const i = Ua(), s = ((d = n.current) == null ? void 0 : d.querySelector(".editor-input")) ?? void 0, c = (l) => {
      var u, g, h, f;
...
const tw = (t, e, r) => t === "generated" ? /* @__PURE__ */ p(it, { children: [
...
function ew({
  ...
  const i = K(null), s = K(null), c = K(!1), [d, l] = _(t), [w, u] = _(r), [g, h] = _(!1);
  W(() => {
    l(t);
  }, [t]), W(() => {
    w !== r && u(r);
  ...
  return /* @__PURE__ */ p(ke, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: tw(t, n, r) }) }) }),
...
const rw = (t, e) => t === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ a(vn, {}),
  " ",
...
function ow({
  ...
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: rw(t, r) }) }) }),
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: aw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ p(Ne, { style: { zIndex: wn }, children: [
...
function sw({
  ...
  return /* @__PURE__ */ p(Ge, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      Zr,
      {
    ...
    /* @__PURE__ */ p(He, { children: [
      /* @__PURE__ */ a(Ba, { children: t["%markerMenu_noResults%"] }),
...
function su({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [I, B] = _("*"), [T, V] = _("f"), [M, N] = _(!1), [j, R] = _(!0), [E, Y] = _(!1), q = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [At, U] = _(), [tt, wt] = _(), st = K(null), vt = A(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      pt === Ra ? ct = "generated" : pt === Oa ? ct = "hidden" : pt && (k(pt), B(pt)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const at = L(
    (P, X, ot = !1) => {
      ...
      if (et && Or("note", et)) {
        if (et.insert.note) {
          let ut;
          P === "custom" ? ut = X : P === "generated" ? ut = Ra : ut = Oa, et.insert.note.caller = ut;
        }
  ...
  Zt(() => {
    (Wt.current.book !== n.book || Wt.current.chapterNum !== n.chapterNum) && (Wt.current = { book: n.book, chapterNum: n.chapterNum }, zt.current());
  }, [n.book, n.chapterNum]);
  const oe = () => {
    var X;
    ...
    if (X && Or("note", X)) {
      ...
      T !== "x" && P === "x" ? ut == null || ut.forEach((ft) => lw(ft)) : T === "x" && P !== "x" && (ut == null || ut.forEach((ft) => dw(ft))), (gt = w.current) == null || gt.applyUpdate([X, { delete: 1 }]);
    }
  }, Ct = (P) => {
    ...
    (P) => {
      ...
      if (X && Or("note", X)) {
        ...
        if (ut || N(!1), N(
          ut === "x" ? !!(ft != null && ft.every((St) => {
            var Lt, Rt;
            if (!((Lt = St.attributes) != null && Lt.char)) return !0;
            const Dt = ((Rt = St.attributes) == null ? void 0 : Rt.char).style;
          ...
          q.current = !0, F.current = JSON.stringify(X), R(!0);
          return;
        }
        R(JSON.stringify(X) === F.current), at(f, y);
      } else
        N(!1), R(!0);
    },
    [f, y, at]
  ...
  return /* @__PURE__ */ p(it, { children: [
    /* @__PURE__ */ p("div", { ref: h, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ p(Fa, { children: [
          /* @__PURE__ */ a(
            Zd,
            {
              onUndoClick: () => {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
              ...
              /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: ne }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ p(it, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(it, { children: pw(t.marker, c, o, l) })
      }
    )
  ] });
}
...
function fw({
  ...
  return /* @__PURE__ */ p(Ka, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(qa, { stickyHeader: !0, children: /* @__PURE__ */ p(Re, { children: [
      /* @__PURE__ */ a(qr, { children: n }),
      /* @__PURE__ */ a(qr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Ga, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ p(
      Re,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(tr, { className: o, children: gw(c.text) })
        ]
      },
...
const mw = (t) => {
...
}, ra = (t, e, r) => /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ p(qt, { children: [
  /* @__PURE__ */ p(
    Gt,
    {
  ...
  header: ({ column: e }) => ra(e, t)
}), vw = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (r) => r.items[e],
  header: ({ column: r }) => ra(r, t)
}), wu = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => ra(e, t, "tw:justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: i }) => ra(i, t, "tw:justify-center"),
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ p(cn, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Vr,
          {
            onClick: (d) => {
              d.stopPropagation(), va(
                [c],
                "approved",
                e,
                r,
  ...
  return e ? e[1] : "";
}, bw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fu = Object.freeze([
...
function mu({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), C = de(r, "%webView_inventory_scope_currentBook%"), y = de(r, "%webView_inventory_scope_chapter%"), k = de(r, "%webView_inventory_scope_verse%"), I = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = de(r, "%webView_inventory_no_results%"), [V, M] = _(!1), [N, j] = _("all"), [R, E] = _(""), [Y, q] = _([]), F = A(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = A(() => O.length === 0 ? [] : xw(O, N, R), [O, N, R]), Z = A(() => {
    var wt, st;
    if (!V) return d;
...
const kw = "16rem", _w = "3rem", vi = Ut.createContext(void 0);
function aa() {
  const t = Ut.useContext(vi);
  if (!t)
...
function Nw({
  ...
  const [d, l] = Ut.useState(t), w = e ?? d, u = Ut.useCallback(
    (k) => {
      const I = typeof k == "function" ? k(w) : k;
      r ? r(I) : l(I);
    },
    [r, w]
  ), g = Ut.useCallback(() => u((k) => !k), [u]), h = w ? "expanded" : "collapsed", v = he() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: u,
    ...
    "--sidebar-width": kw,
    "--sidebar-width-icon": _w,
    ...n
  };
  return /* @__PURE__ */ a(vi.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
...
function vu({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = aa();
  return /* @__PURE__ */ p(
    G,
    {
...
function Rw({
  ...
  const c = t ? Tr.Root : "button", { state: d } = aa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(Dw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Ow({
  ...
  return /* @__PURE__ */ a(
    Cw,
    {
      ...
      children: /* @__PURE__ */ p(Tw, { children: [
        /* @__PURE__ */ p(en, { children: [
          /* @__PURE__ */ a(rn, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(an, { children: /* @__PURE__ */ a(zw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Sw, { children: /* @__PURE__ */ a(
            Rw,
            {
              onClick: () => l(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ p(en, { children: [
          ...
          /* @__PURE__ */ a(an, { className: "tw:pl-3", children: /* @__PURE__ */ p(
            "div",
            {
              className: m(
...
const Se = "scrBook", Mw = "scrRef", Le = "source", $w = "details", Aw = "Scripture Reference", Iw = "Scripture Book", bi = "Type", Vw = "Details";
function Pw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Se,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Aw,
      cell: (o) => {
    ...
    },
    {
      ...
      id: $w,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Vw,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
const jw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || za(t.start, t.end) === 0 ? `${ia(t.start)}+${e}` : `${ia(t.start)}+${e}-${ia(t.end)}+${r}`;
...
function Ou({
  ...
  const [l, w] = _([]), [u, g] = _([{ id: Se, desc: !1 }]), [h, f] = _({}), x = A(
  ...
  W(() => {
    if (c) {
      ...
      if (j.length === 1) {
        const R = x.find((E) => on(E) === j[0]) || void 0;
        R && c(R);
      }
    }
  }, [h, x, c, C]);
  const y = n ?? Iw, k = i ?? bi, I = [
  ...
  }, V = (N, j) => N.getIsGrouped() ? "" : m("banded-row", j % 2 === 0 ? "even" : "odd"), M = (N, j, R) => {
    ...
    !e && /* @__PURE__ */ p(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Fd, { children: I.map((N) => /* @__PURE__ */ a(ie, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Ka, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(qa, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ a(Re, { children: N.headers.filter((j) => j.column.columnDef.header).map((j) => (
      ...
      /* @__PURE__ */ a(Ga, { children: C.getRowModel().rows.map((N, j) => {
        const R = he();
        return /* @__PURE__ */ a(
          Re,
          {
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ p(
                      G,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (R === "ltr" ? /* @__PURE__ */ a(Ea, {}) : /* @__PURE__ */ a(Ca, {})),
                          " ",
...
const yi = (t, e, r) => po(t, e).every((o) => r.includes(o));
function Bw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: u, ntLong: g, dcLong: h, extraLong: f } = {
    ...
    (E, Y = !1) => {
      ...
      const q = B.findIndex((Q) => Q === k.current), F = B.findIndex((Q) => Q === E);
      if (q === -1 || F === -1) return;
      const [O, S] = [
        Math.min(q, F),
        Math.max(q, F)
  ...
  return /* @__PURE__ */ p(
    Ae,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ie, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ p(
          Ge,
          {
            shouldFilter: !1,
            onKeyDown: (E) => {
                  ...
                  if (q.length !== 0)
                    return /* @__PURE__ */ p(kn, { children: [
                      /* @__PURE__ */ a(
                        ye,
                        {
                          heading: sn(E, u, g, h, f),
                          children: q.map((F) => /* @__PURE__ */ a(
                            jn,
                            {
                              bookId: F,
                      ...
                      Y < Object.values(dt).length - 1 && /* @__PURE__ */ a(pn, {})
                    ] }, E);
                })
              ] })
            ]
...
function $u({
  ...
  const I = Et(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = Et(s, "%webView_scope_selector_verse%"), T = Et(s, "%webView_scope_selector_chapter%"), V = Et(s, "%webView_scope_selector_book%"), M = Et(
    s,
    "%webView_scope_selector_current_verse%"
  ), N = Et(
    s,
    "%webView_scope_selector_current_chapter%"
  ), j = Et(s, "%webView_scope_selector_current_book%"), R = Et(s, "%webView_scope_selector_choose_books%"), E = Et(s, "%webView_scope_selector_scope%"), Y = Et(s, "%webView_scope_selector_select_books%"), q = Et(s, "%webView_scope_selector_range%"), F = Et(s, "%webView_scope_selector_select_range%"), O = Et(s, "%webView_scope_selector_range_start%"), S = Et(s, "%webView_scope_selector_range_end%"), Z = Et(s, "%webView_scope_selector_ok%"), Q = Et(s, "%webView_scope_selector_cancel%"), _t = Et(s, "%webView_scope_selector_navigate%"), Nt = ($) => {
    if (!f) return;
  ...
  ], U = ($, J, Ft = !1) => /* @__PURE__ */ p(it, { children: [
    $,
    J && !Ft && /* @__PURE__ */ p("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      J
    ] })
  ] }), tt = e ? At.filter(($) => e.includes($.value)) : At, wt = f ?? sa, st = w ?? wt, vt = u ?? wt, ae = () => {
  }, at = K(null), It = K(null), zt = K(!1), Wt = K(null), oe = K(!1), [D, Xt] = _(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L(($) => {
    if ($) {
    ...
    Xt((J) => J === "start" ? void 0 : J), xt.current && (xt.current = !1, requestAnimationFrame(() => {
      var Ft;
      const J = (Ft = at.current) == null ? void 0 : Ft.querySelector("button");
      J == null || J.click();
    }));
  }, []), ne = L(($) => {
    if ($) {
    ...
    ($) => {
      g == null || g($), h == null || h($), xt.current = !0;
    },
    [g, h]
  ), X = L(
    ($) => {
    ...
    [r, n, f, i]
  ), et = tt.find(($) => $.value === t), pt = () => t === "selectedBooks" && n.length > 0 ? n.map(($) => $.toUpperCase()).join(", ") : t === "range" ? js(st, vt, {
  ...
  ), gt = tt.find(($) => $.value === "selectedBooks"), ut = tt.find(($) => $.value === "range"), [ft, St] = _(!1), [Dt, Lt] = _(void 0), [Rt, Ee] = _(void 0), [z, Ot] = _(void 0), [yt, le] = _(void 0), [Te, wr] = _([]), pr = l === "dropdown" && Dt === "selectedBooks", ur = /* @__PURE__ */ a(
    Fw,
    {
      availableBookInfo: o,
      selectedBookIds: pr ? Te : n,
      onChangeSelectedBookIds: pr ? wr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), zr = D === "end", Sr = D === "start", Xe = "tw:text-muted-foreground", b = l === "dropdown" && Dt === "range", H = b ? Ot : P, Vt = b ? le : h ? X : ae, ve = /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ p("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        la,
        {
          ...
          onCloseAutoFocus: ($) => {
            var J;
            Ct.current && (Ct.current = !1, $.preventDefault(), (J = Qt.current) == null || J.focus());
          },
          className: m(Sr && Xe),
          modal: !0,
          align: "start"
  ...
  const [mt, $t] = _(null), [ht, te] = _(null), [Jt, je] = _(null), Si = 200, [Di, Ri] = _(!1);
  W(() => {
    if (!Jt || typeof ResizeObserver > "u") return;
    const $ = new ResizeObserver(([J]) => {
      Ri(J.contentRect.width < Si);
    });
    return $.observe(Jt), () => $.disconnect();
  }, [Jt]);
  const uo = L(
    ($) => {
      Ee($), Ot(st), le(vt), wr(n), St(!1), Lt($);
    },
    [st, vt, n]
  ), ho = L(() => {
    Rt !== void 0 && (Rt === "range" ? (z && (g == null || g(z)), yt && (h == null || h(yt))) : Rt === "selectedBooks" && i(Te), ot(Rt), Lt(void 0), Ee(void 0));
  }, [
    Rt,
    z,
    yt,
    ...
    var J;
    $.preventDefault(), (J = Mt.current) == null || J.focus();
  }, []), fo = ($) => t === $ ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(kt, { children: E }),
      l === "dropdown" ? /* @__PURE__ */ p(ke, { open: ft, onOpenChange: St, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(oa, { container: Jt, children: [
              ct.map(({ value: $, label: J, dropdownLabel: Ft, scrRefSuffix: hr, id: Oi }) => /* @__PURE__ */ p(
                Fe,
                {
                  ref: ze($),
                  ...
                  children: [
                    t === $ && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-4 tw:w-4" }) }),
                    U(Ft ?? J, hr, Di)
                  ]
                },
                Oi
              ...
              x && /* @__PURE__ */ p(it, { children: [
                ...
                /* @__PURE__ */ a(
                  Fe,
                  {
                    ...
                    onSelect: ($) => {
                      var J, Ft;
                      if ($.preventDefault(), zt.current) {
                        zt.current = !1;
                        return;
                      }
                      oe.current || (Ft = (J = It.current) == null ? void 0 : J.querySelector("button")) == null || Ft.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: ($) => {
                          ...
                          J != null && J.closest("button") && (zt.current = !0, requestAnimationFrame(() => {
                            zt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          la,
                          {
                            ...
                            onCloseAutoFocus: ($) => {
                              var J;
                              $.preventDefault(), (J = Wt.current) == null || J.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ p(it, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: be(f ?? sa, "id") }),
                              /* @__PURE__ */ a(or, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        La,
        {
          ...
          children: tt.map(({ value: $, label: J, scrRefSuffix: Ft, id: hr }) => /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Kr, { className: "tw:me-2", value: $, id: hr }),
            /* @__PURE__ */ a(kt, { htmlFor: hr, children: U(J, Ft) })
          ] }, hr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && ve,
    l === "dropdown" && gt && /* @__PURE__ */ a(ya, { open: Dt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      ka,
      {
        ref: te,
        onCloseAutoFocus: go,
        onEscapeKeyDown: ($) => {
          ht != null && ht.querySelector('[data-state="open"]') && $.preventDefault();
        },
        children: /* @__PURE__ */ p(oa, { container: ht, children: [
          /* @__PURE__ */ a(_a, { className: "tw:pe-8", children: /* @__PURE__ */ a(Na, { children: R }) }),
          ur,
          /* @__PURE__ */ p(vo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Dr(!1), children: Q }),
            /* @__PURE__ */ a(G, { onClick: ho, children: Z })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ut && /* @__PURE__ */ a(ya, { open: Dt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      ka,
      {
        ref: $t,
        onCloseAutoFocus: go,
        onEscapeKeyDown: ($) => {
          mt != null && mt.querySelector('[data-state="open"]') && $.preventDefault();
        },
        children: /* @__PURE__ */ p(oa, { container: mt, children: [
          /* @__PURE__ */ a(_a, { className: "tw:pe-8", children: /* @__PURE__ */ a(Na, { children: F }) }),
          ve,
          /* @__PURE__ */ p(vo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Dr(!1), children: Q }),
            /* @__PURE__ */ a(G, { ref: Qt, onClick: ho, children: Z })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          lr,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((w) => /* @__PURE__ */ a(ie, { value: `${w}`, children: d[No(w)] }, `${w}`))
          }
        )
      ]
    }
...
const _i = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ p(Wi, { children: [
    /* @__PURE__ */ a(Xi, { children: c.label }),
    /* @__PURE__ */ a(Ji, { children: /* @__PURE__ */ a(Zi, { children: _i(
      t,
      e,
      ki(t, c.id),
      o
...
function Va({
  ...
  return /* @__PURE__ */ p(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ss, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ p(kn, { children: [
      /* @__PURE__ */ a(dn, { children: /* @__PURE__ */ a(Kt, { children: _i(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ke, {})
    ] }, d)) })
  ] });
}
const Ni = Ut.forwardRef(
...
function ju({
  ...
  return /* @__PURE__ */ p(Ni, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Va,
      {
        onSelectMenuItem: t,
...
const Ci = Ut.forwardRef(({ className: t, ...e }, r) => {
  const o = he();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
Ci.displayName = ce.List.displayName;
const Ei = Ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: m(
...
Ei.displayName = ce.List.displayName;
const qw = Ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Trigger,
  {
    ref: r,
    ...e,
...
)), Ti = Ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Content,
  {
    ref: r,
    className: m(
...
Ti.displayName = ce.Content.displayName;
function Lu({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ p("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Ci, { children: [
      /* @__PURE__ */ a(Ei, { children: t.map((c) => /* @__PURE__ */ a(qw, { value: c.value, children: c.value }, c.key)) }),
...
const fr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(Zw, {}, `separator-${i}`)), d;
  });
};
function rp({
  menuData: t,
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, u) => {
    var f, x, v, C;
    w.preventDefault();
    ...
    return /* @__PURE__ */ a(Gw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w, u]) => /* @__PURE__ */ p(Hw, { children: [
      /* @__PURE__ */ a(Ww, { ref: l(w), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ a(
        Xw,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Kt, { children: zi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function op({ item: t, createLabel: e, createComplexLabel: r }) {
        ...
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ p(ke, { children: [
              /* @__PURE__ */ a(_e, { className: m(u && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(G, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
...
function Hu({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function ch({
  ...
  return /* @__PURE__ */ p(
    Tt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Tt.ItemIndicator, { children: /* @__PURE__ */ a(ta, {}) }) }),
        e
      ]
    }
  );
...
function Eh({
  ...
  return /* @__PURE__ */ a(
    ce.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", lp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Oh(t) {
  const e = A(() => Bs(t).slice().sort().join(" "), [t]);
...
export {
  ...
  eu as ERROR_POPOVER_STRING_KEYS,
  Qd as EditorKeyboardShortcuts,
  Hu as EmptyState,
  Yd as ErrorDump,
  ru as ErrorPopover,
  cu as FOOTNOTE_EDITOR_STRING_KEYS,
  iu as Filter,
  au as FilterDropdown,
  nu as Footer,
  su as FootnoteEditor,
  hw as FootnoteItem,
  lu as FootnoteList,
  fu as INVENTORY_STRING_KEYS,
  Qr as Input,
  mu as Inventory,
  mo as Kbd,
  Uh as KbdGroup,
  ...
  Kh as PopoverDescription,
  qh as PopoverHeader,
  oa as PopoverPortalContainerProvider,
  Gh as PopoverTitle,
  ...
  Hh as ResizableHandle,
  Yh as ResizablePanel,
  Wh as ResizablePanelGroup,
  Gu as ResultsCard,
  Mu as SCOPE_SELECTOR_STRING_KEYS,
  Uw as SELECT_BOOKS_STRING_KEYS,
  $u as ScopeSelector,
  Ou as ScriptureResultsViewer,
  Au as ScrollGroupSelector,
  un as SearchBar,
  ir as Select,
  Fw as SelectBooks,
  ...
  Cw as Sidebar,
  Tw as SidebarContent,
  ku as SidebarFooter,
  en as SidebarGroup,
  Nu as SidebarGroupAction,
  ...
  Rw as SidebarMenuButton,
  Sw as SidebarMenuItem,
  Tu as SidebarMenuSkeleton,
  zu as SidebarMenuSub,
  Du as SidebarMenuSubButton,
  Su as SidebarMenuSubItem,
  Nw as SidebarProvider,
  bu as SidebarRail,
  _u as SidebarSeparator,
  vu as SidebarTrigger,
  Qe as Skeleton,
  _h as Slider,
  kh as Sonner,
  Xh as Spinner,
  Nh as Switch,
  Va as TabDropdownMenu,
  ...
  m as cn,
  gu as getBookIdFromUSFM,
  qp as getCommentThreadElementId,
  ra as getInventoryHeader,
  uu as getLinesFromUSFM,
  hu as getNumberFromUSFM,
  bw as getStatusForItem,
  Fu as getToolbarOSReservedSpaceClassName,
  wu as inventoryCountColumn,
  du as inventoryItemColumn,
  pu as inventoryStatusColumn,
  Ua as isMacOs,
  ng as isWindows,
  cg as sonner,
  Sh as useEvent,
  Dh as useEventAsync,
  Oh as useExtraValidMarkers,
  Bi as useListbox,
  wp as usePromise,
  Vp as useRecentSearches,
  aa as useSidebar,
  Rh as useStylesheet,
  ig as useTruncationTooltip,
  Mh as useViewVisibility
};
