...
import { c as m, g as Ee, a as Ua, C as ke, A as ie, P as De, b as We, B as q, d as Me, e as Oe, f as $e, h as xe, i as Vi, k as Pi, j as ji, E as Li, l as Ka, r as pe, m as Bi, n as ln, o as Qr, p as ta, L as Nt, R as qa, q as qr, D as Ca, s as Ea, t as Ta, u as za, T as dn, v as Pr, w as Vt, x as Ga, y as Pt, z as jt, F as Lt, G as wn, H as Ha, I as Ge, J as kr, K as Ie, M as Ae, N as Ve, S as _r, O as er, Q as Fi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ya, $ as Wa, a0 as Gr, a1 as Xa, a2 as un, a3 as Ui, a4 as Ki, a5 as qi, a6 as Sa, a7 as pn, a8 as ea, a9 as hn, aa as Gi, ab as Hi, ac as Yi, ad as Wi, ae as gn, af as Xi, ag as ca, ah as xo, ai as la, aj as Ji, ak as Zi, al as Qi, am as ts, an as es, ao as Tr, ap as Ja, aq as rs, ar as as } from "./resizable-aPuquhT0.js";
import { as as og, at as ng, au as ig, av as sg, aw as cg, ax as lg, ay as dg, az as wg, aA as ug, aB as pg, aC as hg, aD as gg, aE as fg, aF as mg, aG as vg, aH as bg, aI as xg, aJ as yg, aK as kg, aL as _g, aM as Ng, aN as Cg, aO as Eg, aP as Tg, aQ as zg } from "./resizable-aPuquhT0.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as Se, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ra, ChevronRight as Da, ArrowLeft as os, ArrowRight as ns, ChevronDown as nr, BoldIcon as is, ItalicIcon as ss, X as Za, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Ma, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Ms, MenuIcon as Os, Menu as $s, EllipsisVertical as Is, MoreVertical as As } from "lucide-react";
import { Section as dt, getChaptersForBook as Vs, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ps, formatReplacementString as He, sanitizeHtml as Qa, NumberFormat as kn, formatBytes as js, getCurrentLocale as Ls, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Fs, isString as No, compareScrRefs as Oa, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Ks } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as qs, useLayoutEffect as Qt, createContext as to, useContext as _n, Component as Gs, createElement as To, Suspense as Hs, forwardRef as Nn, useId as zo, Fragment as ra } from "react";
...
import { Avatar as oo, Select as Gt, Checkbox as Mo, Slot as Sr, Tabs as se, Menubar as he, ContextMenu as Rt, Progress as Oo, Slider as Mr, Switch as $o } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as Aa, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as al, isInsertEmbedOpOfType as Or, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function pa({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [V, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Ft[rt].filter((At) => Ka(At, V, n));
    }), x;
  }, [Ft, V, n]), R = D(
    () => pl(V, Jt, n),
    [V, Jt, n]
...
function jo({
  ...
  const [N, M] = _(!1), B = d ?? l, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
    const V = l(A), U = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, k = `${C ?? ""}${V}${U ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: V,
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = Gn ? Qt : H, Ir = { tag: eo };
...
function Ol(t, e = Ml) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, M = t.getElementByKey(b), B = t.getElementByKey(y), z = r === null || M !== o || v !== n || b !== r.getKey(), I = i === null || B !== s || N !== c || y !== i.getKey();
      if ((z || I) && M !== null && B !== null) {
        const A = function(C, V, U, k, J, j, Y) {
          const T = (C._window ? C._window.document : document).createRange();
          return T.setStart(...Lo(V, U, k)), T.setEnd(...Lo(J, j, Y)), T;
        }(t, h, f, M, g, E, B);
        l(), l = Dl(t, A, e);
      }
...
let Yr, be = 0, Wr = 0, Bl = 0, ja = 0, Br = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ul(t) {
  ...
  Wn(this), nt = t, this.f &= -2, 8 & this.f && so(this), na();
}
function tr(t, e) {
...
qt.prototype.brand = jl, qt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Wr === 0 && e.l !== ja && (e.l = ja, Yr = { S: e, v: e.v, i: e.i, o: Yr });
...
function Zn(t, e = Jn) {
  return t.registerCommand(Mn, (r) => (t.update(e), !0), ro);
}
...
const La = re({ build: (t) => ti(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, Ba = 1, ri = 2, ma = 3, Ar = 4, Qe = 5, va = 6, mr = 7;
function ba(t) {
  return t.id === co;
}
function ai(t) {
...
function Gl(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || lt(305, String(t.id), String(Ba)), Object.assign(t, { id: ri });
}
...
class or {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ba(i) || lt(300, s, n || "[unknown]"), ba(c = i) || lt(304, String(c.id), String(co)), i = Object.assign(c, { id: Ba }), o.state = i;
...
const Zl = /* @__PURE__ */ new Set(), Ho = re({ build(t, e, r) {
  const o = r.getDependency(La).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => ue(() => {
...
}, dependencies: [La], name: "@lexical/extension/NodeSelection" }), Ql = kc("INSERT_HORIZONTAL_RULE_COMMAND");
class ir extends $a {
  static getType() {
...
re({ dependencies: [La, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if (Ia(v) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(v, E, v, y)), E === y && p === "" || (f.insertRawText(p), v = b.getNode()), Ia(v)) {
                  E = h, y = h + g;
...
function pi({
  ...
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : po(v) && (v.preventDefault(), v.stopPropagation(), ee(i) && g());
        },
        onKeyDown: (v) => {
...
function Zo({
  ...
  const g = L(
    ...
    [t.user]
  ), y = D(() => Qa(t.contents), [t.contents]), N = D(
...
function vi({
  ...
  const Zt = D(() => Ct[0], [Ct]), _e = F(null), te = F(void 0), P = L(() => {
    var S;
  ...
  const Ht = L(
    async (S) => {
      ...
      It && await p({ threadId: l, contents: It }) && P();
    },
    [
      P,
      k,
    ...
    async (S) => {
      ...
      return oe && (xt !== void 0 && $(xt), It && P()), oe;
    },
    [P, k, p, j]
  );
...
), Pd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Pd(Qa(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function jd({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), k = (T) => T ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: T }) : U, J = () => {
    const T = o ?? "accept";
      ...
      !w && !h && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          qa,
          {
            ...
            children: z.map((T) => j(T) ? /* @__PURE__ */ a(Vt, { delayDuration: 0, children: /* @__PURE__ */ u(Pt, { children: [
              /* @__PURE__ */ a(jt, { asChild: !0, children: Y(T) }),
              /* @__PURE__ */ a(Lt, { children: M })
            ] }) }, T.value) : Y(T))
          }
        ),
        /* @__PURE__ */ a(Vt, { delayDuration: 0, children: /* @__PURE__ */ u(Pt, { children: [
...
function Xd({
  ...
  var z;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, E] = _({}), y = D(() => e ?? [], [e]), N = jn({
    data: y,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  return l ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ya, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Wa, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Te, { children: I.headers.map((A) => /* @__PURE__ */ a(Gr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, I.id)) }),
...
function rw({
  ...
  const l = Ha(), d = en(n, "%undoButton_tooltip%"), w = en(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
    ...
    e && /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
        {
          "aria-label": w,
...
function cw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    ...
    /* @__PURE__ */ u(Ve, { style: { zIndex: pn }, children: [
...
function vp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [M, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Or("note", Q)) {
      ...
      let st = "custom";
      it === Aa ? st = "generated" : it === Va ? st = "hidden" : it && (N(it), B(it)), b(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (P, Q, et = !1) => {
      ...
      if (ot && Or("note", ot)) {
        if (ot.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = Aa : pt = Va, ot.insert.note.caller = pt;
        }
  ...
  const Jt = () => {
    ...
    if (Q && Or("note", Q)) {
      ...
      z !== "x" && P === "x" ? pt == null || pt.forEach((gt) => hw(gt)) : z === "x" && P !== "x" && (pt == null || pt.forEach((gt) => gw(gt))), (ht = w.current) == null || ht.applyUpdate([Q, { delete: 1 }]);
    }
  }, Ct = (P) => {
    ...
    if (h.current && ae.length && P && P.rangeCount > 0) {
      const Q = P.getRangeAt(0).getBoundingClientRect(), et = h.current.getBoundingClientRect();
  ...
  H(() => {
    ...
    const P = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !T && P && document.activeElement === P && ot.key === c ? (ot.preventDefault(), _e()) : T && ot.key === "Escape" && (ot.preventDefault(), $(!1));
    };
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
              /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
                q,
                {
                  "aria-label": te,
...
function yw({
  ...
  return /* @__PURE__ */ u(Ya, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Wa, { stickyHeader: !0, children: /* @__PURE__ */ u(Te, { children: [
...
}, ia = (t, e, r) => /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
  /* @__PURE__ */ u(
    jt,
    {
...
function zp({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), M = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = le(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, V] = _("all"), [U, k] = _(""), [J, j] = _([]), Y = D(() => {
    const K = t ?? [];
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
...
const Ce = "scrBook", Pw = "scrRef", qe = "source", jw = "details", Lw = "Scripture Reference", Bw = "Scripture Book", ki = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Up({
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const U = b.find((k) => sn(k) === V[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, E]);
  ...
  }, I = (C, V) => C.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), A = (C, V, U) => {
    if (!((C == null ? void 0 : C.length) === 0 || V.depth < U.column.getGroupedIndex())) {
      if (V.getIsGrouped())
        switch (V.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ya, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Wa, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Te, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Xa, { children: E.getRowModel().rows.map((C, V) => {
        const U = pe();
        return /* @__PURE__ */ a(
          Te,
          {
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Da, {}) : /* @__PURE__ */ a(Ra, {})),
                          " ",
...
function qp({
  ...
  const M = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), U = St(s, "%webView_scope_selector_choose_books%"), k = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (O) => {
    if (!f) return;
  ...
  ] }), tt = e ? Bt.filter((O) => e.includes(O.value)) : Bt, wt = f ?? wa, at = w ?? wt, mt = p ?? wt, ae = () => {
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Be = d === "dropdown" && zt === "range", x = Be ? It : P, rt = Be ? oe : g ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: m(gr && Ze), children: T }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ut, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: m(Rr && Ze), children: $ }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    ...
    d === "radio" && t === "range" && At,
    d === "dropdown" && ht && /* @__PURE__ */ a(Ca, { open: zt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: ft,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ u(ca, { container: _t, children: [
    ...
    d === "dropdown" && pt && /* @__PURE__ */ a(Ca, { open: zt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: kt,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Et, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: Y }) }),
          At,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Z }),
...
function Fa({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ve, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Vt, { children: Ei(e.groups, e.items, l, t) }) }),
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Zw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Vt, { children: Di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ih({
  ...
  return /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Pt, { children: [
    /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(
      pu,
      {
        className: o,
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(Ie, { children: [
                  /* @__PURE__ */ a(Ae, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    q,
                    {
...
function jh({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      "data-variant": e,
      className: m(mu({ variant: e, className: t })),
      ...r
    }
  );
}
...
function Yh({
  ...
  return /* @__PURE__ */ a(
    se.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", vu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
