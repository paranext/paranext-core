...
import { useReactTable as Qa, getCoreRowModel as ei, getPaginationRowModel as fl, getSortedRowModel as ti, getFilteredRowModel as ml, flexRender as sn, getExpandedRowModel as hl, getGroupedRowModel as gl } from "@tanstack/react-table";
...
import { MenuItem as xl, ListItemText as Nl, ListItemIcon as oi, Menu as kl, Grid as ai, List as El, IconButton as ii, Drawer as Tl, AppBar as Cl, Toolbar as Sl } from "@mui/material";
...
function Ht(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Jo ? Jo[e] : 0;
}
function ro(e) {
  return Ht(e) > 0;
}
...
*/
te(Ee, "ValidStatusType", ui);
class Jt extends Error {
}
const ao = we.Root, wi = we.Trigger, Hl = we.Group, xm = we.Portal, Nm = we.Sub, km = we.RadioGroup, Xl = A.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
    ...
    children: [
      n,
      /* @__PURE__ */ s(Ya, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
...
const fi = A.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ s(
  we.Item,
  {
    ref: r,
    className: T(
...
fi.displayName = we.Item.displayName;
...
const mi = A.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(we.ItemIndicator, { children: /* @__PURE__ */ s(Wa, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
mi.displayName = we.RadioItem.displayName;
...
function Em({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ue(""), [o, a] = ue(
    ...
    oe.bookNumberToId(e.bookNum)
  ), [p, h] = ue(!1), [w, g] = ue(p), v = gt(void 0), f = gt(void 0), m = gt(void 0), N = $e(
    (k) => tc(k).filter((B) => {
        ...
        children: [
          ...
          Qo.map(
            (k, B) => N(k).length > 0 && /* @__PURE__ */ x("div", { children: [
              ...
              Qo.length - 1 !== B ? /* @__PURE__ */ s(nr, {}) : void 0
            ] }, k)
          )
        ]
      }
...
), He = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(Za.Root, { ref: n, className: T("pr-twp", ic(), e), ...t }));
He.displayName = Za.Root.displayName;
const hi = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  un.Root,
  {
...
hi.displayName = un.Root.displayName;
const Gr = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  un.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ s(un.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(Wa, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Gr.displayName = un.Item.displayName;
const gi = wn.Root, bi = wn.Trigger, so = A.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(wn.Portal, { children: /* @__PURE__ */ s(
  wn.Content,
  {
    ref: o,
    align: t,
...
const sc = Ye.Portal, vi = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ s(
  Ye.Overlay,
  {
    ref: n,
    className: T(
...
vi.displayName = Ye.Overlay.displayName;
...
const co = A.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
  /* @__PURE__ */ s(Ka, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
  /* @__PURE__ */ s(
    Oe.Input,
    {
      ref: n,
...
const yi = A.forwardRef((e, t) => /* @__PURE__ */ s(Oe.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
yi.displayName = Oe.Empty.displayName;
...
function ea({
  ...
  const [f, m] = ue(!1);
  return /* @__PURE__ */ x(gi, { open: f, onOpenChange: m, ...v, children: [
    /* @__PURE__ */ s(bi, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: p,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ s(Ja, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
...
function Cm({
  ...
  const p = Sr(d, "%webView_bookSelector_currentBook%"), h = Sr(d, "%webView_bookSelector_choose%"), w = Sr(d, "%webView_bookSelector_chooseBooks%"), [g, v] = ue(
    "current book"
    /* CURRENT_BOOK */
  ), f = (m) => {
    v(m), e(m);
...
function Nc({
  ...
  var m;
  const [l, c] = ue([]), [d, p] = ue([]), [h, w] = ue({}), [g, v] = ue({}), f = Qa({
    data: t,
    columns: e,
    getCoreRowModel: ei(),
...
wo.displayName = Fr.Root.displayName;
...
Sc.displayName = ni.Root.displayName;
...
const ir = (e) => e === "asc" ? /* @__PURE__ */ s(qs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ s(Ks, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(Js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Sm = (e) => ({
  ...
  return Ec(e).forEach((p) => {
    p.startsWith("\\id") && (i = Tc(p), l = 0, c = 0), p.startsWith("\\c") && (l = ta(p), c = 0), p.startsWith("\\v") && (c = ta(p), l === 0 && (l = t.chapterNum));
    ...
    for (; h; ) {
      ...
      const g = h.index, v = a.find((m) => to(m.items, w)), f = {
        ...
        text: dl(p, Math.max(0, g - 25), Math.min(g + 25, p.length))
      };
      if (v)
...
function _m({
  ...
  const h = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), g = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), m = Je(n, "%webView_inventory_scope_chapter%"), N = Je(n, "%webView_inventory_scope_verse%"), I = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ue(!1), [_, L] = ue("all"), [H, C] = ue(""), [P, k] = ue([]), B = Te(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    i,
        ...
        fn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Bt, { children: [
              ...
              /* @__PURE__ */ s(Ue, { value: "unapproved", children: g }),
...
function $m({
  ...
  return /* @__PURE__ */ x(gi, { open: c, onOpenChange: d, children: [
    /* @__PURE__ */ s(bi, { asChild: !0, children: /* @__PURE__ */ x(
      me,
      {
        variant: "outline",
        ...
        children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ s("div", { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50", children: /* @__PURE__ */ s("span", { className: "tw-flex tw-h-full tw-w-full tw-items-center tw-justify-center", children: l }) }),
            /* @__PURE__ */ s(
              "div",
              {
                className: T(
          ...
          /* @__PURE__ */ s(Ja, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(so, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ x(lo, { children: [
      ...
      /* @__PURE__ */ s(po, { children: /* @__PURE__ */ s(xi, { children: w.map((g) => {
        ...
        return /* @__PURE__ */ x(
          uo,
          {
            ...
            children: [
              ...
              t && /* @__PURE__ */ s("div", { className: "tw-w-10 tw-text-right tw-text-muted-foreground", children: v })
            ]
          },
          g.value
        );
...
function _c({
  ...
  return /* @__PURE__ */ x("div", { className: "tw-relative", children: [
    /* @__PURE__ */ s(Ka, { className: "tw-absolute tw-left-3 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-transform tw-opacity-50" }),
    /* @__PURE__ */ s(
      kn,
      {
        className: T(
...
}, na = (e) => `${Vc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Am({
  sources: e,
  ...
  const [d, p] = ue([]), [h, w] = ue([{ id: nt, desc: !1 }]), [g, v] = ue({}), f = Te(
  ...
  at(() => {
    if (l) {
      ...
      if (P.length === 1) {
        const k = f.find((B) => na(B) === P[0]) || void 0;
        k && l(k);
      }
    }
  }, [g, f, l, N]);
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    me,
                    {
                      ...
                      children: [
                        ...
                        !C.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ s(Ya, {}) : /* @__PURE__ */ s(Qs, {})),
                        " ",
...
_i.displayName = ri.Root.displayName;
...
function Uc() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = d, ie.ContextConsumer = l, ie.ContextProvider = i, ie.Element = t, ie.ForwardRef = p, ie.Fragment = r, ie.Lazy = v, ie.Memo = g, ie.Portal = n, ie.Profiler = a, ie.StrictMode = o, ie.Suspense = h, ie.isAsyncMode = function(b) {
    return E(b) || O(b) === c;
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === h || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === m || b.$$typeof === N || b.$$typeof === I || b.$$typeof === f);
  }, ie.typeOf = O, ie;
}
var se = {};
/** @license React v16.13.1
...
function Gc() {
  return oa || (oa = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === g || $.$$typeof === i || $.$$typeof === l || $.$$typeof === p || $.$$typeof === m || $.$$typeof === N || $.$$typeof === I || $.$$typeof === f);
    }
    function E($) {
    ...
    var b = c, _ = d, L = l, H = i, C = t, P = p, k = r, B = v, D = g, J = n, q = a, U = o, ee = h, ae = !1;
    function re($) {
...
function Yc() {
  if (da)
    return Dr;
  da = 1;
  var e = Ai(), t = Hc(), n = ho(), r = Di(), o = Xc(), a = function() {
  };
...
const Bi = mo(u.element, Mi);
Bi.isRequired = mo(u.element.isRequired, Mi);
...
function nd() {
  return wa || (wa = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, f = !1, m = !1, N = !1, I = !1, O;
    O = Symbol.for("react.module.reference");
    function E(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || I || j === r || j === d || j === p || N || j === g || v || f || m || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === h || j.$$typeof === a || j.$$typeof === i || j.$$typeof === c || // This needs to include all possible module reference object
...
function _d(e) {
  ...
  function d(w, g) {
    const v = i.indexOf(g);
    return `@media (min-width:${typeof t[w] == "number" ? t[w] : w}${n}) and (max-width:${(v !== -1 && typeof t[i[v]] == "number" ? t[i[v]] : g) - r / 100}${n})`;
  }
  function p(w) {
...
const mp = ve({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (n) => {
      var r, o;
      const a = ((r = e.theme) == null || (r = r.breakpoints) == null || (r = r.values) == null ? void 0 : r[n]) || bo[n];
...
function No(e = {}, ...t) {
  ...
  return d.applyStyles = Tp, d = t.reduce((p, h) => Ze(p, h), d), d.unstable_sxConfig = R({}, yo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return xo({
      sx: h,
      theme: this
    });
...
const Ap = No(), Na = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function jn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Mp(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    yl(i, (b) => b.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Dp(Na(d))
    } = l, g = Ne(l, _p), v = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), f = h || !1;
    let m;
    process.env.NODE_ENV !== "production" && c && (m = `${c}-${Na(d || "Root")}`);
    let N = Un;
...
function Qi(e, t) {
  return e = Nt(e), t = ko(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, gr(e);
}
function zp(e, t) {
  if (e = Nt(e), t = ko(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Gp = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $t = Zp, Qp = ["mode", "contrastThreshold", "tonalOffset"], Ta = {
...
function iu(e) {
  ...
  function h(f) {
    const m = Ea(f, jr.text.primary) >= n ? jr.text.primary : Ta.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const N = Ea(f, m);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ca(f, "light", I, r), Ca(f, "dark", O, r), f.contrastText || (f.contrastText = h(f.main)), f;
  }, g = {
    dark: jr,
    light: Ta
  };
...
function cu(e, t) {
  ...
  const g = o / 14, v = h || ((N) => `${N / d * g}rem`), f = (N, I, O, E, b) => R({
    ...
    button: f(l, 14, 1.75, 0.4, Sa),
    caption: f(i, 12, 1.66, 0.4),
    overline: f(i, 12, 2.66, 1, Sa),
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof i == "string" ? i : Ra(i)} ${l} ${typeof c == "string" ? c : Ra(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
`));
  ...
  return d.unstable_sxConfig = R({}, yo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return xo({
      sx: h,
      theme: this
    });
...
const Ou = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ru = (e) => {
  ...
  const r = Co({
    ...
    titleAccess: h,
    viewBox: w = "0 0 24 24"
  } = r, g = Ne(r, Ou), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", f = R({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function es(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = Pa.muiName, /* @__PURE__ */ M.memo(/* @__PURE__ */ M.forwardRef(n));
}
const _u = {
  configure: (e) => {
...
var ts = fo.default = void 0, Mu = Du(Au()), Bu = Ds;
ts = fo.default = (0, Mu.default)(/* @__PURE__ */ (0, Bu.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function ju(e) {
...
function Gu(e) {
  ...
  const i = Fu(R({}, o, r)), l = $a(r), c = $a(o), d = t(i), p = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, d, n, c, l);
...
var Ce = "top", je = "bottom", Ve = "right", Se = "left", Oo = "auto", Rn = [Ce, je, Ve, Se], zt = "start", vn = "end", Ju = "clippingParents", os = "viewport", en = "popper", Zu = "reference", Ia = /* @__PURE__ */ Rn.reduce(function(e, t) {
  return e.concat([t + "-" + zt, t + "-" + vn]);
}, []), as = /* @__PURE__ */ [].concat(Rn, [Oo]).reduce(function(e, t) {
...
function ww(e) {
  ...
  var o = br(e);
  for (Ro(o) && (o = o.host); Be(o) && ["html", "body"].indexOf(qe(o)) < 0; ) {
    var a = et(o);
...
function Pn(e) {
  for (var t = Ae(e), n = Aa(e); n && uw(n) && et(n).position === "static"; )
    n = Aa(n);
...
function hw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Xe(n.placement), c = _o(l), d = [Se, Ve].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = mw(o.padding, n), w = Po(a), g = c === "y" ? Ce : Se, v = c === "y" ? je : Ve, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], N = Pn(a), I = N ? c === "y" ? N.clientHeight || 0 : N.clientWidth || 0 : 0, O = f / 2 - m / 2, E = h[g], b = I - w[p] - h[v], _ = I / 2 - w[p] / 2 + O, L = dn(E, _, b), H = c;
...
function Da(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, i = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, p = e.roundOffsets, h = e.isFixed, w = i.x, g = w === void 0 ? 0 : w, v = i.y, f = v === void 0 ? 0 : v, m = typeof p == "function" ? p({
    x: g,
    y: f
  }) : {
    x: g,
  ...
  g = m.x, f = m.y;
  var N = i.hasOwnProperty("x"), I = i.hasOwnProperty("y"), O = Se, E = Ce, b = window;
  if (d) {
...
function xw(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, Da(Object.assign({}, d, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, Da(Object.assign({}, d, {
...
function Io(e) {
  return Ut(lt(e)).left + $o(e).scrollLeft;
}
function Sw(e, t) {
...
function Ow(e) {
  var t, n = lt(e), r = $o(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = vt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = vt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Io(e), c = -r.scrollTop;
...
function ps(e) {
  return ["html", "body", "#document"].indexOf(qe(e)) >= 0 ? e.ownerDocument.body : Be(e) && Ao(e) ? e : ps(br(e));
}
function pn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ps(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), a = Ae(r), i = o ? [a].concat(a.visualViewport || [], Ao(r) ? r : []) : r, l = t.concat(i);
  return o ? l : (
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, i = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ju : l, d = n.rootBoundary, p = d === void 0 ? os : d, h = n.elementContext, w = h === void 0 ? en : h, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, m = f === void 0 ? 0 : f, N = cs(typeof m != "number" ? m : ds(m, Rn)), I = w === en ? Zu : en, O = e.rects.popper, E = e.elements[v ? I : w], b = _w(kt(E) ? E : E.contextElement || lt(e.elements.popper), c, p, i), _ = Ut(e.elements.reference), L = us({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? as : c, p = Gt(r), h = p ? l ? Ia : Ia.filter(function(v) {
    return Gt(v) === p;
...
function Aw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, m = t.options.placement, N = Xe(m), I = N === m, O = c || (I || !v ? [Hn(m)] : Iw(m)), E = [m].concat(O).reduce(function(V, W) {
      return V.concat(Xe(W) === Oo ? $w(t, {
        placement: W,
        boundary: p,
        rootBoundary: h,
        padding: d,
...
function Mw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = yn(t, {
    ...
    altBoundary: !0
  }), c = ja(i, r), d = ja(l, o, a), p = Va(c), h = Va(d);
  t.modifiersData[n] = {
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), N = Xe(t.placement), I = Gt(t.placement), O = !I, E = _o(N), b = Uw(E), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, C = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
  ...
  if (_) {
    if (a) {
      var D, J = E === "y" ? Ce : Se, q = E === "y" ? je : Ve, U = E === "y" ? "height" : "width", ee = _[E], ae = ee + m[J], re = ee - m[q], y = g ? -H[U] / 2 : 0, S = I === zt ? L[U] : H[U], z = I === zt ? -H[U] : -L[U], F = t.elements.arrow, V = g && F ? Po(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ls(), X = W[J], Y = W[q], G = dn(0, L[U], V[U]), K = O ? L[U] / 2 - y - G - X - P.mainAxis : S - G - X - P.mainAxis, Z = O ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && Pn(t.elements.arrow), $ = de ? E === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = k == null ? void 0 : k[E]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, ze = dn(g ? Kn(ae, j) : ae, ee, g ? vt(re, ye) : re);
      _[E] = ze, B[E] = ze - ee;
    }
    if (l) {
      var ct, ke = E === "x" ? Ce : Se, $n = E === "x" ? je : Ve, Fe = _[b], Et = b === "y" ? "height" : "width", dt = Fe + m[ke], Tt = Fe - m[$n], Ct = [Ce, Se].indexOf(N) !== -1, St = (ct = k == null ? void 0 : k[b]) != null ? ct : 0, pt = Ct ? dt : Fe - L[Et] - H[Et] - St + P.altAxis, Xt = Ct ? Fe + L[Et] + H[Et] - St - P.altAxis : Tt, In = g && Ct ? fw(pt, Fe, Xt) : dn(g ? pt : dt, Fe, g ? Xt : Tt);
      _[b] = In, B[b] = In - Fe;
    }
    t.modifiersData[r] = B;
  }
...
function qw(e, t, n) {
  ...
  Ao(a)) && (l = Yw(t)), Be(t) ? (c = Ut(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Io(a))), {
...
function ef(e) {
  e === void 0 && (e = {});
  var t = e, n = t.defaultModifiers, r = n === void 0 ? [] : n, o = t.defaultOptions, a = o === void 0 ? La : o;
        ...
        if (!w) {
          ...
          if (za(I, O)) {
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var b = p.orderedModifiers[E], _ = b.fn, L = b.options, H = L === void 0 ? {} : L, C = b.name;
...
process.env.NODE_ENV !== "production" && (fs.propTypes = {
   ...
   */
  anchorEl: mo(u.oneOfType([gn, u.object, u.func]), (e) => {
    if (e.open) {
...
function ms() {
  const e = Zi(Eo);
  return process.env.NODE_ENV !== "production" && M.useDebugValue(e), e[To] || e;
}
function Jr(e, t) {
...
const bf = {
...
}, Vr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Do = /* @__PURE__ */ M.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = t, N = Ne(t, gf), I = rn(), O = M.useRef(), E = ms(), b = M.useRef(null), _ = xt(b, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = b.current;
...
Do.muiSupportAuto = !0;
const Ga = Do, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = On(fs, {
  name: "MuiPopper",
  slot: "Root",
...
const vs = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, i, l, c, d, p, h, w, g, v, f, m, N, I, O, E, b;
  const _ = Co({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: H
  }), ze = ms(), ct = ze.direction === "rtl", [ke, $n] = M.useState(), [Fe, Et] = M.useState(null), dt = M.useRef(!1), Tt = J || re, Ct = rn(), St = rn(), pt = rn(), Xt = rn(), [In, Mo] = Fi({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Bo = (Q) => {
    ...
    (Q) => {
      Ha.start(800 + S, () => {
        Ln = !1;
      }), Mo(!1), F && Ke && F(Q), Ct.start(ze.transitions.duration.shortest, () => {
        dt.current = !1;
      });
    }
  ), xr = (Q) => {
    ...
    onFocus: Es,
    ref: Ts
  } = Ui(), [, Lo] = M.useState(!1), zo = (Q) => {
    ks(Q), Vo.current === !1 && (Lo(!1), jo(Q));
  }, Fo = (Q) => {
    ke || $n(Q.currentTarget), Es(Q), Vo.current === !0 && (Lo(!0), xr(Q));
  }, Uo = (Q) => {
    dt.current = !0;
    const Pe = ye.props;
    Pe.onTouchStart && Pe.onTouchStart(Q);
  }, Go = xr, Ho = jo, Cs = (Q) => {
    Uo(Q), pt.clear(), Ct.clear(), An(), Yt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Xt.start(ae, () => {
...
`));
  ...
  const qt = {};
  q || (De.onTouchStart = Cs, De.onTouchEnd = Ss), D || (De.onMouseOver = zn(Go, De.onMouseOver), De.onMouseLeave = zn(Ho, De.onMouseLeave), Tt || (qt.onMouseOver = Go, qt.onMouseLeave = Ho)), B || (De.onFocus = zn(Fo, De.onFocus), De.onBlur = zn(zo, De.onBlur), Tt || (qt.onFocus = Fo, qt.onBlur = zo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Ps = M.useMemo(() => {
    var Q;
    let Pe = [{
    ...
    touch: dt.current
  }), Er = Tf(Kt), Xo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : Cf, Yo = (a = (i = (l = Z.transition) != null ? l : C.Transition) != null ? i : $) != null ? a : Ga, Wo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : Sf, qo = (p = (h = Z.arrow) != null ? h : C.Arrow) != null ? p : Of, _s = on(Xo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (g = (v = K.popper) != null ? v : P.popper) == null ? void 0 : g.className)
  }), Kt), $s = on(Yo, R({}, xe, (f = K.transition) != null ? f : P.transition), Kt), Is = on(Wo, R({}, (m = K.tooltip) != null ? m : P.tooltip, {
    className: bt(Er.tooltip, (N = (I = K.tooltip) != null ? I : P.tooltip) == null ? void 0 : N.className)
  }), Kt), As = on(qo, R({}, (O = K.arrow) != null ? O : P.arrow, {
    className: bt(Er.arrow, (E = (b = K.arrow) != null ? b : P.arrow) == null ? void 0 : E.className)
  }), Kt);
  return /* @__PURE__ */ x(M.Fragment, {
    children: [/* @__PURE__ */ M.cloneElement(ye, De), /* @__PURE__ */ s(Xo, R({
      as: Y ?? bs,
      placement: X,
      anchorEl: re ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(Wo, R({}, Is, {
          children: [de, L ? /* @__PURE__ */ s(qo, R({}, As, {
            ref: Et
          })) : null]
        }))
      }))
...
const Rf = vs;
function Xa(e, t, n) {
  return e ? /* @__PURE__ */ s(oi, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ s("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function ys(e) {
  const {
    onClick: t,
    ...
    xl,
    {
      ...
      children: n ? /* @__PURE__ */ x(it, { children: [
        ...
        h ? /* @__PURE__ */ s(oi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(ts, {}) }) : Xa(i, n, !1)
      ] }) : m
    }
  );
...
function Jm({ id: e, groups: t }) {
  return /* @__PURE__ */ s("div", { id: e, children: /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ s(wi, { asChild: !0, children: /* @__PURE__ */ s(em, {}) }),
    /* @__PURE__ */ s(tr, { children: t.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ s(En, { children: n.label }),
      /* @__PURE__ */ s(Hl, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(io, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(mi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(nr, {})
    ] }, n.label)) })
  ] }) });
}
