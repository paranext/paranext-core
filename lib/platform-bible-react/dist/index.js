...
import { c as m, g as me, a as _r, C as Se, u as Io, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Zi, l as Qi, m as ts, I as es, n as io, r as ye, Z as rs, o as Tn, p as la, q as da, L as Et, R as so, s as ea, D as ja, t as Ba, v as Fa, w as Ua, y as Sn, z as Gr, E as co, F as Rn, G as lo, H as Je, J as Er, K as je, M as Be, N as Fe, S as Tr, O as nr, Q as as, U as zr, V as Ze, W as Oe, X as tr, Y as De, _ as ir, $ as wo, a0 as uo, a1 as ra, a2 as po, a3 as zn, a4 as os, a5 as ns, a6 as is, a7 as Ka, a8 as Dn, a9 as wa, aa as ss, ab as Mn, ac as cs, ad as ls, ae as ds, af as $o, ag as ws, ah as us, ai as ps, aj as hs, ak as On, al as In, am as ho, an as gs, ao as $n, ap as Na, aq as Po, ar as Ca, as as fs, at as ms, au as vs, av as bs, aw as xs, ax as Dr, ay as go, az as ys, aA as ks } from "./resizable-CYewDr6Y.js";
import { aB as Ig, aC as $g, aD as Pg, aE as Ag, aF as Vg, aG as Lg, aH as jg, aI as Bg, aJ as Fg, aK as Ug, aL as Kg, aM as Hg, aN as Gg, aO as qg, aP as Wg, aQ as Yg, aR as Xg, aS as Jg, aT as Zg, aU as Qg, aV as tf, aW as ef, aX as rf, aY as af, aZ as of, a_ as nf, a$ as sf } from "./resizable-CYewDr6Y.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as Ha, ChevronRight as Ga, ArrowLeft as _s, ArrowRight as Ns, ChevronDown as lr, BoldIcon as Cs, ItalicIcon as Es, X as fo, AtSign as Pn, Pencil as Ts, Trash2 as Ss, ArrowUp as An, MoreHorizontal as Rs, MailOpen as zs, Mail as Ds, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as Vn, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as Ln, FunctionSquare as jn, SquareSigma as Bn, Ban as Ks, AlertCircle as qa, CircleCheckIcon as Hs, CircleXIcon as Gs, CircleHelpIcon as qs, ArrowUpIcon as Ws, ArrowDownIcon as Ys, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as Ct, getChaptersForBook as rc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as ac, sanitizeHtml as mo, NumberFormat as Fn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Wr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as jo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as uc } from "platform-bible-utils";
import Yt, { useRef as K, useMemo as V, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as pc, useLayoutEffect as te, Component as hc, createElement as Uo, Suspense as gc, forwardRef as Un, useId as Ko, Fragment as pa } from "react";
...
import { createEditor as Gn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as bo, ParagraphNode as qn, TextNode as Wn, $getPreviousSelection as Ec, $isRangeSelection as be, $caretFromPoint as Tc, $getSiblingCaret as Yn, $getChildCaret as Sc, $getAdjacentChildCaret as Rc, $isChildCaret as zc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as Ho, $splitAtPointCaretNext as Ic, $isTextPointCaret as $c, $findMatchingParent as Xn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Pc, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Jn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Vc, defineExtension as ne, safeCast as er, createState as Lc, FORMAT_TEXT_COMMAND as Zn, $isNodeSelection as Qn, COMMAND_PRIORITY_LOW as ti, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as Hc, isDOMNode as Gc, $getNodeFromDOMNode as qc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Ya, $getState as Jc, toggleTextFormatType as Go, TEXT_TYPE_TO_FORMAT as Zc, $setState as Qc, addClassNamesToElement as ei, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as qo, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as ri, $insertNodes as wl } from "lexical";
...
function Ra({
  ...
  const F = ye(), A = Ml(), D = S ?? A, [U, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [G, nt] = _(void 0), [at, pt] = _(
    void 0
...
function Gl({ initialConfig: t, children: e }) {
  const r = V(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Kl(null, o), w = Gn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
function md(t) {
  ...
  hi(this), it = t, this.f &= -2, 8 & this.f && To(this), ga();
}
function or(t, e) {
...
function mi(t, e = fi) {
  return t.registerCommand(Jn, (r) => (t.update(e), !0), xo);
}
...
const So = 0, oo = 1, yi = 2, Oa = 3, Kr = 4, ar = 5, Ia = 6, yr = 7;
function $a(t) {
  return t.id === So;
}
function ki(t) {
...
}, name: "@lexical/extension/InitialState", nodes: [jc, Wn, Bc, Fc, qn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function Cd(t) {
  throw t;
...
function fn({
  ...
  const g = j(
    ...
    [t.user]
  ), b = V(() => mo(t.contents), [t.contents]), C = V(
...
function Ai({
  ...
  const [H, Q] = _(mn), [I, tt] = _(), [N, z] = _(), G = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(T), [At, bt] = _(!1), Bt = K(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let x = !0;
    return (async () => {
...
function Xp({
  ...
  const [v, E] = _("generated"), [b, C] = _("generated"), [T, $] = _("*"), [S, F] = _("*"), [A, D] = _("f"), [U, Y] = _(!1), [H, Q] = _(!0), [I, tt] = _(!1), N = K(!1), z = K(""), [G, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = K(null), vt = K(
    void 0
  ...
  W(() => {
    ...
    if (x && xr("note", x)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), F(et)), E(st), C(st), D(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), R = setTimeout(() => {
        var ht, xt, _t;
...
function ih({
  ...
  }, [F, tt]), z = V(() => N.length === 0 ? [] : tu(N, D, Y), [N, D, Y]), G = V(() => {
    var gt, ft;
    if (!F) return l;
...
function yh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(wo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: E.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((U) => U.column.columnDef.header).map((U) => (
      ...
      /* @__PURE__ */ a(po, { children: E.getRowModel().rows.map((D, U) => {
        const Y = ye();
        return /* @__PURE__ */ a(
          De,
          {
