...
import b, { forwardRef as cn, useRef as Z, useMemo as B, useState as I, useCallback as F, useLayoutEffect as Ht, createContext as Rn, useContext as xr, useEffect as Y, Component as xs, createElement as Gr, Suspense as ys, createRef as Ns, Fragment as xo } from "react";
...
function Cp({
  ...
  const c = dt(), [p, m] = I(!1), [f, u] = I(""), [g, x] = I(""), [v, y] = I("books"), [k, T] = I(void 0), [S, $] = I(!1), P = Z(void 0), _ = Z(void 0), C = Z(void 0), E = Z(void 0), N = Z({}), A = F(
    (M) => {
      t(M), l && l(M);
    },
    [t, l]
  ), V = B(() => r ? r() : sa, [r]), z = B(() => ({
    [X.OT]: V.filter((K) => Q.isBookOT(K)),
    [X.NT]: V.filter((K) => Q.isBookNT(K)),
    [X.DC]: V.filter((K) => Q.isBookDC(K)),
    [X.Extra]: V.filter((K) => Q.extraBooks().includes(K))
  }), [V]), R = B(() => Object.values(z).flat(), [z]), G = B(() => {
    if (!g.trim()) return z;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (M) => {
      const K = v === "chapters" ? k : O == null ? void 0 : O.book;
      K && (A({
        book: K,
        chapterNum: M,
        verseNum: 1
      }), m(!1), y("books"), T(void 0), x(""));
    },
    [A, v, k, O]
  ), mt = F(
    (M) => {
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: K, isDigit: ot } = to(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (K || ot) {
          if (M.preventDefault(), M.stopPropagation(), y("books"), T(void 0), ot && k) {
            const ut = ye[k];
            x(`${ut} ${M.key}`);
          } else
            x(M.key);
      ...
      if ((v === "chapters" || v === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const ut = v === "chapters" ? k : O == null ? void 0 : O.book;
        if (!ut) return;
        const lt = (() => {
          if (!f) return 1;
          const ne = f.match(/(\d+)$/);
        ...
        Ct !== lt && (M.preventDefault(), M.stopPropagation(), u(wr(ut, a, Ct)), setTimeout(() => {
          const ne = N.current[Ct];
    ...
    const { isLetter: K, isDigit: ot } = to(M.key);
    (K || ot) && (M.preventDefault(), x((ut) => ut + M.key), _.current.focus(), $(!1));
  }, []);
  return Ht(() => {
    const M = setTimeout(() => {
      if (p && v === "books" && C.current && E.current) {
        const K = C.current, ot = E.current, ut = ot.offsetTop, lt = K.clientHeight, zt = ot.clientHeight, Ct = ut - lt / 2 + zt / 2;
        K.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(wr(e.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if (C.current)
          if (M) {
            const K = N.current[e.chapterNum];
  ...
  }, [v, k, O, e.book, e.chapterNum]), /* @__PURE__ */ d(ce, { open: p, onOpenChange: it, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
      ...
      qt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: pt.map(({ onClick: M, disabled: K, title: ot, icon: ut }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            k && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: De(k, a) })
          ] }),
          !S && /* @__PURE__ */ d(Jt, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(st, { children: [
              !O && Object.entries(G).map(([M, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Ut, { heading: pe(M), children: K.map((ot) => /* @__PURE__ */ o(
                      ia,
                      {
                        bookId: ot,
                        onSelect: (ut) => ct(ut),
              ...
              O && /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o(
                Lt,
                {
              ...
              O && Vt(O.book) > 1 && /* @__PURE__ */ d(st, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: De(O.book, a) }),
                /* @__PURE__ */ o(
                  eo,
                  {
                    bookId: O.book,
...
function dr({
  ...
  const [k, T] = I(!1), S = w ?? l, $ = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], P = (_, C) => {
    const E = l(_), N = typeof _ == "object" && "secondaryLabel" in _ ? _.secondaryLabel : void 0, A = `${C ?? ""}${E}${N ?? ""}`;
    return /* @__PURE__ */ d(
      Lt,
      {
        value: E,
        ...
        children: [
          ...
          /* @__PURE__ */ d("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            E,
            N && /* @__PURE__ */ d("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              N
            ] })
          ] })
  ...
  return /* @__PURE__ */ d(ce, { open: k, onOpenChange: T, ...y, children: [
    ...
    /* @__PURE__ */ o(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          ...
          /* @__PURE__ */ o(Jt, { children: $(t) ? t.map((_) => /* @__PURE__ */ o(Ut, { heading: _.groupHeading, children: _.options.map((C) => P(C, _.groupHeading)) }, _.groupHeading)) : t.map((_) => P(_)) })
        ] })
      }
    )
  ] });
...
function Sp({
  ...
  const p = Hn(c, "%webView_bookSelector_currentBook%"), m = Hn(c, "%webView_bookSelector_choose%"), f = Hn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), e(v);
...
function Ul() {
  return function(e) {
    const [t] = Bt(), n = B(() => e(t), [t, e]), [r, a] = I(() => n.initialValueFn()), s = Z(r);
    return Hl(() => {
...
function Yl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ui(t) && r !== null) {
    ...
    if (c || p) {
      ...
      const k = t.__text.slice(y, v);
      k !== t.__text && (n === "clone" && (t = hi(t)), t.__text = k);
    }
  }
  return t;
}
          ...
          if (w) {
            ...
            e.update(() => {
              ...
              if (on(g)) {
                ...
                if (kn(v) && c >= 0 && p >= 0 && (y = c, k = c + p, g.setTextNodeRange(v, y, v, k)), y === k && m === "" || (g.insertRawText(m), v = x.getNode()), kn(v)) {
                  y = f, k = f + u;
                  const T = v.getTextContentSize();
                  y = y > T ? T : y, k = k > T ? T : k, g.setTextNodeRange(v, y, v, k);
                }
...
function Ac({
  ...
  const [t] = Bt(), [n, r] = I(t), [a, s] = I("paragraph"), [i, l] = Ic(), w = () => {
  };
...
function $c() {
  const { activeEditor: e } = Ta(), [t, n] = I([]), r = F((a) => {
    if (on(a) || Zi(a)) {
      const s = [];
      uo.forEach(({ format: i }) => {
...
function Rp({
  ...
  const [a, s] = I(Hc), [i, l] = I(void 0), [w, c] = I(!1), p = Z(void 0), m = Z(null);
  Y(() => {
    let y = !0;
    const k = m.current;
    if (!k) return;
...
const Dp = Object.freeze([
  ...
  const a = Z(null), [s, i] = I(void 0), [l, w] = I(void 0), c = F(
    (u) => {
      i(u);
    ...
    (u) => {
      var _;
      const g = u.target, x = (C) => C ? document.getElementById(C) : void 0, v = x(l), y = x(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const E = C.findIndex((A) => A === g);
          if (E === -1) return;
          let N;
          u.key === "ArrowDown" ? N = Math.min(E + 1, C.length - 1) : N = Math.max(E - 1, 0), N !== E && (u.preventDefault(), u.stopPropagation(), (_ = C[N]) == null || _.focus());
          return;
        }
        return;
      }
      const S = e.findIndex((C) => C.id === s);
      let $ = S;
      switch (u.key) {
        case "ArrowDown":
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : S.key === "Enter" && S.shiftKey && (S.preventDefault(), S.stopPropagation(), Et(p) && g());
              },
              onKeyDown: (S) => {
                Vr(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  Cn,
...
function aw({
  ...
  const [$, P] = I(ho), _ = r, [C, E] = I(!1), [N, A] = I(!1), [V, z] = I(!1), [R, G] = I(void 0), [O, J] = I(!1), [ct, Qt] = I(!1), [mt, pt] = I(T), [j, it] = I(!1), ht = Z(void 0), [yt, Nt] = I(/* @__PURE__ */ new Map());
  Y(() => {
    let D = !0;
    return (async () => {
  ...
  const jt = B(() => t.filter((D) => !D.deleted), [t]);
  Y(() => {
    let D = !0;
    if (!r || !k) {
      Nt(/* @__PURE__ */ new Map());
  ...
  const pe = B(() => jt[0], [jt]), jn = Z(null), Te = Z(void 0), te = F(() => {
    var D;
    (D = Te.current) == null || D.call(Te), P(ho);
  }, []), zn = F(() => {
    const D = !mt;
    pt(D), it(!D), u == null || u(w, D);
  }, [mt, u, w]);
  Y(() => {
    E(!1);
  }, [r]), Y(() => {
    if (r && !mt && !j) {
      ...
      return ht.current = D, () => clearTimeout(D);
    }
  ...
  const ee = B(
  ...
  }, [s, n]), M = B(() => jt.slice(1), [jt]), K = B(() => M.length ?? 0, [M.length]), ot = B(() => K > 0, [K]), ut = B(() => C || K <= 2 ? M : M.slice(-2), [M, K, C]), lt = B(() => C || K <= 2 ? 0 : K - 2, [K, C]), zt = B(
    () => K === 1 ? ee.singleReply : be(ee.multipleReplies, { count: K }),
    [K, ee]
  ), Ct = B(
    () => lt === 1 ? ee.singleReply : be(ee.multipleReplies, { count: lt }),
    [lt, ee]
  ), Ue = F(async () => {
    const D = Et($) ? En($) : void 0;
    if (R !== void 0) {
      await p({
        threadId: w,
        contents: D,
    ...
    D && await p({ threadId: w, contents: D }) && te();
  }, [te, $, p, R, w]), ne = F(
    async (D) => {
      const ue = Et($) ? En($) : void 0, It = await p({
        ...D,
        contents: ue,
        assignedUser: R ?? D.assignedUser
      });
      return It && ue && te(), It && R !== void 0 && G(void 0), It;
    },
    [te, $, p, R]
  );
  return /* @__PURE__ */ o(
          ...
          r && /* @__PURE__ */ d(st, { children: [
            lt > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                onClick: (D) => {
                  D.stopPropagation(), E(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (D) => {
                  (D.key === "Enter" || D.key === " ") && (D.preventDefault(), D.stopPropagation(), E(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(Pe, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: Ct }),
                    C ? /* @__PURE__ */ o(Co, {}) : /* @__PURE__ */ o(Be, {})
                  ] })
                ]
              }
            ),
            ut.map((D) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              mo,
              {
                comment: D,
                localizedStrings: n,
            ...
            x !== !1 && (!N || Et($)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (D) => {
                  D.key === "Enter" && D.shiftKey && (D.preventDefault(), D.stopPropagation(), (Et($) || R !== void 0) && Ue());
                },
                onKeyDown: (D) => {
                  Vr(D), (D.key === "Enter" || D.key === " ") && D.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    Cn,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    R !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: be(
                    ...
                    /* @__PURE__ */ d(ce, { open: V, onOpenChange: z, children: [
                      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ o(
                        Wt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (D) => {
                            D.key === "Escape" && (D.stopPropagation(), z(!1));
                          },
                          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: g == null ? void 0 : g.map((D) => /* @__PURE__ */ o(
                            Lt,
                            {
                              onSelect: () => {
                                G(D !== s ? D : void 0), z(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: yn(D, n) })
                            },
                            D || "unassigned"
                          )) }) })
                        }
...
function Op({
  ...
  const [v, y] = I(/* @__PURE__ */ new Set());
  Y(() => {
    g && y((N) => new Set(N).add(g));
  }, [g]);
  const k = n.filter(
    (N) => N.comments.some((A) => !A.deleted)
  ), T = k.map((N) => ({
    id: N.id
  })), S = F(
    (N) => {
      y((A) => new Set(A).add(N.id)), x == null || x(N.id);
    },
    [x]
  ), $ = F(
    (N) => {
      ...
      y((V) => {
        const z = new Set(V);
        return z.has(N) ? z.delete(N) : z.add(N), z;
      }), x == null || x(A ? void 0 : N);
    },
    [v, x]
  ), { listboxRef: P, activeId: _, handleKeyDown: C } = Yc({
    options: T,
    onOptionSelect: S
  }), E = F(
    (N) => {
      N.key === "Escape" ? (y(/* @__PURE__ */ new Set()), x == null || x(void 0), N.preventDefault(), N.stopPropagation()) : C(N);
    },
    [C, x]
  );
  return /* @__PURE__ */ o(
...
function bw({
  ...
  var P;
  const [p, m] = I([]), [f, u] = I([]), [g, x] = I({}), [v, y] = I({}), k = B(() => t ?? [], [t]), T = Ko({
    data: k,
    columns: e,
    getCoreRowModel: Xo(),
  ...
  }), S = T.getVisibleFlatColumns();
  let $;
  return w ? $ = Array.from({ length: 10 }).map((E, N) => `skeleton-row-${N}`).map((E) => /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(Ne, { colSpan: S.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(hr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((P = T.getRowModel().rows) == null ? void 0 : P.length) > 0 ? $ = T.getRowModel().rows.map((_) => /* @__PURE__ */ o(
    Ft,
    {
      onClick: () => i(_, T),
      "data-state": _.getIsSelected() && "selected",
      children: _.getVisibleCells().map((C) => /* @__PURE__ */ o(Ne, { children: Qe(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    _.id
    ...
    a && /* @__PURE__ */ o(sw, { table: T }),
    /* @__PURE__ */ d(Pn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Vn, { stickyHeader: s, children: T.getHeaderGroups().map((_) => /* @__PURE__ */ o(Ft, { children: _.headers.map((C) => /* @__PURE__ */ o(ln, { children: C.isPlaceholder ? void 0 : Qe(C.column.columnDef.header, C.getContext()) }, C.id)) }, _.id)) }),
...
function Nw({ id: e, versionHistory: t }) {
  const [n, r] = I(!1), a = /* @__PURE__ */ new Date();
  function s(l) {
...
function kw({
  ...
  const [y, k] = I(!1), T = F(
    (N) => {
      var V;
      const A = (V = e.find((z) => z.label === N)) == null ? void 0 : V.value;
      A && n(
        t.includes(A) ? t.filter((z) => z !== A) : [...t, A]
      );
    },
    [e, t, n]
  ), S = () => w || r, $ = B(() => {
    if (!f) return e;
    const N = e.filter((V) => V.starred).sort((V, z) => V.label.localeCompare(z.label)), A = e.filter((V) => !V.starred).sort((V, z) => {
      const R = t.includes(V.value), G = t.includes(z.value);
      return R && !G ? -1 : !R && G ? 1 : V.label.localeCompare(z.label);
    });
    return [...N, ...A];
  }, [e, t, f]), P = () => {
    n(e.map((N) => N.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(ce, { open: C, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: x,
    ...
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(qt, { children: [
      ...
      /* @__PURE__ */ d(Jt, { children: [
        ...
        /* @__PURE__ */ o(Ut, { children: $.map((N) => /* @__PURE__ */ d(
          Lt,
          {
            value: N.label,
            onSelect: T,
            ...
            children: [
              /* @__PURE__ */ o("div", { className: "w-4", children: /* @__PURE__ */ o(
                Dt,
                {
                  className: h(
                    "tw-h-4 tw-w-4",
                    t.includes(N.value) ? "tw-opacity-100" : "tw-opacity-0"
                  )
                }
              ) }),
              N.starred && /* @__PURE__ */ o(Fs, { className: "tw-h-4 tw-w-4" }),
              /* @__PURE__ */ o("div", { className: "tw-flex-grow", children: N.label }),
              N.secondaryLabel && /* @__PURE__ */ o("div", { className: "tw-text-end tw-text-muted-foreground", children: N.secondaryLabel })
            ]
          },
          N.label
        )) })
...
function Cw({
  ...
  const s = Z(null), i = Z(null), l = Z(!1), [w, c] = I(e), [p, m] = I(n), [f, u] = I(!1);
  Y(() => {
    c(e);
  }, [e]), Y(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var y, k, T, S;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((k = i.current) == null || k.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((T = s.current) == null ? void 0 : T.selectionStart) === 0 && ((S = i.current) == null || S.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
...
function jp({
  ...
  const w = Z(null), c = Ns(), [p, m] = I("generated"), [f, u] = I("*"), [g, x] = I("f"), [v, y] = I(!1), k = B(
    () => ({
      ...i,
  ...
  Y(() => {
    ...
    if (C && fn("note", C)) {
      const A = (E = C.insert.note) == null ? void 0 : E.caller;
      let V = "custom";
      A === ar ? V = "generated" : A === sr ? V = "hidden" : A && u(A), m(V), x(((N = C.insert.note) == null ? void 0 : N.style) ?? "f"), _ = setTimeout(() => {
        var z;
        (z = w.current) == null || z.applyUpdate([{ delete: 1 }, C]);
      }, 0);
    }
    return () => {
      _ && clearTimeout(_);
  ...
  const T = F(() => {
    var C, E;
    const _ = (E = (C = w.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : E.at(0);
    _ && fn("note", _) && (_.insert.note && (p === "custom" ? _.insert.note.caller = f : _.insert.note.caller = p === "generated" ? ar : sr), n([_]));
  }, [p, f, n]), S = () => {
    var C;
    const _ = (C = c.current) == null ? void 0 : C.getElementsByClassName("editor-input")[0];
    _ != null && _.textContent && navigator.clipboard.writeText(_.textContent);
  }, $ = (_) => {
    var E, N, A, V, z;
    x(_);
    const C = (N = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : N.at(0);
    if (C && fn("note", C)) {
      C.insert.note && (C.insert.note.style = _);
      const R = (V = (A = C.insert.note) == null ? void 0 : A.contents) == null ? void 0 : V.ops;
      g !== "x" && _ === "x" ? R == null || R.forEach((G) => Rw(G)) : g === "x" && _ !== "x" && (R == null || R.forEach((G) => Dw(G))), (z = w.current) == null || z.applyUpdate([{ delete: 1 }, C]);
    }
  }, P = () => {
    var C, E, N, A, V;
    const _ = (E = (C = w.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : E.at(0);
    if (_ && fn("note", _)) {
      const z = (N = _.insert.note) == null ? void 0 : N.style, R = (V = (A = _.insert.note) == null ? void 0 : A.contents) == null ? void 0 : V.ops;
      z || y(!1), y(
        z === "x" ? !!(R != null && R.every((G) => {
          var J, ct;
          if (!((J = G.attributes) != null && J.char)) return !0;
          const O = ((ct = G.attributes) == null ? void 0 : ct.char).style;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
            /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Eo, {}) }) }),
...
function Fp({
  ...
  const p = w ?? pi(n, void 0), m = (k, T) => {
    c == null || c(k, T, a);
  }, f = s ? n.findIndex((k) => k === s) : -1, [u, g] = I(f), x = (k, T, S) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), c == null || c(T, S, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
  ...
  return Y(() => {
    var k;
    u >= 0 && u < y.current.length && ((k = y.current[u]) == null || k.focus());
  }, [u]), /* @__PURE__ */ o(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((k, T) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              T < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Pe, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function Jp({
  ...
  const f = At(n, "%webView_inventory_all%"), u = At(n, "%webView_inventory_approved%"), g = At(n, "%webView_inventory_unapproved%"), x = At(n, "%webView_inventory_unknown%"), v = At(n, "%webView_inventory_scope_currentBook%"), y = At(n, "%webView_inventory_scope_chapter%"), k = At(n, "%webView_inventory_scope_verse%"), T = At(n, "%webView_inventory_filter_text%"), S = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = At(n, "%webView_inventory_no_results%"), [P, _] = I(!1), [C, E] = I("all"), [N, A] = I(""), [V, z] = I([]), R = B(() => {
    const j = e ?? [];
  ...
  }, [P, R]), O = B(() => G.length === 0 ? [] : Lw(G, C, N), [G, C, N]), J = B(() => {
    var ht, yt;
    if (!P) return w;
  ...
  Y(() => {
    O.length === 0 ? z([]) : O.length === 1 && z(O[0].items);
  }, [O]);
  const ct = (j, it) => {
    it.setRowSelection(() => {
      const ht = {};
    ...
    if (G.length === 0 || V.length === 0) return [];
    const j = G.filter((it) => Mo(
      P ? it.items : [it.items[0]],
      V
    ));
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? S })
      ] })
    ] }),
...
const Xa = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(e), m = t ?? c, f = b.useCallback(
      (T) => {
        const S = typeof T == "function" ? T(m) : T;
        n ? n(S) : p(S);
      },
      [n, m]
    ), u = b.useCallback(() => f((T) => !T), [f]), g = m ? "expanded" : "collapsed", y = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o(Ha.Provider, { value: k, children: /* @__PURE__ */ o(Tt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
function tu({
  ...
  const [c, p] = I([]), [m, f] = I([{ id: re, desc: !1 }]), [u, g] = I({}), x = B(
    () => e.flatMap((E) => E.data.map((N) => ({
      ...N,
      source: E.source
    }))),
    [e]
  ...
  Y(() => {
    if (l) {
      const E = y.getSelectedRowModel().rowsById, N = Object.keys(E);
      if (N.length === 1) {
        const A = x.find((V) => bo(V) === N[0]) || void 0;
        A && l(A);
      }
    }
  }, [u, x, l, y]);
  const k = a ?? sd, T = s ?? Qa, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [re] },
    { label: `Group by ${T}`, value: [ge] },
    {
    ...
    !E.getIsGrouped() && !E.getIsSelected() && E.getToggleSelectedHandler()(N);
  }, _ = (E, N) => E.getIsGrouped() ? "" : h("banded-row", N % 2 === 0 ? "even" : "odd"), C = (E, N, A) => {
    if (!((E == null ? void 0 : E.length) === 0 || N.depth < A.column.getGroupedIndex())) {
      if (N.getIsGrouped())
        switch (N.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Ce, { position: "item-aligned", children: /* @__PURE__ */ o(iw, { children: S.map((E) => /* @__PURE__ */ o(_t, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Pn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Vn, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ o(Ft, { children: E.headers.filter((N) => N.column.columnDef.header).map((N) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(ln, { colSpan: N.colSpan, className: "top-0 tw-sticky", children: N.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          N.column.getCanGroup() ? /* @__PURE__ */ o(
            L,
            {
              variant: "ghost",
          ...
          " ",
          Qe(N.column.columnDef.header, N.getContext())
        ] }) }, N.id)
      )) }, E.id)) }),
      /* @__PURE__ */ o($n, { children: y.getRowModel().rows.map((E, N) => {
        const A = dt();
        return /* @__PURE__ */ o(
          Ft,
          {
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ o(Me, {}) : /* @__PURE__ */ o(nr, {})),
                          " ",
                          Qe(V.column.columnDef.cell, V.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
function dd({
  ...
  const P = B(() => Q.allBookIds.filter(
    ...
    (R, G = !1) => {
      if (!G || !S.current) {
        n(
          t.includes(R) ? t.filter((pt) => pt !== R) : [...t, R]
        ), S.current = R;
        return;
      }
      const O = P.findIndex((pt) => pt === S.current), J = P.findIndex((pt) => pt === R);
      if (O === -1 || J === -1) return;
      const [ct, Qt] = [
        Math.min(O, J),
        Math.max(O, J)
      ], mt = P.slice(ct, Qt + 1).map((pt) => pt);
      n(
        t.includes(R) ? t.filter((pt) => !mt.includes(pt)) : [.../* @__PURE__ */ new Set([...t, ...mt])]
      );
    },
    [t, n, P]
  ), E = (R) => {
    C(R, $.current), $.current = !1;
  }, N = (R, G) => {
    R.preventDefault(), C(G, R.shiftKey);
  }, A = F(
    (R) => {
      const G = zr(P, R).map((O) => O);
      n(
        ts(P, R, t) ? t.filter((O) => !G.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...G])]
      );
    },
    [t, n, P]
  ), V = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(X).map((R) => /* @__PURE__ */ o(
      wd,
      {
        section: R,
        availableBookIds: P,
        ...
        children: [
          ...
          /* @__PURE__ */ o(Wt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            qt,
            {
              shouldFilter: !1,
              onKeyDown: (R) => {
                R.key === "Enter" && ($.current = R.shiftKey);
              },
              children: [
                /* @__PURE__ */ o(
                  Fe,
                    ...
                    if (O.length !== 0)
                      return /* @__PURE__ */ d(xo, { children: [
                        /* @__PURE__ */ o(
                          Ut,
                          {
                            heading: aa(R, f, u, g, x),
                            children: O.map((J) => /* @__PURE__ */ o(
                              ia,
                              {
                                bookId: J,
                                isSelected: t.includes(J),
                                onSelect: () => E(J),
                                onMouseDown: (ct) => N(ct, J),
                                section: Ze(J),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: wr(J, a),
                        ...
                        G < Object.values(X).length - 1 && /* @__PURE__ */ o(Wo, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Qn ? Qn : vo
      ).map((R) => /* @__PURE__ */ o(Ae, { className: "hover:tw-bg-secondary", variant: "secondary", children: De(R, a) }, R)),
...
function nu({
  ...
  ], y = t ? v.filter((k) => t.includes(k.value)) : v;
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Rr,
        {
          ...
          children: y.map(({ value: k, label: T, id: S }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(_n, { className: "tw-me-2", value: k, id: S }),
            /* @__PURE__ */ o(wt, { htmlFor: S, children: T })
          ] }, S))
        }
      )
    ] }),
...
function pu({
  ...
  const c = vd(
    ...
    var y, k, T, S, $, P;
    const v = x !== g ? ((k = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : k[x]) ?? ((S = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : S.en) : void 0;
