...
import { useReactTable as Io, getFilteredRowModel as Vi, getSortedRowModel as Ao, getPaginationRowModel as ji, getCoreRowModel as Po, flexRender as Ke, getGroupedRowModel as zi, getExpandedRowModel as Bi } from "@tanstack/react-table";
...
Bo.displayName = "CommandShortcut";
const Fo = (t, e, n, o, a) => {
  switch (t) {
    case U.OT:
...
const Uo = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ae : "button", { className: m(Ko({ variant: e, size: n, className: t })), ref: i, ...a })
);
j.displayName = "Button";
const ae = Ee.Root, se = Ee.Trigger, Xc = Ee.Anchor, Jt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = gt();
...
function tr(t, e, n) {
  return `${t} ${he[t]}${e ? ` ${mr(t, e)} ${_e(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Qi({
  recentSearches: t,
  ...
  return /* @__PURE__ */ c(ae, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Jt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(Wt, { children: /* @__PURE__ */ r(Ht, { heading: i, children: t.map((u) => /* @__PURE__ */ c(
      zt,
      {
        onSelect: () => p(u),
...
function Wc(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function nl(t, e, n, o) {
  const a = G(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const w = e[d - 1], p = Math.max(Vt(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function Jc({
  ...
  const w = gt(), [p, u] = D(!1), [h, f] = D(""), [g, x] = D(""), [v, y] = D("books"), [N, _] = D(void 0), [k, B] = D(!1), V = J(void 0), T = J(void 0), A = J(void 0), C = J(void 0), E = J({}), $ = G(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
    ...
    [v, Y]
  ), { otLong: X, ntLong: tt, dcLong: nt, extraLong: ct } = {
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: W, isDigit: at } = Fr(R.key);
      if (v === "chapters") {
        if (R.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(R.key)) {
        ...
        switch (R.key) {
          case "ArrowLeft":
            ft !== 0 && (yt = ft > 1 ? ft - 1 : Ft);
            break;
          case "ArrowRight":
            ft !== 0 && (yt = ft < Ft ? ft + 1 : 1);
            break;
          case "ArrowUp":
            yt = ft === 0 ? Ft : Math.max(1, ft - an);
            break;
          case "ArrowDown":
            yt = ft === 0 ? 1 : Math.min(Ft, ft + an);
            break;
          default:
            return;
        }
    ...
    const { isLetter: W, isDigit: at } = Fr(R.key);
    (W || at) && (R.preventDefault(), x((st) => st + R.key), T.current.focus(), B(!1));
  }, []);
  return Kt(() => {
    const R = setTimeout(() => {
      if (p && v === "books" && A.current && C.current) {
        const W = A.current, at = C.current, st = at.offsetTop, ft = W.clientHeight, Ft = at.clientHeight, yt = st - ft / 2 + Ft / 2;
        W.scrollTo({
          top: Math.max(0, yt),
          behavior: "smooth"
        }), f(tr(t.book));
  ...
  }, [v, N, M, t.book, t.chapterNum]), /* @__PURE__ */ c(ae, { open: p, onOpenChange: P, children: [
    /* @__PURE__ */ r(se, { asChild: !0, children: /* @__PURE__ */ r(
      j,
      {
    ...
    /* @__PURE__ */ r(Jt, { id: d, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ c(
      Xt,
      {
        ref: V,
        onKeyDown: le,
        ...
        children: [
          ...
          !k && /* @__PURE__ */ c(Wt, { ref: A, children: [
            v === "books" && /* @__PURE__ */ c(ut, { children: [
              ...
              M && Vt(M.book) > 1 && /* @__PURE__ */ c(ut, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: _e(M.book, a) }),
                /* @__PURE__ */ r(
                  Gr,
                  {
                    bookId: M.book,
...
function er({
  ...
  const [N, _] = D(!1), k = d ?? l, B = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], V = (T, A) => {
  ...
  return /* @__PURE__ */ c(ae, { open: N, onOpenChange: _, ...y, children: [
    /* @__PURE__ */ r(se, { asChild: !0, children: /* @__PURE__ */ c(
      j,
      {
        variant: f,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Jt,
      {
        ...
        children: /* @__PURE__ */ c(Xt, { children: [
          ...
          /* @__PURE__ */ r(Wt, { children: B(e) ? e.map((T) => /* @__PURE__ */ r(Ht, { heading: T.groupHeading, children: T.options.map((A) => V(A, T.groupHeading)) }, T.groupHeading)) : e.map((T) => V(T)) })
        ] })
      }
    )
  ] });
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ll = Ho ? Kt : K, wn = { tag: cr };
function wl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: d } = t, w = il(null, o), p = yo({ editable: t.editable, html: d, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
const dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : K;
...
const gr = {
  ...
  mark: "",
  markOverlap: ""
}, Et = Pe.Provider, Dt = Pe.Root, Mt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Pe.Trigger,
  {
    ref: o,
...
Mt.displayName = Pe.Trigger.displayName;
const Tt = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Pe.Content,
  {
    ref: o,
    sideOffset: e,
...
Tt.displayName = Pe.Content.displayName;
const br = [
  Mi,
  No,
  ko,
...
function bl() {
  return function(t) {
    const [e] = Bt(), n = z(() => t(e), [e, t]), [o, a] = D(() => n.initialValueFn()), i = J(o);
    return hl(() => {
...
function vl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Ws(e) && o !== null) {
    ...
    if (w || p) {
      const [u, h] = Js(t), f = l.is(d), g = e.is(s ? d : l), x = e.is(s ? l : d);
      let v, y = 0;
...
} }), ce.prototype = new vt(), ce.prototype.h = function() {
...
const xr = 0, or = 1, na = 2, Ln = 3, dn = 4, Ne = 5, Vn = 6, Be = 7;
function jn(t) {
  return t.id === xr;
}
function ra(t) {
...
class Sl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== dn && ot(307, String(n.id), String(Ne)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
    const a = { ...n.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, l) {
      return Object.assign(i, { id: Ne, output: s, registerState: l });
    }(n, o, a);
  }
  register(e, n) {
    this._signal = n;
    const o = this.state;
    o.id !== Ne && ot(308, String(o.id), String(Ne));
    const a = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(i) {
      return Object.assign(i, { id: Vn });
    }(o), () => {
      const i = this.state;
      i.id !== Be && ot(309, String(o.id), String(Be)), this.state = function(s) {
        return Object.assign(s, { id: Ne });
      }(i), a && a();
    };
  }
  afterRegistration(e) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= dn;
    }(e) || ot(313, String(e.id), String(dn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= Be;
    }(e) || ot(316, String(e.id), String(Be)), e;
  }
...
const Il = /* @__PURE__ */ new Set(), Jr = Yt({ build(t, e, n) {
  ...
  return { watchNodeKey: function(s) {
    const l = _l(() => (i.value || Il).has(s)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(s);
    const p = w !== void 0;
...
Yt({ dependencies: [rr, Jr], name: "@lexical/extension/HorizontalRule", nodes: () => [Te], register(t, e, n) {
  ...
  return ne(t.registerCommand(si, (s) => {
    if (ii(s.target)) {
      ...
      if (Pl(l)) return function(d, w = !1) {
        const p = qt(), u = d.isSelected(), h = d.getKey();
        let f;
        w && wi(p) ? f = p : (f = di(), ci(f)), u ? f.delete(h) : f.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, pi), t.registerMutationListener(Te, (s, l) => {
    kl(() => {
      let d = !1;
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) s.push(re(() => {
      const w = l.value;
      w && (d.value ? Eo(w, i) : hi(w, i));
    }));
    return ne(...s);
  }));
} });
function $l(t, e) {
  return ne(t.registerCommand(gi, (n) => {
    ...
    const a = function(i) {
      ...
      const s = i.anchor, l = i.focus, d = l.isBefore(s) ? l : s, w = d.getNode(), p = Ur(w);
      if (p.canIndent()) {
        const u = p.getKey();
        let h = bi();
...
function Ul({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    yr(() => ne(Ii(a), sa(a)), [a]);
  }(o), c(ut, { children: [t, r(Kl, { content: e }), r(Gl, { editor: o, ErrorBoundary: n })] });
}
...
function Zl(t, e) {
  ...
  return c(ut, { children: [r(Wl, { editor: a, ...o, ref: e }), n != null && r(Ql, { editor: a, content: n })] });
}
...
function rw({
  ...
  const [e] = Bt(), [n, o] = D(e), [a, i] = D("paragraph"), [s, l] = nw(), d = () => {
  };
...
function pa(t, e, n, o = null) {
  ...
  const l = fe(s) ? s.getChildren() : [], d = Ci(t, s.getType());
  let w;
...
function ep({
  ...
  const [a, i] = D(mw), [s, l] = D(void 0), [d, w] = D(!1), p = J(void 0), u = J(null);
  K(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ c("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
          /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(j, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ c(ae, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ r(se, { asChild: !0, children: /* @__PURE__ */ c(
        j,
        {
          variant: "outline",
...
const np = Object.freeze([
  ...
  const a = J(null), [i, s] = D(void 0), [l, d] = D(void 0), w = G(
    (f) => {
      s(f);
...
Se.displayName = Oo.Root.displayName;
...
function Rw({
  ...
  const [T, A] = D(no), [C, E] = D(
    void 0
  ), $ = o, [L, O] = D(!1), [I, H] = D(!1), [M, Q] = D(!1), [F, q] = D(!1), [mt, Z] = D(!1), [Y, P] = D(k), [X, tt] = D(!1), nt = J(void 0), [ct, _t] = D(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
      const Rt = N ? await N(d) : !1;
      S && Z(Rt);
    })(), () => {
      S = !1;
    };
  ...
  const Ct = z(() => xt[0], [xt]), on = J(null), ye = J(void 0), le = G(() => {
    var S;
    (S = ye.current) == null || S.call(ye), A(no);
  }, []), On = G(() => {
    const S = !Y;
    P(S), tt(!S), g == null || g(d, S);
  }, [Y, g, d]);
  K(() => {
    O(!1);
  }, [o]), K(() => {
  ...
  }, [i, n]), at = z(() => xt.slice(1), [xt]), st = z(() => at.length ?? 0, [at.length]), ft = z(() => st > 0, [st]), Ft = z(() => L || st <= 2 ? at : at.slice(-2), [at, st, L]), yt = z(() => L || st <= 2 ? 0 : st - 2, [st, L]), an = z(
  ...
  const Dr = G(
    async (S) => {
      ...
      $t && await u({ threadId: d, contents: $t }) && le();
    },
    [
      le,
      T,
      ...
      children: /* @__PURE__ */ c(ba, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            W && /* @__PURE__ */ r(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: W }),
            /* @__PURE__ */ r(
              j,
              {
                variant: "ghost",
          ...
          /* @__PURE__ */ r(
            eo,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: H,
              canEditOrDelete: (!I && ct.get(Ct.id)) ?? !1,
              canUserResolveThread: mt
            }
          )
        ] }),
        /* @__PURE__ */ c(ut, { children: [
          ft && !o && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    L ? /* @__PURE__ */ r(mo, {}) : /* @__PURE__ */ r(Ie, {})
                  ] })
                ]
              }
            ),
            Ft.map((S) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              eo,
              {
                comment: S,
                localizedStrings: n,
                ...
                handleDeleteComment: f,
                onEditingChange: H,
                canEditOrDelete: (!I && ct.get(S.id)) ?? !1
              }
            ) }, S.id)),
            v !== !1 && (!I || Ot(T)) && /* @__PURE__ */ c(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ c(ae, { open: M, onOpenChange: Q, children: [
                      /* @__PURE__ */ r(se, { asChild: !0, children: /* @__PURE__ */ r(
                        j,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !F || !x || x.length === 0 || !x.includes(s),
...
function Sw({ table: t }) {
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ r(Li, { asChild: !0, children: /* @__PURE__ */ c(j, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ms, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(ie, { align: "end", className: "tw-w-[150px]", children: [
...
const De = dt.Root, Dw = dt.Group, Me = dt.Value, Mw = oe(
...
), be = b.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const i = gt();
  return /* @__PURE__ */ c(
    dt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(dt.Icon, { asChild: !0, children: /* @__PURE__ */ r(Ie, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
be.displayName = dt.Trigger.displayName;
...
Ca.displayName = dt.ScrollUpButton.displayName;
...
Ea.displayName = dt.ScrollDownButton.displayName;
const ve = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const i = gt();
  return /* @__PURE__ */ r(dt.Portal, { children: /* @__PURE__ */ c(
    dt.Content,
    {
      ref: a,
      className: m(
...
ve.displayName = dt.Content.displayName;
...
Ow.displayName = dt.Label.displayName;
const St = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  dt.Item,
  {
    ref: o,
    className: m(
...
Iw.displayName = dt.Separator.displayName;
function Aw({ table: t }) {
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ c(
        De,
        {
          ...
          children: [
            /* @__PURE__ */ r(be, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Me, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(ve, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(St, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Bw({
  ...
  let B;
  return d ? B = Array.from({ length: 10 }).map((C, E) => `skeleton-row-${E}`).map((C) => /* @__PURE__ */ r(Gt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(ge, { colSpan: k.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, C)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? B = _.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    Gt,
    {
      onClick: () => s(T, _),
    ...
    T.id
  )) : B = /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(ge, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
...
function ip({
  ...
  return /* @__PURE__ */ c(ae, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ r(se, { asChild: !0, children: o }),
    /* @__PURE__ */ c(Jt, { id: i, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function lp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ c(j, { variant: "default", children: [
      /* @__PURE__ */ r(vs, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(Ie, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ie, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
...
function qw({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ c(ae, { open: A, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(se, { asChild: !0, children: /* @__PURE__ */ c(
      j,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Jt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(Xt, { children: [
      ...
      /* @__PURE__ */ c(Wt, { children: [
        ...
        /* @__PURE__ */ r(Ht, { children: B.map((E) => /* @__PURE__ */ c(
          zt,
          {
            value: E.label,
            onSelect: _,
...
function Hw({
  ...
  return /* @__PURE__ */ c(ut, { children: [
    ...
    e && /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(
        j,
        {
          "aria-label": "Redo",
...
const Yw = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(ut, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ c(ut, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function Xw({
  ...
  const i = J(null), s = J(null), l = J(!1), [d, w] = D(t), [p, u] = D(n), [h, f] = D(!1);
  K(() => {
    w(t);
  }, [t]), K(() => {
    p !== n && u(n);
  ...
  const g = (v) => {
    ...
    var y, N, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = i.current) == null || y.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ c(xe, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: Yw(t, a, n) }) }) }),
...
const Ww = (t, e) => t === "f" ? /* @__PURE__ */ c(ut, { children: [
  /* @__PURE__ */ r(bo, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ c(ut, { children: [
  /* @__PURE__ */ r(vo, {}),
  " ",
...
function Zw({
  ...
  return /* @__PURE__ */ c(xe, { children: [
    /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
      /* @__PURE__ */ r(Di, { asChild: !0, children: /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: Ww(t, n) }) }) }),
      /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r("p", { children: Jw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ c(ie, { className: "tw-z-[300]", children: [
...
function up({
  ...
  const w = J(null), p = as(), [u, h] = D("generated"), [f, g] = D("*"), [x, v] = D("f"), [y, N] = D(!1), [_, k] = D(!0), [B, V] = D(!1), T = J(!1), A = J(""), C = z(
    () => ({
      ...s,
  ...
  K(() => {
    ...
    if (q && ln("note", q)) {
      ...
      let P = "custom";
      Y === Xn ? P = "generated" : Y === Wn ? P = "hidden" : Y && g(Y), h(P), v(((Z = q.insert.note) == null ? void 0 : Z.style) ?? "f"), F = setTimeout(() => {
        var X;
  ...
  const E = G(
    (F, q, mt = !1) => {
      ...
      if (Z && ln("note", Z)) {
        if (Z.insert.note) {
          let tt;
          F === "custom" ? tt = q : F === "generated" ? tt = Xn : tt = Wn, Z.insert.note.caller = tt;
        }
        n == null || n([Z]), mt && d && i && ((X = d.current) == null || X.replaceEmbedUpdate(i, [Z]));
      }
    },
    [i, n, d]
  ), $ = G(() => {
  ...
  const O = () => {
    var q;
    const F = (q = p.current) == null ? void 0 : q.getElementsByClassName("editor-input")[0];
    ...
    if (q && ln("note", q)) {
      q.insert.note && (q.insert.note.style = F);
      const tt = (P = (Y = q.insert.note) == null ? void 0 : Y.contents) == null ? void 0 : P.ops;
      x !== "x" && F === "x" ? tt == null || tt.forEach((nt) => Qw(nt)) : x === "x" && F !== "x" && (tt == null || tt.forEach((nt) => td(nt))), (X = w.current) == null || X.applyUpdate([q, { delete: 1 }]);
    }
  }, Q = (F) => {
    var mt, Z, Y, P, X;
    const q = (Z = (mt = w.current) == null ? void 0 : mt.getNoteOps(0)) == null ? void 0 : Z.at(0);
    if (q && ln("note", q)) {
      F.content.length > 1 && setTimeout(() => {
        var ct;
        (ct = w.current) == null || ct.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const tt = (Y = q.insert.note) == null ? void 0 : Y.style, nt = (X = (P = q.insert.note) == null ? void 0 : P.contents) == null ? void 0 : X.ops;
      if (tt || N(!1), N(
        tt === "x" ? !!(nt != null && nt.every((ct) => {
          var xt, Ct;
          if (!((xt = ct.attributes) != null && xt.char)) return !0;
          const _t = ((Ct = ct.attributes) == null ? void 0 : Ct.char).style;
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
  ...
  return /* @__PURE__ */ c(ut, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ut, { children: nd(t.marker, l, o, w) })
      }
    )
  ] });
}
        ...
        "ul",
        {
          ...
          children: n.map((N, _) => {
            ...
            return /* @__PURE__ */ c(ut, { children: [
              ...
              _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Se, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function sd({
  ...
  return /* @__PURE__ */ c(Tn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Rn, { stickyHeader: !0, children: /* @__PURE__ */ c(Gt, { children: [
    ...
    /* @__PURE__ */ r(Sn, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ c(
      Gt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ge, { className: o, children: ad(l.text) })
        ]
      },
...
}, Dn = (t, e, n) => /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ c(Dt, { children: [
  /* @__PURE__ */ c(
    Mt,
    {
...
function kp({
  ...
  const f = Lt(n, "%webView_inventory_all%"), g = Lt(n, "%webView_inventory_approved%"), x = Lt(n, "%webView_inventory_unapproved%"), v = Lt(n, "%webView_inventory_unknown%"), y = Lt(n, "%webView_inventory_scope_currentBook%"), N = Lt(n, "%webView_inventory_scope_chapter%"), _ = Lt(n, "%webView_inventory_scope_verse%"), k = Lt(n, "%webView_inventory_filter_text%"), B = Lt(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Lt(n, "%webView_inventory_no_results%"), [T, A] = D(!1), [C, E] = D("all"), [$, L] = D(""), [O, I] = D([]), H = z(() => {
    const P = t ?? [];
    return P.length === 0 ? [] : cd(P, a, i);
  }, [t, a, i]), M = z(() => {
    if (T) return H;
    const P = [];
    return H.forEach((X) => {
  ...
  }, [T, H]), Q = z(() => M.length === 0 ? [] : dd(M, C, $), [M, C, $]), F = z(() => {
    var tt, nt;
    if (!T) return d;
    ...
    for (let ct = 0; ct < P; ct++)
      X.push(
        ld(
          ((nt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : nt[ct]) || "Additional Item",
          ct + 1
        )
      );
    return [...X, ...d];
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ c(
        De,
        {
          ...
          defaultValue: C,
          children: [
            /* @__PURE__ */ r(be, { className: "tw-m-1", children: /* @__PURE__ */ r(Me, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ c(De, { onValueChange: (P) => mt(P), defaultValue: s, children: [
        /* @__PURE__ */ r(be, { className: "tw-m-1", children: /* @__PURE__ */ r(Me, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(ve, { children: [
      ...
      o && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(ht, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] })
    ] }),
...
function Cp({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ c(Xt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      Le,
      {
      ...
      /* @__PURE__ */ r(Ht, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ c(
          zt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(pd, { icon: s.icon }) }) }),
              /* @__PURE__ */ c("div", { children: [
              ...
              (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Bo, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
const ud = "16rem", md = "3rem", Ra = b.createContext(void 0);
function Mn() {
...
const Nd = oe(
  ...
  ({
    ...
    const d = t ? Ae : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: m(Nd({ variant: n, size: o }), i),
        ...s
      }
    );
...
const Rd = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Ae : "a",
  {
    ref: i,
...
const Qt = "scrBook", Dd = "scrRef", pe = "source", Md = "details", Od = "Scripture Reference", Id = "Scripture Book", $a = "Type", Ad = "Details";
function Pd(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, so = (t) => `${$d({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Tp({
  sources: t,
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ c(
      De,
      {
        ...
        children: [
          /* @__PURE__ */ r(be, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Me, {}) }),
          /* @__PURE__ */ r(ve, { position: "item-aligned", children: /* @__PURE__ */ r(Dw, { children: k.map((C) => /* @__PURE__ */ r(St, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Tn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Rn, { children: y.getHeaderGroups().map((C) => /* @__PURE__ */ r(Gt, { children: C.headers.filter((E) => E.column.columnDef.header).map((E) => (
        ...
        /* @__PURE__ */ r(Qe, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
                  ...
                  ge,
                  {
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ c(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          C.getIsExpanded() && /* @__PURE__ */ r(Ie, {}),
                          !C.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ r(Ce, {}) : /* @__PURE__ */ r(qn, {})),
                          " ",
...
function Vd({
  ...
  }, [v, y] = D(!1), [N, _] = D(""), k = J(void 0), B = J(!1);
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ c(
      ae,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Jt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            Xt,
            {
              shouldFilter: !1,
              onKeyDown: (I) => {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: L, children: d }),
    ...
    e.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Gn ? Gn : io
      ).map((I) => /* @__PURE__ */ r(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: _e(I, a) }, I)),
...
function Sp({
  ...
  const w = de(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = de(s, "%webView_scope_selector_current_book%"), f = de(s, "%webView_scope_selector_choose_books%"), g = de(s, "%webView_scope_selector_scope%"), x = de(s, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        hr,
        {
          ...
          children: y.map(({ value: N, label: _, id: k }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
...
function Dp({
  ...
  return /* @__PURE__ */ c(
    De,
    {
      ...
      children: [
        /* @__PURE__ */ r(be, { size: a, className: m("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Me,
          {
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Dt, { children: [
  /* @__PURE__ */ r(Mt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    vn,
    {
      onClick: () => {
        o(l);
...
function wr({
  ...
  return /* @__PURE__ */ c(xe, { variant: i, children: [
    /* @__PURE__ */ r(Ve, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Ps, {}) }) }),
    /* @__PURE__ */ r(ie, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(lo, { children: [
      /* @__PURE__ */ r(ya, { children: /* @__PURE__ */ r(Et, { children: ja(e.groups, e.items, d, t) }) }),
...
function Ap({
  ...
  return /* @__PURE__ */ c(za, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: t,
...
Fd.displayName = lt.CheckboxItem.displayName;
...
Gd.displayName = lt.RadioItem.displayName;
...
Ud.displayName = lt.Label.displayName;
...
const Fe = (t, e) => {
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((w) => w.group === i).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        Xa,
        {
          onClick: () => {
            o(w);
    ...
    return l.length > 0 && s < a.length - 1 && d.push(/* @__PURE__ */ r(Wa, {}, `separator-${i}`)), d;
  });
};
function Kd({
  menuData: t,
  ...
  const a = J(void 0), i = J(void 0), s = J(void 0), l = J(void 0), d = J(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return i;
  ...
  if (Ki(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(Ua, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ c(zd, { children: [
  ...
  return /* @__PURE__ */ c("div", { id: d, className: m("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ c(
      De,
      {
        ...
        onOpenChange: (g) => u(g),
        children: [
          /* @__PURE__ */ r(be, { children: /* @__PURE__ */ r(Me, {}) }),
          /* @__PURE__ */ r(
            ve,
            {
              className: "tw-z-[250]",
...
const Yd = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vs, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const Gp = wt.Root, Up = wt.Trigger, Kp = wt.Group, qp = wt.Portal, Hp = wt.Sub, Yp = wt.RadioGroup, Qd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  wt.SubTrigger,
  {
    ref: a,
    className: m(
...
Qd.displayName = wt.SubTrigger.displayName;
...
tc.displayName = wt.SubContent.displayName;
const ec = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(wt.Portal, { children: /* @__PURE__ */ r(
  wt.Content,
  {
    ref: n,
    className: m(
...
ec.displayName = wt.Content.displayName;
...
nc.displayName = wt.Item.displayName;
...
rc.displayName = wt.CheckboxItem.displayName;
...
oc.displayName = wt.RadioItem.displayName;
...
ac.displayName = wt.Label.displayName;
...
sc.displayName = wt.Separator.displayName;
...
const Xp = At.Trigger, wc = At.Portal, Wp = At.Close, Qa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Overlay,
  {
    ref: n,
...
uc.displayName = At.Title.displayName;
...
mc.displayName = At.Description.displayName;
...
const eu = kt.Root, bc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = gt();
  return /* @__PURE__ */ r(
    kt.List,
    {
...
bc.displayName = kt.List.displayName;
...
vc.displayName = kt.Trigger.displayName;
...
xc.displayName = kt.Content.displayName;
...
export {
  ...
  pp as UNDO_REDO_BUTTONS_STRING_KEYS,
