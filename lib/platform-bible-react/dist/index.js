...
var Ht = (t, e, r) => cs(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as fe, a as Tr, C as ke, T as St, b as It, d as Rt, e as Dt, A as de, P as Pe, f as De, B as Z, h as $e, i as Ae, j as je, k as be, x as ls, l as ds, m as ws, I as us, n as ho, r as _e, o as ps, p as zn, q as Pr, s as $r, L as Tt, R as go, t as na, D as Ua, u as Ha, v as Ka, w as qa, y as On, z as Xr, E as fo, F as Mn, G as mo, H as ar, J as ze, K as Le, M as Be, N as Ve, S as Dr, O as wr, Q as hs, U as or, V as Ye, W as Se, Z as Xe, X as Ke, Y as ur, _ as vo, $ as bo, a0 as ia, a1 as xo, a2 as Pn, a3 as $n, a4 as Ya, a5 as gs, a6 as Wa, a7 as An, a8 as pa, a9 as fs, aa as yo, ab as ms, ac as vs, ad as bs, ae as Lo, af as xs, ag as ys, ah as Jr, ai as ks, aj as jn, ak as Ln, al as ko, am as _s, an as Bn, ao as Sa, ap as Bo, aq as Ns, ar as Cs, as as Es, at as Ts, au as Ss, av as Ar, aw as _o, ax as Is, ay as Rs } from "./resizable-B1exdhUM.js";
import { az as Zg, aA as Qg, aB as tf, aC as ef, aD as rf, aE as af, aF as of, aG as nf, aH as sf, aI as cf, aJ as lf, aK as df, aL as wf, aM as uf, aN as pf, aO as hf, aP as gf, aQ as ff, aR as mf, aS as vf, aT as bf, aU as xf, aV as yf, aW as kf, aX as _f, aY as Nf, aZ as Cf, a_ as Ef, a$ as Tf, b0 as Sf, b1 as If, b2 as Rf, b3 as Df, b4 as zf, b5 as Of, b6 as Mf } from "./resizable-B1exdhUM.js";
import { jsx as a, jsxs as u, Fragment as it } from "react/jsx-runtime";
import { Canon as Pt } from "@sillsdev/scripture";
import { Check as Oe, Clock as Vo, ChevronsLeft as Fo, ChevronsRight as Go, ChevronLeft as Xa, ChevronRight as Ja, ArrowLeft as Ds, ArrowRight as Vn, ChevronDown as nr, BoldIcon as zs, ItalicIcon as Os, X as No, AtSign as Fn, Pencil as Ms, Trash2 as Ps, ArrowUp as Gn, MoreHorizontal as $s, MailOpen as As, Mail as js, ChevronUp as Ls, FilterIcon as Bs, ArrowLeftIcon as Vs, ChevronLeftIcon as Fs, ChevronRightIcon as Gs, ArrowRightIcon as Us, Copy as Un, Filter as Hn, User as Hs, Link as Ks, CircleHelp as qs, Undo as Ys, Redo as Ws, SquareX as Kn, FunctionSquare as qn, SquareSigma as Yn, Ban as Xs, AlertCircle as Za, CircleCheckIcon as Js, CircleXIcon as Zs, CircleHelpIcon as Qs, ArrowUpIcon as tc, ArrowDownIcon as ec, Loader2 as rc, ChevronsUpDown as Wn, ScrollText as ac, MenuIcon as oc, Menu as nc, EllipsisVertical as ic, MoreVertical as sc } from "lucide-react";
import { Section as Et, getChaptersForBook as cc, formatScrRef as Ie, formatReplacementString as qe, getSectionForBook as Zr, formatRelativeDate as lc, sanitizeHtml as Co, NumberFormat as Xn, formatBytes as dc, getCurrentLocale as wc, usfmMarkers as Qr, isPlatformError as uc, ABORTED as pc, getErrorMessage as hc, getFormatCallerFunction as gc, deepEqual as fc, isString as Uo, normalizeProjectId as ve, getLocalizeKeyForScrollGroupId as Qa, compareScrRefs as to, scrRefToBBBCCCVVV as Ia, defaultScrRef as Ra, formatScrRefRange as mc, formatReplacementStringToArray as Ho, collectUsjMarkers as vc } from "platform-bible-utils";
import Yt, { useRef as K, useMemo as $, createContext as jr, useContext as ha, useState as N, useCallback as B, useEffect as J, useImperativeHandle as bc, useLayoutEffect as ee, Component as xc, createElement as Ko, Suspense as yc, forwardRef as Jn, useId as qo, Fragment as Lr } from "react";
import { IconSelector as Zn, IconCheck as ga, IconChevronDown as kc, IconChevronUp as _c, IconLayoutSidebar as Nc, IconLayoutSidebarRight as Cc, IconChevronRight as Qn, IconSearch as Ec, IconLoader as Tc, IconAlertOctagon as Sc, IconAlertTriangle as Ic, IconInfoCircle as Rc, IconCircleCheck as Dc } from "@tabler/icons-react";
import { createEditor as ti, $getRoot as We, $createParagraphNode as Br, $getSelection as re, HISTORY_MERGE_TAG as Eo, ParagraphNode as ei, TextNode as ri, $getPreviousSelection as zc, $isRangeSelection as xe, $caretFromPoint as Oc, $getSiblingCaret as ai, $getChildCaret as Mc, $getAdjacentChildCaret as Pc, $isChildCaret as $c, $normalizeCaret as Ac, $setSelectionFromCaretRange as jc, $getCollapsedCaretRange as Lc, $getCaretInDirection as Yo, $splitAtPointCaretNext as Bc, $isTextPointCaret as Vc, $findMatchingParent as oi, $isElementNode as zr, mergeRegister as Me, getDOMTextNode as Fc, isHTMLElement as Gc, CLEAR_EDITOR_COMMAND as ni, COMMAND_PRIORITY_EDITOR as To, shallowMergeConfig as Uc, defineExtension as se, safeCast as ir, createState as Hc, FORMAT_TEXT_COMMAND as ii, $isNodeSelection as si, COMMAND_PRIORITY_LOW as ci, RootNode as Kc, LineBreakNode as qc, TabNode as Yc, $isEditorState as Wc, createCommand as Xc, CLICK_COMMAND as Jc, isDOMNode as Zc, $getNodeFromDOMNode as Qc, $createNodeSelection as tl, $setSelection as el, $getEditor as rl, DecoratorNode as eo, $getState as al, toggleTextFormatType as Wo, TEXT_TYPE_TO_FORMAT as ol, $setState as nl, addClassNamesToElement as li, $create as il, $getNodeByKey as sl, removeClassNamesFromElement as cl, KEY_TAB_COMMAND as ll, $isBlockElementNode as dl, $createRangeSelection as wl, $normalizeSelection__EXPERIMENTAL as ul, OUTDENT_CONTENT_COMMAND as pl, INDENT_CONTENT_COMMAND as Xo, INSERT_TAB_COMMAND as hl, COMMAND_PRIORITY_CRITICAL as So, $isDecoratorNode as gl, $isParagraphNode as fl, $isTextNode as ro, SELECTION_CHANGE_COMMAND as di, $insertNodes as ml } from "lexical";
...
import { useReactTable as ui, getFilteredRowModel as El, getSortedRowModel as pi, getPaginationRowModel as Tl, getCoreRowModel as hi, flexRender as Sr, getGroupedRowModel as Sl, getExpandedRowModel as Il } from "@tanstack/react-table";
import Rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ao, HIDDEN_NOTE_CALLER as oo, getDefaultViewOptions as Dl, isInsertEmbedOpOfType as Nr, getMarkerMenuItems as zl, defaultStyleInfo as Ol, Editorial as Ml } from "@eten-tech-foundation/platform-editor";
...
function fi({
  ...
  const g = K(!1), f = () => {
    ...
    () => Tr(e, l),
    [e, l]
  ), k = !!h && !w, T = `${v} (${z})`, R = k ? p || `${T}, ${h}` : T, M = /* @__PURE__ */ u(
    ke,
    {
      ref: t,
...
function Bl({
  ...
  J(() => {
    ...
    if (!E) return;
    const x = (U) => !!U && U.scrollWidth > U.clientWidth, F = () => {
      io !== "pointer" && (I || x(p.current) || x(l.current)) && T(!0);
    }, S = () => T(!1);
    return E.addEventListener("focus", F), E.addEventListener("blur", S), () => {
      E.removeEventListener("focus", F), E.removeEventListener("blur", S);
    };
  }, [I, p, l]);
  const j = B(() => {
    I && z(!0), f(), M && w();
        ...
        children: [
          /* @__PURE__ */ a(Rt, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                W,
                W && G && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                G
              ]
            }
          ) }),
...
function Xp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function za({
  ...
  const I = _e(), j = jl(), [P, O] = N(!1), [q, W] = N(""), [G, E] = N(""), [x, F] = N("books"), [S, C] = N(void 0), [U, ot] = N(
    void 0
  ), [nt, ut] = N(void 0), [Bt, Q] = N(!1), [ct, ft] = N(!1), mt = K(null), vt = K(!1), _t = K(void 0), ht = K(void 0), Vt = K(void 0), ae = K(void 0), zt = K({}), Ft = K({}), gt = B(
    (_) => {
      e(_), l && l(_);
    },
    [e, l]
    ...
    () => ql(Xt, xt),
    [Xt, xt]
  ), Fe = Zt.has(t.book), ne = $(() => G.trim() ? so(
    Jt.filter((_) => ho(_, G, i))
  ) : ct ? At : Nt, [
    Nt,
    At,
    Jt,
  ...
  const yt = B(() => {
    ...
    F("books"), C(void 0), ot(void 0), ut(void 0), setTimeout(() => {
      ht.current && ht.current.focus();
    }, 0);
  }, []), H = B(() => {
    const _ = U;
    ot(void 0), ut(void 0), _ ? (C(_), F("chapters"), W("")) : D();
  }, [U, D]), X = B(
    (_) => {
      O(_), _ && (F("books"), C(void 0), ot(void 0), ut(void 0), E(""), ft(Fe));
    },
    [Fe]
  );
  J(() => {
  ...
  const { otLong: A, ntLong: et, dcLong: lt, extraLong: pt } = {
    ...
    [t.book, i, j]
  ), Fr = `${t.chapterNum}:${t.verseNum}`, Ze = B((_) => (rt) => {
    zt.current[_] = rt;
  }, []), Ge = B((_) => (rt) => {
    Ft.current[_] = rt;
  }, []), Gr = $(
    () => Ul(G),
    [G]
  ), xa = $(() => !w || !L || !L.chapterNum || !Gr ? !1 : w(L.book, L.chapterNum) > 0, [w, L, Gr]), ya = x === "books" && !Bt && !G.trim() && Zt.size > 0, Ur = B(
    (_) => h ? en(_, h) : !1,
    [h]
  ), yr = B(
    (_) => (rt) => h ? Hl(_, rt, h) : !1,
              ...
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  Z,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: x === "verses" ? H : D,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: I === "ltr" ? /* @__PURE__ */ a(Ds, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Vn, { className: "tw:h-4 tw:w-4" })
                  }
                ),
...
function nn({
  ...
  const [T, R] = N(!1), M = d ?? l, I = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], j = (P, O) => {
    const q = l(P), W = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, G = `${O ?? ""}${q}${W ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: q,
...
const ki = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Jl = ki ? ee : J, qr = { tag: Eo };
function Zl({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Xl(null, o), w = ti({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (h) => s(h, w), theme: o });
    return function(h, p) {
      if (p !== null) {
...
const Ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
...
const _i = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ld = _i && "documentMode" in document ? document.documentMode : null;
!(!_i || !("InputEvent" in window) || ld) && "getTargetRanges" in new window.InputEvent("input");
function me(t) {
  return `${t}px`;
}
...
function wd(t, e, r) {
  ...
  function l() {
    ...
    const { left: h, top: p } = n.getBoundingClientRect(), g = cd(t, e);
    var f, b;
    c.isConnected || (b = c, (f = n).insertBefore(b, f.firstChild));
    let v = !1;
    for (let z = 0; z < g.length; z++) {
      const k = g[z], T = s[z] || document.createElement("div"), R = T.style;
      ...
      const P = me(k.height);
      R.height !== P && (T.style.height = P, v = !0), T.parentNode !== c && (c.append(T), v = !0), s[z] = T;
    }
...
function pd(t, e = ud) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(h), f = p.getNode(), b = f.getKey(), v = p.offset, z = g.getNode(), k = z.getKey(), T = g.offset, R = t.getElementByKey(b), M = t.getElementByKey(k), I = r === null || R !== o || v !== n || b !== r.getKey(), j = i === null || M !== s || T !== c || k !== i.getKey();
      if ((I || j) && R !== null && M !== null) {
        const P = function(O, q, W, G, E, x, F) {
          const S = (O._window ? O._window.document : document).createRange();
          return S.setStart(...sn(q, W, G)), S.setEnd(...sn(E, x, F)), S;
        }(t, p, f, R, g, z, M);
        l(), l = wd(t, P, e);
      }
      r = f, o = R, n = v, i = z, s = M, c = T;
    });
  }
...
function fd(t) {
  ...
  if (xe(e)) r = Oc(e.focus, "next");
    ...
    r = r || Mc(We(), "previous").getFlipped().insert(Br());
  }
  const o = md(t, r), n = Pc(o), i = $c(n) ? Ac(n) : o;
  return jc(Lc(i)), t.getLatest();
}
function md(t, e, r) {
  let o = Yo(e, "next");
  for (let n = o; n; n = Bc(n, r)) o = n;
  return Vc(o) && sa(283), o.insert(t.isInline() ? Br().append(t) : t), Yo(ai(t.getLatest(), "next"), e.direction);
}
function vd(t) {
  const e = re();
  if (!xe(e)) return !1;
...
let ca, Re = 0, la = 0, yd = 0, lo = 0, ea = 0;
function ln(t) {
  if (st === void 0) return;
  let e = t.n;
...
Kt.prototype.brand = bd, Kt.prototype.h = function() {
  return !0;
...
const Pa = Hc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ii extends eo {
  $config() {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [Ii], register: (t, e, r) => t.registerCommand(ii, (o) => {
  const n = re();
  if (si(n) || xe(n)) for (const i of n.getNodes()) Cd(i) && i.toggleFormat(o);
  return !1;
}, ci) });
function Ri(t, e) {
  let r;
...
class Sd {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Uc;
...
const Rd = se({ config: ir({ setOptions: wn, updateOptions: wn }), init: ({ $initialEditorState: t = Id }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Kc, ri, qc, Yc, ei] }), un = Symbol.for("@lexical/extension/LexicalBuilder");
function pn() {
}
function Dd(t) {
  throw t;
...
const zd = /* @__PURE__ */ new Set(), hn = se({ build(t, e, r) {
...
se({ dependencies: [wo, hn], name: "@lexical/extension/HorizontalRule", nodes: () => [gr], register(t, e, r) {
  ...
  return Me(t.registerCommand(Od, (s) => {
    const c = re();
    if (!xe(c)) return !1;
    ...
    return !0;
  }, To), t.registerCommand(Jc, (s) => {
    if (Zc(s.target)) {
      const c = Qc(s.target);
      if (Pd(c)) return function(l, d = !1) {
        const w = re(), h = l.isSelected(), p = l.getKey();
        let g;
        d && si(w) ? g = w : (g = tl(), el(g)), h ? g.delete(p) : g.add(p);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function $d(t, e, r = Mi) {
  return Me(t.registerCommand(ll, (o) => {
    const n = re();
    if (!xe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((p) => dl(p) && p.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), h = gd(w);
      if (h.canIndent()) {
        const p = h.getKey();
        let g = wl();
        if (g.anchor.set(p, 0, "element"), g.focus.set(p, 0, "element"), g = ul(g), g.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? pl : Xo : hl;
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (xe(f)) {
                ...
                if (ro(v) && d >= 0 && w >= 0 && (z = d, k = d + w, f.setTextNodeRange(v, z, v, k)), z === k && h === "" || (f.insertRawText(h), v = b.getNode()), ro(v)) {
                  z = p, k = p + g;
                  const T = v.getTextContentSize();
                  z = z > T ? T : z, k = k > T ? T : k, f.setTextNodeRange(v, z, v, k);
                }
  ...
  return function(r, o) {
    ...
    return Po(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (p) => r._onError(p), children: a(yc, { fallback: null, children: n[d] }) }), h = r.getElementByKey(d);
        h !== null && s.push(kl(w, h, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Ud({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Po(() => Me(xl(n), $i(n)), [n]);
  }(o), u(it, { children: [t, a(Hd, { content: e }), a(Gd, { editor: o, ErrorBoundary: r })] });
}
...
function Zd(t, e) {
  ...
  return u(it, { children: [a(Xd, { editor: n, ...o, ref: e }), r != null && a(Qd, { editor: n, content: r })] });
}
...
function aw({
  ...
  const [e] = Ce(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = rw(), l = () => {
  };
...
function sw({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(aw, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(nw, {}) }) }),
...
function lw(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Cl(e, n);
      We().clear(), ml(i);
    },
    {
      discrete: !0
...
const dw = "verseText", th = Object.freeze([
...
function Hi(t) {
  return (t == null ? void 0 : t.conflictType) === dw;
}
function Ki(t) {
...
function eh({
  ...
  const [i, s] = N(ww), [c, l] = N(n), [d, w] = N(!1), h = K(void 0), p = K(null);
  J(() => {
    let v = !0;
    const z = p.current;
    if (!z) return;
...
function bn({
    ...
    if (o && c)
      return /* @__PURE__ */ u(it, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (I) => {
              I.stopPropagation(), d(!0), h(lw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(gw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(fw, { className: "tw:text-xs tw:font-medium", children: z }) }),
        ...
        M && /* @__PURE__ */ u(Le, { children: [
          /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a($s, {}) }) }),
...
function Yi({
  ...
  const [G, E] = N(xn), [x, F] = N(), [S, C] = N(), U = o, [ot, nt] = N(!1), [ut, Bt] = N(!1), [Q, ct] = N(!1), [ft, mt] = N(!1), [vt, _t] = N(!1), [ht, Vt] = N(R), [ae, zt] = N(!1), Ft = K(void 0), [gt, Xt] = N(/* @__PURE__ */ new Map());
  J(() => {
    let y = !0;
    return (async () => {
  ...
  J(() => {
    if (!o) {
      xt.current !== "idle" && (F(void 0), C(void 0), xt.current = "idle");
      return;
    }
  ...
  }, [i, r]), Gt = $(() => Nt.slice(1), [Nt]), yt = $(() => Gt.length ?? 0, [Gt.length]), ce = $(() => yt > 0, [yt]), Qt = $(() => ot || yt <= 2 ? Gt : Gt.slice(-2), [Gt, yt, ot]), Ut = $(() => ot || yt <= 2 ? 0 : yt - 2, [yt, ot]), pe = $(
  ...
  const D = B(
    ...
    async (y) => {
      const Y = ie(G) ? wa(G) : void 0, A = y.status ? y.assignedUser : x ?? y.assignedUser, et = await h({
        ...y,
        contents: Y,
        assignedUser: A
      });
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              Z,
              {
                ...
                children: ht ? /* @__PURE__ */ a(As, {}) : /* @__PURE__ */ a(js, {})
              }
            ),
            q === void 0 ? (
          ...
          o && /* @__PURE__ */ u(it, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    ot ? /* @__PURE__ */ a(Ls, {}) : /* @__PURE__ */ a(nr, {})
                  ] })
                ]
              }
            ),
            ...
            v !== !1 && (!ut || ie(G)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (y) => {
                  Ao(y) && (y.preventDefault(), y.stopPropagation(), (ie(G) || x !== void 0 && x !== S) && D());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    x !== void 0 && (ie(G) || x !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: qe(
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(je, { children: b == null ? void 0 : b.map((y) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                F(y !== i ? y : void 0), xt.current = "user-selected", C(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), vw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), aa = (t) => vw(Co(t));
function oa({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function bw({
  ...
  const q = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: q }), G = (S) => S ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: S }) : W, E = () => {
    const S = o ?? "accept";
    return S === "merged" ? t.mergedText ? /* @__PURE__ */ a(oa, { html: z }) : W : G(S === "reject" ? t.rejectedResultText : t.resultText);
  }, x = (S) => h && S.value === "reject", F = (S) => {
        ...
        /* @__PURE__ */ a(
          go,
          {
            ...
            children: I.map((S) => x(S) ? /* @__PURE__ */ a(St, { delayDuration: 0, children: /* @__PURE__ */ u(It, { children: [
              /* @__PURE__ */ a(Rt, { asChild: !0, children: F(S) }),
...
function Nw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: h, resolvedResolution: p, showResolveCheck: g } = _w({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function dh({
  ...
  const O = r.filter(
    ...
    [k, b]
  ), { listboxRef: E, activeId: x, handleKeyDown: F } = hs({
    options: q,
    onOptionSelect: W
  }), S = B(
    (C) => {
      ...
      }), M(void 0), b == null || b(void 0)), C.preventDefault(), C.stopPropagation()) : F(C);
    },
    [R, k, F, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: O.map((C) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: C.type === "Conflict" ? /* @__PURE__ */ a(Nw, { ...U, conflictResolution: z }) : /* @__PURE__ */ a(Yi, { ...U })
          },
          C.id
        );
      })
...
function Rw({
  ...
  var I;
  const [w, h] = N([]), [p, g] = N([]), [f, b] = N({}), [v, z] = N({}), k = $(() => e ?? [], [e]), T = ui({
    data: k,
    columns: t,
    getCoreRowModel: hi(),
...
function fh({ id: t, label: e, groups: r }) {
  const [o, n] = N(
    Object.fromEntries(
      r.map(
...
function vh({
  ...
  const s = $(() => dc(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(wc(), { type: "language" });
...
const jw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(it, { children: [
...
function Lw({
  ...
  return /* @__PURE__ */ u(Le, { open: h, onOpenChange: v, children: [
    /* @__PURE__ */ a(St, { children: /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(Rt, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: jw(t, o, e) }) }) }),
...
const Bw = (t, e) => t === "f" ? /* @__PURE__ */ u(it, { children: [
  /* @__PURE__ */ a(qn, {}),
  " ",
...
function Fw({
  ...
  return /* @__PURE__ */ u(Le, { children: [
    /* @__PURE__ */ a(St, { children: /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(Rt, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: Bw(t, r) }) }) }),
      /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ a("p", { children: Vw(t, r) }) })
    ] }) }),
  ...
  return /* @__PURE__ */ u(
    ke,
    {
      ...
      children: [
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Uw, { icon: t.icon }) }) }),
...
function xh({
  ...
  ee(() => {
    if (!b.current) return;
    const { width: D } = b.current.getBoundingClientRect();
    D > 0 && (b.current.style.width = `${D}px`);
  }, []);
  const [v, z] = N("generated"), [k, T] = N("generated"), [R, M] = N("*"), [I, j] = N("*"), [P, O] = N("f"), [q, W] = N(!1), [G, E] = N(!0), [x, F] = N(!1), S = K(!1), C = K(""), [U, ot] = N(!1), [nt, ut] = N(), [Bt, Q] = N(), [ct, ft] = N(), [mt, vt] = N(), _t = K(null), ht = K(
    void 0
  ...
  J(() => {
    var D;
    U || (D = p.current) == null || D.focus();
  }, [P, U]);
  const gt = B(() => {
    var y, Y, A;
    const D = (y = g.current) == null ? void 0 : y.querySelector(".editor-input"), H = D == null ? void 0 : D.querySelector("span.note"), X = (A = (Y = g.current) == null ? void 0 : Y.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
  ...
  J(() => {
    ...
    if (y && Nr("note", y)) {
      ...
      let lt = "custom";
      et === ao ? lt = "generated" : et === oo ? lt = "hidden" : et && (M(et), j(et)), z(lt), T(lt), O(((A = y.insert.note) == null ? void 0 : A.style) ?? "f"), D = setTimeout(() => {
        var pt, Ct, Ot;
    ...
    return () => {
      D && clearTimeout(D), H !== void 0 && cancelAnimationFrame(H), X !== void 0 && clearTimeout(X);
    };
  }, [e, i, gt]);
  const Xt = B(
    (D = !1) => {
      ...
      H && Nr("note", H) && (r == null || r([H]), D && d && i && ((Y = d.current) == null || Y.replaceEmbedUpdate(i, [H])));
    },
    [i, r, h, d]
  ), xt = B(
    (D, H) => {
      ...
      let y;
      D === "custom" ? y = H : D === "generated" ? y = ao : y = oo, X.insert.note.caller !== y && (X.insert.note.caller = y, (et = p.current) == null || et.applyUpdate([X, { delete: 1 }]));
    },
    []
  ), Nt = B(() => {
    var D;
    ht.current || (D = p.current) == null || D.commitPendingMarkerEdits(), Xt(!0), o();
  }, [o, Xt]), At = K(Nt);
  ee(() => {
    At.current = Nt;
  });
  ...
  const ue = () => {
    var H;
    const D = (H = g.current) == null ? void 0 : H.getElementsByClassName("editor-input")[0];
    D != null && D.textContent && navigator.clipboard.writeText(D.textContent);
  }, Zt = B(
    (D, H) => {
      h == null || h(), z(D), M(H), xt(D, H);
    },
    [xt, h]
  ), Fe = (D) => {
    var X, y, Y, A, et;
    ...
    if (H && Nr("note", H)) {
      ...
      P !== "x" && D === "x" ? lt == null || lt.forEach((pt) => Ww(pt)) : P === "x" && D !== "x" && (lt == null || lt.forEach((pt) => Xw(pt))), (et = p.current) == null || et.applyUpdate([H, { delete: 1 }]);
    }
  }, ne = (D) => {
    vt(D.contextMarker), F(D.canRedo);
  }, L = B(
    (D) => {
      var X, y, Y, A, et;
      const H = (y = (X = p.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : y.at(0);
    ...
    if (f.current && Ft.length && D && D.rangeCount > 0) {
      const H = D.getRangeAt(0).getBoundingClientRect(), X = f.current.getBoundingClientRect();
      ut(H.left - X.left), Q(H.top - X.top), ft(H.height), ot(!0);
    }
  }, [Ft, f]), yt = K(() => {
  }), ce = B(
    (D, H, X) => {
      const { anchorRect: y } = D;
      if (!w || !y) return;
      const { passive: Y } = X;
      vs({
        items: H,
    ...
    var X;
    const D = (X = p.current) == null ? void 0 : X.getMarkerMenuContext();
    if (!D) return !1;
    const H = zl(zt.styleInfo ?? Ol, D);
    return H.length === 0 ? !1 : (ce(D, H, { passive: !D.hasTextSelection }), !0);
  ...
  J(() => {
    ...
    const H = (y) => {
      const Y = D();
      !U && Y && document.activeElement === Y && y.key === c ? (y.preventDefault(), Gt()) : U && y.key === "Escape" && (y.preventDefault(), ot(!1));
    };
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(fo, { children: [
          /* @__PURE__ */ a(
            $w,
            {
              onUndoClick: () => {
                var D;
                return (D = p.current) == null ? void 0 : D.undo();
              },
              onRedoClick: () => {
                var D;
                return (D = p.current) == null ? void 0 : D.redo();
              },
              canUndo: !G,
              canRedo: x,
              localizedStrings: l
...
function tu({
  ...
  /* @__PURE__ */ a("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: n }), h = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    jo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, b = !!h, v = e === "horizontal" ? "horizontal" : "vertical", z = o ? "marker-visible" : "", k = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", T = m(v, z);
  return /* @__PURE__ */ u(it, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(it, { children: Zw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(xo, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ur, { className: o, children: eu(c.text) })
        ]
      },
...
const au = (t) => {
  ...
  return e ? e[1] : "";
}, nu = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ih = Object.freeze([
...
function Rh({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), b = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), z = ge(r, "%webView_inventory_scope_currentBook%"), k = ge(r, "%webView_inventory_scope_chapter%"), T = ge(r, "%webView_inventory_scope_verse%"), R = ge(r, "%webView_inventory_filter_text%"), M = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), I = ge(r, "%webView_inventory_no_results%"), [j, P] = N(!1), [O, q] = N("all"), [W, G] = N(""), [E, x] = N([]), F = $(() => {
    const Q = t ?? [];
    return Q.length === 0 ? [] : su(Q, n, i);
  }, [t, n, i]), S = $(() => {
    if (j) return F;
    const Q = [];
    return F.forEach((ct) => {
  ...
  }, [j, F]), C = $(() => S.length === 0 ? [] : iu(S, O, W), [S, O, W]), U = $(() => {
    var ft, mt;
    if (!j) return l;
...
const pu = "__unmatched__";
function hu(t, e, r) {
  if (e.length === 0)
    return [{ kind: "flat", rows: [...t].sort(qt) }];
  const o = /* @__PURE__ */ new Map(), n = (d) => {
    const w = o.get(d);
    if (w !== void 0) return w;
    const h = r.get(d), p = h ? e.findIndex((g) => g.match(h)) : -1;
    return o.set(d, p), p;
  }, i = e.map(() => []), s = [];
  t.forEach((d) => {
    const w = n(ve(d.projectId));
    w < 0 ? s.push(d) : i[w].push(d);
  });
  const c = (d, w) => {
    const { compare: h } = w;
    return h ? [...d].sort((p, g) => {
      const f = r.get(ve(p.projectId)), b = r.get(ve(g.projectId));
      if (!f || !b) return qt(p, g);
      const v = h(f, b);
      return v !== 0 ? v : qt(p, g);
    }) : [...d].sort(qt);
  }, l = [];
  return e.forEach((d, w) => {
    const h = i[w];
    h.length !== 0 && l.push({
      kind: "custom",
      id: d.id,
...
function bu({ scrollGroupId: t, isBoundButClosed: e }) {
  const r = Mr(t);
  return e ? /* @__PURE__ */ a(
    ze,
    {
            ...
            /* @__PURE__ */ u(
              $n,
              {
                ...
                children: [
                  ...
                  t.map((c) => /* @__PURE__ */ a(Ya, { value: c, children: ku(c, i) }, c))
                ]
              }
            )
          ] }),
...
function Nu(t) {
  const [e, r] = N(!1), [o, n] = N(""), i = t.availableGroupings ?? mu, [s, c] = N(() => {
  ...
  const p = fu(t.localizedStrings), g = $(() => t.mode === "project" ? Fa({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? Fa({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
    ...
    let x = g;
    return E && (x = x.filter(
      (F) => F.shortName.toLowerCase().includes(E) || F.fullName.toLowerCase().includes(E) || (F.language ?? "").toLowerCase().includes(E) || (F.languageCode ?? "").toLowerCase().includes(E)
    )), t.mode === "project-multi" && l && (x = x.filter((F) => F.isSelected)), x;
  }, [g, o, t.mode, l]), b = $(
    () => new Map(t.projects.map((E) => [ve(E.id), E])),
    [t.projects]
  ), { renderProjectIndicator: v } = t, z = B(
    (E) => {
      if (!v) return;
    ...
    switch (s) {
      ...
      case "language":
        return du(f, p.languageUnknownSectionHeading);
      case "versification":
        return lu(
          f,
      ...
      case "type":
        return wu(f, p.typeUnknownSectionHeading);
      case "custom":
        return hu(f, t.customSections ?? [], b);
      case "none":
      default:
        return En(f, !1);
    }
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const x = t.selection.pairs, F = (C) => C.projectId === E.projectId && C.scrollGroupId === E.scrollGroupId, S = x.some(F) ? x.filter((C) => !F(C)) : [...x, { projectId: E.projectId, scrollGroupId: E.scrollGroupId }];
    ...
    if (t.mode !== "project-multi") return;
    const E = t.selection.pairs, x = new Set(E.map((S) => `${S.projectId}:${S.scrollGroupId ?? ""}`)), F = [...E];
    T.forEach((S) => {
      const C = `${S.projectId}:${S.scrollGroupId ?? ""}`;
      x.has(C) || (x.add(C), F.push(S));
    }), t.onChangeSelection({ pairs: F });
  }, j = () => {
    t.mode === "project-multi" && (t.onChangeSelection({ pairs: [] }), l && d(!1));
  }, P = $(() => {
    switch (t.mode) {
      case "project": {
        const E = t.projects.find((F) => F.id === t.selection.projectId);
      ...
      case "projectScrollGroup": {
        ...
        const F = `${E.shortName} · ${Mr(x)}`;
        return { node: F, title: F };
      }
      default:
        return { node: "", title: "" };
    }
  ...
  let O;
  t.isLoading ? O = /* @__PURE__ */ a(rc, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? O = void 0 : t.mode === "project-multi" ? O = /* @__PURE__ */ a(Wn, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : O = /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), G = P.title ? /* @__PURE__ */ a(St, { delayDuration: 400, children: /* @__PURE__ */ u(It, { children: [
          ...
          /* @__PURE__ */ u(je, { children: [
            ...
            k.map((E, x) => (
              ...
              /* @__PURE__ */ u(Lr, { children: [
                /* @__PURE__ */ a(be, { heading: Cu(E, p), children: E.rows.map((F) => /* @__PURE__ */ a(
                  xu,
                  {
                    row: F,
                    mode: t.mode,
...
const Eu = "16rem", Tu = "3rem", Ji = Yt.createContext(void 0);
function ba() {
  const t = Yt.useContext(Ji);
  if (!t)
...
function Su({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, h = Yt.useCallback(
    ...
    [r, w]
  ), p = Yt.useCallback(() => h((T) => !T), [h]), g = w ? "expanded" : "collapsed", v = _e() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: h,
...
function Dh({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    Z,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Nc, {}) : /* @__PURE__ */ a(Cc, {}),
    ...
    Iu,
    {
      ...
      children: /* @__PURE__ */ u(Du, { children: [
        /* @__PURE__ */ u(Tn, { children: [
          ...
          /* @__PURE__ */ a(In, { children: /* @__PURE__ */ a(zu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Ou, { children: /* @__PURE__ */ a(
            Pu,
            {
              onClick: () => d(g),
              isActive: p(g),
        ...
        /* @__PURE__ */ u(Tn, { children: [
          ...
          /* @__PURE__ */ a(In, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(ac, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  Nu,
                  {
                    mode: "project",
    ...
    /* @__PURE__ */ u(
      Su,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ru, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const He = "scrBook", Au = "scrRef", rr = "source", ju = "details", Lu = "Scripture Reference", Bu = "Scripture Book", Zi = "Type", Vu = "Details";
function Fu(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Rn = (t) => `${Gu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Hh({
  sources: t,
  ...
  J(() => {
    if (c) {
      const O = z.getSelectedRowModel().rowsById, q = Object.keys(O);
      if (q.length === 1) {
        const W = b.find((G) => Rn(G) === q[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, b, c, z]);
  const k = n ?? Bu, T = i ?? Zi, R = [
    ...
    !e && /* @__PURE__ */ u(
      fr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(br, { position: "item-aligned", children: /* @__PURE__ */ a(Ew, { children: R.map((O) => /* @__PURE__ */ a(le, { value: JSON.stringify(O.value), children: O.label }, O.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(vo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(bo, { children: z.getHeaderGroups().map((O) => /* @__PURE__ */ a(Ke, { children: O.headers.filter((q) => q.column.columnDef.header).map((q) => (
      ...
      /* @__PURE__ */ a(xo, { children: z.getRowModel().rows.map((O, q) => {
        const W = _e();
        return /* @__PURE__ */ a(
          Ke,
          {
            ...
            className: m(j(O, q)),
            onClick: (G) => I(O, G),
            children: O.getVisibleCells().map((G) => {
              if (!(G.getIsPlaceholder() || G.column.columnDef.enableGrouping && !G.getIsGrouped() && (G.column.columnDef.id !== rr || !r)))
                return /* @__PURE__ */ a(
                  ur,
                  {
                    className: m(
                    ...
                    children: G.getIsGrouped() ? /* @__PURE__ */ u(
                      Z,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          Sr(G.column.columnDef.cell, G.getContext()),
                          " (",
                          O.subRows.length,
                          ")"
                        ]
...
function Uu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], h = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [v, z] = N(!1), [k, T] = N(""), R = K(void 0), M = K(!1), I = $(
    () => Ln(t),
    [t]
  ), j = $(() => {
    if (!k.trim()) {
    ...
    x.preventDefault(), P(F, x.shiftKey);
  }, W = () => {
    r(I.map((x) => x));
  }, G = () => {
    r([]);
              ...
              Ae,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u(je, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(Et).filter((x) => j[x].length > 0).map((x, F) => {
                      const S = j[x];
                      return /* @__PURE__ */ u(Lr, { children: [
                        F > 0 && /* @__PURE__ */ a(yo, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          be,
                          {
                  ...
                  E.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: E.map(({ section: x, explanation: F }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: F }, x)) })
                ]
              }
            )
          }
...
function qh({
  ...
  const M = Mt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = Mt(s, "%webView_scope_selector_current_book%"), G = Mt(s, "%webView_scope_selector_choose_books%"), E = Mt(s, "%webView_scope_selector_scope%"), x = Mt(s, "%webView_scope_selector_select_books%"), F = Mt(s, "%webView_scope_selector_range%"), S = Mt(s, "%webView_scope_selector_select_range%"), C = Mt(s, "%webView_scope_selector_range_start%"), U = Mt(s, "%webView_scope_selector_range_end%"), ot = Mt(s, "%webView_scope_selector_ok%"), nt = Mt(s, "%webView_scope_selector_cancel%"), ut = Mt(s, "%webView_scope_selector_navigate%"), Bt = (V) => {
    if (!b) return;
  ...
  }, Vt = K(null), ae = K(null), zt = K(!1), Ft = K(null), gt = K(!1), [Xt, xt] = N(void 0), Nt = K(!1), At = K(!1), Jt = K(null), ue = B((V) => {
    if (V) {
    ...
    [r, n, b, i]
  ), Gt = ft.find((V) => V.value === t), yt = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? mc(vt, _t, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Gt ? ct(Gt.label, Gt.scrRefSuffix) : t, ce = ft.filter(
    (V) => V.value !== "selectedBooks" && V.value !== "range"
  ), Qt = ft.find((V) => V.value === "selectedBooks"), Ut = ft.find((V) => V.value === "range"), [pe, Ee] = N(!1), [D, H] = N(void 0), [X, y] = N(void 0), [Y, A] = N(void 0), [et, lt] = N(void 0), [pt, Ct] = N([]), Ot = w === "dropdown" && D === "selectedBooks", jt = /* @__PURE__ */ a(
    Yu,
    {
      availableBookInfo: o,
  ...
  ), oe = Xt === "end", Fr = Xt === "start", Ze = "tw:text-muted-foreground", Ge = w === "dropdown" && D === "range", Gr = Ge ? A : Fe, ya = Ge ? lt : f ? ne : ht, Ur = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Vt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-end", className: m(Fr && Ze), children: U }),
      /* @__PURE__ */ a(
        za,
        {
          id: "scope-range-end",
          ...
          localizedStrings: z,
          getEndVerse: k,
          disableReferencesUpTo: Ge ? Y ?? vt : vt,
          onOpenChange: Zt,
          onCloseAutoFocus: (V) => {
            var tt;
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          za,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var tt;
                              V.preventDefault(), (tt = Ft.current) == null || tt.focus();
                            },
                            modal: !0,
    ...
    w === "radio" && t === "range" && Ur,
    w === "dropdown" && Qt && /* @__PURE__ */ a(Ua, { open: D === "selectedBooks", onOpenChange: at, children: /* @__PURE__ */ a(
      Ha,
      {
        ref: _a,
        onCloseAutoFocus: te,
        ...
        children: /* @__PURE__ */ u(Sa, { container: tr, children: [
          /* @__PURE__ */ a(Ka, { className: "tw:pe-8", children: /* @__PURE__ */ a(qa, { children: G }) }),
          jt,
    ...
    w === "dropdown" && Ut && /* @__PURE__ */ a(Ua, { open: D === "range", onOpenChange: at, children: /* @__PURE__ */ a(
      Ha,
      {
        ref: ka,
        onCloseAutoFocus: te,
...
const ts = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Rt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(Es, { children: /* @__PURE__ */ a(Ts, { children: ts(
      t,
      e,
      Qi(t, c.id),
      o
...
function po({
  ...
  return /* @__PURE__ */ u(Le, { variant: i, children: [
    /* @__PURE__ */ a(Be, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(oc, {}) }) }),
    /* @__PURE__ */ a(Ve, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Lr, { children: [
      /* @__PURE__ */ a(Pn, { children: /* @__PURE__ */ a(St, { children: ts(e.groups, e.items, l, t) }) }),
...
const Qu = Object.freeze([520, 420, 340]), rs = Yt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = es(n, Qu), d = vi() ?? l, w = d >= Ir.MINIMUM;
...
function Zh({
  ...
  return /* @__PURE__ */ u(rs, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      po,
      {
        onSelectMenuItem: t,
...
const as = Yt.forwardRef(({ className: t, ...e }, r) => {
  const o = _e();
  return /* @__PURE__ */ a(
    we.Root,
    {
...
as.displayName = we.List.displayName;
const os = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.List,
  {
    ref: r,
    className: m(
...
const tp = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Trigger,
  {
    ref: r,
    ...e,
...
)), ns = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Content,
  {
    ref: r,
    className: m(
...
ns.displayName = we.Content.displayName;
function tg({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(as, { children: [
      /* @__PURE__ */ a(os, { children: t.map((c) => /* @__PURE__ */ a(tp, { value: c.value, children: c.value }, c.key)) }),
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(It, { children: [
      /* @__PURE__ */ a(Rt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(lp, { children: d.label }),
        /* @__PURE__ */ a(dp, { children: is(
          t,
          e,
          Qi(t, d.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(sp, {}, `separator-${i}`)), l;
  });
};
function wp({
  menuData: t,
  ...
  if (Pl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, h) => {
    var f, b, v, z;
    w.preventDefault();
    ...
    switch (h.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), Er(l, [p, g]);
        break;
    }
  }), J(() => {
    ...
    return /* @__PURE__ */ a(ep, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, h]) => typeof w == "boolean" || typeof h == "boolean" ? 0 : w.order - h.order).map(([w, h]) => /* @__PURE__ */ u(rp, { children: [
      /* @__PURE__ */ a(op, { ref: d(w), children: typeof h == "object" && "label" in h && h.label }),
      /* @__PURE__ */ a(
        np,
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(St, { children: is(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const up = Object.freeze([950, 800, 700]);
function eg(t) {
  switch (t) {
    case void 0:
      return;
...
function ag({
  ...
  const d = pp(
    ...
    var z, k, T, R, M, I;
    const v = b !== f ? ((k = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : k[b]) ?? ((R = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : R.en) : void 0;
...
function ng({
  ...
  return /* @__PURE__ */ u(Ae, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(Is, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(Rs, { children: /* @__PURE__ */ a(Ec, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(je, { children: [
...
function sg({
  ...
  const c = t ? Ho(r, { key: o }).join("") : "", {
    ...
    showArrow: h
  } = mp(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
...
function Lg({
  ...
  return /* @__PURE__ */ a(
    we.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", xp({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Kg(t) {
  const e = $(() => vc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const _p = () => {
  const [t, e] = N(
...
function Wg({ value: t, children: e }) {
...
export {
  ...
  ah as COMMENT_LIST_STRING_KEYS,
  ...
  wg as ContextMenu,
  yg as ContextMenuCheckboxItem,
  mg as ContextMenuContent,
  pg as ContextMenuGroup,
  vg as ContextMenuItem,
  _g as ContextMenuLabel,
  hg as ContextMenuPortal,
  fg as ContextMenuRadioGroup,
  kg as ContextMenuRadioItem,
  Ng as ContextMenuSeparator,
  Cg as ContextMenuShortcut,
  gg as ContextMenuSub,
  xg as ContextMenuSubContent,
  bg as ContextMenuSubTrigger,
  ug as ContextMenuTrigger,
  Rw as DataTable,
  ...
  hh as ERROR_POPOVER_STRING_KEYS,
  ...
  zw as ErrorDump,
  gh as ErrorPopover,
  yh as FOOTNOTE_EDITOR_STRING_KEYS,
  bh as Filter,
  fh as FilterDropdown,
  vh as Footer,
  xh as FootnoteEditor,
  tu as FootnoteItem,
  kh as FootnoteList,
