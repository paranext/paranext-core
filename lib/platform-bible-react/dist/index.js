...
import p, { forwardRef as Qt, createContext as sr, useContext as ir, useCallback as U, useState as A, useRef as q, useEffect as it, useLayoutEffect as Qe, useMemo as et, Fragment as ln } from "react";
...
import { ChevronRight as De, Check as Ct, Circle as Ve, X as Me, Search as dn, ChevronsUpDown as ze, FilterIcon as cr, ChevronDown as te, ChevronUp as pr, ArrowLeftIcon as ur, ChevronLeftIcon as mr, ChevronRightIcon as hr, ArrowRightIcon as gr, LoaderCircle as fr, Download as br, Filter as vr, User as xr, Link as yr, CircleHelp as Nr, Star as kr, CircleCheckIcon as Cr, CircleXIcon as _r, CircleHelpIcon as Sr, ArrowUpIcon as Tr, ArrowDownIcon as Rr, ArrowUpDownIcon as Er, PanelLeft as Dr, PanelRight as Vr, ScrollText as Mr, ChevronLeft as zr, MenuIcon as Or, Menu as Br, EllipsisVertical as Ir } from "lucide-react";
import { formatScrRef as St, MODIFIER_KEYS as Pr, getChaptersForBook as Ar, NumberFormat as jr, formatBytes as Xr, deepEqual as Oe, isString as ge, compareScrRefs as ke, scrRefToBBBCCCVVV as fe, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
import { useReactTable as pn, getFilteredRowModel as Fr, getSortedRowModel as un, getPaginationRowModel as Gr, getCoreRowModel as mn, flexRender as Ft, getGroupedRowModel as $r, getExpandedRowModel as Lr } from "@tanstack/react-table";
...
const Ie = j.Trigger, fn = j.Group, Wr = j.Portal, Zr = j.Sub, _s = j.RadioGroup;
...
const Ht = p.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = H();
...
const Ae = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    j.CheckboxItem,
    {
...
const re = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
...
var ta = Object.defineProperty, ea = (t, e, n) => e in t ? ta(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => ea(t, typeof e != "symbol" ? e + "" : e, n);
const yt = [
  "GEN",
  "EXO",
  "LEV",
...
const ma = 6, Ge = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ha = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, nn = ["OT", "NT", "DC"], ga = 96, fa = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), ba = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', At = (t) => Ar(M.bookIdToNumber(t));
function va() {
...
function Ts({
  ...
  const o = H(), [s, i] = A(
    () => St(t, "English")
  ), [w, c] = A(""), [u, g] = A(t.book), [v, f] = A(t.chapterNum ?? 0), [m, N] = A(t.book), [T, y] = A(!1), [x, _] = A(T), S = q(void 0), z = q(void 0), $ = q(void 0), ft = U(
    (h) => {
      const V = a ? a() : Ge;
      return {
    ...
    fa.forEach((h) => {
      const V = h.exec(w);
      if (V) {
        const [C, O = void 0, K = void 0] = V.slice(1), L = ya(C);
    ...
    (h, V) => {
      ...
      if (rn.has(C)) {
        if (m === u) {
          ...
          else C === "ArrowDown" ? L = ma : C === "ArrowUp" && (L = -6);
          if (v + L <= 0 || v + L > At(m))
            f(0);
          else if (L !== 0) {
      ...
      Ht,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: nn.map((h, V) => {
          ...
          return C.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(re, { className: "tw-font-semibold tw-text-foreground/80", children: ha[h] }),
...
const Na = gt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Vt : "button", { className: l(Na({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const ka = gt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(cn.Root, { ref: n, className: l("pr-twp", ka(), t), ...e }));
...
const Le = $t.Root, Ye = $t.Trigger, ae = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = H();
...
const Ca = wt.Portal, Tn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
    className: l(
...
const _a = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = H();
...
_a.displayName = wt.Content.displayName;
...
Sa.displayName = wt.Title.displayName;
...
Ta.displayName = wt.Description.displayName;
...
const we = p.forwardRef((t, e) => /* @__PURE__ */ r(Z.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
function Es({
  ...
  const g = be(u, "%webView_bookSelector_currentBook%"), v = be(u, "%webView_bookSelector_choose%"), f = be(u, "%webView_bookSelector_chooseBooks%"), [m, N] = A(
    "current book"
    /* CURRENT_BOOK */
  ), T = (y) => {
    N(y), t(y);
...
function Va({ table: t }) {
  return /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(dr, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Tt = G.Root, Ma = G.Group, Rt = G.Value, za = gt(
  ...
  return /* @__PURE__ */ d(
    G.Trigger,
    {
      className: l(za({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
Oa.displayName = G.Label.displayName;
...
Ba.displayName = G.Separator.displayName;
function Ia({ table: t }) {
...
const de = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const pe = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function ja({
  ...
  var y;
  const [w, c] = A([]), [u, g] = A([]), [v, f] = A({}), [m, N] = A({}), T = pn({
    data: e,
    columns: t,
    getCoreRowModel: mn(),
...
const qt = Qt(({ className: t, ...e }, n) => /* @__PURE__ */ r(fr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      children: t ? /* @__PURE__ */ r(qt, { size: 15 }) : /* @__PURE__ */ d(Dt, { children: [
        /* @__PURE__ */ r(br, { size: 25, className: l("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function Vs({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function zs({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function Os({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Yr, { options: o, children: e }) });
}
const Xa = Qt((t, e) => /* @__PURE__ */ d(
  I,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ r(vr, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ r(
        te,
        {
...
function Bs({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(Ie, { asChild: !0, children: /* @__PURE__ */ r(Xa, {}) }),
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ r(xr, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
...
const $a = gt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", $a({ variant: e }), t), ...n })
);
...
), Ha = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  hn.Root,
  {
    ref: o,
...
const ue = (t) => t === "asc" ? /* @__PURE__ */ r(Tr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Er, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Xs = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, qa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Hs = Object.freeze([
...
function Us({
  ...
  const u = pt(n, "%webView_inventory_all%"), g = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), f = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = A(!1), [S, z] = A("all"), [$, ft] = A(""), [lt, k] = A([]), b = et(() => t.length === 0 ? [] : Ka(t, o, s), [t, o, s]), F = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
...
const Je = Yt.Provider, Ke = Yt.Root, We = Yt.Trigger, me = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Yt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Wa = "16rem", Za = "3rem", On = p.createContext(void 0);
function he() {
...
const In = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = he();
...
const Qa = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    I,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(Dr, {}) : /* @__PURE__ */ r(Vr, {}),
...
const so = gt(
  ...
  ({
    ...
    const c = t ? Vt : "button", { state: u } = he(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: l(so({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(me, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : g;
  }
);
...
const ut = "scrBook", ho = "scrRef", xt = "source", go = "details", fo = "Scripture Reference", bo = "Scripture Book", $n = "Type", vo = "Details";
function xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
function Js({
  ...
  const [c, u] = A([]), [g, v] = A([{ id: ut, desc: !1 }]), [f, m] = A({}), N = et(
    ...
    !e && /* @__PURE__ */ d(
      Tt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(kt, { position: "item-aligned", children: /* @__PURE__ */ r(Ma, { children: S.map((k) => /* @__PURE__ */ r(rt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (F === "ltr" ? /* @__PURE__ */ r(De, {}) : /* @__PURE__ */ r(zr, {})),
                          " ",
...
const Hn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(We, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Wr, { children: /* @__PURE__ */ r(vn, { children: Hn(
      t,
      e,
      Yn(t, w.id),
      a
...
function wn({
  ...
  return /* @__PURE__ */ d(ne, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(I, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Or, {}) }) }),
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ d(ln, { children: [
...
function ri({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Un, { children: [
      /* @__PURE__ */ r(qn, { children: t.map((i) => /* @__PURE__ */ r(To, { value: i.value, children: i.value }, i.key)) }),
...
const Do = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    X.CheckboxItem,
    {
...
Do.displayName = X.CheckboxItem.displayName;
const Vo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ot();
  return /* @__PURE__ */ d(
    X.RadioItem,
    {
...
Vo.displayName = X.RadioItem.displayName;
const Mo = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Mo.displayName = X.Label.displayName;
...
const jt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, g) => u.order - g.order).map((u) => /* @__PURE__ */ d(Ke, { children: [
      /* @__PURE__ */ r(We, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        er,
        {
          onClick: () => {
            a(u);
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ r(Zt, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }),
            u.label,
            u.iconPathAfter && /* @__PURE__ */ r(Zt, { icon: u.iconPathAfter, menuLabel: u.label })
          ]
        },
      ...
      u.tooltip && /* @__PURE__ */ r(me, { children: u.tooltip })
...
function zo({
  ...
  if (Hr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    var N, T, y, x;
    g.preventDefault();
    ...
    return /* @__PURE__ */ r(Kn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ d(Ro, { children: [
      /* @__PURE__ */ r(Wn, { ref: u(g), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        tr,
        {
          className: "tw-z-[250]",
...
), Po = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(Io({ variant: e }), t), ...n }));
...
const jo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
jo.displayName = "AlertDescription";
...
Xo.displayName = Mt.Root.displayName;
...
Fo.displayName = Mt.Image.displayName;
...
Go.displayName = Mt.Fallback.displayName;
...
const Ho = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const li = at.Trigger, Ko = at.Portal, di = at.Close, or = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
const Wo = p.forwardRef(({ className: t, children: e, ...n }, a) => {
...
ts.displayName = at.Title.displayName;
...
es.displayName = at.Description.displayName;
function ci({ ...t }) {
  return /* @__PURE__ */ r(
    Ur,
    {
...
rs.displayName = _e.Root.displayName;
const pi = Q.Root, as = p.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
export {
  ...
  Ks as SCOPE_SELECTOR_STRING_KEYS,
  Ws as ScopeSelector,
  Js as ScriptureResultsViewer,
  ...
  qs as SettingsSidebarContentSearch,
  ns as Slider,
  ci as Sonner,
  qt as Spinner,
  rs as Switch,
