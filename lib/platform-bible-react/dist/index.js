...
Yt.displayName = Tt.Group.displayName;
...
const Wt = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Item,
  {
    ref: n,
    className: h(
...
Wt.displayName = Tt.Item.displayName;
...
const de = $e.Root, ge = $e.Trigger, Al = $e.Anchor, Jt = v.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = mt();
...
Jt.displayName = $e.Content.displayName;
function wr(t, e, n) {
...
function Pl({
  ...
  return /* @__PURE__ */ p(de, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Jt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r(we, { children: /* @__PURE__ */ r(Yt, { heading: i, children: t.map((u) => /* @__PURE__ */ p(
      Wt,
      {
        onSelect: () => f(u),
...
function Vl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const w = e[c - 1], d = Math.max(qt(w), 1);
        o({
          book: w,
          chapterNum: d,
          verseNum: 1
...
function Wp({
  ...
  return Pt(() => {
    ...
    /* @__PURE__ */ r(Jt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      ce,
      {
        ref: F,
        onKeyDown: ee,
        ...
        children: [
          ...
          !k && /* @__PURE__ */ p(we, { ref: R, children: [
            b === "books" && /* @__PURE__ */ p(lt, { children: [
              !O && Object.entries(X).map(([M, E]) => {
                if (E.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Yt, { heading: Qt(M), children: E.map((V) => /* @__PURE__ */ r(
                      wa,
                      {
                        bookId: V,
                        onSelect: (U) => Dt(U),
              ...
              O && qt(O.book) > 1 && /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      Jt,
      {
        ...
        children: /* @__PURE__ */ p(ce, { children: [
          ...
          /* @__PURE__ */ r(we, { children: F(e) ? e.map((R) => /* @__PURE__ */ r(Yt, { heading: R.groupHeading, children: R.options.map((C) => A(C, R.groupHeading)) }, R.groupHeading)) : e.map((R) => A(R)) })
        ] })
      }
    )
  ] });
...
function Ql() {
  return function(t) {
    const [e] = Zt(), n = B(() => t(e), [e, t]), [o, a] = D(() => n.initialValueFn()), i = H(o);
    return Jl(() => {
...
function ic(t, e = ac) {
  ...
  function w(d) {
    d.read(() => {
      const m = Rt();
      if (!Ht(m)) return n = null, a = null, i = null, l = null, c(), void (c = () => {
      });
...
$t({ name: "@lexical/extension/DecoratorText", nodes: () => [xa], register: (t, e, n) => t.registerCommand(Ko, (o) => {
  const a = Rt();
  if (Go(a) || Ht(a)) for (const i of a.getNodes()) bc(i) && i.toggleFormat(o);
  return !1;
}, Uo) });
function ya(t, e) {
  let n;
...
$t({ dependencies: [mr, uo], name: "@lexical/extension/HorizontalRule", nodes: () => [Le], register(t, e, n) {
  ...
  return se(t.registerCommand(Ec, (s) => {
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) s.push(Xt(() => {
      const w = l.value;
...
$t({ build: (t, e, n) => Xe(e), config: Se({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Xt(() => n.getOutput().disabled.value ? void 0 : Ra(t)) });
function Ac(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
function Wc({
  ...
  const [e] = Zt(), [n, o] = D(e), [a, i] = D("paragraph"), [s, l] = Xc(), c = () => {
  };
...
function yw({
  ...
  const [A, R] = D(bo), [C, S] = D(
    void 0
  ), j = o, [$, I] = D(!1), [P, X] = D(!1), [O, J] = D(!1), [Dt, Lt] = D(!1), [It, gt] = D(!1), [pt, G] = D(k), [at, it] = D(!1), ct = H(void 0), [xt, Qt] = D(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const te = B(() => Kt[0], [Kt]), De = H(null), ue = H(void 0), ee = K(() => {
    var T;
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(
            go,
            {
              ...
              handleDeleteComment: u,
              onEditingChange: X,
              canEditOrDelete: (!P && xt.get(te.id)) ?? !1,
...
function iu({
  ...
  return /* @__PURE__ */ p(de, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Jt, { id: i, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function jw({
  ...
  return /* @__PURE__ */ r("div", { id: b, className: g, children: /* @__PURE__ */ p(de, { open: R, onOpenChange: d ?? N, children: [
    ...
    /* @__PURE__ */ r(Jt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ce, { children: [
      ...
      /* @__PURE__ */ p(we, { children: [
        ...
        /* @__PURE__ */ r(Yt, { children: L.map((S) => /* @__PURE__ */ p(
          Wt,
          {
            value: S.label,
            onSelect: _,
...
function du({
  ...
  const Qt = H({ book: a.book, chapterNum: a.chapterNum });
  Pt(() => {
    (Qt.current.book !== a.book || Qt.current.chapterNum !== a.chapterNum) && (Qt.current = { book: a.book, chapterNum: a.chapterNum }, xt.current());
  }, [a.book, a.chapterNum]);
  const Kt = () => {
    var V;
...
function yu({
  ...
  const u = Gt(n, "%webView_inventory_all%"), g = Gt(n, "%webView_inventory_approved%"), x = Gt(n, "%webView_inventory_unapproved%"), b = Gt(n, "%webView_inventory_unknown%"), y = Gt(n, "%webView_inventory_scope_currentBook%"), N = Gt(n, "%webView_inventory_scope_chapter%"), _ = Gt(n, "%webView_inventory_scope_verse%"), k = Gt(n, "%webView_inventory_filter_text%"), L = Gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), F = Gt(n, "%webView_inventory_no_results%"), [A, R] = D(!1), [C, S] = D("all"), [j, $] = D(""), [I, P] = D([]), X = B(() => {
    const G = t ?? [];
    ...
    /* @__PURE__ */ p(
      de,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Jt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            ce,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
