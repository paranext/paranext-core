...
var yt = (t, e, n) => ps(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as ct } from "react/jsx-runtime";
import b, { forwardRef as an, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as It, createContext as Cn, useContext as hr, useEffect as Y, Component as us, createElement as Lr, Suspense as ms, Fragment as mo } from "react";
import { Command as Ct } from "cmdk";
import { X as je, Search as fo, Check as jt, Clock as Vr, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as Wn, ChevronRight as Oe, ArrowLeft as fs, ArrowRight as hs, Circle as En, ChevronDown as ze, BoldIcon as gs, ItalicIcon as bs, AtSign as ho, Pencil as vs, Trash2 as xs, ArrowUp as go, MoreHorizontal as ys, MailOpen as Ns, Mail as ks, ChevronUp as bo, FilterIcon as _s, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ts, ArrowRightIcon as Rs, Copy as vo, Filter as Ss, User as Ds, Link as Ms, CircleHelp as Os, ChevronsUpDown as xo, Star as Is, Undo as As, Redo as Ps, SquareX as yo, FunctionSquare as No, SquareSigma as ko, Ban as $s, AlertCircle as Jn, CircleCheckIcon as Ls, CircleXIcon as Vs, CircleHelpIcon as js, ArrowUpIcon as zs, ArrowDownIcon as Fs, PanelLeft as Bs, PanelRight as Ks, ScrollText as Gs, MenuIcon as Us, Menu as qs, EllipsisVertical as Hs, MoreVertical as Fr, LoaderCircle as Ys, GripVertical as Xs } from "lucide-react";
...
import { includes as cn, Section as X, getChaptersForBook as Zs, formatScrRef as xe, getSectionForBook as We, formatRelativeDate as Qs, formatReplacementString as ve, sanitizeHtml as ti, NumberFormat as ei, formatBytes as ni, getCurrentLocale as ri, usfmMarkers as fn, getFormatCallerFunction as oi, deepEqual as ai, isString as Br, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as Co, $getRoot as ce, $createParagraphNode as Tn, $getSelection as Vt, HISTORY_MERGE_TAG as gr, ParagraphNode as Eo, TextNode as To, $isTokenOrSegmented as si, $getCharacterOffsets as ii, $cloneWithPropertiesEphemeral as li, $findMatchingParent as Ro, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as So, COMMAND_PRIORITY_EDITOR as Do, mergeRegister as de, shallowMergeConfig as wi, defineExtension as Ut, safeCast as sn, createState as ci, FORMAT_TEXT_COMMAND as Mo, $isNodeSelection as Oo, COMMAND_PRIORITY_LOW as Io, RootNode as di, LineBreakNode as pi, TabNode as ui, $isEditorState as mi, createCommand as fi, CLICK_COMMAND as hi, isDOMNode as gi, $getNodeFromDOMNode as bi, $createNodeSelection as vi, $setSelection as xi, DecoratorNode as Qn, $getState as yi, toggleTextFormatType as Kr, TEXT_TYPE_TO_FORMAT as Ni, $setState as ki, addClassNamesToElement as Ao, $create as _i, $getNodeByKey as Ci, removeClassNamesFromElement as Ei, KEY_TAB_COMMAND as Ti, $isBlockElementNode as bn, $createRangeSelection as Ri, $normalizeSelection__EXPERIMENTAL as Si, OUTDENT_CONTENT_COMMAND as Di, INDENT_CONTENT_COMMAND as Gr, INSERT_TAB_COMMAND as Mi, COMMAND_PRIORITY_CRITICAL as br, $isDecoratorNode as Oi, $isParagraphNode as Ii, $isTextNode as vn, SELECTION_CHANGE_COMMAND as Po, getRegisteredNode as Ai, isHTMLElement as Pi, isDocumentFragment as Ur, isDOMDocumentNode as $i, ArtificialNode__DO_NOT_USE as $o, $createLineBreakNode as Lo, $isRootOrShadowRoot as Li, isBlockDomNode as qr, isInlineDomNode as Hr, $insertNodes as Vi } from "lexical";
import * as _e from "@radix-ui/react-tooltip";
import { TooltipTrigger as ji } from "@radix-ui/react-tooltip";
import { HeadingNode as zi, QuoteNode as Fi, registerRichText as Bi } from "@lexical/rich-text";
import { flushSync as Ki, createPortal as Gi } from "react-dom";
...
import { useReactTable as Fo, getFilteredRowModel as Hi, getSortedRowModel as Bo, getPaginationRowModel as Yi, getCoreRowModel as Ko, flexRender as Je, getGroupedRowModel as Xi, getExpandedRowModel as Wi } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import Ji from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as tr, HIDDEN_NOTE_CALLER as er, getDefaultViewOptions as Zi, isInsertEmbedOpOfType as dn, Editorial as Qi } from "@eten-tech-foundation/platform-editor";
...
const ol = Lt.Root, al = Lt.Portal, Go = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
    className: h(
...
sl.displayName = Lt.Description.displayName;
...
Yo.displayName = Ct.Separator.displayName;
...
const Jo = ut.allBookIds.filter(
  (t) => !ut.isObsolete(ut.bookIdToNumber(t))
), ye = Object.fromEntries(
  Jo.map((t) => [t, ut.bookIdToEnglishName(t)])
);
function yr(t, e, n) {
...
const Zo = an(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Fe : "button", { className: h(Qo({ variant: e, size: n, className: t })), ref: i, ...a })
);
z.displayName = "Button";
const oe = Ie.Root, fe = Ie.Trigger, ll = Ie.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ht();
...
function ar(t, e, n) {
  return `${t} ${ye[t]}${e ? ` ${xr(t, e)} ${Me(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function wl({
  recentSearches: t,
...
function pp(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function Xr({
  ...
  if (t)
    return /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Gt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      qt,
      {
        value: `${t} ${ye[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function up({
  ...
  const w = ht(), [d, m] = S(!1), [f, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: L } = Yr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const U = v === "chapters" ? N : O == null ? void 0 : O.book;
        if (!U) return;
        const q = (() => {
          if (!f) return 1;
          const wt = f.match(/(\d+)$/);
  ...
  return It(() => {
  ...
  }, [v, N, O, t.book, t.chapterNum]), /* @__PURE__ */ p(oe, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
    ...
    /* @__PURE__ */ r(Ht, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      ne,
      {
        ref: j,
        onKeyDown: Jt,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(fs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(hs, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !C && /* @__PURE__ */ p(re, { ref: $, children: [
            v === "books" && /* @__PURE__ */ p(ct, { children: [
              !O && Object.entries(W).map(([M, _]) => {
                if (_.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(te, { heading: Xt(M), children: _.map((L) => /* @__PURE__ */ r(
                      Zo,
                      {
                        bookId: L,
                        onSelect: (U) => Tt(U),
              ...
              O && /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(
                qt,
                {
                  ...
                  children: xe(
                    ...
                    a ? xr(O.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              O && Gt(O.book) > 1 && /* @__PURE__ */ p(ct, { children: [
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(_o.Root, { ref: n, className: h("pr-twp", ul(), t), ...e }));
...
function sr({
  ...
  const [N, k] = S(!1), C = c ?? l, F = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], j = (R, $) => {
  ...
  return /* @__PURE__ */ p(oe, { open: N, onOpenChange: k, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: F(e) ? e.map((R) => /* @__PURE__ */ r(te, { heading: R.groupHeading, children: R.options.map(($) => j($, R.groupHeading)) }, R.groupHeading)) : e.map((R) => j(R)) })
        ] })
      }
    )
  ] });
...
function hp({
  ...
  const d = Vn(w, "%webView_bookSelector_currentBook%"), m = Vn(w, "%webView_bookSelector_choose%"), f = Vn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, gl = ea ? It : Y, pn = { tag: gr };
function bl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = hl(null, o), d = Co({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (m) => s(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
...
const vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function xl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Yt();
  return vl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(gr) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const kr = {
  ...
  {
    ref: o,
    className: e ? h(Qo({ variant: e }), t) : t,
    ...n
  }
));
...
class Nl extends us {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && kl(e.resetKeys, a)) {
      var i, s;
...
function _l({ children: t, onError: e }) {
  return r(Nl, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Cl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function El(t) {
...
function Rl(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !si(e) && o !== null) {
    const [a, i] = o, s = t.isBackward(), l = a.getNode(), c = i.getNode(), w = e.is(l), d = e.is(c);
    if (w || d) {
      const [m, f] = ii(t), u = l.is(c), g = e.is(s ? c : l), x = e.is(s ? l : c);
      let v, y = 0;
      u ? (y = m > f ? f : m, v = m > f ? m : f) : g ? (y = s ? f : m, v = void 0) : x && (y = 0, v = s ? m : f);
      const N = e.__text.slice(y, v);
      N !== e.__text && (n === "clone" && (e = li(e)), e.__text = N);
    }
  }
  return e;
}
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = na && "documentMode" in document ? document.documentMode : null;
!(!na || !("InputEvent" in window) || Dl) && "getTargetRanges" in new window.InputEvent("input");
function Ml(t) {
  const e = Ro(t, (n) => le(n) && !n.isInline());
  return le(e) || Sl(4, t.__key), e;
}
function Ol(t) {
  const e = Vt();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Ro(i, (w) => le(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const Il = Symbol.for("preact-signals");
function Sn() {
...
Nt.prototype.brand = Il, Nt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, aa(this), Zr(this), we++;
  const t = Z;
  return Z = this, $l.bind(this, t);
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ $onClear: sa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  ...
  return pe(() => ia(t, o.value));
} });
function Ll(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const zn = ci("format", { parse: (t) => typeof t == "number" ? t : 0 });
class la extends Qn {
  $config() {
...
Ut({ name: "@lexical/extension/DecoratorText", nodes: () => [la], register: (t, e, n) => t.registerCommand(Mo, (o) => {
  const a = Vt();
  if (Oo(a) || ke(a)) for (const i of a.getNodes()) Vl(i) && i.toggleFormat(o);
  return !1;
}, Io) });
function wa(t, e) {
  let n;
...
const Er = 0, cr = 1, da = 2, Fn = 3, un = 4, Se = 5, Bn = 6, He = 7;
function Kn(t) {
  return t.id === Er;
}
function pa(t) {
...
function jl(t) {
  return function(e) {
    return e.id === cr;
  }(t) || et(305, String(t.id), String(cr)), Object.assign(t, { id: da });
}
...
const Kl = Ut({ config: sn({ setOptions: Qr, updateOptions: Qr }), init: ({ $initialEditorState: t = Bl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (mi(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [di, To, pi, ui, Eo] }), to = Symbol.for("@lexical/extension/LexicalBuilder");
function eo() {
}
function Gl(t) {
  throw t;
...
class Qe {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && et(298, o.name), !a) {
      a = new Fl(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Kn(i) || et(300, s, a || "[unknown]"), Kn(l = i) || et(304, String(l.id), String(Er)), i = Object.assign(l, { id: cr }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of Ll(m)) {
    ...
    return e.onError || (e.onError = Gl), e;
  }
}
const Ul = /* @__PURE__ */ new Set(), no = Ut({ build(t, e, n) {
...
Ut({ dependencies: [wr, no], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(no).output, a = nn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return de(t.registerCommand(hi, (s) => {
    if (gi(s.target)) {
      const l = bi(s.target);
      if (Hl(l)) return function(c, w = !1) {
        const d = Vt(), m = c.isSelected(), f = c.getKey();
        let u;
        w && Oo(d) ? u = d : (u = vi(), xi(u)), m ? u.delete(f) : u.add(f);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Io), t.registerMutationListener(Ae, (s, l) => {
    Al(() => {
      let c = !1;
      ...
      for (const [d, m] of s.entries()) if (m === "destroyed") w.delete(d), c = !0;
        ...
        f ? f.domNode.value = u : (c = !0, w.set(d, { domNode: nn(u), selectedSignal: o(d) }));
      }
...
function Yl(t, e, n = ma) {
  return de(t.registerCommand(Ti, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((f) => bn(f) && f.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), m = Ml(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ri();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Si(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Di : Gr : Mi;
    return t.dispatchCommand(i, void 0);
  }, Do), t.registerCommand(Gr, () => {
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ma, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  ...
  return pe(() => {
    if (!o.value) return Yl(t, a, i);
  });
} });
const Xl = Ut({ name: "@lexical/react/ReactProvider" });
function Wl() {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (vn(v) && w >= 0 && d >= 0 && (y = w, N = w + d, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), vn(v)) {
                  y = f, N = f + u;
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : ha(t)) });
function Ql(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Tr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
...
function ew({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Xl.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && Ql(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(tw, { editor: t, ErrorBoundary: e });
}
function ro(t) {
  return t.getEditorState().read(fa(t.isComposing()));
}
function nw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Yt();
  return function(a) {
    Tr(() => de(Bi(a), ha(a)), [a]);
  }(o), p(ct, { children: [t, r(rw, { content: e }), r(ew, { editor: o, ErrorBoundary: n })] });
}
...
function ow({ defaultSelection: t }) {
  const [e] = Yt();
  return Y(() => {
    e.focus(() => {
...
const aw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function sw({ onClear: t }) {
  const [e] = Yt();
  return aw(() => ia(e, t), [e, t]), null;
}
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function iw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...F }, j) {
  ...
  return ga(() => ($(t.isEditable()), t.registerEditableListener((V) => {
    $(V);
  })), [t]), r("div", { "aria-activedescendant": R ? e : void 0, "aria-autocomplete": R ? n : "none", "aria-controls": R ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": R && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": d, "aria-owns": R ? m : void 0, "aria-readonly": !R || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: R, "data-testid": C, id: x, ref: D, role: v, spellCheck: y, style: N, tabIndex: k, ...F });
}
const lw = an(iw);
function oo(t) {
  return t.getEditorState().read(fa(t.isComposing()));
...
function cw(t, e) {
  ...
  return p(ct, { children: [r(lw, { editor: a, ...o, ref: e }), n != null && r(dw, { editor: a, content: n })] });
}
function dw({ content: t, editor: e }) {
  const n = function(s) {
    ...
    return ga(() => {
      ...
      return w(), de(s.registerUpdateListener(() => {
        w();
...
function mw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Uo, { children: [
...
function fw({
  ...
  const [e] = Yt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = mw(), c = () => {
  };
...
), gw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Vo.Root,
  {
    ref: a,
    className: h(xa({ variant: e, size: n, className: t })),
    ...o
  }
));
gw.displayName = Vo.Root.displayName;
...
function bw() {
  const { activeEditor: t } = va(), [e, n] = S([]), o = K((a) => {
    if (ke(a) || Ui(a)) {
      const i = [];
      ao.forEach(({ format: s }) => {
...
function xw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(fw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(bw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        nw,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ r(pw, { placeholder: t }) }),
          ErrorBoundary: _l
        }
      ),
      e && /* @__PURE__ */ r(ow, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(vw, { onClear: n }),
      /* @__PURE__ */ r(sw, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          bl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(xw, { placeholder: a, autoFocus: i, onClear: s }),
              /* @__PURE__ */ r(
                xl,
                {
...
function Nw(t, e) {
  const n = $i(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
...
function Na(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && vn(e) && (s = Rl(o, e, "clone"));
  const l = le(s) ? s.getChildren() : [], c = Ai(t, s.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Na(t, g, f, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Pi(d) || Ur(d)) && d.append(f), n.append(d), m) {
      const u = m.call(s, d);
      u && (Ur(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
...
function _a(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  let f = [];
  const u = (l == null || !Li(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < m.length; g++) f.push(..._a(m[g], e, n, u, new Map(a), l));
  return d != null && (f = d(f)), qr(t) && (f = _w(t, f, u ? () => {
    const g = new $o();
    return n.push(g), g;
  } : Tn)), l == null ? f.length > 0 ? s = s.concat(f) : qr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Hr(g.nextSibling) && Hr(g.previousSibling);
  }(t) && (s = s.concat(Lo())) : le(l) && l.append(...f), s;
}
function _w(t, e, n) {
...
function Cw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), i = Nw(e, a);
      ce().clear(), Vi(i);
    },
    {
      discrete: !0
...
function gp({
  ...
  const [a, i] = S(Ew), [s, l] = S(void 0), [c, w] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Dr(y) && (y.preventDefault(), y.stopPropagation(), $t(a) && f());
        },
        onKeyDown: (y) => {
...
], Tw = ["input", "select", "textarea", "button"], Rw = ["button", "textbox"], Sw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = H(null), [i, s] = S(void 0), [l, c] = S(void 0), w = K(
    (u) => {
      s(u);
    ...
    if (u.isContentEditable || Tw.includes(g)) return !0;
    const x = u.getAttribute("role");
    if (x && Rw.includes(x)) return !0;
...
const Iw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Iw.displayName = "CardDescription";
...
$e.displayName = zo.Root.displayName;
...
Sa.displayName = Be.Root.displayName;
...
Pw.displayName = Be.Image.displayName;
...
Da.displayName = Be.Fallback.displayName;
const Mr = Cn(void 0);
function Ft() {
  const t = hr(Mr);
  if (!t)
...
}), Ce = nt.Trigger, Ma = nt.Group, $w = nt.Portal, Lw = nt.Sub, Vw = nt.RadioGroup;
function ue({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Mr.Provider, { value: n, children: /* @__PURE__ */ r(nt.Root, { ...e }) });
}
...
Oa.displayName = nt.SubTrigger.displayName;
...
Ia.displayName = nt.SubContent.displayName;
...
Aa.displayName = nt.RadioItem.displayName;
...
function so({
  ...
  const u = K(
    (C) => {
      C && C.stopPropagation(), w(!1), m(void 0), s == null || s(!1);
    },
    [s]
  ), g = K(
    async (C) => {
    ...
    [t.user]
  ), N = B(() => ti(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(ct, { children: [
        /* @__PURE__ */ p(
          kn,
          {
            onClick: (C) => {
              C.stopPropagation(), w(!0), m(Cw(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Dr(C) && (C.preventDefault(), C.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ys, {}) }) }),
...
function zw({
  ...
  const [R, $] = S(io), [E, D] = S(
    void 0
  ), V = o, [P, I] = S(!1), [A, W] = S(!1), [O, J] = S(!1), [Tt, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), lt = H(void 0), [xt, Xt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Wt = B(() => Bt[0], [Bt]), Re = H(null), se = H(void 0), Jt = K(() => {
    var T;
    (T = se.current) == null || T.call(se), $(io);
  }, []), qe = K(() => {
    const T = !pt;
  ...
  }, [i, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), it = B(() => P || U <= 2 ? L : L.slice(-2), [L, U, P]), tt = B(() => P || U <= 2 ? 0 : U - 2, [U, P]), bt = B(
  ...
  const Rt = K(
    async (T) => {
      ...
      vt && await m({ threadId: c, contents: vt }) && Jt();
    },
    [
      Jt,
      R,
    ...
    async (T) => {
      ...
      return mt && vt && Jt(), mt && E !== void 0 && D(void 0), mt;
    },
    [Jt, R, m, E]
  );
  return /* @__PURE__ */ r(
    Ta,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ p(Ra, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                children: pt ? /* @__PURE__ */ r(Ns, {}) : /* @__PURE__ */ r(ks, {})
              }
            ),
          ...
          /* @__PURE__ */ r(
            so,
            {
              ...
              handleDeleteComment: u,
              onEditingChange: W,
              canEditOrDelete: (!A && xt.get(Wt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ p(ct, { children: [
            ...
            v !== !1 && (!A || $t(R)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Dr(T) && (T.preventDefault(), T.stopPropagation(), ($t(R) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
...
function xp({
  ...
  const F = n.filter(
    ...
    (I) => {
      N((A) => new Set(A).add(I.id)), C(I.id), x == null || x(I.id);
    },
    [x]
  ), $ = K(
    (I) => {
    ...
    [y, x]
  ), { listboxRef: E, activeId: D, handleKeyDown: V } = Sw({
    options: j,
    onOptionSelect: R
  }), P = K(
    (I) => {
      I.key === "Escape" ? (k && y.has(k) && (N((A) => {
        const W = new Set(A);
        return W.delete(k), W;
...
function Fw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(qi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(_s, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = dt.Root, Bw = dt.Group, Ve = dt.Value, Kw = me(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: h(Kw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
Pa.displayName = dt.ScrollUpButton.displayName;
...
$a.displayName = dt.ScrollDownButton.displayName;
...
Gw.displayName = dt.Label.displayName;
...
Uw.displayName = dt.Separator.displayName;
function qw({ table: t }) {
...
function rn(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Hw(o)
  );
}
...
function Qw({
  ...
  var j;
  const [d, m] = S([]), [f, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = B(() => e ?? [], [e]), k = Fo({
    data: N,
    columns: t,
    getCoreRowModel: Ko(),
  ...
  return c ? F = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    ...
    R.id
  )) : F = /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Fw, { table: k }),
    /* @__PURE__ */ p(Mn, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: k.getHeaderGroups().map((R) => /* @__PURE__ */ r(Zt, { children: R.headers.map(($) => /* @__PURE__ */ r(on, { className: "tw-p-0", children: $.isPlaceholder ? void 0 : Je($.column.columnDef.header, $.getContext()) }, $.id)) }, R.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(vo, {}) })
        ] }),
...
function kp({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Ht, { id: i, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
var nc = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(nc || {});
function _p({ id: t, label: e, groups: n }) {
  const [o, a] = S(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "default", children: [
      /* @__PURE__ */ r(Ss, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
    ...
    /* @__PURE__ */ r(ee, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Ma, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[d][f],
        ...
        Vw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Aa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ge, {})
    ] }, w.label)) })
...
function rc({ id: t, versionHistory: e }) {
...
function Ep({
  ...
  const s = B(() => ni(n), [n]), c = ((w) => {
    const d = new Intl.DisplayNames(ri(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(rc, { versionHistory: a }),
...
function oc({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(oe, { open: $, onOpenChange: d ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      z,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: R, children: s })
      ] }),
      /* @__PURE__ */ p(re, { children: [
        /* @__PURE__ */ r(ln, { children: l }),
        /* @__PURE__ */ r(te, { children: F.map((D) => /* @__PURE__ */ p(
          qt,
          {
            value: D.label,
            onSelect: k,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ r(Is, { className: "tw-h-4 tw-w-4" }),
...
function ic({ children: t, editorRef: e }) {
  const n = H(null);
  return Y(() => {
    var s;
...
const lc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(ct, { children: [
...
function wc({
  ...
  const i = H(null), s = H(null), l = H(!1), [c, w] = S(t), [d, m] = S(n), [f, u] = S(!1);
  Y(() => {
    w(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ue, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: lc(t, a, n) }) }) }),
...
const cc = (t, e) => t === "f" ? /* @__PURE__ */ p(ct, { children: [
  /* @__PURE__ */ r(No, {}),
  " ",
...
function pc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(ji, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: cc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: dc(t, n) }) })
    ] }) }),
...
function mc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? $s, { className: e, size: 16 });
}
function fc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = S(""), i = B(() => {
      ...
      /* @__PURE__ */ r(te, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ p(
          qt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(mc, { icon: s.icon }) }) }),
              /* @__PURE__ */ p("div", { children: [
...
function Rp({
  ...
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, F] = S(!1), [j, R] = S(!0), [$, E] = S(!1), D = H(!1), V = H(""), [P, I] = S(!1), [A, W] = S(), [O, J] = S(), [Tt, At] = S(), [Mt, gt] = S(), pt = H(null), G = B(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && dn("note", L)) {
      ...
      let tt = "custom";
      it === tr ? tt = "generated" : it === er ? tt = "hidden" : it && y(it), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
  ...
  const st = K(
    (_, L, U = !1) => {
      ...
      if (q && dn("note", q)) {
        if (q.insert.note) {
          let wt;
          _ === "custom" ? wt = L : _ === "generated" ? wt = tr : wt = er, q.insert.note.caller = wt;
        }
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      N !== "x" && _ === "x" ? wt == null || wt.forEach((Rt) => gc(Rt)) : N === "x" && _ !== "x" && (wt == null || wt.forEach((Rt) => bc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Jt = (_) => {
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(ic, { editorRef: d, children: /* @__PURE__ */ r(
              Qi,
              {
                options: G,
                onStateChange: Jt,
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: xc(t.marker, l, o, w) })
      }
    )
  ] });
}
function Dp({
  ...
  const d = c ?? oi(n, void 0), m = (N, k) => {
    w == null || w(N, k, a);
  }, f = i ? n.findIndex((N) => N === i) : -1, [u, g] = S(f), x = (N, k, C) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
function _c({
  ...
  return /* @__PURE__ */ p(Mn, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(In, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ p(
      Zt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { className: o, children: kc(l.text) })
        ]
      },
...
const Cc = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ p(Rr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        tn,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, Tc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Lp = Object.freeze([
...
function Vp({
  ...
  }, [R, W]), J = B(() => O.length === 0 ? [] : Rc(O, E, V), [O, E, V]), Tt = B(() => {
    var st, lt;
    if (!R) return c;
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ p(Le, { onValueChange: (G) => Mt(G), defaultValue: s, children: [
...
const Dc = "16rem", Mc = "3rem", Va = b.createContext(void 0);
function Pn() {
...
const ja = b.forwardRef(
  ({
    ...
    const [w, d] = b.useState(t), m = e ?? w, f = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => f((k) => !k), [f]), g = m ? "expanded" : "collapsed", y = ht() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(Va.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Oc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Pn();
  return /* @__PURE__ */ p(
    z,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Bs, {}) : /* @__PURE__ */ r(Ks, {}),
...
const jc = me(
  ...
  ({
    ...
    const c = t ? Fe : "button", { state: w } = Pn(), d = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: h(jc({ variant: n, size: o }), i),
        ...s
      }
    );
...
const zc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: a,
...
const Bc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Uc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: i,
...
Uc.displayName = "SidebarMenuSubButton";
function qc({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    za,
    {
      ...
      children: /* @__PURE__ */ p(Ba, { children: [
        /* @__PURE__ */ p(pr, { children: [
          /* @__PURE__ */ r(ur, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(mr, { children: /* @__PURE__ */ r(Ka, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(Ga, { children: /* @__PURE__ */ r(
            Ua,
            {
              onClick: () => w(f),
              isActive: m(f),
...
const ie = "scrBook", Hc = "scrRef", be = "source", Yc = "details", Xc = "Scripture Reference", Wc = "Scripture Book", qa = "Type", Jc = "Details";
function Zc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Xc,
      cell: (o) => {
    ...
    },
    {
      ...
      id: Yc,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Jc,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, po = (t) => `${Qc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function zp({
  sources: t,
  ...
  const [w, d] = S([]), [m, f] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = B(
  ...
  Y(() => {
    if (l) {
      ...
      if (D.length === 1) {
        const V = x.find((P) => po(P) === D[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? Wc, k = i ?? qa, C = [
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(Bw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Zt, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
...
function td({
  ...
  const i = Pr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function ed({
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (A, W = !1) => {
      ...
      const O = j.findIndex((gt) => gt === C.current), J = j.findIndex((gt) => gt === A);
      if (O === -1 || J === -1) return;
      const [Tt, At] = [
        Math.min(O, J),
        Math.max(O, J)
    ...
    (A) => {
      const W = Pr(j, A).map((O) => O);
      n(
        Ha(j, A, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), P = () => {
            ...
            ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: P, children: c }),
...
function Bp({
  ...
  const w = he(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), f = he(s, "%webView_scope_selector_current_book%"), u = he(s, "%webView_scope_selector_choose_books%"), g = he(s, "%webView_scope_selector_scope%"), x = he(s, "%webView_scope_selector_select_books%"), v = [
...
function Kp({
  ...
  return /* @__PURE__ */ p(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ee, { size: a, className: h("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Ve,
          {
            placeholder: l[Q(e)] ?? e
          }
...
const Xa = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ p(St, { children: [
  ...
  ) : /* @__PURE__ */ p(Lw, { children: [
    /* @__PURE__ */ r(Oa, { children: l.label }),
    /* @__PURE__ */ r($w, { children: /* @__PURE__ */ r(Ia, { children: Xa(
      t,
      e,
      Ya(t, l.id),
      o
...
function fr({
  ...
  return /* @__PURE__ */ p(ue, { variant: i, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Us, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(mo, { children: [
      /* @__PURE__ */ r(Ma, { children: /* @__PURE__ */ r(kt, { children: Xa(e.groups, e.items, c, t) }) }),
      w < d.length - 1 && /* @__PURE__ */ r(Ge, {})
    ] }, c)) })
  ] });
}
...
function Hp({
  ...
  return /* @__PURE__ */ p(Wa, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      fr,
      {
        onSelectMenuItem: t,
...
Ja.displayName = Et.List.displayName;
...
Za.displayName = Et.List.displayName;
...
function Xp({
  ...
  return /* @__PURE__ */ p("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Ja, { children: [
      /* @__PURE__ */ r(Za, { children: t.map((l) => /* @__PURE__ */ r(nd, { value: l.value, children: l.value }, l.key)) }),
...
ts.displayName = rt.Root.displayName;
...
es.displayName = rt.Trigger.displayName;
...
ns.displayName = rt.SubTrigger.displayName;
...
rs.displayName = rt.SubContent.displayName;
...
os.displayName = rt.Content.displayName;
...
as.displayName = rt.Item.displayName;
const ad = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = Ft();
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
...
ad.displayName = rt.CheckboxItem.displayName;
const sd = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
...
sd.displayName = rt.RadioItem.displayName;
...
id.displayName = rt.Label.displayName;
...
ss.displayName = rt.Separator.displayName;
const Ye = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((w) => w.group === i).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ p(
        as,
        {
          onClick: () => {
            o(w);
    ...
    return l.length > 0 && s < a.length - 1 && c.push(/* @__PURE__ */ r(ss, {}, `separator-${i}`)), c;
  });
};
function ld({
  menuData: t,
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Ye(i, [f, u]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Ye(s, [f, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ye(l, [f, u]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Ye(c, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(rd, { children: [
      /* @__PURE__ */ r(es, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        os,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(kt, { children: is(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function cd({ item: t, createLabel: e, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Fr, {}) }) }),
...
const dd = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ys, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
...
const fd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
fd.displayName = "AlertDescription";
const nu = ot.Root, ru = ot.Trigger, ou = ot.Group, au = ot.Portal, su = ot.Sub, iu = ot.RadioGroup, hd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: h(
...
hd.displayName = ot.SubTrigger.displayName;
...
gd.displayName = ot.SubContent.displayName;
const bd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: h(
...
bd.displayName = ot.Content.displayName;
...
const xd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ref: a,
    className: h(
...
xd.displayName = ot.CheckboxItem.displayName;
const yd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ot.RadioItem,
  {
    ref: o,
    className: h(
...
Nd.displayName = ot.Label.displayName;
...
kd.displayName = ot.Separator.displayName;
...
const lu = zt.Trigger, Ed = zt.Portal, wu = zt.Close, ws = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
const Td = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
Dd.displayName = zt.Title.displayName;
...
Md.displayName = zt.Description.displayName;
const Od = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  rr.Root,
  {
    ref: o,
    className: h(
...
function pu({
  ...
  return /* @__PURE__ */ r(
    vr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Xs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function uu({ ...t }) {
...
Id.displayName = Xe.Root.displayName;
...
Ad.displayName = or.Root.displayName;
const mu = Et.Root, Pd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
Pd.displayName = Et.List.displayName;
...
$d.displayName = Et.Trigger.displayName;
...
Ld.displayName = Et.Content.displayName;
...
export {
  ...
  ac as UNDO_REDO_BUTTONS_STRING_KEYS,
  Zp as UiLanguageSelector,
  sc as UndoRedoButtons,
  Ja as VerticalTabs,
