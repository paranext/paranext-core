...
import { formatScrRef as Mt, MODIFIER_KEYS as bn, getChaptersForBook as pa, NumberFormat as ua, formatBytes as ma, deepEqual as Qe, isString as Me, compareScrRefs as je, scrRefToBBBCCCVVV as Ae, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
const ka = Ke(
  ({
    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      ...
      g && w && (s ? /* @__PURE__ */ r(_t, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : i && /* @__PURE__ */ r(Br, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), tn = Ar(void 0);
function ut() {
...
function ei({
  ...
  const o = W(), [s, i] = z(
    () => Mt(t, "English")
  ), [w, p] = z(""), [c, g] = z(t.book), [b, m] = z(t.chapterNum ?? 0), [h, y] = z(t.book), [N, k] = z(!1), [_, x] = z(N), [M, A] = z(!1), [B, mt] = z(), U = Z(void 0), C = Z(void 0), v = Z(void 0), I = Z(void 0), R = H(
    (f) => {
      if (f.trim())
        return Nn.reduce(
          (D, S) => {
    ...
    if (!(!B || !B.chapterNum))
      return B.verseNum ? [B.chapterNum] : Array.from({ length: Pt(h) }, (f, D) => D + 1).filter(
        (f) => {
          var D;
          return (B == null ? void 0 : B.chapterNum) && f.toString().includes((D = B == null ? void 0 : B.chapterNum) == null ? void 0 : D.toString());
        }
      );
  }, [h, B]), lt = q(() => {
    const f = R(s.trim());
    ...
    i(Mt(t, "English")), p(""), g(t.book), y(t.book);
  }, [t]), gt = H((f) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (f, D, S, Y) => {
      if (m(t.book !== f ? 1 : t.chapterNum), D || Pt(f) === -1) {
        e({
          book: f,
          chapterNum: S ?? 1,
          verseNum: Y ?? 1
    ...
    (f) => {
      if (!N)
        f.key !== "Tab" && f.key !== "Escape" && k(!0);
      else if (f.key === "Tab") {
        f.preventDefault(), f.stopPropagation();
        return;
      } else f.key === "ArrowDown" ? (I != null && I.current ? I.current.focus() : v != null && v.current ? v.current.focus() : C.current && C.current.focus(), f.preventDefault()) : f.key === "Escape" && document.activeElement === U.current && (k(!1), f.preventDefault(), f.stopPropagation());
      if (document.activeElement === U.current) {
        if (/^[a-zA-Z]$/.test(f.key) && (T(lt ? w + f.key : f.key), A(!0), f.preventDefault()), /^\d$/.test(f.key)) {
          const D = s;
          if (M)
            T(w + f.key);
          else {
    ...
    (f) => {
      const { key: D } = f;
      kn.has(D) || (oe(f), f.preventDefault());
    },
    [oe]
  ), Or = H((f) => {
    const { key: D } = f;
    ...
    (f, D) => {
      ...
      if (kn.has(S)) {
        if (h === c || tt === 1) {
          ...
          const Rt = S === "ArrowRight" && !o || S === "ArrowRight" && o === "ltr" || S === "ArrowLeft" && o === "rtl", se = S === "ArrowLeft" && !o || S === "ArrowLeft" && o === "ltr" || S === "ArrowRight" && o === "rtl", Ve = Array.from(
            { length: Pt(h) },
            (ie, Et) => Et + 1
          ), it = c !== h || tt === 1 ? G ?? Ve : Ve, dt = it.indexOf(b);
          let yt = b;
          if (Rt)
      ...
      oe(f), f.preventDefault(), f.stopPropagation();
    },
    [
      o,
      h,
  ...
  return ct(() => {
    ...
    /* @__PURE__ */ r(en, { asChild: !0, children: /* @__PURE__ */ r(
      ka,
      {
        ...
        handleKeyDown: Dr,
        handleOnClick: () => {
          g(t.book), y(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
      ...
      re,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((f, D) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(ge, { className: "tw-font-semibold tw-text-foreground/80", children: Ga[f.bookType] }),
            f.books.map((S, Y) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Xa,
              {
                bookId: S,
                handleSelectBook: () => ot(S, !1),
                shouldExpandChildren: c.toLowerCase() === S.toLowerCase() || tt === 1,
...
const Ya = St(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Gt : "button", { className: d(Ya({ variant: e, size: n, className: t })), ref: s, ...o })
);
F.displayName = "Button";
const Ua = St(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), J = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Mn.Root, { ref: n, className: d("pr-twp", Ua(), t), ...e }));
...
function ri({
  ...
  const g = ze(c, "%webView_bookSelector_currentBook%"), b = ze(c, "%webView_bookSelector_choose%"), m = ze(c, "%webView_bookSelector_chooseBooks%"), [h, y] = z(
    "current book"
    /* CURRENT_BOOK */
  ), N = (k) => {
    y(k), t(k);
...
function eo({ table: t }) {
  return /* @__PURE__ */ l(he, { children: [
    /* @__PURE__ */ r(ca, { asChild: !0, children: /* @__PURE__ */ l(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
  ...
  u.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        te(i, '[tabindex]:not([tabindex="-1"])').forEach((g) => {
...
function po({
  ...
  var k;
  const [w, p] = z([]), [c, g] = z([]), [b, m] = z({}), [h, y] = z({}), N = An({
    data: e,
    columns: t,
    getCoreRowModel: Bn(),
...
function ai({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(va, { options: o, children: e }) });
}
...
function uo({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Gr, {}) })
    ] }),
...
function si({
  ...
  return /* @__PURE__ */ l(be, { children: [
    ...
    /* @__PURE__ */ r(ae, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      uo,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function ii({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(he, { children: [
    ...
    /* @__PURE__ */ r(re, { children: n.map((c, g) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(ge, { children: c.label }),
      /* @__PURE__ */ r(Fn, { children: c.itemType === 0 ? /* @__PURE__ */ r(pe, { children: c.items.map((b, m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        nn,
        {
          checked: a[g][m],
        ...
        Ta,
        {
          ...
          children: c.items.map((b) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r($n, { value: b.id, children: b.label }) }, b.id))
        }
      ) }),
      /* @__PURE__ */ r(Ft, {})
    ] }, c.label)) })
...
function wi({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new ua("en", {
    notation: "compact",
...
const fo = St(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: d("pr-twp", fo({ variant: e }), t), ...n })
);
...
const tr = St(
  ...
  {
    ref: o,
    className: d(tr({ variant: e, size: n, className: t })),
    ...a
  }
));
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Qr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(ta, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ci = (t) => ({
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-center", children: [
      ...
      /* @__PURE__ */ r(F, { variant: "ghost", children: "Hello World" })
    ] });
  }
}), mi = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), hi = (t) => {
...
function bi({
  ...
  const c = bt(n, "%webView_inventory_all%"), g = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), m = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), y = bt(n, "%webView_inventory_scope_chapter%"), N = bt(n, "%webView_inventory_scope_verse%"), k = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, M] = z(!1), [A, B] = z("all"), [mt, U] = z(""), [C, v] = z([]), I = q(() => t.length === 0 ? [] : ko(t, o, s), [t, o, s]), R = q(() => {
    if (x) return I;
    const T = [];
    return I.forEach((K) => {
...
const Mo = St(
  ...
  ({
    ...
    const p = t ? Gt : "button", { state: c } = De(), g = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Mo({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(mn, { asChild: !0, children: g }),
...
function xi({
  ...
  const [p, c] = z([]), [g, b] = z([{ id: Nt, desc: !1 }]), [m, h] = z({}), y = q(
  ...
  ct(() => {
    if (w) {
      ...
      if (v.length === 1) {
        const I = y.find((R) => Rn(R) === v[0]) || void 0;
        I && w(I);
      }
    }
  }, [m, y, w, k]);
  ...
  }, mt = (C, v) => C.getIsGrouped() ? "" : d("banded-row", v % 2 === 0 ? "even" : "odd"), U = (C, v, I) => {
    if (!((C == null ? void 0 : C.length) === 0 || v.depth < I.column.getGroupedIndex())) {
      if (v.getIsGrouped())
        switch (v.depth) {
          case 1:
            return "tw-ps-4";
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !C.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ r(qe, {}) : /* @__PURE__ */ r(aa, {})),
                          " ",
...
function Zo({
  ...
  const A = q(() => O.allBookIds.filter(
    (v, I) => t[I] === "1" && !O.isObsolete(O.bookIdToNumber(v))
  ), [t]), B = H(
    (v, I = !1) => {
      if (!I || !x.current) {
        n(
    ...
    (v) => {
      const I = hn(A, v).map((R) => R);
      n(
        ur(A, v, e) ? e.filter((R) => !I.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...I])]
      );
    },
    [e, n, A]
  ), U = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
        ...
        xe,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: U, children: p }),
              /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: C, children: c })
            ] }),
            /* @__PURE__ */ l(Ne, { children: [
              /* @__PURE__ */ r(ke, { children: g }),
              Object.values(kt).map((v, I) => {
                const R = A.filter(
                  (G) => It(G) === v
                );
                if (R.length !== 0)
                  return /* @__PURE__ */ l(Vn, { children: [
                    ...
                    I < Object.values(kt).length - 1 && /* @__PURE__ */ r(Wn, {})
                  ] }, v);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var I;
        return /* @__PURE__ */ r(de, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((I = o.get(v)) == null ? void 0 : I.localizedName) || O.bookIdToEnglishName(v) || v }, v);
      }),
...
function Dn({
  ...
  return /* @__PURE__ */ l(he, { variant: s, children: [
    /* @__PURE__ */ r(en, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(oa, {}) }) }),
    /* @__PURE__ */ r(re, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w], p, c) => /* @__PURE__ */ l(Vn, { children: [
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, g) => c.order - g.order).map((c) => /* @__PURE__ */ l(un, { children: [
...
function os({
  ...
  const o = Z(void 0), s = Z(void 0), i = Z(void 0), w = Z(void 0), p = Z(void 0), c = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (xa(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var y, N, k, _;
    g.preventDefault();
    ...
    return /* @__PURE__ */ r(vr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ l(ts, { children: [
      /* @__PURE__ */ r(xr, { ref: c(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        kr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(pn, { children: Sr(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Vi({
  ...
  const p = ss(
    ...
    o && o(h), a && a([h, ...n.filter((y) => y !== h)]), s && n.find((y) => y === h) && s([...n.filter((y) => y !== h)]), g(!1);
  }, m = (h, y) => {
    var k, _, x, M, A, B;
...
const ws = Ke(({ className: t, ...e }, n) => /* @__PURE__ */ r(wa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
