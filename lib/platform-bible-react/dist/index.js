...
import { extendTailwindMerge as Xn, twMerge as Jn } from "tailwind-merge";
import { Slot as ze, Dialog as Bt, Popover as Qe, Label as Zn, RadioGroup as Xr, Tooltip as Oe, ToggleGroup as Eo, Separator as Qn, Avatar as ha, DropdownMenu as gt, Select as xt, Checkbox as ja, Tabs as Pt, Menubar as qt, ContextMenu as ht, Progress as Fa, Slider as lr, Switch as Ba } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as ti, IconCheck as Te, IconSearch as ei, IconChevronRight as fa, IconChevronDown as ri, IconChevronUp as ai, IconSelector as oi, IconLayoutSidebar as ni, IconLayoutSidebarRight as ii, IconLoader as si, IconAlertOctagon as ci, IconAlertTriangle as li, IconInfoCircle as di, IconCircleCheck as wi } from "@tabler/icons-react";
import { Canon as lt } from "@sillsdev/scripture";
import { includes as dr, Section as W, getChaptersForBook as ui, formatScrRef as Ne, getSectionForBook as Xe, formatRelativeDate as pi, formatReplacementString as _e, sanitizeHtml as gi, NumberFormat as hi, formatBytes as fi, getCurrentLocale as mi, usfmMarkers as fr, getFormatCallerFunction as vi, deepEqual as bi, isString as Ua, compareScrRefs as Jr, scrRefToBBBCCCVVV as Ar, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
import { Check as Ue, Clock as Ka, ChevronsLeft as qa, ChevronsRight as Ga, ChevronLeft as Zr, ChevronRight as Qr, ArrowLeft as xi, ArrowRight as yi, ChevronDown as Sr, BoldIcon as ki, ItalicIcon as _i, X as or, AtSign as zo, Pencil as Ni, Trash2 as Ci, ArrowUp as To, MoreHorizontal as Ei, MailOpen as zi, Mail as Ti, ChevronUp as Si, FilterIcon as Ri, ArrowLeftIcon as Di, ChevronLeftIcon as $i, ChevronRightIcon as Mi, ArrowRightIcon as Oi, Copy as So, Filter as Ii, User as Ai, Link as Pi, CircleHelp as Li, ChevronsUpDown as Ro, Star as Vi, Undo as ji, Redo as Fi, SquareX as Do, FunctionSquare as $o, SquareSigma as Mo, Ban as Bi, AlertCircle as ta, CircleCheckIcon as Ui, CircleXIcon as Ki, CircleHelpIcon as qi, ArrowUpIcon as Gi, ArrowDownIcon as Hi, ScrollText as Wi, Search as Yi, MenuIcon as Xi, Menu as Ji, EllipsisVertical as Zi, MoreVertical as Ha, LoaderCircle as Qi } from "lucide-react";
import rt, { forwardRef as nr, useRef as G, useMemo as j, useState as S, useCallback as F, useLayoutEffect as Mt, createContext as Rr, useContext as ma, useEffect as H, Component as ts, createElement as Wa, Suspense as es, Fragment as Oo } from "react";
import { createEditor as Io, $getRoot as Jt, $createParagraphNode as Ke, $getSelection as Et, HISTORY_MERGE_TAG as va, ParagraphNode as Ao, TextNode as Po, $isTokenOrSegmented as rs, $getCharacterOffsets as as, $cloneWithPropertiesEphemeral as os, $getPreviousSelection as ns, $isRangeSelection as Ut, $caretFromPoint as is, $getSiblingCaret as Lo, $getChildCaret as ss, $getAdjacentChildCaret as cs, $isChildCaret as ls, $normalizeCaret as ds, $setSelectionFromCaretRange as ws, $getCollapsedCaretRange as us, $getCaretInDirection as Ya, $splitAtPointCaretNext as ps, $isTextPointCaret as gs, $findMatchingParent as Vo, $isElementNode as Yt, mergeRegister as Zt, getDOMTextNode as hs, isHTMLElement as jo, CLEAR_EDITOR_COMMAND as Fo, COMMAND_PRIORITY_EDITOR as ba, shallowMergeConfig as fs, defineExtension as Ot, safeCast as Se, createState as ms, FORMAT_TEXT_COMMAND as Bo, $isNodeSelection as Uo, COMMAND_PRIORITY_LOW as Ko, RootNode as vs, LineBreakNode as bs, TabNode as xs, $isEditorState as ys, createCommand as ks, CLICK_COMMAND as _s, isDOMNode as Ns, $getNodeFromDOMNode as Cs, $createNodeSelection as Es, $setSelection as zs, $getEditor as Ts, DecoratorNode as ea, $getState as Ss, toggleTextFormatType as Xa, TEXT_TYPE_TO_FORMAT as Rs, $setState as Ds, addClassNamesToElement as qo, $create as $s, $getNodeByKey as Ms, removeClassNamesFromElement as Os, KEY_TAB_COMMAND as Is, $isBlockElementNode as xr, $createRangeSelection as As, $normalizeSelection__EXPERIMENTAL as Ps, OUTDENT_CONTENT_COMMAND as Ls, INDENT_CONTENT_COMMAND as Ja, INSERT_TAB_COMMAND as Vs, COMMAND_PRIORITY_CRITICAL as xa, $isDecoratorNode as js, $isParagraphNode as Fs, $isTextNode as yr, SELECTION_CHANGE_COMMAND as Go, getRegisteredNode as Bs, isDocumentFragment as Za, isDOMDocumentNode as Us, ArtificialNode__DO_NOT_USE as Ho, $createLineBreakNode as Wo, $isRootOrShadowRoot as Ks, isBlockDomNode as Qa, isInlineDomNode as to, $insertNodes as qs } from "lexical";
import { HeadingNode as Gs, QuoteNode as Hs, registerRichText as Ws } from "@lexical/rich-text";
import { flushSync as Ys, createPortal as Xs } from "react-dom";
import { $isTableSelection as Js } from "@lexical/table";
import { createHeadlessEditor as Yo } from "@lexical/headless";
import { useReactTable as Xo, getFilteredRowModel as Zs, getSortedRowModel as Jo, getPaginationRowModel as Qs, getCoreRowModel as Zo, flexRender as Je, getGroupedRowModel as tc, getExpandedRowModel as ec } from "@tanstack/react-table";
import rc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ra, HIDDEN_NOTE_CALLER as aa, getDefaultViewOptions as ac, isInsertEmbedOpOfType as wr, Editorial as oc } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as nc } from "react-hotkeys-hook";
import { Drawer as he } from "vaul";
import * as ya from "react-resizable-panels";
import { useTheme as ic } from "next-themes";
import { Toaster as sc } from "sonner";
import { toast as yg } from "sonner";
const cc = Xn({ prefix: "tw" });
function oa(t) {
  const e = [];
  let r = "", o = 0;
...
function f(...t) {
  ...
  }), Jn(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? dc(l, d) : l;
  }).join(" ");
}
const qe = 250, Qo = 300, wc = 400, uc = 450, pc = 500, tn = te(
...
function sr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(yc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Ee.Input,
        {
      ...
      /* @__PURE__ */ a(_c, { children: /* @__PURE__ */ a(ei, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
          ...
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a(
              V,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(xi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(yi, { className: "tw:h-4 tw:w-4" })
              }
            ),
...
const cn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Oc = cn ? Mt : H, ur = { tag: va };
function Ic({ initialConfig: t, children: e }) {
  const r = j(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Mc(null, o), w = Io({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Ac = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Pc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Gt();
  return Ac(() => {
...
class Vc extends ts {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && jc(e.resetKeys, n)) {
      var i, s;
...
function Fc({ children: t, onError: e }) {
  return a(Vc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Bc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Uc(t) {
...
const ln = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hc = ln && "documentMode" in document ? document.documentMode : null;
!(!ln || !("InputEvent" in window) || Hc) && "getTargetRanges" in new window.InputEvent("input");
function jt(t) {
  return `${t}px`;
}
const Wc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Yc(t, e, r) {
...
function Zc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = Jc(t, e));
  };
...
function tl(t) {
  const e = Et() || ns();
  let r;
  if (Ut(e)) r = is(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Lo(c, "next"));
    }
    r = r || ss(Jt(), "previous").getFlipped().insert(Ke());
  }
  const o = el(t, r), n = cs(o), i = ls(n) ? ds(n) : o;
  return ws(us(i)), t.getLatest();
}
function el(t, e, r) {
  let o = Ya(e, "next");
  for (let n = o; n; n = ps(n, r)) o = n;
  return gs(o) && kr(283), o.insert(t.isInline() ? Ke().append(t) : t), Ya(Lo(t.getLatest(), "next"), e.direction);
}
function rl(t) {
  const e = Et();
  if (!Ut(e)) return !1;
...
let _r, Xt = 0, Nr = 0, nl = 0, la = 0, mr = 0;
function no(t) {
  if (Z === void 0) return;
  let e = t.n;
...
bt.prototype.brand = al, bt.prototype.h = function() {
  return !0;
...
const jr = ms("format", { parse: (t) => typeof t == "number" ? t : 0 });
class hn extends ea {
  $config() {
...
Ot({ name: "@lexical/extension/DecoratorText", nodes: () => [hn], register: (t, e, r) => t.registerCommand(Bo, (o) => {
  const n = Et();
  if (Uo(n) || Ut(n)) for (const i of n.getNodes()) ll(i) && i.toggleFormat(o);
  return !1;
}, Ko) });
function fn(t, e) {
  let r;
...
class ul {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : fs;
...
const gl = Ot({ config: Se({ setOptions: so, updateOptions: so }), init: ({ $initialEditorState: t = pl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (ys(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [vs, Po, bs, xs, Ao] }), co = Symbol.for("@lexical/extension/LexicalBuilder");
function lo() {
}
function hl(t) {
  throw t;
...
class Ae {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && et(298, o.name), !n) {
      n = new ul(this, o), this.extensionNameMap.set(o.name, n);
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = hl), e;
  }
}
const fl = /* @__PURE__ */ new Set(), wo = Ot({ build(t, e, r) {
...
Ot({ dependencies: [da, wo], name: "@lexical/extension/HorizontalRule", nodes: () => [Le], register(t, e, r) {
  ...
  return Zt(t.registerCommand(ml, (s) => {
    const c = Et();
    if (!Ut(c)) return !1;
    ...
    return !0;
  }, ba), t.registerCommand(_s, (s) => {
    if (Ns(s.target)) {
      const c = Cs(s.target);
      if (bl(c)) return function(l, d = !1) {
        const w = Et(), g = l.isSelected(), h = l.getKey();
        let p;
        d && Uo(w) ? p = w : (p = Es(), zs(p)), g ? p.delete(h) : p.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
Ot({ build: (t, e, r) => Ge(e), config: Se({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Kt(() => {
    if (!o.disabled.value) return Zc(t, o.onReposition.value);
  });
} });
function xn(t) {
  return t.canBeEmpty();
...
function xl(t, e, r = xn) {
  return Zt(t.registerCommand(Is, (o) => {
    const n = Et();
    if (!Ut(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => xr(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), g = Qc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = As();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = Ps(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Ls : Ja : Vs;
...
const yl = Ot({ name: "@lexical/react/ReactProvider" });
function kl() {
  ...
  return function(r, o) {
    ...
    return Sa(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(es, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(Xs(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function zl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(yl.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Cl(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(El, { editor: t, ErrorBoundary: e });
}
function uo(t) {
...
function Tl({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Sa(() => Zt(Ws(n), kn(n)), [n]);
  }(o), u(st, { children: [t, a(Sl, { content: e }), a(zl, { editor: o, ErrorBoundary: r })] });
}
...
const Dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function $l({ onClear: t }) {
  const [e] = Gt();
  return Dl(() => gn(e, t), [e, t]), null;
}
const _n = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Ml({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: x, role: v = "textbox", spellCheck: N = !0, style: b, tabIndex: _, "data-testid": k, ...I }, L) {
...
function Al(t, e) {
  ...
  return u(st, { children: [a(Ol, { editor: n, ...o, ref: e }), r != null && a(Pl, { editor: n, content: r })] });
}
function Pl({ content: t, editor: e }) {
  const r = function(s) {
    const [c, l] = S(() => po(s));
    return _n(() => {
      function d() {
...
function jl() {
  const [t, e] = S(void 0), r = F(() => {
    ...
    return /* @__PURE__ */ a(hc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(vc, { children: [
      /* @__PURE__ */ a(bc, { children: /* @__PURE__ */ a(xc, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = F(
    (i, s, c = !1) => {
...
function Fl({
  ...
  const [e] = Gt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, c] = jl(), l = () => {
  };
...
const go = [
  { format: "bold", icon: ki, label: "Bold" },
  { format: "italic", icon: _i, label: "Italic" }
...
function Gl({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Fl, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Kl, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Tl,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Ll, { placeholder: t }) }),
          ErrorBoundary: Fc
        }
      ),
      e && /* @__PURE__ */ a(Rl, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ a(
          Ic,
          {
            ...
            children: /* @__PURE__ */ u(kt, { children: [
              /* @__PURE__ */ a(Gl, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Pc,
                {
...
function Wl(t, e) {
  const r = Us(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function Tn(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && yr(e) && (s = Gc(o, e, "clone"));
  const c = Yt(s) ? s.getChildren() : [], l = Bs(t, s.getType());
  let d;
...
function Rn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  let h = [];
  const p = (c == null || !Ks(c)) && (c != null && xr(c) || o);
  for (let m = 0; m < g.length; m++) h.push(...Rn(g[m], e, r, p, new Map(n), c));
  return w != null && (h = w(h)), Qa(t) && (h = Xl(t, h, p ? () => {
    const m = new Ho();
    return r.push(m), m;
...
function Jl(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Wl(e, n);
      Jt().clear(), qs(i);
    },
    {
      discrete: !0
...
function Cu({
  ...
  const [i, s] = S(Zl), [c, l] = S(n), [d, w] = S(!1), g = G(void 0), h = G(null);
  H(() => {
    let b = !0;
    const _ = h.current;
    if (!_) return;
...
const Eu = Object.freeze([
...
], Ql = ["input", "select", "textarea", "button"], td = ["button", "textbox"], ed = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = G(null), [i, s] = S(void 0), [c, l] = S(void 0), d = F(
    ...
    if (p.isContentEditable || Ql.includes(m)) return !0;
    const x = p.getAttribute("role");
    if (x && td.includes(x)) return !0;
...
function ud({ className: t, children: e, ...r }) {
  const o = ct();
  return /* @__PURE__ */ a(
    gt.SubContent,
    {
...
function ho({
  ...
  const p = F(
    ...
    [t.user]
  ), b = j(() => gi(t.contents), [t.contents]), _ = j(() => {
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          ua,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(Jl(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u(
          ua,
          {
            ...
            children: [
              /* @__PURE__ */ a(Ci, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(nd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(id, { className: "tw:text-xs tw:font-medium", children: N }) }),
        ...
        _ && /* @__PURE__ */ u(ue, { children: [
          /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ei, {}) }) }),
  ...
  if (It.length !== 0)
    return /* @__PURE__ */ a(
      ad,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ u(od, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              /* @__PURE__ */ a(
                V,
                {
                  ...
                  children: J ? /* @__PURE__ */ a(zi, {}) : /* @__PURE__ */ a(Ti, {})
                }
              ),
...
function Ou({
  ...
  const C = r.filter(
    ...
    [N, x]
  ), { listboxRef: $, activeId: q, handleKeyDown: P } = ed({
    options: T,
    onOptionSelect: z
  }), Y = F(
    (y) => {
...
function gd({ table: t }) {
  return /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ri, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function Fe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    xt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(xt.Icon, { asChild: !0, children: /* @__PURE__ */ a(oi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
  ...
  const c = rt.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), kd(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), yd(c, x, w.key);
...
function _d({
  ...
  const [w, g] = S([]), [h, p] = S([]), [m, x] = S({}), [v, N] = S({}), b = j(() => e ?? [], [e]), _ = Xo({
    ...
    columns: t,
    getCoreRowModel: Zo(),
    ...r && { getPaginationRowModel: Qs() },
    onSortingChange: g,
    getSortedRowModel: Jo(),
    onColumnFiltersChange: p,
    getFilteredRowModel: Zs(),
...
function Vu({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(rc, { options: i, children: e })
    }
  );
}
...
var Ed = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Ed || {});
function Bu({ id: t, label: e, groups: r }) {
  const [o, n] = S(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "default", children: [
      /* @__PURE__ */ a(Ii, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(ge, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Mn, { children: d.itemType === 0 ? /* @__PURE__ */ a(st, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        ...
        cd,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(ld, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
...
function zd({ id: t, versionHistory: e }) {
...
function Ku({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(zd, { versionHistory: n }),
        ...
        /* @__PURE__ */ a(Qt, { children: I.map((z) => /* @__PURE__ */ u(
          ee,
          {
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Vi, { className: "tw:h-4 tw:w-4" }),
...
function Dd({ children: t, editorRef: e }) {
  const r = G(null);
  return H(() => {
    var s;
...
const $d = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(st, { children: [
...
function Md({
  ...
  return /* @__PURE__ */ u(ue, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: $d(t, n, r) }) }) }),
...
const Od = (t, e) => t === "f" ? /* @__PURE__ */ u(st, { children: [
  /* @__PURE__ */ a($o, {}),
  " ",
...
function Ad({
  ...
  return /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Od(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: Id(t, r) }) })
    ] }) }),
...
function Ld({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Bi, { className: e, size: 16 });
}
function xo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ u(
    ee,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ld, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Nc, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Vd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = S(""), [i, s] = j(() => {
...
function Gu({
  ...
  const [m, x] = S("generated"), [v, N] = S("*"), [b, _] = S("f"), [k, I] = S(!1), [L, M] = S(!0), [C, T] = S(!1), z = G(!1), O = G(""), [$, q] = S(!1), [P, Y] = S(), [y, U] = S(), [dt, ft] = S(), [zt, ut] = S(), yt = G(null), B = j(
    () => ({
      ...
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? ac(), noteMode: "expanded" }
    }),
    [s, c]
  ), it = j(
    () => jd(
  ...
  const ie = () => {
    ...
    if (A && wr("note", A)) {
      ...
      b !== "x" && E === "x" ? nt == null || nt.forEach((Rt) => Fd(Rt)) : b === "x" && E !== "x" && (nt == null || nt.forEach((Rt) => Bd(Rt))), (at = w.current) == null || at.applyUpdate([A, { delete: 1 }]);
    }
  }, It = (E) => {
    ...
    /* @__PURE__ */ u("div", { ref: p, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ a("div", { className: t, children: /* @__PURE__ */ a(Dd, { editorRef: w, children: /* @__PURE__ */ a(
              oc,
              {
                options: B,
                onStateChange: It,
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: Kd(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      de,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Pe, { className: o, children: Hd(c.text) })
        ]
      },
...
const Yd = (t) => {
  ...
  if (t === "desc")
    return /* @__PURE__ */ a(Hi, { className: "tw:h-4 tw:w-4" });
  ...
  return e ? e[1] : "";
}, Jd = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ep = Object.freeze([
...
function rp({
  ...
  }, [M, Y]), U = j(() => y.length === 0 ? [] : Zd(y, T, O), [y, T, O]), dt = j(() => {
    var J, wt;
    if (!M) return l;
...
const tw = "16rem", ew = "3rem", An = rt.createContext(void 0);
function Ir() {
...
function ap({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    V,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(ni, {}) : /* @__PURE__ */ a(ii, {}),
    ...
    aw,
    {
      ...
      children: /* @__PURE__ */ u(nw, { children: [
        /* @__PURE__ */ u(yo, { children: [
          ...
          /* @__PURE__ */ a(_o, { children: /* @__PURE__ */ a(iw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(sw, { children: /* @__PURE__ */ a(
            lw,
            {
              onClick: () => d(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ u(
      rw,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ow, { className: "tw:min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const le = "scrBook", ww = "scrRef", ke = "source", uw = "details", pw = "Scripture Reference", gw = "Scripture Book", Pn = "Type", hw = "Details";
function fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, No = (t) => `${mw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function mp({
  sources: t,
    ...
    !e && /* @__PURE__ */ u(
      Ve,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Be, { position: "item-aligned", children: /* @__PURE__ */ a(hd, { children: k.map((T) => /* @__PURE__ */ a(At, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
...
const jn = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(wd, { children: c.label }),
    /* @__PURE__ */ a(sd, { children: /* @__PURE__ */ a(ud, { children: jn(
      t,
      e,
      Vn(t, c.id),
      o
...
function ga({
  ...
  return /* @__PURE__ */ u(ue, { variant: i, children: [
    /* @__PURE__ */ a(pe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Xi, {}) }) }),
...
const xw = rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Pt.Trigger,
  {
    ref: r,
    ...e,
...
function Ep({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Bn, { children: [
      /* @__PURE__ */ a(Un, { children: t.map((c) => /* @__PURE__ */ a(xw, { value: c.value, children: c.value }, c.key)) }),
...
function Cw({
  ...
  const i = oe();
  return /* @__PURE__ */ a(_w, { children: /* @__PURE__ */ a(
    qt.Content,
    {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(Sw, { children: d.label }),
        /* @__PURE__ */ a(Rw, { children: qn(
          t,
          e,
          Vn(t, d.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(zw, {}, `separator-${i}`)), l;
  });
};
function Dw({
  menuData: t,
  ...
  if (nc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    return /* @__PURE__ */ a(yw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(kw, { children: [
      /* @__PURE__ */ a(Nw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Cw,
        {
          style: { zIndex: qe },
...
function Mw({ item: t, createLabel: e, createComplexLabel: r }) {
...
const Ow = nr(({ className: t, ...e }, r) => /* @__PURE__ */ a(Qi, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function tg({
  ...
  const n = ct();
  return /* @__PURE__ */ u(Aw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Pw, {}),
    /* @__PURE__ */ u(
      he.Content,
      {
...
function lg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    sc,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(wi, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(di, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(li, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(ci, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(si, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function pg({
  ...
  return /* @__PURE__ */ a(
    Pt.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Lw({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Fw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  Op as AlertTitle,
  nd as Avatar,
  id as AvatarFallback,
  $u as AvatarImage,
  ku as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  _u as BOOK_SELECTOR_STRING_KEYS,
  er as Badge,
  yu as BookChapterControl,
  ca as BookSelectionMode,
  Nu as BookSelector,
  V as Button,
  Eu as COMMENT_EDITOR_STRING_KEYS,
  zu as COMMENT_LIST_STRING_KEYS,
  ad as Card,
  od as CardContent,
  ...
  Ou as CommentList,
  Ap as ContextMenu,
  Gp as ContextMenuCheckboxItem,
  Bp as ContextMenuContent,
  Lp as ContextMenuGroup,
  Up as ContextMenuItem,
  Wp as ContextMenuLabel,
  Vp as ContextMenuPortal,
  Fp as ContextMenuRadioGroup,
  Hp as ContextMenuRadioItem,
  Yp as ContextMenuSeparator,
  Xp as ContextMenuShortcut,
  jp as ContextMenuSub,
  qp as ContextMenuSubContent,
  Kp as ContextMenuSubTrigger,
  Pp as ContextMenuTrigger,
  _d as DataTable,
  hc as Dialog,
  pu as DialogClose,
  vc as DialogContent,
  ...
  Ed as DropdownMenuItemType,
  Mr as DropdownMenuLabel,
  sd as DropdownMenuPortal,
  ...
  Nd as ERROR_DUMP_STRING_KEYS,
  ju as ERROR_POPOVER_STRING_KEYS,
  Dd as EditorKeyboardShortcuts,
  Cd as ErrorDump,
  Fu as ErrorPopover,
  Hu as FOOTNOTE_EDITOR_STRING_KEYS,
  qu as Filter,
  Bu as FilterDropdown,
  Ku as Footer,
  Gu as FootnoteEditor,
  Gd as FootnoteItem,
  Wu as FootnoteList,
  ...
  rp as Inventory,
  pt as Label,
  Pd as MARKER_MENU_STRING_KEYS,
  Vu as MarkdownRenderer,
  Vd as MarkerMenu,
  Uu as MoreInfo,
  Td as MultiSelectComboBox,
  Ep as NavigationContentSearch,
  re as Popover,
  Ec as PopoverAnchor,
  ae as PopoverContent,
  bu as PopoverDescription,
  mu as PopoverHeader,
  vu as PopoverTitle,
  ...
  zc as RecentSearches,
  cg as ResizableHandle,
  sg as ResizablePanel,
  ig as ResizablePanelGroup,
  Dp as ResultsCard,
  ...
  rr as Separator,
  yp as SettingsList,
  _p as SettingsListHeader,
  kp as SettingsListItem,
  dw as SettingsSidebar,
