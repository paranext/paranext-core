...
import p, { forwardRef as Lt, createContext as Hn, useContext as Un, useCallback as tt, useState as O, useRef as K, useEffect as wt, useLayoutEffect as Xe, useMemo as W, Fragment as qn } from "react";
...
import { ChevronRight as fe, Check as kt, Circle as be, X as ve, Search as Ue, ChevronsUpDown as qe, FilterIcon as Zn, ChevronDown as Yt, ChevronUp as Qn, ArrowLeftIcon as tr, ChevronLeftIcon as er, ChevronRightIcon as nr, ArrowRightIcon as rr, LoaderCircle as ar, Download as or, Filter as sr, User as ir, Link as wr, CircleHelp as lr, Star as dr, CircleCheckIcon as cr, CircleXIcon as pr, CircleHelpIcon as ur, ArrowUpIcon as mr, ArrowDownIcon as hr, ArrowUpDownIcon as gr, PanelLeft as fr, PanelRight as br, ScrollText as vr, ChevronLeft as xr, MenuIcon as yr, Menu as Nr, EllipsisVertical as kr } from "lucide-react";
import { formatScrRef as Dt, getChaptersForBook as Cr, NumberFormat as Sr, formatBytes as Rr, deepEqual as xe, isString as re, compareScrRefs as le, scrRefToBBBCCCVVV as ae, getLocalizeKeyForScrollGroupId as D } from "platform-bible-utils";
...
import { useReactTable as Ke, getFilteredRowModel as Tr, getSortedRowModel as We, getPaginationRowModel as _r, getCoreRowModel as Ze, flexRender as It, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const Ne = V.Trigger, en = V.Group, Pr = V.Portal, Or = V.Sub, ts = V.RadioGroup;
...
var Xr = Object.defineProperty, Fr = (t, e, n) => e in t ? Xr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => Fr(t, typeof e != "symbol" ? e + "" : e, n);
const ht = [
  "GEN",
  "EXO",
  "LEV",
...
const _e = j.allBookIds.filter((t) => !j.isObsolete(j.bookIdToNumber(t))), ta = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], ea = 96, na = [
...
function ns({
  ...
  const o = F(), [s, i] = O(""), [w, c] = O(t.book), [u, g] = O(t.chapterNum ?? 0), [b, h] = O(t.book), [m, f] = O(!1), [k, C] = O(m), y = K(void 0), x = K(void 0), E = K(void 0), $ = tt(
    ...
    na.forEach((S) => {
      const M = S.exec(s);
      if (M) {
        const [P, v = void 0, _ = void 0] = M.slice(1), Z = oa(P);
  ...
  return wt(() => {
    ...
    const S = setTimeout(() => {
      if (k && x.current && E.current && !s) {
        const P = E.current.offsetTop - ea;
      ...
      jt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((S, M) => {
          ...
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(qt, { className: "tw-font-semibold tw-text-foreground/80", children: ta[S] }),
...
const sa = lt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ct : "button", { className: l(sa({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const ia = lt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Je.Root, { ref: n, className: l("pr-twp", ia(), t), ...e }));
...
const un = Bt.Root, mn = Bt.Trigger, ze = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
const wa = rt.Portal, hn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: l(
...
const la = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
...
function ue({
  ...
  const [C, y] = O(!1);
  return /* @__PURE__ */ d(un, { open: C, onOpenChange: y, ...k, children: [
    /* @__PURE__ */ r(mn, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: h,
        role: "combobox",
...
const vt = X.Root, fa = X.Group, xt = X.Value, ba = lt(
...
function Ta({
  ...
  var C;
  const [w, c] = O([]), [u, g] = O([]), [b, h] = O({}), [m, f] = O({}), k = Ke({
    data: e,
    columns: t,
    getCoreRowModel: Ze(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    n && a && /* @__PURE__ */ r(ya, { table: k })
  ] });
}
const Ft = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(ar, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function ds({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ut, { children: [
    ...
    /* @__PURE__ */ r(jt, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(en, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Ce, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(an, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Xt, {})
    ] }, n.label)) })
  ] }) });
}
...
function Da({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ d(un, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(mn, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
          ...
          return /* @__PURE__ */ d(
            Ve,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: C.starred && /* @__PURE__ */ r(dr, { className: "tw-h-4 tw-w-4" }) }),
...
Va.displayName = Qe.Root.displayName;
const yn = p.createContext({
  size: "default",
  variant: "default"
}), Nn = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = F();
  return /* @__PURE__ */ r(
    Ht.Root,
    {
...
const Zt = (t) => t === "asc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), hs = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-center", children: [
      /* @__PURE__ */ d(Nn, { value: i, variant: "outline", type: "single", children: [
        /* @__PURE__ */ r(
          Gt,
          {
            onClick: (c) => {
...
Ae.displayName = tn.Root.displayName;
...
const ja = "16rem", Xa = "3rem", kn = p.createContext(void 0);
function te() {
  const t = p.useContext(kn);
  if (!t)
...
const Cn = p.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(kn.Provider, { value: x, children: /* @__PURE__ */ r(Pe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Sn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = te();
...
const st = "scrBook", no = "scrRef", mt = "source", ro = "details", ao = "Scripture Reference", oo = "Scripture Book", Dn = "Type", so = "Details";
function io(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: mt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Dn : void 0,
...
}, Ye = (t) => `${wo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Cs({
  sources: t,
    ...
    !e && /* @__PURE__ */ d(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ft, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: E.map((N) => /* @__PURE__ */ r(Q, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(fe, {}) : /* @__PURE__ */ r(xr, {})),
                          " ",
...
const Vn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ r(Pr, { children: /* @__PURE__ */ r(rn, { children: Vn(
      t,
      e,
      In(t, w.id),
      a
...
function He({
  ...
  return /* @__PURE__ */ d(Ut, { variant: s, children: [
    /* @__PURE__ */ r(Ne, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(I, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(yr, {}) }) }),
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ d(qn, { children: [
      /* @__PURE__ */ r(en, { children: /* @__PURE__ */ r(Pe, { children: Vn(e.groups, e.items, w, t) }) }),
...
const Bn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.Root,
    {
...
function Es({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Bn, { children: [
      /* @__PURE__ */ r(An, { children: t.map((i) => /* @__PURE__ */ r(lo, { value: i.value, children: i.value }, i.key)) }),
...
Fn.displayName = B.SubContent.displayName;
const Gn = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = et();
...
Gn.displayName = B.Content.displayName;
const $n = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ r(
    B.Item,
    {
...
$n.displayName = B.Item.displayName;
...
Ln.displayName = B.Separator.displayName;
const Et = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    ...
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(Ln, {}, `separator-${s}`)), c;
  });
};
function go({
  menuData: t,
  ...
  if (Dr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var f, k, C, y;
    g.preventDefault();
    ...
    return /* @__PURE__ */ r(On, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(co, { children: [
      /* @__PURE__ */ r(jn, { ref: u(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        Gn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Pe, { children: Yn(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
