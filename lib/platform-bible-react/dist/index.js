import Dl, { jsx as d, jsxs as _, Fragment as yt } from "react/jsx-runtime";
import * as N from "react";
import G, { forwardRef as Eo, useCallback as Ce, useState as ie, useRef as $t, useEffect as Ve, useLayoutEffect as ma, useMemo as Ar } from "react";
import { History as jl, ChevronRight as Bl, Check as ko, Circle as Ll, ArrowDownWideNarrow as Fl, Clock as Vl, Bookmark as zl, FilterIcon as Ul, ChevronDown as No, ChevronUp as Hl, ArrowLeftIcon as Gl, ChevronLeftIcon as Wl, ChevronRightIcon as Xl, ArrowRightIcon as ql, X as Yl, Search as Kl, ChevronsUpDown as Jl, CircleCheckIcon as ha, CircleXIcon as ga, CircleHelpIcon as ba, ArrowUpIcon as Zl, ArrowDownIcon as Ql, ArrowUpDownIcon as ec, LoaderCircle as gn, Download as tc, Filter as rc, User as nc, Link as oc, CircleHelp as ac } from "lucide-react";
...
import { getChaptersForBook as cc, compareScrRefs as ao, scrRefToBBBCCCVVV as Fn, formatScrRef as Vn, split as pc, NumberFormat as dc, formatBytes as uc } from "platform-bible-utils";
import { useReactTable as Ti, getCoreRowModel as Ci, getPaginationRowModel as fc, getSortedRowModel as Si, getFilteredRowModel as mc, flexRender as wr, getExpandedRowModel as hc, getGroupedRowModel as gc } from "@tanstack/react-table";
import { Slot as bc } from "@radix-ui/react-slot";
import { cva as To } from "class-variance-authority";
import * as xe from "@radix-ui/react-select";
import { FormControlLabel as va, FormLabel as vc, Checkbox as yc, MenuItem as wc, ListItemText as xc, ListItemIcon as Oi, Menu as Ec, Grid as Ri, List as kc, IconButton as Pi, Drawer as Nc, Slider as Tc, Snackbar as Cc, Switch as Sc, AppBar as Oc, Toolbar as Rc } from "@mui/material";
import * as Cr from "@radix-ui/react-popover";
import { Command as Ae } from "cmdk";
import * as Qe from "@radix-ui/react-dialog";
import Pc, { ThemeContext as $c, internal_processStyles as _c } from "@mui/styled-engine";
...
var Dc = Object.defineProperty, jc = (e, t, r) => t in e ? Dc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => jc(e, typeof t != "symbol" ? t + "" : t, r);
const Mt = [
  "GEN",
  "EXO",
  "LEV",
...
const Ro = ge.Root, Bi = ge.Trigger, qc = ge.Group, Sv = ge.Portal, Ov = ge.Sub, Rv = ge.RadioGroup, Yc = G.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ _(
  ge.SubTrigger,
  {
    ref: o,
    className: F(
    ...
    children: [
      r,
      /* @__PURE__ */ d(Bl, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
Yc.displayName = ge.SubTrigger.displayName;
const Kc = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.SubContent,
  {
    ref: r,
    className: F(
...
const vn = G.forwardRef(({ className: e, sideOffset: t = 4, ...r }, n) => /* @__PURE__ */ d(ge.Portal, { children: /* @__PURE__ */ d(
  ge.Content,
  {
    ref: n,
    sideOffset: t,
...
const Li = G.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ d(
  ge.Item,
  {
    ref: n,
    className: F(
...
const Po = G.forwardRef(({ className: e, children: t, checked: r, ...n }, o) => /* @__PURE__ */ _(
  ge.CheckboxItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(ge.ItemIndicator, { children: /* @__PURE__ */ d(ko, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
Po.displayName = ge.CheckboxItem.displayName;
const Fi = G.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  ge.RadioItem,
  {
    ref: n,
    className: F(
...
const yn = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  ge.Separator,
  {
    ref: r,
...
function Qc({
  ...
  return /* @__PURE__ */ d("div", { className: F("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: a.map((l) => /* @__PURE__ */ d(
    "div",
    {
      className: F(
...
const xr = me.allBookIds, tp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, xa = ["OT", "NT", "DC"], rp = 32 + 32 + 32, np = [
  /^(\w+)$/i,
...
function Pv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ie(""), [o, a] = ie(
    ...
    (k) => op(k).filter((S) => {
      const $ = me.bookIdToEnglishName(S).toLowerCase(), V = r.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    np.forEach((k) => {
      const S = r.match(k);
      if (S) {
        const [$, V = void 0, H = void 0] = S.slice(1), M = sp($);
  ...
  return Ve(() => {
    ...
    /* @__PURE__ */ d(Bi, { asChild: !0, children: /* @__PURE__ */ d(
      Ac,
      {
        ref: h,
        value: r,
        ...
        children: [
          ...
          xa.map(
            (k, S) => x(k).length > 0 && /* @__PURE__ */ _("div", { children: [
              /* @__PURE__ */ d(Dr, { className: "pr-font-semibold pr-text-slate-700", children: tp[k] }),
              x(k).map(($) => /* @__PURE__ */ d("div", { children: /* @__PURE__ */ d(
                Zc,
                {
                  bookId: $,
              ...
              xa.length - 1 !== S ? /* @__PURE__ */ d(yn, {}) : void 0
            ] }, k)
          )
        ]
      }
...
const lp = To(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? bc : "button", { className: F(lp({ variant: t, size: r, className: e })), ref: a, ...o })
);
ve.displayName = "Button";
function cp({ table: e }) {
  return /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(lc, { asChild: !0, children: /* @__PURE__ */ _(ve, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
...
const an = xe.Root, pp = xe.Group, sn = xe.Value, Sr = G.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  xe.Trigger,
  {
    ref: n,
    className: F(
...
const Vi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.ScrollUpButton,
  {
    ref: r,
...
const dp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.Label,
  {
    ref: r,
...
dp.displayName = xe.Label.displayName;
const Ke = G.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(
  xe.Item,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(xe.ItemIndicator, { children: /* @__PURE__ */ d(ko, { className: "pr-h-4 pr-w-4" }) }) }),
...
up.displayName = xe.Separator.displayName;
function fp({ table: e }) {
...
const xn = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("thead", { ref: r, className: F("[&_tr]:pr-border-b", e), ...t }));
xn.displayName = "TableHeader";
const En = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: F("[&_tr:last-child]:pr-border-0", e), ...t }));
En.displayName = "TableBody";
const mp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "tfoot",
  {
    ref: r,
...
function gp({
  ...
  var f;
  const [i, l] = ie([]), [c, u] = ie([]), [m, v] = ie({}), [g, p] = ie({}), h = Ti({
    data: t,
    columns: e,
    getCoreRowModel: Ci(),
  ...
  return /* @__PURE__ */ _("div", { children: [
    o && /* @__PURE__ */ d(cp, { table: h }),
    /* @__PURE__ */ d("div", { className: "pr-twp pr-font-sans", children: /* @__PURE__ */ _(wn, { children: [
      /* @__PURE__ */ d(xn, { children: h.getHeaderGroups().map((b) => /* @__PURE__ */ d(vt, { children: b.headers.map((x) => /* @__PURE__ */ d(Rr, { children: x.isPlaceholder ? void 0 : wr(x.column.columnDef.header, x.getContext()) }, x.id)) }, b.id)) }),
      /* @__PURE__ */ d(En, { children: (f = h.getRowModel().rows) != null && f.length ? h.getRowModel().rows.map((b) => /* @__PURE__ */ d(
        vt,
        {
          onClick: () => a(b, h),
    ...
    r && n && /* @__PURE__ */ d(fp, { table: h })
  ] });
}
const bp = Cr.Root, vp = Cr.Trigger, Ui = G.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d(Cr.Portal, { children: /* @__PURE__ */ d(
  Cr.Content,
  {
    ref: o,
    align: t,
...
const yp = Qe.Portal, Hi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Overlay,
  {
    ref: r,
    className: F(
...
const wp = G.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ _(yp, { children: [
  /* @__PURE__ */ d(Hi, {}),
  /* @__PURE__ */ _(
    Qe.Content,
    {
...
wp.displayName = Qe.Content.displayName;
const xp = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Qe.Title,
  {
    ref: r,
...
xp.displayName = Qe.Title.displayName;
...
Ep.displayName = Qe.Description.displayName;
const Gi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae,
  {
    ref: r,
    className: F(
...
const Wi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
  /* @__PURE__ */ d(Kl, { className: "pr-mr-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ d(
    Ae.Input,
    {
      ref: r,
...
const Xi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae.List,
  {
    ref: r,
...
const qi = G.forwardRef((e, t) => /* @__PURE__ */ d(Ae.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
...
kp.displayName = Ae.Group.displayName;
...
Np.displayName = Ae.Separator.displayName;
const Yi = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Ae.Item,
  {
    ref: r,
    className: F(
...
function Ea({
  ...
  const [m, v] = ie(!1);
  return /* @__PURE__ */ _(bp, { open: m, onOpenChange: v, children: [
    /* @__PURE__ */ d(vp, { asChild: !0, children: /* @__PURE__ */ _(
      ve,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          n ? a(n) : i,
          /* @__PURE__ */ d(Jl, { className: "pr-ml-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ d(Ui, { className: "pr-w-[200px] pr-p-0", children: /* @__PURE__ */ _(Gi, { children: [
      /* @__PURE__ */ d(Wi, { placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ d(qi, { children: c }),
      /* @__PURE__ */ d(Xi, { children: t.map((g) => /* @__PURE__ */ _(
        Yi,
        {
          value: a(g),
          onSelect: () => {
...
function $p() {
  return Na || (Na = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(B) {
      ...
      B === n || B === u || B === a || B === o || B === v || B === g || typeof B == "object" && B !== null && (B.$$typeof === h || B.$$typeof === p || B.$$typeof === i || B.$$typeof === l || B.$$typeof === m || B.$$typeof === b || B.$$typeof === x || B.$$typeof === P || B.$$typeof === f);
    }
    function E(B) {
    ...
    var y = c, C = u, T = l, A = i, j = t, L = m, k = n, S = h, $ = p, V = r, H = a, M = o, z = v, te = !1;
    function Q(B) {
...
function Ip() {
  if (Pa)
    return Xn;
  Pa = 1;
  var e = Zi(), t = _p(), r = _o(), n = Qi(), o = Mp(), a = function() {
  };
  ...
  return Xn = function(l, c) {
    ...
    function L() {
      function O(I, U, Y, W, X) {
        return V(I[U]) ? null : new f("Invalid " + W + " `" + X + "` supplied to " + ("`" + Y + "`, expected a ReactNode."));
      }
      return b(O);
    }
...
if (process.env.NODE_ENV !== "production") {
  var Dp = Zi(), jp = !0;
  so.exports = Ip()(Dp.isElement, jp);
} else
  so.exports = Ap()();
var Bp = so.exports;
const s = /* @__PURE__ */ Sp(Bp);
function Lp(e) {
  const {
    prototype: t = {}
  } = e;
...
function es(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Lp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function Vp(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !Fp(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const zp = nr(s.elementType, Vp), Up = "exact-prop: ​";
function rs(e) {
...
function Gp() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(D) {
      return !!(typeof D == "string" || typeof D == "function" || D === r || D === o || P || D === n || D === u || D === m || x || D === p || h || f || b || typeof D == "object" && D !== null && (D.$$typeof === g || D.$$typeof === v || D.$$typeof === a || D.$$typeof === i || D.$$typeof === c || // This needs to include all possible module reference object
    ...
    var C = i, T = a, A = e, j = c, L = r, k = g, S = v, $ = t, V = o, H = n, M = u, z = m, te = !1, Q = !1;
    function O(D) {
...
const Yp = s.oneOfType([s.func, s.object]), Mo = Yp;
function et(e) {
  if (typeof e != "string")
...
const Qp = typeof window < "u" ? N.useLayoutEffect : N.useEffect, It = Qp;
let Aa = 0;
function ed(e) {
...
function sd(e) {
  ...
  return !!(r === "INPUT" && id[t] && !e.readOnly || r === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function ld(e) {
...
function pd(e) {
  e.addEventListener("keydown", ld, !0), e.addEventListener("mousedown", Yn, !0), e.addEventListener("pointerdown", Yn, !0), e.addEventListener("touchstart", Yn, !0), e.addEventListener("visibilitychange", cd, !0);
}
function dd(e) {
  const {
    target: t
...
function ss() {
  ...
  function r() {
    return t.current ? (po = !0, ad.start(100, () => {
      po = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
...
function bd(e, t = Number.MIN_SAFE_INTEGER, r = Number.MAX_SAFE_INTEGER) {
...
function wd(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = he(e, vd), a = yd(t), i = Object.keys(a);
  function l(g) {
...
const xd = {
  borderRadius: 4
}, Ed = xd, kd = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, xt = kd;
function Er(e, t) {
  return t ? st(e, t, {
    clone: !1
...
const Sd = {
  ...
  if (e.length > 2)
    if (Fa[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Sd[t], o = Od[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), Tn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Cn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Pd = [...Tn, ...Cn];
function Lr(e, t, r, n) {
  var o;
...
function _d(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = Rd(r), a = $d(o, n), i = e[r];
  return ct(e, i, a);
}
function gs(e, t) {
  const r = hs(e.theme);
  return Object.keys(e).map((n) => _d(e, t, n, r)).reduce(Er, {});
}
function ye(e) {
  return gs(e, Tn);
}
...
we.filterProps = Cn;
process.env.NODE_ENV !== "production" && Pd.reduce((e, t) => (e[t] = xt, e), {});
function Md(e = 8) {
  if (e.mui)
    return e;
  const t = hs({
...
const Id = Ye("border", He), Ad = Ye("borderTop", He), Dd = Ye("borderRight", He), jd = Ye("borderBottom", He), Bd = Ye("borderLeft", He), Ld = Ye("borderColor"), Fd = Ye("borderTopColor"), Vd = Ye("borderRightColor"), zd = Ye("borderBottomColor"), Ud = Ye("borderLeftColor"), Hd = Ye("outline", He), Gd = Ye("outlineColor"), On = (e) => {
...
Sn(Id, Ad, Dd, jd, Bd, Ld, Fd, Vd, zd, Ud, On, Hd, Gd);
const Rn = (e) => {
...
Sn(Rn, Pn, $n, Wd, Xd, qd, Yd, Kd, Jd, Zd, Qd, eu);
function qt(e, t) {
  return t === "grey" ? t : e;
}
const tu = ke({
...
function fu() {
  ...
  function t(r) {
    ...
    function l(c) {
      ...
      if (!u)
        return null;
      const m = Nd(a.breakpoints), v = Object.keys(m);
      let g = m;
...
function Bo(e = {}, ...t) {
  ...
  return u.applyStyles = mu, u = t.reduce((m, v) => st(m, v), u), u.unstable_sxConfig = R({}, Do, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return jo({
      sx: v,
      theme: this
    });
...
const ku = Bo(), Va = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Yr({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Tu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    _c(i, (y) => y.filter((C) => !(C != null && C.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: g = Nu(Va(u))
    } = l, p = he(l, wu), h = m !== void 0 ? m : (
    ...
    let x = en;
    u === "Root" || u === "root" ? x = n : u ? x = o : Eu(i) && (x = void 0);
    const P = Pc(i, R({
      shouldForwardProp: x,
      label: b
    }, p)), w = (y) => typeof y == "function" && y.__emotion_real !== y || Rt(y) ? (C) => tn(y, R({}, C, {
      theme: Yr({
        theme: C.theme,
        defaultTheme: r,
        themeId: t
      ...
      c && g && A.push((k) => {
        ...
        if (!S.components || !S.components[c] || !S.components[c].styleOverrides)
          return null;
        const $ = S.components[c].styleOverrides, V = {};
        ...
        const $ = Yr(R({}, k, {
          defaultTheme: r,
          themeId: t
        })), V = $ == null || (S = $.components) == null || (S = S[c]) == null ? void 0 : S.variants;
        return tn({
          variants: V
        }, R({}, k, {
          theme: $
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${et(u || "")}`), k === void 0 && (k = `Styled(${qp(i)})`), L.displayName = k;
      }
...
function Lo(e, t = 0, r = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > r) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${r}].`), bd(e, t, r);
}
function Ou(e) {
  e = e.slice(1);
...
function za(e) {
  e = At(e);
  let t = e.type === "hsl" || e.type === "hsla" ? At(Ru(e)).values : e.values;
...
const Mu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ut = Vu, zu = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function Ga(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = $u(e.main, o) : t === "dark" && (e.dark = Pu(e.main, a)));
}
function Uu(e = "light") {
  return e === "dark" ? {
    main: Vt[200],
...
function Yu(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, zu), a = e.primary || Uu(t), i = e.secondary || Hu(t), l = e.error || Gu(t), c = e.info || Wu(t), u = e.success || Xu(t), m = e.warning || qu(t);
  function v(f) {
...
const rf = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], nf = rf, of = ["duration", "easing", "delay"], af = {
...
function cf(e) {
  const t = R({}, af, e.easing), r = R({}, sf, e.duration);
  return R({
...
const ws = (e) => en(e) && e !== "classes", hf = Tu({
  themeId: Vo,
  defaultTheme: Fo,
...
const bf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], vf = (e) => {
  ...
  const n = ut({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = he(n, bf), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", f = R({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
`)), fs.configure(e);
  ...
  createSvgIcon: xs,
  debounce: os,
  deprecatedPropType: Kp,
  isMuiElement: Jp,
  ownerDocument: Oe,
  ownerWindow: Jt,
  requirePropFactory: Zp,
  setRef: cn,
  unstable_ClassNameGenerator: wf,
...
}, Symbol.toStringTag, { value: "Module" })), Ef = /* @__PURE__ */ Op(xf);
var Ka;
function kf() {
...
var Es = $o.default = void 0, Tf = Nf(kf()), Cf = Dl;
Es = $o.default = (0, Tf.default)(/* @__PURE__ */ (0, Cf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function ks(e) {
...
}, Of = /* @__PURE__ */ N.createContext(Sf);
function Rf(e) {
  const {
...
function $f(e) {
  ...
  const i = Ns(R({}, o, n)), l = Ja(n), c = Ja(o), u = t(i), m = Se(u == null ? void 0 : u.className, r == null ? void 0 : r.className, a, o == null ? void 0 : o.className, n == null ? void 0 : n.className), v = R({}, u == null ? void 0 : u.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), g = R({}, u, r, c, l);
...
const Df = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function jf(e) {
...
function Ff(e) {
  const t = [], r = [];
  return Array.from(e.querySelectorAll(Df)).forEach((n, o) => {
    const a = jf(n);
    a === -1 || !Lf(n) || (a === 0 ? t.push(n) : r.push({
      documentOrder: o,
      tabIndex: a,
      node: n
    }));
...
`)), h.current.setAttribute("tabIndex", "-1")), p.current && h.current.focus()), () => {
    ...
    const w = Oe(h.current), E = (T) => {
      ...
      if (T.contains(w.activeElement) || n && w.activeElement !== u.current && w.activeElement !== m.current)
        return;
      ...
      if (!p.current)
        return;
      let A = [];
      if ((w.activeElement === u.current || w.activeElement === m.current) && (A = a(h.current)), A.length > 0) {
        var j, L;
...
process.env.NODE_ENV !== "production" && (un["propTypes"] = rs(un.propTypes));
function zf(e) {
...
function Jf(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), f = We(h, v), [b, x] = N.useState(!m), P = Yf(c);
  let w = !0;
  ...
  const k = (M) => (z) => {
    ...
    !A()) && (r || (z.stopPropagation(), u && u(z, "escapeKeyDown")));
  }, S = (M) => (z) => {
    var te;
    (te = M.onClick) == null || te.call(M, z), z.target === z.currentTarget && u && u(z, "backdropClick");
  };
  return {
    getRootProps: (M = {}) => {
      const z = Ns(e);
...
var Me = "top", Xe = "bottom", qe = "right", Ie = "left", Uo = "auto", Vr = [Me, Xe, qe, Ie], Zt = "start", Mr = "end", Zf = "clippingParents", Ss = "viewport", ur = "popper", Qf = "reference", ei = /* @__PURE__ */ Vr.reduce(function(e, t) {
  return e.concat([t + "-" + Zt, t + "-" + Mr]);
}, []), Os = /* @__PURE__ */ [].concat(Vr, [Uo]).reduce(function(e, t) {
  return e.concat([t, t + "-" + Zt, t + "-" + Mr]);
}, []), em = "beforeRead", tm = "read", rm = "afterRead", nm = "beforeMain", om = "main", am = "afterMain", im = "beforeWrite", sm = "write", lm = "afterWrite", cm = [em, tm, rm, nm, om, am, im, sm, lm];
function tt(e) {
...
function er(e, t, r) {
  ...
  var i = jt(e) ? ze(e) : window, l = i.visualViewport, c = !Rs() && r, u = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
function zr(e) {
  for (var t = ze(e), r = ti(e); r && fm(r) && pt(r).position === "static"; )
    r = ti(r);
  return r && (tt(r) === "html" || tt(r) === "body" && pt(r).position === "static") ? t : r || mm(e) || t;
}
function Wo(e) {
...
function bm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Ze(r.placement), c = Wo(l), u = [Ie, qe].indexOf(l) >= 0, m = u ? "height" : "width";
  if (!(!a || !i)) {
    var v = gm(o.padding, r), g = Go(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : qe, f = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], x = zr(a), P = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = f / 2 - b / 2, E = v[p], y = P - g[m] - v[h], C = P / 2 - g[m] / 2 + w, T = Nr(E, C, y), A = c;
...
function ri(e) {
  ...
  if (u) {
    var C = zr(r), T = "clientHeight", A = "clientWidth";
...
function oi(e, t, r) {
  return t === Ss ? mo(Om(e, r)) : jt(t) ? Pm(t, r) : mo(Rm(Et(e)));
}
function $m(e) {
...
function _m(e, t, r, n) {
  var o = t === "clippingParents" ? $m(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, u) {
    var m = oi(e, u, n);
...
function Ir(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? Zf : l, u = r.rootBoundary, m = u === void 0 ? Ss : u, v = r.elementContext, g = v === void 0 ? ur : v, p = r.altBoundary, h = p === void 0 ? !1 : p, f = r.padding, b = f === void 0 ? 0 : f, x = _s(typeof b != "number" ? b : Ms(b, Vr)), P = g === ur ? Qf : ur, w = e.rects.popper, E = e.elements[h ? P : g], y = _m(jt(E) ? E : E.contextElement || Et(e.elements.popper), c, m, i), C = er(e.elements.reference), T = As({
    reference: C,
    element: w,
    strategy: "absolute",
    placement: o
...
function Mm(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, i = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, u = c === void 0 ? Os : c, m = tr(n), v = m ? l ? ei : ei.filter(function(h) {
    return tr(h) === m;
...
function Am(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, u = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, f = r.allowedAutoPlacements, b = t.options.placement, x = Ze(b), P = x === b, w = c || (P || !h ? [rn(b)] : Im(b)), E = [b].concat(w).reduce(function(W, X) {
      ...
      var k = E[L], S = Ze(k), $ = tr(k) === Zt, V = [Me, Xe].indexOf(S) >= 0, H = V ? "width" : "height", M = Ir(t, {
        placement: k,
        boundary: m,
        rootBoundary: v,
        altBoundary: g,
...
function Gm(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, u = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, f = h === void 0 ? 0 : h, b = Ir(t, {
    boundary: c,
    rootBoundary: u,
    padding: v,
    altBoundary: m
  }), x = Ze(t.placement), P = tr(t.placement), w = !P, E = Wo(x), y = Hm(E), C = t.modifiersData.popperOffsets, T = t.rects.reference, A = t.rects.popper, j = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, L = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
  ...
  if (C) {
    if (a) {
      var $, V = E === "y" ? Me : Ie, H = E === "y" ? Xe : qe, M = E === "y" ? "height" : "width", z = C[E], te = z + b[V], Q = z - b[H], O = p ? -A[M] / 2 : 0, I = P === Zt ? T[M] : A[M], U = P === Zt ? -A[M] : -T[M], Y = t.elements.arrow, W = p && Y ? Go(Y) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : $s(), K = X[V], J = X[H], q = Nr(0, T[M], W[M]), Z = w ? T[M] / 2 - O - q - K - L.mainAxis : I - q - K - L.mainAxis, ee = w ? -T[M] / 2 + O + q + J + L.mainAxis : U + q + J + L.mainAxis, se = t.elements.arrow && zr(t.elements.arrow), B = se ? E === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, re = ($ = k == null ? void 0 : k[E]) != null ? $ : 0, D = z + Z - re - B, le = z + ee - re, Ne = Nr(p ? fn(te, D) : te, z, p ? _t(Q, le) : Q);
      C[E] = Ne, S[E] = Ne - z;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Me : Ie, kt = E === "x" ? Xe : qe, $e = C[y], nt = y === "y" ? "height" : "width", je = $e + b[Ee], ot = $e - b[kt], Te = [Me, Ie].indexOf(x) !== -1, Bt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Nt = Te ? je : $e - T[nt] - A[nt] - Bt + L.altAxis, or = Te ? $e + T[nt] + A[nt] - Bt - L.altAxis : ot, Hr = p && Te ? hm(Nt, $e, or) : Nr(p ? Nt : je, $e, p ? or : ot);
      C[y] = Hr, S[y] = Hr - $e;
    }
    t.modifiersData[n] = S;
  }
...
function Km(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && Ym(t), a = Et(t), i = er(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Yo(a)) && (l = qm(t)), Ge(t) ? (c = er(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
  ...
  return function(l, c, u) {
    ...
    var m = {
      ...
      setOptions: function(x) {
        ...
        var w = Zm(eh([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (li(P, w)) {
            m.rects = {
              reference: Km(P, zr(w), m.options.strategy === "fixed"),
              popper: Go(w)
...
var rh = [Tm, Um, km, um, Vm, Dm, Wm, ym, Bm], nh = /* @__PURE__ */ th({
  defaultModifiers: rh
});
const Ds = "Popper";
function oh(e) {
...
Af(Ds, ["root"]);
const ah = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], ih = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function sh(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const ch = () => dt({
  root: ["root"]
}, Rf(oh)), ph = {}, dh = /* @__PURE__ */ N.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, b = he(t, ah), x = N.useRef(null), P = We(x, r), w = N.useRef(null), E = We(w, g), y = N.useRef(E);
  It(() => {
    y.current = E;
  }, [E]), N.useImperativeHandle(g, () => w.current, []);
  const C = sh(m, i), [T, A] = N.useState(C), [j, L] = N.useState(mn(o));
  N.useEffect(() => {
...
`));
  ...
  const S = ch(), $ = (n = h.root) != null ? n : "div", V = Dt({
    elementType: $,
  ...
  const {
    ...
    slotProps: b = {},
    slots: x = {}
  } = t, P = he(t, ih), [w, E] = N.useState(!0), y = () => {
    E(!1);
  }, C = () => {
    E(!0);
  };
...
const hh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function bo(e) {
  return `scale(${e}, ${e ** 2})`;
}
const gh = {
  ...
  } = t, x = he(t, hh), P = br(), w = N.useRef(), E = Ur(), y = N.useRef(null), C = We(y, a.ref, r), T = (H) => (M) => {
    if (H) {
      const z = y.current;
      M === void 0 ? H(z) : H(z, M);
    }
...
const vo = Ko, bh = (e) => {
...
}, pi = bh, vh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yh = Re(js, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = vs(), a = ut({
    ...
    slots: w,
    slotProps: E
  } = a, y = he(a, vh), C = (n = w == null ? void 0 : w.root) != null ? n : c == null ? void 0 : c.Root, T = R({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const xh = wt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), bt = xh, Eh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function kh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Nh = (e) => {
...
const Us = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const C = ut({
    ...
    TransitionProps: re
  } = C, D = he(C, Eh), le = /* @__PURE__ */ N.isValidElement(A) ? A : /* @__PURE__ */ d("span", {
    children: A
  }), Ne = Ur(), Pe = Ne.direction === "rtl", [Ee, kt] = N.useState(), [$e, nt] = N.useState(null), je = N.useRef(!1), ot = V || Q, Te = br(), Bt = br(), Nt = br(), or = br(), [Hr, ea] = is({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const An = as(O), ar = N.useRef(), Gr = Pr(() => {
  ...
  const ta = (ne) => {
    ...
    je.current && ne.type !== "touchstart" || (Ee && Ee.removeAttribute("title"), Bt.clear(), Nt.clear(), M || Jr && z ? Bt.start(Jr ? z : M, () => {
      ta(ne);
    }) : ta(ne));
  }, ra = (ne) => {
    Bt.clear(), Nt.start(I, () => {
    ...
    le.props.onTouchEnd && le.props.onTouchEnd(ne), Gr(), Nt.start(U, () => {
      Wr(ne);
    });
  };
  N.useEffect(() => {
...
`));
  ...
  const sr = {};
  H || (Ue.onTouchStart = Sl, Ue.onTouchEnd = Ol), $ || (Ue.onMouseOver = Zr(la, Ue.onMouseOver), Ue.onMouseLeave = Zr(ca, Ue.onMouseLeave), ot || (sr.onMouseOver = la, sr.onMouseLeave = ca)), S || (Ue.onFocus = Zr(ia, Ue.onFocus), Ue.onBlur = Zr(aa, Ue.onBlur), ot || (sr.onFocus = ia, sr.onBlur = aa)), process.env.NODE_ENV !== "production" && le.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${le.props.title}\` or the Tooltip component.`].join(`
`));
  const $l = N.useMemo(() => {
    var ne;
    let Be = [{
    ...
    touch: je.current
  }), Ln = Nh(lr), pa = (n = (o = ee.popper) != null ? o : j.Popper) != null ? n : Th, da = (a = (i = (l = ee.transition) != null ? l : j.Transition) != null ? i : B) != null ? a : vo, ua = (c = (u = ee.tooltip) != null ? u : j.Tooltip) != null ? c : Ch, fa = (m = (v = ee.arrow) != null ? v : j.Arrow) != null ? m : Sh, _l = vr(pa, R({}, q, (g = Z.popper) != null ? g : L.popper, {
    ...
    children: [/* @__PURE__ */ N.cloneElement(le, Ue), /* @__PURE__ */ d(pa, R({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ _(ua, R({}, Il, {
          children: [se, T ? /* @__PURE__ */ d(fa, R({}, Al, {
            ref: nt
          })) : null]
        }))
      }))
...
const Oh = Us;
function ui(e, t, r) {
  return e ? /* @__PURE__ */ d(Oi, { className: `papi-menu-icon-${r ? "leading" : "trailing"}`, children: /* @__PURE__ */ d("img", { src: e, alt: `${r ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function Hs(e) {
  const {
    onClick: t,
    ...
    wc,
    {
      ...
      children: r ? /* @__PURE__ */ _(yt, { children: [
        ui(a, r, !0),
        /* @__PURE__ */ d(xc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Oi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(Es, {}) }) : ui(i, r, !1)
      ] }) : b
    }
  );
  return n ? /* @__PURE__ */ d(Oh, { title: n, placement: "right", children: /* @__PURE__ */ d("div", { children: x }) }) : x;
}
function Gs(e) {
...
function Rh(e) {
  const [t, r] = ie(void 0), { parentMenuItem: n, parentItemProps: o, menuDefinition: a } = e, i = (u) => {
    ...
    let u = Gs(a).filter((m) => "menuItem" in m.group);
    if (!(n != null && n.id))
  ...
  return /* @__PURE__ */ _(yt, { children: [
    /* @__PURE__ */ d(Hs, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ d(
      Ec,
      {
        anchorEl: t,
...
const Ph = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function Jo(e) {
  ...
  return /* @__PURE__ */ _(
    Ri,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(kc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          $h,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Dh = ["children", "className", "component", "dense", "disablePadding", "subheader"], jh = (e) => {
  const {
    classes: t,
    disablePadding: r,
    dense: n,
  ...
  return /* @__PURE__ */ d(Ih.Provider, {
    value: v,
    children: /* @__PURE__ */ _(Bh, R({
      as: i,
...
const Lh = Xs, Fh = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Qn(e, t, r) {
...
const Ys = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  } = t, g = he(t, Fh), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const f = (w) => {
    ...
    if (y === "ArrowDown")
      w.preventDefault(), mr(E, C, u, c, Qn);
    else if (y === "ArrowUp")
      w.preventDefault(), mr(E, C, u, c, fi);
    else if (y === "Home")
      w.preventDefault(), mr(E, null, u, c, Qn);
    else if (y === "End")
...
const Vh = Ys, zh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Uh = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const n = Ur(), o = {
  ...
  } = t, w = he(t, zh), E = N.useRef(null), y = We(E, l.ref, r), C = (V) => (H) => {
    if (V) {
      const M = E.current;
      H === void 0 ? V(M) : V(M, H);
    }
    ...
    V.style.webkitTransition = n.transitions.create("opacity", M), V.style.transition = n.transitions.create("opacity", M), m && m(V, H);
  }), j = C(v), L = C(f), k = C((V) => {
    const H = hn({
      style: b,
      timeout: x,
    ...
    V.style.webkitTransition = n.transitions.create("opacity", H), V.style.transition = n.transitions.create("opacity", H), p && p(V);
  }), S = C(h);
  return /* @__PURE__ */ d(P, R({
    ...
    children: (V, H) => /* @__PURE__ */ N.cloneElement(l, R({
      style: R({
        opacity: 0,
        visibility: V === "exited" && !u ? "hidden" : void 0
      }, Uh[V], b, l.props.style),
      ref: y
    }, H))
  }));
});
...
const Wh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Xh = (e) => {
  ...
  const i = ut({
    ...
    slotProps: h = {},
    slots: f = {},
    TransitionComponent: b = Hh,
    transitionDuration: x
  } = i, P = he(i, Wh), w = R({}, i, {
    component: u,
    invisible: g
  }), E = Xh(w), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ d(b, R({
    in: p,
    timeout: x
  }, P, {
    children: /* @__PURE__ */ d(qh, R({
      "aria-hidden": !0
    }, y, {
...
const Jh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Zh = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  const J = (n = (o = V == null ? void 0 : V.root) != null ? o : x.Root) != null ? n : Qh, q = (a = (i = V == null ? void 0 : V.backdrop) != null ? i : x.Backdrop) != null ? a : m, Z = (l = $ == null ? void 0 : $.root) != null ? l : P.root, ee = (c = $ == null ? void 0 : $.backdrop) != null ? c : P.backdrop, se = Dt({
    elementType: J,
    externalSlotProps: Z,
  ...
  return !L && !S && (!Y || U) ? null : /* @__PURE__ */ d(_r, {
    ref: O,
    container: f,
    disablePortal: C,
    children: /* @__PURE__ */ _(J, R({}, se, {
      children: [!j && m ? /* @__PURE__ */ d(q, R({}, B)) : null, /* @__PURE__ */ d(un, {
        disableEnforceFocus: E,
        disableAutoFocus: w,
        disableRestoreFocus: T,
        isEnabled: I,
...
const ng = ["className", "component", "elevation", "square", "variant"], og = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
...
const lg = ["onEntering"], cg = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], pg = ["slotProps"];
function mi(e, t) {
  let r = 0;
...
const dg = (e) => {
  ...
  const i = ut({
  ...
  } = i, L = he(i.TransitionProps, lg), k = he(i, cg), S = (n = E == null ? void 0 : E.paper) != null ? n : P, $ = N.useRef(), V = We($, S.ref), H = R({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: f,
    marginThreshold: b,
    ...
    const re = nn(c), D = re && re.nodeType === 1 ? re : Oe($.current).body, le = D.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const kt = Pe + D.height, $e = Ee + D.width, nt = Jt(nn(c)), je = nt.innerHeight - b, ot = nt.innerWidth - b;
    if (b !== null && Pe < b) {
      const Te = Pe - b;
...
`)), b !== null && Ee < b) {
  ...
  const K = h || (c ? Oe(nn(c)).body : void 0), J = (o = w == null ? void 0 : w.root) != null ? o : ug, q = (a = w == null ? void 0 : w.paper) != null ? a : el, Z = Dt({
    elementType: q,
  ...
  return /* @__PURE__ */ d(J, R({}, B, !ks(J) && {
    slotProps: se,
    disableScrollLock: j
  }, {
    children: /* @__PURE__ */ d(C, R({
      appear: !0,
      in: x,
      onEntering: Y,
      onExited: W,
...
const hg = ["onEntering"], gg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], bg = {
  vertical: "top",
  horizontal: "right"
}, vg = {
  vertical: "top",
  ...
  const a = ut({
    ...
    slots: P = {},
    slotProps: w = {}
  } = a, E = he(a.TransitionProps, hg), y = he(a, gg), C = Ur(), T = C.direction === "rtl", A = R({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: x
  }), j = yg(A), L = i && !u && g, k = N.useRef(null), S = (Q, O) => {
...
`)), Q.props.disabled || (x === "selectedMenu" && Q.props.selected || V === -1) && (V = O));
  });
  const H = (n = P.paper) != null ? n : xg, M = (o = w.paper) != null ? o : p, z = Dt({
    elementType: P.root,
  ...
  return /* @__PURE__ */ d(wg, R({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: T ? "right" : "left"
    },
    transformOrigin: T ? bg : vg,
    slots: {
      paper: H,
      root: P.root
    },
...
const gt = "scrBook", Sg = "scrRef", Ot = "source", Og = "details", Rg = "Scripture Reference", Pg = "Scripture Book", nl = "Type", $g = "Details";
function _g(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      id: gt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Rg,
      cell: (n) => {
        const o = n.row.original;
        return n.row.getIsGrouped() ? me.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === gt ? Vn(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Og,
      header: (e == null ? void 0 : e.detailsColumnName) ?? $g,
      cell: (n) => n.getValue(),
      enableGrouping: !1
    }
  ];
...
function Av({
  ...
  const [c, u] = ie([]), [m, v] = ie([{ id: gt, desc: !1 }]), [g, p] = ie(() => e.flatMap((k) => {
    const S = k.source;
    return k.data.map(($) => ({
      ...$,
      source: S
  ...
  Ve(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const $ = g.find((V) => P(V) === S[0]) || void 0;
        $ && l($);
      }
    }
  }, [h, g, P, l, w]);
  const E = o ?? Pg, y = a ?? nl, C = [
  ...
  }, j = (k, S) => k.getIsGrouped() ? "" : F("banded-row", S % 2 === 0 ? "even" : "odd"), L = (k, S, $) => {
    ...
    !t && /* @__PURE__ */ _(
      an,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Or, { position: "item-aligned", children: /* @__PURE__ */ d(pp, { children: C.map((k) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ _(wn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(xn, { children: w.getHeaderGroups().map((k) => /* @__PURE__ */ d(vt, { children: k.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ d(En, { children: w.getRowModel().rows.map((k, S) => /* @__PURE__ */ d(
        vt,
        {
...
), ol = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d($i.Root, { ref: r, className: F(Mg(), e), ...t }));
...
function Ig({
  ...
  return /* @__PURE__ */ _("div", { className: F("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": n }), children: [
    ...
    /* @__PURE__ */ d("p", { className: F({ "pr-hidden": !o }), children: o })
  ] });
}
function Dv({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [n, o] = ie(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ d(
...
function Fv({
  ...
  const a = $t(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Oc, { position: "static", id: n, children: /* @__PURE__ */ _(Rc, { className: `papi-toolbar ${r ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ d(
      Cg,
      {
        commandHandler: t,
...
const Vv = De.Root, Ag = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.List,
  {
    ref: r,
    className: F(
...
Ag.displayName = De.List.displayName;
const Dg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    className: F(
...
Dg.displayName = De.Trigger.displayName;
...
jg.displayName = De.Content.displayName;
...
Bg.displayName = De.List.displayName;
...
const zv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Trigger,
  {
    ref: r,
    ...t,
...
)), Fg = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  De.Content,
  {
    ref: r,
    className: F(
...
Fg.displayName = De.Content.displayName;
const Qr = (e) => e === "asc" ? /* @__PURE__ */ d(Zl, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(Ql, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(ec, { className: "pr-ml-2 pr-h-4 pr-w-4" }), Vg = (e, t, r, n, o) => [
  {
...
function Ug({
  ...
  return Ve(
    ...
    /* @__PURE__ */ d(xn, { children: /* @__PURE__ */ _(vt, { children: [
      /* @__PURE__ */ d(Rr, { children: a }),
      /* @__PURE__ */ d(Rr, { children: i })
    ] }) }),
    /* @__PURE__ */ d(En, { children: l.map((u) => /* @__PURE__ */ _(
      vt,
      {
        onClick: () => {
          n(u.reference);
...
function Uv({
  ...
  return Ve(() => {
    ...
    /* @__PURE__ */ _("div", { className: "pr-flex", children: [
      ...
      /* @__PURE__ */ _(an, { onValueChange: (M) => C(M), defaultValue: y, children: [
    ...
    $ !== "" && /* @__PURE__ */ d("div", { className: "pr-mt-4 pr-rounded-md pr-border", children: /* @__PURE__ */ d(
      Ug,
      {
        selectedCharacter: $,
        text: w,
...
function Hv({
  ...
  return /* @__PURE__ */ d(
    ve,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ d(gn, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ _(yt, { children: [
        /* @__PURE__ */ d(tc, { size: 25, className: F("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
const Gg = ["children", "options"], vi = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), yi = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Wg = ["style", "script"], Xg = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, qg = /mailto:/i, Yg = /\n{2,}$/, al = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, Kg = /^ *> ?/gm, Jg = /^ {2,}\n/, Zg = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, il = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, sl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Qg = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, eb = /^(?:\n *)*\n/, tb = /\r\n?/g, rb = /^\[\^([^\]]+)](:.*)\n/, nb = /^\[\^([^\]]+)]/, ob = /\f/g, ab = /^\s*?\[(x|\s)\]/, ll = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, cl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, pl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, wo = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, ib = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, dl = /^<!--[\s\S]*?(?:-->)/, sb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, xo = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, lb = /^\{.*\}$/, cb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, pb = /^<([^ >]+@[^ >]+)>/, db = /^<([^ >]+:\/[^ >]+)>/, ub = /-([a-z])?/gi, ul = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, fb = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, mb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, hb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, gb = /(\[|\])/g, bb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, vb = /\t/g, yb = /^ *\| */, wb = /(^ *\||\| *$)/g, xb = / *$/, Eb = /^ *:-+: *$/, kb = /^ *:-+ *$/, Nb = /^ *-+: *$/, Tb = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, Cb = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, Sb = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, Ob = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, Rb = /^\\([^0-9A-Za-z\s])/, Pb = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, $b = /^\n+/, _b = /^([ \t]*)/, Mb = /\\([^\\])/g, wi = / *\n+$/, Ib = /(?:^|\n)( *)$/, Zo = "(?:\\d+\\.)", Qo = "(?:[*+-])";
function fl(e) {
  return "( *)(" + (e === 1 ? Zo : Qo) + ") +";
}
...
function xi(e, t) {
  const r = t === 1, n = r ? xl : El, o = r ? vl : yl, a = r ? Ab : Db;
  return { t(i, l, c) {
    const u = Ib.exec(c);
    return u && (l.o || !l._ && !l.u) ? n.exec(i = u[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const u = r ? +i[2] : void 0, m = i[0].replace(Yg, `
`).match(o);
    let v = !1;
...
const jb = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Bb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, kl = [al, il, sl, ll, pl, cl, dl, ul, vl, xl, yl, El], Lb = [...kl, /^[^\n]+(?:  \n|\n{2,})/, wo, xo];
function Fb(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function Vb(e) {
  return Nb.test(e) ? "right" : Eb.test(e) ? "center" : kb.test(e) ? "left" : null;
}
function Ei(e, t, r) {
  const n = r.$;
  r.$ = !0;
  ...
  return o.forEach(function(i, l) {
    i.type === "tableSeparator" ? l !== 0 && l !== o.length - 1 && a.push([]) : (i.type !== "text" || o[l + 1] != null && o[l + 1].type !== "tableSeparator" || (i.v = i.v.replace(xb, "")), a[a.length - 1].push(i));
  }), a;
}
function zb(e, t, r) {
  r._ = !0;
  const n = Ei(e[1], t, r), o = e[2].replace(wb, "").split("|").map(Vb), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(u) {
      return Ei(u, l, c);
    });
...
var ae;
function Xb(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || Fb, t.namedCodesToUnicode = t.namedCodesToUnicode ? Pt({}, yi, t.namedCodesToUnicode) : yi;
  ...
  function n(p, h, ...f) {
    ...
    }(p, t.overrides), Pt({}, h, b, { className: Wb(h == null ? void 0 : h.className, b.className) || void 0 }), ...f);
  }
  function o(p) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = bb.test(p) === !1);
    const f = m(u(h ? p : `${p.trimEnd().replace($b, "")}
...
`, { _: h }));
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(f, b, x) {
      ...
      if (P !== -1) {
        const w = function(T) {
          return T.indexOf("-") !== -1 && T.match(sb) === null && (T = T.replace(ub, function(A, j) {
          ...
          }, {}) : T === "href" ? Gt(A) : (A.match(lb) && (A = A.slice(1, A.length - 1)), A === "true" || A !== "false" && A);
        }(w, E);
  ...
  const i = [], l = {}, c = { blockQuote: { t: it(al), i: ae.HIGH, l: (p, h, f) => ({ v: h(p[0].replace(Kg, ""), f) }), h: (p, h, f) => n("blockquote", { key: f.k }, h(p.v, f)) }, breakLine: { t: hr(Jg), i: ae.HIGH, l: to, h: (p, h, f) => n("br", { key: f.k }) }, breakThematic: { t: it(Zg), i: ae.HIGH, l: to, h: (p, h, f) => n("hr", { key: f.k }) }, codeBlock: { t: it(sl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, f) => n("pre", { key: f.k }, n("code", Pt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: it(il), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: ht(Qg), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, f) => n("code", { key: f.k }, p.v) }, footnote: { t: it(rb), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: ro }, footnoteReference: { t: mt(nb), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, f) => n("a", { key: f.k, href: Gt(p.B) }, n("sup", { key: f.k }, p.v)) }, gfmTask: { t: mt(ab), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, f) => n("input", { checked: p.R, key: f.k, readOnly: !0, type: "checkbox" }) }, heading: { t: it(t.enforceAtxHeadings ? cl : ll), i: ae.HIGH, l: (p, h, f) => ({ v: on(h, p[2], f), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, f) => n(`h${p.C}`, { id: p.T, key: f.k }, h(p.v, f)) }, headingSetext: { t: it(pl), i: ae.MAX, l: (p, h, f) => ({ v: on(h, p[1], f), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: hr(dl), i: ae.HIGH, l: () => ({}), h: ro }, image: { t: ht(Bb), i: ae.HIGH, l: (p) => ({ D: p[1], B: Ni(p[2]), F: p[3] }), h: (p, h, f) => n("img", { key: f.k, alt: p.D || void 0, title: p.F || void 0, src: Gt(p.B) }) }, link: { t: mt(jb), i: ae.LOW, l: (p, h, f) => ({ v: Hb(h, p[1], f), B: Ni(p[2]), F: p[3] }), h: (p, h, f) => n("a", { key: f.k, href: Gt(p.B), title: p.F }, h(p.v, f)) }, linkAngleBraceStyleDetector: { t: mt(db), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : mt(cb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: mt(pb), i: ae.MAX, l(p) {
    let h = p[1], f = p[1];
    return qg.test(f) || (f = "mailto:" + f), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: f, type: "link" };
  } }, orderedList: xi(n, 1), unorderedList: xi(n, 2), newlineCoalescer: { t: it(eb), i: ae.LOW, l: to, h: () => `
` }, paragraph: { t: Ub, i: ae.LOW, l: eo, h: (p, h, f) => n("p", { key: f.k }, h(p.v, f)) }, ref: { t: mt(fb), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: ro }, refImage: { t: ht(mb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, f) => n("img", { key: f.k, alt: p.D, src: Gt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: mt(hb), i: ae.MAX, l: (p, h, f) => ({ v: h(p[1], f), Z: h(p[0].replace(gb, "\\$1"), f), P: p[2] }), h: (p, h, f) => l[p.P] ? n("a", { key: f.k, href: Gt(l[p.P].B), title: l[p.P].F }, h(p.v, f)) : n("span", { key: f.k }, h(p.Z, f)) }, table: { t: it(ul), i: ae.HIGH, l: zb, h: (p, h, f) => n("table", { key: f.k }, n("thead", null, n("tr", null, p.L.map(function(b, x) {
  ...
  }, h: () => " | " }, text: { t: hr(Pb), i: ae.MIN, l: (p) => ({ v: p[0].replace(ib, (h, f) => t.namedCodesToUnicode[f] ? t.namedCodesToUnicode[f] : h) }), h: (p) => p.v }, textBolded: { t: ht(Tb), i: ae.MED, l: (p, h, f) => ({ v: h(p[2], f) }), h: (p, h, f) => n("strong", { key: f.k }, h(p.v, f)) }, textEmphasized: { t: ht(Cb), i: ae.LOW, l: (p, h, f) => ({ v: h(p[2], f) }), h: (p, h, f) => n("em", { key: f.k }, h(p.v, f)) }, textEscaped: { t: ht(Rb), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: ht(Sb), i: ae.LOW, l: eo, h: (p, h, f) => n("mark", { key: f.k }, h(p.v, f)) }, textStrikethroughed: { t: ht(Ob), i: ae.LOW, l: eo, h: (p, h, f) => n("del", { key: f.k }, h(p.v, f)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: hr(wo), i: ae.HIGH, l(p, h, f) {
    const [, b] = p[3].match(_b), x = new RegExp(`^${b}`, "gm"), P = p[3].replace(x, ""), w = (E = P, Lb.some((A) => A.test(E)) ? Gb : on);
    var E;
    const y = p[1].toLowerCase(), C = Wg.indexOf(y) !== -1;
    f.N = f.N || y === "a";
...
const Yb = Eo((e, t) => /* @__PURE__ */ _(
  ve,
  {
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(rc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        No,
        {
...
var Kb = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(Kb || {});
function Yv({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ _(Ro, { children: [
    /* @__PURE__ */ d(Bi, { asChild: !0, children: /* @__PURE__ */ d(Yb, {}) }),
    /* @__PURE__ */ d(vn, { children: t.map((r) => /* @__PURE__ */ _("div", { children: [
      /* @__PURE__ */ d(Dr, { children: r.label }),
      /* @__PURE__ */ d(qc, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Po, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(Fi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(yn, {})
    ] }, r.label)) })
  ] }) });
}
function Kv({ id: e, message: t }) {
      ...
      children: [
        ...
        /* @__PURE__ */ _("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ _("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(nc, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ _("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          /* @__PURE__ */ _(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ d(oc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ _(
...
function Jb({ id: e, versionHistory: t }) {
...
function Zv({
  ...
  return /* @__PURE__ */ d("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ _("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ d(Jb, { versionHistory: o }),
...
ev.displayName = "CardTitle";
const tv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: F("pr-text-sm pr-text-muted-foreground", e), ...t }));
tv.displayName = "CardDescription";
const rv = G.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-p-6 pr-pt-0", e), ...t })
);
rv.displayName = "CardContent";
const nv = G.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-flex pr-items-center pr-p-6 pr-pt-0", e), ...t })
);
nv.displayName = "CardFooter";
const ov = To(
...
), av = G.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: F(ov({ variant: t }), e), ...r }));
av.displayName = "Alert";
const iv = G.forwardRef(
...
const sv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: F("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
sv.displayName = "AlertDescription";
const lv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ _(
  gr.Root,
  {
    ref: r,
    className: F(
...
lv.displayName = gr.Root.displayName;
const cv = G.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  io.Root,
  {
    className: F(
...
cv.displayName = io.Root.displayName;
function pv(e, t = "top") {
...
export {
  av as Alert,
  sv as AlertDescription,
  iv as AlertTitle,
  Pv as BookChapterControl,
  ve as Button,
  Zb as Card,
  rv as CardContent,
  tv as CardDescription,
  nv as CardFooter,
  Qb as CardHeader,
  ev as CardTitle,
  $v as ChapterRangeSelector,
  Uv as CharacterInventory,
  Cp as Checkbox,
  _v as Checklist,
  Ea as ComboBox,
  Mv as ContextMenu,
  ...
  Kb as DropdownMenuItemType,
  Dr as DropdownMenuLabel,
  Sv as DropdownMenuPortal,
  Rv as DropdownMenuRadioGroup,
  ...
  Gv as EnableButton,
  Yb as FilterButton,
  Yv as FilterDropdown,
  Zv as Footer,
  Mh as GridMenu,
  Cg as HamburgerMenuButton,
  Iv as IconButton,
  bn as Input,
  Hv as InstallButton,
  ol as Label,
  ...
  Fv as Toolbar,
  Xv as UpdateButton,
  Jb as VersionHistory,
  Bg as VerticalTabs,
  Fg as VerticalTabsContent,
  Lg as VerticalTabsList,
  zv as VerticalTabsTrigger,
  lp as buttonVariants,
  Qv as useEvent,
  e0 as useEventAsync,
  yo as usePromise
};
