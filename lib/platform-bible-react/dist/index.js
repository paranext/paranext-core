...
import { c as b, g as Te, a as zr, C as Ue, L as Un, u as Jo, T as Dt, b as Nt, d as Ct, e as Et, A as ha, D as Oe, f as xe, h as Me, i as br, j as Ae, B as X, x as fs, k as ms, l as vs, I as bs, m as _o, n as Be, r as _e, o as xs, p as Kn, P as Xe, q as xr, s as Ze, t as Je, v as Na, w as Ca, y as No, z as Qe, E as Ea, F as Rt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as $r, U as Vr, V as dr, W as ys, X as We, Y as Le, Z as ze, _ as $e, $ as wr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as qn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as Gn, aa as Ta, ab as Cs, ac as Wn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Os, ak as Yn, al as Xn, am as Do, an as Ms, ao as Zn, ap as Ba, aq as tn, ar as ja, as as zs, at as Is, au as Ps, av as As, aw as $s, ax as jr, ay as Oo, az as Vs, aA as Ls } from "./resizable-DgWO6rDX.js";
...
import { Check as je, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Jn, ChevronDown as Ye, ArrowLeft as Bs, ArrowRight as js, BoldIcon as Fs, ItalicIcon as Us, X as Mo, AtSign as Qn, Pencil as Ks, Trash2 as Hs, ArrowUp as ti, MoreHorizontal as qs, MailOpen as Gs, Mail as Ws, FilterIcon as Ys, ArrowLeftIcon as Xs, ChevronLeftIcon as Zs, ChevronRightIcon as Js, ArrowRightIcon as Qs, Copy as ei, Filter as tc, User as ec, Link as rc, CircleHelp as ac, Undo as oc, Redo as nc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as ic, AlertCircle as so, CircleCheckIcon as sc, CircleXIcon as cc, CircleHelpIcon as lc, ArrowUpIcon as dc, ArrowDownIcon as wc, ScrollText as uc, ChevronRight as pc, ChevronLeft as hc, ChevronsUpDown as gc, MenuIcon as fc, Menu as mc, EllipsisVertical as vc, MoreVertical as bc } from "lucide-react";
import { Section as St, compareScrRefs as ma, getChaptersForBook as xc, formatScrRef as Se, formatReplacementString as Ve, getSectionForBook as ia, formatRelativeDate as yc, sanitizeHtml as zo, NumberFormat as ni, formatBytes as kc, getCurrentLocale as _c, usfmMarkers as sa, isPlatformError as Nc, ABORTED as Cc, getErrorMessage as Ec, getFormatCallerFunction as Tc, deepEqual as Sc, isString as on, scrRefToBBBCCCVVV as Fa, defaultScrRef as Ua, formatScrRefRange as Rc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Dc } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as $, createContext as Fr, useContext as Sa, useState as N, useEffect as Y, useCallback as j, useId as co, useImperativeHandle as Oc, useLayoutEffect as Xt, Fragment as Ur, Component as Mc, createElement as cn, Suspense as zc, forwardRef as ii } from "react";
...
import { createEditor as li, $getRoot as Fe, $createParagraphNode as Kr, $getSelection as re, HISTORY_MERGE_TAG as Io, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Kc, $isRangeSelection as ye, $caretFromPoint as Hc, $getSiblingCaret as ui, $getChildCaret as qc, $getAdjacentChildCaret as Gc, $isChildCaret as Wc, $normalizeCaret as Yc, $setSelectionFromCaretRange as Xc, $getCollapsedCaretRange as Zc, $getCaretInDirection as ln, $splitAtPointCaretNext as Jc, $isTextPointCaret as Qc, $findMatchingParent as pi, $isElementNode as Lr, mergeRegister as De, getDOMTextNode as tl, isHTMLElement as el, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as Po, shallowMergeConfig as rl, defineExtension as ce, safeCast as tr, createState as al, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as ol, LineBreakNode as nl, TabNode as il, $isEditorState as sl, createCommand as cl, CLICK_COMMAND as ll, isDOMNode as dl, $getNodeFromDOMNode as wl, $createNodeSelection as ul, $setSelection as pl, $getEditor as hl, DecoratorNode as lo, $getState as gl, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as fl, $setState as ml, addClassNamesToElement as vi, $create as vl, $getNodeByKey as bl, removeClassNamesFromElement as xl, KEY_TAB_COMMAND as yl, $isBlockElementNode as kl, $createRangeSelection as _l, $normalizeSelection__EXPERIMENTAL as Nl, OUTDENT_CONTENT_COMMAND as Cl, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as El, COMMAND_PRIORITY_CRITICAL as Ao, $isDecoratorNode as Tl, $isParagraphNode as Sl, $isTextNode as wo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Rl } from "lexical";
...
import { Avatar as $o, Select as Zt, Checkbox as un, Slot as Hr, Tabs as he, Menubar as Ne, ContextMenu as Ut, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
import { useReactTable as yi, getFilteredRowModel as Vl, getSortedRowModel as ki, getPaginationRowModel as Ll, getCoreRowModel as _i, flexRender as Ir, getGroupedRowModel as Bl, getExpandedRowModel as jl } from "@tanstack/react-table";
import Fl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Ul, isInsertEmbedOpOfType as Rr, getMarkerMenuItems as Kl, defaultStyleInfo as Hl, Editorial as ql } from "@eten-tech-foundation/platform-editor";
...
function Ci({
  ...
  const f = B(!1), y = () => {
    ...
    () => zr(e, l),
    [e, l]
  ), C = !!h && !p, E = `${D} (${k})`, I = C ? g || `${E}, ${h}` : E, T = /* @__PURE__ */ u(
    Ue,
    {
      ref: t,
...
function ed({
  ...
  const M = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), O = I ? (
...
function nd({
  ...
  const [h, g] = N(!1), [f, y] = N(!1), x = co(), D = B(!1), k = w !== void 0, C = k ? w : h, E = n === "" ? "" : ee(n, ad), I = ee(s, od), T = (O) => {
    O || (D.current = !0, y(!1)), k || g(O), p == null || p(O);
  }, V = (O) => {
    if (O && D.current) {
      D.current = !1;
      return;
  ...
  return /* @__PURE__ */ u(Oe, { open: C, onOpenChange: T, modal: !1, children: [
    /* @__PURE__ */ a(Dt, { children: E ? /* @__PURE__ */ u(Nt, { open: f, onOpenChange: V, children: [
...
function Ha({
  ...
  const T = _e(), V = Ql(), [P, M] = N(!1), [O, W] = N(""), [F, et] = N(""), [_, tt] = N("books"), [z, R] = N(void 0), [q, ct] = N(
    void 0
  ), [nt, dt] = N(void 0), [yt, Z] = N(!1), [lt, ut] = N(!1), [gt, kt] = N(!1), [Tt, ft] = N(!1), Vt = B(null), Jt = B(!1), Ot = B(void 0), mt = B(void 0), Kt = B(void 0), Qt = B(void 0), Mt = B({}), zt = B({}), vt = j(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    if (!m) return;
    const v = O.startsWith(`${m.book} `) ? O : "", H = ta(v), ot = Mr(v);
    return {
      book: m.book,
  ...
  const { otLong: kr, ntLong: _r, dcLong: Nr, extraLong: Cr } = {
    ...
    (v) => {
      ...
      if (!(!!H && !!((Yo = Ot.current) != null && Yo.contains(H))) && (H != null && H.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const $t = Ot.current ? gd(Ot.current) : [];
        if ($t.length === 0) {
      ...
      const { isLetter: Bt, isDigit: Ht } = gn(v.key);
      if ((_ === "chapters" || _ === "verses") && (v.key === " " || v.key === "Enter")) {
        ...
        const ie = (() => {
          if (_ === "verses") {
            const Sr = q, Zo = nt, La = ta(O);
            return !Sr || !Zo || La === void 0 ? void 0 : {
              isDisabled: nr(Sr, Zo)(La),
              activate: () => G(La)
            };
          }
          const qt = z, ue = Mr(O);
      ...
      _ === "books" && ft(!0), xt.takeFocus && ((Xo = Ot.current) == null || Xo.focus());
      const te = pd({
        current: xt.current,
        key: v.key,
        max: xt.max,
    ...
    const { isLetter: H, isDigit: ot } = gn(v.key);
    (H || ot) && (v.preventDefault(), et((xt) => xt + v.key), (Ht = mt.current) == null || Ht.focus(), Z(!1));
  }, []);
  Xt(() => {
    const v = setTimeout(() => {
  ...
  return Xt(() => {
  ...
  }, [_, m, we, Q, O]), /* @__PURE__ */ u(Xe, { open: P, onOpenChange: Pt, modal: k, children: [
    ...
    /* @__PURE__ */ a(
      Ze,
      {
        ...
        onCloseAutoFocus: D,
        children: /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(
          Je,
          {
            ref: Ot,
            loop: !0,
...
function xn({
  ...
  const [C, E] = N(!1), I = d ?? l, T = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], V = (P, M) => {
    const O = l(P), W = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, F = `${M ?? ""}${O}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Ue,
      {
        value: O,
  ...
  return /* @__PURE__ */ u(Xe, { open: C, onOpenChange: E, ...k, children: [
    /* @__PURE__ */ a(xr, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
...
const Di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bd = Di ? Xt : Y, ra = { tag: Io };
...
const Td = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function Sd(t) {
...
function zd(t, e, r) {
  ...
  function l() {
    ...
    for (let D = 0; D < g.length; D++) {
      const k = g[D], C = i[D] || document.createElement("div"), E = C.style;
      ...
      const P = be(k.height);
      E.height !== P && (C.style.height = P, x = !0), C.parentNode !== c && (c.append(C), x = !0), i[D] = C;
    }
...
function Pd(t, e = Id) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), y = f.getKey(), x = h.offset, D = g.getNode(), k = D.getKey(), C = g.offset, E = t.getElementByKey(y), I = t.getElementByKey(k), T = r === null || E !== o || x !== n || y !== r.getKey(), V = s === null || I !== i || C !== c || k !== s.getKey();
      if ((T || V) && E !== null && I !== null) {
        const P = function(M, O, W, F, et, _, tt) {
          const z = (M._window ? M._window.document : document).createRange();
          return z.setStart(...yn(O, W, F)), z.setEnd(...yn(et, _, tt)), z;
        }(t, h, f, E, g, D, I);
        l(), l = zd(t, P, e);
      }
      r = f, o = E, n = x, s = D, i = I, c = C;
    });
  }
...
function Vd(t) {
  const e = re() || Kc();
  let r;
  if (ye(e)) r = Hc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || qc(Fe(), "previous").getFlipped().insert(Kr());
  }
...
function Ld(t, e, r) {
  ...
  return Qc(o) && va(283), o.insert(t.isInline() ? Kr().append(t) : t), ln(ui(t.getLatest(), "next"), e.direction);
}
function Bd(t) {
  const e = re();
  if (!ye(e)) return !1;
...
let ba, Re = 0, xa = 0, Ud = 0, bo = 0, da = 0;
function _n(t) {
  if (st === void 0) return;
  let e = t.n;
...
Wt.prototype.brand = jd, Wt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ii(this), Nn(this), Re++;
  const t = st;
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [$i], register: (t, e, r) => t.registerCommand(gi, (o) => {
  const n = re();
  if (fi(n) || ye(n)) for (const s of n.getNodes()) Gd(s) && s.toggleFormat(o);
  return !1;
}, mi) });
function Vi(t, e) {
  let r;
...
const jo = 0, yo = 1, Bi = 2, Ya = 3, aa = 4, cr = 5, Xa = 6, Dr = 7;
function Za(t) {
  return t.id === jo;
}
function ji(t) {
...
class Xd {
  ...
  register(e, r) {
    ...
    return this.state = function(s) {
      ...
      const s = this.state;
      s.id !== Dr && pt(309, String(o.id), String(Dr)), this.state = function(i) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Xa && pt(310, String(r.id), String(Xa)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Dr;
    }(e) || pt(316, String(e.id), String(Dr)), e;
  }
...
const Jd = ce({ config: tr({ setOptions: Cn, updateOptions: Cn }), init: ({ $initialEditorState: t = Zd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class pr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Za(s) || pt(300, i, n || "[unknown]"), Za(c = s) || pt(304, String(c.id), String(jo)), s = Object.assign(c, { id: yo }), o.state = s;
...
const tw = /* @__PURE__ */ new Set(), Sn = ce({ build(t, e, r) {
...
ce({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [hr], register(t, e, r) {
  ...
  return De(t.registerCommand(ew, (i) => {
    const c = re();
    if (!ye(c)) return !1;
...
function ow(t, e, r = Fi) {
  return De(t.registerCommand(yl, (o) => {
    const n = re();
    if (!ye(n)) return !1;
    o.preventDefault();
    const s = function(i) {
...
const nw = ce({ name: "@lexical/react/ReactProvider" });
function iw() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ye(f)) {
                const y = f.anchor;
                let x = y.getNode(), D = 0, k = 0;
                if (wo(x) && d >= 0 && w >= 0 && (D = d, k = d + w, f.setTextNodeRange(x, D, x, k)), D === k && p === "" || (f.insertRawText(p), x = y.getNode()), wo(x)) {
                  D = h, k = h + g;
                  const C = x.getTextContentSize();
                  D = D > C ? C : D, k = k > C ? C : k, f.setTextNodeRange(x, D, x, k);
                }
...
const Uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function fw({ onClear: t }) {
  const [e] = Ce();
  return gw(() => Ai(e, t), [e, t]), null;
}
const Hi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : Y;
function mw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: y, role: x = "textbox", spellCheck: D = !0, style: k, tabIndex: C, "data-testid": E, ...I }, T) {
...
function Cw({
  ...
  const [e] = Ce(), [r, o] = N(e), [n, s] = N("paragraph"), [i, c] = Nw(), l = () => {
  };
...
function Zi({
  ...
  return /* @__PURE__ */ u(Ca, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
        X,
        {
          "aria-label": i,
...
function nh({
  ...
  const [s, i] = N(zw), [c, l] = N(n), [d, w] = N(!1), p = B(void 0), h = B(null);
  Y(() => {
    let x = !0;
    const D = h.current;
    if (!D) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (x) => {
          x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), r()) : Ho(x) && (x.preventDefault(), x.stopPropagation(), se(s) && g());
        },
        onKeyDown: (x) => {
...
function zn({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a($w, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vw, { className: "tw:text-xs tw:font-medium", children: D }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : Ho(T) && (T.preventDefault(), T.stopPropagation(), se(w) && f());
              },
              onKeyDown: (T) => {
        ...
        I && /* @__PURE__ */ u(Oe, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(qs, {}) }) }),
...
function rs({
  ...
  const [F, et] = N(In), [_, tt] = N(), [z, R] = N(), q = o, [ct, nt] = N(!1), [dt, yt] = N(!1), [Z, lt] = N(!1), [ut, gt] = N(!1), [kt, Tt] = N(!1), [ft, Vt] = N(E), [Jt, Ot] = N(!1), mt = B(void 0), [Kt, Qt] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let S = !0;
    return (async () => {
  ...
  const vt = $(() => zt[0], [zt]), le = B(null), oe = B(void 0), ae = j(() => {
    var S;
    (S = oe.current) == null || S.call(oe), et(In);
  }, []), ge = j(() => {
    const S = !ft;
    Vt(S), Ot(!S), f == null || f(l, S);
  }, [ft, f, l]);
  Y(() => {
    nt(!1);
  }, [o]), Y(() => {
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              X,
              {
                ...
                children: ft ? /* @__PURE__ */ a(Gs, {}) : /* @__PURE__ */ a(Ws, {})
              }
            ),
            O === void 0 ? (
          ...
          o && /* @__PURE__ */ u(ht, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    ct ? /* @__PURE__ */ a(Jn, {}) : /* @__PURE__ */ a(Ye, {})
                  ] })
                ]
              }
            ),
            ...
            x !== !1 && (!dt || se(F)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  Ho(S) && (S.preventDefault(), S.stopPropagation(), (se(F) || _ !== void 0 && _ !== z) && G());
                },
                onKeyDown: (S) => {
                  Ko(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    ya,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ u(Xe, { open: Z, onOpenChange: lt, children: [
...
function jw({
  ...
  const O = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: O }), F = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : W, et = () => {
    const z = o ?? "accept";
    return z === "merged" ? t.mergedText ? /* @__PURE__ */ a(pa, { html: D }) : W : F(z === "reject" ? t.rejectedResultText : t.resultText);
      ...
      !w && !h && /* @__PURE__ */ u(ht, { children: [
        ...
        /* @__PURE__ */ a(
          Co,
          {
            ...
            children: T.map((z) => _(z) ? /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Nt, { children: [
              /* @__PURE__ */ a(Ct, { asChild: !0, children: tt(z) }),
              /* @__PURE__ */ a(Et, { children: E })
            ] }) }, z.value) : tt(z))
          }
        ),
        /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Nt, { children: [
      ...
      children: M.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(qw, { ...q, conflictResolution: D }) : /* @__PURE__ */ a(rs, { ...q })
          },
          R.id
        );
      })
...
function Gw({ table: t }) {
  return /* @__PURE__ */ u(Oe, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Jw({
  ...
  var T;
  const [w, p] = N([]), [h, g] = N([]), [f, y] = N({}), [x, D] = N({}), k = $(() => e ?? [], [e]), C = yi({
    data: k,
    columns: t,
    getCoreRowModel: _i(),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(X, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ a(ei, {}) })
        ] }),
...
function bh({
  ...
  return /* @__PURE__ */ u(Xe, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Ze, { id: s, className: b("tw:min-w-80 tw:max-w-96", n), children: [
...
function xh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Oe, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(X, { variant: "default", children: [
...
function ou({
  ...
  return /* @__PURE__ */ u(Ca, { children: [
    ...
    e && /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
        X,
        {
          "aria-label": w,
...
function su({
  ...
  return /* @__PURE__ */ u(Oe, { open: p, onOpenChange: x, children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: iu(t, o, e) }) }) }),
...
function du({
  ...
  return /* @__PURE__ */ u(Oe, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
      /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "outline", className: "tw:h-6", children: cu(t, r) }) }) }),
      /* @__PURE__ */ a(Et, { children: /* @__PURE__ */ a("p", { children: lu(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Me, { style: { zIndex: Gn }, children: [
...
function Nh({
  ...
  const [y, x] = N("generated"), [D, k] = N("generated"), [C, E] = N("*"), [I, T] = N("*"), [V, P] = N("f"), [M, O] = N(!1), [W, F] = N(!0), [et, _] = N(!1), tt = B(!1), z = B(""), [R, q] = N(!1), ct = B(void 0), nt = B(void 0), dt = B({
  ...
  const Mt = () => {
    ...
    if (A && Rr("note", A)) {
      ...
      V !== "x" && m === "x" ? S == null || S.forEach((at) => mu(at)) : V === "x" && m !== "x" && (S == null || S.forEach((at) => vu(at))), (rt = h.current) == null || rt.applyUpdate([A, { delete: 1 }]);
    }
  }, le = (m) => {
    Z(m.contextMarker), _(m.canRedo);
  }, oe = j(
    (m) => {
      var J, K, G, U, rt;
      const A = (K = (J = h.current) == null ? void 0 : J.getNoteOps(0)) == null ? void 0 : K.at(0);
    ...
    (m, A, J) => {
      ...
      Ts({
        ...
        clearSessionIfCurrent: (U) => Qo(ut, U),
        ...
        onShowError: (U) => {
          (!Nc(U) || U.code !== Cc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Ec(U)}`
          );
        }
      });
    },
  ...
  return /* @__PURE__ */ u(ht, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
              /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
                X,
                {
                  "aria-label": _t,
    ...
    /* @__PURE__ */ u(Xe, { open: R, children: [
      /* @__PURE__ */ a(Rs, { virtualRef: dt }),
      /* @__PURE__ */ a(
        Ze,
        {
...
function ku({
  ...
  /* @__PURE__ */ a("span", { className: b("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    qo(t.marker, [i], o, !1),
    " "
  ] }), g = !!l, f = !!w, y = !!p, x = e === "horizontal" ? "horizontal" : "vertical", D = o ? "marker-visible" : "", k = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = b(x, D);
  return /* @__PURE__ */ u(ht, { children: [
    ...
    /* @__PURE__ */ a(Ro, { children: i.length > 0 && i.map((c) => /* @__PURE__ */ u(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wr, { className: o, children: _u(c.text) })
        ]
      },
...
}, Ma = (t, e, r) => /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
  /* @__PURE__ */ u(
    Ct,
    {
...
function Ih({
  ...
  const g = ve(r, "%webView_inventory_all%"), f = ve(r, "%webView_inventory_approved%"), y = ve(r, "%webView_inventory_unapproved%"), x = ve(r, "%webView_inventory_unknown%"), D = ve(r, "%webView_inventory_scope_currentBook%"), k = ve(r, "%webView_inventory_scope_chapter%"), C = ve(r, "%webView_inventory_scope_verse%"), E = ve(r, "%webView_inventory_filter_text%"), I = ve(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ve(r, "%webView_inventory_no_results%"), [V, P] = N(!1), [M, O] = N("all"), [W, F] = N(""), [et, _] = N([]), tt = $(() => {
    const Z = t ?? [];
    ...
    return tt.forEach((lt) => {
      const ut = lt.items[0], gt = Z.find(
        (kt) => kt.items[0] === ut
      );
      gt ? (gt.count += lt.count, gt.occurrences = gt.occurrences.concat(lt.occurrences)) : Z.push({
        items: [ut],
        count: lt.count,
  ...
  }, [V, tt]), R = $(() => z.length === 0 ? [] : Su(z, M, W), [z, M, W]), q = $(() => {
    var ut, gt;
    if (!V) return l;
    const Z = (ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut.length;
    if (!Z) return l;
    const lt = [];
    for (let kt = 0; kt < Z; kt++)
      lt.push(
        Eu(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
...
const Du = "16rem", Ou = "3rem", os = Yt.createContext(void 0);
function za() {
...
function Mu({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", x = _e() === "ltr" ? i : i === "primary" ? "secondary" : "primary", D = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
const Ie = "scrBook", ju = "scrRef", Ge = "source", Fu = "details", Uu = "Scripture Reference", Ku = "Scripture Book", ns = "Type", Hu = "Details";
function qu(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Yh({
  ...
  Y(() => {
    if (c) {
      const M = D.getSelectedRowModel().rowsById, O = Object.keys(M);
      if (O.length === 1) {
        const W = y.find((F) => jn(F) === O[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, y, c, D]);
  ...
  }, V = (M, O) => M.getIsGrouped() ? "" : b("banded-row", O % 2 === 0 ? "even" : "odd"), P = (M, O, W) => {
    ...
    !e && /* @__PURE__ */ u(
      gr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(vr, { position: "item-aligned", children: /* @__PURE__ */ a(Ww, { children: E.map((M) => /* @__PURE__ */ a(pe, { value: JSON.stringify(M.value), children: M.label }, M.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(To, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(So, { children: D.getHeaderGroups().map((M) => /* @__PURE__ */ a($e, { children: M.headers.filter((O) => O.column.columnDef.header).map((O) => (
        ...
        /* @__PURE__ */ a(fa, { colSpan: O.colSpan, className: "tw:sticky top-0", children: O.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Ir(O.column.columnDef.header, O.getContext())
        ] }) }, O.id)
      )) }, M.id)) }),
      /* @__PURE__ */ a(Ro, { children: D.getRowModel().rows.map((M, O) => {
        const W = _e();
        return /* @__PURE__ */ a(
          $e,
          {
                    ...
                    children: F.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !M.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(pc, {}) : /* @__PURE__ */ a(hc, {})),
                          " ",
...
function Wu({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: y } = {
  ...
  }, [x, D] = N(!1), [k, C] = N(""), E = B(void 0), I = B(!1), T = $(
    () => Xn(t),
    [t]
  ), V = $(() => {
    if (!k.trim()) {
    ...
    () => Object.values(St).filter(
      (_) => (s == null ? void 0 : s[_]) !== void 0 && Do(T, _).length === 0
                  ...
                  /* @__PURE__ */ u(Qe, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(St).filter((_) => V[_].length > 0).map((_, tt) => {
                      ...
                      return /* @__PURE__ */ u(Ur, { children: [
                        tt > 0 && /* @__PURE__ */ a(Wn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Be,
                          {
                            heading: Kn(_, h, g, f, y),
...
function Xu({
  ...
  return /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Nt, { children: [
    /* @__PURE__ */ a(Ct, { asChild: !0, children: /* @__PURE__ */ a(
      Yu,
      {
        className: o,
...
function Zh({
  ...
  const T = jt(
  ...
  }, Jt = B(null), Ot = B(null), mt = B(!1), Kt = B(null), Qt = B(!1), [Mt, zt] = N(void 0), vt = B(!1), le = B(!1), oe = B(null), ae = j((L) => {
    if (L) {
    ...
    [r, n, x, s]
  ), _t = gt.find((L) => L.value === t), fe = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Rc(Tt, ft, {
  ...
  return /* @__PURE__ */ u("div", { id: w, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      p === "dropdown" ? /* @__PURE__ */ u(Oe, { open: K, onOpenChange: G, children: [
                ...
                /* @__PURE__ */ a(
                  Ae,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      Qt.current || (At = (Q = Ot.current) == null ? void 0 : Q.querySelector("button")) == null || At.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
      ...
      ao,
      {
        ...
        children: /* @__PURE__ */ u(Ba, { container: Ee, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => sr(!1), children: dt }),
            /* @__PURE__ */ a(X, { onClick: Xr, children: nt })
          ] })
        ] })
      }
    ) }),
    p === "dropdown" && J && /* @__PURE__ */ a(ro, { open: U === "range", onOpenChange: sr, children: /* @__PURE__ */ a(
      ao,
      {
        ...
        children: /* @__PURE__ */ u(Ba, { container: or, children: [
          ...
          /* @__PURE__ */ u(tn, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => sr(!1), children: dt }),
            /* @__PURE__ */ a(X, { ref: oe, onClick: Xr, children: nt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          vr,
          {
            ...
            style: { zIndex: ze },
            children: t.map((w) => /* @__PURE__ */ a(pe, { value: `${w}`, children: l[nn(w)] }, `${w}`))
          }
        )
      ]
    }
...
function ko({
  ...
  return /* @__PURE__ */ u(Oe, { variant: s, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(X, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ a(fc, {}) }) }),
    /* @__PURE__ */ a(Me, { align: "start", style: { zIndex: ze }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Ur, { children: [
      /* @__PURE__ */ a(qn, { children: /* @__PURE__ */ a(Dt, { children: ss(e.groups, e.items, l, t) }) }),
...
const ap = Object.freeze([520, 420, 340]), ls = Yt.forwardRef(
...
const op = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
  ...
  if (Gl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (D = l.current) == null || D.focus(), Or(l, [h, g]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(np, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ip, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ze },
          children: /* @__PURE__ */ a(Dt, { children: ps(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sg({
  ...
  const d = mp(
    ...
    var D, k, C, E, I, T;
    const x = y !== f ? ((k = (D = t[f]) == null ? void 0 : D.uiNames) == null ? void 0 : k[y]) ?? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
