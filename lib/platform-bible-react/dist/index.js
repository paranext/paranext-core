  ...
  return /* @__PURE__ */ u("div", { id: f, className: "tw:flex tw:items-center tw:gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:items-center tw:gap-2", children: e.map((m) => {
      ...
      return /* @__PURE__ */ u(Fr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        ...
        (x = t.find((g) => g.value === m)) == null ? void 0 : x.label
      ] }, m);
