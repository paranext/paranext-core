...
import b, { forwardRef as tn, useRef as rt, useMemo as z, useState as I, useCallback as j, useLayoutEffect as Lt, createContext as bn, useContext as cr, useEffect as Q, Component as ds, createElement as Vr, Suspense as cs, createRef as ps, Fragment as co } from "react";
import { Command as gt } from "cmdk";
import { X as en, Search as po, Check as Ot, Clock as $r, ChevronsLeft as Pr, ChevronsRight as Lr, ChevronLeft as Hn, ChevronRight as Ee, ArrowLeft as us, ArrowRight as ms, Circle as vn, ChevronDown as pe, BoldIcon as hs, ItalicIcon as fs, UnderlineIcon as gs, StrikethroughIcon as bs, Pencil as vs, Trash2 as xs, ArrowUp as uo, MoreHorizontal as mo, ChevronUp as Xn, AtSign as ys, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as ho, Filter as Ss, User as Ts, Link as Rs, CircleHelp as Ds, ChevronsUpDown as fo, Star as Os, FunctionSquare as go, SquareSigma as bo, SquareX as Is, AlertCircle as Kn, CircleCheckIcon as Ms, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as $s, ArrowDownIcon as Ps, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as zs, ScrollText as js, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Ks } from "lucide-react";
import { clsx as Us } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as _t from "@radix-ui/react-dialog";
import { includes as sn, Section as G, getChaptersForBook as qs, formatScrRef as _e, getSectionForBook as He, formatRelativeDate as Js, formatReplacementString as ie, sanitizeHtml as Ws, parseParatextHtml as Br, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as vo, isString as Dn, compareScrRefs as Un, scrRefToBBBCCCVVV as On, getLocalizeKeyForScrollGroupId as Y } from "platform-bible-utils";
...
import { createEditor as yo, $getRoot as Yt, $createParagraphNode as xn, $getSelection as Bt, HISTORY_MERGE_TAG as pr, ParagraphNode as No, TextNode as ko, $isTokenOrSegmented as ri, $getCharacterOffsets as oi, $cloneWithPropertiesEphemeral as ai, $findMatchingParent as si, $isElementNode as le, CLEAR_EDITOR_COMMAND as _o, COMMAND_PRIORITY_EDITOR as Co, $isRangeSelection as Je, shallowMergeConfig as ii, defineExtension as zt, safeCast as nn, RootNode as li, LineBreakNode as wi, TabNode as di, $isEditorState as ci, createCommand as pi, CLICK_COMMAND as ui, isDOMNode as mi, $getNodeFromDOMNode as hi, $isNodeSelection as fi, $createNodeSelection as gi, $setSelection as bi, COMMAND_PRIORITY_LOW as vi, DecoratorNode as xi, $create as yi, $getNodeByKey as Ni, INDENT_CONTENT_COMMAND as zr, COMMAND_PRIORITY_CRITICAL as ur, KEY_TAB_COMMAND as ki, $createRangeSelection as _i, $normalizeSelection__EXPERIMENTAL as Ci, OUTDENT_CONTENT_COMMAND as Ei, INSERT_TAB_COMMAND as Si, $isBlockElementNode as un, $isDecoratorNode as Ti, $isParagraphNode as Ri, $isTextNode as mn, SELECTION_CHANGE_COMMAND as Eo, FORMAT_TEXT_COMMAND as Di, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as jr, isDOMDocumentNode as Mi, ArtificialNode__DO_NOT_USE as So, $createLineBreakNode as To, $isRootOrShadowRoot as Ai, isBlockDomNode as Fr, isInlineDomNode as Gr, $insertNodes as Vi } from "lexical";
...
import { useReactTable as Io, getFilteredRowModel as Hi, getSortedRowModel as Mo, getPaginationRowModel as Xi, getCoreRowModel as Ao, flexRender as Xe, getGroupedRowModel as Ki, getExpandedRowModel as Ui } from "@tanstack/react-table";
...
const el = _t.Root, nl = _t.Portal, Vo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  _t.Overlay,
  {
    ref: n,
    className: h(
...
Vo.displayName = _t.Overlay.displayName;
const $o = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = dt();
...
$o.displayName = _t.Content.displayName;
...
const Lo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  _t.Title,
  {
    ref: n,
...
Lo.displayName = _t.Title.displayName;
...
const on = b.forwardRef(({ className: e, ...t }, n) => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ o(po, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ o(
      gt.Input,
      {
        ref: n,
...
Bo.displayName = gt.Separator.displayName;
const Qt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  gt.Item,
  {
    ref: n,
...
function ml(e) {
  return zo[e - 1].includes("*obsolete*");
}
function hl() {
  const e = {};
...
const ft = class H {
  ...
  allVerses(t = !1, n = H.verseRangeSeparators, r = H.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = Xr(this._verse, r);
    for (const i of s.map((l) => Xr(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const d = l.verseNum;
...
const Uo = q.allBookIds.filter(
  (e) => !q.isObsolete(q.bookIdToNumber(e))
), we = Object.fromEntries(
  Uo.map((e) => [e, q.bookIdToEnglishName(e)])
);
function vr(e, t, n) {
...
function Qn(e, t, n) {
  return `${e} ${we[e]}${t ? ` ${br(e, t)} ${Ce(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function bl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ c(be, { open: l, onOpenChange: d, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      B,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o($r, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(te, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: /* @__PURE__ */ o(qt, { heading: s, children: e.map((p) => /* @__PURE__ */ c(
      Qt,
      {
        ...
        children: [
          /* @__PURE__ */ o($r, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function mp({
  ...
  const w = dt(), [p, f] = I(!1), [m, u] = I(""), [g, x] = I(""), [y, R] = I("books"), [N, v] = I(void 0), [C, V] = I(!1), _ = rt(void 0), E = rt(void 0), D = rt(void 0), k = rt(void 0), S = rt({}), L = j(
    (T) => {
      t(T), l && l(T);
    },
    [t, l]
  ), P = z(() => r ? r() : Uo, [r]), J = z(() => ({
    [G.OT]: P.filter((U) => q.isBookOT(U)),
    [G.NT]: P.filter((U) => q.isBookNT(U)),
    [G.DC]: P.filter((U) => q.isBookDC(U)),
    [G.Extra]: P.filter((U) => q.extraBooks().includes(U))
    ...
    (T) => {
      const U = y === "chapters" ? N : M == null ? void 0 : M.book;
      U && (L({
        book: U,
        chapterNum: T,
        verseNum: 1
    ...
    [y, ot]
  ), { otLong: vt, ntLong: kt, dcLong: A, extraLong: ct } = {
    ...
    (T) => M ? !!M.chapterNum && !T.toString().includes(M.chapterNum.toString()) : !1,
    [M]
  ), os = z(
    () => _e(
      e,
    ...
    (T) => {
      if (T.ctrlKey) return;
      const { isLetter: U, isDigit: lt } = Kr(T.key);
      if (y === "chapters") {
        if (T.key === "Backspace") {
      ...
      if ((y === "chapters" || y === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(T.key)) {
        const pt = y === "chapters" ? N : M == null ? void 0 : M.book;
        if (!pt) return;
        const ht = (() => {
          if (!m) return 1;
          const Be = m.match(/(\d+)$/);
        ...
        switch (T.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            At = ht === 0 ? ne : Math.max(1, ht - Ar);
            break;
          case "ArrowDown":
            At = ht === 0 ? 1 : Math.min(ne, ht + Ar);
            break;
          default:
            return;
        }
    ...
    const { isLetter: U, isDigit: lt } = Kr(T.key);
    (U || lt) && (T.preventDefault(), x((pt) => pt + T.key), E.current.focus(), V(!1));
  }, []);
  return Lt(() => {
    const T = setTimeout(() => {
      if (p && y === "books" && D.current && k.current) {
        const U = D.current, lt = k.current, pt = lt.offsetTop, ht = U.clientHeight, ne = lt.clientHeight, At = pt - ht / 2 + ne / 2;
        U.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(Qn(e.book));
  ...
  }, [y, N, M, e.book, e.chapterNum]), /* @__PURE__ */ c(be, { open: p, onOpenChange: yt, children: [
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ o(
      B,
      {
      ...
      fe,
      {
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: T, disabled: U, title: lt, icon: pt }) => /* @__PURE__ */ o(
              B,
              {
                variant: "ghost",
                size: "sm",
          ...
          !C && /* @__PURE__ */ c(ge, { ref: D, children: [
            y === "books" && /* @__PURE__ */ c(at, { children: [
              !M && Object.entries(X).map(([T, U]) => {
                if (U.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(qt, { heading: St(T), children: U.map((lt) => /* @__PURE__ */ o(
                      Yo,
                      {
                        bookId: lt,
                        onSelect: (pt) => it(pt),
              ...
              M && /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(
                Qt,
                {
                  value: `${M.book} ${we[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                  onSelect: W,
                  ...
                  children: _e(
                    ...
                    a ? br(M.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              M && Dt(M.book) > 1 && /* @__PURE__ */ c(at, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(M.book, a) }),
                /* @__PURE__ */ o(
                  Ur,
                  {
                    bookId: M.book,
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(xo.Root, { ref: n, className: h("pr-twp", Nl(), e), ...t }));
wt.displayName = xo.Root.displayName;
const xr = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    qe.Root,
    {
...
xr.displayName = qe.Root.displayName;
...
function tr({
  ...
  const [N, v] = I(!1), C = d ?? l, V = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], _ = (E, D) => {
...
function gp({
  ...
  const p = An(w, "%webView_bookSelector_currentBook%"), f = An(w, "%webView_bookSelector_choose%"), m = An(w, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    g(y), e(y);
...
const bp = [
  ...
  const a = rt(null), [s, i] = I(void 0), [l, d] = I(void 0), w = j(
    (u) => {
      i(u);
...
const Jo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = Jo ? Lt : Q, ln = { tag: pr };
function Ol({ initialConfig: e, children: t }) {
  const n = z(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Rl(null, r), p = yo({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, m) {
      if (m !== null) {
        if (m === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = xn();
            u.append(g);
            const x = Jo ? document.activeElement : null;
  ...
  }, []), o(qo.Provider, { value: n, children: t });
}
...
function Ml({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Il(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      t && s.size === 0 && i.size === 0 || e && d.has(pr) || l.isEmpty() || n(a, r, d);
    });
  }, [r, e, t, n]), null;
}
const yr = {
...
function zl() {
  return function(e) {
    const [t] = It(), n = z(() => e(t), [t, e]), [r, a] = I(() => n.initialValueFn()), s = rt(r);
    return Ll(() => {
...
const Wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = Wo && "documentMode" in document ? document.documentMode : null;
!(!Wo || !("InputEvent" in window) || Gl) && "getTargetRanges" in new window.InputEvent("input");
function Zo(...e) {
  const t = [];
...
function kn() {
  if (Kt > 1) return void Kt--;
  let e, t = !1;
  for (; Ke !== void 0; ) {
    let n = Ke;
    for (Ke = void 0, er++; n !== void 0; ) {
      const r = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && ta(n)) try {
        n.c();
      } catch (a) {
        t || (e = a, t = !0);
      }
...
function kr(e) {
  ...
  e.x = void 0, e.s = void 0, na(e);
}
function ql(e) {
  if (K !== this) throw new Error("Out-of-order effect");
  ea(this), K = e, this.f &= -2, 8 & this.f && kr(this), kn();
}
function ke(e, t) {
...
mt.prototype.brand = Kl, mt.prototype.h = function() {
  return !0;
  ...
  if (this.g = pn, this.f |= 1, this.i > 0 && !ta(this)) return this.f &= -2, !0;
  const e = K;
  try {
    Wr(this), K = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, na(this), Wr(this), Kt++;
  const e = K;
...
function oa(e, t = ra) {
  return e.registerCommand(_o, (n) => (e.update(t), !0), Co);
}
zt({ build: (e, t, n) => _n(t), config: nn({ $onClear: ra }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Wt(() => oa(e, r.value));
} });
function Jl(e) {
...
const nr = zt({ build: (e) => aa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function sa(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = sa(n[a], r[a]);
    return e;
  }
  return t;
}
const _r = 0, rr = 1, ia = 2, $n = 3, wn = 4, Ne = 5, Pn = 6, je = 7;
function Ln(e) {
  return e.id === _r;
}
function la(e) {
...
function Wl(e) {
  return function(t) {
    return t.id === rr;
  }(e) || Z(305, String(e.id), String(rr)), Object.assign(e, { id: ia });
}
...
class Ql {
  constructor(t, n) {
    ...
    ut(this, "state");
    ut(this, "_signal");
    this.builder = t, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: _r };
  }
  mergeConfigs() {
...
const ew = zt({ config: nn({ setOptions: Zr, updateOptions: Zr }), init: ({ $initialEditorState: e = tw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [li, ko, wi, di, No] }), Qr = Symbol.for("@lexical/extension/LexicalBuilder");
function to() {
}
function nw(e) {
  throw e;
...
class Ue {
  ...
  static maybeFromEditor(t) {
    const n = t[Qr];
    return n && (n.PACKAGE_VERSION !== Bn && Z(292, n.PACKAGE_VERSION, Bn), n instanceof Ue || Z(293)), n;
  }
  static fromEditor(t) {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(yo({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [Qr]: this });
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Ln(s) || Z(300, i, a || "[unknown]"), Ln(l = s) || Z(304, String(l.id), String(_r)), s = Object.assign(l, { id: rr }), r.state = s;
...
const rw = /* @__PURE__ */ new Set(), eo = zt({ build(e, t, n) {
  const r = n.getDependency(nr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = aa(() => {
  }, () => Wt(() => {
...
zt({ dependencies: [nr, eo], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(eo).output, a = We({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
...
function sw(e, t) {
  return Jt(e.registerCommand(ki, (n) => {
    ...
    const a = function(s) {
      ...
      const l = s.anchor, d = s.focus, w = d.isBefore(l) ? d : l, p = w.getNode(), f = Yr(p);
      if (f.canIndent()) {
        const m = f.getKey();
        let u = _i();
      ...
      return !1;
    }(r) ? n.shiftKey ? Ei : zr : Si;
    return e.dispatchCommand(a, void 0);
  }, Co), e.registerCommand(zr, () => {
    const n = typeof t == "number" ? t : t ? t.peek() : null;
    if (n == null) return !1;
    const r = Bt();
    if (!Je(r)) return !1;
    const a = r.getNodes().map((s) => Yr(s).getIndent());
...
zt({ build: (e, t, n) => _n(t), config: nn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Wt(() => n.getOutput().disabled.value ? void 0 : ca(e)) });
function cw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Cr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function pw({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    const [a, s] = I(() => n.getDecorators());
    return Cr(() => n.registerDecoratorListener((i) => {
      zi(() => {
        s(i);
      });
    }), [n]), Q(() => {
...
function no(e) {
  return e.getEditorState().read(da(e.isComposing()));
}
...
function bw({ onClear: e }) {
  const [t] = It();
  return gw(() => oa(t, e), [t, e]), null;
}
const pa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : Q;
function vw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: m, autoCapitalize: u, className: g, id: x, role: y = "textbox", spellCheck: R = !0, style: N, tabIndex: v, "data-testid": C, ...V }, _) {
  const [E, D] = I(e.isEditable()), k = j((L) => {
  ...
  return pa(() => (D(e.isEditable()), e.registerEditableListener((L) => {
    D(L);
...
function Cw({
  ...
  return /* @__PURE__ */ o(ua.Provider, { value: i, children: s });
}
function ma() {
  const e = cr(ua);
  if (!e)
...
function Ew() {
  const [e, t] = I(void 0), n = j(() => {
    t(void 0);
  }, []), r = z(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(el, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c($o, { children: [
      /* @__PURE__ */ o(Po, { children: /* @__PURE__ */ o(Lo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = j(
    (s, i, l = !1) => {
...
function Sw({
  ...
  const [t] = It(), [n, r] = I(t), [a, s] = I("paragraph"), [i, l] = Ew(), d = () => {
  };
...
const ha = Zt(
  ...
  {
    ref: a,
    className: h(ha({ variant: t, size: n, className: e })),
    ...r
  }
));
Rw.displayName = Ro.Root.displayName;
const fa = b.createContext({
  size: "default",
  variant: "default"
}), Er = b.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = dt();
  return /* @__PURE__ */ o(
    yn.Root,
    {
...
function Dw() {
  const { activeEditor: e } = ma(), [t, n] = I([]), r = j((a) => {
    if (Je(a) || Fi(a)) {
      const s = [];
      oo.forEach(({ format: i }) => {
  ...
  return Tw(r), /* @__PURE__ */ o(
    Er,
    {
      ...
      variant: "outline",
      size: "sm",
      children: oo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        Ye,
        {
          value: a,
          "aria-label": i,
...
function Aw(e, t) {
  ...
  let r = [];
  const a = [];
  for (const s of n) if (!ba.has(s.nodeName)) {
    const i = va(s, e, a, !1);
    i !== null && (r = r.concat(i));
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof So && i.insertAfter(To());
    for (const i of s) {
...
function ga(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = ga(e, g, m, r);
    !a && le(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || jr(p)) && p.append(m), n.append(p), f) {
      const u = f.call(i, p);
...
const ba = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function va(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (ba.has(e.nodeName)) return i;
  let l = null;
  ...
  for (let g = 0; g < f.length; g++) m.push(...va(f[g], t, n, u, new Map(a), l));
  return p != null && (m = p(m)), Fr(e) && (m = $w(e, m, u ? () => {
    const g = new So();
    return n.push(g), g;
  } : xn)), l == null ? m.length > 0 ? i = i.concat(m) : Fr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Gr(g.nextSibling) && Gr(g.previousSibling);
  }(e) && (i = i.concat(To())) : le(l) && l.append(...m), i;
}
function $w(e, t, n) {
...
function Lw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Do({
...
const Na = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ae.Root,
  {
    ref: n,
    className: h(
...
Na.displayName = Ae.Root.displayName;
...
ka.displayName = Ae.Fallback.displayName;
const Tr = bn(void 0);
function Et() {
  const e = cr(Tr);
  if (!e)
...
}), $e = tt.Trigger, _a = tt.Group, Xw = tt.Portal, Kw = tt.Sub, Uw = tt.RadioGroup;
function xe({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Tr.Provider, { value: n, children: /* @__PURE__ */ o(tt.Root, { ...t }) });
}
const Ca = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Et();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
    {
...
Ca.displayName = tt.SubTrigger.displayName;
...
Ea.displayName = tt.SubContent.displayName;
...
const Ut = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Et();
  return /* @__PURE__ */ c(
    tt.CheckboxItem,
    {
...
Ut.displayName = tt.CheckboxItem.displayName;
const Sa = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Et();
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
...
Sa.displayName = tt.RadioItem.displayName;
...
function ao({
    ...
    if (a && n)
      return /* @__PURE__ */ c(at, { children: [
        !Zs(e.contents) && /* @__PURE__ */ c(
          ...
          {
            onClick: () => {
              f(!0), u(Lw(Br(e.contents))), w == null || w(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Na, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(ka, { className: "tw-text-xs tw-font-medium", children: v }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          p && /* @__PURE__ */ c(
            "div",
            {
              ...
              onKeyDown: (_) => {
                xa(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  or,
        ...
        V && /* @__PURE__ */ c(xe, { children: [
          /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(mo, {}) }) }),
...
function qw({
  ...
  const [u, g] = I(cn), [x, y] = I(!1), [R, N] = I(!1), [v, C] = I(!1), [V, _] = I(!1), [E, D] = I(!1), [k, S] = I(void 0), L = z(() => e.filter((A) => !A.deleted), [e]), P = z(() => L[0], [L]), J = rt(null), O = rt(void 0);
  Q(() => {
    const A = J.current;
    if (!A) return;
    const ct = () => {
  ...
  const X = z(
    ...
    [t]
  ), M = z(() => a === "" ? t["%comment_assign_unassigned%"] ?? "Unassigned" : a ? ie(t["%comment_assigned_to%"], { assignedUser: a }) : void 0, [a, t]), W = z(() => L.slice(1), [L]), it = z(() => W.length ?? 0, [W.length]), Ft = z(() => it > 0, [it]), Mt = z(() => v || it <= 2 ? W : W.slice(-2), [W, it, v]), $ = z(() => v || it <= 2 ? 0 : it - 2, [it, v]), ot = z(
    ...
    var ct, St;
    const A = Gt(u) ? ar(u) : void 0;
    if (k !== void 0) {
      await w({
        threadId: l,
        contents: A,
        assignedUser: k
      }) && (S(void 0), A && ((ct = O.current) == null || ct.call(O), g(cn)));
      return;
    }
    A && await w({ threadId: l, contents: A }) && ((St = O.current) == null || St.call(O), g(cn));
  }, [u, w, k, l]), kt = j(
    async (A) => {
      var ye;
  ...
  return /* @__PURE__ */ o(
    Sr,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(ya, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          M && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: M }),
          ...
          n && /* @__PURE__ */ c(at, { children: [
            $ > 0 && /* @__PURE__ */ c(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (A) => {
                  (A.key === "Enter" || A.key === " ") && (A.preventDefault(), A.stopPropagation(), C(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
            ...
            Mt.map((A) => {
              const St = A.id === W[W.length - 1].id && A.user === s;
            ...
            (!V || Gt(u)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (A) => {
                  A.key === "Enter" && A.shiftKey && (A.preventDefault(), A.stopPropagation(), (Gt(u) || k !== void 0) && vt());
                },
                onKeyDown: (A) => {
                  xa(A), (A.key === "Enter" || A.key === " ") && A.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    or,
                    ...
                    /* @__PURE__ */ c(be, { open: E, onOpenChange: D, children: [
                      ...
                      /* @__PURE__ */ o(
                        te,
                        {
                          ...
                          align: "end",
                          onKeyDown: (A) => {
                            A.key === "Escape" && (A.stopPropagation(), D(!1));
                          },
                          children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(ge, { children: m == null ? void 0 : m.map((A) => {
                            let ct = A;
                            return A === "" ? ct = t["%comment_assign_unassigned%"] ?? "Unassigned" : A === "Team" && (ct = t["%comment_assign_team%"] ?? "Team"), /* @__PURE__ */ o(
                              Qt,
                              {
                                onSelect: () => {
                                  A !== a && S(A), D(!1);
...
function ld({
  ...
  var _;
  const [p, f] = I([]), [m, u] = I([]), [g, x] = I({}), [y, R] = I({}), N = z(() => t ?? [], [t]), v = Io({
    data: N,
    columns: e,
    getCoreRowModel: Ao(),
...
function dd({
  ...
  const a = io(n, "%webView_error_dump_header%"), s = io(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(ho, {}) })
        ] }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(xe, { children: [
    ...
    /* @__PURE__ */ o(ee, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ o(_a, { children: w.itemType === 0 ? /* @__PURE__ */ o(at, { children: w.items.map((f, m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Ut,
        {
          checked: r[p][m],
        ...
        Uw,
        {
          ...
          children: w.items.map((f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Sa, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ o(Pe, {})
    ] }, w.label)) })
    ...
    /* @__PURE__ */ o(ve, { asChild: !0, children: /* @__PURE__ */ c(
      B,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(fo, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
...
function Sp({
  ...
  const l = rt(null), d = ps(), [w, p] = I("generated"), [f, m] = I("*"), [u, g] = I("f"), x = z(
    () => ({
      ...s,
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ c(Xt, { children: [
            /* @__PURE__ */ o(de, { asChild: !0, children: /* @__PURE__ */ o(B, { onClick: R, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(ho, {}) }) }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ c(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(Kn, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function Dp({
  ...
  const f = p ? Nd(p, "%webView_footnoteList_header%") : "Footnotes", m = d ?? ni(n, void 0), u = (v, C) => {
    w == null || w(v, C, a);
  }, g = s ? n.findIndex((v) => v === s) : 0, [x, y] = I(g), R = (v) => {
    if (n.length)
      switch (v.key) {
        case "ArrowDown":
...
const Dr = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Jn.Root,
  {
    ref: n,
    className: h(
...
Dr.displayName = Jn.Root.displayName;
const Tn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Op = (e) => ({
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ c(Er, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        Ye,
        {
          onClick: (d) => {
...
function Lp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), m = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), y = Tt(n, "%webView_inventory_scope_chapter%"), R = Tt(n, "%webView_inventory_scope_verse%"), N = Tt(n, "%webView_inventory_filter_text%"), v = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), C = Tt(n, "%webView_inventory_no_results%"), [V, _] = I(!1), [E, D] = I("all"), [k, S] = I(""), [L, P] = I([]), J = z(() => {
    const $ = e ?? [];
  ...
  }, [V, J]), X = z(() => O.length === 0 ? [] : Sd(O, E, k), [O, E, k]), M = z(() => {
    var yt, vt;
    if (!V) return d;
...
const lr = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Me : "div",
  {
    ref: r,
...
const jd = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      ...n,
      children: [
        t && /* @__PURE__ */ o(sr, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ o(
          sr,
          {
    ...
    Aa,
    {
      ...
      children: /* @__PURE__ */ c($a, { children: [
        /* @__PURE__ */ c(ir, { children: [
          /* @__PURE__ */ o(lr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(wr, { children: /* @__PURE__ */ o(Pa, { children: Object.entries(t).map(([m, u]) => /* @__PURE__ */ o(La, { children: /* @__PURE__ */ o(
            Ba,
            {
              onClick: () => w(m),
              isActive: f(m),
        ...
        /* @__PURE__ */ c(ir, { children: [
          /* @__PURE__ */ o(lr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ o(wr, { className: "tw-pl-3", children: /* @__PURE__ */ o(
            tr,
            {
              buttonVariant: "ghost",
...
const Ht = "scrBook", Kd = "scrRef", se = "source", Ud = "details", Yd = "Scripture Reference", qd = "Scripture Book", za = "Type", Jd = "Details";
function Wd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      sortingFn: (r, a) => Un(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
...
const Zd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Un(e.start, e.end) === 0 ? `${On(e.start)}+${t}` : `${On(e.start)}+${t}-${On(e.end)}+${n}`;
}, lo = (e) => `${Zd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function zp({
  sources: e,
  ...
  const [w, p] = I([]), [f, m] = I([{ id: Ht, desc: !1 }]), [u, g] = I({}), x = z(
  ...
  Q(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const L = x.find((P) => lo(P) === S[0]) || void 0;
        L && l(L);
      }
    }
  }, [u, x, l, R]);
...
const Ir = (e, t) => e.filter((n) => {
  try {
    return He(n) === t;
  } catch {
    return !1;
  }
}), ja = (e, t, n) => Ir(e, t).every((r) => n.includes(r));
function Qd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Ir(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    B,
    {
      variant: "outline",
...
function tc({
  ...
  }, [y, R] = I(!1), [N, v] = I(""), C = rt(void 0), V = rt(!1);
  ...
  const _ = z(() => q.allBookIds.filter(
    ...
    (O, X = !1) => {
      ...
      const M = _.findIndex(($) => $ === C.current), W = _.findIndex(($) => $ === O);
      if (M === -1 || W === -1) return;
      const [it, Ft] = [
        Math.min(M, W),
        Math.max(M, W)
    ...
    (O) => {
      const X = Ir(_, O).map((M) => M);
      n(
        ja(_, O, t) ? t.filter((M) => !X.includes(M)) : [.../* @__PURE__ */ new Set([...t, ...X])]
      );
    },
    [t, n, _]
  ), P = () => {
              ...
              children: [
                ...
                /* @__PURE__ */ c(ge, { children: [
                  ...
                  Object.values(G).map((O, X) => {
                    const M = E[O];
                    if (M.length !== 0)
                      return /* @__PURE__ */ c(co, { children: [
                        /* @__PURE__ */ o(
                          qt,
                          {
                            heading: Ko(O, m, u, g, x),
                            children: M.map((W) => /* @__PURE__ */ o(
                              Yo,
                              {
                                bookId: W,
                        ...
                        X < Object.values(G).length - 1 && /* @__PURE__ */ o(Bo, {})
                      ] }, O);
                  })
                ] })
              ]
...
const Ga = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(de, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    ...
    /* @__PURE__ */ o(Ca, { children: l.label }),
    /* @__PURE__ */ o(Xw, { children: /* @__PURE__ */ o(Ea, { children: Ga(
      e,
      t,
      Fa(e, l.id),
      r
...
function dr({
  ...
  return /* @__PURE__ */ c(xe, { variant: s, children: [
    ...
    /* @__PURE__ */ o(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(co, { children: [
      /* @__PURE__ */ o(_a, { children: /* @__PURE__ */ o($t, { children: Ga(t.groups, t.items, d, e) }) }),
...
Ka.displayName = bt.List.displayName;
...
)), Ua = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  bt.Content,
  {
    ref: n,
    className: h(
...
Ua.displayName = bt.Content.displayName;
function qp({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Xa, { children: [
      /* @__PURE__ */ o(Ka, { children: e.map((l) => /* @__PURE__ */ o(ec, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(Ua, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function nc({ ...e }) {
...
const Ya = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  ...
  return /* @__PURE__ */ o(Tr.Provider, { value: a, children: /* @__PURE__ */ o(
    et.Root,
    {
      ref: r,
      className: h(
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ c(xe, { children: [
              /* @__PURE__ */ o($e, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(mo, {}) }) }),
...
zc(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
