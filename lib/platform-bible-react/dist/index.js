...
import b, { forwardRef as tn, useRef as W, useMemo as L, useState as D, useCallback as j, useLayoutEffect as Pt, createContext as xn, useContext as fr, useEffect as q, Component as ps, createElement as Lr, Suspense as us, createRef as ms, Fragment as fo } from "react";
import { Command as ft } from "cmdk";
import { X as en, Search as go, Check as Mt, Clock as Br, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as qn, ChevronRight as Ce, ArrowLeft as hs, ArrowRight as fs, Circle as yn, ChevronDown as me, BoldIcon as gs, ItalicIcon as bs, UnderlineIcon as vs, StrikethroughIcon as xs, Pencil as ys, Trash2 as Ns, ArrowUp as bo, MoreHorizontal as vo, ChevronUp as Jn, AtSign as ks, FilterIcon as _s, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ss, ArrowRightIcon as Ts, Copy as xo, Filter as Rs, User as Ds, Link as Ms, CircleHelp as Os, ChevronsUpDown as yo, Star as Is, FunctionSquare as No, SquareSigma as ko, SquareX as As, AlertCircle as Wn, CircleCheckIcon as Vs, CircleXIcon as $s, CircleHelpIcon as Ps, ArrowUpIcon as Ls, ArrowDownIcon as Bs, ArrowUpDownIcon as js, PanelLeft as zs, PanelRight as Fs, ScrollText as Gs, MenuIcon as Hs, Menu as Xs, EllipsisVertical as Ks, LoaderCircle as Us, GripVertical as Ys } from "lucide-react";
import { clsx as qs } from "clsx";
import { extendTailwindMerge as Js } from "tailwind-merge";
import * as Ct from "@radix-ui/react-dialog";
import { includes as wn, Section as H, getChaptersForBook as Ws, formatScrRef as we, getSectionForBook as He, formatRelativeDate as Zs, formatReplacementString as le, sanitizeHtml as Qs, parseParatextHtml as Fr, hasCustomParatextTags as ti, NumberFormat as ei, formatBytes as ni, getCurrentLocale as ri, getFormatCallerFunction as oi, deepEqual as _o, isString as Vn, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as U, formatScrRefRange as ai } from "platform-bible-utils";
...
import { createEditor as Eo, $getRoot as qt, $createParagraphNode as Nn, $getSelection as Lt, HISTORY_MERGE_TAG as gr, ParagraphNode as So, TextNode as To, $isTokenOrSegmented as si, $getCharacterOffsets as ii, $cloneWithPropertiesEphemeral as li, $findMatchingParent as wi, $isElementNode as ce, CLEAR_EDITOR_COMMAND as Ro, COMMAND_PRIORITY_EDITOR as Do, $isRangeSelection as Je, shallowMergeConfig as ci, defineExtension as jt, safeCast as nn, RootNode as di, LineBreakNode as pi, TabNode as ui, $isEditorState as mi, createCommand as hi, CLICK_COMMAND as fi, isDOMNode as gi, $getNodeFromDOMNode as bi, $isNodeSelection as vi, $createNodeSelection as xi, $setSelection as yi, COMMAND_PRIORITY_LOW as Ni, DecoratorNode as ki, $create as _i, $getNodeByKey as Ci, INDENT_CONTENT_COMMAND as Gr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as Ei, $createRangeSelection as Si, $normalizeSelection__EXPERIMENTAL as Ti, OUTDENT_CONTENT_COMMAND as Ri, INSERT_TAB_COMMAND as Di, $isBlockElementNode as hn, $isDecoratorNode as Mi, $isParagraphNode as Oi, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Mo, FORMAT_TEXT_COMMAND as Ii, getRegisteredNode as Ai, isHTMLElement as Vi, isDocumentFragment as Hr, isDOMDocumentNode as $i, ArtificialNode__DO_NOT_USE as Oo, $createLineBreakNode as Io, $isRootOrShadowRoot as Pi, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Li } from "lexical";
...
import { flushSync as Gi, createPortal as Hi } from "react-dom";
...
const ol = Ct.Root, al = Ct.Portal, jo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: m(
...
const be = Ee.Root, ve = Ee.Trigger, hp = Ee.Anchor, ee = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
...
function fp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
...
function gp({
  ...
  const w = lt(), [p, f] = D(!1), [h, u] = D(""), [g, y] = D(""), [x, C] = D("books"), [_, N] = D(void 0), [R, A] = D(!1), E = W(void 0), T = W(void 0), M = W(void 0), k = W(void 0), S = W({}), V = j(
    (v) => {
      t(v), l && l(v);
    },
    [t, l]
  ...
  }), [B]), I = L(() => Object.values(F).flat(), [F]), Z = L(() => {
    if (!g.trim()) return F;
    const v = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    (v) => {
      const z = x === "chapters" ? _ : O == null ? void 0 : O.book;
      z && (V({
        book: z,
        chapterNum: v,
        verseNum: 1
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: z, isDigit: Q } = qr(v.key);
      if (x === "chapters") {
        if (v.key === "Backspace") {
      ...
      if ((x === "chapters" || x === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        ...
        switch (v.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            It = mt === 0 ? re : Math.max(1, mt - Pr);
            break;
          case "ArrowDown":
            It = mt === 0 ? 1 : Math.min(re, mt + Pr);
            break;
          default:
            return;
        }
    ...
    const { isLetter: z, isDigit: Q } = qr(v.key);
    (z || Q) && (v.preventDefault(), y((ct) => ct + v.key), T.current.focus(), A(!1));
  }, []);
  return Pt(() => {
    const v = setTimeout(() => {
      if (p && x === "books" && M.current && k.current) {
        const z = M.current, Q = k.current, ct = Q.offsetTop, mt = z.clientHeight, re = Q.clientHeight, It = ct - mt / 2 + re / 2;
        z.scrollTo({
          top: Math.max(0, It),
          behavior: "smooth"
        }), u(or(e.book));
    ...
    if (x === "chapters" && _) {
      ...
      setTimeout(() => {
        if (M.current)
          if (v) {
            const z = S.current[e.chapterNum];
      ...
      Qt,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: $.map(({ onClick: v, disabled: z, title: Q, icon: ct }) => /* @__PURE__ */ o(
              P,
              {
                variant: "ghost",
                size: "sm",
          ...
          !R && /* @__PURE__ */ d(te, { ref: M, children: [
            x === "books" && /* @__PURE__ */ d(st, { children: [
              !O && Object.entries(Z).map(([v, z]) => {
                if (z.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Bt, { heading: Mn(v), children: z.map((Q) => /* @__PURE__ */ o(
                      ta,
                      {
                        bookId: Q,
                        onSelect: (ct) => yt(ct),
    ...
    /* @__PURE__ */ o(
      ee,
      {
        ...
        children: /* @__PURE__ */ d(Qt, { children: [
          ...
          /* @__PURE__ */ o(te, { children: A(t) ? t.map((T) => /* @__PURE__ */ o(Bt, { heading: T.groupHeading, children: T.options.map((M) => E(M, T.groupHeading)) }, T.groupHeading)) : t.map((T) => E(T)) })
        ] })
      }
    )
  ] });
...
const yp = [
  ...
  const a = W(null), [s, i] = D(void 0), [l, c] = D(void 0), w = j(
    (u) => {
      i(u);
...
const Er = {
  ...
  mark: "",
  markOverlap: ""
}, Vt = rn.Provider, Kt = rn.Root, pe = rn.Trigger, $t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  rn.Content,
  {
    ref: r,
    sideOffset: t,
...
function jl({ children: e, onError: t }) {
...
ut.prototype.brand = ql, ut.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), to(this), Ut++;
  const e = K;
...
const Rr = 0, lr = 1, ua = 2, zn = 3, dn = 4, Ne = 5, Fn = 6, ze = 7;
function Gn(e) {
  return e.id === Rr;
}
function ma(e) {
...
const ow = jt({ config: nn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = rw }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
const sw = /* @__PURE__ */ new Set(), oo = jt({ build(e, t, n) {
...
jt({ dependencies: [ir, oo], name: "@lexical/extension/HorizontalRule", nodes: [Se], register(e, t, n) {
  ...
  return Jt(e.registerCommand(fi, (i) => {
    if (gi(i.target)) {
      const l = bi(i.target);
...
function ww(e, t) {
  return Jt(e.registerCommand(Ei, (n) => {
    const r = Lt();
    if (!Je(r)) return !1;
    n.preventDefault();
    const a = function(s) {
...
const cw = jt({ name: "@lexical/react/ReactProvider" });
function dw() {
  ...
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (h) => n._onError(h), children: o(us, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
...
function Nw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: C = !0, style: _, tabIndex: N, "data-testid": R, ...A }, E) {
  const [T, M] = D(e.isEditable()), k = j((V) => {
...
function Rw() {
  const [e, t] = D(void 0), n = j(() => {
    ...
    return /* @__PURE__ */ o(ol, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(zo, { children: [
...
const Fw = Zt(
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: m("pr-twp", Fw({ variant: t }), e), ...n })
);
...
function lo({
  ...
  const _ = j(() => {
    ...
    if (r && y)
      return /* @__PURE__ */ d(st, { children: [
        !ti(e.contents) && /* @__PURE__ */ d(
          bn,
          {
            onClick: () => {
              h(!0), g(zw(Fr(e.contents))), c == null || c(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        M && /* @__PURE__ */ d(xe, { children: [
          ...
          /* @__PURE__ */ o(ne, { align: "end", children: M })
        ] })
      ]
    }
  );
...
function Zw({
  ...
  const [C, _] = D(wo), [N, R] = D(!1), [A, E] = D(!1), [T, M] = D(!1), [k, S] = D(!1), [V, B] = D(!1), [F, I] = D(void 0), [Z, O] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      O(!1), yt(!1);
  ...
  const _t = L(() => e.filter((v) => !v.deleted), [e]), bt = L(() => _t[0], [_t]), $ = W(null), tt = W(void 0), dt = j(() => {
    var v;
  ...
  const wt = L(
  ...
  }, [a, t]), Gt = L(() => _t.slice(1), [_t]), vt = L(() => Gt.length ?? 0, [Gt.length]), Mn = L(() => vt > 0, [vt]), On = L(() => T || vt <= 2 ? Gt : Gt.slice(-2), [Gt, vt, T]), ye = L(() => T || vt <= 2 ? 0 : vt - 2, [vt, T]), sn = L(
    () => vt === 1 ? wt.singleReply : le(wt.multipleReplies, { count: vt }),
    [vt, wt]
  ), In = L(
    () => ye === 1 ? wt.singleReply : le(wt.multipleReplies, { count: ye }),
    [ye, wt]
  ), ln = j(async () => {
    ...
    async (v) => {
      const z = Ht(C) ? cr(C) : void 0, Q = await w({
        ...v,
        contents: z,
        assignedUser: F ?? v.assignedUser
      });
      return Q && z && dt(), Q && F !== void 0 && I(void 0), Q;
    },
    [dt, C, w, F]
  );
  return /* @__PURE__ */ o(
          ...
          n && /* @__PURE__ */ d(st, { children: [
            ...
            u !== !1 && (!k || Ht(C)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Ht(C) || F !== void 0) && ln());
                },
                onKeyDown: (v) => {
                    ...
                    /* @__PURE__ */ d(be, { open: V, onOpenChange: B, children: [
                      ...
                      /* @__PURE__ */ o(
                        ee,
                        {
                          ...
                          children: /* @__PURE__ */ o(Qt, { children: /* @__PURE__ */ o(te, { children: h == null ? void 0 : h.map((v) => /* @__PURE__ */ o(
                            zt,
                            {
                              onSelect: () => {
                                I(v !== a ? v : void 0), B(!1);
...
const De = at.Root, tc = at.Group, Me = at.Value, ec = Zt(
...
function Cp({
  ...
  return /* @__PURE__ */ d(be, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(ee, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function Ep({ id: e, label: t, groups: n }) {
  const [r, a] = D(
    Object.fromEntries(
      n.map(
...
function fc({
  ...
  const [C, _] = D(!1), N = j(
    (S) => {
      var B;
      const V = (B = e.find((F) => F.label === S)) == null ? void 0 : B.value;
      V && n(
    ...
    if (!h) return e;
    const S = e.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), V = e.filter((B) => !B.starred).sort((B, F) => {
      const I = t.includes(B.value), Z = t.includes(F.value);
      return I && !Z ? -1 : !I && Z ? 1 : B.label.localeCompare(F.label);
    });
    return [...S, ...V];
  }, [e, t, h]), E = () => {
    n(e.map((S) => S.value));
        ...
        /* @__PURE__ */ o(Bt, { children: A.map((S) => /* @__PURE__ */ d(
          zt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Is, { className: "tw-h-4 tw-w-4" }),
...
function Dp({
  ...
  const l = W(null), c = ms(), [w, p] = D("generated"), [f, h] = D("*"), [u, g] = D("f"), y = L(
    () => ({
      ...s,
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(js, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ip = (e) => ({
  accessorKey: "item",
  ...
  return t ? t[1] : "";
}, Tc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Bp = Object.freeze([
...
function jp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), y = Tt(n, "%webView_inventory_scope_currentBook%"), x = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), N = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), R = Tt(n, "%webView_inventory_no_results%"), [A, E] = D(!1), [T, M] = D("all"), [k, S] = D(""), [V, B] = D([]), F = L(() => {
    const $ = e ?? [];
  ...
  }, [A, F]), Z = L(() => I.length === 0 ? [] : Rc(I, T, k), [I, T, k]), O = L(() => {
    var dt, wt;
    if (!A) return c;
...
function Fp({ localizedStrings: e, markerMenuItems: t }) {
  const [n, r] = D(""), a = L(() => {
...
const Ic = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    P,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(zs, {}) : /* @__PURE__ */ o(Fs, {}),
  ...
  ({
    ...
    const c = e ? Oe : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      c,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: m(jc({ variant: n, size: r }), s),
        ...i
      }
    );
    ...
    ja,
    {
      ...
      children: /* @__PURE__ */ d(Fa, { children: [
        /* @__PURE__ */ d(pr, { children: [
          ...
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Ga, { children: Object.entries(t).map(([h, u]) => /* @__PURE__ */ o(Ha, { children: /* @__PURE__ */ o(
            Xa,
            {
              onClick: () => w(h),
              isActive: f(h),
...
const Xt = "scrBook", Yc = "scrRef", ie = "source", qc = "details", Jc = "Scripture Reference", Wc = "Scripture Book", Ka = "Type", Zc = "Details";
function Qc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? Y.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Xt ? we(a.start) : void 0;
      },
    ...
    {
      accessorFn: (r) => we(r.start),
      id: Yc,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : we(a.start);
      },
      sortingFn: (r, a) => Zn(r.original.start, a.original.start),
      enableGrouping: !1
    },
            ...
            Qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ o(P, { variant: "ghost", size: "sm", onClick: F, children: w })
                ] }),
                /* @__PURE__ */ d(te, { children: [
...
function Kp({
  ...
  const w = oe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = oe(i, "%webView_scope_selector_current_book%"), u = oe(i, "%webView_scope_selector_choose_books%"), g = oe(i, "%webView_scope_selector_scope%"), y = oe(i, "%webView_scope_selector_select_books%"), x = [
...
function hr({
  ...
  return /* @__PURE__ */ d(xe, { variant: s, children: [
    /* @__PURE__ */ o($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(P, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Hs, {}) }) }),
  ...
  if (tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Fe(i, [h, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Fe(l, [h, u]);
        break;
      case "alt+h":
        (C = c.current) == null || C.focus(), Fe(c, [h, u]);
        break;
    }
  }), q(() => {
  ...
  return /* @__PURE__ */ d("div", { className: m("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ d(
      P,
      {
        ...
        children: [
          /* @__PURE__ */ o("span", { className: m({ "tw-me-2": i === "allText" }), children: t ? ai(e, t, s) : we(
            e,
...
const ud = tn(({ className: e, ...t }, n) => /* @__PURE__ */ o(Us, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
), hd = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const gd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
gd.displayName = "AlertDescription";
const iu = rt.Root, lu = rt.Trigger, wu = rt.Group, cu = rt.Portal, du = rt.Sub, pu = rt.RadioGroup, bd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  rt.SubTrigger,
  {
    ref: a,
    className: m(
...
bd.displayName = rt.SubTrigger.displayName;
...
vd.displayName = rt.SubContent.displayName;
const xd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ o(
  rt.Content,
  {
    ref: n,
    className: m(
...
xd.displayName = rt.Content.displayName;
...
yd.displayName = rt.Item.displayName;
const Nd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ref: a,
    className: m(
...
Nd.displayName = rt.CheckboxItem.displayName;
const kd = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  rt.RadioItem,
  {
    ref: r,
    className: m(
...
kd.displayName = rt.RadioItem.displayName;
const _d = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  rt.Label,
  {
    ref: r,
    className: m(
...
_d.displayName = rt.Label.displayName;
...
Cd.displayName = rt.Separator.displayName;
...
Ed.displayName = "ContextMenuShortcut";
...
const uu = Et.Trigger, Td = Et.Portal, mu = Et.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
const Rd = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Od.displayName = Et.Title.displayName;
...
const Ad = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  nr.Root,
  {
    ref: r,
    className: m(
...
Ad.displayName = nr.Root.displayName;
function hu({
  className: e,
  ...t
}) {
...
Vd.displayName = Ge.Root.displayName;
...
$d.displayName = rr.Root.displayName;
const vu = gt.Root, Pd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
Ld.displayName = gt.Trigger.displayName;
...
Bd.displayName = gt.Content.displayName;
...
export {
  ...
  Uw as AvatarImage,
  bp as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  vp as BOOK_SELECTOR_STRING_KEYS,
  Te as Badge,
  gp as BookChapterControl,
  ...
  xd as ContextMenuContent,
  wu as ContextMenuGroup,
  yd as ContextMenuItem,
  _d as ContextMenuLabel,
  cu as ContextMenuPortal,
  pu as ContextMenuRadioGroup,
  kd as ContextMenuRadioItem,
  Cd as ContextMenuSeparator,
  Ed as ContextMenuShortcut,
  du as ContextMenuSub,
  vd as ContextMenuSubContent,
  bd as ContextMenuSubTrigger,
