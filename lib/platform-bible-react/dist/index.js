...
var mt = (t, e, n) => ts(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as c, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as W, useMemo as z, useState as M, useCallback as B, useLayoutEffect as Bt, createContext as kn, useContext as pr, useEffect as H, Component as es, createElement as Ir, Suspense as ns, createRef as rs, Fragment as so } from "react";
import { Command as bt } from "cmdk";
import { X as Oe, Search as io, Check as Tt, Clock as Or, ChevronsLeft as Ar, ChevronsRight as Pr, ChevronLeft as Hn, ChevronRight as Ee, ArrowLeft as os, ArrowRight as as, Circle as _n, ChevronDown as be, BoldIcon as ss, ItalicIcon as is, UnderlineIcon as ls, StrikethroughIcon as ws, AtSign as lo, Pencil as ds, Trash2 as cs, ArrowUp as wo, MoreHorizontal as co, MailOpen as ps, Mail as us, ChevronUp as Yn, FilterIcon as ms, ArrowLeftIcon as fs, ChevronLeftIcon as hs, ChevronRightIcon as gs, ArrowRightIcon as bs, Copy as po, Filter as vs, User as xs, Link as ys, CircleHelp as Ns, ChevronsUpDown as uo, Star as ks, SquareX as mo, FunctionSquare as fo, SquareSigma as ho, AlertCircle as Xn, CircleCheckIcon as _s, CircleXIcon as Cs, CircleHelpIcon as Es, ArrowUpIcon as Rs, ArrowDownIcon as Ts, ArrowUpDownIcon as Ss, PanelLeft as Ds, PanelRight as Ms, ScrollText as Is, MenuIcon as Os, Menu as As, EllipsisVertical as Ps, LoaderCircle as $s, GripVertical as Vs } from "lucide-react";
...
import { includes as wn, Section as q, getChaptersForBook as zs, formatScrRef as me, getSectionForBook as Ke, formatRelativeDate as Fs, formatReplacementString as ue, sanitizeHtml as Bs, NumberFormat as Gs, formatBytes as Ks, getCurrentLocale as Us, getFormatCallerFunction as qs, deepEqual as Hs, isString as $r, compareScrRefs as Wn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as X } from "platform-bible-utils";
...
import { createEditor as bo, $getRoot as te, $createParagraphNode as Cn, $getSelection as Gt, HISTORY_MERGE_TAG as ur, ParagraphNode as vo, TextNode as xo, $isTokenOrSegmented as Ys, $getCharacterOffsets as Xs, $cloneWithPropertiesEphemeral as Ws, $findMatchingParent as Js, $isElementNode as fe, CLEAR_EDITOR_COMMAND as yo, COMMAND_PRIORITY_EDITOR as No, $isRangeSelection as We, mergeRegister as ee, shallowMergeConfig as Zs, defineExtension as Ut, safeCast as en, RootNode as Qs, LineBreakNode as ti, TabNode as ei, $isEditorState as ni, createCommand as ri, CLICK_COMMAND as oi, isDOMNode as ai, $getNodeFromDOMNode as si, $isNodeSelection as ii, $createNodeSelection as li, $setSelection as wi, COMMAND_PRIORITY_LOW as di, DecoratorNode as ci, addClassNamesToElement as ko, $create as pi, $getNodeByKey as ui, removeClassNamesFromElement as mi, KEY_TAB_COMMAND as fi, $isBlockElementNode as hn, $createRangeSelection as hi, $normalizeSelection__EXPERIMENTAL as gi, OUTDENT_CONTENT_COMMAND as bi, INDENT_CONTENT_COMMAND as Vr, INSERT_TAB_COMMAND as vi, COMMAND_PRIORITY_CRITICAL as mr, $isDecoratorNode as xi, $isParagraphNode as yi, $isTextNode as gn, SELECTION_CHANGE_COMMAND as _o, FORMAT_TEXT_COMMAND as Ni, getRegisteredNode as ki, isHTMLElement as _i, isDocumentFragment as Lr, isDOMDocumentNode as Ci, ArtificialNode__DO_NOT_USE as Co, $createLineBreakNode as Eo, $isRootOrShadowRoot as Ei, isBlockDomNode as jr, isInlineDomNode as zr, $insertNodes as Ri } from "lexical";
...
import { flushSync as Ii, createPortal as Oi } from "react-dom";
...
import { useReactTable as Do, getFilteredRowModel as $i, getSortedRowModel as Mo, getPaginationRowModel as Vi, getCoreRowModel as Io, flexRender as Ue, getGroupedRowModel as Li, getExpandedRowModel as ji } from "@tanstack/react-table";
import * as rt from "@radix-ui/react-select";
import zi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Jn, HIDDEN_NOTE_CALLER as Zn, getDefaultViewOptions as Fi, isInsertEmbedOpOfType as dn, Editorial as Bi } from "@eten-tech-foundation/platform-editor";
...
const Hi = Rt.Root, Yi = Rt.Portal, Oo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Overlay,
  {
    ref: n,
    className: f(
...
const Ao = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = dt();
...
Ao.displayName = Rt.Content.displayName;
...
$o.displayName = Rt.Title.displayName;
...
$e.displayName = bt.Input.displayName;
...
Ht.displayName = bt.List.displayName;
const rn = b.forwardRef((t, e) => /* @__PURE__ */ r(bt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
rn.displayName = bt.Empty.displayName;
...
Kt.displayName = bt.Group.displayName;
...
Vo.displayName = bt.Separator.displayName;
...
Pt.displayName = bt.Item.displayName;
...
const Fo = tn(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ c(
          ...
          {
            ref: w,
            value: d || `${t} ${at.bookIdToEnglishName(t)}`,
            onSelect: m,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ae : "button", { className: f(Ji({ variant: e, size: n, className: t })), ref: s, ...a })
);
L.displayName = "Button";
const oe = Re.Root, ae = Re.Trigger, Uc = Re.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = dt();
  return /* @__PURE__ */ r(Re.Portal, { children: /* @__PURE__ */ r(
    Re.Content,
    {
      ref: a,
      align: e,
...
Yt.displayName = Re.Content.displayName;
function nr(t, e, n) {
  return `${t} ${he[t]}${e ? ` ${hr(t, e)} ${Ce(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Zi({
  recentSearches: t,
  ...
  return /* @__PURE__ */ c(oe, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Ht, { children: /* @__PURE__ */ r(Kt, { heading: s, children: t.map((m) => /* @__PURE__ */ c(
      Pt,
      {
        onSelect: () => p(m),
        className: f("tw-flex tw-items-center", l),
        children: [
          /* @__PURE__ */ r(Or, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function qc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
  ...
  const o = Qi.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!p && d) {
          const u = ((g) => Object.keys(he).find(
            (y) => he[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function el(t, e, n, o) {
  const a = B(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const w = e[d - 1], p = Math.max(Ot(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function Br({
  ...
  if (t)
    return /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Ot(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Pt,
      {
        value: `${t} ${he[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Hc({
  ...
  const w = dt(), [p, m] = M(!1), [h, u] = M(""), [g, y] = M(""), [v, N] = M("books"), [k, R] = M(void 0), [P, $] = M(!1), V = W(void 0), x = W(void 0), E = W(void 0), _ = W(void 0), T = W({}), C = B(
    (I) => {
      e(I), l && l(I);
    },
    [e, l]
  ), A = z(() => o ? o() : zo, [o]), G = z(() => ({
    [q.OT]: A.filter((K) => at.isBookOT(K)),
    [q.NT]: A.filter((K) => at.isBookNT(K)),
    [q.DC]: A.filter((K) => at.isBookDC(K)),
    [q.Extra]: A.filter((K) => at.extraBooks().includes(K))
  }), [A]), O = z(() => Object.values(G).flat(), [G]), U = z(() => {
    if (!g.trim()) return G;
    const I = {
      [q.OT]: [],
      [q.NT]: [],
    ...
    (I) => {
      const K = v === "chapters" ? k : D == null ? void 0 : D.book;
      K && (C({
        book: K,
        chapterNum: I,
        verseNum: 1
      }), m(!1), N("books"), R(void 0), y(""));
    },
    [C, v, k, D]
  ), Vt = B(
    (I) => {
    ...
    (I) => {
      ...
      m(I), I && (N("books"), R(void 0), y(""));
    },
    [v, yt]
  ), { otLong: it, ntLong: ut, dcLong: ct, extraLong: gt } = {
    ...
    (I) => D ? !!D.chapterNum && !I.toString().includes(D.chapterNum.toString()) : !1,
    [D]
  ), Wt = z(
    () => me(
      t,
    ...
    (I) => {
      if (I.ctrlKey) return;
      const { isLetter: K, isDigit: nt } = Fr(I.key);
      if (v === "chapters") {
        if (I.key === "Backspace") {
          I.preventDefault(), I.stopPropagation(), yt();
          return;
        }
        if (K || nt) {
          if (I.preventDefault(), I.stopPropagation(), N("books"), R(void 0), nt && k) {
            const ot = he[k];
            y(`${ot} ${I.key}`);
          } else
            y(I.key);
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(I.key)) {
        const ot = v === "chapters" ? k : D == null ? void 0 : D.book;
        if (!ot) return;
        const Z = (() => {
          if (!h) return 1;
          const we = h.match(/(\d+)$/);
        ...
        switch (I.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            kt = Z === 0 ? Lt : Math.max(1, Z - le);
            break;
          case "ArrowDown":
            kt = Z === 0 ? 1 : Math.min(Lt, Z + le);
            break;
          default:
            return;
        }
        kt !== Z && (I.preventDefault(), I.stopPropagation(), u(nr(ot, a, kt)), setTimeout(() => {
          const we = T.current[kt];
    ...
    const { isLetter: K, isDigit: nt } = Fr(I.key);
    (K || nt) && (I.preventDefault(), y((ot) => ot + I.key), x.current.focus(), $(!1));
  }, []);
  return Bt(() => {
    const I = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const K = E.current, nt = _.current, ot = nt.offsetTop, Z = K.clientHeight, Lt = nt.clientHeight, kt = ot - Z / 2 + Lt / 2;
        K.scrollTo({
          top: Math.max(0, kt),
          behavior: "smooth"
        }), u(nr(t.book));
  ...
  }, [v, k, D, t.book, t.chapterNum]), /* @__PURE__ */ c(oe, { open: p, onOpenChange: j, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
      L,
      {
      ...
      qt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: pt.map(({ onClick: I, disabled: K, title: nt, icon: ot }) => /* @__PURE__ */ r(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            k && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ce(k, a) })
          ] }),
          !P && /* @__PURE__ */ c(Ht, { ref: E, children: [
            v === "books" && /* @__PURE__ */ c(lt, { children: [
              !D && Object.entries(U).map(([I, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Kt, { heading: an(I), children: K.map((nt) => /* @__PURE__ */ r(
                      Fo,
                      {
                        bookId: nt,
                        onSelect: (ot) => st(ot),
              ...
              D && /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r(
                Pt,
                {
                  ...
                  children: me(
                    ...
                    a ? hr(D.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              D && Ot(D.book) > 1 && /* @__PURE__ */ c(lt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(D.book, a) }),
                /* @__PURE__ */ r(
                  Br,
                  {
                    bookId: D.book,
...
), wt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(go.Root, { ref: n, className: f("pr-twp", nl(), t), ...e }));
wt.displayName = go.Root.displayName;
const br = b.forwardRef(({ className: t, ...e }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    Xe.Root,
    {
...
br.displayName = Xe.Root.displayName;
const bn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Xe.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Xe.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(_n, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
bn.displayName = Xe.Item.displayName;
function rl(t) {
...
function rr({
  ...
  const [k, R] = M(!1), P = d ?? l, $ = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], V = (x, E) => {
    const _ = l(x), T = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, C = `${E ?? ""}${_}${T ?? ""}`;
    return /* @__PURE__ */ c(
      Pt,
      {
        value: _,
  ...
  return /* @__PURE__ */ c(oe, { open: k, onOpenChange: R, ...N, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ c(qt, { children: [
          ...
          /* @__PURE__ */ r(rn, { children: h }),
          /* @__PURE__ */ r(Ht, { children: $(e) ? e.map((x) => /* @__PURE__ */ r(Kt, { heading: x.groupHeading, children: x.options.map((E) => V(E, x.groupHeading)) }, x.groupHeading)) : e.map((x) => V(x)) })
        ] })
      }
    )
  ] });
...
function Wc({
  ...
  const p = $n(w, "%webView_bookSelector_currentBook%"), m = $n(w, "%webView_bookSelector_choose%"), h = $n(w, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    g(v), t(v);
    ...
    br,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(wt, { className: "tw-flex tw-items-center", children: o.map((v) => at.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            L,
            {
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, il = Go ? Bt : H, cn = { tag: ur };
function ll({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = sl(null, o), p = bo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Cn();
            u.append(g);
            const y = Go ? document.activeElement : null;
            (Gt() !== null || y !== null && y === m.getRootElement()) && g.select();
          }
        }, cn);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const u = m.parseEditorState(h);
            m.setEditorState(u, cn);
            break;
          }
          case "object":
            m.setEditorState(h, cn);
            break;
          case "function":
            m.update(() => {
              te().isEmpty() && h(m);
  ...
  }, []), r(Bo.Provider, { value: n, children: e });
}
const wl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function dl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return wl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(ur) || l.isEmpty() || n(a, o, d);
    });
  }, [o, t, e, n]), null;
}
const vr = {
  ...
  mark: "",
  markOverlap: ""
}, Ct = nn.Provider, At = nn.Root, zt = nn.Trigger, Et = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  nn.Content,
  {
    ref: o,
    sideOffset: e,
...
const fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function hl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function gl() {
  return function(t) {
    const [e] = $t(), n = z(() => t(e), [e, t]), [o, a] = M(() => n.initialValueFn()), s = W(o);
    return fl(() => {
...
function bl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Ys(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), d = s.getNode(), w = e.is(l), p = e.is(d);
    if (w || p) {
      const [m, h] = Xs(t), u = l.is(d), g = e.is(i ? d : l), y = e.is(i ? l : d);
      let v, N = 0;
      u ? (N = m > h ? h : m, v = m > h ? m : h) : g ? (N = i ? h : m, v = void 0) : y && (N = 0, v = i ? m : h);
      const k = e.__text.slice(N, v);
      k !== e.__text && (n === "clone" && (e = Ws(e)), e.__text = k);
    }
  }
  return e;
}
...
const Ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Ko && "documentMode" in document ? document.documentMode : null;
!(!Ko || !("InputEvent" in window) || xl) && "getTargetRanges" in new window.InputEvent("input");
function Gr(t) {
  const e = Js(t, (n) => fe(n) && !n.isInline());
  return fe(e) || vl(4, t.__key), e;
}
...
function Rn() {
  ...
  for (; qe !== void 0; ) {
    let n = qe;
    for (qe = void 0, or++; n !== void 0; ) {
      const o = n.o;
      if (n.o = void 0, n.f &= -3, !(8 & n.f) && Uo(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
function ce(t, e) {
  ft.call(this, void 0), this.x = t, this.s = void 0, this.g = mn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function kl(t, e) {
  return new ce(t, e);
}
...
function yr(t) {
  ...
  t.x = void 0, t.s = void 0, Ho(t);
}
function _l(t) {
  if (Y !== this) throw new Error("Out-of-order effect");
  qo(this), Y = t, this.f &= -2, 8 & this.f && yr(this), Rn();
}
function _e(t, e) {
...
function Tn(t, e = {}) {
  const n = {};
  for (const o in t) {
    const a = e[o], s = Je(a === void 0 ? t[o] : a);
    n[o] = s;
  }
  return n;
}
ft.prototype.brand = yl, ft.prototype.h = function() {
  return !0;
...
} }), ce.prototype = new ft(), ce.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === mn)) return !0;
  if (this.g = mn, this.f |= 1, this.i > 0 && !Uo(this)) return this.f &= -2, !0;
  const t = Y;
  try {
    qr(this), Y = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ho(this), qr(this), Qt++;
  const t = Y;
...
Ut({ build: (t, e, n) => Tn(e), config: en({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function Yo() {
  const t = te(), e = Gt(), n = Cn();
  t.clear(), t.append(n), e !== null && n.select(), We(e) && (e.format = 0);
}
function Xo(t, e = Yo) {
  return t.registerCommand(yo, (n) => (t.update(e), !0), No);
}
Ut({ build: (t, e, n) => Tn(e), config: en({ $onClear: Yo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ne(() => Xo(t, o.value));
} });
function Cl(t) {
...
const ar = Ut({ build: (t) => Wo(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function Jo(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = Jo(n[a], o[a]);
    return t;
  }
  return e;
}
const Nr = 0, sr = 1, Zo = 2, Ln = 3, pn = 4, ke = 5, jn = 6, Fe = 7;
function zn(t) {
  return t.id === Nr;
}
function Qo(t) {
...
function El(t) {
  return function(e) {
    return e.id === sr;
  }(t) || J(305, String(t.id), String(sr)), Object.assign(t, { id: Zo });
}
...
class Tl {
  constructor(e, n) {
    ...
    mt(this, "state");
    mt(this, "_signal");
    this.builder = e, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Nr };
  }
  mergeConfigs() {
  ...
  init(e) {
    ...
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(e, s.config, o)), this.state = function(l, d, w) {
      return Object.assign(l, { id: pn, initResult: d, registerState: w });
    }(s, i, a);
  }
  build(e) {
    const n = this.state;
    let o;
    n.id !== pn && J(307, String(n.id), String(ke)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== jn && J(310, String(n.id), String(jn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= pn;
    }(e) || J(313, String(e.id), String(pn)), e.initResult;
  }
  getInitPeer(e) {
...
const Dl = Ut({ config: en({ setOptions: Hr, updateOptions: Hr }), init: ({ $initialEditorState: t = Sl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (ni(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Qs, xo, ti, ei, vo] }), Yr = Symbol.for("@lexical/extension/LexicalBuilder");
function Xr() {
}
function Ml(t) {
  throw t;
...
class He {
  ...
  static maybeFromEditor(e) {
    const n = e[Yr];
    return n && (n.PACKAGE_VERSION !== Fn && J(292, n.PACKAGE_VERSION, Fn), n instanceof He || J(293)), n;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(bo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [Yr]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      zn(s) || J(300, i, a || "[unknown]"), zn(l = s) || J(304, String(l.id), String(Nr)), s = Object.assign(l, { id: sr }), o.state = s;
      const d = this.outgoingConfigEdges.get(i);
      if (d) for (const w of d.keys()) {
        const p = this.extensionNameMap.get(w);
        p && n(p, i);
      }
      s = El(s), o.state = s, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const p of l) {
      const { extension: m } = p;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of Cl(m)) {
      ...
      m.theme && Jo(i, m.theme);
    }
    Object.keys(i).length > 0 && (e.theme = i), n.size && (e.nodes = [...n]);
    const d = Object.keys(s).length > 0, w = a.size > 0;
    (d || w) && (e.html = {}, d && (e.html.import = s), w && (e.html.export = a));
    for (const p of l) p.init(e);
    return e.onError || (e.onError = Ml), e;
  }
}
const Il = /* @__PURE__ */ new Set(), Wr = Ut({ build(t, e, n) {
  const o = n.getDependency(ar).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Wo(() => {
  }, () => ne(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let d, w = !1;
    o.value.read(() => {
      if (Gt()) for (const [p, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(p);
          continue;
        }
        const h = ui(p), u = h && h.isSelected() || !1;
        w = w || u !== (!!i && i.has(p)), u && (d = d || /* @__PURE__ */ new Set(), d.add(p));
      }
    }), !w && d && i && d.size === i.size || (s.value = d);
  }));
  return { watchNodeKey: function(i) {
    const l = kl(() => (s.value || Il).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
Ut({ dependencies: [ar, Wr], name: "@lexical/extension/HorizontalRule", nodes: () => [Te], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Wr).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ee(t.registerCommand(oi, (i) => {
    if (ai(i.target)) {
      const l = si(i.target);
      if (Al(l)) return function(d, w = !1) {
        const p = Gt(), m = d.isSelected(), h = d.getKey();
        let u;
        w && ii(p) ? u = p : (u = li(), wi(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, di), t.registerMutationListener(Te, (i, l) => {
    Nl(() => {
      let d = !1;
      const { nodeSelections: w } = a.peek();
      for (const [p, m] of i.entries()) if (m === "destroyed") w.delete(p), d = !0;
      else {
        const h = w.get(p), u = t.getElementByKey(p);
        h ? h.domNode.value = u : (d = !0, w.set(p, { domNode: Je(u), selectedSignal: o(p) }));
      }
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ne(() => {
      const w = l.value;
      w && (d.value ? ko(w, s) : mi(w, s));
    }));
    return ee(...i);
  }));
} });
function Pl(t, e) {
  return ee(t.registerCommand(fi, (n) => {
    const o = Gt();
    if (!We(o)) return !1;
    n.preventDefault();
    const a = function(s) {
      if (s.getNodes().filter((m) => hn(m) && m.canIndent()).length > 0) return !0;
      const i = s.anchor, l = s.focus, d = l.isBefore(i) ? l : i, w = d.getNode(), p = Gr(w);
      if (p.canIndent()) {
        const m = p.getKey();
        let h = hi();
        if (h.anchor.set(m, 0, "element"), h.focus.set(m, 0, "element"), h = gi(h), h.anchor.is(d)) return !0;
      }
      return !1;
    }(o) ? n.shiftKey ? bi : Vr : vi;
    return t.dispatchCommand(a, void 0);
  }, No), t.registerCommand(Vr, () => {
    const n = typeof e == "number" ? e : e ? e.peek() : null;
    if (n == null) return !1;
    const o = Gt();
    if (!We(o)) return !1;
    const a = o.getNodes().map((s) => Gr(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, mr));
}
Ut({ build: (t, e, n) => Tn(e), config: en({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return ne(() => {
    if (!o.value) return Pl(t, a);
  });
} });
const $l = Ut({ name: "@lexical/react/ReactProvider" });
function Vl() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (We(g)) {
                ...
                if (gn(v) && w >= 0 && p >= 0 && (N = w, k = w + p, g.setTextNodeRange(v, N, v, k)), N === k && m === "" || (g.insertRawText(m), v = y.getNode()), gn(v)) {
                  N = h, k = h + u;
                  const R = v.getTextContentSize();
                  N = N > R ? R : N, k = k > R ? R : k, g.setTextNodeRange(v, N, v, k);
                }
...
Ut({ build: (t, e, n) => Tn(e), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ne(() => n.getOutput().disabled.value ? void 0 : na(t)) });
function zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const kr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
  ...
  return function(n, o) {
    ...
    return kr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = r(o, { onError: (h) => n._onError(h), children: r(ns, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Oi(p, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function Gl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    kr(() => ee(Mi(a), na(a)), [a]);
  }(o), c(lt, { children: [t, r(Kl, { content: e }), r(Bl, { editor: o, ErrorBoundary: n })] });
}
...
const ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function Hl({ onClear: t }) {
  const [e] = $t();
  return ql(() => Xo(e, t), [e, t]), null;
}
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : H;
function Yl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: v = "textbox", spellCheck: N = !0, style: k, tabIndex: R, "data-testid": P, ...$ }, V) {
  const [x, E] = M(t.isEditable()), _ = B((C) => {
    C && C.ownerDocument && C.ownerDocument.defaultView ? t.setRootElement(C) : t.setRootElement(null);
  }, [t]), T = z(() => /* @__PURE__ */ function(...C) {
    return (A) => {
      for (const G of C) typeof G == "function" ? G(A) : G != null && (G.current = A);
    };
  }(V, _), [_, V]);
  return ra(() => (E(t.isEditable()), t.registerEditableListener((C) => {
    E(C);
  })), [t]), r("div", { "aria-activedescendant": x ? e : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: x, "data-testid": P, id: y, ref: T, role: v, spellCheck: N, style: k, tabIndex: R, ...$ });
}
const Xl = tn(Yl);
function Zr(t) {
  return t.getEditorState().read(ea(t.isComposing()));
...
function Jl(t, e) {
  ...
  return c(lt, { children: [r(Xl, { editor: a, ...o, ref: e }), n != null && r(Zl, { editor: a, content: n })] });
}
...
function tw({
  ...
  return /* @__PURE__ */ r(oa.Provider, { value: i, children: s });
}
function aa() {
  const t = pr(oa);
  if (!t)
...
function ew() {
  const [t, e] = M(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Hi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Ao, { children: [
...
function nw({
  ...
  const [e] = $t(), [n, o] = M(e), [a, s] = M("paragraph"), [i, l] = ew(), d = () => {
  };
...
const sa = re(
  ...
  {
    ref: a,
    className: f(sa({ variant: e, size: n, className: t })),
    ...o
  }
));
...
const ia = b.createContext({
  size: "default",
  variant: "default"
}), _r = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = dt();
  return /* @__PURE__ */ r(
    En.Root,
    {
...
_r.displayName = En.Root.displayName;
const Ye = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
...
Ye.displayName = En.Item.displayName;
const Qr = [
...
function aw() {
  const { activeEditor: t } = aa(), [e, n] = M([]), o = B((a) => {
    if (We(a) || Ai(a)) {
      const s = [];
      Qr.forEach(({ format: i }) => {
  ...
  return rw(o), /* @__PURE__ */ r(
    _r,
    {
      ...
      variant: "outline",
      size: "sm",
      children: Qr.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        Ye,
        {
          value: a,
          "aria-label": i,
...
function ww(t, e) {
  ...
  let o = [];
  const a = [];
  for (const s of n) if (!wa.has(s.nodeName)) {
    const i = da(s, t, a, !1);
    i !== null && (o = o.concat(i));
  }
  return function(s) {
...
function la(t, e, n, o = null) {
  ...
  const s = fe(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && gn(e) && (i = bl(o, e, "clone"));
  const l = fe(i) ? i.getChildren() : [], d = ki(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = la(t, g, h, o);
    !a && fe(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((_i(p) || Lr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
      u && (Lr(p) ? p.replaceChildren(u) : p.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
const wa = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function da(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (wa.has(t.nodeName)) return i;
  let l = null;
  const d = function(g, y) {
    const { nodeName: v } = g, N = y._htmlConversions.get(v.toLowerCase());
    let k = null;
    if (N !== void 0) for (const R of N) {
      const P = R(g);
  ...
  let h = [];
  const u = (l == null || !Ei(l)) && (l != null && hn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...da(m[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), jr(t) && (h = cw(t, h, u ? () => {
    const g = new Co();
    return n.push(g), g;
  } : Cn)), l == null ? h.length > 0 ? i = i.concat(h) : jr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : zr(g.nextSibling) && zr(g.previousSibling);
  }(t) && (i = i.concat(Eo())) : fe(l) && l.append(...h), i;
}
function cw(t, e, n) {
...
function Jc({
  ...
  const [a, s] = M(uw), [i, l] = M(void 0), [d, w] = M(!1), p = W(void 0), m = W(null);
  H(() => {
    let N = !0;
    const k = m.current;
    if (!k) return;
  ...
  const h = B(() => {
    ...
    const N = xn(a);
    e(N, i);
  }, [a, e, i]), u = o["%commentEditor_placeholder%"] ?? "Type your comment here...", g = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", y = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", v = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ c("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
          /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
          /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: y }) })
        ] }) }),
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ c(oe, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ c(
        L,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ r("span", { children: Bn(i !== void 0 ? i : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ r(
        Yt,
        {
          ...
          children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Ht, { children: t.map((N) => /* @__PURE__ */ r(
            Pt,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), w(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: Bn(N, o) })
            },
            N || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), _t(a) && h());
        },
        onKeyDown: (N) => {
...
const Zc = Object.freeze([
  ...
  const a = W(null), [s, i] = M(void 0), [l, d] = M(void 0), w = B(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (_ === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(_ + 1, E.length - 1) : T = Math.max(_ - 1, 0), T !== _ && (u.preventDefault(), u.stopPropagation(), (x = E[T]) == null || x.focus());
          return;
        }
        return;
      }
      const P = t.findIndex((E) => E.id === s);
      let $ = P;
      switch (u.key) {
        case "ArrowDown":
          $ = Math.min(P + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", gw({ variant: e }), t), ...n })
);
...
const xw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
De.displayName = So.Root.displayName;
...
fa.displayName = Pe.Root.displayName;
...
Nw.displayName = Pe.Image.displayName;
...
ha.displayName = Pe.Fallback.displayName;
const Er = kn(void 0);
function Dt() {
  const t = pr(Er);
  if (!t)
...
}), Ve = Q.Trigger, ga = Q.Group, kw = Q.Portal, _w = Q.Sub, Cw = Q.RadioGroup;
function ye({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Er.Provider, { value: n, children: /* @__PURE__ */ r(Q.Root, { ...e }) });
}
const ba = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ c(
    Q.SubTrigger,
    {
...
ba.displayName = Q.SubTrigger.displayName;
...
va.displayName = Q.SubContent.displayName;
...
se.displayName = Q.Content.displayName;
...
yn.displayName = Q.Item.displayName;
...
Ft.displayName = Q.CheckboxItem.displayName;
const xa = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Dt();
  return /* @__PURE__ */ c(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(_n, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
xa.displayName = Q.RadioItem.displayName;
const on = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Q.Label,
  {
    ref: o,
...
on.displayName = Q.Label.displayName;
...
Le.displayName = Q.Separator.displayName;
...
function to({
  ...
  }, [t.date, n]), R = z(() => t.user, [t.user]), P = z(
    () => t.user.split(" ").map((x) => x[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), $ = z(() => Bs(t.contents), [t.contents]), V = z(() => {
    if (o && w)
      return /* @__PURE__ */ c(lt, { children: [
        /* @__PURE__ */ c(
          yn,
          {
            onClick: () => {
              h(!0), g(pw(t.contents)), d == null || d(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(fa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(ha, { className: "tw-text-xs tw-font-medium", children: P }) }),
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ r("p", { className: "tw-text-sm tw-font-medium", children: R }),
            /* @__PURE__ */ r("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: k }),
            /* @__PURE__ */ r("div", { className: "tw-flex-1" }),
            e && t.assignedUser !== void 0 && /* @__PURE__ */ c(Se, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              fn(t.assignedUser, n)
            ] })
          ] }),
          m && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: y,
              onKeyDownCapture: (x) => {
                x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), v()) : x.key === "Enter" && x.shiftKey && (x.preventDefault(), x.stopPropagation(), _t(u) && N());
              },
              onKeyDown: (x) => {
                Cr(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  vn,
        ...
        o && p && !e && a !== "Resolved" && s && /* @__PURE__ */ r(
          L,
          {
            ...
            onClick: (x) => {
              x.stopPropagation(), s({ threadId: t.thread, status: "Resolved" });
            },
            children: /* @__PURE__ */ r(Tt, {})
          }
        ),
        V && /* @__PURE__ */ c(ye, { children: [
          /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
...
function Rw({
  ...
  const [$, V] = M(eo), [x, E] = M(!1), [_, T] = M(!1), [C, A] = M(!1), [G, O] = M(!1), [U, D] = M(!1), [F, st] = M(void 0), [ht, Vt] = M(!1), [pt, yt] = M(!1), [j, it] = M(R), [ut, ct] = M(!1), gt = W(void 0), [an, ze] = M(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    if (!o) {
      Vt(!1), yt(!1), ze(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Jt = v ? await v(d) : !1;
      if (!S) return;
      const ln = N ? await N(d) : !1;
      S && (Vt(Jt), yt(ln));
    })(), () => {
      S = !1;
    };
  }, [o, d, v, N]);
  const Wt = z(() => e.filter((S) => !S.deleted), [e]);
  H(() => {
    let S = !0;
    if (!o || !k) {
      ze(/* @__PURE__ */ new Map());
  ...
  const Nt = z(() => Wt[0], [Wt]), sn = W(null), Ne = W(void 0), ie = B(() => {
    var S;
    (S = Ne.current) == null || S.call(Ne), V(eo);
  }, []), I = B(() => {
    const S = !j;
    it(S), ct(!S), u == null || u(d, S);
  }, [j, u, d]);
  H(() => {
    const S = sn.current;
    if (!S)
    ...
    return Mt(), window.addEventListener("resize", Mt), () => window.removeEventListener("resize", Mt);
  }, [Nt == null ? void 0 : Nt.verse]), H(() => {
    A(!1);
  }, [o]), H(() => {
    if (o && !j && !ut) {
      const S = setTimeout(() => {
  ...
  const K = z(
  ...
  }, [s, n]), ot = z(() => Wt.slice(1), [Wt]), Z = z(() => ot.length ?? 0, [ot.length]), Lt = z(() => Z > 0, [Z]), kt = z(() => C || Z <= 2 ? ot : ot.slice(-2), [ot, Z, C]), le = z(() => C || Z <= 2 ? 0 : Z - 2, [Z, C]), we = z(
    () => Z === 1 ? K.singleReply : ue(K.multipleReplies, { count: Z }),
    [Z, K]
  ), Wa = z(
    () => le === 1 ? K.singleReply : ue(K.multipleReplies, { count: le }),
    [le, K]
  ), Mr = B(async () => {
    const S = _t($) ? xn($) : void 0;
    if (F !== void 0) {
      await p({
        threadId: d,
        contents: S,
    ...
    S && await p({ threadId: d, contents: S }) && ie();
  }, [ie, $, p, F, d]), Ja = B(
    async (S) => {
      const Mt = _t($) ? xn($) : void 0, Jt = await p({
        ...S,
        contents: Mt,
        assignedUser: F ?? S.assignedUser
      });
      return Jt && Mt && ie(), Jt && F !== void 0 && st(void 0), Jt;
    },
    [ie, $, p, F]
  );
  return /* @__PURE__ */ r(
    ua,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(ma, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ r(
              L,
              {
                ...
                children: j ? /* @__PURE__ */ r(ps, {}) : /* @__PURE__ */ r(us, {})
              }
            ),
            nt && /* @__PURE__ */ r(Se, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: nt })
          ] }),
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
              ...
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("span", { className: t, children: [
                    Nt.contextBefore,
                    /* @__PURE__ */ r("span", { className: "tw-font-bold", children: Nt.selectedText }),
                    Nt.contextAfter
                  ] })
                ]
              }
            ...
            _ && /* @__PURE__ */ r(
              L,
              {
                ...
                size: "icon",
                onClick: (S) => {
                  S.stopPropagation(), E(!x);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": x ? "Collapse text" : "Expand text",
                children: x ? /* @__PURE__ */ r(Yn, {}) : /* @__PURE__ */ r(be, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
            to,
            {
              ...
              isThreadExpanded: o,
              threadStatus: w,
              handleAddCommentToThread: Ja,
              handleUpdateComment: m,
              handleDeleteComment: h,
              onEditingChange: O,
              canEditOrDelete: an.get(Nt.id) ?? !1,
              canUserResolveThread: pt
            }
          )
        ] }),
        /* @__PURE__ */ c(lt, { children: [
          Lt && !o && /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          !o && _t($) && /* @__PURE__ */ r(
            vn,
            {
              ...
              onSerializedChange: (S) => V(S),
              placeholder: n["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ c(lt, { children: [
            le > 0 && /* @__PURE__ */ c(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (S) => {
                  (S.key === "Enter" || S.key === " ") && (S.preventDefault(), S.stopPropagation(), A(!0));
                },
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(De, {}) }),
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: Wa }),
                    C ? /* @__PURE__ */ r(Yn, {}) : /* @__PURE__ */ r(be, {})
                  ] })
                ]
              }
            ),
            kt.map((S) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              to,
              {
                comment: S,
                localizedStrings: n,
            ...
            y !== !1 && (!G || _t($)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  S.key === "Enter" && S.shiftKey && (S.preventDefault(), S.stopPropagation(), (_t($) || F !== void 0) && Mr());
                },
                onKeyDown: (S) => {
                  Cr(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    vn,
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    F !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ue(
                    ...
                    /* @__PURE__ */ c(oe, { open: U, onOpenChange: D, children: [
                      /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !ht || !g || g.length === 0 || !g.includes(i),
                      ...
                      /* @__PURE__ */ r(
                        Yt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (S) => {
                            S.key === "Escape" && (S.stopPropagation(), D(!1));
                          },
                          children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Ht, { children: g == null ? void 0 : g.map((S) => /* @__PURE__ */ r(
                            Pt,
                            {
                              onSelect: () => {
                                st(S !== s ? S : void 0), D(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ r("span", { children: fn(S, n) })
                            },
                            S || "unassigned"
                          )) }) })
                        }
...
function tp({
  ...
  const R = n.filter(
    ...
    [y]
  ), { listboxRef: x, activeId: E, handleKeyDown: _ } = hw({
    options: P,
    onOptionSelect: $
  }), T = B(
    (C) => {
...
function Tw({ table: t }) {
  return /* @__PURE__ */ c(ye, { children: [
    /* @__PURE__ */ r(Pi, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ms, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ c(se, { align: "end", className: "tw-w-[150px]", children: [
...
const Me = rt.Root, Sw = rt.Group, Ie = rt.Value, Dw = re(
  ...
  return /* @__PURE__ */ c(
    rt.Trigger,
    {
      className: f(Dw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(rt.Icon, { asChild: !0, children: /* @__PURE__ */ r(be, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
ve.displayName = rt.Trigger.displayName;
const ya = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Yn, { className: "tw-h-4 tw-w-4" })
  }
));
ya.displayName = rt.ScrollUpButton.displayName;
...
Na.displayName = rt.ScrollDownButton.displayName;
...
xe.displayName = rt.Content.displayName;
...
const xt = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  rt.Item,
  {
    ref: o,
    className: f(
...
xt.displayName = rt.Item.displayName;
...
Iw.displayName = rt.Separator.displayName;
function Ow({ table: t }) {
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ c(
        Me,
        {
          ...
          children: [
            /* @__PURE__ */ r(ve, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ie, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(xe, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(xt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Mn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? Ze(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
const jt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const l = b.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Lw(u, g, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Vw(l, y, p.key);
...
function zw({
  ...
  var V;
  const [p, m] = M([]), [h, u] = M([]), [g, y] = M({}), [v, N] = M({}), k = z(() => e ?? [], [e]), R = Do({
    data: k,
    columns: t,
    getCoreRowModel: Io(),
    ...n && { getPaginationRowModel: Vi() },
    onSortingChange: m,
  ...
  let $;
  return d ? $ = Array.from({ length: 10 }).map((_, T) => `skeleton-row-${T}`).map((_) => /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(ge, { colSpan: P.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ir, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((V = R.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = R.getRowModel().rows.map((x) => /* @__PURE__ */ r(
    jt,
    {
      onClick: () => i(x, R),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((E) => /* @__PURE__ */ r(ge, { children: Ue(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    x.id
  )) : $ = /* @__PURE__ */ r(jt, { children: /* @__PURE__ */ r(ge, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Tw, { table: R }),
    /* @__PURE__ */ c(Sn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Dn, { stickyHeader: s, children: R.getHeaderGroups().map((x) => /* @__PURE__ */ r(jt, { children: x.headers.map((E) => /* @__PURE__ */ r(Qe, { children: E.isPlaceholder ? void 0 : Ue(E.column.columnDef.header, E.getContext()) }, E.id)) }, x.id)) }),
...
function Bw({
  ...
  const a = ro(n, "%webView_error_dump_header%"), s = ro(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(po, {}) })
        ] }),
...
function rp({
  ...
  return /* @__PURE__ */ c(oe, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: o }),
    /* @__PURE__ */ c(Yt, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function op({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(ye, { children: [
    /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ c(L, { variant: "default", children: [
      /* @__PURE__ */ r(vs, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(be, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(se, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      /* @__PURE__ */ r(on, { children: w.label }),
      /* @__PURE__ */ r(ga, { children: w.itemType === 0 ? /* @__PURE__ */ r(lt, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Ft,
        {
          checked: o[p][h],
...
function Kw({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const d = new Date(l), w = new Date(a.getTime() - d.getTime()), p = w.getUTCFullYear() - 1970, m = w.getUTCMonth(), h = w.getUTCDate() - 1;
    let u = "";
...
function Uw({
  ...
  const [N, k] = M(!1), R = B(
    (T) => {
      var A;
      const C = (A = t.find((G) => G.label === T)) == null ? void 0 : A.value;
      C && n(
        e.includes(C) ? e.filter((G) => G !== C) : [...e, C]
      );
    },
    [t, e, n]
  ), P = () => d || o, $ = z(() => {
    if (!h) return t;
    const T = t.filter((A) => A.starred).sort((A, G) => A.label.localeCompare(G.label)), C = t.filter((A) => !A.starred).sort((A, G) => {
      const O = e.includes(A.value), U = e.includes(G.value);
      return O && !U ? -1 : !O && U ? 1 : A.label.localeCompare(G.label);
    });
    return [...T, ...C];
  }, [t, e, h]), V = () => {
    n(t.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ c(oe, { open: E, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ c(
      L,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(qt, { children: [
      ...
      a && /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: V, children: s }),
        /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: x, children: i })
      ] }),
      /* @__PURE__ */ c(Ht, { children: [
        /* @__PURE__ */ r(rn, { children: l }),
        /* @__PURE__ */ r(Kt, { children: $.map((T) => /* @__PURE__ */ c(
          Pt,
          {
            value: T.label,
            onSelect: R,
...
function ip({
  ...
  return /* @__PURE__ */ c("div", { id: m, className: "tw-flex tw-items-center tw-gap-2", children: [
    /* @__PURE__ */ r(
      Uw,
      {
        entries: t,
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((h) => {
      var u;
      return /* @__PURE__ */ c(Se, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          L,
          {
            variant: "ghost",
...
const qw = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(lt, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ c(lt, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function Hw({
  ...
  const s = W(null), i = W(null), l = W(!1), [d, w] = M(t), [p, m] = M(n), [h, u] = M(!1);
  H(() => {
    w(t);
  }, [t]), H(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    l.current = !1, u(v), v || (d !== "custom" || p ? (e(d), o(p)) : (w(t), m(n)));
  }, y = (v) => {
    var N, k, R, P;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = s.current) == null || N.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((k = i.current) == null || k.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((R = s.current) == null ? void 0 : R.selectionStart) === 0 && ((P = i.current) == null || P.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ c(ye, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
      /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: qw(t, a, n) }) }) }),
...
const Yw = (t, e) => t === "f" ? /* @__PURE__ */ c(lt, { children: [
  /* @__PURE__ */ r(fo, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ c(lt, { children: [
  /* @__PURE__ */ r(ho, {}),
  " ",
...
function Ww({
  ...
  return /* @__PURE__ */ c(ye, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
      /* @__PURE__ */ r(Ti, { asChild: !0, children: /* @__PURE__ */ r(Ve, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: Yw(t, n) }) }) }),
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: Xw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ c(se, { className: "tw-z-[300]", children: [
...
function lp({
  ...
  const d = W(null), w = rs(), [p, m] = M("generated"), [h, u] = M("*"), [g, y] = M("f"), [v, N] = M(!1), k = z(
    () => ({
      ...i,
  ...
  H(() => {
    ...
    if (E && dn("note", E)) {
      ...
      let A = "custom";
      C === Jn ? A = "generated" : C === Zn ? A = "hidden" : C && u(C), m(A), y(((T = E.insert.note) == null ? void 0 : T.style) ?? "f"), x = setTimeout(() => {
        var G;
        (G = d.current) == null || G.applyUpdate([E]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const R = B(() => {
    var E, _;
    const x = (_ = (E = d.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    x && dn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = h : x.insert.note.caller = p === "generated" ? Jn : Zn), n([x]));
  }, [p, h, n]), P = () => {
    var E;
    const x = (E = w.current) == null ? void 0 : E.getElementsByClassName("editor-input")[0];
    x != null && x.textContent && navigator.clipboard.writeText(x.textContent);
  }, $ = (x) => {
    var _, T, C, A, G;
    y(x);
    const E = (T = (_ = d.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (E && dn("note", E)) {
      E.insert.note && (E.insert.note.style = x);
      const O = (A = (C = E.insert.note) == null ? void 0 : C.contents) == null ? void 0 : A.ops;
      g !== "x" && x === "x" ? O == null || O.forEach((U) => Jw(U)) : g === "x" && x !== "x" && (O == null || O.forEach((U) => Zw(U))), (G = d.current) == null || G.applyUpdate([E, { delete: 1 }]);
    }
  }, V = (x) => {
    var _, T, C, A, G;
    const E = (T = (_ = d.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (E && dn("note", E)) {
      x.content.length > 1 && setTimeout(() => {
        var D;
        (D = d.current) == null || D.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const O = (C = E.insert.note) == null ? void 0 : C.style, U = (G = (A = E.insert.note) == null ? void 0 : A.contents) == null ? void 0 : G.ops;
      O || N(!1), N(
        O === "x" ? !!(U != null && U.every((D) => {
          var st, ht;
          if (!((st = D.attributes) != null && st.char)) return !0;
          const F = ((ht = D.attributes) == null ? void 0 : ht.char).style;
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
          /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ c(At, { children: [
            /* @__PURE__ */ r(zt, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: P, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(po, {}) }) }),
...
function nd({
  ...
  /* @__PURE__ */ c("span", { className: f("note-caller tw-inline-block", { formatted: s }), children: [
    a,
    " "
  ] }), m = i && /* @__PURE__ */ c(lt, { children: [
    Rr(t.marker, [i], o, !1),
    " "
  ...
  return /* @__PURE__ */ c(lt, { children: [
    /* @__PURE__ */ c("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", y), children: [
      d,
      p
    ] }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: td(t.marker, l, o, w) })
      }
    )
  ] });
}
function dp({
  ...
  const p = d ?? qs(n, void 0), m = (k, R) => {
    w == null || w(k, R, a);
  }, h = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(h), y = (k, R, P) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), w == null || w(R, P, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
      switch (k.key) {
        case "ArrowDown":
          k.preventDefault(), g((R) => Math.min(R + 1, n.length - 1));
          break;
        case "ArrowUp":
          k.preventDefault(), g((R) => Math.max(R - 1, 0));
          break;
      }
  }, N = W([]);
  return H(() => {
        ...
        "ul",
        {
          ...
          children: n.map((k, R) => {
            ...
            return /* @__PURE__ */ c(lt, { children: [
              ...
              R < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(De, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function od({
  ...
  return /* @__PURE__ */ c(Sn, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Dn, { stickyHeader: !0, children: /* @__PURE__ */ c(jt, { children: [
      /* @__PURE__ */ r(Qe, { children: a }),
      /* @__PURE__ */ r(Qe, { children: s })
    ] }) }),
    /* @__PURE__ */ r(Mn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ c(
      jt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(ge, { className: o, children: rd(l.text) })
        ]
      },
...
Tr.displayName = Qn.Root.displayName;
const In = (t) => t === "asc" ? /* @__PURE__ */ r(Rs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Ts, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ss, { className: "tw-ms-2 tw-h-4 tw-w-4" }), cp = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    In(e.getIsSorted())
  ] })
}), ad = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    In(n.getIsSorted())
  ] })
}), pp = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    In(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(L, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    In(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ c(_r, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ye,
        {
          onClick: (d) => {
            d.stopPropagation(), Gn(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, sd = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", gp = Object.freeze([
...
function bp({
  ...
  const u = It(n, "%webView_inventory_all%"), g = It(n, "%webView_inventory_approved%"), y = It(n, "%webView_inventory_unapproved%"), v = It(n, "%webView_inventory_unknown%"), N = It(n, "%webView_inventory_scope_currentBook%"), k = It(n, "%webView_inventory_scope_chapter%"), R = It(n, "%webView_inventory_scope_verse%"), P = It(n, "%webView_inventory_filter_text%"), $ = It(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = It(n, "%webView_inventory_no_results%"), [x, E] = M(!1), [_, T] = M("all"), [C, A] = M(""), [G, O] = M([]), U = z(() => {
    const j = t ?? [];
    return j.length === 0 ? [] : ld(j, a, s);
  }, [t, a, s]), D = z(() => {
    if (x) return U;
    const j = [];
    return U.forEach((it) => {
      const ut = it.items[0], ct = j.find(
        (gt) => gt.items[0] === ut
      );
      ct ? (ct.count += it.count, ct.occurrences = ct.occurrences.concat(it.occurrences)) : j.push({
        items: [ut],
        count: it.count,
  ...
  }, [x, U]), F = z(() => D.length === 0 ? [] : id(D, _, C), [D, _, C]), st = z(() => {
    var ut, ct;
    if (!x) return d;
    const j = (ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut.length;
    if (!j) return d;
    const it = [];
    for (let gt = 0; gt < j; gt++)
      it.push(
        ad(
          ((ct = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ct[gt]) || "Additional Item",
          gt + 1
        )
      );
    return [...it, ...d];
  }, [o == null ? void 0 : o.tableHeaders, d, x]);
  H(() => {
  ...
  const ht = (j, it) => {
    it.setRowSelection(() => {
      const ct = {};
      return ct[j.index] = !0, ct;
    });
    const ut = j.original.items;
    O(ut), h && ut.length > 0 && h(ut[0]);
  }, Vt = (j) => {
    ...
    const j = D.filter((it) => Hs(
      x ? it.items : [it.items[0]],
      G
    ));
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ c(
        Me,
        {
          ...
          defaultValue: _,
          children: [
            /* @__PURE__ */ r(ve, { className: "tw-m-1", children: /* @__PURE__ */ r(Ie, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ c(xe, { children: [
              /* @__PURE__ */ r(xt, { value: "all", children: u }),
              /* @__PURE__ */ r(xt, { value: "approved", children: g }),
              /* @__PURE__ */ r(xt, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(xt, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(Me, { onValueChange: (j) => Vt(j), defaultValue: i, children: [
        /* @__PURE__ */ r(ve, { className: "tw-m-1", children: /* @__PURE__ */ r(Ie, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(xe, { children: [
          /* @__PURE__ */ r(xt, { value: "book", children: N }),
          /* @__PURE__ */ r(xt, { value: "chapter", children: k }),
          /* @__PURE__ */ r(xt, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ r(
        je,
      ...
      o && /* @__PURE__ */ c("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? $ })
      ] })
    ] }),
...
function xp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = M(""), a = z(() => {
  ...
  return /* @__PURE__ */ c(qt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      $e,
      {
        value: n,
    ...
    /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ r(rn, { children: t["%markerMenu_noResults%"] }),
      /* @__PURE__ */ r(Kt, { children: a.map((s) => /* @__PURE__ */ c(
        Pt,
        {
...
const wd = "16rem", dd = "3rem", _a = b.createContext(void 0);
function On() {
  const t = b.useContext(_a);
  if (!t)
...
const Ca = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), m = e ?? w, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((R) => !R), [h]), g = m ? "expanded" : "collapsed", N = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(_a.Provider, { value: k, children: /* @__PURE__ */ r(Ct, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
Ca.displayName = "SidebarProvider";
const Ea = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = On();
...
const wr = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ae : "div",
  {
    ref: o,
...
Da.displayName = "SidebarMenuItem";
const bd = re(
  ...
  ({
    ...
    const d = t ? Ae : "button", { state: w } = On(), p = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(bd({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(zt, { asChild: !0, children: p }),
      /* @__PURE__ */ r(Et, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
Ma.displayName = "SidebarMenuButton";
...
const yd = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(ir, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          ir,
          {
...
const _d = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ae : "a",
  {
    ref: s,
...
function Cd({
  ...
  return /* @__PURE__ */ r(
    Ea,
    {
      ...
      children: /* @__PURE__ */ c(Ta, { children: [
        /* @__PURE__ */ c(lr, { children: [
          /* @__PURE__ */ r(wr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(dr, { children: /* @__PURE__ */ r(Sa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Da, { children: /* @__PURE__ */ r(
            Ma,
            {
              onClick: () => w(h),
              isActive: m(h),
...
const Sr = tn(
  ({ value: t, onSearch: e, placeholder: n, isFullWidth: o, className: a, isDisabled: s = !1, id: i }, l) => {
    const d = dt();
    return /* @__PURE__ */ c("div", { id: i, className: f("tw-relative", { "tw-w-full": o }, a), children: [
      /* @__PURE__ */ r(
        io,
        {
          className: f(
...
const Zt = "scrBook", Ed = "scrRef", pe = "source", Rd = "details", Td = "Scripture Reference", Sd = "Scripture Book", Ia = "Type", Dd = "Details";
function Md(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Zt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Td,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? at.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Zt ? me(a.start) : void 0;
      },
...
function Np({
  ...
  const [w, p] = M([]), [m, h] = M([{ id: Zt, desc: !1 }]), [u, g] = M({}), y = z(
  ...
  H(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const C = y.find((A) => oo(A) === T[0]) || void 0;
        C && l(C);
      }
    }
  }, [u, y, l, N]);
  const k = a ?? Sd, R = s ?? Ia, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Zt] },
    { label: `Group by ${R}`, value: [pe] },
    {
      label: `Group by ${k} and ${R}`,
      value: [Zt, pe]
    },
    {
      label: `Group by ${R} and ${k}`,
      value: [pe, Zt]
    }
  ], $ = (_) => {
    p(JSON.parse(_));
  ...
  }, x = (_, T) => _.getIsGrouped() ? "" : f("banded-row", T % 2 === 0 ? "even" : "odd"), E = (_, T, C) => {
    if (!((_ == null ? void 0 : _.length) === 0 || T.depth < C.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ c(
      Me,
      {
        ...
        children: [
          /* @__PURE__ */ r(ve, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ie, {}) }),
          /* @__PURE__ */ r(xe, { position: "item-aligned", children: /* @__PURE__ */ r(Sw, { children: P.map((_) => /* @__PURE__ */ r(xt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Dn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ r(jt, { children: _.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(Mn, { children: N.getRowModel().rows.map((_, T) => {
        const C = dt();
        return /* @__PURE__ */ r(
          jt,
          {
            ...
            children: _.getVisibleCells().map((A) => {
              if (!(A.getIsPlaceholder() || A.column.columnDef.enableGrouping && !A.getIsGrouped() && (A.column.columnDef.id !== pe || !n)))
                return /* @__PURE__ */ r(
                  ge,
                  {
                    className: f(
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ c(
                      L,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (C === "ltr" ? /* @__PURE__ */ r(Ee, {}) : /* @__PURE__ */ r(Hn, {})),
                          " ",
                          Ue(A.column.columnDef.cell, A.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
}), Oa = (t, e, n) => Dr(t, e).every((o) => n.includes(o));
function Od({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Dr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    L,
    {
      variant: "outline",
...
function Ad({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: y } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = M(!1), [k, R] = M(""), P = W(void 0), $ = W(!1);
  if (t.length !== at.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const V = z(() => at.allBookIds.filter(
    (O, U) => t[U] === "1" && !at.isObsolete(at.bookIdToNumber(O))
  ), [t]), x = z(() => {
    if (!k.trim()) {
      const D = {
        [q.OT]: [],
    ...
    (O, U = !1) => {
      if (!U || !P.current) {
        n(
          e.includes(O) ? e.filter((pt) => pt !== O) : [...e, O]
        ), P.current = O;
        return;
      }
      const D = V.findIndex((pt) => pt === P.current), F = V.findIndex((pt) => pt === O);
      if (D === -1 || F === -1) return;
      const [st, ht] = [
        Math.min(D, F),
        Math.max(D, F)
      ], Vt = V.slice(st, ht + 1).map((pt) => pt);
      n(
        e.includes(O) ? e.filter((pt) => !Vt.includes(pt)) : [.../* @__PURE__ */ new Set([...e, ...Vt])]
      );
    },
    [e, n, V]
  ), _ = (O) => {
    E(O, $.current), $.current = !1;
  }, T = (O, U) => {
    O.preventDefault(), E(U, O.shiftKey);
  }, C = B(
    (O) => {
      const U = Dr(V, O).map((D) => D);
      n(
        Oa(V, O, e) ? e.filter((D) => !U.includes(D)) : [.../* @__PURE__ */ new Set([...e, ...U])]
      );
    },
    [e, n, V]
  ), A = () => {
  ...
  return /* @__PURE__ */ c("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(q).map((O) => /* @__PURE__ */ r(
      Od,
      {
        section: O,
        availableBookIds: V,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            qt,
            {
              shouldFilter: !1,
              onKeyDown: (O) => {
                O.key === "Enter" && ($.current = O.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  $e,
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: A, children: d }),
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: G, children: w })
                ] }),
                /* @__PURE__ */ c(Ht, { children: [
                  /* @__PURE__ */ r(rn, { children: p }),
                  Object.values(q).map((O, U) => {
                    const D = x[O];
                    if (D.length !== 0)
                      return /* @__PURE__ */ c(so, { children: [
                        /* @__PURE__ */ r(
                          Kt,
                          {
                            heading: jo(O, h, u, g, y),
                            children: D.map((F) => /* @__PURE__ */ r(
                              Fo,
                              {
                                bookId: F,
                                isSelected: e.includes(F),
                                onSelect: () => _(F),
                                onMouseDown: (st) => T(st, F),
                                section: Ke(F),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: nr(F, a),
                        ...
                        U < Object.values(q).length - 1 && /* @__PURE__ */ r(Vo, {})
                      ] }, O);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ c("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Kn ? Kn : ao
      ).map((O) => /* @__PURE__ */ r(Se, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(O, a) }, O)),
      e.length > Kn && /* @__PURE__ */ r(
        Se,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - ao} ${m}`
        }
      )
    ] })
  ] });
...
function _p({
  ...
  const w = de(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = de(i, "%webView_scope_selector_current_book%"), u = de(i, "%webView_scope_selector_choose_books%"), g = de(i, "%webView_scope_selector_scope%"), y = de(i, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        br,
        {
          ...
          children: N.map(({ value: k, label: R, id: P }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(bn, { className: "tw-me-2", value: k, id: P }),
            /* @__PURE__ */ r(wt, { htmlFor: P, children: R })
          ] }, P))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(wt, { children: y }),
      /* @__PURE__ */ r(
        Ad,
        {
          availableBookInfo: o,
...
function Cp({
  ...
  return /* @__PURE__ */ c(
    Me,
    {
      ...
      children: [
        /* @__PURE__ */ r(ve, { size: a, className: f("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Ie,
          {
            placeholder: l[X(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          xe,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(xt, { value: `${w}`, children: l[X(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Pa = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(At, { children: [
  /* @__PURE__ */ r(zt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    yn,
    {
      onClick: () => {
        o(l);
  ...
  ) : /* @__PURE__ */ c(_w, { children: [
    /* @__PURE__ */ r(ba, { children: l.label }),
    /* @__PURE__ */ r(kw, { children: /* @__PURE__ */ r(va, { children: Pa(
      t,
      e,
      Aa(t, l.id),
      o
...
function cr({
  ...
  return /* @__PURE__ */ c(ye, { variant: s, children: [
    /* @__PURE__ */ r(Ve, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(L, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Os, {}) }) }),
    /* @__PURE__ */ r(se, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(so, { children: [
      /* @__PURE__ */ r(ga, { children: /* @__PURE__ */ r(Ct, { children: Pa(e.groups, e.items, d, t) }) }),
...
function Sp({
  ...
  return /* @__PURE__ */ c($a, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      cr,
      {
        onSelectMenuItem: t,
...
function Dp({
  ...
  return /* @__PURE__ */ r($a, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    cr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
Va.displayName = vt.List.displayName;
...
La.displayName = vt.List.displayName;
...
)), ja = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  vt.Content,
  {
    ref: n,
    className: f(
...
ja.displayName = vt.Content.displayName;
function Mp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Va, { children: [
      /* @__PURE__ */ r(La, { children: t.map((l) => /* @__PURE__ */ r(Pd, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(ja, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function $d({ ...t }) {
...
const za = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
za.displayName = tt.Root.displayName;
...
Fa.displayName = tt.Trigger.displayName;
const Ba = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ c(
    tt.SubTrigger,
...
Ba.displayName = tt.SubTrigger.displayName;
...
Ga.displayName = tt.SubContent.displayName;
const Ka = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Dt();
...
Ka.displayName = tt.Content.displayName;
const Ua = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Dt();
  return /* @__PURE__ */ r(
    tt.Item,
    {
...
Ua.displayName = tt.Item.displayName;
const Ld = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ c(
    tt.CheckboxItem,
    {
...
Ld.displayName = tt.CheckboxItem.displayName;
const jd = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ c(
    tt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(tt.ItemIndicator, { children: /* @__PURE__ */ r(_n, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
jd.displayName = tt.RadioItem.displayName;
...
zd.displayName = tt.Label.displayName;
...
qa.displayName = tt.Separator.displayName;
const Be = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(At, { children: [
      /* @__PURE__ */ r(zt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        Ua,
        {
          onClick: () => {
            o(w);
        ...
        /* @__PURE__ */ r(Ba, { children: w.label }),
        /* @__PURE__ */ r(Ga, { children: Ha(
          t,
          e,
          Aa(t, w.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(qa, {}, `separator-${s}`)), d;
  });
};
function Fd({
  menuData: t,
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    var g, y, v, N;
    p.preventDefault();
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Be(s, [h, u]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Be(i, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Be(l, [h, u]);
        break;
      case "alt+h":
        (N = d.current) == null || N.focus(), Be(d, [h, u]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ r(za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ c($d, { children: [
      /* @__PURE__ */ r(Fa, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        Ka,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ct, { children: Ha(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function Ap({
  ...
  const w = Bd(
    ...
    var N, k, R, P, $, V;
    const v = y !== g ? ((k = (N = t[g]) == null ? void 0 : N.uiNames) == null ? void 0 : k[y]) ?? ((P = (R = t[g]) == null ? void 0 : R.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${($ = t[g]) == null ? void 0 : $.autonym} (${v})` : (V = t[g]) == null ? void 0 : V.autonym;
  };
  return /* @__PURE__ */ c("div", { id: d, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ c(
      Me,
      {
        name: "uiLanguage",
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(ve, { children: /* @__PURE__ */ r(Ie, {}) }),
          /* @__PURE__ */ r(
            xe,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(xt, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(wt, { className: "tw-font-normal tw-text-muted-foreground", children: ue(w, {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ c(ye, { children: [
              /* @__PURE__ */ r(Ve, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(co, {}) }) }),
...
const Kd = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r($s, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
function Vp({
  ...
  return /* @__PURE__ */ c("div", { className: f("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": o }), children: [
    /* @__PURE__ */ r(
      wt,
      {
        htmlFor: t,
...
), qd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Yd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Yd.displayName = "AlertDescription";
const Lp = et.Root, jp = et.Trigger, zp = et.Group, Fp = et.Portal, Bp = et.Sub, Gp = et.RadioGroup, Xd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  et.SubTrigger,
  {
    ref: a,
    className: f(
...
Xd.displayName = et.SubTrigger.displayName;
...
Wd.displayName = et.SubContent.displayName;
const Jd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(et.Portal, { children: /* @__PURE__ */ r(
  et.Content,
  {
    ref: n,
    className: f(
...
Jd.displayName = et.Content.displayName;
const Zd = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  et.Item,
  {
    ref: o,
...
Zd.displayName = et.Item.displayName;
...
Qd.displayName = et.CheckboxItem.displayName;
const tc = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  et.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(et.ItemIndicator, { children: /* @__PURE__ */ r(_n, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
tc.displayName = et.RadioItem.displayName;
...
ec.displayName = et.Label.displayName;
...
nc.displayName = et.Separator.displayName;
...
function oc({
  ...
  return /* @__PURE__ */ r(Ya.Provider, { value: o, children: /* @__PURE__ */ r(
    St.Root,
    {
...
const Kp = St.Trigger, ac = St.Portal, Up = St.Close, Xa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
...
Xa.displayName = St.Overlay.displayName;
const sc = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(Ya), i = {
...
wc.displayName = St.Title.displayName;
...
dc.displayName = St.Description.displayName;
...
cc.displayName = tr.Root.displayName;
function qp({
  className: t,
  ...e
}) {
...
function Yp({
  ...
  return /* @__PURE__ */ r(
    fr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Vs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Xp({ ...t }) {
...
uc.displayName = er.Root.displayName;
const Wp = vt.Root, mc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = dt();
  return /* @__PURE__ */ r(
    vt.List,
    {
...
mc.displayName = vt.List.displayName;
...
fc.displayName = vt.Trigger.displayName;
...
hc.displayName = vt.Content.displayName;
