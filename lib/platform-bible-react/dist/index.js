...
function tp({
  ...
  const w = ba(l, "%webView_bookSelector_currentBook%"), p = ba(l, "%webView_bookSelector_choose%"), f = ba(l, "%webView_bookSelector_chooseBooks%"), [h, m] = C(
    "current book"
    /* CurrentBook */
  ), k = (v) => {
    m(v), t(v);
...
function Ml(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: f } = n.getBoundingClientRect(), h = Ol(t, e);
    var m, k;
...
function Pl(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      const [f, h] = function(P) {
        const y = P.getStartEndPoints();
        return P.isBackward() ? [y[1], y[0]] : y;
      }(p), m = f.getNode(), k = m.getKey(), v = f.offset, D = h.getNode(), T = D.getKey(), _ = h.offset, N = t.getElementByKey(k), A = t.getElementByKey(T), F = r === null || N !== o || v !== n || k !== r.getKey(), V = i === null || A !== s || _ !== c || T !== i.getKey();
...
class ar {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const f of Hl(p)) {
  ...
  const o = r.getDependency(qa).output, n = _r({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
    ...
    o.value.read(() => {
      if (qt()) for (const [w, p] of c.entries()) {
        ...
        const f = kc(w), h = f && f.isSelected() || !1;
  ...
  return Se(t.registerCommand(rd, (s) => {
    ...
    if (pc(s.target)) {
      ...
      if (od(c)) return function(d, l = !1) {
        ...
        let h;
        l && Rn(w) ? h = w : (h = gc(), fc(h)), p ? h.delete(f) : h.add(f);
      }(c, s.shiftKey), !0;
    }
    return !1;
    ...
    Ul(() => {
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        f ? f.domNode.value = h : (d = !0, l.set(w, { domNode: _r(h), selectedSignal: o(w) }));
      }
...
function nd(t, e, r = ni) {
  return Se(t.registerCommand(Nc, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((f) => Cc(f) && f.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Vl(w);
      if (p.canIndent()) {
        const f = p.getKey();
        let h = Ec();
        if (h.anchor.set(f, 0, "element"), h.focus.set(f, 0, "element"), h = Tc(h), h.anchor.is(l)) return !0;
      }
      return !1;
  ...
  return function(r, o) {
    ...
    return lo(() => r.registerDecoratorListener((s) => {
      ...
      for (let d = 0; d < c.length; d++) {
        const l = c[d], w = a(o, { onError: (f) => r._onError(f), children: a(qs, { fallback: null, children: n[l] }) }), p = r.getElementByKey(l);
...
function rp({
  ...
  const [i, s] = C(Ad), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), f = q(null);
  X(() => {
    let v = !0;
    const D = f.current;
    if (!D) return;
...
function Bd({
  ...
  const [d, l] = C("accept"), w = r ?? d, p = zo(), f = zo(), h = n === "accept", m = n === "none", k = n === "acceptRejectOrMerge", v = h ? "accept" : w, D = L(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), T = L(
    () => qr(t.acceptedText ?? ""),
  ...
  const S = () => {
    ...
    const Y = v === O.value, st = `${f}-${O.value}`, B = h && O.value === "reject";
    return (
...
function ew({
  ...
  var F;
  const [w, p] = C([]), [f, h] = C([]), [m, k] = C({}), [v, D] = C({}), T = L(() => e ?? [], [e]), _ = Vn({
    data: T,
    columns: t,
    getCoreRowModel: jn(),
...
function vp({
  ...
  return /* @__PURE__ */ u(Re, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u($e, { id: i, className: g("tw:min-w-80 tw:max-w-96", n), children: [
...
function bp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    ...
    /* @__PURE__ */ a(De, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(un, { children: l.itemType === 0 ? /* @__PURE__ */ a(at, { children: l.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Le,
        {
          checked: o[w][f],
...
function dw({
  ...
  const i = q(null), s = q(null), c = q(!1), [d, l] = C(t), [w, p] = C(r), [f, h] = C(!1);
  X(() => {
    l(t);
  }, [t]), X(() => {
    w !== r && p(r);
...
function _p({
  ...
  const ee = () => {
    ...
    if (f.current && Vt.length && $ && $.rangeCount > 0) {
      const H = $.getRangeAt(0).getBoundingClientRect(), Z = f.current.getBoundingClientRect();
...
function _w({
  ...
  /* @__PURE__ */ u("span", { className: g("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    go(t.marker, [s], o, !1),
    " "
  ] }), f = e === "horizontal" ? "horizontal" : "vertical", h = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", k = g(f, h);
  return /* @__PURE__ */ u(at, { children: [
    /* @__PURE__ */ u("div", { className: g("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: [
      d,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: g("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", k), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: g(
...
function Cp({
  ...
  const w = d ?? ss(r, void 0), p = (T, _) => {
    l == null || l(T, _, n);
  }, f = i ? r.findIndex((T) => T === i) : -1, [h, m] = C(f), k = (T, _, N) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
...
const ki = na(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ls, { size: 35, className: g("tw:animate-spin", t), ...e, ref: r }));
...
function Ap({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = L(
    ...
    [t]
  ), T = p.length === 0 && f.length === 0 && h.length === 0, _ = _e(n, "%resourcePicker_title%"), N = _e(n, "%resourcePicker_search_placeholder%"), A = _e(n, "%resourcePicker_language_filter_any%"), F = _e(
    n,
    "%resourcePicker_section_already_selected%"
  ...
  return /* @__PURE__ */ u(at, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !T && !e && /* @__PURE__ */ a(ca, { children: /* @__PURE__ */ u(la, { children: [
        ...
        /* @__PURE__ */ a(za, { label: V, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          za,
          {
            label: P,
...
function Aw({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), f = ut.useCallback(() => p((_) => !_), [p]), h = w ? "expanded" : "collapsed", v = Gt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", D = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Bw({
  ...
  const c = t ? ur.Root : "button", { state: d } = ua(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: g(Fw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Xp({
  ...
  const [l, w] = C([]), [p, f] = C([{ id: Ie, desc: !1 }]), [h, m] = C({}), k = L(
  ...
  }, V = (y, z) => y.getIsGrouped() ? "" : g("banded-row", z % 2 === 0 ? "even" : "odd"), P = (y, z, I) => {
...
function Zp({
  ...
  const N = Rt(
    ...
    (M) => {
      f == null || f(M), h == null || h(M), ae.current = !0;
    },
    [f, h]
  ), H = j(
    (M) => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: g(b && rt), children: Y }),
      /* @__PURE__ */ a(
        va,
        {
    ...
    /* @__PURE__ */ u("div", { ref: xt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: g(G && rt), children: st }),
      /* @__PURE__ */ a(
        va,
        {
          id: "scope-range-end",
  ...
  const mo = j(
    ...
    pt !== void 0 && (pt === "range" ? (ne && (f == null || f(ne)), ke && (h == null || h(ke))) : pt === "selectedBooks" && i(Ae), Z(pt), Tt(void 0), ye(void 0));
  }, [
    pt,
    ne,
    ke,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (k = s.current) == null || k.focus(), mr(s, [f, h]);
        break;
      case "alt+n":
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(ze, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
...
function Uh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: g("pr-twp", xu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
