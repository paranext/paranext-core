...
import c, { forwardRef as Lt, createContext as Yn, useContext as Hn, useCallback as tt, useState as P, useRef as K, useEffect as wt, useLayoutEffect as je, useMemo as W, Fragment as Un } from "react";
...
import { useReactTable as Je, getFilteredRowModel as Cr, getSortedRowModel as Ke, getPaginationRowModel as Sr, getCoreRowModel as We, flexRender as It, getGroupedRowModel as Rr, getExpandedRowModel as Tr } from "@tanstack/react-table";
...
const Ne = B.Trigger, tn = B.Group, Br = B.Portal, Vr = B.Sub, Ko = B.RadioGroup;
function Ut({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(ye.Provider, { value: n, children: /* @__PURE__ */ r(B.Root, { ...e }) });
}
...
const Xt = c.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = F();
...
const ke = c.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = F(), s = et();
  return /* @__PURE__ */ r(
    B.Item,
    {
...
const Ce = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = et();
  return /* @__PURE__ */ d(
    B.CheckboxItem,
    {
...
Ce.displayName = B.CheckboxItem.displayName;
const rn = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    B.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(be, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
var Or = Object.defineProperty, Pr = (t, e, n) => e in t ? Or(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => Pr(t, typeof e != "symbol" ? e + "" : e, n);
const mt = [
  "GEN",
  "EXO",
  "LEV",
...
const Y = class E {
  constructor(e, n, a, o) {
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        this.setEmpty(s), this._verseNum = e % E.chapterDigitShifter, this._chapterNum = Math.floor(
          e % E.bookDigitShifter / E.chapterDigitShifter
        ), this._bookNum = Math.floor(e / E.bookDigitShifter);
      } else if (n == null)
        if (e != null && e instanceof E) {
          ...
          if (e == null) return;
          const s = e instanceof pt ? e : E.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof e == "string" && typeof n == "string" && typeof a == "string")
        ...
        this._bookNum = e, this._chapterNum = n, this._verseNum = a, this.versification = o ?? E.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static tryParse(e) {
    let n;
    try {
      return n = new E(e), { success: !0, verseRef: n };
    } catch (a) {
      if (a instanceof _t)
        return n = new E(), { success: !1, verseRef: n };
      throw a;
    }
  }
  /**
  ...
  static getBBBCCCVVV(e, n, a) {
    return e % E.bcvMaxValue * E.bookDigitShifter + (n >= 0 ? n % E.bcvMaxValue * E.chapterDigitShifter : 0) + (a >= 0 ? a % E.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(e) {
    ...
    let p;
    return w && (p = new pt(w)), n ? new E(n, a.toString(), i, p) : new E();
  }
  /**
   ...
   */
  get hasMultiple() {
    return this._verse != null && (this._verse.includes(E.verseRangeSeparator) || this._verse.includes(E.verseSequenceIndicator));
  }
  /**
  ...
  set verse(e) {
    const { success: n, vNum: a } = E.tryGetVerseNum(e);
    this._verse = n ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = a, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = E.tryGetVerseNum(this._verse));
  }
  /**
   ...
   */
  get validStatus() {
    return this.validateVerse(E.verseRangeSeparators, E.verseSequenceIndicators);
  }
  /**
   ...
   */
  get BBBCCC() {
    return E.getBBBCCCVVV(this._bookNum, this._chapterNum, 0);
  }
  /**
   * Gets the reference as a comparable integer where the book,
   ...
   */
  get BBBCCCVVV() {
    return E.getBBBCCCVVV(this._bookNum, this._chapterNum, this._verseNum);
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || X.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !E.isVerseParseable(a[1]))
      throw new _t("Invalid reference : " + e);
   ...
   */
  equals(e) {
    return e instanceof E ? e._bookNum === this._bookNum && e._chapterNum === this._chapterNum && e._verseNum === this._verseNum && e.verse === this.verse && (e.versification == null && this.versification == null || e.versification != null && this.versification != null && e.versification.equals(this.versification)) : !1;
  }
  /**
   ...
   */
  allVerses(e = !1, n = E.verseRangeSeparators, a = E.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], s = Ge(this._verse, a);
    for (const w of s.map((i) => Ge(i, n))) {
      const i = this.clone();
      i.verse = w[0];
      const p = i.verseNum;
  ...
  setEmpty(e = E.defaultVersification) {
...
const _e = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), Wr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], Zr = 96, Qr = [
...
function Zo({
  ...
  const o = F(), [s, w] = P(""), [i, p] = P(t.book), [u, g] = P(t.chapterNum ?? 0), [b, h] = P(t.book), [m, f] = P(!1), [k, C] = P(m), y = K(void 0), x = K(void 0), z = K(void 0), $ = tt(
    (S) => {
      const M = a ? a() : _e;
      return {
        ...
        const v = X.bookIdToEnglishName(O).toLowerCase(), _ = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (S, M, O, v) => {
      if (g(t.book !== S ? 1 : t.chapterNum), M || Et(S) === -1) {
        e({
          book: S,
          chapterNum: O ?? 1,
          verseNum: v ?? 1
    ...
    Qr.forEach((S) => {
      const M = S.exec(s);
      if (M) {
        const [O, v = void 0, _ = void 0] = M.slice(1), Z = na(O);
    ...
    (S) => {
      m ? (S.key === "ArrowDown" || S.key === "ArrowUp") && (z != null && z.current ? z.current.focus() : x.current && x.current.focus(), S.preventDefault()) : f(!0);
    },
    [m]
  ), ee = (S) => {
    const { key: M } = S;
    ...
    if (b === i) {
      ...
      const O = M === "ArrowRight" && !o || M === "ArrowRight" && o === "ltr" || M === "ArrowLeft" && o === "rtl", v = M === "ArrowLeft" && !o || M === "ArrowLeft" && o === "ltr" || M === "ArrowRight" && o === "rtl";
      let _ = 0;
      if (O)
        if (u < Et(b))
          _ = 1;
  ...
  return wt(() => {
    i === b ? i === t.book ? g(t.chapterNum) : g(1) : g(0);
  }, [b, t.book, t.chapterNum, i]), je(() => {
    C(m);
  }, [m]), je(() => {
    const S = setTimeout(() => {
      if (k && x.current && z.current && !s) {
        const O = z.current.offsetTop - Zr;
  ...
  }, [k, s]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Ut, { modal: !1, open: m, onOpenChange: dt, children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(
      Dr,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          p(t.book), h(t.book), g(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), w(Dt(t, "English")), y.current.focus();
        },
        onFocus: () => {
          lt.current = !0;
        },
      ...
      Xt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((S, M) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            ...
            $e.length - 1 !== M ? /* @__PURE__ */ r(jt, {}) : void 0
          ] }, S);
        }) })
      }
    )
...
), G = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: l("pr-twp", aa(), t), ...e }));
...
const pe = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Bt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(be, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
pe.displayName = Bt.Item.displayName;
const pn = Vt.Root, un = Vt.Trigger, Ee = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = F();
...
sa.displayName = rt.Content.displayName;
...
ia.displayName = rt.Title.displayName;
...
const Me = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
...
function ue({
  ...
  const [C, y] = P(!1);
  return /* @__PURE__ */ d(pn, { open: C, onOpenChange: y, ...k, children: [
...
function ts({
  ...
  const g = oe(u, "%webView_bookSelector_currentBook%"), b = oe(u, "%webView_bookSelector_choose%"), h = oe(u, "%webView_bookSelector_chooseBooks%"), [m, f] = P(
    "current book"
    /* CURRENT_BOOK */
  ), k = (C) => {
    f(C), t(C);
    ...
    cn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(G, { className: "tw-flex tw-items-center", children: a.map((C) => X.bookIdToEnglishName(C)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
function ua({ table: t }) {
  return /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(Kn, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const vt = j.Root, ma = j.Group, xt = j.Value, ht = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
  return /* @__PURE__ */ d(
    j.Trigger,
    {
...
ha.displayName = j.Label.displayName;
...
ga.displayName = j.Separator.displayName;
function fa({ table: t }) {
...
const Jt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => {
  ...
  const s = (w) => {
    ...
    if (i) {
      if (w.key === "ArrowDown") {
        w.preventDefault(), At(i)[0].focus();
        return;
      }
      w.key === " " && document.activeElement === i && w.preventDefault();
    }
  };
...
const Kt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: l(
...
const Wt = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? At(t.current) : [], s = o.indexOf(document.activeElement), w = a.key === "ArrowRight" ? s + 1 : s - 1;
...
const it = c.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a, ...o }, s) => {
  ...
  const i = (h, m, f) => {
    ...
    if (h.key === "ArrowDown" || h.key === "ArrowUp")
      h.preventDefault(), i(k, C, h.key);
    else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
      h.preventDefault(), p(u, y, h.key);
...
function ka({
  ...
  var C;
  const [i, p] = P([]), [u, g] = P([]), [b, h] = P({}), [m, f] = P({}), k = Je({
    data: e,
    columns: t,
    getCoreRowModel: We(),
    ...n && { getPaginationRowModel: Sr() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ua, { table: k }),
    /* @__PURE__ */ d(Jt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Kt, { stickyHeader: s, children: k.getHeaderGroups().map((y) => /* @__PURE__ */ r(it, { children: y.headers.map((x) => /* @__PURE__ */ r(Ot, { children: x.isPlaceholder ? void 0 : It(x.column.columnDef.header, x.getContext()) }, x.id)) }, y.id)) }),
    ...
    n && a && /* @__PURE__ */ r(fa, { table: k })
  ] });
}
const Ft = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(rr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function os({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(_r, { options: o, children: e }) });
}
const Ca = Lt((t, e) => /* @__PURE__ */ d(
  I,
  {
    ref: e,
...
function ss({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ut, { children: [
    /* @__PURE__ */ r(Ne, { asChild: !0, children: /* @__PURE__ */ r(Ca, {}) }),
...
function Ra({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    const p = new Date(i), u = new Date(o.getTime() - p.getTime()), g = u.getUTCFullYear() - 1970, b = u.getUTCMonth(), h = u.getUTCDate() - 1;
    let m = "";
...
function _a({
  ...
  const [b, h] = P(!1), m = tt(
    (C) => {
      var x;
      const y = (x = t.find((z) => z.label === C)) == null ? void 0 : x.value;
      y && a(
        n.includes(y) ? n.filter((z) => z !== y) : [...n, y]
      );
    },
    [t, n, a]
  ), f = () => w || o, k = W(() => {
    if (!p) return t;
    const C = t.filter((x) => x.starred).sort((x, z) => x.label.localeCompare(z.label)), y = t.filter((x) => !x.starred).sort((x, z) => {
      const $ = n.includes(x.value), q = n.includes(z.value);
      return $ && !q ? -1 : !$ && q ? 1 : x.label.localeCompare(z.label);
    });
    return [...C, ...y];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ d(pn, { open: b, onOpenChange: h, children: [
    /* @__PURE__ */ r(un, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ze, { children: [
      /* @__PURE__ */ r(Me, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ d(De, { children: [
        /* @__PURE__ */ r(Ie, { children: s }),
        /* @__PURE__ */ r(hn, { children: k.map((C) => {
          ...
          return /* @__PURE__ */ d(
            Be,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: C.starred && /* @__PURE__ */ r(lr, { className: "tw-h-4 tw-w-4" }) }),
...
), za = c.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Ze.Root,
  {
    ref: o,
...
za.displayName = Ze.Root.displayName;
const xn = c.createContext({
  size: "default",
  variant: "default"
...
yn.displayName = Ht.Root.displayName;
const Gt = c.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
const Zt = (t) => t === "asc" ? /* @__PURE__ */ r(ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), cs = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-center", children: [
      /* @__PURE__ */ d(yn, { value: w, variant: "outline", type: "single", children: [
        /* @__PURE__ */ r(
          Gt,
          {
            onClick: (p) => {
  ...
  return e ? e[1] : "";
}, Da = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fs = Object.freeze([
...
function bs({
  ...
  const u = ot(n, "%webView_inventory_all%"), g = ot(n, "%webView_inventory_approved%"), b = ot(n, "%webView_inventory_unapproved%"), h = ot(n, "%webView_inventory_unknown%"), m = ot(n, "%webView_inventory_scope_currentBook%"), f = ot(n, "%webView_inventory_scope_chapter%"), k = ot(n, "%webView_inventory_filter_text%"), C = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, x] = P(!1), [z, $] = P("all"), [q, lt] = P(""), [dt, N] = P([]), T = W(() => t.length === 0 ? [] : Ba(t, o, s), [t, o, s]), L = W(() => {
    if (y) return T;
    const v = [];
    return T.forEach((_) => {
      ...
      ct ? (ct.count += _.count, ct.occurrences = ct.occurrences.concat(_.occurrences)) : v.push({
        items: [Z],
        count: _.count,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(vt, { onValueChange: (v) => S(v), defaultValue: w, children: [
...
Ae.displayName = Qe.Root.displayName;
...
const Oe = Pt.Provider, Pe = Pt.Root, Xe = Pt.Trigger, Qt = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Pt.Content,
  {
    ref: a,
    sideOffset: e,
...
const kn = c.forwardRef(
  ({
    ...
    const [u, g] = c.useState(t), b = e ?? u, h = c.useCallback(
      (z) => {
        const $ = typeof z == "function" ? z(b) : z;
        n ? n($) : g($);
      },
      [n, b]
    ), m = c.useCallback(() => h((z) => !z), [h]), f = b ? "expanded" : "collapsed", y = F() === "ltr" ? w : w === "primary" ? "secondary" : "primary", x = c.useMemo(
      () => ({
        state: f,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Nn.Provider, { value: x, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const La = ft(
  ...
  ({
    ...
    const p = t ? Ct : "button", { state: u } = te(), g = /* @__PURE__ */ r(
      p,
      {
        ref: i,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(Xe, { asChild: !0, children: g }),
      /* @__PURE__ */ r(Qt, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : g;
  }
);
En.displayName = "SidebarMenuButton";
const Ya = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Ct : "button",
  {
    ref: o,
...
const Ua = c.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
const Ka = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Ct : "a",
  {
    ref: s,
    ...
    Cn,
    {
      ...
      children: /* @__PURE__ */ d(Rn, { children: [
        /* @__PURE__ */ d(me, { children: [
          ...
          /* @__PURE__ */ r(ge, { children: /* @__PURE__ */ r(Tn, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(_n, { children: /* @__PURE__ */ r(
            En,
            {
              onClick: () => u(h),
              isActive: b(h),
...
const st = "scrBook", Za = "scrRef", ut = "source", Qa = "details", to = "Scripture Reference", eo = "Scripture Book", Mn = "Type", no = "Details";
function ro(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? X.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === st ? Dt(o.start) : void 0;
      },
...
function xs({
  ...
  const [p, u] = P([]), [g, b] = P([{ id: st, desc: !1 }]), [h, m] = P({}), f = W(
  ...
  }, lt = (N, T) => N.getIsGrouped() ? "" : l("banded-row", T % 2 === 0 ? "even" : "odd"), dt = (N, T, L) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(gt, { position: "item-aligned", children: /* @__PURE__ */ r(ma, { children: z.map((N) => /* @__PURE__ */ r(Q, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Jt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Kt, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(it, { children: N.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        /* @__PURE__ */ r(Ot, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(fe, {}) : /* @__PURE__ */ r(vr, {})),
                          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          gt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((i) => /* @__PURE__ */ r(Q, { value: `${i}`, children: s[D(i)] }, `${i}`))
          }
        )
      ]
    }
...
).sort(([, s], [, w]) => s.order - w.order).flatMap(([s]) => e.filter((i) => i.group === s).sort((i, p) => i.order - p.order).map((i) => /* @__PURE__ */ d(Pe, { children: [
  /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    ke,
    {
      onClick: () => {
        a(i);
    ...
    /* @__PURE__ */ r(Br, { children: /* @__PURE__ */ r(nn, { children: In(
      t,
      e,
      Dn(t, i.id),
      a
...
function Ss({
  ...
  return /* @__PURE__ */ d(Ut, { variant: s, children: [
    /* @__PURE__ */ r(Ne, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(xr, {}) }) }),
    /* @__PURE__ */ r(Xt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, p]) => typeof i == "boolean" || typeof p == "boolean" ? 0 : i.order - p.order).map(([i], p, u) => /* @__PURE__ */ d(Un, { children: [
      /* @__PURE__ */ r(tn, { children: /* @__PURE__ */ r(Oe, { children: In(e.groups, e.items, i, t) }) }),
...
function Rs({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Bn, { children: [
      /* @__PURE__ */ r(Vn, { children: t.map((w) => /* @__PURE__ */ r(oo, { value: w.value, children: w.value }, w.key)) }),
      t.map((w) => /* @__PURE__ */ r(An, { value: w.value, children: w.content }, w.key))
    ] })
  ] });
}
function so({ ...t }) {
...
function po({
  ...
  const o = K(void 0), s = K(void 0), w = K(void 0), i = K(void 0), p = K(void 0), u = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (Er(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var f, k, C, y;
    g.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = s.current) == null || f.focus(), zt(s, [h, m]);
        break;
      case "alt+l":
        (k = w.current) == null || k.focus(), zt(w, [h, m]);
        break;
      case "alt+n":
        (C = i.current) == null || C.focus(), zt(i, [h, m]);
        break;
      case "alt+h":
        (y = p.current) == null || y.focus(), zt(p, [h, m]);
        break;
    }
  }), wt(() => {
    ...
    return /* @__PURE__ */ r(On, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(so, { children: [
      /* @__PURE__ */ r(Pn, { ref: u(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        Fn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Ln(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Es({
  ...
  const p = uo(
    ...
    var C, y, x, z, $, q;
    const k = f !== m ? ((y = (C = t[m]) == null ? void 0 : C.uiNames) == null ? void 0 : y[f]) ?? ((z = (x = t[m]) == null ? void 0 : x.uiNames) == null ? void 0 : z.en) : void 0;
...
Eo.displayName = ce.Root.displayName;
const Is = U.Root, zo = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
zo.displayName = U.List.displayName;
...
Mo.displayName = U.Trigger.displayName;
...
Do.displayName = U.Content.displayName;
const Bs = (t, e) => {
  wt(() => {
    if (!t) return () => {
    };
