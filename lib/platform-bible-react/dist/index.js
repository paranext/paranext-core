...
var ji = (t, e, r) => e in t ? Pi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Bt = (t, e, r) => ji(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Se, a as Fa, C as Ce, A as se, P as Me, b as Ye, B as U, d as $e, e as Ie, f as Ae, h as xe, i as Li, k as Bi, j as Fi, E as Ui, l as Ua, r as re, m as Ki, n as dn, o as Qr, p as ta, L as Nt, D as Na, q as Ca, s as Ea, t as Ta, T as Gt, u as Ka, v as Ht, w as Yt, x as Wt, y as wn, z as qa, F as qe, G as kr, H as ye, I as ke, J as _e, S as _r, K as tr, M as qi, N as Er, O as He, Q as De, Z as We, R as Re, U as er, V as Ga, W as Ha, X as qr, Y as Ya, _ as un, $ as Gi, a0 as Hi, a1 as Yi, a2 as xo, a3 as pn, a4 as ea, a5 as hn, a6 as Wi, a7 as Xi, a8 as Ji, a9 as Zi, aa as gn, ab as Qi, ac as sa, ad as yo, ae as ca, af as ts, ag as es, ah as rs, ai as as, aj as os, ak as Tr, al as Wa, am as ns, an as is } from "./resizable-Ds9c_6hc.js";
import { ao as Wh, ap as Xh, aq as Jh, ar as Zh, as as Qh, at as tg, au as eg, av as rg, aw as ag, ax as og, ay as ng, az as ig, aA as sg, aB as cg, aC as lg, aD as dg, aE as wg, aF as ug, aG as pg, aH as hg, aI as gg, aJ as fg, aK as mg, aL as vg, aM as bg } from "./resizable-Ds9c_6hc.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as vt } from "@sillsdev/scripture";
import { Check as or, Clock as ko, ChevronsLeft as _o, ChevronsRight as No, ChevronLeft as za, ChevronRight as Sa, ArrowLeft as ss, ArrowRight as cs, ChevronDown as nr, BoldIcon as ls, ItalicIcon as ds, X as Xa, AtSign as fn, Pencil as ws, Trash2 as us, ArrowUp as mn, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as vn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, Undo as Es, Redo as Ts, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as zs, AlertCircle as Ra, CircleCheckIcon as Ss, CircleXIcon as Rs, CircleHelpIcon as Ds, ArrowUpIcon as Os, ArrowDownIcon as Ms, ScrollText as $s, ChevronsUpDown as Is, MenuIcon as As, Menu as Vs, EllipsisVertical as Ps, MoreVertical as Co } from "lucide-react";
import { Section as dt, getChaptersForBook as js, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Ls, formatReplacementString as Ge, sanitizeHtml as Ja, NumberFormat as kn, formatBytes as Bs, getCurrentLocale as Fs, usfmMarkers as Pr, getFormatCallerFunction as Us, deepEqual as Ks, isString as Eo, compareScrRefs as Da, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as qs, getLocalizeKeyForScrollGroupId as To, collectUsjMarkers as Gs } from "platform-bible-utils";
import Rt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Hs, useLayoutEffect as Qt, createContext as Za, useContext as _n, Component as Ys, createElement as zo, Suspense as Ws, forwardRef as Nn, useId as So, Fragment as Qa } from "react";
import { IconSelector as Cn, IconCheck as ra, IconChevronDown as Xs, IconChevronUp as Js, IconLayoutSidebar as Zs, IconLayoutSidebarRight as Qs, IconChevronRight as En, IconSearch as tc, IconLoader as ec, IconAlertOctagon as rc, IconAlertTriangle as ac, IconInfoCircle as oc, IconCircleCheck as nc } from "@tabler/icons-react";
import { RadioGroup as Oa, ToggleGroup as Tn, Avatar as to, Select as Ut, Checkbox as Ro, Slot as zr, Tabs as ce, Menubar as he, ContextMenu as Dt, Progress as Do, Slider as Or, Switch as Oo } from "radix-ui";
import { createEditor as zn, $getRoot as Oe, $createParagraphNode as Sr, $getSelection as Xt, HISTORY_MERGE_TAG as eo, ParagraphNode as Sn, TextNode as Rn, $getPreviousSelection as ic, $isRangeSelection as ue, $caretFromPoint as sc, $getSiblingCaret as Dn, $getChildCaret as cc, $getAdjacentChildCaret as lc, $isChildCaret as dc, $normalizeCaret as wc, $setSelectionFromCaretRange as uc, $getCollapsedCaretRange as pc, $getCaretInDirection as Mo, $splitAtPointCaretNext as hc, $isTextPointCaret as gc, $findMatchingParent as On, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as fc, isHTMLElement as mc, CLEAR_EDITOR_COMMAND as Mn, COMMAND_PRIORITY_EDITOR as ro, shallowMergeConfig as vc, defineExtension as ae, safeCast as Xe, createState as bc, FORMAT_TEXT_COMMAND as $n, $isNodeSelection as In, COMMAND_PRIORITY_LOW as An, RootNode as xc, LineBreakNode as yc, TabNode as kc, $isEditorState as _c, createCommand as Nc, CLICK_COMMAND as Cc, isDOMNode as Ec, $getNodeFromDOMNode as Tc, $createNodeSelection as zc, $setSelection as Sc, $getEditor as Rc, DecoratorNode as Ma, $getState as Dc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as Oc, $setState as Mc, addClassNamesToElement as Vn, $create as $c, $getNodeByKey as Ic, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Vc, $isBlockElementNode as Pc, $createRangeSelection as jc, $normalizeSelection__EXPERIMENTAL as Lc, OUTDENT_CONTENT_COMMAND as Bc, INDENT_CONTENT_COMMAND as Io, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as ao, $isDecoratorNode as Uc, $isParagraphNode as Kc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Pn, $insertNodes as qc } from "lexical";
...
import { useReactTable as Ln, getFilteredRowModel as tl, getSortedRowModel as Bn, getPaginationRowModel as el, getCoreRowModel as Fn, flexRender as xr, getGroupedRowModel as rl, getExpandedRowModel as al } from "@tanstack/react-table";
import ol from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as nl, isInsertEmbedOpOfType as Mr, Editorial as il } from "@eten-tech-foundation/platform-editor";
...
function ua({
  ...
  const B = re(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ...
  }), [Mt]), Jt = D(() => Object.values(jt).flat(), [jt]), fe = D(() => {
    if (!V.trim()) return jt;
    const b = {
      [dt.OT]: [],
      [dt.NT]: [],
  ...
  const { otLong: pt, ntLong: gt, dcLong: $t, extraLong: zt } = {
    ...
    () => pl(V),
    [V]
  ), ne = D(() => !l || !R || !R.chapterNum || !xt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, xt]), je = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), ur = L(
    (b) => (G) => w ? hl(b, G, w) : !1,
...
function Lo({
  ...
  const [N, O] = _(!1), B = l ?? d, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Hn ? Qt : H, Ir = { tag: eo };
function xl({ initialConfig: t, children: e }) {
  const r = D(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = vl(null, o), w = zn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function kl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return yl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: d }) => {
      e && i.size === 0 && s.size === 0 || t && d.has(eo) || c.isEmpty() || r(n, o, d);
    });
  }, [o, t, e, r]), null;
}
const no = {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = Yn && "documentMode" in document ? document.documentMode : null;
!(!Yn || !("InputEvent" in window) || Dl) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function jl(t, e, r) {
  ...
  return gc(o) && Hr(283), o.insert(t.isInline() ? Sr().append(t) : t), Mo(Dn(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Xt();
  if (!ue(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = On(i, (l) => Nr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
Ft.prototype.brand = Bl, Ft.prototype.h = function() {
  ...
  if (this.g = Lr, this.f |= 1, this.i > 0 && !Wn(this)) return this.f &= -2, !0;
  const t = nt;
  try {
    Ko(this), nt = this;
    const e = this.x();
...
ae({ build: (t, e, r) => wr(e), config: Xe({ $onClear: Zn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [ti], register: (t, e, r) => t.registerCommand($n, (o) => {
  const n = Xt();
  if (In(n) || ue(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, An) });
function ei(t, e) {
  let r;
...
const ja = ae({ build: (t) => ei(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, La = 1, ai = 2, fa = 3, Ar = 4, Ze = 5, ma = 6, mr = 7;
function va(t) {
  return t.id === co;
}
function oi(t) {
...
const Zl = ae({ config: Xe({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [xc, Rn, yc, kc, Sn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function Ql(t) {
  throw t;
...
const td = /* @__PURE__ */ new Set(), Yo = ae({ build(t, e, r) {
...
ae({ dependencies: [ja, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return Ne(t.registerCommand(ed, (s) => {
    ...
    if (Ec(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        ...
        let h;
        l && In(w) ? h = w : (h = zc(), Sc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function od(t, e, r = ni) {
  return Ne(t.registerCommand(Vc, (o) => {
    ...
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Bc : Io : Fc;
    return t.dispatchCommand(i, void 0);
  }, ro), t.registerCommand(Io, () => {
...
ae({ build: (t, e, r) => wr(e), config: Xe({ $canIndent: ni, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ae({ build: (t, e, r) => wr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : si(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function md({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: E = !0, style: k, tabIndex: N, "data-testid": O, ...B }, z) {
  ...
  return ci(() => (A(t.isEditable()), t.registerEditableListener((K) => {
    A(K);
...
const Md = "verseText", Ju = Object.freeze([
...
function Qo({
  ...
  const h = L(
    ...
    [t.user]
  ), k = D(() => Ja(t.contents), [t.contents]), N = D(
    ...
    "div",
    {
      ...
      children: [
        ...
        B && /* @__PURE__ */ u(ye, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
...
function yi({
  ...
  const [y, J] = _(tn), [j, Y] = _(), [T, $] = _(), W = o, [Z, Ot] = _(!1), [Tt, Pt] = _(!1), [q, tt] = _(!1), [wt, at] = _(!1), [mt, oe] = _(!1), [ut, bt] = _(O), [Mt, jt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            v !== !1 && (!Tt || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  po(S) && (S.preventDefault(), S.stopPropagation(), (ee(y) || j !== void 0 && j !== T) && Kt());
                },
                onKeyDown: (S) => {
...
function Fd({
  ...
  const [s, c] = _("accept"), d = So(), l = So(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = D(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => Ur(t.acceptedText ?? ""),
...
function Hd(t) {
  ...
  } = t, c = D(() => e.filter((E) => !E.deleted), [e]), d = D(
...
function sp({
  ...
  const C = r.filter(
    ...
    [k, x]
  ), { listboxRef: J, activeId: j, handleKeyDown: Y } = qi({
    options: V,
    onOptionSelect: K
  }), T = L(
    ($) => {
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(yi, { ...W })
          },
          $.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(Cn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function cw({
  ...
  const f = (v) => {
    ...
    var E, k, N, O;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((O = s.current) == null || O.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function mp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [O, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Ot, Tt] = _(), [Pt, q] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Qt(() => {
    (jt.current.book !== n.book || jt.current.chapterNum !== n.chapterNum) && (jt.current = { book: n.book, chapterNum: n.chapterNum }, Mt.current());
  }, [n.book, n.chapterNum]);
  const Jt = () => {
    var Q;
      ...
      if (Q && Mr("note", Q)) {
        ...
        if (pt || C(!1), C(
          pt === "x" ? !!(gt != null && gt.every(($t) => {
            var Kt, It;
            if (!((Kt = $t.attributes) != null && Kt.char)) return !0;
...
function Tp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), O = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = de(r, "%webView_inventory_no_results%"), [I, A] = _(!1), [C, V] = _("all"), [K, y] = _(""), [J, j] = _([]), Y = D(() => {
    const q = t ?? [];
  ...
  }, [I, Y]), $ = D(() => T.length === 0 ? [] : Tw(T, C, K), [T, C, K]), W = D(() => {
    var wt, at;
    if (!I) return d;
...
const Sw = "16rem", Rw = "3rem", Ni = Rt.createContext(void 0);
function ia() {
  const t = Rt.useContext(Ni);
  if (!t)
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u($w, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Pw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const ze = "scrBook", Lw = "scrRef", Ke = "source", Bw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", Ci = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Fp({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), x = D(
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: O.map((C) => /* @__PURE__ */ a(ie, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
const Ti = (t, e, r) => go(t, e).every((o) => r.includes(o));
function Hw({
  availableBookInfo: t,
  selectedBookIds: e,
...
function Kp({
  ...
  const O = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), y = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Ot = St(s, "%webView_scope_selector_navigate%"), Tt = (M) => {
    if (!f) return;
  ...
  ], q = (M, X, qt = !1) => /* @__PURE__ */ u(ct, { children: [
    M,
    X && !qt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), tt = e ? Pt.filter((M) => e.includes(M.value)) : Pt, wt = f ?? da, at = w ?? wt, mt = p ?? wt, oe = () => {
  }, ut = F(null), bt = F(null), Mt = F(!1), jt = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), Ee = L((M) => {
    if (M) {
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, $t] = _(!1), [zt, Kt] = _(void 0), [It, Pe] = _(void 0), [S, At] = _(void 0), [xt, ne] = _(void 0), [je, ur] = _([]), pr = l === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  H(() => {
    ...
    const M = new ResizeObserver(([X]) => {
      Ai(X.contentRect.width < Fe);
    });
    return M.observe(Lt), () => M.disconnect();
  }, [Lt]);
  const fo = L(
    (M) => {
      Pe(M), At(at), ne(mt), ur(n), $t(!1), Kt(M);
    },
    [at, mt, n]
  ), mo = L(() => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: $t, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(sa, { container: Lt, children: [
              st.map(({ value: M, label: X, dropdownLabel: qt, scrRefSuffix: fr, id: Vi }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te(M),
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ua,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var X;
                              M.preventDefault(), (X = jt.current) == null || X.focus();
                            },
                            modal: !0,
        ...
        oo,
        {
          ...
          children: tt.map(({ value: M, label: X, scrRefSuffix: qt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: M, id: fr }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(ie, { value: `${w}`, children: d[To(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Qa, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Gt, { children: Si(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(He, {})
    ] }, d)) })
  ] });
}
const Ri = Rt.forwardRef(
...
const Di = Rt.forwardRef(({ className: t, ...e }, r) => {
  const o = re();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
const Oi = Rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: m(
...
function Jp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Di, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(Zw, { value: c.value, children: c.value }, c.key)) }),
...
function rh({
  ...
  return /* @__PURE__ */ u(Ie, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ns, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(is, { children: /* @__PURE__ */ a(tc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ye, { children: [
              /* @__PURE__ */ a(ke, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Co, {}) }) }),
...
function sh({
  ...
  const n = r || "en", i = D(
    ...
    [o, n]
  ), s = Math.min(Math.max(t, 1), e), c = D(() => Array.from({ length: e }, (d, l) => l + 1), [e]);
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: c.map((d) => {
    const l = d < s, w = d === s;
    return /* @__PURE__ */ u(Qa, { children: [
      d > 1 && /* @__PURE__ */ a("div", { className: "tw:h-px tw:flex-1 tw:bg-border" }),
      /* @__PURE__ */ a(
        "div",
        {
          className: m(
            "tw:flex tw:h-8 tw:w-8 tw:shrink-0 tw:items-center tw:justify-center tw:rounded-full tw:text-sm tw:font-medium",
            w && "tw:bg-primary tw:text-primary-foreground",
            l && "tw:bg-muted tw:text-muted-foreground",
            !w && !l && "tw:border tw:border-muted-foreground tw:text-muted-foreground"
          ),
          children: i(d)
        }
      )
