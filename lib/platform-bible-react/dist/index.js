...
function Pm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Me(""), [o, i] = Me(
    ...
    (S) => ul(S).filter((N) => {
      const $ = ue.bookIdToEnglishName(N).toLowerCase(), L = n.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    cl.forEach((S) => {
      const N = n.match(S);
      if (N) {
        const [$, L = void 0, V = void 0] = N.slice(1), D = fl($);
    ...
    /* @__PURE__ */ de(
      Di,
      {
        ...
        children: [
          ...
          Po.map(
            (S, N) => E(S).length > 0 && /* @__PURE__ */ de("div", { children: [
              ...
              Po.length - 1 !== N ? /* @__PURE__ */ T(Bi, {}) : void 0
            ] }, S)
          )
        ]
      }
...
function vl() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var h = c, C = u, P = l, B = s, j = t, S = d, N = r, $ = v, L = b, V = n, D = i, I = o, F = f, Q = !1;
    function Z(_) {
...
function Ml() {
  return Lo || (Lo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var C = s, P = i, B = e, j = c, S = n, N = p, $ = f, L = t, V = o, D = r, I = u, F = d, Q = !1, Z = !1;
    function O(R) {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (B = i(v.current)), B.length > 0) {
        var j, S;
        const N = !!((j = m.current) != null && j.shiftKey && ((S = m.current) == null ? void 0 : S.key) === "Tab"), $ = B[0], L = B[B.length - 1];
...
function dn(e, t) {
  ...
  if (p === Xt && N) {
    ...
    Object.keys(S).forEach(function(L) {
      var V = [Ve, Fe].indexOf(L) >= 0 ? 1 : -1, D = [Ce, Fe].indexOf(L) >= 0 ? "y" : "x";
      S[L] += $[D] * V;
    });
  }
  return S;
...
function fu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), M = E === m, y = c || (M || !v ? [Rn(m)] : pu(m)), w = [m].concat(y).reduce(function(z, H) {
      ...
      var N = w[S], $ = Ue(N), L = Bt(N) === At, V = [Ce, Fe].indexOf($) >= 0, D = V ? "width" : "height", I = dn(t, {
        placement: N,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
      ...
      h[D] > C[D] && (F = Rn(F));
      var Q = Rn(F), Z = [];
      if (i && Z.push(I[$] <= 0), l && Z.push(I[F] <= 0, I[Q] <= 0), Z.every(function(z) {
        return z;
      })) {
        j = N, B = !1;
        break;
...
function Tu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = dn(t, {
    ...
    mainAxis: 0,
    altAxis: 0
  }, j), N = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, $ = {
    x: 0,
    y: 0
  };
  if (C) {
    if (i) {
      var L, V = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, I = w === "y" ? "height" : "width", F = C[w], Q = F + m[V], Z = F - m[D], O = b ? -B[I] / 2 : 0, A = M === At ? P[I] : B[I], U = M === At ? -B[I] : -P[I], K = t.elements.arrow, z = b && K ? Ur(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : pa(), q = H[V], G = H[D], W = on(0, P[I], z[I]), X = y ? P[I] / 2 - O - W - q - S.mainAxis : A - W - q - S.mainAxis, Y = y ? -P[I] / 2 + O + W + G + S.mainAxis : U + W + G + S.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), _ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (L = N == null ? void 0 : N[w]) != null ? L : 0, R = F + X - J - _, re = F + Y - J, ve = on(b ? jn(Q, R) : Q, F, b ? ft(Z, re) : Z);
      C[w] = ve, $[w] = ve - F;
    }
    if (l) {
...
`));
  ...
  const $ = Vu(), L = (r = v.root) != null ? r : "div", V = gt({
    elementType: L,
    ...
    const M = Is(s, k({
      ...
      c && p && B.push((N) => {
        ...
        if (!$.components || !$.components[c] || !$.components[c].styleOverrides)
          return null;
        const L = $.components[c].styleOverrides, V = {};
        ...
        const L = Cn(k({}, N, {
          defaultTheme: n,
          themeId: t
        })), V = L == null || ($ = L.components) == null || ($ = $[c]) == null ? void 0 : $.variants;
        return Mn({
          variants: V
        }, k({}, N, {
          theme: L
...
`));
  ...
  const so = (ee) => {
    ...
    Ne.current && ee.type !== "touchstart" || (he && he.removeAttribute("title"), yt.clear(), ct.clear(), I || Pn && F ? yt.start(Pn ? F : I, () => {
      so(ee);
    }) : so(ee));
  }, lo = (ee) => {
    yt.clear(), ct.start(A, () => {
...
const Lf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Ff = (e) => {
  ...
  const G = (r = (o = V == null ? void 0 : V.root) != null ? o : E.Root) != null ? r : Vf, W = (i = (s = V == null ? void 0 : V.backdrop) != null ? s : E.Backdrop) != null ? i : d, X = (l = L == null ? void 0 : L.root) != null ? l : M.root, Y = (c = L == null ? void 0 : L.backdrop) != null ? c : M.backdrop, ne = gt({
    elementType: G,
    externalSlotProps: X,
...
const Qf = (e) => {
  ...
  const s = tt({
  ...
  } = s, S = ce(s.TransitionProps, Yf), N = ce(s, Jf), $ = (r = w == null ? void 0 : w.paper) != null ? r : M, L = x.useRef(), V = Le(L, $.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
    ...
    TransitionProps: S
  }), I = Qf(D), F = x.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = In(c), R = J && J.nodeType === 1 ? J : xe(L.current).body, re = R.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`)), m !== null && he < m) {
  ...
  }, [c, f, F, Q, m]), [O, A] = x.useState(E), U = x.useCallback(() => {
    const J = L.current;
    if (!J)
      return;
    const R = Z(J);
...
const rm = ["onEntering"], om = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], im = {
  ...
  const i = tt({
    ...
    TransitionProps: w,
    variant: E
  }), j = sm(B), S = s && !u && p, N = x.useRef(null), $ = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || V === -1) && (V = O));
  ...
  const D = (r = M.paper) != null ? r : cm, I = (o = y.paper) != null ? o : b, F = gt({
    elementType: M.root,
