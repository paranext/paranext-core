...
import c, { forwardRef as Ut, createContext as Un, useContext as Jn, useCallback as et, useState as A, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Kn } from "react";
...
import { formatScrRef as Ot, getChaptersForBook as Cr, NumberFormat as Sr, formatBytes as Rr, deepEqual as ye, substring as Tr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as D } from "platform-bible-utils";
...
const ke = V.Trigger, rn = V.Group, Pr = V.Portal, Xr = V.Sub, ns = V.RadioGroup;
...
const H = class T {
  ...
  parse(e) {
    ...
    if (a.length !== 2 || P.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !T.isVerseParseable(a[1]))
      throw new It("Invalid reference : " + e);
...
function as({
  ...
  const o = $(), [i, w] = A(""), [s, p] = A(t.book), [m, u] = A(t.chapterNum ?? 0), [f, g] = A(t.book), [h, v] = A(!1), [N, b] = A(h), k = Z(void 0), x = Z(void 0), _ = Z(void 0), M = et(
    (C) => {
      const z = a ? a() : Ee;
      return {
    ...
    (C, z, O, G) => {
      if (u(t.book !== C ? 1 : t.chapterNum), z || Vt(C) === -1) {
        e({
          book: C,
          chapterNum: O ?? 1,
          verseNum: G ?? 1
    ...
    ra.forEach((C) => {
      const z = C.exec(i);
      if (z) {
        const [O, G = void 0, F = void 0] = z.slice(1), Dt = sa(O);
        (P.isBookIdValid(O) || Dt) && y(
          Dt ?? O,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (C) => {
      h ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (_ != null && _.current ? _.current.focus() : x.current && x.current.focus(), C.preventDefault()) : v(!0);
    },
    [h]
  ), Mt = (C) => {
    const { key: z } = C;
  ...
  return ct(() => {
    s === f ? s === t.book ? u(t.chapterNum) : u(1) : u(0);
  }, [f, t.book, t.chapterNum, s]), Fe(() => {
    b(h);
  }, [h]), Fe(() => {
    const C = setTimeout(() => {
      if (N && x.current && _.current && !i) {
        const O = _.current.offsetTop - na;
  ...
  }, [N, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Wt, { modal: !1, open: h, onOpenChange: zt, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ar,
      {
        ...
        handleKeyDown: X,
        handleOnClick: () => {
          p(t.book), g(t.book), u(t.chapterNum > 0 ? t.chapterNum : 0), v(!0), w(Ot(t, "English")), k.current.focus();
        },
        onFocus: () => {
          ot.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      $t,
      {
        ...
        ref: x,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Le.map((C, z) => {
          const O = M(C);
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: ea[C] }),
            O.map((G) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Qr,
              {
                bookId: G,
                handleSelectBook: () => y(G, !1),
                isSelected: s === G,
...
const hn = jt.Root, gn = jt.Trigger, ze = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const i = $();
...
ze.displayName = jt.Content.displayName;
...
De.displayName = q.Input.displayName;
...
Ie.displayName = q.List.displayName;
const Ve = c.forwardRef((t, e) => /* @__PURE__ */ r(q.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
function me({
  ...
  const [b, k] = A(!1);
  return /* @__PURE__ */ d(hn, { open: b, onOpenChange: k, ...N, children: [
      ...
      I,
      {
        ...
        children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: l("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: i ? s(i) : m })
          ] }),
...
function ss({
  ...
  const u = se(m, "%webView_bookSelector_currentBook%"), f = se(m, "%webView_bookSelector_choose%"), g = se(m, "%webView_bookSelector_chooseBooks%"), [h, v] = A(
    "current book"
    /* CURRENT_BOOK */
  ), N = (b) => {
    v(b), t(b);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(L, { className: "tw-ms-1", children: u })
          ] }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((b) => P.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
const yt = j.Root, ba = j.Group, Nt = j.Value, ft = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
  return /* @__PURE__ */ d(
    j.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(j.Icon, { asChild: !0, children: /* @__PURE__ */ r(Jt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
ft.displayName = j.Trigger.displayName;
...
vn.displayName = j.ScrollUpButton.displayName;
...
xn.displayName = j.ScrollDownButton.displayName;
...
bt.displayName = j.Content.displayName;
...
W.displayName = j.Item.displayName;
...
const Qt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-p-1": e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
  ...
  "tfoot",
  {
    ...
    onKeyDown: (o) => {
      if (o.key === "Tab" && o.shiftKey) {
        const i = document.activeElement, w = i == null ? void 0 : i.closest("table");
        if (!w) return;
        const s = w.querySelector("tfoot");
        if (!(s != null && s.contains(i))) return;
        o.preventDefault();
...
const dt = c.forwardRef(
  ({ className: t, onKeyDown: e, onSelect: n, ...a }, o) => {
    ...
    const w = (u, f) => {
      var N;
      const g = u.closest("table"), h = f.indexOf(u);
      let v = !1;
      for (let b = h + 1; b < f.length; b++) {
        const k = f[b];
        if (!(g != null && g.contains(k))) {
          k.focus(), v = !0;
          break;
        }
      }
      v || (N = f[0]) == null || N.focus();
    }, s = (u, f, g) => {
      let h;
      return g === "down" && f < u.length - 1 ? h = u[f + 1] : g === "up" && f > 0 && (h = u[f - 1]), h ? (h.focus(), !0) : !1;
    }, p = (u, f, g, h, v) => {
      var k, x, _;
      const N = Ca(f), b = f.closest("table");
      if (u.shiftKey) {
        if (u.preventDefault(), N === "tfoot") {
          const M = b == null ? void 0 : b.querySelector('tbody tr[tabindex="0"]:last-of-type');
          M instanceof HTMLElement && M.focus();
          return;
        }
        if (N === "tbody") {
          const M = b == null ? void 0 : b.querySelector('thead tr[tabindex="0"]');
          M instanceof HTMLElement && M.focus();
          return;
        }
        return;
      ...
      if (N === "tbody") {
        if (u.preventDefault(), h === g.length - 1 || g.length === 0) {
          const M = (x = (k = f.parentElement) == null ? void 0 : k.parentElement) == null ? void 0 : x.querySelector('tfoot tr[tabindex="0"]');
          M ? M.focus() : w(f, v);
        }
        (_ = g[h + 1]) == null || _.focus();
      }
    };
    return /* @__PURE__ */ r(
      "tr",
      {
        ...
        onKeyDown: (u) => {
          ...
          ), h = g.indexOf(f), v = Ye(document.body), N = Ye(f), b = N.indexOf(
          ...
          u.key === "Tab" ? p(
            ...
            b,
            v
          ) : u.key === "ArrowDown" ? s(g, h, "down") && u.preventDefault() : u.key === "ArrowUp" ? s(g, h, "up") && u.preventDefault() : u.key === "Enter" && n && (u.preventDefault(), n(u)), e == null || e(u);
        },
        className: l(
...
function Ta({
  ...
  var b;
  const [s, p] = A([]), [m, u] = A([]), [f, g] = A({}), [h, v] = A({}), N = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(fa, { table: N }),
    /* @__PURE__ */ d(Qt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(te, { stickyHeader: i, children: N.getHeaderGroups().map((k) => /* @__PURE__ */ r(dt, { children: k.headers.map((x) => /* @__PURE__ */ r(Ft, { children: x.isPlaceholder ? void 0 : Pt(x.column.columnDef.header, x.getContext()) }, x.id)) }, k.id)) }),
      /* @__PURE__ */ r(ee, { children: (b = N.getRowModel().rows) != null && b.length ? N.getRowModel().rows.map((k) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => w(k, N),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((x) => /* @__PURE__ */ r(kt, { children: Pt(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        k.id
    ...
    n && a && /* @__PURE__ */ r(ya, { table: N })
  ] });
}
const Yt = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(sr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function za({ id: t, versionHistory: e }) {
  ...
  function i(s) {
    const p = new Date(s), m = new Date(o.getTime() - p.getTime()), u = m.getUTCFullYear() - 1970, f = m.getUTCMonth(), g = m.getUTCDate() - 1;
    let h = "";
...
function Da({
  ...
  const [f, g] = A(!1), h = et(
    (b) => {
      var x;
      const k = (x = t.find((_) => _.label === b)) == null ? void 0 : x.value;
      k && a(
        n.includes(k) ? n.filter((_) => _ !== k) : [...n, k]
      );
    },
    [t, n, a]
  ), v = () => w || o, N = Q(() => {
    if (!p) return t;
    const b = t.filter((x) => x.starred).sort((x, _) => x.label.localeCompare(_.label)), k = t.filter((x) => !x.starred).sort((x, _) => {
      const M = n.includes(x.value), tt = n.includes(_.value);
      return M && !tt ? -1 : !M && tt ? 1 : x.label.localeCompare(_.label);
    });
    return [...b, ...k];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ d(hn, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(gn, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
        ...
        children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ r("div", { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50", children: /* @__PURE__ */ r("span", { className: "tw-flex tw-h-full tw-w-full tw-items-center tw-justify-center", children: m }) }),
            /* @__PURE__ */ r(
              "div",
              {
                className: l({
    ...
    /* @__PURE__ */ r(ze, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Me, { children: [
      /* @__PURE__ */ r(De, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ d(Ie, { children: [
        /* @__PURE__ */ r(Ve, { children: i }),
        /* @__PURE__ */ r(bn, { children: N.map((b) => {
          const k = e ? e(b) : void 0;
          return /* @__PURE__ */ d(
            Be,
            {
              value: b.label,
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: b.starred && /* @__PURE__ */ r(pr, { className: "tw-h-4 tw-w-4" }) }),
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      ...
      return /* @__PURE__ */ d(yn, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        ...
        (h = t.find((v) => v.value === g)) == null ? void 0 : h.label
      ] }, g);
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), fs = (t) => ({
  ...
  let s = [...o];
  t.forEach((p) => {
    e === "unapproved" ? s.includes(p) || s.push(p) : s = s.filter((m) => m !== p);
  }), i(s);
}, vs = (t, e, n, a, o) => ({
  accessorKey: "status",
  ...
  return Aa(t).forEach((u) => {
    u.startsWith("\\id") && (w = Oa(u), s = 0, p = 0), u.startsWith("\\c") && (s = He(u), p = 0), u.startsWith("\\v") && (p = He(u), s === 0 && (s = e.chapterNum));
    let f = o.exec(u) ?? void 0;
    for (; f; ) {
      const g = [];
      f.forEach((b) => g.push(b));
      const h = f.index, v = i.find((b) => ye(b.items, g)), N = {
        reference: {
          book: w !== void 0 ? w : "",
          chapterNum: s !== void 0 ? s : -1,
          verseNum: p !== void 0 ? p : -1
        },
        text: Tr(u, Math.max(0, h - 25), Math.min(h + 25, u.length))
      };
      if (v)
        v.count += 1, v.occurrences.push(N);
      else {
        const b = {
          items: g,
          count: 1,
...
function ys({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), v = st(n, "%webView_inventory_unknown%"), N = st(n, "%webView_inventory_scope_currentBook%"), b = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), x = st(n, "%webView_inventory_filter_text%"), _ = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [M, tt] = A(!1), [ot, zt] = A("all"), [y, E] = A(""), [K, X] = A([]), Mt = Q(() => s ? a instanceof RegExp ? ja(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (M) return Mt;
    const R = [];
    return Mt.forEach((Y) => {
  ...
  }, [M, Mt]), C = Q(() => Xa(pt, ot, y), [pt, ot, y]), z = Q(() => {
    var wt, ut;
    if (!M) return u;
    ...
    return [...Y, ...u];
  }, [o == null ? void 0 : o.tableHeaders, u, M]);
  ct(() => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(yt, { onValueChange: (R) => G(R), defaultValue: p, children: [
        ...
        /* @__PURE__ */ d(bt, { children: [
          /* @__PURE__ */ r(W, { value: "book", children: N }),
          /* @__PURE__ */ r(W, { value: "chapter", children: b }),
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(L, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? _ })
      ] })
    ] }),
...
const Pe = Gt.Provider, Xe = Gt.Root, je = Gt.Trigger, re = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Gt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Rn = c.forwardRef(
  ({
    ...
    const [m, u] = c.useState(t), f = e ?? m, g = c.useCallback(
      (_) => {
        const M = typeof _ == "function" ? _(f) : _;
        n ? n(M) : u(M);
      },
      [n, f]
    ), h = c.useCallback(() => g((_) => !_), [g]), v = f ? "expanded" : "collapsed", k = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", x = c.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Sn.Provider, { value: x, children: /* @__PURE__ */ r(Pe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ka = vt(
  ...
  ({
    ...
    const p = t ? Rt : "button", { state: m } = ae(), u = /* @__PURE__ */ r(
      p,
      {
        ref: s,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(je, { asChild: !0, children: u }),
      /* @__PURE__ */ r(re, { side: "right", align: "center", hidden: m !== "collapsed", ...o })
    ] })) : u;
  }
);
    ...
    Tn,
    {
      ...
      children: /* @__PURE__ */ d(En, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(Mn, { children: /* @__PURE__ */ r(
            Dn,
            {
              onClick: () => m(g),
              isActive: f(g),
  ...
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? P.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === lt ? Ot(o.start) : void 0;
      },
...
function ks({
  ...
  const [p, m] = A([]), [u, f] = A([{ id: lt, desc: !1 }]), [g, h] = A({}), v = Q(
    () => t.flatMap((y) => y.data.map((E) => ({
      ...E,
      source: y.source
    }))),
    [t]
  ...
  ct(() => {
    if (s) {
      const y = b.getSelectedRowModel().rowsById, E = Object.keys(y);
      if (E.length === 1) {
        const K = v.find((X) => Ue(X) === E[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, v, s, b]);
  const k = o ?? io, x = i ?? Vn, _ = [
  ...
  }, ot = (y, E) => y.getIsGrouped() ? "" : l("banded-row", E % 2 === 0 ? "even" : "odd"), zt = (y, E, K) => {
    if (!((y == null ? void 0 : y.length) === 0 || E.depth < K.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(ba, { children: _.map((y) => /* @__PURE__ */ r(W, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Qt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(te, { children: b.getHeaderGroups().map((y) => /* @__PURE__ */ r(dt, { children: y.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ft, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Pt(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, y.id)) }),
      /* @__PURE__ */ r(ee, { children: b.getRowModel().rows.map((y, E) => {
        const K = $();
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            className: l(ot(y, E)),
            onClick: (X) => tt(y, X),
            children: y.getVisibleCells().map((X) => {
              if (!(X.getIsPlaceholder() || X.column.columnDef.enableGrouping && !X.getIsGrouped() && (X.column.columnDef.id !== ht || !n)))
                return /* @__PURE__ */ r(
                  kt,
                  {
                    className: l(
                    ...
                    children: X.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ r(Jt, {}),
                          !y.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(Nr, {})),
                          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          bt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((s) => /* @__PURE__ */ r(W, { value: `${s}`, children: i[D(s)] }, `${s}`))
          }
        )
      ]
    }
...
function _s({
  ...
  return /* @__PURE__ */ d(Wt, { variant: i, children: [
    ...
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, m) => /* @__PURE__ */ d(Kn, { children: [
      /* @__PURE__ */ r(rn, { children: /* @__PURE__ */ r(Pe, { children: An(e.groups, e.items, s, t) }) }),
      p < m.length - 1 && /* @__PURE__ */ r(Lt, {})
    ] }, s)) })
  ] });
}
...
Xn.displayName = U.Content.displayName;
function Es({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
Fn.displayName = B.Trigger.displayName;
...
ho.displayName = B.CheckboxItem.displayName;
...
go.displayName = B.RadioItem.displayName;
...
fo.displayName = B.Label.displayName;
...
Hn.displayName = B.Separator.displayName;
const Bt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([i], w) => {
    const s = e.filter((m) => m.group === i).sort((m, u) => m.order - u.order).map((m) => /* @__PURE__ */ d(Xe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in m ? /* @__PURE__ */ d(
        Yn,
        {
          onClick: () => {
            a(m);
          ...
          children: [
            m.iconPathBefore && /* @__PURE__ */ r(qt, { icon: m.iconPathBefore, menuLabel: m.label, leading: !0 }),
            m.label,
            m.iconPathAfter && /* @__PURE__ */ r(qt, { icon: m.iconPathAfter, menuLabel: m.label })
          ]
        },
        `menubar-item-${m.label}-${m.command}`
      ) : /* @__PURE__ */ d(mo, { children: [
        /* @__PURE__ */ r(Gn, { children: m.label }),
        /* @__PURE__ */ r($n, { children: qn(
          t,
          e,
          Bn(t, m.id),
          a
        ) })
      ] }, `menubar-sub-${m.label}-${m.id}`) }),
      m.tooltip && /* @__PURE__ */ r(re, { children: m.tooltip })
    ] }, `tooltip-${m.label}-${"command" in m ? m.command : m.id}`)), p = [...s];
...
function bo({
  ...
  const o = Z(void 0), i = Z(void 0), w = Z(void 0), s = Z(void 0), p = Z(void 0), m = (u) => {
    switch (u) {
      case "platform.app":
        return i;
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, f) => {
    var v, N, b, k;
    u.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (N = w.current) == null || N.focus(), Bt(w, [g, h]);
        break;
      case "alt+n":
    ...
    const u = new MutationObserver((h) => {
      h.forEach((v) => {
        if (v.attributeName === "data-state" && v.target instanceof HTMLElement) {
          const N = v.target.getAttribute("data-state");
          n(N === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, f]) => typeof u == "boolean" || typeof f == "boolean" ? 0 : u.order - f.order).map(([u, f]) => /* @__PURE__ */ d(uo, { children: [
      /* @__PURE__ */ r(Fn, { ref: m(u), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Ln,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Pe, { children: qn(t.groups, t.items, u, e) })
        }
      )
    ] }, u)) });
}
...
function Ds({
  ...
  const p = vo(
    ...
    o && o(h), a && a([h, ...n.filter((v) => v !== h)]), i && n.find((v) => v === h) && i([...n.filter((v) => v !== h)]), u(!1);
  }, g = (h, v) => {
    var b, k, x, _, M, tt;
    const N = v !== h ? ((k = (b = t[h]) == null ? void 0 : b.uiNames) == null ? void 0 : k[v]) ?? ((_ = (x = t[h]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return N ? `${(M = t[h]) == null ? void 0 : M.autonym} (${N})` : (tt = t[h]) == null ? void 0 : tt.autonym;
  };
...
const As = U.Root, Ao = c.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Ao.displayName = U.List.displayName;
...
Oo.displayName = U.Trigger.displayName;
const Po = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  U.Content,
  {
    ref: n,
...
Po.displayName = U.Content.displayName;
const Os = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
