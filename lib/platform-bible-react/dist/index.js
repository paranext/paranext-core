...
import b, { forwardRef as en, useRef as Q, useMemo as $, useState as M, useCallback as z, useLayoutEffect as Lt, createContext as xn, useContext as fr, useEffect as J, Component as ds, createElement as Lr, Suspense as ps, createRef as us, Fragment as ho } from "react";
...
import { toast as xu } from "sonner";
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ea ? Lt : J, cn = { tag: gr };
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : J;
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : J;
function jl(e) {
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : J;
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : J;
function vw({ onClear: e }) {
  const [t] = Ot();
  return bw(() => wa(t, e), [t, e]), null;
}
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Lt : J;
...
function Jw({
  ...
  const [x, C] = M(wo), [S, A] = M(!1), [O, _] = M(!1), [R, y] = M(!1), [E, P] = M(!1), [j, Y] = M(!1), [V, X] = M(void 0), [I, rt] = M(!1), [kt, It] = M(!1);
  J(() => {
    let k = !0;
    if (!r) {
      rt(!1), It(!1);
...
function mc({
  ...
  const [T, x] = M(!1), C = z(
    (E) => {
      var j;
      const P = (j = e.find((Y) => Y.label === E)) == null ? void 0 : j.value;
      P && n(
    ...
    if (!f) return e;
    const E = e.filter((j) => j.starred).sort((j, Y) => j.label.localeCompare(Y.label)), P = e.filter((j) => !j.starred).sort((j, Y) => {
      const V = t.includes(j.value), X = t.includes(Y.value);
      return V && !X ? -1 : !V && X ? 1 : j.label.localeCompare(Y.label);
    });
    return [...E, ...P];
  }, [e, t, f]), O = () => {
    n(e.map((E) => E.value));
...
function $p({
  ...
  const f = Tt(n, "%webView_inventory_all%"), u = Tt(n, "%webView_inventory_approved%"), g = Tt(n, "%webView_inventory_unapproved%"), N = Tt(n, "%webView_inventory_unknown%"), v = Tt(n, "%webView_inventory_scope_currentBook%"), T = Tt(n, "%webView_inventory_scope_chapter%"), x = Tt(n, "%webView_inventory_scope_verse%"), C = Tt(n, "%webView_inventory_filter_text%"), S = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), A = Tt(n, "%webView_inventory_no_results%"), [O, _] = M(!1), [R, y] = M("all"), [E, P] = M(""), [j, Y] = M([]), V = $(() => {
    const B = e ?? [];
  ...
  J(() => {
    I.length === 0 ? Y([]) : I.length === 1 && Y(I[0].items);
  }, [I]);
  const kt = (B, at) => {
    at.setRowSelection(() => {
      const dt = {};
