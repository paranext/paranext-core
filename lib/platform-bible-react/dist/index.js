...
import { r as Bt, Z as Ii, B as j, c as g, a as Vi, C as ze, P as Se, b as Ve, d as De, e as Le, f as Fe, g as he, h as _r, i as ta, T as ee, S as Qe, j as re, k as ae, l as oe, D as Ge, m as br, n as Ne, o as Ce, p as Ee, u as Li, q as Nr, s as He, t as Ae, v as za, w as sn, x as Fi, y as ji, z as cn, A as ln, E as Bi, F as Ui, G as Ki, H as qi, I as da, J as wa, K as ir, L as Gi, M as Hi, N as Yi, O as Wi, Q as Xi, R as Cr, U as Ga } from "./resizable-CUvCloPJ.js";
...
import { includes as Rr, Section as Q, getChaptersForBook as Ji, formatScrRef as ke, getSectionForBook as fr, formatRelativeDate as Zi, formatReplacementString as ye, sanitizeHtml as Qi, NumberFormat as ts, formatBytes as es, getCurrentLocale as rs, usfmMarkers as Fr, getFormatCallerFunction as as, deepEqual as os, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as ns, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
...
import pt, { useRef as K, useMemo as F, useState as N, useCallback as L, useEffect as H, useLayoutEffect as Wt, createContext as Ha, useContext as mn, Component as Fs, createElement as _o, Suspense as js, forwardRef as ra, Fragment as vn } from "react";
import { Dialog as ge, Label as Bs, RadioGroup as Ma, ToggleGroup as bn, Slot as sr, Avatar as Ya, Select as Pt, Checkbox as No, Tabs as de, Menubar as ve, ContextMenu as Dt, Progress as Co, Slider as Ar, Switch as Eo } from "radix-ui";
import { createEditor as xn, $getRoot as Ie, $createParagraphNode as Er, $getSelection as jt, HISTORY_MERGE_TAG as Wa, ParagraphNode as yn, TextNode as kn, $getPreviousSelection as Us, $isRangeSelection as fe, $caretFromPoint as Ks, $getSiblingCaret as _n, $getChildCaret as qs, $getAdjacentChildCaret as Gs, $isChildCaret as Hs, $normalizeCaret as Ys, $setSelectionFromCaretRange as Ws, $getCollapsedCaretRange as Xs, $getCaretInDirection as To, $splitAtPointCaretNext as Js, $isTextPointCaret as Zs, $findMatchingParent as Nn, $isElementNode as xr, mergeRegister as Te, getDOMTextNode as Qs, isHTMLElement as tc, CLEAR_EDITOR_COMMAND as Cn, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as ec, defineExtension as ne, safeCast as Ye, createState as rc, FORMAT_TEXT_COMMAND as En, $isNodeSelection as Tn, COMMAND_PRIORITY_LOW as zn, RootNode as ac, LineBreakNode as oc, TabNode as nc, $isEditorState as ic, createCommand as sc, CLICK_COMMAND as cc, isDOMNode as lc, $getNodeFromDOMNode as dc, $createNodeSelection as wc, $setSelection as uc, $getEditor as pc, DecoratorNode as Ra, $getState as hc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as gc, $setState as fc, addClassNamesToElement as Sn, $create as mc, $getNodeByKey as vc, removeClassNamesFromElement as bc, KEY_TAB_COMMAND as xc, $isBlockElementNode as yc, $createRangeSelection as kc, $normalizeSelection__EXPERIMENTAL as _c, OUTDENT_CONTENT_COMMAND as Nc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Cc, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Ec, $isParagraphNode as Tc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as Dn, $insertNodes as zc } from "lexical";
  ...
  return /* @__PURE__ */ u(ol, { children: [
    ...
    /* @__PURE__ */ u(
      ge.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ge.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(j, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Rc, {}),
...
function Do({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ge.Close, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function sl({
  ...
  return /* @__PURE__ */ u(Se, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(De, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(he, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      ze,
      {
        onSelect: () => f(h),
...
function ga({
  ...
  const z = Bt(), [y, _] = N(!1), [V, q] = N(""), [I, $] = N(""), [k, E] = N("books"), [P, S] = N(void 0), [O, X] = N(
    void 0
  ), [B, R] = N(void 0), [J, ht] = N(!1), it = K(null), Ut = K(!1), xt = K(void 0), Ot = K(void 0), U = K(void 0), nt = K(void 0), at = K({}), st = K({}), ot = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Xt = F(() => o ? o() : In, [o]), Et = F(() => ({
    [Q.OT]: Xt.filter((G) => wt.isBookOT(G)),
    [Q.NT]: Xt.filter((G) => wt.isBookNT(G)),
    [Q.DC]: Xt.filter((G) => wt.isBookDC(G)),
    [Q.Extra]: Xt.filter((G) => wt.extraBooks().includes(G))
  }), [Xt]), Nt = F(() => Object.values(Et).flat(), [Et]), It = F(() => {
    if (!I.trim()) return Et;
    const b = {
      [Q.OT]: [],
      [Q.NT]: [],
  ...
  const Vt = L(() => {
    ...
    E("books"), S(void 0), X(void 0), R(void 0), setTimeout(() => {
      Ot.current && Ot.current.focus();
    }, 0);
  }, []), Lt = L(() => {
    const b = O;
    X(void 0), R(void 0), b ? (S(b), E("chapters"), q("")) : qt();
  }, [O, qt]), M = L((b) => {
    _(b), b && (E("books"), S(void 0), X(void 0), R(void 0), $(""));
  }, []), { otLong: Y, ntLong: gt, dcLong: et, extraLong: vt } = {
    ...
    () => ll(I),
    [I]
  ), yt = F(() => !l || !D || !D.chapterNum || !lt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, lt]), Gt = L(
    (b) => w ? Oo(b, w) : !1,
    [w]
  ), $e = L(
    (b) => (G) => w ? dl(b, G, w) : !1,
    ...
    (b) => {
      ...
      if ((k === "chapters" || k === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const zt = (Zt = xt.current) == null ? void 0 : Zt.querySelector(
      ...
      if (k === "verses" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), Lt();
        return;
      }
      ...
      if (k === "verses" && Ct) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (Ht = ft > 1 ? ft - 1 : zt);
            break;
          case "ArrowRight":
            ft !== 0 && (Ht = ft < zt ? ft + 1 : 1);
            break;
          case "ArrowUp":
            Ht = ft === 0 ? zt : Math.max(1, ft - Yt);
            break;
          case "ArrowDown":
            Ht = ft === 0 ? 1 : Math.min(zt, ft + Yt);
            break;
          default:
            return;
        }
        Ht !== ft && (b.preventDefault(), b.stopPropagation(), q(
          `${Mt} ${ce[Mt] || ""} ${kt}:${Ht}`
        ), setTimeout(() => {
          const Ue = st.current[Ht];
      ...
      if ((k === "chapters" || k === "books" && D) && Ct) {
        ...
        if (!Mt) return;
        k === "chapters" && ((ur = xt.current) == null || ur.focus());
        const kt = (() => {
          if (!V) return 1;
          const Yt = V.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            kt !== 0 && (ft = kt > 1 ? kt - 1 : zt);
            break;
          case "ArrowRight":
            kt !== 0 && (ft = kt < zt ? kt + 1 : 1);
            break;
          case "ArrowUp":
            ft = kt === 0 ? zt : Math.max(1, kt - Ht);
            break;
          case "ArrowDown":
            ft = kt === 0 ? 1 : Math.min(zt, kt + Ht);
            break;
          default:
            return;
        }
        ft !== kt && (b.preventDefault(), b.stopPropagation(), q(
          `${Mt} ${ce[Mt] || ""} ${ft}`
        ), setTimeout(() => {
          const Yt = at.current[ft];
    ...
    const { isLetter: G, isDigit: Z } = $o(b.key);
    (G || Z) && (b.preventDefault(), $((Zt) => Zt + b.key), Ot.current.focus(), ht(!1));
  }, []);
  return Wt(() => {
    const b = setTimeout(() => {
      if (y && k === "books" && U.current && nt.current) {
        const G = U.current, Z = nt.current, Ct = Z.offsetTop, Zt = G.clientHeight, We = Z.clientHeight, ur = Ct - Zt / 2 + We / 2;
        G.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), q(Ln(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Se, { open: y, onOpenChange: M, modal: v, children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(
      j,
      {
        ref: it,
        ...
        onClick: (b) => {
          Ut.current && (Ut.current = !1, b.preventDefault());
        },
    ...
    /* @__PURE__ */ a(
      De,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          y && it.current && G instanceof Node && it.current.contains(G) && (Ut.current = !0, M(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Le,
          {
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Jt.map(({ onClick: b, disabled: G, title: Z, icon: Ct }) => /* @__PURE__ */ a(
                  j,
                  {
                    variant: "ghost",
                    size: "sm",
              ...
              !J && /* @__PURE__ */ u(Fe, { ref: U, children: [
                k === "books" && /* @__PURE__ */ u(tt, { children: [
                  !D && Object.entries(It).map(([b, G]) => {
                    if (G.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(he, { heading: mt(b), children: G.map((Z) => /* @__PURE__ */ a(
                          Vn,
                          {
                            bookId: Z,
                            onSelect: (Ct) => Kt(Ct),
                  ...
                  D && /* @__PURE__ */ a(he, { children: /* @__PURE__ */ a(
                    ze,
                    {
                  ...
                  D && yt && D.chapterNum && l && /* @__PURE__ */ u(tt, { children: [
                  ...
                  D && !yt && pe(D.book) > 1 && /* @__PURE__ */ u(tt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function Ao({
  ...
  const [y, _] = N(!1), V = l ?? d, q = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], I = ($, k) => {
  ...
  return /* @__PURE__ */ u(Se, { open: y, onOpenChange: _, ...z, children: [
    ...
    /* @__PURE__ */ a(
      De,
      {
        ...
        children: /* @__PURE__ */ u(Le, { children: [
          ...
          /* @__PURE__ */ a(Fe, { children: q(e) ? e.map(($) => /* @__PURE__ */ a(he, { heading: $.groupHeading, children: $.options.map((k) => I(k, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map(($) => I($)) }) })
        ] })
      }
    )
  ] });
...
const Un = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Un ? Wt : H, Ir = { tag: Wa };
...
const vl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : H;
...
const Nl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : H;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = be(), r = F(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = K(o);
    return Nl(() => {
  ...
  function l(w) {
    w.read(() => {
      ...
      if ((q || I) && _ !== null && V !== null) {
        const $ = function(k, E, P, S, O, X, B) {
          const R = (k._window ? k._window.document : document).createRange();
          return R.setStart(...Po(E, P, S)), R.setEnd(...Po(O, X, B)), R;
        }(t, f, m, _, h, T, V);
        d(), d = Dl(t, $, e);
      }
...
let Yr, _e = 0, Wr = 0, Fl = 0, Ba = 0, Br = 0;
function Vo(t) {
  if (rt === void 0) return;
  let e = t.n;
...
At.prototype.brand = Vl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      _e !== 0 && Wr === 0 && e.l !== Ba && (e.l = Ba, Yr = { S: e, v: e.v, i: e.i, o: Yr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Hn(this), Lo(this), _e++;
  const t = rt;
...
ne({ build: (t, e, r) => cr(e), config: Ye({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Yn() {
  const t = Ie(), e = jt(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), fe(e) && (e.format = 0);
}
function Wn(t, e = Yn) {
  return t.registerCommand(Cn, (r) => (t.update(e), !0), Xa);
}
ne({ build: (t, e, r) => cr(e), config: Ye({ $onClear: Yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return me(() => Wn(t, o.value));
} });
function Ul(t) {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [Xn], register: (t, e, r) => t.registerCommand(En, (o) => {
  const n = jt();
  if (Tn(n) || fe(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, zn) });
function Jn(t, e) {
  let r;
...
const Ua = ne({ build: (t) => Jn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Wl = ne({ config: Ye({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Yl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const Jl = /* @__PURE__ */ new Set(), Uo = ne({ build(t, e, r) {
...
ne({ dependencies: [Ua, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [er], register(t, e, r) {
  ...
  return Te(t.registerCommand(Zl, (s) => {
    const c = jt();
    if (!fe(c)) return !1;
...
ne({ build: (t, e) => cr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ye({ $getParentEditor: function() {
  const t = pc();
...
ne({ build: (t, e, r) => cr(e), config: Ye({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return me(() => {
...
function ed(t, e, r = ei) {
  return Te(t.registerCommand(xc, (o) => {
    const n = jt();
    if (!fe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
ne({ build: (t, e, r) => cr(e), config: Ye({ $canIndent: ei, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ne({ build: (t, e, r) => cr(e), config: Ye({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => me(() => r.getOutput().disabled.value ? void 0 : ai(t)) });
function id(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const no = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : H;
...
const ud = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : H;
function pd({ onClear: t }) {
  const [e] = be();
  return ud(() => Wn(e, t), [e, t]), null;
}
const oi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : H;
...
function kd({
  ...
  const [e] = be(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = yd(), d = () => {
  };
...
function Hu({
  ...
  const [i, s] = N(Od), [c, d] = N(n), [l, w] = N(!1), p = K(void 0), f = K(null);
  H(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : co(v) && (v.preventDefault(), v.stopPropagation(), Qt(i) && h());
        },
        onKeyDown: (v) => {
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), h()) : co(_) && (_.preventDefault(), _.stopPropagation(), Qt(w) && m());
              },
              onKeyDown: (_) => {
        ...
        y && /* @__PURE__ */ u(Ne, { children: [
          /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
          /* @__PURE__ */ a(Ee, { align: "end", children: y })
        ] })
      ]
    }
  );
...
function Pd({
  ...
  const [$, k] = N(Wo), [E, P] = N(), [S, O] = N(), X = o, [B, R] = N(!1), [J, ht] = N(!1), [it, Ut] = N(!1), [xt, Ot] = N(!1), [U, nt] = N(!1), [at, st] = N(_), [ot, Xt] = N(!1), Et = K(void 0), [Nt, It] = N(/* @__PURE__ */ new Map());
  H(() => {
    let C = !0;
    return (async () => {
      const lt = z ? await z(d) : !1;
      C && nt(lt);
    })(), () => {
      C = !1;
    };
    ...
    let C = !0;
    if (!o) {
      Ot(!1), It(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const lt = T ? await T(d) : !1;
      C && Ot(lt);
    })(), () => {
      C = !1;
    };
  ...
  H(() => {
    ...
    D.current === "idle" && (D.current = "pending"), xt ? D.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (P(I), D.current = "auto-populated") : D.current === "auto-populated" && (P(void 0), D.current = "pending");
  }, [o, I, xt, i]);
  const Tt = F(() => e.filter((C) => !C.deleted), [e]);
  H(() => {
    let C = !0;
    if (!o || !y) {
      It(/* @__PURE__ */ new Map());
  ...
  const Vt = F(() => Tt[0], [Tt]), ie = K(null), Kt = K(void 0), $t = L(() => {
    var C;
    (C = Kt.current) == null || C.call(Kt), k(Wo);
  }, []), Oe = L(() => {
    const C = !at;
    st(C), Xt(!C), m == null || m(d, C);
  }, [at, m, d]);
  H(() => {
    R(!1);
  }, [o]), H(() => {
    if (o && !at && !ot) {
      ...
      return Et.current = C, () => clearTimeout(C);
    }
  ...
  }, [i, r]), Lt = F(() => Tt.slice(1), [Tt]), M = F(() => Lt.length ?? 0, [Lt.length]), Y = F(() => M > 0, [M]), gt = F(() => B || M <= 2 ? Lt : Lt.slice(-2), [Lt, M, B]), et = F(() => B || M <= 2 ? 0 : M - 2, [M, B]), vt = F(
    () => M === 1 ? Jt.singleReply : ye(Jt.multipleReplies, { count: M }),
    [M, Jt]
  ), mt = F(
    () => et === 1 ? Jt.singleReply : ye(Jt.multipleReplies, { count: et }),
    [et, Jt]
  );
  H(() => {
    !o && J && Y && ht(!1);
  ...
  const bt = L(
    async (C) => {
      ...
      ct && await p({ threadId: d, contents: ct }) && $t();
    },
    [
      $t,
      $,
    ...
    async (C) => {
      const ct = Qt($) ? Jr($) : void 0, lt = C.status ? C.assignedUser : E ?? C.assignedUser, yt = await p({
        ...C,
        contents: ct,
        assignedUser: lt
      });
      return yt && (lt !== void 0 && O(lt), ct && $t()), yt;
    },
    [$t, $, p, E]
  );
  if (Tt.length !== 0)
        ...
        children: /* @__PURE__ */ u(Md, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              qt && /* @__PURE__ */ a(br, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: qt }),
              /* @__PURE__ */ a(
                j,
                {
                  variant: "ghost",
            ...
            /* @__PURE__ */ a(
              Yo,
              {
                ...
                handleDeleteComment: h,
                onEditingChange: ht,
                canEditOrDelete: (!J && Nt.get(Vt.id)) ?? !1,
                canUserResolveThread: U
              }
            )
          ] }),
          /* @__PURE__ */ u(tt, { children: [
            Y && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              et > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (C) => {
                    (C.key === "Enter" || C.key === " ") && (C.preventDefault(), C.stopPropagation(), R(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Qe, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              gt.map((C) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Yo,
                {
                  comment: C,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: h,
                  onEditingChange: ht,
                  canEditOrDelete: (!J && Nt.get(C.id)) ?? !1
                }
              ) }, C.id)),
              v !== !1 && (!J || Qt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (C) => {
                    co(C) && (C.preventDefault(), C.stopPropagation(), (Qt($) || E !== void 0 && E !== S) && bt());
                  },
                  onKeyDown: (C) => {
                    io(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      Xr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Qt($) || E !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ye(
                      ...
                      /* @__PURE__ */ u(Se, { open: it, onOpenChange: Ut, children: [
                        /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(
                          j,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !xt || !x || x.length === 0 || !x.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          De,
                          {
                            ...
                            align: "end",
                            onKeyDown: (C) => {
                              C.key === "Escape" && (C.stopPropagation(), Ut(!1));
                            },
                            children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Fe, { children: x == null ? void 0 : x.map((C) => /* @__PURE__ */ a(
                              ze,
                              {
                                onSelect: () => {
                                  P(C !== i ? C : void 0), D.current = "user-selected", O(void 0), Ut(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Kr(C, r) })
                              },
                              C || "unassigned"
                            )) }) })
                          }
...
function ep({
  ...
  const [T, z] = N(/* @__PURE__ */ new Set()), [y, _] = N(), [V, q] = N(), I = L(
    async (R) => {
      const J = await i(R);
      return J !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && q(R.assignedUser), J;
    },
    [i]
  );
  H(() => {
    m && (z((R) => new Set(R).add(m)), _(m));
  }, [m]);
  const $ = r.filter(
    (R) => R.comments.some((J) => !J.deleted)
  ), k = $.map((R) => ({ id: R.id })), E = L(
    (R) => {
      z((J) => new Set(J).add(R.id)), _(R.id), x == null || x(R.id);
    },
    [x]
  ), P = L(
    (R) => {
      ...
      }), _(R), x == null || x(J ? void 0 : R);
    },
    [T, x]
  ), { listboxRef: S, activeId: O, handleKeyDown: X } = Li({
    options: k,
    onOptionSelect: E
  }), B = L(
    (R) => {
      R.key === "Escape" ? (y && T.has(y) && (z((J) => {
        const ht = new Set(J);
        return ht.delete(y), ht;
      }), _(void 0), x == null || x(void 0)), R.preventDefault(), R.stopPropagation()) : X(R);
    },
    [y, T, X, x]
  );
  return /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ u(
        rr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(nr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(se, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Gd({
  ...
  var q;
  const [w, p] = N([]), [f, h] = N([]), [m, x] = N({}), [v, T] = N({}), z = F(() => e ?? [], [e]), y = Mn({
    data: z,
    columns: t,
    getCoreRowModel: An(),
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((k, E) => `skeleton-row-${E}`).map((k) => /* @__PURE__ */ a(le, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(te, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, k)) : ((q = y.getRowModel().rows) == null ? void 0 : q.length) > 0 ? V = y.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    le,
    {
      onClick: () => s(I, y),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map(($) => /* @__PURE__ */ a(te, { children: mr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    I.id
  )) : V = /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a(te, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Id, { table: y }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: y.getHeaderGroups().map((I) => /* @__PURE__ */ a(le, { children: I.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : mr($.column.columnDef.header, $.getContext()) }, $.id)) }, I.id)) }),
...
function hi({
  ...
  const [T, z] = N(!1), y = L(
    ...
    const E = t.filter((S) => S.starred).sort((S, O) => S.label.localeCompare(O.label)), P = t.filter((S) => !S.starred).sort((S, O) => {
      const X = e.includes(S.value), B = e.includes(O.value);
      return X && !B ? -1 : !X && B ? 1 : S.label.localeCompare(O.label);
    });
    return [...E, ...P];
  }, [t, e, f]), q = () => {
    r(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Se, { open: $, onOpenChange: w ?? z, children: [
    /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ u(
      j,
      {
        variant: x,
    ...
    /* @__PURE__ */ a(De, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Le, { children: [
      ...
      /* @__PURE__ */ u(Fe, { children: [
        ...
        /* @__PURE__ */ a(he, { children: V.map((E) => /* @__PURE__ */ u(
          ze,
          {
            value: E.label,
            onSelect: y,
...
function ew({
  ...
  const i = K(null), s = K(null), c = K(!1), [d, l] = N(t), [w, p] = N(r), [f, h] = N(!1);
  H(() => {
    l(t);
  }, [t]), H(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Ne, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: tw(t, n, r) }) }) }),
...
function ow({
  ...
  return /* @__PURE__ */ u(Ne, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ce, { asChild: !0, children: /* @__PURE__ */ a(j, { variant: "outline", className: "tw:h-6", children: rw(t, r) }) }) }),
      /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a("p", { children: aw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ee, { style: { zIndex: cn }, children: [
...
function pp({
  ...
  Wt(() => {
    if (!m.current) return;
    const { width: M } = m.current.getBoundingClientRect();
    M > 0 && (m.current.style.width = `${M}px`);
  }, []);
  const [x, v] = N("generated"), [T, z] = N("generated"), [y, _] = N("*"), [V, q] = N("*"), [I, $] = N("f"), [k, E] = N(!1), [P, S] = N(!0), [O, X] = N(!1), B = K(!1), R = K(""), [J, ht] = N(!1), [it, Ut] = N(), [xt, Ot] = N(), [U, nt] = N(), [at, st] = N(), ot = K(null), Xt = F(
    () => ({
      ...c,
      markerMenuTrigger: d,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Y && Pr("note", Y)) {
      const vt = (gt = Y.insert.note) == null ? void 0 : gt.caller;
      let mt = "custom";
      vt === Pa ? mt = "generated" : vt === Ia ? mt = "hidden" : vt && (_(vt), q(vt)), v(mt), z(mt), $(((et = Y.insert.note) == null ? void 0 : et.style) ?? "f"), M = setTimeout(() => {
        var bt, ut, C;
        (bt = p.current) == null || bt.applyUpdate([Y]), s && ((ut = p.current) == null || ut.selectNote(0), (C = p.current) == null || C.focus());
      }, 0);
    }
    return () => {
      M && clearTimeout(M);
  ...
  const Nt = L(
    (M, Y, gt = !1) => {
      var vt, mt, bt;
      const et = (mt = (vt = p.current) == null ? void 0 : vt.getNoteOps(0)) == null ? void 0 : mt.at(0);
      if (et && Pr("note", et)) {
        if (et.insert.note) {
          let ut;
          M === "custom" ? ut = Y : M === "generated" ? ut = Pa : ut = Ia, et.insert.note.caller = ut;
        }
        r == null || r([et]), gt && w && i && ((bt = w.current) == null || bt.replaceEmbedUpdate(i, [et]));
      }
    },
    [i, r, w]
  ), It = L(() => {
  ...
  const Vt = () => {
    var Y;
    const M = (Y = f.current) == null ? void 0 : Y.getElementsByClassName("editor-input")[0];
    ...
    var gt, et, vt, mt, bt;
    $(M);
    const Y = (et = (gt = p.current) == null ? void 0 : gt.getNoteOps(0)) == null ? void 0 : et.at(0);
    if (Y && Pr("note", Y)) {
      Y.insert.note && (Y.insert.note.style = M);
      const ut = (mt = (vt = Y.insert.note) == null ? void 0 : vt.contents) == null ? void 0 : mt.ops;
      I !== "x" && M === "x" ? ut == null || ut.forEach((C) => lw(C)) : I === "x" && M !== "x" && (ut == null || ut.forEach((C) => dw(C))), (bt = p.current) == null || bt.applyUpdate([Y, { delete: 1 }]);
    }
  }, Oe = (M) => {
    st(M.contextMarker), X(M.canRedo);
  }, Jt = L(
    (M) => {
      var gt, et, vt, mt, bt;
      const Y = (et = (gt = p.current) == null ? void 0 : gt.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (Y && Pr("note", Y)) {
        ...
        const ut = (vt = Y.insert.note) == null ? void 0 : vt.style, C = (bt = (mt = Y.insert.note) == null ? void 0 : mt.contents) == null ? void 0 : bt.ops;
        if (ut || E(!1), E(
          ut === "x" ? !!(C != null && C.every((ct) => {
            var yt, Gt;
            if (!((yt = ct.attributes) != null && yt.char)) return !0;
            const lt = ((Gt = ct.attributes) == null ? void 0 : Gt.char).style;
          ...
          B.current = !0, R.current = JSON.stringify(Y), S(!0);
          return;
        }
        S(JSON.stringify(Y) === R.current), Nt(x, y);
      } else
        E(!1), S(!0);
    },
    [x, y, Nt]
    ...
    if (h.current && Et.length && M && M.rangeCount > 0) {
      const Y = M.getRangeAt(0).getBoundingClientRect(), gt = h.current.getBoundingClientRect();
      Ut(Y.left - gt.left), Ot(Y.top - gt.top), nt(Y.height), ht(!0);
    }
  }, [Et, h]);
  H(() => {
    const M = () => {
    ...
    var M;
    J && ((M = ot.current) == null || M.focus());
  }, [J]), H(() => {
    var gt;
    const M = ((gt = f.current) == null ? void 0 : gt.querySelector(".editor-input")) ?? void 0, Y = (et) => {
      !J && M && document.activeElement === M && et.key === d ? (et.preventDefault(), qt()) : J && et.key === "Escape" && (et.preventDefault(), ht(!1));
    };
    return document.addEventListener("keydown", Y), () => {
      document.removeEventListener("keydown", Y);
    };
  }, [J, qt, d]);
  const Lt = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(tt, { children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(so, { children: [
          /* @__PURE__ */ a(
            Zd,
            {
              onUndoClick: () => {
                var M;
                return (M = p.current) == null ? void 0 : M.undo();
              },
              onRedoClick: () => {
                var M;
                return (M = p.current) == null ? void 0 : M.redo();
              },
              canUndo: !P,
              canRedo: O,
              localizedStrings: l
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
              ...
              /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a("p", { children: Lt }) })
            ] }) }) })
          ]
        }
      )
...
function gp({
  ...
  const w = d ?? as(r, void 0), p = (z, y) => {
    l == null || l(z, y, n);
  }, f = i ? r.findIndex((z) => z === i) : -1, [h, m] = N(f), x = (z, y, _) => {
    if (r.length)
      switch (z.key) {
        case "Enter":
        case " ":
...
function fw({
  ...
  return /* @__PURE__ */ u(na, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(lo, { stickyHeader: !0, children: /* @__PURE__ */ u(le, { children: [
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ a(te, { children: ke(c.reference, "English") }),
          /* @__PURE__ */ a(te, { className: o, children: gw(c.text) })
        ]
      },
...
function _p({
  ...
  const h = we(r, "%webView_inventory_all%"), m = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), T = we(r, "%webView_inventory_scope_currentBook%"), z = we(r, "%webView_inventory_scope_chapter%"), y = we(r, "%webView_inventory_scope_verse%"), _ = we(r, "%webView_inventory_filter_text%"), V = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), q = we(r, "%webView_inventory_no_results%"), [I, $] = N(!1), [k, E] = N("all"), [P, S] = N(""), [O, X] = N([]), B = F(() => {
    const U = t ?? [];
    ...
    const U = [];
    return B.forEach((nt) => {
      const at = nt.items[0], st = U.find(
        (ot) => ot.items[0] === at
      );
      st ? (st.count += nt.count, st.occurrences = st.occurrences.concat(nt.occurrences)) : U.push({
        items: [at],
        count: nt.count,
  ...
  }, [I, B]), J = F(() => R.length === 0 ? [] : xw(R, k, P), [R, k, P]), ht = F(() => {
    var at, st;
    if (!I) return d;
    ...
    for (let ot = 0; ot < U; ot++)
      nt.push(
        vw(
          ((st = o == null ? void 0 : o.tableHeaders) == null ? void 0 : st[ot]) || "Additional Item",
          ot + 1
        )
      );
    return [...nt, ...d];
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(rr, { onValueChange: (U) => Ut(U), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(nr, { children: [
          ...
          /* @__PURE__ */ a(se, { value: "chapter", children: z }),
          /* @__PURE__ */ a(se, { value: "verse", children: y })
        ] })
      ] }),
      /* @__PURE__ */ a(
        zr,
      ...
      o && /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
        ...
        /* @__PURE__ */ a(oe, { children: (o == null ? void 0 : o.checkboxText) ?? V })
      ] }) })
    ] }),
...
function Ca({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(tt, { children: [
      /* @__PURE__ */ a(le, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(te, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(_t, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        le,
        {
...
function Cp({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = F(
    ...
    [t]
  ), z = p.length === 0 && f.length === 0 && h.length === 0, y = xe(n, "%resourcePicker_title%"), _ = xe(n, "%resourcePicker_search_placeholder%"), V = xe(n, "%resourcePicker_language_filter_any%"), q = xe(
    n,
    "%resourcePicker_section_already_selected%"
  ), I = xe(n, "%resourcePicker_section_installed%"), $ = xe(
    n,
    "%resourcePicker_section_available_to_download%"
  ), k = xe(n, "%resourcePicker_no_results%"), E = xe(n, "%resourcePicker_showing_count%"), P = F(() => {
    if (d.length === T.length || d.length === 0)
      return V;
    if (d.length === 1) {
      const O = T.find((X) => X.value === d[0]);
      if (O) return O.label;
    }
    return ye(
      xe(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    S && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ye(E, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !z && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        ...
        v && /* @__PURE__ */ a(le, { className: "tw:border-0", children: /* @__PURE__ */ a(te, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: x, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
...
function Ew({
  ...
  const [d, l] = pt.useState(t), w = e ?? d, p = pt.useCallback(
    ...
    [r, w]
  ), f = pt.useCallback(() => p((y) => !y), [p]), h = w ? "expanded" : "collapsed", v = Bt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = pt.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? wt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Me ? ke(n.start) : void 0;
      },
...
function Fp({
  ...
  const [l, w] = N([]), [p, f] = N([{ id: Me, desc: !1 }]), [h, m] = N({}), x = F(
    ...
    !e && /* @__PURE__ */ u(
      rr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(nr, { position: "item-aligned", children: /* @__PURE__ */ a(Vd, { children: _.map((k) => /* @__PURE__ */ a(se, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: T.getHeaderGroups().map((k) => /* @__PURE__ */ a(le, { children: k.headers.filter((E) => E.column.columnDef.header).map((E) => (
...
function Bw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
  ...
  }, [x, v] = N(!1), [T, z] = N(""), y = K(void 0), _ = K(!1), V = F(
    () => xi(t),
    [t]
  ), q = F(() => {
    if (!T.trim()) {
    ...
    (S, O = !1) => {
      ...
      const X = V.findIndex((it) => it === y.current), B = V.findIndex((it) => it === S);
      if (X === -1 || B === -1) return;
      const [R, J] = [
        Math.min(X, B),
        Math.max(X, B)
      ], ht = V.slice(R, J + 1).map((it) => it);
      r(
        e.includes(S) ? e.filter((it) => !ht.includes(it)) : [.../* @__PURE__ */ new Set([...e, ...ht])]
      );
    },
    [e, r, V]
  ), $ = (S) => {
...
function Bp({
  ...
  const _ = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), E = St(s, "%webView_scope_selector_current_book%"), P = St(s, "%webView_scope_selector_choose_books%"), S = St(s, "%webView_scope_selector_scope%"), O = St(s, "%webView_scope_selector_select_books%"), X = St(s, "%webView_scope_selector_range%"), B = St(s, "%webView_scope_selector_select_range%"), R = St(s, "%webView_scope_selector_range_start%"), J = St(s, "%webView_scope_selector_range_end%"), ht = St(s, "%webView_scope_selector_ok%"), it = St(s, "%webView_scope_selector_cancel%"), Ut = St(s, "%webView_scope_selector_navigate%"), xt = (A) => {
    if (!m) return;
  ...
  ], U = (A, W, Ft = !1) => /* @__PURE__ */ u(tt, { children: [
    A,
    W && !Ft && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), nt = e ? Ot.filter((A) => e.includes(A.value)) : Ot, at = m ?? pa, st = w ?? at, ot = p ?? at, Xt = () => {
  }, Et = K(null), Nt = K(null), It = K(!1), D = K(null), Tt = K(!1), [Vt, ie] = N(void 0), Kt = K(!1), $t = K(!1), Oe = K(null), Jt = L((A) => {
    if (A) {
      ie("start"), Kt.current = !1;
      return;
    }
    ie((W) => W === "start" ? void 0 : W), Kt.current && (Kt.current = !1, requestAnimationFrame(() => {
      var Ft;
      const W = (Ft = Et.current) == null ? void 0 : Ft.querySelector("button");
      W == null || W.click();
    }));
  }, []), qt = L((A) => {
    if (A) {
    ...
    (A) => {
      f == null || f(A), h == null || h(A), Kt.current = !0;
    },
    [f, h]
  ), M = L(
    (A) => {
      h == null || h(A), $t.current = !0;
    },
    [h]
  ), Y = L(
    (A) => {
    ...
    [r, n, m, i]
  ), gt = nt.find((A) => A.value === t), et = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? ns(st, ot, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : gt ? U(gt.label, gt.scrRefSuffix) : t, vt = nt.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), mt = nt.find((A) => A.value === "selectedBooks"), bt = nt.find((A) => A.value === "range"), [ut, C] = N(!1), [ct, lt] = N(void 0), [yt, Gt] = N(void 0), [$e, lr] = N(void 0), [Be, dr] = N(void 0), [wr, Sr] = N([]), Dr = l === "dropdown" && ct === "selectedBooks", b = /* @__PURE__ */ a(
    Kw,
    {
      availableBookInfo: o,
  ...
  ), G = Vt === "end", Z = Vt === "start", Ct = "tw:text-muted-foreground", Zt = l === "dropdown" && ct === "range", We = Zt ? lr : Lt, Mt = Zt ? dr : h ? M : Xt, kt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: g(G && Ct), children: R }),
      /* @__PURE__ */ a(
        ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Et, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: g(Z && Ct), children: J }),
      /* @__PURE__ */ a(
        ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: T,
          disableReferencesUpTo: Zt ? $e ?? st : st,
          onOpenChange: qt,
          onCloseAutoFocus: (A) => {
            var W;
            $t.current && ($t.current = !1, A.preventDefault(), (W = Oe.current) == null || W.focus());
          },
          className: g(Z && Ct),
          modal: !0,
          align: "start"
  ...
  const [Yt, Ue] = N(null), [Or, Si] = N(null), [$r, Di] = N(null), Oi = 200, [$i, Mi] = N(!1);
  H(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([W]) => {
      Mi(W.contentRect.width < Oi);
    });
    return A.observe($r), () => A.disconnect();
  }, [$r]);
  const po = L(
    (A) => {
      Gt(A), lr(st), dr(ot), Sr(n), C(!1), lt(A);
    },
    [st, ot, n]
  ), ho = L(() => {
    yt !== void 0 && (yt === "range" ? ($e && (f == null || f($e)), Be && (h == null || h(Be))) : yt === "selectedBooks" && i(wr), Y(yt), lt(void 0), Gt(void 0));
  }, [
    yt,
    $e,
    Be,
    ...
    A || (lt(void 0), Gt(void 0));
  }, []), go = L((A) => {
    var W;
    A.preventDefault(), (W = Ht.current) == null || W.focus();
  }, []), fo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Pe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !z && /* @__PURE__ */ a(_t, { children: S }),
      l === "dropdown" ? /* @__PURE__ */ u(Ne, { open: ut, onOpenChange: C, children: [
        ...
        /* @__PURE__ */ a(
          Ee,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: $r, children: [
              vt.map(({ value: A, label: W, dropdownLabel: Ft, scrRefSuffix: pr, id: Ri }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(A),
              ...
              x && /* @__PURE__ */ u(tt, { children: [
                ...
                /* @__PURE__ */ a(
                  Ge,
                  {
                    ...
                    onSelect: (A) => {
                      var W, Ft;
                      if (A.preventDefault(), It.current) {
                        It.current = !1;
                        return;
                      }
                      Tt.current || (Ft = (W = Nt.current) == null ? void 0 : W.querySelector("button")) == null || Ft.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          W != null && W.closest("button") && (It.current = !0, requestAnimationFrame(() => {
                            It.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ga,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var W;
                              A.preventDefault(), (W = D.current) == null || W.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(tt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ke(m ?? pa, "id") }),
                              /* @__PURE__ */ a(tr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        jn,
        {
          ...
          children: nt.map(({ value: A, label: W, scrRefSuffix: Ft, id: pr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Fa, { className: "tw:me-2", value: A, id: pr }),
            /* @__PURE__ */ a(_t, { htmlFor: pr, children: U(W, Ft) })
          ] }, pr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { children: O }),
      b
    ] }),
    l === "radio" && t === "range" && kt,
    l === "dropdown" && mt && /* @__PURE__ */ a(Va, { open: ct === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ref: Si,
        onCloseAutoFocus: go,
        ...
        children: /* @__PURE__ */ u(da, { container: Or, children: [
          ...
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => Mr(!1), children: it }),
            /* @__PURE__ */ a(j, { onClick: ho, children: ht })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && bt && /* @__PURE__ */ a(Va, { open: ct === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      La,
      {
        ref: Ue,
        onCloseAutoFocus: go,
        ...
        children: /* @__PURE__ */ u(da, { container: Yt, children: [
          /* @__PURE__ */ a(qr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Gr, { children: B }) }),
          kt,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(j, { variant: "outline", onClick: () => Mr(!1), children: it }),
            /* @__PURE__ */ a(j, { ref: Oe, onClick: ho, children: ht })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          nr,
          {
            ...
            style: { zIndex: ir },
            children: t.map((l) => /* @__PURE__ */ a(se, { value: `${l}`, children: c[vo(l)] }, `${l}`))
          }
        )
      ]
    }
...
function qa({
  ...
  return /* @__PURE__ */ u(Ne, { variant: i, children: [
    /* @__PURE__ */ a(Ce, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(j, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(Ee, { align: "start", style: { zIndex: ir }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(vn, { children: [
      /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(ee, { children: _i(e.groups, e.items, d, t) }) }),
...
Ci.displayName = de.List.displayName;
...
Ei.displayName = de.List.displayName;
...
Ti.displayName = de.Content.displayName;
function Wp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Yw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Ww, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ir },
          children: /* @__PURE__ */ a(ee, { children: zi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Zp({
  ...
  return /* @__PURE__ */ u("div", { id: d, className: g("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(_t, { className: "tw:font-normal tw:text-muted-foreground", children: ye(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ne, { children: [
              /* @__PURE__ */ a(Ce, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(j, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
