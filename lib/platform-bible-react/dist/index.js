...
import { c as m, g as $e, a as La, C as Pe, A as ue, P as Ve, b as We, B as G, d as je, e as Xe, f as Je, h as Ce, i as Bi, k as Li, j as Fi, E as Ui, l as Fa, r as se, m as Ki, n as dn, o as Qr, p as Ua, L as Et, D as _a, q as Na, s as Ca, t as Ea, T as Wt, u as Ka, v as Xt, w as Jt, x as Zt, y as wn, z as qa, F as Ge, G as kr, H as Ee, I as Te, J as ze, S as _r, K as ar, M as qi, N as Er, O as Ye, Q as Ae, R as Oe, U as or, V as Ga, W as Ha, X as qr, Y as Ya, Z as un, _ as Gi, $ as Hi, a0 as Yi, a1 as bo, a2 as pn, a3 as ta, a4 as hn, a5 as Wi, a6 as Xi, a7 as Ji, a8 as Zi, a9 as gn, aa as Qi, ab as ia, ac as xo, ad as sa, ae as hr, af as ts, ag as es, ah as rs, ai as as, aj as os, ak as Tr, al as Wa } from "./resizable-C-htIGp4.js";
...
import { useReactTable as Vn, getFilteredRowModel as Uc, getSortedRowModel as jn, getPaginationRowModel as Kc, getCoreRowModel as Bn, flexRender as xr, getGroupedRowModel as qc, getExpandedRowModel as Gc } from "@tanstack/react-table";
...
function wl({
  ...
  return /* @__PURE__ */ u(Ve, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(je, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Je, { children: /* @__PURE__ */ a(Ce, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      Pe,
      {
        onSelect: () => h(g),
...
function Kn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function wa({
  ...
  const M = se(), [j, z] = _(!1), [P, $] = _(""), [E, B] = _(""), [O, T] = _("books"), [H, Y] = _(void 0), [F, V] = _(
    void 0
  ), [R, Z] = _(void 0), [rt, Tt] = _(!1), St = U(null), Pt = U(!1), K = U(void 0), ot = U(void 0), gt = U(void 0), wt = U(void 0), xt = U({}), he = U({}), st = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Ut = I(() => o ? o() : Ki, [o]), yt = I(() => ({
    [ht.OT]: Ut.filter((W) => kt.isBookOT(W)),
    [ht.NT]: Ut.filter((W) => kt.isBookNT(W)),
    [ht.DC]: Ut.filter((W) => kt.isBookDC(W)),
    [ht.Extra]: Ut.filter((W) => kt.extraBooks().includes(W))
    ...
    return [ht.OT, ht.NT, ht.DC, ht.Extra].forEach((nt) => {
      b[nt] = yt[nt].filter((jt) => Fa(jt, E, n));
    }), b;
  }, [yt, E, n]), D = I(
    () => fl(E, oe, n),
    [E, oe, n]
  ...
  const mt = L(() => {
    ...
    (b) => {
      const W = F ?? (D == null ? void 0 : D.book), nt = R ?? (D == null ? void 0 : D.chapterNum);
      !W || !nt || (st({
        book: W,
        chapterNum: nt,
        verseNum: b
    ...
    (b) => {
      const W = O === "chapters" ? H : D == null ? void 0 : D.book;
      if (W) {
        if (l && l(W, b) > 1) {
          V(W), Z(b), T("verses"), $("");
          return;
    ...
    T("books"), Y(void 0), V(void 0), Z(void 0), setTimeout(() => {
      ot.current && ot.current.focus();
    }, 0);
  }, []), Dt = L(() => {
    const b = F;
    V(void 0), Z(void 0), b ? (Y(b), T("chapters"), $("")) : de();
  }, [F, de]), Vt = L((b) => {
    z(b), b && (T("books"), Y(void 0), V(void 0), Z(void 0), B(""));
  }, []);
  J(() => {
    k && Vt(!1);
  }, [k, Vt]);
  ...
  J(() => {
    var b;
    ee !== 0 && ((b = ot.current) == null || b.focus());
  }, [ee]), Gs(
    N,
    () => ({
      open: () => {
  ...
  const { otLong: qt, ntLong: re, dcLong: Gt, extraLong: S } = {
    ...
    () => hl(E),
    [E]
  ), q = I(() => !l || !D || !D.chapterNum || !et ? !1 : l(D.book, D.chapterNum) > 0, [l, D, et]), lt = L(
    (b) => w ? Ao(b, w) : !1,
    [w]
  ), ut = L(
    (b) => (W) => w ? gl(b, W, w) : !1,
    ...
    (b, W) => (nt) => w ? da(b, W, nt, w) : !1,
    [w]
  ), Nt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ct = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Le = L(
    (b) => {
      (b.key === "Home" || b.key === "End") && b.stopPropagation(), p && p.includes(b.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (b.preventDefault(), b.stopPropagation(), mt());
    },
    [p, D, mt]
  ), Dr = L(
    (b) => {
      var ke, Fe, Re;
      if (b.ctrlKey) return;
      const { isLetter: W, isDigit: nt } = Io(b.key);
      if ((O === "chapters" || O === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const It = (ke = K.current) == null ? void 0 : ke.querySelector(
      ...
      if (O === "verses" && jt) {
        ...
        ne !== ft && (b.preventDefault(), b.stopPropagation(), $(
          ...
          const Ue = he.current[ne];
          Ue && Ue.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((O === "chapters" || O === "books" && D) && jt) {
        const At = O === "chapters" ? H : D == null ? void 0 : D.book;
        if (!At) return;
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (jt = ot.current) == null || jt.focus();
      return;
    }
    const { isLetter: W, isDigit: nt } = Io(b.key);
    (W || nt) && (b.preventDefault(), B((ke) => ke + b.key), ot.current.focus(), Tt(!1));
  }, []);
  return Yt(() => {
    const b = setTimeout(() => {
      if (j && O === "books" && gt.current && wt.current) {
        const W = gt.current, nt = wt.current, jt = nt.offsetTop, ke = W.clientHeight, Fe = nt.clientHeight, Re = jt - ke / 2 + Fe / 2;
        W.scrollTo({
          top: Math.max(0, Re),
          behavior: "smooth"
        }), $(Un(t.book));
    ...
    if (O === "chapters" && H) {
      const b = H === t.book, W = b ? t.chapterNum : 1;
      $(
        `${H} ${ue[H] || ""} ${W}`
      ), setTimeout(() => {
        if (gt.current)
          if (b) {
            const nt = xt.current[t.chapterNum];
  ...
  }, [O, H, D, t.book, t.chapterNum]), Yt(() => {
    if (O === "verses" && F && R !== void 0) {
      const b = F === t.book && R === t.chapterNum, W = b ? t.verseNum : 1;
      $(
        `${F} ${ue[F] || ""} ${R}:${W}`
      ), setTimeout(() => {
        if (gt.current)
          if (b) {
            const nt = he.current[t.verseNum];
            nt && nt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            gt.current.scrollTo({ top: 0 });
        K.current && K.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ve, { open: j, onOpenChange: Vt, modal: v, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
      G,
      {
        ref: St,
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: W } = b;
          j && St.current && W instanceof Node && St.current.contains(W) && (Pt.current = !0, Vt(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Xe,
            ...
            children: [
              O === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: le.map(
                  ({ onClick: b, disabled: W, title: nt, icon: jt }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                O === "chapters" && H && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: $e(H, n) }),
                O === "verses" && F && R !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${$e(F, n)} ${R}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !rt && /* @__PURE__ */ u(Je, { ref: gt, children: [
                O === "books" && /* @__PURE__ */ u(dt, { children: [
                  !D && Object.entries(te).map(([b, W]) => {
                    if (W.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ce, { heading: X(b), children: W.map((nt) => /* @__PURE__ */ a(
                          Fn,
                          {
                            bookId: nt,
                            onSelect: (jt) => Kt(jt),
                            section: br(nt),
                            commandValue: `${nt} ${ue[nt]}`,
                            ref: nt === t.book ? wt : void 0,
                            localizedBookNames: n,
                            disabled: lt(nt)
                          },
                          nt
                  ...
                  D && /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(
                    Pe,
                    {
                  ...
                  D && q && D.chapterNum && l && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${$e(D.book, n)} ${D.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        onVerseSelect: zt,
                        setVerseRef: x,
                        isVerseDisabled: vt(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !q && nr(D.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: $e(D.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Po,
                      {
                        ...
                        setChapterRef: at,
                        isChapterDimmed: it,
                        isChapterDisabled: ut(D.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                O === "chapters" && H && /* @__PURE__ */ a(
                  Po,
                  {
                    bookId: H,
                    scrRef: t,
...
function jo({
  ...
  const [k, M] = _(!1), j = l ?? d, z = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], P = ($, E) => {
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        children: /* @__PURE__ */ u(Xe, { children: [
          ...
          /* @__PURE__ */ a(Je, { children: z(e) ? e.map(($) => /* @__PURE__ */ a(Ce, { heading: $.groupHeading, children: $.options.map((E) => P(E, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(Ce, { children: e.map(($) => P($)) }) })
        ] })
      }
    )
  ] });
...
function Dl() {
  return function(t) {
    const [e] = ye(), r = I(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = U(o);
    return zl(() => {
...
function Il(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      const p = Qt();
      if (!ve(p)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [h, g] = function($) {
        const E = $.getStartEndPoints();
        return $.isBackward() ? [E[1], E[0]] : E;
      }(p), f = h.getNode(), y = f.getKey(), v = h.offset, C = g.getNode(), N = C.getKey(), k = g.offset, M = t.getElementByKey(y), j = t.getElementByKey(N), z = r === null || M !== o || v !== n || y !== r.getKey(), P = i === null || j !== s || k !== c || N !== i.getKey();
      if ((z || P) && M !== null && j !== null) {
        const $ = function(E, B, O, T, H, Y, F) {
          const V = (E._window ? E._window.document : document).createRange();
          return V.setStart(...Bo(B, O, T)), V.setEnd(...Bo(H, Y, F)), V;
        }(t, h, f, M, g, C, j);
        d(), d = Ol(t, $, e);
      }
...
function jl(t) {
  const e = Qt() || Ws();
  let r;
  if (ve(e)) r = Xs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Sn(c, "next"));
    }
    r = r || Js(Ie(), "previous").getFlipped().insert(Sr());
  }
...
function Bl(t, e, r) {
  ...
  return oc(o) && Hr(283), o.insert(t.isInline() ? Sr().append(t) : t), Mo(Sn(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Qt();
  if (!ve(e)) return !1;
...
let Yr, Ne = 0, Wr = 0, Kl = 0, Pa = 0, Br = 0;
function Fo(t) {
  if (ct === void 0) return;
  let e = t.n;
...
Lt.prototype.brand = Fl, Lt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && Wr === 0 && e.l !== Pa && (e.l = Pa, Yr = { S: e, v: e.v, i: e.i, o: Yr });
...
} }), Ke.prototype = new Lt(), Ke.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Xn(this), Uo(this), Ne++;
  const t = ct;
...
ce({ build: (t, e, r) => gr(e), config: Ze({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Jn() {
  const t = Ie(), e = Qt(), r = Sr();
  t.clear(), t.append(r), e !== null && r.select(), ve(e) && (e.format = 0);
}
function Zn(t, e = Jn) {
  return t.registerCommand(Rn, (r) => (t.update(e), !0), eo);
}
ce({ build: (t, e, r) => gr(e), config: Ze({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return be(() => Zn(t, o.value));
} });
function Hl(t) {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [Qn], register: (t, e, r) => t.registerCommand(Mn, (o) => {
  const n = Qt();
  if ($n(n) || ve(n)) for (const i of n.getNodes()) Yl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function ti(t, e) {
  let r;
...
const so = 0, ja = 1, ri = 2, ga = 3, Ir = 4, tr = 5, fa = 6, mr = 7;
function ma(t) {
  return t.id === so;
}
function ai(t) {
...
class Jl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && pt(307, String(r.id), String(tr)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= mr;
    }(e) || pt(316, String(e.id), String(mr)), e;
  }
...
const Ql = ce({ config: Ze({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class ir {
  ...
  static maybeFromEditor(e) {
    const r = e[qo];
    return r && (r.PACKAGE_VERSION !== va && pt(292, r.PACKAGE_VERSION, va), r instanceof ir || pt(293)), r;
  }
  static fromEditor(e) {
...
ce({ dependencies: [Va, Ho], name: "@lexical/extension/HorizontalRule", nodes: () => [lr], register(t, e, r) {
  ...
  return Se(t.registerCommand(rd, (s) => {
    ...
    return !1;
  }, On), t.registerMutationListener(lr, (s, c) => {
    Ul(() => {
      let d = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = g : (d = !0, l.set(w, { domNode: Cr(g), selectedSignal: o(w) }));
      }
      d && (n.value = { nodeSelections: l });
    });
  }), be(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(be(() => {
      const l = c.value;
...
ce({ build: (t, e) => gr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Ze({ $getParentEditor: function() {
  const t = bc();
...
ce({ build: (t, e, r) => gr(e), config: Ze({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return be(() => {
...
function nd(t, e, r = oi) {
  return Se(t.registerCommand(Ec, (o) => {
    const n = Qt();
    if (!ve(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
ce({ build: (t, e, r) => gr(e), config: Ze({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ce({ build: (t, e, r) => gr(e), config: Ze({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => be(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: y, role: v = "textbox", spellCheck: C = !0, style: N, tabIndex: k, "data-testid": M, ...j }, z) {
  const [P, $] = _(t.isEditable()), E = L((O) => {
    ...
    return (T) => {
      for (const H of O) typeof H == "function" ? H(T) : H != null && (H.current = T);
    };
  }(z, E), [E, z]);
...
function Ed({
  ...
  const [e] = ye(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Cd(), d = () => {
  };
...
function Qu({
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ve, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
        G,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        je,
        {
          ...
          children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Je, { children: t.map((v) => /* @__PURE__ */ a(
            Pe,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
    ...
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (z) => {
              z.stopPropagation(), l(!0), p($d(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (z) => {
                z.key === "Escape" ? (z.preventDefault(), z.stopPropagation(), g()) : uo(z) && (z.preventDefault(), z.stopPropagation(), ie(w) && f());
              },
              onKeyDown: (z) => {
        ...
        j && /* @__PURE__ */ u(Ee, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
          /* @__PURE__ */ a(ze, { align: "end", children: j })
        ] })
      ]
    }
  );
...
function xi({
  ...
  const [T, H] = _(Qo), [Y, F] = _(), [V, R] = _(), Z = o, [rt, Tt] = _(!1), [St, Pt] = _(!1), [K, ot] = _(!1), [gt, wt] = _(!1), [xt, he] = _(!1), [st, Ut] = _(M), [yt, oe] = _(!1), te = U(void 0), [D, _t] = _(/* @__PURE__ */ new Map());
  J(() => {
    let x = !0;
    return (async () => {
  ...
  const Kt = I(() => zt[0], [zt]), De = U(null), ge = U(void 0), le = L(() => {
    var x;
    (x = ge.current) == null || x.call(ge), H(Qo);
  }, []), de = L(() => {
    const x = !st;
  ...
  }, [i, r]), ee = I(() => zt.slice(1), [zt]), Rt = I(() => ee.length ?? 0, [ee.length]), qt = I(() => Rt > 0, [Rt]), re = I(() => rt || Rt <= 2 ? ee : ee.slice(-2), [ee, Rt, rt]), Gt = I(() => rt || Rt <= 2 ? 0 : Rt - 2, [Rt, rt]), S = I(
    () => Rt === 1 ? Dt.singleReply : He(Dt.multipleReplies, { count: Rt }),
    [Rt, Dt]
  ), X = I(
    () => Gt === 1 ? Dt.singleReply : He(Dt.multipleReplies, { count: Gt }),
    [Gt, Dt]
  );
  J(() => {
    !o && St && qt && Pt(!1);
  ...
  const it = L(
    async (x) => {
      ...
      et && await p({ threadId: d, contents: et }) && le();
    },
    [
      le,
      T,
    ...
    async (x) => {
      const et = ie(T) ? Jr(T) : void 0, q = x.status ? x.assignedUser : Y ?? x.assignedUser, lt = await p({
        ...x,
        contents: et,
        assignedUser: q
      });
      return lt && (q !== void 0 && R(q), et && le()), lt;
    },
    [le, T, p, Y]
  );
  ...
  const at = /* @__PURE__ */ a(
    Zo,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Pt,
      canEditOrDelete: (!St && D.get(Kt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            Vt && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: Vt }),
            /* @__PURE__ */ a(
              G,
              {
                variant: "ghost",
            ...
            B === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: xt && w !== "Resolved",
                  onClick: () => tt({ threadId: d, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(dt, { children: [
          qt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: S })
          ] }),
          !o && ie(T) && /* @__PURE__ */ a(
            Xr,
            {
              editorSerializedState: T,
              onSerializedChange: (x) => H(x),
          ...
          o && /* @__PURE__ */ u(dt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    rt ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(cr, {})
                  ] })
                ]
              }
            ),
            re.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Zo,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: Pt,
                canEditOrDelete: (!St && D.get(x.id)) ?? !1
              }
            ) }, x.id)),
            v !== !1 && (!St || ie(T)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  uo(x) && (x.preventDefault(), x.stopPropagation(), (ie(T) || Y !== void 0 && Y !== V) && it());
                },
                onKeyDown: (x) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    Y !== void 0 && (ie(T) || Y !== V) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: He(
                    ...
                    /* @__PURE__ */ u(Ve, { open: K, onOpenChange: ot, children: [
                      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        je,
                        {
                          ...
                          align: "end",
                          onKeyDown: (x) => {
                            x.key === "Escape" && (x.stopPropagation(), ot(!1));
                          },
                          children: /* @__PURE__ */ a(Xe, { children: /* @__PURE__ */ a(Je, { children: y == null ? void 0 : y.map((x) => /* @__PURE__ */ a(
                            Pe,
                            {
                              onSelect: () => {
                                F(x !== i ? x : void 0), mt.current = "user-selected", R(void 0), ot(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function Fd({
  ...
  const B = e["%conflict_note_no_result%"] ?? "No result preview available.", O = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: B }), T = (V) => V ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: V }) : O, H = () => {
    const V = o ?? "accept";
    return V === "merged" ? t.mergedText ? /* @__PURE__ */ a(Kr, { html: C }) : O : T(V === "reject" ? t.rejectedResultText : t.resultText);
  }, Y = (V) => p && V.value === "reject", F = (V) => {
    const R = f === V.value, Z = `${l}-${V.value}`, rt = Y(V);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: z.map((V) => Y(V) ? /* @__PURE__ */ a(Wt, { delayDuration: 0, children: /* @__PURE__ */ u(Xt, { children: [
...
function sp({
  ...
  const [N, k] = _(/* @__PURE__ */ new Set()), [M, j] = _(), [z, P] = _(), $ = L(
    async (R) => {
      const Z = await i(R);
  ...
  const E = r.filter(
    ...
    [N, y]
  ), { listboxRef: H, activeId: Y, handleKeyDown: F } = qi({
    options: B,
    onOptionSelect: O
  }), V = L(
    (R) => {
...
function Yd({ table: t }) {
  return /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function ur({ className: t, size: e = "default", children: r, ...o }) {
  const n = se();
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        dr,
        {
          ...
          children: [
            /* @__PURE__ */ a(ur, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(wr, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(pr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(we, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Qd({
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((E, B) => `skeleton-row-${B}`).map((E) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(or, { colSpan: M.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((P) => /* @__PURE__ */ a(
    Oe,
    {
      onClick: () => s(P, k),
      "data-state": P.getIsSelected() && "selected",
      children: P.getVisibleCells().map(($) => /* @__PURE__ */ a(or, { children: xr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    P.id
  )) : j = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(or, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Yd, { table: k }),
    /* @__PURE__ */ u(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: k.getHeaderGroups().map((P) => /* @__PURE__ */ a(Oe, { children: P.headers.map(($) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : xr($.column.columnDef.header, $.getContext()) }, $.id)) }, P.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(G, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(vn, {}) })
        ] }),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "default", children: [
...
function nw(t, e, r) {
  var o;
  return t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (er(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (er(t), r.commit(), "ended") : t.key === "Escape" ? (er(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? t.key === " " && ((o = e.shouldSpaceCommit) != null && o.call(e, e.filter)) ? (er(t), r.commit(), "ended") : (r.dismiss(), "ended") : e.kind === "backslash" && t.key === "Backspace" && e.filter === "" ? (r.dismiss(), "ended") : t.key === "Backspace" || ow[e.kind].test(t.key) ? (e.kind !== "backslash" && er(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && er(t), r.dismiss(), "ended");
}
function en(t, e) {
  var r;
...
function dw({
  ...
  return /* @__PURE__ */ u(Ee, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: lw(t, n, r) }) }) }),
...
function pw({
  ...
  return /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Wt, { children: /* @__PURE__ */ u(Xt, { children: [
      /* @__PURE__ */ a(Jt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: ww(t, r) }) }) }),
      /* @__PURE__ */ a(Zt, { children: /* @__PURE__ */ a("p", { children: uw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ze, { style: { zIndex: pn }, children: [
...
function fw({
  ...
  return /* @__PURE__ */ u(Xe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Je, { children: [
      ...
      /* @__PURE__ */ a(Ce, { children: s.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          an,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(Ce, { children: c.map((d) => {
          var l;
          return /* @__PURE__ */ a(
            an,
            {
...
function mp({
  ...
  const [v, C] = _("generated"), [N, k] = _("generated"), [M, j] = _("*"), [z, P] = _("*"), [$, E] = _("f"), [B, O] = _(!1), [T, H] = _(!0), [Y, F] = _(!1), V = U(!1), R = U(""), [Z, rt] = _(!1), [Tt, St] = _(), [Pt, K] = _(), [ot, gt] = _(), [wt, xt] = _(), he = U(null), st = U(void 0), Ut = U(0), yt = I(
    () => ({
      ...c,
  ...
  Yt(() => {
    var S;
    oe.current = (S = yt.view) == null ? void 0 : S.markerMode;
  });
  const te = I(
    () => mw(
      h,
  ...
  J(() => {
    var S;
    Z || (S = h.current) == null || S.focus();
  }, [$, Z]);
  const D = L(() => {
    var tt, at, x;
    const S = (tt = g.current) == null ? void 0 : tt.querySelector(".editor-input"), X = S == null ? void 0 : S.querySelector("span.note"), it = (x = (at = g.current) == null ? void 0 : at.ownerDocument.getSelection()) == null ? void 0 : x.anchorNode;
    return !!X && !!it && X.contains(it);
  }, []);
  J(() => {
    var at, x;
    let S, X, it;
    ...
    if (tt && $r("note", tt)) {
      const et = (at = tt.insert.note) == null ? void 0 : at.caller;
      let q = "custom";
      et === Oa ? q = "generated" : et === Aa ? q = "hidden" : et && (j(et), P(et)), C(q), k(q), E(((x = tt.insert.note) == null ? void 0 : x.style) ?? "f"), S = setTimeout(() => {
        var ut, vt, Nt;
        const lt = oe.current === "editable" ? [{ retain: kw }, tt] : [tt];
        (ut = h.current) == null || ut.applyUpdate(lt), s && ((vt = h.current) == null || vt.selectNote(0), (Nt = h.current) == null || Nt.focus(), X = requestAnimationFrame(() => {
          it = setTimeout(() => {
            var Ct, Le;
            D() || ((Ct = h.current) == null || Ct.selectNote(0), (Le = h.current) == null || Le.focus());
          }, 0);
        }));
      }, 0);
    }
    return () => {
      S && clearTimeout(S), X !== void 0 && cancelAnimationFrame(X), it !== void 0 && clearTimeout(it);
    };
  }, [e, i, s, D]);
  const _t = L(
    (S, X, it = !1) => {
      var at, x, et;
      const tt = (x = (at = h.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : x.at(0);
      if (tt && $r("note", tt)) {
        if (tt.insert.note) {
          let q;
          S === "custom" ? q = X : S === "generated" ? q = Oa : q = Aa, tt.insert.note.caller = q;
        }
        r == null || r([tt]), it && w && i && ((et = w.current) == null || et.replaceEmbedUpdate(i, [tt]));
      }
    },
    [i, r, w]
  ), mt = L(() => {
    var S;
    st.current || (S = h.current) == null || S.commitPendingMarkerEdits(), _t(v, M, !0), o();
  }, [v, M, o, _t]), zt = U(mt);
  Yt(() => {
    zt.current = mt;
  });
  ...
  const De = () => {
    var X;
    const S = (X = g.current) == null ? void 0 : X.getElementsByClassName("editor-input")[0];
    ...
    var it, tt, at, x, et;
    E(S);
    const X = (tt = (it = h.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : tt.at(0);
    if (X && $r("note", X)) {
      X.insert.note && (X.insert.note.style = S);
      const q = (x = (at = X.insert.note) == null ? void 0 : at.contents) == null ? void 0 : x.ops;
      $ !== "x" && S === "x" ? q == null || q.forEach((lt) => bw(lt)) : $ === "x" && S !== "x" && (q == null || q.forEach((lt) => xw(lt))), (et = h.current) == null || et.applyUpdate([X, { delete: 1 }]);
    }
  }, Dt = (S) => {
    xt(S.contextMarker), F(S.canRedo);
  }, Vt = L(
    (S) => {
      var it, tt, at, x, et;
      const X = (tt = (it = h.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (X && $r("note", X)) {
        ...
        const q = (at = X.insert.note) == null ? void 0 : at.style, lt = (et = (x = X.insert.note) == null ? void 0 : x.contents) == null ? void 0 : et.ops;
        if (q || O(!1), O(
          ...
          V.current = !0, R.current = JSON.stringify(X), H(!0);
          return;
        }
        H(JSON.stringify(X) === R.current), _t(v, M);
      } else
        O(!1), H(!0);
    },
    [v, M, _t]
    ...
    if (f.current && te.length && S && S.rangeCount > 0) {
      const X = S.getRangeAt(0).getBoundingClientRect(), it = f.current.getBoundingClientRect();
      St(X.left - it.left), K(X.top - it.top), gt(X.height), rt(!0);
    }
  }, [te, f]), Rt = L(
    (S, X, it) => {
      const { anchorRect: tt } = S;
      if (!p || !tt) return;
      const { passive: at, literalPrefixLanded: x } = it;
      Ut.current += 1;
      const et = Ut.current;
      st.current = {
        kind: at ? "backslash" : "selection",
        token: et,
        literalPrefixLanded: x,
        filter: "",
        items: X
      }, p.show(X.map(vw), tt, at).then((q) => {
        var lt, ut, vt;
        if (en(st, et), q !== void 0) {
          const Nt = X.find((Ct) => Ct.marker === q);
          Nt && ((lt = h.current) == null || lt.applyMarkerMenuSelection(Nt, {
            trigger: "backslash",
            literalPrefixLanded: x
          })), (ut = h.current) == null || ut.focus();
        } else at || (vt = h.current) == null || vt.focus();
      }).catch(() => {
        var q;
        en(st, et), at || (q = h.current) == null || q.focus();
      });
    },
    [p]
  );
  J(() => {
    ...
    var S;
    Z && ((S = he.current) == null || S.focus());
  }, [Z]), J(() => {
    var it, tt;
    const S = ((it = g.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0;
    if (((tt = yt.view) == null ? void 0 : tt.markerMode) === "editable") {
      const at = (x) => {
        var vt, Nt, Ct;
        if (!S || document.activeElement !== S) return;
        const et = st.current;
        if (et && p) {
          nw(x, et, p) === "ended" && (st.current = void 0);
          return;
        }
        if (x.key === "Enter" && !D()) {
        ...
        if (!p || x.key !== d) return;
        const q = (Ct = h.current) == null ? void 0 : Ct.getMarkerMenuContext();
        if (!q) return;
      ...
      return document.addEventListener("keydown", at, { capture: !0 }), () => {
        document.removeEventListener("keydown", at, { capture: !0 });
      };
    }
    const X = (at) => {
      !Z && S && document.activeElement === S && at.key === d ? (at.preventDefault(), ee()) : Z && at.key === "Escape" && (at.preventDefault(), rt(!1));
    };
  ...
  return /* @__PURE__ */ u(Ga, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Ya, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          /* @__PURE__ */ a(or, { children: _e(c.reference, "English") }),
          /* @__PURE__ */ a(or, { className: o, children: Ew(c.text) })
        ]
      },
...
function Tp({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), y = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), C = fe(r, "%webView_inventory_scope_currentBook%"), N = fe(r, "%webView_inventory_scope_chapter%"), k = fe(r, "%webView_inventory_scope_verse%"), M = fe(r, "%webView_inventory_filter_text%"), j = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = fe(r, "%webView_inventory_no_results%"), [P, $] = _(!1), [E, B] = _("all"), [O, T] = _(""), [H, Y] = _([]), F = I(() => {
    const K = t ?? [];
    ...
    const K = [];
    return F.forEach((ot) => {
      const gt = ot.items[0], wt = K.find(
        (xt) => xt.items[0] === gt
      );
      wt ? (wt.count += ot.count, wt.occurrences = wt.occurrences.concat(ot.occurrences)) : K.push({
        items: [gt],
        count: ot.count,
  ...
  const rt = (K, ot) => {
    ...
    const K = V.filter((ot) => Us(
      P ? ot.items : [ot.items[0]],
      H
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        dr,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ a(ur, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(wr, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ u(dr, { onValueChange: (K) => Tt(K), defaultValue: s, children: [
        /* @__PURE__ */ a(ur, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(wr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(pr, { children: [
...
const Me = "scrBook", Kw = "scrRef", qe = "source", qw = "details", Gw = "Scripture Reference", Hw = "Scripture Book", Ni = "Type", Yw = "Details";
function Ww(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? kt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Me ? _e(n.start) : void 0;
      },
...
function Fp({
  ...
  const [l, w] = _([]), [p, h] = _([{ id: Me, desc: !1 }]), [g, f] = _({}), y = I(
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      dr,
      {
        ...
        children: [
          /* @__PURE__ */ a(ur, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(wr, {}) }),
          /* @__PURE__ */ a(pr, { position: "item-aligned", children: /* @__PURE__ */ a(Wd, { children: M.map((E) => /* @__PURE__ */ a(we, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ga, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ha, { children: C.getHeaderGroups().map((E) => /* @__PURE__ */ a(Oe, { children: E.headers.filter((B) => B.column.columnDef.header).map((B) => (
        ...
        /* @__PURE__ */ a(qr, { colSpan: B.colSpan, className: "tw:sticky top-0", children: B.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          xr(B.column.columnDef.header, B.getContext())
        ] }) }, B.id)
      )) }, E.id)) }),
        ...
        return /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: E.getVisibleCells().map((T) => {
              if (!(T.getIsPlaceholder() || T.column.columnDef.enableGrouping && !T.getIsGrouped() && (T.column.columnDef.id !== qe || !r)))
                return /* @__PURE__ */ a(
                  or,
                  {
                    className: m(
                    ...
                    children: T.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        type: "button",
                        children: [
                          E.getIsExpanded() && /* @__PURE__ */ a(cr, {}),
                          !E.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ a(za, {}) : /* @__PURE__ */ a(Ta, {})),
                          " ",
                          xr(T.column.columnDef.cell, T.getContext()),
                          " (",
                          E.subRows.length,
                          ")"
                        ]
...
function Jw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
    ...
    (T, H = !1) => {
      ...
      const Y = j.findIndex((rt) => rt === k.current), F = j.findIndex((rt) => rt === T);
      if (Y === -1 || F === -1) return;
      const [V, R] = [
        Math.min(Y, F),
        Math.max(Y, F)
    ...
    T.preventDefault(), P(H, T.shiftKey);
  }, B = () => {
    r(j.map((T) => T));
  }, O = () => {
    r([]);
          ...
          Xe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: B, children: d }),
                /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: O, children: l })
              ] }),
              /* @__PURE__ */ u(Je, { children: [
                /* @__PURE__ */ a(Ua, { children: w }),
                Object.values(ht).map((T, H) => {
                  const Y = z[T];
                  if (Y.length !== 0)
                    return /* @__PURE__ */ u(Nn, { children: [
                      ...
                      H < Object.values(ht).length - 1 && /* @__PURE__ */ a(hn, {})
                    ] }, T);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === ya ? ya : ln
      ).map((d) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: $e(d, n) }, d)),
...
function Kp({
  ...
  const M = Mt(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = Mt(s, "%webView_scope_selector_verse%"), z = Mt(s, "%webView_scope_selector_chapter%"), P = Mt(s, "%webView_scope_selector_book%"), $ = Mt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Mt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), B = Mt(s, "%webView_scope_selector_current_book%"), O = Mt(s, "%webView_scope_selector_choose_books%"), T = Mt(s, "%webView_scope_selector_scope%"), H = Mt(s, "%webView_scope_selector_select_books%"), Y = Mt(s, "%webView_scope_selector_range%"), F = Mt(s, "%webView_scope_selector_select_range%"), V = Mt(s, "%webView_scope_selector_range_start%"), R = Mt(s, "%webView_scope_selector_range_end%"), Z = Mt(s, "%webView_scope_selector_ok%"), rt = Mt(s, "%webView_scope_selector_cancel%"), Tt = Mt(s, "%webView_scope_selector_navigate%"), St = (A) => {
    if (!f) return;
  ...
  ], K = (A, Q, Ht = !1) => /* @__PURE__ */ u(dt, { children: [
    A,
    Q && !Ht && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Q
    ] })
  ] }), ot = e ? Pt.filter((A) => e.includes(A.value)) : Pt, gt = f ?? la, wt = w ?? gt, xt = p ?? gt, he = () => {
  }, st = U(null), Ut = U(null), yt = U(!1), oe = U(null), te = U(!1), [D, _t] = _(void 0), mt = U(!1), zt = U(!1), Kt = U(null), De = L((A) => {
    if (A) {
      _t("start"), mt.current = !1;
      return;
    }
    _t((Q) => Q === "start" ? void 0 : Q), mt.current && (mt.current = !1, requestAnimationFrame(() => {
      var Ht;
      const Q = (Ht = st.current) == null ? void 0 : Ht.querySelector("button");
      Q == null || Q.click();
    }));
  }, []), ge = L((A) => {
    if (A) {
    ...
    [r, n, f, i]
  ), Vt = ot.find((A) => A.value === t), ee = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Ks(wt, xt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Vt ? K(Vt.label, Vt.scrRefSuffix) : t, Rt = ot.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), qt = ot.find((A) => A.value === "selectedBooks"), re = ot.find((A) => A.value === "range"), [Gt, S] = _(!1), [X, it] = _(void 0), [tt, at] = _(void 0), [x, et] = _(void 0), [q, lt] = _(void 0), [ut, vt] = _([]), Nt = l === "dropdown" && X === "selectedBooks", Ct = /* @__PURE__ */ a(
    Qw,
    {
      availableBookInfo: o,
  ...
  ), Le = D === "end", Dr = D === "start", Qe = "tw:text-muted-foreground", b = l === "dropdown" && X === "range", W = b ? et : le, jt = b ? lt : g ? de : he, ke = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(Le && Qe), children: V }),
      /* @__PURE__ */ a(
        wa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: st, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Dr && Qe), children: R }),
      /* @__PURE__ */ a(
        wa,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (A) => {
            var Q;
            zt.current && (zt.current = !1, A.preventDefault(), (Q = Kt.current) == null || Q.focus());
          },
          className: m(Dr && Qe),
          modal: !0,
          align: "start"
  ...
  const [bt, It] = _(null), [ft, ne] = _(null), [ae, Ue] = _(null), Oi = 200, [Ai, Ii] = _(!1);
  J(() => {
  ...
  const go = L(
    (A) => {
      at(A), et(wt), lt(xt), vt(n), S(!1), it(A);
    },
    [wt, xt, n]
  ), fo = L(() => {
    tt !== void 0 && (tt === "range" ? (x && (h == null || h(x)), q && (g == null || g(q))) : tt === "selectedBooks" && i(ut), Dt(tt), it(void 0), at(void 0));
  }, [
    tt,
    x,
    q,
    ...
    A || (it(void 0), at(void 0));
  }, []), mo = L((A) => {
    var Q;
    A.preventDefault(), (Q = At.current) == null || Q.focus();
  }, []), vo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !N && /* @__PURE__ */ a(Et, { children: T }),
      l === "dropdown" ? /* @__PURE__ */ u(Ee, { open: Gt, onOpenChange: S, children: [
        ...
        /* @__PURE__ */ a(
          ze,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: ae, children: [
              Rt.map(({ value: A, label: Q, dropdownLabel: Ht, scrRefSuffix: fr, id: Pi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: Re(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-4 tw:w-4" }) }),
                    K(Ht ?? Q, fr, Ai)
                  ]
                },
                Pi
                ...
                /* @__PURE__ */ a(
                  Ge,
                  {
                    ...
                    onSelect: (A) => {
                      ...
                      te.current || (Ht = (Q = Ut.current) == null ? void 0 : Q.querySelector("button")) == null || Ht.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          wa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var Q;
                              A.preventDefault(), (Q = oe.current) == null || Q.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _e(f ?? la, "id") }),
                              /* @__PURE__ */ a(cr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ao,
        {
          ...
          children: ot.map(({ value: A, label: Q, scrRefSuffix: Ht, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: fr }),
            /* @__PURE__ */ a(Et, { htmlFor: fr, children: K(Q, Ht) })
          ] }, fr))
        }
      )
    ] }),
    ...
    l === "radio" && t === "range" && ke,
    l === "dropdown" && qt && /* @__PURE__ */ a(_a, { open: X === "selectedBooks", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: ne,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(ia, { container: ft, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Rr(!1), children: rt }),
            /* @__PURE__ */ a(G, { onClick: fo, children: Z })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && re && /* @__PURE__ */ a(_a, { open: X === "range", onOpenChange: Rr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: It,
        onCloseAutoFocus: mo,
        ...
        children: /* @__PURE__ */ u(ia, { container: bt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Rr(!1), children: rt }),
            /* @__PURE__ */ a(G, { ref: Kt, onClick: fo, children: Z })
          ] })
        ] })
      }
    ) })
...
function qp({
  ...
  return /* @__PURE__ */ u(
    dr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(ur, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          wr,
          {
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ee, { variant: i, children: [
    /* @__PURE__ */ a(Te, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Os, {}) }) }),
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: hr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Nn, { children: [
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), vr(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), vr(c, [h, g]);
        break;
      case "alt+h":
        (C = d.current) == null || C.focus(), vr(d, [h, g]);
        break;
    }
  }), J(() => {
...
function th({
  ...
  const l = hu(
    ...
    return v ? `${(j = t[f]) == null ? void 0 : j.autonym} (${v})` : (z = t[f]) == null ? void 0 : z.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: m("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      dr,
      {
        ...
        onOpenChange: (f) => p(f),
        children: [
          /* @__PURE__ */ a(ur, { children: /* @__PURE__ */ a(wr, {}) }),
          /* @__PURE__ */ a(
            pr,
            {
              style: { zIndex: hr },
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: He(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ee, { children: [
              /* @__PURE__ */ a(Te, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(G, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
              /* @__PURE__ */ a(ze, { align: "end", children: l })
            ] }) }),
            e && l && /* @__PURE__ */ u(Ee, { children: [
              /* @__PURE__ */ a(Te, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(G, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
              /* @__PURE__ */ a(ze, { align: "end", children: l })
            ] })
          ] }),
