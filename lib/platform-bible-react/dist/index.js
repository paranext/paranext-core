...
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as Ge, sanitizeHtml as Xa, NumberFormat as kn, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as Co, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as Us } from "platform-bible-utils";
import qt, { useRef as F, useMemo as D, useState as _, useCallback as B, useEffect as H, useImperativeHandle as Ks, useLayoutEffect as Qt, createContext as Ja, useContext as _n, Component as qs, createElement as To, Suspense as Gs, forwardRef as Nn, useId as zo, Fragment as Za } from "react";
...
function wa({
  ...
  const L = pe(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ), [W, Z] = _(void 0), [Dt, Tt] = _(!1), Vt = F(null), q = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), ae = F({}), ut = F({}), bt = B(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = Pt[rt].filter((At) => La(At, V, n));
    }), b;
  }, [Pt, V, n]), R = D(
    () => ul(V, Jt, n),
    [V, Jt, n]
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => dl(V),
    [V]
  ), oe = D(() => !l || !R || !R.chapterNum || !xt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, xt]), je = B(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), ur = B(
    (b) => (G) => w ? wl(b, G, w) : !1,
    ...
    (b) => {
      ...
      if ((y === "chapters" || y === "books" && R) && At) {
        ...
        if (!Et) return;
        y === "chapters" && ((Le = tt.current) == null || Le.focus());
        const kt = (() => {
          if (!A) return 1;
          const ce = A.match(/(\d+)$/);
  ...
  return Qt(() => {
    const b = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, At = rt.offsetTop, me = G.clientHeight, Te = rt.clientHeight, Le = At - me / 2 + Te / 2;
        G.scrollTo({
          top: Math.max(0, Le),
          behavior: "smooth"
        }), C(Un(t.book));
...
function jo({
  ...
  const [N, O] = _(!1), L = l ?? d, z = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], I = (A, C) => {
...
function Ol(t, e = Dl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, E = h.getNode(), k = E.getKey(), N = h.offset, O = t.getElementByKey(x), L = t.getElementByKey(k), z = r === null || O !== o || v !== n || x !== r.getKey(), I = i === null || L !== s || N !== c || k !== i.getKey();
      if ((z || I) && O !== null && L !== null) {
...
let Yr, be = 0, Wr = 0, Bl = 0, Aa = 0, Lr = 0;
function Fo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ue(t, e) {
  Lt.call(this, void 0), this.x = t, this.s = void 0, this.g = Lr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Ll(t, e) {
  return new Ue(t, e);
}
...
Lt.prototype.brand = Pl, Lt.prototype.h = function() {
  return !0;
...
} }), Ue.prototype = new Lt(), Ue.prototype.h = function() {
...
function Zo({
  ...
  const h = B(
    ...
    [t.contents]
  ), O = !!t.conflictResolutionAction && !N, L = D(() => {
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          qe,
...
function vi({
  ...
  const Zt = D(() => Ct[0], [Ct]), Ee = F(null), te = F(void 0), P = B(() => {
    var S;
...
function Pd({
  ...
  }, O = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", L = h ? [
    {
      value: "merge",
...
function ap({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [O, L] = _(), [z, I] = _(), A = B(
    async ($) => {
      const W = await i($);
...
function Wd({
  ...
  return d ? L = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? L = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    I.id
  )) : L = /* @__PURE__ */ a(Re, { children: /* @__PURE__ */ a(er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function pp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [O, L] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Vt, q] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ma ? st = "generated" : it === $a ? st = "hidden" : it && (N(it), L(it)), x(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
...
function _p({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), x = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), k = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), L = le(
    r,
    "%webView_inventory_show_additional_items%"
...
const ze = "scrBook", Aw = "scrRef", Ke = "source", Vw = "details", Pw = "Scripture Reference", jw = "Scripture Book", ki = "Type", Bw = "Details";
function Lw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Uw({
  ...
  }, [x, v] = _(!1), [E, k] = _(""), N = F(void 0), O = F(!1), L = D(
    () => _i(t),
    [t]
  ), z = D(() => {
    if (!E.trim()) {
...
function Bp({
  ...
  }, ut = F(null), bt = F(null), Ot = F(!1), Pt = F(null), Jt = F(!1), [fe, R] = _(void 0), yt = F(!1), Ct = F(!1), Zt = F(null), Ee = B((M) => {
    if (M) {
  ...
  ), gr = fe === "end", Rr = fe === "start", Je = "tw:text-muted-foreground", Be = l === "dropdown" && zt === "range", b = Be ? It : P, rt = Be ? oe : h ? Q : ae, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const go = B(
    ...
    var X;
    M.preventDefault(), (X = Le.current) == null || X.focus();
...
function ah({
  ...
  const n = D(() => {
    ...
    const c = new kn(r);
    return (d) => c.format(d);
  }, [o, r]), i = Math.min(Math.max(t, 1), e), s = Array.from({ length: e }, (c, d) => d + 1);
