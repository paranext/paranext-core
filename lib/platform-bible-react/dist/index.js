...
import p, { forwardRef as qt, createContext as qn, useContext as Jn, useCallback as et, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Kn } from "react";
...
import { useReactTable as Ze, getFilteredRowModel as Er, getSortedRowModel as Qe, getPaginationRowModel as Mr, getCoreRowModel as tn, flexRender as Ot, getGroupedRowModel as Ir, getExpandedRowModel as Vr } from "@tanstack/react-table";
...
const ke = V.Trigger, rn = V.Group, jr = V.Portal, Fr = V.Sub, ns = V.RadioGroup;
...
on.displayName = V.SubContent.displayName;
...
$t.displayName = V.Content.displayName;
...
sn.displayName = V.RadioItem.displayName;
...
Zt.displayName = V.Label.displayName;
...
Lt.displayName = V.Separator.displayName;
...
var $r = Object.defineProperty, Lr = (t, e, n) => e in t ? $r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, C = (t, e, n) => Lr(t, typeof e != "symbol" ? e + "" : e, n);
const ft = [
  "GEN",
  "EXO",
  "LEV",
...
const J = class {
  ...
  constructor(e) {
    if (C(this, "name"), C(this, "fullPath"), C(this, "isPresent"), C(this, "hasVerseSegments"), C(this, "isCustomized"), C(this, "baseVersification"), C(this, "scriptureBooks"), C(this, "_type"), e == null)
...
C(J, "Original", new J(rt.Original)), C(J, "Septuagint", new J(rt.Septuagint)), C(J, "Vulgate", new J(rt.Vulgate)), C(J, "English", new J(rt.English)), C(J, "RussianProtestant", new J(rt.RussianProtestant)), C(J, "RussianOrthodox", new J(rt.RussianOrthodox));
let ht = J;
function $e(t, e) {
  const n = e[0];
...
const H = class T {
  constructor(e, n, a, o) {
    if (C(this, "firstChapter"), C(this, "lastChapter"), C(this, "lastVerse"), C(this, "hasSegmentsDefined"), C(this, "text"), C(this, "BBBCCCVVVS"), C(this, "longHashCode"), C(this, "versification"), C(this, "rtlMark", "‏"), C(this, "_bookNum", 0), C(this, "_chapterNum", 0), C(this, "_verseNum", 0), C(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const s = e, w = n != null && n instanceof ht ? n : void 0;
        ...
        if (e != null && e instanceof T) {
          ...
          if (e == null) return;
          const s = e instanceof ht ? e : T.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return w && (c = new ht(w)), n ? new T(n, a.toString(), i, c) : new T();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const w = +s[1].trim();
          this.versification = new ht(rt[w]);
        } catch {
    ...
    if (a.length !== 2 || A.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !T.isVerseParseable(a[1]))
      throw new Vt("Invalid reference : " + e);
...
function na({
  ...
  const s = Array.from({ length: e }, (i, c) => c + 1), w = et(
    (i) => {
      o(i);
    },
    [o]
...
const ze = A.allBookIds.filter((t) => !A.isObsolete(A.bookIdToNumber(t))), ra = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
], Dt = (t) => Rr(A.bookIdToNumber(t));
function sa() {
  return ze.map((e) => A.bookIdToEnglishName(e));
}
function ia(t) {
...
function wa(t) {
  ...
  if (ia(e))
    return ze.find((a) => A.bookIdToEnglishName(a) === e);
}
function as({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = $(), [s, w] = B(""), [i, c] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, b] = B(!1), [S, x] = B(h), k = Z(void 0), y = Z(void 0), E = Z(void 0), j = et(
    (N) => {
      const z = a ? a() : ze;
      return {
        OT: z.filter((P) => A.isBookOT(P)),
        NT: z.filter((P) => A.isBookNT(P)),
        DC: z.filter((P) => A.isBookDC(P))
      }[N].filter((P) => {
        const G = A.bookIdToEnglishName(P).toLowerCase(), F = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    (N, z, P, G) => {
      if (m(t.book !== N ? 1 : t.chapterNum), z || Dt(N) === -1) {
        e({
          book: N,
          chapterNum: P ?? 1,
          verseNum: G ?? 1
    ...
    oa.forEach((N) => {
      const z = N.exec(s);
      if (z) {
        const [P, G = void 0, F = void 0] = z.slice(1), It = wa(P);
        (A.isBookIdValid(P) || It) && v(
          It ?? P,
          !0,
          G ? parseInt(G, 10) : 1,
          F ? parseInt(F, 10) : 1
    ...
    (N) => {
      h ? (N.key === "ArrowDown" || N.key === "ArrowUp") && (E != null && E.current ? E.current.focus() : y.current && y.current.focus(), N.preventDefault()) : b(!0);
    },
    [h]
  ), Mt = (N) => {
    const { key: z } = N;
    z === "ArrowRight" || z === "ArrowLeft" || z === "ArrowDown" || z === "ArrowUp" || z === "Enter" || k.current.dispatchEvent(new KeyboardEvent("keydown", { key: z }));
  }, ut = (N) => {
    const { key: z } = N;
    if (f === i) {
      if (z === "Enter") {
        N.preventDefault(), v(i, !0, u);
        return;
      }
      const P = z === "ArrowRight" && !o || z === "ArrowRight" && o === "ltr" || z === "ArrowLeft" && o === "rtl", G = z === "ArrowLeft" && !o || z === "ArrowLeft" && o === "ltr" || z === "ArrowRight" && o === "rtl";
      let F = 0;
      if (P)
        if (u < Dt(f))
          F = 1;
      ...
      u + F <= 0 || u + F > Dt(f) ? m(0) : F !== 0 && (m(u + F), N.preventDefault());
    }
  };
  return ct(() => {
    i === f ? i === t.book ? m(t.chapterNum) : m(1) : m(0);
  }, [f, t.book, t.chapterNum, i]), Fe(() => {
    x(h);
  }, [h]), Fe(() => {
    const N = setTimeout(() => {
      if (S && y.current && E.current && !s) {
        const P = E.current.offsetTop - aa;
        y.current.scrollTo({ top: P, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(N);
    };
  }, [S, s]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Wt, { modal: !1, open: h, onOpenChange: Et, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Or,
      {
        ...
        handleKeyDown: O,
        handleOnClick: () => {
          c(t.book), g(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), w(At(t, "English")), k.current.focus();
        },
        onFocus: () => {
          ot.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      $t,
      {
        ...
        ref: y,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Le.map((N, z) => {
          const P = j(N);
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: ra[N] }),
            P.map((G) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ea,
              {
                bookId: G,
...
const la = pt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Rt : "button", { className: l(la({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const da = pt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), L = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(We.Root, { ref: n, className: l("pr-twp", da(), t), ...e }));
...
const hn = jt.Root, gn = jt.Trigger, Ee = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = $();
...
const ca = at.Portal, fn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
    className: l(
...
const pa = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
...
const De = p.forwardRef((t, e) => /* @__PURE__ */ r(U.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
ha.displayName = U.Separator.displayName;
...
function me({
  ...
  const [x, k] = B(!1);
  return /* @__PURE__ */ d(hn, { open: x, onOpenChange: k, ...S, children: [
    ...
    /* @__PURE__ */ r(
      Ee,
      {
        ...
        children: /* @__PURE__ */ d(Me, { children: [
          ...
          /* @__PURE__ */ r(Ve, { children: e.map((y) => /* @__PURE__ */ d(
            Be,
            {
              value: i(y),
              onSelect: () => {
    ...
    mn,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(L, { className: "tw-flex tw-items-center", children: a.map((x) => A.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
function va({ table: t }) {
  return /* @__PURE__ */ d(Wt, { children: [
    /* @__PURE__ */ r(Qn, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const yt = X.Root, xa = X.Group, Nt = X.Value, ya = pt(
  ...
  return /* @__PURE__ */ d(
    X.Trigger,
    {
      className: l(ya({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
bt.displayName = X.Trigger.displayName;
...
Na.displayName = X.Label.displayName;
const W = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  X.Item,
  {
    ref: a,
    className: l(
...
ka.displayName = X.Separator.displayName;
function Ca({ table: t }) {
      ...
      /* @__PURE__ */ d(
        yt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(vt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(W, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const kt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function Ta({
  ...
  var x;
  const [i, c] = B([]), [u, m] = B([]), [f, g] = B({}), [h, b] = B({}), S = Ze({
    data: e,
    columns: t,
    getCoreRowModel: tn(),
    ...n && { getPaginationRowModel: Mr() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(va, { table: S }),
    /* @__PURE__ */ d(Qt, { stickyHeader: s, children: [
      /* @__PURE__ */ r(te, { stickyHeader: s, children: S.getHeaderGroups().map((k) => /* @__PURE__ */ r(dt, { children: k.headers.map((y) => /* @__PURE__ */ r(Ft, { children: y.isPlaceholder ? void 0 : Ot(y.column.columnDef.header, y.getContext()) }, y.id)) }, k.id)) }),
      /* @__PURE__ */ r(ee, { children: (x = S.getRowModel().rows) != null && x.length ? S.getRowModel().rows.map((k) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => w(k, S),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((y) => /* @__PURE__ */ r(kt, { children: Ot(y.column.columnDef.cell, y.getContext()) }, y.id))
        },
        k.id
...
function is({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Yt, { size: 15 }) : /* @__PURE__ */ d(Ct, { children: [
...
function Ea({ id: t, versionHistory: e }) {
  ...
  function s(i) {
    const c = new Date(i), u = new Date(o.getTime() - c.getTime()), m = u.getUTCFullYear() - 1970, f = u.getUTCMonth(), g = u.getUTCDate() - 1;
    let h = "";
...
function Ia({
  ...
  const [f, g] = B(!1), h = et(
    (x) => {
      var y;
      const k = (y = t.find((E) => E.label === x)) == null ? void 0 : y.value;
      k && a(
        n.includes(k) ? n.filter((E) => E !== k) : [...n, k]
      );
    },
    [t, n, a]
  ), b = () => w || o, S = Q(() => {
    if (!c) return t;
    const x = t.filter((y) => y.starred).sort((y, E) => y.label.localeCompare(E.label)), k = t.filter((y) => !y.starred).sort((y, E) => {
      const j = n.includes(y.value), tt = n.includes(E.value);
      return j && !tt ? -1 : !j && tt ? 1 : y.label.localeCompare(E.label);
    });
    return [...x, ...k];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ d(hn, { open: f, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Me, { children: [
      ...
      /* @__PURE__ */ d(Ve, { children: [
        /* @__PURE__ */ r(De, { children: s }),
        /* @__PURE__ */ r(bn, { children: S.map((x) => {
          const k = e ? e(x) : void 0;
          return /* @__PURE__ */ d(
            Be,
            {
              value: x.label,
...
function Va({
  ...
  return /* @__PURE__ */ d(Qt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(ee, { children: s.length > 0 && s.map((w) => /* @__PURE__ */ d(
      dt,
      {
        onClick: () => {
          e(w.reference);
        ...
        children: [
          /* @__PURE__ */ r(kt, { children: `${A.bookIdToEnglishName(w.reference.book)} ${w.reference.chapterNum}:${w.reference.verseNum}` }),
...
), Da = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  en.Root,
  {
    ref: o,
...
Da.displayName = en.Root.displayName;
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(br, { className: "tw-ms-2 tw-h-4 tw-w-4" }), fs = (t) => ({
  ...
  return e ? e[1] : "";
}, Oa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", xs = Object.freeze([
  ...
  if (!t) return [];
  const s = [];
  let w = e.book, i = e.chapterNum, c = e.verseNum;
  return Pa(t).forEach((m) => {
    m.startsWith("\\id") && (w = Aa(m), i = 0, c = 0), m.startsWith("\\c") && (i = Ye(m), c = 0), m.startsWith("\\v") && (c = Ye(m), i === 0 && (i = e.chapterNum));
    let f = o.exec(m) ?? void 0;
    for (; f; ) {
      const g = [];
      f.forEach((x) => g.push(x));
      const h = f.index, b = s.find((x) => ye(x.items, g)), S = {
        reference: {
          book: w !== void 0 ? w : "",
          chapterNum: i !== void 0 ? i : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: zr(m, Math.max(0, h - 25), Math.min(h + 25, m.length))
      };
      if (b)
        b.count += 1, b.occurrences.push(S);
      else {
        const x = {
          items: g,
          count: 1,
...
function ys({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), S = st(n, "%webView_inventory_scope_currentBook%"), x = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), y = st(n, "%webView_inventory_filter_text%"), E = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, Et] = B("all"), [v, _] = B(""), [K, O] = B([]), Mt = Q(() => i ? a instanceof RegExp ? ja(i, t, s, w, a) : a(i, t, s, w) : [], [i, a, t, s, w]), ut = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((Y) => {
      const wt = Y.items[0], mt = R.find(
        (xt) => xt.items[0] === wt
      );
      mt ? (mt.count += Y.count, mt.occurrences = mt.occurrences.concat(Y.occurrences)) : R.push({
        items: [wt],
        count: Y.count,
  ...
  }, [j, Mt]), N = Q(() => Xa(ut, ot, v), [ut, ot, v]), z = Q(() => {
    var wt, mt;
    if (!j) return m;
    ...
    for (let xt = 0; xt < R; xt++)
      Y.push(
        Ba(
          ((mt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : mt[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...Y, ...m];
  ...
  ct(() => {
    N.length === 0 ? O([]) : N.length === 1 && O(N[0].items);
  }, [N]);
  const P = (R, Y) => {
    Y.setRowSelection(() => {
      const wt = {};
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d(yt, { onValueChange: (R) => G(R), defaultValue: c, children: [
        /* @__PURE__ */ r(bt, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(vt, { children: [
          /* @__PURE__ */ r(W, { value: "book", children: S }),
          /* @__PURE__ */ r(W, { value: "chapter", children: x }),
          /* @__PURE__ */ r(W, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        _t,
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(L, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? E })
      ] })
    ] }),
...
const Oe = Gt.Provider, Xe = Gt.Root, je = Gt.Trigger, re = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Gt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Rn = p.forwardRef(
  ({
    ...
    const [u, m] = p.useState(t), f = e ?? u, g = p.useCallback(
      (E) => {
        const j = typeof E == "function" ? E(f) : E;
        n ? n(j) : m(j);
      },
      [n, f]
    ), h = p.useCallback(() => g((E) => !E), [g]), b = f ? "expanded" : "collapsed", k = $() === "ltr" ? w : w === "primary" ? "secondary" : "primary", y = p.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Sn.Provider, { value: y, children: /* @__PURE__ */ r(Oe, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ka = pt(
  ...
  ({
    ...
    const c = t ? Rt : "button", { state: u } = ae(), m = /* @__PURE__ */ r(
      c,
      {
        ref: i,
...
function ro({
  ...
  return /* @__PURE__ */ r(
    Tn,
    {
      ...
      children: /* @__PURE__ */ d(zn, { children: [
        /* @__PURE__ */ d(he, { children: [
          /* @__PURE__ */ r(ge, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(En, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(Mn, { children: /* @__PURE__ */ r(
            In,
            {
              onClick: () => u(g),
              isActive: f(g),
...
const lt = "scrBook", ao = "scrRef", gt = "source", oo = "details", so = "Scripture Reference", io = "Scripture Book", Dn = "Type", wo = "Details";
function lo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? A.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === lt ? At(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => At(a.start),
      id: ao,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : At(o.start);
      },
      sortingFn: (a, o) => de(a.original.start, o.original.start),
      enableGrouping: !1
    },
...
function ks({
  ...
  const [c, u] = B([]), [m, f] = B([{ id: lt, desc: !1 }]), [g, h] = B({}), b = Q(
    () => t.flatMap((v) => v.data.map((_) => ({
      ..._,
      source: v.source
    }))),
    [t]
  ...
  ct(() => {
    if (i) {
      const v = x.getSelectedRowModel().rowsById, _ = Object.keys(v);
      if (_.length === 1) {
        const K = b.find((O) => Ue(O) === _[0]) || void 0;
        K && i(K);
      }
    }
  }, [g, b, i, x]);
  const k = o ?? io, y = s ?? Dn, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [lt] },
    ...
    !v.getIsGrouped() && !v.getIsSelected() && v.getToggleSelectedHandler()(_);
  }, ot = (v, _) => v.getIsGrouped() ? "" : l("banded-row", _ % 2 === 0 ? "even" : "odd"), Et = (v, _, K) => {
    if (!((v == null ? void 0 : v.length) === 0 || _.depth < K.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(vt, { position: "item-aligned", children: /* @__PURE__ */ r(xa, { children: E.map((v) => /* @__PURE__ */ r(W, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Qt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(te, { children: x.getHeaderGroups().map((v) => /* @__PURE__ */ r(dt, { children: v.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ft, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ot(_.column.columnDef.header, _.getContext())
        ] }) }, _.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(ee, { children: x.getRowModel().rows.map((v, _) => {
        const K = $();
        return /* @__PURE__ */ r(
          dt,
          {
            ...
            className: l(ot(v, _)),
            onClick: (O) => tt(v, O),
            children: v.getVisibleCells().map((O) => {
              if (!(O.getIsPlaceholder() || O.column.columnDef.enableGrouping && !O.getIsGrouped() && (O.column.columnDef.id !== gt || !n)))
                return /* @__PURE__ */ r(
                  kt,
                  {
                    className: l(
                    ...
                    children: O.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !v.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(Nr, {})),
                          " ",
                          Ot(O.column.columnDef.cell, O.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
function Cs({
  ...
  return /* @__PURE__ */ d(
    yt,
    {
      ...
      children: [
        /* @__PURE__ */ r(bt, { size: o, className: l("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Nt,
          {
            placeholder: w[M(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          vt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(W, { value: `${c}`, children: w[M(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Pn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in i ? /* @__PURE__ */ d(
    Ce,
    {
      ...
      children: [
        i.iconPathBefore && /* @__PURE__ */ r(Ut, { icon: i.iconPathBefore, menuLabel: i.label, leading: !0 }),
        i.label,
        i.iconPathAfter && /* @__PURE__ */ r(Ut, { icon: i.iconPathAfter, menuLabel: i.label })
      ]
    },
  ...
  i.tooltip && /* @__PURE__ */ r(re, { children: i.tooltip })
...
function qe({
  ...
  return /* @__PURE__ */ d(Wt, { variant: s, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(kr, {}) }) }),
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, i]) => typeof i == "object").sort(([, i], [, c]) => typeof i == "boolean" || typeof c == "boolean" ? 0 : i.order - c.order).map(([i], c, u) => /* @__PURE__ */ d(Kn, { children: [
...
function _s({
  ...
  return /* @__PURE__ */ d(
    ...
    {
      className: l(
        "tw-box-border tw-flex tw-w-full tw-flex-row tw-items-center tw-justify-between tw-gap-2 tw-overflow-hidden tw-border tw-px-4 tw-py-2 tw-text-foreground",
        s
      ),
      id: o,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-flex-shrink-0", children: n ? /* @__PURE__ */ r(
          qe,
          {
            commandHandler: t,
            menuData: n,
        ...
        /* @__PURE__ */ r("div", { className: "xs:tw-gap-0.5 tw-flex tw-min-w-0 tw-flex-shrink tw-flex-row tw-items-center tw-justify-start tw-gap-2 tw-overflow-hidden sm:tw-gap-1", children: w }),
        /* @__PURE__ */ r("div", { className: "xs:tw-gap-0.5 tw-flex tw-min-w-0 tw-flex-shrink tw-flex-grow tw-flex-row tw-items-center tw-justify-center tw-gap-2 tw-overflow-hidden sm:tw-gap-1", children: i }),
        /* @__PURE__ */ r("div", { className: "xs:tw-gap-0.5 tw-flex tw-min-w-0 tw-flex-shrink tw-flex-row tw-flex-nowrap tw-items-center tw-justify-end tw-gap-2 tw-overflow-hidden tw-whitespace-nowrap sm:tw-gap-1", children: c }),
        /* @__PURE__ */ r("div", { className: "tw-flex-shrink-0", children: a && /* @__PURE__ */ r(
          qe,
          {
            commandHandler: e,
            menuData: a,
...
An.displayName = q.List.displayName;
const On = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  q.List,
  {
    ref: n,
...
jn.displayName = D.Root.displayName;
...
Fn.displayName = D.Trigger.displayName;
...
Gn.displayName = D.SubTrigger.displayName;
...
$n.displayName = D.SubContent.displayName;
...
Ln.displayName = D.Content.displayName;
...
Yn.displayName = D.Item.displayName;
const ho = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ d(
    D.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(D.ItemIndicator, { children: /* @__PURE__ */ r(St, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
ho.displayName = D.CheckboxItem.displayName;
const go = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    D.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(D.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
go.displayName = D.RadioItem.displayName;
...
fo.displayName = D.Label.displayName;
...
Hn.displayName = D.Separator.displayName;
const Bt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], w) => {
    const i = e.filter((u) => u.group === s).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ d(Xe, { children: [
...
function bo({
  ...
  const o = Z(void 0), s = Z(void 0), w = Z(void 0), i = Z(void 0), c = Z(void 0), u = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (Br(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    var b, S, x, k;
    m.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Bt(s, [g, h]);
        break;
      case "alt+l":
        (S = w.current) == null || S.focus(), Bt(w, [g, h]);
        break;
      case "alt+n":
        (x = i.current) == null || x.focus(), Bt(i, [g, h]);
        break;
      case "alt+h":
        (k = c.current) == null || k.focus(), Bt(c, [g, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(jn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(uo, { children: [
      /* @__PURE__ */ r(Fn, { ref: u(m), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        Ln,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Oe, { children: Un(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Is({
  ...
  const c = vo(
    ...
    o && o(h), a && a([h, ...n.filter((b) => b !== h)]), s && n.find((b) => b === h) && s([...n.filter((b) => b !== h)]), m(!1);
  }, g = (h, b) => {
    var x, k, y, E, j, tt;
    const S = b !== h ? ((k = (x = t[h]) == null ? void 0 : x.uiNames) == null ? void 0 : k[b]) ?? ((E = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : E.en) : void 0;
    return S ? `${(j = t[h]) == null ? void 0 : j.autonym} (${S})` : (tt = t[h]) == null ? void 0 : tt.autonym;
  };
...
const Mo = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Do = p.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ d(
    Pt.Root,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r(Pt.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ r(Pt.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ r(Pt.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
Do.displayName = Pt.Root.displayName;
...
const Ps = q.Root, Po = p.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    q.List,
    {
...
Po.displayName = q.List.displayName;
...
Ao.displayName = q.Trigger.displayName;
...
Oo.displayName = q.Content.displayName;
const As = (t, e) => {
  ct(() => {
    if (!t) return () => {
    };
...
export {
  ...
  l as cn,
  Aa as getBookIdFromUSFM,
  Pa as getLinesFromUSFM,
  Ye as getNumberFromUSFM,
  Oa as getStatusForItem,
  Es as getToolbarOSReservedSpaceClassName,
