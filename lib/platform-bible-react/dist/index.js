...
import { Avatar as so, Select as Zt, Checkbox as $o, Slot as Rr, Tabs as he, Menubar as ye, ContextMenu as At, Progress as Io, Slider as Mr, Switch as Ao } from "radix-ui";
...
function pw(t, e, r) {
  ...
  if (t.key === "ArrowDown" || t.key === "ArrowUp")
    return ge(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue";
  ...
  if (t.key === "Escape")
    return ge(t), r.dismiss(), "ended";
  if (t.key === " ") {
    if (o === "backslash")
      return ge(t), (i = e.shouldSpaceCommit) != null && i.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    ge(t);
    const s = e.filter.toLowerCase(), c = e.items.find((l) => l.marker.toLowerCase() === s);
    return c && r.commitItem(c.marker), r.dismiss(), "ended";
  }
  return t.key === "*" ? (ge(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (r.dismiss(), "ended") : (ge(t), r.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (ge(t), r.dismiss(), "ended") : t.key === "Backspace" || Ci[o].test(t.key) ? (ge(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (o === "selection" && ge(t), r.dismiss(), "ended");
}
function _a(t, e) {
  var r;
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(tw, { children: M.map((z) => /* @__PURE__ */ a(ue, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          fr,
          {
            ...
            style: { zIndex: rr },
            children: t.map((w) => /* @__PURE__ */ a(ue, { value: `${w}`, children: l[To(w)] }, `${w}`))
          }
        )
      ]
    }
...
Oi.displayName = he.List.displayName;
...
$i.displayName = he.Content.displayName;
function uh({
  tabList: t,
  searchValue: e,
  onSearch: r,
