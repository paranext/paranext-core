...
import c, { forwardRef as Ut, createContext as Un, useContext as qn, useCallback as tt, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Jn } from "react";
...
import { ChevronRight as be, Check as St, Circle as ve, X as xe, Search as qe, ChevronsUpDown as Je, FilterIcon as Qn, ChevronDown as qt, ChevronUp as tr, ArrowLeftIcon as er, ChevronLeftIcon as nr, ChevronRightIcon as rr, ArrowRightIcon as ar, LoaderCircle as or, Download as sr, Filter as ir, User as wr, Link as lr, CircleHelp as dr, Star as cr, CircleCheckIcon as pr, CircleXIcon as ur, CircleHelpIcon as mr, ArrowUpIcon as hr, ArrowDownIcon as gr, ArrowUpDownIcon as fr, PanelLeft as br, PanelRight as vr, ScrollText as xr, ChevronLeft as yr, MenuIcon as Nr } from "lucide-react";
import { getChaptersForBook as kr, NumberFormat as Cr, formatBytes as Sr, deepEqual as ye, substring as Rr, formatScrRef as ae, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as E } from "platform-bible-utils";
...
import { useReactTable as We, getFilteredRowModel as Tr, getSortedRowModel as Ze, getPaginationRowModel as _r, getCoreRowModel as Qe, flexRender as Pt, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
const ke = I.Trigger, nn = I.Group, Pr = I.Portal, Ar = I.Sub, Zo = I.RadioGroup;
...
const Gt = c.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const i = $();
...
const Wt = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  I.Label,
  {
    ref: a,
...
Wt.displayName = I.Label.displayName;
const $t = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  I.Separator,
  {
    ref: n,
...
$t.displayName = I.Separator.displayName;
...
var jr = Object.defineProperty, Fr = (t, e, n) => e in t ? jr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, S = (t, e, n) => Fr(t, typeof e != "symbol" ? e + "" : e, n);
const gt = [
  "GEN",
  "EXO",
  "LEV",
...
const H = class T {
  constructor(e, n, a, o) {
    if (S(this, "firstChapter"), S(this, "lastChapter"), S(this, "lastVerse"), S(this, "hasSegmentsDefined"), S(this, "text"), S(this, "BBBCCCVVVS"), S(this, "longHashCode"), S(this, "versification"), S(this, "rtlMark", "‏"), S(this, "_bookNum", 0), S(this, "_chapterNum", 0), S(this, "_verseNum", 0), S(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        const i = e, l = n != null && n instanceof mt ? n : void 0;
   ...
   */
  static fromJSON(e) {
    const { book: n, chapterNum: a, verseNum: o, verse: i, versificationStr: l } = e, s = i || o.toString();
    let p;
    return l && (p = new mt(l)), n ? new T(n, a.toString(), s, p) : new T();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = i[0], i.length > 1)
        try {
          const l = +i[1].trim();
          this.versification = new mt(nt[l]);
        } catch {
    ...
    if (a.length !== 2 || D.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !T.isVerseParseable(a[1]))
      throw new Vt("Invalid reference : " + e);
...
function Qr({
  ...
  const i = Array.from({ length: e }, (s, p) => p + 1), l = tt(
    (s) => {
      o(s);
    },
    [o]
  );
  return /* @__PURE__ */ r("div", { className: w("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"), children: i.map((s) => /* @__PURE__ */ r(
    "div",
    {
      className: w(
...
const ze = D.allBookIds.filter((t) => !D.isObsolete(D.bookIdToNumber(t))), ta = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Ye = ["OT", "NT", "DC"], ea = 96, na = [
  /^(\w+)$/i,
...
], Dt = (t) => kr(D.bookIdToNumber(t));
function ra() {
  return ze.map((e) => D.bookIdToEnglishName(e));
}
function aa(t) {
...
function oa(t) {
  ...
  if (aa(e))
    return ze.find((a) => D.bookIdToEnglishName(a) === e);
}
function ts({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = $(), [i, l] = B(""), [s, p] = B(t.book), [u, m] = B(t.chapterNum ?? 0), [f, g] = B(t.book), [h, v] = B(!1), [x, y] = B(h), N = Z(void 0), k = Z(void 0), P = Z(void 0), j = tt(
    (C) => {
      const z = a ? a() : ze;
      return {
    ...
    na.forEach((C) => {
      const z = i.match(C);
      if (z) {
        const [O, G = void 0, F = void 0] = z.slice(1), It = oa(O);
    ...
    (C) => {
      h ? (C.key === "ArrowDown" || C.key === "ArrowUp") && (typeof P < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      P.current !== null ? P.current.focus() : typeof k < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
  ...
  return ct(() => {
    ...
    const C = setTimeout(() => {
      if (x && k.current && P.current) {
        const O = P.current.offsetTop - ea;
  ...
  }, [x]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ d(Kt, { modal: !1, open: h, onOpenChange: Et, children: [
      ...
      Gt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((C, z) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Wt, { className: "tw-font-semibold tw-text-foreground/80", children: ta[C] }),
            ...
            Ye.length - 1 !== z ? /* @__PURE__ */ r($t, {}) : void 0
          ] }, C);
        }) })
      }
    )
...
const sa = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? Rt : "button", { className: w(sa({ variant: e, size: n, className: t })), ref: i, ...o })
);
M.displayName = "Button";
const ia = vt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ke.Root, { ref: n, className: w("pr-twp", ia(), t), ...e }));
...
un.displayName = At.Root.displayName;
const ue = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  At.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(At.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ve, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ue.displayName = At.Item.displayName;
const mn = Xt.Root, hn = Xt.Trigger, Ee = c.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const i = $();
...
const wa = rt.Portal, gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: w(
...
pa.displayName = U.Separator.displayName;
      ...
      M,
      {
        ...
        children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: w("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: i ? s(i) : u })
          ] }),
...
function ns({
  ...
  const m = se(u, "%webView_bookSelector_currentBook%"), f = se(u, "%webView_bookSelector_choose%"), g = se(u, "%webView_bookSelector_chooseBooks%"), [h, v] = B(
    "current book"
    /* CURRENT_BOOK */
  ), x = (y) => {
    v(y), t(y);
...
function ga({ table: t }) {
  return /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(Zn, { asChild: !0, children: /* @__PURE__ */ d(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Qn, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ d(Gt, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r(Wt, { children: "Toggle columns" }),
      /* @__PURE__ */ r($t, {}),
...
const yt = X.Root, fa = X.Group, Nt = X.Value, ft = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = $();
  return /* @__PURE__ */ d(
    X.Trigger,
    {
...
ba.displayName = X.Label.displayName;
...
va.displayName = X.Separator.displayName;
function xa({ table: t }) {
...
const Zt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: w("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const Qt = c.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: w(
...
const te = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: w("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function ka({
  ...
  var y;
  const [s, p] = B([]), [u, m] = B([]), [f, g] = B({}), [h, v] = B({}), x = We({
    data: e,
    columns: t,
    getCoreRowModel: Qe(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ga, { table: x }),
    /* @__PURE__ */ d(Zt, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Qt, { stickyHeader: i, children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(dt, { children: N.headers.map((k) => /* @__PURE__ */ r(jt, { children: k.isPlaceholder ? void 0 : Pt(k.column.columnDef.header, k.getContext()) }, k.id)) }, N.id)) }),
      /* @__PURE__ */ r(te, { children: (y = x.getRowModel().rows) != null && y.length ? x.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        dt,
        {
          onClick: () => l(N, x),
          "data-state": N.getIsSelected() && "selected",
          children: N.getVisibleCells().map((k) => /* @__PURE__ */ r(kt, { children: Pt(k.column.columnDef.cell, k.getContext()) }, k.id))
        },
        N.id
    ...
    n && a && /* @__PURE__ */ r(xa, { table: x })
  ] });
}
const Yt = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(or, { size: 35, className: w("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      children: t ? /* @__PURE__ */ r(Yt, { size: 15 }) : /* @__PURE__ */ d(Ct, { children: [
        /* @__PURE__ */ r(sr, { size: 25, className: w("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function is({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: w("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Mr, { options: o, children: e }) });
}
const Ca = Ut((t, e) => /* @__PURE__ */ d(
  M,
  {
    ref: e,
...
function ws({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Kt, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(Ca, {}) }),
    /* @__PURE__ */ r(Gt, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(Wt, { children: n.label }),
...
function ds({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  ...
  }).format(Object.values(n).reduce((s, p) => s + p, 0)), l = () => {
...
function Ra({ id: t, versionHistory: e }) {
  ...
  return /* @__PURE__ */ d("div", { id: t, children: [
    ...
    /* @__PURE__ */ r("ul", { className: "tw-list-disc tw-pl-5 tw-pr-4 tw-text-xs tw-text-gray-600", children: (n ? l : l.slice(0, 5)).map((s) => /* @__PURE__ */ d("div", { className: "tw-mt-3 tw-flex tw-justify-between", children: [
...
const Ta = vt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: w("pr-twp", Ta({ variant: e }), t), ...n })
);
...
function _a({
  ...
  const [m, f] = B(!1), g = tt(
    ...
    const x = t.filter((N) => N.starred).sort((N, k) => N.label.localeCompare(k.label)), y = t.filter((N) => !N.starred).sort((N, k) => {
      const P = n.includes(N.value), j = n.includes(k.value);
      return P && !j ? -1 : !P && j ? 1 : N.label.localeCompare(k.label);
    });
    return [...x, ...y];
  }, [t, n, s]);
          ...
          return /* @__PURE__ */ d(
            Be,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: x.starred && /* @__PURE__ */ r(cr, { className: "tw-h-4 tw-w-4" }) }),
...
function za({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], i = Q(() => {
    const l = [];
    return t.forEach((s) => {
      l.some((p) => ye(p, s)) || l.push(s);
    }), l;
  }, [t]);
  return /* @__PURE__ */ d(Zt, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Qt, { stickyHeader: !0, children: /* @__PURE__ */ d(dt, { children: [
      /* @__PURE__ */ r(jt, { children: a }),
      /* @__PURE__ */ r(jt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(te, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      dt,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          /* @__PURE__ */ r(kt, { children: `${D.bookIdToEnglishName(l.reference.book)} ${l.reference.chapterNum}:${l.reference.verseNum}` }),
...
const Nn = c.createContext({
  size: "default",
  variant: "default"
}), kn = c.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, i) => {
  const l = $();
  return /* @__PURE__ */ r(
    Jt.Root,
    {
...
kn.displayName = Jt.Root.displayName;
...
const ee = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), us = (t) => ({
  accessorKey: "item",
  ...
  return Ia(t).forEach((m) => {
    m.startsWith("\\id") && (l = Va(m), s = 0, p = 0), m.startsWith("\\c") && (s = Le(m), p = 0), m.startsWith("\\v") && (p = Le(m), s === 0 && (s = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const h = f.index, v = i.find((y) => ye(y.items, g)), x = {
        ...
        text: Rr(m, Math.max(0, h - 25), Math.min(h + 25, m.length))
      };
      if (v)
...
function fs({
  ...
  const f = ot(n, "%webView_inventory_all%"), g = ot(n, "%webView_inventory_approved%"), h = ot(n, "%webView_inventory_unapproved%"), v = ot(n, "%webView_inventory_unknown%"), x = ot(n, "%webView_inventory_scope_currentBook%"), y = ot(n, "%webView_inventory_scope_chapter%"), N = ot(n, "%webView_inventory_scope_verse%"), k = ot(n, "%webView_inventory_filter_text%"), P = ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, it] = B(!1), [at, Et] = B("all"), [b, _] = B(""), [K, A] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Oa(s, t, i, l, a) : a(s, t, i, l) : [], [s, a, t, i, l]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(Y, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? P })
      ] })
    ] }),
...
const Ae = Ft.Provider, Xe = Ft.Root, je = Ft.Trigger, ne = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Ft.Content,
  {
    ref: a,
    sideOffset: e,
...
ne.displayName = Ft.Content.displayName;
const Pa = "16rem", Aa = "3rem", Cn = c.createContext(void 0);
function re() {
...
const Sn = c.forwardRef(
  ({
    ...
    const [u, m] = c.useState(t), f = e ?? u, g = c.useCallback(
      (P) => {
        const j = typeof P == "function" ? P(f) : P;
        n ? n(j) : m(j);
      },
      [n, f]
    ), h = c.useCallback(() => g((P) => !P), [g]), v = f ? "expanded" : "collapsed", N = $() === "ltr" ? l : l === "primary" ? "secondary" : "primary", k = c.useMemo(
      () => ({
        state: v,
        open: f,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: k, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Rn = c.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, i) => {
  const l = re();
...
const Ha = vt(
  ...
  ({
    ...
    const p = t ? Rt : "button", { state: u } = re(), m = /* @__PURE__ */ r(
      p,
      {
        ref: s,
        ...
        "data-size": a,
        "data-active": e,
        className: w(Ha({ variant: n, size: a }), i),
        ...l
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(ne, { side: "right", align: "center", hidden: u !== "collapsed", ...o })
    ] })) : m;
  }
);
    ...
    Rn,
    {
      ...
      children: /* @__PURE__ */ d(_n, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(zn, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(En, { children: /* @__PURE__ */ r(
            Mn,
            {
              onClick: () => u(g),
              isActive: f(g),
...
const lt = "scrBook", to = "scrRef", ht = "source", eo = "details", no = "Scripture Reference", ro = "Scripture Book", Vn = "Type", ao = "Details";
function oo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? D.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === lt ? ae(o.start) : void 0;
      },
    ...
    {
      accessorFn: (a) => ae(a.start),
      id: to,
      header: void 0,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? void 0 : ae(o.start);
      },
      sortingFn: (a, o) => de(a.original.start, o.original.start),
      enableGrouping: !1
    },
...
function vs({
  ...
  const [p, u] = B([]), [m, f] = B([{ id: lt, desc: !1 }]), [g, h] = B({}), v = Q(
  ...
  ct(() => {
    if (s) {
      const b = y.getSelectedRowModel().rowsById, _ = Object.keys(b);
      if (_.length === 1) {
        const K = v.find((A) => Ue(A) === _[0]) || void 0;
        K && s(K);
      }
    }
  }, [g, v, s, y]);
  const N = o ?? ro, k = i ?? Vn, P = [
  ...
  }, at = (b, _) => b.getIsGrouped() ? "" : w("banded-row", _ % 2 === 0 ? "even" : "odd"), Et = (b, _, K) => {
    if (!((b == null ? void 0 : b.length) === 0 || _.depth < K.column.getGroupedIndex())) {
      if (_.getIsGrouped())
        switch (_.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: P.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Zt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Qt, { children: y.getHeaderGroups().map((b) => /* @__PURE__ */ r(dt, { children: b.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(jt, { colSpan: _.colSpan, className: "top-0 tw-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(te, { children: y.getRowModel().rows.map((b, _) => {
        const K = $();
        return /* @__PURE__ */ r(
          dt,
          {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !b.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(yr, {})),
                          " ",
                          Pt(A.column.columnDef.cell, A.getContext()),
                          " (",
                          b.subRows.length,
                          ")"
                        ]
...
function xs({
  ...
  return /* @__PURE__ */ d(
    yt,
    {
      ...
      children: [
        /* @__PURE__ */ r(ft, { className: w("pr-twp tw-w-auto", o), children: /* @__PURE__ */ r(
          Nt,
          {
            placeholder: i[E(e)] ?? e
          }
...
function Ht({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const Bn = (t, e, n, a) => n ? Object.entries(t).filter(
  ([i, l]) => "column" in l && l.column === n || i === n
).sort(([, i], [, l]) => i.order - l.order).flatMap(([i]) => e.filter((s) => s.group === i).sort((s, p) => s.order - p.order).map((s) => /* @__PURE__ */ d(Xe, { children: [
  /* @__PURE__ */ r(je, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    Ce,
    {
      ...
      children: [
        s.iconPathBefore && /* @__PURE__ */ r(Ht, { icon: s.iconPathBefore, menuLabel: s.label, leading: !0 }),
        s.label,
        s.iconPathAfter && /* @__PURE__ */ r(Ht, { icon: s.iconPathAfter, menuLabel: s.label })
      ]
    },
    `dropdown-menu-item-${s.label}-${s.command}`
  ) : /* @__PURE__ */ d(Ar, { children: [
    /* @__PURE__ */ r(rn, { children: s.label }),
    /* @__PURE__ */ r(Pr, { children: /* @__PURE__ */ r(an, { children: Bn(
      t,
      e,
      Dn(t, s.id),
      a
  ...
  s.tooltip && /* @__PURE__ */ r(ne, { children: s.tooltip })
...
function Cs({
  ...
  return /* @__PURE__ */ d(Kt, { variant: i, children: [
    /* @__PURE__ */ r(
      ke,
      {
        "aria-label": n,
        className: w("tw-cursor-pointer", o),
        asChild: !0,
        id: l,
        children: a ?? /* @__PURE__ */ r(Nr, {})
      }
    ),
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(Jn, { children: [
      /* @__PURE__ */ r(nn, { children: /* @__PURE__ */ r(Ae, { children: Bn(e.groups, e.items, s, t) }) }),
      p < u.length - 1 && /* @__PURE__ */ r($t, {})
    ] }, s)) })
  ] });
}
...
function Ss({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(On, { children: [
      /* @__PURE__ */ r(Pn, { children: t.map((l) => /* @__PURE__ */ r(io, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(An, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function wo({ ...t }) {
...
Xn.displayName = V.Root.displayName;
...
Fn.displayName = V.SubTrigger.displayName;
...
Gn.displayName = V.SubContent.displayName;
const $n = c.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, i) => {
  const l = et();
...
$n.displayName = V.Content.displayName;
    ...
    const s = e.filter((u) => u.group === i).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ d(Xe, { children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: "command" in u ? /* @__PURE__ */ d(
        Yn,
        {
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ r(Ht, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }),
            u.label,
            u.iconPathAfter && /* @__PURE__ */ r(Ht, { icon: u.iconPathAfter, menuLabel: u.label })
          ]
        },
      ...
      u.tooltip && /* @__PURE__ */ r(ne, { children: u.tooltip })
    ] }, `tooltip-${u.label}-${"command" in u ? u.command : u.id}`)), p = [...s];
    return s.length > 0 && l < o.length - 1 && p.push(/* @__PURE__ */ r(Ln, {}, `separator-${i}`)), p;
  });
};
function mo({
  menuData: t,
  ...
  const o = Z(void 0), i = Z(void 0), l = Z(void 0), s = Z(void 0), p = Z(void 0), u = (m) => {
    switch (m) {
      case "platform.app":
        return i;
  ...
  if (Ir(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    var v, x, y, N;
    m.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = l.current) == null || x.focus(), Bt(l, [g, h]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(Xn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ d(wo, { children: [
      /* @__PURE__ */ r(jn, { ref: u(m), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        $n,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Ae, { children: Hn(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function _s({
  ...
  const p = ho(
    ...
    var y, N, k, P, j, it;
    const x = v !== h ? ((N = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((P = (k = t[h]) == null ? void 0 : k.uiNames) == null ? void 0 : P.en) : void 0;
    return x ? `${(j = t[h]) == null ? void 0 : j.autonym} (${x})` : (it = t[h]) == null ? void 0 : it.autonym;
  };
  return /* @__PURE__ */ d("div", { className: w("pr-twp tw-max-w-sm", s), children: [
    /* @__PURE__ */ d(
      yt,
      {
        name: "uiLanguage",
...
), bo = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: w(fo({ variant: e }), t), ...n }));
...
const xo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: w("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
yo.displayName = Tt.Root.displayName;
...
No.displayName = Tt.Image.displayName;
...
ko.displayName = Tt.Fallback.displayName;
...
const To = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: w("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
