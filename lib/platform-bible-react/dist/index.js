...
function Pm({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Me(""), [o, i] = Me(
    ...
    !O && document.activeElement === v.current ? f(!0) : f(O);
  }, []), w = Se(
    (O, N, _, V) => {
      if (O && (!_ || Kt(O) === -1)) {
        i(o !== O ? O : "");
      ...
      l(
        ue.bookNumberToId(e.bookNum) !== O ? 1 : e.chapterNum
      ), i(o !== O ? O : ""), t({
    ...
    (O) => {
      d ? (O.key === "ArrowDown" || O.key === "ArrowUp") && (typeof m < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      m.current !== null ? m.current.focus() : typeof g < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      g.current !== null && g.current.focus(), O.preventDefault()) : f(!0);
    },
    [d]
  ), B = (O) => {
    const { key: N } = O;
    ...
    if (c === o) {
      ...
      s + _ <= 0 || s + _ > Kt(c) ? l(0) : (l(s + _), O.preventDefault());
    }
  };
  return fn(() => {
    ...
    /* @__PURE__ */ de(
      Ai,
      {
        ...
        children: [
          ...
          sl.map(
            (O) => E(O).length > 0 && /* @__PURE__ */ de("div", { children: [
              /* @__PURE__ */ T(Br, { className: "pr-font-semibold pr-text-slate-700", children: al[O] }),
              E(O).map((N) => /* @__PURE__ */ T("div", { children: /* @__PURE__ */ T(
                ol,
                {
                  bookId: N,
              ...
              O === "OT" || O === "NT" ? /* @__PURE__ */ T(ji, {}) : void 0
            ] }, O)
          )
        ]
      }
...
function vl() {
  return No || (No = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var h = c, C = u, P = l, B = s, j = t, O = d, N = r, _ = v, V = b, F = n, D = i, M = o, L = f, Q = !1;
    function Z(I) {
      return Q || (Q = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), S(I) || w(I) === c;
    }
    function S(I) {
      return w(I) === u;
    }
    ...
    function P(S) {
      ...
      function A(U, K, z, H, q) {
        for (var G = U[K], W = 0; W < S.length; W++)
          if (v(G, S[W]))
            return null;
        var X = JSON.stringify(S, function(ne, I) {
          var J = L(I);
...
function Ml() {
  return Bo || (Bo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var C = s, P = i, B = e, j = c, O = n, N = p, _ = f, V = t, F = o, D = r, M = u, L = d, Q = !1, Z = !1;
    function S(R) {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (B = i(v.current)), B.length > 0) {
        var j, O;
        const N = !!((j = m.current) != null && j.shiftKey && ((O = m.current) == null ? void 0 : O.key) === "Tab"), _ = B[0], V = B[B.length - 1];
...
function dn(e, t) {
  ...
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Rc : l, u = n.rootBoundary, d = u === void 0 ? sa : u, f = n.elementContext, p = f === void 0 ? Xt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, E = pa(typeof m != "number" ? m : fa(m, gn)), $ = p === Xt ? $c : Xt, y = e.rects.popper, w = e.elements[v ? $ : p], h = uu(bt(w) ? w : w.contextElement || at(e.elements.popper), c, d, s), C = jt(e.elements.reference), P = ha({
    ...
    strategy: "absolute",
    placement: o
  }), B = Nr(Object.assign({}, y, P)), j = p === Xt ? B : C, O = {
...
function fu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, E = Ue(m), $ = E === m, y = c || ($ || !v ? [Rn(m)] : pu(m)), w = [m].concat(y).reduce(function(z, H) {
      ...
      var N = w[O], _ = Ue(N), V = Bt(N) === At, F = [Ce, Fe].indexOf(_) >= 0, D = F ? "width" : "height", M = dn(t, {
        placement: N,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function Tu(e) {
  ...
  if (C) {
    if (i) {
      var V, F = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, M = w === "y" ? "height" : "width", L = C[w], Q = L + m[F], Z = L - m[D], S = b ? -B[M] / 2 : 0, A = $ === At ? P[M] : B[M], U = $ === At ? -B[M] : -P[M], K = t.elements.arrow, z = b && K ? Ur(K) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : da(), q = H[F], G = H[D], W = on(0, P[M], z[M]), X = y ? P[M] / 2 - S - W - q - O.mainAxis : A - W - q - O.mainAxis, Y = y ? -P[M] / 2 + S + W + G + O.mainAxis : U + W + G + O.mainAxis, ne = t.elements.arrow && bn(t.elements.arrow), I = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (V = N == null ? void 0 : N[w]) != null ? V : 0, R = L + X - J - I, re = L + Y - J, ve = on(b ? jn(Q, R) : Q, L, b ? ft(Z, re) : Z);
      C[w] = ve, _[w] = ve - L;
    }
    if (l) {
      var Te, he = w === "x" ? Ce : Pe, lt = w === "x" ? Fe : Ve, ke = C[h], Ge = h === "y" ? "height" : "width", Ne = ke + m[he], Ke = ke - m[lt], ye = [Ce, Pe].indexOf(E) !== -1, yt = (Te = N == null ? void 0 : N[h]) != null ? Te : 0, ct = ye ? Ne : ke - P[Ge] - B[Ge] - yt + O.altAxis, zt = ye ? ke + P[Ge] + B[Ge] - yt - O.altAxis : Ke, xn = b && ye ? Gc(ct, ke, zt) : on(b ? ct : Ne, ke, b ? zt : Ke);
      C[h] = xn, _[h] = xn - ke;
    }
    t.modifiersData[r] = _;
  }
...
const Vu = () => et({
  ...
  const C = Lu(d, s), [P, B] = x.useState(C), [j, O] = x.useState(Bn(o));
  x.useEffect(() => {
...
`));
  ...
  if (i)
    ...
    const O = Bn(r);
    P = O && qn(O) ? xe(O).body : xe(null).body;
  }
...
function Jd(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const $ = Ms(s, k({
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${He(u || "")}`), N === void 0 && (N = `Styled(${Al(s)})`), O.displayName = N;
      }
...
const Wp = {
  ...
  const {
    ...
    let S;
    g === "auto" ? (S = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = S) : S = L, D.style.transition = [w.transitions.create("opacity", {
      duration: S,
      delay: Q
...
`));
  ...
  const nr = Gi(S), Ut = x.useRef(), En = ln(() => {
...
`));
  const Qa = x.useMemo(() => {
    ...
    touch: Ne.current
  }), ar = Qp(qt), bo = (r = (o = Y.popper) != null ? o : j.Popper) != null ? r : ef, vo = (i = (s = (l = Y.transition) != null ? l : j.Transition) != null ? s : I) != null ? i : Ir, yo = (c = (u = Y.tooltip) != null ? u : j.Tooltip) != null ? c : tf, wo = (d = (f = Y.arrow) != null ? f : j.Arrow) != null ? d : nf, es = en(bo, k({}, W, (p = X.popper) != null ? p : O.popper, {
    className: we(ar.popper, W == null ? void 0 : W.className, (b = (v = X.popper) != null ? v : O.popper) == null ? void 0 : b.className)
  }), qt), ts = en(vo, k({}, J, (g = X.transition) != null ? g : O.transition), qt), ns = en(yo, k({}, (m = X.tooltip) != null ? m : O.tooltip, {
    className: we(ar.tooltip, (E = ($ = X.tooltip) != null ? $ : O.tooltip) == null ? void 0 : E.className)
  }), qt), rs = en(wo, k({}, (y = X.arrow) != null ? y : O.arrow, {
    className: we(ar.arrow, (w = (h = X.arrow) != null ? h : O.arrow) == null ? void 0 : w.className)
  }), qt);
  return /* @__PURE__ */ de(x.Fragment, {
...
const Lf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Ff = (e) => {
  ...
  return !O && !_ && (!K || U) ? null : /* @__PURE__ */ T(cn, {
    ref: S,
    container: g,
    disablePortal: C,
...
const Qf = (e) => {
  ...
  } = s, O = ce(s.TransitionProps, Yf), N = ce(s, Jf), _ = (r = w == null ? void 0 : w.paper) != null ? r : $, V = x.useRef(), F = Le(V, _.ref), D = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
...
`)), m !== null && he < m) {
  ...
  }, [c, f, L, Q, m]), [S, A] = x.useState(E), U = x.useCallback(() => {
    const J = V.current;
    if (!J)
      return;
    const R = Z(J);
...
const rm = ["onEntering"], om = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], im = {
  ...
  const i = tt({
    ...
    TransitionProps: w,
    variant: E
  }), j = sm(B), O = s && !u && p, N = x.useRef(null), _ = (Z, S) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || F === -1) && (F = S));
  });
