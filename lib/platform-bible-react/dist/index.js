import al, { jsx as s, jsxs as N, Fragment as Zt } from "react/jsx-runtime";
import * as B from "react";
import E, { forwardRef as lr, useCallback as Et, useState as ut, useRef as ve, useEffect as le, useLayoutEffect as ma, useMemo as Rt } from "react";
...
import { ChevronRight as go, Check as Je, Circle as bo, X as vo, Search as fi, ChevronsUpDown as mi, FilterIcon as cl, ChevronDown as cr, ChevronUp as dl, ArrowLeftIcon as pl, ChevronLeftIcon as ul, ChevronRightIcon as wl, ArrowRightIcon as fl, CircleCheckIcon as ml, CircleXIcon as hl, CircleHelpIcon as gl, ArrowUpIcon as bl, ArrowDownIcon as vl, ArrowUpDownIcon as yl, Star as xl, PanelLeft as Nl, PanelRight as kl, ScrollText as El, ChevronLeft as Sl, LoaderCircle as Tl, Download as Cl, Filter as Rl, User as Ol, Link as _l, CircleHelp as Pl } from "lucide-react";
import { getChaptersForBook as Il, deepEqual as yo, substring as $l, formatScrRef as Br, compareScrRefs as eo, scrRefToBBBCCCVVV as Vr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Ml, formatBytes as Al } from "platform-bible-utils";
...
import { useReactTable as gi, getFilteredRowModel as Dl, getSortedRowModel as bi, getPaginationRowModel as jl, getCoreRowModel as vi, flexRender as gn, getGroupedRowModel as Bl, getExpandedRowModel as Vl } from "@tanstack/react-table";
...
import zl, { ThemeContext as Fl, internal_processStyles as Ll } from "@mui/styled-engine";
import { MenuItem as Gl, ListItemText as Ul, ListItemIcon as Ni, Menu as Xl, Grid as ki, List as Yl, IconButton as Ei, Drawer as Hl } from "@mui/material";
...
const Zl = lr(
  ({
    ...
    className: o,
    ...a
  }, i) => /* @__PURE__ */ s("div", { className: "tw-relative", children: /* @__PURE__ */ s(
    Qe,
    {
      ...a,
      type: "text",
...
const xo = ft.Root, Si = ft.Trigger, tc = ft.Group, Hm = ft.Portal, qm = ft.Sub, Wm = ft.RadioGroup, ec = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
    ...
    children: [
      n,
      /* @__PURE__ */ s(go, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
ec.displayName = ft.SubTrigger.displayName;
const nc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.SubContent,
  {
    ref: n,
    className: y(
...
const No = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ N(
  ft.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ s(ft.ItemIndicator, { children: /* @__PURE__ */ s(Je, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
...
const Ci = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  ft.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ s(ft.ItemIndicator, { children: /* @__PURE__ */ s(bo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Ci.displayName = ft.RadioItem.displayName;
const ur = E.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  ft.Label,
  {
    ref: r,
...
const wr = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.Separator,
  {
    ref: n,
...
var oc = Object.defineProperty, ac = (t, e, n) => e in t ? oc(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, nt = (t, e, n) => ac(t, typeof e != "symbol" ? e + "" : e, n);
const Ne = [
  "GEN",
  "EXO",
  "LEV",
...
nt(Mt, "Original", new Mt(Ht.Original)), nt(Mt, "Septuagint", new Mt(Ht.Septuagint)), nt(Mt, "Vulgate", new Mt(Ht.Vulgate)), nt(Mt, "English", new Mt(Ht.English)), nt(Mt, "RussianProtestant", new Mt(Ht.RussianProtestant)), nt(Mt, "RussianOrthodox", new Mt(Ht.RussianOrthodox));
let fe = Mt;
function ga(t, e) {
  const n = e[0];
...
const Ct = class ot {
  constructor(e, n, r, o) {
    if (nt(this, "firstChapter"), nt(this, "lastChapter"), nt(this, "lastVerse"), nt(this, "hasSegmentsDefined"), nt(this, "text"), nt(this, "BBBCCCVVVS"), nt(this, "longHashCode"), nt(this, "versification"), nt(this, "rtlMark", "‏"), nt(this, "_bookNum", 0), nt(this, "_chapterNum", 0), nt(this, "_verseNum", 0), nt(this, "_verse"), r == null && o == null)
      if (e != null && typeof e == "string") {
        const a = e, i = n != null && n instanceof fe ? n : void 0;
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new fe(i)), n ? new ot(n, r.toString(), l, c) : new ot();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = a[0], a.length > 1)
        try {
          const i = +a[1].trim();
          this.versification = new fe(Ht[i]);
        } catch {
...
function gc({
  ...
  return /* @__PURE__ */ s("div", { className: y("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"), children: a.map((l) => /* @__PURE__ */ s(
    "div",
    {
      className: y(
...
const To = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), bc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ba = ["OT", "NT", "DC"], vc = 96, yc = [
  /^(\w+)$/i,
...
function Jm({
  ...
  const o = Nt(), [a, i] = ut(""), [l, c] = ut(
    at.bookNumberToId(t.bookNum)
  ), [d, p] = ut(t.chapterNum ?? 0), [f, w] = ut(
    at.bookNumberToId(t.bookNum)
  ), [h, b] = ut(!1), [m, g] = ut(h), k = ve(void 0), T = ve(void 0), C = ve(void 0), S = Et(
    (j) => {
      const M = r ? r() : To;
      return {
    ...
    yc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, G = void 0, H = void 0] = M.slice(1), rt = kc(A);
  ...
  return le(() => {
    ...
    const j = setTimeout(() => {
      if (m && T.current && C.current) {
        const A = C.current.offsetTop - vc;
  ...
  }, [m]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ N(xo, { modal: !1, open: h, onOpenChange: F, children: [
    ...
    /* @__PURE__ */ s(
      pr,
      {
        ...
        ref: T,
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: ba.map((j, M) => {
          const A = S(j);
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ s(ur, { className: "tw-font-semibold tw-text-foreground/80", children: bc[j] }),
            A.map((G) => /* @__PURE__ */ s("div", { children: /* @__PURE__ */ s(
              hc,
              {
                bookId: G,
            ...
            ba.length - 1 !== M ? /* @__PURE__ */ s(wr, {}) : void 0
          ] }, j);
        }) })
      }
    )
...
const Ec = Re(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? Ze : "button", { className: y(Ec({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Sc = Re(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Dt = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(hi.Root, { ref: n, className: y("pr-twp", Sc(), t), ...e }));
...
const oo = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  xn.Item,
  {
    ref: n,
    className: y(
    ...
    ...e,
    children: /* @__PURE__ */ s(xn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(bo, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
oo.displayName = xn.Item.displayName;
const Ai = Nn.Root, Di = Nn.Trigger, Co = E.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = Nt();
  return /* @__PURE__ */ s(Nn.Portal, { children: /* @__PURE__ */ s(
    Nn.Content,
    {
      ref: o,
      align: e,
...
const Tc = Wt.Portal, ji = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Overlay,
  {
    ref: n,
    className: y(
...
ji.displayName = Wt.Overlay.displayName;
const Cc = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(Tc, { children: [
    /* @__PURE__ */ s(ji, {}),
    /* @__PURE__ */ N(
      Wt.Content,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ N(
            Wt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ s(vo, { className: "tw-h-4 tw-w-4" }),
...
Cc.displayName = Wt.Content.displayName;
const Rc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Title,
  {
    ref: n,
...
const Oc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Wt.Description,
  {
    ref: n,
...
Oc.displayName = Wt.Description.displayName;
const Ro = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt,
  {
    ref: n,
    className: y(
...
const Oo = E.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ s(fi, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ s(
      Pt.Input,
      {
        ref: n,
...
const _o = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.List,
  {
    ref: n,
...
const Po = E.forwardRef((t, e) => /* @__PURE__ */ s(Pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Po.displayName = Pt.Empty.displayName;
const Bi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Group,
  {
    ref: n,
    className: y(
...
const _c = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Separator,
  {
    ref: n,
...
_c.displayName = Pt.Separator.displayName;
const Io = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Item,
  {
    ref: n,
    className: y(
...
function ao({
  ...
  return /* @__PURE__ */ N(Ai, { open: g, onOpenChange: k, ...m, children: [
    /* @__PURE__ */ s(Di, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: w,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ s(mi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(
      Co,
      {
        ...
        children: /* @__PURE__ */ N(Ro, { children: [
          /* @__PURE__ */ s(Oo, { placeholder: p, className: "tw-text-inherit" }),
          /* @__PURE__ */ s(Po, { children: f }),
          /* @__PURE__ */ s(_o, { children: e.map((T) => /* @__PURE__ */ N(
            Io,
            {
              value: l(T),
              onSelect: () => {
...
function Ic({
  ...
  return /* @__PURE__ */ N(Zt, { children: [
    /* @__PURE__ */ s(Dt, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ s(
      ao,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ s(Dt, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ s(
      ao,
      {
        isDisabled: o,
...
var $c = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))($c || {});
...
function Qm({
  ...
  const p = zr(d, "%webView_bookSelector_currentBook%"), f = zr(d, "%webView_bookSelector_choose%"), w = zr(d, "%webView_bookSelector_chooseBooks%"), [h, b] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), m = (g) => {
    b(g), t(g);
      ...
      children: /* @__PURE__ */ N("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Dt, { className: "tw-ms-1", children: p })
          ] }),
          /* @__PURE__ */ s(Dt, { className: "tw-flex tw-items-center", children: e }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(Dt, { className: "tw-ms-1", children: w })
          ] }),
          /* @__PURE__ */ s(Dt, { className: "tw-flex tw-items-center", children: r.map((g) => at.bookIdToEnglishName(g)).join(", ") }),
          /* @__PURE__ */ s(
            wt,
            {
...
function Mc({ table: t }) {
  return /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ s(ll, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ s(cl, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ N(pr, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ s(ur, { children: "Toggle columns" }),
      /* @__PURE__ */ s(wr, {}),
...
const Le = vt.Root, Ac = vt.Group, Ge = vt.Value, ke = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(
    vt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ s(vt.Icon, { asChild: !0, children: /* @__PURE__ */ s(cr, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
ke.displayName = vt.Trigger.displayName;
const Vi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.ScrollUpButton,
  {
    ref: n,
    className: y("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ s(dl, { className: "tw-h-4 tw-w-4" })
  }
));
Vi.displayName = vt.ScrollUpButton.displayName;
const zi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.ScrollDownButton,
  {
    ref: n,
    className: y("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ s(cr, { className: "tw-h-4 tw-w-4" })
  }
));
zi.displayName = vt.ScrollDownButton.displayName;
const Ee = E.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => {
  const a = Nt();
  return /* @__PURE__ */ s(vt.Portal, { children: /* @__PURE__ */ N(
    vt.Content,
    {
      ref: o,
      className: y(
...
const Dc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Label,
  {
    ref: n,
...
Dc.displayName = vt.Label.displayName;
const Vt = E.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  vt.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(vt.ItemIndicator, { children: /* @__PURE__ */ s(Je, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ s(vt.ItemText, { children: e })
    ]
  }
));
Vt.displayName = vt.Item.displayName;
const jc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Separator,
  {
    ref: n,
    className: y("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
jc.displayName = vt.Separator.displayName;
function Bc({ table: t }) {
    ...
    /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ N(
        Le,
        {
          ...
          children: [
            /* @__PURE__ */ s(ke, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ s(Ge, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ s(Ee, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ s(Vt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ N(
        wt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(ul, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ N(
        wt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(wl, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ N(
        wt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ s(fl, { className: "tw-h-4 tw-w-4" })
          ]
        }
      )
    ] })
...
const fr = E.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s("div", { className: y("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ s(
  "table",
  {
    ref: r,
...
const mr = E.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s(
  "thead",
  {
    ref: r,
    className: y(
...
const hr = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("tbody", { ref: n, className: y("[&_tr:last-child]:tw-border-0", t), ...e }));
hr.displayName = "TableBody";
const Vc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "tfoot",
  {
    ref: n,
...
const kn = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "th",
  {
    ref: n,
    className: y(
...
const Ue = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "td",
  {
    ref: n,
...
const zc = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "caption",
  {
    ref: n,
...
function Fc({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(fr, { stickyHeader: a, children: [
      /* @__PURE__ */ s(mr, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ s(se, { children: k.headers.map((T) => /* @__PURE__ */ s(kn, { children: T.isPlaceholder ? void 0 : gn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ s(hr, { children: (g = m.getRowModel().rows) != null && g.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        se,
        {
          onClick: () => i(k, m),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((T) => /* @__PURE__ */ s(Ue, { children: gn(T.column.columnDef.cell, T.getContext()) }, T.id))
        },
        k.id
      )) : /* @__PURE__ */ s(se, { children: /* @__PURE__ */ s(Ue, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Lc({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = Rt(() => {
    const i = [];
    return t.forEach((l) => {
      i.some((c) => yo(c, l)) || i.push(l);
    }), i;
  }, [t]);
  return /* @__PURE__ */ N(fr, { stickyHeader: !0, children: [
    /* @__PURE__ */ s(mr, { stickyHeader: !0, children: /* @__PURE__ */ N(se, { children: [
      /* @__PURE__ */ s(kn, { children: r }),
      /* @__PURE__ */ s(kn, { children: o })
    ] }) }),
    /* @__PURE__ */ s(hr, { children: a.length > 0 && a.map((i) => /* @__PURE__ */ N(
      se,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ s(Ue, { children: `${at.bookNumberToEnglishName(i.reference.bookNum)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ s(Ue, { children: i.text })
        ]
      },
...
const $o = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  no.Root,
  {
    ref: n,
    className: y(
    ...
    children: /* @__PURE__ */ s(
      no.Indicator,
      {
        ...
        children: /* @__PURE__ */ s(Je, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
$o.displayName = no.Root.displayName;
const Gc = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), va = (t) => {
...
}, Xc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fi = Re(
...
), Yc = E.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ s(
  yi.Root,
  {
    ref: o,
...
Yc.displayName = yi.Root.displayName;
...
Wn.displayName = dr.Item.displayName;
const gr = (t) => t === "asc" ? /* @__PURE__ */ s(bl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(vl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), th = (t) => ({
  accessorKey: "item",
  ...
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ s("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ N(wt, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    gr(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: a }) => /* @__PURE__ */ s("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ N(wt, { variant: "ghost", onClick: () => a.toggleSorting(void 0), children: [
    t,
    gr(a.getIsSorted())
  ] }) }),
  cell: ({ row: a }) => {
  ...
  return Gc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Uc(p), l = 0, c = 0), p.startsWith("\\c") && (l = va(p), c = 0), p.startsWith("\\v") && (c = va(p), l === 0 && (l = e.chapterNum));
    ...
    for (; f; ) {
      ...
      const h = f.index, b = a.find((g) => yo(g.items, w)), m = {
        ...
        text: $l(p, Math.max(0, h - 25), Math.min(h + 25, p.length))
      };
      if (b)
...
function oh({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), h = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), m = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), T = te(n, "%webView_inventory_filter_text%"), C = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? Wc(
    l,
    t,
    a,
    i,
    r
  ) : r(l, t, a, i) : [], [l, r, t, a, i]), J = Rt(() => {
    if (S) return tt;
    const x = [];
    return tt.forEach((O) => {
    ...
    /* @__PURE__ */ N("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ N(
        Le,
        {
          ...
          defaultValue: P,
          children: [
            /* @__PURE__ */ s(ke, { className: "tw-m-1", children: /* @__PURE__ */ s(Ge, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ N(Ee, { children: [
              /* @__PURE__ */ s(Vt, { value: "all", children: f }),
              /* @__PURE__ */ s(Vt, { value: "approved", children: w }),
              /* @__PURE__ */ s(Vt, { value: "unapproved", children: h }),
              /* @__PURE__ */ s(Vt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ N(Le, { onValueChange: (x) => G(x), defaultValue: c, children: [
        /* @__PURE__ */ s(ke, { className: "tw-m-1", children: /* @__PURE__ */ s(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ N(Ee, { children: [
          /* @__PURE__ */ s(Vt, { value: "book", children: m }),
          /* @__PURE__ */ s(Vt, { value: "chapter", children: g }),
          /* @__PURE__ */ s(Vt, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ s(
        Qe,
      ...
      o && /* @__PURE__ */ N("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(Dt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
function Kc({
  ...
  return /* @__PURE__ */ s("div", { className: d, children: /* @__PURE__ */ N(Ai, { open: p, onOpenChange: f, children: [
    /* @__PURE__ */ s(Di, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: "ghost",
          ...
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ s(
              "div",
              {
                ...
                children: /* @__PURE__ */ s("div", { className: "tw-font-normal", children: h() })
              }
            )
          ] }),
          /* @__PURE__ */ s(mi, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(Co, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ N(Ro, { children: [
      /* @__PURE__ */ s(Oo, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ N(_o, { children: [
        /* @__PURE__ */ s(Po, { children: a }),
        /* @__PURE__ */ s(Bi, { children: b.map((m) => {
          ...
          return /* @__PURE__ */ N(
            Io,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: m.starred && /* @__PURE__ */ s(xl, { className: "tw-h-4 tw-w-4" }) }),
                /* @__PURE__ */ s("div", { className: "tw-flex-grow", children: m.label }),
                e && /* @__PURE__ */ s("div", { className: "tw-w-10 tw-text-end tw-text-muted-foreground", children: g })
              ]
            },
            m.label
          );
...
Xi.displayName = It.List.displayName;
const Yi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.List,
  {
    ref: n,
    className: y(
...
)), Hi = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.Content,
  {
    ref: n,
    className: y(
...
Hi.displayName = It.Content.displayName;
function ah({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(Xi, { children: [
      /* @__PURE__ */ s(Yi, { children: t.map((i) => /* @__PURE__ */ s(Jc, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ s(Hi, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const Mo = E.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ s(
  xi.Root,
  {
    ref: o,
    decorative: n,
...
const Zc = Rn.Provider, Qc = Rn.Root, td = Rn.Trigger, qi = E.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Rn.Content,
  {
    ref: r,
    sideOffset: e,
...
qi.displayName = Rn.Content.displayName;
const ed = "16rem", nd = "3rem", Wi = E.createContext(void 0);
function br() {
  const t = E.useContext(Wi);
  if (!t)
...
const Ki = E.forwardRef(
  ({
    ...
    const [d, p] = E.useState(t), f = e ?? d, w = E.useCallback(
      ...
      [n, f]
    ), h = E.useCallback(() => w((C) => !C), [w]), b = f ? "expanded" : "collapsed", k = Nt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = E.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: w,
    ...
    return /* @__PURE__ */ s(Wi.Provider, { value: T, children: /* @__PURE__ */ s(Zc, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
Ki.displayName = "SidebarProvider";
const Ji = E.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: r, ...o }, a) => {
  const i = br();
...
Ji.displayName = "Sidebar";
const rd = E.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = br();
  return /* @__PURE__ */ N(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ s(Nl, {}) : /* @__PURE__ */ s(kl, {}),
        /* @__PURE__ */ s("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
rd.displayName = "SidebarTrigger";
...
Zi.displayName = "SidebarInset";
const ad = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Qe,
  {
    ref: n,
    "data-sidebar": "input",
...
sd.displayName = "SidebarFooter";
const ld = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Mo,
  {
    ref: n,
...
const so = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? Ze : "div",
  {
    ref: r,
...
const cd = E.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? Ze : "button",
  {
    ref: r,
...
const dd = Re(
  ...
  ({
    ...
    const c = t ? Ze : "button", { state: d } = br(), p = /* @__PURE__ */ s(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": e,
        className: y(dd({ variant: n, size: r }), a),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ N(Qc, { children: [
      /* @__PURE__ */ s(td, { asChild: !0, children: p }),
      /* @__PURE__ */ s(qi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ns.displayName = "SidebarMenuButton";
const pd = E.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ s(
  e ? Ze : "button",
  {
    ref: o,
...
pd.displayName = "SidebarMenuAction";
...
ud.displayName = "SidebarMenuBadge";
const wd = E.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ s(ya, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ s(
          ya,
          {
...
wd.displayName = "SidebarMenuSkeleton";
...
const hd = E.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ s(
  t ? Ze : "a",
  {
    ref: a,
...
function gd({
  ...
  return /* @__PURE__ */ s(
    Ji,
    {
      ...
      children: /* @__PURE__ */ N(Qi, { children: [
        /* @__PURE__ */ N(io, { children: [
          /* @__PURE__ */ s(so, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ s(lo, { children: /* @__PURE__ */ s(ts, { children: Object.entries(e).map(([w, h]) => /* @__PURE__ */ s(es, { children: /* @__PURE__ */ s(
            ns,
            {
              className: y(
              ...
              onClick: () => d(w),
              isActive: f(w),
              children: /* @__PURE__ */ s("span", { className: "tw-pl-3", children: h })
            }
          ) }, w)) }) })
        ] }),
        /* @__PURE__ */ N(io, { children: [
          /* @__PURE__ */ s(so, { className: "tw-text-sm tw-text-gray-400", children: i }),
          /* @__PURE__ */ s(lo, { className: "tw-pl-3", children: /* @__PURE__ */ s(
            ao,
            {
    ...
    /* @__PURE__ */ N(
      Ki,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Zi, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const ae = "scrBook", bd = "scrRef", me = "source", vd = "details", yd = "Scripture Reference", xd = "Scripture Book", rs = "Type", Nd = "Details";
function kd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ae,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? yd,
      cell: (r) => {
        const o = r.row.original;
        return r.row.getIsGrouped() ? at.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === ae ? Br(o.start) : void 0;
      },
...
}, xa = (t) => `${Ed({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function sh({
  sources: t,
  ...
  const [c, d] = ut([]), [p, f] = ut([{ id: ae, desc: !1 }]), [w, h] = ut({}), b = Rt(
  ...
  const k = o ?? xd, T = a ?? rs, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [ae] },
    { label: `Group by ${T}`, value: [me] },
    {
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          /* @__PURE__ */ s(ke, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ s(Ge, {}) }),
          /* @__PURE__ */ s(Ee, { position: "item-aligned", children: /* @__PURE__ */ s(Ac, { children: C.map((R) => /* @__PURE__ */ s(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ N(fr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(mr, { children: g.getHeaderGroups().map((R) => /* @__PURE__ */ s(se, { children: R.headers.filter((I) => I.column.columnDef.header).map((I) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ s(kn, { colSpan: I.colSpan, className: "top-0 tw-sticky", children: I.isPlaceholder ? void 0 : /* @__PURE__ */ N("div", { children: [
          I.column.getCanGroup() ? /* @__PURE__ */ s(
            wt,
            {
              variant: "ghost",
      ...
      /* @__PURE__ */ s(hr, { children: g.getRowModel().rows.map((R, I) => {
        const L = Nt();
        return /* @__PURE__ */ s(
          se,
          {
                  ...
                  Ue,
                  {
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        ...
                        type: "button",
                        children: [
                          R.getIsExpanded() && /* @__PURE__ */ s(cr, {}),
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ s(go, {}) : /* @__PURE__ */ s(Sl, {})),
                          " ",
...
function lh({
  ...
  return /* @__PURE__ */ N(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ s(ke, { className: y("pr-twp tw-w-auto", o), children: /* @__PURE__ */ s(
          Ge,
          {
        ...
        /* @__PURE__ */ s(
          Ee,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((l) => /* @__PURE__ */ s(Vt, { value: `${l}`, children: a[pt(l)] }, `${l}`))
          }
        )
      ]
    }
...
function uh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: e, children: n.map((i) => /* @__PURE__ */ N("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    ...
    /* @__PURE__ */ s(Dt, { children: a ? a(i) : i })
  ] }, i)) });
}
function os(t) {
...
function ee(t, e, n = {
  ...
  return be(t) && be(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (be(e[o]) && o in t && be(t[o]) ? r[o] = ee(t[o], e[o], n) : n.clone ? r[o] = be(e[o]) ? as(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function Cd() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = b, it.Memo = h, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = f, it.isAsyncMode = function(v) {
    return S(v) || C(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === f || v === w || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === h || v.$$typeof === i || v.$$typeof === l || v.$$typeof === p || v.$$typeof === g || v.$$typeof === k || v.$$typeof === T || v.$$typeof === m);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function Rd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === f || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === b || $.$$typeof === h || $.$$typeof === i || $.$$typeof === l || $.$$typeof === p || $.$$typeof === g || $.$$typeof === k || $.$$typeof === T || $.$$typeof === m);
    }
    function S($) {
    ...
    var v = c, P = d, F = l, R = i, I = e, L = p, D = r, tt = b, J = h, j = n, M = a, A = o, G = f, H = !1;
    function rt($) {
...
var Sa;
function is() {
  return Sa || (Sa = 1, process.env.NODE_ENV === "production" ? Gn.exports = Cd() : Gn.exports = Rd()), Gn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var Hr, Ra;
function ss() {
  return Ra || (Ra = 1, Hr = Function.call.bind(Object.prototype.hasOwnProperty)), Hr;
}
var qr, Oa;
function _d() {
  if (Oa) return qr;
  ...
  if (process.env.NODE_ENV !== "production") {
    var e = /* @__PURE__ */ Do(), n = {}, r = /* @__PURE__ */ ss();
    t = function(a) {
      var i = "Warning: " + a;
...
function Pd() {
  if (_a) return Wr;
  _a = 1;
  var t = is(), e = Od(), n = /* @__PURE__ */ Do(), r = /* @__PURE__ */ ss(), o = /* @__PURE__ */ _d(), a = function() {
  };
...
function $d() {
  ...
  if (Ia = 1, process.env.NODE_ENV !== "production") {
    var t = is(), e = !0;
    Ln.exports = /* @__PURE__ */ Pd()(t.isElement, e);
  } else
    Ln.exports = /* @__PURE__ */ Id()();
  return Ln.exports;
}
var Md = /* @__PURE__ */ $d();
const u = /* @__PURE__ */ os(Md);
function Ad(t) {
  const {
    prototype: e = {}
  } = t;
...
const jo = Ao(u.element, ls);
jo.isRequired = Ao(u.element.isRequired, ls);
const Dd = "exact-prop: ​";
function jd(t) {
...
function Bd() {
  ...
  return lt.ContextConsumer = i, lt.ContextProvider = a, lt.Element = t, lt.ForwardRef = c, lt.Fragment = n, lt.Lazy = w, lt.Memo = f, lt.Portal = e, lt.Profiler = o, lt.StrictMode = r, lt.Suspense = d, lt.SuspenseList = p, lt.isAsyncMode = function() {
    ...
    return typeof g == "string" || typeof g == "function" || g === n || g === o || g === r || g === d || g === p || g === h || typeof g == "object" && g !== null && (g.$$typeof === w || g.$$typeof === f || g.$$typeof === a || g.$$typeof === i || g.$$typeof === c || g.$$typeof === b || g.getModuleId !== void 0);
  }, lt.typeOf = m, lt;
}
var ct = {};
/**
...
function Vd() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function S(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || T || V === r || V === d || V === p || k || V === h || b || m || g || typeof V == "object" && V !== null && (V.$$typeof === w || V.$$typeof === f || V.$$typeof === a || V.$$typeof === i || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = i, F = a, R = t, I = c, L = n, D = w, tt = f, J = e, j = o, M = r, A = d, G = p, H = !1, rt = !1;
    function x(V) {
...
var Aa;
function zd() {
  return Aa || (Aa = 1, process.env.NODE_ENV === "production" ? Un.exports = Bd() : Un.exports = Vd()), Un.exports;
}
var Da = zd();
...
function cs(t, e = "") {
  return t.displayName || t.name || Ld(t) || e;
}
function ja(t, e, n) {
  const r = cs(e);
...
const ds = u.oneOfType([u.func, u.object]);
function Kt(t) {
  if (typeof t != "string")
...
function us({
  ...
  const {
    current: o
  } = B.useRef(t !== void 0), [a, i] = B.useState(e), l = o ? t : a;
  if (process.env.NODE_ENV !== "production") {
    B.useEffect(() => {
...
function ip(t) {
  t.addEventListener("keydown", op, !0), t.addEventListener("mousedown", Jr, !0), t.addEventListener("pointerdown", Jr, !0), t.addEventListener("touchstart", Jr, !0), t.addEventListener("visibilitychange", ap, !0);
}
function sp(t) {
  const {
    target: e
...
function ws() {
  ...
  function n() {
    return e.current ? (po = !0, ep.start(100, () => {
      po = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function yr(t, e, n = "Mui") {
  const r = hs[e];
  return r ? `${n}-${r}` : `${ms.generate(t)}-${e}`;
}
function gs(t, e, n = "Mui") {
  const r = {};
  return e.forEach((o) => {
    r[o] = yr(t, o, n);
  }), r;
...
function up(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = St(t, dp), a = pp(e), i = Object.keys(a);
  function l(w) {
  ...
  function d(w, h) {
    const b = i.indexOf(h);
    return `@media (min-width:${typeof e[w] == "number" ? e[w] : w}${n}) and (max-width:${(b !== -1 && typeof e[i[b]] == "number" ? e[i[b]] : h) - r / 100}${n})`;
  }
  function p(w) {
  ...
  function f(w) {
    const h = i.indexOf(w);
    return h === 0 ? l(i[1]) : h === i.length - 1 ? c(i[h]) : d(w, i[i.indexOf(w) + 1]).replace("@media", "@media not all and");
  }
  return _({
    keys: i,
    values: a,
...
const wp = {
  borderRadius: 4
}, ce = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {};
function bn(t, e) {
  return e ? ee(t, e, {
    clone: !1
...
function yt(t) {
  const {
    ...
    if (i[e] == null)
      return null;
    const l = i[e], c = i.theme, d = xr(c, r) || {};
    return ne(i, l, (f) => {
      let w = er(d, o, f);
      return f === w && typeof f == "string" && (w = er(d, o, `${e}${f === "default" ? "" : Kt(f)}`, f)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const gp = {
  ...
  if (t.length > 2)
    if (Ga[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = gp[e], o = bp[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), Nr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], kr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], yp = [...Nr, ...kr];
function _n(t, e, n, r) {
  var o;
...
function xp(t, e) {
  return (n) => t.reduce((r, o) => (r[o] = Pn(e, n), r), {});
}
function Np(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = vp(n), a = xp(o, r), i = t[n];
  return ne(t, i, a);
}
function vs(t, e) {
  const n = bs(t.theme);
  return Object.keys(t).map((r) => Np(t, e, r, n)).reduce(bn, {});
}
function gt(t) {
  return vs(t, Nr);
}
gt.propTypes = process.env.NODE_ENV !== "production" ? Nr.reduce((t, e) => (t[e] = ce, t), {}) : {};
gt.filterProps = Nr;
function bt(t) {
  return vs(t, kr);
}
bt.propTypes = process.env.NODE_ENV !== "production" ? kr.reduce((t, e) => (t[e] = ce, t), {}) : {};
bt.filterProps = kr;
process.env.NODE_ENV !== "production" && yp.reduce((t, e) => (t[e] = ce, t), {});
function kp(t = 8) {
  if (t.mui)
    return t;
  const e = bs({
...
const Ep = Ut("border", zt), Sp = Ut("borderTop", zt), Tp = Ut("borderRight", zt), Cp = Ut("borderBottom", zt), Rp = Ut("borderLeft", zt), Op = Ut("borderColor"), _p = Ut("borderTopColor"), Pp = Ut("borderRightColor"), Ip = Ut("borderBottomColor"), $p = Ut("borderLeftColor"), Mp = Ut("outline", zt), Ap = Ut("outlineColor"), Sr = (t) => {
  if (t.borderRadius !== void 0 && t.borderRadius !== null) {
    const e = _n(t.theme, "shape.borderRadius", 4, "borderRadius"), n = (r) => ({
      borderRadius: Pn(e, r)
    });
...
Er(Ep, Sp, Tp, Cp, Rp, Op, _p, Pp, Ip, $p, Sr, Mp, Ap);
const Tr = (t) => {
  if (t.gap !== void 0 && t.gap !== null) {
    const e = _n(t.theme, "spacing", 8, "gap"), n = (r) => ({
      gap: Pn(e, r)
    });
    return ne(t, t.gap, n);
  }
...
const Cr = (t) => {
  if (t.columnGap !== void 0 && t.columnGap !== null) {
    const e = _n(t.theme, "spacing", 8, "columnGap"), n = (r) => ({
      columnGap: Pn(e, r)
    });
...
const Rr = (t) => {
  if (t.rowGap !== void 0 && t.rowGap !== null) {
    const e = _n(t.theme, "spacing", 8, "rowGap"), n = (r) => ({
      rowGap: Pn(e, r)
    });
...
Er(Tr, Cr, Rr, Dp, jp, Bp, Vp, zp, Fp, Lp, Gp, Up);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const Xp = yt({
...
function nu() {
  function t(n, r, o, a) {
    ...
    const w = xr(o, d) || {};
    return f ? f(i) : ne(i, r, (b) => {
      let m = er(w, p, b);
      return b === m && typeof b == "string" && (m = er(w, p, `${n}${b === "default" ? "" : Kt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = fp(a.breakpoints), f = Object.keys(p);
      let w = p;
...
function Lo(t = {}, ...e) {
  ...
  return d.applyStyles = ru, d = e.reduce((p, f) => ee(p, f), d), d.unstable_sxConfig = _({}, Fo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Or({
      sx: f,
      theme: this
    });
...
const su = ["ownerState"], lu = ["variants"], cu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function du(t) {
  return Object.keys(t).length === 0;
}
function pu(t) {
...
const uu = Lo(), Ua = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Xn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function fu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Ll(i, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = wu(Ua(d))
    } = l, h = St(l, cu), b = p !== void 0 ? p : (
    ...
    let k = Kn;
    d === "Root" || d === "root" ? k = r : d ? k = o : pu(i) && (k = void 0);
    const T = zl(i, _({
      shouldForwardProp: k,
      label: g
    }, h)), C = (v) => typeof v == "function" && v.__emotion_real !== v || be(v) ? (P) => Jn(v, _({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Kt(d || "")}`), D === void 0 && (D = `Styled(${Gd(i)})`), L.displayName = D;
      }
...
function mu(t) {
  ...
  return !e || !e.components || !e.components[n] || !e.components[n].defaultProps ? r : fs(e.components[n].defaultProps, r);
}
function hu({
  props: t,
  name: e,
...
function Xa(t) {
  t = Te(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Te(bu(t)).values : t.values;
...
function Ns(t, e) {
  return t = Te(t), e = Go(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, _r(t);
}
function vu(t, e) {
...
const Sn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, ku = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function qa(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = yu(t.main, o) : e === "dark" && (t.dark = vu(t.main, a)));
}
function Eu(t = "light") {
  return t === "dark" ? {
    main: De[200],
...
function _u(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, ku), a = t.primary || Eu(e), i = t.secondary || Su(e), l = t.error || Tu(e), c = t.info || Cu(e), d = t.success || Ru(e), p = t.warning || Ou(e);
  function f(m) {
    const g = Ya(m, Zr.text.primary) >= n ? Zr.text.primary : Ha.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = Ya(m, g);
...
function Lu(t) {
  const e = _({}, Vu, t.easing), n = _({}, zu, t.duration);
  return _({
    getAutoHeightDuration: Fu,
    create: (o = ["all"], a = {}) => {
      const {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof i == "string" ? i : Ja(i)} ${l} ${typeof c == "string" ? c : Ja(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
const Gu = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Uu = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Xu(t = {}, ...e) {
  const {
    mixins: n = {},
    palette: r = {},
  ...
  if (d = ee(d, i), d = e.reduce((p, f) => ee(p, f), d), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return d.unstable_sxConfig = _({}, Fo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return Or({
      sx: f,
      theme: this
    });
...
const Yu = (t) => Kn(t) && t !== "classes", In = fu({
  themeId: Xo,
  defaultTheme: Uo,
...
const qu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Wu = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
  } = t, o = {
    root: ["root", e !== "inherit" && `color${Kt(e)}`, `fontSize${Kt(n)}`]
  };
  return Bo(o, Hu, r);
}, Ku = In("svg", {
  name: "MuiSvgIcon",
  ...
  return /* @__PURE__ */ N(Ku, _({
    ...
    ownerState: m,
    children: [b ? o.props.children : o, f ? /* @__PURE__ */ s("title", {
      children: f
    }) : null]
  }));
});
...
}, Symbol.toStringTag, { value: "Module" })), Qu = /* @__PURE__ */ Sd(Zu);
var Za;
function tw() {
...
function ew() {
  ...
  var e = t(/* @__PURE__ */ tw()), n = al;
  return cn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), cn;
}
var nw = /* @__PURE__ */ ew();
const rw = /* @__PURE__ */ os(nw);
function ow(t) {
  return typeof t == "string";
}
function mn(t, e, n) {
  return t === void 0 || ow(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const aw = {
  disableDefaultClasses: !1
}, iw = /* @__PURE__ */ B.createContext(aw);
function sw(t) {
  const {
...
function dw(t) {
  ...
  const i = lw(_({}, o, r)), l = ti(r), c = ti(o), d = e(i), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
const rr = /* @__PURE__ */ B.forwardRef(function(e, n) {
  const {
    ...
    container: o,
    disablePortal: a = !1
  } = e, [i, l] = B.useState(null), c = Se(/* @__PURE__ */ B.isValidElement(r) ? r.ref : null, n);
  if (Ye(() => {
    a || l(hw(o) || document.body);
  }, [o, a]), Ye(() => {
    if (i && !a)
      return tr(n, i), () => {
        tr(n, null);
    ...
    return /* @__PURE__ */ s(B.Fragment, {
      children: r
    });
  }
  return /* @__PURE__ */ s(B.Fragment, {
    children: i && /* @__PURE__ */ ql.createPortal(r, i)
  });
});
...
process.env.NODE_ENV !== "production" && (rr.propTypes = jd(rr.propTypes));
var Ot = "top", Lt = "bottom", Gt = "right", _t = "left", Ho = "auto", $n = [Ot, Lt, Gt, _t], He = "start", Tn = "end", gw = "clippingParents", Ss = "viewport", pn = "popper", bw = "reference", ei = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Tn]);
}, []), Ts = /* @__PURE__ */ [].concat($n, [Ho]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Tn]);
}, []), vw = "beforeRead", yw = "read", xw = "afterRead", Nw = "beforeMain", kw = "main", Ew = "afterMain", Sw = "beforeWrite", Tw = "write", Cw = "afterWrite", Rw = [vw, yw, xw, Nw, kw, Ew, Sw, Tw, Cw];
function Jt(t) {
...
function Ow(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    ...
    !Ft(a) || !Jt(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(i) {
      var l = o[i];
...
function _w(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Ft(o) || !Jt(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
function We(t, e, n) {
  ...
  var i = Ce(t) ? jt(t) : window, l = i.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function $w(t) {
  ...
  var o = Pr(t);
  for (qo(o) && (o = o.host); Ft(o) && ["html", "body"].indexOf(Jt(o)) < 0; ) {
    var a = re(o);
...
function Mn(t) {
  for (var e = jt(t), n = ni(t); n && Iw(n) && re(n).position === "static"; )
    n = ni(n);
  return n && (Jt(n) === "html" || Jt(n) === "body" && re(n).position === "static") ? e : n || $w(t) || e;
}
function Ko(t) {
...
var Aw = function(e, n) {
  ...
  })) : e, _s(typeof e != "number" ? e : Ps(e, $n));
};
function Dw(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = qt(n.placement), c = Ko(l), d = [_t, Gt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var f = Aw(o.padding, n), w = Wo(a), h = c === "y" ? Ot : _t, b = c === "y" ? Lt : Gt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], g = i[c] - n.rects.reference[c], k = Mn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - g / 2, S = f[h], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = vn(S, P, v), R = c;
...
function ri(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, i = t.offsets, l = t.position, c = t.gpuAcceleration, d = t.adaptive, p = t.roundOffsets, f = t.isFixed, w = i.x, h = w === void 0 ? 0 : w, b = i.y, m = b === void 0 ? 0 : b, g = typeof p == "function" ? p({
    x: h,
    y: m
  }) : {
    x: h,
  ...
  h = g.x, m = g.y;
  var k = i.hasOwnProperty("x"), T = i.hasOwnProperty("y"), C = _t, S = Ot, v = window;
  if (d) {
    var P = Mn(n), F = "clientHeight", R = "clientWidth";
    if (P === jt(n) && (P = de(n), re(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === Ot || (o === _t || o === Gt) && a === Tn) {
      S = Lt;
...
function Gw(t) {
  var e = t.state, n = t.instance, r = t.options, o = r.scroll, a = o === void 0 ? !0 : o, i = r.resize, l = i === void 0 ? !0 : i, c = jt(e.elements.popper), d = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Zo(t) {
  return We(de(t)).left + Jo(t).scrollLeft;
}
function Hw(t, e) {
  var n = jt(t), r = de(t), o = n.visualViewport, a = r.clientWidth, i = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function qw(t) {
  var e, n = de(t), r = Jo(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = xe(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = xe(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Zo(t), c = -r.scrollTop;
...
function Is(t) {
  return ["html", "body", "#document"].indexOf(Jt(t)) >= 0 ? t.ownerDocument.body : Ft(t) && Qo(t) ? t : Is(Pr(t));
}
function yn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Is(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = jt(r), i = o ? [a].concat(a.visualViewport || [], Qo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function ai(t, e, n) {
  return e === Ss ? wo(Hw(t, n)) : Ce(e) ? Ww(e, n) : wo(qw(de(t)));
}
function Kw(t) {
  var e = yn(Pr(t)), n = ["absolute", "fixed"].indexOf(re(t).position) >= 0, r = n && Ft(t) ? Mn(t) : t;
  return Ce(r) ? e.filter(function(o) {
    return Ce(o) && Rs(o, r) && Jt(o) !== "body";
  }) : [];
}
function Jw(t, e, n, r) {
  var o = e === "clippingParents" ? Kw(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = ai(t, d, r);
...
function $s(t) {
  var e = t.reference, n = t.element, r = t.placement, o = r ? qt(r) : null, a = r ? Ke(r) : null, i = e.x + e.width / 2 - n.width / 2, l = e.y + e.height / 2 - n.height / 2, c;
  switch (o) {
    case Ot:
      c = {
        x: i,
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? gw : l, d = n.rootBoundary, p = d === void 0 ? Ss : d, f = n.elementContext, w = f === void 0 ? pn : f, h = n.altBoundary, b = h === void 0 ? !1 : h, m = n.padding, g = m === void 0 ? 0 : m, k = _s(typeof g != "number" ? g : Ps(g, $n)), T = w === pn ? bw : pn, C = t.rects.popper, S = t.elements[b ? T : w], v = Jw(Ce(S) ? S : S.contextElement || de(t.elements.popper), c, p, i), P = We(t.elements.reference), F = $s({
    reference: P,
    element: C,
    placement: o
  }), R = wo(Object.assign({}, C, F)), I = w === pn ? R : P, L = {
...
function Zw(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ts : c, p = Ke(r), f = p ? l ? ei : ei.filter(function(b) {
    return Ke(b) === p;
  }) : $n, w = f.filter(function(b) {
...
function tf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, h = n.flipVariations, b = h === void 0 ? !0 : h, m = n.allowedAutoPlacements, g = e.options.placement, k = qt(g), T = k === g, C = c || (T || !b ? [Zn(g)] : Qw(g)), S = [g].concat(C).reduce(function(z, K) {
      return z.concat(qt(K) === Ho ? Zw(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var D = S[L], tt = qt(D), J = Ke(D) === He, j = [Ot, Lt].indexOf(tt) >= 0, M = j ? "width" : "height", A = Cn(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function nf(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = Cn(e, {
    elementContext: "reference"
  }), l = Cn(e, {
    altBoundary: !0
  }), c = ii(i, r), d = ii(l, o, a), p = si(c), f = si(d);
  e.modifiersData[n] = {
...
function of(t, e, n) {
  var r = qt(t), o = [_t, Ot].indexOf(r) >= 0 ? -1 : 1, a = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, i = a[0], l = a[1];
  return i = i || 0, l = (l || 0) * o, [_t, Gt].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function af(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, i = Ts.reduce(function(p, f) {
...
function pf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, h = w === void 0 ? !0 : w, b = n.tetherOffset, m = b === void 0 ? 0 : b, g = Cn(e, {
    boundary: c,
    rootBoundary: d,
    padding: f,
    altBoundary: p
  }), k = qt(e.placement), T = Ke(e.placement), C = !T, S = Ko(k), v = df(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? Ot : _t, M = S === "y" ? Lt : Gt, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = h ? -R[A] / 2 : 0, O = T === He ? F[A] : R[A], U = T === He ? -R[A] : -F[A], X = e.elements.arrow, z = h && X ? Wo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Os(), q = K[j], W = K[M], Y = vn(0, F[A], z[A]), Z = C ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Mn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Xt = vn(h ? or(H, V) : H, G, h ? xe(rt, xt) : rt);
      P[S] = Xt, tt[S] = Xt - G;
    }
    if (l) {
      var pe, Tt = S === "x" ? Ot : _t, jn = S === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", ue = Yt + g[Tt], Pe = Yt - g[jn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (pe = D == null ? void 0 : D[v]) != null ? pe : 0, we = Ie ? ue : Yt - F[_e] - R[_e] - $e + L.altAxis, en = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Bn = h && Ie ? Mw(we, Yt, en) : vn(h ? we : ue, Yt, h ? en : Pe);
      P[v] = Bn, tt[v] = Bn - Yt;
    }
...
function hf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && mf(e), a = de(e), i = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Qo(a)) && (l = ff(e)), Ft(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Zo(a))), {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = bf(yf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (ci(T, C)) {
            p.rects = {
              reference: hf(T, Mn(C), p.options.strategy === "fixed"),
              popper: Wo(C)
...
var Nf = [Uw, cf, Lw, Pw, sf, ef, uf, Bw, rf], kf = /* @__PURE__ */ xf({
  defaultModifiers: Nf
});
const Ef = "Popper";
function Sf(t) {
...
const Tf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Cf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Rf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const _f = () => Bo({
  root: ["root"]
}, sw(Sf)), Pf = {}, If = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = St(e, Tf), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
  }, [S]), B.useImperativeHandle(w, () => C.current, []);
  const P = Rf(p, i), [F, R] = B.useState(P), [I, L] = B.useState(ar(o));
  B.useEffect(() => {
...
`));
  ...
  const tt = _f(), J = (r = b.root) != null ? r : "div", j = uw({
    elementType: J,
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = St(e, Cf), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
  ...
  if (a)
    ...
    const L = ar(r);
    F = L && Ir(L) ? Qn(L).body : Qn(null).body;
  }
...
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || Of(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
var Mf = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const Ds = E.createContext(null);
var Af = function(e) {
  return e.scrollTop;
}, hn = "unmounted", he = "exited", ge = "entering", ze = "entered", mo = "exiting", oe = /* @__PURE__ */ function(t) {
  $f(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var i = o, l = i && !i.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = he, a.appearStatus = ge) : c = ze : r.unmountOnExit || r.mountOnEnter ? c = hn : c = he, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== ge && i !== ze && (a = ge) : (i === ge || i === ze) && (a = mo);
    }
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Fn.findDOMNode(this), l], d = c[0], p = c[1], f = this.getTimeouts(), w = l ? f.appear : f.enter;
    if (!o && !i || di.disabled) {
      this.safeSetState({
        status: ze
      }, function() {
    ...
    var o = this, a = this.props.exit, i = this.getTimeouts(), l = this.props.nodeRef ? void 0 : Fn.findDOMNode(this);
    if (!a || di.disabled) {
      this.safeSetState({
        status: he
      }, function() {
    ...
    var i = this.props.nodeRef ? this.props.nodeRef.current : Fn.findDOMNode(this), l = o == null && !this.props.addEndListener;
    if (!i || l) {
    ...
    return (
      ...
      /* @__PURE__ */ E.createElement(Ds.Provider, {
        value: null
      }, typeof i == "function" ? i(o, l) : E.cloneElement(E.Children.only(i), l))
    );
  }, e;
}(E.Component);
oe.contextType = Ds;
...
}, Qr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), ir = /* @__PURE__ */ B.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
    ...
    TransitionComponent: g = oe
  } = e, k = St(e, jf), T = fn(), C = B.useRef(), S = As(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
ir.muiSupportAuto = !0;
const Vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], zf = In(Ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ys(), a = Yo({
    ...
    slots: C,
    slotProps: S
  } = a, v = St(a, Vf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const ie = gs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Lf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Gf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Uf = (t) => {
  const {
    ...
    tooltip: ["tooltip", r && "tooltipArrow", o && "touch", `tooltipPlacement${Kt(a.split("-")[0])}`],
    arrow: ["arrow"]
  };
  return Bo(i, Ff, e);
}, Xf = In(ta, {
  ...
  [`&[data-popper-placement*="right"] .${ie.arrow}`]: _({}, e.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${ie.arrow}`]: _({}, e.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  overridesResolver: (t, e) => {
    ...
    return [e.tooltip, n.touch && e.touch, n.arrow && e.tooltipArrow, e[`tooltipPlacement${Kt(n.placement.split("-")[0])}`]];
  }
})(({
  theme: t,
  ownerState: e
}) => _({
  backgroundColor: t.vars ? t.vars.palette.Tooltip.bg : Ns(t.palette.grey[700], 0.92),
  ...
  [`.${ie.popper}[data-popper-placement*="left"] &`]: _({
  ...
  [`.${ie.popper}[data-popper-placement*="right"] &`]: _({
  ...
  [`.${ie.popper}[data-popper-placement*="top"] &`]: _({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, e.touch && {
    marginBottom: "24px"
  }),
  [`.${ie.popper}[data-popper-placement*="bottom"] &`]: _({
  ...
  color: t.vars ? t.vars.palette.Tooltip.bg : Ns(t.palette.grey[700], 0.9),
  "&::before": {
    content: '""',
    margin: "auto",
    display: "block",
...
const js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, f, w, h, b, m, g, k, T, C, S, v;
  const P = Yo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: kt
  } = P, V = St(P, Lf), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
  }), Xt = As(), pe = Xt.direction === "rtl", [Tt, jn] = B.useState(), [Yt, _e] = B.useState(null), ue = B.useRef(!1), Pe = j || rt, Ie = fn(), $e = fn(), we = fn(), en = fn(), [Bn, ea] = us({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const $r = ps(x), nn = B.useRef(), Vn = co(() => {
  ...
  const na = (et) => {
    ...
    ue.current && et.type !== "touchstart" || (Tt && Tt.removeAttribute("title"), $e.clear(), we.clear(), A || Hn && G ? $e.start(Hn ? G : A, () => {
      na(et);
    }) : na(et));
  }, ra = (et) => {
    $e.clear(), we.start(O, () => {
    ...
    onFocus: qs,
    ref: Ws
  } = ws(), [, aa] = B.useState(!1), ia = (et) => {
    Hs(et), oa.current === !1 && (aa(!1), ra(et));
  }, sa = (et) => {
    Tt || jn(et.currentTarget), qs(et), oa.current === !0 && (aa(!0), Mr(et));
  }, la = (et) => {
    ue.current = !0;
    const $t = xt.props;
    $t.onTouchStart && $t.onTouchStart(et);
  }, ca = Mr, da = ra, Ks = (et) => {
    la(et), we.clear(), Ie.clear(), Vn(), nn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(H, () => {
      document.body.style.WebkitUserSelect = nn.current, Mr(et);
    });
  }, Js = (et) => {
    xt.props.onTouchEnd && xt.props.onTouchEnd(et), Vn(), we.start(U, () => {
      zn(et);
    });
  };
  B.useEffect(() => {
  ...
  const Zs = Se(xt.ref, Ws, jn, n);
  !dt && dt !== 0 && (Qt = !1);
  const Ar = B.useRef(), Qs = (et) => {
    const $t = xt.props;
...
`));
  ...
  const on = {};
  M || (Bt.onTouchStart = Ks, Bt.onTouchEnd = Js), J || (Bt.onMouseOver = qn(ca, Bt.onMouseOver), Bt.onMouseLeave = qn(da, Bt.onMouseLeave), Pe || (on.onMouseOver = ca, on.onMouseLeave = da)), tt || (Bt.onFocus = qn(sa, Bt.onFocus), Bt.onBlur = qn(ia, Bt.onBlur), Pe || (on.onFocus = sa, on.onBlur = ia)), process.env.NODE_ENV !== "production" && xt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${xt.props.title}\` or the Tooltip component.`].join(`
`));
  const tl = B.useMemo(() => {
    var et;
    let $t = [{
    ...
    touch: ue.current
  }), jr = Uf(an), pa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : Xf, ua = (a = (i = (l = Q.transition) != null ? l : I.Transition) != null ? i : $) != null ? a : ir, wa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Yf, fa = (p = (f = Q.arrow) != null ? f : I.Arrow) != null ? p : Hf, el = mn(pa, _({}, Y, (w = Z.popper) != null ? w : L.popper, {
    className: ye(jr.popper, Y == null ? void 0 : Y.className, (h = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : h.className)
  }), an), nl = mn(ua, _({}, kt, (m = Z.transition) != null ? m : L.transition), an), rl = mn(wa, _({}, (g = Z.tooltip) != null ? g : L.tooltip, {
    className: ye(jr.tooltip, (k = (T = Z.tooltip) != null ? T : L.tooltip) == null ? void 0 : k.className)
  }), an), ol = mn(fa, _({}, (C = Z.arrow) != null ? C : L.arrow, {
    className: ye(jr.arrow, (S = (v = Z.arrow) != null ? v : L.arrow) == null ? void 0 : S.className)
  }), an);
  return /* @__PURE__ */ N(B.Fragment, {
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ s(pa, _({
      as: W ?? ta,
      placement: q,
      anchorEl: rt ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(wa, _({}, rl, {
          children: [dt, F ? /* @__PURE__ */ s(fa, _({}, ol, {
            ref: _e
          })) : null]
        }))
      }))
...
function wi(t, e, n) {
  return t ? /* @__PURE__ */ s(Ni, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ s("img", { src: t, alt: `${n ? "Leading" : "Trailing"} icon for ${e}` }) }) : void 0;
}
function Bs(t) {
  const {
    onClick: e,
    ...
    Gl,
    {
      ...
      onClick: e,
      id: m,
      children: n ? /* @__PURE__ */ N(Zt, { children: [
        wi(a, n, !0),
        /* @__PURE__ */ s(Ul, { primary: n, inset: !a && o }),
        f ? /* @__PURE__ */ s(Ni, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(rw, {}) }) : wi(i, n, !1)
      ] }) : g
    }
  );
  return r ? /* @__PURE__ */ s(js, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: k }) }) : k;
}
function Vs(t) {
...
const Wf = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function zs(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: i } = Rt(() => {
    const p = o && o.length > 0 ? o : (
      // We're apparently laying out a single-column menu (presumably a context menu). In this
      // case, all groups should be included except ones that belong to a submenu.
      Vs(e).filter((b) => !("menuItem" in b.group))
    ), f = Object.values(p).sort(
      (b, m) => (b.group.order || 0) - (m.group.order || 0)
    ), w = [];
    f.forEach((b) => {
      Wf(b.id, e.items).forEach(
...
const An = lr(({ className: t, ...e }, n) => /* @__PURE__ */ s(Tl, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
function fh({
  ...
  return /* @__PURE__ */ N("div", { className: y("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": r }), children: [
    ...
    /* @__PURE__ */ s("p", { className: y({ "tw-hidden": !o }), children: o })
  ] });
}
const Fs = E.createContext(void 0);
function Oe() {
  const t = E.useContext(Fs);
  if (!t)
...
function nm({ ...t }) {
  return /* @__PURE__ */ s(ht.Menu, { ...t });
}
const Ls = E.forwardRef(({ className: t, variant: e = "default", ...n }, r) => {
  const o = E.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ s(Fs.Provider, { value: o, children: /* @__PURE__ */ s(
    ht.Root,
    {
      ref: r,
      className: y(
...
Ls.displayName = ht.Root.displayName;
const Gs = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ s(
    ht.Trigger,
    {
      ...
      className: y(
        ...
        // CUSTOM
        Dn({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
});
Gs.displayName = ht.Trigger.displayName;
const rm = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    ht.SubTrigger,
    {
      ...
      className: y(
        ...
        e && "tw-pl-8",
        // CUSTOM
        Dn({ variant: a.variant, className: t }),
        t
      ),
      ...r,
      children: [
...
rm.displayName = ht.SubTrigger.displayName;
...
om.displayName = ht.SubContent.displayName;
const Us = E.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: r = 8, ...o }, a) => {
  const i = Oe();
  return /* @__PURE__ */ s(ht.Portal, { children: /* @__PURE__ */ s(
    ht.Content,
    {
      ref: a,
      align: e,
...
Us.displayName = ht.Content.displayName;
const Xs = E.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ s(
    ht.Item,
    {
      ...
      className: y(
        ...
        e && "tw-pl-8",
        // CUSTOM
        Dn({ variant: o.variant, className: t }),
        t
      ),
      ...n
    }
...
Xs.displayName = ht.Item.displayName;
const am = E.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    ht.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(ht.ItemIndicator, { children: /* @__PURE__ */ s(Je, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
am.displayName = ht.CheckboxItem.displayName;
const im = E.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ N(
    ht.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ s("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(ht.ItemIndicator, { children: /* @__PURE__ */ s(bo, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
im.displayName = ht.RadioItem.displayName;
const sm = E.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  ht.Label,
  {
    ref: r,
    className: y("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
sm.displayName = ht.Label.displayName;
const Ys = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ht.Separator,
  {
    ref: n,
    className: y("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
Ys.displayName = ht.Separator.displayName;
function lm({ menuProvider: t, commandHandler: e, variant: n }) {
  const [r] = sr(
    Et(async () => t == null ? void 0 : t(!1), [t]),
    void 0
  );
  if (!r) return;
  const o = (i) => typeof i == "object" && i !== null && "order" in i && "label" in i, a = (i) => typeof i == "object" && i !== null && "column" in i && "order" in i;
  return /* @__PURE__ */ s(Ls, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(r.columns).filter(([i, l]) => i !== "isExtensible" && o(l)).sort(([, i], [, l]) => i.order - l.order).map(([i, l]) => /* @__PURE__ */ N(nm, { children: [
    /* @__PURE__ */ s(Gs, { children: l.label }),
    /* @__PURE__ */ s(Us, { children: Object.entries(r.groups).filter(([, c]) => a(c) && c.column === i).sort(([, c], [, d]) => c.order - d.order).map(([c]) => {
      const d = r.items.filter((p) => p.group === c).sort((p, f) => p.order - f.order);
      return d.length > 0 ? /* @__PURE__ */ N(E.Fragment, { children: [
        d.map((p) => /* @__PURE__ */ s(
          Xs,
          {
            onClick: () => {
              console.log("running command from item:", p), "command" in p && e(p.command);
            },
            children: p.label
          },
          "command" in p ? p.command : p.id
        )),
        /* @__PURE__ */ s(Ys, {})
      ] }, c) : void 0;
    }) })
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ N(
        "div",
        {
          ...
          style: i ? { WebkitAppRegion: "drag" } : void 0,
          children: [
            /* @__PURE__ */ s("div", { className: "tw-flex tw-grow tw-basis-0", children: /* @__PURE__ */ s(
              "div",
              {
                className: "tw-flex tw-items-center",
                style: { WebkitAppRegion: "no-drag" },
                children: t ? /* @__PURE__ */ N(Zt, { children: [
                  /* @__PURE__ */ s(
                    em,
                    {
                      commandHandler: e,
            ...
            /* @__PURE__ */ s("div", { className: "tw-flex tw-grow tw-basis-0 tw-justify-end", children: /* @__PURE__ */ s(
              "div",
              {
                className: "tw-flex tw-items-center tw-gap-2",
                style: { WebkitAppRegion: "no-drag" },
...
), dm = E.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: y(cm({ variant: e }), t), ...n }));
dm.displayName = "Alert";
const pm = E.forwardRef(
...
pm.displayName = "AlertTitle";
const um = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function fm({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: y("pr-twp", wm({ variant: e }), t), ...n });
}
...
const bm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
bm.displayName = "CardDescription";
const vm = E.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: y("pr-twp tw-p-6 tw-pt-0", t), ...e })
);
...
const xm = E.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ N(
    wn.Root,
    {
      ...
      dir: r,
      children: [
        /* @__PURE__ */ s(wn.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ s(wn.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ s(wn.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
xm.displayName = wn.Root.displayName;
const Nm = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ s(
    ro.Root,
    {
...
Nm.displayName = ro.Root.displayName;
const gh = It.Root, km = E.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ s(
    It.List,
    {
...
km.displayName = It.List.displayName;
const Em = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.Trigger,
  {
    ref: n,
    className: y(
...
Em.displayName = It.Trigger.displayName;
const Sm = E.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  It.Content,
  {
    ref: n,
    className: y(
...
Sm.displayName = It.Content.displayName;
function bh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ s(An, { size: 15 }) : /* @__PURE__ */ N(Zt, { children: [
        /* @__PURE__ */ s(Cl, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Nh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: y("pr-twp tw-prose", n), children: /* @__PURE__ */ s(Kl, { options: o, children: e }) });
}
const Tm = lr((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ s(Rl, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ s(
        cr,
        {
...
function kh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ s(Si, { asChild: !0, children: /* @__PURE__ */ s(Tm, {}) }),
    /* @__PURE__ */ s(pr, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ s(ur, { children: n.label }),
      /* @__PURE__ */ s(tc, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(No, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(Ci, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(wr, {})
    ] }, n.label)) })
  ] }) });
}
function Eh({ id: t, message: e }) {
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ s(Ol, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ s(_l, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ s(Pl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Rm({ id: t, versionHistory: e }) {
...
function Th({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ N("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ s(Rm, { versionHistory: o }),
...
function Ch({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var w;
      return /* @__PURE__ */ N(fm, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ s(vo, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (w = t.find((h) => h.value === f)) == null ? void 0 : w.label
      ] }, f);
    }) }) : /* @__PURE__ */ s(Dt, { children: p })
  ] });
}
const Om = (t, e) => t[e] ?? e;
function Rh({
  ...
  return /* @__PURE__ */ N("div", { className: y("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ N(
      Le,
      {
        ...
        onOpenChange: (h) => p(h),
        children: [
          /* @__PURE__ */ s(ke, { children: /* @__PURE__ */ s(Ge, {}) }),
          /* @__PURE__ */ s(
            Ee,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ s(Vt, { value: h, children: w(h, e) }, h))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ N(Zt, { children: [
      /* @__PURE__ */ s(Dt, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ s("div", { className: "tw-ms-3", children: /* @__PURE__ */ N(Dt, { children: [
        "Currently:",
        " ",
...
export {
  ...
  $c as BookSelectionMode,
  Qm as BookSelector,
  wt as Button,
  mm as Card,
  vm as CardContent,
  bm as CardDescription,
  ym as CardFooter,
  hm as CardHeader,
  gm as CardTitle,
  ...
  oh as Inventory,
  Dt as Label,
  Nh as MarkdownRenderer,
  Bs as MenuItem,
  Sh as MoreInfo,
  Kc as MultiSelectComboBox,
  ah as NavigationContentSearch,
  Eh as NoExtensionsFound,
  Ai as Popover,
  ...
  gd as SettingsSidebar,
  ih as SettingsSidebarContentSearch,
  xm as Slider,
  hh as Sonner,
  An as Spinner,
  Nm as Switch,
  ...
  mh as Toolbar,
  Qc as Tooltip,
  qi as TooltipContent,
  Zc as TooltipProvider,
  td as TooltipTrigger,
  Rh as UiLanguageSelector,
  xh as UpdateButton,
  Rm as VersionHistory,
  Xi as VerticalTabs,
  ...
  y as cn,
  Uc as getBookNumFromId,
  Gc as getLinesFromUSFM,
  va as getNumberFromUSFM,
  Xc as getStatusForItem,
