...
import { am as Bh, an as Lh, ao as Fh, ap as Uh, aq as Kh, ar as qh, as as Gh, at as Hh, au as Yh, av as Wh, aw as Xh, ax as Jh, ay as Zh, az as Qh, aA as tg, aB as eg, aC as rg, aD as ag, aE as og, aF as ng, aG as ig, aH as sg, aI as cg, aJ as lg, aK as dg } from "./resizable-JZpwvayK.js";
...
function da({
  ...
  const A = re(), [B, T] = _(!1), [V, $] = _(""), [N, j] = _(""), [R, E] = _("books"), [Y, q] = _(void 0), [F, O] = _(
    void 0
    ...
    w.read(() => {
      ...
      if ((T || V) && A !== null && B !== null) {
        const $ = function(N, j, R, E, Y, q, F) {
          ...
          return O.setStart(...jo(j, R, E)), O.setEnd(...jo(Y, q, F)), O;
        }(t, g, f, A, h, C, B);
        d(), d = Dl(t, $, e);
      }
...
function vi({
  ...
  const [E, Y] = _(Zo), [q, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, At] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, oe] = _(!1), [at, Vt] = _(A), [St, Wt] = _(!1), ne = K(void 0), [D, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
...
function wp({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [A, B] = _("*"), [T, V] = _("f"), [$, N] = _(!1), [j, R] = _(!0), [E, Y] = _(!1), q = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [At, U] = _(), [tt, wt] = _(), st = K(null), vt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function yp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = _(!1), [N, j] = _("all"), [R, E] = _(""), [Y, q] = _([]), F = I(() => {
    const U = t ?? [];
...
function Ap({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: Se, desc: !1 }]), [h, f] = _({}), x = I(
...
function Pp({
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [ft, Dt] = _(!1), [Rt, Ft] = _(void 0), [Ot, Ee] = _(void 0), [z, $t] = _(void 0), [yt, de] = _(void 0), [Te, wr] = _([]), ur = l === "dropdown" && Rt === "selectedBooks", pr = /* @__PURE__ */ a(
    Gw,
    {
      availableBookInfo: o,
