...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => "command" in c ? /* @__PURE__ */ u(xt, { children: [
  /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ u(
    qe,
    {
      onClick: () => {
...
] }, `tooltip-${c.label}-${c.command}`) : /* @__PURE__ */ u(Hs, { children: [
  /* @__PURE__ */ u(xt, { children: [
    /* @__PURE__ */ a(yt, { asChild: !0, children: /* @__PURE__ */ a(Gs, { children: c.label }) }),
    c.tooltip && /* @__PURE__ */ a(kt, { children: c.tooltip })
  ] }),
