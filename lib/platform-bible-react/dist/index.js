...
import m, { forwardRef as Ze, useRef as nt, useMemo as H, useState as O, useCallback as B, useLayoutEffect as Sn, createContext as Kr, useContext as qr, useEffect as Ot, Fragment as jn } from "react";
import { Command as it } from "cmdk";
import { X as Qe, Search as Bn, Check as Rt, Clock as Rn, ChevronsLeft as Tn, ChevronsRight as En, ChevronLeft as $e, ChevronRight as Ft, ArrowLeft as Jr, ArrowRight as Wr, Circle as be, ChevronsUpDown as tn, FilterIcon as Zr, ChevronDown as ve, ChevronUp as Qr, ArrowLeftIcon as to, ChevronLeftIcon as eo, ChevronRightIcon as no, ArrowRightIcon as ro, Copy as oo, Filter as ao, User as so, Link as io, CircleHelp as wo, Star as lo, AlertCircle as je, CircleCheckIcon as co, CircleXIcon as po, CircleHelpIcon as mo, ArrowUpIcon as uo, ArrowDownIcon as ho, ArrowUpDownIcon as fo, PanelLeft as go, PanelRight as bo, ScrollText as vo, MenuIcon as xo, Menu as yo, EllipsisVertical as No, LoaderCircle as ko } from "lucide-react";
import { clsx as Co } from "clsx";
import { extendTailwindMerge as _o } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as me, Section as M, getChaptersForBook as So, formatScrRef as Lt, getSectionForBook as oe, NumberFormat as Ro, formatBytes as To, getCurrentLocale as Eo, getFormatCallerFunction as Vo, deepEqual as en, isString as Ve, compareScrRefs as Be, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Gn, getFilteredRowModel as Mo, getSortedRowModel as Fn, getPaginationRowModel as Do, getCoreRowModel as Xn, flexRender as ae, getGroupedRowModel as Io, getExpandedRowModel as Oo } from "@tanstack/react-table";
import * as G from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as Ao } from "@radix-ui/react-dropdown-menu";
...
import { useHotkeys as zo } from "react-hotkeys-hook";
...
const Lo = xt.Portal, Yn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xt.Overlay,
  {
    ref: n,
    className: c(
...
const Go = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = tt();
  return /* @__PURE__ */ l(Lo, { children: [
    /* @__PURE__ */ r(Yn, {}),
    /* @__PURE__ */ l(
      xt.Content,
      {
...
Go.displayName = xt.Content.displayName;
...
Fo.displayName = xt.Title.displayName;
...
Xo.displayName = xt.Description.displayName;
...
var Ho = Object.defineProperty, Uo = (t, e, n) => e in t ? Ho(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, V = (t, e, n) => Uo(t, typeof e != "symbol" ? e + "" : e, n);
const Pt = [
  "GEN",
  "EXO",
  "LEV",
...
const st = class D {
    ...
    if (V(this, "firstChapter"), V(this, "lastChapter"), V(this, "lastVerse"), V(this, "hasSegmentsDefined"), V(this, "text"), V(this, "BBBCCCVVVS"), V(this, "longHashCode"), V(this, "versification"), V(this, "rtlMark", "‏"), V(this, "_bookNum", 0), V(this, "_chapterNum", 0), V(this, "_verseNum", 0), V(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof D) {
          ...
          if (e == null) return;
          const s = e instanceof Mt ? e : D.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Mt(i)), n ? new D(n, o.toString(), w, u) : new D();
  }
  /**
  ...
  parse(e) {
    ...
    if (o.length !== 2 || $.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !D.isVerseParseable(o[1]))
      throw new ee("Invalid reference : " + e);
...
const rr = Ze(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Yt : "button", { className: c(oa({ variant: e, size: n, className: t })), ref: s, ...a })
);
I.displayName = "Button";
const Zt = se.Root, Qt = se.Trigger, Bt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = tt();
...
function aa({
  ...
  return /* @__PURE__ */ l(Zt, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(Bt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(At, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      jt,
      {
        onSelect: () => d(p),
...
function Ri(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (w) => !n(w, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function ia(t, e, n) {
  ...
  const o = sa.reduce(
    (a, s) => {
      ...
      if (i) {
        const [w, u = void 0, d = void 0] = i.slice(1);
        let p;
...
function wa(t, e, n, o) {
  const a = B(() => {
    if (t.chapterNum > 1)
      ...
      if (u > 0) {
        const d = e[u - 1], p = Math.max(vt(d), 1);
        o({
          book: d,
          chapterNum: p,
          verseNum: 1
...
function Ti({
  ...
  const d = tt(), [p, g] = O(!1), [h, f] = O(""), [b, y] = O(""), [v, S] = O("books"), [N, C] = O(void 0), [j, W] = O(!1), L = nt(void 0), ot = nt(void 0), pt = nt(void 0), _ = nt(void 0), E = nt({}), Y = B(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
    ...
    (x) => {
      ...
      if (v === "chapters") {
        ...
        if (P || J) {
          if (x.preventDefault(), x.stopPropagation(), S("books"), C(void 0), J && N) {
            const rt = It[N];
            y(`${rt} ${x.key}`);
          } else
            y(x.key);
      ...
      if ((v === "chapters" || v === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        const rt = v === "chapters" ? N : k == null ? void 0 : k.book;
        if (!rt) return;
        const at = (() => {
          if (!h) return 1;
          const te = h.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            at !== 0 && (yt = at > 1 ? at - 1 : Et);
            break;
          case "ArrowRight":
            at !== 0 && (yt = at < Et ? at + 1 : 1);
            break;
          case "ArrowUp":
            yt = at === 0 ? Et : Math.max(1, at - _n);
            break;
          case "ArrowDown":
            yt = at === 0 ? 1 : Math.min(Et, at + _n);
            break;
          default:
            return;
        }
        yt !== at && (x.preventDefault(), x.stopPropagation(), f(Xe(rt, a, yt)), setTimeout(() => {
    ...
    const { isLetter: P, isDigit: J } = Dn(x.key);
    (P || J) && (x.preventDefault(), y((rt) => rt + x.key), ot.current.focus(), W(!1));
  }, []);
  return Sn(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && pt.current && _.current) {
        const P = pt.current, J = _.current, rt = J.offsetTop, at = P.clientHeight, Et = J.clientHeight, yt = rt - at / 2 + Et / 2;
        P.scrollTo({
          top: Math.max(0, yt),
          behavior: "smooth"
        }), f(Xe(t.book));
  ...
  }, [v, N, k, t.book, t.chapterNum]), /* @__PURE__ */ l(Zt, { open: p, onOpenChange: Ct, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ r(
      I,
      {
    ...
    /* @__PURE__ */ r(Bt, { id: u, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      qt,
      {
        ref: L,
        onKeyDown: Ur,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: q.map(({ onClick: x, disabled: P, title: J, icon: rt }) => /* @__PURE__ */ r(
              I,
              {
                variant: "ghost",
                size: "sm",
            ...
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Gt(N, a) })
          ] }),
          !j && /* @__PURE__ */ l(Jt, { ref: pt, children: [
            v === "books" && /* @__PURE__ */ l(bt, { children: [
              !k && Object.entries(et).map(([x, P]) => {
                if (P.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(At, { heading: Gr(x), children: P.map((J) => /* @__PURE__ */ r(
                      rr,
                      {
                        bookId: J,
                        onSelect: (rt) => ft(rt),
              ...
              k && /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r(
                jt,
                {
                  value: `${k.book} ${It[k.book]} ${k.chapterNum || ""}:${k.verseNum || ""})}`,
                  onSelect: K,
                  ...
                  children: Lt(
                    ...
                    a ? an(k.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              k && vt(k.book) > 1 && /* @__PURE__ */ l(bt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Gt(k.book, a) }),
                /* @__PURE__ */ r(
                  In,
                  {
                    bookId: k.book,
...
), Q = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ln.Root, { ref: n, className: c("pr-twp", la(), t), ...e }));
Q.displayName = Ln.Root.displayName;
...
function He({
  ...
  const [v, S] = O(!1);
  return /* @__PURE__ */ l(Zt, { open: v, onOpenChange: S, ...y, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ l(
      I,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(tn, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(
      Bt,
      {
        ...
        children: /* @__PURE__ */ l(qt, { children: [
          ...
          /* @__PURE__ */ r(Jt, { children: e.map((N) => /* @__PURE__ */ l(
            jt,
            {
              value: w(N),
              onSelect: () => {
...
var pa = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(pa || {});
...
function Mi({
  ...
  const p = Ie(d, "%webView_bookSelector_currentBook%"), g = Ie(d, "%webView_bookSelector_choose%"), h = Ie(d, "%webView_bookSelector_chooseBooks%"), [f, b] = O(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    b(v), t(v);
    ...
    wn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Q, { className: "tw-flex tw-items-center", children: o.map((v) => $.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
}), or = G.Trigger, ar = G.Group, ma = G.Portal, ua = G.Sub, ha = G.RadioGroup;
function dn({ variant: t = "default", ...e }) {
  const n = m.useMemo(
    () => ({
      variant: t
    }),
...
const cn = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const pn = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: o,
...
function ga({ table: t }) {
  return /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(Ao, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = U.Root, ba = U.Group, Ht = U.Value, va = Tt(
  ...
  return /* @__PURE__ */ l(
    U.Trigger,
    {
      className: c(va({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
dr.displayName = U.ScrollUpButton.displayName;
...
cr.displayName = U.ScrollDownButton.displayName;
...
xa.displayName = U.Label.displayName;
const mt = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  U.Item,
  {
    ref: o,
    className: c(
...
function we(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && ka(o)
  );
}
...
const St = m.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
  ...
  const w = m.useMemo(
    ...
    (p) => {
      ...
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), Ra(f, b, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), Sa(w, y, p.key);
...
function Ea({
  ...
  var S;
  const [u, d] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Gn({
    data: e,
    columns: t,
    getCoreRowModel: Xn(),
    ...n && { getPaginationRowModel: Do() },
    onSortingChange: d,
    getSortedRowModel: Fn(),
    onColumnFiltersChange: g,
    getFilteredRowModel: Mo(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    a && /* @__PURE__ */ r(ga, { table: v }),
    /* @__PURE__ */ l(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: v.getHeaderGroups().map((N) => /* @__PURE__ */ r(St, { children: N.headers.map((C) => /* @__PURE__ */ r(le, { children: C.isPlaceholder ? void 0 : ae(C.column.columnDef.header, C.getContext()) }, C.id)) }, N.id)) }),
      /* @__PURE__ */ r(Se, { children: (S = v.getRowModel().rows) != null && S.length ? v.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        St,
        {
          ...
          children: N.getVisibleCells().map((C) => /* @__PURE__ */ r(Ut, { children: ae(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        N.id
    ...
    n && o && /* @__PURE__ */ r(Na, { table: v })
  ] });
}
function Di({ id: t, markdown: e, className: n, anchorTarget: o }) {
  const a = H(
    () => ({
      overrides: {
        a: {
...
function Ma({
  ...
  const a = An(n, "%webView_error_dump_header%"), s = An(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(I, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(oo, {}) })
        ] }),
...
function Oi({
  ...
  return /* @__PURE__ */ l(Zt, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ l(Bt, { id: s, className: c("tw-min-w-80 tw-max-w-96", a), children: [
...
var Da = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Da || {});
function Ai({ id: t, label: e, groups: n }) {
  const [o, a] = O(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(or, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "default", children: [
      /* @__PURE__ */ r(ao, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ve, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(pn, { children: d.label }),
...
function Ia({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const u = new Date(w), d = new Date(a.getTime() - u.getTime()), p = d.getUTCFullYear() - 1970, g = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let f = "";
...
function zi({
  ...
  const i = H(() => To(n), [n]), u = ((d) => {
    const p = new Intl.DisplayNames(Eo(), { type: "language" });
...
const Oa = Tt(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: c("pr-twp", Oa({ variant: e }), t), ...n })
);
...
function Aa({
  ...
  const [h, f] = O(!1), b = B(
    ...
    const S = t.filter((C) => C.starred).sort((C, j) => C.label.localeCompare(j.label)), N = t.filter((C) => !C.starred).sort((C, j) => {
      const W = n.includes(C.value), L = n.includes(j.value);
      return W && !L ? -1 : !W && L ? 1 : C.label.localeCompare(j.label);
    });
    return [...S, ...N];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { id: g, className: p, children: /* @__PURE__ */ l(Zt, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ r(Qt, { asChild: !0, children: /* @__PURE__ */ l(
      I,
      {
        variant: "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ r(tn, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Bt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(qt, { children: [
          ...
          return /* @__PURE__ */ l(
            jt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: S.starred && /* @__PURE__ */ r(lo, { className: "tw-h-4 tw-w-4" }) }),
...
const Ue = c("marker", "marker-visible'}");
function Ye(t, e, n = !0, o = !0, a = []) {
  if (!(!e || e.length === 0))
    return e.map((s) => {
      ...
      return i += `-${s.marker ?? "unknown"}`, Pa(s, i, n, [
        ...a,
        t ?? "unknown"
      ]);
    });
...
function Pa(t, e, n, o = []) {
  ...
  return /* @__PURE__ */ l("span", { children: [
    a ? n && /* @__PURE__ */ r("span", { className: Ue, children: `\\${a} ` }) : /* @__PURE__ */ r(
      je,
      {
...
function za({
  ...
  const u = o ? /* @__PURE__ */ r("span", { className: Ue, children: `\\${t.marker} ` }) : void 0, d = o ? /* @__PURE__ */ r("span", { className: Ue, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
...
const Ba = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function ji({
  ...
  const p = d ? Fa(d, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Vo(e, void 0), h = (f) => {
    u && u(f);
  };
  return /* @__PURE__ */ l(bt, { children: [
...
mn.displayName = Le.Root.displayName;
...
), Ha = m.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Hn.Root,
  {
    ref: a,
...
Ha.displayName = Hn.Root.displayName;
const ur = m.createContext({
  size: "default",
  variant: "default"
}), hr = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = tt();
  return /* @__PURE__ */ r(
    xe.Root,
    {
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(uo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fo, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Bi = (t) => ({
  accessorKey: "item",
  ...
  let i = [...n];
  t.forEach((u) => {
    e === "approved" ? i.includes(u) || i.push(u) : i = i.filter((d) => d !== u);
  }), o(i);
  let w = [...a];
  t.forEach((u) => {
    e === "unapproved" ? w.includes(u) || w.push(u) : w = w.filter((d) => d !== u);
  }), s(w);
}, Gi = (t, e, n, o, a) => ({
  accessorKey: "status",
  ...
  return e ? e[1] : "";
}, Ya = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ui = Object.freeze([
...
function Yi({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = O(!1), [W, L] = O("all"), [ot, pt] = O(""), [_, E] = O([]), Y = H(() => t.length === 0 ? [] : qa(t, a, s), [t, a, s]), A = H(() => {
    if (C) return Y;
    const T = [];
    return Y.forEach((Z) => {
    ...
    for (let Ct = 0; Ct < T; Ct++)
      Z.push(
        Ua(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[Ct]) || "Additional Item",
          Ct + 1
        )
      );
    return [...Z, ...u];
  ...
  return /* @__PURE__ */ l("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Xt, { onValueChange: (T) => k(T), defaultValue: i, children: [
...
const un = m.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Un.Root,
  {
    ref: a,
    decorative: n,
...
un.displayName = Un.Root.displayName;
...
const hn = de.Provider, fn = de.Root, gn = de.Trigger, Te = m.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: o,
    sideOffset: e,
...
const Ja = "16rem", Wa = "3rem", fr = m.createContext(void 0);
function Ee() {
  const t = m.useContext(fr);
  if (!t)
...
const gr = m.forwardRef(
  ({
    ...
    const [d, p] = m.useState(t), g = e ?? d, h = m.useCallback(
      (C) => {
    ...
    return /* @__PURE__ */ r(fr.Provider, { value: N, children: /* @__PURE__ */ r(hn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const br = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Ee();
...
const ts = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pe,
  {
    ref: n,
    "data-sidebar": "input",
...
const os = m.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: o,
...
os.displayName = "SidebarGroupAction";
...
Je.displayName = "SidebarGroupContent";
...
const as = Tt(
  ...
  ({
    ...
    const u = t ? Yt : "button", { state: d } = Ee(), p = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": o,
        "data-active": e,
        className: c(as({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Te, { side: "right", align: "center", hidden: d !== "collapsed", ...a })
    ] })) : p;
  }
);
kr.displayName = "SidebarMenuButton";
const ss = m.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Yt : "button",
  {
    ref: a,
...
ss.displayName = "SidebarMenuAction";
...
is.displayName = "SidebarMenuBadge";
const ws = m.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
ws.displayName = "SidebarMenuSkeleton";
...
ls.displayName = "SidebarMenuSub";
const ds = m.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
ds.displayName = "SidebarMenuSubItem";
const cs = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Yt : "a",
  {
    ref: s,
...
cs.displayName = "SidebarMenuSubButton";
function ps({
  id: t,
  extensionLabels: e,
  projectInfo: n,
    ...
    br,
    {
      ...
      children: /* @__PURE__ */ l(xr, { children: [
        /* @__PURE__ */ l(Ke, { children: [
          ...
          /* @__PURE__ */ r(Je, { children: /* @__PURE__ */ r(yr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(Nr, { children: /* @__PURE__ */ r(
            kr,
            {
              onClick: () => d(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ l(Ke, { children: [
          ...
          /* @__PURE__ */ r(Je, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            He,
            {
              buttonVariant: "ghost",
...
const _t = "scrBook", ms = "scrRef", Dt = "source", us = "details", hs = "Scripture Reference", fs = "Scripture Book", Cr = "Type", gs = "Details";
function bs(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: _t,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? hs,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? $.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === _t ? Lt(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: us,
      header: (t == null ? void 0 : t.detailsColumnName) ?? gs,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, zn = (t) => `${vs({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qi({
  sources: t,
  ...
  const [d, p] = O([]), [g, h] = O([{ id: _t, desc: !1 }]), [f, b] = O({}), y = H(
  ...
  Ot(() => {
    if (w) {
      ...
      if (E.length === 1) {
        const Y = y.find((A) => zn(A) === E[0]) || void 0;
        Y && w(Y);
      }
    }
  }, [f, y, w, S]);
  const N = a ?? fs, C = s ?? Cr, j = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [_t] },
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($t, { position: "item-aligned", children: /* @__PURE__ */ r(ba, { children: j.map((_) => /* @__PURE__ */ r(mt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ce, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(_e, { children: S.getHeaderGroups().map((_) => /* @__PURE__ */ r(St, { children: _.headers.filter((E) => E.column.columnDef.header).map((E) => (
        ...
        /* @__PURE__ */ r(le, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          ae(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, _.id)) }),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ l(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r($e, {})),
                          " ",
                          ae(A.column.columnDef.cell, A.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
}), _r = (t, e, n) => vn(t, e).every((o) => n.includes(o));
function xs({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = vn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], u = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
...
function ys({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], w = o["%webView_book_selector_search_books%"], u = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: h, ntLong: f, dcLong: b, extraLong: y } = {
  ...
  const L = H(() => $.allBookIds.filter(
    ...
    (R, et = !1) => {
      ...
      const k = L.findIndex((q) => q === j.current), K = L.findIndex((q) => q === R);
      if (k === -1 || K === -1) return;
      const [ft, T] = [
        Math.min(k, K),
        Math.max(k, K)
    ...
    (R) => {
      const et = vn(L, R).map((k) => k);
      n(
        _r(L, R, e) ? e.filter((k) => !et.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...et])]
      );
    },
    [e, n, L]
  ), A = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(
      Zt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Bt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
            qt,
            {
              shouldFilter: !1,
              onKeyDown: (R) => {
              ...
              children: [
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(I, { variant: "ghost", size: "sm", onClick: lt, children: d })
                ] }),
                /* @__PURE__ */ l(Jt, { children: [
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Ae ? Ae : $n
      ).map((R) => /* @__PURE__ */ r(fe, { className: "hover:tw-bg-secondary", variant: "secondary", children: Gt(R, a) }, R)),
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        wn,
        {
          ...
          children: S.map(({ value: N, label: C, id: j }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
...
const Rr = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ l(ua, { children: [
    /* @__PURE__ */ r(sr, { children: w.label }),
    /* @__PURE__ */ r(ma, { children: /* @__PURE__ */ r(ir, { children: Rr(
      t,
      e,
      Sr(t, w.id),
      o
...
function We({
  ...
  return /* @__PURE__ */ l(dn, { variant: s, children: [
    /* @__PURE__ */ r(or, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(xo, {}) }) }),
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, d]) => typeof u == "boolean" || typeof d == "boolean" ? 0 : u.order - d.order).map(([u], d, p) => /* @__PURE__ */ l(jn, { children: [
      /* @__PURE__ */ r(ar, { children: /* @__PURE__ */ r(hn, { children: Rr(e.groups, e.items, u, t) }) }),
      d < p.length - 1 && /* @__PURE__ */ r(ke, {})
    ] }, u)) })
  ] });
}
...
const Vr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.List,
  {
    ref: n,
    className: c(
...
function ow({
  ...
  return /* @__PURE__ */ l("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Er, { children: [
      /* @__PURE__ */ r(Vr, { children: t.map((w) => /* @__PURE__ */ r(Ns, { value: w.value, children: w.value }, w.key)) }),
...
const Dr = m.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = m.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(ln.Provider, { value: a, children: /* @__PURE__ */ r(
    F.Root,
    {
      ref: o,
      className: c(
...
Or.displayName = F.SubTrigger.displayName;
const Ar = m.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    F.SubContent,
    {
...
const Pr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = ht();
...
const zr = m.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = ht();
  return /* @__PURE__ */ r(
    F.Item,
    {
...
const _s = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
...
_s.displayName = F.CheckboxItem.displayName;
const Ss = m.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = ht();
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
...
const ne = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((d) => d.group === s).sort((d, p) => d.order - p.order).map((d) => /* @__PURE__ */ l(fn, { children: [
      /* @__PURE__ */ r(gn, { asChild: !0, children: "command" in d ? /* @__PURE__ */ l(
        zr,
        {
          onClick: () => {
            o(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ r(ge, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ r(ge, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ l(Cs, { children: [
        /* @__PURE__ */ r(Or, { children: d.label }),
      ...
      d.tooltip && /* @__PURE__ */ r(Te, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), u = [...w];
...
function Ts({
  ...
  const a = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), u = nt(void 0), d = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (zo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    var b, y, v, S;
    p.preventDefault();
    ...
    return /* @__PURE__ */ r(Dr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(ks, { children: [
      /* @__PURE__ */ r(Ir, { ref: d(p), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        Pr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(hn, { children: jr(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function iw({
  ...
  const d = Es(
    ...
    return v ? `${(W = t[b]) == null ? void 0 : W.autonym} (${v})` : (L = t[b]) == null ? void 0 : L.autonym;
  };
  return /* @__PURE__ */ l("div", { id: u, className: c("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Xt,
      {
        name: "uiLanguage",
    ...
    e !== "en" && /* @__PURE__ */ l(bt, { children: [
      /* @__PURE__ */ r(Q, { className: "tw-ms-3 tw-pt-4 tw-text-muted-foreground", children: d }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3 tw-text-muted-foreground", children: /* @__PURE__ */ r(Q, { children: (n == null ? void 0 : n.length) > 0 ? `${n.map((b) => f(b, e)).join(", ")}` : `default (${t.en.autonym})` }) })
    ] })
  ] });
}
function Vs({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Ms = Ze(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
Ms.displayName = "Spinner";
function lw({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), Is = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Ps.displayName = Kt.Root.displayName;
...
zs.displayName = Kt.Image.displayName;
const $s = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Kt.Fallback,
  {
    ref: n,
    className: c(
...
$s.displayName = Kt.Fallback.displayName;
const dw = X.Root, cw = X.Trigger, pw = X.Group, mw = X.Portal, uw = X.Sub, hw = X.RadioGroup, js = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
js.displayName = X.SubTrigger.displayName;
...
const Ls = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: c(
...
Ls.displayName = X.Content.displayName;
const Gs = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  X.Item,
  {
    ref: o,
    className: c(
...
Gs.displayName = X.Item.displayName;
const Fs = m.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  X.CheckboxItem,
  {
    ref: a,
    className: c(
...
Fs.displayName = X.CheckboxItem.displayName;
const Xs = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ref: o,
    className: c(
...
Xs.displayName = X.RadioItem.displayName;
const Hs = m.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: o,
    className: c(
...
Hs.displayName = X.Label.displayName;
...
Us.displayName = X.Separator.displayName;
...
const fw = ut.Trigger, qs = ut.Portal, gw = ut.Close, Lr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
...
Lr.displayName = ut.Overlay.displayName;
const Js = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
Qs.displayName = ut.Title.displayName;
...
ti.displayName = ut.Description.displayName;
const ei = m.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Ge.Root,
  {
    ref: o,
    className: c(
...
ei.displayName = Ge.Root.displayName;
function bw({ ...t }) {
  return /* @__PURE__ */ r(
    $o,
    {
...
ni.displayName = re.Root.displayName;
...
const vw = wt.Root, oi = m.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
...
oi.displayName = wt.List.displayName;
...
ai.displayName = wt.Trigger.displayName;
...
si.displayName = wt.Content.displayName;
const ii = m.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: c(
...
const li = (t, e, n = {}) => {
  ...
  const a = nt(null), [s, i] = O(void 0), [w, u] = O(void 0), d = B(
    (h) => {
      i(h);
...
export {
  ...
  $s as AvatarFallback,
  zs as AvatarImage,
  Ei as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  Vi as BOOK_SELECTOR_STRING_KEYS,
  fe as Badge,
  Ti as BookChapterControl,
  ...
  Va as ERROR_DUMP_STRING_KEYS,
  Ii as ERROR_POPOVER_STRING_KEYS,
  Ma as ErrorDump,
  Oi as ErrorPopover,
  $i as Filter,
  Ai as FilterDropdown,
  zi as Footer,
  za as FootnoteItem,
  ji as FootnoteList,
  ...
  Yi as Inventory,
  Q as Label,
  Di as MarkdownRenderer,
  Pi as MoreInfo,
  Aa as MultiSelectComboBox,
  ow as NavigationContentSearch,
  Zt as Popover,
  ...
  Ji as SCOPE_SELECTOR_STRING_KEYS,
  Wi as ScopeSelector,
  ...
  un as Separator,
  Qi as SettingsList,
  ew as SettingsListHeader,
  tw as SettingsListItem,
  ps as SettingsSidebar,
  Ki as SettingsSidebarContentSearch,
  br as Sidebar,
  xr as SidebarContent,
  ns as SidebarFooter,
  Ke as SidebarGroup,
  os as SidebarGroupAction,
  Je as SidebarGroupContent,
  qe as SidebarGroupLabel,
  es as SidebarHeader,
  ts as SidebarInput,
  vr as SidebarInset,
  yr as SidebarMenu,
  ss as SidebarMenuAction,
  is as SidebarMenuBadge,
  kr as SidebarMenuButton,
  Nr as SidebarMenuItem,
  ws as SidebarMenuSkeleton,
  ls as SidebarMenuSub,
  cs as SidebarMenuSubButton,
  ...
  Ms as Spinner,
  ri as Switch,
  We as TabDropdownMenu,
  rw as TabFloatingMenu,
  nw as TabToolbar,
  Ce as Table,
  Se as TableBody,
  Ta as TableCaption,
  ...
  c as cn,
  Hi as getBookIdFromUSFM,
  Fi as getLinesFromUSFM,
  Xi as getNumberFromUSFM,
  Ya as getStatusForItem,
  aw as getToolbarOSReservedSpaceClassName,
  Li as inventoryCountColumn,
  Bi as inventoryItemColumn,
  Gi as inventoryStatusColumn,
