...
import b, { forwardRef as an, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as fs, createElement as Vr, Suspense as hs, Fragment as fo } from "react";
...
import { includes as dn, Section as X, getChaptersForBook as ti, formatScrRef as xe, getSectionForBook as We, formatRelativeDate as ei, formatReplacementString as ve, sanitizeHtml as ni, NumberFormat as ri, formatBytes as oi, getCurrentLocale as ai, usfmMarkers as hn, getFormatCallerFunction as si, deepEqual as ii, isString as Kr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { useReactTable as Bo, getFilteredRowModel as Xi, getSortedRowModel as Ko, getPaginationRowModel as Wi, getCoreRowModel as Go, flexRender as Je, getGroupedRowModel as Ji, getExpandedRowModel as Zi } from "@tanstack/react-table";
...
const ln = b.forwardRef((t, e) => /* @__PURE__ */ r(Ct.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ln.displayName = Ct.Empty.displayName;
...
const wn = 250, ea = 300, dl = 400, bp = 450, vp = 500, oe = Oe.Root, fe = Oe.Trigger, pl = Oe.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = mt();
...
const yn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  en.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(en.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Tn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
yn.displayName = en.Item.displayName;
function bl(t) {
...
Ut({ build: (t, e, n) => Mn(e), config: sn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
Ut({ build: (t, e, n) => Mn(e), config: sn({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const Tr = 0, dr = 1, ua = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, He = 7;
function Gn(t) {
  return t.id === Tr;
}
function ma(t) {
...
class Ul {
  ...
  register(e, n) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== He && et(309, String(o.id), String(He)), this.state = function(s) {
...
const Hl = Ut({ config: sn({ setOptions: to, updateOptions: to }), init: ({ $initialEditorState: t = ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
class Qe {
  ...
  static maybeFromEditor(e) {
    const n = e[eo];
    return n && (n.PACKAGE_VERSION !== Un && et(292, n.PACKAGE_VERSION, Un), n instanceof Qe || et(293)), n;
  }
  static fromEditor(e) {
...
const Xl = /* @__PURE__ */ new Set(), ro = Ut({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = nn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = da(() => {
  }, () => pe(() => {
...
Ut({ dependencies: [cr, ro], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(ro).output, a = nn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return de(t.registerCommand(bi, (s) => {
    ...
    Vl(() => {
      ...
      for (const [d, m] of s.entries()) if (m === "destroyed") c.delete(d), w = !0;
        ...
        h ? h.domNode.value = u : (w = !0, c.set(d, { domNode: nn(u), selectedSignal: o(d) }));
      }
...
Ut({ build: (t, e, n) => Mn(e), config: sn({ $canIndent: ha, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
...
Ut({ build: (t, e, n) => Mn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : ba(t)) });
function rw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
tn.displayName = Sn.Item.displayName;
const so = [
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        rn(s, '[tabindex]:not([tabindex="-1"])').forEach((d) => {
...
function rc({
  ...
  return w ? F = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    Zt,
    {
      ...
      children: A.getVisibleCells().map((M) => /* @__PURE__ */ r(Ne, { children: Je(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    A.id
    ...
    /* @__PURE__ */ p(In, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Zt, { children: A.headers.map((M) => /* @__PURE__ */ r(on, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Je(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ p(In, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Zt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
        ...
        /* @__PURE__ */ r(on, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          Je(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, E.id)) }),
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: i, children: [
    ...
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: wn }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(fo, { children: [
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Ye(i, [h, u]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Ye(s, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ye(l, [h, u]);
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Ye(w, [h, u]);
        break;
    }
  }), Y(() => {
...
const fd = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ws, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
Ld.displayName = Xe.Root.displayName;
