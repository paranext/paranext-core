...
import b, { forwardRef as an, useRef as H, useMemo as F, useState as S, useCallback as K, useLayoutEffect as It, createContext as Cn, useContext as hr, useEffect as Y, Component as us, createElement as Lr, Suspense as ms, Fragment as uo } from "react";
...
Be.displayName = Ct.Input.displayName;
...
ne.displayName = Ct.List.displayName;
...
function pp({
  ...
  const c = ht(), [p, u] = S(!1), [h, m] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, z] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: L } = Hr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
  ...
  }, [v, N, O, t.book, t.chapterNum]), /* @__PURE__ */ d(re, { open: p, onOpenChange: G, children: [
    /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
          ...
          !C && /* @__PURE__ */ d(ne, { ref: $, children: [
            v === "books" && /* @__PURE__ */ d(ct, { children: [
              ...
              O && /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(
                qt,
                {
                  value: `${O.book} ${xe[O.book]} ${O.chapterNum || ""}:${O.verseNum || ""})}`,
                  onSelect: J,
              ...
              O && Gt(O.book) > 1 && /* @__PURE__ */ d(ct, { children: [
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(_o.Root, { ref: n, className: f("pr-twp", pl(), t), ...e }));
...
function sr({
  ...
  const [N, k] = S(!1), C = w ?? l, z = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], j = (R, $) => {
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ d(ee, { children: [
          ...
          /* @__PURE__ */ r(ne, { children: z(e) ? e.map((R) => /* @__PURE__ */ r(te, { heading: R.groupHeading, children: R.options.map(($) => j($, R.groupHeading)) }, R.groupHeading)) : e.map((R) => j(R)) })
        ] })
      }
    )
  ] });
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = ea ? It : Y, pn = { tag: gr };
...
const bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
...
const kr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = ke.Provider, St = ke.Root, Dt = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  ke.Trigger,
  {
    ref: o,
...
const _t = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(ke.Portal, { children: /* @__PURE__ */ r(
  ke.Content,
  {
    ref: o,
    sideOffset: e,
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
function Cl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function El() {
  return function(t) {
    const [e] = Yt(), n = F(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = H(o);
    return _l(() => {
...
Nt.prototype.brand = Ol, Nt.prototype.h = function() {
  return !0;
...
const ow = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : Y;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
          /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Ve, {}) }) }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Dr(y) && (y.preventDefault(), y.stopPropagation(), $t(a) && h());
        },
        onKeyDown: (y) => {
...
}), Ke = nt.Trigger, Ma = nt.Group, Pw = nt.Portal, $w = nt.Sub, Lw = nt.RadioGroup;
...
function ao({
  ...
  const m = K(
    ...
    [t.user]
  ), N = F(() => Qs(t.contents), [t.contents]), k = F(() => {
    if (o && l)
      return /* @__PURE__ */ d(ct, { children: [
        /* @__PURE__ */ d(
          kn,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : Dr(C) && (C.preventDefault(), C.stopPropagation(), $t(p) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ d(Ee, { children: [
          /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(go, {}) }) }),
...
function jw({
  ...
  const Wt = F(() => Bt[0], [Bt]), Te = H(null), ae = H(void 0), Jt = K(() => {
    var T;
    (T = ae.current) == null || T.call(ae), $(so);
  }, []), qe = K(() => {
    const T = !pt;
  ...
  }, [i, n]), L = F(() => Bt.slice(1), [Bt]), U = F(() => L.length ?? 0, [L.length]), q = F(() => U > 0, [U]), it = F(() => P || U <= 2 ? L : L.slice(-2), [L, U, P]), tt = F(() => P || U <= 2 ? 0 : U - 2, [U, P]), bt = F(
  ...
  const Rt = K(
    async (T) => {
      ...
      vt && await u({ threadId: w, contents: vt }) && Jt();
    },
    [
      Jt,
      R,
    ...
    async (T) => {
      const vt = $t(R) ? Nn(R) : void 0, mt = await u({
        ...T,
        contents: vt,
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              B,
              {
                ...
                children: pt ? /* @__PURE__ */ r(ys, {}) : /* @__PURE__ */ r(Ns, {})
              }
            ),
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ d(re, { open: O, onOpenChange: J, children: [
                      /* @__PURE__ */ r(ue, { asChild: !0, children: /* @__PURE__ */ r(
                        B,
                        {
                          size: "icon",
...
function vp({
  ...
  const z = n.filter(
    ...
    [y, x]
  ), { listboxRef: E, activeId: D, handleKeyDown: V } = Rw({
    options: j,
    onOptionSelect: R
  }), P = K(
    (I) => {
...
function zw({ table: t }) {
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Ui, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const $e = dt.Root, Fw = dt.Group, Le = dt.Value, Bw = pe(
...
const Ot = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  dt.Item,
  {
    ref: o,
    className: f(
...
function Zw({
  ...
  var j;
  const [p, u] = S([]), [h, m] = S([]), [g, x] = S({}), [v, y] = S({}), N = F(() => e ?? [], [e]), k = Fo({
    data: N,
    columns: t,
    getCoreRowModel: Ko(),
  ...
  let z;
  return w ? z = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(ye, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? z = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    Zt,
    {
      onClick: () => s(R, k),
      "data-state": R.getIsSelected() && "selected",
      children: R.getVisibleCells().map(($) => /* @__PURE__ */ r(ye, { children: Je($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    R.id
  )) : z = /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(ye, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
...
function kp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ee, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Ma, { children: c.itemType === 0 ? /* @__PURE__ */ r(ct, { children: c.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[p][h],
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(re, { open: $, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(ee, { children: [
      ...
      /* @__PURE__ */ d(ne, { children: [
        ...
        /* @__PURE__ */ r(te, { children: z.map((D) => /* @__PURE__ */ d(
          qt,
          {
            value: D.label,
            onSelect: k,
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ r(Os, { className: "tw-h-4 tw-w-4" }),
...
function ac({
  ...
  return /* @__PURE__ */ d(ct, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ d("p", { children: [
        wo(a, "%undoButton_tooltip%"),
        i && ` (${w ? "⌘Z" : "Ctrl+Z"})`
      ] }) })
    ] }) }),
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
        B,
        {
          "aria-label": "Redo",
...
function lc({
  ...
  return /* @__PURE__ */ d(Ee, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: ic(t, a, n) }) }) }),
...
function dc({
  ...
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: cc(t, n) }) })
    ] }) }),
...
function Tp({
  ...
  const p = H(null), u = H(null), h = H(null), m = H(null);
  It(() => {
    if (!m.current) return;
    const { width: _ } = m.current.getBoundingClientRect();
    _ > 0 && (m.current.style.width = `${_}px`);
  }, []);
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, z] = S(!1), [j, R] = S(!0), [$, E] = S(!1), D = H(!1), V = H(""), [P, I] = S(!1), [A, W] = S(), [O, J] = S(), [Tt, At] = S(), [Mt, gt] = S(), pt = H(null), G = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const st = K(
    (_, L, U = !1) => {
      var it, tt, bt;
      const q = (tt = (it = p.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (q && dn("note", q)) {
        if (q.insert.note) {
          let wt;
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      N !== "x" && _ === "x" ? wt == null || wt.forEach((Rt) => hc(Rt)) : N === "x" && _ !== "x" && (wt == null || wt.forEach((Rt) => gc(Rt))), (bt = p.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Jt = (_) => {
    ...
    (_) => {
      ...
      if (L && dn("note", L)) {
        _.content.length > 1 && setTimeout(() => {
          var Pt;
          (Pt = p.current) == null || Pt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
  ...
  }, [P, M, l]), /* @__PURE__ */ d(ct, { children: [
    /* @__PURE__ */ d("div", { ref: m, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ d("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
            /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(Ve, {}) }) }),
      ...
      /* @__PURE__ */ d(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
              /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
                B,
                {
                  onClick: Bt,
...
function Sp({
  ...
  const p = w ?? ri(n, void 0), u = (N, k) => {
    c == null || c(N, k, a);
  }, h = i ? n.findIndex((N) => N === i) : -1, [m, g] = S(h), x = (N, k, C) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
}, An = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ d(St, { children: [
  /* @__PURE__ */ d(
    Dt,
    {
...
function Lp({
  ...
  const m = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), z = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Kt(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [E, D] = S("all"), [V, P] = S(""), [I, A] = S([]), W = F(() => {
    const G = t ?? [];
  ...
  }, [R, W]), J = F(() => O.length === 0 ? [] : Tc(O, E, V), [O, E, V]), Tt = F(() => {
    var st, lt;
    if (!R) return w;
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d($e, { onValueChange: (G) => Mt(G), defaultValue: s, children: [
...
const ja = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(t), u = e ?? c, h = b.useCallback(
      ...
      [n, u]
    ), m = b.useCallback(() => h((k) => !k), [h]), g = u ? "expanded" : "collapsed", y = ht() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
...
function jp({
  ...
  const [c, p] = S([]), [u, h] = S([{ id: se, desc: !1 }]), [m, g] = S({}), x = F(
  ...
  Y(() => {
    if (l) {
      ...
      if (D.length === 1) {
        const V = x.find((P) => co(P) === D[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, y]);
    ...
    !e && /* @__PURE__ */ d(
      $e,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ce, { position: "item-aligned", children: /* @__PURE__ */ r(Fw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
function td({
  ...
  const j = F(() => ut.allBookIds.filter(
            ...
            ee,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: P, children: w }),
                  /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: I, children: c })
                ] }),
                /* @__PURE__ */ d(ne, { children: [
  ...
  if (Qi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(nd, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(kt, { children: is(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ r(Ke, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(go, {}) }) }),
...
const uu = Et.Root, Ad = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
Pd.displayName = Et.Trigger.displayName;
...
$d.displayName = Et.Content.displayName;
