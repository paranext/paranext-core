...
function va({
  ...
  let f;
  if (n) {
    const p = r === Ot.Before || r === Ot.Above, b = /* @__PURE__ */ S("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Ot.Before || r === Ot.After, g = v ? b : /* @__PURE__ */ S("div", { children: b }), h = v ? d : /* @__PURE__ */ S("div", { children: d });
    f = /* @__PURE__ */ ye(
      Xs,
      {
...
function xa() {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = a, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    return E(m) || y(m) === c;
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === p || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === a || m.$$typeof === l || m.$$typeof === d || m.$$typeof === h || m.$$typeof === x || m.$$typeof === R || m.$$typeof === g);
  }, ie.typeOf = y, ie;
}
var se = {};
/** @license React v16.13.1
...
function Ta() {
  return Eo || (Eo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y($) {
      ...
      $ === r || $ === u || $ === i || $ === o || $ === f || $ === p || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === a || $.$$typeof === l || $.$$typeof === d || $.$$typeof === h || $.$$typeof === x || $.$$typeof === R || $.$$typeof === g);
    }
    function E($) {
    ...
    var m = c, P = u, k = l, D = a, A = t, I = d, B = r, z = v, G = b, L = n, _ = i, N = o, j = f, Q = !1;
    function Z($) {
...
function Da() {
  return Ro || (Ro = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(C) {
      return !!(typeof C == "string" || typeof C == "function" || C === n || C === o || R || C === r || C === u || C === d || x || C === b || v || g || h || typeof C == "object" && C !== null && (C.$$typeof === p || C.$$typeof === f || C.$$typeof === i || C.$$typeof === a || C.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = a, k = i, D = e, A = c, I = n, B = p, z = f, G = t, L = o, _ = r, N = u, j = d, Q = !1, Z = !1;
    function O(C) {
...
process.env.NODE_ENV === "production" ? Er.exports = Aa() : Er.exports = Da();
var Cn = Er.exports;
...
function $i() {
  ...
  function n() {
    return t.current ? (Tr = !0, Ya.start(100, () => {
      Tr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
Ii.isRequired = _i;
wr.isRequired = wr;
const Ai = process.env.NODE_ENV === "production" ? wr : Ii;
function Di(e, t) {
  const n = w({}, t);
...
function Nn(e) {
  const {
    ...
    isEnabled: a = wl,
    open: l
  } = e, c = T.useRef(!1), u = T.useRef(null), d = T.useRef(null), f = T.useRef(null), p = T.useRef(null), b = T.useRef(!1), v = T.useRef(null), g = Ie(t.ref, v), h = T.useRef(null);
  T.useEffect(() => {
...
function _l(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = T.useRef({}), b = T.useRef(null), v = T.useRef(null), g = Ie(v, f), [h, x] = T.useState(!d), R = $l(c);
  let y = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (y = !1);
  const E = () => ve(b.current), m = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), P = () => {
    o.mount(m(), {
      disableScrollLock: r
    ...
    b.current = N, N && (d && D() ? P() : v.current && Zt(v.current, y));
  }), I = T.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  T.useEffect(() => () => {
...
var Oe = "top", Ae = "bottom", De = "right", Pe = "left", Mr = "auto", un = [Oe, Ae, De, Pe], Mt = "start", on = "end", Il = "clippingParents", Ui = "viewport", Ht = "popper", Al = "reference", Bo = /* @__PURE__ */ un.reduce(function(e, t) {
...
function Ql(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, a = n.modifiersData.popperOffsets, l = Le(n.placement), c = Ar(l), u = [Pe, De].indexOf(l) >= 0, d = u ? "height" : "width";
  if (!(!i || !a)) {
    var f = Zl(o.padding, n), p = Ir(i), b = c === "y" ? Oe : Pe, v = c === "y" ? Ae : De, g = n.rects.reference[d] + n.rects.reference[c] - a[c] - n.rects.popper[d], h = a[c] - n.rects.reference[c], x = dn(i), R = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, y = g / 2 - h / 2, E = f[b], m = R - p[d] - f[v], P = R / 2 - p[d] / 2 + y, k = Qt(E, P, m), D = c;
...
function Fo(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, a = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, p = a.x, b = p === void 0 ? 0 : p, v = a.y, g = v === void 0 ? 0 : v, h = typeof d == "function" ? d({
    x: b,
    y: g
  }) : {
    x: b,
  ...
  b = h.x, g = h.y;
  var x = a.hasOwnProperty("x"), R = a.hasOwnProperty("y"), y = Pe, E = Oe, m = window;
  if (u) {
    var P = dn(n), k = "clientHeight", D = "clientWidth";
    if (P === Ne(n) && (P = nt(n), Ke(P).position !== "static" && l === "absolute" && (k = "scrollHeight", D = "scrollWidth")), P = P, o === Oe || (o === Pe || o === De) && i === on) {
      E = Ae;
...
function Yi(e) {
  return ["html", "body", "#document"].indexOf(Ve(e)) >= 0 ? e.ownerDocument.body : _e(e) && Br(e) ? e : Yi(Fn(e));
}
function en(e, t) {
  var n;
  t === void 0 && (t = []);
...
function zo(e, t, n) {
  return t === Ui ? Pr(uc(e, n)) : ft(t) ? pc(t, n) : Pr(dc(nt(e)));
}
function fc(e) {
  var t = en(Fn(e)), n = ["absolute", "fixed"].indexOf(Ke(e).position) >= 0, r = n && _e(e) ? dn(e) : e;
...
function sn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, a = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? Il : l, u = n.rootBoundary, d = u === void 0 ? Ui : u, f = n.elementContext, p = f === void 0 ? Ht : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, h = g === void 0 ? 0 : g, x = Ki(typeof h != "number" ? h : Xi(h, un)), R = p === Ht ? Al : Ht, y = e.rects.popper, E = e.elements[v ? R : p], m = hc(ft(E) ? E : E.contextElement || nt(e.elements.popper), c, d, a), P = It(e.elements.reference), k = Ji({
    reference: P,
    element: y,
    strategy: "absolute",
    placement: o
  }), D = Pr(Object.assign({}, y, k)), A = p === Ht ? D : P, I = {
...
function bc(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, x = Le(h), R = x === h, y = c || (R || !v ? [On(h)] : gc(h)), E = [h].concat(y).reduce(function(F, U) {
      ...
      var B = E[I], z = Le(B), G = At(B) === Mt, L = [Oe, Ae].indexOf(z) >= 0, _ = L ? "width" : "height", N = sn(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function Ho(e) {
  return [Oe, De, Ae, Pe].some(function(t) {
    return e[t] >= 0;
  });
}
function yc(e) {
...
function xc(e, t, n) {
  var r = Le(e), o = [Pe, Oe].indexOf(r) >= 0 ? -1 : 1, i = typeof n == "function" ? n(Object.assign({}, t, {
    placement: e
  })) : n, a = i[0], l = i[1];
  return a = a || 0, l = (l || 0) * o, [Pe, De].indexOf(r) >= 0 ? {
    x: l,
    y: a
  } : {
    x: a,
...
function Sc(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = sn(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), x = Le(t.placement), R = At(t.placement), y = !R, E = Ar(x), m = kc(E), P = t.modifiersData.popperOffsets, k = t.rects.reference, D = t.rects.popper, A = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, I = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (P) {
    if (i) {
      var G, L = E === "y" ? Oe : Pe, _ = E === "y" ? Ae : De, N = E === "y" ? "height" : "width", j = P[E], Q = j + h[L], Z = j - h[_], O = b ? -D[N] / 2 : 0, M = R === Mt ? k[N] : D[N], V = R === Mt ? -D[N] : -k[N], K = t.elements.arrow, F = b && K ? Ir(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Gi(), W = U[L], q = U[_], H = Qt(0, k[N], F[N]), X = y ? k[N] / 2 - O - H - W - I.mainAxis : M - H - W - I.mainAxis, Y = y ? -k[N] / 2 + O + H + q + I.mainAxis : V + H + q + I.mainAxis, ne = t.elements.arrow && dn(t.elements.arrow), $ = ne ? E === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[E]) != null ? G : 0, C = j + X - J - $, re = j + Y - J, me = Qt(b ? $n(Q, C) : Q, j, b ? ut(Z, re) : Z);
      P[E] = me, z[E] = me - j;
    }
    if (l) {
      var xe, fe = E === "x" ? Oe : Pe, ot = E === "x" ? Ae : De, Te = P[m], Ue = m === "y" ? "height" : "width", ke = Te + h[fe], He = Te - h[ot], ge = [Oe, Pe].indexOf(x) !== -1, gt = (xe = B == null ? void 0 : B[m]) != null ? xe : 0, it = ge ? ke : Te - k[Ue] - D[Ue] - gt + I.altAxis, Lt = ge ? Te + k[Ue] + D[Ue] - gt - I.altAxis : He, mn = b && ge ? Jl(it, Te, Lt) : Qt(b ? it : ke, Te, b ? Lt : He);
      P[m] = mn, z[m] = mn - Te;
    }
    t.modifiersData[r] = z;
  }
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (qo(R, y)) {
            d.rects = {
              reference: Mc(R, dn(y), d.options.strategy === "fixed"),
              popper: Ir(y)
            ...
            for (var E = 0; E < d.orderedModifiers.length; E++) {
              ...
              var m = d.orderedModifiers[E], P = m.fn, k = m.options, D = k === void 0 ? {} : k, A = m.name;
...
const Wc = () => Ye({
  ...
  } = t, h = ce(t, Vc), x = T.useRef(null), R = Ie(x, n), y = T.useRef(null), E = Ie(y, p), m = T.useRef(E);
  dt(() => {
    m.current = E;
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: x = {}
  } = t, R = ce(t, zc), [y, E] = T.useState(!0), m = () => {
    E(!1);
  }, P = () => {
    E(!0);
  };
...
pe.propTypes = process.env.NODE_ENV !== "production" ? Hn.reduce((e, t) => (e[t] = rt, e), {}) : {};
pe.filterProps = Hn;
...
const uu = je("border", Me), du = je("borderTop", Me), pu = je("borderRight", Me), fu = je("borderBottom", Me), hu = je("borderLeft", Me), mu = je("borderColor"), gu = je("borderTopColor"), bu = je("borderRightColor"), vu = je("borderBottomColor"), yu = je("borderLeftColor"), Eu = je("outline", Me), xu = je("outlineColor"), qn = (e) => {
...
Wn(uu, du, pu, fu, hu, mu, gu, bu, vu, yu, qn, Eu, xu);
const Gn = (e) => {
...
Wn(Gn, Kn, Xn, Tu, wu, Ou, Pu, ku, Su, Cu, Ru, Nu);
function Rt(e, t) {
  return t === "grey" ? t : e;
}
const $u = he({
...
function td(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ua(a, (m) => m.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: u,
...
function Pd(e) {
  ...
  function f(g) {
    const h = Jo(g, ur.text.primary) >= n ? ur.text.primary : Zo.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const x = Jo(g, h);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Qo(g, "light", R, r), Qo(g, "dark", y, r), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: ur,
    light: Zo
  };
...
const Xd = {
...
}, dr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), Gr = /* @__PURE__ */ T.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, x = ce(t, Kd), R = Xt(), y = T.useRef(), E = hn(), m = T.useRef(null), P = Ie(m, i.ref, n), k = (_) => (N) => {
    if (_) {
      const j = m.current;
      N === void 0 ? _(j) : _(j, N);
    }
...
const Rr = Gr, Yd = (e) => {
...
}, oi = Yd, Jd = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Zd = Ee(Qi, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = rs(), i = Je({
    ...
    slots: y,
    slotProps: E
  } = i, m = ce(i, Jd), P = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, k = w({
    anchorEl: a,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const ds = /* @__PURE__ */ T.forwardRef(function(t, n) {
  var r, o, i, a, l, c, u, d, f, p, b, v, g, h, x, R, y, E, m;
  const P = Je({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: D
  }), me = hn(), xe = me.direction === "rtl", [fe, ot] = T.useState(), [Te, Ue] = T.useState(null), ke = T.useRef(!1), He = L || Z, ge = Xt(), gt = Xt(), it = Xt(), Lt = Xt(), [mn, eo] = Ni({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Jn = Ri(O), Ft = T.useRef(), gn = nn(() => {
  ...
  const to = (ee) => {
    ...
    ke.current && ee.type !== "touchstart" || (fe && fe.removeAttribute("title"), gt.clear(), it.clear(), N || Tn && j ? gt.start(Tn ? j : N, () => {
      to(ee);
    }) : to(ee));
  }, no = (ee) => {
    gt.clear(), it.start(M, () => {
    ...
    fe || ot(ee.currentTarget), As(ee), ro.current === !0 && (oo(!0), Zn(ee));
  }, ao = (ee) => {
    ke.current = !0;
    const Se = re.props;
...
`));
  const Vs = T.useMemo(() => {
    ...
    touch: ke.current
  }), tr = rp(Ut), uo = (r = (o = Y.popper) != null ? o : A.Popper) != null ? r : op, po = (i = (a = (l = Y.transition) != null ? l : A.Transition) != null ? a : $) != null ? i : Rr, fo = (c = (u = Y.tooltip) != null ? u : A.Tooltip) != null ? c : ip, ho = (d = (f = Y.arrow) != null ? f : A.Arrow) != null ? d : sp, zs = Yt(uo, w({}, H, (p = X.popper) != null ? p : I.popper, {
    className: be(tr.popper, H == null ? void 0 : H.className, (b = (v = X.popper) != null ? v : I.popper) == null ? void 0 : b.className)
  }), Ut), Us = Yt(po, w({}, J, (g = X.transition) != null ? g : I.transition), Ut), Hs = Yt(fo, w({}, (h = X.tooltip) != null ? h : I.tooltip, {
    className: be(tr.tooltip, (x = (R = X.tooltip) != null ? R : I.tooltip) == null ? void 0 : x.className)
  }), Ut), Ws = Yt(ho, w({}, (y = X.arrow) != null ? y : I.arrow, {
    className: be(tr.arrow, (E = (m = X.arrow) != null ? m : I.arrow) == null ? void 0 : E.className)
  }), Ut);
  return /* @__PURE__ */ ye(T.Fragment, {
...
const up = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], dp = (e) => {
  ...
  const r = Je({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, up), v = /* @__PURE__ */ T.isValidElement(o) && o.type === "svg", g = w({}, r, {
    color: a,
    component: l,
    fontSize: c,
...
const Mp = Es, _p = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ip = {
  ...
  } = t, y = ce(t, _p), E = T.useRef(null), m = Ie(E, l.ref, n), P = (L) => (_) => {
    if (L) {
      const N = E.current;
      _ === void 0 ? L(N) : L(N, _);
    }
...
const jp = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], Bp = (e) => {
  ...
  const a = Je({
    ...
    component: u,
    invisible: p
  }), E = Bp(y), m = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ S(h, w({
    in: b,
    timeout: x
  }, R, {
    children: /* @__PURE__ */ S(Lp, w({
      ...
      className: be(E.root, c, m == null ? void 0 : m.className),
...
const zp = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Up = (e) => {
  ...
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : x.Root) != null ? r : Hp, H = (i = (a = L == null ? void 0 : L.backdrop) != null ? a : x.Backdrop) != null ? i : d, X = (l = G == null ? void 0 : G.root) != null ? l : R.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : R.backdrop, ne = pt({
    elementType: q,
    externalSlotProps: X,
  ...
  return !I && !z && (!K || V) ? null : /* @__PURE__ */ S(rn, {
    ...
    children: /* @__PURE__ */ ye(q, w({}, ne, {
      children: [!A && d ? /* @__PURE__ */ S(H, w({}, $)) : null, /* @__PURE__ */ S(Nn, {
        disableEnforceFocus: E,
        disableAutoFocus: y,
        disableRestoreFocus: k,
        isEnabled: M,
...
const nf = (e) => {
  ...
  } = a, I = ce(a.TransitionProps, Qp), B = ce(a, ef), z = (r = E == null ? void 0 : E.paper) != null ? r : R, G = T.useRef(), L = Ie(G, z.ref), _ = w({}, a, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: h,
...
`));
    ...
    const ot = xe + C.height, Te = fe + C.width, Ue = $t(Sn(c)), ke = Ue.innerHeight - h, He = Ue.innerWidth - h;
    if (h !== null && xe < h) {
      const ge = xe - h;
...
`)), h !== null && fe < h) {
  ...
  const W = v || (c ? ve(Sn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : rf, H = (i = y == null ? void 0 : y.paper) != null ? i : Ps, X = pt({
    ...
    ownerState: _,
    className: be(N.paper, z == null ? void 0 : z.className)
  }), Y = pt({
    elementType: q,
    ...
    ownerState: _,
    className: be(N.root, b)
  }), {
    slotProps: ne
  } = Y, $ = ce(Y, tf);
  return /* @__PURE__ */ S(q, w({}, $, !Li(q) && {
    slotProps: ne,
    disableScrollLock: A
  }, {
...
const af = ["onEntering"], lf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], cf = {
  ...
  const i = Je({
    ...
    slots: R = {},
    slotProps: y = {}
  } = i, E = ce(i.TransitionProps, af), m = ce(i, lf), P = hn(), k = P.direction === "rtl", D = w({}, i, {
    autoFocus: a,
...
`)), Z.props.disabled || (x === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const _ = (r = R.paper) != null ? r : ff, N = (o = y.paper) != null ? o : b, j = pt({
    elementType: R.root,
...
function qf({ onSearch: e, placeholder: t, isFullWidth: n }) {
  ...
  return /* @__PURE__ */ S(na, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ S(
    Dn,
    {
      isFullWidth: n,
...
function Jf({
  ...
  const i = br(void 0);
  return /* @__PURE__ */ S("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ S(sa, { position: "static", id: r, children: /* @__PURE__ */ ye(aa, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ S(
      bf,
      {
        commandHandler: t,
