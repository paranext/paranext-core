...
import { c as b, g as $e, a as Vr, C as er, L as Hn, u as tn, T as Vt, b as bt, d as xt, e as yt, A as xa, r as se, D as je, f as Te, h as Fe, i as cr, j as We, B as et, x as ks, k as _s, l as Ns, I as Cs, m as To, n as Ze, o as De, p as Es, q as qn, P as lr, s as Dr, t as dr, v as wr, w as Ma, y as Oa, z as So, E as ur, F as Ia, G as $t, R as Ro, H as ya, J as so, K as co, M as lo, N as wo, O as Gn, Q as wa, S as Do, U as Fr, V as Ur, W as yr, X as Ts, Y as ir, Z as Je, _ as Ue, $ as Ye, a0 as kr, a1 as Mo, a2 as Oo, a3 as ka, a4 as Io, a5 as Wn, a6 as Ss, a7 as Rs, a8 as Ds, a9 as uo, aa as Yn, ab as za, ac as Ms, ad as Xn, ae as Os, af as Is, ag as zs, ah as en, ai as Ps, aj as As, ak as $s, al as Jn, am as Zn, an as zo, ao as Vs, ap as Qn, aq as Ha, ar as rn, as as qa, at as Ls, au as Bs, av as js, aw as Fs, ax as Us, ay as Ks, az as Gr, aA as Po, aB as Hs, aC as qs } from "./resizable-Bak4HE5M.js";
import { aD as hf, aE as gf, aF as ff, aG as mf, aH as vf, aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as jf, b3 as Ff, b4 as Uf, b5 as Kf, b6 as Hf, b7 as qf, b8 as Gf, b9 as Wf, ba as Yf, bb as Xf } from "./resizable-Bak4HE5M.js";
...
const ld = "top-match", dd = "Show recent searches", wd = "Recent";
function ud({
  recentSearches: t,
  ...
  const [h, f] = _(!1), [m, x] = _(!1), g = Na(), T = L(!1), y = w !== void 0, C = y ? w : h, N = n === "" ? "" : se(n, dd), A = se(s, wd), B = (D) => {
...
const yd = "a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]";
function kd(t) {
  return Array.from(t.querySelectorAll(yd)).filter(
    (e) => e.tabIndex >= 0
  );
}
function Xa({
  ...
  const B = De(), U = id(), [O, S] = _(!1), [D, W] = _(""), [Y, z] = _(""), [k, ot] = _("books"), [I, X] = _(void 0), [G, $] = _(
    void 0
  ...
  const { otLong: Tt, ntLong: Gt, dcLong: ar, extraLong: Ke } = {
    ...
    (v) => {
      ...
      if (!(!!q && !!((Jo = _t.current) != null && Jo.contains(q))) && (q != null && q.closest('[role="menu"], [role="menuitem"]')))
        return;
      if (v.key === "Tab") {
        const Bt = _t.current ? kd(_t.current) : [];
        if (Bt.length === 0) {
...
const zi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ed = zi ? re : Z, ca = { tag: $o };
function Td({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: s, onError: i, editorState: c, html: d } = t, l = Cd(null, o), w = pi({ editable: t.editable, html: d, namespace: n, nodes: s, onError: (p) => i(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const Sd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
function Rd({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Oe();
  return Sd(() => {
...
const zd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : Z;
function Pd(t) {
...
const Pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Vd = Pi && "documentMode" in document ? document.documentMode : null;
!(!Pi || !("InputEvent" in window) || Vd) && "getTargetRanges" in new window.InputEvent("input");
function Ee(t) {
  return `${t}px`;
}
...
function Bd(t, e, r) {
  ...
  function d() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), f = $d(t, e);
    var m, x;
...
function Ud(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? r !== null && (r(), r = null) : r === null && (r = Fd(t, e));
  };
...
function Hd(t) {
  ...
  const o = qd(t, r), n = el(o), s = rl(n) ? al(n) : o;
...
let Ea, Le = 0, Ta = 0, Xd = 0, _o = 0, fa = 0;
function Cn(t) {
  if (ht === void 0) return;
  let e = t.n;
...
te.prototype.brand = Wd, te.prototype.h = function() {
  return !0;
...
ge({ name: "@lexical/extension/DecoratorText", nodes: () => [ji], register: (t, e, r) => t.registerCommand(bi, (o) => {
  const n = ce();
  if (xi(n) || Se(n)) for (const s of n.getNodes()) tw(s) && s.toggleFormat(o);
  return !1;
}, yi) });
function Fi(t, e) {
  let r;
...
const nw = ge({ config: pr({ setOptions: Tn, updateOptions: Tn }), init: ({ $initialEditorState: t = ow }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class Nr {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && ft(298, o.name), !n) {
      n = new aw(this, o), this.extensionNameMap.set(o.name, n);
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = iw), e;
  }
}
const sw = /* @__PURE__ */ new Set(), Dn = ge({ build(t, e, r) {
  ...
  return { watchNodeKey: function(i) {
    const c = Jd(() => (s.value || sw).has(i)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(i);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(i, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [No], name: "@lexical/extension/NodeSelection" }), cw = fl("INSERT_HORIZONTAL_RULE_COMMAND");
class Cr extends ho {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: lw, priority: 0 }) };
  }
  exportDOM() {
...
ge({ dependencies: [No, Dn], name: "@lexical/extension/HorizontalRule", nodes: () => [Cr], register(t, e, r) {
  ...
  return Be(t.registerCommand(cw, (i) => {
    const c = ce();
    if (!Se(c)) return !1;
...
function ww(t, e, r = qi) {
  return Be(t.registerCommand(Rl, (o) => {
    ...
    const s = function(i) {
      ...
      const c = i.anchor, d = i.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Kd(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let f = Ml();
...
ge({ build: (t, e, r) => Mr(e), config: pr({ $canIndent: qi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Re(() => {
    if (!o.value) return ww(t, n, s);
  });
} });
const uw = ge({ name: "@lexical/react/ReactProvider" });
function pw() {
...
function vw({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(uw.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && fw(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(mw, { editor: t, ErrorBoundary: e });
}
function Mn(t) {
  return t.getEditorState().read(Gi(t.isComposing()));
}
function bw({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Oe();
  return function(n) {
    qo(() => Be(Bl(n), Wi(n)), [n]);
  }(o), u(gt, { children: [t, a(xw, { content: e }), a(vw, { editor: o, ErrorBoundary: r })] });
}
function xw({ content: t }) {
...
function yw({ defaultSelection: t }) {
  const [e] = Oe();
  return Z(() => {
    e.focus(() => {
...
function Tw(t, e) {
  ...
  return u(gt, { children: [a(Cw, { editor: n, ...o, ref: e }), r != null && a(Sw, { editor: n, content: r })] });
}
function Sw({ content: t, editor: e }) {
  const r = function(i) {
    const [c, d] = _(() => On(i));
    return Yi(() => {
      function l() {
...
function Ow({
  ...
  const [e] = Oe(), [r, o] = _(e), [n, s] = _("paragraph"), [i, c] = Mw(), d = () => {
  };
      ...
      /* @__PURE__ */ a(
        bw,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && n(i);
          }, children: /* @__PURE__ */ a(Rw, { placeholder: t }) }),
          ErrorBoundary: Id
        }
      ),
      e && /* @__PURE__ */ a(yw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(Pw, { onClear: r }),
      /* @__PURE__ */ a(_w, {})
    ] }),
    o && /* @__PURE__ */ a(
      "div",
  ...
  return (
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ a(Td, { initialConfig: l, children: /* @__PURE__ */ u(Vt, { children: [
          /* @__PURE__ */ a(
            Aw,
            {
              placeholder: n,
          ...
          /* @__PURE__ */ a(Rd, { ignoreSelectionChange: !0, onChange: w })
        ] }) })
      }
    )
  );
...
const Lw = "verseText", hh = Object.freeze([
...
function as(t) {
  return (t == null ? void 0 : t.conflictType) === Lw;
}
function os(t) {
        ...
        /* @__PURE__ */ u(
          We,
          {
            onClick: (z) => {
              ...
              g(k ? Vw(t.contents) : Bw), i == null || i(!0);
            },
            children: [
...
function fu({
  ...
  return /* @__PURE__ */ u(je, { open: p, onOpenChange: g, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: gu(t, o, e) }) }) }),
...
function bu({
  ...
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(bt, { children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(et, { variant: "outline", className: "tw:h-6", children: mu(t, r) }) }) }),
...
const qe = "scrBook", Xu = "scrRef", nr = "source", Ju = "details", Zu = "Scripture Reference", Qu = "Scripture Book", ls = "Type", tp = "Details";
function ep(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(au, { children: N.map((S) => /* @__PURE__ */ a(ye, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
