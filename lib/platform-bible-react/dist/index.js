...
var Gi = (t, e, r) => e in t ? Hi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var jt = (t, e, r) => Gi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as fe, a as Nr, C as Te, u as Ro, T as Mt, b as Ot, d as It, e as $t, A as pe, P as Pe, f as Ze, B as J, h as Ae, i as Ve, j as Le, k as Ce, x as Wi, l as Yi, m as Xi, I as Ji, n as ao, r as xe, o as Zi, p as yn, q as ia, s as sa, L as Nt, R as oo, t as Zr, D as Aa, v as Va, w as La, y as ja, z as kn, E as Kr, F as no, G as _n, H as io, J as Xe, K as Sr, M as je, N as Be, O as Fe, S as Rr, Q as ir, U as Qi, V as Mr, W as Je, X as Oe, Z as Qe, Y as De, _ as sr, $ as so, a0 as co, a1 as Qr, a2 as lo, a3 as Nn, a4 as ts, a5 as es, a6 as rs, a7 as Ba, a8 as Cn, a9 as ca, aa as as, ab as En, ac as os, ad as ns, ae as is, af as zo, ag as ss, ah as cs, ai as ls, aj as Tn, ak as Sn, al as wo, am as ds, an as Rn, ao as ya, ap as Do, aq as ka, ar as ws, as as us, at as ps, au as hs, av as gs, aw as Or, ax as uo, ay as fs, az as ms } from "./resizable-BTh0w_GD.js";
import { aA as _g, aB as Ng, aC as Cg, aD as Eg, aE as Tg, aF as Sg, aG as Rg, aH as zg, aI as Dg, aJ as Mg, aK as Og, aL as Ig, aM as $g, aN as Pg, aO as Ag, aP as Vg, aQ as Lg, aR as jg, aS as Bg, aT as Fg, aU as Ug, aV as Kg, aW as qg, aX as Hg, aY as Gg, aZ as Wg, a_ as Yg, a$ as Xg, b0 as Jg, b1 as Zg, b2 as Qg, b3 as tf, b4 as ef, b5 as rf, b6 as af, b7 as of, b8 as nf, b9 as sf } from "./resizable-BTh0w_GD.js";
import { jsx as a, jsxs as u, Fragment as wt } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Mo, ChevronsLeft as Oo, ChevronsRight as Io, ChevronLeft as Fa, ChevronRight as Ua, ArrowLeft as vs, ArrowRight as bs, ChevronDown as dr, BoldIcon as xs, ItalicIcon as ys, X as po, AtSign as zn, Pencil as ks, Trash2 as _s, ArrowUp as Dn, MoreHorizontal as Ns, MailOpen as Cs, Mail as Es, ChevronUp as Ts, FilterIcon as Ss, ArrowLeftIcon as Rs, ChevronLeftIcon as zs, ChevronRightIcon as Ds, ArrowRightIcon as Ms, Copy as Mn, Filter as Os, User as Is, Link as $s, CircleHelp as Ps, Undo as As, Redo as Vs, SquareX as On, FunctionSquare as In, SquareSigma as $n, Ban as Ls, AlertCircle as Ka, CircleCheckIcon as js, CircleXIcon as Bs, CircleHelpIcon as Fs, ArrowUpIcon as Us, ArrowDownIcon as Ks, ScrollText as qs, ChevronsUpDown as Hs, MenuIcon as Gs, Menu as Ws, EllipsisVertical as Ys, MoreVertical as Xs } from "lucide-react";
import { Section as _t, getChaptersForBook as Js, formatScrRef as _e, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as Zs, sanitizeHtml as ho, NumberFormat as Pn, formatBytes as Qs, getCurrentLocale as tc, usfmMarkers as Hr, isPlatformError as ec, ABORTED as rc, getErrorMessage as ac, getFormatCallerFunction as oc, deepEqual as nc, isString as $o, compareScrRefs as qa, scrRefToBBBCCCVVV as _a, defaultScrRef as Na, formatScrRefRange as ic, getLocalizeKeyForScrollGroupId as Po, formatReplacementStringToArray as Ao, collectUsjMarkers as sc } from "platform-bible-utils";
import Ft, { useRef as U, useMemo as A, createContext as Ir, useContext as la, useState as _, useEffect as Y, useCallback as L, useImperativeHandle as cc, useLayoutEffect as Jt, Component as lc, createElement as Vo, Suspense as dc, forwardRef as An, useId as Lo, Fragment as da } from "react";
import { IconSelector as Vn, IconCheck as wa, IconChevronDown as wc, IconChevronUp as uc, IconLayoutSidebar as pc, IconLayoutSidebarRight as hc, IconChevronRight as Ln, IconSearch as gc, IconLoader as fc, IconAlertOctagon as mc, IconAlertTriangle as vc, IconInfoCircle as bc, IconCircleCheck as xc } from "@tabler/icons-react";
import { createEditor as jn, $getRoot as $e, $createParagraphNode as $r, $getSelection as Zt, HISTORY_MERGE_TAG as go, ParagraphNode as Bn, TextNode as Fn, $getPreviousSelection as yc, $isRangeSelection as ve, $caretFromPoint as kc, $getSiblingCaret as Un, $getChildCaret as _c, $getAdjacentChildCaret as Nc, $isChildCaret as Cc, $normalizeCaret as Ec, $setSelectionFromCaretRange as Tc, $getCollapsedCaretRange as Sc, $getCaretInDirection as jo, $splitAtPointCaretNext as Rc, $isTextPointCaret as zc, $findMatchingParent as Kn, $isElementNode as zr, mergeRegister as Ee, getDOMTextNode as Dc, isHTMLElement as Mc, CLEAR_EDITOR_COMMAND as qn, COMMAND_PRIORITY_EDITOR as fo, shallowMergeConfig as Oc, defineExtension as ne, safeCast as tr, createState as Ic, FORMAT_TEXT_COMMAND as Hn, $isNodeSelection as Gn, COMMAND_PRIORITY_LOW as Wn, RootNode as $c, LineBreakNode as Pc, TabNode as Ac, $isEditorState as Vc, createCommand as Lc, CLICK_COMMAND as jc, isDOMNode as Bc, $getNodeFromDOMNode as Fc, $createNodeSelection as Uc, $setSelection as Kc, $getEditor as qc, DecoratorNode as Ha, $getState as Hc, toggleTextFormatType as Bo, TEXT_TYPE_TO_FORMAT as Gc, $setState as Wc, addClassNamesToElement as Yn, $create as Yc, $getNodeByKey as Xc, removeClassNamesFromElement as Jc, KEY_TAB_COMMAND as Zc, $isBlockElementNode as Qc, $createRangeSelection as tl, $normalizeSelection__EXPERIMENTAL as el, OUTDENT_CONTENT_COMMAND as rl, INDENT_CONTENT_COMMAND as Fo, INSERT_TAB_COMMAND as al, COMMAND_PRIORITY_CRITICAL as mo, $isDecoratorNode as ol, $isParagraphNode as nl, $isTextNode as Ga, SELECTION_CHANGE_COMMAND as Xn, $insertNodes as il } from "lexical";
import { HeadingNode as sl, QuoteNode as cl, registerRichText as ll } from "@lexical/rich-text";
import { flushSync as dl, createPortal as wl } from "react-dom";
import { $isTableSelection as ul } from "@lexical/table";
import { createHeadlessEditor as Jn } from "@lexical/headless";
import { $generateHtmlFromNodes as pl, $generateNodesFromDOM as hl } from "@lexical/html";
import { Avatar as vo, Select as Ut, Checkbox as Uo, Slot as Pr, Tabs as he, Menubar as ye, ContextMenu as Pt, Progress as Ko, Slider as Lr, Switch as qo } from "radix-ui";
import { useReactTable as Zn, getFilteredRowModel as gl, getSortedRowModel as Qn, getPaginationRowModel as fl, getCoreRowModel as ti, flexRender as Cr, getGroupedRowModel as ml, getExpandedRowModel as vl } from "@tanstack/react-table";
import bl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Wa, HIDDEN_NOTE_CALLER as Ya, getDefaultViewOptions as xl, isInsertEmbedOpOfType as yr, getMarkerMenuItems as yl, defaultStyleInfo as kl, Editorial as _l } from "@eten-tech-foundation/platform-editor";
...
import { useTheme as Cl } from "next-themes";
...
function ri({
  ...
  const g = U(!1), f = () => {
    ...
    () => Nr(e, l),
    [e, l]
  ), y = !!p && !w, C = `${v} (${R})`, T = y ? h || `${C}, ${p}` : C, $ = /* @__PURE__ */ u(
    Te,
    {
      ref: t,
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: m(
        ...
        {
          "tw:border-s-red-200": i === _t.OT,
          "tw:border-s-purple-200": i === _t.NT,
          "tw:border-s-indigo-200": i === _t.DC,
          "tw:border-s-amber-200": i === _t.Extra
        }
      ),
      children: $
    }
...
function Rl({
  ...
  Y(() => {
    ...
    if (!Q) return;
    const N = (H) => !!H && H.scrollWidth > H.clientWidth, et = () => {
      Xa !== "pointer" && (E || N(h.current) || N(l.current)) && C(!0);
    }, D = () => C(!1);
  ...
  const z = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), q = $ ? (
  ...
  return /* @__PURE__ */ u(Pe, { open: b, onOpenChange: v, children: [
    /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ a(
      J,
      {
        ...
        className: l,
        "aria-label": n,
        children: /* @__PURE__ */ a(Mo, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ a(Ce, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      Te,
      {
        onSelect: () => R(y),
        className: m("tw:flex tw:items-center", c),
        children: [
          /* @__PURE__ */ a(Mo, { className: "tw:mr-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function yp(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function Ja(t) {
  return {
    [_t.OT]: t.filter((e) => Dt.isBookOT(e)),
    [_t.NT]: t.filter((e) => Dt.isBookNT(e)),
    [_t.DC]: t.filter((e) => Dt.isBookDC(e)),
    [_t.Extra]: t.filter((e) => Dt.extraBooks().includes(e))
  };
}
function Pl(t, e) {
  const r = new Set(t), o = e.filter((d) => !r.has(d)), n = new Set(o), i = n.size === 0 ? t : Dt.allBookIds.filter(
    (d) => r.has(d) || n.has(d)
  ), s = Ja(i), c = Object.values(s).flat(), l = Ja(t);
  return {
...
function ii({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function Ea({
  ...
  const E = xe(), B = Tl(), [I, z] = _(!1), [q, W] = _(""), [j, Q] = _(""), [N, et] = _("books"), [D, M] = _(void 0), [H, nt] = _(
    void 0
  ), [ot, pt] = _(void 0), [St, Z] = _(!1), ct = U(null), ft = U(!1), lt = U(void 0), ht = U(void 0), Ct = U(void 0), bt = U(void 0), ie = U({}), Qt = U({}), mt = L(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    projectBooksBySection: qt,
    reachableBooksBySection: yt,
    reachableBooks: xt,
    projectBooks: Vt,
    booksOutsideProject: te
  } = A(
    () => Pl(Kt, Rt),
    [Kt, Rt]
  ), se = te.has(t.book), ce = A(() => j.trim() ? Ja(
    xt.filter((k) => ao(k, j, i))
  ) : St ? yt : qt, [
    qt,
    yt,
    xt,
  ...
  const re = L(() => {
    if (V) {
      const k = V.chapterNum ?? 1, rt = V.verseNum ?? 1;
      if (p && Ca(V.book, k, rt, p))
        return;
      mt({
        book: V.book,
        chapterNum: k,
    ...
    (k) => {
      const rt = H ?? (V == null ? void 0 : V.book), at = ot ?? (V == null ? void 0 : V.chapterNum);
      !rt || !at || (mt({
        book: rt,
        chapterNum: at,
        verseNum: k
    ...
    (k) => {
      const rt = N === "chapters" ? D : V == null ? void 0 : V.book;
      if (rt) {
        if (w && w(rt, k) > 1) {
          nt(rt), pt(k), et("verses"), W("");
          return;
        }
        mt({
          book: rt,
    ...
    et("books"), M(void 0), nt(void 0), pt(void 0), setTimeout(() => {
      ht.current && ht.current.focus();
    }, 0);
  }, []), de = L(() => {
    const k = H;
    nt(void 0), pt(void 0), k ? (M(k), et("chapters"), W("")) : Wt();
  }, [H, Wt]), S = L(
    (k) => {
      z(k), k && (et("books"), M(void 0), nt(void 0), pt(void 0), Q(""), Z(se));
    },
    [se]
  );
  Y(() => {
  ...
  const { otLong: x, ntLong: K, dcLong: P, extraLong: tt } = {
    ...
    () => B >= Er.TIGHT ? Nr(t.book, i) : fe(t.book, i),
    [t.book, i, B]
  ), At = `${t.chapterNum}:${t.verseNum}`, Yt = L((k) => (rt) => {
    ie.current[k] = rt;
  }, []), mr = L((k) => (rt) => {
    Qt.current[k] = rt;
  }, []), Ke = A(
    () => Ol(j),
    [j]
  ), Se = A(() => !w || !V || !V.chapterNum || !Ke ? !1 : w(V.book, V.chapterNum) > 0, [w, V, Ke]), fa = N === "books" && !j.trim() && te.size > 0, So = L(
    (k) => p ? Go(k, p) : !1,
    [p]
  ), Ar = L(
    (k) => (rt) => p ? Il(k, rt, p) : !1,
    ...
    (k, rt) => (at) => p ? Ca(k, rt, at, p) : !1,
    [p]
  ), br = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", er = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", Vr = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "Not in project", qe = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProjectDescription%"]) || "{book} is not in this project", ma = L(
    (k) => Me(qe, {
      book: `${fe(k, i)} (${Nr(
        k,
        i
    ...
    [qe, i]
  ), rr = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", va = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", ar = L(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), h && h.includes(k.key) && V && V.chapterNum !== void 0 && V.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), re());
    },
    [h, V, re]
  ), ba = L(
    (k) => {
      var we, He, Ge;
      if (k.ctrlKey) return;
      const { isLetter: rt, isDigit: at } = Wo(k.key);
      if ((N === "chapters" || N === "verses") && (k.key === " " || k.key === "Enter")) {
        const O = k.target instanceof HTMLElement ? k.target : void 0;
        if (!!(O != null && O.closest(
        ...
        const st = (we = lt.current) == null ? void 0 : we.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (st) {
          k.preventDefault(), k.stopPropagation(), st.click();
          return;
        }
      }
      ...
      if (N === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), Wt();
        return;
      }
      if (N === "verses" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), de();
        return;
      }
      const Xt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(k.key);
      if (N === "verses" && Xt) {
        const O = H, G = ot;
        if (!O || !G || !w) return;
        const st = w(O, G);
        if (!st) return;
        (He = lt.current) == null || He.focus();
        const gt = (() => {
          if (!q) return 1;
          const xr = q.match(/:(\d+)$/);
        ...
        switch (k.key) {
          case "ArrowLeft":
            gt !== 0 && (ae = gt > 1 ? gt - 1 : st);
            break;
          case "ArrowRight":
            gt !== 0 && (ae = gt < st ? gt + 1 : 1);
            break;
          case "ArrowUp":
            ae = gt === 0 ? st : Math.max(1, gt - Re);
            break;
          case "ArrowDown":
            ae = gt === 0 ? 1 : Math.min(st, gt + Re);
            break;
          default:
            return;
        }
        ae !== gt && (k.preventDefault(), k.stopPropagation(), W(
          `${O} ${pe[O] || ""} ${G}:${ae}`
        ), setTimeout(() => {
          const xr = Qt.current[ae];
          xr && xr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((N === "chapters" || N === "books" && V) && Xt) {
        const O = N === "chapters" ? D : V == null ? void 0 : V.book;
        if (!O) return;
        N === "chapters" && ((Ge = lt.current) == null || Ge.focus());
        const G = (() => {
          if (!q) return 1;
          const Re = q.match(/(\d+)$/);
        ...
        switch (k.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            gt = G === 0 ? st : Math.max(1, G - ae);
            break;
          case "ArrowDown":
            gt = G === 0 ? 1 : Math.min(st, G + ae);
            break;
          default:
            return;
        }
        gt !== G && (k.preventDefault(), k.stopPropagation(), W(
          `${O} ${pe[O] || ""} ${gt}`
        ), setTimeout(() => {
          const Re = ie.current[gt];
    ...
    if (k.key === "ArrowUp" || k.key === "ArrowDown") {
      (Xt = ht.current) == null || Xt.focus();
      return;
    }
    const { isLetter: rt, isDigit: at } = Wo(k.key);
    (rt || at) && (k.preventDefault(), Q((we) => we + k.key), ht.current.focus());
  }, []);
  return Jt(() => {
    const k = setTimeout(() => {
      if (I && N === "books" && Ct.current && bt.current) {
        const rt = Ct.current, at = bt.current, Xt = at.offsetTop, we = rt.clientHeight, He = at.clientHeight, Ge = Xt - we / 2 + He / 2;
        rt.scrollTo({
          top: Math.max(0, Ge),
          behavior: "smooth"
        }), W(ni(t.book));
    ...
    if (N === "chapters" && D) {
      ...
      W(
        ...
        if (Ct.current)
          if (k) {
            const at = ie.current[t.chapterNum];
  ...
  }, [N, D, V, t.book, t.chapterNum]), Jt(() => {
    if (N === "verses" && H && ot !== void 0) {
      const k = H === t.book && ot === t.chapterNum, rt = k ? t.verseNum : 1;
      W(
        `${H} ${pe[H] || ""} ${ot}:${rt}`
      ), setTimeout(() => {
        if (Ct.current)
          if (k) {
            const at = Qt.current[t.verseNum];
            at && at.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Ct.current.scrollTo({ top: 0 });
        lt.current && lt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Pe, { open: I, onOpenChange: S, modal: y, children: [
    /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        ...
        onClick: (k) => {
          ft.current && (ft.current = !1, k.preventDefault());
        },
        children: [
          g ?? /* @__PURE__ */ a(
            Rl,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: rt } = k;
          I && ct.current && rt instanceof Node && ct.current.contains(rt) && (ft.current = !0, S(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          Ve,
          {
            ...
            shouldFilter: !1,
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:pe-2", children: Gt.map(
                  ({ onClick: k, disabled: rt, title: at, icon: Xt }) => /* @__PURE__ */ a(
                    J,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  J,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: N === "verses" ? de : Wt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: E === "ltr" ? /* @__PURE__ */ a(vs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(bs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && D && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: fe(D, i) }),
                N === "verses" && H && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${fe(H, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? er : br
                  }
                )
              ] }),
              /* @__PURE__ */ u(Le, { ref: Ct, children: [
                N === "books" && /* @__PURE__ */ u(wt, { children: [
                  !V && Object.entries(ce).map(([k, rt]) => {
                    if (rt.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ce, { heading: dt(k), children: rt.map((at) => /* @__PURE__ */ a(
                          ri,
                          {
                            bookId: at,
                            onSelect: (Xt) => Et(Xt),
                            section: qr(at),
                            commandValue: `${at} ${pe[at]}`,
                            ref: at === t.book ? bt : void 0,
                            localizedBookNames: i,
                            disabled: So(at),
                            dimmedReason: te.has(at) ? Vr : void 0,
                            dimmedDescription: te.has(at) ? ma(at) : void 0
                          },
                          at
                        )) }, k)
                      );
                  ...
                  V && /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(
                    Te,
                    {
                      value: `${V.book} ${pe[V.book]} ${V.chapterNum || ""}:${V.verseNum || ""})}`,
                      onSelect: re,
                      disabled: !!p && Ca(
                        V.book,
                        V.chapterNum ?? 1,
                      ...
                      children: _e(
                        ...
                        // one control.
                        i ? Nr(V.book, i) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  V && Se && V.chapterNum && w && /* @__PURE__ */ u(wt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Xo,
                      {
                        ...
                        onVerseSelect: Lt,
                        setVerseRef: mr,
                        isVerseDisabled: vr(V.book, V.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  V && !Se && cr(V.book) > 1 && /* @__PURE__ */ u(wt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                ...
                N === "chapters" && D && /* @__PURE__ */ a(
                  Yo,
                  {
                    ...
                    onChapterSelect: le,
                    setChapterRef: Yt,
                    isChapterDisabled: Ar(D),
                    className: "tw:p-4"
                  }
                ),
                N === "verses" && H && ot !== void 0 && w && /* @__PURE__ */ a(
                  Xo,
                  {
                    bookId: H,
                    chapterNum: ot,
              ...
              fa && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                J,
                {
                  variant: "ghost",
                  size: "sm",
...
function Jo({
  ...
  const [C, T] = _(!1), $ = d ?? l, E = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], B = (I, z) => {
    const q = l(I), W = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, j = `${z ?? ""}${q}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Te,
      {
        value: q,
  ...
  return /* @__PURE__ */ u(Pe, { open: C, onOpenChange: T, ...y, children: [
    /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: E(e) ? e.map((I) => /* @__PURE__ */ a(Ce, { heading: I.groupHeading, children: I.options.map((z) => B(z, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(Ce, { children: e.map((I) => B(I)) }) })
        ] })
      }
    )
  ] });
...
var Za = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(Za || {});
((t) => {
...
function Np({
  ...
  const w = Ta(d, "%webView_bookSelector_currentBook%"), p = Ta(d, "%webView_bookSelector_choose%"), h = Ta(d, "%webView_bookSelector_chooseBooks%"), [g, f] = _(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    f(v), t(v);
...
const ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, jl = ci ? Jt : Y, Br = { tag: go };
function Bl({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Ll(null, o), w = jn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = $r();
            g.append(f);
            const b = ci ? document.activeElement : null;
  ...
  }, []), a(si.Provider, { value: r, children: e });
}
const Fl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Ul({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = ke();
  return Fl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(go) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const bo = {
...
class ql extends lc {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && Hl(e.resetKeys, n)) {
      var i, s;
...
function Gl({ children: t, onError: e }) {
  return a(ql, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Wl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Yl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Xl() {
  return function(t) {
    const [e] = ke(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = U(o);
    return Wl(() => {
...
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Zl = li && "documentMode" in document ? document.documentMode : null;
!(!li || !("InputEvent" in window) || Zl) && "getTargetRanges" in new window.InputEvent("input");
function me(t) {
  return `${t}px`;
}
...
function td(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), g = Jl(t, e);
    var f, b;
    ...
    for (let R = 0; R < g.length; R++) {
      ...
      const B = me(y.width);
      T.width !== B && (C.style.width = B, v = !0);
      const I = me(y.height);
      T.height !== I && (C.style.height = I, v = !0), C.parentNode !== c && (c.append(C), v = !0), s[R] = C;
    }
...
function rd(t, e = ed) {
  ...
  function d(w) {
    w.read(() => {
      const p = Zt();
      if (!ve(p)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function(I) {
        const z = I.getStartEndPoints();
        return I.isBackward() ? [z[1], z[0]] : z;
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, R = g.getNode(), y = R.getKey(), C = g.offset, T = t.getElementByKey(b), $ = t.getElementByKey(y), E = r === null || T !== o || v !== n || b !== r.getKey(), B = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((E || B) && T !== null && $ !== null) {
        const I = function(z, q, W, j, Q, N, et) {
          const D = (z._window ? z._window.document : document).createRange();
          return D.setStart(...Zo(q, W, j)), D.setEnd(...Zo(Q, N, et)), D;
        }(t, h, f, T, g, R, $);
        l(), l = td(t, I, e);
      }
      r = f, o = T, n = v, i = R, s = $, c = C;
    });
  }
...
function ad(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = rd(t, e));
  };
...
function od(t) {
  const e = Kn(t, (r) => zr(r) && !r.isInline());
  return zr(e) || ta(4, t.__key), e;
}
function nd(t) {
  const e = Zt() || yc();
  let r;
  if (ve(e)) r = kc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Un(c, "next"));
    }
    r = r || _c($e(), "previous").getFlipped().insert($r());
  }
  const o = id(t, r), n = Nc(o), i = Cc(n) ? Ec(n) : o;
  return Tc(Sc(i)), t.getLatest();
}
function id(t, e, r) {
  let o = jo(e, "next");
  for (let n = o; n; n = Rc(n, r)) o = n;
  return zc(o) && ta(283), o.insert(t.isInline() ? $r().append(t) : t), jo(Un(t.getLatest(), "next"), e.direction);
}
function sd(t) {
  const e = Zt();
  if (!ve(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Kn(i, (d) => zr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
const cd = Symbol.for("preact-signals");
function pa() {
  ...
  for (!function() {
    ...
    for (Tr = void 0, ra++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && di(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let ea, Ne = 0, ra = 0, dd = 0, Qa = 0, Wr = 0;
function tn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function We(t, e) {
  Bt.call(this, void 0), this.x = t, this.s = void 0, this.g = Wr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function wd(t, e) {
  return new We(t, e);
}
...
function yo(t) {
  ...
  t.x = void 0, t.s = void 0, ui(t);
}
function ud(t) {
  if (it !== this) throw new Error("Out-of-order effect");
  wi(this), it = t, this.f &= -2, 8 & this.f && yo(this), pa();
}
function nr(t, e) {
...
Bt.prototype.brand = cd, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && ra === 0 && e.l !== Qa && (e.l = Qa, ea = { S: e, v: e.v, i: e.i, o: ea });
    })(this), this.v = t, this.i++, Wr++, Ne++;
    try {
...
} }), We.prototype = new Bt(), We.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Wr)) return !0;
  if (this.g = Wr, this.f |= 1, this.i > 0 && !di(this)) return this.f &= -2, !0;
  const t = it;
  try {
    en(this), it = this;
    const e = this.x();
  ...
  return it = t, wi(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ui(this), en(this), Ne++;
  const t = it;
  return it = this, ud.bind(this, t);
...
ne({ build: (t, e, r) => fr(e), config: tr({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function hi(t, e = pi) {
  return t.registerCommand(qn, (r) => (t.update(e), !0), fo);
}
ne({ build: (t, e, r) => fr(e), config: tr({ $onClear: pi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return be(() => hi(t, o.value));
} });
function pd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ra = Ic("format", { parse: (t) => typeof t == "number" ? t : 0 });
class gi extends Ha {
  $config() {
    return this.config("decorator-text", { extends: Ha, stateConfigs: [{ flat: !0, stateConfig: Ra }] });
  }
  getFormat() {
    return Hc(this, Ra);
  }
  getFormatFlags(e, r) {
    return Bo(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = Gc[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = Bo(r, e, null);
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [gi], register: (t, e, r) => t.registerCommand(Hn, (o) => {
  const n = Zt();
  if (Gn(n) || ve(n)) for (const i of n.getNodes()) hd(i) && i.toggleFormat(o);
  return !1;
}, Wn) });
function fi(t, e) {
  let r;
...
const to = ne({ build: (t) => fi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function mi(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = mi(r[n], o[n]);
    return t;
  }
  return e;
}
const ko = 0, eo = 1, vi = 2, za = 3, Fr = 4, or = 5, Da = 6, kr = 7;
function Ma(t) {
  return t.id === ko;
}
function bi(t) {
...
function gd(t) {
  return function(e) {
    return e.id === eo;
  }(t) || ut(305, String(t.id), String(eo)), Object.assign(t, { id: vi });
}
...
class md {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Fr && ut(307, String(r.id), String(or)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== or && ut(308, String(o.id), String(or));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(i) {
      return Object.assign(i, { id: Da });
    }(o), () => {
      const i = this.state;
      i.id !== kr && ut(309, String(o.id), String(kr)), this.state = function(s) {
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Da && ut(310, String(r.id), String(Da)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Fr;
    }(e) || ut(313, String(e.id), String(Fr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= za;
    }(e) || ut(314, String(e.id), String(za)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= kr;
    }(e) || ut(316, String(e.id), String(kr)), e;
  }
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || fd;
  }
  getPeerNameSet() {
...
const bd = ne({ config: tr({ setOptions: rn, updateOptions: rn }), init: ({ $initialEditorState: t = vd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [$c, Fn, Pc, Ac, Bn] }), an = Symbol.for("@lexical/extension/LexicalBuilder");
function on() {
}
function xd(t) {
  throw t;
...
class lr {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Oa, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[an];
    return r && (r.PACKAGE_VERSION !== Oa && ut(292, r.PACKAGE_VERSION, Oa), r instanceof lr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && ut(298, o.name), !n) {
      n = new md(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ma(i) || ut(300, s, n || "[unknown]"), Ma(c = i) || ut(304, String(c.id), String(ko)), i = Object.assign(c, { id: eo }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = gd(i), o.state = i, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of pd(p)) {
    ...
    return e.onError || (e.onError = xd), e;
  }
}
const yd = /* @__PURE__ */ new Set(), nn = ne({ build(t, e, r) {
  const o = r.getDependency(to).output, n = Dr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = fi(() => {
  }, () => be(() => {
...
class wr extends Ha {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: _d, priority: 0 }) };
  }
  exportDOM() {
...
ne({ dependencies: [to, nn], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(nn).output, n = Dr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ee(t.registerCommand(kd, (s) => {
    const c = Zt();
    if (!ve(c)) return !1;
    ...
    return !0;
  }, fo), t.registerCommand(jc, (s) => {
    if (Bc(s.target)) {
      const c = Fc(s.target);
      if (Nd(c)) return function(l, d = !1) {
        const w = Zt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Gn(w) ? g = w : (g = Uc(), Kc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Wn), t.registerMutationListener(wr, (s, c) => {
    ld(() => {
      let l = !1;
    ...
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(be(() => {
      const d = c.value;
      d && (l.value ? Yn(d, i) : Jc(d, i));
    }));
    return Ee(...s);
  }));
} });
ne({ build: (t, e) => fr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: tr({ $getParentEditor: function() {
  const t = qc();
...
ne({ build: (t, e, r) => fr(e), config: tr({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return be(() => {
...
function Cd(t, e, r = xi) {
  return Ee(t.registerCommand(Zc, (o) => {
    const n = Zt();
    if (!ve(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Qc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = od(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = tl();
      ...
      return !1;
    }(n) ? o.shiftKey ? rl : Fo : al;
    return t.dispatchCommand(i, void 0);
  }, fo), t.registerCommand(Fo, () => {
...
ne({ build: (t, e, r) => fr(e), config: tr({ $canIndent: xi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return be(() => {
    if (!o.value) return Cd(t, n, i);
  });
} });
const Ed = ne({ name: "@lexical/react/ReactProvider" });
function Td() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ve(f)) {
                ...
                if (Ga(v) && d >= 0 && w >= 0 && (R = d, y = d + w, f.setTextNodeRange(v, R, v, y)), R === y && p === "" || (f.insertRawText(p), v = b.getNode()), Ga(v)) {
                  R = h, y = h + g;
...
ne({ build: (t, e, r) => fr(e), config: tr({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => be(() => r.getOutput().disabled.value ? void 0 : ki(t)) });
function zd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const No = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
  ...
  return function(r, o) {
    ...
    return No(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(dc, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(wl(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Md({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Ed.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && zd(320, n);
      return !0;
    }
    return !1;
...
function Od({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    No(() => Ee(ll(n), ki(n)), [n]);
  }(o), u(wt, { children: [t, a(Id, { content: e }), a(Md, { editor: o, ErrorBoundary: r })] });
}
function Id({ content: t }) {
...
const Pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function Ad({ onClear: t }) {
  const [e] = ke();
  return Pd(() => hi(e, t), [e, t]), null;
}
const _i = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Bd(t, e) {
  ...
  return u(wt, { children: [a(Ld, { editor: n, ...o, ref: e }), r != null && a(Fd, { editor: n, content: r })] });
}
function Fd({ content: t, editor: e }) {
  const r = function(s) {
    const [c, l] = _(() => cn(s));
    return _i(() => {
      function d() {
...
function qd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Aa, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Va, { children: [
      /* @__PURE__ */ a(La, { children: /* @__PURE__ */ a(ja, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function Hd({
  ...
  const [e] = ke(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = qd(), l = () => {
  };
...
function Wd() {
  const { activeEditor: t } = Ci(), [e, r] = _([]), o = L((n) => {
    if (ve(n) || ul(n)) {
      const i = [];
      ln.forEach(({ format: s }) => {
  ...
  return Gd(o), /* @__PURE__ */ a(
    kn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: ln.map(({ format: n, icon: i, label: s }) => /* @__PURE__ */ a(
        Kr,
        {
          value: n,
          "aria-label": s,
...
function Xd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Hd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Wd, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Od,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Ud, { placeholder: t }) }),
          ErrorBoundary: Gl
        }
      ),
      e && /* @__PURE__ */ a($d, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ a(
          Bl,
          {
            ...
            children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Xd, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Ul,
                {
...
function Ti(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Ti(e.children)
  ) : !1;
}
function oe(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Ti(t.root.children) : !1;
}
function Zd(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = hl(e, n);
      $e().clear(), il(i);
    },
    {
      discrete: !0
...
function Ri({
  ...
  const s = dn(o, "%cancelButton_tooltip%"), c = i ?? dn(o, "%acceptButton_tooltip%");
...
const Qd = "verseText", Cp = Object.freeze([
...
function Di(t) {
  return (t == null ? void 0 : t.conflictType) === Qd;
}
function Mi(t) {
...
function Ep({
  ...
  const [i, s] = _(tw), [c, l] = _(n), [d, w] = _(!1), p = U(void 0), h = U(null);
  Y(() => {
    let v = !0;
    const R = h.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Pe, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ u(
        J,
        {
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(zn, { className: "tw:h-4 tw:w-4" }),
            /* @__PURE__ */ a("span", { children: Ia(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : Eo(v) && (v.preventDefault(), v.stopPropagation(), oe(i) && g());
        },
        onKeyDown: (v) => {
...
function wn({
  ...
  const g = L(
    ...
    [t.user]
  ), y = A(() => ho(t.contents), [t.contents]), C = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), T = !!t.conflictResolutionAction && !C, $ = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(wt, { children: [
        /* @__PURE__ */ u(
          Xe,
          {
            onClick: (E) => {
              E.stopPropagation(), d(!0), p(Zd(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u(
          Xe,
          {
            ...
            children: [
              /* @__PURE__ */ a(_s, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(ow, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(nw, { className: "tw:text-xs tw:font-medium", children: R }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (E) => {
                E.key === "Escape" ? (E.preventDefault(), E.stopPropagation(), g()) : Eo(E) && (E.preventDefault(), E.stopPropagation(), oe(w) && f());
              },
              onKeyDown: (E) => {
                Co(E), (E.key === "Enter" || E.key === " ") && E.stopPropagation();
              },
              onClick: (E) => {
                E.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(wt, { children: [
            ...
            T ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: Mi(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: m(
        ...
        $ && /* @__PURE__ */ u(je, { children: [
          /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ns, {}) }) }),
...
function Ii({
  ...
  const [j, Q] = _(un), [N, et] = _(), [D, M] = _(), H = o, [nt, ot] = _(!1), [pt, St] = _(!1), [Z, ct] = _(!1), [ft, lt] = _(!1), [ht, Ct] = _(!1), [bt, ie] = _(T), [Qt, mt] = _(!1), Kt = U(void 0), [Rt, qt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const P = y ? await y(l) : !1;
      x && Ct(P);
    })(), () => {
      x = !1;
    };
    ...
    let x = !0;
    if (!o) {
      lt(!1), qt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const P = R ? await R(l) : !1;
      x && lt(P);
    })(), () => {
      x = !1;
    };
  ...
  Y(() => {
    ...
    yt.current === "idle" && (yt.current = "pending"), ft ? yt.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== i && (et(B), yt.current = "auto-populated") : yt.current === "auto-populated" && (et(void 0), yt.current = "pending");
  }, [o, B, ft, i]);
  const xt = A(
    () => I ?? e.filter((x) => !x.deleted),
    [I, e]
  );
  Y(() => {
    let x = !0;
  ...
  const Vt = A(() => xt[0], [xt]), te = U(null), se = U(void 0), ce = L(() => {
    var x;
    (x = se.current) == null || x.call(se), Q(un);
  }, []), V = L(() => {
    const x = !bt;
    ie(x), mt(!x), f == null || f(l, x);
  }, [bt, f, l]);
  Y(() => {
    ot(!1);
  }, [o]), Y(() => {
    if (o && !bt && !Qt) {
      ...
      return Kt.current = x, () => clearTimeout(x);
    }
  ...
  }, [i, r]), Lt = A(() => xt.slice(1), [xt]), Et = A(() => Lt.length ?? 0, [Lt.length]), le = A(() => Et > 0, [Et]), Ht = A(() => nt || Et <= 2 ? Lt : Lt.slice(-2), [Lt, Et, nt]), Gt = A(() => nt || Et <= 2 ? 0 : Et - 2, [Et, nt]), Wt = A(
    () => Et === 1 ? ee.singleReply : Me(ee.multipleReplies, { count: Et }),
    [Et, ee]
  ), de = A(
    () => Gt === 1 ? ee.singleReply : Me(ee.multipleReplies, { count: Gt }),
    [Gt, ee]
  );
  Y(() => {
    !o && pt && le && St(!1);
  ...
  const S = L(
    async (x) => {
      ...
      K && await p({ threadId: l, contents: K }) && ce();
    },
    [
      ce,
      j,
    ...
    async (x) => {
      const K = oe(j) ? oa(j) : void 0, P = x.status ? x.assignedUser : N ?? x.assignedUser, tt = await p({
        ...x,
        contents: K,
        assignedUser: P
      });
      return tt && (P !== void 0 && M(P), K && ce()), tt;
    },
    [ce, j, p, N]
  );
  ...
  const X = /* @__PURE__ */ a(
    wn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: St,
      canEditOrDelete: (!pt && Rt.get(Vt.id)) ?? !1,
      canUserResolveThread: ht
    }
  );
  return /* @__PURE__ */ a(
    rw,
      ...
      children: /* @__PURE__ */ u(aw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            re && /* @__PURE__ */ a(Sr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: re }),
            /* @__PURE__ */ a(
              J,
              {
                variant: "ghost",
                ...
                children: bt ? /* @__PURE__ */ a(Cs, {}) : /* @__PURE__ */ a(Es, {})
              }
            ),
            q === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: ht && w !== "Resolved",
                  onClick: () => F({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(wt, { children: [
          le && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(wt, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    nt ? /* @__PURE__ */ a(Ts, {}) : /* @__PURE__ */ a(dr, {})
                  ] })
                ]
              }
            ),
            Ht.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              wn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: St,
                canEditOrDelete: (!pt && Rt.get(x.id)) ?? !1
              }
            ) }, x.id)),
            v !== !1 && (!pt || oe(j)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (x) => {
                  Eo(x) && (x.preventDefault(), x.stopPropagation(), (oe(j) || N !== void 0 && N !== D) && S());
                },
                onKeyDown: (x) => {
                  Co(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    aa,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    N !== void 0 && (oe(j) || N !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Me(
                    ...
                    /* @__PURE__ */ u(Pe, { open: Z, onOpenChange: ct, children: [
                      /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ a(
                        J,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                            Te,
                            {
                              onSelect: () => {
                                et(x !== i ? x : void 0), yt.current = "user-selected", M(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), sw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Xr = (t) => sw(ho(t));
function Jr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function cw({
  ...
  const [s, c] = _("accept"), l = Lo(), d = Lo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = A(
    () => Xr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Xr(t.acceptedText ?? ""),
  ...
  const q = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: q }), j = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : W, Q = () => {
    const D = o ?? "accept";
    ...
    const M = f === D.value, H = `${d}-${D.value}`, nt = N(D);
    return (
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return Mi(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function pw(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = uw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function $p({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [T, $] = _(), [E, B] = _(), I = L(
    async (M) => {
      const H = await i(M);
  ...
  Y(() => {
    f && (C((M) => new Set(M).add(f)), $(f));
  }, [f]);
  const z = r.filter(
    (M) => M.comments.some((H) => !H.deleted)
  ), q = z.map((M) => ({ id: M.id })), W = L(
    (M) => {
      C((H) => new Set(H).add(M.id)), $(M.id), b == null || b(M.id);
    },
    [b]
  ), j = L(
    (M) => {
      ...
      }), $(M), b == null || b(H ? void 0 : M);
    },
    [y, b]
  ), { listboxRef: Q, activeId: N, handleKeyDown: et } = Qi({
    options: q,
    onOptionSelect: W
  }), D = L(
    (M) => {
      M.key === "Escape" ? (T && y.has(T) && (C((H) => {
        const nt = new Set(H);
        return nt.delete(T), nt;
      }), $(void 0), b == null || b(void 0)), M.preventDefault(), M.stopPropagation()) : et(M);
    },
    [T, y, et, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: z.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(pw, { ...H, conflictResolution: R }) : /* @__PURE__ */ a(Ii, { ...H })
          },
          M.id
        );
      })
...
function hw({ table: t }) {
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(J, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Ss, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function hr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(Vn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function ue({
  ...
  return /* @__PURE__ */ u(
    Ut.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ut.ItemIndicator, { children: /* @__PURE__ */ a(wa, { className: "tw:pointer-events-none" }) }) }),
...
function bw({
  ...
  var E;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, R] = _({}), y = A(() => e ?? [], [e]), C = Zn({
    data: y,
    columns: t,
    getCoreRowModel: ti(),
  ...
  let $;
  return l ? $ = Array.from({ length: 10 }).map((z, q) => `skeleton-row-${q}`).map((z) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: T.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((E = C.getRowModel().rows) == null ? void 0 : E.length) > 0 ? $ = C.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    De,
    {
      onClick: () => s(B, C),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((I) => /* @__PURE__ */ a(sr, { children: Cr(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    B.id
  )) : $ = /* @__PURE__ */ a(De, { children: /* @__PURE__ */ a(sr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(hw, { table: C }),
    /* @__PURE__ */ u(so, { stickyHeader: i, children: [
      /* @__PURE__ */ a(co, { stickyHeader: i, children: C.getHeaderGroups().map((B) => /* @__PURE__ */ a(De, { children: B.headers.map((I) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : Cr(I.column.columnDef.header, I.getContext()) }, I.id)) }, B.id)) }),
      /* @__PURE__ */ a(lo, { children: $ })
    ] }),
...
function Vp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(bl, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(J, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Mn, {}) })
        ] }),
...
function Bp({ id: t, label: e, groups: r }) {
  const [o, n] = _(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(je, { children: [
    ...
    /* @__PURE__ */ a(Fe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Nn, { children: d.itemType === 0 ? /* @__PURE__ */ a(wt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][h],
...
function Up({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(_w, { versionHistory: n }),
      ...
      return /* @__PURE__ */ u(Sr, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          J,
          {
            ...
            children: /* @__PURE__ */ a(po, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function Cw({
  ...
  const l = io(), d = hn(n, "%undoButton_tooltip%"), w = hn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(no, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(
        J,
      ...
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(Ba, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      ...
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(wt, { children: [
          " ",
          /* @__PURE__ */ a(Ba, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Ew({
  ...
  return Y(() => {
    var l;
    const i = io(), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const Tw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(wt, { children: [
...
function Sw({
  ...
  const v = (y) => {
    ...
    var C, T, $, E;
    y.stopPropagation(), document.activeElement === i.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), s.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((T = i.current) == null || T.focus(), s.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && (($ = n.current) == null ? void 0 : $.selectionStart) === 0 && ((E = i.current) == null || E.focus(), s.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && v(!1);
  };
  return /* @__PURE__ */ u(je, { open: p, onOpenChange: v, children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: Tw(t, o, e) }) }) }),
...
const Rw = (t, e) => t === "f" ? /* @__PURE__ */ u(wt, { children: [
  /* @__PURE__ */ a(In, {}),
  " ",
...
function Dw({
  ...
  return /* @__PURE__ */ u(je, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: Rw(t, r) }) }) }),
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: zw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Fe, { style: { zIndex: Cn }, children: [
...
function Ow({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Ls, { className: e, size: 16 });
}
function Iw({ state: t }) {
  return /* @__PURE__ */ a(
    "div",
...
function gn({
  ...
  return /* @__PURE__ */ u(
    Te,
    {
      ...
      onSelect: t.action,
      children: [
        t.selectionState !== void 0 && /* @__PURE__ */ a(Iw, { state: t.selectionState }),
        ...
        ) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ow, { icon: t.icon }) }) }),
...
function Pw(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, s]) => {
    i.push(
      ...s.map((c) => ({
        marker: c,
        title: r[Hr[c].description] ?? Hr[c].description,
        action: () => {
          var l;
...
function qp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [T, $] = _("*"), [E, B] = _("*"), [I, z] = _("f"), [q, W] = _(!1), [j, Q] = _(!0), [N, et] = _(!1), D = U(!1), M = U(""), [H, nt] = _(!1), [ot, pt] = _(), [St, Z] = _(), [ct, ft] = _(), [lt, ht] = _(), Ct = U(null), bt = U(
    void 0
  ), ie = U(0), Qt = U(void 0), mt = A(
    () => ({
      ...s,
  ...
  const Rt = L(() => {
    var x, K, P;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), F = S == null ? void 0 : S.querySelector("span.note"), X = (P = (K = g.current) == null ? void 0 : K.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
    return !!F && !!X && F.contains(X);
  }, []);
  Y(() => {
    var K, P;
    let S, F, X;
    D.current = !1, Qt.current = void 0, Q(!0);
    const x = e == null ? void 0 : e.at(0);
    if (x && yr("note", x)) {
      const tt = (K = x.insert.note) == null ? void 0 : K.caller;
      let dt = "custom";
      tt === Wa ? dt = "generated" : tt === Ya ? dt = "hidden" : tt && ($(tt), B(tt)), R(dt), C(dt), z(((P = x.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var vt, kt, Tt;
        (vt = h.current) == null || vt.applyUpdate([x]), (kt = h.current) == null || kt.selectNote(0), (Tt = h.current) == null || Tt.focus(), F = requestAnimationFrame(() => {
          X = setTimeout(() => {
            var At, Yt;
            Rt() || ((At = h.current) == null || At.selectNote(0), (Yt = h.current) == null || Yt.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      S && clearTimeout(S), F !== void 0 && cancelAnimationFrame(F), X !== void 0 && clearTimeout(X);
    };
  }, [e, i, Rt]);
  const qt = L(
    (S = !1) => {
      var X, x, K;
      p == null || p();
      const F = (x = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : x.at(0);
      F && yr("note", F) && (r == null || r([F]), S && d && i && ((K = d.current) == null || K.replaceEmbedUpdate(i, [F])));
    },
    [i, r, p, d]
  ), yt = L(
    (S, F) => {
      var K, P, tt;
      const X = (P = (K = h.current) == null ? void 0 : K.getNoteOps(0)) == null ? void 0 : P.at(0);
      if (!X || !yr("note", X) || !X.insert.note) return;
      let x;
      S === "custom" ? x = F : S === "generated" ? x = Wa : x = Ya, X.insert.note.caller !== x && (X.insert.note.caller = x, (tt = h.current) == null || tt.applyUpdate([X, { delete: 1 }]));
    },
    []
  ), xt = L(() => {
    var S;
    bt.current || (S = h.current) == null || S.commitPendingMarkerEdits(), qt(!0), o();
  }, [o, qt]), Vt = U(xt);
  Jt(() => {
    Vt.current = xt;
  });
  const te = U({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
    (te.current.book !== n.book || te.current.chapterNum !== n.chapterNum) && (te.current = { book: n.book, chapterNum: n.chapterNum }, Vt.current());
  }, [n.book, n.chapterNum]);
  const se = () => {
    var F;
    ...
    if (F && yr("note", F)) {
      ...
      const dt = (P = (K = F.insert.note) == null ? void 0 : K.contents) == null ? void 0 : P.ops;
      I !== "x" && S === "x" ? dt == null || dt.forEach((vt) => Vw(vt)) : I === "x" && S !== "x" && (dt == null || dt.forEach((vt) => Lw(vt))), (tt = h.current) == null || tt.applyUpdate([F, { delete: 1 }]);
    }
  }, ee = (S) => {
    ht(S.contextMarker), et(S.canRedo);
  }, re = L(
    (S) => {
      var X, x, K, P, tt;
      const F = (x = (X = h.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : x.at(0);
      if (F && yr("note", F)) {
        ...
        const dt = (K = F.insert.note) == null ? void 0 : K.style, vt = (tt = (P = F.insert.note) == null ? void 0 : P.contents) == null ? void 0 : tt.ops;
        if (dt || W(!1), W(
          dt === "x" ? !!(vt != null && vt.every((kt) => {
            var At, Yt;
            if (!((At = kt.attributes) != null && At.char)) return !0;
            const Tt = ((Yt = kt.attributes) == null ? void 0 : Yt.char).style;
          ...
          D.current = !0, M.current = JSON.stringify(F), Q(!0);
          return;
        }
        Q(JSON.stringify(F) === M.current), qt();
      } else
        W(!1), Q(!0);
    },
    [qt]
    ...
    if (f.current && Kt.length && S && S.rangeCount > 0) {
      const F = S.getRangeAt(0).getBoundingClientRect(), X = f.current.getBoundingClientRect();
      pt(F.left - X.left), Z(F.top - X.top), ft(F.height), nt(!0);
    }
  }, [Kt, f]), Et = U(() => {
  }), le = L(
    (S, F, X) => {
      ...
      ns({
        ...
        sessionCounterRef: ie,
        setSession: (P) => {
          bt.current = P;
        },
        clearSessionIfCurrent: (P) => zo(bt, P),
        ...
        restoreSelectionIfLost: () => {
          ...
          if (!((P = h.current) != null && P.getSelection())) {
            const vt = Qt.current;
            vt ? (tt = h.current) == null || tt.setSelection(vt) : (dt = h.current) == null || dt.selectNote(0);
          }
        },
        focusEditor: () => {
          var P;
        ...
        applyItem: (P) => {
          var tt;
          return (tt = h.current) == null ? void 0 : tt.applyMarkerMenuSelection(P, {
            trigger: "backslash",
        ...
        onShowError: (P) => {
          (!ec(P) || P.code !== rc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${ac(P)}`
          );
        }
      });
    },
    ...
    if (!S) return !1;
    const F = yl(mt.styleInfo ?? kl, S);
    return F.length === 0 ? !1 : (le(S, F, { passive: !S.hasTextSelection }), !0);
  }, [le, mt.styleInfo]), Gt = L(
    (S) => {
      const F = bt.current;
      if (!F || !w) return;
      is(S, F, {
        ...
        commitItem: (x) => {
          var P;
          const K = F.items.find((tt) => tt.marker === x);
          K && ((P = h.current) == null || P.applyMarkerMenuSelection(K, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const S = (F) => {
      var K, P;
      const X = (K = g.current) == null ? void 0 : K.querySelector(".editor-input");
      if (!X || F.target !== X) return;
    ...
    if (((X = mt.view) == null ? void 0 : X.markerMode) === "editable") {
      const x = (P) => {
        var vt, kt, Tt, At;
        if (cs(P)) return;
        const tt = S();
        ...
        if (P.key === "Enter" && !Rt()) {
          P.preventDefault(), P.stopPropagation(), (vt = h.current) == null || vt.selectNote(0), (kt = h.current) == null || kt.focus();
          return;
        }
        if (w && P.key === c) {
          if (!Rt()) {
            P.preventDefault(), P.stopPropagation(), (Tt = h.current) == null || Tt.selectNote(0), (At = h.current) == null || At.focus();
            return;
          }
          Ht() && (P.preventDefault(), P.stopPropagation());
        }
      }, K = () => {
        var tt, dt;
        const P = S();
        !P || document.activeElement !== P || Rt() || ((tt = h.current) == null || tt.selectNote(0), (dt = h.current) == null || dt.focus());
      };
    ...
    const F = (x) => {
      const K = S();
      !H && K && document.activeElement === K && x.key === c ? (x.preventDefault(), Lt()) : H && x.key === "Escape" && (x.preventDefault(), nt(!1));
    };
    ...
    Lt,
    c,
    (de = mt.view) == null ? void 0 : de.markerMode,
    mt.styleInfo,
    w,
    Ht,
    Rt
    ...
    const S = () => {
      var x, K, P;
      const F = ((x = g.current) == null ? void 0 : x.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const X = document.getSelection();
      X && !X.isCollapsed || Rt() || ((K = h.current) == null || K.selectNote(0), (P = h.current) == null || P.focus());
    };
  ...
  const Wt = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(wt, { children: [
    /* @__PURE__ */ u("div", { ref: b, className: "footnote-editor tw:grid tw:gap-[12px]", children: [
      /* @__PURE__ */ u("div", { className: "tw:flex", children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(no, { children: [
          /* @__PURE__ */ a(
            Cw,
            {
              onUndoClick: () => {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
              ...
              /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: Wt }) })
            ] }) }) })
          ]
        }
      )
...
const Hp = Object.freeze([
  ...Mw,
  ...Object.entries(Hr).map(([, t]) => t.description).filter((t) => !!t),
  ...
  return /* @__PURE__ */ u(wt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(wt, { children: Bw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Gp({
  ...
  const p = d ?? oc(r, void 0), h = (T, $) => {
    w == null || w(T, $, n);
  }, g = i ? r.findIndex((T) => T === i) : -1, [f, b] = _(g), v = (T, $, E) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
    ...
    if (r.length)
      switch (T.key) {
        case "ArrowDown":
          T.preventDefault(), b(($) => Math.min($ + 1, r.length - 1));
          break;
        case "ArrowUp":
          T.preventDefault(), b(($) => Math.max($ - 1, 0));
          break;
      }
  }, y = U([]);
  Y(() => {
        ...
        "ul",
        {
          ...
          children: r.map((T, $) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Ft.Fragment, { children: [
                /* @__PURE__ */ a(
                  "li",
                  {
                    ref: (I) => {
                ...
                $ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Rr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, B)
            );
          })
        }
...
function qw({
  ...
  return /* @__PURE__ */ u(so, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(co, { stickyHeader: !0, children: /* @__PURE__ */ u(De, { children: [
      /* @__PURE__ */ a(Qr, { children: n }),
      /* @__PURE__ */ a(Qr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(lo, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      De,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(sr, { className: o, children: Kw(c.text) })
        ]
      },
...
const Hw = (t) => {
  ...
  return e ? e[1] : "";
}, Ww = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", th = Object.freeze([
  ...
  const n = $o(o.key) ? o.key : o.key[0];
  return {
    items: $o(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || Ww(n, e, r),
...
function eh({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), b = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), R = ge(r, "%webView_inventory_scope_currentBook%"), y = ge(r, "%webView_inventory_scope_chapter%"), C = ge(r, "%webView_inventory_scope_verse%"), T = ge(r, "%webView_inventory_filter_text%"), $ = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = ge(r, "%webView_inventory_no_results%"), [B, I] = _(!1), [z, q] = _("all"), [W, j] = _(""), [Q, N] = _([]), et = A(() => {
    const Z = t ?? [];
    return Z.length === 0 ? [] : Xw(Z, n, i);
  }, [t, n, i]), D = A(() => {
    if (B) return et;
    const Z = [];
    return et.forEach((ct) => {
      const ft = ct.items[0], lt = Z.find(
        (ht) => ht.items[0] === ft
      );
      lt ? (lt.count += ct.count, lt.occurrences = lt.occurrences.concat(ct.occurrences)) : Z.push({
        items: [ft],
        count: ct.count,
  ...
  }, [B, et]), M = A(() => D.length === 0 ? [] : Yw(D, z, W), [D, z, W]), H = A(() => {
    var ft, lt;
    if (!B) return l;
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
        /* @__PURE__ */ a(It, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? $ })
        ] }) }),
...
const Jw = "16rem", Zw = "3rem", Pi = Ft.createContext(void 0);
function ga() {
  const t = Ft.useContext(Pi);
  if (!t)
...
function Qw({
  ...
  const [l, d] = Ft.useState(t), w = e ?? l, p = Ft.useCallback(
    (C) => {
      const T = typeof C == "function" ? C(w) : C;
      r ? r(T) : d(T);
    },
    [r, w]
  ), h = Ft.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = xe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Ft.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
    ...
    "--sidebar-width": Jw,
    "--sidebar-width-icon": Zw,
    ...n
  };
  return /* @__PURE__ */ a(Pi.Provider, { value: R, children: /* @__PURE__ */ a(
    "div",
    {
...
function rh({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    J,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(pc, {}) : /* @__PURE__ */ a(hc, {}),
...
function iu({
  ...
  const c = t ? Pr.Root : "button", { state: l } = ga(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(nu({ variant: r, size: o }), i),
      ...s
    }
  );
...
function wh({
  ...
  const [o] = Ft.useState(() => `${Math.floor(Math.random() * 40) + 50}%`), n = { "--skeleton-width": o };
  return /* @__PURE__ */ u(
    "div",
    {
    ...
    tu,
    {
      ...
      children: /* @__PURE__ */ u(ru, { children: [
        /* @__PURE__ */ u(fn, { children: [
          ...
          /* @__PURE__ */ a(vn, { children: /* @__PURE__ */ a(au, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(ou, { children: /* @__PURE__ */ a(
            iu,
            {
              onClick: () => d(g),
              isActive: h(g),
        ...
        /* @__PURE__ */ u(fn, { children: [
          ...
          /* @__PURE__ */ a(vn, { className: "tw:pl-3", children: /* @__PURE__ */ u(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ a(qs, { className: "tw:h-4 tw:w-4 tw:shrink-0" }),
                /* @__PURE__ */ a(
                  ls,
                  {
                    mode: "project",
...
const ze = "scrBook", cu = "scrRef", Ye = "source", lu = "details", du = "Scripture Reference", wu = "Scripture Book", Ai = "Type", uu = "Details";
function pu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ze ? _e(n.start) : void 0;
      },
      getGroupingValue: (o) => Dt.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => qa(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
...
const hu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || qa(t.start, t.end) === 0 ? `${_a(t.start)}+${e}` : `${_a(t.start)}+${e}-${_a(t.end)}+${r}`;
}, bn = (t) => `${hu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function fh({
  sources: t,
  ...
  const [d, w] = _([]), [p, h] = _([{ id: ze, desc: !1 }]), [g, f] = _({}), b = A(
  ...
  const R = Zn({
    ...
    getExpandedRowModel: vl(),
    getGroupedRowModel: ml(),
    getCoreRowModel: ti(),
    getSortedRowModel: Qn(),
    getRowId: bn,
    autoResetExpanded: !1,
  ...
  Y(() => {
    if (c) {
      ...
      if (q.length === 1) {
        const W = b.find((j) => bn(j) === q[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, b, c, R]);
  const y = n ?? wu, C = i ?? Ai, T = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [ze] },
    { label: `Group by ${C}`, value: [Ye] },
    {
  ...
  }, B = (z, q) => z.getIsGrouped() ? "" : m("banded-row", q % 2 === 0 ? "even" : "odd"), I = (z, q, W) => {
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(gw, { children: T.map((z) => /* @__PURE__ */ a(ue, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(so, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(co, { children: R.getHeaderGroups().map((z) => /* @__PURE__ */ a(De, { children: z.headers.filter((q) => q.column.columnDef.header).map((q) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Qr, { colSpan: q.colSpan, className: "tw:sticky top-0", children: q.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Cr(q.column.columnDef.header, q.getContext())
        ] }) }, q.id)
      )) }, z.id)) }),
      /* @__PURE__ */ a(lo, { children: R.getRowModel().rows.map((z, q) => {
        const W = xe();
        return /* @__PURE__ */ a(
          De,
          {
            ...
            children: z.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== Ye || !r)))
                return /* @__PURE__ */ a(
                  sr,
                  {
                    className: m(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(Ua, {}) : /* @__PURE__ */ a(Fa, {})),
                          " ",
                          Cr(j.column.columnDef.cell, j.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function gu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [v, R] = _(!1), [y, C] = _(""), T = U(void 0), $ = U(!1), E = A(
    () => Sn(t),
    [t]
  ), B = A(() => {
    if (!y.trim()) {
    ...
    (N, et = !1) => {
      ...
      const D = E.findIndex((pt) => pt === T.current), M = E.findIndex((pt) => pt === N);
      if (D === -1 || M === -1) return;
      const [H, nt] = [
        Math.min(D, M),
        Math.max(D, M)
      ], ot = E.slice(H, nt + 1).map((pt) => pt);
      r(
        e.includes(N) ? e.filter((pt) => !ot.includes(pt)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, r, E]
  ), z = (N) => {
    I(N, $.current), $.current = !1;
  }, q = (N, et) => {
    N.preventDefault(), I(et, N.shiftKey);
  }, W = () => {
    r(E.map((N) => N));
  }, j = () => {
    r([]);
  }, Q = A(
    () => Object.values(_t).filter(
      (N) => (i == null ? void 0 : i[N]) !== void 0 && wo(E, N).length === 0
        ...
        /* @__PURE__ */ a(Ze, { asChild: !0, children: /* @__PURE__ */ u(
          J,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a(Hs, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Ae,
          {
            ...
            children: /* @__PURE__ */ u(
              Ve,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (N) => {
                  N.key === "Enter" && ($.current = N.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    ia,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(J, { variant: "ghost", size: "sm", onClick: j, children: w })
                  ] }),
                  /* @__PURE__ */ u(Le, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(sa, { children: p }),
                    Object.values(_t).filter((N) => B[N].length > 0).map((N, et) => {
                      const D = B[N];
                      return /* @__PURE__ */ u(da, { children: [
                        et > 0 && /* @__PURE__ */ a(En, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ce,
                          {
                            heading: yn(N, h, g, f, b),
...
function vu({
  ...
  const s = wo(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    J,
    {
      variant: "outline",
      size: "sm",
      onClick: () => o(t),
      className: m(
        Rn(e, t, r) && !s && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: s,
      children: ds(
        t,
...
function bu({
  ...
  const s = o["%webView_book_selector_more%"], c = A(
    ...
    (d) => {
      const w = wo(c, d).map((p) => p);
      r(
        Rn(c, d, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(_t).map((d) => /* @__PURE__ */ a(
      vu,
      {
        section: d,
        availableBookIds: c,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Pa ? Pa : xn
      ).map((d) => /* @__PURE__ */ a(Sr, { className: "tw:hover:bg-secondary", variant: "secondary", children: fe(d, n) }, d)),
      e.length > Pa && /* @__PURE__ */ a(
        Sr,
        {
...
function vh({
  ...
  const $ = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), E = zt(s, "%webView_scope_selector_verse%"), B = zt(s, "%webView_scope_selector_chapter%"), I = zt(s, "%webView_scope_selector_book%"), z = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), q = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = zt(s, "%webView_scope_selector_current_book%"), j = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), N = zt(s, "%webView_scope_selector_select_books%"), et = zt(s, "%webView_scope_selector_range%"), D = zt(s, "%webView_scope_selector_select_range%"), M = zt(s, "%webView_scope_selector_range_start%"), H = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), ot = zt(s, "%webView_scope_selector_cancel%"), pt = zt(s, "%webView_scope_selector_navigate%"), St = (O) => {
    if (!b) return;
    const G = b.book.toUpperCase();
    switch (O) {
      case "verse":
        return _e(b, "id");
      case "chapter":
        return `${G} ${b.chapterNum}`;
      case "book":
        return G;
      default:
        return;
  ...
  ], ct = (O, G, st = !1) => /* @__PURE__ */ u(wt, { children: [
    O,
    G && !st && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      G
    ] })
  ] }), ft = e ? Z.filter((O) => e.includes(O.value)) : Z, lt = b ?? Na, ht = p ?? lt, Ct = h ?? lt, bt = () => {
  }, ie = U(null), Qt = U(null), mt = U(!1), Kt = U(null), Rt = U(!1), [qt, yt] = _(void 0), xt = U(!1), Vt = U(!1), te = U(null), se = L((O) => {
    if (O) {
      yt("start"), xt.current = !1;
      return;
    }
    yt((G) => G === "start" ? void 0 : G), xt.current && (xt.current = !1, requestAnimationFrame(() => {
      var st;
      const G = (st = ie.current) == null ? void 0 : st.querySelector("button");
      G == null || G.click();
    }));
  }, []), ce = L((O) => {
    if (O) {
    ...
    (O) => {
      g == null || g(O), f == null || f(O), xt.current = !0;
    },
    [g, f]
  ), ee = L(
    (O) => {
    ...
    (O) => {
      r(O), O === "selectedBooks" && n.length === 0 && (b != null && b.book) && i([b.book]);
    },
    [r, n, b, i]
  ), Lt = ft.find((O) => O.value === t), Et = () => t === "selectedBooks" && n.length > 0 ? n.map((O) => O.toUpperCase()).join(", ") : t === "range" ? ic(ht, Ct, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Lt ? ct(Lt.label, Lt.scrRefSuffix) : t, le = ft.filter(
    (O) => O.value !== "selectedBooks" && O.value !== "range"
  ), Ht = ft.find((O) => O.value === "selectedBooks"), Gt = ft.find((O) => O.value === "range"), [Wt, de] = _(!1), [S, F] = _(void 0), [X, x] = _(void 0), [K, P] = _(void 0), [tt, dt] = _(void 0), [vt, kt] = _([]), Tt = w === "dropdown" && S === "selectedBooks", At = /* @__PURE__ */ a(
    bu,
    {
      availableBookInfo: o,
      selectedBookIds: Tt ? vt : n,
      onChangeSelectedBookIds: Tt ? kt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Yt = qt === "end", mr = qt === "start", Ke = "tw:text-muted-foreground", Se = w === "dropdown" && S === "range", fa = Se ? P : V, Ar = Se ? dt : f ? ee : bt, vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: m(Yt && Ke), children: M }),
      /* @__PURE__ */ a(
        Ea,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ie, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: m(mr && Ke), children: H }),
      /* @__PURE__ */ a(
        Ea,
        {
          id: "scope-range-end",
          ...
          localizedStrings: R,
          getEndVerse: y,
          disableReferencesUpTo: Se ? K ?? ht : ht,
          onOpenChange: ce,
          onCloseAutoFocus: (O) => {
            var G;
            Vt.current && (Vt.current = !1, O.preventDefault(), (G = te.current) == null || G.focus());
          },
          className: m(mr && Ke),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    const G = requestAnimationFrame(() => {
      O = requestAnimationFrame(() => {
        var st;
        (st = br.current[t]) == null || st.focus();
      });
    });
    return () => {
      cancelAnimationFrame(G), O && cancelAnimationFrame(O);
    };
  }, [Wt, t]);
  const [qe, ma] = _(null), [rr, va] = _(null), [ar, ba] = _(null), xa = 200, [k, rt] = _(!1);
  Y(() => {
    if (!ar || typeof ResizeObserver > "u") return;
    const O = new ResizeObserver(([G]) => {
      rt(G.contentRect.width < xa);
    });
    return O.observe(ar), () => O.disconnect();
  }, [ar]);
  const at = L(
    (O) => {
      x(O), P(ht), dt(Ct), kt(n), de(!1), F(O);
    },
    [ht, Ct, n]
  ), Xt = L(() => {
    X !== void 0 && (X === "range" ? (K && (g == null || g(K)), tt && (f == null || f(tt))) : X === "selectedBooks" && i(vt), re(X), F(void 0), x(void 0));
  }, [
    X,
    K,
    tt,
    ...
    var G;
    O.preventDefault(), (G = Vr.current) == null || G.focus();
  }, []), Ge = (O) => t === O ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ie, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Nt, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(je, { open: Wt, onOpenChange: de, children: [
        /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
          J,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Et() }),
              /* @__PURE__ */ a(dr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Fe,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ya, { container: ar, children: [
              le.map(({ value: O, label: G, dropdownLabel: st, scrRefSuffix: gt, id: ae }) => /* @__PURE__ */ u(
                Xe,
                {
                  ref: er(O),
              ...
              v && /* @__PURE__ */ u(wt, { children: [
                ...
                /* @__PURE__ */ a(
                  Xe,
                  {
                    ...
                    onSelect: (O) => {
                      var G, st;
                      if (O.preventDefault(), mt.current) {
                        mt.current = !1;
                        return;
                      }
                      Rt.current || (st = (G = Qt.current) == null ? void 0 : G.querySelector("button")) == null || st.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (O) => {
                          const G = O.target instanceof HTMLElement ? O.target : void 0;
                          G != null && G.closest("button") && (mt.current = !0, requestAnimationFrame(() => {
                            mt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          Ea,
                          {
                            ...
                            onCloseAutoFocus: (O) => {
                              var G;
                              O.preventDefault(), (G = Kt.current) == null || G.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(wt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _e(b ?? Na, "id") }),
                              /* @__PURE__ */ a(dr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        oo,
        {
          ...
          children: ft.map(({ value: O, label: G, scrRefSuffix: st, id: gt }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: O, id: gt }),
            /* @__PURE__ */ a(Nt, { htmlFor: gt, children: ct(G, st) })
          ] }, gt))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { children: N }),
      At
    ] }),
    w === "radio" && t === "range" && vr,
    w === "dropdown" && Ht && /* @__PURE__ */ a(Aa, { open: S === "selectedBooks", onOpenChange: we, children: /* @__PURE__ */ a(
      Va,
      {
        ref: va,
        onCloseAutoFocus: He,
        onEscapeKeyDown: (O) => {
          rr != null && rr.querySelector('[data-state="open"]') && O.preventDefault();
        },
        children: /* @__PURE__ */ u(ya, { container: rr, children: [
          /* @__PURE__ */ a(La, { className: "tw:pe-8", children: /* @__PURE__ */ a(ja, { children: j }) }),
          At,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => we(!1), children: ot }),
            /* @__PURE__ */ a(J, { onClick: Xt, children: nt })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Gt && /* @__PURE__ */ a(Aa, { open: S === "range", onOpenChange: we, children: /* @__PURE__ */ a(
      Va,
      {
        ref: ma,
        onCloseAutoFocus: He,
        ...
        children: /* @__PURE__ */ u(ya, { container: qe, children: [
          /* @__PURE__ */ a(La, { className: "tw:pe-8", children: /* @__PURE__ */ a(ja, { children: D }) }),
          vr,
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => we(!1), children: ot }),
            /* @__PURE__ */ a(J, { ref: te, onClick: Xt, children: nt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          gr,
          {
            ...
            style: { zIndex: Qe },
            children: t.map((w) => /* @__PURE__ */ a(ue, { value: `${w}`, children: l[Po(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Li = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(It, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(us, { children: c.label }),
    /* @__PURE__ */ a(ps, { children: /* @__PURE__ */ a(hs, { children: Li(
      t,
      e,
      Vi(t, c.id),
      o
...
function ro({
  ...
  return /* @__PURE__ */ u(je, { variant: i, children: [
    /* @__PURE__ */ a(Be, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(J, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Gs, {}) }) }),
    /* @__PURE__ */ a(Fe, { align: "start", style: { zIndex: Qe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(da, { children: [
      /* @__PURE__ */ a(Nn, { children: /* @__PURE__ */ a(Mt, { children: Li(e.groups, e.items, l, t) }) }),
...
const Nu = Object.freeze([520, 420, 340]), Bi = Ft.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = ji(n, Nu), d = oi() ?? l, w = d >= Er.MINIMUM;
...
function _h({
  ...
  return /* @__PURE__ */ u(Bi, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      ro,
      {
        onSelectMenuItem: t,
...
const Fi = Ft.forwardRef(({ className: t, ...e }, r) => {
  const o = xe();
  return /* @__PURE__ */ a(
    he.Root,
    {
...
Fi.displayName = he.List.displayName;
const Ui = Ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.List,
  {
    ref: r,
    className: m(
...
Ui.displayName = he.List.displayName;
const Cu = Ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
)), Ki = Ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Content,
  {
    ref: r,
    className: m(
...
Ki.displayName = he.Content.displayName;
function Ch({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Fi, { children: [
      /* @__PURE__ */ a(Ui, { children: t.map((c) => /* @__PURE__ */ a(Cu, { value: c.value, children: c.value }, c.key)) }),
  ...
  return /* @__PURE__ */ a(
    ye.Trigger,
    {
      ...
      className: m(
        ...
        uo({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
  ...
  return /* @__PURE__ */ a(
    ye.Item,
    {
      ...
      className: m(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        uo({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
...
const _r = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Ot, { children: [
      ...
      ) : /* @__PURE__ */ u(Ou, { children: [
        /* @__PURE__ */ a(Iu, { children: d.label }),
        /* @__PURE__ */ a($u, { children: qi(
          t,
          e,
          Vi(t, d.id),
          o
...
function Pu({
  ...
  if (Nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Eu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Tu, { children: [
      /* @__PURE__ */ a(Ru, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        zu,
        {
          style: { zIndex: Qe },
          children: /* @__PURE__ */ a(Mt, { children: qi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
const Au = Object.freeze([950, 800, 700]);
function Eh(t) {
  switch (t) {
    case void 0:
      return;
...
function Sh({
  ...
  const d = Vu(
    ...
    return v ? `${($ = t[f]) == null ? void 0 : $.autonym} (${v})` : (E = t[f]) == null ? void 0 : E.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Nt, { className: "tw:font-normal tw:text-muted-foreground", children: Me(d, {
...
function zh({
  ...
  return /* @__PURE__ */ u(Ve, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(fs, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(ms, { children: /* @__PURE__ */ a(gc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Le, { children: [
...
function Mh({
  ...
  const c = t ? Ao(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = Fu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
    ...
    /* @__PURE__ */ u(Ot, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        $t,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Ao(d, {
            key: /* @__PURE__ */ a(
              Ba,
              {
                className: m(
...
function $h({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = A(() => {
    const c = new Pn(o);
    return (l) => c.format(l);
...
function tg({
  ...
  const n = xe();
  return /* @__PURE__ */ u(Uu, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Ku, {}),
    /* @__PURE__ */ u(
      Ue.Content,
      {
...
function ig({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    El,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(xc, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(bc, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(vc, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(mc, { className: "tw:size-4" }),
...
function dg({
  ...
  return /* @__PURE__ */ a(
    he.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", qu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function mg(t) {
  const e = A(() => sc(t).slice().sort().join(" "), [t]);
...
function xg({ value: t, children: e }) {
  return /* @__PURE__ */ a(ai.Provider, { value: t, children: /* @__PURE__ */ a(ua.Provider, { value: t, children: e }) });
}
function Xu(t, e = "top") {
...
export {
  ...
  Ri as CancelAcceptButtons,
  rw as Card,
  aw as CardContent,
  Mp as CardDescription,
  Op as CardFooter,
  zp as CardHeader,
  Dp as CardTitle,
  ...
  bw as DataTable,
  Mh as DestructiveKeyConfirmation,
  Aa as Dialog,
  Tg as DialogClose,
  Va as DialogContent,
  ...
  Kp as Filter,
  Bp as FilterDropdown,
  Up as Footer,
  qp as FootnoteEditor,
  Uw as FootnoteItem,
  Gp as FootnoteList,
  Rh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  th as INVENTORY_STRING_KEYS,
  ca as Input,
  zh as InterfaceLanguagePicker,
  eh as Inventory,
  Ba as Kbd,
  jg as KbdGroup,
  Nt as Label,
  ...
  Fg as PopoverHeader,
  ya as PopoverPortalContainerProvider,
  Ug as PopoverTitle,
  Ze as PopoverTrigger,
  ng as Progress,
  oo as RadioGroup,
  Zr as RadioGroupItem,
  zl as RecentSearches,
  Kg as ResizableHandle,
  qg as ResizablePanel,
  Hg as ResizablePanelGroup,
  Oh as ResultsCard,
  Gg as RetryableErrorView,
  mh as SCOPE_SELECTOR_STRING_KEYS,
  xu as SELECT_BOOKS_STRING_KEYS,
  Er as SHRINK_STEP,
  vh as ScopeSelector,
  fh as ScriptureResultsViewer,
  bh as ScrollGroupSelector,
  Tn as SearchBar,
  ur as Select,
  bu as SelectBooks,
  gu as SelectBooksPicker,
  gr as SelectContent,
  gw as SelectGroup,
  ue as SelectItem,
  Pp as SelectLabel,
  mw as SelectScrollDownButton,
  fw as SelectScrollUpButton,
  Ap as SelectSeparator,
  hr as SelectTrigger,
  pr as SelectValue,
  Rr as Separator,
  xh as SettingsList,
  kh as SettingsListHeader,
  yh as SettingsListItem,
  ...
  iu as SidebarMenuButton,
  ou as SidebarMenuItem,
  wh as SidebarMenuSkeleton,
  uh as SidebarMenuSub,
  hh as SidebarMenuSubButton,
  ph as SidebarMenuSubItem,
  Qw as SidebarProvider,
  ah as SidebarRail,
  sh as SidebarSeparator,
  rh as SidebarTrigger,
  ir as Skeleton,
  sg as Slider,
  ig as Sonner,
  Wg as Spinner,
  ...
  Th as Toolbar,
  Rl as ToolbarCompoundLabel,
  Ot as Tooltip,
  $t as TooltipContent,
  Mt as TooltipProvider,
  It as TooltipTrigger,
  Nw as UNDO_REDO_BUTTONS_STRING_KEYS,
  Sh as UiLanguageSelector,
  Cw as UndoRedoButtons,
  Fi as VerticalTabs,
  Ki as VerticalTabsContent,
  Ui as VerticalTabsList,
  Cu as VerticalTabsTrigger,
  $h as WizardStepper,
  Qe as Z_INDEX_ABOVE_DOCK,
  Cn as Z_INDEX_ABOVE_POPOVER,
  Jg as Z_INDEX_CONNECTION_LOST,
  Zg as Z_INDEX_FIRST_RUN,
  Qg as Z_INDEX_MODAL,
  tf as Z_INDEX_MODAL_BACKDROP,
  ef as Z_INDEX_ONBOARDING_TOUR,
  rf as Z_INDEX_OVERLAY,
  af as badgeVariants,
  of as buttonGroupVariants,
  nf as buttonVariants,
  m as cn,
  Qp as getBookIdFromUSFM,
  Rp as getCommentThreadElementId,
  ha as getInventoryHeader,
  Jp as getLinesFromUSFM,
  Zp as getNumberFromUSFM,
  Ww as getStatusForItem,
  Eh as getToolbarOSReservedSpaceClassName,
  Yp as inventoryCountColumn,
  Wp as inventoryItemColumn,
  Xp as inventoryStatusColumn,
  io as isMacOs,
  sf as isWindows,
  Aw as markerMenuItemToPaletteItem,
  Yu as pickTabIconUrl,
  lf as sonner,
  pg as useEvent,
  hg as useEventAsync,
  mg as useExtraValidMarkers,
  Qi as useListbox,
  Gu as usePromise,
  yp as useRecentSearches,
  gg as useRetryablePromise,
  vg as useRunWhenVisible,
  ji as useShrinkStep,
  oi as useShrinkStepOverride,
  Tl as useShrinkStepValue,
  ga as useSidebar,
  fg as useStylesheet,
  bg as useTabIconSelection,
  Ro as useTruncationTooltip,
  Wu as useViewVisibility
};
