...
function cl({
  ...
  return /* @__PURE__ */ u(Me, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a($e, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ce,
      {
        onSelect: () => g(h),
...
function ua({
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    () => wl(V),
    [V]
  ), oe = D(() => !d || !R || !R.chapterNum || !xt ? !1 : d(R.book, R.chapterNum) > 0, [d, R, xt]), je = L(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), ur = L(
    (b) => (G) => w ? ul(b, G, w) : !1,
  ...
  return Qt(() => {
    const b = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, It = rt.offsetTop, me = G.clientHeight, Te = rt.clientHeight, Be = It - me / 2 + Te / 2;
        G.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), C(Kn(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Me, { open: z, onOpenChange: it, modal: E, children: [
        ...
        children: /* @__PURE__ */ u(
          Ae,
          {
            ...
            children: [
              ...
              !Dt && /* @__PURE__ */ u(Ie, { ref: at, children: [
...
function Lo({
  ...
  return /* @__PURE__ */ u(Me, { open: N, onOpenChange: O, ...k, children: [
    /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          ...
          /* @__PURE__ */ a(Ie, { children: z(e) ? e.map((I) => /* @__PURE__ */ a(xe, { heading: I.groupHeading, children: I.options.map((C) => A(C, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((I) => A(I)) }) })
        ] })
      }
    )
  ] });
...
const Rd = "verseText", Wu = Object.freeze([
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Me, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        $e,
        {
          ...
          children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Ie, { children: t.map((v) => /* @__PURE__ */ a(
            Ce,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    ...
                    /* @__PURE__ */ u(Me, { open: q, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(We, { asChild: !0, children: /* @__PURE__ */ a(
                        U,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        $e,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Ie, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                            Ce,
                            {
                              onSelect: () => {
...
function Cp({
  ...
  }, [A, Y]), $ = D(() => T.length === 0 ? [] : Nw(T, C, K), [T, C, K]), W = D(() => {
    var wt, at;
    if (!A) return l;
    ...
    Sw,
    {
      ...
      children: /* @__PURE__ */ u(Dw, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(Ow, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Aw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const ze = "scrBook", Vw = "scrRef", Ke = "source", Pw = "details", jw = "Scripture Reference", Lw = "Scripture Book", _i = "Type", Bw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, cn = (t) => `${Uw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Lp({
  sources: t,
...
function Fp({
  ...
  ), ht = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [gt, Mt] = _(!1), [zt, Ht] = _(void 0), [$t, Pe] = _(void 0), [S, At] = _(void 0), [xt, oe] = _(void 0), [je, ur] = _([]), pr = d === "dropdown" && zt === "selectedBooks", hr = /* @__PURE__ */ a(
    Gw,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Le = d === "dropdown" && zt === "range", b = Le ? At : P, rt = Le ? oe : h ? Q : ae, It = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  const [Et, kt] = _(null), [_t, ft] = _(null), [Ut, ce] = _(null), Fe = 200, [Mi, $i] = _(!1);
  H(() => {
    if (!Ut || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([X]) => {
      $i(X.contentRect.width < Fe);
    });
    return M.observe(Ut), () => M.disconnect();
  }, [Ut]);
  const fo = L(
    (M) => {
      Pe(M), At(at), oe(mt), ur(n), Mt(!1), Ht(M);
    },
    [at, mt, n]
  ), mo = L(() => {
    $t !== void 0 && ($t === "range" ? (S && (g == null || g(S)), xt && (h == null || h(xt))) : $t === "selectedBooks" && i(je), et($t), Ht(void 0), Pe(void 0));
  }, [
    $t,
    S,
    xt,
    ...
    M || (Ht(void 0), Pe(void 0));
  }, []), vo = L((M) => {
    var X;
    M.preventDefault(), (X = Be.current) == null || X.focus();
  }, []), bo = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ye, { className: "tw:h-4 tw:w-4" }) }) : void 0;
...
function Wp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Si, { children: [
      /* @__PURE__ */ a(Ri, { children: t.map((c) => /* @__PURE__ */ a(Ww, { value: c.value, children: c.value }, c.key)) }),
...
export {
  ...
  ia as useSidebar,
  Kh as useStylesheet,
  Gh as useTabIconSelection,
  bg as useTruncationTooltip,
