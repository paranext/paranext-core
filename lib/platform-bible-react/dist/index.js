...
function Si({
  ...
  const b = A(!1), x = () => {
    ...
    () => Lr(e, d),
    [e, d]
  ), S = !!h && !p, y = `${E} (${N})`, z = S ? f || `${y}, ${h}` : y, T = /* @__PURE__ */ u(
    tr,
    {
      ref: t,
...
function md({
  ...
  const [h, f] = _(!1), [b, x] = _(!1), g = _a(), E = A(!1), N = w !== void 0, S = N ? w : h, y = n === "" ? "" : oe(n, gd), z = oe(s, fd), T = (I) => {
...
function Ya({
  ...
  const T = Re(), O = ud(), [M, D] = _(!1), [I, Y] = _(""), [X, B] = _(""), [k, ot] = _("books"), [$, q] = _(void 0), [Q, j] = _(
    void 0
  ), [at, wt] = _(void 0), [ct, tt] = _(!1), [ut, xt] = _(!1), [gt, Nt] = _(!1), [St, Gt] = _(!1), $t = A(null), ie = A(!1), Rt = A(void 0), Et = A(void 0), Bt = A(void 0), ce = A(void 0), le = A({}), Mt = A({}), Dt = L(
    (m) => {
      e(m), d && d(m);
    },
    [e, d]
  ...
  const G = L(() => {
    ...
    (m) => {
      D(m), m && (ot("books"), q(void 0), j(void 0), wt(void 0), B(""), Gt(!1), Nt(!1), xt(re));
    },
    [re]
  );
  J(() => {
...
function yn({
  ...
  return /* @__PURE__ */ u(lr, { open: S, onOpenChange: y, ...N, children: [
    /* @__PURE__ */ a(Dr, { asChild: !0, children: /* @__PURE__ */ u(
      et,
      {
        variant: b,
...
function Hd(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < f.length; E++) {
      const N = f[E], S = i[E] || document.createElement("div"), y = S.style;
      ...
      const M = Ce(N.height);
      y.height !== M && (S.style.height = M, g = !0), S.parentNode !== c && (c.append(S), g = !0), i[E] = S;
    }
...
function Gd(t, e = qd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), b = h.getNode(), x = b.getKey(), g = h.offset, E = f.getNode(), N = E.getKey(), S = f.offset, y = t.getElementByKey(x), z = t.getElementByKey(N), T = r === null || y !== o || g !== n || x !== r.getKey(), O = s === null || z !== i || S !== c || N !== s.getKey();
            ...
            t.update(() => {
              ...
              if (Te(b)) {
                ...
                if (ho(g) && l >= 0 && w >= 0 && (E = l, N = l + w, b.setTextNodeRange(g, E, g, N)), E === N && p === "" || (b.insertRawText(p), g = x.getNode()), ho(g)) {
                  ...
                  E = E > S ? S : E, N = N > S ? S : N, b.setTextNodeRange(g, E, g, N);
                }
...
const Jw = {
  ...
  const ct = L(
    ...
    [q.commentEdits, ct]
  ), [ut, xt] = _(), gt = n, [Nt, St] = _(!1), [Gt, $t] = _(!1), [ie, Rt] = _(!1), [Et, Bt] = _(!1), [ce, le] = _(!1), [Mt, Dt] = _(z), [de, xe] = _(!1), ge = A(void 0), [ye, Zt] = _(/* @__PURE__ */ new Map());
  J(() => {
    let R = !0;
    return (async () => {
  ...
  }, [ht, lt, Nt, q.commentEdits]), ke = V(() => Nt || lt <= 2 ? 0 : lt - Ie.length, [lt, Nt, Ie.length]), rr = V(
      ...
      !w && !h && /* @__PURE__ */ u(ft, { children: [
        ...
        /* @__PURE__ */ a(
          To,
          {
            ...
            children: T.map(($) => k($) ? /* @__PURE__ */ a(At, { delayDuration: 0, children: /* @__PURE__ */ u(yt, { children: [
...
function pu({
  ...
  var T;
  const [w, p] = _([]), [h, f] = _([]), [b, x] = _({}), [g, E] = _({}), N = V(() => e ?? [], [e]), S = Ni({
    data: N,
    columns: t,
    getCoreRowModel: Ei(),
...
function Cu({
  ...
  const N = (y) => {
    if (d.current = !1, b(y), !y) {
      const z = g.current, T = E.current;
      z !== "custom" || T ? (z !== t || T !== e) && (s.current = !0, r(z, T)) : (w(t), h(e));
    }
  }, S = (y) => {
    var z, T, O, M;
    y.stopPropagation(), document.activeElement === c.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((z = i.current) == null || z.focus(), d.current = !0) : document.activeElement === i.current && y.key === "ArrowUp" ? ((T = c.current) == null || T.focus(), d.current = !1) : document.activeElement === i.current && y.key === "ArrowLeft" && ((O = i.current) == null ? void 0 : O.selectionStart) === 0 && ((M = c.current) == null || M.focus(), d.current = !1), l === "custom" && y.key === "Enter" && (document.activeElement === c.current || document.activeElement === i.current) && N(!1);
  };
...
function Hh({
  ...
  const [x, g] = _("generated"), [E, N] = _("generated"), [S, y] = _("*"), [z, T] = _("*"), [O, M] = _("f"), [D, I] = _(!1), [Y, X] = _(!0), [B, k] = _(!1), ot = A(!1), $ = A(""), [q, Q] = _(!1), j = yu(), [at, wt] = _(), ct = A(null), tt = A(
    void 0
  ), ut = A(0), xt = A(void 0), gt = L(() => {
    var F, G, U;
    if ((F = h.current) != null && F.getSelection()) return;
    const C = xt.current;
    C ? (G = h.current) == null || G.setSelection(C) : (U = h.current) == null || U.selectNote(0);
  }, []), Nt = L(() => {
    var C;
  ...
  const $t = L(() => {
    var U, Z, H;
    const C = (U = f.current) == null ? void 0 : U.querySelector(".editor-input"), F = C == null ? void 0 : C.querySelector("span.note"), G = (H = (Z = f.current) == null ? void 0 : Z.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
  ...
  J(() => {
    ...
    if (U && Ir("note", U)) {
      ...
      let Ct = "custom";
      nt === go ? Ct = "generated" : nt === fo ? Ct = "hidden" : nt && (y(nt), T(nt)), g(Ct), N(Ct), M(((H = U.insert.note) == null ? void 0 : H.style) ?? "f"), C = setTimeout(() => {
        var mt, bt, ht;
    ...
    return () => {
      C && clearTimeout(C), F !== void 0 && cancelAnimationFrame(F), G !== void 0 && clearTimeout(G);
    };
  }, [e, s, $t]);
  const ie = L(
    (C = !1) => {
    ...
    (C, F) => {
      ...
      let U;
      C === "custom" ? U = F : C === "generated" ? U = go : U = fo, G.insert.note.caller !== U && (G.insert.note.caller = U, Rt(G));
    },
    [Rt]
  ), Bt = L(() => {
    var C;
  ...
  const Mt = () => {
    ...
    if (!Gt.length || !C || C.rangeCount === 0)
      return;
    const F = f.current;
    if (!F) return;
    const G = C.getRangeAt(0).cloneRange();
    j.setSource({
      measure: () => {
        const U = ku(G);
        return U && _u(U);
    ...
    var G;
    const C = (G = h.current) == null ? void 0 : G.getMarkerMenuContext();
    if (!C) return !1;
...
function Bu({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Yo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, b = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", E = o ? "marker-visible" : "", N = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", S = v(g, E);
  return /* @__PURE__ */ u(ft, { children: [
...
function Gh({
  ...
  return J(() => {
    var y;
    S < 0 || S >= N.current.length || (y = N.current[S]) == null || y.scrollIntoView({ block: "nearest" });
  }, [S, i]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function eg({
  ...
  const f = Ne(r, "%webView_inventory_all%"), b = Ne(r, "%webView_inventory_approved%"), x = Ne(r, "%webView_inventory_unapproved%"), g = Ne(r, "%webView_inventory_unknown%"), E = Ne(r, "%webView_inventory_scope_currentBook%"), N = Ne(r, "%webView_inventory_scope_chapter%"), S = Ne(r, "%webView_inventory_scope_verse%"), y = Ne(r, "%webView_inventory_filter_text%"), z = Ne(
    r,
    "%webView_inventory_show_additional_items%"
...
const Yu = "16rem", Zu = "3rem", ws = te.createContext(void 0);
function La() {
  const t = te.useContext(ws);
  if (!t)
...
function Xu({
  ...
  const [d, l] = te.useState(t), w = e ?? d, p = te.useCallback(
    ...
    [r, w]
  ), h = te.useCallback(() => p((S) => !S), [p]), f = w ? "expanded" : "collapsed", g = Re() === "ltr" ? i : i === "primary" ? "secondary" : "primary", E = te.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(ws.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
    ...
    Ju,
    {
      ...
      children: /* @__PURE__ */ u(tp, { children: [
        /* @__PURE__ */ u(Ln, { children: [
          ...
          /* @__PURE__ */ a(Fn, { children: /* @__PURE__ */ a(ep, { children: Object.entries(e).map(([g, E]) => /* @__PURE__ */ a(rp, { children: /* @__PURE__ */ a(
            op,
            {
              onClick: () => p(g),
              isActive: x(g),
...
const He = "scrBook", ip = "scrRef", nr = "source", sp = "details", cp = "Scripture Reference", lp = "Scripture Book", us = "Type", dp = "Details";
function wp(t, e) {
  const r = e ?? !1;
  return [
    {
...
function pp({
  ...
  }, [g, E] = _(!1), [N, S] = _(""), y = A(void 0), z = A(!1), T = V(
    () => Jn(t),
    [t]
  ), O = V(() => {
    if (!N.trim()) {
...
function vg({
  ...
  ] }), gt = e ? ut.filter((K) => e.includes(K.value)) : ut, Nt = g ?? Ga, St = h ?? Nt, Gt = f ?? Nt, $t = () => {
  ...
  ), C = gt.find((K) => K.value === "selectedBooks"), F = gt.find((K) => K.value === "range"), [G, U] = _(!1), [Z, H] = _(void 0), [nt, Ct] = _(void 0), [mt, bt] = _(void 0), [ht, lt] = _(void 0), [It, Ie] = _([]), ke = p === "dropdown" && Z === "selectedBooks", rr = /* @__PURE__ */ a(
    fp,
    {
      availableBookInfo: o,
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => ds(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => {
  if ("command" in c)
...
function No({
  ...
  const l = _a(), w = Wu(e), p = s && w.length > 1;
  Oi();
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        children: w.map(({ columnKey: b, label: x, isHeaderHidden: g }, E) => {
          const N = `${l}-${b}`;
          return /* @__PURE__ */ u(Yr, { children: [
            /* @__PURE__ */ u(Wn, { "aria-labelledby": p ? N : void 0, children: [
...
function zp({
  ...
  if (sd(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(_p, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ls(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Np, { children: [
...
function Sg({
  ...
  const l = Ap(
    ...
    var E, N, S, y, z, T;
    const g = x !== b ? ((N = (E = t[b]) == null ? void 0 : E.uiNames) == null ? void 0 : N[x]) ?? ((y = (S = t[b]) == null ? void 0 : S.uiNames) == null ? void 0 : y.en) : void 0;
...
function Dg({
  ...
  Ht(() => {
    ...
    const T = h.current.get(E), O = N ? w.current : void 0;
    O && (T ? O.setAttribute("aria-activedescendant", T.id) : O.removeAttribute("aria-activedescendant")), T && E !== d && T.scrollIntoView({ block: "nearest" });
  }, [E, d, N]);
...
export {
  ...
  ds as isGroupUnderColumnOrSubMenu,
  So as isMacOs,
  hm as isWindows,
  _u as leftEdgeRect,
