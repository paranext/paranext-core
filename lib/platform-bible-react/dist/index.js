...
import b, { forwardRef as an, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as Ot, createContext as Cn, useContext as gr, useEffect as Y, Component as fs, createElement as jr, Suspense as hs, Fragment as go } from "react";
import { Command as Ct } from "cmdk";
import { X as je, Search as bo, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Wn, ChevronRight as Oe, ArrowLeft as gs, ArrowRight as bs, Circle as En, ChevronDown as ze, BoldIcon as vs, ItalicIcon as xs, AtSign as vo, Pencil as ys, Trash2 as Ns, ArrowUp as xo, MoreHorizontal as ks, MailOpen as _s, Mail as Cs, ChevronUp as yo, FilterIcon as Es, ArrowLeftIcon as Ts, ChevronLeftIcon as Rs, ChevronRightIcon as Ss, ArrowRightIcon as Ds, Copy as No, Filter as Ms, User as Is, Link as Os, CircleHelp as As, ChevronsUpDown as ko, Star as Ps, Undo as $s, Redo as Ls, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, Ban as Vs, AlertCircle as Jn, CircleCheckIcon as js, CircleXIcon as zs, CircleHelpIcon as Fs, ArrowUpIcon as Bs, ArrowDownIcon as Ks, PanelLeft as Gs, PanelRight as Us, ScrollText as qs, MenuIcon as Hs, Menu as Ys, EllipsisVertical as Xs, MoreVertical as Kr, LoaderCircle as Ws, GripVertical as Js } from "lucide-react";
...
import { includes as cn, Section as X, getChaptersForBook as ti, formatScrRef as xe, getSectionForBook as We, formatRelativeDate as ei, formatReplacementString as ve, sanitizeHtml as ni, NumberFormat as ri, formatBytes as oi, getCurrentLocale as ai, usfmMarkers as fn, getFormatCallerFunction as si, deepEqual as ii, isString as Gr, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as Ro, $getRoot as de, $createParagraphNode as Tn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as So, TextNode as Do, $isTokenOrSegmented as li, $getCharacterOffsets as wi, $cloneWithPropertiesEphemeral as ci, $findMatchingParent as Mo, $isElementNode as we, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Io, COMMAND_PRIORITY_EDITOR as Oo, mergeRegister as pe, shallowMergeConfig as di, defineExtension as qt, safeCast as sn, createState as pi, FORMAT_TEXT_COMMAND as Ao, $isNodeSelection as Po, COMMAND_PRIORITY_LOW as $o, RootNode as ui, LineBreakNode as mi, TabNode as fi, $isEditorState as hi, createCommand as gi, CLICK_COMMAND as bi, isDOMNode as vi, $getNodeFromDOMNode as xi, $createNodeSelection as yi, $setSelection as Ni, DecoratorNode as Qn, $getState as ki, toggleTextFormatType as Ur, TEXT_TYPE_TO_FORMAT as _i, $setState as Ci, addClassNamesToElement as Lo, $create as Ei, $getNodeByKey as Ti, removeClassNamesFromElement as Ri, KEY_TAB_COMMAND as Si, $isBlockElementNode as bn, $createRangeSelection as Di, $normalizeSelection__EXPERIMENTAL as Mi, OUTDENT_CONTENT_COMMAND as Ii, INDENT_CONTENT_COMMAND as qr, INSERT_TAB_COMMAND as Oi, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Ai, $isParagraphNode as Pi, $isTextNode as vn, SELECTION_CHANGE_COMMAND as Vo, getRegisteredNode as $i, isHTMLElement as Li, isDocumentFragment as Hr, isDOMDocumentNode as Vi, ArtificialNode__DO_NOT_USE as jo, $createLineBreakNode as zo, $isRootOrShadowRoot as ji, isBlockDomNode as Yr, isInlineDomNode as Xr, $insertNodes as zi } from "lexical";
...
import { useReactTable as Go, getFilteredRowModel as Xi, getSortedRowModel as Uo, getPaginationRowModel as Wi, getCoreRowModel as qo, flexRender as Je, getGroupedRowModel as Ji, getExpandedRowModel as Zi } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import Qi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as tr, HIDDEN_NOTE_CALLER as er, getDefaultViewOptions as tl, isInsertEmbedOpOfType as dn, Editorial as el } from "@eten-tech-foundation/platform-editor";
...
const sl = Lt.Root, il = Lt.Portal, Ho = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
    className: f(
...
Ho.displayName = Lt.Overlay.displayName;
...
Yo.displayName = Lt.Content.displayName;
...
Wo.displayName = Lt.Title.displayName;
...
ll.displayName = Lt.Description.displayName;
...
const ae = Ae.Root, fe = Ae.Trigger, cl = Ae.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ht();
...
Yt.displayName = Ae.Content.displayName;
function ar(t, e, n) {
  return `${t} ${ye[t]}${e ? ` ${Nr(t, e)} ${Ie(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function dl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(ae, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r(Ut, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Ht,
      {
        onSelect: () => h(u),
...
function gp(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function bp({
  ...
  const c = ht(), [d, m] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), R = H(void 0), $ = H(void 0), E = H(void 0), D = H({}), V = K(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
  ...
  }), [P]), A = B(() => Object.values(O).flat(), [O]), W = B(() => {
    if (!g.trim()) return O;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: L } = Wr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (_ || L) {
          if (M.preventDefault(), M.stopPropagation(), y("books"), k(void 0), L && N) {
            const U = ye[N];
            x(`${U} ${M.key}`);
          } else
            x(M.key);
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        ...
        tt !== q && (M.preventDefault(), M.stopPropagation(), u(ar(U, a, tt)), setTimeout(() => {
    ...
    const { isLetter: _, isDigit: L } = Wr(M.key);
    (_ || L) && (M.preventDefault(), x((U) => U + M.key), R.current.focus(), F(!1));
  }, []);
  return Ot(() => {
    const M = setTimeout(() => {
      if (d && v === "books" && $.current && E.current) {
        const _ = $.current, L = E.current, U = L.offsetTop, q = _.clientHeight, lt = L.clientHeight, tt = U - q / 2 + lt / 2;
        _.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(ar(t.book));
  ...
  }, [v, N, I, t.book, t.chapterNum]), /* @__PURE__ */ p(ae, { open: d, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
      ...
      re,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: gt.map(({ onClick: M, disabled: _, title: L, icon: U }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
          ...
          !C && /* @__PURE__ */ p(oe, { ref: $, children: [
            v === "books" && /* @__PURE__ */ p(it, { children: [
              ...
              I && Gt(I.book) > 1 && /* @__PURE__ */ p(it, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ie(I.book, a) }),
                /* @__PURE__ */ r(
                  Jr,
                  {
                    bookId: I.book,
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: f("pr-twp", fl(), t), ...e }));
ft.displayName = To.Root.displayName;
...
function sr({
  ...
  const [N, k] = S(!1), C = w ?? l, F = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], j = (R, $) => {
  ...
  return /* @__PURE__ */ p(ae, { open: N, onOpenChange: k, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(re, { children: [
          ...
          /* @__PURE__ */ r(oe, { children: F(e) ? e.map((R) => /* @__PURE__ */ r(Ut, { heading: R.groupHeading, children: R.options.map(($) => j($, R.groupHeading)) }, R.groupHeading)) : e.map((R) => j(R)) })
        ] })
      }
    )
  ] });
...
function yp({
  ...
  const d = Vn(c, "%webView_bookSelector_currentBook%"), m = Vn(c, "%webView_bookSelector_choose%"), h = Vn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(ft, { className: "tw-ms-1", children: d })
          ] }),
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(ft, { className: "tw-flex tw-items-center", children: o.map((v) => ut.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = ra ? Ot : Y, pn = { tag: br };
function xl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = bl(null, o), d = Ro({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          case "string": {
            ...
            m.setEditorState(u, pn);
            break;
          }
          case "object":
            m.setEditorState(h, pn);
            break;
          case "function":
            m.update(() => {
              de().isEmpty() && h(m);
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function Nl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Xt();
  return yl(() => {
...
function El({ children: t, onError: e }) {
  return r(_l, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function Rl(t) {
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = oa && "documentMode" in document ? document.documentMode : null;
!(!oa || !("InputEvent" in window) || Il) && "getTargetRanges" in new window.InputEvent("input");
function Ol(t) {
  const e = Mo(t, (n) => we(n) && !n.isInline());
  return we(e) || Ml(4, t.__key), e;
}
function Al(t) {
  const e = Vt();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Mo(s, (c) => we(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Vl(t) {
  ...
  sa(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Sn();
}
function Me(t, e) {
...
Nt.prototype.brand = Pl, Nt.prototype.h = function() {
  return !0;
  ...
  if (this.g = hn, this.f |= 1, this.i > 0 && !aa(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    to(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), to(this), ce++;
  const t = Z;
  return Z = this, Vl.bind(this, t);
...
function la() {
  const t = de(), e = Vt(), n = Tn();
  t.clear(), t.append(n), e !== null && n.select(), ke(e) && (e.format = 0);
}
function wa(t, e = la) {
  return t.registerCommand(Io, (n) => (t.update(e), !0), Oo);
}
qt({ build: (t, e, n) => Dn(e), config: sn({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ue(() => wa(t, o.value));
} });
function jl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const zn = pi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ca extends Qn {
  $config() {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [ca], register: (t, e, n) => t.registerCommand(Ao, (o) => {
  const a = Vt();
  if (Po(a) || ke(a)) for (const s of a.getNodes()) zl(s) && s.toggleFormat(o);
  return !1;
}, $o) });
function da(t, e) {
  let n;
...
const wr = qt({ build: (t) => da(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Rr = 0, cr = 1, ua = 2, Fn = 3, un = 4, De = 5, Bn = 6, He = 7;
function Kn(t) {
  return t.id === Rr;
}
function ma(t) {
...
function Fl(t) {
  return function(e) {
    return e.id === cr;
  }(t) || et(305, String(t.id), String(cr)), Object.assign(t, { id: ua });
}
...
class Kl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== un && et(307, String(n.id), String(De)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  register(e, n) {
    this._signal = n;
    const o = this.state;
    o.id !== De && et(308, String(o.id), String(De));
...
const Ul = qt({ config: sn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: t = Gl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (hi(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ui, Do, mi, fi, So] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function ql(t) {
  throw t;
...
class Qe {
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && et(298, o.name), !a) {
      a = new Kl(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Kn(s) || et(300, i, a || "[unknown]"), Kn(l = s) || et(304, String(l.id), String(Rr)), s = Object.assign(l, { id: cr }), o.state = s;
      const w = this.outgoingConfigEdges.get(i);
      if (w) for (const c of w.keys()) {
        const d = this.extensionNameMap.get(c);
        d && n(d, i);
      }
      s = Fl(s), o.state = s, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of jl(m)) {
...
const Hl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(wr).output, a = nn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = da(() => {
  }, () => ue(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = Ll(() => (s.value || Hl).has(i)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(i);
    const d = c !== void 0;
...
qt({ dependencies: [wr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Pe], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(oo).output, a = nn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return pe(t.registerCommand(bi, (i) => {
    if (vi(i.target)) {
      const l = xi(i.target);
      if (Xl(l)) return function(w, c = !1) {
        const d = Vt(), m = w.isSelected(), h = w.getKey();
        let u;
        c && Po(d) ? u = d : (u = yi(), Ni(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, $o), t.registerMutationListener(Pe, (i, l) => {
    $l(() => {
      let w = !1;
...
function Wl(t, e, n = ha) {
  return pe(t.registerCommand(Si, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => bn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = Ol(d);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Di();
...
qt({ build: (t, e, n) => Dn(e), config: sn({ $canIndent: ha, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return ue(() => {
    if (!o.value) return Wl(t, a, s);
  });
} });
const Jl = qt({ name: "@lexical/react/ReactProvider" });
function Zl() {
          ...
          if (w) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (vn(v) && c >= 0 && d >= 0 && (y = c, N = c + d, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), vn(v)) {
                  y = h, N = h + u;
...
qt({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ue(() => n.getOutput().disabled.value ? void 0 : ba(t)) });
function ew(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Sr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
...
function rw({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Jl.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && ew(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(nw, { editor: t, ErrorBoundary: e });
}
function ao(t) {
  return t.getEditorState().read(ga(t.isComposing()));
}
function ow({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => pe(Gi(a), ba(a)), [a]);
  }(o), p(it, { children: [t, r(aw, { content: e }), r(rw, { editor: o, ErrorBoundary: n })] });
}
function aw({ content: t }) {
...
const iw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function lw({ onClear: t }) {
  const [e] = Xt();
  return iw(() => wa(e, t), [e, t]), null;
}
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function ww({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...F }, j) {
  ...
  return va(() => ($(t.isEditable()), t.registerEditableListener((V) => {
    $(V);
  })), [t]), r("div", { "aria-activedescendant": R ? e : void 0, "aria-autocomplete": R ? n : "none", "aria-controls": R ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": R && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": d, "aria-owns": R ? m : void 0, "aria-readonly": !R || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: R, "data-testid": C, id: x, ref: D, role: v, spellCheck: y, style: N, tabIndex: k, ...F });
}
const cw = an(ww);
function so(t) {
  return t.getEditorState().read(ga(t.isComposing()));
...
function pw(t, e) {
  ...
  return p(it, { children: [r(cw, { editor: a, ...o, ref: e }), n != null && r(uw, { editor: a, content: n })] });
}
function uw({ content: t, editor: e }) {
  const n = function(i) {
    const [l, w] = S(() => so(i));
    return va(() => {
      function c() {
...
function gw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = hw(), w = () => {
  };
...
), vw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Fo.Root,
  {
    ref: a,
...
vw.displayName = Fo.Root.displayName;
...
Dr.displayName = Rn.Root.displayName;
...
function Nw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(gw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(xw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        ow,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(mw, { placeholder: t }) }),
          ErrorBoundary: El
        }
      ),
      e && /* @__PURE__ */ r(sw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(yw, { onClear: n }),
      /* @__PURE__ */ r(lw, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          xl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(Nw, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Nl,
                {
...
function _a(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && vn(e) && (i = Dl(o, e, "clone"));
  const l = we(i) ? i.getChildren() : [], w = $i(t, i.getType());
  let c;
  ...
  if (a && !s) {
    if ((Li(d) || Hr(d)) && d.append(h), n.append(d), m) {
      const u = m.call(i, d);
...
function Ea(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !ji(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Ea(m[g], e, n, u, new Map(a), l));
  return d != null && (h = d(h)), Yr(t) && (h = Ew(t, h, u ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Tn)), l == null ? h.length > 0 ? i = i.concat(h) : Yr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Xr(g.nextSibling) && Xr(g.previousSibling);
  }(t) && (i = i.concat(zo())) : we(l) && l.append(...h), i;
}
function Ew(t, e, n) {
...
function Tw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = _w(e, a);
      de().clear(), zi(s);
    },
    {
      discrete: !0
...
function Np({
  ...
  const [a, s] = S(Rw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(ae, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
        z,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        Yt,
        {
          ...
          children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: t.map((y) => /* @__PURE__ */ r(
            Ht,
            {
              onSelect: () => {
                l(y === "" ? void 0 : y), c(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Ir(y) && (y.preventDefault(), y.stopPropagation(), $t(a) && h());
        },
        onKeyDown: (y) => {
...
const kp = Object.freeze([
...
], Sw = ["input", "select", "textarea", "button"], Dw = ["button", "textbox"], Mw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
  ...
  const a = H(null), [s, i] = S(void 0), [l, w] = S(void 0), c = K(
    ...
    if (u.isContentEditable || Sw.includes(g)) return !0;
    const x = u.getAttribute("role");
    if (x && Dw.includes(x)) return !0;
    const v = u.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = K(
    (u) => {
      var R;
      const g = u.target, x = ($) => $ ? document.getElementById($) : void 0, v = x(l), y = x(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          if (E === -1) return;
          let D;
          u.key === "ArrowDown" ? D = Math.min(E + 1, $.length - 1) : D = Math.max(E - 1, 0), D !== E && (u.preventDefault(), u.stopPropagation(), (R = $[D]) == null || R.focus());
          return;
        }
        return;
      }
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", Iw({ variant: e }), t), ...n })
);
$e.displayName = "Badge";
...
const Pw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Pw.displayName = "CardDescription";
...
const Ce = b.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Ko.Root,
  {
    ref: a,
    decorative: n,
...
Ce.displayName = Ko.Root.displayName;
...
Lw.displayName = Be.Image.displayName;
...
}), Ee = nt.Trigger, Oa = nt.Group, Vw = nt.Portal, jw = nt.Sub, zw = nt.RadioGroup;
...
Fw.displayName = "DropdownMenuShortcut";
function lo({
  comment: t,
  isReply: e = !1,
  localizedStrings: n,
    ...
    if (o && l)
      return /* @__PURE__ */ p(it, { children: [
        /* @__PURE__ */ p(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Tw(t.contents)), i == null || i(!0);
            },
            children: [
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p($e, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              gn(t.assignedUser, n)
            ] })
          ] }),
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Ir(C) && (C.preventDefault(), C.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ p(me, { children: [
          /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ks, {}) }) }),
...
function Bw({
  ...
  const [R, $] = S(wo), [E, D] = S(
    void 0
  ), V = o, [P, O] = S(!1), [A, W] = S(!1), [I, J] = S(!1), [Tt, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Jt = B(() => Bt[0], [Bt]), Se = H(null), ie = H(void 0), Zt = K(() => {
    var T;
    (T = ie.current) == null || T.call(ie), $(wo);
  }, []), qe = K(() => {
    const T = !pt;
  ...
  }, [s, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), lt = B(() => P || U <= 2 ? L : L.slice(-2), [L, U, P]), tt = B(() => P || U <= 2 ? 0 : U - 2, [U, P]), bt = B(
  ...
  const Rt = K(
    ...
    async (T) => {
      const vt = $t(R) ? Nn(R) : void 0, mt = await m({
        ...T,
        contents: vt,
        assignedUser: E ?? T.assignedUser
      });
      return mt && vt && Zt(), mt && E !== void 0 && D(void 0), mt;
    },
    [Zt, R, m, E]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ p(Da, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            _ && /* @__PURE__ */ r($e, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: _ }),
            /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ p(it, { children: [
          q && !o && /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Ce, {}) }),
          ...
          o && /* @__PURE__ */ p(it, { children: [
            ...
            v !== !1 && (!A || $t(R)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Ir(T) && (T.preventDefault(), T.stopPropagation(), ($t(R) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
                    ...
                    /* @__PURE__ */ p(ae, { open: I, onOpenChange: J, children: [
                      ...
                      /* @__PURE__ */ r(
                        Yt,
                        {
                          ...
                          children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(oe, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ r(
                            Ht,
                            {
                              onSelect: () => {
                                D(T !== s ? T : void 0), J(!1);
...
function Cp({
  ...
  const F = n.filter(
    ...
    (O) => {
      N((A) => new Set(A).add(O.id)), C(O.id), x == null || x(O.id);
    },
    [x]
  ), $ = K(
    (O) => {
      ...
      }), C(O), x == null || x(A ? void 0 : O);
    },
    [y, x]
  ), { listboxRef: E, activeId: D, handleKeyDown: V } = Mw({
    options: j,
    onOptionSelect: R
  }), P = K(
    (O) => {
      O.key === "Escape" ? (k && y.has(k) && (N((A) => {
        const W = new Set(A);
        return W.delete(k), W;
...
const Le = dt.Root, Gw = dt.Group, Ve = dt.Value, Uw = ne(
...
qw.displayName = dt.Label.displayName;
...
Hw.displayName = dt.Separator.displayName;
function Yw({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        Le,
        {
          ...
          children: [
            /* @__PURE__ */ r(Te, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ve, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Re, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(It, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function rn(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Xw(o)
  );
}
...
const On = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), Qw(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), Zw(l, x, d.key);
...
function ec({
  ...
  let F;
  return w ? F = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i(R, k),
    ...
    a && /* @__PURE__ */ r(Kw, { table: k }),
    /* @__PURE__ */ p(Mn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(In, { stickyHeader: s, children: k.getHeaderGroups().map((R) => /* @__PURE__ */ r(Qt, { children: R.headers.map(($) => /* @__PURE__ */ r(on, { className: "tw-p-0", children: $.isPlaceholder ? void 0 : Je($.column.columnDef.header, $.getContext()) }, $.id)) }, R.id)) }),
      /* @__PURE__ */ r(On, { children: F })
    ] }),
...
function Ep({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Qi, { options: s, children: e })
    }
  );
}
...
var oc = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(oc || {});
function Sp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(me, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Oa, { children: c.itemType === 0 ? /* @__PURE__ */ r(it, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
...
function Mp({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(ac, { versionHistory: a }),
...
function sc({
  ...
  const [y, N] = S(!1), k = K(
    (D) => {
      var P;
      const V = (P = t.find((O) => O.label === D)) == null ? void 0 : P.value;
      V && n(
    ...
    if (!h) return t;
    const D = t.filter((P) => P.starred).sort((P, O) => P.label.localeCompare(O.label)), V = t.filter((P) => !P.starred).sort((P, O) => {
      const A = e.includes(P.value), W = e.includes(O.value);
      return A && !W ? -1 : !A && W ? 1 : P.label.localeCompare(O.label);
    });
    return [...D, ...V];
  }, [t, e, h]), j = () => {
    n(t.map((D) => D.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(ae, { open: $, onOpenChange: d ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      z,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(re, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
        ...
        /* @__PURE__ */ r(Ut, { children: F.map((D) => /* @__PURE__ */ p(
          Ht,
          {
            ...
            children: [
              ...
              D.starred && /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" }),
...
function Ip({
  ...
  return /* @__PURE__ */ p("div", { id: m, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((h) => {
      var u;
      return /* @__PURE__ */ p($e, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          z,
          {
            variant: "ghost",
...
function lc({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      "data-orientation": e,
      className: f("pr-twp", ic({ orientation: e }), t),
      ...n
    }
  );
}
...
function dc({
  ...
  const w = B(() => /Macintosh/i.test(navigator.userAgent), []), c = uo(a, "%undoButton_tooltip%"), d = uo(a, "%redoButton_tooltip%");
  return /* @__PURE__ */ p(lc, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(
        z,
        {
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ r(pr, { children: w ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (l === "secondary" || l === "default") && /* @__PURE__ */ r(wc, {}),
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ p("p", { children: [
        ...
        s && /* @__PURE__ */ p(it, { children: [
          " ",
          /* @__PURE__ */ r(pr, { children: w ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const uc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(it, { children: [
...
function mc({
  ...
  return /* @__PURE__ */ p(me, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: uc(t, a, n) }) }) }),
...
const fc = (t, e) => t === "f" ? /* @__PURE__ */ p(it, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function gc({
  ...
  return /* @__PURE__ */ p(me, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Fi, { asChild: !0, children: /* @__PURE__ */ r(Ee, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: fc(t, n) }) }) }),
...
function Op({
  ...
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, F] = S(!1), [j, R] = S(!0), [$, E] = S(!1), D = H(!1), V = H(""), [P, O] = S(!1), [A, W] = S(), [I, J] = S(), [Tt, At] = S(), [Mt, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && dn("note", L)) {
      ...
      let tt = "custom";
      lt === tr ? tt = "generated" : lt === er ? tt = "hidden" : lt && y(lt), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
  ...
  const st = K(
    (_, L, U = !1) => {
      var lt, tt, bt;
      const q = (tt = (lt = d.current) == null ? void 0 : lt.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (q && dn("note", q)) {
        if (q.insert.note) {
          let ct;
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      const ct = (tt = (lt = L.insert.note) == null ? void 0 : lt.contents) == null ? void 0 : tt.ops;
    ...
    (_) => {
      ...
      if (L && dn("note", L)) {
        ...
        const ct = (lt = L.insert.note) == null ? void 0 : lt.style, Rt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (ct || F(!1), F(
          ct === "x" ? !!(Rt != null && Rt.every((Pt) => {
            var vt, mt;
    ...
    if (h.current && at.length && _ && _.rangeCount > 0) {
      ...
      W(L.left - U.left), J(L.top - U.top), At(L.height), O(!0);
    }
  }, [at, h]);
  return Y(() => {
    const _ = () => {
    ...
    const _ = ((U = m.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
      !P && _ && document.activeElement === _ && q.key === l ? (q.preventDefault(), M()) : P && q.key === "Escape" && (q.preventDefault(), O(!1));
    };
    return document.addEventListener("keydown", L), () => {
      document.removeEventListener("keydown", L);
    };
  }, [P, M, l]), /* @__PURE__ */ p(it, { children: [
  ...
  return /* @__PURE__ */ p(it, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(it, { children: Cc(t.marker, l, o, c) })
      }
    )
  ] });
}
        ...
        "ul",
        {
          ...
          children: n.map((N, k) => {
            ...
            return /* @__PURE__ */ p(it, { children: [
              ...
              k < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Ce, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function Sc({
  ...
  return /* @__PURE__ */ p(Mn, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(On, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        onClick: () => {
          e(l.reference);
...
Pr.displayName = nr.Root.displayName;
const Dc = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Bs, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(Ks, { className: "tw-h-4 tw-w-4" });
}, An = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
  /* @__PURE__ */ p(
    Dt,
    {
  ...
  return e ? e[1] : "";
}, Ic = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Bp = Object.freeze([
...
function Kp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), F = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Kt(n, "%webView_inventory_no_results%"), [R, $] = S(!1), [E, D] = S("all"), [V, P] = S(""), [O, A] = S([]), W = B(() => {
    const G = t ?? [];
  ...
  }, [R, W]), J = B(() => I.length === 0 ? [] : Oc(I, E, V), [I, E, V]), Tt = B(() => {
    var st, wt;
    if (!R) return w;
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ p(
        Le,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(Te, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ p(Le, { onValueChange: (G) => Mt(G), defaultValue: i, children: [
        /* @__PURE__ */ r(Te, { className: "tw-m-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Re, { children: [
          /* @__PURE__ */ r(It, { value: "book", children: y }),
          /* @__PURE__ */ r(It, { value: "chapter", children: N }),
...
const Fa = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), m = e ?? c, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((k) => !k), [h]), g = m ? "expanded" : "collapsed", y = ht() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
...
const le = "scrBook", Zc = "scrRef", be = "source", Qc = "details", td = "Scripture Reference", ed = "Scripture Book", Ya = "Type", nd = "Details";
function rd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ut.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === le ? xe(a.start) : void 0;
      },
...
function Up({
  ...
  const [c, d] = S([]), [m, h] = S([{ id: le, desc: !1 }]), [u, g] = S({}), x = B(
  ...
  Y(() => {
    if (l) {
      ...
      if (D.length === 1) {
        const V = x.find((P) => fo(P) === D[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? ed, k = s ?? Ya, C = [
  ...
  }, R = (E, D) => E.getIsGrouped() ? "" : f("banded-row", D % 2 === 0 ? "even" : "odd"), $ = (E, D, V) => {
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          /* @__PURE__ */ r(Te, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ve, {}) }),
          /* @__PURE__ */ r(Re, { position: "item-aligned", children: /* @__PURE__ */ r(Gw, { children: C.map((E) => /* @__PURE__ */ r(It, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Mn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(In, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((D) => D.column.columnDef.header).map((D) => (
      ...
      /* @__PURE__ */ r(On, { children: y.getRowModel().rows.map((E, D) => {
        const V = ht();
        return /* @__PURE__ */ r(
          Qt,
          {
...
function sd({
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (A, W = !1) => {
      if (!W || !C.current) {
        n(
          e.includes(A) ? e.filter((gt) => gt !== A) : [...e, A]
        ), C.current = A;
        return;
      }
      const I = j.findIndex((gt) => gt === C.current), J = j.findIndex((gt) => gt === A);
      if (I === -1 || J === -1) return;
      const [Tt, At] = [
        Math.min(I, J),
        Math.max(I, J)
      ], Mt = j.slice(Tt, At + 1).map((gt) => gt);
      n(
        e.includes(A) ? e.filter((gt) => !Mt.includes(gt)) : [.../* @__PURE__ */ new Set([...e, ...Mt])]
      );
    },
    [e, n, j]
  ), E = (A) => {
    $(A, F.current), F.current = !1;
  }, D = (A, W) => {
    A.preventDefault(), $(W, A.shiftKey);
  }, V = K(
    (A) => {
      const W = Lr(j, A).map((I) => I);
      n(
        Xa(j, A, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), P = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            re,
            {
              shouldFilter: !1,
              onKeyDown: (A) => {
                A.key === "Enter" && (F.current = A.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ke,
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: P, children: w }),
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Hn ? Hn : ho
      ).map((A) => /* @__PURE__ */ r($e, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ie(A, a) }, A)),
      ...
      /* @__PURE__ */ r(
        _r,
        {
          ...
          children: y.map(({ value: N, label: k, id: C }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(ft, { htmlFor: C, children: k })
          ] }, C))
        }
      )
    ] }),
...
function Yp({
  ...
  return /* @__PURE__ */ p(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Te, { size: a, className: f("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Ve,
          {
            placeholder: l[Q(e)] ?? e
          }
...
const Ja = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ p(jw, { children: [
    /* @__PURE__ */ r(Aa, { children: l.label }),
    /* @__PURE__ */ r(Vw, { children: /* @__PURE__ */ r(Pa, { children: Ja(
      t,
      e,
      Wa(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(me, { variant: s, children: [
    /* @__PURE__ */ r(Ee, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Hs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(go, { children: [
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ye(s, [h, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Ye(i, [h, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(ld, { children: [
  ...
  return /* @__PURE__ */ p("div", { id: w, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      Le,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Te, { children: /* @__PURE__ */ r(Ve, {}) }),
          /* @__PURE__ */ r(
            Re,
            {
              className: "tw-z-[250]",
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(me, { children: [
              /* @__PURE__ */ r(Ee, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
...
const hd = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ws, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
const iu = ot.Root, lu = ot.Trigger, wu = ot.Group, cu = ot.Portal, du = ot.Sub, pu = ot.RadioGroup, yd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
const uu = zt.Trigger, Md = zt.Portal, mu = zt.Close, ds = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
const vu = Et.Root, zd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    Et.List,
    {
