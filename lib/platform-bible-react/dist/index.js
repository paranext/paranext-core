...
import u, { forwardRef as pe, useState as O, createContext as Or, useContext as Mr, useCallback as $, useRef as q, useMemo as J, useEffect as ct, useLayoutEffect as gn, Fragment as Dn } from "react";
import { Check as _t, CircleSlash as zr, ChevronRight as Ke, Circle as qe, X as Je, Search as Vn, ChevronsUpDown as We, FilterIcon as Br, ChevronDown as ue, ChevronUp as Ar, ArrowLeftIcon as Ir, ChevronLeftIcon as Pr, ChevronRightIcon as jr, ArrowRightIcon as Fr, Copy as Xr, Filter as Gr, User as $r, Link as Lr, CircleHelp as Hr, Star as Yr, CircleCheckIcon as Ur, CircleXIcon as Kr, CircleHelpIcon as qr, ArrowUpIcon as Jr, ArrowDownIcon as Wr, ArrowUpDownIcon as Zr, PanelLeft as Qr, PanelRight as ta, ScrollText as ea, ChevronLeft as na, MenuIcon as ra, Menu as aa, EllipsisVertical as oa, LoaderCircle as sa } from "lucide-react";
...
import { formatScrRef as Mt, MODIFIER_KEYS as bn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as Me, compareScrRefs as Fe, scrRefToBBBCCCVVV as ze, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
function Fa({
  ...
  const i = Array.from({ length: e }, (p, c) => c + 1), w = $(
    (p) => {
      o(p);
    },
    [o]
...
const yn = 6, on = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), Kn = Object.fromEntries(
...
function Ws({
  ...
  const o = Z(), [s, i] = O(
    () => Mt(t, "English")
  ), [w, p] = O(""), [c, g] = O(t.book), [b, m] = O(t.chapterNum ?? 0), [h, x] = O(t.book), [C, N] = O(!1), [S, y] = O(C), [z, B] = O(!1), [A, mt] = O(), U = q(void 0), k = q(void 0), v = q(void 0), P = q(void 0), R = $(
    (f) => {
      if (f.trim())
        return Nn.reduce(
          (D, _) => {
    ...
    if (!(!A || !A.chapterNum))
      return A.verseNum ? [A.chapterNum] : Array.from({ length: It(h) }, (f, D) => D + 1).filter(
        (f) => {
          var D;
          return (A == null ? void 0 : A.chapterNum) && f.toString().includes((D = A == null ? void 0 : A.chapterNum) == null ? void 0 : D.toString());
        }
      );
  }, [h, A]), lt = J(() => {
    const f = R(s.trim());
    ...
    (f) => {
      ...
      return {
        ...
        const Y = Kn[_].toLowerCase(), F = w.length > 0 && /^\d/.test(w) ? (
    ...
    i(Mt(t, "English")), p(""), g(t.book), x(t.book);
  }, [t]), gt = $((f) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (f, D, _, Y) => {
      if (m(t.book !== f ? 1 : t.chapterNum), D || It(f) === -1) {
        e({
          book: f,
          chapterNum: _ ?? 1,
          verseNum: Y ?? 1
    ...
    (f) => {
      if (!C)
        ...
        return;
      } else f.key === "ArrowDown" ? (P != null && P.current ? P.current.focus() : v != null && v.current ? v.current.focus() : k.current && k.current.focus(), f.preventDefault()) : f.key === "Escape" && document.activeElement === U.current && (N(!1), f.preventDefault(), f.stopPropagation());
      if (document.activeElement === U.current) {
        if (/^[a-zA-Z]$/.test(f.key) && (T(lt ? w + f.key : f.key), B(!0), f.preventDefault()), /^\d$/.test(f.key)) {
          const D = s;
          if (z)
            T(w + f.key);
          else {
    ...
    bn.has(f.key) || (f.key === "Tab" && f.shiftKey && (U.current.focus(), f.preventDefault()), f.stopPropagation(), U.current.focus(), U.current.dispatchEvent(new KeyboardEvent("keydown", { ...f, view: void 0 })));
  }, []), Er = $(
    (f) => {
      const { key: D } = f;
    ...
    const { key: D } = f;
    D === "ArrowUp" && (f.preventDefault(), U.current.focus());
  }, []), Vr = $(
    (f, D) => {
      const { key: _ } = f;
      if (kn.has(_)) {
        if (h === c || tt === 1) {
          const F = tt === 1 ? h : c;
          if (_ === "Enter") {
            f.preventDefault(), ot(F, !0, b);
            return;
          }
          const Rt = _ === "ArrowRight" && !o || _ === "ArrowRight" && o === "ltr" || _ === "ArrowLeft" && o === "rtl", oe = _ === "ArrowLeft" && !o || _ === "ArrowLeft" && o === "ltr" || _ === "ArrowRight" && o === "rtl", Ve = Array.from(
            { length: It(h) },
            (se, Et) => Et + 1
          ), it = c !== h || tt === 1 ? L ?? Ve : Ve, dt = it.indexOf(b);
          let yt = b;
          if (Rt)
            ...
            const se = it[dt] + yn, Et = it.find((Oe) => Oe >= se);
            Et !== void 0 && (yt = Et);
          } else if (_ === "ArrowUp") {
            const se = it[dt] - yn, Et = it.slice().reverse().find((Oe) => Oe <= se);
            Et !== void 0 && (yt = Et);
          }
          if (yt !== b) {
        ...
        if (D === 0 && _ === "ArrowUp" && !xt) {
          f.preventDefault(), U.current.focus();
          return;
        }
        return;
      }
  ...
  return ct(() => {
    tt === 1 ? m(1) : c === h ? c === t.book ? m(t.chapterNum) : m(1) : m(0);
  }, [h, t.book, t.chapterNum, c, tt]), ct(() => {
    if (!L || tt > 1) return;
    L.indexOf(b) === -1 && m(L[0]);
  }, [h, b, c, L, tt]), ct(() => {
    et();
    ...
    const f = setTimeout(() => {
      ...
      if (S && k.current && v.current) {
        const F = v.current.offsetTop - $a;
        k.current.scrollTo({ top: F, behavior: "instant" }), U.current.focus();
      }
  ...
  }, [S, et]), /* @__PURE__ */ l(he, { modal: !1, open: C, onOpenChange: gt, children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          g(t.book), x(t.book), m(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
          K.current = !0, B(!1), mt(R(s));
        },
        onBlur: () => {
          tt === 0 && et();
        },
      ...
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((f, D) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(ge, { className: "tw-font-semibold tw-text-foreground/80", children: Xa[f.bookType] }),
            f.books.map((_, Y) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              ja,
              {
                bookId: _,
                handleSelectBook: () => ot(_, !1),
                shouldExpandChildren: c.toLowerCase() === _.toLowerCase() || tt === 1,
                ...
                children: /* @__PURE__ */ r(
                  Fa,
                  {
                    ...
                    highlightedChapter: c === h || tt === 1 ? b : 0,
...
), W = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(On.Root, { ref: n, className: d("pr-twp", Ha(), t), ...e }));
W.displayName = On.Root.displayName;
...
const be = Qt.Root, ve = Qt.Trigger, re = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = Z();
...
const Ya = ft.Portal, qn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
function Le({
  ...
  const [N, S] = O(!1);
  return /* @__PURE__ */ l(be, { open: N, onOpenChange: S, ...C, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l(xe, { children: [
          /* @__PURE__ */ r(ye, { placeholder: g, className: "tw-text-inherit" }),
...
function Qs({
  ...
  const g = Be(c, "%webView_bookSelector_currentBook%"), b = Be(c, "%webView_bookSelector_choose%"), m = Be(c, "%webView_bookSelector_chooseBooks%"), [h, x] = O(
    "current book"
    /* CURRENT_BOOK */
  ), C = (N) => {
    x(N), t(N);
...
const Ft = H.Root, to = H.Group, Xt = H.Value, eo = St(
  ...
  return /* @__PURE__ */ l(
    H.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(H.Icon, { asChild: !0, children: /* @__PURE__ */ r(ue, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
At.displayName = H.Content.displayName;
...
const _e = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
function io({
  ...
  var N;
  const [w, p] = O([]), [c, g] = O([]), [b, m] = O({}), [h, x] = O({}), C = Mn({
    data: e,
    columns: t,
    getCoreRowModel: Bn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Qa, { table: C }),
    /* @__PURE__ */ l(_e, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Se, { stickyHeader: s, children: C.getHeaderGroups().map((S) => /* @__PURE__ */ r(Ct, { children: S.headers.map((y) => /* @__PURE__ */ r(te, { children: y.isPlaceholder ? void 0 : Jt(y.column.columnDef.header, y.getContext()) }, y.id)) }, S.id)) }),
      /* @__PURE__ */ r(Te, { children: (N = C.getRowModel().rows) != null && N.length ? C.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(S, C),
...
function ri({ id: t, label: e, groups: n }) {
  const [a, o] = O(
    ...
    i((m) => (m[c] = g, { ...m }));
    const b = n[c].items.find((m) => m.id === g);
    b ? b.onUpdate(g) : console.error(`Could not find dropdown radio item with id '${g}'!`);
  };
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(he, { children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((c, g) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(ge, { children: c.label }),
      /* @__PURE__ */ r(Pn, { children: c.itemType === 0 ? /* @__PURE__ */ r(ce, { children: c.items.map((b, m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        en,
        {
          checked: a[g][m],
          onCheckedChange: () => w(g, m),
          children: b.label
        }
      ) }, b.id)) }) : /* @__PURE__ */ r(
        _a,
        {
          value: s[g],
          onValueChange: (b) => p(g, b),
          children: c.items.map((b) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Xn, { value: b.id, children: b.label }) }, b.id))
        }
      ) }),
      /* @__PURE__ */ r(jt, {})
    ] }, c.label)) })
...
function co({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const p = new Date(w), c = new Date(o.getTime() - p.getTime()), g = c.getUTCFullYear() - 1970, b = c.getUTCMonth(), m = c.getUTCDate() - 1;
    let h = "";
    return g > 0 ? h = `${g.toString()} year${g === 1 ? "" : "s"} ago` : b > 0 ? h = `${b.toString()} month${b === 1 ? "" : "s"} ago` : m === 0 ? h = "today" : h = `${m.toString()} day${m === 1 ? "" : "s"} ago`, h;
  }
...
function uo({
  ...
  const [b, m] = O(!1), h = $(
    (N) => {
      var y;
      const S = (y = t.find((z) => z.label === N)) == null ? void 0 : y.value;
      S && a(
        n.includes(S) ? n.filter((z) => z !== S) : [...n, S]
      );
    },
    [t, n, a]
  ), x = () => i || o, C = J(() => {
    if (!p) return t;
    const N = t.filter((y) => y.starred).sort((y, z) => y.label.localeCompare(z.label)), S = t.filter((y) => !y.starred).sort((y, z) => {
      const B = n.includes(y.value), A = n.includes(z.value);
      return B && !A ? -1 : !B && A ? 1 : y.label.localeCompare(z.label);
    });
    return [...N, ...S];
  }, [t, n, p]);
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(be, { open: b, onOpenChange: m, children: [
    /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ l(
      j,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(xe, { children: [
...
ln.displayName = Xe.Root.displayName;
const Qn = St(
...
ho.displayName = An.Root.displayName;
...
er.displayName = me.Root.displayName;
...
ie.displayName = me.Item.displayName;
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ii = (t) => ({
  accessorKey: "item",
...
function mi({
  ...
  const c = bt(n, "%webView_inventory_all%"), g = bt(n, "%webView_inventory_approved%"), b = bt(n, "%webView_inventory_unapproved%"), m = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), x = bt(n, "%webView_inventory_scope_chapter%"), C = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), S = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, z] = O(!1), [B, A] = O("all"), [mt, U] = O(""), [k, v] = O([]), P = J(() => t.length === 0 ? [] : vo(t, o, s), [t, o, s]), R = J(() => {
    if (y) return P;
    const T = [];
    return P.forEach((K) => {
...
const cn = ee.Provider, pn = ee.Root, un = ee.Trigger, Ee = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ee.Content,
  {
    ref: a,
    sideOffset: e,
...
const xo = "16rem", yo = "3rem", nr = u.createContext(void 0);
function De() {
...
const rr = u.forwardRef(
  ({
    ...
    const [c, g] = u.useState(t), b = e ?? c, m = u.useCallback(
      (z) => {
        const B = typeof z == "function" ? z(b) : z;
        n ? n(B) : g(B);
      },
      [n, b]
    ), h = u.useCallback(() => m((z) => !z), [m]), x = b ? "expanded" : "collapsed", S = Z() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = u.useMemo(
      () => ({
        state: x,
        open: b,
        setOpen: m,
...
const Eo = St(
  ...
  ({
    ...
    const p = t ? $t : "button", { state: c } = De(), g = /* @__PURE__ */ r(
      p,
      {
        ref: w,
...
const Do = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? $t : "button",
  {
    ref: o,
...
Do.displayName = "SidebarMenuAction";
    ...
    ar,
    {
      ...
      children: /* @__PURE__ */ l(sr, { children: [
        /* @__PURE__ */ l(He, { children: [
          ...
          /* @__PURE__ */ r(Ue, { children: /* @__PURE__ */ r(ir, { children: Object.entries(e).map(([m, h]) => /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(
            lr,
            {
              onClick: () => c(m),
              isActive: b(m),
...
const Nt = "scrBook", Io = "scrRef", Ot = "source", Po = "details", jo = "Scripture Reference", Fo = "Scripture Book", dr = "Type", Xo = "Details";
function Go(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Nt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? jo,
      cell: (a) => {
...
const $o = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Fe(t.start, t.end) === 0 ? `${ze(t.start)}+${e}` : `${ze(t.start)}+${e}-${ze(t.end)}+${n}`;
}, Tn = (t) => `${$o({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function fi({
  sources: t,
  ...
  const [p, c] = O([]), [g, b] = O([{ id: Nt, desc: !1 }]), [m, h] = O({}), x = J(
  ...
  ct(() => {
    if (w) {
      const k = N.getSelectedRowModel().rowsById, v = Object.keys(k);
      if (v.length === 1) {
        const P = x.find((R) => Tn(R) === v[0]) || void 0;
        P && w(P);
      }
    }
  }, [m, x, w, N]);
  const S = o ?? Fo, y = s ?? dr, z = [
  ...
  }, mt = (k, v) => k.getIsGrouped() ? "" : d("banded-row", v % 2 === 0 ? "even" : "odd"), U = (k, v, P) => {
    if (!((k == null ? void 0 : k.length) === 0 || v.depth < P.column.getGroupedIndex())) {
      if (v.getIsGrouped())
        switch (v.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(At, { position: "item-aligned", children: /* @__PURE__ */ r(to, { children: z.map((k) => /* @__PURE__ */ r(wt, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(_e, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Se, { children: N.getHeaderGroups().map((k) => /* @__PURE__ */ r(Ct, { children: k.headers.filter((v) => v.column.columnDef.header).map((v) => (
      ...
      /* @__PURE__ */ r(Te, { children: N.getRowModel().rows.map((k, v) => {
        const P = Z();
        return /* @__PURE__ */ r(
          Ct,
          {
                  ...
                  Gt,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(ue, {}),
                          !k.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(Ke, {}) : /* @__PURE__ */ r(na, {})),
                          " ",
...
function Uo({
  ...
  const s = hn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], p = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    j,
    {
      variant: "outline",
...
function Ko({
  ...
  const B = J(() => M.allBookIds.filter(
    ...
    (v, P = !1) => {
      ...
      const R = B.findIndex((Q) => Q === y.current), L = B.findIndex((Q) => Q === v);
      if (R === -1 || L === -1) return;
      const [lt, xt] = [
        Math.min(R, L),
        Math.max(R, L)
      ], Tt = B.slice(lt, xt + 1).map((Q) => Q);
      n(
    ...
    (v) => {
      const P = hn(B, v).map((R) => R);
      n(
        cr(B, v, e) ? e.filter((R) => !P.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...P])]
      );
    },
    [e, n, B]
  ), U = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(be, { open: N, onOpenChange: S, children: [
      /* @__PURE__ */ r(ve, { asChild: !0, children: /* @__PURE__ */ l(
        j,
        {
          variant: "outline",
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var P;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((P = o.get(v)) == null ? void 0 : P.localizedName) || M.bookIdToEnglishName(v) || v }, v);
      }),
...
function bi({
  ...
  const p = Dt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), b = Dt(i, "%webView_scope_selector_current_book%"), m = Dt(i, "%webView_scope_selector_choose_books%"), h = Dt(i, "%webView_scope_selector_scope%"), x = Dt(i, "%webView_scope_selector_select_books%"), C = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: N.map(({ value: S, label: y, id: z }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: S, id: z }),
            /* @__PURE__ */ r(W, { htmlFor: z, children: y })
          ] }, z))
        }
      )
    ] }),
...
function En({
  ...
  return /* @__PURE__ */ l(he, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w], p, c) => /* @__PURE__ */ l(Dn, { children: [
      /* @__PURE__ */ r(Pn, { children: /* @__PURE__ */ r(cn, { children: ur(e.groups, e.items, w, t) }) }),
      p < c.length - 1 && /* @__PURE__ */ r(jt, {})
    ] }, w)) })
  ] });
}
function ki({
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, g) => c.order - g.order).map((c) => /* @__PURE__ */ l(pn, { children: [
...
function es({
  ...
  const o = q(void 0), s = q(void 0), i = q(void 0), w = q(void 0), p = q(void 0), c = (g) => {
    switch (g) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    var x, C, N, S;
    g.preventDefault();
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (x = s.current) == null || x.focus(), Kt(s, [m, h]);
        break;
      case "alt+l":
        (C = i.current) == null || C.focus(), Kt(i, [m, h]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), Kt(w, [m, h]);
        break;
      case "alt+h":
        (S = p.current) == null || S.focus(), Kt(p, [m, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ l(Jo, { children: [
      /* @__PURE__ */ r(br, { ref: c(g), children: typeof b == "object" && "label" in b && b.label }),
      /* @__PURE__ */ r(
        yr,
        {
          className: "tw-z-[250]",
...
function Ti({
  ...
  const p = ns(
    ...
    var N, S, y, z, B, A;
    const C = x !== h ? ((S = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : S[x]) ?? ((z = (y = t[h]) == null ? void 0 : y.uiNames) == null ? void 0 : z.en) : void 0;
    return C ? `${(B = t[h]) == null ? void 0 : B.autonym} (${C})` : (A = t[h]) == null ? void 0 : A.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ l(ce, { children: [
      /* @__PURE__ */ r(W, { className: "tw-ms-3", children: p }),
...
const as = pe(({ className: t, ...e }, n) => /* @__PURE__ */ r(sa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
const Di = pt.Trigger, vs = pt.Portal, Vi = pt.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
_s.displayName = Ge.Root.displayName;
function Oi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
Ts.displayName = $e.Root.displayName;
...
const Ms = (t, e, n = {}) => {
  ...
  const o = q(null), [s, i] = O(void 0), [w, p] = O(void 0), c = $(
    (m) => {
      i(m);
