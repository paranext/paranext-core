import ws, { jsxs as re, jsx as y, Fragment as Xn } from "react/jsx-runtime";
import * as E from "react";
import he, { forwardRef as Ri, useCallback as Pe, useState as Ee, useRef as vt, useEffect as zt, useLayoutEffect as Co, useMemo as bn } from "react";
import { getChaptersForBook as $i, offsetBook as So, FIRST_SCR_BOOK_NUM as xs, offsetChapter as Po, FIRST_SCR_CHAPTER_NUM as Es, offsetVerse as Ro, FIRST_SCR_VERSE_NUM as ks } from "platform-bible-utils";
import * as fe from "@radix-ui/react-dropdown-menu";
import { ChevronRight as Ts, Check as Mi, Circle as Os, History as Ns, ArrowDownWideNarrow as Cs, Clock as Ss, Bookmark as Ps, X as Rs, Search as $s, ChevronsUpDown as Ms } from "lucide-react";
import ke, { clsx as Is } from "clsx";
import { twMerge as _s } from "tailwind-merge";
import { Slot as As } from "@radix-ui/react-slot";
import { cva as Ii } from "class-variance-authority";
import { FormControlLabel as $o, FormLabel as Ds, Checkbox as js, MenuItem as Bs, ListItemText as Ls, ListItemIcon as _i, Menu as Fs, Grid as Ai, List as Vs, IconButton as Di, Drawer as zs, Slider as Us, Snackbar as Hs, Switch as Ws, AppBar as qs, Toolbar as Xs } from "@mui/material";
import * as un from "@radix-ui/react-popover";
import { Command as Me } from "cmdk";
import * as Xe from "@radix-ui/react-dialog";
import Gs, { ThemeContext as Ys, internal_processStyles as Ks } from "@mui/styled-engine";
import * as Js from "react-dom";
import Sn from "react-dom";
import * as ji from "@radix-ui/react-label";
import Zs, { SelectColumn as Qs } from "react-data-grid";
import * as Ie from "@radix-ui/react-tabs";
var el = Object.defineProperty, tl = (e, t, n) => t in e ? el(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, ne = (e, t, n) => (tl(e, typeof t != "symbol" ? t + "" : t, n), n);
const wt = [
  "GEN",
  "EXO",
  "LEV",
...
function* il() {
  for (let e = 1; e <= wt.length; e++)
    yield e;
}
const al = 1, Fi = wt.length;
function sl() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function Vr(e, t = "***") {
  const n = e - 1;
  return n < 0 || n >= wt.length ? t : wt[n];
}
function Vi(e) {
...
*/
ne(Se, "ValidStatusType", Ui);
class Kt extends Error {
}
function ee(...e) {
  return _s(Is(e));
}
const dl = fe.Root, fl = fe.Trigger, ch = fe.Group, ph = fe.Portal, uh = fe.Sub, dh = fe.RadioGroup, ml = he.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ re(
  fe.SubTrigger,
  {
    ref: o,
    className: ee(
    ...
    children: [
      n,
      /* @__PURE__ */ y(Ts, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
ml.displayName = fe.SubTrigger.displayName;
const hl = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  fe.SubContent,
  {
    ref: n,
    className: ee(
...
hl.displayName = fe.SubContent.displayName;
const Hi = he.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ y(fe.Portal, { children: /* @__PURE__ */ y(
  fe.Content,
  {
    ref: r,
    sideOffset: t,
...
Hi.displayName = fe.Content.displayName;
const Wi = he.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ y(
  fe.Item,
  {
    ref: r,
    className: ee(
...
Wi.displayName = fe.Item.displayName;
const gl = he.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ re(
  fe.CheckboxItem,
  {
    ref: o,
    className: ee(
    ...
    ...r,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(fe.ItemIndicator, { children: /* @__PURE__ */ y(Mi, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
gl.displayName = fe.CheckboxItem.displayName;
const bl = he.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ re(
  fe.RadioItem,
  {
    ref: r,
    className: ee(
    ...
    ...n,
    children: [
      /* @__PURE__ */ y("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ y(fe.ItemIndicator, { children: /* @__PURE__ */ y(Os, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
bl.displayName = fe.RadioItem.displayName;
...
const qi = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  fe.Separator,
  {
    ref: n,
...
qi.displayName = fe.Separator.displayName;
...
vl.displayName = "DropdownMenuShortcut";
...
function El({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
...
const an = ue.allBookIds, kl = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, _o = ["OT", "NT", "DC"], Tl = 32 + 32 + 32, Ol = [
  /^(\w+)$/i,
...
function fh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, i] = Ee(
    ue.bookNumberToId(e.bookNum)
  ), [s, l] = Ee(e.chapterNum ?? 0), [c, p] = Ee(
    ue.bookNumberToId(e.bookNum)
  ), [u, f] = Ee(!1), [d, b] = Ee(u), v = vt(void 0), g = vt(void 0), m = vt(void 0), k = Pe(
    (C) => Nl(C).filter((R) => {
    ...
    Ol.forEach((C) => {
      const R = n.match(C);
      if (R) {
        const [$, j = void 0, D = void 0] = R.slice(1), M = Pl($);
  ...
  }, [c, e.bookNum, e.chapterNum, o]), Co(() => {
    b(u);
  }, [u]), Co(() => {
    const C = setTimeout(() => {
      if (d && g.current && m.current) {
        const $ = m.current.offsetTop - Tl;
  ...
  }, [d]), /* @__PURE__ */ y("div", { className: "pr-flex", children: /* @__PURE__ */ re(dl, { modal: !1, open: u, onOpenChange: x, children: [
    /* @__PURE__ */ y(fl, { asChild: !0, children: /* @__PURE__ */ y(
      yl,
      {
        ref: v,
        value: n,
        ...
        children: [
          ...
          _o.map(
            (C, R) => k(C).length > 0 && /* @__PURE__ */ re("div", { children: [
              /* @__PURE__ */ y(zr, { className: "pr-font-semibold pr-text-slate-700", children: kl[C] }),
              ...
              _o.length - 1 !== R ? /* @__PURE__ */ y(qi, {}) : void 0
            ] }, C)
          )
        ]
      }
...
const Rl = Ii(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ y(r ? As : "button", { className: ee(Rl({ variant: t, size: n, className: e })), ref: i, ...o })
);
lt.displayName = "Button";
const $l = un.Root, Ml = un.Trigger, Xi = E.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ y(un.Portal, { children: /* @__PURE__ */ y(
  un.Content,
  {
    ref: o,
    align: t,
...
Xi.displayName = un.Content.displayName;
const Il = Xe.Portal, Gi = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Xe.Overlay,
  {
    ref: n,
    className: ee(
...
const _l = E.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ re(Il, { children: [
  /* @__PURE__ */ y(Gi, {}),
  /* @__PURE__ */ re(
    Xe.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ re(Xe.Close, { className: "pr-absolute pr-right-4 pr-top-4 pr-rounded-sm pr-opacity-70 pr-ring-offset-background pr-transition-opacity hover:pr-opacity-100 focus:pr-outline-none focus:pr-ring-2 focus:pr-ring-ring focus:pr-ring-offset-2 disabled:pr-pointer-events-none data-[state=open]:pr-bg-accent data-[state=open]:pr-text-muted-foreground", children: [
          /* @__PURE__ */ y(Rs, { className: "pr-h-4 pr-w-4" }),
...
_l.displayName = Xe.Content.displayName;
const Al = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Xe.Title,
  {
    ref: n,
...
Al.displayName = Xe.Title.displayName;
...
Dl.displayName = Xe.Description.displayName;
const Yi = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Me,
  {
    ref: n,
    className: ee(
...
Yi.displayName = Me.displayName;
const Ki = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ re("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", "cmdk-input-wrapper": "", children: [
  /* @__PURE__ */ y($s, { className: "pr-mr-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ y(
    Me.Input,
    {
      ref: n,
...
Ki.displayName = Me.Input.displayName;
const Ji = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Me.List,
  {
    ref: n,
...
Ji.displayName = Me.List.displayName;
const Zi = E.forwardRef((e, t) => /* @__PURE__ */ y(Me.Empty, { ref: t, className: "pr-py-6 pr-text-center pr-text-sm", ...e }));
Zi.displayName = Me.Empty.displayName;
...
jl.displayName = Me.Group.displayName;
...
Bl.displayName = Me.Separator.displayName;
const Qi = E.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Me.Item,
  {
    ref: n,
    className: ee(
...
Qi.displayName = Me.Item.displayName;
function Ll(e) {
...
function Nr({
  ...
  const [u, f] = Ee(!1);
  return /* @__PURE__ */ re($l, { open: u, onOpenChange: f, children: [
    /* @__PURE__ */ y(Ml, { asChild: !0, children: /* @__PURE__ */ re(
      lt,
      {
        variant: p,
        role: "combobox",
        ...
        children: [
          r ? i(r) : s,
          /* @__PURE__ */ y(Ms, { className: "pr-ml-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ y(Xi, { className: "pr-w-[200px] pr-p-0", children: /* @__PURE__ */ re(Yi, { children: [
      /* @__PURE__ */ y(Ki, { placeholder: l, className: "pr-text-inherit" }),
      /* @__PURE__ */ y(Zi, { children: c }),
      /* @__PURE__ */ y(Ji, { children: t.map((d) => /* @__PURE__ */ re(
        Qi,
        {
          value: i(d),
          onSelect: () => {
...
function Ul() {
  return Do || (Do = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    le.AsyncMode = h, le.ConcurrentMode = N, le.ContextConsumer = S, le.ContextProvider = L, le.Element = B, le.ForwardRef = F, le.Fragment = C, le.Lazy = R, le.Memo = $, le.Portal = j, le.Profiler = D, le.StrictMode = M, le.Suspense = V, le.isAsyncMode = Z, le.isConcurrentMode = O, le.isContextConsumer = A, le.isContextProvider = U, le.isElement = G, le.isForwardRef = z, le.isFragment = H, le.isLazy = q, le.isMemo = X, le.isPortal = W, le.isProfiler = Y, le.isStrictMode = K, le.isSuspense = oe, le.isValidElementType = w, le.typeOf = x;
  }()), le;
}
var jo;
function ta() {
  return jo || (jo = 1, process.env.NODE_ENV === "production" ? Pn.exports = zl() : Pn.exports = Ul()), Pn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var fr, Fo;
function na() {
  return Fo || (Fo = 1, fr = Function.call.bind(Object.prototype.hasOwnProperty)), fr;
}
var mr, Vo;
function Wl() {
  if (Vo)
...
function ql() {
  if (zo)
    return hr;
  zo = 1;
  var e = ta(), t = Hl(), n = Hr(), r = na(), o = Wl(), i = function() {
  };
    ...
    function S(O) {
      ...
      function A(U, G, z, H, q) {
        for (var X = U[G], W = 0; W < O.length; W++)
          if (v(X, O[W]))
            return null;
        var Y = JSON.stringify(O, function(oe, _) {
          var J = V(_);
...
if (process.env.NODE_ENV !== "production") {
  var Gl = ta(), Yl = !0;
  Cr.exports = ql()(Gl.isElement, Yl);
} else
  Cr.exports = Xl()();
var Kl = Cr.exports;
const a = /* @__PURE__ */ Fl(Kl);
function Ht(e, t) {
...
function et(e, t, n = {
  ...
  return bt(e) && bt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (bt(t[o]) && o in e && bt(e[o]) ? r[o] = et(e[o], t[o], n) : n.clone ? r[o] = bt(t[o]) ? ra(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function Jl(e) {
  const {
...
function oa(e, t, n, r, o) {
  ...
  let l;
  const c = i.type;
  return typeof c == "function" && !Jl(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ia = Ht(a.element, oa);
ia.isRequired = Ht(a.element.isRequired, oa);
const vn = ia;
function Zl(e) {
  const {
    prototype: t = {}
...
function Ql(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof i == "function" && !Zl(i) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ec = Ht(a.elementType, Ql), tc = "exact-prop: ​";
function aa(e) {
...
function rc() {
  return Wo || (Wo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    pe.ContextConsumer = N, pe.ContextProvider = S, pe.Element = L, pe.ForwardRef = B, pe.Fragment = F, pe.Lazy = C, pe.Memo = R, pe.Portal = $, pe.Profiler = j, pe.StrictMode = D, pe.Suspense = M, pe.SuspenseList = V, pe.isAsyncMode = O, pe.isConcurrentMode = A, pe.isContextConsumer = U, pe.isContextProvider = G, pe.isElement = z, pe.isForwardRef = H, pe.isFragment = q, pe.isLazy = X, pe.isMemo = W, pe.isPortal = Y, pe.isProfiler = K, pe.isStrictMode = oe, pe.isSuspense = _, pe.isSuspenseList = J, pe.isValidElementType = x, pe.typeOf = h;
  }()), pe;
}
process.env.NODE_ENV === "production" ? Sr.exports = nc() : Sr.exports = rc();
var Bn = Sr.exports;
const oc = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function ic(e) {
  const t = `${e}`.match(oc);
  return t && t[1] || "";
}
function sa(e, t = "") {
  return e.displayName || e.name || ic(e) || t;
}
function qo(e, t, n) {
  const r = sa(t);
...
const sc = a.oneOfType([a.func, a.object]), Wr = sc;
function Ge(e) {
  if (typeof e != "string")
...
const uc = typeof window < "u" ? E.useLayoutEffect : E.useEffect, xt = uc;
let Xo = 0;
function dc(e) {
...
function yc(e) {
  ...
  return !!(n === "INPUT" && vc[t] && !e.readOnly || n === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function wc(e) {
...
function xc() {
  this.visibilityState === "hidden" && Rr && (Gn = !0);
}
function Ec(e) {
  e.addEventListener("keydown", wc, !0), e.addEventListener("mousedown", br, !0), e.addEventListener("pointerdown", br, !0), e.addEventListener("touchstart", br, !0), e.addEventListener("visibilitychange", xc, !0);
}
function kc(e) {
  const {
    target: t
...
function ua() {
  ...
  function n() {
    return t.current ? (Rr = !0, bc.start(100, () => {
      Rr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
    return kc(o) ? (t.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: t,
    onFocus: r,
...
function ma(e, t, ...n) {
  return e[t] === void 0 ? null : fa(e, t, ...n);
}
function $r() {
  return null;
}
ma.isRequired = fa;
$r.isRequired = $r;
const ha = process.env.NODE_ENV === "production" ? $r : ma;
function ga(e, t) {
  const n = T({}, t);
...
function rn(e, t, n) {
  return e === void 0 || ya(e) ? t : T({}, t, {
    ownerState: T({}, t.ownerState, n)
  });
}
const Rc = {
  disableDefaultClasses: !1
}, $c = /* @__PURE__ */ E.createContext(Rc);
function Mc(e) {
  const {
...
function _c(e) {
  ...
  const s = wa(T({}, o, r)), l = Jo(r), c = Jo(o), p = t(s), u = ke(p == null ? void 0 : p.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = T({}, p == null ? void 0 : p.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = T({}, p, n, c, l);
...
const Lc = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function Fc(e) {
...
function Uc(e) {
  const t = [], n = [];
  return Array.from(e.querySelectorAll(Lc)).forEach((r, o) => {
    const i = Fc(r);
    i === -1 || !zc(r) || (i === 0 ? t.push(r) : n.push({
      documentOrder: o,
      tabIndex: i,
      node: r
    }));
...
process.env.NODE_ENV !== "production" && (Fn["propTypes"] = aa(Fn.propTypes));
function Wc(e) {
...
function ep(e) {
  const {
    ...
    open: u,
    rootRef: f
  } = e, d = E.useRef({}), b = E.useRef(null), v = E.useRef(null), g = ze(v, f), [m, k] = E.useState(!u), I = Zc(c);
  let w = !0;
...
var Re = "top", Ue = "bottom", He = "right", $e = "left", qr = "auto", wn = [Re, Ue, He, $e], Bt = "start", mn = "end", tp = "clippingParents", ka = "viewport", Zt = "popper", np = "reference", ei = /* @__PURE__ */ wn.reduce(function(e, t) {
  return e.concat([t + "-" + Bt, t + "-" + mn]);
}, []), Ta = /* @__PURE__ */ [].concat(wn, [qr]).reduce(function(e, t) {
  return e.concat([t, t + "-" + Bt, t + "-" + mn]);
}, []), rp = "beforeRead", op = "read", ip = "afterRead", ap = "beforeMain", sp = "main", lp = "afterMain", cp = "beforeWrite", pp = "write", up = "afterWrite", dp = [rp, op, ip, ap, sp, lp, cp, pp, up];
function Ye(e) {
...
function fp(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !Ve(i) || !Ye(i) || (Object.assign(i.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function mp(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !Ve(o) || !Ye(o) || (Object.assign(o.style, l), Object.keys(i).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
var yt = Math.max, Vn = Math.min, Lt = Math.round;
function Mr() {
...
function Ft(e, t, n) {
  ...
  var s = kt(e) ? Be(e) : window, l = s.visualViewport, c = !Oa() && n, p = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / i, f = r.width / o, d = r.height / i;
  return {
    width: f,
    height: d,
    top: u,
...
function bp(e) {
  ...
  var o = Yn(e);
  for (Xr(o) && (o = o.host); Ve(o) && ["html", "body"].indexOf(Ye(o)) < 0; ) {
    var i = nt(o);
...
function xn(e) {
  for (var t = Be(e), n = ti(e); n && gp(n) && nt(n).position === "static"; )
    n = ti(n);
  return n && (Ye(n) === "html" || Ye(n) === "body" && nt(n).position === "static") ? t : n || bp(e) || t;
}
function Yr(e) {
...
var yp = function(t, n) {
  ...
  })) : t, Sa(typeof t != "number" ? t : Pa(t, wn));
};
function wp(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, l = qe(n.placement), c = Yr(l), p = [$e, He].indexOf(l) >= 0, u = p ? "height" : "width";
  if (!(!i || !s)) {
    var f = yp(o.padding, n), d = Gr(i), b = c === "y" ? Re : $e, v = c === "y" ? Ue : He, g = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], m = s[c] - n.rects.reference[c], k = xn(i), I = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, w = g / 2 - m / 2, x = f[b], h = I - d[u] - f[v], N = I / 2 - d[u] / 2 + w, S = ln(x, N, h), L = c;
...
function ni(e) {
  ...
  if (p) {
    ...
    if (N === Be(n) && (N = ut(n), nt(N).position !== "static" && l === "absolute" && (S = "scrollHeight", L = "scrollWidth")), N = N, o === Re || (o === $e || o === He) && i === mn) {
      x = Ue;
...
function Op(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, ni(Object.assign({}, p, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: s,
    roundOffsets: c
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, ni(Object.assign({}, p, {
...
function Jr(e) {
  return Ft(ut(e)).left + Kr(e).scrollLeft;
}
function $p(e, t) {
  var n = Be(e), r = ut(e), o = n.visualViewport, i = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function Mp(e) {
  var t, n = ut(e), r = Kr(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = yt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = yt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + Jr(e), c = -r.scrollTop;
  return nt(o || n).direction === "rtl" && (l += yt(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: s,
    x: l,
    y: c
...
function Ra(e) {
  return ["html", "body", "#document"].indexOf(Ye(e)) >= 0 ? e.ownerDocument.body : Ve(e) && Zr(e) ? e : Ra(Yn(e));
}
function cn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = Ra(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Be(r), s = o ? [i].concat(i.visualViewport || [], Zr(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function oi(e, t, n) {
  return t === ka ? Ir($p(e, n)) : kt(t) ? Ip(t, n) : Ir(Mp(ut(e)));
}
function _p(e) {
  var t = cn(Yn(e)), n = ["absolute", "fixed"].indexOf(nt(e).position) >= 0, r = n && Ve(e) ? xn(e) : e;
  return kt(r) ? t.filter(function(o) {
    return kt(o) && Na(o, r) && Ye(o) !== "body";
  }) : [];
}
function Ap(e, t, n, r) {
  var o = t === "clippingParents" ? _p(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], l = i.reduce(function(c, p) {
    var u = oi(e, p, r);
    return c.top = yt(u.top, c.top), c.right = Vn(u.right, c.right), c.bottom = Vn(u.bottom, c.bottom), c.left = yt(u.left, c.left), c;
  }, oi(e, s, r));
...
function hn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? tp : l, p = n.rootBoundary, u = p === void 0 ? ka : p, f = n.elementContext, d = f === void 0 ? Zt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, g = n.padding, m = g === void 0 ? 0 : g, k = Sa(typeof m != "number" ? m : Pa(m, wn)), I = d === Zt ? np : Zt, w = e.rects.popper, x = e.elements[v ? I : d], h = Ap(kt(x) ? x : x.contextElement || ut(e.elements.popper), c, u, s), N = Ft(e.elements.reference), S = $a({
    reference: N,
    element: w,
    strategy: "absolute",
    placement: o
...
function Dp(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, p = c === void 0 ? Ta : c, u = Vt(r), f = u ? l ? ei : ei.filter(function(v) {
    return Vt(v) === u;
...
function Bp(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, p = n.padding, u = n.boundary, f = n.rootBoundary, d = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, m = t.options.placement, k = qe(m), I = k === m, w = c || (I || !v ? [_n(m)] : jp(m)), x = [m].concat(w).reduce(function(z, H) {
      return z.concat(qe(H) === qr ? Dp(t, {
        placement: H,
        boundary: u,
        rootBoundary: f,
        padding: p,
...
function Fp(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, s = hn(t, {
    ...
    altBoundary: !0
  }), c = ii(s, r), p = ii(l, o, i), u = ai(c), f = ai(p);
  t.modifiersData[n] = {
...
function Up(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, i = o === void 0 ? [0, 0] : o, s = Ta.reduce(function(u, f) {
    return u[f] = zp(f, t.rects, i), u;
...
function Gp(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, p = n.rootBoundary, u = n.altBoundary, f = n.padding, d = n.tether, b = d === void 0 ? !0 : d, v = n.tetherOffset, g = v === void 0 ? 0 : v, m = hn(t, {
    ...
    padding: f,
    altBoundary: u
  }), k = qe(t.placement), I = Vt(t.placement), w = !I, x = Yr(k), h = Xp(x), N = t.modifiersData.popperOffsets, S = t.rects.reference, L = t.rects.popper, B = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, F = typeof B == "number" ? {
    mainAxis: B,
    altAxis: B
  ...
  if (N) {
    if (i) {
      var $, j = x === "y" ? Re : $e, D = x === "y" ? Ue : He, M = x === "y" ? "height" : "width", V = N[x], Q = V + m[j], Z = V - m[D], O = b ? -L[M] / 2 : 0, A = I === Bt ? S[M] : L[M], U = I === Bt ? -L[M] : -S[M], G = t.elements.arrow, z = b && G ? Gr(G) : {
        width: 0,
        height: 0
      }, H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Ca(), q = H[j], X = H[D], W = ln(0, S[M], z[M]), Y = w ? S[M] / 2 - O - W - q - F.mainAxis : A - W - q - F.mainAxis, K = w ? -S[M] / 2 + O + W + X + F.mainAxis : U + W + X + F.mainAxis, oe = t.elements.arrow && xn(t.elements.arrow), _ = oe ? x === "y" ? oe.clientTop || 0 : oe.clientLeft || 0 : 0, J = ($ = C == null ? void 0 : C[x]) != null ? $ : 0, P = V + Y - J - _, ie = V + K - J, we = ln(b ? Vn(Q, P) : Q, V, b ? yt(Z, ie) : Z);
      N[x] = we, R[x] = we - V;
    }
    if (l) {
      var Ne, ve = x === "x" ? Re : $e, ft = x === "x" ? Ue : He, Ce = N[h], Je = h === "y" ? "height" : "width", _e = Ce + m[ve], Ze = Ce - m[ft], xe = [Re, $e].indexOf(k) !== -1, Ot = (Ne = C == null ? void 0 : C[h]) != null ? Ne : 0, mt = xe ? _e : Ce - S[Je] - L[Je] - Ot + F.altAxis, Wt = xe ? Ce + S[Je] + L[Je] - Ot - F.altAxis : Ze, On = b && xe ? vp(mt, Ce, Wt) : ln(b ? mt : _e, Ce, b ? Wt : Ze);
      N[h] = On, R[h] = On - Ce;
    }
    t.modifiersData[r] = R;
  }
...
function Qp(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ve(t), o = Ve(t) && Zp(t), i = ut(t), s = Ft(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Zr(i)) && (l = Jp(t)), Ve(t) ? (c = Ft(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Jr(i))), {
    ...
    var u = {
      ...
      setOptions: function(k) {
        ...
        g(), u.options = Object.assign({}, i, u.options, I), u.scrollParents = {
          reference: kt(l) ? cn(l) : l.contextElement ? cn(l.contextElement) : [],
          popper: cn(c)
        };
        var w = tu(ru([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!d) {
          ...
          if (li(I, w)) {
            u.rects = {
              reference: Qp(I, xn(w), u.options.strategy === "fixed"),
              popper: Gr(w)
...
var iu = [Sp, qp, Np, hp, Hp, Lp, Yp, Ep, Vp], au = /* @__PURE__ */ ou({
  defaultModifiers: iu
});
const Ma = "Popper";
function su(e) {
...
const du = () => ot({
  root: ["root"]
}, Mc(su)), fu = {}, mu = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, m = de(t, lu), k = E.useRef(null), I = ze(k, n), w = E.useRef(null), x = ze(w, d), h = E.useRef(x);
  xt(() => {
    h.current = x;
  }, [x]), E.useImperativeHandle(d, () => w.current, []);
  const N = pu(u, s), [S, L] = E.useState(N), [B, F] = E.useState(zn(o));
  E.useEffect(() => {
...
`));
  ...
  const R = du(), $ = (r = v.root) != null ? r : "div", j = Et({
    elementType: $,
  ...
  const {
    ...
    slotProps: m = {},
    slots: k = {}
  } = t, I = de(t, cu), [w, x] = E.useState(!0), h = () => {
    x(!1);
  }, N = () => {
    x(!0);
  };
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || uu(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const hu = ["values", "unit", "step"], gu = (e) => {
...
function bu(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = de(e, hu), i = gu(t), s = Object.keys(i);
  function l(d) {
...
const vu = {
  borderRadius: 4
}, yu = vu, wu = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.string, a.object, a.array]) : {}, dt = wu;
function pn(e, t) {
  return t ? et(e, t, {
    clone: !1
...
function ye(e) {
  const {
    ...
    return rt(s, l, (f) => {
      let d = Un(p, o, f);
      return f === d && typeof f == "string" && (d = Un(p, o, `${t}${f === "default" ? "" : Ge(f)}`, f)), n === !1 ? d : {
        [n]: d
      };
    });
  };
...
const Tu = {
  ...
  if (e.length > 2)
    if (pi[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = Tu[t], o = Ou[n] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), Zn = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Qn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Cu = [...Zn, ...Qn];
function En(e, t, n, r) {
  var o;
...
function Pu(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = Nu(n), i = Su(o, r), s = e[n];
  return rt(e, s, i);
}
function Aa(e, t) {
  const n = _a(e.theme);
  return Object.keys(e).map((r) => Pu(e, t, r, n)).reduce(pn, {});
}
function ge(e) {
  return Aa(e, Zn);
}
ge.propTypes = process.env.NODE_ENV !== "production" ? Zn.reduce((e, t) => (e[t] = dt, e), {}) : {};
ge.filterProps = Zn;
function be(e) {
  return Aa(e, Qn);
}
be.propTypes = process.env.NODE_ENV !== "production" ? Qn.reduce((e, t) => (e[t] = dt, e), {}) : {};
be.filterProps = Qn;
process.env.NODE_ENV !== "production" && Cu.reduce((e, t) => (e[t] = dt, e), {});
function Ru(e = 8) {
  if (e.mui)
    return e;
  const t = _a({
...
const $u = We("border", Fe), Mu = We("borderTop", Fe), Iu = We("borderRight", Fe), _u = We("borderBottom", Fe), Au = We("borderLeft", Fe), Du = We("borderColor"), ju = We("borderTopColor"), Bu = We("borderRightColor"), Lu = We("borderBottomColor"), Fu = We("borderLeftColor"), Vu = We("outline", Fe), zu = We("outlineColor"), tr = (e) => {
...
er($u, Mu, Iu, _u, Au, Du, ju, Bu, Lu, Fu, tr, Vu, zu);
const nr = (e) => {
...
er(nr, rr, or, Uu, Hu, Wu, qu, Xu, Gu, Yu, Ku, Ju);
function At(e, t) {
  return t === "grey" ? t : e;
}
const Zu = ye({
...
function pd() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : rt(s, r, (v) => {
      let g = Un(d, u, v);
      return v === g && typeof v == "string" && (g = Un(d, u, `${n}${v === "default" ? "" : Ge(v)}`, v)), c === !1 ? g : {
        [c]: g
      };
    });
  }
  function t(n) {
    ...
    function l(c) {
      ...
      if (!p)
        return null;
      const u = xu(i.breakpoints), f = Object.keys(u);
      let d = u;
...
const dd = ["breakpoints", "palette", "spacing", "shape"];
function ro(e = {}, ...t) {
  const {
    breakpoints: n = {},
    palette: r = {},
  ...
  return p.applyStyles = ud, p = t.reduce((u, f) => et(u, f), p), p.unstable_sxConfig = T({}, to, s == null ? void 0 : s.unstable_sxConfig), p.unstable_sx = function(f) {
    return no({
      sx: f,
      theme: this
    });
...
const hd = ["ownerState"], gd = ["variants"], bd = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function vd(e) {
  return Object.keys(e).length === 0;
}
function yd(e) {
...
const wd = ro(), ui = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function $n({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Ed(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, l = {}) => {
    Ks(s, (h) => h.filter((N) => !(N != null && N.__mui_systemSx)));
    const {
      name: c,
      slot: p,
      ...
      overridesResolver: d = xd(ui(p))
    } = l, b = de(l, bd), v = u !== void 0 ? u : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      p && p !== "Root" && p !== "root" || !1
    ), g = f || !1;
    let m;
    process.env.NODE_ENV !== "production" && c && (m = `${c}-${ui(p || "Root")}`);
    let k = An;
    p === "Root" || p === "root" ? k = r : p ? k = o : yd(s) && (k = void 0);
    const I = Gs(s, T({
      shouldForwardProp: k,
      label: m
    }, b)), w = (h) => typeof h == "function" && h.__emotion_real !== h || bt(h) ? (N) => Dn(h, T({}, N, {
      theme: $n({
        theme: N.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${Ge(p || "")}`), C === void 0 && (C = `Styled(${ac(s)})`), F.displayName = C;
      }
...
function kd(e) {
  ...
  return !t || !t.components || !t.components[n] || !t.components[n].defaultProps ? r : ga(t.components[n].defaultProps, r);
}
function Td({
  props: e,
  name: t,
...
function di(e) {
  e = Tt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Tt(Nd(e)).values : e.values;
...
function Hn(e, t) {
  return e = Tt(e), t = oo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, ir(e);
}
function Cd(e, t) {
  if (e = Tt(e), t = oo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Rd = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Rt = Bd, Ld = ["mode", "contrastThreshold", "tonalOffset"], mi = {
...
function hi(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Sd(e.main, o) : t === "dark" && (e.dark = Cd(e.main, i)));
}
function Fd(e = "light") {
  return e === "dark" ? {
    main: St[200],
...
function qd(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = de(e, Ld), i = e.primary || Fd(t), s = e.secondary || Vd(t), l = e.error || zd(t), c = e.info || Ud(t), p = e.success || Hd(t), u = e.warning || Wd(t);
  function f(g) {
    const m = fi(g, yr.text.primary) >= n ? yr.text.primary : mi.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = fi(g, m);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return hi(g, "light", I, r), hi(g, "dark", w, r), g.contrastText || (g.contrastText = f(g.main)), g;
  }, b = {
    dark: yr,
    light: mi
  };
...
const Kd = 0.2, Jd = 0.14, Zd = 0.12;
function me(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Kd})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Jd})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Zd})`].join(",");
}
const Qd = ["none", me(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), me(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), me(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), me(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), me(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), me(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), me(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), me(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), me(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), me(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), me(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), me(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), me(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), me(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), me(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), me(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), me(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), me(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), me(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), me(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), me(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), me(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), me(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), me(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], ef = Qd, tf = ["duration", "easing", "delay"], nf = {
...
function af(e) {
  const t = T({}, nf, e.easing), n = T({}, rf, e.duration);
  return T({
...
`)), Object.keys(p).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(p).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof s == "string" ? s : vi(s)} ${l} ${typeof c == "string" ? c : vi(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
const uf = pf(), io = uf, ao = "$$material", La = (e) => An(e) && e !== "classes", df = Ed({
  themeId: ao,
  defaultTheme: io,
...
var mf = process.env.NODE_ENV !== "production" ? a.oneOfType([a.number, a.shape({
  enter: a.number,
  exit: a.number,
  appear: a.number
}).isRequired]) : null;
...
const Fa = he.createContext(null);
var hf = function(t) {
  return t.scrollTop;
}, on = "unmounted", ht = "exited", gt = "entering", _t = "entered", Ar = "exiting", at = /* @__PURE__ */ function(e) {
  ff(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? l ? (c = ht, i.appearStatus = gt) : c = _t : r.unmountOnExit || r.mountOnEnter ? c = on : c = ht, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== gt && s !== _t && (i = gt) : (s === gt || s === _t) && (i = Ar);
    }
    ...
    return (
      ...
      /* @__PURE__ */ he.createElement(Fa.Provider, {
        value: null
...
const bf = {
...
}, wr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), so = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, k = de(t, gf), I = nn(), w = E.useRef(), x = Tn(), h = E.useRef(null), N = ze(h, i.ref, n), S = (D) => (M) => {
    if (D) {
      const V = h.current;
      M === void 0 ? D(V) : D(V, M);
    }
...
}, wi = vf, yf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], wf = Oe(Ia, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (e, t) => t.root
})({}), Ua = /* @__PURE__ */ E.forwardRef(function(t, n) {
  var r;
  const o = ja(), i = it({
    props: t,
    name: "MuiPopper"
    ...
    slots: w,
    slotProps: x
  } = i, h = de(i, yf), N = (r = w == null ? void 0 : w.root) != null ? r : c == null ? void 0 : c.Root, S = T({
    anchorEl: s,
    container: u,
    disablePortal: f,
    keepMounted: d,
...
const Ef = pt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), ct = Ef, kf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Tf(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Of = (e) => {
...
const Wa = /* @__PURE__ */ E.forwardRef(function(t, n) {
  ...
  const N = it({
    ...
    TransitionProps: J
  } = N, P = de(N, kf), ie = /* @__PURE__ */ E.isValidElement(L) ? L : /* @__PURE__ */ y("span", {
    children: L
  }), we = Tn(), Ne = we.direction === "rtl", [ve, ft] = E.useState(), [Ce, Je] = E.useState(null), _e = E.useRef(!1), Ze = j || Z, xe = nn(), Ot = nn(), mt = nn(), Wt = nn(), [On, fo] = pa({
    controlled: H,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const mo = (te) => {
    ...
    (te) => {
      xi.start(800 + A, () => {
        Mn = !1;
      }), fo(!1), G && Qe && G(te), xe.start(we.transitions.duration.shortest, () => {
        _e.current = !1;
      });
    }
  ), sr = (te) => {
    _e.current && te.type !== "touchstart" || (ve && ve.removeAttribute("title"), Ot.clear(), mt.clear(), M || Mn && V ? Ot.start(Mn ? V : M, () => {
      mo(te);
    }) : mo(te));
  }, ho = (te) => {
    Ot.clear(), mt.start(A, () => {
    ...
    onFocus: cs,
    ref: ps
  } = ua(), [, bo] = E.useState(!1), vo = (te) => {
    ls(te), go.current === !1 && (bo(!1), ho(te));
  }, yo = (te) => {
    ve || ft(te.currentTarget), cs(te), go.current === !0 && (bo(!0), sr(te));
  }, wo = (te) => {
    _e.current = !0;
    const Ae = ie.props;
    Ae.onTouchStart && Ae.onTouchStart(te);
  }, xo = sr, Eo = ho, us = (te) => {
    wo(te), mt.clear(), xe.clear(), Nn(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(Q, () => {
      document.body.style.WebkitUserSelect = qt.current, sr(te);
    });
  }, ds = (te) => {
    ie.props.onTouchEnd && ie.props.onTouchEnd(te), Nn(), mt.start(U, () => {
      Cn(te);
    });
  };
  E.useEffect(() => {
  ...
  const fs = ze(ie.ref, ps, ft, n);
  !oe && oe !== 0 && (Qe = !1);
  const lr = E.useRef(), ms = (te) => {
    const Ae = ie.props;
...
`));
  ...
  const Gt = {};
  D || (Le.onTouchStart = us, Le.onTouchEnd = ds), $ || (Le.onMouseOver = In(xo, Le.onMouseOver), Le.onMouseLeave = In(Eo, Le.onMouseLeave), Ze || (Gt.onMouseOver = xo, Gt.onMouseLeave = Eo)), R || (Le.onFocus = In(yo, Le.onFocus), Le.onBlur = In(vo, Le.onBlur), Ze || (Gt.onFocus = yo, Gt.onBlur = vo)), process.env.NODE_ENV !== "production" && ie.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ie.props.title}\` or the Tooltip component.`].join(`
`));
  const hs = E.useMemo(() => {
    var te;
    let Ae = [{
    ...
    touch: _e.current
  }), pr = Of(Yt), ko = (r = (o = K.popper) != null ? o : B.Popper) != null ? r : Nf, To = (i = (s = (l = K.transition) != null ? l : B.Transition) != null ? s : _) != null ? i : jr, Oo = (c = (p = K.tooltip) != null ? p : B.Tooltip) != null ? c : Cf, No = (u = (f = K.arrow) != null ? f : B.Arrow) != null ? u : Sf, gs = rn(ko, T({}, W, (d = Y.popper) != null ? d : F.popper, {
    className: ke(pr.popper, W == null ? void 0 : W.className, (b = (v = Y.popper) != null ? v : F.popper) == null ? void 0 : b.className)
  }), Yt), bs = rn(To, T({}, J, (g = Y.transition) != null ? g : F.transition), Yt), vs = rn(Oo, T({}, (m = Y.tooltip) != null ? m : F.tooltip, {
    className: ke(pr.tooltip, (k = (I = Y.tooltip) != null ? I : F.tooltip) == null ? void 0 : k.className)
  }), Yt), ys = rn(No, T({}, (w = Y.arrow) != null ? w : F.arrow, {
    className: ke(pr.arrow, (x = (h = Y.arrow) != null ? h : F.arrow) == null ? void 0 : x.className)
  }), Yt);
  return /* @__PURE__ */ re(E.Fragment, {
    children: [/* @__PURE__ */ E.cloneElement(ie, Le), /* @__PURE__ */ y(ko, T({
      as: X ?? Ha,
      placement: q,
      anchorEl: Z ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ re(Oo, T({}, vs, {
          children: [oe, S ? /* @__PURE__ */ y(No, T({}, ys, {
            ref: Je
          })) : null]
        }))
      }))
...
const Mf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], If = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = it({
    ...
    titleAccess: f,
    viewBox: d = "0 0 24 24"
  } = r, b = de(r, Mf), v = /* @__PURE__ */ E.isValidElement(o) && o.type === "svg", g = T({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function Xa(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${t}Icon`), n.muiName = Ei.muiName, /* @__PURE__ */ E.memo(/* @__PURE__ */ E.forwardRef(n));
}
const Af = {
  configure: (e) => {
...
}, Symbol.toStringTag, { value: "Module" })), jf = /* @__PURE__ */ Vl(Df);
var ki;
function Bf() {
...
var Ga = lo.default = void 0, Ff = Lf(Bf()), Vf = ws;
Ga = lo.default = (0, Ff.default)(/* @__PURE__ */ (0, Vf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Ti(e, t, n) {
  return e ? /* @__PURE__ */ y(_i, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ y("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function Ya(e) {
  const {
    onClick: t,
    ...
    Bs,
    {
      ...
      children: n ? /* @__PURE__ */ re(Xn, { children: [
        Ti(i, n, !0),
        /* @__PURE__ */ y(Ls, { primary: n, inset: !i && o }),
        f ? /* @__PURE__ */ y(_i, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ y(Ga, {}) }) : Ti(s, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ y(Pf, { title: r, placement: "right", children: /* @__PURE__ */ y("div", { children: k }) }) : k;
}
function Ka(e) {
...
function zf(e) {
  const [t, n] = Ee(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (p) => {
    ...
    let p = Ka(i).filter((u) => "menuItem" in u.group);
    if (!(r != null && r.id))
  ...
  return /* @__PURE__ */ re(Xn, { children: [
    /* @__PURE__ */ y(Ya, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ y(
      Fs,
      {
        anchorEl: t,
...
function po(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = bn(() => {
    const u = o && o.length > 0 ? o : (
      ...
      Ka(t).filter((v) => !("menuItem" in v.group))
  ...
  return /* @__PURE__ */ re(
    Ai,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ y(Vs, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ y(
          Hf,
          {
            commandHandler: e,
            menuDefinition: t,
...
const Yf = ["children", "className", "component", "dense", "disablePadding", "subheader"], Kf = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
...
const Zf = Za, Qf = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Er(e, t, n) {
...
function tn(e, t, n, r, o, i) {
  ...
  for (; l; ) {
    ...
    if (!l.hasAttribute("tabindex") || !Qa(l, i) || c)
      l = o(e, l, n);
    else
      return l.focus(), !0;
  }
...
const es = /* @__PURE__ */ E.forwardRef(function(t, n) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: r,
  ...
  } = t, d = de(t, Qf), b = E.useRef(null), v = E.useRef({
    keys: [],
    repeating: !0,
  ...
  const g = (w) => {
    ...
    if (h === "ArrowDown")
      ...
      w.preventDefault(), tn(x, N, p, c, Oi);
    else if (h === "Home")
      w.preventDefault(), tn(x, null, p, c, Er);
    else if (h === "End")
      w.preventDefault(), tn(x, null, p, c, Oi);
    else if (h.length === 1) {
...
const em = es, tm = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], nm = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const r = Tn(), o = {
    ...
    timeout: k = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: I = Va
  } = t, w = de(t, tm), x = E.useRef(null), h = ze(x, l.ref, n), N = (j) => (D) => {
    if (j) {
      const M = x.current;
      D === void 0 ? j(M) : j(M, D);
    }
...
const im = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], am = (e) => {
  const {
    classes: t,
    invisible: n
  } = e;
  ...
  const s = it({
    ...
    slotProps: v = {},
    slots: g = {},
    TransitionComponent: m = rm,
    transitionDuration: k
  } = s, I = de(s, im), w = T({}, s, {
    component: p,
    invisible: d
  }), x = am(w), h = (r = v.root) != null ? r : f.root;
  return /* @__PURE__ */ y(m, T({
    in: b,
    timeout: k
  }, I, {
    children: /* @__PURE__ */ y(sm, T({
      "aria-hidden": !0
    }, h, {
...
const pm = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], um = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  const X = (r = (o = j == null ? void 0 : j.root) != null ? o : k.Root) != null ? r : dm, W = (i = (s = j == null ? void 0 : j.backdrop) != null ? s : k.Backdrop) != null ? i : u, Y = (l = $ == null ? void 0 : $.root) != null ? l : I.root, K = (c = $ == null ? void 0 : $.backdrop) != null ? c : I.backdrop, oe = Et({
    elementType: X,
    externalSlotProps: Y,
  ...
  return !F && !R && (!G || U) ? null : /* @__PURE__ */ y(fn, {
    ref: O,
    container: g,
    disablePortal: N,
...
const gm = ["className", "component", "elevation", "square", "variant"], bm = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
  ...
  return T({
    ...
    backgroundImage: `linear-gradient(${Hn("#fff", wi(t.elevation))}, ${Hn("#fff", wi(t.elevation))})`
  }, e.vars && {
...
const xm = ["onEntering"], Em = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], km = ["slotProps"];
function Ni(e, t) {
  let n = 0;
...
const Tm = (e) => {
  ...
  } = s, F = de(s.TransitionProps, xm), C = de(s, Em), R = (r = x == null ? void 0 : x.paper) != null ? r : I, $ = E.useRef(), j = ze($, R.ref), D = T({}, s, {
    anchorOrigin: p,
    anchorReference: f,
    elevation: g,
    marginThreshold: m,
...
`));
    ...
    return {
      top: ie.top + Ni(ie, p.vertical),
      left: ie.left + Ci(ie, p.horizontal)
    };
  }, [c, p.horizontal, p.vertical, u, f]), Q = E.useCallback((J) => ({
    vertical: Ni(J, h.vertical),
    horizontal: Ci(J, h.horizontal)
    ...
    const ft = Ne + P.height, Ce = ve + P.width, Je = jt(jn(c)), _e = Je.innerHeight - m, Ze = Je.innerWidth - m;
    if (m !== null && Ne < m) {
      const xe = Ne - m;
      Ne -= xe, ie.vertical += xe;
    } else if (m !== null && ft > _e) {
      const xe = ft - _e;
      Ne -= xe, ie.vertical += xe;
    }
...
`)), m !== null && ve < m) {
  ...
  const q = v || (c ? Te(jn(c)).body : void 0), X = (o = w == null ? void 0 : w.root) != null ? o : Om, W = (i = w == null ? void 0 : w.paper) != null ? i : is, Y = Et({
    elementType: W,
...
const Sm = ["onEntering"], Pm = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Rm = {
  vertical: "top",
  horizontal: "right"
}, $m = {
  vertical: "top",
  ...
  const i = it({
    ...
    slots: I = {},
    slotProps: w = {}
  } = i, x = de(i.TransitionProps, Sm), h = de(i, Pm), N = Tn(), S = N.direction === "rtl", L = T({}, i, {
    autoFocus: s,
    ...
    TransitionProps: x,
    variant: k
  }), B = Mm(L), F = s && !p && d, C = E.useRef(null), R = (Z, O) => {
...
`)), Z.props.disabled || (k === "selectedMenu" && Z.props.selected || j === -1) && (j = O));
  ...
  const D = (r = I.paper) != null ? r : _m, M = (o = w.paper) != null ? o : b, V = Et({
    elementType: I.root,
  ...
  return /* @__PURE__ */ y(Im, T({
    onClose: f,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: S ? "right" : "left"
    },
    transformOrigin: S ? Rm : $m,
    slots: {
      paper: D,
      root: I.root
    },
...
), uo = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(ji.Root, { ref: n, className: ee(Fm(), e), ...t }));
uo.displayName = ji.Root.displayName;
function qn({
  id: e,
  isDisabled: t = !1,
  hasError: n = !1,
...
function vh({ scrRef: e, handleSubmit: t, id: n }) {
  const r = (c) => {
    t(c);
  }, o = (c) => {
  ...
  return /* @__PURE__ */ re("span", { id: n, className: "pr-flex pr-place-items-center", children: [
    ...
    /* @__PURE__ */ y(
      ...
      {
        onClick: () => t(Po(e, 1)),
        disabled: e.chapterNum >= $i(e.bookNum),
        children: ">"
      }
    ),
    /* @__PURE__ */ y(
    ...
    /* @__PURE__ */ y(
      ...
      {
        onClick: () => t(Ro(e, -1)),
        disabled: e.verseNum <= ks,
        children: "<"
      }
    ),
    /* @__PURE__ */ y(lt, { onClick: () => t(Ro(e, 1)), children: ">" })
  ] });
}
function yh({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = Ee(""), i = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ y(
...
function Th({
  ...
  const i = vt(void 0);
  return /* @__PURE__ */ y("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ y(qs, { position: "static", id: r, children: /* @__PURE__ */ re(Xs, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ y(
      Lm,
      {
        commandHandler: t,
...
}, Ch = Ie.Root, zm = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Ie.List,
  {
    ref: n,
    className: ee(
...
zm.displayName = Ie.List.displayName;
const Um = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Ie.Trigger,
  {
    ref: n,
    className: ee(
...
Um.displayName = Ie.Trigger.displayName;
...
Hm.displayName = Ie.Content.displayName;
...
Wm.displayName = Ie.List.displayName;
...
const Sh = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Ie.Trigger,
  {
    ref: n,
    ...t,
...
)), Xm = he.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ y(
  Ie.Content,
  {
    ref: n,
    className: ee(
...
Xm.displayName = Ie.Content.displayName;
function Gm(e, t = "top") {
...
export {
  ...
  lt as Button,
  mh as ChapterRangeSelector,
  ea as Checkbox,
  hh as Checklist,
  Nr as ComboBox,
  gh as ContextMenu,
  dl as DropdownMenu,
  gl as DropdownMenuCheckboxItem,
  Hi as DropdownMenuContent,
  ch as DropdownMenuGroup,
  Wi as DropdownMenuItem,
  zr as DropdownMenuLabel,
  ph as DropdownMenuPortal,
  dh as DropdownMenuRadioGroup,
  bl as DropdownMenuRadioItem,
  qi as DropdownMenuSeparator,
  ...
  Th as Toolbar,
  Wm as VerticalTabs,
  Xm as VerticalTabsContent,
  qm as VerticalTabsList,
  Sh as VerticalTabsTrigger,
