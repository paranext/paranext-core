...
import { c as m, g as ve, a as _r, C as Se, u as Io, T as Mt, b as Ot, d as It, e as $t, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Zi, l as Qi, m as ts, I as es, n as so, r as we, o as rs, p as En, q as la, s as da, L as Et, R as co, t as ea, D as Ba, v as Fa, w as Ua, y as Ka, z as lo, E as Tn, F as wo, G as Je, H as Er, J as je, K as Be, M as Fe, S as Tr, N as nr, O as as, Q as Rr, U as Ze, V as Oe, Z as tr, W as De, X as ir, Y as uo, _ as po, $ as ra, a0 as ho, a1 as Sn, a2 as os, a3 as ns, a4 as is, a5 as qa, a6 as zn, a7 as wa, a8 as ss, a9 as Rn, aa as cs, ab as ls, ac as ds, ad as $o, ae as ws, af as us, ag as ps, ah as hs, ai as Dn, aj as Mn, ak as go, al as gs, am as On, an as Ca, ao as Po, ap as Ea, aq as fs, ar as ms, as as vs, at as bs, au as xs, av as Dr, aw as fo, ax as ys, ay as ks } from "./resizable-Bt1tBW_y.js";
import { az as $g, aA as Pg, aB as Ag, aC as Vg, aD as Lg, aE as jg, aF as Bg, aG as Fg, aH as Ug, aI as Kg, aJ as qg, aK as Hg, aL as Gg, aM as Wg, aN as Yg, aO as Xg, aP as Jg, aQ as Zg, aR as Qg, aS as tf, aT as ef, aU as rf, aV as af, aW as of, aX as nf, aY as sf, aZ as cf, a_ as lf } from "./resizable-Bt1tBW_y.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as Ha, ChevronRight as Ga, ArrowLeft as _s, ArrowRight as Ns, ChevronDown as lr, BoldIcon as Cs, ItalicIcon as Es, X as mo, AtSign as In, Pencil as Ts, Trash2 as Ss, ArrowUp as $n, MoreHorizontal as zs, MailOpen as Rs, Mail as Ds, ChevronUp as Ms, FilterIcon as Os, ArrowLeftIcon as Is, ChevronLeftIcon as $s, ChevronRightIcon as Ps, ArrowRightIcon as As, Copy as Pn, Filter as Vs, User as Ls, Link as js, CircleHelp as Bs, Undo as Fs, Redo as Us, SquareX as An, FunctionSquare as Vn, SquareSigma as Ln, Ban as Ks, AlertCircle as Wa, CircleCheckIcon as qs, CircleXIcon as Hs, CircleHelpIcon as Gs, ArrowUpIcon as Ws, ArrowDownIcon as Ys, ScrollText as Xs, ChevronsUpDown as Js, MenuIcon as Zs, Menu as Qs, EllipsisVertical as tc, MoreVertical as ec } from "lucide-react";
import { Section as Ct, getChaptersForBook as rc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as Hr, formatRelativeDate as ac, sanitizeHtml as vo, NumberFormat as jn, formatBytes as oc, getCurrentLocale as nc, usfmMarkers as Gr, isPlatformError as ic, ABORTED as sc, getErrorMessage as cc, getFormatCallerFunction as lc, deepEqual as dc, isString as jo, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as wc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as uc } from "platform-bible-utils";
import St, { useRef as K, useMemo as V, createContext as ua, useContext as bo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as pc, useLayoutEffect as te, Component as hc, createElement as Uo, Suspense as gc, forwardRef as Bn, useId as Ko, Fragment as pa } from "react";
...
import { createEditor as Kn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as xo, ParagraphNode as qn, TextNode as Hn, $getPreviousSelection as Ec, $isRangeSelection as xe, $caretFromPoint as Tc, $getSiblingCaret as Gn, $getChildCaret as Sc, $getAdjacentChildCaret as zc, $isChildCaret as Rc, $normalizeCaret as Dc, $setSelectionFromCaretRange as Mc, $getCollapsedCaretRange as Oc, $getCaretInDirection as qo, $splitAtPointCaretNext as Ic, $isTextPointCaret as $c, $findMatchingParent as Wn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Pc, isHTMLElement as Ac, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as yo, shallowMergeConfig as Vc, defineExtension as ne, safeCast as er, createState as Lc, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Jn, COMMAND_PRIORITY_LOW as Zn, RootNode as jc, LineBreakNode as Bc, TabNode as Fc, $isEditorState as Uc, createCommand as Kc, CLICK_COMMAND as qc, isDOMNode as Hc, $getNodeFromDOMNode as Gc, $createNodeSelection as Wc, $setSelection as Yc, $getEditor as Xc, DecoratorNode as Xa, $getState as Jc, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Zc, $setState as Qc, addClassNamesToElement as Qn, $create as tl, $getNodeByKey as el, removeClassNamesFromElement as rl, KEY_TAB_COMMAND as al, $isBlockElementNode as ol, $createRangeSelection as nl, $normalizeSelection__EXPERIMENTAL as il, OUTDENT_CONTENT_COMMAND as sl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as ko, $isDecoratorNode as ll, $isParagraphNode as dl, $isTextNode as Ja, SELECTION_CHANGE_COMMAND as ti, $insertNodes as wl } from "lexical";
...
import { ToggleGroup as ei, Avatar as _o, Select as Xt, Checkbox as Wo, Slot as Or, Tabs as ue, Menubar as ke, ContextMenu as Pt, Progress as Yo, Slider as Br, Switch as Xo } from "radix-ui";
...
function ii({
  ...
  const g = K(!1), f = () => {
    ...
    () => _r(e, l),
    [e, l]
  ), y = !!p && !w, C = `${v} (${z})`, E = y ? h || `${C}, ${p}` : C, $ = /* @__PURE__ */ u(
    Se,
    {
      ref: t,
...
function Il({
  ...
  W(() => {
    var R;
    Ol();
    const Q = (R = E.current) == null ? void 0 : R.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
...
function Ra({
  ...
  const F = we(), A = Ml(), D = T ?? A, [U, Y] = _(!1), [q, Q] = _(""), [I, tt] = _(""), [N, R] = _("books"), [H, nt] = _(void 0), [at, pt] = _(
    void 0
  ), [dt, J] = _(void 0), [wt, gt] = _(!1), [ft, mt] = _(!1), Jt = K(null), vt = K(!1), At = K(void 0), Vt = K(void 0), bt = K(void 0), Ft = K(void 0), Tt = K({}), Ut = K({}), ct = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Bl(kt, Lt),
    [kt, Lt]
  ), ae = qt.has(t.book), Zt = V(() => I.trim() ? eo(
    Kt.filter((k) => so(k, I, i))
  ) : ft ? se : ie, [
    ie,
    se,
    Kt,
  ...
  const jt = j(() => {
    ...
    R("books"), nt(void 0), pt(void 0), J(void 0), setTimeout(() => {
      Vt.current && Vt.current.focus();
    }, 0);
  }, []), b = j(() => {
    const k = at;
    pt(void 0), J(void 0), k ? (nt(k), R("chapters"), Q("")) : G();
  }, [at, G]), L = j(
    (k) => {
      Y(k), k && (R("books"), nt(void 0), pt(void 0), J(void 0), tt(""), mt(ae));
    },
    [ae]
  );
  W(() => {
  ...
  const { otLong: st, ntLong: ht, dcLong: xt, extraLong: _t } = {
    ...
    () => Vl(I),
    [I]
  ), fr = V(() => !w || !M || !M.chapterNum || !Pr ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Pr]), Ar = N === "books" && !wt && !I.trim() && qt.size > 0, mr = j(
    (k) => p ? Zo(k, p) : !1,
    [p]
  ), vr = j(
    (k) => (rt) => p ? Ll(k, rt, p) : !1,
    ...
    (k) => {
      ...
      if ((N === "chapters" || N === "books" && M) && O) {
        const Gt = N === "chapters" ? H : M == null ? void 0 : M.book;
        if (!Gt) return;
        ...
        switch (k.key) {
          case "ArrowLeft":
            zt !== 0 && (yt = zt > 1 ? zt - 1 : Qt);
            break;
          case "ArrowRight":
            zt !== 0 && (yt = zt < Qt ? zt + 1 : 1);
            break;
          case "ArrowUp":
            yt = zt === 0 ? Qt : Math.max(1, zt - fe);
            break;
          case "ArrowDown":
            yt = zt === 0 ? 1 : Math.min(Qt, zt + fe);
            break;
          default:
            return;
        }
        yt !== zt && (k.preventDefault(), k.stopPropagation(), Q(
          `${Gt} ${de[Gt] || ""} ${yt}`
        ), setTimeout(() => {
  ...
  return te(() => {
    const k = setTimeout(() => {
      if (U && N === "books" && bt.current && Ft.current) {
          ...
          Ve,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                N === "chapters" && H && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ve(H, i) }),
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a(Ee, { heading: Bt(k), children: rt.map((ot) => /* @__PURE__ */ a(
                          ii,
                          {
                            ...
                            localizedBookNames: i,
                            disabled: mr(ot),
                            dimmedReason: qt.has(ot) ? xa : void 0,
                            dimmedDescription: qt.has(ot) ? ya(ot) : void 0
                          },
                          ot
                        )) }, k)
                      );
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ql = di ? te : W, Ur = { tag: xo };
...
function nd(t, e, r) {
  ...
  function l() {
    ...
    for (let z = 0; z < g.length; z++) {
      const y = g[z], C = s[z] || document.createElement("div"), E = C.style;
      ...
      const A = be(y.height);
      E.height !== A && (C.style.height = A, v = !0), C.parentNode !== c && (c.append(C), v = !0), s[z] = C;
    }
...
function sd(t, e = id) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), x = f.getKey(), v = h.offset, z = g.getNode(), y = z.getKey(), C = g.offset, E = t.getElementByKey(x), $ = t.getElementByKey(y), T = r === null || E !== o || v !== n || x !== r.getKey(), F = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((T || F) && E !== null && $ !== null) {
...
function dd(t) {
  ...
  const o = wd(t, r), n = zc(o), i = Rc(n) ? Dc(n) : o;
  return Mc(Oc(i)), t.getLatest();
}
function wd(t, e, r) {
  let o = qo(e, "next");
  for (let n = o; n; n = Ic(n, r)) o = n;
  return $c(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), qo(Gn(t.getLatest(), "next"), e.direction);
}
function ud(t) {
  const e = ee();
  if (!xe(e)) return !1;
...
let oa, Ce = 0, na = 0, gd = 0, ao = 0, Xr = 0;
function nn(t) {
  if (it === void 0) return;
  let e = t.n;
...
function md(t) {
  ...
  pi(this), it = t, this.f &= -2, 8 & this.f && To(this), fa();
}
function or(t, e) {
...
const oo = ne({ build: (t) => vi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const So = 0, no = 1, xi = 2, Ia = 3, Kr = 4, ar = 5, $a = 6, yr = 7;
function Pa(t) {
  return t.id === So;
}
function yi(t) {
...
}, name: "@lexical/extension/InitialState", nodes: [jc, Hn, Bc, Fc, qn] }), ln = Symbol.for("@lexical/extension/LexicalBuilder");
function dn() {
}
function Cd(t) {
  throw t;
...
ne({ dependencies: [oo, wn], name: "@lexical/extension/HorizontalRule", nodes: () => [dr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(wn).output, n = zr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Te(t.registerCommand(Td, (s) => {
    ...
    return !0;
  }, yo), t.registerCommand(qc, (s) => {
    if (Hc(s.target)) {
      const c = Gc(s.target);
      if (zd(c)) return function(l, d = !1) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (xe(f)) {
                const x = f.anchor;
                let v = x.getNode(), z = 0, y = 0;
                if (Ja(v) && d >= 0 && w >= 0 && (z = d, y = d + w, f.setTextNodeRange(v, z, v, y)), z === y && p === "" || (f.insertRawText(p), v = x.getNode()), Ja(v)) {
                  z = h, y = h + g;
                  const C = v.getTextContentSize();
                  z = z > C ? C : z, y = y > C ? C : y, f.setTextNodeRange(v, z, v, y);
                }
...
function Mp({
  ...
  const [i, s] = _(iw), [c, l] = _(n), [d, w] = _(!1), p = K(void 0), h = K(null);
  W(() => {
    let v = !0;
    const z = h.current;
    if (!z) return;
...
function fn({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(dw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(ww, { className: "tw:text-xs tw:font-medium", children: z }) }),
        ...
        $ && /* @__PURE__ */ u(je, { children: [
          /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(X, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(zs, {}) }) }),
...
function Vi({
  ...
  const [q, Q] = _(mn), [I, tt] = _(), [N, R] = _(), H = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, At] = _(E), [Vt, bt] = _(!1), Ft = K(void 0), [Tt, Ut] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
  ...
  W(() => {
    if (!o) {
      ct.current !== "idle" && (tt(void 0), R(void 0), ct.current = "idle");
      return;
    }
  ...
  const Lt = V(() => kt[0], [kt]), ie = K(null), se = K(void 0), Kt = j(() => {
    var b;
  ...
  }, [i, r]), Zt = V(() => kt.slice(1), [kt]), M = V(() => Zt.length ?? 0, [Zt.length]), ce = V(() => M > 0, [M]), jt = V(() => nt || M <= 2 ? Zt : Zt.slice(-2), [Zt, M, nt]), Ht = V(() => nt || M <= 2 ? 0 : M - 2, [M, nt]), pe = V(
    () => M === 1 ? qt.singleReply : Me(qt.multipleReplies, { count: M }),
    [M, qt]
  ), he = V(
    () => Ht === 1 ? qt.singleReply : Me(qt.multipleReplies, { count: Ht }),
    [Ht, qt]
  );
  W(() => {
    !o && pt && ce && dt(!1);
  ...
  const S = j(
    ...
    async (b) => {
      ...
      return et && (P !== void 0 && R(P), L && Kt()), et;
    },
    [Kt, q, p, I]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              X,
              {
                ...
                children: vt ? /* @__PURE__ */ a(Rs, {}) : /* @__PURE__ */ a(Ds, {})
              }
            ),
            U === void 0 ? (
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: x == null ? void 0 : x.map((b) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                tt(b !== i ? b : void 0), ct.current = "user-selected", R(void 0), wt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), pw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => pw(vo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function hw({
  ...
  const U = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: U }), q = (N) => N ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: N }) : Y, Q = () => {
    const N = o ?? "accept";
    return N === "merged" ? t.mergedText ? /* @__PURE__ */ a(ta, { html: z }) : Y : q(N === "reject" ? t.rejectedResultText : t.resultText);
  }, I = (N) => p && N.value === "reject", tt = (N) => {
    const R = f === N.value, H = `${d}-${N.value}`, nt = I(N);
    return (
...
function bw(t) {
  ...
  } = t, c = V(() => e.filter((z) => !z.deleted), [e]), l = V(
...
function Bp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, F] = _(), A = j(
    async (R) => {
      const H = await i(R);
      return H !== void 0 && R.assignedUser !== void 0 && R.assignedUser !== "" && F(R.assignedUser), H;
    },
    [i]
  );
  W(() => {
    f && (C((R) => new Set(R).add(f)), $(f));
  }, [f]);
  const D = r.filter(
    (R) => R.comments.some((H) => !H.deleted)
  ), U = D.map((R) => ({ id: R.id })), Y = j(
    (R) => {
      C((H) => new Set(H).add(R.id)), $(R.id), x == null || x(R.id);
    },
    [x]
  ), q = j(
    (R) => {
    ...
    (R) => {
      R.key === "Escape" ? (E && y.has(E) && (C((H) => {
        const nt = new Set(H);
        return nt.delete(E), nt;
      }), $(void 0), x == null || x(void 0)), R.preventDefault(), R.stopPropagation()) : tt(R);
    },
    [E, y, tt, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: D.map((R) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: R.type === "Conflict" ? /* @__PURE__ */ a(bw, { ...H, conflictResolution: z }) : /* @__PURE__ */ a(Vi, { ...H })
          },
          R.id
        );
      })
...
function Cw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [v, z] = _({}), y = V(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
  ...
  return /* @__PURE__ */ u(lo, { children: [
    /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      ...
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(lt, { children: [
          " ",
          /* @__PURE__ */ a(qa, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
      ...
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(lt, { children: [
          " ",
          /* @__PURE__ */ a(qa, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
  ...
  return /* @__PURE__ */ u(je, { open: p, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ u(
      Fe,
      {
        ...
        children: [
          /* @__PURE__ */ a(Rr, { children: o["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(Ze, {}),
          /* @__PURE__ */ a(
            Oe,
            {
...
function Jp({
  ...
  const [v, z] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, F] = _("*"), [A, D] = _("f"), [U, Y] = _(!1), [q, Q] = _(!0), [I, tt] = _(!1), N = K(!1), R = K(""), [H, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = K(null), vt = K(
    void 0
  ), At = K(0), Vt = K(void 0), bt = V(
    () => ({
      ...s,
  ...
  W(() => {
    ...
    if (b && xr("note", b)) {
      ...
      let st = "custom";
      et === Za ? st = "generated" : et === Qa ? st = "hidden" : et && ($(et), F(et)), z(st), C(st), D(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const se = () => {
    ...
    if (B && xr("note", B)) {
      ...
      A !== "x" && S === "x" ? st == null || st.forEach((ht) => Kw(ht)) : A === "x" && S !== "x" && (st == null || st.forEach((ht) => qw(ht))), (et = h.current) == null || et.applyUpdate([B, { delete: 1 }]);
    }
  }, qt = (S) => {
    ...
    (S) => {
      ...
      if (B && xr("note", B)) {
        ...
        if (st || Y(!1), Y(
          ...
          N.current = !0, R.current = JSON.stringify(B), Q(!0);
          return;
        }
        Q(JSON.stringify(B) === R.current), Ut();
      } else
        Y(!1), Q(!0);
    },
    [Ut]
...
function Yw({
  ...
  /* @__PURE__ */ a("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Oo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, x = !!p, v = e === "horizontal" ? "horizontal" : "vertical", z = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = m(v, z);
  return /* @__PURE__ */ u(lt, { children: [
...
const Zw = (t) => {
  ...
  cell: ({ row: i }) => {
    ...
    return (
      ...
      /* @__PURE__ */ a("div", { className: "tw:flex tw:justify-center", children: /* @__PURE__ */ u(zi, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
        /* @__PURE__ */ a(
          Jr,
          {
            onClick: (l) => {
...
function sh({
  ...
  const g = me(r, "%webView_inventory_all%"), f = me(r, "%webView_inventory_approved%"), x = me(r, "%webView_inventory_unapproved%"), v = me(r, "%webView_inventory_unknown%"), z = me(r, "%webView_inventory_scope_currentBook%"), y = me(r, "%webView_inventory_scope_chapter%"), C = me(r, "%webView_inventory_scope_verse%"), E = me(r, "%webView_inventory_filter_text%"), $ = me(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = me(r, "%webView_inventory_no_results%"), [F, A] = _(!1), [D, U] = _("all"), [Y, q] = _(""), [Q, I] = _([]), tt = V(() => {
    const J = t ?? [];
  ...
  }, [F, tt]), R = V(() => N.length === 0 ? [] : eu(N, D, Y), [N, D, Y]), H = V(() => {
    var gt, ft;
    if (!F) return l;
  ...
  W(() => {
    R.length === 0 ? I([]) : R.length === 1 && I(R[0].items);
  }, [R]);
  const nt = (J, wt) => {
    wt.setRowSelection(() => {
      const ft = {};
...
function nu({
  ...
  const [l, d] = St.useState(t), w = e ?? l, p = St.useCallback(
    ...
    [r, w]
  ), h = St.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = we() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = St.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(ji.Provider, { value: z, children: /* @__PURE__ */ a(
    "div",
    {
...
const Re = "scrBook", hu = "scrRef", Xe = "source", gu = "details", fu = "Scripture Reference", mu = "Scripture Book", Bi = "Type", vu = "Details";
function bu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Re ? Ne(n.start) : void 0;
      },
...
function kh({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Re, desc: !1 }]), [g, f] = _({}), x = V(
  ...
  W(() => {
    if (c) {
      const D = z.getSelectedRowModel().rowsById, U = Object.keys(D);
      if (U.length === 1) {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: z.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((U) => U.column.columnDef.header).map((U) => (
      ...
      /* @__PURE__ */ a(ho, { children: z.getRowModel().rows.map((D, U) => {
        const Y = we();
        return /* @__PURE__ */ a(
          De,
          {
...
function yu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
  ...
  }, [v, z] = _(!1), [y, C] = _(""), E = K(void 0), $ = K(!1), T = V(
    () => Mn(t),
    [t]
  ), F = V(() => {
    if (!y.trim()) {
    ...
    (I, tt = !1) => {
      ...
      const N = T.findIndex((pt) => pt === E.current), R = T.findIndex((pt) => pt === I);
      if (N === -1 || R === -1) return;
      const [H, nt] = [
        Math.min(N, R),
        Math.max(N, R)
                  ...
                  /* @__PURE__ */ u(Le, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(Ct).filter((I) => F[I].length > 0).map((I, tt) => {
                      ...
                      return /* @__PURE__ */ u(pa, { children: [
                        tt > 0 && /* @__PURE__ */ a(Rn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Ee,
                          {
                            heading: En(I, h, g, f, x),
                            children: N.map((R) => /* @__PURE__ */ a(
                              ii,
                              {
                                bookId: R,
...
function Nh({
  ...
  const $ = Rt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = Rt(s, "%webView_scope_selector_current_book%"), q = Rt(s, "%webView_scope_selector_choose_books%"), Q = Rt(s, "%webView_scope_selector_scope%"), I = Rt(s, "%webView_scope_selector_select_books%"), tt = Rt(s, "%webView_scope_selector_range%"), N = Rt(s, "%webView_scope_selector_select_range%"), R = Rt(s, "%webView_scope_selector_range_start%"), H = Rt(s, "%webView_scope_selector_range_end%"), nt = Rt(s, "%webView_scope_selector_ok%"), at = Rt(s, "%webView_scope_selector_cancel%"), pt = Rt(s, "%webView_scope_selector_navigate%"), dt = (O) => {
    if (!x) return;
  ...
  }, At = K(null), Vt = K(null), bt = K(!1), Ft = K(null), Tt = K(!1), [Ut, ct] = _(void 0), kt = K(!1), Lt = K(!1), ie = K(null), se = j((O) => {
    if (O) {
  ...
  ), jt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [pe, he] = _(!1), [S, B] = _(void 0), [G, b] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", Bt = /* @__PURE__ */ a(
    Cu,
    {
      availableBookInfo: o,
  ...
  ), re = Ut === "end", Ir = Ut === "start", rr = "tw:text-muted-foreground", qe = w === "dropdown" && S === "range", $r = qe ? P : Ke, Pr = qe ? st : f ? qt : vt, fr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(re && rr), children: R }),
      /* @__PURE__ */ a(
        Ra,
        {
  ...
  const [He, Vr] = _(null), [Ge, xa] = _(null), [We, ya] = _(null), ka = 200, [_a, Na] = _(!1);
  W(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
          ...
          Fe,
          {
            ...
            children: /* @__PURE__ */ u(Ca, { container: We, children: [
              ...
              v && /* @__PURE__ */ u(lt, { children: [
                /* @__PURE__ */ a(Ze, {}),
                /* @__PURE__ */ a(Rr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  Je,
                  {
                    ref: Ft,
                        ...
                        children: /* @__PURE__ */ a(
                          Ra,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(lt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(x ?? Sa, "id") }),
                              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
    ...
    w === "radio" && t === "range" && fr,
    w === "dropdown" && jt && /* @__PURE__ */ a(Ba, { open: S === "selectedBooks", onOpenChange: k, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: xa,
        onCloseAutoFocus: rt,
        ...
        children: /* @__PURE__ */ u(Ca, { container: Ge, children: [
          /* @__PURE__ */ a(Ua, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ka, { children: q }) }),
          Bt,
...
const Ru = Object.freeze([520, 420, 340]), qi = St.forwardRef(
...
const Hi = St.forwardRef(({ className: t, ...e }, r) => {
  const o = we();
  return /* @__PURE__ */ a(
    ue.Root,
    {
...
function Fu({
  ...
  if (zl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var f, x, v, z;
    w.preventDefault();
...
function Ih({
  ...
  const d = Ku(
    ...
    var z, y, C, E, $, T;
    const v = x !== f ? ((y = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : y[x]) ?? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
...
export {
  ...
  Ot as Tooltip,
  $t as TooltipContent,
  ef as TooltipPortalContainerProvider,
