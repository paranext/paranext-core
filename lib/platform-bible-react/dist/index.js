...
import { c as m, g as De, a as La, C as Ee, A as ce, P as Ie, b as He, B as G, d as Ae, e as Ve, f as Pe, h as ye, i as Pi, k as ji, j as Bi, E as Li, l as Fa, r as re, m as Fi, n as cn, o as Nr, p as Qr, L as kt, D as _a, q as Na, s as Ca, t as Ea, T as Kt, u as Ua, v as qt, w as Gt, x as Ht, y as ln, z as Ka, F as Ke, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ui, N as Cr, O as Ge, Q as $e, Z as Ye, R as Oe, U as tr, V as qa, W as Ga, X as qr, Y as Ha, _ as dn, $ as Ki, a0 as qi, a1 as Gi, a2 as vo, a3 as wn, a4 as ta, a5 as un, a6 as Hi, a7 as Yi, a8 as Wi, a9 as Xi, aa as pn, ab as Ji, ac as ia, ad as bo, ae as sa, af as Zi, ag as Qi, ah as ts, ai as es, aj as rs, ak as Er, al as Ya } from "./resizable-JZpwvayK.js";
import { am as Uh, an as Kh, ao as qh, ap as Gh, aq as Hh, ar as Yh, as as Wh, at as Xh, au as Jh, av as Zh, aw as Qh, ax as tg, ay as eg, az as rg, aA as ag, aB as og, aC as ng, aD as ig, aE as sg, aF as cg, aG as lg, aH as dg, aI as wg, aJ as ug, aK as pg } from "./resizable-JZpwvayK.js";
import { jsx as a, jsxs as u, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ar, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as as, ArrowRight as os, ChevronDown as or, BoldIcon as ns, ItalicIcon as is, X as Wa, AtSign as hn, Pencil as ss, Trash2 as cs, ArrowUp as gn, MoreHorizontal as ls, MailOpen as ds, Mail as ws, ChevronUp as us, FilterIcon as ps, ArrowLeftIcon as hs, ChevronLeftIcon as gs, ChevronRightIcon as fs, ArrowRightIcon as ms, Copy as fn, Filter as vs, User as bs, Link as xs, CircleHelp as ys, Undo as ks, Redo as _s, SquareX as mn, FunctionSquare as vn, SquareSigma as bn, Ban as Ns, AlertCircle as Sa, CircleCheckIcon as Cs, CircleXIcon as Es, CircleHelpIcon as Ts, ArrowUpIcon as zs, ArrowDownIcon as Ss, ScrollText as Rs, ChevronsUpDown as Ds, MenuIcon as Os, Menu as $s, EllipsisVertical as Ms, MoreVertical as _o } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as As, formatReplacementString as qe, sanitizeHtml as Xa, NumberFormat as Vs, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as Pr, getFormatCallerFunction as Bs, deepEqual as Ls, isString as No, compareScrRefs as Ra, scrRefToBBBCCCVVV as ca, defaultScrRef as la, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as Co, collectUsjMarkers as Us } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as I, useState as _, useCallback as L, useEffect as W, useImperativeHandle as Ks, useLayoutEffect as Zt, createContext as Ja, useContext as xn, Component as qs, createElement as Eo, Suspense as Gs, forwardRef as yn, useId as To, Fragment as kn } from "react";
import { RadioGroup as Da, ToggleGroup as _n, Avatar as Za, Select as Lt, Checkbox as zo, Slot as Tr, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as So, Slider as Or, Switch as Ro } from "radix-ui";
import { createEditor as Nn, $getRoot as Me, $createParagraphNode as zr, $getSelection as Yt, HISTORY_MERGE_TAG as Qa, ParagraphNode as Cn, TextNode as En, $getPreviousSelection as Hs, $isRangeSelection as pe, $caretFromPoint as Ys, $getSiblingCaret as Tn, $getChildCaret as Ws, $getAdjacentChildCaret as Xs, $isChildCaret as Js, $normalizeCaret as Zs, $setSelectionFromCaretRange as Qs, $getCollapsedCaretRange as tc, $getCaretInDirection as Do, $splitAtPointCaretNext as ec, $isTextPointCaret as rc, $findMatchingParent as zn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as ac, isHTMLElement as oc, CLEAR_EDITOR_COMMAND as Sn, COMMAND_PRIORITY_EDITOR as to, shallowMergeConfig as nc, defineExtension as ae, safeCast as We, createState as ic, FORMAT_TEXT_COMMAND as Rn, $isNodeSelection as Dn, COMMAND_PRIORITY_LOW as On, RootNode as sc, LineBreakNode as cc, TabNode as lc, $isEditorState as dc, createCommand as wc, CLICK_COMMAND as uc, isDOMNode as pc, $getNodeFromDOMNode as hc, $createNodeSelection as gc, $setSelection as fc, $getEditor as mc, DecoratorNode as Oa, $getState as vc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as bc, $setState as xc, addClassNamesToElement as $n, $create as yc, $getNodeByKey as kc, removeClassNamesFromElement as _c, KEY_TAB_COMMAND as Nc, $isBlockElementNode as Cc, $createRangeSelection as Ec, $normalizeSelection__EXPERIMENTAL as Tc, OUTDENT_CONTENT_COMMAND as zc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as Sc, COMMAND_PRIORITY_CRITICAL as eo, $isDecoratorNode as Rc, $isParagraphNode as Dc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Mn, $insertNodes as Oc } from "lexical";
...
import { useReactTable as An, getFilteredRowModel as Lc, getSortedRowModel as Vn, getPaginationRowModel as Fc, getCoreRowModel as Pn, flexRender as vr, getGroupedRowModel as Uc, getExpandedRowModel as Kc } from "@tanstack/react-table";
import { IconCheck as ra, IconChevronDown as qc, IconChevronUp as Gc, IconSelector as Hc, IconLayoutSidebar as Yc, IconLayoutSidebarRight as Wc, IconChevronRight as jn, IconLoader as Xc, IconAlertOctagon as Jc, IconAlertTriangle as Zc, IconInfoCircle as Qc, IconCircleCheck as tl } from "@tabler/icons-react";
...
function wa({
  ...
  const A = re(), [B, T] = _(!1), [V, $] = _(""), [N, j] = _(""), [D, E] = _("books"), [Y, q] = _(void 0), [F, O] = _(
    void 0
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Rt } = {
    ...
    [w]
  ), ur = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", pr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Sr = L(
    (b) => {
  ...
  return Zt(() => {
    const b = setTimeout(() => {
      if (B && D === "books" && wt.current && st.current) {
        const H = wt.current, rt = st.current, Pt = rt.offsetTop, ve = H.clientHeight, Be = rt.clientHeight, Se = Pt - ve / 2 + Be / 2;
        H.scrollTo({
          top: Math.max(0, Se),
          behavior: "smooth"
        }), $(Ln(t.book));
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ie, { open: B, onOpenChange: et, modal: v, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(
      G,
      {
        ref: Nt,
...
function Po({
  ...
  return /* @__PURE__ */ u(Ie, { open: k, onOpenChange: A, ...y, children: [
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, fl = Kn ? Zt : W, Ir = { tag: Qa };
...
function Ol(t, e = Dl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), k = h.offset, A = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || A !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || k !== c || y !== i.getKey();
...
function Il(t) {
  ...
  if (pe(e)) r = Ys(e.focus, "next");
    ...
    r = r || Ws(Me(), "previous").getFlipped().insert(zr());
  }
...
function Al(t, e, r) {
  ...
  return rc(o) && Hr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(Tn(t.getLatest(), "next"), e.direction);
}
function Vl(t) {
  const e = Yt();
  if (!pe(e)) return !1;
...
let Yr, xe = 0, Wr = 0, Bl = 0, Va = 0, Br = 0;
function Lo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Bt.prototype.brand = Pl, Bt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && Wr === 0 && e.l !== Va && (e.l = Va, Yr = { S: e, v: e.v, i: e.i, o: Yr });
...
} }), Fe.prototype = new Bt(), Fe.prototype.h = function() {
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Rn, (o) => {
  const n = Yt();
  if (Dn(n) || pe(n)) for (const i of n.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, On) });
function Zn(t, e) {
  let r;
...
const io = 0, ja = 1, ti = 2, ga = 3, Ar = 4, Je = 5, fa = 6, gr = 7;
function ma(t) {
  return t.id === io;
}
function ei(t) {
...
function hd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: C = !0, style: y, tabIndex: k, "data-testid": A, ...B }, T) {
  ...
  return ni(() => ($(t.isEditable()), t.registerEditableListener((D) => {
    $(D);
...
const Rd = "verseText", Gu = Object.freeze([
...
function Hu({
  ...
  const [i, s] = _(Dd), [c, d] = _(n), [l, w] = _(!1), p = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
...
function Jo({
  ...
  const h = L(
    ...
    [t.user]
  ), y = I(() => Xa(t.contents), [t.contents]), k = I(
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ad, { className: "tw:text-xs tw:font-medium", children: C }) }),
...
function vi({
  ...
  const [E, Y] = _(Zo), [q, F] = _(), [O, S] = _(), Z = o, [Q, _t] = _(!1), [Nt, At] = _(!1), [U, tt] = _(!1), [wt, st] = _(!1), [vt, oe] = _(!1), [at, Vt] = _(A), [St, Wt] = _(!1), ne = K(void 0), [R, Xt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  }, [i, r]), ut = I(() => Ct.slice(1), [Ct]), ct = I(() => ut.length ?? 0, [ut.length]), gt = I(() => ct > 0, [ct]), pt = I(() => Q || ct <= 2 ? ut : ut.slice(-2), [ut, ct, Q]), ft = I(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Rt = I(
  ...
  const Ft = L(
    ...
    async (z) => {
      const $t = ee(E) ? Jr(E) : void 0, yt = z.status ? z.assignedUser : q ?? z.assignedUser, de = await p({
        ...z,
        contents: $t,
        assignedUser: yt
      });
...
), Pd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Ur = (t) => Pd(Xa(t));
function Kr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function jd({
  ...
  const [s, c] = _("accept"), d = To(), l = To(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = I(
    () => Ur(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Ur(t.acceptedText ?? ""),
      ...
      children: N.map((S) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: S.type === "Conflict" ? /* @__PURE__ */ a(Kd, { ...Z, conflictResolution: C }) : /* @__PURE__ */ a(vi, { ...Z })
          },
          S.id
        );
      })
...
function cr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Lt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Lt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Hc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function se({
  ...
  return /* @__PURE__ */ u(
    Lt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Lt.ItemIndicator, { children: /* @__PURE__ */ a(ra, { className: "tw:pointer-events-none" }) }) }),
...
function Xd({
  ...
  var T;
  const [w, p] = _([]), [g, h] = _([]), [f, x] = _({}), [v, C] = _({}), y = I(() => e ?? [], [e]), k = An({
    data: y,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(Oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: A.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = k.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    V.id
  )) : B = /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(tr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(qd, { table: k }),
    /* @__PURE__ */ u(qa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ga, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(Oe, { children: V.headers.map(($) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : vr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
const ow = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(it, { children: [
...
function nw({
  ...
  return /* @__PURE__ */ u(ke, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: ow(t, n, r) }) }) }),
...
const iw = (t, e) => t === "f" ? /* @__PURE__ */ u(it, { children: [
  /* @__PURE__ */ a(vn, {}),
  " ",
...
function cw({
  ...
  return /* @__PURE__ */ u(ke, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: iw(t, r) }) }) }),
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: sw(t, r) }) })
    ] }) }),
...
function up({
  ...
  const [f, x] = _("generated"), [v, C] = _("generated"), [y, k] = _("*"), [A, B] = _("*"), [T, V] = _("f"), [$, N] = _(!1), [j, D] = _(!0), [E, Y] = _(!1), q = K(!1), F = K(""), [O, S] = _(!1), [Z, Q] = _(), [_t, Nt] = _(), [At, U] = _(), [tt, wt] = _(), st = K(null), vt = I(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && $r("note", X)) {
      ...
      let ct = "custom";
      ut === Ma ? ct = "generated" : ut === Ia ? ct = "hidden" : ut && (k(ut), B(ut)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const ne = () => {
    ...
    if (X && $r("note", X)) {
      ...
      T !== "x" && P === "x" ? pt == null || pt.forEach((ft) => pw(ft)) : T === "x" && P !== "x" && (pt == null || pt.forEach((ft) => hw(ft))), (gt = w.current) == null || gt.applyUpdate([X, { delete: 1 }]);
    }
  }, Ct = (P) => {
  ...
  return /* @__PURE__ */ u(it, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(it, { children: fw(t.marker, c, o, l) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Ha, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(tr, { className: o, children: bw(c.text) })
        ]
      },
...
const yw = (t) => {
  ...
  return e ? e[1] : "";
}, _w = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", yp = Object.freeze([
...
function kp({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), A = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = _(!1), [N, j] = _("all"), [D, E] = _(""), [Y, q] = _([]), F = I(() => {
    const U = t ?? [];
  ...
  }, [V, F]), S = I(() => O.length === 0 ? [] : Nw(O, N, D), [O, N, D]), Z = I(() => {
    var wt, st;
    if (!V) return d;
...
const Ew = "16rem", Tw = "3rem", yi = Tt.createContext(void 0);
function na() {
...
function _p({ className: t, onClick: e, ...r }) {
...
const Re = "scrBook", Vw = "scrRef", Ue = "source", Pw = "details", jw = "Scripture Reference", Bw = "Scripture Book", ki = "Type", Lw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Vp({
  ...
  const [l, w] = _([]), [p, g] = _([{ id: Re, desc: !1 }]), [h, f] = _({}), x = I(
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Gd, { children: A.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
...
function jp({
  ...
  const A = Et(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), j = Et(s, "%webView_scope_selector_current_book%"), D = Et(s, "%webView_scope_selector_choose_books%"), E = Et(s, "%webView_scope_selector_scope%"), Y = Et(s, "%webView_scope_selector_select_books%"), q = Et(s, "%webView_scope_selector_range%"), F = Et(s, "%webView_scope_selector_select_range%"), O = Et(s, "%webView_scope_selector_range_start%"), S = Et(s, "%webView_scope_selector_range_end%"), Z = Et(s, "%webView_scope_selector_ok%"), Q = Et(s, "%webView_scope_selector_cancel%"), _t = Et(s, "%webView_scope_selector_navigate%"), Nt = (M) => {
    if (!f) return;
  ...
  ] }), tt = e ? At.filter((M) => e.includes(M.value)) : At, wt = f ?? la, st = w ?? wt, vt = p ?? wt, oe = () => {
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [R, Xt] = _(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = L((M) => {
    if (M) {
    ...
    [r, n, f, i]
  ), et = tt.find((M) => M.value === t), ut = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Fs(st, vt, {
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [ft, Rt] = _(!1), [Dt, Ft] = _(void 0), [Ot, Te] = _(void 0), [z, $t] = _(void 0), [yt, de] = _(void 0), [ze, wr] = _([]), ur = l === "dropdown" && Dt === "selectedBooks", pr = /* @__PURE__ */ a(
    Gw,
    {
      availableBookInfo: o,
  ...
  ), Sr = R === "end", Rr = R === "start", Xe = "tw:text-muted-foreground", b = l === "dropdown" && Dt === "range", H = b ? $t : P, Pt = b ? de : h ? X : oe, ve = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-start", className: m(Sr && Xe), children: O }),
      /* @__PURE__ */ a(
        wa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: at, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(kt, { htmlFor: "scope-range-end", className: m(Rr && Xe), children: S }),
      /* @__PURE__ */ a(
        wa,
        {
          id: "scope-range-end",
  ...
  const [mt, It] = _(null), [ht, te] = _(null), [Jt, Le] = _(null), Oi = 200, [$i, Mi] = _(!1);
  W(() => {
  ...
  const ho = L(
    (M) => {
      Te(M), $t(st), de(vt), wr(n), Rt(!1), Ft(M);
    },
    [st, vt, n]
  ), go = L(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            children: /* @__PURE__ */ u(ia, { container: Jt, children: [
              ct.map(({ value: M, label: J, dropdownLabel: Ut, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ u(
                Ke,
                {
                  ref: Se(M),
              ...
              x && /* @__PURE__ */ u(it, { children: [
                /* @__PURE__ */ a(Ge, {}),
                /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: _t }),
                /* @__PURE__ */ a(
                  Ke,
                  {
                    ref: Wt,
    ...
    l === "radio" && t === "range" && ve,
    l === "dropdown" && gt && /* @__PURE__ */ a(_a, { open: Dt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: te,
        onCloseAutoFocus: fo,
    ...
    l === "dropdown" && pt && /* @__PURE__ */ a(_a, { open: Dt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Na,
      {
        ref: It,
        onCloseAutoFocus: fo,
...
const Ww = Tt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
function Jp({
  ...
  const s = I(
    () => cu(Object.entries(t)).map(([p, g]) => ({
      tag: p,
      info: g,
      keywords: [g.autonym, ...Object.values(g.uiNames ?? {}), ...g.otherNames ?? []]
    })),
    [t]
  ), c = s.length > 1, d = o["%firstRun_language_search_placeholder%"] ?? "", l = o["%firstRun_language_noResults%"] ?? "", w = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(Ve, { id: i, className: m("pr-twp", n), children: [
    c && /* @__PURE__ */ a(Nr, { placeholder: d, "aria-label": d }),
    /* @__PURE__ */ u(Pe, { children: [
      /* @__PURE__ */ a(Qr, { children: l }),
      s.map(({ tag: p, info: g, keywords: h }) => {
        const f = p === e;
        return /* @__PURE__ */ u(
          Ee,
          {
            ...
            onSelect: () => r(p),
            children: [
              /* @__PURE__ */ a("span", { dir: "auto", children: g.autonym }),
              f && /* @__PURE__ */ a("span", { className: "tw:sr-only", children: w })
            ]
          },
          p
        );
...
function jh(t) {
  const e = I(() => Us(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Gu as CONFLICT_NOTE_STRING_KEYS,
  ...
  vw as FootnoteItem,
  hp as FootnoteList,
  Xp as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  yp as INVENTORY_STRING_KEYS,
  ta as Input,
  Jp as InterfaceLanguagePicker,
  kp as Inventory,
  vo as Kbd,
  Xh as KbdGroup,
  kt as Label,
  ...
  Xu as getCommentThreadElementId,
