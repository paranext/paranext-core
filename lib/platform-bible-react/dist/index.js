...
var di = (t, e, r) => e in t ? ci(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var _t = (t, e, r) => di(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as ke, Dialog as Ht, Popover as rr, Label as gi, RadioGroup as ra, Tooltip as Le, ToggleGroup as Io, Separator as hi, Avatar as ya, DropdownMenu as vt, Select as Ct, Checkbox as qa, Tabs as Bt, Menubar as Jt, ContextMenu as bt, Progress as Ha, Slider as wr, Switch as Wa } from "radix-ui";
import { cva as Zt } from "class-variance-authority";
import { IconX as fi, IconCheck as Me, IconSearch as mi, IconChevronRight as ka, IconChevronDown as vi, IconChevronUp as bi, IconSelector as xi, IconLayoutSidebar as yi, IconLayoutSidebarRight as ki, IconLoader as _i, IconAlertOctagon as Ni, IconAlertTriangle as Ci, IconInfoCircle as Ei, IconCircleCheck as zi } from "@tabler/icons-react";
import { Canon as ct } from "@sillsdev/scripture";
import { includes as ur, Section as W, getChaptersForBook as Ti, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Si, formatReplacementString as oe, sanitizeHtml as Di, NumberFormat as Ri, formatBytes as $i, getCurrentLocale as Mi, usfmMarkers as vr, getFormatCallerFunction as Oi, deepEqual as Ai, isString as Ya, compareScrRefs as aa, scrRefToBBBCCCVVV as Fr, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as nr, Clock as Xa, ChevronsLeft as Ja, ChevronsRight as Za, ChevronLeft as oa, ChevronRight as na, ArrowLeft as Ii, ArrowRight as Pi, ChevronDown as Rr, BoldIcon as Li, ItalicIcon as Vi, X as $r, AtSign as Po, Pencil as ji, Trash2 as Fi, ArrowUp as Lo, MoreHorizontal as Bi, MailOpen as Ui, Mail as Ki, ChevronUp as Gi, FilterIcon as qi, ArrowLeftIcon as Hi, ChevronLeftIcon as Wi, ChevronRightIcon as Yi, ArrowRightIcon as Xi, Copy as Vo, Filter as Ji, User as Zi, Link as Qi, CircleHelp as ts, ChevronsUpDown as jo, Star as es, Undo as rs, Redo as as, SquareX as Fo, FunctionSquare as Bo, SquareSigma as Uo, Ban as os, AlertCircle as ia, CircleCheckIcon as ns, CircleXIcon as is, CircleHelpIcon as ss, ArrowUpIcon as ls, ArrowDownIcon as cs, Search as ds, LoaderCircle as ws, CheckIcon as us, ScrollText as ps, MenuIcon as gs, Menu as hs, EllipsisVertical as fs, MoreVertical as Qa } from "lucide-react";
import et, { forwardRef as ir, useRef as q, useMemo as I, useState as T, useCallback as j, useLayoutEffect as Pt, createContext as Mr, useContext as _a, useEffect as K, Component as ms, createElement as to, Suspense as vs, Fragment as Ko } from "react";
import { createEditor as Go, $getRoot as le, $createParagraphNode as We, $getSelection as zt, HISTORY_MERGE_TAG as Na, ParagraphNode as qo, TextNode as Ho, $isTokenOrSegmented as bs, $getCharacterOffsets as xs, $cloneWithPropertiesEphemeral as ys, $getPreviousSelection as ks, $isRangeSelection as Wt, $caretFromPoint as _s, $getSiblingCaret as Wo, $getChildCaret as Ns, $getAdjacentChildCaret as Cs, $isChildCaret as Es, $normalizeCaret as zs, $setSelectionFromCaretRange as Ts, $getCollapsedCaretRange as Ss, $getCaretInDirection as eo, $splitAtPointCaretNext as Ds, $isTextPointCaret as Rs, $findMatchingParent as Yo, $isElementNode as ie, mergeRegister as ce, getDOMTextNode as $s, isHTMLElement as Xo, CLEAR_EDITOR_COMMAND as Jo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Ms, defineExtension as Lt, safeCast as Oe, createState as Os, FORMAT_TEXT_COMMAND as Zo, $isNodeSelection as Qo, COMMAND_PRIORITY_LOW as tn, RootNode as As, LineBreakNode as Is, TabNode as Ps, $isEditorState as Ls, createCommand as Vs, CLICK_COMMAND as js, isDOMNode as Fs, $getNodeFromDOMNode as Bs, $createNodeSelection as Us, $setSelection as Ks, $getEditor as Gs, DecoratorNode as sa, $getState as qs, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as Hs, $setState as Ws, addClassNamesToElement as en, $create as Ys, $getNodeByKey as Xs, removeClassNamesFromElement as Js, KEY_TAB_COMMAND as Zs, $isBlockElementNode as kr, $createRangeSelection as Qs, $normalizeSelection__EXPERIMENTAL as tl, OUTDENT_CONTENT_COMMAND as el, INDENT_CONTENT_COMMAND as ao, INSERT_TAB_COMMAND as rl, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as al, $isParagraphNode as ol, $isTextNode as _r, SELECTION_CHANGE_COMMAND as rn, getRegisteredNode as nl, isDocumentFragment as oo, isDOMDocumentNode as il, ArtificialNode__DO_NOT_USE as an, $createLineBreakNode as on, $isRootOrShadowRoot as sl, isBlockDomNode as no, isInlineDomNode as io, $insertNodes as ll } from "lexical";
import { HeadingNode as cl, QuoteNode as dl, registerRichText as wl } from "@lexical/rich-text";
...
import { useReactTable as sn, getFilteredRowModel as hl, getSortedRowModel as ln, getPaginationRowModel as fl, getCoreRowModel as cn, flexRender as tr, getGroupedRowModel as ml, getExpandedRowModel as vl } from "@tanstack/react-table";
import bl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as la, HIDDEN_NOTE_CALLER as ca, getDefaultViewOptions as xl, isInsertEmbedOpOfType as pr, Editorial as yl } from "@eten-tech-foundation/platform-editor";
...
function f(...t) {
  const e = wi(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return Cl(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((c) => {
    const d = El(c);
    o.set(d.normalized, d.original), n.push(d.normalized);
  }), pi(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const d = o.get(c);
    return d ? zl(c, d) : c;
  }).join(" ");
}
const Ye = 250, dn = 300, Tl = 400, Sl = 450, wn = 500, un = Zt(
...
function L({
  ...
  return /* @__PURE__ */ a(
    i,
    {
      ...
      "data-variant": e,
      "data-size": r,
      className: f(un({ variant: e, size: r, className: t })),
      ...n
    }
  );
}
const Dl = "layoutDirection";
function lt() {
  const t = localStorage.getItem(Dl);
  return t === "rtl" ? t : "ltr";
}
function Rl({ ...t }) {
  return /* @__PURE__ */ a(Ht.Root, { "data-slot": "dialog", ...t });
}
function Su({ ...t }) {
  return /* @__PURE__ */ a(Ht.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function $l({ ...t }) {
  return /* @__PURE__ */ a(Ht.Portal, { "data-slot": "dialog-portal", ...t });
}
function Du({ ...t }) {
  return /* @__PURE__ */ a(Ht.Close, { "data-slot": "dialog-close", ...t });
}
function Ml({
  className: t,
  ...
  return /* @__PURE__ */ u($l, { children: [
    ...
    /* @__PURE__ */ u(
      Ht.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(Ht.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(L, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(fi, {}),
...
function Ru({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(Ht.Close, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function lr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Al, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(Pl, { children: /* @__PURE__ */ a(mi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const hn = ct.allBookIds.filter(
  (t) => !ct.isObsolete(ct.bookIdToNumber(t))
), Re = Object.fromEntries(
  hn.map((t) => [t, ct.bookIdToEnglishName(t)])
);
function Ra(t, e, r) {
...
function wa(t, e, r) {
  return `${t} ${Re[t]}${e ? ` ${Da(t, e)} ${Ve(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function Fl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ u(we, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(Yt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      de,
      {
        onSelect: () => h(p),
...
function Kl(t, e, r, o) {
  const n = j(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const d = e[c - 1], w = Math.max(qt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function lo({
  ...
  if (t)
    return /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: qt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      de,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Lu({
  ...
  const d = lt(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, k] = T("books"), [x, N] = T(void 0), [_, M] = T(!1), V = q(void 0), A = q(void 0), C = q(void 0), z = q(void 0), E = q({}), O = j(
    ($) => {
      e($), l && l($);
    },
    [e, l]
  ), D = I(() => o ? o() : hn, [o]), F = I(() => ({
    [W.OT]: D.filter((H) => ct.isBookOT(H)),
    [W.NT]: D.filter((H) => ct.isBookNT(H)),
    [W.DC]: D.filter((H) => ct.isBookDC(H)),
    [W.Extra]: D.filter((H) => ct.extraBooks().includes(H))
  }), [D]), P = I(() => Object.values(F).flat(), [F]), G = I(() => {
    if (!m.trim()) return F;
    const $ = {
      [W.OT]: [],
      [W.NT]: [],
    ...
    ($) => {
      const H = v === "chapters" ? x : y == null ? void 0 : y.book;
      H && (O({
        book: H,
        chapterNum: $,
        verseNum: 1
      }), g(!1), k("books"), N(void 0), b(""));
    },
    [O, v, x, y]
  ), te = j(
    ($) => {
    ...
    ($) => {
      ...
      g($), $ && (k("books"), N(void 0), b(""));
    },
    [v, Tt]
  ), { otLong: it, ntLong: at, dcLong: dt, extraLong: Et } = {
    ...
    ($) => {
      if ($.ctrlKey) return;
      const { isLetter: H, isDigit: Q } = so($.key);
      if (v === "chapters") {
        if ($.key === "Backspace") {
          $.preventDefault(), $.stopPropagation(), Tt();
          return;
        }
        if (H || Q) {
          if ($.preventDefault(), $.stopPropagation(), k("books"), N(void 0), Q && x) {
            const wt = Re[x];
            b(`${wt} ${$.key}`);
          } else
            b($.key);
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes($.key)) {
        const wt = v === "chapters" ? x : y == null ? void 0 : y.book;
        if (!wt) return;
        const ot = (() => {
          if (!h) return 1;
          const rt = h.match(/(\d+)$/);
        ...
        switch ($.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            R = ot === 0 ? St : Math.max(1, ot - B);
            break;
          case "ArrowDown":
            R = ot === 0 ? 1 : Math.min(St, ot + B);
            break;
          default:
            return;
        }
        R !== ot && ($.preventDefault(), $.stopPropagation(), p(wa(wt, n, R)), setTimeout(() => {
    ...
    const { isLetter: H, isDigit: Q } = so($.key);
    (H || Q) && ($.preventDefault(), b((wt) => wt + $.key), A.current.focus(), M(!1));
  }, []);
  return Pt(() => {
    const $ = setTimeout(() => {
      if (w && v === "books" && C.current && z.current) {
        const H = C.current, Q = z.current, wt = Q.offsetTop, ot = H.clientHeight, St = Q.clientHeight, R = wt - ot / 2 + St / 2;
        H.scrollTo({
          top: Math.max(0, R),
          behavior: "smooth"
        }), p(wa(t.book));
      ...
      Ne,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ee.map(({ onClick: $, disabled: H, title: Q, icon: wt }) => /* @__PURE__ */ a(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ a(
              L,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(Ii, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Pi, { className: "tw:h-4 tw:w-4" })
              }
            ),
            x && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(x, n) })
          ] }),
          !_ && /* @__PURE__ */ u(Ce, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(Z, { children: [
              !y && Object.entries(G).map(([$, H]) => {
                if (H.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ a(Yt, { heading: ge($), children: H.map((Q) => /* @__PURE__ */ a(
                      fn,
                      {
                        bookId: Q,
                        onSelect: (wt) => ft(wt),
              ...
              y && /* @__PURE__ */ a(Yt, { children: /* @__PURE__ */ a(
                de,
                {
                  ...
                  children: De(
                    ...
                    n ? Da(y.book, n) : void 0
                  )
                },
                "top-match"
              ) }),
              y && qt(y.book) > 1 && /* @__PURE__ */ u(Z, { children: [
...
function pa({
  ...
  const [N, _] = T(!1), M = d ?? c, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    ...
    /* @__PURE__ */ a(
      ue,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Or, { children: p }),
          /* @__PURE__ */ a(Ce, { children: V(e) ? e.map((C) => /* @__PURE__ */ a(Yt, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : /* @__PURE__ */ a(Yt, { children: e.map((C) => A(C)) }) })
        ] })
      }
    )
  ] });
...
const bn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Wl = bn ? Pt : K, gr = { tag: Na };
function Yl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = Hl(null, o), w = Go({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            ...
            (zt() !== null || b !== null && b === g.getRootElement()) && m.select();
          }
        }, gr);
...
const Xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : K;
...
function Ot({
  ...
  return /* @__PURE__ */ a(
    Le.Trigger,
    {
      ...
      className: e ? f(un({ variant: e }), t) : t,
      ...r
    }
  );
}
...
class Ql extends ms {
  ...
  componentDidUpdate(e, r) {
    ...
    if (o && r.error !== null && tc(e.resetKeys, n)) {
      var i, s;
...
function ec({ children: t, onError: e }) {
...
const rc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : K;
function ac(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function oc() {
  return function(t) {
    const [e] = Qt(), r = I(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = q(o);
    return rc(() => {
...
function ic(t, e, r = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !bs(e) && o !== null) {
    const [n, i] = o, s = t.isBackward(), l = n.getNode(), c = i.getNode(), d = e.is(l), w = e.is(c);
    if (d || w) {
      const [g, h] = xs(t), p = l.is(c), m = e.is(s ? c : l), b = e.is(s ? l : c);
      let v, k = 0;
      p ? (k = g > h ? h : g, v = g > h ? g : h) : m ? (k = s ? h : g, v = void 0) : b && (k = 0, v = s ? g : h);
      const x = e.__text.slice(k, v);
      x !== e.__text && (r === "clone" && (e = ys(e)), e.__text = x);
    }
  }
  return e;
}
...
const xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sc = xn && "documentMode" in document ? document.documentMode : null;
!(!xn || !("InputEvent" in window) || sc) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
const lc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function cc(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const l = document.createElement("div");
  function c() {
    o === null && Nr(182), n === null && Nr(183);
    const { left: g, top: h } = n.getBoundingClientRect(), p = nc(t, e);
    var m, b;
    l.isConnected || (b = l, (m = n).insertBefore(b, m.firstChild));
    let v = !1;
    for (let k = 0; k < p.length; k++) {
      const x = p[k], N = s[k] || document.createElement("div"), _ = N.style;
      _.position !== "absolute" && (_.position = "absolute", v = !0);
      const M = Gt(x.left - g);
      _.left !== M && (_.left = M, v = !0);
      const V = Gt(x.top - h);
      _.top !== V && (N.style.top = V, v = !0);
      const A = Gt(x.width);
      _.width !== A && (N.style.width = A, v = !0);
      const C = Gt(x.height);
      _.height !== C && (N.style.height = C, v = !0), N.parentNode !== l && (l.append(N), v = !0), s[k] = N;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (b !== o || v !== n) return g();
      for (const k of m) if (!l.contains(k.target)) return c();
    }), i.observe(p, lc), c();
  });
  return () => {
    w(), d();
...
function wc(t, e = dc) {
  ...
  function d(w) {
    w.read(() => {
      const g = zt();
      if (!Wt(g)) return r = null, n = null, i = null, l = null, c(), void (c = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, k = p.getNode(), x = k.getKey(), N = p.offset, _ = t.getElementByKey(b), M = t.getElementByKey(x), V = r === null || _ !== o || v !== n || b !== r.getKey(), A = i === null || M !== s || N !== l || x !== i.getKey();
      if ((V || A) && _ !== null && M !== null) {
        const C = function(z, E, O, D, F, P, G) {
          const y = (z._window ? z._window.document : document).createRange();
          return y.setStart(...co(E, O, D)), y.setEnd(...co(F, P, G)), y;
        }(t, h, m, _, p, k, M);
        c(), c = cc(t, C, e);
      }
      r = m, o = _, n = v, i = k, s = M, l = N;
    });
  }
...
function uc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = wc(t, e));
  };
...
function pc(t) {
  const e = Yo(t, (r) => ie(r) && !r.isInline());
  return ie(e) || Nr(4, t.__key), e;
}
function gc(t) {
  const e = zt() || ks();
  let r;
  if (Wt(e)) r = _s(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), l = s[s.length - 1];
      l && (r = Wo(l, "next"));
    }
    r = r || Ns(le(), "previous").getFlipped().insert(We());
  }
  const o = hc(t, r), n = Cs(o), i = Es(n) ? zs(n) : o;
  return Ts(Ss(i)), t.getLatest();
}
function hc(t, e, r) {
  let o = eo(e, "next");
  for (let n = o; n; n = Ds(n, r)) o = n;
  return Rs(o) && Nr(283), o.insert(t.isInline() ? We().append(t) : t), eo(Wo(t.getLatest(), "next"), e.direction);
}
function fc(t) {
  const e = zt();
  if (!Wt(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const l = Yo(i, (d) => ie(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
const mc = Symbol.for("preact-signals");
function Ar() {
  if (se > 1) return void se--;
  let t, e = !1;
  for (!function() {
    let r = Cr;
    for (Cr = void 0; r !== void 0; ) r.S.v === r.v && (r.S.i = r.i), r = r.o;
  }(); er !== void 0; ) {
    let r = er;
    for (er = void 0, Er++; r !== void 0; ) {
      const o = r.u;
...
let Cr, se = 0, Er = 0, bc = 0, ha = 0, br = 0;
function uo(t) {
  if (X === void 0) return;
  let e = t.n;
...
function Te(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = br - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function xc(t, e) {
  return new Te(t, e);
}
...
function yc(t) {
  ...
  kn(this), X = t, this.f &= -2, 8 & this.f && Oa(this), Ar();
}
function Pe(t, e) {
...
Nt.prototype.brand = mc, Nt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      se !== 0 && Er === 0 && e.l !== ha && (e.l = ha, Cr = { S: e, v: e.v, i: e.i, o: Cr });
    })(this), this.v = t, this.i++, br++, se++;
    try {
...
} }), Te.prototype = new Nt(), Te.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, _n(this), po(this), se++;
  const t = X;
  return X = this, yc.bind(this, t);
}, Pe.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = er, er = this);
}, Pe.prototype.d = function() {
  this.f |= 8, 1 & this.f || Oa(this);
}, Pe.prototype.dispose = function() {
  this.d();
};
Lt({ build: (t, e, r) => Xe(e), config: Oe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Nn() {
  const t = le(), e = zt(), r = We();
  t.clear(), t.append(r), e !== null && r.select(), Wt(e) && (e.format = 0);
}
function Cn(t, e = Nn) {
  return t.registerCommand(Jo, (r) => (t.update(e), !0), Ca);
}
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: Nn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Xt(() => Cn(t, o.value));
} });
function kc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Gr = Os("format", { parse: (t) => typeof t == "number" ? t : 0 });
class En extends sa {
  $config() {
...
Lt({ name: "@lexical/extension/DecoratorText", nodes: () => [En], register: (t, e, r) => t.registerCommand(Zo, (o) => {
  const n = zt();
  if (Qo(n) || Wt(n)) for (const i of n.getNodes()) _c(i) && i.toggleFormat(o);
  return !1;
}, tn) });
function zn(t, e) {
  let r;
...
const fa = Lt({ build: (t) => zn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Aa = 0, ma = 1, Sn = 2, qr = 3, hr = 4, Ie = 5, Hr = 6, Je = 7;
function Wr(t) {
  return t.id === Aa;
}
function Dn(t) {
...
function Nc(t) {
  return function(e) {
    return e.id === ma;
  }(t) || tt(305, String(t.id), String(ma)), Object.assign(t, { id: Sn });
}
...
class Ec {
  constructor(e, r) {
    ...
    _t(this, "configs");
    _t(this, "_dependency");
    _t(this, "_peerNameSet");
    _t(this, "extension");
    _t(this, "state");
    _t(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Aa };
  }
  mergeConfigs() {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== hr && tt(307, String(r.id), String(Ie)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= Je;
    }(e) || tt(316, String(e.id), String(Je)), e;
  }
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || Cc;
  }
  getPeerNameSet() {
...
const Tc = Lt({ config: Oe({ setOptions: go, updateOptions: go }), init: ({ $initialEditorState: t = zc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [As, Ho, Is, Ps, qo] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function fo() {
}
function Sc(t) {
  throw t;
...
class je {
  constructor(e) {
    _t(this, "roots");
    _t(this, "extensionNameMap");
    _t(this, "outgoingConfigEdges");
    _t(this, "incomingEdges");
    _t(this, "conflicts");
    _t(this, "_sortedExtensionReps");
    _t(this, "PACKAGE_VERSION");
  ...
  static maybeFromEditor(e) {
    const r = e[ho];
    return r && (r.PACKAGE_VERSION !== Yr && tt(292, r.PACKAGE_VERSION, Yr), r instanceof je || tt(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && tt(298, o.name), !n) {
      n = new Ec(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var l;
      Wr(i) || tt(300, s, n || "[unknown]"), Wr(l = i) || tt(304, String(l.id), String(Aa)), i = Object.assign(l, { id: ma }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = Sc), e;
  }
}
const Dc = /* @__PURE__ */ new Set(), mo = Lt({ build(t, e, r) {
  const o = r.getDependency(fa).output, n = ar({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = zn(() => {
  }, () => Xt(() => {
    const s = i.peek(), { watchedNodeKeys: l } = n.value;
    let c, d = !1;
    o.value.read(() => {
      if (zt()) for (const [w, g] of l.entries()) {
        if (g.size === 0) {
          l.delete(w);
          continue;
        }
  ...
  return { watchNodeKey: function(s) {
    const l = xc(() => (i.value || Dc).has(s)), { watchedNodeKeys: c } = n.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), n.value = { watchedNodeKeys: c }), l;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Rc = Vs("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
...
Lt({ dependencies: [fa, mo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(mo).output, n = ar({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ce(t.registerCommand(Rc, (s) => {
    const l = zt();
    if (!Wt(l)) return !1;
    ...
    return !0;
  }, Ca), t.registerCommand(js, (s) => {
    if (Fs(s.target)) {
      const l = Bs(s.target);
      if (Mc(l)) return function(c, d = !1) {
        const w = zt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Qo(w) ? p = w : (p = Us(), Ks(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, tn), t.registerMutationListener(Fe, (s, l) => {
    vc(() => {
      let c = !1;
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: c } of n.value.nodeSelections.values()) s.push(Xt(() => {
      const d = l.value;
      d && (c.value ? en(d, i) : Js(d, i));
    }));
    return ce(...s);
  }));
} });
Lt({ build: (t, e) => Xe({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Oe({ $getParentEditor: function() {
  const t = Gs();
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Xt(() => {
...
function Oc(t, e, r = Rn) {
  return ce(t.registerCommand(Zs, (o) => {
    const n = zt();
    if (!Wt(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => kr(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), g = pc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Qs();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = tl(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? el : ao : rl;
    return t.dispatchCommand(i, void 0);
  }, Ca), t.registerCommand(ao, () => {
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: Rn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Xt(() => {
    if (!o.value) return Oc(t, n, i);
  });
} });
const Ac = Lt({ name: "@lexical/react/ReactProvider" });
function Ic() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (Wt(m)) {
                const b = m.anchor;
                let v = b.getNode(), k = 0, x = 0;
                if (_r(v) && d >= 0 && w >= 0 && (k = d, x = d + w, m.setTextNodeRange(v, k, v, x)), k === x && g === "" || (m.insertRawText(g), v = b.getNode()), _r(v)) {
                  k = h, x = h + p;
                  const N = v.getTextContentSize();
                  k = k > N ? N : k, x = x > N ? N : x, m.setTextNodeRange(v, k, v, x);
                }
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Xt(() => r.getOutput().disabled.value ? void 0 : Mn(t)) });
function Vc(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Pa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : K;
  ...
  return function(r, o) {
    ...
    return Pa(() => r.registerDecoratorListener((s) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = a(o, { onError: (h) => r._onError(h), children: a(vs, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(pl(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Fc({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    ...
    if (o && o.hasExtensionByName(Ac.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Vc(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(jc, { editor: t, ErrorBoundary: e });
}
function vo(t) {
  return t.getEditorState().read($n(t.isComposing()));
}
function Bc({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Qt();
  return function(n) {
    Pa(() => ce(wl(n), Mn(n)), [n]);
  }(o), u(Z, { children: [t, a(Uc, { content: e }), a(Fc, { editor: o, ErrorBoundary: r })] });
}
function Uc({ content: t }) {
  const [e] = Qt(), r = function(n) {
    ...
    return Pa(() => {
      ...
      return l(), ce(n.registerUpdateListener(() => {
        l();
...
const Gc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : K;
function qc({ onClear: t }) {
  const [e] = Qt();
  return Gc(() => Cn(e, t), [e, t]), null;
}
const On = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Pt : K;
function Hc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: k = !0, style: x, tabIndex: N, "data-testid": _, ...M }, V) {
  const [A, C] = T(t.isEditable()), z = j((O) => {
    O && O.ownerDocument && O.ownerDocument.defaultView ? t.setRootElement(O) : t.setRootElement(null);
  }, [t]), E = I(() => /* @__PURE__ */ function(...O) {
    return (D) => {
      for (const F of O) typeof F == "function" ? F(D) : F != null && (F.current = D);
    };
  }(V, z), [z, V]);
  return On(() => (C(t.isEditable()), t.registerEditableListener((O) => {
    C(O);
  })), [t]), a("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? r : "none", "aria-controls": A ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? g : void 0, "aria-readonly": !A || void 0, "aria-required": h, autoCapitalize: p, className: m, contentEditable: A, "data-testid": _, id: b, ref: E, role: v, spellCheck: k, style: x, tabIndex: N, ...M });
}
const Wc = ir(Hc);
function bo(t) {
  return t.getEditorState().read($n(t.isComposing()));
...
function Xc(t, e) {
  ...
  return u(Z, { children: [a(Wc, { editor: n, ...o, ref: e }), r != null && a(Jc, { editor: n, content: r })] });
}
function Jc({ content: t, editor: e }) {
  const r = function(s) {
    const [l, c] = T(() => bo(s));
    return On(() => {
      function d() {
  ...
  if (Pt(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function td() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Rl, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ol, { children: [
...
function ed({
  ...
  const [e] = Qt(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = td(), c = () => {
  };
...
function od() {
  const { activeEditor: t } = In(), [e, r] = T([]), o = j((n) => {
    if (Wt(n) || gl(n)) {
      const i = [];
      xo.forEach(({ format: s }) => {
...
function id({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(ed, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(od, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Bc,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Zc, { placeholder: t }) }),
          ErrorBoundary: ec
        }
      ),
      e && /* @__PURE__ */ a(Kc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(nd, { onClear: r }),
      /* @__PURE__ */ a(qc, {})
    ] })
  ] });
}
...
function ld(t, e) {
  const r = il(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function Vn(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && _r(e) && (s = ic(o, e, "clone"));
  const l = ie(s) ? s.getChildren() : [], c = nl(t, s.getType());
  let d;
  ...
  for (let p = 0; p < l.length; p++) {
    ...
    !n && ie(e) && b && e.extractWithChild(m, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((Xo(w) || oo(w)) && w.append(h), r.append(w), g) {
      const p = g.call(s, w);
...
function Fn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  const c = function(m, b) {
    const { nodeName: v } = m, k = b._htmlConversions.get(v.toLowerCase());
    let x = null;
    if (k !== void 0) for (const N of k) {
      const _ = N(m);
  ...
  let h = [];
  const p = (l == null || !sl(l)) && (l != null && kr(l) || o);
  for (let m = 0; m < g.length; m++) h.push(...Fn(g[m], e, r, p, new Map(n), l));
  return w != null && (h = w(h)), no(t) && (h = dd(t, h, p ? () => {
    const m = new an();
    return r.push(m), m;
  } : We)), l == null ? h.length > 0 ? s = s.concat(h) : no(t) && function(m) {
    return m.nextSibling == null || m.previousSibling == null ? !1 : io(m.nextSibling) && io(m.previousSibling);
  }(t) && (s = s.concat(on())) : ie(l) && l.append(...h), s;
}
function dd(t, e, r) {
...
function wd(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = ld(e, n);
      le().clear(), ll(i);
    },
    {
      discrete: !0
...
function qn({
  ...
  const s = yo(o, "%cancelButton_tooltip%"), l = i ?? yo(o, "%acceptButton_tooltip%");
  return /* @__PURE__ */ u(Va, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
    ...
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: l }) })
    ] }) })
  ] });
}
function yr(t, e) {
...
function Uu({
  ...
  const [i, s] = T(pd), [l, c] = T(n), [d, w] = T(!1), g = q(void 0), h = q(null);
  K(() => {
    let v = !0;
    const k = h.current;
    if (!k) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : ja(v) && (v.preventDefault(), v.stopPropagation(), It(i) && p());
        },
        onKeyDown: (v) => {
...
], gd = ["input", "select", "textarea", "button"], hd = ["button", "textbox"], fd = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
}) => {
  const n = q(null), [i, s] = T(void 0), [l, c] = T(void 0), d = j(
    (p) => {
      s(p);
    ...
    if (p.isContentEditable || gd.includes(m)) return !0;
    const b = p.getAttribute("role");
    if (b && hd.includes(b)) return !0;
    const v = p.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = j(
    (p) => {
      var A;
      const m = p.target, b = (C) => C ? document.getElementById(C) : void 0, v = b(l), k = b(i);
      ...
      const _ = t.findIndex((C) => C.id === i);
      let M = _;
      switch (p.key) {
        case "ArrowDown":
          M = Math.min(_ + 1, t.length - 1), p.preventDefault();
          break;
        case "ArrowUp":
          M = Math.max(_ - 1, 0), p.preventDefault();
          break;
        case "Home":
          M = 0, p.preventDefault();
          break;
        case "End":
          M = t.length - 1, p.preventDefault();
          break;
        case " ":
        case "Enter":
...
function be({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ a(Fa.Provider, { value: o, children: /* @__PURE__ */ a(vt.Root, { "data-slot": "dropdown-menu", dir: r, ...e }) });
}
function kd({
  ...t
}) {
...
function zd({ className: t, children: e, ...r }) {
  const o = lt();
  return /* @__PURE__ */ a(
    vt.SubContent,
    {
...
function ko({
  ...
  }, [t.date, r]), v = I(() => t.user, [t.user]), k = I(
    () => t.user.split(" ").map((_) => _[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), x = I(() => Di(t.contents), [t.contents]), N = I(() => {
    if (o && l)
      return /* @__PURE__ */ u(Z, { children: [
        /* @__PURE__ */ u(
          va,
          {
            onClick: (_) => {
              _.stopPropagation(), d(!0), g(wd(t.contents)), s == null || s(!0);
            },
            children: [
              /* @__PURE__ */ a(ji, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(xd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(yd, { className: "tw:text-xs tw:font-medium", children: k }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (_) => {
                _.key === "Escape" ? (_.preventDefault(), _.stopPropagation(), p()) : ja(_) && (_.preventDefault(), _.stopPropagation(), It(w) && m());
              },
              onKeyDown: (_) => {
                La(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
              },
              onClick: (_) => {
                _.stopPropagation();
              },
        ...
        N && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Bi, {}) }) }),
...
function Td({
  ...
  const [C, z] = T(_o), [E, O] = T(), [D, F] = T(), P = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, te] = T(!1), [ee, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(_), [Et, ge] = T(!1), xt = q(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
    ...
    let S = !0;
    if (!o) {
      Tt(!1), re(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const ht = k ? await k(c) : !1;
      S && Tt(ht);
    })(), () => {
      S = !1;
    };
  ...
  K(() => {
    if (!o) {
      yt.current !== "idle" && (O(void 0), F(void 0), yt.current = "idle");
      return;
    }
    yt.current === "idle" && (yt.current = "pending"), ee ? yt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== i && (O(A), yt.current = "auto-populated") : yt.current === "auto-populated" && (O(void 0), yt.current = "pending");
  }, [o, A, ee, i]);
  const Vt = I(() => e.filter((S) => !S.deleted), [e]);
  K(() => {
    let S = !0;
    if (!o || !N) {
      re(/* @__PURE__ */ new Map());
  ...
  const ae = I(() => Vt[0], [Vt]), $ = q(null), H = q(void 0), Q = j(() => {
    var S;
    (S = H.current) == null || S.call(H), z(_o);
  }, []), wt = j(() => {
    const S = !at;
    dt(S), ge(!S), m == null || m(c, S);
  }, [at, m, c]);
  K(() => {
    y(!1);
  }, [o]), K(() => {
  ...
  }, [i, r]), R = I(() => Vt.slice(1), [Vt]), B = I(() => R.length ?? 0, [R.length]), rt = I(() => B > 0, [B]), st = I(() => G || B <= 2 ? R : R.slice(-2), [R, B, G]), ut = I(() => G || B <= 2 ? 0 : B - 2, [B, G]), kt = I(
    () => B === 1 ? ot.singleReply : oe(ot.multipleReplies, { count: B }),
    [B, ot]
  ), Dt = I(
    () => ut === 1 ? ot.singleReply : oe(ot.multipleReplies, { count: ut }),
    [ut, ot]
  );
  K(() => {
    !o && Y && rt && ft(!1);
  ...
  const mt = j(
    async (S) => {
      ...
      gt && await g({ threadId: c, contents: gt }) && Q();
    },
    [
      Q,
      C,
    ...
    async (S) => {
      const gt = It(C) ? Tr(C) : void 0, ht = S.status ? S.assignedUser : E ?? S.assignedUser, jt = await g({
        ...S,
        contents: gt,
        assignedUser: ht
      });
      return jt && (ht !== void 0 && F(ht), gt && Q()), jt;
    },
    [Q, C, g, E]
  );
  if (Vt.length !== 0)
        ...
        children: /* @__PURE__ */ u(bd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              St && /* @__PURE__ */ a(Ue, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: St }),
              /* @__PURE__ */ a(
                L,
                {
                  variant: "ghost",
            ...
            /* @__PURE__ */ a(
              ko,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: ft,
                canEditOrDelete: (!Y && he.get(ae.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(Z, { children: [
              ...
              st.map((S) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                ko,
                {
                  ...
                  handleDeleteComment: p,
                  onEditingChange: ft,
                  canEditOrDelete: (!Y && he.get(S.id)) ?? !1
                }
              ) }, S.id)),
              v !== !1 && (!Y || It(C)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (S) => {
                    ja(S) && (S.preventDefault(), S.stopPropagation(), (It(C) || E !== void 0 && E !== D) && mt());
                  },
                  onKeyDown: (S) => {
                    La(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ a(
                      zr,
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (It(C) || E !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: oe(
                      ...
                      /* @__PURE__ */ u(we, { open: nt, onOpenChange: te, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          L,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !ee || !b || b.length === 0 || !b.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          ue,
                          {
                            ...
                            align: "end",
                            onKeyDown: (S) => {
                              S.key === "Escape" && (S.stopPropagation(), te(!1));
                            },
                            children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                              de,
                              {
                                onSelect: () => {
                                  O(S !== i ? S : void 0), yt.current = "user-selected", F(void 0), te(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function Zu({
  ...
  const [k, x] = T(/* @__PURE__ */ new Set()), [N, _] = T(), [M, V] = T(), A = j(
    async (y) => {
      const Y = await i(y);
      return Y !== void 0 && y.assignedUser !== void 0 && y.assignedUser !== "" && V(y.assignedUser), Y;
    },
    [i]
  );
  K(() => {
  ...
  const C = r.filter(
    (y) => y.comments.some((Y) => !Y.deleted)
  ), z = C.map((y) => ({ id: y.id })), E = j(
    (y) => {
      x((Y) => new Set(Y).add(y.id)), _(y.id), b == null || b(y.id);
    },
    [b]
  ), O = j(
    (y) => {
      ...
      }), _(y), b == null || b(Y ? void 0 : y);
    },
    [k, b]
  ), { listboxRef: D, activeId: F, handleKeyDown: P } = fd({
    options: z,
    onOptionSelect: E
  }), G = j(
    (y) => {
      y.key === "Escape" ? (N && k.has(N) && (x((Y) => {
        const ft = new Set(Y);
        return ft.delete(N), ft;
      }), _(void 0), b == null || b(void 0)), y.preventDefault(), y.stopPropagation()) : P(y);
    },
    [N, k, P, b]
  );
  return /* @__PURE__ */ a(
...
function Sd({ table: t }) {
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(L, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Ke({ ...t }) {
  return /* @__PURE__ */ a(Ct.Root, { "data-slot": "select", ...t });
}
...
function Ge({ ...t }) {
  return /* @__PURE__ */ a(Ct.Value, { "data-slot": "select-value", ...t });
}
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ct.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ct.Icon, { asChild: !0, children: /* @__PURE__ */ a(xi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
function He({
  ...
  const i = lt();
  return /* @__PURE__ */ a(Ct.Portal, { children: /* @__PURE__ */ u(
    Ct.Content,
    {
...
function Ft({
  ...
  return /* @__PURE__ */ u(
    Ct.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ct.ItemIndicator, { children: /* @__PURE__ */ a(Me, { className: "tw:pointer-events-none" }) }) }),
        /* @__PURE__ */ a(Ct.ItemText, { children: e })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ u(
        Ke,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(He, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(Ft, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  const l = et.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Pd(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Id(l, b, w.key);
...
function Ld({
  ...
  var V;
  const [w, g] = T([]), [h, p] = T([]), [m, b] = T({}), [v, k] = T({}), x = I(() => e ?? [], [e]), N = sn({
    data: x,
    columns: t,
    getCoreRowModel: cn(),
  ...
  let M;
  return c ? M = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = N.getRowModel().rows) == null ? void 0 : V.length) > 0 ? M = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ne,
    {
      onClick: () => s(A, N),
    ...
    A.id
  )) : M = /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Sd, { table: N }),
    /* @__PURE__ */ u(Pr, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ba, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(ne, { children: A.headers.map((C) => /* @__PURE__ */ a(Sr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : tr(C.column.columnDef.header, C.getContext()) }, C.id)) }, A.id)) }),
      /* @__PURE__ */ a(Lr, { children: M })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Vo, {}) })
        ] }),
...
var Fd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Fd || {});
function ip({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ u(L, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(Z, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        me,
        {
          checked: o[w][h],
        ...
        _d,
        {
          ...
          children: d.items.map((g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Nd, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ a(cr, {})
    ] }, d.label)) })
...
function Bd({ id: t, versionHistory: e }) {
...
function lp({
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(Bd, { versionHistory: n }),
...
function Wn({
  ...
  const [k, x] = T(!1), N = j(
    (E) => {
      var D;
      const O = (D = t.find((F) => F.label === E)) == null ? void 0 : D.value;
      O && r(
    ...
    if (!h) return t;
    const E = t.filter((D) => D.starred).sort((D, F) => D.label.localeCompare(F.label)), O = t.filter((D) => !D.starred).sort((D, F) => {
      const P = e.includes(D.value), G = e.includes(F.value);
      return P && !G ? -1 : !P && G ? 1 : D.label.localeCompare(F.label);
    });
    return [...E, ...O];
  }, [t, e, h]), V = () => {
    r(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(we, { open: C, onOpenChange: w ?? x, children: [
    /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ u(
      L,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(jo, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(L, { variant: "ghost", size: "sm", onClick: V, children: i }),
        /* @__PURE__ */ a(L, { variant: "ghost", size: "sm", onClick: A, children: s })
      ] }),
      /* @__PURE__ */ u(Ce, { children: [
        /* @__PURE__ */ a(Or, { children: l }),
        /* @__PURE__ */ a(Yt, { children: M.map((E) => /* @__PURE__ */ u(
          de,
          {
            value: E.label,
            onSelect: N,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ a(es, { className: "tw:h-4 tw:w-4" }),
...
function Kd({
  ...
  const c = I(() => /Macintosh/i.test(navigator.userAgent), []), d = zo(n, "%undoButton_tooltip%"), w = zo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Va, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        L,
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(Z, { children: [
          " ",
          /* @__PURE__ */ a(Eo, { children: c ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (l === "secondary" || l === "default") && /* @__PURE__ */ a(Kn, {}),
    e && /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        L,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(Z, { children: [
          " ",
          /* @__PURE__ */ a(Eo, { children: c ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const qd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(Z, { children: [
...
function Hd({
  ...
  const i = q(null), s = q(null), l = q(!1), [c, d] = T(t), [w, g] = T(r), [h, p] = T(!1);
  K(() => {
    d(t);
  }, [t]), K(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var k, x, N, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((k = i.current) == null || k.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((x = s.current) == null || x.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: qd(t, n, r) }) }) }),
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            me,
            {
              ...
              onClick: (v) => {
                var k;
                v.stopPropagation(), l.current = !0, (k = i.current) == null || k.focus();
              },
...
const Wd = (t, e) => t === "f" ? /* @__PURE__ */ u(Z, { children: [
  /* @__PURE__ */ a(Bo, {}),
  " ",
...
function Xd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(L, { variant: "outline", className: "tw:h-6", children: Wd(t, r) }) }) }),
      /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: Yd(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ye, { style: { zIndex: dn }, children: [
...
function Zd({ icon: t, className: e }) {
...
function To({
  ...
  return /* @__PURE__ */ u(
    de,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Zd, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Ll, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Qd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = T(""), [i, s] = I(() => {
  ...
  return /* @__PURE__ */ u(Ne, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ce, { children: [
      /* @__PURE__ */ a(Or, { children: t["%markerMenu_noResults%"] }),
      /* @__PURE__ */ a(Yt, { children: i.map((l) => {
        var c;
        return /* @__PURE__ */ a(
          To,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(Z, { children: [
        ...
        /* @__PURE__ */ a(Yt, { children: s.map((l) => {
          var c;
          return /* @__PURE__ */ a(
            To,
            {
...
function dp({
  ...
  const [m, b] = T("generated"), [v, k] = T("generated"), [x, N] = T("*"), [_, M] = T("*"), [V, A] = T("f"), [C, z] = T(!1), [E, O] = T(!0), [D, F] = T(!1), P = q(!1), G = q(""), [y, Y] = T(!1), [ft, nt] = T(), [te, ee] = T(), [Tt, U] = T(), [it, at] = T(), dt = q(null), Et = I(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (B && pr("note", B)) {
      const ut = (rt = B.insert.note) == null ? void 0 : rt.caller;
      let kt = "custom";
      ut === la ? kt = "generated" : ut === ca ? kt = "hidden" : ut && (N(ut), M(ut)), b(kt), k(kt), A(((st = B.insert.note) == null ? void 0 : st.style) ?? "f"), R = setTimeout(() => {
        var Dt;
  ...
  const xt = j(
    (R, B, rt = !1) => {
      var ut, kt, Dt;
      const st = (kt = (ut = w.current) == null ? void 0 : ut.getNoteOps(0)) == null ? void 0 : kt.at(0);
      if (st && pr("note", st)) {
        if (st.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = la : mt = ca, st.insert.note.caller = mt;
        }
        r == null || r([st]), rt && d && i && ((Dt = d.current) == null || Dt.replaceEmbedUpdate(i, [st]));
      }
    },
    [i, r, d]
  ), he = j(() => {
  ...
  const yt = q({ book: n.book, chapterNum: n.chapterNum });
  Pt(() => {
    (yt.current.book !== n.book || yt.current.chapterNum !== n.chapterNum) && (yt.current = { book: n.book, chapterNum: n.chapterNum }, re.current());
  }, [n.book, n.chapterNum]);
  const Vt = () => {
    var B;
    ...
    var rt, st, ut, kt, Dt;
    A(R);
    const B = (st = (rt = w.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : st.at(0);
    if (B && pr("note", B)) {
      B.insert.note && (B.insert.note.style = R);
      const mt = (kt = (ut = B.insert.note) == null ? void 0 : ut.contents) == null ? void 0 : kt.ops;
      V !== "x" && R === "x" ? mt == null || mt.forEach((Rt) => ew(Rt)) : V === "x" && R !== "x" && (mt == null || mt.forEach((Rt) => rw(Rt))), (Dt = w.current) == null || Dt.applyUpdate([B, { delete: 1 }]);
    }
  }, Q = (R) => {
    at(R.contextMarker), F(R.canRedo);
  }, wt = j(
    (R) => {
      var rt, st, ut, kt, Dt;
      const B = (st = (rt = w.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : st.at(0);
      if (B && pr("note", B)) {
        ...
        const mt = (ut = B.insert.note) == null ? void 0 : ut.style, Rt = (Dt = (kt = B.insert.note) == null ? void 0 : kt.contents) == null ? void 0 : Dt.ops;
        if (mt || z(!1), z(
          mt === "x" ? !!(Rt != null && Rt.every((S) => {
            var ht, jt;
            if (!((ht = S.attributes) != null && ht.char)) return !0;
            const gt = ((jt = S.attributes) == null ? void 0 : jt.char).style;
        ...
        O(JSON.stringify(B) === G.current), xt(m, x);
      } else
        z(!1), O(!0);
    },
    [m, x, xt]
    ...
    if (h.current && ge.length && R && R.rangeCount > 0) {
      ...
      nt(B.left - rt.left), ee(B.top - rt.top), U(B.height), Y(!0);
    }
  }, [ge, h]);
  K(() => {
    const R = () => {
    ...
    var R;
    y && ((R = dt.current) == null || R.focus());
  }, [y]), K(() => {
    var rt;
    const R = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, B = (st) => {
      !y && R && document.activeElement === R && st.key === l ? (st.preventDefault(), ot()) : y && st.key === "Escape" && (st.preventDefault(), Y(!1));
    };
    return document.addEventListener("keydown", B), () => {
      document.removeEventListener("keydown", B);
    };
  }, [y, ot, l]);
  const St = c["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(Z, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
                L,
                {
                  "aria-label": St,
              ...
              /* @__PURE__ */ a(At, { children: /* @__PURE__ */ a("p", { children: St }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(Z, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ a(Z, { children: ow(t.marker, l, o, d) })
      }
    )
  ] });
}
function up({
  ...
  return K(() => {
    var x;
    p >= 0 && p < k.current.length && ((x = k.current[p]) == null || x.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function lw({
  ...
  return /* @__PURE__ */ u(Pr, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ba, { stickyHeader: !0, children: /* @__PURE__ */ u(ne, { children: [
      /* @__PURE__ */ a(Sr, { children: n }),
      /* @__PURE__ */ a(Sr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Lr, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ u(
      ne,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(ve, { className: o, children: sw(l.text) })
        ]
      },
...
const cw = (t) => {
...
}, Vr = (t, e, r) => /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
  ...
  return e ? e[1] : "";
}, ww = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", bp = Object.freeze([
...
function xp({
  ...
  const p = Ut(r, "%webView_inventory_all%"), m = Ut(r, "%webView_inventory_approved%"), b = Ut(r, "%webView_inventory_unapproved%"), v = Ut(r, "%webView_inventory_unknown%"), k = Ut(r, "%webView_inventory_scope_currentBook%"), x = Ut(r, "%webView_inventory_scope_chapter%"), N = Ut(r, "%webView_inventory_scope_verse%"), _ = Ut(r, "%webView_inventory_filter_text%"), M = Ut(
    r,
    "%webView_inventory_show_additional_items%"
  ), V = Ut(r, "%webView_inventory_no_results%"), [A, C] = T(!1), [z, E] = T("all"), [O, D] = T(""), [F, P] = T([]), G = I(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : pw(U, n, i);
  }, [t, n, i]), y = I(() => {
    if (A) return G;
    const U = [];
    return G.forEach((it) => {
      const at = it.items[0], dt = U.find(
        (Et) => Et.items[0] === at
      );
      dt ? (dt.count += it.count, dt.occurrences = dt.occurrences.concat(it.occurrences)) : U.push({
        items: [at],
        count: it.count,
  ...
  }, [A, G]), Y = I(() => y.length === 0 ? [] : uw(y, z, O), [y, z, O]), ft = I(() => {
    var at, dt;
    if (!A) return c;
    ...
    for (let Et = 0; Et < U; Et++)
      it.push(
        dw(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[Et]) || "Additional Item",
          Et + 1
        )
      );
    return [...it, ...c];
  ...
  K(() => {
    Y.length === 0 ? P([]) : Y.length === 1 && P(Y[0].items);
  }, [Y]);
  const nt = (U, it) => {
    it.setRowSelection(() => {
      const dt = {};
    ...
    if (y.length === 0 || F.length === 0) return [];
    const U = y.filter((it) => Ai(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        Ke,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(He, { children: [
              /* @__PURE__ */ a(Ft, { value: "all", children: p }),
              /* @__PURE__ */ a(Ft, { value: "approved", children: m }),
              /* @__PURE__ */ a(Ft, { value: "unapproved", children: b }),
              /* @__PURE__ */ a(Ft, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => te(U), defaultValue: s, children: [
        /* @__PURE__ */ a(qe, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Ge, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(He, { children: [
          /* @__PURE__ */ a(Ft, { value: "book", children: k }),
          /* @__PURE__ */ a(Ft, { value: "chapter", children: x }),
          /* @__PURE__ */ a(Ft, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        sr,
      ...
      o && /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
        /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(pt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? M })
        ] }) }),
        /* @__PURE__ */ a(At, { children: (o == null ? void 0 : o.checkboxText) ?? M })
      ] }) })
    ] }),
...
const Ka = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(ws, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function So(t, e) {
  ...
  return t.fullName.toLowerCase().includes(r) || t.shortName.toLowerCase().includes(r) || (((o = t.language) == null ? void 0 : o.toLowerCase().includes(r)) ?? !1);
}
function Do({
  label: t,
  projects: e,
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(Z, { children: [
      /* @__PURE__ */ a("div", { className: "tw:col-start-2 tw:col-span-2 tw:pb-1 tw:pt-3 tw:first:pt-0", children: /* @__PURE__ */ a(pt, { className: "tw:text-xs tw:uppercase tw:tracking-wider tw:text-muted-foreground", children: t }) }),
      e.map((n) => /* @__PURE__ */ u(
        "div",
        {
          role: "option",
          ...
          onClick: () => o(n.id),
          onKeyDown: (i) => {
            (i.key === "Enter" || i.key === " ") && (i.preventDefault(), o(n.id));
          },
          children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-end tw:gap-1 tw:pr-2 tw:text-sm tw:font-medium", children: [
              n.id === r && /* @__PURE__ */ a(us, { className: "tw:h-3 tw:w-3 tw:shrink-0", "aria-label": "current project" }),
              n.shortName
            ] }),
            /* @__PURE__ */ a("div", { className: "tw:px-3 tw:text-sm", children: n.fullName }),
            /* @__PURE__ */ a("div", { className: "tw:text-right tw:text-sm tw:text-muted-foreground", children: n.language && (n.languageDisplayName ? /* @__PURE__ */ a($t, { children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:cursor-default", children: n.language }) }),
              /* @__PURE__ */ a(At, { style: { zIndex: wn + 50 }, children: n.languageDisplayName })
            ] }) }) : n.language) })
          ]
        },
        n.id
...
function kp({
  ...
  const [s, l] = T(""), c = I(
    ...
    () => r.filter((k) => So(k, s)),
    [r, s]
  ), w = I(() => !t || !c.some((x) => x.id === t.id) ? c : [t, ...c.filter((x) => x.id !== t.id)], [c, t]), g = w.length === 0 && d.length === 0, h = i["%projectPicker_title%"] ?? "%projectPicker_title%", p = i["%projectPicker_section_recent%"] ?? "Recent", m = i["%projectPicker_section_projects%"] ?? "Your projects", b = i["%projectPicker_search_placeholder%"] ?? "Search projects...", v = i["%projectPicker_no_results%"] ?? "No projects found";
  return /* @__PURE__ */ u(Z, { children: [
    /* @__PURE__ */ a(Ta, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Sa, { children: h }) }),
    /* @__PURE__ */ a("div", { className: "tw:p-4", children: /* @__PURE__ */ a(
      dr,
      {
        value: s,
        onSearch: l,
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      o && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Ka, {}) }),
      !o && g && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: v }),
      !o && !g && /* Single shared grid so column widths (short name, full name, language) are consistent
...
function Zr({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(Z, { children: [
      /* @__PURE__ */ a(pt, { className: "tw:text-xs tw:uppercase tw:tracking-wider tw:text-muted-foreground", children: t }),
      /* @__PURE__ */ a(Pr, { children: /* @__PURE__ */ a(Lr, { children: e.map((n) => /* @__PURE__ */ u(ne, { children: [
        ...
        o && r && /* @__PURE__ */ a(ve, { className: "tw:border-0 tw:text-right", children: /* @__PURE__ */ a(L, { variant: "outline", onClick: () => o(n), children: r }) })
      ] }, n.dblEntryUid)) }) })
    ] });
}
function hw(t, e) {
...
function Np({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = I(
    () => t.filter((P) => !r || P.type === r).filter((P) => hw(P, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = gw(p), k = I(
    () => Array.from(new Set(t.map((P) => P.bestLanguageName))).map((P) => ({
      label: P,
      value: P
    })),
    [t]
  ), x = g.length === 0 && h.length === 0 && p.length === 0, N = Kt(n, "%resourcePicker_title%"), _ = Kt(n, "%resourcePicker_search_placeholder%"), M = Kt(n, "%resourcePicker_language_filter_any%"), V = Kt(
    n,
    "%resourcePicker_section_already_selected%"
  ), A = Kt(n, "%resourcePicker_section_installed%"), C = Kt(
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = Kt(n, "%resourcePicker_button_use%"), E = Kt(n, "%resourcePicker_no_results%"), O = Kt(n, "%resourcePicker_showing_count%"), D = I(() => {
    if (c.length === k.length || c.length === 0)
      return M;
    if (c.length === 1) {
      const P = k.find((G) => G.value === c[0]);
      if (P) return P.label;
    }
    return oe(
      Kt(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
        selectCount: c.length
      }
    );
  }, [c, k, M, n]), F = s.length > 0 || c.length > 0;
  return /* @__PURE__ */ u(Z, { children: [
    /* @__PURE__ */ a(Ta, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(Sa, { children: N }) }),
    ...
    F && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: oe(O, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      x && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: E }),
      e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center", children: /* @__PURE__ */ a(Ka, {}) }),
      !x && !e && /* @__PURE__ */ u(Z, { children: [
        /* @__PURE__ */ a(Zr, { label: V, resources: g }),
        /* @__PURE__ */ a(
          Zr,
          {
            label: A,
...
const fw = "16rem", mw = "3rem", Jn = et.createContext(void 0);
function jr() {
  const t = et.useContext(Jn);
  if (!t)
...
function vw({
  ...
  const [c, d] = et.useState(t), w = e ?? c, g = et.useCallback(
    ...
    [r, w]
  ), h = et.useCallback(() => g((N) => !N), [g]), p = w ? "expanded" : "collapsed", v = lt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", k = et.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return /* @__PURE__ */ a(Jn.Provider, { value: k, children: /* @__PURE__ */ a(
    "div",
    {
    ...
    bw,
    {
      ...
      children: /* @__PURE__ */ u(yw, { children: [
        /* @__PURE__ */ u(Ro, { children: [
          /* @__PURE__ */ a($o, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(Mo, { children: /* @__PURE__ */ a(kw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(_w, { children: /* @__PURE__ */ a(
            Cw,
            {
              onClick: () => d(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(Ro, { children: [
          /* @__PURE__ */ a($o, { className: "tw:text-sm", children: s }),
...
const fe = "scrBook", zw = "scrRef", Se = "source", Tw = "details", Sw = "Scripture Reference", Dw = "Scripture Book", Zn = "Type", Rw = "Details";
function $w(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ct.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === fe ? De(n.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Se,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Zn : void 0,
...
}, Oo = (t) => `${Mw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Vp({
  sources: t,
  ...
  const [d, w] = T([]), [g, h] = T([{ id: fe, desc: !1 }]), [p, m] = T({}), b = I(
  ...
  K(() => {
    if (l) {
      const z = k.getSelectedRowModel().rowsById, E = Object.keys(z);
      if (E.length === 1) {
        const O = b.find((D) => Oo(D) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [p, b, l, k]);
  const x = n ?? Dw, N = i ?? Zn, _ = [
  ...
  }, A = (z, E) => z.getIsGrouped() ? "" : f("banded-row", E % 2 === 0 ? "even" : "odd"), C = (z, E, O) => {
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(Dd, { children: _.map((z) => /* @__PURE__ */ a(Ft, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Pr, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ba, { children: k.getHeaderGroups().map((z) => /* @__PURE__ */ a(ne, { children: z.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Sr, { colSpan: E.colSpan, className: "tw:sticky top-0", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Lr, { children: k.getRowModel().rows.map((z, E) => {
        const O = lt();
        return /* @__PURE__ */ a(
          ne,
          {
            ...
            children: z.getVisibleCells().map((D) => {
              if (!(D.getIsPlaceholder() || D.column.columnDef.enableGrouping && !D.getIsGrouped() && (D.column.columnDef.id !== Se || !r)))
                return /* @__PURE__ */ a(
                  ve,
                  {
                    className: f(
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ u(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ a(na, {}) : /* @__PURE__ */ a(oa, {})),
                          " ",
                          tr(D.column.columnDef.cell, D.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function Qn(t) {
  ...
  return ct.allBookIds.filter(
    (e, r) => t[r] === "1" && !ct.isObsolete(ct.bookIdToNumber(e))
  );
}
function Ga(t, e) {
  return t.filter((r) => {
...
const ti = (t, e, r) => Ga(t, e).every((o) => r.includes(o));
function Ow({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: g, ntLong: h, dcLong: p, extraLong: m } = {
  ...
  }, [b, v] = T(!1), [k, x] = T(""), N = q(void 0), _ = q(!1), M = I(
    () => Qn(t),
    [t]
  ), V = I(() => {
    if (!k.trim()) {
    ...
    (D, F = !1) => {
      if (!F || !N.current) {
        r(
          e.includes(D) ? e.filter((nt) => nt !== D) : [...e, D]
        ), N.current = D;
        return;
      }
      const P = M.findIndex((nt) => nt === N.current), G = M.findIndex((nt) => nt === D);
      if (P === -1 || G === -1) return;
      const [y, Y] = [
        Math.min(P, G),
        Math.max(P, G)
      ], ft = M.slice(y, Y + 1).map((nt) => nt);
      r(
        e.includes(D) ? e.filter((nt) => !ft.includes(nt)) : [.../* @__PURE__ */ new Set([...e, ...ft])]
      );
    },
    [e, r, M]
  ), C = (D) => {
    A(D, _.current), _.current = !1;
  }, z = (D, F) => {
    D.preventDefault(), A(F, D.shiftKey);
  }, E = () => {
    r(M.map((D) => D));
  }, O = () => {
    r([]);
          ...
          Ne,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(L, { variant: "ghost", size: "sm", onClick: E, children: c }),
                /* @__PURE__ */ a(L, { variant: "ghost", size: "sm", onClick: O, children: d })
              ] }),
              /* @__PURE__ */ u(Ce, { children: [
                /* @__PURE__ */ a(Or, { children: w }),
                Object.values(W).map((D, F) => {
                  const P = V[D];
                  if (P.length !== 0)
                    return /* @__PURE__ */ u(Ko, { children: [
                      ...
                      F < Object.values(W).length - 1 && /* @__PURE__ */ a(pn, {})
                    ] }, D);
                })
              ] })
            ]
...
function Aw({
  ...
  const i = Ga(e, t).length === 0, s = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], c = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    L,
    {
      variant: "outline",
...
function Iw({
  ...
  const i = o["%webView_book_selector_more%"], s = I(
    ...
    (c) => {
      const d = Ga(s, c).map((w) => w);
      r(
        ti(s, c, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(W).map((c) => /* @__PURE__ */ a(
      Aw,
      {
        section: c,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Qr ? Qr : Ao
      ).map((c) => /* @__PURE__ */ a(Ue, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(c, n) }, c)),
      e.length > Qr && /* @__PURE__ */ a(
        Ue,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - Ao} ${i}`
        }
      )
    ] })
  ] });
...
function Fp({
  ...
  ], k = e ? v.filter((x) => e.includes(x.value)) : v;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        mn,
        {
          ...
          children: k.map(({ value: x, label: N, id: _ }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ua, { className: "tw:me-2", value: x, id: _ }),
            /* @__PURE__ */ a(pt, { htmlFor: _, children: N })
          ] }, _))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((d) => /* @__PURE__ */ a(Ft, { value: `${d}`, children: l[J(d)] }, `${d}`))
          }
        )
      ]
    }
...
function Dr({ icon: t, menuLabel: e, leading: r }) {
  return t ? /* @__PURE__ */ a(
    "img",
    {
...
const ri = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ u(Mt, { children: [
  /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
    va,
    {
      onClick: () => {
        o(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ a(Dr, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ a(Dr, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ u(Cd, { children: [
    /* @__PURE__ */ a(Ed, { children: l.label }),
    /* @__PURE__ */ a(kd, { children: /* @__PURE__ */ a(zd, { children: ri(
      t,
      e,
      ei(t, l.id),
      o
  ...
  l.tooltip && /* @__PURE__ */ a(At, { children: l.tooltip })
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(L, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(gs, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(Ko, { children: [
      /* @__PURE__ */ a(Hn, { children: /* @__PURE__ */ a($t, { children: ri(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, c)) })
  ] });
}
const ai = et.forwardRef(
...
const oi = et.forwardRef(({ className: t, ...e }, r) => {
  const o = lt();
  return /* @__PURE__ */ a(
    Bt.Root,
    {
...
oi.displayName = Bt.List.displayName;
const ni = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.List,
  {
    ref: r,
    className: f(
...
ni.displayName = Bt.List.displayName;
const Lw = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Trigger,
  {
    ref: r,
    ...e,
...
)), ii = et.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Bt.Content,
  {
    ref: r,
    className: f(
...
ii.displayName = Bt.Content.displayName;
function Wp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(oi, { children: [
      /* @__PURE__ */ a(ni, { children: t.map((l) => /* @__PURE__ */ a(Lw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ a(ii, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Vw({
  ...
  return /* @__PURE__ */ a(Fa.Provider, { value: o, children: /* @__PURE__ */ a(
    Jt.Root,
    {
      "data-slot": "menubar",
      className: f(
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Kw,
        {
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(Dr, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(Dr, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(qw, { children: [
        /* @__PURE__ */ a(Hw, { children: d.label }),
        /* @__PURE__ */ a(Ww, { children: si(
          t,
          e,
          ei(t, d.id),
          o
    ...
    return l.length > 0 && s < n.length - 1 && c.push(/* @__PURE__ */ a(Gw, {}, `separator-${i}`)), c;
  });
};
function Yw({
  menuData: t,
  ...
  const n = q(void 0), i = q(void 0), s = q(void 0), l = q(void 0), c = q(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (kl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, k;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (k = c.current) == null || k.focus(), Ze(c, [h, p]);
        break;
    }
  }), K(() => {
    ...
    return /* @__PURE__ */ a(Vw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(jw, { children: [
      /* @__PURE__ */ a(Bw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Uw,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a($t, { children: si(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Jp({
  ...
  const d = Xw(
    ...
    var k, x, N, _, M, V;
    const v = b !== m ? ((x = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : x[b]) ?? ((_ = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : _.en) : void 0;
    return v ? `${(M = t[m]) == null ? void 0 : M.autonym} (${v})` : (V = t[m]) == null ? void 0 : V.autonym;
  };
      ...
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Ye },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(Ft, { value: m, children: p(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(pt, { className: "tw:font-normal tw:text-muted-foreground", children: oe(d, {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(L, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Qa, {}) }) }),
...
function kg({
  ...
  const n = lt();
  return /* @__PURE__ */ u(Qw, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(tu, {}),
    /* @__PURE__ */ u(
      _e.Content,
      {
...
export {
  ...
  Fd as DropdownMenuItemType,
  Ir as DropdownMenuLabel,
  kd as DropdownMenuPortal,
  _d as DropdownMenuRadioGroup,
  Nd as DropdownMenuRadioItem,
  cr as DropdownMenuSeparator,
  Ju as DropdownMenuShortcut,
  Cd as DropdownMenuSub,
  zd as DropdownMenuSubContent,
  Ed as DropdownMenuSubTrigger,
  ...
  Pw as SELECT_BOOKS_STRING_KEYS,
  Fp as ScopeSelector,
  ...
  Ke as Select,
  Iw as SelectBooks,
  Ow as SelectBooksPicker,
  He as SelectContent,
  Dd as SelectGroup,
  Ft as SelectItem,
  Qu as SelectLabel,
  $d as SelectScrollDownButton,
  Rd as SelectScrollUpButton,
  ...
  Ud as UNDO_REDO_BUTTONS_STRING_KEYS,
  Jp as UiLanguageSelector,
  Kd as UndoRedoButtons,
  oi as VerticalTabs,
  ...
  wn as Z_INDEX_MODAL,
  Sl as Z_INDEX_MODAL_BACKDROP,
  Tl as Z_INDEX_OVERLAY,
  md as badgeVariants,
  ud as buttonGroupVariants,
