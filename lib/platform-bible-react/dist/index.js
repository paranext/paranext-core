...
import b, { forwardRef as an, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as Ot, createContext as Cn, useContext as hr, useEffect as Y, Component as ms, createElement as Vr, Suspense as fs, Fragment as ho } from "react";
import { Command as Ct } from "cmdk";
import { X as je, Search as go, Check as jt, Clock as jr, ChevronsLeft as zr, ChevronsRight as Fr, ChevronLeft as Wn, ChevronRight as Ie, ArrowLeft as hs, ArrowRight as gs, Circle as En, ChevronDown as ze, BoldIcon as bs, ItalicIcon as vs, AtSign as bo, Pencil as xs, Trash2 as ys, ArrowUp as vo, MoreHorizontal as Ns, MailOpen as ks, Mail as _s, ChevronUp as xo, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ts, ChevronRightIcon as Rs, ArrowRightIcon as Ss, Copy as yo, Filter as Ds, User as Ms, Link as Is, CircleHelp as Os, ChevronsUpDown as No, Star as As, Undo as Ps, Redo as $s, SquareX as ko, FunctionSquare as _o, SquareSigma as Co, Ban as Ls, AlertCircle as Jn, CircleCheckIcon as Vs, CircleXIcon as js, CircleHelpIcon as zs, ArrowUpIcon as Fs, ArrowDownIcon as Bs, PanelLeft as Ks, PanelRight as Gs, ScrollText as Us, MenuIcon as qs, Menu as Hs, EllipsisVertical as Ys, MoreVertical as Br, LoaderCircle as Xs, GripVertical as Ws } from "lucide-react";
...
const oe = Oe.Root, fe = Oe.Trigger, wl = Oe.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ht();
...
), ft = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Eo.Root, { ref: n, className: h("pr-twp", ml(), t), ...e }));
ft.displayName = Eo.Root.displayName;
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = na ? Ot : Y, pn = { tag: gr };
function vl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = gl(null, o), d = To({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
...
const xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function yl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return xl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      e && s.size === 0 && i.size === 0 || t && c.has(gr) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const _r = {
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function Tl(t) {
...
function Sl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !ii(e) && o !== null) {
    ...
    if (w || d) {
      const [m, f] = li(t), u = l.is(c), g = e.is(i ? c : l), x = e.is(i ? l : c);
      let v, y = 0;
      u ? (y = m > f ? f : m, v = m > f ? m : f) : g ? (y = i ? f : m, v = void 0) : x && (y = 0, v = i ? m : f);
      const N = e.__text.slice(y, v);
      N !== e.__text && (n === "clone" && (e = wi(e)), e.__text = N);
    }
  }
  return e;
}
...
function Ol(t) {
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Do(s, (w) => le(w) && !w.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [wa], register: (t, e, n) => t.registerCommand(Oo, (o) => {
  const a = Vt();
...
class Qe {
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of Vl(m)) {
  ...
  return de(t.registerCommand(gi, (i) => {
    if (bi(i.target)) {
      ...
      if (Yl(l)) return function(c, w = !1) {
        ...
        let u;
        w && Ao(d) ? u = d : (u = xi(), yi(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
...
function Xl(t, e, n = fa) {
  return de(t.registerCommand(Ri, (o) => {
    ...
    const s = function(i) {
      ...
      const l = i.anchor, c = i.focus, w = c.isBefore(l) ? c : l, d = w.getNode(), m = Il(d);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Si();
...
const Rr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
  ...
  return function(n, o) {
    ...
    return Rr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], d = r(o, { onError: (f) => n._onError(f), children: r(fs, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Ui(d, m, w));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function rw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Rr(() => de(Ki(a), ga(a)), [a]);
  }(o), p(ct, { children: [t, r(ow, { content: e }), r(nw, { editor: o, ErrorBoundary: n })] });
}
...
const sw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
function iw({ onClear: t }) {
  const [e] = Xt();
  return sw(() => la(e, t), [e, t]), null;
}
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : Y;
...
function dw(t, e) {
  ...
  return p(ct, { children: [r(ww, { editor: a, ...o, ref: e }), n != null && r(pw, { editor: a, content: n })] });
}
...
function hw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = fw(), c = () => {
  };
...
function ka(t, e, n, o = null) {
  ...
  const l = le(i) ? i.getChildren() : [], c = Pi(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = ka(t, g, f, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if (($i(d) || qr(d)) && d.append(f), n.append(d), m) {
      const u = m.call(i, d);
...
function Ca(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let f = [];
  const u = (l == null || !Vi(l)) && (l != null && bn(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...Ca(m[g], e, n, u, new Map(a), l));
  return d != null && (f = d(f)), Hr(t) && (f = Cw(t, f, u ? () => {
    const g = new Vo();
    return n.push(g), g;
...
function bp({
  ...
  const [a, s] = S(Tw), [i, l] = S(void 0), [c, w] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Mr(y) && (y.preventDefault(), y.stopPropagation(), $t(a) && f());
        },
        onKeyDown: (y) => {
...
}), Ce = nt.Trigger, Ia = nt.Group, Lw = nt.Portal, Vw = nt.Sub, jw = nt.RadioGroup;
...
function io({
  ...
  const u = K(
    ...
    [t.user]
  ), N = B(() => ei(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(ct, { children: [
        /* @__PURE__ */ p(
          kn,
          {
            onClick: (C) => {
              C.stopPropagation(), w(!0), m(Ew(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Ns, {}) }) }),
...
function Fw({
  ...
  const [R, $] = S(lo), [E, D] = S(
    void 0
  ), V = o, [P, O] = S(!1), [A, W] = S(!1), [I, J] = S(!1), [Tt, At] = S(!1), [Mt, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), lt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
...
function Bw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Hi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const On = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function tc({
  ...
  var j;
  const [d, m] = S([]), [f, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = B(() => e ?? [], [e]), k = Ko({
    data: N,
    columns: t,
    getCoreRowModel: Uo(),
  ...
  return c ? F = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((R) => /* @__PURE__ */ r(
    ...
    R.id
  )) : F = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(yo, {}) })
        ] }),
...
function Cp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((w, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Ia, { children: w.itemType === 0 ? /* @__PURE__ */ r(ct, { children: w.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][f],
        ...
        jw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Pa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ge, {})
    ] }, w.label)) })
...
const wc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(ct, { children: [
...
function cc({
  ...
  const s = H(null), i = H(null), l = H(!1), [c, w] = S(t), [d, m] = S(n), [f, u] = S(!1);
  Y(() => {
    w(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ue, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: wc(t, a, n) }) }) }),
...
const dc = (t, e) => t === "f" ? /* @__PURE__ */ p(ct, { children: [
  /* @__PURE__ */ r(_o, {}),
  " ",
...
function uc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(zi, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: dc(t, n) }) }) }),
...
function uo({
  ...
  return /* @__PURE__ */ p(
    ...
    `item-${t.marker ?? ((n = t.icon) == null ? void 0 : n.displayName)}-${t.title.replaceAll(" ", "")}`
  );
}
function hc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(ne, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(re, { children: [
      ...
      /* @__PURE__ */ r(Ut, { children: s.map((l) => /* @__PURE__ */ r(uo, { item: l, localizedStrings: t })) }),
      i.length && s.length ? /* @__PURE__ */ r(xr, { alwaysRender: !0 }) : "",
      /* @__PURE__ */ r(Ut, { children: i.map((l) => /* @__PURE__ */ r(uo, { item: l, localizedStrings: t })) })
    ] })
  ] });
}
function gc(t, e, n, o) {
...
function Sp({
  ...
  const Bt = () => {
    ...
    if (L && dn("note", L)) {
      ...
      N !== "x" && _ === "x" ? wt == null || wt.forEach((Rt) => bc(Rt)) : N === "x" && _ !== "x" && (wt == null || wt.forEach((Rt) => vc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: yc(t.marker, l, o, w) })
      }
    )
  ] });
}
...
function jp({
  ...
  }, [R, W]), J = B(() => I.length === 0 ? [] : Sc(I, E, V), [I, E, V]), Tt = B(() => {
    var st, lt;
    if (!R) return c;
...
const Mc = "16rem", Ic = "3rem", ja = b.createContext(void 0);
function Pn() {
...
const za = b.forwardRef(
  ({
    ...
    const [w, d] = b.useState(t), m = e ?? w, f = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => f((k) => !k), [f]), g = m ? "expanded" : "collapsed", y = ht() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ r(ja.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    Fa,
    {
      ...
      children: /* @__PURE__ */ p(Ka, { children: [
        /* @__PURE__ */ p(pr, { children: [
          ...
          /* @__PURE__ */ r(mr, { children: /* @__PURE__ */ r(Ga, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(Ua, { children: /* @__PURE__ */ r(
            qa,
            {
              onClick: () => w(f),
              isActive: m(f),
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(Kw, { children: C.map((E) => /* @__PURE__ */ r(It, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ p(
                      z,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(Wn, {})),
                          " ",
...
function ed({
  ...
  const s = $r(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function nd({
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (A) => {
      const W = $r(j, A).map((I) => I);
      n(
        Ya(j, A, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), P = () => {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Te,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(It, { value: `${w}`, children: l[Q(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ p(St, { children: [
...
function fr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(qs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, d) => /* @__PURE__ */ p(ho, { children: [
      /* @__PURE__ */ r(Ia, { children: /* @__PURE__ */ r(kt, { children: Wa(e.groups, e.items, c, t) }) }),
...
ts.displayName = Et.Content.displayName;
function Wp({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
const Ye = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, d) => w.order - d.order).map((w) => /* @__PURE__ */ p(St, { children: [
    ...
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(is, {}, `separator-${s}`)), c;
  });
};
function wd({
  menuData: t,
  ...
  if (el(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ye(s, [f, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Ye(i, [f, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(es, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(od, { children: [
      /* @__PURE__ */ r(ns, { ref: w(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        as,
        {
          className: "tw-z-[250]",
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && w && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Br, {}) }) }),
...
Id.displayName = zt.Description.displayName;
...
const fu = Et.Root, $d = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
$d.displayName = Et.List.displayName;
...
Ld.displayName = Et.Trigger.displayName;
...
Vd.displayName = Et.Content.displayName;
