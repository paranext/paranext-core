...
import m, { forwardRef as tn, useRef as nt, useMemo as J, useState as P, useCallback as H, useLayoutEffect as Tn, createContext as qr, useContext as Jr, useEffect as St, Fragment as jn } from "react";
...
const it = class A {
    ...
    if (D(this, "firstChapter"), D(this, "lastChapter"), D(this, "lastVerse"), D(this, "hasSegmentsDefined"), D(this, "text"), D(this, "BBBCCCVVVS"), D(this, "longHashCode"), D(this, "versification"), D(this, "rtlMark", "‏"), D(this, "_bookNum", 0), D(this, "_chapterNum", 0), D(this, "_verseNum", 0), D(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof A) {
          ...
          if (e == null) return;
          const s = e instanceof Ot ? e : A.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Ot(i)), n ? new A(n, a.toString(), w, u) : new A();
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || X.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !A.isVerseParseable(a[1]))
      throw new re("Invalid reference : " + e);
...
function wo({
  ...
  return /* @__PURE__ */ c(te, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(Gt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Wt, { children: /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(Tt, { heading: s, children: t.map((p) => /* @__PURE__ */ c(
      Bt,
      {
        onSelect: () => l(p),
      ...
      if (i) {
        ...
        if (!p && u) {
          const g = ((b) => Object.keys(Pt).find(
            (y) => Pt[y].toLowerCase() === b.toLowerCase()
          ))(w);
...
function Ii({
  ...
  const l = at(), [p, f] = P(!1), [h, g] = P(""), [b, y] = P(""), [x, I] = P("books"), [N, _] = P(void 0), [j, $] = P(!1), z = nt(void 0), F = nt(void 0), V = nt(void 0), R = nt(void 0), C = nt({}), L = H(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
  ), E = J(() => a ? a() : rr, [a]), Z = J(() => ({
    [O.OT]: E.filter((B) => X.isBookOT(B)),
    [O.NT]: E.filter((B) => X.isBookNT(B)),
    [O.DC]: E.filter((B) => X.isBookDC(B)),
    [O.Extra]: E.filter((B) => X.extraBooks().includes(B))
    ...
    (v) => {
      const B = x === "chapters" ? N : k == null ? void 0 : k.book;
      B && (L({
        book: B,
        chapterNum: v,
        verseNum: 1
      }), f(!1), I("books"), _(void 0), y(""));
    },
    [L, x, N, k]
  ), Dt = H(
    (v) => {
    ...
    (v) => {
      ...
      if (x === "chapters") {
        ...
        if (B || et) {
          if (v.preventDefault(), v.stopPropagation(), I("books"), _(void 0), et && N) {
            const ot = Pt[N];
            y(`${ot} ${v.key}`);
          } else
            y(v.key);
      ...
      if ((x === "chapters" || x === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const ot = x === "chapters" ? N : k == null ? void 0 : k.book;
        if (!ot) return;
        const st = (() => {
          if (!h) return 1;
          const ne = h.match(/(\d+)$/);
    ...
    const { isLetter: B, isDigit: et } = On(v.key);
    (B || et) && (v.preventDefault(), y((ot) => ot + v.key), F.current.focus(), $(!1));
  }, []);
  return Tn(() => {
    const v = setTimeout(() => {
      if (p && x === "books" && V.current && R.current) {
        const B = V.current, et = R.current, ot = et.offsetTop, st = B.clientHeight, Mt = et.clientHeight, Nt = ot - st / 2 + Mt / 2;
        B.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), g(Ue(t.book));
  ...
  }, [x, N, k, t.book, t.chapterNum]), /* @__PURE__ */ c(te, { open: p, onOpenChange: mt, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ r(
      M,
      {
      ...
      Wt,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ht(N, o) })
          ] }),
          !j && /* @__PURE__ */ c(Zt, { ref: V, children: [
            x === "books" && /* @__PURE__ */ c(kt, { children: [
              !k && Object.entries(q).map(([v, B]) => {
                if (B.length !== 0)
                  return (
              ...
              k && /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r(
                Bt,
                {
                  value: `${k.book} ${Pt[k.book]} ${k.chapterNum || ""}:${k.verseNum || ""})}`,
                  onSelect: Q,
...
function Ke({
  ...
  const [_, j] = P(!1), $ = u ?? w, z = (V) => !!(x && x.length > 0 && V.length > 0 && Array.isArray(V[0])), F = (V) => /* @__PURE__ */ c(
    Bt,
    {
      value: w(V),
      onSelect: () => {
      ...
      children: [
        ...
        /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: w(V) })
      ]
    },
    w(V)
  );
  return /* @__PURE__ */ c(te, { open: _, onOpenChange: j, ...N, children: [
      ...
      M,
      {
        ...
        children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            l && /* @__PURE__ */ r("div", { className: "tw-pe-2", children: l }),
            /* @__PURE__ */ r("span", { className: d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? $(s) : p })
          ] }),
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(Wt, { children: [
          ...
          /* @__PURE__ */ r(Zt, { children: z(e) ? e.map((V, R) => {
            const C = (x == null ? void 0 : x[R]) ?? void 0;
            return /* @__PURE__ */ r(Tt, { heading: C, children: V.map((L) => F(L)) }, C);
          }) : e.map((V) => F(V)) })
        ] })
      }
    )
    ...
    dn,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(rt, { className: "tw-flex tw-items-center", children: a.map((x) => X.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
function yo({ table: t }) {
  return /* @__PURE__ */ c(_e, { children: [
    /* @__PURE__ */ r($a, { asChild: !0, children: /* @__PURE__ */ c(M, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function Io({
  ...
  var z;
  const [p, f] = P([]), [h, g] = P([]), [b, y] = P({}), [x, I] = P({}), N = J(() => e ?? [], [e]), _ = Xn({
    data: N,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  }), j = _.getVisibleFlatColumns();
  let $;
  return u ? $ = Array.from({ length: 10 }).map((R, C) => `skeleton-row-${C}`).map((R) => /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(zt, { colSpan: j.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(qe, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, R)) : ((z = _.getRowModel().rows) == null ? void 0 : z.length) > 0 ? $ = _.getRowModel().rows.map((F) => /* @__PURE__ */ r(
    Ct,
    {
      onClick: () => i(F, _),
      "data-state": F.getIsSelected() && "selected",
      children: F.getVisibleCells().map((V) => /* @__PURE__ */ r(zt, { children: ie(V.column.columnDef.cell, V.getContext()) }, V.id))
    },
    F.id
  )) : $ = /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(zt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: l }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: w, children: [
    o && /* @__PURE__ */ r(yo, { table: _ }),
    /* @__PURE__ */ c(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: _.getHeaderGroups().map((F) => /* @__PURE__ */ r(Ct, { children: F.headers.map((V) => /* @__PURE__ */ r(de, { children: V.isPlaceholder ? void 0 : ie(V.column.columnDef.header, V.getContext()) }, V.id)) }, F.id)) }),
...
function ji({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(_e, { children: [
    /* @__PURE__ */ r(un, { asChild: !0, children: /* @__PURE__ */ c(M, { variant: "default", children: [
...
function Lo({
  ...
  const [I, N] = P(!1), _ = H(
    (C) => {
      var E;
      const L = (E = t.find((Z) => Z.label === C)) == null ? void 0 : E.value;
      L && n(
    ...
    if (!h) return t;
    const C = t.filter((E) => E.starred).sort((E, Z) => E.label.localeCompare(Z.label)), L = t.filter((E) => !E.starred).sort((E, Z) => {
  ...
  return /* @__PURE__ */ r("div", { id: x, className: b, children: /* @__PURE__ */ c(te, { open: V, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(ee, { asChild: !0, children: /* @__PURE__ */ c(
      M,
      {
        variant: y,
...
function Go({
  ...
  return /* @__PURE__ */ c(kt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: d("textual-note-body", g), children: w && w.length > 0 && /* @__PURE__ */ r(kt, { children: jo(t.marker, w, a, l) }) })
  ] });
}
...
function Fi({
  ...
  const p = l ? Ko(l, "%webView_footnoteList_header%") : "Footnotes", f = w ?? Ma(e, void 0), h = (N, _) => {
    u == null || u(N, _, a);
  }, g = o ? e.findIndex((N) => N === o) : 0, [b, y] = P(g), x = (N) => {
    if (e.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), y((_) => Math.min(_ + 1, e.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), y((_) => Math.max(_ - 1, 0));
          break;
        case "Enter":
        case " ":
          N.preventDefault(), u == null || u(e[b], b, a);
          break;
      }
  }, I = nt([]);
  return St(() => {
    var N;
    b >= 0 && b < I.current.length && ((N = I.current[b]) == null || N.focus());
  }, [b]), /* @__PURE__ */ c(kt, { children: [
...
const Ve = (t) => t === "asc" ? /* @__PURE__ */ r(ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ha, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Hi = (t) => ({
  ...
  header: ({ column: e }) => /* @__PURE__ */ c(M, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ve(e.getIsSorted())
  ] })
}), Wo = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ c(M, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Ve(n.getIsSorted())
  ] })
}), Yi = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c(M, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Ve(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c(M, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Ve(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
...
function Zi({
  ...
  const f = ft(n, "%webView_inventory_all%"), h = ft(n, "%webView_inventory_approved%"), g = ft(n, "%webView_inventory_unapproved%"), b = ft(n, "%webView_inventory_unknown%"), y = ft(n, "%webView_inventory_scope_currentBook%"), x = ft(n, "%webView_inventory_scope_chapter%"), I = ft(n, "%webView_inventory_scope_verse%"), N = ft(n, "%webView_inventory_filter_text%"), _ = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = ft(n, "%webView_inventory_no_results%"), [$, z] = P(!1), [F, V] = P("all"), [R, C] = P(""), [L, E] = P([]), Z = J(() => {
    const T = t ?? [];
  ...
  }, [$, Z]), q = J(() => S.length === 0 ? [] : Qo(S, F, R), [S, F, R]), k = J(() => {
    var mt, ht;
    if (!$) return u;
    ...
    return [...tt, ...u];
  }, [a == null ? void 0 : a.tableHeaders, u, $]);
  St(() => {
  ...
  return /* @__PURE__ */ c("div", { id: l, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(Ut, { onValueChange: (T) => xt(T), defaultValue: i, children: [
        /* @__PURE__ */ r(Lt, { className: "tw-m-1", children: /* @__PURE__ */ r(Kt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ c(jt, { children: [
          /* @__PURE__ */ r(dt, { value: "book", children: y }),
...
const br = m.forwardRef(
  ({
    ...
    const [l, p] = m.useState(t), f = e ?? l, h = m.useCallback(
      (_) => {
        const j = typeof _ == "function" ? _(f) : _;
        n ? n(j) : p(j);
      },
      [n, f]
    ), g = m.useCallback(() => h((_) => !_), [h]), b = f ? "expanded" : "collapsed", I = at() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = m.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(gr.Provider, { value: N, children: /* @__PURE__ */ r(vn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
function tw({
  ...
  const [l, p] = P([]), [f, h] = P([{ id: Rt, desc: !1 }]), [g, b] = P({}), y = J(
  ...
  St(() => {
    if (w) {
      const R = I.getSelectedRowModel().rowsById, C = Object.keys(R);
      if (C.length === 1) {
        const L = y.find((E) => $n(E) === C[0]) || void 0;
        L && w(L);
      }
    }
  }, [g, y, w, I]);
  const N = o ?? ys, _ = s ?? _r, j = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Rt] },
    { label: `Group by ${_}`, value: [At] },
    {
  ...
  }, F = (R, C) => R.getIsGrouped() ? "" : d("banded-row", C % 2 === 0 ? "even" : "odd"), V = (R, C, L) => {
    if (!((R == null ? void 0 : R.length) === 0 || C.depth < L.column.getGroupedIndex())) {
      if (C.getIsGrouped())
        switch (C.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ c(
      Ut,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: j.map((R) => /* @__PURE__ */ r(dt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ c(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: I.getHeaderGroups().map((R) => /* @__PURE__ */ r(Ct, { children: R.headers.filter((C) => C.column.columnDef.header).map((C) => (
      ...
      /* @__PURE__ */ r(Ee, { children: I.getRowModel().rows.map((R, C) => {
        const L = at();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: R.getVisibleCells().map((E) => {
              if (!(E.getIsPlaceholder() || E.column.columnDef.enableGrouping && !E.getIsGrouped() && (E.column.columnDef.id !== At || !n)))
                return /* @__PURE__ */ r(
                  zt,
                  {
                    className: d(
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ c(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(Yt, {}) : /* @__PURE__ */ r(Be, {})),
                          " ",
...
function Rs({
  ...
  }, [x, I] = P(!1), [N, _] = P(""), j = nt(void 0), $ = nt(!1);
  if (t.length !== X.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const z = J(() => X.allBookIds.filter(
    ...
    (S, q = !1) => {
      ...
      const k = z.findIndex((T) => T === j.current), Q = z.findIndex((T) => T === S);
      if (k === -1 || Q === -1) return;
      const [xt, Xt] = [
        Math.min(k, Q),
        Math.max(k, Q)
      ], Dt = z.slice(xt, Xt + 1).map((T) => T);
      n(
    ...
    V(S, $.current), $.current = !1;
  }, C = (S, q) => {
    S.preventDefault(), V(q, S.shiftKey);
  }, L = H(
    (S) => {
      const q = kn(z, S).map((k) => k);
      n(
        Rr(z, S, e) ? e.filter((k) => !q.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, z]
  ), E = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Gt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ c(
            Wt,
            {
              shouldFilter: !1,
              onKeyDown: (S) => {
                S.key === "Enter" && ($.current = S.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  ue,
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(M, { variant: "ghost", size: "sm", onClick: Z, children: l })
                ] }),
                /* @__PURE__ */ c(Zt, { children: [
...
function nw({
  ...
  const l = It(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = It(i, "%webView_scope_selector_current_book%"), g = It(i, "%webView_scope_selector_choose_books%"), b = It(i, "%webView_scope_selector_scope%"), y = It(i, "%webView_scope_selector_select_books%"), x = [
  ...
  ], I = e ? x.filter((N) => e.includes(N.value)) : x;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        dn,
        {
          ...
          children: I.map(({ value: N, label: _, id: j }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(be, { className: "tw-me-2", value: N, id: j }),
            /* @__PURE__ */ r(rt, { htmlFor: j, children: _ })
          ] }, j))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((l) => /* @__PURE__ */ r(dt, { value: `${l}`, children: w[G(l)] }, `${l}`))
          }
        )
      ]
    }
  ...
  if (ja(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (x = w.current) == null || x.focus(), ae(w, [h, g]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(Ir, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(Ts, { children: [
...
function pw({
  ...
  const l = Os(
    ...
    var I, N, _, j, $, z;
    const x = y !== b ? ((N = (I = t[b]) == null ? void 0 : I.uiNames) == null ? void 0 : N[y]) ?? ((j = (_ = t[b]) == null ? void 0 : _.uiNames) == null ? void 0 : j.en) : void 0;
    return x ? `${($ = t[b]) == null ? void 0 : $.autonym} (${x})` : (z = t[b]) == null ? void 0 : z.autonym;
  };
  return /* @__PURE__ */ c("div", { id: u, className: d("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(rt, { className: "tw-font-normal tw-text-muted-foreground", children: Ia(l, {
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && w && /* @__PURE__ */ c(_e, { children: [
              /* @__PURE__ */ r(un, { className: d(l && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(M, { className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ka, {}) }) }),
...
const fw = K.Root, gw = K.Trigger, bw = K.Group, vw = K.Portal, xw = K.Sub, yw = K.RadioGroup, Fs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ c(
  K.SubTrigger,
  {
    ref: o,
    className: d(
...
const mi = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = P(void 0), [w, u] = P(void 0), l = H(
    (h) => {
      i(h);
