import { jsx as r, jsxs as l, Fragment as yt } from "react/jsx-runtime";
import p, { forwardRef as Kt, createContext as Qn, useContext as tr, useCallback as tt, useState as P, useRef as U, useEffect as pt, useLayoutEffect as Ke, useMemo as et, Fragment as er } from "react";
...
import { ChevronRight as Re, Check as Nt, Circle as Te, X as Ee, Search as an, ChevronsUpDown as Ve, FilterIcon as or, ChevronDown as Wt, ChevronUp as sr, ArrowLeftIcon as ir, ChevronLeftIcon as wr, ChevronRightIcon as lr, ArrowRightIcon as dr, LoaderCircle as cr, Download as pr, Filter as ur, User as mr, Link as hr, CircleHelp as gr, Star as fr, CircleCheckIcon as br, CircleXIcon as vr, CircleHelpIcon as xr, ArrowUpIcon as yr, ArrowDownIcon as Nr, ArrowUpDownIcon as kr, PanelLeft as Cr, PanelRight as Sr, ScrollText as _r, ChevronLeft as Rr, MenuIcon as Tr, Menu as Er, EllipsisVertical as Vr } from "lucide-react";
import { formatScrRef as Pt, getChaptersForBook as zr, NumberFormat as Mr, formatBytes as Dr, deepEqual as ze, isString as ue, compareScrRefs as xe, scrRefToBBBCCCVVV as me, getLocalizeKeyForScrollGroupId as O } from "platform-bible-utils";
...
import { useReactTable as sn, getFilteredRowModel as Br, getSortedRowModel as wn, getPaginationRowModel as Or, getCoreRowModel as ln, flexRender as At, getGroupedRowModel as Ir, getExpandedRowModel as Pr } from "@tanstack/react-table";
...
import * as cn from "@radix-ui/react-separator";
...
const De = A.Trigger, pn = A.Group, Lr = A.Portal, Yr = A.Sub, is = A.RadioGroup;
...
un.displayName = A.SubTrigger.displayName;
...
mn.displayName = A.SubContent.displayName;
...
const Oe = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    A.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(A.ItemIndicator, { children: /* @__PURE__ */ r(Nt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const hn = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = at();
  return /* @__PURE__ */ l(
    A.RadioItem,
    {
...
hn.displayName = A.RadioItem.displayName;
...
te.displayName = A.Label.displayName;
...
Lt.displayName = A.Separator.displayName;
...
R(Q, "Original", new Q(ot.Original)), R(Q, "Septuagint", new Q(ot.Septuagint)), R(Q, "Vulgate", new Q(ot.Vulgate)), R(Q, "English", new Q(ot.English)), R(Q, "RussianProtestant", new Q(ot.RussianProtestant)), R(Q, "RussianOrthodox", new Q(ot.RussianOrthodox));
let gt = Q;
function Ze(t, e) {
  const n = e[0];
...
const J = class M {
    ...
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof M) {
          ...
          if (e == null) return;
          const s = e instanceof gt ? e : M.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new gt(i)), n ? new M(n, a.toString(), w, c) : new M();
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new gt(ot[i]);
        } catch {
    ...
    if (a.length !== 2 || E.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !M.isVerseParseable(a[1]))
      throw new Dt("Invalid reference : " + e);
  ...
  updateInternal(e, n, a) {
    this.bookNum = E.bookIdToNumber(e), this.chapter = n, this.verse = a;
  }
};
R(J, "defaultVersification", gt.English), R(J, "verseRangeSeparator", "-"), R(J, "verseSequenceIndicator", ","), R(J, "verseRangeSeparators", [J.verseRangeSeparator]), R(J, "verseSequenceIndicators", [J.verseSequenceIndicator]), R(J, "chapterDigitShifter", 1e3), R(J, "bookDigitShifter", J.chapterDigitShifter * J.chapterDigitShifter), R(J, "bcvMaxValue", J.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
R(J, "ValidStatusType", yn);
      ...
      children: [
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: E.bookIdToEnglishName(t)
          }
        ),
...
function sa({
  ...
  const s = Array.from({ length: e }, (w, c) => c + 1), i = tt(
    (w) => {
      o(w);
    },
    [o]
...
const je = E.allBookIds.filter((t) => !E.isObsolete(E.bookIdToNumber(t))), ia = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
], Bt = (t) => zr(E.bookIdToNumber(t));
function da() {
  return je.map((e) => E.bookIdToEnglishName(e));
}
function ca(t) {
...
function pa(t) {
  ...
  if (ca(e))
    return je.find((a) => E.bookIdToEnglishName(a) === e);
}
function ls({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = $(), [s, i] = P(""), [w, c] = P(t.book), [u, h] = P(t.chapterNum ?? 0), [v, g] = P(t.book), [m, y] = P(!1), [_, k] = P(m), f = U(void 0), N = U(void 0), V = U(void 0), L = tt(
    (S) => {
      const D = a ? a() : je;
      return {
        OT: D.filter((X) => E.isBookOT(X)),
        NT: D.filter((X) => E.isBookNT(X)),
        DC: D.filter((X) => E.isBookDC(X))
      }[S].filter((X) => {
        const x = E.bookIdToEnglishName(X).toLowerCase(), z = s.replace(/[^a-zA-Z]/g, "").toLowerCase();
        return x.includes(z) || // Match book name
        X.toLowerCase().includes(z);
      });
    },
    [s, a]
    ...
    (S, D, X, x) => {
      if (h(t.book !== S ? 1 : t.chapterNum), D || Bt(S) === -1) {
        e({
          book: S,
          chapterNum: X ?? 1,
          verseNum: x ?? 1
    ...
    la.forEach((S) => {
      const D = S.exec(s);
      if (D) {
        const [X, x = void 0, z = void 0] = D.slice(1), nt = pa(X);
        (E.isBookIdValid(X) || nt) && b(
          nt ?? X,
          !0,
          x ? parseInt(x, 10) : 1,
          z ? parseInt(z, 10) : 1
    ...
    (S) => {
      m ? (S.key === "ArrowDown" || S.key === "ArrowUp") && (V != null && V.current ? V.current.focus() : N.current && N.current.focus(), S.preventDefault()) : y(!0);
    },
    [m]
  ), kt = (S) => {
    const { key: D } = S;
    D === "ArrowRight" || D === "ArrowLeft" || D === "ArrowDown" || D === "ArrowUp" || D === "Enter" || f.current.dispatchEvent(new KeyboardEvent("keydown", { key: D }));
  }, Z = (S) => {
    const { key: D } = S;
    if (v === w) {
      if (D === "Enter") {
        S.preventDefault(), b(w, !0, u);
        return;
      }
      const X = D === "ArrowRight" && !o || D === "ArrowRight" && o === "ltr" || D === "ArrowLeft" && o === "rtl", x = D === "ArrowLeft" && !o || D === "ArrowLeft" && o === "ltr" || D === "ArrowRight" && o === "rtl";
      let z = 0;
      if (X)
        if (u < Bt(v))
          z = 1;
      ...
      else D === "ArrowDown" ? z = 6 : D === "ArrowUp" && (z = -6);
      u + z <= 0 || u + z > Bt(v) ? h(0) : z !== 0 && (h(u + z), S.preventDefault());
    }
  };
  return pt(() => {
    w === v ? w === t.book ? h(t.chapterNum) : h(1) : h(0);
  }, [v, t.book, t.chapterNum, w]), Ke(() => {
    k(m);
  }, [m]), Ke(() => {
    const S = setTimeout(() => {
      if (_ && N.current && V.current && !s) {
        const X = V.current.offsetTop - wa;
        N.current.scrollTo({ top: X, behavior: "instant" });
      }
    }, 10);
    return () => {
      clearTimeout(S);
    };
  }, [_, s]), /* @__PURE__ */ l(Qt, { modal: !1, open: m, onOpenChange: Y, children: [
    /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(
      Gr,
      {
        ...
        handleKeyDown: I,
        handleOnClick: () => {
          c(t.book), g(t.book), h(t.chapterNum > 0 ? t.chapterNum : 0), y(!0), i(Pt(t, "English")), f.current.focus();
        },
        onFocus: () => {
          T.current = !0;
        },
    ...
    /* @__PURE__ */ r(
      $t,
      {
        ...
        ref: N,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Qe.map((S, D) => {
          const X = L(S);
          return X.length > 0 && /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(te, { className: "tw-font-semibold tw-text-foreground/80", children: ia[S] }),
            X.map((x) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              oa,
              {
                bookId: x,
                handleSelectBook: () => b(x, !1),
                isSelected: w === x,
                handleHighlightBook: () => g(x),
                handleKeyDown: Z,
                bookType: S,
                ref: (z) => {
                  w === x && (V.current = z);
                ...
                children: /* @__PURE__ */ r(
                  sa,
                  {
                    ...
                    endChapter: Bt(x),
                    activeChapter: t.book === x ? t.chapterNum : 0,
            ...
            Qe.length - 1 !== D ? /* @__PURE__ */ r(Lt, {}) : void 0
          ] }, S);
        }) })
      }
    )
...
const ua = ut(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Et : "button", { className: d(ua({ variant: e, size: n, className: t })), ref: s, ...o })
);
B.displayName = "Button";
const ma = ut(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(on.Root, { ref: n, className: d("pr-twp", ma(), t), ...e }));
G.displayName = on.Root.displayName;
...
Xe.displayName = jt.Root.displayName;
const Ut = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(jt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Te, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Ut.displayName = jt.Item.displayName;
const Fe = Xt.Root, Ge = Xt.Trigger, ee = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = $();
  return /* @__PURE__ */ r(Xt.Portal, { children: /* @__PURE__ */ r(
    Xt.Content,
    {
      ref: o,
      align: e,
...
const ha = st.Portal, Nn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  st.Overlay,
  {
    ref: n,
    className: d(
...
Nn.displayName = st.Overlay.displayName;
...
ga.displayName = st.Content.displayName;
...
fa.displayName = st.Title.displayName;
...
ba.displayName = st.Description.displayName;
...
re.displayName = K.Input.displayName;
...
ae.displayName = K.List.displayName;
const oe = p.forwardRef((t, e) => /* @__PURE__ */ r(K.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
oe.displayName = K.Empty.displayName;
...
kn.displayName = K.Separator.displayName;
...
se.displayName = K.Item.displayName;
function va(t) {
...
function ke({
  ...
  const [k, f] = P(!1);
  return /* @__PURE__ */ l(Fe, { open: k, onOpenChange: f, ..._, children: [
    ...
    /* @__PURE__ */ r(
      ee,
      {
        ...
        children: /* @__PURE__ */ l(ne, { children: [
          /* @__PURE__ */ r(re, { placeholder: h, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(oe, { children: v }),
          /* @__PURE__ */ r(ae, { children: e.map((N) => /* @__PURE__ */ l(
            se,
            {
              value: w(N),
              onSelect: () => {
...
function cs({
  ...
  const h = he(u, "%webView_bookSelector_currentBook%"), v = he(u, "%webView_bookSelector_choose%"), g = he(u, "%webView_bookSelector_chooseBooks%"), [m, y] = P(
    "current book"
    /* CURRENT_BOOK */
  ), _ = (k) => {
    y(k), t(k);
    ...
    Xe,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(G, { className: "tw-flex tw-items-center", children: a.map((k) => E.bookIdToEnglishName(k)).join(", ") }),
          /* @__PURE__ */ r(
            B,
            {
...
function Na({ table: t }) {
  return /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(ar, { asChild: !0, children: /* @__PURE__ */ l(B, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(or, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ l($t, { align: "end", className: "tw-w-[150px]", children: [
...
const _t = F.Root, ka = F.Group, Rt = F.Value, Ca = ut(
...
), vt = p.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = $();
  return /* @__PURE__ */ l(
    F.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(F.Icon, { asChild: !0, children: /* @__PURE__ */ r(Wt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
vt.displayName = F.Trigger.displayName;
...
Cn.displayName = F.ScrollUpButton.displayName;
...
const xt = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = $();
...
xt.displayName = F.Content.displayName;
...
Sa.displayName = F.Label.displayName;
const rt = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  F.Item,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(Nt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(F.ItemText, { children: e })
    ]
  }
));
rt.displayName = F.Item.displayName;
...
_a.displayName = F.Separator.displayName;
function Ra({ table: t }) {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        _t,
        {
          ...
          children: [
            /* @__PURE__ */ r(vt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Rt, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(xt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(rt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const ie = p.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: d("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const le = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: d("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function Va({
  ...
  var k;
  const [w, c] = P([]), [u, h] = P([]), [v, g] = P({}), [m, y] = P({}), _ = sn({
    data: e,
    columns: t,
    getCoreRowModel: ln(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(Na, { table: _ }),
    /* @__PURE__ */ l(ie, { stickyHeader: s, children: [
      /* @__PURE__ */ r(we, { stickyHeader: s, children: _.getHeaderGroups().map((f) => /* @__PURE__ */ r(ct, { children: f.headers.map((N) => /* @__PURE__ */ r(Ft, { children: N.isPlaceholder ? void 0 : At(N.column.columnDef.header, N.getContext()) }, N.id)) }, f.id)) }),
      /* @__PURE__ */ r(le, { children: (k = _.getRowModel().rows) != null && k.length ? _.getRowModel().rows.map((f) => /* @__PURE__ */ r(
        ct,
        {
          onClick: () => i(f, _),
          "data-state": f.getIsSelected() && "selected",
          children: f.getVisibleCells().map((N) => /* @__PURE__ */ r(Tt, { children: At(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        f.id
      )) : /* @__PURE__ */ r(ct, { children: /* @__PURE__ */ r(Tt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(Ra, { table: _ })
  ] });
}
const Yt = Kt(({ className: t, ...e }, n) => /* @__PURE__ */ r(cr, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function ps({
  ...
  return /* @__PURE__ */ r(
    B,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(Yt, { size: 15 }) : /* @__PURE__ */ l(yt, { children: [
...
function us({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    B,
    {
      ...
      onClick: e,
      ...a,
      children: t ? /* @__PURE__ */ l(yt, { children: [
...
function fs({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Qt, { children: [
    /* @__PURE__ */ r(De, { asChild: !0, children: /* @__PURE__ */ r(za, {}) }),
    /* @__PURE__ */ r($t, { children: e.map((n) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(te, { children: n.label }),
      /* @__PURE__ */ r(pn, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Oe, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(hn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Lt, {})
    ] }, n.label)) })
  ] }) });
}
...
function Da({ id: t, versionHistory: e }) {
  ...
  function s(w) {
    const c = new Date(w), u = new Date(o.getTime() - c.getTime()), h = u.getUTCFullYear() - 1970, v = u.getUTCMonth(), g = u.getUTCDate() - 1;
    let m = "";
    return h > 0 ? m = `${h.toString()} year${h === 1 ? "" : "s"} ago` : v > 0 ? m = `${v.toString()} month${v === 1 ? "" : "s"} ago` : g === 0 ? m = "today" : m = `${g.toString()} day${g === 1 ? "" : "s"} ago`, m;
  }
...
function Oa({
  ...
  const [v, g] = P(!1), m = tt(
    (k) => {
      var N;
      const f = (N = t.find((V) => V.label === k)) == null ? void 0 : N.value;
      f && a(
        n.includes(f) ? n.filter((V) => V !== f) : [...n, f]
      );
    },
    [t, n, a]
  ), y = () => i || o, _ = et(() => {
    if (!c) return t;
    const k = t.filter((N) => N.starred).sort((N, V) => N.label.localeCompare(V.label)), f = t.filter((N) => !N.starred).sort((N, V) => {
      const L = n.includes(N.value), q = n.includes(V.value);
      return L && !q ? -1 : !L && q ? 1 : N.label.localeCompare(V.label);
    });
    return [...k, ...f];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: h, children: /* @__PURE__ */ l(Fe, { open: v, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ l(
      B,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ne, { children: [
      /* @__PURE__ */ r(re, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ l(ae, { children: [
        /* @__PURE__ */ r(oe, { children: s }),
        /* @__PURE__ */ r($e, { children: _.map((k) => {
          const f = e ? e(k) : void 0;
          return /* @__PURE__ */ l(
            se,
            {
              value: k.label,
              ...
              children: [
                ...
                e && /* @__PURE__ */ r("div", { className: "tw-w-10 tw-text-end tw-text-muted-foreground", children: f })
              ]
            },
            k.label
          );
...
function Ia({
  ...
  return /* @__PURE__ */ l(ie, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(we, { stickyHeader: !0, children: /* @__PURE__ */ l(ct, { children: [
      /* @__PURE__ */ r(Ft, { children: a }),
      /* @__PURE__ */ r(Ft, { children: o })
    ] }) }),
    /* @__PURE__ */ r(le, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      ct,
      {
        onClick: () => {
          e(i.reference);
        ...
        children: [
          /* @__PURE__ */ r(Tt, { children: `${E.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(Tt, { children: i.text })
        ]
      },
...
const _n = ut(
  ...
  {
    ref: o,
    className: d(_n({ variant: e, size: n, className: t })),
    ...a
  }
));
Pa.displayName = dn.Root.displayName;
const Rn = p.createContext({
  size: "default",
  variant: "default"
}), Tn = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = $();
  return /* @__PURE__ */ r(
    Zt.Root,
    {
...
Tn.displayName = Zt.Root.displayName;
const Ht = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(Rn);
  return /* @__PURE__ */ r(
    Zt.Item,
    {
      ref: s,
...
Ht.displayName = Zt.Item.displayName;
const de = (t) => t === "asc" ? /* @__PURE__ */ r(yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Nr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(kr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ns = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ l(B, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    de(e.getIsSorted())
  ] })
}), Aa = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ l(B, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    de(n.getIsSorted())
  ] })
}), ks = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ l(B, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    de(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ l(B, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    de(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), w = s.getValue("item");
    return /* @__PURE__ */ l(Tn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          onClick: (c) => {
...
function Es({
  ...
  const u = wt(n, "%webView_inventory_all%"), h = wt(n, "%webView_inventory_approved%"), v = wt(n, "%webView_inventory_unapproved%"), g = wt(n, "%webView_inventory_unknown%"), m = wt(n, "%webView_inventory_scope_currentBook%"), y = wt(n, "%webView_inventory_scope_chapter%"), _ = wt(n, "%webView_inventory_filter_text%"), k = wt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [f, N] = P(!1), [V, L] = P("all"), [q, T] = P(""), [Y, b] = P([]), C = et(() => t.length === 0 ? [] : Fa(t, o, s), [t, o, s]), H = et(() => {
    if (f) return C;
    const x = [];
    return C.forEach((z) => {
      const nt = z.items[0], mt = x.find(
        (Ct) => Ct.items[0] === nt
      );
      mt ? (mt.count += z.count, mt.occurrences = mt.occurrences.concat(z.occurrences)) : x.push({
        items: [nt],
        count: z.count,
  ...
  }, [f, C]), I = et(() => Xa(H, V, q), [H, V, q]), kt = et(() => {
    var nt, mt;
    if (!f) return c;
    const x = (nt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : nt.length;
    if (!x) return c;
    const z = [];
    for (let Ct = 0; Ct < x; Ct++)
      z.push(
        Aa(
          ((mt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : mt[Ct]) || "Additional Item",
          Ct + 1
        )
      );
    return [...z, ...c];
  }, [a == null ? void 0 : a.tableHeaders, c, f]);
  pt(() => {
    I.length === 0 ? b([]) : I.length === 1 && b(I[0].items);
  }, [I]);
  const Z = (x, z) => {
    z.setRowSelection(() => {
      const nt = {};
      return nt[x.index] = !0, nt;
    }), b(x.original.items);
  }, S = (x) => {
    if (x === "book" || x === "chapter")
      w(x);
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        _t,
        {
          ...
          defaultValue: V,
          children: [
            /* @__PURE__ */ r(vt, { className: "tw-m-1", children: /* @__PURE__ */ r(Rt, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ l(xt, { children: [
              /* @__PURE__ */ r(rt, { value: "all", children: u }),
              /* @__PURE__ */ r(rt, { value: "approved", children: h }),
      ...
      /* @__PURE__ */ l(_t, { onValueChange: (x) => S(x), defaultValue: i, children: [
        /* @__PURE__ */ r(vt, { className: "tw-m-1", children: /* @__PURE__ */ r(Rt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(xt, { children: [
...
Ye.displayName = cn.Root.displayName;
...
const He = Gt.Provider, Ue = Gt.Root, qe = Gt.Trigger, ce = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Gt.Content,
  {
    ref: a,
    sideOffset: e,
...
ce.displayName = Gt.Content.displayName;
const Ga = "16rem", $a = "3rem", En = p.createContext(void 0);
function pe() {
  const t = p.useContext(En);
  if (!t)
...
const Vn = p.forwardRef(
  ({
    ...
    const [u, h] = p.useState(t), v = e ?? u, g = p.useCallback(
      (V) => {
        const L = typeof V == "function" ? V(v) : V;
        n ? n(L) : h(L);
      },
      [n, v]
    ), m = p.useCallback(() => g((V) => !V), [g]), y = v ? "expanded" : "collapsed", f = $() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = p.useMemo(
      () => ({
        state: y,
        open: v,
        setOpen: g,
    ...
    return /* @__PURE__ */ r(En.Provider, { value: N, children: /* @__PURE__ */ r(He, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Vn.displayName = "SidebarProvider";
const zn = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = pe();
...
On.displayName = "SidebarMenuItem";
const Wa = ut(
  ...
  ({
    ...
    const c = t ? Et : "button", { state: u } = pe(), h = /* @__PURE__ */ r(
      c,
      {
        ref: w,
...
In.displayName = "SidebarMenuButton";
...
function ao({
  ...
  return /* @__PURE__ */ r(
    zn,
    {
      ...
      children: /* @__PURE__ */ l(Dn, { children: [
        /* @__PURE__ */ l(Ce, { children: [
          /* @__PURE__ */ r(Se, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(_e, { children: /* @__PURE__ */ r(Bn, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ r(On, { children: /* @__PURE__ */ r(
            In,
            {
              onClick: () => u(g),
              isActive: v(g),
    ...
    /* @__PURE__ */ l(
      Vn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Mn, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const lt = "scrBook", oo = "scrRef", ft = "source", so = "details", io = "Scripture Reference", wo = "Scripture Book", An = "Type", lo = "Details";
function co(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? E.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === lt ? Pt(o.start) : void 0;
      },
      getGroupingValue: (a) => E.bookIdToNumber(a.start.book),
    ...
    },
    {
      ...
      id: ft,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? An : void 0,
...
function zs({
  ...
  const [c, u] = P([]), [h, v] = P([{ id: lt, desc: !1 }]), [g, m] = P({}), y = et(
    () => t.flatMap((b) => b.data.map((C) => ({
      ...C,
      source: b.source
    }))),
    [t]
  ...
  pt(() => {
    if (w) {
      const b = k.getSelectedRowModel().rowsById, C = Object.keys(b);
      if (C.length === 1) {
        const H = y.find((I) => en(I) === C[0]) || void 0;
        H && w(H);
      }
    }
  }, [g, y, w, k]);
  const f = o ?? wo, N = s ?? An, V = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${f}`, value: [lt] },
    { label: `Group by ${N}`, value: [ft] },
    {
      label: `Group by ${f} and ${N}`,
      value: [lt, ft]
    },
    {
      label: `Group by ${N} and ${f}`,
      value: [ft, lt]
    }
  ], L = (b) => {
    u(JSON.parse(b));
  }, q = (b, C) => {
    !b.getIsGrouped() && !b.getIsSelected() && b.getToggleSelectedHandler()(C);
  }, T = (b, C) => b.getIsGrouped() ? "" : d("banded-row", C % 2 === 0 ? "even" : "odd"), Y = (b, C, H) => {
    if (!((b == null ? void 0 : b.length) === 0 || C.depth < H.column.getGroupedIndex())) {
      if (C.getIsGrouped())
        switch (C.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      _t,
      {
        ...
        children: [
          /* @__PURE__ */ r(vt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Rt, {}) }),
          /* @__PURE__ */ r(xt, { position: "item-aligned", children: /* @__PURE__ */ r(ka, { children: V.map((b) => /* @__PURE__ */ r(rt, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(ie, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(we, { children: k.getHeaderGroups().map((b) => /* @__PURE__ */ r(ct, { children: b.headers.filter((C) => C.column.columnDef.header).map((C) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ft, { colSpan: C.colSpan, className: "top-0 tw-sticky", children: C.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          At(C.column.columnDef.header, C.getContext())
        ] }) }, C.id)
      )) }, b.id)) }),
      /* @__PURE__ */ r(le, { children: k.getRowModel().rows.map((b, C) => {
        const H = $();
        return /* @__PURE__ */ r(
          ct,
          {
            ...
            children: b.getVisibleCells().map((I) => {
              if (!(I.getIsPlaceholder() || I.column.columnDef.enableGrouping && !I.getIsGrouped() && (I.column.columnDef.id !== ft || !n)))
                return /* @__PURE__ */ r(
                  Tt,
                  {
                    className: d(
                    ...
                    children: I.getIsGrouped() ? /* @__PURE__ */ l(
                      B,
                      {
                        ...
                        type: "button",
                        children: [
                          b.getIsExpanded() && /* @__PURE__ */ r(Wt, {}),
                          !b.getIsExpanded() && (H === "ltr" ? /* @__PURE__ */ r(Re, {}) : /* @__PURE__ */ r(Rr, {})),
                          " ",
                          At(I.column.columnDef.cell, I.getContext()),
                          " (",
                          b.subRows.length,
                          ")"
                        ]
...
var dt = /* @__PURE__ */ ((t) => (t.OT = "OT", t.NT = "NT", t.DC = "DC", t.Extra = "Extra", t))(dt || {});
const uo = (t) => {
  switch (t) {
    case "OT":
  ...
  if (E.isBookOT(t)) return "OT";
  if (E.isBookNT(t)) return "NT";
  if (E.isBookDC(t)) return "DC";
  if (E.isExtraMaterial(t)) return "Extra";
...
}), jn = (t, e, n) => Je(t, e).every((a) => n.includes(a));
function mo({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
  ...
  return /* @__PURE__ */ l(
    se,
    {
      ...
      "aria-label": `${E.bookIdToEnglishName(t)} (${t.toLocaleUpperCase()})`,
      children: [
        /* @__PURE__ */ r(
          Nt,
          {
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": St(t) === dt.OT,
                "tw-border-s-purple-200": St(t) === dt.NT,
                "tw-border-s-indigo-200": St(t) === dt.DC,
                "tw-border-s-yellow-200": St(t) === dt.Extra
              }
            ),
            children: E.bookIdToEnglishName(t)
          }
...
function ho({
  ...
  return /* @__PURE__ */ r(
    B,
    {
      ...
      onClick: () => a(t),
      className: d(
        jn(e, t, n) && !o && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/90"
      ),
      disabled: o,
      children: t
    }
...
function go({
  ...
  const o = a["%webView_book_selector_books_selected%"], s = a["%webView_book_selector_select_books%"], i = a["%webView_book_selector_search_books%"], w = a["%webView_book_selector_select_all%"], c = a["%webView_book_selector_clear_all%"], u = a["%webView_book_selector_no_book_found%"], h = a["%webView_book_selector_more%"], [v, g] = P(!1), m = U(void 0), y = U(!1), _ = U(!1), k = U();
  if (t.length !== E.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const f = et(() => E.allBookIds.filter(
    (T, Y) => t[Y] === "1" && !E.isObsolete(E.bookIdToNumber(T))
  ), [t]), N = tt(
    (T, Y = !1) => {
      if (!Y || !m.current) {
        n(
          e.includes(T) ? e.filter((Z) => Z !== T) : [...e, T]
        ), m.current = T;
        return;
      }
      const b = f.findIndex((Z) => Z === m.current), C = f.findIndex((Z) => Z === T);
      if (b === -1 || C === -1) return;
      const [H, I] = [
        Math.min(b, C),
        Math.max(b, C)
      ], kt = f.slice(H, I + 1).map((Z) => Z);
      n(
        e.includes(T) ? e.filter((Z) => !kt.includes(Z)) : [.../* @__PURE__ */ new Set([...e, ...kt])]
      );
    },
    [e, n, f]
  ), V = tt(
    (T) => {
      const Y = Je(f, T).map((b) => b);
      n(
        jn(f, T, e) ? e.filter((b) => !Y.includes(b)) : [.../* @__PURE__ */ new Set([...e, ...Y])]
      );
    },
    [e, n, f]
  ), L = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(dt).map((T) => /* @__PURE__ */ r(
      ho,
      {
        section: T,
        availableBookIds: f,
    ...
    /* @__PURE__ */ l(Fe, { open: v, onOpenChange: g, children: [
      /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ l(
        B,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(ee, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        ne,
        {
          onKeyDown: (T) => {
            T.key === "Enter" && (y.current = T.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(re, { placeholder: i }),
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ r(B, { variant: "ghost", size: "sm", onClick: q, children: c })
            ] }),
            /* @__PURE__ */ l(ae, { children: [
              /* @__PURE__ */ r(oe, { children: u }),
              Object.values(dt).map((T, Y) => {
                const b = f.filter(
                  (C) => St(C) === T
                );
                if (b.length !== 0)
                  return /* @__PURE__ */ l(yt, { children: [
                    /* @__PURE__ */ r($e, { heading: uo(T), children: b.map((C) => /* @__PURE__ */ r(
                      mo,
                      {
                        bookId: C,
                        selectedBookIds: e,
                        toggleBook: N,
                        lastKeyEventShiftKey: y,
                        isMouseClick: _,
                        mouseClickTimer: k
                      },
                      C
                    )) }, T),
                    Y < Object.values(dt).length - 1 && /* @__PURE__ */ r(kn, {})
                  ] });
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === fe ? fe : nn
      ).map((T) => /* @__PURE__ */ r(qt, { variant: "secondary", children: E.bookIdToEnglishName(T) || T }, T)),
      e.length > fe && /* @__PURE__ */ r(qt, { variant: "secondary", children: `+${e.length - nn} ${h}` })
    ] })
  ] });
}
...
function Ds({
  ...
  const w = ht(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ht(i, "%webView_scope_selector_current_book%"), v = ht(i, "%webView_scope_selector_choose_books%"), g = ht(i, "%webView_scope_selector_scope%"), m = ht(i, "%webView_scope_selector_select_books%"), y = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Xe,
        {
          ...
          children: _.map(({ value: k, label: f, id: N }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
            /* @__PURE__ */ r(Ut, { value: k, id: N }),
            /* @__PURE__ */ r(G, { htmlFor: N, children: f })
          ] }, N))
        }
      )
    ] }),
...
function Bs({
  ...
  return /* @__PURE__ */ l(
    _t,
    {
      ...
      children: [
        /* @__PURE__ */ r(vt, { size: o, className: d("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Rt,
          {
            placeholder: i[O(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          xt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(rt, { value: `${c}`, children: i[O(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Fn = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(qe, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Lr, { children: /* @__PURE__ */ r(mn, { children: Fn(
      t,
      e,
      Xn(t, w.id),
      a
...
function rn({
  ...
  return /* @__PURE__ */ l(Qt, { variant: s, children: [
    /* @__PURE__ */ r(De, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(Tr, {}) }) }),
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, u) => /* @__PURE__ */ l(er, { children: [
      /* @__PURE__ */ r(pn, { children: /* @__PURE__ */ r(He, { children: Fn(e.groups, e.items, w, t) }) }),
...
const Gn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = $();
  return /* @__PURE__ */ r(
    W.Root,
    {
...
Gn.displayName = W.List.displayName;
...
)), Ln = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  W.Content,
  {
    ref: n,
    className: d(
...
Ln.displayName = W.Content.displayName;
function js({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Gn, { children: [
      /* @__PURE__ */ r($n, { children: t.map((i) => /* @__PURE__ */ r(fo, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(Ln, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function bo({ ...t }) {
...
const Yn = p.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = p.useMemo(
    () => ({
      variant: e
    }),
...
const Hn = p.forwardRef(({ className: t, ...e }, n) => {
  const a = at();
  return /* @__PURE__ */ r(
    j.Trigger,
    {
...
Hn.displayName = j.Trigger.displayName;
const Un = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = at();
  return /* @__PURE__ */ l(
    j.SubTrigger,
    {
      ...
      className: d(
        ...
        e && "tw-pl-8",
        it({ variant: s.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...a,
...
Un.displayName = j.SubTrigger.displayName;
...
qn.displayName = j.SubContent.displayName;
const Jn = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = at();
...
Jn.displayName = j.Content.displayName;
const Kn = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = at();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
Kn.displayName = j.Item.displayName;
const xo = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(Nt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
Wn.displayName = j.Separator.displayName;
const Ot = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((u) => u.group === s).sort((u, h) => u.order - h.order).map((u) => /* @__PURE__ */ l(Ue, { children: [
      /* @__PURE__ */ r(qe, { asChild: !0, children: "command" in u ? /* @__PURE__ */ l(
        Kn,
        {
          ...
          children: [
            u.iconPathBefore && /* @__PURE__ */ r(Jt, { icon: u.iconPathBefore, menuLabel: u.label, leading: !0 }),
            u.label,
            u.iconPathAfter && /* @__PURE__ */ r(Jt, { icon: u.iconPathAfter, menuLabel: u.label })
          ]
        },
        `menubar-item-${u.label}-${u.command}`
      ) : /* @__PURE__ */ l(vo, { children: [
        /* @__PURE__ */ r(Un, { children: u.label }),
        /* @__PURE__ */ r(qn, { children: Zn(
          t,
          e,
          Xn(t, u.id),
          a
    ...
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(Wn, {}, `separator-${s}`)), c;
  });
};
function ko({
  menuData: t,
  ...
  const o = U(void 0), s = U(void 0), i = U(void 0), w = U(void 0), c = U(void 0), u = (h) => {
    switch (h) {
      case "platform.app":
        return s;
  ...
  if (jr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (h, v) => {
    var y, _, k, f;
    h.preventDefault();
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (y = s.current) == null || y.focus(), Ot(s, [g, m]);
        break;
      case "alt+l":
        (_ = i.current) == null || _.focus(), Ot(i, [g, m]);
        break;
      case "alt+n":
        (k = w.current) == null || k.focus(), Ot(w, [g, m]);
        break;
      case "alt+h":
        (f = c.current) == null || f.focus(), Ot(c, [g, m]);
        break;
    }
  }), pt(() => {
    ...
    const h = new MutationObserver((m) => {
      m.forEach((y) => {
        if (y.attributeName === "data-state" && y.target instanceof HTMLElement) {
          const _ = y.target.getAttribute("data-state");
          n(_ === "open");
        }
      });
    });
    ...
    return /* @__PURE__ */ r(Yn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, h]) => typeof h == "object").sort(([, h], [, v]) => typeof h == "boolean" || typeof v == "boolean" ? 0 : h.order - v.order).map(([h, v]) => /* @__PURE__ */ l(bo, { children: [
      /* @__PURE__ */ r(Hn, { ref: u(h), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        Jn,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(He, { children: Zn(t.groups, t.items, h, e) })
        }
      )
    ] }, h)) });
}
...
function Gs({
  ...
  const c = Co(
    ...
    var k, f, N, V, L, q;
    const _ = y !== m ? ((f = (k = t[m]) == null ? void 0 : k.uiNames) == null ? void 0 : f[y]) ?? ((V = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : V.en) : void 0;
    return _ ? `${(L = t[m]) == null ? void 0 : L.autonym} (${_})` : (q = t[m]) == null ? void 0 : q.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      _t,
      {
        ...
        onOpenChange: (m) => h(m),
        children: [
          /* @__PURE__ */ r(vt, { children: /* @__PURE__ */ r(Rt, {}) }),
          /* @__PURE__ */ r(
            xt,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ l(yt, { children: [
      /* @__PURE__ */ r(G, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ l(G, { children: [
        "Currently:",
        " ",
...
Vo.displayName = Vt.Root.displayName;
...
zo.displayName = Vt.Image.displayName;
...
Mo.displayName = Vt.Fallback.displayName;
...
jo.displayName = It.Root.displayName;
...
export {
  ...
  Gn as VerticalTabs,
  Ln as VerticalTabsContent,
  $n as VerticalTabsList,
