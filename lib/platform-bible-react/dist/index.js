...
import { r as Gt, Z as Fi, B as q, c as g, a as Bi, C as Se, P as Oe, b as Be, d as Re, e as Ue, f as qe, g as he, h as Er, i as ra, T as Ft, S as or, j as Bt, k as Ut, l as qt, D as Je, m as kr, n as Ee, o as Te, p as ze, u as Ui, q as Tr, s as Ze, t as Le, v as Ra, w as un, x as qi, y as Ki, z as pn, A as hn, E as Gi, F as Hi, G as Yi, H as Wi, I as ua, J as pa, K as wr, L as Xi, M as Ji, N as Zi, O as Qi, Q as ts, R as zr, U as Wa } from "./resizable-CUvCloPJ.js";
...
import { includes as Ar, Section as et, getChaptersForBook as es, formatScrRef as Ne, getSectionForBook as br, formatRelativeDate as rs, formatReplacementString as _e, sanitizeHtml as vr, NumberFormat as as, formatBytes as os, getCurrentLocale as ns, usfmMarkers as Fr, getFormatCallerFunction as is, deepEqual as ss, isString as yo, compareScrRefs as $a, scrRefToBBBCCCVVV as ha, defaultScrRef as ga, formatScrRefRange as cs, getLocalizeKeyForScrollGroupId as ko } from "platform-bible-utils";
  ...
  return /* @__PURE__ */ u(sl, { children: [
    ...
    /* @__PURE__ */ u(
      ge.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(ge.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(q, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Ic, {}),
...
function Ao({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(ge.Close, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function dl({
  ...
  return /* @__PURE__ */ u(Oe, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Re, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(he, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Se,
      {
        onSelect: () => f(h),
...
function ma({
  ...
  const E = Gt(), [k, _] = N(!1), [A, B] = N(""), [V, P] = N(""), [x, T] = N("books"), [I, C] = N(void 0), [S, W] = N(
    void 0
  ), [O, Y] = N(void 0), [st, U] = N(!1), Q = G(null), Et = G(!1), ht = G(void 0), zt = G(void 0), K = G(void 0), ot = G(void 0), bt = G({}), ct = G({}), tt = F(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const $t = F(() => {
    if (R) {
      const b = R.chapterNum ?? 1, L = R.verseNum ?? 1;
      if (w && fa(R.book, b, L, w))
        return;
      tt({
        book: R.book,
        chapterNum: b,
    ...
    (b) => {
      const L = S ?? (R == null ? void 0 : R.book), J = O ?? (R == null ? void 0 : R.chapterNum);
      !L || !J || (tt({
        book: L,
        chapterNum: J,
        verseNum: b
    ...
    (b) => {
      const L = x === "chapters" ? I : R == null ? void 0 : R.book;
      if (L) {
        if (l && l(L, b) > 1) {
          W(L), Y(b), T("verses"), B("");
          return;
    ...
    T("books"), C(void 0), W(void 0), Y(void 0), setTimeout(() => {
      zt.current && zt.current.focus();
    }, 0);
  }, []), $ = F(() => {
    const b = S;
    W(void 0), Y(void 0), b ? (C(b), T("chapters"), B("")) : Yt();
  }, [S, Yt]), H = F((b) => {
    _(b), b && (T("books"), C(void 0), W(void 0), Y(void 0), P(""));
    ...
    () => ul(V),
    [V]
  ), Tt = j(() => !l || !R || !R.chapterNum || !vt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, vt]), Me = F(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), Wt = F(
    (b) => (L) => w ? pl(b, L, w) : !1,
    ...
    [w]
  ), ye = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ae = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Pe = F(
    (b) => {
    ...
    const { isLetter: L, isDigit: J } = Io(b.key);
    (L || J) && (b.preventDefault(), P((Qt) => Qt + b.key), zt.current.focus(), U(!1));
  }, []);
  return Zt(() => {
    const b = setTimeout(() => {
      if (k && x === "books" && K.current && ot.current) {
        const L = K.current, J = ot.current, _t = J.offsetTop, Qt = L.clientHeight, tr = J.clientHeight, hr = _t - Qt / 2 + tr / 2;
        L.scrollTo({
          top: Math.max(0, hr),
          behavior: "smooth"
        }), B(qn(t.book));
    ...
    if (x === "chapters" && I) {
      const b = I === t.book, L = b ? t.chapterNum : 1;
      B(
        `${I} ${ce[I] || ""} ${L}`
      ), setTimeout(() => {
        if (K.current)
  ...
  }, [x, I, R, t.book, t.chapterNum]), Zt(() => {
    if (x === "verses" && S && O !== void 0) {
      const b = S === t.book && O === t.chapterNum, L = b ? t.verseNum : 1;
      B(
        `${S} ${ce[S] || ""} ${O}:${L}`
      ), setTimeout(() => {
        if (K.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Oe, { open: k, onOpenChange: H, modal: v, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
      q,
      {
        ref: Q,
    ...
    /* @__PURE__ */ a(
      Re,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: L } = b;
          k && Q.current && L instanceof Node && Q.current.contains(L) && (Et.current = !0, H(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Ue,
          {
            ...
            children: [
              x === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: xe.map(({ onClick: b, disabled: L, title: J, icon: _t }) => /* @__PURE__ */ a(
                  q,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                x === "chapters" && I && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(I, n) }),
                x === "verses" && S && O !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ve(S, n)} ${O}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: x === "verses" ? Ae : ye
                  }
                )
              ] }),
              !st && /* @__PURE__ */ u(qe, { ref: K, children: [
                x === "books" && /* @__PURE__ */ u(rt, { children: [
                  !R && Object.entries(Lt).map(([b, L]) => {
                    if (L.length !== 0)
                      return (
                ...
                x === "chapters" && I && /* @__PURE__ */ a(
                  Vo,
                  {
                    ...
                    onChapterSelect: ie,
                    setChapterRef: Dt,
                    isChapterDisabled: Wt(I),
                    className: "tw:p-4"
                  }
                ),
                x === "verses" && S && O !== void 0 && l && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: S,
                    chapterNum: O,
...
function jo({
  ...
  const [k, _] = N(!1), A = l ?? d, B = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], V = (P, x) => {
    const T = d(P), I = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, C = `${x ?? ""}${T}${I ?? ""}`;
    return /* @__PURE__ */ u(
      Se,
      {
        value: T,
  ...
  return /* @__PURE__ */ u(Oe, { open: k, onOpenChange: _, ...E, children: [
    ...
    /* @__PURE__ */ a(
      Re,
      {
        ...
        children: /* @__PURE__ */ u(Ue, { children: [
          ...
          /* @__PURE__ */ a(qe, { children: B(e) ? e.map((P) => /* @__PURE__ */ a(he, { heading: P.groupHeading, children: P.options.map((x) => V(x, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map((P) => V(P)) }) })
        ] })
      }
    )
  ] });
...
const Hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Hn ? Zt : X, Vr = { tag: Za };
      ...
      if (f !== null) {
        if (f === void 0) p.update(() => {
          ...
          if (h.isEmpty()) {
            ...
            (Kt() !== null || y !== null && y === p.getRootElement()) && m.select();
          }
        }, Vr);
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : X;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : X;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = be(), r = j(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = G(o);
    return Tl(() => {
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let D = 0; D < h.length; D++) {
      ...
      const P = ue(E.height);
      _.height !== P && (k.style.height = P, v = !0), k.parentNode !== c && (c.append(k), v = !0), s[D] = k;
    }
  ...
  function l(w) {
    w.read(() => {
      ...
      const [f, h] = function(P) {
        const x = P.getStartEndPoints();
        return P.isBackward() ? [x[1], x[0]] : x;
      }(p), m = f.getNode(), y = m.getKey(), v = f.offset, D = h.getNode(), E = D.getKey(), k = h.offset, _ = t.getElementByKey(y), A = t.getElementByKey(E), B = r === null || _ !== o || v !== n || y !== r.getKey(), V = i === null || A !== s || k !== c || E !== i.getKey();
      if ((B || V) && _ !== null && A !== null) {
        const P = function(x, T, I, C, S, W, O) {
          const Y = (x._window ? x._window.document : document).createRange();
          return Y.setStart(...Fo(T, I, C)), Y.setEnd(...Fo(S, W, O)), Y;
        }(t, f, m, _, h, D, A);
        d(), d = $l(t, P, e);
      }
      r = m, o = _, n = v, i = D, s = A, c = k;
    });
  }
...
let Xr, Ce = 0, Jr = 0, Ul = 0, Ka = 0, Ur = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Pt.prototype.brand = Fl, Pt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ce !== 0 && Jr === 0 && e.l !== Ka && (e.l = Ka, Xr = { S: e, v: e.v, i: e.i, o: Xr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Jn(this), qo(this), Ce++;
  const t = nt;
...
const Zl = re({ config: Qe({ setOptions: Ko, updateOptions: Ko }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
const td = /* @__PURE__ */ new Set(), Yo = re({ build(t, e, r) {
  const o = r.getDependency(Ga).output, n = Nr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ei(() => {
    ...
    let d, l = !1;
    o.value.read(() => {
      if (Kt()) for (const [w, p] of c.entries()) {
        if (p.size === 0) {
          c.delete(w);
          continue;
        }
  ...
  return { watchNodeKey: function(s) {
    const c = ql(() => (i.value || td).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
...
re({ dependencies: [Ga, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [ir], register(t, e, r) {
  ...
  return De(t.registerCommand(ed, (s) => {
    const c = Kt();
    if (!fe(c)) return !1;
    ...
    if (uc(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        const w = Kt(), p = d.isSelected(), f = d.getKey();
        let h;
...
function od(t, e, r = ni) {
  return De(t.registerCommand(_c, (o) => {
    const n = Kt();
    if (!fe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
    ...
    const o = typeof e == "number" ? e : e ? e.peek() : null, n = Kt();
    if (!fe(n)) return !1;
...
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : X;
...
function Qu({
  ...
  const [i, s] = N(Md), [c, d] = N(n), [l, w] = N(!1), p = G(void 0), f = G(null);
  X(() => {
    let v = !0;
    const D = f.current;
    if (!D) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Oe, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
        q,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        Re,
        {
          ...
          children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(qe, { children: t.map((v) => /* @__PURE__ */ a(
            Se,
            {
              onSelect: () => {
                d(v || void 0), w(!1);
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ u(Ee, { children: [
          /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
          /* @__PURE__ */ a(ze, { align: "end", children: k })
        ] })
      ]
    }
  );
...
function Fd({
  ...
  const B = (O) => {
    ...
    l(Y), o == null || o(Y);
  }, V = e["%conflict_note_stale_notice%"] ?? "The verse has been edited since this conflict was recorded, so rejecting is no longer available. Accept keeps the current text.", P = y ? [
    {
      value: "merge",
  ...
  let C;
  T ? C = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : c || (C = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const S = () => {
    const O = i ?? "accept";
    return O === "merged" ? /* @__PURE__ */ a(Ta, { html: k }) : O === "reject" ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.rejectedResultText }) : /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: t.resultText });
  }, W = (O) => {
    const Y = v === O.value, st = `${f}-${O.value}`, U = h && O.value === "reject";
    return (
      ...
      m ? S() : /* @__PURE__ */ u(rt, { children: [
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: x.map((O) => h && O.value === "reject" ? /* @__PURE__ */ a(Ft, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
              /* @__PURE__ */ a(Ut, { asChild: !0, children: W(O) }),
              /* @__PURE__ */ a(qt, { side: "right", children: V })
            ] }) }, O.value) : W(O))
          }
        ),
...
function Bd({
  ...
  const [T, I] = N(tn), [C, S] = N(), [W, O] = N(), Y = o, [st, U] = N(!1), [Q, Et] = N(!1), [ht, zt] = N(!1), [K, ot] = N(!1), [bt, ct] = N(!1), [tt, Vt] = N(_), [kt, Ht] = N(!1), Lt = G(void 0), [R, ae] = N(/* @__PURE__ */ new Map()), $t = l.type === "Conflict", [oe, ne] = N("none"), [ie, $e] = N("accept"), [xe, Yt] = N(!1);
  X(() => {
    let z = !0;
    return (async () => {
  ...
  const H = j(() => e.filter((z) => !z.deleted), [e]);
  X(() => {
    let z = !0;
    if (!o || !k) {
      ae(/* @__PURE__ */ new Map());
  ...
  }, [$t, H, w]), xt = G(null), gt = G(void 0), ut = F(() => {
    var z;
    (z = gt.current) == null || z.call(gt), I(tn);
  }, []), ft = F(() => {
    const z = !tt;
  ...
  }, [i, r]), yt = j(() => H.slice(1), [H]), vt = j(() => yt.length ?? 0, [yt.length]), Tt = j(() => vt > 0, [vt]), Me = j(() => st || vt <= 2 ? yt : yt.slice(-2), [yt, vt, st]), Wt = j(() => st || vt <= 2 ? 0 : vt - 2, [vt, st]), Ge = j(
    () => vt === 1 ? mt.singleReply : _e(mt.multipleReplies, { count: vt }),
    [vt, mt]
  ), ye = j(
    () => Wt === 1 ? mt.singleReply : _e(mt.multipleReplies, { count: Wt }),
    [Wt, mt]
  );
  X(() => {
    !o && Q && Tt && Et(!1);
            ...
            o && /* @__PURE__ */ u(rt, { children: [
              ...
              v !== !1 && (!Q || te(T)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (z) => {
                    po(z) && (z.preventDefault(), z.stopPropagation(), (te(T) || C !== void 0 && C !== W) && Ae());
                  },
                  onKeyDown: (z) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      C !== void 0 && (te(T) || C !== W) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: _e(
                      ...
                      /* @__PURE__ */ u(Oe, { open: ht, onOpenChange: zt, children: [
                        /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
                          q,
                          {
                            size: "icon",
                        ...
                        /* @__PURE__ */ a(
                          Re,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(qe, { children: y == null ? void 0 : y.map((z) => /* @__PURE__ */ a(
                              Se,
                              {
                                onSelect: () => {
                                  S(z !== i ? z : void 0), $.current = "user-selected", O(void 0), zt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function sp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [A, B] = N(), [V, P] = N(), x = F(
    async (U) => {
      const Q = await i(U);
      return Q !== void 0 && U.assignedUser !== void 0 && U.assignedUser !== "" && P(U.assignedUser), Q;
    },
    [i]
  );
  X(() => {
    m && (_((U) => new Set(U).add(m)), B(m));
  }, [m]);
  const T = r.filter(
    (U) => U.comments.some((Q) => !Q.deleted)
  ), I = T.map((U) => ({ id: U.id })), C = F(
    (U) => {
      _((Q) => new Set(Q).add(U.id)), B(U.id), y == null || y(U.id);
    },
    [y]
  ), S = F(
    (U) => {
    ...
    (U) => {
      U.key === "Escape" ? (A && k.has(A) && (_((Q) => {
        const Et = new Set(Q);
        return Et.delete(A), Et;
      }), B(void 0), y == null || y(void 0)), U.preventDefault(), U.stopPropagation()) : Y(U);
    },
    [A, k, Y, y]
  );
  return /* @__PURE__ */ a(
...
function Ud({ table: t }) {
  return /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function Zd({
  ...
  let A;
  return d ? A = Array.from({ length: 10 }).map((x, T) => `skeleton-row-${T}`).map((x) => /* @__PURE__ */ a(le, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ee, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Ra, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, x)) : ((B = k.getRowModel().rows) == null ? void 0 : B.length) > 0 ? A = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    le,
    {
      onClick: () => s(V, k),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((P) => /* @__PURE__ */ a(ee, { children: xr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    V.id
  )) : A = /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a(ee, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Ud, { table: k }),
    /* @__PURE__ */ u(sa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ho, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(le, { children: V.headers.map((P) => /* @__PURE__ */ a(ta, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : xr(P.column.columnDef.header, P.getContext()) }, P.id)) }, V.id)) }),
      /* @__PURE__ */ a(ca, { children: A })
    ] }),
...
function fp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "default", children: [
...
function vi({
  ...
  const [D, E] = N(!1), k = F(
    (T) => {
      var C;
      const I = (C = t.find((S) => S.label === T)) == null ? void 0 : C.value;
      I && r(
    ...
    if (!f) return t;
    const T = t.filter((C) => C.starred).sort((C, S) => C.label.localeCompare(S.label)), I = t.filter((C) => !C.starred).sort((C, S) => {
      const W = e.includes(C.value), O = e.includes(S.value);
      return W && !O ? -1 : !W && O ? 1 : C.label.localeCompare(S.label);
    });
    return [...T, ...I];
  }, [t, e, f]), B = () => {
    r(t.map((T) => T.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Oe, { open: P, onOpenChange: w ?? E, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        variant: y,
    ...
    /* @__PURE__ */ a(Re, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ue, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: B, children: i }),
        /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: V, children: s })
      ] }),
      /* @__PURE__ */ u(qe, { children: [
        /* @__PURE__ */ a(ra, { children: c }),
        /* @__PURE__ */ a(he, { children: A.map((T) => /* @__PURE__ */ u(
          Se,
          {
            value: T.label,
            onSelect: k,
...
function sw({
  ...
  const i = G(null), s = G(null), c = G(!1), [d, l] = N(t), [w, p] = N(r), [f, h] = N(!1);
  X(() => {
    l(t);
  }, [t]), X(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Ee, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
function dw({
  ...
  return /* @__PURE__ */ u(Ee, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
...
function xp({
  ...
  const w = G(null), p = G(null), f = G(null), h = G(null);
  Zt(() => {
    if (!h.current) return;
    const { width: $ } = h.current.getBoundingClientRect();
    $ > 0 && (h.current.style.width = `${$}px`);
  }, []);
  const [m, y] = N("generated"), [v, D] = N("generated"), [E, k] = N("*"), [_, A] = N("*"), [B, V] = N("f"), [P, x] = N(!1), [T, I] = N(!0), [C, S] = N(!1), W = G(!1), O = G(""), [Y, st] = N(!1), [U, Q] = N(), [Et, ht] = N(), [zt, K] = N(), [ot, bt] = N(), ct = G(null), tt = j(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  X(() => {
    ...
    if (H && Ir("note", H)) {
      ...
      let gt = "custom";
      xt === ja ? gt = "generated" : xt === Fa ? gt = "hidden" : xt && (k(xt), A(xt)), y(gt), D(gt), V(((it = H.insert.note) == null ? void 0 : it.style) ?? "f"), $ = setTimeout(() => {
        var ut;
  ...
  const kt = F(
    ($, H, at = !1) => {
      ...
      if (it && Ir("note", it)) {
        if (it.insert.note) {
          let ft;
          $ === "custom" ? ft = H : $ === "generated" ? ft = ja : ft = Fa, it.insert.note.caller = ft;
        }
  ...
  const ae = () => {
    ...
    if (H && Ir("note", H)) {
      ...
      B !== "x" && $ === "x" ? ft == null || ft.forEach((mt) => gw(mt)) : B === "x" && $ !== "x" && (ft == null || ft.forEach((mt) => fw(mt))), (ut = w.current) == null || ut.applyUpdate([H, { delete: 1 }]);
    }
  }, ie = ($) => {
    bt($.contextMarker), S($.canRedo);
  }, $e = F(
    ($) => {
      var at, it, xt, gt, ut;
      const H = (it = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : it.at(0);
      if (H && Ir("note", H)) {
        ...
        I(JSON.stringify(H) === O.current), kt(m, E);
      } else
        x(!1), I(!0);
    },
    [m, E, kt]
    ...
    if (f.current && Vt.length && $ && $.rangeCount > 0) {
      const H = $.getRangeAt(0).getBoundingClientRect(), at = f.current.getBoundingClientRect();
      Q(H.left - at.left), ht(H.top - at.top), K(H.height), st(!0);
    }
  }, [Vt, f]);
  X(() => {
    const $ = () => {
    ...
    var at;
    const $ = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, H = (it) => {
      !Y && $ && document.activeElement === $ && it.key === c ? (it.preventDefault(), xe()) : Y && it.key === "Escape" && (it.preventDefault(), st(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
              ...
              /* @__PURE__ */ a(qt, { children: /* @__PURE__ */ a("p", { children: Yt }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(sa, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(ca, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ a(ee, { children: Ne(c.reference, "English") }),
...
function Sp({
  ...
  const h = we(r, "%webView_inventory_all%"), m = we(r, "%webView_inventory_approved%"), y = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), D = we(r, "%webView_inventory_scope_currentBook%"), E = we(r, "%webView_inventory_scope_chapter%"), k = we(r, "%webView_inventory_scope_verse%"), _ = we(r, "%webView_inventory_filter_text%"), A = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), B = we(r, "%webView_inventory_no_results%"), [V, P] = N(!1), [x, T] = N("all"), [I, C] = N(""), [S, W] = N([]), O = j(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : Tw(K, n, i);
  }, [t, n, i]), Y = j(() => {
    if (V) return O;
    const K = [];
    return O.forEach((ot) => {
      const bt = ot.items[0], ct = K.find(
        (tt) => tt.items[0] === bt
      );
  ...
  }, [V, O]), st = j(() => Y.length === 0 ? [] : Ew(Y, x, I), [Y, x, I]), U = j(() => {
    var bt, ct;
    if (!V) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(sr, { onValueChange: (K) => Et(K), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
        ...
        /* @__PURE__ */ a(qt, { children: (o == null ? void 0 : o.checkboxText) ?? A })
      ] }) })
    ] }),
...
function Rp({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = j(
    ...
    [t]
  ), E = p.length === 0 && f.length === 0 && h.length === 0, k = ke(n, "%resourcePicker_title%"), _ = ke(n, "%resourcePicker_search_placeholder%"), A = ke(n, "%resourcePicker_language_filter_any%"), B = ke(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = ke(n, "%resourcePicker_section_installed%"), P = ke(
    n,
    "%resourcePicker_section_available_to_download%"
  ), x = ke(n, "%resourcePicker_no_results%"), T = ke(n, "%resourcePicker_showing_count%"), I = j(() => {
    ...
    return _e(
      ke(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
        selectCount: d.length
      }
    );
  }, [d, D, A, n]), C = s.length > 0 || d.length > 0;
  return /* @__PURE__ */ u(rt, { children: [
    ...
    C && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: _e(T, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !E && !e && /* @__PURE__ */ a(sa, { children: /* @__PURE__ */ u(ca, { children: [
        ...
        /* @__PURE__ */ a(Da, { label: V, resources: f, onSelect: i }),
        /* @__PURE__ */ a(
          Da,
          {
            label: P,
...
const Ie = "scrBook", Fw = "scrRef", Xe = "source", Bw = "details", Uw = "Scripture Reference", qw = "Scripture Book", _i = "Type", Kw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Ne(n.start) : void 0;
      },
...
function Hp({
  ...
  X(() => {
    if (c) {
      ...
      if (T.length === 1) {
        const I = y.find((C) => dn(C) === T[0]) || void 0;
        I && c(I);
      }
    }
  }, [h, y, c, D]);
  const E = n ?? qw, k = i ?? _i, _ = [
  ...
  }, V = (x, T) => x.getIsGrouped() ? "" : g("banded-row", T % 2 === 0 ? "even" : "odd"), P = (x, T, I) => {
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(qd, { children: _.map((x) => /* @__PURE__ */ a(se, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
                    ...
                    children: C.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        children: [
                          ...
                          !x.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ a(Aa, {}) : /* @__PURE__ */ a(Ma, {})),
                          " ",
...
function Yw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
  ...
  }, [y, v] = N(!1), [D, E] = N(""), k = G(void 0), _ = G(!1), A = j(
    () => Ni(t),
    [t]
  ), B = j(() => {
    if (!D.trim()) {
    ...
    (C, S = !1) => {
      ...
      const W = A.findIndex((Q) => Q === k.current), O = A.findIndex((Q) => Q === C);
      if (W === -1 || O === -1) return;
      const [Y, st] = [
        Math.min(W, O),
        Math.max(W, O)
      ], U = A.slice(Y, st + 1).map((Q) => Q);
      r(
        e.includes(C) ? e.filter((Q) => !U.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...U])]
      );
    },
    [e, r, A]
  ), P = (C) => {
    V(C, _.current), _.current = !1;
  }, x = (C, S) => {
    C.preventDefault(), V(S, C.shiftKey);
  }, T = () => {
    r(A.map((C) => C));
  }, I = () => {
    r([]);
          ...
          Ue,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: T, children: d }),
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: I, children: l })
              ] }),
              /* @__PURE__ */ u(qe, { children: [
...
function Wp({
  ...
  const _ = Ot(
    s,
    "%webView_scope_selector_selected_text%"
  ), A = Ot(s, "%webView_scope_selector_verse%"), B = Ot(s, "%webView_scope_selector_chapter%"), V = Ot(s, "%webView_scope_selector_book%"), P = Ot(
    s,
    "%webView_scope_selector_current_verse%"
  ), x = Ot(
    s,
    "%webView_scope_selector_current_chapter%"
  ), T = Ot(s, "%webView_scope_selector_current_book%"), I = Ot(s, "%webView_scope_selector_choose_books%"), C = Ot(s, "%webView_scope_selector_scope%"), S = Ot(s, "%webView_scope_selector_select_books%"), W = Ot(s, "%webView_scope_selector_range%"), O = Ot(s, "%webView_scope_selector_select_range%"), Y = Ot(s, "%webView_scope_selector_range_start%"), st = Ot(s, "%webView_scope_selector_range_end%"), U = Ot(s, "%webView_scope_selector_ok%"), Q = Ot(s, "%webView_scope_selector_cancel%"), Et = Ot(s, "%webView_scope_selector_navigate%"), ht = (M) => {
    if (!m) return;
  ...
  ], K = (M, Z, jt = !1) => /* @__PURE__ */ u(rt, { children: [
    M,
    Z && !jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), ot = e ? zt.filter((M) => e.includes(M.value)) : zt, bt = m ?? ga, ct = w ?? bt, tt = p ?? bt, Vt = () => {
  }, kt = G(null), Ht = G(null), Lt = G(!1), R = G(null), ae = G(!1), [$t, oe] = N(void 0), ne = G(!1), ie = G(!1), $e = G(null), xe = F((M) => {
    if (M) {
    ...
    (M) => {
      f == null || f(M), h == null || h(M), ne.current = !0;
    },
    [f, h]
  ), H = F(
    (M) => {
      h == null || h(M), ie.current = !0;
    },
    [h]
  ), at = F(
    (M) => {
    ...
    [r, n, m, i]
  ), it = ot.find((M) => M.value === t), xt = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? cs(ct, tt, {
  ...
  ), ut = ot.find((M) => M.value === "selectedBooks"), ft = ot.find((M) => M.value === "range"), [mt, Dt] = N(!1), [yt, vt] = N(void 0), [Tt, Me] = N(void 0), [Wt, Ge] = N(void 0), [ye, Ae] = N(void 0), [Pe, He] = N([]), z = l === "dropdown" && yt === "selectedBooks", b = /* @__PURE__ */ a(
    Xw,
    {
      availableBookInfo: o,
  ...
  ), L = $t === "end", J = $t === "start", _t = "tw:text-muted-foreground", Qt = l === "dropdown" && yt === "range", tr = Qt ? Ge : $, Mt = Qt ? Ae : h ? H : Vt, Nt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-start", className: g(L && _t), children: Y }),
      /* @__PURE__ */ a(
        ma,
        {
    ...
    /* @__PURE__ */ u("div", { ref: kt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Ct, { htmlFor: "scope-range-end", className: g(J && _t), children: st }),
      /* @__PURE__ */ a(
        ma,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (M) => {
            var Z;
            ie.current && (ie.current = !1, M.preventDefault(), (Z = $e.current) == null || Z.focus());
          },
          className: g(J && _t),
          modal: !0,
          align: "start"
  ...
  X(() => {
    ...
    return () => {
      cancelAnimationFrame(Z), M && cancelAnimationFrame(M);
    };
  }, [mt, t]);
  ...
  const mo = F(
    (M) => {
      Me(M), Ge(ct), Ae(tt), He(n), Dt(!1), vt(M);
    },
    [ct, tt, n]
  ), vo = F(() => {
    Tt !== void 0 && (Tt === "range" ? (Wt && (f == null || f(Wt)), ye && (h == null || h(ye))) : Tt === "selectedBooks" && i(Pe), at(Tt), vt(void 0), Me(void 0));
  }, [
    Tt,
    Wt,
    ye,
    ...
    M || (vt(void 0), Me(void 0));
  }, []), bo = F((M) => {
    var Z;
    M.preventDefault(), (Z = Xt.current) == null || Z.focus();
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(Ee, { open: mt, onOpenChange: Dt, children: [
        ...
        /* @__PURE__ */ a(
          ze,
          {
            ...
            children: /* @__PURE__ */ u(ua, { container: $r, children: [
              gt.map(({ value: M, label: Z, dropdownLabel: jt, scrRefSuffix: gr, id: Vi }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: pt(M),
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (M) => {
                          const Z = M.target instanceof HTMLElement ? M.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          ma,
                          {
                            ...
                            onCloseAutoFocus: (M) => {
                              var Z;
                              M.preventDefault(), (Z = R.current) == null || Z.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(rt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(m ?? ga, "id") }),
                              /* @__PURE__ */ a(nr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        ao,
        {
          ...
          children: ot.map(({ value: M, label: Z, scrRefSuffix: jt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Yr, { className: "tw:me-2", value: M, id: gr }),
            /* @__PURE__ */ a(Ct, { htmlFor: gr, children: K(Z, jt) })
          ] }, gr))
        }
      )
    ] }),
    ...
    l === "dropdown" && ut && /* @__PURE__ */ a(Ba, { open: yt === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ua,
      {
        ...
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (M) => {
          Rr != null && Rr.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: Rr, children: [
          /* @__PURE__ */ a(Gr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Hr, { children: I }) }),
          b,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: Q }),
            /* @__PURE__ */ a(q, { onClick: vo, children: U })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ft && /* @__PURE__ */ a(Ba, { open: yt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ua,
      {
        ...
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (M) => {
          Jt != null && Jt.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(ua, { container: Jt, children: [
          /* @__PURE__ */ a(Gr, { className: "tw:pe-8", children: /* @__PURE__ */ a(Hr, { children: O }) }),
          Nt,
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: Q }),
            /* @__PURE__ */ a(q, { ref: $e, onClick: vo, children: U })
          ] })
        ] })
      }
    ) })
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ee, { variant: i, children: [
    /* @__PURE__ */ a(Te, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(js, {}) }) }),
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: wr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(_n, { children: [
...
function nh({
  ...
  const l = wu(
    ...
    return v ? `${(A = t[m]) == null ? void 0 : A.autonym} (${v})` : (B = t[m]) == null ? void 0 : B.autonym;
  };
  return /* @__PURE__ */ u("div", { id: d, className: g("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Ct, { className: "tw:font-normal tw:text-muted-foreground", children: _e(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ee, { children: [
              /* @__PURE__ */ a(Te, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
