...
var Lt = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Ae, a as Ua, C as De, A as de, P as je, b as Qe, B as q, d as Le, e as Be, f as Fe, h as Ee, i as ji, k as Li, j as Bi, E as Fi, l as Ka, r as be, m as Ui, n as wn, o as ta, p as ea, L as Et, R as qa, q as Gr, D as Ca, s as Ea, t as Ta, u as za, T as un, v as jr, w as Ut, x as Ga, y as Kt, z as qt, F as Gt, G as pn, H as Ha, I as We, J as kr, K as Te, M as ze, N as Se, S as _r, O as nr, Q as Ki, U as Er, V as Je, W as Pe, Z as tr, X as Ie, Y as ir, _ as Ya, $ as Wa, a0 as Hr, a1 as Xa, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as Sa, a7 as gn, a8 as ra, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as ca, ah as yo, ai as la, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as Tr, ap as Ja, aq as os, ar as ns } from "./resizable-C2eEiE_z.js";
import { as as Zh, at as Qh, au as tg, av as eg, aw as rg, ax as ag, ay as og, az as ng, aA as ig, aB as sg, aC as cg, aD as lg, aE as dg, aF as wg, aG as ug, aH as pg, aI as hg, aJ as gg, aK as fg, aL as mg, aM as vg, aN as bg, aO as xg, aP as yg, aQ as kg } from "./resizable-C2eEiE_z.js";
...
import { Section as ut, getChaptersForBook as Vs, formatScrRef as Ne, getSectionForBook as br, formatRelativeDate as js, formatReplacementString as Xe, sanitizeHtml as Qa, NumberFormat as Nn, formatBytes as Ls, getCurrentLocale as Bs, usfmMarkers as Lr, getFormatCallerFunction as Fs, deepEqual as Us, isString as Eo, compareScrRefs as Ma, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as To, formatReplacementStringToArray as zo, collectUsjMarkers as qs } from "platform-bible-utils";
import Zt, { useRef as F, useMemo as $, useState as k, useCallback as j, useEffect as K, useImperativeHandle as Gs, useLayoutEffect as Qt, createContext as to, useContext as Cn, Component as Hs, createElement as So, Suspense as Ys, forwardRef as En, useId as Ro, Fragment as aa } from "react";
...
import { Avatar as oo, Select as Ft, Checkbox as $o, Slot as Sr, Tabs as we, Menubar as xe, ContextMenu as Ot, Progress as Ao, Slider as Or, Switch as Io } from "radix-ui";
import { useReactTable as Bn, getFilteredRowModel as Qc, getSortedRowModel as Fn, getPaginationRowModel as tl, getCoreRowModel as Un, flexRender as xr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Pa, getDefaultViewOptions as ol, isInsertEmbedOpOfType as Mr, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
function ll({
  ...
  return /* @__PURE__ */ u(je, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Le, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ee, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      De,
      {
        onSelect: () => h(g),
...
function pa({
  ...
  const B = be(), [z, _] = k(!1), [T, N] = k(""), [M, U] = k(""), [y, Y] = k("books"), [L, W] = k(void 0), [O, V] = k(
    void 0
  ), [X, Q] = k(void 0), [pt, yt] = k(!1), It = F(null), G = F(!1), tt = F(void 0), ht = F(void 0), at = F(void 0), mt = F(void 0), ue = F({}), Tt = F({}), kt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Pt = $(() => o ? o() : Ui, [o]), Vt = $(() => ({
    [ut.OT]: Pt.filter((H) => xt.isBookOT(H)),
    [ut.NT]: Pt.filter((H) => xt.isBookNT(H)),
    [ut.DC]: Pt.filter((H) => xt.isBookDC(H)),
    [ut.Extra]: Pt.filter((H) => xt.extraBooks().includes(H))
  }), [Pt]), gt = $(() => Object.values(Vt).flat(), [Vt]), Ht = $(() => {
    if (!M.trim()) return Vt;
    const x = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((rt) => {
      x[rt] = Vt[rt].filter((At) => Ka(At, M, n));
    }), x;
  }, [Vt, M, n]), D = $(
    () => hl(M, gt, n),
    [M, gt, n]
  ...
  const dt = j(() => {
    ...
    (x) => {
      const H = y === "chapters" ? L : D == null ? void 0 : D.book;
      if (H) {
        if (d && d(H, x) > 1) {
          V(H), Q(x), Y("verses"), N("");
          return;
  ...
  K(() => {
    var x;
    St !== 0 && ((x = ht.current) == null || x.focus());
  }, [St]), Gs(
    R,
    () => ({
      open: () => {
  ...
  const { otLong: ne, ntLong: Wt, dcLong: pe, extraLong: A } = {
    ...
    () => ul(M),
    [M]
  ), ct = $(() => !d || !D || !D.chapterNum || !et ? !1 : d(D.book, D.chapterNum) > 0, [d, D, et]), bt = j(
    (x) => w ? Po(x, w) : !1,
    [w]
  ), Rt = j(
    (x) => (H) => w ? pl(x, H, w) : !1,
    ...
    [w]
  ), Xt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", ce = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Rr = j(
    (x) => {
    ...
    (x) => {
      ...
      if ((y === "chapters" || y === "verses") && (x.key === " " || x.key === "Enter")) {
        const zt = x.target instanceof HTMLElement ? x.target : void 0;
      ...
      const At = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (y === "verses" && At) {
        const zt = O, Nt = X;
        if (!zt || !Nt || !d) return;
        const Ct = d(zt, Nt);
      ...
      if ((y === "chapters" || y === "books" && D) && At) {
        const zt = y === "chapters" ? L : D == null ? void 0 : D.book;
        if (!zt) return;
  ...
  return Qt(() => {
    const x = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const H = at.current, rt = mt.current, At = rt.offsetTop, _e = H.clientHeight, Me = rt.clientHeight, qe = At - _e / 2 + Me / 2;
        H.scrollTo({
          top: Math.max(0, qe),
          behavior: "smooth"
        }), N(qn(t.book));
    ...
    if (y === "chapters" && L) {
      const x = L === t.book, H = x ? t.chapterNum : 1;
      N(
        `${L} ${de[L] || ""} ${H}`
      ), setTimeout(() => {
        if (at.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: z, onOpenChange: Mt, modal: S, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        ...
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: lt }),
          f && /* @__PURE__ */ a(
            Tn,
            {
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: H } = x;
          z && It.current && H instanceof Node && It.current.contains(H) && (G.current = !0, Mt(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Be,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ke.map(
                  ({ onClick: x, disabled: H, title: rt, icon: At }) => /* @__PURE__ */ a(
                    q,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                y === "chapters" && L && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ae(L, n) }),
              ...
              !pt && /* @__PURE__ */ u(Fe, { ref: at, children: [
                y === "books" && /* @__PURE__ */ u(st, { children: [
                  !D && Object.entries(Ht).map(([x, H]) => {
                    if (H.length !== 0)
                      return (
                  ...
                  D && ct && D.chapterNum && d && /* @__PURE__ */ u(st, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: Yt,
                        setVerseRef: ot,
                        isVerseDisabled: $t(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !ct && sr(D.book) > 1 && /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                    ...
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        setChapterRef: E,
                        isChapterDimmed: nt,
                        isChapterDisabled: Rt(D.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                y === "chapters" && L && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: L,
                    scrRef: t,
...
function Bo({
  ...
  return /* @__PURE__ */ u(je, { open: R, onOpenChange: P, ...C, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        children: /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(ta, { placeholder: h, className: "tw:text-inherit" }),
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Yn ? Qt : K, Ar = { tag: eo };
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((z || _) && P !== null && B !== null) {
        const T = function(N, M, U, y, Y, L, W) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Fo(M, U, y)), O.setEnd(...Fo(Y, L, W)), O;
        }(t, h, f, P, g, S, B);
        l(), l = Ol(t, T, e);
      }
...
function Il(t) {
  const e = Mn(t, (r) => Nr(r) && !r.isInline());
  return Nr(e) || Yr(4, t.__key), e;
}
function Pl(t) {
  const e = te() || nc();
  let r;
...
function Vl(t, e, r) {
  ...
  return hc(o) && Yr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(On(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = te();
  if (!me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Mn(i, (d) => Nr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Wr, Ce = 0, Xr = 0, Fl = 0, ja = 0, Fr = 0;
function Ko(t) {
  if (it === void 0) return;
  let e = t.n;
...
function He(t, e) {
  Bt.call(this, void 0), this.x = t, this.s = void 0, this.g = Fr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Ul(t, e) {
  return new He(t, e);
}
...
Bt.prototype.brand = Ll, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ce !== 0 && Xr === 0 && e.l !== ja && (e.l = ja, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, Fr++, Ce++;
    try {
...
se({ build: (t, e, r) => gr(e), config: er({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Qn() {
  const t = Ve(), e = te(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), me(e) && (e.format = 0);
}
function ti(t, e = Qn) {
  return t.registerCommand($n, (r) => (t.update(e), !0), ro);
}
se({ build: (t, e, r) => gr(e), config: er({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const La = se({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const lo = 0, Ba = 1, oi = 2, ma = 3, Ir = 4, ar = 5, va = 6, mr = 7;
function ba(t) {
  return t.id === lo;
}
function ni(t) {
...
class Wl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && wt(307, String(r.id), String(ar)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ir;
    }(e) || wt(313, String(e.id), String(Ir)), e.initResult;
  }
  getInitPeer(e) {
...
const Ql = /* @__PURE__ */ new Set(), Wo = se({ build(t, e, r) {
  const o = r.getDependency(La).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => ve(() => {
...
}, dependencies: [La], name: "@lexical/extension/NodeSelection" }), td = _c("INSERT_HORIZONTAL_RULE_COMMAND");
class dr extends $a {
  static getType() {
...
se({ dependencies: [La, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [dr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Wo).output, n = Cr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Re(t.registerCommand(td, (s) => {
    ...
    return !1;
  }, Pn), t.registerMutationListener(dr, (s, c) => {
    Bl(() => {
      let l = !1;
...
se({ build: (t, e) => gr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: er({ $getParentEditor: function() {
  const t = Sc();
...
se({ build: (t, e, r) => gr(e), config: er({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ve(() => {
...
se({ build: (t, e, r) => gr(e), config: er({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
se({ build: (t, e, r) => gr(e), config: er({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ve(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function cd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function wd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    uo(() => Re(Hc(n), ci(n)), [n]);
  }(o), u(st, { children: [t, a(ud, { content: e }), a(dd, { editor: o, ErrorBoundary: r })] });
}
...
function fd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: v = "textbox", spellCheck: S = !0, style: C, tabIndex: R, "data-testid": P, ...B }, z) {
  const [_, T] = k(t.isEditable()), N = j((U) => {
...
function bd(t, e) {
  ...
  return u(st, { children: [a(md, { editor: n, ...o, ref: e }), r != null && a(xd, { editor: n, content: r })] });
}
...
function Ed() {
  const { activeEditor: t } = wi(), [e, r] = k([]), o = j((n) => {
    if (me(n) || Xc(n)) {
      const i = [];
      Zo.forEach(({ format: s }) => {
...
function gi({
  ...
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      ...
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(pn, {}),
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
const Dd = "verseText", Qu = Object.freeze([
...
function xi({
  ...
  const [y, Y] = k(en), [L, W] = k(), [O, V] = k(), X = o, [Q, pt] = k(!1), [yt, It] = k(!1), [G, tt] = k(!1), [ht, at] = k(!1), [mt, ue] = k(!1), [Tt, kt] = k(P), [Pt, Vt] = k(!1), gt = F(void 0), [Ht, D] = k(/* @__PURE__ */ new Map());
  K(() => {
    let E = !0;
    return (async () => {
  ...
  const Yt = $(() => dt[0], [dt]), Oe = F(null), ee = F(void 0), re = j(() => {
    var E;
    (E = ee.current) == null || E.call(ee), Y(en);
  }, []), ke = j(() => {
    const E = !Tt;
    kt(E), Vt(!E), f == null || f(l, E);
  }, [Tt, f, l]);
  K(() => {
    pt(!1);
  }, [o]), K(() => {
  ...
  }, [i, r]), Mt = $(() => dt.slice(1), [dt]), St = $(() => Mt.length ?? 0, [Mt.length]), oe = $(() => St > 0, [St]), ne = $(() => Q || St <= 2 ? Mt : Mt.slice(-2), [Mt, St, Q]), Wt = $(() => Q || St <= 2 ? 0 : St - 2, [St, Q]), pe = $(
    () => St === 1 ? _t.singleReply : Xe(_t.multipleReplies, { count: St }),
    [St, _t]
  ), A = $(
  ...
  const J = j(
    ...
    async (E) => {
      const ot = ie(y) ? Zr(y) : void 0, et = E.status ? E.assignedUser : L ?? E.assignedUser, ct = await p({
        ...E,
        contents: ot,
        assignedUser: et
      });
      return ct && (et !== void 0 && V(et), ot && re()), ct;
    },
    [re, y, p, L]
  );
  ...
  const lt = /* @__PURE__ */ a(
    tn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: It,
      canEditOrDelete: (!yt && Ht.get(Yt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Ad, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ae && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: ae }),
            /* @__PURE__ */ a(
              q,
              {
                variant: "ghost",
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("span", { className: t, children: [
                  Yt.contextBefore,
                  /* @__PURE__ */ a("span", { className: "tw:font-bold", children: Yt.selectedText }),
                  Yt.contextAfter
                ] })
              ]
            }
          ...
          o && /* @__PURE__ */ u(st, { children: [
            ...
            ne.map((E) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              tn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: It,
                canEditOrDelete: (!yt && Ht.get(E.id)) ?? !1
              }
            ) }, E.id)),
            v !== !1 && (!yt || ie(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (E) => {
                  ho(E) && (E.preventDefault(), E.stopPropagation(), (ie(y) || L !== void 0 && L !== O) && J());
                },
                onKeyDown: (E) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    L !== void 0 && (ie(y) || L !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Xe(
                    ...
                    /* @__PURE__ */ u(je, { open: G, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                        q,
                        {
                          size: "icon",
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Kr = (t) => jd(Qa(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Ld({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), y = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : U, Y = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: S }) : U : y(O === "reject" ? t.rejectedResultText : t.resultText);
  }, L = (O) => p && O.value === "reject", W = (O) => {
    const V = f === O.value, X = `${d}-${O.value}`, Q = L(O);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(st, { children: [
        ...
        /* @__PURE__ */ a(
          qa,
          {
            ...
            children: z.map((O) => L(O) ? /* @__PURE__ */ a(Ut, { delayDuration: 0, children: /* @__PURE__ */ u(Kt, { children: [
              /* @__PURE__ */ a(qt, { asChild: !0, children: W(O) }),
              /* @__PURE__ */ a(Gt, { children: P })
            ] }) }, O.value) : W(O))
          }
        ),
        /* @__PURE__ */ a(Ut, { delayDuration: 0, children: /* @__PURE__ */ u(Kt, { children: [
...
function lp({
  ...
  const [C, R] = k(/* @__PURE__ */ new Set()), [P, B] = k(), [z, _] = k(), T = j(
    async (V) => {
      const X = await i(V);
  ...
  const N = r.filter(
    ...
    [C, b]
  ), { listboxRef: Y, activeId: L, handleKeyDown: W } = Ki({
    options: M,
    onOptionSelect: U
  }), O = j(
    (V) => {
...
function pr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(Tn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function le({
  ...
  return /* @__PURE__ */ u(
    Ft.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ft.ItemIndicator, { children: /* @__PURE__ */ a(oa, { className: "tw:pointer-events-none" }) }) }),
...
function Jd({
  ...
  return l ? B = Array.from({ length: 10 }).map((N, M) => `skeleton-row-${M}`).map((N) => /* @__PURE__ */ a(Ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((z = R.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = R.getRowModel().rows.map((_) => /* @__PURE__ */ a(
    Ie,
    {
      ...
      children: _.getVisibleCells().map((T) => /* @__PURE__ */ a(ir, { children: xr(T.column.columnDef.cell, T.getContext()) }, T.id))
    },
    _.id
    ...
    /* @__PURE__ */ u(Ya, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Wa, { stickyHeader: i, children: R.getHeaderGroups().map((_) => /* @__PURE__ */ a(Ie, { children: _.headers.map((T) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: T.isPlaceholder ? void 0 : xr(T.column.columnDef.header, T.getContext()) }, T.id)) }, _.id)) }),
...
function gp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    ...
    /* @__PURE__ */ a(Se, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(st, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Pe,
        {
          checked: o[w][h],
...
function ow({
  ...
  return /* @__PURE__ */ u(Ga, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      ...
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u("p", { children: [
        d,
...
const iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(st, { children: [
...
function sw({
  ...
  return /* @__PURE__ */ u(Te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Se,
      {
...
const cw = (t, e) => t === "f" ? /* @__PURE__ */ u(st, { children: [
  /* @__PURE__ */ a(kn, {}),
  " ",
...
function dw({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
...
function gw(t, e) {
  ...
  let o, n = 0;
  const i = e === "end" ? Number.POSITIVE_INFINITY : e.utf16Offset;
  let s = r.nextNode();
  for (; s; ) {
    const d = s, { length: w } = d.data;
    if (n + w >= i) {
      const p = window.getSelection();
      p == null || p.removeAllRanges();
      const h = document.createRange();
      return h.setStart(d, i - n), h.collapse(!0), p == null || p.addRange(h), !0;
    }
    n += w, o = d, s = r.nextNode();
  }
  if (!o) return !1;
  const c = window.getSelection();
  c == null || c.removeAllRanges();
  const l = document.createRange();
  return l.setStart(o, o.data.length), l.collapse(!0), c == null || c.addRange(l), !0;
}
function fw(t) {
  var r;
...
function bp({
  ...
  const [C, R] = k("generated"), [P, B] = k("generated"), [z, _] = k("*"), [T, N] = k("*"), [M, U] = k("f"), [y, Y] = k(!1), [L, W] = k(!0), [O, V] = k(!1), X = F(!1), Q = F(""), [pt, yt] = k(!1), [It, G] = k(), [tt, ht] = k(), [at, mt] = k(), [ue, Tt] = k(), kt = F(null), Pt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (nt && Mr("note", nt)) {
      const ot = (lt = nt.insert.note) == null ? void 0 : lt.caller;
      let et = "custom";
      ot === Ia ? et = "generated" : ot === Pa ? et = "hidden" : ot && (_(ot), N(ot)), R(et), B(et), U(((E = nt.insert.note) == null ? void 0 : E.style) ?? "f"), A = setTimeout(() => {
        ...
        const ct = S.current;
        ct !== void 0 && (J = setTimeout(() => {
          var $t, Xt;
          const Rt = (($t = g.current) == null ? void 0 : $t.querySelector(".editor-input")) ?? void 0;
          Rt && ((Xt = h.current) == null || Xt.focus(), gw(Rt, ct));
        }, 0));
      }, 0);
    }
    return () => {
      A && clearTimeout(A), J && clearTimeout(J);
    };
  }, [e]);
  const gt = j(
    (A, J, nt = !1) => {
      var E, ot, et;
      const lt = (ot = (E = h.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (lt && Mr("note", lt)) {
        if (lt.insert.note) {
          let ct;
          A === "custom" ? ct = J : A === "generated" ? ct = Ia : ct = Pa, lt.insert.note.caller = ct;
        }
        r == null || r([lt]), nt && d && v.current && ((et = d.current) == null || et.replaceEmbedUpdate(v.current, [lt]));
      }
    },
    [r, d]
  ), Ht = F(void 0), D = F({ callerType: C, customCaller: z });
  K(() => {
  ...
  const dt = j(() => {
    Ht.current !== void 0 && (clearTimeout(Ht.current), Ht.current = void 0);
  }, []), Yt = j(() => {
    if (Ht.current === void 0) return;
    dt();
    const { callerType: A, customCaller: J } = D.current;
    vt.current(A, J, !0);
  }, [dt]), Oe = j(() => {
    dt(), Ht.current = setTimeout(() => {
      Ht.current = void 0;
      const { callerType: A, customCaller: J } = D.current;
      vt.current(A, J, !0);
    }, vw);
  ...
  const _t = () => {
    ...
    var nt, lt, E, ot, et;
    U(A);
    const J = (lt = (nt = h.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : lt.at(0);
    if (J && Mr("note", J)) {
      J.insert.note && (J.insert.note.style = A);
      const ct = (ot = (E = J.insert.note) == null ? void 0 : E.contents) == null ? void 0 : ot.ops;
      M !== "x" && A === "x" ? ct == null || ct.forEach((bt) => fw(bt)) : M === "x" && A !== "x" && (ct == null || ct.forEach((bt) => mw(bt))), (et = h.current) == null || et.applyUpdate([J, { delete: 1 }]);
    }
  }, oe = (A) => {
    ...
    (A) => {
      ...
      if (J && Mr("note", J)) {
        A.content.length > 1 && setTimeout(() => {
          var Rt;
          (Rt = h.current) == null || Rt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const ct = (E = J.insert.note) == null ? void 0 : E.style, bt = (et = (ot = J.insert.note) == null ? void 0 : ot.contents) == null ? void 0 : et.ops;
        if (ct || Y(!1), Y(
          ct === "x" ? !!(bt != null && bt.every((Rt) => {
            var Xt, ce;
            if (!((Xt = Rt.attributes) != null && Xt.char)) return !0;
            const $t = ((ce = Rt.attributes) == null ? void 0 : ce.char).style;
    ...
    if (f.current && Vt.length && A && A.rangeCount > 0) {
  ...
  K(() => {
    ...
    var nt;
    const A = ((nt = g.current) == null ? void 0 : nt.querySelector(".editor-input")) ?? void 0, J = (lt) => {
      !pt && A && document.activeElement === A && lt.key === c ? (lt.preventDefault(), Wt()) : pt && lt.key === "Escape" && (lt.preventDefault(), yt(!1));
    };
  ...
  return /* @__PURE__ */ u(st, { children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
                  ...
                  /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ a("p", { children: pe }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(je, { open: pt, children: [
      /* @__PURE__ */ a(
        Wi,
        {
          className: "tw:absolute",
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: xw(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function yp({
  ...
  const g = l ?? Fs(r, void 0), f = h ? p : void 0, b = F([]), v = (_, T, N) => {
    ...
    if (r.length && !(f !== void 0 && _.target instanceof HTMLElement && _.target.closest('li[data-state="editing"]')))
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), R((T) => Vr(T, 1, B, f));
          break;
        case "ArrowUp":
          _.preventDefault(), R((T) => Vr(T, -1, B, f));
          break;
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: r.map((_, T) => {
            const N = _ === i, M = `${n}-${T}`, U = T === p && !!h, y = T < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(_r, { tabIndex: -1, className: "tw:col-span-2" });
            return U ? /* @__PURE__ */ u(st, { children: [
              /* @__PURE__ */ a(
                "li",
                {
                  "data-state": "editing",
    ...
    /* @__PURE__ */ a(Xa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ie,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ir, { className: o, children: _w(c.text) })
        ]
      },
...
const Cw = (t) => {
...
}, ia = (t, e, r) => /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
  /* @__PURE__ */ u(
    qt,
    {
  ...
  /* @__PURE__ */ a(Gt, { side: "bottom", children: e })
] }) }), kp = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Tw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", zp = Object.freeze([
...
function Sp({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), b = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), S = ge(r, "%webView_inventory_scope_currentBook%"), C = ge(r, "%webView_inventory_scope_chapter%"), R = ge(r, "%webView_inventory_scope_verse%"), P = ge(r, "%webView_inventory_filter_text%"), B = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = ge(r, "%webView_inventory_no_results%"), [_, T] = k(!1), [N, M] = k("all"), [U, y] = k(""), [Y, L] = k([]), W = $(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Sw(G, n, i);
  }, [t, n, i]), O = $(() => {
    if (_) return W;
    const G = [];
    return W.forEach((tt) => {
  ...
  }, [_, W]), V = $(() => O.length === 0 ? [] : zw(O, N, U), [O, N, U]), X = $(() => {
    var ht, at;
    if (!_) return l;
  ...
  K(() => {
    V.length === 0 ? L([]) : V.length === 1 && L(V[0].items);
  }, [V]);
  const Q = (G, tt) => {
    tt.setRowSelection(() => {
      const at = {};
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(wr, { onValueChange: (G) => pt(G), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
        ...
        /* @__PURE__ */ a(Gt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Rw = "16rem", Dw = "3rem", _i = Zt.createContext(void 0);
function sa() {
...
function jw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = sa(), d = /* @__PURE__ */ a(
    c,
    {
  ...
  return n ? /* @__PURE__ */ u(Kt, { children: [
    /* @__PURE__ */ a(qt, { asChild: !0, children: d }),
    /* @__PURE__ */ a(
      Gt,
      {
        side: "right",
    ...
    Mw,
    {
      ...
      children: /* @__PURE__ */ u(Aw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Pw, { children: /* @__PURE__ */ a(
            jw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const $e = "scrBook", Bw = "scrRef", Ye = "source", Fw = "details", Uw = "Scripture Reference", Kw = "Scripture Book", Ni = "Type", qw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, ln = (t) => `${Hw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Kp({
  sources: t,
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: P.map((N) => /* @__PURE__ */ a(le, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ya, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Wa, { children: S.getHeaderGroups().map((N) => /* @__PURE__ */ a(Ie, { children: N.headers.filter((M) => M.column.columnDef.header).map((M) => (
        ...
        /* @__PURE__ */ a(Hr, { colSpan: M.colSpan, className: "tw:sticky top-0", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          xr(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, N.id)) }),
...
function Yw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
    ...
    (y, Y = !1) => {
      ...
      const L = B.findIndex((Q) => Q === R.current), W = B.findIndex((Q) => Q === y);
      if (L === -1 || W === -1) return;
      const [O, V] = [
        Math.min(L, W),
        Math.max(L, W)
  ...
  return /* @__PURE__ */ u(
    je,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Le, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Be,
          {
            shouldFilter: !1,
            onKeyDown: (y) => {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === _a ? _a : dn
      ).map((l) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ae(l, n) }, l)),
...
function Gp({
  ...
  const P = Dt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), M = Dt(s, "%webView_scope_selector_current_book%"), U = Dt(s, "%webView_scope_selector_choose_books%"), y = Dt(s, "%webView_scope_selector_scope%"), Y = Dt(s, "%webView_scope_selector_select_books%"), L = Dt(s, "%webView_scope_selector_range%"), W = Dt(s, "%webView_scope_selector_select_range%"), O = Dt(s, "%webView_scope_selector_range_start%"), V = Dt(s, "%webView_scope_selector_range_end%"), X = Dt(s, "%webView_scope_selector_ok%"), Q = Dt(s, "%webView_scope_selector_cancel%"), pt = Dt(s, "%webView_scope_selector_navigate%"), yt = (I) => {
    if (!f) return;
  ...
  ], G = (I, Z, Jt = !1) => /* @__PURE__ */ u(st, { children: [
    I,
    Z && !Jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), tt = e ? It.filter((I) => e.includes(I.value)) : It, ht = f ?? wa, at = w ?? ht, mt = p ?? ht, ue = () => {
  }, Tt = F(null), kt = F(null), Pt = F(!1), Vt = F(null), gt = F(!1), [Ht, D] = k(void 0), vt = F(!1), dt = F(!1), Yt = F(null), Oe = j((I) => {
    if (I) {
    ...
    [r, n, f, i]
  ), ae = tt.find((I) => I.value === t), Mt = () => t === "selectedBooks" && n.length > 0 ? n.map((I) => I.toUpperCase()).join(", ") : t === "range" ? Ks(at, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ae ? G(ae.label, ae.scrRefSuffix) : t, St = tt.filter(
    (I) => I.value !== "selectedBooks" && I.value !== "range"
  ), oe = tt.find((I) => I.value === "selectedBooks"), ne = tt.find((I) => I.value === "range"), [Wt, pe] = k(!1), [A, J] = k(void 0), [nt, lt] = k(void 0), [E, ot] = k(void 0), [et, ct] = k(void 0), [bt, Rt] = k([]), $t = d === "dropdown" && A === "selectedBooks", Xt = /* @__PURE__ */ a(
    Xw,
    {
      availableBookInfo: o,
      selectedBookIds: $t ? bt : n,
      onChangeSelectedBookIds: $t ? Rt : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), ce = Ht === "end", Rr = Ht === "start", rr = "tw:text-muted-foreground", Ke = d === "dropdown" && A === "range", x = Ke ? ot : re, rt = Ke ? ct : g ? ke : ue, At = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Tt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Rr && rr), children: V }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          onCloseAutoFocus: (I) => {
            var Z;
            dt.current && (dt.current = !1, I.preventDefault(), (Z = Yt.current) == null || Z.focus());
          },
          className: m(Rr && rr),
          modal: !0,
          align: "start"
  ...
  const mo = j(
    (I) => {
      lt(I), ot(at), ct(mt), Rt(n), pe(!1), J(I);
    },
    [at, mt, n]
  ), vo = j(() => {
    nt !== void 0 && (nt === "range" ? (E && (h == null || h(E)), et && (g == null || g(et))) : nt === "selectedBooks" && i(bt), _t(nt), J(void 0), lt(void 0));
  }, [
    nt,
    E,
    et,
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(Te, { open: Wt, onOpenChange: pe, children: [
        /* @__PURE__ */ a(ze, { asChild: !0, children: /* @__PURE__ */ u(
          q,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Mt() }),
              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Se,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: jt, children: [
              St.map(({ value: I, label: Z, dropdownLabel: Jt, scrRefSuffix: fr, id: Ii }) => /* @__PURE__ */ u(
                We,
                {
                  ref: Me(I),
              ...
              b && /* @__PURE__ */ u(st, { children: [
                /* @__PURE__ */ a(Je, {}),
                /* @__PURE__ */ a(Er, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  We,
                  {
                    ref: Vt,
                    ...
                    onSelect: (I) => {
                      var Z, Jt;
                      if (I.preventDefault(), Pt.current) {
                        Pt.current = !1;
                        return;
                      }
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (I) => {
                          ...
                          Z != null && Z.closest("button") && (Pt.current = !0, requestAnimationFrame(() => {
                            Pt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (I) => {
                              var Z;
                              I.preventDefault(), (Z = Vt.current) == null || Z.focus();
                            },
                            modal: !0,
        ...
        qa,
        {
          ...
          children: tt.map(({ value: I, label: Z, scrRefSuffix: Jt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: I, id: fr }),
            /* @__PURE__ */ a(Et, { htmlFor: fr, children: G(Z, Jt) })
          ] }, fr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && At,
    d === "dropdown" && oe && /* @__PURE__ */ a(Ca, { open: A === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: ft,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Ct, children: [
          ...
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Q }),
            /* @__PURE__ */ a(q, { onClick: vo, children: X })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && ne && /* @__PURE__ */ a(Ca, { open: A === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ea,
      {
        ref: Nt,
        onCloseAutoFocus: bo,
        ...
        children: /* @__PURE__ */ u(ca, { container: zt, children: [
          /* @__PURE__ */ a(Ta, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: W }) }),
          At,
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Dr(!1), children: Q }),
            /* @__PURE__ */ a(q, { ref: Yt, onClick: vo, children: X })
          ] })
        ] })
      }
    ) })
...
const zi = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Kt, { children: [
  ...
  c.tooltip && /* @__PURE__ */ a(Gt, { children: c.tooltip })
...
function Fa({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Se, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Ut, { children: zi(e.groups, e.items, l, t) }) }),
...
const Qw = Zt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Trigger,
  {
    ref: r,
    ...e,
...
function Qp({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ri, { children: [
      /* @__PURE__ */ a(Di, { children: t.map((c) => /* @__PURE__ */ a(Qw, { value: c.value, children: c.value }, c.key)) }),
...
const vr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        nu,
        {
          onClick: () => {
            o(d);
      ...
      d.tooltip && /* @__PURE__ */ a(Gt, { children: d.tooltip })
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (S = l.current) == null || S.focus(), vr(l, [h, g]);
        break;
    }
  }), K(() => {
    ...
    return /* @__PURE__ */ a(tu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(eu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: tr },
          children: /* @__PURE__ */ a(Ut, { children: Mi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ch({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function dh({ currentStep: t, totalSteps: e, locale: r }) {
  const o = r || "en", n = $(() => {
    const c = new Nn(o);
    return (l) => c.format(l);
...
export {
  ...
  kw as FootnoteItem,
  yp as FootnoteList,
  vw as INLINE_APPLY_DEBOUNCE_MS,
  ah as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  ...
  Fp as SidebarMenuSubButton,
  Bp as SidebarMenuSubItem,
  Ow as SidebarProvider,
  Dp as SidebarRail,
  Ap as SidebarSeparator,
  ...
  sa as useSidebar,
  Hh as useStylesheet,
  Wh as useTabIconSelection,
  kg as useTruncationTooltip,
