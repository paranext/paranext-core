...
import b, { forwardRef as rn, useRef as Z, useMemo as L, useState as D, useCallback as z, useLayoutEffect as Gt, createContext as kn, useContext as gr, useEffect as X, Component as ms, createElement as jr, Suspense as hs, createRef as fs, Fragment as go } from "react";
...
function fp({
  ...
  const w = ct(), [p, h] = D(!1), [m, u] = D(""), [g, N] = D(""), [v, x] = D("books"), [_, y] = D(void 0), [S, P] = D(!1), V = Z(void 0), C = Z(void 0), M = Z(void 0), k = Z(void 0), T = Z({}), j = z(
    ...
    [K.OT]: B.filter((U) => W.isBookOT(U)),
    [K.NT]: B.filter((U) => W.isBookNT(U)),
    [K.DC]: B.filter((U) => W.isBookDC(U)),
    [K.Extra]: B.filter((U) => W.extraBooks().includes(U))
    ...
    (R) => {
      const U = v === "chapters" ? _ : O == null ? void 0 : O.book;
      U && (j({
        book: U,
        chapterNum: R,
        verseNum: 1
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: U, isDigit: E } = Wr(R.key);
      if (v === "chapters") {
        if (R.key === "Backspace") {
    ...
    const { isLetter: U, isDigit: E } = Wr(R.key);
    (U || E) && (R.preventDefault(), N((et) => et + R.key), C.current.focus(), P(!1));
  }, []);
  return Gt(() => {
    const R = setTimeout(() => {
      if (p && v === "books" && M.current && k.current) {
        const U = M.current, E = k.current, et = E.offsetTop, at = U.clientHeight, Nt = E.clientHeight, Ct = et - at / 2 + Nt / 2;
        U.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(ir(e.book));
    ...
    if (v === "chapters" && _) {
      ...
      setTimeout(() => {
        if (M.current)
          if (R) {
            const U = T.current[e.chapterNum];
      ...
      Ut,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: I.map(({ onClick: R, disabled: U, title: E, icon: et }) => /* @__PURE__ */ r(
              $,
              {
                variant: "ghost",
                size: "sm",
          ...
          !S && /* @__PURE__ */ d(Yt, { ref: M, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !O && Object.entries(tt).map(([R, U]) => {
                if (U.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Ht, { heading: ie(R), children: U.map((E) => /* @__PURE__ */ r(
                      na,
                      {
                        bookId: E,
                        onSelect: (et) => xt(et),
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = oa ? Gt : X, dn = { tag: br };
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : X;
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : X;
function Bl(e) {
...
const Mr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : X;
...
const gw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : X;
function bw({ onClear: e }) {
  const [t] = Lt();
  return gw(() => pa(t, e), [t, e]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Gt : X;
