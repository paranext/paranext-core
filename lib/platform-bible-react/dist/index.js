import { jsx as x, jsxs as ze, Fragment as Fr } from "react/jsx-runtime";
import { Button as Lr, Autocomplete as Ur, TextField as vr, FormControlLabel as jn, FormLabel as Wr, Checkbox as Gr, MenuItem as Hr, Grid as wr, IconButton as kr, Paper as qr, Slider as Xr, Snackbar as Yr, Switch as Kr, AppBar as Jr, Toolbar as Zr, Drawer as Qr } from "@mui/material";
import * as Le from "react";
import { useMemo as Cn, useState as Pe, useCallback as Xe, useRef as kn, useEffect as nn } from "react";
import { offsetBook as Vn, FIRST_SCR_BOOK_NUM as et, offsetChapter as Fn, FIRST_SCR_CHAPTER_NUM as nt, getChaptersForBook as rt, offsetVerse as Ln, FIRST_SCR_VERSE_NUM as tt } from "platform-bible-utils";
...
function ha({
  ...
  return /* @__PURE__ */ ze(Fr, { children: [
    /* @__PURE__ */ x(
      jn,
      {
...
function lt({
  ...
  let p;
  if (r) {
    const d = t === Ae.Before || t === Ae.Above, v = /* @__PURE__ */ x("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: r }), b = t === Ae.Before || t === Ae.After, h = b ? v : /* @__PURE__ */ x("div", { children: v }), f = b ? u : /* @__PURE__ */ x("div", { children: u });
    p = /* @__PURE__ */ ze(
      Wr,
      {
...
function dt({ commandHandler: e, name: n, className: r, items: t, id: o }) {
  return /* @__PURE__ */ ze(wr, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${r ?? ""}`, children: [
    /* @__PURE__ */ x("h3", { className: `papi-menu ${r ?? ""}`, children: n }),
    t.map((i, a) => /* @__PURE__ */ x(
      ut,
      {
...
function St(e) {
  return xr[e - 1].includes("*obsolete*");
}
function Et() {
  const e = {};
...
let ae = xe;
A(ae, "Original", new xe(ye.Original)), A(ae, "Septuagint", new xe(ye.Septuagint)), A(ae, "Vulgate", new xe(ye.Vulgate)), A(ae, "English", new xe(ye.English)), A(ae, "RussianProtestant", new xe(ye.RussianProtestant)), A(ae, "RussianOrthodox", new xe(ye.RussianOrthodox));
function Wn(e, n) {
  const r = n[0];
...
const N = class {
  constructor(n, r, t, o) {
    if (A(this, "firstChapter"), A(this, "lastChapter"), A(this, "lastVerse"), A(this, "hasSegmentsDefined"), A(this, "text"), A(this, "BBBCCCVVVS"), A(this, "longHashCode"), A(this, "versification"), A(this, "rtlMark", "‏"), A(this, "_bookNum", 0), A(this, "_chapterNum", 0), A(this, "_verseNum", 0), A(this, "_verse"), t == null && o == null)
      ...
      if (typeof n == "string" && typeof r == "string" && typeof t == "string")
        ...
        this._bookNum = n, this._chapterNum = r, this._verseNum = t, this.versification = o ?? N.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
   ...
   */
  static parse(n, r = N.defaultVersification) {
    const t = new N(r);
    return t.parse(n), t;
  }
  /**
  ...
  static tryParse(n) {
    let r;
    try {
      return r = N.parse(n), { success: !0, verseRef: r };
    } catch (t) {
      if (t instanceof je)
  ...
  static getBBBCCCVVV(n, r, t) {
    return n % N.bcvMaxValue * N.bookDigitShifter + (r >= 0 ? r % N.bcvMaxValue * N.chapterDigitShifter : 0) + (t >= 0 ? t % N.bcvMaxValue : 0);
  }
  /**
  ...
  set book(n) {
    this.bookNum = ge.bookIdToNumber(n);
  }
  /**
  ...
  set verse(n) {
    const { success: r, vNum: t } = N.tryGetVerseNum(n);
    this._verse = r ? void 0 : n.replace(this.rtlMark, ""), this._verseNum = t, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = N.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(n) {
    ...
    if (t.length !== 2 || ge.bookIdToNumber(r[0]) === 0 || !Number.isInteger(o) || o < 0 || !N.isVerseParseable(t[1]))
      throw new je("Invalid reference : " + n);
   ...
   */
  allVerses(n = !1, r = N.verseRangeSeparators, t = N.verseSequenceIndicators) {
  ...
  updateInternal(n, r, t) {
    this.bookNum = ge.bookIdToNumber(n), this.chapter = r, this.verse = t;
  }
};
let he = N;
...
function ba({ scrRef: e, handleSubmit: n, id: r }) {
  ...
  return /* @__PURE__ */ ze("span", { id: r, children: [
    ...
    /* @__PURE__ */ x(Te, { onClick: () => n(Ln(e, 1)), children: ">" })
  ] });
}
function ya({ onSearch: e, placeholder: n, isFullWidth: r }) {
  ...
  return /* @__PURE__ */ x(qr, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ x(
    Je,
    {
      isFullWidth: r,
...
function Gn({ onRowChange: e, row: n, column: r }) {
  ...
  return /* @__PURE__ */ x(Je, { defaultValue: n[r.key], onChange: t });
}
const Ct = ({ onChange: e, disabled: n, checked: r, ...t }) => /* @__PURE__ */ x(
  lt,
  {
    ...t,
    isChecked: r,
...
function Ot() {
  return qn || (qn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var g = c, Q = s, re = l, fe = a, le = n, T = u, G = t, Z = b, te = v, J = r, H = i, ne = o, ue = p, ke = !1;
    function Ee(y) {
      return ke || (ke = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), m(y) || C(y) === c;
    }
    function m(y) {
      return C(y) === s;
    }
...
var Xn;
function $r() {
  return Xn || (Xn = 1, process.env.NODE_ENV === "production" ? qe.exports = _t() : qe.exports = Ot()), qe.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Nt() {
  if (Qn)
    return bn;
  Qn = 1;
  var e = $r(), n = $t(), r = $n(), t = Rr(), o = Rt(), i = function() {
  };
    ...
    function le(m) {
      ...
      for (var w = 0; w < m.length; w++) {
        ...
        if (typeof R != "function")
          return i(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ke(R) + " at index " + w + "."
          ), a;
      }
      function O(E, P, _, $, I) {
...
if (process.env.NODE_ENV !== "production") {
  var Pt = $r(), It = !0;
  Sn.exports = Nt()(Pt.isElement, It);
} else
  Sn.exports = At()();
var Mt = Sn.exports;
const U = /* @__PURE__ */ Tt(Mt);
function Me(e) {
...
function zt() {
  return rr || (rr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === r || k === o || K || k === t || k === s || k === u || S || k === v || b || h || f || typeof k == "object" && k !== null && (k.$$typeof === d || k.$$typeof === p || k.$$typeof === i || k.$$typeof === a || k.$$typeof === c || // This needs to include all possible module reference object
    ...
    var Q = a, re = i, fe = e, le = c, T = r, G = d, Z = p, te = n, J = o, H = t, ne = s, ue = u, ke = !1, Ee = !1;
    function m(k) {
...
process.env.NODE_ENV === "production" ? En.exports = Bt() : En.exports = zt();
var tr = En.exports;
const Dt = /^\s*function(?:\s|\s*\/\*.*\*\/\s*)+([^(\s/]*)\s*/;
function jt(e) {
  const n = `${e}`.match(Dt);
  return n && n[1] || "";
}
function Nr(e, n = "") {
  return e.displayName || e.name || jt(e) || n;
}
function or(e, n, r) {
  const t = Nr(n);
...
const Zt = {
  borderRadius: 4
}, Qt = Zt, eo = process.env.NODE_ENV !== "production" ? U.oneOfType([U.number, U.string, U.object, U.array]) : {}, we = eo;
function Fe(e, n) {
  return n ? de(e, n, {
    clone: !1
...
const fo = ce("border", se), po = ce("borderTop", se), ho = ce("borderRight", se), go = ce("borderBottom", se), mo = ce("borderLeft", se), bo = ce("borderColor"), yo = ce("borderTopColor"), vo = ce("borderRightColor"), wo = ce("borderBottomColor"), ko = ce("borderLeftColor"), xo = ce("outline", se), So = ce("outlineColor"), sn = (e) => {
...
an(fo, po, ho, go, mo, bo, yo, vo, wo, ko, sn, xo, So);
const cn = (e) => {
...
function ai(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ...
    const K = at(a, B({
      ...
      if (process.env.NODE_ENV !== "production") {
        let T;
        c && (T = `${c}${pe(s || "")}`), T === void 0 && (T = `Styled(${Vt(a)})`), le.displayName = T;
      }
...
function di(e, n) {
  if (e = Be(e), n = Dr(n), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - n;
...
const hi = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ne = xi, Si = ["mode", "contrastThreshold", "tonalOffset"], pr = {
...
const ea = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], na = (e) => {
  ...
  return /* @__PURE__ */ ze(ra, B({
    ...
    ownerState: h,
    children: [b ? o.props.children : o, p ? /* @__PURE__ */ x("title", {
      children: p
    }) : null]
  }));
});
...
function Sa({
  ...
  let f = e;
  return !f && n && (f = n(c)), /* @__PURE__ */ x("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ x(Jr, { position: "static", id: o, children: /* @__PURE__ */ ze(Zr, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ x(
      kr,
      {
        edge: "start",
    ...
    i ? /* @__PURE__ */ x("div", { className: "papi-menu-children", children: i }) : void 0,
    f ? /* @__PURE__ */ x(
      Qr,
      {
        ...
        children: /* @__PURE__ */ x(ft, { commandHandler: h, columns: f.columns })
      }
    ) : void 0
  ] }) }) });
}
