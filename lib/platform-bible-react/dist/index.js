...
function iw({
  ...
  return /* @__PURE__ */ l("div", { id: u, className: c("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ l(bt, { children: [
      /* @__PURE__ */ r(Q, { className: "tw-ms-3", children: d }),
      /* @__PURE__ */ r("div", { className: "tw-ms-3", children: /* @__PURE__ */ r(Q, { children: (n == null ? void 0 : n.length) > 0 ? `${n.map((b) => f(b, e)).join(", ")}` : `default (${t.en.autonym})` }) })
    ] })
  ] });
}
