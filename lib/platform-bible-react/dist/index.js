...
import u, { forwardRef as de, useState as B, createContext as Mr, useContext as Or, useCallback as $, useRef as q, useMemo as J, useEffect as dt, useLayoutEffect as gn, Fragment as Dn } from "react";
import { Check as Ct, CircleSlash as zr, ChevronRight as Ye, Circle as Ke, X as Ue, Search as Vn, ChevronsUpDown as qe, FilterIcon as Br, ChevronDown as ce, ChevronUp as Ir, ArrowLeftIcon as Ar, ChevronLeftIcon as Pr, ChevronRightIcon as jr, ArrowRightIcon as Fr, Filter as Xr, User as Gr, Link as $r, CircleHelp as Lr, Star as Hr, CircleCheckIcon as Yr, CircleXIcon as Kr, CircleHelpIcon as Ur, ArrowUpIcon as qr, ArrowDownIcon as Jr, ArrowUpDownIcon as Wr, PanelLeft as Zr, PanelRight as Qr, ScrollText as ta, ChevronLeft as ea, MenuIcon as na, Menu as ra, EllipsisVertical as aa, LoaderCircle as oa, Copy as sa } from "lucide-react";
...
import { formatScrRef as Mt, MODIFIER_KEYS as bn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Je, isString as De, compareScrRefs as Ae, scrRefToBBBCCCVVV as Ve, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
const Ze = X.Trigger, Pn = X.Group, ka = X.Portal, Ca = X.Sub, Us = X.RadioGroup;
...
const Xn = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    X.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(Ke, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const yn = 6, rn = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), Un = Object.fromEntries(
  rn.map((t) => [t, O.bookIdToEnglishName(t)])
), Fa = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function Js({
  ...
  const o = Z(), [s, i] = B(
      ...
      if (f.trim())
        return Nn.reduce(
          (V, S) => {
            ...
            const K = S.exec(f);
            if (K) {
              const [F, Tt = void 0, ae = void 0] = K.slice(1), st = Cn(F) ?? (O.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (st) {
    ...
    (f) => {
      const { key: V } = f;
      kn.has(V) || (re(f), f.preventDefault());
    },
    [re]
  ), Dr = $((f) => {
    const { key: V } = f;
    ...
    (f, V) => {
      ...
      if (kn.has(S)) {
        if (h === p || _ === 1) {
          ...
          const Tt = S === "ArrowRight" && !o || S === "ArrowRight" && o === "ltr" || S === "ArrowLeft" && o === "rtl", ae = S === "ArrowLeft" && !o || S === "ArrowLeft" && o === "ltr" || S === "ArrowRight" && o === "rtl", Re = Array.from(
            { length: At(h) },
            (oe, Rt) => Rt + 1
          ), st = p !== h || _ === 1 ? U ?? Re : Re, wt = st.indexOf(v);
          let vt = v;
          if (Tt)
      ...
      re(f), f.preventDefault(), f.stopPropagation();
    },
    [
      o,
      h,
  ...
  }, [N, tt]), /* @__PURE__ */ l(ue, { modal: !1, open: C, onOpenChange: bt, children: [
      ...
      ne,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((f, V) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(he, { className: "tw-font-semibold tw-text-foreground/80", children: Fa[f.bookType] }),
...
const ie = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Zt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Zt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Ke, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function Xe({
  ...
  const [y, N] = B(!1);
  return /* @__PURE__ */ l(on, { open: y, onOpenChange: N, ...C, children: [
    ...
    /* @__PURE__ */ r(
      fe,
      {
        ...
        children: /* @__PURE__ */ l(ge, { children: [
          ...
          /* @__PURE__ */ r(ve, { children: e.map((T) => /* @__PURE__ */ l(
            ye,
            {
              value: w(T),
              onSelect: () => {
...
function Zs({
  ...
  const g = Me(p, "%webView_bookSelector_currentBook%"), v = Me(p, "%webView_bookSelector_choose%"), m = Me(p, "%webView_bookSelector_chooseBooks%"), [h, x] = B(
    "current book"
    /* CURRENT_BOOK */
  ), C = (y) => {
    x(y), t(y);
...
function so({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Ne, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ke, { stickyHeader: s, children: C.getHeaderGroups().map((N) => /* @__PURE__ */ r(kt, { children: N.headers.map((T) => /* @__PURE__ */ r(te, { children: T.isPlaceholder ? void 0 : Jt(T.column.columnDef.header, T.getContext()) }, T.id)) }, N.id)) }),
      /* @__PURE__ */ r(Ce, { children: (y = C.getRowModel().rows) != null && y.length ? C.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        kt,
        {
          onClick: () => i(N, C),
...
function ti({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ue, { children: [
    /* @__PURE__ */ r(Ze, { asChild: !0, children: /* @__PURE__ */ l(j, { variant: "default", children: [
...
function co({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(on, { open: v, onOpenChange: m, children: [
    /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ l(
      j,
      {
        variant: "ghost",
...
uo.displayName = In.Root.displayName;
...
function ci({
  ...
  const p = xt(n, "%webView_inventory_all%"), g = xt(n, "%webView_inventory_approved%"), v = xt(n, "%webView_inventory_unapproved%"), m = xt(n, "%webView_inventory_unknown%"), h = xt(n, "%webView_inventory_scope_currentBook%"), x = xt(n, "%webView_inventory_scope_chapter%"), C = xt(n, "%webView_inventory_filter_text%"), y = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, T] = B(!1), [D, A] = B("all"), [z, ft] = B(""), [Y, k] = B([]), b = J(() => t.length === 0 ? [] : go(t, o, s), [t, o, s]), I = J(() => {
    if (N) return b;
    const _ = [];
    return b.forEach((H) => {
...
const bo = "16rem", vo = "3rem", nr = u.createContext(void 0);
function Te() {
...
const Oo = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? $t : "a",
  {
    ref: s,
    ...
    ar,
    {
      ...
      children: /* @__PURE__ */ l(sr, { children: [
        /* @__PURE__ */ l(Ge, { children: [
          ...
          /* @__PURE__ */ r(Le, { children: /* @__PURE__ */ r(ir, { children: Object.entries(e).map(([m, h]) => /* @__PURE__ */ r(wr, { children: /* @__PURE__ */ r(
            lr,
            {
              onClick: () => p(m),
              isActive: v(m),
...
const yt = "scrBook", Bo = "scrRef", Vt = "source", Io = "details", Ao = "Scripture Reference", Po = "Scripture Book", dr = "Type", jo = "Details";
function Fo(t, e) {
  const n = e ?? !1;
  return [
    {
...
const Xo = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Ae(t.start, t.end) === 0 ? `${Ve(t.start)}+${e}` : `${Ve(t.start)}+${e}-${Ve(t.end)}+${n}`;
}, Sn = (t) => `${Xo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ui({
  sources: t,
  ...
  dt(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const I = x.find((R) => Sn(R) === b[0]) || void 0;
        I && w(I);
      }
    }
  }, [m, x, w, y]);
  const N = o ?? Po, T = s ?? dr, D = [
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(Ne, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(ke, { children: y.getHeaderGroups().map((k) => /* @__PURE__ */ r(kt, { children: k.headers.filter((b) => b.column.columnDef.header).map((b) => (
                  ...
                  Gt,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      j,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(ce, {}),
                          !k.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ r(Ye, {}) : /* @__PURE__ */ r(ea, {})),
                          " ",
...
function Yo({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(on, { open: y, onOpenChange: N, children: [
      /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ l(
        j,
        {
          variant: "outline",
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var I;
        return /* @__PURE__ */ r(we, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((I = o.get(b)) == null ? void 0 : I.localizedName) || O.bookIdToEnglishName(b) || b }, b);
      }),
      ...
      /* @__PURE__ */ r(
        an,
        {
          ...
          children: y.map(({ value: N, label: T, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(ie, { className: "tw-me-2", value: N, id: D }),
...
function Rn({
  ...
  return /* @__PURE__ */ l(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ze, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(j, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(na, {}) }) }),
...
const Wo = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(Ke, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
function Qo({
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ l(Uo, { children: [
...
const ns = de(({ className: t, ...e }, n) => /* @__PURE__ */ r(oa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
function Ri({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(sa, {}) })
    ] }),
...
ks.displayName = je.Root.displayName;
function Vi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
const Mi = rt.Root, Ss = u.forwardRef(({ className: t, ...e }, n) => {
  const a = Z();
  return /* @__PURE__ */ r(
    rt.List,
    {
