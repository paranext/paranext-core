...
import ie, { forwardRef as rs, useCallback as Me, useState as Ee, useRef as Rt, useEffect as Yt, useLayoutEffect as ei, useMemo as ao } from "react";
...
var Bl = Object.defineProperty, jl = (e, t, n) => t in e ? Bl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, se = (e, t, n) => (jl(e, typeof t != "symbol" ? t + "" : t, n), n);
const Pt = [
  "GEN",
  "EXO",
  "LEV",
...
se(Le, "Original", new Le(dt.Original)), se(Le, "Septuagint", new Le(dt.Septuagint)), se(Le, "Vulgate", new Le(dt.Vulgate)), se(Le, "English", new Le(dt.English)), se(Le, "RussianProtestant", new Le(dt.RussianProtestant)), se(Le, "RussianOrthodox", new Le(dt.RussianOrthodox));
let Lt = Le;
function ri(e, t) {
  const n = t[0];
...
const $e = class ue {
    ...
    if (se(this, "firstChapter"), se(this, "lastChapter"), se(this, "lastVerse"), se(this, "hasSegmentsDefined"), se(this, "text"), se(this, "BBBCCCVVVS"), se(this, "longHashCode"), se(this, "versification"), se(this, "rtlMark", "‏"), se(this, "_bookNum", 0), se(this, "_chapterNum", 0), se(this, "_verseNum", 0), se(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof ue) {
          ...
          if (t == null)
            return;
          const i = t instanceof Lt ? t : ue.defaultVersification;
          this.setEmpty(i);
        }
      else
   ...
   */
  static parse(t, n = ue.defaultVersification) {
    const r = new ue(n);
    return r.parse(t), r;
  }
  /**
  ...
  static tryParse(t) {
    let n;
    try {
      return n = ue.parse(t), { success: !0, verseRef: n };
    } catch (r) {
      if (r instanceof rn)
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Lt(dt[s]);
        } catch {
   ...
   */
  equals(t) {
    return t instanceof ue ? t._bookNum === this._bookNum && t._chapterNum === this._chapterNum && t._verseNum === this._verseNum && t.verse === this.verse && t.versification != null && this.versification != null && t.versification.equals(this.versification) : !1;
  }
  /**
...
const mo = (e, t, n, r, o, i, s) => {
  let a = {
    ...
    getAllCells: K(() => [e.getAllLeafColumns()], (u) => u.map((c) => hu(e, a, c, c.id)), J(e.options, "debugRows", "getAllCells")),
...
const $u = {
  ...
  createColumn: (e, t) => {
    e.getIndex = K((n) => [mn(t, n)], (n) => n.findIndex((r) => r.id === e.id), J(t.options, "debugColumns", "getIndex")), e.getIsFirstColumn = (n) => {
      var r;
  ...
  createColumn: (e, t) => {
    ...
    }, e.getStart = K((n) => [n, mn(t, n), t.getState().columnSizing], (n, r) => r.slice(0, e.getIndex(n)).reduce((o, i) => o + i.getSize(), 0), J(t.options, "debugColumns", "getStart")), e.getAfter = K((n) => [n, mn(t, n), t.getState().columnSizing], (n, r) => r.slice(e.getIndex(n) + 1).reduce((o, i) => o + i.getSize(), 0), J(t.options, "debugColumns", "getAfter")), e.resetSize = () => {
      t.setColumnSizing((n) => {
        let {
          [e.id]: r,
          ...o
...
const Du = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => ot.includesString, e.getGlobalFilterFn = () => {
      ...
      return ir(r) ? r : r === "auto" ? e.getGlobalAutoFilterFn() : (t = (n = e.options.filterFns) == null ? void 0 : n[r]) != null ? t : ot[r];
    }, e.setGlobalFilter = (t) => {
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = K(() => [e.getState().rowSelection, e.getCoreRowModel()], (t, n) => Object.keys(t).length ? kr(e, n) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, J(e.options, "debugTable", "getSelectedRowModel")), e.getFilteredSelectedRowModel = K(() => [e.getState().rowSelection, e.getFilteredRowModel()], (t, n) => Object.keys(t).length ? kr(e, n) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, J(e.options, "debugTable", "getFilteredSelectedRowModel")), e.getGroupedSelectedRowModel = K(() => [e.getState().rowSelection, e.getSortedRowModel()], (t, n) => Object.keys(t).length ? kr(e, n) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    ...
    function k(R) {
      ...
      function A(H, X, z, G, q) {
        for (var W = H[X], U = 0; U < R.length; U++)
          if (h(W, R[U]))
            return null;
        var Y = JSON.stringify(R, function(ae, I) {
          var Q = j(I);
...
function it(e, t, n = {
  ...
  return Ct(e) && Ct(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (Ct(t[o]) && o in e && Ct(e[o]) ? r[o] = it(e[o], t[o], n) : n.clone ? r[o] = Ct(t[o]) ? Bs(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function _c(e) {
  const {
...
const Uc = typeof window < "u" ? E.useLayoutEffect : E.useEffect, Ot = Uc;
let xi = 0;
function qc(e) {
...
function Wt(e, t, n) {
  ...
  var s = Nt(e) ? ze(e) : window, a = s.visualViewport, u = !la() && n, c = (r.left + (u && a ? a.offsetLeft : 0)) / o, p = (r.top + (u && a ? a.offsetTop : 0)) / i, g = r.width / o, f = r.height / i;
  return {
    width: g,
    height: f,
    top: p,
...
function Jp(e) {
  ...
  var o = ar(e);
  for (So(o) && (o = o.host); Ue(o) && ["html", "body"].indexOf(Qe(o)) < 0; ) {
    var i = at(o);
...
function On(e) {
  for (var t = ze(e), n = ki(e); n && Kp(n) && at(n).position === "static"; )
    n = ki(n);
  return n && (Qe(n) === "html" || Qe(n) === "body" && at(n).position === "static") ? t : n || Jp(e) || t;
}
function Co(e) {
...
function ed(e) {
  var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, s = n.modifiersData.popperOffsets, a = Je(n.placement), u = Co(a), c = [Ae, Xe].indexOf(a) >= 0, p = c ? "height" : "width";
  if (!(!i || !s)) {
...
function Ni(e) {
  ...
  if (c) {
    ...
    if (T === ze(n) && (T = wt(n), at(T).position !== "static" && a === "absolute" && (k = "scrollHeight", F = "scrollWidth")), T = T, o === Ie || (o === Ae || o === Xe) && i === Sn) {
      S = We;
...
function dd(e) {
  var t, n = wt(e), r = Ro(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = Tt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = Tt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), a = -r.scrollLeft + To(e), u = -r.scrollTop;
  return at(o || n).direction === "rtl" && (a += Tt(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: s,
    x: a,
    y: u
...
function fa(e) {
  return ["html", "body", "#document"].indexOf(Qe(e)) >= 0 ? e.ownerDocument.body : Ue(e) && Po(e) ? e : fa(ar(e));
}
function wn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function $i(e, t, n) {
  return t === sa ? to(pd(e, n)) : Nt(t) ? fd(t, n) : to(dd(wt(e)));
}
function gd(e) {
  var t = wn(ar(e)), n = ["absolute", "fixed"].indexOf(at(e).position) >= 0, r = n && Ue(e) ? On(e) : e;
  return Nt(r) ? t.filter(function(o) {
    return Nt(o) && ua(o, r) && Qe(o) !== "body";
  }) : [];
}
function md(e, t, n, r) {
...
function En(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, u = a === void 0 ? Ap : a, c = n.rootBoundary, p = c === void 0 ? sa : c, g = n.elementContext, f = g === void 0 ? an : g, d = n.altBoundary, h = d === void 0 ? !1 : d, m = n.padding, v = m === void 0 ? 0 : m, y = pa(typeof v != "number" ? v : da(v, Pn)), O = f === an ? Fp : an, x = e.rects.popper, S = e.elements[h ? O : f], w = md(Nt(S) ? S : S.contextElement || wt(e.elements.popper), u, p, s), T = Wt(e.elements.reference), k = ga({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
...
function wd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !0 : s, u = n.fallbackPlacements, c = n.padding, p = n.boundary, g = n.rootBoundary, f = n.altBoundary, d = n.flipVariations, h = d === void 0 ? !0 : d, m = n.allowedAutoPlacements, v = t.options.placement, y = Je(v), O = y === v, x = u || (O || !h ? [Un(v)] : vd(v)), S = [v].concat(x).reduce(function(z, G) {
      return z.concat(Je(G) === xo ? hd(t, {
        placement: G,
        boundary: p,
        rootBoundary: g,
        padding: c,
...
function Od(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, c = n.rootBoundary, p = n.altBoundary, g = n.padding, f = n.tether, d = f === void 0 ? !0 : f, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = En(t, {
    ...
    padding: g,
    altBoundary: p
  }), y = Je(t.placement), O = Xt(t.placement), x = !O, S = Co(y), w = Pd(S), T = t.modifiersData.popperOffsets, k = t.rects.reference, F = t.rects.popper, D = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, V = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (T) {
    if (i) {
      var M, L = S === "y" ? Ie : Ae, B = S === "y" ? We : Xe, _ = S === "y" ? "height" : "width", j = T[S], ne = j + v[L], ee = j - v[B], R = d ? -F[_] / 2 : 0, A = O === Ut ? k[_] : F[_], H = O === Ut ? -F[_] : -k[_], X = t.elements.arrow, z = d && X ? Eo(X) : {
        width: 0,
        height: 0
      }, G = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ca(), q = G[L], W = G[B], U = vn(0, k[_], z[_]), Y = x ? k[_] / 2 - R - U - q - V.mainAxis : A - U - q - V.mainAxis, Z = x ? -k[_] / 2 + R + U + W + V.mainAxis : H + U + W + V.mainAxis, ae = t.elements.arrow && On(t.elements.arrow), I = ae ? S === "y" ? ae.clientTop || 0 : ae.clientLeft || 0 : 0, Q = (M = P == null ? void 0 : P[S]) != null ? M : 0, N = j + Y - Q - I, le = j + Z - Q, Ce = vn(d ? Zn(ne, N) : ne, j, d ? Tt(ee, le) : ee);
      T[S] = Ce, $[S] = Ce - j;
    }
    if (a) {
      var Ne, xe = S === "x" ? Ie : Ae, yt = S === "x" ? We : Xe, _e = T[w], tt = w === "y" ? "height" : "width", De = _e + v[xe], nt = _e - v[yt], Re = [Ie, Ae].indexOf(y) !== -1, $t = (Ne = P == null ? void 0 : P[w]) != null ? Ne : 0, xt = Re ? De : _e - k[tt] - F[tt] - $t + V.altAxis, Zt = Re ? _e + k[tt] + F[tt] - $t - V.altAxis : nt, $n = d && Re ? Zp(xt, _e, Zt) : vn(d ? xt : De, _e, d ? Zt : nt);
      T[w] = $n, $[w] = $n - _e;
    }
    t.modifiersData[r] = $;
  }
    ...
    var p = {
      ...
      setOptions: function(y) {
        ...
        m(), p.options = Object.assign({}, i, p.options, O), p.scrollParents = {
          reference: Nt(a) ? wn(a) : a.contextElement ? wn(a.contextElement) : [],
          popper: wn(u)
        };
...
`));
  ...
  const $ = qd(), M = (r = h.root) != null ? r : "div", L = kt({
    elementType: M,
...
process.env.NODE_ENV !== "production" && (ha.propTypes = {
   ...
   */
  anchorEl: Jt(l.oneOfType([st, l.object, l.func]), (e) => {
    if (e.open) {
...
function $o(e = {}, ...t) {
  ...
  return c.applyStyles = qf, c = t.reduce((p, g) => it(p, g), c), c.unstable_sxConfig = C({}, No, s == null ? void 0 : s.unstable_sxConfig), c.unstable_sx = function(g) {
    return _o({
      sx: g,
      theme: this
    });
...
function rg(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, a = {}) => {
    ...
    const O = Fl(s, C({
      shouldForwardProp: y,
      label: v
    }, d)), x = (w) => typeof w == "function" && w.__emotion_real !== w || Ct(w) ? (T) => Wn(w, C({}, T, {
      theme: jn({
        theme: T.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let P;
        u && (P = `${u}${Ze(c || "")}`), P === void 0 && (P = `Styled(${Bc(s)})`), V.displayName = P;
      }
...
function Bi(e) {
  e = _t(e);
  let t = e.type === "hsl" || e.type === "hsla" ? _t(ag(e)).values : e.values;
...
function tr(e, t) {
  return e = _t(e), t = Mo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, vr(e);
}
function lg(e, t) {
...
const pg = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Dt = bg, yg = ["mode", "contrastThreshold", "tonalOffset"], zi = {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (d[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), it(C({
...
function Gg(e = {}, ...t) {
  ...
  if (c = it(c, s), c = t.reduce((p, g) => it(p, g), c), process.env.NODE_ENV !== "production") {
...
var Yg = function(t) {
  return t.scrollTop;
}, fn = "unmounted", St = "exited", Et = "entering", jt = "entered", ro = "exiting", pt = /* @__PURE__ */ function(e) {
  Wg(t, e);
  function t(r, o) {
    var i;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== Et && s !== jt && (i = Et) : (s === Et || s === jt) && (i = ro);
    }
...
const Oa = /* @__PURE__ */ E.forwardRef(function(t, n) {
  ...
  const T = ct({
    ...
    children: F
  }), Ce = _n(), Ne = Ce.direction === "rtl", [xe, yt] = E.useState(), [_e, tt] = E.useState(null), De = E.useRef(!1), nt = L || ee, Re = pn(), $t = pn(), xt = pn(), Zt = pn(), [$n, Bo] = Ws({
    controlled: G,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const jo = (oe) => {
    ...
    De.current && oe.type !== "touchstart" || (xe && xe.removeAttribute("title"), $t.clear(), xt.clear(), _ || zn && j ? $t.start(zn ? j : _, () => {
      jo(oe);
    }) : jo(oe));
  }, zo = (oe) => {
    $t.clear(), xt.start(A, () => {
  ...
  P ? (en.title = !rt && xr && !M ? ae : null, en["aria-describedby"] = rt ? wr : null) : (en["aria-label"] = xr ? ae : null, en["aria-labelledby"] = rt && !xr ? wr : null);
...
`));
  const Qa = E.useMemo(() => {
    ...
    touch: De.current
  }), Sr = im(nn), Ko = (r = (o = Z.popper) != null ? o : D.Popper) != null ? r : sm, Jo = (i = (s = (a = Z.transition) != null ? a : D.Transition) != null ? s : I) != null ? i : io, Zo = (u = (c = Z.tooltip) != null ? c : D.Tooltip) != null ? u : am, Qo = (p = (g = Z.arrow) != null ? g : D.Arrow) != null ? p : lm, el = dn(Ko, C({}, U, (f = Y.popper) != null ? f : V.popper, {
...
const Gm = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Um = (e) => {
  ...
  const W = (r = (o = L == null ? void 0 : L.root) != null ? o : y.Root) != null ? r : qm, U = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : y.Backdrop) != null ? i : p, Y = (a = M == null ? void 0 : M.root) != null ? a : O.root, Z = (u = M == null ? void 0 : M.backdrop) != null ? u : O.backdrop, ae = kt({
    elementType: W,
    externalSlotProps: Y,
...
`));
    ...
    const yt = Ne + N.height, _e = xe + N.width, tt = Gt(Xn(u)), De = tt.innerHeight - v, nt = tt.innerWidth - v;
    if (v !== null && Ne < v) {
      const Re = Ne - v;
...
`)), v !== null && xe < v) {
  ...
  const q = h || (u ? Oe(Xn(u)).body : void 0), W = (o = x == null ? void 0 : x.root) != null ? o : ih, U = (i = x == null ? void 0 : x.paper) != null ? i : za, Y = kt({
    elementType: U,
    externalSlotProps: C({}, $, {
...
process.env.NODE_ENV !== "production" && (Ha.propTypes = {
   ...
   */
  anchorEl: Jt(l.oneOfType([st, l.func]), (e) => {
...
`)), ee.props.disabled || (y === "selectedMenu" && ee.props.selected || L === -1) && (L = R));
  ...
  const B = (r = O.paper) != null ? r : gh, _ = (o = x.paper) != null ? o : d, j = kt({
    elementType: O.root,
