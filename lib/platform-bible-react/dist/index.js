...
const uo = ft.Root, gi = ft.Trigger, Wl = ft.Group, rh = ft.Portal, oh = ft.Sub, ah = ft.RadioGroup, Kl = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
const Tt = class nt {
  ...
  set book(e) {
    this.bookNum = rt.bookIdToNumber(e);
  }
  /**
  ...
  parse(e) {
    ...
    if (r.length !== 2 || rt.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !nt.isVerseParseable(r[1]))
      throw new rn("Invalid reference : " + e);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > rt.lastBook ? 2 : (rt.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = nt.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, r) {
    this.bookNum = rt.bookIdToNumber(e), this.chapter = n, this.verse = r;
  }
};
      ...
      children: [
        /* @__PURE__ */ s(
          "span",
          {
            ...
            children: rt.bookIdToEnglishName(t)
          }
        ),
...
const fn = rt.allBookIds.filter((t) => !rt.isObsolete(rt.bookIdToNumber(t))), wc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  OT: fn.filter((n) => rt.isBookOT(n)),
  NT: fn.filter((n) => rt.isBookNT(n)),
  DC: fn.filter((n) => rt.isBookDC(n))
})[t], on = (t) => Sl(rt.bookIdToNumber(t));
function gc() {
  return fn.map((e) => rt.bookIdToEnglishName(e));
}
function bc(t) {
...
function vc(t) {
  ...
  if (bc(e))
    return fn.find((r) => rt.bookIdToEnglishName(r) === e);
}
function sh({ scrRef: t, handleSubmit: e }) {
  const n = xt(), [r, o] = ut(""), [a, i] = ut(
    rt.bookNumberToId(t.bookNum)
  ), [l, c] = ut(t.chapterNum ?? 0), [d, p] = ut(
    rt.bookNumberToId(t.bookNum)
  ), [f, w] = ut(!1), [g, v] = ut(f), m = be(void 0), h = be(void 0), k = be(void 0), T = Et(
    (I) => hc(I).filter((M) => {
      const Y = rt.bookIdToEnglishName(M).toLowerCase(), G = r.replace(/[^a-zA-Z]/g, "").toLowerCase();
      return Y.includes(G) || // Match book name
    ...
    (I, M, Y, G) => {
      if (c(
        rt.bookNumberToId(t.bookNum) !== I ? 1 : t.chapterNum
      ), M || on(I) === -1) {
        e({
          bookNum: rt.bookIdToNumber(I),
          chapterNum: Y || 1,
          verseNum: G || 1
        }), w(!1), o("");
        return;
    ...
    mc.forEach((I) => {
      const M = r.match(I);
      if (M) {
        const [Y, G = void 0, B = void 0] = M.slice(1), Z = vc(Y);
        (rt.isBookIdValid(Y) || Z) && _(
          Z ?? Y,
          !0,
          G ? parseInt(G, 10) : 1,
          B ? parseInt(B, 10) : 1
    ...
    if (d === a) {
      ...
      const Y = M === "ArrowRight" && !n || M === "ArrowRight" && n === "ltr" || M === "ArrowLeft" && n === "rtl", G = M === "ArrowLeft" && !n || M === "ArrowLeft" && n === "ltr" || M === "ArrowRight" && n === "rtl";
      let B = 0;
      if (Y)
        if (l < on(d))
          B = 1;
  ...
  return se(() => {
    a === d ? a === rt.bookNumberToId(t.bookNum) ? c(t.chapterNum) : c(1) : c(0);
  }, [d, t.bookNum, t.chapterNum, a]), sa(() => {
    v(f);
  }, [f]), sa(() => {
    const I = setTimeout(() => {
      if (g && h.current && k.current) {
        const Y = k.current.offsetTop - fc;
    ...
    /* @__PURE__ */ s(gi, { asChild: !0, children: /* @__PURE__ */ s(
      Hl,
      {
        ...
        handleKeyDown: $,
        handleOnClick: () => {
          i(rt.bookNumberToId(t.bookNum)), p(rt.bookNumberToId(t.bookNum)), c(t.chapterNum > 0 ? t.chapterNum : 0), w(!0), m.current.focus();
        },
        onFocus: () => {
          E.current = !0;
        },
        handleSubmit: R,
        placeholder: `${rt.bookNumberToEnglishName(t.bookNum)} ${t.chapterNum}:${t.verseNum}`
      }
    ) }),
    /* @__PURE__ */ s(
      rr,
      {
        ...
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: da.map(
          (I, M) => T(I).length > 0 && /* @__PURE__ */ x("div", { children: [
            /* @__PURE__ */ s(or, { className: "tw-font-semibold tw-text-foreground/80", children: wc[I] }),
            T(I).map((Y) => /* @__PURE__ */ s("div", { children: /* @__PURE__ */ s(
              pc,
              {
                bookId: Y,
                handleSelectBook: () => _(Y, !1),
                isSelected: a === Y,
                handleHighlightBook: () => p(Y),
                handleKeyDown: D,
                bookType: I,
                ref: (G) => {
                  a === Y && (k.current = G);
                ...
                children: /* @__PURE__ */ s(
                  uc,
                  {
                    ...
                    endChapter: on(Y),
                    activeChapter: t.bookNum === rt.bookIdToNumber(Y) ? t.chapterNum : 0,
...
qr.displayName = bn.Item.displayName;
    ...
    Ti,
    {
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ s(Mt, { className: "tw-flex tw-items-center", children: r.map((h) => rt.bookIdToEnglishName(h)).join(", ") }),
          /* @__PURE__ */ s(
            wt,
            {
  ...
  return /* @__PURE__ */ x(ir, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ s(lr, { children: a.length > 0 && a.map((i) => /* @__PURE__ */ x(
      ie,
      {
        ...
        children: [
          /* @__PURE__ */ s(Fe, { children: `${rt.bookNumberToEnglishName(i.reference.bookNum)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
const Vc = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), pa = (t) => {
  ...
  return e ? rt.bookIdToNumber(e[1]) : 0;
...
const Un = S.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
...
const cr = (t) => t === "asc" ? /* @__PURE__ */ s(ul, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(wl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(fl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), dh = (t) => ({
  accessorKey: "item",
...
function fh({
  ...
  const f = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), m = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [_, F] = ut("all"), [R, $] = ut(""), [L, D] = ut([]), I = Ct(() => l ? r instanceof RegExp ? Xc(
    l,
    t,
    a,
    i,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    ...
    ot.length > 0 && /* @__PURE__ */ s("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ s(
      Bc,
      {
        occurrenceData: ot,
        setScriptureReference: e,
...
const qc = Tn.Provider, Wc = Tn.Root, Kc = Tn.Trigger, zi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Tn.Content,
  {
    ref: r,
    sideOffset: e,
...
function vd(t, e) {
  ...
  return [
    {
      accessorFn: (r) => `${rt.bookNumberToId(r.start.bookNum)} ${r.start.chapterNum}:${r.start.verseNum}`,
      id: oe,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? hd,
      cell: (r) => {
        const o = r.row.original;
        return r.row.getIsGrouped() ? rt.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === oe ? Rr(o.start) : void 0;
      },
...
function Sd() {
  return ma || (ma = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var b = c, _ = d, F = l, R = i, $ = e, L = p, D = r, I = v, M = g, Y = n, G = a, B = o, Z = f, at = !1;
    function ot(A) {
    ...
    st.AsyncMode = b, st.ConcurrentMode = _, st.ContextConsumer = F, st.ContextProvider = R, st.Element = $, st.ForwardRef = L, st.Fragment = D, st.Lazy = I, st.Memo = M, st.Portal = Y, st.Profiler = G, st.StrictMode = B, st.Suspense = Z, st.isAsyncMode = ot, st.isConcurrentMode = y, st.isContextConsumer = O, st.isContextProvider = U, st.isElement = X, st.isForwardRef = z, st.isFragment = K, st.isLazy = q, st.isMemo = W, st.isPortal = H, st.isProfiler = J, st.isStrictMode = Q, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = E;
  }()), st;
}
var ha;
function Zi() {
  return ha || (ha = 1, process.env.NODE_ENV === "production" ? Vn.exports = Ed() : Vn.exports = Sd()), Vn.exports;
}
/*
object-assign
(c) Sindre Sorhus
  ...
  return Vr = function(l, c) {
    ...
    function h(y) {
      ...
      function X(K, q, W, H, J, Q, dt) {
        ...
        return q[W] == null ? K ? q[W] === null ? new m("The " + J + " `" + Q + "` is marked as required " + ("in `" + H + "`, but its value is `null`.")) : new m("The " + J + " `" + Q + "` is marked as required in " + ("`" + H + "`, but its value is `undefined`.")) : null : y(q, W, H, J, Q);
      }
      var z = X.bind(null, !1);
    ...
    function k(y) {
      function O(U, X, z, K, q, W) {
        ...
        if (J !== y) {
          var Q = Z(H);
          return new m(
            "Invalid " + K + " `" + q + "` of type " + ("`" + Q + "` supplied to `" + z + "`, expected ") + ("`" + y + "`."),
            { expectedType: y }
          );
        }
        return null;
    ...
    function C(y) {
      function O(U, X, z, K, q) {
        ...
        if (!Array.isArray(W)) {
          var H = B(W);
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + z + "`, expected an array."));
        }
        for (var J = 0; J < W.length; J++) {
          var Q = y(W, J, z, K, q + "[" + J + "]", n);
    ...
    function _(y) {
      function O(U, X, z, K, q) {
        if (!(U[X] instanceof y)) {
          var W = y.name || w, H = ot(U[X]);
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + z + "`, expected ") + ("instance of `" + W + "`."));
        }
        return null;
      }
      return h(O);
    ...
    function F(y) {
      ...
      function O(U, X, z, K, q) {
        ...
        return new m("Invalid " + K + " `" + q + "` of value `" + String(W) + "` " + ("supplied to `" + z + "`, expected one of " + J + "."));
      }
      return h(O);
    }
    function R(y) {
      function O(U, X, z, K, q) {
        ...
        var W = U[X], H = B(W);
        if (H !== "object")
          return new m("Invalid " + K + " `" + q + "` of type " + ("`" + H + "` supplied to `" + z + "`, expected an object."));
        for (var J in W)
          if (r(W, J)) {
            var Q = y(W, J, z, K, q + "." + J, n);
            if (Q instanceof Error)
    ...
    function $(y) {
      ...
      function X(z, K, q, W, H) {
        for (var J = [], Q = 0; Q < y.length; Q++) {
          var dt = y[Q], A = dt(z, K, q, W, H, n);
          if (A == null)
            return null;
    ...
    function L() {
      function y(O, U, X, z, K) {
        return Y(O[U]) ? null : new m("Invalid " + z + " `" + K + "` supplied to " + ("`" + X + "`, expected a ReactNode."));
      }
      return h(y);
    }
    ...
    function I(y) {
      function O(U, X, z, K, q) {
        var W = U[X], H = B(W);
        if (H !== "object")
          return new m("Invalid " + K + " `" + q + "` of type `" + H + "` " + ("supplied to `" + z + "`, expected `object`."));
        for (var J in y) {
          var Q = y[J];
          if (typeof Q != "function")
            return D(z, K, q, J, Z(Q));
          var dt = Q(W, J, z, K, q + "." + J, n);
          if (dt)
            return dt;
        }
        return null;
...
function jd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var _ = i, F = a, R = t, $ = c, L = n, D = w, I = f, M = e, Y = o, G = r, B = d, Z = p, at = !1, ot = !1;
    function y(V) {
...
function ap(t) {
  t.addEventListener("keydown", rp, !0), t.addEventListener("mousedown", Fr, !0), t.addEventListener("pointerdown", Fr, !0), t.addEventListener("touchstart", Fr, !0), t.addEventListener("visibilitychange", op, !0);
}
function ip(t) {
  const {
    target: e
...
function ss() {
  ...
  function n() {
    return e.current ? (no = !0, tp.start(100, () => {
      no = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function ws(t, e) {
  const n = us(t.theme);
  return Object.keys(t).map((r) => Ep(t, e, r, n)).reduce(mn, {});
}
function ht(t) {
  return ws(t, fr);
}
...
const Tp = Gt("border", Vt), Cp = Gt("borderTop", Vt), Op = Gt("borderRight", Vt), Rp = Gt("borderBottom", Vt), _p = Gt("borderLeft", Vt), Pp = Gt("borderColor"), $p = Gt("borderTopColor"), Ip = Gt("borderRightColor"), Ap = Gt("borderBottomColor"), Mp = Gt("borderLeftColor"), Dp = Gt("outline", Vt), jp = Gt("outlineColor"), gr = (t) => {
...
hr(Tp, Cp, Op, Rp, _p, Pp, $p, Ip, Ap, Mp, gr, Dp, jp);
const br = (t) => {
...
hr(br, vr, yr, Bp, Vp, zp, Fp, Lp, Gp, Up, Xp, Yp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const Hp = vt({
...
function au() {
  function t(n, r, o, a) {
    ...
    return f ? f(i) : te(i, r, (v) => {
      let m = Kn(w, p, v);
      return v === m && typeof v == "string" && (m = Kn(w, p, `${n}${v === "default" ? "" : Wt(v)}`, v)), c === !1 ? m : {
        [c]: m
      };
    });
  }
...
function Io(t = {}, ...e) {
  ...
  return d.applyStyles = iu, d = e.reduce((p, f) => Qt(p, f), d), d.unstable_sxConfig = P({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return $o({
      sx: f,
      theme: this
    });
...
function gu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Ml(i, (b) => b.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const T = Il(i, P({
      ...
      c && w && R.push((D) => {
        ...
        if (!I.components || !I.components[c] || !I.components[c].styleOverrides)
          return null;
        const M = I.components[c].styleOverrides, Y = {};
        ...
        const M = zn(P({}, D, {
          defaultTheme: n,
          themeId: e
        })), Y = M == null || (I = M.components) == null || (I = I[c]) == null ? void 0 : I.variants;
        return Yn({
          variants: Y
        }, P({}, D, {
          theme: M
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Wt(d || "")}`), D === void 0 && (D = `Styled(${zd(i)})`), L.displayName = D;
      }
...
function tw(t) {
  const e = P({}, Ju, t.easing), n = P({}, Zu, t.duration);
  return P({
...
const iw = (t) => Xn(t) && t !== "classes", sw = gu({
  themeId: Do,
  defaultTheme: Mo,
...
const cw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], dw = (t) => {
  ...
  const r = jo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, cw), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = P({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
}, xw = /* @__PURE__ */ j.createContext(yw);
function Nw(t) {
  const {
...
function Sw(t) {
  ...
  const i = kw(P({}, o, r)), l = Ga(r), c = Ga(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (Jn["propTypes"] = Md(Jn.propTypes));
var Ot = "top", Ft = "bottom", Lt = "right", Rt = "left", Vo = "auto", Pn = [Ot, Ft, Lt, Rt], Ue = "start", kn = "end", $w = "clippingParents", Ns = "viewport", sn = "popper", Iw = "reference", Ua = /* @__PURE__ */ Pn.reduce(function(t, e) {
  return t.concat([e + "-" + Ue, e + "-" + kn]);
}, []), ks = /* @__PURE__ */ [].concat(Pn, [Vo]).reduce(function(t, e) {
...
function Jw(t) {
  ...
  if (!(!a || !i)) {
    var f = Kw(o.padding, n), w = Fo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = $n(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], b = T - w[p] - f[v], _ = T / 2 - w[p] / 2 + C, F = hn(E, _, b), R = c;
...
function Ya(t) {
  ...
  if (d) {
    var _ = $n(n), F = "clientHeight", R = "clientWidth";
...
function qa(t, e, n) {
  return e === Ns ? oo(cf(t, n)) : Te(e) ? pf(e, n) : oo(df(ce(t)));
}
function uf(t) {
  var e = gn(Nr(t)), n = ["absolute", "fixed"].indexOf(ee(t).position) >= 0, r = n && zt(t) ? $n(t) : t;
...
function En(t, e) {
  ...
  if (w === sn && D) {
    ...
    Object.keys(L).forEach(function(M) {
      var Y = [Lt, Ft].indexOf(M) >= 0 ? 1 : -1, G = [Ot, Ft].indexOf(M) >= 0 ? "y" : "x";
      L[M] += I[G] * Y;
    });
  }
  return L;
...
function hf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Ht(h), T = k === h, C = c || (T || !v ? [Hn(h)] : mf(h)), E = [h].concat(C).reduce(function(z, K) {
      return z.concat(Ht(K) === Vo ? ff(e, {
        placement: K,
        boundary: p,
        rootBoundary: f,
        padding: d,
      ...
      var D = E[L], I = Ht(D), M = He(D) === Ue, Y = [Ot, Ft].indexOf(I) >= 0, G = Y ? "width" : "height", B = En(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
      ...
      b[G] > _[G] && (Z = Hn(Z));
      var at = Hn(Z), ot = [];
      if (a && ot.push(B[I] <= 0), l && ot.push(B[Z] <= 0, B[at] <= 0), ot.every(function(z) {
        return z;
      })) {
        $ = D, R = !1;
        break;
...
function Tf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = En(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Ht(e.placement), T = He(e.placement), C = !T, E = Lo(k), b = Sf(E), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, $ = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (_) {
    if (a) {
      var M, Y = E === "y" ? Ot : Rt, G = E === "y" ? Ft : Lt, B = E === "y" ? "height" : "width", Z = _[E], at = Z + h[Y], ot = Z - h[G], y = g ? -R[B] / 2 : 0, O = T === Ue ? F[B] : R[B], U = T === Ue ? -R[B] : -F[B], X = e.elements.arrow, z = g && X ? Fo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ts(), q = K[Y], W = K[G], H = hn(0, F[B], z[B]), J = C ? F[B] / 2 - y - H - q - L.mainAxis : O - H - q - L.mainAxis, Q = C ? -F[B] / 2 + y + H + W + L.mainAxis : U + H + W + L.mainAxis, dt = e.elements.arrow && $n(e.elements.arrow), A = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = (M = D == null ? void 0 : D[E]) != null ? M : 0, V = Z + J - Nt - A, yt = Z + Q - Nt, Ut = hn(g ? Zn(at, V) : at, Z, g ? ye(ot, yt) : ot);
      _[E] = Ut, I[E] = Ut - Z;
    }
    if (l) {
      var de, St = E === "x" ? Ot : Rt, An = E === "x" ? Ft : Lt, Xt = _[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[St], Oe = Xt - h[An], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = D == null ? void 0 : D[b]) != null ? de : 0, ue = Re ? pe : Xt - F[Ce] - R[Ce] - _e + L.altAxis, Ze = Re ? Xt + F[Ce] + R[Ce] - _e - L.altAxis : Oe, Mn = g && Re ? Ww(ue, Xt, Ze) : hn(g ? ue : pe, Xt, g ? Ze : Oe);
      _[b] = Mn, I[b] = Mn - Xt;
    }
    e.modifiersData[r] = I;
  }
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Za(T, C)) {
            p.rects = {
              reference: Pf(T, $n(C), p.options.strategy === "fixed"),
              popper: Fo(C)
...
const Uf = () => Oo({
  root: ["root"]
}, Nw(Vf)), Xf = {}, Yf = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, h = kt(e, zf), k = j.useRef(null), T = Ee(k, n), C = j.useRef(null), E = Ee(C, w), b = j.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const _ = Lf(p, i), [F, R] = j.useState(_), [$, L] = j.useState(Qn(o));
  j.useEffect(() => {
...
`));
  ...
  const I = Uf(), M = (r = v.root) != null ? r : "div", Y = Cw({
    elementType: M,
  ...
  const {
    ...
    slotProps: h = {},
    slots: k = {}
  } = e, T = kt(e, Ff), [C, E] = j.useState(!0), b = () => {
    E(!1);
  }, _ = () => {
    E(!0);
  };
...
const Qf = {
  ...
  const {
  ...
  } = e, k = kt(e, Zf), T = dn(), C = j.useRef(), E = Is(), b = j.useRef(null), _ = Ee(b, a.ref, n), F = (G) => (B) => {
    if (G) {
      const Z = b.current;
      B === void 0 ? G(Z) : G(Z, B);
    }
    ...
    let ot;
    m === "auto" ? (ot = E.transitions.getAutoHeightDuration(G.clientHeight), C.current = ot) : ot = B, G.style.transition = [E.transitions.create("opacity", {
      duration: ot,
      delay: Z
    }), E.transitions.create("transform", {
      duration: Gr ? ot : ot * 0.666,
      delay: Gr ? Z : Z || ot * 0.333,
      easing: at
...
Yo.muiSupportAuto = !0;
const ei = Yo, tm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], em = _n($s, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ms(), a = jo({
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, tm), _ = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = P({
    anchorEl: i,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const js = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const _ = jo({
    ...
    TransitionProps: Nt
  } = _, V = kt(_, om), yt = /* @__PURE__ */ j.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
  }), Ut = Is(), de = Ut.direction === "rtl", [St, An] = j.useState(), [Xt, Ce] = j.useState(null), pe = j.useRef(!1), Oe = Y || ot, Re = dn(), _e = dn(), ue = dn(), Ze = dn(), [Mn, Ho] = is({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const qo = (tt) => {
    ...
    pe.current && tt.type !== "touchstart" || (St && St.removeAttribute("title"), _e.clear(), ue.clear(), B || Ln && Z ? _e.start(Ln ? Z : B, () => {
      qo(tt);
    }) : qo(tt));
  }, Wo = (tt) => {
    _e.clear(), ue.start(O, () => {
    ...
    St || An(tt.currentTarget), Ls(tt), Ko.current === !0 && (Jo(!0), Sr(tt));
  }, ta = (tt) => {
    pe.current = !0;
    const $t = yt.props;
    $t.onTouchStart && $t.onTouchStart(tt);
  }, ea = Sr, na = Wo, Us = (tt) => {
    ta(tt), ue.clear(), Re.clear(), Dn(), Qe.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Ze.start(at, () => {
      document.body.style.WebkitUserSelect = Qe.current, Sr(tt);
    });
  }, Xs = (tt) => {
    yt.props.onTouchEnd && yt.props.onTouchEnd(tt), Dn(), ue.start(U, () => {
      jn(tt);
    });
  };
  j.useEffect(() => {
  ...
  const Ys = Ee(yt.ref, Gs, An, n);
  !dt && dt !== 0 && (Jt = !1);
  const Tr = j.useRef(), Hs = (tt) => {
    const $t = yt.props;
...
`));
  ...
  const en = {};
  G || (jt.onTouchStart = Us, jt.onTouchEnd = Xs), M || (jt.onMouseOver = Gn(ea, jt.onMouseOver), jt.onMouseLeave = Gn(na, jt.onMouseLeave), Oe || (en.onMouseOver = ea, en.onMouseLeave = na)), I || (jt.onFocus = Gn(Qo, jt.onFocus), jt.onBlur = Gn(Zo, jt.onBlur), Oe || (en.onFocus = Qo, en.onBlur = Zo)), process.env.NODE_ENV !== "production" && yt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${yt.props.title}\` or the Tooltip component.`].join(`
`));
  const qs = j.useMemo(() => {
    var tt;
    let $t = [{
    ...
    return (tt = H.popperOptions) != null && tt.modifiers && ($t = $t.concat(H.popperOptions.modifiers)), P({}, H.popperOptions, {
      modifiers: $t
    });
  }, [Xt, H]), nn = P({}, _, {
    isRtl: de,
    ...
    touch: pe.current
  }), Or = im(nn), ra = (r = (o = Q.popper) != null ? o : $.Popper) != null ? r : sm, oa = (a = (i = (l = Q.transition) != null ? l : $.Transition) != null ? i : A) != null ? a : ei, aa = (c = (d = Q.tooltip) != null ? d : $.Tooltip) != null ? c : lm, ia = (p = (f = Q.arrow) != null ? f : $.Arrow) != null ? p : cm, Ws = pn(ra, P({}, H, (w = J.popper) != null ? w : L.popper, {
    className: ve(Or.popper, H == null ? void 0 : H.className, (g = (v = J.popper) != null ? v : L.popper) == null ? void 0 : g.className)
...
const In = tr(({ className: t, ...e }, n) => /* @__PURE__ */ s(vl, { size: 35, className: N("tw-animate-spin", t), ...e, ref: n }));
...
$m.displayName = Hr.Root.displayName;
