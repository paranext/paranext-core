...
import { c as v, g as xe, a as Yr, C as Ce, u as Eo, T as Mt, b as Ot, d as $t, e as It, A as ce, P as $e, f as We, B as G, h as Ie, i as Ae, j as Pe, k as _e, l as Ui, m as Ki, n as Hi, E as qi, o as Xa, r as fe, X as Gi, p as mn, q as oa, s as na, L as _t, R as Ja, t as Xr, D as Da, v as Ma, w as Oa, x as $a, y as vn, z as jr, F as Za, G as bn, H as Qa, I as He, J as kr, K as Ve, M as Le, N as je, S as _r, O as rr, Q as Wi, U as Er, V as Ge, W as De, Z as Ye, Y as Re, _ as ar, $ as to, a0 as eo, a1 as Jr, a2 as ro, a3 as xn, a4 as Yi, a5 as Xi, a6 as Ji, a7 as Ia, a8 as yn, a9 as ia, aa as kn, ab as Zi, ac as Qi, ad as ts, ae as es, af as _n, ag as Nn, ah as ao, ai as rs, aj as Cn, ak as ga, al as To, am as fa, an as as, ao as os, ap as ns, aq as is, ar as ss, as as Tr, at as oo, au as cs, av as ls } from "./resizable-CHn51d4g.js";
import { aw as vg, ax as bg, ay as xg, az as yg, aA as kg, aB as _g, aC as Ng, aD as Cg, aE as Eg, aF as Tg, aG as Sg, aH as zg, aI as Rg, aJ as Dg, aK as Mg, aL as Og, aM as $g, aN as Ig, aO as Ag, aP as Pg, aQ as Vg, aR as Lg, aS as jg, aT as Fg } from "./resizable-CHn51d4g.js";
import { jsx as a, jsxs as u, Fragment as st } from "react/jsx-runtime";
import { Canon as Dt } from "@sillsdev/scripture";
import { Check as Me, Clock as So, ChevronsLeft as zo, ChevronsRight as Ro, ChevronLeft as Aa, ChevronRight as Pa, ArrowLeft as ds, ArrowRight as ws, ChevronDown as ir, BoldIcon as us, ItalicIcon as ps, X as no, AtSign as En, Pencil as hs, Trash2 as gs, ArrowUp as Tn, MoreHorizontal as fs, MailOpen as ms, Mail as vs, ChevronUp as bs, FilterIcon as xs, ArrowLeftIcon as ys, ChevronLeftIcon as ks, ChevronRightIcon as _s, ArrowRightIcon as Ns, Copy as Sn, Filter as Cs, User as Es, Link as Ts, CircleHelp as Ss, Undo as zs, Redo as Rs, SquareX as zn, FunctionSquare as Rn, SquareSigma as Dn, Ban as Ds, AlertCircle as Va, CircleCheckIcon as Ms, CircleXIcon as Os, CircleHelpIcon as $s, ArrowUpIcon as Is, ArrowDownIcon as As, ScrollText as Ps, ChevronsUpDown as Vs, MenuIcon as Ls, Menu as js, EllipsisVertical as Fs, MoreVertical as Bs } from "lucide-react";
import { Section as ut, getChaptersForBook as Us, formatScrRef as ye, getSectionForBook as Fr, formatRelativeDate as Ks, formatReplacementString as qe, sanitizeHtml as io, NumberFormat as Mn, formatBytes as Hs, getCurrentLocale as qs, usfmMarkers as Br, getFormatCallerFunction as Gs, deepEqual as Ws, isString as Do, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Ys, getLocalizeKeyForScrollGroupId as Mo, formatReplacementStringToArray as Oo, collectUsjMarkers as Xs } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as O, createContext as sa, useContext as so, useState as k, useEffect as q, useCallback as F, useImperativeHandle as Js, useLayoutEffect as Xt, Component as Zs, createElement as $o, Suspense as Qs, forwardRef as On, useId as Io, Fragment as ca } from "react";
...
function fl({
  ...
  q(() => {
    var N;
    gl();
    const Y = (N = M.current) == null ? void 0 : N.closest('button, [role="combobox"], [tabindex]');
    if (!Y) return;
...
function xa({
  ...
  }), [Qt]), yt = O(() => Object.values(Gt).flat(), [Gt]), Pt = O(() => {
    if (!Y.trim()) return Gt;
    const x = {
      [ut.OT]: [],
      [ut.NT]: [],
  ...
  const { otLong: Bt, ntLong: Lt, dcLong: Ut, extraLong: we } = {
    ...
    () => xl(Y),
    [Y]
  ), gr = O(() => !d || !z || !z.chapterNum || !hr ? !1 : d(z.book, z.chapterNum) > 0, [d, z, hr]), Rr = F(
    (x) => w ? Uo(x, w) : !1,
    [w]
  ), fr = F(
    (x) => (H) => w ? yl(x, H, w) : !1,
...
function Go({
  ...
  const [_, M] = k(!1), U = d ?? l, C = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], j = ($, E) => {
...
function Al() {
  return function(t) {
    const [e] = ve(), r = O(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = B(o);
    return $l(() => {
...
function jl(t, e, r) {
  ...
  function l() {
    ...
    for (let T = 0; T < g.length; T++) {
      const y = g[T], _ = s[T] || document.createElement("div"), M = _.style;
      M.position !== "absolute" && (M.position = "absolute", m = !0);
      const U = pe(y.left - p);
      M.left !== U && (M.left = U, m = !0);
      const C = pe(y.top - h);
      M.top !== C && (_.style.top = C, m = !0);
      const j = pe(y.width);
      M.width !== j && (_.style.width = j, m = !0);
      const $ = pe(y.height);
      M.height !== $ && (_.style.height = $, m = !0), _.parentNode !== c && (c.append(_), m = !0), s[T] = _;
    }
...
function Bl(t, e = Fl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, T = g.getNode(), y = T.getKey(), _ = g.offset, M = t.getElementByKey(b), U = t.getElementByKey(y), C = r === null || M !== o || m !== n || b !== r.getKey(), j = i === null || U !== s || _ !== c || y !== i.getKey();
      if ((C || j) && M !== null && U !== null) {
...
function Hl(t) {
  ...
  if (he(e)) r = wc(e.focus, "next");
    ...
    r = r || uc(Oe(), "previous").getFlipped().insert(Sr());
  }
  ...
  return Ne(t.registerCommand(cd, (s) => {
    ...
    if (Rc(s.target)) {
      ...
      if (dd(c)) return function(l, d = !1) {
        ...
        let g;
        d && Un(w) ? g = w : (g = Mc(), Oc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Ad({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Md, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a($d, {}) }) }),
...
function sn({
  ...
  const g = F(
    ...
    [t.user]
  ), y = O(() => io(t.contents), [t.contents]), _ = O(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), M = !!t.conflictResolutionAction && !_, U = O(() => {
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          He,
...
function Ti({
  ...
  const [V, Y] = k(cn), [D, L] = k(), [S, N] = k(), Z = o, [X, gt] = k(!1), [tt, St] = k(!1), [W, nt] = k(!1), [ht, ft] = k(!1), [ct, Nt] = k(!1), [lt, Zt] = k(M), [ee, Ft] = k(!1), xt = B(void 0), [Qt, Gt] = k(/* @__PURE__ */ new Map());
  q(() => {
    let R = !0;
    return (async () => {
  ...
  const z = O(() => Pt[0], [Pt]), de = B(null), te = B(void 0), A = F(() => {
    var R;
  ...
  }, [i, r]), pt = O(() => Pt.slice(1), [Pt]), rt = O(() => pt.length ?? 0, [pt.length]), bt = O(() => rt > 0, [rt]), it = O(() => X || rt <= 2 ? pt : pt.slice(-2), [pt, rt, X]), mt = O(() => X || rt <= 2 ? 0 : rt - 2, [rt, X]), Vt = O(
...
function Wd({
  ...
  const [s, c] = k("accept"), l = Io(), d = Io(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = O(
    () => Gr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = O(
    () => Gr(t.acceptedText ?? ""),
    ...
    () => Gr(t.mergedText ?? ""),
    [t.mergedText]
  ), y = O(() => io(t.contents), [t.contents]);
  if (!Ni(t))
    return /* @__PURE__ */ a(Wr, { html: y });
  const _ = (S) => {
    c(S === "reject" || S === "merge" ? S : "accept");
  }, M = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", U = g ? [
    {
      value: "merge",
      ...
      !w && !h && /* @__PURE__ */ u(st, { children: [
        ...
        /* @__PURE__ */ a(
          Ja,
          {
            ...
            children: C.map((S) => D(S) ? /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u(Ot, { children: [
              /* @__PURE__ */ a($t, { asChild: !0, children: L(S) }),
              /* @__PURE__ */ a(It, { children: M })
            ] }) }, S.value) : L(S))
          }
        ),
...
function yp({
  ...
  const [y, _] = k(/* @__PURE__ */ new Set()), [M, U] = k(), [C, j] = k(), $ = F(
    async (N) => {
      const Z = await i(N);
...
function nw({
  ...
  var C;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, T] = k({}), y = O(() => e ?? [], [e]), _ = Wn({
    data: y,
    columns: t,
    getCoreRowModel: Xn(),
...
function hw({
  ...
  const f = (m) => {
    ...
    var T, y, _, M;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((T = i.current) == null || T.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((M = s.current) == null || M.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function Dp({
  ...
  const [f, b] = k("generated"), [m, T] = k("generated"), [y, _] = k("*"), [M, U] = k("*"), [C, j] = k("f"), [$, E] = k(!1), [P, K] = k(!0), [V, Y] = k(!1), D = B(!1), L = B(""), [S, N] = k(!1), [Z, X] = k(), [gt, tt] = k(), [St, W] = k(), [nt, ht] = k(), ft = B(null), ct = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
const Dw = (t) => {
...
}, ua = (t, e, r) => /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u(Ot, { children: [
  /* @__PURE__ */ u(
    $t,
    {
  ...
  return e ? e[1] : "";
}, Ow = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", jp = Object.freeze([
...
function Fp({
  ...
  const g = ue(r, "%webView_inventory_all%"), f = ue(r, "%webView_inventory_approved%"), b = ue(r, "%webView_inventory_unapproved%"), m = ue(r, "%webView_inventory_unknown%"), T = ue(r, "%webView_inventory_scope_currentBook%"), y = ue(r, "%webView_inventory_scope_chapter%"), _ = ue(r, "%webView_inventory_scope_verse%"), M = ue(r, "%webView_inventory_filter_text%"), U = ue(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = ue(r, "%webView_inventory_no_results%"), [j, $] = k(!1), [E, P] = k("all"), [K, V] = k(""), [Y, D] = k([]), L = O(() => {
    const W = t ?? [];
  ...
  }, [j, L]), N = O(() => S.length === 0 ? [] : $w(S, E, K), [S, E, K]), Z = O(() => {
    var ht, ft;
    if (!j) return l;
    ...
    !e && /* @__PURE__ */ u(
      cr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(wr, { position: "item-aligned", children: /* @__PURE__ */ a(ew, { children: M.map((E) => /* @__PURE__ */ a(se, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
...
function tu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, T] = k(!1), [y, _] = k(""), M = B(void 0), U = B(!1), C = O(
    () => Nn(t),
    [t]
  ), j = O(() => {
    if (!y.trim()) {
    ...
    (D, L = !1) => {
      ...
      const S = C.findIndex((tt) => tt === M.current), N = C.findIndex((tt) => tt === D);
      if (S === -1 || N === -1) return;
      const [Z, X] = [
        Math.min(S, N),
        Math.max(S, N)
...
function oh({
  ...
  ), Rr = Gt === "end", fr = Gt === "start", Be = "tw:text-muted-foreground", Ee = w === "dropdown" && Lt === "range", Dr = Ee ? zt : Q, ha = Ee ? Je : f ? dt : lt, Mr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
  ...
  }, []), Co = (I) => t === I ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
            ...
            children: /* @__PURE__ */ u(ga, { container: Tt, children: [
              bt.map(({ value: I, label: J, dropdownLabel: Wt, scrRefSuffix: mr, id: ji }) => /* @__PURE__ */ u(
                He,
                {
                  ...
                  children: [
                    t === I && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Me, { className: "tw:h-4 tw:w-4" }) }),
                    nt(Wt ?? J, mr, vt)
                  ]
                },
                ji
    ...
    w === "radio" && t === "range" && Mr,
    w === "dropdown" && it && /* @__PURE__ */ a(Da, { open: Lt === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: Qe,
        onCloseAutoFocus: No,
        ...
        children: /* @__PURE__ */ u(ga, { container: be, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: V }) }),
          gr,
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Or(!1), children: gt }),
            /* @__PURE__ */ a(G, { onClick: Se, children: X })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && mt && /* @__PURE__ */ a(Da, { open: Lt === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: Te,
        onCloseAutoFocus: No,
        ...
        children: /* @__PURE__ */ u(ga, { container: Et, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: S }) }),
          Mr,
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Or(!1), children: gt }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          wr,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((w) => /* @__PURE__ */ a(se, { value: `${w}`, children: l[Mo(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Oi = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a($t, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ns, { children: /* @__PURE__ */ a(is, { children: Oi(
      t,
      e,
      Mi(t, c.id),
      o
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ve, { variant: i, children: [
    ...
    /* @__PURE__ */ a(je, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ca, { children: [
      /* @__PURE__ */ a(xn, { children: /* @__PURE__ */ a(Mt, { children: Oi(e.groups, e.items, l, t) }) }),
  ...
  if (wl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(wu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(uu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Mt, { children: Li(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function hh({
  ...
  const d = _u(
    ...
    var T, y, _, M, U, C;
    const m = b !== f ? ((y = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : y[b]) ?? ((M = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : M.en) : void 0;
...
function pg(t) {
  const e = O(() => Xs(t).slice().sort().join(" "), [t]);
...
Au(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
