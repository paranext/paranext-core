...
import { r as Ut, Z as Vi, B as U, c as f, a as Li, C as $e, P as Re, b as Be, d as Ae, e as Ue, f as Ke, g as ve, h as _r, i as ta, T as ne, S as rr, j as ie, k as se, l as ce, D as We, m as br, n as Se, o as De, p as Oe, u as Fi, q as Nr, s as Xe, t as Le, v as za, w as cn, x as ji, y as Bi, z as ln, A as dn, E as Ui, F as Ki, G as qi, H as Gi, I as da, J as wa, K as lr, L as Hi, M as Yi, N as Wi, O as Xi, Q as Ji, R as Cr, U as Ga } from "./resizable-CUvCloPJ.js";
import { V as qh, W as Gh, X as Hh, Y as Yh, _ as Wh, $ as Xh, a0 as Jh, a1 as Zh, a2 as Qh } from "./resizable-CUvCloPJ.js";
import { jsx as a, jsxs as u, Fragment as nt } from "react/jsx-runtime";
import { Canon as gt } from "@sillsdev/scripture";
import { includes as Rr, Section as rt, getChaptersForBook as Zi, formatScrRef as Te, getSectionForBook as fr, formatRelativeDate as Qi, formatReplacementString as Ee, sanitizeHtml as ts, NumberFormat as es, formatBytes as rs, getCurrentLocale as as, usfmMarkers as Fr, getFormatCallerFunction as os, deepEqual as ns, isString as mo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as is, getLocalizeKeyForScrollGroupId as vo } from "platform-bible-utils";
import { Check as Fe, Clock as bo, ChevronsLeft as xo, ChevronsRight as yo, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as ss, ArrowRight as cs, ChevronDown as ar, BoldIcon as ls, ItalicIcon as ds, X as ea, AtSign as wn, Pencil as ws, Trash2 as us, ArrowUp as un, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as pn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, ChevronsUpDown as hn, Star as Es, Undo as Ts, Redo as zs, SquareX as gn, FunctionSquare as fn, SquareSigma as mn, Ban as Ss, AlertCircle as Ma, CircleCheckIcon as Ds, CircleXIcon as Os, CircleHelpIcon as Ms, ArrowUpIcon as $s, ArrowDownIcon as Rs, Search as As, LoaderCircle as Ps, ScrollText as Is, MenuIcon as Vs, Menu as Ls, EllipsisVertical as Fs, MoreVertical as ko } from "lucide-react";
import ft, { useRef as B, useMemo as F, useState as C, useCallback as L, useEffect as X, useLayoutEffect as Xt, createContext as Ha, useContext as vn, Component as js, createElement as _o, Suspense as Bs, forwardRef as ra, Fragment as bn } from "react";
import { Dialog as be, Label as Us, RadioGroup as $a, ToggleGroup as xn, Slot as dr, Avatar as Ya, Select as Vt, Checkbox as No, Tabs as he, Menubar as ke, ContextMenu as St, Progress as Co, Slider as Ar, Switch as Eo } from "radix-ui";
import { createEditor as yn, $getRoot as je, $createParagraphNode as Er, $getSelection as Bt, HISTORY_MERGE_TAG as Wa, ParagraphNode as kn, TextNode as _n, $getPreviousSelection as Ks, $isRangeSelection as xe, $caretFromPoint as qs, $getSiblingCaret as Nn, $getChildCaret as Gs, $getAdjacentChildCaret as Hs, $isChildCaret as Ys, $normalizeCaret as Ws, $setSelectionFromCaretRange as Xs, $getCollapsedCaretRange as Js, $getCaretInDirection as To, $splitAtPointCaretNext as Zs, $isTextPointCaret as Qs, $findMatchingParent as Cn, $isElementNode as xr, mergeRegister as Me, getDOMTextNode as tc, isHTMLElement as ec, CLEAR_EDITOR_COMMAND as En, COMMAND_PRIORITY_EDITOR as Xa, shallowMergeConfig as rc, defineExtension as le, safeCast as Je, createState as ac, FORMAT_TEXT_COMMAND as Tn, $isNodeSelection as zn, COMMAND_PRIORITY_LOW as Sn, RootNode as oc, LineBreakNode as nc, TabNode as ic, $isEditorState as sc, createCommand as cc, CLICK_COMMAND as lc, isDOMNode as dc, $getNodeFromDOMNode as wc, $createNodeSelection as uc, $setSelection as pc, $getEditor as hc, DecoratorNode as Ra, $getState as gc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as fc, $setState as mc, addClassNamesToElement as Dn, $create as vc, $getNodeByKey as bc, removeClassNamesFromElement as xc, KEY_TAB_COMMAND as yc, $isBlockElementNode as kc, $createRangeSelection as _c, $normalizeSelection__EXPERIMENTAL as Nc, OUTDENT_CONTENT_COMMAND as Cc, INDENT_CONTENT_COMMAND as So, INSERT_TAB_COMMAND as Ec, COMMAND_PRIORITY_CRITICAL as Ja, $isDecoratorNode as Tc, $isParagraphNode as zc, $isTextNode as Aa, SELECTION_CHANGE_COMMAND as On, $insertNodes as Sc } from "lexical";
import { HeadingNode as Dc, QuoteNode as Oc, registerRichText as Mc } from "@lexical/rich-text";
import { flushSync as $c, createPortal as Rc } from "react-dom";
import { IconX as Ac, IconCheck as aa, IconChevronDown as Pc, IconChevronUp as Ic, IconSelector as Vc, IconLayoutSidebar as Lc, IconLayoutSidebarRight as Fc, IconChevronRight as Mn, IconLoader as jc, IconAlertOctagon as Bc, IconAlertTriangle as Uc, IconInfoCircle as Kc, IconCircleCheck as qc } from "@tabler/icons-react";
...
import { useReactTable as Rn, getFilteredRowModel as Wc, getSortedRowModel as An, getPaginationRowModel as Xc, getCoreRowModel as Pn, flexRender as mr, getGroupedRowModel as Jc, getExpandedRowModel as Zc } from "@tanstack/react-table";
...
function Va({ ...t }) {
  return /* @__PURE__ */ a(be.Root, { "data-slot": "dialog", ...t });
}
function Bu({ ...t }) {
  return /* @__PURE__ */ a(be.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function sl({ ...t }) {
  return /* @__PURE__ */ a(be.Portal, { "data-slot": "dialog-portal", ...t });
}
function Uu({ ...t }) {
  return /* @__PURE__ */ a(be.Close, { "data-slot": "dialog-close", ...t });
}
function cl({
  className: t,
  ...
  return /* @__PURE__ */ u(sl, { children: [
    ...
    /* @__PURE__ */ u(
      be.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(be.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Ac, {}),
...
function Do({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(be.Close, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function dl({
  ...
  return /* @__PURE__ */ u(Re, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(ve, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      $e,
      {
        onSelect: () => h(g),
  ...
  const o = wl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && d) {
          const g = ((m) => Object.keys(ue).find(
            (y) => ue[y].toLowerCase() === m.toLowerCase()
          ))(c);
...
function gl(t, e, r, o) {
  const n = L(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const l = e[d - 1], w = Math.max(me(l), 1);
        o({
          book: l,
          chapterNum: w,
          verseNum: 1
...
function jn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ve, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (d, l) => l + 1).map((d) => {
...
function ga({
  ...
  const T = Ut(), [N, x] = C(!1), [I, q] = C(""), [V, M] = C(""), [k, z] = C("books"), [P, S] = C(void 0), [D, J] = C(
    void 0
  ), [G, $] = C(void 0), [at, ot] = C(!1), it = B(null), Kt = B(!1), kt = B(void 0), Dt = B(void 0), K = B(void 0), ct = B(void 0), lt = B({}), dt = B({}), wt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), qt = F(() => o ? o() : Vn, [o]), vt = F(() => ({
    [rt.OT]: qt.filter((H) => gt.isBookOT(H)),
    [rt.NT]: qt.filter((H) => gt.isBookNT(H)),
    [rt.DC]: qt.filter((H) => gt.isBookDC(H)),
    [rt.Extra]: qt.filter((H) => gt.extraBooks().includes(H))
  }), [qt]), Jt = F(() => Object.values(vt).flat(), [vt]), Ot = F(() => {
    if (!V.trim()) return vt;
    const b = {
      [rt.OT]: [],
      [rt.NT]: [],
    ...
    return [rt.OT, rt.NT, rt.DC, rt.Extra].forEach((et) => {
      b[et] = vt[et].filter((Ct) => Qa(Ct, V, n));
    }), b;
  }, [vt, V, n]), O = F(
    () => hl(V, Jt, n),
    [V, Jt, n]
  ...
  const Mt = L(() => {
    ...
    (b) => {
      const H = D ?? (O == null ? void 0 : O.book), et = G ?? (O == null ? void 0 : O.chapterNum);
      !H || !et || (wt({
        book: H,
        chapterNum: et,
        verseNum: b
    ...
    (b) => {
      const H = k === "chapters" ? P : O == null ? void 0 : O.book;
      if (H) {
        if (l && l(H, b) > 1) {
          J(H), $(b), z("verses"), q("");
          return;
    ...
    z("books"), S(void 0), J(void 0), $(void 0), setTimeout(() => {
      Dt.current && Dt.current.focus();
    }, 0);
  }, []), Gt = L(() => {
    const b = D;
    J(void 0), $(void 0), b ? (S(b), z("chapters"), q("")) : te();
  }, [D, te]), Et = L((b) => {
    x(b), b && (z("books"), S(void 0), J(void 0), $(void 0), M(""));
  }, []), { otLong: Lt, ntLong: de, dcLong: ee, extraLong: Ne } = {
    ...
    () => ul(V),
    [V]
  ), Q = F(() => !l || !O || !O.chapterNum || !j ? !1 : l(O.book, O.chapterNum) > 0, [l, O, j]), tt = L(
    (b) => w ? Oo(b, w) : !1,
    [w]
  ), ut = L(
    (b) => (H) => w ? pl(b, H, w) : !1,
    ...
    (b, H) => (et) => w ? ha(b, H, et, w) : !1,
    [w]
  ), yt = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ft = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Ht = L(
    (b) => {
    ...
    (b) => {
      var re, Ze, ur;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: et } = Mo(b.key);
      if ((k === "chapters" || k === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const Tt = (re = kt.current) == null ? void 0 : re.querySelector(
      ...
      if (k === "verses" && Ct) {
        ...
        switch (b.key) {
          case "ArrowLeft":
            mt !== 0 && (Yt = mt > 1 ? mt - 1 : Tt);
            break;
          case "ArrowRight":
            mt !== 0 && (Yt = mt < Tt ? mt + 1 : 1);
            break;
          case "ArrowUp":
            Yt = mt === 0 ? Tt : Math.max(1, mt - Wt);
            break;
          case "ArrowDown":
            Yt = mt === 0 ? 1 : Math.min(Tt, mt + Wt);
            break;
          default:
            return;
        }
        Yt !== mt && (b.preventDefault(), b.stopPropagation(), q(
          `${At} ${ue[At] || ""} ${_t}:${Yt}`
        ), setTimeout(() => {
          const Ge = dt.current[Yt];
          Ge && Ge.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((k === "chapters" || k === "books" && O) && Ct) {
        const At = k === "chapters" ? P : O == null ? void 0 : O.book;
        if (!At) return;
        k === "chapters" && ((ur = kt.current) == null || ur.focus());
        const _t = (() => {
          if (!I) return 1;
          const Wt = I.match(/(\d+)$/);
        ...
        switch (b.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            mt = _t === 0 ? Tt : Math.max(1, _t - Yt);
            break;
          case "ArrowDown":
            mt = _t === 0 ? 1 : Math.min(Tt, _t + Yt);
            break;
          default:
            return;
        }
        mt !== _t && (b.preventDefault(), b.stopPropagation(), q(
          `${At} ${ue[At] || ""} ${mt}`
        ), setTimeout(() => {
          const Wt = lt.current[mt];
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (Ct = Dt.current) == null || Ct.focus();
      return;
    }
    const { isLetter: H, isDigit: et } = Mo(b.key);
    (H || et) && (b.preventDefault(), M((re) => re + b.key), Dt.current.focus(), ot(!1));
  }, []);
  return Xt(() => {
    const b = setTimeout(() => {
      if (N && k === "books" && K.current && ct.current) {
        const H = K.current, et = ct.current, Ct = et.offsetTop, re = H.clientHeight, Ze = et.clientHeight, ur = Ct - re / 2 + Ze / 2;
        H.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), q(Fn(t.book));
    ...
    if (k === "chapters" && P) {
      const b = P === t.book, H = b ? t.chapterNum : 1;
      q(
        `${P} ${ue[P] || ""} ${H}`
      ), setTimeout(() => {
        if (K.current)
          if (b) {
            const et = lt.current[t.chapterNum];
  ...
  }, [k, P, O, t.book, t.chapterNum]), Xt(() => {
    if (k === "verses" && D && G !== void 0) {
      const b = D === t.book && G === t.chapterNum, H = b ? t.verseNum : 1;
      q(
        `${D} ${ue[D] || ""} ${G}:${H}`
      ), setTimeout(() => {
        if (K.current)
          if (b) {
            const et = dt.current[t.verseNum];
            et && et.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            K.current.scrollTo({ top: 0 });
        kt.current && kt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Re, { open: N, onOpenChange: Et, modal: v, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: it,
        ...
        onClick: (b) => {
          Kt.current && (Kt.current = !1, b.preventDefault());
        },
        children: h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: pt })
      }
    ) }),
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          N && it.current && H instanceof Node && it.current.contains(H) && (Kt.current = !0, Et(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ u(
          Ue,
          {
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Qt.map(({ onClick: b, disabled: H, title: et, icon: Ct }) => /* @__PURE__ */ a(
                  U,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: k === "verses" ? Gt : te,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                k === "chapters" && P && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ve(P, n) }),
                k === "verses" && D && G !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ve(D, n)} ${G}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: k === "verses" ? Ft : yt
                  }
                )
              ] }),
              !at && /* @__PURE__ */ u(Ke, { ref: K, children: [
                k === "books" && /* @__PURE__ */ u(nt, { children: [
                  !O && Object.entries(Ot).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ve, { heading: R(b), children: H.map((et) => /* @__PURE__ */ a(
                          Ln,
                          {
                            bookId: et,
                            onSelect: (Ct) => $t(Ct),
                            section: fr(et),
                            commandValue: `${et} ${ue[et]}`,
                            ref: et === t.book ? ct : void 0,
                            localizedBookNames: n,
                            disabled: tt(et)
                          },
                          et
                  ...
                  O && /* @__PURE__ */ a(ve, { children: /* @__PURE__ */ a(
                    $e,
                    {
                      ...
                      children: Te(
                        ...
                        n ? Za(O.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  O && Q && O.chapterNum && l && /* @__PURE__ */ u(nt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Ro,
                      {
                        ...
                        onVerseSelect: Zt,
                        setVerseRef: Y,
                        isVerseDisabled: xt(O.book, O.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  O && !Q && me(O.book) > 1 && /* @__PURE__ */ u(nt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                ...
                k === "chapters" && P && /* @__PURE__ */ a(
                  $o,
                  {
                    ...
                    onChapterSelect: Rt,
                    setChapterRef: _,
                    isChapterDisabled: ut(P),
                    className: "tw:p-4"
                  }
                ),
                k === "verses" && D && G !== void 0 && l && /* @__PURE__ */ a(
                  Ro,
                  {
                    bookId: D,
                    chapterNum: G,
...
function Ao({
  ...
  const [N, x] = C(!1), I = l ?? d, q = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], V = (M, k) => {
    const z = d(M), P = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, S = `${k ?? ""}${z}${P ?? ""}`;
    return /* @__PURE__ */ u(
      $e,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(Re, { open: N, onOpenChange: x, ...T, children: [
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ue, { children: [
          /* @__PURE__ */ a(_r, { placeholder: h, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(ta, { children: g }),
          /* @__PURE__ */ a(Ke, { children: q(e) ? e.map((M) => /* @__PURE__ */ a(ve, { heading: M.groupHeading, children: M.options.map((k) => V(k, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(ve, { children: e.map((M) => V(M)) }) })
        ] })
      }
    )
  ] });
    ...
    Bn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Nt, { className: "tw:flex tw:items-center", children: o.map((v) => gt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            U,
            {
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Kn ? Xt : X, Ir = { tag: Wa };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const m = Er();
            g.append(m);
            const y = Kn ? document.activeElement : null;
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : X;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : X;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = _e(), r = F(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = B(o);
    return Tl(() => {
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = qn && "documentMode" in document ? document.documentMode : null;
!(!qn || !("InputEvent" in window) || Ol) && "getTargetRanges" in new window.InputEvent("input");
function fe(t) {
  return `${t}px`;
}
...
function $l(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < g.length; E++) {
      const T = g[E], N = s[E] || document.createElement("div"), x = N.style;
      x.position !== "absolute" && (x.position = "absolute", v = !0);
      const I = fe(T.left - p);
      x.left !== I && (x.left = I, v = !0);
      const q = fe(T.top - h);
      x.top !== q && (N.style.top = q, v = !0);
      const V = fe(T.width);
      x.width !== V && (N.style.width = V, v = !0);
      const M = fe(T.height);
      x.height !== M && (N.style.height = M, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[E] = N;
    }
...
function Al(t, e = Rl) {
  ...
  function l(w) {
    w.read(() => {
      const p = Bt();
      if (!xe(p)) return r = null, n = null, i = null, c = null, d(), void (d = () => {
      });
      const [h, g] = function(M) {
        const k = M.getStartEndPoints();
        return M.isBackward() ? [k[1], k[0]] : k;
      }(p), m = h.getNode(), y = m.getKey(), v = h.offset, E = g.getNode(), T = E.getKey(), N = g.offset, x = t.getElementByKey(y), I = t.getElementByKey(T), q = r === null || x !== o || v !== n || y !== r.getKey(), V = i === null || I !== s || N !== c || T !== i.getKey();
      if ((q || V) && x !== null && I !== null) {
        const M = function(k, z, P, S, D, J, G) {
          const $ = (k._window ? k._window.document : document).createRange();
          return $.setStart(...Po(z, P, S)), $.setEnd(...Po(D, J, G)), $;
        }(t, h, m, x, g, E, I);
        d(), d = $l(t, M, e);
      }
      r = m, o = x, n = v, i = E, s = I, c = N;
    });
  }
...
function Il(t) {
  const e = Cn(t, (r) => xr(r) && !r.isInline());
  return xr(e) || Hr(4, t.__key), e;
}
function Vl(t) {
  const e = Bt() || Ks();
  let r;
  if (xe(e)) r = qs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Nn(c, "next"));
    }
    r = r || Gs(je(), "previous").getFlipped().insert(Er());
  }
...
function Ll(t, e, r) {
  ...
  return Qs(o) && Hr(283), o.insert(t.isInline() ? Er().append(t) : t), To(Nn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = Bt();
  if (!xe(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Cn(i, (l) => xr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Yr, ze = 0, Wr = 0, Ul = 0, Ba = 0, Br = 0;
function Vo(t) {
  if (st === void 0) return;
  let e = t.n;
...
function He(t, e) {
  It.call(this, void 0), this.x = t, this.s = void 0, this.g = Br - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Kl(t, e) {
  return new He(t, e);
}
...
It.prototype.brand = jl, It.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ze !== 0 && Wr === 0 && e.l !== Ba && (e.l = Ba, Yr = { S: e, v: e.v, i: e.i, o: Yr });
    })(this), this.v = t, this.i++, Br++, ze++;
    try {
...
} }), He.prototype = new It(), He.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yn(this), Lo(this), ze++;
  const t = st;
...
le({ build: (t, e, r) => wr(e), config: Je({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function Wn() {
  const t = je(), e = Bt(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), xe(e) && (e.format = 0);
}
function Xn(t, e = Wn) {
  return t.registerCommand(En, (r) => (t.update(e), !0), Xa);
}
le({ build: (t, e, r) => wr(e), config: Je({ $onClear: Wn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ye(() => Xn(t, o.value));
} });
function Gl(t) {
...
le({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Tn, (o) => {
  const n = Bt();
  if (zn(n) || xe(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Sn) });
function Zn(t, e) {
  let r;
...
const Ua = le({ build: (t) => Zn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const ao = 0, Ka = 1, ti = 2, ba = 3, Vr = 4, Qe = 5, xa = 6, hr = 7;
function ya(t) {
  return t.id === ao;
}
function ei(t) {
...
class Xl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Vr && ht(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= hr;
    }(e) || ht(316, String(e.id), String(hr)), e;
  }
...
const Zl = le({ config: Je({ setOptions: Fo, updateOptions: Fo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class er {
  ...
  static maybeFromEditor(e) {
    const r = e[jo];
    return r && (r.PACKAGE_VERSION !== ka && ht(292, r.PACKAGE_VERSION, ka), r instanceof er || ht(293)), r;
  }
  static fromEditor(e) {
...
const td = /* @__PURE__ */ new Set(), Uo = le({ build(t, e, r) {
  const o = r.getDependency(Ua).output, n = yr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Zn(() => {
  }, () => ye(() => {
...
le({ dependencies: [Ua, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [or], register(t, e, r) {
  ...
  return Me(t.registerCommand(ed, (s) => {
    const c = Bt();
    if (!xe(c)) return !1;
    ...
    if (dc(s.target)) {
      ...
      if (ad(c)) return function(d, l = !1) {
        const w = Bt(), p = d.isSelected(), h = d.getKey();
        let g;
        l && zn(w) ? g = w : (g = uc(), pc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Sn), t.registerMutationListener(or, (s, c) => {
    Bl(() => {
      let d = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") l.delete(w), d = !0;
        ...
        h ? h.domNode.value = g : (d = !0, l.set(w, { domNode: yr(g), selectedSignal: o(w) }));
      }
      d && (n.value = { nodeSelections: l });
    });
  }), ye(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: d } of n.value.nodeSelections.values()) s.push(ye(() => {
      const l = c.value;
...
le({ build: (t, e) => wr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Je({ $getParentEditor: function() {
  const t = hc();
...
le({ build: (t, e, r) => wr(e), config: Je({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ye(() => {
...
function od(t, e, r = ri) {
  return Me(t.registerCommand(yc, (o) => {
    const n = Bt();
    if (!xe(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
le({ build: (t, e, r) => wr(e), config: Je({ $canIndent: ri, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ye(() => {
    if (!o.value) return od(t, n, i);
  });
} });
const nd = le({ name: "@lexical/react/ReactProvider" });
function id() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (xe(m)) {
                const y = m.anchor;
                let v = y.getNode(), E = 0, T = 0;
                if (Aa(v) && l >= 0 && w >= 0 && (E = l, T = l + w, m.setTextNodeRange(v, E, v, T)), E === T && p === "" || (m.insertRawText(p), v = y.getNode()), Aa(v)) {
                  E = h, T = h + g;
...
le({ build: (t, e, r) => wr(e), config: Je({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ye(() => r.getOutput().disabled.value ? void 0 : oi(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const no = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : X;
...
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : X;
function fd({ onClear: t }) {
  const [e] = _e();
  return gd(() => Xn(e, t), [e, t]), null;
}
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : X;
function md({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: d, ariaLabelledBy: l, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: m, id: y, role: v = "textbox", spellCheck: E = !0, style: T, tabIndex: N, "data-testid": x, ...I }, q) {
  const [V, M] = C(t.isEditable()), k = L((P) => {
...
function Cd({
  ...
  const [e] = _e(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function hi({
  ...
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(
        U,
        {
          "aria-label": s,
          className: n,
      ...
      /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(ui, {}),
    /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(
      ...
      /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a("p", { children: c }) })
    ] }) })
  ] });
}
function Kr(t, e) {
...
function Ju({
  ...
  const [i, s] = C(Rd), [c, d] = C(n), [l, w] = C(!1), p = B(void 0), h = B(null);
  X(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Re, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
        U,
        {
          variant: "outline",
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : co(v) && (v.preventDefault(), v.stopPropagation(), ae(i) && g());
        },
        onKeyDown: (v) => {
...
function Yo({
  ...
  const g = L(
    (x) => {
      x && x.stopPropagation(), l(!1), p(void 0), s == null || s(!1);
    },
    [s]
  ), m = L(
    async (x) => {
      if (x && x.stopPropagation(), !w || !n) return;
      await n(
        t.id,
        Jr(w)
    ...
    const x = new Date(t.date), I = Qi(
      x,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), q = x.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    if (o && c)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (x) => {
              x.stopPropagation(), l(!0), p(Md(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u(
          ...
          {
            onClick: async (x) => {
              x.stopPropagation(), i && await i(t.id);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (x) => {
                x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), g()) : co(x) && (x.preventDefault(), x.stopPropagation(), ae(w) && m());
              },
              onKeyDown: (x) => {
                io(x), (x.key === "Enter" || x.key === " ") && x.stopPropagation();
              },
              onClick: (x) => {
                x.stopPropagation();
              },
        ...
        N && /* @__PURE__ */ u(Se, { children: [
          /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
          /* @__PURE__ */ a(Oe, { align: "end", children: N })
        ] })
      ]
    }
  );
...
function Ld({
  ...
  const [M, k] = C(Wo), [z, P] = C(), [S, D] = C(), J = o, [G, $] = C(!1), [at, ot] = C(!1), [it, Kt] = C(!1), [kt, Dt] = C(!1), [K, ct] = C(!1), [lt, dt] = C(x), [wt, qt] = C(!1), vt = B(void 0), [Jt, Ot] = C(/* @__PURE__ */ new Map());
  X(() => {
    let _ = !0;
    return (async () => {
  ...
  X(() => {
    if (!o) {
      O.current !== "idle" && (P(void 0), D(void 0), O.current = "idle");
      return;
    }
    O.current === "idle" && (O.current = "pending"), kt ? O.current === "pending" && V !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    V !== i && (P(V), O.current = "auto-populated") : O.current === "auto-populated" && (P(void 0), O.current = "pending");
  }, [o, V, kt, i]);
  const bt = F(() => e.filter((_) => !_.deleted), [e]);
  X(() => {
    let _ = !0;
    if (!o || !N) {
      Ot(/* @__PURE__ */ new Map());
  ...
  const Mt = F(() => bt[0], [bt]), Zt = B(null), $t = B(void 0), Rt = L(() => {
    var _;
    (_ = $t.current) == null || _.call($t), k(Wo);
  }, []), Pe = L(() => {
    const _ = !lt;
    dt(_), qt(!_), m == null || m(d, _);
  }, [lt, m, d]);
  X(() => {
    $(!1);
  }, [o]), X(() => {
    if (o && !lt && !wt) {
      ...
      return vt.current = _, () => clearTimeout(_);
    }
  ...
  }, [i, r]), Gt = F(() => bt.slice(1), [bt]), Et = F(() => Gt.length ?? 0, [Gt.length]), Lt = F(() => Et > 0, [Et]), de = F(() => G || Et <= 2 ? Gt : Gt.slice(-2), [Gt, Et, G]), ee = F(() => G || Et <= 2 ? 0 : Et - 2, [Et, G]), Ne = F(
    () => Et === 1 ? Qt.singleReply : Ee(Qt.multipleReplies, { count: Et }),
    [Et, Qt]
  ), R = F(
    () => ee === 1 ? Qt.singleReply : Ee(Qt.multipleReplies, { count: ee }),
    [ee, Qt]
  );
  X(() => {
    !o && at && Lt && ot(!1);
  ...
  const W = L(
    async (_) => {
      ...
      Y && await p({ threadId: d, contents: Y }) && Rt();
    },
    [
      Rt,
      M,
    ...
    async (_) => {
      const Y = ae(M) ? Jr(M) : void 0, j = _.status ? _.assignedUser : z ?? _.assignedUser, Q = await p({
        ..._,
        contents: Y,
        assignedUser: j
      });
      return Q && (j !== void 0 && D(j), Y && Rt()), Q;
    },
    [Rt, M, p, z]
  );
  if (bt.length !== 0)
        ...
        children: /* @__PURE__ */ u(Pd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              te && /* @__PURE__ */ a(br, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: te }),
              /* @__PURE__ */ a(
                U,
                {
                  variant: "ghost",
                  ...
                  children: lt ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(gs, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              Yo,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: ot,
                canEditOrDelete: (!at && Jt.get(Mt.id)) ?? !1,
            ...
            o && /* @__PURE__ */ u(nt, { children: [
              ee > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (_) => {
                    (_.key === "Enter" || _.key === " ") && (_.preventDefault(), _.stopPropagation(), $(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(rr, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: R }),
                      G ? /* @__PURE__ */ a(fs, {}) : /* @__PURE__ */ a(ar, {})
                    ] })
                  ]
                }
              ),
              de.map((_) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                Yo,
                {
                  comment: _,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: g,
                  onEditingChange: ot,
                  canEditOrDelete: (!at && Jt.get(_.id)) ?? !1
                }
              ) }, _.id)),
              v !== !1 && (!at || ae(M)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (_) => {
                    co(_) && (_.preventDefault(), _.stopPropagation(), (ae(M) || z !== void 0 && z !== S) && W());
                  },
                  onKeyDown: (_) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && (ae(M) || z !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ee(
                      ...
                      /* @__PURE__ */ u(Re, { open: it, onOpenChange: Kt, children: [
                        /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ a(
                          U,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !kt || !y || y.length === 0 || !y.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          Ae,
                          {
                            ...
                            align: "end",
                            onKeyDown: (_) => {
                              _.key === "Escape" && (_.stopPropagation(), Kt(!1));
                            },
                            children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(Ke, { children: y == null ? void 0 : y.map((_) => /* @__PURE__ */ a(
                              $e,
                              {
                                onSelect: () => {
                                  P(_ !== i ? _ : void 0), O.current = "user-selected", D(void 0), Kt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: Kr(_, r) })
                              },
                              _ || "unassigned"
                            )) }) })
                          }
...
function np({
  ...
  const [E, T] = C(/* @__PURE__ */ new Set()), [N, x] = C(), [I, q] = C(), V = L(
    async ($) => {
      const at = await i($);
      return at !== void 0 && $.assignedUser !== void 0 && $.assignedUser !== "" && q($.assignedUser), at;
    },
    [i]
  );
  X(() => {
    m && (T(($) => new Set($).add(m)), x(m));
  }, [m]);
  const M = r.filter(
    ($) => $.comments.some((at) => !at.deleted)
  ), k = M.map(($) => ({ id: $.id })), z = L(
    ($) => {
      T((at) => new Set(at).add($.id)), x($.id), y == null || y($.id);
    },
    [y]
  ), P = L(
    ($) => {
      ...
      T((ot) => {
        const it = new Set(ot);
        return it.has($) ? it.delete($) : it.add($), it;
      }), x($), y == null || y(at ? void 0 : $);
    },
    [E, y]
  ), { listboxRef: S, activeId: D, handleKeyDown: J } = Fi({
    options: k,
    onOptionSelect: z
  }), G = L(
    ($) => {
      $.key === "Escape" ? (N && E.has(N) && (T((at) => {
        const ot = new Set(at);
        return ot.delete(N), ot;
      }), x(void 0), y == null || y(void 0)), $.preventDefault(), $.stopPropagation()) : J($);
    },
    [N, E, J, y]
  );
  return /* @__PURE__ */ a(
...
function Fd({ table: t }) {
  return /* @__PURE__ */ u(Se, { children: [
    /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(ms, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ u(Oe, { align: "end", className: "tw:w-[150px]", children: [
...
function sr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Vt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Vt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Vc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ u(
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(cr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(we, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Wd({
  ...
  var q;
  const [w, p] = C([]), [h, g] = C([]), [m, y] = C({}), [v, E] = C({}), T = F(() => e ?? [], [e]), N = Rn({
    data: T,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  }), x = N.getVisibleFlatColumns();
  let I;
  return d ? I = Array.from({ length: 10 }).map((k, z) => `skeleton-row-${z}`).map((k) => /* @__PURE__ */ a(pe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(oe, { colSpan: x.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, k)) : ((q = N.getRowModel().rows) == null ? void 0 : q.length) > 0 ? I = N.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    pe,
    {
      onClick: () => s(V, N),
      "data-state": V.getIsSelected() && "selected",
      children: V.getVisibleCells().map((M) => /* @__PURE__ */ a(oe, { children: mr(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    V.id
  )) : I = /* @__PURE__ */ a(pe, { children: /* @__PURE__ */ a(oe, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Fd, { table: N }),
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(lo, { stickyHeader: i, children: N.getHeaderGroups().map((V) => /* @__PURE__ */ a(pe, { children: V.headers.map((M) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : mr(M.column.columnDef.header, M.getContext()) }, M.id)) }, V.id)) }),
...
function pp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Se, { children: [
    /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ u(U, { variant: "default", children: [
      /* @__PURE__ */ a(ks, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
      /* @__PURE__ */ a(ar, { size: 16, className: "tw:ml-2 tw:h-4 tw:w-4" })
    ] }) }),
    /* @__PURE__ */ a(Oe, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
...
function gi({
  ...
  const [E, T] = C(!1), N = L(
    ...
    const z = t.filter((S) => S.starred).sort((S, D) => S.label.localeCompare(D.label)), P = t.filter((S) => !S.starred).sort((S, D) => {
      const J = e.includes(S.value), G = e.includes(D.value);
      return J && !G ? -1 : !J && G ? 1 : S.label.localeCompare(D.label);
    });
    return [...z, ...P];
  }, [t, e, h]), q = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Re, { open: M, onOpenChange: w ?? T, children: [
    /* @__PURE__ */ a(Be, { asChild: !0, children: /* @__PURE__ */ u(
      U,
      {
        variant: y,
    ...
    /* @__PURE__ */ a(Ae, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ue, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: V, children: s })
      ] }),
      /* @__PURE__ */ u(Ke, { children: [
        /* @__PURE__ */ a(ta, { children: c }),
        /* @__PURE__ */ a(ve, { children: I.map((z) => /* @__PURE__ */ u(
          $e,
          {
            value: z.label,
            onSelect: N,
...
function ew({
  ...
  return /* @__PURE__ */ u(so, { children: [
    /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      ...
      /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ u("p", { children: [
        l,
    ...
    e && /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(
        U,
        {
          "aria-label": w,
...
function ow({
  ...
  const i = B(null), s = B(null), c = B(!1), [d, l] = C(t), [w, p] = C(r), [h, g] = C(!1);
  X(() => {
    l(t);
  }, [t]), X(() => {
    w !== r && p(r);
  ...
  const m = (v) => {
    ...
    var E, T, N, x;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((T = s.current) == null || T.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((x = s.current) == null || x.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(Se, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: aw(t, n, r) }) }) }),
      /* @__PURE__ */ a(ce, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Oe,
      {
...
function sw({
  ...
  return /* @__PURE__ */ u(Se, { children: [
    /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: nw(t, r) }) }) }),
      /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a("p", { children: iw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Oe, { style: { zIndex: ln }, children: [
...
function dw({
  ...
  return /* @__PURE__ */ u(Ue, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(Ke, { children: [
      ...
      /* @__PURE__ */ a(ve, { children: s.map((d) => {
        var l;
        return /* @__PURE__ */ a(
          tn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a(ve, { children: c.map((d) => {
          var l;
          return /* @__PURE__ */ a(
            tn,
            {
...
function mp({
  ...
  var Ne;
  const h = B(null), g = B(null), m = B(null), y = B(null);
  Xt(() => {
    if (!y.current) return;
    const { width: R } = y.current.getBoundingClientRect();
    R > 0 && (y.current.style.width = `${R}px`);
  }, []);
  const [v, E] = C("generated"), [T, N] = C("generated"), [x, I] = C("*"), [q, V] = C("*"), [M, k] = C("f"), [z, P] = C(!1), [S, D] = C(!0), [J, G] = C(!1), $ = B(!1), at = B(""), [ot, it] = C(!1), [Kt, kt] = C(), [Dt, K] = C(), [ct, lt] = C(), [dt, wt] = C(), qt = B(null), vt = B(void 0), Jt = B(0), Ot = F(
    () => ({
      ...c,
  ...
  X(() => {
    ...
    if (W && Pr("note", W)) {
      const Y = (pt = W.insert.note) == null ? void 0 : pt.caller;
      let j = "custom";
      Y === Pa ? j = "generated" : Y === Ia ? j = "hidden" : Y && (I(Y), V(Y)), E(j), N(j), k(((_ = W.insert.note) == null ? void 0 : _.style) ?? "f"), R = setTimeout(() => {
        var Q, tt, ut;
        (Q = h.current) == null || Q.applyUpdate([W]), s && ((tt = h.current) == null || tt.selectNote(0), (ut = h.current) == null || ut.focus());
      }, 0);
    }
    return () => {
      R && clearTimeout(R);
  ...
  const bt = L(
    (R, W, pt = !1) => {
      var Y, j, Q;
      const _ = (j = (Y = h.current) == null ? void 0 : Y.getNoteOps(0)) == null ? void 0 : j.at(0);
      if (_ && Pr("note", _)) {
        if (_.insert.note) {
          let tt;
          R === "custom" ? tt = W : R === "generated" ? tt = Pa : tt = Ia, _.insert.note.caller = tt;
        }
        r == null || r([_]), pt && w && i && ((Q = w.current) == null || Q.replaceEmbedUpdate(i, [_]));
      }
    },
    [i, r, w]
  ), Mt = L(() => {
  ...
  const $t = B({ book: n.book, chapterNum: n.chapterNum });
  Xt(() => {
    ($t.current.book !== n.book || $t.current.chapterNum !== n.chapterNum) && ($t.current = { book: n.book, chapterNum: n.chapterNum }, Zt.current());
  }, [n.book, n.chapterNum]);
  const Rt = () => {
    var W;
    const R = (W = g.current) == null ? void 0 : W.getElementsByClassName("editor-input")[0];
    ...
    var pt, _, Y, j, Q;
    k(R);
    const W = (_ = (pt = h.current) == null ? void 0 : pt.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (W && Pr("note", W)) {
      W.insert.note && (W.insert.note.style = R);
      const tt = (j = (Y = W.insert.note) == null ? void 0 : Y.contents) == null ? void 0 : j.ops;
      M !== "x" && R === "x" ? tt == null || tt.forEach((ut) => pw(ut)) : M === "x" && R !== "x" && (tt == null || tt.forEach((ut) => hw(ut))), (Q = h.current) == null || Q.applyUpdate([W, { delete: 1 }]);
    }
  }, Gt = (R) => {
    wt(R.contextMarker), G(R.canRedo);
  }, Et = L(
    (R) => {
      var pt, _, Y, j, Q;
      const W = (_ = (pt = h.current) == null ? void 0 : pt.getNoteOps(0)) == null ? void 0 : _.at(0);
      if (W && Pr("note", W)) {
        ...
        const tt = (Y = W.insert.note) == null ? void 0 : Y.style, ut = (Q = (j = W.insert.note) == null ? void 0 : j.contents) == null ? void 0 : Q.ops;
        if (tt || P(!1), P(
          tt === "x" ? !!(ut != null && ut.every((xt) => {
            var Ft, Ht;
            if (!((Ft = xt.attributes) != null && Ft.char)) return !0;
            const yt = ((Ht = xt.attributes) == null ? void 0 : Ht.char).style;
          ...
          $.current = !0, at.current = JSON.stringify(W), D(!0);
          return;
        }
        D(JSON.stringify(W) === at.current), bt(v, x);
      } else
        P(!1), D(!0);
    },
    [v, x, bt]
    ...
    if (m.current && O.length && R && R.rangeCount > 0) {
      const W = R.getRangeAt(0).getBoundingClientRect(), pt = m.current.getBoundingClientRect();
      kt(W.left - pt.left), K(W.top - pt.top), lt(W.height), it(!0);
    }
  }, [O, m]), de = L(
    (R, W, pt) => {
      const { anchorRect: _ } = R;
      if (!p || !_) return;
      const { passive: Y, literalPrefixLanded: j } = pt;
      Jt.current += 1;
      const Q = Jt.current;
      vt.current = Y ? { token: Q, literalPrefixLanded: j, filter: "", items: W } : void 0, p.show(W.map(uw), _, Y).then((tt) => {
        var ut, xt, yt;
        if (en(vt, Q), tt !== void 0) {
          const Ft = W.find((Ht) => Ht.marker === tt);
          Ft && ((ut = h.current) == null || ut.applyMarkerMenuSelection(Ft, {
            trigger: "backslash",
            literalPrefixLanded: j
          })), (xt = h.current) == null || xt.focus();
        } else Y || (yt = h.current) == null || yt.focus();
      }).catch(() => {
        var tt;
        en(vt, Q), Y || (tt = h.current) == null || tt.focus();
      });
    },
    [p]
  );
  X(() => {
    ...
    var R;
    ot && ((R = qt.current) == null || R.focus());
  }, [ot]), X(() => {
    var pt, _;
    const R = ((pt = g.current) == null ? void 0 : pt.querySelector(".editor-input")) ?? void 0;
    if (((_ = Ot.view) == null ? void 0 : _.markerMode) === "editable") {
      if (!p) return () => {
      };
      const Y = (j) => {
        var yt;
        ...
        const Q = vt.current;
        if (Q) {
          if (j.key === "Shift" || j.key === "Control" || j.key === "Alt" || j.key === "Meta")
            return;
          if (j.key === "ArrowDown" || j.key === "ArrowUp") {
            j.preventDefault(), p.update({ moveSelection: j.key === "ArrowDown" ? 1 : -1 });
            return;
          }
          if (j.key === "Enter") {
            j.preventDefault(), vt.current = void 0, p.commit();
            return;
          }
          if (j.key === "Escape") {
            j.preventDefault(), vt.current = void 0, p.dismiss();
            return;
          }
          if (j.key === " " || j.key === "*") {
            vt.current = void 0, p.dismiss();
            return;
          }
          if (j.key === "Backspace" || /^[a-z0-9+]$/.test(j.key)) {
            Q.filter = j.key === "Backspace" ? Q.filter.slice(0, -1) : Q.filter + j.key, p.update({ filterText: Q.filter });
            return;
          }
          vt.current = void 0, p.dismiss();
          return;
        ...
        if (j.key !== d) return;
        const tt = (yt = h.current) == null ? void 0 : yt.getMarkerMenuContext();
        if (!tt) return;
        const ut = rl(Ot.styleInfo ?? al, tt);
        if (ut.length === 0) return;
        const xt = !tt.hasTextSelection;
        xt || j.preventDefault(), de(tt, ut, { passive: xt, literalPrefixLanded: xt });
      };
    ...
    const W = (Y) => {
      !ot && R && document.activeElement === R && Y.key === d ? (Y.preventDefault(), Lt()) : ot && Y.key === "Escape" && (Y.preventDefault(), it(!1));
    };
    ...
    Lt,
    d,
    (Ne = Ot.view) == null ? void 0 : Ne.markerMode,
    Ot.styleInfo,
    p,
    de
  ]);
  ...
  return /* @__PURE__ */ u(nt, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
              /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ a(
                U,
                {
                  "aria-label": ee,
              ...
              /* @__PURE__ */ a(ce, { children: /* @__PURE__ */ a("p", { children: ee }) })
            ] }) }) })
          ]
        }
      )
    ...
    /* @__PURE__ */ u(Re, { open: ot, children: [
      /* @__PURE__ */ a(
        Ki,
        {
          className: "tw:absolute",
...
function vw({
  ...
  /* @__PURE__ */ u("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    wo(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", y = f(h, g);
  return /* @__PURE__ */ u(nt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(nt, { children: fw(t.marker, c, o, l) })
      }
    )
  ] });
}
function bp({
  ...
  const w = d ?? os(r, void 0), p = (T, N) => {
    l == null || l(T, N, n);
  }, h = i ? r.findIndex((T) => T === i) : -1, [g, m] = C(h), y = (T, N, x) => {
    if (r.length)
      switch (T.key) {
        case "Enter":
        case " ":
          T.preventDefault(), l == null || l(N, x, n);
          break;
      }
  }, v = (T) => {
    if (r.length)
        ...
        "ul",
        {
          ...
          children: r.map((T, N) => {
            ...
            return /* @__PURE__ */ u(nt, { children: [
              ...
              N < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(rr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function xw({
  ...
  return /* @__PURE__ */ u(na, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(lo, { stickyHeader: !0, children: /* @__PURE__ */ u(pe, { children: [
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      pe,
      {
        ...
        children: [
          /* @__PURE__ */ a(oe, { children: Te(c.reference, "English") }),
          /* @__PURE__ */ a(oe, { className: o, children: bw(c.text) })
        ]
      },
...
const yw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
  /* @__PURE__ */ u(
    se,
    {
  ...
  /* @__PURE__ */ a(ce, { side: "bottom", children: e })
] }) }), xp = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, _w = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ep = Object.freeze([
...
function Tp({
  ...
  const g = ge(r, "%webView_inventory_all%"), m = ge(r, "%webView_inventory_approved%"), y = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), E = ge(r, "%webView_inventory_scope_currentBook%"), T = ge(r, "%webView_inventory_scope_chapter%"), N = ge(r, "%webView_inventory_scope_verse%"), x = ge(r, "%webView_inventory_filter_text%"), I = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), q = ge(r, "%webView_inventory_no_results%"), [V, M] = C(!1), [k, z] = C("all"), [P, S] = C(""), [D, J] = C([]), G = F(() => {
    const K = t ?? [];
    ...
    const K = [];
    return G.forEach((ct) => {
      const lt = ct.items[0], dt = K.find(
        (wt) => wt.items[0] === lt
      );
      dt ? (dt.count += ct.count, dt.occurrences = dt.occurrences.concat(ct.occurrences)) : K.push({
        items: [lt],
        count: ct.count,
  ...
  }, [V, G]), at = F(() => $.length === 0 ? [] : Nw($, k, P), [$, k, P]), ot = F(() => {
    var lt, dt;
    if (!V) return d;
  ...
  X(() => {
    at.length === 0 ? J([]) : at.length === 1 && J(at[0].items);
  }, [at]);
  const it = (K, ct) => {
    ct.setRowSelection(() => {
      const dt = {};
    ...
    const K = $.filter((ct) => ns(
      V ? ct.items : [ct.items[0]],
      D
    ));
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        nr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(cr, { children: [
              ...
              /* @__PURE__ */ a(we, { value: "approved", children: m }),
              /* @__PURE__ */ a(we, { value: "unapproved", children: y }),
              /* @__PURE__ */ a(we, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(nr, { onValueChange: (K) => Kt(K), defaultValue: s, children: [
        /* @__PURE__ */ a(sr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(ir, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(cr, { children: [
          /* @__PURE__ */ a(we, { value: "book", children: E }),
          /* @__PURE__ */ a(we, { value: "chapter", children: T }),
          /* @__PURE__ */ a(we, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        zr,
      ...
      o && /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ u(ie, { children: [
        /* @__PURE__ */ a(se, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          /* @__PURE__ */ a(
            mi,
            {
        ...
        /* @__PURE__ */ a(ce, { children: (o == null ? void 0 : o.checkboxText) ?? I })
      ] }) })
    ] }),
...
function Ca({
  ...
  if (e.length !== 0)
    return /* @__PURE__ */ u(nt, { children: [
      /* @__PURE__ */ a(pe, { className: "tw:border-0 tw:hover:bg-transparent", children: /* @__PURE__ */ a(oe, { colSpan: 4, className: "tw:border-0 tw:pt-4 tw:pb-0", children: /* @__PURE__ */ a(Nt, { className: "tw:text-xs tw:tracking-wider tw:text-muted-foreground tw:uppercase", children: t }) }) }),
      e.map((o) => /* @__PURE__ */ u(
        pe,
        {
          ...
          children: [
            /* @__PURE__ */ a(oe, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(nt, { children: [
              /* @__PURE__ */ a(Fe, { className: "tw:h-3.5 tw:w-3.5", "aria-hidden": !0 }),
              /* @__PURE__ */ a("span", { className: "tw:sr-only", children: t })
            ] }) }),
            /* @__PURE__ */ a(oe, { className: "tw:border-0 tw:py-1 tw:pr-2 tw:font-normal tw:whitespace-nowrap", children: o.displayName }),
            /* @__PURE__ */ a(oe, { className: "tw:border-0 tw:py-1 tw:pl-2", children: o.fullName }),
            /* @__PURE__ */ a(oe, { className: "tw:border-0 tw:py-1 tw:pl-4 tw:text-right tw:text-muted-foreground", children: o.bestLanguageName })
          ]
        },
        o.dblEntryUid
      ))
...
function Sp({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = F(
    () => t.filter((D) => !r || D.type === r).filter((D) => Tw(D, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: y, hasMore: v } = Ew(g), E = F(
    () => Array.from(new Set(t.map((D) => D.bestLanguageName))).map((D) => ({
      label: D,
      value: D
    })),
    [t]
  ), T = p.length === 0 && h.length === 0 && g.length === 0, N = Ce(n, "%resourcePicker_title%"), x = Ce(n, "%resourcePicker_search_placeholder%"), I = Ce(n, "%resourcePicker_language_filter_any%"), q = Ce(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = Ce(n, "%resourcePicker_section_installed%"), M = Ce(
    n,
    "%resourcePicker_section_available_to_download%"
  ), k = Ce(n, "%resourcePicker_no_results%"), z = Ce(n, "%resourcePicker_showing_count%"), P = F(() => {
    if (d.length === E.length || d.length === 0)
      return I;
    if (d.length === 1) {
      const D = E.find((J) => J.value === d[0]);
      if (D) return D.label;
    }
    return Ee(
      Ce(n, "%resourcePicker_language_filter_multipleSelected%"),
      {
  ...
  return /* @__PURE__ */ u(nt, { children: [
    ...
    S && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: Ee(z, {
      filtered: w.length,
      total: t.length
    }) }),
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      T && !e && /* @__PURE__ */ a("p", { className: "tw:py-8 tw:text-center tw:text-muted-foreground", children: k }),
      !T && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        ...
        v && /* @__PURE__ */ a(pe, { className: "tw:border-0", children: /* @__PURE__ */ a(oe, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: y, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const zw = "16rem", Sw = "3rem", bi = ft.createContext(void 0);
function la() {
...
function Dw({
  ...
  const [d, l] = ft.useState(t), w = e ?? d, p = ft.useCallback(
    (N) => {
      const x = typeof N == "function" ? N(w) : N;
      r ? r(x) : l(x);
    },
    [r, w]
  ), h = ft.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", v = Ut() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ft.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Iw({
  ...
  const c = t ? dr.Root : "button", { state: d } = la(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(Pw({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(ie, { children: [
    /* @__PURE__ */ a(se, { asChild: !0, children: l }),
    /* @__PURE__ */ a(
      ce,
      {
        side: "right",
...
function Vw({
  ...
  const l = L(
    ...
    (g) => {
      const m = r.find((y) => y.projectId === g);
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u($w, { children: [
        /* @__PURE__ */ u(rn, { children: [
          ...
          /* @__PURE__ */ a(on, { children: /* @__PURE__ */ a(Rw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => l(g),
              isActive: h(g),
...
const Ie = "scrBook", Lw = "scrRef", Ye = "source", Fw = "details", jw = "Scripture Reference", Bw = "Scripture Book", xi = "Type", Uw = "Details";
function Kw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? gt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ie ? Te(n.start) : void 0;
      },
...
}, nn = (t) => `${qw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Kp({
  sources: t,
  ...
  const [l, w] = C([]), [p, h] = C([{ id: Ie, desc: !1 }]), [g, m] = C({}), y = F(
    () => t.flatMap((k) => k.data.map((z) => ({
      ...z,
      source: k.source
    }))),
    [t]
  ...
  X(() => {
    if (c) {
      const k = E.getSelectedRowModel().rowsById, z = Object.keys(k);
      if (z.length === 1) {
        const P = y.find((S) => nn(S) === z[0]) || void 0;
        P && c(P);
      }
    }
  }, [g, y, c, E]);
  const T = n ?? Bw, N = i ?? xi, x = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${T}`, value: [Ie] },
    { label: `Group by ${N}`, value: [Ye] },
    {
    ...
    !k.getIsGrouped() && !k.getIsSelected() && k.getToggleSelectedHandler()(z);
  }, V = (k, z) => k.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), M = (k, z, P) => {
    if (!((k == null ? void 0 : k.length) === 0 || z.depth < P.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(cr, { position: "item-aligned", children: /* @__PURE__ */ a(jd, { children: x.map((k) => /* @__PURE__ */ a(we, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(lo, { children: E.getHeaderGroups().map((k) => /* @__PURE__ */ a(pe, { children: k.headers.filter((z) => z.column.columnDef.header).map((z) => (
      ...
      /* @__PURE__ */ a(ia, { children: E.getRowModel().rows.map((k, z) => {
        const P = Ut();
        return /* @__PURE__ */ a(
          pe,
          {
            ...
            children: k.getVisibleCells().map((S) => {
              if (!(S.getIsPlaceholder() || S.column.columnDef.enableGrouping && !S.getIsGrouped() && (S.column.columnDef.id !== Ye || !r)))
                return /* @__PURE__ */ a(
                  oe,
                  {
                    className: f(
...
function Gw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: m } = {
  ...
  }, [y, v] = C(!1), [E, T] = C(""), N = B(void 0), x = B(!1), I = F(
    () => yi(t),
    [t]
  ), q = F(() => {
    if (!E.trim()) {
    ...
    (S, D = !1) => {
      ...
      const J = I.findIndex((it) => it === N.current), G = I.findIndex((it) => it === S);
      if (J === -1 || G === -1) return;
      const [$, at] = [
        Math.min(J, G),
        Math.max(J, G)
      ], ot = I.slice($, at + 1).map((it) => it);
      r(
  ...
  return /* @__PURE__ */ u(
    Re,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ae, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ue,
          {
            shouldFilter: !1,
            onKeyDown: (S) => {
              S.key === "Enter" && (x.current = S.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                _r,
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: z, children: d }),
                /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: P, children: l })
              ] }),
              /* @__PURE__ */ u(Ke, { children: [
                /* @__PURE__ */ a(ta, { children: w }),
                Object.values(rt).map((S, D) => {
                  const J = q[S];
                  if (J.length !== 0)
                    return /* @__PURE__ */ u(bn, { children: [
                      ...
                      D < Object.values(rt).length - 1 && /* @__PURE__ */ a(dn, {})
                    ] }, S);
                })
              ] })
            ]
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ea ? Ea : sn
      ).map((d) => /* @__PURE__ */ a(br, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(d, n) }, d)),
...
function Gp({
  ...
  const x = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), I = zt(s, "%webView_scope_selector_verse%"), q = zt(s, "%webView_scope_selector_chapter%"), V = zt(s, "%webView_scope_selector_book%"), M = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), k = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), z = zt(s, "%webView_scope_selector_current_book%"), P = zt(s, "%webView_scope_selector_choose_books%"), S = zt(s, "%webView_scope_selector_scope%"), D = zt(s, "%webView_scope_selector_select_books%"), J = zt(s, "%webView_scope_selector_range%"), G = zt(s, "%webView_scope_selector_select_range%"), $ = zt(s, "%webView_scope_selector_range_start%"), at = zt(s, "%webView_scope_selector_range_end%"), ot = zt(s, "%webView_scope_selector_ok%"), it = zt(s, "%webView_scope_selector_cancel%"), Kt = zt(s, "%webView_scope_selector_navigate%"), kt = (A) => {
    if (!m) return;
    ...
    { value: "selectedText", label: x, id: "scope-selected-text" },
    {
      value: "verse",
      label: I,
      dropdownLabel: M,
      scrRefSuffix: kt("verse"),
      id: "scope-verse"
    },
    {
      value: "chapter",
    ...
    },
    {
      ...
      label: V,
      dropdownLabel: z,
      scrRefSuffix: kt("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: P, id: "scope-selected" },
    { value: "range", label: J, id: "scope-range" }
  ], K = (A, Z, jt = !1) => /* @__PURE__ */ u(nt, { children: [
    A,
    Z && !jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), ct = e ? Dt.filter((A) => e.includes(A.value)) : Dt, lt = m ?? pa, dt = w ?? lt, wt = p ?? lt, qt = () => {
  }, vt = B(null), Jt = B(null), Ot = B(!1), O = B(null), bt = B(!1), [Mt, Zt] = C(void 0), $t = B(!1), Rt = B(!1), Pe = B(null), Qt = L((A) => {
    if (A) {
      Zt("start"), $t.current = !1;
      return;
    }
    Zt((Z) => Z === "start" ? void 0 : Z), $t.current && ($t.current = !1, requestAnimationFrame(() => {
      var jt;
      const Z = (jt = vt.current) == null ? void 0 : jt.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), te = L((A) => {
    if (A) {
    ...
    (A) => {
      h == null || h(A), g == null || g(A), $t.current = !0;
    },
    [h, g]
  ), Et = L(
    (A) => {
      g == null || g(A), Rt.current = !0;
    },
    [g]
  ), Lt = L(
    (A) => {
    ...
    [r, n, m, i]
  ), de = ct.find((A) => A.value === t), ee = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? is(dt, wt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : de ? K(de.label, de.scrRefSuffix) : t, Ne = ct.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), R = ct.find((A) => A.value === "selectedBooks"), W = ct.find((A) => A.value === "range"), [pt, _] = C(!1), [Y, j] = C(void 0), [Q, tt] = C(void 0), [ut, xt] = C(void 0), [yt, Ft] = C(void 0), [Ht, Sr] = C([]), Dr = l === "dropdown" && Y === "selectedBooks", b = /* @__PURE__ */ a(
    Yw,
    {
      availableBookInfo: o,
      selectedBookIds: Dr ? Ht : n,
      onChangeSelectedBookIds: Dr ? Sr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), H = Mt === "end", et = Mt === "start", Ct = "tw:text-muted-foreground", re = l === "dropdown" && Y === "range", Ze = re ? xt : Gt, At = re ? Ft : g ? Et : qt, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: f(H && Ct), children: $ }),
      /* @__PURE__ */ a(
        ga,
        {
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-end", className: f(et && Ct), children: at }),
      /* @__PURE__ */ a(
        ga,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: re ? ut ?? dt : dt,
          onOpenChange: te,
          onCloseAutoFocus: (A) => {
            var Z;
            Rt.current && (Rt.current = !1, A.preventDefault(), (Z = Pe.current) == null || Z.focus());
          },
          className: f(et && Ct),
          modal: !0,
          align: "start"
  ...
  const [Wt, Ge] = C(null), [Or, Di] = C(null), [Mr, Oi] = C(null), Mi = 200, [$i, Ri] = C(!1);
  X(() => {
    if (!Mr || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([Z]) => {
      Ri(Z.contentRect.width < Mi);
    });
    return A.observe(Mr), () => A.disconnect();
  }, [Mr]);
  const po = L(
    (A) => {
      tt(A), xt(dt), Ft(wt), Sr(n), _(!1), j(A);
    },
    [dt, wt, n]
  ), ho = L(() => {
    Q !== void 0 && (Q === "range" ? (ut && (h == null || h(ut)), yt && (g == null || g(yt))) : Q === "selectedBooks" && i(Ht), Lt(Q), j(void 0), tt(void 0));
  }, [
    Q,
    ut,
    yt,
    ...
    A || (j(void 0), tt(void 0));
  }, []), go = L((A) => {
    var Z;
    A.preventDefault(), (Z = Yt.current) == null || Z.focus();
  }, []), fo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !T && /* @__PURE__ */ a(Nt, { children: S }),
      l === "dropdown" ? /* @__PURE__ */ u(Se, { open: pt, onOpenChange: _, children: [
        /* @__PURE__ */ a(De, { asChild: !0, children: /* @__PURE__ */ u(
          U,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ee() }),
              /* @__PURE__ */ a(ar, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Oe,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: Mr, children: [
              Ne.map(({ value: A, label: Z, dropdownLabel: jt, scrRefSuffix: pr, id: Ai }) => /* @__PURE__ */ u(
                We,
                {
                  ref: mt(A),
                  ...
                  children: [
                    t === A && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Fe, { className: "tw:h-4 tw:w-4" }) }),
                    K(jt ?? Z, pr, $i)
                  ]
                },
                Ai
              ...
              y && /* @__PURE__ */ u(nt, { children: [
                /* @__PURE__ */ a(Xe, {}),
                /* @__PURE__ */ a(Nr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: Kt }),
                /* @__PURE__ */ a(
                  We,
                  {
                    ref: O,
                    ...
                    onSelect: (A) => {
                      var Z, jt;
                      if (A.preventDefault(), Ot.current) {
                        Ot.current = !1;
                        return;
                      }
                      bt.current || (jt = (Z = Jt.current) == null ? void 0 : Z.querySelector("button")) == null || jt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          Z != null && Z.closest("button") && (Ot.current = !0, requestAnimationFrame(() => {
                            Ot.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ga,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var Z;
                              A.preventDefault(), (Z = O.current) == null || Z.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(nt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Te(m ?? pa, "id") }),
                              /* @__PURE__ */ a(ar, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Bn,
        {
          ...
          children: ct.map(({ value: A, label: Z, scrRefSuffix: jt, id: pr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Fa, { className: "tw:me-2", value: A, id: pr }),
            /* @__PURE__ */ a(Nt, { htmlFor: pr, children: K(Z, jt) })
          ] }, pr))
        }
      )
    ] }),
    l === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { children: D }),
      b
    ] }),
    l === "radio" && t === "range" && _t,
    l === "dropdown" && R && /* @__PURE__ */ a(Va, { open: Y === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Di,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (A) => {
          Or != null && Or.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(da, { container: Or, children: [
          ...
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => $r(!1), children: it }),
            /* @__PURE__ */ a(U, { onClick: ho, children: ot })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && W && /* @__PURE__ */ a(Va, { open: Y === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      La,
      {
        ref: Ge,
        onCloseAutoFocus: go,
        onEscapeKeyDown: (A) => {
          Wt != null && Wt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(Do, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => $r(!1), children: it }),
            /* @__PURE__ */ a(U, { ref: Pe, onClick: ho, children: ot })
          ] })
        ] })
      }
    ) })
...
function Hp({
  ...
  return /* @__PURE__ */ u(
    nr,
    {
      ...
      children: [
        /* @__PURE__ */ a(sr, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          ir,
          {
        ...
        /* @__PURE__ */ a(
          cr,
          {
            ...
            style: { zIndex: lr },
            children: t.map((l) => /* @__PURE__ */ a(we, { value: `${l}`, children: c[vo(l)] }, `${l}`))
          }
        )
      ]
    }
...
const Ni = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ u(ie, { children: [
  /* @__PURE__ */ a(se, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    We,
    {
      onClick: () => {
        o(c);
  ...
  c.tooltip && /* @__PURE__ */ a(ce, { children: c.tooltip })
...
function qa({
  ...
  return /* @__PURE__ */ u(Se, { variant: i, children: [
    /* @__PURE__ */ a(De, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(Oe, { align: "start", style: { zIndex: lr }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(bn, { children: [
      /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(ne, { children: Ni(e.groups, e.items, d, t) }) }),
...
Ei.displayName = he.List.displayName;
...
Ti.displayName = he.List.displayName;
const Jw = ft.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  he.Trigger,
  {
    ref: r,
    ...e,
...
zi.displayName = he.Content.displayName;
function Qp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ei, { children: [
      /* @__PURE__ */ a(Ti, { children: t.map((c) => /* @__PURE__ */ a(Jw, { value: c.value, children: c.value }, c.key)) }),
...
const gr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(ie, { children: [
      /* @__PURE__ */ a(se, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        au,
        {
          onClick: () => {
            o(l);
        ...
        /* @__PURE__ */ a(iu, { children: l.label }),
        /* @__PURE__ */ a(su, { children: Si(
          t,
          e,
          _i(t, l.id),
          o
      ...
      l.tooltip && /* @__PURE__ */ a(ce, { children: l.tooltip })
    ] }, `tooltip-${l.label}-${"command" in l ? l.command : l.id}`)), d = [...c];
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(ou, {}, `separator-${i}`)), d;
  });
};
function cu({
  menuData: t,
  ...
  const n = B(void 0), i = B(void 0), s = B(void 0), c = B(void 0), d = B(void 0), l = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), gr(i, [h, g]);
        break;
      case "alt+l":
        (y = s.current) == null || y.focus(), gr(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), gr(c, [h, g]);
        break;
      case "alt+h":
        (E = d.current) == null || E.focus(), gr(d, [h, g]);
        break;
    }
  }), X(() => {
    ...
    return /* @__PURE__ */ a(Zw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Qw, { children: [
      /* @__PURE__ */ a(eu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        ru,
        {
          style: { zIndex: lr },
          children: /* @__PURE__ */ a(ne, { children: Si(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function rh({
  ...
  const l = lu(
    ...
    var E, T, N, x, I, q;
    const v = y !== m ? ((T = (E = t[m]) == null ? void 0 : E.uiNames) == null ? void 0 : T[y]) ?? ((x = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : x.en) : void 0;
      ...
      nr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: lr },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(we, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Nt, { className: "tw:font-normal tw:text-muted-foreground", children: Ee(l, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Se, { children: [
              /* @__PURE__ */ a(De, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(U, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
              /* @__PURE__ */ a(Oe, { align: "end", children: l })
            ] }) }),
...
function bh({
  ...
  return /* @__PURE__ */ u(
    St.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(St.ItemIndicator, { children: /* @__PURE__ */ a(aa, {}) }) }),
        e
      ]
    }
  );
...
function Th({
  ...
  const n = Ut();
  return /* @__PURE__ */ u(pu, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(hu, {}),
    /* @__PURE__ */ u(
      qe.Content,
      {
...
function Ih({
  ...
  return /* @__PURE__ */ a(
    he.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", gu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
export {
  ...
  Gh as PopoverDescription,
  Hh as PopoverHeader,
  da as PopoverPortalContainerProvider,
  Yh as PopoverTitle,
  Be as PopoverTrigger,
  Mh as Progress,
  zp as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  Bn as RadioGroup,
  Fa as RadioGroupItem,
  dl as RecentSearches,
  Wh as ResizableHandle,
  Xh as ResizablePanel,
  Jh as ResizablePanelGroup,
  Sp as ResourcePickerDialog,
  oh as ResultsCard,
  qp as SCOPE_SELECTOR_STRING_KEYS,
  Ww as SELECT_BOOKS_STRING_KEYS,
  Gp as ScopeSelector,
