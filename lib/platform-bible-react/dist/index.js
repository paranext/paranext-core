...
import { includes as cn, Section as Y, getChaptersForBook as Fs, formatScrRef as ve, getSectionForBook as Xe, formatRelativeDate as Gs, formatReplacementString as be, sanitizeHtml as Us, NumberFormat as Ks, formatBytes as qs, getCurrentLocale as Hs, usfmMarkers as fn, getFormatCallerFunction as Ys, deepEqual as Xs, isString as Vr, compareScrRefs as Jn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as et } from "platform-bible-utils";
...
import { GENERATOR_NOTE_CALLER as Zn, HIDDEN_NOTE_CALLER as Qn, getDefaultViewOptions as Gi, isInsertEmbedOpOfType as dn, Editorial as Ui } from "@eten-tech-foundation/platform-editor";
...
Kt.displayName = Nt.Item.displayName;
...
const Uo = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), ye = Object.fromEntries(
  Uo.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function br(t, e, n) {
...
function tl({
  ...
  return /* @__PURE__ */ d(re, { open: c, onOpenChange: w, children: [
...
function tp(t, e, n = (a, i) => a === i, o = 15) {
  return (a) => {
    const i = t.filter(
      (l) => !n(l, a)
    ), s = [a, ...i.slice(0, o - 1)];
...
function rl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const w = e[c - 1], p = Math.max(Gt(w), 1);
        o({
          book: w,
          chapterNum: p,
          verseNum: 1
...
function Ur({
  ...
  if (t)
    return /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Gt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      Kt,
      {
        value: `${t} ${ye[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function ep({
  ...
  const w = ht(), [p, u] = T(!1), [h, f] = T(""), [g, x] = T(""), [v, y] = T("books"), [k, C] = T(void 0), [_, F] = T(!1), L = X(void 0), S = X(void 0), P = X(void 0), E = X(void 0), D = X({}), A = K(
    (N) => {
      e(N), l && l(N);
    },
    [e, l]
  ), V = z(() => o ? o() : Uo, [o]), O = z(() => ({
    [Y.OT]: V.filter((j) => dt.isBookOT(j)),
    [Y.NT]: V.filter((j) => dt.isBookNT(j)),
    [Y.DC]: V.filter((j) => dt.isBookDC(j)),
    [Y.Extra]: V.filter((j) => dt.extraBooks().includes(j))
  }), [V]), I = z(() => Object.values(O).flat(), [O]), W = z(() => {
    if (!g.trim()) return O;
    const N = {
      [Y.OT]: [],
      [Y.NT]: [],
    ...
    return [Y.OT, Y.NT, Y.DC, Y.Extra].forEach((G) => {
      N[G] = O[G].filter((q) => br(q, g, a));
    }), N;
  }, [O, g, a]), M = z(
    () => nl(g, I, a),
    [g, I, a]
    ...
    (N) => {
      const j = v === "chapters" ? k : M == null ? void 0 : M.book;
      j && (A({
        book: j,
        chapterNum: N,
        verseNum: 1
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: j, isDigit: G } = Gr(N.key);
      if (v === "chapters") {
        if (N.key === "Backspace") {
        ...
        if (j || G) {
          if (N.preventDefault(), N.stopPropagation(), y("books"), C(void 0), G && k) {
            const q = ye[k];
            x(`${q} ${N.key}`);
          } else
            x(N.key);
    ...
    const { isLetter: j, isDigit: G } = Gr(N.key);
    (j || G) && (N.preventDefault(), x((q) => q + N.key), S.current.focus(), F(!1));
  }, []);
  return Jt(() => {
    const N = setTimeout(() => {
      if (p && v === "books" && P.current && E.current) {
        const j = P.current, G = E.current, q = G.offsetTop, J = j.clientHeight, ct = G.clientHeight, tt = q - J / 2 + ct / 2;
        j.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), f(rr(t.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if (P.current)
          if (N) {
            const j = D.current[t.chapterNum];
  ...
  }, [v, k, M, t.book, t.chapterNum]), /* @__PURE__ */ d(re, { open: p, onOpenChange: U, children: [
    /* @__PURE__ */ r(pe, { asChild: !0, children: /* @__PURE__ */ r(
      B,
      {
      ...
      ee,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: mt.map(({ onClick: N, disabled: j, title: G, icon: q }) => /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
                size: "sm",
          ...
          !_ && /* @__PURE__ */ d(ne, { ref: P, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !M && Object.entries(W).map(([N, j]) => {
                if (j.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Qt, { heading: me(N), children: j.map((G) => /* @__PURE__ */ r(
                      Ko,
                      {
                        bookId: G,
                        onSelect: (q) => _t(q),
...
function or({
  ...
  const [k, C] = T(!1), _ = c ?? l, F = (S) => S.length > 0 && typeof S[0] == "object" && "options" in S[0], L = (S, P) => {
...
function op({
  ...
  const p = Vn(w, "%webView_bookSelector_currentBook%"), u = Vn(w, "%webView_bookSelector_choose%"), h = Vn(w, "%webView_bookSelector_chooseBooks%"), [f, g] = T(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), t(v);
...
function cl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = ll(null, o), p = No({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (u) => s(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function vl() {
  return function(t) {
    const [e] = Ht(), n = z(() => t(e), [e, t]), [o, a] = T(() => n.initialValueFn()), i = X(o);
    return gl(() => {
...
class Ze {
  ...
  static maybeFromEditor(e) {
    const n = e[Wr];
    return n && (n.PACKAGE_VERSION !== Gn && rt(292, n.PACKAGE_VERSION, Gn), n instanceof Ze || rt(293)), n;
  }
  static fromEditor(e) {
...
const Al = /* @__PURE__ */ new Set(), Zr = te({ build(t, e, n) {
  ...
  return { watchNodeKey: function(s) {
    const l = Cl(() => (i.value || Al).has(s)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(s);
    const p = w !== void 0;
  ...
  return we(t.registerCommand(si, (s) => {
    if (ii(s.target)) {
      ...
      if ($l(l)) return function(c, w = !1) {
        const p = Zt(), u = c.isSelected(), h = c.getKey();
        let f;
    ...
    _l(() => {
      ...
      for (const [p, u] of s.entries()) if (u === "destroyed") w.delete(p), c = !0;
        ...
        h ? h.domNode.value = f : (c = !0, w.set(p, { domNode: nn(f), selectedSignal: o(p) }));
      }
...
function Ll(t, e) {
  return we(t.registerCommand(gi, (n) => {
    ...
    const a = function(i) {
      ...
      const s = i.anchor, l = i.focus, c = l.isBefore(s) ? l : s, w = c.getNode(), p = Kr(w);
      if (p.canIndent()) {
        const u = p.getKey();
        let h = bi();
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (en(g)) {
                ...
                if (vn(v) && w >= 0 && p >= 0 && (y = w, k = w + p, g.setTextNodeRange(v, y, v, k)), y === k && u === "" || (g.insertRawText(u), v = x.getNode()), vn(v)) {
                  y = h, k = h + f;
...
function Kl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    _r(() => we(Ii(a), ia(a)), [a]);
  }(o), d(lt, { children: [t, r(ql, { content: e }), r(Ul, { editor: o, ErrorBoundary: n })] });
}
...
function ow({
  ...
  const [e] = Ht(), [n, o] = T(e), [a, i] = T("paragraph"), [s, l] = rw(), c = () => {
  };
...
function ua(t, e, n, o = null) {
  ...
  const l = xe(s) ? s.getChildren() : [], c = Ci(t, s.getType());
  let w;
...
function ap({
  ...
  const [a, i] = T(fw), [s, l] = T(void 0), [c, w] = T(!1), p = X(void 0), u = X(null);
  H(() => {
    let y = !0;
    const k = u.current;
    if (!k) return;
...
const sp = Object.freeze([
  ...
  const a = X(null), [i, s] = T(void 0), [l, c] = T(void 0), w = K(
    (f) => {
      s(f);
...
}), Ge = ot.Trigger, Na = ot.Group, Cw = ot.Portal, Ew = ot.Sub, Rw = ot.RadioGroup;
...
function no({
  ...
  const f = K(
    (_) => {
      _ && _.stopPropagation(), w(!1), u(void 0), s == null || s(!1);
    },
    [s]
  ), g = K(
    async (_) => {
    ...
    [t.user]
  ), k = z(() => Us(t.contents), [t.contents]), C = z(() => {
    if (o && l)
      return /* @__PURE__ */ d(lt, { children: [
        /* @__PURE__ */ d(
          kn,
          {
            onClick: (_) => {
              _.stopPropagation(), w(!0), u(mw(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        C && /* @__PURE__ */ d(Ee, { children: [
          /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(mo, {}) }) }),
...
function Sw({
  ...
  const [S, P] = T(ro), [E, D] = T(
    void 0
  ), A = o, [V, O] = T(!1), [I, W] = T(!1), [M, Z] = T(!1), [_t, Rt] = T(!1), [Ot, mt] = T(!1), [pt, U] = T(_), [nt, ut] = T(!1), it = X(void 0), [xt, me] = T(/* @__PURE__ */ new Map());
  H(() => {
    let R = !0;
    return (async () => {
      const Tt = k ? await k(c) : !1;
      R && mt(Tt);
    })(), () => {
      R = !1;
    };
  ...
  const Yt = z(() => jt[0], [jt]), Re = X(null), ae = X(void 0), zt = K(() => {
    var R;
    (R = ae.current) == null || R.call(ae), P(ro);
  }, []), $ = K(() => {
    const R = !pt;
    U(R), ut(!R), g == null || g(c, R);
  }, [pt, g, c]);
  H(() => {
    O(!1);
  }, [o]), H(() => {
  ...
  }, [i, n]), G = z(() => jt.slice(1), [jt]), q = z(() => G.length ?? 0, [G.length]), J = z(() => q > 0, [q]), ct = z(() => V || q <= 2 ? G : G.slice(-2), [G, q, V]), tt = z(() => V || q <= 2 ? 0 : q - 2, [q, V]), It = z(
  ...
  const At = K(
    async (R) => {
      ...
      gt && await u({ threadId: c, contents: gt }) && zt();
    },
    [
      zt,
      S,
      ...
      children: /* @__PURE__ */ d(va, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            j && /* @__PURE__ */ r(Ae, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: j }),
            /* @__PURE__ */ r(
              B,
              {
                variant: "ghost",
...
function Fw({
  ...
  var L;
  const [p, u] = T([]), [h, f] = T([]), [g, x] = T({}), [v, y] = T({}), k = z(() => e ?? [], [e]), C = Ao({
    data: k,
    columns: t,
    getCoreRowModel: $o(),
  ...
  return c ? F = Array.from({ length: 10 }).map((E, D) => `skeleton-row-${D}`).map((E) => /* @__PURE__ */ r(Xt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(lr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = C.getRowModel().rows) == null ? void 0 : L.length) > 0 ? F = C.getRowModel().rows.map((S) => /* @__PURE__ */ r(
    ...
    S.id
  )) : F = /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
...
function pp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ d(B, { variant: "default", children: [
      /* @__PURE__ */ r(vs, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(je, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ue, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(wn, { children: w.label }),
      /* @__PURE__ */ r(Na, { children: w.itemType === 0 ? /* @__PURE__ */ r(lt, { children: w.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Wt,
        {
          checked: o[p][h],
...
function Xw({
  ...
  return /* @__PURE__ */ d(lt, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      ...
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: so(a, "%undoButton_tooltip%") }) })
    ] }) }),
    e && /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      ...
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: so(a, "%redoButton_tooltip%") }) })
    ] }) })
  ] });
}
...
const Ww = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(lt, { children: [
...
function Jw({
  ...
  const g = (v) => {
    ...
    var y, k, C, _;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = i.current) == null || y.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((k = s.current) == null || k.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((C = i.current) == null ? void 0 : C.selectionStart) === 0 && ((_ = s.current) == null || _.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ee, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Mt, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Ww(t, a, n) }) }) }),
...
const Zw = (t, e) => t === "f" ? /* @__PURE__ */ d(lt, { children: [
  /* @__PURE__ */ r(vo, {}),
  " ",
...
function tc({
  ...
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
      /* @__PURE__ */ r(Di, { asChild: !0, children: /* @__PURE__ */ r(Ge, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: Zw(t, n) }) }) }),
      /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: Qw(t, n) }) })
    ] }) }),
...
function rc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = T(""), i = z(() => {
      ...
      /* @__PURE__ */ r(Qt, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ d(
          Kt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(nc, { icon: s.icon }) }) }),
              /* @__PURE__ */ d("div", { children: [
...
function hp({
  ...
  const p = X(null), u = X(null), h = X(null), [f, g] = T("generated"), [x, v] = T("*"), [y, k] = T("f"), [C, _] = T(!1), [F, L] = T(!0), [S, P] = T(!1), E = X(!1), D = X(""), [A, V] = T(!1), [O, I] = T(), [W, M] = T(), [Z, _t] = T(), [Rt, Ot] = T(), mt = X(null), pt = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (N && dn("note", N)) {
      const q = (j = N.insert.note) == null ? void 0 : j.caller;
      let J = "custom";
      q === Zn ? J = "generated" : q === Qn ? J = "hidden" : q && v(q), g(J), k(((G = N.insert.note) == null ? void 0 : G.style) ?? "f"), $ = setTimeout(() => {
        var ct;
  ...
  const nt = K(
    ($, N, j = !1) => {
      var q, J, ct;
      const G = (J = (q = p.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (G && dn("note", G)) {
        if (G.insert.note) {
          let tt;
          $ === "custom" ? tt = N : $ === "generated" ? tt = Zn : tt = Qn, G.insert.note.caller = tt;
        }
        n == null || n([G]), j && w && i && ((ct = w.current) == null || ct.replaceEmbedUpdate(i, [G]));
      }
    },
    [i, n, w]
  ), ut = K(() => {
    nt(f, x, !0), o();
  }, [f, x, o, nt]), it = X({ book: a.book, chapterNum: a.chapterNum });
  H(() => {
  ...
  const xt = () => {
    ...
    var j, G, q, J, ct;
    k($);
    const N = (G = (j = p.current) == null ? void 0 : j.getNoteOps(0)) == null ? void 0 : G.at(0);
    if (N && dn("note", N)) {
      N.insert.note && (N.insert.note.style = $);
      const tt = (J = (q = N.insert.note) == null ? void 0 : q.contents) == null ? void 0 : J.ops;
      y !== "x" && $ === "x" ? tt == null || tt.forEach((It) => ac(It)) : y === "x" && $ !== "x" && (tt == null || tt.forEach((It) => sc(It))), (ct = p.current) == null || ct.applyUpdate([N, { delete: 1 }]);
    }
  }, Re = ($) => {
    ...
    const N = (q = (G = p.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : q.at(0);
    if (N && dn("note", N)) {
    ...
    if (h.current && U.length && $ && $.rangeCount > 0) {
      const N = $.getRangeAt(0).getBoundingClientRect(), j = h.current.getBoundingClientRect();
      I(N.left - j.left), M(N.top - j.top), _t(N.height), V(!0);
    }
  }, [U, h]);
  return H(() => {
    const $ = () => {
    ...
    var j;
    const $ = ((j = u.current) == null ? void 0 : j.querySelector(".editor-input")) ?? void 0, N = (G) => {
      !A && $ && document.activeElement === $ && G.key === l ? (G.preventDefault(), zt()) : A && G.key === "Escape" && (G.preventDefault(), V(!1));
    };
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
            ...
            /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_closeButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ d(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(Dt, { children: [
              ...
              /* @__PURE__ */ r(Et, { children: /* @__PURE__ */ r("p", { children: c["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: lc(t.marker, l, o, w) })
      }
    )
  ] });
}
  ...
  const p = c ?? Ys(n, void 0), u = (k, C) => {
    ...
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), w == null || w(C, _, a);
          break;
      }
  }, v = (k) => {
    if (n.length)
...
const uc = (t) => {
  ...
  return e ? e[1] : "";
}, fc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Cp = Object.freeze([
...
function Ep({
  ...
  const f = Ft(n, "%webView_inventory_all%"), g = Ft(n, "%webView_inventory_approved%"), x = Ft(n, "%webView_inventory_unapproved%"), v = Ft(n, "%webView_inventory_unknown%"), y = Ft(n, "%webView_inventory_scope_currentBook%"), k = Ft(n, "%webView_inventory_scope_chapter%"), C = Ft(n, "%webView_inventory_scope_verse%"), _ = Ft(n, "%webView_inventory_filter_text%"), F = Ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Ft(n, "%webView_inventory_no_results%"), [S, P] = T(!1), [E, D] = T("all"), [A, V] = T(""), [O, I] = T([]), W = z(() => {
    const U = t ?? [];
    return U.length === 0 ? [] : gc(U, a, i);
  }, [t, a, i]), M = z(() => {
    if (S) return W;
    const U = [];
    return W.forEach((nt) => {
      const ut = nt.items[0], it = U.find(
        (xt) => xt.items[0] === ut
      );
      it ? (it.count += nt.count, it.occurrences = it.occurrences.concat(nt.occurrences)) : U.push({
        items: [ut],
        count: nt.count,
  ...
  }, [S, W]), Z = z(() => M.length === 0 ? [] : hc(M, E, A), [M, E, A]), _t = z(() => {
    var ut, it;
    if (!S) return c;
    const U = (ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut.length;
    if (!U) return c;
    const nt = [];
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ d($e, { onValueChange: (U) => Ot(U), defaultValue: s, children: [
...
const bc = "16rem", vc = "3rem", Sa = b.createContext(void 0);
function Pn() {
...
const xc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Pn();
  return /* @__PURE__ */ d(
    B,
    {
...
Cc.displayName = "SidebarSeparator";
...
const Ec = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? ze : "button",
  {
    ref: o,
...
Ec.displayName = "SidebarGroupAction";
...
const Rc = de(
  ...
  ({
    ...
    const c = t ? ze : "button", { state: w } = Pn(), p = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: m(Rc({ variant: n, size: o }), i),
        ...s
      }
    );
...
const Tc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? ze : "button",
  {
    ref: a,
...
Tc.displayName = "SidebarMenuAction";
...
Sc.displayName = "SidebarMenuBadge";
const Dc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Dc.displayName = "SidebarMenuSkeleton";
...
Mc.displayName = "SidebarMenuSub";
const Oc = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Oc.displayName = "SidebarMenuSubItem";
const Ic = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? ze : "a",
  {
    ref: i,
...
Ic.displayName = "SidebarMenuSubButton";
function Ac({
  id: t,
  extensionLabels: e,
  projectInfo: n,
...
const se = "scrBook", Pc = "scrRef", ge = "source", $c = "details", Lc = "Scripture Reference", Vc = "Scripture Book", La = "Type", jc = "Details";
function zc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: se,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Lc,
      cell: (o) => {
...
}, io = (t) => `${Bc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Tp({
  sources: t,
  ...
  const [w, p] = T([]), [u, h] = T([{ id: se, desc: !1 }]), [f, g] = T({}), x = z(
...
function Gc({
  ...
  }, [v, y] = T(!1), [k, C] = T(""), _ = X(void 0), F = X(!1);
  if (t.length !== dt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const L = z(() => dt.allBookIds.filter(
                  ...
                  Object.values(Y).map((I, W) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(wo, { children: [
                        ...
                        W < Object.values(Y).length - 1 && /* @__PURE__ */ r(Bo, {})
                      ] }, I);
                  })
                ] })
              ]
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Ce,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(St, { value: `${w}`, children: l[et(w)] }, `${w}`))
          }
        )
      ]
    }
...
function pr({
  ...
  return /* @__PURE__ */ d(Ee, { variant: i, children: [
    /* @__PURE__ */ r(Ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Ps, {}) }) }),
    /* @__PURE__ */ r(ue, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(wo, { children: [
      /* @__PURE__ */ r(Na, { children: /* @__PURE__ */ r(Ct, { children: za(e.groups, e.items, c, t) }) }),
      w < p.length - 1 && /* @__PURE__ */ r(Ue, {})
    ] }, c)) })
  ] });
}
const Ba = b.forwardRef(
...
Ga.displayName = kt.List.displayName;
...
)), Ua = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.Content,
  {
    ref: n,
    className: m(
...
Ua.displayName = kt.Content.displayName;
function Lp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Fa, { children: [
      /* @__PURE__ */ r(Ga, { children: t.map((l) => /* @__PURE__ */ r(Uc, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Ua, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Kc({ ...t }) {
...
const Hc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = Vt();
  return /* @__PURE__ */ d(
    at.CheckboxItem,
    {
...
Hc.displayName = at.CheckboxItem.displayName;
const Yc = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Vt();
  return /* @__PURE__ */ d(
    at.RadioItem,
    {
...
Yc.displayName = at.RadioItem.displayName;
const Xc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  at.Label,
  {
    ref: o,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Xc.displayName = at.Label.displayName;
  ...
  if (Ki(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), He(c, [h, f]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ r(Ka, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(Kc, { children: [
...
function Zc({ item: t, createLabel: e, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ r(Ge, { className: m(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(mo, {}) }) }),
...
const Qc = an(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vs, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
), ed = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const rd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
rd.displayName = "AlertDescription";
const Up = st.Root, Kp = st.Trigger, qp = st.Group, Hp = st.Portal, Yp = st.Sub, Xp = st.RadioGroup, od = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  st.SubTrigger,
  {
    ref: a,
    className: m(
...
od.displayName = st.SubTrigger.displayName;
...
ad.displayName = st.SubContent.displayName;
...
id.displayName = st.Item.displayName;
const ld = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  st.CheckboxItem,
  {
    ref: a,
    className: m(
...
ld.displayName = st.CheckboxItem.displayName;
const wd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  st.RadioItem,
  {
    ref: o,
    className: m(
...
wd.displayName = st.RadioItem.displayName;
const cd = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  st.Label,
  {
    ref: o,
    className: m(
...
cd.displayName = st.Label.displayName;
...
dd.displayName = st.Separator.displayName;
...
ud.displayName = "Drawer";
const Wp = Lt.Trigger, md = Lt.Portal, Jp = Lt.Close, ts = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
...
const fd = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
bd.displayName = Lt.Title.displayName;
...
vd.displayName = Lt.Description.displayName;
const xd = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  er.Root,
  {
    ref: o,
    className: m(
...
xd.displayName = er.Root.displayName;
function Zp({
  className: t,
  ...e
}) {
...
const yd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ d(
    Ye.Root,
    {
...
yd.displayName = Ye.Root.displayName;
...
Nd.displayName = nr.Root.displayName;
const nu = kt.Root, kd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ht();
  return /* @__PURE__ */ r(
    kt.List,
    {
...
kd.displayName = kt.List.displayName;
...
_d.displayName = kt.Trigger.displayName;
...
Cd.displayName = kt.Content.displayName;
...
export {
  ...
  Xp as ContextMenuRadioGroup,
  wd as ContextMenuRadioItem,
  dd as ContextMenuSeparator,
  pd as ContextMenuShortcut,
  Yp as ContextMenuSub,
  ad as ContextMenuSubContent,
  od as ContextMenuSubTrigger,
  ...
  Ac as SettingsSidebar,
  Rp as SettingsSidebarContentSearch,
  Ma as Sidebar,
