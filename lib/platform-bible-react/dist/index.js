...
var Ui = (t, e, r) => e in t ? Fi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Kt = (t, e, r) => Ui(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Ee, a as ea, C as _e, A as ce, P as De, b as Ye, B as q, d as Oe, e as Me, f as $e, h as ye, i as Ki, k as qi, j as Gi, E as Hi, l as qa, r as he, m as Yi, n as un, o as ra, p as aa, L as _t, R as Ga, q as Hr, D as Ta, s as Sa, t as za, u as Ra, T as pn, v as Lr, w as Rt, x as Ha, y as Dt, z as Ot, F as Mt, G as hn, H as Ya, I as qe, J as yr, K as Ae, M as Ie, N as Ve, S as kr, O as tr, Q as Wi, U as Cr, V as He, W as Se, Z as We, X as Te, Y as er, _ as Wa, $ as Xa, a0 as Yr, a1 as Ja, a2 as gn, a3 as Xi, a4 as Ji, a5 as Zi, a6 as Da, a7 as fn, a8 as oa, a9 as mn, aa as Qi, ab as ts, ac as es, ad as rs, ae as vn, af as as, ag as wa, ah as _o, ai as ua, aj as os, ak as ns, al as is, am as ss, an as cs, ao as Er, ap as Za, aq as ls, ar as ds } from "./resizable-BwezOpOQ.js";
import { as as hg, at as gg, au as fg, av as mg, aw as vg, ax as bg, ay as xg, az as yg, aA as kg, aB as _g, aC as Ng, aD as Cg, aE as Eg, aF as Tg, aG as Sg, aH as zg, aI as Rg, aJ as Dg, aK as Og, aL as Mg, aM as $g, aN as Ag, aO as Ig, aP as Vg, aQ as Pg } from "./resizable-BwezOpOQ.js";
import { jsx as a, jsxs as u, Fragment as st } from "react/jsx-runtime";
import { Canon as ft } from "@sillsdev/scripture";
import { Check as ze, Clock as No, ChevronsLeft as Co, ChevronsRight as Eo, ChevronLeft as Oa, ChevronRight as Ma, ArrowLeft as ws, ArrowRight as us, ChevronDown as or, BoldIcon as ps, ItalicIcon as hs, X as Qa, AtSign as bn, Pencil as gs, Trash2 as fs, ArrowUp as xn, MoreHorizontal as ms, MailOpen as vs, Mail as bs, ChevronUp as xs, FilterIcon as ys, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Ns, ArrowRightIcon as Cs, Copy as yn, Filter as Es, User as Ts, Link as Ss, CircleHelp as zs, Undo as Rs, Redo as Ds, SquareX as kn, FunctionSquare as _n, SquareSigma as Nn, Ban as Os, AlertCircle as $a, CircleCheckIcon as Ms, CircleXIcon as $s, CircleHelpIcon as As, ArrowUpIcon as Is, ArrowDownIcon as Vs, ScrollText as Ps, ChevronsUpDown as js, MenuIcon as Ls, Menu as Bs, EllipsisVertical as Fs, MoreVertical as Us } from "lucide-react";
import { Section as wt, getChaptersForBook as Ks, formatScrRef as be, getSectionForBook as vr, formatRelativeDate as qs, formatReplacementString as Ge, sanitizeHtml as to, NumberFormat as Cn, formatBytes as Gs, getCurrentLocale as Hs, usfmMarkers as Br, getFormatCallerFunction as Ys, deepEqual as Ws, isString as To, compareScrRefs as Aa, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as Xs, getLocalizeKeyForScrollGroupId as So, formatReplacementStringToArray as zo, collectUsjMarkers as Js } from "platform-bible-utils";
import Jt, { useRef as F, useMemo as D, useState as _, useCallback as L, useEffect as H, useImperativeHandle as Zs, useLayoutEffect as re, createContext as eo, useContext as En, Component as Qs, createElement as Ro, Suspense as tc, forwardRef as Tn, useId as Do, Fragment as na } from "react";
import { IconSelector as Sn, IconCheck as ia, IconChevronDown as ec, IconChevronUp as rc, IconLayoutSidebar as ac, IconLayoutSidebarRight as oc, IconChevronRight as zn, IconSearch as nc, IconLoader as ic, IconAlertOctagon as sc, IconAlertTriangle as cc, IconInfoCircle as lc, IconCircleCheck as dc } from "@tabler/icons-react";
import { createEditor as Rn, $getRoot as Re, $createParagraphNode as Tr, $getSelection as Zt, HISTORY_MERGE_TAG as ro, ParagraphNode as Dn, TextNode as On, $getPreviousSelection as wc, $isRangeSelection as ue, $caretFromPoint as uc, $getSiblingCaret as Mn, $getChildCaret as pc, $getAdjacentChildCaret as hc, $isChildCaret as gc, $normalizeCaret as fc, $setSelectionFromCaretRange as mc, $getCollapsedCaretRange as vc, $getCaretInDirection as Oo, $splitAtPointCaretNext as bc, $isTextPointCaret as xc, $findMatchingParent as $n, $isElementNode as _r, mergeRegister as ke, getDOMTextNode as yc, isHTMLElement as kc, CLEAR_EDITOR_COMMAND as An, COMMAND_PRIORITY_EDITOR as ao, shallowMergeConfig as _c, defineExtension as ie, safeCast as Xe, createState as Nc, FORMAT_TEXT_COMMAND as In, $isNodeSelection as Vn, COMMAND_PRIORITY_LOW as Pn, RootNode as Cc, LineBreakNode as Ec, TabNode as Tc, $isEditorState as Sc, createCommand as zc, CLICK_COMMAND as Rc, isDOMNode as Dc, $getNodeFromDOMNode as Oc, $createNodeSelection as Mc, $setSelection as $c, $getEditor as Ac, DecoratorNode as Ia, $getState as Ic, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as Vc, $setState as Pc, addClassNamesToElement as jn, $create as jc, $getNodeByKey as Lc, removeClassNamesFromElement as Bc, KEY_TAB_COMMAND as Fc, $isBlockElementNode as Uc, $createRangeSelection as Kc, $normalizeSelection__EXPERIMENTAL as qc, OUTDENT_CONTENT_COMMAND as Gc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as Hc, COMMAND_PRIORITY_CRITICAL as oo, $isDecoratorNode as Yc, $isParagraphNode as Wc, $isTextNode as Va, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as Xc } from "lexical";
import { HeadingNode as Jc, QuoteNode as Zc, registerRichText as Qc } from "@lexical/rich-text";
...
import { $generateHtmlFromNodes as al, $generateNodesFromDOM as ol } from "@lexical/html";
import { Avatar as no, Select as Gt, Checkbox as Ao, Slot as Sr, Tabs as le, Menubar as ge, ContextMenu as $t, Progress as Io, Slider as $r, Switch as Vo } from "radix-ui";
import { useReactTable as Fn, getFilteredRowModel as nl, getSortedRowModel as Un, getPaginationRowModel as il, getCoreRowModel as Kn, flexRender as br, getGroupedRowModel as sl, getExpandedRowModel as cl } from "@tanstack/react-table";
import ll from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as ja, getDefaultViewOptions as dl, isInsertEmbedOpOfType as Ar, Editorial as wl } from "@eten-tech-foundation/platform-editor";
...
function Hn({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function fa({
  ...
  const B = he(), [S, A] = _(!1), [I, C] = _(""), [V, K] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
  ), [W, Z] = _(void 0), [At, Vt] = _(!1), It = F(null), G = F(!1), et = F(void 0), ct = F(void 0), lt = F(void 0), gt = F(void 0), Pt = F({}), ut = F({}), bt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Ht = D(() => o ? o() : Yi, [o]), St = D(() => ({
    [wt.OT]: Ht.filter((U) => ft.isBookOT(U)),
    [wt.NT]: Ht.filter((U) => ft.isBookNT(U)),
    [wt.DC]: Ht.filter((U) => ft.isBookDC(U)),
    [wt.Extra]: Ht.filter((U) => ft.extraBooks().includes(U))
  }), [Ht]), Qt = D(() => Object.values(St).flat(), [St]), me = D(() => {
    if (!V.trim()) return St;
    const x = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((tt) => {
      x[tt] = St[tt].filter((Et) => qa(Et, V, n));
    }), x;
  }, [St, V, n]), R = D(
    () => xl(V, Qt, n),
    [V, Qt, n]
  ...
  const Nt = L(() => {
    ...
    (x) => {
      const U = T ?? (R == null ? void 0 : R.book), tt = W ?? (R == null ? void 0 : R.chapterNum);
      !U || !tt || (bt({
        book: U,
        chapterNum: tt,
        verseNum: x
    ...
    A(x), x && (J("books"), Y(void 0), $(void 0), Z(void 0), K(""));
  }, []);
  H(() => {
    O && ot(!1);
  }, [O, ot]);
  ...
  const { otLong: pt, ntLong: vt, dcLong: Lt, extraLong: Yt } = {
    ...
    () => vl(V),
    [V]
  ), Wt = D(() => !d || !R || !R.chapterNum || !kt ? !1 : d(R.book, R.chapterNum) > 0, [d, R, kt]), Le = L(
    (x) => w ? Po(x, w) : !1,
    [w]
  ), Ne = L(
    (x) => (U) => w ? bl(x, U, w) : !1,
    ...
    (x) => {
      var oe, Je, hr;
      if (x.ctrlKey) return;
      const { isLetter: U, isDigit: tt } = jo(x.key);
      if ((k === "chapters" || k === "verses") && (x.key === " " || x.key === "Enter")) {
        const Ut = x.target instanceof HTMLElement ? x.target : void 0;
        if (!!(Ut != null && Ut.closest(
          'button, a, input, select, textarea, [role="button"]'
        ))) {
          x.stopPropagation();
          return;
        }
        const zt = (oe = et.current) == null ? void 0 : oe.querySelector(
      ...
      if (k === "verses" && Et) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            ht !== 0 && (te = ht > 1 ? ht - 1 : zt);
            break;
          case "ArrowRight":
            ht !== 0 && (te = ht < zt ? ht + 1 : 1);
            break;
          case "ArrowUp":
            te = ht === 0 ? zt : Math.max(1, ht - ee);
            break;
          case "ArrowDown":
            te = ht === 0 ? 1 : Math.min(zt, ht + ee);
            break;
          default:
            return;
        }
        te !== ht && (x.preventDefault(), x.stopPropagation(), C(
          `${Ut} ${ce[Ut] || ""} ${xt}:${te}`
        ), setTimeout(() => {
          const Fe = ut.current[te];
          Fe && Fe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((k === "chapters" || k === "books" && R) && Et) {
        const Ut = k === "chapters" ? j : R == null ? void 0 : R.book;
        if (!Ut) return;
        k === "chapters" && ((hr = et.current) == null || hr.focus());
        const xt = (() => {
          if (!I) return 1;
          const ee = I.match(/(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            xt !== 0 && (ht = xt > 1 ? xt - 1 : zt);
            break;
          case "ArrowRight":
            xt !== 0 && (ht = xt < zt ? xt + 1 : 1);
            break;
          case "ArrowUp":
            ht = xt === 0 ? zt : Math.max(1, xt - te);
            break;
          case "ArrowDown":
            ht = xt === 0 ? 1 : Math.min(zt, xt + te);
            break;
          default:
            return;
        }
        ht !== xt && (x.preventDefault(), x.stopPropagation(), C(
          `${Ut} ${ce[Ut] || ""} ${ht}`
        ), setTimeout(() => {
          const ee = Pt.current[ht];
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Et = ct.current) == null || Et.focus();
      return;
    }
    const { isLetter: U, isDigit: tt } = jo(x.key);
    (U || tt) && (x.preventDefault(), K((oe) => oe + x.key), ct.current.focus(), Vt(!1));
  }, []);
  return re(() => {
    const x = setTimeout(() => {
      if (S && k === "books" && lt.current && gt.current) {
        const U = lt.current, tt = gt.current, Et = tt.offsetTop, oe = U.clientHeight, Je = tt.clientHeight, hr = Et - oe / 2 + Je / 2;
        U.scrollTo({
          top: Math.max(0, hr),
          behavior: "smooth"
        }), C(Gn(t.book));
  ...
  }, [k, j, R, t.book, t.chapterNum]), re(() => {
    if (k === "verses" && T && W !== void 0) {
      const x = T === t.book && W === t.chapterNum, U = x ? t.verseNum : 1;
      C(
        `${T} ${ce[T] || ""} ${W}:${U}`
      ), setTimeout(() => {
        if (lt.current)
          if (x) {
            const tt = ut.current[t.verseNum];
            tt && tt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            lt.current.scrollTo({ top: 0 });
        et.current && et.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(De, { open: S, onOpenChange: ot, modal: E, children: [
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: U } = x;
          S && It.current && U instanceof Node && It.current.contains(U) && (G.current = !0, ot(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Me,
            ...
            children: [
              k === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Q.map(
                  ({ onClick: x, disabled: U, title: tt, icon: Et }) => /* @__PURE__ */ a(
                    q,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    ...
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(ws, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(us, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                ...
                /* @__PURE__ */ a(
                  "span",
                  {
                    ...
                    children: k === "verses" ? ur : Be
                  }
                )
              ] }),
              !At && /* @__PURE__ */ u($e, { ref: lt, children: [
                k === "books" && /* @__PURE__ */ u(st, { children: [
                  !R && Object.entries(me).map(([x, U]) => {
                    if (U.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ye, { heading: Bt(x), children: U.map((tt) => /* @__PURE__ */ a(
                          qn,
                          {
                            bookId: tt,
                            onSelect: (Et) => ve(Et),
                  ...
                  R && /* @__PURE__ */ a(ye, { children: /* @__PURE__ */ a(
                    _e,
                    {
                      ...
                      children: be(
                        ...
                        n ? ea(R.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  R && Wt && R.chapterNum && d && /* @__PURE__ */ u(st, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Bo,
                      {
                        ...
                        onVerseSelect: jt,
                        setVerseRef: Ct,
                        isVerseDisabled: wr(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !Wt && rr(R.book) > 1 && /* @__PURE__ */ u(st, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function Fo({
  ...
  const [N, O] = _(!1), B = d ?? l, S = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], A = (I, C) => {
    const V = l(I), K = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, k = `${C ?? ""}${V}${K ?? ""}`;
    return /* @__PURE__ */ u(
      _e,
      {
        value: V,
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        children: /* @__PURE__ */ u(Me, { children: [
          ...
          /* @__PURE__ */ a($e, { children: S(e) ? e.map((I) => /* @__PURE__ */ a(ye, { heading: I.groupHeading, children: I.options.map((C) => A(C, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(ye, { children: e.map((I) => A(I)) }) })
        ] })
      }
    )
  ] });
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = Wn ? re : H, Vr = { tag: ro };
function Cl({ initialConfig: t, children: e }) {
  const r = D(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = _l(null, o), w = Rn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : H;
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : H;
function Ml(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function $l() {
  return function(t) {
    const [e] = fe(), r = D(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = F(o);
    return Ol(() => {
...
const Xn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Il = Xn && "documentMode" in document ? document.documentMode : null;
!(!Xn || !("InputEvent" in window) || Il) && "getTargetRanges" in new window.InputEvent("input");
function we(t) {
  return `${t}px`;
}
...
function Ll(t, e = jl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), v = h.offset, E = g.getNode(), y = E.getKey(), N = g.offset, O = t.getElementByKey(b), B = t.getElementByKey(y), S = r === null || O !== o || v !== n || b !== r.getKey(), A = i === null || B !== s || N !== c || y !== i.getKey();
      if ((S || A) && O !== null && B !== null) {
        const I = function(C, V, K, k, J, j, Y) {
          const T = (C._window ? C._window.document : document).createRange();
          return T.setStart(...Uo(V, K, k)), T.setEnd(...Uo(J, j, Y)), T;
        }(t, h, f, O, g, E, B);
        l(), l = Pl(t, I, e);
      }
...
function Fl(t) {
  const e = $n(t, (r) => _r(r) && !r.isInline());
  return _r(e) || Wr(4, t.__key), e;
}
function Ul(t) {
  const e = Zt() || wc();
  let r;
  if (ue(e)) r = uc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Mn(c, "next"));
    }
    r = r || pc(Re(), "previous").getFlipped().insert(Tr());
  }
  const o = Kl(t, r), n = hc(o), i = gc(n) ? fc(n) : o;
  return mc(vc(i)), t.getLatest();
}
function Kl(t, e, r) {
  let o = Oo(e, "next");
  for (let n = o; n; n = bc(n, r)) o = n;
  return xc(o) && Wr(283), o.insert(t.isInline() ? Tr().append(t) : t), Oo(Mn(t.getLatest(), "next"), e.direction);
}
function ql(t) {
  const e = Zt();
  if (!ue(e)) return !1;
...
let Xr, xe = 0, Jr = 0, Yl = 0, Ba = 0, Ur = 0;
function qo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ue(t, e) {
  qt.call(this, void 0), this.x = t, this.s = void 0, this.g = Ur - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Wl(t, e) {
  return new Ue(t, e);
}
...
function Xl(t) {
  ...
  Zn(this), nt = t, this.f &= -2, 8 & this.f && co(this), ca();
}
function Qe(t, e) {
...
qt.prototype.brand = Gl, qt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      xe !== 0 && Jr === 0 && e.l !== Ba && (e.l = Ba, Xr = { S: e, v: e.v, i: e.i, o: Xr });
    })(this), this.v = t, this.i++, Ur++, xe++;
    try {
...
} }), Ue.prototype = new qt(), Ue.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Ur)) return !0;
  if (this.g = Ur, this.f |= 1, this.i > 0 && !Jn(this)) return this.f &= -2, !0;
  const t = nt;
  try {
    Go(this), nt = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Qn(this), Go(this), xe++;
  const t = nt;
  return nt = this, Xl.bind(this, t);
...
ie({ build: (t, e, r) => dr(e), config: Xe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ti() {
  const t = Re(), e = Zt(), r = Tr();
  t.clear(), t.append(r), e !== null && r.select(), ue(e) && (e.format = 0);
}
function ei(t, e = ti) {
  return t.registerCommand(An, (r) => (t.update(e), !0), ao);
}
ie({ build: (t, e, r) => dr(e), config: Xe({ $onClear: ti }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
class ri extends Ia {
  $config() {
    return this.config("decorator-text", { extends: Ia, stateConfigs: [{ flat: !0, stateConfig: ba }] });
  }
  getFormat() {
    return Ic(this, ba);
  }
...
ie({ name: "@lexical/extension/DecoratorText", nodes: () => [ri], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = Zt();
  if (Vn(n) || ue(n)) for (const i of n.getNodes()) Zl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ai(t, e) {
  let r;
...
const Fa = ie({ build: (t) => ai(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const lo = 0, Ua = 1, ni = 2, xa = 3, Pr = 4, Ze = 5, ya = 6, fr = 7;
function ka(t) {
  return t.id === lo;
}
function ii(t) {
...
function Ql(t) {
  return function(e) {
    return e.id === Ua;
  }(t) || dt(305, String(t.id), String(Ua)), Object.assign(t, { id: ni });
}
...
class ed {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : _c;
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && dt(307, String(r.id), String(Ze)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== ya && dt(310, String(r.id), String(ya)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= xa;
    }(e) || dt(314, String(e.id), String(xa)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
const ad = ie({ config: Xe({ setOptions: Ho, updateOptions: Ho }), init: ({ $initialEditorState: t = rd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Cc, On, Ec, Tc, Dn] }), Yo = Symbol.for("@lexical/extension/LexicalBuilder");
function Wo() {
}
function od(t) {
  throw t;
...
class ar {
  ...
  static maybeFromEditor(e) {
    const r = e[Yo];
    return r && (r.PACKAGE_VERSION !== _a && dt(292, r.PACKAGE_VERSION, _a), r instanceof ar || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ka(i) || dt(300, s, n || "[unknown]"), ka(c = i) || dt(304, String(c.id), String(lo)), i = Object.assign(c, { id: Ua }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Jl(p)) {
...
const nd = /* @__PURE__ */ new Set(), Xo = ie({ build(t, e, r) {
  const o = r.getDependency(Fa).output, n = Nr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ai(() => {
  }, () => pe(() => {
...
}, dependencies: [Fa], name: "@lexical/extension/NodeSelection" }), id = zc("INSERT_HORIZONTAL_RULE_COMMAND");
class nr extends Ia {
  static getType() {
...
ie({ dependencies: [Fa, Xo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Xo).output, n = Nr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return ke(t.registerCommand(id, (s) => {
    const c = Zt();
    if (!ue(c)) return !1;
    ...
    return !0;
  }, ao), t.registerCommand(Rc, (s) => {
    if (Dc(s.target)) {
      const c = Oc(s.target);
      if (cd(c)) return function(l, d = !1) {
        const w = Zt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Vn(w) ? g = w : (g = Mc(), $c(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Pn), t.registerMutationListener(nr, (s, c) => {
    Hl(() => {
      let l = !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(pe(() => {
      const d = c.value;
      d && (l.value ? jn(d, i) : Bc(d, i));
    }));
    return ke(...s);
  }));
} });
ie({ build: (t, e) => dr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Xe({ $getParentEditor: function() {
  const t = Ac();
...
ie({ build: (t, e, r) => dr(e), config: Xe({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return pe(() => {
...
function ld(t, e, r = si) {
  return ke(t.registerCommand(Fc, (o) => {
    const n = Zt();
    if (!ue(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Uc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Fl(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Kc();
      ...
      return !1;
    }(n) ? o.shiftKey ? Gc : $o : Hc;
    return t.dispatchCommand(i, void 0);
  }, ao), t.registerCommand($o, () => {
...
ie({ build: (t, e, r) => dr(e), config: Xe({ $canIndent: si, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return pe(() => {
    if (!o.value) return ld(t, n, i);
  });
} });
const dd = ie({ name: "@lexical/react/ReactProvider" });
function wd() {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                ...
                if (Va(v) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(v, E, v, y)), E === y && p === "" || (f.insertRawText(p), v = b.getNode()), Va(v)) {
                  E = h, y = h + g;
...
ie({ build: (t, e, r) => dr(e), config: Xe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => pe(() => r.getOutput().disabled.value ? void 0 : li(t)) });
function hd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : H;
...
function md({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    uo(() => ke(Qc(n), li(n)), [n]);
  }(o), u(st, { children: [t, a(vd, { content: e }), a(fd, { editor: o, ErrorBoundary: r })] });
}
...
const xd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : H;
function yd({ onClear: t }) {
  const [e] = fe();
  return xd(() => ei(e, t), [e, t]), null;
}
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? re : H;
function kd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: v = "textbox", spellCheck: E = !0, style: y, tabIndex: N, "data-testid": O, ...B }, S) {
...
function Cd(t, e) {
  ...
  return u(st, { children: [a(_d, { editor: n, ...o, ref: e }), r != null && a(Ed, { editor: n, content: r })] });
}
function Ed({ content: t, editor: e }) {
  ...
  if (re(() => (n(e.isEditable()), e.registerEditableListener((s) => {
    n(s);
  })), [e]), !r) return null;
  let i = null;
...
function zd() {
  const [t, e] = _(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Ta, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Sa, { children: [
      /* @__PURE__ */ a(za, { children: /* @__PURE__ */ a(Ra, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function Rd({
  ...
  const [e] = fe(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = zd(), l = () => {
  };
...
function Od() {
  const { activeEditor: t } = ui(), [e, r] = _([]), o = L((n) => {
    if (ue(n) || rl(n)) {
      const i = [];
      Qo.forEach(({ format: s }) => {
...
function $d({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Rd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Od, {}) }) }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ a(
          Cl,
          {
            ...
            children: /* @__PURE__ */ u(Rt, { children: [
              /* @__PURE__ */ a($d, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Tl,
                {
...
function Id(t) {
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = ol(e, n);
      Re().clear(), Xc(i);
    },
    {
      discrete: !0
...
function fi({
  ...
  return /* @__PURE__ */ u(Ha, { children: [
    /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: s }) })
    ] }) }),
    /* @__PURE__ */ a(hn, {}),
    /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
...
const Vd = "verseText", sp = Object.freeze([
...
function cp({
  ...
  const [i, s] = _(Pd), [c, l] = _(n), [d, w] = _(!1), p = F(void 0), h = F(null);
  H(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(De, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Oe,
        {
          ...
          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: t.map((v) => /* @__PURE__ */ a(
            _e,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
...
function en({
  ...
  const g = L(
    ...
    const S = new Date(t.date), A = qs(
      S,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), I = S.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    [t.user]
  ), y = D(() => to(t.contents), [t.contents]), N = D(
    ...
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (S) => {
              S.stopPropagation(), d(!0), p(Id(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Fd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Ud, { className: "tw:text-xs tw:font-medium", children: E }) }),
        ...
        B && /* @__PURE__ */ u(Ae, { children: [
          /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ms, {}) }) }),
...
function yi({
  ...
  const [k, J] = _(rn), [j, Y] = _(), [T, $] = _(), W = o, [Z, At] = _(!1), [Vt, It] = _(!1), [G, et] = _(!1), [ct, lt] = _(!1), [gt, Pt] = _(!1), [ut, bt] = _(O), [Ht, St] = _(!1), Qt = F(void 0), [me, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let z = !0;
    return (async () => {
  ...
  H(() => {
    ...
    yt.current === "idle" && (yt.current = "pending"), ct ? yt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
  ...
  const jt = D(() => Nt[0], [Nt]), ve = F(null), ae = F(void 0), P = L(() => {
    var z;
    (z = ae.current) == null || z.call(ae), J(rn);
  }, []), Q = L(() => {
    const z = !ut;
    bt(z), St(!z), f == null || f(l, z);
  }, [ut, f, l]);
  H(() => {
    At(!1);
  }, [o]), H(() => {
    if (o && !ut && !Ht) {
      ...
      return Qt.current = z, () => clearTimeout(z);
    }
  ...
  }, [i, r]), ot = D(() => Nt.slice(1), [Nt]), it = D(() => ot.length ?? 0, [ot.length]), mt = D(() => it > 0, [it]), pt = D(() => Z || it <= 2 ? ot : ot.slice(-2), [ot, it, Z]), vt = D(() => Z || it <= 2 ? 0 : it - 2, [it, Z]), Lt = D(
    () => it === 1 ? at.singleReply : Ge(at.multipleReplies, { count: it }),
    [it, at]
  ), Yt = D(
    () => vt === 1 ? at.singleReply : Ge(at.multipleReplies, { count: vt }),
    [vt, at]
  );
  H(() => {
    !o && Vt && mt && It(!1);
  ...
  const Bt = L(
    async (z) => {
      ...
      Ct && await p({ threadId: l, contents: Ct }) && P();
    },
    [
      P,
      k,
    ...
    async (z) => {
      const Ct = ne(k) ? Qr(k) : void 0, kt = z.status ? z.assignedUser : j ?? z.assignedUser, Wt = await p({
        ...z,
        contents: Ct,
        assignedUser: kt
      });
      return Wt && (kt !== void 0 && $(kt), Ct && P()), Wt;
    },
    [P, k, p, j]
  );
  ...
  const je = /* @__PURE__ */ a(
    en,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: It,
      canEditOrDelete: (!Vt && me.get(jt.id)) ?? !1,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              q,
              {
                ...
                children: ut ? /* @__PURE__ */ a(vs, {}) : /* @__PURE__ */ a(bs, {})
              }
            ),
            V === void 0 ? (
          ...
          o && /* @__PURE__ */ u(st, { children: [
            ...
            vt > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (z) => {
                  z.stopPropagation(), At(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (z) => {
                  (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), At(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(kr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: Yt }),
                    Z ? /* @__PURE__ */ a(xs, {}) : /* @__PURE__ */ a(or, {})
                  ] })
                ]
              }
            ),
            pt.map((z) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              en,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: It,
                canEditOrDelete: (!Vt && me.get(z.id)) ?? !1
              }
            ) }, z.id)),
            v !== !1 && (!Vt || ne(k)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (z) => {
                  ho(z) && (z.preventDefault(), z.stopPropagation(), (ne(k) || j !== void 0 && j !== T) && Bt());
                },
                onKeyDown: (z) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ne(k) || j !== T) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
                    ...
                    /* @__PURE__ */ u(De, { open: G, onOpenChange: et, children: [
                      /* @__PURE__ */ a(Ye, { asChild: !0, children: /* @__PURE__ */ a(
                        q,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Oe,
                        {
                          ...
                          align: "end",
                          onKeyDown: (z) => {
                            z.key === "Escape" && (z.stopPropagation(), et(!1));
                          },
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((z) => /* @__PURE__ */ a(
                            _e,
                            {
                              onSelect: () => {
                                Y(z !== i ? z : void 0), yt.current = "user-selected", $(void 0), et(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Kr(z, r) })
                            },
                            z || "unassigned"
                          )) }) })
                        }
...
), qd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => qd(to(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Gd({
  ...
  const [s, c] = _("accept"), l = Do(), d = Do(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = D(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = D(
    () => qr(t.acceptedText ?? ""),
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), k = (T) => T ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: T }) : K, J = () => {
    const T = o ?? "accept";
    return T === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: E }) : K : k(T === "reject" ? t.rejectedResultText : t.resultText);
      ...
      !w && !h && /* @__PURE__ */ u(st, { children: [
        ...
        /* @__PURE__ */ a(
          Ga,
          {
            ...
            children: S.map((T) => j(T) ? /* @__PURE__ */ a(Rt, { delayDuration: 0, children: /* @__PURE__ */ u(Dt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: Y(T) }),
              /* @__PURE__ */ a(Mt, { children: O })
            ] }) }, T.value) : Y(T))
          }
        ),
        /* @__PURE__ */ a(Rt, { delayDuration: 0, children: /* @__PURE__ */ u(Dt, { children: [
...
function Jd(t) {
  const {
    ...
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Xd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function mp({
  ...
  const [y, N] = _(/* @__PURE__ */ new Set()), [O, B] = _(), [S, A] = _(), I = L(
    async ($) => {
      const W = await i($);
  ...
  const C = r.filter(
    ...
    ($) => {
      ...
      N((Z) => {
        const At = new Set(Z);
        return At.has($) ? At.delete($) : At.add($), At;
      }), B($), b == null || b(W ? void 0 : $);
    },
    [y, b]
  ), { listboxRef: J, activeId: j, handleKeyDown: Y } = Wi({
    options: V,
    onOptionSelect: K
  }), T = L(
    ($) => {
      ...
      children: C.map(($) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: $.type === "Conflict" ? /* @__PURE__ */ a(Jd, { ...W, conflictResolution: E }) : /* @__PURE__ */ a(yi, { ...W })
          },
          $.id
        );
      })
...
function Zd({ table: t }) {
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(ys, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function cr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Gt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Gt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Sn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function se({
  ...
  return /* @__PURE__ */ u(
    Gt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Gt.ItemIndicator, { children: /* @__PURE__ */ a(ia, { className: "tw:pointer-events-none" }) }) }),
...
function aw({
  ...
  var S;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, E] = _({}), y = D(() => e ?? [], [e]), N = Fn({
    data: y,
    columns: t,
    getCoreRowModel: Kn(),
    ...r && { getPaginationRowModel: il() },
    onSortingChange: p,
  ...
  let B;
  return l ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: O.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((S = N.getRowModel().rows) == null ? void 0 : S.length) > 0 ? B = N.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    Te,
    {
      onClick: () => s(A, N),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((I) => /* @__PURE__ */ a(er, { children: br(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    A.id
  )) : B = /* @__PURE__ */ a(Te, { children: /* @__PURE__ */ a(er, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Zd, { table: N }),
    /* @__PURE__ */ u(Wa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Xa, { stickyHeader: i, children: N.getHeaderGroups().map((A) => /* @__PURE__ */ a(Te, { children: A.headers.map((I) => /* @__PURE__ */ a(Yr, { className: "tw:p-0", children: I.isPlaceholder ? void 0 : br(I.column.columnDef.header, I.getContext()) }, I.id)) }, A.id)) }),
      /* @__PURE__ */ a(Ja, { children: B })
    ] }),
...
function xp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(ll, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(q, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(yn, {}) })
        ] }),
...
var iw = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(iw || {});
function _p({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "default", children: [
      /* @__PURE__ */ a(Es, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(Ve, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(gn, { children: d.itemType === 0 ? /* @__PURE__ */ a(st, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Se,
        {
          checked: o[w][h],
        ...
        Xi,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ji, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(He, {})
    ] }, d.label)) })
...
function lw({
  ...
  const l = Ya(), d = on(n, "%undoButton_tooltip%"), w = on(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ha, { children: [
    /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        q,
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(st, { children: [
          " ",
          /* @__PURE__ */ a(Da, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    e && (c === "secondary" || c === "default") && /* @__PURE__ */ a(hn, {}),
    e && /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        q,
        {
          "aria-label": w,
      ...
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(st, { children: [
          " ",
          /* @__PURE__ */ a(Da, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
const ww = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(st, { children: [
...
function uw({
  ...
  const f = (v) => {
    ...
    var E, y, N, O;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((N = i.current) == null ? void 0 : N.selectionStart) === 0 && ((O = s.current) == null || O.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Ae, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: ww(t, n, r) }) }) }),
      /* @__PURE__ */ a(Mt, { children: n["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ u(
      Ve,
      {
...
const pw = (t, e) => t === "f" ? /* @__PURE__ */ u(st, { children: [
  /* @__PURE__ */ a(_n, {}),
  " ",
...
function gw({
  ...
  return /* @__PURE__ */ u(Ae, { children: [
    /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: pw(t, r) }) }) }),
      /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: hw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ve, { style: { zIndex: fn }, children: [
...
function Tp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [O, B] = _("*"), [S, A] = _("f"), [I, C] = _(!1), [V, K] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [At, Vt] = _(), [It, G] = _(), [et, ct] = _(), lt = F(null), gt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? dl(), noteMode: "expanded" }
    }),
    [s, c]
  ), Pt = D(
    () => xw(
  ...
  H(() => {
    ...
    if (Q && Ar("note", Q)) {
      ...
      let it = "custom";
      ot === Pa ? it = "generated" : ot === ja ? it = "hidden" : ot && (N(ot), B(ot)), b(it), E(it), A(((rt = Q.insert.note) == null ? void 0 : rt.style) ?? "f"), P = setTimeout(() => {
        var mt;
        (mt = w.current) == null || mt.applyUpdate([Q]);
      }, 0);
    }
    return () => {
      P && clearTimeout(P);
  ...
  const ut = L(
    (P, Q, at = !1) => {
      ...
      if (rt && Ar("note", rt)) {
        if (rt.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = Pa : pt = ja, rt.insert.note.caller = pt;
        }
        r == null || r([rt]), at && d && i && ((mt = d.current) == null || mt.replaceEmbedUpdate(i, [rt]));
      }
    },
    [i, r, d]
  ), bt = L(() => {
  ...
  const St = F({ book: n.book, chapterNum: n.chapterNum });
  re(() => {
    (St.current.book !== n.book || St.current.chapterNum !== n.chapterNum) && (St.current = { book: n.book, chapterNum: n.chapterNum }, Ht.current());
  }, [n.book, n.chapterNum]);
  const Qt = () => {
    var Q;
    ...
    if (Q && Ar("note", Q)) {
      ...
      const pt = (it = (ot = Q.insert.note) == null ? void 0 : ot.contents) == null ? void 0 : it.ops;
      S !== "x" && P === "x" ? pt == null || pt.forEach((vt) => yw(vt)) : S === "x" && P !== "x" && (pt == null || pt.forEach((vt) => kw(vt))), (mt = w.current) == null || mt.applyUpdate([Q, { delete: 1 }]);
    }
  }, Nt = (P) => {
    ...
    (P) => {
      ...
      if (Q && Ar("note", Q)) {
        ...
        const pt = (ot = Q.insert.note) == null ? void 0 : ot.style, vt = (mt = (it = Q.insert.note) == null ? void 0 : it.contents) == null ? void 0 : mt.ops;
        if (pt || C(!1), C(
          pt === "x" ? !!(vt != null && vt.every((Lt) => {
            var Bt, Ft;
            if (!((Bt = Lt.attributes) != null && Bt.char)) return !0;
            const Yt = ((Ft = Lt.attributes) == null ? void 0 : Ft.char).style;
        ...
        K(JSON.stringify(Q) === Y.current), ut(f, y);
      } else
        C(!1), K(!0);
    },
    [f, y, ut]
    ...
    if (h.current && Pt.length && P && P.rangeCount > 0) {
  ...
  H(() => {
    ...
    var P;
    T && ((P = lt.current) == null || P.focus());
  }, [T]), H(() => {
    var at;
    const P = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, Q = (rt) => {
      !T && P && document.activeElement === P && rt.key === c ? (rt.preventDefault(), ve()) : T && rt.key === "Escape" && (rt.preventDefault(), $(!1));
    };
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
                q,
                {
                  "aria-label": ae,
              ...
              /* @__PURE__ */ a(Mt, { children: /* @__PURE__ */ a("p", { children: ae }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: Nw(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function Sw({
  ...
  return /* @__PURE__ */ u(Wa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Xa, { stickyHeader: !0, children: /* @__PURE__ */ u(Te, { children: [
    ...
    /* @__PURE__ */ a(Ja, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Te,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(er, { className: o, children: Tw(c.text) })
        ]
      },
...
const zw = (t) => {
...
}, la = (t, e, r) => /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
  ...
  return e ? e[1] : "";
}, Dw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ip = Object.freeze([
  ...
  const n = To(o.key) ? o.key : o.key[0];
  return {
...
function Vp({
  ...
  const g = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), b = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), y = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), O = de(r, "%webView_inventory_filter_text%"), B = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), S = de(r, "%webView_inventory_no_results%"), [A, I] = _(!1), [C, V] = _("all"), [K, k] = _(""), [J, j] = _([]), Y = D(() => {
    const G = t ?? [];
    ...
    const G = [];
    return Y.forEach((et) => {
      const ct = et.items[0], lt = G.find(
        (gt) => gt.items[0] === ct
      );
      lt ? (lt.count += et.count, lt.occurrences = lt.occurrences.concat(et.occurrences)) : G.push({
        items: [ct],
        count: et.count,
  ...
  }, [A, Y]), $ = D(() => T.length === 0 ? [] : Ow(T, C, K), [T, C, K]), W = D(() => {
    var ct, lt;
    if (!A) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ir, { onValueChange: (G) => At(G), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(lr, { children: [
          ...
          /* @__PURE__ */ a(se, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        oa,
      ...
      o && /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
        ...
        /* @__PURE__ */ a(Mt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const $w = "16rem", Aw = "3rem", Ni = Jt.createContext(void 0);
function da() {
...
function Iw({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    ...
    [r, w]
  ), h = Jt.useCallback(() => p((N) => !N), [p]), g = w ? "expanded" : "collapsed", v = he() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Pp({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    q,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(ac, {}) : /* @__PURE__ */ a(oc, {}),
...
function Uw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = da(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    Vw,
    {
      ...
      children: /* @__PURE__ */ u(jw, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Lw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Bw, { children: /* @__PURE__ */ a(
            Uw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ce = "scrBook", qw = "scrRef", Ke = "source", Gw = "details", Hw = "Scripture Reference", Yw = "Scripture Book", Ci = "Type", Ww = "Details";
function Xw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? ft.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ce ? be(n.start) : void 0;
      },
...
}, dn = (t) => `${Jw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Zp({
  sources: t,
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const K = b.find((k) => dn(k) === V[0]) || void 0;
        K && c(K);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Yw, N = i ?? Ci, O = [
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Qd, { children: O.map((C) => /* @__PURE__ */ a(se, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Wa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Xa, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Te, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Yr, { colSpan: V.colSpan, className: "tw:sticky top-0", children: V.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Ja, { children: E.getRowModel().rows.map((C, V) => {
        const K = he();
        return /* @__PURE__ */ a(
          Te,
          {
            ...
            children: C.getVisibleCells().map((k) => {
              if (!(k.getIsPlaceholder() || k.column.columnDef.enableGrouping && !k.getIsGrouped() && (k.column.columnDef.id !== Ke || !r)))
                return /* @__PURE__ */ a(
                  er,
                  {
                    className: m(
                    ...
                    children: k.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        type: "button",
                        children: [
                          C.getIsExpanded() && /* @__PURE__ */ a(or, {}),
                          !C.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a(Ma, {}) : /* @__PURE__ */ a(Oa, {})),
                          " ",
...
const Zw = 5;
function fo(t) {
  return t.length !== ft.allBookIds.length ? [] : ft.allBookIds.filter(
...
const Ei = (t, e, r) => mo(t, e).every((o) => r.includes(o));
function Ti(t, e) {
  return [...t].sort((r, o) => ft.bookIdToNumber(r) - ft.bookIdToNumber(o)).map((r) => ea(r, e));
}
function Qw(t, e, r, o) {
  if (t.length === 0) return;
  if (e.length > 0 && e.every((i) => t.includes(i)))
    return r;
  const n = Ti(t, o);
  return n.length <= Zw ? n.join(", ") : `${n[0]} … ${n[n.length - 1]}`;
}
function tu(t, e) {
  if (t.length !== 0)
    return Ti(t, e).join(", ");
...
function eu({
  ...
  }, [b, v] = _(!1), [E, y] = _(""), N = F(void 0), O = F(!1), B = D(
    () => fo(t),
    [t]
  ), S = D(() => {
    if (!E.trim()) {
              ...
              Me,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: K, children: d })
                  ] }),
                  /* @__PURE__ */ u($e, { className: "tw:max-h-none tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(aa, { children: w }),
                    Object.values(wt).map((k, J) => {
                      const j = S[k];
                      if (j.length !== 0)
...
function ru({
  ...
  const i = mo(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    q,
    {
      variant: "outline",
...
function th({
  ...
  const O = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), B = Tt(s, "%webView_scope_selector_verse%"), S = Tt(s, "%webView_scope_selector_chapter%"), A = Tt(s, "%webView_scope_selector_book%"), I = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), C = Tt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = Tt(s, "%webView_scope_selector_current_book%"), K = Tt(s, "%webView_scope_selector_choose_books%"), k = Tt(s, "%webView_scope_selector_scope%"), J = Tt(s, "%webView_scope_selector_select_books%"), j = Tt(s, "%webView_scope_selector_range%"), Y = Tt(s, "%webView_scope_selector_select_range%"), T = Tt(s, "%webView_scope_selector_range_start%"), $ = Tt(s, "%webView_scope_selector_range_end%"), W = Tt(s, "%webView_scope_selector_ok%"), Z = Tt(s, "%webView_scope_selector_cancel%"), At = Tt(s, "%webView_scope_selector_navigate%"), Vt = Tt(s, "%webView_scope_selector_all_books%"), It = (M) => {
    if (!f) return;
  ...
  ], et = (M, X, Xt = !1) => /* @__PURE__ */ u(st, { children: [
    M,
    X && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      X
    ] })
  ] }), ct = e ? G.filter((M) => e.includes(M.value)) : G, lt = f ?? ha, gt = w ?? lt, Pt = p ?? lt, ut = () => {
  }, bt = F(null), Ht = F(null), St = F(!1), Qt = F(null), me = F(!1), [R, yt] = _(void 0), Nt = F(!1), jt = F(!1), ve = F(null), ae = L((M) => {
    if (M) {
      yt("start"), Nt.current = !1;
      return;
    }
    yt((X) => X === "start" ? void 0 : X), Nt.current && (Nt.current = !1, requestAnimationFrame(() => {
      var Xt;
      const X = (Xt = bt.current) == null ? void 0 : Xt.querySelector("button");
      X == null || X.click();
    }));
  }, []), P = L((M) => {
    if (M) {
    ...
    (M) => {
      h == null || h(M), g == null || g(M), Nt.current = !0;
    },
    [h, g]
  ), at = L(
    (M) => {
      g == null || g(M), jt.current = !0;
    },
    [g]
  ), rt = L(
    (M) => {
    ...
    [r, n, f, i]
  ), ot = ct.find((M) => M.value === t), it = D(
    () => fo(o),
    [o]
  ), mt = t === "selectedBooks" && n.length > 0 ? Qw(n, it, Vt, c) : void 0, pt = tu(n, c), vt = mt && pt && mt !== pt ? pt : void 0, Lt = () => mt || (t === "range" ? Xs(gt, Pt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ot ? et(ot.label, ot.scrRefSuffix) : t), Yt = ct.filter(
    (M) => M.value !== "selectedBooks" && M.value !== "range"
  ), Bt = ct.find((M) => M.value === "selectedBooks"), Ft = ct.find((M) => M.value === "range"), [je, z] = _(!1), [Ct, kt] = _(void 0), [Wt, Le] = _(void 0), [Ne, wr] = _(void 0), [Be, ur] = _(void 0), [pr, zr] = _([]), Rr = d === "dropdown" && Ct === "selectedBooks", x = /* @__PURE__ */ a(
    au,
    {
      availableBookInfo: o,
      selectedBookIds: Rr ? pr : n,
      onChangeSelectedBookIds: Rr ? zr : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), U = R === "end", tt = R === "start", Et = "tw:text-muted-foreground", oe = d === "dropdown" && Ct === "range", Je = oe ? wr : Q, Ut = oe ? ur : g ? at : ut, xt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: m(U && Et), children: T }),
      /* @__PURE__ */ a(
        fa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: bt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: m(tt && Et), children: $ }),
      /* @__PURE__ */ a(
        fa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: oe ? Ne ?? gt : gt,
          onOpenChange: P,
          onCloseAutoFocus: (M) => {
            var X;
            jt.current && (jt.current = !1, M.preventDefault(), (X = ve.current) == null || X.focus());
          },
          className: m(tt && Et),
          modal: !0,
          align: "start"
  ...
  const [ee, Fe] = _(null), [Dr, Ai] = _(null), [Or, Ii] = _(null), Vi = 200, [Pi, ji] = _(!1);
  H(() => {
    if (!Or || typeof ResizeObserver > "u") return;
    const M = new ResizeObserver(([X]) => {
      ji(X.contentRect.width < Vi);
    });
    return M.observe(Or), () => M.disconnect();
  }, [Or]);
  const vo = L(
    (M) => {
      Le(M), wr(gt), ur(Pt), zr(n), z(!1), kt(M);
    },
    [gt, Pt, n]
  ), bo = L(() => {
    Wt !== void 0 && (Wt === "range" ? (Ne && (h == null || h(Ne)), Be && (g == null || g(Be))) : Wt === "selectedBooks" && i(pr), rt(Wt), kt(void 0), Le(void 0));
  }, [
    Wt,
    Ne,
    Be,
    ...
    M || (kt(void 0), Le(void 0));
  }, []), xo = L((M) => {
    var X;
    M.preventDefault(), (X = te.current) == null || X.focus();
  }, []), yo = /* @__PURE__ */ u(
    q,
    {
      ref: te,
      ...
      children: [
        /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Lt() }),
        /* @__PURE__ */ a(or, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
      ]
    }
  ), Li = (M) => vt ? /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
    M,
    /* @__PURE__ */ a(Mt, { children: vt })
  ] }) }) : M, ko = (M) => t === M ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !y && /* @__PURE__ */ a(_t, { children: k }),
      d === "dropdown" ? Li(
        /* @__PURE__ */ u(Ae, { open: je, onOpenChange: z, children: [
          /* @__PURE__ */ a(Ie, { asChild: !0, children: vt ? /* @__PURE__ */ a(Ot, { asChild: !0, children: yo }) : yo }),
          /* @__PURE__ */ a(
            Ve,
            {
              ref: Ii,
              ...
              children: /* @__PURE__ */ u(wa, { container: Or, children: [
                Yt.map(
                  ({ value: M, label: X, dropdownLabel: Xt, scrRefSuffix: gr, id: Bi }) => /* @__PURE__ */ u(
                    qe,
                    {
                      ref: ht(M),
                      ...
                      children: [
                        t === M && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }),
                        et(Xt ?? X, gr, Pi)
                      ]
                    },
                    Bi
                ...
                b && /* @__PURE__ */ u(st, { children: [
                  /* @__PURE__ */ a(He, {}),
                  /* @__PURE__ */ a(Cr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: At }),
                  /* @__PURE__ */ a(
                    qe,
                    {
                      ref: Qt,
                      ...
                      onSelect: (M) => {
                        ...
                        me.current || (Xt = (X = Ht.current) == null ? void 0 : X.querySelector("button")) == null || Xt.click();
                      },
                      children: /* @__PURE__ */ a(
                        "div",
                        {
                          ...
                          onPointerDownCapture: (M) => {
                            ...
                            X != null && X.closest("button") && (St.current = !0, requestAnimationFrame(() => {
                              St.current = !1;
                            }));
                          },
                          children: /* @__PURE__ */ a(
                            fa,
                            {
                              ...
                              onCloseAutoFocus: (M) => {
                                var X;
                                M.preventDefault(), (X = Qt.current) == null || X.focus();
                              },
                              modal: !0,
                              ...
                              triggerContent: /* @__PURE__ */ u(st, { children: [
                                /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: be(f ?? ha, "id") }),
                                /* @__PURE__ */ a(or, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                              ] })
                            }
                          )
        ...
        Ga,
        {
          ...
          children: ct.map(({ value: M, label: X, scrRefSuffix: Xt, id: gr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Hr, { className: "tw:me-2", value: M, id: gr }),
            /* @__PURE__ */ a(_t, { htmlFor: gr, children: et(X, Xt) })
          ] }, gr))
        }
      )
    ] }),
    ...
    d === "radio" && t === "range" && xt,
    d === "dropdown" && Bt && /* @__PURE__ */ a(Ta, { open: Ct === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Sa,
      {
        ref: Ai,
        onCloseAutoFocus: xo,
        ...
        children: /* @__PURE__ */ u(wa, { container: Dr, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ra, { children: K }) }),
          x,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: Z }),
            /* @__PURE__ */ a(q, { onClick: bo, children: W })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && Ft && /* @__PURE__ */ a(Ta, { open: Ct === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Sa,
      {
        ref: Fe,
        onCloseAutoFocus: xo,
        onEscapeKeyDown: (M) => {
          ee != null && ee.querySelector('[data-state="open"]') && M.preventDefault();
        },
        children: /* @__PURE__ */ u(wa, { container: ee, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ra, { children: Y }) }),
          xt,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: Z }),
            /* @__PURE__ */ a(q, { ref: ve, onClick: bo, children: W })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          lr,
          {
            ...
            style: { zIndex: We },
            children: t.map((w) => /* @__PURE__ */ a(se, { value: `${w}`, children: l[So(w)] }, `${w}`))
          }
        )
      ]
    }
...
const zi = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Dt, { children: [
  /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ns, { children: c.label }),
    /* @__PURE__ */ a(is, { children: /* @__PURE__ */ a(ss, { children: zi(
      t,
      e,
      Si(t, c.id),
      o
...
function Ka({
  ...
  return /* @__PURE__ */ u(Ae, { variant: i, children: [
    /* @__PURE__ */ a(Ie, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ls, {}) }) }),
    /* @__PURE__ */ a(Ve, { align: "start", style: { zIndex: We }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(na, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(Rt, { children: zi(e.groups, e.items, l, t) }) }),
...
const iu = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Trigger,
  {
    ref: r,
    ...e,
...
)), Mi = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Content,
  {
    ref: r,
    className: m(
...
Mi.displayName = le.Content.displayName;
function sh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Di, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(iu, { value: c.value, children: c.value }, c.key)) }),
...
function su({
  ...
  return /* @__PURE__ */ a(cs.Provider, { value: o, children: /* @__PURE__ */ a(
    ge.Root,
    {
      "data-slot": "menubar",
      className: m(
...
function wu({
  ...
  const i = Er();
  return /* @__PURE__ */ a(lu, { children: /* @__PURE__ */ a(
    ge.Content,
    {
...
const mr = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Dt, { children: [
...
function mu({
  ...
  if (ul(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var f, b, v, E;
    w.preventDefault();
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (b = s.current) == null || b.focus(), mr(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), mr(c, [h, g]);
        break;
      case "alt+h":
        (E = l.current) == null || E.focus(), mr(l, [h, g]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(su, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(cu, { children: [
      /* @__PURE__ */ a(du, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        wu,
        {
          style: { zIndex: We },
          children: /* @__PURE__ */ a(Rt, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function dh({
  ...
  const d = vu(
    ...
    var E, y, N, O, B, S;
    const v = b !== f ? ((y = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? ((O = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : O.en) : void 0;
...
function uh({
  ...
  return /* @__PURE__ */ u(Me, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(ls, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(ds, { children: /* @__PURE__ */ a(nc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u($e, { children: [
      ...
      /* @__PURE__ */ a(
        Mt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: zo(d, {
            ...
            /* @__PURE__ */ a(na, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
...
function gh({
  ...
  return /* @__PURE__ */ a(Rt, { children: /* @__PURE__ */ u(Dt, { children: [
    /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
      _u,
      {
        className: o,
...
function bh({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(na, { children: [
...
function Mh({
  ...
  return /* @__PURE__ */ u(
    $t.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a($t.ItemIndicator, { children: /* @__PURE__ */ a(ia, {}) }) }),
        e
      ]
    }
  );
  ...
  return /* @__PURE__ */ a(
    hl,
    {
      ...
      icons: {
        ...
        info: /* @__PURE__ */ a(lc, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(cc, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(sc, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(ic, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function ag({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", Su({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function dg(t) {
  const e = D(() => Js(t).slice().sort().join(" "), [t]);
...
export {
  ...
  iw as DropdownMenuItemType,
  Cr as DropdownMenuLabel,
  is as DropdownMenuPortal,
  ...
  m as cn,
  tu as formatSelectedBooksList,
  fo as getAvailableBookIds,
