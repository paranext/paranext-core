...
import S, { forwardRef as er, useCallback as Et, useState as ut, useRef as be, useEffect as se, useLayoutEffect as sa, useMemo as Ot } from "react";
...
), uo = ft.Root, gi = ft.Trigger, Ql = ft.Group, ch = ft.Portal, dh = ft.Sub, ph = ft.RadioGroup, tc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  ft.SubTrigger,
  {
    ref: o,
    className: N(
...
et(Ct, "defaultVersification", we.English), et(Ct, "verseRangeSeparator", "-"), et(Ct, "verseSequenceIndicator", ","), et(Ct, "verseRangeSeparators", [Ct.verseRangeSeparator]), et(Ct, "verseSequenceIndicators", [Ct.verseSequenceIndicator]), et(Ct, "chapterDigitShifter", 1e3), et(Ct, "bookDigitShifter", Ct.chapterDigitShifter * Ct.chapterDigitShifter), et(Ct, "bcvMaxValue", Ct.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
et(Ct, "ValidStatusType", Si);
...
), St = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(li.Root, { ref: n, className: N("pr-twp", Tc(), t), ...e }));
St.displayName = li.Root.displayName;
...
const Ci = vn.Root, Oi = vn.Trigger, go = S.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(vn.Portal, { children: /* @__PURE__ */ s(
  vn.Content,
  {
    ref: o,
    align: e,
...
vo.displayName = Pt.Input.displayName;
...
yo.displayName = Pt.List.displayName;
const xo = S.forwardRef((t, e) => /* @__PURE__ */ s(Pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
xo.displayName = Pt.Empty.displayName;
...
_i.displayName = Pt.Group.displayName;
...
Pc.displayName = Pt.Separator.displayName;
...
No.displayName = Pt.Item.displayName;
function $c(t) {
...
function Ic({
  ...
  return /* @__PURE__ */ x(ne, { children: [
    /* @__PURE__ */ s(St, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ s(
      qr,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ s(St, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ s(
      qr,
      {
        isDisabled: o,
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(St, { className: "tw-ms-1", children: p })
          ] }),
          /* @__PURE__ */ s(St, { className: "tw-flex tw-items-center", children: e }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ s(St, { className: "tw-ms-1", children: w })
          ] }),
          /* @__PURE__ */ s(St, { className: "tw-flex tw-items-center", children: r.map((h) => ot.bookIdToEnglishName(h)).join(", ") }),
          /* @__PURE__ */ s(
            wt,
            {
...
function yh({
  ...
  const f = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), m = Zt(n, "%webView_inventory_scope_currentBook%"), h = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [_, F] = ut("all"), [R, $] = ut(""), [L, D] = ut([]), I = Ot(() => l ? r instanceof RegExp ? Kc(
    l,
    t,
    a,
    i,
    r
  ) : r(l, t, a, i) : [], [l, r, t, a, i]), M = Ot(() => {
    if (E)
      return I;
    const y = [];
    return I.forEach((O) => {
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ s(St, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? C })
      ] })
    ] }),
...
Bi.displayName = $t.List.displayName;
const Zc = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  $t.Trigger,
  {
    ref: n,
...
Vi.displayName = $t.Content.displayName;
function xh({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
function kh({
  ...
  const [c, d] = ut([]), [p, f] = ut([{ id: oe, desc: !1 }]), [w, g] = ut({}), v = Ot(
...
function Td({ item: t, createLabel: e, createComplexLabel: n }) {
  return e ? /* @__PURE__ */ s(St, { children: e(t) }) : n ? /* @__PURE__ */ s(St, { children: n(t) }) : /* @__PURE__ */ s(St, { children: t });
}
function Oh({
  id: t,
  className: e,
  ...
  return /* @__PURE__ */ s("div", { id: t, className: e, children: n.map((l) => /* @__PURE__ */ x("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ s(
      ko,
      {
...
function pu() {
  ...
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = Np(a.breakpoints), f = Object.keys(p);
      let w = p;
...
function Io(t = {}, ...e) {
  ...
  return d.applyStyles = uu, d = e.reduce((p, f) => Qt(p, f), d), d.unstable_sxConfig = P({}, Po, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(f) {
    return $o({
      sx: f,
      theme: this
    });
...
const mw = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hw = (t) => {
  ...
  const r = jo({
    ...
    titleAccess: f,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, mw), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", m = P({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function Pw(t) {
  ...
  const i = Rw(P({}, o, r)), l = Ga(r), c = Ga(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
var Rt = "top", Ft = "bottom", Lt = "right", _t = "left", Vo = "auto", $n = [Rt, Ft, Lt, _t], Ue = "start", kn = "end", Bw = "clippingParents", Ns = "viewport", sn = "popper", Vw = "reference", Ua = /* @__PURE__ */ $n.reduce(function(t, e) {
...
function rf(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Yt(n.placement), c = Lo(l), d = [_t, Lt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var f = nf(o.padding, n), w = Fo(a), g = c === "y" ? Rt : _t, v = c === "y" ? Ft : Lt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], k = In(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - h / 2, E = f[g], b = T - w[p] - f[v], _ = T / 2 - w[p] / 2 + C, F = hn(E, _, b), R = c;
...
function Ha(t) {
  ...
  g = h.x, m = h.y;
  var k = i.hasOwnProperty("x"), T = i.hasOwnProperty("y"), C = _t, E = Rt, b = window;
  if (d) {
    var _ = In(n), F = "clientHeight", R = "clientWidth";
    if (_ === Dt(n) && (_ = ce(n), ee(_).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), _ = _, o === Rt || (o === _t || o === Lt) && a === kn) {
      E = Ft;
...
function En(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Bw : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, f = n.elementContext, w = f === void 0 ? sn : f, g = n.altBoundary, v = g === void 0 ? !1 : g, m = n.padding, h = m === void 0 ? 0 : m, k = Cs(typeof h != "number" ? h : Os(h, $n)), T = w === sn ? Vw : sn, C = t.rects.popper, E = t.elements[v ? T : w], b = vf(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), _ = He(t.elements.reference), F = _s({
    reference: _,
    element: C,
    strategy: "absolute",
    placement: o
  ...
  if (w === sn && D) {
    ...
    Object.keys(L).forEach(function(M) {
      var H = [Lt, Ft].indexOf(M) >= 0 ? 1 : -1, G = [Rt, Ft].indexOf(M) >= 0 ? "y" : "x";
      L[M] += I[G] * H;
    });
  }
  return L;
...
function Nf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, k = Yt(h), T = k === h, C = c || (T || !v ? [Wn(h)] : xf(h)), E = [h].concat(C).reduce(function(z, K) {
      ...
      var D = E[L], I = Yt(D), M = Ye(D) === Ue, H = [Rt, Ft].indexOf(I) >= 0, G = H ? "width" : "height", B = En(e, {
        placement: D,
        boundary: p,
        rootBoundary: f,
        altBoundary: w,
...
function Ka(t) {
  return [Rt, Lt, Ft, _t].some(function(e) {
    return t[e] >= 0;
  });
}
function Ef(t) {
...
function Tf(t, e, n) {
  var r = Yt(t), o = [_t, Rt].indexOf(r) >= 0 ? -1 : 1, a = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, i = a[0], l = a[1];
  return i = i || 0, l = (l || 0) * o, [_t, Lt].indexOf(r) >= 0 ? {
    x: l,
    y: i
  } : {
    x: i,
...
function $f(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = En(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Yt(e.placement), T = Ye(e.placement), C = !T, E = Lo(k), b = Pf(E), _ = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, $ = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
  ...
  if (_) {
    if (a) {
      var M, H = E === "y" ? Rt : _t, G = E === "y" ? Ft : Lt, B = E === "y" ? "height" : "width", Z = _[E], at = Z + h[H], rt = Z - h[G], y = g ? -R[B] / 2 : 0, O = T === Ue ? F[B] : R[B], U = T === Ue ? -R[B] : -F[B], X = e.elements.arrow, z = g && X ? Fo(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var de, Tt = E === "x" ? Rt : _t, Mn = E === "x" ? Ft : Lt, Xt = _[b], Ce = b === "y" ? "height" : "width", pe = Xt + h[Tt], Oe = Xt - h[Mn], Re = [Rt, _t].indexOf(k) !== -1, _e = (de = D == null ? void 0 : D[b]) != null ? de : 0, ue = Re ? pe : Xt - F[Ce] - R[Ce] - _e + L.altAxis, Ze = Re ? Xt + F[Ce] + R[Ce] - _e - L.altAxis : Oe, Dn = g && Re ? ef(ue, Xt, Ze) : hn(g ? ue : pe, Xt, g ? Ze : Oe);
      _[b] = Dn, I[b] = Dn - Xt;
    }
    e.modifiersData[r] = I;
  }
...
const js = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const _ = jo({
    ...
    children: R
  }), Ut = Is(), de = Ut.direction === "rtl", [Tt, Mn] = j.useState(), [Xt, Ce] = j.useState(null), pe = j.useRef(!1), Oe = H || rt, Re = dn(), _e = dn(), ue = dn(), Ze = dn(), [Dn, Yo] = is({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    j.useEffect(() => {
      Tt && Tt.disabled && !tt && dt !== "" && Tt.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [dt, Tt, tt]);
  }
  ...
  const Wo = (tt) => {
    ...
    pe.current && tt.type !== "touchstart" || (Tt && Tt.removeAttribute("title"), _e.clear(), ue.clear(), B || Gn && Z ? _e.start(Gn ? Z : B, () => {
      Wo(tt);
    }) : Wo(tt));
  }, qo = (tt) => {
    _e.clear(), ue.start(O, () => {
    ...
    Tt || Mn(tt.currentTarget), Ls(tt), Ko.current === !0 && (Jo(!0), Sr(tt));
  }, ta = (tt) => {
    pe.current = !0;
    const It = yt.props;
    It.onTouchStart && It.onTouchStart(tt);
  }, ea = Sr, na = qo, Us = (tt) => {
  ...
  j.useEffect(() => {
    if (!Jt)
      return;
    function tt(It) {
      (It.key === "Escape" || It.key === "Esc") && Bn(It);
    }
  ...
  const Tr = j.useRef(), Ys = (tt) => {
    const It = yt.props;
    It.onMouseMove && It.onMouseMove(tt), ln = {
      x: tt.clientX,
      y: tt.clientY
...
`));
  const Ws = j.useMemo(() => {
    ...
    return (tt = Y.popperOptions) != null && tt.modifiers && (It = It.concat(Y.popperOptions.modifiers)), P({}, Y.popperOptions, {
      modifiers: It
    });
  }, [Xt, Y]), nn = P({}, _, {
    isRtl: de,
    ...
    touch: pe.current
  }), Or = um(nn), ra = (r = (o = Q.popper) != null ? o : $.Popper) != null ? r : wm, oa = (a = (i = (l = Q.transition) != null ? l : $.Transition) != null ? i : A) != null ? a : ei, aa = (c = (d = Q.tooltip) != null ? d : $.Tooltip) != null ? c : fm, ia = (p = (f = Q.arrow) != null ? f : $.Arrow) != null ? p : mm, qs = pn(ra, P({}, Y, (w = J.popper) != null ? w : L.popper, {
...
function zs(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: i } = Ot(() => {
...
const Ih = $t.Root, Vm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    $t.List,
    {
...
Vm.displayName = $t.List.displayName;
...
zm.displayName = $t.Trigger.displayName;
...
Fm.displayName = $t.Content.displayName;
function Ah({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
...
function Uh({
  ...
  return /* @__PURE__ */ x("div", { className: N("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ x(ne, { children: [
      /* @__PURE__ */ s(St, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ s("div", { className: "tw-ms-3", children: /* @__PURE__ */ x(St, { children: [
        "Currently:",
        " ",
