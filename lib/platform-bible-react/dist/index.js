...
import Yt, { useRef as q, useMemo as A, createContext as la, useContext as wo, useState as _, useEffect as Y, useCallback as L, useImperativeHandle as ic, useLayoutEffect as Zt, Component as sc, createElement as Po, Suspense as cc, forwardRef as Pn, useId as Vo, Fragment as da } from "react";
...
function Tl({
  ...
  Y(() => {
    ...
    if (!Q) return;
    const O = (J) => !!J && J.scrollWidth > J.clientWidth, U = () => {
      Ga !== "pointer" && (C || O(h.current) || O(l.current)) && S(!0);
    }, I = () => S(!1);
    return Q.addEventListener("focus", U), Q.addEventListener("blur", I), () => {
      Q.removeEventListener("focus", U), Q.removeEventListener("blur", I);
    };
  }, [C, h, l]);
  const K = L(() => {
    C && R(!0), f(), P && w();
...
function Sl({
  ...
  const [h, g] = _(!1), f = w !== void 0, v = f ? w : h, b = (x) => {
    f || g(x), p == null || p(x);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Be, { open: v, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ a(Ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(Me, { heading: i, children: t.map((x) => /* @__PURE__ */ u(
      Ie,
      {
        onSelect: () => R(x),
...
function ka({
  ...
  const C = Ce(), K = Cl(), M = P ?? K, [z, H] = _(!1), [W, j] = _(""), [Q, O] = _(""), [U, I] = _("books"), [E, J] = _(void 0), [et, ft] = _(
    void 0
  ), [ot, Mt] = _(void 0), [tt, ct] = _(!1), ht = q(null), mt = q(!1), lt = q(void 0), Ot = q(void 0), wt = q(void 0), ie = q(void 0), te = q({}), St = q({}), xt = L(
    (k) => {
      e(k), c && c(k);
    },
    [e, c]
  ...
  }), [Nt]), vt = A(() => Object.values(It).flat(), [It]), zt = A(() => {
    if (!Q.trim()) return It;
    const k = {
      [pt.OT]: [],
      [pt.NT]: [],
    ...
    return [pt.OT, pt.NT, pt.DC, pt.Extra].forEach((nt) => {
      k[nt] = It[nt].filter((Rt) => Qa(Rt, Q, n));
    }), k;
  }, [It, Q, n]), D = A(
    () => Ol(Q, vt, n),
    [Q, vt, n]
  ...
  const se = L(() => {
    ...
    (k) => {
      const X = U === "chapters" ? E : D == null ? void 0 : D.book;
      if (X) {
        if (d && d(X, k) > 1) {
          ft(X), Mt(k), I("verses"), j("");
          return;
        }
        xt({
          book: X,
    ...
    I("books"), J(void 0), ft(void 0), Mt(void 0), setTimeout(() => {
      Ot.current && Ot.current.focus();
    }, 0);
  }, []), ae = L(() => {
    const k = et;
    ft(void 0), Mt(void 0), k ? (J(k), I("chapters"), j("")) : _t();
  }, [et, _t]), $t = L((k) => {
    H(k), k && (I("books"), J(void 0), ft(void 0), Mt(void 0), O(""));
  }, []);
  Y(() => {
    N && $t(!1);
  }, [N, $t]);
  ...
  Y(() => {
    var k;
    At !== 0 && ((k = Ot.current) == null || k.focus());
  }, [At]), ic(
    S,
    () => ({
      open: () => {
  ...
  const { otLong: be, ntLong: oe, dcLong: T, extraLong: F } = {
    ...
    () => M >= Hr.TIGHT ? Jr(t.book, n) : ze(t.book, n),
    [t.book, n, M]
  ), at = `${t.chapterNum}:${t.verseNum}`, it = L((k) => (X) => {
    te.current[k] = X;
  }, []), gt = L((k) => (X) => {
    St.current[k] = X;
  }, []), bt = A(
    () => Dl(Q),
    [Q]
  ), yt = A(() => !d || !D || !D.chapterNum || !bt ? !1 : d(D.book, D.chapterNum) > 0, [d, D, bt]), Ct = L(
    (k) => w ? Go(k, w) : !1,
    [w]
  ), Pt = L(
    (k) => (X) => w ? Ml(k, X, w) : !1,
    ...
    [w]
  ), ne = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ir = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Eo = L(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), p && p.includes(k.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), se());
    },
    [p, D, se]
  ), fa = L(
    (k) => {
      var $e, Se, nr;
      if (k.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Yo(k.key);
      if ((U === "chapters" || U === "verses") && (k.key === " " || k.key === "Enter")) {
        ...
        if (Ht) {
          k.preventDefault(), k.stopPropagation(), Ht.click();
          return;
        }
      }
      ...
      if (U === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), _t();
        return;
      }
      if (U === "verses" && k.key === "Backspace") {
      ...
      if (U === "verses" && Rt) {
        ...
        le !== kt && (k.preventDefault(), k.stopPropagation(), j(
          `${Dt} ${fe[Dt] || ""} ${Et}:${le}`
        ), setTimeout(() => {
      ...
      if ((U === "chapters" || U === "books" && D) && Rt) {
        const Dt = U === "chapters" ? E : D == null ? void 0 : D.book;
        if (!Dt) return;
        ...
        kt !== Et && (k.preventDefault(), k.stopPropagation(), j(
          `${Dt} ${fe[Dt] || ""} ${kt}`
        ), setTimeout(() => {
    ...
    const { isLetter: X, isDigit: nt } = Yo(k.key);
    (X || nt) && (k.preventDefault(), O(($e) => $e + k.key), Ot.current.focus(), ct(!1));
  }, []);
  return Zt(() => {
    const k = setTimeout(() => {
      if (z && U === "books" && wt.current && ie.current) {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Be, { open: z, onOpenChange: $t, modal: R, children: [
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: X } = k;
          z && ht.current && X instanceof Node && ht.current.contains(X) && (mt.current = !0, $t(!1));
        },
        onCloseAutoFocus: b,
        children: /* @__PURE__ */ u(
          Ke,
          {
            ...
            children: [
              U === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                U === "chapters" && E && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ze(E, n) }),
                  ...
                  !D && Object.entries(zt).map(([k, X]) => {
                    if (X.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ a(Me, { heading: y(k), children: X.map((nt) => /* @__PURE__ */ a(
                          ei,
                          {
                            bookId: nt,
                            onSelect: (Rt) => Xe(Rt),
...
function Jo({
  ...
  const [S, N] = _(!1), P = d ?? l, C = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], K = (M, z) => {
    const H = l(M), W = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, j = `${z ?? ""}${H}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Ie,
      {
        value: H,
  ...
  return /* @__PURE__ */ u(Be, { open: S, onOpenChange: N, ...x, children: [
    /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ u(
      Z,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        children: /* @__PURE__ */ u(Ke, { children: [
          ...
          /* @__PURE__ */ a(He, { children: C(e) ? e.map((M) => /* @__PURE__ */ a(Me, { heading: M.groupHeading, children: M.options.map((z) => K(z, M.groupHeading)) }, M.groupHeading)) : /* @__PURE__ */ a(Me, { children: e.map((M) => K(M)) }) })
        ] })
      }
    )
  ] });
...
function Gl() {
  return function(t) {
    const [e] = Te(), r = A(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = q(o);
    return Hl(() => {
...
function Jl(t, e, r) {
  ...
  function l() {
    ...
    for (let R = 0; R < g.length; R++) {
      ...
      const P = ke(x.left - p);
      N.left !== P && (N.left = P, b = !0);
      const C = ke(x.top - h);
      N.top !== C && (S.style.top = C, b = !0);
      const K = ke(x.width);
      N.width !== K && (S.style.width = K, b = !0);
      const M = ke(x.height);
      N.height !== M && (S.style.height = M, b = !0), S.parentNode !== c && (c.append(S), b = !0), s[R] = S;
    }
...
function Ql(t, e = Zl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), v = f.getKey(), b = h.offset, R = g.getNode(), x = R.getKey(), S = g.offset, N = t.getElementByKey(v), P = t.getElementByKey(x), C = r === null || N !== o || b !== n || v !== r.getKey(), K = i === null || P !== s || S !== c || x !== i.getKey();
      if ((C || K) && N !== null && P !== null) {
        const M = function(z, H, W, j, Q, O, U) {
          const I = (z._window ? z._window.document : document).createRange();
          return I.setStart(...Zo(H, W, j)), I.setEnd(...Zo(Q, O, U)), I;
        }(t, h, f, N, g, R, P);
        l(), l = Jl(t, M, e);
      }
      r = f, o = N, n = b, i = R, s = P, c = S;
    });
  }
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (_e(f)) {
                ...
                if (Ka(b) && d >= 0 && w >= 0 && (R = d, x = d + w, f.setTextNodeRange(b, R, b, x)), R === x && p === "" || (f.insertRawText(p), b = v.getNode()), Ka(b)) {
                  R = h, x = h + g;
                  const S = b.getTextContentSize();
                  R = R > S ? S : R, x = x > S ? S : x, f.setTextNodeRange(b, R, b, x);
                }
...
function $d({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: v, role: b = "textbox", spellCheck: R = !0, style: x, tabIndex: S, "data-testid": N, ...P }, C) {
  ...
  return xi(() => (M(t.isEditable()), t.registerEditableListener((W) => {
    M(W);
  })), [t]), a("div", { "aria-activedescendant": K ? e : void 0, "aria-autocomplete": K ? r : "none", "aria-controls": K ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": K && b === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": K ? p : void 0, "aria-readonly": !K || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: K, "data-testid": N, id: v, ref: H, role: b, spellCheck: R, style: x, tabIndex: S, ...P });
}
const Ad = Pn($d);
function cn(t) {
  return t.getEditorState().read(vi(t.isComposing()));
...
function Ud({
  ...
  const [e] = Te(), [r, o] = _(e), [n, i] = _("paragraph"), [s, c] = Bd(), l = () => {
  };
...
function Hd() {
  const { activeEditor: t } = ki(), [e, r] = _([]), o = L((n) => {
    if (_e(n) || dl(n)) {
      const i = [];
      ln.forEach(({ format: s }) => {
...
function wn({
  ...
  const g = L(
    ...
    [t.user]
  ), x = A(() => lo(t.contents), [t.contents]), S = A(
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : No(C) && (C.preventDefault(), C.stopPropagation(), de(w) && f());
              },
              onKeyDown: (C) => {
                _o(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
...
function Di({
  ...
  const [j, Q] = _(un), [O, U] = _(), [I, E] = _(), J = o, [et, ft] = _(!1), [ot, Mt] = _(!1), [tt, ct] = _(!1), [ht, mt] = _(!1), [lt, Ot] = _(!1), [wt, ie] = _(N), [te, St] = _(!1), xt = q(void 0), [Nt, It] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let y = !0;
    return (async () => {
      const B = x ? await x(l) : !1;
      y && Ot(B);
    })(), () => {
      y = !1;
    };
  ...
  Y(() => {
    if (!o) {
      vt.current !== "idle" && (U(void 0), E(void 0), vt.current = "idle");
      return;
    }
    ...
    K !== i && (U(K), vt.current = "auto-populated") : vt.current === "auto-populated" && (U(void 0), vt.current = "pending");
  }, [o, K, ht, i]);
  const zt = A(
  ...
  const D = A(() => zt[0], [zt]), ue = q(null), se = q(void 0), ce = L(() => {
    var y;
    (y = se.current) == null || y.call(se), Q(un);
  }, []), Xe = L(() => {
    const y = !wt;
    ie(y), St(!y), f == null || f(l, y);
  }, [wt, f, l]);
  Y(() => {
    ft(!1);
  }, [o]), Y(() => {
  ...
  }, [i, r]), re = A(() => zt.slice(1), [zt]), _t = A(() => re.length ?? 0, [re.length]), ae = A(() => _t > 0, [_t]), $t = A(() => et || _t <= 2 ? re : re.slice(-2), [re, _t, et]), At = A(() => et || _t <= 2 ? 0 : _t - 2, [_t, et]), ve = A(
  ...
  const oe = L(
    async (y) => {
      ...
      $ && await p({ threadId: l, contents: $ }) && ce();
    },
    [
      ce,
      j,
    ...
    async (y) => {
      const $ = de(j) ? oa(j) : void 0, B = y.status ? y.assignedUser : O ?? y.assignedUser, G = await p({
        ...y,
        contents: $,
        assignedUser: B
      });
      return G && (B !== void 0 && E(B), $ && ce()), G;
    },
    [ce, j, p, O]
  );
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            ...
            $t.map((y) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              wn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: Mt,
                canEditOrDelete: (!ot && Nt.get(y.id)) ?? !1
              }
            ) }, y.id)),
            b !== !1 && (!ot || de(j)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (y) => {
                  No(y) && (y.preventDefault(), y.stopPropagation(), (de(j) || O !== void 0 && O !== I) && oe());
                },
                onKeyDown: (y) => {
                  _o(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    aa,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    O !== void 0 && (de(j) || O !== I) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: tr(
                    ...
                    /* @__PURE__ */ u(Be, { open: tt, onOpenChange: ct, children: [
                      ...
                      /* @__PURE__ */ a(
                        Ue,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: v == null ? void 0 : v.map((y) => /* @__PURE__ */ a(
                            Ie,
                            {
                              onSelect: () => {
                                U(y !== i ? y : void 0), vt.current = "user-selected", E(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function nw({
  ...
  const [s, c] = _("accept"), l = Vo(), d = Vo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, v = A(
    () => Wr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = A(
    () => Wr(t.acceptedText ?? ""),
  ...
  const H = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: H }), j = (I) => I ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: I }) : W, Q = () => {
    const I = o ?? "accept";
    return I === "merged" ? t.mergedText ? /* @__PURE__ */ a(Xr, { html: R }) : W : j(I === "reject" ? t.rejectedResultText : t.resultText);
  }, O = (I) => p && I.value === "reject", U = (I) => {
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          to,
          {
            ...
            children: C.map((I) => O(I) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Bt, { asChild: !0, children: U(I) }),
              /* @__PURE__ */ a(Ut, { children: N })
            ] }) }, I.value) : U(I))
          }
        ),
...
function Vp({
  ...
  const [x, S] = _(/* @__PURE__ */ new Set()), [N, P] = _(), [C, K] = _(), M = L(
    async (E) => {
      const J = await i(E);
  ...
  ), H = z.map((E) => ({ id: E.id })), W = L(
    (E) => {
      S((J) => new Set(J).add(E.id)), P(E.id), v == null || v(E.id);
    },
    [v]
  ), j = L(
    (E) => {
      ...
      }), P(E), v == null || v(J ? void 0 : E);
    },
    [x, v]
  ), { listboxRef: Q, activeId: O, handleKeyDown: U } = Qi({
    options: H,
    onOptionSelect: W
  }), I = L(
    (E) => {
      ...
      }), P(void 0), v == null || v(void 0)), E.preventDefault(), E.stopPropagation()) : U(E);
    },
    [N, x, U, v]
  );
  return /* @__PURE__ */ a(
...
function fw({
  ...
  var C;
  const [w, p] = _([]), [h, g] = _([]), [f, v] = _({}), [b, R] = _({}), x = A(() => e ?? [], [e]), S = Zn({
    data: x,
    columns: t,
    getCoreRowModel: ti(),
  ...
  return l ? P = Array.from({ length: 10 }).map((z, H) => `skeleton-row-${H}`).map((z) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((C = S.getRowModel().rows) == null ? void 0 : C.length) > 0 ? P = S.getRowModel().rows.map((K) => /* @__PURE__ */ a(
    ...
    K.id
  )) : P = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(lr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(ww, { table: S }),
    /* @__PURE__ */ u(ao, { stickyHeader: i, children: [
      /* @__PURE__ */ a(oo, { stickyHeader: i, children: S.getHeaderGroups().map((K) => /* @__PURE__ */ a(Ve, { children: K.headers.map((M) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : Nr(M.column.columnDef.header, M.getContext()) }, M.id)) }, K.id)) }),
...
function Rw({
  ...
  const b = (x) => {
    if (c.current = !1, g(x), !x) {
      const S = f.current, N = v.current;
      S !== "custom" || N ? (S !== t && e(S), N !== r && o(N)) : (d(t), p(r));
    }
  }, R = (x) => {
    var S, N, P, C;
    x.stopPropagation(), document.activeElement === s.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((S = i.current) == null || S.focus(), c.current = !0) : document.activeElement === i.current && x.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), c.current = !1) : document.activeElement === i.current && x.key === "ArrowLeft" && ((P = i.current) == null ? void 0 : P.selectionStart) === 0 && ((C = s.current) == null || C.focus(), c.current = !1), l === "custom" && x.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && b(!1);
  };
...
function Yp({
  ...
  var oe;
  const h = q(null), g = q(null), f = q(null), v = q(null);
  Zt(() => {
    if (!v.current) return;
    const { width: T } = v.current.getBoundingClientRect();
    T > 0 && (v.current.style.width = `${T}px`);
  }, []);
  const [b, R] = _("generated"), [x, S] = _("generated"), [N, P] = _("*"), [C, K] = _("*"), [M, z] = _("f"), [H, W] = _(!1), [j, Q] = _(!0), [O, U] = _(!1), I = q(!1), E = q(""), [J, et] = _(!1), [ft, ot] = _(), [Mt, tt] = _(), [ct, ht] = _(), [mt, lt] = _(), Ot = q(null), wt = q(void 0), ie = q(0), te = q(void 0), St = A(
    () => ({
      ...s,
  ...
  const Nt = L(() => {
    var $, B, G;
    const T = ($ = g.current) == null ? void 0 : $.querySelector(".editor-input"), F = T == null ? void 0 : T.querySelector("span.note"), y = (G = (B = g.current) == null ? void 0 : B.ownerDocument.getSelection()) == null ? void 0 : G.anchorNode;
  ...
  Y(() => {
    ...
    if ($ && yr("note", $)) {
      const at = (B = $.insert.note) == null ? void 0 : B.caller;
      let it = "custom";
      at === Ha ? it = "generated" : at === qa ? it = "hidden" : at && (P(at), K(at)), R(it), S(it), z(((G = $.insert.note) == null ? void 0 : G.style) ?? "f"), T = setTimeout(() => {
        var gt, bt, yt;
        (gt = h.current) == null || gt.applyUpdate([$]), (bt = h.current) == null || bt.selectNote(0), (yt = h.current) == null || yt.focus(), F = requestAnimationFrame(() => {
          y = setTimeout(() => {
            var Ct, Pt;
    ...
    return () => {
      T && clearTimeout(T), F !== void 0 && cancelAnimationFrame(F), y !== void 0 && clearTimeout(y);
    };
  }, [e, i, Nt]);
  const It = L(
    (T = !1) => {
      var y, $, B;
      p == null || p();
      const F = ($ = (y = h.current) == null ? void 0 : y.getNoteOps(0)) == null ? void 0 : $.at(0);
      F && yr("note", F) && (r == null || r([F]), T && d && i && ((B = d.current) == null || B.replaceEmbedUpdate(i, [F])));
    },
    [i, r, p, d]
  ), vt = L(
    (T, F) => {
      var B, G, at;
      const y = (G = (B = h.current) == null ? void 0 : B.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (!y || !yr("note", y) || !y.insert.note) return;
      let $;
      T === "custom" ? $ = F : T === "generated" ? $ = Ha : $ = qa, y.insert.note.caller !== $ && (y.insert.note.caller = $, (at = h.current) == null || at.applyUpdate([y, { delete: 1 }]));
    },
    []
  ), zt = L(() => {
    var T;
    wt.current || (T = h.current) == null || T.commitPendingMarkerEdits(), It(!0), o();
  }, [o, It]), D = q(zt);
  Zt(() => {
    D.current = zt;
  });
  const ue = q({ book: n.book, chapterNum: n.chapterNum });
  Zt(() => {
    (ue.current.book !== n.book || ue.current.chapterNum !== n.chapterNum) && (ue.current = { book: n.book, chapterNum: n.chapterNum }, D.current());
  }, [n.book, n.chapterNum]);
  const se = () => {
    var F;
    const T = (F = g.current) == null ? void 0 : F.getElementsByClassName("editor-input")[0];
    ...
    if (F && yr("note", F)) {
      ...
      M !== "x" && T === "x" ? it == null || it.forEach((gt) => jw(gt)) : M === "x" && T !== "x" && (it == null || it.forEach((gt) => Fw(gt))), (at = h.current) == null || at.applyUpdate([F, { delete: 1 }]);
    }
  }, pe = (T) => {
    lt(T.contextMarker), U(T.canRedo);
  }, re = L(
    (T) => {
      var y, $, B, G, at;
      const F = ($ = (y = h.current) == null ? void 0 : y.getNoteOps(0)) == null ? void 0 : $.at(0);
      if (F && yr("note", F)) {
        ...
        if (it || W(!1), W(
          ...
          I.current = !0, E.current = JSON.stringify(F), Q(!0);
          return;
        }
        Q(JSON.stringify(F) === E.current), It();
      } else
        W(!1), Q(!0);
    },
    [It]
    ...
    if (f.current && xt.length && T && T.rangeCount > 0) {
      const F = T.getRangeAt(0).getBoundingClientRect(), y = f.current.getBoundingClientRect();
      ot(F.left - y.left), tt(F.top - y.top), ht(F.height), et(!0);
    }
  }, [xt, f]), ae = q(() => {
  }), $t = L(
    (T, F, y) => {
    ...
    if (!T) return !1;
    const F = bl(St.styleInfo ?? xl, T);
    return F.length === 0 ? !1 : ($t(T, F, { passive: !T.hasTextSelection }), !0);
  }, [$t, St.styleInfo]), ve = L(
    (T) => {
      const F = wt.current;
      if (!F || !w) return;
      Cw(T, F, {
        ...
        commitTyped: ($) => {
          var B;
          return (B = h.current) == null ? void 0 : B.commitTypedMarker($);
        },
        commitTypedAndReopen: ($) => {
          var B;
          (B = h.current) == null || B.commitTypedMarker($, { trailingSpace: !1 }), At();
        },
        commitTypedCloser: ($) => {
          var B;
          return (B = h.current) == null ? void 0 : B.commitTypedCloser($);
        },
        commitItem: ($) => {
          var G;
          const B = F.items.find((at) => at.marker === $);
  ...
  Y(() => {
    ...
    const T = (F) => {
      var B, G;
      const y = (B = g.current) == null ? void 0 : B.querySelector(".editor-input");
      if (!y || F.target !== y) return;
      const $ = (G = h.current) == null ? void 0 : G.getSelection();
      $ && (te.current = $);
    };
    ...
    if (((y = St.view) == null ? void 0 : y.markerMode) === "editable") {
      ...
      return document.addEventListener("keydown", $, { capture: !0 }), document.addEventListener("paste", B, { capture: !0 }), () => {
        document.removeEventListener("keydown", $, { capture: !0 }), document.removeEventListener("paste", B, { capture: !0 });
      };
    }
    const F = ($) => {
      const B = T();
      !J && B && document.activeElement === B && $.key === c ? ($.preventDefault(), _t()) : J && $.key === "Escape" && ($.preventDefault(), et(!1));
    };
    ...
    const T = () => {
      var $, B, G;
      const F = (($ = g.current) == null ? void 0 : $.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const y = document.getSelection();
      y && !y.isCollapsed || Nt() || ((B = h.current) == null || B.selectNote(0), (G = h.current) == null || G.focus());
    };
...
function Xp({
  ...
  const p = d ?? rc(r, void 0), h = (N, P) => {
    w == null || w(N, P, n);
  }, g = i ? r.findIndex((N) => N === i) : -1, [f, v] = _(g), b = (N, P, C) => {
    if (r.length)
      switch (N.key) {
        case "Enter":
        case " ":
    ...
    if (r.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), v((P) => Math.min(P + 1, r.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), v((P) => Math.max(P - 1, 0));
          break;
      }
  }, x = q([]);
  Y(() => {
...
function oh({
  ...
  const g = ye(r, "%webView_inventory_all%"), f = ye(r, "%webView_inventory_approved%"), v = ye(r, "%webView_inventory_unapproved%"), b = ye(r, "%webView_inventory_unknown%"), R = ye(r, "%webView_inventory_scope_currentBook%"), x = ye(r, "%webView_inventory_scope_chapter%"), S = ye(r, "%webView_inventory_scope_verse%"), N = ye(r, "%webView_inventory_filter_text%"), P = ye(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = ye(r, "%webView_inventory_no_results%"), [K, M] = _(!1), [z, H] = _("all"), [W, j] = _(""), [Q, O] = _([]), U = A(() => {
    const tt = t ?? [];
  ...
  }, [K, U]), E = A(() => I.length === 0 ? [] : Jw(I, z, W), [I, z, W]), J = A(() => {
    var ht, mt;
    if (!K) return l;
  ...
  const et = (tt, ct) => {
    ...
    const tt = I.filter((ct) => ac(
      K ? ct.items : [ct.items[0]],
      Q
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(gr, { onValueChange: (tt) => ft(tt), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(vr, { children: [
          ...
          /* @__PURE__ */ a(ge, { value: "chapter", children: x }),
          /* @__PURE__ */ a(ge, { value: "verse", children: S })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ca,
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
        ...
        /* @__PURE__ */ a(Ut, { children: (o == null ? void 0 : o.checkboxText) ?? P })
      ] }) })
    ] }),
...
function eu({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((S) => !S), [p]), g = w ? "expanded" : "collapsed", b = Ce() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function bh({
  ...
  const [d, w] = _([]), [p, h] = _([{ id: Pe, desc: !1 }]), [g, f] = _({}), v = A(
  ...
  Y(() => {
    if (c) {
      ...
      if (H.length === 1) {
        const W = v.find((j) => bn(j) === H[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, v, c, R]);
  const x = n ?? pu, S = i ?? Ai, N = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Pe] },
    ...
    !e && /* @__PURE__ */ u(
      gr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(vr, { position: "item-aligned", children: /* @__PURE__ */ a(uw, { children: N.map((z) => /* @__PURE__ */ a(ge, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ao, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(oo, { children: R.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ve, { children: z.headers.filter((H) => H.column.columnDef.header).map((H) => (
      ...
      /* @__PURE__ */ a(no, { children: R.getRowModel().rows.map((z, H) => {
        const W = Ce();
        return /* @__PURE__ */ a(
          Ve,
          {
            ...
            children: z.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== Ze || !r)))
                return /* @__PURE__ */ a(
                  lr,
                  {
                    className: m(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ u(
                      Z,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(ja, {}) : /* @__PURE__ */ a(La, {})),
                          " ",
...
function mu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: v } = {
  ...
  }, [b, R] = _(!1), [x, S] = _(""), N = q(void 0), P = q(!1), C = A(
    () => Sn(t),
    [t]
  ), K = A(() => {
    if (!x.trim()) {
    ...
    (O, U = !1) => {
      ...
      const I = C.findIndex((ot) => ot === N.current), E = C.findIndex((ot) => ot === O);
      if (I === -1 || E === -1) return;
      const [J, et] = [
        Math.min(I, E),
        Math.max(I, E)
    ...
    O.preventDefault(), M(U, O.shiftKey);
  }, W = () => {
    r(C.map((O) => O));
  }, j = () => {
    r([]);
    ...
    () => Object.values(pt).filter(
      (O) => (i == null ? void 0 : i[O]) !== void 0 && io(C, O).length === 0
              ...
              Ke,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(Z, { variant: "ghost", size: "sm", onClick: j, children: w })
                  ] }),
                  /* @__PURE__ */ u(He, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(sa, { children: p }),
                    Object.values(pt).filter((O) => K[O].length > 0).map((O, U) => {
                      const I = K[O];
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: O, explanation: U }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: U }, O)) })
                ]
              }
            )
          }
...
function yh({
  ...
  const P = Vt(
    s,
    "%webView_scope_selector_selected_text%"
  ), C = Vt(s, "%webView_scope_selector_verse%"), K = Vt(s, "%webView_scope_selector_chapter%"), M = Vt(s, "%webView_scope_selector_book%"), z = Vt(
    s,
    "%webView_scope_selector_current_verse%"
  ), H = Vt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = Vt(s, "%webView_scope_selector_current_book%"), j = Vt(s, "%webView_scope_selector_choose_books%"), Q = Vt(s, "%webView_scope_selector_scope%"), O = Vt(s, "%webView_scope_selector_select_books%"), U = Vt(s, "%webView_scope_selector_range%"), I = Vt(s, "%webView_scope_selector_select_range%"), E = Vt(s, "%webView_scope_selector_range_start%"), J = Vt(s, "%webView_scope_selector_range_end%"), et = Vt(s, "%webView_scope_selector_ok%"), ft = Vt(s, "%webView_scope_selector_cancel%"), ot = Vt(s, "%webView_scope_selector_navigate%"), Mt = (V) => {
    if (!v) return;
  ...
  ], ct = (V, rt, Xt = !1) => /* @__PURE__ */ u(dt, { children: [
    V,
    rt && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      rt
    ] })
  ] }), ht = e ? tt.filter((V) => e.includes(V.value)) : tt, mt = v ?? xa, lt = p ?? mt, Ot = h ?? mt, wt = () => {
  }, ie = q(null), te = q(null), St = q(!1), xt = q(null), Nt = q(!1), [It, vt] = _(void 0), zt = q(!1), D = q(!1), ue = q(null), se = L((V) => {
    if (V) {
    ...
    [r, n, v, i]
  ), re = ht.find((V) => V.value === t), _t = () => t === "selectedBooks" && n.length > 0 ? n.map((V) => V.toUpperCase()).join(", ") : t === "range" ? oc(lt, Ot, {
  ...
  ), $t = ht.find((V) => V.value === "selectedBooks"), At = ht.find((V) => V.value === "range"), [ve, be] = _(!1), [oe, T] = _(void 0), [F, y] = _(void 0), [$, B] = _(void 0), [G, at] = _(void 0), [it, gt] = _([]), bt = w === "dropdown" && oe === "selectedBooks", yt = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-start", className: m(Ct && xe), children: E }),
      /* @__PURE__ */ a(
        ka,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ie, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ka,
        {
          ...
          localizedStrings: R,
          getEndVerse: x,
          disableReferencesUpTo: ne ? $ ?? lt : lt,
          onOpenChange: ce,
          onCloseAutoFocus: (V) => {
            var rt;
            D.current && (D.current = !1, V.preventDefault(), (rt = ue.current) == null || rt.focus());
          },
          className: m(Pt && xe),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    return () => {
      cancelAnimationFrame(rt), V && cancelAnimationFrame(V);
    };
  }, [ve, t]);
  const [Rt, $e] = _(null), [Se, nr] = _(null), [Dt, Et] = _(null), Ht = 200, [kt, le] = _(!1);
  Y(() => {
    if (!Dt || typeof ResizeObserver > "u") return;
    const V = new ResizeObserver(([rt]) => {
  ...
  const he = L(
    (V) => {
      y(V), B(lt), at(Ot), gt(n), be(!1), T(V);
    },
    [lt, Ot, n]
  ), Ae = L(() => {
    F !== void 0 && (F === "range" ? ($ && (g == null || g($)), G && (f == null || f(G))) : F === "selectedBooks" && i(it), pe(F), T(void 0), y(void 0));
  }, [
    F,
    $,
    G,
    ...
    var rt;
    V.preventDefault(), (rt = nt.current) == null || rt.focus();
  }, []), So = (V) => t === V ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !S && /* @__PURE__ */ a(Tt, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(qe, { open: ve, onOpenChange: be, children: [
        ...
        /* @__PURE__ */ a(
          Ye,
          {
            ...
            children: /* @__PURE__ */ u(ma, { container: Dt, children: [
              ae.map(({ value: V, label: rt, dropdownLabel: Xt, scrRefSuffix: xr, id: Hi }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: X(V),
                  ...
                  children: [
                    t === V && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }),
                    ct(Xt ?? rt, xr, kt)
                  ]
                },
                Hi
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (V) => {
                          const rt = V.target instanceof HTMLElement ? V.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          ka,
                          {
                            ...
                            onCloseAutoFocus: (V) => {
                              var rt;
                              V.preventDefault(), (rt = xt.current) == null || rt.focus();
                            },
                            modal: !0,
        ...
        to,
        {
          ...
          children: ht.map(({ value: V, label: rt, scrRefSuffix: Xt, id: xr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: V, id: xr }),
    ...
    w === "dropdown" && $t && /* @__PURE__ */ a(Ia, { open: oe === "selectedBooks", onOpenChange: Ar, children: /* @__PURE__ */ a(
      $a,
      {
        ...
        onCloseAutoFocus: To,
        onEscapeKeyDown: (V) => {
          Se != null && Se.querySelector('[data-state="open"]') && V.preventDefault();
        },
        children: /* @__PURE__ */ u(ma, { container: Se, children: [
          /* @__PURE__ */ a(Aa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Pa, { children: j }) }),
          yt,
    ...
    w === "dropdown" && At && /* @__PURE__ */ a(Ia, { open: oe === "range", onOpenChange: Ar, children: /* @__PURE__ */ a(
      $a,
      {
        ...
        children: /* @__PURE__ */ u(ma, { container: Rt, children: [
          /* @__PURE__ */ a(Aa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Pa, { children: I }) }),
          $r,
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => Ar(!1), children: ft }),
...
function Dh({
  ...
  const d = ju(
    ...
    var R, x, S, N, P, C;
    const b = v !== f ? ((x = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : x[v]) ?? ((N = (S = t[f]) == null ? void 0 : S.uiNames) == null ? void 0 : N.en) : void 0;
    return b ? `${(P = t[f]) == null ? void 0 : P.autonym} (${b})` : (C = t[f]) == null ? void 0 : C.autonym;
  };
