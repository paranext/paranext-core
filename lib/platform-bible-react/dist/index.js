...
var ht = (e, t, n) => ws(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as en, useRef as tt, useMemo as $, useState as M, useCallback as z, useLayoutEffect as Bt, createContext as xn, useContext as hr, useEffect as U, Component as cs, createElement as $r, Suspense as ds, createRef as ps, Fragment as ho } from "react";
import { Command as bt } from "cmdk";
import { X as nn, Search as fo, Check as Ot, Clock as Lr, ChevronsLeft as Br, ChevronsRight as jr, ChevronLeft as Yn, ChevronRight as Ee, ArrowLeft as us, ArrowRight as ms, Circle as yn, ChevronDown as fe, BoldIcon as hs, ItalicIcon as fs, UnderlineIcon as gs, StrikethroughIcon as bs, Pencil as vs, Trash2 as xs, ArrowUp as go, MoreHorizontal as bo, ChevronUp as qn, AtSign as ys, FilterIcon as Ns, ArrowLeftIcon as ks, ChevronLeftIcon as _s, ChevronRightIcon as Cs, ArrowRightIcon as Es, Copy as vo, Filter as Ss, User as Ts, Link as Rs, CircleHelp as Ds, ChevronsUpDown as xo, Star as Ms, FunctionSquare as yo, SquareSigma as No, SquareX as Os, AlertCircle as Jn, CircleCheckIcon as Is, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as Ps, ArrowDownIcon as $s, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as js, ScrollText as zs, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Ks } from "lucide-react";
import { clsx as Us } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as Et from "@radix-ui/react-dialog";
import { includes as wn, Section as G, getChaptersForBook as qs, formatScrRef as de, getSectionForBook as Xe, formatRelativeDate as Js, formatReplacementString as ce, sanitizeHtml as Ws, parseParatextHtml as zr, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as ri, isString as Fr, compareScrRefs as Wn, scrRefToBBBCCCVVV as Vn, getLocalizeKeyForScrollGroupId as q } from "platform-bible-utils";
...
import { createEditor as _o, $getRoot as Jt, $createParagraphNode as Nn, $getSelection as jt, HISTORY_MERGE_TAG as fr, ParagraphNode as Co, TextNode as Eo, $isTokenOrSegmented as oi, $getCharacterOffsets as ai, $cloneWithPropertiesEphemeral as si, $findMatchingParent as ii, $isElementNode as pe, CLEAR_EDITOR_COMMAND as So, COMMAND_PRIORITY_EDITOR as To, $isRangeSelection as We, shallowMergeConfig as li, defineExtension as Ft, safeCast as rn, RootNode as wi, LineBreakNode as ci, TabNode as di, $isEditorState as pi, createCommand as ui, CLICK_COMMAND as mi, isDOMNode as hi, $getNodeFromDOMNode as fi, $isNodeSelection as gi, $createNodeSelection as bi, $setSelection as vi, COMMAND_PRIORITY_LOW as xi, DecoratorNode as yi, $create as Ni, $getNodeByKey as ki, INDENT_CONTENT_COMMAND as Gr, COMMAND_PRIORITY_CRITICAL as gr, KEY_TAB_COMMAND as _i, $createRangeSelection as Ci, $normalizeSelection__EXPERIMENTAL as Ei, OUTDENT_CONTENT_COMMAND as Si, INSERT_TAB_COMMAND as Ti, $isBlockElementNode as hn, $isDecoratorNode as Ri, $isParagraphNode as Di, $isTextNode as fn, SELECTION_CHANGE_COMMAND as Ro, FORMAT_TEXT_COMMAND as Mi, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Hr, isDOMDocumentNode as Ai, ArtificialNode__DO_NOT_USE as Do, $createLineBreakNode as Mo, $isRootOrShadowRoot as Vi, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Pi } from "lexical";
...
import * as Oo from "@radix-ui/react-toggle";
import { createHeadlessEditor as Io } from "@lexical/headless";
import * as Ao from "@radix-ui/react-separator";
...
import { useReactTable as Vo, getFilteredRowModel as Xi, getSortedRowModel as Po, getPaginationRowModel as Ki, getCoreRowModel as $o, flexRender as Ke, getGroupedRowModel as Ui, getExpandedRowModel as Yi } from "@tanstack/react-table";
import * as at from "@radix-ui/react-select";
import qi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Zn, HIDDEN_NOTE_CALLER as Qn, getDefaultViewOptions as Ji, isInsertEmbedOpOfType as Pn, Editorial as Wi } from "@eten-tech-foundation/platform-editor";
...
const nl = Et.Root, rl = Et.Portal, Lo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
    className: h(
...
Lo.displayName = Et.Overlay.displayName;
const Bo = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = dt();
...
Bo.displayName = Et.Content.displayName;
...
zo.displayName = Et.Title.displayName;
...
Fo.displayName = bt.Separator.displayName;
...
Go.displayName = "CommandShortcut";
var al = Object.defineProperty, sl = (e, t, n) => t in e ? al(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, F = (e, t, n) => sl(e, typeof t != "symbol" ? t + "" : t, n);
const ge = [
  "GEN",
  "EXO",
  "LEV",
...
F(xt, "Original", new xt(Dt.Original)), F(xt, "Septuagint", new xt(Dt.Septuagint)), F(xt, "Vulgate", new xt(Dt.Vulgate)), F(xt, "English", new xt(Dt.English)), F(xt, "RussianProtestant", new xt(Dt.RussianProtestant)), F(xt, "RussianOrthodox", new xt(Dt.RussianOrthodox));
let ie = xt;
function Yr(e, t) {
  const n = t[0];
...
const gt = class H {
    ...
    if (F(this, "firstChapter"), F(this, "lastChapter"), F(this, "lastVerse"), F(this, "hasSegmentsDefined"), F(this, "text"), F(this, "BBBCCCVVVS"), F(this, "longHashCode"), F(this, "versification"), F(this, "rtlMark", "‏"), F(this, "_bookNum", 0), F(this, "_chapterNum", 0), F(this, "_verseNum", 0), F(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof H) {
          ...
          if (t == null) return;
          const s = t instanceof ie ? t : H.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new ie(i)), n ? new H(n, r.toString(), l, c) : new H();
  }
  /**
  ...
  set book(t) {
    this.bookNum = J.bookIdToNumber(t);
  }
  /**
  ...
  parse(t) {
    ...
    if (r.length !== 2 || J.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !H.isVerseParseable(r[1]))
      throw new ze("Invalid reference : " + t);
  ...
  updateInternal(t, n, r) {
    this.bookNum = J.bookIdToNumber(t), this.chapter = n, this.verse = r;
  }
};
F(gt, "defaultVersification", ie.English), F(gt, "verseRangeSeparator", "-"), F(gt, "verseSequenceIndicator", ","), F(gt, "verseRangeSeparators", [gt.verseRangeSeparator]), F(gt, "verseSequenceIndicators", [gt.verseSequenceIndicator]), F(gt, "chapterDigitShifter", 1e3), F(gt, "bookDigitShifter", gt.chapterDigitShifter * gt.chapterDigitShifter), F(gt, "bcvMaxValue", gt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
F(gt, "ValidStatusType", qo);
...
function Ce(e, t) {
  var r;
  return ((r = t == null ? void 0 : t.get(e)) == null ? void 0 : r.localizedName) ?? J.bookIdToEnglishName(e);
}
function Nr(e, t) {
  var r;
  return ((r = t == null ? void 0 : t.get(e)) == null ? void 0 : r.localizedId) ?? e.toUpperCase();
}
const Wo = J.allBookIds.filter(
  (e) => !J.isObsolete(J.bookIdToNumber(e))
), ue = Object.fromEntries(
  Wo.map((e) => [e, J.bookIdToEnglishName(e)])
);
function kr(e, t, n) {
  const r = t.trim().toLowerCase();
  if (!r) return !1;
  const a = J.bookIdToEnglishName(e), s = n == null ? void 0 : n.get(e);
    ...
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: c || `${e} ${J.bookIdToEnglishName(e)}`,
            onSelect: m,
            onMouseDown: f,
            role: "option",
            "aria-selected": t,
            "aria-label": `${J.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
            className: s,
            children: [
              i && /* @__PURE__ */ o(
                Ot,
      ...
      if (i) {
        ...
        if (!p && c) {
          const u = ((g) => Object.keys(ue).find(
            (N) => ue[N].toLowerCase() === g.toLowerCase()
          ))(l);
...
function mp({
  ...
  const w = dt(), [p, m] = M(!1), [f, u] = M(""), [g, N] = M(""), [v, T] = M("books"), [x, C] = M(void 0), [E, I] = M(!1), V = tt(void 0), _ = tt(void 0), R = tt(void 0), y = tt(void 0), S = tt({}), P = z(
    (D) => {
      t(D), l && l(D);
    },
    [t, l]
  ), j = $(() => r ? r() : Wo, [r]), Y = $(() => ({
    [G.OT]: j.filter((k) => J.isBookOT(k)),
    [G.NT]: j.filter((k) => J.isBookNT(k)),
    [G.DC]: j.filter((k) => J.isBookDC(k)),
    [G.Extra]: j.filter((k) => J.extraBooks().includes(k))
  }), [j]), A = $(() => Object.values(Y).flat(), [Y]), W = $(() => {
    if (!g.trim()) return Y;
    const D = {
      [G.OT]: [],
      [G.NT]: [],
    ...
    return [G.OT, G.NT, G.DC, G.Extra].forEach((X) => {
      D[X] = Y[X].filter((st) => kr(st, g, a));
    }), D;
  }, [Y, g, a]), O = $(
    () => yl(g, A, a),
    [g, A, a]
    ...
    (D) => {
      const k = v === "chapters" ? x : O == null ? void 0 : O.book;
      k && (P({
        book: k,
        chapterNum: D,
        verseNum: 1
      }), m(!1), T("books"), C(void 0), N(""));
    },
    [P, v, x, O]
  ), _t = z(
    (D) => {
    ...
    (D) => {
      ...
      m(D), D && (T("books"), C(void 0), N(""));
    },
    [v, Ct]
  ), { otLong: ot, ntLong: wt, dcLong: pt, extraLong: mt } = {
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: k, isDigit: X } = qr(D.key);
      if (v === "chapters") {
        if (D.key === "Backspace") {
          D.preventDefault(), D.stopPropagation(), Ct();
          return;
        }
        if (k || X) {
          if (D.preventDefault(), D.stopPropagation(), T("books"), C(void 0), X && x) {
            const st = ue[x];
            N(`${st} ${D.key}`);
          } else
            N(D.key);
      ...
      if ((v === "chapters" || v === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const st = v === "chapters" ? x : O == null ? void 0 : O.book;
        if (!st) return;
        const ut = (() => {
          if (!f) return 1;
          const je = f.match(/(\d+)$/);
        ...
        switch (D.key) {
          case "ArrowLeft":
            ut !== 0 && (Vt = ut > 1 ? ut - 1 : ae);
            break;
          case "ArrowRight":
            ut !== 0 && (Vt = ut < ae ? ut + 1 : 1);
            break;
          case "ArrowUp":
            Vt = ut === 0 ? ae : Math.max(1, ut - Pr);
            break;
          case "ArrowDown":
            Vt = ut === 0 ? 1 : Math.min(ae, ut + Pr);
            break;
          default:
            return;
        }
        Vt !== ut && (D.preventDefault(), D.stopPropagation(), u(rr(st, a, Vt)), setTimeout(() => {
    ...
    const { isLetter: k, isDigit: X } = qr(D.key);
    (k || X) && (D.preventDefault(), N((st) => st + D.key), _.current.focus(), I(!1));
  }, []);
  return Bt(() => {
    const D = setTimeout(() => {
      if (p && v === "books" && R.current && y.current) {
        const k = R.current, X = y.current, st = X.offsetTop, ut = k.clientHeight, ae = X.clientHeight, Vt = st - ut / 2 + ae / 2;
        k.scrollTo({
          top: Math.max(0, Vt),
          behavior: "smooth"
        }), u(rr(e.book));
  ...
  }, [v, x, O, e.book, e.chapterNum]), /* @__PURE__ */ d(xe, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: lt.map(({ onClick: D, disabled: k, title: X, icon: st }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            x && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Ce(x, a) })
          ] }),
          !E && /* @__PURE__ */ d(ee, { ref: R, children: [
            v === "books" && /* @__PURE__ */ d(it, { children: [
              !O && Object.entries(W).map(([D, k]) => {
                if (k.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(zt, { heading: yt(D), children: k.map((X) => /* @__PURE__ */ o(
                      Zo,
                      {
                        bookId: X,
                        onSelect: (st) => kt(st),
              ...
              O && /* @__PURE__ */ o(zt, { children: /* @__PURE__ */ o(
                Gt,
                {
                  ...
                  children: de(
                    ...
                    a ? Nr(O.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              O && Mt(O.book) > 1 && /* @__PURE__ */ d(it, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(O.book, a) }),
                /* @__PURE__ */ o(
                  Jr,
                  {
                    bookId: O.book,
...
), ct = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(ko.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
ct.displayName = ko.Root.displayName;
...
const gn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Je.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(Je.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(yn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
gn.displayName = Je.Item.displayName;
function _l(e) {
...
function or({
  ...
  const [x, C] = M(!1), E = c ?? l, I = (_) => _.length > 0 && typeof _[0] == "object" && "options" in _[0], V = (_, R) => {
    const y = l(_), S = typeof _ == "object" && "secondaryLabel" in _ ? _.secondaryLabel : void 0, P = `${R ?? ""}${y}${S ?? ""}`;
    return /* @__PURE__ */ d(
      Gt,
      {
        value: y,
  ...
  return /* @__PURE__ */ d(xe, { open: x, onOpenChange: C, ...T, children: [
    ...
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ o(ee, { children: I(t) ? t.map((_) => /* @__PURE__ */ o(zt, { heading: _.groupHeading, children: _.options.map((R) => V(R, _.groupHeading)) }, _.groupHeading)) : t.map((_) => V(_)) })
        ] })
      }
    )
  ] });
...
function gp({
  ...
  const p = Ln(w, "%webView_bookSelector_currentBook%"), m = Ln(w, "%webView_bookSelector_choose%"), f = Ln(w, "%webView_bookSelector_chooseBooks%"), [u, g] = M(
    "current book"
    /* CURRENT_BOOK */
  ), N = (v) => {
    g(v), e(v);
    ...
    _r,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ o(ct, { className: "tw-flex tw-items-center", children: r.map((v) => J.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ o(
            L,
            {
...
const bp = [
  ...
  const a = tt(null), [s, i] = M(void 0), [l, c] = M(void 0), w = z(
    (u) => {
      i(u);
    ...
    if (N && Tl.includes(N)) return !0;
    const v = u.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, f = z(
    (u) => {
      var _;
      const g = u.target, N = (R) => R ? document.getElementById(R) : void 0, v = N(l), T = N(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const R = e.find((y) => y.id === l);
            R && w(R.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const y = R.findIndex((P) => P === g);
          if (y === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(y + 1, R.length - 1) : S = Math.max(y - 1, 0), S !== y && (u.preventDefault(), u.stopPropagation(), (_ = R[S]) == null || _.focus());
          return;
        }
        return;
      }
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ta ? Bt : U, cn = { tag: fr };
function Ol({ initialConfig: e, children: t }) {
  const n = $(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Dl(null, r), p = _o({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Nn();
            u.append(g);
            const N = ta ? document.activeElement : null;
            (jt() !== null || N !== null && N === m.getRootElement()) && g.select();
          }
        }, cn);
...
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, $t = on.Provider, Ut = on.Root, me = on.Trigger, Lt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  on.Content,
  {
    ref: r,
    sideOffset: t,
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = It(), n = $(() => e(t), [t, e]), [r, a] = M(() => n.initialValueFn()), s = tt(r);
    return Bl(() => {
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !oi(t) && r !== null) {
    ...
    if (w || p) {
      const [m, f] = ai(e), u = l.is(c), g = t.is(i ? c : l), N = t.is(i ? l : c);
      let v, T = 0;
      u ? (T = m > f ? f : m, v = m > f ? m : f) : g ? (T = i ? f : m, v = void 0) : N && (T = 0, v = i ? m : f);
      const x = t.__text.slice(T, v);
      x !== t.__text && (n === "clone" && (t = si(t)), t.__text = x);
    }
  }
  return t;
}
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = ea && "documentMode" in document ? document.documentMode : null;
!(!ea || !("InputEvent" in window) || Hl) && "getTargetRanges" in new window.InputEvent("input");
function na(...e) {
  const t = [];
...
function le(e, t) {
  ft.call(this, void 0), this.x = e, this.s = void 0, this.g = un - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function ql(e, t) {
  return new le(e, t);
}
...
function Sr(e) {
  ...
  e.x = void 0, e.s = void 0, sa(e);
}
function Jl(e) {
  if (K !== this) throw new Error("Out-of-order effect");
  aa(this), K = e, this.f &= -2, 8 & this.f && Sr(this), _n();
}
function _e(e, t) {
...
ft.prototype.brand = Ul, ft.prototype.h = function() {
  ...
  if (this.g = un, this.f |= 1, this.i > 0 && !oa(this)) return this.f &= -2, !0;
  const e = K;
  try {
    to(this), K = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, sa(this), to(this), Yt++;
  const e = K;
...
Ft({ build: (e, t, n) => Cn(t), config: rn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function ia() {
  const e = Jt(), t = jt(), n = Nn();
  e.clear(), e.append(n), t !== null && n.select(), We(t) && (t.format = 0);
}
function la(e, t = ia) {
  return e.registerCommand(So, (n) => (e.update(t), !0), To);
}
Ft({ build: (e, t, n) => Cn(t), config: rn({ $onClear: ia }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Zt(() => la(e, r.value));
} });
function Wl(e) {
...
const sr = Ft({ build: (e) => wa(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function ca(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = ca(n[a], r[a]);
    return e;
  }
  return t;
}
const Tr = 0, ir = 1, da = 2, jn = 3, dn = 4, ke = 5, zn = 6, Fe = 7;
function Fn(e) {
  return e.id === Tr;
}
function pa(e) {
...
function Zl(e) {
  return function(t) {
    return t.id === ir;
  }(e) || Q(305, String(e.id), String(ir)), Object.assign(e, { id: da });
}
...
class tw {
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== dn && Q(307, String(n.id), String(ke)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= dn;
    }(t) || Q(313, String(t.id), String(dn)), t.initResult;
  }
  getInitPeer(t) {
...
}, name: "@lexical/extension/InitialState", nodes: [wi, Eo, ci, di, Co] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function rw(e) {
  throw e;
...
class Ye {
  ...
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(_o({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [no]: this });
...
const ow = /* @__PURE__ */ new Set(), oo = Ft({ build(e, t, n) {
  const r = n.getDependency(sr).output, a = Ze({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = wa(() => {
  }, () => Zt(() => {
...
Ft({ dependencies: [sr, oo], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
...
function iw(e, t) {
  return Wt(e.registerCommand(_i, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Kl(i, (f) => hn(f) && f.canIndent() ? f : null).length > 0) return !0;
...
Ft({ build: (e, t, n) => Cn(t), config: rn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (We(g)) {
                const N = g.anchor;
                let v = N.getNode(), T = 0, x = 0;
                if (fn(v) && w >= 0 && p >= 0 && (T = w, x = w + p, g.setTextNodeRange(v, T, v, x)), T === x && m === "" || (g.insertRawText(m), v = N.getNode()), fn(v)) {
                  T = f, x = f + u;
                  const C = v.getTextContentSize();
                  T = T > C ? C : T, x = x > C ? C : x, g.setTextNodeRange(v, T, v, x);
                }
...
Ft({ build: (e, t, n) => Cn(t), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Zt(() => n.getOutput().disabled.value ? void 0 : ha(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Rr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
  ...
  return function(n, r) {
    ...
    return Rr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (f) => n._onError(f), children: o(ds, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
...
function ao(e) {
  return e.getEditorState().read(ma(e.isComposing()));
}
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
function vw({ onClear: e }) {
  const [t] = It();
  return bw(() => la(t, e), [t, e]), null;
}
const fa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: N, role: v = "textbox", spellCheck: T = !0, style: x, tabIndex: C, "data-testid": E, ...I }, V) {
  const [_, R] = M(e.isEditable()), y = z((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? e.setRootElement(P) : e.setRootElement(null);
  }, [e]), S = $(() => /* @__PURE__ */ function(...P) {
    return (j) => {
      for (const Y of P) typeof Y == "function" ? Y(j) : Y != null && (Y.current = j);
    };
  }(V, y), [y, V]);
  return fa(() => (R(e.isEditable()), e.registerEditableListener((P) => {
    R(P);
  })), [e]), o("div", { "aria-activedescendant": _ ? t : void 0, "aria-autocomplete": _ ? n : "none", "aria-controls": _ ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": _ && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": _ ? m : void 0, "aria-readonly": !_ || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: _, "data-testid": E, id: N, ref: S, role: v, spellCheck: T, style: x, tabIndex: C, ...I });
}
const yw = en(xw);
function so(e) {
  return e.getEditorState().read(ma(e.isComposing()));
...
function Ew({
  ...
  return /* @__PURE__ */ o(ga.Provider, { value: i, children: s });
}
function ba() {
  const e = hr(ga);
  if (!e)
...
function Sw() {
  const [e, t] = M(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(nl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Bo, { children: [
      /* @__PURE__ */ o(jo, { children: /* @__PURE__ */ o(zo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Tw({
  ...
  const [t] = It(), [n, r] = M(t), [a, s] = M("paragraph"), [i, l] = Sw(), c = () => {
  };
...
const va = Qt(
  ...
  {
    ref: a,
    className: h(va({ variant: t, size: n, className: e })),
    ...r
  }
));
Dw.displayName = Oo.Root.displayName;
...
qe.displayName = kn.Item.displayName;
const io = [
...
function Mw() {
  const { activeEditor: e } = ba(), [t, n] = M([]), r = z((a) => {
    if (We(a) || Gi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function Vw(e, t) {
  ...
  let r = [];
  const a = [];
  for (const s of n) if (!Na.has(s.nodeName)) {
    const i = ka(s, e, a, !1);
    i !== null && (r = r.concat(i));
  }
  return function(s) {
...
function ya(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], N = ya(e, g, f, r);
    !a && pe(t) && N && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
...
const Na = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function ka(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Na.has(e.nodeName)) return i;
  let l = null;
  const c = function(g, N) {
    const { nodeName: v } = g, T = N._htmlConversions.get(v.toLowerCase());
    let x = null;
    if (T !== void 0) for (const C of T) {
      const E = C(g);
      E !== null && (x === null || (x.priority || 0) <= (E.priority || 0)) && (x = E);
    }
  ...
  for (let g = 0; g < m.length; g++) f.push(...ka(m[g], t, n, u, new Map(a), l));
  return p != null && (f = p(f)), Xr(e) && (f = $w(e, f, u ? () => {
    const g = new Do();
    return n.push(g), g;
  } : Nn)), l == null ? f.length > 0 ? i = i.concat(f) : Xr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Kr(g.nextSibling) && Kr(g.previousSibling);
  }(e) && (i = i.concat(Mo())) : pe(l) && l.append(...f), i;
}
function $w(e, t, n) {
...
function Bw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Io({
...
De.displayName = Ao.Root.displayName;
...
Sa.displayName = Ae.Root.displayName;
...
Ta.displayName = Ae.Fallback.displayName;
const Mr = xn(void 0);
function Tt() {
  const e = hr(Mr);
  if (!e)
...
}), $e = et.Trigger, Ra = et.Group, Kw = et.Portal, Uw = et.Sub, Yw = et.RadioGroup;
...
Da.displayName = et.SubTrigger.displayName;
...
qt.displayName = et.CheckboxItem.displayName;
const Oa = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Tt();
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
...
Oa.displayName = et.RadioItem.displayName;
...
function lo({
  ...
  const [m, f] = M(!1), [u, g] = M(), [N, v] = M(!1), T = tt(null);
  U(() => {
    let y = !0;
    if (!r) {
      v(!1);
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Sa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ta, { className: "tw-text-xs tw-font-medium", children: V }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), x()) : y.key === "Enter" && y.shiftKey && (y.preventDefault(), y.stopPropagation(), Xt(u) && C());
              },
              onKeyDown: (y) => {
                _a(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  lr,
        ...
        R && /* @__PURE__ */ d(Ne, { children: [
          ...
          /* @__PURE__ */ o(re, { align: "end", children: R })
        ] })
      ]
    }
  );
...
function Jw({
  ...
  const [x, C] = M(wo), [E, I] = M(!1), [V, _] = M(!1), [R, y] = M(!1), [S, P] = M(!1), [j, Y] = M(!1), [A, W] = M(void 0), [O, Z] = M(!1), [kt, At] = M(!1);
  U(() => {
    let k = !0;
    if (!r) {
      Z(!1), At(!1);
    ...
    return (async () => {
      const st = N ? await N(c) : !1;
      if (!k) return;
      const ut = v ? await v(c) : !1;
      k && (Z(st), At(ut));
    })(), () => {
      k = !1;
    };
  }, [r, c, N, v]);
  const _t = $(() => t.filter((k) => !k.deleted), [t]), lt = $(() => _t[0], [_t]), Ct = tt(null), B = tt(void 0), ot = z(() => {
    var k;
    (k = B.current) == null || k.call(B), C(wo);
  }, []);
  U(() => {
    const k = Ct.current;
    if (!k) return;
  ...
  const wt = $(
  ...
  }, [s, n]), mt = $(() => _t.slice(1), [_t]), yt = $(() => mt.length ?? 0, [mt.length]), Mn = $(() => yt > 0, [yt]), On = $(() => R || yt <= 2 ? mt : mt.slice(-2), [mt, yt, R]), oe = $(() => R || yt <= 2 ? 0 : yt - 2, [yt, R]), In = $(
    () => yt === 1 ? wt.singleReply : ce(wt.multipleReplies, { count: yt }),
    [yt, wt]
  ), An = $(
    () => oe === 1 ? wt.singleReply : ce(wt.multipleReplies, { count: oe }),
    [oe, wt]
  ), ln = z(async () => {
    const k = Xt(x) ? wr(x) : void 0;
    if (A !== void 0) {
      await p({
        threadId: c,
        contents: k,
    ...
    k && await p({ threadId: c, contents: k }) && ot();
  }, [ot, x, p, A, c]), D = z(
    async (k) => {
      const X = Xt(x) ? wr(x) : void 0, st = await p({
        ...k,
        contents: X,
        assignedUser: A ?? k.assignedUser
      });
      return st && X && ot(), st && A !== void 0 && W(void 0), st;
    },
    [ot, x, p, A]
  );
  return /* @__PURE__ */ o(
    Ca,
    {
      ...
      children: /* @__PURE__ */ d(Ea, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          pt && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: pt }),
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            V && /* @__PURE__ */ o(
              L,
              {
                ...
                "aria-label": E ? "Collapse text" : "Expand text",
                children: E ? /* @__PURE__ */ o(qn, {}) : /* @__PURE__ */ o(fe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
        ...
        /* @__PURE__ */ d(it, { children: [
          Mn && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          r && /* @__PURE__ */ d(it, { children: [
            oe > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                onClick: (k) => {
                  k.stopPropagation(), y(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (k) => {
                  (k.key === "Enter" || k.key === " ") && (k.preventDefault(), k.stopPropagation(), y(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    R ? /* @__PURE__ */ o(qn, {}) : /* @__PURE__ */ o(fe, {})
                  ] })
                ]
              }
            ),
            On.map((k) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              lo,
              {
                comment: k,
                localizedStrings: n,
            ...
            g !== !1 && (!S || Xt(x)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (k) => {
                  k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), (Xt(x) || A !== void 0) && ln());
                },
                onKeyDown: (k) => {
                  _a(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    lr,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    A !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ce(
                    ...
                    /* @__PURE__ */ d(xe, { open: j, onOpenChange: Y, children: [
                      /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !O || !u || u.length === 0 || !u.includes(i),
                      ...
                      /* @__PURE__ */ o(
                        ne,
                        {
                          ...
                          align: "end",
                          onKeyDown: (k) => {
                            k.key === "Escape" && (k.stopPropagation(), Y(!1));
                          },
                          children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: u == null ? void 0 : u.map((k) => /* @__PURE__ */ o(
                            Gt,
                            {
                              onSelect: () => {
                                W(k !== s ? k : void 0), Y(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: mn(k, n) })
                            },
                            k || "unassigned"
                          )) }) })
                        }
...
function vp({
  ...
  const [u, g] = M(), N = n.filter(
    (_) => _.comments.some((R) => !R.deleted)
  ), v = N.map((_) => ({
    id: _.id
  })), T = z((_) => {
    g(_.id);
    ...
    g(_);
  }, []), { listboxRef: C, activeId: E, handleKeyDown: I } = Rl({
    options: v,
    onOptionSelect: T
  }), V = z(
    (_) => {
      _.key === "Escape" ? (g(void 0), _.preventDefault(), _.stopPropagation()) : I(_);
    },
    [I]
  );
  return /* @__PURE__ */ o(
...
Ia.displayName = at.ScrollUpButton.displayName;
...
Aa.displayName = at.ScrollDownButton.displayName;
...
const Nt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  at.Item,
  {
    ref: r,
    className: h(
...
Nt.displayName = at.Item.displayName;
      ...
      /* @__PURE__ */ d(
        Me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o(ve, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(Nt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
function wc({
  ...
  var V;
  const [p, m] = M([]), [f, u] = M([]), [g, N] = M({}), [v, T] = M({}), x = $(() => t ?? [], [t]), C = Vo({
    data: x,
    columns: e,
    getCoreRowModel: $o(),
  ...
  let I;
  return c ? I = Array.from({ length: 10 }).map((y, S) => `skeleton-row-${S}`).map((y) => /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(he, { colSpan: E.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((V = C.getRowModel().rows) == null ? void 0 : V.length) > 0 ? I = C.getRowModel().rows.map((_) => /* @__PURE__ */ o(
    Pt,
    {
      onClick: () => i(_, C),
      "data-state": _.getIsSelected() && "selected",
      children: _.getVisibleCells().map((R) => /* @__PURE__ */ o(he, { children: Ke(R.column.columnDef.cell, R.getContext()) }, R.id))
    },
    _.id
  )) : I = /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: C }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Sn, { stickyHeader: s, children: C.getHeaderGroups().map((_) => /* @__PURE__ */ o(Pt, { children: _.headers.map((R) => /* @__PURE__ */ o(tn, { children: R.isPlaceholder ? void 0 : Ke(R.column.columnDef.header, R.getContext()) }, R.id)) }, _.id)) }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    ...
    /* @__PURE__ */ o(re, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Ra, { children: w.itemType === 0 ? /* @__PURE__ */ o(it, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        qt,
        {
          checked: r[p][f],
        ...
        Yw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Oa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(Le, {})
    ] }, w.label)) })
...
function mc({
  ...
  const [T, x] = M(!1), C = z(
    (S) => {
      var j;
      const P = (j = e.find((Y) => Y.label === S)) == null ? void 0 : j.value;
      P && n(
        t.includes(P) ? t.filter((Y) => Y !== P) : [...t, P]
      );
    },
    [e, t, n]
  ), E = () => c || r, I = $(() => {
    if (!f) return e;
    const S = e.filter((j) => j.starred).sort((j, Y) => j.label.localeCompare(Y.label)), P = e.filter((j) => !j.starred).sort((j, Y) => {
      const A = t.includes(j.value), W = t.includes(Y.value);
      return A && !W ? -1 : !A && W ? 1 : j.label.localeCompare(Y.label);
    });
    return [...S, ...P];
  }, [e, t, f]), V = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(xe, { open: R, onOpenChange: p ?? x, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: N,
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      /* @__PURE__ */ d(ee, { children: [
        ...
        /* @__PURE__ */ o(zt, { children: I.map((S) => /* @__PURE__ */ d(
          Gt,
          {
            value: S.label,
            onSelect: C,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Ms, { className: "tw-h-4 tw-w-4" }),
...
function fc({
  ...
  const s = tt(null), i = tt(null), l = tt(!1), [c, w] = M(e), [p, m] = M(n), [f, u] = M(!1);
  U(() => {
    w(e);
  }, [e]), U(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var T, x, C, E;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = s.current) == null || T.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((x = i.current) == null || x.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((E = i.current) == null || E.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Ut, { children: [
...
function vc({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    ...
    e !== "x" && /* @__PURE__ */ d(re, { className: "tw-z-[300]", children: [
...
function Sp({
  ...
  const c = tt(null), w = ps(), [p, m] = M("generated"), [f, u] = M("*"), [g, N] = M("f"), v = $(
    () => ({
      ...i,
  ...
  U(() => {
    ...
    var V, _;
    let E;
    const I = t == null ? void 0 : t.at(0);
    if (I && Pn("note", I)) {
      const R = (V = I.insert.note) == null ? void 0 : V.caller;
      let y = "custom";
      R === Zn ? y = "generated" : R === Qn ? y = "hidden" : R && u(R), m(y), N(((_ = I.insert.note) == null ? void 0 : _.style) ?? "f"), I.insert.note && (I.insert.note.caller = ""), E = setTimeout(() => {
        var S;
        (S = c.current) == null || S.applyUpdate([{ delete: 1 }, I]);
      }, 0);
    }
    return () => {
      E && clearTimeout(E);
  ...
  const T = z(() => {
    var I, V;
    const E = (V = (I = c.current) == null ? void 0 : I.getNoteOps(0)) == null ? void 0 : V.at(0);
    E && Pn("note", E) && (E.insert.note && (p === "custom" ? E.insert.note.caller = f : E.insert.note.caller = p === "generated" ? Zn : Qn), n([E]));
  }, [p, f, n]), x = () => {
    var I;
    const E = (I = w.current) == null ? void 0 : I.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
        ...
        /* @__PURE__ */ o(
          vc,
          {
            ...
            handleNoteTypeChange: (E) => {
              var V, _, R;
              N(E);
              const I = (_ = (V = c.current) == null ? void 0 : V.getNoteOps(0)) == null ? void 0 : _.at(0);
              I && Pn("note", I) && (I.insert.note && (I.insert.note.style = E), (R = c.current) == null || R.applyUpdate([{ delete: 1 }, I]));
            },
            localizedStrings: l
          }
        ),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ o("div", { className: e, children: /* @__PURE__ */ o(Wi, { options: v, onScrRefChange: () => {
          }, scrRef: a, ref: c }) }),
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Ut, { children: [
            /* @__PURE__ */ o(me, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: x, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
  ...
  return /* @__PURE__ */ d(it, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(it, { children: xc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Rp({
  ...
  const p = c ?? ni(n, void 0), m = (x, C) => {
    w == null || w(x, C, a);
  }, f = s ? n.findIndex((x) => x === s) : -1, [u, g] = M(f), N = (x, C, E) => {
    if (n.length)
      switch (x.key) {
        case "Enter":
        case " ":
          x.preventDefault(), w == null || w(C, E, a);
          break;
      }
  }, v = (x) => {
    if (n.length)
  ...
  return U(() => {
    var x;
    u >= 0 && u < T.current.length && ((x = T.current[u]) == null || x.focus());
  }, [u]), /* @__PURE__ */ o(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((x, C) => {
            ...
            return /* @__PURE__ */ d(it, { children: [
              ...
              C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(De, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function _c({
  ...
  return /* @__PURE__ */ d(En, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Sn, { stickyHeader: !0, children: /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ o(tn, { children: a }),
      /* @__PURE__ */ o(tn, { children: s })
    ] }) }),
    /* @__PURE__ */ o(Tn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Pt,
      {
        onClick: () => {
          t(l.reference);
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Dp = (e) => ({
  accessorKey: "item",
...
function $p({
  ...
  const u = Rt(n, "%webView_inventory_all%"), g = Rt(n, "%webView_inventory_approved%"), N = Rt(n, "%webView_inventory_unapproved%"), v = Rt(n, "%webView_inventory_unknown%"), T = Rt(n, "%webView_inventory_scope_currentBook%"), x = Rt(n, "%webView_inventory_scope_chapter%"), C = Rt(n, "%webView_inventory_scope_verse%"), E = Rt(n, "%webView_inventory_filter_text%"), I = Rt(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Rt(n, "%webView_inventory_no_results%"), [_, R] = M(!1), [y, S] = M("all"), [P, j] = M(""), [Y, A] = M([]), W = $(() => {
    const B = e ?? [];
    ...
    const B = [];
    return W.forEach((ot) => {
      const wt = ot.items[0], pt = B.find(
        (mt) => mt.items[0] === wt
      );
      pt ? (pt.count += ot.count, pt.occurrences = pt.occurrences.concat(ot.occurrences)) : B.push({
        items: [wt],
        count: ot.count,
  ...
  }, [_, W]), Z = $(() => O.length === 0 ? [] : Sc(O, y, P), [O, y, P]), kt = $(() => {
    var wt, pt;
    if (!_) return c;
    ...
    for (let mt = 0; mt < B; mt++)
      ot.push(
        Cc(
          ((pt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : pt[mt]) || "Additional Item",
          mt + 1
        )
      );
    return [...ot, ...c];
  }, [r == null ? void 0 : r.tableHeaders, c, _]);
  U(() => {
    Z.length === 0 ? A([]) : Z.length === 1 && A(Z[0].items);
  }, [Z]);
  const At = (B, ot) => {
    ot.setRowSelection(() => {
      const pt = {};
    ...
    const B = O.filter((ot) => ri(
      _ ? ot.items : [ot.items[0]],
      Y
    ));
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        Me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(Nt, { value: "all", children: u }),
              /* @__PURE__ */ o(Nt, { value: "approved", children: g }),
              /* @__PURE__ */ o(Nt, { value: "unapproved", children: N }),
              /* @__PURE__ */ o(Nt, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Me, { onValueChange: (B) => _t(B), defaultValue: i, children: [
        ...
        /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(Nt, { value: "book", children: T }),
          /* @__PURE__ */ o(Nt, { value: "chapter", children: x }),
          /* @__PURE__ */ o(Nt, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Be,
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(ct, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? I })
      ] })
    ] }),
      ...
      /* @__PURE__ */ o(zt, { children: a.map((s) => /* @__PURE__ */ d(
        Gt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Go, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const $a = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), m = t ?? w, f = b.useCallback(
      (C) => {
        const E = typeof C == "function" ? C(m) : C;
        n ? n(E) : p(E);
      },
      [n, m]
    ), u = b.useCallback(() => f((C) => !C), [f]), g = m ? "expanded" : "collapsed", T = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o(Pa.Provider, { value: x, children: /* @__PURE__ */ o($t, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
    ...
    La,
    {
      ...
      children: /* @__PURE__ */ d(ja, { children: [
        /* @__PURE__ */ d(dr, { children: [
          ...
          /* @__PURE__ */ o(ur, { children: /* @__PURE__ */ o(za, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Fa, { children: /* @__PURE__ */ o(
            Ga,
            {
              onClick: () => w(f),
              isActive: m(f),
...
const Kt = "scrBook", Kc = "scrRef", we = "source", Uc = "details", Yc = "Scripture Reference", qc = "Scripture Book", Ha = "Type", Jc = "Details";
function Wc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? J.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Kt ? de(a.start) : void 0;
      },
      getGroupingValue: (r) => J.bookIdToNumber(r.start.book),
...
const Zc = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Wn(e.start, e.end) === 0 ? `${Vn(e.start)}+${t}` : `${Vn(e.start)}+${t}-${Vn(e.end)}+${n}`;
...
function zp({
  ...
  const [w, p] = M([]), [m, f] = M([{ id: Kt, desc: !1 }]), [u, g] = M({}), N = $(
  ...
  U(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const P = N.find((j) => uo(j) === S[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, N, l, T]);
  const x = a ?? qc, C = s ?? Ha, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${x}`, value: [Kt] },
  ...
  }, _ = (y, S) => y.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), R = (y, S, P) => {
    if (!((y == null ? void 0 : y.length) === 0 || S.depth < P.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ve, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: E.map((y) => /* @__PURE__ */ o(Nt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Sn, { children: T.getHeaderGroups().map((y) => /* @__PURE__ */ o(Pt, { children: y.headers.filter((S) => S.column.columnDef.header).map((S) => (
      ...
      /* @__PURE__ */ o(Tn, { children: T.getRowModel().rows.map((y, S) => {
        const P = dt();
        return /* @__PURE__ */ o(
          Pt,
          {
            ...
            children: y.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== we || !n)))
                return /* @__PURE__ */ o(
                  he,
                  {
                    className: h(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(Yn, {})),
                          " ",
                          Ke(j.column.columnDef.cell, j.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
}), Xa = (e, t, n) => Vr(e, t).every((r) => n.includes(r));
function Qc({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
...
function td({
  ...
  }, [v, T] = M(!1), [x, C] = M(""), E = tt(void 0), I = tt(!1);
  if (e.length !== J.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const V = $(() => J.allBookIds.filter(
    (A, W) => e[W] === "1" && !J.isObsolete(J.bookIdToNumber(A))
  ), [e]), _ = $(() => {
    if (!x.trim()) {
      const O = {
        [G.OT]: [],
    ...
    (A, W = !1) => {
      if (!W || !E.current) {
        n(
          t.includes(A) ? t.filter((lt) => lt !== A) : [...t, A]
        ), E.current = A;
        return;
      }
      const O = V.findIndex((lt) => lt === E.current), Z = V.findIndex((lt) => lt === A);
      if (O === -1 || Z === -1) return;
      const [kt, At] = [
        Math.min(O, Z),
        Math.max(O, Z)
      ], _t = V.slice(kt, At + 1).map((lt) => lt);
      n(
        t.includes(A) ? t.filter((lt) => !_t.includes(lt)) : [.../* @__PURE__ */ new Set([...t, ..._t])]
      );
    },
    [t, n, V]
  ), y = (A) => {
    R(A, I.current), I.current = !1;
  }, S = (A, W) => {
    A.preventDefault(), R(W, A.shiftKey);
  }, P = z(
    (A) => {
      const W = Vr(V, A).map((O) => O);
      n(
        Xa(V, A, t) ? t.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...t, ...W])]
      );
    },
    [t, n, V]
  ), j = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
            ...
            te,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: j, children: c }),
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: Y, children: w })
                ] }),
                /* @__PURE__ */ d(ee, { children: [
                  /* @__PURE__ */ o(an, { children: p }),
                  Object.values(G).map((A, W) => {
                    const O = _[A];
                    if (O.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        /* @__PURE__ */ o(
                          zt,
                          {
                            heading: Jo(A, f, u, g, N),
                            children: O.map((Z) => /* @__PURE__ */ o(
                              Zo,
                              {
                                bookId: Z,
                                isSelected: t.includes(Z),
                                onSelect: () => y(Z),
                                onMouseDown: (kt) => S(kt, Z),
                                section: Xe(Z),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: rr(Z, a),
                        ...
                        W < Object.values(G).length - 1 && /* @__PURE__ */ o(Fo, {})
                      ] }, A);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Xn ? Xn : mo
      ).map((A) => /* @__PURE__ */ o(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(A, a) }, A)),
...
function Gp({
  ...
  const w = se(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = se(i, "%webView_scope_selector_current_book%"), u = se(i, "%webView_scope_selector_choose_books%"), g = se(i, "%webView_scope_selector_scope%"), N = se(i, "%webView_scope_selector_select_books%"), v = [
  ...
  ], T = t ? v.filter((x) => t.includes(x.value)) : v;
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        _r,
        {
          ...
          children: T.map(({ value: x, label: C, id: E }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(gn, { className: "tw-me-2", value: x, id: E }),
            /* @__PURE__ */ o(ct, { htmlFor: E, children: C })
          ] }, E))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(ct, { children: N }),
      /* @__PURE__ */ o(
        td,
        {
          availableBookInfo: r,
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          ve,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(Nt, { value: `${w}`, children: l[q(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ua = (e, t, n, r) => n ? Object.entries(e).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ d(Ut, { children: [
  /* @__PURE__ */ o(me, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ o(Kw, { children: /* @__PURE__ */ o(Ma, { children: Ua(
      e,
      t,
      Ka(e, l.id),
      r
...
function mr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    ...
    /* @__PURE__ */ o(re, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
      /* @__PURE__ */ o(Ra, { children: /* @__PURE__ */ o($t, { children: Ua(t.groups, t.items, c, e) }) }),
...
qa.displayName = vt.List.displayName;
...
Ja.displayName = vt.List.displayName;
...
Wa.displayName = vt.Content.displayName;
function Jp({
  tabList: e,
  searchValue: t,
  onSearch: n,
...
Za.displayName = nt.Root.displayName;
const Qa = b.forwardRef(({ className: e, ...t }, n) => {
  const r = Tt();
  return /* @__PURE__ */ o(
    nt.Trigger,
...
Qa.displayName = nt.Trigger.displayName;
...
ts.displayName = nt.SubTrigger.displayName;
...
es.displayName = nt.SubContent.displayName;
...
rs.displayName = nt.Item.displayName;
...
os.displayName = nt.Separator.displayName;
const Ge = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(Ut, { children: [
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (N = i.current) == null || N.focus(), Ge(i, [f, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ o(Za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(nd, { children: [
      /* @__PURE__ */ o(Qa, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ns,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o($t, { children: as(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function Qp({
  ...
  const w = ld(
    ...
    var T, x, C, E, I, V;
    const v = N !== g ? ((x = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : x[N]) ?? ((E = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return v ? `${(I = e[g]) == null ? void 0 : I.autonym} (${v})` : (V = e[g]) == null ? void 0 : V.autonym;
  };
...
const cd = en(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
const wu = St.Trigger, Cd = St.Portal, cu = St.Close, is = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  St.Overlay,
  {
    ref: n,
...
is.displayName = St.Overlay.displayName;
...
Md.displayName = er.Root.displayName;
function du({
  className: e,
  ...t
}) {
...
Od.displayName = He.Root.displayName;
...
Id.displayName = nr.Root.displayName;
const hu = vt.Root, Ad = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    vt.List,
    {
...
Ad.displayName = vt.List.displayName;
...
Vd.displayName = vt.Trigger.displayName;
...
Pd.displayName = vt.Content.displayName;
