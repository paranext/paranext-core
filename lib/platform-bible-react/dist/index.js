...
var Pi = (t, e, r) => e in t ? Ii(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Kt = (t, e, r) => Pi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Se, a as Fa, C as Ce, A as ie, P as $e, b as We, B as U, d as Ae, e as Ie, f as Pe, h as xe, i as Vi, k as ji, j as Li, E as Bi, l as Ua, r as pe, W as Fi, m as dn, n as Qr, o as ta, L as Nt, R as Ka, p as qr, D as Na, q as Ca, s as Ea, t as Ta, T as wn, u as Vr, v as Pt, w as qa, x as Vt, y as jt, z as Lt, F as un, G as Ga, H as Ge, I as kr, J as ye, K as ke, M as _e, S as _r, N as er, O as Ui, Q as Er, U as Ye, V as De, Z as Xe, X as Re, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as pn, a3 as Ki, a4 as qi, a5 as Gi, a6 as za, a7 as hn, a8 as ea, a9 as gn, aa as Hi, ab as Yi, ac as Wi, ad as Xi, ae as fn, af as Ji, ag as sa, ah as xo, ai as ca, aj as Zi, ak as Qi, al as ts, am as es, an as rs, ao as Tr, ap as Xa, aq as as, ar as os } from "./resizable-Dfg3qUeK.js";
import { as as Jh, at as Zh, au as Qh, av as tg, aw as eg, ax as rg, ay as ag, az as og, aA as ng, aB as ig, aC as sg, aD as cg, aE as lg, aF as dg, aG as wg, aH as ug, aI as pg, aJ as hg, aK as gg, aL as fg, aM as mg, aN as vg, aO as bg, aP as xg, aQ as yg } from "./resizable-Dfg3qUeK.js";
...
function cl({
  ...
  return /* @__PURE__ */ u($e, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      Ce,
      {
        onSelect: () => g(h),
...
function ua({
  ...
  const B = pe(), [z, A] = _(!1), [I, C] = _(""), [P, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    void 0
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = Ft[rt].filter((It) => Ua(It, P, n));
    }), b;
  }, [Ft, P, n]), R = D(
    () => pl(P, Jt, n),
    [P, Jt, n]
  ...
  const { otLong: pt, ntLong: gt, dcLong: Mt, extraLong: zt } = {
    ...
    (b) => {
      var me, Te, Fe;
      if (b.ctrlKey) return;
      const { isLetter: G, isDigit: rt } = Po(b.key);
        ...
        children: /* @__PURE__ */ u(
          Ie,
          {
            ...
            children: [
              ...
              !Dt && /* @__PURE__ */ u(Pe, { ref: at, children: [
...
function Lo({
  ...
  const [N, O] = _(!1), B = d ?? l, z = (I) => I.length > 0 && typeof I[0] == "object" && "options" in I[0], A = (I, C) => {
    const P = l(I), K = typeof I == "object" && "secondaryLabel" in I ? I.secondaryLabel : void 0, y = `${C ?? ""}${P}${K ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: P,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ie, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: z(e) ? e.map((I) => /* @__PURE__ */ a(xe, { heading: I.groupHeading, children: I.options.map((C) => A(C, I.groupHeading)) }, I.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((I) => A(I)) }) })
        ] })
      }
    )
  ] });
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((z || A) && O !== null && B !== null) {
        const I = function(C, P, K, y, J, j, Y) {
          const T = (C._window ? C._window.document : document).createRange();
          return T.setStart(...Bo(P, K, y)), T.setEnd(...Bo(J, j, Y)), T;
        }(t, g, f, O, h, E, B);
        l(), l = Dl(t, I, e);
      }
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u($e, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ae,
        {
          ...
          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: t.map((v) => /* @__PURE__ */ a(
            Ce,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
...
function bi({
  ...
  const Zt = D(() => Ct[0], [Ct]), Ee = F(null), te = F(void 0), V = L(() => {
    var S;
  ...
  const Ht = L(
    ...
    async (S) => {
      ...
      return oe && (xt !== void 0 && $(xt), At && V()), oe;
    },
    [V, y, p, j]
  );
                    ...
                    /* @__PURE__ */ u($e, { open: q, onOpenChange: tt, children: [
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(Pe, { children: x == null ? void 0 : x.map((S) => /* @__PURE__ */ a(
                            Ce,
                            {
                              onSelect: () => {
...
function jd({
  ...
  const P = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: P }), y = (T) => T ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: T }) : K, J = () => {
    const T = o ?? "accept";
...
function mp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [O, B] = _("*"), [z, A] = _("f"), [I, C] = _(!1), [P, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, q] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Aa ? st = "generated" : it === Ia ? st = "hidden" : it && (N(it), B(it)), x(st), E(st), A(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), V = setTimeout(() => {
        var ht;
  ...
  const Jt = () => {
    ...
    if (g.current && ae.length && V && V.rangeCount > 0) {
      const Q = V.getRangeAt(0).getBoundingClientRect(), et = g.current.getBoundingClientRect();
  ...
  H(() => {
    ...
    const V = ((et = p.current) == null ? void 0 : et.querySelector(".editor-input")) ?? void 0, Q = (ot) => {
      !T && V && document.activeElement === V && ot.key === c ? (ot.preventDefault(), Ee()) : T && ot.key === "Escape" && (ot.preventDefault(), $(!1));
    };
...
function Tp({
  ...
  const h = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), x = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), k = le(r, "%webView_inventory_scope_chapter%"), N = le(r, "%webView_inventory_scope_verse%"), O = le(r, "%webView_inventory_filter_text%"), B = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), z = le(r, "%webView_inventory_no_results%"), [A, I] = _(!1), [C, P] = _("all"), [K, y] = _(""), [J, j] = _([]), Y = D(() => {
    const q = t ?? [];
...
const ze = "scrBook", Vw = "scrRef", qe = "source", jw = "details", Lw = "Scripture Reference", Bw = "Scripture Book", _i = "Type", Fw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Fp({
  ...
  H(() => {
    if (c) {
      ...
      if (P.length === 1) {
        const K = x.find((y) => cn(y) === P[0]) || void 0;
        K && c(K);
      }
    }
  }, [h, x, c, E]);
  ...
  }, A = (C, P) => C.getIsGrouped() ? "" : m("banded-row", P % 2 === 0 ? "even" : "odd"), I = (C, P, K) => {
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Re, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
...
function Kp({
  ...
  const O = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), P = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), y = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (M) => {
    if (!f) return;
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", Be = d === "dropdown" && zt === "range", b = Be ? At : V, rt = Be ? oe : h ? Q : ae, It = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
...
function Ba({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(pn, { children: /* @__PURE__ */ a(Pt, { children: Ti(e.groups, e.items, l, t) }) }),
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Zw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Pt, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
