import Kl, { jsx as d, jsxs as $, Fragment as Et } from "react/jsx-runtime";
import * as N from "react";
import U, { forwardRef as wn, useCallback as Se, useState as fe, useRef as Mt, useEffect as Je, useLayoutEffect as ya, useMemo as xt } from "react";
import { History as Jl, ChevronRight as Ri, Check as Ro, Circle as Zl, ArrowDownWideNarrow as Ql, Clock as ec, Bookmark as tc, FilterIcon as rc, ChevronDown as xn, ChevronUp as nc, ArrowLeftIcon as oc, ChevronLeftIcon as ac, ChevronRightIcon as ic, ArrowRightIcon as sc, ArrowUpIcon as lc, ArrowDownIcon as cc, ArrowUpDownIcon as pc, CircleCheckIcon as dc, CircleXIcon as uc, CircleHelpIcon as fc, X as mc, Search as hc, ChevronsUpDown as gc, ChevronLeft as bc, LoaderCircle as vc, Download as yc, Filter as wc, User as xc, Link as Ec, CircleHelp as kc } from "lucide-react";
import Oe, { clsx as Nc } from "clsx";
...
import { getChaptersForBook as Sc, getLocalizeKeyForScrollGroupId as me, formatScrRef as Wn, compareScrRefs as fo, scrRefToBBBCCCVVV as Xn, NumberFormat as Oc, formatBytes as Rc } from "platform-bible-utils";
import { useReactTable as Pi, getCoreRowModel as $i, getPaginationRowModel as Pc, getSortedRowModel as _i, getFilteredRowModel as $c, flexRender as Tr, getExpandedRowModel as _c, getGroupedRowModel as Ic } from "@tanstack/react-table";
...
import { FormControlLabel as wa, FormLabel as Ac, Checkbox as Dc, MenuItem as jc, ListItemText as Bc, ListItemIcon as Mi, Menu as Lc, Grid as Ai, List as Fc, IconButton as Di, Drawer as Vc, Slider as zc, Snackbar as Uc, Switch as Hc, AppBar as Gc, Toolbar as Wc } from "@mui/material";
import * as $r from "@radix-ui/react-popover";
import { Command as De } from "cmdk";
import * as et from "@radix-ui/react-dialog";
import Xc, { ThemeContext as Yc, internal_processStyles as qc } from "@mui/styled-engine";
...
import { Toaster as Jc } from "sonner";
import { toast as $0 } from "sonner";
import * as xr from "@radix-ui/react-slider";
import * as mo from "@radix-ui/react-switch";
const Zc = Tc({ prefix: "pr-" });
function D(...e) {
  return Zc(Nc(e));
}
...
var ep = Object.defineProperty, tp = (e, t, r) => t in e ? ep(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => tp(e, typeof t != "symbol" ? t + "" : t, r);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
const Io = be.Root, Gi = be.Trigger, up = be.Group, Wv = be.Portal, Xv = be.Sub, Yv = be.RadioGroup, fp = U.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: D(
...
fp.displayName = be.SubTrigger.displayName;
...
mp.displayName = be.SubContent.displayName;
const Nn = U.forwardRef(({ className: e, sideOffset: t = 4, ...r }, n) => /* @__PURE__ */ d(be.Portal, { children: /* @__PURE__ */ d(
  be.Content,
  {
    ref: n,
    sideOffset: t,
...
Nn.displayName = be.Content.displayName;
...
const Mo = U.forwardRef(({ className: e, children: t, checked: r, ...n }, o) => /* @__PURE__ */ $(
  be.CheckboxItem,
  {
    ref: o,
    className: D(
    ...
    ...n,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(be.ItemIndicator, { children: /* @__PURE__ */ d(Ro, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
Mo.displayName = be.CheckboxItem.displayName;
const Xi = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  be.RadioItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(be.ItemIndicator, { children: /* @__PURE__ */ d(Zl, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
...
const Tn = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  be.Separator,
  {
    ref: r,
...
Tn.displayName = be.Separator.displayName;
...
function vp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
...
const Cr = he.allBookIds, yp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ka = ["OT", "NT", "DC"], wp = 32 + 32 + 32, xp = [
  /^(\w+)$/i,
...
function qv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = fe(""), [o, a] = fe(
    ...
    xp.forEach((k) => {
      const M = r.match(k);
      if (M) {
        const [j, z = void 0, G = void 0] = M.slice(1), B = Tp(j);
  ...
  return Je(() => {
    ...
    const k = setTimeout(() => {
      if (g && u.current && b.current) {
        const j = b.current.offsetTop - wp;
  ...
  }, [g]), /* @__PURE__ */ d("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ $(Io, { modal: !1, open: m, onOpenChange: E, children: [
        ...
        children: [
          ...
          ka.map(
            (k, M) => w(k).length > 0 && /* @__PURE__ */ $("div", { children: [
              /* @__PURE__ */ d(Vr, { className: "pr-font-semibold pr-text-foreground/80", children: yp[k] }),
              ...
              ka.length - 1 !== M ? /* @__PURE__ */ d(Tn, {}) : void 0
            ] }, k)
          )
        ]
      }
...
const Cp = En(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ d(n ? Mc : "button", { className: D(Cp({ variant: t, size: r, className: e })), ref: a, ...o })
);
Te.displayName = "Button";
function Sp({ table: e }) {
  return /* @__PURE__ */ $(Io, { children: [
    /* @__PURE__ */ d(Cc, { asChild: !0, children: /* @__PURE__ */ $(Te, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ d(rc, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ $(Nn, { align: "end", className: "pr-w-[150px]", children: [
...
const _r = xe.Root, Op = xe.Group, Ir = xe.Value, Zt = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  xe.Trigger,
  {
    ref: n,
    className: D(
    ...
    children: [
      t,
      /* @__PURE__ */ d(xe.Icon, { asChild: !0, children: /* @__PURE__ */ d(xn, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
...
const Yi = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  xe.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ d(nc, { className: "pr-h-4 pr-w-4" })
  }
));
...
Rp.displayName = xe.Label.displayName;
const Ke = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  xe.Item,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ d("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ d(xe.ItemIndicator, { children: /* @__PURE__ */ d(Ro, { className: "pr-h-4 pr-w-4" }) }) }),
...
const Cn = U.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d("div", { className: D("pr-twp pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ d(
  "table",
  {
    ref: n,
...
const Sn = U.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ d(
  "thead",
  {
    ref: n,
    className: D(
...
const On = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("tbody", { ref: r, className: D("[&_tr:last-child]:pr-border-0", e), ...t }));
...
const Ip = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  "caption",
  {
    ref: r,
...
function Mp({
  ...
  var b;
  const [l, c] = fe([]), [f, m] = fe([]), [v, g] = fe({}), [p, h] = fe({}), u = Pi({
    data: t,
    columns: e,
    getCoreRowModel: $i(),
    ...r && { getPaginationRowModel: Pc() },
    onSortingChange: c,
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-font-sans", children: [
    o && /* @__PURE__ */ d(Sp, { table: u }),
    /* @__PURE__ */ $(Cn, { stickyHeader: a, children: [
      /* @__PURE__ */ d(Sn, { stickyHeader: a, children: u.getHeaderGroups().map((w) => /* @__PURE__ */ d(wt, { children: w.headers.map((O) => /* @__PURE__ */ d(Mr, { children: O.isPlaceholder ? void 0 : Tr(O.column.columnDef.header, O.getContext()) }, O.id)) }, w.id)) }),
      /* @__PURE__ */ d(On, { children: (b = u.getRowModel().rows) != null && b.length ? u.getRowModel().rows.map((w) => /* @__PURE__ */ d(
        wt,
        {
          onClick: () => i(w, u),
    ...
    r && n && /* @__PURE__ */ d($p, { table: u })
  ] });
}
const Ap = (e) => e.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Na = (e) => {
  ...
  return a.forEach((f) => {
    f.startsWith("\\id") && (i = 0, l = 0), f.startsWith("\\c") && (i = Na(f), l = 0), f.startsWith("\\v") && (l = Na(f), i === 0 && (i = n.chapterNum));
    const m = r(f, t);
...
function Dp({
  ...
  return Je(
    () => f(Ta(t, e, r, n)),
    [t, e, n, r]
  ), /* @__PURE__ */ $(Cn, { stickyHeader: !0, children: [
    /* @__PURE__ */ d(Sn, { stickyHeader: !0, children: /* @__PURE__ */ $(wt, { children: [
      /* @__PURE__ */ d(Mr, { children: i }),
      /* @__PURE__ */ d(Mr, { children: l })
    ] }) }),
    /* @__PURE__ */ d(On, { children: c.map((m) => /* @__PURE__ */ $(
      wt,
      {
        onClick: () => {
          o(m.reference);
...
]), Ao = (e) => e === "asc" ? /* @__PURE__ */ d(lc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ d(cc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ d(pc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), jp = (e, t, r) => {
  let n = e;
...
), Lp = U.forwardRef(({ className: e, variant: t, size: r, ...n }, o) => /* @__PURE__ */ d(
  Ii.Root,
  {
    ref: o,
...
Lp.displayName = Ii.Root.displayName;
...
Zi.displayName = kn.Root.displayName;
...
an.displayName = kn.Item.displayName;
const Zv = (e) => ({
  accessorKey: "item",
  ...
  accessorKey: "status",
  header: ({ column: r }) => /* @__PURE__ */ $(Te, { className: "pr-mt-1", variant: "ghost", onClick: () => r.toggleSorting(void 0), children: [
    e,
    Ao(r.getIsSorted())
  ] }),
  cell: ({ row: r }) => {
    ...
    return /* @__PURE__ */ $(Zi, { value: n, variant: "outline", type: "single", children: [
      /* @__PURE__ */ d(an, { onClick: () => t([o], "approved"), value: "approved", children: /* @__PURE__ */ d(dc, {}) }),
      /* @__PURE__ */ d(
        an,
        {
          onClick: () => t([o], "unapproved"),
          value: "unapproved",
          children: /* @__PURE__ */ d(uc, {})
        }
      ),
      /* @__PURE__ */ d(an, { onClick: () => t([o], "unknown"), value: "unknown", children: /* @__PURE__ */ d(fc, {}) })
    ] });
  }
}), Yn = {
  [me("undefined")]: "Ø",
...
const Fp = $r.Root, Vp = $r.Trigger, Qi = U.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ d($r.Portal, { children: /* @__PURE__ */ d(
  $r.Content,
  {
    ref: o,
    align: t,
...
const zp = et.Portal, es = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  et.Overlay,
  {
    ref: r,
    className: D(
...
const Up = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(zp, { children: [
  /* @__PURE__ */ d(es, {}),
  /* @__PURE__ */ $(
    et.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ $(et.Close, { className: "pr-absolute pr-right-4 pr-top-4 pr-rounded-sm pr-opacity-70 pr-ring-offset-background pr-transition-opacity hover:pr-opacity-100 focus:pr-outline-none focus:pr-ring-2 focus:pr-ring-ring focus:pr-ring-offset-2 disabled:pr-pointer-events-none data-[state=open]:pr-bg-accent data-[state=open]:pr-text-muted-foreground", children: [
          /* @__PURE__ */ d(mc, { className: "pr-h-4 pr-w-4" }),
...
Up.displayName = et.Content.displayName;
...
Hp.displayName = et.Title.displayName;
...
Gp.displayName = et.Description.displayName;
...
const rs = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
  /* @__PURE__ */ d(hc, { className: "pr-me-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ d(
    De.Input,
    {
      ref: r,
...
Xp.displayName = De.Separator.displayName;
...
function Ca({
  ...
  const [p, h] = fe(!1);
  return /* @__PURE__ */ $(Fp, { open: p, onOpenChange: h, ...g, children: [
    /* @__PURE__ */ d(Vp, { asChild: !0, children: /* @__PURE__ */ $(
      Te,
      {
        variant: f,
        role: "combobox",
    ...
    /* @__PURE__ */ d(Qi, { className: "pr-w-[200px] pr-p-0", dir: m, children: /* @__PURE__ */ $(ts, { children: [
      ...
      /* @__PURE__ */ d(ns, { children: t.map((u) => /* @__PURE__ */ $(
        as,
        {
          value: a(u),
          onSelect: () => {
...
function td() {
  ...
  return Kn = o() ? Object.assign : function(a, i) {
...
var Zn, _a;
function cs() {
  return _a || (_a = 1, Zn = Function.call.bind(Object.prototype.hasOwnProperty)), Zn;
}
var Qn, Ia;
function rd() {
  if (Ia)
...
function nd() {
  if (Ma)
    return eo;
  Ma = 1;
  var e = ls(), t = td(), r = jo(), n = cs(), o = rd(), a = function() {
  };
...
process.env.NODE_ENV === "production" ? go.exports = fd() : go.exports = md();
var un = go.exports;
...
const vd = s.oneOfType([s.func, s.object]), Bo = vd;
function tt(e) {
  if (typeof e != "string")
...
function _d() {
  this.visibilityState === "hidden" && vo && (Rn = !0);
}
function Id(e) {
  e.addEventListener("keydown", $d, !0), e.addEventListener("mousedown", ro, !0), e.addEventListener("pointerdown", ro, !0), e.addEventListener("touchstart", ro, !0), e.addEventListener("visibilitychange", _d, !0);
}
function Md(e) {
  const {
    target: t
...
function bs() {
  ...
  function r() {
    return t.current ? (vo = !0, Od.start(100, () => {
      vo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
...
ws.isRequired = ys;
yo.isRequired = yo;
const xs = process.env.NODE_ENV === "production" ? yo : ws;
function Es(e, t) {
  const r = P({}, t);
...
function Ud(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = ge(e, Vd), a = zd(t), i = Object.keys(a);
  function l(g) {
...
function mn(e, t, r, n = r) {
  let o;
  return typeof e == "function" ? o = e(r) : Array.isArray(e) ? o = e[r] || n : o = Pn(e, r) || n, t && (o = t(o, n, e)), o;
}
function ke(e) {
  const {
    prop: t,
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, f = Pn(c, n) || {};
    return pt(i, l, (v) => {
      let g = mn(f, o, v);
...
}), $n = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], _n = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Qd = [...$n, ..._n];
function Hr(e, t, r, n) {
  var o;
  const a = (o = Pn(e, t, !1)) != null ? o : r;
...
ye.propTypes = process.env.NODE_ENV !== "production" ? $n.reduce((e, t) => (e[t] = Nt, e), {}) : {};
ye.filterProps = $n;
function we(e) {
  return Cs(e, _n);
}
we.propTypes = process.env.NODE_ENV !== "production" ? _n.reduce((e, t) => (e[t] = Nt, e), {}) : {};
we.filterProps = _n;
...
const nu = qe("border", He), ou = qe("borderTop", He), au = qe("borderRight", He), iu = qe("borderBottom", He), su = qe("borderLeft", He), lu = qe("borderColor"), cu = qe("borderTopColor"), pu = qe("borderRightColor"), du = qe("borderBottomColor"), uu = qe("borderLeftColor"), fu = qe("outline", He), mu = qe("outlineColor"), Mn = (e) => {
...
In(nu, ou, au, iu, su, lu, cu, pu, du, uu, Mn, fu, mu);
const An = (e) => {
...
In(An, Dn, jn, hu, gu, bu, vu, yu, wu, xu, Eu, ku);
function Jt(e, t) {
  return t === "grey" ? t : e;
}
const Nu = ke({
...
const Su = ke({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (r) => {
      var n, o;
      const a = ((n = e.theme) == null || (n = n.breakpoints) == null || (n = n.values) == null ? void 0 : n[r]) || Lo[r];
...
function Du() {
  ...
  function t(r) {
    ...
    if (!o)
      return null;
    const i = (n = a.unstable_sxConfig) != null ? n : Vo;
    function l(c) {
      let f = c;
...
function Uo(e = {}, ...t) {
  ...
  return f.applyStyles = ju, f = t.reduce((m, v) => lt(m, v), f), f.unstable_sxConfig = P({}, Vo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return zo({
      sx: v,
      theme: this
    });
...
const Wu = Uo(), Ga = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function tn({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function Yu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    qc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: f,
      ...
      overridesResolver: g = Xu(Ga(f))
    } = l, p = ge(l, Uu), h = m !== void 0 ? m : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      f && f !== "Root" && f !== "root" || !1
    ), u = v || !1;
    let b;
    process.env.NODE_ENV !== "production" && c && (b = `${c}-${Ga(f || "Root")}`);
    let w = sn;
    f === "Root" || f === "root" ? w = n : f ? w = o : Gu(i) && (w = void 0);
    const O = Xc(i, P({
      shouldForwardProp: w,
      label: b
      ...
      if (process.env.NODE_ENV !== "production") {
        let k;
        c && (k = `${c}${tt(f || "")}`), k === void 0 && (k = `Styled(${bd(i)})`), _.displayName = k;
      }
...
function Zu(e) {
  ...
  return e.type === "hsla" && (l += "a", c.push(t[3])), Bn({
    type: l,
    values: c
  });
}
...
function hn(e, t) {
  return e = Bt(e), t = Ho(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Bn(e);
}
function Qu(e, t) {
  if (e = Bt(e), t = Ho(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
function yf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = ge(e, uf), a = e.primary || ff(t), i = e.secondary || mf(t), l = e.error || hf(t), c = e.info || gf(t), f = e.success || bf(t), m = e.warning || vf(t);
  function v(u) {
    const b = Xa(u, no.text.primary) >= r ? no.text.primary : Ya.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = Xa(u, b);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return qa(u, "light", O, n), qa(u, "dark", x, n), u.contrastText || (u.contrastText = v(u.main)), u;
  }, p = {
    dark: no,
    light: Ya
  };
...
function Ef(e, t) {
  ...
  const p = o / 14, h = v || ((w) => `${w / f * p}rem`), u = (w, O, x, E, y) => P({
    ...
    button: u(l, 14, 1.75, 0.4, Ka),
    caption: u(i, 12, 1.66, 0.4),
    overline: u(i, 12, 2.66, 1, Ka),
...
`));
  ...
  return f.unstable_sxConfig = P({}, Vo, i == null ? void 0 : i.unstable_sxConfig), f.unstable_sx = function(v) {
    return zo({
      sx: v,
      theme: this
    });
...
}), Xo = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const n = ft({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = n, p = ge(n, Ff), h = /* @__PURE__ */ N.isValidElement(o) && o.type === "svg", u = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
var _s = Do.default = void 0, Yf = Xf(Wf()), qf = Kl;
_s = Do.default = (0, Yf.default)(/* @__PURE__ */ (0, qf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Is(e) {
...
function em(e) {
  ...
  const i = Ms(P({}, o, n)), l = ti(n), c = ti(o), f = t(i), m = Oe(f == null ? void 0 : f.className, r == null ? void 0 : r.className, a, o == null ? void 0 : o.className, n == null ? void 0 : n.className), v = P({}, f == null ? void 0 : f.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), g = P({}, f, r, c, l);
...
process.env.NODE_ENV !== "production" && (gn["propTypes"] = us(gn.propTypes));
function dm(e) {
...
const jr = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  return /* @__PURE__ */ d(N.Fragment, {
    children: i && /* @__PURE__ */ Kc.createPortal(n, i)
  });
});
...
class gm {
  ...
  add(t, r) {
    ...
    const a = oo(this.containers, (i) => i.container === r);
  ...
  mount(t, r) {
    const n = oo(this.containers, (a) => a.modals.indexOf(t) !== -1), o = this.containers[n];
  ...
  remove(t, r = !0) {
    ...
    if (n === -1)
      return n;
    const o = oo(this.containers, (i) => i.modals.indexOf(t) !== -1), a = this.containers[o];
...
function wm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, g = N.useRef({}), p = N.useRef(null), h = N.useRef(null), u = We(h, v), [b, w] = N.useState(!m), O = vm(c);
  let x = !0;
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: bo(B, c == null ? void 0 : c.props.onEnter),
        onExited: bo(W, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: u,
    portalRef: R,
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Yo = "auto", Wr = [Me, Xe, Ye, Ae], nr = "start", Br = "end", xm = "clippingParents", js = "viewport", br = "popper", Em = "reference", oi = /* @__PURE__ */ Wr.reduce(function(e, t) {
  return e.concat([t + "-" + nr, t + "-" + Br]);
}, []), Bs = /* @__PURE__ */ [].concat(Wr, [Yo]).reduce(function(e, t) {
...
function ar(e, t, r) {
  ...
  var i = Ft(e) ? ze(e) : window, l = i.visualViewport, c = !Ls() && r, f = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, g = n.height / a;
  return {
    width: v,
    height: g,
    top: m,
...
function jm(e) {
  ...
  var o = Ln(e);
  for (qo(o) && (o = o.host); Ge(o) && ["html", "body"].indexOf(rt(o)) < 0; ) {
    var a = dt(o);
...
function Xr(e) {
  for (var t = ze(e), r = ai(e); r && Dm(r) && dt(r).position === "static"; )
    r = ai(r);
  return r && (rt(r) === "html" || rt(r) === "body" && dt(r).position === "static") ? t : r || jm(e) || t;
}
function Jo(e) {
...
function Fm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Qe(r.placement), c = Jo(l), f = [Ae, Ye].indexOf(l) >= 0, m = f ? "height" : "width";
  if (!(!a || !i)) {
    var v = Lm(o.padding, r), g = Ko(a), p = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, u = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], b = i[c] - r.rects.reference[c], w = Xr(a), O = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = u / 2 - b / 2, E = v[p], y = O - g[m] - v[h], T = O / 2 - g[m] / 2 + x, C = Rr(E, T, y), I = c;
...
function Gm(e) {
  ...
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, ii(Object.assign({}, f, {
    offsets: t.modifiersData.popperOffsets,
    position: t.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, ii(Object.assign({}, f, {
...
function Qo(e) {
  return ar(Tt(e)).left + Zo(e).scrollLeft;
}
function Jm(e, t) {
...
function Zm(e) {
  var t, r = Tt(e), n = Zo(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = At(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = At(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -n.scrollLeft + Qo(e), c = -n.scrollTop;
...
function Hs(e) {
  return ["html", "body", "#document"].indexOf(rt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && ea(e) ? e : Hs(Ln(e));
}
function Pr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Hs(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = ze(n), i = o ? [a].concat(a.visualViewport || [], ea(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function li(e, t, r) {
  return t === js ? xo(Jm(e, r)) : Ft(t) ? Qm(t, r) : xo(Zm(Tt(e)));
}
function eh(e) {
  var t = Pr(Ln(e)), r = ["absolute", "fixed"].indexOf(dt(e).position) >= 0, n = r && Ge(e) ? Xr(e) : e;
  return Ft(n) ? t.filter(function(o) {
    return Ft(o) && Fs(o, n) && rt(o) !== "body";
  }) : [];
}
function th(e, t, r, n) {
  var o = t === "clippingParents" ? eh(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, f) {
    var m = li(e, f, n);
...
function Lr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? xm : l, f = r.rootBoundary, m = f === void 0 ? js : f, v = r.elementContext, g = v === void 0 ? br : v, p = r.altBoundary, h = p === void 0 ? !1 : p, u = r.padding, b = u === void 0 ? 0 : u, w = zs(typeof b != "number" ? b : Us(b, Wr)), O = g === br ? Em : br, x = e.rects.popper, E = e.elements[h ? O : g], y = th(Ft(E) ? E : E.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), C = Gs({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
  }), I = xo(Object.assign({}, x, C)), R = g === br ? I : T, _ = {
...
function rh(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, i = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, f = c === void 0 ? Bs : c, m = ir(n), v = m ? l ? oi : oi.filter(function(h) {
    return ir(h) === m;
...
function oh(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, f = r.padding, m = r.boundary, v = r.rootBoundary, g = r.altBoundary, p = r.flipVariations, h = p === void 0 ? !0 : p, u = r.allowedAutoPlacements, b = t.options.placement, w = Qe(b), O = w === b, x = c || (O || !h ? [cn(b)] : nh(b)), E = [b].concat(x).reduce(function(H, K) {
      return H.concat(Qe(K) === Yo ? rh(t, {
        placement: K,
        boundary: m,
        rootBoundary: v,
        padding: f,
...
function ih(e) {
  var t = e.state, r = e.name, n = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, i = Lr(t, {
    ...
    altBoundary: !0
  }), c = ci(i, n), f = ci(l, o, a), m = pi(c), v = pi(f);
  t.modifiersData[r] = {
...
function mh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, v = r.padding, g = r.tether, p = g === void 0 ? !0 : g, h = r.tetherOffset, u = h === void 0 ? 0 : h, b = Lr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Qe(t.placement), O = ir(t.placement), x = !O, E = Jo(w), y = fh(E), T = t.modifiersData.popperOffsets, C = t.rects.reference, I = t.rects.popper, R = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
  ...
  if (T) {
    if (a) {
      var j, z = E === "y" ? Me : Ae, G = E === "y" ? Xe : Ye, B = E === "y" ? "height" : "width", W = T[E], te = W + b[z], V = W - b[G], S = p ? -I[B] / 2 : 0, L = O === nr ? C[B] : I[B], X = O === nr ? -I[B] : -C[B], Y = t.elements.arrow, H = p && Y ? Ko(Y) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var $e, Ee = E === "x" ? Me : Ae, Ct = E === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + b[Ee], at = _e - b[Ct], Ce = [Me, Ae].indexOf(w) !== -1, Vt = ($e = k == null ? void 0 : k[y]) != null ? $e : 0, St = Ce ? Be : _e - C[ot] - I[ot] - Vt + _.altAxis, cr = Ce ? _e + C[ot] + I[ot] - Vt - _.altAxis : at, Kr = p && Ce ? Bm(St, _e, cr) : Rr(p ? St : Be, _e, p ? cr : at);
      T[y] = Kr, M[y] = Kr - _e;
    }
    t.modifiersData[n] = M;
  }
...
function yh(e, t, r) {
  ...
  ea(a)) && (l = bh(t)), Ge(t) ? (c = ar(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Qo(a))), {
...
const _h = () => ut({
  ...
  } = t, b = ge(t, Oh), w = N.useRef(null), O = We(w, r), x = N.useRef(null), E = We(x, g), y = N.useRef(E);
  jt(() => {
    y.current = E;
  }, [E]), N.useImperativeHandle(g, () => x.current, []);
  const T = Ph(m, i), [C, I] = N.useState(T), [R, _] = N.useState(vn(o));
  N.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && R && Fn(R) && R.nodeType === 1) {
...
`));
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, O = ge(t, Rh), [x, E] = N.useState(!0), y = () => {
    E(!1);
  }, T = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const _ = vn(n);
    C = _ && Fn(_) ? Re(_).body : Re(null).body;
  }
...
function Yr() {
  const e = Rs(Go);
  return process.env.NODE_ENV !== "production" && N.useDebugValue(e), e[Wo] || e;
}
function Eo(e, t) {
...
var jh = function(t) {
  return t.scrollTop;
}, Nr = "unmounted", Rt = "exited", Pt = "entering", Kt = "entered", ko = "exiting", mt = /* @__PURE__ */ function(e) {
  Ah(t, e);
  function t(n, o) {
    var a;
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Pt && i !== Kt && (a = Pt) : (i === Pt || i === Kt) && (a = ko);
    }
...
}, ao = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), ta = /* @__PURE__ */ N.forwardRef(function(t, r) {
  const {
    addEndListener: n,
    appear: o = !0,
    children: a,
    ...
    TransitionComponent: b = qs
  } = t, w = ge(t, Bh), O = Er(), x = N.useRef(), E = Yr(), y = N.useRef(null), T = We(y, a.ref, r), C = (G) => (B) => {
    if (G) {
      const W = y.current;
      B === void 0 ? G(W) : G(W, B);
    }
    ...
    u === "auto" ? (V = E.transitions.getAutoHeightDuration(G.clientHeight), x.current = V) : V = B, G.style.transition = [E.transitions.create("opacity", {
      ...
      duration: ao ? V : V * 0.666,
      delay: ao ? W : W || V * 0.333,
      easing: te
    })].join(","), G.style.opacity = 0, G.style.transform = No(0.75), v && v(G);
  }), j = C(g);
...
const To = ta, Fh = (e) => {
  ...
  const o = Os(), a = ft({
    ...
    slots: x,
    slotProps: E
  } = a, y = ge(a, Vh), T = (n = x == null ? void 0 : x.root) != null ? n : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: g,
...
const Hh = kt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), yt = Hh, Gh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Wh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Xh = (e) => {
...
const Qs = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  const T = ft({
    ...
    TransitionProps: re
  } = T, A = ge(T, Gh), se = /* @__PURE__ */ N.isValidElement(I) ? I : /* @__PURE__ */ d("span", {
    children: I
  }), Ne = Yr(), $e = Ne.direction === "rtl", [Ee, Ct] = N.useState(), [_e, ot] = N.useState(null), Be = N.useRef(!1), at = z || V, Ce = Er(), Vt = Er(), St = Er(), cr = Er(), [Kr, aa] = gs({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const ia = (ne) => {
    ...
    (ne) => {
      hi.start(800 + L, () => {
        nn = !1;
      }), aa(!1), Y && it && Y(ne), Ce.start(Ne.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), zn = (ne) => {
    ...
    onFocus: Ll,
    ref: Fl
  } = bs(), [, ca] = N.useState(!1), pa = (ne) => {
    Bl(ne), la.current === !1 && (ca(!1), sa(ne));
  }, da = (ne) => {
    Ee || Ct(ne.currentTarget), Ll(ne), la.current === !0 && (ca(!0), zn(ne));
  }, ua = (ne) => {
    Be.current = !0;
    const Le = se.props;
    Le.onTouchStart && Le.onTouchStart(ne);
  }, fa = zn, ma = sa, Vl = (ne) => {
    ua(ne), St.clear(), Ce.clear(), Jr(), pr.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", cr.start(te, () => {
      document.body.style.WebkitUserSelect = pr.current, zn(ne);
    });
  }, zl = (ne) => {
  ...
  const Ul = We(se.ref, Fl, Ct, r);
  !ie && ie !== 0 && (it = !1);
  const Un = N.useRef(), Hl = (ne) => {
    const Le = se.props;
    Le.onMouseMove && Le.onMouseMove(ne), vr = {
      x: ne.clientX,
      y: ne.clientY
    }, Un.current && Un.current.update();
  }, dr = {}, Hn = typeof ie == "string";
  k ? (dr.title = !it && Hn && !j ? ie : null, dr["aria-describedby"] = it ? Vn : null) : (dr["aria-label"] = Hn ? ie : null, dr["aria-labelledby"] = it && !Hn ? Vn : null);
...
`));
  ...
  const ur = {};
  G || (Ue.onTouchStart = Vl, Ue.onTouchEnd = zl), j || (Ue.onMouseOver = on(fa, Ue.onMouseOver), Ue.onMouseLeave = on(ma, Ue.onMouseLeave), at || (ur.onMouseOver = fa, ur.onMouseLeave = ma)), M || (Ue.onFocus = on(da, Ue.onFocus), Ue.onBlur = on(pa, Ue.onBlur), at || (ur.onFocus = da, ur.onBlur = pa)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Gl = N.useMemo(() => {
    var ne;
    let Le = [{
    ...
    touch: Be.current
  }), Gn = Xh(fr), ha = (n = (o = ee.popper) != null ? o : R.Popper) != null ? n : Yh, ga = (a = (i = (l = ee.transition) != null ? l : R.Transition) != null ? i : F) != null ? a : To, ba = (c = (f = ee.tooltip) != null ? f : R.Tooltip) != null ? c : qh, va = (m = (v = ee.arrow) != null ? v : R.Arrow) != null ? m : Kh, Wl = kr(ha, P({}, J, (g = Q.popper) != null ? g : _.popper, {
    className: Oe(Gn.popper, J == null ? void 0 : J.className, (p = (h = Q.popper) != null ? h : _.popper) == null ? void 0 : p.className)
  }), fr), Xl = kr(ga, P({}, re, (u = Q.transition) != null ? u : _.transition), fr), Yl = kr(ba, P({}, (b = Q.tooltip) != null ? b : _.tooltip, {
    className: Oe(Gn.tooltip, (w = (O = Q.tooltip) != null ? O : _.tooltip) == null ? void 0 : w.className)
  }), fr), ql = kr(va, P({}, (x = Q.arrow) != null ? x : _.arrow, {
    className: Oe(Gn.arrow, (E = (y = Q.arrow) != null ? y : _.arrow) == null ? void 0 : E.className)
  }), fr);
  return /* @__PURE__ */ $(N.Fragment, {
    children: [/* @__PURE__ */ N.cloneElement(se, Ue), /* @__PURE__ */ d(ha, P({
      as: Z ?? Zs,
      placement: q,
      anchorEl: V ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ $(ba, P({}, Yl, {
          children: [ie, C ? /* @__PURE__ */ d(va, P({}, ql, {
            ref: ot
          })) : null]
        }))
      }))
  ...
  const {
    ...
    jc,
    {
      ...
      children: r ? /* @__PURE__ */ $(Et, { children: [
        gi(a, r, !0),
        /* @__PURE__ */ d(Bc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ d(Mi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ d(_s, {}) }) : gi(i, r, !1)
      ] }) : b
    }
  );
...
function Zh(e) {
  const [t, r] = fe(void 0), { parentMenuItem: n, parentItemProps: o, menuDefinition: a } = e, i = (f) => {
    ...
    let f = tl(a).filter((m) => "menuItem" in m.group);
    if (!(n != null && n.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return f = f.filter(
      (m) => "menuItem" in m.group && m.group.menuItem === n.id
    ), /* @__PURE__ */ d(ra, { ...e, includedGroups: f });
  };
...
function eg(e) {
  ...
  )), /* @__PURE__ */ d(ra, { ...e, includedGroups: a });
}
function tg({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ $(
    Ai,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d(Fc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ d(
          eg,
          {
            commandHandler: e,
            menuDefinition: t,
...
const al = /* @__PURE__ */ N.forwardRef(function(t, r) {
  ...
  } = t, g = ge(t, cg), p = N.useRef(null), h = N.useRef({
    keys: [],
    repeating: !0,
  ...
  const u = (x) => {
    ...
    if (y === "ArrowDown")
      x.preventDefault(), yr(E, T, f, c, io);
    else if (y === "ArrowUp")
      x.preventDefault(), yr(E, T, f, c, bi);
    else if (y === "Home")
      x.preventDefault(), yr(E, null, f, c, io);
    else if (y === "End")
      x.preventDefault(), yr(E, null, f, c, bi);
    else if (y.length === 1) {
      ...
      C.previousKeyMatched && (_ || yr(E, T, !1, c, io, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    m && m(x);
  }, b = We(p, r);
  let w = -1;
...
const pg = al, dg = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], ug = {
  ...
  } = t, x = ge(t, dg), E = N.useRef(null), y = We(E, l.ref, r), T = (z) => (G) => {
    if (z) {
      const B = E.current;
      G === void 0 ? z(B) : z(B, G);
    }
...
const Cg = ["className", "component", "elevation", "square", "variant"], Sg = (e) => {
  ...
  return P({
    ...
    backgroundImage: `linear-gradient(${hn("#fff", mi(t.elevation))}, ${hn("#fff", mi(t.elevation))})`
  }, e.vars && {
...
const Mg = (e) => {
  ...
  const i = ft({
    ...
    TransitionComponent: T = To,
    transitionDuration: C = "auto",
    TransitionProps: {
      onEntering: I
    } = {},
    disableScrollLock: R = !1
  } = i, _ = ge(i.TransitionProps, $g), k = ge(i, _g), M = (n = E == null ? void 0 : E.paper) != null ? n : O, j = N.useRef(), z = We(j, M.ref), G = P({}, i, {
    anchorOrigin: f,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
...
`));
    ...
    return {
      top: se.top + vi(se, f.vertical),
      left: se.left + yi(se, f.horizontal)
    };
...
const Bg = ["onEntering"], Lg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Fg = {
  ...
  const a = ft({
    ...
    slots: O = {},
    slotProps: x = {}
  } = a, E = ge(a.TransitionProps, Bg), y = ge(a, Lg), T = Yr(), C = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), R = zg(I), _ = i && !f && g, k = N.useRef(null), M = (V, S) => {
...
const vt = "scrBook", Kg = "scrRef", $t = "source", Jg = "details", Zg = "Scripture Reference", Qg = "Scripture Book", fl = "Type", eb = "Details";
function tb(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      cell: (n) => {
        ...
        return n.row.getIsGrouped() ? he.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === vt ? Wn(o.start) : void 0;
      },
      getGroupingValue: (n) => n.start.bookNum,
      sortingFn: (n, o) => fo(n.original.start, o.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (n) => Wn(n.start),
      id: Kg,
      header: void 0,
      cell: (n) => {
        const o = n.row.original;
        return n.row.getIsGrouped() ? void 0 : Wn(o.start);
      },
      sortingFn: (n, o) => fo(n.original.start, o.original.start),
      enableGrouping: !1
    },
...
const rb = (e) => {
  ...
  let r = 0;
  return e.end && ({ offset: r } = e.end), !e.end || fo(e.start, e.end) === 0 ? `${Xn(e.start)}+${t}` : `${Xn(e.start)}+${t}-${Xn(e.end)}+${r}`;
...
function i0({
  ...
  Je(() => {
    if (l) {
      ...
      if (_.length === 1) {
        const k = u.find((M) => xi(M) === _[0]) || void 0;
        k && l(k);
      }
    }
  }, [p, u, l, w]);
    ...
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d(Qt, { position: "item-aligned", children: /* @__PURE__ */ d(Op, { children: E.map((R) => /* @__PURE__ */ d(Ke, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ $(Cn, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ d(Sn, { children: w.getHeaderGroups().map((R) => /* @__PURE__ */ d(wt, { children: R.headers.filter((_) => _.column.columnDef.header).map((_) => (
      ...
      /* @__PURE__ */ d(On, { children: w.getRowModel().rows.map((R, _) => /* @__PURE__ */ d(
        wt,
        {
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ $(
                    Te,
                    {
                      ...
                      children: [
                        ...
                        !R.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ d(Ri, {}) : /* @__PURE__ */ d(bc, {})),
                        " ",
...
bl.displayName = ji.Root.displayName;
...
const qr = wn(({ className: e, ...t }, r) => /* @__PURE__ */ d(vc, { size: 35, className: D("pr-animate-spin", e), ...t, ref: r }));
...
), vl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  Bi.Root,
  {
    ref: r,
    className: D("pr-twp pr-font-sans", ab(), e),
    ...t
  }
));
vl.displayName = Bi.Root.displayName;
function m0({
  id: e,
  isDisabled: t = !1,
  hasError: r = !1,
...
function h0({
  ...
  const a = Mt(void 0);
  return /* @__PURE__ */ d("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ d(Gc, { position: "static", id: n, children: /* @__PURE__ */ $(
    Wc,
    {
...
), sb = U.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ d("div", { ref: n, role: "alert", className: D(ib({ variant: t }), e), ...r }));
...
const cb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("div", { ref: r, className: D("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
...
const fb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d("p", { ref: r, className: D("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
bb.displayName = mo.Root.displayName;
const b0 = je.Root, vb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ d(
  je.List,
  {
    ref: r,
    className: D(
  ...
  return /* @__PURE__ */ d(
    Te,
    {
      ...
      children: e ? /* @__PURE__ */ d(qr, { size: 15 }) : /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ d(yc, { size: 25, className: D("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
...
const xb = ["children", "options"], Ei = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), ki = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Eb = ["style", "script"], kb = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Nb = /mailto:/i, Tb = /\n{2,}$/, yl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, Cb = /^ *> ?/gm, Sb = /^ {2,}\n/, Ob = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, wl = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, xl = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Rb = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, Pb = /^(?:\n *)*\n/, $b = /\r\n?/g, _b = /^\[\^([^\]]+)](:.*)\n/, Ib = /^\[\^([^\]]+)]/, Mb = /\f/g, Ab = /^\s*?\[(x|\s)\]/, El = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, kl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, Nl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, So = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, Db = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, Tl = /^<!--[\s\S]*?(?:-->)/, jb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, Oo = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, Bb = /^\{.*\}$/, Lb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, Fb = /^<([^ >]+@[^ >]+)>/, Vb = /^<([^ >]+:\/[^ >]+)>/, zb = /-([a-z])?/gi, Cl = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, Ub = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, Hb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, Gb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, Wb = /(\[|\])/g, Xb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, Yb = /\t/g, qb = /^ *\| */, Kb = /(^ *\||\| *$)/g, Jb = / *$/, Zb = /^ *:-+: *$/, Qb = /^ *:-+ *$/, ev = /^ *-+: *$/, tv = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, rv = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, nv = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, ov = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, av = /^\\([^0-9A-Za-z\s])/, iv = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, sv = /^\n+/, lv = /^([ \t]*)/, cv = /\\([^\\])/g, Ni = / *\n+$/, pv = /(?:^|\n)( *)$/, na = "(?:\\d+\\.)", oa = "(?:[*+-])";
function Sl(e) {
  return "( *)(" + (e === 1 ? na : oa) + ") +";
}
const Ol = Sl(1), Rl = Sl(2);
function Pl(e) {
  return new RegExp("^" + (e === 1 ? Ol : Rl));
}
const dv = Pl(1), uv = Pl(2);
function $l(e) {
  return new RegExp("^" + (e === 1 ? Ol : Rl) + "[^\\n]*(?:\\n(?!\\1" + (e === 1 ? na : oa) + " )[^\\n]*)*(\\n|$)", "gm");
}
const _l = $l(1), Il = $l(2);
...
function Ti(e, t) {
  const r = t === 1, n = r ? Al : Dl, o = r ? _l : Il, a = r ? dv : uv;
  return { t(i, l, c) {
    const f = pv.exec(c);
...
const fv = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, mv = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, jl = [yl, wl, xl, El, Nl, kl, Tl, Cl, _l, Al, Il, Dl], hv = [...jl, /^[^\n]+(?:  \n|\n{2,})/, So, Oo];
function gv(e) {
...
function vv(e, t, r) {
  r._ = !0;
  const n = Ci(e[1], t, r), o = e[2].replace(Kb, "").split("|").map(bv), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(f) {
      return Ci(f, l, c);
    });
...
`))
  ...
  let n = "";
  e.split(`
`).every((a) => !jl.some((i) => i.test(a)) && (n += a + `
`, a.trim()));
  const o = n.trimEnd();
  return o == "" ? null : [n, o];
}
...
var ae;
function kv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || gv, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, ki, t.namedCodesToUnicode) : ki;
  const r = t.createElement || N.createElement;
  function n(p, h, ...u) {
    const b = po(t.overrides, `${p}.props`, {});
    return r(function(w, O) {
      const x = po(O, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : po(O, `${w}.component`, w) : w;
  ...
  function a(p) {
    ...
    return h ? h.reduce(function(u, b, w) {
      ...
      if (O !== -1) {
        ...
        }(b.slice(O + 1).trim()), y = Ei[x] || x, T = u[y] = function(C, I) {
        ...
        typeof T == "string" && (So.test(T) || Oo.test(T)) && (u[y] = N.cloneElement(o(T.trim()), { key: w }));
      } else
        b !== "style" && (u[Ei[b] || b] = !0);
      return u;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: st(yl), i: ae.HIGH, l: (p, h, u) => ({ v: h(p[0].replace(Cb, ""), u) }), h: (p, h, u) => n("blockquote", { key: u.k }, h(p.v, u)) }, breakLine: { t: wr(Sb), i: ae.HIGH, l: lo, h: (p, h, u) => n("br", { key: u.k }) }, breakThematic: { t: st(Ob), i: ae.HIGH, l: lo, h: (p, h, u) => n("hr", { key: u.k }) }, codeBlock: { t: st(xl), i: ae.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, h, u) => n("pre", { key: u.k }, n("code", It({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: st(wl), i: ae.MAX, l: (p) => ({ O: a(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: bt(Rb), i: ae.LOW, l: (p) => ({ v: p[2] }), h: (p, h, u) => n("code", { key: u.k }, p.v) }, footnote: { t: st(_b), i: ae.MAX, l: (p) => (i.push({ I: p[2], j: p[1] }), {}), h: co }, footnoteReference: { t: gt(Ib), i: ae.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B) }, n("sup", { key: u.k }, p.v)) }, gfmTask: { t: gt(Ab), i: ae.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, h, u) => n("input", { checked: p.R, key: u.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? kl : El), i: ae.HIGH, l: (p, h, u) => ({ v: dn(h, p[2], u), T: t.slugify(p[2]), C: p[1].length }), h: (p, h, u) => n(`h${p.C}`, { id: p.T, key: u.k }, h(p.v, u)) }, headingSetext: { t: st(Nl), i: ae.MAX, l: (p, h, u) => ({ v: dn(h, p[1], u), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: wr(Tl), i: ae.HIGH, l: () => ({}), h: co }, image: { t: bt(mv), i: ae.HIGH, l: (p) => ({ D: p[1], B: Oi(p[2]), F: p[3] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D || void 0, title: p.F || void 0, src: Yt(p.B) }) }, link: { t: gt(fv), i: ae.LOW, l: (p, h, u) => ({ v: wv(h, p[1], u), B: Oi(p[2]), F: p[3] }), h: (p, h, u) => n("a", { key: u.k, href: Yt(p.B), title: p.F }, h(p.v, u)) }, linkAngleBraceStyleDetector: { t: gt(Vb), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, h) => h.N ? null : gt(Lb)(p, h), i: ae.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: gt(Fb), i: ae.MAX, l(p) {
    let h = p[1], u = p[1];
    return Nb.test(u) || (u = "mailto:" + u), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: u, type: "link" };
  } }, orderedList: Ti(n, 1), unorderedList: Ti(n, 2), newlineCoalescer: { t: st(Pb), i: ae.LOW, l: lo, h: () => `
` }, paragraph: { t: yv, i: ae.LOW, l: so, h: (p, h, u) => n("p", { key: u.k }, h(p.v, u)) }, ref: { t: gt(Ub), i: ae.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: co }, refImage: { t: bt(Hb), i: ae.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, h, u) => n("img", { key: u.k, alt: p.D, src: Yt(l[p.P].B), title: l[p.P].F }) }, refLink: { t: gt(Gb), i: ae.MAX, l: (p, h, u) => ({ v: h(p[1], u), Z: h(p[0].replace(Wb, "\\$1"), u), P: p[2] }), h: (p, h, u) => l[p.P] ? n("a", { key: u.k, href: Yt(l[p.P].B), title: l[p.P].F }, h(p.v, u)) : n("span", { key: u.k }, h(p.Z, u)) }, table: { t: st(Cl), i: ae.HIGH, l: vv, h: (p, h, u) => n("table", { key: u.k }, n("thead", null, n("tr", null, p.L.map(function(b, w) {
    return n("th", { key: w, style: Si(p, w) }, h(b, u));
  }))), n("tbody", null, p.A.map(function(b, w) {
    return n("tr", { key: w }, b.map(function(O, x) {
      return n("td", { key: x, style: Si(p, x) }, h(O, u));
    }));
  }))) }, tableSeparator: { t: function(p, h) {
    return h.$ ? (h._ = !0, qb.exec(p)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: wr(iv), i: ae.MIN, l: (p) => ({ v: p[0].replace(Db, (h, u) => t.namedCodesToUnicode[u] ? t.namedCodesToUnicode[u] : h) }), h: (p) => p.v }, textBolded: { t: bt(tv), i: ae.MED, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("strong", { key: u.k }, h(p.v, u)) }, textEmphasized: { t: bt(rv), i: ae.LOW, l: (p, h, u) => ({ v: h(p[2], u) }), h: (p, h, u) => n("em", { key: u.k }, h(p.v, u)) }, textEscaped: { t: bt(av), i: ae.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: bt(nv), i: ae.LOW, l: so, h: (p, h, u) => n("mark", { key: u.k }, h(p.v, u)) }, textStrikethroughed: { t: bt(ov), i: ae.LOW, l: so, h: (p, h, u) => n("del", { key: u.k }, h(p.v, u)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(So), i: ae.HIGH, l(p, h, u) {
    const [, b] = p[3].match(lv), w = new RegExp(`^${b}`, "gm"), O = p[3].replace(w, ""), x = (E = O, hv.some((I) => I.test(E)) ? xv : dn);
    var E;
    const y = p[1].toLowerCase(), T = Eb.indexOf(y) !== -1;
    u.N = u.N || y === "a";
    const C = T ? p[3] : x(h, O, u);
    return u.N = !1, { O: a(p[2]), v: C, G: T, H: T ? y : p[1] };
  }, h: (p, h, u) => n(p.H, It({ key: u.k }, p.O), p.G ? p.v : h(p.v, u)) }, c.htmlSelfClosing = { t: wr(Oo), i: ae.HIGH, l: (p) => ({ O: a(p[2] || ""), H: p[1] }), h: (p, h, u) => n(p.H, It({}, p.O, { key: u.k })) });
  const f = function(p) {
    let h = Object.keys(p);
    function u(b, w) {
      let O = [], x = "";
...
const Tv = wn((e, t) => /* @__PURE__ */ $(
  Te,
  {
    ...
    ...e,
    children: [
      /* @__PURE__ */ d(wc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ d(
        xn,
        {
...
function k0({ id: e, groups: t }) {
  return /* @__PURE__ */ d("div", { id: e, children: /* @__PURE__ */ $(Io, { children: [
    /* @__PURE__ */ d(Gi, { asChild: !0, children: /* @__PURE__ */ d(Tv, {}) }),
    /* @__PURE__ */ d(Nn, { children: t.map((r) => /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ d(Vr, { children: r.label }),
      /* @__PURE__ */ d(up, { children: r.items.map((n) => /* @__PURE__ */ d("div", { children: n.itemType === 0 ? /* @__PURE__ */ d(Mo, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ d(Xi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ d(Tn, {})
    ] }, r.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ $("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ d(xc, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ $("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          ...
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ d(kc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          )
        ] })
...
export {
  ...
  hp as DropdownMenuShortcut,
  Xv as DropdownMenuSub,
  mp as DropdownMenuSubContent,
  fp as DropdownMenuSubTrigger,
