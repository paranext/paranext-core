...
const Ao = bt.Portal, Xn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  bt.Overlay,
  {
    ref: n,
    className: c(
...
Xn.displayName = bt.Overlay.displayName;
...
jo.displayName = bt.Content.displayName;
...
zo.displayName = bt.Title.displayName;
...
Bo.displayName = bt.Description.displayName;
...
V(ct, "Original", new ct(ft.Original)), V(ct, "Septuagint", new ct(ft.Septuagint)), V(ct, "Vulgate", new ct(ft.Vulgate)), V(ct, "English", new ct(ft.English)), V(ct, "RussianProtestant", new ct(ft.RussianProtestant)), V(ct, "RussianOrthodox", new ct(ft.RussianOrthodox));
let Vt = ct;
function Tn(t, e) {
  const n = e[0];
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Vt(ft[i]);
        } catch {
...
function ra(t, e, n, o) {
  const a = L(() => {
    if (t.chapterNum > 1)
      ...
      if (u > 0) {
        const l = e[u - 1], p = Math.max(gt(l), 1);
        o({
          book: l,
          chapterNum: p,
          verseNum: 1
...
function Vn({
  ...
  if (t)
    return /* @__PURE__ */ r(Ot, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: gt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      zt,
      {
        value: `${t} ${Dt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function yi({
  ...
  }, [x, N, k, t.book, t.chapterNum]), /* @__PURE__ */ d(Wt, { open: p, onOpenChange: Nt, children: [
    /* @__PURE__ */ r(Zt, { asChild: !0, children: /* @__PURE__ */ r(
      I,
      {
        ...
        children: [
          ...
          !B && /* @__PURE__ */ d(qt, { ref: pt, children: [
            x === "books" && /* @__PURE__ */ d(ae, { children: [
              ...
              k && gt(k.book) > 1 && /* @__PURE__ */ d(ae, { children: [
...
const Ft = U.Root, ma = U.Group, Xt = U.Value, ua = St(
...
function Ca({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", id: w, children: [
    ...
    /* @__PURE__ */ d(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: x.getHeaderGroups().map((N) => /* @__PURE__ */ r(Ct, { children: N.headers.map((C) => /* @__PURE__ */ r(le, { children: C.isPlaceholder ? void 0 : oe(C.column.columnDef.header, C.getContext()) }, C.id)) }, N.id)) }),
      /* @__PURE__ */ r(Se, { children: (S = x.getRowModel().rows) != null && S.length ? x.getRowModel().rows.map((N) => /* @__PURE__ */ r(
        ...
        N.id
      )) : /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(Ht, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Ma({
  ...
  return /* @__PURE__ */ d(Ce, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(_e, { stickyHeader: !0, children: /* @__PURE__ */ d(Ct, { children: [
...
function Bi({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), h = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), b = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), x = yt(n, "%webView_inventory_scope_verse%"), S = yt(n, "%webView_inventory_filter_text%"), N = yt(
    ...
    for (let Nt = 0; Nt < T; Nt++)
      Z.push(
        Ia(
          ((dt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : dt[Nt]) || "Additional Item",
          Nt + 1
        )
      );
    return [...Z, ...u];
...
const kt = "scrBook", ts = "scrRef", Mt = "source", es = "details", ns = "Scripture Reference", rs = "Scripture Book", xr = "Type", os = "Details";
function as(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? z.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === kt ? Lt(a.start) : void 0;
      },
...
function $i({
  ...
  const [l, p] = O([]), [g, h] = O([{ id: kt, desc: !1 }]), [f, b] = O({}), y = H(
  ...
  return /* @__PURE__ */ d("div", { id: u, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(Ce, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(_e, { children: S.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.filter((E) => E.column.columnDef.header).map((E) => (
...
), xs = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: c(vs({ variant: e }), t), ...n }));
