import Pi, { jsx as i, jsxs as x, Fragment as nt } from "react/jsx-runtime";
import * as M from "react";
import I, { forwardRef as Kn, useCallback as Be, useState as pe, useRef as gt, useEffect as Qe, useLayoutEffect as Ho, useMemo as _e } from "react";
import { History as _i, ChevronRight as Ua, Check as Jn, Circle as Ga, ArrowDownWideNarrow as $i, Clock as Ii, Bookmark as Ai, X as Di, Search as Mi, ChevronsUpDown as Bi, FilterIcon as ji, ChevronDown as Zn, ChevronUp as Vi, ArrowLeftIcon as Li, ChevronLeftIcon as zi, ChevronRightIcon as Fi, ArrowRightIcon as Ui, CircleCheckIcon as Gi, CircleXIcon as Hi, CircleHelpIcon as Xi, ArrowUpIcon as Yi, ArrowDownIcon as Wi, ArrowUpDownIcon as qi, ChevronLeft as Ki, LoaderCircle as Ji, Download as Zi, Filter as Qi, User as el, Link as tl, CircleHelp as nl } from "lucide-react";
import bt, { clsx as rl } from "clsx";
import { extendTailwindMerge as ol } from "tailwind-merge";
import * as we from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as al } from "@radix-ui/react-dropdown-menu";
import { getChaptersForBook as sl, deepEqual as to, substring as il, formatScrRef as Tr, compareScrRefs as zr, scrRefToBBBCCCVVV as Cr, getLocalizeKeyForScrollGroupId as ue, NumberFormat as ll, formatBytes as cl } from "platform-bible-utils";
import { Slot as dl } from "@radix-ui/react-slot";
import { cva as Qn } from "class-variance-authority";
import * as Ha from "@radix-ui/react-label";
...
import { useReactTable as Xa, getCoreRowModel as Ya, getPaginationRowModel as ul, getSortedRowModel as Wa, getFilteredRowModel as pl, flexRender as cn, getExpandedRowModel as wl, getGroupedRowModel as fl } from "@tanstack/react-table";
...
import * as qa from "@radix-ui/react-toggle";
import * as Oe from "@radix-ui/react-tabs";
import * as Ka from "@radix-ui/react-separator";
import ml, { ThemeContext as hl, internal_processStyles as gl } from "@mui/styled-engine";
import { MenuItem as bl, ListItemText as vl, ListItemIcon as Ja, Menu as yl, Grid as Za, List as xl, IconButton as Qa, Drawer as Nl, AppBar as kl, Toolbar as El } from "@mui/material";
import * as Tl from "react-dom";
import An from "react-dom";
import { Toaster as Cl } from "sonner";
import { toast as oh } from "sonner";
import * as on from "@radix-ui/react-slider";
import * as Ur from "@radix-ui/react-switch";
import Sl from "markdown-to-jsx";
const Ol = ol({ prefix: "tw-" });
function T(...e) {
  return Ol(rl(e));
}
...
var Pl = Object.defineProperty, _l = (e, t, n) => t in e ? Pl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, te = (e, t, n) => _l(e, typeof t != "symbol" ? t + "" : t, n);
const yt = [
  "GEN",
  "EXO",
  "LEV",
...
function Ll(e) {
  return es[e - 1].includes("*obsolete*");
}
function zl() {
  const e = {};
...
te(Pe, "Original", new Pe(He.Original)), te(Pe, "Septuagint", new Pe(He.Septuagint)), te(Pe, "Vulgate", new Pe(He.Vulgate)), te(Pe, "English", new Pe(He.English)), te(Pe, "RussianProtestant", new Pe(He.RussianProtestant)), te(Pe, "RussianOrthodox", new Pe(He.RussianOrthodox));
let pt = Pe;
function Yo(e, t) {
  const n = t[0];
...
const Ee = class ne {
  constructor(t, n, r, o) {
    if (te(this, "firstChapter"), te(this, "lastChapter"), te(this, "lastVerse"), te(this, "hasSegmentsDefined"), te(this, "text"), te(this, "BBBCCCVVVS"), te(this, "longHashCode"), te(this, "versification"), te(this, "rtlMark", "‏"), te(this, "_bookNum", 0), te(this, "_chapterNum", 0), te(this, "_verseNum", 0), te(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        const a = t, s = n != null && n instanceof pt ? n : void 0;
        this.setEmpty(s), this.parse(a);
      } else if (t != null && typeof t == "number") {
        const a = n != null && n instanceof pt ? n : void 0;
        ...
        if (t != null && t instanceof ne) {
          ...
          if (t == null)
            return;
          const a = t instanceof pt ? t : ne.defaultVersification;
          this.setEmpty(a);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return s && (c = new pt(s)), n ? new ne(n, r.toString(), l, c) : new ne();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = a[0], a.length > 1)
        try {
          const s = +a[1].trim();
          this.versification = new pt(He[s]);
        } catch {
...
te(Ee, "defaultVersification", pt.English), te(Ee, "verseRangeSeparator", "-"), te(Ee, "verseSequenceIndicator", ","), te(Ee, "verseRangeSeparators", [Ee.verseRangeSeparator]), te(Ee, "verseSequenceIndicators", [Ee.verseSequenceIndicator]), te(Ee, "chapterDigitShifter", 1e3), te(Ee, "bookDigitShifter", Ee.chapterDigitShifter * Ee.chapterDigitShifter), te(Ee, "bcvMaxValue", Ee.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
te(Ee, "ValidStatusType", as);
class Qt extends Error {
}
const ao = we.Root, ss = we.Trigger, Fl = we.Group, xm = we.Portal, Nm = we.Sub, km = we.RadioGroup, Ul = I.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
    ...
    children: [
      n,
      /* @__PURE__ */ i(Ua, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
Ul.displayName = we.SubTrigger.displayName;
const Gl = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  we.SubContent,
  {
    ref: n,
    className: T(
...
Gl.displayName = we.SubContent.displayName;
...
const is = I.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Item,
  {
    ref: r,
    className: T(
...
is.displayName = we.Item.displayName;
const so = I.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ x(
  we.CheckboxItem,
  {
    ref: o,
    className: T(
...
const ls = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(we.ItemIndicator, { children: /* @__PURE__ */ i(Ga, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
ls.displayName = we.RadioItem.displayName;
...
function Yl({
  ...
  const a = Array.from({ length: t }, (l, c) => c + 1), s = Be(
    (l) => {
      o(l);
    },
    [o]
...
const dn = oe.allBookIds, ql = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Wo = ["OT", "NT", "DC"], Kl = 32 + 32 + 32, Jl = [
  /^(\w+)$/i,
  ...
  OT: dn.filter((n) => oe.isBookOT(n)),
  NT: dn.filter((n) => oe.isBookNT(n)),
  DC: dn.filter((n) => oe.isBookDC(n))
})[e], en = (e) => sl(oe.bookIdToNumber(e));
function Ql() {
  return dn.map((t) => oe.bookIdToEnglishName(t));
}
function ec(e) {
...
function tc(e) {
  ...
  if (ec(t))
    return dn.find((r) => oe.bookIdToEnglishName(r) === t);
}
function Em({ scrRef: e, handleSubmit: t }) {
  const [n, r] = pe(""), [o, a] = pe(
    oe.bookNumberToId(e.bookNum)
  ), [s, l] = pe(e.chapterNum ?? 0), [c, d] = pe(
    oe.bookNumberToId(e.bookNum)
  ), [u, m] = pe(!1), [w, b] = pe(u), v = gt(void 0), f = gt(void 0), h = gt(void 0), E = Be(
    (N) => Zl(N).filter((B) => {
    ...
    (N, B, D, J) => {
      if (l(
        oe.bookNumberToId(e.bookNum) !== N ? 1 : e.chapterNum
      ), B || en(N) === -1) {
        t({
    ...
    Jl.forEach((N) => {
      const B = n.match(N);
      if (B) {
        const [D, J = void 0, q = void 0] = B.slice(1), U = tc(D);
    ...
    (N) => {
      u ? (N.key === "ArrowDown" || N.key === "ArrowUp") && (typeof h < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      h.current !== null ? h.current.focus() : typeof f < "u" && // Ref uses null
      // eslint-disable-next-line no-null/no-null
      f.current !== null && f.current.focus(), N.preventDefault()) : m(!0);
    },
    [u]
  ), C = (N) => {
    const { key: B } = N;
    ...
    if (c === o) {
      ...
      s + D <= 0 || s + D > en(c) ? l(0) : D !== 0 && (l(s + D), N.preventDefault());
    }
  };
  return Qe(() => {
    ...
    const N = setTimeout(() => {
      if (w && f.current && h.current) {
        const D = h.current.offsetTop - Kl;
  ...
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: u, onOpenChange: k, children: [
    /* @__PURE__ */ i(ss, { asChild: !0, children: /* @__PURE__ */ i(
      Rl,
      {
        ...
        handleKeyDown: H,
        handleOnClick: () => {
          a(oe.bookNumberToId(e.bookNum)), d(oe.bookNumberToId(e.bookNum)), l(e.chapterNum > 0 ? e.chapterNum : 0), m(!0), v.current.focus();
        },
        onFocus: () => {
          O.current = !0;
        },
    ...
    /* @__PURE__ */ x(
      tr,
      {
        ...
        children: [
          ...
          Wo.map(
            (N, B) => E(N).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ i(Nn, { className: "tw-font-semibold tw-text-foreground/80", children: ql[N] }),
              E(N).map((D) => /* @__PURE__ */ i("div", { children: /* @__PURE__ */ i(
                Xl,
                {
                  bookId: D,
...
const nc = Qn(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? dl : "button", { className: T(nc({ variant: t, size: n, className: e })), ref: a, ...o })
);
be.displayName = "Button";
const rc = Qn(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Ge = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(Ha.Root, { ref: n, className: T("pr-twp", rc(), e), ...t }));
Ge.displayName = Ha.Root.displayName;
const cs = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  fn.Root,
  {
...
cs.displayName = fn.Root.displayName;
const Gr = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  fn.Item,
  {
    ...
    ...t,
    children: /* @__PURE__ */ i(fn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ i(Ga, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Gr.displayName = fn.Item.displayName;
const oc = mn.Root, ac = mn.Trigger, ds = I.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ i(mn.Portal, { children: /* @__PURE__ */ i(
  mn.Content,
  {
    ref: o,
    align: t,
...
ds.displayName = mn.Content.displayName;
const sc = Ye.Portal, us = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Ye.Overlay,
  {
    ref: n,
    className: T(
...
us.displayName = Ye.Overlay.displayName;
const ic = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(sc, { children: [
  /* @__PURE__ */ i(us, {}),
  /* @__PURE__ */ x(
    Ye.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x(Ye.Close, { className: "tw-absolute tw-right-4 tw-top-4 tw-rounded-sm tw-opacity-70 tw-ring-offset-background tw-transition-opacity hover:tw-opacity-100 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-pointer-events-none data-[state=open]:tw-bg-accent data-[state=open]:tw-text-muted-foreground", children: [
          /* @__PURE__ */ i(Di, { className: "tw-h-4 tw-w-4" }),
...
lc.displayName = Ye.Title.displayName;
...
cc.displayName = Ye.Description.displayName;
...
const ws = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
...
ws.displayName = Se.Input.displayName;
const fs = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Se.List,
  {
    ref: n,
...
fs.displayName = Se.List.displayName;
const ms = I.forwardRef((e, t) => /* @__PURE__ */ i(Se.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
ms.displayName = Se.Empty.displayName;
...
dc.displayName = Se.Group.displayName;
const uc = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Se.Separator,
  {
    ref: n,
...
uc.displayName = Se.Separator.displayName;
...
hs.displayName = Se.Item.displayName;
function pc(e) {
...
function qo({
  ...
  const [b, v] = pe(!1);
  return /* @__PURE__ */ x(oc, { open: b, onOpenChange: v, ...w, children: [
    /* @__PURE__ */ i(ac, { asChild: !0, children: /* @__PURE__ */ x(
      be,
      {
        variant: d,
        role: "combobox",
        "aria-expanded": b,
        id: e,
        className: T("tw-w-[200px] tw-justify-between", n),
        disabled: m,
        children: [
          /* @__PURE__ */ i("span", { className: "tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: r ? a(r) : s }),
          /* @__PURE__ */ i(Bi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ i(ds, { className: "tw-w-[200px] tw-p-0", dir: u, children: /* @__PURE__ */ x(ps, { children: [
      /* @__PURE__ */ i(ws, { dir: u, placeholder: l, className: "tw-text-inherit" }),
      /* @__PURE__ */ i(ms, { children: c }),
      /* @__PURE__ */ i(fs, { children: t.map((f) => /* @__PURE__ */ x(
        hs,
        {
          value: a(f),
          onSelect: () => {
...
function wc({
  ...
  return /* @__PURE__ */ x(nt, { children: [
    /* @__PURE__ */ i(Ge, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ i(
      qo,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ i(Ge, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ i(
      qo,
      {
        isDisabled: o,
...
function Cm({
  ...
  const u = Sr(d, "%webView_bookSelector_currentBook%"), m = Sr(d, "%webView_bookSelector_choose%"), w = Sr(d, "%webView_bookSelector_chooseBooks%"), [b, v] = pe(
    "current book"
    /* CURRENT_BOOK */
  ), f = (h) => {
    v(h), e(h);
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Ge, { className: "tw-ml-1", children: u })
          ] }),
          /* @__PURE__ */ i(Ge, { className: "tw-flex tw-items-center", children: t }),
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Ge, { className: "tw-ml-1", children: w })
          ] }),
          /* @__PURE__ */ i(Ge, { className: "tw-flex tw-items-center", children: r.map((h) => oe.bookIdToEnglishName(h)).join(", ") }),
          /* @__PURE__ */ i(
            be,
            {
...
function mc({ table: e }) {
  return /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ i(al, { asChild: !0, children: /* @__PURE__ */ x(be, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ i(ji, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const jt = ge.Root, hc = ge.Group, Vt = ge.Value, xt = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Trigger,
  {
    ref: r,
    className: T(
...
xt.displayName = ge.Trigger.displayName;
const gs = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  ge.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ i(Vi, { className: "tw-h-4 tw-w-4" })
  }
));
gs.displayName = ge.ScrollUpButton.displayName;
const bs = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  ge.ScrollDownButton,
  {
    ref: n,
    className: T("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
bs.displayName = ge.ScrollDownButton.displayName;
const Nt = I.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(ge.Portal, { children: /* @__PURE__ */ x(
  ge.Content,
  {
    ref: o,
    className: T(
...
Nt.displayName = ge.Content.displayName;
...
const De = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Item,
  {
    ref: r,
    className: T(
...
De.displayName = ge.Item.displayName;
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ x(
        jt,
        {
          ...
          children: [
            /* @__PURE__ */ i(xt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ i(Vt, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ i(Nt, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ i(De, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Lt = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "td",
  {
    ref: n,
...
function Nc({
  ...
  var h;
  const [l, c] = pe([]), [d, u] = pe([]), [m, w] = pe({}), [b, v] = pe({}), f = Xa({
    data: t,
    columns: e,
    getCoreRowModel: Ya(),
    ...n && { getPaginationRowModel: ul() },
    onSortingChange: c,
    getSortedRowModel: Wa(),
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(rr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(or, { stickyHeader: a, children: f.getHeaderGroups().map((E) => /* @__PURE__ */ i(st, { children: E.headers.map((A) => /* @__PURE__ */ i(hn, { children: A.isPlaceholder ? void 0 : cn(A.column.columnDef.header, A.getContext()) }, A.id)) }, E.id)) }),
      /* @__PURE__ */ i(ar, { children: (h = f.getRowModel().rows) != null && h.length ? f.getRowModel().rows.map((E) => /* @__PURE__ */ i(
        st,
        {
          onClick: () => s(E, f),
          "data-state": E.getIsSelected() && "selected",
          children: E.getVisibleCells().map((A) => /* @__PURE__ */ i(Lt, { children: cn(A.column.columnDef.cell, A.getContext()) }, A.id))
        },
        E.id
      )) : /* @__PURE__ */ i(st, { children: /* @__PURE__ */ i(Lt, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function kc({
  ...
  return /* @__PURE__ */ x(rr, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(or, { stickyHeader: !0, children: /* @__PURE__ */ x(st, { children: [
      /* @__PURE__ */ i(hn, { children: r }),
      /* @__PURE__ */ i(hn, { children: o })
    ] }) }),
    /* @__PURE__ */ i(ar, { children: a.length > 0 && a.map((s) => /* @__PURE__ */ x(
      st,
      {
        onClick: () => {
          t(s.reference);
        ...
        children: [
          /* @__PURE__ */ i(Lt, { children: `${oe.bookNumberToEnglishName(s.reference.bookNum)} ${s.reference.chapterNum}:${s.reference.verseNum}` }),
          /* @__PURE__ */ i(Lt, { children: s.text })
        ]
      },
...
const Ec = (e) => e.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Ko = (e) => {
...
}, Cc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", vs = Qn(
  ...
  {
    ref: o,
    className: T(vs({ variant: t, size: n, className: e })),
    ...r
  }
));
Sc.displayName = qa.Root.displayName;
const ys = I.createContext({
  size: "default",
  variant: "default"
}), xs = I.forwardRef(({ className: e, variant: t, size: n, children: r, ...o }, a) => /* @__PURE__ */ i(
  er.Root,
  {
    ref: a,
...
const sr = (e) => e === "asc" ? /* @__PURE__ */ i(Yi, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ i(Wi, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(qi, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Sm = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => /* @__PURE__ */ x(be, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    sr(t.getIsSorted())
  ] })
}), Oc = (e, t) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ x(be, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    e,
    sr(n.getIsSorted())
  ] })
}), Om = (e) => ({
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ x(be, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    sr(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: a }) => /* @__PURE__ */ i("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ x(be, { variant: "ghost", onClick: () => a.toggleSorting(void 0), children: [
    e,
    sr(a.getIsSorted())
  ] }) }),
  cell: ({ row: a }) => {
    const s = a.getValue("status"), l = a.getValue("item");
    return /* @__PURE__ */ x(xs, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        Ln,
        {
          onClick: () => Or(
  ...
  return Ec(e).forEach((u) => {
    u.startsWith("\\id") && (s = Tc(u), l = 0, c = 0), u.startsWith("\\c") && (l = Ko(u), c = 0), u.startsWith("\\v") && (c = Ko(u), l === 0 && (l = t.chapterNum));
    let m = o.exec(u) ?? void 0;
    for (; m; ) {
      const w = [];
      m.forEach((h) => w.push(h));
      const b = m.index, v = a.find((h) => to(h.items, w)), f = {
        reference: {
          bookNum: s !== void 0 ? s : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: il(u, Math.max(0, b - 25), Math.min(b + 25, u.length))
      };
      if (v)
...
function _m({
  ...
  const m = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), h = Je(n, "%webView_inventory_scope_chapter%"), E = Je(n, "%webView_inventory_scope_verse%"), A = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, g] = pe(!1), [_, L] = pe("all"), [H, C] = pe(""), [P, N] = pe([]), B = _e(() => l ? r instanceof RegExp ? Pc(
    l,
    e,
    a,
    s,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ x(
        jt,
        {
          ...
          defaultValue: _,
          children: [
            /* @__PURE__ */ i(xt, { className: "tw-m-1", children: /* @__PURE__ */ i(Vt, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ x(Nt, { children: [
              /* @__PURE__ */ i(De, { value: "all", children: m }),
              /* @__PURE__ */ i(De, { value: "approved", children: w }),
              /* @__PURE__ */ i(De, { value: "unapproved", children: b }),
              /* @__PURE__ */ i(De, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ x(jt, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        /* @__PURE__ */ i(xt, { className: "tw-m-1", children: /* @__PURE__ */ i(Vt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ x(Nt, { children: [
          /* @__PURE__ */ i(De, { value: "book", children: f }),
          /* @__PURE__ */ i(De, { value: "chapter", children: h }),
          /* @__PURE__ */ i(De, { value: "verse", children: E })
        ] })
      ] }),
      /* @__PURE__ */ i(
        xn,
      ...
      o && /* @__PURE__ */ x("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ i(Ge, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? O })
      ] })
    ] }),
...
const ks = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.List,
  {
    ref: n,
    className: T(
...
ks.displayName = Oe.List.displayName;
...
)), Es = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Content,
  {
    ref: n,
    className: T(
...
Es.displayName = Oe.Content.displayName;
function $m({
  tabList: e,
  onSearch: t,
  searchPlaceholder: n,
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(Ns, { dir: a, children: [
      /* @__PURE__ */ i(ks, { children: e.map((s) => /* @__PURE__ */ i($c, { value: s.value, children: s.value }, s.key)) }),
      e.map((s) => /* @__PURE__ */ i(Es, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const ot = "scrBook", Ic = "scrRef", wt = "source", Ac = "details", Dc = "Scripture Reference", Mc = "Scripture Book", Ts = "Type", Bc = "Details";
function jc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? oe.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === ot ? Tr(o.start) : void 0;
      },
...
function Im({
  ...
  const [d, u] = pe([]), [m, w] = pe([{ id: ot, desc: !1 }]), [b, v] = pe({}), f = _e(
  ...
  Qe(() => {
    if (l) {
      ...
      if (P.length === 1) {
        const N = f.find((B) => Jo(B) === P[0]) || void 0;
        N && l(N);
      }
    }
  }, [b, f, l, E]);
  const A = o ?? Mc, O = a ?? Ts, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${A}`, value: [ot] },
  ...
  }, L = (C, P) => C.getIsGrouped() ? "" : T("banded-row", P % 2 === 0 ? "even" : "odd"), H = (C, P, N) => {
    if (!((C == null ? void 0 : C.length) === 0 || P.depth < N.column.getGroupedIndex())) {
      if (P.getIsGrouped())
        switch (P.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ x(
      jt,
      {
        ...
        children: [
          /* @__PURE__ */ i(xt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ i(Vt, {}) }),
          /* @__PURE__ */ i(Nt, { position: "item-aligned", children: /* @__PURE__ */ i(hc, { children: k.map((C) => /* @__PURE__ */ i(De, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ x(rr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ i(or, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ i(st, { children: C.headers.filter((P) => P.column.columnDef.header).map((P) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ i(hn, { colSpan: P.colSpan, className: "top-0 tw-sticky", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ x("div", { children: [
      ...
      /* @__PURE__ */ i(ar, { children: E.getRowModel().rows.map((C, P) => /* @__PURE__ */ i(
        st,
        {
          ...
          children: C.getVisibleCells().map((N) => {
            if (!(N.getIsPlaceholder() || N.column.columnDef.enableGrouping && !N.getIsGrouped() && (N.column.columnDef.id !== wt || !n)))
              return /* @__PURE__ */ i(
                Lt,
                {
                  className: T(
                  ...
                  children: (() => N.getIsGrouped() ? /* @__PURE__ */ x(
                    be,
                    {
                      variant: "link",
                      ...
                      children: [
                        ...
                        !C.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ i(Ua, {}) : /* @__PURE__ */ i(Ki, {})),
                        " ",
                        cn(N.column.columnDef.cell, N.getContext()),
                        " (",
                        C.subRows.length,
                        ")"
                      ]
...
function Am({
  ...
  return /* @__PURE__ */ x(
    jt,
    {
      ...
      children: [
        /* @__PURE__ */ i(xt, { className: "pr-twp tw-w-auto", children: /* @__PURE__ */ i(
          Vt,
          {
        ...
        /* @__PURE__ */ i(
          ...
          {
            style: { zIndex: 250 },
            children: e.map((a) => /* @__PURE__ */ i(De, { value: `${a}`, children: o[ue(a)] }, `${a}`))
          }
        )
      ]
    }
...
const Cs = I.forwardRef(({ className: e, orientation: t = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  Ka.Root,
  {
    ref: o,
    decorative: n,
...
Cs.displayName = Ka.Root.displayName;
...
function jm({
  ...
  return /* @__PURE__ */ i("div", { id: e, className: t, children: n.map((s) => /* @__PURE__ */ x("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    ...
    /* @__PURE__ */ i(Ge, { children: a ? a(s) : s })
  ] }, s)) });
}
function Lc(e) {
...
function Ze(e, t, n = {
  ...
  return ht(e) && ht(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (ht(t[o]) && o in e && ht(e[o]) ? r[o] = Ze(e[o], t[o], n) : n.clone ? r[o] = ht(t[o]) ? Os(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
...
function Uc() {
  if (Zo)
    return se;
  Zo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, a = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, d = e ? Symbol.for("react.concurrent_mode") : 60111, u = e ? Symbol.for("react.forward_ref") : 60112, m = e ? Symbol.for("react.suspense") : 60113, w = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, f = e ? Symbol.for("react.block") : 60121, h = e ? Symbol.for("react.fundamental") : 60117, E = e ? Symbol.for("react.responder") : 60118, A = e ? Symbol.for("react.scope") : 60119;
  function O(g) {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = d, se.ContextConsumer = l, se.ContextProvider = s, se.Element = t, se.ForwardRef = u, se.Fragment = r, se.Lazy = v, se.Memo = b, se.Portal = n, se.Profiler = a, se.StrictMode = o, se.Suspense = m, se.isAsyncMode = function(g) {
    return k(g) || O(g) === c;
  }, se.isConcurrentMode = k, se.isContextConsumer = function(g) {
    return O(g) === l;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === m || g === w || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === s || g.$$typeof === l || g.$$typeof === u || g.$$typeof === h || g.$$typeof === E || g.$$typeof === A || g.$$typeof === f);
  }, se.typeOf = O, se;
}
var ie = {};
/** @license React v16.13.1
...
function Gc() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === m || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === s || $.$$typeof === l || $.$$typeof === u || $.$$typeof === h || $.$$typeof === E || $.$$typeof === A || $.$$typeof === f);
    }
    function k($) {
    ...
    var g = c, _ = d, L = l, H = s, C = t, P = u, N = r, B = v, D = b, J = n, q = a, U = o, ee = m, ae = !1;
    function re($) {
      return ae || (ae = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), y($) || k($) === c;
    }
    function y($) {
      return k($) === d;
    }
    ...
    ie.AsyncMode = g, ie.ConcurrentMode = _, ie.ContextConsumer = L, ie.ContextProvider = H, ie.Element = C, ie.ForwardRef = P, ie.Fragment = N, ie.Lazy = B, ie.Memo = D, ie.Portal = J, ie.Profiler = q, ie.StrictMode = U, ie.Suspense = ee, ie.isAsyncMode = re, ie.isConcurrentMode = y, ie.isContextConsumer = S, ie.isContextProvider = z, ie.isElement = F, ie.isForwardRef = V, ie.isFragment = W, ie.isLazy = X, ie.isMemo = Y, ie.isPortal = G, ie.isProfiler = K, ie.isStrictMode = Z, ie.isSuspense = de, ie.isValidElementType = O, ie.typeOf = k;
  }()), ie;
}
var ea;
function Rs() {
...
function Yc() {
  if (aa)
    return Dr;
  aa = 1;
  var e = Rs(), t = Hc(), n = uo(), r = Ps(), o = Xc(), a = function() {
  };
...
const $s = co(p.element, _s);
$s.isRequired = co(p.element.isRequired, _s);
const Is = $s, Qc = "exact-prop: ​";
function ed(e) {
...
function td() {
  ...
  return le.ContextConsumer = s, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = w, le.Memo = m, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = u, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === d || h === u || h === b || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === m || h.$$typeof === a || h.$$typeof === s || h.$$typeof === c || h.$$typeof === v || h.getModuleId !== void 0);
  }, le.typeOf = f, le;
}
var ce = {};
/**
...
function nd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), u = Symbol.for("react.suspense_list"), m = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, f = !1, h = !1, E = !1, A = !1, O;
    O = Symbol.for("react.module.reference");
    function k(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || A || j === r || j === d || j === u || E || j === b || v || f || h || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === m || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = s, L = a, H = e, C = c, P = n, N = w, B = m, D = t, J = o, q = r, U = d, ee = u, ae = !1, re = !1;
    function y(j) {
    ...
    ce.ContextConsumer = _, ce.ContextProvider = L, ce.Element = H, ce.ForwardRef = C, ce.Fragment = P, ce.Lazy = N, ce.Memo = B, ce.Portal = D, ce.Profiler = J, ce.StrictMode = q, ce.Suspense = U, ce.SuspenseList = ee, ce.isAsyncMode = y, ce.isConcurrentMode = S, ce.isContextConsumer = z, ce.isContextProvider = F, ce.isElement = V, ce.isForwardRef = W, ce.isFragment = X, ce.isLazy = Y, ce.isMemo = G, ce.isPortal = K, ce.isProfiler = Z, ce.isStrictMode = de, ce.isSuspense = $, ce.isSuspenseList = xe, ce.isValidElementType = k, ce.typeOf = g;
  }()), ce;
}
...
const sd = p.oneOfType([p.func, p.object]), Ds = sd;
function We(e) {
  if (typeof e != "string")
...
function pd(e, t) {
  ...
  return (o) => (a, s, l, c, d, ...u) => {
    ...
    return typeof a[s] < "u" && !a[o] ? new Error(`The prop \`${m}\` of \`${e}\` can only be used together with the \`${o}\` prop.`) : null;
  };
}
function Hn(e, t) {
  typeof e == "function" ? e(t) : e && (e.current = t);
}
const wd = typeof window < "u" ? M.useLayoutEffect : M.useEffect, Ft = wd;
let ua = 0;
function fd(e) {
  const [t, n] = M.useState(e), r = e || t;
  return M.useEffect(() => {
    t == null && (ua += 1, n(`mui-${ua}`));
  }, [t]), r;
}
const pa = M["useId".toString()];
function Ms(e) {
  if (pa !== void 0) {
    const t = pa();
    return e ?? t;
...
const $d = {
  borderRadius: 4
}, Id = $d, Ad = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.string, p.object, p.array]) : {}, it = Ad;
function un(e, t) {
  return t ? Ze(e, t, {
    clone: !1
...
function ve(e) {
  const {
    ...
    return et(s, l, (m) => {
      let w = Xn(d, o, m);
      return m === w && typeof m == "string" && (w = Xn(d, o, `${t}${m === "default" ? "" : We(m)}`, m)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
function Gs(e, t) {
  const n = Us(e.theme);
  return Object.keys(e).map((r) => Ud(e, t, r, n)).reduce(un, {});
}
function me(e) {
  return Gs(e, dr);
}
...
he.propTypes = process.env.NODE_ENV !== "production" ? ur.reduce((e, t) => (e[t] = it, e), {}) : {};
he.filterProps = ur;
...
function pr(...e) {
  const t = e.reduce((r, o) => (o.filterProps.forEach((a) => {
    r[a] = o;
  }), r), {}), n = (r) => Object.keys(r).reduce((o, a) => t[a] ? un(o, t[a](r)) : o, {});
...
const Hd = ze("border", Me), Xd = ze("borderTop", Me), Yd = ze("borderRight", Me), Wd = ze("borderBottom", Me), qd = ze("borderLeft", Me), Kd = ze("borderColor"), Jd = ze("borderTopColor"), Zd = ze("borderRightColor"), Qd = ze("borderBottomColor"), eu = ze("borderLeftColor"), tu = ze("outline", Me), nu = ze("outlineColor"), wr = (e) => {
...
pr(Hd, Xd, Yd, Wd, qd, Kd, Jd, Zd, Qd, eu, wr, tu, nu);
const fr = (e) => {
...
pr(fr, mr, hr, ru, ou, au, su, iu, lu, cu, du, uu);
function Bt(e, t) {
  return t === "grey" ? t : e;
}
const pu = ve({
...
function Eu() {
  function e(n, r, o, a) {
    ...
    const w = cr(o, d) || {};
    return m ? m(s) : et(s, r, (v) => {
      let f = Xn(w, u, v);
      return v === f && typeof v == "string" && (f = Xn(w, u, `${n}${v === "default" ? "" : We(v)}`, v)), c === !1 ? f : {
        [c]: f
      };
    });
  }
  function t(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const u = Dd(a.breakpoints), m = Object.keys(u);
      let w = u;
...
function go(e = {}, ...t) {
  ...
  return d.applyStyles = Tu, d = t.reduce((u, m) => Ze(u, m), d), d.unstable_sxConfig = R({}, mo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return ho({
      sx: m,
      theme: this
    });
...
const Ru = ["ownerState"], Pu = ["variants"], _u = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function $u(e) {
  return Object.keys(e).length === 0;
}
function Iu(e) {
...
const Au = go(), ga = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Mn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Mu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    gl(s, (g) => g.filter((_) => !(_ != null && _.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = Du(ga(d))
    } = l, b = Ne(l, _u), v = u !== void 0 ? u : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), f = m || !1;
    let h;
    process.env.NODE_ENV !== "production" && c && (h = `${c}-${ga(d || "Root")}`);
    let E = zn;
    d === "Root" || d === "root" ? E = r : d ? E = o : Iu(s) && (E = void 0);
    const A = ml(s, R({
      shouldForwardProp: E,
      label: h
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${We(d || "")}`), N === void 0 && (N = `Styled(${ad(s)})`), P.displayName = N;
      }
...
function Bu(e) {
  ...
  return !t || !t.components || !t.components[n] || !t.components[n].defaultProps ? r : Vs(t.components[n].defaultProps, r);
}
function ju({
  props: e,
  name: t,
...
function ba(e) {
  e = Et(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Et(Lu(e)).values : e.values;
...
function Ws(e, t) {
  return e = Et(e), t = bo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, gr(e);
}
function zu(e, t) {
...
const Gu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, At = Zu, Qu = ["mode", "contrastThreshold", "tonalOffset"], ya = {
...
function xa(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Fu(e.main, o) : t === "dark" && (e.dark = zu(e.main, a)));
}
function ep(e = "light") {
  return e === "dark" ? {
    main: $t[200],
...
function sp(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = Ne(e, Qu), a = e.primary || ep(t), s = e.secondary || tp(t), l = e.error || np(t), c = e.info || rp(t), d = e.success || op(t), u = e.warning || ap(t);
  function m(f) {
    const h = va(f, jr.text.primary) >= n ? jr.text.primary : ya.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = va(f, h);
...
The color object needs to have a \`main\` property or a \`${E}\` property.` : zt(11, h ? ` (${h})` : "", E));
...
} });` : zt(12, h ? ` (${h})` : "", JSON.stringify(f.main)));
    return xa(f, "light", A, r), xa(f, "dark", O, r), f.contrastText || (f.contrastText = m(f.main)), f;
  }, b = {
    dark: jr,
    light: ya
  };
...
const ip = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function lp(e) {
...
function cp(e, t) {
  ...
  const b = o / 14, v = m || ((E) => `${E / d * b}rem`), f = (E, A, O, k, g) => R({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(A),
...
const dp = 0.2, up = 0.14, pp = 0.12;
function fe(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${dp})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${up})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${pp})`].join(",");
}
const wp = ["none", fe(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), fe(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), fe(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), fe(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), fe(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), fe(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), fe(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), fe(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), fe(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), fe(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), fe(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), fe(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), fe(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), fe(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), fe(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), fe(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), fe(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), fe(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), fe(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), fe(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), fe(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), fe(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), fe(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), fe(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], fp = wp, mp = ["duration", "easing", "delay"], hp = {
...
function vp(e) {
  const t = R({}, hp, e.easing), n = R({}, gp, e.duration);
  return R({
    getAutoHeightDuration: bp,
    create: (o = ["all"], a = {}) => {
      const {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((u) => `${u} ${typeof s == "string" ? s : Ea(s)} ${l} ${typeof c == "string" ? c : Ea(c)}`).join(",");
    }
  }, e, {
    easing: t,
    duration: n
...
const yp = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, xp = yp, Np = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function kp(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
  ...
  if (d = Ze(d, s), d = t.reduce((u, m) => Ze(u, m), d), process.env.NODE_ENV !== "production") {
    const u = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], m = (w, b) => {
      let v;
      for (v in w) {
        const f = w[v];
        if (u.indexOf(v) !== -1 && Object.keys(f).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const h = lr("", v);
            console.error([`MUI: The \`${b}\` component increases the CSS specificity of the \`${v}\` internal state.`, "You can not override it like this: ", JSON.stringify(w, null, 2), "", `Instead, you need to use the '&.${h}' syntax:`, JSON.stringify({
              root: {
                [`&.${h}`]: f
              }
...
`));
    ...
    Object.keys(d.components).forEach((w) => {
      ...
      b && w.indexOf("Mui") === 0 && m(b, w);
    });
  }
  return d.unstable_sxConfig = R({}, mo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return ho({
      sx: m,
      theme: this
    });
...
const Tp = (e) => zn(e) && e !== "classes", Cp = Mu({
  themeId: yo,
  defaultTheme: vo,
  rootShouldForwardProp: Tp
}), Cn = Cp;
function Sp(e) {
...
const Op = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Rp = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  return {
    ...
    color: (m = (w = (e.vars || e).palette) == null || (w = w[t.color]) == null ? void 0 : w.main) != null ? m : {
  ...
  const r = xo({
    ...
    titleAccess: m,
    viewBox: w = "0 0 24 24"
  } = r, b = Ne(r, Op), v = /* @__PURE__ */ M.isValidElement(o) && o.type === "svg", f = R({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ x(Pp, R({
    ...
    ownerState: f,
    children: [v ? o.props.children : o, m ? /* @__PURE__ */ i("title", {
      children: m
    }) : null]
  }));
});
...
}, Symbol.toStringTag, { value: "Module" })), Ip = /* @__PURE__ */ zc($p);
var Ca;
function Ap() {
...
var Ks = lo.default = void 0, Mp = Dp(Ap()), Bp = Pi;
Ks = lo.default = (0, Mp.default)(/* @__PURE__ */ (0, Bp.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function jp(e) {
...
function sn(e, t, n) {
  return e === void 0 || jp(e) ? t : R({}, t, {
    ownerState: R({}, t.ownerState, n)
  });
}
const Vp = {
  disableDefaultClasses: !1
}, Lp = /* @__PURE__ */ M.createContext(Vp);
function zp(e) {
  const {
...
function Gp(e) {
  ...
  const s = Fp(R({}, o, r)), l = Sa(r), c = Sa(o), d = t(s), u = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, d, n, c, l);
...
const Yn = /* @__PURE__ */ M.forwardRef(function(t, n) {
  const {
    ...
    container: o,
    disablePortal: a = !1
  } = t, [s, l] = M.useState(null), c = kt(/* @__PURE__ */ M.isValidElement(r) ? r.ref : null, n);
  if (Ft(() => {
    a || l(Kp(o) || document.body);
  }, [o, a]), Ft(() => {
    if (s && !a)
      return Hn(n, s), () => {
        Hn(n, null);
...
process.env.NODE_ENV !== "production" && (Yn.propTypes = {
   ...
   */
  container: p.oneOfType([gn, p.func]),
  /**
...
var Te = "top", Ve = "bottom", Le = "right", Ce = "left", ko = "auto", Sn = [Te, Ve, Le, Ce], Ut = "start", vn = "end", Jp = "clippingParents", Qs = "viewport", nn = "popper", Zp = "reference", Oa = /* @__PURE__ */ Sn.reduce(function(e, t) {
  return e.concat([t + "-" + Ut, t + "-" + vn]);
}, []), ei = /* @__PURE__ */ [].concat(Sn, [ko]).reduce(function(e, t) {
  return e.concat([t, t + "-" + Ut, t + "-" + vn]);
}, []), Qp = "beforeRead", ew = "read", tw = "afterRead", nw = "beforeMain", rw = "main", ow = "afterMain", aw = "beforeWrite", sw = "write", iw = "afterWrite", lw = [Qp, ew, tw, nw, rw, ow, aw, sw, iw];
function qe(e) {
...
function cw(e) {
  ...
  Object.keys(t.elements).forEach(function(n) {
    ...
    !je(a) || !qe(a) || (Object.assign(a.style, r), Object.keys(o).forEach(function(s) {
      var l = o[s];
...
function dw(e) {
  ...
  return Object.assign(t.elements.popper.style, n.popper), t.styles = n, t.elements.arrow && Object.assign(t.elements.arrow.style, n.arrow), function() {
    Object.keys(t.elements).forEach(function(r) {
      ...
      !je(o) || !qe(o) || (Object.assign(o.style, l), Object.keys(a).forEach(function(c) {
        o.removeAttribute(c);
      }));
    });
  };
...
var vt = Math.max, Wn = Math.min, Gt = Math.round;
function qr() {
...
function Ht(e, t, n) {
  ...
  t && je(e) && (o = e.offsetWidth > 0 && Gt(r.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && Gt(r.height) / e.offsetHeight || 1);
  var s = Tt(e) ? Ie(e) : window, l = s.visualViewport, c = !ti() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, u = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: u,
...
function ww(e) {
  ...
  var o = br(e);
  for (Eo(o) && (o = o.host); je(o) && ["html", "body"].indexOf(qe(o)) < 0; ) {
    var a = tt(o);
...
function On(e) {
  for (var t = Ie(e), n = Ra(e); n && pw(n) && tt(n).position === "static"; )
    n = Ra(n);
  return n && (qe(n) === "html" || qe(n) === "body" && tt(n).position === "static") ? t : n || ww(e) || t;
}
function Co(e) {
...
var mw = function(t, n) {
  ...
  })) : t, oi(typeof t != "number" ? t : ai(t, Sn));
};
function hw(e) {
  var t, n = e.state, r = e.name, o = e.options, a = n.elements.arrow, s = n.modifiersData.popperOffsets, l = Xe(n.placement), c = Co(l), d = [Ce, Le].indexOf(l) >= 0, u = d ? "height" : "width";
  if (!(!a || !s)) {
    var m = mw(o.padding, n), w = To(a), b = c === "y" ? Te : Ce, v = c === "y" ? Ve : Le, f = n.rects.reference[u] + n.rects.reference[c] - s[c] - n.rects.popper[u], h = s[c] - n.rects.reference[c], E = On(a), A = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, O = f / 2 - h / 2, k = m[b], g = A - w[u] - m[v], _ = A / 2 - w[u] / 2 + O, L = pn(k, _, g), H = c;
...
function Pa(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, u = e.roundOffsets, m = e.isFixed, w = s.x, b = w === void 0 ? 0 : w, v = s.y, f = v === void 0 ? 0 : v, h = typeof u == "function" ? u({
    x: b,
    y: f
  }) : {
    x: b,
  ...
  b = h.x, f = h.y;
  var E = s.hasOwnProperty("x"), A = s.hasOwnProperty("y"), O = Ce, k = Te, g = window;
  if (d) {
    var _ = On(n), L = "clientHeight", H = "clientWidth";
    if (_ === Ie(n) && (_ = lt(n), tt(_).position !== "static" && l === "absolute" && (L = "scrollHeight", H = "scrollWidth")), _ = _, o === Te || (o === Ce || o === Le) && a === vn) {
      k = Ve;
      var C = m && _ === g && g.visualViewport ? g.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[L]
      );
      f -= C - r.height, f *= c ? 1 : -1;
    }
    if (o === Ce || (o === Te || o === Ve) && a === vn) {
      O = Le;
      var P = m && _ === g && g.visualViewport ? g.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        _[H]
      );
      b -= P - r.width, b *= c ? 1 : -1;
  ...
  if (b = B.x, f = B.y, c) {
    var D;
    return Object.assign({}, N, (D = {}, D[k] = A ? "0" : "", D[O] = E ? "0" : "", D.transform = (g.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + f + "px)" : "translate3d(" + b + "px, " + f + "px, 0)", D));
  }
  return Object.assign({}, N, (t = {}, t[k] = A ? f + "px" : "", t[O] = E ? b + "px" : "", t.transform = "", t));
}
function xw(e) {
...
function kw(e) {
  var t = e.state, n = e.instance, r = e.options, o = r.scroll, a = o === void 0 ? !0 : o, s = r.resize, l = s === void 0 ? !0 : s, c = Ie(t.elements.popper), d = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function Oo(e) {
  return Ht(lt(e)).left + So(e).scrollLeft;
}
function Sw(e, t) {
  var n = Ie(e), r = lt(e), o = n.visualViewport, a = r.clientWidth, s = r.clientHeight, l = 0, c = 0;
  if (o) {
...
function Ow(e) {
  ...
  return tt(o || n).direction === "rtl" && (l += vt(n.clientWidth, o ? o.clientWidth : 0) - a), {
    width: a,
    height: s,
    x: l,
    y: c
...
function si(e) {
  return ["html", "body", "#document"].indexOf(qe(e)) >= 0 ? e.ownerDocument.body : je(e) && Ro(e) ? e : si(br(e));
}
function wn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = si(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), a = Ie(r), s = o ? [a].concat(a.visualViewport || [], Ro(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function $a(e, t, n) {
  return t === Qs ? Kr(Sw(e, n)) : Tt(t) ? Rw(t, n) : Kr(Ow(lt(e)));
}
function Pw(e) {
  var t = wn(br(e)), n = ["absolute", "fixed"].indexOf(tt(e).position) >= 0, r = n && je(e) ? On(e) : e;
  return Tt(r) ? t.filter(function(o) {
    return Tt(o) && ni(o, r) && qe(o) !== "body";
  }) : [];
}
function _w(e, t, n, r) {
  var o = t === "clippingParents" ? Pw(e) : [].concat(t), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var u = $a(e, d, r);
    return c.top = vt(u.top, c.top), c.right = Wn(u.right, c.right), c.bottom = Wn(u.bottom, c.bottom), c.left = vt(u.left, c.left), c;
  }, $a(e, s, r));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function ii(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? Xe(r) : null, a = r ? Xt(r) : null, s = t.x + t.width / 2 - n.width / 2, l = t.y + t.height / 2 - n.height / 2, c;
  switch (o) {
    case Te:
      c = {
        x: s,
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Jp : l, d = n.rootBoundary, u = d === void 0 ? Qs : d, m = n.elementContext, w = m === void 0 ? nn : m, b = n.altBoundary, v = b === void 0 ? !1 : b, f = n.padding, h = f === void 0 ? 0 : f, E = oi(typeof h != "number" ? h : ai(h, Sn)), A = w === nn ? Zp : nn, O = e.rects.popper, k = e.elements[v ? A : w], g = _w(Tt(k) ? k : k.contextElement || lt(e.elements.popper), c, u, s), _ = Ht(e.elements.reference), L = ii({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
  }), H = Kr(Object.assign({}, O, L)), C = w === nn ? H : _, P = {
  ...
  if (w === nn && N) {
    ...
    Object.keys(P).forEach(function(D) {
      var J = [Le, Ve].indexOf(D) >= 0 ? 1 : -1, q = [Te, Ve].indexOf(D) >= 0 ? "y" : "x";
      P[D] += B[q] * J;
    });
  }
  return P;
...
function $w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ei : c, u = Xt(r), m = u ? l ? Oa : Oa.filter(function(v) {
    return Xt(v) === u;
  }) : Sn, w = m.filter(function(v) {
...
function Aw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, u = n.boundary, m = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, h = t.options.placement, E = Xe(h), A = E === h, O = c || (A || !v ? [Un(h)] : Iw(h)), k = [h].concat(O).reduce(function(V, W) {
    ...
    }, []), g = t.rects.reference, _ = t.rects.popper, L = /* @__PURE__ */ new Map(), H = !0, C = k[0], P = 0; P < k.length; P++) {
      var N = k[P], B = Xe(N), D = Xt(N) === Ut, J = [Te, Ve].indexOf(B) >= 0, q = J ? "width" : "height", U = yn(t, {
        placement: N,
        boundary: u,
        rootBoundary: m,
        altBoundary: w,
        padding: d
      }), ee = J ? D ? Le : Ce : D ? Ve : Te;
      g[q] > _[q] && (ee = Un(ee));
      var ae = Un(ee), re = [];
...
function Aa(e) {
  return [Te, Le, Ve, Ce].some(function(t) {
    return e[t] >= 0;
  });
}
function Mw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, s = yn(t, {
    ...
    altBoundary: !0
  }), c = Ia(s, r), d = Ia(l, o, a), u = Aa(c), m = Aa(d);
  t.modifiersData[n] = {
...
function jw(e, t, n) {
  ...
  return s = s || 0, l = (l || 0) * o, [Ce, Le].indexOf(r) >= 0 ? {
    x: l,
    y: s
  } : {
    x: s,
...
function Vw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = ei.reduce(function(u, m) {
    return u[m] = jw(m, t.rects, a), u;
...
function Gw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, u = n.altBoundary, m = n.padding, w = n.tether, b = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, h = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: m,
    altBoundary: u
  }), E = Xe(t.placement), A = Xt(t.placement), O = !A, k = Co(E), g = Uw(k), _ = t.modifiersData.popperOffsets, L = t.rects.reference, H = t.rects.popper, C = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, P = typeof C == "number" ? {
    mainAxis: C,
    altAxis: C
    ...
    mainAxis: 0,
    altAxis: 0
  }, C), N = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, B = {
    x: 0,
    y: 0
  };
  if (_) {
    if (a) {
      var D, J = k === "y" ? Te : Ce, q = k === "y" ? Ve : Le, U = k === "y" ? "height" : "width", ee = _[k], ae = ee + h[J], re = ee - h[q], y = b ? -H[U] / 2 : 0, S = A === Ut ? L[U] : H[U], z = A === Ut ? -H[U] : -L[U], F = t.elements.arrow, V = b && F ? To(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ri(), X = W[J], Y = W[q], G = pn(0, L[U], V[U]), K = O ? L[U] / 2 - y - G - X - P.mainAxis : S - G - X - P.mainAxis, Z = O ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && On(t.elements.arrow), $ = de ? k === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = N == null ? void 0 : N[k]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, Fe = pn(b ? Wn(ae, j) : ae, ee, b ? vt(re, ye) : re);
      _[k] = Fe, B[k] = Fe - ee;
    }
    if (l) {
      var ct, ke = k === "x" ? Te : Ce, Pn = k === "x" ? Ve : Le, Ue = _[g], Ct = g === "y" ? "height" : "width", dt = Ue + h[ke], St = Ue - h[Pn], Ot = [Te, Ce].indexOf(E) !== -1, Rt = (ct = N == null ? void 0 : N[g]) != null ? ct : 0, ut = Ot ? dt : Ue - L[Ct] - H[Ct] - Rt + P.altAxis, Wt = Ot ? Ue + L[Ct] + H[Ct] - Rt - P.altAxis : St, _n = b && Ot ? fw(ut, Ue, Wt) : pn(b ? ut : dt, Ue, b ? Wt : St);
      _[g] = _n, B[g] = _n - Ue;
    }
    t.modifiersData[r] = B;
  }
...
function Yw(e) {
  return e === Ie(e) || !je(e) ? So(e) : Xw(e);
}
function Ww(e) {
  var t = e.getBoundingClientRect(), n = Gt(t.width) / e.offsetWidth || 1, r = Gt(t.height) / e.offsetHeight || 1;
  return n !== 1 || r !== 1;
}
function qw(e, t, n) {
  n === void 0 && (n = !1);
  var r = je(t), o = je(t) && Ww(t), a = lt(t), s = Ht(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Ro(a)) && (l = Yw(t)), je(t) ? (c = Ht(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Oo(a))), {
...
function ef(e) {
  ...
  return function(l, c, d) {
    ...
    var u = {
      ...
      setOptions: function(E) {
        ...
        f(), u.options = Object.assign({}, a, u.options, A), u.scrollParents = {
          reference: Tt(l) ? wn(l) : l.contextElement ? wn(l.contextElement) : [],
          popper: wn(c)
        };
        var O = Jw(Qw([].concat(r, u.options.modifiers)));
        return u.orderedModifiers = O.filter(function(k) {
          return k.enabled;
        }), v(), b.update();
      },
      ...
      forceUpdate: function() {
        if (!w) {
          var E = u.elements, A = E.reference, O = E.popper;
          if (Ma(A, O)) {
            u.rects = {
              reference: qw(A, On(O), u.options.strategy === "fixed"),
              popper: To(O)
            ...
            for (var k = 0; k < u.orderedModifiers.length; k++) {
              ...
              var g = u.orderedModifiers[k], _ = g.fn, L = g.options, H = L === void 0 ? {} : L, C = g.name;
    ...
    if (!Ma(l, c))
      return b;
    b.setOptions(d).then(function(h) {
      !w && d.onFirstUpdate && d.onFirstUpdate(h);
    });
    function v() {
      u.orderedModifiers.forEach(function(h) {
        var E = h.name, A = h.options, O = A === void 0 ? {} : A, k = h.effect;
...
var tf = [Ew, Fw, Nw, uw, Lw, Dw, Hw, bw, Bw], nf = /* @__PURE__ */ ef({
  defaultModifiers: tf
});
const li = "Popper";
function rf(e) {
...
const cf = () => po({
  root: ["root"]
}, zp(rf)), df = {}, uf = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, h = Ne(t, of), E = M.useRef(null), A = kt(E, n), O = M.useRef(null), k = kt(O, w), g = M.useRef(k);
  Ft(() => {
    g.current = k;
  }, [k]), M.useImperativeHandle(w, () => O.current, []);
  const _ = sf(u, s), [L, H] = M.useState(_), [C, P] = M.useState(qn(o));
  M.useEffect(() => {
...
`));
  ...
  const B = cf(), D = (r = v.root) != null ? r : "div", J = Xp({
    elementType: D,
...
}), ci = /* @__PURE__ */ M.forwardRef(function(t, n) {
  const {
    anchorEl: r,
    children: o,
    container: a,
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, A = Ne(t, af), [O, k] = M.useState(!0), g = () => {
    k(!1);
  }, _ = () => {
    k(!0);
  };
  ...
  const H = !u && c && (!f || O) ? "none" : void 0, C = f ? {
    in: u,
    onEnter: g,
    onExited: _
  } : void 0;
...
process.env.NODE_ENV !== "production" && (ci.propTypes = {
   ...
   */
  anchorEl: co(p.oneOfType([gn, p.object, p.func]), (e) => {
    if (e.open) {
...
var wf = process.env.NODE_ENV !== "production" ? p.oneOfType([p.number, p.shape({
  enter: p.number,
  exit: p.number,
  appear: p.number
}).isRequired]) : null;
...
const ui = I.createContext(null);
var ff = function(t) {
  return t.scrollTop;
}, ln = "unmounted", ft = "exited", mt = "entering", Mt = "entered", Zr = "exiting", rt = /* @__PURE__ */ function(e) {
  pf(t, e);
  function t(r, o) {
    var a;
    a = e.call(this, r, o) || this;
    var s = o, l = s && !s.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = ft, a.appearStatus = mt) : c = Mt : r.unmountOnExit || r.mountOnEnter ? c = ln : c = ft, a.state = {
      status: c
    }, a.nextCallback = null, a;
  }
  t.getDerivedStateFromProps = function(o, a) {
    var s = o.in;
    return s && a.status === ln ? {
      status: ft
    } : null;
  };
  var n = t.prototype;
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== mt && s !== Mt && (a = mt) : (s === mt || s === Mt) && (a = Zr);
    }
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [An.findDOMNode(this), l], d = c[0], u = c[1], m = this.getTimeouts(), w = l ? m.appear : m.enter;
    if (!o && !s || Ba.disabled) {
      this.safeSetState({
        status: Mt
      }, function() {
    ...
    var o = this, a = this.props.exit, s = this.getTimeouts(), l = this.props.nodeRef ? void 0 : An.findDOMNode(this);
    if (!a || Ba.disabled) {
      this.safeSetState({
        status: ft
      }, function() {
    ...
    var s = this.props.nodeRef ? this.props.nodeRef.current : An.findDOMNode(this), l = o == null && !this.props.addEndListener;
    if (!s || l) {
    ...
    return (
      ...
      /* @__PURE__ */ I.createElement(ui.Provider, {
        value: null
...
const bf = {
  ...
  const {
    ...
    TransitionComponent: h = mf
  } = t, E = Ne(t, gf), A = an(), O = M.useRef(), k = di(), g = M.useRef(null), _ = kt(g, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = g.current;
    ...
    let y;
    f === "auto" ? (y = k.transitions.getAutoHeightDuration(q.clientHeight), O.current = y) : y = ee, q.style.transition = [k.transitions.create("opacity", {
      duration: y,
      delay: ae
    ...
    let re;
    f === "auto" ? (re = k.transitions.getAutoHeightDuration(q.clientHeight), O.current = re) : re = U, q.style.transition = [k.transitions.create("opacity", {
      duration: re,
      delay: ee
    }), k.transitions.create("transform", {
      ...
      easing: ae
    })].join(","), q.style.opacity = 0, q.style.transform = Qr(0.75), m && m(q);
  }), D = L(w);
  return /* @__PURE__ */ i(h, R({
    appear: o,
    in: l,
    nodeRef: g,
    onEnter: C,
...
Po.muiSupportAuto = !0;
const Va = Po, vf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], yf = Cn(ci, {
  name: "MuiPopper",
  slot: "Root",
...
process.env.NODE_ENV !== "production" && (pi.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: p.oneOfType([gn, p.object, p.func]),
  /**
   * Popper render function or node.
   */
  children: p.oneOfType([p.node, p.func]),
...
const Nf = Fs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), at = Nf, kf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Ef(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Tf = (e) => {
  ...
  [`&[data-popper-placement*="right"] .${at.arrow}`]: R({}, t.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${at.arrow}`]: R({}, t.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  backgroundColor: e.vars ? e.vars.palette.Tooltip.bg : Ws(e.palette.grey[700], 0.92),
  ...
  [`.${at.popper}[data-popper-placement*="left"] &`]: R({
  ...
  [`.${at.popper}[data-popper-placement*="right"] &`]: R({
  ...
  [`.${at.popper}[data-popper-placement*="top"] &`]: R({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, t.touch && {
    marginBottom: "24px"
  }),
  [`.${at.popper}[data-popper-placement*="bottom"] &`]: R({
  ...
  color: e.vars ? e.vars.palette.Tooltip.bg : Ws(e.palette.grey[700], 0.9),
  "&::before": {
    content: '""',
    margin: "auto",
    display: "block",
...
const fi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, s, l, c, d, u, m, w, b, v, f, h, E, A, O, k, g;
  const _ = xo({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: H
  }), Fe = di(), ct = Fe.direction === "rtl", [ke, Pn] = M.useState(), [Ue, Ct] = M.useState(null), dt = M.useRef(!1), St = J || re, Ot = an(), Rt = an(), ut = an(), Wt = an(), [_n, _o] = Bs({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const yr = Ms(y), qt = M.useRef(), $n = Yr(() => {
  ...
  const $o = (Q) => {
    ...
    (Q) => {
      La.start(800 + S, () => {
        jn = !1;
      }), _o(!1), F && Ke && F(Q), Ot.start(Fe.transitions.duration.shortest, () => {
        dt.current = !1;
      });
    }
  ), xr = (Q) => {
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), Rt.clear(), ut.clear(), U || jn && ee ? Rt.start(jn ? ee : U, () => {
      $o(Q);
    }) : $o(Q));
  }, Io = (Q) => {
    Rt.clear(), ut.start(S, () => {
    ...
    onFocus: vi,
    ref: yi
  } = js(), [, Do] = M.useState(!1), Mo = (Q) => {
    bi(Q), Ao.current === !1 && (Do(!1), Io(Q));
  }, Bo = (Q) => {
    ke || Pn(Q.currentTarget), vi(Q), Ao.current === !0 && (Do(!0), xr(Q));
  }, jo = (Q) => {
    dt.current = !0;
    const Re = ye.props;
    Re.onTouchStart && Re.onTouchStart(Q);
  }, Vo = xr, Lo = Io, xi = (Q) => {
    jo(Q), ut.clear(), Ot.clear(), $n(), qt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Wt.start(ae, () => {
      document.body.style.WebkitUserSelect = qt.current, xr(Q);
    });
  }, Ni = (Q) => {
    ye.props.onTouchEnd && ye.props.onTouchEnd(Q), $n(), ut.start(z, () => {
      In(Q);
    });
  };
  M.useEffect(() => {
  ...
  const ki = kt(ye.ref, yi, Pn, n);
  !de && de !== 0 && (Ke = !1);
  const Nr = M.useRef(), Ei = (Q) => {
    const Re = ye.props;
    Re.onMouseMove && Re.onMouseMove(Q), rn = {
      x: Q.clientX,
      y: Q.clientY
    }, Nr.current && Nr.current.update();
  }, Kt = {}, kr = typeof de == "string";
  N ? (Kt.title = !Ke && kr && !D ? de : null, Kt["aria-describedby"] = Ke ? yr : null) : (Kt["aria-label"] = kr ? de : null, Kt["aria-labelledby"] = Ke && !kr ? yr : null);
  const Ae = R({}, Kt, j, ye.props, {
...
`));
  ...
  const Jt = {};
  q || (Ae.onTouchStart = xi, Ae.onTouchEnd = Ni), D || (Ae.onMouseOver = Vn(Vo, Ae.onMouseOver), Ae.onMouseLeave = Vn(Lo, Ae.onMouseLeave), St || (Jt.onMouseOver = Vo, Jt.onMouseLeave = Lo)), B || (Ae.onFocus = Vn(Bo, Ae.onFocus), Ae.onBlur = Vn(Mo, Ae.onBlur), St || (Jt.onFocus = Bo, Jt.onBlur = Mo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Ti = M.useMemo(() => {
    var Q;
    let Re = [{
    ...
    touch: dt.current
  }), Er = Tf(Zt), zo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : Cf, Fo = (a = (s = (l = Z.transition) != null ? l : C.Transition) != null ? s : $) != null ? a : Va, Uo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : Sf, Go = (u = (m = Z.arrow) != null ? m : C.Arrow) != null ? u : Of, Ci = sn(zo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (b = (v = K.popper) != null ? v : P.popper) == null ? void 0 : b.className)
  }), Zt), Si = sn(Fo, R({}, xe, (f = K.transition) != null ? f : P.transition), Zt), Oi = sn(Uo, R({}, (h = K.tooltip) != null ? h : P.tooltip, {
    className: bt(Er.tooltip, (E = (A = K.tooltip) != null ? A : P.tooltip) == null ? void 0 : E.className)
  }), Zt), Ri = sn(Go, R({}, (O = K.arrow) != null ? O : P.arrow, {
    className: bt(Er.arrow, (k = (g = K.arrow) != null ? g : P.arrow) == null ? void 0 : k.className)
  }), Zt);
  return /* @__PURE__ */ x(M.Fragment, {
    children: [/* @__PURE__ */ M.cloneElement(ye, Ae), /* @__PURE__ */ i(zo, R({
      as: Y ?? wi,
      placement: X,
      anchorEl: re ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ x(Uo, R({}, Oi, {
          children: [de, L ? /* @__PURE__ */ i(Go, R({}, Ri, {
            ref: Ct
          })) : null]
        }))
      }))
...
const Rf = fi;
function za(e, t, n) {
  return e ? /* @__PURE__ */ i(Ja, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ i("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function mi(e) {
  const {
    onClick: t,
    ...
    bl,
    {
      ...
      onClick: t,
      id: f,
      children: n ? /* @__PURE__ */ x(nt, { children: [
        za(a, n, !0),
        /* @__PURE__ */ i(vl, { primary: n, inset: !a && o }),
        m ? /* @__PURE__ */ i(Ja, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(Ks, {}) }) : za(s, n, !1)
      ] }) : h
    }
  );
...
function Pf(e) {
  const [t, n] = pe(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = e, s = (d) => {
    n(d.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
    let d = hi(a).filter((u) => "menuItem" in u.group);
    if (!(r != null && r.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return d = d.filter(
      (u) => "menuItem" in u.group && u.group.menuItem === r.id
    ), /* @__PURE__ */ i(gi, { ...e, includedGroups: d });
  };
  return /* @__PURE__ */ x(nt, { children: [
    /* @__PURE__ */ i(mi, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ i(
      yl,
      {
        anchorEl: t,
...
function gi(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: a, allowForLeadingIcons: s } = _e(() => {
    const u = o && o.length > 0 ? o : (
      ...
      hi(t).filter((v) => !("menuItem" in v.group))
...
function $f(e) {
  ...
  )), /* @__PURE__ */ i(gi, { ...e, includedGroups: a });
}
function If({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ x(
    Za,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ i(xl, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ i(
          $f,
          {
            commandHandler: e,
            menuDefinition: t,
...
const eo = (e, t, n = {}) => {
  ...
  const [a, s] = pe(() => r.current), [l, c] = pe(!0);
  return Qe(() => {
    let d = !0;
    return c(!!e), (async () => {
      if (e) {
...
function Bf({
  ...
  const [c, d] = pe(!1), [u, m] = pe(!1), w = Be(() => {
    c && d(!1), m(!1);
  }, [c]), b = Be((k) => {
    k.stopPropagation(), d((g) => {
      const _ = !g;
      return _ && k.shiftKey ? m(!0) : _ || m(!1), _;
    });
  }, []), v = Be(
    (k) => (w(), r(k)),
    [r, w]
  ...
  Qe(() => {
    if (c) {
      ...
      if (k) {
        const g = k.getBoundingClientRect(), _ = window.scrollY, L = window.scrollX, H = g.top + _ + k.clientHeight, C = g.left + L;
        h({ top: H, left: C });
      }
    }
  }, [c, o]);
  const [E] = eo(
    Be(async () => (e == null ? void 0 : e(!1)) ?? t, [e, t, c]),
    t
  ), [A] = eo(
    Be(async () => (e == null ? void 0 : e(!0)) ?? n ?? E, [e, n, E, c]),
    n ?? E
  ), O = u && A ? A : E;
  return /* @__PURE__ */ x(nt, { children: [
    /* @__PURE__ */ i(
...
const Rn = Kn(({ className: e, ...t }, n) => /* @__PURE__ */ i(Ji, { size: 35, className: T("tw-animate-spin", e), ...t, ref: n }));
...
function zm({
  ...
  const a = gt(void 0);
  return /* @__PURE__ */ i("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ i(kl, { position: "static", id: r, children: /* @__PURE__ */ x(
    El,
    {
...
const Wf = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x(
  on.Root,
  {
    ref: n,
    className: T(
    ...
    ...t,
    children: [
      /* @__PURE__ */ i(on.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ i(on.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
      /* @__PURE__ */ i(on.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
    ]
  }
));
Wf.displayName = on.Root.displayName;
...
const Um = Oe.Root, Kf = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.List,
  {
    ref: n,
    className: T(
...
function Gm({
  ...
  return /* @__PURE__ */ i(
    be,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ i(Rn, { size: 15 }) : /* @__PURE__ */ x(nt, { children: [
        /* @__PURE__ */ i(Zi, { size: 25, className: T("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Hm({
  ...
  return /* @__PURE__ */ i(
    be,
    {
      ...
      onClick: t,
      ...r,
      children: e ? /* @__PURE__ */ x(nt, { children: [
...
function Wm({
  ...
  return /* @__PURE__ */ i("div", { id: e, className: T("pr-twp tw-prose", n), children: /* @__PURE__ */ i(Sl, { options: o, children: t }) });
}
const Qf = Kn((e, t) => /* @__PURE__ */ x(
  be,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ i(Qi, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ i(
        Zn,
        {
...
function qm({ id: e, groups: t }) {
  return /* @__PURE__ */ i("div", { id: e, children: /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ i(ss, { asChild: !0, children: /* @__PURE__ */ i(Qf, {}) }),
    /* @__PURE__ */ i(tr, { children: t.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ i(Nn, { children: n.label }),
      /* @__PURE__ */ i(Fl, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(so, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(ls, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(nr, {})
    ] }, n.label)) })
  ] }) });
}
function Km({ id: e, message: t }) {
      ...
      children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(el, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
...
function tm({ id: e, versionHistory: t }) {
  const [n, r] = pe(!1), o = /* @__PURE__ */ new Date();
  function a(l) {
    const c = new Date(l), d = new Date(o.getTime() - c.getTime()), u = d.getUTCFullYear() - 1970, m = d.getUTCMonth(), w = d.getUTCDate() - 1;
    let b = "";
    return u > 0 ? b = `${u.toString()} year${u === 1 ? "" : "s"} ago` : m > 0 ? b = `${m.toString()} month${m === 1 ? "" : "s"} ago` : w === 0 ? b = "today" : b = `${w.toString()} day${w === 1 ? "" : "s"} ago`, b;
  }
...
const nm = (e, t) => e[t] ?? t, Fa = (e, t) => {
  var r, o;
  const n = t !== e.tag ? ((r = e.uiNames) == null ? void 0 : r[t]) ?? ((o = e.uiNames) == null ? void 0 : o.en) : void 0;
  return n ? `${e.autonym} (${n})` : e.autonym;
};
function Qm({
  knownUiLanguages: e,
  primaryLanguage: t = { tag: "en", autonym: "English" },
  fallbackLanguages: n = [],
  handlePrimaryLanguageChange: r,
  handleFallbackLanguagesChange: o,
  localizedStrings: a
}) {
  const s = nm(
    a,
  ...
  return Qe(() => {
    o([]);
  }, [o]), /* @__PURE__ */ x("div", { className: "flex flex-col gap-4 p-4 max-w-sm border rounded-lg shadow", children: [
    /* @__PURE__ */ x(jt, { name: "uiLanguage", value: l, onValueChange: d, children: [
      /* @__PURE__ */ i(xt, { className: "w-full", children: /* @__PURE__ */ i(Vt, {}) }),
      /* @__PURE__ */ i(Nt, { children: e.map((u) => /* @__PURE__ */ i(De, { value: u.tag, children: Fa(u, t.tag) }, u.tag)) })
    ] }),
    l !== "en" && /* @__PURE__ */ x(nt, { children: [
      /* @__PURE__ */ i(Ge, { className: "ml-5", children: s }),
      n.map((u) => Fa(u, t.tag))
    ] })
  ] });
}
...
export {
  ...
  _m as Inventory,
  Ge as Label,
  Wm as MarkdownRenderer,
  mi as MenuItem,
  Jm as MoreInfo,
  $m as NavigationContentSearch,
  Km as NoExtensionsFound,
  cs as RadioGroup,
  Gr as RadioGroupItem,
  Im as ScriptureResultsViewer,
  ...
  Cs as Separator,
  Dm as SettingsList,
  Bm as SettingsListHeader,
  Mm as SettingsListItem,
  Wf as Slider,
  Fm as Sonner,
  Rn as Spinner,
  qf as Switch,
