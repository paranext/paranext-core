...
function gh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ...
    ot.bookNumberToId(t.bookNum)
  ), [p, f] = ut(!1), [w, g] = ut(p), v = ge(void 0), m = ge(void 0), h = ge(void 0), E = Et(
    (k) => gc(k).filter((B) => {
...
function Lc({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(ar, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ir, { stickyHeader: a, children: m.getHeaderGroups().map((E) => /* @__PURE__ */ s(oe, { children: E.headers.map((_) => /* @__PURE__ */ s(vn, { children: _.isPlaceholder ? void 0 : dn(_.column.columnDef.header, _.getContext()) }, _.id)) }, E.id)) }),
      /* @__PURE__ */ s(sr, { children: (h = m.getRowModel().rows) != null && h.length ? m.getRowModel().rows.map((E) => /* @__PURE__ */ s(
        oe,
        {
          onClick: () => i(E, m),
...
function Eh({
  ...
  const f = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), v = Jt(n, "%webView_inventory_unknown%"), m = Jt(n, "%webView_inventory_scope_currentBook%"), h = Jt(n, "%webView_inventory_scope_chapter%"), E = Jt(n, "%webView_inventory_scope_verse%"), _ = Jt(n, "%webView_inventory_filter_text%"), C = Jt(
    n,
    "%webView_inventory_show_additional_items%"
...
const Vi = T.forwardRef(
  ({
    ...
    const c = ad(), [d, p] = T.useState(!1), [f, w] = T.useState(t), g = e ?? f, v = T.useCallback(
      (_) => {
        const C = typeof _ == "function" ? _(g) : _;
        n ? n(C) : w(C), document.cookie = `${id}=${C}; path=/; max-age=${sd}`;
      },
      [n, g]
    ), m = T.useCallback(() => c ? p((_) => !_) : v((_) => !_), [c, v, p]);
    T.useEffect(() => {
      const _ = (C) => {
...
function Bd() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = i, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = v, it.Memo = g, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = f, it.isAsyncMode = function(b) {
    ...
    return typeof b == "string" || typeof b == "function" || b === r || b === d || b === a || b === o || b === f || b === w || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === g || b.$$typeof === i || b.$$typeof === l || b.$$typeof === p || b.$$typeof === h || b.$$typeof === E || b.$$typeof === _ || b.$$typeof === m);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function jd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(A) {
      ...
      A === r || A === d || A === a || A === o || A === f || A === w || typeof A == "object" && A !== null && (A.$$typeof === v || A.$$typeof === g || A.$$typeof === i || A.$$typeof === l || A.$$typeof === p || A.$$typeof === h || A.$$typeof === E || A.$$typeof === _ || A.$$typeof === m);
    }
    function S(A) {
...
function Kd() {
  return ga || (ga = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), i = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), g = Symbol.for("react.offscreen"), v = !1, m = !1, h = !1, E = !1, _ = !1, C;
    C = Symbol.for("react.module.reference");
    function S(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || _ || j === r || j === d || j === p || E || j === g || v || m || h || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === f || j.$$typeof === a || j.$$typeof === i || j.$$typeof === c || // This needs to include all possible module reference object
...
`));
  ...
  const w = ({
    ...
    if (m = P({}, m), !m.main && m[E] && (m.main = m[E]), !m.hasOwnProperty("main"))
...
function rw(t, e) {
  ...
  const g = o / 14, v = f || ((E) => `${E / d * g}rem`), m = (E, _, C, S, b) => P({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(_),
...
function pf(t) {
  ...
  if (!(!a || !i)) {
    var f = df(o.padding, n), w = Ao(a), g = c === "y" ? Ct : Ot, v = c === "y" ? Vt : zt, m = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], h = i[c] - n.rects.reference[c], E = Pn(a), _ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, C = m / 2 - h / 2, S = f[g], b = _ - w[p] - f[v], I = _ / 2 - w[p] / 2 + C, z = wn(S, I, b), H = c;
...
function Va(t) {
  ...
  if (g = B.x, m = B.y, c) {
    var D;
    return Object.assign({}, k, (D = {}, D[S] = _ ? "0" : "", D[C] = E ? "0" : "", D.transform = (b.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + m + "px)" : "translate3d(" + g + "px, " + m + "px, 0)", D));
  }
  return Object.assign({}, k, (e = {}, e[S] = _ ? m + "px" : "", e[C] = E ? g + "px" : "", e.transform = "", e));
}
function hf(t) {
...
function Rf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, m = n.allowedAutoPlacements, h = e.options.placement, E = Yt(h), _ = E === h, C = c || (_ || !v ? [Xn(h)] : Of(h)), S = [h].concat(C).reduce(function(V, W) {
...
function Vf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, m = v === void 0 ? 0 : v, h = kn(e, {
    ...
    padding: f,
    altBoundary: p
  }), E = Yt(e.placement), _ = Ge(e.placement), C = !_, S = Mo(E), b = jf(S), I = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, O = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, $ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
...
const As = /* @__PURE__ */ M.forwardRef(function(e, n) {
  var r, o, a, i, l, c, d, p, f, w, g, v, m, h, E, _, C, S, b;
  const I = _o({
    props: e,
    name: "MuiTooltip"
  }), {
