...
const oe = Oe.Root, fe = Oe.Trigger, fl = Oe.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = mt();
...
const Wl = qt({ config: ln({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: t = Xl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
const Zl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
...
const nc = qt({ name: "@lexical/react/ReactProvider" });
function rc() {
...
function Nc({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = yc(), c = () => {
  };
