...
var qt = (t, e, n) => Si(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as zn, useRef as q, useMemo as z, useState as D, useCallback as G, useEffect as J, useLayoutEffect as ee, createContext as gr, useContext as mo, Component as Ri, createElement as zo, Suspense as Ii, Fragment as fo } from "react";
import { Command as Wt } from "cmdk";
import { X as bn, Search as Ea, Check as Yt, Clock as Ko, ChevronsLeft as qo, ChevronsRight as Ho, ChevronLeft as Hr, ChevronRight as pn, ArrowLeft as Di, ArrowRight as Ta, Circle as br, ChevronDown as Oe, BoldIcon as Oi, ItalicIcon as Mi, AtSign as Sa, Pencil as Ai, Trash2 as Pi, ArrowUp as Ra, MoreHorizontal as $i, MailOpen as ji, Mail as Li, ChevronUp as Ia, FilterIcon as Vi, ArrowLeftIcon as Bi, ChevronLeftIcon as Gi, ChevronRightIcon as Fi, ArrowRightIcon as zi, Copy as Da, Filter as Oa, User as Ki, Link as qi, CircleHelp as Hi, ChevronsUpDown as ho, Star as Ui, Undo as Yi, Redo as Xi, SquareX as Ma, FunctionSquare as Aa, SquareSigma as Pa, Ban as Wi, AlertCircle as Ur, CircleCheckIcon as Ji, CircleXIcon as Zi, CircleHelpIcon as Qi, ArrowUpIcon as tl, ArrowDownIcon as el, PanelLeft as nl, PanelRight as rl, ScrollText as ol, MenuIcon as al, Menu as sl, EllipsisVertical as il, MoreVertical as Uo, LoaderCircle as ll, GripVertical as cl } from "lucide-react";
...
import { includes as Wn, Section as Q, getChaptersForBook as pl, formatScrRef as Re, getSectionForBook as An, formatRelativeDate as ul, formatReplacementString as Qe, sanitizeHtml as ml, NumberFormat as fl, formatBytes as hl, getCurrentLocale as gl, usfmMarkers as er, getFormatCallerFunction as bl, deepEqual as vl, isString as Yo, compareScrRefs as Yr, scrRefToBBBCCCVVV as Tr, defaultScrRef as Sr, formatScrRefRange as xl, getLocalizeKeyForScrollGroupId as st } from "platform-bible-utils";
...
import { createEditor as ja, $getRoot as Me, $createParagraphNode as xn, $getSelection as Xt, HISTORY_MERGE_TAG as go, ParagraphNode as La, TextNode as Va, $isTokenOrSegmented as yl, $getCharacterOffsets as Nl, $cloneWithPropertiesEphemeral as kl, $getPreviousSelection as _l, $isRangeSelection as xe, $caretFromPoint as Cl, $getSiblingCaret as Ba, $getChildCaret as El, $getAdjacentChildCaret as Tl, $isChildCaret as Sl, $normalizeCaret as Rl, $setSelectionFromCaretRange as Il, $getCollapsedCaretRange as Dl, $getCaretInDirection as Xo, $splitAtPointCaretNext as Ol, $isTextPointCaret as Ml, $findMatchingParent as Ga, $isElementNode as Ie, mergeRegister as Ae, getDOMTextNode as Al, isHTMLElement as Fa, CLEAR_EDITOR_COMMAND as za, COMMAND_PRIORITY_EDITOR as bo, shallowMergeConfig as Pl, defineExtension as se, safeCast as on, createState as $l, FORMAT_TEXT_COMMAND as Ka, $isNodeSelection as qa, COMMAND_PRIORITY_LOW as Ha, RootNode as jl, LineBreakNode as Ll, TabNode as Vl, $isEditorState as Bl, createCommand as Gl, CLICK_COMMAND as Fl, isDOMNode as zl, $getNodeFromDOMNode as Kl, $createNodeSelection as ql, $setSelection as Hl, $getEditor as Ul, DecoratorNode as Xr, $getState as Yl, toggleTextFormatType as Wo, TEXT_TYPE_TO_FORMAT as Xl, $setState as Wl, addClassNamesToElement as Ua, $create as Jl, $getNodeByKey as Zl, removeClassNamesFromElement as Ql, KEY_TAB_COMMAND as tc, $isBlockElementNode as ar, $createRangeSelection as ec, $normalizeSelection__EXPERIMENTAL as nc, OUTDENT_CONTENT_COMMAND as rc, INDENT_CONTENT_COMMAND as Jo, INSERT_TAB_COMMAND as oc, COMMAND_PRIORITY_CRITICAL as vo, $isDecoratorNode as ac, $isParagraphNode as sc, $isTextNode as sr, SELECTION_CHANGE_COMMAND as Ya, getRegisteredNode as ic, isDocumentFragment as Zo, isDOMDocumentNode as lc, ArtificialNode__DO_NOT_USE as Xa, $createLineBreakNode as Wa, $isRootOrShadowRoot as cc, isBlockDomNode as Qo, isInlineDomNode as ta, $insertNodes as dc } from "lexical";
...
import { useReactTable as ts, getFilteredRowModel as vc, getSortedRowModel as es, getPaginationRowModel as xc, getCoreRowModel as ns, flexRender as Pn, getGroupedRowModel as yc, getExpandedRowModel as Nc } from "@tanstack/react-table";
import * as kt from "@radix-ui/react-select";
import kc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Wr, HIDDEN_NOTE_CALLER as Jr, getDefaultViewOptions as _c, isInsertEmbedOpOfType as Jn, Editorial as Cc } from "@eten-tech-foundation/platform-editor";
...
const Kn = 250, rs = 300, yo = 400, Rc = 450, Ic = 500, Dc = 550, Oc = "layoutDirection";
function _t() {
  const t = localStorage.getItem(Oc);
  return t === "rtl" ? t : "ltr";
}
const eo = ne.Root, im = ne.Trigger, Mc = ne.Portal, lm = ne.Close, os = b.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  ne.Overlay,
  {
    ref: o,
    className: h(
...
Ac.displayName = ne.Description.displayName;
...
const Ee = un.Root, je = un.Trigger, $c = un.Anchor, ds = b.createContext(null);
function Rr({
  container: t,
  children: e
}) {
...
function jc({
  ...
  return /* @__PURE__ */ p(Ee, { open: w, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(ue, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(_e, { children: /* @__PURE__ */ r(Ce, { children: /* @__PURE__ */ r(ae, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      ie,
      {
        onSelect: () => f(u),
...
function Fc(t, e, n, o) {
  const a = G(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const c = e[d - 1], w = Math.max(ve(c), 1);
        o({
          book: c,
          chapterNum: w,
          verseNum: 1
...
function ra({
  ...
  if (t)
    return /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: ve(t) }, (l, d) => d + 1).map((l) => {
...
function Dr({
  ...
  return ee(() => {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ p(Ee, { open: I, onOpenChange: Rt, modal: x, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
        ref: Gt,
    ...
    /* @__PURE__ */ r(
      ue,
      {
        ...
        onPointerDownOutside: (_) => {
          const { target: U } = _;
          Gt.current && U instanceof Node && Gt.current.contains(U) && (jt.current = !0, Rt(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ p(
          _e,
          {
            ...
            children: [
              v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
                ...
                /* @__PURE__ */ r(
                  F,
                  {
                    ...
                    children: R === "ltr" ? /* @__PURE__ */ r(Di, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ta, { className: "tw-h-4 tw-w-4" })
                  }
                ),
              ...
              !tt && /* @__PURE__ */ p(Ce, { ref: K, children: [
                v === "books" && /* @__PURE__ */ p(it, { children: [
                  !A && Object.entries(fe).map(([_, U]) => {
                    if (U.length !== 0)
                      return (
                        ...
                        /* @__PURE__ */ r(ae, { heading: Nt(_), children: U.map((Z) => /* @__PURE__ */ r(
                          ls,
                          {
                            bookId: Z,
                            onSelect: (It) => B(It),
                  ...
                  A && Be && A.chapterNum && c && /* @__PURE__ */ p(it, { children: [
                  ...
                  A && !Be && ve(A.book) > 1 && /* @__PURE__ */ p(it, { children: [
                    /* @__PURE__ */ p("div", { className: "tw-mb-2 tw-flex tw-items-center tw-justify-between tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: [
...
), Tt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($a.Root, { ref: n, className: h("pr-twp", zc(), t), ...e }));
...
function ro({
  ...
  return /* @__PURE__ */ p(Ee, { open: I, onOpenChange: S, ...R, children: [
    ...
    /* @__PURE__ */ r(
      ue,
      {
        ...
        style: s,
        children: /* @__PURE__ */ p(_e, { children: [
          /* @__PURE__ */ r(an, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(Nn, { children: u }),
          /* @__PURE__ */ r(Ce, { children: k(e) ? e.map((C) => /* @__PURE__ */ r(ae, { heading: C.groupHeading, children: C.options.map((v) => T(v, C.groupHeading)) }, C.groupHeading)) : e.map((C) => T(C)) })
        ] })
      }
    )
  ] });
...
function pm({
  ...
  const w = Or(c, "%webView_bookSelector_currentBook%"), m = Or(c, "%webView_bookSelector_choose%"), f = Or(c, "%webView_bookSelector_chooseBooks%"), [u, g] = D(
    "current book"
    /* CurrentBook */
  ), y = (x) => {
    g(x), t(x);
...
const us = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Uc = us ? ee : J, Zn = { tag: go };
function Yc({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, c = Hc(null, o), w = ja({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, w), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = xn();
            u.append(g);
            const y = us ? document.activeElement : null;
  ...
  }, []), r(ps.Provider, { value: n, children: e });
}
const Xc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
...
const ed = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function nd(t) {
...
const ms = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sd = ms && "documentMode" in document ? document.documentMode : null;
!(!ms || !("InputEvent" in window) || sd) && "getTargetRanges" in new window.InputEvent("input");
function be(t) {
  return `${t}px`;
}
...
function ud(t) {
  const e = Xt() || _l();
  let n;
  if (xe(e)) n = Cl(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = Ba(l, "next"));
    }
    n = n || El(Me(), "previous").getFlipped().insert(xn());
  }
...
function md(t, e, n) {
  ...
  return Ml(o) && wr(283), o.insert(t.isInline() ? xn().append(t) : t), Xo(Ba(t.getLatest(), "next"), e.direction);
}
function fd(t) {
  const e = Xt();
  if (!xe(e)) return !1;
...
function yr() {
  ...
  for (!function() {
    ...
    for ($n = void 0, ur++; n !== void 0; ) {
      const o = n.u;
      if (n.u = void 0, n.f &= -3, !(8 & n.f) && fs(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
let pr, De = 0, ur = 0, bd = 0, ao = 0, rr = 0;
function ia(t) {
  if (ot === void 0) return;
  let e = t.n;
...
function To(t) {
  ...
  t.x = void 0, t.s = void 0, gs(t);
}
function xd(t) {
  if (ot !== this) throw new Error("Out-of-order effect");
  hs(this), ot = t, this.f &= -2, 8 & this.f && To(this), yr();
}
function dn(t, e) {
...
Ht.prototype.brand = hd, Ht.prototype.h = function() {
  return !0;
  ...
  if (this.g = rr, this.f |= 1, this.i > 0 && !fs(this)) return this.f &= -2, !0;
  const t = ot;
  try {
    la(this), ot = this;
    const e = this.x();
  ...
  return ot = t, hs(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, gs(this), la(this), De++;
  const t = ot;
...
se({ build: (t, e, n) => kn(e), config: on({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
se({ build: (t, e, n) => kn(e), config: on({ $onClear: bs }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ye(() => vs(t, o.value));
} });
function yd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Ar = $l("format", { parse: (t) => typeof t == "number" ? t : 0 });
class xs extends Xr {
  $config() {
...
se({ name: "@lexical/extension/DecoratorText", nodes: () => [xs], register: (t, e, n) => t.registerCommand(Ka, (o) => {
  const a = Xt();
  if (qa(a) || xe(a)) for (const s of a.getNodes()) Nd(s) && s.toggleFormat(o);
  return !1;
}, Ha) });
function ys(t, e) {
  let n;
...
const so = se({ build: (t) => ys(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function Ns(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = Ns(n[a], o[a]);
    return t;
  }
  return e;
}
const So = 0, io = 1, ks = 2, Pr = 3, Qn = 4, cn = 5, $r = 6, Dn = 7;
function jr(t) {
  return t.id === So;
}
function _s(t) {
...
function kd(t) {
  return function(e) {
    return e.id === io;
  }(t) || wt(305, String(t.id), String(io)), Object.assign(t, { id: ks });
}
...
const Td = se({ config: on({ setOptions: ca, updateOptions: ca }), init: ({ $initialEditorState: t = Ed }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [jl, Va, Ll, Vl, La] }), da = Symbol.for("@lexical/extension/LexicalBuilder");
function wa() {
}
function Sd(t) {
  throw t;
...
const Rd = /* @__PURE__ */ new Set(), pa = se({ build(t, e, n) {
  const o = n.getDependency(so).output, a = Vn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ys(() => {
  }, () => ye(() => {
...
}, dependencies: [so], name: "@lexical/extension/NodeSelection" }), Id = Gl("INSERT_HORIZONTAL_RULE_COMMAND");
class mn extends Xr {
  static getType() {
...
se({ dependencies: [so, pa], name: "@lexical/extension/HorizontalRule", nodes: () => [mn], register(t, e, n) {
  ...
  return Ae(t.registerCommand(Id, (i) => {
    const l = Xt();
    if (!xe(l)) return !1;
    ...
    return !0;
  }, bo), t.registerCommand(Fl, (i) => {
    if (zl(i.target)) {
      const l = Kl(i.target);
      if (Od(l)) return function(d, c = !1) {
        const w = Xt(), m = d.isSelected(), f = d.getKey();
        let u;
        c && qa(w) ? u = w : (u = ql(), Hl(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ye(() => {
      const c = l.value;
      c && (d.value ? Ua(c, s) : Ql(c, s));
    }));
    return Ae(...i);
  }));
} });
se({ build: (t, e) => kn({ inheritEditableFromParent: e.inheritEditableFromParent }), config: on({ $getParentEditor: function() {
  const t = Ul();
...
se({ build: (t, e, n) => kn(e), config: on({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return ye(() => {
...
se({ build: (t, e, n) => kn(e), config: on({ $canIndent: Cs, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (xe(g)) {
                ...
                if (sr(x) && c >= 0 && w >= 0 && (N = c, R = c + w, g.setTextNodeRange(x, N, x, R)), N === R && m === "" || (g.insertRawText(m), x = y.getNode()), sr(x)) {
                  N = f, R = f + u;
...
se({ build: (t, e, n) => kn(e), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ye(() => n.getOutput().disabled.value ? void 0 : Ts(t)) });
function Ld(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Kd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function qd({ onClear: t }) {
  const [e] = Te();
  return Kd(() => vs(e, t), [e, t]), null;
}
const Ss = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ee : J;
function Hd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: w, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: N = !0, style: R, tabIndex: I, "data-testid": S, ...V }, k) {
  ...
  return Ss(() => (C(t.isEditable()), t.registerEditableListener((P) => {
    C(P);
...
function Zd({
  ...
  return /* @__PURE__ */ r(Rs.Provider, { value: i, children: s });
}
function Is() {
  const t = mo(Rs);
  if (!t)
...
function Qd() {
  const [t, e] = D(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(eo, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(ir, { children: [
...
function tw({
  ...
  const [e] = Te(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Qd(), d = () => {
  };
...
const Ds = He(
  ...
  {
    ref: a,
    className: h(Ds({ variant: e, size: n, className: t })),
    ...o
  }
));
nw.displayName = Ja.Root.displayName;
const Os = b.createContext({
  size: "default",
  variant: "default"
...
function rw() {
  const { activeEditor: t } = Is(), [e, n] = D([]), o = G((a) => {
    if (xe(a) || gc(a)) {
      const s = [];
      fa.forEach(({ format: i }) => {
...
function iw(t, e) {
  ...
  let o = [];
  const a = [];
  for (const s of n) if (!As.has(s.nodeName)) {
    const i = Ps(s, t, a, !1);
    i !== null && (o = o.concat(i));
  }
  return function(s) {
...
function Ms(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = Ie(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && sr(e) && (i = ad(o, e, "clone"));
  const l = Ie(i) ? i.getChildren() : [], d = ic(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Ms(t, g, f, o);
    !a && Ie(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Fa(w) || Zo(w)) && w.append(f), n.append(w), m) {
      const u = m.call(i, w);
      u && (Zo(w) ? w.replaceChildren(u) : w.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
const As = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ps(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (As.has(t.nodeName)) return i;
  let l = null;
  ...
  let f = [];
  const u = (l == null || !cc(l)) && (l != null && ar(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...Ps(m[g], e, n, u, new Map(a), l));
  return w != null && (f = w(f)), Qo(t) && (f = cw(t, f, u ? () => {
    const g = new Xa();
    return n.push(g), g;
...
function js(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : js(e.children)
  ) : !1;
}
function ce(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? js(t.root.children) : !1;
}
function dw(t) {
  if (!t || t.trim() === "")
...
function um({
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(Ee, { open: d, onOpenChange: c, children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Mo(N) && (N.preventDefault(), N.stopPropagation(), ce(a) && f());
        },
        onKeyDown: (N) => {
...
Bs.displayName = yn.Root.displayName;
...
xw.displayName = yn.Image.displayName;
...
Gs.displayName = yn.Fallback.displayName;
const Ao = gr(void 0);
function me() {
  const t = mo(Ao);
  if (!t)
...
}), Pe = mt.Trigger, Fs = mt.Group, yw = mt.Portal, Nw = mt.Sub, kw = mt.RadioGroup;
...
const zs = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = me();
  return /* @__PURE__ */ p(
    mt.SubTrigger,
    {
...
zs.displayName = mt.SubTrigger.displayName;
...
Ks.displayName = mt.SubContent.displayName;
const we = b.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = _t();
...
we.displayName = mt.Content.displayName;
...
const de = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = _t(), i = me();
  return /* @__PURE__ */ p(
    mt.CheckboxItem,
    {
...
de.displayName = mt.CheckboxItem.displayName;
...
qs.displayName = mt.RadioItem.displayName;
...
function ha({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Bs, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Gs, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p(Ne, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              or(t.assignedUser, n)
            ] })
          ] }),
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : Mo(S) && (S.preventDefault(), S.stopPropagation(), ce(w) && g());
              },
              onKeyDown: (S) => {
        ...
        I && /* @__PURE__ */ p(ke, { children: [
          /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r($i, {}) }) }),
          /* @__PURE__ */ r(we, { align: "end", children: I })
        ] })
      ]
    }
  );
...
function Cw({
  ...
  const Ct = G(
    ...
    async (O) => {
      const Nt = ce(T) ? fr(T) : void 0, ut = await m({
        ...O,
        contents: Nt,
  ...
  if (zt)
    return /* @__PURE__ */ r(
      Ls,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ p(Vs, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
            ...
            o && /* @__PURE__ */ p(it, { children: [
              ...
              x !== !1 && (!$ || ce(T)) && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  onKeyDownCapture: (O) => {
                    Mo(O) && (O.preventDefault(), O.stopPropagation(), (ce(T) || v !== void 0) && Ct());
                  },
                  onKeyDown: (O) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      ...
                      /* @__PURE__ */ p(Ee, { open: Y, onOpenChange: tt, children: [
                        /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ r(
                          F,
                          {
                            size: "icon",
...
const hn = kt.Root, Tw = kt.Group, gn = kt.Value, Sw = He(
...
Hs.displayName = kt.ScrollUpButton.displayName;
...
Us.displayName = kt.ScrollDownButton.displayName;
...
const oe = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  kt.Item,
  {
    ref: o,
    className: h(
...
function Lw({
  ...
  var k;
  const [w, m] = D([]), [f, u] = D([]), [g, y] = D({}), [x, N] = D({}), R = z(() => e ?? [], [e]), I = ts({
    data: R,
    columns: t,
    getCoreRowModel: ns(),
  ...
  return d ? V = Array.from({ length: 10 }).map((v, E) => `skeleton-row-${E}`).map((v) => /* @__PURE__ */ r(Se, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(tn, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(lo, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, v)) : ((k = I.getRowModel().rows) == null ? void 0 : k.length) > 0 ? V = I.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ p(Nr, { stickyHeader: s, children: [
...
function vm({
  ...
  return /* @__PURE__ */ p(Ee, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: o }),
    /* @__PURE__ */ p(ue, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function xm({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ke, { children: [
    ...
    /* @__PURE__ */ r(we, { children: n.map((c, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(qe, { children: c.label }),
      /* @__PURE__ */ r(Fs, { children: c.itemType === 0 ? /* @__PURE__ */ r(it, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        de,
        {
          checked: o[w][f],
        ...
        kw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(qs, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r($e, {})
    ] }, c.label)) })
...
function zw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ p(Ee, { open: C, onOpenChange: w ?? R, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(ue, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(_e, { children: [
...
function km({
  ...
  return /* @__PURE__ */ p("div", { id: m, className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    e.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: e.map((f) => {
      var u;
      return /* @__PURE__ */ p(Ne, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          F,
          {
            variant: "ghost",
...
function Yw({
  ...
  return /* @__PURE__ */ p(ke, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Uw(t, a, n) }) }) }),
...
function Jw({
  ...
  return /* @__PURE__ */ p(ke, { children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(wc, { asChild: !0, children: /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: Xw(t, n) }) }) }),
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r("p", { children: Ww(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(we, { style: { zIndex: rs }, children: [
...
function tp({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(_e, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      an,
      {
...
function _m({
  ...
  const ct = G(
    (B, X, et = !1) => {
      var xt, yt, Rt;
      const dt = (yt = (xt = w.current) == null ? void 0 : xt.getNoteOps(0)) == null ? void 0 : yt.at(0);
      if (dt && Jn("note", dt)) {
        if (dt.insert.note) {
          let bt;
...
function cp({
  ...
  return /* @__PURE__ */ p(Nr, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(kr, { stickyHeader: !0, children: /* @__PURE__ */ p(Se, { children: [
      /* @__PURE__ */ r(Gn, { children: a }),
      /* @__PURE__ */ r(Gn, { children: s })
    ] }) }),
    /* @__PURE__ */ r(_r, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Se,
      {
        onClick: () => {
          e(l.reference);
...
const dp = (t) => {
...
}, Cr = (t, e, n) => /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
  /* @__PURE__ */ p(
    Bt,
    {
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ p(Do, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        jn,
        {
          onClick: (d) => {
...
function Am({
  ...
  return /* @__PURE__ */ r("div", { id: c, className: "pr-twp tw-h-full tw-overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-h-full tw-w-full tw-min-w-min tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ p(hn, { onValueChange: (K) => jt(K), defaultValue: i, children: [
...
function yp({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  ...
  let l = null;
  e === "project" ? t.openGroups.length > 0 && (l = /* @__PURE__ */ r("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-gap-1", children: t.openGroups.map((m) => /* @__PURE__ */ r(Ne, { variant: "secondary", children: Fn(m) }, m)) })) : t.scrollGroupId !== void 0 && (l = /* @__PURE__ */ p("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-items-center tw-gap-2", children: [
    /* @__PURE__ */ r(
      xp,
      {
...
function Np({
  ...
  return /* @__PURE__ */ p(ke, { children: [
    ...
    /* @__PURE__ */ p(we, { align: "end", className: "tw-w-56", style: { zIndex: yo }, children: [
...
function Pm(t) {
  const [e, n] = D(!1), [o, a] = D(""), [s, i] = D(t.defaultGroupByOpenTabs ?? !0), [l, d] = D(!1), c = bp(t.localizedStrings), w = z(() => t.mode === "project" ? Gr({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  return /* @__PURE__ */ p(Ee, { open: e, onOpenChange: n, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
    ...
    /* @__PURE__ */ r(
      ue,
      {
        ...
        children: /* @__PURE__ */ r(Pt, { delayDuration: 200, children: /* @__PURE__ */ p(_e, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ p(Ce, { children: [
            ...
            f.map((k, T) => /* @__PURE__ */ p(fo, { children: [
...
const _p = "16rem", Cp = "3rem", Xs = b.createContext(void 0);
function Er() {
...
const Ws = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Xs.Provider, { value: R, children: /* @__PURE__ */ r(Pt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Ws.displayName = "SidebarProvider";
const Js = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Er();
...
const Mp = He(
  ...
  ({
    ...
    const d = t ? vn : "button", { state: c } = Er(), w = /* @__PURE__ */ r(
      d,
      {
        ref: l,
...
function Bp({
  ...
  return /* @__PURE__ */ r(
    Js,
    {
      ...
      children: /* @__PURE__ */ p(Qs, { children: [
        /* @__PURE__ */ p(co, { children: [
          /* @__PURE__ */ r(wo, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(po, { children: /* @__PURE__ */ r(ti, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(ei, { children: /* @__PURE__ */ r(
            ni,
            {
              onClick: () => c(f),
              isActive: m(f),
    ...
    /* @__PURE__ */ p(
      Ws,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Zs, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Fe = "scrBook", Gp = "scrRef", Ze = "source", Fp = "details", zp = "Scripture Reference", Kp = "Scripture Book", ri = "Type", qp = "Details";
function Hp(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, _a = (t) => `${Up({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function jm({
  sources: t,
  ...
  const [c, w] = D([]), [m, f] = D([{ id: Fe, desc: !1 }]), [u, g] = D({}), y = z(
    ...
    !e && /* @__PURE__ */ p(
      hn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(rn, { position: "item-aligned", children: /* @__PURE__ */ r(Tw, { children: S.map((v) => /* @__PURE__ */ r(oe, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(Nr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
...
}), oi = (t, e, n) => Lo(t, e).every((o) => n.includes(o));
function Yp({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    F,
    {
      ...
      onClick: () => o(t),
      className: h(
        oi(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Pc(
        t,
...
function Xp({
  ...
  const k = z(() => pt.allBookIds.filter(
    ...
    ($) => {
      ...
      n(
        oi(k, $, e) ? e.filter((Y) => !H.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, k]
  ), L = () => {
    ...
    /* @__PURE__ */ p(
      Ee,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ue, { className: "tw-w-[500px] tw-max-w-[calc(100vw-2rem)] tw-p-0", align: "start", children: /* @__PURE__ */ p(
            _e,
            {
              shouldFilter: !1,
              onKeyDown: ($) => {
...
function Vm({
  ...
  const S = At(
  ...
  ], K = (j, W, Ut = !1) => /* @__PURE__ */ p(it, { children: [
    j,
    W && !Ut && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), nt = e ? gt.filter((j) => e.includes(j.value)) : gt, ct = g ?? Sr, rt = w ?? ct, at = m ?? ct, Ft = () => {
    ...
    [n, a, g, s]
  ), Ct = nt.find((j) => j.value === t), Lt = () => t === "selectedBooks" && a.length > 0 ? a.map((j) => j.toUpperCase()).join(", ") : t === "range" ? xl(rt, at, {
  ...
  ), U = he === "end", Z = he === "start", It = "tw-text-muted-foreground", re = c === "dropdown" && Ye === "range", ln = re ? En : yt, Kt = re ? Tn : u ? Rt : Ft, Et = /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-wrap tw-items-end tw-gap-4", children: [
    ...
    /* @__PURE__ */ p("div", { ref: Dt, className: "tw-grid tw-gap-2", children: [
  ...
  const [te, We] = D(null), [Un, yi] = D(null), [Yn, Ni] = D(null), ki = 200, [_i, Ci] = D(!1);
  J(() => {
    if (!Yn || typeof ResizeObserver > "u") return;
    const j = new ResizeObserver(([W]) => {
      Ci(W.contentRect.width < ki);
    });
  ...
  return /* @__PURE__ */ p("div", { id: d, className: "tw-grid tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      c === "dropdown" ? /* @__PURE__ */ p(ke, { open: Ve, onOpenChange: Ue, children: [
        ...
        /* @__PURE__ */ r(
          we,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(Rr, { container: Yn, children: [
              O.map(({ value: j, label: W, dropdownLabel: Ut, scrRefSuffix: In, id: Ei }) => /* @__PURE__ */ p(
                Ke,
                {
                  ref: vt(j),
        ...
        _o,
        {
          ...
          children: nt.map(({ value: j, label: W, scrRefSuffix: Ut, id: In }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
    ...
    c === "dropdown" && Nt && /* @__PURE__ */ r(eo, { open: Ye === "selectedBooks", onOpenChange: Xn, children: /* @__PURE__ */ r(
      ir,
      {
        ...
        children: /* @__PURE__ */ p(Rr, { container: Un, children: [
    ...
    c === "dropdown" && ut && /* @__PURE__ */ r(eo, { open: Ye === "range", onOpenChange: Xn, children: /* @__PURE__ */ r(
      ir,
      {
        ...
        children: /* @__PURE__ */ p(Rr, { container: te, children: [
...
const si = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Bt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(zs, { children: l.label }),
    /* @__PURE__ */ r(yw, { children: /* @__PURE__ */ r(Ks, { children: si(
      t,
      e,
      ai(t, l.id),
      o
...
function uo({
  ...
  return /* @__PURE__ */ p(ke, { variant: s, children: [
    /* @__PURE__ */ r(Pe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(al, {}) }) }),
    /* @__PURE__ */ r(we, { align: "start", style: { zIndex: Kn }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, w) => /* @__PURE__ */ p(fo, { children: [
      /* @__PURE__ */ r(Fs, { children: /* @__PURE__ */ r(Pt, { children: si(e.groups, e.items, d, t) }) }),
...
function Km({
  ...
  return /* @__PURE__ */ p(ii, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      uo,
      {
        onSelectMenuItem: t,
...
function qm({
  ...
  return /* @__PURE__ */ r(ii, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    uo,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const li = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Jt.Root,
    {
...
)), di = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Jt.Content,
  {
    ref: n,
    className: h(
...
di.displayName = Jt.Content.displayName;
function Hm({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(li, { children: [
      /* @__PURE__ */ r(ci, { children: t.map((l) => /* @__PURE__ */ r(Jp, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(di, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Zp({ ...t }) {
...
const wi = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
wi.displayName = ft.Root.displayName;
...
pi.displayName = ft.Trigger.displayName;
const ui = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = me();
  return /* @__PURE__ */ p(
    ft.SubTrigger,
    {
...
ui.displayName = ft.SubTrigger.displayName;
...
mi.displayName = ft.SubContent.displayName;
const fi = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = me();
...
fi.displayName = ft.Content.displayName;
const hi = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = me();
  return /* @__PURE__ */ r(
    ft.Item,
    {
...
hi.displayName = ft.Item.displayName;
...
const gi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
gi.displayName = ft.Separator.displayName;
const On = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, w) => c.order - w.order).map((c) => /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(Bt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        ...
        /* @__PURE__ */ r(ui, { children: c.label }),
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(gi, {}, `separator-${s}`)), d;
  });
};
function ru({
  menuData: t,
  ...
  if (Ec(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    ...
    return /* @__PURE__ */ r(wi, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(Zp, { children: [
      /* @__PURE__ */ r(pi, { ref: c(w), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        fi,
        {
          style: { zIndex: Kn },
          children: /* @__PURE__ */ r(Pt, { children: bi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ke, { children: [
              ...
              /* @__PURE__ */ r(we, { align: "end", children: c })
            ] }) }),
...
const sf = pe.Trigger, yu = pe.Portal, lf = pe.Close, xi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pe.Overlay,
  {
    ref: n,
...
xi.displayName = pe.Overlay.displayName;
const Nu = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(vi), i = {
...
Cu.displayName = pe.Title.displayName;
...
Eu.displayName = pe.Description.displayName;
...
Tu.displayName = Qr.Root.displayName;
function cf({
  className: t,
  ...e
}) {
...
Ru.displayName = to.Root.displayName;
