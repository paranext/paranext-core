...
import { includes as fe, Section as M, getChaptersForBook as Ta, formatScrRef as Ft, getSectionForBook as se, NumberFormat as Ea, formatBytes as Va, getCurrentLocale as Da, getFormatCallerFunction as Ma, deepEqual as rn, isString as Ie, compareScrRefs as Xe, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as j, formatReplacementString as Ia } from "platform-bible-utils";
...
const it = class A {
    ...
    if (V(this, "firstChapter"), V(this, "lastChapter"), V(this, "lastVerse"), V(this, "hasSegmentsDefined"), V(this, "text"), V(this, "BBBCCCVVVS"), V(this, "longHashCode"), V(this, "versification"), V(this, "rtlMark", "‏"), V(this, "_bookNum", 0), V(this, "_chapterNum", 0), V(this, "_verseNum", 0), V(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        if (e != null && e instanceof A) {
          ...
          if (e == null) return;
          const s = e instanceof It ? e : A.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new It(i)), n ? new A(n, a.toString(), w, u) : new A();
  }
  /**
...
function Ii({
  ...
  const l = at(), [p, f] = P(!1), [h, g] = P(""), [b, x] = P(""), [y, I] = P("books"), [T, N] = P(void 0), [O, z] = P(!1), $ = nt(void 0), X = nt(void 0), H = nt(void 0), _ = nt(void 0), C = nt({}), G = F(
    (v) => {
      e(v), w && w(v);
    },
    [e, w]
  ), E = J(() => a ? a() : rr, [a]), Z = J(() => ({
    [M.OT]: E.filter((L) => B.isBookOT(L)),
    [M.NT]: E.filter((L) => B.isBookNT(L)),
    [M.DC]: E.filter((L) => B.isBookDC(L)),
    [M.Extra]: E.filter((L) => B.extraBooks().includes(L))
    ...
    return [M.OT, M.NT, M.DC, M.Extra].forEach((et) => {
    ...
    (v) => {
      const L = y === "chapters" ? T : k == null ? void 0 : k.book;
      L && (G({
        book: L,
        chapterNum: v,
        verseNum: 1
      }), f(!1), I("books"), N(void 0), x(""));
    },
    [G, y, T, k]
  ), Vt = F(
    (v) => {
    ...
    (v) => {
      if (v.ctrlKey) return;
      const { isLetter: L, isDigit: et } = On(v.key);
      if (y === "chapters") {
        if (v.key === "Backspace") {
        ...
        if (L || et) {
          if (v.preventDefault(), v.stopPropagation(), I("books"), N(void 0), et && T) {
            const ot = At[T];
            x(`${ot} ${v.key}`);
          } else
            x(v.key);
    ...
    const { isLetter: L, isDigit: et } = On(v.key);
    (L || et) && (v.preventDefault(), x((ot) => ot + v.key), X.current.focus(), z(!1));
  }, []);
  return Tn(() => {
    const v = setTimeout(() => {
      if (p && y === "books" && H.current && _.current) {
        const L = H.current, et = _.current, ot = et.offsetTop, st = L.clientHeight, Dt = et.clientHeight, Nt = ot - st / 2 + Dt / 2;
        L.scrollTo({
          top: Math.max(0, Nt),
          behavior: "smooth"
        }), g(Ue(t.book));
    ...
    if (y === "chapters" && T) {
      ...
      setTimeout(() => {
        if (H.current)
          if (v) {
            const L = C.current[t.chapterNum];
      ...
      Wt,
      {
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: S.map(({ onClick: v, disabled: L, title: et, icon: ot }) => /* @__PURE__ */ r(
              D,
              {
                variant: "ghost",
                size: "sm",
          ...
          !O && /* @__PURE__ */ c(Zt, { ref: H, children: [
            y === "books" && /* @__PURE__ */ c(kt, { children: [
              !k && Object.entries(q).map(([v, L]) => {
                if (L.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(zt, { heading: Xr(v), children: L.map((et) => /* @__PURE__ */ r(
                      ar,
                      {
                        bookId: et,
                        onSelect: (ot) => xt(ot),
...
function Ke({
  ...
  const [y, I] = P(!1);
  return /* @__PURE__ */ c(te, { open: y, onOpenChange: I, ...x, children: [
...
function yo({ table: t }) {
  return /* @__PURE__ */ c(_e, { children: [
    /* @__PURE__ */ r($a, { asChild: !0, children: /* @__PURE__ */ c(D, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function Io({
  ...
  var $;
  const [p, f] = P([]), [h, g] = P([]), [b, x] = P({}), [y, I] = P({}), T = J(() => e ?? [], [e]), N = Xn({
    data: T,
    columns: t,
    getCoreRowModel: Hn(),
...
function Fi({
  ...
  const f = p ? Ko(p, "%webView_footnoteList_header%") : "Footnotes", h = u ?? Ma(n, void 0), g = (N, O) => {
    l == null || l(N, O, o);
  }, b = s ? n.findIndex((N) => N === s) : 0, [x, y] = P(b), I = (N) => {
    if (n.length)
      switch (N.key) {
        case "ArrowDown":
...
function Zi({
  ...
  const f = ft(n, "%webView_inventory_all%"), h = ft(n, "%webView_inventory_approved%"), g = ft(n, "%webView_inventory_unapproved%"), b = ft(n, "%webView_inventory_unknown%"), x = ft(n, "%webView_inventory_scope_currentBook%"), y = ft(n, "%webView_inventory_scope_chapter%"), I = ft(n, "%webView_inventory_scope_verse%"), T = ft(n, "%webView_inventory_filter_text%"), N = ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), O = ft(n, "%webView_inventory_no_results%"), [z, $] = P(!1), [X, H] = P("all"), [_, C] = P(""), [G, E] = P([]), Z = J(() => {
    const S = t ?? [];
...
const br = m.forwardRef(
  ({
    ...
    const [l, p] = m.useState(t), f = e ?? l, h = m.useCallback(
      ...
      [n, f]
    ), g = m.useCallback(() => h((N) => !N), [h]), b = f ? "expanded" : "collapsed", I = at() === "ltr" ? i : i === "primary" ? "secondary" : "primary", T = m.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: h,
...
function tw({
  ...
  St(() => {
    if (w) {
      const _ = I.getSelectedRowModel().rowsById, C = Object.keys(_);
      if (C.length === 1) {
        const G = x.find((E) => $n(E) === C[0]) || void 0;
        G && w(G);
      }
    }
  }, [g, x, w, I]);
  ...
  return /* @__PURE__ */ c("div", { id: u, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ c(Se, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Te, { children: I.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.filter((C) => C.column.columnDef.header).map((C) => (
      ...
      /* @__PURE__ */ r(Ee, { children: I.getRowModel().rows.map((_, C) => {
        const G = at();
        return /* @__PURE__ */ r(
          Ct,
          {
...
function Rs({
  ...
  }, [y, I] = P(!1), [T, N] = P(""), O = nt(void 0), z = nt(!1);
  if (t.length !== B.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const $ = J(() => B.allBookIds.filter(
    ...
    (R, q = !1) => {
      ...
      const k = $.findIndex((S) => S === O.current), Q = $.findIndex((S) => S === R);
      if (k === -1 || Q === -1) return;
      const [xt, Xt] = [
        Math.min(k, Q),
        Math.max(k, Q)
      ], Vt = $.slice(xt, Xt + 1).map((S) => S);
      n(
    ...
    (R) => {
      const q = kn($, R).map((k) => k);
      n(
        Rr($, R, e) ? e.filter((k) => !q.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, $]
  ), E = () => {
                  ...
                  Object.values(M).map((R, q) => {
                    ...
                    if (k.length !== 0)
                      return /* @__PURE__ */ c(jn, { children: [
                        ...
                        q < Object.values(M).length - 1 && /* @__PURE__ */ r(qn, {})
                      ] }, R);
                  })
                ] })
              ]
...
function nw({
  ...
  const l = Mt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Mt(i, "%webView_scope_selector_current_book%"), g = Mt(i, "%webView_scope_selector_choose_books%"), b = Mt(i, "%webView_scope_selector_scope%"), x = Mt(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], I = e ? y.filter((T) => e.includes(T.value)) : y;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        dn,
        {
          ...
          children: I.map(({ value: T, label: N, id: O }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
...
function pw({
  ...
  const l = Os(
    ...
    var I, T, N, O, z, $;
    const y = x !== b ? ((T = (I = t[b]) == null ? void 0 : I.uiNames) == null ? void 0 : T[x]) ?? ((O = (N = t[b]) == null ? void 0 : N.uiNames) == null ? void 0 : O.en) : void 0;
    return y ? `${(z = t[b]) == null ? void 0 : z.autonym} (${y})` : ($ = t[b]) == null ? void 0 : $.autonym;
  };
