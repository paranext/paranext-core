...
import v, { forwardRef as fn, useRef as G, useMemo as z, useState as D, useCallback as B, useLayoutEffect as $t, createContext as Ln, useContext as Tr, useEffect as U, Component as Ii, createElement as Wr, Suspense as Ai, Fragment as Mo } from "react";
import { Command as Et } from "cmdk";
import { X as hn, Search as Oo, Check as Qt, Clock as Jr, ChevronsLeft as Zr, ChevronsRight as Qr, ChevronLeft as ir, ChevronRight as je, ArrowLeft as Pi, ArrowRight as $i, Circle as Vn, ChevronDown as Ue, BoldIcon as Li, ItalicIcon as Vi, AtSign as Io, Pencil as ji, Trash2 as zi, ArrowUp as Ao, MoreHorizontal as Fi, MailOpen as Bi, Mail as Ki, ChevronUp as Po, FilterIcon as Gi, ArrowLeftIcon as Ui, ChevronLeftIcon as qi, ChevronRightIcon as Hi, ArrowRightIcon as Yi, Copy as $o, Filter as Xi, User as Wi, Link as Ji, CircleHelp as Zi, ChevronsUpDown as Lo, Star as Qi, Undo as ts, Redo as es, SquareX as Vo, FunctionSquare as jo, SquareSigma as zo, Ban as ns, AlertCircle as sr, CircleCheckIcon as rs, CircleXIcon as os, CircleHelpIcon as as, ArrowUpIcon as is, ArrowDownIcon as ss, PanelLeft as ls, PanelRight as cs, ScrollText as ws, MenuIcon as ds, Menu as ps, EllipsisVertical as us, MoreVertical as to, LoaderCircle as ms, GripVertical as fs } from "lucide-react";
...
import { createEditor as Bo, $getRoot as ce, $createParagraphNode as He, $getSelection as Ct, HISTORY_MERGE_TAG as Rr, ParagraphNode as Ko, TextNode as Go, $isTokenOrSegmented as Es, $getCharacterOffsets as Ts, $cloneWithPropertiesEphemeral as Rs, $getPreviousSelection as Ss, $isRangeSelection as Wt, $caretFromPoint as Ds, $getSiblingCaret as Uo, $getChildCaret as Ms, $getAdjacentChildCaret as Os, $isChildCaret as Is, $normalizeCaret as As, $setSelectionFromCaretRange as Ps, $getCollapsedCaretRange as $s, $getCaretInDirection as no, $splitAtPointCaretNext as Ls, $isTextPointCaret as Vs, $findMatchingParent as qo, $isElementNode as ie, mergeRegister as we, getDOMTextNode as js, isHTMLElement as Ho, CLEAR_EDITOR_COMMAND as Yo, COMMAND_PRIORITY_EDITOR as Sr, shallowMergeConfig as zs, defineExtension as jt, safeCast as Ae, createState as Fs, FORMAT_TEXT_COMMAND as Xo, $isNodeSelection as Wo, COMMAND_PRIORITY_LOW as Jo, RootNode as Bs, LineBreakNode as Ks, TabNode as Gs, $isEditorState as Us, createCommand as qs, CLICK_COMMAND as Hs, isDOMNode as Ys, $getNodeFromDOMNode as Xs, $createNodeSelection as Ws, $setSelection as Js, $getEditor as Zs, DecoratorNode as cr, $getState as Qs, toggleTextFormatType as ro, TEXT_TYPE_TO_FORMAT as tl, $setState as el, addClassNamesToElement as Zo, $create as nl, $getNodeByKey as rl, removeClassNamesFromElement as ol, KEY_TAB_COMMAND as al, $isBlockElementNode as Tn, $createRangeSelection as il, $normalizeSelection__EXPERIMENTAL as sl, OUTDENT_CONTENT_COMMAND as ll, INDENT_CONTENT_COMMAND as oo, INSERT_TAB_COMMAND as cl, COMMAND_PRIORITY_CRITICAL as Dr, $isDecoratorNode as wl, $isParagraphNode as dl, $isTextNode as Rn, SELECTION_CHANGE_COMMAND as Qo, getRegisteredNode as pl, isDocumentFragment as ao, isDOMDocumentNode as ul, ArtificialNode__DO_NOT_USE as ta, $createLineBreakNode as ea, $isRootOrShadowRoot as ml, isBlockDomNode as io, isInlineDomNode as so, $insertNodes as fl } from "lexical";
...
import * as na from "@radix-ui/react-toggle";
import { createHeadlessEditor as ra } from "@lexical/headless";
import * as oa from "@radix-ui/react-separator";
...
import { useReactTable as aa, getFilteredRowModel as _l, getSortedRowModel as ia, getPaginationRowModel as Cl, getCoreRowModel as sa, flexRender as ln, getGroupedRowModel as El, getExpandedRowModel as Tl } from "@tanstack/react-table";
...
const Xe = 250, la = 300, Al = 400, Pl = 450, $l = 500, Ll = "layoutDirection";
function ft() {
  const t = localStorage.getItem(Ll);
  return t === "rtl" ? t : "ltr";
}
const Vl = Dt.Root, ru = Dt.Trigger, jl = Dt.Portal, ou = Dt.Close, ca = v.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: o,
    className: h(
...
ca.displayName = Dt.Overlay.displayName;
const wa = v.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, i) => {
  const s = ft();
...
wa.displayName = Dt.Content.displayName;
...
const pa = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Title,
  {
    ref: n,
...
pa.displayName = Dt.Title.displayName;
...
const We = v.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(Oo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Et.Input,
      {
        ref: n,
...
const fa = mt.allBookIds.filter(
  (t) => !mt.isObsolete(mt.bookIdToNumber(t))
), Te = Object.fromEntries(
  fa.map((t) => [t, mt.bookIdToEnglishName(t)])
);
function Ar(t, e, n) {
...
const ha = fn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? qe : "button", { className: h(ga({ variant: e, size: n, className: t })), ref: i, ...a })
);
...
function iu({
  ...
  const c = ft(), [d, m] = D(!1), [f, u] = D(""), [g, b] = D(""), [x, C] = D("books"), [y, k] = D(void 0), [N, V] = D(!1), $ = G(void 0), A = G(void 0), R = G(void 0), _ = G(void 0), S = G({}), L = B(
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: X, isDigit: Q } = lo(M.key);
      if (x === "chapters") {
        if (M.key === "Backspace") {
...
), gt = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Fo.Root, { ref: n, className: h("pr-twp", Yl(), t), ...e }));
...
const va = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Zl = va ? $t : U, yn = { tag: Rr };
function Ql({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: w } = t, c = Jl(null, o), d = Bo({ editable: t.editable, html: w, namespace: a, nodes: i, onError: (m) => s(m, d), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = He();
            u.append(g);
            const b = va ? document.activeElement : null;
...
const $r = {
  ...
  {
    ref: o,
    className: e ? h(ga({ variant: e }), t) : t,
    ...n
  }
));
...
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, dc = xa && "documentMode" in document ? document.documentMode : null;
!(!xa || !("InputEvent" in window) || dc) && "getTargetRanges" in new window.InputEvent("input");
function Yt(t) {
  return `${t}px`;
}
    ...
    d.read(() => {
      ...
      if (($ || A) && N !== null && V !== null) {
        const R = function(_, S, L, j, P, I, q) {
          ...
          return T.setStart(...wo(S, L, j)), T.setEnd(...wo(P, I, q)), T;
        }(t, f, g, N, u, C, V);
        w(), w = uc(t, R, e);
      }
...
function gc(t) {
  const e = qo(t, (n) => ie(n) && !n.isInline());
...
function vc(t, e, n) {
  ...
  return Vs(o) && Dn(283), o.insert(t.isInline() ? He().append(t) : t), no(Uo(t.getLatest(), "next"), e.direction);
}
function xc(t) {
  const e = Ct();
  if (!Wt(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = qo(i, (c) => ie(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Cc(t) {
  ...
  Na(this), J = t, this.f &= -2, 8 & this.f && Vr(this), zn();
}
function $e(t, e) {
...
kt.prototype.brand = yc, kt.prototype.h = function() {
  ...
  if (this.g = Cn, this.f |= 1, this.i > 0 && !ya(this)) return this.f &= -2, !0;
  const t = J;
  try {
    mo(this), J = this;
    const e = this.x();
...
function Ca(t, e = _a) {
  return t.registerCommand(Yo, (n) => (t.update(e), !0), Sr);
}
jt({ build: (t, e, n) => Je(e), config: Ae({ $onClear: _a }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [Ea], register: (t, e, n) => t.registerCommand(Xo, (o) => {
  const a = Ct();
  if (Wo(a) || Wt(a)) for (const i of a.getNodes()) Tc(i) && i.toggleFormat(o);
  return !1;
}, Jo) });
function Ta(t, e) {
  let n;
...
const vr = jt({ build: (t) => Ta(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const jr = 0, xr = 1, Sa = 2, Jn = 3, Nn = 4, Pe = 5, Zn = 6, rn = 7;
function Qn(t) {
  return t.id === jr;
}
function Da(t) {
...
function Rc(t) {
  return function(e) {
    return e.id === xr;
  }(t) || nt(305, String(t.id), String(xr)), Object.assign(t, { id: Sa });
}
...
const Oc = jt({ config: Ae({ setOptions: fo, updateOptions: fo }), init: ({ $initialEditorState: t = Mc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Bs, Go, Ks, Gs, Ko] }), ho = Symbol.for("@lexical/extension/LexicalBuilder");
function go() {
}
function Ic(t) {
  throw t;
...
class Ve {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Bo({ ...o, ...n ? { onError: (i) => {
      n(i, a);
    } } : {} }), { [ho]: this });
...
const Ac = /* @__PURE__ */ new Set(), bo = jt({ build(t, e, n) {
  const o = n.getDependency(vr).output, a = pn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Ta(() => {
  }, () => Zt(() => {
...
jt({ dependencies: [vr, bo], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(bo).output, a = pn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return we(t.registerCommand(Pc, (s) => {
    ...
    if (Ys(s.target)) {
      ...
      if (Lc(l)) return function(w, c = !1) {
        ...
        let u;
        c && Wo(d) ? u = d : (u = Ws(), Js(u)), m ? u.delete(f) : u.add(f);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Jo), t.registerMutationListener(Fe, (s, l) => {
    Nc(() => {
      let w = !1;
...
jt({ build: (t, e, n) => Je(e), config: Ae({ $canIndent: Ma, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
...
jt({ build: (t, e, n) => Je(e), config: Ae({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => Zt(() => n.getOutput().disabled.value ? void 0 : Ia(t)) });
function Kc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
function Wc({ onClear: t }) {
  const [e] = ne();
  return Xc(() => Ca(e, t), [e, t]), null;
}
const Aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : U;
function Jc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: b, role: x = "textbox", spellCheck: C = !0, style: y, tabIndex: k, "data-testid": N, ...V }, $) {
  ...
  return Aa(() => (R(t.isEditable()), t.registerEditableListener((L) => {
    R(L);
...
function ow() {
  const [t, e] = D(void 0), n = B(() => {
    ...
    return /* @__PURE__ */ r(Vl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(wa, { children: [
...
const La = pe(
  ...
  {
    ref: a,
    className: h(La({ variant: e, size: n, className: t })),
    ...o
  }
));
sw.displayName = na.Root.displayName;
const Va = v.createContext({
  size: "default",
  variant: "default"
...
function lw() {
  const { activeEditor: t } = $a(), [e, n] = D([]), o = B((a) => {
    if (Wt(a) || Nl(a)) {
      const i = [];
      yo.forEach(({ format: s }) => {
...
function pw(t, e) {
  ...
  let o = [];
  const a = [];
  for (const i of n) if (!za.has(i.nodeName)) {
    const s = Fa(i, t, a, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof ta && s.insertAfter(ea());
    for (const s of i) {
...
function ja(t, e, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], b = ja(t, g, f, o);
    !a && ie(e) && b && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Ho(d) || ao(d)) && d.append(f), n.append(d), m) {
      const u = m.call(s, d);
...
function Fa(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  ...
  return d != null && (f = d(f)), io(t) && (f = mw(t, f, u ? () => {
    const g = new ta();
    return n.push(g), g;
  } : He)), l == null ? f.length > 0 ? s = s.concat(f) : io(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : so(g.nextSibling) && so(g.previousSibling);
  }(t) && (s = s.concat(ea())) : ie(l) && l.append(...f), s;
}
function mw(t, e, n) {
...
De.displayName = oa.Root.displayName;
const hw = pe(
...
function Ha({
  ...
  const i = No(o, "%cancelButton_tooltip%"), s = No(o, "%acceptButton_tooltip%");
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), n()) : Gr(b) && (b.preventDefault(), b.stopPropagation(), Bt(a) && f());
        },
        onKeyDown: (b) => {
...
function be({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ur.Provider, { value: n, children: /* @__PURE__ */ r(rt.Root, { ...e }) });
}
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), u()) : Gr(N) && (N.preventDefault(), N.stopPropagation(), Bt(d) && g());
              },
              onKeyDown: (N) => {
...
function Mw({
  ...
  const It = z(() => xt[0], [xt]), xe = G(null), Ut = G(void 0), oe = B(() => {
    var E;
    (E = Ut.current) == null || E.call(Ut), R(_o);
  }, []), tn = B(() => {
    const E = !ht;
            ...
            o && /* @__PURE__ */ p(st, { children: [
              ...
              x !== !1 && (!I || Bt(A)) && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  onKeyDownCapture: (E) => {
                    Gr(E) && (E.preventDefault(), E.stopPropagation(), (Bt(A) || _ !== void 0) && ct());
                  },
                  onKeyDown: (E) => {
...
function Gw({
  ...
  var $;
  const [d, m] = D([]), [f, u] = D([]), [g, b] = D({}), [x, C] = D({}), y = z(() => e ?? [], [e]), k = aa({
    data: y,
    columns: t,
    getCoreRowModel: sa(),
...
function qw({
  ...
  const a = Eo(n, "%webView_error_dump_header%"), i = Eo(n, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r($o, {}) })
        ] }),
...
function Jw({
  ...
  const w = z(() => /Macintosh/i.test(navigator.userAgent), []), c = To(a, "%undoButton_tooltip%"), d = To(a, "%redoButton_tooltip%");
  return /* @__PURE__ */ p(Ga, { children: [
    /* @__PURE__ */ r(Mt, { children: /* @__PURE__ */ p(Lt, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(
        F,
...
function rd({
  ...
  return /* @__PURE__ */ p(be, { children: [
    ...
    /* @__PURE__ */ p(de, { style: { zIndex: la }, children: [
...
const Hr = v.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pr.Root,
  {
    ref: n,
    className: h(
...
Hr.displayName = pr.Root.displayName;
const hd = (t) => {
  if (t === "asc")
...
}, So = (t) => `${Gd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Iu({
  sources: t,
  ...
  U(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const L = b.find((j) => So(j) === S[0]) || void 0;
        L && l(L);
      }
    }
  }, [u, b, l, C]);
...
}), mi = (t, e, n) => Xr(t, e).every((o) => n.includes(o));
function Ud({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Xr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function Er({
  ...
  return /* @__PURE__ */ p(be, { variant: i, children: [
    ...
    /* @__PURE__ */ r(de, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(Mo, { children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(be, { children: [
              /* @__PURE__ */ r(Me, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(to, {}) }) }),
