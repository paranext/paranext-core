      ...
      /* @__PURE__ */ r(
        Yt,
        {
          ...
          className: d(
            ...
            i && (s ? "focus-visible:tw-ring-green-600" : "focus-visible:tw-ring-destructive"),
            o
          ),
          onChange: (v) => t(v.target.value),
          onKeyDown: (v) => {
            v.key === "Enter" ? (a(), v.preventDefault()) : e(v);
          },
          onClick: n,
          onFocus: (v) => {
            var f;
            g(!0), (f = w.onFocus) == null || f.call(w, v);
          },
          onBlur: (v) => {
            var f;
            g(!1), (f = w.onBlur) == null || f.call(w, v);
          },
          ref: c
        }
      ),
      p && i && (s ? /* @__PURE__ */ r(Tt, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : /* @__PURE__ */ r(Vr, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), Je = Rr(void 0);
function dt() {
...
const tt = class O {
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new Ot(i)), n ? new O(n, a.toString(), w, c) : new O();
  }
  /**
...
E(tt, "defaultVersification", Ot.English), E(tt, "verseRangeSeparator", "-"), E(tt, "verseSequenceIndicator", ","), E(tt, "verseRangeSeparators", [tt.verseRangeSeparator]), E(tt, "verseSequenceIndicators", [tt.verseSequenceIndicator]), E(tt, "chapterDigitShifter", 1e3), E(tt, "bookDigitShifter", tt.chapterDigitShifter * tt.chapterDigitShifter), E(tt, "bcvMaxValue", tt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
E(tt, "ValidStatusType", Ln);
...
function Us({
  ...
  const o = K(), [s, i] = P(
    () => zt(t, "English")
  ), [w, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, C] = P(t.book), [S, N] = P(!1), [y, _] = P(S), [D, I] = P(!1), [z, yt] = P(void 0), H = Z(void 0), x = Z(void 0), b = Z(void 0), B = Y(
    (m) => {
      if (m.trim())
        return vn.reduce(
          (V, k) => {
    ...
    (m) => {
      ...
      return {
        ...
        const j = Hn[k].toLowerCase(), X = w.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    () => Nt.reduce((m, V) => m + V.books.length, 0),
    [Nt]
  ), ct = Y(
    (m) => {
      i(m), c(m.trim()), yt(B(m.trim()));
    },
    [B]
  ), J = Z(!1), R = Y(() => {
    ...
    (m) => {
      if (S ? m.key === "ArrowDown" || m.key === "Tab" && !m.shiftKey ? (b != null && b.current ? b.current.focus() : x.current && x.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === H.current && (N(!1), m.preventDefault(), m.stopPropagation()) : m.key !== "Tab" && N(!0), document.activeElement === H.current) {
        if (!D) {
          if (/^[a-zA-Z]$/.test(m.key) && (ct(m.key), I(!0), m.preventDefault()), /^\d$/.test(m.key)) {
            const k = s.match(
              Zt.EXTRACT_BOOK_FROM_REFERENCE
            );
            if (k) {
              const X = `${k[1]} ${m.key}`;
              ct(X), I(!0), m.preventDefault();
            }
          }
          if (m.key === ":") {
            const k = s.match(
      ...
      if (m.key === "Tab") {
        if (m.shiftKey)
          ...
          const V = [
            ...
            (j) => {
              var X, pt;
              return j instanceof HTMLElement && ((j.offsetWidth > 0 || j.offsetHeight > 0) && !((X = x.current) != null && X.contains(j)) && !((pt = H.current) != null && pt.contains(j)) || j === m.target);
            }
          ), k = m.target instanceof HTMLElement ? V.indexOf(m.target) : -1;
          k >= 0 ? V[(k + 1) % V.length].focus() : H.current.focus();
        }
        m.preventDefault(), m.stopPropagation();
        return;
      }
      m.stopPropagation(), H.current.focus(), H.current.dispatchEvent(new KeyboardEvent("keydown", { ...m, view: void 0 }));
    }
  }, []), Sr = Y(
    (m) => {
      const { key: V } = m;
      xn.has(V) || (ae(m), m.preventDefault());
    },
    [ae]
  ), Tr = Y(
    (m, V) => {
      ...
      if (xn.has(k)) {
        if (h === p || at === 1) {
          const X = at === 1 ? h : p;
          if (k === "Enter") {
            m.preventDefault(), Q(X, !0, v);
            return;
          }
          const pt = k === "ArrowRight" && !o || k === "ArrowRight" && o === "ltr" || k === "ArrowLeft" && o === "rtl", oe = k === "ArrowLeft" && !o || k === "ArrowLeft" && o === "ltr" || k === "ArrowRight" && o === "rtl", st = p !== h ? T ?? Array.from({ length: Pt(h) }, (Et, vt) => vt + 1) : Array.from({ length: Pt(h) }, (Et, vt) => vt + 1);
          console.log("availableChapters:", st);
          const ut = st.indexOf(v);
          let mt = v;
          if (pt)
  ...
  wt(() => {
    at === 1 ? f(1) : p === h ? p === t.book ? f(t.chapterNum) : f(1) : f(0);
  }, [h, t.book, t.chapterNum, p, at]), wt(() => {
    if (!T || at > 1) return;
    T.indexOf(v) === -1 && f(T[0]);
  }, [h, v, p, T, at]), wt(() => {
    R();
  ...
  return /* @__PURE__ */ l(pe, { modal: !1, open: S, onOpenChange: W, children: [
    ...
    at > 0 && /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ l("div", { className: "rtl:tw-ps-2", children: [
          ...
          Nt.map((m, V) => /* @__PURE__ */ l("div", { children: [
            /* @__PURE__ */ r(me, { className: "tw-font-semibold tw-text-foreground/80", children: Ia[m.bookType] }),
            m.books.map((k, j) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              za,
              {
                bookId: k,
                handleSelectBook: () => Q(k, !1),
                shouldExpandChildren: p.toLowerCase() === k.toLowerCase() || at === 1,
...
const ja = Rt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Lt : "button", { className: d(ja({ variant: e, size: n, className: t })), ref: s, ...o })
);
F.displayName = "Button";
const Xa = Rt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), U = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(En.Root, { ref: n, className: d("pr-twp", Xa(), t), ...e }));
...
sn.displayName = et.Group.displayName;
...
Un.displayName = et.Separator.displayName;
...
function Fe({
  ...
  const [N, y] = P(!1);
  return /* @__PURE__ */ l(an, { open: N, onOpenChange: y, ...S, children: [
    /* @__PURE__ */ r(on, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: f,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      he,
      {
        ...
        children: /* @__PURE__ */ l(fe, { children: [
          ...
          /* @__PURE__ */ r(be, { children: e.map((_) => /* @__PURE__ */ l(
            xe,
            {
              value: w(_),
              onSelect: () => {
...
function qa({ table: t }) {
  return /* @__PURE__ */ l(pe, { children: [
    /* @__PURE__ */ r(oa, { asChild: !0, children: /* @__PURE__ */ l(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = L.Root, Ja = L.Group, Gt = L.Value, Wa = Rt(
  ...
  return /* @__PURE__ */ l(
    L.Trigger,
    {
      className: d(Wa({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
...
const it = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  L.Item,
  {
    ref: a,
    className: d(
...
function ro({
  ...
  var N;
  const [w, c] = P([]), [p, g] = P([]), [v, f] = P({}), [h, C] = P({}), S = Vn({
    data: e,
    columns: t,
    getCoreRowModel: On(),
...
function Ws({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(pe, { children: [
    /* @__PURE__ */ r(We, { asChild: !0, children: /* @__PURE__ */ l(F, { variant: "default", children: [
      /* @__PURE__ */ r(Ar, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(de, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(re, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
...
function io({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ l(an, { open: v, onOpenChange: f, children: [
    /* @__PURE__ */ r(on, { asChild: !0, children: /* @__PURE__ */ l(
      F,
      {
        variant: "ghost",
...
function wo({
  ...
  return /* @__PURE__ */ l(ye, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ne, { stickyHeader: !0, children: /* @__PURE__ */ l(St, { children: [
...
function wi({
  ...
  const p = kt(n, "%webView_inventory_all%"), g = kt(n, "%webView_inventory_approved%"), v = kt(n, "%webView_inventory_unapproved%"), f = kt(n, "%webView_inventory_unknown%"), h = kt(n, "%webView_inventory_scope_currentBook%"), C = kt(n, "%webView_inventory_scope_chapter%"), S = kt(n, "%webView_inventory_filter_text%"), N = kt(
    n,
    "%webView_inventory_show_additional_items%"
  ...
  }, [y, b]), T = q(() => uo(B, D, z), [B, D, z]), rt = q(() => {
    var Q, gt;
    if (!y) return c;
    const R = (Q = a == null ? void 0 : a.tableHeaders) == null ? void 0 : Q.length;
    if (!R) return c;
    const W = [];
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Xt, { onValueChange: (R) => at(R), defaultValue: i, children: [
        /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Gt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(At, { children: [
          /* @__PURE__ */ r(it, { value: "book", children: h }),
...
const tr = u.forwardRef(
  ({
    ...
    const [p, g] = u.useState(t), v = e ?? p, f = u.useCallback(
      ...
      [n, v]
    ), h = u.useCallback(() => f((D) => !D), [f]), C = v ? "expanded" : "collapsed", y = K() === "ltr" ? i : i === "primary" ? "secondary" : "primary", _ = u.useMemo(
      () => ({
        state: C,
        open: v,
        setOpen: f,
    ...
    er,
    {
      ...
      children: /* @__PURE__ */ l(rr, { children: [
        /* @__PURE__ */ l(je, { children: [
          ...
          /* @__PURE__ */ r(Ge, { children: /* @__PURE__ */ r(ar, { children: Object.entries(e).map(([f, h]) => /* @__PURE__ */ r(or, { children: /* @__PURE__ */ r(
            sr,
            {
              onClick: () => p(f),
              isActive: v(f),
...
function di({
  ...
  const [c, p] = P([]), [g, v] = P([{ id: Ct, desc: !1 }]), [f, h] = P({}), C = q(
  ...
  }, yt = (x, b) => x.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), H = (x, b, B) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: N.getHeaderGroups().map((x) => /* @__PURE__ */ r(St, { children: x.headers.filter((b) => b.column.columnDef.header).map((b) => (
        ...
        /* @__PURE__ */ r(ee, { colSpan: b.colSpan, className: "top-0 tw-sticky", children: b.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
...
function Go({
  ...
  const s = un(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], p = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
...
function $o({
  ...
  const I = q(() => M.allBookIds.filter(
    ...
    (b, B = !1) => {
      ...
      const T = I.findIndex((J) => J === _.current), rt = I.findIndex((J) => J === b);
      if (T === -1 || rt === -1) return;
      const [Nt, at] = [
        Math.min(T, rt),
        Math.max(T, rt)
      ], ct = I.slice(Nt, at + 1).map((J) => J);
      n(
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(an, { open: N, onOpenChange: y, children: [
      /* @__PURE__ */ r(on, { asChild: !0, children: /* @__PURE__ */ l(
        F,
        {
          variant: "outline",
...
function pi({
  ...
  const c = Dt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Dt(i, "%webView_scope_selector_current_book%"), f = Dt(i, "%webView_scope_selector_choose_books%"), h = Dt(i, "%webView_scope_selector_scope%"), C = Dt(i, "%webView_scope_selector_select_books%"), S = [
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        rn,
        {
          ...
          children: N.map(({ value: y, label: _, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ l(cn, { children: [
...
function _n({
  ...
  return /* @__PURE__ */ l(pe, { variant: s, children: [
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ l(Tn, { children: [
      /* @__PURE__ */ r(Bn, { children: /* @__PURE__ */ r(dn, { children: cr(e.groups, e.items, w, t) }) }),
...
pr.displayName = nt.List.displayName;
...
ur.displayName = nt.List.displayName;
...
mr.displayName = nt.Content.displayName;
function bi({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
const qt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ l(cn, { children: [
      /* @__PURE__ */ r(pn, { asChild: !0, children: "command" in p ? /* @__PURE__ */ l(
        xr,
        {
          onClick: () => {
            a(p);
    ...
    return w.length > 0 && i < o.length - 1 && c.push(/* @__PURE__ */ r(yr, {}, `separator-${s}`)), c;
  });
};
function Jo({
  menuData: t,
  ...
  if (ma(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (C = s.current) == null || C.focus(), qt(s, [f, h]);
        break;
      case "alt+l":
        (S = i.current) == null || S.focus(), qt(i, [f, h]);
        break;
      case "alt+n":
        (N = w.current) == null || N.focus(), qt(w, [f, h]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), qt(c, [f, h]);
        break;
    }
  }), wt(() => {
    ...
    return /* @__PURE__ */ r(hr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ l(Ho, { children: [
...
function yi({
  ...
  const c = Wo(
    ...
    var N, y, _, D, I, z;
    const S = C !== h ? ((y = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : y[C]) ?? ((D = (_ = t[h]) == null ? void 0 : _.uiNames) == null ? void 0 : D.en) : void 0;
    return S ? `${(I = t[h]) == null ? void 0 : I.autonym} (${S})` : (z = t[h]) == null ? void 0 : z.autonym;
  };
      ...
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(it, { value: h, children: f(h, e) }, h))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ l($e, { children: [
...
const Qo = Le(({ className: t, ...e }, n) => /* @__PURE__ */ r(ea, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), es = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(ts({ variant: e }), t), ...n }));
...
const rs = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const ds = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Ei = nt.Root, ks = u.forwardRef(({ className: t, ...e }, n) => {
  const a = K();
  return /* @__PURE__ */ r(
    nt.List,
    {
...
ks.displayName = nt.List.displayName;
...
Cs.displayName = nt.Trigger.displayName;
...
_s.displayName = nt.Content.displayName;
