...
import Rt, { forwardRef as wi, useCallback as Se, useState as je, useRef as $t, useEffect as It, useMemo as Ft } from "react";
...
function yh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = ue, [r, o] = je(""), [i, s] = je(""), [l, c] = je(0), [u, d] = je(""), [f, p] = je(!1), b = $t(void 0), v = $t(void 0), h = $t(void 0), g = Se(
    (S) => ({
    ...
    (S) => {
      f ? (S.key === "ArrowDown" || S.key === "ArrowUp") && (typeof h < "u" && // Ref uses null
  ...
  return It(() => {
    ...
    if (f && v.current && h.current) {
      const A = h.current.offsetTop - 96;
      v.current.scrollTo({ top: A, behavior: "instant" });
    }
  }, [f, v.current, h.current]), /* @__PURE__ */ T("div", { children: /* @__PURE__ */ de(Gs, { modal: !1, open: f, onOpenChange: C, children: [
    /* @__PURE__ */ T(Ks, { asChild: !0, children: /* @__PURE__ */ T(
      Qs,
      {
        ...
        handleOnClick: () => {
          ...
          // eslint-disable-next-line no-null/no-null
          h.current !== null && h.current !== void 0 && h.current.focus();
        },
...
function il({
  ...
  let f;
  if (n) {
    const p = r === Pt.Before || r === Pt.Above, b = /* @__PURE__ */ T("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: n }), v = r === Pt.Before || r === Pt.After, h = v ? b : /* @__PURE__ */ T("div", { children: b }), g = v ? d : /* @__PURE__ */ T("div", { children: d });
    f = /* @__PURE__ */ de(
      gs,
      {
...
function ll() {
  if (Oo)
    return ie;
  Oo = 1;
  var e = typeof Symbol == "function" && Symbol.for, t = e ? Symbol.for("react.element") : 60103, n = e ? Symbol.for("react.portal") : 60106, r = e ? Symbol.for("react.fragment") : 60107, o = e ? Symbol.for("react.strict_mode") : 60108, i = e ? Symbol.for("react.profiler") : 60114, s = e ? Symbol.for("react.provider") : 60109, l = e ? Symbol.for("react.context") : 60110, c = e ? Symbol.for("react.async_mode") : 60111, u = e ? Symbol.for("react.concurrent_mode") : 60111, d = e ? Symbol.for("react.forward_ref") : 60112, f = e ? Symbol.for("react.suspense") : 60113, p = e ? Symbol.for("react.suspense_list") : 60120, b = e ? Symbol.for("react.memo") : 60115, v = e ? Symbol.for("react.lazy") : 60116, h = e ? Symbol.for("react.block") : 60121, g = e ? Symbol.for("react.fundamental") : 60117, E = e ? Symbol.for("react.responder") : 60118, $ = e ? Symbol.for("react.scope") : 60119;
  function y(m) {
  ...
  return ie.AsyncMode = c, ie.ConcurrentMode = u, ie.ContextConsumer = l, ie.ContextProvider = s, ie.Element = t, ie.ForwardRef = d, ie.Fragment = r, ie.Lazy = v, ie.Memo = b, ie.Portal = n, ie.Profiler = i, ie.StrictMode = o, ie.Suspense = f, ie.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === r || m === u || m === i || m === o || m === f || m === p || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === b || m.$$typeof === s || m.$$typeof === l || m.$$typeof === d || m.$$typeof === g || m.$$typeof === E || m.$$typeof === $ || m.$$typeof === h);
  }, ie.typeOf = y, ie;
}
var ae = {};
/** @license React v16.13.1
...
function cl() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function y(I) {
      ...
      I === r || I === u || I === i || I === o || I === f || I === p || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === b || I.$$typeof === s || I.$$typeof === l || I.$$typeof === d || I.$$typeof === g || I.$$typeof === E || I.$$typeof === $ || I.$$typeof === h);
    }
    function w(I) {
    ...
    var m = c, C = u, P = l, B = s, j = t, S = d, N = r, A = v, G = b, F = n, D = i, M = o, L = f, Q = !1;
    function Z(I) {
  ...
  return cr = function(l, c) {
    ...
    function g(O) {
      ...
      function K(U, W, q, H, X, Y, ne) {
        ...
        return W[q] == null ? U ? W[q] === null ? new h("The " + X + " `" + Y + "` is marked as required " + ("in `" + H + "`, but its value is `null`.")) : new h("The " + X + " `" + Y + "` is marked as required in " + ("`" + H + "`, but its value is `undefined`.")) : null : O(W, q, H, X, Y);
      }
      var V = K.bind(null, !1);
    ...
    function y(O) {
      function _(z, K, V, U, W) {
        ...
        if (!Array.isArray(q)) {
          var H = M(q);
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + V + "`, expected an array."));
        }
    ...
    function w() {
      function O(_, z, K, V, U) {
        ...
        if (!l(W)) {
          var q = M(W);
          return new h("Invalid " + V + " `" + U + "` of type " + ("`" + q + "` supplied to `" + K + "`, expected a single ReactElement."));
        }
        return null;
      }
      return g(O);
    ...
    function m() {
      function O(_, z, K, V, U) {
        ...
        if (!e.isValidElementType(W)) {
          var q = M(W);
          return new h("Invalid " + V + " `" + U + "` of type " + ("`" + q + "` supplied to `" + K + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return g(O);
    ...
    function C(O) {
      function _(z, K, V, U, W) {
        if (!(z[K] instanceof O)) {
          ...
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + V + "`, expected ") + ("instance of `" + q + "`."));
        }
        return null;
      }
      return g(_);
    ...
    function P(O) {
      ...
      function _(z, K, V, U, W) {
        ...
        return new h("Invalid " + U + " `" + W + "` of value `" + String(q) + "` " + ("supplied to `" + V + "`, expected one of " + X + "."));
      }
      return g(_);
    }
    function B(O) {
      function _(z, K, V, U, W) {
        ...
        var q = z[K], H = M(q);
        if (H !== "object")
          return new h("Invalid " + U + " `" + W + "` of type " + ("`" + H + "` supplied to `" + V + "`, expected an object."));
        for (var X in q)
          if (r(q, X)) {
            var Y = O(q, X, V, U, W + "." + X, n);
            if (Y instanceof Error)
    ...
    function S() {
      function O(_, z, K, V, U) {
        return F(_[z]) ? null : new h("Invalid " + V + " `" + U + "` supplied to " + ("`" + K + "`, expected a ReactNode."));
      }
      return g(O);
    }
    ...
    function A(O) {
      function _(z, K, V, U, W) {
        var q = z[K], H = M(q);
        if (H !== "object")
          return new h("Invalid " + U + " `" + W + "` of type `" + H + "` " + ("supplied to `" + V + "`, expected `object`."));
        for (var X in O) {
          var Y = O[X];
...
const wl = zt(a.elementType, yl), xl = "exact-prop: ​";
function Vi(e) {
...
function Tl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), t = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), i = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), u = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), v = !1, h = !1, g = !1, E = !1, $ = !1, y;
    y = Symbol.for("react.module.reference");
    function w(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === n || R === o || $ || R === r || R === u || R === d || E || R === b || v || h || g || typeof R == "object" && R !== null && (R.$$typeof === p || R.$$typeof === f || R.$$typeof === i || R.$$typeof === s || R.$$typeof === c || // This needs to include all possible module reference object
...
function ec(e) {
  ...
  if (!t) {
    const b = we(n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = k({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), h = k({}, n, o, r);
...
function _n(e) {
  const {
    ...
    isEnabled: s = uc,
    open: l
  } = e, c = x.useRef(!1), u = x.useRef(null), d = x.useRef(null), f = x.useRef(null), p = x.useRef(null), b = x.useRef(!1), v = x.useRef(null), h = Le(t.ref, v), g = x.useRef(null);
  x.useEffect(() => {
...
function wc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = x.useRef({}), b = x.useRef(null), v = x.useRef(null), h = Le(v, f), [g, E] = x.useState(!d), $ = vc(c);
  let y = !0;
  ...
  }), B = x.useCallback(() => o.isTopModal(m()), [o]), j = sn((M) => {
    b.current = M, M && (d && B() ? C() : v.current && nn(v.current, y));
  }), S = x.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  x.useEffect(() => () => {
...
var Ce = "top", Fe = "bottom", Ve = "right", Pe = "left", Lr = "auto", hn = [Ce, Fe, Ve, Pe], Dt = "start", cn = "end", xc = "clippingParents", oa = "viewport", Xt = "popper", Ec = "reference", Ho = /* @__PURE__ */ hn.reduce(function(e, t) {
...
function Fc(e) {
  ...
  if (!(!i || !s)) {
    var f = Lc(o.padding, n), p = Vr(i), b = c === "y" ? Ce : Pe, v = c === "y" ? Fe : Ve, h = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], g = s[c] - n.rects.reference[c], E = mn(i), $ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = h / 2 - g / 2, w = f[b], m = $ - p[d] - f[v], C = $ / 2 - p[d] / 2 + y, P = rn(w, C, m), B = c;
...
function qo(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, i = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, d = e.roundOffsets, f = e.isFixed, p = s.x, b = p === void 0 ? 0 : p, v = s.y, h = v === void 0 ? 0 : v, g = typeof d == "function" ? d({
    x: b,
    y: h
  }) : {
    x: b,
  ...
  if (u) {
    ...
    if (C === _e(n) && (C = at(n), Ze(C).position !== "static" && l === "absolute" && (P = "scrollHeight", B = "scrollWidth")), C = C, o === Ce || (o === Pe || o === Ve) && i === cn) {
      w = Fe;
      var j = f && C === m && m.visualViewport ? m.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        C[P]
      );
    ...
    if (o === Pe || (o === Ce || o === Fe) && i === cn) {
      y = Ve;
      var S = f && C === m && m.visualViewport ? m.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        C[B]
      );
      b -= S - r.width, b *= c ? 1 : -1;
  ...
  if (b = A.x, h = A.y, c) {
    var G;
    return Object.assign({}, N, (G = {}, G[w] = $ ? "0" : "", G[y] = E ? "0" : "", G.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + h + "px)" : "translate3d(" + b + "px, " + h + "px, 0)", G));
  }
  return Object.assign({}, N, (t = {}, t[w] = $ ? h + "px" : "", t[y] = E ? b + "px" : "", t.transform = "", t));
}
function Wc(e) {
...
function un(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? xc : l, u = n.rootBoundary, d = u === void 0 ? oa : u, f = n.elementContext, p = f === void 0 ? Xt : f, b = n.altBoundary, v = b === void 0 ? !1 : b, h = n.padding, g = h === void 0 ? 0 : h, E = ca(typeof g != "number" ? g : ua(g, hn)), $ = p === Xt ? Ec : Xt, y = e.rects.popper, w = e.elements[v ? $ : p], m = tu(bt(w) ? w : w.contextElement || at(e.elements.popper), c, d, s), C = Bt(e.elements.reference), P = pa({
    reference: C,
    element: y,
    strategy: "absolute",
    placement: o
  }), B = Cr(Object.assign({}, y, P)), j = p === Xt ? B : C, S = {
    top: m.top - j.top + E.top,
    bottom: j.bottom - m.bottom + E.bottom,
    left: m.left - j.left + E.left,
    right: j.right - m.right + E.right
...
function ou(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, h = n.allowedAutoPlacements, g = t.options.placement, E = Ue(g), $ = E === g, y = c || ($ || !v ? [Pn(g)] : ru(g)), w = [g].concat(y).reduce(function(V, U) {
    ...
    }, []), m = t.rects.reference, C = t.rects.popper, P = /* @__PURE__ */ new Map(), B = !0, j = w[0], S = 0; S < w.length; S++) {
      var N = w[S], A = Ue(N), G = Lt(N) === Dt, F = [Ce, Fe].indexOf(A) >= 0, D = F ? "width" : "height", M = un(t, {
        placement: N,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function hu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, h = v === void 0 ? 0 : v, g = un(t, {
    boundary: c,
    rootBoundary: u,
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), $ = Lt(t.placement), y = !$, w = zr(E), m = fu(w), C = t.modifiersData.popperOffsets, P = t.rects.reference, B = t.rects.popper, j = typeof h == "function" ? h(Object.assign({}, t.rects, {
    placement: t.placement
  })) : h, S = typeof j == "number" ? {
    mainAxis: j,
    altAxis: j
  ...
  if (C) {
    if (i) {
      var G, F = w === "y" ? Ce : Pe, D = w === "y" ? Fe : Ve, M = w === "y" ? "height" : "width", L = C[w], Q = L + g[F], Z = L - g[D], O = b ? -B[M] / 2 : 0, _ = $ === Dt ? P[M] : B[M], z = $ === Dt ? -B[M] : -P[M], K = t.elements.arrow, V = b && K ? Vr(K) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : la(), W = U[F], q = U[D], H = rn(0, P[M], V[M]), X = y ? P[M] / 2 - O - H - W - S.mainAxis : _ - H - W - S.mainAxis, Y = y ? -P[M] / 2 + O + H + q + S.mainAxis : z + H + q + S.mainAxis, ne = t.elements.arrow && mn(t.elements.arrow), I = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = N == null ? void 0 : N[w]) != null ? G : 0, R = L + X - J - I, re = L + Y - J, ve = rn(b ? An(Q, R) : Q, L, b ? ft(Z, re) : Z);
      C[w] = ve, A[w] = ve - L;
    }
    if (l) {
      var Te, me = w === "x" ? Ce : Pe, lt = w === "x" ? Fe : Ve, ke = C[m], Ge = m === "y" ? "height" : "width", Ne = ke + g[me], Ke = ke - g[lt], ye = [Ce, Pe].indexOf(E) !== -1, yt = (Te = N == null ? void 0 : N[m]) != null ? Te : 0, ct = ye ? Ne : ke - P[Ge] - B[Ge] - yt + S.altAxis, Ut = ye ? ke + P[Ge] + B[Ge] - yt - S.altAxis : Ke, yn = b && ye ? Bc(ct, ke, Ut) : rn(b ? ct : Ne, ke, b ? Ut : Ke);
      C[m] = yn, A[m] = yn - ke;
    }
    t.modifiersData[r] = A;
  }
...
function yu(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && vu(t), i = at(t), s = Bt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wr(i)) && (l = bu(t)), Be(t) ? (c = Bt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Hr(i))), {
        ...
        if (!p) {
          ...
          if (Zo($, y)) {
            ...
            for (var w = 0; w < d.orderedModifiers.length; w++) {
              ...
              var m = d.orderedModifiers[w], C = m.fn, P = m.options, B = P === void 0 ? {} : P, j = m.name;
...
const Mu = () => et({
  ...
  } = t, g = ce(t, Pu), E = x.useRef(null), $ = Le(E, n), y = x.useRef(null), w = Le(y, p), m = x.useRef(w);
  mt(() => {
    m.current = w;
...
`));
  ...
  const B = !d && c && (!h || y) ? "none" : void 0, j = h ? {
    in: d,
    onEnter: m,
    onExited: C
  } : void 0;
...
function ga(e, t) {
  const n = ma(e.theme);
  return Object.keys(e).map((r) => Xu(e, t, r, n)).reduce(an, {});
}
function fe(e) {
  return ga(e, qn);
}
...
function Rd() {
  function e(n, r, o, i) {
    ...
    return f ? f(s) : Qe(s, r, (v) => {
      let h = jn(p, d, v);
      return v === h && typeof v == "string" && (h = jn(p, d, `${n}${v === "default" ? "" : He(v)}`, v)), c === !1 ? h : {
        [c]: h
      };
    });
  }
...
function pp(e) {
  ...
  function f(h) {
    const g = ri(h, fr.text.primary) >= n ? fr.text.primary : oi.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const E = ri(h, g);
      E < 3 && console.error([`MUI: The contrast ratio of ${E}:1 for ${g} on ${h}`, "falls below the WCAG recommended absolute minimum contrast ratio of 3:1.", "https://www.w3.org/TR/2008/REC-WCAG20-20081211/#visual-audio-contrast-contrast"].join(`
`));
    }
    return g;
  }
...
The color object needs to have a \`main\` property or a \`${E}\` property.` : _t(11, g ? ` (${g})` : "", E));
...
} });` : _t(12, g ? ` (${g})` : "", JSON.stringify(h.main)));
    return ii(h, "light", $, r), ii(h, "dark", y, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, b = {
    dark: fr,
    light: oi
  };
...
function mp(e, t) {
  ...
  const b = o / 14, v = f || ((E) => `${E / u * b}rem`), h = (E, $, y, w, m) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: v($),
    ...
    button: h(l, 14, 1.75, 0.4, ai),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, ai),
...
const Dp = {
  ...
  const {
  ...
  } = t, E = ce(t, Ap), $ = Qt(), y = x.useRef(), w = vn(), m = x.useRef(null), C = Le(m, i.ref, n), P = (D) => (M) => {
    if (D) {
      const L = m.current;
      M === void 0 ? D(L) : D(L, M);
    }
    ...
    let O;
    h === "auto" ? (O = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = O) : O = L, D.style.transition = [w.transitions.create("opacity", {
      duration: O,
      delay: Q
    ...
    let Z;
    h === "auto" ? (Z = w.transitions.getAutoHeightDuration(D.clientHeight), y.current = Z) : Z = M, D.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: L
    }), w.transitions.create("transform", {
  ...
  return /* @__PURE__ */ T(g, k({
    ...
    onExiting: N,
    addEndListener: (D) => {
      h === "auto" && $.start(y.current || 0, D), r && r(m.current, D);
    },
...
const Sa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, b, v, h, g, E, $, y, w, m;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    children: B
  }), ve = vn(), Te = ve.direction === "rtl", [me, lt] = x.useState(), [ke, Ge] = x.useState(null), Ne = x.useRef(!1), Ke = F || Z, ye = Qt(), yt = Qt(), ct = Qt(), Ut = Qt(), [yn, oo] = Wi({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const er = Hi(O), Ht = x.useRef(), wn = sn(() => {
  ...
  N ? (Wt.title = !Xe && rr && !G ? ne : null, Wt["aria-describedby"] = Xe ? er : null) : (Wt["aria-label"] = rr ? ne : null, Wt["aria-labelledby"] = Xe && !rr ? er : null);
...
`));
  ...
  const qt = {};
  D || (Ae.onTouchStart = qa, Ae.onTouchEnd = Ga), G || (Ae.onMouseOver = Cn(fo, Ae.onMouseOver), Ae.onMouseLeave = Cn(ho, Ae.onMouseLeave), Ke || (qt.onMouseOver = fo, qt.onMouseLeave = ho)), A || (Ae.onFocus = Cn(uo, Ae.onFocus), Ae.onBlur = Cn(co, Ae.onBlur), Ke || (qt.onFocus = uo, qt.onBlur = co)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Ya = x.useMemo(() => {
    var ee;
    let Re = [{
    ...
    touch: Ne.current
  }), or = Hp(Gt), mo = (r = (o = Y.popper) != null ? o : j.Popper) != null ? r : Wp, go = (i = (s = (l = Y.transition) != null ? l : j.Transition) != null ? s : I) != null ? i : $r, bo = (c = (u = Y.tooltip) != null ? u : j.Tooltip) != null ? c : qp, vo = (d = (f = Y.arrow) != null ? f : j.Arrow) != null ? d : Gp, Ja = en(mo, k({}, H, (p = X.popper) != null ? p : S.popper, {
    className: we(or.popper, H == null ? void 0 : H.className, (b = (v = X.popper) != null ? v : S.popper) == null ? void 0 : b.className)
  }), Gt), Za = en(go, k({}, J, (h = X.transition) != null ? h : S.transition), Gt), Qa = en(bo, k({}, (g = X.tooltip) != null ? g : S.tooltip, {
    className: we(or.tooltip, (E = ($ = X.tooltip) != null ? $ : S.tooltip) == null ? void 0 : E.className)
  }), Gt), es = en(vo, k({}, (y = X.arrow) != null ? y : S.arrow, {
    className: we(or.arrow, (w = (m = X.arrow) != null ? m : S.arrow) == null ? void 0 : w.className)
  }), Gt);
  return /* @__PURE__ */ de(x.Fragment, {
...
const Jp = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Zp = (e) => {
  ...
  const r = tt({
    ...
    titleAccess: f,
    viewBox: p = "0 0 24 24"
  } = r, b = ce(r, Jp), v = /* @__PURE__ */ x.isValidElement(o) && o.type === "svg", h = k({}, r, {
    color: s,
    component: l,
    fontSize: c,
...
function ro(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: s } = Ft(() => {
    const d = o && o.length > 0 ? o : (
      ...
      (v, h) => (v.group.order || 0) - (h.group.order || 0)
    ), p = [];
    f.forEach((v) => {
...
const Aa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const h = (y) => {
    ...
    if (m === "ArrowDown")
      y.preventDefault(), Zt(w, C, u, c, gr);
    else if (m === "ArrowUp")
      y.preventDefault(), Zt(w, C, u, c, mi);
    else if (m === "Home")
      ...
      P.previousKeyMatched && (S || Zt(w, C, !1, c, gr, P)) ? y.preventDefault() : P.previousKeyMatched = !1;
    }
    d && d(y);
  }, g = Le(b, n);
  let E = -1;
...
const wf = Aa, xf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ef = {
  ...
  } = t, y = ce(t, xf), w = x.useRef(null), m = Le(w, l.ref, n), C = (F) => (D) => {
    if (F) {
      const M = w.current;
      D === void 0 ? F(M) : F(M, D);
    }
...
const Rf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], $f = (e) => {
  ...
  return !S && !A && (!K || z) ? null : /* @__PURE__ */ T(ln, {
    ref: O,
    container: h,
    disablePortal: C,
...
`));
    ...
    const lt = Te + R.height, ke = me + R.width, Ge = At($n(c)), Ne = Ge.innerHeight - g, Ke = Ge.innerWidth - g;
    if (g !== null && Te < g) {
      const ye = Te - g;
...
const Kf = ["onEntering"], Xf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Yf = {
  ...
  const i = tt({
    ...
    slots: $ = {},
    slotProps: y = {}
  } = i, w = ce(i.TransitionProps, Kf), m = ce(i, Xf), C = vn(), P = C.direction === "rtl", B = k({}, i, {
    autoFocus: s,
...
function ih({
  ...
  It(() => {
    if (c) {
      ...
      if (w) {
        const m = w.getBoundingClientRect(), C = window.scrollY, P = window.scrollX, B = m.top + C + w.clientHeight, j = m.left + P;
        g({ top: B, left: j });
      }
    }
  }, [c, o]);
