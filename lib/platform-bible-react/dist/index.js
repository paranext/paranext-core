...
import { c as m, g as me, a as _r, C as Se, u as Oo, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Xi, l as Ji, m as Zi, I as Qi, n as io, r as ye, o as ts, p as Cn, q as la, s as da, L as Et, R as so, t as ea, D as ja, v as Ba, w as Fa, y as Ua, z as En, E as Gr, F as co, G as Tn, H as lo, J as Je, K as Er, M as je, N as Be, O as Fe, S as Tr, Q as nr, U as es, V as zr, W as Ze, X as Oe, Z as tr, Y as De, _ as ir, $ as wo, a0 as uo, a1 as ra, a2 as po, a3 as Sn, a4 as rs, a5 as as, a6 as os, a7 as Ka, a8 as Rn, a9 as wa, aa as ns, ab as zn, ac as is, ad as ss, ae as cs, af as Io, ag as ls, ah as ds, ai as ws, aj as us, ak as Dn, al as Mn, am as ho, an as ps, ao as On, ap as Na, aq as $o, ar as Ca, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Dr, ay as go, az as bs, aA as xs } from "./resizable-DrPRlURI.js";
import { aB as Cg, aC as Eg, aD as Tg, aE as Sg, aF as Rg, aG as zg, aH as Dg, aI as Mg, aJ as Og, aK as Ig, aL as $g, aM as Pg, aN as Ag, aO as Vg, aP as Lg, aQ as jg, aR as Bg, aS as Fg, aT as Ug, aU as Kg, aV as Hg, aW as Gg, aX as qg, aY as Wg, aZ as Yg, a_ as Xg, a$ as Jg, b0 as Zg, b1 as Qg, b2 as tf, b3 as ef, b4 as rf, b5 as af, b6 as of, b7 as nf } from "./resizable-DrPRlURI.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Po, ChevronsLeft as Ao, ChevronsRight as Vo, ChevronLeft as Ha, ChevronRight as Ga, ArrowLeft as ys, ArrowRight as ks, ChevronDown as lr, BoldIcon as _s, ItalicIcon as Ns, X as fo, AtSign as In, Pencil as Cs, Trash2 as Es, ArrowUp as $n, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as Pn, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as An, FunctionSquare as Vn, SquareSigma as Ln, Ban as Fs, AlertCircle as qa, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as Gs, ArrowDownIcon as qs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Js, EllipsisVertical as Zs, MoreVertical as Qs } from "lucide-react";
import { Section as Ct, getChaptersForBook as tc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as qr, formatRelativeDate as ec, sanitizeHtml as mo, NumberFormat as jn, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as Wr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as Lo, compareScrRefs as Wa, scrRefToBBBCCCVVV as Ea, defaultScrRef as Ta, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as jo, formatReplacementStringToArray as Bo, collectUsjMarkers as dc } from "platform-bible-utils";
import Yt, { useRef as F, useMemo as A, createContext as ua, useContext as vo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Fo, Suspense as pc, forwardRef as Bn, useId as Uo, Fragment as pa } from "react";
import { IconSelector as Fn, IconCheck as ha, IconChevronDown as hc, IconChevronUp as gc, IconLayoutSidebar as fc, IconLayoutSidebarRight as mc, IconChevronRight as Un, IconSearch as vc, IconLoader as bc, IconAlertOctagon as xc, IconAlertTriangle as yc, IconInfoCircle as kc, IconCircleCheck as _c } from "@tabler/icons-react";
import { createEditor as Kn, $getRoot as $e, $createParagraphNode as Mr, $getSelection as ee, HISTORY_MERGE_TAG as bo, ParagraphNode as Hn, TextNode as Gn, $getPreviousSelection as Nc, $isRangeSelection as be, $caretFromPoint as Cc, $getSiblingCaret as qn, $getChildCaret as Ec, $getAdjacentChildCaret as Tc, $isChildCaret as Sc, $normalizeCaret as Rc, $setSelectionFromCaretRange as zc, $getCollapsedCaretRange as Dc, $getCaretInDirection as Ko, $splitAtPointCaretNext as Mc, $isTextPointCaret as Oc, $findMatchingParent as Wn, $isElementNode as Sr, mergeRegister as Te, getDOMTextNode as Ic, isHTMLElement as $c, CLEAR_EDITOR_COMMAND as Yn, COMMAND_PRIORITY_EDITOR as xo, shallowMergeConfig as Pc, defineExtension as ne, safeCast as er, createState as Ac, FORMAT_TEXT_COMMAND as Xn, $isNodeSelection as Jn, COMMAND_PRIORITY_LOW as Zn, RootNode as Vc, LineBreakNode as Lc, TabNode as jc, $isEditorState as Bc, createCommand as Fc, CLICK_COMMAND as Uc, isDOMNode as Kc, $getNodeFromDOMNode as Hc, $createNodeSelection as Gc, $setSelection as qc, $getEditor as Wc, DecoratorNode as Ya, $getState as Yc, toggleTextFormatType as Ho, TEXT_TYPE_TO_FORMAT as Xc, $setState as Jc, addClassNamesToElement as Qn, $create as Zc, $getNodeByKey as Qc, removeClassNamesFromElement as tl, KEY_TAB_COMMAND as el, $isBlockElementNode as rl, $createRangeSelection as al, $normalizeSelection__EXPERIMENTAL as ol, OUTDENT_CONTENT_COMMAND as nl, INDENT_CONTENT_COMMAND as Go, INSERT_TAB_COMMAND as il, COMMAND_PRIORITY_CRITICAL as yo, $isDecoratorNode as sl, $isParagraphNode as cl, $isTextNode as Xa, SELECTION_CHANGE_COMMAND as ti, $insertNodes as ll } from "lexical";
...
import { Avatar as ko, Select as Xt, Checkbox as qo, Slot as Or, Tabs as we, Menubar as ke, ContextMenu as $t, Progress as Wo, Slider as Br, Switch as Yo } from "radix-ui";
import { useReactTable as ri, getFilteredRowModel as vl, getSortedRowModel as ai, getPaginationRowModel as bl, getCoreRowModel as oi, flexRender as Nr, getGroupedRowModel as xl, getExpandedRowModel as yl } from "@tanstack/react-table";
...
function Ml({
  ...
  W(() => {
    ...
    const I = (G) => !!G && G.scrollWidth > G.clientWidth, tt = () => {
      Qa !== "pointer" && (T || I(h.current) || I(l.current)) && C(!0);
    }, N = () => C(!1);
...
function Ra({
  ...
  const U = ye(), V = zl(), D = T ?? V, [K, Y] = _(!1), [H, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [G, nt] = _(void 0), [at, pt] = _(
    void 0
  ), [dt, J] = _(void 0), [wt, gt] = _(!1), [ft, mt] = _(!1), Jt = F(null), vt = F(!1), Pt = F(void 0), At = F(void 0), bt = F(void 0), Bt = F(void 0), Tt = F({}), Ft = F({}), ct = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Ll(kt, Vt),
    [kt, Vt]
  ), ae = Kt.has(t.book), Zt = A(() => I.trim() ? to(
    Ut.filter((k) => io(k, I, i))
  ) : ft ? se : ie, [
    ie,
    se,
    Ut,
  ...
  const Lt = j(() => {
    ...
    (k) => {
      const rt = N === "chapters" ? G : M == null ? void 0 : M.book;
      if (rt) {
        if (w && w(rt, k) > 1) {
    ...
    const k = at;
    pt(void 0), J(void 0), k ? (nt(k), z("chapters"), Q("")) : q();
  }, [at, q]), L = j(
    (k) => {
  ...
  const { otLong: st, ntLong: ht, dcLong: xt, extraLong: _t } = {
    ...
    () => Pl(I),
    [I]
  ), fr = A(() => !w || !M || !M.chapterNum || !Pr ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Pr]), Ar = N === "books" && !wt && !I.trim() && Kt.size > 0, mr = j(
    (k) => p ? Jo(k, p) : !1,
    [p]
  ), vr = j(
    (k) => (rt) => p ? Al(k, rt, p) : !1,
    ...
    [We, i]
  ), ya = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", ka = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", _a = j(
    (k) => {
    ...
    (k) => {
      ...
      if (N === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), q();
        return;
      }
  ...
  return te(() => {
    ...
    if (N === "chapters" && G) {
      const k = G === t.book, rt = k ? t.chapterNum : 1;
      Q(
        `${G} ${de[G] || ""} ${rt}`
      ), setTimeout(() => {
        if (bt.current)
              ...
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: N === "verses" ? b : q,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: U === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && G && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: me(G, i) }),
                      ...
                      return (
                        ...
                        /* @__PURE__ */ a(Ee, { heading: jt(k), children: rt.map((ot) => /* @__PURE__ */ a(
                          ii,
                          {
                            ...
                            localizedBookNames: i,
                            disabled: mr(ot),
                            dimmedReason: Kt.has(ot) ? ba : void 0,
                            dimmedDescription: Kt.has(ot) ? xa(ot) : void 0
                          },
                          ot
                        )) }, k)
                      );
                  ...
                  M && fr && M.chapterNum && w && /* @__PURE__ */ u(lt, { children: [
                    ...
                    /* @__PURE__ */ a(
                      tn,
                      {
                        ...
                        onVerseSelect: Ht,
                        setVerseRef: va,
                        isVerseDisabled: Ge(M.book, M.chapterNum),
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Le, { children: T(e) ? e.map((V) => /* @__PURE__ */ a(Ee, { heading: V.groupHeading, children: V.options.map((D) => U(D, V.groupHeading)) }, V.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((V) => U(V)) }) })
        ] })
      }
    )
  ] });
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ul = di ? te : W, Ur = { tag: bo };
...
function sd(t) {
  const e = Wn(t, (r) => Sr(r) && !r.isInline());
...
function cd(t) {
  ...
  if (be(e)) r = Cc(e.focus, "next");
    ...
    r = r || Ec($e(), "previous").getFlipped().insert(Mr());
  }
...
function ld(t, e, r) {
  ...
  return Oc(o) && aa(283), o.insert(t.isInline() ? Mr().append(t) : t), Ko(qn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = ee();
  if (!be(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Wn(i, (d) => Sr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let oa, Ce = 0, na = 0, pd = 0, ro = 0, Jr = 0;
function on(t) {
  if (it === void 0) return;
  let e = t.n;
...
function gd(t) {
  ...
  pi(this), it = t, this.f &= -2, 8 & this.f && Eo(this), ga();
}
function or(t, e) {
...
Wt.prototype.brand = wd, Wt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ce !== 0 && na === 0 && e.l !== ro && (e.l = ro, oa = { S: e, v: e.v, i: e.i, o: oa });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, hi(this), nn(this), Ce++;
  const t = it;
...
ne({ build: (t, e, r) => gr(e), config: er({ $onClear: gi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [mi], register: (t, e, r) => t.registerCommand(Xn, (o) => {
  const n = ee();
  if (Jn(n) || be(n)) for (const i of n.getNodes()) md(i) && i.toggleFormat(o);
  return !1;
}, Zn) });
function vi(t, e) {
  let r;
...
const ao = ne({ build: (t) => vi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const To = 0, oo = 1, xi = 2, Oa = 3, Kr = 4, ar = 5, Ia = 6, yr = 7;
function $a(t) {
  return t.id === To;
}
function yi(t) {
...
function vd(t) {
  return function(e) {
    return e.id === oo;
  }(t) || ut(305, String(t.id), String(oo)), Object.assign(t, { id: xi });
}
...
const kd = ne({ config: er({ setOptions: sn, updateOptions: sn }), init: ({ $initialEditorState: t = yd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Vc, Gn, Lc, jc, Hn] }), cn = Symbol.for("@lexical/extension/LexicalBuilder");
function ln() {
}
function _d(t) {
  throw t;
...
class cr {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      $a(i) || ut(300, s, n || "[unknown]"), $a(c = i) || ut(304, String(c.id), String(To)), i = Object.assign(c, { id: oo }), o.state = i;
...
const Nd = /* @__PURE__ */ new Set(), dn = ne({ build(t, e, r) {
...
ne({ dependencies: [ao, dn], name: "@lexical/extension/HorizontalRule", nodes: () => [dr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(dn).output, n = Rr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Te(t.registerCommand(Cd, (s) => {
    ...
    if (Kc(s.target)) {
      ...
      if (Td(c)) return function(l, d = !1) {
        ...
        let g;
        d && Jn(w) ? g = w : (g = Gc(), qc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Sd(t, e, r = ki) {
  return Te(t.registerCommand(el, (o) => {
    ...
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? nl : Go : il;
    return t.dispatchCommand(i, void 0);
  }, xo), t.registerCommand(Go, () => {
...
ne({ build: (t, e, r) => gr(e), config: er({ $canIndent: ki, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ne({ build: (t, e, r) => gr(e), config: er({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => xe(() => r.getOutput().disabled.value ? void 0 : Ni(t)) });
function Od(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Pi({
  ...
  const [H, Q] = _(fn), [I, tt] = _(), [N, z] = _(), G = o, [nt, at] = _(!1), [pt, dt] = _(!1), [J, wt] = _(!1), [gt, ft] = _(!1), [mt, Jt] = _(!1), [vt, Pt] = _(E), [At, bt] = _(!1), Bt = F(void 0), [Tt, Ft] = _(/* @__PURE__ */ new Map());
  W(() => {
    let b = !0;
    return (async () => {
  ...
  W(() => {
    ...
    ct.current === "idle" && (ct.current = "pending"), gt ? ct.current === "pending" && U !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    U !== i && (tt(U), ct.current = "auto-populated") : ct.current === "auto-populated" && (tt(void 0), ct.current = "pending");
  }, [o, U, gt, i]);
  const kt = A(
  ...
  const Vt = A(() => kt[0], [kt]), ie = F(null), se = F(void 0), Ut = j(() => {
    var b;
    (b = se.current) == null || b.call(se), Q(fn);
  }, []), Ke = j(() => {
    const b = !vt;
  ...
  }, [i, r]), Zt = A(() => kt.slice(1), [kt]), M = A(() => Zt.length ?? 0, [Zt.length]), ce = A(() => M > 0, [M]), Lt = A(() => nt || M <= 2 ? Zt : Zt.slice(-2), [Zt, M, nt]), Ht = A(() => nt || M <= 2 ? 0 : M - 2, [M, nt]), ue = A(
  ...
  const S = j(
    ...
    async (b) => {
      const L = oe(H) ? sa(H) : void 0, P = b.status ? b.assignedUser : I ?? b.assignedUser, et = await p({
        ...b,
        contents: L,
        assignedUser: P
      });
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Le, { children: x == null ? void 0 : x.map((b) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                tt(b !== i ? b : void 0), ct.current = "user-selected", z(void 0), wt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), dw = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Qr = (t) => dw(mo(t));
function ta({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Vp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, U] = _(), V = j(
    async (z) => {
      const G = await i(z);
      return G !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && U(z.assignedUser), G;
    },
    [i]
  );
  W(() => {
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(Pi, { ...G })
          },
          z.id
        );
      })
...
function kw({
  ...
  return l ? $ = Array.from({ length: 10 }).map((D, K) => `skeleton-row-${K}`).map((D) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? $ = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(wo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(De, { children: U.headers.map((V) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : Nr(V.column.columnDef.header, V.getContext()) }, V.id)) }, U.id)) }),
...
function Kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(je, { children: [
    ...
    /* @__PURE__ */ a(Fe, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Sn, { children: d.itemType === 0 ? /* @__PURE__ */ a(lt, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][h],
...
function Sw({
  ...
  const l = lo(), d = vn(n, "%undoButton_tooltip%"), w = vn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        X,
...
const zw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(lt, { children: [
...
const Mw = (t, e) => t === "f" ? /* @__PURE__ */ u(lt, { children: [
  /* @__PURE__ */ a(Vn, {}),
  " ",
...
function Wp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, U] = _("*"), [V, D] = _("f"), [K, Y] = _(!1), [H, Q] = _(!0), [I, tt] = _(!1), N = F(!1), z = F(""), [G, nt] = _(!1), [at, pt] = _(), [dt, J] = _(), [wt, gt] = _(), [ft, mt] = _(), Jt = F(null), vt = F(
    void 0
  ...
  const Tt = j(() => {
    var b, L, P;
    const S = (b = g.current) == null ? void 0 : b.querySelector(".editor-input"), B = S == null ? void 0 : S.querySelector("span.note"), q = (P = (L = g.current) == null ? void 0 : L.ownerDocument.getSelection()) == null ? void 0 : P.anchorNode;
  ...
  W(() => {
    ...
    if (b && xr("note", b)) {
      ...
      let st = "custom";
      et === Ja ? st = "generated" : et === Za ? st = "hidden" : et && ($(et), U(et)), R(st), C(st), D(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
  ...
  const Ft = j(
    (S = !1) => {
      var q, b, L;
      p == null || p();
      const B = (b = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : b.at(0);
      B && xr("note", B) && (r == null || r([B]), S && d && i && ((L = d.current) == null || L.replaceEmbedUpdate(i, [B])));
    },
    [i, r, p, d]
  ), ct = j(
    (S, B) => {
      var L, P, et;
      const q = (P = (L = h.current) == null ? void 0 : L.getNoteOps(0)) == null ? void 0 : P.at(0);
      if (!q || !xr("note", q) || !q.insert.note) return;
      let b;
      S === "custom" ? b = B : S === "generated" ? b = Ja : b = Za, q.insert.note.caller !== b && (q.insert.note.caller = b, (et = h.current) == null || et.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), kt = j(() => {
    var S;
  ...
  const ie = F({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
  ...
  const se = () => {
    ...
    if (B && xr("note", B)) {
      ...
      V !== "x" && S === "x" ? st == null || st.forEach((ht) => Bw(ht)) : V === "x" && S !== "x" && (st == null || st.forEach((ht) => Fw(ht))), (et = h.current) == null || et.applyUpdate([B, { delete: 1 }]);
    }
  }, Kt = (S) => {
    ...
    if (f.current && Bt.length && S && S.rangeCount > 0) {
      ...
      pt(B.left - q.left), J(B.top - q.top), gt(B.height), nt(!0);
    }
  }, [Bt, f]), M = F(() => {
  }), ce = j(
    (S, B, q) => {
    ...
    return B.length === 0 ? !1 : (ce(S, B, { passive: !S.hasTextSelection }), !0);
  ...
  W(() => {
    ...
    const B = (b) => {
      const L = S();
      !G && L && document.activeElement === L && b.key === c ? (b.preventDefault(), Zt()) : G && b.key === "Escape" && (b.preventDefault(), nt(!1));
    };
    ...
    const S = () => {
      ...
      q && !q.isCollapsed || Tt() || ((L = h.current) == null || L.selectNote(0), (P = h.current) == null || P.focus());
    };
...
function Ww({
  ...
  return /* @__PURE__ */ u(wo, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(uo, { stickyHeader: !0, children: /* @__PURE__ */ u(De, { children: [
    ...
    /* @__PURE__ */ a(po, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ir, { className: o, children: qw(c.text) })
        ]
      },
...
}, fa = (t, e, r) => /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
...
function oh({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), x = fe(r, "%webView_inventory_unapproved%"), v = fe(r, "%webView_inventory_unknown%"), R = fe(r, "%webView_inventory_scope_currentBook%"), y = fe(r, "%webView_inventory_scope_chapter%"), C = fe(r, "%webView_inventory_scope_verse%"), E = fe(r, "%webView_inventory_filter_text%"), $ = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = fe(r, "%webView_inventory_no_results%"), [U, V] = _(!1), [D, K] = _("all"), [Y, H] = _(""), [Q, I] = _([]), tt = A(() => {
    const J = t ?? [];
  ...
  }, [U, tt]), z = A(() => N.length === 0 ? [] : Zw(N, D, Y), [N, D, Y]), G = A(() => {
    var gt, ft;
    if (!U) return l;
...
function ru({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = ye() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
const ze = "scrBook", wu = "scrRef", Xe = "source", uu = "details", pu = "Scripture Reference", hu = "Scripture Book", Li = "Type", gu = "Details";
function fu(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ u(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(hr, { position: "item-aligned", children: /* @__PURE__ */ a(vw, { children: E.map((D) => /* @__PURE__ */ a(le, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(wo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(uo, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((K) => K.column.columnDef.header).map((K) => (
      ...
      /* @__PURE__ */ a(po, { children: R.getRowModel().rows.map((D, K) => {
        const Y = ye();
        return /* @__PURE__ */ a(
          De,
          {
                    ...
                    children: H.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(Ga, {}) : /* @__PURE__ */ a(Ha, {})),
                          " ",
...
function vu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
    ...
    () => Object.values(Ct).filter(
      (I) => (i == null ? void 0 : i[I]) !== void 0 && ho(T, I).length === 0
...
function yh({
  ...
  const $ = Rt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = Rt(s, "%webView_scope_selector_current_book%"), H = Rt(s, "%webView_scope_selector_choose_books%"), Q = Rt(s, "%webView_scope_selector_scope%"), I = Rt(s, "%webView_scope_selector_select_books%"), tt = Rt(s, "%webView_scope_selector_range%"), N = Rt(s, "%webView_scope_selector_select_range%"), z = Rt(s, "%webView_scope_selector_range_start%"), G = Rt(s, "%webView_scope_selector_range_end%"), nt = Rt(s, "%webView_scope_selector_ok%"), at = Rt(s, "%webView_scope_selector_cancel%"), pt = Rt(s, "%webView_scope_selector_navigate%"), dt = (O) => {
    if (!x) return;
  ...
  ] }), gt = e ? J.filter((O) => e.includes(O.value)) : J, ft = x ?? Ta, mt = p ?? ft, Jt = h ?? ft, vt = () => {
  }, Pt = F(null), At = F(null), bt = F(!1), Bt = F(null), Tt = F(!1), [Ft, ct] = _(void 0), kt = F(!1), Vt = F(!1), ie = F(null), se = j((O) => {
    if (O) {
  ...
  ), Lt = gt.find((O) => O.value === "selectedBooks"), Ht = gt.find((O) => O.value === "range"), [ue, pe] = _(!1), [S, B] = _(void 0), [q, b] = _(void 0), [L, P] = _(void 0), [et, st] = _(void 0), [ht, xt] = _([]), _t = w === "dropdown" && S === "selectedBooks", jt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), re = Ft === "end", Ir = Ft === "start", rr = "tw:text-muted-foreground", He = w === "dropdown" && S === "range", $r = He ? P : Ke, Pr = He ? st : f ? Kt : vt, fr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: Pt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Ir && rr), children: G }),
      /* @__PURE__ */ a(
        Ra,
        {
          id: "scope-range-end",
  ...
  const [Ge, Vr] = _(null), [qe, ba] = _(null), [We, xa] = _(null), ya = 200, [ka, _a] = _(!1);
  W(() => {
  ...
  const Lr = j(
    (O) => {
      b(O), P(mt), st(Jt), xt(n), pe(!1), B(O);
    },
    [mt, Jt, n]
  ), jr = j(() => {
    q !== void 0 && (q === "range" ? (L && (g == null || g(L)), et && (f == null || f(et))) : q === "selectedBooks" && i(ht), ae(q), B(void 0), b(void 0));
  }, [
    q,
    L,
    et,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
        ...
        /* @__PURE__ */ a(
          Fe,
          {
            ...
            children: /* @__PURE__ */ u(Na, { container: We, children: [
              ce.map(({ value: O, label: Z, dropdownLabel: Nt, scrRefSuffix: he, id: Gt }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: mr(O),
    ...
    w === "radio" && t === "range" && fr,
    w === "dropdown" && Lt && /* @__PURE__ */ a(ja, { open: S === "selectedBooks", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: ba,
        onCloseAutoFocus: rt,
    ...
    w === "dropdown" && Ht && /* @__PURE__ */ a(ja, { open: S === "range", onOpenChange: k, children: /* @__PURE__ */ a(
      Ba,
      {
        ref: Vr,
        onCloseAutoFocus: rt,
...
Ki.displayName = we.List.displayName;
  ...
  if (Tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Ru, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(zu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: tr },
          children: /* @__PURE__ */ a(Dt, { children: qi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
