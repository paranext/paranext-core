...
import Q, { forwardRef as da, useCallback as _e, useState as he, useRef as Nt, useEffect as it, useLayoutEffect as ri, useMemo as lo } from "react";
import { getChaptersForBook as vl, split as fa } from "platform-bible-utils";
import * as ge from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as yl } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as wl, Check as ma, Circle as xl, History as El, ArrowDownWideNarrow as kl, Clock as Tl, Bookmark as Nl, ChevronDown as ha, ChevronUp as Ol, ArrowLeftIcon as Sl, ChevronLeftIcon as Cl, ChevronRightIcon as Pl, ArrowRightIcon as Rl, FilterIcon as $l, ArrowUpIcon as _l, ArrowDownIcon as Il, ArrowUpDownIcon as Ml, CircleCheckIcon as Yn, CircleXIcon as Kn, CircleHelpIcon as Jn, LoaderCircle as co, Download as Al } from "lucide-react";
import Oe, { clsx as Dl } from "clsx";
import { extendTailwindMerge as jl } from "tailwind-merge";
import { useReactTable as Bl, getCoreRowModel as Ll, getPaginationRowModel as Vl, getSortedRowModel as Fl, getFilteredRowModel as zl, flexRender as oi } from "@tanstack/react-table";
import { Slot as Ul } from "@radix-ui/react-slot";
import { cva as po } from "class-variance-authority";
import * as xe from "@radix-ui/react-select";
import { Autocomplete as Hl, TextField as Wl, FormControlLabel as ii, FormLabel as Xl, Checkbox as Gl, MenuItem as ql, ListItemText as Yl, ListItemIcon as ga, Menu as Kl, Grid as ba, List as Jl, IconButton as va, Drawer as Zl, Slider as Ql, Snackbar as ec, Switch as tc, AppBar as nc, Toolbar as rc } from "@mui/material";
import oc, { ThemeContext as ic, internal_processStyles as ac } from "@mui/styled-engine";
...
var lc = Object.defineProperty, cc = (e, t, n) => t in e ? lc(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, oe = (e, t, n) => cc(e, typeof t != "symbol" ? t + "" : t, n);
const Ct = [
  "GEN",
  "EXO",
  "LEV",
...
*/
oe($e, "ValidStatusType", Na);
let an = class extends Error {
};
const wc = jl({ prefix: "pr-" });
function W(...e) {
  return wc(Dl(e));
}
const Oa = ge.Root, xc = ge.Trigger, Lb = ge.Group, Vb = ge.Portal, Fb = ge.Sub, zb = ge.RadioGroup, Ec = Q.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ F(
  ge.SubTrigger,
  {
    ref: o,
    className: W(
    ...
    children: [
      n,
      /* @__PURE__ */ h(wl, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
Ec.displayName = ge.SubTrigger.displayName;
const kc = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  ge.SubContent,
  {
    ref: n,
    className: W(
...
kc.displayName = ge.SubContent.displayName;
...
const Tc = Q.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ F(
  ge.RadioItem,
  {
    ref: r,
    className: W(
    ...
    ...n,
    children: [
      /* @__PURE__ */ h("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ h(ge.ItemIndicator, { children: /* @__PURE__ */ h(xl, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
Tc.displayName = ge.RadioItem.displayName;
const cr = Q.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ h(
  ge.Label,
  {
    ref: r,
...
cr.displayName = ge.Label.displayName;
...
function Pc({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ F(cr, { className: "pr-flex pr-justify-between", children: [
...
const bn = me.allBookIds, Rc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, li = ["OT", "NT", "DC"], $c = 32 + 32 + 32, _c = [
  /^(\w+)$/i,
...
function Ub({ scrRef: e, handleSubmit: t }) {
  const [n, r] = he(""), [o, i] = he(
    ...
    me.bookNumberToId(e.bookNum)
  ), [f, v] = he(!1), [g, p] = he(f), m = Nt(void 0), d = Nt(void 0), b = Nt(void 0), w = _e(
    (C) => Ic(C).filter((I) => {
    ...
    (C, I, M, V) => {
      if (l(
        me.bookNumberToId(e.bookNum) !== C ? 1 : e.chapterNum
      ), I || sn(C) === -1) {
        t({
          bookNum: me.bookIdToNumber(C),
          chapterNum: M || 1,
          verseNum: V || 1
        }), v(!1), r("");
        return;
    ...
    _c.forEach((C) => {
      const I = n.match(C);
      if (I) {
        const [M, V = void 0, D = void 0] = I.slice(1), $ = Dc(M);
    ...
    if (c === o) {
      ...
      a + M <= 0 || a + M > sn(c) ? l(0) : M !== 0 && (l(a + M), C.preventDefault());
    }
  };
  return it(() => {
    ...
    /* @__PURE__ */ h(xc, { asChild: !0, children: /* @__PURE__ */ h(
      Oc,
      {
        ref: m,
        value: n,
    ...
    /* @__PURE__ */ F(
      ho,
      {
        ...
        children: [
          ...
          li.map(
            (C, I) => w(C).length > 0 && /* @__PURE__ */ F("div", { children: [
              /* @__PURE__ */ h(cr, { className: "pr-font-semibold pr-text-slate-700", children: Rc[C] }),
...
const jc = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  "tfoot",
  {
    ref: n,
...
const Lc = po(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ h(r ? Ul : "button", { className: W(Lc({ variant: t, size: n, className: e })), ref: i, ...o })
);
ve.displayName = "Button";
const Xr = xe.Root, Hb = xe.Group, Gr = xe.Value, Qn = Q.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ F(
  xe.Trigger,
  {
    ref: r,
    className: W(
...
const Pa = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  xe.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ h(Ol, { className: "pr-h-4 pr-w-4" })
  }
));
...
const Vc = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  xe.Label,
  {
    ref: n,
...
Vc.displayName = xe.Label.displayName;
...
Fc.displayName = xe.Separator.displayName;
function zc({ table: e }) {
    ...
    /* @__PURE__ */ F("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
      ...
      /* @__PURE__ */ F(
        Xr,
        {
          ...
          children: [
            /* @__PURE__ */ h(Qn, { className: "pr-h-8 pr-w-[70px]", children: /* @__PURE__ */ h(Gr, { placeholder: e.getState().pagination.pageSize }) }),
...
function Uc({ table: e }) {
  return /* @__PURE__ */ F(Oa, { children: [
    /* @__PURE__ */ h(yl, { asChild: !0, children: /* @__PURE__ */ F(ve, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ h($l, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ F(ho, { align: "end", className: "pr-w-[150px]", children: [
      /* @__PURE__ */ h(cr, { children: "Toggle columns" }),
      /* @__PURE__ */ h(go, {}),
...
function Hc({
  ...
  var d;
  const [a, l] = he([]), [c, u] = he([]), [f, v] = he({}), [g, p] = he({}), m = Bl({
    data: t,
    columns: e,
    getCoreRowModel: Ll(),
...
function Yc() {
  return ui || (ui = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = u, O = l, R = a, A = t, L = f, C = r, I = m, M = p, V = n, D = i, $ = o, z = v, Z = !1;
    function q(B) {
...
var Rr, hi;
function _a() {
  return hi || (hi = 1, Rr = Function.call.bind(Object.prototype.hasOwnProperty)), Rr;
}
var $r, gi;
function Jc() {
  if (gi)
...
function Zc() {
  if (bi)
    return _r;
  bi = 1;
  var e = $a(), t = Kc(), n = wo(), r = _a(), o = Jc(), i = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var ep = $a(), tp = !0;
  qr.exports = Zc()(ep.isElement, tp);
} else
  qr.exports = Qc()();
var np = qr.exports;
const s = /* @__PURE__ */ Xc(np);
function Qt(e, t) {
...
function Ma(e, t, n, r, o) {
  ...
  let l;
  const c = i.type;
  return typeof c == "function" && !rp(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${a}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
...
function ip(e, t, n, r, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof i == "function" && !op(i) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${a}\` supplied to \`${n}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ap = Qt(s.elementType, ip), sp = "exact-prop: ​";
function Da(e) {
...
function cp() {
  return wi || (wi = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(_) {
      return !!(typeof _ == "string" || typeof _ == "function" || _ === n || _ === o || P || _ === r || _ === u || _ === f || w || _ === p || m || d || b || typeof _ == "object" && _ !== null && (_.$$typeof === g || _.$$typeof === v || _.$$typeof === i || _.$$typeof === a || _.$$typeof === c || // This needs to include all possible module reference object
    ...
    var T = a, O = i, R = e, A = c, L = n, C = g, I = v, M = t, V = o, D = r, $ = u, z = f, Z = !1, q = !1;
    function N(_) {
    ...
    de.ContextConsumer = T, de.ContextProvider = O, de.Element = R, de.ForwardRef = A, de.Fragment = L, de.Lazy = C, de.Memo = I, de.Portal = M, de.Profiler = V, de.StrictMode = D, de.Suspense = $, de.SuspenseList = z, de.isAsyncMode = N, de.isConcurrentMode = j, de.isContextConsumer = U, de.isContextProvider = J, de.isElement = H, de.isForwardRef = X, de.isFragment = Y, de.isLazy = K, de.isMemo = G, de.isPortal = ee, de.isProfiler = te, de.isStrictMode = ae, de.isSuspense = B, de.isSuspenseList = ne, de.isValidElementType = E, de.typeOf = y;
  }()), de;
}
process.env.NODE_ENV === "production" ? Yr.exports = lp() : Yr.exports = cp();
var tr = Yr.exports;
...
function ja(e, t = "") {
  return e.displayName || e.name || up(e) || t;
}
function xi(e, t, n) {
  const r = ja(t);
...
const fp = s.oneOfType([s.func, s.object]), xo = fp;
function Ke(e) {
  if (typeof e != "string")
...
const bp = typeof window < "u" ? k.useLayoutEffect : k.useEffect, Pt = bp;
let Ei = 0;
function vp(e) {
...
function Sp() {
  this.visibilityState === "hidden" && Jr && (ur = !0);
}
function Cp(e) {
  e.addEventListener("keydown", Op, !0), e.addEventListener("mousedown", Mr, !0), e.addEventListener("pointerdown", Mr, !0), e.addEventListener("touchstart", Mr, !0), e.addEventListener("visibilitychange", Sp, !0);
}
function Pp(e) {
  const {
    target: t
...
function Fa() {
  ...
  function n() {
    return t.current ? (Jr = !0, kp.start(100, () => {
      Jr = !1;
    }), t.current = !1, !0) : !1;
  }
  function r(o) {
...
Ha.isRequired = Ua;
Zr.isRequired = Zr;
const Wa = process.env.NODE_ENV === "production" ? Zr : Ha;
function Xa(e, t) {
  const n = S({}, t);
...
function Ap(e, t = Number.MIN_SAFE_INTEGER, n = Number.MAX_SAFE_INTEGER) {
...
}, jp = /* @__PURE__ */ k.createContext(Dp);
function Bp(e) {
  const {
...
function Vp(e) {
  ...
  if (!t) {
    const p = Oe(n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = S({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), d = S({}, n, o, r);
    return p.length > 0 && (d.className = p), Object.keys(m).length > 0 && (d.style = m), {
      props: d,
      internalRef: void 0
    };
  }
  const a = Ka(S({}, o, r)), l = Oi(r), c = Oi(o), u = t(a), f = Oe(u == null ? void 0 : u.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), v = S({}, u == null ? void 0 : u.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), g = S({}, u, n, c, l);
...
const Wp = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function Xp(e) {
...
function qp(e) {
  return !(e.disabled || e.tagName === "INPUT" && e.type === "hidden" || Gp(e));
}
function Yp(e) {
  const t = [], n = [];
  return Array.from(e.querySelectorAll(Wp)).forEach((r, o) => {
    const i = Xp(r);
...
`)), m.current.setAttribute("tabIndex", "-1")), p.current && m.current.focus()), () => {
    ...
    const x = Se(m.current), E = (O) => {
      ...
      if ((x.activeElement === u.current || x.activeElement === f.current) && (R = i(m.current)), R.length > 0) {
        var A, L;
        const C = !!((A = b.current) != null && A.shiftKey && ((L = b.current) == null ? void 0 : L.key) === "Tab"), I = R[0], M = R[R.length - 1];
        typeof I != "string" && typeof M != "string" && (C ? M.focus() : I.focus());
      } else
        O.focus();
    };
...
const Tn = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  return /* @__PURE__ */ h(k.Fragment, {
    children: a && /* @__PURE__ */ sc.createPortal(r, a)
  });
});
...
function au(e) {
  const {
    ...
    open: f,
    rootRef: v
  } = e, g = k.useRef({}), p = k.useRef(null), m = k.useRef(null), d = He(m, v), [b, w] = k.useState(!f), P = ou(c);
  let x = !0;
  (e["aria-hidden"] === "false" || e["aria-hidden"] === !1) && (x = !1);
  const E = () => Se(p.current), y = () => (g.current.modalRef = m.current, g.current.mount = p.current, g.current), T = () => {
    o.mount(y(), {
      disableScrollLock: r
    ...
    const $ = ru(t) || E().body;
    o.add(y(), $), m.current && T();
  }), R = k.useCallback(() => o.isTopModal(y()), [o]), A = kn(($) => {
    p.current = $, $ && (f && R() ? T() : m.current && vn(m.current, x));
  }), L = k.useCallback(() => {
    o.remove(y(), x);
  }, [x, o]);
  k.useEffect(() => () => {
  ...
  const C = ($) => (z) => {
    var Z;
    (Z = $.onKeyDown) == null || Z.call($, z), !(z.key !== "Escape" || z.which === 229 || // Wait until IME is settled.
    !R()) && (n || (z.stopPropagation(), u && u(z, "escapeKeyDown")));
  }, I = ($) => (z) => {
    var Z;
    (Z = $.onClick) == null || Z.call($, z), z.target === z.currentTarget && u && u(z, "backdropClick");
  };
  return {
    getRootProps: ($ = {}) => {
      const z = Ka(e);
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: Kr($, c == null ? void 0 : c.props.onEnter),
...
var Ie = "top", We = "bottom", Xe = "right", Me = "left", Eo = "auto", Rn = [Ie, We, Xe, Me], qt = "start", Nn = "end", su = "clippingParents", Qa = "viewport", ln = "popper", lu = "reference", Pi = /* @__PURE__ */ Rn.reduce(function(e, t) {
  return e.concat([t + "-" + qt, t + "-" + Nn]);
}, []), es = /* @__PURE__ */ [].concat(Rn, [Eo]).reduce(function(e, t) {
  return e.concat([t, t + "-" + qt, t + "-" + Nn]);
}, []), cu = "beforeRead", pu = "read", uu = "afterRead", du = "beforeMain", fu = "main", mu = "afterMain", hu = "beforeWrite", gu = "write", bu = "afterWrite", vu = [cu, pu, uu, du, fu, mu, hu, gu, bu];
function Je(e) {
...
function $n(e) {
  for (var t = Ve(e), n = Ri(e); n && Eu(n) && st(n).position === "static"; )
    n = Ri(n);
  return n && (Je(n) === "html" || Je(n) === "body" && st(n).position === "static") ? t : n || ku(e) || t;
}
function No(e) {
...
function Ou(e) {
  ...
  if (!(!i || !a)) {
    var v = Nu(o.padding, n), g = To(i), p = c === "y" ? Ie : Me, m = c === "y" ? We : Xe, d = n.rects.reference[f] + n.rects.reference[c] - a[c] - n.rects.popper[f], b = a[c] - n.rects.reference[c], w = $n(i), P = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = d / 2 - b / 2, E = v[p], y = P - g[f] - v[m], T = P / 2 - g[f] / 2 + x, O = yn(E, T, y), R = c;
...
function $i(e) {
  ...
  p = b.x, d = b.y;
  var w = a.hasOwnProperty("x"), P = a.hasOwnProperty("y"), x = Me, E = Ie, y = window;
  if (u) {
    var T = $n(n), O = "clientHeight", R = "clientWidth";
    if (T === Ve(n) && (T = gt(n), st(T).position !== "static" && l === "absolute" && (O = "scrollHeight", R = "scrollWidth")), T = T, o === Ie || (o === Me || o === Xe) && i === Nn) {
      E = We;
...
function Bu(e) {
  ...
  return st(o || n).direction === "rtl" && (l += St(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: a,
    x: l,
    y: c
...
function as(e) {
  return ["html", "body", "#document"].indexOf(Je(e)) >= 0 ? e.ownerDocument.body : Ue(e) && Co(e) ? e : as(dr(e));
}
function wn(e, t) {
  var n;
  t === void 0 && (t = []);
...
function Ii(e, t, n) {
  return t === Qa ? eo(ju(e, n)) : $t(t) ? Lu(t, n) : eo(Bu(gt(e)));
}
function Vu(e) {
  var t = wn(dr(e)), n = ["absolute", "fixed"].indexOf(st(e).position) >= 0, r = n && Ue(e) ? $n(e) : e;
  return $t(r) ? t.filter(function(o) {
    return $t(o) && ns(o, r) && Je(o) !== "body";
  }) : [];
}
function Fu(e, t, n, r) {
  var o = t === "clippingParents" ? Vu(e) : [].concat(t), i = [].concat(o, [n]), a = i[0], l = i.reduce(function(c, u) {
    var f = Ii(e, u, r);
...
function On(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, a = i === void 0 ? e.strategy : i, l = n.boundary, c = l === void 0 ? su : l, u = n.rootBoundary, f = u === void 0 ? Qa : u, v = n.elementContext, g = v === void 0 ? ln : v, p = n.altBoundary, m = p === void 0 ? !1 : p, d = n.padding, b = d === void 0 ? 0 : d, w = os(typeof b != "number" ? b : is(b, Rn)), P = g === ln ? lu : ln, x = e.rects.popper, E = e.elements[m ? P : g], y = Fu($t(E) ? E : E.contextElement || gt(e.elements.popper), c, f, a), T = Kt(e.elements.reference), O = ss({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
  }), R = eo(Object.assign({}, x, O)), A = g === ln ? R : T, L = {
...
function Hu(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !0 : a, c = n.fallbackPlacements, u = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, m = p === void 0 ? !0 : p, d = n.allowedAutoPlacements, b = t.options.placement, w = Ye(b), P = w === b, x = c || (P || !m ? [Hn(b)] : Uu(b)), E = [b].concat(x).reduce(function(H, X) {
      return H.concat(Ye(X) === Eo ? zu(t, {
        placement: X,
        boundary: f,
        rootBoundary: v,
        padding: u,
      ...
      var C = E[L], I = Ye(C), M = Jt(C) === qt, V = [Ie, We].indexOf(I) >= 0, D = V ? "width" : "height", $ = On(t, {
        placement: C,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
      ...
      y[D] > T[D] && (z = Hn(z));
      var Z = Hn(z), q = [];
      if (i && q.push($[I] <= 0), l && q.push($[z] <= 0, $[Z] <= 0), q.every(function(H) {
        return H;
      })) {
        A = C, R = !1;
        break;
...
function ed(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, a = n.altAxis, l = a === void 0 ? !1 : a, c = n.boundary, u = n.rootBoundary, f = n.altBoundary, v = n.padding, g = n.tether, p = g === void 0 ? !0 : g, m = n.tetherOffset, d = m === void 0 ? 0 : m, b = On(t, {
    ...
    padding: v,
    altBoundary: f
  }), w = Ye(t.placement), P = Jt(t.placement), x = !P, E = No(w), y = Qu(E), T = t.modifiersData.popperOffsets, O = t.rects.reference, R = t.rects.popper, A = typeof d == "function" ? d(Object.assign({}, t.rects, {
    placement: t.placement
  })) : d, L = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
    ...
    mainAxis: 0,
    altAxis: 0
  }, A), C = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, I = {
    x: 0,
    y: 0
  };
  if (T) {
    if (i) {
      var M, V = E === "y" ? Ie : Me, D = E === "y" ? We : Xe, $ = E === "y" ? "height" : "width", z = T[E], Z = z + b[V], q = z - b[D], N = p ? -R[$] / 2 : 0, j = P === qt ? O[$] : R[$], U = P === qt ? -R[$] : -O[$], J = t.elements.arrow, H = p && J ? To(J) : {
        width: 0,
        height: 0
      }, X = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : rs(), Y = X[V], K = X[D], G = yn(0, O[$], H[$]), ee = x ? O[$] / 2 - N - G - Y - L.mainAxis : j - G - Y - L.mainAxis, te = x ? -O[$] / 2 + N + G + K + L.mainAxis : U + G + K + L.mainAxis, ae = t.elements.arrow && $n(t.elements.arrow), B = ae ? E === "y" ? ae.clientTop || 0 : ae.clientLeft || 0 : 0, ne = (M = C == null ? void 0 : C[E]) != null ? M : 0, _ = z + ee - ne - B, se = z + te - ne, Te = yn(p ? or(Z, _) : Z, z, p ? St(q, se) : q);
      T[E] = Te, I[E] = Te - z;
    }
    if (l) {
      var Pe, Ee = E === "x" ? Ie : Me, vt = E === "x" ? We : Xe, Re = T[y], Qe = y === "y" ? "height" : "width", De = Re + b[Ee], et = Re - b[vt], Ne = [Ie, Me].indexOf(w) !== -1, Mt = (Pe = C == null ? void 0 : C[y]) != null ? Pe : 0, yt = Ne ? De : Re - O[Qe] - R[Qe] - Mt + L.altAxis, en = Ne ? Re + O[Qe] + R[Qe] - Mt - L.altAxis : et, An = p && Ne ? Tu(yt, Re, en) : yn(p ? yt : De, Re, p ? en : et);
      T[y] = An, I[y] = An - Re;
    }
    t.modifiersData[r] = I;
  }
...
function id(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ue(t), o = Ue(t) && od(t), i = gt(t), a = Kt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Co(i)) && (l = rd(t)), Ue(t) ? (c = Kt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = So(i))), {
  ...
  return function(l, c, u) {
    ...
    var f = {
      ...
      setOptions: function(w) {
        ...
        var x = sd(cd([].concat(r, f.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!g) {
          ...
          if (ji(P, x)) {
            f.rects = {
              reference: id(P, $n(x), f.options.strategy === "fixed"),
              popper: To(x)
...
var ud = [Mu, Zu, _u, xu, Ku, Wu, td, Cu, Gu], dd = /* @__PURE__ */ pd({
  defaultModifiers: ud
});
const ls = "Popper";
function fd(e) {
...
Hp(ls, ["root"]);
const md = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], hd = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function gd(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const vd = () => ct({
  root: ["root"]
}, Bp(fd)), yd = {}, wd = /* @__PURE__ */ k.forwardRef(function(t, n) {
  var r;
  const {
    anchorEl: o,
    children: i,
  ...
  } = t, b = fe(t, md), w = k.useRef(null), P = He(w, n), x = k.useRef(null), E = He(x, g), y = k.useRef(E);
  Pt(() => {
    y.current = E;
  }, [E]), k.useImperativeHandle(g, () => x.current, []);
  const T = gd(f, a), [O, R] = k.useState(T), [A, L] = k.useState(ir(o));
  k.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && A && fr(A) && A.nodeType === 1) {
...
`));
    ...
    c != null && ($ = $.concat(c)), v && v.modifiers != null && ($ = $.concat(v.modifiers));
    const z = dd(A, w.current, S({
      placement: T
    }, v, {
      modifiers: $
    }));
  ...
  const I = vd(), M = (r = m.root) != null ? r : "div", V = Rt({
    elementType: M,
  ...
  const {
    ...
    slotProps: b = {},
    slots: w = {}
  } = t, P = fe(t, hd), [x, E] = k.useState(!0), y = () => {
    E(!1);
  }, T = () => {
    E(!0);
  };
  ...
  if (i)
    ...
    const L = ir(r);
    O = L && fr(L) ? Se(L).body : Se(null).body;
  }
...
process.env.NODE_ENV !== "production" && (cs.propTypes = {
   ...
   */
  anchorEl: Qt(s.oneOfType([at, s.object, s.func]), (e) => {
    if (e.open) {
      const t = ir(e.anchorEl);
      if (t && fr(t) && t.nodeType === 1) {
        const n = t.getBoundingClientRect();
        if (process.env.NODE_ENV !== "test" && n.top === 0 && n.left === 0 && n.right === 0 && n.bottom === 0)
          return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.", "The anchor element should be part of the document layout.", "Make sure the element is present in the document or that it's not display none."].join(`
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || bd(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
const xd = ["values", "unit", "step"], Ed = (e) => {
...
function kd(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = fe(e, xd), i = Ed(t), a = Object.keys(i);
  function l(g) {
...
const Td = {
  borderRadius: 4
}, Nd = Td, Od = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, bt = Od;
function xn(e, t) {
  return t ? ot(e, t, {
    clone: !1
...
function ar(e, t, n, r = n) {
  let o;
  return typeof e == "function" ? o = e(n) : Array.isArray(e) ? o = e[n] || r : o = mr(e, n) || r, t && (o = t(o, r, e)), o;
}
function ke(e) {
  const {
    prop: t,
    ...
    if (a[t] == null)
      return null;
    const l = a[t], c = a.theme, u = mr(c, r) || {};
    return lt(a, l, (v) => {
      let g = ar(u, o, v);
...
const Rd = {
  ...
  if (e.length > 2)
    if (Li[e])
      ...
      return [e];
  const [t, n] = e.split(""), r = Rd[t], o = $d[n] || "";
  return Array.isArray(o) ? o.map((i) => r + i) : [r + o];
}), hr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], gr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], Id = [...hr, ...gr];
function _n(e, t, n, r) {
  var o;
  const i = (o = mr(e, t, !1)) != null ? o : n;
...
function Ad(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = _d(n), i = Md(o, r), a = e[n];
  return lt(e, a, i);
}
function us(e, t) {
  const n = ps(e.theme);
  return Object.keys(e).map((r) => Ad(e, t, r, n)).reduce(xn, {});
}
function ye(e) {
  return us(e, hr);
}
ye.propTypes = process.env.NODE_ENV !== "production" ? hr.reduce((e, t) => (e[t] = bt, e), {}) : {};
ye.filterProps = hr;
function we(e) {
  return us(e, gr);
}
we.propTypes = process.env.NODE_ENV !== "production" ? gr.reduce((e, t) => (e[t] = bt, e), {}) : {};
we.filterProps = gr;
process.env.NODE_ENV !== "production" && Id.reduce((e, t) => (e[t] = bt, e), {});
function Dd(e = 8) {
  if (e.mui)
    return e;
  const t = ps({
...
const jd = Ge("border", ze), Bd = Ge("borderTop", ze), Ld = Ge("borderRight", ze), Vd = Ge("borderBottom", ze), Fd = Ge("borderLeft", ze), zd = Ge("borderColor"), Ud = Ge("borderTopColor"), Hd = Ge("borderRightColor"), Wd = Ge("borderBottomColor"), Xd = Ge("borderLeftColor"), Gd = Ge("outline", ze), qd = Ge("outlineColor"), vr = (e) => {
...
br(jd, Bd, Ld, Vd, Fd, zd, Ud, Hd, Wd, Xd, vr, Gd, qd);
const yr = (e) => {
...
br(yr, wr, xr, Yd, Kd, Jd, Zd, Qd, ef, tf, nf, rf);
function Wt(e, t) {
  return t === "grey" ? t : e;
}
const of = ke({
...
function bf() {
  ...
  function t(n) {
    ...
    function l(c) {
      ...
      if (!u)
        return null;
      const f = Sd(i.breakpoints), v = Object.keys(f);
      let g = f;
...
function Io(e = {}, ...t) {
  ...
  return u.applyStyles = vf, u = t.reduce((f, v) => ot(f, v), u), u.unstable_sxConfig = S({}, $o, a == null ? void 0 : a.unstable_sxConfig), u.unstable_sx = function(v) {
    return _o({
      sx: v,
      theme: this
    });
...
const Ef = ["ownerState"], kf = ["variants"], Tf = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Nf(e) {
  return Object.keys(e).length === 0;
}
function Of(e) {
...
const Sf = Io(), Vi = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Fn({
  defaultTheme: e,
  theme: t,
  themeId: n
...
function Pf(e = {}) {
  ...
  return i.__mui_systemSx = !0, (a, l = {}) => {
    ac(a, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: g = Cf(Vi(u))
    } = l, p = fe(l, Tf), m = f !== void 0 ? f : (
    ...
    let w = Wn;
    u === "Root" || u === "root" ? w = r : u ? w = o : Of(a) && (w = void 0);
    const P = oc(a, S({
      shouldForwardProp: w,
      label: b
      ...
      c && g && R.push((C) => {
        ...
        return Object.entries(M).forEach(([D, $]) => {
          V[D] = Xn($, S({}, C, {
            theme: I
          }));
        }), g(C, V);
      ...
      if (process.env.NODE_ENV !== "production") {
        let C;
        c && (C = `${c}${Ke(u || "")}`), C === void 0 && (C = `Styled(${dp(a)})`), L.displayName = C;
      }
...
function Mo(e, t = 0, n = 1) {
  return process.env.NODE_ENV !== "production" && (e < t || e > n) && console.error(`MUI: The value provided ${e} is out of range [${t}, ${n}].`), Ap(e, t, n);
}
function _f(e) {
  e = e.slice(1);
...
function Fi(e) {
  e = _t(e);
  let t = e.type === "hsl" || e.type === "hsla" ? _t(If(e)).values : e.values;
...
function sr(e, t) {
  return e = _t(e), t = Mo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Er(e);
}
function Mf(e, t) {
...
const jf = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Lt = Wf, Xf = ["mode", "contrastThreshold", "tonalOffset"], Ui = {
...
function Hi(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Af(e.main, o) : t === "dark" && (e.dark = Mf(e.main, i)));
}
function Gf(e = "light") {
  return e === "dark" ? {
    main: jt[200],
...
function Qf(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = fe(e, Xf), i = e.primary || Gf(t), a = e.secondary || qf(t), l = e.error || Yf(t), c = e.info || Kf(t), u = e.success || Jf(t), f = e.warning || Zf(t);
  function v(d) {
    const b = zi(d, Dr.text.primary) >= n ? Dr.text.primary : Ui.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = zi(d, b);
...
const em = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function tm(e) {
...
function nm(e, t) {
  ...
  const p = o / 14, m = v || ((w) => `${w / u * p}rem`), d = (w, P, x, E, y) => S({
    fontFamily: r,
    fontWeight: w,
    fontSize: m(P),
...
const rm = 0.2, om = 0.14, im = 0.12;
function be(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${rm})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${om})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${im})`].join(",");
}
const am = ["none", be(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), be(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), be(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), be(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), be(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), be(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), be(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), be(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), be(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), be(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), be(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), be(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), be(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), be(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), be(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), be(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), be(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), be(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), be(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), be(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), be(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), be(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), be(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), be(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], sm = am, lm = ["duration", "easing", "delay"], cm = {
...
function dm(e) {
  const t = S({}, cm, e.easing), n = S({}, pm, e.duration);
  return S({
...
const fm = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, mm = fm, hm = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function gm(e = {}, ...t) {
  const {
    mixins: n = {},
    palette: r = {},
...
const bm = gm(), Ao = bm, Do = "$$material", hs = (e) => Wn(e) && e !== "classes", vm = Pf({
  themeId: Do,
  defaultTheme: Ao,
...
function to(e, t) {
  return to = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(r, o) {
...
var wm = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.shape({
  enter: s.number,
  exit: s.number,
  appear: s.number
}).isRequired]) : null;
...
var xm = function(t) {
  return t.scrollTop;
}, gn = "unmounted", xt = "exited", Et = "entering", Ut = "entered", no = "exiting", ut = /* @__PURE__ */ function(e) {
  ym(t, e);
  function t(r, o) {
    var i;
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? a !== Et && a !== Ut && (i = Et) : (a === Et || a === Ut) && (i = no);
    }
...
const km = {
...
}, jr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), jo = /* @__PURE__ */ k.forwardRef(function(t, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: i,
  ...
  } = t, w = fe(t, Em), P = mn(), x = k.useRef(), E = Mn(), y = k.useRef(null), T = He(y, i.ref, n), O = (D) => ($) => {
    if (D) {
      const z = y.current;
      $ === void 0 ? D(z) : D(z, $);
    }
    ...
    let q;
    d === "auto" ? (q = E.transitions.getAutoHeightDuration(D.clientHeight), x.current = q) : q = $, D.style.transition = [E.transitions.create("opacity", {
      duration: q,
      delay: z
    }), E.transitions.create("transform", {
      duration: jr ? q : q * 0.666,
      delay: jr ? z : z || q * 0.333,
      easing: Z
    })].join(","), D.style.opacity = 0, D.style.transform = ro(0.75), v && v(D);
  }), M = O(g);
  return /* @__PURE__ */ h(b, S({
    ...
    onExiting: C,
    addEndListener: (D) => {
      d === "auto" && P.start(x.current || 0, D), r && r(y.current, D);
    },
    timeout: d === "auto" ? null : d
  }, w, {
    children: (D, $) => /* @__PURE__ */ k.cloneElement(i, S({
      style: S({
        opacity: 0,
        transform: ro(0.75),
        visibility: D === "exited" && !l ? "hidden" : void 0
      }, km[D], m, i.props.style),
      ref: T
    }, $))
  }));
});
...
const oo = jo, Tm = (e) => {
...
}, Yi = Tm, Nm = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Om = Ce(cs, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = fs(), i = pt({
    ...
    slots: x,
    slotProps: E
  } = i, y = fe(i, Nm), T = (r = x == null ? void 0 : x.root) != null ? r : c == null ? void 0 : c.Root, O = S({
    anchorEl: a,
    container: f,
    disablePortal: v,
    keepMounted: g,
...
const Cm = ht("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), mt = Cm, Pm = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Rm(e) {
  return Math.round(e * 1e5) / 1e5;
}
const $m = (e) => {
  ...
  [`&[data-popper-placement*="right"] .${mt.arrow}`]: S({}, t.isRtl ? {
    right: 0,
    marginRight: "-0.71em"
  } : {
    left: 0,
  ...
  [`&[data-popper-placement*="left"] .${mt.arrow}`]: S({}, t.isRtl ? {
    left: 0,
    marginLeft: "-0.71em"
  } : {
    right: 0,
  ...
  [`.${mt.popper}[data-popper-placement*="left"] &`]: S({
  ...
  [`.${mt.popper}[data-popper-placement*="right"] &`]: S({
  ...
  [`.${mt.popper}[data-popper-placement*="top"] &`]: S({
    transformOrigin: "center bottom",
    marginBottom: "14px"
  }, t.touch && {
    marginBottom: "24px"
  }),
  [`.${mt.popper}[data-popper-placement*="bottom"] &`]: S({
...
const xs = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  const T = pt({
    ...
    TransitionProps: ne
  } = T, _ = fe(T, Pm), se = /* @__PURE__ */ k.isValidElement(R) ? R : /* @__PURE__ */ h("span", {
    children: R
  }), Te = Mn(), Pe = Te.direction === "rtl", [Ee, vt] = k.useState(), [Re, Qe] = k.useState(null), De = k.useRef(!1), et = V || q, Ne = mn(), Mt = mn(), yt = mn(), en = mn(), [An, Uo] = Va({
    controlled: X,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const kr = La(N), tn = k.useRef(), Dn = kn(() => {
  ...
  const Ho = (re) => {
    ...
    De.current && re.type !== "touchstart" || (Ee && Ee.removeAttribute("title"), Mt.clear(), yt.clear(), $ || zn && z ? Mt.start(zn ? z : $, () => {
      Ho(re);
    }) : Ho(re));
  }, Wo = (re) => {
    Mt.clear(), yt.start(j, () => {
    ...
    Ee || vt(re.currentTarget), al(re), Xo.current === !0 && (Go(!0), Tr(re));
  }, Ko = (re) => {
    De.current = !0;
    const je = se.props;
    ...
    Ko(re), yt.clear(), Ne.clear(), Dn(), tn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(Z, () => {
      document.body.style.WebkitUserSelect = tn.current, Tr(re);
    });
  }, cl = (re) => {
  ...
  !ae && ae !== 0 && (tt = !1);
  const Nr = k.useRef(), ul = (re) => {
    const je = se.props;
    je.onMouseMove && je.onMouseMove(re), pn = {
      x: re.clientX,
      y: re.clientY
    }, Nr.current && Nr.current.update();
  }, nn = {}, Or = typeof ae == "string";
  C ? (nn.title = !tt && Or && !M ? ae : null, nn["aria-describedby"] = tt ? kr : null) : (nn["aria-label"] = Or ? ae : null, nn["aria-labelledby"] = tt && !Or ? kr : null);
  const Fe = S({}, nn, _, se.props, {
    className: Oe(_.className, se.props.className),
    onTouchStart: Ko,
    ref: pl
  }, q ? {
    onMouseMove: ul
...
`));
  const dl = k.useMemo(() => {
    ...
    touch: De.current
  }), Sr = $m(on), Qo = (r = (o = te.popper) != null ? o : A.Popper) != null ? r : _m, ei = (i = (a = (l = te.transition) != null ? l : A.Transition) != null ? a : B) != null ? i : oo, ti = (c = (u = te.tooltip) != null ? u : A.Tooltip) != null ? c : Im, ni = (f = (v = te.arrow) != null ? v : A.Arrow) != null ? f : Mm, fl = hn(Qo, S({}, G, (g = ee.popper) != null ? g : L.popper, {
    className: Oe(Sr.popper, G == null ? void 0 : G.className, (p = (m = ee.popper) != null ? m : L.popper) == null ? void 0 : p.className)
  }), on), ml = hn(ei, S({}, ne, (d = ee.transition) != null ? d : L.transition), on), hl = hn(ti, S({}, (b = ee.tooltip) != null ? b : L.tooltip, {
    className: Oe(Sr.tooltip, (w = (P = ee.tooltip) != null ? P : L.tooltip) == null ? void 0 : w.className)
  }), on), gl = hn(ni, S({}, (x = ee.arrow) != null ? x : L.arrow, {
    className: Oe(Sr.arrow, (E = (y = ee.arrow) != null ? y : L.arrow) == null ? void 0 : E.className)
  }), on);
  return /* @__PURE__ */ F(k.Fragment, {
...
const Bm = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Lm = (e) => {
  const {
    color: t,
    fontSize: n,
    classes: r
  ...
  const r = pt({
    ...
    titleAccess: v,
    viewBox: g = "0 0 24 24"
  } = r, p = fe(r, Bm), m = /* @__PURE__ */ k.isValidElement(o) && o.type === "svg", d = S({}, r, {
    color: a,
    component: l,
    fontSize: c,
...
}, Symbol.toStringTag, { value: "Module" })), Um = /* @__PURE__ */ Gc(zm);
var Zi;
function Hm() {
...
var Ts = Bo.default = void 0, Xm = Wm(Hm()), Gm = bl;
Ts = Bo.default = (0, Xm.default)(/* @__PURE__ */ (0, Gm.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Qi(e, t, n) {
  ...
  const {
    ...
    ql,
    {
      ...
      children: n ? /* @__PURE__ */ F(It, { children: [
        Qi(i, n, !0),
        /* @__PURE__ */ h(Yl, { primary: n, inset: !i && o }),
        v ? /* @__PURE__ */ h(ga, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ h(Ts, {}) }) : Qi(a, n, !1)
      ] }) : b
    }
  );
  return r ? /* @__PURE__ */ h(Am, { title: r, placement: "right", children: /* @__PURE__ */ h("div", { children: w }) }) : w;
}
function Os(e) {
...
const Ym = (e, t) => t.filter((o) => o.group === e).sort((o, i) => (o.order || 0) - (i.order || 0));
function Vo(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: i, allowForLeadingIcons: a } = lo(() => {
  ...
  return /* @__PURE__ */ F(
    ba,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ h(Jl, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ h(
          Km,
          {
            commandHandler: e,
            menuDefinition: t,
...
const th = ["children", "className", "component", "dense", "disablePadding", "subheader"], nh = (e) => {
  const {
    classes: t,
    disablePadding: n,
    dense: r,
  ...
  return /* @__PURE__ */ h(Qm.Provider, {
    value: v,
    children: /* @__PURE__ */ F(rh, S({
      as: a,
...
const oh = Cs, ih = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Lr(e, t, n) {
...
const Rs = /* @__PURE__ */ k.forwardRef(function(t, n) {
  ...
  } = t, g = fe(t, ih), p = k.useRef(null), m = k.useRef({
    keys: [],
    repeating: !0,
  ...
  const d = (x) => {
    const E = p.current, y = x.key, T = Se(E).activeElement;
    if (y === "ArrowDown")
      x.preventDefault(), un(E, T, u, c, Lr);
    else if (y === "ArrowUp")
      x.preventDefault(), un(E, T, u, c, ea);
    else if (y === "Home")
      x.preventDefault(), un(E, null, u, c, Lr);
    else if (y === "End")
      ...
      O.previousKeyMatched && (L || un(E, T, !1, c, Lr, O)) ? x.preventDefault() : O.previousKeyMatched = !1;
    }
    f && f(x);
  }, b = He(p, n);
  let w = -1;
...
const ah = Rs, sh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], lh = {
  entering: {
    opacity: 1
  },
  entered: {
  ...
  const r = Mn(), o = {
  ...
  } = t, x = fe(t, sh), E = k.useRef(null), y = He(E, l.ref, n), T = (V) => (D) => {
    if (V) {
      const $ = E.current;
      D === void 0 ? V($) : V($, D);
    }
    ...
    V.style.webkitTransition = r.transitions.create("opacity", $), V.style.transition = r.transitions.create("opacity", $), f && f(V, D);
  }), A = T(v), L = T(d), C = T((V) => {
    const D = lr({
      style: b,
      timeout: w,
...
const uh = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], dh = (e) => {
  ...
  const a = pt({
    ...
    slotProps: m = {},
    slots: d = {},
    TransitionComponent: b = ch,
    transitionDuration: w
  } = a, P = fe(a, uh), x = S({}, a, {
    component: u,
    invisible: g
  }), E = dh(x), y = (r = m.root) != null ? r : v.root;
  return /* @__PURE__ */ h(b, S({
    in: p,
    timeout: w
  }, P, {
    children: /* @__PURE__ */ h(fh, S({
      "aria-hidden": !0
    }, y, {
...
const gh = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], bh = (e) => {
  const {
    open: t,
    exited: n,
    classes: r
  ...
  if (m.props.tabIndex === void 0 && (Y.tabIndex = "-1"), J) {
    ...
    Y.onEnter = ne, Y.onExited = _;
  }
  const K = (r = (o = V == null ? void 0 : V.root) != null ? o : w.Root) != null ? r : vh, G = (i = (a = V == null ? void 0 : V.backdrop) != null ? a : w.Backdrop) != null ? i : f, ee = (l = M == null ? void 0 : M.root) != null ? l : P.root, te = (c = M == null ? void 0 : M.backdrop) != null ? c : P.backdrop, ae = Rt({
    elementType: K,
    ...
    ownerState: H,
    className: Oe(g, ee == null ? void 0 : ee.className, X == null ? void 0 : X.root, !H.open && H.exited && (X == null ? void 0 : X.hidden))
  }), B = Rt({
    elementType: G,
    ...
    getSlotProps: (ne) => Z(S({}, ne, {
      onClick: (_) => {
        C && C(_), ne != null && ne.onClick && ne.onClick(_);
      }
    })),
...
const Eh = ["className", "component", "elevation", "square", "variant"], kh = (e) => {
  const {
    square: t,
    elevation: n,
    variant: r,
...
const Sh = ["onEntering"], Ch = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Ph = ["slotProps"];
function ta(e, t) {
  let n = 0;
...
const Rh = (e) => {
  ...
  const a = pt({
  ...
  } = a, L = fe(a.TransitionProps, Sh), C = fe(a, Ch), I = (r = E == null ? void 0 : E.paper) != null ? r : P, M = k.useRef(), V = He(M, I.ref), D = S({}, a, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: d,
    marginThreshold: b,
    ...
    const ne = Gn(c), _ = ne && ne.nodeType === 1 ? ne : Se(M.current).body, se = _.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
      const Te = _.getBoundingClientRect();
...
`));
    ...
    const vt = Pe + _.height, Re = Ee + _.width, Qe = Gt(Gn(c)), De = Qe.innerHeight - b, et = Qe.innerWidth - b;
    if (b !== null && Pe < b) {
      const Ne = Pe - b;
...
`)), b !== null && Ee < b) {
    ...
    if (!ne)
      return;
    const _ = q(ne);
    _.top !== null && (ne.style.top = _.top), _.left !== null && (ne.style.left = _.left), ne.style.transformOrigin = _.transformOrigin, j(!0);
  }, [q]);
  ...
  k.useEffect(() => {
    ...
    return _.addEventListener("resize", ne), () => {
      ne.clear(), _.removeEventListener("resize", ne);
    };
  }, [c, w, U]);
  let X = O;
  O === "auto" && !T.muiSupportAuto && (X = void 0);
  const Y = m || (c ? Se(Gn(c)).body : void 0), K = (o = x == null ? void 0 : x.root) != null ? o : $h, G = (i = x == null ? void 0 : x.paper) != null ? i : As, ee = Rt({
    elementType: G,
    ...
    ownerState: D,
    className: Oe($.paper, I == null ? void 0 : I.className)
  }), te = Rt({
    elementType: K,
...
process.env.NODE_ENV !== "production" && (Ds.propTypes = {
   ...
   */
  anchorEl: Qt(s.oneOfType([at, s.func]), (e) => {
...
const Mh = ["onEntering"], Ah = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Dh = {
  vertical: "top",
  horizontal: "right"
}, jh = {
  vertical: "top",
  ...
  const i = pt({
    ...
    slots: P = {},
    slotProps: x = {}
  } = i, E = fe(i.TransitionProps, Mh), y = fe(i, Ah), T = Mn(), O = T.direction === "rtl", R = S({}, i, {
    autoFocus: a,
    ...
    TransitionProps: E,
    variant: w
  }), A = Bh(R), L = a && !u && g, C = k.useRef(null), I = (q, N) => {
    C.current && C.current.adjustStyleForScrollbar(q, T), b && b(q, N);
  }, M = (q) => {
...
`)), q.props.disabled || (w === "selectedMenu" && q.props.selected || V === -1) && (V = N));
  ...
  const D = (r = P.paper) != null ? r : Vh, $ = (o = x.paper) != null ? o : p, z = Rt({
    elementType: P.root,
  ...
  return /* @__PURE__ */ h(Lh, S({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: O ? "right" : "left"
    },
    transformOrigin: O ? Dh : jh,
    slots: {
      paper: D,
      root: P.root
    },
    ...
    children: /* @__PURE__ */ h(Fh, S({
      ...
      className: Oe(A.list, f.className),
      children: l
    }))
  }));
});
...
function Gb({
  ...
  var u;
  const [o, i] = Q.useState(void 0), a = _e(
    (f) => {
      f.preventDefault(), i(
        o === void 0 ? {
          mouseX: f.clientX + 2,
...
), Bs = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(ya.Root, { ref: n, className: W(Xh(), e), ...t }));
...
function Qb({
  ...
  const i = Nt(void 0);
  return /* @__PURE__ */ h("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ h(nc, { position: "static", id: r, children: /* @__PURE__ */ F(rc, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ h(
      Wh,
      {
        commandHandler: t,
...
const ev = Ae.Root, qh = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  Ae.List,
  {
    ref: n,
    className: W(
...
const Yh = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  Ae.Trigger,
  {
    ref: n,
    className: W(
...
Yh.displayName = Ae.Trigger.displayName;
...
const tv = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  Ae.Trigger,
  {
    ref: n,
    ...t,
...
)), Qh = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  Ae.Content,
  {
    ref: n,
    className: W(
...
Qh.displayName = Ae.Content.displayName;
function eg({ columns: e, tableData: t, onSelectItem: n }) {
  return /* @__PURE__ */ h("div", { className: "pr-overflow-y-auto", children: /* @__PURE__ */ h(Hc, { columns: e, data: t, onRowClickHandler: (o, i) => {
...
function tg({
  ...
  const i = o["%webView_inventory_occurrences_table_header_reference%"], a = o["%webView_inventory_occurrences_table_header_occurrence%"], [l, c] = he(
    oa(t, e, n)
  );
  return it(
    () => c(oa(t, e, n)),
    ...
    /* @__PURE__ */ h(vo, { children: /* @__PURE__ */ F(Ht, { children: [
      /* @__PURE__ */ h(Zn, { children: i }),
      /* @__PURE__ */ h(Zn, { children: a })
    ] }) }),
    /* @__PURE__ */ h(yo, { children: l.map((u) => /* @__PURE__ */ F(
      Ht,
      {
        onClick: () => {
          r(u.reference);
        ...
        children: [
          /* @__PURE__ */ h(En, { children: `${me.bookNumberToEnglishName(u.reference.bookNum)} ${u.reference.chapterNum}:${u.reference.verseNum}` }),
          /* @__PURE__ */ h(En, { children: u.snippet })
        ]
      },
      u.key
    )) })
...
function Ls({
  ...
  return it(() => {
  ...
  }, [o, a, x, T, R]), /* @__PURE__ */ F("div", { className: "pr-twp pr-font-sans", children: [
    /* @__PURE__ */ F("div", { className: "pr-flex", children: [
      /* @__PURE__ */ F(Xr, { onValueChange: (D) => O(D), defaultValue: T, children: [
        /* @__PURE__ */ h(Qn, { children: /* @__PURE__ */ h(Gr, { placeholder: "Select filter" }) }),
        /* @__PURE__ */ F(er, { className: "pr-font-sans", children: [
          /* @__PURE__ */ h(rt, { value: "all", children: v }),
          /* @__PURE__ */ h(rt, { value: "approved", children: g }),
          /* @__PURE__ */ h(rt, { value: "unapproved", children: p }),
          /* @__PURE__ */ h(rt, { value: "unknown", children: m })
        ] })
      ] }),
      /* @__PURE__ */ F(Xr, { onValueChange: (D) => u(D), defaultValue: y, children: [
        /* @__PURE__ */ h(Qn, { children: /* @__PURE__ */ h(Gr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ F(er, { className: "pr-font-sans", children: [
          /* @__PURE__ */ h(rt, { value: "book", children: d }),
          /* @__PURE__ */ h(rt, { value: "chapter", children: b }),
          /* @__PURE__ */ h(rt, { value: "verse", children: w })
        ] })
      ] }),
      /* @__PURE__ */ h(
        pr,
    ...
    /* @__PURE__ */ h(
      "div",
      {
        className: `pr-overflow-y-auto pr-rounded-md pr-border ${I !== "" && "pr-max-h-96"}`,
        children: /* @__PURE__ */ h(
          eg,
          {
            columns: f(V),
    ...
    I !== "" && /* @__PURE__ */ h("div", { className: "pr-mt-4 pr-rounded-md pr-border", children: /* @__PURE__ */ h(
      tg,
      {
        selectedItem: I,
        text: c,
...
const Ot = (e) => e === "asc" ? /* @__PURE__ */ h(_l, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ h(Il, { className: "pr-ml-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ h(Ml, { className: "pr-ml-2 pr-h-4 pr-w-4" }), rg = (e, t, n, r, o) => [
  {
    accessorKey: "item",
...
function nv({
  ...
  const u = n["%webView_inventory_table_header_character%"], f = n["%webView_inventory_table_header_unicode_value%"], v = n["%webView_inventory_table_header_count%"], g = n["%webView_inventory_table_header_status%"];
...
function rv({
  ...
  const u = n["%webView_inventory_table_header_repeated_words%"], f = n["%webView_inventory_table_header_count%"], v = n["%webView_inventory_table_header_status%"];
  ...
  return /* @__PURE__ */ h(
    ve,
    {
      ...
      children: e ? /* @__PURE__ */ h(co, { size: 15, className: "pr-animate-spin" }) : /* @__PURE__ */ F(It, { children: [
        /* @__PURE__ */ h(Al, { size: 25, className: "pr-h-4 pr-w-4" }),
        n
      ] })
    }
  );
}
function iv({ isRemoving: e, handleClick: t }) {
  return /* @__PURE__ */ h(
    ve,
    {
      className: W(
...
function av({ isUpdating: e, handleClick: t }) {
  return /* @__PURE__ */ h(
    ve,
    {
      className: W(
...
function la(e, t) {
  const n = t === 1, r = n ? nl : rl, o = n ? Qs : el, i = n ? Jg : Zg;
  return { t(a, l, c) {
    const u = Kg.exec(c);
...
const Qg = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, eb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, ol = [Vs, Fs, zs, Us, Ws, Hs, Xs, Gs, Qs, nl, el, rl], tb = [...ol, /^[^\n]+(?:  \n|\n{2,})/, ao, so];
function nb(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function rb(e) {
  return Vg.test(e) ? "right" : Bg.test(e) ? "center" : Lg.test(e) ? "left" : null;
}
function ca(e, t, n) {
  const r = n.$;
  n.$ = !0;
  ...
  return o.forEach(function(a, l) {
    a.type === "tableSeparator" ? l !== 0 && l !== o.length - 1 && i.push([]) : (a.type !== "text" || o[l + 1] != null && o[l + 1].type !== "tableSeparator" || (a.v = a.v.replace(jg, "")), i[i.length - 1].push(a));
  }), i;
}
function ob(e, t, n) {
  n._ = !0;
...
function cb(e, t = {}) {
  ...
  function r(p, m, ...d) {
    const b = Ur(t.overrides, `${p}.props`, {});
    return n(function(w, P) {
      const x = Ur(P, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : Ur(P, `${w}.component`, w) : w;
    }(p, t.overrides), Tt({}, m, b, { className: lb(m == null ? void 0 : m.className, b.className) || void 0 }), ...d);
  }
  function o(p) {
    let m = !1;
    t.forceInline ? m = !0 : t.forceBlock || (m = Ig.test(p) === !1);
...
`, { _: m }));
  ...
  function i(p) {
    ...
    return m ? m.reduce(function(d, b, w) {
      ...
      if (P !== -1) {
        const x = function(O) {
          return O.indexOf("-") !== -1 && O.match(kg) === null && (O = O.replace(Cg, function(R, A) {
            return A.toUpperCase();
          })), O;
        }(b.slice(0, P)).trim(), E = function(O) {
          const R = O[0];
          return (R === '"' || R === "'") && O.length >= 2 && O[O.length - 1] === R ? O.slice(1, -1) : O;
        }(b.slice(P + 1).trim()), y = ia[x] || x, T = d[y] = function(O, R) {
          return O === "style" ? R.split(/;\s?/).reduce(function(A, L) {
            const C = L.slice(0, L.indexOf(":"));
            return A[C.replace(/(-[a-z])/g, (I) => I[1].toUpperCase())] = L.slice(C.length + 1).trim(), A;
          }, {}) : O === "href" ? Ft(R) : (R.match(Tg) && (R = R.slice(1, R.length - 1)), R === "true" || R !== "false" && R);
        }(x, E);
        typeof T == "string" && (ao.test(T) || so.test(T)) && (d[y] = k.cloneElement(o(T.trim()), { key: w }));
      } else
        b !== "style" && (d[ia[b] || b] = !0);
      return d;
    }, {}) : null;
  }
  const a = [], l = {}, c = { blockQuote: { t: nt(Vs), i: ie.HIGH, l: (p, m, d) => ({ v: m(p[0].replace(dg, ""), d) }), h: (p, m, d) => r("blockquote", { key: d.k }, m(p.v, d)) }, breakLine: { t: dn(fg), i: ie.HIGH, l: Fr, h: (p, m, d) => r("br", { key: d.k }) }, breakThematic: { t: nt(mg), i: ie.HIGH, l: Fr, h: (p, m, d) => r("hr", { key: d.k }) }, codeBlock: { t: nt(zs), i: ie.MAX, l: (p) => ({ v: p[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (p, m, d) => r("pre", { key: d.k }, r("code", Tt({}, p.O, { className: p.M ? `lang-${p.M}` : "" }), p.v)) }, codeFenced: { t: nt(Fs), i: ie.MAX, l: (p) => ({ O: i(p[3] || ""), v: p[4], M: p[2] || void 0, type: "codeBlock" }) }, codeInline: { t: ft(hg), i: ie.LOW, l: (p) => ({ v: p[2] }), h: (p, m, d) => r("code", { key: d.k }, p.v) }, footnote: { t: nt(vg), i: ie.MAX, l: (p) => (a.push({ I: p[2], j: p[1] }), {}), h: zr }, footnoteReference: { t: dt(yg), i: ie.HIGH, l: (p) => ({ v: p[1], B: `#${t.slugify(p[1])}` }), h: (p, m, d) => r("a", { key: d.k, href: Ft(p.B) }, r("sup", { key: d.k }, p.v)) }, gfmTask: { t: dt(xg), i: ie.HIGH, l: (p) => ({ R: p[1].toLowerCase() === "x" }), h: (p, m, d) => r("input", { checked: p.R, key: d.k, readOnly: !0, type: "checkbox" }) }, heading: { t: nt(t.enforceAtxHeadings ? Hs : Us), i: ie.HIGH, l: (p, m, d) => ({ v: qn(m, p[2], d), T: t.slugify(p[2]), C: p[1].length }), h: (p, m, d) => r(`h${p.C}`, { id: p.T, key: d.k }, m(p.v, d)) }, headingSetext: { t: nt(Ws), i: ie.MAX, l: (p, m, d) => ({ v: qn(m, p[1], d), C: p[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: dn(Xs), i: ie.HIGH, l: () => ({}), h: zr }, image: { t: ft(eb), i: ie.HIGH, l: (p) => ({ D: p[1], B: ua(p[2]), F: p[3] }), h: (p, m, d) => r("img", { key: d.k, alt: p.D || void 0, title: p.F || void 0, src: Ft(p.B) }) }, link: { t: dt(Qg), i: ie.LOW, l: (p, m, d) => ({ v: ab(m, p[1], d), B: ua(p[2]), F: p[3] }), h: (p, m, d) => r("a", { key: d.k, href: Ft(p.B), title: p.F }, m(p.v, d)) }, linkAngleBraceStyleDetector: { t: dt(Sg), i: ie.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], type: "link" }) }, linkBareUrlDetector: { t: (p, m) => m.N ? null : dt(Ng)(p, m), i: ie.MAX, l: (p) => ({ v: [{ v: p[1], type: "text" }], B: p[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: dt(Og), i: ie.MAX, l(p) {
    let m = p[1], d = p[1];
    return pg.test(d) || (d = "mailto:" + d), { v: [{ v: m.replace("mailto:", ""), type: "text" }], B: d, type: "link" };
  } }, orderedList: la(r, 1), unorderedList: la(r, 2), newlineCoalescer: { t: nt(gg), i: ie.LOW, l: Fr, h: () => `
` }, paragraph: { t: ib, i: ie.LOW, l: Vr, h: (p, m, d) => r("p", { key: d.k }, m(p.v, d)) }, ref: { t: dt(Pg), i: ie.MAX, l: (p) => (l[p[1]] = { B: p[2], F: p[4] }, {}), h: zr }, refImage: { t: ft(Rg), i: ie.MAX, l: (p) => ({ D: p[1] || void 0, P: p[2] }), h: (p, m, d) => r("img", { key: d.k, alt: p.D, src: Ft(l[p.P].B), title: l[p.P].F }) }, refLink: { t: dt($g), i: ie.MAX, l: (p, m, d) => ({ v: m(p[1], d), Z: m(p[0].replace(_g, "\\$1"), d), P: p[2] }), h: (p, m, d) => l[p.P] ? r("a", { key: d.k, href: Ft(l[p.P].B), title: l[p.P].F }, m(p.v, d)) : r("span", { key: d.k }, m(p.Z, d)) }, table: { t: nt(Gs), i: ie.HIGH, l: ob, h: (p, m, d) => r("table", { key: d.k }, r("thead", null, r("tr", null, p.L.map(function(b, w) {
  ...
  }, h: () => " | " }, text: { t: dn(Xg), i: ie.MIN, l: (p) => ({ v: p[0].replace(Eg, (m, d) => t.namedCodesToUnicode[d] ? t.namedCodesToUnicode[d] : m) }), h: (p) => p.v }, textBolded: { t: ft(Fg), i: ie.MED, l: (p, m, d) => ({ v: m(p[2], d) }), h: (p, m, d) => r("strong", { key: d.k }, m(p.v, d)) }, textEmphasized: { t: ft(zg), i: ie.LOW, l: (p, m, d) => ({ v: m(p[2], d) }), h: (p, m, d) => r("em", { key: d.k }, m(p.v, d)) }, textEscaped: { t: ft(Wg), i: ie.HIGH, l: (p) => ({ v: p[1], type: "text" }) }, textMarked: { t: ft(Ug), i: ie.LOW, l: Vr, h: (p, m, d) => r("mark", { key: d.k }, m(p.v, d)) }, textStrikethroughed: { t: ft(Hg), i: ie.LOW, l: Vr, h: (p, m, d) => r("del", { key: d.k }, m(p.v, d)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: dn(ao), i: ie.HIGH, l(p, m, d) {
    const [, b] = p[3].match(qg), w = new RegExp(`^${b}`, "gm"), P = p[3].replace(w, ""), x = (E = P, tb.some((R) => R.test(E)) ? sb : qn);
    var E;
    const y = p[1].toLowerCase(), T = lg.indexOf(y) !== -1;
    d.N = d.N || y === "a";
    const O = T ? p[3] : x(m, P, d);
    return d.N = !1, { O: i(p[2]), v: O, G: T, H: T ? y : p[1] };
  }, h: (p, m, d) => r(p.H, Tt({ key: d.k }, p.O), p.G ? p.v : m(p.v, d)) }, c.htmlSelfClosing = { t: dn(so), i: ie.HIGH, l: (p) => ({ O: i(p[2] || ""), H: p[1] }), h: (p, m, d) => r(p.H, Tt({}, p.O, { key: d.k })) });
  const u = function(p) {
    let m = Object.keys(p);
    function d(b, w) {
      let P = [], x = "";
      for (; b; ) {
        ...
        for (; E < m.length; ) {
          ...
          if (O) {
            ...
            const A = T.l(O, d, w);
            A.type == null && (A.type = y), P.push(A), x = R;
            break;
          }
          E++;
        }
...
const mb = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h("p", { ref: n, className: W("pr-text-sm pr-text-muted-foreground", e), ...t }));
...
), vb = Q.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ h("div", { ref: r, role: "alert", className: W(bb({ variant: t }), e), ...n }));
vb.displayName = "Alert";
const yb = Q.forwardRef(
...
const wb = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h("div", { ref: n, className: W("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
wb.displayName = "AlertDescription";
const xb = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ F(
  fn.Root,
  {
    ref: n,
    className: W(
...
xb.displayName = fn.Root.displayName;
const Eb = Q.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ h(
  Wr.Root,
  {
    className: W(
...
Eb.displayName = Wr.Root.displayName;
function kb(e, t = "top") {
