...
import rt, { useRef as U, useMemo as B, useState as T, useCallback as j, useEffect as X, useLayoutEffect as ee, createContext as ca, useContext as to, Component as is, createElement as Oo, Suspense as ss, forwardRef as da, Fragment as eo } from "react";
...
function ba({
  ...
  const _ = bt(), [z, C] = T(!1), [N, E] = T(""), [I, y] = T(""), [b, S] = T("books"), [M, F] = T(void 0), [K, L] = T(
    void 0
  ), [q, $] = T(void 0), [W, pt] = T(!1), _t = U(null), $t = U(!1), tt = U(void 0), Rt = U(void 0), G = U(void 0), ot = U(void 0), it = U({}), st = U({}), lt = j(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  const Bt = j(() => {
    if (O) {
      const k = O.chapterNum ?? 1, H = O.verseNum ?? 1;
      if (w && va(O.book, k, H, w))
        return;
      lt({
        book: O.book,
        chapterNum: k,
    ...
    S("books"), F(void 0), L(void 0), $(void 0), setTimeout(() => {
      Rt.current && Rt.current.focus();
    }, 0);
  }, []), P = j(() => {
    const k = K;
    L(void 0), $(void 0), k ? (F(k), S("chapters"), E("")) : Zt();
  }, [K, Zt]), Y = j((k) => {
    C(k), k && (S("books"), F(void 0), L(void 0), $(void 0), y(""));
    ...
    () => Mc(I),
    [I]
  ), kt = B(() => !c || !O || !O.chapterNum || !gt ? !1 : c(O.book, O.chapterNum) > 0, [c, O, gt]), Ke = j(
    (k) => w ? Xo(k, w) : !1,
    [w]
  ), Pe = j(
    (k) => (H) => w ? Ac(k, H, w) : !1,
    ...
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), g && g.includes(k.key) && O && O.chapterNum !== void 0 && O.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), Bt());
    },
    [g, O, Bt]
  ), Ar = j(
    (k) => {
      var re, or, kr;
      if (k.ctrlKey) return;
      const { isLetter: H, isDigit: Z } = Jo(k.key);
      if ((b === "chapters" || b === "verses") && (k.key === " " || k.key === "Enter")) {
        const At = k.target instanceof HTMLElement ? k.target : void 0;
        ...
        if (Tt) {
          k.preventDefault(), k.stopPropagation(), Tt.click();
          return;
        }
      }
      ...
      if (b === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), Zt();
        return;
      }
      if (b === "verses" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), P();
        return;
      }
      ...
      if (b === "verses" && zt) {
        ...
        Qt !== mt && (k.preventDefault(), k.stopPropagation(), E(
          `${At} ${se[At] || ""} ${Nt}:${Qt}`
        ), setTimeout(() => {
      ...
      if ((b === "chapters" || b === "books" && O) && zt) {
        ...
        mt !== Nt && (k.preventDefault(), k.stopPropagation(), E(
          `${At} ${se[At] || ""} ${mt}`
        ), setTimeout(() => {
    ...
    const { isLetter: H, isDigit: Z } = Jo(k.key);
    (H || Z) && (k.preventDefault(), y((re) => re + k.key), Rt.current.focus(), pt(!1));
  }, []);
  return ee(() => {
    const k = setTimeout(() => {
      if (z && b === "books" && G.current && ot.current) {
    ...
    if (b === "chapters" && M) {
      const k = M === t.book, H = k ? t.chapterNum : 1;
      E(
        `${M} ${se[M] || ""} ${H}`
      ), setTimeout(() => {
        if (G.current)
    ...
    if (b === "verses" && K && q !== void 0) {
      const k = K === t.book && q === t.chapterNum, H = k ? t.verseNum : 1;
      E(
        `${K} ${se[K] || ""} ${q}:${H}`
      ), setTimeout(() => {
        if (G.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ne, { open: z, onOpenChange: Y, modal: v, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ a(
      V,
      {
        ref: _t,
        ...
        onClick: (k) => {
          $t.current && ($t.current = !1, k.preventDefault());
        },
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: H } = k;
          z && _t.current && H instanceof Node && _t.current.contains(H) && ($t.current = !0, Y(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          $e,
          {
            ...
            children: [
              b === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Jt.map(({ onClick: k, disabled: H, title: Z, icon: zt }) => /* @__PURE__ */ a(
                  V,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ a(
                  V,
                  {
                    ...
                    tabIndex: -1,
                    children: _ === "ltr" ? /* @__PURE__ */ a(Os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Sn, { className: "tw:h-4 tw:w-4" })
                  }
                ),
              ...
              !W && /* @__PURE__ */ u(Re, { ref: G, children: [
                b === "books" && /* @__PURE__ */ u(at, { children: [
                  !O && Object.entries(Yt).map(([k, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(he, { heading: yt(k), children: H.map((Z) => /* @__PURE__ */ a(
                          ni,
                          {
                            bookId: Z,
                            onSelect: (zt) => Xt(zt),
                  ...
                  O && kt && O.chapterNum && c && /* @__PURE__ */ u(at, { children: [
...
function tn({
  ...
  const [z, C] = T(!1), N = c ?? d, E = (y) => y.length > 0 && typeof y[0] == "object" && "options" in y[0], I = (y, b) => {
    const S = d(y), M = typeof y == "object" && "secondaryLabel" in y ? y.secondaryLabel : void 0, F = `${b ?? ""}${S}${M ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: S,
  ...
  return /* @__PURE__ */ u(Ne, { open: z, onOpenChange: C, ..._, children: [
    ...
    /* @__PURE__ */ a(
      _e,
      {
        ...
        children: /* @__PURE__ */ u($e, { children: [
          ...
          /* @__PURE__ */ a(Re, { children: E(e) ? e.map((y) => /* @__PURE__ */ a(he, { heading: y.groupHeading, children: y.options.map((b) => I(b, y.groupHeading)) }, y.groupHeading)) : e.map((y) => I(y)) })
        ] })
      }
    )
  ] });
...
function td(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !ul(e) && o !== null) {
    ...
    if (c || w) {
      const [g, m] = pl(t), p = l.is(d), f = e.is(s ? d : l), x = e.is(s ? l : d);
      let v, D = 0;
      p ? (D = g > m ? m : g, v = g > m ? g : m) : f ? (D = s ? m : g, v = void 0) : x && (D = 0, v = s ? g : m);
      const _ = e.__text.slice(D, v);
      _ !== e.__text && (r === "clone" && (e = gl(e)), e.__text = _);
    }
  }
  return e;
}
...
function ad(t, e, r) {
  ...
  function d() {
    ...
    var f, x;
    l.isConnected || (x = l, (f = n).insertBefore(x, f.firstChild));
    let v = !1;
    for (let D = 0; D < p.length; D++) {
      const _ = p[D], z = s[D] || document.createElement("div"), C = z.style;
      C.position !== "absolute" && (C.position = "absolute", v = !0);
      const N = de(_.left - g);
      C.left !== N && (C.left = N, v = !0);
      const E = de(_.top - m);
      C.top !== E && (z.style.top = E, v = !0);
      const I = de(_.width);
      C.width !== I && (z.style.width = I, v = !0);
      const y = de(_.height);
      C.height !== y && (z.style.height = y, v = !0), z.parentNode !== l && (l.append(z), v = !0), s[D] = z;
    }
  ...
  const w = t.registerRootListener(function g() {
    ...
    c(), o = m, n = p, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return g();
      for (const D of f) if (!l.contains(D.target)) return d();
    }), i.observe(p, rd), d();
  });
  return () => {
    w(), c();
...
function nd(t, e = od) {
  ...
  function c(w) {
    w.read(() => {
      ...
      const [m, p] = function(y) {
        const b = y.getStartEndPoints();
        return y.isBackward() ? [b[1], b[0]] : b;
      }(g), f = m.getNode(), x = f.getKey(), v = m.offset, D = p.getNode(), _ = D.getKey(), z = p.offset, C = t.getElementByKey(x), N = t.getElementByKey(_), E = r === null || C !== o || v !== n || x !== r.getKey(), I = i === null || N !== s || z !== l || _ !== i.getKey();
      if ((E || I) && C !== null && N !== null) {
        const y = function(b, S, M, F, K, L, q) {
          const $ = (b._window ? b._window.document : document).createRange();
          return $.setStart(...en(S, M, F)), $.setEnd(...en(K, L, q)), $;
        }(t, m, f, C, p, D, N);
        d(), d = ad(t, y, e);
      }
      r = f, o = C, n = v, i = D, s = N, l = z;
    });
  }
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(f)) {
                const x = f.anchor;
                let v = x.getNode(), D = 0, _ = 0;
                if (ea(v) && c >= 0 && w >= 0 && (D = c, _ = c + w, f.setTextNodeRange(v, D, v, _)), D === _ && g === "" || (f.insertRawText(g), v = x.getNode()), ea(v)) {
                  D = m, _ = m + p;
                  const z = v.getTextContentSize();
                  D = D > z ? z : D, _ = _ > z ? z : _, f.setTextNodeRange(v, D, v, _);
                }
...
function Up({
  ...
  const [i, s] = T(sw), [l, d] = T(n), [c, w] = T(!1), g = U(void 0), m = U(null);
  X(() => {
    let v = !0;
    const D = m.current;
    if (!D) return;
  ...
  const p = j(() => {
    ...
    const v = ia(i);
    e(v, l);
  }, [i, e, l]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", x = o["%commentEditor_assignTo_label%"] ?? "Assign to";
...
const Kp = Object.freeze([
  ...
  const n = U(null), [i, s] = T(void 0), [l, d] = T(void 0), c = j(
    (p) => {
      s(p);
    ...
    (p) => {
      var I;
      const f = p.target, x = (y) => y ? document.getElementById(y) : void 0, v = x(l), D = x(i);
      if (!!(v && f && v.contains(f) && f !== v) && g(f)) {
        ...
        if (p.key === "ArrowDown" || p.key === "ArrowUp") {
          ...
          const b = y.findIndex((M) => M === f);
          if (b === -1) return;
          let S;
          p.key === "ArrowDown" ? S = Math.min(b + 1, y.length - 1) : S = Math.max(b - 1, 0), S !== b && (p.preventDefault(), p.stopPropagation(), (I = y[S]) == null || I.focus());
          return;
        }
        return;
      }
      ...
      switch (p.key) {
        case "ArrowDown":
          N = Math.min(C + 1, t.length - 1), p.preventDefault();
          break;
        case "ArrowUp":
          N = Math.max(C - 1, 0), p.preventDefault();
          break;
        case "Home":
...
function gn({
  ...
  }, [t.date, r]), v = B(() => t.user, [t.user]), D = B(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), _ = B(() => zs(t.contents), [t.contents]), z = B(() => {
    if (o && l)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          Je,
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(gw, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(hw, { className: "tw:text-xs tw:font-medium", children: D }) }),
...
function kw({
  ...
  canUserEditOrDeleteCommentCallback: z,
  isRead: C = !1,
  autoReadDelay: N = 5,
  onVerseRefClick: E,
  initialAssignedUser: I
}) {
  const [y, b] = T(hn), [S, M] = T(), [F, K] = T(), L = o, [q, $] = T(!1), [W, pt] = T(!1), [_t, $t] = T(!1), [tt, Rt] = T(!1), [G, ot] = T(!1), [it, st] = T(C), [lt, Vt] = T(!1), vt = U(void 0), [Wt, Yt] = T(/* @__PURE__ */ new Map());
  X(() => {
    let R = !0;
    return (async () => {
      const gt = _ ? await _(d) : !1;
      R && ot(gt);
    })(), () => {
      R = !1;
    };
  ...
  X(() => {
    ...
    O.current === "idle" && (O.current = "pending"), tt ? O.current === "pending" && I !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    I !== i && (M(I), O.current = "auto-populated") : O.current === "auto-populated" && (M(void 0), O.current = "pending");
  }, [o, I, tt, i]);
  const Ot = B(() => e.filter((R) => !R.deleted), [e]);
  X(() => {
    let R = !0;
    if (!o || !z) {
      Yt(/* @__PURE__ */ new Map());
  ...
  }, [i, r]), P = B(() => Ot.slice(1), [Ot]), Y = B(() => P.length ?? 0, [P.length]), ct = B(() => Y > 0, [Y]), nt = B(() => q || Y <= 2 ? P : P.slice(-2), [P, Y, q]), ht = B(() => q || Y <= 2 ? 0 : Y - 2, [Y, q]), xt = B(
  ...
  const ft = j(
    ...
    async (R) => {
      const ut = ae(y) ? ia(y) : void 0, gt = R.status ? R.assignedUser : S ?? R.assignedUser, kt = await g({
        ...R,
        contents: ut,
        assignedUser: gt
      });
            ...
            o && /* @__PURE__ */ u(at, { children: [
              ht > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  tabIndex: 0,
                  onKeyDown: (R) => {
                    (R.key === "Enter" || R.key === " ") && (R.preventDefault(), R.stopPropagation(), $(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(wr, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ...
              v !== !1 && (!W || ae(y)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (R) => {
                    ko(R) && (R.preventDefault(), R.stopPropagation(), (ae(y) || S !== void 0 && S !== F) && ft());
                  },
                  onKeyDown: (R) => {
                      ...
                      /* @__PURE__ */ u(Ne, { open: _t, onOpenChange: $t, children: [
                        ...
                        /* @__PURE__ */ a(
                          _e,
                          {
                            ...
                            children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(Re, { children: x == null ? void 0 : x.map((R) => /* @__PURE__ */ a(
                              ke,
                              {
                                onSelect: () => {
                                  M(R !== i ? R : void 0), O.current = "user-selected", K(void 0), $t(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function Qp({
  ...
  const [D, _] = T(/* @__PURE__ */ new Set()), [z, C] = T(), [N, E] = T(), I = j(
    async ($) => {
      const W = await i($);
...
function $w({
  ...
  var E;
  const [w, g] = T([]), [m, p] = T([]), [f, x] = T({}), [v, D] = T({}), _ = B(() => e ?? [], [e]), z = Zn({
    data: _,
    columns: t,
    getCoreRowModel: ti(),
  ...
  }), C = z.getVisibleFlatColumns();
  let N;
  return d ? N = Array.from({ length: 10 }).map((b, S) => `skeleton-row-${S}`).map((b) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((E = z.getRowModel().rows) == null ? void 0 : E.length) > 0 ? N = z.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(I, z),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((y) => /* @__PURE__ */ a(cr, { children: zr(y.column.columnDef.cell, y.getContext()) }, y.id))
    },
    I.id
  )) : N = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: c }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    n && /* @__PURE__ */ a(Nw, { table: z }),
    /* @__PURE__ */ u(_o, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Co, { stickyHeader: i, children: z.getHeaderGroups().map((I) => /* @__PURE__ */ a(Ve, { children: I.headers.map((y) => /* @__PURE__ */ a(sa, { className: "tw:p-0", children: y.isPlaceholder ? void 0 : zr(y.column.columnDef.header, y.getContext()) }, y.id)) }, I.id)) }),
      /* @__PURE__ */ a(Eo, { children: N })
    ] }),
...
function Lw({ row: t, mode: e, strings: r, onClick: o, onOpen: n }) {
  const [i, s] = T(!1), l = U(null), d = !!(t.language || t.languageCode), c = d || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = j(() => {
    if (c) {
      s(!0);
      return;
    }
  ...
  }, [c]), g = /* @__PURE__ */ a(Be, { className: h("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let m;
...
function Bw(t) {
  const [e, r] = T(!1), [o, n] = T(""), [i, s] = T(t.defaultGroupByOpenTabs ?? !0), [l, d] = T(!1), c = Aw(t.localizedStrings), w = B(() => t.mode === "project" ? Ta({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    let E = w;
    return N && (E = E.filter(
      (I) => I.shortName.toLowerCase().includes(N) || I.fullName.toLowerCase().includes(N) || (I.language ?? "").toLowerCase().includes(N) || (I.languageCode ?? "").toLowerCase().includes(N)
    )), t.mode === "project-multi" && l && (E = E.filter((I) => I.isSelected)), E;
  }, [w, o, t.mode, l]), m = B(
    () => Ow(g, i),
    [g, i]
  ), p = B(() => {
    ...
    return t.projects.forEach((E) => {
      const I = t.openTabs.filter((b) => b.projectId === E.id);
      if (I.length === 0) {
      ...
      I.forEach((b) => {
        y.has(b.scrollGroupId) || (y.add(b.scrollGroupId), N.push({ projectId: E.id, scrollGroupId: b.scrollGroupId }));
      });
    }), N;
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const E = t.selection.pairs, I = (b) => b.projectId === N.projectId && b.scrollGroupId === N.scrollGroupId, y = E.some(I) ? E.filter((b) => !I(b)) : [...E, { projectId: N.projectId, scrollGroupId: N.scrollGroupId }];
    ...
    if (t.mode !== "project-multi") return;
    const N = t.selection.pairs, E = new Set(N.map((y) => `${y.projectId}:${y.scrollGroupId ?? ""}`)), I = [...N];
    p.forEach((y) => {
      const b = `${y.projectId}:${y.scrollGroupId ?? ""}`;
      E.has(b) || (E.add(b), I.push(y));
    }), t.onChangeSelection({ pairs: I });
  }, D = () => {
    t.mode === "project-multi" && (t.onChangeSelection({ pairs: [] }), l && d(!1));
  }, _ = B(() => {
    switch (t.mode) {
      case "project": {
        const N = t.projects.find((I) => I.id === t.selection.projectId), E = N ? N.shortName : t.buttonPlaceholder ?? "";
      ...
      case "project-multi": {
        ...
        const I = E.map(
          ({ project: b, scrollGroupId: S }) => S === void 0 ? b.shortName : `${b.shortName} (${$r(S)})`
        ).join(", ");
        if (E.length === 1) return { node: I, title: I };
        const y = E.length.toString();
        return {
          node: /* @__PURE__ */ u(at, { children: [
            /* @__PURE__ */ a(De, { variant: "muted", className: "tw:shrink-0", children: y }),
            /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:truncate", children: I })
          ] }),
          title: `${y} ${I}`
        };
      }
      case "projectScrollGroup": {
        const N = t.projects.find((y) => y.id === t.selection.projectId);
        if (!N) {
        ...
        const I = `${N.shortName} · ${$r(E)}`;
        return { node: I, title: I };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t]), z = t.mode === "project-multi" ? /* @__PURE__ */ a(oo, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : /* @__PURE__ */ a(Ze, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }), C = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? f : void 0;
  return /* @__PURE__ */ u(Ne, { open: e, onOpenChange: r, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(
      V,
      {
        ...
        children: [
          /* @__PURE__ */ a("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof _.node == "string" ? /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:truncate", children: _.node }) : _.node }),
          z
        ]
      }
    ) }),
      ...
      _e,
      {
        ...
        children: /* @__PURE__ */ a(Ut, { delayDuration: 400, children: /* @__PURE__ */ u($e, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: v, children: `${c.selectAll} (${p.length.toString()})` }),
            /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: D, children: `${c.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ u(Re, { children: [
            /* @__PURE__ */ a(Mr, { children: t.commandEmptyMessage ?? "No projects found" }),
            m.map((N, E) => /* @__PURE__ */ u(eo, { children: [
              /* @__PURE__ */ a(he, { heading: Fw(N, c), children: N.rows.map((I) => /* @__PURE__ */ a(
                Lw,
                {
                  row: I,
                  mode: t.mode,
...
function Hw({
  ...
  const [D, _] = T(!1), z = j(
    (S) => {
      var F;
      const M = (F = t.find((K) => K.label === S)) == null ? void 0 : F.value;
      M && r(
    ...
    if (!m) return t;
    const S = t.filter((F) => F.starred).sort((F, K) => F.label.localeCompare(K.label)), M = t.filter((F) => !F.starred).sort((F, K) => {
  ...
  return /* @__PURE__ */ a("div", { id: v, className: f, children: /* @__PURE__ */ u(Ne, { open: y, onOpenChange: w ?? _, children: [
    /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(
      V,
      {
        variant: x,
    ...
    /* @__PURE__ */ a(_e, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u($e, { children: [
      ...
      /* @__PURE__ */ u(Re, { children: [
        ...
        /* @__PURE__ */ a(he, { children: N.map((S) => /* @__PURE__ */ u(
          ke,
          {
            value: S.label,
            onSelect: z,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ a(Js, { className: "tw:h-4 tw:w-4" }),
...
function Zw({
  ...
  const i = U(null), s = U(null), l = U(!1), [d, c] = T(t), [w, g] = T(r), [m, p] = T(!1);
  X(() => {
    c(t);
  }, [t]), X(() => {
    w !== r && g(r);
  ...
  const f = (v) => {
    ...
    var D, _, z, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((D = i.current) == null || D.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((_ = s.current) == null || _.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((z = i.current) == null ? void 0 : z.selectionStart) === 0 && ((C = s.current) == null || C.focus(), l.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ue,
            {
              ...
              onClick: (v) => {
                var D;
                v.stopPropagation(), l.current = !0, (D = i.current) == null || D.focus();
              },
...
function wg({
  ...
  const [f, x] = T("generated"), [v, D] = T("generated"), [_, z] = T("*"), [C, N] = T("*"), [E, I] = T("f"), [y, b] = T(!1), [S, M] = T(!0), [F, K] = T(!1), L = U(!1), q = U(""), [$, W] = T(!1), [pt, _t] = T(), [$t, tt] = T(), [Rt, G] = T(), [ot, it] = T(), st = U(null), lt = B(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  X(() => {
    ...
    if (Y && Gr("note", Y)) {
      ...
      let xt = "custom";
      ht === Va ? xt = "generated" : ht === Ba ? xt = "hidden" : ht && (z(ht), N(ht)), x(xt), D(xt), I(((nt = Y.insert.note) == null ? void 0 : nt.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const Ot = () => {
    ...
    (P) => {
      ...
      if (Y && Gr("note", Y)) {
        ...
        M(JSON.stringify(Y) === q.current), vt(f, _);
      } else
        b(!1), M(!0);
    },
    [f, _, vt]
    ...
    if (m.current && Vt.length && P && P.rangeCount > 0) {
      const Y = P.getRangeAt(0).getBoundingClientRect(), ct = m.current.getBoundingClientRect();
      _t(Y.left - ct.left), tt(Y.top - ct.top), G(Y.height), W(!0);
    }
  }, [Vt, m]);
  X(() => {
    const P = () => {
    ...
    var P;
    $ && ((P = st.current) == null || P.focus());
  }, [$]), X(() => {
    var ct;
    const P = ((ct = g.current) == null ? void 0 : ct.querySelector(".editor-input")) ?? void 0, Y = (nt) => {
      !$ && P && document.activeElement === P && nt.key === l ? (nt.preventDefault(), Jt()) : $ && nt.key === "Escape" && (nt.preventDefault(), W(!1));
    };
...
function pg({
  ...
  const w = d ?? Ds(r, void 0), g = (_, z) => {
    c == null || c(_, z, n);
  }, m = i ? r.findIndex((_) => _ === i) : -1, [p, f] = T(m), x = (_, z, C) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), c == null || c(z, C, n);
          break;
      }
  }, v = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), f((z) => Math.min(z + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), f((z) => Math.max(z - 1, 0));
          break;
      }
  }, D = U([]);
  return X(() => {
    var _;
    p >= 0 && p < D.current.length && ((_ = D.current[p]) == null || _.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function yg({
  ...
  const p = ce(r, "%webView_inventory_all%"), f = ce(r, "%webView_inventory_approved%"), x = ce(r, "%webView_inventory_unapproved%"), v = ce(r, "%webView_inventory_unknown%"), D = ce(r, "%webView_inventory_scope_currentBook%"), _ = ce(r, "%webView_inventory_scope_chapter%"), z = ce(r, "%webView_inventory_scope_verse%"), C = ce(r, "%webView_inventory_filter_text%"), N = ce(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = ce(r, "%webView_inventory_no_results%"), [I, y] = T(!1), [b, S] = T("all"), [M, F] = T(""), [K, L] = T([]), q = B(() => {
    const G = t ?? [];
  ...
  }, [I, q]), W = B(() => $.length === 0 ? [] : mu($, b, M), [$, b, M]), pt = B(() => {
    var it, st;
    if (!I) return d;
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(ur, { onValueChange: (G) => $t(G), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(hr, { children: [
          ...
          /* @__PURE__ */ a(ie, { value: "chapter", children: _ }),
          /* @__PURE__ */ a(ie, { value: "verse", children: z })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Or,
...
function yu({
  ...
  const [d, c] = rt.useState(t), w = e ?? d, g = rt.useCallback(
    (z) => {
      const C = typeof z == "function" ? z(w) : z;
      r ? r(C) : c(C);
    },
    [r, w]
  ), m = rt.useCallback(() => g((z) => !z), [g]), p = w ? "expanded" : "collapsed", v = bt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", D = rt.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return /* @__PURE__ */ a(Fi.Provider, { value: D, children: /* @__PURE__ */ a(
    "div",
    {
...
function Ag({
  ...
  const [c, w] = T([]), [g, m] = T([{ id: je, desc: !1 }]), [p, f] = T({}), x = B(
  ...
  X(() => {
    if (l) {
      const b = D.getSelectedRowModel().rowsById, S = Object.keys(b);
      if (S.length === 1) {
        const M = x.find((F) => En(F) === S[0]) || void 0;
        M && l(M);
      }
    }
  }, [p, x, l, D]);
  const _ = n ?? Ru, z = i ?? Gi, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${_}`, value: [je] },
    { label: `Group by ${z}`, value: [Ye] },
    {
      label: `Group by ${_} and ${z}`,
      value: [je, Ye]
    },
    {
      label: `Group by ${z} and ${_}`,
      value: [Ye, je]
    }
  ], N = (b) => {
    w(JSON.parse(b));
  ...
  }, I = (b, S) => b.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), y = (b, S, M) => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(_o, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Co, { children: D.getHeaderGroups().map((b) => /* @__PURE__ */ a(Ve, { children: b.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(sa, { colSpan: S.colSpan, className: "tw:sticky top-0", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          zr(S.column.columnDef.header, S.getContext())
        ] }) }, S.id)
      )) }, b.id)) }),
      /* @__PURE__ */ a(Eo, { children: D.getRowModel().rows.map((b, S) => {
        const M = bt();
        return /* @__PURE__ */ a(
          Ve,
          {
...
function ju({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: m, ntLong: p, dcLong: f, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, D] = T(!1), [_, z] = T(""), C = U(void 0), N = U(!1);
  ...
  const E = B(() => wt.allBookIds.filter(
    ...
    (L, q = !1) => {
      ...
      const $ = E.findIndex((tt) => tt === C.current), W = E.findIndex((tt) => tt === L);
      if ($ === -1 || W === -1) return;
      const [pt, _t] = [
        Math.min($, W),
        Math.max($, W)
      ], $t = E.slice(pt, _t + 1).map((tt) => tt);
      r(
    ...
    y(L, N.current), N.current = !1;
  }, S = (L, q) => {
    L.preventDefault(), y(q, L.shiftKey);
  }, M = j(
    (L) => {
      const q = So(E, L).map(($) => $);
      r(
        Ui(E, L, e) ? e.filter(($) => !q.includes($)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, r, E]
  ), F = () => {
            ...
            $e,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: K, children: c })
                ] }),
                /* @__PURE__ */ u(Re, { children: [
...
function jg({
  ...
  const C = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), N = St(s, "%webView_scope_selector_verse%"), E = St(s, "%webView_scope_selector_chapter%"), I = St(s, "%webView_scope_selector_book%"), y = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), b = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), S = St(s, "%webView_scope_selector_current_book%"), M = St(s, "%webView_scope_selector_choose_books%"), F = St(s, "%webView_scope_selector_scope%"), K = St(s, "%webView_scope_selector_select_books%"), L = St(s, "%webView_scope_selector_range%"), q = St(s, "%webView_scope_selector_select_range%"), $ = St(s, "%webView_scope_selector_range_start%"), W = St(s, "%webView_scope_selector_range_end%"), pt = St(s, "%webView_scope_selector_ok%"), _t = St(s, "%webView_scope_selector_cancel%"), $t = St(s, "%webView_scope_selector_navigate%"), tt = (A) => {
    if (!f) return;
  ...
  ] }), ot = e ? Rt.filter((A) => e.includes(A.value)) : Rt, it = f ?? fa, st = w ?? it, lt = g ?? it, Vt = () => {
    ...
    [r, n, f, i]
  ), nt = ot.find((A) => A.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Rs(st, lt, {
  ...
  ), yt = ot.find((A) => A.value === "selectedBooks"), ft = ot.find((A) => A.value === "range"), [Ct, R] = T(!1), [ut, gt] = T(void 0), [kt, Ke] = T(void 0), [Pe, br] = T(void 0), [qe, xr] = T(void 0), [yr, Ar] = T([]), Pr = c === "dropdown" && ut === "selectedBooks", k = /* @__PURE__ */ a(
    ju,
    {
      availableBookInfo: o,
  ...
  const Io = j(
    (A) => {
      Ke(A), br(st), xr(lt), Ar(n), R(!1), gt(A);
    },
    [st, lt, n]
  ), Do = j(() => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      c === "dropdown" ? /* @__PURE__ */ u(me, { open: Ct, onOpenChange: R, children: [
        ...
        /* @__PURE__ */ a(
          be,
          {
            ...
            children: /* @__PURE__ */ u(ma, { container: Lr, children: [
              xt.map(({ value: A, label: J, dropdownLabel: Ft, scrRefSuffix: Nr, id: as }) => /* @__PURE__ */ u(
                Je,
                {
                  ref: mt(A),
        ...
        ci,
        {
          ...
          children: ot.map(({ value: A, label: J, scrRefSuffix: Ft, id: Nr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ha, { className: "tw:me-2", value: A, id: Nr }),
            /* @__PURE__ */ a(Et, { htmlFor: Nr, children: G(J, Ft) })
          ] }, Nr))
        }
      )
    ] }),
      ...
      Ua,
      {
        ...
        children: /* @__PURE__ */ u(ma, { container: jr, children: [
          ...
          /* @__PURE__ */ u(Yo, { children: [
            /* @__PURE__ */ a(V, { variant: "outline", onClick: () => Vr(!1), children: _t }),
  ...
  if (hc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (D = d.current) == null || D.focus(), Cr(d, [m, p]);
        break;
    }
  }), X(() => {
...
function Wg({
  ...
  const c = Zu(
    ...
    var D, _, z, C, N, E;
    const v = x !== f ? ((_ = (D = t[f]) == null ? void 0 : D.uiNames) == null ? void 0 : _[x]) ?? ((C = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : C.en) : void 0;
