...
import lt, { useRef as K, useMemo as B, useState as y, useImperativeHandle as Ls, useCallback as L, useEffect as W, useLayoutEffect as Ht, createContext as Ka, useContext as pn, Component as Fs, createElement as bo, Suspense as js, forwardRef as ea, Fragment as hn } from "react";
...
function ha({
  ...
  const _ = Ut(), [V, q] = y(!1), [I, R] = y(""), [z, C] = y(""), [D, S] = y("books"), [$, X] = y(void 0), [F, M] = y(
    void 0
  ), [Y, ft] = y(void 0), [dt, qt] = y(!1), Dt = K(null), It = K(!1), j = K(void 0), Q = K(void 0), tt = K(void 0), nt = K(void 0), mt = K({}), Yt = K({});
  Ls(
    N,
    () => ({
      open: () => {
  ...
  const $t = L(() => {
    ...
    q(b), b && (S("books"), X(void 0), M(void 0), ft(void 0), C(""));
  }, []), { otLong: gt, ntLong: yt, dcLong: vt, extraLong: wt } = {
    ...
    (b) => {
      ...
      if (D === "verses" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), at();
        return;
      }
  ...
  return Ht(() => {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ee, { open: V, onOpenChange: ot, modal: v, children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ref: Dt,
    ...
    /* @__PURE__ */ a(
      Te,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: G } = b;
          V && Dt.current && G instanceof Node && Dt.current.contains(G) && (It.current = !0, ot(!1));
        },
        onCloseAutoFocus: x,
        children: /* @__PURE__ */ u(
          Ve,
          {
            ...
            children: [
              ...
              !dt && /* @__PURE__ */ u(Ie, { ref: tt, children: [
                D === "books" && /* @__PURE__ */ u(et, { children: [
                  ...
                  O && De && O.chapterNum && d && /* @__PURE__ */ u(et, { children: [
                  ...
                  O && !De && Br(O.book) > 1 && /* @__PURE__ */ u(et, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
...
function So({
  ...
  const [k, _] = y(!1), V = d ?? l, q = (R) => R.length > 0 && typeof R[0] == "object" && "options" in R[0], I = (R, z) => {
    ...
    /* @__PURE__ */ a(
      Te,
      {
        ...
        children: /* @__PURE__ */ u(Ve, { children: [
          ...
          /* @__PURE__ */ a(Ie, { children: q(e) ? e.map((R) => /* @__PURE__ */ a(le, { heading: R.groupHeading, children: R.options.map((z) => I(z, R.groupHeading)) }, R.groupHeading)) : /* @__PURE__ */ a(le, { children: e.map((R) => I(R)) }) })
        ] })
      }
    )
  ] });
...
function yl() {
  return function(t) {
    const [e] = he(), r = B(() => t(e), [e, t]), [o, n] = y(() => r.initialValueFn()), i = K(o);
    return bl(() => {
...
function Tl(t, e = El) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), m = f.getNode(), x = m.getKey(), v = f.offset, T = g.getNode(), N = T.getKey(), k = g.offset, _ = t.getElementByKey(x), V = t.getElementByKey(N), q = r === null || _ !== o || v !== n || x !== r.getKey(), I = i === null || V !== s || k !== c || N !== i.getKey();
...
function Vl(t) {
  ...
  Ln(this), rt = t, this.f &= -2, 8 & this.f && Za(this), aa();
}
function Ze(t, e) {
...
Pt.prototype.brand = Ml, Pt.prototype.h = function() {
  ...
  return rt = t, Ln(this), this.f &= -2, !0;
...
function od({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    eo(() => Ne($c(n), Jn(n)), [n]);
  }(o), u(et, { children: [t, a(nd, { content: e }), a(ad, { editor: o, ErrorBoundary: r })] });
}
...
function ud(t, e) {
  ...
  return u(et, { children: [a(dd, { editor: n, ...o, ref: e }), r != null && a(pd, { editor: n, content: r })] });
}
...
function ju({
  ...
  const [i, s] = y(Ed), [c, l] = y(n), [d, w] = y(!1), p = K(void 0), f = K(null);
  W(() => {
    let v = !0;
    const T = f.current;
    if (!T) return;
...
function Rd({
  ...
  const [R, z] = y(Uo), [C, D] = y(), [S, $] = y(), X = o, [F, M] = y(!1), [Y, ft] = y(!1), [dt, qt] = y(!1), [Dt, It] = y(!1), [j, Q] = y(!1), [tt, nt] = y(_), [mt, Yt] = y(!1), it = K(void 0), [Rt, Ct] = y(/* @__PURE__ */ new Map());
  W(() => {
    let E = !0;
    return (async () => {
  ...
  const O = B(() => Bt[0], [Bt]), ae = K(null), $t = K(void 0), Mt = L(() => {
    var E;
  ...
  }, [i, r]), P = B(() => Bt.slice(1), [Bt]), H = B(() => P.length ?? 0, [P.length]), at = B(() => H > 0, [H]), ot = B(() => F || H <= 2 ? P : P.slice(-2), [P, H, F]), gt = B(() => F || H <= 2 ? 0 : H - 2, [H, F]), yt = B(
      ...
      Td,
      {
        ...
        children: /* @__PURE__ */ u(zd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          ...
          /* @__PURE__ */ u(et, { children: [
            at && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              ot.map((E) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                jo,
                {
                  comment: E,
                  localizedStrings: r,
...
function Xu({
  ...
  const [T, N] = y(/* @__PURE__ */ new Set()), [k, _] = y(), [V, q] = y(), I = L(
    async (M) => {
      const Y = await i(M);
      return Y !== void 0 && M.assignedUser !== void 0 && M.assignedUser !== "" && q(M.assignedUser), Y;
    },
    [i]
  );
  W(() => {
...
function Fd({
  ...
  let V;
  return l ? V = Array.from({ length: 10 }).map((z, C) => `skeleton-row-${C}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Jt, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Ta, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((q = k.getRowModel().rows) == null ? void 0 : q.length) > 0 ? V = k.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ne,
    {
      onClick: () => s(I, k),
...
function op({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ye, { children: [
    ...
    /* @__PURE__ */ a(_e, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(rn, { children: d.itemType === 0 ? /* @__PURE__ */ a(et, { children: d.items.map((p, f) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Me,
        {
          checked: o[w][f],
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Ee, { open: R, onOpenChange: w ?? N, children: [
    ...
    /* @__PURE__ */ a(Te, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ve, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(U, { variant: "ghost", size: "sm", onClick: q, children: i }),
...
const Wd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(et, { children: [
...
function Xd({
  ...
  const i = K(null), s = K(null), c = K(!1), [l, d] = y(t), [w, p] = y(r), [f, g] = y(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
...
const Jd = (t, e) => t === "f" ? /* @__PURE__ */ u(et, { children: [
  /* @__PURE__ */ a(wn, {}),
  " ",
...
function lp({
  ...
  const w = K(null), p = K(null), f = K(null), g = K(null);
  Ht(() => {
    if (!g.current) return;
    const { width: P } = g.current.getBoundingClientRect();
    P > 0 && (g.current.style.width = `${P}px`);
  }, []);
  const [m, x] = y("generated"), [v, T] = y("generated"), [N, k] = y("*"), [_, V] = y("*"), [q, I] = y("f"), [R, z] = y(!1), [C, D] = y(!0), [S, $] = y(!1), X = K(!1), F = K(""), [M, Y] = y(!1), [ft, dt] = y(), [qt, Dt] = y(), [It, j] = y(), [Q, tt] = y(), nt = K(null), mt = B(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (H && Ar("note", H)) {
      const gt = (at = H.insert.note) == null ? void 0 : at.caller;
      let yt = "custom";
      gt === Ma ? yt = "generated" : gt === Oa ? yt = "hidden" : gt && (k(gt), V(gt)), x(yt), T(yt), I(((ot = H.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var vt;
  ...
  const it = L(
    (P, H, at = !1) => {
      ...
      if (ot && Ar("note", ot)) {
        if (ot.insert.note) {
          let wt;
          P === "custom" ? wt = H : P === "generated" ? wt = Ma : wt = Oa, ot.insert.note.caller = wt;
        }
        r == null || r([ot]), at && d && i && ((vt = d.current) == null || vt.replaceEmbedUpdate(i, [ot]));
      }
    },
    [i, r, d]
  ), Rt = L(() => {
  ...
  const xt = K({ book: n.book, chapterNum: n.chapterNum });
  Ht(() => {
  ...
  const Bt = () => {
    ...
    var at, ot, gt, yt, vt;
    I(P);
    const H = (ot = (at = w.current) == null ? void 0 : at.getNoteOps(0)) == null ? void 0 : ot.at(0);
    if (H && Ar("note", H)) {
      H.insert.note && (H.insert.note.style = P);
      const wt = (yt = (gt = H.insert.note) == null ? void 0 : gt.contents) == null ? void 0 : yt.ops;
      q !== "x" && P === "x" ? wt == null || wt.forEach((Nt) => ow(Nt)) : q === "x" && P !== "x" && (wt == null || wt.forEach((Nt) => nw(Nt))), (vt = w.current) == null || vt.applyUpdate([H, { delete: 1 }]);
    }
  }, Mt = (P) => {
    ...
    if (f.current && Yt.length && P && P.rangeCount > 0) {
      const H = P.getRangeAt(0).getBoundingClientRect(), at = f.current.getBoundingClientRect();
      dt(H.left - at.left), Dt(H.top - at.top), j(H.height), Y(!0);
    }
  }, [Yt, f]);
  W(() => {
    const P = () => {
    ...
    var at;
    const P = ((at = p.current) == null ? void 0 : at.querySelector(".editor-input")) ?? void 0, H = (ot) => {
      !M && P && document.activeElement === P && ot.key === c ? (ot.preventDefault(), Lt()) : M && ot.key === "Escape" && (ot.preventDefault(), Y(!1));
    };
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(et, { children: sw(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function bp({
  ...
  const g = se(r, "%webView_inventory_all%"), m = se(r, "%webView_inventory_approved%"), x = se(r, "%webView_inventory_unapproved%"), v = se(r, "%webView_inventory_unknown%"), T = se(r, "%webView_inventory_scope_currentBook%"), N = se(r, "%webView_inventory_scope_chapter%"), k = se(r, "%webView_inventory_scope_verse%"), _ = se(r, "%webView_inventory_filter_text%"), V = se(
    r,
    "%webView_inventory_show_additional_items%"
  ), q = se(r, "%webView_inventory_no_results%"), [I, R] = y(!1), [z, C] = y("all"), [D, S] = y(""), [$, X] = y([]), F = B(() => {
    const j = t ?? [];
    ...
    return /* @__PURE__ */ u(et, { children: [
      ...
      e.map((o) => /* @__PURE__ */ u(
        ne,
        {
          ...
          children: [
            /* @__PURE__ */ a(Jt, { className: "tw:w-5 tw:border-0 tw:py-1 tw:pr-1", children: !r && /* @__PURE__ */ u(et, { children: [
...
function yp({
  ...
  const [s, c] = y(""), [l, d] = y([]), w = B(
    ...
    [t]
  ), N = p.length === 0 && f.length === 0 && g.length === 0, k = fe(n, "%resourcePicker_title%"), _ = fe(n, "%resourcePicker_search_placeholder%"), V = fe(n, "%resourcePicker_language_filter_any%"), q = fe(
    n,
    "%resourcePicker_section_already_selected%"
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !N && !e && /* @__PURE__ */ a(oa, { children: /* @__PURE__ */ u(na, { children: [
        /* @__PURE__ */ a(Na, { label: q, resources: p }),
...
function Vw({
  ...
  }, [x, v] = y(!1), [T, N] = y(""), k = K(void 0), _ = K(!1), V = B(
    () => hi(t),
    [t]
  ), q = B(() => {
    if (!T.trim()) {
...
function Ip({
  ...
  const _ = Tt(
    s,
    "%webView_scope_selector_selected_text%"
  ), V = Tt(s, "%webView_scope_selector_verse%"), q = Tt(s, "%webView_scope_selector_chapter%"), I = Tt(s, "%webView_scope_selector_book%"), R = Tt(
    s,
    "%webView_scope_selector_current_verse%"
  ), z = Tt(
    s,
  ...
  ], j = (A, J, Ft = !1) => /* @__PURE__ */ u(et, { children: [
    A,
  ...
  }, it = K(null), Rt = K(null), Ct = K(!1), xt = K(null), Bt = K(!1), [O, ae] = y(void 0), $t = K(!1), Mt = K(!1), ze = K(null), Lt = L((A) => {
    if (A) {
    ...
    [r, n, m, i]
  ), ot = Q.find((A) => A.value === t), gt = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? Bs(nt, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ot ? j(ot.label, ot.scrRefSuffix) : t, yt = Q.filter(
  ...
  const co = L(
    ...
    kt !== void 0 && (kt === "range" ? (De && (f == null || f(De)), Le && (g == null || g(Le))) : kt === "selectedBooks" && i(We), at(kt), pt(void 0), Se(void 0));
  }, [
    kt,
    De,
    Le,
...
lu(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
