...
var ht = (t, e, n) => ns(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as c, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as tn, useRef as X, useMemo as j, useState as A, useCallback as G, useLayoutEffect as Bt, createContext as yn, useContext as dr, useEffect as U, Component as rs, createElement as Ir, Suspense as os, createRef as as, Fragment as lo } from "react";
import { Command as vt } from "cmdk";
import { X as Me, Search as wo, Check as Dt, Clock as Ar, ChevronsLeft as Pr, ChevronsRight as $r, ChevronLeft as Un, ChevronRight as _e, ArrowLeft as ss, ArrowRight as is, Circle as Nn, ChevronDown as Oe, BoldIcon as ls, ItalicIcon as ws, AtSign as co, Pencil as ds, Trash2 as cs, ArrowUp as po, MoreHorizontal as uo, MailOpen as ps, Mail as us, ChevronUp as mo, FilterIcon as ms, ArrowLeftIcon as fs, ChevronLeftIcon as hs, ChevronRightIcon as gs, ArrowRightIcon as bs, Copy as fo, Filter as vs, User as xs, Link as ys, CircleHelp as Ns, ChevronsUpDown as ho, Star as ks, SquareX as go, FunctionSquare as bo, SquareSigma as vo, AlertCircle as Hn, CircleCheckIcon as _s, CircleXIcon as Cs, CircleHelpIcon as Es, ArrowUpIcon as Ts, ArrowDownIcon as Rs, Ban as Ss, PanelLeft as Ds, PanelRight as Ms, ScrollText as Os, MenuIcon as Is, Menu as As, EllipsisVertical as Ps, LoaderCircle as $s, GripVertical as Ls } from "lucide-react";
...
import { includes as sn, Section as q, getChaptersForBook as zs, formatScrRef as ue, getSectionForBook as Ke, formatRelativeDate as Fs, formatReplacementString as pe, sanitizeHtml as Bs, NumberFormat as Gs, formatBytes as Ks, getCurrentLocale as qs, getFormatCallerFunction as Us, deepEqual as Hs, isString as Lr, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as W, formatScrRefRange as Ys, formatScrRefWithOptionalParts as Xs } from "platform-bible-utils";
import { getLocalizedBookName as su } from "platform-bible-utils";
...
import { createEditor as yo, $getRoot as Qt, $createParagraphNode as kn, $getSelection as Gt, HISTORY_MERGE_TAG as cr, ParagraphNode as No, TextNode as ko, $isTokenOrSegmented as Ws, $getCharacterOffsets as Js, $cloneWithPropertiesEphemeral as Zs, $findMatchingParent as Qs, $isElementNode as me, CLEAR_EDITOR_COMMAND as _o, COMMAND_PRIORITY_EDITOR as Co, $isRangeSelection as We, mergeRegister as te, shallowMergeConfig as ti, defineExtension as qt, safeCast as en, RootNode as ei, LineBreakNode as ni, TabNode as ri, $isEditorState as oi, createCommand as ai, CLICK_COMMAND as si, isDOMNode as ii, $getNodeFromDOMNode as li, $isNodeSelection as wi, $createNodeSelection as di, $setSelection as ci, COMMAND_PRIORITY_LOW as pi, DecoratorNode as ui, addClassNamesToElement as Eo, $create as mi, $getNodeByKey as fi, removeClassNamesFromElement as hi, KEY_TAB_COMMAND as gi, $isBlockElementNode as mn, $createRangeSelection as bi, $normalizeSelection__EXPERIMENTAL as vi, OUTDENT_CONTENT_COMMAND as xi, INDENT_CONTENT_COMMAND as Vr, INSERT_TAB_COMMAND as yi, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as Ni, $isParagraphNode as ki, $isTextNode as fn, SELECTION_CHANGE_COMMAND as To, FORMAT_TEXT_COMMAND as _i, getRegisteredNode as Ci, isHTMLElement as Ei, isDocumentFragment as jr, isDOMDocumentNode as Ti, ArtificialNode__DO_NOT_USE as Ro, $createLineBreakNode as So, $isRootOrShadowRoot as Ri, isBlockDomNode as zr, isInlineDomNode as Fr, $insertNodes as Si } from "lexical";
...
import { useReactTable as Io, getFilteredRowModel as Vi, getSortedRowModel as Ao, getPaginationRowModel as ji, getCoreRowModel as Po, flexRender as qe, getGroupedRowModel as zi, getExpandedRowModel as Fi } from "@tanstack/react-table";
...
const Xi = St.Root, Wi = St.Portal, $o = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
    className: m(
...
$o.displayName = St.Overlay.displayName;
...
Lo.displayName = St.Content.displayName;
...
jo.displayName = St.Title.displayName;
...
Ji.displayName = St.Description.displayName;
...
const Go = ot.allBookIds.filter(
  (t) => !ot.isObsolete(ot.bookIdToNumber(t))
), fe = Object.fromEntries(
  Go.map((t) => [t, ot.bookIdToEnglishName(t)])
);
function fr(t, e, n) {
...
const Ko = tn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: m(qo({ variant: e, size: n, className: t })), ref: s, ...a })
);
V.displayName = "Button";
const re = Ce.Root, oe = Ce.Trigger, Xc = Ce.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = ct();
...
function Qi({
  ...
  return /* @__PURE__ */ c(re, { open: d, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Ht, { children: /* @__PURE__ */ r(Kt, { heading: s, children: t.map((u) => /* @__PURE__ */ c(
      $t,
      {
        onSelect: () => p(u),
...
function Wc(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Gr({
  ...
  if (t)
    return /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Pt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      $t,
      {
        value: `${t} ${fe[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Jc({
  ...
  const w = ct(), [p, u] = A(!1), [h, f] = A(""), [g, v] = A(""), [x, y] = A("books"), [N, C] = A(void 0), [E, z] = A(!1), L = X(void 0), k = X(void 0), T = X(void 0), _ = X(void 0), R = X({}), P = G(
    (O) => {
      e(O), l && l(O);
    },
    [e, l]
  ...
  }), [$]), M = j(() => Object.values(D).flat(), [D]), F = j(() => {
    if (!g.trim()) return D;
    const O = {
      [q.OT]: [],
      [q.NT]: [],
    ...
    (O) => {
      const H = x === "chapters" ? N : S == null ? void 0 : S.book;
      H && (P({
        book: H,
        chapterNum: O,
        verseNum: 1
    ...
    (O) => {
      ...
      if ((x === "chapters" || x === "books" && S) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const Q = x === "chapters" ? N : S == null ? void 0 : S.book;
        if (!Q) return;
        const wt = (() => {
          if (!h) return 1;
          const le = h.match(/(\d+)$/);
  ...
  return Bt(() => {
    const O = setTimeout(() => {
      if (p && x === "books" && T.current && _.current) {
  ...
  }, [x, N, S, t.book, t.chapterNum]), /* @__PURE__ */ c(re, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ r(
      V,
      {
...
), dt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(xo.Root, { ref: n, className: m("pr-twp", rl(), t), ...e }));
dt.displayName = xo.Root.displayName;
    ...
    hr,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(dt, { className: "tw-flex tw-items-center", children: o.map((x) => ot.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            V,
            {
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ll = Ho ? Bt : U, wn = { tag: cr };
function wl({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, w = il(null, o), p = yo({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
        if (h === void 0) u.update(() => {
          ...
          if (f.isEmpty()) {
            const g = kn();
            f.append(g);
            const v = Ho ? document.activeElement : null;
            (Gt() !== null || v !== null && v === u.getRootElement()) && g.select();
          }
        }, wn);
...
const dl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
...
const hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
function gl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function bl() {
  return function(t) {
    const [e] = Lt(), n = j(() => t(e), [e, t]), [o, a] = A(() => n.initialValueFn()), s = X(o);
    return hl(() => {
...
function vl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Ws(e) && o !== null) {
    ...
    if (w || p) {
      const [u, h] = Js(t), f = l.is(d), g = e.is(i ? d : l), v = e.is(i ? l : d);
      let x, y = 0;
...
function Kr(t) {
  const e = Qs(t, (n) => me(n) && !n.isInline());
  return me(e) || xl(4, t.__key), e;
}
...
function Cl(t) {
  ...
  Wo(this), Y = t, this.f &= -2, 8 & this.f && vr(this), Cn();
}
function Ne(t, e) {
...
gt.prototype.brand = Nl, gt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Jo(this), Hr(this), Zt++;
  const t = Y;
  return Y = this, Cl.bind(this, t);
...
qt({ build: (t, e, n) => En(e), config: en({ $onClear: Zo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return ee(() => Qo(t, o.value));
} });
function El(t) {
...
const rr = qt({ build: (t) => ta(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const xr = 0, or = 1, na = 2, Ln = 3, dn = 4, ye = 5, Vn = 6, Fe = 7;
function jn(t) {
  return t.id === xr;
}
function ra(t) {
...
function Tl(t) {
  return function(e) {
    return e.id === or;
  }(t) || J(305, String(t.id), String(or)), Object.assign(t, { id: na });
}
...
const Ml = qt({ config: en({ setOptions: Yr, updateOptions: Yr }), init: ({ $initialEditorState: t = Dl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (oi(s)) t.setEditorState(s, n);
...
class He {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(yo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [Xr]: this });
...
const Il = /* @__PURE__ */ new Set(), Jr = qt({ build(t, e, n) {
  const o = n.getDependency(rr).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ta(() => {
  }, () => ee(() => {
...
qt({ dependencies: [rr, Jr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Jr).output, a = Je({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return te(t.registerCommand(si, (i) => {
    if (ii(i.target)) {
      const l = li(i.target);
    ...
    return !1;
  }, pi), t.registerMutationListener(Ee, (i, l) => {
    kl(() => {
      let d = !1;
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(ee(() => {
      const w = l.value;
      w && (d.value ? Eo(w, s) : hi(w, s));
    }));
    return te(...i);
  }));
} });
function $l(t, e) {
  return te(t.registerCommand(gi, (n) => {
    const o = Gt();
    if (!We(o)) return !1;
    n.preventDefault();
    const a = function(s) {
      if (s.getNodes().filter((u) => mn(u) && u.canIndent()).length > 0) return !0;
      const i = s.anchor, l = s.focus, d = l.isBefore(i) ? l : i, w = d.getNode(), p = Kr(w);
      if (p.canIndent()) {
        const u = p.getKey();
        let h = bi();
    ...
    const o = Gt();
    if (!We(o)) return !1;
    const a = o.getNodes().map((s) => Kr(s).getIndent());
...
const Ll = qt({ name: "@lexical/react/ReactProvider" });
function Vl() {
            ...
            t.update(() => {
              ...
              if (We(g)) {
                ...
                if (fn(x) && w >= 0 && p >= 0 && (y = w, N = w + p, g.setTextNodeRange(x, y, x, N)), y === N && u === "" || (g.insertRawText(u), x = v.getNode()), fn(x)) {
                  ...
                  y = y > C ? C : y, N = N > C ? C : N, g.setTextNodeRange(x, y, x, N);
                }
...
qt({ build: (t, e, n) => En(e), config: en({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ee(() => n.getOutput().disabled.value ? void 0 : sa(t)) });
function Fl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return yr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = r(o, { onError: (h) => n._onError(h), children: r(os, { fallback: null, children: a[w] }) }), u = n.getElementByKey(w);
...
function Kl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Lt();
  return function(a) {
    yr(() => te(Ii(a), sa(a)), [a]);
  }(o), c(st, { children: [t, r(ql, { content: e }), r(Gl, { editor: o, ErrorBoundary: n })] });
}
...
const ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : U;
function Xl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: f, className: g, id: v, role: x = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": E, ...z }, L) {
  const [k, T] = A(t.isEditable()), _ = G((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? t.setRootElement(P) : t.setRootElement(null);
  }, [t]), R = j(() => /* @__PURE__ */ function(...P) {
    return ($) => {
      for (const D of P) typeof D == "function" ? D($) : D != null && (D.current = $);
    };
  }(L, _), [_, L]);
  return ia(() => (T(t.isEditable()), t.registerEditableListener((P) => {
    T(P);
  })), [t]), r("div", { "aria-activedescendant": k ? e : void 0, "aria-autocomplete": k ? n : "none", "aria-controls": k ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": k && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": d, "aria-labelledby": w, "aria-multiline": p, "aria-owns": k ? u : void 0, "aria-readonly": !k || void 0, "aria-required": h, autoCapitalize: f, className: g, contentEditable: k, "data-testid": E, id: v, ref: R, role: x, spellCheck: y, style: N, tabIndex: C, ...z });
}
const Wl = tn(Xl);
function Qr(t) {
  return t.getEditorState().read(aa(t.isComposing()));
...
function Zl(t, e) {
  ...
  return c(st, { children: [r(Wl, { editor: a, ...o, ref: e }), n != null && r(Ql, { editor: a, content: n })] });
}
...
function nw() {
  const [t, e] = A(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Xi, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(Lo, { children: [
      /* @__PURE__ */ r(Vo, { children: /* @__PURE__ */ r(jo, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = G(
    (s, i, l = !1) => {
...
function rw({
  ...
  const [e] = Lt(), [n, o] = A(e), [a, s] = A("paragraph"), [i, l] = nw(), d = () => {
  };
...
function sw() {
  const { activeEditor: t } = wa(), [e, n] = A([]), o = G((a) => {
    if (We(a) || $i(a)) {
      const s = [];
      to.forEach(({ format: i }) => {
  ...
  return ow(o), /* @__PURE__ */ r(
    Nr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: to.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        Ye,
        {
          value: a,
          "aria-label": i,
...
function dw(t, e) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Ro && i.insertAfter(So());
    for (const i of s) {
...
function pa(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && fn(e) && (i = vl(o, e, "clone"));
  const l = me(i) ? i.getChildren() : [], d = Ci(t, i.getType());
  let w;
...
function ep({
  ...
  const [a, s] = A(mw), [i, l] = A(void 0), [d, w] = A(!1), p = X(void 0), u = X(null);
  U(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
          /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
          /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r("p", { children: v }) })
        ] }) }),
        /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
...
const np = Object.freeze([
  ...
  const a = X(null), [s, i] = A(void 0), [l, d] = A(void 0), w = G(
    (f) => {
      i(f);
    ...
    (f) => {
      var k;
      const g = f.target, v = (T) => T ? document.getElementById(T) : void 0, x = v(l), y = v(s);
...
Re.displayName = Oo.Root.displayName;
...
va.displayName = Pe.Root.displayName;
...
xa.displayName = Pe.Fallback.displayName;
const Cr = yn(void 0);
function Ot() {
  const t = dr(Cr);
  if (!t)
...
}), Le = tt.Trigger, ya = tt.Group, _w = tt.Portal, Cw = tt.Sub, Ew = tt.RadioGroup;
...
Na.displayName = tt.SubTrigger.displayName;
...
_a.displayName = tt.RadioItem.displayName;
...
function eo({
  ...
  const f = G(
    (E) => {
      E && E.stopPropagation(), w(!1), u(void 0), i == null || i(!1);
    },
    [i]
  ), g = G(
    async (E) => {
    ...
    [t.user]
  ), N = j(() => Bs(t.contents), [t.contents]), C = j(() => {
    if (o && l)
      return /* @__PURE__ */ c(st, { children: [
        /* @__PURE__ */ c(
          vn,
          {
            onClick: (E) => {
              E.stopPropagation(), w(!0), u(uw(t.contents)), i == null || i(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        C && /* @__PURE__ */ c(ve, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(uo, {}) }) }),
...
function Rw({
  ...
  const [k, T] = A(no), [_, R] = A(
    void 0
  ), P = o, [$, D] = A(!1), [M, F] = A(!1), [S, K] = A(!1), [pt, ut] = A(!1), [Vt, mt] = A(!1), [it, B] = A(E), [at, ft] = A(!1), lt = X(void 0), [yt, ze] = A(/* @__PURE__ */ new Map());
  U(() => {
    let I = !0;
    return (async () => {
  ...
  const Wt = j(() => e.filter((I) => !I.deleted), [e]);
  U(() => {
    let I = !0;
    if (!o || !C) {
      ze(/* @__PURE__ */ new Map());
  ...
  const se = j(() => Wt[0], [Wt]), on = X(null), xe = X(void 0), ie = G(() => {
    var I;
  ...
  }, [s, n]), Z = j(() => Wt.slice(1), [Wt]), Q = j(() => Z.length ?? 0, [Z.length]), wt = j(() => Q > 0, [Q]), jt = j(() => $ || Q <= 2 ? Z : Z.slice(-2), [Z, Q, $]), bt = j(() => $ || Q <= 2 ? 0 : Q - 2, [Q, $]), an = j(
  ...
  return /* @__PURE__ */ r(
    ga,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(ba, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
                    ...
                    /* @__PURE__ */ c(re, { open: S, onOpenChange: K, children: [
                      /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ r(
                        V,
                        {
                          ...
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !pt || !v || v.length === 0 || !v.includes(i),
                      ...
                      /* @__PURE__ */ r(
                        Yt,
                        {
                          ...
                          children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Ht, { children: v == null ? void 0 : v.map((I) => /* @__PURE__ */ r(
                            $t,
                            {
                              onSelect: () => {
                                R(I !== s ? I : void 0), K(!1);
...
function op({
  ...
  const z = n.filter(
    ...
    (D) => {
      N((M) => new Set(M).add(D.id)), E(D.id), v == null || v(D.id);
    },
    [v]
  ), T = G(
    (D) => {
      ...
      }), E(D), v == null || v(M ? void 0 : D);
    },
    [y, v]
  ), { listboxRef: _, activeId: R, handleKeyDown: P } = gw({
    options: L,
    onOptionSelect: k
  }), $ = G(
    (D) => {
      D.key === "Escape" ? (C && y.has(C) && (N((M) => {
        const F = new Set(M);
        return F.delete(C), F;
      }), E(void 0), v == null || v(void 0)), D.preventDefault(), D.stopPropagation()) : P(D);
    },
    [C, y, P, v]
  );
  return /* @__PURE__ */ r(
...
Ca.displayName = rt.ScrollUpButton.displayName;
...
Ea.displayName = rt.ScrollDownButton.displayName;
...
function Fw({
  ...
  var L;
  const [p, u] = A([]), [h, f] = A([]), [g, v] = A({}), [x, y] = A({}), N = j(() => e ?? [], [e]), C = Io({
    data: N,
    columns: t,
    getCoreRowModel: Po(),
  ...
  return d ? z = Array.from({ length: 10 }).map((_, R) => `skeleton-row-${R}`).map((_) => /* @__PURE__ */ r(zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(he, { colSpan: E.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((L = C.getRowModel().rows) == null ? void 0 : L.length) > 0 ? z = C.getRowModel().rows.map((k) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ c(Tn, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Rn, { stickyHeader: s, children: C.getHeaderGroups().map((k) => /* @__PURE__ */ r(zt, { children: k.headers.map((T) => /* @__PURE__ */ r(Qe, { className: "tw-p-0", children: T.isPlaceholder ? void 0 : qe(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
...
function ap({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Bi, { options: s, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(fo, {}) })
        ] }),
...
function ip({
  ...
  return /* @__PURE__ */ c(re, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ c(Yt, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function lp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ c(ve, { children: [
    ...
    /* @__PURE__ */ r(ae, { children: n.map((w, p) => /* @__PURE__ */ c("div", { children: [
      ...
      /* @__PURE__ */ r(ya, { children: w.itemType === 0 ? /* @__PURE__ */ r(st, { children: w.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Ft,
        {
          checked: o[p][h],
...
function Uw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ c(re, { open: T, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(oe, { asChild: !0, children: /* @__PURE__ */ c(
      V,
      {
        variant: v,
        ...
        /* @__PURE__ */ r(Kt, { children: z.map((R) => /* @__PURE__ */ c(
          $t,
          {
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r(ks, { className: "tw-h-4 tw-w-4" }),
...
const Hw = (t, e, n) => t === "generated" ? /* @__PURE__ */ c(st, { children: [
...
function Yw({
  ...
  const s = X(null), i = X(null), l = X(!1), [d, w] = A(t), [p, u] = A(n), [h, f] = A(!1);
  U(() => {
    w(t);
  }, [t]), U(() => {
    p !== n && u(n);
  ...
  const g = (x) => {
    ...
    var y, N, C, E;
    x.stopPropagation(), document.activeElement === i.current && x.key === "ArrowDown" || x.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && x.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && x.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((E = i.current) == null || E.focus(), l.current = !1), d === "custom" && x.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ c(ve, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Hw(t, a, n) }) }) }),
...
const Xw = (t, e) => t === "f" ? /* @__PURE__ */ c(st, { children: [
  /* @__PURE__ */ r(bo, {}),
  " ",
...
function Jw({
  ...
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
      /* @__PURE__ */ r(Di, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Xw(t, n) }) }) }),
      /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r("p", { children: Ww(t, n) }) })
    ] }) }),
...
function pp({
  ...
  const d = X(null), w = as(), [p, u] = A("generated"), [h, f] = A("*"), [g, v] = A("f"), [x, y] = A(!1), N = j(
    () => ({
      ...i,
  ...
  U(() => {
    ...
    if (T && ln("note", T)) {
      ...
      let $ = "custom";
      P === Xn ? $ = "generated" : P === Wn ? $ = "hidden" : P && f(P), u($), v(((R = T.insert.note) == null ? void 0 : R.style) ?? "f"), k = setTimeout(() => {
        var D;
  ...
  const C = G(() => {
    ...
    if (T && ln("note", T)) {
      ...
      g !== "x" && k === "x" ? M == null || M.forEach((F) => Zw(F)) : g === "x" && k !== "x" && (M == null || M.forEach((F) => Qw(F))), (D = d.current) == null || D.applyUpdate([T, { delete: 1 }]);
    }
  }, L = (k) => {
    var _, R, P, $, D;
    const T = (R = (_ = d.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : R.at(0);
  ...
  return /* @__PURE__ */ c("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
          /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ c(Tt, { children: [
            /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: E, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(fo, {}) }) }),
  ...
  return /* @__PURE__ */ c(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: ed(t.marker, l, o, w) })
      }
    )
  ] });
}
function mp({
  ...
  const p = d ?? Us(n, void 0), u = (N, C) => {
    w == null || w(N, C, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [f, g] = A(h), v = (N, C, E) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
const sd = (t) => {
  ...
  return e ? e[1] : "";
}, ld = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", yp = Object.freeze([
...
function Np({
  ...
  const f = At(n, "%webView_inventory_all%"), g = At(n, "%webView_inventory_approved%"), v = At(n, "%webView_inventory_unapproved%"), x = At(n, "%webView_inventory_unknown%"), y = At(n, "%webView_inventory_scope_currentBook%"), N = At(n, "%webView_inventory_scope_chapter%"), C = At(n, "%webView_inventory_scope_verse%"), E = At(n, "%webView_inventory_filter_text%"), z = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = At(n, "%webView_inventory_no_results%"), [k, T] = A(!1), [_, R] = A("all"), [P, $] = A(""), [D, M] = A([]), F = j(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : dd(B, a, s);
  }, [t, a, s]), S = j(() => {
    if (k) return F;
    const B = [];
    return F.forEach((at) => {
  ...
  }, [k, F]), K = j(() => S.length === 0 ? [] : wd(S, _, P), [S, _, P]), pt = j(() => {
    var ft, lt;
    if (!k) return d;
        ...
        Se,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ c(be, { children: [
              ...
              /* @__PURE__ */ r(kt, { value: "unapproved", children: v }),
              /* @__PURE__ */ r(kt, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ c(Se, { onValueChange: (B) => Vt(B), defaultValue: i, children: [
...
function _p({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = A(""), a = j(() => {
  ...
  return /* @__PURE__ */ c(Ut, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ c(Ht, { children: [
      ...
      /* @__PURE__ */ r(Kt, { children: a.map((s) => {
        var i;
        return /* @__PURE__ */ c(
          $t,
          {
...
const pd = "16rem", ud = "3rem", Ra = b.createContext(void 0);
function Mn() {
...
const Sa = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), u = e ?? w, h = b.useCallback(
      ...
      [n, u]
    ), f = b.useCallback(() => h((C) => !C), [h]), g = u ? "expanded" : "collapsed", y = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ra.Provider, { value: N, children: /* @__PURE__ */ r(_t, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Da = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Mn();
...
const md = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Mn();
  return /* @__PURE__ */ c(
    V,
    {
...
const xd = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: o,
...
const Nd = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ie : "button",
  {
    ref: a,
...
const _d = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
function Rd({
  ...
  return /* @__PURE__ */ r(
    Da,
    {
      ...
      children: /* @__PURE__ */ c(Oa, { children: [
...
const Jt = "scrBook", Sd = "scrRef", ce = "source", Dd = "details", Md = "Scripture Reference", Od = "Scripture Book", $a = "Type", Id = "Details";
function Ad(t, e) {
  const n = e ?? !1;
  return [
    {
...
}, ao = (t) => `${Pd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Ep({
  sources: t,
  ...
  const [w, p] = A([]), [u, h] = A([{ id: Jt, desc: !1 }]), [f, g] = A({}), v = j(
  ...
  U(() => {
    if (l) {
      ...
      if (R.length === 1) {
        const P = v.find(($) => ao($) === R[0]) || void 0;
        P && l(P);
      }
    }
  }, [f, v, l, y]);
  const N = a ?? Od, C = s ?? $a, E = [
    ...
    !e && /* @__PURE__ */ c(
      Se,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(be, { position: "item-aligned", children: /* @__PURE__ */ r(Dw, { children: E.map((_) => /* @__PURE__ */ r(kt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
...
function $d({
  ...
  return /* @__PURE__ */ r(
    V,
    {
      ...
      onClick: () => o(t),
      className: m(
        La(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Zi(
        t,
...
function Ld({
  ...
  }, [x, y] = A(!1), [N, C] = A(""), E = X(void 0), z = X(!1);
  ...
  const L = j(() => ot.allBookIds.filter(
    ...
    (M) => {
      ...
      n(
        La(L, M, e) ? e.filter((S) => !F.includes(S)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, L]
  ), $ = () => {
            ...
            Ut,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: D, children: w })
                ] }),
                /* @__PURE__ */ c(Ht, { children: [
                  ...
                  Object.values(q).map((M, F) => {
                    ...
                    if (S.length !== 0)
                      return /* @__PURE__ */ c(lo, { children: [
                        ...
                        F < Object.values(q).length - 1 && /* @__PURE__ */ r(zo, {})
                      ] }, M);
                  })
                ] })
              ]
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          be,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(kt, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ c(Tt, { children: [
...
function wr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Is, {}) }) }),
    /* @__PURE__ */ r(ae, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(lo, { children: [
      /* @__PURE__ */ r(ya, { children: /* @__PURE__ */ r(_t, { children: ja(e.groups, e.items, d, t) }) }),
...
function Ip({
  ...
  return /* @__PURE__ */ c(za, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: t,
...
Ga.displayName = xt.Content.displayName;
function Pp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(Fa, { children: [
      /* @__PURE__ */ r(Ba, { children: t.map((l) => /* @__PURE__ */ r(Vd, { value: l.value, children: l.value }, l.key)) }),
...
Ha.displayName = et.SubContent.displayName;
const Ya = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ot();
...
Ya.displayName = et.Content.displayName;
...
Xa.displayName = et.Item.displayName;
...
Fd.displayName = et.CheckboxItem.displayName;
const Bd = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ot();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
...
Bd.displayName = et.RadioItem.displayName;
...
const Be = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Tt, { children: [
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(Wa, {}, `separator-${s}`)), d;
  });
};
function Kd({
  menuData: t,
  ...
  if (qi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(Ka, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ c(jd, { children: [
      /* @__PURE__ */ r(qa, { ref: w(p), children: typeof u == "object" && "label" in u && u.label }),
      /* @__PURE__ */ r(
        Ya,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(_t, { children: Ja(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
function Vp({
  ...
  const w = qd(
    ...
    var y, N, C, E, z, L;
    const x = v !== g ? ((N = (y = t[g]) == null ? void 0 : y.uiNames) == null ? void 0 : N[v]) ?? ((E = (C = t[g]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
  ...
  return /* @__PURE__ */ c("div", { className: "tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none", children: [
    /* @__PURE__ */ c(
      V,
      {
        ...
        children: [
          /* @__PURE__ */ r("span", { className: m({ "tw-me-2": i === "allText" }), children: e ? Ys(t, e, s) : Xs(t, s) }),
          i === "allText" && io(n, o)
        ]
      }
    ),
        ...
        /* @__PURE__ */ c("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": e }), children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ r("div", { className: "tw-p-1", children: /* @__PURE__ */ c(ve, { children: [
              /* @__PURE__ */ r(Le, { className: w, asChild: !0, children: /* @__PURE__ */ r(V, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(uo, {}) }) }),
...
const Yd = tn(({ className: t, ...e }, n) => /* @__PURE__ */ r($s, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
), Wd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Zd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Zd.displayName = "AlertDescription";
const Bp = nt.Root, Gp = nt.Trigger, Kp = nt.Group, qp = nt.Portal, Up = nt.Sub, Hp = nt.RadioGroup, Qd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
const ec = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(nt.Portal, { children: /* @__PURE__ */ r(
  nt.Content,
  {
    ref: n,
    className: m(
...
const rc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
const oc = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: o,
    className: m(
...
const ac = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  nt.Label,
  {
    ref: o,
    className: m(
...
const Yp = Mt.Trigger, wc = Mt.Portal, Xp = Mt.Close, Qa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
...
Qa.displayName = Mt.Overlay.displayName;
const dc = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(Za), i = {
...
uc.displayName = Mt.Title.displayName;
...
mc.displayName = Mt.Description.displayName;
const fc = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Zn.Root,
  {
    ref: o,
    className: m(
...
const hc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ct();
  return /* @__PURE__ */ c(
    Ge.Root,
    {
...
const tu = xt.Root, bc = b.forwardRef(({ className: t, ...e }, n) => {
  const o = ct();
  return /* @__PURE__ */ r(
    xt.List,
    {
