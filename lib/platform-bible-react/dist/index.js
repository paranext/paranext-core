...
const Bo = Qe(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ie : "button", { className: m(Ji({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function Zi({
  ...
  return /* @__PURE__ */ d(ne, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Gt, { heading: s, children: t.map((u) => /* @__PURE__ */ d(
      At,
      {
        onSelect: () => p(u),
...
function Hd(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Br({
  ...
  if (t)
    return /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Ot(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      At,
      {
        value: `${t} ${fe[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ll({ initialConfig: t, children: e }) {
  const n = j(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = sl(null, o), p = vo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (u) => i(u, p), theme: o });
    return function(u, h) {
      if (h !== null) {
...
function bl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !Ys(e) && o !== null) {
    ...
    if (w || p) {
      const [u, h] = Xs(t), f = l.is(c), g = e.is(i ? c : l), x = e.is(i ? l : c);
      let v, y = 0;
  ...
  const o = n.getDependency(rr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Jo(() => {
    ...
    o.value.read(() => {
      if (Bt()) for (const [p, u] of l.entries()) {
        ...
        w = w || f !== (!!i && i.has(p)), f && (c = c || /* @__PURE__ */ new Set(), c.add(p));
      }
    }), !w && c && i && c.size === i.size || (s.value = c);
  }));
  return { watchNodeKey: function(i) {
    const l = kl(() => (s.value || Ol).has(i)), { watchedNodeKeys: c } = a.peek();
    let w = c.get(i);
    const p = w !== void 0;
...
Kt({ dependencies: [rr, Wr], name: "@lexical/extension/HorizontalRule", nodes: () => [Ee], register(t, e, n) {
  ...
  return Qt(t.registerCommand(oi, (i) => {
    ...
    return !1;
  }, ci), t.registerMutationListener(Ee, (i, l) => {
    Nl(() => {
      let c = !1;
      const { nodeSelections: w } = a.peek();
      for (const [p, u] of i.entries()) if (u === "destroyed") w.delete(p), c = !0;
      else {
...
function Pl(t, e) {
  return Qt(t.registerCommand(fi, (n) => {
    ...
    const a = function(s) {
      ...
      const i = s.anchor, l = s.focus, c = l.isBefore(i) ? l : i, w = c.getNode(), p = Gr(w);
      if (p.canIndent()) {
        const u = p.getKey();
        let h = hi();
...
function nw({
  ...
  const [e] = Pt(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = ew(), c = () => {
  };
...
function Zd({
  ...
  const [a, s] = I(uw), [i, l] = I(void 0), [c, w] = I(!1), p = W(void 0), u = W(null);
  q(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
    ...
    if (o && l)
      return /* @__PURE__ */ d(st, { children: [
        /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              w(!0), u(pw(t.contents)), i == null || i(!0);
            },
            children: [
...
function Hw({
  ...
  const s = W(null), i = W(null), l = W(!1), [c, w] = I(t), [p, u] = I(n), [h, f] = I(!1);
  q(() => {
    w(t);
  }, [t]), q(() => {
    p !== n && u(n);
      ...
      /* @__PURE__ */ r(Gt, { children: a.map((s) => {
        ...
        return /* @__PURE__ */ d(
          At,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-6", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(wc, { icon: s.icon }) }) }),
              /* @__PURE__ */ d("div", { children: [
...
const Ea = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), u = e ?? w, h = b.useCallback(
      ...
      [n, u]
    ), f = b.useCallback(() => h((_) => !_), [h]), g = u ? "expanded" : "collapsed", y = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: u,
        setOpen: h,
  ...
  ({
    ...
    const c = t ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ r(
      c,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(vc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Cc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ie : "a",
  {
    ref: s,
...
function Pc({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], u = o["%webView_book_selector_more%"], { otLong: h, ntLong: f, dcLong: g, extraLong: x } = {
...
function wr({
  ...
  return /* @__PURE__ */ d(ve, { variant: s, children: [
    /* @__PURE__ */ r($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Is, {}) }) }),
  ...
  if (Gi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    switch (u.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Fe(i, [h, f]);
        break;
      case "alt+n":
