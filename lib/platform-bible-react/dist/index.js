...
import { c as m, g as Ee, a as Fa, C as ke, A as ie, P as De, b as We, B as q, d as Oe, e as Me, f as $e, h as xe, i as Ai, k as Vi, j as Pi, E as ji, l as Ua, r as pe, m as Li, n as cn, o as Qr, p as ta, L as Nt, R as Ka, q as qr, D as Na, s as Ca, t as Ea, u as Ta, T as ln, v as Pr, w as Vt, x as qa, y as Pt, z as jt, F as Lt, G as dn, H as Ga, I as Ge, J as kr, K as Ie, M as Ae, N as Ve, S as _r, O as er, Q as Bi, U as Er, V as Ye, W as ze, Z as Xe, X as Te, Y as rr, _ as Ha, $ as Ya, a0 as Gr, a1 as Wa, a2 as wn, a3 as Fi, a4 as Ui, a5 as Ki, a6 as za, a7 as un, a8 as ea, a9 as pn, aa as qi, ab as Gi, ac as Hi, ad as Yi, ae as hn, af as Wi, ag as ca, ah as bo, ai as la, aj as Xi, ak as Ji, al as Zi, am as Qi, an as ts, ao as Tr, ap as Xa, aq as es, ar as rs } from "./resizable-BwezOpOQ.js";
...
import { Section as dt, getChaptersForBook as As, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Vs, formatReplacementString as He, sanitizeHtml as Za, NumberFormat as yn, formatBytes as Ps, getCurrentLocale as js, usfmMarkers as jr, getFormatCallerFunction as Ls, deepEqual as Bs, isString as _o, compareScrRefs as Oa, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as Fs, getLocalizeKeyForScrollGroupId as No, formatReplacementStringToArray as Co, collectUsjMarkers as Us } from "platform-bible-utils";
...
import { useReactTable as Pn, getFilteredRowModel as Jc, getSortedRowModel as jn, getPaginationRowModel as Zc, getCoreRowModel as Ln, flexRender as xr, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
...
function pa({
  ...
  const B = pe(), [z, I] = _(!1), [A, C] = _(""), [V, U] = _(""), [k, J] = _("books"), [j, Y] = _(void 0), [T, $] = _(
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      x[rt] = Ft[rt].filter((At) => Ua(At, V, n));
    }), x;
  }, [Ft, V, n]), R = D(
    () => ul(V, Jt, n),
    [V, Jt, n]
    ...
    w.read(() => {
      ...
      if ((z || I) && O !== null && B !== null) {
        const A = function(C, V, U, k, J, j, Y) {
          ...
          return T.setStart(...jo(V, U, k)), T.setEnd(...jo(J, j, Y)), T;
        }(t, h, f, O, g, E, B);
        l(), l = Rl(t, A, e);
      }
...
qt.prototype.brand = Pl, qt.prototype.h = function() {
  return !0;
...
function Wd({
  ...
  var z;
  const [w, p] = _([]), [h, g] = _([]), [f, b] = _({}), [v, E] = _({}), y = D(() => e ?? [], [e]), N = Pn({
    data: y,
    columns: t,
    getCoreRowModel: Ln(),
...
function fp({
  ...
  const [f, b] = _("generated"), [v, E] = _("generated"), [y, N] = _("*"), [O, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, U] = _(!0), [k, J] = _(!1), j = F(!1), Y = F(""), [T, $] = _(!1), [W, Z] = _(), [Dt, Tt] = _(), [Bt, K] = _(), [tt, wt] = _(), at = F(null), mt = D(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      let st = "custom";
      it === Ia ? st = "generated" : it === Aa ? st = "hidden" : it && (N(it), B(it)), b(st), E(st), I(((ot = Q.insert.note) == null ? void 0 : ot.style) ?? "f"), P = setTimeout(() => {
        var ht;
  ...
  const ut = L(
    (P, Q, et = !1) => {
      ...
      if (ot && Mr("note", ot)) {
        if (ot.insert.note) {
          let pt;
          P === "custom" ? pt = Q : P === "generated" ? pt = Ia : pt = Aa, ot.insert.note.caller = pt;
        }
...
const Ce = "scrBook", Vw = "scrRef", qe = "source", Pw = "details", jw = "Scripture Reference", Lw = "Scripture Book", yi = "Type", Bw = "Details";
function Fw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Bp({
  ...
  H(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const U = b.find((k) => nn(k) === V[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, b, c, E]);
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: E.getHeaderGroups().map((C) => /* @__PURE__ */ a(Te, { children: C.headers.filter((V) => V.column.columnDef.header).map((V) => (
...
function Up({
  ...
  const O = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), U = St(s, "%webView_scope_selector_choose_books%"), k = St(s, "%webView_scope_selector_scope%"), J = St(s, "%webView_scope_selector_select_books%"), j = St(s, "%webView_scope_selector_range%"), Y = St(s, "%webView_scope_selector_select_range%"), T = St(s, "%webView_scope_selector_range_start%"), $ = St(s, "%webView_scope_selector_range_end%"), W = St(s, "%webView_scope_selector_ok%"), Z = St(s, "%webView_scope_selector_cancel%"), Dt = St(s, "%webView_scope_selector_navigate%"), Tt = (M) => {
    if (!f) return;
...
function Ba({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ve, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ra, { children: [
      /* @__PURE__ */ a(wn, { children: /* @__PURE__ */ a(Vt, { children: Ci(e.groups, e.items, l, t) }) }),
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Xw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Jw, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Vt, { children: Ri(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
