...
import b, { forwardRef as sn, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as fs, createElement as Vr, Suspense as hs, Fragment as fo } from "react";
import { Command as Ct } from "cmdk";
import { X as je, Search as ho, Check as jt, Clock as jr, ChevronsLeft as zr, ChevronsRight as Fr, ChevronLeft as Jn, ChevronRight as Ie, ArrowLeft as gs, ArrowRight as bs, Circle as Tn, ChevronDown as ze, BoldIcon as vs, ItalicIcon as xs, AtSign as go, Pencil as ys, Trash2 as Ns, ArrowUp as bo, MoreHorizontal as ks, MailOpen as _s, Mail as Cs, ChevronUp as vo, FilterIcon as Es, ArrowLeftIcon as Ts, ChevronLeftIcon as Rs, ChevronRightIcon as Ss, ArrowRightIcon as Ds, Copy as xo, Filter as Ms, User as Is, Link as Os, CircleHelp as As, ChevronsUpDown as yo, Star as Ps, Undo as $s, Redo as Ls, SquareX as No, FunctionSquare as ko, SquareSigma as _o, Ban as Vs, AlertCircle as Zn, CircleCheckIcon as js, CircleXIcon as zs, CircleHelpIcon as Fs, ArrowUpIcon as Bs, ArrowDownIcon as Ks, PanelLeft as Gs, PanelRight as Us, ScrollText as qs, MenuIcon as Hs, Menu as Ys, EllipsisVertical as Xs, MoreVertical as Br, LoaderCircle as Ws, GripVertical as Js } from "lucide-react";
...
import { includes as dn, Section as X, getChaptersForBook as ti, formatScrRef as xe, getSectionForBook as Je, formatRelativeDate as ei, formatReplacementString as ve, sanitizeHtml as ni, NumberFormat as ri, formatBytes as oi, getCurrentLocale as ai, usfmMarkers as hn, getFormatCallerFunction as si, deepEqual as ii, isString as Kr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as Eo, $getRoot as ce, $createParagraphNode as Rn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as To, TextNode as Ro, $isTokenOrSegmented as li, $getCharacterOffsets as wi, $cloneWithPropertiesEphemeral as ci, $findMatchingParent as So, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Do, COMMAND_PRIORITY_EDITOR as Mo, mergeRegister as de, shallowMergeConfig as di, defineExtension as Ut, safeCast as ln, createState as pi, FORMAT_TEXT_COMMAND as Io, $isNodeSelection as Oo, COMMAND_PRIORITY_LOW as Ao, RootNode as ui, LineBreakNode as mi, TabNode as fi, $isEditorState as hi, createCommand as gi, CLICK_COMMAND as bi, isDOMNode as vi, $getNodeFromDOMNode as xi, $createNodeSelection as yi, $setSelection as Ni, DecoratorNode as tr, $getState as ki, toggleTextFormatType as Gr, TEXT_TYPE_TO_FORMAT as _i, $setState as Ci, addClassNamesToElement as Po, $create as Ei, $getNodeByKey as Ti, removeClassNamesFromElement as Ri, KEY_TAB_COMMAND as Si, $isBlockElementNode as vn, $createRangeSelection as Di, $normalizeSelection__EXPERIMENTAL as Mi, OUTDENT_CONTENT_COMMAND as Ii, INDENT_CONTENT_COMMAND as Ur, INSERT_TAB_COMMAND as Oi, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Ai, $isParagraphNode as Pi, $isTextNode as xn, SELECTION_CHANGE_COMMAND as $o, getRegisteredNode as $i, isHTMLElement as Li, isDocumentFragment as qr, isDOMDocumentNode as Vi, ArtificialNode__DO_NOT_USE as Lo, $createLineBreakNode as Vo, $isRootOrShadowRoot as ji, isBlockDomNode as Hr, isInlineDomNode as Yr, $insertNodes as zi } from "lexical";
import * as _e from "@radix-ui/react-tooltip";
import { TooltipTrigger as Fi } from "@radix-ui/react-tooltip";
import { HeadingNode as Bi, QuoteNode as Ki, registerRichText as Gi } from "@lexical/rich-text";
import { flushSync as Ui, createPortal as qi } from "react-dom";
...
import { useReactTable as Bo, getFilteredRowModel as Xi, getSortedRowModel as Ko, getPaginationRowModel as Wi, getCoreRowModel as Go, flexRender as Ze, getGroupedRowModel as Ji, getExpandedRowModel as Zi } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import Qi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as er, HIDDEN_NOTE_CALLER as nr, getDefaultViewOptions as tl, isInsertEmbedOpOfType as pn, Editorial as el } from "@eten-tech-foundation/platform-editor";
...
const sl = Mt.Root, hp = Mt.Trigger, il = Mt.Portal, gp = Mt.Close, Uo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
    className: f(
...
Uo.displayName = Mt.Overlay.displayName;
...
const wl = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Description,
  {
    ref: n,
...
wl.displayName = Mt.Description.displayName;
...
const Ke = b.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(ho, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Ct.Input,
      {
        ref: n,
...
te.displayName = Ct.Group.displayName;
...
Xo.displayName = Ct.Separator.displayName;
...
qt.displayName = Ct.Item.displayName;
...
function Nr(t, e, n) {
  ...
  return !!(dn(a.toLowerCase(), o) || dn(t.toLowerCase(), o) || (i ? dn(i.localizedName.toLowerCase(), o) || dn(i.localizedId.toLowerCase(), o) : !1));
}
const Qo = sn(
  ({
    bookId: t,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Fe : "button", { className: f(ta({ variant: e, size: n, className: t })), ref: i, ...a })
);
z.displayName = "Button";
const Ge = 250, ea = 300, dl = 400, bp = 450, vp = 500, oe = Oe.Root, fe = Oe.Trigger, pl = Oe.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = mt();
...
function ul({
  ...
  return /* @__PURE__ */ p(oe, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Ht, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(te, { heading: i, children: t.map((u) => /* @__PURE__ */ p(
      qt,
      {
        onSelect: () => h(u),
...
function yp({
  ...
  const c = mt(), [d, m] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, F] = S(!1), j = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    ...
    [v, pt]
  ), { otLong: at, ntLong: st, dcLong: lt, extraLong: xt } = {
  ...
  return At(() => {
    ...
    /* @__PURE__ */ r(Ht, { id: w, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      ne,
      {
        ref: j,
        onKeyDown: Jt,
        ...
        children: [
          ...
          !C && /* @__PURE__ */ p(re, { ref: M, children: [
            v === "books" && /* @__PURE__ */ p(ct, { children: [
              !I && Object.entries(W).map(([D, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(te, { heading: Xt(D), children: _.map((L) => /* @__PURE__ */ r(
                      Qo,
                      {
                        bookId: L,
                        onSelect: (U) => Tt(U),
              ...
              I && /* @__PURE__ */ r(te, { children: /* @__PURE__ */ r(
                qt,
                {
                  ...
                  children: xe(
                    ...
                    a ? yr(I.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              I && Gt(I.book) > 1 && /* @__PURE__ */ p(ct, { children: [
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Co.Root, { ref: n, className: f("pr-twp", gl(), t), ...e }));
ht.displayName = Co.Root.displayName;
...
kr.displayName = nn.Root.displayName;
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: j(e) ? e.map((M) => /* @__PURE__ */ r(te, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = ra ? At : Y, un = { tag: br };
function Nl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: w } = t, c = xl(null, o), d = Eo({ editable: t.editable, html: w, namespace: a, nodes: i, onError: (m) => s(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
...
const kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function _l({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Yt();
  return kl(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: w }) => {
      e && i.size === 0 && s.size === 0 || t && w.has(br) || l.isEmpty() || n(a, o, w);
    });
  }, [o, t, e, n]), null;
}
const _r = {
  ...
  {
    ref: o,
    className: e ? f(ta({ variant: e }), t) : t,
    ...n
  }
));
...
class El extends fs {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Tl(e.resetKeys, a)) {
      var i, s;
...
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function Dl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ml() {
  return function(t) {
    const [e] = Yt(), n = B(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = H(o);
    return Sl(() => {
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Al = oa && "documentMode" in document ? document.documentMode : null;
!(!oa || !("InputEvent" in window) || Al) && "getTargetRanges" in new window.InputEvent("input");
function Pl(t) {
  const e = So(t, (n) => le(n) && !n.isInline());
  return le(e) || Ol(4, t.__key), e;
}
function $l(t) {
  const e = Vt();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = So(i, (c) => le(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function zl(t) {
  ...
  sa(this), Z = t, this.f &= -2, 8 & this.f && Er(this), Dn();
}
function De(t, e) {
...
Nt.prototype.brand = Ll, Nt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), Qr(this), we++;
  const t = Z;
  return Z = this, zl.bind(this, t);
...
Ut({ build: (t, e, n) => Mn(e), config: ln({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function wa(t, e = la) {
  return t.registerCommand(Do, (n) => (t.update(e), !0), Mo);
}
Ut({ build: (t, e, n) => Mn(e), config: ln({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return pe(() => wa(t, o.value));
} });
function Fl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Fn = pi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ca extends tr {
  $config() {
...
Ut({ name: "@lexical/extension/DecoratorText", nodes: () => [ca], register: (t, e, n) => t.registerCommand(Io, (o) => {
  const a = Vt();
  if (Oo(a) || ke(a)) for (const i of a.getNodes()) Bl(i) && i.toggleFormat(o);
  return !1;
}, Ao) });
function da(t, e) {
  let n;
...
const cr = Ut({ build: (t) => da(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Tr = 0, dr = 1, ua = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Tr;
}
function ma(t) {
...
const Hl = Ut({ config: ln({ setOptions: to, updateOptions: to }), init: ({ $initialEditorState: t = ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (hi(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ui, Ro, mi, fi, To] }), eo = Symbol.for("@lexical/extension/LexicalBuilder");
function no() {
}
function Yl(t) {
  throw t;
...
class tn {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Eo({ ...o, ...n ? { onError: (i) => {
      n(i, a);
    } } : {} }), { [eo]: this });
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && et(298, o.name), !a) {
      a = new Ul(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Gn(i) || et(300, s, a || "[unknown]"), Gn(l = i) || et(304, String(l.id), String(Tr)), i = Object.assign(l, { id: dr }), o.state = i;
      const w = this.outgoingConfigEdges.get(s);
      if (w) for (const c of w.keys()) {
        const d = this.extensionNameMap.get(c);
        d && n(d, s);
      }
      i = Kl(i), o.state = i, e.push(o);
    };
...
const Xl = /* @__PURE__ */ new Set(), ro = Ut({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = da(() => {
  }, () => pe(() => {
...
gi("INSERT_HORIZONTAL_RULE_COMMAND");
class Ae extends tr {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: Wl, priority: 0 }) };
  }
  exportDOM() {
...
Ut({ dependencies: [cr, ro], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(ro).output, a = rn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return de(t.registerCommand(bi, (s) => {
    if (vi(s.target)) {
      const l = xi(s.target);
      if (Jl(l)) return function(w, c = !1) {
        const d = Vt(), m = w.isSelected(), h = w.getKey();
        let u;
        c && Oo(d) ? u = d : (u = yi(), Ni(u)), m ? u.delete(h) : u.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, Ao), t.registerMutationListener(Ae, (s, l) => {
    Vl(() => {
      let w = !1;
    ...
    const s = [];
    for (const { domNode: l, selectedSignal: w } of a.value.nodeSelections.values()) s.push(pe(() => {
      const c = l.value;
      c && (w.value ? Po(c, i) : Ri(c, i));
    }));
    return de(...s);
  }));
} });
...
function Zl(t, e, n = ha) {
  return de(t.registerCommand(Si, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => vn(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, w = s.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = Pl(d);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Di();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Mi(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Ii : Ur : Oi;
    return t.dispatchCommand(i, void 0);
  }, Mo), t.registerCommand(Ur, () => {
...
Ut({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ha, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: i } = n.getOutput();
  return pe(() => {
    if (!o.value) return Zl(t, a, i);
  });
} });
const Ql = Ut({ name: "@lexical/react/ReactProvider" });
function tw() {
...
Ut({ build: (t, e, n) => Mn(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : ba(t)) });
function rw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Rr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function ow({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, i] = S(() => n.getDecorators());
    return Rr(() => n.registerDecoratorListener((s) => {
      Ui(() => {
        i(s);
      });
    }), [n]), Y(() => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (h) => n._onError(h), children: r(hs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && s.push(qi(d, m, c));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function aw({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Ql.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && rw(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(ow, { editor: t, ErrorBoundary: e });
}
function oo(t) {
  return t.getEditorState().read(ga(t.isComposing()));
}
function sw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Yt();
  return function(a) {
    Rr(() => de(Gi(a), ba(a)), [a]);
  }(o), p(ct, { children: [t, r(iw, { content: e }), r(aw, { editor: o, ErrorBoundary: n })] });
}
function iw({ content: t }) {
...
function lw({ defaultSelection: t }) {
  const [e] = Yt();
  return Y(() => {
    e.focus(() => {
...
function mw(t, e) {
  ...
  return p(ct, { children: [r(pw, { editor: a, ...o, ref: e }), n != null && r(fw, { editor: a, content: n })] });
}
function fw({ content: t, editor: e }) {
  const n = function(s) {
    const [l, w] = S(() => ao(s));
    return va(() => {
      function c() {
      ...
      return c(), de(s.registerUpdateListener(() => {
        c();
...
function gw({
  ...
  return /* @__PURE__ */ r(xa.Provider, { value: s, children: i });
}
function ya() {
  const t = gr(xa);
  if (!t)
...
function bw() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(sl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(qo, { children: [
      /* @__PURE__ */ r(Ho, { children: /* @__PURE__ */ r(Yo, { children: i }) }),
      s
    ] }) });
  }, [t, n]), a = K(
    (i, s, l = !1) => {
...
function vw({
  ...
  const [e] = Yt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = bw(), w = () => {
  };
...
), yw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  jo.Root,
  {
    ref: a,
    className: f(Na({ variant: e, size: n, className: t })),
    ...o
  }
));
yw.displayName = jo.Root.displayName;
const ka = b.createContext({
  size: "default",
  variant: "default"
}), Sr = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = mt();
  return /* @__PURE__ */ r(
    Sn.Root,
    {
...
function Nw() {
  const { activeEditor: t } = ya(), [e, n] = S([]), o = K((a) => {
    if (ke(a) || Hi(a)) {
      const i = [];
      so.forEach(({ format: s }) => {
...
function _w({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(vw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Nw, {}) }) }),
      ...
      /* @__PURE__ */ r(
        sw,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ r(hw, { placeholder: t }) }),
          ErrorBoundary: Rl
        }
      ),
      e && /* @__PURE__ */ r(lw, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(kw, { onClear: n }),
      /* @__PURE__ */ r(cw, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          Nl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(_w, { placeholder: a, autoFocus: i, onClear: s }),
              /* @__PURE__ */ r(
                _l,
                {
...
function Ew(t, e) {
  const n = Vi(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  ...
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Lo && s.insertAfter(Vo());
    for (const s of i) {
...
function _a(t, e, n, o = null) {
  ...
  let s = e;
  o !== null && xn(e) && (s = Il(o, e, "clone"));
  const l = le(s) ? s.getChildren() : [], w = $i(t, s.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = _a(t, g, h, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Li(d) || qr(d)) && d.append(h), n.append(d), m) {
      const u = m.call(s, d);
...
function Ea(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  ...
  let h = [];
  const u = (l == null || !ji(l)) && (l != null && vn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Ea(m[g], e, n, u, new Map(a), l));
  return d != null && (h = d(h)), Hr(t) && (h = Rw(t, h, u ? () => {
    const g = new Lo();
    return n.push(g), g;
  } : Rn)), l == null ? h.length > 0 ? s = s.concat(h) : Hr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Yr(g.nextSibling) && Yr(g.previousSibling);
  }(t) && (s = s.concat(Vo())) : le(l) && l.append(...h), s;
}
function Rw(t, e, n) {
...
function Sw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), i = Ew(e, a);
      ce().clear(), zi(i);
    },
    {
      discrete: !0
...
function Cp({
  ...
  const [a, i] = S(Dw), [s, l] = S(void 0), [w, c] = S(!1), d = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(oe, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
        z,
        {
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ r(go, { className: "tw-h-4 tw-w-4" }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Mr(y) && (y.preventDefault(), y.stopPropagation(), Lt(a) && h());
        },
        onKeyDown: (y) => {
          Dr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          Nn,
          {
...
const Ep = Object.freeze([
...
], Mw = ["input", "select", "textarea", "button"], Iw = ["button", "textbox"], Ow = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = H(null), [i, s] = S(void 0), [l, w] = S(void 0), c = K(
    (u) => {
      s(u);
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", Aw({ variant: e }), t), ...n })
);
...
const Lw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Lw.displayName = "CardDescription";
...
Ma.displayName = Be.Root.displayName;
...
jw.displayName = Be.Image.displayName;
...
Ia.displayName = Be.Fallback.displayName;
const Ir = En(void 0);
function Ft() {
  const t = gr(Ir);
  if (!t)
...
}), Ce = nt.Trigger, Oa = nt.Group, zw = nt.Portal, Fw = nt.Sub, Bw = nt.RadioGroup;
function ue({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ir.Provider, { value: n, children: /* @__PURE__ */ r(nt.Root, { ...e }) });
}
const Aa = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Ft();
  return /* @__PURE__ */ p(
    nt.SubTrigger,
    {
...
Kw.displayName = "DropdownMenuShortcut";
function io({
  comment: t,
  isReply: e = !1,
  localizedStrings: n,
  ...
  const u = K(
    (C) => {
      C && C.stopPropagation(), c(!1), m(void 0), s == null || s(!1);
    },
    [s]
  ), g = K(
    async (C) => {
    ...
    [t.user]
  ), N = B(() => ni(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(ct, { children: [
        /* @__PURE__ */ p(
          _n,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Sw(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ma, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Ia, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Mr(C) && (C.preventDefault(), C.stopPropagation(), Lt(d) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ks, {}) }) }),
...
function Gw({
  ...
  const [A, M] = S(lo), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [Tt, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), lt = H(void 0), [xt, Xt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Wt = B(() => Bt[0], [Bt]), Re = H(null), se = H(void 0), Jt = K(() => {
    var T;
    (T = se.current) == null || T.call(se), M(lo);
  }, []), He = K(() => {
    const T = !pt;
  ...
  }, [i, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), it = B(() => $ || U <= 2 ? L : L.slice(-2), [L, U, $]), tt = B(() => $ || U <= 2 ? 0 : U - 2, [U, $]), bt = B(
  ...
  const Rt = K(
    async (T) => {
      ...
      vt && await m({ threadId: w, contents: vt }) && Jt();
    },
    [
      Jt,
      A,
    ...
    async (T) => {
      ...
      return ft && vt && Jt(), ft && E !== void 0 && R(void 0), ft;
    },
    [Jt, A, m, E]
  );
  return /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(
            io,
            {
              ...
              handleDeleteComment: u,
              onEditingChange: W,
              canEditOrDelete: (!P && xt.get(Wt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ p(ct, { children: [
            ...
            v !== !1 && (!P || Lt(A)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Mr(T) && (T.preventDefault(), T.stopPropagation(), (Lt(A) || E !== void 0) && Rt());
                },
                onKeyDown: (T) => {
...
function Rp({
  ...
  const F = n.filter(
    ...
    [y, x]
  ), { listboxRef: E, activeId: R, handleKeyDown: V } = Ow({
    options: j,
    onOptionSelect: A
  }), $ = K(
    (O) => {
...
function Uw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Yi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = dt.Root, qw = dt.Group, Ve = dt.Value, Hw = me(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: f(Hw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
const La = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(vo, { className: "tw-h-4 tw-w-4" })
  }
));
...
Yw.displayName = dt.Label.displayName;
...
Xw.displayName = dt.Separator.displayName;
function Ww({ table: t }) {
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        on(s, '[tabindex]:not([tabindex="-1"])').forEach((d) => {
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), ec(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), tc(l, x, d.key);
...
function rc({
  ...
  var j;
  const [d, m] = S([]), [h, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = B(() => e ?? [], [e]), k = Bo({
    data: N,
    columns: t,
    getCoreRowModel: Go(),
    ...n && { getPaginationRowModel: Wi() },
    onSortingChange: m,
  ...
  return w ? F = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? F = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ...
    A.id
  )) : F = /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Uw, { table: k }),
    /* @__PURE__ */ p(In, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Zt, { children: A.headers.map((M) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Ze(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
...
function Sp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(Qi, { options: i, children: e })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(xo, {}) })
        ] }),
...
function Mp({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Ht, { id: i, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
var sc = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(sc || {});
function Ip({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Oa, { children: c.itemType === 0 ? /* @__PURE__ */ r(ct, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[d][h],
        ...
        Bw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r($a, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function ic({ id: t, versionHistory: e }) {
...
function Ap({
  ...
  const s = B(() => oi(n), [n]), w = ((c) => {
    const d = new Intl.DisplayNames(ai(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(ic, { versionHistory: a }),
    ...
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      z,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(yo, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
        ...
        /* @__PURE__ */ r(te, { children: F.map((R) => /* @__PURE__ */ p(
          qt,
          {
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r(Ps, { className: "tw-h-4 tw-w-4" }),
...
function dc({ children: t, editorRef: e }) {
  const n = H(null);
  return Y(() => {
    var s;
...
const pc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(ct, { children: [
...
function uc({
  ...
  const i = H(null), s = H(null), l = H(!1), [w, c] = S(t), [d, m] = S(n), [h, u] = S(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ue, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Dt, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: pc(t, a, n) }) }) }),
...
const mc = (t, e) => t === "f" ? /* @__PURE__ */ p(ct, { children: [
  /* @__PURE__ */ r(ko, {}),
  " ",
...
function hc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(St, { children: [
      /* @__PURE__ */ r(Fi, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: mc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: fc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ee, { style: { zIndex: ea }, children: [
...
function bc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Vs, { className: e, size: 16 });
}
function vc({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  const [o, a] = S(""), i = B(() => {
    ...
    const l = e.filter(
      (w) => {
        var c;
        return (c = w.marker) == null ? void 0 : c.toLowerCase().includes(s);
      }
    );
    return l.push(
      ...e.filter(
      ...
      /* @__PURE__ */ r(te, { children: i.map((s) => {
        ...
        return /* @__PURE__ */ p(
          qt,
          {
            ...
            onSelect: s.action,
            children: [
              /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: s.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: s.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(bc, { icon: s.icon }) }) }),
              /* @__PURE__ */ p("div", { children: [
              ...
              (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Wo, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
            ]
          },
...
function $p({
  ...
  const st = K(
    (_, L, U = !1) => {
      ...
      if (q && pn("note", q)) {
        if (q.insert.note) {
          let wt;
          _ === "custom" ? wt = L : _ === "generated" ? wt = er : wt = nr, q.insert.note.caller = wt;
        }
        n == null || n([q]), U && c && i && ((bt = c.current) == null || bt.replaceEmbedUpdate(i, [q]));
      }
    },
    [i, n, c]
  ), lt = K(() => {
  ...
  const Xt = H({ book: a.book, chapterNum: a.chapterNum });
  At(() => {
    (Xt.current.book !== a.book || Xt.current.chapterNum !== a.chapterNum) && (Xt.current = { book: a.book, chapterNum: a.chapterNum }, xt.current());
  }, [a.book, a.chapterNum]);
  const Bt = () => {
    var L;
    ...
    if (L && pn("note", L)) {
      ...
      const wt = (tt = (it = L.insert.note) == null ? void 0 : it.contents) == null ? void 0 : tt.ops;
      N !== "x" && _ === "x" ? wt == null || wt.forEach((Rt) => yc(Rt)) : N === "x" && _ !== "x" && (wt == null || wt.forEach((Rt) => Nc(Rt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Jt = (_) => {
    ...
    (_) => {
      ...
      if (L && pn("note", L)) {
        ...
        const wt = (it = L.insert.note) == null ? void 0 : it.style, Rt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (wt || F(!1), F(
          wt === "x" ? !!(Rt != null && Rt.every(($t) => {
            var vt, ft;
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(dc, { editorRef: d, children: /* @__PURE__ */ r(
              el,
              {
                options: G,
                onStateChange: Jt,
  ...
  return /* @__PURE__ */ p(ct, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(ct, { children: _c(t.marker, l, o, c) })
      }
    )
  ] });
}
...
function Rc({
  ...
  return /* @__PURE__ */ p(In, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(On, { stickyHeader: !0, children: /* @__PURE__ */ p(Zt, { children: [
    ...
    /* @__PURE__ */ r(An, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ p(
      Zt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { className: o, children: Tc(l.text) })
        ]
      },
...
Ar.displayName = rr.Root.displayName;
const Sc = (t) => {
  if (t === "asc")
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ p(Sr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        en,
        {
          onClick: (w) => {
  ...
  return e ? e[1] : "";
}, Mc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Up = Object.freeze([
...
function qp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), F = Kt(
    ...
    const G = t ?? [];
    return G.length === 0 ? [] : Oc(G, a, i);
  }, [t, a, i]), I = B(() => {
    if (A) return W;
    const G = [];
    return W.forEach((at) => {
      const st = at.items[0], lt = G.find(
        (xt) => xt.items[0] === st
      );
      lt ? (lt.count += at.count, lt.occurrences = lt.occurrences.concat(at.occurrences)) : G.push({
        items: [st],
        count: at.count,
  ...
  }, [A, W]), J = B(() => I.length === 0 ? [] : Ic(I, E, V), [I, E, V]), Tt = B(() => {
    var st, lt;
    if (!A) return w;
    ...
    for (let xt = 0; xt < G; xt++)
      at.push(
        Dc(
          ((lt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : lt[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [...at, ...w];
...
const Ac = "16rem", Pc = "3rem", za = b.createContext(void 0);
function $n() {
...
const Fa = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(za.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ba = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = $n();
...
const $c = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    z,
    {
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = $n(), d = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: f(Kc({ variant: n, size: o }), i),
        ...s
      }
    );
...
const Gc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: a,
...
Yc.displayName = "SidebarMenuSubItem";
const Xc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: i,
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ p(Ga, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Ua, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(qa, { children: /* @__PURE__ */ r(
            Ha,
            {
              onClick: () => c(h),
              isActive: m(h),
...
const ie = "scrBook", Jc = "scrRef", be = "source", Zc = "details", Qc = "Scripture Reference", td = "Scripture Book", Ya = "Type", ed = "Details";
function nd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Qc,
      cell: (o) => {
...
}, uo = (t) => `${rd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Yp({
  sources: t,
  ...
  Y(() => {
    if (l) {
      ...
      if (R.length === 1) {
        const V = x.find(($) => uo($) === R[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? td, k = i ?? Ya, C = [
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(qw, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(In, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Zt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
...
}), Xa = (t, e, n) => $r(t, e).every((o) => n.includes(o));
function od({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = $r(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        Xa(e, t, n) && !i && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: i,
      children: cl(
        t,
...
function ad({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  const j = B(() => ut.allBookIds.filter(
    ...
    (P) => {
      const W = $r(j, P).map((I) => I);
      n(
        Xa(j, P, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, j]
  ), $ = () => {
    ...
    /* @__PURE__ */ p(
      oe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ht, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            ne,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
              ...
              children: [
                ...
                /* @__PURE__ */ p(re, { children: [
                  ...
                  Object.values(X).map((P, W) => {
                    const I = A[P];
                    if (I.length !== 0)
                      return /* @__PURE__ */ p(fo, { children: [
                        /* @__PURE__ */ r(
                          te,
                          {
                            heading: Jo(P, h, u, g, x),
                        ...
                        W < Object.values(X).length - 1 && /* @__PURE__ */ r(Xo, {})
                      ] }, P);
                  })
                ] })
              ]
...
const Ja = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ p(St, { children: [
  /* @__PURE__ */ r(Dt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r(zw, { children: /* @__PURE__ */ r(Pa, { children: Ja(
      t,
      e,
      Wa(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: i, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Hs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(fo, { children: [
...
function eu({
  ...
  return /* @__PURE__ */ p(Za, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      hr,
      {
        onSelectMenuItem: t,
...
Qa.displayName = Et.List.displayName;
const ts = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.List,
  {
    ref: n,
    className: f(
...
)), es = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Et.Content,
  {
    ref: n,
    className: f(
...
es.displayName = Et.Content.displayName;
function ru({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ r(ts, { children: t.map((l) => /* @__PURE__ */ r(sd, { value: l.value, children: l.value }, l.key)) }),
...
const ns = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
const ss = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = Ft();
...
const is = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
const wd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = Ft();
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
...
wd.displayName = rt.CheckboxItem.displayName;
...
dd.displayName = rt.Label.displayName;
...
const Xe = (t, e) => {
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((c) => c.group === i).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(St, { children: [
    ...
    return l.length > 0 && s < a.length - 1 && w.push(/* @__PURE__ */ r(ls, {}, `separator-${i}`)), w;
  });
};
function pd({
  menuData: t,
  ...
  const a = H(void 0), i = H(void 0), s = H(void 0), l = H(void 0), w = H(void 0), c = (d) => {
    switch (d) {
      case "platform.app":
        return i;
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    return /* @__PURE__ */ r(ns, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(id, { children: [
      /* @__PURE__ */ r(rs, { ref: c(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        ss,
        {
          style: { zIndex: Ge },
...
function md({ item: t, createLabel: e, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Br, {}) }) }),
...
const fd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ws, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), gd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const vd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
vd.displayName = "AlertDescription";
const cu = ot.Root, du = ot.Trigger, pu = ot.Group, uu = ot.Portal, mu = ot.Sub, fu = ot.RadioGroup, xd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
xd.displayName = ot.SubTrigger.displayName;
...
yd.displayName = ot.SubContent.displayName;
const Nd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
Nd.displayName = ot.Content.displayName;
...
kd.displayName = ot.Item.displayName;
const _d = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ref: a,
    className: f(
...
_d.displayName = ot.CheckboxItem.displayName;
const Cd = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ot.RadioItem,
  {
    ref: o,
    className: f(
...
Ed.displayName = ot.Label.displayName;
...
Rd.displayName = "ContextMenuShortcut";
...
const hu = zt.Trigger, Dd = zt.Portal, gu = zt.Close, ds = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
const Md = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: i = "bottom" } = b.useContext(cs), s = {
...
Ad.displayName = zt.Title.displayName;
...
Pd.displayName = zt.Description.displayName;
const $d = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  or.Root,
  {
    ref: o,
    className: f(
...
$d.displayName = or.Root.displayName;
function bu({
  className: t,
  ...e
}) {
...
const Ld = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ p(
    We.Root,
    {
...
Ld.displayName = We.Root.displayName;
...
Vd.displayName = ar.Root.displayName;
const Nu = Et.Root, jd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Et.List,
    {
...
jd.displayName = Et.List.displayName;
...
zd.displayName = Et.Trigger.displayName;
...
Fd.displayName = Et.Content.displayName;
const Bd = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
...
export {
  ...
  wc as UNDO_REDO_BUTTONS_STRING_KEYS,
  su as UiLanguageSelector,
  cc as UndoRedoButtons,
  Qa as VerticalTabs,
  ...
  vp as Z_INDEX_MODAL,
  bp as Z_INDEX_MODAL_BACKDROP,
  dl as Z_INDEX_OVERLAY,
  Aw as badgeVariants,
