...
import { c as v, g as Oe, a as Fa, C as ze, A as pe, P as Ve, b as er, B as H, d as Le, e as je, f as Be, h as Te, i as Li, k as ji, j as Bi, E as Fi, l as Ua, r as xe, m as Ui, n as wn, o as ta, p as ea, L as Rt, R as Ka, q as Gr, D as Na, s as Ca, t as Ea, u as Ta, T as un, v as Lr, w as jt, x as qa, y as Bt, z as Ft, F as Ut, G as pn, H as Ga, I as Ze, J as Nr, K as Fe, M as Ue, N as Ke, S as Cr, O as ir, Q as Ki, U as Sr, V as tr, W as Ie, Z as rr, X as $e, Y as sr, _ as Ha, $ as Ya, a0 as Hr, a1 as Wa, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as Sa, a7 as gn, a8 as ra, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as ca, ah as xo, ai as la, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as zr, ap as Xa, aq as os, ar as ns } from "./resizable-C3AVzTx2.js";
...
import Wt, { useRef as F, useMemo as I, useState as N, useCallback as L, useEffect as G, useImperativeHandle as Hs, useLayoutEffect as ne, createContext as Qa, useContext as Cn, Component as Ys, createElement as To, Suspense as Ws, forwardRef as En, useId as So, Fragment as aa } from "react";
...
import { Avatar as ao, Select as Xt, Checkbox as Mo, Slot as Dr, Tabs as he, Menubar as ye, ContextMenu as At, Progress as Oo, Slider as Or, Switch as $o } from "radix-ui";
...
function pa({
  ...
  const j = xe(), [D, $] = N(!1), [P, S] = N(""), [V, Y] = N(""), [_, et] = N("books"), [B, X] = N(void 0), [M, O] = N(
    void 0
  ), [W, ot] = N(void 0), [Pt, Ot] = N(!1), Kt = F(null), q = F(!1), it = F(void 0), gt = F(void 0), lt = F(void 0), ft = F(void 0), Jt = F({}), Ct = F({}), xt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ...
  const { otLong: T, ntLong: U, dcLong: nt, extraLong: J } = {
    ...
    [w]
  ), ae = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Re = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", mr = L(
    (x) => {
    ...
    (x) => {
      ...
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const zt = (_e = it.current) == null ? void 0 : _e.querySelector(
      ...
      if (_ === "verses" && Lt) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            Gt = vt === 0 ? zt : Math.max(1, vt - ge);
            break;
          case "ArrowDown":
            Gt = vt === 0 ? 1 : Math.min(zt, vt + ge);
            break;
          default:
            return;
        }
    ...
    const { isLetter: K, isDigit: ct } = Po(x.key);
    (K || ct) && (x.preventDefault(), Y((_e) => _e + x.key), gt.current.focus(), Ot(!1));
  }, []);
  return ne(() => {
    const x = setTimeout(() => {
      if (D && _ === "books" && lt.current && ft.current) {
        const K = lt.current, ct = ft.current, Lt = ct.offsetTop, _e = K.clientHeight, De = ct.clientHeight, Ye = Lt - _e / 2 + De / 2;
        K.scrollTo({
          top: Math.max(0, Ye),
          behavior: "smooth"
        }), S(qn(t.book));
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: K } = x;
          D && Kt.current && K instanceof Node && Kt.current.contains(K) && (q.current = !0, $t(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          je,
            ...
            children: [
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: He.map(
                  ({ onClick: x, disabled: K, title: ct, icon: Lt }) => /* @__PURE__ */ a(
                    H,
                    {
                      variant: "ghost",
                      size: "sm",
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = Yn ? ne : G, Ar = { tag: to };
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : G;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : G;
function Rl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = ke(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = F(o);
    return zl(() => {
...
ce({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = Qt();
  if (An(n) || ve(n)) for (const i of n.getNodes()) Wl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ri(t, e) {
  let r;
...
ce({ build: (t, e, r) => fr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => be(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function wd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : G;
...
const md = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? ne : G;
...
function Td({
  ...
  const [e] = ke(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Ed(), l = () => {
  };
...
function xi({
  ...
  const [_, et] = N(tn), [B, X] = N(), [M, O] = N(), W = o, [ot, Pt] = N(!1), [Ot, Kt] = N(!1), [q, it] = N(!1), [gt, lt] = N(!1), [ft, Jt] = N(!1), [Ct, xt] = N(z), [Et, qt] = N(!1), yt = F(void 0), [Vt, R] = N(/* @__PURE__ */ new Map());
  G(() => {
    let y = !0;
    return (async () => {
  ...
  const te = I(() => _t[0], [_t]), Ge = F(null), le = F(void 0), de = L(() => {
    var y;
      ...
      children: /* @__PURE__ */ u(Vd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ee && /* @__PURE__ */ a(Nr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: ee }),
            /* @__PURE__ */ a(
              H,
              {
                variant: "ghost",
...
function sw(t, e, r) {
  ...
  if (t.key === " ") {
    if (e.kind === "backslash")
      return Ne(t), (o = e.shouldSpaceCommit) != null && o.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    if (e.kind === "selection") {
      Ne(t);
      const n = e.items.find((i) => i.marker === e.filter);
      return n && r.commitItem(n.marker), r.dismiss(), "ended";
    }
    return Ne(t), e.filter += " ", r.update({ filterText: e.filter }), "continue";
  }
  return t.key === "Backspace" && e.filter === "" ? (Ne(t), r.dismiss(), "ended") : t.key === "Backspace" || iw[e.kind].test(t.key) ? (Ne(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && Ne(t), r.dismiss(), "ended");
}
function rn(t, e) {
  var r;
...
function uw({
  ...
  return /* @__PURE__ */ u(Fe, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: ww(t, n, r) }) }) }),
...
function gw({
  ...
  return /* @__PURE__ */ u(Fe, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(Ue, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: pw(t, r) }) }) }),
...
function Np({
  ...
  const [b, m] = N("generated"), [C, E] = N("generated"), [k, z] = N("*"), [j, D] = N("*"), [$, P] = N("f"), [S, V] = N(!1), [Y, _] = N(!0), [et, B] = N(!1), X = F(!1), M = F(""), [O, W] = N(!1), [ot, Pt] = N(), [Ot, Kt] = N(), [q, it] = N(), [gt, lt] = N(), ft = F(null), Jt = F(void 0), Ct = F(0), xt = F(void 0), Et = I(
    () => ({
      ...s,
  ...
  const te = () => {
    ...
    (T, U, nt) => {
      ...
      Jt.current = {
        ...
        if (rn(Jt, st), Q !== void 0) {
          if (!((y = p.current) != null && y.getSelection())) {
            const ae = xt.current;
            ae ? (rt = p.current) == null || rt.setSelection(ae) : (at = p.current) == null || at.selectNote(0);
          }
          (ut = p.current) == null || ut.focus();
          const we = U.find((ae) => ae.marker === Q);
        ...
        var Q;
        rn(Jt, st), Z || (Q = p.current) == null || Q.focus();
      });
    },
    [w]
  );
      ...
      const Z = (Q) => {
        ...
        if (y && w) {
          sw(Q, y, {
            ...
            update: (ie) => w.update(ie),
            commit: () => w.commit(),
            dismiss: () => w.dismiss(),
            commitTyped: (ie) => {
              var oe;
              return (oe = p.current) == null ? void 0 : oe.commitTypedMarker(ie);
            },
            commitItem: (ie) => {
              var x;
              const oe = y.items.find((K) => K.marker === ie);
              oe && ((x = p.current) == null || x.applyMarkerMenuSelection(oe, {
                trigger: "backslash",
                literalPrefixLanded: !1
              }));
            }
          }) === "ended" && (Jt.current = void 0);
          return;
        }
        if (Q.key === "Enter" && !yt()) {
        ...
        if (!w || Q.key !== c) return;
        if (!yt()) {
          Q.preventDefault(), Q.stopPropagation(), (we = p.current) == null || we.selectNote(0), (ae = p.current) == null || ae.focus();
          return;
        }
...
function $p({
  ...
  const g = fe(r, "%webView_inventory_all%"), f = fe(r, "%webView_inventory_approved%"), b = fe(r, "%webView_inventory_unapproved%"), m = fe(r, "%webView_inventory_unknown%"), C = fe(r, "%webView_inventory_scope_currentBook%"), E = fe(r, "%webView_inventory_scope_chapter%"), k = fe(r, "%webView_inventory_scope_verse%"), z = fe(r, "%webView_inventory_filter_text%"), j = fe(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = fe(r, "%webView_inventory_no_results%"), [$, P] = N(!1), [S, V] = N("all"), [Y, _] = N(""), [et, B] = N([]), X = I(() => {
    const q = t ?? [];
...
function Pw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    ...
    [r, w]
  ), h = Wt.useCallback(() => p((k) => !k), [p]), g = w ? "expanded" : "collapsed", m = xe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Jp({
  ...
  const z = It(
  ...
  ], q = (A, tt, Zt = !1) => /* @__PURE__ */ u(wt, { children: [
    A,
    tt && !Zt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      tt
    ] })
  ] }), it = e ? Kt.filter((A) => e.includes(A.value)) : Kt, gt = f ?? wa, lt = w ?? gt, ft = p ?? gt, Jt = () => {
  }, Ct = F(null), xt = F(null), Et = F(!1), qt = F(null), yt = F(!1), [Vt, R] = N(void 0), kt = F(!1), _t = F(!1), te = F(null), Ge = L((A) => {
    if (A) {
    ...
    R((tt) => tt === "start" ? void 0 : tt), kt.current && (kt.current = !1, requestAnimationFrame(() => {
      var Zt;
      const tt = (Zt = Ct.current) == null ? void 0 : Zt.querySelector("button");
      tt == null || tt.click();
    }));
  }, []), le = L((A) => {
    if (A) {
    ...
    repeatBookName: !0
  }) : ee ? q(ee.label, ee.scrRefSuffix) : t, Dt = it.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), re = it.find((A) => A.value === "selectedBooks"), T = it.find((A) => A.value === "range"), [U, nt] = N(!1), [J, Z] = N(void 0), [st, Q] = N(void 0), [y, rt] = N(void 0), [at, ut] = N(void 0), [mt, Nt] = N([]), we = d === "dropdown" && J === "selectedBooks", ae = /* @__PURE__ */ a(
    eu,
    {
      availableBookInfo: o,
  ...
  ), Re = Vt === "end", mr = Vt === "start", ie = "tw:text-muted-foreground", oe = d === "dropdown" && J === "range", x = oe ? rt : de, ct = oe ? ut : g ? He : Jt, Lt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-start", className: v(Re && ie), children: M }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-end", className: v(mr && ie), children: O }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: C,
          disableReferencesUpTo: oe ? y ?? lt : lt,
          onOpenChange: le,
          onCloseAutoFocus: (A) => {
            var tt;
            _t.current && (_t.current = !1, A.preventDefault(), (tt = te.current) == null || tt.focus());
          },
          className: v(mr && ie),
          modal: !0,
          align: "start"
  ...
  const [Mt, St] = N(null), [zt, vt] = N(null), [Gt, ge] = N(null), We = 200, [$i, Ii] = N(!1);
  G(() => {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      d === "dropdown" ? /* @__PURE__ */ u(Fe, { open: U, onOpenChange: nt, children: [
        ...
        /* @__PURE__ */ a(
          Ke,
          {
            ...
            children: /* @__PURE__ */ u(ca, { container: Gt, children: [
              Dt.map(({ value: A, label: tt, dropdownLabel: Zt, scrRefSuffix: vr, id: Ai }) => /* @__PURE__ */ u(
                Ze,
                {
                  ref: De(A),
                ...
                /* @__PURE__ */ a(
                  Ze,
                  {
                    ...
                    onSelect: (A) => {
                      ...
                      yt.current || (Zt = (tt = xt.current) == null ? void 0 : tt.querySelector("button")) == null || Zt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var tt;
                              A.preventDefault(), (tt = qt.current) == null || tt.focus();
                            },
                            modal: !0,
        ...
        Ka,
        {
          ...
          children: it.map(({ value: A, label: tt, scrRefSuffix: Zt, id: vr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: vr }),
            /* @__PURE__ */ a(Rt, { htmlFor: vr, children: q(tt, Zt) })
          ] }, vr))
        }
      )
    ] }),
    ...
    d === "dropdown" && T && /* @__PURE__ */ a(Na, { open: J === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ...
        children: /* @__PURE__ */ u(ca, { container: Mt, children: [
          ...
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(H, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(H, { ref: te, onClick: mo, children: W })
          ] })
        ] })
      }
    ) })
