...
import m, { useCallback as F, useMemo as L, useState as I, useRef as U, useLayoutEffect as cn, createContext as _r, useContext as Sr, useEffect as Et, forwardRef as Cn, Fragment as _n } from "react";
...
import { X as He, Search as Sn, ChevronsLeft as pn, ChevronsRight as mn, ChevronLeft as Ie, ChevronRight as At, ArrowLeft as Er, ArrowRight as Vr, Circle as he, ChevronsUpDown as Ue, Check as _t, FilterIcon as Mr, ChevronDown as fe, ChevronUp as Dr, ArrowLeftIcon as zr, ChevronLeftIcon as Or, ChevronRightIcon as Ir, ArrowRightIcon as Ar, Copy as Pr, Filter as Br, User as jr, Link as $r, CircleHelp as Fr, Star as Gr, CircleCheckIcon as Lr, CircleXIcon as Xr, CircleHelpIcon as Hr, ArrowUpIcon as Ur, ArrowDownIcon as Yr, ArrowUpDownIcon as qr, PanelLeft as Kr, PanelRight as Jr, ScrollText as Wr, MenuIcon as Zr, Menu as Qr, EllipsisVertical as to, LoaderCircle as eo } from "lucide-react";
import * as ut from "@radix-ui/react-dialog";
import * as Qt from "@radix-ui/react-popover";
import { getChaptersForBook as no, formatScrRef as Jt, NumberFormat as ro, formatBytes as oo, getCurrentLocale as ao, deepEqual as Ye, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
const fo = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ft : "button", { className: c(fo({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
const ie = Qt.Root, we = Qt.Trigger, Lt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = Y();
...
const Fn = D.allBookIds.filter(
  (t) => !D.isObsolete(D.bookIdToNumber(t))
), at = Object.fromEntries(
  Fn.map((t) => [t, D.bookIdToEnglishName(t)])
), Oo = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon",
...
function bn({
  ...
  if (t)
    return /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ r("div", { className: c("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: mt(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Vt,
      {
        value: `${t} ${at[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ri({
  ...
  const a = Y(), [s, i] = I(!1), [w, p] = I(""), [l, u] = I(""), [g, h] = I("books"), [f, b] = I(void 0), [_, k] = I(!1), S = U(void 0), x = U(void 0), V = U(void 0), A = U(void 0), W = U({}), nt = L(() => o ? o() : Fn, [o]), it = L(() => ({
              ...
              !y && Object.entries(v).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Pt, { heading: Oo[N], children: O.map((H) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: c(
...
}), Gn = B.Trigger, Ln = B.Group, Go = B.Portal, Lo = B.Sub, Xo = B.RadioGroup;
...
function wi({
  ...
  return /* @__PURE__ */ d(ie, { onOpenChange: (l) => {
    ...
    /* @__PURE__ */ d(Lt, { className: c("tw-min-w-80 tw-max-w-96", a), children: [
      s && n["%webView_error_dump_copied_message%"] && /* @__PURE__ */ r(X, { children: n["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ r(
        sa,
        {
          errorDetails: t,
...
function li({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Qe, { children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((l, u) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Ln, { children: l.itemType === 0 ? /* @__PURE__ */ r(Zt, { children: l.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        tn,
        {
          checked: o[u][h],
...
const Wn = m.createContext({
  size: "default",
  variant: "default"
}), Zn = m.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = Y();
  return /* @__PURE__ */ r(
    ge.Root,
    {
...
const ce = m.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = m.useContext(Wn);
  return /* @__PURE__ */ r(
    ge.Item,
    {
      ref: s,
...
function xi({
  ...
  const l = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = I(!1), [A, W] = I("all"), [nt, it] = I(""), [C, v] = I([]), y = L(() => t.length === 0 ? [] : fa(t, a, s), [t, a, s]), E = L(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
...
const tr = m.forwardRef(
  ({
    ...
    const [l, u] = m.useState(t), g = e ?? l, h = m.useCallback(
      ...
      [n, g]
    ), f = m.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", S = Y() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = m.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
...
const er = m.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Se();
...
const Sa = Ct(
  ...
  ({
    ...
    const p = t ? Ft : "button", { state: l } = Se(), u = /* @__PURE__ */ r(
      p,
      {
        ref: w,
        ...
        "data-size": o,
        "data-active": e,
        className: c(Sa({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Da = m.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ft : "a",
  {
    ref: s,
...
const yt = "scrBook", Oa = "scrRef", Rt = "source", Ia = "details", Aa = "Scripture Reference", Pa = "Scripture Book", ir = "Type", Ba = "Details";
function ja(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: yt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Aa,
      cell: (o) => {
...
function Ni({
  ...
  const [p, l] = I([]), [u, g] = I([{ id: yt, desc: !1 }]), [h, f] = I({}), b = L(
...
function Xa({
  ...
  const s = ln(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], p = a["%scripture_section_dc_short%"], l = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
...
function Ha({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], w = o["%webView_book_selector_search_books%"], p = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], u = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], h = o["%scripture_section_ot_long%"], f = o["%scripture_section_nt_long%"], b = o["%scripture_section_dc_long%"], _ = o["%scripture_section_extra_long%"], [k, S] = I(!1), x = U(void 0), V = U(!1);
  if (t.length !== D.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const A = L(() => D.allBookIds.filter(
...
function _i({
  ...
  return /* @__PURE__ */ d(
    Bt,
    {
      ...
      children: [
        /* @__PURE__ */ r(Dt, { size: a, className: c("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          jt,
          {
            placeholder: i[P(e)] ?? e
          }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(an, { children: [
...
function Xe({
  ...
  return /* @__PURE__ */ d(Qe, { variant: s, children: [
    /* @__PURE__ */ r(Gn, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Zr, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, l]) => typeof p == "boolean" || typeof l == "boolean" ? 0 : p.order - l.order).map(([p], l, u) => /* @__PURE__ */ d(_n, { children: [
      /* @__PURE__ */ r(Ln, { children: /* @__PURE__ */ r(on, { children: dr(e.groups, e.items, p, t) }) }),
...
function Ei({
  ...
  return /* @__PURE__ */ d(cr, { className: `tw-w-full tw-border tw-bg-background ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      Xe,
      {
        onSelectMenuItem: t,
...
function Vi({
  ...
  return /* @__PURE__ */ r(cr, { className: `tw-pointer-events-none ${o}`, id: n, children: e && /* @__PURE__ */ r(
    Xe,
    {
      onSelectMenuItem: t,
      menuData: e,
...
function Mi({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(pr, { children: [
      /* @__PURE__ */ r(mr, { children: t.map((i) => /* @__PURE__ */ r(Ua, { value: i.value, children: i.value }, i.key)) }),
...
const vr = m.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = lt();
...
const qt = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const w = e.filter((l) => l.group === s).sort((l, u) => l.order - u.order).map((l) => /* @__PURE__ */ d(an, { children: [
    ...
    return w.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(yr, {}, `separator-${s}`)), p;
  });
};
function Za({
  menuData: t,
  ...
  const a = U(void 0), s = U(void 0), i = U(void 0), w = U(void 0), p = U(void 0), l = (u) => {
    switch (u) {
      case "platform.app":
        return s;
...
const Pi = $.Root, Bi = $.Trigger, ji = $.Group, $i = $.Portal, Fi = $.Sub, Gi = $.RadioGroup, hs = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  $.SubTrigger,
  {
    ref: a,
    className: c(
...
const Li = wt.Trigger, _s = wt.Portal, Xi = wt.Close, Cr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
const Ss = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = m.useContext(kr), i = {
...
As.displayName = et.Content.displayName;
...
const js = (t, e, n = {}) => {
  ...
  const a = U(null), [s, i] = I(void 0), [w, p] = I(void 0), l = F(
    (h) => {
      i(h);
