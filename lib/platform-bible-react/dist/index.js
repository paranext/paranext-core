...
import { r as Ft, Z as Fi, B, c as f, a as Bi, C as Te, P as ze, b as Ie, d as De, e as Ve, f as Le, g as pe, h as _r, i as ea, T as ee, S as He, j as re, k as ae, l as oe, D as Ge, m as br, n as _e, o as Ne, p as Ce, u as Ui, q as Nr, s as Ye, t as Re, v as Sa, w as dn, x as Ki, y as qi, z as wn, A as un, E as Gi, F as Hi, G as Yi, H as Wi, I as wa, J as ua, K as ir, L as Xi, M as Ji, N as Zi, O as Qi, Q as ts, R as Cr, U as Ya } from "./resizable-CUvCloPJ.js";
...
import { includes as Rr, Section as Z, getChaptersForBook as es, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as rs, formatReplacementString as xe, sanitizeHtml as jr, NumberFormat as as, formatBytes as os, getCurrentLocale as ns, usfmMarkers as Fr, getFormatCallerFunction as is, deepEqual as ss, isString as bo, compareScrRefs as Oa, scrRefToBBBCCCVVV as pa, defaultScrRef as ha, formatScrRefRange as cs, getLocalizeKeyForScrollGroupId as xo } from "platform-bible-utils";
...
import { useReactTable as Pn, getFilteredRowModel as Zc, getSortedRowModel as In, getPaginationRowModel as Qc, getCoreRowModel as Vn, flexRender as mr, getGroupedRowModel as tl, getExpandedRowModel as el } from "@tanstack/react-table";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Va, HIDDEN_NOTE_CALLER as La, getDefaultViewOptions as al, isInsertEmbedOpOfType as Pr, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Gn ? Jt : Y, Ir = { tag: Ja };
...
function Pl(t, e = Al) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = g.getNode(), x = m.getKey(), v = g.offset, E = h.getNode(), C = E.getKey(), k = h.offset, _ = t.getElementByKey(x), I = t.getElementByKey(C), F = r === null || _ !== o || v !== n || x !== r.getKey(), V = i === null || I !== s || k !== c || C !== i.getKey();
...
function Vl(t) {
  const e = Tn(t, (r) => xr(r) && !r.isInline());
  return xr(e) || Yr(4, t.__key), e;
}
function Ll(t) {
  const e = jt() || Hs();
  let r;
...
function jl(t, e, r) {
  ...
  return rc(o) && Yr(283), o.insert(t.isInline() ? Er().append(t) : t), Do(En(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = jt();
  if (!ge(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Tn(i, (l) => xr(l) && !l.isInline());
    if (c === null) continue;
    const d = c.getKey();
...
let Wr, ke = 0, Xr = 0, Kl = 0, Ka = 0, Ur = 0;
function jo(t) {
  if (et === void 0) return;
  let e = t.n;
...
function Ke(t, e) {
  At.call(this, void 0), this.x = t, this.s = void 0, this.g = Ur - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ql(t, e) {
  return new Ke(t, e);
}
...
At.prototype.brand = Bl, At.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ke !== 0 && Xr === 0 && e.l !== Ka && (e.l = Ka, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, Ur++, ke++;
    try {
  ...
  if (this.g = Ur, this.f |= 1, this.i > 0 && !Yn(this)) return this.f &= -2, !0;
  const t = et;
  try {
    Fo(this), et = this;
    const e = this.x();
...
ne({ build: (t, e, r) => cr(e), config: Qe({ $onClear: Jn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const no = 0, Ga = 1, ri = 2, xa = 3, Vr = 4, er = 5, ya = 6, hr = 7;
function ka(t) {
  return t.id === no;
}
function ai(t) {
...
const ed = /* @__PURE__ */ new Set(), qo = ne({ build(t, e, r) {
  const o = r.getDependency(qa).output, n = yr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ti(() => {
  }, () => fe(() => {
...
ne({ dependencies: [qa, qo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(qo).output, n = yr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ee(t.registerCommand(rd, (s) => {
    ...
    if (pc(s.target)) {
      ...
      if (od(c)) return function(d, l = !1) {
        ...
        let h;
        l && Sn(w) ? h = w : (h = gc(), fc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
ne({ build: (t, e, r) => cr(e), config: Qe({ $canIndent: oi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
ne({ build: (t, e, r) => cr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : ii(t)) });
function dd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Xo({
  ...
  const h = j(
    ...
    [t.user]
  ), C = L(() => jr(t.contents), [t.contents]), k = L(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
...
function jd({
  ...
  const gt = j(
    ...
    async (T) => {
      const wt = Qt($) ? Zr($) : void 0, pt = T.status ? T.assignedUser : z ?? T.assignedUser, kt = await p({
        ...T,
        contents: wt,
        assignedUser: pt
      });
...
function dp({
  ...
  const [i, s] = N("accept"), c = r ?? i, d = qs(), l = L(
    () => Zo(jr(t.rejectedText ?? "")),
    [t.rejectedText]
  ), w = L(
    () => Zo(jr(t.acceptedText ?? "")),
    [t.acceptedText]
  ), p = L(() => jr(t.contents), [t.contents]);
...
function Jd({
  ...
  var F;
  const [w, p] = N([]), [g, h] = N([]), [m, x] = N({}), [v, E] = N({}), C = L(() => e ?? [], [e]), k = Pn({
    data: C,
    columns: t,
    getCoreRowModel: Vn(),
  ...
  return d ? I = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(te, { colSpan: _.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Sa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? I = k.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(ia, { stickyHeader: i, children: [
      /* @__PURE__ */ a(uo, { stickyHeader: i, children: k.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : mr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function fp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(_e, { children: [
    ...
    /* @__PURE__ */ a(Ce, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(dn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][g],
...
function _p({
  ...
  const w = d ?? is(r, void 0), p = (C, k) => {
    l == null || l(C, k, n);
  }, g = i ? r.findIndex((C) => C === i) : -1, [h, m] = N(g), x = (C, k, _) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
...
const kw = (t) => {
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Sp = Object.freeze([
...
const yi = aa(({ className: t, ...e }, r) => /* @__PURE__ */ a(Vs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Ow({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = Ft() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function Vw({
  ...
  const c = t ? sr.Root : "button", { state: d } = da(), l = /* @__PURE__ */ a(
    c,
    {
...
function Yp({
  ...
  const [l, w] = N([]), [p, g] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), x = L(
...
function Xp({
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, T] = N(!1), [wt, pt] = N(void 0), [kt, Fe] = N(void 0), [Oe, lr] = N(void 0), [Be, dr] = N(void 0), [wr, Dr] = N([]), Sr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  const [Wt, Ue] = N(null), [Or, Mi] = N(null), [$r, Ri] = N(null), Ai = 200, [Pi, Ii] = N(!1);
  Y(() => {
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(_e, { open: Ct, onOpenChange: T, children: [
        ...
        /* @__PURE__ */ a(
          Ce,
          {
            ...
            children: /* @__PURE__ */ u(wa, { container: $r, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: pr, id: Vi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
        ...
        Kn,
        {
          ...
          children: rt.map(({ value: R, label: X, scrRefSuffix: Lt, id: pr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Ba, { className: "tw:me-2", value: R, id: pr }),
    ...
    l === "radio" && t === "range" && _t,
    l === "dropdown" && yt && /* @__PURE__ */ a(ja, { open: wt === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Mi,
        onCloseAutoFocus: mo,
    ...
    l === "dropdown" && gt && /* @__PURE__ */ a(ja, { open: wt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Ue,
        onCloseAutoFocus: mo,
...
function Ha({
  ...
  return /* @__PURE__ */ u(_e, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ce, { align: "start", style: { zIndex: ir }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(yn, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(_e, { children: [
              /* @__PURE__ */ a(Ne, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(No, {}) }) }),
...
export {
  ...
  Ph as Progress,
  $p as RESOURCE_PICKER_DIALOG_STRING_KEYS,
  Kn as RadioGroup,
