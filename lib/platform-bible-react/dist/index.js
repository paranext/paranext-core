...
import { c as m, g as me, a as _r, C as Se, u as Io, T as Dt, b as Mt, d as Ot, e as It, A as de, P as Pe, f as Qe, B as X, h as Ae, i as Ve, j as Le, k as Ee, x as Xi, l as Ji, m as Zi, I as Qi, n as so, r as ye, Z as ts, o as En, p as la, q as da, L as Et, R as co, s as ea, D as Ba, t as Fa, v as Ua, w as Ka, y as Tn, z as qr, E as lo, F as Sn, G as wo, H as Je, J as Er, K as je, M as Be, N as Fe, S as Tr, O as nr, Q as es, U as zr, V as Ze, W as Oe, X as tr, Y as De, _ as ir, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as Rn, a4 as rs, a5 as as, a6 as os, a7 as Ha, a8 as zn, a9 as wa, aa as ns, ab as Dn, ac as is, ad as ss, ae as cs, af as $o, ag as ls, ah as ds, ai as ws, aj as us, ak as Mn, al as On, am as go, an as ps, ao as In, ap as Ca, aq as Po, ar as Ea, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Dr, ay as fo, az as bs, aA as xs } from "./resizable-IStUK-JI.js";
import { aB as Ag, aC as Vg, aD as Lg, aE as jg, aF as Bg, aG as Fg, aH as Ug, aI as Kg, aJ as Hg, aK as qg, aL as Gg, aM as Wg, aN as Yg, aO as Xg, aP as Jg, aQ as Zg, aR as Qg, aS as tf, aT as ef, aU as rf, aV as af, aW as of, aX as nf, aY as sf } from "./resizable-IStUK-JI.js";
import { jsx as a, jsxs as u, Fragment as lt } from "react/jsx-runtime";
import { Canon as zt } from "@sillsdev/scripture";
import { Check as Ie, Clock as Ao, ChevronsLeft as Vo, ChevronsRight as Lo, ChevronLeft as qa, ChevronRight as Ga, ArrowLeft as ys, ArrowRight as ks, ChevronDown as lr, BoldIcon as _s, ItalicIcon as Ns, X as mo, AtSign as $n, Pencil as Cs, Trash2 as Es, ArrowUp as Pn, MoreHorizontal as Ts, MailOpen as Ss, Mail as Rs, ChevronUp as zs, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Os, ChevronRightIcon as Is, ArrowRightIcon as $s, Copy as An, Filter as Ps, User as As, Link as Vs, CircleHelp as Ls, Undo as js, Redo as Bs, SquareX as Vn, FunctionSquare as Ln, SquareSigma as jn, Ban as Fs, AlertCircle as Wa, CircleCheckIcon as Us, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as qs, ArrowDownIcon as Gs, ScrollText as Ws, ChevronsUpDown as Ys, MenuIcon as Xs, Menu as Js, EllipsisVertical as Zs, MoreVertical as Qs } from "lucide-react";
import { Section as Ct, getChaptersForBook as tc, formatScrRef as Ne, formatReplacementString as Me, getSectionForBook as Gr, formatRelativeDate as ec, sanitizeHtml as vo, NumberFormat as Bn, formatBytes as rc, getCurrentLocale as ac, usfmMarkers as Wr, isPlatformError as oc, ABORTED as nc, getErrorMessage as ic, getFormatCallerFunction as sc, deepEqual as cc, isString as jo, compareScrRefs as Ya, scrRefToBBBCCCVVV as Ta, defaultScrRef as Sa, formatScrRefRange as lc, getLocalizeKeyForScrollGroupId as Bo, formatReplacementStringToArray as Fo, collectUsjMarkers as dc } from "platform-bible-utils";
import Yt, { useRef as F, useMemo as A, createContext as ua, useContext as bo, useState as _, useEffect as W, useCallback as j, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
import { GENERATOR_NOTE_CALLER as Za, HIDDEN_NOTE_CALLER as Qa, getDefaultViewOptions as _l, isInsertEmbedOpOfType as xr, getMarkerMenuItems as Nl, defaultStyleInfo as Cl, Editorial as El } from "@eten-tech-foundation/platform-editor";
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ul = di ? te : W, Ur = { tag: xo };
...
let oa, Ce = 0, na = 0, pd = 0, ao = 0, Jr = 0;
function nn(t) {
  if (it === void 0) return;
  let e = t.n;
...
const Nd = /* @__PURE__ */ new Set(), wn = ne({ build(t, e, r) {
  const o = r.getDependency(oo).output, n = Rr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = vi(() => {
  }, () => xe(() => {
...
const rw = "verseText", zp = Object.freeze([
...
function fn({
  ...
  const g = j(
    ...
    [t.user]
  ), y = A(() => vo(t.contents), [t.contents]), C = A(
...
function kw({
  ...
  return l ? $ = Array.from({ length: 10 }).map((D, K) => `skeleton-row-${K}`).map((D) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? $ = C.getRowModel().rows.map((U) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: C.getHeaderGroups().map((U) => /* @__PURE__ */ a(De, { children: U.headers.map((V) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: V.isPlaceholder ? void 0 : Nr(V.column.columnDef.header, V.getContext()) }, V.id)) }, U.id)) }),
...
function Xp({
  ...
  W(() => {
    ...
    if (b && xr("note", b)) {
      ...
      let st = "custom";
      et === Za ? st = "generated" : et === Qa ? st = "hidden" : et && ($(et), U(et)), R(st), C(st), D(((P = b.insert.note) == null ? void 0 : P.style) ?? "f"), S = setTimeout(() => {
        var ht, xt, _t;
...
const Yw = (t) => {
  ...
  return e ? e[1] : "";
}, Jw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", nh = Object.freeze([
...
function yh({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    ...
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: R.getHeaderGroups().map((D) => /* @__PURE__ */ a(De, { children: D.headers.filter((K) => K.column.columnDef.header).map((K) => (
...
const Zu = (t, e, r = {}) => {
  ...
  const s = A(() => {
    ...
    return async () => {
      try {
        const p = await t();
        return w === i.current && n(!1), p;
      } catch (p) {
        throw w === i.current && n(!0), p;
      }
    };
  }, [t, e]), [c, l] = Zu(s, void 0), d = j(() => {
    n(!1), r((w) => w + 1);
  }, []);
  return A(
    () => ({ data: c, isLoading: l, hasError: o, refetch: d }),
    [c, l, o, d]
  );
};
function Dg(t) {
