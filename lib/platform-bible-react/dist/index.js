...
const Jt = M.Root, ye = M.Trigger, tn = M.Group, Mr = M.Portal, Vr = M.Sub, Jo = M.RadioGroup, en = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ d(
  M.SubTrigger,
  {
    ref: o,
    className: l(
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(dr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(pr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ds = (t) => ({
  ...
  return e ? e[1] : "";
}, Ea = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", us = Object.freeze([
...
const Ga = ft(
  // CUSTOM: Removed data-[active=true]:tw-bg-sidebar-accent active:tw-bg-sidebar-accent active:tw-text-sidebar-accent-foreground hover:tw-bg-sidebar-accent hover:tw-text-sidebar-accent-foreground data-[active=true]:tw-text-sidebar-accent-foreground
  "tw-peer/menu-button tw-flex tw-w-full tw-items-center tw-gap-2 tw-overflow-hidden tw-rounded-md tw-p-2 tw-text-left tw-text-sm tw-outline-none tw-ring-sidebar-ring tw-transition-[width,height,padding] focus-visible:tw-ring-2 disabled:tw-pointer-events-none disabled:tw-opacity-50 tw-group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:tw-pointer-events-none aria-disabled:tw-opacity-50 data-[active=true]:tw-font-medium data-[state=open]:hover:tw-bg-sidebar-accent data-[state=open]:hover:tw-text-sidebar-accent-foreground group-data-[collapsible=icon]:tw-!size-8 group-data-[collapsible=icon]:tw-!p-2 [&>span:last-child]:tw-truncate [&>svg]:tw-size-4 [&>svg]:tw-shrink-0",
  {
    variants: {
      variant: {
        // CUSTOM: re-added classes removed above
        default: "data-[active=true]:tw-bg-sidebar-accent data-[active=true]:tw-text-sidebar-accent-foreground active:tw-bg-sidebar-accent active:tw-text-sidebar-accent-foreground  hover:tw-bg-sidebar-accent hover:tw-text-sidebar-accent-foreground",
        // CUSTOM: re-added classes removed above
        outline: "data-[active=true]:tw-bg-sidebar-accent data-[active=true]:tw-text-sidebar-accent-foreground active:tw-bg-sidebar-accent active:tw-text-sidebar-accent-foreground tw-bg-background tw-shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:tw-bg-sidebar-accent hover:tw-text-sidebar-accent-foreground hover:tw-shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
        // CUSTOM: new variant
        muted: "tw-text-muted-foreground data-[active=true]:tw-bg-muted data-[active=true]:tw-text-foreground hover:tw-text-foreground"
      },
      size: {
    ...
    kn,
    {
      ...
      children: /* @__PURE__ */ d(Sn, { children: [
        /* @__PURE__ */ d(me, { children: [
          /* @__PURE__ */ r(he, { className: "tw-text-sm tw-text-muted-foreground", children: i }),
        ...
        /* @__PURE__ */ d(me, { children: [
          /* @__PURE__ */ r(he, { className: "tw-text-sm tw-text-muted-foreground", children: w }),
          /* @__PURE__ */ r(ge, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            ue,
            {
              buttonVariant: "ghost",
              buttonClassName: l("tw-w-full", {
                "tw-bg-muted": o == null ? void 0 : o.projectId
              }),
  ...
  return /* @__PURE__ */ r("div", { id: t, className: e, children: n.map((w) => /* @__PURE__ */ d("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ r(
      De,
      {
        ...
        onCheckedChange: (s) => o(w, s)
      }
    ),
    /* @__PURE__ */ r(J, { children: i ? i(w) : w })
  ] }, w)) });
}
function _s({
  id: t,
