...
var _i = (t, e, n) => e in t ? ki(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var Ht = (t, e, n) => _i(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as Kn, useRef as q, useMemo as z, useState as D, useCallback as G, useEffect as J, useLayoutEffect as Qt, createContext as mr, useContext as po, Component as Ci, createElement as Go, Suspense as Ei, Fragment as uo } from "react";
import { Command as Wt } from "cmdk";
import { X as gn, Search as _a, Check as ee, Clock as Fo, ChevronsLeft as zo, ChevronsRight as Ko, ChevronLeft as Kr, ChevronRight as wn, ArrowLeft as Ti, ArrowRight as Ca, Circle as fr, ChevronDown as Oe, BoldIcon as Si, ItalicIcon as Ri, AtSign as Ea, Pencil as Ii, Trash2 as Di, ArrowUp as Ta, MoreHorizontal as Oi, MailOpen as Mi, Mail as Ai, ChevronUp as Sa, FilterIcon as Pi, ArrowLeftIcon as $i, ChevronLeftIcon as ji, ChevronRightIcon as Li, ArrowRightIcon as Vi, Copy as Ra, Filter as Ia, User as Bi, Link as Gi, CircleHelp as Fi, ChevronsUpDown as mo, Star as zi, Undo as Ki, Redo as qi, SquareX as Da, FunctionSquare as Oa, SquareSigma as Ma, Ban as Hi, AlertCircle as qr, CircleCheckIcon as Ui, CircleXIcon as Yi, CircleHelpIcon as Xi, ArrowUpIcon as Wi, ArrowDownIcon as Ji, PanelLeft as Zi, PanelRight as Qi, ScrollText as tl, MenuIcon as el, Menu as nl, EllipsisVertical as rl, MoreVertical as qo, LoaderCircle as ol, GripVertical as al } from "lucide-react";
import { clsx as sl } from "clsx";
import { extendTailwindMerge as il } from "tailwind-merge";
import * as te from "@radix-ui/react-dialog";
import { Canon as pt } from "@sillsdev/scripture";
import { includes as Un, Section as Q, getChaptersForBook as ll, formatScrRef as Re, getSectionForBook as Pn, formatRelativeDate as cl, formatReplacementString as Ze, sanitizeHtml as dl, NumberFormat as wl, formatBytes as pl, getCurrentLocale as ul, usfmMarkers as Zn, getFormatCallerFunction as ml, deepEqual as fl, isString as Ho, compareScrRefs as Hr, scrRefToBBBCCCVVV as Cr, defaultScrRef as Er, formatScrRefRange as hl, getLocalizeKeyForScrollGroupId as at } from "platform-bible-utils";
...
import { createEditor as Pa, $getRoot as Me, $createParagraphNode as vn, $getSelection as Xt, HISTORY_MERGE_TAG as fo, ParagraphNode as $a, TextNode as ja, $isTokenOrSegmented as gl, $getCharacterOffsets as bl, $cloneWithPropertiesEphemeral as vl, $getPreviousSelection as xl, $isRangeSelection as ve, $caretFromPoint as yl, $getSiblingCaret as La, $getChildCaret as Nl, $getAdjacentChildCaret as kl, $isChildCaret as _l, $normalizeCaret as Cl, $setSelectionFromCaretRange as El, $getCollapsedCaretRange as Tl, $getCaretInDirection as Uo, $splitAtPointCaretNext as Sl, $isTextPointCaret as Rl, $findMatchingParent as Va, $isElementNode as Ie, mergeRegister as Ae, getDOMTextNode as Il, isHTMLElement as Ba, CLEAR_EDITOR_COMMAND as Ga, COMMAND_PRIORITY_EDITOR as ho, shallowMergeConfig as Dl, defineExtension as ae, safeCast as on, createState as Ol, FORMAT_TEXT_COMMAND as Fa, $isNodeSelection as za, COMMAND_PRIORITY_LOW as Ka, RootNode as Ml, LineBreakNode as Al, TabNode as Pl, $isEditorState as $l, createCommand as jl, CLICK_COMMAND as Ll, isDOMNode as Vl, $getNodeFromDOMNode as Bl, $createNodeSelection as Gl, $setSelection as Fl, $getEditor as zl, DecoratorNode as Ur, $getState as Kl, toggleTextFormatType as Yo, TEXT_TYPE_TO_FORMAT as ql, $setState as Hl, addClassNamesToElement as qa, $create as Ul, $getNodeByKey as Yl, removeClassNamesFromElement as Xl, KEY_TAB_COMMAND as Wl, $isBlockElementNode as nr, $createRangeSelection as Jl, $normalizeSelection__EXPERIMENTAL as Zl, OUTDENT_CONTENT_COMMAND as Ql, INDENT_CONTENT_COMMAND as Xo, INSERT_TAB_COMMAND as tc, COMMAND_PRIORITY_CRITICAL as go, $isDecoratorNode as ec, $isParagraphNode as nc, $isTextNode as rr, SELECTION_CHANGE_COMMAND as Ha, getRegisteredNode as rc, isDocumentFragment as Wo, isDOMDocumentNode as oc, ArtificialNode__DO_NOT_USE as Ua, $createLineBreakNode as Ya, $isRootOrShadowRoot as ac, isBlockDomNode as Jo, isInlineDomNode as Zo, $insertNodes as sc } from "lexical";
import * as en from "@radix-ui/react-tooltip";
import { TooltipTrigger as ic } from "@radix-ui/react-tooltip";
import { HeadingNode as lc, QuoteNode as cc, registerRichText as dc } from "@lexical/rich-text";
import { flushSync as wc, createPortal as pc } from "react-dom";
import { $isTableSelection as uc } from "@lexical/table";
import * as hr from "@radix-ui/react-toggle-group";
import * as Xa from "@radix-ui/react-toggle";
import { createHeadlessEditor as Wa } from "@lexical/headless";
...
import { useReactTable as Za, getFilteredRowModel as fc, getSortedRowModel as Qa, getPaginationRowModel as hc, getCoreRowModel as ts, flexRender as $n, getGroupedRowModel as gc, getExpandedRowModel as bc } from "@tanstack/react-table";
import * as kt from "@radix-ui/react-select";
import vc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Yr, HIDDEN_NOTE_CALLER as Xr, getDefaultViewOptions as xc, isInsertEmbedOpOfType as Yn, Editorial as yc } from "@eten-tech-foundation/platform-editor";
...
import * as bo from "react-resizable-panels";
...
const _c = il({ prefix: "tw-" });
function h(...t) {
  return _c(sl(t));
}
const qn = 250, es = 300, vo = 400, Cc = 450, Ec = 500, Tc = 550, Sc = "layoutDirection";
function _t() {
  const t = localStorage.getItem(Sc);
  return t === "rtl" ? t : "ltr";
}
const Qr = te.Root, rm = te.Trigger, Rc = te.Portal, om = te.Close, ns = b.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  te.Overlay,
  {
    ref: o,
    className: h(
...
ns.displayName = te.Overlay.displayName;
const or = b.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = _t();
  return /* @__PURE__ */ p(Rc, { children: [
    /* @__PURE__ */ r(ns, { className: n }),
    /* @__PURE__ */ p(
      te.Content,
      {
        ref: s,
...
or.displayName = te.Content.displayName;
...
sr.displayName = te.Title.displayName;
...
Ic.displayName = te.Description.displayName;
...
const an = b.forwardRef(({ className: t, onKeyDown: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: a, children: [
    /* @__PURE__ */ r(_a, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Wt.Input,
      {
        ref: o,
...
_e.displayName = Wt.List.displayName;
const yn = b.forwardRef((t, e) => /* @__PURE__ */ r(Wt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
yn.displayName = Wt.Empty.displayName;
...
oe.displayName = Wt.Group.displayName;
...
gr.displayName = Wt.Separator.displayName;
const se = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Wt.Item,
  {
    ref: n,
    className: h(
...
se.displayName = Wt.Item.displayName;
...
rs.displayName = "CommandShortcut";
const os = (t, e, n, o, a) => {
  switch (t) {
    case Q.OT:
...
const as = pt.allBookIds.filter(
  (t) => !pt.isObsolete(pt.bookIdToNumber(t))
), ie = Object.fromEntries(
  as.map((t) => [t, pt.bookIdToEnglishName(t)])
);
function yo(t, e, n) {
...
const ss = Kn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? bn : "button", { className: h(is({ variant: e, size: n, className: t })), ref: s, ...a })
);
F.displayName = "Button";
const Ce = pn.Root, je = pn.Trigger, Oc = pn.Anchor, ls = b.createContext(null);
function Tr({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ r(ls.Provider, { value: t, children: e });
}
const we = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = _t(), l = b.useContext(ls);
  return (
...
we.displayName = pn.Content.displayName;
function cs(t, e, n) {
  return `${t} ${ie[t]}${e ? ` ${xo(t, e)} ${Fe(t, e)}` : ""}`;
}
function Mc({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(Ce, { open: w, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(we, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ke, { children: /* @__PURE__ */ r(_e, { children: /* @__PURE__ */ r(oe, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      se,
      {
        onSelect: () => f(u),
        className: h("tw-flex tw-items-center", l),
        children: [
          /* @__PURE__ */ r(Fo, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function am(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
const Qn = {
  ...
  Qn.BOOK_ONLY,
  Qn.BOOK_CHAPTER,
  Qn.BOOK_CHAPTER_VERSE
];
function Pc(t) {
  return Qn.BOOK_CHAPTER_VERSE.test(t.trim());
}
function Qo(t, e) {
...
function Lc(t, e, n, o) {
  const a = G(() => {
    if (t.chapterNum > 1)
      ...
      if (d > 0) {
        const c = e[d - 1], w = Math.max(be(c), 1);
        o({
          book: c,
          chapterNum: w,
          verseNum: 1
...
function ea({
  ...
  if (t)
    return /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: be(t) }, (l, d) => d + 1).map((l) => {
...
function na({
  ...
  if (!(!t || n <= 0))
    return /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", d), children: Array.from({ length: n }, (c, w) => w + 1).map((c) => {
...
function Rr({
  ...
  const R = _t(), [I, S] = D(!1), [V, _] = D(""), [T, C] = D(""), [v, E] = D("books"), [P, j] = D(void 0), [M, $] = D(
    void 0
  ), [H, Y] = D(void 0), [tt, Rt] = D(!1), Gt = q(null), jt = q(!1), it = q(void 0), gt = q(void 0), K = q(void 0), nt = q(void 0), lt = q({}), ot = q({}), ct = G(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
  ...
  }), [Ft]), zt = z(() => Object.values(Ot).flat(), [Ot]), ue = z(() => {
    if (!T.trim()) return Ot;
    const k = {
      [Q.OT]: [],
      [Q.NT]: [],
  ...
  const me = G(() => {
    if (A) {
      const k = A.chapterNum ?? 1, U = A.verseNum ?? 1;
      if (w && Sr(A.book, k, U, w))
        return;
      ct({
        book: A.book,
        chapterNum: k,
    ...
    const k = M;
    $(void 0), Y(void 0), k ? (j(k), E("chapters"), _("")) : vt();
  }, [M, vt]), It = G((k) => {
    S(k), k && (E("books"), j(void 0), $(void 0), Y(void 0), C(""));
    ...
    () => Pc(T),
    [T]
  ), Cn = z(() => !c || !A || !A.chapterNum || !Ue ? !1 : c(A.book, A.chapterNum) > 0, [c, A, Ue]), En = G(
    (k) => w ? Qo(k, w) : !1,
    [w]
  ), Tn = G(
    (k) => (U) => w ? $c(k, U, w) : !1,
    ...
    (k, U) => (Z) => w ? Sr(k, U, Z, w) : !1,
    [w]
  ), sn = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ve = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Rn = G(
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), m && m.includes(k.key) && A && A.chapterNum !== void 0 && A.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), me());
    },
    [m, A, me]
  ), In = G(
    (k) => {
      var Te, Be, Ye;
      if (k.ctrlKey) return;
      const { isLetter: U, isDigit: Z } = ta(k.key);
      if ((v === "chapters" || v === "verses") && (k.key === " " || k.key === "Enter")) {
        ...
        const St = (Te = it.current) == null ? void 0 : Te.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (St) {
      ...
      if (v === "chapters" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), vt();
        return;
      }
      if (v === "verses" && k.key === "Backspace") {
        k.preventDefault(), k.stopPropagation(), xt();
        return;
      }
      const Kt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(k.key);
      if (v === "verses" && Kt) {
        const Dt = M, Tt = H;
        if (!Dt || !Tt || !c) return;
        const St = c(Dt, Tt);
        if (!St) return;
        (Be = it.current) == null || Be.focus();
        const Nt = (() => {
          if (!V) return 1;
          const Xe = V.match(/:(\d+)$/);
        ...
        switch (k.key) {
          case "ArrowLeft":
            Nt !== 0 && (qt = Nt > 1 ? Nt - 1 : St);
            break;
          case "ArrowRight":
            Nt !== 0 && (qt = Nt < St ? Nt + 1 : 1);
            break;
          case "ArrowUp":
            qt = Nt === 0 ? St : Math.max(1, Nt - fe);
            break;
          case "ArrowDown":
            qt = Nt === 0 ? 1 : Math.min(St, Nt + fe);
            break;
          default:
            return;
        }
        qt !== Nt && (k.preventDefault(), k.stopPropagation(), _(
          `${Dt} ${ie[Dt] || ""} ${Tt}:${qt}`
        ), setTimeout(() => {
          const Xe = ot.current[qt];
          Xe && Xe.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((v === "chapters" || v === "books" && A) && Kt) {
        const Dt = v === "chapters" ? P : A == null ? void 0 : A.book;
        if (!Dt) return;
        v === "chapters" && ((Ye = it.current) == null || Ye.focus());
        const Tt = (() => {
          if (!V) return 1;
          const fe = V.match(/(\d+)$/);
        ...
        switch (k.key) {
          case "ArrowLeft":
            Tt !== 0 && (Nt = Tt > 1 ? Tt - 1 : St);
            break;
          case "ArrowRight":
            Tt !== 0 && (Nt = Tt < St ? Tt + 1 : 1);
            break;
          case "ArrowUp":
            Nt = Tt === 0 ? St : Math.max(1, Tt - qt);
            break;
          case "ArrowDown":
            Nt = Tt === 0 ? 1 : Math.min(St, Tt + qt);
            break;
          default:
            return;
        }
        Nt !== Tt && (k.preventDefault(), k.stopPropagation(), _(
          `${Dt} ${ie[Dt] || ""} ${Nt}`
        ), setTimeout(() => {
          const fe = lt.current[Nt];
    ...
    if (k.key === "ArrowUp" || k.key === "ArrowDown") {
      (Kt = gt.current) == null || Kt.focus();
      return;
    }
    const { isLetter: U, isDigit: Z } = ta(k.key);
    (U || Z) && (k.preventDefault(), C((Te) => Te + k.key), gt.current.focus(), Rt(!1));
  }, []);
  return Qt(() => {
    const k = setTimeout(() => {
      if (I && v === "books" && K.current && nt.current) {
        const U = K.current, Z = nt.current, Kt = Z.offsetTop, Te = U.clientHeight, Be = Z.clientHeight, Ye = Kt - Te / 2 + Be / 2;
        U.scrollTo({
          top: Math.max(0, Ye),
          behavior: "smooth"
        }), _(cs(t.book));
    ...
    if (v === "chapters" && P) {
      const k = P === t.book, U = k ? t.chapterNum : 1;
      _(
        `${P} ${ie[P] || ""} ${U}`
      ), setTimeout(() => {
        if (K.current)
    ...
    if (v === "verses" && M && H !== void 0) {
      const k = M === t.book && H === t.chapterNum, U = k ? t.verseNum : 1;
      _(
        `${M} ${ie[M] || ""} ${H}:${U}`
      ), setTimeout(() => {
        if (K.current)
          if (k) {
            const Z = ot.current[t.verseNum];
            Z && Z.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            K.current.scrollTo({ top: 0 });
        it.current && it.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ p(Ce, { open: I, onOpenChange: It, modal: x, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
        ref: Gt,
        ...
        onClick: (k) => {
          jt.current && (jt.current = !1, k.preventDefault());
        },
        children: f ?? /* @__PURE__ */ r("span", { className: "tw-truncate", children: qe })
      }
    ) }),
    /* @__PURE__ */ r(
      we,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: U } = k;
          Gt.current && U instanceof Node && Gt.current.contains(U) && (jt.current = !0, It(!1));
        },
        onCloseAutoFocus: y,
        children: /* @__PURE__ */ p(
          ke,
          {
            ...
            children: [
              v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: dt.map(({ onClick: k, disabled: U, title: Z, icon: Kt }) => /* @__PURE__ */ r(
                  F,
                  {
                    variant: "ghost",
                    size: "sm",
                ...
                /* @__PURE__ */ r(
                  F,
                  {
                    ...
                    children: R === "ltr" ? /* @__PURE__ */ r(Ti, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ca, { className: "tw-h-4 tw-w-4" })
                  }
                ),
                v === "chapters" && P && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Fe(P, a) }),
                v === "verses" && M && H !== void 0 && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: `${Fe(M, a)} ${H}` }),
                /* @__PURE__ */ r(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw-ms-auto tw-text-sm tw-font-medium tw-text-muted-foreground",
                    children: v === "verses" ? Ve : sn
                  }
                )
              ] }),
              !tt && /* @__PURE__ */ p(_e, { ref: K, children: [
                v === "books" && /* @__PURE__ */ p(st, { children: [
                  !A && Object.entries(ue).map(([k, U]) => {
                    if (U.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ r(oe, { heading: yt(k), children: U.map((Z) => /* @__PURE__ */ r(
                          ss,
                          {
                            bookId: Z,
                            onSelect: (Kt) => B(Kt),
                  ...
                  A && /* @__PURE__ */ r(oe, { children: /* @__PURE__ */ r(
                    se,
                    {
                      value: `${A.book} ${ie[A.book]} ${A.chapterNum || ""}:${A.verseNum || ""})}`,
                      onSelect: me,
                      disabled: !!w && Sr(
                        A.book,
                        A.chapterNum ?? 1,
                      ...
                      children: Re(
                        ...
                        a ? xo(A.book, a) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  A && Cn && A.chapterNum && c && /* @__PURE__ */ p(st, { children: [
                    ...
                    /* @__PURE__ */ r(
                      na,
                      {
                        ...
                        onVerseSelect: Mt,
                        setVerseRef: _n,
                        isVerseDisabled: Sn(A.book, A.chapterNum),
                        className: "tw-px-4 tw-pb-4"
                      }
                    )
                  ] }),
                  A && !Cn && be(A.book) > 1 && /* @__PURE__ */ p(st, { children: [
                    /* @__PURE__ */ p("div", { className: "tw-mb-2 tw-flex tw-items-center tw-justify-between tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: [
...
), Et = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Aa.Root, { ref: n, className: h("pr-twp", Vc(), t), ...e }));
Et.displayName = Aa.Root.displayName;
const No = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Vn.Root,
    {
...
No.displayName = Vn.Root.displayName;
const ir = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Vn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Vn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(fr, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ir.displayName = Vn.Item.displayName;
function Bc(t) {
...
function eo({
  ...
  return /* @__PURE__ */ p(Ce, { open: I, onOpenChange: S, ...R, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: g,
        role: "combobox",
    ...
    /* @__PURE__ */ r(
      we,
      {
        ...
        style: s,
        children: /* @__PURE__ */ p(ke, { children: [
          /* @__PURE__ */ r(an, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(yn, { children: u }),
          /* @__PURE__ */ r(_e, { children: _(e) ? e.map((C) => /* @__PURE__ */ r(oe, { heading: C.groupHeading, children: C.options.map((v) => T(v, C.groupHeading)) }, C.groupHeading)) : e.map((C) => T(C)) })
        ] })
      }
    )
  ] });
...
function lm({
  ...
  const w = Ir(c, "%webView_bookSelector_currentBook%"), m = Ir(c, "%webView_bookSelector_choose%"), f = Ir(c, "%webView_bookSelector_chooseBooks%"), [u, g] = D(
    "current book"
    /* CurrentBook */
  ), y = (x) => {
    g(x), t(x);
    ...
    No,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Et, { className: "tw-flex tw-items-center", children: o.map((x) => pt.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            F,
            {
...
const ws = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zc = ws ? Qt : J, Xn = { tag: fo };
function Kc({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: d } = t, c = Fc(null, o), w = Pa({ editable: t.editable, html: d, namespace: a, nodes: s, onError: (m) => i(m, w), theme: o });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = vn();
            u.append(g);
            const y = ws ? document.activeElement : null;
  ...
  }, []), r(ds.Provider, { value: n, children: e });
}
const qc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : J;
function Hc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return qc(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: d }) => {
      e && s.size === 0 && i.size === 0 || t && d.has(fo) || l.isEmpty() || n(a, o, d);
    });
  }, [o, t, e, n]), null;
}
const ko = {
  ...
  {
    ref: o,
    className: e ? h(is({ variant: e }), t) : t,
    ...n
  }
));
...
class Yc extends Ci {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Xc(e.resetKeys, a)) {
      var s, i;
...
function Wc({ children: t, onError: e }) {
  return r(Yc, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Jc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : J;
function Zc(t) {
...
const ps = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, nd = ps && "documentMode" in document ? document.documentMode : null;
!(!ps || !("InputEvent" in window) || nd) && "getTargetRanges" in new window.InputEvent("input");
function ge(t) {
  return `${t}px`;
}
...
function od(t, e, n) {
  ...
  function d() {
    o === null && lr(182), a === null && lr(183);
    const { left: m, top: f } = a.getBoundingClientRect(), u = td(t, e);
    var g, y;
    ...
    w.read(() => {
      ...
      if ((_ || T) && S !== null && V !== null) {
        const C = function(v, E, P, j, M, $, H) {
          ...
          return Y.setStart(...ra(E, P, j)), Y.setEnd(...ra(M, $, H)), Y;
        }(t, f, g, S, u, N, V);
        d(), d = od(t, C, e);
      }
...
function id(t, e) {
  ...
  const o = () => {
    ...
    s !== null && i !== null && i.contains(s) ? n !== null && (n(), n = null) : n === null && (n = sd(t, e));
  };
...
function ld(t) {
  const e = Va(t, (n) => Ie(n) && !n.isInline());
  return Ie(e) || lr(4, t.__key), e;
}
function cd(t) {
  const e = Xt() || xl();
  let n;
  if (ve(e)) n = yl(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), l = i[i.length - 1];
      l && (n = La(l, "next"));
    }
    n = n || Nl(Me(), "previous").getFlipped().insert(vn());
  }
  const o = dd(t, n), a = kl(o), s = _l(a) ? Cl(a) : o;
  return El(Tl(s)), t.getLatest();
}
function dd(t, e, n) {
  let o = Uo(e, "next");
  for (let a = o; a; a = Sl(a, n)) o = a;
  return Rl(o) && lr(283), o.insert(t.isInline() ? vn().append(t) : t), Uo(La(t.getLatest(), "next"), e.direction);
}
function wd(t) {
  const e = Xt();
  if (!ve(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Va(s, (c) => Ie(c) && !c.isInline());
    if (l === null) continue;
    const d = l.getKey();
...
function br() {
  ...
  for (!function() {
    let n = cr;
    for (cr = void 0; n !== void 0; ) n.S.v === n.v && (n.S.i = n.i), n = n.o;
  }(); jn !== void 0; ) {
    let n = jn;
    for (jn = void 0, dr++; n !== void 0; ) {
      const o = n.u;
      if (n.u = void 0, n.f &= -3, !(8 & n.f) && us(n)) try {
        n.c();
      } catch (a) {
        e || (t = a, e = !0);
      }
...
let cr, De = 0, dr = 0, md = 0, ro = 0, tr = 0;
function aa(t) {
  if (rt === void 0) return;
  let e = t.n;
...
function We(t, e) {
  Ut.call(this, void 0), this.x = t, this.s = void 0, this.g = tr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function fd(t, e) {
  return new We(t, e);
}
...
function Co(t) {
  ...
  t.x = void 0, t.s = void 0, fs(t);
}
function hd(t) {
  if (rt !== this) throw new Error("Out-of-order effect");
  ms(this), rt = t, this.f &= -2, 8 & this.f && Co(this), br();
}
function cn(t, e) {
...
function Nn(t, e = {}) {
  const n = {};
  for (const o in t) {
    const a = e[o], s = Bn(a === void 0 ? t[o] : a);
    n[o] = s;
  }
  return n;
}
Ut.prototype.brand = pd, Ut.prototype.h = function() {
  return !0;
}, Ut.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : oa(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && oa(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      De !== 0 && dr === 0 && e.l !== ro && (e.l = ro, cr = { S: e, v: e.v, i: e.i, o: cr });
    })(this), this.v = t, this.i++, tr++, De++;
    try {
  ...
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === tr)) return !0;
  if (this.g = tr, this.f |= 1, this.i > 0 && !us(this)) return this.f &= -2, !0;
  const t = rt;
  try {
    sa(this), rt = this;
    const e = this.x();
  ...
  return rt = t, ms(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, fs(this), sa(this), De++;
  const t = rt;
  return rt = this, hd.bind(this, t);
}, cn.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = jn, jn = this);
}, cn.prototype.d = function() {
  this.f |= 8, 1 & this.f || Co(this);
}, cn.prototype.dispose = function() {
  this.d();
};
ae({ build: (t, e, n) => Nn(e), config: on({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function hs() {
  const t = Me(), e = Xt(), n = vn();
  t.clear(), t.append(n), e !== null && n.select(), ve(e) && (e.format = 0);
}
function gs(t, e = hs) {
  return t.registerCommand(Ga, (n) => (t.update(e), !0), ho);
}
ae({ build: (t, e, n) => Nn(e), config: on({ $onClear: hs }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return xe(() => gs(t, o.value));
} });
function gd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Or = Ol("format", { parse: (t) => typeof t == "number" ? t : 0 });
class bs extends Ur {
  $config() {
    return this.config("decorator-text", { extends: Ur, stateConfigs: [{ flat: !0, stateConfig: Or }] });
  }
  getFormat() {
    return Kl(this, Or);
  }
  getFormatFlags(e, n) {
    return Yo(this.getFormat(), e, n);
  }
  hasFormat(e) {
    const n = ql[e];
  ...
  toggleFormat(e) {
    const n = this.getFormat(), o = Yo(n, e, null);
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [bs], register: (t, e, n) => t.registerCommand(Fa, (o) => {
  const a = Xt();
  if (za(a) || ve(a)) for (const s of a.getNodes()) bd(s) && s.toggleFormat(o);
  return !1;
}, Ka) });
function vs(t, e) {
  let n;
  return Bn(t(), { unwatched() {
    n && (n(), n = void 0);
  }, watched() {
    this.value = t(), n = e(this);
  } });
}
const oo = ae({ build: (t) => vs(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
function xs(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const n = t, o = e;
    for (const a in o) n[a] = xs(n[a], o[a]);
    return t;
  }
  return e;
}
const Eo = 0, ao = 1, ys = 2, Mr = 3, Wn = 4, ln = 5, Ar = 6, On = 7;
function Pr(t) {
  return t.id === Eo;
}
function Ns(t) {
...
function vd(t) {
  return function(e) {
    return e.id === ao;
  }(t) || wt(305, String(t.id), String(ao)), Object.assign(t, { id: ys });
}
...
class yd {
  constructor(e, n) {
    ...
    Ht(this, "state");
    Ht(this, "_signal");
    this.builder = e, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Eo };
  }
  mergeConfigs() {
    let e = this.extension.config || {};
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : Dl;
    for (const o of this.configs) e = n(e, o);
    return e;
  }
  init(e) {
    const n = this.state;
    Ns(n) || wt(306, String(n.id));
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, d, c) {
      return Object.assign(l, { config: d, id: Mr, registerState: c });
    }(n, this.mergeConfigs(), o);
    let i;
    this.state = s, this.extension.init && (i = this.extension.init(e, s.config, o)), this.state = function(l, d, c) {
      return Object.assign(l, { id: Wn, initResult: d, registerState: c });
    }(s, i, a);
  }
  build(e) {
    const n = this.state;
    let o;
    n.id !== Wn && wt(307, String(n.id), String(ln)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Ar && wt(310, String(n.id), String(Ar)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
      return Object.assign(a, { id: On });
    }(n), o;
  }
  getSignal() {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= Wn;
    }(e) || wt(313, String(e.id), String(Wn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Mr;
    }(e) || wt(314, String(e.id), String(Mr)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= On;
    }(e) || wt(316, String(e.id), String(On)), e;
  }
...
const kd = ae({ config: on({ setOptions: ia, updateOptions: ia }), init: ({ $initialEditorState: t = Nd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if ($l(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [Ml, ja, Al, Pl, $a] }), la = Symbol.for("@lexical/extension/LexicalBuilder");
function ca() {
}
function _d(t) {
  throw t;
...
class dn {
  ...
  static fromExtensions(e) {
    const n = [Jn(kd)];
    for (const o of e) n.push(Jn(o));
    return new dn(n);
  }
  static maybeFromEditor(e) {
    const n = e[la];
    return n && (n.PACKAGE_VERSION !== $r && wt(292, n.PACKAGE_VERSION, $r), n instanceof dn || wt(293)), n;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Pa({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [la]: this });
  ...
  addExtension(e) {
    ...
    if (a !== void 0 && a.extension !== o && wt(298, o.name), !a) {
      a = new yd(this, o), this.extensionNameMap.set(o.name, a);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Pr(s) || wt(300, i, a || "[unknown]"), Pr(l = s) || wt(304, String(l.id), String(Eo)), s = Object.assign(l, { id: ao }), o.state = s;
      const d = this.outgoingConfigEdges.get(i);
      if (d) for (const c of d.keys()) {
        const w = this.extensionNameMap.get(c);
        w && n(w, i);
      }
      s = vd(s), o.state = s, e.push(o);
    };
    for (const o of this.extensionNameMap.values()) Pr(o.state) && n(o);
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of l) {
      const { extension: m } = w;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of gd(m)) {
...
const Cd = /* @__PURE__ */ new Set(), da = ae({ build(t, e, n) {
  const o = n.getDependency(oo).output, a = Bn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = vs(() => {
  }, () => xe(() => {
...
ae({ dependencies: [oo, da], name: "@lexical/extension/HorizontalRule", nodes: () => [un], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(da).output, a = Bn({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return Ae(t.registerCommand(Ed, (i) => {
    const l = Xt();
    if (!ve(l)) return !1;
    ...
    return !0;
  }, ho), t.registerCommand(Ll, (i) => {
    if (Vl(i.target)) {
      const l = Bl(i.target);
      if (Sd(l)) return function(d, c = !1) {
        const w = Xt(), m = d.isSelected(), f = d.getKey();
        let u;
        c && za(w) ? u = w : (u = Gl(), Fl(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Ka), t.registerMutationListener(un, (i, l) => {
    ud(() => {
      let d = !1;
      ...
      for (const [w, m] of i.entries()) if (m === "destroyed") c.delete(w), d = !0;
        ...
        f ? f.domNode.value = u : (d = !0, c.set(w, { domNode: Bn(u), selectedSignal: o(w) }));
      }
    ...
    for (const { domNode: l, selectedSignal: d } of a.value.nodeSelections.values()) i.push(xe(() => {
      const c = l.value;
      c && (d.value ? qa(c, s) : Xl(c, s));
    }));
    return Ae(...i);
  }));
} });
ae({ build: (t, e) => Nn({ inheritEditableFromParent: e.inheritEditableFromParent }), config: on({ $getParentEditor: function() {
  const t = zl();
...
ae({ build: (t, e, n) => Nn(e), config: on({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, n) => {
  const o = n.getOutput();
  return xe(() => {
...
function Rd(t, e, n = ks) {
  return Ae(t.registerCommand(Wl, (o) => {
    const a = Xt();
    if (!ve(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((f) => nr(f) && f.canIndent()).length > 0) return !0;
      const l = i.anchor, d = i.focus, c = d.isBefore(l) ? d : l, w = c.getNode(), m = ld(w);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Jl();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Zl(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Ql : Xo : tc;
    return t.dispatchCommand(s, void 0);
  }, ho), t.registerCommand(Xo, () => {
...
ae({ build: (t, e, n) => Nn(e), config: on({ $canIndent: ks, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return xe(() => {
    if (!o.value) return Rd(t, a, s);
  });
} });
const Id = ae({ name: "@lexical/react/ReactProvider" });
function Dd() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ve(g)) {
                ...
                if (rr(x) && c >= 0 && w >= 0 && (N = c, R = c + w, g.setTextNodeRange(x, N, x, R)), N === R && m === "" || (g.insertRawText(m), x = y.getNode()), rr(x)) {
                  N = f, R = f + u;
...
ae({ build: (t, e, n) => Nn(e), config: on({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => xe(() => n.getOutput().disabled.value ? void 0 : Cs(t)) });
function Ad(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const So = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : J;
function Pd({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, s] = D(() => n.getDecorators());
    return So(() => n.registerDecoratorListener((i) => {
      wc(() => {
        s(i);
      });
    }), [n]), J(() => {
      ...
      for (let d = 0; d < l.length; d++) {
        const c = l[d], w = r(o, { onError: (f) => n._onError(f), children: r(Ei, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(pc(w, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function $d({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(Id.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && Ad(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(Pd, { editor: t, ErrorBoundary: e });
}
function wa(t) {
  return t.getEditorState().read(_s(t.isComposing()));
}
function jd({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Ee();
  return function(a) {
    So(() => Ae(dc(a), Cs(a)), [a]);
  }(o), p(st, { children: [t, r(Ld, { content: e }), r($d, { editor: o, ErrorBoundary: n })] });
}
...
const Bd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : J;
function Gd({ onClear: t }) {
  const [e] = Ee();
  return Bd(() => gs(e, t), [e, t]), null;
}
const Es = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Qt : J;
function Fd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: d, ariaLabelledBy: c, ariaMultiline: w, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: N = !0, style: R, tabIndex: I, "data-testid": S, ...V }, _) {
  ...
  return Es(() => (C(t.isEditable()), t.registerEditableListener((P) => {
    C(P);
...
function qd(t, e) {
  ...
  return p(st, { children: [r(zd, { editor: a, ...o, ref: e }), n != null && r(Hd, { editor: a, content: n })] });
}
...
function Yd({
  ...
  return /* @__PURE__ */ r(Ts.Provider, { value: i, children: s });
}
function Ss() {
  const t = po(Ts);
  if (!t)
...
function Xd() {
  const [t, e] = D(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Qr, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(or, { children: [
      /* @__PURE__ */ r(ar, { children: /* @__PURE__ */ r(sr, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = G(
    (s, i, l = !1) => {
...
function Wd({
  ...
  const [e] = Ee(), [n, o] = D(e), [a, s] = D("paragraph"), [i, l] = Xd(), d = () => {
  };
...
), Zd = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Xa.Root,
  {
    ref: a,
    className: h(Rs({ variant: e, size: n, className: t })),
    ...o
  }
));
Zd.displayName = Xa.Root.displayName;
const Is = b.createContext({
  size: "default",
  variant: "default"
}), Ro = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = _t();
  return /* @__PURE__ */ r(
    hr.Root,
    {
...
Ro.displayName = hr.Root.displayName;
const Ln = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = b.useContext(Is);
  return /* @__PURE__ */ r(
    hr.Item,
    {
      ref: s,
...
Ln.displayName = hr.Item.displayName;
const ua = [
  { format: "bold", icon: Si, label: "Bold" },
  { format: "italic", icon: Ri, label: "Italic" }
...
function Qd() {
  const { activeEditor: t } = Ss(), [e, n] = D([]), o = G((a) => {
    if (ve(a) || uc(a)) {
      const s = [];
      ua.forEach(({ format: i }) => {
  ...
  return Jd(o), /* @__PURE__ */ r(
    Ro,
    {
      ...
      variant: "outline",
      size: "sm",
      children: ua.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        Ln,
        {
          value: a,
          "aria-label": i,
          onClick: () => {
            t.dispatchCommand(Fa, a);
          },
...
function ew({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Wd, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Qd, {}) }) }),
      ...
      /* @__PURE__ */ r(
        jd,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(Ud, { placeholder: t }) }),
          ErrorBoundary: Wc
        }
      ),
      e && /* @__PURE__ */ r(Vd, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ r(
          Kc,
          {
            ...
            children: /* @__PURE__ */ p(Pt, { children: [
              /* @__PURE__ */ r(ew, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Hc,
                {
...
function rw(t, e) {
  const n = oc(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const s of n) if (!Os.has(s.nodeName)) {
    const i = Ms(s, t, a, !1);
    i !== null && (o = o.concat(i));
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Ua && i.insertAfter(Ya());
    for (const i of s) {
...
function Ds(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = Ie(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && rr(e) && (i = ed(o, e, "clone"));
  const l = Ie(i) ? i.getChildren() : [], d = rc(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Ds(t, g, f, o);
    !a && Ie(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ba(w) || Wo(w)) && w.append(f), n.append(w), m) {
      const u = m.call(i, w);
      u && (Wo(w) ? w.replaceChildren(u) : w.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
const Os = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ms(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (Os.has(t.nodeName)) return i;
  let l = null;
  ...
  let f = [];
  const u = (l == null || !ac(l)) && (l != null && nr(l) || o);
  for (let g = 0; g < m.length; g++) f.push(...Ms(m[g], e, n, u, new Map(a), l));
  return w != null && (f = w(f)), Jo(t) && (f = aw(t, f, u ? () => {
    const g = new Ua();
    return n.push(g), g;
  } : vn)), l == null ? f.length > 0 ? i = i.concat(f) : Jo(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Zo(g.nextSibling) && Zo(g.previousSibling);
  }(t) && (i = i.concat(Ya())) : Ie(l) && l.append(...f), i;
}
function aw(t, e, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    const l = e[i];
    if (nr(l)) o && !l.getFormat() && l.setFormat(o), a.push(l);
    else if (s.push(l), i === e.length - 1 || i < e.length - 1 && nr(e[i + 1])) {
      const d = n();
...
function sw(t) {
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), s = rw(e, a);
      Me().clear(), sc(s);
    },
    {
      discrete: !0
...
function cm({
  ...
  const [a, s] = D(iw), [i, l] = D(void 0), [d, c] = D(!1), w = q(void 0), m = q(null);
  J(() => {
    let N = !0;
    const R = m.current;
    if (!R) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
          /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(gn, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ p(Ce, { open: d, onOpenChange: c, children: [
      /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          variant: "outline",
          ...
          children: [
            ...
            /* @__PURE__ */ r("span", { children: jr(i !== void 0 ? i : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ r(
        we,
        {
          ...
          children: /* @__PURE__ */ r(ke, { children: /* @__PURE__ */ r(_e, { children: t.map((N) => /* @__PURE__ */ r(
            se,
            {
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ r("span", { children: jr(N, o) })
            },
            N || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Do(N) && (N.preventDefault(), N.stopPropagation(), le(a) && f());
        },
        onKeyDown: (N) => {
...
const dm = Object.freeze([
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: h("pr-twp", ww({ variant: e }), t), ...n })
);
...
const mw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const mn = b.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Ja.Root,
  {
    ref: a,
    decorative: n,
...
mn.displayName = Ja.Root.displayName;
const Ls = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xn.Root,
  {
    ref: n,
    className: h(
...
Ls.displayName = xn.Root.displayName;
...
hw.displayName = xn.Image.displayName;
...
Vs.displayName = xn.Fallback.displayName;
const Oo = mr(void 0);
function pe() {
  const t = po(Oo);
  if (!t)
...
}), Pe = mt.Trigger, Bs = mt.Group, gw = mt.Portal, bw = mt.Sub, vw = mt.RadioGroup;
function Ne({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Oo.Provider, { value: n, children: /* @__PURE__ */ r(mt.Root, { ...e }) });
}
...
Gs.displayName = mt.SubTrigger.displayName;
const Fs = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = _t();
  return /* @__PURE__ */ r(
    mt.SubContent,
    {
...
const re = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = _t(), i = pe();
  return /* @__PURE__ */ p(
    mt.CheckboxItem,
    {
...
re.displayName = mt.CheckboxItem.displayName;
const zs = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    mt.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(mt.ItemIndicator, { children: /* @__PURE__ */ r(fr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
zs.displayName = mt.RadioItem.displayName;
...
ze.displayName = mt.Label.displayName;
...
function ma({
  ...
  const u = G(
    ...
    [t.user]
  ), R = z(() => dl(t.contents), [t.contents]), I = z(() => {
    if (o && l)
      return /* @__PURE__ */ p(st, { children: [
        /* @__PURE__ */ p(
          Qe,
          {
            onClick: (S) => {
              S.stopPropagation(), c(!0), m(sw(t.contents)), i == null || i(!0);
            },
            children: [
              /* @__PURE__ */ r(Ii, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ls, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Vs, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            ...
            e && t.assignedUser !== void 0 && /* @__PURE__ */ p(ye, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              er(t.assignedUser, n)
            ] })
          ] }),
          d && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), u()) : Do(S) && (S.preventDefault(), S.stopPropagation(), le(w) && g());
              },
              onKeyDown: (S) => {
                Io(S), (S.key === "Enter" || S.key === " ") && S.stopPropagation();
              },
              onClick: (S) => {
                S.stopPropagation();
              },
        ...
        I && /* @__PURE__ */ p(Ne, { children: [
          /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Oi, {}) }) }),
...
function yw({
  ...
  const [T, C] = D(fa), [v, E] = D(
    void 0
  ), P = o, [j, M] = D(!1), [$, H] = D(!1), [Y, tt] = D(!1), [Rt, Gt] = D(!1), [jt, it] = D(!1), [gt, K] = D(S), [nt, lt] = D(!1), ot = q(void 0), [ct, Ft] = D(/* @__PURE__ */ new Map());
  J(() => {
    let O = !0;
    return (async () => {
  ...
  const zt = z(() => Ot[0], [Ot]), ue = q(null), A = q(void 0), Zt = G(() => {
    var O;
    (O = A.current) == null || O.call(A), C(fa);
  }, []), me = G(() => {
    const O = !gt;
    K(O), lt(!O), g == null || g(d, O);
  }, [gt, g, d]);
  J(() => {
    M(!1);
  }, [o]), J(() => {
    if (o && !gt && !nt) {
      ...
      return ot.current = O, () => clearTimeout(O);
    }
    ot.current && (clearTimeout(ot.current), ot.current = void 0);
  }, [o, gt, nt, V, d, g]);
  const Mt = z(
    () => ({
  ...
  }, [s, n]), X = z(() => Ot.slice(1), [Ot]), et = z(() => X.length ?? 0, [X.length]), dt = z(() => et > 0, [et]), vt = z(() => j || et <= 2 ? X : X.slice(-2), [X, et, j]), xt = z(() => j || et <= 2 ? 0 : et - 2, [et, j]), It = z(
  ...
  const Ct = G(
    ...
    async (O) => {
      const yt = le(T) ? pr(T) : void 0, ut = await m({
        ...O,
        contents: yt,
  ...
  if (zt)
    return /* @__PURE__ */ r(
      $s,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ p(js, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              ...
              /* @__PURE__ */ r(
                F,
                {
                  ...
                  children: gt ? /* @__PURE__ */ r(Mi, {}) : /* @__PURE__ */ r(Ai, {})
                }
              ),
            ...
            /* @__PURE__ */ r(
              ma,
              {
                ...
                handleDeleteComment: u,
                onEditingChange: H,
                canEditOrDelete: (!$ && ct.get(zt.id)) ?? !1,
            ...
            o && /* @__PURE__ */ p(st, { children: [
              ...
              x !== !1 && (!$ || le(T)) && /* @__PURE__ */ p(
                "div",
                {
                  ...
                  onKeyDownCapture: (O) => {
                    Do(O) && (O.preventDefault(), O.stopPropagation(), (le(T) || v !== void 0) && Ct());
                  },
                  onKeyDown: (O) => {
                    Io(O), (O.key === "Enter" || O.key === " ") && O.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      wr,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      ...
                      /* @__PURE__ */ p(Ce, { open: Y, onOpenChange: tt, children: [
                        /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ r(
                          F,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                            disabled: !Rt || !y || y.length === 0 || !y.includes(i),
                        ...
                        /* @__PURE__ */ r(
                          we,
                          {
                            ...
                            children: /* @__PURE__ */ r(ke, { children: /* @__PURE__ */ r(_e, { children: y == null ? void 0 : y.map((O) => /* @__PURE__ */ r(
                              se,
                              {
                                onSelect: () => {
                                  E(O !== s ? O : void 0), tt(!1);
                                ...
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: er(O, n) })
                              },
                              O || "unassigned"
                            )) }) })
                          }
...
function pm({
  ...
  const V = n.filter(
    ...
    [N, y]
  ), { listboxRef: v, activeId: E, handleKeyDown: P } = dw({
    options: _,
    onOptionSelect: T
  }), j = G(
    (M) => {
...
function Nw({ table: t }) {
  return /* @__PURE__ */ p(Ne, { children: [
    /* @__PURE__ */ r(mc, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const fn = kt.Root, kw = kt.Group, hn = kt.Value, _w = Ke(
...
const Ks = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kt.ScrollUpButton,
  {
    ref: n,
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ r(Sa, { className: "tw-h-4 tw-w-4" })
  }
));
Ks.displayName = kt.ScrollUpButton.displayName;
...
qs.displayName = kt.ScrollDownButton.displayName;
...
Cw.displayName = kt.Label.displayName;
const ne = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  kt.Item,
  {
    ref: o,
    className: h(
...
ne.displayName = kt.Item.displayName;
...
Ew.displayName = kt.Separator.displayName;
function Tw({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        fn,
        {
          ...
          children: [
            /* @__PURE__ */ r(nn, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(hn, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(rn, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(ne, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const vr = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => {
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Gn(i, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
...
const xr = b.forwardRef(({ className: t, stickyHeader: e, ...n }, o) => /* @__PURE__ */ r(
  "thead",
  {
    ref: o,
    className: h(
...
const yr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? Gn(t.current) : [], s = a.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
function Aw({
  ...
  let V;
  return d ? V = Array.from({ length: 10 }).map((v, E) => `skeleton-row-${E}`).map((v) => /* @__PURE__ */ r(Se, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(tn, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(so, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, v)) : ((_ = I.getRowModel().rows) == null ? void 0 : _.length) > 0 ? V = I.getRowModel().rows.map((T) => /* @__PURE__ */ r(
    Se,
    {
      onClick: () => i(T, I),
      "data-state": T.getIsSelected() && "selected",
      children: T.getVisibleCells().map((C) => /* @__PURE__ */ r(tn, { children: $n(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    T.id
  )) : V = /* @__PURE__ */ r(Se, { children: /* @__PURE__ */ r(tn, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Nw, { table: I }),
    /* @__PURE__ */ p(vr, { stickyHeader: s, children: [
      /* @__PURE__ */ r(xr, { stickyHeader: s, children: I.getHeaderGroups().map((T) => /* @__PURE__ */ r(Se, { children: T.headers.map((C) => /* @__PURE__ */ r(Fn, { className: "tw-p-0", children: C.isPlaceholder ? void 0 : $n(C.column.columnDef.header, C.getContext()) }, C.id)) }, T.id)) }),
      /* @__PURE__ */ r(yr, { children: V })
    ] }),
...
function um({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(vc, { options: s, children: e })
    }
  );
}
...
function $w({
  ...
  const a = ga(n, "%webView_error_dump_header%"), s = ga(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Ra, {}) })
        ] }),
...
function fm({
  ...
  return /* @__PURE__ */ p(Ce, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: o }),
    /* @__PURE__ */ p(we, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
var jw = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(jw || {});
function hm({ id: t, label: e, groups: n }) {
  const [o, a] = D(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(Ne, { children: [
    /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "default", children: [
      /* @__PURE__ */ r(Ia, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(Oe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ce, { children: n.map((c, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(ze, { children: c.label }),
      /* @__PURE__ */ r(Bs, { children: c.itemType === 0 ? /* @__PURE__ */ r(st, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        re,
        {
          checked: o[w][f],
        ...
        vw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(zs, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r($e, {})
    ] }, c.label)) })
...
function bm({
  ...
  const i = z(() => pl(n), [n]), d = ((c) => {
    const w = new Intl.DisplayNames(ul(), { type: "language" });
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(Lw, { versionHistory: a }),
...
function Vw({
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ p(Ce, { open: C, onOpenChange: w ?? R, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: y,
    ...
    /* @__PURE__ */ r(we, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ke, { children: [
      ...
      /* @__PURE__ */ p(_e, { children: [
        ...
        /* @__PURE__ */ r(oe, { children: V.map((E) => /* @__PURE__ */ p(
          se,
          {
            value: E.label,
            onSelect: I,
            ...
            children: [
              ...
              E.starred && /* @__PURE__ */ r(zi, { className: "tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(st, { children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      ...
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ p("p", { children: [
        ba(a, "%undoButton_tooltip%"),
        s && ` (${d ? "⌘Z" : "Ctrl+Z"})`
      ] }) })
    ] }) }),
    e && /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(
        F,
        {
          "aria-label": "Redo",
      ...
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ p("p", { children: [
        ba(a, "%redoButton_tooltip%"),
        s && ` (${d ? "⌘⇧Z" : "Ctrl+Y"})`
      ] }) })
    ] }) })
  ] });
}
function Fw({ children: t, editorRef: e }) {
  const n = q(null);
  return J(() => {
    var i;
...
const zw = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(st, { children: [
...
function Kw({
  ...
  return /* @__PURE__ */ p(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: zw(t, a, n) }) }) }),
          ...
          /* @__PURE__ */ r(
            re,
            {
              ...
              children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
                ...
                /* @__PURE__ */ r("span", { className: "tw-w-10 tw-text-center", children: Yr })
              ] })
            }
          ),
          /* @__PURE__ */ r(
...
const qw = (t, e) => t === "f" ? /* @__PURE__ */ p(st, { children: [
  /* @__PURE__ */ r(Oa, {}),
  " ",
...
function Uw({
  ...
  return /* @__PURE__ */ p(Ne, { children: [
    /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(ic, { asChild: !0, children: /* @__PURE__ */ r(Pe, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: qw(t, n) }) }) }),
      /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r("p", { children: Hw(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ce, { style: { zIndex: es }, children: [
  ...
  return /* @__PURE__ */ p(
    se,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ r(rs, { className: "tw-font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Ww({ localizedStrings: t, markerMenuItems: e, searchRef: n }) {
  ...
  return /* @__PURE__ */ p(ke, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      an,
      {
    ...
    /* @__PURE__ */ p(_e, { children: [
      ...
      /* @__PURE__ */ r(oe, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ r(
          va,
          {
      ...
      i.length > 0 && /* @__PURE__ */ p(st, { children: [
        s.length > 0 && /* @__PURE__ */ r(gr, { alwaysRender: !0 }),
        /* @__PURE__ */ r(oe, { children: i.map((l) => {
          var d;
          return /* @__PURE__ */ r(
            va,
            {
...
function xm({
  ...
  const [g, y] = D("generated"), [x, N] = D("*"), [R, I] = D("f"), [S, V] = D(!1), [_, T] = D(!0), [C, v] = D(!1), E = q(!1), P = q(""), [j, M] = D(!1), [$, H] = D(), [Y, tt] = D(), [Rt, Gt] = D(), [jt, it] = D(), gt = q(null), K = z(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? xc(), noteMode: "expanded" }
    }),
    [i, l]
  ), nt = z(
    () => Jw(
  ...
  J(() => {
    ...
    if (X && Yn("note", X)) {
      ...
      let xt = "custom";
      vt === Yr ? xt = "generated" : vt === Xr ? xt = "hidden" : vt && N(vt), y(xt), I(((dt = X.insert.note) == null ? void 0 : dt.style) ?? "f"), B = setTimeout(() => {
        var It;
        (It = w.current) == null || It.applyUpdate([X]);
      }, 0);
    }
    return () => {
      B && clearTimeout(B);
  ...
  const lt = G(
    (B, X, et = !1) => {
      ...
      if (dt && Yn("note", dt)) {
        if (dt.insert.note) {
          let bt;
          B === "custom" ? bt = X : B === "generated" ? bt = Yr : bt = Xr, dt.insert.note.caller = bt;
        }
        n == null || n([dt]), et && c && s && ((It = c.current) == null || It.replaceEmbedUpdate(s, [dt]));
      }
    },
    [s, n, c]
  ), ot = G(() => {
  ...
  Qt(() => {
    (Ft.current.book !== a.book || Ft.current.chapterNum !== a.chapterNum) && (Ft.current = { book: a.book, chapterNum: a.chapterNum }, ct.current());
  }, [a.book, a.chapterNum]);
  const Ot = () => {
    var X;
    ...
    if (X && Yn("note", X)) {
      ...
      R !== "x" && B === "x" ? bt == null || bt.forEach((Ct) => Zw(Ct)) : R === "x" && B !== "x" && (bt == null || bt.forEach((Ct) => Qw(Ct))), (It = w.current) == null || It.applyUpdate([X, { delete: 1 }]);
    }
  }, Zt = (B) => {
    it(B.contextMarker), v(B.canRedo);
  }, me = G(
    (B) => {
      var et, dt, vt, xt, It;
      const X = (dt = (et = w.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : dt.at(0);
      if (X && Yn("note", X)) {
        ...
        const bt = (vt = X.insert.note) == null ? void 0 : vt.style, Ct = (It = (xt = X.insert.note) == null ? void 0 : xt.contents) == null ? void 0 : It.ops;
        if (bt || V(!1), V(
        ...
        T(JSON.stringify(X) === P.current), lt(g, x);
      } else
        V(!1), T(!0);
    },
    [g, x, lt]
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
            /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(F, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(gn, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(Fw, { editorRef: w, children: /* @__PURE__ */ r(
              yc,
              {
                options: K,
                onStateChange: Zt,
            ...
            /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
              /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ r(
                F,
                {
                  onClick: Ot,
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ r(qr, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
  ...
  return /* @__PURE__ */ p(st, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(st, { children: ep(t.marker, l, o, c) })
      }
    )
  ] });
}
        ...
        "ul",
        {
          ...
          children: n.map((R, I) => {
            ...
            return /* @__PURE__ */ p(st, { children: [
              ...
              I < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(mn, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function ap({
  ...
  return /* @__PURE__ */ p(vr, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(xr, { stickyHeader: !0, children: /* @__PURE__ */ p(Se, { children: [
      /* @__PURE__ */ r(Fn, { children: a }),
      /* @__PURE__ */ r(Fn, { children: s })
    ] }) }),
    /* @__PURE__ */ r(yr, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Se,
      {
        onClick: () => {
          e(l.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ r(tn, { className: o, children: op(l.text) })
        ]
      },
...
const Ao = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Wr.Root,
  {
    ref: n,
    className: h(
...
Ao.displayName = Wr.Root.displayName;
const sp = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Wi, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(Ji, { className: "tw-h-4 tw-w-4" });
}, Nr = (t, e, n) => /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
  /* @__PURE__ */ p(
    Bt,
    {
  ...
  header: ({ column: e }) => Nr(e, t)
}), ip = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (n) => n.items[e],
  header: ({ column: n }) => Nr(n, t)
}), _m = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Nr(e, t, "tw-justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: s }) => Nr(s, t, "tw-justify-center"),
  cell: ({ row: s }) => {
    const i = s.getValue("status"), l = s.getValue("item");
    return /* @__PURE__ */ p(Ro, { value: i, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        Ln,
        {
          onClick: (d) => {
            d.stopPropagation(), Lr(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, lp = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Rm = Object.freeze([
  ...
  const a = Ho(o.key) ? o.key : o.key[0];
  return {
    items: Ho(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || lp(a, e, n),
...
function Im({
  ...
  const u = he(n, "%webView_inventory_all%"), g = he(n, "%webView_inventory_approved%"), y = he(n, "%webView_inventory_unapproved%"), x = he(n, "%webView_inventory_unknown%"), N = he(n, "%webView_inventory_scope_currentBook%"), R = he(n, "%webView_inventory_scope_chapter%"), I = he(n, "%webView_inventory_scope_verse%"), S = he(n, "%webView_inventory_filter_text%"), V = he(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = he(n, "%webView_inventory_no_results%"), [T, C] = D(!1), [v, E] = D("all"), [P, j] = D(""), [M, $] = D([]), H = z(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : dp(K, a, s);
  }, [t, a, s]), Y = z(() => {
    if (T) return H;
    const K = [];
    return H.forEach((nt) => {
      const lt = nt.items[0], ot = K.find(
        (ct) => ct.items[0] === lt
      );
      ot ? (ot.count += nt.count, ot.occurrences = ot.occurrences.concat(nt.occurrences)) : K.push({
        items: [lt],
        count: nt.count,
  ...
  }, [T, H]), tt = z(() => Y.length === 0 ? [] : cp(Y, v, P), [Y, v, P]), Rt = z(() => {
    var lt, ot;
    if (!T) return d;
    ...
    for (let ct = 0; ct < K; ct++)
      nt.push(
        ip(
          ((ot = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ot[ct]) || "Additional Item",
          ct + 1
        )
      );
    return [...nt, ...d];
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        fn,
        {
          ...
          defaultValue: v,
          children: [
            /* @__PURE__ */ r(nn, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(hn, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ p(rn, { children: [
              /* @__PURE__ */ r(ne, { value: "all", children: u }),
              /* @__PURE__ */ r(ne, { value: "approved", children: g }),
              /* @__PURE__ */ r(ne, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(ne, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(fn, { onValueChange: (K) => jt(K), defaultValue: i, children: [
        /* @__PURE__ */ r(nn, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(hn, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(rn, { children: [
          /* @__PURE__ */ r(ne, { value: "book", children: N }),
          /* @__PURE__ */ r(ne, { value: "chapter", children: R }),
          /* @__PURE__ */ r(ne, { value: "verse", children: I })
        ] })
      ] }),
      /* @__PURE__ */ r(
        kn,
      ...
      o && /* @__PURE__ */ r(Pt, { children: /* @__PURE__ */ p(Vt, { children: [
        /* @__PURE__ */ r(Bt, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          /* @__PURE__ */ r(
            Ao,
            {
  ...
  return t.projects.forEach((a) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: xa(n, a.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1
      });
    });
...
function pp(t, e) {
  if (!e)
    return [{ kind: "flat", rows: [...t].sort(Br) }];
  const n = t.filter(ya).sort(Br), o = t.filter((s) => !ya(s)).sort(Br), a = [];
...
function hp({ scrollGroupId: t, isBoundButClosed: e }) {
  const n = zn(t);
  return e ? /* @__PURE__ */ r(
    ye,
    {
...
function gp({ row: t, mode: e, strings: n, onClick: o, onOpen: a }) {
  const s = !!(t.language || t.languageCode), i = /* @__PURE__ */ r(ee, { className: h("tw-h-4 tw-w-4", t.isSelected ? "tw-opacity-100" : "tw-opacity-0") });
  let l = null;
  e === "project" ? t.openGroups.length > 0 && (l = /* @__PURE__ */ r("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-gap-1", children: t.openGroups.map((m) => /* @__PURE__ */ r(ye, { variant: "secondary", children: zn(m) }, m)) })) : t.scrollGroupId !== void 0 && (l = /* @__PURE__ */ p("span", { className: "tw-ms-auto tw-flex tw-shrink-0 tw-items-center tw-gap-2", children: [
    /* @__PURE__ */ r(
      hp,
      {
    ...
    t.isBoundButClosed && a && /* @__PURE__ */ p(
      F,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ca, { className: "tw-h-3 tw-w-3" }),
          n.openButtonLabel
        ]
      }
    )
  ...
  ), c = t.scrollGroupId !== void 0 ? zn(t.scrollGroupId) : void 0, w = t.isBoundButClosed && c ? n.boundButClosedTooltip.replace("{group}", c) : void 0;
  return /* @__PURE__ */ p(Vt, { delayDuration: 200, children: [
...
function bp({
  ...
  return /* @__PURE__ */ p(Ne, { children: [
    ...
    /* @__PURE__ */ p(ce, { align: "end", className: "tw-w-56", style: { zIndex: vo }, children: [
      /* @__PURE__ */ r(ze, { children: a.groupSectionLabel }),
      /* @__PURE__ */ r(
        re,
        {
          checked: t,
      ...
      o && /* @__PURE__ */ p(st, { children: [
        /* @__PURE__ */ r($e, {}),
        /* @__PURE__ */ r(ze, { children: a.filterSectionLabel }),
        /* @__PURE__ */ r(
          re,
          {
            checked: !!n,
...
function Dm(t) {
  const [e, n] = D(!1), [o, a] = D(""), [s, i] = D(t.defaultGroupByOpenTabs ?? !0), [l, d] = D(!1), c = mp(t.localizedStrings), w = z(() => t.mode === "project" ? Vr({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? Vr({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const C = T.map(
          ({ project: E, scrollGroupId: P }) => P === void 0 ? E.shortName : `${E.shortName} (${zn(P)})`
        ).join(", ");
        if (T.length === 1) return { node: C, title: C };
        const v = T.length.toString();
        return {
          node: /* @__PURE__ */ p(st, { children: [
            /* @__PURE__ */ r(ye, { variant: "muted", className: "tw-shrink-0", children: v }),
      ...
      case "projectScrollGroup": {
        ...
        const C = `${_.shortName} · ${zn(T)}`;
        return { node: C, title: C };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t]), I = t.mode === "project-multi" ? /* @__PURE__ */ r(mo, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }) : /* @__PURE__ */ r(Oe, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }), S = t.mode === "project-multi" && t.selection.pairs.length > 0, V = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? g : void 0;
  return /* @__PURE__ */ p(Ce, { open: e, onOpenChange: n, children: [
    /* @__PURE__ */ r(je, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
    ...
    /* @__PURE__ */ r(
      we,
      {
        ...
        children: /* @__PURE__ */ r(Pt, { delayDuration: 200, children: /* @__PURE__ */ p(ke, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ p(_e, { children: [
            ...
            f.map((_, T) => /* @__PURE__ */ p(uo, { children: [
              /* @__PURE__ */ r(oe, { heading: vp(_, c), children: _.rows.map((C) => /* @__PURE__ */ r(
                gp,
                {
                  row: C,
                  mode: t.mode,
...
const xp = "16rem", yp = "3rem", Us = b.createContext(void 0);
function kr() {
  const t = b.useContext(Us);
  if (!t)
...
const Ys = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Us.Provider, { value: R, children: /* @__PURE__ */ r(Pt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Ys.displayName = "SidebarProvider";
const Xs = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = kr();
...
const Np = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = kr();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Zi, {}) : /* @__PURE__ */ r(Qi, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Np.displayName = "SidebarTrigger";
...
Ws.displayName = "SidebarInset";
const _p = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  kn,
  {
    ref: n,
    "data-sidebar": "input",
...
Cp.displayName = "SidebarHeader";
const Ep = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
const Tp = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mn,
  {
    ref: n,
...
const lo = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? bn : "div",
  {
    ref: o,
...
const Sp = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? bn : "button",
  {
    ref: o,
...
Sp.displayName = "SidebarGroupAction";
...
Qs.displayName = "SidebarMenuItem";
const Rp = Ke(
  ...
  ({
    ...
    const d = t ? bn : "button", { state: c } = kr(), w = /* @__PURE__ */ r(
      d,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: h(Rp({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Bt, { asChild: !0, children: w }),
      /* @__PURE__ */ r($t, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : w;
  }
);
ti.displayName = "SidebarMenuButton";
const Ip = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? bn : "button",
  {
    ref: a,
...
Dp.displayName = "SidebarMenuBadge";
const Op = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(so, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          so,
          {
...
Mp.displayName = "SidebarMenuSub";
const Ap = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Ap.displayName = "SidebarMenuSubItem";
const Pp = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? bn : "a",
  {
    ref: s,
...
Pp.displayName = "SidebarMenuSubButton";
function $p({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  return /* @__PURE__ */ r(
    Xs,
    {
      ...
      children: /* @__PURE__ */ p(Js, { children: [
        /* @__PURE__ */ p(io, { children: [
          /* @__PURE__ */ r(lo, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(co, { children: /* @__PURE__ */ r(Zs, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(Qs, { children: /* @__PURE__ */ r(
            ti,
            {
              onClick: () => c(f),
              isActive: m(f),
        ...
        /* @__PURE__ */ p(io, { children: [
          /* @__PURE__ */ r(lo, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(co, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            eo,
            {
              buttonVariant: "ghost",
    ...
    /* @__PURE__ */ p(
      Ys,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ws, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Ge = "scrBook", jp = "scrRef", Je = "source", Lp = "details", Vp = "Scripture Reference", Bp = "Scripture Book", ei = "Type", Gp = "Details";
function Fp(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? pt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Ge ? Re(a.start) : void 0;
      },
      getGroupingValue: (o) => pt.bookIdToNumber(o.start.book),
      sortingFn: (o, a) => Hr(o.original.start, a.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: Je,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? ei : void 0,
...
const zp = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Hr(t.start, t.end) === 0 ? `${Cr(t.start)}+${e}` : `${Cr(t.start)}+${e}-${Cr(t.end)}+${n}`;
}, Na = (t) => `${zp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Mm({
  sources: t,
  ...
  const [c, w] = D([]), [m, f] = D([{ id: Ge, desc: !1 }]), [u, g] = D({}), y = z(
  ...
  J(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const P = y.find((j) => Na(j) === E[0]) || void 0;
        P && l(P);
      }
    }
  }, [u, y, l, N]);
  const R = a ?? Bp, I = s ?? ei, S = [
  ...
  return /* @__PURE__ */ p("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      fn,
      {
        ...
        children: [
          /* @__PURE__ */ r(nn, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(hn, {}) }),
          /* @__PURE__ */ r(rn, { position: "item-aligned", children: /* @__PURE__ */ r(kw, { children: S.map((v) => /* @__PURE__ */ r(ne, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(vr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(xr, { children: N.getHeaderGroups().map((v) => /* @__PURE__ */ r(Se, { children: v.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Fn, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          $n(E.column.columnDef.header, E.getContext())
        ] }) }, E.id)
      )) }, v.id)) }),
      /* @__PURE__ */ r(yr, { children: N.getRowModel().rows.map((v, E) => {
        const P = _t();
        return /* @__PURE__ */ r(
          Se,
          {
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ p(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !v.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(wn, {}) : /* @__PURE__ */ r(Kr, {})),
                          " ",
                          $n(j.column.columnDef.cell, j.getContext()),
                          " (",
                          v.subRows.length,
                          ")"
                        ]
...
}), ni = (t, e, n) => $o(t, e).every((o) => n.includes(o));
function Kp({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = $o(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: h(
        ni(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Dc(
        t,
...
function qp({
  ...
  const _ = z(() => pt.allBookIds.filter(
    ...
    ($, H = !1) => {
      ...
      const Y = _.findIndex((it) => it === S.current), tt = _.findIndex((it) => it === $);
      if (Y === -1 || tt === -1) return;
      const [Rt, Gt] = [
        Math.min(Y, tt),
        Math.max(Y, tt)
      ], jt = _.slice(Rt, Gt + 1).map((it) => it);
      n(
        e.includes($) ? e.filter((it) => !jt.includes(it)) : [.../* @__PURE__ */ new Set([...e, ...jt])]
      );
    },
    [e, n, _]
  ), v = ($) => {
    ...
    ($) => {
      const H = $o(_, $).map((Y) => Y);
      n(
        ni(_, $, e) ? e.filter((Y) => !H.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, n, _]
  ), j = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
                  ...
                  Object.values(Q).map(($, H) => {
                    ...
                    if (Y.length !== 0)
                      return /* @__PURE__ */ p(uo, { children: [
                          ...
                          oe,
                          {
                            ...
                            children: Y.map((tt) => /* @__PURE__ */ r(
                              ss,
                              {
                                ...
                                onSelect: () => v(tt),
                                onMouseDown: (Rt) => E(Rt, tt),
                                section: Pn(tt),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: cs(tt, a),
                                className: "tw-flex tw-items-center"
                              },
                              tt
                            ))
                        ...
                        H < Object.values(Q).length - 1 && /* @__PURE__ */ r(gr, {})
                      ] }, $);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      ...
      e.length > Gr && /* @__PURE__ */ r(
        ye,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - ka} ${m}`
        }
      )
    ] })
  ] });
...
function Pm({
  ...
  const S = At(
  ...
  ], K = (L, W, Yt = !1) => /* @__PURE__ */ p(st, { children: [
    L,
    W && !Yt && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
      ": ",
      W
    ] })
  ] }), nt = e ? gt.filter((L) => e.includes(L.value)) : gt, lt = g ?? Er, ot = w ?? lt, ct = m ?? lt, Ft = () => {
  }, Ot = q(null), zt = q(null), ue = q(!1), A = q(null), Zt = q(!1), [me, Mt] = D(void 0), B = q(!1), X = q(!1), et = q(null), dt = G((L) => {
    if (L) {
    ...
    [n, a, g, s]
  ), Ct = nt.find((L) => L.value === t), Lt = () => t === "selectedBooks" && a.length > 0 ? a.map((L) => L.toUpperCase()).join(", ") : t === "range" ? hl(ot, ct, {
  ...
  ), yt = nt.find((L) => L.value === "selectedBooks"), ut = nt.find((L) => L.value === "range"), qe = /* @__PURE__ */ r(
    qp,
    {
      availableBookInfo: o,
      selectedBookIds: a,
  ...
  ), He = me === "end", _n = me === "start", Ue = "tw-text-muted-foreground", Cn = /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-wrap tw-items-end tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(Et, { htmlFor: "scope-range-start", className: h(He && Ue), children: Y }),
      /* @__PURE__ */ r(
        Rr,
        {
    ...
    /* @__PURE__ */ p("div", { ref: Ot, className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(Et, { htmlFor: "scope-range-end", className: h(_n && Ue), children: tt }),
      /* @__PURE__ */ r(
        Rr,
        {
          id: "scope-range-end",
          scrRef: ct,
          handleSubmit: u ? It : Ft,
          localizedBookNames: l,
          localizedStrings: x,
          getEndVerse: N,
          disableReferencesUpTo: ot,
          onOpenChange: vt,
          onCloseAutoFocus: (L) => {
            var W;
  ...
  ] }), [En, Tn] = D(!1), [Sn, sn] = D(void 0), [Ve, Rn] = D(void 0), [In, _r] = D(void 0), [k, U] = D(void 0), [Z, Kt] = D([]), Te = q({}), Be = G(
    (L) => (W) => {
      Te.current[L] = W;
    },
    []
  ...
  const [Dt, Tt] = D(null), [St, Nt] = D(null), [qt, fe] = D(null), Xe = 200, [vi, xi] = D(!1);
  J(() => {
    if (!qt || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([W]) => {
      xi(W.contentRect.width < Xe);
    });
    return L.observe(qt), () => L.disconnect();
  }, [qt]);
  const jo = G(
    (L) => {
      Rn(L), _r(ot), U(ct), Kt(a), Tn(!1), sn(L);
    },
    [ot, ct, a]
  ), Lo = G(() => {
    Ve !== void 0 && (Ve === "range" ? (In && (f == null || f(In)), k && (u == null || u(k))) : Ve === "selectedBooks" && s(Z), bt(Ve), sn(void 0), Rn(void 0));
  }, [
    Ve,
    In,
    k,
    ...
    L || (sn(void 0), Rn(void 0));
  }, []), Vo = G((L) => {
    var W;
    L.preventDefault(), (W = Ye.current) == null || W.focus();
  }, []), Bo = (L) => t === L ? /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(ee, { className: "tw-h-4 tw-w-4" }) }) : void 0;
  return /* @__PURE__ */ p("div", { id: d, className: "tw-grid tw-gap-4", children: [
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      !R && /* @__PURE__ */ r(Et, { children: j }),
      c === "dropdown" ? /* @__PURE__ */ p(Ne, { open: En, onOpenChange: Tn, children: [
        ...
        /* @__PURE__ */ r(
          ce,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ p(Tr, { container: qt, children: [
              O.map(({ value: L, label: W, dropdownLabel: Yt, scrRefSuffix: Dn, id: yi }) => /* @__PURE__ */ r(
                re,
                {
                  ref: Be(L),
                  checked: t === L,
              ...
              y && /* @__PURE__ */ p(st, { children: [
                /* @__PURE__ */ r($e, {}),
                /* @__PURE__ */ r(ze, { className: "tw-px-2 tw-py-1.5 tw-text-xs tw-font-medium tw-text-muted-foreground", children: jt }),
                /* @__PURE__ */ r(
                  Qe,
                  {
                    ref: A,
                    ...
                    onSelect: (L) => {
                      var W, Yt;
                      if (L.preventDefault(), ue.current) {
                        ue.current = !1;
                        return;
                      }
                      Zt.current || (Yt = (W = zt.current) == null ? void 0 : W.querySelector("button")) == null || Yt.click();
                    },
                    children: /* @__PURE__ */ r(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (L) => {
                          ...
                          W != null && W.closest("button") && (ue.current = !0, requestAnimationFrame(() => {
                            ue.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ r(
                          Rr,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ p(st, { children: [
                              /* @__PURE__ */ r("span", { className: "tw-min-w-0 tw-flex-1 tw-truncate tw-text-start", children: Re(g ?? Er, "id") }),
                              /* @__PURE__ */ r(Oe, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
                            ] })
                          }
                        )
        ...
        No,
        {
          ...
          children: nt.map(({ value: L, label: W, scrRefSuffix: Yt, id: Dn }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(ir, { className: "tw-me-2", value: L, id: Dn }),
            /* @__PURE__ */ r(Et, { htmlFor: Dn, children: K(W, Yt) })
          ] }, Dn))
        }
      )
    ] }),
    ...
    c === "radio" && t === "range" && Cn,
    c === "dropdown" && yt && /* @__PURE__ */ r(Qr, { open: Sn === "selectedBooks", onOpenChange: Hn, children: /* @__PURE__ */ r(
      or,
      {
        ref: Nt,
        onCloseAutoFocus: Vo,
        ...
        children: /* @__PURE__ */ p(Tr, { container: St, children: [
          /* @__PURE__ */ r(ar, { className: "tw-pe-8", children: /* @__PURE__ */ r(sr, { children: P }) }),
          qe,
          /* @__PURE__ */ p(to, { children: [
            /* @__PURE__ */ r(F, { variant: "outline", onClick: () => Hn(!1), children: Gt }),
            /* @__PURE__ */ r(F, { onClick: Lo, children: Rt })
          ] })
        ] })
      }
    ) }),
    c === "dropdown" && ut && /* @__PURE__ */ r(Qr, { open: Sn === "range", onOpenChange: Hn, children: /* @__PURE__ */ r(
      or,
      {
        ref: Tt,
        onCloseAutoFocus: Vo,
        onEscapeKeyDown: (L) => {
          Dt != null && Dt.querySelector('[data-state="open"]') && L.preventDefault();
        },
        children: /* @__PURE__ */ p(Tr, { container: Dt, children: [
          /* @__PURE__ */ r(ar, { className: "tw-pe-8", children: /* @__PURE__ */ r(sr, { children: H }) }),
          Cn,
          /* @__PURE__ */ p(to, { children: [
            /* @__PURE__ */ r(F, { variant: "outline", onClick: () => Hn(!1), children: Gt }),
            /* @__PURE__ */ r(F, { ref: et, onClick: Lo, children: Rt })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          rn,
          {
            ...
            style: { zIndex: qn },
            children: t.map((c) => /* @__PURE__ */ r(ne, { value: `${c}`, children: l[at(c)] }, `${c}`))
          }
        )
      ]
    }
...
function ur({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
const oi = (t, e, n, o) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, d) => l.order - d.order).map((l) => /* @__PURE__ */ p(Vt, { children: [
  /* @__PURE__ */ r(Bt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    Qe,
    {
      onClick: () => {
        o(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(ur, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(ur, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ p(bw, { children: [
    /* @__PURE__ */ r(Gs, { children: l.label }),
    /* @__PURE__ */ r(gw, { children: /* @__PURE__ */ r(Fs, { children: oi(
      t,
      e,
      ri(t, l.id),
      o
...
function wo({
  ...
  return /* @__PURE__ */ p(Ne, { variant: s, children: [
    /* @__PURE__ */ r(Pe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(el, {}) }) }),
    /* @__PURE__ */ r(ce, { align: "start", style: { zIndex: qn }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, c]) => typeof d == "boolean" || typeof c == "boolean" ? 0 : d.order - c.order).map(([d], c, w) => /* @__PURE__ */ p(uo, { children: [
      /* @__PURE__ */ r(Bs, { children: /* @__PURE__ */ r(Pt, { children: oi(e.groups, e.items, d, t) }) }),
      c < w.length - 1 && /* @__PURE__ */ r($e, {})
    ] }, d)) })
  ] });
}
...
function Bm({
  ...
  return /* @__PURE__ */ p(ai, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wo,
      {
        onSelectMenuItem: t,
...
function Gm({
  ...
  return /* @__PURE__ */ r(ai, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    wo,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const si = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Jt.Root,
    {
...
si.displayName = Jt.List.displayName;
const ii = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Jt.List,
  {
    ref: n,
    className: h(
...
)), li = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Jt.Content,
  {
    ref: n,
    className: h(
...
li.displayName = Jt.Content.displayName;
function Fm({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(si, { children: [
      /* @__PURE__ */ r(ii, { children: t.map((l) => /* @__PURE__ */ r(Up, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(li, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function Yp({ ...t }) {
...
const ci = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ r(Oo.Provider, { value: a, children: /* @__PURE__ */ r(
    ft.Root,
    {
      ref: o,
      className: h(
...
ci.displayName = ft.Root.displayName;
const di = b.forwardRef(({ className: t, ...e }, n) => {
  const o = pe();
  return /* @__PURE__ */ r(
    ft.Trigger,
    {
...
di.displayName = ft.Trigger.displayName;
const wi = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = pe();
  return /* @__PURE__ */ p(
    ft.SubTrigger,
    {
...
wi.displayName = ft.SubTrigger.displayName;
const pi = b.forwardRef(({ className: t, ...e }, n) => {
  const o = pe();
  return /* @__PURE__ */ r(
    ft.SubContent,
    {
...
const ui = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = pe();
...
ui.displayName = ft.Content.displayName;
const mi = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = pe();
  return /* @__PURE__ */ r(
    ft.Item,
    {
...
mi.displayName = ft.Item.displayName;
const Wp = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = pe();
  return /* @__PURE__ */ p(
    ft.CheckboxItem,
    {
...
Wp.displayName = ft.CheckboxItem.displayName;
const Jp = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    ft.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ft.ItemIndicator, { children: /* @__PURE__ */ r(fr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
Jp.displayName = ft.RadioItem.displayName;
const Zp = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ft.Label,
  {
    ref: o,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Zp.displayName = ft.Label.displayName;
const fi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
fi.displayName = ft.Separator.displayName;
const Mn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, w) => c.order - w.order).map((c) => /* @__PURE__ */ p(Vt, { children: [
      /* @__PURE__ */ r(Bt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        mi,
        {
          onClick: () => {
            o(c);
          ...
          children: [
            c.iconPathBefore && /* @__PURE__ */ r(ur, { icon: c.iconPathBefore, menuLabel: c.label, leading: !0 }),
            c.label,
            c.iconPathAfter && /* @__PURE__ */ r(ur, { icon: c.iconPathAfter, menuLabel: c.label })
          ]
        },
        `menubar-item-${c.label}-${c.command}`
      ) : /* @__PURE__ */ p(Xp, { children: [
        /* @__PURE__ */ r(wi, { children: c.label }),
        /* @__PURE__ */ r(pi, { children: hi(
          t,
          e,
          ri(t, c.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ r(fi, {}, `separator-${s}`)), d;
  });
};
function Qp({
  menuData: t,
  ...
  if (Nc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    var g, y, x, N;
    w.preventDefault();
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Mn(s, [f, u]);
        break;
      case "alt+l":
        (y = i.current) == null || y.focus(), Mn(i, [f, u]);
        break;
      case "alt+n":
        (x = l.current) == null || x.focus(), Mn(l, [f, u]);
        break;
      case "alt+h":
        (N = d.current) == null || N.focus(), Mn(d, [f, u]);
        break;
    }
  }), J(() => {
    ...
    return /* @__PURE__ */ r(ci, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(Yp, { children: [
      /* @__PURE__ */ r(di, { ref: c(w), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        ui,
        {
          style: { zIndex: qn },
          children: /* @__PURE__ */ r(Pt, { children: hi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
  ...
  return /* @__PURE__ */ p("div", { id: d, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      fn,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(nn, { children: /* @__PURE__ */ r(hn, {}) }),
          /* @__PURE__ */ r(
            rn,
            {
              style: { zIndex: qn },
              children: Object.keys(t).map((g) => /* @__PURE__ */ r(ne, { value: g, children: u(g, e) }, g))
            }
          )
        ]
      }
...
function eu({ item: t, createLabel: e, createComplexLabel: n }) {
...
function Um({
  ...
  return n ? /* @__PURE__ */ r(Pt, { delayDuration: 0, children: /* @__PURE__ */ p(Vt, { children: [
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(Ne, { children: [
              /* @__PURE__ */ r(Pe, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(qo, {}) }) }),
              /* @__PURE__ */ r(ce, { align: "end", children: c })
            ] }) }),
            e && c && /* @__PURE__ */ p(Ne, { children: [
              /* @__PURE__ */ r(Pe, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(qo, {}) }) }),
              /* @__PURE__ */ r(ce, { align: "end", children: c })
            ] })
          ] }),
...
const nu = Kn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ol, { size: 35, className: h("tw-animate-spin", t), ...e, ref: n }));
nu.displayName = "Spinner";
function Xm({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
), ou = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
au.displayName = "AlertTitle";
const su = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
su.displayName = "AlertDescription";
const Wm = ht.Root, Jm = ht.Trigger, Zm = ht.Group, Qm = ht.Portal, tf = ht.Sub, ef = ht.RadioGroup, iu = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ht.SubTrigger,
  {
    ref: a,
    className: h(
...
iu.displayName = ht.SubTrigger.displayName;
...
lu.displayName = ht.SubContent.displayName;
const cu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ht.Portal, { children: /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    className: h(
...
cu.displayName = ht.Content.displayName;
const du = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ht.Item,
  {
    ref: o,
    className: h(
...
du.displayName = ht.Item.displayName;
const wu = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ht.CheckboxItem,
  {
    ref: a,
    className: h(
...
wu.displayName = ht.CheckboxItem.displayName;
const pu = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ht.RadioItem,
  {
    ref: o,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ht.ItemIndicator, { children: /* @__PURE__ */ r(fr, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
pu.displayName = ht.RadioItem.displayName;
const uu = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ht.Label,
  {
    ref: o,
    className: h(
...
uu.displayName = ht.Label.displayName;
...
mu.displayName = ht.Separator.displayName;
...
fu.displayName = "ContextMenuShortcut";
...
function hu({
  ...
  return /* @__PURE__ */ r(gi.Provider, { value: o, children: /* @__PURE__ */ r(
    de.Root,
    {
...
hu.displayName = "Drawer";
const nf = de.Trigger, gu = de.Portal, rf = de.Close, bi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  de.Overlay,
  {
    ref: n,
...
bi.displayName = de.Overlay.displayName;
const bu = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(gi), i = {
...
yu.displayName = de.Title.displayName;
const Nu = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  de.Description,
  {
    ref: n,
    className: h("tw-text-sm tw-text-muted-foreground", t),
...
Nu.displayName = de.Description.displayName;
const ku = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Jr.Root,
  {
    ref: o,
    className: h(
...
ku.displayName = Jr.Root.displayName;
function of({
  className: t,
  ...e
}) {
...
function sf({
  ...
  return /* @__PURE__ */ r(
    bo.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(al, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function lf({ ...t }) {
...
const _u = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ p(
    An.Root,
    {
...
_u.displayName = An.Root.displayName;
const Cu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Zr.Root,
    {
...
Cu.displayName = Zr.Root.displayName;
const cf = Jt.Root, Eu = b.forwardRef(({ className: t, ...e }, n) => {
  const o = _t();
  return /* @__PURE__ */ r(
    Jt.List,
    {
...
Eu.displayName = Jt.List.displayName;
...
Tu.displayName = Jt.Trigger.displayName;
const Su = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Jt.Content,
  {
    ref: n,
    className: h(
...
Su.displayName = Jt.Content.displayName;
const Ru = b.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: h(
...
export {
  ...
  hw as AvatarImage,
  sm as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  im as BOOK_SELECTOR_STRING_KEYS,
  ye as Badge,
  Rr as BookChapterControl,
  no as BookSelectionMode,
  lm as BookSelector,
  F as Button,
  dm as COMMENT_EDITOR_STRING_KEYS,
  wm as COMMENT_LIST_STRING_KEYS,
  $s as Card,
  js as CardContent,
  ...
  pm as CommentList,
  Wm as ContextMenu,
  wu as ContextMenuCheckboxItem,
  cu as ContextMenuContent,
  Zm as ContextMenuGroup,
  du as ContextMenuItem,
  uu as ContextMenuLabel,
  Qm as ContextMenuPortal,
  ef as ContextMenuRadioGroup,
  pu as ContextMenuRadioItem,
  mu as ContextMenuSeparator,
  fu as ContextMenuShortcut,
  tf as ContextMenuSub,
  lu as ContextMenuSubContent,
  iu as ContextMenuSubTrigger,
  Jm as ContextMenuTrigger,
  Aw as DataTable,
  Qr as Dialog,
  om as DialogClose,
  or as DialogContent,
  Ic as DialogDescription,
  to as DialogFooter,
  ar as DialogHeader,
  ns as DialogOverlay,
  Rc as DialogPortal,
  ...
  Bs as DropdownMenuGroup,
  Qe as DropdownMenuItem,
  jw as DropdownMenuItemType,
  ...
  mm as ERROR_POPOVER_STRING_KEYS,
  Fw as EditorKeyboardShortcuts,
  $w as ErrorDump,
  fm as ErrorPopover,
  ym as FOOTNOTE_EDITOR_STRING_KEYS,
  vm as Filter,
  hm as FilterDropdown,
  bm as Footer,
  xm as FootnoteEditor,
  rp as FootnoteItem,
  Nm as FootnoteList,
  ...
  Im as Inventory,
  Et as Label,
  Um as LinkedScrRefButton,
  Yw as MARKER_MENU_STRING_KEYS,
  um as MarkdownRenderer,
  Ww as MarkerMenu,
  gm as MoreInfo,
  Vw as MultiSelectComboBox,
  Fm as NavigationContentSearch,
  Ce as Popover,
  Oc as PopoverAnchor,
  we as PopoverContent,
  Tr as PopoverPortalContainerProvider,
  je as PopoverTrigger,
  ku as Progress,
  Dm as ProjectSelector,
  No as RadioGroup,
  ...
  Ym as ResultsCard,
  Am as SCOPE_SELECTOR_STRING_KEYS,
  Pm as ScopeSelector,
  Mm as ScriptureResultsViewer,
  ...
  mn as Separator,
  jm as SettingsList,
  Vm as SettingsListHeader,
  Lm as SettingsListItem,
  $p as SettingsSidebar,
  Om as SettingsSidebarContentSearch,
  Xs as Sidebar,
  Js as SidebarContent,
  Ep as SidebarFooter,
  io as SidebarGroup,
  ...
  nu as Spinner,
  Cu as Switch,
  wo as TabDropdownMenu,
  Gm as TabFloatingMenu,
  Bm as TabToolbar,
  vr as Table,
  yr as TableBody,
  Mw as TableCaption,
  ...
  qm as UiLanguageSelector,
  Gw as UndoRedoButtons,
  si as VerticalTabs,
  li as VerticalTabsContent,
  ii as VerticalTabsList,
  Up as VerticalTabsTrigger,
  qn as Z_INDEX_ABOVE_DOCK,
  es as Z_INDEX_FOOTNOTE_EDITOR,
  Ec as Z_INDEX_MODAL,
  Cc as Z_INDEX_MODAL_BACKDROP,
  vo as Z_INDEX_OVERLAY,
  ww as badgeVariants,
  is as buttonVariants,
  h as cn,
  Vr as computeRows,
  Sm as getBookIdFromUSFM,
  Nr as getInventoryHeader,
  Em as getLinesFromUSFM,
  Tm as getNumberFromUSFM,
  lp as getStatusForItem,
  zm as getToolbarOSReservedSpaceClassName,
  _m as inventoryCountColumn,
  km as inventoryItemColumn,
  Cm as inventoryStatusColumn,
  pp as partitionAndSort,
  zn as scrollGroupLetter,
