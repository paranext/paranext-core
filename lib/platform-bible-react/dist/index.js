...
var Ft = (t, e, r) => Pi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Ce, a as Ja, C as ke, T as Dt, b as Mt, d as Ot, e as $t, A as se, P as Re, f as He, B as G, h as De, i as Me, j as Oe, k as xe, x as Vi, l as ji, m as Bi, n as Li, o as Za, r as pe, p as Fi, q as pn, s as aa, t as oa, L as _t, R as Qa, u as Wr, D as Da, v as Ma, w as Oa, y as $a, z as hn, E as Lr, F as to, G as gn, H as eo, I as Ke, J as kr, K as $e, M as Ie, N as Ae, S as _r, O as ar, Q as Ui, U as Er, V as Ge, W as Te, Z as Ye, X as Ee, Y as or, _ as ro, $ as ao, a0 as Xr, a1 as oo, a2 as fn, a3 as Ki, a4 as qi, a5 as Gi, a6 as Ia, a7 as mn, a8 as na, a9 as vn, aa as Hi, ab as Yi, ac as Wi, ad as Xi, ae as bn, af as xn, ag as no, ah as Ji, ai as yn, aj as ga, ak as Co, al as fa, am as Zi, an as Qi, ao as ts, ap as es, aq as rs, ar as Tr, as as io, at as as, au as os } from "./resizable-D5FFq0E2.js";
import { av as sg, aw as cg, ax as lg, ay as dg, az as wg, aA as ug, aB as pg, aC as hg, aD as gg, aE as fg, aF as mg, aG as vg, aH as bg, aI as xg, aJ as yg, aK as kg, aL as _g, aM as Ng, aN as Cg, aO as Eg, aP as Tg, aQ as zg, aR as Sg, aS as Rg, aT as Dg } from "./resizable-D5FFq0E2.js";
import { jsx as a, jsxs as u, Fragment as at } from "react/jsx-runtime";
import { Canon as Rt } from "@sillsdev/scripture";
import { Check as ze, Clock as Eo, ChevronsLeft as To, ChevronsRight as zo, ChevronLeft as Aa, ChevronRight as Pa, ArrowLeft as ns, ArrowRight as is, ChevronDown as sr, BoldIcon as ss, ItalicIcon as cs, X as so, AtSign as kn, Pencil as ls, Trash2 as ds, ArrowUp as _n, MoreHorizontal as ws, MailOpen as us, Mail as ps, ChevronUp as hs, FilterIcon as gs, ArrowLeftIcon as fs, ChevronLeftIcon as ms, ChevronRightIcon as vs, ArrowRightIcon as bs, Copy as Nn, Filter as xs, User as ys, Link as ks, CircleHelp as _s, Undo as Ns, Redo as Cs, SquareX as Cn, FunctionSquare as En, SquareSigma as Tn, Ban as Es, AlertCircle as Va, CircleCheckIcon as Ts, CircleXIcon as zs, CircleHelpIcon as Ss, ArrowUpIcon as Rs, ArrowDownIcon as Ds, ScrollText as Ms, ChevronsUpDown as Os, MenuIcon as $s, Menu as Is, EllipsisVertical as As, MoreVertical as Ps } from "lucide-react";
import { Section as kt, getChaptersForBook as Vs, formatScrRef as ve, getSectionForBook as Fr, formatRelativeDate as js, formatReplacementString as qe, sanitizeHtml as co, NumberFormat as zn, formatBytes as Bs, getCurrentLocale as Ls, usfmMarkers as Ur, getFormatCallerFunction as Fs, deepEqual as Us, isString as So, compareScrRefs as ja, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as Ro, formatReplacementStringToArray as Do, collectUsjMarkers as qs } from "platform-bible-utils";
import Yt, { useRef as K, useMemo as O, useState as k, useCallback as L, useId as Ba, useEffect as W, useImperativeHandle as Gs, useLayoutEffect as te, createContext as lo, useContext as Sn, Component as Hs, createElement as Mo, Suspense as Ys, forwardRef as Rn, Fragment as ia } from "react";
import { IconSelector as Dn, IconCheck as sa, IconChevronDown as Ws, IconChevronUp as Xs, IconLayoutSidebar as Js, IconLayoutSidebarRight as Zs, IconChevronRight as Mn, IconSearch as Qs, IconLoader as tc, IconAlertOctagon as ec, IconAlertTriangle as rc, IconInfoCircle as ac, IconCircleCheck as oc } from "@tabler/icons-react";
import { createEditor as On, $getRoot as Se, $createParagraphNode as zr, $getSelection as Wt, HISTORY_MERGE_TAG as wo, ParagraphNode as $n, TextNode as In, $getPreviousSelection as nc, $isRangeSelection as we, $caretFromPoint as ic, $getSiblingCaret as An, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as Oo, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as Pn, $isElementNode as Nr, mergeRegister as ye, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as Vn, COMMAND_PRIORITY_EDITOR as uo, shallowMergeConfig as mc, defineExtension as ae, safeCast as We, createState as vc, FORMAT_TEXT_COMMAND as jn, $isNodeSelection as Bn, COMMAND_PRIORITY_LOW as Ln, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as zc, $getEditor as Sc, DecoratorNode as La, $getState as Rc, toggleTextFormatType as $o, TEXT_TYPE_TO_FORMAT as Dc, $setState as Mc, addClassNamesToElement as Fn, $create as Oc, $getNodeByKey as $c, removeClassNamesFromElement as Ic, KEY_TAB_COMMAND as Ac, $isBlockElementNode as Pc, $createRangeSelection as Vc, $normalizeSelection__EXPERIMENTAL as jc, OUTDENT_CONTENT_COMMAND as Bc, INDENT_CONTENT_COMMAND as Io, INSERT_TAB_COMMAND as Lc, COMMAND_PRIORITY_CRITICAL as po, $isDecoratorNode as Fc, $isParagraphNode as Uc, $isTextNode as Fa, SELECTION_CHANGE_COMMAND as Un, $insertNodes as Kc } from "lexical";
...
import { Avatar as ho, Select as Kt, Checkbox as Ao, Slot as Sr, Tabs as ce, Menubar as he, ContextMenu as It, Progress as Po, Slider as Ir, Switch as Vo } from "radix-ui";
import { useReactTable as qn, getFilteredRowModel as Qc, getSortedRowModel as Gn, getPaginationRowModel as tl, getCoreRowModel as Hn, flexRender as xr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ua, HIDDEN_NOTE_CALLER as Ka, getDefaultViewOptions as ol, isInsertEmbedOpOfType as Ar, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
function Yn({
  ...
  const h = K(!1), g = () => {
    ...
    ke,
    {
      ...
      className: v(
        ...
        E && "tw:opacity-70 tw:data-selected:opacity-100"
      ),
      children: [
        c && /* @__PURE__ */ a(
          ze,
  ...
  return E ? /* @__PURE__ */ a(Dt, { delayDuration: 500, children: /* @__PURE__ */ u(Mt, { children: [
    /* @__PURE__ */ a(Ot, { asChild: !0, children: $ }),
    /* @__PURE__ */ a($t, { children: p })
  ] }) }) : $;
}
function Wn(t, e, r) {
  return `${t} ${se[t]}${e ? ` ${Ja(t, e)} ${Ce(t, e)}` : ""}`;
}
function ll({
  recentSearches: t,
  ...
  return /* @__PURE__ */ u(Re, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(De, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a(xe, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      ke,
      {
        onSelect: () => E(y),
...
function qa(t) {
  return {
    [kt.OT]: t.filter((e) => Rt.isBookOT(e)),
    [kt.NT]: t.filter((e) => Rt.isBookNT(e)),
    [kt.DC]: t.filter((e) => Rt.isBookDC(e)),
    [kt.Extra]: t.filter((e) => Rt.extraBooks().includes(e))
  };
}
function gl(t, e) {
...
function xa({
  ...
  const T = pe(), [A, P] = k(!1), [z, V] = k(""), [q, B] = k(""), [U, M] = k("books"), [Y, D] = k(void 0), [_, Q] = k(
    void 0
  ), [J, ut] = k(void 0), [pt, At] = k(!1), [H, ot] = k(!1), dt = Ba(), ht = K(null), gt = K(!1), mt = K(void 0), nt = K(void 0), Tt = K(void 0), ee = K(void 0), Bt = K({}), Xt = K({}), Nt = L(
    (x) => {
      e(x), l && l(x);
    },
    [e, l]
    ...
    reachableBooksBySection: Lt,
    reachableBooks: Jt,
    projectBooks: ne,
    booksOutsideProject: I
  } = O(
    () => gl(oe, xt),
    [oe, xt]
  ), Z = I.has(t.book), it = O(() => q.trim() ? qa(
    Jt.filter((x) => Za(x, q, i))
  ) : H ? Lt : zt, [
    zt,
    Lt,
    Jt,
  ...
  const et = L(() => {
    if (N) {
      const x = N.chapterNum ?? 1, X = N.verseNum ?? 1;
      if (p && ba(N.book, x, X, p))
        return;
      Nt({
        book: N.book,
        chapterNum: x,
    ...
    (x) => {
      const X = _ ?? (N == null ? void 0 : N.book), tt = J ?? (N == null ? void 0 : N.chapterNum);
      !X || !tt || (Nt({
        book: X,
        chapterNum: tt,
        verseNum: x
    ...
    (x) => {
      const X = U === "chapters" ? Y : N == null ? void 0 : N.book;
      if (X) {
        if (w && w(X, x) > 1) {
          Q(X), ut(x), M("verses"), V("");
          return;
    ...
    M("books"), D(void 0), Q(void 0), ut(void 0), setTimeout(() => {
      nt.current && nt.current.focus();
    }, 0);
  }, []), Vt = L(() => {
    const x = _;
    Q(void 0), ut(void 0), x ? (D(x), M("chapters"), V("")) : yt();
  }, [_, yt]), Gt = L(
    (x) => {
      P(x), x && (M("books"), D(void 0), Q(void 0), ut(void 0), B(""), ot(Z));
    },
    [Z]
  );
  W(() => {
  ...
  const { otLong: Et, ntLong: Zt, dcLong: Ve, extraLong: Xe } = {
    ...
    () => ul(q),
    [q]
  ), _e = O(() => !w || !N || !N.chapterNum || !je ? !1 : w(N.book, N.chapterNum) > 0, [w, N, je]), ua = U === "books" && !q.trim() && I.size > 0, No = L(
    (x) => p ? jo(x, p) : !1,
    [p]
  ), Or = L(
    (x) => (X) => p ? pl(x, X, p) : !1,
    ...
    (x, X) => (tt) => p ? ba(x, X, tt, p) : !1,
    [p]
  ), mr = (s == null ? void 0 : s["%webView_bookChapterControl_selectChapter%"]) || "Select chapter", Je = (s == null ? void 0 : s["%webView_bookChapterControl_selectVerse%"]) || "Select verse", $r = (s == null ? void 0 : s["%webView_bookChapterControl_bookNotInProject%"]) || "not in this project", Ze = (s == null ? void 0 : s["%webView_bookChapterControl_showMoreBooks%"]) || "Show more books", pa = (s == null ? void 0 : s["%webView_bookChapterControl_showProjectBooksOnly%"]) || "Show project books only", Qe = L(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), h && h.includes(x.key) && N && N.chapterNum !== void 0 && N.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), et());
    },
    [h, N, et]
  ), ha = L(
    (x) => {
      var fe, Be, me;
      if (x.ctrlKey) return;
      const { isLetter: X, isDigit: tt } = Bo(x.key);
      if ((U === "chapters" || U === "verses") && (x.key === " " || x.key === "Enter")) {
        const jt = x.target instanceof HTMLElement ? x.target : void 0;
        ...
        const S = (fe = mt.current) == null ? void 0 : fe.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (S) {
          x.preventDefault(), x.stopPropagation(), S.click();
          return;
        }
      }
      if ((U === "chapters" || U === "verses") && (X || tt)) {
        x.preventDefault(), x.stopPropagation();
        return;
      }
      if (U === "chapters" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), yt();
        return;
      }
      if (U === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), Vt();
        return;
      }
      const Qt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (U === "verses" && Qt) {
        const jt = _, bt = J;
        if (!jt || !bt || !w) return;
        const S = w(jt, bt);
        if (!S) return;
        (Be = mt.current) == null || Be.focus();
        const j = (() => {
          if (!z) return 1;
          const Le = z.match(/:(\d+)$/);
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            lt = j === 0 ? S : Math.max(1, j - Ht);
            break;
          case "ArrowDown":
            lt = j === 0 ? 1 : Math.min(S, j + Ht);
            break;
          default:
            return;
        }
        lt !== j && (x.preventDefault(), x.stopPropagation(), V(
          `${jt} ${se[jt] || ""} ${bt}:${lt}`
        ), setTimeout(() => {
          const Le = Xt.current[lt];
          Le && Le.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((U === "chapters" || U === "books" && N) && Qt) {
        const jt = U === "chapters" ? Y : N == null ? void 0 : N.book;
        if (!jt) return;
        U === "chapters" && ((me = mt.current) == null || me.focus());
        const bt = (() => {
          if (!z) return 1;
          const Ht = z.match(/(\d+)$/);
          return Ht ? parseInt(Ht[1], 10) : 0;
        })(), S = nr(jt);
        if (!S) return;
        let j = bt;
        const lt = 6;
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            j = bt === 0 ? S : Math.max(1, bt - lt);
            break;
          case "ArrowDown":
            j = bt === 0 ? 1 : Math.min(S, bt + lt);
            break;
          default:
            return;
        }
        j !== bt && (x.preventDefault(), x.stopPropagation(), V(
          `${jt} ${se[jt] || ""} ${j}`
        ), setTimeout(() => {
          const Ht = Bt.current[j];
          Ht && Ht.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
      }
    },
    [
    ...
    if (x.key === "ArrowUp" || x.key === "ArrowDown") {
      (Qt = nt.current) == null || Qt.focus();
      return;
    }
    const { isLetter: X, isDigit: tt } = Bo(x.key);
    (X || tt) && (x.preventDefault(), B((fe) => fe + x.key), nt.current.focus(), At(!1));
  }, []);
  return te(() => {
    const x = setTimeout(() => {
      if (A && U === "books" && Tt.current && ee.current) {
        const X = Tt.current, tt = ee.current, Qt = tt.offsetTop, fe = X.clientHeight, Be = tt.clientHeight, me = Qt - fe / 2 + Be / 2;
        X.scrollTo({
          top: Math.max(0, me),
          behavior: "smooth"
        }), V(Wn(t.book));
    ...
    if (U === "chapters" && Y) {
      ...
      V(
        ...
        if (Tt.current)
          if (x) {
            const tt = Bt.current[t.chapterNum];
    ...
    if (U === "verses" && _ && J !== void 0) {
      ...
      V(
        ...
        if (Tt.current)
          if (x) {
            const tt = Xt.current[t.verseNum];
            tt && tt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            Tt.current.scrollTo({ top: 0 });
        mt.current && mt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Re, { open: A, onOpenChange: Gt, modal: y, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        ...
        children: [
          g ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Mr }),
          b && /* @__PURE__ */ a(
            Dn,
            {
    ...
    /* @__PURE__ */ a(
      De,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: X } = x;
          A && ht.current && X instanceof Node && ht.current.contains(X) && (gt.current = !0, Gt(!1));
        },
        onCloseAutoFocus: E,
        children: /* @__PURE__ */ u(
          Me,
            ...
            children: [
              U === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: qt.map(
                  ({ onClick: x, disabled: X, title: tt, icon: Qt }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: U === "verses" ? Vt : yt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                U === "chapters" && Y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ce(Y, i) }),
                U === "verses" && _ && J !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ce(_, i)} ${J}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: U === "verses" ? Je : mr
                  }
                )
              ] }),
              !pt && /* @__PURE__ */ u(Oe, { ref: Tt, id: dt, children: [
                U === "books" && /* @__PURE__ */ u(at, { children: [
                  !N && Object.entries(it).map(([x, X]) => {
                    if (X.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(xe, { heading: Rr(x), children: X.map((tt) => /* @__PURE__ */ a(
                          Yn,
                          {
                            bookId: tt,
                            onSelect: (Qt) => wt(Qt),
                            ...
                            ref: tt === t.book ? ee : void 0,
                            localizedBookNames: i,
                            disabled: No(tt),
                            dimmedReason: I.has(tt) ? $r : void 0
                          },
                          tt
                        )) }, x)
                      );
                  }),
                  N && /* @__PURE__ */ a(xe, { children: /* @__PURE__ */ a(
                    ke,
                    {
                      value: `${N.book} ${se[N.book]} ${N.chapterNum || ""}:${N.verseNum || ""})}`,
                      onSelect: et,
                      disabled: !!p && ba(
                        N.book,
                        N.chapterNum ?? 1,
                      ...
                      children: ve(
                        ...
                        i ? Ja(N.book, i) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  N && _e && N.chapterNum && w && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ce(N.book, i)} ${N.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: Je })
                    ] }),
                    /* @__PURE__ */ a(
                      Fo,
                      {
                        ...
                        endVerse: w(N.book, N.chapterNum),
                        scrRef: t,
                        onVerseSelect: vt,
                        setVerseRef: gr,
                        isVerseDisabled: fr(N.book, N.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  N && !_e && nr(N.book) > 1 && /* @__PURE__ */ u(at, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ce(N.book, i) }),
              ...
              ua && /* @__PURE__ */ a("div", { className: "tw:border-t tw:p-1", children: /* @__PURE__ */ a(
                G,
                {
                  variant: "ghost",
                  size: "sm",
...
function Uo({
  ...
  const [C, $] = k(!1), F = d ?? l, T = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], A = (P, z) => {
    const V = l(P), q = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, B = `${z ?? ""}${V}${q ?? ""}`;
    return /* @__PURE__ */ u(
      ke,
      {
        value: V,
  ...
  return /* @__PURE__ */ u(Re, { open: C, onOpenChange: $, ...y, children: [
    /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      De,
      {
        ...
        children: /* @__PURE__ */ u(Me, { children: [
          ...
          /* @__PURE__ */ a(Oe, { children: T(e) ? e.map((P) => /* @__PURE__ */ a(xe, { heading: P.groupHeading, children: P.options.map((z) => A(z, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((P) => A(P)) }) })
        ] })
      }
    )
  ] });
    ...
    Qa,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(_t, { className: "tw:flex tw:items-center", children: o.map((m) => Rt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            G,
            {
...
const Zn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Zn ? te : W, Vr = { tag: wo };
function xl({ initialConfig: t, children: e }) {
  const r = O(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = vl(null, o), w = On({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (Wt() !== null || b !== null && b === p.getRootElement()) && f.select();
          }
        }, Vr);
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = ge(), r = O(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = K(o);
    return Tl(() => {
...
const Qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Dl = Qn && "documentMode" in document ? document.documentMode : null;
!(!Qn || !("InputEvent" in window) || Dl) && "getTargetRanges" in new window.InputEvent("input");
function de(t) {
  return `${t}px`;
}
...
function Ol(t, e, r) {
  ...
  function l() {
    ...
    const { left: p, top: h } = n.getBoundingClientRect(), g = Rl(t, e);
    var f, b;
    c.isConnected || (b = c, (f = n).insertBefore(b, f.firstChild));
    let m = !1;
    for (let E = 0; E < g.length; E++) {
      const y = g[E], C = s[E] || document.createElement("div"), $ = C.style;
      $.position !== "absolute" && ($.position = "absolute", m = !0);
      const F = de(y.left - p);
      $.left !== F && ($.left = F, m = !0);
      const T = de(y.top - h);
      $.top !== T && (C.style.top = T, m = !0);
      const A = de(y.width);
      $.width !== A && (C.style.width = A, m = !0);
      const P = de(y.height);
      $.height !== P && (C.style.height = P, m = !0), C.parentNode !== c && (c.append(C), m = !0), s[E] = C;
    }
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(P) {
        const z = P.getStartEndPoints();
        return P.isBackward() ? [z[1], z[0]] : z;
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, E = g.getNode(), y = E.getKey(), C = g.offset, $ = t.getElementByKey(b), F = t.getElementByKey(y), T = r === null || $ !== o || m !== n || b !== r.getKey(), A = i === null || F !== s || C !== c || y !== i.getKey();
      if ((T || A) && $ !== null && F !== null) {
        const P = function(z, V, q, B, U, M, Y) {
          const D = (z._window ? z._window.document : document).createRange();
          return D.setStart(...Ko(V, q, B)), D.setEnd(...Ko(U, M, Y)), D;
        }(t, h, f, $, g, E, F);
        l(), l = Ol(t, P, e);
      }
      r = f, o = $, n = m, i = E, s = F, c = C;
    });
  }
...
function Vl(t) {
  const e = Wt() || nc();
  let r;
  if (we(e)) r = ic(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = An(c, "next"));
    }
    r = r || sc(Se(), "previous").getFlipped().insert(zr());
  }
...
function jl(t, e, r) {
  ...
  return hc(o) && Jr(283), o.insert(t.isInline() ? zr().append(t) : t), Oo(An(t.getLatest(), "next"), e.direction);
}
function Bl(t) {
  const e = Wt();
  if (!we(e)) return !1;
...
let Zr, be = 0, Qr = 0, Ul = 0, Ha = 0, qr = 0;
function Go(t) {
  if (rt === void 0) return;
  let e = t.n;
...
function ql(t) {
  ...
  ei(this), rt = t, this.f &= -2, 8 & this.f && mo(this), la();
}
function rr(t, e) {
...
Ut.prototype.brand = Ll, Ut.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      be !== 0 && Qr === 0 && e.l !== Ha && (e.l = Ha, Zr = { S: e, v: e.v, i: e.i, o: Zr });
    })(this), this.v = t, this.i++, qr++, be++;
    try {
  ...
  if (this.g = qr, this.f |= 1, this.i > 0 && !ti(this)) return this.f &= -2, !0;
  const t = rt;
  try {
    Ho(this), rt = this;
    const e = this.x();
  ...
  return rt = t, ei(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ri(this), Ho(this), be++;
  const t = rt;
  return rt = this, ql.bind(this, t);
...
ae({ build: (t, e, r) => pr(e), config: We({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function ai() {
  const t = Se(), e = Wt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), we(e) && (e.format = 0);
}
function oi(t, e = ai) {
  return t.registerCommand(Vn, (r) => (t.update(e), !0), uo);
}
ae({ build: (t, e, r) => pr(e), config: We({ $onClear: ai }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ue(() => oi(t, o.value));
} });
function Gl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const _a = vc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ni extends La {
  $config() {
    return this.config("decorator-text", { extends: La, stateConfigs: [{ flat: !0, stateConfig: _a }] });
  }
  getFormat() {
    return Rc(this, _a);
  }
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [ni], register: (t, e, r) => t.registerCommand(jn, (o) => {
  const n = Wt();
  if (Bn(n) || we(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Ln) });
function ii(t, e) {
  let r;
...
const Ya = ae({ build: (t) => ii(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const vo = 0, Wa = 1, ci = 2, Na = 3, jr = 4, er = 5, Ca = 6, vr = 7;
function Ea(t) {
  return t.id === vo;
}
function li(t) {
...
function Yl(t) {
  return function(e) {
    return e.id === Wa;
  }(t) || ct(305, String(t.id), String(Wa)), Object.assign(t, { id: ci });
}
...
class Xl {
  constructor(e, r) {
    ...
    Ft(this, "state");
    Ft(this, "_signal");
    this.builder = e, this.extension = r, this.configs = /* @__PURE__ */ new Set(), this.state = { id: vo };
  }
  mergeConfigs() {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== jr && ct(307, String(r.id), String(er)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ca && ct(310, String(r.id), String(Ca)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= jr;
    }(e) || ct(313, String(e.id), String(jr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Na;
    }(e) || ct(314, String(e.id), String(Na)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= vr;
    }(e) || ct(316, String(e.id), String(vr)), e;
  }
...
const Zl = ae({ config: We({ setOptions: Yo, updateOptions: Yo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [bc, In, xc, yc, $n] }), Wo = Symbol.for("@lexical/extension/LexicalBuilder");
function Xo() {
}
function Ql(t) {
  throw t;
...
class ir {
  ...
  static maybeFromEditor(e) {
    const r = e[Wo];
    return r && (r.PACKAGE_VERSION !== Ta && ct(292, r.PACKAGE_VERSION, Ta), r instanceof ir || ct(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ea(i) || ct(300, s, n || "[unknown]"), Ea(c = i) || ct(304, String(c.id), String(vo)), i = Object.assign(c, { id: Wa }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Gl(p)) {
        if (typeof h != "function") {
          const g = o.get(h.replace);
          g && ct(302, p.name, h.replace.name, g.extension.name), o.set(h.replace, w);
        }
        r.add(h);
      }
      if (p.html) {
...
const td = /* @__PURE__ */ new Set(), Jo = ae({ build(t, e, r) {
  const o = r.getDependency(Ya).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ii(() => {
  }, () => ue(() => {
    const s = i.peek(), { watchedNodeKeys: c } = n.value;
    let l, d = !1;
    o.value.read(() => {
      if (Wt()) for (const [w, p] of c.entries()) {
        if (p.size === 0) {
          c.delete(w);
          continue;
        }
  ...
  return { watchNodeKey: function(s) {
    const c = Kl(() => (i.value || td).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(s, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [Ya], name: "@lexical/extension/NodeSelection" }), ed = _c("INSERT_HORIZONTAL_RULE_COMMAND");
class cr extends La {
  static getType() {
...
ae({ dependencies: [Ya, Jo], name: "@lexical/extension/HorizontalRule", nodes: () => [cr], register(t, e, r) {
  ...
  return ye(t.registerCommand(ed, (s) => {
    const c = Wt();
    if (!we(c)) return !1;
    ...
    return !0;
  }, uo), t.registerCommand(Nc, (s) => {
    if (Cc(s.target)) {
      const c = Ec(s.target);
      if (ad(c)) return function(l, d = !1) {
        const w = Wt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && Bn(w) ? g = w : (g = Tc(), zc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Ln), t.registerMutationListener(cr, (s, c) => {
    Fl(() => {
      let l = !1;
    ...
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(ue(() => {
      const d = c.value;
      d && (l.value ? Fn(d, i) : Ic(d, i));
    }));
    return ye(...s);
  }));
} });
ae({ build: (t, e) => pr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: We({ $getParentEditor: function() {
  const t = Sc();
...
ae({ build: (t, e, r) => pr(e), config: We({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ue(() => {
...
function od(t, e, r = di) {
  return ye(t.registerCommand(Ac, (o) => {
    const n = Wt();
    if (!we(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Pc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Pl(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Vc();
      ...
      return !1;
    }(n) ? o.shiftKey ? Bc : Io : Lc;
    return t.dispatchCommand(i, void 0);
  }, uo), t.registerCommand(Io, () => {
    const o = typeof e == "number" ? e : e ? e.peek() : null, n = Wt();
    if (!we(n)) return !1;
...
ae({ build: (t, e, r) => pr(e), config: We({ $canIndent: di, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (we(f)) {
                ...
                if (Fa(m) && d >= 0 && w >= 0 && (E = d, y = d + w, f.setTextNodeRange(m, E, m, y)), E === y && p === "" || (f.insertRawText(p), m = b.getNode()), Fa(m)) {
                  E = h, y = h + g;
                  const C = m.getTextContentSize();
                  E = E > C ? C : E, y = y > C ? C : y, f.setTextNodeRange(m, E, m, y);
                }
...
ae({ build: (t, e, r) => pr(e), config: We({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ue(() => r.getOutput().disabled.value ? void 0 : ui(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const xo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
...
const gd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function fd({ onClear: t }) {
  const [e] = ge();
  return gd(() => oi(e, t), [e, t]), null;
}
const pi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? te : W;
function md({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: E = !0, style: y, tabIndex: C, "data-testid": $, ...F }, T) {
  const [A, P] = k(t.isEditable()), z = L((q) => {
    q && q.ownerDocument && q.ownerDocument.defaultView ? t.setRootElement(q) : t.setRootElement(null);
  }, [t]), V = O(() => /* @__PURE__ */ function(...q) {
    return (B) => {
      for (const U of q) typeof U == "function" ? U(B) : U != null && (U.current = B);
    };
  }(T, z), [z, T]);
  return pi(() => (P(t.isEditable()), t.registerEditableListener((q) => {
    P(q);
  })), [t]), a("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? r : "none", "aria-controls": A ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? p : void 0, "aria-readonly": !A || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: A, "data-testid": $, id: b, ref: V, role: m, spellCheck: E, style: y, tabIndex: C, ...F });
}
const vd = Rn(md);
function Qo(t) {
  return t.getEditorState().read(wi(t.isComposing()));
...
function Nd() {
  const [t, e] = k(void 0), r = L(() => {
    ...
    return /* @__PURE__ */ a(Da, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Ma, { children: [
      /* @__PURE__ */ a(Oa, { children: /* @__PURE__ */ a($a, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = L(
    (i, s, c = !1) => {
...
function Cd({
  ...
  const [e] = ge(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = Nd(), l = () => {
  };
...
function Td() {
  const { activeEditor: t } = gi(), [e, r] = k([]), o = L((n) => {
    if (we(n) || Xc(n)) {
      const i = [];
      tn.forEach(({ format: s }) => {
...
function Sd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Cd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Td, {}) }) }),
...
const Md = "verseText", tp = Object.freeze([
...
function ep({
  ...
  const [i, s] = k(Od), [c, l] = k(n), [d, w] = k(!1), p = K(void 0), h = K(null);
  W(() => {
    let m = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Re, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ u(
        G,
        {
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(kn, { className: "tw:h-4 tw:w-4" }),
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : ko(m) && (m.preventDefault(), m.stopPropagation(), re(i) && g());
        },
        onKeyDown: (m) => {
          yo(m), (m.key === "Enter" || m.key === " ") && m.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ta,
          {
...
function rn({
  ...
  }, [t.date, r]), m = O(() => t.user, [t.user]), E = O(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = O(() => co(t.contents), [t.contents]), C = O(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), $ = !!t.conflictResolutionAction && !C, F = O(() => {
    if (o && c)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          Ke,
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Dd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Pd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: E }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : ko(T) && (T.preventDefault(), T.stopPropagation(), re(w) && f());
              },
              onKeyDown: (T) => {
                yo(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
        ...
        F && /* @__PURE__ */ u($e, { children: [
          /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ws, {}) }) }),
...
function Ni({
  ...
  const [B, U] = k(an), [M, Y] = k(), [D, _] = k(), Q = o, [J, ut] = k(!1), [pt, At] = k(!1), [H, ot] = k(!1), [dt, ht] = k(!1), [gt, mt] = k(!1), [nt, Tt] = k($), [ee, Bt] = k(!1), Xt = K(void 0), [Nt, oe] = k(/* @__PURE__ */ new Map());
  W(() => {
    let R = !0;
    return (async () => {
    ...
    let R = !0;
    if (!o) {
      ht(!1), oe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Et = E ? await E(l) : !1;
      R && ht(Et);
    })(), () => {
      R = !1;
    };
  ...
  W(() => {
    if (!o) {
      xt.current !== "idle" && (Y(void 0), _(void 0), xt.current = "idle");
      return;
    }
    xt.current === "idle" && (xt.current = "pending"), dt ? xt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    A !== i && (Y(A), xt.current = "auto-populated") : xt.current === "auto-populated" && (Y(void 0), xt.current = "pending");
  }, [o, A, dt, i]);
  const zt = O(
    () => P ?? e.filter((R) => !R.deleted),
    [P, e]
  );
  W(() => {
    let R = !0;
  ...
  const Lt = O(() => zt[0], [zt]), Jt = K(null), ne = K(void 0), I = L(() => {
    var R;
    (R = ne.current) == null || R.call(ne), U(an);
  }, []), Z = L(() => {
    const R = !nt;
    Tt(R), Bt(!R), f == null || f(l, R);
  }, [nt, f, l]);
  W(() => {
    ut(!1);
  }, [o]), W(() => {
  ...
  }, [i, r]), st = O(() => zt.slice(1), [zt]), et = O(() => st.length ?? 0, [st.length]), vt = O(() => et > 0, [et]), wt = O(() => J || et <= 2 ? st : st.slice(-2), [st, et, J]), ft = O(() => J || et <= 2 ? 0 : et - 2, [et, J]), Pt = O(
    () => et === 1 ? it.singleReply : qe(it.multipleReplies, { count: et }),
    [et, it]
  ), qt = O(
    () => ft === 1 ? it.singleReply : qe(it.multipleReplies, { count: ft }),
    [ft, it]
  );
  W(() => {
    !o && pt && vt && At(!1);
  ...
  const yt = L(
    async (R) => {
      ...
      Ct && await p({ threadId: l, contents: Ct }) && I();
    },
    [
      I,
      B,
    ...
    async (R) => {
      const Ct = re(B) ? ea(B) : void 0, Et = R.status ? R.assignedUser : M ?? R.assignedUser, Zt = await p({
        ...R,
        contents: Ct,
        assignedUser: Et
      });
      return Zt && (Et !== void 0 && _(Et), Ct && I()), Zt;
    },
    [I, B, p, M]
  );
  ...
  const Gt = /* @__PURE__ */ a(
    rn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: At,
      canEditOrDelete: (!pt && Nt.get(Lt.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Ad, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            N && /* @__PURE__ */ a(kr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: N }),
            /* @__PURE__ */ a(
              G,
              {
                variant: "ghost",
                ...
                children: nt ? /* @__PURE__ */ a(us, {}) : /* @__PURE__ */ a(ps, {})
              }
            ),
            V === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: gt && w !== "Resolved",
                  onClick: () => Vt({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(at, { children: [
          ...
          o && /* @__PURE__ */ u(at, { children: [
            q && wt.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            ft > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (R) => {
                  R.stopPropagation(), ut(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (R) => {
                  (R.key === "Enter" || R.key === " ") && (R.preventDefault(), R.stopPropagation(), ut(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(_r, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: qt }),
                    J ? /* @__PURE__ */ a(hs, {}) : /* @__PURE__ */ a(sr, {})
                  ] })
                ]
              }
            ),
            wt.map((R) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              rn,
              {
                comment: R,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: At,
                canEditOrDelete: (!pt && Nt.get(R.id)) ?? !1
              }
            ) }, R.id)),
            m !== !1 && (!pt || re(B)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (R) => {
                  ko(R) && (R.preventDefault(), R.stopPropagation(), (re(B) || M !== void 0 && M !== D) && yt());
                },
                onKeyDown: (R) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    M !== void 0 && (re(B) || M !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: qe(
                    ...
                    /* @__PURE__ */ u(Re, { open: H, onOpenChange: ot, children: [
                      /* @__PURE__ */ a(He, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        De,
                        {
                          ...
                          align: "end",
                          onKeyDown: (R) => {
                            R.key === "Escape" && (R.stopPropagation(), ot(!1));
                          },
                          children: /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a(Oe, { children: b == null ? void 0 : b.map((R) => /* @__PURE__ */ a(
                            ke,
                            {
                              onSelect: () => {
                                Y(R !== i ? R : void 0), xt.current = "user-selected", _(void 0), ot(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Gr(R, r) })
                            },
                            R || "unassigned"
                          )) }) })
                        }
...
), Bd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Hr = (t) => Bd(co(t));
function Yr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Ld({
  ...
  const [s, c] = k("accept"), l = Ba(), d = Ba(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = O(
    () => Hr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = O(
    () => Hr(t.acceptedText ?? ""),
    ...
    () => Hr(t.mergedText ?? ""),
    [t.mergedText]
  ), y = O(() => co(t.contents), [t.contents]);
  if (!yi(t))
    return /* @__PURE__ */ a(Yr, { html: y });
  const C = (D) => {
    c(D === "reject" || D === "merge" ? D : "accept");
  }, $ = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", F = g ? [
    {
      value: "merge",
  ...
  let z;
  A ? z = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (z = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", q = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), B = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : q, U = () => {
    const D = o ?? "accept";
    return D === "merged" ? t.mergedText ? /* @__PURE__ */ a(Yr, { html: E }) : q : B(D === "reject" ? t.rejectedResultText : t.resultText);
  }, M = (D) => p && D.value === "reject", Y = (D) => {
    const _ = f === D.value, Q = `${d}-${D.value}`, J = M(D);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(at, { children: [
        ...
        /* @__PURE__ */ a(
          Qa,
          {
            ...
            children: T.map((D) => M(D) ? /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: Y(D) }),
...
function Gd(t) {
  ...
  } = t, c = O(() => e.filter((E) => !E.deleted), [e]), l = O(
    () => c.find((E) => E.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = qd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function dp({
  ...
  const [y, C] = k(/* @__PURE__ */ new Set()), [$, F] = k(), [T, A] = k(), P = L(
    async (_) => {
      const Q = await i(_);
      return Q !== void 0 && _.assignedUser !== void 0 && _.assignedUser !== "" && A(_.assignedUser), Q;
    },
    [i]
  );
  W(() => {
    f && (C((_) => new Set(_).add(f)), F(f));
  }, [f]);
  const z = r.filter(
    (_) => _.comments.some((Q) => !Q.deleted)
  ), V = z.map((_) => ({ id: _.id })), q = L(
    (_) => {
      C((Q) => new Set(Q).add(_.id)), F(_.id), b == null || b(_.id);
    },
    [b]
  ), B = L(
    (_) => {
      ...
      C((J) => {
        const ut = new Set(J);
        return ut.has(_) ? ut.delete(_) : ut.add(_), ut;
      }), F(_), b == null || b(Q ? void 0 : _);
    },
    [y, b]
  ), { listboxRef: U, activeId: M, handleKeyDown: Y } = Ui({
    options: V,
    onOptionSelect: q
  }), D = L(
    (_) => {
      _.key === "Escape" ? ($ && y.has($) && (C((Q) => {
        const J = new Set(Q);
        return J.delete($), J;
      ...
      children: z.map((_) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: _.type === "Conflict" ? /* @__PURE__ */ a(Gd, { ...Q, conflictResolution: E }) : /* @__PURE__ */ a(Ni, { ...Q })
          },
          _.id
        );
      })
...
function wr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Kt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Kt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Dn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
      ...
      /* @__PURE__ */ u(
        lr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(ur, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ie, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Zd({
  ...
  var T;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, E] = k({}), y = O(() => e ?? [], [e]), C = qn({
    data: y,
    columns: t,
    getCoreRowModel: Hn(),
  ...
  let F;
  return l ? F = Array.from({ length: 10 }).map((z, V) => `skeleton-row-${V}`).map((z) => /* @__PURE__ */ a(Ee, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(or, { colSpan: $.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ar, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? F = C.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    Ee,
    {
      onClick: () => s(A, C),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((P) => /* @__PURE__ */ a(or, { children: xr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    A.id
  )) : F = /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(or, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Hd, { table: C }),
    /* @__PURE__ */ u(ro, { stickyHeader: i, children: [
      /* @__PURE__ */ a(ao, { stickyHeader: i, children: C.getHeaderGroups().map((A) => /* @__PURE__ */ a(Ee, { children: A.headers.map((P) => /* @__PURE__ */ a(Xr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : xr(P.column.columnDef.header, P.getContext()) }, P.id)) }, A.id)) }),
      /* @__PURE__ */ a(oo, { children: F })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(G, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Nn, {}) })
        ] }),
...
function fp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u($e, { children: [
    ...
    /* @__PURE__ */ a(Ae, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(fn, { children: d.itemType === 0 ? /* @__PURE__ */ a(at, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Te,
        {
          checked: o[w][h],
...
function ow({
  ...
  const l = eo(), d = nn(n, "%undoButton_tooltip%"), w = nn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(to, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(
        G,
...
const iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(at, { children: [
...
function sw({
  ...
  const i = K(null), s = K(null), c = K(!1), [l, d] = k(t), [w, p] = k(r), [h, g] = k(!1);
  W(() => {
    d(t);
  }, [t]), W(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var E, y, C, $;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((E = i.current) == null || E.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((C = i.current) == null ? void 0 : C.selectionStart) === 0 && (($ = s.current) == null || $.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u($e, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
const cw = (t, e) => t === "f" ? /* @__PURE__ */ u(at, { children: [
  /* @__PURE__ */ a(En, {}),
  " ",
...
function dw({
  ...
  return /* @__PURE__ */ u($e, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Ie, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Ae, { style: { zIndex: mn }, children: [
...
function xp({
  ...
  const w = K(null), p = K(null), h = K(null), g = K(null);
  te(() => {
    if (!g.current) return;
    const { width: I } = g.current.getBoundingClientRect();
    I > 0 && (g.current.style.width = `${I}px`);
  }, []);
  const [f, b] = k("generated"), [m, E] = k("generated"), [y, C] = k("*"), [$, F] = k("*"), [T, A] = k("f"), [P, z] = k(!1), [V, q] = k(!0), [B, U] = k(!1), M = K(!1), Y = K(""), [D, _] = k(!1), [Q, J] = k(), [ut, pt] = k(), [At, H] = k(), [ot, dt] = k(), ht = K(null), gt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (Z && Ar("note", Z)) {
      const st = (it = Z.insert.note) == null ? void 0 : it.caller;
      let et = "custom";
      st === Ua ? et = "generated" : st === Ka ? et = "hidden" : st && (C(st), F(st)), b(et), E(et), A(((N = Z.insert.note) == null ? void 0 : N.style) ?? "f"), I = setTimeout(() => {
        var vt;
        (vt = w.current) == null || vt.applyUpdate([Z]);
      }, 0);
    }
    return () => {
      I && clearTimeout(I);
  ...
  const nt = L(
    (I, Z, it = !1) => {
      var st, et, vt;
      const N = (et = (st = w.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (N && Ar("note", N)) {
        if (N.insert.note) {
          let wt;
          I === "custom" ? wt = Z : I === "generated" ? wt = Ua : wt = Ka, N.insert.note.caller = wt;
        }
        r == null || r([N]), it && d && i && ((vt = d.current) == null || vt.replaceEmbedUpdate(i, [N]));
      }
    },
    [i, r, d]
  ), Tt = L(() => {
  ...
  const Bt = K({ book: n.book, chapterNum: n.chapterNum });
  te(() => {
    (Bt.current.book !== n.book || Bt.current.chapterNum !== n.chapterNum) && (Bt.current = { book: n.book, chapterNum: n.chapterNum }, ee.current());
  }, [n.book, n.chapterNum]);
  const Xt = () => {
    var Z;
    ...
    var it, N, st, et, vt;
    A(I);
    const Z = (N = (it = w.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : N.at(0);
    if (Z && Ar("note", Z)) {
      Z.insert.note && (Z.insert.note.style = I);
      const wt = (et = (st = Z.insert.note) == null ? void 0 : st.contents) == null ? void 0 : et.ops;
      T !== "x" && I === "x" ? wt == null || wt.forEach((ft) => fw(ft)) : T === "x" && I !== "x" && (wt == null || wt.forEach((ft) => mw(ft))), (vt = w.current) == null || vt.applyUpdate([Z, { delete: 1 }]);
    }
  }, zt = (I) => {
    dt(I.contextMarker), U(I.canRedo);
  }, Lt = L(
    (I) => {
      var it, N, st, et, vt;
      const Z = (N = (it = w.current) == null ? void 0 : it.getNoteOps(0)) == null ? void 0 : N.at(0);
      if (Z && Ar("note", Z)) {
        ...
        const wt = (st = Z.insert.note) == null ? void 0 : st.style, ft = (vt = (et = Z.insert.note) == null ? void 0 : et.contents) == null ? void 0 : vt.ops;
        if (wt || z(!1), z(
          wt === "x" ? !!(ft != null && ft.every((Pt) => {
            var yt, Vt;
            if (!((yt = Pt.attributes) != null && yt.char)) return !0;
            const qt = ((Vt = Pt.attributes) == null ? void 0 : Vt.char).style;
            return qt === "xt" || qt === "xo" || qt === "xq";
          })) : !!(ft != null && ft.every((Pt) => {
            var yt, Vt;
            if (!((yt = Pt.attributes) != null && yt.char)) return !0;
            const qt = ((Vt = Pt.attributes) == null ? void 0 : Vt.char).style;
            return qt === "ft" || qt === "fr" || qt === "fq";
          }))
        ), !M.current) {
          M.current = !0, Y.current = JSON.stringify(Z), q(!0);
          return;
        }
        q(JSON.stringify(Z) === Y.current), nt(f, y);
      } else
        z(!1), q(!0);
    },
    [f, y, nt]
    ...
    if (h.current && mt.length && I && I.rangeCount > 0) {
      const Z = I.getRangeAt(0).getBoundingClientRect(), it = h.current.getBoundingClientRect();
      J(Z.left - it.left), pt(Z.top - it.top), H(Z.height), _(!0);
    }
  }, [mt, h]);
  W(() => {
    const I = () => {
    ...
    var I;
    D && ((I = ht.current) == null || I.focus());
  }, [D]), W(() => {
    var it;
    const I = ((it = p.current) == null ? void 0 : it.querySelector(".editor-input")) ?? void 0, Z = (N) => {
      !D && I && document.activeElement === I && N.key === c ? (N.preventDefault(), Jt()) : D && N.key === "Escape" && (N.preventDefault(), _(!1));
    };
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
              ...
              /* @__PURE__ */ a($t, { children: /* @__PURE__ */ a("p", { children: ne }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(at, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(at, { children: bw(t.marker, c, o, d) })
      }
    )
  ] });
}
function kp({
  ...
  const w = l ?? Fs(r, void 0), p = (y, C) => {
    d == null || d(y, C, n);
  }, h = i ? r.findIndex((y) => y === i) : -1, [g, f] = k(h), b = (y, C, $) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), d == null || d(C, $, n);
          break;
      }
  }, m = (y) => {
    if (r.length)
      switch (y.key) {
        case "ArrowDown":
          y.preventDefault(), f((C) => Math.min(C + 1, r.length - 1));
          break;
        case "ArrowUp":
          y.preventDefault(), f((C) => Math.max(C - 1, 0));
          break;
      }
  }, E = K([]);
  return W(() => {
        ...
        "ul",
        {
          ...
          children: r.map((y, C) => {
            ...
            return /* @__PURE__ */ u(at, { children: [
              ...
              C < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(_r, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function _w({
  ...
  return /* @__PURE__ */ u(ro, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(ao, { stickyHeader: !0, children: /* @__PURE__ */ u(Ee, { children: [
    ...
    /* @__PURE__ */ a(oo, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ee,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(or, { className: o, children: kw(c.text) })
        ]
      },
...
const Nw = (t) => {
...
}, da = (t, e, r) => /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
  /* @__PURE__ */ u(
    Ot,
    {
  ...
  return e ? e[1] : "";
}, Ew = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Sp = Object.freeze([
...
function Rp({
  ...
  const g = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), b = le(r, "%webView_inventory_unapproved%"), m = le(r, "%webView_inventory_unknown%"), E = le(r, "%webView_inventory_scope_currentBook%"), y = le(r, "%webView_inventory_scope_chapter%"), C = le(r, "%webView_inventory_scope_verse%"), $ = le(r, "%webView_inventory_filter_text%"), F = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = le(r, "%webView_inventory_no_results%"), [A, P] = k(!1), [z, V] = k("all"), [q, B] = k(""), [U, M] = k([]), Y = O(() => {
    const H = t ?? [];
    return H.length === 0 ? [] : zw(H, n, i);
  }, [t, n, i]), D = O(() => {
    if (A) return Y;
    const H = [];
    return Y.forEach((ot) => {
      const dt = ot.items[0], ht = H.find(
        (gt) => gt.items[0] === dt
      );
      ht ? (ht.count += ot.count, ht.occurrences = ht.occurrences.concat(ot.occurrences)) : H.push({
        items: [dt],
        count: ot.count,
  ...
  }, [A, Y]), _ = O(() => D.length === 0 ? [] : Tw(D, z, q), [D, z, q]), Q = O(() => {
    var dt, ht;
    if (!A) return l;
  ...
  const J = (H, ot) => {
    ot.setRowSelection(() => {
      const ht = {};
      return ht[H.index] = !0, ht;
    });
    const dt = H.original.items;
    M(dt), h && dt.length > 0 && h(dt[0]);
  }, ut = (H) => {
    ...
    const H = D.filter((ot) => Us(
      A ? ot.items : [ot.items[0]],
      U
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(lr, { onValueChange: (H) => ut(H), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(ur, { children: [
          ...
          /* @__PURE__ */ a(ie, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ a(
        na,
      ...
      o && /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
        ...
        /* @__PURE__ */ a($t, { children: (o == null ? void 0 : o.checkboxText) ?? F })
      ] }) })
    ] }),
...
const Sw = "16rem", Rw = "3rem", Ti = Yt.createContext(void 0);
function wa() {
...
function Dw({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    (C) => {
      const $ = typeof C == "function" ? C(w) : C;
      r ? r($) : d($);
    },
    [r, w]
  ), h = Yt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", m = pe() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
    ...
    "--sidebar-width": Sw,
    "--sidebar-width-icon": Rw,
    ...n
  };
  return /* @__PURE__ */ a(Ti.Provider, { value: E, children: /* @__PURE__ */ a(
    "div",
    {
...
function Dp({ className: t, onClick: e, ...r }) {
...
function Vw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = wa(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Pw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    Mw,
    {
      ...
      children: /* @__PURE__ */ u($w, { children: [
        /* @__PURE__ */ u(cn, { children: [
          ...
          /* @__PURE__ */ a(dn, { children: /* @__PURE__ */ a(Iw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Aw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Ne = "scrBook", Bw = "scrRef", Ue = "source", Lw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", zi = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      id: Ne,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Fw,
      cell: (o) => {
        const n = o.row.original;
        return o.row.getIsGrouped() ? Rt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Ne ? ve(n.start) : void 0;
      },
...
}, wn = (t) => `${Gw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qp({
  sources: t,
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Ne, desc: !1 }]), [g, f] = k({}), b = O(
    () => t.flatMap((z) => z.data.map((V) => ({
      ...V,
      source: z.source
    }))),
    [t]
  ...
  W(() => {
    if (c) {
      const z = E.getSelectedRowModel().rowsById, V = Object.keys(z);
      if (V.length === 1) {
        const q = b.find((B) => wn(B) === V[0]) || void 0;
        q && c(q);
      }
    }
  }, [g, b, c, E]);
  const y = n ?? Uw, C = i ?? zi, $ = [
    ...
    !z.getIsGrouped() && !z.getIsSelected() && z.getToggleSelectedHandler()(V);
  }, A = (z, V) => z.getIsGrouped() ? "" : v("banded-row", V % 2 === 0 ? "even" : "odd"), P = (z, V, q) => {
    if (!((z == null ? void 0 : z.length) === 0 || V.depth < q.column.getGroupedIndex())) {
      if (V.getIsGrouped())
        switch (V.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(ur, { position: "item-aligned", children: /* @__PURE__ */ a(Yd, { children: $.map((z) => /* @__PURE__ */ a(ie, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ro, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(ao, { children: E.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ee, { children: z.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(oo, { children: E.getRowModel().rows.map((z, V) => {
        const q = pe();
        return /* @__PURE__ */ a(
          Ee,
          {
            ...
            children: z.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== Ue || !r)))
                return /* @__PURE__ */ a(
                  or,
                  {
                    className: v(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && (q === "ltr" ? /* @__PURE__ */ a(Pa, {}) : /* @__PURE__ */ a(Aa, {})),
                          " ",
                          xr(B.column.columnDef.cell, B.getContext()),
                          " (",
                          z.subRows.length,
                          ")"
                        ]
...
function Hw({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [m, E] = k(!1), [y, C] = k(""), $ = K(void 0), F = K(!1), T = O(
    () => xn(t),
    [t]
  ), A = O(() => {
    if (!y.trim()) {
    ...
    (M, Y = !1) => {
      ...
      const D = T.findIndex((pt) => pt === $.current), _ = T.findIndex((pt) => pt === M);
      if (D === -1 || _ === -1) return;
      const [Q, J] = [
        Math.min(D, _),
        Math.max(D, _)
      ], ut = T.slice(Q, J + 1).map((pt) => pt);
      r(
        e.includes(M) ? e.filter((pt) => !ut.includes(pt)) : [.../* @__PURE__ */ new Set([...e, ...ut])]
      );
    },
    [e, r, T]
  ), z = (M) => {
    P(M, F.current), F.current = !1;
  }, V = (M, Y) => {
    M.preventDefault(), P(Y, M.shiftKey);
  }, q = () => {
    r(T.map((M) => M));
  }, B = () => {
    r([]);
    ...
    () => Object.values(kt).filter(
      (M) => (i == null ? void 0 : i[M]) !== void 0 && no(T, M).length === 0
              ...
              Me,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(G, { variant: "ghost", size: "sm", onClick: B, children: w })
                  ] }),
                  /* @__PURE__ */ u(Oe, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(oa, { children: p }),
                    Object.values(kt).filter((M) => A[M].length > 0).map((M, Y) => {
                      const D = A[M];
                      return /* @__PURE__ */ u(ia, { children: [
                        Y > 0 && /* @__PURE__ */ a(vn, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          xe,
                          {
                            heading: pn(M, h, g, f, b),
                            children: D.map((_) => /* @__PURE__ */ a(
                              Yn,
                              {
                                bookId: _,
...
function Xw({
  ...
  const s = no(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    G,
    {
      ...
      onClick: () => o(t),
      className: v(
        yn(e, t, r) && !s && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: s,
      children: Ji(
        t,
...
function Jw({
  ...
  const s = o["%webView_book_selector_more%"], c = O(
    ...
    (d) => {
      ...
      r(
        yn(c, d, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ra ? Ra : un
      ).map((d) => /* @__PURE__ */ a(kr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ce(d, n) }, d)),
      e.length > Ra && /* @__PURE__ */ a(
        kr,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - un} ${s}`
        }
      )
    ] })
  ] });
...
function Hp({
  ...
  const F = St(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = St(s, "%webView_scope_selector_verse%"), A = St(s, "%webView_scope_selector_chapter%"), P = St(s, "%webView_scope_selector_book%"), z = St(
    s,
    "%webView_scope_selector_current_verse%"
  ), V = St(
    s,
    "%webView_scope_selector_current_chapter%"
  ), q = St(s, "%webView_scope_selector_current_book%"), B = St(s, "%webView_scope_selector_choose_books%"), U = St(s, "%webView_scope_selector_scope%"), M = St(s, "%webView_scope_selector_select_books%"), Y = St(s, "%webView_scope_selector_range%"), D = St(s, "%webView_scope_selector_select_range%"), _ = St(s, "%webView_scope_selector_range_start%"), Q = St(s, "%webView_scope_selector_range_end%"), J = St(s, "%webView_scope_selector_ok%"), ut = St(s, "%webView_scope_selector_cancel%"), pt = St(s, "%webView_scope_selector_navigate%"), At = (S) => {
    if (!b) return;
    ...
    },
    {
      ...
      label: P,
      dropdownLabel: q,
      scrRefSuffix: At("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: B, id: "scope-selected" },
    { value: "range", label: Y, id: "scope-range" }
  ], ot = (S, j, lt = !1) => /* @__PURE__ */ u(at, { children: [
    S,
    j && !lt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      j
    ] })
  ] }), dt = e ? H.filter((S) => e.includes(S.value)) : H, ht = b ?? va, gt = p ?? ht, mt = h ?? ht, nt = () => {
  }, Tt = K(null), ee = K(null), Bt = K(!1), Xt = K(null), Nt = K(!1), [oe, xt] = k(void 0), zt = K(!1), Lt = K(!1), Jt = K(null), ne = L((S) => {
    if (S) {
      xt("start"), zt.current = !1;
      return;
    }
    xt((j) => j === "start" ? void 0 : j), zt.current && (zt.current = !1, requestAnimationFrame(() => {
      var lt;
      const j = (lt = Tt.current) == null ? void 0 : lt.querySelector("button");
      j == null || j.click();
    }));
  }, []), I = L((S) => {
    if (S) {
    ...
    (S) => {
      g == null || g(S), f == null || f(S), zt.current = !0;
    },
    [g, f]
  ), it = L(
    (S) => {
      f == null || f(S), Lt.current = !0;
    },
    [f]
  ), N = L(
    (S) => {
      r(S), S === "selectedBooks" && n.length === 0 && (b != null && b.book) && i([b.book]);
    },
    [r, n, b, i]
  ), st = dt.find((S) => S.value === t), et = () => t === "selectedBooks" && n.length > 0 ? n.map((S) => S.toUpperCase()).join(", ") : t === "range" ? Ks(gt, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : st ? ot(st.label, st.scrRefSuffix) : t, vt = dt.filter(
    (S) => S.value !== "selectedBooks" && S.value !== "range"
  ), wt = dt.find((S) => S.value === "selectedBooks"), ft = dt.find((S) => S.value === "range"), [Pt, qt] = k(!1), [yt, Vt] = k(void 0), [Gt, R] = k(void 0), [Ct, Et] = k(void 0), [Zt, Ve] = k(void 0), [Xe, Rr] = k([]), Dr = w === "dropdown" && yt === "selectedBooks", Mr = /* @__PURE__ */ a(
    Jw,
    {
      availableBookInfo: o,
      selectedBookIds: Dr ? Xe : n,
      onChangeSelectedBookIds: Dr ? Rr : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), hr = oe === "end", gr = oe === "start", je = "tw:text-muted-foreground", _e = w === "dropdown" && yt === "range", ua = _e ? Et : Z, Or = _e ? Ve : f ? it : nt, fr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-start", className: v(hr && je), children: _ }),
      /* @__PURE__ */ a(
        xa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Tt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(_t, { htmlFor: "scope-range-end", className: v(gr && je), children: Q }),
      /* @__PURE__ */ a(
        xa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: E,
          getEndVerse: y,
          disableReferencesUpTo: _e ? Ct ?? gt : gt,
          onOpenChange: I,
          onCloseAutoFocus: (S) => {
            var j;
            Lt.current && (Lt.current = !1, S.preventDefault(), (j = Jt.current) == null || j.focus());
          },
          className: v(gr && je),
          modal: !0,
          align: "start"
  ...
  W(() => {
    ...
    return () => {
      cancelAnimationFrame(j), S && cancelAnimationFrame(S);
    };
  }, [Pt, t]);
  const [Ze, pa] = k(null), [Qe, ha] = k(null), [tr, x] = k(null), X = 200, [tt, Qt] = k(!1);
  W(() => {
    if (!tr || typeof ResizeObserver > "u") return;
    const S = new ResizeObserver(([j]) => {
      Qt(j.contentRect.width < X);
    });
    return S.observe(tr), () => S.disconnect();
  }, [tr]);
  const fe = L(
    (S) => {
      R(S), Et(gt), Ve(mt), Rr(n), qt(!1), Vt(S);
    },
    [gt, mt, n]
  ), Be = L(() => {
    Gt !== void 0 && (Gt === "range" ? (Ct && (g == null || g(Ct)), Zt && (f == null || f(Zt))) : Gt === "selectedBooks" && i(Xe), N(Gt), Vt(void 0), R(void 0));
  }, [
    Gt,
    Ct,
    Zt,
    ...
    S || (Vt(void 0), R(void 0));
  }, []), jt = L((S) => {
    var j;
    S.preventDefault(), (j = $r.current) == null || j.focus();
  }, []), bt = (S) => t === S ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(_t, { children: U }),
      w === "dropdown" ? /* @__PURE__ */ u($e, { open: Pt, onOpenChange: qt, children: [
        ...
        /* @__PURE__ */ a(
          Ae,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ga, { container: tr, children: [
              vt.map(({ value: S, label: j, dropdownLabel: lt, scrRefSuffix: Ht, id: Le }) => /* @__PURE__ */ u(
                Ke,
                {
                  ref: Je(S),
                  className: "tw:relative tw:ps-8 data-[highlighted]:tw:bg-accent data-[highlighted]:tw:text-accent-foreground",
                  onSelect: () => N(S),
                  "data-selected": t === S ? "true" : void 0,
                  children: [
                    t === S && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(ze, { className: "tw:h-4 tw:w-4" }) }),
                    ot(lt ?? j, Ht, tt)
                  ]
                },
                Le
              ...
              m && /* @__PURE__ */ u(at, { children: [
                ...
                /* @__PURE__ */ a(
                  Ke,
                  {
                    ...
                    onSelect: (S) => {
                      var j, lt;
                      if (S.preventDefault(), Bt.current) {
                        Bt.current = !1;
                        return;
                      }
                      Nt.current || (lt = (j = ee.current) == null ? void 0 : j.querySelector("button")) == null || lt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (S) => {
                          const j = S.target instanceof HTMLElement ? S.target : void 0;
                          j != null && j.closest("button") && (Bt.current = !0, requestAnimationFrame(() => {
                            Bt.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          xa,
                          {
                            ...
                            onCloseAutoFocus: (S) => {
                              var j;
                              S.preventDefault(), (j = Xt.current) == null || j.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(at, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: ve(b ?? va, "id") }),
                              /* @__PURE__ */ a(sr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Qa,
        {
          ...
          children: dt.map(({ value: S, label: j, scrRefSuffix: lt, id: Ht }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Wr, { className: "tw:me-2", value: S, id: Ht }),
            /* @__PURE__ */ a(_t, { htmlFor: Ht, children: ot(j, lt) })
          ] }, Ht))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && fr,
    w === "dropdown" && wt && /* @__PURE__ */ a(Da, { open: yt === "selectedBooks", onOpenChange: me, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: ha,
        onCloseAutoFocus: jt,
        onEscapeKeyDown: (S) => {
          Qe != null && Qe.querySelector('[data-state="open"]') && S.preventDefault();
        },
        children: /* @__PURE__ */ u(ga, { container: Qe, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: B }) }),
          Mr,
          /* @__PURE__ */ u(Co, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => me(!1), children: ut }),
            /* @__PURE__ */ a(G, { onClick: Be, children: J })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && ft && /* @__PURE__ */ a(Da, { open: yt === "range", onOpenChange: me, children: /* @__PURE__ */ a(
      Ma,
      {
        ref: pa,
        onCloseAutoFocus: jt,
        onEscapeKeyDown: (S) => {
          Ze != null && Ze.querySelector('[data-state="open"]') && S.preventDefault();
        },
        children: /* @__PURE__ */ u(ga, { container: Ze, children: [
          /* @__PURE__ */ a(Oa, { className: "tw:pe-8", children: /* @__PURE__ */ a($a, { children: D }) }),
          fr,
          /* @__PURE__ */ u(Co, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => me(!1), children: ut }),
            /* @__PURE__ */ a(G, { ref: Jt, onClick: Be, children: J })
          ] })
        ] })
      }
    ) })
...
function Yp({
  ...
  return /* @__PURE__ */ u(
    lr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(wr, { size: n, className: v("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          dr,
          {
        ...
        /* @__PURE__ */ a(
          ur,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((w) => /* @__PURE__ */ a(ie, { value: `${w}`, children: l[Ro(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Ri = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Ot, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ts, { children: /* @__PURE__ */ a(es, { children: Ri(
      t,
      e,
      Si(t, c.id),
      o
...
function Xa({
  ...
  return /* @__PURE__ */ u($e, { variant: i, children: [
    /* @__PURE__ */ a(Ie, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(Ae, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(ia, { children: [
      /* @__PURE__ */ a(fn, { children: /* @__PURE__ */ a(Dt, { children: Ri(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(Ge, {})
    ] }, l)) })
  ] });
}
const Di = Yt.forwardRef(
...
const Mi = Yt.forwardRef(({ className: t, ...e }, r) => {
  const o = pe();
  return /* @__PURE__ */ a(
    ce.Root,
    {
...
const Oi = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.List,
  {
    ref: r,
    className: v(
...
)), $i = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  ce.Content,
  {
    ref: r,
    className: v(
...
$i.displayName = ce.Content.displayName;
function th({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Mi, { children: [
      /* @__PURE__ */ a(Oi, { children: t.map((c) => /* @__PURE__ */ a(tu, { value: c.value, children: c.value }, c.key)) }),
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(su, {}, `separator-${i}`)), l;
  });
};
function wu({
  menuData: t,
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (E = l.current) == null || E.focus(), br(l, [h, g]);
        break;
    }
  }), W(() => {
    ...
    return /* @__PURE__ */ a(eu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(ru, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(Dt, { children: Ii(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ah({
  ...
  const d = uu(
    ...
    var E, y, C, $, F, T;
    const m = b !== f ? ((y = (E = t[f]) == null ? void 0 : E.uiNames) == null ? void 0 : y[b]) ?? (($ = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : $.en) : void 0;
      ...
      lr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: Ye },
              children: Object.keys(t).map((f) => /* @__PURE__ */ a(ie, { value: f, children: g(f, e) }, f))
            }
          )
        ]
      }
...
function nh({
  ...
  return /* @__PURE__ */ u(Me, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(as, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(os, { children: /* @__PURE__ */ a(Qs, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Oe, { children: [
      ...
      /* @__PURE__ */ a(
        $t,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Do(d, {
            ...
            /* @__PURE__ */ a(ia, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
...
function lh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function Ch({
  ...
  return /* @__PURE__ */ u(
    It.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(It.ItemIndicator, { children: /* @__PURE__ */ a(sa, {}) }) }),
        e
      ]
    }
  );
...
function Wh({
  ...
  return /* @__PURE__ */ a(
    ce.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", yu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function rg(t) {
  const e = O(() => qs(t).slice().sort().join(" "), [t]);
...
export {
  ...
  $a as DialogTitle,
  ug as DialogTrigger,
  Ww as DisabledActionTooltip,
  Yw as DisabledTooltipWrapper,
  Rh as Drawer,
  Mh as DrawerClose,
  Oh as DrawerContent,
  ...
  ie as SelectItem,
  wp as SelectLabel,
  Xd as SelectScrollDownButton,
  Wd as SelectScrollUpButton,
  ...
  Dw as SidebarProvider,
  Mp as SidebarRail,
  Ap as SidebarSeparator,
  Dp as SidebarTrigger,
  ar as Skeleton,
  Gh as Slider,
  qh as Sonner,
  yg as Spinner,
