...
import H, { forwardRef as Eo, useCallback as Ne, useState as fe, useRef as _t, useEffect as He, useLayoutEffect as ma, useMemo as Bn } from "react";
...
function kv({
  ...
  return /* @__PURE__ */ V("div", { className: "pr-twp pr-flex pr-h-full pr-flex-col", children: [
...
const Ru = Ye("border", Ue), Pu = Ye("borderTop", Ue), $u = Ye("borderRight", Ue), _u = Ye("borderBottom", Ue), Mu = Ye("borderLeft", Ue), Iu = Ye("borderColor"), Au = Ye("borderTopColor"), Du = Ye("borderRightColor"), Bu = Ye("borderBottomColor"), ju = Ye("borderLeftColor"), Lu = Ye("outline", Ue), Vu = Ye("outlineColor"), Sr = (e) => {
...
function Wf(e) {
  const {
    ...
    open: f,
    rootRef: v
  } = e, g = T.useRef({}), p = T.useRef(null), h = T.useRef(null), u = We(h, v), [b, x] = T.useState(!f), S = Hf(c);
  let w = !0;
...
var Me = "top", Xe = "bottom", qe = "right", Ie = "left", Uo = "auto", Un = [Me, Xe, qe, Ie], Qt = "start", An = "end", Xf = "clippingParents", Ns = "viewport", mn = "popper", qf = "reference", Qa = /* @__PURE__ */ Un.reduce(function(e, t) {
...
function tn(e, t, n) {
  ...
  t && Ge(e) && (o = e.offsetWidth > 0 && en(r.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && en(r.height) / e.offsetHeight || 1);
...
function dm(e) {
  ...
  if (!(!a || !i)) {
    var v = um(o.padding, n), g = Go(a), p = c === "y" ? Me : Ie, h = c === "y" ? Xe : qe, u = n.rects.reference[f] + n.rects.reference[c] - i[c] - n.rects.popper[f], b = i[c] - n.rects.reference[c], x = Hn(a), S = x ? c === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, w = u / 2 - b / 2, E = v[p], y = S - g[f] - v[h], N = S / 2 - g[f] / 2 + w, C = On(E, N, y), M = c;
...
function ti(e) {
  ...
  if (d) {
    ...
    if (N === Fe(n) && (N = kt(n), pt(N).position !== "static" && l === "absolute" && (C = "scrollHeight", M = "scrollWidth")), N = N, o === Me || (o === Ie || o === qe) && a === An) {
      E = Xe;
...
function Om(e) {
  var t = Cn(Mr(e)), n = ["absolute", "fixed"].indexOf(pt(e).position) >= 0, r = n && Ge(e) ? Hn(e) : e;
...
function Dn(e, t) {
  ...
  if (g === mn && k) {
    ...
    Object.keys(j).forEach(function($) {
      var F = [qe, Xe].indexOf($) >= 0 ? 1 : -1, U = [Me, Xe].indexOf($) >= 0 ? "y" : "x";
      j[$] += R[U] * F;
    });
  }
  return j;
...
function Pm(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, f = n.boundary, v = n.rootBoundary, g = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, u = n.allowedAutoPlacements, b = t.options.placement, x = Ze(b), S = x === b, w = c || (S || !h ? [rr(b)] : Rm(b)), E = [b].concat(w).reduce(function(W, q) {
      ...
      var k = E[j], R = Ze(k), $ = nn(k) === Qt, F = [Me, Xe].indexOf(R) >= 0, U = F ? "width" : "height", _ = Dn(t, {
        placement: k,
        boundary: f,
        rootBoundary: v,
        altBoundary: g,
...
function Vm(e) {
  ...
  if (N) {
    if (a) {
      var $, F = E === "y" ? Me : Ie, U = E === "y" ? Xe : qe, _ = E === "y" ? "height" : "width", z = N[E], Q = z + b[F], Z = z - b[U], O = p ? -M[_] / 2 : 0, A = S === Qt ? C[_] : M[_], G = S === Qt ? -M[_] : -C[_], X = t.elements.arrow, W = p && X ? Go(X) : {
        width: 0,
        height: 0
    ...
    if (l) {
      var Pe, xe = E === "x" ? Me : Ie, Tt = E === "x" ? Xe : qe, $e = N[y], rt = y === "y" ? "height" : "width", Be = $e + b[xe], ot = $e - b[Tt], Te = [Me, Ie].indexOf(x) !== -1, Lt = (Pe = k == null ? void 0 : k[y]) != null ? Pe : 0, Nt = Te ? Be : $e - C[rt] - M[rt] - Lt + j.altAxis, an = Te ? $e + C[rt] + M[rt] - Lt - j.altAxis : ot, Wn = p && Te ? pm(Nt, $e, an) : On(p ? Nt : Be, $e, p ? an : ot);
      N[y] = Wn, R[y] = Wn - $e;
    }
    t.modifiersData[r] = R;
  }
...
function Gm(e, t, n) {
  n === void 0 && (n = !1);
  var r = Ge(t), o = Ge(t) && Hm(t), a = kt(t), i = tn(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Yo(a)) && (l = Um(t)), Ge(t) ? (c = tn(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = qo(a))), {
...
const oh = () => dt({
  ...
  } = t, b = he(t, eh), x = T.useRef(null), S = We(x, n), w = T.useRef(null), E = We(w, g), y = T.useRef(E);
  At(() => {
    y.current = E;
...
const uh = {
  ...
  } = t, x = he(t, ph), S = yn(), w = T.useRef(), E = Gn(), y = T.useRef(null), N = We(y, a.ref, n), C = (U) => (_) => {
    if (U) {
      const z = y.current;
      _ === void 0 ? U(z) : U(z, _);
    }
...
const Dh = Xs, Bh = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], jh = {
  ...
  } = t, w = he(t, Bh), E = T.useRef(null), y = We(E, l.ref, n), N = (F) => (U) => {
    if (F) {
      const _ = E.current;
      U === void 0 ? F(_) : F(_, U);
    }
...
const ig = (e) => {
  ...
  } = i, j = he(i.TransitionProps, rg), k = he(i, og), R = (r = E == null ? void 0 : E.paper) != null ? r : S, $ = T.useRef(), F = We($, R.ref), U = P({}, i, {
    anchorOrigin: d,
    anchorReference: v,
    elevation: u,
    marginThreshold: b,
