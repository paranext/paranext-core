import Ri, { jsx as i, jsxs as x, Fragment as st } from "react/jsx-runtime";
import * as M from "react";
import I, { forwardRef as Jn, useCallback as Me, useState as ue, useRef as gt, useEffect as at, useLayoutEffect as Ho, useMemo as _e } from "react";
import { History as Pi, ChevronRight as Fa, Check as Zn, Circle as Ua, ArrowDownWideNarrow as _i, Clock as $i, Bookmark as Ii, X as Ai, Search as Di, ChevronsUpDown as Mi, FilterIcon as Bi, ChevronDown as Qn, ChevronUp as ji, ArrowLeftIcon as Vi, ChevronLeftIcon as Li, ChevronRightIcon as zi, ArrowRightIcon as Fi, CircleCheckIcon as Ui, CircleXIcon as Gi, CircleHelpIcon as Hi, ArrowUpIcon as Xi, ArrowDownIcon as Yi, ArrowUpDownIcon as Wi, ChevronLeft as qi, LoaderCircle as Ki, Download as Ji, Filter as Zi, User as Qi, Link as el, CircleHelp as tl } from "lucide-react";
...
const ao = we.Root, as = we.Trigger, zl = we.Group, ym = we.Portal, xm = we.Sub, Nm = we.RadioGroup, Fl = I.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ x(
  we.SubTrigger,
  {
    ref: o,
    className: T(
...
const so = I.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ x(
  we.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(we.ItemIndicator, { children: /* @__PURE__ */ i(Zn, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
so.displayName = we.CheckboxItem.displayName;
const is = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  we.RadioItem,
  {
    ref: r,
    className: T(
...
const kn = I.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ i(
  we.Label,
  {
    ref: r,
...
kn.displayName = we.Label.displayName;
...
function Yl({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
  return /* @__PURE__ */ x(kn, { className: "tw-flex tw-justify-between", children: [
...
function km({ scrRef: e, handleSubmit: t }) {
  const [n, r] = ue(""), [o, a] = ue(
    ...
    if (c === o) {
      ...
      s + D <= 0 || s + D > Zt(c) ? l(0) : D !== 0 && (l(s + D), N.preventDefault());
    }
  };
  return at(() => {
  ...
  }, [w]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ x(ao, { modal: !1, open: p, onOpenChange: k, children: [
        ...
        children: [
          ...
          Wo.map(
            (N, B) => E(N).length > 0 && /* @__PURE__ */ x("div", { children: [
              /* @__PURE__ */ i(kn, { className: "tw-font-semibold tw-text-foreground/80", children: Wl[N] }),
...
const sc = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(ac, { children: [
  /* @__PURE__ */ i(ds, {}),
  /* @__PURE__ */ x(
    Ye.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ x(Ye.Close, { className: "tw-absolute tw-right-4 tw-top-4 tw-rounded-sm tw-opacity-70 tw-ring-offset-background tw-transition-opacity hover:tw-opacity-100 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2 disabled:tw-pointer-events-none data-[state=open]:tw-bg-accent data-[state=open]:tw-text-muted-foreground", children: [
          /* @__PURE__ */ i(Ai, { className: "tw-h-4 tw-w-4" }),
...
const us = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ x("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", children: [
...
function qo({
  ...
  return /* @__PURE__ */ x(rc, { open: b, onOpenChange: v, ...w, children: [
    /* @__PURE__ */ i(oc, { asChild: !0, children: /* @__PURE__ */ x(
      be,
      {
        variant: d,
        role: "combobox",
    ...
    /* @__PURE__ */ i(cs, { className: "tw-w-[200px] tw-p-0", dir: p, children: /* @__PURE__ */ x(ps, { children: [
      /* @__PURE__ */ i(us, { dir: p, placeholder: l, className: "tw-text-inherit" }),
      /* @__PURE__ */ i(fs, { children: c }),
      /* @__PURE__ */ i(ws, { children: t.map((f) => /* @__PURE__ */ x(
        ms,
        {
          value: a(f),
          onSelect: () => {
    ...
    ls,
    {
      ...
      children: /* @__PURE__ */ x("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ x("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ i(He, { className: "tw-flex tw-items-center", children: r.map((h) => oe.bookIdToEnglishName(h)).join(", ") }),
          /* @__PURE__ */ i(
            be,
            {
...
function fc({ table: e }) {
  return /* @__PURE__ */ x(ao, { children: [
    /* @__PURE__ */ i(ol, { asChild: !0, children: /* @__PURE__ */ x(be, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ i(Bi, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ x(tr, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ i(kn, { children: "Toggle columns" }),
      /* @__PURE__ */ i(nr, {}),
...
const fn = ge.Root, mc = ge.Group, mn = ge.Value, Mt = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Trigger,
  {
    ref: r,
    className: T(
    ...
    children: [
      t,
      /* @__PURE__ */ i(ge.Icon, { asChild: !0, children: /* @__PURE__ */ i(Qn, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
    ]
  }
));
...
const Bt = I.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ i(ge.Portal, { children: /* @__PURE__ */ x(
  ge.Content,
  {
    ref: o,
    className: T(
...
const hc = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  ge.Label,
  {
    ref: n,
...
hc.displayName = ge.Label.displayName;
const Ue = I.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ x(
  ge.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ i("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ i(ge.ItemIndicator, { children: /* @__PURE__ */ i(Zn, { className: "tw-h-4 tw-w-4" }) }) }),
...
gc.displayName = ge.Separator.displayName;
function bc({ table: e }) {
...
const vc = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  "tfoot",
  {
    ref: n,
...
function xc({
  ...
  var h;
  const [l, c] = ue([]), [d, p] = ue([]), [m, w] = ue({}), [b, v] = ue({}), f = Ha({
    data: t,
    columns: e,
    getCoreRowModel: Xa(),
...
}, Tc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", bs = xn(
...
), Cc = I.forwardRef(({ className: e, variant: t, size: n, ...r }, o) => /* @__PURE__ */ i(
  Wa.Root,
  {
    ref: o,
...
Cc.displayName = Wa.Root.displayName;
...
const zn = I.forwardRef(({ className: e, children: t, variant: n, size: r, ...o }, a) => {
...
zn.displayName = er.Item.displayName;
const sr = (e) => e === "asc" ? /* @__PURE__ */ i(Xi, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ i(Yi, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Wi, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Cm = (e) => ({
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ x(ys, { value: s, variant: "outline", type: "single", children: [
      /* @__PURE__ */ i(
        zn,
        {
          onClick: () => Or(
  ...
  return kc(e).forEach((p) => {
    p.startsWith("\\id") && (s = Ec(p), l = 0, c = 0), p.startsWith("\\c") && (l = Ko(p), c = 0), p.startsWith("\\v") && (c = Ko(p), l === 0 && (l = t.chapterNum));
...
function Pm({
  ...
  const m = Je(n, "%webView_inventory_all%"), w = Je(n, "%webView_inventory_approved%"), b = Je(n, "%webView_inventory_unapproved%"), v = Je(n, "%webView_inventory_unknown%"), f = Je(n, "%webView_inventory_scope_currentBook%"), h = Je(n, "%webView_inventory_scope_chapter%"), E = Je(n, "%webView_inventory_scope_verse%"), A = Je(n, "%webView_inventory_filter_text%"), O = Je(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, g] = ue(!1), [_, L] = ue("all"), [H, C] = ue(""), [P, N] = ue([]), B = _e(() => l ? r instanceof RegExp ? Rc(
    l,
    e,
    a,
    s,
    ...
    /* @__PURE__ */ x("div", { className: "tw-flex tw-items-stretch", children: [
        ...
        fn,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ x(Bt, { children: [
              /* @__PURE__ */ i(Ue, { value: "all", children: m }),
      ...
      /* @__PURE__ */ x(fn, { onValueChange: (y) => ee(y), defaultValue: c, children: [
        ...
        /* @__PURE__ */ x(Bt, { children: [
          ...
          /* @__PURE__ */ i(Ue, { value: "chapter", children: h }),
...
function Pc({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = ue(""), a = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ i(
...
const _c = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i(
  Oe.Trigger,
  {
    ref: n,
    ...t,
...
function _m({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(xs, { dir: a, children: [
      /* @__PURE__ */ i(Ns, { children: e.map((s) => /* @__PURE__ */ i(_c, { value: s.value, children: s.value }, s.key)) }),
      e.map((s) => /* @__PURE__ */ i(ks, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const nt = "scrBook", $c = "scrRef", wt = "source", Ic = "details", Ac = "Scripture Reference", Dc = "Scripture Book", Es = "Type", Mc = "Details";
function Bc(e, t) {
  const n = t ?? !1;
  return [
    {
    ...
    !t && /* @__PURE__ */ x(
      fn,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Bt, { position: "item-aligned", children: /* @__PURE__ */ i(mc, { children: k.map((C) => /* @__PURE__ */ i(Ue, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
...
function Fc() {
  ...
  return se.AsyncMode = c, se.ConcurrentMode = d, se.ContextConsumer = l, se.ContextProvider = s, se.Element = t, se.ForwardRef = p, se.Fragment = r, se.Lazy = v, se.Memo = b, se.Portal = n, se.Profiler = a, se.StrictMode = o, se.Suspense = m, se.isAsyncMode = function(g) {
    return k(g) || O(g) === c;
    ...
    return typeof g == "string" || typeof g == "function" || g === r || g === d || g === a || g === o || g === m || g === w || typeof g == "object" && g !== null && (g.$$typeof === v || g.$$typeof === b || g.$$typeof === s || g.$$typeof === l || g.$$typeof === p || g.$$typeof === h || g.$$typeof === E || g.$$typeof === A || g.$$typeof === f);
  }, se.typeOf = O, se;
}
var ie = {};
/** @license React v16.13.1
...
function Uc() {
  return Qo || (Qo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function O($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === m || $ === w || typeof $ == "object" && $ !== null && ($.$$typeof === v || $.$$typeof === b || $.$$typeof === s || $.$$typeof === l || $.$$typeof === p || $.$$typeof === h || $.$$typeof === E || $.$$typeof === A || $.$$typeof === f);
    }
    function k($) {
    ...
    var g = c, _ = d, L = l, H = s, C = t, P = p, N = r, B = v, D = b, J = n, q = a, U = o, ee = m, ae = !1;
    function re($) {
...
var ea;
function Os() {
  return ea || (ea = 1, process.env.NODE_ENV === "production" ? Mn.exports = Fc() : Mn.exports = Uc()), Mn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Xc() {
  if (aa)
    return Dr;
  aa = 1;
  var e = Os(), t = Gc(), n = po(), r = Rs(), o = Hc(), a = function() {
  };
...
function Ps(e, t, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Jc(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${s}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const _s = co(u.element, Ps);
_s.isRequired = co(u.element.isRequired, Ps);
const $s = _s, Zc = "exact-prop: ​";
function Qc(e) {
...
function ed() {
  ...
  return le.ContextConsumer = s, le.ContextProvider = a, le.Element = e, le.ForwardRef = c, le.Fragment = n, le.Lazy = w, le.Memo = m, le.Portal = t, le.Profiler = o, le.StrictMode = r, le.Suspense = d, le.SuspenseList = p, le.isAsyncMode = function() {
    return !1;
    ...
    return typeof h == "string" || typeof h == "function" || h === n || h === o || h === r || h === d || h === p || h === b || typeof h == "object" && h !== null && (h.$$typeof === w || h.$$typeof === m || h.$$typeof === a || h.$$typeof === s || h.$$typeof === c || h.$$typeof === v || h.getModuleId !== void 0);
  }, le.typeOf = f, le;
}
var ce = {};
/**
...
function td() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function k(j) {
      return !!(typeof j == "string" || typeof j == "function" || j === n || j === o || A || j === r || j === d || j === p || E || j === b || v || f || h || typeof j == "object" && j !== null && (j.$$typeof === w || j.$$typeof === m || j.$$typeof === a || j.$$typeof === s || j.$$typeof === c || // This needs to include all possible module reference object
    ...
    var _ = s, L = a, H = e, C = c, P = n, N = w, B = m, D = t, J = o, q = r, U = d, ee = p, ae = !1, re = !1;
    function y(j) {
...
const ad = u.oneOfType([u.func, u.object]), As = ad;
function We(e) {
  if (typeof e != "string")
...
function Pd(e) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = e, o = Ne(e, Od), a = Rd(t), s = Object.keys(a);
  function l(w) {
...
const _d = {
  borderRadius: 4
}, $d = _d, Id = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, it = Id;
function cn(e, t) {
  return t ? Ze(e, t, {
    clone: !1
...
function ve(e) {
  const {
    ...
    return Qe(s, l, (m) => {
      let w = Yn(d, o, m);
      return m === w && typeof m == "string" && (w = Yn(d, o, `${t}${m === "default" ? "" : We(m)}`, m)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
function zd(e, t) {
  return (n) => e.reduce((r, o) => (r[o] = Cn(t, n), r), {});
}
function Fd(e, t, n, r) {
  if (t.indexOf(n) === -1)
    return null;
  const o = Vd(n), a = zd(o, r), s = e[n];
  return Qe(e, s, a);
}
function Us(e, t) {
  const n = Fs(e.theme);
...
he.filterProps = pr;
process.env.NODE_ENV !== "production" && Ld.reduce((e, t) => (e[t] = it, e), {});
function Ud(e = 8) {
  if (e.mui)
    return e;
  const t = Fs({
...
ur(fr, mr, hr, np, rp, op, ap, sp, ip, lp, cp, dp);
function Dt(e, t) {
  return t === "grey" ? t : e;
}
const pp = ve({
...
function kp() {
  function e(n, r, o, a) {
    ...
    return m ? m(s) : Qe(s, r, (v) => {
      let f = Yn(w, p, v);
      return v === f && typeof v == "string" && (f = Yn(w, p, `${n}${v === "default" ? "" : We(v)}`, v)), c === !1 ? f : {
        [c]: f
      };
    });
  }
...
function go(e = {}, ...t) {
  ...
  return d.applyStyles = Ep, d = t.reduce((p, m) => Ze(p, m), d), d.unstable_sxConfig = R({}, mo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(m) {
    return ho({
      sx: m,
      theme: this
    });
...
function Dp(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    let E = Fn;
    d === "Root" || d === "root" ? E = r : d ? E = o : $p(s) && (E = void 0);
    const A = fl(s, R({
      shouldForwardProp: E,
      label: h
    }, b)), O = (g) => typeof g == "function" && g.__emotion_real !== g || ht(g) ? (_) => Un(g, R({}, _, {
      theme: Bn({
        theme: _.theme,
        defaultTheme: n,
        themeId: t
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${We(d || "")}`), N === void 0 && (N = `Styled(${od(s)})`), P.displayName = N;
      }
...
function au(e) {
  const {
    ...
    tonalOffset: r = 0.2
  } = e, o = Ne(e, Zp), a = e.primary || Qp(t), s = e.secondary || eu(t), l = e.error || tu(t), c = e.info || nu(t), d = e.success || ru(t), p = e.warning || ou(t);
  function m(f) {
...
function Nu(e = {}, ...t) {
  ...
  if (d = Ze(d, s), d = t.reduce((p, m) => Ze(p, m), d), process.env.NODE_ENV !== "production") {
...
const Eu = (e) => Fn(e) && e !== "classes", Tu = Dp({
  themeId: yo,
  defaultTheme: vo,
...
var qs = lo.default = void 0, Du = Au(Iu()), Mu = Ri;
qs = lo.default = (0, Du.default)(/* @__PURE__ */ (0, Mu.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Bu(e) {
...
function Uu(e) {
  ...
  const s = zu(R({}, o, r)), l = Sa(r), c = Sa(o), d = t(s), p = bt(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), m = R({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = R({}, d, n, c, l);
...
const Wn = /* @__PURE__ */ M.forwardRef(function(t, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
...
process.env.NODE_ENV !== "production" && (Wn["propTypes"] = Qc(Wn.propTypes));
var Te = "top", je = "bottom", Ve = "right", Ce = "left", ko = "auto", On = [Te, je, Ve, Ce], zt = "start", vn = "end", Ku = "clippingParents", Zs = "viewport", en = "popper", Ju = "reference", Oa = /* @__PURE__ */ On.reduce(function(e, t) {
  return e.concat([t + "-" + zt, t + "-" + vn]);
}, []), Qs = /* @__PURE__ */ [].concat(On, [ko]).reduce(function(e, t) {
  return e.concat([t, t + "-" + zt, t + "-" + vn]);
}, []), Zu = "beforeRead", Qu = "read", ew = "afterRead", tw = "beforeMain", nw = "main", rw = "afterMain", ow = "beforeWrite", aw = "write", sw = "afterWrite", iw = [Zu, Qu, ew, tw, nw, rw, ow, aw, sw];
function qe(e) {
...
var vt = Math.max, qn = Math.min, Ft = Math.round;
function qr() {
...
function Ut(e, t, n) {
  ...
  var s = kt(e) ? Ie(e) : window, l = s.visualViewport, c = !ei() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, m = r.width / o, w = r.height / a;
  return {
    width: m,
    height: w,
    top: p,
...
var fw = function(t, n) {
  ...
  })) : t, ri(typeof t != "number" ? t : oi(t, On));
};
function mw(e) {
  ...
  if (!(!a || !s)) {
    var m = fw(o.padding, n), w = To(a), b = c === "y" ? Te : Ce, v = c === "y" ? je : Ve, f = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], h = s[c] - n.rects.reference[c], E = Rn(a), A = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, O = f / 2 - h / 2, k = m[b], g = A - w[p] - m[v], _ = A / 2 - w[p] / 2 + O, L = dn(k, _, g), H = c;
...
function Pa(e) {
  var t, n = e.popper, r = e.popperRect, o = e.placement, a = e.variation, s = e.offsets, l = e.position, c = e.gpuAcceleration, d = e.adaptive, p = e.roundOffsets, m = e.isFixed, w = s.x, b = w === void 0 ? 0 : w, v = s.y, f = v === void 0 ? 0 : v, h = typeof p == "function" ? p({
    x: b,
    y: f
  }) : {
    x: b,
  ...
  if (d) {
    var _ = Rn(n), L = "clientHeight", H = "clientWidth";
...
function pn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = ai(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), a = Ie(r), s = o ? [a].concat(a.visualViewport || [], Ro(r) ? r : []) : r, l = t.concat(s);
  return o ? l : (
...
function $a(e, t, n) {
  return t === Zs ? Kr(Cw(e, n)) : kt(t) ? Ow(t, n) : Kr(Sw(lt(e)));
}
function Rw(e) {
  var t = pn(br(e)), n = ["absolute", "fixed"].indexOf(et(e).position) >= 0, r = n && Be(e) ? Rn(e) : e;
  return kt(r) ? t.filter(function(o) {
    return kt(o) && ti(o, r) && qe(o) !== "body";
  }) : [];
}
function Pw(e, t, n, r) {
  var o = t === "clippingParents" ? Rw(e) : [].concat(t), a = [].concat(o, [n]), s = a[0], l = a.reduce(function(c, d) {
    var p = $a(e, d, r);
    return c.top = vt(p.top, c.top), c.right = qn(p.right, c.right), c.bottom = qn(p.bottom, c.bottom), c.left = vt(p.left, c.left), c;
  }, $a(e, s, r));
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, a = n.strategy, s = a === void 0 ? e.strategy : a, l = n.boundary, c = l === void 0 ? Ku : l, d = n.rootBoundary, p = d === void 0 ? Zs : d, m = n.elementContext, w = m === void 0 ? en : m, b = n.altBoundary, v = b === void 0 ? !1 : b, f = n.padding, h = f === void 0 ? 0 : f, E = ri(typeof h != "number" ? h : oi(h, On)), A = w === en ? Ju : en, O = e.rects.popper, k = e.elements[v ? A : w], g = Pw(kt(k) ? k : k.contextElement || lt(e.elements.popper), c, p, s), _ = Ut(e.elements.reference), L = si({
    reference: _,
    element: O,
    strategy: "absolute",
    placement: o
...
function _w(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Qs : c, p = Gt(r), m = p ? l ? Oa : Oa.filter(function(v) {
    return Gt(v) === p;
  }) : On, w = m.filter(function(v) {
...
function Iw(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, m = n.rootBoundary, w = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, f = n.allowedAutoPlacements, h = t.options.placement, E = Xe(h), A = E === h, O = c || (A || !v ? [Gn(h)] : $w(h)), k = [h].concat(O).reduce(function(V, W) {
...
function Dw(e) {
  var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper, a = t.modifiersData.preventOverflow, s = yn(t, {
    ...
    altBoundary: !0
  }), c = Ia(s, r), d = Ia(l, o, a), p = Aa(c), m = Aa(d);
  t.modifiersData[n] = {
...
function jw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = Qs.reduce(function(p, m) {
...
function Uw(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, m = n.padding, w = n.tether, b = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, h = yn(t, {
    boundary: c,
    rootBoundary: d,
    padding: m,
    altBoundary: p
  ...
  if (_) {
    if (a) {
      var D, J = k === "y" ? Te : Ce, q = k === "y" ? je : Ve, U = k === "y" ? "height" : "width", ee = _[k], ae = ee + h[J], re = ee - h[q], y = b ? -H[U] / 2 : 0, S = A === zt ? L[U] : H[U], z = A === zt ? -H[U] : -L[U], F = t.elements.arrow, V = b && F ? To(F) : {
        width: 0,
        height: 0
      }, W = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ni(), X = W[J], Y = W[q], G = dn(0, L[U], V[U]), K = O ? L[U] / 2 - y - G - X - P.mainAxis : S - G - X - P.mainAxis, Z = O ? -L[U] / 2 + y + G + Y + P.mainAxis : z + G + Y + P.mainAxis, de = t.elements.arrow && Rn(t.elements.arrow), $ = de ? k === "y" ? de.clientTop || 0 : de.clientLeft || 0 : 0, xe = (D = N == null ? void 0 : N[k]) != null ? D : 0, j = ee + K - xe - $, ye = ee + Z - xe, ze = dn(b ? qn(ae, j) : ae, ee, b ? vt(re, ye) : re);
      _[k] = ze, B[k] = ze - ee;
    }
    if (l) {
      var ct, ke = k === "x" ? Te : Ce, _n = k === "x" ? je : Ve, Fe = _[g], Et = g === "y" ? "height" : "width", dt = Fe + h[ke], Tt = Fe - h[_n], Ct = [Te, Ce].indexOf(E) !== -1, St = (ct = N == null ? void 0 : N[g]) != null ? ct : 0, pt = Ct ? dt : Fe - L[Et] - H[Et] - St + P.altAxis, Xt = Ct ? Fe + L[Et] + H[Et] - St - P.altAxis : Tt, $n = b && Ct ? ww(pt, Fe, Xt) : dn(b ? pt : dt, Fe, b ? Xt : Tt);
      _[g] = $n, B[g] = $n - Fe;
    }
    t.modifiersData[r] = B;
  }
...
function Ww(e, t, n) {
  n === void 0 && (n = !1);
  var r = Be(t), o = Be(t) && Yw(t), a = lt(t), s = Ut(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (Ma(A, O)) {
            p.rects = {
              reference: Ww(A, Rn(O), p.options.strategy === "fixed"),
              popper: To(O)
...
const lf = () => uo({
  ...
  const _ = af(p, s), [L, H] = M.useState(_), [C, P] = M.useState(Kn(o));
  M.useEffect(() => {
...
`));
  ...
  if (a)
    ...
    const P = Kn(r);
    L = P && vr(P) ? Hn(P).body : Hn(null).body;
  }
...
var wf = function(t) {
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Dn.findDOMNode(this), l], d = c[0], p = c[1], m = this.getTimeouts(), w = l ? m.appear : m.enter;
    if (!o && !s || Ba.disabled) {
      this.safeSetState({
        status: At
      }, function() {
    ...
    var o = this, a = this.props.exit, s = this.getTimeouts(), l = this.props.nodeRef ? void 0 : Dn.findDOMNode(this);
    if (!a || Ba.disabled) {
      this.safeSetState({
        status: ft
      }, function() {
    ...
    var s = this.props.nodeRef ? this.props.nodeRef.current : Dn.findDOMNode(this), l = o == null && !this.props.addEndListener;
    if (!s || l) {
...
const gf = {
  ...
  } = t, E = Ne(t, hf), A = rn(), O = M.useRef(), k = ci(), g = M.useRef(null), _ = xt(g, a.ref, n), L = (q) => (U) => {
    if (q) {
      const ee = g.current;
...
Po.muiSupportAuto = !0;
const Va = Po, bf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], vf = Sn(li, {
  name: "MuiPopper",
  slot: "Root",
...
const xf = zs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), rt = xf, Nf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function kf(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Ef = (e) => {
...
const wi = /* @__PURE__ */ M.forwardRef(function(t, n) {
  var r, o, a, s, l, c, d, p, m, w, b, v, f, h, E, A, O, k, g;
  const _ = xo({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: xe
  } = _, j = Ne(_, Nf), ye = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ i("span", {
    children: H
  }), ze = ci(), ct = ze.direction === "rtl", [ke, _n] = M.useState(), [Fe, Et] = M.useState(null), dt = M.useRef(!1), Tt = J || re, Ct = rn(), St = rn(), pt = rn(), Xt = rn(), [$n, _o] = Ms({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const $o = (Q) => {
    ...
    dt.current && Q.type !== "touchstart" || (ke && ke.removeAttribute("title"), St.clear(), pt.clear(), U || Vn && ee ? St.start(Vn ? ee : U, () => {
      $o(Q);
    }) : $o(Q));
  }, Io = (Q) => {
    St.clear(), pt.start(S, () => {
    ...
    gi(Q), Ao.current === !1 && (Do(!1), Io(Q));
  }, Bo = (Q) => {
    ke || _n(Q.currentTarget), bi(Q), Ao.current === !0 && (Do(!0), xr(Q));
  }, jo = (Q) => {
    dt.current = !0;
    const Re = ye.props;
    Re.onTouchStart && Re.onTouchStart(Q);
  }, Vo = xr, Lo = Io, yi = (Q) => {
    jo(Q), pt.clear(), Ct.clear(), In(), Yt.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Xt.start(ae, () => {
      document.body.style.WebkitUserSelect = Yt.current, xr(Q);
    });
  }, xi = (Q) => {
    ye.props.onTouchEnd && ye.props.onTouchEnd(Q), In(), pt.start(z, () => {
      An(Q);
    });
  };
  M.useEffect(() => {
...
`));
  ...
  const qt = {};
  q || (Ae.onTouchStart = yi, Ae.onTouchEnd = xi), D || (Ae.onMouseOver = Ln(Vo, Ae.onMouseOver), Ae.onMouseLeave = Ln(Lo, Ae.onMouseLeave), Tt || (qt.onMouseOver = Vo, qt.onMouseLeave = Lo)), B || (Ae.onFocus = Ln(Bo, Ae.onFocus), Ae.onBlur = Ln(Mo, Ae.onBlur), Tt || (qt.onFocus = Bo, qt.onBlur = Mo)), process.env.NODE_ENV !== "production" && ye.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ye.props.title}\` or the Tooltip component.`].join(`
`));
  const Ei = M.useMemo(() => {
    var Q;
    let Re = [{
    ...
    touch: dt.current
  }), Er = Ef(Kt), zo = (r = (o = Z.popper) != null ? o : C.Popper) != null ? r : Tf, Fo = (a = (s = (l = Z.transition) != null ? l : C.Transition) != null ? s : $) != null ? a : Va, Uo = (c = (d = Z.tooltip) != null ? d : C.Tooltip) != null ? c : Cf, Go = (p = (m = Z.arrow) != null ? m : C.Arrow) != null ? p : Sf, Ti = on(zo, R({}, G, (w = K.popper) != null ? w : P.popper, {
    className: bt(Er.popper, G == null ? void 0 : G.className, (b = (v = K.popper) != null ? v : P.popper) == null ? void 0 : b.className)
  }), Kt), Ci = on(Fo, R({}, xe, (f = K.transition) != null ? f : P.transition), Kt), Si = on(Uo, R({}, (h = K.tooltip) != null ? h : P.tooltip, {
  ...
  const {
    ...
    gl,
    {
      ...
      children: n ? /* @__PURE__ */ x(st, { children: [
        ...
        m ? /* @__PURE__ */ i(Ka, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(qs, {}) }) : za(s, n, !1)
      ] }) : h
    }
  );
  return r ? /* @__PURE__ */ i(Of, { title: r, placement: "right", children: /* @__PURE__ */ i("div", { children: E }) }) : E;
}
function mi(e) {
...
function hi(e) {
  const { menuDefinition: t, onClick: n, commandHandler: r, includedGroups: o } = e, { items: a, allowForLeadingIcons: s } = _e(() => {
    const p = o && o.length > 0 ? o : (
      ...
      mi(t).filter((v) => !("menuItem" in v.group))
  ...
  }, [o, t]), l = ({ item: p, isLastItemInGroup: m }) => ({
...
const Pn = Jn(({ className: e, ...t }, n) => /* @__PURE__ */ i(Ki, { size: 35, className: T("tw-animate-spin", e), ...t, ref: n }));
...
function Lm({
  ...
  const a = gt(void 0);
  return /* @__PURE__ */ i("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ i(Nl, { position: "static", id: r, children: /* @__PURE__ */ x(
    kl,
    {
...
), jf = I.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: T(Bf({ variant: t }), e), ...n }));
...
const Lf = I.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ i("div", { ref: n, className: T("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Lf.displayName = "AlertDescription";
const zf = xn(
  "pr-twp tw-inline-flex tw-items-center tw-rounded-full tw-border tw-px-2.5 tw-py-0.5 tw-text-xs tw-font-semibold tw-transition-colors focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-ring focus:tw-ring-offset-2",
  {
    variants: {
      variant: {
...
function zm({ className: e, variant: t, ...n }) {
  return /* @__PURE__ */ i("div", { className: T(zf({ variant: t }), e), ...n });
}
...
function Gm({
  ...
  return /* @__PURE__ */ i(
    be,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ i(Pn, { size: 15 }) : /* @__PURE__ */ x(st, { children: [
...
function qm({ id: e, groups: t }) {
  return /* @__PURE__ */ i("div", { id: e, children: /* @__PURE__ */ x(ao, { children: [
    ...
    /* @__PURE__ */ i(tr, { children: t.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ i(kn, { children: n.label }),
