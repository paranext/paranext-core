    ...
    return /* @__PURE__ */ i(Fs, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(r.columns).filter(([, o]) => typeof o == "object").sort(([, o], [, a]) => typeof o == "boolean" || typeof a == "boolean" ? 0 : o.order - a.order).map(([o, a]) => /* @__PURE__ */ N(nm, { children: [
      ...
      /* @__PURE__ */ i(Us, { children: (() => {
        ...
        return s.flatMap(([l], c) => {
          const d = r.items.filter((f) => f.group === l).sort((f, w) => f.order - w.order).map(
            (f) => /* @__PURE__ */ i(
              Xs,
              {
                onClick: () => {
              ...
              "command" in f ? f.command : f.id
            )
          ), p = [...d];
          return d.length > 0 && c < s.length - 1 && p.push(/* @__PURE__ */ i(Ys, {}, `${l}-separator`)), p;
        });
      })() })
    ] }, o)) });
}
