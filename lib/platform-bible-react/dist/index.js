...
function lt() {
  if (!el()) return "ltr";
  try {
    return window.localStorage.getItem(tl) === "rtl" ? "rtl" : "ltr";
  } catch {
    return "ltr";
  }
}
const nl = Ct.Root, rl = Ct.Portal, zo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Ct.Overlay,
  {
    ref: n,
    className: m(
...
const ht = class X {
  ...
  static fromJSON(t) {
    ...
    let d;
    return i && (d = new re(i)), n ? new X(n, r.toString(), l, d) : new X();
  }
  /**
...
const Qo = Qe(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Ie : "button", { className: m(bl({ variant: t, size: n, className: e })), ref: s, ...a })
);
$.displayName = "Button";
const ge = Ee.Root, be = Ee.Trigger, hp = Ee.Anchor, Qt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = lt();
...
function vl({
  ...
  return /* @__PURE__ */ c(ge, { open: l, onOpenChange: d, children: [
    ...
    /* @__PURE__ */ o(Qt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(he, { children: /* @__PURE__ */ o(fe, { children: /* @__PURE__ */ o(Yt, { heading: s, children: e.map((p) => /* @__PURE__ */ c(
      Zt,
      {
        onSelect: () => w(p),
      ...
      if (i) {
        ...
        if (!p && d) {
          const u = ((g) => Object.keys(le).find(
            (x) => le[x].toLowerCase() === g.toLowerCase()
          ))(l);
...
function gp({
  ...
  return $t(() => {
    const v = setTimeout(() => {
      if (p && k === "books" && O.current && N.current) {
        const j = O.current, Z = N.current, dt = Z.offsetTop, mt = j.clientHeight, ee = Z.clientHeight, Mt = dt - mt / 2 + ee / 2;
        j.scrollTo({
          top: Math.max(0, Mt),
          behavior: "smooth"
        }), u(or(e.book));
  ...
  }, [k, _, I, e.book, e.chapterNum]), /* @__PURE__ */ c(ge, { open: p, onOpenChange: ct, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
      $,
      {
      ...
      he,
      {
        ...
        children: [
          k === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: P.map(({ onClick: v, disabled: j, title: Z, icon: dt }) => /* @__PURE__ */ o(
              $,
              {
                variant: "ghost",
                size: "sm",
          ...
          !E && /* @__PURE__ */ c(fe, { ref: O, children: [
...
), it = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Co.Root, { ref: n, className: m("pr-twp", kl(), e), ...t }));
...
function ar({
  ...
  return /* @__PURE__ */ c(ge, { open: _, onOpenChange: y, ...C, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ o(ce, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = ea ? $t : q, wn = { tag: gr };
function Il({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: d } = e, w = Dl(null, r), p = Eo({ editable: e.editable, html: d, namespace: a, nodes: s, onError: (f) => i(f, p), theme: r });
    return function(f, h) {
      if (h !== null) {
...
const Ml = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : q;
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ri(t) && r !== null) {
    ...
    if (w || p) {
      const [f, h] = oi(e), u = l.is(d), g = t.is(i ? d : l), x = t.is(i ? l : d);
      let k, C = 0;
...
const ir = Bt({ build: (e) => da(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, pa = 2, jn = 3, dn = 4, ye = 5, Fn = 6, ze = 7;
function Gn(e) {
  return e.id === Rr;
}
function ua(e) {
...
const nw = Bt({ config: en({ setOptions: no, updateOptions: no }), init: ({ $initialEditorState: e = ew }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [li, To, wi, di, So] }), ro = Symbol.for("@lexical/extension/LexicalBuilder");
function oo() {
}
function rw(e) {
  throw e;
...
const ow = /* @__PURE__ */ new Set(), ao = Bt({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = Je({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = da(() => {
  }, () => Jt(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = ql(() => (s.value || ow).has(i)), { watchedNodeKeys: d } = a.peek();
    let w = d.get(i);
    const p = w !== void 0;
...
function iw(e, t) {
  return qt(e.registerCommand(ki, (n) => {
    ...
    const a = function(s) {
      const i = s.getNodes();
      if (Kl(i, (h) => mn(h) && h.canIndent() ? h : null).length > 0) return !0;
...
const lw = Bt({ name: "@lexical/react/ReactProvider" });
function ww() {
  ...
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let d = 0; d < l.length; d++) {
        const w = l[d], p = o(r, { onError: (h) => n._onError(h), children: o(cs, { fallback: null, children: a[w] }) }), f = n.getElementByKey(w);
...
function hw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Dr(() => qt(Bi(a), fa(a)), [a]);
  }(r), c(at, { children: [e, o(fw, { content: t }), o(mw, { editor: r, ErrorBoundary: n })] });
}
...
function kw(e, t) {
  ...
  return c(at, { children: [o(yw, { editor: a, ...r, ref: t }), n != null && o(_w, { editor: a, content: n })] });
}
...
function Sw() {
  const [e, t] = D(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ o(nl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ c(jo, { children: [
...
function Tw({
  ...
  const [t] = It(), [n, r] = D(t), [a, s] = D("paragraph"), [i, l] = Sw(), d = () => {
  };
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Il,
    {
      ...
      children: /* @__PURE__ */ c(Vt, { children: [
        /* @__PURE__ */ o(Mw, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ o(
          Al,
          {
...
function Na(e, t, n, r = null) {
  ...
  const l = ie(i) ? i.getChildren() : [], d = Oi(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Na(e, g, h, r);
    !a && ie(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
...
function _a(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  return p != null && (h = p(h)), Kr(e) && (h = $w(e, h, u ? () => {
    const g = new Io();
    return n.push(g), g;
...
const Gw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
...
Xw.displayName = Me.Image.displayName;
...
}), Ve = tt.Trigger, Ra = tt.Group, Kw = tt.Portal, Uw = tt.Sub, Yw = tt.RadioGroup;
    ...
    if (r && x)
      return /* @__PURE__ */ c(at, { children: [
        !Zs(e.contents) && /* @__PURE__ */ c(
          ...
          {
            onClick: () => {
              h(!0), g(Bw(Gr(e.contents))), d == null || d(!0);
            },
            children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: C,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), _()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Ft(u) && y());
              },
              onKeyDown: (N) => {
                Ca(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  wr,
...
function Jw({
  ...
  const [C, _] = D(co), [y, E] = D(!1), [M, R] = D(!1), [S, O] = D(!1), [N, T] = D(!1), [V, L] = D(!1), [F, A] = D(void 0), [W, I] = D(!1), [ot, yt] = D(!1);
  q(() => {
    let v = !0;
    if (!n) {
      I(!1), yt(!1);
  ...
  const _t = B(() => e.filter((v) => !v.deleted), [e]), bt = B(() => _t[0], [_t]), P = rt(null), Q = rt(void 0), ct = z(() => {
    var v;
  ...
  const wt = B(
    ...
    async (v) => {
      const j = Ft(C) ? dr(C) : void 0, Z = await w({
        ...v,
        contents: j,
        assignedUser: F ?? v.assignedUser
      });
      return Z && j && ct(), Z && F !== void 0 && A(void 0), Z;
    },
    [ct, C, w, F]
  );
  return /* @__PURE__ */ o(
    Ir,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ c(Ea, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          ...
          /* @__PURE__ */ c("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            M && /* @__PURE__ */ o(
              $,
              {
                ...
                children: y ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(ce, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ c(ge, { open: V, onOpenChange: L, children: [
                      /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ o(
                        $,
                        {
                          size: "icon",
...
function Ww({ table: e }) {
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ o(Gi, { asChild: !0, children: /* @__PURE__ */ c($, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const De = st.Root, Zw = st.Group, Oe = st.Value, Qw = Wt(
  ...
  return /* @__PURE__ */ c(
    st.Trigger,
    {
      className: m(Qw({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ o(st.Icon, { asChild: !0, children: /* @__PURE__ */ o(ce, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const Aa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  st.ScrollDownButton,
  {
    ...
    className: m("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ o(ce, { className: "tw-h-4 tw-w-4" })
  }
));
...
td.displayName = st.Label.displayName;
...
ed.displayName = st.Separator.displayName;
function nd({ table: e }) {
...
function We(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && rd(r)
  );
}
...
const de = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "td",
  {
    ref: n,
...
function wd({
  ...
  var R;
  const [p, f] = D([]), [h, u] = D([]), [g, x] = D({}), [k, C] = D({}), _ = B(() => t ?? [], [t]), y = $o({
    data: _,
    columns: e,
    getCoreRowModel: Bo(),
  ...
  let M;
  return d ? M = Array.from({ length: 10 }).map((N, T) => `skeleton-row-${T}`).map((N) => /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(de, { colSpan: E.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, N)) : ((R = y.getRowModel().rows) == null ? void 0 : R.length) > 0 ? M = y.getRowModel().rows.map((S) => /* @__PURE__ */ o(
    At,
    {
      onClick: () => i(S, y),
      "data-state": S.getIsSelected() && "selected",
      children: S.getVisibleCells().map((O) => /* @__PURE__ */ o(de, { children: He(O.column.columnDef.cell, O.getContext()) }, O.id))
    },
    S.id
  )) : M = /* @__PURE__ */ o(At, { children: /* @__PURE__ */ o(de, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ c("div", { className: "pr-twp", id: l, children: [
...
function Cp({
  ...
  return /* @__PURE__ */ c(ge, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: r }),
    /* @__PURE__ */ c(Qt, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
var pd = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(pd || {});
function Ep({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ c($, { variant: "default", children: [
      /* @__PURE__ */ o(Ss, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(ce, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
...
function ud({ id: e, versionHistory: t }) {
...
function Tp({
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(ud, { versionHistory: a }),
...
function md({
  ...
  return /* @__PURE__ */ o("div", { id: k, className: g, children: /* @__PURE__ */ c(ge, { open: O, onOpenChange: p ?? _, children: [
    /* @__PURE__ */ o(be, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        variant: x,
    ...
    /* @__PURE__ */ o(Qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(he, { children: [
      ...
      /* @__PURE__ */ c(fe, { children: [
        ...
        /* @__PURE__ */ o(Yt, { children: M.map((T) => /* @__PURE__ */ c(
          Zt,
          {
            value: T.label,
            onSelect: y,
...
$e.displayName = "Input";
const hd = (e, t, n) => e === "generated" ? /* @__PURE__ */ c(at, { children: [
...
function fd({
  ...
  return q(() => {
    ...
    l !== n && d(n);
  }, [n]), /* @__PURE__ */ c(ve, { onOpenChange: (p) => {
    p || (s !== "custom" || l ? (t(s), r(l)) : (i(e), d(n)));
  }, children: [
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(Ve, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "outline", className: "tw-h-6", children: hd(e, a, n) }) }) }),
...
const gd = (e, t) => e === "f" ? /* @__PURE__ */ c(at, { children: [
  /* @__PURE__ */ o(No, {}),
  " ",
...
function vd({
  ...
  return /* @__PURE__ */ c(ve, { children: [
    /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Ht, { children: [
      ...
      /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o("p", { children: bd(e, n) }) })
    ] }) }),
...
function Dp({
  ...
  const l = rt(null), d = ps(), [w, p] = D("generated"), [f, h] = D("*"), [u, g] = D("f"), x = B(
    () => ({
      ...s,
    ...
    /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ c(Ht, { children: [
...
function Nd({
  ...
  return /* @__PURE__ */ c(at, { children: [
    ...
    /* @__PURE__ */ o("div", { className: m("textual-note-body tw-pr-0.5", u), children: l && l.length > 0 && /* @__PURE__ */ o(at, { children: xd(e.marker, l, r, w) }) })
  ] });
}
const Ip = ["%webView_footnoteList_header%"], kd = (e, t) => e[t] ?? t;
function Mp({
  className: e,
  classNameForItems: t,
  footnotes: n,
  ...
  const f = p ? kd(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? ni(n, void 0), u = (y, E) => {
    w == null || w(y, E, a);
  ...
  return /* @__PURE__ */ c(En, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ o(Tn, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      At,
      {
        ...
        children: [
          /* @__PURE__ */ o(de, { children: `${Y.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ o(de, { children: _d(i.text) })
        ]
      },
...
const Rn = (e) => e === "asc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ap = (e) => ({
  accessorKey: "item",
  accessorFn: (t) => t.items[0],
  header: ({ column: t }) => /* @__PURE__ */ c($, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] })
}), Ed = (e, t) => ({
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ c($, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    Rn(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ o("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ c($, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    e,
    Rn(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
  ...
  return t ? t[1] : "";
}, Sd = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", zp = Object.freeze([
...
function jp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), h = Tt(n, "%webView_inventory_approved%"), u = Tt(n, "%webView_inventory_unapproved%"), g = Tt(n, "%webView_inventory_unknown%"), x = Tt(n, "%webView_inventory_scope_currentBook%"), k = Tt(n, "%webView_inventory_scope_chapter%"), C = Tt(n, "%webView_inventory_scope_verse%"), _ = Tt(n, "%webView_inventory_filter_text%"), y = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), E = Tt(n, "%webView_inventory_no_results%"), [M, R] = D(!1), [S, O] = D("all"), [N, T] = D(""), [V, L] = D([]), F = B(() => {
    const P = e ?? [];
    return P.length === 0 ? [] : Rd(P, a, s);
  }, [e, a, s]), A = B(() => {
    if (M) return F;
    const P = [];
    return F.forEach((Q) => {
      const ct = Q.items[0], wt = P.find(
        (Nt) => Nt.items[0] === ct
      );
  ...
  }, [M, F]), W = B(() => A.length === 0 ? [] : Td(A, S, N), [A, S, N]), I = B(() => {
    var ct, wt;
    if (!M) return d;
    const P = (ct = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ct.length;
    if (!P) return d;
    const Q = [];
  ...
  return /* @__PURE__ */ c("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(De, { onValueChange: (P) => yt(P), defaultValue: i, children: [
...
const Dd = "16rem", Od = "3rem", Pa = b.createContext(void 0);
function Dn() {
...
const Id = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Dn();
  return /* @__PURE__ */ c(
    $,
    {
...
const Ld = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: r,
...
Ld.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const d = e ? Ie : "button", { state: w } = Dn(), p = /* @__PURE__ */ o(
      d,
      {
        ...
        "data-size": r,
        "data-active": t,
        className: m(Bd({ variant: n, size: r }), s),
        ...i
      }
    );
...
const zd = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: a,
...
jd.displayName = "SidebarMenuBadge";
...
const Xd = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? Ie : "a",
  {
    ref: s,
...
function Kd({
  ...
  return /* @__PURE__ */ o(
    La,
    {
      ...
      children: /* @__PURE__ */ c(za, { children: [
...
const Gt = "scrBook", Ud = "scrRef", ae = "source", Yd = "details", qd = "Scripture Reference", Jd = "Scripture Book", Ha = "Type", Wd = "Details";
function Zd(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: Gt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? qd,
      cell: (r) => {
...
}, mo = (e) => `${Qd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Gp({
  sources: e,
  ...
  const [w, p] = D([]), [f, h] = D([{ id: Gt, desc: !1 }]), [u, g] = D({}), x = B(
  ...
  const _ = a ?? Jd, y = s ?? Ha, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${_}`, value: [Gt] },
    { label: `Group by ${y}`, value: [ae] },
    {
    ...
    !t && /* @__PURE__ */ c(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(me, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: E.map((N) => /* @__PURE__ */ o(kt, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
...
function tc({
  ...
  const s = $r(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], d = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    $,
    {
      variant: "outline",
            ...
            he,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: L, children: d }),
...
function Xp({
  ...
  const w = ne(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ne(i, "%webView_scope_selector_current_book%"), u = ne(i, "%webView_scope_selector_choose_books%"), g = ne(i, "%webView_scope_selector_scope%"), x = ne(i, "%webView_scope_selector_select_books%"), k = [
...
const Ua = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(we, { asChild: !0, children: "command" in l ? /* @__PURE__ */ c(
    gn,
    {
      onClick: () => {
        r(l);
    ...
    /* @__PURE__ */ o(Kw, { children: /* @__PURE__ */ o(Oa, { children: Ua(
      e,
      t,
      Ka(e, l.id),
      r
...
function hr({
  ...
  return /* @__PURE__ */ c(ve, { variant: s, children: [
    ...
    /* @__PURE__ */ o(te, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, w]) => typeof d == "boolean" || typeof w == "boolean" ? 0 : d.order - w.order).map(([d], w, p) => /* @__PURE__ */ c(fo, { children: [
      /* @__PURE__ */ o(Ra, { children: /* @__PURE__ */ o(Vt, { children: Ua(t.groups, t.items, d, e) }) }),
...
function Jp({
  ...
  return /* @__PURE__ */ c(Ya, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ o(
      hr,
      {
        onSelectMenuItem: e,
...
function Zp({
  ...
  return /* @__PURE__ */ c("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ c(qa, { children: [
      /* @__PURE__ */ o(Ja, { children: e.map((l) => /* @__PURE__ */ o(nc, { value: l.value, children: l.value }, l.key)) }),
...
const ac = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = St();
  return /* @__PURE__ */ c(
    et.CheckboxItem,
    {
...
ac.displayName = et.CheckboxItem.displayName;
const sc = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = St();
  return /* @__PURE__ */ c(
    et.RadioItem,
    {
...
sc.displayName = et.RadioItem.displayName;
const ic = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
    className: m("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
ic.displayName = et.Label.displayName;
...
const je = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ c(Ht, { children: [
      /* @__PURE__ */ o(we, { asChild: !0, children: "command" in w ? /* @__PURE__ */ c(
        rs,
        {
          onClick: () => {
            r(w);
    ...
    return l.length > 0 && i < a.length - 1 && d.push(/* @__PURE__ */ o(os, {}, `separator-${s}`)), d;
  });
};
function lc({
  menuData: e,
  ...
  if (Wi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    return /* @__PURE__ */ o(Za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, f]) => typeof p == "boolean" || typeof f == "boolean" ? 0 : p.order - f.order).map(([p, f]) => /* @__PURE__ */ c(rc, { children: [
...
function dc({ item: e, createLabel: t, createComplexLabel: n }) {
...
function cc(e, t) {
  ...
  if (n.length <= t * 2)
    return e;
  const r = n.slice(0, t), a = n.slice(-t);
  return [...r, "[...]", ...a].join(" ");
}
function pc({
  startRef: e,
  ...
  className: r,
  onClick: a,
  remainderTextLength: s = 7
}) {
  const i = e.book === (t == null ? void 0 : t.book) ? t == null ? void 0 : t.chapterAndVerse : `${t == null ? void 0 : t.book} ${t == null ? void 0 : t.chapterAndVerse}`;
  return /* @__PURE__ */ c("div", { className: m("tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none"), children: [
    /* @__PURE__ */ c(
      $,
      {
        ...
        onClick: (l) => {
          l.stopPropagation(), a == null || a(l);
        },
        className: m("tw-me-2 tw-h-4 tw-p-0", r),
        children: [
          e.book,
          " ",
          e.chapterAndVerse,
      ...
      children: [
        /* @__PURE__ */ c("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": t }), children: [
          /* @__PURE__ */ c("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ o("div", { className: "tw-p-1", children: /* @__PURE__ */ c(ve, { children: [
              /* @__PURE__ */ o(Ve, { className: w, asChild: !0, children: /* @__PURE__ */ o($, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
...
const uc = Qe(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: m("tw-animate-spin", e), ...t, ref: n }));
...
), hc = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
fc.displayName = "AlertTitle";
const gc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
gc.displayName = "AlertDescription";
const au = nt.Root, su = nt.Trigger, iu = nt.Group, lu = nt.Portal, wu = nt.Sub, du = nt.RadioGroup, bc = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ c(
  nt.SubTrigger,
  {
    ref: a,
    className: m(
...
bc.displayName = nt.SubTrigger.displayName;
...
vc.displayName = nt.SubContent.displayName;
const xc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(nt.Portal, { children: /* @__PURE__ */ o(
  nt.Content,
  {
    ref: n,
    className: m(
...
xc.displayName = nt.Content.displayName;
...
yc.displayName = nt.Item.displayName;
const Nc = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ c(
  nt.CheckboxItem,
  {
    ref: a,
    className: m(
...
Nc.displayName = nt.CheckboxItem.displayName;
const kc = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ c(
  nt.RadioItem,
  {
    ref: r,
    className: m(
...
kc.displayName = nt.RadioItem.displayName;
const _c = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: m(
...
_c.displayName = nt.Label.displayName;
...
Cc.displayName = nt.Separator.displayName;
...
Ec.displayName = "ContextMenuShortcut";
...
Sc.displayName = "Drawer";
const cu = Et.Trigger, Tc = Et.Portal, pu = Et.Close, is = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
const Rc = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Ic.displayName = Et.Title.displayName;
...
Mc.displayName = Et.Description.displayName;
const Ac = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  nr.Root,
  {
    ref: r,
    className: m(
...
Ac.displayName = nr.Root.displayName;
function uu({
  className: e,
  ...t
}) {
...
const Vc = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ c(
    Fe.Root,
    {
...
Vc.displayName = Fe.Root.displayName;
...
Pc.displayName = rr.Root.displayName;
const gu = gt.Root, $c = b.forwardRef(({ className: e, ...t }, n) => {
  const r = lt();
  return /* @__PURE__ */ o(
    gt.List,
    {
...
$c.displayName = gt.List.displayName;
...
Lc.displayName = gt.Trigger.displayName;
...
Bc.displayName = gt.Content.displayName;
...
export {
  ...
  Np as CommentList,
  au as ContextMenu,
  Nc as ContextMenuCheckboxItem,
  xc as ContextMenuContent,
  iu as ContextMenuGroup,
  yc as ContextMenuItem,
  _c as ContextMenuLabel,
  lu as ContextMenuPortal,
  du as ContextMenuRadioGroup,
  kc as ContextMenuRadioItem,
  Cc as ContextMenuSeparator,
  Ec as ContextMenuShortcut,
  wu as ContextMenuSub,
  vc as ContextMenuSubContent,
  bc as ContextMenuSubTrigger,
  ...
  Ip as FOOTNOTE_LIST_STRING_KEYS,
  Rp as Filter,
  ...
  jd as SidebarMenuBadge,
  Ga as SidebarMenuButton,
  Fa as SidebarMenuItem,
  Fd as SidebarMenuSkeleton,
  Gd as SidebarMenuSub,
  Xd as SidebarMenuSubButton,
  Hd as SidebarMenuSubItem,
  $a as SidebarProvider,
  Md as SidebarRail,
  $d as SidebarSeparator,
  Id as SidebarTrigger,
  cr as Skeleton,
  Vc as Slider,
  fu as Sonner,
  uc as Spinner,
