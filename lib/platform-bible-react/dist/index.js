...
function ti({
  ...
  return /* @__PURE__ */ d(oe, { children: [
    ...
    /* @__PURE__ */ r($t, { className: l("tw-z-[250] tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      Wa,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function ri({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(o).length > 0 && /* @__PURE__ */ r(Qa, { versionHistory: o }),
