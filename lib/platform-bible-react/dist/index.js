...
import { getChaptersForBook as Rl, deepEqual as co, substring as _l, formatScrRef as Or, compareScrRefs as Hr, scrRefToBBBCCCVVV as Rr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Pl, formatBytes as $l } from "platform-bible-utils";
...
import { useReactTable as ei, getCoreRowModel as ni, getPaginationRowModel as Al, getSortedRowModel as ri, getFilteredRowModel as Il, flexRender as dn, getExpandedRowModel as Ml, getGroupedRowModel as Dl } from "@tanstack/react-table";
...
import { CardContent as Bl, MenuItem as jl, ListItemText as Vl, ListItemIcon as ii, Menu as zl, Grid as si, List as Ll, IconButton as li, Drawer as Fl, AppBar as Ul, Toolbar as Gl } from "@mui/material";
...
*/
et(St, "ValidStatusType", fi);
class tn extends Error {
}
const fo = wt.Root, mi = wt.Trigger, pc = wt.Group, mh = wt.Portal, hh = wt.Sub, gh = wt.RadioGroup, uc = T.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ x(
  wt.SubTrigger,
  {
    ref: o,
    className: N(
...
function hc({
  ...
  const a = Array.from({ length: e }, (l, c) => c + 1), i = Tt(
    (l) => {
      o(l);
    },
    [o]
...
function bh({ scrRef: t, handleSubmit: e }) {
  const [n, r] = ut(""), [o, a] = ut(
    ...
    ot.bookNumberToId(t.bookNum)
  ), [p, h] = ut(!1), [w, g] = ut(p), v = ge(void 0), f = ge(void 0), m = ge(void 0), E = Tt(
    (k) => xc(k).filter((B) => {
  ...
  return ae(() => {
    ...
    const k = setTimeout(() => {
      if (w && f.current && m.current) {
        const D = m.current.offsetTop - vc;
...
), Xt = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(ti.Root, { ref: n, className: N("pr-twp", Tc(), t), ...e }));
...
const Cc = hn.Root, Oc = hn.Trigger, vi = T.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ s(hn.Portal, { children: /* @__PURE__ */ s(
  hn.Content,
  {
    ref: o,
    align: e,
...
const Rc = vt.Portal, yi = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Overlay,
  {
    ref: n,
    className: N(
...
Ic.displayName = Rt.Separator.displayName;
...
function qr({
  ...
  const [v, f] = ut(!1);
  return /* @__PURE__ */ x(Cc, { open: v, onOpenChange: f, ...g, children: [
...
function Xc({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = At(() => {
    const i = [];
    return t.forEach((l) => {
...
}, qc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Oi = Xe(
...
Kc.displayName = oi.Root.displayName;
...
const lr = (t) => t === "asc" ? /* @__PURE__ */ s(ml, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(hl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(gl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), xh = (t) => ({
  ...
  return Yc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Wc(p), l = 0, c = 0), p.startsWith("\\c") && (l = oa(p), c = 0), p.startsWith("\\v") && (c = oa(p), l === 0 && (l = e.chapterNum));
...
function Sh({
  ...
  const h = Jt(n, "%webView_inventory_all%"), w = Jt(n, "%webView_inventory_approved%"), g = Jt(n, "%webView_inventory_unapproved%"), v = Jt(n, "%webView_inventory_unknown%"), f = Jt(n, "%webView_inventory_scope_currentBook%"), m = Jt(n, "%webView_inventory_scope_chapter%"), E = Jt(n, "%webView_inventory_scope_verse%"), _ = Jt(n, "%webView_inventory_filter_text%"), C = Jt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, b] = ut(!1), [A, z] = ut("all"), [H, O] = ut(""), [$, k] = ut([]), B = At(() => l ? r instanceof RegExp ? Qc(
    l,
    t,
    a,
    i,
    r
  ) : r(l, t, a, i) : [], [l, r, t, a, i]), D = At(() => {
    if (S)
      return B;
    const y = [];
    return B.forEach((R) => {
...
Pi.displayName = _t.List.displayName;
...
function Th({
  ...
  return /* @__PURE__ */ x("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ x(Pi, { dir: a, children: [
      /* @__PURE__ */ s($i, { children: t.map((i) => /* @__PURE__ */ s(ed, { value: i.value, children: i.value }, i.key)) }),
...
const nd = vt.Root, rd = vt.Portal, Ii = M.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vt.Overlay,
  {
    className: N(
      "tw-fixed tw-inset-0 tw-z-50 tw-bg-black/80 data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0",
...
Ii.displayName = vt.Overlay.displayName;
const od = Xe(
...
), Mi = M.forwardRef(({ side: t = "right", className: e, children: n, ...r }, o) => /* @__PURE__ */ x(rd, { children: [
  /* @__PURE__ */ s(Ii, {}),
...
Mi.displayName = vt.Content.displayName;
...
const sd = En.Provider, ld = En.Root, cd = En.Trigger, Di = T.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  En.Content,
  {
    ref: r,
    sideOffset: e,
...
Di.displayName = En.Content.displayName;
const $r = 768;
function dd() {
...
const pd = "sidebar:state", ud = 60 * 60 * 24 * 7, wd = "16rem", fd = "18rem", md = "3rem", hd = "b", Bi = T.createContext(void 0);
function cr() {
  const t = T.useContext(Bi);
  if (!t)
...
const ji = T.forwardRef(
  ({
    ...
    return /* @__PURE__ */ s(Bi.Provider, { value: E, children: /* @__PURE__ */ s(sd, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
function Pd({
  ...
  const a = Tt(
    ...
    (l) => {
      const c = n.find((d) => d.projectId === l);
      return c ? c.projectName : l;
    },
    [n]
  );
  return /* @__PURE__ */ s(Vi, { id: t, collapsible: "offcanvas", variant: "sidebar", children: /* @__PURE__ */ x(Li, { children: [
    /* @__PURE__ */ x(Kr, { children: [
      /* @__PURE__ */ s(Jr, { children: "Extensions" }),
      /* @__PURE__ */ s(Zr, { children: /* @__PURE__ */ s(Fi, { children: e.map((l) => /* @__PURE__ */ s(Ui, { children: /* @__PURE__ */ s(
        Gi,
        {
          onClick: () => a(l),
          isActive: !(o != null && o.projectId) && l === (o == null ? void 0 : o.label),
          children: l
        }
      ) }, l)) }) })
    ] }),
    /* @__PURE__ */ x(Kr, { children: [
      /* @__PURE__ */ s(Jr, { children: "Projects" }),
      /* @__PURE__ */ s(Zr, { children: /* @__PURE__ */ s(
        qr,
        {
          popoverContentClassName: "tw-z-[1000]",
          options: n.flatMap((l) => l.projectId),
          getOptionLabel: (l) => i(l),
...
function Ch({
  ...
  return /* @__PURE__ */ x(ji, { dir: e, id: t, children: [
    /* @__PURE__ */ s(
      Pd,
      {
        extensionLabels: n,
    ...
    /* @__PURE__ */ s(zi, { children: o })
  ] });
}
const ne = "scrBook", $d = "scrRef", we = "source", Ad = "details", Id = "Scripture Reference", Md = "Scripture Book", Hi = "Type", Dd = "Details";
function Bd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ne,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Id,
      cell: (r) => {
...
function Oh({
  ...
  const [d, p] = ut([]), [h, w] = ut([{ id: ne, desc: !1 }]), [g, v] = ut({}), f = At(
                  ...
                  children: (() => k.getIsGrouped() ? /* @__PURE__ */ x(
                    gt,
                    {
                      ...
                      children: [
                        ...
                        !O.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ s(Ja, {}) : /* @__PURE__ */ s(vl, {})),
                        " ",
...
function Ah({
  ...
  return /* @__PURE__ */ x(Xi, { id: t, children: [
    /* @__PURE__ */ x(Yi, { children: [
      /* @__PURE__ */ s(Wi, { children: e }),
      n && /* @__PURE__ */ s(qi, { children: n })
    ] }),
    /* @__PURE__ */ s(Bl, { className: "tw-space-y-4", children: r })
  ] });
}
function Ih({
  id: t,
...
function Hd() {
  return la || (la = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C(I) {
      ...
      I === r || I === d || I === a || I === o || I === h || I === w || typeof I == "object" && I !== null && (I.$$typeof === v || I.$$typeof === g || I.$$typeof === i || I.$$typeof === l || I.$$typeof === p || I.$$typeof === m || I.$$typeof === E || I.$$typeof === _ || I.$$typeof === f);
    }
    function S(I) {
    ...
    var b = c, A = d, z = l, H = i, O = e, $ = p, k = r, B = v, D = g, J = n, q = a, U = o, tt = h, at = !1;
    function rt(I) {
      return at || (at = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), y(I) || S(I) === c;
    }
    function y(I) {
      return S(I) === d;
    }
...
function Wd() {
  if (fa)
    return Vr;
  fa = 1;
  var t = Zi(), e = Xd(), n = yo(), r = Qi(), o = Yd(), a = function() {
  };
...
const es = vo(u.element, ts);
es.isRequired = vo(u.element.isRequired, ts);
...
function rp() {
  return ga || (ga = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var A = i, z = a, H = t, O = c, $ = n, k = w, B = h, D = e, J = o, q = r, U = d, tt = p, at = !1, rt = !1;
    function y(j) {
...
function ss() {
  ...
  function n() {
    return e.current ? (no = !0, yp.start(100, () => {
      no = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
const Ap = {
  borderRadius: 4
}, Ip = Ap, Mp = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.string, u.object, u.array]) : {}, se = Mp;
function un(t, e) {
  return e ? Zt(t, e, {
    clone: !1
...
const Xp = Lt("border", Bt), Yp = Lt("borderTop", Bt), Wp = Lt("borderRight", Bt), qp = Lt("borderBottom", Bt), Kp = Lt("borderLeft", Bt), Jp = Lt("borderColor"), Zp = Lt("borderTopColor"), Qp = Lt("borderRightColor"), tu = Lt("borderBottomColor"), eu = Lt("borderLeftColor"), nu = Lt("outline", Bt), ru = Lt("outlineColor"), hr = (t) => {
...
function Su() {
  ...
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = Dp(a.breakpoints), h = Object.keys(p);
      let w = p;
...
function To(t = {}, ...e) {
  ...
  return d.applyStyles = Tu, d = e.reduce((p, h) => Zt(p, h), d), d.unstable_sxConfig = P({}, Eo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return So({
      sx: h,
      theme: this
    });
...
const Mu = To(), Ta = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Vn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function Bu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Yl(i, (b) => b.filter((A) => !(A != null && A.__mui_systemSx)));
    const {
      name: c,
      slot: d,
    ...
    const _ = Hl(i, P({
      shouldForwardProp: E,
      label: m
    }, g)), C = (b) => typeof b == "function" && b.__emotion_real !== b || he(b) ? (A) => Hn(b, P({}, A, {
      theme: Vn({
        theme: A.theme,
        defaultTheme: n,
        themeId: e
...
const Hu = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, $e = Qu, tw = ["mode", "contrastThreshold", "tonalOffset"], Ra = {
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof i == "string" ? i : Aa(i)} ${l} ${typeof c == "string" ? c : Aa(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
function bs(t, e) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${e}Icon`), n.muiName = Ia.muiName, /* @__PURE__ */ M.memo(/* @__PURE__ */ M.forwardRef(n));
}
const $w = {
  configure: (t) => {
...
}, Symbol.toStringTag, { value: "Module" })), Iw = /* @__PURE__ */ Fd(Aw);
var Ma;
function Mw() {
...
var vs = bo.default = void 0, Bw = Dw(Mw()), jw = Qs;
vs = bo.default = (0, Bw.default)(/* @__PURE__ */ (0, jw.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Vw(t) {
...
function Hw(t) {
  ...
  const i = Uw(P({}, o, r)), l = Da(r), c = Da(o), d = e(i), p = be(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = P({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = P({}, d, n, c, l);
...
var Ct = "top", Vt = "bottom", zt = "right", Ot = "left", $o = "auto", _n = [Ct, Vt, zt, Ot], Le = "start", Nn = "end", Zw = "clippingParents", Ns = "viewport", rn = "popper", Qw = "reference", Ba = /* @__PURE__ */ _n.reduce(function(t, e) {
  return t.concat([e + "-" + Le, e + "-" + Nn]);
}, []), ks = /* @__PURE__ */ [].concat(_n, [$o]).reduce(function(t, e) {
...
function Ue(t, e, n) {
  ...
  var i = ke(t) ? Mt(t) : window, l = i.visualViewport, c = !Es() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, w = r.height / a;
  return {
    width: h,
    height: w,
    top: p,
...
function xr(t) {
  return qt(t) === "html" ? t : (
    ...
    (Ao(t) ? t.host : null) || // ShadowRoot detected
...
function mf(t) {
  ...
  var o = xr(t);
  for (Ao(o) && (o = o.host); jt(o) && ["html", "body"].indexOf(qt(o)) < 0; ) {
    var a = te(o);
...
function Pn(t) {
  for (var e = Mt(t), n = ja(t); n && ff(n) && te(n).position === "static"; )
    n = ja(n);
...
function bf(t) {
  ...
  if (!(!a || !i)) {
    var h = gf(o.padding, n), w = Io(a), g = c === "y" ? Ct : Ot, v = c === "y" ? Vt : zt, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], E = Pn(a), _ = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, C = f / 2 - m / 2, S = h[g], b = _ - w[p] - h[v], A = _ / 2 - w[p] / 2 + C, z = wn(S, A, b), H = c;
    n.modifiersData[r] = (e = {}, e[H] = z, e.centerOffset = z - A, e);
  }
}
function vf(t) {
...
function Va(t) {
  ...
  if (d) {
    var A = Pn(n), z = "clientHeight", H = "clientWidth";
    if (A === Mt(n) && (A = le(n), te(A).position !== "static" && l === "absolute" && (z = "scrollHeight", H = "scrollWidth")), A = A, o === Ct || (o === Ot || o === zt) && a === Nn) {
      S = Vt;
      var O = h && A === b && b.visualViewport ? b.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        A[z]
      );
    ...
    if (o === Ot || (o === Ct || o === Vt) && a === Nn) {
      C = zt;
      var $ = h && A === b && b.visualViewport ? b.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        A[H]
      );
      g -= $ - r.width, g *= c ? 1 : -1;
...
function Rs(t) {
  return ["html", "body", "#document"].indexOf(qt(t)) >= 0 ? t.ownerDocument.body : jt(t) && jo(t) ? t : Rs(xr(t));
}
function fn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Rs(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Mt(r), i = o ? [a].concat(a.visualViewport || [], jo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function La(t, e, n) {
  return e === Ns ? oo(Rf(t, n)) : ke(e) ? Pf(e, n) : oo(_f(le(t)));
}
function $f(t) {
...
function kn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Zw : l, d = n.rootBoundary, p = d === void 0 ? Ns : d, h = n.elementContext, w = h === void 0 ? rn : h, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, m = f === void 0 ? 0 : f, E = Cs(typeof m != "number" ? m : Os(m, _n)), _ = w === rn ? Qw : rn, C = t.rects.popper, S = t.elements[v ? _ : w], b = Af(ke(S) ? S : S.contextElement || le(t.elements.popper), c, p, i), A = Ue(t.elements.reference), z = _s({
    reference: A,
    element: C,
    strategy: "absolute",
    placement: o
  }), H = oo(Object.assign({}, C, z)), O = w === rn ? H : A, $ = {
...
function If(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? ks : c, p = Ge(r), h = p ? l ? Ba : Ba.filter(function(v) {
    return Ge(v) === p;
...
function Df(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, m = e.options.placement, E = Yt(m), _ = E === m, C = c || (_ || !v ? [Xn(m)] : Mf(m)), S = [m].concat(C).reduce(function(V, W) {
    ...
    }, []), b = e.rects.reference, A = e.rects.popper, z = /* @__PURE__ */ new Map(), H = !0, O = S[0], $ = 0; $ < S.length; $++) {
...
function Xf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = kn(e, {
    ...
    padding: h,
    altBoundary: p
  }), E = Yt(e.placement), _ = Ge(e.placement), C = !_, S = Mo(E), b = Hf(S), A = e.modifiersData.popperOffsets, z = e.rects.reference, H = e.rects.popper, O = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, $ = typeof O == "number" ? {
    mainAxis: O,
    altAxis: O
  ...
  if (A) {
    if (a) {
      var D, J = S === "y" ? Ct : Ot, q = S === "y" ? Vt : zt, U = S === "y" ? "height" : "width", tt = A[S], at = tt + m[J], rt = tt - m[q], y = g ? -H[U] / 2 : 0, R = _ === Le ? z[U] : H[U], L = _ === Le ? -H[U] : -z[U], F = e.elements.arrow, V = g && F ? Io(F) : {
        width: 0,
        height: 0
      }, W = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Ts(), X = W[J], Y = W[q], G = wn(0, z[U], V[U]), K = C ? z[U] / 2 - y - G - X - $.mainAxis : R - G - X - $.mainAxis, Z = C ? -z[U] / 2 + y + G + Y + $.mainAxis : L + G + Y + $.mainAxis, dt = e.elements.arrow && Pn(e.elements.arrow), I = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = (D = k == null ? void 0 : k[S]) != null ? D : 0, j = tt + K - Nt - I, xt = tt + Z - Nt, Ft = wn(g ? Jn(at, j) : at, tt, g ? ve(rt, xt) : rt);
      A[S] = Ft, B[S] = Ft - tt;
    }
    if (l) {
      var ce, Et = S === "x" ? Ct : Ot, An = S === "x" ? Vt : zt, Ut = A[b], Ee = b === "y" ? "height" : "width", de = Ut + m[Et], Se = Ut - m[An], Te = [Ct, Ot].indexOf(E) !== -1, Ce = (ce = k == null ? void 0 : k[b]) != null ? ce : 0, pe = Te ? de : Ut - z[Ee] - H[Ee] - Ce + $.altAxis, qe = Te ? Ut + z[Ee] + H[Ee] - Ce - $.altAxis : Se, In = g && Te ? hf(pe, Ut, qe) : wn(g ? pe : de, Ut, g ? qe : Se);
      A[b] = In, B[b] = In - Ut;
    }
    e.modifiersData[r] = B;
  }
...
function Jf(t, e, n) {
  ...
  jo(a)) && (l = qf(e)), jt(e) ? (c = Ue(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Bo(a))), {
        ...
        if (!w) {
          ...
          if (Ha(_, C)) {
            ...
            for (var S = 0; S < p.orderedModifiers.length; S++) {
              ...
              var b = p.orderedModifiers[S], A = b.fn, z = b.options, H = z === void 0 ? {} : z, O = b.name;
              typeof A == "function" && (p = A({
                state: p,
                options: H,
                name: O,
                instance: g
...
const dm = () => xo({
  ...
  } = e, m = kt(e, im), E = M.useRef(null), _ = xe(E, n), C = M.useRef(null), S = xe(C, w), b = M.useRef(S);
  ze(() => {
    b.current = S;
  }, [S]), M.useImperativeHandle(w, () => C.current, []);
  const A = lm(p, i), [z, H] = M.useState(A), [O, $] = M.useState(Zn(o));
  M.useEffect(() => {
...
var mm = function(e) {
  return e.scrollTop;
}, cn = "unmounted", fe = "exited", me = "entering", Ie = "entered", io = "exiting", ee = /* @__PURE__ */ function(t) {
  wm(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var i = o, l = i && !i.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = fe, a.appearStatus = me) : c = Ie : r.unmountOnExit || r.mountOnEnter ? c = cn : c = fe, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== me && i !== Ie && (a = me) : (i === me || i === Ie) && (a = io);
    }
...
const vm = {
  ...
  const {
    ...
    TransitionComponent: m = hm
  } = e, E = kt(e, bm), _ = sn(), C = M.useRef(), S = As(), b = M.useRef(null), A = xe(b, a.ref, n), z = (q) => (U) => {
    if (q) {
      const tt = b.current;
...
Vo.muiSupportAuto = !0;
const Wa = Vo, ym = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], xm = Rn($s, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ms(), a = _o({
    ...
    slots: C,
    slotProps: S
  } = a, b = kt(a, ym), A = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, z = P({
    anchorEl: i,
    container: p,
    disablePortal: h,
    keepMounted: w,
...
const Bs = /* @__PURE__ */ M.forwardRef(function(e, n) {
  ...
  const A = _o({
    ...
    slots: Z = {},
    title: dt,
    TransitionComponent: I = Wa,
    TransitionProps: Nt
  } = A, j = kt(A, Em), xt = /* @__PURE__ */ M.isValidElement(H) ? H : /* @__PURE__ */ s("span", {
    children: H
  }), Ft = As(), ce = Ft.direction === "rtl", [Et, An] = M.useState(), [Ut, Ee] = M.useState(null), de = M.useRef(!1), Se = J || rt, Te = sn(), Ce = sn(), pe = sn(), qe = sn(), [In, zo] = is({
    controlled: W,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const kr = as(y), Ke = M.useRef(), Mn = eo(() => {
  ...
  const Lo = (Q) => {
    ...
    onFocus: Fs,
    ref: Us
  } = ss(), [, Go] = M.useState(!1), Ho = (Q) => {
    Ls(Q), Uo.current === !1 && (Go(!1), Fo(Q));
  }, Xo = (Q) => {
    Et || An(Q.currentTarget), Fs(Q), Uo.current === !0 && (Go(!0), Er(Q));
  }, Yo = (Q) => {
    de.current = !0;
    const Pt = xt.props;
...
`));
  const Ws = M.useMemo(() => {
    ...
    touch: de.current
  }), Cr = Tm(Qe), Ko = (r = (o = Z.popper) != null ? o : O.Popper) != null ? r : Cm, Jo = (a = (i = (l = Z.transition) != null ? l : O.Transition) != null ? i : I) != null ? a : Wa, Zo = (c = (d = Z.tooltip) != null ? d : O.Tooltip) != null ? c : Om, Qo = (p = (h = Z.arrow) != null ? h : O.Arrow) != null ? p : Rm, qs = ln(Ko, P({}, G, (w = K.popper) != null ? w : $.popper, {
    className: be(Cr.popper, G == null ? void 0 : G.className, (g = (v = K.popper) != null ? v : $.popper) == null ? void 0 : g.className)
  }), Qe), Ks = ln(Jo, P({}, Nt, (f = K.transition) != null ? f : $.transition), Qe), Js = ln(Zo, P({}, (m = K.tooltip) != null ? m : $.tooltip, {
  ...
  const {
    ...
    jl,
    {
      ...
      children: n ? /* @__PURE__ */ x(ie, { children: [
        ...
        h ? /* @__PURE__ */ s(ii, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(vs, {}) }) : Ka(i, n, !1)
      ] }) : m
    }
  );
...
function zs(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: i } = At(() => {
...
function jm({
  ...
  const [c, d] = ut(!1), [p, h] = ut(!1), w = Tt(() => {
    c && d(!1), h(!1);
  }, [c]), g = Tt((S) => {
    S.stopPropagation(), d((b) => {
      const A = !b;
      return A && S.shiftKey ? h(!0) : A || h(!1), A;
    });
  }, []), v = Tt(
    (S) => (w(), r(S)),
    [r, w]
  ...
  ae(() => {
    if (c) {
      ...
      if (S) {
        const b = S.getBoundingClientRect(), A = window.scrollY, z = window.scrollX, H = b.top + A + S.clientHeight, O = b.left + z;
        m({ top: H, left: O });
      }
    }
  }, [c, o]);
  const [E] = lo(
    ...
    Tt(async () => (t == null ? void 0 : t(!0)) ?? n ?? E, [t, n, E, c]),
    n ?? E
  ), C = p && _ ? _ : E;
  return /* @__PURE__ */ x(ie, { children: [
    /* @__PURE__ */ s(
...
const Vh = _t.Root, Hm = T.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  _t.List,
  {
    ref: n,
    className: N(
...
Hm.displayName = _t.List.displayName;
...
Xm.displayName = _t.Trigger.displayName;
...
Ym.displayName = _t.Content.displayName;
function zh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
...
function Hh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ x(fo, { children: [
    /* @__PURE__ */ s(mi, { asChild: !0, children: /* @__PURE__ */ s(Wm, {}) }),
    /* @__PURE__ */ s(rr, { children: e.map((n) => /* @__PURE__ */ x("div", { children: [
      /* @__PURE__ */ s(Sn, { children: n.label }),
      /* @__PURE__ */ s(pc, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(mo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(gi, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(or, {})
    ] }, n.label)) })
  ] }) });
}
