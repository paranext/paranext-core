...
var Wn = (t, e, r) => e in t ? Hn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var vt = (t, e, r) => Wn(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as ze, Dialog as Bt, Popover as Qe, Label as Jn, RadioGroup as Xr, Tooltip as Oe, ToggleGroup as Eo, Separator as Zn, Avatar as ha, DropdownMenu as gt, Select as xt, Checkbox as ja, Tabs as Pt, Menubar as qt, ContextMenu as ht, Progress as Fa, Slider as lr, Switch as Ba } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as Qn, IconCheck as Te, IconSearch as ti, IconChevronRight as fa, IconChevronDown as ei, IconChevronUp as ri, IconSelector as ai, IconLayoutSidebar as oi, IconLayoutSidebarRight as ni, IconLoader as ii, IconAlertOctagon as si, IconAlertTriangle as ci, IconInfoCircle as li, IconCircleCheck as di } from "@tabler/icons-react";
import { Canon as lt } from "@sillsdev/scripture";
import { includes as dr, Section as W, getChaptersForBook as wi, formatScrRef as Ne, getSectionForBook as Xe, formatRelativeDate as ui, formatReplacementString as _e, sanitizeHtml as pi, NumberFormat as gi, formatBytes as hi, getCurrentLocale as fi, usfmMarkers as fr, getFormatCallerFunction as mi, deepEqual as vi, isString as Ua, compareScrRefs as Jr, scrRefToBBBCCCVVV as Ar, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
import { Check as Ue, Clock as Ka, ChevronsLeft as qa, ChevronsRight as Ga, ChevronLeft as Zr, ChevronRight as Qr, ArrowLeft as bi, ArrowRight as xi, ChevronDown as Sr, BoldIcon as yi, ItalicIcon as ki, X as or, AtSign as zo, Pencil as _i, Trash2 as Ni, ArrowUp as To, MoreHorizontal as Ci, MailOpen as Ei, Mail as zi, ChevronUp as Ti, FilterIcon as Si, ArrowLeftIcon as Ri, ChevronLeftIcon as Di, ChevronRightIcon as $i, ArrowRightIcon as Mi, Copy as So, Filter as Oi, User as Ii, Link as Ai, CircleHelp as Pi, ChevronsUpDown as Ro, Star as Li, Undo as Vi, Redo as ji, SquareX as Do, FunctionSquare as $o, SquareSigma as Mo, Ban as Fi, AlertCircle as ta, CircleCheckIcon as Bi, CircleXIcon as Ui, CircleHelpIcon as Ki, ArrowUpIcon as qi, ArrowDownIcon as Gi, ScrollText as Hi, Search as Wi, MenuIcon as Yi, Menu as Xi, EllipsisVertical as Ji, MoreVertical as Ha, LoaderCircle as Zi } from "lucide-react";
import rt, { forwardRef as nr, useRef as G, useMemo as j, useState as S, useCallback as F, useLayoutEffect as Mt, createContext as Rr, useContext as ma, useEffect as H, Component as Qi, createElement as Wa, Suspense as ts, Fragment as Oo } from "react";
import { createEditor as Io, $getRoot as Jt, $createParagraphNode as Ke, $getSelection as Et, HISTORY_MERGE_TAG as va, ParagraphNode as Ao, TextNode as Po, $isTokenOrSegmented as es, $getCharacterOffsets as rs, $cloneWithPropertiesEphemeral as as, $getPreviousSelection as os, $isRangeSelection as Ut, $caretFromPoint as ns, $getSiblingCaret as Lo, $getChildCaret as is, $getAdjacentChildCaret as ss, $isChildCaret as cs, $normalizeCaret as ls, $setSelectionFromCaretRange as ds, $getCollapsedCaretRange as ws, $getCaretInDirection as Ya, $splitAtPointCaretNext as us, $isTextPointCaret as ps, $findMatchingParent as Vo, $isElementNode as Yt, mergeRegister as Zt, getDOMTextNode as gs, isHTMLElement as jo, CLEAR_EDITOR_COMMAND as Fo, COMMAND_PRIORITY_EDITOR as ba, shallowMergeConfig as hs, defineExtension as Ot, safeCast as Se, createState as fs, FORMAT_TEXT_COMMAND as Bo, $isNodeSelection as Uo, COMMAND_PRIORITY_LOW as Ko, RootNode as ms, LineBreakNode as vs, TabNode as bs, $isEditorState as xs, createCommand as ys, CLICK_COMMAND as ks, isDOMNode as _s, $getNodeFromDOMNode as Ns, $createNodeSelection as Cs, $setSelection as Es, $getEditor as zs, DecoratorNode as ea, $getState as Ts, toggleTextFormatType as Xa, TEXT_TYPE_TO_FORMAT as Ss, $setState as Rs, addClassNamesToElement as qo, $create as Ds, $getNodeByKey as $s, removeClassNamesFromElement as Ms, KEY_TAB_COMMAND as Os, $isBlockElementNode as xr, $createRangeSelection as Is, $normalizeSelection__EXPERIMENTAL as As, OUTDENT_CONTENT_COMMAND as Ps, INDENT_CONTENT_COMMAND as Ja, INSERT_TAB_COMMAND as Ls, COMMAND_PRIORITY_CRITICAL as xa, $isDecoratorNode as Vs, $isParagraphNode as js, $isTextNode as yr, SELECTION_CHANGE_COMMAND as Go, getRegisteredNode as Fs, isDocumentFragment as Za, isDOMDocumentNode as Bs, ArtificialNode__DO_NOT_USE as Ho, $createLineBreakNode as Wo, $isRootOrShadowRoot as Us, isBlockDomNode as Qa, isInlineDomNode as to, $insertNodes as Ks } from "lexical";
import { HeadingNode as qs, QuoteNode as Gs, registerRichText as Hs } from "@lexical/rich-text";
import { flushSync as Ws, createPortal as Ys } from "react-dom";
import { $isTableSelection as Xs } from "@lexical/table";
import { createHeadlessEditor as Yo } from "@lexical/headless";
import { useReactTable as Xo, getFilteredRowModel as Js, getSortedRowModel as Jo, getPaginationRowModel as Zs, getCoreRowModel as Zo, flexRender as Je, getGroupedRowModel as Qs, getExpandedRowModel as tc } from "@tanstack/react-table";
import ec from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ra, HIDDEN_NOTE_CALLER as aa, getDefaultViewOptions as rc, isInsertEmbedOpOfType as wr, Editorial as ac } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as oc } from "react-hotkeys-hook";
import { Drawer as he } from "vaul";
import * as ya from "react-resizable-panels";
import { useTheme as nc } from "next-themes";
import { Toaster as ic } from "sonner";
...
function sc(t) {
  ...
  const e = oa(t), r = e.findIndex((i) => i.startsWith("-tw-"));
  if (r !== -1) {
    const i = e[r].slice(4);
...
function cc(t, e) {
  ...
  const r = oa(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = oa(e), s = i.some((l) => l.startsWith("-tw-")), c = i.some((l) => l.startsWith("!tw-"));
  if (s && n.startsWith("-")) {
    const l = n.slice(1);
    return [...o, `-tw-${l}`].join(":");
  }
...
function f(...t) {
  ...
  }), Xn(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? cc(l, d) : l;
  }).join(" ");
}
const qe = 250, Qo = 300, lc = 400, dc = 450, wc = 500, tn = te(
...
function V({
  ...
  return /* @__PURE__ */ a(
    i,
    {
      ...
      "data-variant": e,
      "data-size": r,
      className: f(tn({ variant: e, size: r, className: t })),
      ...n
    }
  );
}
const uc = "layoutDirection";
function ct() {
  const t = localStorage.getItem(uc);
  return t === "rtl" ? t : "ltr";
}
function pc({ ...t }) {
  return /* @__PURE__ */ a(Bt.Root, { "data-slot": "dialog", ...t });
}
function du({ ...t }) {
  return /* @__PURE__ */ a(Bt.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function gc({ ...t }) {
  return /* @__PURE__ */ a(Bt.Portal, { "data-slot": "dialog-portal", ...t });
}
function wu({ ...t }) {
  return /* @__PURE__ */ a(Bt.Close, { "data-slot": "dialog-close", ...t });
}
function hc({
  className: t,
...
function fc({
  ...
  const s = ct();
  return /* @__PURE__ */ u(gc, { children: [
    /* @__PURE__ */ a(hc, { className: o }),
    /* @__PURE__ */ u(
      Bt.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ a(Bt.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ u(V, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ a(Qn, {}),
...
function uu({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ a(Bt.Close, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function sr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(bc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Ee.Input,
        {
      ...
      /* @__PURE__ */ a(yc, { children: /* @__PURE__ */ a(ti, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const an = lt.allBookIds.filter(
  (t) => !lt.isObsolete(lt.bookIdToNumber(t))
), Ce = Object.fromEntries(
  an.map((t) => [t, lt.bookIdToEnglishName(t)])
);
function _a(t, e, r) {
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        children: /* @__PURE__ */ u(
          ...
          {
            ref: d,
            value: l || `${t} ${lt.bookIdToEnglishName(t)}`,
            onSelect: g,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
function re({ ...t }) {
  return /* @__PURE__ */ a(Qe.Root, { "data-slot": "popover", ...t });
}
function ve({ ...t }) {
  return /* @__PURE__ */ a(Qe.Trigger, { "data-slot": "popover-trigger", ...t });
}
function ae({
  className: t,
  align: e = "center",
  ...
  const i = ct();
  return /* @__PURE__ */ a(Qe.Portal, { children: /* @__PURE__ */ a(
    Qe.Content,
    {
...
function Nc({ ...t }) {
  return /* @__PURE__ */ a(Qe.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function na(t, e, r) {
  return `${t} ${Ce[t]}${e ? ` ${ka(t, e)} ${Ie(t, e)}` : ""}${r ? ` ${r}` : ""}`;
}
function Cc({
  recentSearches: t,
  ...
  return /* @__PURE__ */ u(re, { open: w, onOpenChange: g, children: [
    /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(
      V,
      {
        ...
        className: l,
        "aria-label": n,
        children: /* @__PURE__ */ a(Ka, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ a(ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(fe, { children: /* @__PURE__ */ a(me, { children: /* @__PURE__ */ a(Qt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      ee,
      {
        onSelect: () => h(p),
        className: f("tw:flex tw:items-center", c),
        children: [
          /* @__PURE__ */ a(Ka, { className: "tw:mr-2 tw:h-4 tw:w-4 tw:opacity-50" }),
...
function vu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
  ...
  const o = Ec.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const p = ((m) => Object.keys(Ce).find(
            (x) => Ce[x].toLowerCase() === m.toLowerCase()
          ))(c);
...
function Tc(t, e, r, o) {
  const n = F(() => {
    if (t.chapterNum > 1)
      ...
      if (l > 0) {
        const d = e[l - 1], w = Math.max(Ft(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function ro({
  ...
  if (t)
    return /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Ft(t) }, (s, c) => c + 1).map((s) => /* @__PURE__ */ a(
      ee,
      {
        value: `${t} ${Ce[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function bu({
  ...
  const d = ct(), [w, g] = S(!1), [h, p] = S(""), [m, x] = S(""), [v, N] = S("books"), [b, _] = S(void 0), [k, I] = S(!1), L = G(void 0), M = G(void 0), C = G(void 0), T = G(void 0), z = G({}), O = F(
    (D) => {
      e(D), c && c(D);
    },
    [e, c]
  ), $ = j(() => o ? o() : an, [o]), q = j(() => ({
    [W.OT]: $.filter((E) => lt.isBookOT(E)),
    [W.NT]: $.filter((E) => lt.isBookNT(E)),
    [W.DC]: $.filter((E) => lt.isBookDC(E)),
    [W.Extra]: $.filter((E) => lt.extraBooks().includes(E))
  }), [$]), P = j(() => Object.values(q).flat(), [q]), Y = j(() => {
    if (!m.trim()) return q;
    const D = {
      [W.OT]: [],
      [W.NT]: [],
    ...
    (D) => {
      const E = v === "chapters" ? b : y == null ? void 0 : y.book;
      E && (O({
        book: E,
        chapterNum: D,
        verseNum: 1
    ...
    (D) => {
      ...
      g(D), D && (N("books"), _(void 0), x(""));
    },
    [v, yt]
  ), { otLong: it, ntLong: J, dcLong: wt, extraLong: mt } = {
    ...
    (D) => y ? !!y.chapterNum && !D.toString().includes(y.chapterNum.toString()) : !1,
    [y]
  ), De = j(
    () => Ne(
      t,
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: E, isDigit: A } = eo(D.key);
      if (v === "chapters") {
        if (D.key === "Backspace") {
          D.preventDefault(), D.stopPropagation(), yt();
          return;
        }
        if (E || A) {
          if (D.preventDefault(), D.stopPropagation(), N("books"), _(void 0), A && b) {
            const X = Ce[b];
            x(`${X} ${D.key}`);
          } else
            x(D.key);
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const X = v === "chapters" ? b : y == null ? void 0 : y.book;
        if (!X) return;
        const K = (() => {
          if (!h) return 1;
          const nt = h.match(/(\d+)$/);
          return nt ? parseInt(nt[1], 10) : 0;
        })(), ot = Ft(X);
        if (!ot) return;
        let tt = K;
        const at = 6;
        switch (D.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            tt = K === 0 ? ot : Math.max(1, K - at);
            break;
          case "ArrowDown":
            tt = K === 0 ? 1 : Math.min(ot, K + at);
            break;
          default:
            return;
        }
        tt !== K && (D.preventDefault(), D.stopPropagation(), p(na(X, n, tt)), setTimeout(() => {
          const nt = z.current[tt];
          nt && nt.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
      }
    },
    [
    ...
    const { isLetter: E, isDigit: A } = eo(D.key);
    (E || A) && (D.preventDefault(), x((X) => X + D.key), M.current.focus(), I(!1));
  }, []);
  return Mt(() => {
    const D = setTimeout(() => {
      if (w && v === "books" && C.current && T.current) {
        const E = C.current, A = T.current, X = A.offsetTop, K = E.clientHeight, ot = A.clientHeight, tt = X - K / 2 + ot / 2;
        E.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), p(na(t.book));
    ...
    if (v === "chapters" && b) {
      ...
      setTimeout(() => {
        if (C.current)
          if (D) {
            const E = z.current[t.chapterNum];
  ...
  }, [v, b, y, t.book, t.chapterNum]), /* @__PURE__ */ u(re, { open: w, onOpenChange: B, children: [
    /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(
      V,
      {
        ...
        children: /* @__PURE__ */ a("span", { className: "tw:truncate", children: De })
      }
    ) }),
    /* @__PURE__ */ a(ae, { id: l, forceMount: !0, className: "tw:w-[280px] tw:p-0", align: "center", children: /* @__PURE__ */ u(
      fe,
      {
        ref: L,
        onKeyDown: It,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ut.map(({ onClick: D, disabled: E, title: A, icon: X }) => /* @__PURE__ */ a(
              V,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ a(
              V,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ a(bi, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(xi, { className: "tw:h-4 tw:w-4" })
              }
            ),
            b && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ie(b, n) })
          ] }),
          !k && /* @__PURE__ */ u(me, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(st, { children: [
              !y && Object.entries(Y).map(([D, E]) => {
                if (E.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ a(Qt, { heading: ne(D), children: E.map((A) => /* @__PURE__ */ a(
                      on,
                      {
                        bookId: A,
                        onSelect: (X) => dt(X),
              ...
              y && /* @__PURE__ */ a(Qt, { children: /* @__PURE__ */ a(
                ee,
                {
                  ...
                  children: Ne(
                    ...
                    n ? ka(y.book, n) : void 0
                  )
                },
                "top-match"
              ) }),
              y && Ft(y.book) > 1 && /* @__PURE__ */ u(st, { children: [
                /* @__PURE__ */ a("div", { className: "tw:mb-2 tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: Ie(y.book, n) }),
                /* @__PURE__ */ a(
                  ro,
                  {
                    bookId: y.book,
...
function sa({
  ...
  const [_, k] = S(!1), I = d ?? l, L = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], M = (C, T) => {
    const z = l(C), O = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, $ = `${T ?? ""}${z}${O ?? ""}`;
    return /* @__PURE__ */ u(
      ee,
      {
        value: z,
  ...
  return /* @__PURE__ */ u(re, { open: _, onOpenChange: k, ...b, children: [
    ...
    /* @__PURE__ */ a(
      ae,
      {
        ...
        children: /* @__PURE__ */ u(fe, { children: [
          ...
          /* @__PURE__ */ a(Dr, { children: p }),
          /* @__PURE__ */ a(me, { children: L(e) ? e.map((C) => /* @__PURE__ */ a(Qt, { heading: C.groupHeading, children: C.options.map((T) => M(T, C.groupHeading)) }, C.groupHeading)) : e.map((C) => M(C)) })
        ] })
      }
    )
  ] });
...
var ca = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(ca || {});
((t) => {
...
function ku({
  ...
  const w = Lr(d, "%webView_bookSelector_currentBook%"), g = Lr(d, "%webView_bookSelector_choose%"), h = Lr(d, "%webView_bookSelector_chooseBooks%"), [p, m] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    m(v), t(v);
    ...
    nn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(pt, { className: "tw:flex tw:items-center", children: o.map((v) => lt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            V,
            {
...
const cn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $c = cn ? Mt : H, ur = { tag: va };
function Mc({ initialConfig: t, children: e }) {
  const r = j(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Dc(null, o), w = Io({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
        if (h === void 0) g.update(() => {
          ...
          if (p.isEmpty()) {
            const m = Ke();
            p.append(m);
            const x = cn ? document.activeElement : null;
            (Et() !== null || x !== null && x === g.getRootElement()) && m.select();
          }
        }, ur);
  ...
  }, []), a(sn.Provider, { value: r, children: e });
}
const Oc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Ic({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Gt();
  return Oc(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(va) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const Na = {
...
function _t({ ...t }) {
  return /* @__PURE__ */ a(Oe.Root, { "data-slot": "tooltip", ...t });
}
function Nt({
  className: t,
  variant: e,
  ...
  return /* @__PURE__ */ a(
    Oe.Trigger,
    {
      ...
      className: e ? f(tn({ variant: e }), t) : t,
      ...r
    }
  );
}
function Ct({
  ...
  return /* @__PURE__ */ a(Oe.Portal, { children: /* @__PURE__ */ u(
    Oe.Content,
    {
      ...
      children: [
        o,
        /* @__PURE__ */ a(Oe.Arrow, { className: "tw:z-50 tw:size-2.5 tw:translate-y-[calc(-50%_-_2px)] tw:rotate-45 tw:rounded-[2px] tw:bg-foreground tw:fill-foreground" })
      ]
    }
  ) });
}
...
class Pc extends Qi {
  constructor(e) {
    super(e), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Vr;
  }
...
function Vc({ children: t, onError: e }) {
  return a(Pc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const jc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Fc(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Bc() {
  return function(t) {
    const [e] = Gt(), r = j(() => t(e), [e, t]), [o, n] = S(() => r.initialValueFn()), i = G(o);
    return jc(() => {
...
function Uc(t, e) {
  ...
  for (let d = 0; d < l; d++) {
    const w = s[d], g = c && c.top <= w.top && c.top + c.height > w.top && c.left + c.width > w.left, h = w.width + i === o.width;
    g || h ? (s.splice(d--, 1), l--) : c = w;
  }
  return s;
}
function Kc(t, e, r = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !es(e) && o !== null) {
    const [n, i] = o, s = t.isBackward(), c = n.getNode(), l = i.getNode(), d = e.is(c), w = e.is(l);
    if (d || w) {
      const [g, h] = rs(t), p = c.is(l), m = e.is(s ? l : c), x = e.is(s ? c : l);
      let v, N = 0;
      p ? (N = g > h ? h : g, v = g > h ? g : h) : m ? (N = s ? h : g, v = void 0) : x && (N = 0, v = s ? g : h);
      const b = e.__text.slice(N, v);
      b !== e.__text && (r === "clone" && (e = as(e)), e.__text = b);
    }
  }
  return e;
}
...
const ln = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, qc = ln && "documentMode" in document ? document.documentMode : null;
!(!ln || !("InputEvent" in window) || qc) && "getTargetRanges" in new window.InputEvent("input");
function jt(t) {
  return `${t}px`;
}
const Gc = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
function Hc(t, e, r) {
  let o = null, n = null, i = null, s = [];
  const c = document.createElement("div");
  function l() {
    o === null && kr(182), n === null && kr(183);
    const { left: g, top: h } = n.getBoundingClientRect(), p = Uc(t, e);
    var m, x;
    c.isConnected || (x = c, (m = n).insertBefore(x, m.firstChild));
    let v = !1;
    for (let N = 0; N < p.length; N++) {
      const b = p[N], _ = s[N] || document.createElement("div"), k = _.style;
      k.position !== "absolute" && (k.position = "absolute", v = !0);
      const I = jt(b.left - g);
      k.left !== I && (k.left = I, v = !0);
      const L = jt(b.top - h);
      k.top !== L && (_.style.top = L, v = !0);
      const M = jt(b.width);
  ...
  const w = t.registerRootListener(function g() {
    ...
    d(), o = h, n = p, i = new MutationObserver((m) => {
      ...
      if (x !== o || v !== n) return g();
      for (const N of m) if (!c.contains(N.target)) return l();
    }), i.observe(p, Gc), l();
  });
  return () => {
    w(), d();
...
function ao(t, e, r) {
  ...
  return [gs(r) || r, t.offset];
}
function Wc(t) {
  for (const e of t) {
    const r = e.style;
    r.background !== "Highlight" && (r.background = "Highlight"), r.color !== "HighlightText" && (r.color = "HighlightText"), r.marginTop !== jt(-1.5) && (r.marginTop = jt(-1.5)), r.paddingTop !== jt(4) && (r.paddingTop = jt(4)), r.paddingBottom !== jt(0) && (r.paddingBottom = jt(0));
  }
}
function Yc(t, e = Wc) {
  ...
  function d(w) {
    w.read(() => {
      const g = Et();
      if (!Ut(g)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, p] = function(C) {
        const T = C.getStartEndPoints();
        return C.isBackward() ? [T[1], T[0]] : T;
      }(g), m = h.getNode(), x = m.getKey(), v = h.offset, N = p.getNode(), b = N.getKey(), _ = p.offset, k = t.getElementByKey(x), I = t.getElementByKey(b), L = r === null || k !== o || v !== n || x !== r.getKey(), M = i === null || I !== s || _ !== c || b !== i.getKey();
      if ((L || M) && k !== null && I !== null) {
        const C = function(T, z, O, $, q, P, Y) {
          const y = (T._window ? T._window.document : document).createRange();
          return y.setStart(...ao(z, O, $)), y.setEnd(...ao(q, P, Y)), y;
        }(t, h, m, k, p, N, I);
        l(), l = Hc(t, C, e);
      }
      r = m, o = k, n = v, i = N, s = I, c = _;
    });
  }
...
function Xc(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = Yc(t, e));
  };
...
function Jc(t) {
  const e = Vo(t, (r) => Yt(r) && !r.isInline());
  return Yt(e) || kr(4, t.__key), e;
}
function Zc(t) {
  const e = Et() || os();
  let r;
  if (Ut(e)) r = ns(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Lo(c, "next"));
    }
    r = r || is(Jt(), "previous").getFlipped().insert(Ke());
  }
  const o = Qc(t, r), n = ss(o), i = cs(n) ? ls(n) : o;
  return ds(ws(i)), t.getLatest();
}
function Qc(t, e, r) {
  let o = Ya(e, "next");
  for (let n = o; n; n = us(n, r)) o = n;
  return ps(o) && kr(283), o.insert(t.isInline() ? Ke().append(t) : t), Ya(Lo(t.getLatest(), "next"), e.direction);
}
function tl(t) {
  const e = Et();
  if (!Ut(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Vo(i, (d) => Yt(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
const el = Symbol.for("preact-signals");
function $r() {
  ...
  for (!function() {
    ...
    let r = Ze;
    for (Ze = void 0, Nr++; r !== void 0; ) {
      const o = r.u;
      if (r.u = void 0, r.f &= -3, !(8 & r.f) && dn(r)) try {
        r.c();
      } catch (n) {
        e || (t = n, e = !0);
      }
...
let _r, Xt = 0, Nr = 0, al = 0, la = 0, mr = 0;
function no(t) {
  if (Z === void 0) return;
  let e = t.n;
...
function ye(t, e) {
  bt.call(this, void 0), this.x = t, this.s = void 0, this.g = mr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function ol(t, e) {
  return new ye(t, e);
}
...
function nl(t) {
  ...
  wn(this), Z = t, this.f &= -2, 8 & this.f && Ea(this), $r();
}
function Me(t, e) {
...
bt.prototype.brand = el, bt.prototype.h = function() {
  return !0;
  ...
  if (this.t !== void 0) {
    const e = t.e, r = t.x;
    e !== void 0 && (e.x = r, t.e = void 0), r !== void 0 && (r.e = e, t.x = void 0), t === this.t && (this.t = r, r === void 0 && oo(() => {
      var o;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Xt !== 0 && Nr === 0 && e.l !== la && (e.l = la, _r = { S: e, v: e.v, i: e.i, o: _r });
    })(this), this.v = t, this.i++, mr++, Xt++;
    try {
...
} }), ye.prototype = new bt(), ye.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === mr)) return !0;
  if (this.g = mr, this.f |= 1, this.i > 0 && !dn(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    io(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, un(this), io(this), Xt++;
  const t = Z;
  return Z = this, nl.bind(this, t);
}, Me.prototype.N = function() {
  2 & this.f || (this.f |= 2, this.u = Ze, Ze = this);
}, Me.prototype.d = function() {
  this.f |= 8, 1 & this.f || Ea(this);
}, Me.prototype.dispose = function() {
  this.d();
};
Ot({ build: (t, e, r) => Ge(e), config: Se({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Kt(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
function pn() {
  const t = Jt(), e = Et(), r = Ke();
  t.clear(), t.append(r), e !== null && r.select(), Ut(e) && (e.format = 0);
}
function gn(t, e = pn) {
  return t.registerCommand(Fo, (r) => (t.update(e), !0), ba);
}
Ot({ build: (t, e, r) => Ge(e), config: Se({ $onClear: pn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Kt(() => gn(t, o.value));
} });
function il(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const jr = fs("format", { parse: (t) => typeof t == "number" ? t : 0 });
class hn extends ea {
  $config() {
    return this.config("decorator-text", { extends: ea, stateConfigs: [{ flat: !0, stateConfig: jr }] });
  }
  getFormat() {
    return Ts(this, jr);
  }
  getFormatFlags(e, r) {
    return Xa(this.getFormat(), e, r);
  }
  hasFormat(e) {
    const r = Ss[e];
  ...
  toggleFormat(e) {
    const r = this.getFormat(), o = Xa(r, e, null);
...
Ot({ name: "@lexical/extension/DecoratorText", nodes: () => [hn], register: (t, e, r) => t.registerCommand(Bo, (o) => {
  const n = Et();
  if (Uo(n) || Ut(n)) for (const i of n.getNodes()) sl(i) && i.toggleFormat(o);
  return !1;
}, Ko) });
function fn(t, e) {
  let r;
...
const da = Ot({ build: (t) => fn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function mn(t, e) {
  if (t && e && !Array.isArray(e) && typeof t == "object" && typeof e == "object") {
    const r = t, o = e;
    for (const n in o) r[n] = mn(r[n], o[n]);
    return t;
  }
  return e;
}
const za = 0, wa = 1, vn = 2, Fr = 3, pr = 4, $e = 5, Br = 6, We = 7;
function Ur(t) {
  return t.id === za;
}
function bn(t) {
...
function cl(t) {
  return function(e) {
    return e.id === wa;
  }(t) || et(305, String(t.id), String(wa)), Object.assign(t, { id: vn });
}
...
class dl {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, l, d) {
      return Object.assign(c, { config: l, id: Fr, registerState: d });
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== pr && et(307, String(r.id), String($e)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
    const n = { ...r.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, c) {
      return Object.assign(i, { id: $e, output: s, registerState: c });
    }(r, o, n);
  }
  register(e, r) {
    this._signal = r;
    const o = this.state;
    o.id !== $e && et(308, String(o.id), String($e));
    const n = this.extension.register && this.extension.register(e, o.config, o.registerState);
    return this.state = function(i) {
      return Object.assign(i, { id: Br });
    }(o), () => {
      const i = this.state;
      i.id !== We && et(309, String(o.id), String(We)), this.state = function(s) {
        return Object.assign(s, { id: $e });
      }(i), n && n();
    };
  }
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Br && et(310, String(r.id), String(Br)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
      return Object.assign(n, { id: We });
    }(r), o;
  }
  getSignal() {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= pr;
    }(e) || et(313, String(e.id), String(pr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Fr;
    }(e) || et(314, String(e.id), String(Fr)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
function wl() {
  const t = Jt();
  t.isEmpty() && t.append(Ke());
}
const ul = Ot({ config: Se({ setOptions: so, updateOptions: so }), init: ({ $initialEditorState: t = wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (xs(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [ms, Po, vs, bs, Ao] }), co = Symbol.for("@lexical/extension/LexicalBuilder");
function lo() {
}
function pl(t) {
  throw t;
...
class Ae {
  constructor(e) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Kr, this.roots = e;
  ...
  static maybeFromEditor(e) {
    const r = e[co];
    return r && (r.PACKAGE_VERSION !== Kr && et(292, r.PACKAGE_VERSION, Kr), r instanceof Ae || et(293)), r;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...o } = this.buildCreateEditorArgs(), n = Object.assign(Io({ ...o, ...r ? { onError: (i) => {
      r(i, n);
    } } : {} }), { [co]: this });
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && et(298, o.name), !n) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ur(i) || et(300, s, n || "[unknown]"), Ur(c = i) || et(304, String(c.id), String(za)), i = Object.assign(c, { id: wa }), o.state = i;
    ...
    for (const o of this.extensionNameMap.values()) Ur(o.state) && r(o);
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = pl), e;
  }
}
const gl = /* @__PURE__ */ new Set(), wo = Ot({ build(t, e, r) {
  const o = r.getDependency(da).output, n = tr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = fn(() => {
  }, () => Kt(() => {
    const s = i.peek(), { watchedNodeKeys: c } = n.value;
    let l, d = !1;
    o.value.read(() => {
      if (Et()) for (const [w, g] of c.entries()) {
        if (g.size === 0) {
          c.delete(w);
          continue;
        }
        const h = $s(w), p = h && h.isSelected() || !1;
        d = d || p !== (!!s && s.has(w)), p && (l = l || /* @__PURE__ */ new Set(), l.add(w));
      }
    }), !d && l && s && l.size === s.size || (i.value = l);
  }));
  return { watchNodeKey: function(s) {
    const c = ol(() => (i.value || gl).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(s, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [da], name: "@lexical/extension/NodeSelection" }), hl = ys("INSERT_HORIZONTAL_RULE_COMMAND");
class Le extends ea {
  static getType() {
...
Ot({ dependencies: [da, wo], name: "@lexical/extension/HorizontalRule", nodes: () => [Le], register(t, e, r) {
  ...
  return Zt(t.registerCommand(hl, (s) => {
    const c = Et();
    if (!Ut(c)) return !1;
    ...
    return !0;
  }, ba), t.registerCommand(ks, (s) => {
    if (_s(s.target)) {
      const c = Ns(s.target);
      if (ml(c)) return function(l, d = !1) {
        const w = Et(), g = l.isSelected(), h = l.getKey();
        let p;
        d && Uo(w) ? p = w : (p = Cs(), Es(p)), g ? p.delete(h) : p.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Ko), t.registerMutationListener(Le, (s, c) => {
    rl(() => {
      let l = !1;
      const { nodeSelections: d } = n.peek();
      for (const [w, g] of s.entries()) if (g === "destroyed") d.delete(w), l = !0;
      else {
        const h = d.get(w), p = t.getElementByKey(w);
        h ? h.domNode.value = p : (l = !0, d.set(w, { domNode: tr(p), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Kt(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(Kt(() => {
      const d = c.value;
      d && (l.value ? qo(d, i) : Ms(d, i));
    }));
    return Zt(...s);
  }));
} });
Ot({ build: (t, e) => Ge({ inheritEditableFromParent: e.inheritEditableFromParent }), config: Se({ $getParentEditor: function() {
  const t = zs();
...
Ot({ build: (t, e, r) => Ge(e), config: Se({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Kt(() => {
...
function vl(t, e, r = xn) {
  return Zt(t.registerCommand(Os, (o) => {
    const n = Et();
    if (!Ut(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => xr(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), g = Jc(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Is();
        if (p.anchor.set(h, 0, "element"), p.focus.set(h, 0, "element"), p = As(p), p.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Ps : Ja : Ls;
    return t.dispatchCommand(i, void 0);
  }, ba), t.registerCommand(Ja, () => {
...
Ot({ build: (t, e, r) => Ge(e), config: Se({ $canIndent: xn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Kt(() => {
    if (!o.value) return vl(t, n, i);
  });
} });
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (Ut(m)) {
                const x = m.anchor;
                let v = x.getNode(), N = 0, b = 0;
                if (yr(v) && d >= 0 && w >= 0 && (N = d, b = d + w, m.setTextNodeRange(v, N, v, b)), N === b && g === "" || (m.insertRawText(g), v = x.getNode()), yr(v)) {
                  N = h, b = h + p;
                  const _ = v.getTextContentSize();
                  N = N > _ ? _ : N, b = b > _ ? _ : b, m.setTextNodeRange(v, N, v, b);
                }
...
Ot({ build: (t, e, r) => Ge(e), config: Se({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Kt(() => r.getOutput().disabled.value ? void 0 : kn(t)) });
function _l(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Nl({ editor: t, ErrorBoundary: e }) {
  return function(r, o) {
    const [n, i] = S(() => r.getDecorators());
    return Sa(() => r.registerDecoratorListener((s) => {
      Ws(() => {
        i(s);
      });
    }), [r]), H(() => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(ts, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(Ys(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Cl({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    const o = Ae.maybeFromEditor(r);
    if (o && o.hasExtensionByName(bl.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && _l(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Nl, { editor: t, ErrorBoundary: e });
}
function uo(t) {
  return t.getEditorState().read(yn(t.isComposing()));
}
function El({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = Gt();
  return function(n) {
    Sa(() => Zt(Hs(n), kn(n)), [n]);
  }(o), u(st, { children: [t, a(zl, { content: e }), a(Cl, { editor: o, ErrorBoundary: r })] });
}
function zl({ content: t }) {
  const [e] = Gt(), r = function(n) {
    const [i, s] = S(() => uo(n));
    return Sa(() => {
      function c() {
        const l = uo(n);
      ...
      return c(), Zt(n.registerUpdateListener(() => {
        c();
...
function Rl({ onClear: t }) {
  const [e] = Gt();
  return Sl(() => gn(e, t), [e, t]), null;
}
const _n = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : H;
function Dl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: x, role: v = "textbox", spellCheck: N = !0, style: b, tabIndex: _, "data-testid": k, ...I }, L) {
  const [M, C] = S(t.isEditable()), T = F((O) => {
    O && O.ownerDocument && O.ownerDocument.defaultView ? t.setRootElement(O) : t.setRootElement(null);
  }, [t]), z = j(() => /* @__PURE__ */ function(...O) {
    return ($) => {
      for (const q of O) typeof q == "function" ? q($) : q != null && (q.current = $);
    };
  }(L, T), [T, L]);
  return _n(() => (C(t.isEditable()), t.registerEditableListener((O) => {
    C(O);
  })), [t]), a("div", { "aria-activedescendant": M ? e : void 0, "aria-autocomplete": M ? r : "none", "aria-controls": M ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": M && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": M ? g : void 0, "aria-readonly": !M || void 0, "aria-required": h, autoCapitalize: p, className: m, contentEditable: M, "data-testid": k, id: x, ref: z, role: v, spellCheck: N, style: b, tabIndex: _, ...I });
}
const $l = nr(Dl);
function po(t) {
  return t.getEditorState().read(yn(t.isComposing()));
...
const Ml = nr(Ol);
function Ol(t, e) {
  const { placeholder: r, ...o } = t, [n] = Gt();
  return u(st, { children: [a($l, { editor: n, ...o, ref: e }), r != null && a(Il, { editor: n, content: r })] });
}
...
function Pl({
  ...
  return /* @__PURE__ */ a(Nn.Provider, { value: s, children: i });
}
function Cn() {
  const t = ma(Nn);
  if (!t)
...
function Ll() {
  const [t, e] = S(void 0), r = F(() => {
    ...
    return /* @__PURE__ */ a(pc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(fc, { children: [
      /* @__PURE__ */ a(mc, { children: /* @__PURE__ */ a(vc, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = F(
    (i, s, c = !1) => {
...
function Vl({
  ...
  const [e] = Gt(), [r, o] = S(e), [n, i] = S("paragraph"), [s, c] = Ll(), l = () => {
  };
...
const go = [
  { format: "bold", icon: yi, label: "Bold" },
  { format: "italic", icon: ki, label: "Italic" }
...
function Bl() {
  const { activeEditor: t } = Cn(), [e, r] = S([]), o = F((n) => {
    if (Ut(n) || Xs(n)) {
      const i = [];
      go.forEach(({ format: s }) => {
...
function Kl({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Vl, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Bl, {}) }) }),
      ...
      /* @__PURE__ */ a(
        El,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Al, { placeholder: t }) }),
          ErrorBoundary: Vc
        }
      ),
      e && /* @__PURE__ */ a(Tl, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ a(Ul, { onClear: r }),
      /* @__PURE__ */ a(Rl, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ a(
          Mc,
          {
            ...
            children: /* @__PURE__ */ u(kt, { children: [
              /* @__PURE__ */ a(Kl, { placeholder: n, autoFocus: i, onClear: s }),
              /* @__PURE__ */ a(
                Ic,
                {
...
function Gl(t, e) {
  const r = Bs(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
  for (const i of r) if (!Sn.has(i.nodeName)) {
    const s = Rn(i, t, n, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
    for (const s of i) s.getNextSibling() instanceof Ho && s.insertAfter(Wo());
    for (const s of i) {
...
function Tn(t, e, r, o = null) {
  let n = o === null || e.isSelected(o);
  const i = Yt(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && yr(e) && (s = Kc(o, e, "clone"));
  const c = Yt(s) ? s.getChildren() : [], l = Fs(t, s.getType());
  let d;
  ...
  for (let p = 0; p < c.length; p++) {
    const m = c[p], x = Tn(t, m, h, o);
    !n && Yt(e) && x && e.extractWithChild(m, o, "html") && (n = !0);
  }
  if (n && !i) {
    if ((jo(w) || Za(w)) && w.append(h), r.append(w), g) {
      const p = g.call(s, w);
      p && (Za(w) ? w.replaceChildren(p) : w.replaceWith(p));
    }
  } else r.append(h);
  return n;
}
const Sn = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Rn(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  let s = [];
  if (Sn.has(t.nodeName)) return s;
  let c = null;
  const l = function(m, x) {
    const { nodeName: v } = m, N = x._htmlConversions.get(v.toLowerCase());
    let b = null;
    if (N !== void 0) for (const _ of N) {
      const k = _(m);
      k !== null && (b === null || (b.priority || 0) <= (k.priority || 0)) && (b = k);
    }
  ...
  let h = [];
  const p = (c == null || !Us(c)) && (c != null && xr(c) || o);
  for (let m = 0; m < g.length; m++) h.push(...Rn(g[m], e, r, p, new Map(n), c));
  return w != null && (h = w(h)), Qa(t) && (h = Wl(t, h, p ? () => {
    const m = new Ho();
    return r.push(m), m;
  } : Ke)), c == null ? h.length > 0 ? s = s.concat(h) : Qa(t) && function(m) {
    return m.nextSibling == null || m.previousSibling == null ? !1 : to(m.nextSibling) && to(m.previousSibling);
  }(t) && (s = s.concat(Wo())) : Yt(c) && c.append(...h), s;
}
function Wl(t, e, r) {
...
function $n(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : $n(e.children)
  ) : !1;
}
function $t(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? $n(t.root.children) : !1;
}
function Yl(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const n = new DOMParser().parseFromString(t, "text/html"), i = Gl(e, n);
      Jt().clear(), Ks(i);
    },
    {
      discrete: !0
...
function _u({
  ...
  const [i, s] = S(Xl), [c, l] = S(n), [d, w] = S(!1), g = G(void 0), h = G(null);
  H(() => {
    let b = !0;
    const _ = h.current;
    if (!_) return;
  ...
  const p = F(() => {
    ...
    const b = Er(i);
    e(b, c);
  }, [i, e, c]), m = o["%commentEditor_placeholder%"] ?? "Type your comment here...", x = o["%commentEditor_saveButton_tooltip%"] ?? "Save comment", v = o["%commentEditor_cancelButton_tooltip%"] ?? "Cancel", N = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between", children: [
      /* @__PURE__ */ a("span", { className: "tw:text-sm tw:font-medium", children: N }),
      /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
        /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
          /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(V, { onClick: r, className: "tw:h-6 tw:w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ a(or, {}) }) }),
          /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: v }) })
        ] }) }),
        /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
          ...
          /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: x }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(re, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ u(
        V,
        {
          variant: "outline",
          ...
          disabled: t.length === 0,
          children: [
            /* @__PURE__ */ a(zo, { className: "tw:h-4 tw:w-4" }),
            /* @__PURE__ */ a("span", { children: qr(c !== void 0 ? c : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ a(
        ae,
        {
          ...
          children: /* @__PURE__ */ a(fe, { children: /* @__PURE__ */ a(me, { children: t.map((b) => /* @__PURE__ */ a(
            ee,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : Da(b) && (b.preventDefault(), b.stopPropagation(), $t(i) && p());
        },
        onKeyDown: (b) => {
          Ra(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          Cr,
          {
...
const Nu = Object.freeze([
...
], Jl = ["input", "select", "textarea", "button"], Zl = ["button", "textbox"], Ql = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  onCharacterPress: o
  ...
  const n = G(null), [i, s] = S(void 0), [c, l] = S(void 0), d = F(
    ...
    (p) => {
      ...
      m && (l((x) => x === p ? void 0 : p), r == null || r(m));
    },
    [r, t]
  ), g = (p) => {
    if (!p) return !1;
    const m = p.tagName.toLowerCase();
    if (p.isContentEditable || Jl.includes(m)) return !0;
    const x = p.getAttribute("role");
    if (x && Zl.includes(x)) return !0;
    const v = p.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = F(
    (p) => {
      var M;
      const m = p.target, x = (C) => C ? document.getElementById(C) : void 0, v = x(c), N = x(i);
      if (!!(v && m && v.contains(m) && m !== v) && g(m)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !m.isContentEditable) {
          if (c) {
            p.preventDefault(), p.stopPropagation();
            const C = t.find((T) => T.id === c);
            C && d(C.id);
          }
          return;
        }
        if (p.key === "ArrowDown" || p.key === "ArrowUp") {
          ...
          const T = C.findIndex((O) => O === m);
          if (T === -1) return;
          let z;
          p.key === "ArrowDown" ? z = Math.min(T + 1, C.length - 1) : z = Math.max(T - 1, 0), z !== T && (p.preventDefault(), p.stopPropagation(), (M = C[z]) == null || M.focus());
          return;
        }
        return;
      }
...
function er({ className: t, variant: e = "default", asChild: r = !1, ...o }) {
  const n = r ? ze.Root : "span";
  return /* @__PURE__ */ a(
    n,
    {
      "data-slot": "badge",
...
function ue({ variant: t = "default", ...e }) {
  const r = ct(), o = rt.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ a($a.Provider, { value: o, children: /* @__PURE__ */ a(gt.Root, { "data-slot": "dropdown-menu", dir: r, ...e }) });
}
function nd({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ a(
          "span",
          {
            ...
            children: /* @__PURE__ */ a(gt.ItemIndicator, { children: /* @__PURE__ */ a(Te, {}) })
          }
        ),
        e
      ]
...
function Mr({ className: t, inset: e, ...r }) {
  return /* @__PURE__ */ a(
    gt.Label,
    {
  ...
  return /* @__PURE__ */ u(
    gt.SubTrigger,
    {
      ...
      className: f(
        ...
        t,
        // CUSTOM: Apply variant-driven styles from menu context
        Re({ variant: n.variant })
      ),
      ...o,
      children: [
        r,
        /* @__PURE__ */ a(fa, { className: "tw:ms-auto" })
      ]
    }
  );
}
function dd({ className: t, children: e, ...r }) {
  const o = ct();
  return /* @__PURE__ */ a(
    gt.SubContent,
    {
...
function ho({
  ...
  }, [t.date, r]), v = j(() => t.user, [t.user]), N = j(
    () => t.user.split(" ").map((k) => k[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), b = j(() => pi(t.contents), [t.contents]), _ = j(() => {
    if (o && c)
      return /* @__PURE__ */ u(st, { children: [
        /* @__PURE__ */ u(
          ua,
          {
            onClick: (k) => {
              k.stopPropagation(), d(!0), g(Yl(t.contents)), s == null || s(!0);
            },
            children: [
              /* @__PURE__ */ a(_i, { className: "tw:me-2 tw:h-4 tw:w-4" }),
        ...
        /* @__PURE__ */ u(
          ua,
          {
            ...
            children: [
              /* @__PURE__ */ a(Ni, { className: "tw:me-2 tw:h-4 tw:w-4" }),
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(ad, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(od, { className: "tw:text-xs tw:font-medium", children: N }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : Da(k) && (k.preventDefault(), k.stopPropagation(), $t(w) && m());
              },
              onKeyDown: (k) => {
                Ra(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
              },
              onClick: (k) => {
                k.stopPropagation();
              },
        ...
        _ && /* @__PURE__ */ u(ue, { children: [
          /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ci, {}) }) }),
          /* @__PURE__ */ a(ge, { align: "end", children: _ })
        ] })
      ]
    }
  );
...
function wd({
  ...
  const [C, T] = S(fo), [z, O] = S(), [$, q] = S(), P = o, [Y, y] = S(!1), [U, dt] = S(!1), [ft, zt] = S(!1), [ut, yt] = S(!1), [B, it] = S(!1), [J, wt] = S(k), [mt, ne] = S(!1), ie = G(void 0), [De, se] = S(/* @__PURE__ */ new Map());
  H(() => {
    let R = !0;
    return (async () => {
      const Dt = b ? await b(l) : !1;
      R && it(Dt);
    })(), () => {
      R = !1;
    };
    ...
    let R = !0;
    if (!o) {
      yt(!1), se(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Dt = N ? await N(l) : !1;
      R && yt(Dt);
    })(), () => {
      R = !1;
    };
  ...
  H(() => {
    if (!o) {
      Tt.current !== "idle" && (O(void 0), q(void 0), Tt.current = "idle");
      return;
    }
    Tt.current === "idle" && (Tt.current = "pending"), ut ? Tt.current === "pending" && M !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    M !== i && (O(M), Tt.current = "auto-populated") : Tt.current === "auto-populated" && (O(void 0), Tt.current = "pending");
  }, [o, M, ut, i]);
  const It = j(() => e.filter((R) => !R.deleted), [e]);
  H(() => {
    let R = !0;
    if (!o || !_) {
      se(/* @__PURE__ */ new Map());
  ...
  const Ht = j(() => It[0], [It]), D = G(null), E = G(void 0), A = F(() => {
    var R;
    (R = E.current) == null || R.call(E), T(fo);
  }, []), X = F(() => {
    const R = !J;
    wt(R), ne(!R), m == null || m(l, R);
  }, [J, m, l]);
  H(() => {
    y(!1);
  }, [o]), H(() => {
  ...
  }, [i, r]), tt = j(() => It.slice(1), [It]), at = j(() => tt.length ?? 0, [tt.length]), nt = j(() => at > 0, [at]), Rt = j(() => Y || at <= 2 ? tt : tt.slice(-2), [tt, at, Y]), St = j(() => Y || at <= 2 ? 0 : at - 2, [at, Y]), Wt = j(
    () => at === 1 ? K.singleReply : _e(K.multipleReplies, { count: at }),
    [at, K]
  ), be = j(
    () => St === 1 ? K.singleReply : _e(K.multipleReplies, { count: St }),
    [St, K]
  );
  H(() => {
    !o && U && nt && dt(!1);
  ...
  const ce = F(
    async (R) => {
      ...
      Lt && await g({ threadId: l, contents: Lt }) && A();
    },
    [
      A,
      C,
    ...
    async (R) => {
      const Lt = $t(C) ? Er(C) : void 0, Dt = R.status ? R.assignedUser : z ?? R.assignedUser, He = await g({
        ...R,
        contents: Lt,
        assignedUser: Dt
      });
      return He && (Dt !== void 0 && q(Dt), Lt && A()), He;
    },
    [A, C, g, z]
  );
  if (It.length !== 0)
    return /* @__PURE__ */ a(
      ed,
      {
        ...
        className: f(
          ...
          {
            "tw:bg-primary-foreground": !o && w !== "Resolved" && J,
            "tw:bg-background": o && w !== "Resolved" && J,
            "tw:bg-muted": w === "Resolved",
            "tw:bg-accent": !J && !o && w !== "Resolved"
          }
        ),
        onClick: () => {
          c(l);
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ u(rd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
              ot && /* @__PURE__ */ a(er, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: ot }),
              /* @__PURE__ */ a(
                V,
                {
                  variant: "ghost",
                  ...
                  children: J ? /* @__PURE__ */ a(Ei, {}) : /* @__PURE__ */ a(zi, {})
                }
              ),
            ...
            /* @__PURE__ */ a(
              ho,
              {
                ...
                isThreadExpanded: o,
                threadStatus: w,
                handleAddCommentToThread: Va,
                handleUpdateComment: h,
                handleDeleteComment: p,
                onEditingChange: dt,
                canEditOrDelete: (!U && De.get(Ht.id)) ?? !1,
                canUserResolveThread: B
              }
            )
          ] }),
          /* @__PURE__ */ u(st, { children: [
            nt && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
            ...
            o && /* @__PURE__ */ u(st, { children: [
              St > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onClick: (R) => {
                    R.stopPropagation(), y(!0);
                  },
                  role: "button",
                  tabIndex: 0,
                  onKeyDown: (R) => {
                    (R.key === "Enter" || R.key === " ") && (R.preventDefault(), R.stopPropagation(), y(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(rr, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                      /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: be }),
                      Y ? /* @__PURE__ */ a(Ti, {}) : /* @__PURE__ */ a(Sr, {})
                    ] })
                  ]
                }
              ),
              Rt.map((R) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
                ho,
                {
                  comment: R,
                  localizedStrings: r,
                  ...
                  handleDeleteComment: p,
                  onEditingChange: dt,
                  canEditOrDelete: (!U && De.get(R.id)) ?? !1
                }
              ) }, R.id)),
              v !== !1 && (!U || $t(C)) && /* @__PURE__ */ u(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (R) => {
                    Da(R) && (R.preventDefault(), R.stopPropagation(), ($t(C) || z !== void 0 && z !== $) && ce());
                  },
                  onKeyDown: (R) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      z !== void 0 && ($t(C) || z !== $) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: _e(
                      ...
                      /* @__PURE__ */ u(re, { open: ft, onOpenChange: zt, children: [
                        /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ a(
                          V,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !ut || !x || x.length === 0 || !x.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          ae,
                          {
                            ...
                            align: "end",
                            onKeyDown: (R) => {
                              R.key === "Escape" && (R.stopPropagation(), zt(!1));
                            },
                            children: /* @__PURE__ */ a(fe, { children: /* @__PURE__ */ a(me, { children: x == null ? void 0 : x.map((R) => /* @__PURE__ */ a(
                              ee,
                              {
                                onSelect: () => {
                                  O(R !== i ? R : void 0), Tt.current = "user-selected", q(void 0), zt(!1);
                                },
                                className: "tw:flex tw:items-center",
                                children: /* @__PURE__ */ a("span", { children: br(R, r) })
                              },
                              R || "unassigned"
                            )) }) })
                          }
...
function $u({
  ...
  const [N, b] = S(/* @__PURE__ */ new Set()), [_, k] = S(), [I, L] = S(), M = F(
    async (y) => {
      const U = await i(y);
      return U !== void 0 && y.assignedUser !== void 0 && y.assignedUser !== "" && L(y.assignedUser), U;
    },
    [i]
  );
  H(() => {
    m && (b((y) => new Set(y).add(m)), k(m));
  }, [m]);
  const C = r.filter(
    (y) => y.comments.some((U) => !U.deleted)
  ), T = C.map((y) => ({ id: y.id })), z = F(
    (y) => {
      b((U) => new Set(U).add(y.id)), k(y.id), x == null || x(y.id);
    },
    [x]
  ), O = F(
    (y) => {
      ...
      b((dt) => {
        const ft = new Set(dt);
        return ft.has(y) ? ft.delete(y) : ft.add(y), ft;
      }), k(y), x == null || x(U ? void 0 : y);
    },
    [N, x]
  ), { listboxRef: $, activeId: q, handleKeyDown: P } = Ql({
    options: T,
    onOptionSelect: z
  }), Y = F(
    (y) => {
      y.key === "Escape" ? (_ && N.has(_) && (b((U) => {
        const dt = new Set(U);
        return dt.delete(_), dt;
...
function ud({ table: t }) {
  return /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      /* @__PURE__ */ a(Si, { className: "tw:mr-2 tw:h-4 tw:w-4" }),
      "View"
    ] }) }),
...
function Fe({ className: t, size: e = "default", children: r, ...o }) {
  const n = ct();
  return /* @__PURE__ */ u(
    xt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(xt.Icon, { asChild: !0, children: /* @__PURE__ */ a(ai, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function At({
  ...
  return /* @__PURE__ */ u(
    xt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(xt.ItemIndicator, { children: /* @__PURE__ */ a(Te, { className: "tw:pointer-events-none" }) }) }),
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:space-x-2", children: [
      ...
      /* @__PURE__ */ u(
        Ve,
        {
          ...
          children: [
            /* @__PURE__ */ a(Fe, { className: "tw:h-8 tw:w-[70px]", children: /* @__PURE__ */ a(je, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ a(Be, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(At, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ar(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && md(o)
  );
}
function Ma({
  className: t,
...
function de({
  ...
  const c = rt.useMemo(
    ...
    (w) => {
      ...
      ) : [], m = p.indexOf(g), x = c.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), xd(p, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), bd(c, x, w.key);
...
function yd({
  ...
  var L;
  const [w, g] = S([]), [h, p] = S([]), [m, x] = S({}), [v, N] = S({}), b = j(() => e ?? [], [e]), _ = Xo({
    data: b,
    columns: t,
    getCoreRowModel: Zo(),
    ...r && { getPaginationRowModel: Zs() },
    onSortingChange: g,
  ...
  let I;
  return l ? I = Array.from({ length: 10 }).map((T, z) => `skeleton-row-${z}`).map((T) => /* @__PURE__ */ a(de, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(Pe, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(pa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, T)) : ((L = _.getRowModel().rows) == null ? void 0 : L.length) > 0 ? I = _.getRowModel().rows.map((M) => /* @__PURE__ */ a(
    de,
    {
      onClick: () => s(M, _),
      "data-state": M.getIsSelected() && "selected",
      children: M.getVisibleCells().map((C) => /* @__PURE__ */ a(Pe, { children: Je(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    M.id
  )) : I = /* @__PURE__ */ a(de, { children: /* @__PURE__ */ a(Pe, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(ud, { table: _ }),
    /* @__PURE__ */ u(Ma, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Oa, { stickyHeader: i, children: _.getHeaderGroups().map((M) => /* @__PURE__ */ a(de, { children: M.headers.map((C) => /* @__PURE__ */ a(zr, { className: "tw:p-0", children: C.isPlaceholder ? void 0 : Je(C.column.columnDef.header, C.getContext()) }, C.id)) }, M.id)) }),
...
function Pu({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(ec, { options: i, children: e })
    }
  );
}
...
function _d({
  ...
  const n = vo(r, "%webView_error_dump_header%"), i = vo(r, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(So, {}) })
        ] }),
...
var Nd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Nd || {});
function ju({ id: t, label: e, groups: r }) {
  const [o, n] = S(
    Object.fromEntries(
      r.map(
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ u(V, { variant: "default", children: [
      /* @__PURE__ */ a(Oi, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
    ...
    /* @__PURE__ */ a(ge, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Mn, { children: d.itemType === 0 ? /* @__PURE__ */ a(st, { children: d.items.map((g, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        we,
        {
          checked: o[w][h],
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:items-center tw:gap-1 tw:ps-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-1", children: [
            /* @__PURE__ */ a(Ii, { className: "tw:h-4 tw:w-4" }),
...
function Cd({ id: t, versionHistory: e }) {
  ...
  function i(c) {
    const l = new Date(c), d = new Date(n.getTime() - l.getTime()), w = d.getUTCFullYear() - 1970, g = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let p = "";
...
function Bu({
  ...
  const s = j(() => hi(r), [r]), l = ((d) => {
    const w = new Intl.DisplayNames(fi(), { type: "language" });
  ...
  return /* @__PURE__ */ a("div", { id: t, className: "pr-twp tw:border-t tw:py-2", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:divide-y", children: [
    Object.entries(n).length > 0 && /* @__PURE__ */ a(Cd, { versionHistory: n }),
...
function Ed({
  ...
  const [N, b] = S(!1), _ = F(
    (z) => {
      var $;
      const O = ($ = t.find((q) => q.label === z)) == null ? void 0 : $.value;
      O && r(
    ...
    if (!h) return t;
    const z = t.filter(($) => $.starred).sort(($, q) => $.label.localeCompare(q.label)), O = t.filter(($) => !$.starred).sort(($, q) => {
      const P = e.includes($.value), Y = e.includes(q.value);
      return P && !Y ? -1 : !P && Y ? 1 : $.label.localeCompare(q.label);
    });
    return [...z, ...O];
  }, [t, e, h]), L = () => {
    r(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(re, { open: C, onOpenChange: w ?? b, children: [
    /* @__PURE__ */ a(ve, { asChild: !0, children: /* @__PURE__ */ u(
      V,
      {
        variant: x,
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ro, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ a(ae, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(fe, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: L, children: i }),
        /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: M, children: s })
      ] }),
      /* @__PURE__ */ u(me, { children: [
        /* @__PURE__ */ a(Dr, { children: c }),
        /* @__PURE__ */ a(Qt, { children: I.map((z) => /* @__PURE__ */ u(
          ee,
          {
            value: z.label,
            onSelect: _,
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ a(Li, { className: "tw:h-4 tw:w-4" }),
...
function Td({
  ...
  const l = j(() => /Macintosh/i.test(navigator.userAgent), []);
  return /* @__PURE__ */ u(st, { children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(
        V,
    ...
    e && /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      ...
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ u("p", { children: [
        bo(n, "%redoButton_tooltip%"),
        i && ` (${l ? "⌘⇧Z" : "Ctrl+Y"})`
      ] }) })
    ] }) })
  ] });
}
function Sd({ children: t, editorRef: e }) {
  const r = G(null);
  return H(() => {
    var s;
    const o = /Macintosh/i.test(navigator.userAgent), n = ((s = r.current) == null ? void 0 : s.querySelector(".editor-input")) ?? void 0, i = (c) => {
      var d, w, g, h;
      if (!n || document.activeElement !== n) return;
      const l = c.key.toLowerCase();
      if (o) {
        if (!c.metaKey) return;
        !c.shiftKey && l === "z" ? (c.preventDefault(), (d = e.current) == null || d.undo()) : c.shiftKey && l === "z" && (c.preventDefault(), (w = e.current) == null || w.redo());
      } else {
        if (!c.ctrlKey) return;
        !c.shiftKey && l === "z" ? (c.preventDefault(), (g = e.current) == null || g.undo()) : (l === "y" || c.shiftKey && l === "z") && (c.preventDefault(), (h = e.current) == null || h.redo());
      }
    };
    return document.addEventListener("keydown", i), () => document.removeEventListener("keydown", i);
  }, [e]), /* @__PURE__ */ a("div", { ref: r, children: t });
}
const Rd = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(st, { children: [
...
function Dd({
  ...
  const i = G(null), s = G(null), c = G(!1), [l, d] = S(t), [w, g] = S(r), [h, p] = S(!1);
  H(() => {
    d(t);
  }, [t]), H(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    c.current = !1, p(v), v || (l !== "custom" || w ? (e(l), o(w)) : (d(t), g(r)));
  }, x = (v) => {
    var N, b, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((b = s.current) == null || b.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  return /* @__PURE__ */ u(ue, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Rd(t, n, r) }) }) }),
    ...
    /* @__PURE__ */ u(
      ge,
      {
        ...
        children: [
          /* @__PURE__ */ a(Mr, { children: n["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(cr, {}),
          /* @__PURE__ */ a(
            we,
            {
              ...
              children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ a("span", { className: "tw:w-10 tw:text-center", children: ra })
              ] })
            }
          ),
          /* @__PURE__ */ a(
...
const $d = (t, e) => t === "f" ? /* @__PURE__ */ u(st, { children: [
  /* @__PURE__ */ a($o, {}),
  " ",
...
function Od({
  ...
  return /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(pe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: $d(t, r) }) }) }),
      /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: Md(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ge, { style: { zIndex: Qo }, children: [
...
function Ad({ icon: t, className: e }) {
  return /* @__PURE__ */ a(t ?? Fi, { className: e, size: 16 });
}
function xo({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ u(
    ee,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Ad, { icon: t.icon }) }) }),
        /* @__PURE__ */ u("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(kc, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
function Pd({ localizedStrings: t, markerMenuItems: e, searchRef: r }) {
  const [o, n] = S(""), [i, s] = j(() => {
  ...
  return /* @__PURE__ */ u(fe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(me, { children: [
      /* @__PURE__ */ a(Dr, { children: t["%markerMenu_noResults%"] }),
      /* @__PURE__ */ a(Qt, { children: i.map((c) => {
        var l;
        return /* @__PURE__ */ a(
          xo,
          {
      ...
      s.length > 0 && /* @__PURE__ */ u(st, { children: [
        i.length > 0 && /* @__PURE__ */ a(en, { alwaysRender: !0 }),
        /* @__PURE__ */ a(Qt, { children: s.map((c) => {
          var l;
          return /* @__PURE__ */ a(
            xo,
            {
...
function Ku({
  ...
  Mt(() => {
    if (!p.current) return;
    const { width: E } = p.current.getBoundingClientRect();
    E > 0 && (p.current.style.width = `${E}px`);
  }, []);
  const [m, x] = S("generated"), [v, N] = S("*"), [b, _] = S("f"), [k, I] = S(!1), [L, M] = S(!0), [C, T] = S(!1), z = G(!1), O = G(""), [$, q] = S(!1), [P, Y] = S(), [y, U] = S(), [dt, ft] = S(), [zt, ut] = S(), yt = G(null), B = j(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? rc(), noteMode: "expanded" }
    }),
    [s, c]
  ), it = j(
    () => Ld(
  ...
  H(() => {
    ...
    if (A && wr("note", A)) {
      const ot = (X = A.insert.note) == null ? void 0 : X.caller;
      let tt = "custom";
      ot === ra ? tt = "generated" : ot === aa ? tt = "hidden" : ot && N(ot), x(tt), _(((K = A.insert.note) == null ? void 0 : K.style) ?? "f"), E = setTimeout(() => {
        var at;
        (at = w.current) == null || at.applyUpdate([A]);
      }, 0);
    }
    return () => {
      E && clearTimeout(E);
  ...
  const J = F(
    (E, A, X = !1) => {
      var ot, tt, at;
      const K = (tt = (ot = w.current) == null ? void 0 : ot.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (K && wr("note", K)) {
        if (K.insert.note) {
          let nt;
          E === "custom" ? nt = A : E === "generated" ? nt = ra : nt = aa, K.insert.note.caller = nt;
        }
        r == null || r([K]), X && d && i && ((at = d.current) == null || at.replaceEmbedUpdate(i, [K]));
      }
    },
    [i, r, d]
  ), wt = F(() => {
  ...
  const ne = G({ book: n.book, chapterNum: n.chapterNum });
  Mt(() => {
    (ne.current.book !== n.book || ne.current.chapterNum !== n.chapterNum) && (ne.current = { book: n.book, chapterNum: n.chapterNum }, mt.current());
  }, [n.book, n.chapterNum]);
  const ie = () => {
    var A;
    const E = (A = g.current) == null ? void 0 : A.getElementsByClassName("editor-input")[0];
    ...
    var X, K, ot, tt, at;
    _(E);
    const A = (K = (X = w.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : K.at(0);
    if (A && wr("note", A)) {
      A.insert.note && (A.insert.note.style = E);
      const nt = (tt = (ot = A.insert.note) == null ? void 0 : ot.contents) == null ? void 0 : tt.ops;
      b !== "x" && E === "x" ? nt == null || nt.forEach((Rt) => Vd(Rt)) : b === "x" && E !== "x" && (nt == null || nt.forEach((Rt) => jd(Rt))), (at = w.current) == null || at.applyUpdate([A, { delete: 1 }]);
    }
  }, It = (E) => {
    ut(E.contextMarker), T(E.canRedo);
  }, Ht = F(
    (E) => {
      var X, K, ot, tt, at;
      const A = (K = (X = w.current) == null ? void 0 : X.getNoteOps(0)) == null ? void 0 : K.at(0);
      if (A && wr("note", A)) {
        ...
        const nt = (ot = A.insert.note) == null ? void 0 : ot.style, Rt = (at = (tt = A.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : at.ops;
        if (nt || I(!1), I(
          nt === "x" ? !!(Rt != null && Rt.every((St) => {
            var be, ce;
            if (!((be = St.attributes) != null && be.char)) return !0;
            const Wt = ((ce = St.attributes) == null ? void 0 : ce.char).style;
          ...
          z.current = !0, O.current = JSON.stringify(A), M(!0);
          return;
        }
        M(JSON.stringify(A) === O.current), J(m, v);
      } else
        I(!1), M(!0);
    },
    [m, v, J]
    ...
    if (h.current && it.length && E && E.rangeCount > 0) {
      const A = E.getRangeAt(0).getBoundingClientRect(), X = h.current.getBoundingClientRect();
      Y(A.left - X.left), U(A.top - X.top), ft(A.height), q(!0);
    }
  }, [it, h]);
  return H(() => {
    const E = () => {
    ...
    var E;
    $ && ((E = yt.current) == null || E.focus());
  }, [$]), H(() => {
    var X;
    const E = ((X = g.current) == null ? void 0 : X.querySelector(".editor-input")) ?? void 0, A = (K) => {
      !$ && E && document.activeElement === E && K.key === c ? (K.preventDefault(), D()) : $ && K.key === "Escape" && (K.preventDefault(), q(!1));
    };
    return document.addEventListener("keydown", A), () => {
      document.removeEventListener("keydown", A);
    };
  }, [$, D, c]), /* @__PURE__ */ u(st, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:justify-end tw:gap-4", children: [
          /* @__PURE__ */ a(
            Td,
            {
              onUndoClick: () => {
                var E;
                return (E = w.current) == null ? void 0 : E.undo();
              },
              onRedoClick: () => {
                var E;
                return (E = w.current) == null ? void 0 : E.redo();
              },
              canUndo: !L,
              canRedo: C,
              localizedStrings: l
          ...
          /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
            ...
            /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: l["%footnoteEditor_saveButton_tooltip%"] }) })
          ] }) }),
          /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
            /* @__PURE__ */ a(Nt, { asChild: !0, children: /* @__PURE__ */ a(V, { onClick: o, className: "tw:h-6 tw:w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ a(or, {}) }) }),
            /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
          ] }) })
        ] })
      ] }),
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ a("div", { className: t, children: /* @__PURE__ */ a(Sd, { editorRef: w, children: /* @__PURE__ */ a(
              ac,
              {
                options: B,
                onStateChange: It,
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
              ...
              /* @__PURE__ */ a(Ct, { children: /* @__PURE__ */ a("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(st, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(st, { children: Bd(t.marker, c, o, d) })
      }
    )
  ] });
}
function Gu({
  ...
  const w = l ?? mi(r, void 0), g = (b, _) => {
    d == null || d(b, _, n);
  }, h = i ? r.findIndex((b) => b === i) : -1, [p, m] = S(h), x = (b, _, k) => {
    if (r.length)
      switch (b.key) {
        case "Enter":
        case " ":
          b.preventDefault(), d == null || d(_, k, n);
          break;
      }
  }, v = (b) => {
    if (r.length)
      switch (b.key) {
        case "ArrowDown":
          b.preventDefault(), m((_) => Math.min(_ + 1, r.length - 1));
          break;
        case "ArrowUp":
          b.preventDefault(), m((_) => Math.max(_ - 1, 0));
          break;
      }
  }, N = G([]);
  return H(() => {
    var b;
    p >= 0 && p < N.current.length && ((b = N.current[p]) == null || b.focus());
  }, [p]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: r.map((b, _) => {
            ...
            return /* @__PURE__ */ u(st, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(rr, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
...
function Gd({
  ...
  return /* @__PURE__ */ u(Ma, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Oa, { stickyHeader: !0, children: /* @__PURE__ */ u(de, { children: [
    ...
    /* @__PURE__ */ a(Ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      de,
      {
        ...
        children: [
          /* @__PURE__ */ a(Pe, { children: Ne(c.reference, "English") }),
          /* @__PURE__ */ a(Pe, { className: o, children: qd(c.text) })
        ]
      },
...
const Hd = (t) => {
  ...
  if (t === "desc")
    return /* @__PURE__ */ a(Gi, { className: "tw:h-4 tw:w-4" });
}, Or = (t, e, r) => /* @__PURE__ */ a(kt, { children: /* @__PURE__ */ u(_t, { children: [
  /* @__PURE__ */ u(
    Nt,
    {
  ...
  header: ({ column: e }) => Or(e, t)
}), Wd = (t, e) => ({
  accessorKey: `item${e}`,
  accessorFn: (r) => r.items[e],
  header: ({ column: r }) => Or(r, t)
}), Wu = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => Or(e, t, "tw:justify-end"),
  ...
  accessorKey: "status",
  header: ({ column: i }) => Or(i, t, "tw:justify-center"),
  cell: ({ row: i }) => {
    const s = i.getValue("status"), c = i.getValue("item");
    return /* @__PURE__ */ u(zn, { value: s, variant: "outline", type: "single", className: "tw:gap-0", children: [
      /* @__PURE__ */ a(
        vr,
        {
          onClick: (l) => {
            l.stopPropagation(), Gr(
              [c],
              "approved",
              e,
              r,
  ...
  return e ? e[1] : "";
}, Yd = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Qu = Object.freeze([
  ...
  const n = Ua(o.key) ? o.key : o.key[0];
  return {
    items: Ua(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || Yd(n, e, r),
...
function tp({
  ...
  const p = Vt(r, "%webView_inventory_all%"), m = Vt(r, "%webView_inventory_approved%"), x = Vt(r, "%webView_inventory_unapproved%"), v = Vt(r, "%webView_inventory_unknown%"), N = Vt(r, "%webView_inventory_scope_currentBook%"), b = Vt(r, "%webView_inventory_scope_chapter%"), _ = Vt(r, "%webView_inventory_scope_verse%"), k = Vt(r, "%webView_inventory_filter_text%"), I = Vt(
    r,
    "%webView_inventory_show_additional_items%"
  ), L = Vt(r, "%webView_inventory_no_results%"), [M, C] = S(!1), [T, z] = S("all"), [O, $] = S(""), [q, P] = S([]), Y = j(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : Jd(B, n, i);
  }, [t, n, i]), y = j(() => {
    if (M) return Y;
    const B = [];
    return Y.forEach((it) => {
      const J = it.items[0], wt = B.find(
        (mt) => mt.items[0] === J
      );
      wt ? (wt.count += it.count, wt.occurrences = wt.occurrences.concat(it.occurrences)) : B.push({
        items: [J],
        count: it.count,
  ...
  }, [M, Y]), U = j(() => y.length === 0 ? [] : Xd(y, T, O), [y, T, O]), dt = j(() => {
    var J, wt;
    if (!M) return l;
    const B = (J = o == null ? void 0 : o.tableHeaders) == null ? void 0 : J.length;
    if (!B) return l;
    const it = [];
    for (let mt = 0; mt < B; mt++)
      it.push(
        Wd(
          ((wt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : wt[mt]) || "Additional Item",
          mt + 1
        )
      );
    return [...it, ...l];
  }, [o == null ? void 0 : o.tableHeaders, l, M]);
  H(() => {
    U.length === 0 ? P([]) : U.length === 1 && P(U[0].items);
  }, [U]);
  const ft = (B, it) => {
    it.setRowSelection(() => {
      const wt = {};
      return wt[B.index] = !0, wt;
    });
    const J = B.original.items;
    P(J), h && J.length > 0 && h(J[0]);
  }, zt = (B) => {
    ...
    const B = y.filter((it) => vi(
      M ? it.items : [it.items[0]],
      q
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ u(
        Ve,
        {
          ...
          defaultValue: T,
          children: [
            /* @__PURE__ */ a(Fe, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(je, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ u(Be, { children: [
              /* @__PURE__ */ a(At, { value: "all", children: p }),
              /* @__PURE__ */ a(At, { value: "approved", children: m }),
              /* @__PURE__ */ a(At, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(At, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(Ve, { onValueChange: (B) => zt(B), defaultValue: s, children: [
        /* @__PURE__ */ a(Fe, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(je, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Be, { children: [
          /* @__PURE__ */ a(At, { value: "book", children: N }),
          /* @__PURE__ */ a(At, { value: "chapter", children: b }),
          /* @__PURE__ */ a(At, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ir,
...
const Zd = "16rem", Qd = "3rem", An = rt.createContext(void 0);
function Ir() {
  const t = rt.useContext(An);
  if (!t)
...
function tw({
  ...
  const [l, d] = rt.useState(t), w = e ?? l, g = rt.useCallback(
    (_) => {
      const k = typeof _ == "function" ? _(w) : _;
      r ? r(k) : d(k);
    },
    [r, w]
  ), h = rt.useCallback(() => g((_) => !_), [g]), p = w ? "expanded" : "collapsed", v = ct() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = rt.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
  ...
  return /* @__PURE__ */ a(An.Provider, { value: N, children: /* @__PURE__ */ a(
    "div",
    {
...
function ep({ className: t, onClick: e, ...r }) {
  const { toggleSidebar: o, side: n } = Ir();
  return /* @__PURE__ */ u(
    V,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(oi, {}) : /* @__PURE__ */ a(ni, {}),
...
function sw({
  ...
  const c = t ? ze.Root : "button", { state: l } = Ir(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: f(iw({ variant: r, size: o }), i),
      ...s
    }
  );
    ...
    ew,
    {
      ...
      children: /* @__PURE__ */ u(aw, { children: [
        /* @__PURE__ */ u(yo, { children: [
          /* @__PURE__ */ a(ko, { className: "tw:text-sm", children: i }),
          /* @__PURE__ */ a(_o, { children: /* @__PURE__ */ a(ow, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(nw, { children: /* @__PURE__ */ a(
            sw,
            {
              onClick: () => d(h),
              isActive: g(h),
        ...
        /* @__PURE__ */ u(yo, { children: [
          /* @__PURE__ */ a(ko, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(_o, { className: "tw:pl-3", children: /* @__PURE__ */ a(
            sa,
            {
              buttonVariant: "ghost",
...
const le = "scrBook", lw = "scrRef", ke = "source", dw = "details", ww = "Scripture Reference", uw = "Scripture Book", Pn = "Type", pw = "Details";
function gw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === le ? Ne(n.start) : void 0;
      },
      getGroupingValue: (o) => lt.bookIdToNumber(o.start.book),
      sortingFn: (o, n) => Jr(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
    ...
    },
    {
      ...
      id: ke,
      header: r ? (t == null ? void 0 : t.typeColumnName) ?? Pn : void 0,
...
const hw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Jr(t.start, t.end) === 0 ? `${Ar(t.start)}+${e}` : `${Ar(t.start)}+${e}-${Ar(t.end)}+${r}`;
}, No = (t) => `${hw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function hp({
  sources: t,
  ...
  const [d, w] = S([]), [g, h] = S([{ id: le, desc: !1 }]), [p, m] = S({}), x = j(
  ...
  H(() => {
    if (c) {
      const T = N.getSelectedRowModel().rowsById, z = Object.keys(T);
      if (z.length === 1) {
        const O = x.find(($) => No($) === z[0]) || void 0;
        O && c(O);
      }
    }
  }, [p, x, c, N]);
  const b = n ?? uw, _ = i ?? Pn, k = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${b}`, value: [le] },
    { label: `Group by ${_}`, value: [ke] },
    {
      label: `Group by ${b} and ${_}`,
      value: [le, ke]
    },
    {
      label: `Group by ${_} and ${b}`,
      value: [ke, le]
    }
  ], I = (T) => {
    w(JSON.parse(T));
  ...
  }, M = (T, z) => T.getIsGrouped() ? "" : f("banded-row", z % 2 === 0 ? "even" : "odd"), C = (T, z, O) => {
    if (!((T == null ? void 0 : T.length) === 0 || z.depth < O.column.getGroupedIndex())) {
      if (z.getIsGrouped())
        switch (z.depth) {
          case 1:
            return "tw:ps-4";
  ...
  return /* @__PURE__ */ u("div", { id: l, className: "pr-twp tw:flex tw:h-full tw:w-full tw:flex-col", children: [
    !e && /* @__PURE__ */ u(
      Ve,
      {
        ...
        children: [
          /* @__PURE__ */ a(Fe, { className: "tw:mb-1 tw:mt-2", children: /* @__PURE__ */ a(je, {}) }),
          /* @__PURE__ */ a(Be, { position: "item-aligned", children: /* @__PURE__ */ a(pd, { children: k.map((T) => /* @__PURE__ */ a(At, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ma, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Oa, { children: N.getHeaderGroups().map((T) => /* @__PURE__ */ a(de, { children: T.headers.filter((z) => z.column.columnDef.header).map((z) => (
        ...
        /* @__PURE__ */ a(zr, { colSpan: z.colSpan, className: "tw:sticky top-0", children: z.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Je(z.column.columnDef.header, z.getContext())
        ] }) }, z.id)
      )) }, T.id)) }),
      /* @__PURE__ */ a(Ia, { children: N.getRowModel().rows.map((T, z) => {
        const O = ct();
        return /* @__PURE__ */ a(
          de,
          {
            ...
            children: T.getVisibleCells().map(($) => {
              if (!($.getIsPlaceholder() || $.column.columnDef.enableGrouping && !$.getIsGrouped() && ($.column.columnDef.id !== ke || !r)))
                return /* @__PURE__ */ a(
                  Pe,
                  {
                    className: f(
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ u(
                      V,
                      {
                        ...
                        children: [
                          ...
                          !T.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ a(Qr, {}) : /* @__PURE__ */ a(Zr, {})),
                          " ",
                          Je($.column.columnDef.cell, $.getContext()),
                          " (",
                          T.subRows.length,
                          ")"
                        ]
...
const La = (t, e) => t.filter((r) => {
  try {
    return Xe(r) === e;
  } catch {
    return !1;
  }
}), Ln = (t, e, r) => La(t, e).every((o) => r.includes(o));
function fw({
  section: t,
  availableBookIds: e,
  selectedBookIds: r,
  ...
  const i = La(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    V,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        Ln(e, t, r) && !i && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: i,
      children: _c(
        t,
...
function mw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: h, ntLong: p, dcLong: m, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, N] = S(!1), [b, _] = S(""), k = G(void 0), I = G(!1);
  if (t.length !== lt.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const L = j(() => lt.allBookIds.filter(
    (P, Y) => t[Y] === "1" && !lt.isObsolete(lt.bookIdToNumber(P))
  ), [t]), M = j(() => {
    if (!b.trim()) {
      const y = {
        [W.OT]: [],
    ...
    (P, Y = !1) => {
      if (!Y || !k.current) {
        r(
          e.includes(P) ? e.filter((ut) => ut !== P) : [...e, P]
        ), k.current = P;
        return;
      }
      const y = L.findIndex((ut) => ut === k.current), U = L.findIndex((ut) => ut === P);
      if (y === -1 || U === -1) return;
      const [dt, ft] = [
        Math.min(y, U),
        Math.max(y, U)
      ], zt = L.slice(dt, ft + 1).map((ut) => ut);
      r(
        e.includes(P) ? e.filter((ut) => !zt.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...zt])]
      );
    },
    [e, r, L]
  ), T = (P) => {
    C(P, I.current), I.current = !1;
  }, z = (P, Y) => {
    P.preventDefault(), C(Y, P.shiftKey);
  }, O = F(
    (P) => {
      const Y = La(L, P).map((y) => y);
      r(
        Ln(L, P, e) ? e.filter((y) => !Y.includes(y)) : [.../* @__PURE__ */ new Set([...e, ...Y])]
      );
    },
    [e, r, L]
  ), $ = () => {
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(W).map((P) => /* @__PURE__ */ a(
      fw,
      {
        section: P,
        availableBookIds: L,
        ...
        children: [
          ...
          /* @__PURE__ */ a(ae, { className: "tw:w-full tw:p-0", align: "start", children: /* @__PURE__ */ u(
            fe,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
                P.key === "Enter" && (I.current = P.shiftKey);
              },
              children: [
                /* @__PURE__ */ a(
                  sr,
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: $, children: l }),
                  /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: q, children: d })
                ] }),
                /* @__PURE__ */ u(me, { children: [
                  /* @__PURE__ */ a(Dr, { children: w }),
                  Object.values(W).map((P, Y) => {
                    const y = M[P];
                    if (y.length !== 0)
                      return /* @__PURE__ */ u(Oo, { children: [
                        /* @__PURE__ */ a(
                          Qt,
                          {
                            heading: rn(P, h, p, m, x),
                            children: y.map((U) => /* @__PURE__ */ a(
                              on,
                              {
                                bookId: U,
                                isSelected: e.includes(U),
                                onSelect: () => T(U),
                                onMouseDown: (dt) => z(dt, U),
                                section: Xe(U),
                                showCheck: !0,
                                localizedBookNames: n,
                                commandValue: na(U, n),
                        ...
                        Y < Object.values(W).length - 1 && /* @__PURE__ */ a(en, {})
                      ] }, P);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Hr ? Hr : Co
      ).map((P) => /* @__PURE__ */ a(er, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ie(P, n) }, P)),
      e.length > Hr && /* @__PURE__ */ a(
        er,
        {
          className: "tw:hover:bg-secondary",
          variant: "secondary",
          children: `+${e.length - Co} ${g}`
        }
      )
    ] })
  ] });
...
function mp({
  ...
  const d = xe(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = xe(s, "%webView_scope_selector_current_book%"), p = xe(s, "%webView_scope_selector_choose_books%"), m = xe(s, "%webView_scope_selector_scope%"), x = xe(s, "%webView_scope_selector_select_books%"), v = [
  ...
  ], N = e ? v.filter((b) => e.includes(b.value)) : v;
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        nn,
        {
          ...
          children: N.map(({ value: b, label: _, id: k }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ia, { className: "tw:me-2", value: b, id: k }),
...
function vp({
  ...
  return /* @__PURE__ */ u(
    Ve,
    {
      ...
      children: [
        /* @__PURE__ */ a(Fe, { size: n, className: f("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          je,
          {
            placeholder: c[Q(e)] ?? e
          }
        ...
        /* @__PURE__ */ a(
          Be,
          {
            ...
            style: { zIndex: qe },
            children: t.map((d) => /* @__PURE__ */ a(At, { value: `${d}`, children: c[Q(d)] }, `${d}`))
          }
        )
      ]
    }
...
const jn = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(_t, { children: [
  ...
  ) : /* @__PURE__ */ u(cd, { children: [
    /* @__PURE__ */ a(ld, { children: c.label }),
    /* @__PURE__ */ a(nd, { children: /* @__PURE__ */ a(dd, { children: jn(
      t,
      e,
      Vn(t, c.id),
      o
...
function ga({
  ...
  return /* @__PURE__ */ u(ue, { variant: i, children: [
    /* @__PURE__ */ a(pe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Yi, {}) }) }),
    /* @__PURE__ */ a(ge, { align: "start", style: { zIndex: qe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Oo, { children: [
      /* @__PURE__ */ a(Mn, { children: /* @__PURE__ */ a(kt, { children: jn(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(cr, {})
    ] }, l)) })
  ] });
}
const Fn = rt.forwardRef(
...
function kp({
  ...
  return /* @__PURE__ */ u(Fn, { className: `tw:w-full tw:border ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      ga,
      {
        onSelectMenuItem: t,
...
function _p({
  ...
  return /* @__PURE__ */ a(Fn, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    ga,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const Bn = rt.forwardRef(({ className: t, ...e }, r) => {
  const o = ct();
  return /* @__PURE__ */ a(
    Pt.Root,
    {
...
Bn.displayName = Pt.List.displayName;
const Un = rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Pt.List,
  {
    ref: r,
    className: f(
...
Un.displayName = Pt.List.displayName;
const vw = rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Pt.Trigger,
  {
    ref: r,
    ...e,
...
)), Kn = rt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  Pt.Content,
  {
    ref: r,
    className: f(
...
Kn.displayName = Pt.Content.displayName;
function Np({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Bn, { children: [
      /* @__PURE__ */ a(Un, { children: t.map((c) => /* @__PURE__ */ a(vw, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(Kn, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function bw({
  ...
  return /* @__PURE__ */ a($a.Provider, { value: o, children: /* @__PURE__ */ a(
    qt.Root,
    {
      "data-slot": "menubar",
      className: f(
  ...
  return /* @__PURE__ */ a(
    qt.Trigger,
    {
      ...
      className: f(
        ...
        "pr-twp",
        // CUSTOM: Apply variant-driven styles from menu context
        Re({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
...
function _w({
  ...
  const i = oe();
  return /* @__PURE__ */ a(yw, { children: /* @__PURE__ */ a(
    qt.Content,
    {
...
function zw({
  ...
  return /* @__PURE__ */ u(
    qt.SubTrigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(fa, { className: "tw:ms-auto tw:size-4" })
      ]
    }
  );
}
...
const Ye = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(_t, { children: [
      /* @__PURE__ */ a(Nt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        Nw,
        {
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(Tr, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(Tr, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(Ew, { children: [
        /* @__PURE__ */ a(zw, { children: d.label }),
        /* @__PURE__ */ a(Tw, { children: qn(
          t,
          e,
          Vn(t, d.id),
          o
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Cw, {}, `separator-${i}`)), l;
  });
};
function Sw({
  menuData: t,
  ...
  if (oc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, x, v, N;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (m = i.current) == null || m.focus(), Ye(i, [h, p]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Ye(s, [h, p]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), Ye(c, [h, p]);
        break;
      case "alt+h":
        (N = l.current) == null || N.focus(), Ye(l, [h, p]);
        break;
    }
  }), H(() => {
    ...
    return /* @__PURE__ */ a(bw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(xw, { children: [
      /* @__PURE__ */ a(kw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        _w,
        {
          style: { zIndex: qe },
          children: /* @__PURE__ */ a(kt, { children: qn(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function zp({
  ...
  const d = Rw(
    ...
    var N, b, _, k, I, L;
    const v = x !== m ? ((b = (N = t[m]) == null ? void 0 : N.uiNames) == null ? void 0 : b[x]) ?? ((k = (_ = t[m]) == null ? void 0 : _.uiNames) == null ? void 0 : k.en) : void 0;
    return v ? `${(I = t[m]) == null ? void 0 : I.autonym} (${v})` : (L = t[m]) == null ? void 0 : L.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: f("pr-twp tw:max-w-sm", c), children: [
    /* @__PURE__ */ u(
      Ve,
      {
        ...
        onOpenChange: (m) => g(m),
        children: [
          /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(je, {}) }),
          /* @__PURE__ */ a(
            Be,
            {
              style: { zIndex: qe },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(At, { value: m, children: p(m, e) }, m))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(pt, { className: "tw:font-normal tw:text-muted-foreground", children: _e(d, {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(ue, { children: [
              /* @__PURE__ */ a(pe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(V, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ha, {}) }) }),
              /* @__PURE__ */ a(ge, { align: "end", children: d })
            ] }) }),
            e && d && /* @__PURE__ */ u(ue, { children: [
              /* @__PURE__ */ a(pe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(V, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ha, {}) }) }),
              /* @__PURE__ */ a(ge, { align: "end", children: d })
            ] })
          ] }),
...
const $w = nr(({ className: t, ...e }, r) => /* @__PURE__ */ a(Zi, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Kp({
  ...
  return /* @__PURE__ */ u(
    ht.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(ht.ItemIndicator, { children: /* @__PURE__ */ a(Te, {}) }) }),
        e
      ]
    }
  );
...
function Zp({
  ...
  const n = ct();
  return /* @__PURE__ */ u(Ow, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Iw, {}),
    /* @__PURE__ */ u(
      he.Content,
      {
...
function sg({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    ic,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(di, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(li, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(ci, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(si, { className: "tw:size-4" }),
        loading: /* @__PURE__ */ a(ii, { className: "tw:size-4 tw:animate-spin" })
      },
      style: {
...
function wg({
  ...
  return /* @__PURE__ */ a(
    Pt.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", Aw({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
Vw(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  $p as AlertTitle,
  ad as Avatar,
  od as AvatarFallback,
  Ru as AvatarImage,
  xu as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  yu as BOOK_SELECTOR_STRING_KEYS,
  er as Badge,
  bu as BookChapterControl,
  ca as BookSelectionMode,
  ku as BookSelector,
  V as Button,
  Nu as COMMENT_EDITOR_STRING_KEYS,
  Cu as COMMENT_LIST_STRING_KEYS,
  ed as Card,
  rd as CardContent,
  Tu as CardDescription,
  Su as CardFooter,
  Eu as CardHeader,
  zu as CardTitle,
  ...
  $u as CommentList,
  Op as ContextMenu,
  Kp as ContextMenuCheckboxItem,
  jp as ContextMenuContent,
  Ap as ContextMenuGroup,
  Fp as ContextMenuItem,
  Gp as ContextMenuLabel,
  Pp as ContextMenuPortal,
  Vp as ContextMenuRadioGroup,
  qp as ContextMenuRadioItem,
  Hp as ContextMenuSeparator,
  Wp as ContextMenuShortcut,
  Lp as ContextMenuSub,
  Up as ContextMenuSubContent,
  Bp as ContextMenuSubTrigger,
  Ip as ContextMenuTrigger,
  yd as DataTable,
  pc as Dialog,
  wu as DialogClose,
  fc as DialogContent,
  pu as DialogDescription,
  uu as DialogFooter,
  mc as DialogHeader,
  hc as DialogOverlay,
  gc as DialogPortal,
  ...
  ua as DropdownMenuItem,
  Nd as DropdownMenuItemType,
  ...
  Lu as ERROR_POPOVER_STRING_KEYS,
  Sd as EditorKeyboardShortcuts,
  _d as ErrorDump,
  Vu as ErrorPopover,
  qu as FOOTNOTE_EDITOR_STRING_KEYS,
  Uu as Filter,
  ju as FilterDropdown,
  Bu as Footer,
  Ku as FootnoteEditor,
  Kd as FootnoteItem,
  Gu as FootnoteList,
  Qu as INVENTORY_STRING_KEYS,
  ir as Input,
  tp as Inventory,
  pt as Label,
  Id as MARKER_MENU_STRING_KEYS,
  Pu as MarkdownRenderer,
  Pd as MarkerMenu,
  Fu as MoreInfo,
  Ed as MultiSelectComboBox,
  Np as NavigationContentSearch,
  re as Popover,
  Nc as PopoverAnchor,
  ae as PopoverContent,
  mu as PopoverDescription,
  hu as PopoverHeader,
  fu as PopoverTitle,
  ve as PopoverTrigger,
  ag as Progress,
  nn as RadioGroup,
  ia as RadioGroupItem,
  Cc as RecentSearches,
  ig as ResizableHandle,
  ng as ResizablePanel,
  ...
  ko as SidebarGroupLabel,
  op as SidebarHeader,
  ap as SidebarInput,
  rw as SidebarInset,
  ow as SidebarMenu,
  cp as SidebarMenuAction,
  lp as SidebarMenuBadge,
  ...
  zd as UNDO_REDO_BUTTONS_STRING_KEYS,
  zp as UiLanguageSelector,
  Td as UndoRedoButtons,
  Bn as VerticalTabs,
  Kn as VerticalTabsContent,
  Un as VerticalTabsList,
  vw as VerticalTabsTrigger,
  qe as Z_INDEX_ABOVE_DOCK,
  Qo as Z_INDEX_FOOTNOTE_EDITOR,
  wc as Z_INDEX_MODAL,
  dc as Z_INDEX_MODAL_BACKDROP,
  lc as Z_INDEX_OVERLAY,
  td as badgeVariants,
  tn as buttonVariants,
  f as cn,
  Zu as getBookIdFromUSFM,
  Or as getInventoryHeader,
  Xu as getLinesFromUSFM,
  Ju as getNumberFromUSFM,
  Yd as getStatusForItem,
  Cp as getToolbarOSReservedSpaceClassName,
  Wu as inventoryCountColumn,
  Hu as inventoryItemColumn,
  Yu as inventoryStatusColumn,
  bg as sonner,
  gg as useEvent,
  hg as useEventAsync,
  Ql as useListbox,
  Lw as usePromise,
  vu as useRecentSearches,
  Ir as useSidebar,
  fg as useStylesheet
};
