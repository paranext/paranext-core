...
var ft = (e, t, n) => cs(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as it } from "react/jsx-runtime";
import b, { forwardRef as en, useRef as tt, useMemo as $, useState as O, useCallback as z, useLayoutEffect as jt, createContext as yn, useContext as hr, useEffect as J, Component as ds, createElement as $r, Suspense as ps, createRef as us, Fragment as ho } from "react";
import { Command as vt } from "cmdk";
import { X as nn, Search as fo, Check as Ot, Clock as Lr, ChevronsLeft as Br, ChevronsRight as jr, ChevronLeft as Yn, ChevronRight as Ee, ArrowLeft as ms, ArrowRight as hs, Circle as Nn, ChevronDown as fe, BoldIcon as fs, ItalicIcon as gs, UnderlineIcon as bs, StrikethroughIcon as vs, Pencil as xs, Trash2 as ys, ArrowUp as go, MoreHorizontal as bo, ChevronUp as qn, AtSign as Ns, FilterIcon as ks, ArrowLeftIcon as _s, ChevronLeftIcon as Cs, ChevronRightIcon as Es, ArrowRightIcon as Ss, Copy as vo, Filter as Ts, User as Rs, Link as Ds, CircleHelp as Ms, ChevronsUpDown as xo, Star as Os, SquareX as yo, FunctionSquare as No, SquareSigma as ko, AlertCircle as Jn, CircleCheckIcon as Is, CircleXIcon as As, CircleHelpIcon as Vs, ArrowUpIcon as Ps, ArrowDownIcon as $s, ArrowUpDownIcon as Ls, PanelLeft as Bs, PanelRight as js, ScrollText as zs, MenuIcon as Fs, Menu as Gs, EllipsisVertical as Hs, LoaderCircle as Xs, GripVertical as Ks } from "lucide-react";
import { clsx as Us } from "clsx";
import { extendTailwindMerge as Ys } from "tailwind-merge";
import * as Et from "@radix-ui/react-dialog";
import { includes as wn, Section as X, getChaptersForBook as qs, formatScrRef as de, getSectionForBook as Xe, formatRelativeDate as Js, formatReplacementString as ce, sanitizeHtml as Ws, parseParatextHtml as zr, hasCustomParatextTags as Zs, NumberFormat as Qs, formatBytes as ti, getCurrentLocale as ei, getFormatCallerFunction as ni, deepEqual as ri, isString as Fr, compareScrRefs as Wn, scrRefToBBBCCCVVV as Pn, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as Co, $getRoot as Jt, $createParagraphNode as kn, $getSelection as zt, HISTORY_MERGE_TAG as fr, ParagraphNode as Eo, TextNode as So, $isTokenOrSegmented as oi, $getCharacterOffsets as ai, $cloneWithPropertiesEphemeral as si, $findMatchingParent as ii, $isElementNode as pe, CLEAR_EDITOR_COMMAND as To, COMMAND_PRIORITY_EDITOR as Ro, $isRangeSelection as We, shallowMergeConfig as li, defineExtension as Gt, safeCast as rn, RootNode as wi, LineBreakNode as ci, TabNode as di, $isEditorState as pi, createCommand as ui, CLICK_COMMAND as mi, isDOMNode as hi, $getNodeFromDOMNode as fi, $isNodeSelection as gi, $createNodeSelection as bi, $setSelection as vi, COMMAND_PRIORITY_LOW as xi, DecoratorNode as yi, $create as Ni, $getNodeByKey as ki, INDENT_CONTENT_COMMAND as Gr, COMMAND_PRIORITY_CRITICAL as gr, KEY_TAB_COMMAND as _i, $createRangeSelection as Ci, $normalizeSelection__EXPERIMENTAL as Ei, OUTDENT_CONTENT_COMMAND as Si, INSERT_TAB_COMMAND as Ti, $isBlockElementNode as fn, $isDecoratorNode as Ri, $isParagraphNode as Di, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Do, FORMAT_TEXT_COMMAND as Mi, getRegisteredNode as Oi, isHTMLElement as Ii, isDocumentFragment as Hr, isDOMDocumentNode as Ai, ArtificialNode__DO_NOT_USE as Mo, $createLineBreakNode as Oo, $isRootOrShadowRoot as Vi, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Pi } from "lexical";
...
import { useReactTable as Po, getFilteredRowModel as Xi, getSortedRowModel as $o, getPaginationRowModel as Ki, getCoreRowModel as Lo, flexRender as Ke, getGroupedRowModel as Ui, getExpandedRowModel as Yi } from "@tanstack/react-table";
import * as at from "@radix-ui/react-select";
import qi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Zn, HIDDEN_NOTE_CALLER as Qn, getDefaultViewOptions as Ji, isInsertEmbedOpOfType as cn, Editorial as Wi } from "@eten-tech-foundation/platform-editor";
...
const nl = Et.Root, rl = Et.Portal, Bo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
    className: h(
...
Bo.displayName = Et.Overlay.displayName;
...
jo.displayName = Et.Content.displayName;
...
const Fo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Title,
  {
    ref: n,
...
Fo.displayName = Et.Title.displayName;
...
ol.displayName = Et.Description.displayName;
...
const Ve = b.forwardRef(({ className: e, ...t }, n) => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ o(fo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ o(
      vt.Input,
      {
        ref: n,
...
Ve.displayName = vt.Input.displayName;
...
ee.displayName = vt.List.displayName;
const an = b.forwardRef((e, t) => /* @__PURE__ */ o(vt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
an.displayName = vt.Empty.displayName;
...
Ft.displayName = vt.Group.displayName;
...
Go.displayName = vt.Separator.displayName;
...
Ho.displayName = "CommandShortcut";
var al = Object.defineProperty, sl = (e, t, n) => t in e ? al(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, H = (e, t, n) => sl(e, typeof t != "symbol" ? t + "" : t, n);
const ge = [
  "GEN",
  "EXO",
  "LEV",
...
function Pe(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Ur ? Ur[e] : 0;
}
function xr(e) {
  return Pe(e) > 0;
}
...
function qo(e) {
  const t = typeof e == "number" ? yr(e) : e;
  return xr(t) && !vr.includes(t);
}
function ml(e) {
  const t = typeof e == "number" ? yr(e) : e;
  return xr(t) && vr.includes(t);
...
H(yt, "Original", new yt(Dt.Original)), H(yt, "Septuagint", new yt(Dt.Septuagint)), H(yt, "Vulgate", new yt(Dt.Vulgate)), H(yt, "English", new yt(Dt.English)), H(yt, "RussianProtestant", new yt(Dt.RussianProtestant)), H(yt, "RussianOrthodox", new yt(Dt.RussianOrthodox));
let ie = yt;
function Yr(e, t) {
  const n = t[0];
...
const bt = class U {
  constructor(t, n, r, a) {
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        const s = t, i = n != null && n instanceof ie ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (t != null && typeof t == "number") {
        const s = n != null && n instanceof ie ? n : void 0;
        ...
        if (t != null && t instanceof U) {
          ...
          if (t == null) return;
          const s = t instanceof ie ? t : U.defaultVersification;
          this.setEmpty(s);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new ie(i)), n ? new U(n, r.toString(), l, c) : new U();
  }
  /**
  ...
  set versificationStr(t) {
    this.versification = this.versification != null ? new ie(t) : void 0;
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new ie(Dt[i]);
        } catch {
    ...
    if (r.length !== 2 || Z.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !U.isVerseParseable(r[1]))
      throw new ze("Invalid reference : " + t);
  ...
  allVerses(t = !1, n = U.verseRangeSeparators, r = U.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = Yr(this._verse, r);
    for (const i of s.map((l) => Yr(l, n))) {
      const l = this.clone();
      l.verse = i[0];
      const c = l.verseNum;
...
const Zo = Z.allBookIds.filter(
  (e) => !Z.isObsolete(Z.bookIdToNumber(e))
), ue = Object.fromEntries(
  Zo.map((e) => [e, Z.bookIdToEnglishName(e)])
);
function kr(e, t, n) {
...
const Qo = en(
    ...
    return /* @__PURE__ */ o(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: c || `${e} ${Z.bookIdToEnglishName(e)}`,
            onSelect: m,
            onMouseDown: f,
            role: "option",
            "aria-selected": t,
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Ie : "button", { className: h(bl({ variant: t, size: n, className: e })), ref: s, ...a })
);
L.displayName = "Button";
const xe = Se.Root, ye = Se.Trigger, mp = Se.Anchor, ne = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = dt();
...
ne.displayName = Se.Content.displayName;
function rr(e, t, n) {
  return `${e} ${ue[e]}${t ? ` ${Nr(e, t)} ${Ce(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function vl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ d(xe, { open: c, onOpenChange: w, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        variant: "ghost",
        size: "icon",
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Lr, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(ne, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: /* @__PURE__ */ o(Ft, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Ht,
      {
        onSelect: () => p(m),
        className: h("tw-flex tw-items-center", l),
        children: [
          /* @__PURE__ */ o(Lr, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function hp(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
...
function fp({
  ...
  const w = dt(), [p, m] = O(!1), [f, u] = O(""), [g, k] = O(""), [v, T] = O("books"), [N, E] = O(void 0), [A, j] = O(!1), P = tt(void 0), x = tt(void 0), C = tt(void 0), y = tt(void 0), S = tt({}), I = z(
    (M) => {
      t(M), l && l(M);
    },
    [t, l]
  ), V = $(() => r ? r() : Zo, [r]), F = $(() => ({
    [X.OT]: V.filter((_) => Z.isBookOT(_)),
    [X.NT]: V.filter((_) => Z.isBookNT(_)),
    [X.DC]: V.filter((_) => Z.isBookDC(_)),
    [X.Extra]: V.filter((_) => Z.extraBooks().includes(_))
  }), [V]), R = $(() => Object.values(F).flat(), [F]), G = $(() => {
    if (!g.trim()) return F;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    return [X.OT, X.NT, X.DC, X.Extra].forEach((Y) => {
      M[Y] = F[Y].filter((st) => kr(st, g, a));
    }), M;
  }, [F, g, a]), D = $(
    () => yl(g, R, a),
    [g, R, a]
    ...
    (M) => {
      const _ = v === "chapters" ? N : D == null ? void 0 : D.book;
      _ && (I({
        book: _,
        chapterNum: M,
        verseNum: 1
      }), m(!1), T("books"), E(void 0), k(""));
    },
    [I, v, N, D]
  ), _t = z(
    (M) => {
    ...
    (M) => {
      ...
      m(M), M && (T("books"), E(void 0), k(""));
    },
    [v, Ct]
  ), { otLong: ot, ntLong: wt, dcLong: ut, extraLong: ht } = {
    ...
    (M) => D ? !!D.chapterNum && !M.toString().includes(D.chapterNum.toString()) : !1,
    [D]
  ), In = $(
    () => de(
      e,
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: Y } = qr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (_ || Y) {
          if (M.preventDefault(), M.stopPropagation(), T("books"), E(void 0), Y && N) {
            const st = ue[N];
            k(`${st} ${M.key}`);
          } else
            k(M.key);
      ...
      if ((v === "chapters" || v === "books" && D) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const st = v === "chapters" ? N : D == null ? void 0 : D.book;
        if (!st) return;
        const mt = (() => {
          if (!f) return 1;
          const je = f.match(/(\d+)$/);
        ...
        switch (M.key) {
          case "ArrowLeft":
            mt !== 0 && (Vt = mt > 1 ? mt - 1 : ae);
            break;
          case "ArrowRight":
            mt !== 0 && (Vt = mt < ae ? mt + 1 : 1);
            break;
          case "ArrowUp":
            Vt = mt === 0 ? ae : Math.max(1, mt - Pr);
            break;
          case "ArrowDown":
            Vt = mt === 0 ? 1 : Math.min(ae, mt + Pr);
            break;
          default:
            return;
        }
        Vt !== mt && (M.preventDefault(), M.stopPropagation(), u(rr(st, a, Vt)), setTimeout(() => {
          const je = S.current[Vt];
    ...
    const { isLetter: _, isDigit: Y } = qr(M.key);
    (_ || Y) && (M.preventDefault(), k((st) => st + M.key), x.current.focus(), j(!1));
  }, []);
  return jt(() => {
    const M = setTimeout(() => {
      if (p && v === "books" && C.current && y.current) {
        const _ = C.current, Y = y.current, st = Y.offsetTop, mt = _.clientHeight, ae = Y.clientHeight, Vt = st - mt / 2 + ae / 2;
        _.scrollTo({
          top: Math.max(0, Vt),
          behavior: "smooth"
        }), u(rr(e.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if (C.current)
          if (M) {
            const _ = S.current[e.chapterNum];
  ...
  }, [v, N, D, e.book, e.chapterNum]), /* @__PURE__ */ d(xe, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        children: /* @__PURE__ */ o("span", { className: "tw-truncate", children: In })
      }
    ) }),
    /* @__PURE__ */ o(ne, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      te,
      {
        ref: P,
        onKeyDown: Vn,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: lt.map(({ onClick: M, disabled: _, title: Y, icon: st }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !A && /* @__PURE__ */ d(ee, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(it, { children: [
              !D && Object.entries(G).map(([M, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Ft, { heading: Nt(M), children: _.map((Y) => /* @__PURE__ */ o(
                      Qo,
                      {
                        bookId: Y,
                        onSelect: (st) => pt(st),
              ...
              D && /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(
                Ht,
                {
                  ...
                  children: de(
                    ...
                    a ? Nr(D.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              D && Mt(D.book) > 1 && /* @__PURE__ */ d(it, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(D.book, a) }),
                /* @__PURE__ */ o(
                  Jr,
                  {
                    bookId: D.book,
...
), ct = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(_o.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
ct.displayName = _o.Root.displayName;
const _r = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    Je.Root,
    {
...
_r.displayName = Je.Root.displayName;
const bn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Je.Item,
  {
    ref: n,
    className: h(
    ...
    ...t,
    children: /* @__PURE__ */ o(Je.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(Nn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
...
function or({
  ...
  const [N, E] = O(!1), A = c ?? l, j = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], P = (x, C) => {
    const y = l(x), S = typeof x == "object" && "secondaryLabel" in x ? x.secondaryLabel : void 0, I = `${C ?? ""}${y}${S ?? ""}`;
    return /* @__PURE__ */ d(
      Ht,
      {
        value: y,
  ...
  return /* @__PURE__ */ d(xe, { open: N, onOpenChange: E, ...T, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ o(fe, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          /* @__PURE__ */ o(Ve, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ o(an, { children: f }),
          /* @__PURE__ */ o(ee, { children: j(t) ? t.map((x) => /* @__PURE__ */ o(Ft, { heading: x.groupHeading, children: x.options.map((C) => P(C, x.groupHeading)) }, x.groupHeading)) : t.map((x) => P(x)) })
        ] })
      }
    )
  ] });
...
function Cl({
  ...
  return /* @__PURE__ */ d(it, { children: [
    /* @__PURE__ */ o(ct, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ o(
      or,
      {
        isDisabled: a,
    ...
    /* @__PURE__ */ o(ct, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ o(
      or,
      {
        isDisabled: a,
...
function vp({
  ...
  const p = Ln(w, "%webView_bookSelector_currentBook%"), m = Ln(w, "%webView_bookSelector_choose%"), f = Ln(w, "%webView_bookSelector_chooseBooks%"), [u, g] = O(
    "current book"
    /* CURRENT_BOOK */
  ), k = (v) => {
    g(v), e(v);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(ct, { className: "tw-ms-1", children: p })
          ] }),
          /* @__PURE__ */ o(ct, { className: "tw-flex tw-items-center", children: t }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ o(ct, { className: "tw-ms-1", children: f })
          ] }),
          /* @__PURE__ */ o(ct, { className: "tw-flex tw-items-center", children: r.map((v) => Z.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ o(
            L,
            {
...
const xp = [
  ...
  const a = tt(null), [s, i] = O(void 0), [l, c] = O(void 0), w = z(
    (u) => {
      i(u);
    ...
    (u) => {
      var x;
      const g = u.target, k = (C) => C ? document.getElementById(C) : void 0, v = k(l), T = k(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const C = e.find((y) => y.id === l);
            C && w(C.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const y = C.findIndex((I) => I === g);
          if (y === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(y + 1, C.length - 1) : S = Math.max(y - 1, 0), S !== y && (u.preventDefault(), u.stopPropagation(), (x = C[S]) == null || x.focus());
          return;
        }
        return;
      }
      const A = e.findIndex((C) => C.id === s);
      let j = A;
      switch (u.key) {
        case "ArrowDown":
          j = Math.min(A + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(A - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const ea = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = ea ? jt : J, dn = { tag: fr };
function Ol({ initialConfig: e, children: t }) {
  const n = $(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Dl(null, r), p = Co({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = kn();
            u.append(g);
            const k = ea ? document.activeElement : null;
            (zt() !== null || k !== null && k === m.getRootElement()) && g.select();
          }
        }, dn);
...
const Il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : J;
function Al({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  ...
  return Il(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: c }) => {
      t && s.size === 0 && i.size === 0 || e && c.has(fr) || l.isEmpty() || n(a, r, c);
    });
  }, [r, e, t, n]), null;
}
const Cr = {
  ...
  mark: "",
  markOverlap: ""
}, $t = on.Provider, Yt = on.Root, me = on.Trigger, Lt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  on.Content,
  {
    ref: r,
    sideOffset: t,
...
Lt.displayName = on.Content.displayName;
const Er = [
  Li,
  Eo,
  So,
...
class Pl extends ds {
  constructor(t) {
    super(t), this.resetErrorBoundary = this.resetErrorBoundary.bind(this), this.state = Bn;
  }
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : J;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = It(), n = $(() => e(t), [t, e]), [r, a] = O(() => n.initialValueFn()), s = tt(r);
    return Bl(() => {
...
function Fl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !oi(t) && r !== null) {
    ...
    if (w || p) {
      const [m, f] = ai(e), u = l.is(c), g = t.is(i ? c : l), k = t.is(i ? l : c);
      let v, T = 0;
      u ? (T = m > f ? f : m, v = m > f ? m : f) : g ? (T = i ? f : m, v = void 0) : k && (T = 0, v = i ? m : f);
      const N = t.__text.slice(T, v);
      N !== t.__text && (n === "clone" && (t = si(t)), t.__text = N);
    }
  }
  return t;
}
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Hl = na && "documentMode" in document ? document.documentMode : null;
!(!na || !("InputEvent" in window) || Hl) && "getTargetRanges" in new window.InputEvent("input");
function ra(...e) {
  const t = [];
...
function le(e, t) {
  gt.call(this, void 0), this.x = e, this.s = void 0, this.g = mn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function ql(e, t) {
  return new le(e, t);
}
...
function Jl(e) {
  ...
  sa(this), q = e, this.f &= -2, 8 & this.f && Sr(this), Cn();
}
function _e(e, t) {
...
function En(e, t = {}) {
  const n = {};
  for (const r in e) {
    const a = t[r], s = Ze(a === void 0 ? e[r] : a);
    n[r] = s;
  }
  return n;
}
gt.prototype.brand = Ul, gt.prototype.h = function() {
  return !0;
}, gt.prototype.S = function(e) {
  const t = this.t;
  t !== e && e.e === void 0 && (e.x = t, this.t = e, t !== void 0 ? t.e = e : Zr(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const t = e.e, n = e.x;
    t !== void 0 && (t.x = n, e.e = void 0), n !== void 0 && (n.e = t, e.x = void 0), e === this.t && (this.t = n, n === void 0 && Zr(() => {
      var r;
...
} }), le.prototype = new gt(), le.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === mn)) return !0;
  if (this.g = mn, this.f |= 1, this.i > 0 && !aa(this)) return this.f &= -2, !0;
  const e = q;
  try {
    to(this), q = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ia(this), to(this), qt++;
  const e = q;
  return q = this, Jl.bind(this, e);
...
Gt({ build: (e, t, n) => En(t), config: rn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
  return Zt(() => r.disabled.value ? void 0 : e.registerRootListener((a) => {
    e.focus(() => {
...
function la() {
  ...
  e.clear(), e.append(n), t !== null && n.select(), We(t) && (t.format = 0);
}
function wa(e, t = la) {
  return e.registerCommand(To, (n) => (e.update(t), !0), Ro);
}
Gt({ build: (e, t, n) => En(t), config: rn({ $onClear: la }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Zt(() => wa(e, r.value));
} });
function Wl(e) {
...
function ca(e, t) {
  let n;
  return Ze(e(), { unwatched() {
    n && (n(), n = void 0);
  }, watched() {
    this.value = e(), n = t(this);
  } });
}
const sr = Gt({ build: (e) => ca(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Tr = 0, ir = 1, pa = 2, jn = 3, pn = 4, ke = 5, zn = 6, Fe = 7;
function Fn(e) {
  return e.id === Tr;
}
function ua(e) {
...
function Zl(e) {
  return function(t) {
    return t.id === ir;
  }(e) || Q(305, String(e.id), String(ir)), Object.assign(e, { id: pa });
}
...
class tw {
  constructor(t, n) {
    ...
    ft(this, "state");
    ft(this, "_signal");
    this.builder = t, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Tr };
  }
  mergeConfigs() {
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== pn && Q(307, String(n.id), String(ke)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
    const a = { ...n.registerState, getOutput: () => r, getSignal: this.getSignal.bind(this) };
    this.state = function(s, i, l) {
      return Object.assign(s, { id: ke, output: i, registerState: l });
    }(n, r, a);
  }
  register(t, n) {
    this._signal = n;
    const r = this.state;
    r.id !== ke && Q(308, String(r.id), String(ke));
    const a = this.extension.register && this.extension.register(t, r.config, r.registerState);
    return this.state = function(s) {
      return Object.assign(s, { id: zn });
    }(r), () => {
      const s = this.state;
      s.id !== Fe && Q(309, String(r.id), String(Fe)), this.state = function(i) {
        return Object.assign(i, { id: ke });
      }(s), a && a();
    };
  }
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== zn && Q(310, String(n.id), String(zn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= jn;
    }(t) || Q(314, String(t.id), String(jn)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= Fe;
    }(t) || Q(316, String(t.id), String(Fe)), t;
  }
...
const nw = Gt({ config: rn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = ew }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [wi, So, ci, di, Eo] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function rw(e) {
  throw e;
...
class Ye {
  ...
  static fromExtensions(t) {
    const n = [un(nw)];
    for (const r of t) n.push(un(r));
    return new Ye(n);
  }
  static maybeFromEditor(t) {
    const n = t[no];
    return n && (n.PACKAGE_VERSION !== Gn && Q(292, n.PACKAGE_VERSION, Gn), n instanceof Ye || Q(293)), n;
  }
  static fromEditor(t) {
    const n = Ye.maybeFromEditor(t);
    return n === void 0 && Q(294), n;
  }
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(Co({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [no]: this });
  ...
  buildEditor() {
    ...
    return t = Wt(this.registerEditor(r), () => r.setRootElement(null)), r;
  }
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== r && Q(298, r.name), !a) {
      a = new tw(this, r), this.extensionNameMap.set(r.name, a);
      const s = this.conflicts.get(r.name);
      typeof s == "string" && Q(299, r.name, s);
      for (const i of r.conflictsWith || []) this.extensionNameMap.has(i) && Q(299, r.name, i), this.conflicts.set(i, r.name);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Fn(s) || Q(300, i, a || "[unknown]"), Fn(l = s) || Q(304, String(l.id), String(Tr)), s = Object.assign(l, { id: ir }), r.state = s;
    ...
    for (const r of this.extensionNameMap.values()) Fn(r.state) && n(r);
...
const ow = /* @__PURE__ */ new Set(), oo = Gt({ build(e, t, n) {
  const r = n.getDependency(sr).output, a = Ze({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ca(() => {
  }, () => Zt(() => {
    ...
    r.value.read(() => {
      if (zt()) for (const [p, m] of l.entries()) {
        ...
        const f = ki(p), u = f && f.isSelected() || !1;
...
Gt({ dependencies: [sr, oo], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(oo).output, a = Ze({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return Wt(e.registerCommand(mi, (i) => {
    if (hi(i.target)) {
      const l = fi(i.target);
      if (sw(l)) return function(c, w = !1) {
        const p = zt(), m = c.isSelected(), f = c.getKey();
        let u;
        w && gi(p) ? u = p : (u = bi(), vi(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, xi), e.registerMutationListener(Te, (i, l) => {
    Yl(() => {
      let c = !1;
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") w.delete(p), c = !0;
        ...
        f ? f.domNode.value = u : (c = !0, w.set(p, { domNode: Ze(u), selectedSignal: r(p) }));
      }
      c && (a.value = { nodeSelections: w });
    });
  }), Zt(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) i.push(Zt(() => {
      const w = l.value;
      w && (c.value ? oa(w, s) : Xl(w, s));
    }));
    return Wt(...i);
  }));
} });
function iw(e, t) {
  return Wt(e.registerCommand(_i, (n) => {
    const r = zt();
    if (!We(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      const i = s.getNodes();
      if (Kl(i, (f) => fn(f) && f.canIndent() ? f : null).length > 0) return !0;
      const l = s.anchor, c = s.focus, w = c.isBefore(l) ? c : l, p = w.getNode(), m = Wr(p);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ci();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Ei(u), u.anchor.is(w)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Si : Gr : Ti;
    return e.dispatchCommand(a, void 0);
  }, Ro), e.registerCommand(Gr, () => {
    const n = typeof t == "number" ? t : t ? t.peek() : null;
    if (n == null) return !1;
    const r = zt();
    if (!We(r)) return !1;
    const a = r.getNodes().map((s) => Wr(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, gr));
}
Gt({ build: (e, t, n) => En(t), config: rn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: r, maxIndent: a } = n.getOutput();
  return Zt(() => {
    if (!r.value) return iw(e, a);
  });
} });
const lw = Gt({ name: "@lexical/react/ReactProvider" });
function ww() {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (c) {
            ...
            e.update(() => {
              ...
              if (We(g)) {
                const k = g.anchor;
                let v = k.getNode(), T = 0, N = 0;
                if (gn(v) && w >= 0 && p >= 0 && (T = w, N = w + p, g.setTextNodeRange(v, T, v, N)), T === N && m === "" || (g.insertRawText(m), v = k.getNode()), gn(v)) {
                  T = f, N = f + u;
                  const E = v.getTextContentSize();
                  T = T > E ? E : T, N = N > E ? E : N, g.setTextNodeRange(v, T, v, N);
                }
...
Gt({ build: (e, t, n) => En(t), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Zt(() => n.getOutput().disabled.value ? void 0 : fa(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Rr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : J;
  ...
  return function(n, r) {
    ...
    return Rr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (f) => n._onError(f), children: o(ps, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
        m !== null && i.push(Fi(p, m, w));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
...
function hw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Rr(() => Wt(ji(a), fa(a)), [a]);
  }(r), d(it, { children: [e, o(fw, { content: t }), o(mw, { editor: r, ErrorBoundary: n })] });
}
function fw({ content: e }) {
  const [t] = It(), n = function(a) {
    ...
    return Rr(() => {
      ...
      return l(), Wt(a.registerUpdateListener(() => {
        l();
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : J;
function vw({ onClear: e }) {
  const [t] = It();
  return bw(() => wa(t, e), [t, e]), null;
}
const ga = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? jt : J;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: k, role: v = "textbox", spellCheck: T = !0, style: N, tabIndex: E, "data-testid": A, ...j }, P) {
  const [x, C] = O(e.isEditable()), y = z((I) => {
    I && I.ownerDocument && I.ownerDocument.defaultView ? e.setRootElement(I) : e.setRootElement(null);
  }, [e]), S = $(() => /* @__PURE__ */ function(...I) {
    return (V) => {
      for (const F of I) typeof F == "function" ? F(V) : F != null && (F.current = V);
    };
  }(P, y), [y, P]);
  return ga(() => (C(e.isEditable()), e.registerEditableListener((I) => {
    C(I);
  })), [e]), o("div", { "aria-activedescendant": x ? t : void 0, "aria-autocomplete": x ? n : "none", "aria-controls": x ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": x && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": x ? m : void 0, "aria-readonly": !x || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: x, "data-testid": A, id: k, ref: S, role: v, spellCheck: T, style: N, tabIndex: E, ...j });
}
const yw = en(xw);
function so(e) {
  return e.getEditorState().read(ha(e.isComposing()));
...
function kw(e, t) {
  ...
  return d(it, { children: [o(yw, { editor: a, ...r, ref: t }), n != null && o(_w, { editor: a, content: n })] });
}
function _w({ content: e, editor: t }) {
  const n = function(i) {
    ...
    return ga(() => {
      ...
      return w(), Wt(i.registerUpdateListener(() => {
        w();
      }), i.registerEditableListener(() => {
        w();
      }));
    }, [i]), l;
  }(t), [r, a] = O(t.isEditable());
...
function Sw() {
  const [e, t] = O(void 0), n = z(() => {
    t(void 0);
  }, []), r = $(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(nl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(jo, { children: [
      /* @__PURE__ */ o(zo, { children: /* @__PURE__ */ o(Fo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Tw({
  ...
  const [t] = It(), [n, r] = O(t), [a, s] = O("paragraph"), [i, l] = Sw(), c = () => {
  };
...
const xa = Qt(
  ...
  {
    ref: a,
    className: h(xa({ variant: t, size: n, className: e })),
    ...r
  }
));
Dw.displayName = Io.Root.displayName;
const ya = b.createContext({
  size: "default",
  variant: "default"
}), Dr = b.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = dt();
  return /* @__PURE__ */ o(
    _n.Root,
    {
...
Dr.displayName = _n.Root.displayName;
const qe = b.forwardRef(({ className: e, children: t, variant: n, size: r, ...a }, s) => {
...
qe.displayName = _n.Item.displayName;
const io = [
...
function Mw() {
  const { activeEditor: e } = va(), [t, n] = O([]), r = z((a) => {
    if (We(a) || Gi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
  ...
  return Rw(r), /* @__PURE__ */ o(
    Dr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: io.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        qe,
        {
          value: a,
          "aria-label": i,
          onClick: () => {
            e.dispatchCommand(Mi, a);
          },
...
function Iw({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Tw, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o(Mw, {}) }) }),
...
function Vw(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Mo && i.insertAfter(Oo());
    for (const i of s) {
...
function Pw(e, t) {
  ...
  const n = document.createElement("div"), r = Jt().getChildren();
...
function Na(e, t, n, r = null) {
  ...
  let i = t;
  r !== null && gn(t) && (i = Fl(r, t, "clone"));
  const l = pe(i) ? i.getChildren() : [], c = Oi(e, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], k = Na(e, g, f, r);
    !a && pe(t) && k && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ii(p) || Hr(p)) && p.append(f), n.append(p), m) {
      const u = m.call(i, p);
      u && (Hr(p) ? p.replaceChildren(u) : p.replaceWith(u));
    }
  } else n.append(f);
  return a;
}
...
function _a(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  const c = function(g, k) {
    const { nodeName: v } = g, T = k._htmlConversions.get(v.toLowerCase());
    let N = null;
    if (T !== void 0) for (const E of T) {
      const A = E(g);
      A !== null && (N === null || (N.priority || 0) <= (A.priority || 0)) && (N = A);
    }
  ...
  let f = [];
  const u = (l == null || !Vi(l)) && (l != null && fn(l) || r);
  for (let g = 0; g < m.length; g++) f.push(..._a(m[g], t, n, u, new Map(a), l));
  return p != null && (f = p(f)), Xr(e) && (f = $w(e, f, u ? () => {
    const g = new Mo();
    return n.push(g), g;
  } : kn)), l == null ? f.length > 0 ? i = i.concat(f) : Xr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Kr(g.nextSibling) && Kr(g.previousSibling);
  }(e) && (i = i.concat(Oo())) : pe(l) && l.append(...f), i;
}
function $w(e, t, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    const l = t[i];
    if (fn(l)) r && !l.getFormat() && l.setFormat(r), a.push(l);
...
function Bw(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Ao({
...
De.displayName = Vo.Root.displayName;
...
Ta.displayName = Ae.Root.displayName;
...
Ra.displayName = Ae.Fallback.displayName;
const Mr = yn(void 0);
function Tt() {
  const e = hr(Mr);
  if (!e)
...
}), $e = et.Trigger, Da = et.Group, Kw = et.Portal, Uw = et.Sub, Yw = et.RadioGroup;
function Ne({ variant: e = "default", ...t }) {
  ...
  return /* @__PURE__ */ o(Mr.Provider, { value: n, children: /* @__PURE__ */ o(et.Root, { ...t }) });
}
const Ma = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Tt();
  return /* @__PURE__ */ d(
    et.SubTrigger,
    {
...
Ma.displayName = et.SubTrigger.displayName;
...
Oa.displayName = et.SubContent.displayName;
const re = b.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = dt();
...
re.displayName = et.Content.displayName;
const vn = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = dt(), s = Tt();
  return /* @__PURE__ */ o(
    et.Item,
    {
...
vn.displayName = et.Item.displayName;
...
Bt.displayName = et.CheckboxItem.displayName;
const Ia = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(Nn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
...
const sn = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  et.Label,
  {
    ref: r,
...
sn.displayName = et.Label.displayName;
const Le = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  et.Separator,
  {
    ref: n,
...
Le.displayName = et.Separator.displayName;
...
function lo({
  ...
  const [m, f] = O(!1), [u, g] = O(), [k, v] = O(!1), T = tt(null);
  J(() => {
    let y = !0;
    if (!r) {
      v(!1);
  ...
  const N = z(() => {
    ...
    const y = new Date(e.date), S = Js(
      y,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), I = y.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    if (r && k)
      return /* @__PURE__ */ d(it, { children: [
        !Zs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), g(Bw(zr(e.contents))), c == null || c(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ta, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Ra, { className: "tw-text-xs tw-font-medium", children: P }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-font-medium", children: j }),
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: A }),
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (y) => {
                y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), N()) : y.key === "Enter" && y.shiftKey && (y.preventDefault(), y.stopPropagation(), Kt(u) && E());
              },
              onKeyDown: (y) => {
        ...
        C && /* @__PURE__ */ d(Ne, { children: [
          /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
          /* @__PURE__ */ o(re, { align: "end", children: C })
        ] })
      ]
    }
  );
...
function Jw({
  ...
  const [N, E] = O(wo), [A, j] = O(!1), [P, x] = O(!1), [C, y] = O(!1), [S, I] = O(!1), [V, F] = O(!1), [R, G] = O(void 0), [D, K] = O(!1), [pt, At] = O(!1);
  J(() => {
    let _ = !0;
    if (!r) {
      K(!1), At(!1);
  ...
  const _t = $(() => t.filter((_) => !_.deleted), [t]), lt = $(() => _t[0], [_t]), Ct = tt(null), B = tt(void 0), ot = z(() => {
    var _;
    (_ = B.current) == null || _.call(B), E(wo);
  }, []);
  J(() => {
    const _ = Ct.current;
    if (!_) return;
    const Y = () => {
      x(_.scrollWidth > _.clientWidth);
    };
    return Y(), window.addEventListener("resize", Y), () => window.removeEventListener("resize", Y);
  }, [lt == null ? void 0 : lt.verse]), J(() => {
    y(!1);
  }, [r]);
  const wt = $(
    () => ({
  ...
  }, [s, n]), ht = $(() => _t.slice(1), [_t]), Nt = $(() => ht.length ?? 0, [ht.length]), On = $(() => Nt > 0, [Nt]), In = $(() => C || Nt <= 2 ? ht : ht.slice(-2), [ht, Nt, C]), oe = $(() => C || Nt <= 2 ? 0 : Nt - 2, [Nt, C]), An = $(
    () => Nt === 1 ? wt.singleReply : ce(wt.multipleReplies, { count: Nt }),
    [Nt, wt]
  ), Vn = $(
    () => oe === 1 ? wt.singleReply : ce(wt.multipleReplies, { count: oe }),
    [oe, wt]
  ), ln = z(async () => {
    const _ = Kt(N) ? wr(N) : void 0;
    if (R !== void 0) {
      await p({
        threadId: c,
        contents: _,
    ...
    _ && await p({ threadId: c, contents: _ }) && ot();
  }, [ot, N, p, R, c]), M = z(
    async (_) => {
      const Y = Kt(N) ? wr(N) : void 0, st = await p({
        ..._,
        contents: Y,
        assignedUser: R ?? _.assignedUser
      });
      return st && Y && ot(), st && R !== void 0 && G(void 0), st;
    },
    [ot, N, p, R]
  );
  return /* @__PURE__ */ o(
    Ea,
    {
      ...
      className: h(
        ...
        {
          "tw-bg-primary-foreground": !r && w !== "Resolved",
          "tw-bg-background": r && w !== "Resolved",
      ...
      children: /* @__PURE__ */ d(Sa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          ut && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: ut }),
            ...
            /* @__PURE__ */ d(
              "p",
              {
                ...
                children: [
                  a,
                  " ",
                  /* @__PURE__ */ o("span", { className: e, children: lt.verse })
                ]
              }
            ),
            P && /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (_) => {
                  _.stopPropagation(), j(!A);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": A ? "Collapse text" : "Expand text",
                children: A ? /* @__PURE__ */ o(qn, {}) : /* @__PURE__ */ o(fe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
        ...
        /* @__PURE__ */ d(it, { children: [
          On && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          !r && Kt(N) && /* @__PURE__ */ o(
            lr,
            {
              ...
              onSerializedChange: (_) => E(_),
              placeholder: n["%comment_replyOrAssign%"]
            }
          ),
          r && /* @__PURE__ */ d(it, { children: [
            oe > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (_) => {
                  (_.key === "Enter" || _.key === " ") && (_.preventDefault(), _.stopPropagation(), y(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: Vn }),
                    C ? /* @__PURE__ */ o(qn, {}) : /* @__PURE__ */ o(fe, {})
                  ] })
                ]
              }
            ),
            In.map((_) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              lo,
              {
                comment: _,
                localizedStrings: n,
            ...
            g !== !1 && (!S || Kt(N)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (_) => {
                  _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), (Kt(N) || R !== void 0) && ln());
                },
                onKeyDown: (_) => {
                  Ca(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    lr,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    R !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ce(
                    ...
                    /* @__PURE__ */ d(xe, { open: V, onOpenChange: F, children: [
                      /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ o(
                        ne,
                        {
                          ...
                          align: "end",
                          onKeyDown: (_) => {
                            _.key === "Escape" && (_.stopPropagation(), F(!1));
                          },
                          children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: u == null ? void 0 : u.map((_) => /* @__PURE__ */ o(
                            Ht,
                            {
                              onSelect: () => {
                                G(_ !== s ? _ : void 0), F(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: hn(_, n) })
                            },
                            _ || "unassigned"
                          )) }) })
                        }
...
function yp({
  ...
  const [u, g] = O(), k = n.filter(
    (x) => x.comments.some((C) => !C.deleted)
  ), v = k.map((x) => ({
    id: x.id
  })), T = z((x) => {
    g(x.id);
    ...
    g(x);
  }, []), { listboxRef: E, activeId: A, handleKeyDown: j } = Rl({
    options: v,
    onOptionSelect: T
  }), P = z(
    (x) => {
      x.key === "Escape" ? (g(void 0), x.preventDefault(), x.stopPropagation()) : j(x);
    },
    [j]
  );
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      tabIndex: 0,
      ref: E,
      "aria-activedescendant": A ?? void 0,
      "aria-label": "Comments",
      className: h(
...
function Ww({ table: e }) {
  return /* @__PURE__ */ d(Ne, { children: [
    ...
    /* @__PURE__ */ d(re, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ o(sn, { children: "Toggle columns" }),
      /* @__PURE__ */ o(Le, {}),
...
const Me = at.Root, Zw = at.Group, Oe = at.Value, Qw = Qt(
...
), be = b.forwardRef(({ className: e, children: t, size: n, ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ d(
    at.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
be.displayName = at.Trigger.displayName;
const Aa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ o(qn, { className: "tw-h-4 tw-w-4" })
  }
));
Aa.displayName = at.ScrollUpButton.displayName;
const Va = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.ScrollDownButton,
  {
    ...
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ o(fe, { className: "tw-h-4 tw-w-4" })
  }
));
Va.displayName = at.ScrollDownButton.displayName;
const ve = b.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = dt();
...
ve.displayName = at.Content.displayName;
...
tc.displayName = at.Label.displayName;
const kt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  at.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(at.ItemIndicator, { children: /* @__PURE__ */ o(Ot, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ o(at.ItemText, { children: t })
    ]
  }
));
kt.displayName = at.Item.displayName;
...
ec.displayName = at.Separator.displayName;
function nc({ table: e }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Me,
        {
          ...
          children: [
            /* @__PURE__ */ o(be, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Oe, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(ve, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(kt, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Sn = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => {
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Qe(i, '[tabindex]:not([tabindex="-1"])').forEach((p) => {
...
const Tn = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => /* @__PURE__ */ o(
  "thead",
  {
    ref: r,
    className: h(
...
const Rn = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", e), ...t }));
...
function wc({
  ...
  var P;
  const [p, m] = O([]), [f, u] = O([]), [g, k] = O({}), [v, T] = O({}), N = $(() => t ?? [], [t]), E = Po({
    data: N,
    columns: e,
    getCoreRowModel: Lo(),
  ...
  }), A = E.getVisibleFlatColumns();
  let j;
  return c ? j = Array.from({ length: 10 }).map((y, S) => `skeleton-row-${S}`).map((y) => /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(he, { colSpan: A.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, y)) : ((P = E.getRowModel().rows) == null ? void 0 : P.length) > 0 ? j = E.getRowModel().rows.map((x) => /* @__PURE__ */ o(
    Pt,
    {
      onClick: () => i(x, E),
      "data-state": x.getIsSelected() && "selected",
      children: x.getVisibleCells().map((C) => /* @__PURE__ */ o(he, { children: Ke(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    x.id
  )) : j = /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ o(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: E }),
    /* @__PURE__ */ d(Sn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Tn, { stickyHeader: s, children: E.getHeaderGroups().map((x) => /* @__PURE__ */ o(Pt, { children: x.headers.map((C) => /* @__PURE__ */ o(tn, { children: C.isPlaceholder ? void 0 : Ke(C.column.columnDef.header, C.getContext()) }, C.id)) }, x.id)) }),
      /* @__PURE__ */ o(Rn, { children: j })
    ] }),
...
function dc({
  ...
  const a = po(n, "%webView_error_dump_header%"), s = po(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(vo, {}) })
        ] }),
...
function _p({
  ...
  return /* @__PURE__ */ d(xe, { onOpenChange: (p) => {
    p || l(!1);
  }, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: r }),
    /* @__PURE__ */ d(ne, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
      i && n["%webView_error_dump_copied_message%"] && /* @__PURE__ */ o(ct, { children: n["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ o(
        dc,
        {
          errorDetails: e,
...
function Cp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "default", children: [
      /* @__PURE__ */ o(Ts, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(fe, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(re, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ o(sn, { children: w.label }),
      /* @__PURE__ */ o(Da, { children: w.itemType === 0 ? /* @__PURE__ */ o(it, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Bt,
        {
          checked: r[p][f],
        ...
        Yw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Ia, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(Le, {})
    ] }, w.label)) })
        ...
        (a || i) && /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          ...
          i && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ d(
            L,
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ o(Ms, { className: "tw-h-4 tw-w-4" })
              ]
            }
          ) })
        ] })
...
function uc({ id: e, versionHistory: t }) {
  const [n, r] = O(!1), a = /* @__PURE__ */ new Date();
  function s(l) {
...
function mc({
  ...
  const [T, N] = O(!1), E = z(
    (S) => {
      var V;
      const I = (V = e.find((F) => F.label === S)) == null ? void 0 : V.value;
      I && n(
        t.includes(I) ? t.filter((F) => F !== I) : [...t, I]
      );
    },
    [e, t, n]
  ), A = () => c || r, j = $(() => {
    if (!f) return e;
    const S = e.filter((V) => V.starred).sort((V, F) => V.label.localeCompare(F.label)), I = e.filter((V) => !V.starred).sort((V, F) => {
      const R = t.includes(V.value), G = t.includes(F.value);
      return R && !G ? -1 : !R && G ? 1 : V.label.localeCompare(F.label);
    });
    return [...S, ...I];
  }, [e, t, f]), P = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(xe, { open: C, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: k,
        ...
        children: [
          ...
          /* @__PURE__ */ o(xo, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      /* @__PURE__ */ o(Ve, { placeholder: `Search ${r.toLowerCase()}...` }),
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: x, children: i })
      ] }),
      /* @__PURE__ */ d(ee, { children: [
        /* @__PURE__ */ o(an, { children: l }),
        /* @__PURE__ */ o(Ft, { children: j.map((S) => /* @__PURE__ */ d(
          Ht,
          {
            value: S.label,
            onSelect: E,
      ...
      return /* @__PURE__ */ d(Re, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ o(
          L,
          {
            ...
            children: /* @__PURE__ */ o(nn, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
const hc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ o("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ o("p", { children: "-" }),
  " ",
...
function fc({
  ...
  const s = tt(null), i = tt(null), l = tt(!1), [c, w] = O(e), [p, m] = O(n), [f, u] = O(!1);
  J(() => {
    w(e);
  }, [e]), J(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var T, N, E, A;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = s.current) == null || T.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((E = s.current) == null ? void 0 : E.selectionStart) === 0 && ((A = i.current) == null || A.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Yt, { children: [
      /* @__PURE__ */ o(me, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: hc(e, a, n) }) }) }),
    ...
    /* @__PURE__ */ d(
      re,
      {
        ...
        children: [
          /* @__PURE__ */ o(sn, { children: a["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ o(Le, {}),
          /* @__PURE__ */ o(
            Bt,
            {
              ...
              children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
                ...
                /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: Zn })
              ] })
            }
          ),
          /* @__PURE__ */ o(
          ...
          /* @__PURE__ */ o(
            Bt,
            {
              ...
              onClick: (v) => {
                var T;
                v.stopPropagation(), l.current = !0, (T = s.current) == null || T.focus();
              },
...
const gc = (e, t) => e === "f" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ o(No, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ d(it, { children: [
  /* @__PURE__ */ o(ko, {}),
  " ",
  ...
  return e === "f" && (n = t["%footnoteEditor_noteType_footnote_label%"]), ce(t["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function vc({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Yt, { children: [
      /* @__PURE__ */ o($i, { asChild: !0, children: /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: gc(e, n) }) }) }),
      /* @__PURE__ */ o(Lt, { children: /* @__PURE__ */ o("p", { children: bc(e, n) }) })
    ] }) }),
    /* @__PURE__ */ d(re, { className: "tw-z-[300]", children: [
      /* @__PURE__ */ o(sn, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ o(Le, {}),
      /* @__PURE__ */ d(
        Bt,
        {
...
function Rp({
  ...
  const c = tt(null), w = us(), [p, m] = O("generated"), [f, u] = O("*"), [g, k] = O("f"), [v, T] = O(!1), N = $(
    () => ({
      ...i,
  ...
  J(() => {
    ...
    if (C && cn("note", C)) {
      const I = (y = C.insert.note) == null ? void 0 : y.caller;
      let V = "custom";
      I === Zn ? V = "generated" : I === Qn ? V = "hidden" : I && u(I), m(V), k(((S = C.insert.note) == null ? void 0 : S.style) ?? "f"), x = setTimeout(() => {
        var F;
        (F = c.current) == null || F.applyUpdate([{ delete: 1 }, C]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const E = z(() => {
    var C, y;
    const x = (y = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : y.at(0);
    x && cn("note", x) && (x.insert.note && (p === "custom" ? x.insert.note.caller = f : x.insert.note.caller = p === "generated" ? Zn : Qn), n([x]));
  }, [p, f, n]), A = () => {
    var C;
    const x = (C = w.current) == null ? void 0 : C.getElementsByClassName("editor-input")[0];
    x != null && x.textContent && navigator.clipboard.writeText(x.textContent);
  }, j = (x) => {
    var y, S, I, V, F;
    k(x);
    const C = (S = (y = c.current) == null ? void 0 : y.getNoteOps(0)) == null ? void 0 : S.at(0);
    if (C && cn("note", C)) {
      C.insert.note && (C.insert.note.style = x);
      const R = (V = (I = C.insert.note) == null ? void 0 : I.contents) == null ? void 0 : V.ops;
      g !== "x" && x === "x" ? R == null || R.forEach((G) => xc(G)) : g === "x" && x !== "x" && (R == null || R.forEach((G) => yc(G))), (F = c.current) == null || F.applyUpdate([{ delete: 1 }, C]);
    }
  }, P = () => {
    var C, y, S, I, V;
    const x = (y = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : y.at(0);
    if (x && cn("note", x)) {
      const F = (S = x.insert.note) == null ? void 0 : S.style, R = (V = (I = x.insert.note) == null ? void 0 : I.contents) == null ? void 0 : V.ops;
      F || T(!1), T(
        F === "x" ? !!(R != null && R.every((G) => {
          var K, pt;
          if (!((K = G.attributes) != null && K.char)) return !0;
          const D = ((pt = G.attributes) == null ? void 0 : pt.char).style;
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Yt, { children: [
          /* @__PURE__ */ o(me, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(nn, {}) }) }),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o($t, { children: /* @__PURE__ */ d(Yt, { children: [
            /* @__PURE__ */ o(me, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: A, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(vo, {}) }) }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(Jn, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
  ...
  return /* @__PURE__ */ d(it, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(it, { children: Nc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Mp({
  ...
  const p = c ?? ni(n, void 0), m = (N, E) => {
    w == null || w(N, E, a);
  }, f = s ? n.findIndex((N) => N === s) : -1, [u, g] = O(f), k = (N, E, A) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), w == null || w(E, A, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
      switch (N.key) {
        case "ArrowDown":
          N.preventDefault(), g((E) => Math.min(E + 1, n.length - 1));
          break;
        case "ArrowUp":
          N.preventDefault(), g((E) => Math.max(E - 1, 0));
          break;
      }
  }, T = tt([]);
  return J(() => {
    var N;
    u >= 0 && u < T.current.length && ((N = T.current[u]) == null || N.focus());
  }, [u]), /* @__PURE__ */ o(
    "div",
    {
      role: "listbox",
        ...
        "ul",
        {
          ...
          children: n.map((N, E) => {
            ...
            return /* @__PURE__ */ d(it, { children: [
              ...
              E < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(De, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function Ec({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], s = n["%webView_inventory_occurrences_table_header_occurrence%"], i = $(() => {
  ...
  return /* @__PURE__ */ d(Sn, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Tn, { stickyHeader: !0, children: /* @__PURE__ */ d(Pt, { children: [
      /* @__PURE__ */ o(tn, { children: a }),
      /* @__PURE__ */ o(tn, { children: s })
    ] }) }),
    /* @__PURE__ */ o(Rn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Pt,
      {
        onClick: () => {
          t(l.reference);
        ...
        children: [
          /* @__PURE__ */ o(he, { children: de(l.reference, "English") }),
          /* @__PURE__ */ o(he, { className: r, children: Cc(l.text) })
        ]
      },
...
const Ir = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  tr.Root,
  {
    ref: n,
    className: h(
...
Ir.displayName = tr.Root.displayName;
const Dn = (e) => e === "asc" ? /* @__PURE__ */ o(Ps, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Op = (e) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(Dr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        qe,
        {
          onClick: (c) => {
            c.stopPropagation(), Hn(
              [l],
              "approved",
              t,
              n,
  ...
  return t ? t[1] : "";
}, Tc = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Lp = Object.freeze([
  ...
  const a = Fr(r.key) ? r.key : r.key[0];
  return {
    items: Fr(r.key) ? [r.key] : r.key,
    count: r.count,
    status: r.status || Tc(a, t, n),
...
function Bp({
  ...
  const u = Rt(n, "%webView_inventory_all%"), g = Rt(n, "%webView_inventory_approved%"), k = Rt(n, "%webView_inventory_unapproved%"), v = Rt(n, "%webView_inventory_unknown%"), T = Rt(n, "%webView_inventory_scope_currentBook%"), N = Rt(n, "%webView_inventory_scope_chapter%"), E = Rt(n, "%webView_inventory_scope_verse%"), A = Rt(n, "%webView_inventory_filter_text%"), j = Rt(
    n,
    "%webView_inventory_show_additional_items%"
  ), P = Rt(n, "%webView_inventory_no_results%"), [x, C] = O(!1), [y, S] = O("all"), [I, V] = O(""), [F, R] = O([]), G = $(() => {
    const B = e ?? [];
    return B.length === 0 ? [] : Dc(B, a, s);
  }, [e, a, s]), D = $(() => {
    if (x) return G;
    const B = [];
    return G.forEach((ot) => {
      const wt = ot.items[0], ut = B.find(
        (ht) => ht.items[0] === wt
      );
      ut ? (ut.count += ot.count, ut.occurrences = ut.occurrences.concat(ot.occurrences)) : B.push({
        items: [wt],
        count: ot.count,
  ...
  }, [x, G]), K = $(() => D.length === 0 ? [] : Rc(D, y, I), [D, y, I]), pt = $(() => {
    var wt, ut;
    if (!x) return c;
    const B = (wt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : wt.length;
    if (!B) return c;
    const ot = [];
    for (let ht = 0; ht < B; ht++)
      ot.push(
        Sc(
          ((ut = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ut[ht]) || "Additional Item",
          ht + 1
        )
      );
    return [...ot, ...c];
  }, [r == null ? void 0 : r.tableHeaders, c, x]);
  J(() => {
    K.length === 0 ? R([]) : K.length === 1 && R(K[0].items);
  }, [K]);
  const At = (B, ot) => {
    ot.setRowSelection(() => {
      const ut = {};
    ...
    const wt = B.original.items;
    R(wt), f && wt.length > 0 && f(wt[0]);
  }, _t = (B) => {
    ...
    const B = D.filter((ot) => ri(
      x ? ot.items : [ot.items[0]],
      F
    ));
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Me,
        {
          ...
          defaultValue: y,
          children: [
            /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Oe, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ d(ve, { children: [
              /* @__PURE__ */ o(kt, { value: "all", children: u }),
              /* @__PURE__ */ o(kt, { value: "approved", children: g }),
              /* @__PURE__ */ o(kt, { value: "unapproved", children: k }),
              /* @__PURE__ */ o(kt, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Me, { onValueChange: (B) => _t(B), defaultValue: i, children: [
        /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Oe, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(kt, { value: "book", children: T }),
          /* @__PURE__ */ o(kt, { value: "chapter", children: N }),
          /* @__PURE__ */ o(kt, { value: "verse", children: E })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Be,
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(ct, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? j })
      ] })
    ] }),
...
function zp({ localizedStrings: e, markerMenuItems: t }) {
  ...
  return /* @__PURE__ */ d(te, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(ee, { children: [
      /* @__PURE__ */ o(an, { children: e["%markerMenu_noResults%"] }),
      /* @__PURE__ */ o(Ft, { children: a.map((s) => /* @__PURE__ */ d(
        Ht,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Ho, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const Mc = "16rem", Oc = "3rem", $a = b.createContext(void 0);
function Mn() {
...
const La = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), m = t ?? w, f = b.useCallback(
      (E) => {
        const A = typeof E == "function" ? E(m) : E;
        n ? n(A) : p(A);
      },
      [n, m]
    ), u = b.useCallback(() => f((E) => !E), [f]), g = m ? "expanded" : "collapsed", T = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o($a.Provider, { value: N, children: /* @__PURE__ */ o($t, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ic = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Mn();
  return /* @__PURE__ */ d(
    L,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(Bs, {}) : /* @__PURE__ */ o(js, {}),
...
const pr = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "div",
  {
    ref: r,
...
const Bc = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: r,
...
const jc = Qt(
  ...
  ({
    ...
    const c = e ? Ie : "button", { state: w } = Mn(), p = /* @__PURE__ */ o(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: h(jc({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(me, { asChild: !0, children: p }),
      /* @__PURE__ */ o(Lt, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
Ha.displayName = "SidebarMenuButton";
const zc = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? Ie : "button",
  {
    ref: a,
...
const Gc = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      ...n,
      children: [
        t && /* @__PURE__ */ o(cr, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ o(
          cr,
          {
...
const Kc = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? Ie : "a",
  {
    ref: s,
    ...
    Ba,
    {
      ...
      children: /* @__PURE__ */ d(za, { children: [
        /* @__PURE__ */ d(dr, { children: [
          /* @__PURE__ */ o(pr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(ur, { children: /* @__PURE__ */ o(Fa, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Ga, { children: /* @__PURE__ */ o(
            Ha,
            {
              onClick: () => w(f),
              isActive: m(f),
        ...
        /* @__PURE__ */ d(dr, { children: [
          /* @__PURE__ */ o(pr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ o(ur, { className: "tw-pl-3", children: /* @__PURE__ */ o(
            or,
            {
              buttonVariant: "ghost",
...
const Ut = "scrBook", Yc = "scrRef", we = "source", qc = "details", Jc = "Scripture Reference", Wc = "Scripture Book", Xa = "Type", Zc = "Details";
function Qc(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? Z.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === Ut ? de(a.start) : void 0;
      },
      getGroupingValue: (r) => Z.bookIdToNumber(r.start.book),
      sortingFn: (r, a) => Wn(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (r) => de(r.start),
      id: Yc,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : de(a.start);
      },
      sortingFn: (r, a) => Wn(r.original.start, a.original.start),
      enableGrouping: !1
    },
...
const td = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Wn(e.start, e.end) === 0 ? `${Pn(e.start)}+${t}` : `${Pn(e.start)}+${t}-${Pn(e.end)}+${n}`;
}, uo = (e) => `${td({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function Gp({
  sources: e,
  ...
  const [w, p] = O([]), [m, f] = O([{ id: Ut, desc: !1 }]), [u, g] = O({}), k = $(
    () => e.flatMap((y) => y.data.map((S) => ({
      ...S,
      source: y.source
    }))),
    [e]
  ...
  J(() => {
    if (l) {
      const y = T.getSelectedRowModel().rowsById, S = Object.keys(y);
      if (S.length === 1) {
        const I = k.find((V) => uo(V) === S[0]) || void 0;
        I && l(I);
      }
    }
  }, [u, k, l, T]);
  const N = a ?? Wc, E = s ?? Xa, A = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Ut] },
    { label: `Group by ${E}`, value: [we] },
    {
      label: `Group by ${N} and ${E}`,
      value: [Ut, we]
    },
    {
      label: `Group by ${E} and ${N}`,
      value: [we, Ut]
    }
  ], j = (y) => {
    p(JSON.parse(y));
  }, P = (y, S) => {
    !y.getIsGrouped() && !y.getIsSelected() && y.getToggleSelectedHandler()(S);
  }, x = (y, S) => y.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), C = (y, S, I) => {
    if (!((y == null ? void 0 : y.length) === 0 || S.depth < I.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          /* @__PURE__ */ o(be, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Oe, {}) }),
          /* @__PURE__ */ o(ve, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: A.map((y) => /* @__PURE__ */ o(kt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Tn, { children: T.getHeaderGroups().map((y) => /* @__PURE__ */ o(Pt, { children: y.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(tn, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ke(S.column.columnDef.header, S.getContext())
        ] }) }, S.id)
      )) }, y.id)) }),
      /* @__PURE__ */ o(Rn, { children: T.getRowModel().rows.map((y, S) => {
        const I = dt();
        return /* @__PURE__ */ o(
          Pt,
          {
            ...
            children: y.getVisibleCells().map((V) => {
              if (!(V.getIsPlaceholder() || V.column.columnDef.enableGrouping && !V.getIsGrouped() && (V.column.columnDef.id !== we || !n)))
                return /* @__PURE__ */ o(
                  he,
                  {
                    className: h(
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ o(fe, {}),
                          !y.getIsExpanded() && (I === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(Yn, {})),
                          " ",
                          Ke(V.column.columnDef.cell, V.getContext()),
                          " (",
                          y.subRows.length,
                          ")"
                        ]
...
const Vr = (e, t) => e.filter((n) => {
  try {
    return Xe(n) === t;
  } catch {
    return !1;
  }
}), Ka = (e, t, n) => Vr(e, t).every((r) => n.includes(r));
function ed({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Vr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    L,
    {
      variant: "outline",
...
function nd({
  ...
  const s = r["%webView_book_selector_books_selected%"], i = r["%webView_book_selector_select_books%"], l = r["%webView_book_selector_search_books%"], c = r["%webView_book_selector_select_all%"], w = r["%webView_book_selector_clear_all%"], p = r["%webView_book_selector_no_book_found%"], m = r["%webView_book_selector_more%"], { otLong: f, ntLong: u, dcLong: g, extraLong: k } = {
  ...
  }, [v, T] = O(!1), [N, E] = O(""), A = tt(void 0), j = tt(!1);
  if (e.length !== Z.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const P = $(() => Z.allBookIds.filter(
    (R, G) => e[G] === "1" && !Z.isObsolete(Z.bookIdToNumber(R))
  ), [e]), x = $(() => {
    if (!N.trim()) {
      const D = {
        [X.OT]: [],
    ...
    (R, G = !1) => {
      if (!G || !A.current) {
        n(
          t.includes(R) ? t.filter((lt) => lt !== R) : [...t, R]
        ), A.current = R;
        return;
      }
      const D = P.findIndex((lt) => lt === A.current), K = P.findIndex((lt) => lt === R);
      if (D === -1 || K === -1) return;
      const [pt, At] = [
        Math.min(D, K),
        Math.max(D, K)
      ], _t = P.slice(pt, At + 1).map((lt) => lt);
      n(
        t.includes(R) ? t.filter((lt) => !_t.includes(lt)) : [.../* @__PURE__ */ new Set([...t, ..._t])]
      );
    },
    [t, n, P]
  ), y = (R) => {
    ...
    (R) => {
      const G = Vr(P, R).map((D) => D);
      n(
        Ka(P, R, t) ? t.filter((D) => !G.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...G])]
      );
    },
    [t, n, P]
  ), V = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ d(
      xe,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ne, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            te,
            {
              shouldFilter: !1,
              onKeyDown: (R) => {
              ...
              children: [
                ...
                /* @__PURE__ */ d(ee, { children: [
                  /* @__PURE__ */ o(an, { children: p }),
                  Object.values(X).map((R, G) => {
                    const D = x[R];
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        /* @__PURE__ */ o(
                          Ft,
                          {
                            heading: Wo(R, f, u, g, k),
                            children: D.map((K) => /* @__PURE__ */ o(
                              Qo,
                              {
                                bookId: K,
                                isSelected: t.includes(K),
                                onSelect: () => y(K),
                                onMouseDown: (pt) => S(pt, K),
                                section: Xe(K),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: rr(K, a),
                        ...
                        G < Object.values(X).length - 1 && /* @__PURE__ */ o(Go, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Xn ? Xn : mo
      ).map((R) => /* @__PURE__ */ o(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(R, a) }, R)),
      t.length > Xn && /* @__PURE__ */ o(
        Re,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${t.length - mo} ${m}`
        }
      )
    ] })
  ] });
...
function Xp({
  ...
  const w = se(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = se(i, "%webView_scope_selector_current_book%"), u = se(i, "%webView_scope_selector_choose_books%"), g = se(i, "%webView_scope_selector_scope%"), k = se(i, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        _r,
        {
          ...
          children: T.map(({ value: N, label: E, id: A }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(bn, { className: "tw-me-2", value: N, id: A }),
            /* @__PURE__ */ o(ct, { htmlFor: A, children: E })
          ] }, A))
        }
      )
    ] }),
...
function Kp({
  ...
  return /* @__PURE__ */ d(
    Me,
    {
      ...
      children: [
        /* @__PURE__ */ o(be, { size: a, className: h("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          Oe,
          {
            placeholder: l[W(t)] ?? t
          }
        ...
        /* @__PURE__ */ o(
          ve,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(kt, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, c) => l.order - c.order).map((l) => /* @__PURE__ */ d(Yt, { children: [
  /* @__PURE__ */ o(me, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    vn,
    {
      onClick: () => {
        r(l);
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ o(xn, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ o(xn, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ d(Uw, { children: [
    /* @__PURE__ */ o(Ma, { children: l.label }),
    /* @__PURE__ */ o(Kw, { children: /* @__PURE__ */ o(Oa, { children: Ya(
      e,
      t,
      Ua(e, l.id),
      r
...
function mr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    /* @__PURE__ */ o($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Fs, {}) }) }),
    /* @__PURE__ */ o(re, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
      /* @__PURE__ */ o(Da, { children: /* @__PURE__ */ o($t, { children: Ya(t.groups, t.items, c, e) }) }),
      w < p.length - 1 && /* @__PURE__ */ o(Le, {})
    ] }, c)) })
  ] });
}
...
Wa.displayName = xt.List.displayName;
...
function Zp({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Ja, { children: [
      /* @__PURE__ */ o(Wa, { children: e.map((l) => /* @__PURE__ */ o(rd, { value: l.value, children: l.value }, l.key)) }),
...
const sd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Tt();
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
...
sd.displayName = nt.CheckboxItem.displayName;
const id = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Tt();
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Nn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
id.displayName = nt.RadioItem.displayName;
const ld = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  nt.Label,
  {
    ref: r,
    className: h("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", t && "tw-pl-8", e),
...
ld.displayName = nt.Label.displayName;
...
const Ge = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(Yt, { children: [
      /* @__PURE__ */ o(me, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        os,
        {
          onClick: () => {
            r(w);
          ...
          children: [
            w.iconPathBefore && /* @__PURE__ */ o(xn, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
            w.label,
            w.iconPathAfter && /* @__PURE__ */ o(xn, { icon: w.iconPathAfter, menuLabel: w.label })
          ]
        },
...
function wd({
  ...
  const a = tt(void 0), s = tt(void 0), i = tt(void 0), l = tt(void 0), c = tt(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    var g, k, v, T;
    p.preventDefault();
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Ge(s, [f, u]);
        break;
      case "alt+l":
        (k = i.current) == null || k.focus(), Ge(i, [f, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Ge(l, [f, u]);
        break;
      case "alt+h":
        (T = c.current) == null || T.focus(), Ge(c, [f, u]);
        break;
    }
  }), J(() => {
    ...
    return /* @__PURE__ */ o(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(od, { children: [
      /* @__PURE__ */ o(ts, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        rs,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o($t, { children: ss(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function eu({
  ...
  const w = cd(
    ...
    var T, N, E, A, j, P;
    const v = k !== g ? ((N = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : N[k]) ?? ((A = (E = e[g]) == null ? void 0 : E.uiNames) == null ? void 0 : A.en) : void 0;
    return v ? `${(j = e[g]) == null ? void 0 : j.autonym} (${v})` : (P = e[g]) == null ? void 0 : P.autonym;
  };
  return /* @__PURE__ */ d("div", { id: c, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      Me,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ o(be, { children: /* @__PURE__ */ o(Oe, {}) }),
          /* @__PURE__ */ o(
            ve,
            {
              className: "tw-z-[250]",
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(ct, { className: "tw-font-normal tw-text-muted-foreground", children: ce(w, {
...
function dd({ item: e, createLabel: t, createComplexLabel: n }) {
  return t ? /* @__PURE__ */ o(ct, { children: t(e) }) : n ? /* @__PURE__ */ o(ct, { children: n(e) }) : /* @__PURE__ */ o(ct, { children: e });
}
function nu({
  id: e,
  className: t,
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Ne, { children: [
              /* @__PURE__ */ o($e, { className: h(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(bo, {}) }) }),
              /* @__PURE__ */ o(re, { align: "end", children: l })
            ] })
          ] }),
...
const pd = en(({ className: e, ...t }, n) => /* @__PURE__ */ o(Xs, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
), md = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
const fd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
fd.displayName = "AlertDescription";
const au = rt.Root, su = rt.Trigger, iu = rt.Group, lu = rt.Portal, wu = rt.Sub, cu = rt.RadioGroup, gd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  rt.SubTrigger,
  {
    ref: a,
    className: h(
...
gd.displayName = rt.SubTrigger.displayName;
...
bd.displayName = rt.SubContent.displayName;
const vd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ o(
  rt.Content,
  {
    ref: n,
    className: h(
...
xd.displayName = rt.Item.displayName;
const yd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ref: a,
    className: h(
...
yd.displayName = rt.CheckboxItem.displayName;
const Nd = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  rt.RadioItem,
  {
    ref: r,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Nn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
Nd.displayName = rt.RadioItem.displayName;
const kd = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  rt.Label,
  {
    ref: r,
    className: h(
...
kd.displayName = rt.Label.displayName;
const _d = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  rt.Separator,
  {
    ref: n,
...
_d.displayName = rt.Separator.displayName;
...
const du = St.Trigger, Sd = St.Portal, pu = St.Close, ls = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  St.Overlay,
  {
    ref: n,
...
ls.displayName = St.Overlay.displayName;
const Td = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
Md.displayName = St.Title.displayName;
...
Od.displayName = St.Description.displayName;
const Id = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  er.Root,
  {
    ref: r,
    className: h(
...
Id.displayName = er.Root.displayName;
function uu({
  className: e,
  ...t
}) {
...
const Ad = b.forwardRef(({ className: e, ...t }, n) => {
  ...
  return /* @__PURE__ */ d(
    He.Root,
    {
      ...
      dir: r,
      children: [
        /* @__PURE__ */ o(He.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ o(He.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ o(He.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
Ad.displayName = He.Root.displayName;
...
Vd.displayName = nr.Root.displayName;
const gu = xt.Root, Pd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    xt.List,
    {
...
Pd.displayName = xt.List.displayName;
...
$d.displayName = xt.Trigger.displayName;
...
Ld.displayName = xt.Content.displayName;
