...
import b, { forwardRef as wn, useRef as Z, useMemo as B, useState as M, useCallback as z, useLayoutEffect as Kt, createContext as On, useContext as Nr, useEffect as Y, Component as ks, createElement as qr, Suspense as _s, createRef as Cs, Fragment as yo } from "react";
import { Command as vt } from "cmdk";
import { X as je, Search as No, Check as Mt, Clock as Kr, ChevronsLeft as Hr, ChevronsRight as Xr, ChevronLeft as rr, ChevronRight as Ie, ArrowLeft as Es, ArrowRight as Ts, Circle as In, ChevronDown as _e, BoldIcon as Ss, ItalicIcon as Rs, UnderlineIcon as Ds, StrikethroughIcon as Ms, AtSign as ko, Pencil as Os, Trash2 as Is, ArrowUp as _o, MoreHorizontal as Co, MailOpen as As, Mail as Ps, ChevronUp as or, FilterIcon as Vs, ArrowLeftIcon as $s, ChevronLeftIcon as Ls, ChevronRightIcon as Bs, ArrowRightIcon as js, Copy as Eo, Filter as zs, User as Fs, Link as Gs, CircleHelp as Us, ChevronsUpDown as To, Star as qs, SquareX as So, FunctionSquare as Ro, SquareSigma as Do, AlertCircle as ar, CircleCheckIcon as Ks, CircleXIcon as Hs, CircleHelpIcon as Xs, ArrowUpIcon as Ys, ArrowDownIcon as Js, ArrowUpDownIcon as Ws, PanelLeft as Zs, PanelRight as Qs, ScrollText as ti, MenuIcon as ei, Menu as ni, EllipsisVertical as ri, LoaderCircle as oi, GripVertical as ai } from "lucide-react";
import { clsx as si } from "clsx";
import { extendTailwindMerge as ii } from "tailwind-merge";
import * as Dt from "@radix-ui/react-dialog";
import { includes as bn, Section as H, getChaptersForBook as li, formatScrRef as xe, getSectionForBook as Qe, formatRelativeDate as ci, formatReplacementString as ve, sanitizeHtml as wi, NumberFormat as di, formatBytes as pi, getCurrentLocale as ui, getFormatCallerFunction as mi, deepEqual as Mo, isString as Gn, compareScrRefs as sr, scrRefToBBBCCCVVV as Un, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { useReactTable as Uo, getFilteredRowModel as nl, getSortedRowModel as qo, getPaginationRowModel as rl, getCoreRowModel as Ko, flexRender as tn, getGroupedRowModel as ol, getExpandedRowModel as al } from "@tanstack/react-table";
...
const ul = Dt.Root, ml = Dt.Portal, Ho = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: n,
    className: f(
...
Ho.displayName = Dt.Overlay.displayName;
...
Xo.displayName = Dt.Content.displayName;
...
Jo.displayName = Dt.Title.displayName;
...
const un = b.forwardRef((e, t) => /* @__PURE__ */ r(vt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
...
Xt.displayName = vt.Group.displayName;
...
const Bt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  vt.Item,
  {
    ref: n,
    className: f(
...
const bt = class X {
  constructor(t, n, o, a) {
    if (K(this, "firstChapter"), K(this, "lastChapter"), K(this, "lastVerse"), K(this, "hasSegmentsDefined"), K(this, "text"), K(this, "BBBCCCVVVS"), K(this, "longHashCode"), K(this, "versification"), K(this, "rtlMark", "‏"), K(this, "_bookNum", 0), K(this, "_chapterNum", 0), K(this, "_verseNum", 0), K(this, "_verse"), o == null && a == null)
  ...
  static fromJSON(t) {
    ...
    let w;
    return i && (w = new he(i)), n ? new X(n, o.toString(), l, w) : new X();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new he(Vt[i]);
        } catch {
...
const le = Ae.Root, ce = Ae.Trigger, Ep = Ae.Anchor, Zt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...o }, a) => {
  const s = pt();
...
function Dl({
  ...
  return /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ r(Zt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Wt, { children: /* @__PURE__ */ r(Xt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Bt,
      {
        onSelect: () => p(m),
...
function Tp(e, t, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function no({
  ...
  if (e)
    return /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: $t(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Bt,
      {
        value: `${e} ${Ne[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Sp({
  ...
  const c = pt(), [p, m] = M(!1), [h, u] = M(""), [g, x] = M(""), [v, N] = M("books"), [k, T] = M(void 0), [V, $] = M(!1), P = Z(void 0), y = Z(void 0), C = Z(void 0), _ = Z(void 0), S = Z({}), E = z(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ), A = B(() => o ? o() : sa, [o]), U = B(() => ({
    [H.OT]: A.filter((q) => Q.isBookOT(q)),
    [H.NT]: A.filter((q) => Q.isBookNT(q)),
    [H.DC]: A.filter((q) => Q.isBookDC(q)),
    [H.Extra]: A.filter((q) => Q.extraBooks().includes(q))
    ...
    (O) => {
      const q = v === "chapters" ? k : D == null ? void 0 : D.book;
      q && (E({
        book: q,
        chapterNum: O,
        verseNum: 1
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: q, isDigit: st } = eo(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
    ...
    const { isLetter: q, isDigit: st } = eo(O.key);
    (q || st) && (O.preventDefault(), x((lt) => lt + O.key), y.current.focus(), $(!1));
  }, []);
  return Kt(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && C.current && _.current) {
        const q = C.current, st = _.current, lt = st.offsetTop, nt = q.clientHeight, Ft = st.clientHeight, Et = lt - nt / 2 + Ft / 2;
        q.scrollTo({
          top: Math.max(0, Et),
          behavior: "smooth"
        }), u(pr(e.book));
    ...
    if (v === "chapters" && k) {
      ...
      setTimeout(() => {
        if (C.current)
          if (O) {
            const q = S.current[e.chapterNum];
    ...
    /* @__PURE__ */ r(Zt, { id: w, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      Jt,
      {
        ref: P,
        onKeyDown: Re,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ut.map(({ onClick: O, disabled: q, title: st, icon: lt }) => /* @__PURE__ */ r(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !V && /* @__PURE__ */ d(Wt, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(wt, { children: [
              !D && Object.entries(G).map(([O, q]) => {
                if (q.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Xt, { heading: fn(O), children: q.map((st) => /* @__PURE__ */ r(
                      ia,
                      {
                        bookId: st,
                        onSelect: (lt) => ct(lt),
    ...
    /* @__PURE__ */ r(
      Zt,
      {
        ...
        children: /* @__PURE__ */ d(Jt, { children: [
          ...
          /* @__PURE__ */ r(Wt, { children: $(t) ? t.map((y) => /* @__PURE__ */ r(Xt, { heading: y.groupHeading, children: y.options.map((C) => P(C, y.groupHeading)) }, y.groupHeading)) : t.map((y) => P(y)) })
        ] })
      }
    )
  ] });
      ...
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (Ht() !== null || x !== null && x === m.getRootElement()) && g.select();
          }
        }, xn);
...
const Or = {
  ...
  mark: "",
  markOverlap: ""
}, St = pn.Provider, Lt = pn.Root, Ut = pn.Trigger, Rt = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, o) => /* @__PURE__ */ r(
  pn.Content,
  {
    ref: o,
    sideOffset: t,
...
class Ul extends ks {
  ...
  componentDidUpdate(t, n) {
    ...
    if (o && n.error !== null && ql(t.resetKeys, a)) {
      var s, i;
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Kt : Y;
function Xl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Yl() {
  return function(e) {
    const [t] = jt(), n = B(() => e(t), [t, e]), [o, a] = M(() => n.initialValueFn()), s = Z(o);
    return Hl(() => {
...
function Jl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !fi(t) && o !== null) {
    ...
    if (c || p) {
      const [m, h] = hi(e), u = l.is(w), g = t.is(i ? w : l), x = t.is(i ? l : w);
      let v, N = 0;
      u ? (N = m > h ? h : m, v = m > h ? m : h) : g ? (N = i ? h : m, v = void 0) : x && (N = 0, v = i ? m : h);
...
Yt({ build: (e, t, n) => $n(t), config: dn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const o = n.getOutput();
...
function ha() {
  const e = oe(), t = Ht(), n = An();
  e.clear(), e.append(n), t !== null && n.select(), an(t) && (t.format = 0);
}
function ga(e, t = ha) {
  return e.registerCommand(Vo, (n) => (e.update(t), !0), $o);
}
Yt({ build: (e, t, n) => $n(t), config: dn({ $onClear: ha }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
...
const fr = Yt({ build: (e) => ba(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Pr = 0, hr = 1, xa = 2, Xn = 3, yn = 4, De = 5, Yn = 6, Je = 7;
function Jn(e) {
  return e.id === Pr;
}
function ya(e) {
...
class lc {
  ...
  init(t) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, s = function(l, w, c) {
      return Object.assign(l, { config: w, id: Xn, registerState: c });
...
const wc = Yt({ config: dn({ setOptions: io, updateOptions: io }), init: ({ $initialEditorState: e = cc }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, o) {
...
const pc = /* @__PURE__ */ new Set(), wo = Yt({ build(e, t, n) {
...
Yt({ dependencies: [fr, wo], name: "@lexical/extension/HorizontalRule", nodes: [Pe], register(e, t, n) {
  ...
  return ae(e.registerCommand(Ci, (i) => {
    if (Ei(i.target)) {
      ...
      if (mc(l)) return function(w, c = !1) {
        const p = Ht(), m = w.isSelected(), h = w.getKey();
        let u;
...
Yt({ build: (e, t, n) => $n(t), config: dn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return se(() => {
    if (!o.value) return fc(e, a);
  });
} });
const hc = Yt({ name: "@lexical/react/ReactProvider" });
function gc() {
...
Yt({ build: (e, t, n) => $n(t), config: dn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => se(() => n.getOutput().disabled.value ? void 0 : _a(e)) });
function xc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", e);
  for (const a of t) o.append("v", a);
...
function Pc() {
  const [e, t] = M(void 0), n = z(() => {
    ...
    return /* @__PURE__ */ r(ul, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Xo, { children: [
...
function Vc({
  ...
  const [t] = jt(), [n, o] = M(t), [a, s] = M("paragraph"), [i, l] = Pc(), w = () => {
  };
...
function Gc(e, t) {
  const n = qi(t) ? t.body.childNodes : t.childNodes;
  let o = [];
  const a = [];
...
function Da(e, t, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Da(e, g, h, o);
    !a && ye(t) && x && t.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
...
function Oa(e, t, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Ki(l)) && (l != null && Cn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Oa(m[g], t, n, u, new Map(a), l));
  return p != null && (h = p(h)), Wr(e) && (h = qc(e, h, u ? () => {
    const g = new Bo();
    return n.push(g), g;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
          /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
          /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: x }) })
        ] }) }),
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
          ...
          /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: g }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(le, { open: w, onOpenChange: c, children: [
      ...
      /* @__PURE__ */ r(
        Zt,
        {
          ...
          children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Wt, { children: e.map((N) => /* @__PURE__ */ r(
            Bt,
            {
              onSelect: () => {
                l(N === "" ? void 0 : N), c(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : N.key === "Enter" && N.shiftKey && (N.preventDefault(), N.stopPropagation(), Tt(a) && h());
        },
        onKeyDown: (N) => {
...
}), qe = rt.Trigger, Ba = rt.Group, rw = rt.Portal, ow = rt.Sub, aw = rt.RadioGroup;
...
const qt = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    rt.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(rt.ItemIndicator, { children: /* @__PURE__ */ r(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
    ...
    if (o && c)
      return /* @__PURE__ */ d(wt, { children: [
        /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              h(!0), g(Kc(e.contents)), w == null || w(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ d(Se, { children: [
          /* @__PURE__ */ r(qe, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Co, {}) }) }),
...
function iw({
  ...
  const [$, P] = M(ho), [y, C] = M(!1), [_, S] = M(!1), [E, A] = M(!1), [U, I] = M(!1), [G, D] = M(!1), [F, ct] = M(void 0), [ht, zt] = M(!1), [ut, j] = M(!1), [et, gt] = M(T), [yt, kt] = M(!1), de = Z(void 0), [fn, Xe] = M(/* @__PURE__ */ new Map());
  Y(() => {
    let R = !0;
    if (!o) {
      zt(!1), j(!1), Xe(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
  ...
  const Ct = B(() => te[0], [te]), hn = Z(null), Re = Z(void 0), pe = z(() => {
    var R;
  ...
  const q = B(
    ...
    () => nt === 1 ? q.singleReply : ve(q.multipleReplies, { count: nt }),
    [nt, q]
  ), bs = B(
    () => ue === 1 ? q.singleReply : ve(q.multipleReplies, { count: ue }),
    [ue, q]
  ), Ur = z(async () => {
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            _ && /* @__PURE__ */ r(
              L,
              {
                ...
                children: y ? /* @__PURE__ */ r(or, {}) : /* @__PURE__ */ r(_e, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
            fo,
            {
              ...
              handleDeleteComment: h,
              onEditingChange: I,
              canEditOrDelete: fn.get(Ct.id) ?? !1,
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    E ? /* @__PURE__ */ r(or, {}) : /* @__PURE__ */ r(_e, {})
                  ] })
                ]
              }
            ),
            Et.map((R) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              fo,
              {
                comment: R,
                localizedStrings: n,
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    F !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ve(
                    ...
                    /* @__PURE__ */ d(le, { open: G, onOpenChange: D, children: [
                      ...
                      /* @__PURE__ */ r(
                        Zt,
                        {
                          ...
                          children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(Wt, { children: g == null ? void 0 : g.map((R) => /* @__PURE__ */ r(
                            Bt,
                            {
                              onSelect: () => {
                                ct(R !== s ? R : void 0), D(!1);
...
function Pp({
  ...
  const T = n.filter(
    ...
    [x]
  ), { listboxRef: y, activeId: C, handleKeyDown: _ } = Jc({
    options: V,
    onOptionSelect: $
  }), S = z(
    (E) => {
...
const Ua = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  it.ScrollDownButton,
  {
    ref: n,
    className: f("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
...
const _t = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ d(
  it.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(it.ItemIndicator, { children: /* @__PURE__ */ r(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
      ...
      /* @__PURE__ */ d(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Te, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ r(_t, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
const Gt = b.forwardRef(({ className: e, onKeyDown: t, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
...
function xw({
  ...
  var P;
  const [p, m] = M([]), [h, u] = M([]), [g, x] = M({}), [v, N] = M({}), k = B(() => t ?? [], [t]), T = Uo({
    data: k,
    columns: e,
    getCoreRowModel: Ko(),
  ...
  let $;
  return w ? $ = Array.from({ length: 10 }).map((_, S) => `skeleton-row-${S}`).map((_) => /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(ke, { colSpan: V.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(gr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((P = T.getRowModel().rows) == null ? void 0 : P.length) > 0 ? $ = T.getRowModel().rows.map((y) => /* @__PURE__ */ r(
    Gt,
    {
      onClick: () => i(y, T),
      "data-state": y.getIsSelected() && "selected",
      children: y.getVisibleCells().map((C) => /* @__PURE__ */ r(ke, { children: tn(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    y.id
  )) : $ = /* @__PURE__ */ r(Gt, { children: /* @__PURE__ */ r(ke, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(lw, { table: T }),
    /* @__PURE__ */ d(Ln, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Bn, { stickyHeader: s, children: T.getHeaderGroups().map((y) => /* @__PURE__ */ r(Gt, { children: y.headers.map((C) => /* @__PURE__ */ r(cn, { children: C.isPlaceholder ? void 0 : tn(C.column.columnDef.header, C.getContext()) }, C.id)) }, y.id)) }),
...
function Lp({
  ...
  return /* @__PURE__ */ d(le, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ d(Zt, { id: s, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
function Bp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: e, children: /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ r(qe, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "default", children: [
...
function Cw({
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(le, { open: C, onOpenChange: p ?? k, children: [
    /* @__PURE__ */ r(ce, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Zt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Jt, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: y, children: i })
      ] }),
      /* @__PURE__ */ d(Wt, { children: [
...
function Tw({
  ...
  return /* @__PURE__ */ d(Se, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
      /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(qe, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: Ew(e, a, n) }) }) }),
...
function Dw({
  ...
  return /* @__PURE__ */ d(Se, { children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
      /* @__PURE__ */ r(Xi, { asChild: !0, children: /* @__PURE__ */ r(qe, { asChild: !0, children: /* @__PURE__ */ r(L, { variant: "outline", className: "tw-h-6", children: Sw(e, n) }) }) }),
      /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: Rw(e, n) }) })
    ] }) }),
...
function Gp({
  ...
  const w = Z(null), c = Cs(), [p, m] = M("generated"), [h, u] = M("*"), [g, x] = M("f"), [v, N] = M(!1), k = B(
    () => ({
      ...i,
  ...
  const T = z(() => {
    ...
    y && vn("note", y) && (y.insert.note && (p === "custom" ? y.insert.note.caller = h : y.insert.note.caller = p === "generated" ? ir : lr), n([y]));
  }, [p, h, n]), V = () => {
    var C;
    ...
    if (C && vn("note", C)) {
      ...
      g !== "x" && y === "x" ? I == null || I.forEach((G) => Mw(G)) : g === "x" && y !== "x" && (I == null || I.forEach((G) => Ow(G))), (U = w.current) == null || U.applyUpdate([C, { delete: 1 }]);
    }
  }, P = (y) => {
    var _, S, E, A, U;
    const C = (S = (_ = w.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : S.at(0);
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
          /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
          /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
          /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(
            L,
          ...
          /* @__PURE__ */ r(Rt, { children: l["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(Lt, { children: [
            /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r(L, { onClick: V, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Eo, {}) }) }),
            /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
...
function Vw({
  ...
  /* @__PURE__ */ d("span", { className: f("note-caller tw-inline-block", { formatted: s }), children: [
    ...
    jr(e.marker, [i], o, !1),
    " "
  ] }), h = t === "horizontal" ? "horizontal" : "vertical", u = o ? "marker-visible" : "", g = t === "horizontal" ? "tw-col-span-1" : "tw-col-span-2 tw-col-start-1 tw-row-start-2", x = f(h, u);
  return /* @__PURE__ */ d(wt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(wt, { children: Aw(e.marker, l, o, c) })
      }
    )
  ] });
}
function qp({
  ...
  const p = w ?? mi(n, void 0), m = (k, T) => {
    c == null || c(k, T, a);
  }, h = s ? n.findIndex((k) => k === s) : -1, [u, g] = M(h), x = (k, T, V) => {
    if (n.length)
      switch (k.key) {
        case "Enter":
        case " ":
...
function Lw({
  ...
  return /* @__PURE__ */ d(Ln, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Bn, { stickyHeader: !0, children: /* @__PURE__ */ d(Gt, { children: [
    ...
    /* @__PURE__ */ r(jn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Gt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(ke, { className: o, children: $w(l.text) })
        ]
      },
...
function Qp({
  ...
  const h = Pt(n, "%webView_inventory_all%"), u = Pt(n, "%webView_inventory_approved%"), g = Pt(n, "%webView_inventory_unapproved%"), x = Pt(n, "%webView_inventory_unknown%"), v = Pt(n, "%webView_inventory_scope_currentBook%"), N = Pt(n, "%webView_inventory_scope_chapter%"), k = Pt(n, "%webView_inventory_scope_verse%"), T = Pt(n, "%webView_inventory_filter_text%"), V = Pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = Pt(n, "%webView_inventory_no_results%"), [P, y] = M(!1), [C, _] = M("all"), [S, E] = M(""), [A, U] = M([]), I = B(() => {
    const j = e ?? [];
    return j.length === 0 ? [] : Fw(j, a, s);
  }, [e, a, s]), G = B(() => {
    if (P) return I;
    const j = [];
    return I.forEach((et) => {
  ...
  }, [P, I]), D = B(() => G.length === 0 ? [] : zw(G, C, S), [G, C, S]), F = B(() => {
    var gt, yt;
    if (!P) return w;
    ...
    for (let kt = 0; kt < j; kt++)
      et.push(
        Bw(
          ((yt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : yt[kt]) || "Additional Item",
          kt + 1
        )
      );
    return [...et, ...w];
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(Te, { children: [
              /* @__PURE__ */ r(_t, { value: "all", children: h }),
              /* @__PURE__ */ r(_t, { value: "approved", children: u }),
              /* @__PURE__ */ r(_t, { value: "unapproved", children: g }),
              /* @__PURE__ */ r(_t, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Le, { onValueChange: (j) => ht(j), defaultValue: i, children: [
        /* @__PURE__ */ r(Ee, { className: "tw-m-1", children: /* @__PURE__ */ r(Be, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Te, { children: [
          /* @__PURE__ */ r(_t, { value: "book", children: v }),
          /* @__PURE__ */ r(_t, { value: "chapter", children: N }),
          /* @__PURE__ */ r(_t, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ r(
        He,
...
const Ha = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Ka.Provider, { value: k, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Xa = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = Fn();
...
const Hw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  He,
  {
    ref: n,
    "data-sidebar": "input",
...
const Jw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  $e,
  {
    ref: n,
...
const Ww = b.forwardRef(({ className: e, asChild: t = !1, ...n }, o) => /* @__PURE__ */ r(
  t ? ze : "button",
  {
    ref: o,
  ...
  ({
    ...
    const w = e ? ze : "button", { state: c } = Fn(), p = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": t,
        className: f(Zw({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Ut, { asChild: !0, children: p }),
      /* @__PURE__ */ r(Rt, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : p;
  }
);
Qa.displayName = "SidebarMenuButton";
const Qw = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  t ? ze : "button",
  {
    ref: a,
...
const ed = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, o) => {
...
const od = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  e ? ze : "a",
  {
    ref: s,
...
const ne = "scrBook", sd = "scrRef", be = "source", id = "details", ld = "Scripture Reference", cd = "Scripture Book", ts = "Type", wd = "Details";
function dd(e, t) {
  const n = t ?? !1;
  return [
    {
...
function ru({
  ...
  const [c, p] = M([]), [m, h] = M([{ id: ne, desc: !1 }]), [u, g] = M({}), x = B(
  ...
  Y(() => {
    if (l) {
      ...
      if (S.length === 1) {
        const E = x.find((A) => vo(A) === S[0]) || void 0;
        E && l(E);
      }
    }
  }, [u, x, l, N]);
  const k = a ?? cd, T = s ?? ts, V = [
  ...
  }, y = (_, S) => _.getIsGrouped() ? "" : f("banded-row", S % 2 === 0 ? "even" : "odd"), C = (_, S, E) => {
    ...
    !t && /* @__PURE__ */ d(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(cw, { children: V.map((_) => /* @__PURE__ */ r(_t, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ln, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ r(Bn, { children: N.getHeaderGroups().map((_) => /* @__PURE__ */ r(Gt, { children: _.headers.filter((S) => S.column.columnDef.header).map((S) => (
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (E === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(rr, {})),
                          " ",
...
function md({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
            ...
            Jt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  ...
                  /* @__PURE__ */ r(L, { variant: "ghost", size: "sm", onClick: U, children: c })
                ] }),
                /* @__PURE__ */ d(Wt, { children: [
                  /* @__PURE__ */ r(un, { children: p }),
                  Object.values(H).map((I, G) => {
                    const D = y[I];
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(yo, { children: [
                        ...
                        G < Object.values(H).length - 1 && /* @__PURE__ */ r(Wo, {})
                      ] }, I);
                  })
                ] })
              ]
...
function au({
  ...
  const c = fe(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = fe(i, "%webView_scope_selector_current_book%"), u = fe(i, "%webView_scope_selector_choose_books%"), g = fe(i, "%webView_scope_selector_scope%"), x = fe(i, "%webView_scope_selector_select_books%"), v = [
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          Te,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((c) => /* @__PURE__ */ r(_t, { value: `${c}`, children: l[W(c)] }, `${c}`))
          }
        )
      ]
    }
...
function yr({
  ...
  return /* @__PURE__ */ d(Se, { variant: s, children: [
    /* @__PURE__ */ r(qe, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(L, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(ei, {}) }) }),
    /* @__PURE__ */ r(we, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(yo, { children: [
      /* @__PURE__ */ r(Ba, { children: /* @__PURE__ */ r(St, { children: rs(t.groups, t.items, w, e) }) }),
...
function pu({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(as, { children: [
      /* @__PURE__ */ r(ss, { children: e.map((l) => /* @__PURE__ */ r(fd, { value: l.value, children: l.value }, l.key)) }),
  ...
  return /* @__PURE__ */ r(
    ot.Trigger,
    {
      ...
      className: f(
        ...
        // CUSTOM
        "pr-twp",
        Qt({ variant: o.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...t
    }
...
const bd = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    ot.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
bd.displayName = ot.CheckboxItem.displayName;
const vd = b.forwardRef(({ className: e, children: t, ...n }, o) => {
  const a = It();
  return /* @__PURE__ */ d(
    ot.RadioItem,
    {
...
vd.displayName = ot.RadioItem.displayName;
...
const We = (e, t) => {
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d(Lt, { children: [
      /* @__PURE__ */ r(Ut, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        us,
        {
          onClick: () => {
            o(c);
      ...
      c.tooltip && /* @__PURE__ */ r(Rt, { children: c.tooltip })
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    switch (m.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), We(i, [h, u]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ r(ls, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(hd, { children: [
      /* @__PURE__ */ r(cs, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        ps,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(St, { children: fs(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Se, { children: [
              /* @__PURE__ */ r(qe, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Co, {}) }) }),
...
const _d = wn(({ className: e, ...t }, n) => /* @__PURE__ */ r(oi, { size: 35, className: f("tw-animate-spin", e), ...t, ref: n }));
...
), Ed = b.forwardRef(({ className: e, variant: t, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Sd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Sd.displayName = "AlertDescription";
const vu = at.Root, xu = at.Trigger, yu = at.Group, Nu = at.Portal, ku = at.Sub, _u = at.RadioGroup, Rd = b.forwardRef(({ className: e, inset: t, children: n, ...o }, a) => /* @__PURE__ */ d(
  at.SubTrigger,
  {
    ref: a,
    className: f(
...
Rd.displayName = at.SubTrigger.displayName;
const Dd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  at.SubContent,
  {
    ref: n,
    className: f(
...
Dd.displayName = at.SubContent.displayName;
const Md = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(at.Portal, { children: /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: f(
...
Md.displayName = at.Content.displayName;
...
Od.displayName = at.Item.displayName;
const Id = b.forwardRef(({ className: e, children: t, checked: n, ...o }, a) => /* @__PURE__ */ d(
  at.CheckboxItem,
  {
    ref: a,
    className: f(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(at.ItemIndicator, { children: /* @__PURE__ */ r(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
Id.displayName = at.CheckboxItem.displayName;
const Ad = b.forwardRef(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ d(
  at.RadioItem,
  {
    ref: o,
    className: f(
...
Pd.displayName = at.Label.displayName;
...
Vd.displayName = at.Separator.displayName;
...
const Cu = Ot.Trigger, Bd = Ot.Portal, Eu = Ot.Close, gs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ r(
  Ot.Overlay,
  {
    ref: n,
...
const jd = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...o }, a) => {
...
Gd.displayName = Ot.Title.displayName;
...
Ud.displayName = Ot.Description.displayName;
...
Hd.displayName = dr.Root.displayName;
const Mu = xt.Root, Xd = b.forwardRef(({ className: e, ...t }, n) => {
  const o = pt();
  return /* @__PURE__ */ r(
    xt.List,
    {
...
Xd.displayName = xt.List.displayName;
...
Yd.displayName = xt.Trigger.displayName;
...
Jd.displayName = xt.Content.displayName;
