...
var bs = (t, e, n) => e in t ? gs(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var yt = (t, e, n) => bs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as dn, useRef as U, useMemo as B, useState as S, useCallback as K, useLayoutEffect as Ot, createContext as Dn, useContext as yr, useEffect as H, Component as vs, createElement as Br, Suspense as xs, Fragment as xo } from "react";
import { Command as Tt } from "cmdk";
import { X as Ke, Search as yo, Check as Vt, Clock as Kr, ChevronsLeft as Ur, ChevronsRight as Gr, ChevronLeft as er, ChevronRight as $e, ArrowLeft as ys, ArrowRight as Ns, Circle as Mn, ChevronDown as Ue, BoldIcon as ks, ItalicIcon as _s, AtSign as No, Pencil as Cs, Trash2 as Es, ArrowUp as ko, MoreHorizontal as Ts, MailOpen as Rs, Mail as Ss, ChevronUp as _o, FilterIcon as Ds, ArrowLeftIcon as Ms, ChevronLeftIcon as Is, ChevronRightIcon as Os, ArrowRightIcon as As, Copy as Co, Filter as Ps, User as $s, Link as Ls, CircleHelp as Vs, ChevronsUpDown as Eo, Star as js, Undo as zs, Redo as Fs, SquareX as To, FunctionSquare as Ro, SquareSigma as So, Ban as Bs, AlertCircle as nr, CircleCheckIcon as Ks, CircleXIcon as Us, CircleHelpIcon as Gs, ArrowUpIcon as qs, ArrowDownIcon as Hs, PanelLeft as Ys, PanelRight as Xs, ScrollText as Ws, MenuIcon as Js, Menu as Zs, EllipsisVertical as Qs, MoreVertical as qr, LoaderCircle as ti, GripVertical as ei } from "lucide-react";
import { clsx as ni } from "clsx";
import { extendTailwindMerge as ri } from "tailwind-merge";
import * as Dt from "@radix-ui/react-dialog";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as fn, Section as W, getChaptersForBook as oi, formatScrRef as ke, getSectionForBook as en, formatRelativeDate as ai, formatReplacementString as Ne, sanitizeHtml as si, NumberFormat as ii, formatBytes as li, getCurrentLocale as wi, usfmMarkers as xn, getFormatCallerFunction as ci, deepEqual as di, isString as Hr, compareScrRefs as rr, scrRefToBBBCCCVVV as Fn, getLocalizeKeyForScrollGroupId as tt } from "platform-bible-utils";
...
import * as Do from "@radix-ui/react-label";
import * as sn from "@radix-ui/react-radio-group";
import { createEditor as Mo, $getRoot as pe, $createParagraphNode as In, $getSelection as Lt, HISTORY_MERGE_TAG as Nr, ParagraphNode as Io, TextNode as Oo, $isTokenOrSegmented as pi, $getCharacterOffsets as ui, $cloneWithPropertiesEphemeral as mi, $findMatchingParent as Ao, $isElementNode as ce, $isRangeSelection as Ee, CLEAR_EDITOR_COMMAND as Po, COMMAND_PRIORITY_EDITOR as $o, mergeRegister as ue, shallowMergeConfig as fi, defineExtension as Ht, safeCast as pn, createState as hi, FORMAT_TEXT_COMMAND as Lo, $isNodeSelection as Vo, COMMAND_PRIORITY_LOW as jo, RootNode as gi, LineBreakNode as bi, TabNode as vi, $isEditorState as xi, createCommand as yi, CLICK_COMMAND as Ni, isDOMNode as ki, $getNodeFromDOMNode as _i, $createNodeSelection as Ci, $setSelection as Ei, DecoratorNode as or, $getState as Ti, toggleTextFormatType as Yr, TEXT_TYPE_TO_FORMAT as Ri, $setState as Si, addClassNamesToElement as zo, $create as Di, $getNodeByKey as Mi, removeClassNamesFromElement as Ii, KEY_TAB_COMMAND as Oi, $isBlockElementNode as kn, $createRangeSelection as Ai, $normalizeSelection__EXPERIMENTAL as Pi, OUTDENT_CONTENT_COMMAND as $i, INDENT_CONTENT_COMMAND as Xr, INSERT_TAB_COMMAND as Li, COMMAND_PRIORITY_CRITICAL as kr, $isDecoratorNode as Vi, $isParagraphNode as ji, $isTextNode as _n, SELECTION_CHANGE_COMMAND as Fo, getRegisteredNode as zi, isHTMLElement as Fi, isDocumentFragment as Wr, isDOMDocumentNode as Bi, ArtificialNode__DO_NOT_USE as Bo, $createLineBreakNode as Ko, $isRootOrShadowRoot as Ki, isBlockDomNode as Jr, isInlineDomNode as Zr, $insertNodes as Ui } from "lexical";
import * as Te from "@radix-ui/react-tooltip";
import { TooltipTrigger as Gi } from "@radix-ui/react-tooltip";
import { HeadingNode as qi, QuoteNode as Hi, registerRichText as Yi } from "@lexical/rich-text";
import { flushSync as Xi, createPortal as Wi } from "react-dom";
...
import { DropdownMenuTrigger as Zi } from "@radix-ui/react-dropdown-menu";
import { useReactTable as Ho, getFilteredRowModel as Qi, getSortedRowModel as Yo, getPaginationRowModel as tl, getCoreRowModel as Xo, flexRender as nn, getGroupedRowModel as el, getExpandedRowModel as nl } from "@tanstack/react-table";
import * as ct from "@radix-ui/react-select";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ar, HIDDEN_NOTE_CALLER as sr, getDefaultViewOptions as ol, isInsertEmbedOpOfType as hn, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
const ll = ri({ prefix: "tw-" });
function f(...t) {
  return ll(ni(t));
}
const He = 250, Wo = 300, wl = 400, cl = 450, dl = 500, pl = "layoutDirection";
function pt() {
  const t = localStorage.getItem(pl);
  return t === "rtl" ? t : "ltr";
}
const ul = Dt.Root, Np = Dt.Trigger, ml = Dt.Portal, kp = Dt.Close, Jo = b.forwardRef(({ className: t, style: e, ...n }, o) => /* @__PURE__ */ r(
  Dt.Overlay,
  {
    ref: o,
    className: f(
...
Jo.displayName = Dt.Overlay.displayName;
const Zo = b.forwardRef(({ className: t, children: e, overlayClassName: n, style: o, ...a }, s) => {
  const i = pt();
  return /* @__PURE__ */ p(ml, { children: [
    /* @__PURE__ */ r(Jo, { className: n }),
    /* @__PURE__ */ p(
      Dt.Content,
      {
        ref: s,
...
Zo.displayName = Dt.Content.displayName;
...
const ta = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Dt.Title,
  {
    ref: n,
...
ta.displayName = Dt.Title.displayName;
...
hl.displayName = Dt.Description.displayName;
...
const Ye = b.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(yo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      Tt.Input,
      {
        ref: n,
...
const ra = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), _e = Object.fromEntries(
  ra.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function Tr(t, e, n) {
...
const oa = dn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ge : "button", { className: f(aa({ variant: e, size: n, className: t })), ref: s, ...a })
);
z.displayName = "Button";
const oe = Le.Root, ge = Le.Trigger, bl = Le.Anchor, Xt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = pt();
...
function cr(t, e, n) {
  return `${t} ${_e[t]}${e ? ` ${Er(t, e)} ${Pe(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function vl({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(oe, { open: d, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Xt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(qt, { heading: s, children: t.map((u) => /* @__PURE__ */ p(
      Yt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Kr, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function _p(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
  ...
  const o = xl.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!d && w) {
          const u = ((g) => Object.keys(_e).find(
            (y) => _e[y].toLowerCase() === g.toLowerCase()
          ))(l);
...
function Cp({
  ...
  const c = pt(), [d, m] = S(!1), [h, u] = S(""), [g, y] = S(""), [x, R] = S("books"), [v, _] = S(void 0), [C, F] = S(!1), V = U(void 0), $ = U(void 0), T = U(void 0), M = U(void 0), E = U({}), O = K(
    (I) => {
      e(I), l && l(I);
    },
    [e, l]
  ), A = B(() => o ? o() : ra, [o]), Y = B(() => ({
    [W.OT]: A.filter((k) => dt.isBookOT(k)),
    [W.NT]: A.filter((k) => dt.isBookNT(k)),
    [W.DC]: A.filter((k) => dt.isBookDC(k)),
    [W.Extra]: A.filter((k) => dt.extraBooks().includes(k))
  }), [A]), P = B(() => Object.values(Y).flat(), [Y]), Z = B(() => {
    if (!g.trim()) return Y;
    const I = {
      [W.OT]: [],
      [W.NT]: [],
    ...
    return [W.OT, W.NT, W.DC, W.Extra].forEach((L) => {
      I[L] = Y[L].filter((q) => Tr(q, g, a));
    }), I;
  }, [Y, g, a]), N = B(
    () => yl(g, P, a),
    [g, P, a]
    ...
    [x, St]
  ), { otLong: st, ntLong: it, dcLong: mt, extraLong: vt } = {
    ...
    (I) => {
      if (I.ctrlKey) return;
      const { isLetter: k, isDigit: L } = Qr(I.key);
      if (x === "chapters") {
        if (I.key === "Backspace") {
          I.preventDefault(), I.stopPropagation(), St();
          return;
        }
        if (k || L) {
          if (I.preventDefault(), I.stopPropagation(), R("books"), _(void 0), L && v) {
            const q = _e[v];
            y(`${q} ${I.key}`);
          } else
            y(I.key);
      ...
      if ((x === "chapters" || x === "books" && N) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(I.key)) {
        const q = x === "chapters" ? v : N == null ? void 0 : N.book;
        if (!q) return;
        const X = (() => {
          if (!h) return 1;
          const wt = h.match(/(\d+)$/);
        ...
        switch (I.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            J = X === 0 ? et : Math.max(1, X - ht);
            break;
          case "ArrowDown":
            J = X === 0 ? 1 : Math.min(et, X + ht);
            break;
          default:
            return;
        }
        J !== X && (I.preventDefault(), I.stopPropagation(), u(cr(q, a, J)), setTimeout(() => {
          const wt = E.current[J];
    ...
    const { isLetter: k, isDigit: L } = Qr(I.key);
    (k || L) && (I.preventDefault(), y((q) => q + I.key), $.current.focus(), F(!1));
  }, []);
  return Ot(() => {
    const I = setTimeout(() => {
      if (d && x === "books" && T.current && M.current) {
        const k = T.current, L = M.current, q = L.offsetTop, X = k.clientHeight, et = L.clientHeight, J = q - X / 2 + et / 2;
        k.scrollTo({
          top: Math.max(0, J),
          behavior: "smooth"
        }), u(cr(t.book));
  ...
  }, [x, v, N, t.book, t.chapterNum]), /* @__PURE__ */ p(oe, { open: d, onOpenChange: j, children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: Me })
      }
    ) }),
      ...
      ne,
      {
        ...
        children: [
          x === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: ft.map(({ onClick: I, disabled: k, title: L, icon: q }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              z,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(ys, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ns, { className: "tw-h-4 tw-w-4" })
              }
            ),
            v && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Pe(v, a) })
          ] }),
          !C && /* @__PURE__ */ p(re, { ref: T, children: [
            x === "books" && /* @__PURE__ */ p(lt, { children: [
              !N && Object.entries(Z).map(([I, k]) => {
                if (k.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(qt, { heading: se(I), children: k.map((L) => /* @__PURE__ */ r(
                      oa,
                      {
                        bookId: L,
                        onSelect: (q) => ut(q),
              ...
              N && /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(
                Yt,
                {
                  value: `${N.book} ${_e[N.book]} ${N.chapterNum || ""}:${N.verseNum || ""})}`,
                  onSelect: G,
              ...
              N && Gt(N.book) > 1 && /* @__PURE__ */ p(lt, { children: [
...
), gt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Do.Root, { ref: n, className: f("pr-twp", kl(), t), ...e }));
gt.displayName = Do.Root.displayName;
...
function dr({
  ...
  const [_, C] = S(!1), F = c ?? w, V = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], $ = (T, M) => {
    const E = w(T), O = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, A = `${M ?? ""}${E}${O ?? ""}`;
    return /* @__PURE__ */ p(
      Yt,
      {
        value: E,
        ...
        children: [
          ...
          /* @__PURE__ */ p("span", { className: "tw-flex-1 tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap", children: [
            E,
            O && /* @__PURE__ */ p("span", { className: "tw-text-muted-foreground", children: [
              " · ",
              O
            ] })
          ] })
    ...
    /* @__PURE__ */ r(
      Xt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: V(e) ? e.map((T) => /* @__PURE__ */ r(qt, { heading: T.groupHeading, children: T.options.map((M) => $(M, T.groupHeading)) }, T.groupHeading)) : e.map((T) => $(T)) })
        ] })
      }
    )
  ] });
    ...
    Rr,
    {
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(gt, { className: "tw-flex tw-items-center", children: o.map((x) => dt.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
const ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Tl = ia ? Ot : H, gn = { tag: Nr };
function Rl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = El(null, o), d = Mo({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, d), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = In();
            u.append(g);
            const y = ia ? document.activeElement : null;
  ...
  }, []), r(sa.Provider, { value: n, children: e });
}
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : H;
...
const Sr = {
  ...
  mark: "",
  markOverlap: ""
}, kt = Te.Provider, Ct = Te.Root, Et = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  Te.Trigger,
  {
    ref: o,
    className: e ? f(aa({ variant: e }), t) : t,
    ...n
  }
));
Et.displayName = Te.Trigger.displayName;
const _t = b.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(Te.Portal, { children: /* @__PURE__ */ r(
  Te.Content,
  {
    ref: a,
    sideOffset: e,
...
class Il extends vs {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Ol(e.resetKeys, a)) {
      var s, i;
...
const Pl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : H;
function $l(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Ll() {
  return function(t) {
    const [e] = Wt(), n = B(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), s = U(o);
    return Pl(() => {
...
const la = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, zl = la && "documentMode" in document ? document.documentMode : null;
!(!la || !("InputEvent" in window) || zl) && "getTargetRanges" in new window.InputEvent("input");
function Fl(t) {
  const e = Ao(t, (n) => ce(n) && !n.isInline());
  return ce(e) || jl(4, t.__key), e;
}
function Bl(t) {
  const e = Lt();
  if (!Ee(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Ao(s, (c) => ce(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function xe(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = yn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Gl(t, e) {
  return new xe(t, e);
}
...
function ql(t) {
  ...
  ca(this), Q = t, this.f &= -2, 8 & this.f && Mr(this), An();
}
function Ae(t, e) {
...
Nt.prototype.brand = Kl, Nt.prototype.h = function() {
  return !0;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && eo(() => {
      var o;
...
} }), xe.prototype = new Nt(), xe.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, da(this), ro(this), de++;
  const t = Q;
  return Q = this, ql.bind(this, t);
...
function pa() {
  const t = pe(), e = Lt(), n = In();
  t.clear(), t.append(n), e !== null && n.select(), Ee(e) && (e.format = 0);
}
function ua(t, e = pa) {
  return t.registerCommand(Po, (n) => (t.update(e), !0), $o);
}
Ht({ build: (t, e, n) => Pn(e), config: pn({ $onClear: pa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return me(() => ua(t, o.value));
} });
function Hl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Gn = hi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ma extends or {
  $config() {
  ...
  toggleFormat(e) {
    const n = this.getFormat(), o = Yr(n, e, null);
...
Ht({ name: "@lexical/extension/DecoratorText", nodes: () => [ma], register: (t, e, n) => t.registerCommand(Lo, (o) => {
  const a = Lt();
  if (Vo(a) || Ee(a)) for (const s of a.getNodes()) Yl(s) && s.toggleFormat(o);
  return !1;
}, jo) });
function fa(t, e) {
  let n;
...
const mr = Ht({ build: (t) => fa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Ir = 0, fr = 1, ga = 2, qn = 3, bn = 4, Oe = 5, Hn = 6, Ze = 7;
function Yn(t) {
  return t.id === Ir;
}
function ba(t) {
...
function Xl(t) {
  return function(e) {
    return e.id === fr;
  }(t) || nt(305, String(t.id), String(fr)), Object.assign(t, { id: ga });
}
...
const Ql = Ht({ config: pn({ setOptions: oo, updateOptions: oo }), init: ({ $initialEditorState: t = Zl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (xi(s)) t.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [gi, Oo, bi, vi, Io] }), ao = Symbol.for("@lexical/extension/LexicalBuilder");
function so() {
}
function tw(t) {
  throw t;
...
class on {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Mo({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [ao]: this });
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of Hl(m)) {
...
const ew = /* @__PURE__ */ new Set(), io = Ht({ build(t, e, n) {
  const o = n.getDependency(mr).output, a = ln({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = fa(() => {
  }, () => me(() => {
...
yi("INSERT_HORIZONTAL_RULE_COMMAND");
class Ve extends or {
  static getType() {
...
Ht({ dependencies: [mr, io], name: "@lexical/extension/HorizontalRule", nodes: () => [Ve], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(io).output, a = ln({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ue(t.registerCommand(Ni, (i) => {
    if (ki(i.target)) {
      const l = _i(i.target);
      if (rw(l)) return function(w, c = !1) {
        const d = Lt(), m = w.isSelected(), h = w.getKey();
        let u;
        c && Vo(d) ? u = d : (u = Ci(), Ei(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, jo), t.registerMutationListener(Ve, (i, l) => {
    Ul(() => {
      let w = !1;
    ...
    const i = [];
    for (const { domNode: l, selectedSignal: w } of a.value.nodeSelections.values()) i.push(me(() => {
      const c = l.value;
      c && (w.value ? zo(c, s) : Ii(c, s));
    }));
    return ue(...i);
  }));
} });
...
function ow(t, e, n = xa) {
  return ue(t.registerCommand(Oi, (o) => {
    const a = Lt();
    if (!Ee(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => kn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), m = Fl(d);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Ai();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Pi(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? $i : Xr : Li;
    return t.dispatchCommand(s, void 0);
  }, $o), t.registerCommand(Xr, () => {
...
Ht({ build: (t, e, n) => Pn(e), config: pn({ $canIndent: xa, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return me(() => {
    if (!o.value) return ow(t, a, s);
  });
} });
const aw = Ht({ name: "@lexical/react/ReactProvider" });
function sw() {
...
Ht({ build: (t, e, n) => Pn(e), config: pn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => me(() => n.getOutput().disabled.value ? void 0 : Na(t)) });
function ww(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Or = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : H;
  ...
  return function(n, o) {
    ...
    return Or(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (h) => n._onError(h), children: r(xs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(Wi(d, m, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function dw({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(aw.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && ww(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(cw, { editor: t, ErrorBoundary: e });
}
function lo(t) {
  return t.getEditorState().read(ya(t.isComposing()));
}
function pw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Wt();
  return function(a) {
    Or(() => ue(Yi(a), Na(a)), [a]);
  }(o), p(lt, { children: [t, r(uw, { content: e }), r(dw, { editor: o, ErrorBoundary: n })] });
}
...
const fw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : H;
function hw({ onClear: t }) {
  const [e] = Wt();
  return fw(() => ua(e, t), [e, t]), null;
}
const ka = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ot : H;
function gw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: y, role: x = "textbox", spellCheck: R = !0, style: v, tabIndex: _, "data-testid": C, ...F }, V) {
  const [$, T] = S(t.isEditable()), M = K((O) => {
    O && O.ownerDocument && O.ownerDocument.defaultView ? t.setRootElement(O) : t.setRootElement(null);
  }, [t]), E = B(() => /* @__PURE__ */ function(...O) {
    return (A) => {
      for (const Y of O) typeof Y == "function" ? Y(A) : Y != null && (Y.current = A);
    };
  }(V, M), [M, V]);
  return ka(() => (T(t.isEditable()), t.registerEditableListener((O) => {
    T(O);
  })), [t]), r("div", { "aria-activedescendant": $ ? e : void 0, "aria-autocomplete": $ ? n : "none", "aria-controls": $ ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": $ && x === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": d, "aria-owns": $ ? m : void 0, "aria-readonly": !$ || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: $, "data-testid": C, id: y, ref: E, role: x, spellCheck: R, style: v, tabIndex: _, ...F });
}
const bw = dn(gw);
function wo(t) {
  return t.getEditorState().read(ya(t.isComposing()));
...
function xw(t, e) {
  ...
  return p(lt, { children: [r(bw, { editor: a, ...o, ref: e }), n != null && r(yw, { editor: a, content: n })] });
}
function yw({ content: t, editor: e }) {
  ...
  if (Ot(() => (a(e.isEditable()), e.registerEditableListener((i) => {
    a(i);
  })), [e]), !n) return null;
  let s = null;
...
function kw({
  ...
  return /* @__PURE__ */ r(_a.Provider, { value: i, children: s });
}
function Ca() {
  const t = yr(_a);
  if (!t)
...
function _w() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(ul, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Zo, { children: [
      /* @__PURE__ */ r(Qo, { children: /* @__PURE__ */ r(ta, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = K(
    (s, i, l = !1) => {
...
function Cw({
  ...
  const [e] = Wt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = _w(), w = () => {
  };
...
), Tw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Uo.Root,
  {
    ref: a,
    className: f(Ea({ variant: e, size: n, className: t })),
    ...o
  }
));
Tw.displayName = Uo.Root.displayName;
const Ta = b.createContext({
  size: "default",
  variant: "default"
...
function Rw() {
  const { activeEditor: t } = Ca(), [e, n] = S([]), o = K((a) => {
    if (Ee(a) || Ji(a)) {
      const s = [];
      co.forEach(({ format: i }) => {
...
function Dw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(Cw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Rw, {}) }) }),
    /* @__PURE__ */ p("div", { className: "tw-relative", children: [
      ...
      e && /* @__PURE__ */ r(mw, { defaultSelection: "rootEnd" }),
...
function Iw(t, e) {
  const n = Bi(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Bo && i.insertAfter(Ko());
    for (const i of s) {
...
function Ra(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = ce(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && _n(e) && (i = Vl(o, e, "clone"));
  const l = ce(i) ? i.getChildren() : [], w = zi(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], y = Ra(t, g, h, o);
    !a && ce(e) && y && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Fi(d) || Wr(d)) && d.append(h), n.append(d), m) {
      const u = m.call(i, d);
      u && (Wr(d) ? d.replaceChildren(u) : d.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
...
function Da(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Ki(l)) && (l != null && kn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Da(m[g], e, n, u, new Map(a), l));
  return d != null && (h = d(h)), Jr(t) && (h = Aw(t, h, u ? () => {
    const g = new Bo();
    return n.push(g), g;
  } : In)), l == null ? h.length > 0 ? i = i.concat(h) : Jr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Zr(g.nextSibling) && Zr(g.previousSibling);
  }(t) && (i = i.concat(Ko())) : ce(l) && l.append(...h), i;
}
function Aw(t, e, n) {
...
function Sp({
  ...
  const [s, i] = S($w), [l, w] = S(a), [c, d] = S(!1), m = U(void 0), h = U(null);
  H(() => {
    let v = !0;
    const _ = h.current;
    if (!_) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
          /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Ke, {}) }) }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), n()) : $r(v) && (v.preventDefault(), v.stopPropagation(), $t(s) && u());
        },
        onKeyDown: (v) => {
...
const Dp = Object.freeze([
...
], Lw = ["input", "select", "textarea", "button"], Vw = ["button", "textbox"], jw = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = U(null), [s, i] = S(void 0), [l, w] = S(void 0), c = K(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(x && g && x.contains(g) && g !== x) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const M = T.findIndex((O) => O === g);
          if (M === -1) return;
          let E;
          u.key === "ArrowDown" ? E = Math.min(M + 1, T.length - 1) : E = Math.max(M - 1, 0), E !== M && (u.preventDefault(), u.stopPropagation(), ($ = T[E]) == null || $.focus());
          return;
        }
        return;
      }
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", zw({ variant: e }), t), ...n })
);
...
const Kw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
ze.displayName = qo.Root.displayName;
...
Pa.displayName = qe.Root.displayName;
...
Gw.displayName = qe.Image.displayName;
...
$a.displayName = qe.Fallback.displayName;
const Lr = Dn(void 0);
function zt() {
  const t = yr(Lr);
  if (!t)
...
}), Re = rt.Trigger, La = rt.Group, qw = rt.Portal, Hw = rt.Sub, Yw = rt.RadioGroup;
function fe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Lr.Provider, { value: n, children: /* @__PURE__ */ r(rt.Root, { ...e }) });
}
...
Rn.displayName = rt.Item.displayName;
const te = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
      ...
      dir: s,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(rt.ItemIndicator, { children: /* @__PURE__ */ r(Vt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
...
const za = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(rt.ItemIndicator, { children: /* @__PURE__ */ r(Mn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
Xe.displayName = rt.Separator.displayName;
...
function po({
  ...
  const u = K(
    ...
    return Ne(n["%comment_dateAtTime%"], {
      date: F,
      time: V
    });
    ...
    [t.user]
  ), v = B(() => si(t.contents), [t.contents]), _ = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          Rn,
          {
            onClick: (C) => {
              C.stopPropagation(), c(!0), m(Pw(t.contents)), i == null || i(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Pa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r($a, { className: "tw-text-xs tw-font-medium", children: R }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : $r(C) && (C.preventDefault(), C.stopPropagation(), $t(d) && g());
              },
              onKeyDown: (C) => {
        ...
        _ && /* @__PURE__ */ p(fe, { children: [
          /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Ts, {}) }) }),
...
function Ww({
  ...
  const [T, M] = S(uo), [E, O] = S(
    void 0
  ), A = o, [Y, P] = S(!1), [Z, N] = S(!1), [G, ut] = S(!1), [bt, Mt] = S(!1), [ft, St] = S(!1), [j, st] = S(C), [it, mt] = S(!1), vt = U(void 0), [se, be] = S(/* @__PURE__ */ new Map());
  H(() => {
    let D = !0;
    return (async () => {
      const Kt = v ? await v(w) : !1;
      D && St(Kt);
    })(), () => {
      D = !1;
    };
    ...
    let D = !0;
    if (!o) {
      Mt(!1), be(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const Kt = R ? await R(w) : !1;
      D && Mt(Kt);
    })(), () => {
      D = !1;
    };
  ...
  const Me = U(o), At = U(!1);
  H(() => {
    const D = Me.current && !o;
    if (Me.current = o, !o) {
      D && O(void 0), At.current = !1;
      return;
    }
    bt ? !At.current && $ !== void 0 && (O($), At.current = !0) : At.current && (O(void 0), At.current = !1);
  }, [o, $, bt]);
  const Pt = B(() => e.filter((D) => !D.deleted), [e]);
  H(() => {
    let D = !0;
    if (!o || !_) {
      be(/* @__PURE__ */ new Map());
  ...
  const Jt = B(() => Pt[0], [Pt]), Je = U(null), I = U(void 0), k = K(() => {
    var D;
    (D = I.current) == null || D.call(I), M(uo);
  }, []), L = K(() => {
    const D = !j;
    st(D), mt(!D), g == null || g(w, D);
  }, [j, g, w]);
  H(() => {
    P(!1);
  }, [o]), H(() => {
  ...
  const q = B(
    ...
    const D = Nn(s, n);
    return Ne(n["%comment_assigned_to%"], {
      assignedUser: D
    });
  }, [s, n]), et = B(() => Pt.slice(1), [Pt]), J = B(() => et.length ?? 0, [et.length]), ht = B(() => J > 0, [J]), wt = B(() => Y || J <= 2 ? et : et.slice(-2), [et, J, Y]), xt = B(() => Y || J <= 2 ? 0 : J - 2, [J, Y]), Ft = B(
    () => J === 1 ? q.singleReply : Ne(q.multipleReplies, { count: J }),
    [J, q]
  ), Zt = B(
    () => xt === 1 ? q.singleReply : Ne(q.multipleReplies, { count: xt }),
    [xt, q]
  );
  H(() => {
    !o && Z && ht && N(!1);
  ...
  const ie = K(
    async (D) => {
      ...
      Bt && await m({ threadId: w, contents: Bt }) && k();
    },
    [
      k,
      T,
    ...
    async (D) => {
      const Bt = $t(T) ? Tn(T) : void 0, Kt = D.status ? D.assignedUser : E ?? D.assignedUser, Ie = await m({
        ...D,
        contents: Bt,
        assignedUser: Kt
      });
      return Ie && Bt && k(), Ie && E !== void 0 && O(void 0), Ie;
    },
    [k, T, m, E]
  );
  if (Pt.length !== 0)
    return /* @__PURE__ */ r(
      Oa,
      {
        ...
        tabIndex: -1,
        children: /* @__PURE__ */ p(Aa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
            /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
              X && /* @__PURE__ */ r(je, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: X }),
              /* @__PURE__ */ r(
                z,
                {
                  variant: "ghost",
                  ...
                  children: j ? /* @__PURE__ */ r(Rs, {}) : /* @__PURE__ */ r(Ss, {})
                }
              ),
            ...
            /* @__PURE__ */ r(
              po,
              {
                ...
                isThreadExpanded: o,
                threadStatus: d,
                handleAddCommentToThread: le,
                handleUpdateComment: h,
                handleDeleteComment: u,
                onEditingChange: N,
                canEditOrDelete: (!Z && se.get(Jt.id)) ?? !1,
                canUserResolveThread: ft
              }
            )
          ] }),
          /* @__PURE__ */ p(lt, { children: [
            ht && !o && /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                      ...
                      Y ? /* @__PURE__ */ r(_o, {}) : /* @__PURE__ */ r(Ue, {})
                    ] })
                  ]
                }
              ),
              wt.map((D) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
                po,
                {
                  comment: D,
                  localizedStrings: n,
                  ...
                  handleDeleteComment: u,
                  onEditingChange: N,
                  canEditOrDelete: (!Z && se.get(D.id)) ?? !1
                }
              ) }, D.id)),
              x !== !1 && (!Z || $t(T)) && /* @__PURE__ */ p(
                "div",
                {
                  role: "textbox",
                  tabIndex: -1,
                  ...
                  onKeyDownCapture: (D) => {
                    $r(D) && (D.preventDefault(), D.stopPropagation(), ($t(T) || E !== void 0) && ie());
                  },
                  onKeyDown: (D) => {
                    Pr(D), (D.key === "Enter" || D.key === " ") && D.stopPropagation();
                  },
                  children: [
                    /* @__PURE__ */ r(
                      En,
                    ...
                    /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                      E !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: Ne(
                      ...
                      /* @__PURE__ */ p(oe, { open: G, onOpenChange: ut, children: [
                        /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r(
                          z,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                            disabled: !bt || !y || y.length === 0 || !y.includes(i),
                        ...
                        /* @__PURE__ */ r(
                          Xt,
                          {
                            ...
                            align: "end",
                            onKeyDown: (D) => {
                              D.key === "Escape" && (D.stopPropagation(), ut(!1));
                            },
                            children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: y == null ? void 0 : y.map((D) => /* @__PURE__ */ r(
                              Yt,
                              {
                                onSelect: () => {
                                  O(D !== s ? D : void 0), At.current = !1, ut(!1);
                                },
                                className: "tw-flex tw-items-center",
                                children: /* @__PURE__ */ r("span", { children: Nn(D, n) })
                              },
                              D || "unassigned"
                            )) }) })
                          }
...
function Ip({
  ...
  const [R, v] = S(/* @__PURE__ */ new Set()), [_, C] = S(), [F, V] = S(void 0), $ = K(
    async (N) => {
      const G = await s(N);
  ...
  ), M = T.map((N) => ({ id: N.id })), E = K(
    (N) => {
      v((G) => new Set(G).add(N.id)), C(N.id), y == null || y(N.id);
    },
    [y]
  ), O = K(
    (N) => {
      ...
      }), C(N), y == null || y(G ? void 0 : N);
    },
    [R, y]
  ), { listboxRef: A, activeId: Y, handleKeyDown: P } = jw({
    options: M,
    onOptionSelect: E
  }), Z = K(
    (N) => {
      N.key === "Escape" ? (_ && R.has(_) && (v((G) => {
        const ut = new Set(G);
        return ut.delete(_), ut;
      }), C(void 0), y == null || y(void 0)), N.preventDefault(), N.stopPropagation()) : P(N);
    },
    [_, R, P, y]
  );
  return /* @__PURE__ */ r(
...
function Jw({ table: t }) {
  return /* @__PURE__ */ p(fe, { children: [
    /* @__PURE__ */ r(Zi, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Fe = ct.Root, Zw = ct.Group, Be = ct.Value, Qw = he(
  ...
  return /* @__PURE__ */ p(
    ct.Trigger,
    {
      className: f(Qw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(ct.Icon, { asChild: !0, children: /* @__PURE__ */ r(Ue, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Se.displayName = ct.Trigger.displayName;
const Fa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(_o, { className: "tw-h-4 tw-w-4" })
  }
));
Fa.displayName = ct.ScrollUpButton.displayName;
...
Ba.displayName = ct.ScrollDownButton.displayName;
const De = b.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = pt();
...
De.displayName = ct.Content.displayName;
...
tc.displayName = ct.Label.displayName;
const It = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ct.Item,
  {
    ref: o,
    className: f(
...
ec.displayName = ct.Separator.displayName;
function nc({ table: t }) {
    ...
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ p(
        Fe,
        {
          ...
          children: [
            /* @__PURE__ */ r(Se, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Be, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(De, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(It, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  const l = b.useMemo(
    ...
    (d) => {
      ...
      if (d.key === "ArrowDown" || d.key === "ArrowUp")
        d.preventDefault(), ic(u, g, d.key);
      else if (d.key === "ArrowLeft" || d.key === "ArrowRight")
        d.preventDefault(), sc(l, y, d.key);
...
function wc({
  ...
  var V;
  const [d, m] = S([]), [h, u] = S([]), [g, y] = S({}), [x, R] = S({}), v = B(() => e ?? [], [e]), _ = Ho({
    data: v,
    columns: t,
    getCoreRowModel: Xo(),
    ...n && { getPaginationRowModel: tl() },
    onSortingChange: m,
    getSortedRowModel: Yo(),
  ...
  let F;
  return w ? F = Array.from({ length: 10 }).map((M, E) => `skeleton-row-${E}`).map((M) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ce, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(hr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, M)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? F = _.getRowModel().rows.map(($) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i($, _),
      "data-state": $.getIsSelected() && "selected",
      children: $.getVisibleCells().map((T) => /* @__PURE__ */ r(Ce, { children: nn(T.column.columnDef.cell, T.getContext()) }, T.id))
    },
    $.id
  )) : F = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ce, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Jw, { table: _ }),
...
function Op({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(rl, { options: s, children: e })
    }
  );
}
...
function dc({
  ...
  const a = fo(n, "%webView_error_dump_header%"), s = fo(n, "%webView_error_dump_info_message%");
  function i() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Co, {}) })
        ] }),
...
function $p({ id: t, label: e, groups: n }) {
  const [o, a] = S(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(fe, { children: [
    /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ p(z, { variant: "default", children: [
      /* @__PURE__ */ r(Ps, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(La, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
...
function uc({ id: t, versionHistory: e }) {
...
function Vp({
  ...
  const i = B(() => li(n), [n]), w = ((c) => {
    const d = new Intl.DisplayNames(wi(), { type: "language" });
...
function mc({
  ...
  const [R, v] = S(!1), _ = K(
    (E) => {
      var A;
      const O = (A = t.find((Y) => Y.label === E)) == null ? void 0 : A.value;
      O && n(
        e.includes(O) ? e.filter((Y) => Y !== O) : [...e, O]
      );
    },
    [t, e, n]
  ), C = () => w || o, F = B(() => {
    if (!h) return t;
    const E = t.filter((A) => A.starred).sort((A, Y) => A.label.localeCompare(Y.label)), O = t.filter((A) => !A.starred).sort((A, Y) => {
      const P = e.includes(A.value), Z = e.includes(Y.value);
      return P && !Z ? -1 : !P && Z ? 1 : A.label.localeCompare(Y.label);
    });
    return [...E, ...O];
  }, [t, e, h]), V = () => {
    n(t.map((E) => E.value));
  ...
  return /* @__PURE__ */ r("div", { id: x, className: g, children: /* @__PURE__ */ p(oe, { open: T, onOpenChange: d ?? v, children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ p(
      z,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Eo, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Xt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        ...
        /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: $, children: i })
      ] }),
...
function hc({
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    e && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      ...
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ p("p", { children: [
        ho(a, "%redoButton_tooltip%"),
        s && ` (${w ? "⌘⇧Z" : "Ctrl+Y"})`
      ] }) })
    ] }) })
  ] });
}
function gc({ children: t, editorRef: e }) {
  const n = U(null);
  return H(() => {
    var i;
...
const bc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function vc({
  ...
  const s = U(null), i = U(null), l = U(!1), [w, c] = S(t), [d, m] = S(n), [h, u] = S(!1);
  H(() => {
    c(t);
  }, [t]), H(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(fe, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: bc(t, a, n) }) }) }),
...
const xc = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Ro, {}),
  " ",
  ...
  return t === "f" && (n = e["%footnoteEditor_noteType_footnote_label%"]), Ne(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function Nc({
  ...
  return /* @__PURE__ */ p(fe, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Gi, { asChild: !0, children: /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(z, { variant: "outline", className: "tw-h-6", children: xc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: yc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ee, { style: { zIndex: Wo }, children: [
...
function _c({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? Bs, { className: e, size: 16 });
}
function go({
  item: t,
  localizedStrings: e
  ...
  return /* @__PURE__ */ p(
    Yt,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(_c, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ r(ea, { className: "tw-font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
...
function zp({
  ...
  const [g, y] = S("generated"), [x, R] = S("*"), [v, _] = S("f"), [C, F] = S(!1), [V, $] = S(!0), [T, M] = S(!1), E = U(!1), O = U(""), [A, Y] = S(!1), [P, Z] = S(), [N, G] = S(), [ut, bt] = S(), [Mt, ft] = S(), St = U(null), j = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
      view: { ...i.view ?? ol(), noteMode: "expanded" }
    }),
    [i, l]
  ), st = B(
    () => Ec(
  ...
  H(() => {
    ...
    if (L && hn("note", L)) {
      const et = (q = L.insert.note) == null ? void 0 : q.caller;
      let J = "custom";
      et === ar ? J = "generated" : et === sr ? J = "hidden" : et && R(et), y(J), _(((X = L.insert.note) == null ? void 0 : X.style) ?? "f"), k = setTimeout(() => {
        var ht;
        (ht = d.current) == null || ht.applyUpdate([L]);
      }, 0);
    }
    return () => {
      k && clearTimeout(k);
  ...
  const it = K(
    (k, L, q = !1) => {
      var et, J, ht;
      const X = (J = (et = d.current) == null ? void 0 : et.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (X && hn("note", X)) {
        if (X.insert.note) {
          let wt;
          k === "custom" ? wt = L : k === "generated" ? wt = ar : wt = sr, X.insert.note.caller = wt;
        }
        n == null || n([X]), q && c && s && ((ht = c.current) == null || ht.replaceEmbedUpdate(s, [X]));
      }
    },
    [s, n, c]
  ), mt = K(() => {
  ...
  const se = U({ book: a.book, chapterNum: a.chapterNum });
  Ot(() => {
    (se.current.book !== a.book || se.current.chapterNum !== a.chapterNum) && (se.current = { book: a.book, chapterNum: a.chapterNum }, vt.current());
  }, [a.book, a.chapterNum]);
  const be = () => {
    var L;
    const k = (L = m.current) == null ? void 0 : L.getElementsByClassName("editor-input")[0];
    ...
    var q, X, et, J, ht;
    _(k);
    const L = (X = (q = d.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : X.at(0);
    if (L && hn("note", L)) {
      L.insert.note && (L.insert.note.style = k);
      const wt = (J = (et = L.insert.note) == null ? void 0 : et.contents) == null ? void 0 : J.ops;
      v !== "x" && k === "x" ? wt == null || wt.forEach((xt) => Tc(xt)) : v === "x" && k !== "x" && (wt == null || wt.forEach((xt) => Rc(xt))), (ht = d.current) == null || ht.applyUpdate([L, { delete: 1 }]);
    }
  }, Jt = (k) => {
    ft(k.contextMarker), M(k.canRedo);
  }, Je = K(
    (k) => {
      var q, X, et, J, ht;
      const L = (X = (q = d.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : X.at(0);
      if (L && hn("note", L)) {
        ...
        const wt = (et = L.insert.note) == null ? void 0 : et.style, xt = (ht = (J = L.insert.note) == null ? void 0 : J.contents) == null ? void 0 : ht.ops;
        if (wt || F(!1), F(
          wt === "x" ? !!(xt != null && xt.every((Ft) => {
            var ie, le;
            if (!((ie = Ft.attributes) != null && ie.char)) return !0;
            const Zt = ((le = Ft.attributes) == null ? void 0 : le.char).style;
          ...
          E.current = !0, O.current = JSON.stringify(L), $(!0);
          return;
        }
        $(JSON.stringify(L) === O.current), it(g, x);
      } else
        F(!1), $(!0);
    },
    [g, x, it]
    ...
    if (h.current && st.length && k && k.rangeCount > 0) {
      const L = k.getRangeAt(0).getBoundingClientRect(), q = h.current.getBoundingClientRect();
      Z(L.left - q.left), G(L.top - q.top), bt(L.height), Y(!0);
    }
  }, [st, h]);
  return H(() => {
    const k = () => {
    ...
    var k;
    A && ((k = St.current) == null || k.focus());
  }, [A]), H(() => {
    var q;
    const k = ((q = m.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0, L = (X) => {
      !A && k && document.activeElement === k && X.key === l ? (X.preventDefault(), I()) : A && X.key === "Escape" && (X.preventDefault(), Y(!1));
    };
    return document.addEventListener("keydown", L), () => {
      document.removeEventListener("keydown", L);
    };
  }, [A, I, l]), /* @__PURE__ */ p(lt, { children: [
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
            /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(z, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(Ke, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(gc, { editorRef: d, children: /* @__PURE__ */ r(
              al,
              {
                options: j,
                onStateChange: Jt,
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Dc(t.marker, l, o, c) })
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ p($n, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Vn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ce, { children: ke(l.reference, "English") }),
          /* @__PURE__ */ r(Ce, { className: o, children: Oc(l.text) })
        ]
      },
...
const Pc = (t) => {
  ...
  return e ? e[1] : "";
}, Lc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Xp = Object.freeze([
  ...
  const a = Hr(o.key) ? o.key : o.key[0];
  return {
    items: Hr(o.key) ? [o.key] : o.key,
    count: o.count,
...
function Wp({
  ...
  const u = Ut(n, "%webView_inventory_all%"), g = Ut(n, "%webView_inventory_approved%"), y = Ut(n, "%webView_inventory_unapproved%"), x = Ut(n, "%webView_inventory_unknown%"), R = Ut(n, "%webView_inventory_scope_currentBook%"), v = Ut(n, "%webView_inventory_scope_chapter%"), _ = Ut(n, "%webView_inventory_scope_verse%"), C = Ut(n, "%webView_inventory_filter_text%"), F = Ut(
    n,
    "%webView_inventory_show_additional_items%"
  ), V = Ut(n, "%webView_inventory_no_results%"), [$, T] = S(!1), [M, E] = S("all"), [O, A] = S(""), [Y, P] = S([]), Z = B(() => {
    const j = t ?? [];
    return j.length === 0 ? [] : jc(j, a, s);
  }, [t, a, s]), N = B(() => {
    if ($) return Z;
    const j = [];
    return Z.forEach((st) => {
      const it = st.items[0], mt = j.find(
        (vt) => vt.items[0] === it
      );
  ...
  }, [$, Z]), G = B(() => N.length === 0 ? [] : Vc(N, M, O), [N, M, O]), ut = B(() => {
    var it, mt;
    if (!$) return w;
    const j = (it = o == null ? void 0 : o.tableHeaders) == null ? void 0 : it.length;
    if (!j) return w;
    const st = [];
  ...
  H(() => {
    G.length === 0 ? P([]) : G.length === 1 && P(G[0].items);
  }, [G]);
  const bt = (j, st) => {
    st.setRowSelection(() => {
      const mt = {};
  ...
  return /* @__PURE__ */ r("div", { id: c, className: "pr-twp tw-h-full tw-overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-h-full tw-w-full tw-min-w-min tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      /* @__PURE__ */ p(
        Fe,
        {
          ...
          defaultValue: M,
          children: [
            /* @__PURE__ */ r(Se, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Be, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ p(De, { children: [
              /* @__PURE__ */ r(It, { value: "all", children: u }),
              /* @__PURE__ */ r(It, { value: "approved", children: g }),
              /* @__PURE__ */ r(It, { value: "unapproved", children: y }),
              /* @__PURE__ */ r(It, { value: "unknown", children: x })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Fe, { onValueChange: (j) => Mt(j), defaultValue: i, children: [
        /* @__PURE__ */ r(Se, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Be, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(De, { children: [
          /* @__PURE__ */ r(It, { value: "book", children: R }),
          /* @__PURE__ */ r(It, { value: "chapter", children: v }),
          /* @__PURE__ */ r(It, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ r(
        We,
    ...
    St.length > 0 && /* @__PURE__ */ r("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ r(
      Ac,
      {
        classNameForText: m,
        occurrenceData: St,
...
const zc = "16rem", Fc = "3rem", Ua = b.createContext(void 0);
function zn() {
  const t = b.useContext(Ua);
  if (!t)
...
const Ga = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), m = e ?? c, h = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => h((_) => !_), [h]), g = m ? "expanded" : "collapsed", R = pt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", v = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ua.Provider, { value: v, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Ga.displayName = "SidebarProvider";
const qa = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, s) => {
  const i = zn();
...
qa.displayName = "Sidebar";
const Bc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = zn();
  return /* @__PURE__ */ p(
    z,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Ys, {}) : /* @__PURE__ */ r(Xs, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Bc.displayName = "SidebarTrigger";
...
Ja.displayName = "SidebarMenuButton";
const Wc = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ge : "button",
  {
    ref: a,
...
Wc.displayName = "SidebarMenuAction";
...
const Zc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const ed = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ge : "a",
  {
    ref: s,
...
function nd({
  ...
  return /* @__PURE__ */ r(
    qa,
    {
      ...
      children: /* @__PURE__ */ p(Ya, { children: [
        /* @__PURE__ */ p(gr, { children: [
          /* @__PURE__ */ r(br, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(vr, { children: /* @__PURE__ */ r(Xa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Wa, { children: /* @__PURE__ */ r(
            Ja,
            {
              onClick: () => c(h),
              isActive: m(h),
...
const we = "scrBook", rd = "scrRef", ye = "source", od = "details", ad = "Scripture Reference", sd = "Scripture Book", Za = "Type", id = "Details";
function ld(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === we ? ke(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: ye,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Za : void 0,
...
}, bo = (t) => `${wd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Zp({
  sources: t,
  ...
  const [c, d] = S([]), [m, h] = S([{ id: we, desc: !1 }]), [u, g] = S({}), y = B(
  ...
  H(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const O = y.find((A) => bo(A) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [u, y, l, R]);
  const v = a ?? sd, _ = s ?? Za, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${v}`, value: [we] },
  ...
  }, $ = (M, E) => M.getIsGrouped() ? "" : f("banded-row", E % 2 === 0 ? "even" : "odd"), T = (M, E, O) => {
    if (!((M == null ? void 0 : M.length) === 0 || E.depth < O.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ p(
      Fe,
      {
        ...
        children: [
          /* @__PURE__ */ r(Se, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Be, {}) }),
          /* @__PURE__ */ r(De, { position: "item-aligned", children: /* @__PURE__ */ r(Zw, { children: C.map((M) => /* @__PURE__ */ r(It, { value: JSON.stringify(M.value), children: M.label }, M.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p($n, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ln, { children: R.getHeaderGroups().map((M) => /* @__PURE__ */ r(Qt, { children: M.headers.filter((E) => E.column.columnDef.header).map((E) => (
      ...
      /* @__PURE__ */ r(Vn, { children: R.getRowModel().rows.map((M, E) => {
        const O = pt();
        return /* @__PURE__ */ r(
          Qt,
          {
            ...
            className: f($(M, E)),
            onClick: (A) => V(M, A),
            children: M.getVisibleCells().map((A) => {
              if (!(A.getIsPlaceholder() || A.column.columnDef.enableGrouping && !A.getIsGrouped() && (A.column.columnDef.id !== ye || !n)))
                return /* @__PURE__ */ r(
                  Ce,
                  {
                    className: f(
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ p(
                      z,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          M.getIsExpanded() && /* @__PURE__ */ r(Ue, {}),
                          !M.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ r($e, {}) : /* @__PURE__ */ r(er, {})),
                          " ",
                          nn(A.column.columnDef.cell, A.getContext()),
                          " (",
                          M.subRows.length,
                          ")"
                        ]
...
}), Qa = (t, e, n) => Fr(t, e).every((o) => n.includes(o));
function cd({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    z,
    {
      ...
      onClick: () => o(t),
      className: f(
        Qa(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: gl(
        t,
...
function dd({
  ...
  const V = B(() => dt.allBookIds.filter(
    ...
    (P, Z = !1) => {
      if (!Z || !C.current) {
        n(
          e.includes(P) ? e.filter((ft) => ft !== P) : [...e, P]
        ), C.current = P;
        return;
      }
      const N = V.findIndex((ft) => ft === C.current), G = V.findIndex((ft) => ft === P);
      if (N === -1 || G === -1) return;
      const [ut, bt] = [
        Math.min(N, G),
        Math.max(N, G)
      ], Mt = V.slice(ut, bt + 1).map((ft) => ft);
      n(
        e.includes(P) ? e.filter((ft) => !Mt.includes(ft)) : [.../* @__PURE__ */ new Set([...e, ...Mt])]
      );
    },
    [e, n, V]
  ), M = (P) => {
    T(P, F.current), F.current = !1;
  }, E = (P, Z) => {
    P.preventDefault(), T(Z, P.shiftKey);
  }, O = K(
    (P) => {
      const Z = Fr(V, P).map((N) => N);
      n(
        Qa(V, P, e) ? e.filter((N) => !Z.includes(N)) : [.../* @__PURE__ */ new Set([...e, ...Z])]
      );
    },
    [e, n, V]
  ), A = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
            ...
            ne,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: A, children: w }),
                  /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: Y, children: c })
                ] }),
                /* @__PURE__ */ p(re, { children: [
                  /* @__PURE__ */ r(un, { children: d }),
                  Object.values(W).map((P, Z) => {
                    const N = $[P];
                    if (N.length !== 0)
                      return /* @__PURE__ */ p(xo, { children: [
                        /* @__PURE__ */ r(
                          qt,
                          {
                            heading: na(P, h, u, g, y),
                        ...
                        Z < Object.values(W).length - 1 && /* @__PURE__ */ r(Cr, {})
                      ] }, P);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Zn ? Zn : vo
      ).map((P) => /* @__PURE__ */ r(je, { className: "hover:tw-bg-secondary", variant: "secondary", children: Pe(P, a) }, P)),
      e.length > Zn && /* @__PURE__ */ r(
        je,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - vo} ${m}`
        }
      )
    ] })
  ] });
...
function tu({
  ...
  const c = ve(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = ve(i, "%webView_scope_selector_current_book%"), u = ve(i, "%webView_scope_selector_choose_books%"), g = ve(i, "%webView_scope_selector_scope%"), y = ve(i, "%webView_scope_selector_select_books%"), x = [
...
const es = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ p(Hw, { children: [
    /* @__PURE__ */ r(Va, { children: l.label }),
    /* @__PURE__ */ r(qw, { children: /* @__PURE__ */ r(ja, { children: es(
      t,
      e,
      ts(t, l.id),
      o
...
function xr({
  ...
  return /* @__PURE__ */ p(fe, { variant: s, children: [
    /* @__PURE__ */ r(Re, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(z, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Js, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: He }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(xo, { children: [
      /* @__PURE__ */ r(La, { children: /* @__PURE__ */ r(kt, { children: es(e.groups, e.items, w, t) }) }),
...
function au({
  ...
  return /* @__PURE__ */ p(ns, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      xr,
      {
        onSelectMenuItem: t,
...
function su({
  ...
  return /* @__PURE__ */ r(ns, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    xr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
rs.displayName = Rt.List.displayName;
const os = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.List,
  {
    ref: n,
    className: f(
...
)), as = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Content,
  {
    ref: n,
    className: f(
...
function iu({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(rs, { children: [
      /* @__PURE__ */ r(os, { children: t.map((l) => /* @__PURE__ */ r(pd, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(as, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function ud({ ...t }) {
...
const ss = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
ss.displayName = ot.Root.displayName;
const is = b.forwardRef(({ className: t, ...e }, n) => {
  const o = zt();
  return /* @__PURE__ */ r(
    ot.Trigger,
    {
...
is.displayName = ot.Trigger.displayName;
const ls = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    ot.SubTrigger,
    {
...
ls.displayName = ot.SubTrigger.displayName;
...
ws.displayName = ot.SubContent.displayName;
const cs = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = zt();
...
cs.displayName = ot.Content.displayName;
const ds = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ r(
    ot.Item,
    {
...
ds.displayName = ot.Item.displayName;
const fd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = zt();
  return /* @__PURE__ */ p(
    ot.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Vt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
fd.displayName = ot.CheckboxItem.displayName;
const hd = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = zt();
  return /* @__PURE__ */ p(
    ot.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ot.ItemIndicator, { children: /* @__PURE__ */ r(Mn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
hd.displayName = ot.RadioItem.displayName;
...
gd.displayName = ot.Label.displayName;
...
ps.displayName = ot.Separator.displayName;
const Qe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        ...
        /* @__PURE__ */ r(ls, { children: c.label }),
        /* @__PURE__ */ r(ws, { children: us(
          t,
          e,
          ts(t, c.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ r(ps, {}, `separator-${s}`)), w;
  });
};
function bd({
  menuData: t,
  ...
  if (sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    var g, y, x, R;
    d.preventDefault();
    ...
    return /* @__PURE__ */ r(ss, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, m]) => typeof d == "boolean" || typeof m == "boolean" ? 0 : d.order - m.order).map(([d, m]) => /* @__PURE__ */ p(ud, { children: [
      /* @__PURE__ */ r(is, { ref: c(d), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        cs,
        {
          style: { zIndex: He },
          children: /* @__PURE__ */ r(kt, { children: us(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
  ...
  return /* @__PURE__ */ p("div", { id: w, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ p(
      Fe,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(Se, { children: /* @__PURE__ */ r(Be, {}) }),
          /* @__PURE__ */ r(
            De,
            {
              style: { zIndex: He },
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(gt, { className: "tw-font-normal tw-text-muted-foreground", children: Ne(c, {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(fe, { children: [
              /* @__PURE__ */ r(Re, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(qr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] }) }),
            e && c && /* @__PURE__ */ p(fe, { children: [
              /* @__PURE__ */ r(Re, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(z, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(qr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] })
          ] }),
...
const yd = dn(({ className: t, ...e }, n) => /* @__PURE__ */ r(ti, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), kd = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Cd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Cd.displayName = "AlertDescription";
const mu = at.Root, fu = at.Trigger, hu = at.Group, gu = at.Portal, bu = at.Sub, vu = at.RadioGroup, Ed = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  at.SubTrigger,
  {
    ref: a,
    className: f(
...
Ed.displayName = at.SubTrigger.displayName;
...
Td.displayName = at.SubContent.displayName;
const Rd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(at.Portal, { children: /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: f(
...
Rd.displayName = at.Content.displayName;
...
const Dd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  at.CheckboxItem,
  {
    ref: a,
    className: f(
...
Dd.displayName = at.CheckboxItem.displayName;
const Md = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  at.RadioItem,
  {
    ref: o,
    className: f(
...
Md.displayName = at.RadioItem.displayName;
const Id = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  at.Label,
  {
    ref: o,
    className: f(
...
Id.displayName = at.Label.displayName;
...
Od.displayName = at.Separator.displayName;
...
function Pd({
  ...
  return /* @__PURE__ */ r(ms.Provider, { value: o, children: /* @__PURE__ */ r(
    jt.Root,
    {
...
const xu = jt.Trigger, $d = jt.Portal, yu = jt.Close, fs = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  jt.Overlay,
  {
    ref: n,
...
fs.displayName = jt.Overlay.displayName;
const Ld = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(ms), i = {
...
zd.displayName = jt.Title.displayName;
...
Fd.displayName = jt.Description.displayName;
const Bd = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  lr.Root,
  {
    ref: o,
    className: f(
...
Bd.displayName = lr.Root.displayName;
function Nu({
  className: t,
  ...e
}) {
...
function _u({
  ...
  return /* @__PURE__ */ r(
    _r.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(ei, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Cu({ ...t }) {
...
Kd.displayName = tn.Root.displayName;
...
Ud.displayName = wr.Root.displayName;
const Eu = Rt.Root, Gd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = pt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
Gd.displayName = Rt.List.displayName;
...
qd.displayName = Rt.Trigger.displayName;
...
Hd.displayName = Rt.Content.displayName;
...
export {
  ...
  Rd as ContextMenuContent,
  hu as ContextMenuGroup,
  Sd as ContextMenuItem,
  Id as ContextMenuLabel,
  gu as ContextMenuPortal,
  vu as ContextMenuRadioGroup,
  ...
  _u as ResizableHandle,
  ku as ResizablePanel,
  Nu as ResizablePanelGroup,
  pu as ResultsCard,
