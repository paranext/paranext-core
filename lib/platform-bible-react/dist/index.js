...
import { r as Gt, Z as Fi, B as q, c as g, a as Bi, C as De, P as Se, b as Be, d as Oe, e as Ue, f as qe, g as he, h as Er, i as ra, T as Ft, S as or, j as Bt, k as Ut, l as qt, D as Je, m as kr, n as Ce, o as Ee, p as Te, u as Ui, q as Tr, s as Ze, t as Le, v as Ra, w as un, x as qi, y as Ki, z as pn, A as hn, E as Gi, F as Hi, G as Yi, H as Wi, I as ua, J as pa, K as wr, L as Xi, M as Ji, N as Zi, O as Qi, Q as ts, R as zr, U as Wa } from "./resizable-CUvCloPJ.js";
...
import wt, { useRef as H, useMemo as j, useState as N, useCallback as F, useEffect as W, useLayoutEffect as Zt, createContext as Xa, useContext as kn, Component as Us, createElement as To, Suspense as qs, forwardRef as oa, useId as zo, Fragment as _n } from "react";
...
function dl({
  ...
  return /* @__PURE__ */ u(Se, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(Oe, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(qe, { children: /* @__PURE__ */ a(he, { heading: i, children: t.map((h) => /* @__PURE__ */ u(
      De,
      {
        onSelect: () => f(h),
...
function ma({
  ...
  const E = Gt(), [k, _] = N(!1), [M, B] = N(""), [I, A] = N(""), [x, T] = N("books"), [P, C] = N(void 0), [S, V] = N(
    void 0
  ), [U, X] = N(void 0), [it, K] = N(!1), Q = H(null), Et = H(!1), ht = H(void 0), zt = H(void 0), G = H(void 0), ot = H(void 0), bt = H({}), ct = H({}), tt = F(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  const $t = F(() => {
    ...
    const { isLetter: L, isDigit: J } = Io(b.key);
    (L || J) && (b.preventDefault(), A((Qt) => Qt + b.key), zt.current.focus(), K(!1));
  }, []);
  return Zt(() => {
    const b = setTimeout(() => {
        ...
        children: /* @__PURE__ */ u(
          Ue,
          {
            ...
            children: [
              ...
              !it && /* @__PURE__ */ u(qe, { ref: G, children: [
    ...
    /* @__PURE__ */ a(
      Oe,
      {
        ...
        children: /* @__PURE__ */ u(Ue, { children: [
          ...
          /* @__PURE__ */ a(qe, { children: B(e) ? e.map((A) => /* @__PURE__ */ a(he, { heading: A.groupHeading, children: A.options.map((x) => I(x, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(he, { children: e.map((A) => I(A)) }) })
        ] })
      }
    )
  ] });
...
let Xr, Ne = 0, Jr = 0, Ul = 0, Ka = 0, Ur = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
Pt.prototype.brand = Fl, Pt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && Jr === 0 && e.l !== Ka && (e.l = Ka, Xr = { S: e, v: e.v, i: e.i, o: Xr });
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Jn(this), qo(this), Ne++;
  const t = nt;
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ u(Ce, { children: [
          /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(gs, {}) }) }),
        ...
        /* @__PURE__ */ a(
          ao,
          {
            ...
            children: x.map((V) => h && V.value === "reject" ? /* @__PURE__ */ a(Ft, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
              ...
              /* @__PURE__ */ a(qt, { side: "right", children: I })
            ] }) }, V.value) : S(V))
          }
        ),
...
function Bd({
  ...
  const [T, P] = N(tn), [C, S] = N(), [V, U] = N(), X = o, [it, K] = N(!1), [Q, Et] = N(!1), [ht, zt] = N(!1), [G, ot] = N(!1), [bt, ct] = N(!1), [tt, Vt] = N(_), [kt, Ht] = N(!1), Lt = H(void 0), [O, ae] = N(/* @__PURE__ */ new Map()), $t = l.type === "Conflict", [oe, ne] = N("none"), [ie, Re] = N("accept"), [$e, Yt] = N(!1);
  W(() => {
    let z = !0;
    return (async () => {
            ...
            o && /* @__PURE__ */ u(rt, { children: [
              ...
              Wt > 0 && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onClick: (z) => {
                    z.stopPropagation(), K(!0);
                  },
                  role: "button",
                  tabIndex: 0,
                  onKeyDown: (z) => {
                    (z.key === "Enter" || z.key === " ") && (z.preventDefault(), z.stopPropagation(), K(!0));
                  },
                  children: [
                    /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(or, {}) }),
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
...
function sp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [M, B] = N(), [I, A] = N(), x = F(
    async (K) => {
      const Q = await i(K);
      return Q !== void 0 && K.assignedUser !== void 0 && K.assignedUser !== "" && A(K.assignedUser), Q;
    },
    [i]
  );
  W(() => {
    m && (_((K) => new Set(K).add(m)), B(m));
  }, [m]);
  const T = r.filter(
    (K) => K.comments.some((Q) => !Q.deleted)
  ), P = T.map((K) => ({ id: K.id })), C = F(
    (K) => {
      _((Q) => new Set(Q).add(K.id)), B(K.id), y == null || y(K.id);
    },
    [y]
  ), S = F(
    (K) => {
      ...
      _((Et) => {
        const ht = new Set(Et);
        return ht.has(K) ? ht.delete(K) : ht.add(K), ht;
      }), B(K), y == null || y(Q ? void 0 : K);
    },
    [k, y]
    ...
    (K) => {
      K.key === "Escape" ? (M && k.has(M) && (_((Q) => {
        const Et = new Set(Q);
        return Et.delete(M), Et;
      }), B(void 0), y == null || y(void 0)), K.preventDefault(), K.stopPropagation()) : X(K);
    },
    [M, k, X, y]
  );
  return /* @__PURE__ */ a(
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(Se, { open: A, onOpenChange: w ?? E, children: [
    ...
    /* @__PURE__ */ a(Oe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ue, { children: [
      ...
      n && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: I, children: s })
      ] }),
...
function sw({
  ...
  return /* @__PURE__ */ u(Ce, { open: f, onOpenChange: m, children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
function dw({
  ...
  return /* @__PURE__ */ u(Ce, { children: [
    /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ut, { asChild: !0, children: /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
...
function xp({
  ...
  const [m, y] = N("generated"), [v, D] = N("generated"), [E, k] = N("*"), [_, M] = N("*"), [B, I] = N("f"), [A, x] = N(!1), [T, P] = N(!0), [C, S] = N(!1), V = H(!1), U = H(""), [X, it] = N(!1), [K, Q] = N(), [Et, ht] = N(), [zt, G] = N(), [ot, bt] = N(), ct = H(null), tt = j(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
function Sp({
  ...
  }, [I, U]), it = j(() => X.length === 0 ? [] : Ew(X, x, P), [X, x, P]), K = j(() => {
    var bt, ct;
    if (!I) return d;
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: f, dcLong: h, extraLong: m } = {
    ...
    (C, S = !1) => {
      ...
      const [X, it] = [
        Math.min(V, U),
        Math.max(V, U)
      ], K = M.slice(X, it + 1).map((Q) => Q);
      r(
        e.includes(C) ? e.filter((Q) => !K.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...K])]
      );
    },
    [e, r, M]
  ), A = (C) => {
...
function Wp({
  ...
  const _ = Ot(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), T = Ot(s, "%webView_scope_selector_current_book%"), P = Ot(s, "%webView_scope_selector_choose_books%"), C = Ot(s, "%webView_scope_selector_scope%"), S = Ot(s, "%webView_scope_selector_select_books%"), V = Ot(s, "%webView_scope_selector_range%"), U = Ot(s, "%webView_scope_selector_select_range%"), X = Ot(s, "%webView_scope_selector_range_start%"), it = Ot(s, "%webView_scope_selector_range_end%"), K = Ot(s, "%webView_scope_selector_ok%"), Q = Ot(s, "%webView_scope_selector_cancel%"), Et = Ot(s, "%webView_scope_selector_navigate%"), ht = ($) => {
    if (!m) return;
      ...
      Ua,
      {
        ...
        children: /* @__PURE__ */ u(ua, { container: Rr, children: [
          ...
          /* @__PURE__ */ u(Ao, { children: [
            ...
            /* @__PURE__ */ a(q, { onClick: vo, children: K })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && ft && /* @__PURE__ */ a(Ba, { open: yt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ua,
      {
        ...
        children: /* @__PURE__ */ u(ua, { container: Jt, children: [
          ...
          /* @__PURE__ */ u(Ao, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: Q }),
            /* @__PURE__ */ a(q, { ref: Re, onClick: vo, children: K })
          ] })
        ] })
      }
    ) })
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ce, { variant: i, children: [
    /* @__PURE__ */ a(Ee, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(js, {}) }) }),
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && f && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Ce, { children: [
              /* @__PURE__ */ a(Ee, { className: g(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Eo, {}) }) }),
