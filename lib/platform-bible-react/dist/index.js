...
import p, { forwardRef as Le, useRef as nt, useCallback as X, useMemo as q, useState as I, useLayoutEffect as fn, createContext as Br, useContext as jr, useEffect as Mt, Fragment as Vn } from "react";
...
const it = class V {
  ...
  parse(e) {
    ...
    if (a.length !== 2 || z.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !V.isVerseParseable(a[1]))
      throw new Ut("Invalid reference : " + e);
  ...
  updateInternal(e, n, a) {
    this.bookNum = z.bookIdToNumber(e), this.chapter = n, this.verse = a;
  }
};
...
const Kn = Le(
  ({
    ...
    }, f = w && ((v = w.get(t)) == null ? void 0 : v.localizedName) || z.bookIdToEnglishName(t), b = w && ((x = w.get(t)) == null ? void 0 : x.localizedId) || t.toLocaleUpperCase();
    return /* @__PURE__ */ r(
      "div",
      {
        className: d(
          ...
          {
            "tw-border-s-red-200": o === P.OT,
            "tw-border-s-purple-200": o === P.NT,
            "tw-border-s-indigo-200": o === P.DC,
            "tw-border-s-amber-200": o === P.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          Ft,
...
function ci({
  ...
  var pn, un, mn;
  const i = et(), [w, u] = I(!1), [c, m] = I(""), [g, h] = I(""), [f, b] = I("books"), [v, x] = I(void 0), [C, N] = I(!1), M = nt(void 0), $ = nt(void 0), Z = nt(void 0), H = nt(void 0), gt = nt({}), k = q(() => a ? a() : qn, [a]), T = q(() => ({
    [P.OT]: k.filter((O) => z.isBookOT(O)),
    [P.NT]: k.filter((O) => z.isBookNT(O)),
    [P.DC]: k.filter((O) => z.isBookDC(O)),
    [P.Extra]: k.filter((O) => z.extraBooks().includes(O))
  }), [k]), rt = q(() => Object.values(T).flat(), [T]), B = q(() => {
    if (!g.trim()) return T;
    const y = {
      [P.OT]: [],
      [P.NT]: [],
    ...
    return [P.OT, P.NT, P.DC, P.Extra].forEach((W) => {
      y[W] = T[W].filter((at) => Ue(at, g, o));
    }), y;
  }, [T, g, o]), _ = q(
    () => Ua(g, rt, o),
    [g, rt, o]
    ...
    [f, j]
  ), { otLong: Q, ntLong: ot, dcLong: J, extraLong: bt } = Dn(s), Dr = X(
    (y) => zn(y, Q, ot, J, bt),
    [Q, ot, J, bt]
  ), zr = X(
    ...
    (y) => {
      if (y.ctrlKey) return;
      const { isLetter: O, isDigit: W } = yn(y.key);
      if (f === "chapters") {
        if (y.key === "Backspace") {
        ...
        if (O || W) {
          if (y.preventDefault(), y.stopPropagation(), b("books"), x(void 0), W && v) {
            const at = yt[v];
            h(`${at} ${y.key}`);
          } else
            h(y.key);
      ...
      if ((f === "chapters" || f === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key)) {
        ...
        vt !== st && (y.preventDefault(), y.stopPropagation(), m(Nn(at, vt)), setTimeout(() => {
    ...
    const { isLetter: O, isDigit: W } = yn(y.key);
    (O || W) && (y.preventDefault(), h((at) => at + y.key), $.current.focus(), N(!1));
  }, []);
  return fn(() => {
    const y = setTimeout(() => {
      if (w && f === "books" && Z.current && H.current) {
        const O = Z.current, W = H.current, at = W.offsetTop, st = O.clientHeight, Rt = W.clientHeight, vt = at - st / 2 + Rt / 2;
        O.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), m(Nn(t.book));
      ...
      setTimeout(() => {
        if (Z.current)
          if (y) {
            ...
            Z.current.scrollTo({ top: 0 });
        M.current && M.current.focus();
      }, 0);
    }
  }, [f, v, _, t.book, t.chapterNum]), /* @__PURE__ */ l(we, { open: w, onOpenChange: R, children: [
      ...
      oe,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Y.map(({ onClick: y, disabled: O, title: W, icon: at }) => /* @__PURE__ */ r(
              D,
              {
                variant: "ghost",
                size: "sm",
          ...
          !C && /* @__PURE__ */ l(ie, { ref: Z, children: [
            f === "books" && /* @__PURE__ */ l(Qt, { children: [
              !_ && Object.entries(B).map(([y, O]) => {
                if (O.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(At, { heading: Dr(y), children: O.map((W) => /* @__PURE__ */ r(
                      Kn,
                      {
                        bookId: W,
                        onSelect: (at) => S(at),
...
), tt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(In.Root, { ref: n, className: d("pr-twp", qa(), t), ...e }));
tt.displayName = In.Root.displayName;
    ...
    Ze,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(tt, { className: "tw-flex tw-items-center", children: a.map((x) => z.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
const Pt = U.Root, ao = U.Group, Bt = U.Value, oo = St(
  ...
  return /* @__PURE__ */ l(
    U.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(U.Icon, { asChild: !0, children: /* @__PURE__ */ r(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
nr.displayName = U.ScrollUpButton.displayName;
...
rr.displayName = U.ScrollDownButton.displayName;
...
It.displayName = U.Content.displayName;
...
so.displayName = U.Label.displayName;
const ct = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  U.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(U.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(U.ItemText, { children: e })
    ]
  }
));
ct.displayName = U.Item.displayName;
...
io.displayName = U.Separator.displayName;
function wo({ table: t }) {
...
function fo({
  ...
  var x;
  const [w, u] = I([]), [c, m] = I([]), [g, h] = I({}), [f, b] = I({}), v = On({
    data: e,
    columns: t,
    getCoreRowModel: Pn(),
...
function yo({
  ...
  const [g, h] = I(!1), f = X(
    ...
    const x = t.filter((N) => N.starred).sort((N, M) => N.label.localeCompare(M.label)), C = t.filter((N) => !N.starred).sort((N, M) => {
      const $ = n.includes(N.value), Z = n.includes(M.value);
      return $ && !Z ? -1 : !$ && Z ? 1 : N.label.localeCompare(M.label);
    });
    return [...x, ...C];
  }, [t, n, u]);
  ...
  return /* @__PURE__ */ l(ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(ke, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(jt, { children: `${z.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
function Ei({
  ...
  const c = xt(n, "%webView_inventory_all%"), m = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, M] = I(!1), [$, Z] = I("all"), [H, gt] = I(""), [k, T] = I([]), rt = q(() => t.length === 0 ? [] : Ro(t, o, s), [t, o, s]), B = q(() => {
    if (N) return rt;
    const R = [];
    return rt.forEach((Q) => {
      const ot = Q.items[0], J = R.find(
        (bt) => bt.items[0] === ot
      );
      J ? (J.count += Q.count, J.occurrences = J.occurrences.concat(Q.occurrences)) : R.push({
        items: [ot],
        count: Q.count,
  ...
  }, [N, rt]), _ = q(() => So(B, $, H), [B, $, H]), Ht = q(() => {
    var ot, J;
    if (!N) return u;
    const R = (ot = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ot.length;
    if (!R) return u;
    const Q = [];
    for (let bt = 0; bt < R; bt++)
      Q.push(
        Co(
          ((J = a == null ? void 0 : a.tableHeaders) == null ? void 0 : J[bt]) || "Additional Item",
          bt + 1
        )
      );
    return [...Q, ...u];
  ...
  const S = (R, Q) => {
    ...
    if (B.length === 0 || k.length === 0) return [];
    const R = B.filter((Q) => Ke(
      N ? Q.items : [Q.items[0]],
      k
    ));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Pt, { onValueChange: (R) => K(R), defaultValue: i, children: [
  ...
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? z.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === kt ? Jt(o.start) : void 0;
      },
...
function Mi({
  ...
  const [u, c] = I([]), [m, g] = I([{ id: kt, desc: !1 }]), [h, f] = I({}), b = q(
  ...
  Mt(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const rt = b.find((B) => Rn(B) === T[0]) || void 0;
        rt && w(rt);
      }
    }
  }, [h, b, w, x]);
    ...
    !e && /* @__PURE__ */ l(
      Pt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(It, { position: "item-aligned", children: /* @__PURE__ */ r(ao, { children: M.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
        ...
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: k.getVisibleCells().map((B) => {
              if (!(B.getIsPlaceholder() || B.column.columnDef.enableGrouping && !B.getIsGrouped() && (B.column.columnDef.id !== Vt || !n)))
                return /* @__PURE__ */ r(
                  jt,
                  {
                    className: d(
                    ...
                    children: B.getIsGrouped() ? /* @__PURE__ */ l(
                      D,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          Zt(B.column.columnDef.cell, B.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
function Qo({
  ...
  const H = q(() => z.allBookIds.filter(
    ...
    (S, K = !1) => {
      ...
      const Y = H.findIndex((J) => J === $.current), j = H.findIndex((J) => J === S);
      if (Y === -1 || j === -1) return;
      const [R, Q] = [
        Math.min(Y, j),
        Math.max(Y, j)
      ], ot = H.slice(R, Q + 1).map((J) => J);
      n(
        e.includes(S) ? e.filter((J) => !ot.includes(J)) : [.../* @__PURE__ */ new Set([...e, ...ot])]
      );
    },
    [e, n, H]
  ), T = (S) => {
    k(S, Z.current), Z.current = !1;
  }, rt = (S, K) => {
    S.preventDefault(), k(K, S.shiftKey);
  }, B = X(
    (S) => {
      const K = dn(H, S).map((Y) => Y);
      n(
        fr(H, S, e) ? e.filter((Y) => !K.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...K])]
      );
    },
    [e, n, H]
  ), _ = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(P).map((S) => /* @__PURE__ */ r(
      Zo,
      {
        section: S,
        availableBookIds: H,
                  ...
                  Object.values(P).map((S, K) => {
                    ...
                    if (Y.length !== 0)
                      return /* @__PURE__ */ l(Vn, { children: [
                          ...
                          At,
                          {
                            ...
                            children: Y.map((j) => /* @__PURE__ */ r(
                              Kn,
                              {
                                ...
                                onSelect: () => T(j),
                                onMouseDown: (R) => rt(R, j),
                                section: Wt(j),
                                showCheck: !0,
                                localizedBookNames: o,
                                commandValue: `${j} ${z.bookIdToEnglishName(j)}`,
                        ...
                        K < Object.values(P).length - 1 && /* @__PURE__ */ r(Xn, {})
                      ] }, S);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var K;
        return /* @__PURE__ */ r(ue, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((K = o.get(S)) == null ? void 0 : K.localizedName) || z.bookIdToEnglishName(S) || S }, S);
      }),
...
function Fi({
  ...
  const u = is(
    ...
    return v ? `${($ = t[f]) == null ? void 0 : $.autonym} (${v})` : (Z = t[f]) == null ? void 0 : Z.autonym;
  };
...
const Wi = pt.Trigger, zs = pt.Portal, Zi = pt.Close, Mr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const Us = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = I(void 0), [w, u] = I(void 0), c = X(
    (h) => {
      i(h);
