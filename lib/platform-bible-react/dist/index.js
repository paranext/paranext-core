...
var vt = (t, e, n) => ns(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as ct } from "react/jsx-runtime";
import b, { forwardRef as nn, useRef as W, useMemo as F, useState as T, useCallback as K, useLayoutEffect as Wt, createContext as kn, useContext as dr, useEffect as U, Component as rs, createElement as Ar, Suspense as os, Fragment as lo } from "react";
...
import { includes as ln, Section as H, getChaptersForBook as js, formatScrRef as ge, getSectionForBook as Ue, formatRelativeDate as zs, formatReplacementString as he, sanitizeHtml as Fs, NumberFormat as Bs, formatBytes as Ks, getCurrentLocale as Gs, usfmMarkers as un, getFormatCallerFunction as qs, deepEqual as Us, isString as Vr, compareScrRefs as Xn, scrRefToBBBCCCVVV as An, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
const ne = Te.Root, ce = Te.Trigger, Wi = Te.Anchor, Gt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = ft();
...
function Wd({
  ...
  const w = ft(), [p, u] = T(!1), [h, f] = T(""), [g, x] = T(""), [v, y] = T("books"), [N, _] = T(void 0), [k, z] = T(!1), L = W(void 0), R = W(void 0), $ = W(void 0), C = W(void 0), S = W({}), V = K(
    (E) => {
      e(E), l && l(E);
    },
    [e, l]
  ), j = F(() => o ? o() : Ko, [o]), I = F(() => ({
    [H.OT]: j.filter((X) => wt.isBookOT(X)),
    [H.NT]: j.filter((X) => wt.isBookNT(X)),
    [H.DC]: j.filter((X) => wt.isBookDC(X)),
    [H.Extra]: j.filter((X) => wt.extraBooks().includes(X))
  }), [j]), A = F(() => Object.values(I).flat(), [I]), Y = F(() => {
    if (!g.trim()) return I;
    const E = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    [v, P]
  ), { otLong: q, ntLong: tt, dcLong: G, extraLong: ot } = {
              ...
              !M && Object.entries(Y).map(([E, X]) => {
                if (X.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Zt, { heading: ht(E), children: X.map((nt) => /* @__PURE__ */ r(
                      Go,
                      {
                        bookId: nt,
                        onSelect: (rt) => Ct(rt),
...
const Ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, sl = Ho ? Wt : U, cn = { tag: pr };
...
const ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : U;
...
const ml = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : U;
function fl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function hl() {
  return function(t) {
    const [e] = qt(), n = F(() => t(e), [e, t]), [o, a] = T(() => n.initialValueFn()), i = W(o);
    return ml(() => {
...
function me(t, e) {
  xt.call(this, void 0), this.x = t, this.s = void 0, this.g = mn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Nl(t, e) {
  return new me(t, e);
}
...
function kl(t) {
  ...
  Wo(this), Z = t, this.f &= -2, 8 & this.f && xr(this), Rn();
}
function Ce(t, e) {
...
xt.prototype.brand = xl, xt.prototype.h = function() {
  return !0;
...
const yr = 0, ar = 1, na = 2, Vn = 3, dn = 4, _e = 5, jn = 6, Ke = 7;
function zn(t) {
  return t.id === yr;
}
function ra(t) {
...
const Nr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : U;
...
const ql = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : U;
function Ul({ onClear: t }) {
  const [e] = qt();
  return ql(() => Qo(e, t), [e, t]), null;
}
const ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Wt : U;
...
function ow() {
  const { activeEditor: t } = wa(), [e, n] = T([]), o = K((a) => {
    if (Ze(a) || Ii(a)) {
      const i = [];
      eo.forEach(({ format: s }) => {
...
function tp({
  ...
  const [a, i] = T(pw), [s, l] = T(void 0), [c, w] = T(!1), p = W(void 0), u = W(null);
  U(() => {
    let y = !0;
    const N = u.current;
    if (!N) return;
...
const ep = Object.freeze([
  ...
  const a = W(null), [i, s] = T(void 0), [l, c] = T(void 0), w = K(
    (f) => {
      s(f);
...
}), ze = at.Trigger, ya = at.Group, Nw = at.Portal, kw = at.Sub, _w = at.RadioGroup;
function ke({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Er.Provider, { value: n, children: /* @__PURE__ */ r(at.Root, { ...e }) });
}
...
Na.displayName = at.SubTrigger.displayName;
...
ka.displayName = at.SubContent.displayName;
...
de.displayName = at.Content.displayName;
...
yn.displayName = at.Item.displayName;
const Xt = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  ...
  return /* @__PURE__ */ d(
    at.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(at.ItemIndicator, { children: /* @__PURE__ */ r(Lt, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Xt.displayName = at.CheckboxItem.displayName;
const _a = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    at.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(at.ItemIndicator, { children: /* @__PURE__ */ r(_n, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
_a.displayName = at.RadioItem.displayName;
...
an.displayName = at.Label.displayName;
...
Fe.displayName = at.Separator.displayName;
...
function Ew({
  ...
  const [R, $] = T(ro), [C, S] = T(
    void 0
  ), V = o, [j, I] = T(!1), [A, Y] = T(!1), [M, J] = T(!1), [Ct, Dt] = T(!1), [Mt, dt] = T(!1), [P, D] = T(k), [q, tt] = T(!1), G = W(void 0), [ot, ht] = T(/* @__PURE__ */ new Map());
  U(() => {
    let O = !0;
    return (async () => {
  ...
  const yt = F(() => pt[0], [pt]), Ot = W(null), gt = W(void 0), bt = K(() => {
    var O;
    (O = gt.current) == null || O.call(gt), $(ro);
  }, []), Ut = K(() => {
    const O = !P;
    D(O), tt(!O), g == null || g(c, O);
  }, [P, g, c]);
  U(() => {
    I(!1);
  }, [o]), U(() => {
    if (o && !P && !q) {
      ...
      return G.current = O, () => clearTimeout(O);
    }
  ...
  const Mr = K(
    async (O) => {
      ...
      zt && await u({ threadId: c, contents: zt }) && bt();
    },
    [
      bt,
      R,
    ...
    async (O) => {
      ...
      return Et && zt && bt(), Et && C !== void 0 && S(void 0), Et;
    },
    [bt, R, u, C]
  );
  return /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(
            no,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: Y,
              canEditOrDelete: (!A && ot.get(yt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ d(ct, { children: [
            ...
            Ht.map((O) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              no,
              {
                ...
                handleDeleteComment: f,
                onEditingChange: Y,
                canEditOrDelete: (!A && ot.get(O.id)) ?? !1
              }
            ) }, O.id)),
                    ...
                    /* @__PURE__ */ d(ne, { open: M, onOpenChange: J, children: [
                      ...
                      /* @__PURE__ */ r(
                        Gt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (O) => {
                            O.key === "Escape" && (O.stopPropagation(), J(!1));
                          },
...
function Uw({
  ...
  const i = W(null), s = W(null), l = W(!1), [c, w] = T(t), [p, u] = T(n), [h, f] = T(!1);
  U(() => {
    w(t);
  }, [t]), U(() => {
    p !== n && u(n);
...
function dp({
  ...
  const w = W(null), p = W(null), u = W(null), [h, f] = T("generated"), [g, x] = T("*"), [v, y] = T("f"), [N, _] = T(!1), [k, z] = T(!1), [L, R] = T(), [$, C] = T(), [S, V] = T(), [j, I] = T(), A = W(null), Y = F(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  U(() => {
    ...
    if (D && wn("note", D)) {
      const G = (q = D.insert.note) == null ? void 0 : q.caller;
      let ot = "custom";
      G === Wn ? ot = "generated" : G === Jn ? ot = "hidden" : G && x(G), f(ot), y(((tt = D.insert.note) == null ? void 0 : tt.style) ?? "f"), P = setTimeout(() => {
        var ht;
        (ht = w.current) == null || ht.applyUpdate([D]);
      }, 0);
    }
    return () => {
      P && clearTimeout(P);
  ...
  const J = K(() => {
    var D, q;
    const P = (q = (D = w.current) == null ? void 0 : D.getNoteOps(0)) == null ? void 0 : q.at(0);
    ...
    var q, tt, G, ot, ht;
    y(P);
    const D = (tt = (q = w.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : tt.at(0);
    if (D && wn("note", D)) {
      D.insert.note && (D.insert.note.style = P);
      const pt = (ot = (G = D.insert.note) == null ? void 0 : G.contents) == null ? void 0 : ot.ops;
      v !== "x" && P === "x" ? pt == null || pt.forEach((yt) => tc(yt)) : v === "x" && P !== "x" && (pt == null || pt.forEach((yt) => ec(yt))), (ht = w.current) == null || ht.applyUpdate([D, { delete: 1 }]);
    }
  }, Mt = (P) => {
    var q, tt, G, ot, ht, pt;
    (q = w.current) == null || q.focus();
    const D = (G = (tt = w.current) == null ? void 0 : tt.getNoteOps(0)) == null ? void 0 : G.at(0);
    if (D && wn("note", D)) {
      P.content.length > 1 && setTimeout(() => {
        var gt;
        (gt = w.current) == null || gt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const yt = (ot = D.insert.note) == null ? void 0 : ot.style, Ot = (pt = (ht = D.insert.note) == null ? void 0 : ht.contents) == null ? void 0 : pt.ops;
      yt || _(!1), _(
        yt === "x" ? !!(Ot != null && Ot.every((gt) => {
          var Ut, E;
          if (!((Ut = gt.attributes) != null && Ut.char)) return !0;
          const bt = ((E = gt.attributes) == null ? void 0 : E.char).style;
    ...
    if (u.current && M.length && P && P.rangeCount > 0) {
      const D = P.getRangeAt(0).getBoundingClientRect(), q = u.current.getBoundingClientRect();
      R(D.left - q.left), C(D.top - q.top), V(D.height), z(!0);
    }
  }, [M, u]);
  return U(() => {
    const P = () => {
    ...
    var tt;
    const P = ((tt = p.current) == null ? void 0 : tt.querySelector(".editor-input")) ?? void 0, D = /Macintosh/i.test(navigator.userAgent), q = (G) => {
      var ot, ht;
      !k && P && document.activeElement === P && G.key === l ? (G.preventDefault(), dt()) : k && G.key === "Escape" && (G.preventDefault(), z(!1)), (D ? G.metaKey : G.ctrlKey) && (G.shiftKey && G.key.toLowerCase() === "z" || G.key.toLowerCase() === "y" ? (ot = w.current) == null || ot.redo() : G.key.toLowerCase() === "z" && ((ht = w.current) == null || ht.undo()));
    };
...
function yp({
  ...
  const f = Ft(n, "%webView_inventory_all%"), g = Ft(n, "%webView_inventory_approved%"), x = Ft(n, "%webView_inventory_unapproved%"), v = Ft(n, "%webView_inventory_unknown%"), y = Ft(n, "%webView_inventory_scope_currentBook%"), N = Ft(n, "%webView_inventory_scope_chapter%"), _ = Ft(n, "%webView_inventory_scope_verse%"), k = Ft(n, "%webView_inventory_filter_text%"), z = Ft(
    n,
    "%webView_inventory_show_additional_items%"
  ), L = Ft(n, "%webView_inventory_no_results%"), [R, $] = T(!1), [C, S] = T("all"), [V, j] = T(""), [I, A] = T([]), Y = F(() => {
    const D = t ?? [];
    ...
    const D = [];
    return Y.forEach((q) => {
      const tt = q.items[0], G = D.find(
        (ot) => ot.items[0] === tt
      );
      G ? (G.count += q.count, G.occurrences = G.occurrences.concat(q.occurrences)) : D.push({
        items: [tt],
        count: q.count,
  ...
  }, [R, Y]), J = F(() => M.length === 0 ? [] : dc(M, C, V), [M, C, V]), Ct = F(() => {
    var tt, G;
    if (!R) return c;
    const D = (tt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : tt.length;
    if (!D) return c;
    const q = [];
    for (let ot = 0; ot < D; ot++)
      q.push(
        wc(
          ((G = o == null ? void 0 : o.tableHeaders) == null ? void 0 : G[ot]) || "Additional Item",
          ot + 1
        )
      );
    return [...q, ...c];
  ...
  const Dt = (D, q) => {
    q.setRowSelection(() => {
      const G = {};
      return G[D.index] = !0, G;
    });
    const tt = D.original.items;
...
function Vc({
  ...
  const L = F(() => wt.allBookIds.filter(
    ...
    (A, Y = !1) => {
      ...
      const M = L.findIndex((dt) => dt === k.current), J = L.findIndex((dt) => dt === A);
      if (M === -1 || J === -1) return;
      const [Ct, Dt] = [
        Math.min(M, J),
        Math.max(M, J)
    ...
    A.preventDefault(), $(Y, A.shiftKey);
  }, V = K(
    (A) => {
      const Y = Dr(L, A).map((M) => M);
      n(
        La(L, A, e) ? e.filter((M) => !Y.includes(M)) : [.../* @__PURE__ */ new Set([...e, ...Y])]
      );
    },
    [e, n, L]
  ), j = () => {
                  ...
                  Object.values(H).map((A, Y) => {
                    ...
                    if (M.length !== 0)
                      return /* @__PURE__ */ d(lo, { children: [
                        ...
                        Y < Object.values(H).length - 1 && /* @__PURE__ */ r(zo, {})
                      ] }, A);
                  })
                ] })
              ]
...
Ga.displayName = st.Root.displayName;
...
qa.displayName = st.Trigger.displayName;
...
Ua.displayName = st.SubTrigger.displayName;
...
Ha.displayName = st.SubContent.displayName;
...
Ya.displayName = st.Content.displayName;
...
Xa.displayName = st.Item.displayName;
...
Bc.displayName = st.CheckboxItem.displayName;
...
Kc.displayName = st.RadioItem.displayName;
...
Gc.displayName = st.Label.displayName;
...
Wa.displayName = st.Separator.displayName;
const Ge = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
...
function qc({
  ...
  if (Bi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(Ga, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(zc, { children: [
...
const jp = it.Root, zp = it.Trigger, Fp = it.Group, Bp = it.Portal, Kp = it.Sub, Gp = it.RadioGroup, Qc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  it.SubTrigger,
  {
    ref: a,
    className: m(
...
Qc.displayName = it.SubTrigger.displayName;
...
td.displayName = it.SubContent.displayName;
const ed = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(it.Portal, { children: /* @__PURE__ */ r(
  it.Content,
  {
    ref: n,
    className: m(
...
ed.displayName = it.Content.displayName;
...
nd.displayName = it.Item.displayName;
const rd = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  it.CheckboxItem,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(it.ItemIndicator, { children: /* @__PURE__ */ r(Lt, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
rd.displayName = it.CheckboxItem.displayName;
const od = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  it.RadioItem,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(it.ItemIndicator, { children: /* @__PURE__ */ r(_n, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
od.displayName = it.RadioItem.displayName;
...
ad.displayName = it.Label.displayName;
...
sd.displayName = it.Separator.displayName;
