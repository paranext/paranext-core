...
import T, { forwardRef as lr, useCallback as Pt, useState as lt, useRef as ke, useEffect as te, useLayoutEffect as ua, useMemo as Tt } from "react";
...
function xh({ scrRef: t, handleSubmit: e }) {
  const n = St(), [r, o] = lt(""), [a, s] = lt(
    ct.bookNumberToId(t.bookNum)
  ), [l, c] = lt(t.chapterNum ?? 0), [d, u] = lt(
    ct.bookNumberToId(t.bookNum)
  ), [f, w] = lt(!1), [g, v] = lt(f), m = ke(void 0), h = ke(void 0), N = ke(void 0), S = Pt(
    (A) => Ac(A).filter((M) => {
...
function kh({
  ...
  const u = Ir(d, "%webView_bookSelector_currentBook%"), f = Ir(d, "%webView_bookSelector_choose%"), w = Ir(d, "%webView_bookSelector_chooseBooks%"), [g, v] = lt(
    "current book"
    /* CURRENT_BOOK */
  ), m = (h) => {
    v(h), t(h);
...
function ed({
  ...
  var h;
  const [l, c] = lt([]), [d, u] = lt([]), [f, w] = lt({}), [g, v] = lt({}), m = hi({
    data: e,
    columns: t,
    getCoreRowModel: gi(),
...
function Oh({
  ...
  const f = ie(n, "%webView_inventory_all%"), w = ie(n, "%webView_inventory_approved%"), g = ie(n, "%webView_inventory_unapproved%"), v = ie(n, "%webView_inventory_unknown%"), m = ie(n, "%webView_inventory_scope_currentBook%"), h = ie(n, "%webView_inventory_scope_chapter%"), N = ie(n, "%webView_inventory_scope_verse%"), S = ie(n, "%webView_inventory_filter_text%"), C = ie(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = lt(!1), [P, L] = lt("all"), [_, $] = lt(""), [F, D] = lt([]), A = Tt(() => l ? r instanceof RegExp ? cd(
    l,
    t,
    a,
    s,
...
function Co({
  ...
  const a = St();
  return /* @__PURE__ */ y("div", { className: k("tw-relative", { "tw-w-full": r }, o), children: [
    /* @__PURE__ */ i(
      wi,
      {
        className: k(
...
function Rh({
  ...
  return /* @__PURE__ */ y("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ y(Li, { children: [
      /* @__PURE__ */ i(Fi, { children: t.map((s) => /* @__PURE__ */ i(ud, { value: s.value, children: s.value }, s.key)) }),
      t.map((s) => /* @__PURE__ */ i(Ui, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
...
function Ph({
  ...
  const [c, d] = lt([]), [u, f] = lt([{ id: pe, desc: !1 }]), [w, g] = lt({}), v = Tt(
    ...
    function L(x) {
      ...
      function O(G, X, z, q, W) {
        for (var K = G[X], H = 0; H < x.length; H++)
          if (v(K, x[H]))
            return null;
        var Z = JSON.stringify(x, function(st, R) {
          var Et = tt(R);
  ...
  if (P) {
    if (a) {
      var M, Y = E === "y" ? At : Mt, U = E === "y" ? Yt : Wt, V = E === "y" ? "height" : "width", tt = P[E], ot = tt + h[Y], at = tt - h[U], x = g ? -_[V] / 2 : 0, O = S === Ye ? L[V] : _[V], G = S === Ye ? -_[V] : -L[V], X = e.elements.arrow, z = g && X ? Xo(X) : {
        width: 0,
        height: 0
      }, q = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : _s(), W = q[Y], K = q[U], H = vn(0, L[V], z[V]), Z = C ? L[V] / 2 - x - H - W - F.mainAxis : O - H - W - F.mainAxis, Q = C ? -L[V] / 2 + x + H + K + F.mainAxis : G + H + K + F.mainAxis, st = e.elements.arrow && Ln(e.elements.arrow), R = st ? E === "y" ? st.clientTop || 0 : st.clientLeft || 0 : 0, Et = (M = D == null ? void 0 : D[E]) != null ? M : 0, j = tt + Z - Et - R, xt = tt + Q - Et, Ot = vn(g ? ir(ot, j) : ot, tt, g ? Te(at, xt) : at);
      P[E] = Ot, A[E] = Ot - tt;
    }
    if (l) {
...
const Ls = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    B.useEffect(() => {
      _t && _t.disabled && !et && st !== "" && _t.tagName.toLowerCase() === "button" && console.error(["MUI: You are providing a disabled `button` child to the Tooltip component.", "A disabled element does not fire events.", "Tooltip needs to listen to the child element's events to display the title.", "", "Add a simple wrapper element, such as a `span`."].join(`
`));
    }, [st, _t, et]);
  }
  ...
  }, rn = {}, Rr = typeof st == "string";
  D ? (rn.title = !ae && Rr && !M ? st : null, rn["aria-describedby"] = ae ? Sr : null) : (rn["aria-label"] = Rr ? st : null, rn["aria-labelledby"] = ae && !Rr ? Sr : null);
    ...
    children: [/* @__PURE__ */ B.cloneElement(xt, Ut), /* @__PURE__ */ i(sa, I({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ y(ca, I({}, sl, {
          children: [st, L ? /* @__PURE__ */ i(da, I({}, ll, {
            ref: Nt
          })) : null]
        }))
      }))
...
function Rm(t) {
  const [e, n] = lt(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, s = (d) => {
    n(d.currentTarget);
  }, l = () => {
    n(void 0);
  }, c = () => {
...
const uo = (t, e, n = {}) => {
  ...
  const [a, s] = lt(() => r.current), [l, c] = lt(!0);
  return te(() => {
    let d = !0;
    return c(!!t), (async () => {
      if (t) {
...
function Km({ id: t, versionHistory: e }) {
  const [n, r] = lt(!1), o = /* @__PURE__ */ new Date();
  function a(l) {
...
function Zh({
  ...
  ], [U, V, tt, ot]), Q = Tt(() => r.length === 0 ? H : H.filter((J) => r.includes(J.type)), [H, r]), st = Tt(() => a.length === 0 ? Q : Q.filter((J) => a.includes(J.bestLanguageName)), [a, Q]), [R, Et] = lt({
