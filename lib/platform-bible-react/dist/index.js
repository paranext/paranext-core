...
var Ht = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as v, g as Re, a as Fa, C as Te, A as ue, P as Ie, b as Qe, B as G, d as Ae, e as Pe, f as Ve, h as Ce, i as Li, k as ji, j as Bi, E as Fi, l as Ua, r as be, m as Ui, n as wn, o as ta, p as ea, L as Rt, R as Ka, q as Gr, D as Na, s as Ca, t as Ea, u as Ta, T as un, v as Lr, w as jt, x as qa, y as Bt, z as Ft, F as Ut, G as pn, H as Ga, I as Xe, J as _r, K as Le, M as je, N as Be, S as Nr, O as ir, Q as Ki, U as Tr, V as Ze, W as Me, Z as tr, X as De, Y as sr, _ as Ha, $ as Ya, a0 as Hr, a1 as Wa, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as Sa, a7 as gn, a8 as ra, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as ca, ah as xo, ai as la, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as Sr, ap as Xa, aq as os, ar as ns } from "./resizable-C3AVzTx2.js";
import { as as ng, at as ig, au as sg, av as cg, aw as lg, ax as dg, ay as wg, az as ug, aA as pg, aB as hg, aC as gg, aD as fg, aE as mg, aF as vg, aG as bg, aH as xg, aI as yg, aJ as kg, aK as _g, aL as Ng, aM as Cg, aN as Eg, aO as Tg, aP as Sg, aQ as zg } from "./resizable-C3AVzTx2.js";
import { jsx as a, jsxs as u, Fragment as ut } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as Oe, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as za, ChevronRight as Ra, ArrowLeft as is, ArrowRight as ss, ChevronDown as dr, BoldIcon as cs, ItalicIcon as ls, X as Ja, AtSign as vn, Pencil as ds, Trash2 as ws, ArrowUp as bn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as xn, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, Undo as Cs, Redo as Es, SquareX as yn, FunctionSquare as kn, SquareSigma as _n, Ban as Ts, AlertCircle as Da, CircleCheckIcon as Ss, CircleXIcon as zs, CircleHelpIcon as Rs, ArrowUpIcon as Ds, ArrowDownIcon as Ms, ScrollText as Os, ChevronsUpDown as $s, MenuIcon as Is, Menu as As, EllipsisVertical as Ps, MoreVertical as Vs } from "lucide-react";
import { Section as ht, getChaptersForBook as Ls, formatScrRef as _e, getSectionForBook as xr, formatRelativeDate as js, formatReplacementString as Je, sanitizeHtml as Za, NumberFormat as Nn, formatBytes as Bs, getCurrentLocale as Fs, usfmMarkers as jr, getFormatCallerFunction as Us, deepEqual as Ks, isString as No, compareScrRefs as Ma, scrRefToBBBCCCVVV as da, defaultScrRef as wa, formatScrRefRange as qs, getLocalizeKeyForScrollGroupId as Co, formatReplacementStringToArray as Eo, collectUsjMarkers as Gs } from "platform-bible-utils";
import Wt, { useRef as F, useMemo as I, useState as N, useCallback as L, useEffect as q, useImperativeHandle as Hs, useLayoutEffect as oe, createContext as Qa, useContext as Cn, Component as Ys, createElement as To, Suspense as Ws, forwardRef as En, useId as So, Fragment as aa } from "react";
import { IconSelector as Tn, IconCheck as oa, IconChevronDown as Xs, IconChevronUp as Js, IconLayoutSidebar as Zs, IconLayoutSidebarRight as Qs, IconChevronRight as Sn, IconSearch as tc, IconLoader as ec, IconAlertOctagon as rc, IconAlertTriangle as ac, IconInfoCircle as oc, IconCircleCheck as nc } from "@tabler/icons-react";
import { createEditor as zn, $getRoot as $e, $createParagraphNode as zr, $getSelection as Qt, HISTORY_MERGE_TAG as to, ParagraphNode as Rn, TextNode as Dn, $getPreviousSelection as ic, $isRangeSelection as me, $caretFromPoint as sc, $getSiblingCaret as Mn, $getChildCaret as cc, $getAdjacentChildCaret as lc, $isChildCaret as dc, $normalizeCaret as wc, $setSelectionFromCaretRange as uc, $getCollapsedCaretRange as pc, $getCaretInDirection as zo, $splitAtPointCaretNext as hc, $isTextPointCaret as gc, $findMatchingParent as On, $isElementNode as Cr, mergeRegister as Ee, getDOMTextNode as fc, isHTMLElement as mc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as eo, shallowMergeConfig as vc, defineExtension as ie, safeCast as er, createState as bc, FORMAT_TEXT_COMMAND as In, $isNodeSelection as An, COMMAND_PRIORITY_LOW as Pn, RootNode as xc, LineBreakNode as yc, TabNode as kc, $isEditorState as _c, createCommand as Nc, CLICK_COMMAND as Cc, isDOMNode as Ec, $getNodeFromDOMNode as Tc, $createNodeSelection as Sc, $setSelection as zc, $getEditor as Rc, DecoratorNode as Oa, $getState as Dc, toggleTextFormatType as Ro, TEXT_TYPE_TO_FORMAT as Mc, $setState as Oc, addClassNamesToElement as Vn, $create as $c, $getNodeByKey as Ic, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Pc, $isBlockElementNode as Vc, $createRangeSelection as Lc, $normalizeSelection__EXPERIMENTAL as jc, OUTDENT_CONTENT_COMMAND as Bc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as ro, $isDecoratorNode as Uc, $isParagraphNode as Kc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as qc } from "lexical";
...
import { Avatar as ao, Select as Xt, Checkbox as Mo, Slot as Rr, Tabs as pe, Menubar as xe, ContextMenu as At, Progress as Oo, Slider as Or, Switch as $o } from "radix-ui";
import { useReactTable as Bn, getFilteredRowModel as tl, getSortedRowModel as Fn, getPaginationRowModel as el, getCoreRowModel as Un, flexRender as yr, getGroupedRowModel as rl, getExpandedRowModel as al } from "@tanstack/react-table";
import ol from "markdown-to-jsx";
import { filterAndRankItems as Io, GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as nl, isInsertEmbedOpOfType as $r, Editorial as il, getMarkerMenuItems as sl, defaultStyleInfo as cl } from "@eten-tech-foundation/platform-editor";
...
function ul({
  ...
  const [h, g] = N(!1), f = w !== void 0, b = f ? w : h, m = (E) => {
    f || g(E), p == null || p(E);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Ie, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Ae, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(Ce, { heading: i, children: t.map((E) => /* @__PURE__ */ u(
      Te,
      {
        onSelect: () => C(E),
...
function pa({
  ...
  const j = be(), [D, $] = N(!1), [P, S] = N(""), [V, H] = N(""), [_, et] = N("books"), [B, X] = N(void 0), [M, O] = N(
    void 0
  ), [W, ot] = N(void 0), [Pt, Ot] = N(!1), Kt = F(null), K = F(!1), it = F(void 0), gt = F(void 0), lt = F(void 0), ft = F(void 0), Jt = F({}), Ct = F({}), xt = L(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ), Et = I(() => o ? o() : Ui, [o]), qt = I(() => ({
    [ht.OT]: Et.filter((Y) => bt.isBookOT(Y)),
    [ht.NT]: Et.filter((Y) => bt.isBookNT(Y)),
    [ht.DC]: Et.filter((Y) => bt.isBookDC(Y)),
    [ht.Extra]: Et.filter((Y) => bt.extraBooks().includes(Y))
  }), [Et]), yt = I(() => Object.values(qt).flat(), [qt]), Vt = I(() => {
    if (!V.trim()) return qt;
    const x = {
      [ht.OT]: [],
      [ht.NT]: [],
    ...
    return [ht.OT, ht.NT, ht.DC, ht.Extra].forEach((ct) => {
      x[ct] = qt[ct].filter((Lt) => Ua(Lt, V, n));
    }), x;
  }, [qt, V, n]), R = I(
    () => ml(V, yt, n),
    [V, yt, n]
  ...
  const _t = L(() => {
    if (R) {
      const x = R.chapterNum ?? 1, Y = R.verseNum ?? 1;
      if (w && ua(R.book, x, Y, w))
        return;
      xt({
        book: R.book,
        chapterNum: x,
    ...
    (x) => {
      const Y = M ?? (R == null ? void 0 : R.book), ct = W ?? (R == null ? void 0 : R.chapterNum);
      !Y || !ct || (xt({
        book: Y,
        chapterNum: ct,
        verseNum: x
    ...
    (x) => {
      const Y = _ === "chapters" ? B : R == null ? void 0 : R.book;
      if (Y) {
        if (d && d(Y, x) > 1) {
          O(Y), ot(x), et("verses"), S("");
          return;
        }
        xt({
          book: Y,
    ...
    et("books"), X(void 0), O(void 0), ot(void 0), setTimeout(() => {
      gt.current && gt.current.focus();
    }, 0);
  }, []), ee = L(() => {
    const x = M;
    O(void 0), ot(void 0), x ? (X(x), et("chapters"), S("")) : Tt();
  }, [M, Tt]), $t = L((x) => {
    $(x), x && (et("books"), X(void 0), O(void 0), ot(void 0), H(""));
  }, []);
  q(() => {
    z && $t(!1);
  }, [z, $t]);
  ...
  q(() => {
    var x;
    Dt !== 0 && ((x = gt.current) == null || x.focus());
  }, [Dt]), Hs(
    k,
    () => ({
      open: () => {
  ...
  const { otLong: T, ntLong: U, dcLong: nt, extraLong: J } = {
    ...
    () => gl(V),
    [V]
  ), wt = I(() => !d || !R || !R.chapterNum || !at ? !1 : d(R.book, R.chapterNum) > 0, [d, R, at]), mt = L(
    (x) => w ? Ao(x, w) : !1,
    [w]
  ), Nt = L(
    (x) => (Y) => w ? fl(x, Y, w) : !1,
    ...
    (x, Y) => (ct) => w ? ua(x, Y, ct, w) : !1,
    [w]
  ), de = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", ae = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Dr = L(
    (x) => {
      (x.key === "Home" || x.key === "End") && x.stopPropagation(), p && p.includes(x.key) && R && R.chapterNum !== void 0 && R.verseNum !== void 0 && (x.preventDefault(), x.stopPropagation(), _t());
    },
    [p, R, _t]
  ), rr = L(
    (x) => {
      var ke, Se, Ge;
      if (x.ctrlKey) return;
      const { isLetter: Y, isDigit: ct } = Po(x.key);
      if ((_ === "chapters" || _ === "verses") && (x.key === " " || x.key === "Enter")) {
        ...
        const zt = (ke = it.current) == null ? void 0 : ke.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (zt) {
          x.preventDefault(), x.stopPropagation(), zt.click();
          return;
        }
      }
      if ((_ === "chapters" || _ === "verses") && (Y || ct)) {
      ...
      if (_ === "verses" && x.key === "Backspace") {
        x.preventDefault(), x.stopPropagation(), ee();
        return;
      }
      const Lt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key);
      if (_ === "verses" && Lt) {
        const Mt = M, St = W;
        if (!Mt || !St || !d) return;
        const zt = d(Mt, St);
        if (!zt) return;
        (Se = it.current) == null || Se.focus();
        const vt = (() => {
          if (!P) return 1;
          const He = P.match(/:(\d+)$/);
        ...
        switch (x.key) {
          case "ArrowLeft":
            vt !== 0 && (Gt = vt > 1 ? vt - 1 : zt);
            break;
          case "ArrowRight":
            vt !== 0 && (Gt = vt < zt ? vt + 1 : 1);
            break;
          case "ArrowUp":
            Gt = vt === 0 ? zt : Math.max(1, vt - he);
            break;
          case "ArrowDown":
            Gt = vt === 0 ? 1 : Math.min(zt, vt + he);
            break;
          default:
            return;
        }
        Gt !== vt && (x.preventDefault(), x.stopPropagation(), S(
          `${Mt} ${ue[Mt] || ""} ${St}:${Gt}`
        ), setTimeout(() => {
          const He = Ct.current[Gt];
          He && He.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((_ === "chapters" || _ === "books" && R) && Lt) {
        const Mt = _ === "chapters" ? B : R == null ? void 0 : R.book;
        if (!Mt) return;
        _ === "chapters" && ((Ge = it.current) == null || Ge.focus());
        const St = (() => {
          if (!P) return 1;
          const he = P.match(/(\d+)$/);
          return he ? parseInt(he[1], 10) : 0;
        ...
        switch (x.key) {
          case "ArrowLeft":
            St !== 0 && (vt = St > 1 ? St - 1 : zt);
            break;
          case "ArrowRight":
            St !== 0 && (vt = St < zt ? St + 1 : 1);
            break;
          case "ArrowUp":
            vt = St === 0 ? zt : Math.max(1, St - Gt);
            break;
          case "ArrowDown":
            vt = St === 0 ? 1 : Math.min(zt, St + Gt);
            break;
          default:
            return;
        }
        vt !== St && (x.preventDefault(), x.stopPropagation(), S(
          `${Mt} ${ue[Mt] || ""} ${vt}`
        ), setTimeout(() => {
          const he = Jt.current[vt];
          he && he.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
      }
    },
    ...
    const { isLetter: Y, isDigit: ct } = Po(x.key);
    (Y || ct) && (x.preventDefault(), H((ke) => ke + x.key), gt.current.focus(), Ot(!1));
  }, []);
  return oe(() => {
    const x = setTimeout(() => {
      if (D && _ === "books" && lt.current && ft.current) {
        const Y = lt.current, ct = ft.current, Lt = ct.offsetTop, ke = Y.clientHeight, Se = ct.clientHeight, Ge = Lt - ke / 2 + Se / 2;
        Y.scrollTo({
          top: Math.max(0, Ge),
          behavior: "smooth"
        }), S(qn(t.book));
    ...
    if (_ === "chapters" && B) {
      const x = B === t.book, Y = x ? t.chapterNum : 1;
      S(
        `${B} ${ue[B] || ""} ${Y}`
      ), setTimeout(() => {
        if (lt.current)
          if (x) {
            const ct = Jt.current[t.chapterNum];
  ...
  }, [_, B, R, t.book, t.chapterNum]), oe(() => {
    if (_ === "verses" && M && W !== void 0) {
      const x = M === t.book && W === t.chapterNum, Y = x ? t.verseNum : 1;
      S(
        `${M} ${ue[M] || ""} ${W}:${Y}`
      ), setTimeout(() => {
        if (lt.current)
          if (x) {
            const ct = Ct.current[t.verseNum];
            ct && ct.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            lt.current.scrollTo({ top: 0 });
        it.current && it.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ie, { open: D, onOpenChange: $t, modal: C, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        ...
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: tt }),
          f && /* @__PURE__ */ a(
            Tn,
            {
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        onPointerDownOutside: (x) => {
          const { target: Y } = x;
          D && Kt.current && Y instanceof Node && Kt.current.contains(Y) && (K.current = !0, $t(!1));
        },
        onCloseAutoFocus: m,
        children: /* @__PURE__ */ u(
          Pe,
              ...
              _ === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                /* @__PURE__ */ u("div", { className: "tw:relative tw:flex-1", children: [
                  ...
                  s && s.length > 0 && /* @__PURE__ */ a(
                    ...
                    {
                      recentSearches: s,
                      onSearchItemSelect: ce,
                      renderItem: (x) => _e(x, "English"),
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: Ke.map(
                  ({ onClick: x, disabled: Y, title: ct, icon: Lt }) => /* @__PURE__ */ a(
                    G,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: _ === "verses" ? ee : Tt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: j === "ltr" ? /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                _ === "chapters" && B && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(B, n) }),
                _ === "verses" && M && W !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Re(M, n)} ${W}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: _ === "verses" ? ae : de
                  }
                )
              ] }),
              !Pt && /* @__PURE__ */ u(Ve, { ref: lt, children: [
                _ === "books" && /* @__PURE__ */ u(ut, { children: [
                  !R && Object.entries(Vt).map(([x, Y]) => {
                    if (Y.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ce, { heading: Z(x), children: Y.map((ct) => /* @__PURE__ */ a(
                          Kn,
                          {
                            bookId: ct,
                            onSelect: (Lt) => Ue(Lt),
                            section: xr(ct),
                            commandValue: `${ct} ${ue[ct]}`,
                            ref: ct === t.book ? ft : void 0,
                            localizedBookNames: n,
                            disabled: mt(ct)
                          },
                          ct
                  ...
                  R && /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(
                    Te,
                    {
                      value: `${R.book} ${ue[R.book]} ${R.chapterNum || ""}:${R.verseNum || ""})}`,
                      onSelect: _t,
                      disabled: !!w && ua(
                        R.book,
                        R.chapterNum ?? 1,
                  ...
                  R && wt && R.chapterNum && d && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Re(R.book, n)} ${R.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      Lo,
                      {
                        ...
                        onVerseSelect: te,
                        setVerseRef: rt,
                        isVerseDisabled: le(R.book, R.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  R && !wt && cr(R.book) > 1 && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Re(R.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Vo,
                      {
                        ...
                        setChapterRef: y,
                        isChapterDimmed: st,
                        isChapterDisabled: Nt(R.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                _ === "chapters" && B && /* @__PURE__ */ a(
                  Vo,
                  {
                    bookId: B,
                    scrRef: t,
                    onChapterSelect: se,
                    setChapterRef: y,
                    isChapterDisabled: Nt(B),
                    className: "tw:p-4"
                  }
                ),
                _ === "verses" && M && W !== void 0 && d && /* @__PURE__ */ a(
                  Lo,
                  {
                    bookId: M,
                    chapterNum: W,
...
function jo({
  ...
  const [k, z] = N(!1), j = d ?? l, D = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], $ = (P, S) => {
    const V = l(P), H = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, _ = `${S ?? ""}${V}${H ?? ""}`;
    return /* @__PURE__ */ u(
      Te,
      {
        value: V,
  ...
  return /* @__PURE__ */ u(Ie, { open: k, onOpenChange: z, ...E, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      G,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ae,
      {
        ...
        children: /* @__PURE__ */ u(Pe, { children: [
          ...
          /* @__PURE__ */ a(Ve, { children: D(e) ? e.map((P) => /* @__PURE__ */ a(Ce, { heading: P.groupHeading, children: P.options.map((S) => $(S, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(Ce, { children: e.map((P) => $(P)) }) })
        ] })
      }
    )
  ] });
    ...
    Ka,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Rt, { className: "tw:flex tw:items-center", children: o.map((m) => bt.bookIdToEnglishName(m)).join(", ") }),
          /* @__PURE__ */ a(
            G,
            {
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, yl = Yn ? oe : q, Ar = { tag: to };
function kl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = xl(null, o), w = zn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : q;
...
const zl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : q;
function Rl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = ye(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = F(o);
    return zl(() => {
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ol = Wn && "documentMode" in document ? document.documentMode : null;
!(!Wn || !("InputEvent" in window) || Ol) && "getTargetRanges" in new window.InputEvent("input");
function fe(t) {
  return `${t}px`;
}
...
function Il(t, e, r) {
  ...
  function l() {
    ...
    for (let C = 0; C < g.length; C++) {
      const E = g[C], k = s[C] || document.createElement("div"), z = k.style;
      z.position !== "absolute" && (z.position = "absolute", m = !0);
      const j = fe(E.left - p);
      z.left !== j && (z.left = j, m = !0);
      const D = fe(E.top - h);
      z.top !== D && (k.style.top = D, m = !0);
      const $ = fe(E.width);
      z.width !== $ && (k.style.width = $, m = !0);
      const P = fe(E.height);
      z.height !== P && (k.style.height = P, m = !0), k.parentNode !== c && (c.append(k), m = !0), s[C] = k;
    }
...
function Pl(t, e = Al) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), b = f.getKey(), m = h.offset, C = g.getNode(), E = C.getKey(), k = g.offset, z = t.getElementByKey(b), j = t.getElementByKey(E), D = r === null || z !== o || m !== n || b !== r.getKey(), $ = i === null || j !== s || k !== c || E !== i.getKey();
      if ((D || $) && z !== null && j !== null) {
        const P = function(S, V, H, _, et, B, X) {
          const M = (S._window ? S._window.document : document).createRange();
          return M.setStart(...Bo(V, H, _)), M.setEnd(...Bo(et, B, X)), M;
        }(t, h, f, z, g, C, j);
        l(), l = Il(t, P, e);
      }
      r = f, o = z, n = m, i = C, s = j, c = k;
    });
  }
...
function Ll(t) {
  const e = On(t, (r) => Cr(r) && !r.isInline());
  return Cr(e) || Yr(4, t.__key), e;
}
function jl(t) {
  const e = Qt() || ic();
  let r;
  if (me(e)) r = sc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Mn(c, "next"));
    }
    r = r || cc($e(), "previous").getFlipped().insert(zr());
  }
...
function Bl(t, e, r) {
  ...
  return gc(o) && Yr(283), o.insert(t.isInline() ? zr().append(t) : t), zo(Mn(t.getLatest(), "next"), e.direction);
}
function Fl(t) {
  const e = Qt();
  if (!me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = On(i, (d) => Cr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Wr, Ne = 0, Xr = 0, ql = 0, Va = 0, Fr = 0;
function Uo(t) {
  if (dt === void 0) return;
  let e = t.n;
...
function Ye(t, e) {
  Yt.call(this, void 0), this.x = t, this.s = void 0, this.g = Fr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Gl(t, e) {
  return new Ye(t, e);
}
...
function Hl(t) {
  ...
  Jn(this), dt = t, this.f &= -2, 8 & this.f && so(this), na();
}
function nr(t, e) {
...
Yt.prototype.brand = Ul, Yt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ne !== 0 && Xr === 0 && e.l !== Va && (e.l = Va, Wr = { S: e, v: e.v, i: e.i, o: Wr });
    })(this), this.v = t, this.i++, Fr++, Ne++;
    try {
  ...
  return dt = t, Jn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zn(this), Ko(this), Ne++;
  const t = dt;
  return dt = this, Hl.bind(this, t);
...
function ti(t, e = Qn) {
  return t.registerCommand($n, (r) => (t.update(e), !0), eo);
}
...
const fa = bc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ei extends Oa {
  $config() {
...
ie({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = Qt();
  if (An(n) || me(n)) for (const i of n.getNodes()) Wl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ri(t, e) {
  let r;
...
const La = ie({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const co = 0, ja = 1, oi = 2, ma = 3, Pr = 4, ar = 5, va = 6, vr = 7;
function ba(t) {
  return t.id === co;
}
function ni(t) {
...
function Xl(t) {
  return function(e) {
    return e.id === ja;
  }(t) || pt(305, String(t.id), String(ja)), Object.assign(t, { id: oi });
}
...
class Zl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && pt(307, String(r.id), String(ar)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== va && pt(310, String(r.id), String(va)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Pr;
    }(e) || pt(313, String(e.id), String(Pr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= vr;
    }(e) || pt(316, String(e.id), String(vr)), e;
  }
...
const td = ie({ config: er({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Ql }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [xc, Dn, yc, kc, Rn] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function ed(t) {
  throw t;
...
class lr {
  ...
  static maybeFromEditor(e) {
    const r = e[Go];
    return r && (r.PACKAGE_VERSION !== xa && pt(292, r.PACKAGE_VERSION, xa), r instanceof lr || pt(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      ba(i) || pt(300, s, n || "[unknown]"), ba(c = i) || pt(304, String(c.id), String(co)), i = Object.assign(c, { id: ja }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const h of Yl(p)) {
...
const rd = /* @__PURE__ */ new Set(), Yo = ie({ build(t, e, r) {
  const o = r.getDependency(La).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => ve(() => {
...
ie({ dependencies: [La, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Yo).output, n = Er({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Ee(t.registerCommand(ad, (s) => {
    const c = Qt();
    if (!me(c)) return !1;
    ...
    return !0;
  }, eo), t.registerCommand(Cc, (s) => {
    if (Ec(s.target)) {
      const c = Tc(s.target);
      if (nd(c)) return function(l, d = !1) {
        const w = Qt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && An(w) ? g = w : (g = Sc(), zc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function id(t, e, r = ii) {
  return Ee(t.registerCommand(Pc, (o) => {
    const n = Qt();
    if (!me(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Vc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Ll(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Lc();
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (me(f)) {
                const b = f.anchor;
                let m = b.getNode(), C = 0, E = 0;
                if ($a(m) && d >= 0 && w >= 0 && (C = d, E = d + w, f.setTextNodeRange(m, C, m, E)), C === E && p === "" || (f.insertRawText(p), m = b.getNode()), $a(m)) {
                  C = h, E = h + g;
                  const k = m.getTextContentSize();
                  C = C > k ? k : C, E = E > k ? k : E, f.setTextNodeRange(m, C, m, E);
                }
...
const wo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : q;
  ...
  return function(r, o) {
    ...
    return wo(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(Ws, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
...
function hd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    wo(() => Ee(Yc(n), ci(n)), [n]);
  }(o), u(ut, { children: [t, a(gd, { content: e }), a(pd, { editor: o, ErrorBoundary: r })] });
}
...
const md = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : q;
function vd({ onClear: t }) {
  const [e] = ye();
  return md(() => ti(e, t), [e, t]), null;
}
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? oe : q;
function bd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: C = !0, style: E, tabIndex: k, "data-testid": z, ...j }, D) {
  const [$, P] = N(t.isEditable()), S = L((H) => {
    H && H.ownerDocument && H.ownerDocument.defaultView ? t.setRootElement(H) : t.setRootElement(null);
  }, [t]), V = I(() => /* @__PURE__ */ function(...H) {
    return (_) => {
      for (const et of H) typeof et == "function" ? et(_) : et != null && (et.current = _);
    };
  }(D, S), [S, D]);
  return li(() => (P(t.isEditable()), t.registerEditableListener((H) => {
    P(H);
  })), [t]), a("div", { "aria-activedescendant": $ ? e : void 0, "aria-autocomplete": $ ? r : "none", "aria-controls": $ ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": $ && m === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": $ ? p : void 0, "aria-readonly": !$ || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: $, "data-testid": z, id: b, ref: V, role: m, spellCheck: C, style: E, tabIndex: k, ...j });
}
const xd = En(bd);
function Xo(t) {
  return t.getEditorState().read(si(t.isComposing()));
...
function kd(t, e) {
  ...
  return u(ut, { children: [a(xd, { editor: n, ...o, ref: e }), r != null && a(_d, { editor: n, content: r })] });
}
...
function Td({
  ...
  const [e] = ye(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Ed(), l = () => {
  };
...
function Dd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Td, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(zd, {}) }) }),
...
const $d = "verseText", op = Object.freeze([
...
function mi(t) {
  return (t == null ? void 0 : t.conflictType) === $d;
}
function vi(t) {
...
function np({
  ...
  const [i, s] = N(Id), [c, l] = N(n), [d, w] = N(!1), p = F(void 0), h = F(null);
  q(() => {
    let m = !0;
    const C = h.current;
    if (!C) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ie, { open: d, onOpenChange: w, children: [
      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
        G,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ a(
        Ae,
        {
          ...
          children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(Ve, { children: t.map((m) => /* @__PURE__ */ a(
            Te,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : po(m) && (m.preventDefault(), m.stopPropagation(), ne(i) && g());
        },
        onKeyDown: (m) => {
...
function Qo({
  ...
  }, [t.date, r]), m = I(() => t.user, [t.user]), C = I(
    () => t.user.split(" ").map((D) => D[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), E = I(() => Za(t.contents), [t.contents]), k = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), z = !!t.conflictResolutionAction && !k, j = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(ut, { children: [
        /* @__PURE__ */ u(
          Xe,
          {
            onClick: (D) => {
              D.stopPropagation(), d(!0), p(Od(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Ld, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(jd, { className: "tw:text-xs tw:font-medium", children: C }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (D) => {
                D.key === "Escape" ? (D.preventDefault(), D.stopPropagation(), g()) : po(D) && (D.preventDefault(), D.stopPropagation(), ne(w) && f());
              },
              onKeyDown: (D) => {
        ...
        j && /* @__PURE__ */ u(Le, { children: [
          /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
...
function xi({
  ...
  const [_, et] = N(tn), [B, X] = N(), [M, O] = N(), W = o, [ot, Pt] = N(!1), [Ot, Kt] = N(!1), [K, it] = N(!1), [gt, lt] = N(!1), [ft, Jt] = N(!1), [Ct, xt] = N(z), [Et, qt] = N(!1), yt = F(void 0), [Vt, R] = N(/* @__PURE__ */ new Map());
  q(() => {
    let y = !0;
    return (async () => {
      const at = E ? await E(l) : !1;
      y && Jt(at);
    })(), () => {
      y = !1;
    };
  ...
  q(() => {
    if (!o) {
      kt.current !== "idle" && (X(void 0), O(void 0), kt.current = "idle");
      return;
    }
    kt.current === "idle" && (kt.current = "pending"), gt ? kt.current === "pending" && $ !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    $ !== i && (X($), kt.current = "auto-populated") : kt.current === "auto-populated" && (X(void 0), kt.current = "pending");
  }, [o, $, gt, i]);
  const _t = I(
  ...
  const te = I(() => _t[0], [_t]), Ue = F(null), se = F(void 0), ce = L(() => {
    var y;
    (y = se.current) == null || y.call(se), et(tn);
  }, []), Ke = L(() => {
    const y = !Ct;
    xt(y), qt(!y), f == null || f(l, y);
  }, [Ct, f, l]);
  q(() => {
    Pt(!1);
  }, [o]), q(() => {
    if (o && !Ct && !Et) {
      ...
      return yt.current = y, () => clearTimeout(y);
    }
  ...
  }, [i, r]), $t = I(() => _t.slice(1), [_t]), Dt = I(() => $t.length ?? 0, [$t.length]), re = I(() => Dt > 0, [Dt]), T = I(() => ot || Dt <= 2 ? $t : $t.slice(-2), [$t, Dt, ot]), U = I(() => ot || Dt <= 2 ? 0 : Dt - 2, [Dt, ot]), nt = I(
    () => Dt === 1 ? Tt.singleReply : Je(Tt.multipleReplies, { count: Dt }),
    [Dt, Tt]
  ), J = I(
    () => U === 1 ? Tt.singleReply : Je(Tt.multipleReplies, { count: U }),
    [U, Tt]
  );
  q(() => {
    !o && Ot && re && Kt(!1);
  ...
  const Z = L(
    async (y) => {
      ...
      rt && await p({ threadId: l, contents: rt }) && ce();
    },
    [
      ce,
      _,
    ...
    async (y) => {
      const rt = ne(_) ? Zr(_) : void 0, at = y.status ? y.assignedUser : B ?? y.assignedUser, wt = await p({
        ...y,
        contents: rt,
        assignedUser: at
      });
      return wt && (at !== void 0 && O(at), rt && ce()), wt;
    },
    [ce, _, p, B]
  );
  ...
  const tt = /* @__PURE__ */ a(
    Qo,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Kt,
      canEditOrDelete: (!Ot && Vt.get(te.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(Vd, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ee && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: ee }),
            /* @__PURE__ */ a(
              G,
              {
                variant: "ghost",
            ...
            V === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: ft && w !== "Resolved",
                  onClick: () => st({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(ut, { children: [
          ...
          !o && ne(_) && /* @__PURE__ */ a(
            Jr,
            {
              ...
              onSerializedChange: (y) => et(y),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ut, { children: [
            H && T.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            U > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (y) => {
                  y.stopPropagation(), Pt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (y) => {
                  (y.key === "Enter" || y.key === " ") && (y.preventDefault(), y.stopPropagation(), Pt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: J }),
                    ot ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(dr, {})
                  ] })
                ]
              }
            ),
            T.map((y) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              Qo,
              {
                comment: y,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Kt,
                canEditOrDelete: (!Ot && Vt.get(y.id)) ?? !1
              }
            ) }, y.id)),
            m !== !1 && (!Ot || ne(_)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (y) => {
                  po(y) && (y.preventDefault(), y.stopPropagation(), (ne(_) || B !== void 0 && B !== M) && Z());
                },
                onKeyDown: (y) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    B !== void 0 && (ne(_) || B !== M) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Je(
                    ...
                    /* @__PURE__ */ u(Ie, { open: K, onOpenChange: it, children: [
                      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                        G,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Ae,
                        {
                          ...
                          align: "end",
                          onKeyDown: (y) => {
                            y.key === "Escape" && (y.stopPropagation(), it(!1));
                          },
                          children: /* @__PURE__ */ a(Pe, { children: /* @__PURE__ */ a(Ve, { children: b == null ? void 0 : b.map((y) => /* @__PURE__ */ a(
                            Te,
                            {
                              onSelect: () => {
                                X(y !== i ? y : void 0), kt.current = "user-selected", O(void 0), it(!1);
                              },
                              className: "tw:flex tw:items-center",
                              children: /* @__PURE__ */ a("span", { children: Ur(y, r) })
                            },
                            y || "unassigned"
                          )) }) })
                        }
...
), Fd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Kr = (t) => Fd(Za(t));
function qr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Ud({
  ...
  const [s, c] = N("accept"), l = So(), d = So(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = I(
    () => Kr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = I(
    () => Kr(t.acceptedText ?? ""),
    ...
    () => Kr(t.mergedText ?? ""),
    [t.mergedText]
  ), E = I(() => Za(t.contents), [t.contents]);
  if (!mi(t))
    return /* @__PURE__ */ a(qr, { html: E });
  const k = (M) => {
    c(M === "reject" || M === "merge" ? M : "accept");
  }, z = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", j = g ? [
    {
      value: "merge",
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", H = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), _ = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : H, et = () => {
    const M = o ?? "accept";
    return M === "merged" ? t.mergedText ? /* @__PURE__ */ a(qr, { html: C }) : H : _(M === "reject" ? t.rejectedResultText : t.resultText);
  }, B = (M) => p && M.value === "reject", X = (M) => {
    const O = f === M.value, W = `${d}-${M.value}`, ot = B(M);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a(
          Ka,
          {
            ...
            children: D.map((M) => B(M) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Bt, { children: [
              /* @__PURE__ */ a(Ft, { asChild: !0, children: X(M) }),
    ...
    if (e === "Resolved") {
      for (let E = o.length - 1; E >= 0; E -= 1)
        if (o[E].status === "Resolved")
          return vi(o[E].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function Yd(t) {
  ...
  } = t, c = I(() => e.filter((C) => !C.deleted), [e]), l = I(
    () => c.find((C) => C.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Hd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function hp({
  ...
  const [E, k] = N(/* @__PURE__ */ new Set()), [z, j] = N(), [D, $] = N(), P = L(
    async (O) => {
      const W = await i(O);
      return W !== void 0 && O.assignedUser !== void 0 && O.assignedUser !== "" && $(O.assignedUser), W;
    },
    [i]
  );
  q(() => {
    f && (k((O) => new Set(O).add(f)), j(f));
  }, [f]);
  const S = r.filter(
    (O) => O.comments.some((W) => !W.deleted)
  ), V = S.map((O) => ({ id: O.id })), H = L(
    (O) => {
      k((W) => new Set(W).add(O.id)), j(O.id), b == null || b(O.id);
    },
    [b]
  ), _ = L(
    (O) => {
      ...
      }), j(O), b == null || b(W ? void 0 : O);
    },
    [E, b]
  ), { listboxRef: et, activeId: B, handleKeyDown: X } = Ki({
    options: V,
    onOptionSelect: H
  }), M = L(
    (O) => {
      O.key === "Escape" ? (z && E.has(z) && (k((W) => {
        const ot = new Set(W);
        return ot.delete(z), ot;
      }), j(void 0), b == null || b(void 0)), O.preventDefault(), O.stopPropagation()) : X(O);
    },
    [z, E, X, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: S.map((O) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: O.type === "Conflict" ? /* @__PURE__ */ a(Yd, { ...W, conflictResolution: C }) : /* @__PURE__ */ a(xi, { ...W })
          },
          O.id
        );
      })
...
function Wd({ table: t }) {
  return /* @__PURE__ */ u(Le, { children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function hr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Xt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Xt.Icon, { asChild: !0, children: /* @__PURE__ */ a(Tn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function we({
  ...
  return /* @__PURE__ */ u(
    Xt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Xt.ItemIndicator, { children: /* @__PURE__ */ a(oa, { className: "tw:pointer-events-none" }) }) }),
...
function tw({
  ...
  var D;
  const [w, p] = N([]), [h, g] = N([]), [f, b] = N({}), [m, C] = N({}), E = I(() => e ?? [], [e]), k = Bn({
    data: E,
    columns: t,
    getCoreRowModel: Un(),
  ...
  let j;
  return l ? j = Array.from({ length: 10 }).map((S, V) => `skeleton-row-${V}`).map((S) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(sr, { colSpan: z.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ir, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, S)) : ((D = k.getRowModel().rows) == null ? void 0 : D.length) > 0 ? j = k.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    De,
    {
      onClick: () => s($, k),
      "data-state": $.getIsSelected() && "selected",
      children: $.getVisibleCells().map((P) => /* @__PURE__ */ a(sr, { children: yr(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    $.id
  )) : j = /* @__PURE__ */ a(De, { children: /* @__PURE__ */ a(sr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Wd, { table: k }),
    /* @__PURE__ */ u(Ha, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ya, { stickyHeader: i, children: k.getHeaderGroups().map(($) => /* @__PURE__ */ a(De, { children: $.headers.map((P) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : yr(P.column.columnDef.header, P.getContext()) }, P.id)) }, $.id)) }),
      /* @__PURE__ */ a(Wa, { children: j })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(G, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(xn, {}) })
        ] }),
...
function bp({
  ...
  return /* @__PURE__ */ u(Ie, { onOpenChange: (w) => {
    w || c(!1);
  }, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: o }),
    /* @__PURE__ */ u(Ae, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
      s && r["%webView_error_dump_copied_message%"] && /* @__PURE__ */ a(Rt, { children: r["%webView_error_dump_copied_message%"] }),
      /* @__PURE__ */ a(
        rw,
        {
          errorDetails: t,
...
function xp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Le, { children: [
    /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ u(G, { variant: "default", children: [
...
function nw(t, e, r) {
  ...
  return Io({ query: e, items: o, filterBy: "label" });
}
function yi(t) {
...
function sw(t, e, r) {
  var o;
  return yi(t) || t.key === "Shift" || t.key === "Control" || t.key === "Alt" || t.key === "Meta" ? "passed" : t.ctrlKey || t.metaKey || t.altKey ? (r.dismiss(), "ended") : t.key === "ArrowDown" || t.key === "ArrowUp" ? (or(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue") : t.key === "Enter" ? (or(t), nw(
    e.items.map((i) => ({ label: i.marker })),
    e.filter,
    e.kind === "backslash" ? "passive" : "active"
  ).length === 0 ? "continue" : (r.commit(), "ended")) : t.key === "Escape" ? (or(t), r.dismiss(), "ended") : e.kind === "backslash" && (t.key === " " || t.key === "*") ? t.key === " " && ((o = e.shouldSpaceCommit) != null && o.call(e, e.filter)) ? (or(t), r.commit(), "ended") : (r.dismiss(), "ended") : e.kind === "backslash" && t.key === "Backspace" && e.filter === "" ? (r.dismiss(), "ended") : t.key === "Backspace" || iw[e.kind].test(t.key) ? (e.kind !== "backslash" && or(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (e.kind === "selection" && or(t), r.dismiss(), "ended");
}
function rn(t, e) {
  var r;
...
function lw({
  ...
  const l = Ga(), d = an(n, "%undoButton_tooltip%"), w = an(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(qa, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(
        G,
...
const ww = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ut, { children: [
...
function uw({
  ...
  const i = F(null), s = F(null), c = F(!1), [l, d] = N(t), [w, p] = N(r), [h, g] = N(!1);
  q(() => {
    d(t);
  }, [t]), q(() => {
    w !== r && p(r);
  ...
  const f = (m) => {
    ...
    var C, E, k, z;
    m.stopPropagation(), document.activeElement === s.current && m.key === "ArrowDown" || m.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && m.key === "ArrowUp" ? ((E = s.current) == null || E.focus(), c.current = !1) : document.activeElement === i.current && m.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((z = s.current) == null || z.focus(), c.current = !1), l === "custom" && m.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Le, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: ww(t, n, r) }) }) }),
...
const pw = (t, e) => t === "f" ? /* @__PURE__ */ u(ut, { children: [
  /* @__PURE__ */ a(kn, {}),
  " ",
...
function gw({
  ...
  return /* @__PURE__ */ u(Le, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
      /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ a(je, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: pw(t, r) }) }) }),
      /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: hw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Be, { style: { zIndex: gn }, children: [
  ...
  return /* @__PURE__ */ u(
    Te,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:w-8 tw:min-w-8", children: t.marker ? /* @__PURE__ */ a("span", { className: "tw:text-xs", children: t.marker }) : /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(mw, { icon: t.icon }) }) }),
...
function Np({
  ...
  var re;
  const p = F(null), h = F(null), g = F(null), f = F(null);
  oe(() => {
    if (!f.current) return;
    const { width: T } = f.current.getBoundingClientRect();
    T > 0 && (f.current.style.width = `${T}px`);
  }, []);
  const [b, m] = N("generated"), [C, E] = N("generated"), [k, z] = N("*"), [j, D] = N("*"), [$, P] = N("f"), [S, V] = N(!1), [H, _] = N(!0), [et, B] = N(!1), X = F(!1), M = F(""), [O, W] = N(!1), [ot, Pt] = N(), [Ot, Kt] = N(), [K, it] = N(), [gt, lt] = N(), ft = F(null), Jt = F(void 0), Ct = F(0), xt = F(void 0), Et = I(
    () => ({
      ...s,
  ...
  q(() => {
    var T;
    O || (T = p.current) == null || T.focus();
  }, [$, O]);
  const yt = L(() => {
    var J, Z, st;
    const T = (J = h.current) == null ? void 0 : J.querySelector(".editor-input"), U = T == null ? void 0 : T.querySelector("span.note"), nt = (st = (Z = h.current) == null ? void 0 : Z.ownerDocument.getSelection()) == null ? void 0 : st.anchorNode;
    return !!U && !!nt && U.contains(nt);
  }, []);
  q(() => {
    var Z, st;
    let T, U, nt;
    X.current = !1, xt.current = void 0, _(!0);
    const J = e == null ? void 0 : e.at(0);
    if (J && $r("note", J)) {
      const tt = (Z = J.insert.note) == null ? void 0 : Z.caller;
      let y = "custom";
      tt === Ia ? y = "generated" : tt === Aa ? y = "hidden" : tt && (z(tt), D(tt)), m(y), E(y), P(((st = J.insert.note) == null ? void 0 : st.style) ?? "f"), T = setTimeout(() => {
        var rt, at, wt;
        (rt = p.current) == null || rt.applyUpdate([J]), (at = p.current) == null || at.selectNote(0), (wt = p.current) == null || wt.focus(), U = requestAnimationFrame(() => {
          nt = setTimeout(() => {
            var mt, Nt;
            yt() || ((mt = p.current) == null || mt.selectNote(0), (Nt = p.current) == null || Nt.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      T && clearTimeout(T), U !== void 0 && cancelAnimationFrame(U), nt !== void 0 && clearTimeout(nt);
    };
  }, [e, i, yt]);
  const Vt = L(
    (T, U, nt = !1) => {
      var Z, st, tt;
      const J = (st = (Z = p.current) == null ? void 0 : Z.getNoteOps(0)) == null ? void 0 : st.at(0);
      if (J && $r("note", J)) {
        if (J.insert.note) {
          let y;
          T === "custom" ? y = U : T === "generated" ? y = Ia : y = Aa, J.insert.note.caller = y;
        }
        r == null || r([J]), nt && d && i && ((tt = d.current) == null || tt.replaceEmbedUpdate(i, [J]));
      }
    },
    [i, r, d]
  ), R = L(() => {
    var T;
    Jt.current || (T = p.current) == null || T.commitPendingMarkerEdits(), Vt(b, k, !0), o();
  }, [b, k, o, Vt]), kt = F(R);
  oe(() => {
    kt.current = R;
  });
  const _t = F({ book: n.book, chapterNum: n.chapterNum });
  oe(() => {
    (_t.current.book !== n.book || _t.current.chapterNum !== n.chapterNum) && (_t.current = { book: n.book, chapterNum: n.chapterNum }, kt.current());
  }, [n.book, n.chapterNum]);
  const te = () => {
    var U;
    const T = (U = h.current) == null ? void 0 : U.getElementsByClassName("editor-input")[0];
    ...
    var nt, J, Z, st, tt;
    P(T);
    const U = (J = (nt = p.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : J.at(0);
    if (U && $r("note", U)) {
      U.insert.note && (U.insert.note.style = T);
      const y = (st = (Z = U.insert.note) == null ? void 0 : Z.contents) == null ? void 0 : st.ops;
      $ !== "x" && T === "x" ? y == null || y.forEach((rt) => kw(rt)) : $ === "x" && T !== "x" && (y == null || y.forEach((rt) => _w(rt))), (tt = p.current) == null || tt.applyUpdate([U, { delete: 1 }]);
    }
  }, Ke = (T) => {
    lt(T.contextMarker), B(T.canRedo);
  }, Tt = L(
    (T) => {
      var nt, J, Z, st, tt;
      const U = (J = (nt = p.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : J.at(0);
      if (U && $r("note", U)) {
        ...
        const y = (Z = U.insert.note) == null ? void 0 : Z.style, rt = (tt = (st = U.insert.note) == null ? void 0 : st.contents) == null ? void 0 : tt.ops;
        if (y || V(!1), V(
          y === "x" ? !!(rt != null && rt.every((at) => {
            var mt, Nt;
            if (!((mt = at.attributes) != null && mt.char)) return !0;
            const wt = ((Nt = at.attributes) == null ? void 0 : Nt.char).style;
          ...
          X.current = !0, M.current = JSON.stringify(U), _(!0);
          return;
        }
        _(JSON.stringify(U) === M.current), Vt(b, k);
      } else
        V(!1), _(!0);
    },
    [b, k, Vt]
    ...
    if (g.current && qt.length && T && T.rangeCount > 0) {
      const U = T.getRangeAt(0).getBoundingClientRect(), nt = g.current.getBoundingClientRect();
      Pt(U.left - nt.left), Kt(U.top - nt.top), it(U.height), W(!0);
    }
  }, [qt, g]), $t = L(
    (T, U, nt) => {
      const { anchorRect: J } = T;
      if (!w || !J) return;
      const { passive: Z, literalPrefixLanded: st } = nt;
      Ct.current += 1;
      const tt = Ct.current;
      Jt.current = {
        kind: Z ? "backslash" : "selection",
        token: tt,
        literalPrefixLanded: st,
        filter: "",
        items: U
      }, w.show(U.map(yw), J, Z).then((y) => {
        var rt, at, wt, mt, Nt, le;
        if (rn(Jt, tt), y !== void 0) {
          if (!((rt = p.current) != null && rt.getSelection())) {
            const ae = xt.current;
            ae ? (at = p.current) == null || at.setSelection(ae) : (wt = p.current) == null || wt.selectNote(0);
          }
          (mt = p.current) == null || mt.focus();
          const de = U.find((ae) => ae.marker === y);
          de && ((Nt = p.current) == null || Nt.applyMarkerMenuSelection(de, {
            trigger: "backslash",
            literalPrefixLanded: st
          }));
        } else Z || (le = p.current) == null || le.focus();
      }).catch(() => {
        var y;
        rn(Jt, tt), Z || (y = p.current) == null || y.focus();
      });
    },
    [w]
  );
  q(() => {
    const T = (U) => {
      var Z, st;
      const nt = (Z = h.current) == null ? void 0 : Z.querySelector(".editor-input");
      if (!nt || U.target !== nt) return;
      const J = (st = p.current) == null ? void 0 : st.getSelection();
      J && (xt.current = J);
    };
    ...
    var T;
    O && ((T = ft.current) == null || T.focus());
  }, [O]), q(() => {
    var nt, J;
    const T = ((nt = h.current) == null ? void 0 : nt.querySelector(".editor-input")) ?? void 0;
    if (((J = Et.view) == null ? void 0 : J.markerMode) === "editable") {
      const Z = (tt) => {
        var mt, Nt, le, de, ae;
        if (yi(tt) || !T || document.activeElement !== T) return;
        const y = Jt.current;
        if (y && w) {
          sw(tt, y, w) === "ended" && (Jt.current = void 0);
          return;
        }
        if (tt.key === "Enter" && !yt()) {
          tt.preventDefault(), tt.stopPropagation(), (mt = p.current) == null || mt.selectNote(0), (Nt = p.current) == null || Nt.focus();
          return;
        }
        if (!w || tt.key !== c) return;
        if (!yt()) {
          tt.preventDefault(), tt.stopPropagation(), (le = p.current) == null || le.selectNote(0), (de = p.current) == null || de.focus();
          return;
        }
        const rt = (ae = p.current) == null ? void 0 : ae.getMarkerMenuContext();
        if (!rt) return;
        const at = sl(Et.styleInfo ?? cl, rt);
        if (at.length === 0) return;
        const wt = !rt.hasTextSelection;
        wt || (tt.preventDefault(), tt.stopPropagation()), $t(rt, at, { passive: wt, literalPrefixLanded: wt });
      }, st = () => {
        var tt, y;
        !T || document.activeElement !== T || yt() || ((tt = p.current) == null || tt.selectNote(0), (y = p.current) == null || y.focus());
      };
      return document.addEventListener("keydown", Z, { capture: !0 }), document.addEventListener("paste", st, { capture: !0 }), () => {
        document.removeEventListener("keydown", Z, { capture: !0 }), document.removeEventListener("paste", st, { capture: !0 });
      };
    }
    const U = (Z) => {
      !O && T && document.activeElement === T && Z.key === c ? (Z.preventDefault(), ee()) : O && Z.key === "Escape" && (Z.preventDefault(), W(!1));
    };
    ...
    ee,
    c,
    (re = Et.view) == null ? void 0 : re.markerMode,
    Et.styleInfo,
    w,
    $t,
    yt
    ...
    var nt;
    const T = ((nt = h.current) == null ? void 0 : nt.querySelector(".editor-input")) ?? void 0, U = () => {
      var J, Z;
      !T || document.activeElement !== T || yt() || ((J = p.current) == null || J.selectNote(0), (Z = p.current) == null || Z.focus());
    };
    return document.addEventListener("pointerup", U), document.addEventListener("selectionchange", U), () => {
      document.removeEventListener("pointerup", U), document.removeEventListener("selectionchange", U);
    };
  }, [yt]);
  const Dt = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(qa, { children: [
          /* @__PURE__ */ a(
            lw,
            {
              onUndoClick: () => {
                var T;
                return (T = p.current) == null ? void 0 : T.undo();
              },
              onRedoClick: () => {
                var T;
                return (T = p.current) == null ? void 0 : T.redo();
              },
              canUndo: !H,
              canRedo: et,
              localizedStrings: l
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
              ...
              /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: Dt }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(ut, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ut, { children: Cw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Ep({
  ...
  const w = l ?? Us(r, void 0), p = (k, z) => {
    d == null || d(k, z, n);
  }, h = i ? r.findIndex((k) => k === i) : -1, [g, f] = N(h), b = (k, z, j) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
          k.preventDefault(), d == null || d(z, j, n);
          break;
      }
  }, m = (k) => {
    if (r.length)
  ...
  q(() => {
    var k;
    g >= 0 && g < C.current.length && ((k = C.current[g]) == null || k.focus());
  }, [g]);
  const E = i ? r.findIndex((k) => k === i) : -1;
  return q(() => {
    var k;
    E < 0 || E >= C.current.length || (k = C.current[E]) == null || k.scrollIntoView({ block: "nearest" });
  }, [E]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
          ...
          children: r.map((k, z) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Wt.Fragment, { children: [
                ...
                z < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Nr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, D)
            );
          })
        }
...
function zw({
  ...
  return /* @__PURE__ */ u(Ha, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ya, { stickyHeader: !0, children: /* @__PURE__ */ u(De, { children: [
    ...
    /* @__PURE__ */ a(Wa, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      De,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(sr, { className: o, children: Sw(c.text) })
        ]
      },
...
const Rw = (t) => {
...
}, ia = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
  /* @__PURE__ */ u(
    Ft,
    {
  ...
  return e ? e[1] : "";
}, Mw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Op = Object.freeze([
...
function $p({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), b = ge(r, "%webView_inventory_unapproved%"), m = ge(r, "%webView_inventory_unknown%"), C = ge(r, "%webView_inventory_scope_currentBook%"), E = ge(r, "%webView_inventory_scope_chapter%"), k = ge(r, "%webView_inventory_scope_verse%"), z = ge(r, "%webView_inventory_filter_text%"), j = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), D = ge(r, "%webView_inventory_no_results%"), [$, P] = N(!1), [S, V] = N("all"), [H, _] = N(""), [et, B] = N([]), X = I(() => {
    const K = t ?? [];
    return K.length === 0 ? [] : $w(K, n, i);
  }, [t, n, i]), M = I(() => {
    if ($) return X;
    const K = [];
    return X.forEach((it) => {
      const gt = it.items[0], lt = K.find(
        (ft) => ft.items[0] === gt
      );
      lt ? (lt.count += it.count, lt.occurrences = lt.occurrences.concat(it.occurrences)) : K.push({
        items: [gt],
        count: it.count,
  ...
  }, [$, X]), O = I(() => M.length === 0 ? [] : Ow(M, S, H), [M, S, H]), W = I(() => {
    var gt, lt;
    if (!$) return l;
  ...
  q(() => {
    O.length === 0 ? B([]) : O.length === 1 && B(O[0].items);
  }, [O]);
  const ot = (K, it) => {
    it.setRowSelection(() => {
      const lt = {};
    ...
    if (M.length === 0 || et.length === 0) return [];
    const K = M.filter((it) => Ks(
      $ ? it.items : [it.items[0]],
      et
    ));
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        ur,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(gr, { children: [
              ...
              /* @__PURE__ */ a(we, { value: "unknown", children: m })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(ur, { onValueChange: (K) => Pt(K), defaultValue: s, children: [
        /* @__PURE__ */ a(hr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(pr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(gr, { children: [
          /* @__PURE__ */ a(we, { value: "book", children: C }),
          /* @__PURE__ */ a(we, { value: "chapter", children: E }),
          /* @__PURE__ */ a(we, { value: "verse", children: k })
        ] })
      ] }),
      /* @__PURE__ */ a(
        ra,
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Bt, { children: [
        /* @__PURE__ */ a(Ft, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Rt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? j })
        ] }) }),
        /* @__PURE__ */ a(Ut, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const Iw = "16rem", Aw = "3rem", _i = Wt.createContext(void 0);
function sa() {
  const t = Wt.useContext(_i);
  if (!t)
...
function Pw({
  ...
  const [l, d] = Wt.useState(t), w = e ?? l, p = Wt.useCallback(
    ...
    [r, w]
  ), h = Wt.useCallback(() => p((k) => !k), [p]), g = w ? "expanded" : "collapsed", m = be() === "ltr" ? s : s === "primary" ? "secondary" : "primary", C = Wt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function Ip({ className: t, onClick: e, ...r }) {
    ...
    Vw,
    {
      ...
      children: /* @__PURE__ */ u(jw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(Bw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Fw, { children: /* @__PURE__ */ a(
            Kw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const ze = "scrBook", Gw = "scrRef", We = "source", Hw = "details", Yw = "Scripture Reference", Ww = "Scripture Book", Ni = "Type", Xw = "Details";
function Jw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? bt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === ze ? _e(n.start) : void 0;
      },
...
}, ln = (t) => `${Zw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wp({
  sources: t,
  ...
  const [d, w] = N([]), [p, h] = N([{ id: ze, desc: !1 }]), [g, f] = N({}), b = I(
  ...
  q(() => {
    if (c) {
      const S = C.getSelectedRowModel().rowsById, V = Object.keys(S);
      if (V.length === 1) {
        const H = b.find((_) => ln(_) === V[0]) || void 0;
        H && c(H);
      }
    }
  }, [g, b, c, C]);
  const E = n ?? Ww, k = i ?? Ni, z = [
  ...
  }, $ = (S, V) => S.getIsGrouped() ? "" : v("banded-row", V % 2 === 0 ? "even" : "odd"), P = (S, V, H) => {
    if (!((S == null ? void 0 : S.length) === 0 || V.depth < H.column.getGroupedIndex())) {
      if (V.getIsGrouped())
        switch (V.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(Xd, { children: z.map((S) => /* @__PURE__ */ a(we, { value: JSON.stringify(S.value), children: S.label }, S.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Ha, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Ya, { children: C.getHeaderGroups().map((S) => /* @__PURE__ */ a(De, { children: S.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(Wa, { children: C.getRowModel().rows.map((S, V) => {
        const H = be();
        return /* @__PURE__ */ a(
          De,
          {
            ...
            children: S.getVisibleCells().map((_) => {
              if (!(_.getIsPlaceholder() || _.column.columnDef.enableGrouping && !_.getIsGrouped() && (_.column.columnDef.id !== We || !r)))
                return /* @__PURE__ */ a(
                  sr,
                  {
                    className: v(
                    ...
                    children: _.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        type: "button",
                        children: [
                          S.getIsExpanded() && /* @__PURE__ */ a(dr, {}),
                          !S.getIsExpanded() && (H === "ltr" ? /* @__PURE__ */ a(Ra, {}) : /* @__PURE__ */ a(za, {})),
                          " ",
...
const Ei = (t, e, r) => go(t, e).every((o) => r.includes(o));
function Qw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [b, m] = N(!1), [C, E] = N(""), k = F(void 0), z = F(!1), j = I(
    () => Ci(t),
    [t]
  ), D = I(() => {
    if (!C.trim()) {
    ...
    (_, et = !1) => {
      ...
      const B = j.findIndex((ot) => ot === k.current), X = j.findIndex((ot) => ot === _);
      if (B === -1 || X === -1) return;
      const [M, O] = [
        Math.min(B, X),
        Math.max(B, X)
      ], W = j.slice(M, O + 1).map((ot) => ot);
      r(
        e.includes(_) ? e.filter((ot) => !W.includes(ot)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, r, j]
  ), P = (_) => {
    ...
    _.preventDefault(), $(et, _.shiftKey);
  }, V = () => {
    r(j.map((_) => _));
  }, H = () => {
    r([]);
                ...
                Object.values(ht).map((_, et) => {
                  ...
                  if (B.length !== 0)
                    return /* @__PURE__ */ u(aa, { children: [
                      ...
                      et < Object.values(ht).length - 1 && /* @__PURE__ */ a(fn, {})
                    ] }, _);
                })
              ] })
            ]
...
function eu({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(ht).map((l) => /* @__PURE__ */ a(
      tu,
      {
        section: l,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === _a ? _a : dn
      ).map((l) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: Re(l, n) }, l)),
...
function Jp({
  ...
  const z = It(
    s,
    "%webView_scope_selector_selected_text%"
  ), j = It(s, "%webView_scope_selector_verse%"), D = It(s, "%webView_scope_selector_chapter%"), $ = It(s, "%webView_scope_selector_book%"), P = It(
    s,
    "%webView_scope_selector_current_verse%"
  ), S = It(
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = It(s, "%webView_scope_selector_current_book%"), H = It(s, "%webView_scope_selector_choose_books%"), _ = It(s, "%webView_scope_selector_scope%"), et = It(s, "%webView_scope_selector_select_books%"), B = It(s, "%webView_scope_selector_range%"), X = It(s, "%webView_scope_selector_select_range%"), M = It(s, "%webView_scope_selector_range_start%"), O = It(s, "%webView_scope_selector_range_end%"), W = It(s, "%webView_scope_selector_ok%"), ot = It(s, "%webView_scope_selector_cancel%"), Pt = It(s, "%webView_scope_selector_navigate%"), Ot = (A) => {
    if (!f) return;
  ...
  ], K = (A, Q, Zt = !1) => /* @__PURE__ */ u(ut, { children: [
    A,
    Q && !Zt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Q
    ] })
  ] }), it = e ? Kt.filter((A) => e.includes(A.value)) : Kt, gt = f ?? wa, lt = w ?? gt, ft = p ?? gt, Jt = () => {
  }, Ct = F(null), xt = F(null), Et = F(!1), qt = F(null), yt = F(!1), [Vt, R] = N(void 0), kt = F(!1), _t = F(!1), te = F(null), Ue = L((A) => {
    if (A) {
      R("start"), kt.current = !1;
      return;
    }
    R((Q) => Q === "start" ? void 0 : Q), kt.current && (kt.current = !1, requestAnimationFrame(() => {
      var Zt;
      const Q = (Zt = Ct.current) == null ? void 0 : Zt.querySelector("button");
      Q == null || Q.click();
    }));
  }, []), se = L((A) => {
    if (A) {
    ...
    [r, n, f, i]
  ), ee = it.find((A) => A.value === t), $t = () => t === "selectedBooks" && n.length > 0 ? n.map((A) => A.toUpperCase()).join(", ") : t === "range" ? qs(lt, ft, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ee ? K(ee.label, ee.scrRefSuffix) : t, Dt = it.filter(
    (A) => A.value !== "selectedBooks" && A.value !== "range"
  ), re = it.find((A) => A.value === "selectedBooks"), T = it.find((A) => A.value === "range"), [U, nt] = N(!1), [J, Z] = N(void 0), [st, tt] = N(void 0), [y, rt] = N(void 0), [at, wt] = N(void 0), [mt, Nt] = N([]), le = d === "dropdown" && J === "selectedBooks", de = /* @__PURE__ */ a(
    eu,
    {
      availableBookInfo: o,
      selectedBookIds: le ? mt : n,
      onChangeSelectedBookIds: le ? Nt : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), ae = Vt === "end", Dr = Vt === "start", rr = "tw:text-muted-foreground", qe = d === "dropdown" && J === "range", x = qe ? rt : ce, ct = qe ? wt : g ? Ke : Jt, Lt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-start", className: v(ae && rr), children: M }),
      /* @__PURE__ */ a(
        pa,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Ct, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { htmlFor: "scope-range-end", className: v(Dr && rr), children: O }),
      /* @__PURE__ */ a(
        pa,
        {
          id: "scope-range-end",
          ...
          localizedStrings: m,
          getEndVerse: C,
          disableReferencesUpTo: qe ? y ?? lt : lt,
          onOpenChange: se,
          onCloseAutoFocus: (A) => {
            var Q;
            _t.current && (_t.current = !1, A.preventDefault(), (Q = te.current) == null || Q.focus());
          },
          className: v(Dr && rr),
          modal: !0,
          align: "start"
  ...
  const [Mt, St] = N(null), [zt, vt] = N(null), [Gt, he] = N(null), He = 200, [$i, Ii] = N(!1);
  q(() => {
    if (!Gt || typeof ResizeObserver > "u") return;
    const A = new ResizeObserver(([Q]) => {
      Ii(Q.contentRect.width < He);
    });
    return A.observe(Gt), () => A.disconnect();
  }, [Gt]);
  const fo = L(
    (A) => {
      tt(A), rt(lt), wt(ft), Nt(n), nt(!1), Z(A);
    },
    [lt, ft, n]
  ), mo = L(() => {
    st !== void 0 && (st === "range" ? (y && (h == null || h(y)), at && (g == null || g(at))) : st === "selectedBooks" && i(mt), Tt(st), Z(void 0), tt(void 0));
  }, [
    st,
    y,
    at,
    ...
    A || (Z(void 0), tt(void 0));
  }, []), vo = L((A) => {
    var Q;
    A.preventDefault(), (Q = Ge.current) == null || Q.focus();
  }, []), bo = (A) => t === A ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Oe, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !E && /* @__PURE__ */ a(Rt, { children: _ }),
      d === "dropdown" ? /* @__PURE__ */ u(Le, { open: U, onOpenChange: nt, children: [
        ...
        /* @__PURE__ */ a(
          Be,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ca, { container: Gt, children: [
              Dt.map(({ value: A, label: Q, dropdownLabel: Zt, scrRefSuffix: mr, id: Ai }) => /* @__PURE__ */ u(
                Xe,
                {
                  ref: Se(A),
                ...
                /* @__PURE__ */ a(
                  Xe,
                  {
                    ...
                    onSelect: (A) => {
                      ...
                      yt.current || (Zt = (Q = xt.current) == null ? void 0 : Q.querySelector("button")) == null || Zt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (A) => {
                          ...
                          Q != null && Q.closest("button") && (Et.current = !0, requestAnimationFrame(() => {
                            Et.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          pa,
                          {
                            ...
                            onCloseAutoFocus: (A) => {
                              var Q;
                              A.preventDefault(), (Q = qt.current) == null || Q.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(ut, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _e(f ?? wa, "id") }),
                              /* @__PURE__ */ a(dr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ka,
        {
          ...
          children: it.map(({ value: A, label: Q, scrRefSuffix: Zt, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: A, id: mr }),
            /* @__PURE__ */ a(Rt, { htmlFor: mr, children: K(Q, Zt) })
          ] }, mr))
        }
      )
    ] }),
    d === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Rt, { children: et }),
      de
    ] }),
    d === "radio" && t === "range" && Lt,
    d === "dropdown" && re && /* @__PURE__ */ a(Na, { open: J === "selectedBooks", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: vt,
        onCloseAutoFocus: vo,
        onEscapeKeyDown: (A) => {
          zt != null && zt.querySelector('[data-state="open"]') && A.preventDefault();
        },
        children: /* @__PURE__ */ u(ca, { container: zt, children: [
          /* @__PURE__ */ a(Ea, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ta, { children: H }) }),
          de,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(G, { onClick: mo, children: W })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && T && /* @__PURE__ */ a(Na, { open: J === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Ca,
      {
        ref: St,
        onCloseAutoFocus: vo,
        ...
        children: /* @__PURE__ */ u(ca, { container: Mt, children: [
          /* @__PURE__ */ a(Ea, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ta, { children: X }) }),
          Lt,
          /* @__PURE__ */ u(xo, { children: [
            /* @__PURE__ */ a(G, { variant: "outline", onClick: () => Mr(!1), children: ot }),
            /* @__PURE__ */ a(G, { ref: te, onClick: mo, children: W })
          ] })
        ] })
      }
    ) })
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          gr,
          {
            ...
            style: { zIndex: tr },
            children: t.map((w) => /* @__PURE__ */ a(we, { value: `${w}`, children: l[Co(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ba({
  ...
  return /* @__PURE__ */ u(Le, { variant: i, children: [
    /* @__PURE__ */ a(je, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Is, {}) }) }),
    /* @__PURE__ */ a(Be, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(aa, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(jt, { children: Si(e.groups, e.items, l, t) }) }),
...
const Ri = Wt.forwardRef(({ className: t, ...e }, r) => {
  const o = be();
  return /* @__PURE__ */ a(
    pe.Root,
    {
...
Ri.displayName = pe.List.displayName;
const Di = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.List,
  {
    ref: r,
    className: v(
...
Di.displayName = pe.List.displayName;
...
)), Mi = Wt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  pe.Content,
  {
    ref: r,
    className: v(
...
Mi.displayName = pe.Content.displayName;
function oh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ri, { children: [
      /* @__PURE__ */ a(Di, { children: t.map((c) => /* @__PURE__ */ a(ou, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (ll(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = l.current) == null || C.focus(), br(l, [h, g]);
        break;
    }
  }), q(() => {
    ...
    return /* @__PURE__ */ a(nu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(iu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: tr },
          children: /* @__PURE__ */ a(jt, { children: Oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function sh({
  ...
  const d = fu(
    ...
    var C, E, k, z, j, D;
    const m = b !== f ? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E[b]) ?? ((z = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : z.en) : void 0;
    return m ? `${(j = t[f]) == null ? void 0 : j.autonym} (${m})` : (D = t[f]) == null ? void 0 : D.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: v("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Rt, { className: "tw:font-normal tw:text-muted-foreground", children: Je(d, {
...
function lh({
  ...
  return /* @__PURE__ */ u(Pe, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
...
function vu({ item: t, createLabel: e, createComplexLabel: r }) {
...
function wh({
  ...
  const c = t ? Eo(r, { key: o }).join("") : "", {
    ...
    showArrow: p
  } = xu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
...
function hh({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function Vh({
  ...
  const n = be();
  return /* @__PURE__ */ u(_u, { "data-slot": "drawer-portal", children: [
    /* @__PURE__ */ a(Nu, {}),
    /* @__PURE__ */ u(
      Fe.Content,
      {
...
function Yh({
  ...
  return /* @__PURE__ */ a(
    pe.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: v("pr-twp", Cu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function eg(t) {
  const e = I(() => Gs(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Ad as COMMENT_LIST_ELEMENT_ID,
  sp as COMMENT_LIST_STRING_KEYS,
  op as CONFLICT_NOTE_STRING_KEYS,
  ...
  Sh as ContextMenuSubTrigger,
  yh as ContextMenuTrigger,
  tw as DataTable,
  wh as DestructiveKeyConfirmation,
  Na as Dialog,
  ig as DialogClose,
  Ca as DialogContent,
  ...
  vp as ERROR_POPOVER_STRING_KEYS,
  ...
  rn as clearPaletteSessionIfCurrent,
  v as cn,
  nw as filterAndRankPaletteItems,
  ...
  sw as handleMarkerPaletteSessionKeyDown,
  Sp as inventoryCountColumn,
  Tp as inventoryItemColumn,
  zp as inventoryStatusColumn,
  Ga as isMacOs,
  Sg as isWindows,
  yw as markerMenuItemToPaletteItem,
  Su as pickTabIconUrl,
  Dg as sonner,
  Jh as useEvent,
  Zh as useEventAsync,
