...
import { c as v, g as ue, a as xr, C as _e, u as $o, T as Dt, b as Mt, d as Ot, e as $t, A as ie, P as De, f as We, B as H, h as Me, i as Oe, j as $e, k as ye, x as Xi, l as Ji, m as Zi, I as Qi, n as so, r as fe, X as ts, o as Cn, p as la, q as da, L as Nt, R as co, s as ea, D as Ba, t as Fa, v as Ua, w as Ka, y as En, z as qr, E as lo, F as Tn, G as wo, H as qe, J as _r, K as Ie, M as Pe, N as Ae, S as Nr, O as er, Q as es, U as Tr, V as Ge, W as Se, Z as Ye, Y as Ee, _ as rr, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as Sn, a4 as rs, a5 as as, a6 as os, a7 as Ha, a8 as zn, a9 as wa, aa as Rn, ab as ns, ac as is, ad as ss, ae as cs, af as Dn, ag as Mn, ah as go, ai as ls, aj as On, ak as Ca, al as Io, am as Ea, an as ds, ao as ws, ap as us, aq as ps, ar as hs, as as Sr, at as fo, au as gs, av as fs } from "./resizable-CE8CrItT.js";
import { aw as Eg, ax as Tg, ay as Sg, az as zg, aA as Rg, aB as Dg, aC as Mg, aD as Og, aE as $g, aF as Ig, aG as Pg, aH as Ag, aI as Vg, aJ as jg, aK as Lg, aL as Bg, aM as Fg, aN as Ug, aO as Kg, aP as Hg, aQ as qg, aR as Gg, aS as Wg, aT as Yg } from "./resizable-CE8CrItT.js";
import { jsx as a, jsxs as u, Fragment as nt } from "react/jsx-runtime";
import { Canon as Rt } from "@sillsdev/scripture";
import { Check as ze, Clock as Po, ChevronsLeft as Ao, ChevronsRight as Vo, ChevronLeft as qa, ChevronRight as Ga, ArrowLeft as ms, ArrowRight as vs, ChevronDown as nr, BoldIcon as bs, ItalicIcon as xs, X as mo, AtSign as $n, Pencil as ys, Trash2 as ks, ArrowUp as In, MoreHorizontal as _s, MailOpen as Ns, Mail as Cs, ChevronUp as Es, FilterIcon as Ts, ArrowLeftIcon as Ss, ChevronLeftIcon as zs, ChevronRightIcon as Rs, ArrowRightIcon as Ds, Copy as Pn, Filter as Ms, User as Os, Link as $s, CircleHelp as Is, Undo as Ps, Redo as As, SquareX as An, FunctionSquare as Vn, SquareSigma as jn, Ban as Vs, AlertCircle as Wa, CircleCheckIcon as js, CircleXIcon as Ls, CircleHelpIcon as Bs, ArrowUpIcon as Fs, ArrowDownIcon as Us, ScrollText as Ks, ChevronsUpDown as Hs, MenuIcon as qs, Menu as Gs, EllipsisVertical as Ws, MoreVertical as Ys } from "lucide-react";
...
import Wt, { useRef as F, useMemo as O, createContext as ua, useContext as bo, useState as k, useEffect as G, useCallback as j, useImperativeHandle as oc, useLayoutEffect as Yt, Component as nc, createElement as Fo, Suspense as ic, forwardRef as Bn, useId as Uo, Fragment as pa } from "react";
...
function Nl({
  ...
  return /* @__PURE__ */ u(De, { open: b, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ a(Me, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(ye, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      _e,
      {
        onSelect: () => T(y),
...
function Ra({
  ...
  const V = fe(), A = yl(), z = C ?? A, [P, U] = k(!1), [L, Y] = k(""), [R, X] = k(""), [_, S] = k("books"), [K, ot] = k(void 0), [Q, dt] = k(
    ...
    () => Rl(Tt, jt),
    [Tt, jt]
  ), et = rt.has(t.book), wt = O(() => R.trim() ? eo(
    I.filter((x) => so(x, R, i))
  ) : ht ? te : ce, [
    ce,
    te,
  ...
  const { otLong: je, ntLong: Je, dcLong: ur, extraLong: pr } = {
    ...
    () => Tl(R),
    [R]
  ), hr = O(() => !w || !E || !E.chapterNum || !Ir ? !1 : w(E.book, E.chapterNum) > 0, [w, E, Ir]), Pr = _ === "books" && !it && !R.trim() && rt.size > 0, gr = j(
    (x) => p ? Jo(x, p) : !1,
    [p]
  ), fr = j(
    (x) => (J) => p ? Sl(x, J, p) : !1,
  ...
  return /* @__PURE__ */ u(De, { open: N, onOpenChange: $, ...y, children: [
    ...
    /* @__PURE__ */ a(
      Me,
      {
        ...
        style: i,
        children: /* @__PURE__ */ u(Oe, { children: [
...
function Il({ initialConfig: t, children: e }) {
  const r = O(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Ol(null, o), w = Kn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
function Kl() {
  return function(t) {
    const [e] = ve(), r = O(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = F(o);
    return Fl(() => {
...
const Oa = Rc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class fi extends Xa {
  $config() {
...
}, name: "@lexical/extension/InitialState", nodes: [Dc, qn, Mc, Oc, Hn] }), cn = Symbol.for("@lexical/extension/LexicalBuilder");
function ln() {
}
function hd(t) {
  throw t;
...
function Id(t, e) {
  ...
  return u(nt, { children: [a(Od, { editor: n, ...o, ref: e }), r != null && a(Pd, { editor: n, content: r })] });
}
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(De, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Me,
        {
          ...
          children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a($e, { children: t.map((m) => /* @__PURE__ */ a(
            _e,
            {
              onSelect: () => {
                l(m || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (m) => {
          m.key === "Escape" ? (m.preventDefault(), m.stopPropagation(), r()) : Mo(m) && (m.preventDefault(), m.stopPropagation(), re(i) && g());
        },
        onKeyDown: (m) => {
...
function gn({
  ...
  }, [t.date, r]), m = O(() => t.user, [t.user]), T = O(
    () => t.user.split(" ").map((C) => C[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), y = O(() => vo(t.contents), [t.contents]), N = O(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), $ = !!t.conflictResolutionAction && !N, B = O(() => {
    if (o && c)
      return /* @__PURE__ */ u(nt, { children: [
        /* @__PURE__ */ u(
          qe,
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), g()) : Mo(C) && (C.preventDefault(), C.stopPropagation(), re(w) && f());
              },
              onKeyDown: (C) => {
          ...
          !l && /* @__PURE__ */ u(nt, { children: [
            ...
            $ ? (
              ...
              /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: Oi(t.conflictResolutionAction) === "merged" ? r["%conflict_note_outcome_combined%"] ?? "Combined both changes." : r["%conflict_note_outcome_used_other%"] ?? "Used the other change instead of the current text." })
            ) : /* @__PURE__ */ a(
              "div",
              {
                className: v(
...
function Ii({
  ...
  const jt = O(() => Tt[0], [Tt]), ce = F(null), te = F(void 0), I = j(() => {
    var M;
    (M = te.current) == null || M.call(te), Y(fn);
  }, []), Z = j(() => {
    const M = !gt;
    Ct(M), yt(!M), f == null || f(l, M);
  }, [gt, f, l]);
  G(() => {
    Q(!1);
  }, [o]), G(() => {
    if (o && !gt && !Vt) {
      ...
      return Jt.current = M, () => clearTimeout(M);
    }
  ...
  }, [i, r]), wt = O(() => Tt.slice(1), [Tt]), E = O(() => wt.length ?? 0, [wt.length]), bt = O(() => E > 0, [E]), ut = O(() => ot || E <= 2 ? wt : wt.slice(-2), [wt, E, ot]), ft = O(() => ot || E <= 2 ? 0 : E - 2, [E, ot]), Pt = O(
  ...
  const Bt = j(
    ...
    async (M) => {
      const mt = re(L) ? sa(L) : void 0, Et = M.status ? M.assignedUser : R ?? M.assignedUser, ee = await p({
        ...M,
        contents: mt,
        assignedUser: Et
      });
          ...
          o && /* @__PURE__ */ u(nt, { children: [
            ...
            ft > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (M) => {
                  (M.key === "Enter" || M.key === " ") && (M.preventDefault(), M.stopPropagation(), Q(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            ut.map((M) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              gn,
              {
                comment: M,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: st,
                canEditOrDelete: (!dt && oe.get(M.id)) ?? !1
              }
            ) }, M.id)),
            m !== !1 && (!dt || re(L)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (M) => {
                  Mo(M) && (M.preventDefault(), M.stopPropagation(), (re(L) || R !== void 0 && R !== _) && Bt());
                },
                onKeyDown: (M) => {
                  Do(M), (M.key === "Enter" || M.key === " ") && M.stopPropagation();
                },
                    ...
                    /* @__PURE__ */ u(De, { open: q, onOpenChange: it, children: [
                      ...
                      /* @__PURE__ */ a(
                        Me,
                        {
                          ...
                          align: "end",
                          onKeyDown: (M) => {
                            M.key === "Escape" && (M.stopPropagation(), it(!1));
                          },
                          children: /* @__PURE__ */ a(Oe, { children: /* @__PURE__ */ a($e, { children: b == null ? void 0 : b.map((M) => /* @__PURE__ */ a(
                            _e,
                            {
                              onSelect: () => {
                                X(M !== i ? M : void 0), ct.current = "user-selected", S(void 0), it(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function rw({
  ...
  const [s, c] = k("accept"), l = Uo(), d = Uo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, b = O(
    () => Qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), m = O(
    () => Qr(t.acceptedText ?? ""),
      ...
      !w && !h && /* @__PURE__ */ u(nt, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: C.map((_) => R(_) ? /* @__PURE__ */ a(Dt, { delayDuration: 0, children: /* @__PURE__ */ u(Mt, { children: [
              /* @__PURE__ */ a(Ot, { asChild: !0, children: X(_) }),
    ...
    if (e === "Resolved") {
      for (let y = o.length - 1; y >= 0; y -= 1)
        if (o[y].status === "Resolved")
          return Oi(o[y].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function sw(t) {
  ...
  } = t, c = O(() => e.filter((T) => !T.deleted), [e]), l = O(
...
function pw({
  ...
  var C;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, T] = k({}), y = O(() => e ?? [], [e]), N = ri({
    data: y,
    columns: t,
    getCoreRowModel: oi(),
...
function $p({
  ...
  return /* @__PURE__ */ u(De, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Me, { id: i, className: v("tw:min-w-80 tw:max-w-96", n), children: [
...
function Ip({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ u(H, { variant: "default", children: [
      /* @__PURE__ */ a(Ms, { size: 16, className: "tw:mr-2 tw:h-4 tw:w-4" }),
      e,
...
function kw({
  ...
  return /* @__PURE__ */ u(Ie, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: yw(t, n, r) }) }) }),
...
function Cw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(Dt, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a(Ot, { asChild: !0, children: /* @__PURE__ */ a(Pe, { asChild: !0, children: /* @__PURE__ */ a(H, { variant: "outline", className: "tw:h-6", children: _w(t, r) }) }) }),
...
function zw({
  ...
  return /* @__PURE__ */ u(Oe, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ a(
      la,
      {
...
function jp({
  ...
  const [f, b] = k("generated"), [m, T] = k("generated"), [y, N] = k("*"), [$, B] = k("*"), [C, V] = k("f"), [A, z] = k(!1), [P, U] = k(!0), [L, Y] = k(!1), R = F(!1), X = F(""), [_, S] = k(!1), [K, ot] = k(), [Q, dt] = k(), [st, q] = k(), [it, pt] = k(), ht = F(null), vt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const Jt = () => {
    ...
    if (Z && Br("note", Z)) {
      ...
      C !== "x" && I === "x" ? ut == null || ut.forEach((ft) => Dw(ft)) : C === "x" && I !== "x" && (ut == null || ut.forEach((ft) => Mw(ft))), (bt = w.current) == null || bt.applyUpdate([Z, { delete: 1 }]);
    }
  }, Tt = (I) => {
...
function Yp({
  ...
  const g = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), b = we(r, "%webView_inventory_unapproved%"), m = we(r, "%webView_inventory_unknown%"), T = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), N = we(r, "%webView_inventory_scope_verse%"), $ = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = we(r, "%webView_inventory_no_results%"), [V, A] = k(!1), [z, P] = k("all"), [U, L] = k(""), [Y, R] = k([]), X = O(() => {
    const q = t ?? [];
  ...
  }, [V, X]), S = O(() => _.length === 0 ? [] : Fw(_, z, U), [_, z, U]), K = O(() => {
    var pt, ht;
    if (!V) return l;
...
function dh({
  ...
  const [d, w] = k([]), [p, h] = k([{ id: Ce, desc: !1 }]), [g, f] = k({}), b = O(
...
function cu({
  ...
  }, [m, T] = k(!1), [y, N] = k(""), $ = F(void 0), B = F(!1), C = O(
    () => Mn(t),
    [t]
  ), V = O(() => {
    if (!y.trim()) {
...
function wu({
  ...
  const s = go(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    H,
    {
      ...
      onClick: () => o(t),
      className: v(
        On(e, t, r) && !s && "tw:bg-primary tw:text-primary-foreground tw:hover:bg-primary/70 tw:hover:text-primary-foreground"
      ),
      disabled: s,
      children: ls(
        t,
...
function uu({
  ...
  const s = o["%webView_book_selector_more%"], c = O(
    () => Mn(t),
    [t]
  ), l = j(
    (d) => {
      ...
      r(
        On(c, d, e) ? e.filter((p) => !w.includes(p)) : [.../* @__PURE__ */ new Set([...e, ...w])]
      );
    },
    [e, r, c]
  );
...
function uh({
  ...
  ), ut = pt.find((D) => D.value === "selectedBooks"), ft = pt.find((D) => D.value === "range"), [Pt, Lt] = k(!1), [Bt, qt] = k(void 0), [Zt, M] = k(void 0), [mt, Et] = k(void 0), [ee, je] = k(void 0), [Je, ur] = k([]), pr = w === "dropdown" && Bt === "selectedBooks", Dr = /* @__PURE__ */ a(
    uu,
    {
      availableBookInfo: o,
  ...
  ), Mr = Qt === "end", Or = Qt === "start", Ze = "tw:text-muted-foreground", Le = w === "dropdown" && Bt === "range", $r = Le ? Et : Z, Ir = Le ? je : f ? rt : gt, hr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(Mr && Ze), children: S }),
      /* @__PURE__ */ a(
        Ra,
        {
  ...
  const Vr = j(
    (D) => {
      M(D), Et(vt), je(At), ur(n), Lt(!1), qt(D);
    },
    [vt, At, n]
  ), jr = j(() => {
    Zt !== void 0 && (Zt === "range" ? (mt && (g == null || g(mt)), ee && (f == null || f(ee))) : Zt === "selectedBooks" && i(Je), et(Zt), qt(void 0), M(void 0));
  }, [
    Zt,
    mt,
    ee,
...
function Nh({
  ...
  return /* @__PURE__ */ u(Oe, { id: i, className: v("pr-twp", n), shouldFilter: !1, children: [
...
function Ou({ item: t, createLabel: e, createComplexLabel: r }) {
...
function yg(t) {
  const e = O(() => ac(t).slice().sort().join(" "), [t]);
