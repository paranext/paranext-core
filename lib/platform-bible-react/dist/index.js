...
import c, { forwardRef as Lt, useCallback as tt, useState as B, useRef as Z, useEffect as dt, useLayoutEffect as Xe, useMemo as Q, Fragment as Yn } from "react";
...
const Jt = M.Root, ye = M.Trigger, tn = M.Group, Mr = M.Portal, Vr = M.Sub, Ko = M.RadioGroup, en = c.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  M.SubTrigger,
  {
    ref: o,
    className: d(
...
function qr({
  ...
  return /* @__PURE__ */ r("div", { className: d("tw-flex tw-flex-wrap tw-items-start tw-justify-start tw-self-stretch"), children: i.map((s) => /* @__PURE__ */ r(
    "div",
    {
      className: d(
...
const ea = ft(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? St : "button", { className: d(ea({ variant: e, size: n, className: t })), ref: i, ...o })
);
I.displayName = "Button";
const na = ft(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: d("pr-twp", na(), t), ...e }));
      ...
      I,
      {
        ...
        children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: d("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: i ? s(i) : u })
          ] }),
...
function ca({ table: t }) {
  return /* @__PURE__ */ l(Jt, { children: [
    /* @__PURE__ */ r(Un, { asChild: !0, children: /* @__PURE__ */ l(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function ba({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Wt, { stickyHeader: i, children: [
...
const $t = Lt(({ className: t, ...e }, n) => /* @__PURE__ */ r(tr, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      children: t ? /* @__PURE__ */ r($t, { size: 15 }) : /* @__PURE__ */ l(kt, { children: [
        /* @__PURE__ */ r(er, { size: 25, className: d("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function os({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Rr, { options: o, children: e }) });
}
const va = Lt((t, e) => /* @__PURE__ */ l(
  I,
  {
    ref: e,
...
function ya({ id: t, versionHistory: e }) {
  ...
  return /* @__PURE__ */ l("div", { id: t, children: [
    ...
    /* @__PURE__ */ r("ul", { className: "tw-list-disc tw-pl-5 tw-pr-4 tw-text-xs tw-text-gray-600", children: (n ? w : w.slice(0, 5)).map((s) => /* @__PURE__ */ l("div", { className: "tw-mt-3 tw-flex tw-justify-between", children: [
...
function ka({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: d("pr-twp", Na({ variant: e }), t), ...n });
}
function Ca({
  entries: t,
  ...
  return /* @__PURE__ */ r("div", { className: u, children: /* @__PURE__ */ l(pn, { open: m, onOpenChange: f, children: [
    ...
    /* @__PURE__ */ r(Te, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ze, { children: [
...
function ls({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var g;
      return /* @__PURE__ */ l(ka, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          I,
          {
            variant: "ghost",
...
function Sa({
  ...
  return /* @__PURE__ */ l(Wt, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Qt, { children: i.length > 0 && i.map((w) => /* @__PURE__ */ l(
      wt,
      {
        onClick: () => {
          e(w.reference);
...
const te = (t) => t === "asc" ? /* @__PURE__ */ r(lr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(cr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(pr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), cs = (t) => ({
  accessorKey: "item",
  ...
  accessorKey: "status",
  header: ({ column: i }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ l(I, { variant: "ghost", onClick: () => i.toggleSorting(void 0), children: [
    t,
    te(i.getIsSorted())
  ] }) }),
  cell: ({ row: i }) => {
...
function hs({
  ...
  const f = at(n, "%webView_inventory_all%"), g = at(n, "%webView_inventory_approved%"), h = at(n, "%webView_inventory_unapproved%"), v = at(n, "%webView_inventory_unknown%"), x = at(n, "%webView_inventory_scope_currentBook%"), y = at(n, "%webView_inventory_scope_chapter%"), N = at(n, "%webView_inventory_scope_verse%"), k = at(n, "%webView_inventory_filter_text%"), A = at(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, ot] = B(!1), [rt, zt] = B("all"), [b, T] = B(""), [K, P] = B([]), Et = Q(() => s ? a instanceof RegExp ? Ma(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), lt = Q(() => {
    if (j) return Et;
    const R = [];
    return Et.forEach((H) => {
  ...
  }, [j, Et]), C = Q(() => Ia(lt, rt, b), [lt, rt, b]), z = Q(() => {
    var st, ct;
    if (!j) return m;
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(xt, { onValueChange: (R) => G(R), defaultValue: p, children: [
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = ne(), m = /* @__PURE__ */ r(
      p,
      {
        ...
        "data-size": a,
        "data-active": e,
        className: d(Ga({ variant: n, size: a }), i),
        ...w
      }
    );
...
function fs({
  ...
  }, rt = (b, T) => b.getIsGrouped() ? "" : d("banded-row", T % 2 === 0 ? "even" : "odd"), zt = (b, T, K) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(Wt, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Zt, { children: y.getHeaderGroups().map((b) => /* @__PURE__ */ r(wt, { children: b.headers.filter((T) => T.column.columnDef.header).map((T) => (
        ...
        /* @__PURE__ */ r(Xt, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
...
).sort(([, i], [, w]) => i.order - w.order).flatMap(([i]) => e.filter((s) => s.group === i).sort((s, p) => s.order - p.order).map((s) => /* @__PURE__ */ l(Ae, { children: [
...
function Ns({
  ...
  return /* @__PURE__ */ l(Jt, { children: [
    ...
    /* @__PURE__ */ r(Ft, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, s]) => typeof w == "boolean" || typeof s == "boolean" ? 0 : w.order - s.order).map(([w], s, p) => /* @__PURE__ */ l(Yn, { children: [
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([i], w) => {
    const s = e.filter((u) => u.group === i).sort((u, m) => u.order - m.order).map((u) => /* @__PURE__ */ l(Ae, { children: [
...
function po({
  ...
  if (_r(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, f) => {
    ...
    return /* @__PURE__ */ r(On, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, f]) => typeof m == "boolean" || typeof f == "boolean" ? 0 : m.order - f.order).map(([m, f]) => /* @__PURE__ */ l(oo, { children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-grow tw-basis-0 tw-justify-end", children: /* @__PURE__ */ r(
              "div",
              {
                className: "tw-flex tw-items-center tw-gap-2 tw-pe-[4px]",
                style: p ? { WebkitAppRegion: "no-drag" } : void 0,
                children: s
              }
            ) })
...
function Rs({
  ...
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", s), children: [
    /* @__PURE__ */ l(
      xt,
      {
        name: "uiLanguage",
...
function _s({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: e, children: n.map((s) => /* @__PURE__ */ l("div", { className: "tw-m-2 tw-flex tw-items-center", children: [
    /* @__PURE__ */ r(
      De,
      {
...
), go = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(ho({ variant: e }), t), ...n }));
...
const bo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
const So = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
