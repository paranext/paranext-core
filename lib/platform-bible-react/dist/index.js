...
function e0({
  ...
  const b = gt(r, "%webView_inventory_all%"), d = gt(r, "%webView_inventory_approved%"), h = gt(r, "%webView_inventory_unapproved%"), f = gt(r, "%webView_inventory_unknown%"), g = gt(r, "%webView_platformScripture_currentBook%"), w = gt(r, "%webView_inventory_scope_chapter%"), O = gt(r, "%webView_inventory_scope_verse%"), x = gt(r, "%webView_inventory_filter_text%"), [E, y] = ge([]), [T, C] = ge("all"), [I, R] = ge(""), [_, N] = ge(""), A = Se(
    (V, S) => {
      y((Y) => {
        let H = [];
        return V.forEach((K) => {
...
function a0({
  ...
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ c(Dr, { htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ c(
      Oa,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ c(Dr, { htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ c(
      Oa,
      {
        isDisabled: o,
