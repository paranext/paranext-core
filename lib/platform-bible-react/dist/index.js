...
import { c as v, g as xe, a as Yr, C as Ce, u as Eo, T as Ot, b as Mt, d as $t, e as It, A as ce, P as $e, f as We, B as q, h as Ie, i as Ae, j as Pe, k as _e, l as Ui, m as Ki, n as Hi, E as Gi, o as Xa, r as fe, p as qi, q as mn, s as oa, t as na, L as _t, R as Ja, v as Xr, D as Da, w as Oa, x as Ma, y as $a, z as vn, F as jr, G as Za, H as bn, I as Qa, J as He, K as kr, M as Ve, N as Le, O as je, S as _r, Q as rr, U as Wi, V as Er, W as qe, X as De, Z as Ye, Y as Re, _ as ar, $ as to, a0 as eo, a1 as Jr, a2 as ro, a3 as xn, a4 as Yi, a5 as Xi, a6 as Ji, a7 as Ia, a8 as yn, a9 as ia, aa as kn, ab as Zi, ac as Qi, ad as ts, ae as es, af as _n, ag as Nn, ah as ao, ai as rs, aj as Cn, ak as ga, al as To, am as fa, an as as, ao as os, ap as ns, aq as is, ar as ss, as as Tr, at as oo, au as cs, av as ls } from "./resizable-BSOjdK2Z.js";
import { aw as vg, ax as bg, ay as xg, az as yg, aA as kg, aB as _g, aC as Ng, aD as Cg, aE as Eg, aF as Tg, aG as Sg, aH as zg, aI as Rg, aJ as Dg, aK as Og, aL as Mg, aM as $g, aN as Ig, aO as Ag, aP as Pg, aQ as Vg, aR as Lg, aS as jg, aT as Fg, aU as Bg } from "./resizable-BSOjdK2Z.js";
...
import { Section as ut, getChaptersForBook as Us, formatScrRef as ye, getSectionForBook as Fr, formatRelativeDate as Ks, formatReplacementString as Ge, sanitizeHtml as io, NumberFormat as On, formatBytes as Hs, getCurrentLocale as Gs, usfmMarkers as Br, getFormatCallerFunction as qs, deepEqual as Ws, isString as Do, compareScrRefs as La, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Ys, getLocalizeKeyForScrollGroupId as Oo, formatReplacementStringToArray as Mo, collectUsjMarkers as Xs } from "platform-bible-utils";
import Yt, { useRef as B, useMemo as M, createContext as sa, useContext as so, useState as k, useEffect as G, useCallback as F, useImperativeHandle as Js, useLayoutEffect as Xt, Component as Zs, createElement as $o, Suspense as Qs, forwardRef as Mn, useId as Io, Fragment as ca } from "react";
...
import { Avatar as uo, Select as Gt, Checkbox as Lo, Slot as zr, Tabs as le, Menubar as me, ContextMenu as At, Progress as jo, Slider as $r, Switch as Fo } from "radix-ui";
...
function xa({
  ...
  const C = fe(), j = hl(), $ = U ?? j, [E, P] = k(!1), [K, V] = k(""), [Y, D] = k(""), [L, S] = k("books"), [N, Z] = k(void 0), [X, gt] = k(
  ...
  }), [Qt]), yt = M(() => Object.values(qt).flat(), [qt]), Pt = M(() => {
    if (!Y.trim()) return qt;
    const x = {
      [ut.OT]: [],
      [ut.NT]: [],
    ...
    return [ut.OT, ut.NT, ut.DC, ut.Extra].forEach((et) => {
      x[et] = qt[et].filter((Et) => Xa(Et, Y, n));
    }), x;
  }, [qt, Y, n]), z = M(
    () => kl(Y, yt, n),
    [Y, yt, n]
...
const ei = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, El = ei ? Xt : G, Pr = { tag: co };
...
const Sl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
...
const $l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
function Il(t) {
...
function Hl(t) {
  ...
  const o = Gl(t, r), n = pc(o), i = hc(n) ? gc(n) : o;
...
let Qr, ke = 0, ta = 0, Xl = 0, Ga = 0, Hr = 0;
function Xo(t) {
  if (ot === void 0) return;
  let e = t.n;
...
Ht.prototype.brand = Wl, Ht.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      ke !== 0 && ta === 0 && e.l !== Ga && (e.l = Ga, Qr = { S: e, v: e.v, i: e.i, o: Qr });
...
const qa = ne({ build: (t) => li(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const sd = /* @__PURE__ */ new Set(), en = ne({ build(t, e, r) {
  const o = r.getDependency(qa).output, n = Cr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = li(() => {
  }, () => ge(() => {
...
}, dependencies: [qa], name: "@lexical/extension/NodeSelection" }), cd = Sc("INSERT_HORIZONTAL_RULE_COMMAND");
class sr extends ja {
  static getType() {
...
ne({ dependencies: [qa, en], name: "@lexical/extension/HorizontalRule", nodes: () => [sr], register(t, e, r) {
...
const bo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
...
const kd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
function _d({ onClear: t }) {
  const [e] = ve();
  return kd(() => si(e, t), [e, t]), null;
}
const fi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Xt : G;
    ...
    "div",
    {
      ...
      children: [
        ...
        U && /* @__PURE__ */ u(Ve, { children: [
          /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(fs, {}) }) }),
...
function Ti({
  ...
  const [V, Y] = k(cn), [D, L] = k(), [S, N] = k(), Z = o, [X, gt] = k(!1), [tt, St] = k(!1), [W, nt] = k(!1), [ht, ft] = k(!1), [ct, Nt] = k(!1), [lt, Zt] = k(O), [ee, Ft] = k(!1), xt = B(void 0), [Qt, qt] = k(/* @__PURE__ */ new Map());
  G(() => {
    let R = !0;
    return (async () => {
  ...
  const dt = M(
    ...
    () => rt === 1 ? dt.singleReply : Ge(dt.multipleReplies, { count: rt }),
    [rt, dt]
  ), Bt = M(
    () => mt === 1 ? dt.singleReply : Ge(dt.multipleReplies, { count: mt }),
    [mt, dt]
  );
  G(() => {
    !o && tt && bt && St(!1);
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    D !== void 0 && (oe(V) || D !== S) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Ge(
...
), qd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => qd(io(t));
function Wr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function tw({ table: t }) {
  return /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function dr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Gt.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Gt.Icon, { asChild: !0, children: /* @__PURE__ */ a($n, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function se({
  ...
  return /* @__PURE__ */ u(
    Gt.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Gt.ItemIndicator, { children: /* @__PURE__ */ a(la, { className: "tw:pointer-events-none" }) }) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(q, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Sn, {}) })
        ] }),
...
function Tp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "default", children: [
...
function hw({
  ...
  return /* @__PURE__ */ u(Ve, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a($t, { asChild: !0, children: /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: pw(t, n, r) }) }) }),
...
function mw({
  ...
  return /* @__PURE__ */ u(Ve, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ u(Mt, { children: [
      /* @__PURE__ */ a($t, { asChild: !0, children: /* @__PURE__ */ a(Le, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: gw(t, r) }) }) }),
...
const ze = "scrBook", qw = "scrRef", Ke = "source", Ww = "details", Yw = "Scripture Reference", Xw = "Scripture Book", Di = "Type", Jw = "Details";
function Zw(t, e) {
  const r = e ?? !1;
  return [
    {
              ...
              Ae,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: V, children: w })
                  ] }),
...
function oh({
  ...
  }, Zt = B(null), ee = B(null), Ft = B(!1), xt = B(null), Qt = B(!1), [qt, yt] = k(void 0), Pt = B(!1), z = B(!1), de = B(null), te = F((I) => {
    if (I) {
  ...
  ), Rr = qt === "end", fr = qt === "start", Be = "tw:text-muted-foreground", Ee = w === "dropdown" && Lt === "range", Dr = Ee ? zt : Q, ha = Ee ? Je : f ? dt : lt, Or = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
      ...
      Oa,
      {
        ...
        children: /* @__PURE__ */ u(ga, { container: be, children: [
          ...
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: gt }),
            /* @__PURE__ */ a(q, { onClick: Se, children: X })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && mt && /* @__PURE__ */ a(Da, { open: Lt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      Oa,
      {
        ...
        children: /* @__PURE__ */ u(ga, { container: Et, children: [
          ...
          /* @__PURE__ */ u(To, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Mr(!1), children: gt }),
            /* @__PURE__ */ a(q, { ref: de, onClick: Se, children: X })
          ] })
        ] })
      }
    ) })
...
function Ya({
  ...
  return /* @__PURE__ */ u(Ve, { variant: i, children: [
    /* @__PURE__ */ a(Le, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ls, {}) }) }),
