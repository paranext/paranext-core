import Jl, { jsx as p, jsxs as $, Fragment as Et } from "react/jsx-runtime";
import * as k from "react";
import U, { forwardRef as xn, useCallback as Se, useState as ge, useRef as Mt, useEffect as Qe, useLayoutEffect as xa, useMemo as ct } from "react";
import { History as Zl, ChevronRight as Pi, Check as En, Circle as Ql, ArrowDownWideNarrow as ec, Clock as tc, Bookmark as rc, FilterIcon as nc, ChevronDown as kn, ChevronUp as oc, ArrowLeftIcon as ac, ChevronLeftIcon as ic, ChevronRightIcon as sc, ArrowRightIcon as lc, ArrowUpIcon as cc, ArrowDownIcon as pc, ArrowUpDownIcon as dc, CircleCheckIcon as uc, CircleXIcon as fc, CircleHelpIcon as mc, X as hc, Search as gc, ChevronsUpDown as bc, ChevronLeft as vc, LoaderCircle as yc, Download as wc, Filter as xc, User as Ec, Link as kc, CircleHelp as Nc } from "lucide-react";
import Oe, { clsx as Tc } from "clsx";
...
import { getChaptersForBook as Oc, getLocalizeKeyForScrollGroupId as fe, formatScrRef as Yn, compareScrRefs as ho, scrRefToBBBCCCVVV as qn, NumberFormat as Rc, formatBytes as Pc } from "platform-bible-utils";
import { useReactTable as $i, getCoreRowModel as _i, getPaginationRowModel as $c, getSortedRowModel as Ii, getFilteredRowModel as _c, flexRender as Tr, getExpandedRowModel as Ic, getGroupedRowModel as Mc } from "@tanstack/react-table";
...
import { FormLabel as Dc, Checkbox as jc, MenuItem as Bc, ListItemText as Lc, ListItemIcon as Di, Menu as Fc, Grid as ji, List as Vc, IconButton as Bi, Drawer as zc, Slider as Uc, Snackbar as Hc, Switch as Gc, AppBar as Wc, Toolbar as Xc } from "@mui/material";
import * as go from "@radix-ui/react-checkbox";
import Yc, { ThemeContext as qc, internal_processStyles as Kc } from "@mui/styled-engine";
...
import { Toaster as Zc } from "sonner";
import { toast as _0 } from "sonner";
import * as xr from "@radix-ui/react-slider";
import * as bo from "@radix-ui/react-switch";
const Qc = Cc({ prefix: "pr-" });
function D(...e) {
  return Qc(Tc(e));
}
...
var tp = Object.defineProperty, rp = (e, t, r) => t in e ? tp(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oe = (e, t, r) => rp(e, typeof t != "symbol" ? t + "" : t, r);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
function dp(e) {
  return Fi[e - 1].includes("*obsolete*");
}
function up() {
  const e = {};
...
*/
oe(Ie, "ValidStatusType", Gi);
let mr = class extends Error {
};
const Ao = be.Root, Wi = be.Trigger, fp = be.Group, Wv = be.Portal, Xv = be.Sub, Yv = be.RadioGroup, mp = U.forwardRef(({ className: e, inset: t, children: r, ...n }, o) => /* @__PURE__ */ $(
  be.SubTrigger,
  {
    ref: o,
    className: D(
    ...
    children: [
      r,
      /* @__PURE__ */ p(Pi, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
mp.displayName = be.SubTrigger.displayName;
const hp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  be.SubContent,
  {
    ref: r,
    className: D(
...
hp.displayName = be.SubContent.displayName;
...
const Xi = U.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ p(
  be.Item,
  {
    ref: n,
    className: D(
...
Xi.displayName = be.Item.displayName;
const Do = U.forwardRef(({ className: e, children: t, checked: r, ...n }, o) => /* @__PURE__ */ $(
  be.CheckboxItem,
  {
    ref: o,
    className: D(
...
Do.displayName = be.CheckboxItem.displayName;
const Yi = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  be.RadioItem,
  {
    ref: n,
    className: D(
    ...
    ...r,
    children: [
      /* @__PURE__ */ p("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ p(be.ItemIndicator, { children: /* @__PURE__ */ p(Ql, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
Yi.displayName = be.RadioItem.displayName;
const zr = U.forwardRef(({ className: e, inset: t, ...r }, n) => /* @__PURE__ */ p(
  be.Label,
  {
    ref: n,
...
zr.displayName = be.Label.displayName;
const Sn = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  be.Separator,
  {
    ref: r,
...
Sn.displayName = be.Separator.displayName;
...
gp.displayName = "DropdownMenuShortcut";
const bp = xn(
  ({
    bookId: e,
    handleSelectBook: t,
...
function vp({
  ...
  return /* @__PURE__ */ p("div", { className: D("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: a.map((l) => /* @__PURE__ */ p(
    "div",
    {
      className: D(
...
function yp({ handleSort: e, handleLocationHistory: t, handleBookmarks: r }) {
  return /* @__PURE__ */ $(zr, { className: "pr-flex pr-justify-between", children: [
...
const Cr = me.allBookIds, wp = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, Na = ["OT", "NT", "DC"], xp = 32 + 32 + 32, Ep = [
  /^(\w+)$/i,
...
function qv({ scrRef: e, handleSubmit: t }) {
  const [r, n] = ge(""), [o, a] = ge(
    ...
    Ep.forEach((N) => {
      const M = r.match(N);
      if (M) {
        const [j, z = void 0, G = void 0] = M.slice(1), B = Cp(j);
    ...
    if (c === o) {
      ...
      i + j <= 0 || i + j > hr(c) ? l(0) : j !== 0 && (l(i + j), N.preventDefault());
    }
  };
  return Qe(() => {
    o === c ? o === me.bookNumberToId(e.bookNum) ? l(e.chapterNum) : l(1) : l(0);
  }, [c, e.bookNum, e.chapterNum, o]), xa(() => {
    d(m);
  }, [m]), xa(() => {
    const N = setTimeout(() => {
      if (b && f.current && g.current) {
        const j = g.current.offsetTop - xp;
  ...
  }, [b]), /* @__PURE__ */ p("div", { className: "pr-twp pr-flex", children: /* @__PURE__ */ $(Ao, { modal: !1, open: m, onOpenChange: E, children: [
    /* @__PURE__ */ p(Wi, { asChild: !0, children: /* @__PURE__ */ p(
      ep,
      {
        ref: h,
        value: r,
    ...
    /* @__PURE__ */ $(
      Cn,
      {
        ...
        children: [
          ...
          Na.map(
            (N, M) => w(N).length > 0 && /* @__PURE__ */ $("div", { children: [
              /* @__PURE__ */ p(zr, { className: "pr-font-semibold pr-text-foreground/80", children: wp[N] }),
              w(N).map((j) => /* @__PURE__ */ p("div", { children: /* @__PURE__ */ p(
                bp,
                {
                  bookId: j,
              ...
              Na.length - 1 !== M ? /* @__PURE__ */ p(Sn, {}) : void 0
            ] }, N)
          )
        ]
      }
...
const Sp = Nn(
  ...
  ({ className: e, variant: t, size: r, asChild: n = !1, ...o }, a) => /* @__PURE__ */ p(n ? Ac : "button", { className: D(Sp({ variant: t, size: r, className: e })), ref: a, ...o })
);
Te.displayName = "Button";
function Op({ table: e }) {
  return /* @__PURE__ */ $(Ao, { children: [
    /* @__PURE__ */ p(Sc, { asChild: !0, children: /* @__PURE__ */ $(Te, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ p(nc, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ $(Cn, { align: "end", className: "pr-w-[150px]", children: [
      /* @__PURE__ */ p(zr, { children: "Toggle columns" }),
      /* @__PURE__ */ p(Sn, {}),
...
const _r = xe.Root, Rp = xe.Group, Ir = xe.Value, Zt = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(
  xe.Trigger,
  {
    ref: n,
    className: D(
    ...
    children: [
      t,
      /* @__PURE__ */ p(xe.Icon, { asChild: !0, children: /* @__PURE__ */ p(kn, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
...
const qi = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  xe.ScrollUpButton,
  {
    ...
    ...t,
    children: /* @__PURE__ */ p(oc, { className: "pr-h-4 pr-w-4" })
  }
));
qi.displayName = xe.ScrollUpButton.displayName;
const Ki = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  xe.ScrollDownButton,
  {
    ref: r,
    className: D("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ p(kn, { className: "pr-h-4 pr-w-4" })
  }
));
Ki.displayName = xe.ScrollDownButton.displayName;
const Qt = U.forwardRef(({ className: e, children: t, position: r = "popper", ...n }, o) => /* @__PURE__ */ p(xe.Portal, { children: /* @__PURE__ */ $(
  xe.Content,
  {
    ref: o,
    className: D(
...
const Pp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  xe.Label,
  {
    ref: r,
...
Pp.displayName = xe.Label.displayName;
...
const $p = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  xe.Separator,
  {
    ref: r,
    className: D("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
...
$p.displayName = xe.Separator.displayName;
function _p({ table: e }) {
    ...
    /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
      ...
      /* @__PURE__ */ $(
        _r,
        {
          ...
          children: [
            /* @__PURE__ */ p(Zt, { className: "pr-h-8 pr-w-[70px]", children: /* @__PURE__ */ p(Ir, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ p(Qt, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ p(Ke, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ $(
        Te,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(ac, { className: "pr-h-4 pr-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ $(
        Te,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(ic, { className: "pr-h-4 pr-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ $(
      ...
      /* @__PURE__ */ $(
        Te,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(lc, { className: "pr-h-4 pr-w-4" })
          ]
        }
      )
    ] })
...
const On = U.forwardRef(({ className: e, stickyHeader: t, ...r }, n) => /* @__PURE__ */ p("div", { className: D("pr-twp pr-relative pr-w-full", { "pr-overflow-auto": !t }), children: /* @__PURE__ */ p(
  "table",
  {
    ref: n,
...
const Pn = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p("tbody", { ref: r, className: D("[&_tr:last-child]:pr-border-0", e), ...t }));
Pn.displayName = "TableBody";
const Ip = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  "tfoot",
  {
    ref: r,
...
const Mr = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  "th",
  {
    ref: r,
    className: D(
...
const er = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  "td",
  {
    ref: r,
...
const Mp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  "caption",
  {
    ref: r,
...
function Ap({
  ...
  var g;
  const [l, c] = ge([]), [u, m] = ge([]), [v, b] = ge({}), [d, h] = ge({}), f = $i({
    data: t,
    columns: e,
    getCoreRowModel: _i(),
    ...r && { getPaginationRowModel: $c() },
    onSortingChange: c,
    getSortedRowModel: Ii(),
    onColumnFiltersChange: m,
    getFilteredRowModel: _c(),
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-font-sans", children: [
    o && /* @__PURE__ */ p(Op, { table: f }),
    /* @__PURE__ */ $(On, { stickyHeader: a, children: [
      /* @__PURE__ */ p(Rn, { stickyHeader: a, children: f.getHeaderGroups().map((w) => /* @__PURE__ */ p(xt, { children: w.headers.map((O) => /* @__PURE__ */ p(Mr, { children: O.isPlaceholder ? void 0 : Tr(O.column.columnDef.header, O.getContext()) }, O.id)) }, w.id)) }),
      /* @__PURE__ */ p(Pn, { children: (g = f.getRowModel().rows) != null && g.length ? f.getRowModel().rows.map((w) => /* @__PURE__ */ p(
        xt,
        {
          onClick: () => i(w, f),
          "data-state": w.getIsSelected() && "selected",
          children: w.getVisibleCells().map((O) => /* @__PURE__ */ p(er, { children: Tr(O.column.columnDef.cell, O.getContext()) }, O.id))
        },
        w.id
      )) : /* @__PURE__ */ p(xt, { children: /* @__PURE__ */ p(er, { colSpan: e.length, className: "pr-h-24 pr-text-center", children: "No results." }) }) })
    ] }),
    ...
    r && n && /* @__PURE__ */ p(_p, { table: f })
  ] });
}
const Dp = (e) => e.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), Ta = (e) => {
...
function jp({
  ...
  return Qe(
    ...
    /* @__PURE__ */ p(Rn, { stickyHeader: !0, children: /* @__PURE__ */ $(xt, { children: [
      /* @__PURE__ */ p(Mr, { children: i }),
      /* @__PURE__ */ p(Mr, { children: l })
    ] }) }),
    /* @__PURE__ */ p(Pn, { children: c.map((m) => /* @__PURE__ */ $(
      xt,
      {
        ...
        children: [
          /* @__PURE__ */ p(er, { children: `${me.bookNumberToEnglishName(m.reference.bookNum)} ${m.reference.chapterNum}:${m.reference.verseNum}` }),
          /* @__PURE__ */ p(er, { children: m.snippet })
        ]
      },
      m.key
    )) })
...
]), jo = (e) => e === "asc" ? /* @__PURE__ */ p(cc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : e === "desc" ? /* @__PURE__ */ p(pc, { className: "pr-ms-2 pr-h-4 pr-w-4" }) : /* @__PURE__ */ p(dc, { className: "pr-ms-2 pr-h-4 pr-w-4" }), Bp = (e, t, r) => {
  let n = e;
    ...
    /* @__PURE__ */ $("div", { className: "pr-flex", children: [
      /* @__PURE__ */ $(
        _r,
        {
          ...
          defaultValue: T,
          children: [
            /* @__PURE__ */ p(Zt, { className: "pr-m-1", children: /* @__PURE__ */ p(Ir, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ $(_r, { onValueChange: (V) => W(V), defaultValue: u, children: [
        /* @__PURE__ */ p(Zt, { className: "pr-m-1", children: /* @__PURE__ */ p(Ir, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ $(Qt, { className: "pr-font-sans", children: [
...
), Fp = U.forwardRef(({ className: e, variant: t, size: r, ...n }, o) => /* @__PURE__ */ p(
  Mi.Root,
  {
    ref: o,
    className: D(Ji({ variant: t, size: r, className: e })),
    ...n
  }
));
Fp.displayName = Mi.Root.displayName;
const Zi = U.createContext({
  size: "default",
  variant: "default"
}), Qi = U.forwardRef(({ className: e, variant: t, size: r, children: n, ...o }, a) => /* @__PURE__ */ p(
  Tn.Root,
  {
    ref: a,
    className: D(
...
Qi.displayName = Tn.Root.displayName;
const sn = U.forwardRef(({ className: e, children: t, variant: r, size: n, ...o }, a) => {
  const i = U.useContext(Zi);
  return /* @__PURE__ */ p(
    Tn.Item,
    {
      ref: a,
...
sn.displayName = Tn.Item.displayName;
const Zv = (e) => ({
  accessorKey: "item",
  ...
  accessorKey: "count",
  header: ({ column: t }) => /* @__PURE__ */ p("div", { className: "pr-flex pr-justify-end pr-tabular-nums", children: /* @__PURE__ */ $(Te, { variant: "ghost", onClick: () => t.toggleSorting(void 0), children: [
    e,
    jo(t.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: r }) => /* @__PURE__ */ p("div", { className: "pr-flex pr-justify-center", children: /* @__PURE__ */ $(Te, { variant: "ghost", onClick: () => r.toggleSorting(void 0), children: [
    e,
    jo(r.getIsSorted())
  ] }) }),
  cell: ({ row: r }) => {
    const n = r.getValue("status"), o = r.getValue("item");
    return /* @__PURE__ */ $(Qi, { value: n, variant: "outline", type: "single", children: [
      /* @__PURE__ */ p(sn, { onClick: () => t([o], "approved"), value: "approved", children: /* @__PURE__ */ p(uc, {}) }),
      /* @__PURE__ */ p(
        sn,
        {
      ...
      /* @__PURE__ */ p(sn, { onClick: () => t([o], "unknown"), value: "unknown", children: /* @__PURE__ */ p(mc, {}) })
    ] });
  }
}), Kn = {
  [fe("undefined")]: "Ø",
...
function t0({
  ...
  return /* @__PURE__ */ $(
    _r,
    {
      ...
      children: [
        /* @__PURE__ */ p(Zt, { className: "pr-twp pr-w-auto", children: /* @__PURE__ */ p(
          Ir,
          {
        ...
        /* @__PURE__ */ p(
          ...
          {
            style: { zIndex: 250 },
            children: e.map((a) => /* @__PURE__ */ p(Ke, { value: `${a}`, children: o[fe(a)] }, `${a}`))
          }
        )
      ]
    }
...
const Vp = $r.Root, zp = $r.Trigger, es = U.forwardRef(({ className: e, align: t = "center", sideOffset: r = 4, ...n }, o) => /* @__PURE__ */ p($r.Portal, { children: /* @__PURE__ */ p(
  $r.Content,
  {
    ref: o,
    align: t,
...
es.displayName = $r.Content.displayName;
const Up = et.Portal, ts = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  et.Overlay,
  {
    ref: r,
    className: D(
...
ts.displayName = et.Overlay.displayName;
const Hp = U.forwardRef(({ className: e, children: t, ...r }, n) => /* @__PURE__ */ $(Up, { children: [
  /* @__PURE__ */ p(ts, {}),
  /* @__PURE__ */ $(
    et.Content,
    {
...
Hp.displayName = et.Content.displayName;
const Gp = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  et.Title,
  {
    ref: r,
...
Gp.displayName = et.Title.displayName;
...
Wp.displayName = et.Description.displayName;
...
const ns = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-border-b pr-px-3", children: [
  /* @__PURE__ */ p(gc, { className: "pr-me-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" }),
  /* @__PURE__ */ p(
    De.Input,
    {
      ref: r,
...
Xp.displayName = De.Group.displayName;
...
function Sa({
  ...
  const [d, h] = ge(!1);
  return /* @__PURE__ */ $(Vp, { open: d, onOpenChange: h, ...b, children: [
    /* @__PURE__ */ p(zp, { asChild: !0, children: /* @__PURE__ */ $(
      Te,
      {
        variant: u,
        role: "combobox",
        ...
        children: [
          n ? a(n) : i,
          /* @__PURE__ */ p(bc, { className: "pr-ms-2 pr-h-4 pr-w-4 pr-shrink-0 pr-opacity-50" })
        ]
      }
    ) }),
...
), Ar = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  Ai.Root,
  {
    ref: r,
    className: D("pr-twp pr-font-sans", Kp(), e),
    ...t
  }
));
Ar.displayName = Ai.Root.displayName;
function r0({
  startChapter: e,
  endChapter: t,
  ...
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ p(Ar, { className: "book-selection-chapter-form-label start", htmlFor: "start-chapters-combobox", children: "Chapters" }),
    /* @__PURE__ */ p(
      Sa,
      {
        isDisabled: o,
    ...
    /* @__PURE__ */ p(Ar, { className: "book-selection-chapter-form-label end", htmlFor: "end-chapters-combobox", children: "to" }),
    /* @__PURE__ */ p(
      Sa,
      {
        isDisabled: o,
...
function n0({
  ...
  let v;
  if (r) {
    const b = n === qt.Before || n === qt.Above, d = /* @__PURE__ */ p("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${c ?? ""}`, children: r }), h = n === qt.Before || n === qt.After, f = h ? d : /* @__PURE__ */ p("div", { children: d }), g = h ? m : /* @__PURE__ */ p("div", { children: m });
    v = /* @__PURE__ */ $(
      Dc,
      {
...
const ss = k.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  go.Root,
  {
    ref: r,
    className: D(
    ...
    children: /* @__PURE__ */ p(
      go.Indicator,
      {
        className: D("pr-flex pr-items-center pr-justify-center pr-text-current"),
        children: /* @__PURE__ */ p(En, { className: "pr-h-4 pr-w-4" })
      }
    )
  }
));
ss.displayName = go.Root.displayName;
function o0({
  id: e,
  className: t,
  legend: r,
  ...
  return /* @__PURE__ */ $("fieldset", { id: e, className: t, children: [
    r && /* @__PURE__ */ p("legend", { className: "pr-font-sans", children: r }),
    n.map((l) => /* @__PURE__ */ $("div", { className: "pr-m-2 pr-flex pr-items-center", children: [
      ...
      /* @__PURE__ */ p(Ar, { children: i ? i(l) : l })
    ] }))
  ] });
}
function Jp(e) {
...
function lt(e, t, r = {
  ...
  return _t(e) && _t(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (_t(t[o]) && o in e && _t(e[o]) ? n[o] = lt(e[o], t[o], r) : r.clone ? n[o] = _t(t[o]) ? cs(t[o]) : t[o] : n[o] = t[o]);
  }), n;
}
var vo = { exports: {} }, tn = { exports: {} }, ce = {};
...
function td() {
  return Ra || (Ra = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var y = c, T = u, C = l, I = i, R = t, _ = m, N = n, M = h, j = d, z = r, G = a, B = o, W = v, te = !1;
    function V(F) {
    ...
    pe.AsyncMode = y, pe.ConcurrentMode = T, pe.ContextConsumer = C, pe.ContextProvider = I, pe.Element = R, pe.ForwardRef = _, pe.Fragment = N, pe.Lazy = M, pe.Memo = j, pe.Portal = z, pe.Profiler = G, pe.StrictMode = B, pe.Suspense = W, pe.isAsyncMode = V, pe.isConcurrentMode = S, pe.isContextConsumer = L, pe.isContextProvider = X, pe.isElement = Y, pe.isForwardRef = H, pe.isFragment = K, pe.isLazy = q, pe.isMemo = Z, pe.isPortal = J, pe.isProfiler = Q, pe.isStrictMode = ee, pe.isSuspense = ie, pe.isValidElementType = x, pe.typeOf = E;
  }()), pe;
}
var Pa;
function ps() {
  return Pa || (Pa = 1, process.env.NODE_ENV === "production" ? tn.exports = ed() : tn.exports = td()), tn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var eo, Ia;
function ds() {
  return Ia || (Ia = 1, eo = Function.call.bind(Object.prototype.hasOwnProperty)), eo;
}
var to, Ma;
function nd() {
  if (Ma)
...
function od() {
  if (Aa)
    return ro;
  Aa = 1;
  var e = ps(), t = rd(), r = Lo(), n = ds(), o = nd(), a = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var id = ps(), sd = !0;
  vo.exports = od()(id.isElement, sd);
} else
  vo.exports = ad()();
var ld = vo.exports;
const s = /* @__PURE__ */ Jp(ld);
function cd(e) {
  const {
    prototype: t = {}
  } = e;
...
function us(e, t, r, n, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !cd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const fs = lr(s.element, us);
fs.isRequired = lr(s.element.isRequired, us);
const Ur = fs;
function pd(e) {
  const {
    prototype: t = {}
...
function dd(e, t, r, n, o) {
  ...
  typeof window > "u")
    return null;
  let l;
  return typeof a == "function" && !pd(a) && (l = "Did you accidentally provide a plain function component instead?"), l !== void 0 ? new Error(`Invalid ${n} \`${i}\` supplied to \`${r}\`. Expected an element type that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const ud = lr(s.elementType, dd), fd = "exact-prop: ​";
function ms(e) {
...
function hd() {
  return Ba || (Ba = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function E(A) {
      return !!(typeof A == "string" || typeof A == "function" || A === r || A === o || O || A === n || A === u || A === m || w || A === d || h || f || g || typeof A == "object" && A !== null && (A.$$typeof === b || A.$$typeof === v || A.$$typeof === a || A.$$typeof === i || A.$$typeof === c || // This needs to include all possible module reference object
    ...
    var T = i, C = a, I = e, R = c, _ = r, N = b, M = v, j = t, z = o, G = n, B = u, W = m, te = !1, V = !1;
    function S(A) {
...
function hs(e, t = "") {
  return e.displayName || e.name || bd(e) || t;
}
function La(e, t, r) {
  const n = hs(t);
...
const yd = s.oneOfType([s.func, s.object]), Fo = yd;
function tt(e) {
  if (typeof e != "string")
...
const kd = typeof window < "u" ? k.useLayoutEffect : k.useEffect, jt = kd;
let Fa = 0;
function Nd(e) {
...
function $d(e) {
  ...
  return !!(r === "INPUT" && Pd[t] && !e.readOnly || r === "TEXTAREA" && !e.readOnly || e.isContentEditable);
}
function _d(e) {
...
function Id() {
  this.visibilityState === "hidden" && xo && ($n = !0);
}
function Md(e) {
  e.addEventListener("keydown", _d, !0), e.addEventListener("mousedown", oo, !0), e.addEventListener("pointerdown", oo, !0), e.addEventListener("touchstart", oo, !0), e.addEventListener("visibilitychange", Id, !0);
}
function Ad(e) {
  const {
    target: t
...
function ys() {
  ...
  function r() {
    return t.current ? (xo = !0, Rd.start(100, () => {
      xo = !1;
    }), t.current = !1, !0) : !1;
  }
  function n(o) {
    return Ad(o) ? (t.current = !0, !0) : !1;
  }
  return {
    isFocusVisibleRef: t,
    onFocus: n,
...
function Es(e, t, ...r) {
  return e[t] === void 0 ? null : xs(e, t, ...r);
}
function Eo() {
  return null;
}
Es.isRequired = xs;
Eo.isRequired = Eo;
const ks = process.env.NODE_ENV === "production" ? Eo : Es;
function Ns(e, t) {
  const r = P({}, t);
...
const zd = ["values", "unit", "step"], Ud = (e) => {
...
function Hd(e) {
  const {
    ...
    unit: r = "px",
    step: n = 5
  } = e, o = he(e, zd), a = Ud(t), i = Object.keys(a);
  function l(b) {
...
const Gd = {
  borderRadius: 4
}, Wd = Gd, Xd = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.string, s.object, s.array]) : {}, Nt = Xd;
function Sr(e, t) {
  return t ? lt(e, t, {
    clone: !1
...
function ke(e) {
  const {
    ...
    if (i[t] == null)
      return null;
    const l = i[t], c = i.theme, u = _n(c, n) || {};
    return dt(i, l, (v) => {
      let b = hn(u, o, v);
...
const Jd = {
  ...
  if (e.length > 2)
    if (Ga[e])
      ...
      return [e];
  const [t, r] = e.split(""), n = Jd[t], o = Zd[r] || "";
  return Array.isArray(o) ? o.map((a) => n + a) : [n + o];
}), In = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], Mn = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], eu = [...In, ...Mn];
function Gr(e, t, r, n) {
  var o;
...
function ru(e, t, r, n) {
  if (t.indexOf(r) === -1)
    return null;
  const o = Qd(r), a = tu(o, n), i = e[r];
  return dt(e, i, a);
}
function Os(e, t) {
  const r = Ss(e.theme);
  return Object.keys(e).map((n) => ru(e, t, n, r)).reduce(Sr, {});
}
function ye(e) {
  return Os(e, In);
}
ye.propTypes = process.env.NODE_ENV !== "production" ? In.reduce((e, t) => (e[t] = Nt, e), {}) : {};
ye.filterProps = In;
function we(e) {
  return Os(e, Mn);
}
we.propTypes = process.env.NODE_ENV !== "production" ? Mn.reduce((e, t) => (e[t] = Nt, e), {}) : {};
we.filterProps = Mn;
process.env.NODE_ENV !== "production" && eu.reduce((e, t) => (e[t] = Nt, e), {});
function nu(e = 8) {
  if (e.mui)
    return e;
  const t = Ss({
...
const ou = qe("border", He), au = qe("borderTop", He), iu = qe("borderRight", He), su = qe("borderBottom", He), lu = qe("borderLeft", He), cu = qe("borderColor"), pu = qe("borderTopColor"), du = qe("borderRightColor"), uu = qe("borderBottomColor"), fu = qe("borderLeftColor"), mu = qe("outline", He), hu = qe("outlineColor"), Dn = (e) => {
...
An(ou, au, iu, su, lu, cu, pu, du, uu, fu, Dn, mu, hu);
const jn = (e) => {
...
An(jn, Bn, Ln, gu, bu, vu, yu, wu, xu, Eu, ku, Nu);
function Jt(e, t) {
  return t === "grey" ? t : e;
}
const Tu = ke({
...
const Ou = ke({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const t = (r) => {
      var n, o;
      const a = ((n = e.theme) == null || (n = n.breakpoints) == null || (n = n.values) == null ? void 0 : n[r]) || Vo[r];
...
function ju() {
  ...
  function t(r) {
    ...
    if (!o)
      return null;
    const i = (n = a.unstable_sxConfig) != null ? n : Uo;
    function l(c) {
      let u = c;
      ...
      if (!u)
        return null;
      const m = Yd(a.breakpoints), v = Object.keys(m);
      let b = m;
...
function Go(e = {}, ...t) {
  ...
  return u.applyStyles = Bu, u = t.reduce((m, v) => lt(m, v), u), u.unstable_sxConfig = P({}, Uo, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return Ho({
      sx: v,
      theme: this
    });
...
const zu = ["ownerState"], Uu = ["variants"], Hu = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Gu(e) {
  return Object.keys(e).length === 0;
}
function Wu(e) {
...
const Xu = Go(), Wa = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function rn({
  defaultTheme: e,
  theme: t,
  themeId: r
...
function qu(e = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Kc(i, (y) => y.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: c,
      slot: u,
      ...
      overridesResolver: b = Yu(Wa(u))
    } = l, d = he(l, Hu), h = m !== void 0 ? m : (
    ...
    let w = ln;
    u === "Root" || u === "root" ? w = n : u ? w = o : Wu(i) && (w = void 0);
    const O = Yc(i, P({
      shouldForwardProp: w,
      label: g
      ...
      if (process.env.NODE_ENV !== "production") {
        let N;
        c && (N = `${c}${tt(u || "")}`), N === void 0 && (N = `Styled(${vd(i)})`), _.displayName = N;
      }
...
function Ku(e) {
  ...
  return !t || !t.components || !t.components[r] || !t.components[r].defaultProps ? n : Ns(t.components[r].defaultProps, n);
}
function Ju({
  props: e,
  name: t,
...
function Xa(e) {
  e = Bt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Bt(Qu(e)).values : e.values;
...
function gn(e, t) {
  return e = Bt(e), t = Wo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, Fn(e);
}
function ef(e, t) {
  if (e = Bt(e), t = Wo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const nf = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Wt = uf, ff = ["mode", "contrastThreshold", "tonalOffset"], qa = {
...
function Ka(e, t, r, n) {
  ...
  e[t] || (e.hasOwnProperty(r) ? e[t] = e[r] : t === "light" ? e.light = tf(e.main, o) : t === "dark" && (e.dark = ef(e.main, a)));
}
function mf(e = "light") {
  return e === "dark" ? {
    main: Ht[200],
...
function wf(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = he(e, ff), a = e.primary || mf(t), i = e.secondary || hf(t), l = e.error || gf(t), c = e.info || bf(t), u = e.success || vf(t), m = e.warning || yf(t);
  function v(f) {
    const g = Ya(f, ao.text.primary) >= r ? ao.text.primary : qa.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const w = Ya(f, g);
...
const Nf = 0.2, Tf = 0.14, Cf = 0.12;
function ve(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Nf})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${Tf})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Cf})`].join(",");
}
const Sf = ["none", ve(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ve(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ve(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ve(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ve(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ve(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ve(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ve(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ve(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ve(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ve(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ve(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ve(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ve(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ve(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ve(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ve(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ve(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ve(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ve(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ve(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ve(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ve(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ve(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Of = Sf, Rf = ["duration", "easing", "delay"], Pf = {
...
function If(e) {
  const t = P({}, Pf, e.easing), r = P({}, $f, e.duration);
  return P({
...
const Mf = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Af = Mf, Df = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function jf(e = {}, ...t) {
  const {
    mixins: r = {},
    palette: n = {},
...
`));
  ...
  return u.unstable_sxConfig = P({}, Uo, i == null ? void 0 : i.unstable_sxConfig), u.unstable_sx = function(v) {
    return Ho({
      sx: v,
      theme: this
    });
...
const _s = (e) => ln(e) && e !== "classes", Lf = qu({
  themeId: Yo,
  defaultTheme: Xo,
...
const Vf = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], zf = (e) => {
  const {
    color: t,
    fontSize: r,
    classes: n
...
}), qo = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const n = mt({
    props: t,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: v,
    viewBox: b = "0 0 24 24"
  } = n, d = he(n, Vf), h = /* @__PURE__ */ k.isValidElement(o) && o.type === "svg", f = P({}, n, {
    color: i,
    component: l,
    fontSize: c,
...
function Is(e, t) {
  ...
  return process.env.NODE_ENV !== "production" && (r.displayName = `${t}Icon`), r.muiName = ei.muiName, /* @__PURE__ */ k.memo(/* @__PURE__ */ k.forwardRef(r));
}
const Hf = {
  configure: (e) => {
...
`)), Ts.configure(e);
  ...
  createSvgIcon: Is,
  debounce: gs,
  deprecatedPropType: wd,
  isMuiElement: xd,
  ownerDocument: Re,
  ownerWindow: rr,
  requirePropFactory: Ed,
  setRef: mn,
...
}, Symbol.toStringTag, { value: "Module" })), Wf = /* @__PURE__ */ Zp(Gf);
var ti;
function Xf() {
...
var Ms = Bo.default = void 0, qf = Yf(Xf()), Kf = Jl;
Ms = Bo.default = (0, qf.default)(/* @__PURE__ */ (0, Kf.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function As(e) {
...
function kr(e, t, r) {
  return e === void 0 || As(e) ? t : P({}, t, {
    ownerState: P({}, t.ownerState, r)
  });
}
const Jf = {
  disableDefaultClasses: !1
}, Zf = /* @__PURE__ */ k.createContext(Jf);
function Qf(e) {
  const {
...
function tm(e) {
  ...
  const i = Ds(P({}, o, n)), l = ri(n), c = ri(o), u = t(i), m = Oe(u == null ? void 0 : u.className, r == null ? void 0 : r.className, a, o == null ? void 0 : o.className, n == null ? void 0 : n.className), v = P({}, u == null ? void 0 : u.style, r == null ? void 0 : r.style, o == null ? void 0 : o.style, n == null ? void 0 : n.style), b = P({}, u, r, c, l);
  return m.length > 0 && (b.className = m), Object.keys(v).length > 0 && (b.style = v), {
    props: b,
    internalRef: u.ref
  };
}
const rm = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function Lt(e) {
  var t;
  const {
    elementType: r,
...
const im = ["input", "select", "textarea", "a[href]", "button", "[tabindex]", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])'].join(",");
function sm(e) {
...
function pm(e) {
  const t = [], r = [];
  return Array.from(e.querySelectorAll(im)).forEach((n, o) => {
    const a = sm(n);
...
function bn(e) {
  const {
    ...
    isEnabled: i = dm,
    open: l
  } = e, c = k.useRef(!1), u = k.useRef(null), m = k.useRef(null), v = k.useRef(null), b = k.useRef(null), d = k.useRef(!1), h = k.useRef(null), f = We(t.ref, h), g = k.useRef(null);
  k.useEffect(() => {
...
`)), h.current.setAttribute("tabIndex", "-1")), d.current && h.current.focus()), () => {
    ...
    const x = Re(h.current), E = (C) => {
      ...
      if ((x.activeElement === u.current || x.activeElement === m.current) && (I = a(h.current)), I.length > 0) {
        var R, _;
        const N = !!((R = g.current) != null && R.shiftKey && ((_ = g.current) == null ? void 0 : _.key) === "Tab"), M = I[0], j = I[I.length - 1];
        typeof M != "string" && typeof j != "string" && (N ? j.focus() : M.focus());
      } else
        C.focus();
    };
...
process.env.NODE_ENV !== "production" && (bn["propTypes"] = ms(bn.propTypes));
function um(e) {
  return typeof e == "function" ? e() : e;
}
const Br = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    children: n,
    container: o,
    disablePortal: a = !1
  } = t, [i, l] = k.useState(null), c = We(/* @__PURE__ */ k.isValidElement(n) ? n.ref : null, r);
  if (jt(() => {
    ...
    return /* @__PURE__ */ p(k.Fragment, {
      children: n
    });
  }
  return /* @__PURE__ */ p(k.Fragment, {
    children: i && /* @__PURE__ */ Jc.createPortal(n, i)
  });
});
...
process.env.NODE_ENV !== "production" && (Br["propTypes"] = ms(Br.propTypes));
function fm(e) {
  const t = Re(e);
...
function xm(e) {
  const {
    ...
    open: m,
    rootRef: v
  } = e, b = k.useRef({}), d = k.useRef(null), h = k.useRef(null), f = We(h, v), [g, w] = k.useState(!m), O = ym(c);
  let x = !0;
  ...
  }), I = k.useCallback(() => o.isTopModal(y()), [o]), R = Dr((B) => {
  ...
  return {
    ...
    getTransitionProps: () => {
      ...
      return {
        onEnter: wo(B, c == null ? void 0 : c.props.onEnter),
        onExited: wo(W, c == null ? void 0 : c.props.onExited)
      };
    },
    rootRef: f,
    portalRef: R,
...
var Me = "top", Xe = "bottom", Ye = "right", Ae = "left", Ko = "auto", Xr = [Me, Xe, Ye, Ae], nr = "start", Lr = "end", Em = "clippingParents", Ls = "viewport", br = "popper", km = "reference", ai = /* @__PURE__ */ Xr.reduce(function(e, t) {
  return e.concat([t + "-" + nr, t + "-" + Lr]);
}, []), Fs = /* @__PURE__ */ [].concat(Xr, [Ko]).reduce(function(e, t) {
  return e.concat([t, t + "-" + nr, t + "-" + Lr]);
}, []), Nm = "beforeRead", Tm = "read", Cm = "afterRead", Sm = "beforeMain", Om = "main", Rm = "afterMain", Pm = "beforeWrite", $m = "write", _m = "afterWrite", Im = [Nm, Tm, Cm, Sm, Om, Rm, Pm, $m, _m];
function rt(e) {
...
function ar(e, t, r) {
  ...
  var i = Ft(e) ? ze(e) : window, l = i.visualViewport, c = !Vs() && r, u = (n.left + (c && l ? l.offsetLeft : 0)) / o, m = (n.top + (c && l ? l.offsetTop : 0)) / a, v = n.width / o, b = n.height / a;
  return {
    width: v,
    height: b,
    top: m,
...
function Bm(e) {
  var t = /firefox/i.test(ko()), r = /Trident/i.test(ko());
  if (r && Ge(e)) {
    var n = ut(e);
    if (n.position === "fixed")
      return null;
  ...
  var o = Vn(e);
  for (Jo(o) && (o = o.host); Ge(o) && ["html", "body"].indexOf(rt(o)) < 0; ) {
    var a = ut(o);
...
function Yr(e) {
  for (var t = ze(e), r = ii(e); r && jm(r) && ut(r).position === "static"; )
    r = ii(r);
  return r && (rt(r) === "html" || rt(r) === "body" && ut(r).position === "static") ? t : r || Bm(e) || t;
}
function Qo(e) {
...
var Fm = function(t, r) {
  ...
  })) : t, Hs(typeof t != "number" ? t : Gs(t, Xr));
};
function Vm(e) {
  var t, r = e.state, n = e.name, o = e.options, a = r.elements.arrow, i = r.modifiersData.popperOffsets, l = Ze(r.placement), c = Qo(l), u = [Ae, Ye].indexOf(l) >= 0, m = u ? "height" : "width";
  if (!(!a || !i)) {
    var v = Fm(o.padding, r), b = Zo(a), d = c === "y" ? Me : Ae, h = c === "y" ? Xe : Ye, f = r.rects.reference[m] + r.rects.reference[c] - i[c] - r.rects.popper[m], g = i[c] - r.rects.reference[c], w = Yr(a), O = w ? c === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, x = f / 2 - g / 2, E = v[d], y = O - b[m] - v[h], T = O / 2 - b[m] / 2 + x, C = Rr(E, T, y), I = c;
...
function si(e) {
  ...
  if (u) {
    var T = Yr(r), C = "clientHeight", I = "clientWidth";
    if (T === ze(r) && (T = Tt(r), ut(T).position !== "static" && l === "absolute" && (C = "scrollHeight", I = "scrollWidth")), T = T, o === Me || (o === Ae || o === Ye) && a === Lr) {
      E = Xe;
...
function Ym(e) {
  ...
  return a && u.forEach(function(m) {
    m.addEventListener("scroll", r.update, nn);
  }), l && c.addEventListener("resize", r.update, nn), function() {
    a && u.forEach(function(m) {
      m.removeEventListener("scroll", r.update, nn);
    }), l && c.removeEventListener("resize", r.update, nn);
  };
}
const qm = {
  name: "eventListeners",
...
function ta(e) {
  return ar(Tt(e)).left + ea(e).scrollLeft;
}
function Zm(e, t) {
...
function Qm(e) {
  var t, r = Tt(e), n = ea(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, a = At(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = At(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -n.scrollLeft + ta(e), c = -n.scrollTop;
...
function Ws(e) {
  return ["html", "body", "#document"].indexOf(rt(e)) >= 0 ? e.ownerDocument.body : Ge(e) && ra(e) ? e : Ws(Vn(e));
}
function Pr(e, t) {
  var r;
  t === void 0 && (t = []);
  var n = Ws(e), o = n === ((r = e.ownerDocument) == null ? void 0 : r.body), a = ze(n), i = o ? [a].concat(a.visualViewport || [], ra(n) ? n : []) : n, l = t.concat(i);
  return o ? l : (
...
function ci(e, t, r) {
  return t === Ls ? No(Zm(e, r)) : Ft(t) ? eh(t, r) : No(Qm(Tt(e)));
}
function th(e) {
  var t = Pr(Vn(e)), r = ["absolute", "fixed"].indexOf(ut(e).position) >= 0, n = r && Ge(e) ? Yr(e) : e;
  return Ft(n) ? t.filter(function(o) {
    return Ft(o) && zs(o, n) && rt(o) !== "body";
  }) : [];
}
function rh(e, t, r, n) {
  var o = t === "clippingParents" ? th(e) : [].concat(t), a = [].concat(o, [r]), i = a[0], l = a.reduce(function(c, u) {
    var m = ci(e, u, n);
...
function Fr(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e.placement : n, a = r.strategy, i = a === void 0 ? e.strategy : a, l = r.boundary, c = l === void 0 ? Em : l, u = r.rootBoundary, m = u === void 0 ? Ls : u, v = r.elementContext, b = v === void 0 ? br : v, d = r.altBoundary, h = d === void 0 ? !1 : d, f = r.padding, g = f === void 0 ? 0 : f, w = Hs(typeof g != "number" ? g : Gs(g, Xr)), O = b === br ? km : br, x = e.rects.popper, E = e.elements[h ? O : b], y = rh(Ft(E) ? E : E.contextElement || Tt(e.elements.popper), c, m, i), T = ar(e.elements.reference), C = Xs({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
  }), I = No(Object.assign({}, x, C)), R = b === br ? I : T, _ = {
...
function nh(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = r.boundary, a = r.rootBoundary, i = r.padding, l = r.flipVariations, c = r.allowedAutoPlacements, u = c === void 0 ? Fs : c, m = ir(n), v = m ? l ? ai : ai.filter(function(h) {
    return ir(h) === m;
  }) : Xr, b = v.filter(function(h) {
...
function ah(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !0 : i, c = r.fallbackPlacements, u = r.padding, m = r.boundary, v = r.rootBoundary, b = r.altBoundary, d = r.flipVariations, h = d === void 0 ? !0 : d, f = r.allowedAutoPlacements, g = t.options.placement, w = Ze(g), O = w === g, x = c || (O || !h ? [pn(g)] : oh(g)), E = [g].concat(x).reduce(function(H, K) {
      return H.concat(Ze(K) === Ko ? nh(t, {
        placement: K,
        boundary: m,
        rootBoundary: v,
        padding: u,
      ...
      var N = E[_], M = Ze(N), j = ir(N) === nr, z = [Me, Xe].indexOf(M) >= 0, G = z ? "width" : "height", B = Fr(t, {
        placement: N,
        boundary: m,
        rootBoundary: v,
        altBoundary: b,
...
function ph(e) {
  var t = e.state, r = e.options, n = e.name, o = r.offset, a = o === void 0 ? [0, 0] : o, i = Fs.reduce(function(m, v) {
...
function hh(e) {
  var t = e.state, r = e.options, n = e.name, o = r.mainAxis, a = o === void 0 ? !0 : o, i = r.altAxis, l = i === void 0 ? !1 : i, c = r.boundary, u = r.rootBoundary, m = r.altBoundary, v = r.padding, b = r.tether, d = b === void 0 ? !0 : b, h = r.tetherOffset, f = h === void 0 ? 0 : h, g = Fr(t, {
    ...
    padding: v,
    altBoundary: m
  }), w = Ze(t.placement), O = ir(t.placement), x = !O, E = Qo(w), y = mh(E), T = t.modifiersData.popperOffsets, C = t.rects.reference, I = t.rects.popper, R = typeof f == "function" ? f(Object.assign({}, t.rects, {
    placement: t.placement
  })) : f, _ = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
    ...
    mainAxis: 0,
    altAxis: 0
  }, R), N = t.modifiersData.offset ? t.modifiersData.offset[t.placement] : null, M = {
    x: 0,
    y: 0
  };
  if (T) {
    if (a) {
      var j, z = E === "y" ? Me : Ae, G = E === "y" ? Xe : Ye, B = E === "y" ? "height" : "width", W = T[E], te = W + g[z], V = W - g[G], S = d ? -I[B] / 2 : 0, L = O === nr ? C[B] : I[B], X = O === nr ? -I[B] : -C[B], Y = t.elements.arrow, H = d && Y ? Zo(Y) : {
        width: 0,
        height: 0
      }, K = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Us(), q = K[z], Z = K[G], J = Rr(0, C[B], H[B]), Q = x ? C[B] / 2 - S - J - q - _.mainAxis : L - J - q - _.mainAxis, ee = x ? -C[B] / 2 + S + J + Z + _.mainAxis : X + J + Z + _.mainAxis, ie = t.elements.arrow && Yr(t.elements.arrow), F = ie ? E === "y" ? ie.clientTop || 0 : ie.clientLeft || 0 : 0, re = (j = N == null ? void 0 : N[E]) != null ? j : 0, A = W + Q - re - F, se = W + ee - re, Ne = Rr(d ? vn(te, A) : te, W, d ? At(V, se) : V);
      T[E] = Ne, M[E] = Ne - W;
    }
    if (l) {
      var $e, Ee = E === "x" ? Me : Ae, Ct = E === "x" ? Xe : Ye, _e = T[y], ot = y === "y" ? "height" : "width", Be = _e + g[Ee], at = _e - g[Ct], Ce = [Me, Ae].indexOf(w) !== -1, Vt = ($e = N == null ? void 0 : N[y]) != null ? $e : 0, St = Ce ? Be : _e - C[ot] - I[ot] - Vt + _.altAxis, cr = Ce ? _e + C[ot] + I[ot] - Vt - _.altAxis : at, Jr = d && Ce ? Lm(St, _e, cr) : Rr(d ? St : Be, _e, d ? cr : at);
      T[y] = Jr, M[y] = Jr - _e;
    }
    t.modifiersData[n] = M;
  }
...
function wh(e, t, r) {
  r === void 0 && (r = !1);
  var n = Ge(t), o = Ge(t) && yh(t), a = Tt(t), i = ar(e, o, r), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  ra(a)) && (l = vh(t)), Ge(t) ? (c = ar(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : a && (c.x = ta(a))), {
  ...
  return function(l, c, u) {
    ...
    var m = {
      ...
      setOptions: function(w) {
        ...
        var x = Eh(Nh([].concat(n, m.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!b) {
          ...
          if (fi(O, x)) {
            m.rects = {
              reference: wh(O, Yr(x), m.options.strategy === "fixed"),
              popper: Zo(x)
...
var Ch = [qm, fh, Xm, Dm, dh, ih, gh, Um, lh], Sh = /* @__PURE__ */ Th({
  defaultModifiers: Ch
});
const Ys = "Popper";
function Oh(e) {
...
am(Ys, ["root"]);
const Rh = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], Ph = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function $h(e, t) {
  if (t === "ltr")
    return e;
  switch (e) {
...
const Ih = () => ft({
  root: ["root"]
}, Qf(Oh)), Mh = {}, Ah = /* @__PURE__ */ k.forwardRef(function(t, r) {
  var n;
  const {
    anchorEl: o,
    children: a,
  ...
  } = t, g = he(t, Rh), w = k.useRef(null), O = We(w, r), x = k.useRef(null), E = We(x, b), y = k.useRef(E);
  jt(() => {
    y.current = E;
  }, [E]), k.useImperativeHandle(b, () => x.current, []);
  const T = $h(m, i), [C, I] = k.useState(T), [R, _] = k.useState(yn(o));
  k.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && R && zn(R) && R.nodeType === 1) {
...
`));
  ...
  const M = Ih(), j = (n = h.root) != null ? n : "div", z = Lt({
    elementType: j,
  ...
  return /* @__PURE__ */ p(j, P({}, z, {
    children: typeof a == "function" ? a(N) : a
  }));
}), qs = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    anchorEl: n,
    children: o,
    container: a,
    ...
    slotProps: g = {},
    slots: w = {}
  } = t, O = he(t, Ph), [x, E] = k.useState(!0), y = () => {
    E(!1);
  }, T = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const _ = yn(n);
    C = _ && zn(_) ? Re(_).body : Re(null).body;
  }
...
`));
      } else if (!t || typeof t.getBoundingClientRect != "function" || _h(t) && t.contextElement != null && t.contextElement.nodeType !== 1)
...
function qr() {
  const e = $s(Xo);
  return process.env.NODE_ENV !== "production" && k.useDebugValue(e), e[Yo] || e;
}
function To(e, t) {
...
var jh = process.env.NODE_ENV !== "production" ? s.oneOfType([s.number, s.shape({
  enter: s.number,
  exit: s.number,
  appear: s.number
}).isRequired]) : null;
...
const Ks = U.createContext(null);
var Bh = function(t) {
  return t.scrollTop;
}, Nr = "unmounted", Rt = "exited", Pt = "entering", Kt = "entered", Co = "exiting", ht = /* @__PURE__ */ function(e) {
  Dh(t, e);
  function t(n, o) {
    var a;
  ...
  return r.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== Pt && i !== Kt && (a = Pt) : (i === Pt || i === Kt) && (a = Co);
    }
    ...
    if (o === void 0 && (o = !1), a !== null)
      if (this.cancelNextCallback(), a === Pt) {
        if (this.props.unmountOnExit || this.props.mountOnEnter) {
          var i = this.props.nodeRef ? this.props.nodeRef.current : en.findDOMNode(this);
          i && Bh(i);
        }
        this.performEnter(o);
      } else
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [en.findDOMNode(this), l], u = c[0], m = c[1], v = this.getTimeouts(), b = l ? v.appear : v.enter;
    if (!o && !i || mi.disabled) {
      this.safeSetState({
        status: Kt
      }, function() {
    ...
    var o = this, a = this.props.exit, i = this.getTimeouts(), l = this.props.nodeRef ? void 0 : en.findDOMNode(this);
    if (!a || mi.disabled) {
      this.safeSetState({
        status: Rt
      }, function() {
    ...
    var i = this.props.nodeRef ? this.props.nodeRef.current : en.findDOMNode(this), l = o == null && !this.props.addEndListener;
    if (!i || l) {
...
}, so = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), na = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    addEndListener: n,
    appear: o = !0,
    children: a,
    ...
    TransitionComponent: g = Js
  } = t, w = he(t, Lh), O = Er(), x = k.useRef(), E = qr(), y = k.useRef(null), T = We(y, a.ref, r), C = (G) => (B) => {
    if (G) {
      const W = y.current;
      B === void 0 ? G(W) : G(W, B);
    }
    ...
    f === "auto" ? (V = E.transitions.getAutoHeightDuration(G.clientHeight), x.current = V) : V = B, G.style.transition = [E.transitions.create("opacity", {
      ...
      duration: so ? V : V * 0.666,
      delay: so ? W : W || V * 0.333,
      easing: te
    })].join(","), G.style.opacity = 0, G.style.transform = So(0.75), v && v(G);
  }), j = C(b);
...
const Oo = na, Vh = (e) => {
...
}, hi = Vh, zh = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Uh = Pe(qs, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = Ps(), a = mt({
    ...
    slots: x,
    slotProps: E
  } = a, y = he(a, zh), T = (n = x == null ? void 0 : x.root) != null ? n : c == null ? void 0 : c.Root, C = P({
    anchorEl: i,
    container: m,
    disablePortal: v,
    keepMounted: b,
...
const Gh = kt("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), wt = Gh, Wh = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Xh(e) {
  return Math.round(e * 1e5) / 1e5;
}
const Yh = (e) => {
...
const tl = /* @__PURE__ */ k.forwardRef(function(t, r) {
  var n, o, a, i, l, c, u, m, v, b, d, h, f, g, w, O, x, E, y;
  const T = mt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: re
  } = T, A = he(T, Wh), se = /* @__PURE__ */ k.isValidElement(I) ? I : /* @__PURE__ */ p("span", {
    children: I
  }), Ne = qr(), $e = Ne.direction === "rtl", [Ee, Ct] = k.useState(), [_e, ot] = k.useState(null), Be = k.useRef(!1), at = z || V, Ce = Er(), Vt = Er(), St = Er(), cr = Er(), [Jr, sa] = vs({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const la = (ne) => {
    ...
    (ne) => {
      gi.start(800 + L, () => {
        on = !1;
      }), sa(!1), Y && it && Y(ne), Ce.start(Ne.transitions.duration.shortest, () => {
        Be.current = !1;
      });
    }
  ), Hn = (ne) => {
    Be.current && ne.type !== "touchstart" || (Ee && Ee.removeAttribute("title"), Vt.clear(), St.clear(), B || on && W ? Vt.start(on ? W : B, () => {
      la(ne);
    }) : la(ne));
  }, ca = (ne) => {
    Vt.clear(), St.start(L, () => {
    ...
    onFocus: Fl,
    ref: Vl
  } = ys(), [, da] = k.useState(!1), ua = (ne) => {
    Ll(ne), pa.current === !1 && (da(!1), ca(ne));
  }, fa = (ne) => {
    Ee || Ct(ne.currentTarget), Fl(ne), pa.current === !0 && (da(!0), Hn(ne));
  }, ma = (ne) => {
    Be.current = !0;
    const Le = se.props;
    Le.onTouchStart && Le.onTouchStart(ne);
  }, ha = Hn, ga = ca, zl = (ne) => {
    ma(ne), St.clear(), Ce.clear(), Zr(), pr.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", cr.start(te, () => {
      document.body.style.WebkitUserSelect = pr.current, Hn(ne);
    });
  }, Ul = (ne) => {
    se.props.onTouchEnd && se.props.onTouchEnd(ne), Zr(), St.start(X, () => {
      Qr(ne);
    });
  };
  k.useEffect(() => {
    if (!it)
      return;
    function ne(Le) {
      (Le.key === "Escape" || Le.key === "Esc") && Qr(Le);
    }
    return document.addEventListener("keydown", ne), () => {
      document.removeEventListener("keydown", ne);
    };
  }, [Qr, it]);
  const Hl = We(se.ref, Vl, Ct, r);
  !ie && ie !== 0 && (it = !1);
  const Gn = k.useRef(), Gl = (ne) => {
    const Le = se.props;
    Le.onMouseMove && Le.onMouseMove(ne), vr = {
      x: ne.clientX,
      y: ne.clientY
    }, Gn.current && Gn.current.update();
  }, dr = {}, Wn = typeof ie == "string";
  N ? (dr.title = !it && Wn && !j ? ie : null, dr["aria-describedby"] = it ? Un : null) : (dr["aria-label"] = Wn ? ie : null, dr["aria-labelledby"] = it && !Wn ? Un : null);
...
`));
  ...
  const ur = {};
  G || (Ue.onTouchStart = zl, Ue.onTouchEnd = Ul), j || (Ue.onMouseOver = an(ha, Ue.onMouseOver), Ue.onMouseLeave = an(ga, Ue.onMouseLeave), at || (ur.onMouseOver = ha, ur.onMouseLeave = ga)), M || (Ue.onFocus = an(fa, Ue.onFocus), Ue.onBlur = an(ua, Ue.onBlur), at || (ur.onFocus = fa, ur.onBlur = ua)), process.env.NODE_ENV !== "production" && se.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${se.props.title}\` or the Tooltip component.`].join(`
`));
  const Wl = k.useMemo(() => {
    var ne;
    let Le = [{
    ...
    touch: Be.current
  }), Xn = Yh(fr), ba = (n = (o = ee.popper) != null ? o : R.Popper) != null ? n : qh, va = (a = (i = (l = ee.transition) != null ? l : R.Transition) != null ? i : F) != null ? a : Oo, ya = (c = (u = ee.tooltip) != null ? u : R.Tooltip) != null ? c : Kh, wa = (m = (v = ee.arrow) != null ? v : R.Arrow) != null ? m : Jh, Xl = kr(ba, P({}, J, (b = Q.popper) != null ? b : _.popper, {
    className: Oe(Xn.popper, J == null ? void 0 : J.className, (d = (h = Q.popper) != null ? h : _.popper) == null ? void 0 : d.className)
  }), fr), Yl = kr(va, P({}, re, (f = Q.transition) != null ? f : _.transition), fr), ql = kr(ya, P({}, (g = Q.tooltip) != null ? g : _.tooltip, {
    className: Oe(Xn.tooltip, (w = (O = Q.tooltip) != null ? O : _.tooltip) == null ? void 0 : w.className)
  }), fr), Kl = kr(wa, P({}, (x = Q.arrow) != null ? x : _.arrow, {
    className: Oe(Xn.arrow, (E = (y = Q.arrow) != null ? y : _.arrow) == null ? void 0 : E.className)
  }), fr);
  return /* @__PURE__ */ $(k.Fragment, {
    children: [/* @__PURE__ */ k.cloneElement(se, Ue), /* @__PURE__ */ p(ba, P({
      as: Z ?? el,
      placement: q,
      anchorEl: V ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ $(ya, P({}, ql, {
          children: [ie, C ? /* @__PURE__ */ p(wa, P({}, Kl, {
            ref: ot
          })) : null]
        }))
      }))
...
const Zh = tl;
function bi(e, t, r) {
  return e ? /* @__PURE__ */ p(Di, { className: `papi-menu-icon-${r ? "leading" : "trailing"}`, children: /* @__PURE__ */ p("img", { src: e, alt: `${r ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function rl(e) {
  const {
    onClick: t,
    ...
    Bc,
    {
      ...
      children: r ? /* @__PURE__ */ $(Et, { children: [
        bi(a, r, !0),
        /* @__PURE__ */ p(Lc, { primary: r, inset: !a && o }),
        v ? /* @__PURE__ */ p(Di, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ p(Ms, {}) }) : bi(i, r, !1)
      ] }) : g
    }
  );
  return n ? /* @__PURE__ */ p(Zh, { title: n, placement: "right", children: /* @__PURE__ */ p("div", { children: w }) }) : w;
}
function nl(e) {
...
function Qh(e) {
  const [t, r] = ge(void 0), { parentMenuItem: n, parentItemProps: o, menuDefinition: a } = e, i = (u) => {
    ...
    let u = nl(a).filter((m) => "menuItem" in m.group);
    if (!(n != null && n.id))
      throw new Error("A valid parent menu item is required for submenus.");
    return u = u.filter(
      (m) => "menuItem" in m.group && m.group.menuItem === n.id
    ), /* @__PURE__ */ p(oa, { ...e, includedGroups: u });
  };
  return /* @__PURE__ */ $(Et, { children: [
    /* @__PURE__ */ p(rl, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ p(
      Fc,
      {
        anchorEl: t,
...
const eg = (e, t) => t.filter((o) => o.group === e).sort((o, a) => (o.order || 0) - (a.order || 0));
function oa(e) {
...
function tg(e) {
  ...
  )), /* @__PURE__ */ p(oa, { ...e, includedGroups: a });
}
function rg({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ $(
    ji,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p(Vc, { id: r, dense: !0, className: a ?? "", children: /* @__PURE__ */ p(
          tg,
          {
            commandHandler: e,
            menuDefinition: t,
...
const ol = /* @__PURE__ */ k.createContext({});
process.env.NODE_ENV !== "production" && (ol.displayName = "ListContext");
const og = ol;
function ag(e) {
  return nt("MuiList", e);
}
...
const ig = ["children", "className", "component", "dense", "disablePadding", "subheader"], sg = (e) => {
  ...
  paddingTop: 0
})), al = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const n = mt({
    props: t,
    name: "MuiList"
  }), {
  ...
  return /* @__PURE__ */ p(og.Provider, {
    value: v,
    children: /* @__PURE__ */ $(lg, P({
      as: i,
...
const cg = al, pg = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function lo(e, t, r) {
...
const sl = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions: n,
  ...
  } = t, b = he(t, pg), d = k.useRef(null), h = k.useRef({
    keys: [],
    repeating: !0,
  ...
  const f = (x) => {
    ...
    if (y === "ArrowDown")
      x.preventDefault(), yr(E, T, u, c, lo);
    else if (y === "ArrowUp")
      x.preventDefault(), yr(E, T, u, c, vi);
    else if (y === "Home")
      x.preventDefault(), yr(E, null, u, c, lo);
    else if (y === "End")
      ...
      const _ = T && !C.repeating && il(T, C);
      C.previousKeyMatched && (_ || yr(E, T, !1, c, lo, C)) ? x.preventDefault() : C.previousKeyMatched = !1;
    }
    m && m(x);
  }, g = We(d, r);
  let w = -1;
...
const dg = sl, ug = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], fg = {
  entering: {
    opacity: 1
  },
  entered: {
...
}, ll = /* @__PURE__ */ k.forwardRef(function(t, r) {
  const n = qr(), o = {
    ...
    timeout: w = o,
    // eslint-disable-next-line react/prop-types
    TransitionComponent: O = Js
  } = t, x = he(t, ug), E = k.useRef(null), y = We(E, l.ref, r), T = (z) => (G) => {
    if (z) {
      const B = E.current;
      G === void 0 ? z(B) : z(B, G);
    }
...
const gg = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"], bg = (e) => {
  const {
    classes: t,
    invisible: r
  } = e;
  ...
  const i = mt({
    ...
    component: u,
    invisible: b
  }), E = bg(x), y = (n = h.root) != null ? n : v.root;
  return /* @__PURE__ */ p(g, P({
    in: d,
    timeout: w
  }, O, {
    children: /* @__PURE__ */ p(vg, P({
      "aria-hidden": !0
    }, y, {
...
const xg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Eg = (e) => {
  const {
    open: t,
    exited: r,
    classes: n
  ...
  zIndex: -1
}), pl = /* @__PURE__ */ k.forwardRef(function(t, r) {
  var n, o, a, i, l, c;
  const u = mt({
    name: "MuiModal",
    props: t
  }), {
    BackdropComponent: m = Ng,
    BackdropProps: v,
    className: b,
  ...
  const Z = (n = (o = z == null ? void 0 : z.root) != null ? o : w.Root) != null ? n : kg, J = (a = (i = z == null ? void 0 : z.backdrop) != null ? i : w.Backdrop) != null ? a : m, Q = (l = j == null ? void 0 : j.root) != null ? l : O.root, ee = (c = j == null ? void 0 : j.backdrop) != null ? c : O.backdrop, ie = Lt({
    elementType: Z,
    externalSlotProps: Q,
    externalForwardedProps: G,
    getSlotProps: W,
    ...
    getSlotProps: (re) => te(P({}, re, {
      onClick: (A) => {
        N && N(A), re != null && re.onClick && re.onClick(A);
      }
    })),
    className: Oe(ee == null ? void 0 : ee.className, v == null ? void 0 : v.className, K == null ? void 0 : K.backdrop),
    ownerState: H
  });
  return !_ && !M && (!Y || X) ? null : /* @__PURE__ */ p(Br, {
    ref: S,
    container: f,
    disablePortal: T,
    children: /* @__PURE__ */ $(Z, P({}, ie, {
      children: [!R && m ? /* @__PURE__ */ p(J, P({}, F)) : null, /* @__PURE__ */ p(bn, {
        disableEnforceFocus: E,
        disableAutoFocus: x,
        disableRestoreFocus: C,
        isEnabled: L,
...
const Sg = ["className", "component", "elevation", "square", "variant"], Og = (e) => {
  const {
    square: t,
    elevation: r,
    variant: n,
  ...
  return P({
    ...
    backgroundImage: `linear-gradient(${gn("#fff", hi(t.elevation))}, ${gn("#fff", hi(t.elevation))})`
  }, e.vars && {
  ...
  return process.env.NODE_ENV !== "production" && qr().shadows[i] === void 0 && console.error([`MUI: The elevation provided <Paper elevation={${i}}> is not available in the theme.`, `Please make sure that \`theme.shadows[${i}]\` is defined.`].join(`
`)), /* @__PURE__ */ p(Rg, P({
    as: a,
    ownerState: m,
...
const _g = ["onEntering"], Ig = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "slots", "slotProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps", "disableScrollLock"], Mg = ["slotProps"];
function yi(e, t) {
  let r = 0;
...
const Ag = (e) => {
  ...
  const i = mt({
  ...
  } = i, _ = he(i.TransitionProps, _g), N = he(i, Ig), M = (n = E == null ? void 0 : E.paper) != null ? n : O, j = k.useRef(), z = We(j, M.ref), G = P({}, i, {
    anchorOrigin: u,
    anchorReference: v,
    elevation: f,
    marginThreshold: g,
    ...
    const re = dn(c), A = re && re.nodeType === 1 ? re : Re(j.current).body, se = A.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
  ...
  }, [c, u.horizontal, u.vertical, m, v]), te = k.useCallback((re) => ({
    ...
    const Ct = $e + A.height, _e = Ee + A.width, ot = rr(dn(c)), Be = ot.innerHeight - g, at = ot.innerWidth - g;
    if (g !== null && $e < g) {
      const Ce = $e - g;
      $e -= Ce, se.vertical += Ce;
...
`)), g !== null && Ee < g) {
  ...
  }, [c, v, W, te, g]), [S, L] = k.useState(w), X = k.useCallback(() => {
    const re = j.current;
    if (!re)
      return;
    const A = V(re);
  ...
  k.useEffect(() => (R && window.addEventListener("scroll", X), () => window.removeEventListener("scroll", X)), [c, R, X]);
  const Y = (re, A) => {
    I && I(re, A), X();
  }, H = () => {
    L(!1);
  ...
  const q = h || (c ? Re(dn(c)).body : void 0), Z = (o = x == null ? void 0 : x.root) != null ? o : Dg, J = (a = x == null ? void 0 : x.paper) != null ? a : ul, Q = Lt({
    elementType: J,
...
const Lg = ["onEntering"], Fg = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Vg = {
  vertical: "top",
  horizontal: "right"
}, zg = {
  vertical: "top",
  ...
  // We disable the focus ring for mouse, touch and keyboard users.
  outline: 0
}), ml = /* @__PURE__ */ k.forwardRef(function(t, r) {
  var n, o;
  const a = mt({
    props: t,
    name: "MuiMenu"
    ...
    slots: O = {},
    slotProps: x = {}
  } = a, E = he(a.TransitionProps, Lg), y = he(a, Fg), T = qr(), C = T.direction === "rtl", I = P({}, a, {
    autoFocus: i,
    ...
    TransitionProps: E,
    variant: w
  }), R = Ug(I), _ = i && !u && b, N = k.useRef(null), M = (V, S) => {
  ...
  k.Children.map(l, (V, S) => {
    /* @__PURE__ */ k.isValidElement(V) && (process.env.NODE_ENV !== "production" && fn.isFragment(V) && console.error(["MUI: The Menu component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join(`
`)), V.props.disabled || (w === "selectedMenu" && V.props.selected || z === -1) && (z = S));
  });
  const G = (n = O.paper) != null ? n : Gg, B = (o = x.paper) != null ? o : d, W = Lt({
    elementType: O.root,
  ...
  return /* @__PURE__ */ p(Hg, P({
    onClose: v,
    anchorOrigin: {
      vertical: "bottom",
      horizontal: C ? "right" : "left"
    },
    transformOrigin: C ? Vg : zg,
    slots: {
      paper: G,
      root: O.root
    },
...
const yt = "scrBook", Jg = "scrRef", $t = "source", Zg = "details", Qg = "Scripture Reference", eb = "Scripture Book", hl = "Type", tb = "Details";
function rb(e, t) {
  const r = t ?? !1;
  return [
    {
      ...
      id: yt,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? Qg,
      cell: (n) => {
        const o = n.row.original;
        return n.row.getIsGrouped() ? me.bookNumberToEnglishName(o.start.bookNum) : n.row.groupingColumnId === yt ? Yn(o.start) : void 0;
      },
      getGroupingValue: (n) => n.start.bookNum,
      sortingFn: (n, o) => ho(n.original.start, o.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (n) => Yn(n.start),
      id: Jg,
      header: void 0,
      cell: (n) => {
        const o = n.row.original;
        return n.row.getIsGrouped() ? void 0 : Yn(o.start);
      },
      sortingFn: (n, o) => ho(n.original.start, o.original.start),
      enableGrouping: !1
    },
    {
      ...
      id: $t,
      header: r ? (e == null ? void 0 : e.typeColumnName) ?? hl : void 0,
    ...
    },
    {
      ...
      id: Zg,
      header: (e == null ? void 0 : e.detailsColumnName) ?? tb,
      cell: (n) => n.getValue(),
      enableGrouping: !1
    }
  ];
...
const nb = (e) => {
  ...
  let r = 0;
  return e.end && ({ offset: r } = e.end), !e.end || ho(e.start, e.end) === 0 ? `${qn(e.start)}+${t}` : `${qn(e.start)}+${t}-${qn(e.end)}+${r}`;
}, Ei = (e) => `${nb({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function s0({
  sources: e,
  ...
  const [u, m] = ge([]), [v, b] = ge([{ id: yt, desc: !1 }]), [d, h] = ge({}), f = ct(
  ...
  Qe(() => {
    if (l) {
      ...
      if (_.length === 1) {
        const N = f.find((M) => Ei(M) === _[0]) || void 0;
        N && l(N);
      }
    }
  }, [d, f, l, w]);
  const O = o ?? eb, x = a ?? hl, E = [
  ...
  }, C = (R, _) => R.getIsGrouped() ? "" : D("banded-row", _ % 2 === 0 ? "even" : "odd"), I = (R, _, N) => {
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp pr-flex pr-h-full pr-w-full pr-flex-col", children: [
    !t && /* @__PURE__ */ $(
      _r,
      {
        ...
        children: [
          /* @__PURE__ */ p(Zt, { className: "pr-mb-1 pr-mt-2", children: /* @__PURE__ */ p(Ir, {}) }),
          /* @__PURE__ */ p(Qt, { position: "item-aligned", children: /* @__PURE__ */ p(Rp, { children: E.map((R) => /* @__PURE__ */ p(Ke, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ $(On, { className: "pr-relative pr-flex pr-flex-col pr-overflow-y-auto pr-p-0", children: [
      t && /* @__PURE__ */ p(Rn, { children: w.getHeaderGroups().map((R) => /* @__PURE__ */ p(xt, { children: R.headers.filter((_) => _.column.columnDef.header).map((_) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ p(Mr, { colSpan: _.colSpan, className: "top-0 pr-sticky", children: _.isPlaceholder ? void 0 : /* @__PURE__ */ $("div", { children: [
      ...
      /* @__PURE__ */ p(Pn, { children: w.getRowModel().rows.map((R, _) => /* @__PURE__ */ p(
        xt,
        {
                ...
                er,
                {
                  ...
                  children: (() => N.getIsGrouped() ? /* @__PURE__ */ $(
                    Te,
                    {
                      ...
                      type: "button",
                      children: [
                        R.getIsExpanded() && /* @__PURE__ */ p(kn, {}),
                        !R.getIsExpanded() && (c === "ltr" ? /* @__PURE__ */ p(Pi, {}) : /* @__PURE__ */ p(vc, {})),
                        " ",
...
function ob({ onSearch: e, placeholder: t, isFullWidth: r }) {
  const [n, o] = ge(""), a = (i) => {
    o(i), e(i);
  };
  return /* @__PURE__ */ p(
...
const gl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.Root,
  {
...
gl.displayName = je.List.displayName;
...
const ab = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.Trigger,
  {
    ref: r,
    ...t,
...
)), vl = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.Content,
  {
    ref: r,
    className: D(
...
vl.displayName = je.Content.displayName;
function p0({
  tabList: e,
  onSearch: t,
  searchPlaceholder: r,
  ...
  return /* @__PURE__ */ $("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ $(gl, { dir: a, children: [
      /* @__PURE__ */ p(bl, { children: e.map((i) => /* @__PURE__ */ p(ab, { value: i.value, children: i.value }, i.key)) }),
      e.map((i) => /* @__PURE__ */ p(vl, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const yl = U.forwardRef(({ className: e, orientation: t = "horizontal", decorative: r = !0, ...n }, o) => /* @__PURE__ */ p(
  Li.Root,
  {
    ref: o,
    decorative: r,
...
yl.displayName = Li.Root.displayName;
...
const Kr = xn(({ className: e, ...t }, r) => /* @__PURE__ */ p(yc, { size: 35, className: D("pr-animate-spin", e), ...t, ref: r }));
...
function h0({
  ...
  return /* @__PURE__ */ $("div", { className: D("pr-inline-grid pr-items-center pr-gap-1.5", { "pr-w-full": n }), children: [
    ...
    /* @__PURE__ */ p("p", { className: D({ "pr-hidden": !o }), children: o })
  ] });
}
function g0({
  menuProvider: e,
  ...
  const a = Mt(void 0);
  return /* @__PURE__ */ p("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ p(Wc, { position: "static", id: n, children: /* @__PURE__ */ $(
    Xc,
    {
...
), sb = U.forwardRef(({ className: e, variant: t, ...r }, n) => /* @__PURE__ */ p("div", { ref: n, role: "alert", className: D(ib({ variant: t }), e), ...r }));
...
lb.displayName = "AlertTitle";
const cb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p("div", { ref: r, className: D("pr-text-sm [&_p]:pr-leading-relaxed", e), ...t }));
...
const fb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p("p", { ref: r, className: D("pr-text-sm pr-text-muted-foreground", e), ...t }));
fb.displayName = "CardDescription";
const mb = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ p("div", { ref: r, className: D("pr-p-6 pr-pt-0", e), ...t })
);
mb.displayName = "CardContent";
const hb = U.forwardRef(
  ({ className: e, ...t }, r) => /* @__PURE__ */ p("div", { ref: r, className: D("pr-flex pr-items-center pr-p-6 pr-pt-0", e), ...t })
);
hb.displayName = "CardFooter";
function b0({ ...e }) {
  return /* @__PURE__ */ p(
    Zc,
    {
...
const gb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ $(
  xr.Root,
  {
    ref: r,
    className: D(
    ...
    ...t,
    children: [
      /* @__PURE__ */ p(xr.Track, { className: "pr-relative pr-h-2 pr-w-full pr-grow pr-overflow-hidden pr-rounded-full pr-bg-secondary", children: /* @__PURE__ */ p(xr.Range, { className: "pr-absolute pr-h-full pr-bg-primary" }) }),
      /* @__PURE__ */ p(xr.Thumb, { className: "pr-block pr-h-5 pr-w-5 pr-rounded-full pr-border-2 pr-border-primary pr-bg-background pr-ring-offset-background pr-transition-colors focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-pointer-events-none disabled:pr-opacity-50" })
    ]
  }
));
gb.displayName = xr.Root.displayName;
const bb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  bo.Root,
  {
    className: D(
...
bb.displayName = bo.Root.displayName;
const v0 = je.Root, vb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.List,
  {
    ref: r,
    className: D(
...
vb.displayName = je.List.displayName;
const yb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.Trigger,
  {
    ref: r,
    className: D(
...
yb.displayName = je.Trigger.displayName;
const wb = U.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ p(
  je.Content,
  {
    ref: r,
    className: D(
...
wb.displayName = je.Content.displayName;
function y0({
  isInstalling: e,
  handleClick: t,
  buttonText: r,
  ...
  return /* @__PURE__ */ p(
    Te,
    {
      ...
      onClick: t,
      ...o,
      children: e ? /* @__PURE__ */ p(Kr, { size: 15 }) : /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ p(wc, { size: 25, className: D("pr-h-4 pr-w-4", { "pr-mr-1": r }) }),
        r
      ] })
    }
  );
  ...
  return /* @__PURE__ */ p(
    Te,
    {
      ...
      children: e ? /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ p(Kr, { size: 15, className: "pr-mr-1 pr-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function x0({
  ...
  return /* @__PURE__ */ p(
    Te,
    {
      ...
      ...n,
      children: e ? /* @__PURE__ */ $(Et, { children: [
        /* @__PURE__ */ p(Kr, { size: 15, className: "pr-mr-1 pr-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
...
const xb = ["children", "options"], ki = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e, t) => (e[t.toLowerCase()] = t, e), { for: "htmlFor" }), Ni = { amp: "&", apos: "'", gt: ">", lt: "<", nbsp: " ", quot: "“" }, Eb = ["style", "script"], kb = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, Nb = /mailto:/i, Tb = /\n{2,}$/, wl = /^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/, Cb = /^ *> ?/gm, Sb = /^ {2,}\n/, Ob = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, xl = /^\s*(`{3,}|~{3,}) *(\S+)?([^\n]*?)?\n([\s\S]+?)\s*\1 *(?:\n *)*\n?/, El = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, Rb = /^(`+)\s*([\s\S]*?[^`])\s*\1(?!`)/, Pb = /^(?:\n *)*\n/, $b = /\r\n?/g, _b = /^\[\^([^\]]+)](:.*)\n/, Ib = /^\[\^([^\]]+)]/, Mb = /\f/g, Ab = /^\s*?\[(x|\s)\]/, kl = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, Nl = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, Tl = /^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/, Po = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?([^>]*)\/{0}>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1)[\s\S])*?)<\/\1>\n*/i, Db = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, Cl = /^<!--[\s\S]*?(?:-->)/, jb = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, $o = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, Bb = /^\{.*\}$/, Lb = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, Fb = /^<([^ >]+@[^ >]+)>/, Vb = /^<([^ >]+:\/[^ >]+)>/, zb = /-([a-z])?/gi, Sl = /^(.*\|?.*)\n *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*)\n?/, Ub = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, Hb = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, Gb = /^\[([^\]]*)\] ?\[([^\]]*)\]/, Wb = /(\[|\])/g, Xb = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, Yb = /\t/g, qb = /^ *\| */, Kb = /(^ *\||\| *$)/g, Jb = / *$/, Zb = /^ *:-+: *$/, Qb = /^ *:-+ *$/, ev = /^ *-+: *$/, tv = /^([*_])\1((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1\1(?!\1)/, rv = /^([*_])((?:\[.*?\][([].*?[)\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~+.*?~+|.)*?)\1(?!\1|\w)/, nv = /^==((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)==/, ov = /^~~((?:\[.*?\]|<.*?>(?:.*?<.*?>)?|`.*?`|.)*?)~~/, av = /^\\([^0-9A-Za-z\s])/, iv = /^[\s\S]+?(?=[^0-9A-Z\s\u00c0-\uffff&#;.()'"]|\d+\.|\n\n| {2,}\n|\w+:\S|$)/i, sv = /^\n+/, lv = /^([ \t]*)/, cv = /\\([^\\])/g, Ti = / *\n+$/, pv = /(?:^|\n)( *)$/, aa = "(?:\\d+\\.)", ia = "(?:[*+-])";
function Ol(e) {
  return "( *)(" + (e === 1 ? aa : ia) + ") +";
}
const Rl = Ol(1), Pl = Ol(2);
function $l(e) {
  return new RegExp("^" + (e === 1 ? Rl : Pl));
}
const dv = $l(1), uv = $l(2);
function _l(e) {
  return new RegExp("^" + (e === 1 ? Rl : Pl) + "[^\\n]*(?:\\n(?!\\1" + (e === 1 ? aa : ia) + " )[^\\n]*)*(\\n|$)", "gm");
}
const Il = _l(1), Ml = _l(2);
function Al(e) {
  const t = e === 1 ? aa : ia;
  return new RegExp("^( *)(" + t + ") [\\s\\S]+?(?:\\n{2,}(?! )(?!\\1" + t + " (?!" + t + " ))\\n*|\\s*\\n*$)");
}
const Dl = Al(1), jl = Al(2);
function Ci(e, t) {
  const r = t === 1, n = r ? Dl : jl, o = r ? Il : Ml, a = r ? dv : uv;
  return { t(i, l, c) {
    const u = pv.exec(c);
    return u && (l.o || !l._ && !l.u) ? n.exec(i = u[1] + i) : null;
  }, i: ae.HIGH, l(i, l, c) {
    const u = r ? +i[2] : void 0, m = i[0].replace(Tb, `
`).match(o);
    let v = !1;
...
const fv = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, mv = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, Bl = [wl, xl, El, kl, Tl, Nl, Cl, Sl, Il, Dl, Ml, jl], hv = [...Bl, /^[^\n]+(?:  \n|\n{2,})/, Po, $o];
function gv(e) {
  return e.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g, "a").replace(/[çÇ]/g, "c").replace(/[ðÐ]/g, "d").replace(/[ÈÉÊËéèêë]/g, "e").replace(/[ÏïÎîÍíÌì]/g, "i").replace(/[Ññ]/g, "n").replace(/[øØœŒÕõÔôÓóÒò]/g, "o").replace(/[ÜüÛûÚúÙù]/g, "u").replace(/[ŸÿÝý]/g, "y").replace(/[^a-z0-9- ]/gi, "").replace(/ /gi, "-").toLowerCase();
}
function bv(e) {
  return ev.test(e) ? "right" : Zb.test(e) ? "center" : Qb.test(e) ? "left" : null;
}
function Si(e, t, r) {
  const n = r.$;
  r.$ = !0;
  ...
  return o.forEach(function(i, l) {
    i.type === "tableSeparator" ? l !== 0 && l !== o.length - 1 && a.push([]) : (i.type !== "text" || o[l + 1] != null && o[l + 1].type !== "tableSeparator" || (i.v = i.v.replace(Jb, "")), a[a.length - 1].push(i));
  }), a;
}
function vv(e, t, r) {
  r._ = !0;
  const n = Si(e[1], t, r), o = e[2].replace(Kb, "").split("|").map(bv), a = function(i, l, c) {
    return i.trim().split(`
`).map(function(u) {
      return Si(u, l, c);
    });
...
var ae;
function kv(e, t = {}) {
  t.overrides = t.overrides || {}, t.slugify = t.slugify || gv, t.namedCodesToUnicode = t.namedCodesToUnicode ? It({}, Ni, t.namedCodesToUnicode) : Ni;
  const r = t.createElement || k.createElement;
  function n(d, h, ...f) {
    const g = fo(t.overrides, `${d}.props`, {});
    return r(function(w, O) {
      const x = fo(O, w);
      return x ? typeof x == "function" || typeof x == "object" && "render" in x ? x : fo(O, `${w}.component`, w) : w;
    }(d, t.overrides), It({}, h, g, { className: Ev(h == null ? void 0 : h.className, g.className) || void 0 }), ...f);
  }
  function o(d) {
    let h = !1;
    t.forceInline ? h = !0 : t.forceBlock || (h = Xb.test(d) === !1);
    const f = m(u(h ? d : `${d.trimEnd().replace(sv, "")}
...
`, { _: h }));
  ...
  function a(d) {
    ...
    return h ? h.reduce(function(f, g, w) {
      ...
      if (O !== -1) {
        const x = function(C) {
          return C.indexOf("-") !== -1 && C.match(jb) === null && (C = C.replace(zb, function(I, R) {
            return R.toUpperCase();
          })), C;
        }(g.slice(0, O)).trim(), E = function(C) {
          const I = C[0];
          return (I === '"' || I === "'") && C.length >= 2 && C[C.length - 1] === I ? C.slice(1, -1) : C;
        }(g.slice(O + 1).trim()), y = ki[x] || x, T = f[y] = function(C, I) {
          return C === "style" ? I.split(/;\s?/).reduce(function(R, _) {
            const N = _.slice(0, _.indexOf(":"));
            return R[N.replace(/(-[a-z])/g, (M) => M[1].toUpperCase())] = _.slice(N.length + 1).trim(), R;
          }, {}) : C === "href" ? Yt(I) : (I.match(Bb) && (I = I.slice(1, I.length - 1)), I === "true" || I !== "false" && I);
        }(x, E);
        typeof T == "string" && (Po.test(T) || $o.test(T)) && (f[y] = k.cloneElement(o(T.trim()), { key: w }));
      } else
        g !== "style" && (f[ki[g] || g] = !0);
      return f;
    }, {}) : null;
  }
  const i = [], l = {}, c = { blockQuote: { t: st(wl), i: ae.HIGH, l: (d, h, f) => ({ v: h(d[0].replace(Cb, ""), f) }), h: (d, h, f) => n("blockquote", { key: f.k }, h(d.v, f)) }, breakLine: { t: wr(Sb), i: ae.HIGH, l: po, h: (d, h, f) => n("br", { key: f.k }) }, breakThematic: { t: st(Ob), i: ae.HIGH, l: po, h: (d, h, f) => n("hr", { key: f.k }) }, codeBlock: { t: st(El), i: ae.MAX, l: (d) => ({ v: d[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""), M: void 0 }), h: (d, h, f) => n("pre", { key: f.k }, n("code", It({}, d.O, { className: d.M ? `lang-${d.M}` : "" }), d.v)) }, codeFenced: { t: st(xl), i: ae.MAX, l: (d) => ({ O: a(d[3] || ""), v: d[4], M: d[2] || void 0, type: "codeBlock" }) }, codeInline: { t: vt(Rb), i: ae.LOW, l: (d) => ({ v: d[2] }), h: (d, h, f) => n("code", { key: f.k }, d.v) }, footnote: { t: st(_b), i: ae.MAX, l: (d) => (i.push({ I: d[2], j: d[1] }), {}), h: uo }, footnoteReference: { t: bt(Ib), i: ae.HIGH, l: (d) => ({ v: d[1], B: `#${t.slugify(d[1])}` }), h: (d, h, f) => n("a", { key: f.k, href: Yt(d.B) }, n("sup", { key: f.k }, d.v)) }, gfmTask: { t: bt(Ab), i: ae.HIGH, l: (d) => ({ R: d[1].toLowerCase() === "x" }), h: (d, h, f) => n("input", { checked: d.R, key: f.k, readOnly: !0, type: "checkbox" }) }, heading: { t: st(t.enforceAtxHeadings ? Nl : kl), i: ae.HIGH, l: (d, h, f) => ({ v: un(h, d[2], f), T: t.slugify(d[2]), C: d[1].length }), h: (d, h, f) => n(`h${d.C}`, { id: d.T, key: f.k }, h(d.v, f)) }, headingSetext: { t: st(Tl), i: ae.MAX, l: (d, h, f) => ({ v: un(h, d[1], f), C: d[2] === "=" ? 1 : 2, type: "heading" }) }, htmlComment: { t: wr(Cl), i: ae.HIGH, l: () => ({}), h: uo }, image: { t: vt(mv), i: ae.HIGH, l: (d) => ({ D: d[1], B: Ri(d[2]), F: d[3] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D || void 0, title: d.F || void 0, src: Yt(d.B) }) }, link: { t: bt(fv), i: ae.LOW, l: (d, h, f) => ({ v: wv(h, d[1], f), B: Ri(d[2]), F: d[3] }), h: (d, h, f) => n("a", { key: f.k, href: Yt(d.B), title: d.F }, h(d.v, f)) }, linkAngleBraceStyleDetector: { t: bt(Vb), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], type: "link" }) }, linkBareUrlDetector: { t: (d, h) => h.N ? null : bt(Lb)(d, h), i: ae.MAX, l: (d) => ({ v: [{ v: d[1], type: "text" }], B: d[1], F: void 0, type: "link" }) }, linkMailtoDetector: { t: bt(Fb), i: ae.MAX, l(d) {
    let h = d[1], f = d[1];
    return Nb.test(f) || (f = "mailto:" + f), { v: [{ v: h.replace("mailto:", ""), type: "text" }], B: f, type: "link" };
  } }, orderedList: Ci(n, 1), unorderedList: Ci(n, 2), newlineCoalescer: { t: st(Pb), i: ae.LOW, l: po, h: () => `
` }, paragraph: { t: yv, i: ae.LOW, l: co, h: (d, h, f) => n("p", { key: f.k }, h(d.v, f)) }, ref: { t: bt(Ub), i: ae.MAX, l: (d) => (l[d[1]] = { B: d[2], F: d[4] }, {}), h: uo }, refImage: { t: vt(Hb), i: ae.MAX, l: (d) => ({ D: d[1] || void 0, P: d[2] }), h: (d, h, f) => n("img", { key: f.k, alt: d.D, src: Yt(l[d.P].B), title: l[d.P].F }) }, refLink: { t: bt(Gb), i: ae.MAX, l: (d, h, f) => ({ v: h(d[1], f), Z: h(d[0].replace(Wb, "\\$1"), f), P: d[2] }), h: (d, h, f) => l[d.P] ? n("a", { key: f.k, href: Yt(l[d.P].B), title: l[d.P].F }, h(d.v, f)) : n("span", { key: f.k }, h(d.Z, f)) }, table: { t: st(Sl), i: ae.HIGH, l: vv, h: (d, h, f) => n("table", { key: f.k }, n("thead", null, n("tr", null, d.L.map(function(g, w) {
    return n("th", { key: w, style: Oi(d, w) }, h(g, f));
  }))), n("tbody", null, d.A.map(function(g, w) {
    return n("tr", { key: w }, g.map(function(O, x) {
      return n("td", { key: x, style: Oi(d, x) }, h(O, f));
    }));
  }))) }, tableSeparator: { t: function(d, h) {
    return h.$ ? (h._ = !0, qb.exec(d)) : null;
  }, i: ae.HIGH, l: function() {
    return { type: "tableSeparator" };
  }, h: () => " | " }, text: { t: wr(iv), i: ae.MIN, l: (d) => ({ v: d[0].replace(Db, (h, f) => t.namedCodesToUnicode[f] ? t.namedCodesToUnicode[f] : h) }), h: (d) => d.v }, textBolded: { t: vt(tv), i: ae.MED, l: (d, h, f) => ({ v: h(d[2], f) }), h: (d, h, f) => n("strong", { key: f.k }, h(d.v, f)) }, textEmphasized: { t: vt(rv), i: ae.LOW, l: (d, h, f) => ({ v: h(d[2], f) }), h: (d, h, f) => n("em", { key: f.k }, h(d.v, f)) }, textEscaped: { t: vt(av), i: ae.HIGH, l: (d) => ({ v: d[1], type: "text" }) }, textMarked: { t: vt(nv), i: ae.LOW, l: co, h: (d, h, f) => n("mark", { key: f.k }, h(d.v, f)) }, textStrikethroughed: { t: vt(ov), i: ae.LOW, l: co, h: (d, h, f) => n("del", { key: f.k }, h(d.v, f)) } };
  t.disableParsingRawHTML !== !0 && (c.htmlBlock = { t: wr(Po), i: ae.HIGH, l(d, h, f) {
    const [, g] = d[3].match(lv), w = new RegExp(`^${g}`, "gm"), O = d[3].replace(w, ""), x = (E = O, hv.some((I) => I.test(E)) ? xv : un);
    var E;
    const y = d[1].toLowerCase(), T = Eb.indexOf(y) !== -1;
    f.N = f.N || y === "a";
    const C = T ? d[3] : x(h, O, f);
    return f.N = !1, { O: a(d[2]), v: C, G: T, H: T ? y : d[1] };
  }, h: (d, h, f) => n(d.H, It({ key: f.k }, d.O), d.G ? d.v : h(d.v, f)) }, c.htmlSelfClosing = { t: wr($o), i: ae.HIGH, l: (d) => ({ O: a(d[2] || ""), H: d[1] }), h: (d, h, f) => n(d.H, It({}, d.O, { key: f.k })) });
  const u = function(d) {
    let h = Object.keys(d);
    function f(g, w) {
      let O = [], x = "";
...
const Nv = (e) => {
  ...
  return k.cloneElement(kv(t, r), n);
};
function k0({ id: e, markdown: t }) {
  return /* @__PURE__ */ p("div", { id: e, className: "pr-prose", children: /* @__PURE__ */ p(Nv, { children: t }) });
}
const Tv = xn((e, t) => /* @__PURE__ */ $(
  Te,
  {
    ref: t,
    ...
    ...e,
    children: [
      /* @__PURE__ */ p(xc, { size: 16, className: "pr-mr-2 pr-h-4 pr-w-4 pr-text-gray-700 hover:pr-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ p(
        kn,
        {
...
var Cv = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(Cv || {});
function N0({ id: e, groups: t }) {
  return /* @__PURE__ */ p("div", { id: e, children: /* @__PURE__ */ $(Ao, { children: [
    /* @__PURE__ */ p(Wi, { asChild: !0, children: /* @__PURE__ */ p(Tv, {}) }),
    /* @__PURE__ */ p(Cn, { children: t.map((r) => /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ p(zr, { children: r.label }),
      /* @__PURE__ */ p(fp, { children: r.items.map((n) => /* @__PURE__ */ p("div", { children: n.itemType === 0 ? /* @__PURE__ */ p(Do, { onClick: n.onClick, children: n.label }) : /* @__PURE__ */ p(Yi, { onClick: n.onClick, value: n.label, children: n.label }) }, n.label)) }),
      /* @__PURE__ */ p(Sn, {})
    ] }, r.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ $("div", { className: "pr-flex pr-flex-col pr-items-center", children: [
          /* @__PURE__ */ $("div", { className: "pr-flex pr-items-center pr-rounded-md pr-bg-gray-100 pr-px-2 pr-py-1", children: [
            /* @__PURE__ */ p(Ec, { className: "pr-mr-1 pr-h-4 pr-w-4" }),
        ...
        /* @__PURE__ */ $("div", { className: "pr-ml-auto pr-flex pr-flex-col pr-space-y-2", children: [
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ p(kc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ $(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ p(Nc, { className: "pr-ml-1 pr-inline pr-h-4 pr-w-4" })
              ]
            }
          )
        ] })
...
function Sv({ id: e, versionHistory: t }) {
...
function S0({
  ...
  return /* @__PURE__ */ p("div", { id: e, className: "pr-border-t pr-pb-4 pr-pt-4", children: /* @__PURE__ */ $("div", { className: "pr-md:flex-row pr-md:space-x-8 pr-flex pr-flex-col pr-space-x-0", children: [
    /* @__PURE__ */ p(Sv, { versionHistory: o }),
...
export {
  ...
  fp as DropdownMenuGroup,
  Xi as DropdownMenuItem,
  Cv as DropdownMenuItemType,
  ...
  Xv as DropdownMenuSub,
  hp as DropdownMenuSubContent,
  mp as DropdownMenuSubTrigger,
  Wi as DropdownMenuTrigger,
  w0 as EnableButton,
  Tv as FilterButton,
  N0 as FilterDropdown,
  S0 as Footer,
  ng as GridMenu,
  Kg as HamburgerMenuButton,
  Kv as INVENTORY_STRING_KEYS,
  i0 as IconButton,
  Vr as Input,
  y0 as InstallButton,
  Jv as Inventory,
  Ar as Label,
  qt as LabelPosition,
  k0 as MarkdownRenderer,
  rl as MenuItem,
  C0 as MoreInfo,
  p0 as NavigationContentSearch,
  T0 as NoExtensionsFound,
  s0 as ScriptureResultsViewer,
  t0 as ScrollGroupSelector,
  ob as SearchBar,
  _r as Select,
  Qt as SelectContent,
  Rp as SelectGroup,
  ...
  yl as Separator,
  d0 as SettingsList,
  f0 as SettingsListHeader,
  u0 as SettingsListItem,
  gb as ShadCnSlider,
  bb as ShadCnSwitch,
  l0 as Slider,
  c0 as Snackbar,
  ...
  g0 as Toolbar,
  E0 as UpdateButton,
  Sv as VersionHistory,
  gl as VerticalTabs,
  vl as VerticalTabsContent,
  bl as VerticalTabsList,
  ab as VerticalTabsTrigger,
  Sp as buttonVariants,
  jo as getSortingIcon,
  Qv as inventoryCountColumn,
  Zv as inventoryItemColumn,
  e0 as inventoryStatusColumn,
  _0 as sonner,
  O0 as useEvent,
  R0 as useEventAsync,
  Ro as usePromise
