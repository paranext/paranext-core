  ...
  return /* @__PURE__ */ u(
    Te,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Bi, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_structureLocked_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
