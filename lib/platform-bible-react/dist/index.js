...
se(Le, "Original", new Le(ft.Original)), se(Le, "Septuagint", new Le(ft.Septuagint)), se(Le, "Vulgate", new Le(ft.Vulgate)), se(Le, "English", new Le(ft.English)), se(Le, "RussianProtestant", new Le(ft.RussianProtestant)), se(Le, "RussianOrthodox", new Le(ft.RussianOrthodox));
let Lt = Le;
function ri(e, t) {
  const n = t[0];
  ...
  createColumn: (e, t) => {
    e.getAutoFilterFn = () => {
      ...
      t.setColumnFilters((r) => {
        const o = e.getFilterFn(), i = r == null ? void 0 : r.find((p) => p.id === e.id), s = gt(n, i ? i.value : void 0);
        if (si(o, s, e)) {
          var a;
...
function st(e, t, n = {
  ...
  return Ct(e) && Ct(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (Ct(t[o]) && o in e && Ct(e[o]) ? r[o] = st(e[o], t[o], n) : n.clone ? r[o] = Ct(t[o]) ? Bs(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function _c(e) {
  const {
...
function On(e) {
  for (var t = ze(e), n = ki(e); n && Kp(n) && lt(n).position === "static"; )
    n = ki(n);
  return n && (Qe(n) === "html" || Qe(n) === "body" && lt(n).position === "static") ? t : n || Jp(e) || t;
}
function Co(e) {
...
var Yg = function(t) {
  return t.scrollTop;
}, fn = "unmounted", St = "exited", Et = "entering", jt = "entered", ro = "exiting", dt = /* @__PURE__ */ function(e) {
  Wg(t, e);
  function t(r, o) {
    var i;
...
function ev({ onSearch: e, placeholder: t, isFullWidth: n }) {
  const [r, o] = Ee(""), i = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ b(
...
const iv = Fe.Root, Sh = ie.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Fe.List,
  {
    ref: n,
    className: re(
...
const sv = ie.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ b(
  Fe.Trigger,
  {
    ref: n,
    ...t,
