...
var Ft = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { c as m, g as Ae, a as Ka, C as De, A as de, P as Le, b as Qe, B as q, d as je, e as Fe, f as Be, h as Ee, i as Li, k as ji, j as Fi, E as Bi, l as qa, r as be, m as Ui, n as wn, o as ra, p as aa, L as Et, R as Ga, q as Yr, D as Ea, s as Ta, t as Sa, u as za, T as un, v as jr, w as Kt, x as Ha, y as qt, z as Gt, F as Ht, G as pn, H as Ya, I as We, J as _r, K as Te, M as Se, N as ze, S as Nr, O as nr, Q as Ki, U as Tr, V as Je, W as Pe, Z as tr, X as Ie, Y as ir, _ as Wa, $ as Xa, a0 as Wr, a1 as Ja, a2 as hn, a3 as qi, a4 as Gi, a5 as Hi, a6 as Ra, a7 as gn, a8 as oa, a9 as fn, aa as Yi, ab as Wi, ac as Xi, ad as Ji, ae as mn, af as Zi, ag as la, ah as yo, ai as da, aj as Qi, ak as ts, al as es, am as rs, an as as, ao as Sr, ap as Za, aq as os, ar as ns } from "./resizable-C2eEiE_z.js";
import { as as rg, at as ag, au as og, av as ng, aw as ig, ax as sg, ay as cg, az as lg, aA as dg, aB as wg, aC as ug, aD as pg, aE as hg, aF as gg, aG as fg, aH as mg, aI as vg, aJ as bg, aK as xg, aL as yg, aM as kg, aN as _g, aO as Ng, aP as Cg, aQ as Eg } from "./resizable-C2eEiE_z.js";
import { jsx as a, jsxs as u, Fragment as ut } from "react/jsx-runtime";
import { Canon as xt } from "@sillsdev/scripture";
import { Check as Ze, Clock as ko, ChevronsLeft as _o, ChevronsRight as No, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as is, ArrowRight as ss, ChevronDown as lr, BoldIcon as cs, ItalicIcon as ls, X as Qa, AtSign as vn, Pencil as ds, Trash2 as ws, ArrowUp as bn, MoreHorizontal as us, MailOpen as ps, Mail as hs, ChevronUp as gs, FilterIcon as fs, ArrowLeftIcon as ms, ChevronLeftIcon as vs, ChevronRightIcon as bs, ArrowRightIcon as xs, Copy as xn, Filter as ys, User as ks, Link as _s, CircleHelp as Ns, Undo as Cs, Redo as Es, SquareX as yn, FunctionSquare as kn, SquareSigma as _n, Ban as Ts, AlertCircle as Ma, CircleCheckIcon as Ss, CircleXIcon as zs, CircleHelpIcon as Rs, ArrowUpIcon as Ds, ArrowDownIcon as Os, ScrollText as Ms, ChevronsUpDown as $s, MenuIcon as As, Menu as Is, EllipsisVertical as Ps, MoreVertical as Co } from "lucide-react";
import { Section as wt, getChaptersForBook as Vs, formatScrRef as Ne, getSectionForBook as xr, formatRelativeDate as Ls, formatReplacementString as Xe, sanitizeHtml as to, NumberFormat as Nn, formatBytes as js, getCurrentLocale as Fs, usfmMarkers as Fr, getFormatCallerFunction as Bs, deepEqual as Us, isString as Eo, compareScrRefs as $a, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Ks, getLocalizeKeyForScrollGroupId as To, formatReplacementStringToArray as So, collectUsjMarkers as qs } from "platform-bible-utils";
import Jt, { useRef as B, useMemo as $, useState as k, useCallback as L, useEffect as K, useImperativeHandle as Gs, useLayoutEffect as Zt, createContext as eo, useContext as Cn, Component as Hs, createElement as zo, Suspense as Ys, forwardRef as En, useId as Ro, Fragment as dr } from "react";
import { IconSelector as Tn, IconCheck as na, IconChevronDown as Ws, IconChevronUp as Xs, IconLayoutSidebar as Js, IconLayoutSidebarRight as Zs, IconChevronRight as Sn, IconSearch as Qs, IconLoader as tc, IconAlertOctagon as ec, IconAlertTriangle as rc, IconInfoCircle as ac, IconCircleCheck as oc } from "@tabler/icons-react";
import { createEditor as zn, $getRoot as Ve, $createParagraphNode as zr, $getSelection as Qt, HISTORY_MERGE_TAG as ro, ParagraphNode as Rn, TextNode as Dn, $getPreviousSelection as nc, $isRangeSelection as me, $caretFromPoint as ic, $getSiblingCaret as On, $getChildCaret as sc, $getAdjacentChildCaret as cc, $isChildCaret as lc, $normalizeCaret as dc, $setSelectionFromCaretRange as wc, $getCollapsedCaretRange as uc, $getCaretInDirection as Do, $splitAtPointCaretNext as pc, $isTextPointCaret as hc, $findMatchingParent as Mn, $isElementNode as Cr, mergeRegister as Re, getDOMTextNode as gc, isHTMLElement as fc, CLEAR_EDITOR_COMMAND as $n, COMMAND_PRIORITY_EDITOR as ao, shallowMergeConfig as mc, defineExtension as ie, safeCast as er, createState as vc, FORMAT_TEXT_COMMAND as An, $isNodeSelection as In, COMMAND_PRIORITY_LOW as Pn, RootNode as bc, LineBreakNode as xc, TabNode as yc, $isEditorState as kc, createCommand as _c, CLICK_COMMAND as Nc, isDOMNode as Cc, $getNodeFromDOMNode as Ec, $createNodeSelection as Tc, $setSelection as Sc, $getEditor as zc, DecoratorNode as Aa, $getState as Rc, toggleTextFormatType as Oo, TEXT_TYPE_TO_FORMAT as Dc, $setState as Oc, addClassNamesToElement as Vn, $create as Mc, $getNodeByKey as $c, removeClassNamesFromElement as Ac, KEY_TAB_COMMAND as Ic, $isBlockElementNode as Pc, $createRangeSelection as Vc, $normalizeSelection__EXPERIMENTAL as Lc, OUTDENT_CONTENT_COMMAND as jc, INDENT_CONTENT_COMMAND as Mo, INSERT_TAB_COMMAND as Fc, COMMAND_PRIORITY_CRITICAL as oo, $isDecoratorNode as Bc, $isParagraphNode as Uc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as Ln, $insertNodes as Kc } from "lexical";
import { HeadingNode as qc, QuoteNode as Gc, registerRichText as Hc } from "@lexical/rich-text";
import { flushSync as Yc, createPortal as Wc } from "react-dom";
import { $isTableSelection as Xc } from "@lexical/table";
import { createHeadlessEditor as jn } from "@lexical/headless";
import { $generateHtmlFromNodes as Jc, $generateNodesFromDOM as Zc } from "@lexical/html";
import { Avatar as no, Select as Ut, Checkbox as $o, Slot as Rr, Tabs as we, Menubar as xe, ContextMenu as Ot, Progress as Ao, Slider as Mr, Switch as Io } from "radix-ui";
import { useReactTable as Fn, getFilteredRowModel as Qc, getSortedRowModel as Bn, getPaginationRowModel as tl, getCoreRowModel as Un, flexRender as yr, getGroupedRowModel as el, getExpandedRowModel as rl } from "@tanstack/react-table";
import al from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Pa, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as ol, isInsertEmbedOpOfType as $r, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
import { Toaster as cl } from "sonner";
...
function ll({
  ...
  return /* @__PURE__ */ u(Le, { open: w, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ a(je, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: /* @__PURE__ */ a(Ee, { heading: i, children: t.map((g) => /* @__PURE__ */ u(
      De,
      {
        onSelect: () => h(g),
...
function Qu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (c) => !r(c, n)
    ), s = [n, ...i.slice(0, o - 1)];
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(de).find(
            (x) => de[x].toLowerCase() === f.toLowerCase()
          ))(c);
...
function ha({
  ...
  const F = be(), [S, _] = k(!1), [T, N] = k(""), [M, U] = k(""), [y, Y] = k("books"), [j, W] = k(void 0), [O, V] = k(
    void 0
  ), [X, Q] = k(void 0), [pt, yt] = k(!1), Pt = B(null), G = B(!1), tt = B(void 0), ht = B(void 0), at = B(void 0), mt = B(void 0), ue = B({}), Tt = B({}), kt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ), Vt = $(() => o ? o() : Ui, [o]), Lt = $(() => ({
    [wt.OT]: Vt.filter((H) => xt.isBookOT(H)),
    [wt.NT]: Vt.filter((H) => xt.isBookNT(H)),
    [wt.DC]: Vt.filter((H) => xt.isBookDC(H)),
    [wt.Extra]: Vt.filter((H) => xt.extraBooks().includes(H))
  }), [Vt]), gt = $(() => Object.values(Lt).flat(), [Lt]), Yt = $(() => {
    if (!M.trim()) return Lt;
    const b = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((rt) => {
      b[rt] = Lt[rt].filter((It) => qa(It, M, n));
    }), b;
  }, [Lt, M, n]), D = $(
    () => hl(M, gt, n),
    [M, gt, n]
  ...
  const lt = L(() => {
    ...
    (b) => {
      const H = O ?? (D == null ? void 0 : D.book), rt = X ?? (D == null ? void 0 : D.chapterNum);
      !H || !rt || (kt({
        book: H,
        chapterNum: rt,
        verseNum: b
    ...
    (b) => {
      const H = y === "chapters" ? j : D == null ? void 0 : D.book;
      if (H) {
        if (d && d(H, b) > 1) {
          V(H), Q(b), Y("verses"), N("");
          return;
    ...
    Y("books"), W(void 0), V(void 0), Q(void 0), setTimeout(() => {
      ht.current && ht.current.focus();
    }, 0);
  }, []), re = L(() => {
    const b = O;
    V(void 0), Q(void 0), b ? (W(b), Y("chapters"), N("")) : _t();
  }, [O, _t]), $t = L((b) => {
    _(b), b && (Y("books"), W(void 0), V(void 0), Q(void 0), U(""));
  }, []);
  K(() => {
    P && $t(!1);
  }, [P, $t]);
  ...
  K(() => {
    var b;
    Rt !== 0 && ((b = ht.current) == null || b.focus());
  }, [Rt]), Gs(
    R,
    () => ({
      open: () => {
  ...
  const { otLong: oe, ntLong: Wt, dcLong: pe, extraLong: A } = {
    ...
    () => ul(M),
    [M]
  ), st = $(() => !d || !D || !D.chapterNum || !et ? !1 : d(D.book, D.chapterNum) > 0, [d, D, et]), bt = L(
    (b) => w ? Po(b, w) : !1,
    [w]
  ), St = L(
    (b) => (H) => w ? pl(b, H, w) : !1,
    ...
    (b, H) => (rt) => w ? pa(b, H, rt, w) : !1,
    [w]
  ), se = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", ce = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Dr = L(
    (b) => {
    ...
    (b) => {
      var _e, Me, qe;
      if (b.ctrlKey) return;
      const { isLetter: H, isDigit: rt } = Vo(b.key);
      if ((y === "chapters" || y === "verses") && (b.key === " " || b.key === "Enter")) {
        ...
        const Ct = (_e = tt.current) == null ? void 0 : _e.querySelector(
      ...
      if ((y === "chapters" || y === "verses") && (H || rt)) {
        b.preventDefault(), b.stopPropagation();
        return;
      }
      if (y === "chapters" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), _t();
        return;
      }
      if (y === "verses" && b.key === "Backspace") {
        b.preventDefault(), b.stopPropagation(), re();
        return;
      }
      const It = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(b.key);
      if (y === "verses" && It) {
        const zt = O, Nt = X;
        if (!zt || !Nt || !d) return;
        const Ct = d(zt, Nt);
        if (!Ct) return;
        (Me = tt.current) == null || Me.focus();
        const ft = (() => {
          if (!T) return 1;
          const Ge = T.match(/:(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            ft !== 0 && (jt = ft > 1 ? ft - 1 : Ct);
            break;
          case "ArrowRight":
            ft !== 0 && (jt = ft < Ct ? ft + 1 : 1);
            break;
          case "ArrowUp":
            jt = ft === 0 ? Ct : Math.max(1, ft - he);
            break;
          case "ArrowDown":
            jt = ft === 0 ? 1 : Math.min(Ct, ft + he);
            break;
          default:
            return;
        }
        jt !== ft && (b.preventDefault(), b.stopPropagation(), N(
          `${zt} ${de[zt] || ""} ${Nt}:${jt}`
        ), setTimeout(() => {
          const Ge = Tt.current[jt];
          Ge && Ge.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((y === "chapters" || y === "books" && D) && It) {
        const zt = y === "chapters" ? j : D == null ? void 0 : D.book;
        if (!zt) return;
        y === "chapters" && ((qe = tt.current) == null || qe.focus());
        const Nt = (() => {
          if (!T) return 1;
          const he = T.match(/(\d+)$/);
        ...
        switch (b.key) {
          case "ArrowLeft":
            Nt !== 0 && (ft = Nt > 1 ? Nt - 1 : Ct);
            break;
          case "ArrowRight":
            Nt !== 0 && (ft = Nt < Ct ? Nt + 1 : 1);
            break;
          case "ArrowUp":
            ft = Nt === 0 ? Ct : Math.max(1, Nt - jt);
            break;
          case "ArrowDown":
            ft = Nt === 0 ? 1 : Math.min(Ct, Nt + jt);
            break;
          default:
            return;
        }
        ft !== Nt && (b.preventDefault(), b.stopPropagation(), N(
          `${zt} ${de[zt] || ""} ${ft}`
        ), setTimeout(() => {
          const he = ue.current[ft];
    ...
    if (b.key === "ArrowUp" || b.key === "ArrowDown") {
      (It = ht.current) == null || It.focus();
      return;
    }
    const { isLetter: H, isDigit: rt } = Vo(b.key);
    (H || rt) && (b.preventDefault(), U((_e) => _e + b.key), ht.current.focus(), yt(!1));
  }, []);
  return Zt(() => {
    const b = setTimeout(() => {
      if (S && y === "books" && at.current && mt.current) {
        const H = at.current, rt = mt.current, It = rt.offsetTop, _e = H.clientHeight, Me = rt.clientHeight, qe = It - _e / 2 + Me / 2;
        H.scrollTo({
          top: Math.max(0, qe),
          behavior: "smooth"
        }), N(qn(t.book));
    ...
    if (y === "chapters" && j) {
      const b = j === t.book, H = b ? t.chapterNum : 1;
      N(
        `${j} ${de[j] || ""} ${H}`
      ), setTimeout(() => {
        if (at.current)
          if (b) {
            const rt = ue.current[t.chapterNum];
  ...
  }, [y, j, D, t.book, t.chapterNum]), Zt(() => {
    if (y === "verses" && O && X !== void 0) {
      const b = O === t.book && X === t.chapterNum, H = b ? t.verseNum : 1;
      N(
        `${O} ${de[O] || ""} ${X}:${H}`
      ), setTimeout(() => {
        if (at.current)
          if (b) {
            const rt = Tt.current[t.verseNum];
            rt && rt.scrollIntoView({ block: "center", behavior: "smooth" });
          } else
            at.current.scrollTo({ top: 0 });
        tt.current && tt.current.focus();
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Le, { open: S, onOpenChange: $t, modal: z, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        ...
        onClick: (b) => {
          G.current && (G.current = !1, b.preventDefault());
        },
        children: [
          h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: ct }),
          f && /* @__PURE__ */ a(
            Tn,
            {
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        onPointerDownOutside: (b) => {
          const { target: H } = b;
          S && Pt.current && H instanceof Node && Pt.current.contains(H) && (G.current = !0, $t(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Fe,
            ...
            children: [
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ke.map(
                  ({ onClick: b, disabled: H, title: rt, icon: It }) => /* @__PURE__ */ a(
                    q,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  q,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: y === "verses" ? re : _t,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: F === "ltr" ? /* @__PURE__ */ a(is, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && j && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Ae(j, n) }),
                y === "verses" && O && X !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Ae(O, n)} ${X}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: y === "verses" ? ce : se
                  }
                )
              ] }),
              !pt && /* @__PURE__ */ u(Be, { ref: at, children: [
                y === "books" && /* @__PURE__ */ u(ut, { children: [
                  !D && Object.entries(Yt).map(([b, H]) => {
                    if (H.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Ee, { heading: J(b), children: H.map((rt) => /* @__PURE__ */ a(
                          Kn,
                          {
                            bookId: rt,
                            onSelect: (It) => Oe(It),
                            section: xr(rt),
                            commandValue: `${rt} ${de[rt]}`,
                            ref: rt === t.book ? mt : void 0,
                            localizedBookNames: n,
                            disabled: bt(rt)
                          },
                          rt
                  ...
                  D && /* @__PURE__ */ a(Ee, { children: /* @__PURE__ */ a(
                    De,
                    {
                      value: `${D.book} ${de[D.book]} ${D.chapterNum || ""}:${D.verseNum || ""})}`,
                      onSelect: lt,
                      disabled: !!w && pa(
                        D.book,
                        D.chapterNum ?? 1,
                      ...
                      children: Ne(
                        ...
                        n ? Ka(D.book, n) : void 0
                      )
                    },
                    "top-match"
                  ) }),
                  D && st && D.chapterNum && d && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${Ae(D.book, n)} ${D.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      jo,
                      {
                        ...
                        onVerseSelect: Mt,
                        setVerseRef: ot,
                        isVerseDisabled: At(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !st && sr(D.book) > 1 && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: Ae(D.book, n) }),
                ...
                y === "chapters" && j && /* @__PURE__ */ a(
                  Lo,
                  {
                    ...
                    onChapterSelect: te,
                    setChapterRef: E,
                    isChapterDisabled: St(j),
                    className: "tw:p-4"
                  }
                ),
                y === "verses" && O && X !== void 0 && d && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: O,
                    chapterNum: X,
...
function Fo({
  ...
  const [R, P] = k(!1), F = d ?? l, S = (T) => T.length > 0 && typeof T[0] == "object" && "options" in T[0], _ = (T, N) => {
    const M = l(T), U = typeof T == "object" && "secondaryLabel" in T ? T.secondaryLabel : void 0, y = `${N ?? ""}${M}${U ?? ""}`;
    return /* @__PURE__ */ u(
      De,
      {
        value: M,
  ...
  return /* @__PURE__ */ u(Le, { open: R, onOpenChange: P, ...C, children: [
    /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ u(
      q,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      je,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          /* @__PURE__ */ a(ra, { placeholder: h, className: "tw:text-inherit" }),
          /* @__PURE__ */ a(aa, { children: g }),
          /* @__PURE__ */ a(Be, { children: S(e) ? e.map((T) => /* @__PURE__ */ a(Ee, { heading: T.groupHeading, children: T.options.map((N) => _(N, T.groupHeading)) }, T.groupHeading)) : /* @__PURE__ */ a(Ee, { children: e.map((T) => _(T)) }) })
        ] })
      }
    )
  ] });
...
function rp({
  ...
  const w = ga(d, "%webView_bookSelector_currentBook%"), p = ga(d, "%webView_bookSelector_choose%"), h = ga(d, "%webView_bookSelector_chooseBooks%"), [g, f] = k(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    f(v), t(v);
...
const Yn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, vl = Yn ? Zt : K, Ir = { tag: ro };
function bl({ initialConfig: t, children: e }) {
  const r = $(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = ml(null, o), w = zn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, h) {
      if (h !== null) {
...
const xl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
function yl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  ...
  return xl(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(ro) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const so = {
...
function Cl({ children: t, onError: e }) {
  return a(_l, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const El = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
function Tl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Sl() {
  return function(t) {
    const [e] = ye(), r = $(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = B(o);
    return El(() => {
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Rl = Wn && "documentMode" in document ? document.documentMode : null;
!(!Wn || !("InputEvent" in window) || Rl) && "getTargetRanges" in new window.InputEvent("input");
function fe(t) {
  return `${t}px`;
}
...
function Ol(t, e, r) {
  ...
  function l() {
    o === null && Xr(182), n === null && Xr(183);
    const { left: p, top: h } = n.getBoundingClientRect(), g = zl(t, e);
    var f, x;
    c.isConnected || (x = c, (f = n).insertBefore(x, f.firstChild));
    let v = !1;
    for (let z = 0; z < g.length; z++) {
      const C = g[z], R = s[z] || document.createElement("div"), P = R.style;
      P.position !== "absolute" && (P.position = "absolute", v = !0);
      const F = fe(C.left - p);
      P.left !== F && (P.left = F, v = !0);
      const S = fe(C.top - h);
      P.top !== S && (R.style.top = S, v = !0);
      const _ = fe(C.width);
      P.width !== _ && (R.style.width = _, v = !0);
      const T = fe(C.height);
      P.height !== T && (R.style.height = T, v = !0), R.parentNode !== c && (c.append(R), v = !0), s[z] = R;
    }
  ...
  const w = t.registerRootListener(function p() {
    ...
    d(), o = h, n = g, i = new MutationObserver((f) => {
      ...
      if (x !== o || v !== n) return p();
      for (const z of f) if (!c.contains(z.target)) return l();
    }), i.observe(g, Dl), l();
  });
  return () => {
    w(), d();
...
function $l(t, e = Ml) {
  ...
  function d(w) {
    w.read(() => {
      ...
      const [h, g] = function(T) {
        const N = T.getStartEndPoints();
        return T.isBackward() ? [N[1], N[0]] : N;
      }(p), f = h.getNode(), x = f.getKey(), v = h.offset, z = g.getNode(), C = z.getKey(), R = g.offset, P = t.getElementByKey(x), F = t.getElementByKey(C), S = r === null || P !== o || v !== n || x !== r.getKey(), _ = i === null || F !== s || R !== c || C !== i.getKey();
      if ((S || _) && P !== null && F !== null) {
        const T = function(N, M, U, y, Y, j, W) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Bo(M, U, y)), O.setEnd(...Bo(Y, j, W)), O;
        }(t, h, f, P, g, z, F);
        l(), l = Ol(t, T, e);
      }
      r = f, o = P, n = v, i = z, s = F, c = R;
    });
  }
...
function Il(t) {
  const e = Mn(t, (r) => Cr(r) && !r.isInline());
  return Cr(e) || Xr(4, t.__key), e;
}
function Pl(t) {
  const e = Qt() || nc();
  let r;
  if (me(e)) r = ic(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = On(c, "next"));
    }
    r = r || sc(Ve(), "previous").getFlipped().insert(zr());
  }
  const o = Vl(t, r), n = cc(o), i = lc(n) ? dc(n) : o;
  return wc(uc(i)), t.getLatest();
}
function Vl(t, e, r) {
  let o = Do(e, "next");
  for (let n = o; n; n = pc(n, r)) o = n;
  return hc(o) && Xr(283), o.insert(t.isInline() ? zr().append(t) : t), Do(On(t.getLatest(), "next"), e.direction);
}
function Ll(t) {
  const e = Qt();
  if (!me(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Mn(i, (d) => Cr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
function ia() {
  ...
  for (!function() {
    let r = Jr;
    for (Jr = void 0; r !== void 0; ) r.S.v === r.v && (r.S.i = r.i), r = r.o;
  }(); kr !== void 0; ) {
    let r = kr;
    for (kr = void 0, Zr++; r !== void 0; ) {
      const o = r.u;
...
let Jr, Ce = 0, Zr = 0, Bl = 0, ja = 0, Ur = 0;
function Ko(t) {
  if (it === void 0) return;
  let e = t.n;
...
function He(t, e) {
  Bt.call(this, void 0), this.x = t, this.s = void 0, this.g = Ur - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function Ul(t, e) {
  return new He(t, e);
}
...
function Kl(t) {
  ...
  Jn(this), it = t, this.f &= -2, 8 & this.f && lo(this), ia();
}
function or(t, e) {
...
Bt.prototype.brand = jl, Bt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      Ce !== 0 && Zr === 0 && e.l !== ja && (e.l = ja, Jr = { S: e, v: e.v, i: e.i, o: Jr });
    })(this), this.v = t, this.i++, Ur++, Ce++;
    try {
...
} }), He.prototype = new Bt(), He.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === Ur)) return !0;
  if (this.g = Ur, this.f |= 1, this.i > 0 && !Xn(this)) return this.f &= -2, !0;
  const t = it;
  try {
    qo(this), it = this;
    const e = this.x();
  ...
  return it = t, Jn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Zn(this), qo(this), Ce++;
  const t = it;
  return it = this, Kl.bind(this, t);
...
function Qn() {
  const t = Ve(), e = Qt(), r = zr();
  t.clear(), t.append(r), e !== null && r.select(), me(e) && (e.format = 0);
}
function ti(t, e = Qn) {
  return t.registerCommand($n, (r) => (t.update(e), !0), ao);
}
ie({ build: (t, e, r) => fr(e), config: er({ $onClear: Qn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return ve(() => ti(t, o.value));
} });
function ql(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const ma = vc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ei extends Aa {
  $config() {
    return this.config("decorator-text", { extends: Aa, stateConfigs: [{ flat: !0, stateConfig: ma }] });
  }
  getFormat() {
    return Rc(this, ma);
  }
...
ie({ name: "@lexical/extension/DecoratorText", nodes: () => [ei], register: (t, e, r) => t.registerCommand(An, (o) => {
  const n = Qt();
  if (In(n) || me(n)) for (const i of n.getNodes()) Gl(i) && i.toggleFormat(o);
  return !1;
}, Pn) });
function ri(t, e) {
  let r;
...
const Fa = ie({ build: (t) => ri(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const wo = 0, Ba = 1, oi = 2, va = 3, Pr = 4, ar = 5, ba = 6, vr = 7;
function xa(t) {
  return t.id === wo;
}
function ni(t) {
...
function Hl(t) {
  return function(e) {
    return e.id === Ba;
  }(t) || dt(305, String(t.id), String(Ba)), Object.assign(t, { id: oi });
}
...
class Wl {
  ...
  mergeConfigs() {
    ...
    const r = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : mc;
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Pr && dt(307, String(r.id), String(ar)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Pr;
    }(e) || dt(313, String(e.id), String(Pr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= vr;
    }(e) || dt(316, String(e.id), String(vr)), e;
  }
...
const Jl = ie({ config: er({ setOptions: Go, updateOptions: Go }), init: ({ $initialEditorState: t = Xl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
  const n = o.getInitResult();
  if (!n.initialized) {
    n.initialized = !0;
    const { $initialEditorState: i } = n;
    if (kc(i)) t.setEditorState(i, r);
...
}, name: "@lexical/extension/InitialState", nodes: [bc, Dn, xc, yc, Rn] }), Ho = Symbol.for("@lexical/extension/LexicalBuilder");
function Yo() {
}
function Zl(t) {
  throw t;
...
class cr {
  ...
  static maybeFromEditor(e) {
    const r = e[Ho];
    return r && (r.PACKAGE_VERSION !== ya && dt(292, r.PACKAGE_VERSION, ya), r instanceof cr || dt(293)), r;
  }
  static fromEditor(e) {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && dt(298, o.name), !n) {
      n = new Wl(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      xa(i) || dt(300, s, n || "[unknown]"), xa(c = i) || dt(304, String(c.id), String(wo)), i = Object.assign(c, { id: Ba }), o.state = i;
      const l = this.outgoingConfigEdges.get(s);
      if (l) for (const d of l.keys()) {
        const w = this.extensionNameMap.get(d);
        w && r(w, s);
      }
      i = Hl(i), o.state = i, e.push(o);
    };
  ...
  buildCreateEditorArgs() {
    ...
    return e.onError || (e.onError = Zl), e;
  }
}
const Ql = /* @__PURE__ */ new Set(), Wo = ie({ build(t, e, r) {
  const o = r.getDependency(Fa).output, n = Er({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = ri(() => {
  }, () => ve(() => {
...
ie({ dependencies: [Fa, Wo], name: "@lexical/extension/HorizontalRule", nodes: () => [wr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(Wo).output, n = Er({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Re(t.registerCommand(td, (s) => {
    const c = Qt();
    if (!me(c)) return !1;
    ...
    return !0;
  }, ao), t.registerCommand(Nc, (s) => {
    if (Cc(s.target)) {
      const c = Ec(s.target);
      if (rd(c)) return function(l, d = !1) {
        const w = Qt(), p = l.isSelected(), h = l.getKey();
        let g;
        d && In(w) ? g = w : (g = Tc(), Sc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Pn), t.registerMutationListener(wr, (s, c) => {
    Fl(() => {
      let l = !1;
      ...
      for (const [w, p] of s.entries()) if (p === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = g : (l = !0, d.set(w, { domNode: Er(g), selectedSignal: o(w) }));
      }
...
ie({ build: (t, e, r) => fr(e), config: er({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ve(() => {
    if (!o.disabled.value) return Al(t, o.onReposition.value);
  });
} });
function ii(t) {
  return t.canBeEmpty();
}
function ad(t, e, r = ii) {
  return Re(t.registerCommand(Ic, (o) => {
    const n = Qt();
    if (!me(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Pc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), p = Il(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Vc();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Lc(g), g.anchor.is(d)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? jc : Mo : Fc;
    return t.dispatchCommand(i, void 0);
  }, ao), t.registerCommand(Mo, () => {
...
ie({ build: (t, e, r) => fr(e), config: er({ $canIndent: ii, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ve(() => {
    if (!o.value) return ad(t, n, i);
  });
} });
const od = ie({ name: "@lexical/react/ReactProvider" });
function nd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (me(f)) {
                const x = f.anchor;
                let v = x.getNode(), z = 0, C = 0;
                if (Ia(v) && d >= 0 && w >= 0 && (z = d, C = d + w, f.setTextNodeRange(v, z, v, C)), z === C && p === "" || (f.insertRawText(p), v = x.getNode()), Ia(v)) {
                  z = h, C = h + g;
                  const R = v.getTextContentSize();
                  z = z > R ? R : z, C = C > R ? R : C, f.setTextNodeRange(v, z, v, C);
                }
...
ie({ build: (t, e, r) => fr(e), config: er({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ve(() => r.getOutput().disabled.value ? void 0 : ci(t)) });
function cd(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const po = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
  ...
  return function(r, o) {
    ...
    return po(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(Ys, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
        p !== null && s.push(Wc(w, p, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function wd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  const [o] = ye();
  return function(n) {
    po(() => Re(Hc(n), ci(n)), [n]);
  }(o), u(ut, { children: [t, a(ud, { content: e }), a(dd, { editor: o, ErrorBoundary: r })] });
}
...
function pd({ defaultSelection: t }) {
  const [e] = ye();
  return K(() => {
    e.focus(() => {
...
const hd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
function gd({ onClear: t }) {
  const [e] = ye();
  return hd(() => ti(e, t), [e, t]), null;
}
const li = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : K;
function fd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: x, role: v = "textbox", spellCheck: z = !0, style: C, tabIndex: R, "data-testid": P, ...F }, S) {
  const [_, T] = k(t.isEditable()), N = L((U) => {
    U && U.ownerDocument && U.ownerDocument.defaultView ? t.setRootElement(U) : t.setRootElement(null);
  }, [t]), M = $(() => /* @__PURE__ */ function(...U) {
    return (y) => {
      for (const Y of U) typeof Y == "function" ? Y(y) : Y != null && (Y.current = y);
    };
  }(S, N), [N, S]);
  return li(() => (T(t.isEditable()), t.registerEditableListener((U) => {
    T(U);
  })), [t]), a("div", { "aria-activedescendant": _ ? e : void 0, "aria-autocomplete": _ ? r : "none", "aria-controls": _ ? o : void 0, "aria-describedby": n, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": _ && v === "combobox" ? !!s : void 0, ...c != null ? { "aria-invalid": c } : {}, "aria-label": l, "aria-labelledby": d, "aria-multiline": w, "aria-owns": _ ? p : void 0, "aria-readonly": !_ || void 0, "aria-required": h, autoCapitalize: g, className: f, contentEditable: _, "data-testid": P, id: x, ref: M, role: v, spellCheck: z, style: C, tabIndex: R, ...F });
}
const md = En(fd);
function Jo(t) {
  return t.getEditorState().read(si(t.isComposing()));
...
function bd(t, e) {
  ...
  return u(ut, { children: [a(md, { editor: n, ...o, ref: e }), r != null && a(xd, { editor: n, content: r })] });
}
function xd({ content: t, editor: e }) {
  const r = function(s) {
    const [c, l] = k(() => Jo(s));
    return li(() => {
      function d() {
      ...
      return d(), Re(s.registerUpdateListener(() => {
        d();
...
function Nd({
  ...
  const [e] = ye(), [r, o] = k(e), [n, i] = k("paragraph"), [s, c] = _d(), l = () => {
  };
...
function Ed() {
  const { activeEditor: t } = wi(), [e, r] = k([]), o = L((n) => {
    if (me(n) || Xc(n)) {
      const i = [];
      Zo.forEach(({ format: s }) => {
...
function Sd({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Nd, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(Ed, {}) }) }),
    /* @__PURE__ */ u("div", { className: "tw:relative", children: [
      ...
      e && /* @__PURE__ */ a(pd, { defaultSelection: "rootEnd" }),
...
const Dd = "verseText", ap = Object.freeze([
...
function op({
  ...
  const [i, s] = k(Od), [c, l] = k(n), [d, w] = k(!1), p = B(void 0), h = B(null);
  K(() => {
    let v = !0;
    const z = h.current;
    if (!z) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : go(v) && (v.preventDefault(), v.stopPropagation(), ne(i) && g());
        },
        onKeyDown: (v) => {
...
function tn({
  ...
  const g = L(
    ...
    const S = new Date(t.date), _ = Ls(
      S,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), T = S.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [t.date, r]), v = $(() => t.user, [t.user]), z = $(
    () => t.user.split(" ").map((S) => S[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), C = $(() => to(t.contents), [t.contents]), R = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), P = !!t.conflictResolutionAction && !R, F = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(ut, { children: [
        /* @__PURE__ */ u(
          We,
          {
            onClick: (S) => {
              S.stopPropagation(), d(!0), p(Rd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Pd, { className: "tw:text-xs tw:font-medium", children: z }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (S) => {
                S.key === "Escape" ? (S.preventDefault(), S.stopPropagation(), g()) : go(S) && (S.preventDefault(), S.stopPropagation(), ne(w) && f());
              },
              onKeyDown: (S) => {
        ...
        F && /* @__PURE__ */ u(Te, { children: [
          /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(us, {}) }) }),
          /* @__PURE__ */ a(ze, { align: "end", children: F })
        ] })
      ]
    }
  );
...
function xi({
  ...
  const [y, Y] = k(en), [j, W] = k(), [O, V] = k(), X = o, [Q, pt] = k(!1), [yt, Pt] = k(!1), [G, tt] = k(!1), [ht, at] = k(!1), [mt, ue] = k(!1), [Tt, kt] = k(P), [Vt, Lt] = k(!1), gt = B(void 0), [Yt, D] = k(/* @__PURE__ */ new Map());
  K(() => {
    let E = !0;
    return (async () => {
      const et = C ? await C(l) : !1;
      E && ue(et);
    })(), () => {
      E = !1;
    };
    ...
    let E = !0;
    if (!o) {
      at(!1), D(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const et = z ? await z(l) : !1;
      E && at(et);
    })(), () => {
      E = !1;
    };
  ...
  K(() => {
    if (!o) {
      vt.current !== "idle" && (W(void 0), V(void 0), vt.current = "idle");
      return;
    }
    vt.current === "idle" && (vt.current = "pending"), ht ? vt.current === "pending" && _ !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    _ !== i && (W(_), vt.current = "auto-populated") : vt.current === "auto-populated" && (W(void 0), vt.current = "pending");
  }, [o, _, ht, i]);
  const lt = $(
    () => T ?? e.filter((E) => !E.deleted),
    [T, e]
  );
  K(() => {
    let E = !0;
  ...
  const Mt = $(() => lt[0], [lt]), Oe = B(null), te = B(void 0), ee = L(() => {
    var E;
    (E = te.current) == null || E.call(te), Y(en);
  }, []), ke = L(() => {
    const E = !Tt;
    kt(E), Lt(!E), f == null || f(l, E);
  }, [Tt, f, l]);
  K(() => {
    pt(!1);
  }, [o]), K(() => {
    if (o && !Tt && !Vt) {
      ...
      return gt.current = E, () => clearTimeout(E);
    }
  ...
  }, [i, r]), $t = $(() => lt.slice(1), [lt]), Rt = $(() => $t.length ?? 0, [$t.length]), ae = $(() => Rt > 0, [Rt]), oe = $(() => Q || Rt <= 2 ? $t : $t.slice(-2), [$t, Rt, Q]), Wt = $(() => Q || Rt <= 2 ? 0 : Rt - 2, [Rt, Q]), pe = $(
    () => Rt === 1 ? _t.singleReply : Xe(_t.multipleReplies, { count: Rt }),
    [Rt, _t]
  ), A = $(
    () => Wt === 1 ? _t.singleReply : Xe(_t.multipleReplies, { count: Wt }),
    [Wt, _t]
  );
  K(() => {
    !o && yt && ae && Pt(!1);
  ...
  const J = L(
    async (E) => {
      ...
      ot && await p({ threadId: l, contents: ot }) && ee();
    },
    [
      ee,
      y,
    ...
    async (E) => {
      const ot = ne(y) ? ta(y) : void 0, et = E.status ? E.assignedUser : j ?? E.assignedUser, st = await p({
        ...E,
        contents: ot,
        assignedUser: et
      });
      return st && (et !== void 0 && V(et), ot && ee()), st;
    },
    [ee, y, p, j]
  );
  ...
  const ct = /* @__PURE__ */ a(
    tn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: Pt,
      canEditOrDelete: (!yt && Yt.get(Mt.id)) ?? !1,
  ...
  return /* @__PURE__ */ a(
    $d,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ u(Ad, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            re && /* @__PURE__ */ a(_r, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: re }),
            /* @__PURE__ */ a(
              q,
              {
                variant: "ghost",
                ...
                children: Tt ? /* @__PURE__ */ a(ps, {}) : /* @__PURE__ */ a(hs, {})
              }
            ),
            M === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: mt && w !== "Resolved",
                  onClick: () => nt({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(ut, { children: [
          ...
          !o && ne(y) && /* @__PURE__ */ a(
            Qr,
            {
              ...
              onSerializedChange: (E) => Y(E),
              placeholder: r["%comment_replyOrAssign%"]
            }
          ),
          o && /* @__PURE__ */ u(ut, { children: [
            U && oe.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            Wt > 0 && /* @__PURE__ */ u(
              "div",
              {
                className: "tw:flex tw:cursor-pointer tw:items-center tw:gap-5 tw:py-2",
                onClick: (E) => {
                  E.stopPropagation(), pt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (E) => {
                  (E.key === "Enter" || E.key === " ") && (E.preventDefault(), E.stopPropagation(), pt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Nr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    /* @__PURE__ */ a("p", { className: "tw:text-sm tw:text-muted-foreground", children: A }),
                    Q ? /* @__PURE__ */ a(gs, {}) : /* @__PURE__ */ a(lr, {})
                  ] })
                ]
              }
            ),
            oe.map((E) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              tn,
              {
                comment: E,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Pt,
                canEditOrDelete: (!yt && Yt.get(E.id)) ?? !1
              }
            ) }, E.id)),
            v !== !1 && (!yt || ne(y)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (E) => {
                  go(E) && (E.preventDefault(), E.stopPropagation(), (ne(y) || j !== void 0 && j !== O) && J());
                },
                onKeyDown: (E) => {
                  ho(E), (E.key === "Enter" || E.key === " ") && E.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ a(
                    Qr,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    j !== void 0 && (ne(y) || j !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Xe(
                    ...
                    /* @__PURE__ */ u(Le, { open: G, onOpenChange: tt, children: [
                      /* @__PURE__ */ a(Qe, { asChild: !0, children: /* @__PURE__ */ a(
                        q,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        je,
                        {
                          ...
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Be, { children: x == null ? void 0 : x.map((E) => /* @__PURE__ */ a(
                            De,
                            {
                              onSelect: () => {
                                W(E !== i ? E : void 0), vt.current = "user-selected", V(void 0), tt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), Ld = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), qr = (t) => Ld(to(t));
function Gr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function jd({
  ...
  const [s, c] = k("accept"), l = Ro(), d = Ro(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = $(
    () => qr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = $(
    () => qr(t.acceptedText ?? ""),
    ...
    () => qr(t.mergedText ?? ""),
    [t.mergedText]
  ), C = $(() => to(t.contents), [t.contents]);
  if (!mi(t))
    return /* @__PURE__ */ a(Gr, { html: C });
  const R = (O) => {
    c(O === "reject" || O === "merge" ? O : "accept");
  }, P = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", F = g ? [
    {
      value: "merge",
  ...
  let N;
  _ ? N = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (N = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", U = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), y = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : U, Y = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Gr, { html: z }) : U : y(O === "reject" ? t.rejectedResultText : t.resultText);
  }, j = (O) => p && O.value === "reject", W = (O) => {
    const V = f === O.value, X = `${d}-${O.value}`, Q = j(O);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          className: m(
            ...
            V ? "tw:border-border tw:bg-accent/50" : "tw:border-transparent tw:hover:bg-accent/30",
      ...
      !w && !h && /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a(
          Ga,
          {
            ...
            children: S.map((O) => j(O) ? /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ u(qt, { children: [
              /* @__PURE__ */ a(Gt, { asChild: !0, children: W(O) }),
    ...
    if (e === "Resolved") {
      for (let C = o.length - 1; C >= 0; C -= 1)
        if (o[C].status === "Resolved")
          return vi(o[C].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function qd(t) {
  ...
  } = t, c = $(() => e.filter((z) => !z.deleted), [e]), l = $(
    () => c.find((z) => z.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: p, resolvedResolution: h, showResolveCheck: g } = Kd({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function pp({
  ...
  const [C, R] = k(/* @__PURE__ */ new Set()), [P, F] = k(), [S, _] = k(), T = L(
    async (V) => {
      const X = await i(V);
      return X !== void 0 && V.assignedUser !== void 0 && V.assignedUser !== "" && _(V.assignedUser), X;
    },
    [i]
  );
  K(() => {
    f && (R((V) => new Set(V).add(f)), F(f));
  }, [f]);
  const N = r.filter(
    (V) => V.comments.some((X) => !X.deleted)
  ), M = N.map((V) => ({ id: V.id })), U = L(
    (V) => {
      R((X) => new Set(X).add(V.id)), F(V.id), x == null || x(V.id);
    },
    [x]
  ), y = L(
    (V) => {
      ...
      R((Q) => {
        const pt = new Set(Q);
        return pt.has(V) ? pt.delete(V) : pt.add(V), pt;
      }), F(V), x == null || x(X ? void 0 : V);
    },
    [C, x]
  ), { listboxRef: Y, activeId: j, handleKeyDown: W } = Ki({
    options: M,
    onOptionSelect: U
  }), O = L(
    (V) => {
      V.key === "Escape" ? (P && C.has(P) && (R((X) => {
        const Q = new Set(X);
        return Q.delete(P), Q;
      }), F(void 0), x == null || x(void 0)), V.preventDefault(), V.stopPropagation()) : W(V);
    },
    [P, C, W, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: N.map((V) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: V.type === "Conflict" ? /* @__PURE__ */ a(qd, { ...X, conflictResolution: z }) : /* @__PURE__ */ a(xi, { ...X })
          },
          V.id
        );
      })
...
function Gd({ table: t }) {
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
...
function hr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(Tn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function le({
  ...
  return /* @__PURE__ */ u(
    Ut.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Ut.ItemIndicator, { children: /* @__PURE__ */ a(na, { className: "tw:pointer-events-none" }) }) }),
      ...
      /* @__PURE__ */ u(
        ur,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(gr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(le, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Jd({
  ...
  var S;
  const [w, p] = k([]), [h, g] = k([]), [f, x] = k({}), [v, z] = k({}), C = $(() => e ?? [], [e]), R = Fn({
    data: C,
    columns: t,
    getCoreRowModel: Un(),
  ...
  }), P = R.getVisibleFlatColumns();
  let F;
  return l ? F = Array.from({ length: 10 }).map((N, M) => `skeleton-row-${M}`).map((N) => /* @__PURE__ */ a(Ie, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ir, { colSpan: P.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(nr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((S = R.getRowModel().rows) == null ? void 0 : S.length) > 0 ? F = R.getRowModel().rows.map((_) => /* @__PURE__ */ a(
    Ie,
    {
      onClick: () => s(_, R),
      "data-state": _.getIsSelected() && "selected",
      children: _.getVisibleCells().map((T) => /* @__PURE__ */ a(ir, { children: yr(T.column.columnDef.cell, T.getContext()) }, T.id))
    },
    _.id
  )) : F = /* @__PURE__ */ a(Ie, { children: /* @__PURE__ */ a(ir, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Gd, { table: R }),
    /* @__PURE__ */ u(Wa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Xa, { stickyHeader: i, children: R.getHeaderGroups().map((_) => /* @__PURE__ */ a(Ie, { children: _.headers.map((T) => /* @__PURE__ */ a(Wr, { className: "tw:p-0", children: T.isPlaceholder ? void 0 : yr(T.column.columnDef.header, T.getContext()) }, T.id)) }, _.id)) }),
      /* @__PURE__ */ a(Ja, { children: F })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(q, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(xn, {}) })
        ] }),
...
function bp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ u(q, { variant: "default", children: [
    ...
    /* @__PURE__ */ a(ze, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(hn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ut, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Pe,
        {
          checked: o[w][h],
      ...
      return /* @__PURE__ */ u(_r, { variant: "muted", className: "tw:flex tw:items-center tw:gap-1", children: [
        /* @__PURE__ */ a(
          q,
          {
            ...
            children: /* @__PURE__ */ a(Qa, { className: "tw:h-3 tw:w-3" })
          }
        ),
...
function nw({
  ...
  const l = Ya(), d = an(n, "%undoButton_tooltip%"), w = an(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(Ha, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(
        q,
...
function iw({
  ...
  return K(() => {
    var l;
    const i = Ya(), s = ((l = n.current) == null ? void 0 : l.querySelector(".editor-input")) ?? void 0, c = (d) => {
      var p, h, g, f;
...
const sw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ut, { children: [
...
function cw({
  ...
  const f = (v) => {
    ...
    var z, C, R, P;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((z = i.current) == null || z.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((R = i.current) == null ? void 0 : R.selectionStart) === 0 && ((P = s.current) == null || P.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(Te, { open: h, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: sw(t, n, r) }) }) }),
...
const lw = (t, e) => t === "f" ? /* @__PURE__ */ u(ut, { children: [
  /* @__PURE__ */ a(kn, {}),
  " ",
...
function ww({
  ...
  return /* @__PURE__ */ u(Te, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ a(q, { variant: "outline", className: "tw:h-6", children: lw(t, r) }) }) }),
      /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: dw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(ze, { style: { zIndex: gn }, children: [
  ...
  return /* @__PURE__ */ u(
    De,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Yi, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
...
function fw(t, e, r = () => !0) {
  ...
  for (; c; ) {
    ...
    if (i + p >= s) {
      ...
      return g.setStart(w, s - i), g.collapse(!0), h == null || h.addRange(g), !0;
    }
...
function _p({
  ...
  const h = B(null), g = B(null), f = B(null), x = B(null), v = B(i);
  K(() => {
    v.current = i;
  }, [i]);
  const z = B(p);
  K(() => {
    ...
    const { width: A } = x.current.getBoundingClientRect();
    A > 0 && (x.current.style.width = `${A}px`);
  }, [w]);
  const [C, R] = k("generated"), [P, F] = k("generated"), [S, _] = k("*"), [T, N] = k("*"), [M, U] = k("f"), [y, Y] = k(!1), [j, W] = k(!0), [O, V] = k(!1), X = B(!1), Q = B(""), [pt, yt] = k(!1), [Pt, G] = k(), [tt, ht] = k(), [at, mt] = k(), [ue, Tt] = k(), kt = B(null), Vt = $(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? ol(), noteMode: "expanded" }
    }),
    [s, c]
  ), Lt = $(
    () => gw(
  ...
  K(() => {
    var A;
    pt || (A = h.current) == null || A.focus();
  }, [M, pt]);
  const gt = L(
    (A, J, nt = !1) => {
      var E, ot, et;
      const ct = (ot = (E = h.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : ot.at(0);
      if (ct && $r("note", ct)) {
        if (ct.insert.note) {
          let st;
          A === "custom" ? st = J : A === "generated" ? st = Pa : st = Va, ct.insert.note.caller = st;
        }
        r == null || r([ct]), nt && d && v.current && ((et = d.current) == null || et.replaceEmbedUpdate(v.current, [ct]));
      }
    },
    [r, d]
  ), Yt = B(void 0), D = B({ callerType: C, customCaller: S });
  K(() => {
    D.current = { callerType: C, customCaller: S };
  }, [C, S]);
  const vt = B(gt);
  K(() => {
    vt.current = gt;
  ...
  const lt = L(() => {
    Yt.current !== void 0 && (clearTimeout(Yt.current), Yt.current = void 0);
  }, []), Mt = L(() => {
    if (Yt.current === void 0) return;
    lt();
    const { callerType: A, customCaller: J } = D.current;
    vt.current(A, J, !0);
  }, [lt]), Oe = L(() => {
    lt(), Yt.current = setTimeout(() => {
      Yt.current = void 0;
      const { callerType: A, customCaller: J } = D.current;
      vt.current(A, J, !0);
    }, xw);
  ...
  K(() => {
    ...
    let A, J;
    X.current = !1, W(!0);
    const nt = e == null ? void 0 : e.at(0);
    if (nt && $r("note", nt)) {
      const ot = (ct = nt.insert.note) == null ? void 0 : ct.caller;
      let et = "custom";
      ot === Pa ? et = "generated" : ot === Va ? et = "hidden" : ot && (_(ot), N(ot)), R(et), F(et), U(((E = nt.insert.note) == null ? void 0 : E.style) ?? "f"), A = setTimeout(() => {
        var bt;
        (bt = h.current) == null || bt.applyUpdate([nt]);
        const st = z.current;
        st !== void 0 && (J = setTimeout(() => {
          var At;
          const St = ((At = g.current) == null ? void 0 : At.querySelector(".editor-input")) ?? void 0;
          St && fw(
            St,
            st,
            mw(St)
    ...
    return () => {
      Mt(), A && clearTimeout(A), J && clearTimeout(J);
    };
  }, [e, Mt]), Zt(() => () => Mt(), [Mt]);
  const te = L(() => {
    lt(), gt(C, S, !0), o();
  ...
  const ke = B({ book: n.book, chapterNum: n.chapterNum });
  Zt(() => {
    (ke.current.book !== n.book || ke.current.chapterNum !== n.chapterNum) && (ke.current = { book: n.book, chapterNum: n.chapterNum }, ee.current());
  }, [n.book, n.chapterNum]);
  const _t = () => {
    var J;
    const A = (J = g.current) == null ? void 0 : J.getElementsByClassName("editor-input")[0];
    ...
    var nt, ct, E, ot, et;
    U(A);
    const J = (ct = (nt = h.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : ct.at(0);
    if (J && $r("note", J)) {
      J.insert.note && (J.insert.note.style = A);
      const st = (ot = (E = J.insert.note) == null ? void 0 : E.contents) == null ? void 0 : ot.ops;
      M !== "x" && A === "x" ? st == null || st.forEach((bt) => vw(bt)) : M === "x" && A !== "x" && (st == null || st.forEach((bt) => bw(bt))), (et = h.current) == null || et.applyUpdate([J, { delete: 1 }]);
    }
  }, ae = (A) => {
    Tt(A.contextMarker), V(A.canRedo);
  }, oe = L(
    (A) => {
      var nt, ct, E, ot, et;
      const J = (ct = (nt = h.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : ct.at(0);
      if (J && $r("note", J)) {
        A.content.length > 1 && setTimeout(() => {
          var St;
          (St = h.current) == null || St.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const st = (E = J.insert.note) == null ? void 0 : E.style, bt = (et = (ot = J.insert.note) == null ? void 0 : ot.contents) == null ? void 0 : et.ops;
        if (st || Y(!1), Y(
          st === "x" ? !!(bt != null && bt.every((St) => {
            var se, ce;
            if (!((se = St.attributes) != null && se.char)) return !0;
            const At = ((ce = St.attributes) == null ? void 0 : ce.char).style;
          ...
          X.current = !0, Q.current = JSON.stringify(J), W(!0);
          return;
        }
        W(JSON.stringify(J) === Q.current), gt(C, S), w && Oe();
      } else
        Y(!1), W(!0);
    },
    [C, S, gt, w, Oe]
    ...
    if (f.current && Lt.length && A && A.rangeCount > 0) {
      const J = A.getRangeAt(0).getBoundingClientRect(), nt = f.current.getBoundingClientRect();
      G(J.left - nt.left), ht(J.top - nt.top), mt(J.height), yt(!0);
    }
  }, [Lt, f]);
  K(() => {
    const A = () => {
    ...
    var A;
    pt && ((A = kt.current) == null || A.focus());
  }, [pt]), K(() => {
    var nt;
    const A = ((nt = g.current) == null ? void 0 : nt.querySelector(".editor-input")) ?? void 0, J = (ct) => {
      !pt && A && document.activeElement === A && ct.key === c ? (ct.preventDefault(), Wt()) : pt && ct.key === "Escape" && (ct.preventDefault(), yt(!1));
    };
  ...
  return /* @__PURE__ */ u(ut, { children: [
            ...
            /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-4", children: [
              ...
              /* @__PURE__ */ a(
                cw,
                {
                  ...
                  updateCallerType: re,
                  customCaller: S,
                  updateCustomCaller: $t,
                  localizedStrings: l
                }
              )
            ] }),
            /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(Ha, { children: [
              /* @__PURE__ */ a(
                nw,
                {
                  onUndoClick: () => {
                    var A;
                    return (A = h.current) == null ? void 0 : A.undo();
                  },
                  onRedoClick: () => {
                    var A;
                    return (A = h.current) == null ? void 0 : A.redo();
                  },
                  canUndo: !j,
                  canRedo: O,
                  localizedStrings: l
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
                  ...
                  /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: pe }) })
                ] }) }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ u(Le, { open: pt, children: [
      /* @__PURE__ */ a(
        Wi,
        {
          className: "tw:absolute",
...
function Nw(t, e, r = !0, o = void 0, n = void 0) {
  const i = [];
  let s = [];
  (e ?? []).forEach((l) => {
...
function Cw(t, e, r, o = !1) {
  const { marker: n } = t, i = `${o ? "+" : ""}${n}`;
  return /* @__PURE__ */ u("span", { children: [
    n ? r && /* @__PURE__ */ a("span", { className: "marker", children: `\\${i}${Hr}` }) : /* @__PURE__ */ a(
      Ma,
      {
    ...
    yi(n, t.content, r, !0, !0),
    n && r && _w(t) && /* @__PURE__ */ a("span", { className: "marker", children: `\\${i}*` })
  ] }, e);
}
function Ew({
  footnote: t,
  ...
  const n = r ? r(t.caller) : t.caller, i = n !== t.caller, s = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}${Hr}` }) : void 0, c = o ? /* @__PURE__ */ a("span", { className: "marker", children: `\\${t.marker}*` }) : void 0, l = t.category ? /* @__PURE__ */ u(ut, { children: [
    /* @__PURE__ */ a("span", { className: "marker", children: `\\cat${Hr}` }),
    t.category,
    /* @__PURE__ */ a("span", { className: "marker", children: "\\cat*" })
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    n,
    Hr
  ] }), w = e === "horizontal" ? "horizontal" : "vertical", p = o ? "marker-visible" : "", h = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", g = m(w, p);
  return /* @__PURE__ */ u(ut, { children: [
    /* @__PURE__ */ u("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", g), children: [
      s,
      d
    ] }),
    /* @__PURE__ */ a(
...
function Cp({
  ...
  onFootnoteEditRequested: w,
  editingFootnoteIndex: p,
  renderEditingFootnote: h
}) {
  const g = l ?? Bs(r, void 0), f = h ? p : void 0, x = B([]), v = (_, T, N) => {
    if (w) {
      const M = x.current[T], U = M ? aw(N.clientX, N.clientY, M) : "end";
      w(_, T, n, U);
      return;
    }
    d == null || d(_, T, n);
  }, z = i ? r.findIndex((_) => _ === i) : -1, [C, R] = k(z), P = (_, T, N) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
          _.preventDefault(), w ? w(T, N, n, "end") : d == null || d(T, N, n);
          break;
        case " ":
          _.preventDefault(), d == null || d(T, N, n);
          break;
      }
  }, F = r.length - 1, S = (_) => {
    if (r.length && !(f !== void 0 && _.target instanceof HTMLElement && _.target.closest('li[data-state="editing"]')))
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), R((T) => Lr(T, 1, F, f));
          break;
        case "ArrowUp":
          _.preventDefault(), R((T) => Lr(T, -1, F, f));
          break;
  ...
  return K(() => {
    ...
    var _;
    C >= 0 && C < x.current.length && ((_ = x.current[C]) == null || _.focus());
  }, [C]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
      ...
      children: /* @__PURE__ */ a(
        "ul",
        {
          ...
          children: r.map((_, T) => {
            const N = _ === i, M = `${n}-${T}`, U = T === p && !!h, y = T < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Nr, { tabIndex: -1, className: "tw:col-span-2" });
            return U ? /* @__PURE__ */ u(dr, { children: [
              /* @__PURE__ */ a(
                "li",
                {
                  "data-state": "editing",
...
function Sw({
  ...
  return /* @__PURE__ */ u(Wa, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Xa, { stickyHeader: !0, children: /* @__PURE__ */ u(Ie, { children: [
      /* @__PURE__ */ a(Wr, { children: n }),
      /* @__PURE__ */ a(Wr, { children: i })
    ] }) }),
    /* @__PURE__ */ a(Ja, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ie,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          ...
          /* @__PURE__ */ a(ir, { className: o, children: Tw(c.text) })
        ]
      },
...
const zw = (t) => {
...
}, sa = (t, e, r) => /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
  /* @__PURE__ */ u(
    Gt,
    {
  ...
  return e ? e[1] : "";
}, Dw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Op = Object.freeze([
  ...
  const n = Eo(o.key) ? o.key : o.key[0];
  return {
    items: Eo(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || Dw(n, e, r),
...
function Mp({
  ...
  const g = ge(r, "%webView_inventory_all%"), f = ge(r, "%webView_inventory_approved%"), x = ge(r, "%webView_inventory_unapproved%"), v = ge(r, "%webView_inventory_unknown%"), z = ge(r, "%webView_inventory_scope_currentBook%"), C = ge(r, "%webView_inventory_scope_chapter%"), R = ge(r, "%webView_inventory_scope_verse%"), P = ge(r, "%webView_inventory_filter_text%"), F = ge(
    r,
    "%webView_inventory_show_additional_items%"
  ), S = ge(r, "%webView_inventory_no_results%"), [_, T] = k(!1), [N, M] = k("all"), [U, y] = k(""), [Y, j] = k([]), W = $(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Mw(G, n, i);
  }, [t, n, i]), O = $(() => {
    if (_) return W;
    const G = [];
    return W.forEach((tt) => {
      const ht = tt.items[0], at = G.find(
        (mt) => mt.items[0] === ht
      );
      at ? (at.count += tt.count, at.occurrences = at.occurrences.concat(tt.occurrences)) : G.push({
        items: [ht],
        count: tt.count,
  ...
  }, [_, W]), V = $(() => O.length === 0 ? [] : Ow(O, N, U), [O, N, U]), X = $(() => {
    var ht, at;
    if (!_) return l;
    const G = (ht = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ht.length;
    if (!G) return l;
    const tt = [];
    for (let mt = 0; mt < G; mt++)
      tt.push(
        Rw(
          ((at = o == null ? void 0 : o.tableHeaders) == null ? void 0 : at[mt]) || "Additional Item",
          mt + 1
        )
      );
    return [...tt, ...l];
  }, [o == null ? void 0 : o.tableHeaders, l, _]);
  K(() => {
    V.length === 0 ? j([]) : V.length === 1 && j(V[0].items);
  }, [V]);
  const Q = (G, tt) => {
    tt.setRowSelection(() => {
      const at = {};
      return at[G.index] = !0, at;
    });
    const ht = G.original.items;
    j(ht), h && ht.length > 0 && h(ht[0]);
  }, pt = (G) => {
    ...
    const G = O.filter((tt) => Us(
      _ ? tt.items : [tt.items[0]],
      Y
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        ur,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(gr, { children: [
              ...
              /* @__PURE__ */ a(le, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(le, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(ur, { onValueChange: (G) => pt(G), defaultValue: s, children: [
        /* @__PURE__ */ a(hr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(pr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(gr, { children: [
          /* @__PURE__ */ a(le, { value: "book", children: z }),
          /* @__PURE__ */ a(le, { value: "chapter", children: C }),
          /* @__PURE__ */ a(le, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ a(
        oa,
      ...
      o && /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
        ...
        /* @__PURE__ */ a(Ht, { children: (o == null ? void 0 : o.checkboxText) ?? F })
      ] }) })
    ] }),
...
const $w = "16rem", Aw = "3rem", _i = Jt.createContext(void 0);
function ca() {
  const t = Jt.useContext(_i);
  if (!t)
...
function Iw({
  ...
  const [l, d] = Jt.useState(t), w = e ?? l, p = Jt.useCallback(
    (R) => {
      const P = typeof R == "function" ? R(w) : R;
      r ? r(P) : d(P);
    },
    [r, w]
  ), h = Jt.useCallback(() => p((R) => !R), [p]), g = w ? "expanded" : "collapsed", v = be() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = Jt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a(_i.Provider, { value: z, children: /* @__PURE__ */ a(
    "div",
    {
...
function $p({ className: t, onClick: e, ...r }) {
  ...
  return /* @__PURE__ */ u(
    q,
    {
      ...
      ...r,
      children: [
        n === "primary" ? /* @__PURE__ */ a(Js, {}) : /* @__PURE__ */ a(Zs, {}),
...
function Uw({
  ...
  const c = t ? Rr.Root : "button", { state: l } = ca(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: m(Bw({ variant: r, size: o }), i),
      ...s
    }
  );
  return n ? /* @__PURE__ */ u(qt, { children: [
    /* @__PURE__ */ a(Gt, { asChild: !0, children: d }),
    /* @__PURE__ */ a(
      Ht,
      {
        side: "right",
    ...
    Pw,
    {
      ...
      children: /* @__PURE__ */ u(Lw, { children: [
        /* @__PURE__ */ u(nn, { children: [
          ...
          /* @__PURE__ */ a(cn, { children: /* @__PURE__ */ a(jw, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(Fw, { children: /* @__PURE__ */ a(
            Uw,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const $e = "scrBook", qw = "scrRef", Ye = "source", Gw = "details", Hw = "Scripture Reference", Yw = "Scripture Book", Ni = "Type", Ww = "Details";
function Xw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? xt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === $e ? Ne(n.start) : void 0;
      },
...
}, ln = (t) => `${Jw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Yp({
  sources: t,
  ...
  const [d, w] = k([]), [p, h] = k([{ id: $e, desc: !1 }]), [g, f] = k({}), x = $(
    () => t.flatMap((N) => N.data.map((M) => ({
      ...M,
      source: N.source
    }))),
    [t]
  ...
  K(() => {
    if (c) {
      const N = z.getSelectedRowModel().rowsById, M = Object.keys(N);
      if (M.length === 1) {
        const U = x.find((y) => ln(y) === M[0]) || void 0;
        U && c(U);
      }
    }
  }, [g, x, c, z]);
  const C = n ?? Yw, R = i ?? Ni, P = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${C}`, value: [$e] },
    { label: `Group by ${R}`, value: [Ye] },
    {
    ...
    !N.getIsGrouped() && !N.getIsSelected() && N.getToggleSelectedHandler()(M);
  }, _ = (N, M) => N.getIsGrouped() ? "" : m("banded-row", M % 2 === 0 ? "even" : "odd"), T = (N, M, U) => {
    if (!((N == null ? void 0 : N.length) === 0 || M.depth < U.column.getGroupedIndex())) {
      if (M.getIsGrouped())
        switch (M.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      ur,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(gr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: P.map((N) => /* @__PURE__ */ a(le, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(Wa, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(Xa, { children: z.getHeaderGroups().map((N) => /* @__PURE__ */ a(Ie, { children: N.headers.filter((M) => M.column.columnDef.header).map((M) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Wr, { colSpan: M.colSpan, className: "tw:sticky top-0", children: M.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          yr(M.column.columnDef.header, M.getContext())
        ] }) }, M.id)
      )) }, N.id)) }),
      /* @__PURE__ */ a(Ja, { children: z.getRowModel().rows.map((N, M) => {
        const U = be();
        return /* @__PURE__ */ a(
          Ie,
          {
            ...
            className: m(_(N, M)),
            onClick: (y) => S(N, y),
            children: N.getVisibleCells().map((y) => {
              if (!(y.getIsPlaceholder() || y.column.columnDef.enableGrouping && !y.getIsGrouped() && (y.column.columnDef.id !== Ye || !r)))
                return /* @__PURE__ */ a(
                  ir,
                  {
                    className: m(
                    ...
                    children: y.getIsGrouped() ? /* @__PURE__ */ u(
                      q,
                      {
                        ...
                        type: "button",
                        children: [
                          N.getIsExpanded() && /* @__PURE__ */ a(lr, {}),
                          !N.getIsExpanded() && (U === "ltr" ? /* @__PURE__ */ a(Oa, {}) : /* @__PURE__ */ a(Da, {})),
                          " ",
                          yr(y.column.columnDef.cell, y.getContext()),
                          " (",
                          N.subRows.length,
                          ")"
                        ]
...
const Ei = (t, e, r) => fo(t, e).every((o) => r.includes(o));
function Zw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
  ...
  }, [x, v] = k(!1), [z, C] = k(""), R = B(void 0), P = B(!1), F = $(
    () => Ci(t),
    [t]
  ), S = $(() => {
    if (!z.trim()) {
    ...
    (y, Y = !1) => {
      if (!Y || !R.current) {
        r(
          e.includes(y) ? e.filter((Q) => Q !== y) : [...e, y]
        ), R.current = y;
        return;
      }
      const j = F.findIndex((Q) => Q === R.current), W = F.findIndex((Q) => Q === y);
      if (j === -1 || W === -1) return;
      const [O, V] = [
        Math.min(j, W),
        Math.max(j, W)
      ], X = F.slice(O, V + 1).map((Q) => Q);
      r(
        e.includes(y) ? e.filter((Q) => !X.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...X])]
      );
    },
    [e, r, F]
  ), T = (y) => {
    _(y, P.current), P.current = !1;
  }, N = (y, Y) => {
    y.preventDefault(), _(Y, y.shiftKey);
  }, M = () => {
    r(F.map((y) => y));
  }, U = () => {
    r([]);
  ...
  return /* @__PURE__ */ u(
    Le,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(je, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Fe,
          {
            shouldFilter: !1,
            onKeyDown: (y) => {
              y.key === "Enter" && (P.current = y.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                ra,
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: M, children: l }),
                /* @__PURE__ */ a(q, { variant: "ghost", size: "sm", onClick: U, children: d })
              ] }),
              /* @__PURE__ */ u(Be, { children: [
                /* @__PURE__ */ a(aa, { children: w }),
                Object.values(wt).map((y, Y) => {
                  const j = S[y];
                  if (j.length !== 0)
                    return /* @__PURE__ */ u(dr, { children: [
                      /* @__PURE__ */ a(
                        Ee,
                        {
                          heading: wn(y, p, h, g, f),
                          children: j.map((W) => /* @__PURE__ */ a(
                            Kn,
                            {
                              bookId: W,
                      ...
                      Y < Object.values(wt).length - 1 && /* @__PURE__ */ a(fn, {})
                    ] }, y);
                })
              ] })
            ]
...
function tu({
  ...
  const i = o["%webView_book_selector_more%"], s = $(
    ...
    (l) => {
      ...
      r(
        Ei(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Na ? Na : dn
      ).map((l) => /* @__PURE__ */ a(_r, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ae(l, n) }, l)),
...
function Xp({
  ...
  const P = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), F = Dt(s, "%webView_scope_selector_verse%"), S = Dt(s, "%webView_scope_selector_chapter%"), _ = Dt(s, "%webView_scope_selector_book%"), T = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), N = Dt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), M = Dt(s, "%webView_scope_selector_current_book%"), U = Dt(s, "%webView_scope_selector_choose_books%"), y = Dt(s, "%webView_scope_selector_scope%"), Y = Dt(s, "%webView_scope_selector_select_books%"), j = Dt(s, "%webView_scope_selector_range%"), W = Dt(s, "%webView_scope_selector_select_range%"), O = Dt(s, "%webView_scope_selector_range_start%"), V = Dt(s, "%webView_scope_selector_range_end%"), X = Dt(s, "%webView_scope_selector_ok%"), Q = Dt(s, "%webView_scope_selector_cancel%"), pt = Dt(s, "%webView_scope_selector_navigate%"), yt = (I) => {
    if (!f) return;
    ...
    },
    {
      ...
      label: _,
      dropdownLabel: M,
      scrRefSuffix: yt("book"),
      id: "scope-book"
    },
    { value: "selectedBooks", label: U, id: "scope-selected" },
    { value: "range", label: j, id: "scope-range" }
  ], G = (I, Z, Xt = !1) => /* @__PURE__ */ u(ut, { children: [
    I,
    Z && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), tt = e ? Pt.filter((I) => e.includes(I.value)) : Pt, ht = f ?? ua, at = w ?? ht, mt = p ?? ht, ue = () => {
  }, Tt = B(null), kt = B(null), Vt = B(!1), Lt = B(null), gt = B(!1), [Yt, D] = k(void 0), vt = B(!1), lt = B(!1), Mt = B(null), Oe = L((I) => {
    if (I) {
      D("start"), vt.current = !1;
      return;
    }
    D((Z) => Z === "start" ? void 0 : Z), vt.current && (vt.current = !1, requestAnimationFrame(() => {
      var Xt;
      const Z = (Xt = Tt.current) == null ? void 0 : Xt.querySelector("button");
      Z == null || Z.click();
    }));
  }, []), te = L((I) => {
    if (I) {
    ...
    (I) => {
      h == null || h(I), g == null || g(I), vt.current = !0;
    },
    [h, g]
  ), ke = L(
    (I) => {
      g == null || g(I), lt.current = !0;
    },
    [g]
  ), _t = L(
    (I) => {
    ...
    [r, n, f, i]
  ), re = tt.find((I) => I.value === t), $t = () => t === "selectedBooks" && n.length > 0 ? n.map((I) => I.toUpperCase()).join(", ") : t === "range" ? Ks(at, mt, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : re ? G(re.label, re.scrRefSuffix) : t, Rt = tt.filter(
    (I) => I.value !== "selectedBooks" && I.value !== "range"
  ), ae = tt.find((I) => I.value === "selectedBooks"), oe = tt.find((I) => I.value === "range"), [Wt, pe] = k(!1), [A, J] = k(void 0), [nt, ct] = k(void 0), [E, ot] = k(void 0), [et, st] = k(void 0), [bt, St] = k([]), At = d === "dropdown" && A === "selectedBooks", se = /* @__PURE__ */ a(
    tu,
    {
      availableBookInfo: o,
      selectedBookIds: At ? bt : n,
      onChangeSelectedBookIds: At ? St : i,
      localizedStrings: s,
      localizedBookNames: c
    }
  ), ce = Yt === "end", Dr = Yt === "start", rr = "tw:text-muted-foreground", Ke = d === "dropdown" && A === "range", b = Ke ? ot : ee, rt = Ke ? st : g ? ke : ue, It = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(ce && rr), children: O }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: Tt, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Dr && rr), children: V }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
          ...
          localizedStrings: v,
          getEndVerse: z,
          disableReferencesUpTo: Ke ? E ?? at : at,
          onOpenChange: te,
          onCloseAutoFocus: (I) => {
            var Z;
            lt.current && (lt.current = !1, I.preventDefault(), (Z = Mt.current) == null || Z.focus());
          },
          className: m(Dr && rr),
          modal: !0,
          align: "start"
  ...
  const [zt, Nt] = k(null), [Ct, ft] = k(null), [jt, he] = k(null), Ge = 200, [$i, Ai] = k(!1);
  K(() => {
    if (!jt || typeof ResizeObserver > "u") return;
    const I = new ResizeObserver(([Z]) => {
      Ai(Z.contentRect.width < Ge);
    });
    return I.observe(jt), () => I.disconnect();
  }, [jt]);
  const mo = L(
    (I) => {
      ct(I), ot(at), st(mt), St(n), pe(!1), J(I);
    },
    [at, mt, n]
  ), vo = L(() => {
    nt !== void 0 && (nt === "range" ? (E && (h == null || h(E)), et && (g == null || g(et))) : nt === "selectedBooks" && i(bt), _t(nt), J(void 0), ct(void 0));
  }, [
    nt,
    E,
    et,
    ...
    I || (J(void 0), ct(void 0));
  }, []), bo = L((I) => {
    var Z;
    I.preventDefault(), (Z = qe.current) == null || Z.focus();
  }, []), xo = (I) => t === I ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ze, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: l, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !C && /* @__PURE__ */ a(Et, { children: y }),
      d === "dropdown" ? /* @__PURE__ */ u(Te, { open: Wt, onOpenChange: pe, children: [
        /* @__PURE__ */ a(Se, { asChild: !0, children: /* @__PURE__ */ u(
          q,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: $t() }),
              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          ze,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(la, { container: jt, children: [
              Rt.map(({ value: I, label: Z, dropdownLabel: Xt, scrRefSuffix: mr, id: Ii }) => /* @__PURE__ */ u(
                We,
                {
                  ref: Me(I),
                  ...
                  children: [
                    t === I && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ze, { className: "tw:h-4 tw:w-4" }) }),
                    G(Xt ?? Z, mr, $i)
                  ]
                },
                Ii
              ...
              x && /* @__PURE__ */ u(ut, { children: [
                /* @__PURE__ */ a(Je, {}),
                /* @__PURE__ */ a(Tr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: pt }),
                /* @__PURE__ */ a(
                  We,
                  {
                    ref: Lt,
                    ...
                    onSelect: (I) => {
                      ...
                      gt.current || (Xt = (Z = kt.current) == null ? void 0 : Z.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ha,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(ut, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Ne(f ?? ua, "id") }),
                              /* @__PURE__ */ a(lr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        Ga,
        {
          ...
          children: tt.map(({ value: I, label: Z, scrRefSuffix: Xt, id: mr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Yr, { className: "tw:me-2", value: I, id: mr }),
            /* @__PURE__ */ a(Et, { htmlFor: mr, children: G(Z, Xt) })
          ] }, mr))
        }
      )
    ] }),
    d === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { children: Y }),
      se
    ] }),
    d === "radio" && t === "range" && It,
    d === "dropdown" && ae && /* @__PURE__ */ a(Ea, { open: A === "selectedBooks", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: ft,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (I) => {
          Ct != null && Ct.querySelector('[data-state="open"]') && I.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: Ct, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: U }) }),
          se,
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(q, { onClick: vo, children: X })
          ] })
        ] })
      }
    ) }),
    d === "dropdown" && oe && /* @__PURE__ */ a(Ea, { open: A === "range", onOpenChange: Or, children: /* @__PURE__ */ a(
      Ta,
      {
        ref: Nt,
        onCloseAutoFocus: bo,
        onEscapeKeyDown: (I) => {
          zt != null && zt.querySelector('[data-state="open"]') && I.preventDefault();
        },
        children: /* @__PURE__ */ u(la, { container: zt, children: [
          /* @__PURE__ */ a(Sa, { className: "tw:pe-8", children: /* @__PURE__ */ a(za, { children: W }) }),
          It,
          /* @__PURE__ */ u(yo, { children: [
            /* @__PURE__ */ a(q, { variant: "outline", onClick: () => Or(!1), children: Q }),
            /* @__PURE__ */ a(q, { ref: Mt, onClick: vo, children: X })
          ] })
        ] })
      }
    ) })
...
const Si = (t, e, r, o) => r ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ a(Gt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(ts, { children: c.label }),
    /* @__PURE__ */ a(es, { children: /* @__PURE__ */ a(rs, { children: Si(
      t,
      e,
      Ti(t, c.id),
      o
...
function Ua({
  ...
  return /* @__PURE__ */ u(Te, { variant: i, children: [
    /* @__PURE__ */ a(Se, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(q, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(As, {}) }) }),
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: tr }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(dr, { children: [
      /* @__PURE__ */ a(hn, { children: /* @__PURE__ */ a(Kt, { children: Si(e.groups, e.items, l, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ a(Je, {})
    ] }, l)) })
  ] });
}
const zi = Jt.forwardRef(
...
function eh({
  ...
  return /* @__PURE__ */ u(zi, { className: `tw:w-full tw:border-b ${i}`, id: n, children: [
    r && /* @__PURE__ */ a(
      Ua,
      {
        onSelectMenuItem: t,
...
const Ri = Jt.forwardRef(({ className: t, ...e }, r) => {
  const o = be();
  return /* @__PURE__ */ a(
    we.Root,
    {
...
Ri.displayName = we.List.displayName;
const Di = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.List,
  {
    ref: r,
    className: m(
...
Di.displayName = we.List.displayName;
const au = Jt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  we.Trigger,
  {
    ref: r,
    ...e,
...
Oi.displayName = we.Content.displayName;
function ah({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ri, { children: [
      /* @__PURE__ */ a(Di, { children: t.map((c) => /* @__PURE__ */ a(au, { value: c.value, children: c.value }, c.key)) }),
...
function ou({
  ...
  return /* @__PURE__ */ a(as.Provider, { value: o, children: /* @__PURE__ */ a(
    xe.Root,
    {
      "data-slot": "menubar",
      className: m(
  ...
  return /* @__PURE__ */ a(
    xe.Trigger,
    {
      ...
      className: m(
        ...
        Za({ variant: r.variant, className: t })
      ),
      ...e
    }
  );
  ...
  return /* @__PURE__ */ a(
    xe.Item,
    {
      ...
      className: m(
        ...
        // CUSTOM: Apply variant-driven styles from menu context
        Za({ variant: n.variant, className: t })
      ),
      ...o
    }
  );
...
const br = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        lu,
        {
          onClick: () => {
            o(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ a(ea, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ a(ea, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ u(wu, { children: [
        /* @__PURE__ */ a(uu, { children: d.label }),
        /* @__PURE__ */ a(pu, { children: Mi(
          t,
          e,
          Ti(t, d.id),
          o
...
function hu({
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    var f, x, v, z;
    w.preventDefault();
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), br(s, [h, g]);
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), br(c, [h, g]);
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), br(l, [h, g]);
        break;
    }
  }), K(() => {
    ...
    return /* @__PURE__ */ a(ou, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(nu, { children: [
      /* @__PURE__ */ a(su, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        cu,
        {
          style: { zIndex: tr },
          children: /* @__PURE__ */ a(Kt, { children: Mi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ih({
  ...
  const d = gu(
    ...
    var z, C, R, P, F, S;
    const v = x !== f ? ((C = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : C[x]) ?? ((P = (R = t[f]) == null ? void 0 : R.uiNames) == null ? void 0 : P.en) : void 0;
    return v ? `${(F = t[f]) == null ? void 0 : F.autonym} (${v})` : (S = t[f]) == null ? void 0 : S.autonym;
  };
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Xe(d, {
...
function ch({
  ...
  return /* @__PURE__ */ u(Fe, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(os, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        "input",
        {
      ...
      /* @__PURE__ */ a(ns, { children: /* @__PURE__ */ a(Qs, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(Be, { children: [
      /* @__PURE__ */ a(aa, { children: h }),
      d.map(({ tag: f, info: x }) => {
        const v = f === e;
        return /* @__PURE__ */ u(
          De,
...
function mu({ item: t, createLabel: e, createComplexLabel: r }) {
...
function dh({
  ...
  const c = t ? So(r, { key: o }).join("") : "", {
    anchorRect: l,
    message: d,
    confirmingKeyLabel: w,
    showArrow: p
  } = bu(t, { anchorRect: e, message: r, confirmingKeyLabel: o, showArrow: s });
  return /* @__PURE__ */ u(Kt, { children: [
    /* @__PURE__ */ a("span", { role: "status", className: "tw:sr-only", children: c }),
    /* @__PURE__ */ u(qt, { open: t, onOpenChange: () => {
    }, children: [
      /* @__PURE__ */ a(
        Gt,
        {
      ...
      /* @__PURE__ */ a(
        Ht,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: So(d, {
            key: /* @__PURE__ */ a(
              Ra,
              {
                className: m(
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(dr, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(Se, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Co, {}) }) }),
              /* @__PURE__ */ a(ze, { align: "end", children: d })
            ] }) }),
            e && d && /* @__PURE__ */ u(Te, { children: [
              /* @__PURE__ */ a(Se, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(q, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Co, {}) }) }),
              /* @__PURE__ */ a(ze, { align: "end", children: d })
            ] })
          ] }),
...
function hh({ currentStep: t, totalSteps: e, locale: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center", "aria-hidden": "true", children: s.map((c) => {
    let l = "upcoming";
    return c === i ? l = "active" : c < i && (l = "complete"), /* @__PURE__ */ u(dr, { children: [
      ...
      /* @__PURE__ */ a(
        "div",
        {
          ...
          children: l === "complete" ? /* @__PURE__ */ a(Ze, { className: "tw:h-4 tw:w-4" }) : n(c)
        }
      )
    ] }, c);
  }) });
...
function Bh({ ...t }) {
  ...
  return /* @__PURE__ */ a(
    cl,
    {
      ...
      icons: {
        success: /* @__PURE__ */ a(oc, { className: "tw:size-4" }),
        info: /* @__PURE__ */ a(ac, { className: "tw:size-4" }),
        warning: /* @__PURE__ */ a(rc, { className: "tw:size-4" }),
        error: /* @__PURE__ */ a(ec, { className: "tw:size-4" }),
...
function Gh({
  ...
  return /* @__PURE__ */ a(
    we.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: m("pr-twp", _u({ variant: e }), t),
      dir: o,
      ...r
    }
  );
...
function Zh(t) {
  const e = $(() => qs(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Eu = () => {
  const [t, e] = k(
...
Su(`/* By default the editor is too tall for the footnote editor, even while empty, so this makes it
   shorter. */
...
export {
  ...
  op as CommentEditor,
  pp as CommentList,
  jd as ConflictNoteCard,
  vh as ContextMenu,
  Sh as ContextMenuCheckboxItem,
  Nh as ContextMenuContent,
  xh as ContextMenuGroup,
  Ch as ContextMenuItem,
  Rh as ContextMenuLabel,
  yh as ContextMenuPortal,
  _h as ContextMenuRadioGroup,
  zh as ContextMenuRadioItem,
  Dh as ContextMenuSeparator,
  Oh as ContextMenuShortcut,
  kh as ContextMenuSub,
  Th as ContextMenuSubContent,
  Eh as ContextMenuSubTrigger,
  bh as ContextMenuTrigger,
  Jd as DataTable,
  dh as DestructiveKeyConfirmation,
  Ea as Dialog,
  ag as DialogClose,
  Ta as DialogContent,
  og as DialogDescription,
  yo as DialogFooter,
  Sa as DialogHeader,
  ng as DialogOverlay,
  ig as DialogPortal,
  ...
  rs as DropdownMenuSubContent,
  ts as DropdownMenuSubTrigger,
  Se as DropdownMenuTrigger,
  Zd as ERROR_DUMP_STRING_KEYS,
  mp as ERROR_POPOVER_STRING_KEYS,
  ...
  Ew as FootnoteItem,
  Cp as FootnoteList,
  xw as INLINE_APPLY_DEBOUNCE_MS,
  sh as INTERFACE_LANGUAGE_PICKER_STRING_KEYS,
  Op as INVENTORY_STRING_KEYS,
  oa as Input,
  ch as InterfaceLanguagePicker,
  Mp as Inventory,
  Ra as Kbd,
  lg as KbdGroup,
  Et as Label,
  ...
  bg as Z_INDEX_FIRST_RUN,
  gn as Z_INDEX_FOOTNOTE_EDITOR,
  xg as Z_INDEX_MODAL,
  yg as Z_INDEX_MODAL_BACKDROP,
  Ji as Z_INDEX_OVERLAY,
  kg as badgeVariants,
  _g as buttonGroupVariants,
  Ng as buttonVariants,
  m as cn,
  Dp as getBookIdFromUSFM,
  aw as getCaretPositionFromClick,
  sp as getCommentThreadElementId,
  sa as getInventoryHeader,
  zp as getLinesFromUSFM,
  Rp as getNumberFromUSFM,
  ...
  Ya as isMacOs,
  Cg as isWindows,
  Tu as pickTabIconUrl,
  Sg as sonner,
  Wh as useEvent,
  Xh as useEventAsync,
  Zh as useExtraValidMarkers,
  Ki as useListbox,
  Cu as usePromise,
  Qu as useRecentSearches,
  ca as useSidebar,
  Jh as useStylesheet,
  Qh as useTabIconSelection,
  Eg as useTruncationTooltip,
  Eu as useViewVisibility
};
