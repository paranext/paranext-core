...
import { aB as Eg, aC as Tg, aD as Sg, aE as Rg, aF as zg, aG as Dg, aH as Mg, aI as Og, aJ as Ig, aK as $g, aL as Pg, aM as Ag, aN as Vg, aO as Lg, aP as jg, aQ as Bg, aR as Fg, aS as Ug, aT as Kg, aU as Hg, aV as Gg, aW as qg, aX as Wg, aY as Yg, aZ as Xg, a_ as Jg, a$ as Zg, b0 as Qg, b1 as tf, b2 as ef, b3 as rf, b4 as af, b5 as of, b6 as nf, b7 as sf, b8 as cf, b9 as lf } from "./resizable-5NEfrGIS.js";
...
import qt, { useRef as U, useMemo as A, createContext as Or, useContext as la, useState as _, useEffect as Y, useCallback as L, useImperativeHandle as wc, useLayoutEffect as te, Component as uc, createElement as jo, Suspense as pc, forwardRef as Ln, useId as Bo, Fragment as da } from "react";
...
import { Avatar as yo, Select as Wt, Checkbox as Ho, Slot as $r, Tabs as de, Menubar as xe, ContextMenu as Pt, Progress as Go, Slider as Lr, Switch as qo } from "radix-ui";
...
function Ml({
  ...
  Y(() => {
    ...
    if (!Q) return;
    const N = (G) => !!G && G.scrollWidth > G.clientWidth, et = () => {
...
function Ra({
  ...
  const E = be(), F = zl(), [O, z] = _(!1), [K, W] = _(""), [j, Q] = _(""), [N, et] = _("books"), [D, M] = _(void 0), [G, nt] = _(
    void 0
  ...
  const yt = L(() => {
    ...
    (k) => {
      const rt = G ?? (P == null ? void 0 : P.book), at = ot ?? (P == null ? void 0 : P.chapterNum);
      !rt || !at || (gt({
        book: rt,
        chapterNum: at,
        verseNum: k
  ...
  const { otLong: $, ntLong: tt, dcLong: ct, extraLong: pt } = {
    ...
    [t.book, i, F]
  ), Pr = `${t.chapterNum}:${t.verseNum}`, Ge = L((k) => (rt) => {
    St.current[k] = rt;
  }, []), ze = L((k) => (rt) => {
    Ft.current[k] = rt;
  }, []), Ar = A(
  ...
  return te(() => {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Ve, { open: O, onOpenChange: q, modal: y, children: [
    ...
    /* @__PURE__ */ a(
      Le,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: rt } = k;
          O && mt.current && rt instanceof Node && mt.current.contains(rt) && (vt.current = !0, q(!1));
        },
        onCloseAutoFocus: R,
        children: /* @__PURE__ */ u(
          je,
          {
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                N === "verses" && G && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ge(G, i)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? qe : vr
                  }
                )
              ] }),
...
function Ye(t, e) {
  Gt.call(this, void 0), this.x = t, this.s = void 0, this.g = Wr - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function hd(t, e) {
  return new Ye(t, e);
}
...
Gt.prototype.brand = wd, Gt.prototype.h = function() {
  return !0;
...
} }), Ye.prototype = new Gt(), Ye.prototype.h = function() {
...
function Pi({
  ...
  const [j, Q] = _(hn), [N, et] = _(), [D, M] = _(), G = o, [nt, ot] = _(!1), [ut, jt] = _(!1), [J, st] = _(!1), [ft, mt] = _(!1), [vt, _t] = _(!1), [ht, Bt] = _(T), [re, St] = _(!1), Ft = U(void 0), [gt, Yt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const $ = y ? await y(l) : !1;
...
function ww({
  ...
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), j = (D) => D ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: D }) : W, Q = () => {
    ...
    const M = f === D.value, G = `${d}-${D.value}`, nt = N(D);
    return (
...
function Vp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [T, I] = _(), [E, F] = _(), O = L(
    async (M) => {
      const G = await i(M);
      return G !== void 0 && M.assignedUser !== void 0 && M.assignedUser !== "" && F(M.assignedUser), G;
    },
    [i]
  );
  Y(() => {
  ...
  const z = r.filter(
    ...
    (M) => {
      C((G) => new Set(G).add(M.id)), I(M.id), b == null || b(M.id);
    },
    [b]
  ), j = L(
    (M) => {
      ...
      children: z.map((M) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: M.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...G, conflictResolution: R }) : /* @__PURE__ */ a(Pi, { ...G })
          },
          M.id
        );
      })
...
function Wp({
  ...
  const [v, R] = _("generated"), [y, C] = _("generated"), [T, I] = _("*"), [E, F] = _("*"), [O, z] = _("f"), [K, W] = _(!1), [j, Q] = _(!0), [N, et] = _(!1), D = U(!1), M = U(""), [G, nt] = _(!1), [ot, ut] = _(), [jt, J] = _(), [st, ft] = _(), [mt, vt] = _(), _t = U(null), ht = U(
    void 0
  ...
  const gt = L(() => {
    var x, H, $;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), B = S == null ? void 0 : S.querySelector("span.note"), q = ($ = (H = g.current) == null ? void 0 : H.ownerDocument.getSelection()) == null ? void 0 : $.anchorNode;
    return !!B && !!q && B.contains(q);
  }, []);
  Y(() => {
    var H, $;
    let S, B, q;
    ...
    return () => {
      S && clearTimeout(S), B !== void 0 && cancelAnimationFrame(B), q !== void 0 && clearTimeout(q);
    };
  }, [e, i, gt]);
  const Yt = L(
    (S = !1) => {
      var q, x, H;
      p == null || p();
      const B = (x = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : x.at(0);
    ...
    (S, B) => {
      var H, $, tt;
      const q = ($ = (H = h.current) == null ? void 0 : H.getNoteOps(0)) == null ? void 0 : $.at(0);
      if (!q || !xr("note", q) || !q.insert.note) return;
      let x;
      S === "custom" ? x = B : S === "generated" ? x = Ja : x = Za, q.insert.note.caller !== x && (q.insert.note.caller = x, (tt = h.current) == null || tt.applyUpdate([q, { delete: 1 }]));
    },
    []
  ), Nt = L(() => {
    var S;
  ...
  const we = () => {
    ...
    if (f.current && Ft.length && S && S.rangeCount > 0) {
      const B = S.getRangeAt(0).getBoundingClientRect(), q = f.current.getBoundingClientRect();
      ut(B.left - q.left), J(B.top - q.top), ft(B.height), nt(!0);
    }
  }, [Ft, f]), yt = U(() => {
  }), se = L(
    (S, B, q) => {
  ...
  Y(() => {
    ...
    const B = (x) => {
      const H = S();
      !G && H && document.activeElement === H && x.key === c ? (x.preventDefault(), Ut()) : G && x.key === "Escape" && (x.preventDefault(), nt(!1));
    };
    ...
    const S = () => {
      ...
      q && !q.isCollapsed || gt() || ((H = h.current) == null || H.selectNote(0), ($ = h.current) == null || $.focus());
    };
...
function oh({
  ...
  }, [F, et]), M = A(() => D.length === 0 ? [] : Zw(D, z, W), [D, z, W]), G = A(() => {
    var ft, mt;
    if (!F) return l;
...
const tu = "16rem", eu = "3rem", Vi = qt.createContext(void 0);
function ga() {
...
function ru({
  ...
  const [l, d] = qt.useState(t), w = e ?? l, p = qt.useCallback(
    ...
    [r, w]
  ), h = qt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", v = be() === "ltr" ? s : s === "primary" ? "secondary" : "primary", R = qt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function yh({
  ...
  const I = zt(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = zt(s, "%webView_scope_selector_current_book%"), j = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), N = zt(s, "%webView_scope_selector_select_books%"), et = zt(s, "%webView_scope_selector_range%"), D = zt(s, "%webView_scope_selector_select_range%"), M = zt(s, "%webView_scope_selector_range_start%"), G = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), ot = zt(s, "%webView_scope_selector_cancel%"), ut = zt(s, "%webView_scope_selector_navigate%"), jt = (V) => {
    if (!b) return;
  ...
  ), Zt = ft.find((V) => V.value === "selectedBooks"), Kt = ft.find((V) => V.value === "range"), [ue, ke] = _(!1), [S, B] = _(void 0), [q, x] = _(void 0), [H, $] = _(void 0), [tt, ct] = _(void 0), [pt, Ct] = _([]), Rt = w === "dropdown" && S === "selectedBooks", Vt = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), ae = Yt === "end", Pr = Yt === "start", Ge = "tw:text-muted-foreground", ze = w === "dropdown" && S === "range", Ar = ze ? $ : Re, ma = ze ? ct : f ? oe : ht, Vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-start", className: m(ae && Ge), children: M }),
      /* @__PURE__ */ a(
        Ra,
        {
  ...
  const [qe, va] = _(null), [We, ba] = _(null), [ar, xa] = _(null), ya = 200, [ka, _a] = _(!1);
  Y(() => {
  ...
  const k = L(
    ...
    q !== void 0 && (q === "range" ? (H && (g == null || g(H)), tt && (f == null || f(tt))) : q === "selectedBooks" && i(pt), P(q), B(void 0), x(void 0));
  }, [
    q,
    H,
    tt,
...
const Tu = Object.freeze([520, 420, 340]), Ui = qt.forwardRef(
