...
var Nt = (t, e, r) => si(t, typeof e != "symbol" ? e + "" : e, r);
...
import { Slot as ke, Dialog as Yt, Popover as rr, Label as wi, RadioGroup as oa, Tooltip as Le, ToggleGroup as Mo, Separator as ui, Avatar as ka, DropdownMenu as vt, Select as Et, Checkbox as Ka, Tabs as Kt, Menubar as Qt, ContextMenu as bt, Progress as Ga, Slider as dr, Switch as qa } from "radix-ui";
import { cva as te } from "class-variance-authority";
import { IconX as pi, IconCheck as $e, IconSearch as gi, IconChevronRight as _a, IconChevronDown as hi, IconChevronUp as fi, IconSelector as mi, IconLayoutSidebar as vi, IconLayoutSidebarRight as bi, IconLoader as xi, IconAlertOctagon as yi, IconAlertTriangle as ki, IconInfoCircle as _i, IconCircleCheck as Ni } from "@tabler/icons-react";
import { Canon as lt } from "@sillsdev/scripture";
import { includes as wr, Section as Y, getChaptersForBook as Ci, formatScrRef as De, getSectionForBook as Qe, formatRelativeDate as Ei, formatReplacementString as oe, sanitizeHtml as zi, NumberFormat as Ti, formatBytes as Si, getCurrentLocale as Di, usfmMarkers as mr, getFormatCallerFunction as Ri, deepEqual as Mi, isString as Ha, compareScrRefs as na, scrRefToBBBCCCVVV as Br, getLocalizeKeyForScrollGroupId as J } from "platform-bible-utils";
import { Check as nr, Clock as Wa, ChevronsLeft as Ya, ChevronsRight as Xa, ChevronLeft as ia, ChevronRight as sa, ArrowLeft as $i, ArrowRight as Oi, ChevronDown as Rr, BoldIcon as Ai, ItalicIcon as Ii, X as Mr, AtSign as $o, Pencil as Pi, Trash2 as Li, ArrowUp as Oo, MoreHorizontal as Vi, MailOpen as ji, Mail as Fi, ChevronUp as Bi, FilterIcon as Ui, ArrowLeftIcon as Ki, ChevronLeftIcon as Gi, ChevronRightIcon as qi, ArrowRightIcon as Hi, Copy as Ao, Filter as Wi, User as Yi, Link as Xi, CircleHelp as Ji, ChevronsUpDown as Io, Star as Zi, Undo as Qi, Redo as ts, SquareX as Po, FunctionSquare as Lo, SquareSigma as Vo, Ban as es, AlertCircle as la, CircleCheckIcon as rs, CircleXIcon as as, CircleHelpIcon as os, ArrowUpIcon as ns, ArrowDownIcon as is, Search as ss, LoaderCircle as ls, ScrollText as cs, MenuIcon as ds, Menu as ws, EllipsisVertical as us, MoreVertical as Ja } from "lucide-react";
import tt, { forwardRef as ir, useRef as G, useMemo as L, useState as T, useCallback as j, useLayoutEffect as At, createContext as $r, useContext as Na, useEffect as K, Component as ps, createElement as Za, Suspense as gs, Fragment as jo } from "react";
import { createEditor as Fo, $getRoot as le, $createParagraphNode as We, $getSelection as Tt, HISTORY_MERGE_TAG as Ca, ParagraphNode as Bo, TextNode as Uo, $isTokenOrSegmented as hs, $getCharacterOffsets as fs, $cloneWithPropertiesEphemeral as ms, $getPreviousSelection as vs, $isRangeSelection as Xt, $caretFromPoint as bs, $getSiblingCaret as Ko, $getChildCaret as xs, $getAdjacentChildCaret as ys, $isChildCaret as ks, $normalizeCaret as _s, $setSelectionFromCaretRange as Ns, $getCollapsedCaretRange as Cs, $getCaretInDirection as Qa, $splitAtPointCaretNext as Es, $isTextPointCaret as zs, $findMatchingParent as Go, $isElementNode as ie, mergeRegister as ce, getDOMTextNode as Ts, isHTMLElement as qo, CLEAR_EDITOR_COMMAND as Ho, COMMAND_PRIORITY_EDITOR as Ea, shallowMergeConfig as Ss, defineExtension as jt, safeCast as Oe, createState as Ds, FORMAT_TEXT_COMMAND as Wo, $isNodeSelection as Yo, COMMAND_PRIORITY_LOW as Xo, RootNode as Rs, LineBreakNode as Ms, TabNode as $s, $isEditorState as Os, createCommand as As, CLICK_COMMAND as Is, isDOMNode as Ps, $getNodeFromDOMNode as Ls, $createNodeSelection as Vs, $setSelection as js, $getEditor as Fs, DecoratorNode as ca, $getState as Bs, toggleTextFormatType as to, TEXT_TYPE_TO_FORMAT as Us, $setState as Ks, addClassNamesToElement as Jo, $create as Gs, $getNodeByKey as qs, removeClassNamesFromElement as Hs, KEY_TAB_COMMAND as Ws, $isBlockElementNode as yr, $createRangeSelection as Ys, $normalizeSelection__EXPERIMENTAL as Xs, OUTDENT_CONTENT_COMMAND as Js, INDENT_CONTENT_COMMAND as eo, INSERT_TAB_COMMAND as Zs, COMMAND_PRIORITY_CRITICAL as za, $isDecoratorNode as Qs, $isParagraphNode as tl, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Zo, getRegisteredNode as el, isDocumentFragment as ro, isDOMDocumentNode as rl, ArtificialNode__DO_NOT_USE as Qo, $createLineBreakNode as tn, $isRootOrShadowRoot as al, isBlockDomNode as ao, isInlineDomNode as oo, $insertNodes as ol } from "lexical";
...
import { useReactTable as rn, getFilteredRowModel as wl, getSortedRowModel as an, getPaginationRowModel as ul, getCoreRowModel as on, flexRender as tr, getGroupedRowModel as pl, getExpandedRowModel as gl } from "@tanstack/react-table";
import hl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as da, HIDDEN_NOTE_CALLER as wa, getDefaultViewOptions as fl, isInsertEmbedOpOfType as ur, Editorial as ml } from "@eten-tech-foundation/platform-editor";
...
const Ye = 250, nn = 300, Nl = 400, Cl = 450, El = 500, sn = te(
...
const un = lt.allBookIds.filter(
  (t) => !lt.isObsolete(lt.bookIdToNumber(t))
), Re = Object.fromEntries(
  un.map((t) => [t, lt.bookIdToEnglishName(t)])
);
function Da(t, e, r) {
...
function Ll({
  ...
  return /* @__PURE__ */ u(we, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(Jt, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      de,
      {
        onSelect: () => h(p),
...
function Mu(t, e, r = (n, i) => n === i, o = 15) {
  return (n) => {
    const i = t.filter(
      (l) => !r(l, n)
    ), s = [n, ...i.slice(0, o - 1)];
...
function io({
  ...
  if (t)
    return /* @__PURE__ */ a(Jt, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: Wt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ a(
      de,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function $u({
  ...
  const d = st(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, I] = T(!1), O = G(void 0), A = G(void 0), C = G(void 0), z = G(void 0), E = G({}), $ = j(
    (M) => {
      e(M), l && l(M);
    },
    [e, l]
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: W, isDigit: Z } = no(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && y) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        ...
        R !== ot && (M.preventDefault(), M.stopPropagation(), p(pa(ut, n, R)), setTimeout(() => {
    ...
    const { isLetter: W, isDigit: Z } = no(M.key);
    (W || Z) && (M.preventDefault(), b((ut) => ut + M.key), A.current.focus(), I(!1));
  }, []);
  return At(() => {
    const M = setTimeout(() => {
      ...
      Ne,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: dt.map(({ onClick: M, disabled: W, title: Z, icon: ut }) => /* @__PURE__ */ a(
              V,
              {
                variant: "ghost",
                size: "sm",
          ...
          !k && /* @__PURE__ */ u(Ce, { ref: C, children: [
            v === "books" && /* @__PURE__ */ u(et, { children: [
              !y && Object.entries(H).map(([M, W]) => {
                if (W.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ a(Jt, { heading: ge(M), children: W.map((Z) => /* @__PURE__ */ a(
                      pn,
                      {
                        bookId: Z,
                        onSelect: (ut) => ct(ut),
...
function _r({
  ...
  const [_, k] = T(!1), I = d ?? c, O = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = c(C), $ = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, P = `${z ?? ""}${E}${$ ?? ""}`;
    return /* @__PURE__ */ u(
      de,
      {
        value: E,
    ...
    /* @__PURE__ */ a(
      ue,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: O(e) ? e.map((C) => /* @__PURE__ */ a(Jt, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : /* @__PURE__ */ a(Jt, { children: e.map((C) => A(C)) }) })
        ] })
      }
    )
  ] });
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gl = fn ? At : K, pr = { tag: Ca };
function ql({ initialConfig: t, children: e }) {
  const r = L(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: l, html: c } = t, d = Kl(null, o), w = Fo({ editable: t.editable, html: c, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
...
function ec() {
  return function(t) {
    const [e] = ee(), r = L(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = G(o);
    return Ql(() => {
...
const mn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, oc = mn && "documentMode" in document ? document.documentMode : null;
!(!mn || !("InputEvent" in window) || oc) && "getTargetRanges" in new window.InputEvent("input");
function Ht(t) {
  return `${t}px`;
}
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((O || A) && k !== null && I !== null) {
        const C = function(z, E, $, P, q, D, H) {
          const y = (z._window ? z._window.document : document).createRange();
          return y.setStart(...so(E, $, P)), y.setEnd(...so(q, D, H)), y;
        }(t, h, m, k, p, N, I);
        c(), c = ic(t, C, e);
      }
...
function uc(t, e, r) {
  ...
  return zs(o) && Nr(283), o.insert(t.isInline() ? We().append(t) : t), Qa(Ko(t.getLatest(), "next"), e.direction);
}
function pc(t) {
  const e = Tt();
  if (!Xt(e)) return !1;
...
let Cr, se = 0, Er = 0, fc = 0, fa = 0, vr = 0;
function co(t) {
  if (X === void 0) return;
  let e = t.n;
...
Ct.prototype.brand = gc, Ct.prototype.h = function() {
  return !0;
...
function yn() {
  const t = le(), e = Tt(), r = We();
  t.clear(), t.append(r), e !== null && r.select(), Xt(e) && (e.format = 0);
}
function kn(t, e = yn) {
  return t.registerCommand(Ho, (r) => (t.update(e), !0), Ea);
}
jt({ build: (t, e, r) => Xe(e), config: Oe({ $onClear: yn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Zt(() => kn(t, o.value));
} });
function bc(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const qr = Ds("format", { parse: (t) => typeof t == "number" ? t : 0 });
class _n extends ca {
  $config() {
...
jt({ name: "@lexical/extension/DecoratorText", nodes: () => [_n], register: (t, e, r) => t.registerCommand(Wo, (o) => {
  const n = Tt();
  if (Yo(n) || Xt(n)) for (const i of n.getNodes()) xc(i) && i.toggleFormat(o);
  return !1;
}, Xo) });
function Nn(t, e) {
  let r;
...
const ma = jt({ build: (t) => Nn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const Cc = jt({ config: Oe({ setOptions: uo, updateOptions: uo }), init: ({ $initialEditorState: t = Nc }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Rs, Uo, Ms, $s, Bo] }), po = Symbol.for("@lexical/extension/LexicalBuilder");
function go() {
}
function Ec(t) {
  throw t;
...
const zc = /* @__PURE__ */ new Set(), ho = jt({ build(t, e, r) {
...
}, dependencies: [ma], name: "@lexical/extension/NodeSelection" }), Tc = As("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends ca {
  static getType() {
...
jt({ dependencies: [ma, ho], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ce(t.registerCommand(Tc, (s) => {
    ...
    return !0;
  }, Ea), t.registerCommand(Is, (s) => {
    if (Ps(s.target)) {
      const l = Ls(s.target);
      if (Dc(l)) return function(c, d = !1) {
        const w = Tt(), g = c.isSelected(), h = c.getKey();
        let p;
        d && Yo(w) ? p = w : (p = Vs(), js(p)), g ? p.delete(h) : p.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: Tn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Zt(() => {
    if (!o.value) return Rc(t, n, i);
  });
} });
const Mc = jt({ name: "@lexical/react/ReactProvider" });
function $c() {
...
jt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Zt(() => r.getOutput().disabled.value ? void 0 : Dn(t)) });
function Ic(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const Ia = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
...
const Bc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Uc({ onClear: t }) {
  const [e] = ee();
  return Bc(() => kn(e, t), [e, t]), null;
}
const Rn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : K;
function Kc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: g, ariaRequired: h, autoCapitalize: p, className: m, id: b, role: v = "textbox", spellCheck: N = !0, style: x, tabIndex: _, "data-testid": k, ...I }, O) {
  const [A, C] = T(t.isEditable()), z = j(($) => {
    $ && $.ownerDocument && $.ownerDocument.defaultView ? t.setRootElement($) : t.setRootElement(null);
  }, [t]), E = L(() => /* @__PURE__ */ function(...$) {
    return (P) => {
      for (const q of $) typeof q == "function" ? q(P) : q != null && (q.current = P);
    };
  }(O, z), [z, O]);
  return Rn(() => (C(t.isEditable()), t.registerEditableListener(($) => {
    C($);
...
function Zc({
  ...
  const [e] = ee(), [r, o] = T(e), [n, i] = T("paragraph"), [s, l] = Jc(), c = () => {
  };
...
function Ln(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  return w != null && (h = w(h)), ao(t) && (h = sd(t, h, p ? () => {
    const m = new Qo();
    return r.push(m), m;
...
function Lu({
  ...
  const [i, s] = T(dd), [l, c] = T(n), [d, w] = T(!1), g = G(void 0), h = G(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : Va(v) && (v.preventDefault(), v.stopPropagation(), Ot(i) && p());
        },
        onKeyDown: (v) => {
...
function xo({
  ...
  const p = j(
    ...
    [t.user]
  ), x = L(() => zi(t.contents), [t.contents]), _ = L(() => {
    if (o && l)
      return /* @__PURE__ */ u(et, { children: [
        /* @__PURE__ */ u(
          ba,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), p()) : Va(k) && (k.preventDefault(), k.stopPropagation(), Ot(w) && m());
              },
              onKeyDown: (k) => {
        ...
        _ && /* @__PURE__ */ u(be, { children: [
          /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Vi, {}) }) }),
...
function Cd({
  ...
  const [C, z] = T(yo), [E, $] = T(), [P, q] = T(), D = o, [H, y] = T(!1), [F, ct] = T(!1), [xt, $t] = T(!1), [dt, St] = T(!1), [U, nt] = T(!1), [at, wt] = T(k), [zt, ge] = T(!1), yt = G(void 0), [he, re] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
  ...
  K(() => {
    if (!o) {
      kt.current !== "idle" && ($(void 0), q(void 0), kt.current = "idle");
      return;
    }
  ...
  const ae = L(() => Ft[0], [Ft]), M = G(null), W = G(void 0), Z = j(() => {
    var S;
    (S = W.current) == null || S.call(W), z(yo);
  }, []), ut = j(() => {
    const S = !at;
  ...
  const ot = L(
    ...
    () => pt === 1 ? ot.singleReply : oe(ot.multipleReplies, { count: pt }),
    [pt, ot]
  );
  K(() => {
    !o && F && rt && ct(!1);
  ...
  const mt = j(
    ...
    async (S) => {
      const gt = Ot(C) ? Tr(C) : void 0, ht = S.status ? S.assignedUser : E ?? S.assignedUser, Bt = await g({
        ...S,
        contents: gt,
        assignedUser: ht
      });
            ...
            o && /* @__PURE__ */ u(et, { children: [
              ...
              v !== !1 && (!F || Ot(C)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (S) => {
                    Va(S) && (S.preventDefault(), S.stopPropagation(), (Ot(C) || E !== void 0 && E !== P) && mt());
                  },
                  onKeyDown: (S) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Ot(C) || E !== P) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: oe(
                      ...
                      /* @__PURE__ */ u(we, { open: xt, onOpenChange: $t, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          V,
                          {
                            size: "icon",
...
function Hu({
  ...
  const C = r.filter(
    ...
    [N, b]
  ), { listboxRef: P, activeId: q, handleKeyDown: D } = pd({
    options: z,
    onOptionSelect: E
  }), H = j(
    (y) => {
...
function qe({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Et.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Et.Icon, { asChild: !0, children: /* @__PURE__ */ a(mi, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Ut({
  ...
  return /* @__PURE__ */ u(
    Et.Item,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2 tw:flex tw:size-4 tw:items-center tw:justify-center", children: /* @__PURE__ */ a(Et.ItemIndicator, { children: /* @__PURE__ */ a($e, { className: "tw:pointer-events-none" }) }) }),
...
function Ad({
  ...
  var O;
  const [w, g] = T([]), [h, p] = T([]), [m, b] = T({}), [v, N] = T({}), x = L(() => e ?? [], [e]), _ = rn({
    data: x,
    columns: t,
    getCoreRowModel: on(),
  ...
  return c ? I = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(ne, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(xa, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((O = _.getRowModel().rows) == null ? void 0 : O.length) > 0 ? I = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    A.id
  )) : I = /* @__PURE__ */ a(ne, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: l, children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ u("div", { className: "tw:inline-flex tw:items-start tw:justify-start tw:gap-4 tw:self-stretch", children: [
          ...
          /* @__PURE__ */ a(V, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ a(Ao, {}) })
        ] }),
...
function Gn({
  ...
  const [N, x] = T(!1), _ = j(
    (E) => {
      var P;
      const $ = (P = t.find((q) => q.label === E)) == null ? void 0 : P.value;
      $ && r(
        e.includes($) ? e.filter((q) => q !== $) : [...e, $]
      );
    },
    [t, e, r]
  ), k = () => c || o, I = L(() => {
    if (!h) return t;
    const E = t.filter((P) => P.starred).sort((P, q) => P.label.localeCompare(q.label)), $ = t.filter((P) => !P.starred).sort((P, q) => {
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(we, { open: C, onOpenChange: w ?? x, children: [
    ...
    /* @__PURE__ */ a(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        ...
        /* @__PURE__ */ a(Jt, { children: I.map((E) => /* @__PURE__ */ u(
          de,
          {
            value: E.label,
            onSelect: _,
...
function Fd({
  ...
  const c = L(() => /Macintosh/i.test(navigator.userAgent), []), d = Co(n, "%undoButton_tooltip%"), w = Co(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(La, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(
        V,
...
function Kd({
  ...
  return /* @__PURE__ */ u(be, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Ud(t, n, r) }) }) }),
...
function Hd({
  ...
  return /* @__PURE__ */ u(be, { children: [
    /* @__PURE__ */ a(It, { children: /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: /* @__PURE__ */ a(xe, { asChild: !0, children: /* @__PURE__ */ a(V, { variant: "outline", className: "tw:h-6", children: Gd(t, r) }) }) }),
      /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ a("p", { children: qd(t, r) }) })
    ] }) }),
...
function np({
  ...
  const [m, b] = T("generated"), [v, N] = T("generated"), [x, _] = T("*"), [k, I] = T("*"), [O, A] = T("f"), [C, z] = T(!1), [E, $] = T(!0), [P, q] = T(!1), D = G(!1), H = G(""), [y, F] = T(!1), [ct, xt] = T(), [$t, dt] = T(), [St, U] = T(), [nt, at] = T(), wt = G(null), zt = L(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let _t = "custom";
      pt === da ? _t = "generated" : pt === wa ? _t = "hidden" : pt && (_(pt), I(pt)), b(_t), N(_t), A(((it = B.insert.note) == null ? void 0 : it.style) ?? "f"), R = setTimeout(() => {
        var Rt;
  ...
  const yt = j(
    (R, B, rt = !1) => {
      ...
      if (it && ur("note", it)) {
        if (it.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = da : mt = wa, it.insert.note.caller = mt;
        }
  ...
  const Ft = () => {
    ...
    if (B && ur("note", B)) {
      ...
      O !== "x" && R === "x" ? mt == null || mt.forEach((Mt) => Zd(Mt)) : O === "x" && R !== "x" && (mt == null || mt.forEach((Mt) => Qd(Mt))), (Rt = w.current) == null || Rt.applyUpdate([B, { delete: 1 }]);
    }
  }, Z = (R) => {
    ...
    (R) => {
      ...
      if (B && ur("note", B)) {
        ...
        const mt = (pt = B.insert.note) == null ? void 0 : pt.style, Mt = (Rt = (_t = B.insert.note) == null ? void 0 : _t.contents) == null ? void 0 : Rt.ops;
        if (mt || z(!1), z(
          mt === "x" ? !!(Mt != null && Mt.every((S) => {
            var ht, Bt;
          ...
          D.current = !0, H.current = JSON.stringify(B), $(!0);
          return;
        }
        $(JSON.stringify(B) === H.current), yt(m, x);
      } else
        z(!1), $(!0);
    },
    [m, x, yt]
...
const iw = (t) => {
  ...
  return e ? e[1] : "";
}, lw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", gp = Object.freeze([
...
function hp({
  ...
  const p = Gt(r, "%webView_inventory_all%"), m = Gt(r, "%webView_inventory_approved%"), b = Gt(r, "%webView_inventory_unapproved%"), v = Gt(r, "%webView_inventory_unknown%"), N = Gt(r, "%webView_inventory_scope_currentBook%"), x = Gt(r, "%webView_inventory_scope_chapter%"), _ = Gt(r, "%webView_inventory_scope_verse%"), k = Gt(r, "%webView_inventory_filter_text%"), I = Gt(
    r,
    "%webView_inventory_show_additional_items%"
  ), O = Gt(r, "%webView_inventory_no_results%"), [A, C] = T(!1), [z, E] = T("all"), [$, P] = T(""), [q, D] = T([]), H = L(() => {
    const U = t ?? [];
  ...
  }, [A, H]), F = L(() => y.length === 0 ? [] : cw(y, z, $), [y, z, $]), ct = L(() => {
    var at, wt;
    if (!A) return c;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => $t(U), defaultValue: s, children: [
...
const Wn = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(ls, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function vp({
  ...
  const [s, l] = T(""), [c, d] = T([]), w = L(
    () => t.filter((D) => !r || D.type === r).filter((D) => uw(D, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: b, hasMore: v } = ww(p), N = L(
    ...
    n,
    "%resourcePicker_section_available_to_download%"
  ), z = qt(n, "%resourcePicker_button_use%"), E = qt(n, "%resourcePicker_no_results%"), $ = qt(n, "%resourcePicker_showing_count%"), P = L(() => {
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    q && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: oe($, {
      filtered: w.length,
      total: t.length
    }) }),
...
const pw = "16rem", gw = "3rem", Yn = tt.createContext(void 0);
function Fr() {
    ...
    fw,
    {
      ...
      children: /* @__PURE__ */ u(vw, { children: [
        /* @__PURE__ */ u(zo, { children: [
          ...
          /* @__PURE__ */ a(So, { children: /* @__PURE__ */ a(bw, { children: Object.entries(e).map(([h, p]) => /* @__PURE__ */ a(xw, { children: /* @__PURE__ */ a(
            kw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const fe = "scrBook", Nw = "scrRef", Se = "source", Cw = "details", Ew = "Scripture Reference", zw = "Scripture Book", Xn = "Type", Tw = "Details";
function Sw(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Do = (t) => `${Dw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function $p({
  sources: t,
  ...
  K(() => {
    if (l) {
      ...
      if (E.length === 1) {
        const $ = b.find((P) => Do(P) === E[0]) || void 0;
        $ && l($);
      }
    }
  }, [p, b, l, N]);
  const x = n ?? zw, _ = i ?? Xn, k = [
  ...
  }, A = (z, E) => z.getIsGrouped() ? "" : f("banded-row", E % 2 === 0 ? "even" : "odd"), C = (z, E, $) => {
    ...
    !e && /* @__PURE__ */ u(
      Ke,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(He, { position: "item-aligned", children: /* @__PURE__ */ a(zd, { children: k.map((z) => /* @__PURE__ */ a(Ut, { value: JSON.stringify(z.value), children: z.label }, z.label)) }) })
        ]
      }
    ),
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ u(
                      V,
                      {
                        ...
                        children: [
                          ...
                          !z.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ a(sa, {}) : /* @__PURE__ */ a(ia, {})),
                          " ",
...
}), Jn = (t, e, r) => Ua(t, e).every((o) => r.includes(o));
function Rw({
  section: t,
  availableBookIds: e,
  selectedBookIds: r,
  ...
  const O = L(() => lt.allBookIds.filter(
    ...
    (D, H = !1) => {
      ...
      const [ct, xt] = [
        Math.min(y, F),
        Math.max(y, F)
      ], $t = O.slice(ct, xt + 1).map((dt) => dt);
      r(
        e.includes(D) ? e.filter((dt) => !$t.includes(dt)) : [.../* @__PURE__ */ new Set([...e, ...$t])]
      );
    },
    [e, r, O]
  ), z = (D) => {
    ...
    (D) => {
      const H = Ua(O, D).map((y) => y);
      r(
        Jn(O, D, e) ? e.filter((y) => !H.includes(y)) : [.../* @__PURE__ */ new Set([...e, ...H])]
      );
    },
    [e, r, O]
  ), P = () => {
                  ...
                  Object.values(Y).map((D, H) => {
                    ...
                    if (y.length !== 0)
                      return /* @__PURE__ */ u(jo, { children: [
                        ...
                        H < Object.values(Y).length - 1 && /* @__PURE__ */ a(dn, {})
                      ] }, D);
                  })
                ] })
              ]
...
function ya({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(V, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ds, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ u(jo, { children: [
      /* @__PURE__ */ a(Kn, { children: /* @__PURE__ */ a(It, { children: Qn(e.groups, e.items, c, t) }) }),
...
ai.displayName = Kt.Content.displayName;
function Bp({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ei, { children: [
      /* @__PURE__ */ a(ri, { children: t.map((l) => /* @__PURE__ */ a($w, { value: l.value, children: l.value }, l.key)) }),
  ...
  return n.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(Pt, { children: [
      /* @__PURE__ */ a(Lt, { asChild: !0, children: "command" in d ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(Bw, { children: d.label }),
        /* @__PURE__ */ a(Uw, { children: oi(
          t,
          e,
          Zn(t, d.id),
          o
    ...
    return l.length > 0 && s < n.length - 1 && c.push(/* @__PURE__ */ a(jw, {}, `separator-${i}`)), c;
  });
};
function Kw({
  menuData: t,
  ...
  if (vl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    ...
    return /* @__PURE__ */ a(Ow, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, g]) => typeof w == "boolean" || typeof g == "boolean" ? 0 : w.order - g.order).map(([w, g]) => /* @__PURE__ */ u(Aw, { children: [
      /* @__PURE__ */ a(Pw, { ref: d(w), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ a(
        Lw,
        {
          style: { zIndex: Ye },
          children: /* @__PURE__ */ a(It, { children: oi(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Gp({
  ...
  return /* @__PURE__ */ u("div", { id: c, className: f("pr-twp tw:max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(ft, { className: "tw:font-normal tw:text-muted-foreground", children: oe(d, {
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(be, { children: [
              /* @__PURE__ */ a(xe, { className: f(g && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(V, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ja, {}) }) }),
...
export {
  ...
  Be as Separator,
  Pp as SettingsList,
  Vp as SettingsListHeader,
  Lp as SettingsListItem,
  _w as SettingsSidebar,
  Mp as SettingsSidebarContentSearch,
  fw as Sidebar,
  vw as SidebarContent,
  _p as SidebarFooter,
  zo as SidebarGroup,
  Cp as SidebarGroupAction,
  ...
  Rp as SidebarMenuSubButton,
  Dp as SidebarMenuSubItem,
  ...
  Up as getToolbarOSReservedSpaceClassName,
