...
function $l(t, e = Ol) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = g.getNode(), y = m.getKey(), v = g.offset, T = h.getNode(), C = T.getKey(), k = h.offset, _ = t.getElementByKey(y), I = t.getElementByKey(C), j = r === null || _ !== o || v !== n || y !== r.getKey(), V = i === null || I !== s || k !== c || C !== i.getKey();
  ...
  return Ee(t.registerCommand(Zl, (s) => {
    ...
    if (lc(s.target)) {
      ...
      if (td(c)) return function(d, l = !1) {
        ...
        let h;
        l && Tn(w) ? h = w : (h = wc(), uc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function Hu({
  ...
  const [i, s] = N(Od), [c, d] = N(n), [l, w] = N(!1), p = q(void 0), g = q(null);
  Y(() => {
    let v = !0;
    const T = g.current;
    if (!T) return;
...
function Gd({
  ...
  var j;
  const [w, p] = N([]), [g, h] = N([]), [m, y] = N({}), [v, T] = N({}), C = F(() => e ?? [], [e]), k = Mn({
    data: C,
    columns: t,
    getCoreRowModel: An(),
...
function lp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(_e, { children: [
    ...
    /* @__PURE__ */ a(Ce, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(sn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Re,
        {
          checked: o[w][g],
...
const mi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(As, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Ep({
  ...
  const [s, c] = N(""), [d, l] = N([]), w = F(
    ...
    [t]
  ), C = p.length === 0 && g.length === 0 && h.length === 0, k = be(n, "%resourcePicker_title%"), _ = be(n, "%resourcePicker_search_placeholder%"), I = be(n, "%resourcePicker_language_filter_any%"), j = be(
    n,
    "%resourcePicker_section_already_selected%"
...
function Ew({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), g = ut.useCallback(() => p((k) => !k), [p]), h = w ? "expanded" : "collapsed", v = jt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = ut.useMemo(
    () => ({
      state: h,
      open: w,
      setOpen: p,
...
function jp({
  ...
  const [l, w] = N([]), [p, g] = N([{ id: $e, desc: !1 }]), [h, m] = N({}), y = F(
...
function Up({
  ...
  const po = L(
    ...
    kt !== void 0 && (kt === "range" ? (Oe && (g == null || g(Oe)), Be && (h == null || h(Be))) : kt === "selectedBooks" && i(wr), st(kt), pt(void 0), je(void 0));
  }, [
    kt,
    Oe,
    Be,
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-2 tw:p-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:overflow-hidden", children: [
            ...
            !e && g && l && /* @__PURE__ */ a("div", { className: "tw:invisible tw:group-hover:visible", children: /* @__PURE__ */ u(_e, { children: [
              /* @__PURE__ */ a(Ne, { className: f(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(B, { className: "tw:m-1 tw:h-6 tw:w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ko, {}) }) }),
