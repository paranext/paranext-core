...
import { c as m, g as Te, a as Xr, C as Me, u as zo, T as Vt, b as Lt, d as jt, e as Ft, A as he, P as Be, f as rr, B as J, h as Ue, i as Ke, j as He, k as Re, l as Yi, m as Wi, n as Xi, E as Ji, o as Qa, r as ke, p as Zi, q as yn, s as na, t as ia, L as zt, R as to, v as Jr, D as Oa, w as Ia, x as $a, y as Aa, z as kn, F as Fr, G as eo, H as _n, I as ro, J as Qe, K as Nr, M as qe, N as Ge, O as Ye, S as Cr, Q as cr, U as Qi, V as Sr, W as er, X as Le, Z as ar, Y as Ve, _ as lr, $ as ao, a0 as oo, a1 as Zr, a2 as no, a3 as Nn, a4 as ts, a5 as es, a6 as rs, a7 as Pa, a8 as Cn, a9 as sa, aa as En, ab as as, ac as os, ad as ns, ae as is, af as Tn, ag as Sn, ah as io, ai as ss, aj as zn, ak as fa, al as Ro, am as ma, an as cs, ao as ls, ap as ds, aq as ws, ar as us, as as zr, at as so, au as ps, av as hs } from "./resizable-m_8o3LMR.js";
import { aw as $g, ax as Ag, ay as Pg, az as Vg, aA as Lg, aB as jg, aC as Fg, aD as Bg, aE as Ug, aF as Kg, aG as Hg, aH as qg, aI as Gg, aJ as Yg, aK as Wg, aL as Xg, aM as Jg, aN as Zg, aO as Qg, aP as tf, aQ as ef, aR as rf, aS as af, aT as of } from "./resizable-m_8o3LMR.js";
...
import { Section as gt, getChaptersForBook as Ys, formatScrRef as Se, getSectionForBook as Br, formatRelativeDate as Ws, formatReplacementString as tr, sanitizeHtml as lo, NumberFormat as An, formatBytes as Xs, getCurrentLocale as Js, MODIFIER_KEYS as Zs, usfmMarkers as Ur, isPlatformError as Qs, ABORTED as tc, getErrorMessage as ec, getFormatCallerFunction as rc, deepEqual as ac, isString as Io, compareScrRefs as Fa, scrRefToBBBCCCVVV as va, defaultScrRef as ba, formatScrRefRange as oc, getLocalizeKeyForScrollGroupId as $o, formatReplacementStringToArray as Ao, collectUsjMarkers as nc } from "platform-bible-utils";
import Yt, { useRef as U, useMemo as I, createContext as ca, useContext as wo, useState as N, useEffect as G, useCallback as L, useImperativeHandle as ic, useLayoutEffect as Zt, Component as sc, createElement as Po, Suspense as cc, forwardRef as Pn, useId as Vo, Fragment as la } from "react";
...
import { useReactTable as Zn, getFilteredRowModel as pl, getSortedRowModel as Qn, getPaginationRowModel as hl, getCoreRowModel as ti, flexRender as kr, getGroupedRowModel as gl, getExpandedRowModel as fl } from "@tanstack/react-table";
import ml from "markdown-to-jsx";
import { filterAndRankItems as Ho, GENERATOR_NOTE_CALLER as Ka, HIDDEN_NOTE_CALLER as Ha, getDefaultViewOptions as vl, isInsertEmbedOpOfType as Ar, getMarkerMenuItems as bl, defaultStyleInfo as xl, Editorial as yl } from "@eten-tech-foundation/platform-editor";
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      className: m(
        ...
        {
          "tw:border-s-red-200": i === gt.OT,
          "tw:border-s-purple-200": i === gt.NT,
          "tw:border-s-indigo-200": i === gt.DC,
          "tw:border-s-amber-200": i === gt.Extra
        }
      ),
      children: /* @__PURE__ */ u(
        Me,
...
function Tl({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: b
  } = zo(), [v, z] = N(!1), [k, _] = N(!1), C = U(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), K = n && e !== void 0, T = i ?? (e !== void 0 && !n);
  G(() => {
    var E;
    El();
    const Z = (E = C.current) == null ? void 0 : E.closest('button, [role="combobox"], [tabindex]');
    if (!Z) return;
    const M = (X) => !!X && X.scrollWidth > X.clientWidth, F = () => {
      qa !== "pointer" && (T || M(p.current) || M(l.current)) && _(!0);
    }, O = () => _(!1);
    return Z.addEventListener("focus", F), Z.addEventListener("blur", O), () => {
      Z.removeEventListener("focus", F), Z.removeEventListener("blur", O);
    };
  }, [T, p, l]);
  const j = L(() => {
    T && z(!0), f(), K && w();
  ...
  const R = /* @__PURE__ */ a("span", { ref: p, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), B = K ? (
        ...
        children: [
          /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ u(
            "span",
            {
              ...
              children: [
                Y,
                Y && V && /* @__PURE__ */ a("span", { className: "tw:shrink-0 tw:whitespace-pre", children: r }, "separator"),
                V
              ]
            }
          ) }),
...
function Sl({
  ...
  return /* @__PURE__ */ u(Be, { open: b, onOpenChange: v, children: [
    ...
    /* @__PURE__ */ a(Ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(Re, { heading: i, children: t.map((k) => /* @__PURE__ */ u(
      Me,
      {
        onSelect: () => z(k),
...
function ya({
  ...
  const T = ke(), j = Cl(), $ = K ?? j, [R, B] = N(!1), [Y, V] = N(""), [Z, M] = N(""), [F, O] = N("books"), [E, X] = N(void 0), [tt, mt] = N(
    void 0
  ), [ot, Ot] = N(void 0), [Q, lt] = N(!1), ft = U(null), vt = U(!1), dt = U(void 0), It = U(void 0), pt = U(void 0), ae = U(void 0), te = U({}), Rt = U({}), bt = L(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ), Ct = I(() => o ? o() : Zi, [o]), Nt = I(() => ({
    [gt.OT]: Ct.filter((W) => Pt.isBookOT(W)),
    [gt.NT]: Ct.filter((W) => Pt.isBookNT(W)),
    [gt.DC]: Ct.filter((W) => Pt.isBookDC(W)),
    [gt.Extra]: Ct.filter((W) => Pt.extraBooks().includes(W))
    ...
    return [gt.OT, gt.NT, gt.DC, gt.Extra].forEach((nt) => {
  ...
  const oe = L(() => {
    ...
    (y) => {
      const W = F === "chapters" ? E : D == null ? void 0 : D.book;
      if (W) {
        if (d && d(W, y) > 1) {
          mt(W), Ot(y), O("verses"), V("");
          return;
        }
        bt({
          book: W,
    ...
    O("books"), X(void 0), mt(void 0), Ot(void 0), setTimeout(() => {
      It.current && It.current.focus();
    }, 0);
  }, []), ie = L(() => {
    const y = tt;
    mt(void 0), Ot(void 0), y ? (X(y), O("chapters"), V("")) : yt();
  }, [tt, yt]), Tt = L((y) => {
    B(y), y && (O("books"), X(void 0), mt(void 0), Ot(void 0), M(""));
  }, []);
  G(() => {
    C && Tt(!1);
  }, [C, Tt]);
  ...
  const { otLong: me, ntLong: S, dcLong: H, extraLong: rt } = {
    ...
    [t.book, n, $]
  ), it = `${t.chapterNum}:${t.verseNum}`, ct = L((y) => (W) => {
    te.current[y] = W;
  }, []), wt = L((y) => (W) => {
    Rt.current[y] = W;
  }, []), kt = I(
    () => Dl(Z),
    [Z]
  ), Et = I(() => !d || !D || !D.chapterNum || !kt ? !1 : d(D.book, D.chapterNum) > 0, [d, D, kt]), Ut = L(
    (y) => w ? Go(y, w) : !1,
    [w]
  ), Oe = L(
    (y) => (W) => w ? Ml(y, W, w) : !1,
    ...
    [w]
  ), Ie = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Mr = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Eo = L(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), h && h.includes(y.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), oe());
    },
    [h, D, oe]
  ), ga = L(
    (y) => {
      ...
      if ((F === "chapters" || F === "verses") && (y.key === " " || y.key === "Enter")) {
        ...
        const Kt = ($e = dt.current) == null ? void 0 : $e.querySelector(
      ...
      if ((F === "chapters" || F === "verses") && (W || nt)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (F === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), yt();
        return;
      }
      if (F === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), ie();
        return;
      }
      ...
      if (F === "verses" && Dt) {
        ...
        switch (y.key) {
          case "ArrowLeft":
            _t !== 0 && (ce = _t > 1 ? _t - 1 : Kt);
            break;
          case "ArrowRight":
            _t !== 0 && (ce = _t < Kt ? _t + 1 : 1);
            break;
          case "ArrowUp":
            ce = _t === 0 ? Kt : Math.max(1, _t - ue);
            break;
          case "ArrowDown":
            ce = _t === 0 ? 1 : Math.min(Kt, _t + ue);
            break;
          default:
            return;
        }
        ce !== _t && (y.preventDefault(), y.stopPropagation(), V(
          `${Mt} ${he[Mt] || ""} ${St}:${ce}`
        ), setTimeout(() => {
          const Ae = Rt.current[ce];
          Ae && Ae.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((F === "chapters" || F === "books" && D) && Dt) {
        const Mt = F === "chapters" ? E : D == null ? void 0 : D.book;
        if (!Mt) return;
        F === "chapters" && ((nr = dt.current) == null || nr.focus());
        const St = (() => {
          if (!Y) return 1;
          const ue = Y.match(/(\d+)$/);
        ...
        switch (y.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            _t = St === 0 ? Kt : Math.max(1, St - ce);
            break;
          case "ArrowDown":
            _t = St === 0 ? 1 : Math.min(Kt, St + ce);
            break;
          default:
            return;
        }
        _t !== St && (y.preventDefault(), y.stopPropagation(), V(
          `${Mt} ${he[Mt] || ""} ${_t}`
        ), setTimeout(() => {
          const ue = te.current[_t];
    ...
    const { isLetter: W, isDigit: nt } = Yo(y.key);
    (W || nt) && (y.preventDefault(), M(($e) => $e + y.key), It.current.focus(), lt(!1));
  }, []);
  return Zt(() => {
    const y = setTimeout(() => {
      if (R && F === "books" && pt.current && ae.current) {
        const W = pt.current, nt = ae.current, Dt = nt.offsetTop, $e = W.clientHeight, Ee = nt.clientHeight, nr = Dt - $e / 2 + Ee / 2;
        W.scrollTo({
          top: Math.max(0, nr),
          behavior: "smooth"
        }), V(ri(t.book));
    ...
    if (F === "chapters" && E) {
      const y = E === t.book, W = y ? t.chapterNum : 1;
      V(
        `${E} ${he[E] || ""} ${W}`
      ), setTimeout(() => {
        if (pt.current)
  ...
  }, [F, E, D, t.book, t.chapterNum]), Zt(() => {
    if (F === "verses" && tt && ot !== void 0) {
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Be, { open: R, onOpenChange: Tt, modal: z, children: [
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: W } = y;
          R && ft.current && W instanceof Node && ft.current.contains(W) && (vt.current = !0, Tt(!1));
        },
        onCloseAutoFocus: v,
        children: /* @__PURE__ */ u(
          Ke,
          {
            ...
            shouldFilter: !1,
            children: [
              F === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  J,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: F === "verses" ? ie : yt,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(fs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                F === "chapters" && E && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Te(E, n) }),
                F === "verses" && tt && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Te(tt, n)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: F === "verses" ? Mr : Ie
                  }
                )
              ] }),
              !Q && /* @__PURE__ */ u(He, { ref: pt, children: [
                F === "books" && /* @__PURE__ */ u(ut, { children: [
                  ...
                  D && Et && D.chapterNum && d && /* @__PURE__ */ u(ut, { children: [
                    ...
                    /* @__PURE__ */ a(
                      Xo,
                      {
                        ...
                        onVerseSelect: ne,
                        setVerseRef: wt,
                        isVerseDisabled: se(D.book, D.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  D && !Et && dr(D.book) > 1 && /* @__PURE__ */ u(ut, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                ...
                F === "chapters" && E && /* @__PURE__ */ a(
                  Wo,
                  {
                    ...
                    onChapterSelect: ee,
                    setChapterRef: ct,
                    isChapterDisabled: Oe(E),
                    className: "tw:p-4"
                  }
                ),
                F === "verses" && tt && ot !== void 0 && d && /* @__PURE__ */ a(
                  Xo,
                  {
                    bookId: tt,
                    chapterNum: ot,
...
function Jo({
  ...
  const [_, C] = N(!1), K = d ?? l, T = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], j = ($, R) => {
    const B = l($), Y = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, V = `${R ?? ""}${B}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Me,
      {
        value: B,
  ...
  return /* @__PURE__ */ u(Be, { open: _, onOpenChange: C, ...k, children: [
    /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ u(
      J,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        children: /* @__PURE__ */ u(Ke, { children: [
          ...
          /* @__PURE__ */ a(He, { children: T(e) ? e.map(($) => /* @__PURE__ */ a(Re, { heading: $.groupHeading, children: $.options.map((R) => j(R, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(Re, { children: e.map(($) => j($)) }) })
        ] })
      }
    )
  ] });
...
function Tp({
  ...
  const w = ka(d, "%webView_bookSelector_currentBook%"), h = ka(d, "%webView_bookSelector_choose%"), p = ka(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), b = (v) => {
    f(v), t(v);
    ...
    to,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(zt, { className: "tw:flex tw:items-center", children: o.map((v) => Pt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            J,
            {
...
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = ni ? Zt : G, Vr = { tag: uo };
function Vl({ initialConfig: t, children: e }) {
  const r = I(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Al(null, o), w = jn({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (h) => s(h, w), theme: o });
    return function(h, p) {
      if (p !== null) {
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
...
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
function ql(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Gl() {
  return function(t) {
    const [e] = Ne(), r = I(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = U(o);
    return Hl(() => {
...
function Jl(t, e, r) {
  ...
  function l() {
    ...
    const { left: h, top: p } = n.getBoundingClientRect(), g = Yl(t, e);
    var f, b;
    c.isConnected || (b = c, (f = n).insertBefore(b, f.firstChild));
    let v = !1;
    for (let z = 0; z < g.length; z++) {
      const k = g[z], _ = s[z] || document.createElement("div"), C = _.style;
      C.position !== "absolute" && (C.position = "absolute", v = !0);
      const K = be(k.left - h);
      C.left !== K && (C.left = K, v = !0);
      const T = be(k.top - p);
      C.top !== T && (_.style.top = T, v = !0);
      const j = be(k.width);
      C.width !== j && (_.style.width = j, v = !0);
      const $ = be(k.height);
      C.height !== $ && (_.style.height = $, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[z] = _;
    }
...
function Ql(t, e = Zl) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(h), f = p.getNode(), b = f.getKey(), v = p.offset, z = g.getNode(), k = z.getKey(), _ = g.offset, C = t.getElementByKey(b), K = t.getElementByKey(k), T = r === null || C !== o || v !== n || b !== r.getKey(), j = i === null || K !== s || _ !== c || k !== i.getKey();
      if ((T || j) && C !== null && K !== null) {
        const $ = function(R, B, Y, V, Z, M, F) {
          const O = (R._window ? R._window.document : document).createRange();
          return O.setStart(...Zo(B, Y, V)), O.setEnd(...Zo(Z, M, F)), O;
        }(t, p, f, C, g, z, K);
        l(), l = Jl(t, $, e);
      }
      r = f, o = C, n = v, i = z, s = K, c = _;
    });
  }
...
function rd(t) {
  const e = Qt() || bc();
  let r;
  if (xe(e)) r = xc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Un(c, "next"));
    }
    r = r || yc(Fe(), "previous").getFlipped().insert(Rr());
  }
...
function ad(t, e, r) {
  ...
  return Sc(o) && Qr(283), o.insert(t.isInline() ? Rr().append(t) : t), Lo(Un(t.getLatest(), "next"), e.direction);
}
function od(t) {
  const e = Qt();
  if (!xe(e)) return !1;
...
let ta, ze = 0, ea = 0, sd = 0, Ya = 0, qr = 0;
function tn(t) {
  if (st === void 0) return;
  let e = t.n;
...
de({ build: (t, e, r) => vr(e), config: or({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
de({ build: (t, e, r) => vr(e), config: or({ $onClear: di }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
de({ name: "@lexical/extension/DecoratorText", nodes: () => [ui], register: (t, e, r) => t.registerCommand(qn, (o) => {
  const n = Qt();
  if (Gn(n) || xe(n)) for (const i of n.getNodes()) wd(i) && i.toggleFormat(o);
  return !1;
}, Yn) });
function pi(t, e) {
  let r;
...
const Wa = de({ build: (t) => pi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
function ud(t) {
  return function(e) {
    return e.id === Xa;
  }(t) || ht(305, String(t.id), String(Xa)), Object.assign(t, { id: gi });
}
...
class hd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Lr && ht(307, String(r.id), String(ir)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ea && ht(310, String(r.id), String(Ea)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Lr;
    }(e) || ht(313, String(e.id), String(Lr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ca;
    }(e) || ht(314, String(e.id), String(Ca)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= xr;
    }(e) || ht(316, String(e.id), String(xr)), e;
  }
...
const fd = de({ config: or({ setOptions: rn, updateOptions: rn }), init: ({ $initialEditorState: t = gd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class wr {
  ...
  static maybeFromEditor(e) {
    const r = e[an];
    return r && (r.PACKAGE_VERSION !== Sa && ht(292, r.PACKAGE_VERSION, Sa), r instanceof wr || ht(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Ta(i) || ht(300, s, n || "[unknown]"), Ta(c = i) || ht(304, String(c.id), String(xo)), i = Object.assign(c, { id: Xa }), o.state = i;
...
const vd = /* @__PURE__ */ new Set(), nn = de({ build(t, e, r) {
  const o = r.getDependency(Wa).output, n = Tr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = pi(() => {
    ...
    o.value.read(() => {
      if (Qt()) for (const [w, h] of c.entries()) {
        ...
        const p = Yc(w), g = p && p.isSelected() || !1;
...
de({ dependencies: [Wa, nn], name: "@lexical/extension/HorizontalRule", nodes: () => [pr], register(t, e, r) {
  ...
  return De(t.registerCommand(bd, (s) => {
    ...
    if (Lc(s.target)) {
      ...
      if (yd(c)) return function(l, d = !1) {
        ...
        let g;
        d && Gn(w) ? g = w : (g = Fc(), Bc(g)), h ? g.delete(p) : g.add(p);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
de({ build: (t, e) => vr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: or({ $getParentEditor: function() {
  const t = Uc();
...
de({ build: (t, e, r) => vr(e), config: or({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return ye(() => {
...
function kd(t, e, r = mi) {
  return De(t.registerCommand(Xc, (o) => {
    ...
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((p) => Jc(p) && p.canIndent()).length > 0) return !0;
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), h = ed(w);
      if (h.canIndent()) {
        const p = h.getKey();
        let g = Zc();
        if (g.anchor.set(p, 0, "element"), g.focus.set(p, 0, "element"), g = Qc(g), g.anchor.is(d)) return !0;
      }
      return !1;
...
de({ build: (t, e, r) => vr(e), config: or({ $canIndent: mi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return ye(() => {
    if (!o.value) return kd(t, n, i);
  });
} });
const _d = de({ name: "@lexical/react/ReactProvider" });
function Nd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (xe(f)) {
                const b = f.anchor;
                let v = b.getNode(), z = 0, k = 0;
                if (Ua(v) && d >= 0 && w >= 0 && (z = d, k = d + w, f.setTextNodeRange(v, z, v, k)), z === k && h === "" || (f.insertRawText(h), v = b.getNode()), Ua(v)) {
                  z = p, k = p + g;
                  const _ = v.getTextContentSize();
                  z = z > _ ? _ : z, k = k > _ ? _ : k, f.setTextNodeRange(v, z, v, k);
                }
...
de({ build: (t, e, r) => vr(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ye(() => r.getOutput().disabled.value ? void 0 : bi(t)) });
function Td(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return ko(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (p) => r._onError(p), children: a(cc, { fallback: null, children: n[d] }) }), h = r.getElementByKey(d);
        h !== null && s.push(ll(w, h, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
...
function Rd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    ko(() => De(sl(n), bi(n)), [n]);
  }(o), u(ut, { children: [t, a(Dd, { content: e }), a(zd, { editor: o, ErrorBoundary: r })] });
}
...
const Od = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : G;
...
function Vd(t, e) {
  ...
  return u(ut, { children: [a(Ad, { editor: n, ...o, ref: e }), r != null && a(Ld, { editor: n, content: r })] });
}
...
function Ud({
  ...
  const [e] = Ne(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Bd(), l = () => {
  };
...
function Hd() {
  const { activeEditor: t } = ki(), [e, r] = N([]), o = L((n) => {
    if (xe(n) || dl(n)) {
      const i = [];
      ln.forEach(({ format: s }) => {
...
function zp({
  ...
  const [i, s] = N(Jd), [c, l] = N(n), [d, w] = N(!1), h = U(void 0), p = U(null);
  G(() => {
    let v = !0;
    const z = p.current;
    if (!z) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Be, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ue,
        {
          ...
          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: t.map((v) => /* @__PURE__ */ a(
            Me,
            {
              onSelect: () => {
                l(v || void 0), w(!1);
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : No(v) && (v.preventDefault(), v.stopPropagation(), le(i) && g());
        },
        onKeyDown: (v) => {
...
function wn({
  ...
  const g = L(
    (T) => {
      T && T.stopPropagation(), d(!1), h(void 0), s == null || s(!1);
    },
    [s]
  ), f = L(
    async (T) => {
  ...
  }, [t.date, r]), v = I(() => t.user, [t.user]), z = I(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = I(() => lo(t.contents), [t.contents]), _ = I(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), C = !!t.conflictResolutionAction && !_, K = I(() => {
    if (o && c)
      return /* @__PURE__ */ u(ut, { children: [
        /* @__PURE__ */ u(
          Qe,
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), h(Wd(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: p,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : No(T) && (T.preventDefault(), T.stopPropagation(), le(w) && f());
              },
              onKeyDown: (T) => {
...
function Di({
  ...
  const [V, Z] = N(un), [M, F] = N(), [O, E] = N(), X = o, [tt, mt] = N(!1), [ot, Ot] = N(!1), [Q, lt] = N(!1), [ft, vt] = N(!1), [dt, It] = N(!1), [pt, ae] = N(C), [te, Rt] = N(!1), bt = U(void 0), [Ct, Nt] = N(/* @__PURE__ */ new Map());
  G(() => {
    let x = !0;
    return (async () => {
      const q = k ? await k(l) : !1;
      x && It(q);
    })(), () => {
      x = !1;
    };
    ...
    let x = !0;
    if (!o) {
      vt(!1), Nt(/* @__PURE__ */ new Map());
      return;
    }
    return (async () => {
      const q = z ? await z(l) : !1;
      x && vt(q);
    })(), () => {
      x = !1;
    };
  ...
  G(() => {
    if (!o) {
      xt.current !== "idle" && (F(void 0), E(void 0), xt.current = "idle");
      return;
    }
    ...
    j !== i && (F(j), xt.current = "auto-populated") : xt.current === "auto-populated" && (F(void 0), xt.current = "pending");
  }, [o, j, ft, i]);
  const $t = I(
  ...
  const D = I(() => $t[0], [$t]), Ce = U(null), oe = U(void 0), ne = L(() => {
    var x;
    (x = oe.current) == null || x.call(oe), Z(un);
  }, []), Xe = L(() => {
    const x = !pt;
    ae(x), Rt(!x), f == null || f(l, x);
  }, [pt, f, l]);
  G(() => {
    mt(!1);
  }, [o]), G(() => {
  ...
  }, [i, r]), Xt = I(() => $t.slice(1), [$t]), yt = I(() => Xt.length ?? 0, [Xt.length]), ie = I(() => yt > 0, [yt]), Tt = I(() => tt || yt <= 2 ? Xt : Xt.slice(-2), [Xt, yt, tt]), Ht = I(() => tt || yt <= 2 ? 0 : yt - 2, [yt, tt]), fe = I(
  ...
  const S = L(
    async (x) => {
      ...
      A && await h({ threadId: l, contents: A }) && ne();
    },
    [
      ne,
      V,
    ...
    async (x) => {
      const A = le(V) ? aa(V) : void 0, q = x.status ? x.assignedUser : M ?? x.assignedUser, et = await h({
        ...x,
        contents: A,
        assignedUser: q
      });
      return et && (q !== void 0 && E(q), A && ne()), et;
    },
    [ne, V, h, M]
  );
      ...
      children: /* @__PURE__ */ u(tw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            we && /* @__PURE__ */ a(Nr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: we }),
            /* @__PURE__ */ a(
              J,
              {
                variant: "ghost",
        ...
        /* @__PURE__ */ u(ut, { children: [
          ie && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(ut, { children: [
            ...
            Ht > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                onClick: (x) => {
                  x.stopPropagation(), mt(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (x) => {
                  (x.key === "Enter" || x.key === " ") && (x.preventDefault(), x.stopPropagation(), mt(!0));
                },
                children: [
                  /* @__PURE__ */ a("div", { className: "tw:w-8", children: /* @__PURE__ */ a(Cr, {}) }),
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            v !== !1 && (!ot || le(V)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  No(x) && (x.preventDefault(), x.stopPropagation(), (le(V) || M !== void 0 && M !== O) && S());
                },
                onKeyDown: (x) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    M !== void 0 && (le(V) || M !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: tr(
                    ...
                    /* @__PURE__ */ u(Be, { open: Q, onOpenChange: lt, children: [
                      /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ a(
                        J,
                        {
                          size: "icon",
                      ...
                      /* @__PURE__ */ a(
                        Ue,
                        {
                          ...
                          align: "end",
                          onKeyDown: (x) => {
                            x.key === "Escape" && (x.stopPropagation(), lt(!1));
                          },
                          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: b == null ? void 0 : b.map((x) => /* @__PURE__ */ a(
                            Me,
                            {
                              onSelect: () => {
                                F(x !== i ? x : void 0), xt.current = "user-selected", E(void 0), lt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function nw({
  ...
  const [s, c] = N("accept"), l = Vo(), d = Vo(), w = r === "loading", h = r === "accept", p = r === "none", g = r === "acceptRejectOrMerge", f = h ? "accept" : s, b = I(
    () => Yr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = I(
    () => Yr(t.acceptedText ?? ""),
    ...
    () => Yr(t.mergedText ?? ""),
    [t.mergedText]
  ), k = I(() => lo(t.contents), [t.contents]);
  if (!Si(t))
    return /* @__PURE__ */ a(Wr, { html: k });
  const _ = (O) => {
    c(O === "reject" || O === "merge" ? O : "accept");
  }, C = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", K = g ? [
    {
      value: "merge",
  ...
  const B = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: B }), V = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : Y, Z = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Wr, { html: z }) : Y : V(O === "reject" ? t.rejectedResultText : t.resultText);
  }, M = (O) => h && O.value === "reject", F = (O) => {
    const E = f === O.value, X = `${d}-${O.value}`, tt = M(O);
    return (
      ...
      !w && !p && /* @__PURE__ */ u(ut, { children: [
        ...
        /* @__PURE__ */ a(
          to,
          {
            ...
            children: T.map((O) => M(O) ? /* @__PURE__ */ a(Vt, { delayDuration: 0, children: /* @__PURE__ */ u(Lt, { children: [
              /* @__PURE__ */ a(jt, { asChild: !0, children: F(O) }),
              /* @__PURE__ */ a(Ft, { children: C })
            ] }) }, O.value) : F(O))
          }
        ),
...
function dw(t) {
  ...
  } = t, c = I(() => e.filter((z) => !z.deleted), [e]), l = I(
    () => c.find((z) => z.conflictType) ?? c[0],
    [c]
  ), { conflictOptions: d, isResolving: w, resolve: h, resolvedResolution: p, showResolveCheck: g } = lw({
    threadId: n,
    threadStatus: i,
    isSelected: o,
    activeComments: c,
...
function Vp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [C, K] = N(), [T, j] = N(), $ = L(
    async (E) => {
      const X = await i(E);
      return X !== void 0 && E.assignedUser !== void 0 && E.assignedUser !== "" && j(E.assignedUser), X;
    },
    [i]
  );
  G(() => {
    f && (_((E) => new Set(E).add(f)), K(f));
  }, [f]);
  const R = r.filter(
    (E) => E.comments.some((X) => !X.deleted)
  ), B = R.map((E) => ({ id: E.id })), Y = L(
    (E) => {
      _((X) => new Set(X).add(E.id)), K(E.id), b == null || b(E.id);
    },
    [b]
  ), V = L(
    (E) => {
      ...
      _((tt) => {
        const mt = new Set(tt);
        return mt.has(E) ? mt.delete(E) : mt.add(E), mt;
      }), K(E), b == null || b(X ? void 0 : E);
    },
    [k, b]
  ), { listboxRef: Z, activeId: M, handleKeyDown: F } = Qi({
    options: B,
    onOptionSelect: Y
  }), O = L(
    (E) => {
      E.key === "Escape" ? (C && k.has(C) && (_((X) => {
        const tt = new Set(X);
        return tt.delete(C), tt;
      }), K(void 0), b == null || b(void 0)), E.preventDefault(), E.stopPropagation()) : F(E);
    },
    [C, k, F, b]
  );
  return /* @__PURE__ */ a(
      ...
      children: R.map((E) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: E.type === "Conflict" ? /* @__PURE__ */ a(dw, { ...X, conflictResolution: z }) : /* @__PURE__ */ a(Di, { ...X })
          },
          E.id
        );
      })
...
function fw({
  ...
  var T;
  const [w, h] = N([]), [p, g] = N([]), [f, b] = N({}), [v, z] = N({}), k = I(() => e ?? [], [e]), _ = Zn({
    data: k,
    columns: t,
    getCoreRowModel: ti(),
  ...
  let K;
  return l ? K = Array.from({ length: 10 }).map((R, B) => `skeleton-row-${B}`).map((R) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, R)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? K = _.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(j, _),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map(($) => /* @__PURE__ */ a(lr, { children: kr($.column.columnDef.cell, $.getContext()) }, $.id))
    },
    j.id
  )) : K = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(lr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(ww, { table: _ }),
    /* @__PURE__ */ u(ao, { stickyHeader: i, children: [
      /* @__PURE__ */ a(oo, { stickyHeader: i, children: _.getHeaderGroups().map((j) => /* @__PURE__ */ a(Ve, { children: j.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : kr($.column.columnDef.header, $.getContext()) }, $.id)) }, j.id)) }),
      /* @__PURE__ */ a(no, { children: K })
    ] }),
...
function Kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(qe, { children: [
    ...
    /* @__PURE__ */ a(Ye, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(Nn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ut, { children: d.items.map((h, p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Le,
        {
          checked: o[w][p],
...
function Cw(t, e, r) {
  ...
  const { kind: o } = e;
  if (o === "enter")
    return t.key === "Enter" ? (re(t), r.commit(), "ended") : t.key === "Escape" ? (re(t), r.dismiss(), "ended") : "passed";
  ...
  if (t.key === "ArrowDown" || t.key === "ArrowUp")
    return re(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue";
  ...
  if (t.key === "Escape")
    return re(t), r.dismiss(), "ended";
  if (t.key === " ") {
    if (o === "backslash")
      return re(t), (i = e.shouldSpaceCommit) != null && i.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    re(t);
    const s = e.filter.toLowerCase(), c = e.items.find((l) => l.marker.toLowerCase() === s);
    return c && r.commitItem(c.marker), r.dismiss(), "ended";
  }
  return t.key === "*" ? o === "selection" && e.filter === "" ? (re(t), r.dismiss(), "ended") : (re(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (r.dismiss(), "ended") : (re(t), r.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (re(t), r.dismiss(), "ended") : t.key === "Backspace" || Oi[o].test(t.key) ? (re(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (o === "selection" && re(t), r.dismiss(), "ended");
}
function Ra(t, e) {
  var r;
...
const zw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(ut, { children: [
...
function Rw({
  ...
  const i = U(null), s = U(null), c = U(!1), [l, d] = N(t), [w, h] = N(r), [p, g] = N(!1), f = U(l);
  f.current = l;
  const b = U(w);
  b.current = w, G(() => {
    d(t);
  ...
  const v = (k) => {
    if (c.current = !1, g(k), !k) {
      const _ = f.current, C = b.current;
      _ !== "custom" || C ? (_ !== t && e(_), C !== r && o(C)) : (d(t), h(r));
    }
  }, z = (k) => {
    var _, C, K, T;
    k.stopPropagation(), document.activeElement === s.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((_ = i.current) == null || _.focus(), c.current = !0) : document.activeElement === i.current && k.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), c.current = !1) : document.activeElement === i.current && k.key === "ArrowLeft" && ((K = i.current) == null ? void 0 : K.selectionStart) === 0 && ((T = s.current) == null || T.focus(), c.current = !1), l === "custom" && k.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && v(!1);
  };
  return /* @__PURE__ */ u(qe, { open: p, onOpenChange: v, children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: zw(t, n, r) }) }) }),
...
const Dw = (t, e) => t === "f" ? /* @__PURE__ */ u(ut, { children: [
  /* @__PURE__ */ a(In, {}),
  " ",
...
function Ow({
  ...
  return /* @__PURE__ */ u(qe, { children: [
    /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
      /* @__PURE__ */ a(jt, { asChild: !0, children: /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "outline", className: "tw:h-6", children: Dw(t, r) }) }) }),
      /* @__PURE__ */ a(Ft, { children: /* @__PURE__ */ a("p", { children: Mw(t, r) }) })
    ] }) }),
...
function Yp({
  ...
  const [v, z] = N("generated"), [k, _] = N("generated"), [C, K] = N("*"), [T, j] = N("*"), [$, R] = N("f"), [B, Y] = N(!1), [V, Z] = N(!0), [M, F] = N(!1), O = U(!1), E = U(""), [X, tt] = N(!1), [mt, ot] = N(), [Ot, Q] = N(), [lt, ft] = N(), [vt, dt] = N(), It = U(null), pt = U(void 0), ae = U(0), te = U(void 0), Rt = I(
    () => ({
      ...s,
  ...
  G(() => {
    var S;
    X || (S = p.current) == null || S.focus();
  }, [$, X]);
  const Ct = L(() => {
    var x, A, q;
    const S = (x = g.current) == null ? void 0 : x.querySelector(".editor-input"), H = S == null ? void 0 : S.querySelector("span.note"), rt = (q = (A = g.current) == null ? void 0 : A.ownerDocument.getSelection()) == null ? void 0 : q.anchorNode;
    return !!H && !!rt && H.contains(rt);
  }, []);
  G(() => {
    var A, q;
    let S, H, rt;
    ...
    if (x && Ar("note", x)) {
      const et = (A = x.insert.note) == null ? void 0 : A.caller;
      let it = "custom";
      et === Ka ? it = "generated" : et === Ha ? it = "hidden" : et && (K(et), j(et)), z(it), _(it), R(((q = x.insert.note) == null ? void 0 : q.style) ?? "f"), S = setTimeout(() => {
        var ct, wt, kt;
        (ct = p.current) == null || ct.applyUpdate([x]), (wt = p.current) == null || wt.selectNote(0), (kt = p.current) == null || kt.focus(), H = requestAnimationFrame(() => {
          rt = setTimeout(() => {
            var Et, Ut;
    ...
    return () => {
      S && clearTimeout(S), H !== void 0 && cancelAnimationFrame(H), rt !== void 0 && clearTimeout(rt);
    };
  }, [e, i, Ct]);
  const Nt = L(
    (S, H, rt = !1, x = !1) => {
      var q, et, it, ct;
      h == null || h();
      const A = (et = (q = p.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : et.at(0);
      if (A && Ar("note", A)) {
        if (A.insert.note) {
          let wt;
          S === "custom" ? wt = H : S === "generated" ? wt = Ka : wt = Ha, A.insert.note.caller = wt, x && ((it = p.current) == null || it.applyUpdate([A, { delete: 1 }]));
        }
        r == null || r([A]), rt && d && i && ((ct = d.current) == null || ct.replaceEmbedUpdate(i, [A]));
      }
    },
    [i, r, h, d]
  ), xt = L(() => {
    var S;
    pt.current || (S = p.current) == null || S.commitPendingMarkerEdits(), Nt(v, C, !0), o();
  }, [v, C, o, Nt]), $t = U(xt);
  Zt(() => {
    $t.current = xt;
  });
  ...
  const Ce = () => {
    ...
    var rt, x, A, q, et;
    R(S);
    const H = (x = (rt = p.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : x.at(0);
    if (H && Ar("note", H)) {
      H.insert.note && (H.insert.note.style = S);
      const it = (q = (A = H.insert.note) == null ? void 0 : A.contents) == null ? void 0 : q.ops;
      $ !== "x" && S === "x" ? it == null || it.forEach((ct) => jw(ct)) : $ === "x" && S !== "x" && (it == null || it.forEach((ct) => Fw(ct))), (et = p.current) == null || et.applyUpdate([H, { delete: 1 }]);
    }
  }, ee = (S) => {
    dt(S.contextMarker), F(S.canRedo);
  }, we = L(
    (S) => {
      var rt, x, A, q, et;
      const H = (x = (rt = p.current) == null ? void 0 : rt.getNoteOps(0)) == null ? void 0 : x.at(0);
      if (H && Ar("note", H)) {
        S.content.length > 1 && setTimeout(() => {
          var wt;
          (wt = p.current) == null || wt.applyUpdate([{ retain: 2 }, { delete: 1 }]);
        }, 0);
        const it = (A = H.insert.note) == null ? void 0 : A.style, ct = (et = (q = H.insert.note) == null ? void 0 : q.contents) == null ? void 0 : et.ops;
        if (it || Y(!1), Y(
          it === "x" ? !!(ct != null && ct.every((wt) => {
            var Et, Ut;
            if (!((Et = wt.attributes) != null && Et.char)) return !0;
            const kt = ((Ut = wt.attributes) == null ? void 0 : Ut.char).style;
          ...
          O.current = !0, E.current = JSON.stringify(H), Z(!0);
          return;
        }
        Z(JSON.stringify(H) === E.current), Nt(v, C);
      } else
        Y(!1), Z(!0);
    },
    [v, C, Nt]
    ...
    if (f.current && bt.length && S && S.rangeCount > 0) {
      const H = S.getRangeAt(0).getBoundingClientRect(), rt = f.current.getBoundingClientRect();
      ot(H.left - rt.left), Q(H.top - rt.top), ft(H.height), tt(!0);
    }
  }, [bt, f]), yt = U(() => {
  }), ie = L(
    (S, H, rt) => {
      ...
      pt.current = {
        ...
        keys: Nw(A ? "backslash" : "selection"),
        onKey: (et) => yt.current(et)
      }).then((et) => {
        var it, ct, wt, kt, Et, Ut;
        if (Ra(pt, q), et !== void 0) {
          if (!((it = p.current) != null && it.getSelection())) {
            const se = te.current;
            se ? (ct = p.current) == null || ct.setSelection(se) : (wt = p.current) == null || wt.selectNote(0);
          }
          (kt = p.current) == null || kt.focus();
          const Oe = H.find((se) => se.marker === et);
        ...
        } else A || (Ut = p.current) == null || Ut.focus();
      }).catch((et) => {
        var it;
        Ra(pt, q), A || (it = p.current) == null || it.focus(), (!Qs(et) || et.code !== tc) && console.warn(
          `FootnoteEditor: the marker palette did not open: ${ec(et)}`
        );
      });
    },
    [w]
    ...
    var rt;
    const S = (rt = p.current) == null ? void 0 : rt.getMarkerMenuContext();
    if (!S) return !1;
    const H = bl(Rt.styleInfo ?? xl, S);
    return H.length === 0 ? !1 : (ie(S, H, { passive: !S.hasTextSelection }), !0);
  }, [ie, Rt.styleInfo]), Ht = L(
    (S) => {
      const H = pt.current;
      if (!H || !w) return;
      Cw(S, H, {
        ...
        commitTyped: (x) => {
          var A;
          return (A = p.current) == null ? void 0 : A.commitTypedMarker(x);
        },
        commitTypedAndReopen: (x) => {
          var A;
          (A = p.current) == null || A.commitTypedMarker(x, { trailingSpace: !1 }), Tt();
        },
        commitTypedCloser: (x) => {
          var A;
          return (A = p.current) == null ? void 0 : A.commitTypedCloser(x);
        },
        commitItem: (x) => {
          var q;
          const A = H.items.find((et) => et.marker === x);
          A && ((q = p.current) == null || q.applyMarkerMenuSelection(A, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  G(() => {
    ...
    const S = (H) => {
      var A, q;
      const rt = (A = g.current) == null ? void 0 : A.querySelector(".editor-input");
      if (!rt || H.target !== rt) return;
      const x = (q = p.current) == null ? void 0 : q.getSelection();
      x && (te.current = x);
    };
    ...
    if (((rt = Rt.view) == null ? void 0 : rt.markerMode) === "editable") {
      const x = (q) => {
        var ct, wt, kt, Et;
        if (Mi(q)) return;
        const et = S();
        ...
        if (q.key === "Enter" && !Ct()) {
          q.preventDefault(), q.stopPropagation(), (ct = p.current) == null || ct.selectNote(0), (wt = p.current) == null || wt.focus();
          return;
        }
        if (w && q.key === c) {
          if (!Ct()) {
            q.preventDefault(), q.stopPropagation(), (kt = p.current) == null || kt.selectNote(0), (Et = p.current) == null || Et.focus();
            return;
          }
          Tt() && (q.preventDefault(), q.stopPropagation());
        }
      }, A = () => {
        var et, it;
        const q = S();
        !q || document.activeElement !== q || Ct() || ((et = p.current) == null || et.selectNote(0), (it = p.current) == null || it.focus());
      };
      return document.addEventListener("keydown", x, { capture: !0 }), document.addEventListener("paste", A, { capture: !0 }), () => {
        document.removeEventListener("keydown", x, { capture: !0 }), document.removeEventListener("paste", A, { capture: !0 });
      };
    }
    const H = (x) => {
      const A = S();
      !X && A && document.activeElement === A && x.key === c ? (x.preventDefault(), Xt()) : X && x.key === "Escape" && (x.preventDefault(), tt(!1));
    };
    ...
    const S = () => {
      var x, A, q;
      const H = ((x = g.current) == null ? void 0 : x.querySelector(".editor-input")) ?? void 0;
      if (!H || document.activeElement !== H) return;
      const rt = document.getSelection();
      rt && !rt.isCollapsed || Ct() || ((A = p.current) == null || A.selectNote(0), (q = p.current) == null || q.focus());
    };
        ...
        /* @__PURE__ */ a("div", { className: "tw:flex tw:w-full tw:justify-end", children: /* @__PURE__ */ u(eo, { children: [
          /* @__PURE__ */ a(
            Tw,
            {
              onUndoClick: () => {
                var S;
                return (S = p.current) == null ? void 0 : S.undo();
              },
              onRedoClick: () => {
                var S;
                return (S = p.current) == null ? void 0 : S.redo();
              },
              canUndo: !V,
              canRedo: M,
              localizedStrings: l
...
function Hw({
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    n,
    " "
  ] }), h = s && /* @__PURE__ */ u(ut, { children: [
    Co(t.marker, [s], o, !1),
    " "
  ] }), p = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", f = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", b = m(p, g);
  return /* @__PURE__ */ u(ut, { children: [
    /* @__PURE__ */ u("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", b), children: [
      l,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", b), children: h }),
    /* @__PURE__ */ a(
      "div",
      {
        className: m(
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ut, { children: Uw(t.marker, c, o, d) })
      }
    )
  ] });
}
function Xp({
  ...
  const w = l ?? rc(r, void 0), h = (_, C) => {
    d == null || d(_, C, n);
  }, p = i ? r.findIndex((_) => _ === i) : -1, [g, f] = N(p), b = (_, C, K) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), d == null || d(C, K, n);
          break;
      }
  }, v = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), f((C) => Math.min(C + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), f((C) => Math.max(C - 1, 0));
          break;
      }
  }, z = U([]);
  G(() => {
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Hw,
                      {
                        footnote: _,
                        layout: o,
                        formatCaller: () => w(_.caller, C),
                        showMarkers: s
                      }
                    )
                  }
                ),
                C < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Cr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, T)
            );
          })
        }
...
function oh({
  ...
  const g = ve(r, "%webView_inventory_all%"), f = ve(r, "%webView_inventory_approved%"), b = ve(r, "%webView_inventory_unapproved%"), v = ve(r, "%webView_inventory_unknown%"), z = ve(r, "%webView_inventory_scope_currentBook%"), k = ve(r, "%webView_inventory_scope_chapter%"), _ = ve(r, "%webView_inventory_scope_verse%"), C = ve(r, "%webView_inventory_filter_text%"), K = ve(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ve(r, "%webView_inventory_no_results%"), [j, $] = N(!1), [R, B] = N("all"), [Y, V] = N(""), [Z, M] = N([]), F = I(() => {
    const Q = t ?? [];
    ...
    const Q = [];
    return F.forEach((lt) => {
      const ft = lt.items[0], vt = Q.find(
        (dt) => dt.items[0] === ft
      );
      vt ? (vt.count += lt.count, vt.occurrences = vt.occurrences.concat(lt.occurrences)) : Q.push({
        items: [ft],
        count: lt.count,
  ...
  }, [j, F]), E = I(() => O.length === 0 ? [] : Jw(O, R, Y), [O, R, Y]), X = I(() => {
    var ft, vt;
    if (!j) return l;
    ...
    for (let dt = 0; dt < Q; dt++)
      lt.push(
        Ww(
          ((vt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : vt[dt]) || "Additional Item",
          dt + 1
        )
      );
    return [...lt, ...l];
  ...
  G(() => {
    E.length === 0 ? M([]) : E.length === 1 && M(E[0].items);
  }, [E]);
  const tt = (Q, lt) => {
    lt.setRowSelection(() => {
      const vt = {};
      return vt[Q.index] = !0, vt;
    });
    const ft = Q.original.items;
    M(ft), p && ft.length > 0 && p(ft[0]);
  }, mt = (Q) => {
    ...
    const Q = O.filter((lt) => ac(
      j ? lt.items : [lt.items[0]],
      Z
    ));
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Vt, { children: /* @__PURE__ */ u(Lt, { children: [
        ...
        /* @__PURE__ */ a(Ft, { children: (o == null ? void 0 : o.checkboxText) ?? K })
      ] }) })
    ] }),
...
function eu({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, h = Yt.useCallback(
    (_) => {
      const C = typeof _ == "function" ? _(w) : _;
      r ? r(C) : d(C);
    },
    [r, w]
  ), p = Yt.useCallback(() => h((_) => !_), [h]), g = w ? "expanded" : "collapsed", v = ke() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: h,
...
function bh({
  ...
  const [d, w] = N([]), [h, p] = N([{ id: Pe, desc: !1 }]), [g, f] = N({}), b = I(
    () => t.flatMap((R) => R.data.map((B) => ({
      ...B,
      source: R.source
    }))),
    [t]
  ...
  G(() => {
    if (c) {
      const R = z.getSelectedRowModel().rowsById, B = Object.keys(R);
      if (B.length === 1) {
        const Y = b.find((V) => bn(V) === B[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, b, c, z]);
  const k = n ?? pu, _ = i ?? Ai, C = [
    ...
    !R.getIsGrouped() && !R.getIsSelected() && R.getToggleSelectedHandler()(B);
  }, j = (R, B) => R.getIsGrouped() ? "" : m("banded-row", B % 2 === 0 ? "even" : "odd"), $ = (R, B, Y) => {
    if (!((R == null ? void 0 : R.length) === 0 || B.depth < Y.column.getGroupedIndex())) {
      if (B.getIsGrouped())
        switch (B.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      hr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(mr, { position: "item-aligned", children: /* @__PURE__ */ a(uw, { children: C.map((R) => /* @__PURE__ */ a(pe, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ao, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(oo, { children: z.getHeaderGroups().map((R) => /* @__PURE__ */ a(Ve, { children: R.headers.filter((B) => B.column.columnDef.header).map((B) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Zr, { colSpan: B.colSpan, className: "tw:sticky top-0", children: B.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          kr(B.column.columnDef.header, B.getContext())
        ] }) }, B.id)
      )) }, R.id)) }),
      /* @__PURE__ */ a(no, { children: z.getRowModel().rows.map((R, B) => {
        const Y = ke();
        return /* @__PURE__ */ a(
          Ve,
          {
            ...
            children: R.getVisibleCells().map((V) => {
              if (!(V.getIsPlaceholder() || V.column.columnDef.enableGrouping && !V.getIsGrouped() && (V.column.columnDef.id !== Ze || !r)))
                return /* @__PURE__ */ a(
                  lr,
                  {
                    className: m(
                    ...
                    children: V.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          " ",
                          kr(V.column.columnDef.cell, V.getContext()),
                          " (",
                          R.subRows.length,
                          ")"
                        ]
...
function mu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], h = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: f, extraLong: b } = {
  ...
  }, [v, z] = N(!1), [k, _] = N(""), C = U(void 0), K = U(!1), T = I(
    () => Sn(t),
    [t]
  ), j = I(() => {
    if (!k.trim()) {
    ...
    (M, F = !1) => {
      ...
      const O = T.findIndex((ot) => ot === C.current), E = T.findIndex((ot) => ot === M);
      if (O === -1 || E === -1) return;
      const [X, tt] = [
        Math.min(O, E),
        Math.max(O, E)
      ], mt = T.slice(X, tt + 1).map((ot) => ot);
      r(
        e.includes(M) ? e.filter((ot) => !mt.includes(ot)) : [.../* @__PURE__ */ new Set([...e, ...mt])]
      );
    },
    [e, r, T]
  ), R = (M) => {
    $(M, K.current), K.current = !1;
  }, B = (M, F) => {
    M.preventDefault(), $(F, M.shiftKey);
  }, Y = () => {
    r(T.map((M) => M));
  }, V = () => {
    r([]);
  }, Z = I(
    () => Object.values(gt).filter(
          ...
          Ue,
          {
            ...
            children: /* @__PURE__ */ u(
              Ke,
              {
                ...
                shouldFilter: !1,
                onKeyDown: (M) => {
                  M.key === "Enter" && (K.current = M.shiftKey);
                },
                children: [
                  /* @__PURE__ */ a(
                    na,
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:shrink-0 tw:justify-between tw:border-b tw:p-2", children: [
                    ...
                    /* @__PURE__ */ a(J, { variant: "ghost", size: "sm", onClick: V, children: w })
                  ] }),
                  /* @__PURE__ */ u(He, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    /* @__PURE__ */ a(ia, { children: h }),
                    Object.values(gt).filter((M) => j[M].length > 0).map((M, F) => {
                      const O = j[M];
                      return /* @__PURE__ */ u(la, { children: [
                        F > 0 && /* @__PURE__ */ a(En, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Re,
                          {
                  ...
                  Z.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Z.map(({ section: M, explanation: F }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: F }, M)) })
                ]
              }
            )
          }
...
function yu({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(gt).map((d) => /* @__PURE__ */ a(
      xu,
      {
        section: d,
        availableBookIds: c,
...
function yh({
  ...
  const K = At(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = At(s, "%webView_scope_selector_verse%"), j = At(s, "%webView_scope_selector_chapter%"), $ = At(s, "%webView_scope_selector_book%"), R = At(
    s,
    "%webView_scope_selector_current_verse%"
  ), B = At(
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = At(s, "%webView_scope_selector_current_book%"), V = At(s, "%webView_scope_selector_choose_books%"), Z = At(s, "%webView_scope_selector_scope%"), M = At(s, "%webView_scope_selector_select_books%"), F = At(s, "%webView_scope_selector_range%"), O = At(s, "%webView_scope_selector_select_range%"), E = At(s, "%webView_scope_selector_range_start%"), X = At(s, "%webView_scope_selector_range_end%"), tt = At(s, "%webView_scope_selector_ok%"), mt = At(s, "%webView_scope_selector_cancel%"), ot = At(s, "%webView_scope_selector_navigate%"), Ot = (P) => {
    if (!b) return;
  ...
  ], lt = (P, at, Jt = !1) => /* @__PURE__ */ u(ut, { children: [
    P,
    at && !Jt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      at
    ] })
  ] }), ft = e ? Q.filter((P) => e.includes(P.value)) : Q, vt = b ?? ba, dt = h ?? vt, It = p ?? vt, pt = () => {
  }, ae = U(null), te = U(null), Rt = U(!1), bt = U(null), Ct = U(!1), [Nt, xt] = N(void 0), $t = U(!1), D = U(!1), Ce = U(null), oe = L((P) => {
    if (P) {
    ...
    xt((at) => at === "start" ? void 0 : at), $t.current && ($t.current = !1, requestAnimationFrame(() => {
      var Jt;
      const at = (Jt = ae.current) == null ? void 0 : Jt.querySelector("button");
      at == null || at.click();
    }));
  }, []), ne = L((P) => {
    if (P) {
    ...
    (P) => {
      g == null || g(P), f == null || f(P), $t.current = !0;
    },
    [g, f]
  ), ee = L(
    (P) => {
    ...
    [r, n, b, i]
  ), Xt = ft.find((P) => P.value === t), yt = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? oc(dt, It, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : Xt ? lt(Xt.label, Xt.scrRefSuffix) : t, ie = ft.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), Tt = ft.find((P) => P.value === "selectedBooks"), Ht = ft.find((P) => P.value === "range"), [fe, me] = N(!1), [S, H] = N(void 0), [rt, x] = N(void 0), [A, q] = N(void 0), [et, it] = N(void 0), [ct, wt] = N([]), kt = w === "dropdown" && S === "selectedBooks", Et = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
      selectedBookIds: kt ? ct : n,
      onChangeSelectedBookIds: kt ? wt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Ut = Nt === "end", Oe = Nt === "start", se = "tw:text-muted-foreground", Ie = w === "dropdown" && S === "range", Mr = Ie ? q : Xe, ga = Ie ? it : f ? ee : pt, Or = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-start", className: m(Ut && se), children: E }),
      /* @__PURE__ */ a(
        ya,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ae, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(zt, { htmlFor: "scope-range-end", className: m(Oe && se), children: X }),
      /* @__PURE__ */ a(
        ya,
        {
          id: "scope-range-end",
          ...
          localizedStrings: z,
          getEndVerse: k,
          disableReferencesUpTo: Ie ? A ?? dt : dt,
          onOpenChange: ne,
          onCloseAutoFocus: (P) => {
            var at;
            D.current && (D.current = !1, P.preventDefault(), (at = Ce.current) == null || at.focus());
          },
          className: m(Oe && se),
          modal: !0,
          align: "start"
  ...
  G(() => {
    ...
    return () => {
      cancelAnimationFrame(at), P && cancelAnimationFrame(P);
    };
  }, [fe, t]);
  const [Dt, $e] = N(null), [Ee, nr] = N(null), [Mt, St] = N(null), Kt = 200, [_t, ce] = N(!1);
  G(() => {
    if (!Mt || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([at]) => {
      ce(at.contentRect.width < Kt);
    });
    return P.observe(Mt), () => P.disconnect();
  }, [Mt]);
  const ue = L(
    (P) => {
      x(P), q(dt), it(It), wt(n), me(!1), H(P);
    },
    [dt, It, n]
  ), Ae = L(() => {
    rt !== void 0 && (rt === "range" ? (A && (g == null || g(A)), et && (f == null || f(et))) : rt === "selectedBooks" && i(ct), we(rt), H(void 0), x(void 0));
  }, [
    rt,
    A,
    et,
    ...
    var at;
    P.preventDefault(), (at = nt.current) == null || at.focus();
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(qe, { open: fe, onOpenChange: me, children: [
        ...
        /* @__PURE__ */ a(
          Ye,
          {
            ...
            children: /* @__PURE__ */ u(fa, { container: Mt, children: [
              ie.map(({ value: P, label: at, dropdownLabel: Jt, scrRefSuffix: br, id: Hi }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: W(P),
                    ...
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (P) => {
                          const at = P.target instanceof HTMLElement ? P.target : void 0;
                        ...
                        children: /* @__PURE__ */ a(
                          ya,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var at;
                              P.preventDefault(), (at = bt.current) == null || at.focus();
                            },
                            modal: !0,
        ...
        to,
        {
          ...
          children: ft.map(({ value: P, label: at, scrRefSuffix: Jt, id: br }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Jr, { className: "tw:me-2", value: P, id: br }),
            /* @__PURE__ */ a(zt, { htmlFor: br, children: lt(at, Jt) })
          ] }, br))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && Or,
    w === "dropdown" && Tt && /* @__PURE__ */ a(Oa, { open: S === "selectedBooks", onOpenChange: Ir, children: /* @__PURE__ */ a(
      Ia,
      {
        ref: nr,
        onCloseAutoFocus: To,
        onEscapeKeyDown: (P) => {
          Ee != null && Ee.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(fa, { container: Ee, children: [
          /* @__PURE__ */ a($a, { className: "tw:pe-8", children: /* @__PURE__ */ a(Aa, { children: V }) }),
          Et,
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(J, { variant: "outline", onClick: () => Ir(!1), children: mt }),
            /* @__PURE__ */ a(J, { onClick: Ae, children: tt })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Ht && /* @__PURE__ */ a(Oa, { open: S === "range", onOpenChange: Ir, children: /* @__PURE__ */ a(
      Ia,
      {
        ref: $e,
        onCloseAutoFocus: To,
        onEscapeKeyDown: (P) => {
          Dt != null && Dt.querySelector('[data-state="open"]') && P.preventDefault();
        },
...
function Vu({
  ...
  if (kl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, h) => {
    var f, b, v, z;
    w.preventDefault();
    ...
    switch (h.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), yr(c, [p, g]);
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), yr(l, [p, g]);
        break;
    }
  }), G(() => {
    ...
    return /* @__PURE__ */ a(Su, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, h]) => typeof w == "boolean" || typeof h == "boolean" ? 0 : w.order - h.order).map(([w, h]) => /* @__PURE__ */ u(zu, { children: [
      /* @__PURE__ */ a(Du, { ref: d(w), children: typeof h == "object" && "label" in h && h.label }),
      /* @__PURE__ */ a(
        Mu,
        {
          style: { zIndex: ar },
...
function Dh({
  ...
  const d = ju(
    ...
    var z, k, _, C, K, T;
    const v = b !== f ? ((k = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : k[b]) ?? ((C = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : C.en) : void 0;
    return v ? `${(K = t[f]) == null ? void 0 : K.autonym} (${v})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
            ...
            d && (e || p && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(qe, { children: [
                  /* @__PURE__ */ a(Ge, { className: m(h && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
...
function Rg(t) {
  const e = I(() => nc(t).slice().sort().join(" "), [t]);
