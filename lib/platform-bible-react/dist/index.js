...
var Rt = (t, e, r) => Vi(t, typeof e != "symbol" ? e + "" : e, r);
import { r as Ft, Z as Li, B as U, c as f, a as ji, C as Ne, P as Ce, b as Re, d as Ee, e as Ae, f as Pe, g as pe, h as _r, i as ta, T as ee, S as He, j as re, k as ae, l as oe, D as Ge, m as br, n as Ie, o as Ve, p as Le, u as Fi, q as Nr, s as Ye, t as Oe, v as Da, w as sn, x as Bi, y as Ui, z as cn, A as ln, E as Ki, F as qi, G as Gi, H as Hi, I as da, J as wa, K as ir, L as Yi, M as Wi, N as Xi, O as Ji, Q as Zi, R as Cr, U as Ha } from "./resizable-CnUlSkqn.js";
import { V as Xh, W as Jh, X as Zh, Y as Qh, _ as tg, $ as eg, a0 as rg, a1 as ag, a2 as og } from "./resizable-CnUlSkqn.js";
import { jsx as a, jsxs as u, Fragment as tt } from "react/jsx-runtime";
import { Canon as dt } from "@sillsdev/scripture";
import { includes as Rr, Section as Z, getChaptersForBook as Qi, formatScrRef as ye, getSectionForBook as fr, formatRelativeDate as ts, formatReplacementString as xe, sanitizeHtml as dn, NumberFormat as es, formatBytes as rs, getCurrentLocale as as, usfmMarkers as jr, getFormatCallerFunction as os, deepEqual as ns, isString as vo, compareScrRefs as Sa, scrRefToBBBCCCVVV as ua, defaultScrRef as pa, formatScrRefRange as is, getLocalizeKeyForScrollGroupId as bo } from "platform-bible-utils";
import { Check as $e, Clock as xo, ChevronsLeft as yo, ChevronsRight as ko, ChevronLeft as Oa, ChevronRight as $a, ArrowLeft as ss, ArrowRight as cs, ChevronDown as or, BoldIcon as ls, ItalicIcon as ds, X as ea, AtSign as wn, Pencil as ws, Trash2 as us, ArrowUp as un, MoreHorizontal as ps, MailOpen as hs, Mail as gs, ChevronUp as fs, FilterIcon as ms, ArrowLeftIcon as vs, ChevronLeftIcon as bs, ChevronRightIcon as xs, ArrowRightIcon as ys, Copy as pn, Filter as ks, User as _s, Link as Ns, CircleHelp as Cs, ChevronsUpDown as hn, Star as Es, Undo as Ts, Redo as zs, SquareX as gn, FunctionSquare as fn, SquareSigma as mn, Ban as Ds, AlertCircle as Ma, CircleCheckIcon as Ss, CircleXIcon as Os, CircleHelpIcon as $s, ArrowUpIcon as Ms, ArrowDownIcon as Rs, Search as As, LoaderCircle as Ps, ScrollText as Is, MenuIcon as Vs, Menu as Ls, EllipsisVertical as js, MoreVertical as Fs } from "lucide-react";
import ut, { useRef as q, useMemo as j, useState as C, useCallback as L, useEffect as Y, useLayoutEffect as Jt, createContext as Ya, useContext as vn, Component as Bs, createElement as _o, Suspense as Us, forwardRef as ra, useId as Ks, Fragment as bn } from "react";
import { Dialog as he, Label as qs, RadioGroup as Ra, ToggleGroup as xn, Slot as sr, Avatar as Wa, Select as Pt, Checkbox as No, Tabs as le, Menubar as me, ContextMenu as Dt, Progress as Co, Slider as Ar, Switch as Eo } from "radix-ui";
import { createEditor as yn, $getRoot as Me, $createParagraphNode as Er, $getSelection as jt, HISTORY_MERGE_TAG as Xa, ParagraphNode as kn, TextNode as _n, $getPreviousSelection as Gs, $isRangeSelection as ge, $caretFromPoint as Hs, $getSiblingCaret as Nn, $getChildCaret as Ys, $getAdjacentChildCaret as Ws, $isChildCaret as Xs, $normalizeCaret as Js, $setSelectionFromCaretRange as Zs, $getCollapsedCaretRange as Qs, $getCaretInDirection as To, $splitAtPointCaretNext as tc, $isTextPointCaret as ec, $findMatchingParent as Cn, $isElementNode as xr, mergeRegister as _e, getDOMTextNode as rc, isHTMLElement as ac, CLEAR_EDITOR_COMMAND as En, COMMAND_PRIORITY_EDITOR as Ja, shallowMergeConfig as oc, defineExtension as ne, safeCast as Qe, createState as nc, FORMAT_TEXT_COMMAND as Tn, $isNodeSelection as zn, COMMAND_PRIORITY_LOW as Dn, RootNode as ic, LineBreakNode as sc, TabNode as cc, $isEditorState as lc, createCommand as dc, CLICK_COMMAND as wc, isDOMNode as uc, $getNodeFromDOMNode as pc, $createNodeSelection as hc, $setSelection as gc, $getEditor as fc, DecoratorNode as Aa, $getState as mc, toggleTextFormatType as zo, TEXT_TYPE_TO_FORMAT as vc, $setState as bc, addClassNamesToElement as Sn, $create as xc, $getNodeByKey as yc, removeClassNamesFromElement as kc, KEY_TAB_COMMAND as _c, $isBlockElementNode as Nc, $createRangeSelection as Cc, $normalizeSelection__EXPERIMENTAL as Ec, OUTDENT_CONTENT_COMMAND as Tc, INDENT_CONTENT_COMMAND as Do, INSERT_TAB_COMMAND as zc, COMMAND_PRIORITY_CRITICAL as Za, $isDecoratorNode as Dc, $isParagraphNode as Sc, $isTextNode as Pa, SELECTION_CHANGE_COMMAND as On, $insertNodes as Oc } from "lexical";
import { HeadingNode as $c, QuoteNode as Mc, registerRichText as Rc } from "@lexical/rich-text";
import { flushSync as Ac, createPortal as Pc } from "react-dom";
import { IconX as Ic, IconCheck as aa, IconChevronDown as Vc, IconChevronUp as Lc, IconSelector as jc, IconLayoutSidebar as Fc, IconLayoutSidebarRight as Bc, IconChevronRight as $n, IconLoader as Uc, IconAlertOctagon as Kc, IconAlertTriangle as qc, IconInfoCircle as Gc, IconCircleCheck as Hc } from "@tabler/icons-react";
import { $isTableSelection as Yc } from "@lexical/table";
import { cva as Tr } from "class-variance-authority";
import { createHeadlessEditor as Mn } from "@lexical/headless";
import { $generateHtmlFromNodes as Wc, $generateNodesFromDOM as Xc } from "@lexical/html";
import { useReactTable as Rn, getFilteredRowModel as Jc, getSortedRowModel as An, getPaginationRowModel as Zc, getCoreRowModel as Pn, flexRender as mr, getGroupedRowModel as Qc, getExpandedRowModel as tl } from "@tanstack/react-table";
import el from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ia, HIDDEN_NOTE_CALLER as Va, getDefaultViewOptions as rl, isInsertEmbedOpOfType as Pr, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
const Vn = dt.allBookIds.filter(
  (t) => !dt.isObsolete(dt.bookIdToNumber(t))
), se = Object.fromEntries(
  Vn.map((t) => [t, dt.bookIdToEnglishName(t)])
);
function to(t, e, r) {
...
function dl({
  ...
  const [h, g] = C(!1), m = w !== void 0, x = m ? w : h, v = (k) => {
    m || g(k), p == null || p(k);
  };
  if (t.length === 0)
    return;
...
function ga({
  ...
  const k = Ft(), [_, N] = C(!1), [I, F] = C(""), [V, $] = C(""), [y, z] = C("books"), [A, S] = C(void 0), [O, W] = C(
    void 0
  ), [K, M] = C(void 0), [Q, mt] = C(!1), ct = q(null), Bt = q(!1), bt = q(void 0), St = q(void 0), B = q(void 0), rt = q(void 0), ot = q({}), nt = q({}), it = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  }), [It]), Ut = j(() => Object.values(vt).flat(), [vt]), Kt = j(() => {
    if (!V.trim()) return vt;
    const b = {
      [Z.OT]: [],
      [Z.NT]: [],
  ...
  const Vt = L(() => {
    ...
    (b) => {
      const G = y === "chapters" ? A : D == null ? void 0 : D.book;
      if (G) {
        if (l && l(G, b) > 1) {
          W(G), M(b), z("verses"), F("");
          return;
    ...
    N(b), b && (z("books"), S(void 0), W(void 0), M(void 0), $(""));
    ...
    () => ul(V),
    [V]
  ), kt = j(() => !l || !D || !D.chapterNum || !pt ? !1 : l(D.book, D.chapterNum) > 0, [l, D, pt]), Fe = L(
    (b) => w ? Oo(b, w) : !1,
    [w]
  ), ze = L(
    (b) => (G) => w ? pl(b, G, w) : !1,
    ...
    (b) => {
      ...
      if ((y === "chapters" || y === "books" && D) && Et) {
        const Mt = y === "chapters" ? A : D == null ? void 0 : D.book;
        if (!Mt) return;
  ...
  return Jt(() => {
    const b = setTimeout(() => {
      if (_ && y === "books" && B.current && rt.current) {
        const G = B.current, J = rt.current, Et = J.offsetTop, Zt = G.clientHeight, tr = J.clientHeight, ur = Et - Zt / 2 + tr / 2;
        G.scrollTo({
          top: Math.max(0, ur),
          behavior: "smooth"
        }), F(jn(t.book));
    ...
    /* @__PURE__ */ a(Re, { asChild: !0, children: /* @__PURE__ */ a(
      U,
      {
        ...
        children: h ?? /* @__PURE__ */ a("span", { className: "tw:truncate", children: Ct })
      }
    ) }),
    /* @__PURE__ */ a(
      Ee,
              ...
              y === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  U,
                  {
                    ...
                    tabIndex: -1,
                    children: k === "ltr" ? /* @__PURE__ */ a(ss, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(cs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                y === "chapters" && A && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Se(A, n) }),
                y === "verses" && O && K !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Se(O, n)} ${K}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
...
function Ao({
  ...
  const [_, N] = C(!1), I = l ?? d, F = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, y) => {
    const z = d($), A = typeof $ == "object" && "secondaryLabel" in $ ? $.secondaryLabel : void 0, S = `${y ?? ""}${z}${A ?? ""}`;
    return /* @__PURE__ */ u(
      Ne,
      {
        value: z,
    ...
    /* @__PURE__ */ a(
      Ee,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          ...
          /* @__PURE__ */ a(Pe, { children: F(e) ? e.map(($) => /* @__PURE__ */ a(pe, { heading: $.groupHeading, children: $.options.map((y) => V(y, $.groupHeading)) }, $.groupHeading)) : /* @__PURE__ */ a(pe, { children: e.map(($) => V($)) }) })
        ] })
      }
    )
  ] });
...
const Kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Kn ? Jt : Y, Ir = { tag: Xa };
...
const yl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
function zl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function Dl() {
  return function(t) {
    const [e] = ve(), r = j(() => t(e), [e, t]), [o, n] = C(() => r.initialValueFn()), i = q(o);
    return Tl(() => {
...
function Ml(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < g.length; E++) {
      const k = g[E], _ = s[E] || document.createElement("div"), N = _.style;
...
function Al(t, e = Rl) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), m = h.getNode(), x = m.getKey(), v = h.offset, E = g.getNode(), k = E.getKey(), _ = g.offset, N = t.getElementByKey(x), I = t.getElementByKey(k), F = r === null || N !== o || v !== n || x !== r.getKey(), V = i === null || I !== s || _ !== c || k !== i.getKey();
      if ((F || V) && N !== null && I !== null) {
        const $ = function(y, z, A, S, O, W, K) {
          const M = (y._window ? y._window.document : document).createRange();
          return M.setStart(...Po(z, A, S)), M.setEnd(...Po(O, W, K)), M;
        }(t, h, m, N, g, E, I);
        d(), d = Ml(t, $, e);
      }
...
function Vl(t) {
  const e = jt() || Gs();
  let r;
  if (ge(e)) r = Hs(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Nn(c, "next"));
    }
    r = r || Ys(Me(), "previous").getFlipped().insert(Er());
  }
...
function Ll(t, e, r) {
  ...
  return ec(o) && Hr(283), o.insert(t.isInline() ? Er().append(t) : t), To(Nn(t.getLatest(), "next"), e.direction);
}
function jl(t) {
  const e = jt();
  if (!ge(e)) return !1;
...
let Yr, ke = 0, Wr = 0, Ul = 0, Ua = 0, Br = 0;
function Vo(t) {
  if (et === void 0) return;
  let e = t.n;
...
function ql(t) {
  ...
  Hn(this), et = t, this.f &= -2, 8 & this.f && ao(this), oa();
}
function rr(t, e) {
...
At.prototype.brand = Fl, At.prototype.h = function() {
  return !0;
  ...
  return et = t, Hn(this), this.f &= -2, !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Yn(this), Lo(this), ke++;
  const t = et;
  return et = this, ql.bind(this, t);
...
function Wn() {
  const t = Me(), e = jt(), r = Er();
  t.clear(), t.append(r), e !== null && r.select(), ge(e) && (e.format = 0);
}
function Xn(t, e = Wn) {
  return t.registerCommand(En, (r) => (t.update(e), !0), Ja);
}
ne({ build: (t, e, r) => cr(e), config: Qe({ $onClear: Wn }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return fe(() => Xn(t, o.value));
} });
function Gl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const va = nc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Jn extends Aa {
  $config() {
...
ne({ name: "@lexical/extension/DecoratorText", nodes: () => [Jn], register: (t, e, r) => t.registerCommand(Tn, (o) => {
  const n = jt();
  if (zn(n) || ge(n)) for (const i of n.getNodes()) Hl(i) && i.toggleFormat(o);
  return !1;
}, Dn) });
function Zn(t, e) {
  let r;
...
const Ka = ne({ build: (t) => Zn(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const oo = 0, qa = 1, ti = 2, ba = 3, Vr = 4, er = 5, xa = 6, hr = 7;
function ya(t) {
  return t.id === oo;
}
function ei(t) {
...
function Yl(t) {
  return function(e) {
    return e.id === qa;
  }(t) || lt(305, String(t.id), String(qa)), Object.assign(t, { id: ti });
}
...
const Zl = ne({ config: Qe({ setOptions: jo, updateOptions: jo }), init: ({ $initialEditorState: t = Jl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [ic, _n, sc, cc, kn] }), Fo = Symbol.for("@lexical/extension/LexicalBuilder");
function Bo() {
}
function Ql(t) {
  throw t;
...
const td = /* @__PURE__ */ new Set(), Uo = ne({ build(t, e, r) {
  const o = r.getDependency(Ka).output, n = yr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = Zn(() => {
  }, () => fe(() => {
...
}, dependencies: [Ka], name: "@lexical/extension/NodeSelection" }), ed = dc("INSERT_HORIZONTAL_RULE_COMMAND");
class nr extends Aa {
  static getType() {
...
ne({ dependencies: [Ka, Uo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return _e(t.registerCommand(ed, (s) => {
    const c = jt();
    if (!ge(c)) return !1;
    ...
    return !0;
  }, Ja), t.registerCommand(wc, (s) => {
    if (uc(s.target)) {
      const c = pc(s.target);
      if (ad(c)) return function(d, l = !1) {
        const w = jt(), p = d.isSelected(), h = d.getKey();
        let g;
        l && zn(w) ? g = w : (g = hc(), gc(g)), p ? g.delete(h) : g.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function od(t, e, r = ri) {
  return _e(t.registerCommand(_c, (o) => {
    const n = jt();
    if (!ge(n)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => Nc(h) && h.canIndent()).length > 0) return !0;
      const c = s.anchor, d = s.focus, l = d.isBefore(c) ? d : c, w = l.getNode(), p = Il(w);
      if (p.canIndent()) {
        const h = p.getKey();
        let g = Cc();
        if (g.anchor.set(h, 0, "element"), g.focus.set(h, 0, "element"), g = Ec(g), g.anchor.is(l)) return !0;
      }
      return !1;
    }(n) ? o.shiftKey ? Tc : Do : zc;
...
ne({ build: (t, e, r) => cr(e), config: Qe({ $canIndent: ri, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return fe(() => {
    if (!o.value) return od(t, n, i);
  });
} });
const nd = ne({ name: "@lexical/react/ReactProvider" });
function id() {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(m)) {
                ...
                if (Pa(v) && l >= 0 && w >= 0 && (E = l, k = l + w, m.setTextNodeRange(v, E, v, k)), E === k && p === "" || (m.insertRawText(p), v = x.getNode()), Pa(v)) {
                  E = h, k = h + g;
...
ne({ build: (t, e, r) => cr(e), config: Qe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => fe(() => r.getOutput().disabled.value ? void 0 : oi(t)) });
function ld(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function ud({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    io(() => _e(Rc(n), oi(n)), [n]);
  }(o), u(tt, { children: [t, a(pd, { content: e }), a(wd, { editor: o, ErrorBoundary: r })] });
}
...
function xd(t, e) {
  ...
  return u(tt, { children: [a(vd, { editor: n, ...o, ref: e }), r != null && a(yd, { editor: n, content: r })] });
}
...
function Cd({
  ...
  const [e] = ve(), [r, o] = C(e), [n, i] = C("paragraph"), [s, c] = Nd(), d = () => {
  };
...
function Qu({
  ...
  const [i, s] = C(Rd), [c, d] = C(n), [l, w] = C(!1), p = q(void 0), h = q(null);
  Y(() => {
    let v = !0;
    const E = h.current;
    if (!E) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (v) => {
          v.key === "Escape" ? (v.preventDefault(), v.stopPropagation(), r()) : lo(v) && (v.preventDefault(), v.stopPropagation(), Qt(i) && g());
        },
        onKeyDown: (v) => {
...
function Yo({
  ...
  }, [t.date, r]), v = j(() => t.user, [t.user]), E = j(
    () => t.user.split(" ").map((N) => N[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = j(() => dn(t.contents), [t.contents]), _ = j(() => {
    if (o && c)
      return /* @__PURE__ */ u(tt, { children: [
        /* @__PURE__ */ u(
          Ge,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          d && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), g()) : lo(N) && (N.preventDefault(), N.stopPropagation(), Qt(w) && m());
              },
              onKeyDown: (N) => {
        ...
        _ && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ps, {}) }) }),
...
function Ld({
  ...
  const [$, y] = C(Wo), [z, A] = C(), [S, O] = C(), W = o, [K, M] = C(!1), [Q, mt] = C(!1), [ct, Bt] = C(!1), [bt, St] = C(!1), [B, rt] = C(!1), [ot, nt] = C(N), [it, It] = C(!1), vt = q(void 0), [Ut, Kt] = C(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Ot = j(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !_) {
      Kt(/* @__PURE__ */ new Map());
  ...
  const Vt = j(() => Ot[0], [Ot]), ie = q(null), qt = q(void 0), $t = L(() => {
    var T;
    (T = qt.current) == null || T.call(qt), y(Wo);
  }, []), Te = L(() => {
    const T = !ot;
  ...
  }, [i, r]), P = j(() => Ot.slice(1), [Ot]), H = j(() => P.length ?? 0, [P.length]), st = j(() => H > 0, [H]), at = j(() => K || H <= 2 ? P : P.slice(-2), [P, H, K]), ht = j(() => K || H <= 2 ? 0 : H - 2, [H, K]), xt = j(
  ...
  const gt = L(
    ...
    async (T) => {
      const wt = Qt($) ? Jr($) : void 0, pt = T.status ? T.assignedUser : z ?? T.assignedUser, kt = await p({
        ...T,
        contents: wt,
        assignedUser: pt
      });
            ...
            o && /* @__PURE__ */ u(tt, { children: [
              ...
              v !== !1 && (!Q || Qt($)) && /* @__PURE__ */ u(
                "div",
                {
                  ...
                  onKeyDownCapture: (T) => {
                    lo(T) && (T.preventDefault(), T.stopPropagation(), (Qt($) || z !== void 0 && z !== S) && gt());
                  },
                  onKeyDown: (T) => {
                        ...
                        /* @__PURE__ */ a(
                          Ee,
                          {
                            ...
                            children: /* @__PURE__ */ a(Ae, { children: /* @__PURE__ */ a(Pe, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ a(
                              ...
                              {
                                onSelect: () => {
                                  A(T !== i ? T : void 0), D.current = "user-selected", O(void 0), Bt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function sp({
  ...
  const [E, k] = C(/* @__PURE__ */ new Set()), [_, N] = C(), [I, F] = C(), V = L(
    async (M) => {
      const Q = await i(M);
  ...
  const $ = r.filter(
    ...
    [E, x]
  ), { listboxRef: S, activeId: O, handleKeyDown: W } = Fi({
    options: y,
    onOptionSelect: z
  }), K = L(
    (M) => {
...
function wp({
  ...
  const [i, s] = C("accept"), c = r ?? i, d = Ks();
  if (!(t.conflictType === Ud)) return /* @__PURE__ */ a(Na, { rawHtml: t.contents });
  const w = r !== void 0, p = (g) => {
    const m = g === "reject" ? "reject" : "accept";
    w || s(m), o == null || o(m);
  }, h = c === "reject" ? t.rejectedResultText : t.resultText;
  return /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-3 tw:text-sm", children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:gap-1", children: [
      ...
      /* @__PURE__ */ a("div", { "aria-live": "polite", "aria-labelledby": d, children: h ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: h }) : (
  ...
  const c = ut.useMemo(
    ...
    (w) => {
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), Jd(g, m, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), Xd(c, x, w.key);
...
function Zd({
  ...
  var F;
  const [w, p] = C([]), [h, g] = C([]), [m, x] = C({}), [v, E] = C({}), k = j(() => e ?? [], [e]), _ = Rn({
    data: k,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  let I;
  return d ? I = Array.from({ length: 10 }).map((y, z) => `skeleton-row-${z}`).map((y) => /* @__PURE__ */ a(ce, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(te, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Da, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, y)) : ((F = _.getRowModel().rows) == null ? void 0 : F.length) > 0 ? I = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ce,
    {
      onClick: () => s(V, _),
    ...
    /* @__PURE__ */ u(na, { stickyHeader: i, children: [
      /* @__PURE__ */ a(wo, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(ce, { children: V.headers.map(($) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : mr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function mp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    ...
    /* @__PURE__ */ a(Le, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(sn, { children: l.itemType === 0 ? /* @__PURE__ */ a(tt, { children: l.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][h],
...
function ow({
  ...
  const d = j(() => /Macintosh/i.test(navigator.userAgent), []), l = Qo(n, "%undoButton_tooltip%"), w = Qo(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(co, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(
        U,
...
const iw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(tt, { children: [
...
function sw({
  ...
  const i = q(null), s = q(null), c = q(!1), [d, l] = C(t), [w, p] = C(r), [h, g] = C(!1);
  Y(() => {
    l(t);
  }, [t]), Y(() => {
    w !== r && p(r);
  ...
  return /* @__PURE__ */ u(Ie, { open: h, onOpenChange: m, children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: iw(t, n, r) }) }) }),
...
const cw = (t, e) => t === "f" ? /* @__PURE__ */ u(tt, { children: [
  /* @__PURE__ */ a(fn, {}),
  " ",
...
function dw({
  ...
  return /* @__PURE__ */ u(Ie, { children: [
    /* @__PURE__ */ a(ee, { children: /* @__PURE__ */ u(re, { children: [
      /* @__PURE__ */ a(ae, { asChild: !0, children: /* @__PURE__ */ a(Ve, { asChild: !0, children: /* @__PURE__ */ a(U, { variant: "outline", className: "tw:h-6", children: cw(t, r) }) }) }),
      /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a("p", { children: lw(t, r) }) })
    ] }) }),
    /* @__PURE__ */ u(Le, { style: { zIndex: cn }, children: [
...
function kp({
  ...
  const w = q(null), p = q(null), h = q(null), g = q(null);
  Jt(() => {
    if (!g.current) return;
    const { width: P } = g.current.getBoundingClientRect();
    P > 0 && (g.current.style.width = `${P}px`);
  }, []);
  const [m, x] = C("generated"), [v, E] = C("generated"), [k, _] = C("*"), [N, I] = C("*"), [F, V] = C("f"), [$, y] = C(!1), [z, A] = C(!0), [S, O] = C(!1), W = q(!1), K = q(""), [M, Q] = C(!1), [mt, ct] = C(), [Bt, bt] = C(), [St, B] = C(), [rt, ot] = C(), nt = q(null), it = j(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (H && Pr("note", H)) {
      ...
      let xt = "custom";
      ht === Ia ? xt = "generated" : ht === Va ? xt = "hidden" : ht && (_(ht), I(ht)), x(xt), E(xt), V(((at = H.insert.note) == null ? void 0 : at.style) ?? "f"), P = setTimeout(() => {
        var yt;
  ...
  const Ot = () => {
    ...
    if (H && Pr("note", H)) {
      ...
      F !== "x" && P === "x" ? gt == null || gt.forEach((Ct) => gw(Ct)) : F === "x" && P !== "x" && (gt == null || gt.forEach((Ct) => fw(Ct))), (yt = w.current) == null || yt.applyUpdate([H, { delete: 1 }]);
    }
  }, $t = (P) => {
    ...
    if (h.current && It.length && P && P.rangeCount > 0) {
      const H = P.getRangeAt(0).getBoundingClientRect(), st = h.current.getBoundingClientRect();
...
function xw({
  ...
  /* @__PURE__ */ u("span", { className: f("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    uo(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", m = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", x = f(h, g);
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(tt, { children: vw(t.marker, c, o, l) })
      }
    )
  ] });
}
function Np({
  ...
  const w = d ?? os(r, void 0), p = (k, _) => {
    l == null || l(k, _, n);
  }, h = i ? r.findIndex((k) => k === i) : -1, [g, m] = C(h), x = (k, _, N) => {
    if (r.length)
      switch (k.key) {
        case "Enter":
        case " ":
        ...
        "ul",
        {
          ...
          children: r.map((k, _) => {
            ...
            return /* @__PURE__ */ u(tt, { children: [
              ...
              _ < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(He, { tabIndex: -1, className: "tw:col-span-2" })
            ] });
          })
        }
      )
    ...
    /* @__PURE__ */ a(ia, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      ce,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(te, { className: o, children: yw(c.text) })
        ]
      },
...
const _w = (t) => {
  ...
  return e ? e[1] : "";
}, Cw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Op = Object.freeze([
...
function $p({
  ...
  const g = de(r, "%webView_inventory_all%"), m = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), E = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), _ = de(r, "%webView_inventory_scope_verse%"), N = de(r, "%webView_inventory_filter_text%"), I = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), F = de(r, "%webView_inventory_no_results%"), [V, $] = C(!1), [y, z] = C("all"), [A, S] = C(""), [O, W] = C([]), K = j(() => {
    const B = t ?? [];
    return B.length === 0 ? [] : Tw(B, n, i);
  }, [t, n, i]), M = j(() => {
    if (V) return K;
    const B = [];
    return K.forEach((rt) => {
  ...
  }, [V, K]), Q = j(() => M.length === 0 ? [] : Ew(M, y, A), [M, y, A]), mt = j(() => {
    var ot, nt;
    if (!V) return d;
      ...
      /* @__PURE__ */ u(
        We,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(Ze, { children: [
              /* @__PURE__ */ a(Xt, { value: "all", children: g }),
              /* @__PURE__ */ a(Xt, { value: "approved", children: m }),
              /* @__PURE__ */ a(Xt, { value: "unapproved", children: x }),
              /* @__PURE__ */ a(Xt, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(We, { onValueChange: (B) => Bt(B), defaultValue: s, children: [
        /* @__PURE__ */ a(Je, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(Xe, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(Ze, { children: [
          /* @__PURE__ */ a(Xt, { value: "book", children: E }),
          /* @__PURE__ */ a(Xt, { value: "chapter", children: k }),
          /* @__PURE__ */ a(Xt, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        zr,
...
const bi = ra(({ className: t, ...e }, r) => /* @__PURE__ */ a(Ps, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function Rp({
  ...
  const [s, c] = C(""), [d, l] = C([]), w = j(
    () => t.filter((O) => !r || O.type === r).filter((O) => Dw(O, s)).filter(
    ...
    [w, o]
  ), { visibleItems: m, sentinelRef: x, hasMore: v } = zw(g), E = j(
    () => Array.from(new Set(t.map((O) => O.bestLanguageName))).map((O) => ({
      label: O,
      value: O
    })),
    [t]
  ), k = p.length === 0 && h.length === 0 && g.length === 0, _ = be(n, "%resourcePicker_title%"), N = be(n, "%resourcePicker_search_placeholder%"), I = be(n, "%resourcePicker_language_filter_any%"), F = be(
    n,
    "%resourcePicker_section_already_selected%"
  ), V = be(n, "%resourcePicker_section_installed%"), $ = be(
    n,
    "%resourcePicker_section_available_to_download%"
  ), y = be(n, "%resourcePicker_no_results%"), z = be(n, "%resourcePicker_showing_count%"), A = j(() => {
  ...
  return /* @__PURE__ */ u(tt, { children: [
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex-1 tw:overflow-y-auto tw:px-4 tw:pb-4", children: [
      ...
      !k && !e && /* @__PURE__ */ a(na, { children: /* @__PURE__ */ u(ia, { children: [
        ...
        v && /* @__PURE__ */ a(ce, { className: "tw:border-0", children: /* @__PURE__ */ a(te, { colSpan: 4, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { ref: x, "aria-hidden": !0 }) }) })
      ] }) })
    ] })
  ] });
}
const Sw = "16rem", Ow = "3rem", xi = ut.createContext(void 0);
function la() {
  const t = ut.useContext(xi);
  if (!t)
...
function $w({
  ...
  const [d, l] = ut.useState(t), w = e ?? d, p = ut.useCallback(
    ...
    [r, w]
  ), h = ut.useCallback(() => p((_) => !_), [p]), g = w ? "expanded" : "collapsed", v = Ft() === "ltr" ? s : s === "primary" ? "secondary" : "primary", E = ut.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
    ...
    Mw,
    {
      ...
      children: /* @__PURE__ */ u(Aw, { children: [
        /* @__PURE__ */ u(en, { children: [
          ...
          /* @__PURE__ */ a(an, { children: /* @__PURE__ */ a(Pw, { children: Object.entries(e).map(([g, m]) => /* @__PURE__ */ a(Iw, { children: /* @__PURE__ */ a(
            Lw,
            {
              onClick: () => l(g),
              isActive: h(g),
...
const De = "scrBook", Fw = "scrRef", qe = "source", Bw = "details", Uw = "Scripture Reference", Kw = "Scripture Book", yi = "Type", qw = "Details";
function Gw(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? dt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === De ? ye(n.start) : void 0;
      },
...
}, on = (t) => `${Hw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wp({
  sources: t,
  ...
  const [l, w] = C([]), [p, h] = C([{ id: De, desc: !1 }]), [g, m] = C({}), x = j(
  ...
  Y(() => {
    if (c) {
      ...
      if (z.length === 1) {
        const A = x.find((S) => on(S) === z[0]) || void 0;
        A && c(A);
      }
    }
  }, [g, x, c, E]);
  const k = n ?? Kw, _ = i ?? yi, N = [
    ...
    !e && /* @__PURE__ */ u(
      We,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Ze, { position: "item-aligned", children: /* @__PURE__ */ a(jd, { children: N.map((y) => /* @__PURE__ */ a(Xt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(na, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(wo, { children: E.getHeaderGroups().map((y) => /* @__PURE__ */ a(ce, { children: y.headers.filter((z) => z.column.columnDef.header).map((z) => (
                  ...
                  te,
                  {
                    ...
                    children: S.getIsGrouped() ? /* @__PURE__ */ u(
                      U,
                      {
                        ...
                        type: "button",
                        children: [
                          y.getIsExpanded() && /* @__PURE__ */ a(or, {}),
                          !y.getIsExpanded() && (A === "ltr" ? /* @__PURE__ */ a($a, {}) : /* @__PURE__ */ a(Oa, {})),
                          " ",
...
function Yw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: m } = {
  ...
  }, [x, v] = C(!1), [E, k] = C(""), _ = q(void 0), N = q(!1), I = j(
    () => ki(t),
    [t]
  ), F = j(() => {
    if (!E.trim()) {
    ...
    (S, O = !1) => {
      ...
      const W = I.findIndex((ct) => ct === _.current), K = I.findIndex((ct) => ct === S);
      if (W === -1 || K === -1) return;
      const [M, Q] = [
        Math.min(W, K),
        Math.max(W, K)
      ...
      children: [
        ...
        /* @__PURE__ */ a(Ee, { className: "tw:w-[500px] tw:max-w-[calc(100vw-2rem)] tw:p-0", align: "start", children: /* @__PURE__ */ u(
          Ae,
          {
            shouldFilter: !1,
            onKeyDown: (S) => {
              S.key === "Enter" && (N.current = S.shiftKey);
            },
            children: [
              /* @__PURE__ */ a(
                _r,
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ta ? Ta : nn
      ).map((d) => /* @__PURE__ */ a(br, { className: "tw:hover:bg-secondary", variant: "secondary", children: Se(d, n) }, d)),
...
function Jp({
  ...
  const N = zt(
  ...
  }, vt = q(null), Ut = q(null), Kt = q(!1), D = q(null), Ot = q(!1), [Vt, ie] = C(void 0), qt = q(!1), $t = q(!1), Te = q(null), Gt = L((R) => {
    if (R) {
    ...
    (R) => {
      h == null || h(R), g == null || g(R), qt.current = !0;
    },
    [h, g]
  ), H = L(
    (R) => {
      g == null || g(R), $t.current = !0;
    },
    [g]
  ), st = L(
    (R) => {
    ...
    [r, n, m, i]
  ), at = rt.find((R) => R.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((R) => R.toUpperCase()).join(", ") : t === "range" ? is(nt, it, {
  ...
  ), yt = rt.find((R) => R.value === "selectedBooks"), gt = rt.find((R) => R.value === "range"), [Ct, T] = C(!1), [wt, pt] = C(void 0), [kt, Fe] = C(void 0), [ze, lr] = C(void 0), [Be, dr] = C(void 0), [wr, Dr] = C([]), Sr = l === "dropdown" && wt === "selectedBooks", b = /* @__PURE__ */ a(
    Xw,
    {
      availableBookInfo: o,
  ...
  ), G = Vt === "end", J = Vt === "start", Et = "tw:text-muted-foreground", Zt = l === "dropdown" && wt === "range", tr = Zt ? lr : P, Mt = Zt ? dr : g ? H : It, _t = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: vt, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ga,
        {
          ...
          localizedStrings: v,
          getEndVerse: E,
          disableReferencesUpTo: Zt ? ze ?? nt : nt,
          onOpenChange: Ht,
          onCloseAutoFocus: (R) => {
            var X;
  ...
  const [Wt, Ue] = C(null), [Or, Oi] = C(null), [$r, $i] = C(null), Mi = 200, [Ri, Ai] = C(!1);
  Y(() => {
    if (!$r || typeof ResizeObserver > "u") return;
    const R = new ResizeObserver(([X]) => {
      Ai(X.contentRect.width < Mi);
    });
    return R.observe($r), () => R.disconnect();
  }, [$r]);
  const ho = L(
    (R) => {
      Fe(R), lr(nt), dr(it), Dr(n), T(!1), pt(R);
    },
    [nt, it, n]
  ), go = L(() => {
    kt !== void 0 && (kt === "range" ? (ze && (h == null || h(ze)), Be && (g == null || g(Be))) : kt === "selectedBooks" && i(wr), st(kt), pt(void 0), Fe(void 0));
  }, [
    kt,
    ze,
    Be,
  ...
  }, []), mo = (R) => t === R ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a($e, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !k && /* @__PURE__ */ a(Nt, { children: S }),
        ...
        /* @__PURE__ */ a(
          Le,
          {
            ...
            children: /* @__PURE__ */ u(da, { container: $r, children: [
              xt.map(({ value: R, label: X, dropdownLabel: Lt, scrRefSuffix: pr, id: Pi }) => /* @__PURE__ */ u(
                Ge,
                {
                  ref: ft(R),
      ...
      ja,
      {
        ...
        children: /* @__PURE__ */ u(da, { container: Or, children: [
          ...
          /* @__PURE__ */ u(So, { children: [
            ...
            /* @__PURE__ */ a(U, { onClick: go, children: mt })
          ] })
        ] })
      }
    ) }),
    l === "dropdown" && gt && /* @__PURE__ */ a(La, { open: wt === "range", onOpenChange: Mr, children: /* @__PURE__ */ a(
      ja,
      {
        ...
        children: /* @__PURE__ */ u(da, { container: Wt, children: [
          ...
          /* @__PURE__ */ u(So, { children: [
            /* @__PURE__ */ a(U, { variant: "outline", onClick: () => Mr(!1), children: ct }),
            /* @__PURE__ */ a(U, { ref: Te, onClick: go, children: mt })
          ] })
        ] })
      }
    ) })
...
function Ga({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(Ve, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(U, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Vs, {}) }) }),
    /* @__PURE__ */ a(Le, { align: "start", style: { zIndex: ir }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(bn, { children: [
      /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(ee, { children: Ci(e.groups, e.items, d, t) }) }),
      l < w.length - 1 && /* @__PURE__ */ a(Ye, {})
    ] }, d)) })
  ] });
}
const Ei = ut.forwardRef(
...
const Ti = ut.forwardRef(({ className: t, ...e }, r) => {
  const o = Ft();
  return /* @__PURE__ */ a(
    le.Root,
    {
...
Ti.displayName = le.List.displayName;
const zi = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.List,
  {
    ref: r,
    className: f(
...
)), Di = ut.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  le.Content,
  {
    ref: r,
    className: f(
...
function oh({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Ti, { children: [
      /* @__PURE__ */ a(zi, { children: t.map((c) => /* @__PURE__ */ a(Qw, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (ol(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), gr(s, [h, g]);
        break;
      case "alt+n":
    ...
    return /* @__PURE__ */ a(tu, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(eu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: ir },
          children: /* @__PURE__ */ a(ee, { children: Si(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
      ...
      We,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: ir },
              children: Object.keys(t).map((m) => /* @__PURE__ */ a(Xt, { value: m, children: g(m, e) }, m))
            }
          )
        ]
      }
...
function Bh({
  ...
  return /* @__PURE__ */ a(
    le.List,
    {
      "data-slot": "tabs-list",
      "data-variant": e,
      className: f("pr-twp", mu({ variant: e }), t),
      dir: o,
      ...r
    }
  );
