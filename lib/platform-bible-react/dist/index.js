...
import { formatScrRef as Mt, MODIFIER_KEYS as gn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as De, compareScrRefs as Ie, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
    ...
    return /* @__PURE__ */ w("div", { className: "tw-relative tw-max-w-48", children: [
      /* @__PURE__ */ r(
        Ht,
        {
          ...
          onFocus: (g) => {
            var h;
            v(!0), (h = c.onFocus) == null || h.call(c, g);
          },
          onBlur: (g) => {
            var h;
            v(!1), (h = c.onBlur) == null || h.call(c, g);
          },
          ref: p
        }
      ),
      f && l && (s ? /* @__PURE__ */ r(_t, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : i && /* @__PURE__ */ r(zr, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), Qe = Or(void 0);
function ut() {
...
const tn = X.Trigger, Pn = X.Group, ka = X.Portal, Ca = X.Sub, qs = X.RadioGroup;
...
he.displayName = X.Label.displayName;
...
const nt = class D {
  ...
  static fromJSON(e) {
    ...
    let c;
    return i && (c = new Dt(i)), n ? new D(n, a.toString(), l, c) : new D();
  }
  /**
...
function Fa({
  ...
  const i = Array.from({ length: e }, (c, p) => p + 1), l = H(
    (c) => {
      o(c);
    },
    [o]
...
function Ws({
  ...
  const o = W(), [s, i] = P(
    () => Mt(t, "English")
  ), [l, c] = P(""), [p, f] = P(t.book), [v, g] = P(t.chapterNum ?? 0), [h, k] = P(t.book), [S, N] = P(!1), [_, x] = P(S), [M, z] = P(!1), [B, mt] = P(), U = Z(void 0), y = Z(void 0), b = Z(void 0), F = Z(void 0), R = H(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (V, C) => {
    ...
    if (!(!B || !B.chapterNum))
      return B.verseNum ? [B.chapterNum] : Array.from({ length: Pt(h) }, (m, V) => V + 1).filter(
        (m) => {
          var V;
          return (B == null ? void 0 : B.chapterNum) && m.toString().includes((V = B == null ? void 0 : B.chapterNum) == null ? void 0 : V.toString());
        }
      );
  }, [h, B]), lt = q(() => {
    const m = R(s.trim());
    ...
    (m) => {
      ...
      return {
        ...
        const Y = Un[C].toLowerCase(), j = l.length > 0 && /^\d/.test(l) ? (
          // consider edge case where the first character is a digit (e.g. "3JN")
          l.charAt(0) + l.slice(1).replace(/[^a-zA-Z]/g, "").toLowerCase()
        ) : l.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    () => Q.reduce((m, V) => m + V.books.length, 0),
    [Q]
  ), T = H(
    (m) => {
      i(m), c(m), mt(R(m.trim()));
    ...
    i(Mt(t, "English")), c(""), f(t.book), k(t.book);
  }, [t]), gt = H((m) => {
    if (K.current) {
      K.current = !1;
      return;
    ...
    (m, V, C, Y) => {
      if (g(t.book !== m ? 1 : t.chapterNum), V || Pt(m) === -1) {
        e({
          book: m,
          chapterNum: C ?? 1,
          verseNum: Y ?? 1
    ...
    (m) => {
      if (!S)
        ...
        return;
      } else m.key === "ArrowDown" ? (F != null && F.current ? F.current.focus() : b != null && b.current ? b.current.focus() : y.current && y.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === U.current && (N(!1), m.preventDefault(), m.stopPropagation());
      if (document.activeElement === U.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (T(lt ? l + m.key : m.key), z(!0), m.preventDefault()), /^\d$/.test(m.key)) {
          const V = s;
          if (M)
            T(l + m.key);
          else {
    ...
    gn.has(m.key) || (m.key === "Tab" && m.shiftKey && (U.current.focus(), m.preventDefault()), m.stopPropagation(), U.current.focus(), U.current.dispatchEvent(new KeyboardEvent("keydown", { ...m, view: void 0 })));
  }, []), Er = H(
    (m) => {
      const { key: V } = m;
      Nn.has(V) || (ae(m), m.preventDefault());
    },
    [ae]
  ), Vr = H((m) => {
    const { key: V } = m;
    V === "ArrowUp" && (m.preventDefault(), U.current.focus());
  }, []), Dr = H(
    (m, V) => {
      const { key: C } = m;
      if (Nn.has(C)) {
        if (h === p || tt === 1) {
          const j = tt === 1 ? h : p;
          if (C === "Enter") {
            m.preventDefault(), ot(j, !0, v);
            return;
          }
          const Rt = C === "ArrowRight" && !o || C === "ArrowRight" && o === "ltr" || C === "ArrowLeft" && o === "rtl", oe = C === "ArrowLeft" && !o || C === "ArrowLeft" && o === "ltr" || C === "ArrowRight" && o === "rtl", Ee = Array.from(
            { length: Pt(h) },
            (se, Et) => Et + 1
          ), it = p !== h || tt === 1 ? $ ?? Ee : Ee, dt = it.indexOf(v);
          let yt = v;
          if (Rt)
            ...
            const se = it[dt] + xn, Et = it.find((Ve) => Ve >= se);
            Et !== void 0 && (yt = Et);
          } else if (C === "ArrowUp") {
            const se = it[dt] - xn, Et = it.slice().reverse().find((Ve) => Ve <= se);
            Et !== void 0 && (yt = Et);
          }
          if (yt !== v) {
            g(yt), m.preventDefault();
            return;
          }
        }
        if (V === 0 && C === "ArrowUp" && !xt) {
          m.preventDefault(), U.current.focus();
          return;
        }
        return;
      }
  ...
  return ct(() => {
    tt === 1 ? g(1) : p === h ? p === t.book ? g(t.chapterNum) : g(1) : g(0);
  }, [h, t.book, t.chapterNum, p, tt]), ct(() => {
    if (!$ || tt > 1) return;
    $.indexOf(v) === -1 && g($[0]);
  }, [h, v, p, $, tt]), ct(() => {
    et();
  ...
  }, [_, et]), /* @__PURE__ */ w(ue, { modal: !1, open: S, onOpenChange: gt, children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ r(
      ya,
      {
        ...
        handleKeyDown: Rr,
        handleOnClick: () => {
          f(t.book), k(t.book), g(t.chapterNum > 0 ? t.chapterNum : 0), U.current.focus();
        },
        onFocus: () => {
    ...
    tt > 0 && /* @__PURE__ */ r(
      ne,
      {
        ...
        children: /* @__PURE__ */ w("div", { className: "rtl:tw-ps-2", children: [
          ...
          Q.map((m, V) => /* @__PURE__ */ w("div", { children: [
            /* @__PURE__ */ r(he, { className: "tw-font-semibold tw-text-foreground/80", children: ja[m.bookType] }),
            m.books.map((C, Y) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Ia,
              {
                bookId: C,
                handleSelectBook: () => ot(C, !1),
                shouldExpandChildren: p.toLowerCase() === C.toLowerCase() || tt === 1,
                ...
                children: /* @__PURE__ */ r(
                  Fa,
                  {
                    ...
                    highlightedChapter: p === h || tt === 1 ? v : 0,
...
), J = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Dn.Root, { ref: n, className: d("pr-twp", La(), t), ...e }));
...
const Ha = ft.Portal, Kn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
Ya.displayName = ft.Content.displayName;
...
Ua.displayName = ft.Title.displayName;
...
Ka.displayName = ft.Description.displayName;
...
ve.displayName = rt.Input.displayName;
...
xe.displayName = rt.List.displayName;
const ye = u.forwardRef((t, e) => /* @__PURE__ */ r(rt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ye.displayName = rt.Empty.displayName;
...
Ne.displayName = rt.Item.displayName;
function qa(t) {
...
function Ge({
  ...
  const [N, _] = P(!1);
  return /* @__PURE__ */ w(fe, { open: N, onOpenChange: _, ...S, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ w(be, { children: [
          /* @__PURE__ */ r(ve, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(ye, { children: v }),
          /* @__PURE__ */ r(xe, { children: e.map((x) => /* @__PURE__ */ w(
            Ne,
            {
              value: l(x),
              onSelect: () => {
...
function Qs({
  ...
  const f = Me(p, "%webView_bookSelector_currentBook%"), v = Me(p, "%webView_bookSelector_choose%"), g = Me(p, "%webView_bookSelector_chooseBooks%"), [h, k] = P(
    "current book"
    /* CURRENT_BOOK */
  ), S = (N) => {
    k(N), t(N);
...
function Za({ table: t }) {
  return /* @__PURE__ */ w(ue, { children: [
    /* @__PURE__ */ r(la, { asChild: !0, children: /* @__PURE__ */ w(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const jt = L.Root, Qa = L.Group, Xt = L.Value, to = St(
  ...
  return /* @__PURE__ */ w(
    L.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(L.Icon, { asChild: !0, children: /* @__PURE__ */ r(ce, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
eo.displayName = L.Label.displayName;
...
no.displayName = L.Separator.displayName;
function ro({ table: t }) {
...
function so({
  ...
  var N;
  const [l, c] = P([]), [p, f] = P([]), [v, g] = P({}), [h, k] = P({}), S = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ w(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: S.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.map((x) => /* @__PURE__ */ r(te, { children: x.isPlaceholder ? void 0 : Jt(x.column.columnDef.header, x.getContext()) }, x.id)) }, _.id)) }),
      /* @__PURE__ */ r(_e, { children: (N = S.getRowModel().rows) != null && N.length ? S.getRowModel().rows.map((_) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(_, S),
...
function io({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
...
function ri({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ w(ue, { children: [
    /* @__PURE__ */ r(tn, { asChild: !0, children: /* @__PURE__ */ w(I, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((a) => /* @__PURE__ */ w("div", { children: [
      ...
      /* @__PURE__ */ r(Pn, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(en, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(jn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Ft, {})
    ] }, a.label)) })
  ] }) });
}
function ai({
  ...
  }).format(Object.values(n).reduce((f, v) => f + v, 0)), p = () => {
  ...
  return /* @__PURE__ */ w(
    "div",
    {
      ...
      children: [
        ...
        (o || i) && /* @__PURE__ */ w("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          o && /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ w(
            I,
            {
              onClick: () => s(),
              variant: "link",
...
function lo({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const c = new Date(l), p = new Date(o.getTime() - c.getTime()), f = p.getUTCFullYear() - 1970, v = p.getUTCMonth(), g = p.getUTCDate() - 1;
    let h = "";
...
function po({
  ...
  const [v, g] = P(!1), h = H(
    ...
    const N = t.filter((x) => x.starred).sort((x, M) => x.label.localeCompare(M.label)), _ = t.filter((x) => !x.starred).sort((x, M) => {
      const z = n.includes(x.value), B = n.includes(M.value);
      return z && !B ? -1 : !z && B ? 1 : x.label.localeCompare(M.label);
    });
    return [...N, ..._];
  }, [t, n, c]);
  return /* @__PURE__ */ r("div", { className: f, children: /* @__PURE__ */ w(fe, { open: v, onOpenChange: g, children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ w(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(re, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ w(be, { children: [
...
function si({
  ...
  return /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((g) => {
      var h;
      return /* @__PURE__ */ w(le, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          I,
          {
            variant: "ghost",
...
function uo({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = q(() => {
    const i = [];
    return t.forEach((l) => {
      i.some((c) => Ze(c, l)) || i.push(l);
    }), i;
  }, [t]);
  return /* @__PURE__ */ w(ke, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ce, { stickyHeader: !0, children: /* @__PURE__ */ w(Ct, { children: [
      /* @__PURE__ */ r(te, { children: a }),
      /* @__PURE__ */ r(te, { children: o })
    ] }) }),
    /* @__PURE__ */ r(_e, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ w(
      Ct,
      {
        onClick: () => {
          e(i.reference);
...
const Se = (t) => t === "asc" ? /* @__PURE__ */ r(Jr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Wr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Zr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ii = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ w(I, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Se(e.getIsSorted())
  ] })
}), ho = (t, e) => ({
  ...
  header: ({ column: n }) => /* @__PURE__ */ w(I, { variant: "ghost", onClick: () => n.toggleSorting(void 0), children: [
    t,
    Se(n.getIsSorted())
  ] })
}), wi = (t) => ({
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ w(I, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    Se(e.getIsSorted())
  ] }) }),
  ...
  accessorKey: "status",
  header: ({ column: s }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-center", children: /* @__PURE__ */ w(I, { variant: "ghost", onClick: () => s.toggleSorting(void 0), children: [
    t,
    Se(s.getIsSorted())
  ] }) }),
  cell: ({ row: s }) => {
  ...
  return e ? e[1] : "";
}, fo = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ui = Object.freeze([
...
function mi({
  ...
  const p = bt(n, "%webView_inventory_all%"), f = bt(n, "%webView_inventory_approved%"), v = bt(n, "%webView_inventory_unapproved%"), g = bt(n, "%webView_inventory_unknown%"), h = bt(n, "%webView_inventory_scope_currentBook%"), k = bt(n, "%webView_inventory_scope_chapter%"), S = bt(n, "%webView_inventory_scope_verse%"), N = bt(n, "%webView_inventory_filter_text%"), _ = bt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, M] = P(!1), [z, B] = P("all"), [mt, U] = P(""), [y, b] = P([]), F = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), R = q(() => {
    if (x) return F;
    const T = [];
    return F.forEach((K) => {
  ...
  return /* @__PURE__ */ w("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ w("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ w(jt, { onValueChange: (T) => Tt(T), defaultValue: i, children: [
...
const nr = u.forwardRef(
  ({
    ...
    const [p, f] = u.useState(t), v = e ?? p, g = u.useCallback(
      ...
      [n, v]
    ), h = u.useCallback(() => g((M) => !M), [g]), k = v ? "expanded" : "collapsed", _ = W() === "ltr" ? i : i === "primary" ? "secondary" : "primary", x = u.useMemo(
      () => ({
        state: k,
        open: v,
        setOpen: g,
...
const Ro = St(
  ...
  ({
    ...
    const c = t ? $t : "button", { state: p } = Re(), f = /* @__PURE__ */ r(
      c,
      {
        ref: l,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(un, { asChild: !0, children: f }),
    ...
    rr,
    {
      ...
      children: /* @__PURE__ */ w(or, { children: [
        /* @__PURE__ */ w($e, { children: [
          ...
          /* @__PURE__ */ r(He, { children: /* @__PURE__ */ r(sr, { children: Object.entries(e).map(([g, h]) => /* @__PURE__ */ r(ir, { children: /* @__PURE__ */ r(
            wr,
            {
              onClick: () => p(g),
              isActive: v(g),
...
const Nt = "scrBook", Ao = "scrRef", Ot = "source", Po = "details", Io = "Scripture Reference", Fo = "Scripture Book", dr = "Type", jo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
const Go = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Ie(t.start, t.end) === 0 ? `${Oe(t.start)}+${e}` : `${Oe(t.start)}+${e}-${Oe(t.end)}+${n}`;
...
function fi({
  ...
  const [c, p] = P([]), [f, v] = P([{ id: Nt, desc: !1 }]), [g, h] = P({}), k = q(
  ...
  ct(() => {
    if (l) {
      ...
      if (b.length === 1) {
        const F = k.find((R) => Sn(R) === b[0]) || void 0;
        F && l(F);
      }
    }
  }, [g, k, l, N]);
  const _ = o ?? Fo, x = s ?? dr, M = [
  ...
  }, mt = (y, b) => y.getIsGrouped() ? "" : d("banded-row", b % 2 === 0 ? "even" : "odd"), U = (y, b, F) => {
    if (!((y == null ? void 0 : y.length) === 0 || b.depth < F.column.getGroupedIndex())) {
      if (b.getIsGrouped())
        switch (b.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ w(
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(At, { position: "item-aligned", children: /* @__PURE__ */ r(Qa, { children: M.map((y) => /* @__PURE__ */ r(wt, { value: JSON.stringify(y.value), children: y.label }, y.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ w(ke, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ce, { children: N.getHeaderGroups().map((y) => /* @__PURE__ */ r(Ct, { children: y.headers.filter((b) => b.column.columnDef.header).map((b) => (
      ...
      /* @__PURE__ */ r(_e, { children: N.getRowModel().rows.map((y, b) => {
        const F = W();
        return /* @__PURE__ */ r(
          Ct,
          {
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: o && ((l = o.get(t)) == null ? void 0 : l.localizedName) || O.bookIdToEnglishName(t)
          }
        ),
...
function Uo({
  ...
  const z = q(() => O.allBookIds.filter(
    ...
    (b, F = !1) => {
      ...
      const R = z.findIndex((Q) => Q === x.current), $ = z.findIndex((Q) => Q === b);
      if (R === -1 || $ === -1) return;
      const [lt, xt] = [
        Math.min(R, $),
        Math.max(R, $)
      ...
      n(
        e.includes(b) ? e.filter((Q) => !Tt.includes(Q)) : [.../* @__PURE__ */ new Set([...e, ...Tt])]
      );
    },
    [e, n, z]
  ), mt = H(
    (b) => {
      const F = mn(z, b).map((R) => R);
      n(
        cr(z, b, e) ? e.filter((R) => !F.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, z]
  ), U = () => {
  ...
  return /* @__PURE__ */ w("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ w(fe, { open: N, onOpenChange: _, children: [
      /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ w(
        I,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(re, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ w(
        be,
        {
          onKeyDown: (b) => {
            b.key === "Enter" && (M.current = b.shiftKey);
          },
          children: [
            /* @__PURE__ */ r(ve, { placeholder: l }),
            /* @__PURE__ */ w("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              ...
              /* @__PURE__ */ r(I, { variant: "ghost", size: "sm", onClick: y, children: p })
            ] }),
            /* @__PURE__ */ w(xe, { children: [
              /* @__PURE__ */ r(ye, { children: f }),
              Object.values(kt).map((b, F) => {
                const R = z.filter(
                  ($) => It($) === b
                );
                if (R.length !== 0)
    ...
    e.length > 0 && /* @__PURE__ */ w("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var F;
        return /* @__PURE__ */ r(le, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((F = o.get(b)) == null ? void 0 : F.localizedName) || O.bookIdToEnglishName(b) || b }, b);
      }),
...
function bi({
  ...
  const c = Vt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), v = Vt(i, "%webView_scope_selector_current_book%"), g = Vt(i, "%webView_scope_selector_choose_books%"), h = Vt(i, "%webView_scope_selector_scope%"), k = Vt(i, "%webView_scope_selector_select_books%"), S = [
    ...
    /* @__PURE__ */ w("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: N.map(({ value: _, label: x, id: M }) => /* @__PURE__ */ w("div", { className: "tw-flex tw-items-center", children: [
...
const ur = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(un, { asChild: !0, children: "command" in l ? /* @__PURE__ */ w(
    me,
    {
      ...
      children: [
        l.iconPathBefore && /* @__PURE__ */ r(de, { icon: l.iconPathBefore, menuLabel: l.label, leading: !0 }),
        l.label,
        l.iconPathAfter && /* @__PURE__ */ r(de, { icon: l.iconPathAfter, menuLabel: l.label })
      ]
    },
    `dropdown-menu-item-${l.label}-${l.command}`
  ) : /* @__PURE__ */ w(Ca, { children: [
    /* @__PURE__ */ r(In, { children: l.label }),
...
function Rn({
  ...
  return /* @__PURE__ */ w(ue, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, c]) => typeof l == "boolean" || typeof c == "boolean" ? 0 : l.order - c.order).map(([l], c, p) => /* @__PURE__ */ w(En, { children: [
      /* @__PURE__ */ r(Pn, { children: /* @__PURE__ */ r(cn, { children: ur(e.groups, e.items, l, t) }) }),
...
Wo.displayName = G.CheckboxItem.displayName;
...
Zo.displayName = G.RadioItem.displayName;
...
const Kt = (t, e) => {
  ...
  return o.flatMap(([s], i) => {
    const l = e.filter((p) => p.group === s).sort((p, f) => p.order - f.order).map((p) => /* @__PURE__ */ w(pn, { children: [
...
function ts({
  ...
  const o = Z(void 0), s = Z(void 0), i = Z(void 0), l = Z(void 0), c = Z(void 0), p = (f) => {
    switch (f) {
      case "platform.app":
        return s;
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (f, v) => {
    var k, S, N, _;
    f.preventDefault();
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (k = s.current) == null || k.focus(), Kt(s, [g, h]);
        break;
      case "alt+l":
        (S = i.current) == null || S.focus(), Kt(i, [g, h]);
        break;
      case "alt+n":
        (N = l.current) == null || N.focus(), Kt(l, [g, h]);
        break;
      case "alt+h":
        (_ = c.current) == null || _.focus(), Kt(c, [g, h]);
        break;
    }
  }), ct(() => {
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, f]) => typeof f == "object").sort(([, f], [, v]) => typeof f == "boolean" || typeof v == "boolean" ? 0 : f.order - v.order).map(([f, v]) => /* @__PURE__ */ w(qo, { children: [
      /* @__PURE__ */ r(br, { ref: p(f), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        yr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(cn, { children: Cr(t.groups, t.items, f, e) })
        }
      )
    ] }, f)) });
}
...
function Ti({
  ...
  const c = es(
    ...
    var N, _, x, M, z, B;
    const S = k !== h ? ((_ = (N = t[h]) == null ? void 0 : N.uiNames) == null ? void 0 : _[k]) ?? ((M = (x = t[h]) == null ? void 0 : x.uiNames) == null ? void 0 : M.en) : void 0;
    return S ? `${(z = t[h]) == null ? void 0 : z.autonym} (${S})` : (B = t[h]) == null ? void 0 : B.autonym;
  };
      ...
      jt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((h) => /* @__PURE__ */ r(wt, { value: h, children: g(h, e) }, h))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ w(Ye, { children: [
...
const rs = Ue(({ className: t, ...e }, n) => /* @__PURE__ */ r(sa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
ws.displayName = Lt.Root.displayName;
...
ls.displayName = Lt.Image.displayName;
...
ds.displayName = Lt.Fallback.displayName;
...
const Vi = pt.Trigger, bs = pt.Portal, Di = pt.Close, Sr = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
Ns.displayName = pt.Title.displayName;
...
ks.displayName = pt.Description.displayName;
...
Cs.displayName = je.Root.displayName;
function Oi({ ...t }) {
  return /* @__PURE__ */ r(
    va,
    {
...
Ss.displayName = Xe.Root.displayName;
const Mi = at.Root, Ts = u.forwardRef(({ className: t, ...e }, n) => {
  const a = W();
  return /* @__PURE__ */ r(
    at.List,
    {
...
Ts.displayName = at.List.displayName;
...
Rs.displayName = at.Trigger.displayName;
...
Es.displayName = at.Content.displayName;
