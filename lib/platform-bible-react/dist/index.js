...
function Fd({
  ...
  const r = Ht(void 0), o = Ht(void 0), a = Ht(void 0), s = Ht(void 0), l = (c) => {
    switch (c) {
  ...
  if (Xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, d) => {
    var w, h, b, m;
    c.preventDefault();
    const p = { key: "Escape", code: "Escape", keyCode: 27, bubbles: !0 }, f = { key: " ", code: "Space", keyCode: 32, bubbles: !0 };
    switch (d.hotkey) {
      case "alt":
        cn(r, [p]);
        break;
      case "alt+p":
        (w = r.current) == null || w.focus(), cn(r, [p, f]);
        break;
      case "alt+l":
        (h = o.current) == null || h.focus(), cn(o, [p, f]);
        break;
      case "alt+n":
        (b = a.current) == null || b.focus(), cn(a, [p, f]);
        break;
      case "alt+h":
        (m = s.current) == null || m.focus(), cn(s, [p, f]);
        break;
    }
  }), !!t)
    return /* @__PURE__ */ i(is, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c, d]) => /* @__PURE__ */ N(Ad, { children: [
      /* @__PURE__ */ i(ss, { ref: l(c), children: typeof d == "object" && "label" in d && d.label }),
      /* @__PURE__ */ i(ds, { children: ws(t.groups, t.items, c, e) })
    ] }, c)) });
}
function Ch(t) {
  switch (t) {
...
function Of(t) {
  ...
  if (P) {
    ...
    if (l) {
      var ue, Tt = S === "x" ? Ot : _t, Bn = S === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", we = Yt + g[Tt], Pe = Yt - g[Bn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Yt - F[_e] - R[_e] - $e + L.altAxis, en = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Vn = h && Ie ? Zw(fe, Yt, en) : yn(h ? fe : we, Yt, h ? en : Pe);
      P[v] = Vn, tt[v] = Vn - Yt;
    }
...
const Hs = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Ho({
    ...
    children: R
  }), Xt = Xs(), ue = Xt.direction === "rtl", [Tt, Bn] = B.useState(), [Yt, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = mn(), $e = mn(), fe = mn(), en = mn(), [Vn, na] = Ns({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
