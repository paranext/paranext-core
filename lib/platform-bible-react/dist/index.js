...
import u, { forwardRef as He, useState as P, createContext as Or, useContext as Mr, useCallback as U, useRef as Q, useMemo as q, useEffect as dt, useLayoutEffect as fn, Fragment as En } from "react";
...
import { formatScrRef as Ot, MODIFIER_KEYS as gn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Je, isString as Ee, compareScrRefs as Ae, scrRefToBBBCCCVVV as De, getLocalizeKeyForScrollGroupId as I } from "platform-bible-utils";
...
const Ze = G.Trigger, In = G.Group, ka = G.Portal, Ca = G.Sub, qs = G.RadioGroup;
...
function Ws({
      ...
      if (m.trim())
        return yn.reduce(
          (E, N) => {
            ...
            const j = N.exec(m);
            if (j) {
              const [F, ut = void 0, ae = void 0] = j.slice(1), st = kn(F) ?? (M.isBookIdValid(F) ? F.toLocaleUpperCase() : void 0);
              if (st) {
                const wt = ut ? parseInt(ut, 10) : void 0;
                if (wt && wt > It(st)) return;
                const xt = ae ? parseInt(ae, 10) : void 0;
                return {
                  book: st,
                  chapterNum: wt,
                  verseNum: xt
    ...
    (m, E) => {
      ...
      if (Nn.has(N)) {
        if (h === p || C === 1) {
          ...
          const ut = N === "ArrowRight" && !o || N === "ArrowRight" && o === "ltr" || N === "ArrowLeft" && o === "rtl", ae = N === "ArrowLeft" && !o || N === "ArrowLeft" && o === "ltr" || N === "ArrowRight" && o === "rtl", Te = Array.from(
            { length: It(h) },
            (oe, Rt) => Rt + 1
          ), st = p !== h || C === 1 ? K ?? Te : Te, wt = st.indexOf(v);
          let xt = v;
          if (ut)
  ...
  }, [y, tt]), /* @__PURE__ */ l(pe, { modal: !1, open: T, onOpenChange: vt, children: [
...
function Qs({
  ...
  const g = Ve(p, "%webView_bookSelector_currentBook%"), v = Ve(p, "%webView_bookSelector_choose%"), f = Ve(p, "%webView_bookSelector_chooseBooks%"), [h, _] = P(
    "current book"
    /* CURRENT_BOOK */
  ), T = (k) => {
    _(k), t(k);
...
function ei({ id: t, label: e, groups: n }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(pe, { children: [
    ...
    /* @__PURE__ */ r(ne, { children: n.map((a) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(In, { children: a.items.map((o) => /* @__PURE__ */ r("div", { children: o.itemType === 0 ? /* @__PURE__ */ r(Qe, { onClick: o.onClick, children: o.label }) : /* @__PURE__ */ r(jn, { onClick: o.onClick, value: o.label, children: o.label }) }, o.label)) }),
      /* @__PURE__ */ r(Ft, {})
    ] }, a.label)) })
  ] }) });
}
...
const Ro = St(
  ...
  ({
    ...
    const c = t ? $t : "button", { state: p } = Se(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
