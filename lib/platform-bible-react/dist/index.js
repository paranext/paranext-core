...
import { c as b, g as Re, a as zr, C as qe, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, D as Ie, f as ke, h as ze, i as kr, j as Be, B as J, x as fs, k as ms, l as vs, I as bs, m as _o, n as Ke, r as Ce, o as xs, p as Kn, P as tr, q as _r, s as er, t as rr, v as Na, w as Ca, y as No, z as ar, E as Ea, F as Mt, R as Co, G as ga, H as ro, J as ao, K as oo, M as no, N as Hn, O as na, Q as Eo, S as Vr, U as Lr, V as pr, W as ys, X as Ze, Y as Ue, Z as Pe, _ as je, $ as hr, a0 as To, a1 as So, a2 as fa, a3 as Ro, a4 as Gn, a5 as ks, a6 as _s, a7 as Ns, a8 as io, a9 as qn, aa as Ta, ab as Cs, ac as Yn, ad as Es, ae as Ts, af as Ss, ag as Qo, ah as Rs, ai as Ds, aj as Ms, ak as Wn, al as Xn, am as Do, an as Os, ao as Jn, ap as Ba, aq as tn, ar as ja, as as Is, at as zs, au as Ps, av as As, aw as $s, ax as Fr, ay as Mo, az as Vs, aA as Ls } from "./resizable-ClhVX69h.js";
...
import { Avatar as $o, Select as Zt, Checkbox as un, Slot as Gr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
...
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as Ul, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as Kl, defaultStyleInfo as Hl, Editorial as Gl } from "@eten-tech-foundation/platform-editor";
...
function Ha({
  ...
  const T = Ce(), B = Ql(), [z, D] = _(!1), [M, Y] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [G, it] = _(
    void 0
  ...
  const Qt = j(() => {
    ...
    (v) => {
      const H = G ?? (A == null ? void 0 : A.book), at = ot ?? (A == null ? void 0 : A.chapterNum);
      !H || !at || (ft({
        book: H,
        chapterNum: at,
        verseNum: v
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => {
      ...
      if (v.key === "Tab") {
        ...
        const de = $t[$t.length - 1], qt = v.shiftKey ? $t[0] : de;
        document.activeElement === qt && (v.preventDefault(), v.stopPropagation(), (v.shiftKey ? de : $t[0]).focus());
        return;
      }
      ...
      if (N === "books" && !Ht && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const $t = H === gt.current ? gt.current : void 0, de = ($t == null ? void 0 : $t.selectionStart) ?? 0, qt = ($t == null ? void 0 : $t.selectionEnd) ?? 0, he = T === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!$t && (de !== qt || (he ? de > 0 : qt < $t.value.length))) return;
      }
      if (v.shiftKey || N === "books" && H !== gt.current && (H != null && H.closest('button, a, [role="button"]')))
        return;
      const yt = (() => {
        const $t = N === "books" && A && be && A.chapterNum ? { bookId: A.book, chapterNum: A.chapterNum } : void 0, de = N === "verses" ? { bookId: G, chapterNum: ot } : $t;
        if (de) {
        ...
        if (N === "chapters" || N === "books" && A && Le(A.book) > 1) {
          const qt = N === "chapters" ? O : A == null ? void 0 : A.book;
          return qt ? {
            max: Le(qt),
            current: Ir(M) ?? 0,
            buildValue: (he) => gr(qt, he),
            refs: Rt,
              ...
              N === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Ca, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: q.map(
...
function Vd(t) {
  ...
  if (_e(e)) r = Hc(e.focus, "next");
    ...
    r = r || Gc(Ge(), "previous").getFlipped().insert(Hr());
  }
...
function rs({
  ...
  const R = j(
    ...
    async (y) => {
      const q = we(U) ? ka(U) : void 0, $ = y.status ? y.assignedUser : N ?? y.assignedUser, et = await p({
        ...y,
        contents: q,
        assignedUser: $
      });
      return et && ($ !== void 0 && I($), q && se()), et;
    },
    [se, U, p, N]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: wt ? /* @__PURE__ */ a(qs, {}) : /* @__PURE__ */ a(Ys, {})
              }
            ),
            M === void 0 ? (
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Gw, { ...G, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...G })
          },
          I.id
        );
      })
...
function Nh({
  ...
  const [g, S] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, Y] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [G, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const xt = j(() => {
    var y, q, $;
    const R = (y = f.current) == null ? void 0 : y.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), X = ($ = (q = f.current) == null ? void 0 : q.ownerDocument.getSelection()) == null ? void 0 : $.anchorNode;
  ...
  const Gt = j(
    ...
    (R, K) => {
      var q, $, et;
      const X = ($ = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : $.at(0);
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      const nt = ($ = (q = K.insert.note) == null ? void 0 : q.contents) == null ? void 0 : $.ops;
    ...
    (R) => {
      ...
      if (K && Dr("note", K)) {
        ...
        const nt = (q = K.insert.note) == null ? void 0 : q.style, ct = (et = ($ = K.insert.note) == null ? void 0 : $.contents) == null ? void 0 : et.ops;
        if (nt || Y(!1), Y(
    ...
    (R) => {
      ...
      Ss(R, K, {
        ...
        commitTypedAndReopen: (y) => {
          var q;
          (q = h.current) == null || q.commitTypedMarker(y, { trailingSpace: !1 }), A();
        },
        commitTypedCloser: (y) => {
          var q;
  ...
  W(() => {
    ...
    const R = () => {
      ...
      X && !X.isCollapsed || xt() || ((q = h.current) == null || q.selectNote(0), ($ = h.current) == null || $.focus());
    };
...
function zh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Su(O, D, Y), [O, D, Y]), G = V(() => {
    var vt, pt;
    if (!B) return l;
...
function Lu({
  ...
  const c = t ? Gr.Root : "button", { state: l } = Ia(), d = /* @__PURE__ */ a(
    c,
    {
...
function Jh({
  ...
  const T = Bt(
  ...
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, R] = _(!1), [K, X] = _(void 0), [y, q] = _(void 0), [$, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    Zu,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: b(Cr && nr), children: G }),
      /* @__PURE__ */ a(
        Ha,
        {
  ...
  const [sr, Aa] = _(null), [Se, cr] = _(null), [lr, $a] = _(null), qr = 200, [Va, Yr] = _(!1);
  W(() => {
    if (!lr || typeof ResizeObserver > "u") return;
    const L = new ResizeObserver(([Q]) => {
      Yr(Q.contentRect.width < qr);
    });
  ...
  const Wr = j(
    ...
    y !== void 0 && (y === "range" ? ($ && (m == null || m($)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), q(void 0));
  }, [
    y,
    $,
    nt,
                ...
                /* @__PURE__ */ a(
                  Be,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      Gt.current || (At = (Q = bt.current) == null ? void 0 : Q.querySelector("button")) == null || At.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
