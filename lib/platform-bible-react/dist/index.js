...
var Za = (t, e, n) => e in t ? Ja(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var ft = (t, e, n) => Za(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as d, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as Qe, useRef as J, useMemo as z, useState as I, useCallback as G, useLayoutEffect as zt, createContext as xn, useContext as cr, useEffect as H, Component as Qa, createElement as Mr, Suspense as ts, createRef as es, Fragment as ao } from "react";
import { Command as gt } from "cmdk";
import { X as Oe, Search as so, Check as Rt, Clock as Or, ChevronsLeft as Ir, ChevronsRight as Ar, ChevronLeft as qn, ChevronRight as Ce, ArrowLeft as ns, ArrowRight as rs, Circle as yn, ChevronDown as Ie, BoldIcon as os, ItalicIcon as as, UnderlineIcon as ss, StrikethroughIcon as is, AtSign as io, Pencil as ls, Trash2 as ws, ArrowUp as lo, MoreHorizontal as wo, MailOpen as cs, Mail as ds, ChevronUp as co, FilterIcon as ps, ArrowLeftIcon as us, ChevronLeftIcon as ms, ChevronRightIcon as fs, ArrowRightIcon as hs, Copy as po, Filter as gs, User as bs, Link as vs, CircleHelp as xs, ChevronsUpDown as uo, Star as ys, SquareX as mo, FunctionSquare as fo, SquareSigma as ho, AlertCircle as Hn, CircleCheckIcon as Ns, CircleXIcon as ks, CircleHelpIcon as _s, ArrowUpIcon as Cs, ArrowDownIcon as Es, ArrowUpDownIcon as Ts, PanelLeft as Rs, PanelRight as Ss, ScrollText as Ds, MenuIcon as Ms, Menu as Os, EllipsisVertical as Is, LoaderCircle as As, GripVertical as Ps } from "lucide-react";
...
import { includes as an, Section as U, getChaptersForBook as Vs, formatScrRef as fe, getSectionForBook as Ge, formatRelativeDate as js, formatReplacementString as me, sanitizeHtml as zs, NumberFormat as Fs, formatBytes as Bs, getCurrentLocale as Gs, getFormatCallerFunction as Ks, deepEqual as Us, isString as Pr, compareScrRefs as Yn, scrRefToBBBCCCVVV as In, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as bo, $getRoot as te, $createParagraphNode as Nn, $getSelection as Ft, HISTORY_MERGE_TAG as dr, ParagraphNode as vo, TextNode as xo, $isTokenOrSegmented as qs, $getCharacterOffsets as Hs, $cloneWithPropertiesEphemeral as Ys, $findMatchingParent as Xs, $isElementNode as he, CLEAR_EDITOR_COMMAND as yo, COMMAND_PRIORITY_EDITOR as No, $isRangeSelection as Xe, mergeRegister as ee, shallowMergeConfig as Ws, defineExtension as Gt, safeCast as tn, RootNode as Js, LineBreakNode as Zs, TabNode as Qs, $isEditorState as ti, createCommand as ei, CLICK_COMMAND as ni, isDOMNode as ri, $getNodeFromDOMNode as oi, $isNodeSelection as ai, $createNodeSelection as si, $setSelection as ii, COMMAND_PRIORITY_LOW as li, DecoratorNode as wi, addClassNamesToElement as ko, $create as ci, $getNodeByKey as di, removeClassNamesFromElement as pi, KEY_TAB_COMMAND as ui, $isBlockElementNode as un, $createRangeSelection as mi, $normalizeSelection__EXPERIMENTAL as fi, OUTDENT_CONTENT_COMMAND as hi, INDENT_CONTENT_COMMAND as $r, INSERT_TAB_COMMAND as gi, COMMAND_PRIORITY_CRITICAL as pr, $isDecoratorNode as bi, $isParagraphNode as vi, $isTextNode as mn, SELECTION_CHANGE_COMMAND as _o, FORMAT_TEXT_COMMAND as xi, getRegisteredNode as yi, isHTMLElement as Ni, isDocumentFragment as Lr, isDOMDocumentNode as ki, ArtificialNode__DO_NOT_USE as Co, $createLineBreakNode as Eo, $isRootOrShadowRoot as _i, isBlockDomNode as Vr, isInlineDomNode as jr, $insertNodes as Ci } from "lexical";
import * as en from "@radix-ui/react-tooltip";
import { TooltipTrigger as Ei } from "@radix-ui/react-tooltip";
import { HeadingNode as Ti, QuoteNode as Ri, registerRichText as Si } from "@lexical/rich-text";
...
import * as To from "@radix-ui/react-toggle";
...
import { useReactTable as Do, getFilteredRowModel as Ai, getSortedRowModel as Mo, getPaginationRowModel as Pi, getCoreRowModel as Oo, flexRender as Ke, getGroupedRowModel as $i, getExpandedRowModel as Li } from "@tanstack/react-table";
...
const Ui = Tt.Root, qi = Tt.Portal, Io = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Overlay,
  {
    ref: n,
    className: f(
...
Ao.displayName = Tt.Content.displayName;
...
$o.displayName = Tt.Title.displayName;
...
Hi.displayName = Tt.Description.displayName;
...
$e.displayName = gt.Input.displayName;
...
Ut.displayName = gt.List.displayName;
const nn = b.forwardRef((t, e) => /* @__PURE__ */ r(gt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
...
Bt.displayName = gt.Group.displayName;
...
Lo.displayName = gt.Separator.displayName;
...
Pt.displayName = gt.Item.displayName;
...
const zo = ot.allBookIds.filter(
  (t) => !ot.isObsolete(ot.bookIdToNumber(t))
), ge = Object.fromEntries(
  zo.map((t) => [t, ot.bookIdToEnglishName(t)])
);
function fr(t, e, n) {
...
const Fo = Qe(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Ae : "button", { className: f(Xi({ variant: e, size: n, className: t })), ref: s, ...a })
);
V.displayName = "Button";
const oe = Ee.Root, ae = Ee.Trigger, Gd = Ee.Anchor, qt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = wt();
...
function tr(t, e, n) {
  return `${t} ${ge[t]}${e ? ` ${mr(t, e)} ${_e(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function Wi({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(oe, { open: c, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(qt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(Bt, { heading: s, children: t.map((m) => /* @__PURE__ */ d(
      Pt,
      {
        onSelect: () => p(m),
...
function Kd(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
  ...
  const o = Ji.reduce(
    (a, s) => {
      ...
      if (i) {
        ...
        if (!p && c) {
          const u = ((g) => Object.keys(ge).find(
            (x) => ge[x].toLowerCase() === g.toLowerCase()
          ))(l);
...
function Fr({
  ...
  if (t)
    return /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: It(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Pt,
      {
        value: `${t} ${ge[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Ud({
  ...
  const w = wt(), [p, m] = I(!1), [h, u] = I(""), [g, x] = I(""), [v, y] = I("books"), [N, C] = I(void 0), [S, F] = I(!1), P = J(void 0), k = J(void 0), E = J(void 0), _ = J(void 0), T = J({}), $ = G(
    (A) => {
      e(A), l && l(A);
    },
    [e, l]
  ), L = z(() => o ? o() : zo, [o]), M = z(() => ({
    [U.OT]: L.filter((K) => ot.isBookOT(K)),
    [U.NT]: L.filter((K) => ot.isBookNT(K)),
    [U.DC]: L.filter((K) => ot.isBookDC(K)),
    [U.Extra]: L.filter((K) => ot.extraBooks().includes(K))
  }), [L]), O = z(() => Object.values(M).flat(), [M]), j = z(() => {
    if (!g.trim()) return M;
    const A = {
      [U.OT]: [],
      [U.NT]: [],
    ...
    return [U.OT, U.NT, U.DC, U.Extra].forEach((Y) => {
      A[Y] = M[Y].filter((dt) => fr(dt, g, a));
    }), A;
  }, [M, g, a]), R = z(
    () => Zi(g, O, a),
    [g, O, a]
    ...
    (A) => {
      const K = v === "chapters" ? N : R == null ? void 0 : R.book;
      K && ($({
        book: K,
        chapterNum: A,
        verseNum: 1
    ...
    (A) => {
      ...
      m(A), A && (y("books"), C(void 0), x(""));
    },
    [v, Nt]
  ), { otLong: at, ntLong: ct, dcLong: pt, extraLong: vt } = {
    ...
    (A) => R ? !!R.chapterNum && !A.toString().includes(R.chapterNum.toString()) : !1,
    [R]
  ), Mn = z(
    () => fe(
      t,
    ...
    (A.key === "Home" || A.key === "End") && A.stopPropagation();
  }, []), On = G(
    (A) => {
      if (A.ctrlKey) return;
      const { isLetter: K, isDigit: Y } = zr(A.key);
      if (v === "chapters") {
        if (A.key === "Backspace") {
          A.preventDefault(), A.stopPropagation(), Nt();
          return;
        }
        if (K || Y) {
          if (A.preventDefault(), A.stopPropagation(), y("books"), C(void 0), Y && N) {
            const dt = ge[N];
            x(`${dt} ${A.key}`);
          } else
            x(A.key);
      ...
      if ((v === "chapters" || v === "books" && R) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(A.key)) {
        const dt = v === "chapters" ? N : R == null ? void 0 : R.book;
        if (!dt) return;
        const ut = (() => {
          if (!h) return 1;
          const Jt = h.match(/(\d+)$/);
        ...
        switch (A.key) {
          case "ArrowLeft":
            ut !== 0 && (kt = ut > 1 ? ut - 1 : xt);
            break;
          case "ArrowRight":
            ut !== 0 && (kt = ut < xt ? ut + 1 : 1);
            break;
          case "ArrowUp":
            kt = ut === 0 ? xt : Math.max(1, ut - on);
            break;
          case "ArrowDown":
            kt = ut === 0 ? 1 : Math.min(xt, ut + on);
            break;
          default:
            return;
        }
        kt !== ut && (A.preventDefault(), A.stopPropagation(), u(tr(dt, a, kt)), setTimeout(() => {
    ...
    if (A.shiftKey || A.key === "Tab" || A.key === " ") return;
    const { isLetter: K, isDigit: Y } = zr(A.key);
    (K || Y) && (A.preventDefault(), x((dt) => dt + A.key), k.current.focus(), F(!1));
  }, []);
  return zt(() => {
    const A = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const K = E.current, Y = _.current, dt = Y.offsetTop, ut = K.clientHeight, xt = Y.clientHeight, kt = dt - ut / 2 + xt / 2;
        K.scrollTo({
          top: Math.max(0, kt),
          behavior: "smooth"
        }), u(tr(t.book));
  ...
  }, [v, N, R, t.book, t.chapterNum]), /* @__PURE__ */ d(oe, { open: p, onOpenChange: B, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
      V,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: Mn })
      }
    ) }),
          ...
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            /* @__PURE__ */ d("div", { className: "tw-relative tw-flex-1", children: [
              ...
              i && i.length > 0 && /* @__PURE__ */ r(
                Wi,
                {
                  ...
                  renderItem: (A) => fe(A, "English"),
                  getItemKey: (A) => `${A.book}-${A.chapterNum}-${A.verseNum}`,
                  ariaLabel: s == null ? void 0 : s["%history_recentSearches_ariaLabel%"],
                  groupHeading: s == null ? void 0 : s["%history_recent%"]
                }
              )
            ] }),
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: nt.map(({ onClick: A, disabled: K, title: Y, icon: dt }) => /* @__PURE__ */ r(
              V,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              V,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(ns, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(rs, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: _e(N, a) })
          ] }),
          !S && /* @__PURE__ */ d(Ut, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(st, { children: [
              !R && Object.entries(j).map(([A, K]) => {
                if (K.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Bt, { heading: Xt(A), children: K.map((Y) => /* @__PURE__ */ r(
                      Fo,
                      {
                        bookId: Y,
                        onSelect: (dt) => it(dt),
              ...
              R && /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r(
                Pt,
                {
                  value: `${R.book} ${ge[R.book]} ${R.chapterNum || ""}:${R.verseNum || ""})}`,
                  onSelect: q,
                  ...
                  children: fe(
                    ...
                    a ? mr(R.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              R && It(R.book) > 1 && /* @__PURE__ */ d(st, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: _e(R.book, a) }),
                /* @__PURE__ */ r(
                  Fr,
                  {
                    bookId: R.book,
...
), lt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(go.Root, { ref: n, className: f("pr-twp", tl(), t), ...e }));
...
function er({
  ...
  const [N, C] = I(!1), S = c ?? l, F = (k) => k.length > 0 && typeof k[0] == "object" && "options" in k[0], P = (k, E) => {
    const _ = l(k), T = typeof k == "object" && "secondaryLabel" in k ? k.secondaryLabel : void 0, $ = `${E ?? ""}${_}${T ?? ""}`;
    return /* @__PURE__ */ d(
      Pt,
      {
        value: _,
    ...
    /* @__PURE__ */ r(
      qt,
      {
        ...
        children: /* @__PURE__ */ d(Kt, { children: [
          ...
          /* @__PURE__ */ r(Ut, { children: F(e) ? e.map((k) => /* @__PURE__ */ r(Bt, { heading: k.groupHeading, children: k.options.map((E) => P(E, k.groupHeading)) }, k.groupHeading)) : e.map((k) => P(k)) })
        ] })
      }
    )
  ] });
...
function Yd({
  ...
  const p = Pn(w, "%webView_bookSelector_currentBook%"), m = Pn(w, "%webView_bookSelector_choose%"), h = Pn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), t(v);
...
const Go = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, al = Go ? zt : H, ln = { tag: dr };
function sl({ initialConfig: t, children: e }) {
  const n = z(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: c } = t, w = ol(null, o), p = bo({ editable: t.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Nn();
            u.append(g);
            const x = Go ? document.activeElement : null;
            (Ft() !== null || x !== null && x === m.getRootElement()) && g.select();
          }
        }, ln);
...
const il = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? zt : H;
...
const gr = {
  ...
  mark: "",
  markOverlap: ""
}, Ct = en.Provider, At = en.Root, Vt = en.Trigger, Et = b.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  en.Content,
  {
    ref: o,
    sideOffset: e,
...
const ul = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? zt : H;
function ml(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function fl() {
  return function(t) {
    const [e] = $t(), n = z(() => t(e), [e, t]), [o, a] = I(() => n.initialValueFn()), s = J(o);
    return ul(() => {
...
const Ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Ko && "documentMode" in document ? document.documentMode : null;
!(!Ko || !("InputEvent" in window) || bl) && "getTargetRanges" in new window.InputEvent("input");
function Br(t) {
  const e = Xs(t, (n) => he(n) && !n.isInline());
  return he(e) || gl(4, t.__key), e;
}
...
function pe(t, e) {
  ht.call(this, void 0), this.x = t, this.s = void 0, this.g = dn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function yl(t, e) {
  return new pe(t, e);
}
...
function Nl(t) {
  ...
  qo(this), X = t, this.f &= -2, 8 & this.f && vr(this), _n();
}
function ke(t, e) {
...
ht.prototype.brand = vl, ht.prototype.h = function() {
  return !0;
...
} }), pe.prototype = new ht(), pe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === dn)) return !0;
  if (this.g = dn, this.f |= 1, this.i > 0 && !Uo(this)) return this.f &= -2, !0;
  const t = X;
  try {
    Ur(this), X = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ho(this), Ur(this), Qt++;
  const t = X;
  return X = this, Nl.bind(this, t);
...
Gt({ build: (t, e, n) => Cn(e), config: tn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function Yo() {
  const t = te(), e = Ft(), n = Nn();
  t.clear(), t.append(n), e !== null && n.select(), Xe(e) && (e.format = 0);
}
function Xo(t, e = Yo) {
  return t.registerCommand(yo, (n) => (t.update(e), !0), No);
}
Gt({ build: (t, e, n) => Cn(e), config: tn({ $onClear: Yo }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const rr = Gt({ build: (t) => Wo(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const xr = 0, or = 1, Zo = 2, Ln = 3, wn = 4, Ne = 5, Vn = 6, ze = 7;
function jn(t) {
  return t.id === xr;
}
function Qo(t) {
...
function _l(t) {
  return function(e) {
    return e.id === or;
  }(t) || Z(305, String(t.id), String(or)), Object.assign(t, { id: Zo });
}
...
class El {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== wn && Z(307, String(n.id), String(Ne)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
  ...
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Vn && Z(310, String(n.id), String(Vn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= wn;
    }(e) || Z(313, String(e.id), String(wn)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Ln;
    }(e) || Z(314, String(e.id), String(Ln)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getInitDependency(e) {
    ...
    return n === void 0 && Z(315, this.extension.name, e.name), n.getExtensionInitDependency();
  }
  getDependency(e) {
    const n = this.builder.getExtensionRep(e);
    return n === void 0 && Z(315, this.extension.name, e.name), n.getExtensionDependency();
  }
  getState() {
    const e = this.state;
    return function(n) {
      return n.id >= ze;
    }(e) || Z(316, String(e.id), String(ze)), e;
  }
  ...
  getExtensionDependency() {
    if (!this._dependency) {
      ...
      (function(n) {
        return n.id >= Ne;
      })(e) || Z(317, this.extension.name), this._dependency = { config: e.config, init: e.initResult, output: e.output };
    }
...
const Rl = Gt({ config: tn({ setOptions: qr, updateOptions: qr }), init: ({ $initialEditorState: t = Tl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Js, xo, Zs, Qs, vo] }), Hr = Symbol.for("@lexical/extension/LexicalBuilder");
function Yr() {
}
function Sl(t) {
  throw t;
...
class qe {
  ...
  static maybeFromEditor(e) {
    const n = e[Hr];
    return n && (n.PACKAGE_VERSION !== zn && Z(292, n.PACKAGE_VERSION, zn), n instanceof qe || Z(293)), n;
  }
  static fromEditor(e) {
  ...
  getExtensionRep(e) {
    ...
    if (n) return n.extension !== e && Z(295, e.name), n;
  }
  addEdge(e, n, o) {
  ...
  addExtension(e) {
    ...
    const n = cn(e), [o] = n;
    typeof o.name != "string" && Z(297, typeof o.name);
    let a = this.extensionNameMap.get(o.name);
    if (a !== void 0 && a.extension !== o && Z(298, o.name), !a) {
      a = new El(this, o), this.extensionNameMap.set(o.name, a);
      const s = this.conflicts.get(o.name);
      typeof s == "string" && Z(299, o.name, s);
      for (const i of o.conflictsWith || []) this.extensionNameMap.has(i) && Z(299, o.name, i), this.conflicts.set(i, o.name);
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      jn(s) || Z(300, i, a || "[unknown]"), jn(l = s) || Z(304, String(l.id), String(xr)), s = Object.assign(l, { id: or }), o.state = s;
    ...
    for (const p of l) {
      ...
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of kl(m)) {
        if (typeof h != "function") {
          ...
          u && Z(302, m.name, h.replace.name, u.extension.name), o.set(h.replace, p);
        }
        n.add(h);
      }
      if (m.html) {
...
const Dl = /* @__PURE__ */ new Set(), Xr = Gt({ build(t, e, n) {
  const o = n.getDependency(rr).output, a = We({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = Wo(() => {
  }, () => ne(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    o.value.read(() => {
      if (Ft()) for (const [p, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(p);
          continue;
        }
...
Gt({ dependencies: [rr, Xr], name: "@lexical/extension/HorizontalRule", nodes: () => [Te], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(Xr).output, a = We({ nodeSelections: /* @__PURE__ */ new Map() }), s = t._config.theme.hrSelected ?? "selected";
  return ee(t.registerCommand(ni, (i) => {
    if (ri(i.target)) {
      const l = oi(i.target);
      if (Ol(l)) return function(c, w = !1) {
        const p = Ft(), m = c.isSelected(), h = c.getKey();
        let u;
        w && ai(p) ? u = p : (u = si(), ii(u)), m ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, li), t.registerMutationListener(Te, (i, l) => {
    xl(() => {
      let c = !1;
...
function Il(t, e) {
  return ee(t.registerCommand(ui, (n) => {
    ...
    const a = function(s) {
      ...
      const i = s.anchor, l = s.focus, c = l.isBefore(i) ? l : i, w = c.getNode(), p = Br(w);
      if (p.canIndent()) {
        const m = p.getKey();
        let h = mi();
      ...
      return !1;
    }(o) ? n.shiftKey ? hi : $r : gi;
    return t.dispatchCommand(a, void 0);
  }, No), t.registerCommand($r, () => {
    const n = typeof e == "number" ? e : e ? e.peek() : null;
    if (n == null) return !1;
    const o = Ft();
    if (!Xe(o)) return !1;
    const a = o.getNodes().map((s) => Br(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, pr));
}
Gt({ build: (t, e, n) => Cn(e), config: tn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a } = n.getOutput();
  return ne(() => {
    if (!o.value) return Il(t, a);
  });
} });
const Al = Gt({ name: "@lexical/react/ReactProvider" });
function Pl() {
...
Gt({ build: (t, e, n) => Cn(e), config: tn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => ne(() => n.getOutput().disabled.value ? void 0 : na(t)) });
function Vl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const yr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? zt : H;
  ...
  return function(n, o) {
    ...
    return yr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = r(o, { onError: (h) => n._onError(h), children: r(ts, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
...
function Fl({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    yr(() => ee(Si(a), na(a)), [a]);
  }(o), d(st, { children: [t, r(Bl, { content: e }), r(zl, { editor: o, ErrorBoundary: n })] });
}
...
const Kl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? zt : H;
function Ul({ onClear: t }) {
  const [e] = $t();
  return Kl(() => Xo(e, t), [e, t]), null;
}
const ra = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? zt : H;
function ql({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": S, ...F }, P) {
  const [k, E] = I(t.isEditable()), _ = G(($) => {
    $ && $.ownerDocument && $.ownerDocument.defaultView ? t.setRootElement($) : t.setRootElement(null);
  }, [t]), T = z(() => /* @__PURE__ */ function(...$) {
    return (L) => {
      for (const M of $) typeof M == "function" ? M(L) : M != null && (M.current = L);
    };
  }(P, _), [_, P]);
  return ra(() => (E(t.isEditable()), t.registerEditableListener(($) => {
    E($);
...
function Xl(t, e) {
  ...
  return d(st, { children: [r(Hl, { editor: a, ...o, ref: e }), n != null && r(Wl, { editor: a, content: n })] });
}
function Wl({ content: t, editor: e }) {
  ...
  if (zt(() => (a(e.isEditable()), e.registerEditableListener((i) => {
    a(i);
  })), [e]), !n) return null;
  let s = null;
...
function Ql() {
  const [t, e] = I(void 0), n = G(() => {
    ...
    return /* @__PURE__ */ r(Ui, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Ao, { children: [
...
function tw({
  ...
  const [e] = $t(), [n, o] = I(e), [a, s] = I("paragraph"), [i, l] = Ql(), c = () => {
  };
...
nw.displayName = To.Root.displayName;
...
const Zr = [
  ...
  { format: "underline", icon: ss, label: "Underline" },
  { format: "strikethrough", icon: is, label: "Strikethrough" }
];
function rw() {
  const { activeEditor: t } = aa(), [e, n] = I([]), o = G((a) => {
    if (Xe(a) || Oi(a)) {
      const s = [];
      Zr.forEach(({ format: i }) => {
...
function la(t, e, n, o = null) {
  ...
  const s = he(e) && e.excludeFromCopy("html");
  let i = e;
  o !== null && mn(e) && (i = hl(o, e, "clone"));
  const l = he(i) ? i.getChildren() : [], c = yi(t, i.getType());
  let w;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = la(t, g, h, o);
    !a && he(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Ni(p) || Lr(p)) && p.append(h), n.append(p), m) {
      const u = m.call(i, p);
...
function ca(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < m.length; g++) h.push(...ca(m[g], e, n, u, new Map(a), l));
  return p != null && (h = p(h)), Vr(t) && (h = ww(t, h, u ? () => {
    const g = new Co();
    return n.push(g), g;
  } : Nn)), l == null ? h.length > 0 ? i = i.concat(h) : Vr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : jr(g.nextSibling) && jr(g.previousSibling);
  }(t) && (i = i.concat(Eo())) : he(l) && l.append(...h), i;
}
function ww(t, e, n) {
...
function Xd({
  ...
  const [a, s] = I(dw), [i, l] = I(void 0), [c, w] = I(!1), p = J(void 0), m = J(null);
  H(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
    ...
    /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(oe, { open: c, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ r(
        qt,
        {
          ...
          children: /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r(Ut, { children: t.map((y) => /* @__PURE__ */ r(
            Pt,
            {
              onSelect: () => {
                l(y === "" ? void 0 : y), w(!1);
...
const Wd = Object.freeze([
  ...
  const a = J(null), [s, i] = I(void 0), [l, c] = I(void 0), w = G(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const _ = E.findIndex(($) => $ === g);
          if (_ === -1) return;
          let T;
          u.key === "ArrowDown" ? T = Math.min(_ + 1, E.length - 1) : T = Math.max(_ - 1, 0), T !== _ && (u.preventDefault(), u.stopPropagation(), (k = E[T]) == null || k.focus());
          return;
        }
        return;
      }
      const S = t.findIndex((E) => E.id === s);
      let F = S;
      switch (u.key) {
        case "ArrowDown":
          F = Math.min(S + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          F = Math.max(S - 1, 0), u.preventDefault();
          break;
        case "Home":
...
const Se = b.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  So.Root,
  {
    ref: a,
    decorative: n,
...
Se.displayName = So.Root.displayName;
...
}), Le = Q.Trigger, ga = Q.Group, yw = Q.Portal, Nw = Q.Sub, kw = Q.RadioGroup;
function ye({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(_r.Provider, { value: n, children: /* @__PURE__ */ r(Q.Root, { ...e }) });
}
...
bn.displayName = Q.Item.displayName;
...
jt.displayName = Q.CheckboxItem.displayName;
const xa = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    Q.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(yn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
rn.displayName = Q.Label.displayName;
...
function Qr({
  ...
  const u = G(() => {
    ...
    [t.user]
  ), N = z(() => zs(t.contents), [t.contents]), C = z(() => {
    if (o && l)
      return /* @__PURE__ */ d(st, { children: [
        /* @__PURE__ */ d(
          bn,
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(fa, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(ha, { className: "tw-text-xs tw-font-medium", children: y }) }),
        ...
        C && /* @__PURE__ */ d(ye, { children: [
          /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(wo, {}) }) }),
...
function Cw({
  ...
  const [P, k] = I(to), E = o, [_, T] = I(!1), [$, L] = I(!1), [M, O] = I(!1), [j, R] = I(void 0), [q, it] = I(!1), [mt, Yt] = I(!1), [nt, Nt] = I(C), [B, at] = I(!1), ct = J(void 0), [pt, vt] = I(/* @__PURE__ */ new Map());
  H(() => {
    let D = !0;
    return (async () => {
  ...
  const Xt = z(() => e.filter((D) => !D.deleted), [e]);
  H(() => {
    let D = !0;
    if (!o || !N) {
      vt(/* @__PURE__ */ new Map());
  ...
  const ie = z(() => Xt[0], [Xt]), Mn = J(null), le = J(void 0), we = G(() => {
    var D;
    (D = le.current) == null || D.call(le), k(to);
  }, []), On = G(() => {
    const D = !nt;
    Nt(D), at(!D), u == null || u(c, D);
  }, [nt, u, c]);
  H(() => {
    T(!1);
  }, [o]), H(() => {
    if (o && !nt && !B) {
      ...
      return ct.current = D, () => clearTimeout(D);
    }
  ...
  const Wt = z(
  ...
  }, [s, n]), K = z(() => Xt.slice(1), [Xt]), Y = z(() => K.length ?? 0, [K.length]), dt = z(() => Y > 0, [Y]), ut = z(() => _ || Y <= 2 ? K : K.slice(-2), [K, Y, _]), xt = z(() => _ || Y <= 2 ? 0 : Y - 2, [Y, _]), kt = z(
    () => Y === 1 ? Wt.singleReply : me(Wt.multipleReplies, { count: Y }),
    [Y, Wt]
  ), on = z(
    () => xt === 1 ? Wt.singleReply : me(Wt.multipleReplies, { count: xt }),
    [xt, Wt]
  ), Jt = G(async () => {
    const D = _t(P) ? gn(P) : void 0;
    if (j !== void 0) {
      await p({
        threadId: c,
        contents: D,
    ...
    D && await p({ threadId: c, contents: D }) && we();
  }, [we, P, p, j, c]), Sr = G(
    async (D) => {
      const ce = _t(P) ? gn(P) : void 0, Mt = await p({
        ...D,
        contents: ce,
        assignedUser: j ?? D.assignedUser
      });
      return Mt && ce && we(), Mt && j !== void 0 && R(void 0), Mt;
    },
    [we, P, p, j]
  );
  return /* @__PURE__ */ r(
      ...
      children: /* @__PURE__ */ d(ma, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            A && /* @__PURE__ */ r(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: A }),
            /* @__PURE__ */ r(
              V,
              {
                variant: "ghost",
                ...
                children: nt ? /* @__PURE__ */ r(cs, {}) : /* @__PURE__ */ r(ds, {})
              }
            ),
            mt && w !== "Resolved" && /* @__PURE__ */ r(
              V,
              {
                variant: "ghost",
                size: "icon",
          ...
          /* @__PURE__ */ r(
            Qr,
            {
              ...
              isThreadExpanded: o,
              threadStatus: w,
              handleAddCommentToThread: Sr,
              handleUpdateComment: m,
              handleDeleteComment: h,
              onEditingChange: L,
              canEditOrDelete: pt.get(ie.id) ?? !1,
              canUserResolveThread: mt
            }
          )
        ] }),
        /* @__PURE__ */ d(st, { children: [
          dt && !o && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
            /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Se, {}) }),
          ...
          o && /* @__PURE__ */ d(st, { children: [
            xt > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                tabIndex: 0,
                onKeyDown: (D) => {
                  (D.key === "Enter" || D.key === " ") && (D.preventDefault(), D.stopPropagation(), T(!0));
                },
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(Se, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ r("p", { className: "tw-text-sm tw-text-muted-foreground", children: on }),
                    _ ? /* @__PURE__ */ r(co, {}) : /* @__PURE__ */ r(Ie, {})
                  ] })
                ]
              }
            ),
            ut.map((D) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
              Qr,
              {
                comment: D,
                localizedStrings: n,
            ...
            x !== !1 && (!$ || _t(P)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (D) => {
                  D.key === "Enter" && D.shiftKey && (D.preventDefault(), D.stopPropagation(), (_t(P) || j !== void 0) && Jt());
                },
                onKeyDown: (D) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    j !== void 0 && /* @__PURE__ */ r("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: me(
                    ...
                    /* @__PURE__ */ d(oe, { open: M, onOpenChange: O, children: [
                      /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ r(
                        V,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !q || !g || g.length === 0 || !g.includes(i),
                      ...
                      /* @__PURE__ */ r(
                        qt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (D) => {
                            D.key === "Escape" && (D.stopPropagation(), O(!1));
                          },
                          children: /* @__PURE__ */ r(Kt, { children: /* @__PURE__ */ r(Ut, { children: g == null ? void 0 : g.map((D) => /* @__PURE__ */ r(
                            Pt,
                            {
                              onSelect: () => {
                                R(D !== s ? D : void 0), O(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ r("span", { children: pn(D, n) })
                            },
                            D || "unassigned"
                          )) }) })
                        }
...
function Zd({
  ...
  const [y, N] = I(/* @__PURE__ */ new Set()), [C, S] = I();
  H(() => {
  ...
  const F = n.filter(
    ...
    (M) => {
      N((O) => new Set(O).add(M.id)), S(M.id), x == null || x(M.id);
    },
    [x]
  ), E = G(
    (M) => {
      ...
      }), S(M), x == null || x(O ? void 0 : M);
    },
    [y, x]
  ), { listboxRef: _, activeId: T, handleKeyDown: $ } = mw({
    options: P,
    onOptionSelect: k
  }), L = G(
    (M) => {
      M.key === "Escape" ? (C && y.has(C) && (N((O) => {
        const j = new Set(O);
        return j.delete(C), j;
      }), S(void 0), x == null || x(void 0)), M.preventDefault(), M.stopPropagation()) : $(M);
    },
    [C, y, $, x]
  );
  return /* @__PURE__ */ r(
...
function Ew({ table: t }) {
  return /* @__PURE__ */ d(ye, { children: [
    /* @__PURE__ */ r(Ii, { asChild: !0, children: /* @__PURE__ */ d(V, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ps, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const De = rt.Root, Tw = rt.Group, Me = rt.Value, Rw = re(
  ...
  return /* @__PURE__ */ d(
    rt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(rt.Icon, { asChild: !0, children: /* @__PURE__ */ r(Ie, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        De,
        {
          ...
          children: [
            /* @__PURE__ */ r(ve, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Me, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(xe, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(yt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
const Rn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const Lt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, s) => {
...
function Vw({
  ...
  var P;
  const [p, m] = I([]), [h, u] = I([]), [g, x] = I({}), [v, y] = I({}), N = z(() => e ?? [], [e]), C = Do({
    data: N,
    columns: t,
    getCoreRowModel: Oo(),
  ...
  let F;
  return c ? F = Array.from({ length: 10 }).map((_, T) => `skeleton-row-${T}`).map((_) => /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r(be, { colSpan: S.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(ar, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((P = C.getRowModel().rows) == null ? void 0 : P.length) > 0 ? F = C.getRowModel().rows.map((k) => /* @__PURE__ */ r(
    Lt,
    {
      onClick: () => i(k, C),
      "data-state": k.getIsSelected() && "selected",
      children: k.getVisibleCells().map((E) => /* @__PURE__ */ r(be, { children: Ke(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    k.id
  )) : F = /* @__PURE__ */ r(Lt, { children: /* @__PURE__ */ r(be, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(Ew, { table: C }),
    /* @__PURE__ */ d(En, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Tn, { stickyHeader: s, children: C.getHeaderGroups().map((k) => /* @__PURE__ */ r(Lt, { children: k.headers.map((E) => /* @__PURE__ */ r(Ze, { children: E.isPlaceholder ? void 0 : Ke(E.column.columnDef.header, E.getContext()) }, E.id)) }, k.id)) }),
      /* @__PURE__ */ r(Rn, { children: F })
    ] }),
...
function np({ id: t, label: e, groups: n }) {
  const [o, a] = I(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ye, { children: [
    ...
    /* @__PURE__ */ r(se, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(ga, { children: w.itemType === 0 ? /* @__PURE__ */ r(st, { children: w.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        jt,
        {
          checked: o[p][h],
...
function Gw({
  ...
  const [y, N] = I(!1), C = G(
    (T) => {
      var L;
      const $ = (L = t.find((M) => M.label === T)) == null ? void 0 : L.value;
      $ && n(
        e.includes($) ? e.filter((M) => M !== $) : [...e, $]
      );
    },
    [t, e, n]
  ), S = () => c || o, F = z(() => {
    if (!h) return t;
    const T = t.filter((L) => L.starred).sort((L, M) => L.label.localeCompare(M.label)), $ = t.filter((L) => !L.starred).sort((L, M) => {
      const O = e.includes(L.value), j = e.includes(M.value);
      return O && !j ? -1 : !O && j ? 1 : L.label.localeCompare(M.label);
    });
    return [...T, ...$];
  }, [t, e, h]), P = () => {
    n(t.map((T) => T.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ d(oe, { open: E, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ r(ae, { asChild: !0, children: /* @__PURE__ */ d(
      V,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(qt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Kt, { children: [
...
const Kw = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(st, { children: [
...
function Uw({
  ...
  const s = J(null), i = J(null), l = J(!1), [c, w] = I(t), [p, m] = I(n), [h, u] = I(!1);
  H(() => {
    w(t);
  }, [t]), H(() => {
    p !== n && m(n);
  ...
  return /* @__PURE__ */ d(ye, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: Kw(t, a, n) }) }) }),
...
const qw = (t, e) => t === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ r(fo, {}),
  " ",
  ...
  return t === "f" && (n = e["%footnoteEditor_noteType_footnote_label%"]), me(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function Yw({
  ...
  return /* @__PURE__ */ d(ye, { children: [
    /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Ei, { asChild: !0, children: /* @__PURE__ */ r(Le, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", className: "tw-h-6", children: qw(t, n) }) }) }),
...
function sp({
  ...
  const c = J(null), w = es(), [p, m] = I("generated"), [h, u] = I("*"), [g, x] = I("f"), [v, y] = I(!1), N = z(
    () => ({
      ...i,
  ...
  H(() => {
    ...
    if (E && sn("note", E)) {
      const $ = (_ = E.insert.note) == null ? void 0 : _.caller;
      let L = "custom";
      $ === Xn ? L = "generated" : $ === Wn ? L = "hidden" : $ && u($), m(L), x(((T = E.insert.note) == null ? void 0 : T.style) ?? "f"), k = setTimeout(() => {
        var M;
        (M = c.current) == null || M.applyUpdate([E]);
      }, 0);
    }
    return () => {
      k && clearTimeout(k);
  ...
  const C = G(() => {
    var E, _;
    const k = (_ = (E = c.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    k && sn("note", k) && (k.insert.note && (p === "custom" ? k.insert.note.caller = h : k.insert.note.caller = p === "generated" ? Xn : Wn), n([k]));
  }, [p, h, n]), S = () => {
    var E;
    const k = (E = w.current) == null ? void 0 : E.getElementsByClassName("editor-input")[0];
    k != null && k.textContent && navigator.clipboard.writeText(k.textContent);
  }, F = (k) => {
    var _, T, $, L, M;
    x(k);
    const E = (T = (_ = c.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (E && sn("note", E)) {
      E.insert.note && (E.insert.note.style = k);
      const O = (L = ($ = E.insert.note) == null ? void 0 : $.contents) == null ? void 0 : L.ops;
      g !== "x" && k === "x" ? O == null || O.forEach((j) => Xw(j)) : g === "x" && k !== "x" && (O == null || O.forEach((j) => Ww(j))), (M = c.current) == null || M.applyUpdate([E, { delete: 1 }]);
    }
  }, P = (k) => {
    var _, T, $, L, M;
    const E = (T = (_ = c.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : T.at(0);
    if (E && sn("note", E)) {
      k.content.length > 1 && setTimeout(() => {
        var R;
        (R = c.current) == null || R.applyUpdate([{ retain: 2 }, { delete: 1 }]);
      }, 0);
      const O = ($ = E.insert.note) == null ? void 0 : $.style, j = (M = (L = E.insert.note) == null ? void 0 : L.contents) == null ? void 0 : M.ops;
      O || y(!1), y(
        O === "x" ? !!(j != null && j.every((R) => {
          var it, mt;
          if (!((it = R.attributes) != null && it.char)) return !0;
          const q = ((mt = R.attributes) == null ? void 0 : mt.char).style;
          return q === "xt" || q === "xo" || q === "xq";
        })) : !!(j != null && j.every((R) => {
          var it, mt;
          if (!((it = R.attributes) != null && it.char)) return !0;
          const q = ((mt = R.attributes) == null ? void 0 : mt.char).style;
          return q === "ft" || q === "fr" || q === "fq";
        }))
      );
    } else
      y(!1);
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Oe, {}) }) }),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Vt, { asChild: !0, children: /* @__PURE__ */ r(V, { onClick: S, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(po, {}) }) }),
...
function lp({
  ...
  const p = c ?? Ks(n, void 0), m = (N, C) => {
    w == null || w(N, C, a);
  }, h = s ? n.findIndex((N) => N === s) : -1, [u, g] = I(h), x = (N, C, S) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
        ...
        "ul",
        {
          ...
          children: n.map((N, C) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              C < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(Se, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function nc({
  ...
  return /* @__PURE__ */ d(En, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Tn, { stickyHeader: !0, children: /* @__PURE__ */ d(Lt, { children: [
    ...
    /* @__PURE__ */ r(Rn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Lt,
      {
        ...
        children: [
          /* @__PURE__ */ r(be, { children: fe(l.reference, "English") }),
          /* @__PURE__ */ r(be, { className: o, children: ec(l.text) })
        ]
      },
...
const Sn = (t) => t === "asc" ? /* @__PURE__ */ r(Cs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Es, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ts, { className: "tw-ms-2 tw-h-4 tw-w-4" }), wp = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, oc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fp = Object.freeze([
  ...
  const a = Pr(o.key) ? o.key : o.key[0];
  return {
    items: Pr(o.key) ? [o.key] : o.key,
    count: o.count,
...
function hp({
  ...
  const u = Ot(n, "%webView_inventory_all%"), g = Ot(n, "%webView_inventory_approved%"), x = Ot(n, "%webView_inventory_unapproved%"), v = Ot(n, "%webView_inventory_unknown%"), y = Ot(n, "%webView_inventory_scope_currentBook%"), N = Ot(n, "%webView_inventory_scope_chapter%"), C = Ot(n, "%webView_inventory_scope_verse%"), S = Ot(n, "%webView_inventory_filter_text%"), F = Ot(
    n,
    "%webView_inventory_show_additional_items%"
  ), P = Ot(n, "%webView_inventory_no_results%"), [k, E] = I(!1), [_, T] = I("all"), [$, L] = I(""), [M, O] = I([]), j = z(() => {
    const B = t ?? [];
  ...
  }, [k, j]), q = z(() => R.length === 0 ? [] : ac(R, _, $), [R, _, $]), it = z(() => {
    var ct, pt;
    if (!k) return c;
    const B = (ct = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ct.length;
    if (!B) return c;
    const at = [];
    for (let vt = 0; vt < B; vt++)
      at.push(
        rc(
          ((pt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : pt[vt]) || "Additional Item",
          vt + 1
        )
      );
    return [...at, ...c];
  ...
  H(() => {
    q.length === 0 ? O([]) : q.length === 1 && O(q[0].items);
  }, [q]);
  const mt = (B, at) => {
    at.setRowSelection(() => {
      const pt = {};
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        De,
        {
          onValueChange: (B) => nt(B),
          defaultValue: _,
          children: [
            /* @__PURE__ */ r(ve, { className: "tw-m-1", children: /* @__PURE__ */ r(Me, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(De, { onValueChange: (B) => Yt(B), defaultValue: i, children: [
        /* @__PURE__ */ r(ve, { className: "tw-m-1", children: /* @__PURE__ */ r(Me, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(xe, { children: [
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(lt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? F })
      ] })
    ] }),
...
function bp({ localizedStrings: t, markerMenuItems: e }) {
  const [n, o] = I(""), a = z(() => {
  ...
  return /* @__PURE__ */ d(Kt, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    /* @__PURE__ */ r(
      $e,
      {
        value: n,
    ...
    /* @__PURE__ */ d(Ut, { children: [
      ...
      /* @__PURE__ */ r(Bt, { children: a.map((s) => /* @__PURE__ */ d(
        Pt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ r(Vo, { className: "tw-font-sans", children: s.isDisallowed ? t["%markerMenu_disallowed_label%"] : t["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const ic = "16rem", lc = "3rem", _a = b.createContext(void 0);
function Dn() {
...
const Ca = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(_a.Provider, { value: N, children: /* @__PURE__ */ r(Ct, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const wc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Dn();
  return /* @__PURE__ */ d(
    V,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Rs, {}) : /* @__PURE__ */ r(Ss, {}),
        /* @__PURE__ */ r("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
wc.displayName = "SidebarTrigger";
...
const fc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ae : "button",
  {
    ref: o,
...
fc.displayName = "SidebarGroupAction";
...
const hc = re(
  ...
  ({
    ...
    const c = t ? Ae : "button", { state: w } = Dn(), p = /* @__PURE__ */ r(
      c,
      {
        ref: l,
...
const vc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const Nc = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Ae : "a",
  {
    ref: s,
...
Nc.displayName = "SidebarMenuSubButton";
function kc({
  id: t,
  extensionLabels: e,
  projectInfo: n,
    ...
    Ea,
    {
      ...
      children: /* @__PURE__ */ d(Ra, { children: [
        /* @__PURE__ */ d(sr, { children: [
          ...
          /* @__PURE__ */ r(lr, { children: /* @__PURE__ */ r(Sa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Da, { children: /* @__PURE__ */ r(
            Ma,
            {
              onClick: () => w(h),
              isActive: m(h),
    ...
    /* @__PURE__ */ d(
      Ca,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ta, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const Zt = "scrBook", _c = "scrRef", ue = "source", Cc = "details", Ec = "Scripture Reference", Tc = "Scripture Book", Oa = "Type", Rc = "Details";
function Sc(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: Zt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Ec,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? ot.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Zt ? fe(a.start) : void 0;
      },
    ...
    },
    {
      ...
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? void 0 : fe(a.start);
      },
      sortingFn: (o, a) => Yn(o.original.start, a.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: Cc,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Rc,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, ro = (t) => `${Dc({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function xp({
  sources: t,
  ...
  const [w, p] = I([]), [m, h] = I([{ id: Zt, desc: !1 }]), [u, g] = I({}), x = z(
  ...
  H(() => {
    if (l) {
      const _ = y.getSelectedRowModel().rowsById, T = Object.keys(_);
      if (T.length === 1) {
        const $ = x.find((L) => ro(L) === T[0]) || void 0;
        $ && l($);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? Tc, C = s ?? Oa, S = [
  ...
  }, k = (_, T) => _.getIsGrouped() ? "" : f("banded-row", T % 2 === 0 ? "even" : "odd"), E = (_, T, $) => {
    if (!((_ == null ? void 0 : _.length) === 0 || T.depth < $.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      De,
      {
        ...
        children: [
          /* @__PURE__ */ r(ve, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Me, {}) }),
          /* @__PURE__ */ r(xe, { position: "item-aligned", children: /* @__PURE__ */ r(Tw, { children: S.map((_) => /* @__PURE__ */ r(yt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(En, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Tn, { children: y.getHeaderGroups().map((_) => /* @__PURE__ */ r(Lt, { children: _.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ r(Rn, { children: y.getRowModel().rows.map((_, T) => {
        const $ = wt();
        return /* @__PURE__ */ r(
          Lt,
          {
            ...
            children: _.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== ue || !n)))
                return /* @__PURE__ */ r(
                  be,
                  {
                    className: f(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ d(
                      V,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ r(Ie, {}),
                          !_.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ r(Ce, {}) : /* @__PURE__ */ r(qn, {})),
                          " ",
...
}), Ia = (t, e, n) => Rr(t, e).every((o) => n.includes(o));
function Mc({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Rr(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    V,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        Ia(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: Yi(
        t,
...
function Oc({
  ...
  }, [v, y] = I(!1), [N, C] = I(""), S = J(void 0), F = J(!1);
  if (t.length !== ot.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const P = z(() => ot.allBookIds.filter(
    (O, j) => t[j] === "1" && !ot.isObsolete(ot.bookIdToNumber(O))
  ), [t]), k = z(() => {
    if (!N.trim()) {
      const R = {
        [U.OT]: [],
    ...
    (O, j = !1) => {
      if (!j || !S.current) {
        n(
          e.includes(O) ? e.filter((nt) => nt !== O) : [...e, O]
        ), S.current = O;
        return;
      }
      const R = P.findIndex((nt) => nt === S.current), q = P.findIndex((nt) => nt === O);
      if (R === -1 || q === -1) return;
      const [it, mt] = [
        Math.min(R, q),
        Math.max(R, q)
      ], Yt = P.slice(it, mt + 1).map((nt) => nt);
      n(
        e.includes(O) ? e.filter((nt) => !Yt.includes(nt)) : [.../* @__PURE__ */ new Set([...e, ...Yt])]
      );
    },
    [e, n, P]
  ), _ = (O) => {
    E(O, F.current), F.current = !1;
  }, T = (O, j) => {
    O.preventDefault(), E(j, O.shiftKey);
  }, $ = G(
    (O) => {
      const j = Rr(P, O).map((R) => R);
      n(
        Ia(P, O, e) ? e.filter((R) => !j.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...j])]
      );
    },
    [e, n, P]
  ), L = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(U).map((O) => /* @__PURE__ */ r(
      Mc,
      {
        section: O,
        availableBookIds: P,
                    ...
                    if (R.length !== 0)
                      return /* @__PURE__ */ d(ao, { children: [
                        /* @__PURE__ */ r(
                          Bt,
                          {
                            heading: jo(O, h, u, g, x),
                            children: R.map((q) => /* @__PURE__ */ r(
                              Fo,
                              {
                                bookId: q,
                                isSelected: e.includes(q),
                                onSelect: () => _(q),
                                onMouseDown: (it) => T(it, q),
                                section: Ge(q),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: tr(q, a),
                        ...
                        j < Object.values(U).length - 1 && /* @__PURE__ */ r(Lo, {})
                      ] }, O);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Gn ? Gn : oo
      ).map((O) => /* @__PURE__ */ r(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: _e(O, a) }, O)),
      e.length > Gn && /* @__PURE__ */ r(
        Re,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - oo} ${m}`
        }
      )
    ] })
  ] });
...
function Np({
  ...
  const w = de(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = de(i, "%webView_scope_selector_current_book%"), u = de(i, "%webView_scope_selector_choose_books%"), g = de(i, "%webView_scope_selector_scope%"), x = de(i, "%webView_scope_selector_select_books%"), v = [
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          xe,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(yt, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Pa = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Vt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    bn,
    {
      onClick: () => {
        o(l);
    ...
    /* @__PURE__ */ r(yw, { children: /* @__PURE__ */ r(va, { children: Pa(
      t,
      e,
      Aa(t, l.id),
      o
...
function wr({
  ...
  return /* @__PURE__ */ d(ye, { variant: s, children: [
    /* @__PURE__ */ r(Le, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(V, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ms, {}) }) }),
    /* @__PURE__ */ r(se, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ao, { children: [
      /* @__PURE__ */ r(ga, { children: /* @__PURE__ */ r(Ct, { children: Pa(e.groups, e.items, c, t) }) }),
...
function Tp({
  ...
  return /* @__PURE__ */ d($a, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      wr,
      {
        onSelectMenuItem: t,
...
const La = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ r(
    bt.Root,
    {
...
La.displayName = bt.List.displayName;
const Va = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  bt.List,
  {
    ref: n,
...
Va.displayName = bt.List.displayName;
...
ja.displayName = bt.Content.displayName;
function Sp({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(La, { children: [
      /* @__PURE__ */ r(Va, { children: t.map((l) => /* @__PURE__ */ r(Ic, { value: l.value, children: l.value }, l.key)) }),
...
const $c = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Dt();
  return /* @__PURE__ */ d(
    tt.CheckboxItem,
    {
...
$c.displayName = tt.CheckboxItem.displayName;
const Lc = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Dt();
  return /* @__PURE__ */ d(
    tt.RadioItem,
    {
...
Lc.displayName = tt.RadioItem.displayName;
const Vc = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Vc.displayName = tt.Label.displayName;
...
const Fe = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Vt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        Ua,
        {
          onClick: () => {
            o(w);
    ...
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ r(qa, {}, `separator-${s}`)), c;
  });
};
function jc({
  menuData: t,
  ...
  const a = J(void 0), s = J(void 0), i = J(void 0), l = J(void 0), c = J(void 0), w = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (Fi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ r(za, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(Ac, { children: [
...
function Op({
  ...
  const w = zc(
    ...
    return v ? `${(F = t[g]) == null ? void 0 : F.autonym} (${v})` : (P = t[g]) == null ? void 0 : P.autonym;
  };
  return /* @__PURE__ */ d("div", { id: c, className: f("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      De,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ r(ve, { children: /* @__PURE__ */ r(Me, {}) }),
          /* @__PURE__ */ r(
            xe,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(lt, { className: "tw-font-normal tw-text-muted-foreground", children: me(w, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, e)).join(", ") : t.en.autonym
    }) }) })
  ] });
}
function Fc({ item: t, createLabel: e, createComplexLabel: n }) {
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ye, { children: [
              /* @__PURE__ */ r(Le, { className: f(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(V, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(wo, {}) }) }),
...
const Bc = Qe(({ className: t, ...e }, n) => /* @__PURE__ */ r(As, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
...
), Kc = b.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const qc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
qc.displayName = "AlertDescription";
const $p = et.Root, Lp = et.Trigger, Vp = et.Group, jp = et.Portal, zp = et.Sub, Fp = et.RadioGroup, Hc = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  et.SubTrigger,
  {
    ref: a,
    className: f(
...
Hc.displayName = et.SubTrigger.displayName;
...
Yc.displayName = et.SubContent.displayName;
const Xc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(et.Portal, { children: /* @__PURE__ */ r(
  et.Content,
  {
    ref: n,
    className: f(
...
Xc.displayName = et.Content.displayName;
...
Wc.displayName = et.Item.displayName;
const Jc = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  et.CheckboxItem,
  {
    ref: a,
    className: f(
...
const Zc = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  et.RadioItem,
  {
    ref: o,
    className: f(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(et.ItemIndicator, { children: /* @__PURE__ */ r(yn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
...
Qc.displayName = et.Label.displayName;
...
td.displayName = et.Separator.displayName;
...
const Bp = St.Trigger, rd = St.Portal, Gp = St.Close, Xa = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  St.Overlay,
  {
    ref: n,
...
const od = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
id.displayName = St.Title.displayName;
...
ld.displayName = St.Description.displayName;
const wd = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Zn.Root,
  {
    ref: o,
    className: f(
...
wd.displayName = Zn.Root.displayName;
function Kp({
  className: t,
  ...e
}) {
...
const cd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ d(
    Be.Root,
    {
...
cd.displayName = Be.Root.displayName;
...
dd.displayName = Qn.Root.displayName;
const Yp = bt.Root, pd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = wt();
  return /* @__PURE__ */ r(
    bt.List,
    {
...
pd.displayName = bt.List.displayName;
...
ud.displayName = bt.Trigger.displayName;
...
md.displayName = bt.Content.displayName;
...
export {
  ...
  Hd as BOOK_SELECTOR_STRING_KEYS,
  Re as Badge,
  Ud as BookChapterControl,
  rl as BookSelectionMode,
  Yd as BookSelector,
  V as Button,
  Wd as COMMENT_EDITOR_STRING_KEYS,
  Jd as COMMENT_LIST_STRING_KEYS,
  ua as Card,
  ma as CardContent,
  ...
  Zd as CommentList,
  $p as ContextMenu,
  Jc as ContextMenuCheckboxItem,
  Xc as ContextMenuContent,
  Vp as ContextMenuGroup,
  Wc as ContextMenuItem,
  Qc as ContextMenuLabel,
  jp as ContextMenuPortal,
  Fp as ContextMenuRadioGroup,
  Zc as ContextMenuRadioItem,
  ...
  hp as Inventory,
  lt as Label,
  gp as MARKER_MENU_STRING_KEYS,
  Qd as MarkdownRenderer,
  bp as MarkerMenu,
  rp as MoreInfo,
  Gw as MultiSelectComboBox,
  Sp as NavigationContentSearch,
  oe as Popover,
  Gd as PopoverAnchor,
  ...
  Va as VerticalTabsList,
  Ic as VerticalTabsTrigger,
  fw as badgeVariants,
