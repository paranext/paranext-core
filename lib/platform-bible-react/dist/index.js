...
import { extendTailwindMerge as li, twMerge as di } from "tailwind-merge";
import { Slot as ke, Dialog as Ht, Popover as rr, Label as wi, RadioGroup as ra, Tooltip as Le, ToggleGroup as Ro, Separator as ui, Avatar as ya, DropdownMenu as vt, Select as Ct, Checkbox as Ua, Tabs as Bt, Menubar as Xt, ContextMenu as bt, Progress as Ka, Slider as dr, Switch as Ga } from "radix-ui";
...
import { createEditor as jo, $getRoot as se, $createParagraphNode as We, $getSelection as zt, HISTORY_MERGE_TAG as Na, ParagraphNode as Fo, TextNode as Bo, $isTokenOrSegmented as hs, $getCharacterOffsets as fs, $cloneWithPropertiesEphemeral as ms, $getPreviousSelection as vs, $isRangeSelection as Wt, $caretFromPoint as bs, $getSiblingCaret as Uo, $getChildCaret as xs, $getAdjacentChildCaret as ys, $isChildCaret as ks, $normalizeCaret as _s, $setSelectionFromCaretRange as Ns, $getCollapsedCaretRange as Cs, $getCaretInDirection as Za, $splitAtPointCaretNext as Es, $isTextPointCaret as zs, $findMatchingParent as Ko, $isElementNode as ne, mergeRegister as ce, getDOMTextNode as Ts, isHTMLElement as Go, CLEAR_EDITOR_COMMAND as qo, COMMAND_PRIORITY_EDITOR as Ca, shallowMergeConfig as Ss, defineExtension as Lt, safeCast as Oe, createState as Ds, FORMAT_TEXT_COMMAND as Ho, $isNodeSelection as Wo, COMMAND_PRIORITY_LOW as Yo, RootNode as Rs, LineBreakNode as Ms, TabNode as $s, $isEditorState as Os, createCommand as As, CLICK_COMMAND as Is, isDOMNode as Ps, $getNodeFromDOMNode as Ls, $createNodeSelection as Vs, $setSelection as js, $getEditor as Fs, DecoratorNode as sa, $getState as Bs, toggleTextFormatType as Qa, TEXT_TYPE_TO_FORMAT as Us, $setState as Ks, addClassNamesToElement as Xo, $create as Gs, $getNodeByKey as qs, removeClassNamesFromElement as Hs, KEY_TAB_COMMAND as Ws, $isBlockElementNode as yr, $createRangeSelection as Ys, $normalizeSelection__EXPERIMENTAL as Xs, OUTDENT_CONTENT_COMMAND as Js, INDENT_CONTENT_COMMAND as to, INSERT_TAB_COMMAND as Zs, COMMAND_PRIORITY_CRITICAL as Ea, $isDecoratorNode as Qs, $isParagraphNode as tc, $isTextNode as kr, SELECTION_CHANGE_COMMAND as Jo, getRegisteredNode as ec, isDocumentFragment as eo, isDOMDocumentNode as rc, ArtificialNode__DO_NOT_USE as Zo, $createLineBreakNode as Qo, $isRootOrShadowRoot as ac, isBlockDomNode as ro, isInlineDomNode as ao, $insertNodes as oc } from "lexical";
import { HeadingNode as nc, QuoteNode as ic, registerRichText as sc } from "@lexical/rich-text";
import { flushSync as cc, createPortal as lc } from "react-dom";
import { $isTableSelection as dc } from "@lexical/table";
import { createHeadlessEditor as tn } from "@lexical/headless";
import { useReactTable as en, getFilteredRowModel as wc, getSortedRowModel as rn, getPaginationRowModel as uc, getCoreRowModel as an, flexRender as tr, getGroupedRowModel as pc, getExpandedRowModel as gc } from "@tanstack/react-table";
import hc from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ca, HIDDEN_NOTE_CALLER as la, getDefaultViewOptions as fc, isInsertEmbedOpOfType as ur, Editorial as mc } from "@eten-tech-foundation/platform-editor";
import { useHotkeys as vc } from "react-hotkeys-hook";
import { Drawer as _e } from "vaul";
import * as za from "react-resizable-panels";
import { useTheme as bc } from "next-themes";
import { Toaster as xc } from "sonner";
import { toast as Lg } from "sonner";
const yc = li({ prefix: "tw" });
function da(t) {
  const e = [];
  let r = "", o = 0;
...
function _c(t, e) {
  ...
  const r = da(t);
  if (r[0] !== "tw") return t;
  const o = r.slice(1, -1), n = r[r.length - 1], i = da(e), s = i.some((l) => l.startsWith("-tw-")), c = i.some((l) => l.startsWith("!tw-"));
  if (s && n.startsWith("-")) {
    const l = n.slice(1);
    return [...o, `-tw-${l}`].join(":");
  }
...
function f(...t) {
  const e = ci(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return yc(e);
  const r = e.split(" ").filter(Boolean), o = /* @__PURE__ */ new Map(), n = [];
  return r.forEach((l) => {
    const d = kc(l);
    o.set(d.normalized, d.original), n.push(d.normalized);
  }), di(n.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = o.get(l);
    return d ? _c(l, d) : l;
  }).join(" ");
}
const Ye = 250, on = 300, Nc = 400, Cc = 450, Ec = 500, nn = Jt(
...
Jt("tw:flex tw:items-center tw:gap-2 tw:text-sm tw:shadow-none", {
  variants: {
    size: {
...
function cr({
  ...
  return (
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ u(Mc, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ a(
        Me.Input,
        {
      ...
      /* @__PURE__ */ a(Oc, { children: /* @__PURE__ */ a(gi, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Lc({
  ...
  return /* @__PURE__ */ u(we, { open: w, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ a(ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: /* @__PURE__ */ a(le, { heading: i, children: t.map((p) => /* @__PURE__ */ u(
      de,
      {
        onSelect: () => h(p),
...
function Fc(t, e, r, o) {
  const n = j(() => {
    if (t.chapterNum > 1)
      ...
      if (l > 0) {
        const d = e[l - 1], w = Math.max(qt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function no({
  ...
  if (t)
    return /* @__PURE__ */ a(le, { children: /* @__PURE__ */ a("div", { className: f("tw:grid tw:grid-cols-6 tw:gap-1", i), children: Array.from({ length: qt(t) }, (s, c) => c + 1).map((s) => /* @__PURE__ */ a(
      de,
      {
        value: `${t} ${Re[t] || ""} ${s}`,
        onSelect: () => r(s),
...
function Au({
  ...
  const d = ct(), [w, g] = T(!1), [h, p] = T(""), [m, b] = T(""), [v, N] = T("books"), [x, _] = T(void 0), [k, $] = T(!1), V = q(void 0), A = q(void 0), C = q(void 0), z = q(void 0), E = q({}), O = j(
    (M) => {
      e(M), c && c(M);
    },
    [e, c]
  ), D = P(() => o ? o() : wn, [o]), F = P(() => ({
    [W.OT]: D.filter((H) => lt.isBookOT(H)),
    [W.NT]: D.filter((H) => lt.isBookNT(H)),
    [W.DC]: D.filter((H) => lt.isBookDC(H)),
    [W.Extra]: D.filter((H) => lt.extraBooks().includes(H))
  ...
  return $t(() => {
    ...
    /* @__PURE__ */ a(ue, { id: l, forceMount: !0, className: "tw:w-[280px] tw:p-0", align: "center", children: /* @__PURE__ */ u(
      Ne,
      {
        ref: V,
        onKeyDown: Vt,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: te.map(({ onClick: M, disabled: H, title: Z, icon: wt }) => /* @__PURE__ */ a(
              L,
              {
                variant: "ghost",
                size: "sm",
              ...
              !y && Object.entries(G).map(([M, H]) => {
                if (H.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ a(le, { heading: ge(M), children: H.map((Z) => /* @__PURE__ */ a(
                      un,
                      {
                        bookId: Z,
                        onSelect: (wt) => ft(wt),
...
function pa({
  ...
  const [_, k] = T(!1), $ = d ?? l, V = (C) => C.length > 0 && typeof C[0] == "object" && "options" in C[0], A = (C, z) => {
    const E = l(C), O = typeof C == "object" && "secondaryLabel" in C ? C.secondaryLabel : void 0, D = `${z ?? ""}${E}${O ?? ""}`;
    return /* @__PURE__ */ u(
      de,
      {
        value: E,
    ...
    /* @__PURE__ */ a(
      ue,
      {
        ...
        children: /* @__PURE__ */ u(Ne, { children: [
          ...
          /* @__PURE__ */ a(Ce, { children: V(e) ? e.map((C) => /* @__PURE__ */ a(le, { heading: C.groupHeading, children: C.options.map((z) => A(z, C.groupHeading)) }, C.groupHeading)) : e.map((C) => A(C)) })
        ] })
      }
    )
  ] });
    ...
    pn,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(ht, { className: "tw:flex tw:items-center", children: o.map((v) => lt.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ a(
            L,
            {
...
const hn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Gc = hn ? $t : K, pr = { tag: Na };
function qc({ initialConfig: t, children: e }) {
  const r = P(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: l } = t, d = Kc(null, o), w = jo({ editable: t.editable, html: l, namespace: n, nodes: i, onError: (g) => s(g, w), theme: o });
    return function(g, h) {
      if (h !== null) {
...
const Hc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Wc({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: r }) {
  const [o] = Zt();
  return Hc(() => {
    if (r) return o.registerUpdateListener(({ editorState: n, dirtyElements: i, dirtyLeaves: s, prevEditorState: c, tags: l }) => {
      e && i.size === 0 && s.size === 0 || t && l.has(Na) || c.isEmpty() || r(n, o, l);
    });
  }, [o, t, e, r]), null;
}
const Da = {
...
function Zc({ children: t, onError: e }) {
  return a(Xc, { fallback: a("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const Qc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function tl(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function el() {
  return function(t) {
    const [e] = Zt(), r = P(() => t(e), [e, t]), [o, n] = T(() => r.initialValueFn()), i = q(o);
    return Qc(() => {
...
function al(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !hs(e) && o !== null) {
    ...
    if (d || w) {
      const [g, h] = fs(t), p = c.is(l), m = e.is(s ? l : c), b = e.is(s ? c : l);
      let v, N = 0;
...
const fn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ol = fn && "documentMode" in document ? document.documentMode : null;
!(!fn || !("InputEvent" in window) || ol) && "getTargetRanges" in new window.InputEvent("input");
function Gt(t) {
  return `${t}px`;
}
...
function il(t, e, r) {
  ...
  function l() {
    ...
    const { left: g, top: h } = n.getBoundingClientRect(), p = rl(t, e);
    var m, b;
...
function cl(t, e = sl) {
  ...
  function d(w) {
    w.read(() => {
      const g = zt();
      if (!Wt(g)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, p] = function(C) {
        const z = C.getStartEndPoints();
        return C.isBackward() ? [z[1], z[0]] : z;
      }(g), m = h.getNode(), b = m.getKey(), v = h.offset, N = p.getNode(), x = N.getKey(), _ = p.offset, k = t.getElementByKey(b), $ = t.getElementByKey(x), V = r === null || k !== o || v !== n || b !== r.getKey(), A = i === null || $ !== s || _ !== c || x !== i.getKey();
      if ((V || A) && k !== null && $ !== null) {
...
function ll(t, e) {
  ...
  const o = () => {
    ...
    i !== null && s !== null && s.contains(i) ? r !== null && (r(), r = null) : r === null && (r = cl(t, e));
  };
...
function wl(t) {
  ...
  if (Wt(e)) r = bs(e.focus, "next");
    ...
    r = r || xs(se(), "previous").getFlipped().insert(We());
  }
  const o = ul(t, r), n = ys(o), i = ks(n) ? _s(n) : o;
...
function pl(t) {
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Ko(i, (d) => ne(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let Nr, ie = 0, Cr = 0, fl = 0, ha = 0, vr = 0;
function co(t) {
  if (X === void 0) return;
  let e = t.n;
...
Nt.prototype.brand = gl, Nt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, bn(this), lo(this), ie++;
  const t = X;
  return X = this, vl.bind(this, t);
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
  return Yt(() => o.disabled.value ? void 0 : t.registerRootListener((n) => {
    t.focus(() => {
...
Lt({ name: "@lexical/extension/DecoratorText", nodes: () => [kn], register: (t, e, r) => t.registerCommand(Ho, (o) => {
  const n = zt();
  if (Wo(n) || Wt(n)) for (const i of n.getNodes()) xl(i) && i.toggleFormat(o);
  return !1;
}, Yo) });
function _n(t, e) {
  let r;
...
class _l {
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || kl;
  }
  getPeerNameSet() {
...
const Cl = Lt({ config: Oe({ setOptions: wo, updateOptions: wo }), init: ({ $initialEditorState: t = Nl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
class je {
  ...
  addExtension(e) {
    ...
    if (n !== void 0 && n.extension !== o && Q(298, o.name), !n) {
      n = new _l(this, o), this.extensionNameMap.set(o.name, n);
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Wr(i) || Q(300, s, n || "[unknown]"), Wr(c = i) || Q(304, String(c.id), String($a)), i = Object.assign(c, { id: ma }), o.state = i;
...
const zl = /* @__PURE__ */ new Set(), go = Lt({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = ml(() => (i.value || zl).has(s)), { watchedNodeKeys: l } = n.peek();
    let d = l.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(c), w || (l.set(s, d), n.value = { watchedNodeKeys: l }), c;
  } };
}, dependencies: [fa], name: "@lexical/extension/NodeSelection" }), Tl = As("INSERT_HORIZONTAL_RULE_COMMAND");
class Fe extends sa {
  static getType() {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: Sl, priority: 0 }) };
  }
  exportDOM() {
...
Lt({ dependencies: [fa, go], name: "@lexical/extension/HorizontalRule", nodes: () => [Fe], register(t, e, r) {
  ...
  return ce(t.registerCommand(Tl, (s) => {
    const c = zt();
    if (!Wt(c)) return !1;
    ...
    if (Ps(s.target)) {
      const c = Ls(s.target);
      if (Dl(c)) return function(l, d = !1) {
        const w = zt(), g = l.isSelected(), h = l.getKey();
        let p;
        d && Wo(w) ? p = w : (p = Vs(), js(p)), g ? p.delete(h) : p.add(h);
      }(c, s.shiftKey), !0;
    }
    return !1;
  }, Yo), t.registerMutationListener(Fe, (s, c) => {
    hl(() => {
      let l = !1;
      ...
      for (const [w, g] of s.entries()) if (g === "destroyed") d.delete(w), l = !0;
        ...
        h ? h.domNode.value = p : (l = !0, d.set(w, { domNode: ar(p), selectedSignal: o(w) }));
      }
      l && (n.value = { nodeSelections: d });
    });
  }), Yt(() => {
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(Yt(() => {
      const d = c.value;
      d && (l.value ? Xo(d, i) : Hs(d, i));
    }));
    return ce(...s);
  }));
} });
...
}, name: "@lexical/extension/NestedEditor", register: (t, e, r) => Yt(() => {
...
function Rl(t, e, r = zn) {
  return ce(t.registerCommand(Ws, (o) => {
    ...
    const i = function(s) {
      ...
      const c = s.anchor, l = s.focus, d = l.isBefore(c) ? l : c, w = d.getNode(), g = dl(w);
      if (g.canIndent()) {
        const h = g.getKey();
        let p = Ys();
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ $canIndent: zn, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  ...
  return Yt(() => {
    if (!o.value) return Rl(t, n, i);
  });
} });
const Ml = Lt({ name: "@lexical/react/ReactProvider" });
function $l() {
...
Lt({ build: (t, e, r) => Xe(e), config: Oe({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Yt(() => r.getOutput().disabled.value ? void 0 : Sn(t)) });
function Il(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
  ...
  return function(r, o) {
    ...
    return Aa(() => r.registerDecoratorListener((s) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a(gs, { fallback: null, children: n[d] }) }), g = r.getElementByKey(d);
        g !== null && s.push(lc(w, g, d));
      }
      return s;
    }, [o, n, r]);
  }(t, e);
}
function Ll({ editor: t, ErrorBoundary: e }) {
  return function(r) {
    const o = je.maybeFromEditor(r);
    if (o && o.hasExtensionByName(Ml.name)) {
      for (const n of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(n) && Il(320, n);
      return !0;
    }
    return !1;
  }(t) ? null : a(Pl, { editor: t, ErrorBoundary: e });
}
function ho(t) {
...
function Vl({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    Aa(() => ce(sc(n), Sn(n)), [n]);
  }(o), u(et, { children: [t, a(jl, { content: e }), a(Ll, { editor: o, ErrorBoundary: r })] });
}
function jl({ content: t }) {
  const [e] = Zt(), r = function(n) {
    const [i, s] = T(() => ho(n));
    return Aa(() => {
      function c() {
        const l = ho(n);
...
function Fl({ defaultSelection: t }) {
  const [e] = Zt();
  return K(() => {
    e.focus(() => {
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : K;
function Ul({ onClear: t }) {
  const [e] = Zt();
  return Bl(() => yn(e, t), [e, t]), null;
}
...
const ql = ir(Hl);
function Hl(t, e) {
  const { placeholder: r, ...o } = t, [n] = Zt();
  return u(et, { children: [a(Gl, { editor: n, ...o, ref: e }), r != null && a(Wl, { editor: n, content: r })] });
}
...
function Jl() {
  const [t, e] = T(void 0), r = j(() => {
    ...
    return /* @__PURE__ */ a(Tc, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u(Rc, { children: [
      /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a(cn, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = j(
    (i, s, c = !1) => {
...
function Zl({
  ...
  const [e] = Zt(), [r, o] = T(e), [n, i] = T("paragraph"), [s, c] = Jl(), l = () => {
  };
...
function ad({
  ...
  return /* @__PURE__ */ u("div", { className: "tw:relative", children: [
    /* @__PURE__ */ a(Zl, { children: () => /* @__PURE__ */ a("div", { className: "tw:sticky tw:top-0 tw:z-10 tw:flex tw:gap-2 tw:overflow-auto tw:border-b tw:p-1", children: /* @__PURE__ */ a(ed, {}) }) }),
      ...
      /* @__PURE__ */ a(
        Vl,
        {
          contentEditable: /* @__PURE__ */ a("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ a(Yl, { placeholder: t }) }),
          ErrorBoundary: Zc
        }
      ),
      e && /* @__PURE__ */ a(Fl, { defaultSelection: "rootEnd" }),
...
function nd(t, e) {
  const r = rc(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const n = [];
...
function An(t, e, r, o = null) {
  ...
  let s = e;
  o !== null && kr(e) && (s = al(o, e, "clone"));
  const c = ne(s) ? s.getChildren() : [], l = ec(t, s.getType());
  let d;
...
function sd(t, e, r) {
  ...
  for (let s = 0; s < e.length; s++) {
    const c = e[s];
    if (yr(c)) o && !c.getFormat() && c.setFormat(o), n.push(c);
    else if (i.push(c), s === e.length - 1 || s < e.length - 1 && yr(e[s + 1])) {
      const l = r();
...
function Bn({
  ...
  const s = vo(o, "%cancelButton_tooltip%"), c = i ?? vo(o, "%acceptButton_tooltip%");
...
function ju({
  ...
  const [i, s] = T(dd), [c, l] = T(n), [d, w] = T(!1), g = q(void 0), h = q(null);
  K(() => {
    let v = !0;
    const N = h.current;
    if (!N) return;
...
const Fu = Object.freeze([
  ...
  const n = q(null), [i, s] = T(void 0), [c, l] = T(void 0), d = j(
    (p) => {
      s(p);
...
function Cd({
  ...
  const [C, z] = T(xo), [E, O] = T(), [D, F] = T(), I = o, [G, y] = T(!1), [Y, ft] = T(!1), [nt, Qt] = T(!1), [te, Tt] = T(!1), [U, it] = T(!1), [at, dt] = T(k), [Et, ge] = T(!1), xt = q(void 0), [he, ee] = T(/* @__PURE__ */ new Map());
  K(() => {
    let S = !0;
    return (async () => {
      const gt = x ? await x(l) : !1;
      S && it(gt);
    })(), () => {
      S = !1;
    };
  ...
  K(() => {
    ...
    yt.current === "idle" && (yt.current = "pending"), te ? yt.current === "pending" && A !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
  ...
  const re = P(() => Vt[0], [Vt]), M = q(null), H = q(void 0), Z = j(() => {
    var S;
    (S = H.current) == null || S.call(H), z(xo);
  }, []), wt = j(() => {
    const S = !at;
    dt(S), ge(!S), m == null || m(l, S);
  }, [at, m, l]);
  K(() => {
    y(!1);
  }, [o]), K(() => {
  ...
  const ot = P(
    ...
    () => ut === 1 ? ot.singleReply : ae(ot.multipleReplies, { count: ut }),
    [ut, ot]
  );
  K(() => {
    !o && Y && rt && ft(!1);
  ...
  const mt = j(
    async (S) => {
      ...
      pt && await g({ threadId: l, contents: pt }) && Z();
    },
    [
      Z,
      C,
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
            ...
            /* @__PURE__ */ a(
              bo,
              {
                ...
                handleDeleteComment: p,
                onEditingChange: ft,
                canEditOrDelete: (!Y && he.get(re.id)) ?? !1,
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                      E !== void 0 && (Mt(C) || E !== D) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: ae(
                      ...
                      /* @__PURE__ */ u(we, { open: nt, onOpenChange: Qt, children: [
                        /* @__PURE__ */ a(Ee, { asChild: !0, children: /* @__PURE__ */ a(
                          L,
                          {
                            size: "icon",
                            variant: "outline",
                            className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                            disabled: !te || !b || b.length === 0 || !b.includes(s),
                        ...
                        /* @__PURE__ */ a(
                          ue,
                          {
                            ...
                            align: "end",
                            onKeyDown: (S) => {
                              S.key === "Escape" && (S.stopPropagation(), Qt(!1));
                            },
                            children: /* @__PURE__ */ a(Ne, { children: /* @__PURE__ */ a(Ce, { children: b == null ? void 0 : b.map((S) => /* @__PURE__ */ a(
                              de,
                              {
                                onSelect: () => {
                                  O(S !== i ? S : void 0), yt.current = "user-selected", F(void 0), Qt(!1);
                                },
                                className: "tw:flex tw:items-center",
...
function Ad({
  ...
  return l ? $ = Array.from({ length: 10 }).map((z, E) => `skeleton-row-${E}`).map((z) => /* @__PURE__ */ a(oe, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(ve, { colSpan: k.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(ba, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, z)) : ((V = _.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = _.getRowModel().rows.map((A) => /* @__PURE__ */ a(
    ...
    A.id
  )) : $ = /* @__PURE__ */ a(oe, { children: /* @__PURE__ */ a(ve, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function tp({
  ...
  return /* @__PURE__ */ a(
    "div",
    {
      ...
      children: /* @__PURE__ */ a(hc, { options: i, children: e })
    }
  );
}
  ...
  return /* @__PURE__ */ a("div", { id: v, className: m, children: /* @__PURE__ */ u(we, { open: C, onOpenChange: w ?? x, children: [
    ...
    /* @__PURE__ */ a(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ u(Ne, { children: [
      ...
      /* @__PURE__ */ u(Ce, { children: [
        ...
        /* @__PURE__ */ a(le, { children: $.map((E) => /* @__PURE__ */ u(
          de,
          {
            value: E.label,
            onSelect: _,
...
function Kd({
  ...
  const i = q(null), s = q(null), c = q(!1), [l, d] = T(t), [w, g] = T(r), [h, p] = T(!1);
  K(() => {
    d(t);
  }, [t]), K(() => {
    w !== r && g(r);
  ...
  const m = (v) => {
    ...
    var N, x, _, k;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((N = i.current) == null || N.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((x = s.current) == null || x.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((k = s.current) == null || k.focus(), c.current = !1), l === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && m(!1);
  };
  ...
  return /* @__PURE__ */ u(
    de,
    {
      ...
      children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ a(Ac, { className: "tw:font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
...
function Jd(t, e, r, o) {
  ...
  return Object.entries(n.children).forEach(([, s]) => {
    i.push(
      ...s.map((c) => ({
        marker: c,
        title: r[mr[c].description] ?? mr[c].description,
        action: () => {
          var l;
...
function sp({
  ...
  const [m, b] = T("generated"), [v, N] = T("generated"), [x, _] = T("*"), [k, $] = T("*"), [V, A] = T("f"), [C, z] = T(!1), [E, O] = T(!0), [D, F] = T(!1), I = q(!1), G = q(""), [y, Y] = T(!1), [ft, nt] = T(), [Qt, te] = T(), [Tt, U] = T(), [it, at] = T(), dt = q(null), Et = P(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
      view: { ...s.view ?? fc(), noteMode: "expanded" }
    }),
    [s, c]
  ), ge = P(
    () => Jd(
  ...
  K(() => {
    ...
    if (B && ur("note", B)) {
      ...
      let kt = "custom";
      ut === ca ? kt = "generated" : ut === la ? kt = "hidden" : ut && (_(ut), $(ut)), b(kt), N(kt), A(((st = B.insert.note) == null ? void 0 : st.style) ?? "f"), R = setTimeout(() => {
        var Dt;
  ...
  const xt = j(
    (R, B, rt = !1) => {
      ...
      if (st && ur("note", st)) {
        if (st.insert.note) {
          let mt;
          R === "custom" ? mt = B : R === "generated" ? mt = ca : mt = la, st.insert.note.caller = mt;
        }
  ...
  $t(() => {
    (yt.current.book !== n.book || yt.current.chapterNum !== n.chapterNum) && (yt.current = { book: n.book, chapterNum: n.chapterNum }, ee.current());
  }, [n.book, n.chapterNum]);
  const Vt = () => {
    var B;
    ...
    if (h.current && ge.length && R && R.rangeCount > 0) {
      ...
      nt(B.left - rt.left), te(B.top - rt.top), U(B.height), Y(!0);
    }
  }, [ge, h]);
  K(() => {
    const R = () => {
    ...
    const R = ((rt = g.current) == null ? void 0 : rt.querySelector(".editor-input")) ?? void 0, B = (st) => {
      !y && R && document.activeElement === R && st.key === c ? (st.preventDefault(), ot()) : y && st.key === "Escape" && (st.preventDefault(), Y(!1));
    };
    return document.addEventListener("keydown", B), () => {
      document.removeEventListener("keydown", B);
    };
  }, [y, ot, c]);
  const St = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(et, { children: [
  ...
  return /* @__PURE__ */ u(et, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(et, { children: ew(t.marker, c, o, d) })
      }
    )
  ] });
}
...
function nw({
  ...
  return /* @__PURE__ */ u(Ir, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(Pr, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      oe,
      {
        onClick: () => {
          e(c.reference);
        ...
        children: [
          /* @__PURE__ */ a(ve, { children: De(c.reference, "English") }),
          /* @__PURE__ */ a(ve, { className: o, children: ow(c.text) })
        ]
      },
...
const iw = (t) => {
  ...
  return e ? e[1] : "";
}, cw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", fp = Object.freeze([
...
function mp({
  ...
  }, [A, G]), Y = P(() => y.length === 0 ? [] : lw(y, z, O), [y, z, O]), ft = P(() => {
    var at, dt;
    if (!A) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Ke, { onValueChange: (U) => Qt(U), defaultValue: s, children: [
...
const Hn = ir(({ className: t, ...e }, r) => /* @__PURE__ */ a(cs, { size: 35, className: f("tw:animate-spin", t), ...e, ref: r }));
...
function bp({
  ...
  }, [l, N, $, n]), F = s.length > 0 || l.length > 0;
  return /* @__PURE__ */ u(et, { children: [
    /* @__PURE__ */ a(sn, { className: "tw:px-4 tw:pt-4", children: /* @__PURE__ */ a(cn, { children: _ }) }),
    ...
    F && /* @__PURE__ */ a("p", { className: "tw:px-4 tw:pb-1 tw:text-right tw:text-xs tw:text-muted-foreground", children: ae(O, {
      filtered: w.length,
      total: t.length
    }) }),
...
function hw({
  ...
  const [l, d] = tt.useState(t), w = e ?? l, g = tt.useCallback(
    (_) => {
      const k = typeof _ == "function" ? _(w) : _;
      r ? r(k) : d(k);
    },
    [r, w]
  ), h = tt.useCallback(() => g((_) => !_), [g]), p = w ? "expanded" : "collapsed", v = ct() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = tt.useMemo(
    () => ({
      state: p,
      open: w,
      setOpen: g,
...
function kw({
  ...
  const c = t ? ke.Root : "button", { state: l } = jr(), d = /* @__PURE__ */ a(
    c,
    {
...
const Xn = (t) => {
  ...
  return lt.allBookIds.filter(
    (e, r) => t[r] === "1" && !lt.isObsolete(lt.bookIdToNumber(e))
  );
}, Ba = (t, e) => t.filter((r) => {
  try {
    return Qe(r) === e;
...
}), Jn = (t, e, r) => Ba(t, e).every((o) => r.includes(o));
function Rw({
  availableBookInfo: t,
  selectedBookIds: e,
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: g, ntLong: h, dcLong: p, extraLong: m } = {
          ...
          Ne,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                /* @__PURE__ */ a(L, { variant: "ghost", size: "sm", onClick: E, children: l }),
                ...
                Object.values(W).map((D, F) => {
                  ...
                  if (I.length !== 0)
                    return /* @__PURE__ */ u(Vo, { children: [
                      ...
                      F < Object.values(W).length - 1 && /* @__PURE__ */ a(ln, {})
                    ] }, D);
                })
              ] })
            ]
...
function Mw({
  ...
  const i = Ba(e, t).length === 0, s = n["%scripture_section_ot_short%"], c = n["%scripture_section_nt_short%"], l = n["%scripture_section_dc_short%"], d = n["%scripture_section_extra_short%"];
  return /* @__PURE__ */ a(
    L,
    {
      variant: "outline",
...
function $w({
  ...
  const i = o["%webView_book_selector_more%"], s = P(
    ...
    (l) => {
      const d = Ba(s, l).map((w) => w);
      r(
        Jn(s, l, e) ? e.filter((w) => !d.includes(w)) : [.../* @__PURE__ */ new Set([...e, ...d])]
      );
    },
    [e, r, s]
  );
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    /* @__PURE__ */ a("div", { className: "tw:flex tw:flex-wrap tw:gap-2", children: Object.values(W).map((l) => /* @__PURE__ */ a(
      Mw,
      {
        section: l,
        availableBookIds: s,
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Qr ? Qr : Do
      ).map((l) => /* @__PURE__ */ a(Ue, { className: "tw:hover:bg-secondary", variant: "secondary", children: Ve(l, n) }, l)),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          He,
          {
            ...
            style: { zIndex: Ye },
            children: t.map((d) => /* @__PURE__ */ a(Ft, { value: `${d}`, children: c[J(d)] }, `${d}`))
          }
        )
      ]
    }
...
const Qn = (t, e, r, o) => r ? Object.entries(t).filter(
...
).sort(([, i], [, s]) => i.order - s.order).flatMap(([i]) => e.filter((c) => c.group === i).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(At, { children: [
  /* @__PURE__ */ a(It, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    ...
    /* @__PURE__ */ a(_d, { children: c.label }),
...
function xa({
  ...
  return /* @__PURE__ */ u(be, { variant: i, children: [
    /* @__PURE__ */ a(xe, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(L, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(ds, {}) }) }),
    /* @__PURE__ */ a(ye, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(Vo, { children: [
      /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(Ot, { children: Qn(e.groups, e.items, l, t) }) }),
...
function Up({
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(ei, { children: [
      /* @__PURE__ */ a(ri, { children: t.map((c) => /* @__PURE__ */ a(Aw, { value: c.value, children: c.value }, c.key)) }),
...
function Pw({ ...t }) {
  return /* @__PURE__ */ a(Xt.Menu, { "data-slot": "menubar-menu", ...t });
}
function Lw({ ...t }) {
  return /* @__PURE__ */ a(Xt.Portal, { "data-slot": "menubar-portal", ...t });
}
function Vw({
  className: t,
  ...e
...
function Uw({ ...t }) {
  return /* @__PURE__ */ a(Xt.Sub, { "data-slot": "menubar-sub", ...t });
}
function Kw({
  className: t,
  inset: e,
...
const Ze = (t, e) => {
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ u(At, { children: [
    ...
    return c.length > 0 && s < n.length - 1 && l.push(/* @__PURE__ */ a(Bw, {}, `separator-${i}`)), l;
  });
};
function qw({
  menuData: t,
  ...
  if (vc(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, g) => {
    var m, b, v, N;
    w.preventDefault();
    ...
    switch (g.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (v = c.current) == null || v.focus(), Ze(c, [h, p]);
        break;
      case "alt+h":
...
function qp({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: f("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(ht, { className: "tw:font-normal tw:text-muted-foreground", children: ae(d, {
