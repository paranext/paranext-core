...
import p, { forwardRef as Ge, useRef as W, useCallback as B, useMemo as G, useState as P, useLayoutEffect as hn, createContext as Br, useContext as jr, useEffect as Mt, Fragment as En } from "react";
import { Command as rt } from "cmdk";
import { X as He, Search as Vn, Check as _t, ChevronsLeft as fn, ChevronsRight as gn, ChevronLeft as Oe, ChevronRight as Ot, ArrowLeft as Lr, ArrowRight as $r, Circle as he, ChevronsUpDown as Ye, FilterIcon as Xr, ChevronDown as fe, ChevronUp as Fr, ArrowLeftIcon as Gr, ChevronLeftIcon as Hr, ChevronRightIcon as Yr, ArrowRightIcon as Ur, Copy as Kr, Filter as qr, User as Jr, Link as Wr, CircleHelp as Zr, Star as Qr, CircleCheckIcon as ta, CircleXIcon as ea, CircleHelpIcon as na, ArrowUpIcon as ra, ArrowDownIcon as aa, ArrowUpDownIcon as oa, PanelLeft as sa, PanelRight as ia, ScrollText as wa, MenuIcon as la, Menu as da, EllipsisVertical as ca, LoaderCircle as pa } from "lucide-react";
import { clsx as ua } from "clsx";
import { extendTailwindMerge as ma } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { Section as H, getChaptersForBook as ha, getLocalizedSectionNames as Mn, getSectionLongName as Dn, formatScrRef as Jt, getSectionForBook as ce, NumberFormat as fa, formatBytes as ga, deepEqual as Ue, isString as Re, compareScrRefs as Ae, scrRefToBBBCCCVVV as Te, getSectionShortName as ba, getLocalizeKeyForScrollGroupId as O } from "platform-bible-utils";
...
import { useReactTable as In, getFilteredRowModel as va, getSortedRowModel as On, getPaginationRowModel as xa, getCoreRowModel as An, flexRender as Wt, getGroupedRowModel as ya, getExpandedRowModel as Na } from "@tanstack/react-table";
import * as j from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as ka } from "@radix-ui/react-dropdown-menu";
...
import { useHotkeys as _a } from "react-hotkeys-hook";
...
const Ra = ma({ prefix: "tw-" });
function d(...t) {
  return Ra(ua(t));
}
const Ta = "layoutDirection";
function K() {
  const t = localStorage.getItem(Ta);
  return t === "rtl" ? t : "ltr";
}
const Ea = ft.Portal, jn = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
Va.displayName = ft.Content.displayName;
...
Da.displayName = ft.Description.displayName;
...
oe.displayName = rt.Input.displayName;
...
se.displayName = rt.List.displayName;
const be = p.forwardRef((t, e) => /* @__PURE__ */ r(rt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
be.displayName = rt.Empty.displayName;
const At = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Group,
  {
    ref: n,
    className: d(
...
At.displayName = rt.Group.displayName;
...
var za = Object.defineProperty, Ia = (t, e, n) => e in t ? za(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => Ia(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
function Fa(t) {
  return $n[t - 1].includes("*obsolete*");
}
function Ga() {
  const t = {};
...
E(ot, "Original", new ot(ut.Original)), E(ot, "Septuagint", new ot(ut.Septuagint)), E(ot, "Vulgate", new ot(ut.Vulgate)), E(ot, "English", new ot(ut.English)), E(ot, "RussianProtestant", new ot(ut.RussianProtestant)), E(ot, "RussianOrthodox", new ot(ut.RussianOrthodox));
let Et = ot;
function vn(t, e) {
  const n = e[0];
...
const nt = class M {
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Et(i)), n ? new M(n, a.toString(), w, u) : new M();
  }
  /**
  ...
  parse(e) {
    ...
    if (a.length !== 2 || A.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !M.isVerseParseable(a[1]))
      throw new Ut("Invalid reference : " + e);
  ...
  updateInternal(e, n, a) {
    this.bookNum = A.bookIdToNumber(e), this.chapter = n, this.verse = a;
  }
};
E(nt, "defaultVersification", Et.English), E(nt, "verseRangeSeparator", "-"), E(nt, "verseSequenceIndicator", ","), E(nt, "verseRangeSeparators", [nt.verseRangeSeparator]), E(nt, "verseSequenceIndicators", [nt.verseSequenceIndicator]), E(nt, "chapterDigitShifter", 1e3), E(nt, "bookDigitShifter", nt.chapterDigitShifter * nt.chapterDigitShifter), E(nt, "bcvMaxValue", nt.chapterDigitShifter - 1), /**
...
const Un = Ge(
  ({
    ...
    const m = W(!1), g = () => {
      ...
      m.current = !0, a ? a(R) : n == null || n(t);
    }, f = w && ((v = w.get(t)) == null ? void 0 : v.localizedName) || A.bookIdToEnglishName(t), b = w && ((x = w.get(t)) == null ? void 0 : x.localizedId) || t.toLocaleUpperCase();
    return /* @__PURE__ */ r(
      "div",
      {
        className: d(
          ...
          {
            "tw-border-s-red-200": o === H.OT,
            "tw-border-s-purple-200": o === H.NT,
            "tw-border-s-indigo-200": o === H.DC,
            "tw-border-s-amber-200": o === H.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          Xt,
          {
            ref: c,
            value: u || `${t} ${A.bookIdToEnglishName(t)}`,
            onSelect: g,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Lt : "button", { className: d(Ha({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
const Kn = A.allBookIds.filter(
  (t) => !A.isObsolete(A.bookIdToNumber(t))
), mt = Object.fromEntries(
  Kn.map((t) => [t, A.bookIdToEnglishName(t)])
), Ee = {
...
function qn(t, e, n) {
  ...
  if (!a) return !1;
  const o = mt[t], s = n == null ? void 0 : n.get(t), i = o.toLowerCase().includes(a) || t.toLowerCase().includes(a), w = s ? s.localizedName.toLowerCase().includes(a) || s.localizedId.toLowerCase().includes(a) : !1;
  return i || w;
}
function ht(t) {
  return ha(A.bookIdToNumber(t));
}
function Ua(t, e, n) {
  ...
  const a = Ya.reduce(
    (o, s) => {
      ...
      if (i) {
        ...
        let m;
        const g = e.filter((h) => qn(h, w, n));
        if (g.length === 1 && ([m] = g), !m && u) {
          if (A.isBookIdValid(w)) {
...
function Ka(t, e, n, a) {
  const o = B(() => {
    if (t.chapterNum > 1)
      ...
      if (u > 0) {
        const c = e[u - 1], m = Math.max(ht(c), 1);
        a({
          book: c,
          chapterNum: m,
          verseNum: 1
...
function Nn({
  ...
  if (t)
    return /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r("div", { className: d("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: ht(t) }, (i, w) => w + 1).map((i) => /* @__PURE__ */ r(
      Xt,
      {
        value: `${t} ${mt[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function ci({
  ...
  var cn, pn, un;
  const i = K(), [w, u] = P(!1), [c, m] = P(""), [g, h] = P(""), [f, b] = P("books"), [v, x] = P(void 0), [R, C] = P(!1), V = W(void 0), D = W(void 0), Y = W(void 0), it = W(void 0), gt = W({}), _ = G(() => a ? a() : Kn, [a]), T = G(() => ({
    [H.OT]: _.filter((I) => A.isBookOT(I)),
    [H.NT]: _.filter((I) => A.isBookNT(I)),
    [H.DC]: _.filter((I) => A.isBookDC(I)),
    [H.Extra]: _.filter((I) => A.extraBooks().includes(I))
  }), [_]), Z = G(() => Object.values(T).flat(), [T]), y = G(() => {
    if (!g.trim()) return T;
    const N = {
      [H.OT]: [],
      [H.NT]: [],
    ...
    return [H.OT, H.NT, H.DC, H.Extra].forEach((F) => {
      N[F] = T[F].filter((Q) => qn(Q, g, o));
    }), N;
  }, [T, g, o]), k = G(
    () => Ua(g, Z, o),
    [g, Z, o]
    ...
    (N) => {
      const I = f === "chapters" ? v : k == null ? void 0 : k.book;
      I && (e({
        book: I,
        chapterNum: N,
        verseNum: 1
      }), u(!1), b("books"), x(void 0), h(""));
    },
    [e, f, v, k]
  ), Ht = Ka(t, Z, i, e), wt = B(() => {
    ...
    (N) => {
      ...
      u(N), N && (b("books"), x(void 0), h(""));
    },
    [f, wt]
  ), { otLong: J, ntLong: lt, dcLong: pt, extraLong: bt } = Mn(s), Dr = B(
    (N) => Dn(N, J, lt, pt, bt),
    [J, lt, pt, bt]
  ), zr = B(
    (N) => k ? !!k.chapterNum && !N.toString().includes(k.chapterNum.toString()) : !1,
    [k]
  ), Ir = G(
    () => {
      var N;
      return Jt(
        t,
        o && ((N = o.get(t.book)) == null ? void 0 : N.localizedName) || "English"
      );
    },
    [t, o]
  ), dn = B((N) => (I) => {
    ...
    (N) => {
      if (N.ctrlKey) return;
      const { isLetter: I, isDigit: F } = xn(N.key);
      if (f === "chapters") {
        if (N.key === "Backspace") {
          N.preventDefault(), N.stopPropagation(), wt();
          return;
        }
        if (I || F) {
          if (N.preventDefault(), N.stopPropagation(), b("books"), x(void 0), F && v) {
            const Q = mt[v];
            h(`${Q} ${N.key}`);
          } else
            h(N.key);
      ...
      if ((f === "chapters" || f === "books" && k) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(N.key)) {
        const Q = f === "chapters" ? v : k == null ? void 0 : k.book;
        if (!Q) return;
        const et = (() => {
          if (!c) return 1;
          const Yt = c.match(/(\d+)$/);
        ...
        switch (N.key) {
          case "ArrowLeft":
            et !== 0 && (vt = et > 1 ? et - 1 : Rt);
            break;
          case "ArrowRight":
            et !== 0 && (vt = et < Rt ? et + 1 : 1);
            break;
          case "ArrowUp":
            vt = et === 0 ? Rt : Math.max(1, et - mn);
            break;
          case "ArrowDown":
            vt = et === 0 ? 1 : Math.min(Rt, et + mn);
            break;
          default:
            return;
        }
        vt !== et && (N.preventDefault(), N.stopPropagation(), m(yn(Q, vt)), setTimeout(() => {
    ...
    const { isLetter: I, isDigit: F } = xn(N.key);
    (I || F) && (N.preventDefault(), h((Q) => Q + N.key), D.current.focus(), C(!1));
  }, []);
  return hn(() => {
    const N = setTimeout(() => {
      if (w && f === "books" && Y.current && it.current) {
        const I = Y.current, F = it.current, Q = F.offsetTop, et = I.clientHeight, Rt = F.clientHeight, vt = Q - et / 2 + Rt / 2;
        I.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), m(yn(t.book));
    ...
    if (f === "chapters" && v) {
      ...
      setTimeout(() => {
        if (Y.current)
          if (N) {
            const I = gt.current[t.chapterNum];
  ...
  }, [f, v, k, t.book, t.chapterNum]), /* @__PURE__ */ l(ie, { open: w, onOpenChange: S, children: [
      ...
      ae,
      {
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Ht.map(({ onClick: N, disabled: I, title: F, icon: Q }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: o && ((cn = o.get(v || "")) == null ? void 0 : cn.localizedName) || mt[v || ""] || "" })
          ] }),
          !R && /* @__PURE__ */ l(se, { ref: Y, children: [
            f === "books" && /* @__PURE__ */ l(Zt, { children: [
              !k && Object.entries(y).map(([N, I]) => {
                if (I.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(At, { heading: Dr(N), children: I.map((F) => /* @__PURE__ */ r(
                      Un,
                      {
                        bookId: F,
                        onSelect: (Q) => q(Q),
              ...
              k && /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r(
                Xt,
                {
                  value: `${k.book} ${mt[k.book]} ${k.chapterNum || ""}:${k.verseNum || ""})}`,
                  onSelect: tt,
                  ...
                  children: Jt(
                    ...
                    o && ((pn = o.get(k.book)) == null ? void 0 : pn.localizedId) || void 0
                  )
                },
                "top-match"
              ) }),
              k && ht(k.book) > 1 && /* @__PURE__ */ l(Zt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: o && ((un = o.get(k.book)) == null ? void 0 : un.localizedName) || mt[k.book] }),
                /* @__PURE__ */ r(
                  Nn,
                  {
                    bookId: k.book,
...
), U = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(zn.Root, { ref: n, className: d("pr-twp", qa(), t), ...e }));
U.displayName = zn.Root.displayName;
const We = p.forwardRef(({ className: t, ...e }, n) => {
  const a = K();
  return /* @__PURE__ */ r(
    te.Root,
    {
...
function Le({
  ...
  const [x, R] = P(!1);
  return /* @__PURE__ */ l(ie, { open: x, onOpenChange: R, ...v, children: [
    /* @__PURE__ */ r(we, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ye, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ l(ae, { children: [
          ...
          /* @__PURE__ */ r(se, { children: e.map((C) => /* @__PURE__ */ l(
            Xt,
            {
              value: w(C),
              onSelect: () => {
...
function mi({
  ...
  const m = Ve(c, "%webView_bookSelector_currentBook%"), g = Ve(c, "%webView_bookSelector_choose%"), h = Ve(c, "%webView_bookSelector_chooseBooks%"), [f, b] = P(
    "current book"
    /* CURRENT_BOOK */
  ), v = (x) => {
    b(x), t(x);
    ...
    We,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(U, { className: "tw-flex tw-items-center", children: a.map((x) => A.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
}), Jn = j.Trigger, Wn = j.Group, Qa = j.Portal, to = j.Sub, eo = j.RadioGroup;
function Qe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ze.Provider, { value: n, children: /* @__PURE__ */ r(j.Root, { ...e }) });
}
const Zn = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  ...
  return /* @__PURE__ */ l(
    j.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(Ot, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
Zn.displayName = j.SubTrigger.displayName;
...
ve.displayName = j.Content.displayName;
const tr = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = K(), s = ct();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
tr.displayName = j.Item.displayName;
const tn = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
...
tn.displayName = j.CheckboxItem.displayName;
const er = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ct();
  return /* @__PURE__ */ l(
    j.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(j.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
er.displayName = j.RadioItem.displayName;
const en = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
...
en.displayName = j.Label.displayName;
...
xe.displayName = j.Separator.displayName;
...
function ro({ table: t }) {
  return /* @__PURE__ */ l(Qe, { children: [
    /* @__PURE__ */ r(ka, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Xr, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Pt = X.Root, ao = X.Group, Bt = X.Value, oo = St(
  ...
  return /* @__PURE__ */ l(
    X.Trigger,
    {
      className: d(oo({ size: n, className: t })),
      ref: o,
      ...a,
      dir: s,
      children: [
        e,
        /* @__PURE__ */ r(X.Icon, { asChild: !0, children: /* @__PURE__ */ r(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
zt.displayName = X.Trigger.displayName;
...
nr.displayName = X.ScrollUpButton.displayName;
...
rr.displayName = X.ScrollDownButton.displayName;
const It = p.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = K();
...
It.displayName = X.Content.displayName;
...
const st = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  X.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(X.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(X.ItemText, { children: e })
    ]
  }
));
st.displayName = X.Item.displayName;
...
io.displayName = X.Separator.displayName;
function wo({ table: t }) {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        Pt,
        {
          ...
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Bt, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(It, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(st, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ee(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (a) => !a.hasAttribute("disabled") && !a.getAttribute("aria-hidden") && lo(a)
  );
}
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        ee(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? ee(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const w = p.useMemo(
    ...
    (m) => {
      ...
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), mo(f, b, m.key);
      else if (m.key === "ArrowLeft" || m.key === "ArrowRight")
        m.preventDefault(), uo(w, v, m.key);
...
function fo({
  ...
  var x;
  const [w, u] = P([]), [c, m] = P([]), [g, h] = P({}), [f, b] = P({}), v = In({
    data: e,
    columns: t,
    getCoreRowModel: An(),
    ...n && { getPaginationRowModel: xa() },
    onSortingChange: u,
    getSortedRowModel: On(),
    onColumnFiltersChange: m,
    getFilteredRowModel: va(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ro, { table: v }),
    /* @__PURE__ */ l(ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: s, children: v.getHeaderGroups().map((R) => /* @__PURE__ */ r(Ct, { children: R.headers.map((C) => /* @__PURE__ */ r(ne, { children: C.isPlaceholder ? void 0 : Wt(C.column.columnDef.header, C.getContext()) }, C.id)) }, R.id)) }),
      /* @__PURE__ */ r(ke, { children: (x = v.getRowModel().rows) != null && x.length ? v.getRowModel().rows.map((R) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(R, v),
          "data-state": R.getIsSelected() && "selected",
          children: R.getVisibleCells().map((C) => /* @__PURE__ */ r(jt, { children: Wt(C.column.columnDef.cell, C.getContext()) }, C.id))
        },
        R.id
      )) : /* @__PURE__ */ r(Ct, { children: /* @__PURE__ */ r(jt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function go({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(z, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Kr, {}) })
    ] }),
...
function gi({
  ...
  return /* @__PURE__ */ l(ie, { children: [
    ...
    /* @__PURE__ */ r(Gt, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      go,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function bi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(Qe, { children: [
    /* @__PURE__ */ r(Jn, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((c, m) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(en, { children: c.label }),
      /* @__PURE__ */ r(Wn, { children: c.itemType === 0 ? /* @__PURE__ */ r(Zt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        tn,
        {
          checked: a[m][h],
        ...
        eo,
        {
          ...
          children: c.items.map((g) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(er, { value: g.id, children: g.label }) }, g.id))
        }
      ) }),
      /* @__PURE__ */ r(xe, {})
    ] }, c.label)) })
...
function yo({
  ...
  const [g, h] = P(!1), f = B(
    (x) => {
      var C;
      const R = (C = t.find((V) => V.label === x)) == null ? void 0 : C.value;
      R && a(
        n.includes(R) ? n.filter((V) => V !== R) : [...n, R]
      );
    },
    [t, n, a]
  ), b = () => i || o, v = G(() => {
    if (!u) return t;
    const x = t.filter((C) => C.starred).sort((C, V) => C.label.localeCompare(V.label)), R = t.filter((C) => !C.starred).sort((C, V) => {
      const D = n.includes(C.value), Y = n.includes(V.value);
      return D && !Y ? -1 : !D && Y ? 1 : C.label.localeCompare(V.label);
    });
    return [...x, ...R];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(ie, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(we, { asChild: !0, children: /* @__PURE__ */ l(
      z,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ye, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ae, { children: [
      ...
      /* @__PURE__ */ l(se, { children: [
        /* @__PURE__ */ r(be, { children: s }),
        /* @__PURE__ */ r(At, { children: v.map((x) => {
          const R = e ? e(x) : void 0;
          return /* @__PURE__ */ l(
            Xt,
            {
              value: x.label,
              ...
              children: [
                ...
                e && /* @__PURE__ */ r("div", { className: "tw-w-10 tw-text-end tw-text-muted-foreground", children: R })
              ]
            },
            x.label
          );
...
function No({
  ...
  return /* @__PURE__ */ l(ye, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ne, { stickyHeader: !0, children: /* @__PURE__ */ l(Ct, { children: [
    ...
    /* @__PURE__ */ r(ke, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(jt, { children: `${A.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(jt, { children: i.text })
        ]
      },
...
), ko = p.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Pn.Root,
  {
    ref: o,
    className: d(ar({ variant: e, size: n, className: t })),
    ...a
  }
));
...
const or = p.createContext({
  size: "default",
  variant: "default"
}), sr = p.forwardRef(({ className: t, variant: e, size: n, children: a, ...o }, s) => {
  const i = K();
  return /* @__PURE__ */ r(
    ge.Root,
    {
...
const de = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = p.useContext(or);
  return /* @__PURE__ */ r(
    ge.Item,
    {
      ref: s,
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(ra, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(aa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(oa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ni = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ l(sr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        de,
        {
          onClick: (u) => {
            u.stopPropagation(), Me(
              [w],
              "approved",
              e,
              n,
...
function Ei({
  ...
  const c = xt(n, "%webView_inventory_all%"), m = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), R = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, V] = P(!1), [D, Y] = P("all"), [it, gt] = P(""), [_, T] = P([]), Z = G(() => t.length === 0 ? [] : Ro(t, o, s), [t, o, s]), y = G(() => {
    if (C) return Z;
    const S = [];
    return Z.forEach((J) => {
      const lt = J.items[0], pt = S.find(
        (bt) => bt.items[0] === lt
      );
      pt ? (pt.count += J.count, pt.occurrences = pt.occurrences.concat(J.occurrences)) : S.push({
        items: [lt],
        count: J.count,
  ...
  }, [C, Z]), k = G(() => So(y, D, it), [y, D, it]), tt = G(() => {
    var lt, pt;
    if (!C) return u;
    const S = (lt = a == null ? void 0 : a.tableHeaders) == null ? void 0 : lt.length;
    if (!S) return u;
    const J = [];
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        Pt,
        {
          onValueChange: (S) => Ht(S),
          defaultValue: D,
          children: [
            /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(Bt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l(Pt, { onValueChange: (S) => Nt(S), defaultValue: i, children: [
        /* @__PURE__ */ r(zt, { className: "tw-m-1", children: /* @__PURE__ */ r(Bt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(It, { children: [
          /* @__PURE__ */ r(st, { value: "book", children: f }),
          /* @__PURE__ */ r(st, { value: "chapter", children: b }),
          /* @__PURE__ */ r(st, { value: "verse", children: v })
        ] })
      ] }),
      /* @__PURE__ */ r(
        le,
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(U, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? R })
      ] })
    ] }),
...
const rn = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Bn.Root,
  {
    ref: o,
    decorative: n,
...
rn.displayName = Bn.Root.displayName;
...
const an = re.Provider, on = re.Root, sn = re.Trigger, _e = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  re.Content,
  {
    ref: a,
    sideOffset: e,
...
const To = "16rem", Eo = "3rem", ir = p.createContext(void 0);
function Se() {
  const t = p.useContext(ir);
  if (!t)
...
const wr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), g = e ?? c, h = p.useCallback(
      ...
      [n, g]
    ), f = p.useCallback(() => h((V) => !V), [h]), b = g ? "expanded" : "collapsed", R = K() === "ltr" ? i : i === "primary" ? "secondary" : "primary", C = p.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(ir.Provider, { value: C, children: /* @__PURE__ */ r(an, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
wr.displayName = "SidebarProvider";
const lr = p.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = Se();
...
lr.displayName = "Sidebar";
const Vo = p.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = Se();
  return /* @__PURE__ */ l(
    z,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ r(sa, {}) : /* @__PURE__ */ r(ia, {}),
...
dr.displayName = "SidebarInset";
const Do = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  le,
  {
    ref: n,
    "data-sidebar": "input",
...
Oo.displayName = "SidebarSeparator";
...
$e.displayName = "SidebarGroup";
const Xe = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Lt : "div",
  {
    ref: a,
...
const Ao = p.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Lt : "button",
  {
    ref: a,
...
ur.displayName = "SidebarMenuItem";
const Po = St(
  ...
  ({
    ...
    const u = t ? Lt : "button", { state: c } = Se(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: d(Po({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(sn, { asChild: !0, children: m }),
      /* @__PURE__ */ r(_e, { side: "right", align: "center", hidden: c !== "collapsed", ...o })
    ] })) : m;
  }
);
mr.displayName = "SidebarMenuButton";
const Bo = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Lt : "button",
  {
    ref: o,
...
Xo.displayName = "SidebarMenuSubItem";
const Fo = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Lt : "a",
  {
    ref: s,
...
function Go({
  ...
  return /* @__PURE__ */ r(
    lr,
    {
      ...
      children: /* @__PURE__ */ l(cr, { children: [
        /* @__PURE__ */ l($e, { children: [
          /* @__PURE__ */ r(Xe, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Fe, { children: /* @__PURE__ */ r(pr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ur, { children: /* @__PURE__ */ r(
            mr,
            {
              onClick: () => c(h),
              isActive: g(h),
    ...
    /* @__PURE__ */ l(
      wr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(dr, { className: "tw-min-w-[215px]", children: a })
        ]
      }
    )
  ] });
}
const kt = "scrBook", Ho = "scrRef", Vt = "source", Yo = "details", Uo = "Scripture Reference", Ko = "Scripture Book", hr = "Type", qo = "Details";
function Jo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? A.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === kt ? Jt(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: Vt,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? hr : void 0,
...
const Wo = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Ae(t.start, t.end) === 0 ? `${Te(t.start)}+${e}` : `${Te(t.start)}+${e}-${Te(t.end)}+${n}`;
...
function Mi({
  ...
  const [u, c] = P([]), [m, g] = P([{ id: kt, desc: !1 }]), [h, f] = P({}), b = G(
  ...
  Mt(() => {
    if (w) {
      const _ = x.getSelectedRowModel().rowsById, T = Object.keys(_);
      if (T.length === 1) {
        const Z = b.find((y) => Sn(y) === T[0]) || void 0;
        Z && w(Z);
      }
    }
  }, [h, b, w, x]);
  const R = o ?? Ko, C = s ?? hr, V = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${R}`, value: [kt] },
    { label: `Group by ${C}`, value: [Vt] },
    {
  ...
  }, it = (_, T) => _.getIsGrouped() ? "" : d("banded-row", T % 2 === 0 ? "even" : "odd"), gt = (_, T, Z) => {
    if (!((_ == null ? void 0 : _.length) === 0 || T.depth < Z.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      Pt,
      {
        ...
        children: [
          /* @__PURE__ */ r(zt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Bt, {}) }),
          /* @__PURE__ */ r(It, { position: "item-aligned", children: /* @__PURE__ */ r(ao, { children: V.map((_) => /* @__PURE__ */ r(st, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: x.getHeaderGroups().map((_) => /* @__PURE__ */ r(Ct, { children: _.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(ne, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          Wt(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, _.id)) }),
      /* @__PURE__ */ r(ke, { children: x.getRowModel().rows.map((_, T) => {
        const Z = K();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            className: d(it(_, T)),
            onClick: (y) => Y(_, y),
            children: _.getVisibleCells().map((y) => {
              if (!(y.getIsPlaceholder() || y.column.columnDef.enableGrouping && !y.getIsGrouped() && (y.column.columnDef.id !== Vt || !n)))
                return /* @__PURE__ */ r(
                  jt,
                  {
                    className: d(
                    ...
                    children: y.getIsGrouped() ? /* @__PURE__ */ l(
                      z,
                      {
                        variant: "link",
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (Z === "ltr" ? /* @__PURE__ */ r(Ot, {}) : /* @__PURE__ */ r(Oe, {})),
                          " ",
                          Wt(y.column.columnDef.cell, y.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
const ln = (t, e) => t.filter((n) => {
  try {
    return ce(n) === e;
  } catch {
    return !1;
  }
}), fr = (t, e, n) => ln(t, e).every((a) => n.includes(a));
function Zo({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = ln(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    z,
    {
      variant: "outline",
      ...
      onClick: () => a(t),
      className: d(
        fr(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: ba(
        t,
...
function Qo({
  ...
  const s = a["%webView_book_selector_books_selected%"], i = a["%webView_book_selector_select_books%"], w = a["%webView_book_selector_search_books%"], u = a["%webView_book_selector_select_all%"], c = a["%webView_book_selector_clear_all%"], m = a["%webView_book_selector_no_book_found%"], g = a["%webView_book_selector_more%"], { otLong: h, ntLong: f, dcLong: b, extraLong: v } = Mn(a), [x, R] = P(!1), C = W(void 0), V = W(!1);
  if (t.length !== A.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const D = G(() => A.allBookIds.filter(
    (y, k) => t[k] === "1" && !A.isObsolete(A.bookIdToNumber(y))
  ), [t]), Y = B(
    (y, k = !1) => {
      if (!k || !C.current) {
        n(
          e.includes(y) ? e.filter((S) => S !== y) : [...e, y]
        ), C.current = y;
        return;
      }
      const tt = D.findIndex((S) => S === C.current), q = D.findIndex((S) => S === y);
      if (tt === -1 || q === -1) return;
      const [Nt, Ht] = [
        Math.min(tt, q),
        Math.max(tt, q)
      ], wt = D.slice(Nt, Ht + 1).map((S) => S);
      n(
        e.includes(y) ? e.filter((S) => !wt.includes(S)) : [.../* @__PURE__ */ new Set([...e, ...wt])]
      );
    },
    [e, n, D]
  ), it = (y) => {
    Y(y, V.current), V.current = !1;
  }, gt = (y, k) => {
    y.preventDefault(), Y(k, y.shiftKey);
  }, _ = B(
    (y) => {
      const k = ln(D, y).map((tt) => tt);
      n(
        fr(D, y, e) ? e.filter((tt) => !k.includes(tt)) : [.../* @__PURE__ */ new Set([...e, ...k])]
      );
    },
    [e, n, D]
  ), T = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(H).map((y) => /* @__PURE__ */ r(
      Zo,
      {
        section: y,
        availableBookIds: D,
    ...
    /* @__PURE__ */ l(ie, { open: x, onOpenChange: R, children: [
      /* @__PURE__ */ r(we, { asChild: !0, children: /* @__PURE__ */ l(
        z,
        {
          variant: "outline",
        ...
        ae,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: T, children: u }),
              /* @__PURE__ */ r(z, { variant: "ghost", size: "sm", onClick: Z, children: c })
            ] }),
            /* @__PURE__ */ l(se, { children: [
              /* @__PURE__ */ r(be, { children: m }),
              Object.values(H).map((y, k) => {
                const tt = D.filter(
                  (q) => ce(q) === y
                );
                if (tt.length !== 0)
                  return /* @__PURE__ */ l(En, { children: [
                    /* @__PURE__ */ r(
                      At,
                      {
                        heading: Dn(y, h, f, b, v),
                        children: tt.map((q) => /* @__PURE__ */ r(
                          Un,
                          {
                            bookId: q,
                            isSelected: e.includes(q),
                            onSelect: () => it(q),
                            onMouseDown: (Nt) => gt(Nt, q),
                            section: ce(q),
                            showCheck: !0,
                            localizedBookNames: o,
                            commandValue: q,
                    ...
                    k < Object.values(H).length - 1 && /* @__PURE__ */ r(Ln, {})
                  ] }, y);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var k;
        return /* @__PURE__ */ r(ue, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((k = o.get(y)) == null ? void 0 : k.localizedName) || A.bookIdToEnglishName(y) || y }, y);
      }),
...
function zi({
  ...
  ], x = e ? v.filter((R) => e.includes(R.value)) : v;
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        We,
        {
          ...
          children: x.map(({ value: R, label: C, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(pe, { className: "tw-me-2", value: R, id: V }),
            /* @__PURE__ */ r(U, { htmlFor: V, children: C })
          ] }, V))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          It,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(st, { value: `${u}`, children: i[O(u)] }, `${u}`))
          }
        )
      ]
    }
...
const br = (t, e, n, a) => n ? Object.entries(t).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(on, { children: [
  /* @__PURE__ */ r(sn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    tr,
    {
      onClick: () => {
        a(w);
    ...
    /* @__PURE__ */ r(Zn, { children: w.label }),
    /* @__PURE__ */ r(Qa, { children: /* @__PURE__ */ r(Qn, { children: br(
      t,
      e,
      gr(t, w.id),
      a
...
function Tn({
  ...
  return /* @__PURE__ */ l(Qe, { variant: s, children: [
    /* @__PURE__ */ r(Jn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(z, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(la, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(En, { children: [
      /* @__PURE__ */ r(Wn, { children: /* @__PURE__ */ r(an, { children: br(e.groups, e.items, w, t) }) }),
...
vr.displayName = at.List.displayName;
...
xr.displayName = at.List.displayName;
...
)), yr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Content,
  {
    ref: n,
    className: d(
...
yr.displayName = at.Content.displayName;
function ji({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(vr, { children: [
      /* @__PURE__ */ r(xr, { children: t.map((i) => /* @__PURE__ */ r(ts, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ r(yr, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
function es({ ...t }) {
  return /* @__PURE__ */ r(L.Menu, { ...t });
}
function ns({ ...t }) {
  return /* @__PURE__ */ r(L.Sub, { "data-slot": "menubar-sub", ...t });
}
...
Nr.displayName = L.Root.displayName;
const kr = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ct();
  return /* @__PURE__ */ r(
    L.Trigger,
    {
...
kr.displayName = L.Trigger.displayName;
const Cr = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    L.SubTrigger,
    {
...
Cr.displayName = L.SubTrigger.displayName;
const _r = p.forwardRef(({ className: t, ...e }, n) => {
  const a = ct();
  return /* @__PURE__ */ r(
    L.SubContent,
    {
...
_r.displayName = L.SubContent.displayName;
const Sr = p.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ct();
  return /* @__PURE__ */ r(L.Portal, { children: /* @__PURE__ */ r(
    L.Content,
    {
      ref: s,
      align: e,
...
Sr.displayName = L.Content.displayName;
const Rr = p.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ct();
  return /* @__PURE__ */ r(
    L.Item,
    {
...
Rr.displayName = L.Item.displayName;
const rs = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ct();
  return /* @__PURE__ */ l(
    L.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(L.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
rs.displayName = L.CheckboxItem.displayName;
const as = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ct();
  return /* @__PURE__ */ l(
    L.RadioItem,
    {
...
as.displayName = L.RadioItem.displayName;
const os = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  L.Label,
  {
    ref: a,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
os.displayName = L.Label.displayName;
...
Tr.displayName = L.Separator.displayName;
const Kt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(on, { children: [
      /* @__PURE__ */ r(sn, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        Rr,
        {
          onClick: () => {
            a(c);
    ...
    return w.length > 0 && i < o.length - 1 && u.push(/* @__PURE__ */ r(Tr, {}, `separator-${s}`)), u;
  });
};
function ss({
  menuData: t,
  ...
  const o = W(void 0), s = W(void 0), i = W(void 0), w = W(void 0), u = W(void 0), c = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (_a(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    var b, v, x, R;
    m.preventDefault();
    ...
    switch (g.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Kt(s, [h, f]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), Kt(i, [h, f]);
        break;
      case "alt+n":
        (x = w.current) == null || x.focus(), Kt(w, [h, f]);
        break;
      case "alt+h":
        (R = u.current) == null || R.focus(), Kt(u, [h, f]);
        break;
    }
  }), Mt(() => {
    ...
    return /* @__PURE__ */ r(Nr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(es, { children: [
      /* @__PURE__ */ r(kr, { ref: c(m), children: typeof g == "object" && "label" in g && g.label }),
      /* @__PURE__ */ r(
        Sr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(an, { children: Er(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Xi({
  ...
  const u = is(
    ...
    o && o(f), a && a([f, ...n.filter((b) => b !== f)]), s && n.find((b) => b === f) && s([...n.filter((b) => b !== f)]), m(!1);
  }, h = (f, b) => {
    var x, R, C, V, D, Y;
    const v = b !== f ? ((R = (x = t[f]) == null ? void 0 : x.uiNames) == null ? void 0 : R[b]) ?? ((V = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : V.en) : void 0;
    return v ? `${(D = t[f]) == null ? void 0 : D.autonym} (${v})` : (Y = t[f]) == null ? void 0 : Y.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Pt,
      {
        ...
        onOpenChange: (f) => m(f),
        children: [
          /* @__PURE__ */ r(zt, { children: /* @__PURE__ */ r(Bt, {}) }),
          /* @__PURE__ */ r(
            It,
            {
              className: "tw-z-[250]",
...
const ls = Ge(({ className: t, ...e }, n) => /* @__PURE__ */ r(pa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), cs = p.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: d(ds({ variant: e }), t), ...n }));
...
const us = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: d("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
ms.displayName = $t.Root.displayName;
...
hs.displayName = $t.Image.displayName;
const fs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  $t.Fallback,
  {
    ref: n,
    className: d(
...
fs.displayName = $t.Fallback.displayName;
const gs = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
const xs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: d("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const Hi = $.Root, Yi = $.Trigger, Ui = $.Group, Ki = $.Portal, qi = $.Sub, Ji = $.RadioGroup, ks = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  $.SubTrigger,
  {
    ref: o,
    className: d(
...
ks.displayName = $.SubTrigger.displayName;
...
Cs.displayName = $.SubContent.displayName;
const _s = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r($.Portal, { children: /* @__PURE__ */ r(
  $.Content,
  {
    ref: n,
    className: d(
...
_s.displayName = $.Content.displayName;
const Ss = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Item,
  {
    ref: a,
    className: d(
...
Ss.displayName = $.Item.displayName;
const Rs = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => /* @__PURE__ */ l(
  $.CheckboxItem,
  {
    ref: o,
    className: d(
...
Rs.displayName = $.CheckboxItem.displayName;
const Ts = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  $.RadioItem,
  {
    ref: a,
    className: d(
...
Ts.displayName = $.RadioItem.displayName;
const Es = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: a,
    className: d(
...
Es.displayName = $.Label.displayName;
...
Vs.displayName = $.Separator.displayName;
...
const Wi = dt.Trigger, zs = dt.Portal, Zi = dt.Close, Mr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Overlay,
  {
    ref: n,
...
Mr.displayName = dt.Overlay.displayName;
const Is = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
  const { direction: s = "bottom" } = p.useContext(Vr), i = {
...
const Ps = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Title,
  {
    ref: n,
    className: d("tw-text-lg tw-font-semibold tw-leading-none tw-tracking-tight", t),
...
Ps.displayName = dt.Title.displayName;
...
Bs.displayName = dt.Description.displayName;
const js = p.forwardRef(({ className: t, value: e, ...n }, a) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: a,
    className: d(
...
js.displayName = Be.Root.displayName;
function Qi({ ...t }) {
  return /* @__PURE__ */ r(
    Sa,
    {
...
const Ls = p.forwardRef(({ className: t, ...e }, n) => {
  const a = K();
  return /* @__PURE__ */ l(
    qt.Root,
    {
...
const $s = p.forwardRef(({ className: t, ...e }, n) => {
  const a = K();
  return /* @__PURE__ */ r(
    je.Root,
    {
...
$s.displayName = je.Root.displayName;
const tw = at.Root, Xs = p.forwardRef(({ className: t, ...e }, n) => {
  const a = K();
  return /* @__PURE__ */ r(
    at.List,
    {
...
Xs.displayName = at.List.displayName;
const Fs = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Trigger,
  {
    ref: n,
...
Fs.displayName = at.Trigger.displayName;
...
Gs.displayName = at.Content.displayName;
const Hs = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "textarea",
    {
      className: d(
...
const Us = (t, e, n = {}) => {
  ...
  const o = W(null), [s, i] = P(void 0), [w, u] = P(void 0), c = B(
    (h) => {
      i(h);
