import { jsx as r, jsxs as d, Fragment as Dt } from "react/jsx-runtime";
import u, { forwardRef as Qt, createContext as or, useContext as sr, useCallback as U, useState as A, useRef as q, useEffect as it, useLayoutEffect as Qe, useMemo as et, Fragment as ln } from "react";
import { clsx as ir } from "clsx";
import { extendTailwindMerge as wr } from "tailwind-merge";
import { cva as gt } from "class-variance-authority";
import * as j from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as lr } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as De, Check as Ct, Circle as Ve, X as Me, Search as dn, ChevronsUpDown as ze, FilterIcon as dr, ChevronDown as te, ChevronUp as cr, ArrowLeftIcon as pr, ChevronLeftIcon as ur, ChevronRightIcon as mr, ArrowRightIcon as hr, LoaderCircle as gr, Download as fr, Filter as br, User as vr, Link as xr, CircleHelp as yr, Star as Nr, CircleCheckIcon as kr, CircleXIcon as Cr, CircleHelpIcon as _r, ArrowUpIcon as Sr, ArrowDownIcon as Tr, ArrowUpDownIcon as Rr, PanelLeft as Er, PanelRight as Dr, ScrollText as Vr, ChevronLeft as Mr, MenuIcon as zr, Menu as Or, EllipsisVertical as Br } from "lucide-react";
import { formatScrRef as St, MODIFIER_KEYS as Ir, getChaptersForBook as Pr, NumberFormat as Ar, formatBytes as jr, deepEqual as Oe, isString as ge, compareScrRefs as ke, scrRefToBBBCCCVVV as fe, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
import { useReactTable as pn, getFilteredRowModel as Xr, getSortedRowModel as un, getPaginationRowModel as Fr, getCoreRowModel as mn, flexRender as Ft, getGroupedRowModel as Gr, getExpandedRowModel as $r } from "@tanstack/react-table";
import * as G from "@radix-ui/react-select";
import Lr from "markdown-to-jsx";
import * as Ce from "@radix-ui/react-checkbox";
import * as ee from "@radix-ui/react-toggle-group";
...
const Ie = j.Trigger, fn = j.Group, Kr = j.Portal, Wr = j.Sub, Cs = j.RadioGroup;
function ne({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Be.Provider, { value: n, children: /* @__PURE__ */ r(j.Root, { ...e }) });
}
const bn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    j.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(De, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
bn.displayName = j.SubTrigger.displayName;
const vn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  j.SubContent,
  {
    ref: n,
    className: l(
...
const Ht = u.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...a }, o) => {
  const s = H();
...
Ht.displayName = j.Content.displayName;
const Pe = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = H(), s = ot();
  return /* @__PURE__ */ r(
    j.Item,
    {
...
const Ae = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    j.CheckboxItem,
    {
...
Ae.displayName = j.CheckboxItem.displayName;
...
const re = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: a,
...
re.displayName = j.Label.displayName;
...
function ea(t) {
  const e = typeof t == "string" ? Ot(t) : t;
  return e >= 40 && e <= 66;
}
function na(t) {
  return (typeof t == "string" ? Ot(t) : t) <= 39;
}
function Nn(t) {
  return t <= 66;
}
...
const ua = 6, Ge = M.allBookIds.filter((t) => !M.isObsolete(M.bookIdToNumber(t))), ma = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, nn = ["OT", "NT", "DC"], ha = 96, ga = [
  /^(\w+)$/i,
  ...
  "ArrowRight",
  "Enter"
]), fa = 'a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])', At = (t) => Pr(M.bookIdToNumber(t));
function ba() {
  return Ge.map((e) => M.bookIdToEnglishName(e));
}
function va(t) {
...
function xa(t) {
  ...
  if (va(e))
    return Ge.find((a) => M.bookIdToEnglishName(a) === e);
}
function Ss({
  scrRef: t,
  handleSubmit: e,
  ...
  const o = H(), [s, i] = A(
    () => St(t, "English")
  ), [w, c] = A(""), [p, g] = A(t.book), [v, f] = A(t.chapterNum ?? 0), [m, N] = A(t.book), [T, y] = A(!1), [x, _] = A(T), S = q(void 0), z = q(void 0), $ = q(void 0), ft = U(
    (h) => {
      const V = a ? a() : Ge;
      return {
    ...
    i(St(t, "English")), c(""), g(t.book), N(t.book);
  }, [t]), F = U((h) => {
    if (k.current) {
      k.current = !1;
      return;
    ...
    (h, V, C, O) => {
      if (f(t.book !== h ? 1 : t.chapterNum), V || At(h) === -1) {
        e({
          book: h,
          chapterNum: C ?? 1,
          verseNum: O ?? 1
    ...
    (h) => {
      const { key: V } = h;
      rn.has(V) || (dt(h), h.preventDefault());
    },
    [dt]
  ), D = U(
    (h, V) => {
  ...
  return it(() => {
  ...
  }, [x, b]), /* @__PURE__ */ d(ne, { modal: !1, open: T, onOpenChange: F, children: [
    ...
    /* @__PURE__ */ r(
      Ht,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: nn.map((h, V) => {
          const C = ft(h);
          return C.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(re, { className: "tw-font-semibold tw-text-foreground/80", children: ma[h] }),
...
const ya = gt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Vt : "button", { className: l(ya({ variant: e, size: n, className: t })), ref: s, ...o })
);
I.displayName = "Button";
const Na = gt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(cn.Root, { ref: n, className: l("pr-twp", Na(), t), ...e }));
Y.displayName = cn.Root.displayName;
const $e = u.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Gt.Root,
    {
...
const Kt = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Gt.Item,
  {
    ref: n,
    className: l(
    ...
    ...e,
    children: /* @__PURE__ */ r(Gt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Ve, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Kt.displayName = Gt.Item.displayName;
const Le = $t.Root, Ye = $t.Trigger, ae = u.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = H();
...
const ka = wt.Portal, Tn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
    className: l(
...
const Ca = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = H();
...
const se = u.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
...
se.displayName = Z.Input.displayName;
...
ie.displayName = Z.List.displayName;
const we = u.forwardRef((t, e) => /* @__PURE__ */ r(Z.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
we.displayName = Z.Empty.displayName;
...
He.displayName = Z.Group.displayName;
...
function Se({
  ...
  const [y, x] = A(!1);
  return /* @__PURE__ */ d(Le, { open: y, onOpenChange: x, ...T, children: [
    /* @__PURE__ */ r(Ye, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: f,
        role: "combobox",
        ...
        children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-items-center tw-overflow-hidden", children: [
            ...
            /* @__PURE__ */ r("span", { className: l("tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap"), children: s ? w(s) : p })
          ] }),
    ...
    /* @__PURE__ */ r(
      ae,
      {
        ...
        children: /* @__PURE__ */ d(oe, { children: [
          /* @__PURE__ */ r(se, { placeholder: g, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(we, { children: v }),
          /* @__PURE__ */ r(ie, { children: e.map((_) => /* @__PURE__ */ d(
            le,
            {
              value: w(_),
              onSelect: () => {
...
function Rs({
  ...
  const g = be(p, "%webView_bookSelector_currentBook%"), v = be(p, "%webView_bookSelector_choose%"), f = be(p, "%webView_bookSelector_chooseBooks%"), [m, N] = A(
    "current book"
    /* CURRENT_BOOK */
  ), T = (y) => {
    N(y), t(y);
...
function Da({ table: t }) {
  return /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(lr, { asChild: !0, children: /* @__PURE__ */ d(I, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(dr, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ d(Ht, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r(re, { children: "Toggle columns" }),
      /* @__PURE__ */ r(Ut, {}),
...
const Tt = G.Root, Va = G.Group, Rt = G.Value, Ma = gt(
...
), Nt = u.forwardRef(({ className: t, children: e, size: n, ...a }, o) => {
  const s = H();
  return /* @__PURE__ */ d(
    G.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(G.Icon, { asChild: !0, children: /* @__PURE__ */ r(te, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const Dn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  G.ScrollDownButton,
  {
    ...
    className: l("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ r(te, { className: "tw-h-4 tw-w-4" })
  }
));
Dn.displayName = G.ScrollDownButton.displayName;
const kt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = H();
...
const rt = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(
  G.Item,
  {
    ref: a,
    className: l(
...
const de = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r("div", { className: l("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ r(
  "table",
  {
    ref: a,
...
const ce = u.forwardRef(({ className: t, stickyHeader: e, ...n }, a) => /* @__PURE__ */ r(
  "thead",
  {
    ref: a,
    className: l(
...
const pe = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: l("[&_tr:last-child]:tw-border-0", t), ...e }));
pe.displayName = "TableBody";
...
const Et = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function Aa({
  ...
  var y;
  const [w, c] = A([]), [p, g] = A([]), [v, f] = A({}), [m, N] = A({}), T = pn({
    data: e,
    columns: t,
    getCoreRowModel: mn(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(de, { stickyHeader: s, children: [
      /* @__PURE__ */ r(ce, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(ht, { children: x.headers.map((_) => /* @__PURE__ */ r(Lt, { children: _.isPlaceholder ? void 0 : Ft(_.column.columnDef.header, _.getContext()) }, _.id)) }, x.id)) }),
      /* @__PURE__ */ r(pe, { children: (y = T.getRowModel().rows) != null && y.length ? T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        ht,
        {
          onClick: () => i(x, T),
          "data-state": x.getIsSelected() && "selected",
          children: x.getVisibleCells().map((_) => /* @__PURE__ */ r(Et, { children: Ft(_.column.columnDef.cell, _.getContext()) }, _.id))
        },
        x.id
    ...
    n && a && /* @__PURE__ */ r(Ba, { table: T })
  ] });
}
const qt = Qt(({ className: t, ...e }, n) => /* @__PURE__ */ r(gr, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function Es({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ r(qt, { size: 15 }) : /* @__PURE__ */ d(Dt, { children: [
        /* @__PURE__ */ r(fr, { size: 25, className: l("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
}
function Ds({ isEnabling: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
      ...
      onClick: e,
      ...a,
      children: t ? /* @__PURE__ */ d(Dt, { children: [
        /* @__PURE__ */ r(qt, { size: 15, className: "tw-mr-1 tw-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function Vs({
  ...
  return /* @__PURE__ */ r(
    I,
    {
      ...
      ...a,
      children: t ? /* @__PURE__ */ d(Dt, { children: [
        /* @__PURE__ */ r(qt, { size: 15, className: "tw-mr-1 tw-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
}
function Ms({ isUpdating: t, handleClick: e, className: n, ...a }) {
  return /* @__PURE__ */ r(
    I,
    {
      className: l(
...
function zs({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Lr, { options: o, children: e }) });
}
const ja = Qt((t, e) => /* @__PURE__ */ d(
  I,
  {
    ref: e,
    ...
    ...t,
    children: [
      /* @__PURE__ */ r(br, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ r(
        te,
        {
...
function Os({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(Ie, { asChild: !0, children: /* @__PURE__ */ r(ja, {}) }),
    /* @__PURE__ */ r(Ht, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(re, { children: n.label }),
      /* @__PURE__ */ r(fn, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Ae, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(xn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(Ut, {})
    ] }, n.label)) })
  ] }) });
}
...
function Is({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const s = new Ar("en", {
    notation: "compact",
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ r(vr, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ d(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ r(xr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ d(
            "a",
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ r(yr, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          )
        ] })
...
function Ps({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Fa, { versionHistory: o }),
...
const Ga = gt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", Ga({ variant: e }), t), ...n })
);
...
function $a({
  ...
  return /* @__PURE__ */ r("div", { className: g, children: /* @__PURE__ */ d(Le, { open: v, onOpenChange: f, children: [
    /* @__PURE__ */ r(Ye, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(ae, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(oe, { children: [
      /* @__PURE__ */ r(se, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ d(ie, { children: [
        /* @__PURE__ */ r(we, { children: s }),
        /* @__PURE__ */ r(He, { children: T.map((y) => {
          ...
          return /* @__PURE__ */ d(
            le,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: y.starred && /* @__PURE__ */ r(Nr, { className: "tw-h-4 tw-w-4" }) }),
...
function As({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var m;
      return /* @__PURE__ */ d(Wt, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          I,
          {
            variant: "ghost",
...
function La({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], s = et(() => {
    const i = [];
    return t.forEach((w) => {
      i.some((c) => Oe(c, w)) || i.push(w);
    }), i;
  }, [t]);
  return /* @__PURE__ */ d(de, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(ce, { stickyHeader: !0, children: /* @__PURE__ */ d(ht, { children: [
      /* @__PURE__ */ r(Lt, { children: a }),
      /* @__PURE__ */ r(Lt, { children: o })
    ] }) }),
    /* @__PURE__ */ r(pe, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      ht,
      {
        onClick: () => {
          e(i.reference);
...
), Ya = u.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  hn.Root,
  {
    ref: o,
...
Ya.displayName = hn.Root.displayName;
...
zn.displayName = ee.Root.displayName;
const Jt = u.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
  const i = u.useContext(Mn);
  return /* @__PURE__ */ r(
    ee.Item,
    {
      ref: s,
...
Jt.displayName = ee.Item.displayName;
const ue = (t) => t === "asc" ? /* @__PURE__ */ r(Sr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Tr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Rr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), js = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ua = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ys = Object.freeze([
...
function Hs({
  ...
  const p = pt(n, "%webView_inventory_all%"), g = pt(n, "%webView_inventory_approved%"), v = pt(n, "%webView_inventory_unapproved%"), f = pt(n, "%webView_inventory_unknown%"), m = pt(n, "%webView_inventory_scope_currentBook%"), N = pt(n, "%webView_inventory_scope_chapter%"), T = pt(n, "%webView_inventory_filter_text%"), y = pt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, _] = A(!1), [S, z] = A("all"), [$, ft] = A(""), [lt, k] = A([]), b = et(() => t.length === 0 ? [] : Ja(t, o, s), [t, o, s]), F = et(() => {
    if (x) return b;
    const D = [];
    return b.forEach((h) => {
...
const qe = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  gn.Root,
  {
    ref: o,
    decorative: n,
...
qe.displayName = gn.Root.displayName;
...
const Je = Yt.Provider, Ke = Yt.Root, We = Yt.Trigger, me = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Yt.Content,
  {
    ref: a,
    sideOffset: e,
...
me.displayName = Yt.Content.displayName;
const Ka = "16rem", Wa = "3rem", On = u.createContext(void 0);
function he() {
...
const Bn = u.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(On.Provider, { value: _, children: /* @__PURE__ */ r(Je, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
Bn.displayName = "SidebarProvider";
const In = u.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: a, ...o }, s) => {
  const i = he();
...
In.displayName = "Sidebar";
const Za = u.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = he();
  return /* @__PURE__ */ d(
    I,
    {
...
const Re = u.forwardRef(({ className: t, asChild: e = !1, ...n }, a) => /* @__PURE__ */ r(
  e ? Vt : "div",
  {
    ref: a,
...
Ee.displayName = "SidebarGroupContent";
...
Xn.displayName = "SidebarMenuItem";
const oo = gt(
  ...
  ({
    ...
    const c = t ? Vt : "button", { state: p } = he(), g = /* @__PURE__ */ r(
      c,
      {
        ref: w,
        ...
        "data-size": a,
        "data-active": e,
        className: l(oo({ variant: n, size: a }), s),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(We, { asChild: !0, children: g }),
      /* @__PURE__ */ r(me, { side: "right", align: "center", hidden: p !== "collapsed", ...o })
    ] })) : g;
  }
);
Fn.displayName = "SidebarMenuButton";
const so = u.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? Vt : "button",
  {
    ref: o,
...
const wo = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
...
wo.displayName = "SidebarMenuSkeleton";
...
lo.displayName = "SidebarMenuSub";
const co = u.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
co.displayName = "SidebarMenuSubItem";
const po = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? Vt : "a",
  {
    ref: s,
...
po.displayName = "SidebarMenuSubButton";
function uo({
  id: t,
  extensionLabels: e,
  projectInfo: n,
    ...
    In,
    {
      ...
      children: /* @__PURE__ */ d(An, { children: [
        /* @__PURE__ */ d(Te, { children: [
          ...
          /* @__PURE__ */ r(Ee, { children: /* @__PURE__ */ r(jn, { children: Object.entries(e).map(([f, m]) => /* @__PURE__ */ r(Xn, { children: /* @__PURE__ */ r(
            Fn,
            {
              onClick: () => p(f),
              isActive: v(f),
        ...
        /* @__PURE__ */ d(Te, { children: [
          ...
          /* @__PURE__ */ r(Ee, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            Se,
            {
              buttonVariant: "ghost",
...
const ut = "scrBook", mo = "scrRef", xt = "source", ho = "details", go = "Scripture Reference", fo = "Scripture Book", $n = "Type", bo = "Details";
function vo(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      sortingFn: (a, o) => ke(a.original.start, o.original.start),
      enableGrouping: !0
    },
    {
...
const xo = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || ke(t.start, t.end) === 0 ? `${fe(t.start)}+${e}` : `${fe(t.start)}+${e}-${fe(t.end)}+${n}`;
}, on = (t) => `${xo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function qs({
  sources: t,
  ...
  const [c, p] = A([]), [g, v] = A([{ id: ut, desc: !1 }]), [f, m] = A({}), N = et(
  ...
  it(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const F = N.find((R) => on(R) === b[0]) || void 0;
        F && w(F);
      }
    }
  }, [f, N, w, y]);
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ d(de, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(ce, { children: y.getHeaderGroups().map((k) => /* @__PURE__ */ r(ht, { children: k.headers.filter((b) => b.column.columnDef.header).map((b) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Lt, { colSpan: b.colSpan, className: "top-0 tw-sticky", children: b.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ft(b.column.columnDef.header, b.getContext())
        ] }) }, b.id)
      )) }, k.id)) }),
      /* @__PURE__ */ r(pe, { children: y.getRowModel().rows.map((k, b) => {
        const F = H();
        return /* @__PURE__ */ r(
          ht,
          {
                  ...
                  Et,
                  {
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        type: "button",
                        children: [
                          k.getIsExpanded() && /* @__PURE__ */ r(te, {}),
                          !k.getIsExpanded() && (F === "ltr" ? /* @__PURE__ */ r(De, {}) : /* @__PURE__ */ r(Mr, {})),
                          " ",
                          Ft(R.column.columnDef.cell, R.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
}), Ln = (t, e, n) => Ze(t, e).every((a) => n.includes(a));
function ko({
  bookId: t,
  selectedBookIds: e,
  toggleBook: n,
...
function Co({
  ...
  const s = Ze(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], p = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
      ...
      onClick: () => a(t),
      className: l(
        Ln(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/90"
      ),
      disabled: s,
      children: No(
        t,
...
function _o({
  ...
  const z = et(() => M.allBookIds.filter(
    ...
    (b) => {
      const F = Ze(z, b).map((R) => R);
      n(
        Ln(z, b, e) ? e.filter((R) => !F.includes(R)) : [.../* @__PURE__ */ new Set([...e, ...F])]
      );
    },
    [e, n, z]
  ), lt = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ d(Le, { open: y, onOpenChange: x, children: [
      /* @__PURE__ */ r(Ye, { asChild: !0, children: /* @__PURE__ */ d(
        I,
        {
          variant: "outline",
              ...
              Object.values(mt).map((b, F) => {
                ...
                if (R.length !== 0)
                  return /* @__PURE__ */ d(ln, { children: [
                    ...
                    F < Object.values(mt).length - 1 && /* @__PURE__ */ r(Rn, {})
                  ] }, b);
              })
            ] })
          ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === xe ? xe : sn
      ).map((b) => /* @__PURE__ */ r(Wt, { variant: "secondary", children: M.bookIdToEnglishName(b) || b }, b)),
      e.length > xe && /* @__PURE__ */ r(Wt, { variant: "secondary", children: `+${e.length - sn} ${v}` })
    ] })
  ] });
}
      ...
      /* @__PURE__ */ r(
        $e,
        {
          ...
          children: y.map(({ value: x, label: _, id: S }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Kt, { className: "tw-me-2", value: x, id: S }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          kt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((c) => /* @__PURE__ */ r(rt, { value: `${c}`, children: i[P(c)] }, `${c}`))
          }
        )
      ]
    }
...
function Zt({ icon: t, menuLabel: e, leading: n }) {
  return t ? /* @__PURE__ */ r(
    "img",
    {
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ d(Ke, { children: [
  /* @__PURE__ */ r(We, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
    Pe,
    {
      onClick: () => {
        a(w);
      ...
      children: [
        w.iconPathBefore && /* @__PURE__ */ r(Zt, { icon: w.iconPathBefore, menuLabel: w.label, leading: !0 }),
        w.label,
        w.iconPathAfter && /* @__PURE__ */ r(Zt, { icon: w.iconPathAfter, menuLabel: w.label })
      ]
    },
...
function wn({
  ...
  return /* @__PURE__ */ d(ne, { variant: s, children: [
    /* @__PURE__ */ r(Ie, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(I, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(zr, {}) }) }),
    /* @__PURE__ */ r(Ht, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(ln, { children: [
      /* @__PURE__ */ r(fn, { children: /* @__PURE__ */ r(Je, { children: Hn(e.groups, e.items, w, t) }) }),
      c < p.length - 1 && /* @__PURE__ */ r(Ut, {})
    ] }, w)) })
  ] });
}
function ei({
...
const Un = u.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.Root,
    {
...
)), Jn = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Q.Content,
  {
    ref: n,
    className: l(
...
function ni({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Un, { children: [
      /* @__PURE__ */ r(qn, { children: t.map((i) => /* @__PURE__ */ r(So, { value: i.value, children: i.value }, i.key)) }),
...
const Kn = u.forwardRef(({ className: t, variant: e = "default", ...n }, a) => {
  const o = u.useMemo(
    () => ({
      variant: e
    }),
...
Kn.displayName = X.Root.displayName;
...
Wn.displayName = X.Trigger.displayName;
const Zn = u.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    X.SubTrigger,
    {
...
Zn.displayName = X.SubTrigger.displayName;
const Qn = u.forwardRef(({ className: t, ...e }, n) => {
  const a = ot();
  return /* @__PURE__ */ r(
    X.SubContent,
    {
...
Qn.displayName = X.SubContent.displayName;
const tr = u.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: a = 8, ...o }, s) => {
  const i = ot();
...
tr.displayName = X.Content.displayName;
const er = u.forwardRef(({ className: t, inset: e, ...n }, a) => {
  const o = ot();
  return /* @__PURE__ */ r(
    X.Item,
    {
...
er.displayName = X.Item.displayName;
const Eo = u.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ot();
  return /* @__PURE__ */ d(
    X.CheckboxItem,
    {
...
Eo.displayName = X.CheckboxItem.displayName;
const Do = u.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = ot();
  return /* @__PURE__ */ d(
    X.RadioItem,
    {
...
Do.displayName = X.RadioItem.displayName;
const Vo = u.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: a,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Vo.displayName = X.Label.displayName;
...
nr.displayName = X.Separator.displayName;
const jt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((p) => p.group === s).sort((p, g) => p.order - g.order).map((p) => /* @__PURE__ */ d(Ke, { children: [
      /* @__PURE__ */ r(We, { asChild: !0, children: "command" in p ? /* @__PURE__ */ d(
        er,
        {
          onClick: () => {
            a(p);
          ...
          children: [
            p.iconPathBefore && /* @__PURE__ */ r(Zt, { icon: p.iconPathBefore, menuLabel: p.label, leading: !0 }),
            p.label,
            p.iconPathAfter && /* @__PURE__ */ r(Zt, { icon: p.iconPathAfter, menuLabel: p.label })
          ]
        },
        `menubar-item-${p.label}-${p.command}`
      ) : /* @__PURE__ */ d(Ro, { children: [
        /* @__PURE__ */ r(Zn, { children: p.label }),
      ...
      p.tooltip && /* @__PURE__ */ r(me, { children: p.tooltip })
...
function Mo({
  ...
  if (Yr(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    var N, T, y, x;
    g.preventDefault();
    ...
    switch (v.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (N = s.current) == null || N.focus(), jt(s, [f, m]);
        break;
      case "alt+l":
        (T = i.current) == null || T.focus(), jt(i, [f, m]);
        break;
      case "alt+n":
        (y = w.current) == null || y.focus(), jt(w, [f, m]);
        break;
      case "alt+h":
        (x = c.current) == null || x.focus(), jt(c, [f, m]);
        break;
    }
  }), it(() => {
    ...
    return /* @__PURE__ */ r(Kn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ d(To, { children: [
      /* @__PURE__ */ r(Wn, { ref: p(g), children: typeof v == "object" && "label" in v && v.label }),
      /* @__PURE__ */ r(
        tr,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(Je, { children: rr(t.groups, t.items, g, e) })
        }
      )
    ] }, g)) });
}
...
function Oo({ item: t, createLabel: e, createComplexLabel: n }) {
...
), Io = u.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(Bo({ variant: e }), t), ...n }));
...
const Ao = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
Xo.displayName = Mt.Image.displayName;
...
Fo.displayName = Mt.Fallback.displayName;
...
const Yo = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
const wi = at.Trigger, Jo = at.Portal, li = at.Close, ar = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
...
ar.displayName = at.Overlay.displayName;
const Ko = u.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ d(Jo, { children: [
  /* @__PURE__ */ r(ar, {}),
  /* @__PURE__ */ d(
    at.Content,
    {
...
const es = u.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ d(
    Xt.Root,
    {
...
es.displayName = Xt.Root.displayName;
...
ns.displayName = _e.Root.displayName;
const ci = Q.Root, rs = u.forwardRef(({ className: t, ...e }, n) => {
  const a = H();
  return /* @__PURE__ */ r(
    Q.List,
    {
...
export {
  ...
  uo as SettingsSidebar,
  Us as SettingsSidebarContentSearch,
  es as Slider,
  di as Sonner,
  qt as Spinner,
  ns as Switch,
  ...
  Ms as UpdateButton,
  Fa as VersionHistory,
  Un as VerticalTabs,
  Jn as VerticalTabsContent,
  qn as VerticalTabsList,
  So as VerticalTabsTrigger,
  Ga as badgeVariants,
  ya as buttonVariants,
  l as cn,
  Ls as getBookIdFromUSFM,
  Gs as getLinesFromUSFM,
  $s as getNumberFromUSFM,
  Ua as getStatusForItem,
  ri as getToolbarOSReservedSpaceClassName,
  Xs as inventoryCountColumn,
