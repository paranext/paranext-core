...
import { formatScrRef as ne, getChaptersForBook as Dr, NumberFormat as Mr, formatBytes as Or, deepEqual as Je, isString as Me, compareScrRefs as $e, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
const Ea = Rt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? Ut : "button", { className: d(Ea({ variant: e, size: n, className: t })), ref: s, ...o })
);
...
const me = se.Root, he = se.Trigger, Kt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = U();
...
function qs({
  ...
  const o = U(), [s, i] = I(!1), [w, u] = I(""), [c, m] = I(""), [b, h] = I("books"), [f, x] = I(void 0), _ = K(void 0), N = K(void 0), S = K(void 0), k = K({}), D = H(() => a ? a() : Gn, [a]), B = H(() => ({
    OT: D.filter((C) => O.isBookOT(C)),
    NT: D.filter((C) => O.isBookNT(C)),
    DC: D.filter((C) => O.isBookDC(C)),
    Extra: D.filter((C) => O.extraBooks().includes(C))
  }), [D]), T = H(() => Object.values(B).flat(), [B]), gt = H(() => {
    if (!c.trim()) return B;
    const g = c.toLowerCase(), C = { OT: [], NT: [], DC: [], Extra: [] };
    return ["OT", "NT", "DC", "Extra"].forEach((J) => {
      C[J] = B[J].filter((Q) => nt[Q].toLowerCase().includes(g) || Q.toLowerCase().includes(g));
    }), C;
  }, [B, c]), kt = j(
    (g) => {
      if (!g.trim()) return;
    ...
    (g, C) => {
      if (!C) return 1;
      const A = C.toLowerCase(), J = g.toLowerCase();
      return v && (J.includes(v.book.toLowerCase()) && J.includes(nt[v.book].toLowerCase()) || g.includes(v.book) && g.includes(nt[v.book])) || J.includes(A) ? 1 : 0;
    },
    [v]
  ), F = j(() => {
    v && (e({
    ...
    (g) => {
      const C = b === "chapters" ? f : v == null ? void 0 : v.book;
      C && (e({
        book: C,
        chapterNum: g,
        verseNum: 1
    ...
    if (t.chapterNum > 1)
      ...
      if (g > 0) {
        const C = T[g - 1], A = Math.max(Dt(C), 1);
        e({
          book: C,
          chapterNum: A,
          verseNum: 1
  ...
  }, [f, v == null ? void 0 : v.book, t.book, t.chapterNum]), Ft = j((g, C) => `${g} ${nt[g]}${C ? ` ${C}` : ""}`, []), hn = j((g) => (C) => {
    k.current[g] = C;
  }, []), Tr = j((g) => {
    (g.key === "Home" || g.key === "End") && g.stopPropagation();
  }, []), Rr = j(
    (g) => {
      const C = /^[a-zA-Z]$/.test(g.key), A = /^[0-9]$/.test(g.key);
      if (b === "chapters") {
        if (g.key === "Backspace") {
        ...
        if (C || A) {
          if (g.preventDefault(), g.stopPropagation(), h("books"), x(void 0), A && f) {
            const J = nt[f];
            m(`${J} ${g.key}`);
          } else
            m(g.key);
      ...
      if ((b === "chapters" || b === "books" && v) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(g.key)) {
        const J = b === "chapters" ? f : v == null ? void 0 : v.book;
        if (!J) return;
        const Q = (() => {
          if (!w) return 1;
          const xt = w.match(/(\d+)$/);
        ...
        ut !== Q && (g.preventDefault(), g.stopPropagation(), u(Ft(J, ut)), setTimeout(() => {
          const xt = k.current[ut];
  ...
  return fn(() => {
    const g = setTimeout(() => {
      if (s && b === "books" && // !inputValue.trim() && // Only auto-scroll when not searching
      // !topMatch && // Only auto-scroll when not showing top match
      N.current && S.current) {
        const C = N.current, A = S.current, J = A.offsetTop, Q = C.clientHeight, tt = A.clientHeight, vt = J - Q / 2 + tt / 2;
        C.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), u(Ft(t.book));
  ...
  }, [s, b, c, v, t.book, Ft]), fn(() => {
    if (b === "chapters" && f) {
      const g = f === t.book, C = g ? t.chapterNum : 1;
      u(Ft(f, C)), setTimeout(() => {
        if (N.current)
          if (g) {
            const A = k.current[t.chapterNum];
    ...
    /* @__PURE__ */ r(he, { asChild: !0, children: /* @__PURE__ */ r(
      z,
      {
        ...
        role: "combobox",
        "aria-expanded": s,
        className: d("tw-min-w-48", n),
        children: pt
      }
    ) }),
    /* @__PURE__ */ r(Kt, { className: "tw-w-[280px] tw-p-0", align: "start", children: /* @__PURE__ */ l(
      ce,
      {
        onKeyDown: Rr,
        loop: !0,
        ...
        children: [
          b === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: R.map(({ onClick: g, disabled: C, title: A, icon: J }) => /* @__PURE__ */ r(
              z,
              {
                variant: "ghost",
                size: "sm",
          ...
          /* @__PURE__ */ l(ue, { ref: N, children: [
            b === "books" && /* @__PURE__ */ l(ae, { children: [
              ...
              v && L && L.endChapter > 1 && /* @__PURE__ */ l(ae, { children: [
                ...
                /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-px-4 tw-pb-4", children: Array.from({ length: L.endChapter }, (g, C) => C + 1).map(
                  (g) => /* @__PURE__ */ r(
                    _t,
                    {
            ...
            b === "chapters" && /* @__PURE__ */ r(Bt, { children: /* @__PURE__ */ r("div", { className: "tw-grid tw-grid-cols-6 tw-gap-1 tw-p-4", children: L && Array.from({ length: L.endChapter }, (g, C) => C + 1).map(
              (g) => /* @__PURE__ */ r(
                _t,
                {
                  value: `${f || ""} ${nt[f || ""] || ""} ${g}`,
...
), Y = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Vn.Root, { ref: n, className: d("pr-twp", Pa(), t), ...e }));
Y.displayName = Vn.Root.displayName;
    ...
    /* @__PURE__ */ r(
      Kt,
      {
        ...
        children: /* @__PURE__ */ l(ce, { children: [
          ...
          /* @__PURE__ */ r(ue, { children: e.map((k) => /* @__PURE__ */ l(
            _t,
            {
              value: w(k),
              onSelect: () => {
    ...
    nn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Y, { className: "tw-flex tw-items-center", children: a.map((N) => O.bookIdToEnglishName(N)).join(", ") }),
          /* @__PURE__ */ r(
            z,
            {
...
const Gt = G.Root, Ya = G.Group, Ht = G.Value, Ua = Rt(
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        Gt,
        {
          ...
          children: [
            /* @__PURE__ */ r(It, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Ht, { placeholder: t.getState().pagination.pageSize }) }),
...
function ro({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(Se, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Te, { stickyHeader: s, children: _.getHeaderGroups().map((S) => /* @__PURE__ */ r(Tt, { children: S.headers.map((k) => /* @__PURE__ */ r(le, { children: k.isPlaceholder ? void 0 : re(k.column.columnDef.header, k.getContext()) }, k.id)) }, S.id)) }),
      /* @__PURE__ */ r(Re, { children: (N = _.getRowModel().rows) != null && N.length ? _.getRowModel().rows.map((S) => /* @__PURE__ */ r(
        Tt,
        {
          ...
          children: S.getVisibleCells().map((k) => /* @__PURE__ */ r(Yt, { children: re(k.column.columnDef.cell, k.getContext()) }, k.id))
        },
        S.id
      )) : /* @__PURE__ */ r(Tt, { children: /* @__PURE__ */ r(Yt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
...
function Qs({
  ...
  return /* @__PURE__ */ l(me, { children: [
    ...
    /* @__PURE__ */ r(Kt, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      ao,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function wo({
  ...
  const [b, h] = I(!1), f = j(
    (N) => {
      var k;
      const S = (k = t.find((D) => D.label === N)) == null ? void 0 : k.value;
      S && a(
    ...
    if (!u) return t;
    const N = t.filter((k) => k.starred).sort((k, D) => k.label.localeCompare(D.label)), S = t.filter((k) => !k.starred).sort((k, D) => {
      const B = n.includes(k.value), T = n.includes(D.value);
      return B && !T ? -1 : !B && T ? 1 : k.label.localeCompare(D.label);
    });
    return [...N, ...S];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(me, { open: b, onOpenChange: h, children: [
    ...
    /* @__PURE__ */ r(Kt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(ce, { children: [
  ...
  return /* @__PURE__ */ l(Se, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Re, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Tt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Yt, { children: `${O.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
function ci({
  ...
  const c = yt(n, "%webView_inventory_all%"), m = yt(n, "%webView_inventory_approved%"), b = yt(n, "%webView_inventory_unapproved%"), h = yt(n, "%webView_inventory_unknown%"), f = yt(n, "%webView_inventory_scope_currentBook%"), x = yt(n, "%webView_inventory_scope_chapter%"), _ = yt(n, "%webView_inventory_scope_verse%"), N = yt(n, "%webView_inventory_filter_text%"), S = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [k, D] = I(!1), [B, T] = I("all"), [gt, kt] = I(""), [v, y] = I([]), F = H(() => t.length === 0 ? [] : ho(t, o, s), [t, o, s]), V = H(() => {
    if (k) return F;
    const R = [];
    return F.forEach((W) => {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        Gt,
        {
          ...
          defaultValue: B,
          children: [
            /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Ht, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l(Gt, { onValueChange: (R) => Et(R), defaultValue: i, children: [
        /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Ht, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(jt, { children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(Y, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? S })
      ] })
    ] }),
...
const rr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), b = e ?? c, h = p.useCallback(
      ...
      [n, b]
    ), f = p.useCallback(() => h((D) => !D), [h]), x = b ? "expanded" : "collapsed", S = U() === "ltr" ? i : i === "primary" ? "secondary" : "primary", k = p.useMemo(
      () => ({
        state: x,
        open: b,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(nr.Provider, { value: k, children: /* @__PURE__ */ r(dn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const _o = Rt(
  ...
  ({
    ...
    const u = t ? Ut : "button", { state: c } = De(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
...
function ui({
  ...
  const S = o ?? Ao, k = s ?? dr, D = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${S}`, value: [Ct] },
    { label: `Group by ${k}`, value: [zt] },
    {
      label: `Group by ${S} and ${k}`,
      value: [Ct, zt]
    },
    {
      label: `Group by ${k} and ${S}`,
      value: [zt, Ct]
    }
  ], B = (v) => {
    c(JSON.parse(v));
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      Gt,
      {
        ...
        children: [
          /* @__PURE__ */ r(It, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Ht, {}) }),
        ...
        /* @__PURE__ */ r(
          "span",
          {
            className: d(
              ...
              {
                "tw-border-s-red-200": Lt(t) === St.OT,
                "tw-border-s-purple-200": Lt(t) === St.NT,
                "tw-border-s-indigo-200": Lt(t) === St.DC,
                "tw-border-s-yellow-200": Lt(t) === St.Extra
              }
            ),
...
function Go({
  ...
  const B = H(() => O.allBookIds.filter(
    ...
    (y, F = !1) => {
      ...
      const V = B.findIndex((Z) => Z === k.current), q = B.findIndex((Z) => Z === y);
      if (V === -1 || q === -1) return;
      const [bt, Xt] = [
        Math.min(V, q),
        Math.max(V, q)
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(me, { open: N, onOpenChange: S, children: [
      ...
      /* @__PURE__ */ r(Kt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        ce,
        {
          onKeyDown: (y) => {
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        nn,
        {
          ...
          children: N.map(({ value: S, label: k, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          jt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(lt, { value: `${u}`, children: i[P(u)] }, `${u}`))
          }
        )
      ]
    }
...
function Ci({
  ...
  const u = Zo(
    ...
    var N, S, k, D, B, T;
    const _ = x !== f ? ((S = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : S[x]) ?? ((D = (k = t[f]) == null ? void 0 : k.uiNames) == null ? void 0 : D.en) : void 0;
  ...
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Gt,
      {
        ...
        onOpenChange: (f) => m(f),
        children: [
          /* @__PURE__ */ r(It, { children: /* @__PURE__ */ r(Ht, {}) }),
          /* @__PURE__ */ r(
            jt,
            {
              className: "tw-z-[250]",
...
ss.displayName = qt.Image.displayName;
...
is.displayName = qt.Fallback.displayName;
