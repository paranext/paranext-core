...
import b, { forwardRef as Pe, useRef as W, useMemo as B, useState as D, useCallback as z, useLayoutEffect as Mt, createContext as zn, useContext as jn, useEffect as K, Suspense as ia, createRef as la, Fragment as Sr } from "react";
...
import { includes as Ge, Section as H, getChaptersForBook as Xa, formatScrRef as ce, getSectionForBook as Re, formatRelativeDate as Ka, formatReplacementString as qt, sanitizeHtml as Ua, parseParatextHtml as dr, hasCustomParatextTags as Ya, NumberFormat as qa, formatBytes as Ja, getCurrentLocale as Wa, getFormatCallerFunction as Za, deepEqual as $r, isString as cn, compareScrRefs as Nn, scrRefToBBBCCCVVV as dn, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
const wo = Y.allBookIds.filter(
  ...
  wo.map((t) => [t, Y.bookIdToEnglishName(t)])
);
function qn(t, e, n) {
...
function yc({
  ...
  const w = st(), [p, f] = D(!1), [h, m] = D(""), [g, N] = D(""), [y, R] = D("books"), [C, x] = D(void 0), [_, M] = D(!1), S = W(void 0), E = W(void 0), I = W(void 0), k = W(void 0), T = W({}), A = z(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
    ...
    (v) => {
      const j = y === "chapters" ? C : O == null ? void 0 : O.book;
      j && (A({
        book: j,
        chapterNum: v,
        verseNum: 1
      }), f(!1), R("books"), x(void 0), N(""));
    },
    [A, y, C, O]
  ), mt = z(
    (v) => {
    ...
    (v) => {
      ...
      if (y === "chapters") {
        ...
        if (j || J) {
          if (v.preventDefault(), v.stopPropagation(), R("books"), x(void 0), J && C) {
            const lt = Jt[C];
            N(`${lt} ${v.key}`);
          } else
            N(v.key);
      ...
      if ((y === "chapters" || y === "books" && O) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(v.key)) {
        const lt = y === "chapters" ? C : O == null ? void 0 : O.book;
        if (!lt) return;
        const ct = (() => {
          if (!h) return 1;
          const _e = h.match(/(\d+)$/);
    ...
    const { isLetter: j, isDigit: J } = gr(v.key);
    (j || J) && (v.preventDefault(), N((lt) => lt + v.key), E.current.focus(), M(!1));
  }, []);
  return Mt(() => {
    const v = setTimeout(() => {
      if (p && y === "books" && I.current && k.current) {
    ...
    if (y === "chapters" && C) {
      ...
      setTimeout(() => {
        if (I.current)
          if (v) {
            const j = T.current[t.chapterNum];
  ...
  }, [y, C, O, t.book, t.chapterNum]), /* @__PURE__ */ c(se, { open: p, onOpenChange: wt, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
      ...
      oe,
      {
        ...
        children: [
          y === "books" ? /* @__PURE__ */ c("div", { className: "tw-flex tw-items-end", children: [
            ...
            C && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: de(C, a) })
          ] }),
          !_ && /* @__PURE__ */ c(ae, { ref: I, children: [
            y === "books" && /* @__PURE__ */ c(rt, { children: [
...
function Dn({
  ...
  const [C, x] = D(!1), _ = d ?? l, M = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], S = (E, I) => {
    const k = l(E), T = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, A = `${I ?? ""}${k}${T ?? ""}`;
    return /* @__PURE__ */ c(
      Ft,
      {
        value: k,
  ...
  return /* @__PURE__ */ c(se, { open: C, onOpenChange: x, ...R, children: [
    ...
    /* @__PURE__ */ r(
      Gt,
      {
        ...
        children: /* @__PURE__ */ c(oe, { children: [
          ...
          /* @__PURE__ */ r(ae, { children: M(e) ? e.map((E) => /* @__PURE__ */ r(zt, { heading: E.groupHeading, children: E.options.map((I) => S(I, E.groupHeading)) }, E.groupHeading)) : e.map((E) => S(E)) })
        ] })
      }
    )
  ] });
    ...
    Jn,
    {
      ...
      children: /* @__PURE__ */ c("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ c("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(at, { className: "tw-flex tw-items-center", children: o.map((y) => Y.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            $,
            {
...
const Cc = [
  ...
  const a = W(null), [s, i] = D(void 0), [l, d] = D(void 0), w = z(
    ...
    (m) => {
      var E;
      const g = m.target, N = (I) => I ? document.getElementById(I) : void 0, y = N(l), R = N(s);
      if (!!(y && g && y.contains(g) && g !== y) && f(g)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (k === -1) return;
          let T;
          m.key === "ArrowDown" ? T = Math.min(k + 1, I.length - 1) : T = Math.max(k - 1, 0), T !== k && (m.preventDefault(), m.stopPropagation(), (E = I[T]) == null || E.focus());
          return;
        }
        return;
      }
...
const uo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = uo ? Mt : K, He = { tag: Br };
...
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
...
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
function mi(t) {
...
function vi(t, e) {
  ...
  if (e.isSelected(t) && !os(e) && n !== null) {
    ...
    if (d || w) {
      ...
      let N, y = 0;
      h ? (y = p > f ? f : p, N = p > f ? p : f) : m ? (y = s ? f : p, N = void 0) : g && (y = 0, N = s ? p : f), e.__text = e.__text.slice(y, N);
    }
  }
  return e;
}
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (Gn(N)) {
                const y = N.anchor;
                let R = y.getNode(), C = 0, x = 0;
                if (Ke(R) && w >= 0 && p >= 0 && (C = w, x = w + p, N.setTextNodeRange(R, C, R, x)), C === x && f === "" || (N.insertRawText(f), R = y.getNode()), Ke(R)) {
                  C = h, x = h + m;
                  const _ = R.getTextContentSize();
                  C = C > _ ? _ : C, x = x > _ ? _ : x, N.setTextNodeRange(R, C, R, x);
                }
...
const On = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
function xr(t) {
...
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Mt : K;
...
function ko(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  const d = function(g, N) {
    const { nodeName: y } = g, R = N._htmlConversions.get(y.toLowerCase());
    let C = null;
    if (R !== void 0) for (const x of R) {
      const _ = x(g);
      _ !== null && (C === null || (C.priority || 0) <= (_.priority || 0)) && (C = _);
    }
...
function kr({
  ...
  const [f, h] = D(!1), [m, g] = D(), [N, y] = D(!1), R = W(null);
  K(() => {
    let k = !0;
    if (!o) {
      y(!1);
        ...
        /* @__PURE__ */ c("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          f && /* @__PURE__ */ c(
            "div",
            {
              ...
              ref: R,
              onKeyDownCapture: (k) => {
                k.key === "Escape" ? (k.preventDefault(), k.stopPropagation(), C()) : k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), Pt(m) && x());
              },
              onKeyDown: (k) => {
...
function rl({
  ...
  const [R, C] = D(_r), [x, _] = D(!1), [M, S] = D(!1), [E, I] = D(!1), [k, T] = D(!1), [A, L] = D(!1), [F, V] = D(void 0), [q, O] = D(!1), [nt, gt] = D(!1);
  K(() => {
    let v = !0;
    if (!n) {
      O(!1), gt(!1);
  ...
  const xt = B(() => t.filter((v) => !v.deleted), [t]), mt = B(() => xt[0], [xt]), P = W(null), Z = W(void 0), wt = z(() => {
    var v;
    (v = Z.current) == null || v.call(Z), C(_r);
  }, []);
  K(() => {
    const v = P.current;
    if (!v) return;
  ...
  const it = B(
  ...
  }, [a, e]), At = B(() => xt.slice(1), [xt]), ht = B(() => At.length ?? 0, [At.length]), on = B(() => ht > 0, [ht]), an = B(() => E || ht <= 2 ? At : At.slice(-2), [At, ht, E]), we = B(() => E || ht <= 2 ? 0 : ht - 2, [ht, E]), je = B(
    ...
    async (v) => {
      const j = Pt(R) ? Vn(R) : void 0, J = await w({
        ...v,
        contents: j,
          ...
          n && /* @__PURE__ */ c(rt, { children: [
            ...
            m !== !1 && (!k || Pt(R)) && /* @__PURE__ */ c(
              "div",
              {
                ...
                onKeyDownCapture: (v) => {
                  v.key === "Enter" && v.shiftKey && (v.preventDefault(), v.stopPropagation(), (Pt(R) || F !== void 0) && Fe());
                },
                onKeyDown: (v) => {
...
function Ec({
  ...
  const [h, m] = D(), g = e.filter(
    ...
    m(S);
  }, []), { listboxRef: C, activeId: x, handleKeyDown: _ } = ai({
    options: N,
    onOptionSelect: y
  }), M = z(
    (S) => {
...
function fl({
  ...
  var S;
  const [p, f] = D([]), [h, m] = D([]), [g, N] = D({}), [y, R] = D({}), C = B(() => e ?? [], [e]), x = Yr({
    data: C,
    columns: t,
    getCoreRowModel: Jr(),
  ...
  let M;
  return d ? M = Array.from({ length: 10 }).map((k, T) => `skeleton-row-${T}`).map((k) => /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r(Zt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(An, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, k)) : ((S = x.getRowModel().rows) == null ? void 0 : S.length) > 0 ? M = x.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Dt,
    {
      onClick: () => i(E, x),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((I) => /* @__PURE__ */ r(Zt, { children: De(I.column.columnDef.cell, I.getContext()) }, I.id))
    },
    E.id
    ...
    /* @__PURE__ */ c(Qe, { stickyHeader: s, children: [
      /* @__PURE__ */ r(tn, { stickyHeader: s, children: x.getHeaderGroups().map((E) => /* @__PURE__ */ r(Dt, { children: E.headers.map((I) => /* @__PURE__ */ r(Ae, { children: I.isPlaceholder ? void 0 : De(I.column.columnDef.header, I.getContext()) }, I.id)) }, E.id)) }),
...
function yl({
  ...
  const [R, C] = D(!1), x = z(
    (T) => {
      var L;
      const A = (L = t.find((F) => F.label === T)) == null ? void 0 : L.value;
      A && n(
    ...
    if (!h) return t;
    const T = t.filter((L) => L.starred).sort((L, F) => L.label.localeCompare(F.label)), A = t.filter((L) => !L.starred).sort((L, F) => {
  ...
  return /* @__PURE__ */ r("div", { id: y, className: g, children: /* @__PURE__ */ c(se, { open: I, onOpenChange: p ?? C, children: [
    /* @__PURE__ */ r(ie, { asChild: !0, children: /* @__PURE__ */ c(
      $,
      {
        variant: N,
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ c(oe, { children: [
      ...
      /* @__PURE__ */ c(ae, { children: [
        ...
        /* @__PURE__ */ r(zt, { children: M.map((T) => /* @__PURE__ */ c(
          Ft,
          {
            value: T.label,
            onSelect: x,
            ...
            children: [
              ...
              T.starred && /* @__PURE__ */ r(Ta, { className: "tw-h-4 tw-w-4" }),
...
function kl({
  ...
  K(() => {
    ...
    return globalThis.addEventListener("click", y), () => {
      globalThis.removeEventListener("click", y);
    };
  }, []), K(() => {
    w(t);
  }, [t]), K(() => {
  ...
  const g = (y) => {
    m(y), y || (d !== "custom" || p ? (e(d), o(p)) : (w(t), f(n)));
  }, N = (y) => {
    var R, C, x, _;
    (y.key === "ArrowDown" || y.key === "ArrowRight") && document.activeElement === i.current ? (R = s.current) == null || R.focus() : y.key === "ArrowUp" && document.activeElement === s.current ? (C = i.current) == null || C.focus() : y.key === "ArrowLeft" && document.activeElement === s.current && ((x = s.current) == null ? void 0 : x.selectionStart) === 0 && ((_ = i.current) == null || _.focus()), d === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ c(le, { open: h, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ c(
      Ht,
      {
        ...
        onMouseMove: () => {
          var y;
          l.current && ((y = s.current) == null || y.focus());
        },
        children: [
...
function Vc({
  ...
  K(() => {
    ...
    if (_ && pn("note", _)) {
      const E = (M = _.insert.note) == null ? void 0 : M.caller;
      let I = "custom";
      E === _n ? I = "generated" : E === Cn ? I = "hidden" : E && h(E), p(I), g(((S = _.insert.note) == null ? void 0 : S.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), x = setTimeout(() => {
        var k;
        ...
        /* @__PURE__ */ r(
          El,
          {
            ...
            handleNoteTypeChange: (x) => {
              ...
              _ && pn("note", _) && (_.insert.note && (_.insert.note.style = x), (E = l.current) == null || E.applyUpdate([{ delete: 1 }, _]));
            },
            localizedStrings: i
          }
        ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(It, { children: /* @__PURE__ */ c(Lt, { children: [
            /* @__PURE__ */ r(Wt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: R, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Mr, {}) }) }),
...
function $c({
  ...
  const f = p ? Dl(p, "%webView_footnoteList_header%") : "Footnotes", h = d ?? Za(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
  }, g = s ? n.findIndex((x) => x === s) : 0, [N, y] = D(g), R = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
  ...
  return K(() => {
    var x;
    N >= 0 && N < C.current.length && ((x = C.current[N]) == null || x.focus());
  }, [N]), /* @__PURE__ */ c(rt, { children: [
  ...
  return /* @__PURE__ */ c(Qe, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(en, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ c(
      Dt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Zt, { children: `${Y.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
function Xc({
  ...
  const f = _t(n, "%webView_inventory_all%"), h = _t(n, "%webView_inventory_approved%"), m = _t(n, "%webView_inventory_unapproved%"), g = _t(n, "%webView_inventory_unknown%"), N = _t(n, "%webView_inventory_scope_currentBook%"), y = _t(n, "%webView_inventory_scope_chapter%"), R = _t(n, "%webView_inventory_scope_verse%"), C = _t(n, "%webView_inventory_filter_text%"), x = _t(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = _t(n, "%webView_inventory_no_results%"), [M, S] = D(!1), [E, I] = D("all"), [k, T] = D(""), [A, L] = D([]), F = B(() => {
    const P = t ?? [];
  ...
  }, [M, F]), q = B(() => V.length === 0 ? [] : Al(V, E, k), [V, E, k]), O = B(() => {
    var wt, it;
    if (!M) return d;
    ...
    /* @__PURE__ */ c("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ c(fe, { onValueChange: (P) => gt(P), defaultValue: i, children: [
        ...
        /* @__PURE__ */ c(re, { children: [
          ...
          /* @__PURE__ */ r(vt, { value: "chapter", children: y }),
          /* @__PURE__ */ r(vt, { value: "verse", children: R })
        ] })
      ] }),
      /* @__PURE__ */ r(
        ke,
...
const Po = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(t), f = e ?? w, h = b.useCallback(
      ...
      [n, f]
    ), m = b.useCallback(() => h((x) => !x), [h]), g = f ? "expanded" : "collapsed", R = st() === "ltr" ? i : i === "primary" ? "secondary" : "primary", C = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ao.Provider, { value: C, children: /* @__PURE__ */ r(It, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Y.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === $t ? ce(a.start) : void 0;
      },
...
function Uc({
  ...
  K(() => {
    if (l) {
      ...
      if (T.length === 1) {
        const A = N.find((L) => Tr(L) === T[0]) || void 0;
        A && l(A);
      }
    }
  }, [m, N, l, R]);
  const C = a ?? rw, x = s ?? Go, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${C}`, value: [$t] },
  ...
  }, E = (k, T) => k.getIsGrouped() ? "" : u("banded-row", T % 2 === 0 ? "even" : "odd"), I = (k, T, A) => {
    if (!((k == null ? void 0 : k.length) === 0 || T.depth < A.column.getGroupedIndex())) {
      if (T.getIsGrouped())
        switch (T.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ c("div", { id: d, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ c(Qe, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(tn, { children: R.getHeaderGroups().map((k) => /* @__PURE__ */ r(Dt, { children: k.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Ae, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ c("div", { children: [
          ...
          " ",
          De(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, k.id)) }),
      /* @__PURE__ */ r(en, { children: R.getRowModel().rows.map((k, T) => {
        const A = st();
        return /* @__PURE__ */ r(
          Dt,
          {
...
function lw({
  ...
  }, [y, R] = D(!1), [C, x] = D(""), _ = W(void 0), M = W(!1);
  if (t.length !== Y.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const S = B(() => Y.allBookIds.filter(
    (V, q) => t[q] === "1" && !Y.isObsolete(Y.bookIdToNumber(V))
  ), [t]), E = B(() => {
    if (!C.trim()) {
      const O = {
        [H.OT]: [],
...
function qc({
  ...
  const w = Kt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = Kt(i, "%webView_scope_selector_current_book%"), m = Kt(i, "%webView_scope_selector_choose_books%"), g = Kt(i, "%webView_scope_selector_scope%"), N = Kt(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], R = e ? y.filter((C) => e.includes(C.value)) : y;
    ...
    /* @__PURE__ */ c("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Jn,
        {
          ...
          children: R.map(({ value: C, label: x, id: _ }) => /* @__PURE__ */ c("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Ue, { className: "tw-me-2", value: C, id: _ }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          re,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(vt, { value: `${w}`, children: l[U(w)] }, `${w}`))
          }
        )
      ]
    }
  ...
  if (Rs(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, f) => {
    ...
    switch (f.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (y = l.current) == null || y.focus(), Ee(l, [h, m]);
        break;
      case "alt+h":
        (R = d.current) == null || R.focus(), Ee(d, [h, m]);
        break;
    }
  }), K(() => {
...
function ad({
  ...
  const w = fw(
    ...
    var R, C, x, _, M, S;
    const y = N !== g ? ((C = (R = t[g]) == null ? void 0 : R.uiNames) == null ? void 0 : C[N]) ?? ((_ = (x = t[g]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return y ? `${(M = t[g]) == null ? void 0 : M.autonym} (${y})` : (S = t[g]) == null ? void 0 : S.autonym;
  };
