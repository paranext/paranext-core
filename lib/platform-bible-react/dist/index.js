...
const ya = He(
  ({
    ...
    return /* @__PURE__ */ l("div", { className: "tw-relative tw-max-w-48", children: [
      ...
      g && w && (s ? /* @__PURE__ */ r(_t, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-green-600" }) : i && /* @__PURE__ */ r(zr, { className: "tw-absolute tw-right-2 tw-top-1/2 tw-h-4 tw-w-4 tw--translate-y-1/2 tw-text-destructive" }))
    ] });
  }
), We = Or(void 0);
function ct() {
...
function Fa({
  ...
  const i = Array.from({ length: e }, (c, p) => p + 1), w = U(
    (c) => {
      o(c);
    },
    [o]
...
function Ws({
  ...
  const o = W(), [s, i] = P(
    () => Ot(t, "English")
  ), [w, c] = P(""), [p, g] = P(t.book), [v, f] = P(t.chapterNum ?? 0), [h, C] = P(t.book), [T, k] = P(!1), [y, S] = P(T), [V, I] = P(!1), [z, gt] = P(void 0), L = Q(void 0), x = Q(void 0), b = Q(void 0), B = Q(void 0), R = U(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (E, N) => {
    ...
    (m) => {
      ...
      return {
        ...
        const j = Un[N].toLowerCase(), F = w.length > 0 && /^\d/.test(w) ? (
    ...
    (m) => {
      if (T ? m.key === "ArrowDown" ? (B != null && B.current ? B.current.focus() : b != null && b.current ? b.current.focus() : x.current && x.current.focus(), m.preventDefault()) : m.key === "Escape" && document.activeElement === L.current && (k(!1), m.preventDefault(), m.stopPropagation()) : m.key !== "Tab" && m.key !== "Escape" && k(!0), document.activeElement === L.current) {
        if (/^[a-zA-Z]$/.test(m.key) && (Y(st ? w + m.key : m.key), I(!0), m.preventDefault()), !V) {
          if (/^\d$/.test(m.key)) {
            const N = s.match(
  ...
  }, [y, rt]), /* @__PURE__ */ l(pe, { modal: !1, open: T, onOpenChange: vt, children: [
...
function je({
  ...
  const [k, y] = P(!1);
  return /* @__PURE__ */ l(on, { open: k, onOpenChange: y, ...T, children: [
    ...
    /* @__PURE__ */ r(
      he,
      {
        ...
        children: /* @__PURE__ */ l(fe, { children: [
          ...
          /* @__PURE__ */ r(be, { children: e.map((S) => /* @__PURE__ */ l(
            xe,
            {
              value: w(S),
              onSelect: () => {
...
const Bt = u.forwardRef(({ className: t, children: e, position: n = "popper", ...a }, o) => {
  const s = W();
  return /* @__PURE__ */ r(H.Portal, { children: /* @__PURE__ */ l(
    H.Content,
    {
      ref: o,
      className: d(
...
function pi({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ft, { onValueChange: (_) => bt(_), defaultValue: i, children: [
...
function Yo({
  ...
  const s = mn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], c = o["%scripture_section_dc_short%"], p = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    X,
    {
      variant: "outline",
...
function Uo({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(on, { open: k, onOpenChange: y, children: [
      /* @__PURE__ */ r(sn, { asChild: !0, children: /* @__PURE__ */ l(
        X,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(he, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
        fe,
        {
          onKeyDown: (b) => {
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        an,
        {
          ...
          children: k.map(({ value: y, label: S, id: V }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
...
const ur = (t, e, n, a) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(un, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(Pn, { children: w.label }),
...
function Tn({
  ...
  return /* @__PURE__ */ l(pe, { variant: s, children: [
    ...
    /* @__PURE__ */ r(ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ l(En, { children: [
      /* @__PURE__ */ r(An, { children: /* @__PURE__ */ r(cn, { children: ur(e.groups, e.items, w, t) }) }),
  ...
  if (ba(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, v) => {
    ...
    switch (v.hotkey) {
      ...
      case "alt+l":
        ...
        break;
      case "alt+n":
        (k = w.current) == null || k.focus(), Kt(w, [f, h]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(gr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, v]) => typeof g == "boolean" || typeof v == "boolean" ? 0 : g.order - v.order).map(([g, v]) => /* @__PURE__ */ l(qo, { children: [
