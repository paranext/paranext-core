...
import { c as m, g as Re, a as Fa, C as Me, A as ce, P as Ae, b as qe, B as G, d as Ie, e as Ge, f as He, h as ye, i as ji, k as Bi, j as Fi, E as Li, l as La, r as re, m as Ui, n as dn, o as Zr, p as Ua, L as kt, D as ka, q as _a, s as Na, t as Ca, T as Lt, u as Ka, v as Ut, w as Kt, x as qt, y as wn, z as qa, F as Le, G as xr, H as ke, I as _e, J as Ne, S as yr, K as Qe, M as Ki, N as Nr, O as Ke, Q as Oe, Z as Ye, R as De, U as tr, V as Ga, W as Ha, X as Kr, Y as Ya, _ as un, $ as qi, a0 as Gi, a1 as Hi, a2 as Ea, a3 as pn, a4 as Qr, a5 as hn, a6 as Yi, a7 as Wi, a8 as Xi, a9 as Ji, aa as gn, ab as Zi, ac as na, ad as xo, ae as ia, af as Qi, ag as ts, ah as es, ai as rs, aj as as, ak as Cr, al as Wa } from "./resizable-BokZk-RX.js";
import { am as Uh, an as Kh, ao as qh, ap as Gh, aq as Hh, ar as Yh, as as Wh, at as Xh, au as Jh, av as Zh, aw as Qh, ax as tg, ay as eg, az as rg, aA as ag, aB as og, aC as ng, aD as ig, aE as sg, aF as cg, aG as lg, aH as dg, aI as wg, aJ as ug, aK as pg } from "./resizable-BokZk-RX.js";
import { jsx as a, jsxs as u, Fragment as it } from "react/jsx-runtime";
import { Canon as bt } from "@sillsdev/scripture";
import { Check as ar, Clock as yo, ChevronsLeft as ko, ChevronsRight as _o, ChevronLeft as Ta, ChevronRight as za, ArrowLeft as os, ArrowRight as ns, ChevronDown as or, BoldIcon as is, ItalicIcon as ss, X as Xa, AtSign as fn, Pencil as cs, Trash2 as ls, ArrowUp as mn, MoreHorizontal as ds, MailOpen as ws, Mail as us, ChevronUp as ps, FilterIcon as hs, ArrowLeftIcon as gs, ChevronLeftIcon as fs, ChevronRightIcon as ms, ArrowRightIcon as vs, Copy as vn, Filter as bs, User as xs, Link as ys, CircleHelp as ks, Undo as _s, Redo as Ns, SquareX as bn, FunctionSquare as xn, SquareSigma as yn, Ban as Cs, AlertCircle as Sa, CircleCheckIcon as Es, CircleXIcon as Ts, CircleHelpIcon as zs, ArrowUpIcon as Ss, ArrowDownIcon as Rs, ScrollText as Ds, ChevronsUpDown as Os, MenuIcon as $s, Menu as Ms, EllipsisVertical as As, MoreVertical as No } from "lucide-react";
import { Section as dt, getChaptersForBook as Is, formatScrRef as be, getSectionForBook as mr, formatRelativeDate as Vs, formatReplacementString as Ue, sanitizeHtml as Ja, NumberFormat as Ps, formatBytes as js, getCurrentLocale as Bs, usfmMarkers as Vr, getFormatCallerFunction as Fs, deepEqual as Ls, isString as Co, compareScrRefs as Ra, scrRefToBBBCCCVVV as sa, defaultScrRef as ca, formatScrRefRange as Us, getLocalizeKeyForScrollGroupId as Eo, formatReplacementStringToArray as To, collectUsjMarkers as Ks } from "platform-bible-utils";
import Tt, { useRef as K, useMemo as A, useState as k, useCallback as F, useEffect as W, useImperativeHandle as qs, useLayoutEffect as Zt, createContext as Za, useContext as kn, Component as Gs, createElement as zo, Suspense as Hs, forwardRef as _n, useId as So, Fragment as Qa } from "react";
import { RadioGroup as Da, ToggleGroup as Nn, Avatar as to, Select as Ft, Checkbox as Ro, Slot as Er, Tabs as le, Menubar as ge, ContextMenu as zt, Progress as Do, Slider as Dr, Switch as Oo } from "radix-ui";
import { createEditor as Cn, $getRoot as $e, $createParagraphNode as Tr, $getSelection as Yt, HISTORY_MERGE_TAG as eo, ParagraphNode as En, TextNode as Tn, $getPreviousSelection as Ys, $isRangeSelection as pe, $caretFromPoint as Ws, $getSiblingCaret as zn, $getChildCaret as Xs, $getAdjacentChildCaret as Js, $isChildCaret as Zs, $normalizeCaret as Qs, $setSelectionFromCaretRange as tc, $getCollapsedCaretRange as ec, $getCaretInDirection as $o, $splitAtPointCaretNext as rc, $isTextPointCaret as ac, $findMatchingParent as Sn, $isElementNode as kr, mergeRegister as Ce, getDOMTextNode as oc, isHTMLElement as nc, CLEAR_EDITOR_COMMAND as Rn, COMMAND_PRIORITY_EDITOR as ro, shallowMergeConfig as ic, defineExtension as ae, safeCast as We, createState as sc, FORMAT_TEXT_COMMAND as Dn, $isNodeSelection as On, COMMAND_PRIORITY_LOW as $n, RootNode as cc, LineBreakNode as lc, TabNode as dc, $isEditorState as wc, createCommand as uc, CLICK_COMMAND as pc, isDOMNode as hc, $getNodeFromDOMNode as gc, $createNodeSelection as fc, $setSelection as mc, $getEditor as vc, DecoratorNode as Oa, $getState as bc, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as xc, $setState as yc, addClassNamesToElement as Mn, $create as kc, $getNodeByKey as _c, removeClassNamesFromElement as Nc, KEY_TAB_COMMAND as Cc, $isBlockElementNode as Ec, $createRangeSelection as Tc, $normalizeSelection__EXPERIMENTAL as zc, OUTDENT_CONTENT_COMMAND as Sc, INDENT_CONTENT_COMMAND as Ao, INSERT_TAB_COMMAND as Rc, COMMAND_PRIORITY_CRITICAL as ao, $isDecoratorNode as Dc, $isParagraphNode as Oc, $isTextNode as $a, SELECTION_CHANGE_COMMAND as An, $insertNodes as $c } from "lexical";
import { HeadingNode as Mc, QuoteNode as Ac, registerRichText as Ic } from "@lexical/rich-text";
...
import { useReactTable as Vn, getFilteredRowModel as Lc, getSortedRowModel as Pn, getPaginationRowModel as Uc, getCoreRowModel as jn, flexRender as vr, getGroupedRowModel as Kc, getExpandedRowModel as qc } from "@tanstack/react-table";
import { IconCheck as ea, IconChevronDown as Gc, IconChevronUp as Hc, IconSelector as Yc, IconLayoutSidebar as Wc, IconLayoutSidebarRight as Xc, IconChevronRight as Bn, IconLoader as Jc, IconAlertOctagon as Zc, IconAlertTriangle as Qc, IconInfoCircle as tl, IconCircleCheck as el } from "@tabler/icons-react";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ma, HIDDEN_NOTE_CALLER as Aa, getDefaultViewOptions as al, isInsertEmbedOpOfType as Or, Editorial as ol } from "@eten-tech-foundation/platform-editor";
...
function da({
  ...
  const I = re(), [B, T] = k(!1), [V, $] = k(""), [N, j] = k(""), [D, E] = k("books"), [Y, q] = k(void 0), [L, O] = k(
    void 0
  ), [S, Z] = k(void 0), [Q, _t] = k(!1), Nt = K(null), It = K(!1), U = K(void 0), tt = K(void 0), wt = K(void 0), st = K(void 0), vt = K({}), oe = K({}), at = F(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
    ...
    return [dt.OT, dt.NT, dt.DC, dt.Extra].forEach((rt) => {
      b[rt] = St[rt].filter((Pt) => La(Pt, N, n));
    }), b;
  }, [St, N, n]), R = A(
    () => pl(N, Wt, n),
    [N, Wt, n]
  ...
  const xt = F(() => {
    ...
    (b) => {
      const H = L ?? (R == null ? void 0 : R.book), rt = S ?? (R == null ? void 0 : R.chapterNum);
      !H || !rt || (at({
        book: H,
        chapterNum: rt,
        verseNum: b
  ...
  const { otLong: gt, ntLong: pt, dcLong: ft, extraLong: Rt } = {
    ...
    () => wl(N),
    [N]
  ), yt = A(() => !l || !R || !R.chapterNum || !$t ? !1 : l(R.book, R.chapterNum) > 0, [l, R, $t]), de = F(
    (b) => w ? Io(b, w) : !1,
    [w]
  ), Te = F(
    (b) => (H) => w ? ul(b, H, w) : !1,
          ...
          Ge,
          {
            ...
            children: [
              D === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a(
                  G,
                  {
                    ...
                    tabIndex: -1,
                    children: I === "ltr" ? /* @__PURE__ */ a(os, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ns, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                D === "chapters" && Y && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: Re(Y, n) }),
                D === "verses" && L && S !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${Re(L, n)} ${S}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
              ...
              !Q && /* @__PURE__ */ u(He, { ref: wt, children: [
                ...
                D === "verses" && L && S !== void 0 && l && /* @__PURE__ */ a(
                  jo,
                  {
                    bookId: L,
                    chapterNum: S,
...
function Bo({
  ...
  const [_, I] = k(!1), B = l ?? d, T = ($) => $.length > 0 && typeof $[0] == "object" && "options" in $[0], V = ($, N) => {
  ...
  return /* @__PURE__ */ u(Ae, { open: _, onOpenChange: I, ...y, children: [
...
const qn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ml = qn ? Zt : W, Mr = { tag: eo };
function vl({ initialConfig: t, children: e }) {
  const r = A(() => {
    const { theme: o, namespace: n, nodes: i, onError: s, editorState: c, html: d } = t, l = fl(null, o), w = Cn({ editable: t.editable, html: d, namespace: n, nodes: i, onError: (p) => s(p, w), theme: o });
    return function(p, g) {
      if (g !== null) {
...
function Tl() {
  return function(t) {
    const [e] = fe(), r = A(() => t(e), [e, t]), [o, n] = k(() => r.initialValueFn()), i = K(o);
    return Cl(() => {
...
function Dl(t, e, r) {
  ...
  function d() {
    ...
    for (let C = 0; C < h.length; C++) {
      const y = h[C], _ = s[C] || document.createElement("div"), I = _.style;
      I.position !== "absolute" && (I.position = "absolute", v = !0);
      const B = ue(y.left - p);
      I.left !== B && (I.left = B, v = !0);
      const T = ue(y.top - g);
      I.top !== T && (_.style.top = T, v = !0);
      const V = ue(y.width);
      I.width !== V && (_.style.width = V, v = !0);
      const $ = ue(y.height);
      I.height !== $ && (_.style.height = $, v = !0), _.parentNode !== c && (c.append(_), v = !0), s[C] = _;
    }
...
function $l(t, e = Ol) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), f = g.getNode(), x = f.getKey(), v = g.offset, C = h.getNode(), y = C.getKey(), _ = h.offset, I = t.getElementByKey(x), B = t.getElementByKey(y), T = r === null || I !== o || v !== n || x !== r.getKey(), V = i === null || B !== s || _ !== c || y !== i.getKey();
      if ((T || V) && I !== null && B !== null) {
        const $ = function(N, j, D, E, Y, q, L) {
          const O = (N._window ? N._window.document : document).createRange();
          return O.setStart(...Fo(j, D, E)), O.setEnd(...Fo(Y, q, L)), O;
        }(t, g, f, I, h, C, B);
        d(), d = Dl(t, $, e);
      }
      r = f, o = I, n = v, i = C, s = B, c = _;
    });
  }
...
function Vl(t, e, r) {
  ...
  return ac(o) && Gr(283), o.insert(t.isInline() ? Tr().append(t) : t), $o(zn(t.getLatest(), "next"), e.direction);
}
function Pl(t) {
  const e = Yt();
  if (!pe(e)) return !1;
...
let Hr, xe = 0, Yr = 0, Fl = 0, Va = 0, jr = 0;
function Uo(t) {
  if (nt === void 0) return;
  let e = t.n;
...
function Ul(t) {
  ...
  Yn(this), nt = t, this.f &= -2, 8 & this.f && so(this), ra();
}
function Ze(t, e) {
...
Bt.prototype.brand = jl, Bt.prototype.h = function() {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Wn(this), Ko(this), xe++;
  const t = nt;
...
function Jn(t, e = Xn) {
  return t.registerCommand(Rn, (r) => (t.update(e), !0), ro);
}
...
const pa = sc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Zn extends Oa {
  $config() {
    return this.config("decorator-text", { extends: Oa, stateConfigs: [{ flat: !0, stateConfig: pa }] });
  }
  getFormat() {
    return bc(this, pa);
  }
...
ae({ name: "@lexical/extension/DecoratorText", nodes: () => [Zn], register: (t, e, r) => t.registerCommand(Dn, (o) => {
  const n = Yt();
  if (On(n) || pe(n)) for (const i of n.getNodes()) ql(i) && i.toggleFormat(o);
  return !1;
}, $n) });
function Qn(t, e) {
  let r;
...
const co = 0, ja = 1, ei = 2, ha = 3, Ar = 4, Je = 5, ga = 6, gr = 7;
function fa(t) {
  return t.id === co;
}
function ri(t) {
...
const Xl = ae({ config: We({ setOptions: qo, updateOptions: qo }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [cc, Tn, lc, dc, En] }), Go = Symbol.for("@lexical/extension/LexicalBuilder");
function Ho() {
}
function Jl(t) {
  throw t;
...
const Zl = /* @__PURE__ */ new Set(), Yo = ae({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = Ll(() => (i.value || Zl).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
    return l = l || /* @__PURE__ */ new Set(), l.add(c), w || (d.set(s, l), n.value = { watchedNodeKeys: d }), c;
  } };
}, dependencies: [Pa], name: "@lexical/extension/NodeSelection" }), Ql = uc("INSERT_HORIZONTAL_RULE_COMMAND");
class nr extends Oa {
  static getType() {
...
ae({ dependencies: [Pa, Yo], name: "@lexical/extension/HorizontalRule", nodes: () => [nr], register(t, e, r) {
  ...
  return Ce(t.registerCommand(Ql, (s) => {
    ...
    return !0;
  }, ro), t.registerCommand(pc, (s) => {
    if (hc(s.target)) {
      const c = gc(s.target);
      if (ed(c)) return function(d, l = !1) {
        const w = Yt(), p = d.isSelected(), g = d.getKey();
        let h;
        l && On(w) ? h = w : (h = fc(), mc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
...
function rd(t, e, r = ai) {
  return Ce(t.registerCommand(Cc, (o) => {
    ...
    const i = function(s) {
      ...
      return !1;
    }(n) ? o.shiftKey ? Sc : Ao : Rc;
    return t.dispatchCommand(i, void 0);
  }, ro), t.registerCommand(Ao, () => {
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (pe(f)) {
                ...
                if ($a(v) && l >= 0 && w >= 0 && (C = l, y = l + w, f.setTextNodeRange(v, C, v, y)), C === y && p === "" || (f.insertRawText(p), v = x.getNode()), $a(v)) {
                  C = g, y = g + h;
...
function dd({ contentEditable: t, placeholder: e = null, ErrorBoundary: r }) {
  ...
  return function(n) {
    wo(() => Ce(Ic(n), ni(n)), [n]);
  }(o), u(it, { children: [t, a(wd, { content: e }), a(ld, { editor: o, ErrorBoundary: r })] });
}
...
const pd = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Zt : W;
...
function vd(t, e) {
  ...
  return u(it, { children: [a(fd, { editor: n, ...o, ref: e }), r != null && a(bd, { editor: n, content: r })] });
}
...
function Ed() {
  const { activeEditor: t } = ci(), [e, r] = k([]), o = F((n) => {
    if (pe(n) || jc(n)) {
      const i = [];
      Jo.forEach(({ format: s }) => {
...
function hi({
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
...
const Dd = "verseText", Hu = Object.freeze([
...
function Yu({
  ...
  const [i, s] = k(Od), [c, d] = k(n), [l, w] = k(!1), p = K(void 0), g = K(null);
  W(() => {
    let v = !0;
    const C = g.current;
    if (!C) return;
...
function Qo({
  ...
  const h = F(
    ...
    [t.user]
  ), y = A(() => Ja(t.contents), [t.contents]), _ = A(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), I = !!t.conflictResolutionAction && !_, B = A(() => {
    if (o && c)
      return /* @__PURE__ */ u(it, { children: [
        /* @__PURE__ */ u(
          Le,
          {
            onClick: (T) => {
              T.stopPropagation(), l(!0), p(Rd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Id, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Vd, { className: "tw:text-xs tw:font-medium", children: C }) }),
        ...
        B && /* @__PURE__ */ u(ke, { children: [
          /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ds, {}) }) }),
...
function bi({
  ...
  const [E, Y] = k(tn), [q, L] = k(), [O, S] = k(), Z = o, [Q, _t] = k(!1), [Nt, It] = k(!1), [U, tt] = k(!1), [wt, st] = k(!1), [vt, oe] = k(!1), [at, Vt] = k(I), [St, Wt] = k(!1), ne = K(void 0), [R, Xt] = k(/* @__PURE__ */ new Map());
  W(() => {
    let z = !0;
    return (async () => {
  ...
  }, [i, r]), ut = A(() => Ct.slice(1), [Ct]), ct = A(() => ut.length ?? 0, [ut.length]), gt = A(() => ct > 0, [ct]), pt = A(() => Q || ct <= 2 ? ut : ut.slice(-2), [ut, ct, Q]), ft = A(() => Q || ct <= 2 ? 0 : ct - 2, [ct, Q]), Rt = A(
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              G,
              {
                ...
                children: at ? /* @__PURE__ */ a(ws, {}) : /* @__PURE__ */ a(us, {})
              }
            ),
            j === void 0 ? (
...
), jd = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Lr = (t) => jd(Ja(t));
function Ur({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function Bd({
  ...
  const [s, c] = k("accept"), d = So(), l = So(), w = r === "loading", p = r === "accept", g = r === "none", h = r === "acceptRejectOrMerge", f = p ? "accept" : s, x = A(
    () => Lr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), v = A(
    () => Lr(t.acceptedText ?? ""),
      ...
      !w && !g && /* @__PURE__ */ u(it, { children: [
        ...
        /* @__PURE__ */ a(
          oo,
          {
            ...
            children: T.map((O) => q(O) ? /* @__PURE__ */ a(Lt, { delayDuration: 0, children: /* @__PURE__ */ u(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: L(O) }),
              /* @__PURE__ */ a(qt, { children: I })
            ] }) }, O.value) : L(O))
          }
        ),
        /* @__PURE__ */ a(Lt, { delayDuration: 0, children: /* @__PURE__ */ u(Ut, { children: [
...
function ap({
  ...
  const [y, _] = k(/* @__PURE__ */ new Set()), [I, B] = k(), [T, V] = k(), $ = F(
    async (S) => {
      const Z = await i(S);
  ...
  const N = r.filter(
    ...
    [y, x]
  ), { listboxRef: Y, activeId: q, handleKeyDown: L } = Ki({
    options: j,
    onOptionSelect: D
  }), O = F(
    (S) => {
      S.key === "Escape" ? (I && y.has(I) && (_((Z) => {
        const Q = new Set(Z);
        return Q.delete(I), Q;
...
function cr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ft.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ft.Icon, { asChild: !0, children: /* @__PURE__ */ a(Yc, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Jd({
  ...
  var T;
  const [w, p] = k([]), [g, h] = k([]), [f, x] = k({}), [v, C] = k({}), y = A(() => e ?? [], [e]), _ = Vn({
    data: y,
    columns: t,
    getCoreRowModel: jn(),
  ...
  return d ? B = Array.from({ length: 10 }).map((N, j) => `skeleton-row-${j}`).map((N) => /* @__PURE__ */ a(De, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(tr, { colSpan: I.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Qe, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, N)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? B = _.getRowModel().rows.map((V) => /* @__PURE__ */ a(
    ...
    V.id
  )) : B = /* @__PURE__ */ a(De, { children: /* @__PURE__ */ a(tr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(Gd, { table: _ }),
    /* @__PURE__ */ u(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: _.getHeaderGroups().map((V) => /* @__PURE__ */ a(De, { children: V.headers.map(($) => /* @__PURE__ */ a(Kr, { className: "tw:p-0", children: $.isPlaceholder ? void 0 : vr($.column.columnDef.header, $.getContext()) }, $.id)) }, V.id)) }),
...
function lp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(ke, { children: [
    ...
    /* @__PURE__ */ a(Ne, { children: r.map((l, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(un, { children: l.itemType === 0 ? /* @__PURE__ */ a(it, { children: l.items.map((p, g) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Oe,
        {
          checked: o[w][g],
...
function aw({
  ...
  return /* @__PURE__ */ u(Ka, { children: [
    ...
    e && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
        G,
        {
          "aria-label": w,
...
const nw = (t, e, r) => t === "generated" ? /* @__PURE__ */ u(it, { children: [
...
function iw({
  ...
  const f = (v) => {
    ...
    var C, y, _, I;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((C = i.current) == null || C.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((_ = i.current) == null ? void 0 : _.selectionStart) === 0 && ((I = s.current) == null || I.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
  return /* @__PURE__ */ u(ke, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: nw(t, n, r) }) }) }),
...
const sw = (t, e) => t === "f" ? /* @__PURE__ */ u(it, { children: [
  /* @__PURE__ */ a(xn, {}),
  " ",
...
function lw({
  ...
  return /* @__PURE__ */ u(ke, { children: [
    /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(_e, { asChild: !0, children: /* @__PURE__ */ a(G, { variant: "outline", className: "tw:h-6", children: sw(t, r) }) }) }),
...
function pp({
  ...
  const [f, x] = k("generated"), [v, C] = k("generated"), [y, _] = k("*"), [I, B] = k("*"), [T, V] = k("f"), [$, N] = k(!1), [j, D] = k(!0), [E, Y] = k(!1), q = K(!1), L = K(""), [O, S] = k(!1), [Z, Q] = k(), [_t, Nt] = k(), [It, U] = k(), [tt, wt] = k(), st = K(null), vt = A(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (X && Or("note", X)) {
      ...
      let ct = "custom";
      ut === Ma ? ct = "generated" : ut === Aa ? ct = "hidden" : ut && (_(ut), B(ut)), x(ct), C(ct), V(((et = X.insert.note) == null ? void 0 : et.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const at = F(
    (P, X, ot = !1) => {
      ...
      if (et && Or("note", et)) {
        if (et.insert.note) {
          let pt;
          P === "custom" ? pt = X : P === "generated" ? pt = Ma : pt = Aa, et.insert.note.caller = pt;
        }
  ...
  const ne = () => {
    ...
    if (X && Or("note", X)) {
      ...
      T !== "x" && P === "x" ? pt == null || pt.forEach((ft) => hw(ft)) : T === "x" && P !== "x" && (pt == null || pt.forEach((ft) => gw(ft))), (gt = w.current) == null || gt.applyUpdate([X, { delete: 1 }]);
    }
  }, Ct = (P) => {
    ...
    (P) => {
      ...
      if (X && Or("note", X)) {
        ...
        if (pt || N(!1), N(
          ...
          q.current = !0, L.current = JSON.stringify(X), D(!0);
          return;
        }
        D(JSON.stringify(X) === L.current), at(f, y);
      } else
        N(!1), D(!0);
    },
    [f, y, at]
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
              /* @__PURE__ */ a(Kt, { asChild: !0, children: /* @__PURE__ */ a(
                G,
                {
                  "aria-label": ie,
...
function gp({
  ...
  const w = d ?? Fs(r, void 0), p = (y, _) => {
    l == null || l(y, _, n);
  }, g = i ? r.findIndex((y) => y === i) : -1, [h, f] = k(g), x = (y, _, I) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
          y.preventDefault(), l == null || l(_, I, n);
          break;
      }
  }, v = (y) => {
    if (r.length)
...
function yw({
  ...
  return /* @__PURE__ */ u(Ga, { stickyHeader: !0, children: [
    /* @__PURE__ */ a(Ha, { stickyHeader: !0, children: /* @__PURE__ */ u(De, { children: [
...
const kw = (t) => {
...
}, aa = (t, e, r) => /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
  /* @__PURE__ */ u(
    Kt,
    {
  ...
  return e ? e[1] : "";
}, Nw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", kp = Object.freeze([
...
function _p({
  ...
  const h = we(r, "%webView_inventory_all%"), f = we(r, "%webView_inventory_approved%"), x = we(r, "%webView_inventory_unapproved%"), v = we(r, "%webView_inventory_unknown%"), C = we(r, "%webView_inventory_scope_currentBook%"), y = we(r, "%webView_inventory_scope_chapter%"), _ = we(r, "%webView_inventory_scope_verse%"), I = we(r, "%webView_inventory_filter_text%"), B = we(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = we(r, "%webView_inventory_no_results%"), [V, $] = k(!1), [N, j] = k("all"), [D, E] = k(""), [Y, q] = k([]), L = A(() => {
    const U = t ?? [];
  ...
  }, [V, L]), S = A(() => O.length === 0 ? [] : Cw(O, N, D), [O, N, D]), Z = A(() => {
    var wt, st;
    if (!V) return d;
  ...
  return /* @__PURE__ */ a("div", { id: l, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      o && /* @__PURE__ */ a(Lt, { children: /* @__PURE__ */ u(Ut, { children: [
        ...
        /* @__PURE__ */ a(qt, { children: (o == null ? void 0 : o.checkboxText) ?? B })
      ] }) })
    ] }),
...
const Tw = "16rem", zw = "3rem", ki = Tt.createContext(void 0);
function oa() {
...
function Sw({
  ...
  const [d, l] = Tt.useState(t), w = e ?? d, p = Tt.useCallback(
    (_) => {
      const I = typeof _ == "function" ? _(w) : _;
      r ? r(I) : l(I);
    },
    [r, w]
    ...
    Rw,
    {
      ...
      children: /* @__PURE__ */ u(Ow, { children: [
        /* @__PURE__ */ u(on, { children: [
          ...
          /* @__PURE__ */ a(sn, { children: /* @__PURE__ */ a($w, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Mw, { children: /* @__PURE__ */ a(
            Iw,
            {
              onClick: () => l(h),
              isActive: g(h),
...
const Se = "scrBook", Pw = "scrRef", Fe = "source", jw = "details", Bw = "Scripture Reference", Fw = "Scripture Book", _i = "Type", Lw = "Details";
function Uw(t, e) {
  const r = e ?? !1;
  return [
    {
...
const Kw = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ra(t.start, t.end) === 0 ? `${sa(t.start)}+${e}` : `${sa(t.start)}+${e}-${sa(t.end)}+${r}`;
...
function Pp({
  ...
  const [l, w] = k([]), [p, g] = k([{ id: Se, desc: !1 }]), [h, f] = k({}), x = A(
    ...
    !e && /* @__PURE__ */ u(
      ir,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(lr, { position: "item-aligned", children: /* @__PURE__ */ a(Hd, { children: I.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
...
function qw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: g, dcLong: h, extraLong: f } = {
  ...
  }, [x, v] = k(!1), [C, y] = k(""), _ = K(void 0), I = K(!1), B = A(
    () => Ni(t),
    [t]
  ), T = A(() => {
    if (!C.trim()) {
    ...
    (E, Y = !1) => {
      ...
      const q = B.findIndex((Q) => Q === _.current), L = B.findIndex((Q) => Q === E);
      if (q === -1 || L === -1) return;
      const [O, S] = [
        Math.min(q, L),
        Math.max(q, L)
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === xa ? xa : ln
      ).map((d) => /* @__PURE__ */ a(xr, { className: "tw:hover:bg-secondary", variant: "secondary", children: Re(d, n) }, d)),
...
function Bp({
  ...
  const I = Et(
  ...
  ], U = (M, J, Ht = !1) => /* @__PURE__ */ u(it, { children: [
    M,
  ...
  }, at = K(null), Vt = K(null), St = K(!1), Wt = K(null), ne = K(!1), [R, Xt] = k(void 0), xt = K(!1), Ct = K(!1), Qt = K(null), me = F((M) => {
    if (M) {
    ...
    [r, n, f, i]
  ), et = tt.find((M) => M.value === t), ut = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Us(st, vt, {
  ...
  ), gt = tt.find((M) => M.value === "selectedBooks"), pt = tt.find((M) => M.value === "range"), [ft, Rt] = k(!1), [Dt, Gt] = k(void 0), [Ot, Ee] = k(void 0), [z, $t] = k(void 0), [yt, de] = k(void 0), [Te, wr] = k([]), ur = l === "dropdown" && Dt === "selectedBooks", pr = /* @__PURE__ */ a(
    Hw,
    {
      availableBookInfo: o,
  ...
  const [mt, At] = k(null), [ht, te] = k(null), [Jt, je] = k(null), $i = 200, [Mi, Ai] = k(!1);
  W(() => {
  ...
  const fo = F(
    (M) => {
      Ee(M), $t(st), de(vt), wr(n), Rt(!1), Gt(M);
    },
    [st, vt, n]
  ), mo = F(() => {
    Ot !== void 0 && (Ot === "range" ? (z && (g == null || g(z)), yt && (h == null || h(yt))) : Ot === "selectedBooks" && i(Te), ot(Ot), Gt(void 0), Ee(void 0));
  }, [
    Ot,
    z,
    yt,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(ke, { open: ft, onOpenChange: Rt, children: [
        ...
        /* @__PURE__ */ a(
          Ne,
          {
            ...
            children: /* @__PURE__ */ u(na, { container: Jt, children: [
              ct.map(({ value: M, label: J, dropdownLabel: Ht, scrRefSuffix: hr, id: Ii }) => /* @__PURE__ */ u(
                Le,
                {
                  ref: ze(M),
        ...
        oo,
        {
          ...
          children: tt.map(({ value: M, label: J, scrRefSuffix: Ht, id: hr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
    ...
    l === "radio" && t === "range" && ve,
    l === "dropdown" && gt && /* @__PURE__ */ a(ka, { open: Dt === "selectedBooks", onOpenChange: Rr, children: /* @__PURE__ */ a(
      _a,
      {
        ref: te,
        onCloseAutoFocus: vo,
    ...
    l === "dropdown" && pt && /* @__PURE__ */ a(ka, { open: Dt === "range", onOpenChange: Rr, children: /* @__PURE__ */ a(
      _a,
      {
        ref: At,
        onCloseAutoFocus: vo,
...
function Ba({
  ...
  return /* @__PURE__ */ u(ke, { variant: i, children: [
    /* @__PURE__ */ a(_e, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(G, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a($s, {}) }) }),
    /* @__PURE__ */ a(Ne, { align: "start", style: { zIndex: Ye }, children: Object.entries(e.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, l]) => typeof d == "boolean" || typeof l == "boolean" ? 0 : d.order - l.order).map(([d], l, w) => /* @__PURE__ */ u(Qa, { children: [
      /* @__PURE__ */ a(un, { children: /* @__PURE__ */ a(Lt, { children: Ti(e.groups, e.items, d, t) }) }),
  ...
  return n.flatMap(([i], s) => {
    const c = e.filter((l) => l.group === i).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ u(Ut, { children: [
      /* @__PURE__ */ a(Kt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ u(
        ...
        /* @__PURE__ */ a(nu, { children: l.label }),
    ...
    return c.length > 0 && s < n.length - 1 && d.push(/* @__PURE__ */ a(au, {}, `separator-${i}`)), d;
  });
};
function su({
  menuData: t,
  ...
  if (nl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Jw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(Zw, { children: [
      /* @__PURE__ */ a(tu, { ref: l(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        eu,
        {
          style: { zIndex: Ye },
...
function Xp({
  ...
  const l = cu(
    ...
    var C, y, _, I, B, T;
    const v = x !== f ? ((y = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : y[x]) ?? ((I = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : I.en) : void 0;
    ...
    /* @__PURE__ */ u(Ut, { open: t, onOpenChange: () => {
      ...
      /* @__PURE__ */ a(
        qt,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:inline-flex tw:w-full tw:h-full tw:items-center tw:gap-1.5 tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: To(l, {
            key: /* @__PURE__ */ a(
              Ea,
              {
                className: m(
...
function th({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function jh(t) {
  const e = A(() => Ks(t).slice().sort().join(" "), [t]);
...
export {
  ...
  Jd as DataTable,
  Zp as DestructiveKeyConfirmation,
  ka as Dialog,
  Kh as DialogClose,
  _a as DialogContent,
