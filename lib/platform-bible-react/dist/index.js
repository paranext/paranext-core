...
import { formatScrRef as Ot, MODIFIER_KEYS as gn, getChaptersForBook as da, NumberFormat as ca, formatBytes as pa, deepEqual as Ze, isString as Ve, compareScrRefs as Ie, scrRefToBBBCCCVVV as Oe, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
function Ws({
  ...
  const o = W(), [s, i] = I(
    () => Ot(t, "English")
  ), [w, c] = I(""), [p, g] = I(t.book), [v, f] = I(t.chapterNum ?? 0), [h, C] = I(t.book), [T, N] = I(!1), [x, S] = I(T), [D, A] = I(!1), [z, ft] = I(), H = Q(void 0), y = Q(void 0), b = Q(void 0), B = Q(void 0), R = Y(
    (m) => {
      if (m.trim())
        return yn.reduce(
          (V, _) => {
            ...
            const U = _.exec(m);
            if (U) {
              const [j, Tt = void 0, oe = void 0] = U.slice(1), st = kn(j) ?? (M.isBookIdValid(j) ? j.toLocaleUpperCase() : void 0);
              if (st) {
                const wt = Tt ? parseInt(Tt, 10) : void 0;
                if (wt && wt > Pt(st)) return;
    ...
    if (!(!z || !z.chapterNum))
      return z.verseNum ? [z.chapterNum] : Array.from({ length: Pt(h) }, (m, V) => V + 1).filter(
        (m) => {
          var V;
    ...
    (m, V) => {
      ...
      if (Nn.has(_)) {
        if (h === p || k === 1) {
          ...
          const Tt = _ === "ArrowRight" && !o || _ === "ArrowRight" && o === "ltr" || _ === "ArrowLeft" && o === "rtl", oe = _ === "ArrowLeft" && !o || _ === "ArrowLeft" && o === "ltr" || _ === "ArrowRight" && o === "rtl", Ee = Array.from(
            { length: Pt(h) },
            (se, Rt) => Rt + 1
          ), st = p !== h || k === 1 ? K ?? Ee : Ee, wt = st.indexOf(v);
          let vt = v;
          if (Tt)
...
function Ge({
  ...
  const [N, x] = I(!1);
  return /* @__PURE__ */ l(fe, { open: N, onOpenChange: x, ...T, children: [
...
function Qs({
  ...
  const g = Me(p, "%webView_bookSelector_currentBook%"), v = Me(p, "%webView_bookSelector_choose%"), f = Me(p, "%webView_bookSelector_chooseBooks%"), [h, C] = I(
    "current book"
    /* CURRENT_BOOK */
  ), T = (N) => {
    C(N), t(N);
...
function so({
  ...
  var N;
  const [w, c] = I([]), [p, g] = I([]), [v, f] = I({}), [h, C] = I({}), T = On({
    data: e,
    columns: t,
    getCoreRowModel: zn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ke, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ce, { stickyHeader: s, children: T.getHeaderGroups().map((x) => /* @__PURE__ */ r(kt, { children: x.headers.map((S) => /* @__PURE__ */ r(te, { children: S.isPlaceholder ? void 0 : Jt(S.column.columnDef.header, S.getContext()) }, S.id)) }, x.id)) }),
      /* @__PURE__ */ r(_e, { children: (N = T.getRowModel().rows) != null && N.length ? T.getRowModel().rows.map((x) => /* @__PURE__ */ r(
        kt,
        {
          onClick: () => i(x, T),
...
function uo({
  ...
  return /* @__PURE__ */ l(ke, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(Ce, { stickyHeader: !0, children: /* @__PURE__ */ l(kt, { children: [
...
function mi({
  ...
  const p = xt(n, "%webView_inventory_all%"), g = xt(n, "%webView_inventory_approved%"), v = xt(n, "%webView_inventory_unapproved%"), f = xt(n, "%webView_inventory_unknown%"), h = xt(n, "%webView_inventory_scope_currentBook%"), C = xt(n, "%webView_inventory_scope_chapter%"), T = xt(n, "%webView_inventory_filter_text%"), N = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, S] = I(!1), [D, A] = I("all"), [z, ft] = I(""), [H, y] = I([]), b = q(() => t.length === 0 ? [] : bo(t, o, s), [t, o, s]), B = q(() => {
    if (x) return b;
    const k = [];
    return b.forEach((L) => {
...
const yt = "scrBook", Ao = "scrRef", Vt = "source", Po = "details", Io = "Scripture Reference", Fo = "Scripture Book", dr = "Type", jo = "Details";
function Xo(t, e) {
  const n = e ?? !1;
  return [
    {
...
function fi({
  ...
  const [c, p] = I([]), [g, v] = I([{ id: yt, desc: !1 }]), [f, h] = I({}), C = q(
  ...
  dt(() => {
    if (w) {
      ...
      if (b.length === 1) {
        const B = C.find((R) => Sn(R) === b[0]) || void 0;
        B && w(B);
      }
    }
  }, [f, C, w, N]);
  const x = o ?? Fo, S = s ?? dr, D = [
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ l(ke, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ce, { children: N.getHeaderGroups().map((y) => /* @__PURE__ */ r(kt, { children: y.headers.filter((b) => b.column.columnDef.header).map((b) => (
                    ...
                    children: R.getIsGrouped() ? /* @__PURE__ */ l(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !y.getIsExpanded() && (B === "ltr" ? /* @__PURE__ */ r(Ke, {}) : /* @__PURE__ */ r(na, {})),
                          " ",
...
function Uo({
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    ...
    /* @__PURE__ */ l(fe, { open: N, onOpenChange: x, children: [
      /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ l(
        F,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(
        sn,
        {
          ...
          children: N.map(({ value: x, label: S, id: D }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(we, { className: "tw-me-2", value: x, id: D }),
