...
import p, { forwardRef as Le, useRef as nt, useCallback as X, useMemo as J, useState as z, useLayoutEffect as fn, createContext as Br, useContext as jr, useEffect as Mt, Fragment as Vn } from "react";
import { Command as wt } from "cmdk";
import { X as He, Search as Mn, Check as _t, ChevronsLeft as gn, ChevronsRight as bn, ChevronLeft as Oe, ChevronRight as Ot, ArrowLeft as $r, ArrowRight as Xr, Circle as he, ChevronsUpDown as Ye, FilterIcon as Fr, ChevronDown as fe, ChevronUp as Gr, ArrowLeftIcon as Lr, ChevronLeftIcon as Hr, ChevronRightIcon as Yr, ArrowRightIcon as Ur, Copy as Kr, Filter as qr, User as Jr, Link as Wr, CircleHelp as Zr, Star as Qr, CircleCheckIcon as ta, CircleXIcon as ea, CircleHelpIcon as na, ArrowUpIcon as ra, ArrowDownIcon as aa, ArrowUpDownIcon as oa, PanelLeft as sa, PanelRight as ia, ScrollText as wa, MenuIcon as la, Menu as da, EllipsisVertical as ca, LoaderCircle as pa } from "lucide-react";
import { clsx as ua } from "clsx";
import { extendTailwindMerge as ma } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { Section as B, doesBookMatchQuery as Ue, getChaptersForBook as ha, getLocalizedSectionNames as Dn, getSectionLongName as In, formatScrRef as Jt, getSectionForBook as Wt, NumberFormat as fa, formatBytes as ga, deepEqual as Ke, isString as Re, compareScrRefs as Ae, scrRefToBBBCCCVVV as Te, getSectionShortName as ba, getLocalizeKeyForScrollGroupId as A } from "platform-bible-utils";
...
import { useReactTable as On, getFilteredRowModel as va, getSortedRowModel as An, getPaginationRowModel as xa, getCoreRowModel as Pn, flexRender as Zt, getGroupedRowModel as ya, getExpandedRowModel as Na } from "@tanstack/react-table";
...
const Ea = ft.Portal, $n = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: d(
...
$n.displayName = ft.Overlay.displayName;
...
oe.displayName = wt.displayName;
const se = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
...
se.displayName = wt.Input.displayName;
...
ie.displayName = wt.List.displayName;
const be = p.forwardRef((t, e) => /* @__PURE__ */ r(wt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
be.displayName = wt.Empty.displayName;
...
At.displayName = wt.Group.displayName;
...
Xn.displayName = wt.Separator.displayName;
...
var Ia = Object.defineProperty, za = (t, e, n) => e in t ? Ia(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, E = (t, e, n) => za(t, typeof e != "symbol" ? e + "" : e, n);
const Dt = [
  "GEN",
  "EXO",
  "LEV",
...
function Hn(t) {
  return t <= 0 || t > Ln ? "******" : Fn[t - 1];
}
function Xa(t) {
  return Hn(Gt(t));
}
function Yn(t) {
  const e = typeof t == "number" ? We(t) : t;
  return Je(e) && !qe.includes(e);
}
function Fa(t) {
  const e = typeof t == "number" ? We(t) : t;
  return Je(e) && qe.includes(e);
...
const it = class V {
  ...
  parse(e) {
    ...
    if (a.length !== 2 || I.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !V.isVerseParseable(a[1]))
      throw new Ut("Invalid reference : " + e);
...
const Kn = Le(
  ({
    ...
    const m = nt(!1), g = () => {
      ...
      m.current = !0, a ? a(C) : n == null || n(t);
    }, f = w && ((v = w.get(t)) == null ? void 0 : v.localizedName) || I.bookIdToEnglishName(t), b = w && ((x = w.get(t)) == null ? void 0 : x.localizedId) || t.toLocaleUpperCase();
    return /* @__PURE__ */ r(
      "div",
      {
        className: d(
          ...
          {
            "tw-border-s-red-200": o === B.OT,
            "tw-border-s-purple-200": o === B.NT,
            "tw-border-s-indigo-200": o === B.DC,
            "tw-border-s-amber-200": o === B.Extra
          }
        ),
        children: /* @__PURE__ */ l(
          Ft,
          {
            ref: c,
            value: u || `${t} ${I.bookIdToEnglishName(t)}`,
            onSelect: g,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
            "aria-label": `${I.bookIdToEnglishName(t)} (${t.toLocaleUpperCase()})`,
            className: s,
            children: [
              i && /* @__PURE__ */ r(
                _t,
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, s) => /* @__PURE__ */ r(a ? $t : "button", { className: d(Ha({ variant: e, size: n, className: t })), ref: s, ...o })
);
D.displayName = "Button";
const we = te.Root, le = te.Trigger, Lt = p.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = et();
...
Lt.displayName = te.Content.displayName;
const qn = I.allBookIds.filter(
  (t) => !I.isObsolete(I.bookIdToNumber(t))
), yt = Object.fromEntries(
  qn.map((t) => [t, I.bookIdToEnglishName(t)])
), Ee = {
  ...
  const a = Ya.reduce(
    (o, s) => {
      ...
      if (i) {
        ...
        let m;
        const g = e.filter((h) => Ue(h, w, n));
        if (g.length === 1 && ([m] = g), !m && u) {
          if (I.isBookIdValid(w)) {
        ...
        if (!m && u) {
          const f = ((b) => Object.keys(yt).find(
            (v) => yt[v].toLowerCase() === b.toLowerCase()
          ))(w);
...
function ci({
  ...
  var pn, un, mn;
  const i = et(), [w, u] = z(!1), [c, m] = z(""), [g, h] = z(""), [f, b] = z("books"), [v, x] = z(void 0), [C, N] = z(!1), M = nt(void 0), $ = nt(void 0), Q = nt(void 0), H = nt(void 0), gt = nt({}), k = J(() => a ? a() : qn, [a]), T = J(() => ({
    [B.OT]: k.filter((O) => I.isBookOT(O)),
    [B.NT]: k.filter((O) => I.isBookNT(O)),
    [B.DC]: k.filter((O) => I.isBookDC(O)),
    [B.Extra]: k.filter((O) => I.extraBooks().includes(O))
  }), [k]), rt = J(() => Object.values(T).flat(), [T]), j = J(() => {
    if (!g.trim()) return T;
    const y = {
      [B.OT]: [],
      [B.NT]: [],
    ...
    return [B.OT, B.NT, B.DC, B.Extra].forEach((Z) => {
      y[Z] = T[Z].filter((ot) => Ue(ot, g, o));
    }), y;
  }, [T, g, o]), _ = J(
    () => Ua(g, rt, o),
    [g, rt, o]
    ...
    (y) => {
      ...
      u(y), y && (b("books"), x(void 0), h(""));
    },
    [f, P]
  ), { otLong: U, ntLong: at, dcLong: W, extraLong: bt } = Dn(s), Dr = X(
    (y) => In(y, U, at, W, bt),
    [U, at, W, bt]
  ), Ir = X(
    (y) => _ ? !!_.chapterNum && !y.toString().includes(_.chapterNum.toString()) : !1,
    [_]
  ), zr = J(
    () => {
      var y;
      return Jt(
        t,
        o && ((y = o.get(t.book)) == null ? void 0 : y.localizedName) || "English"
      );
    },
    [t, o]
  ), cn = X((y) => (O) => {
    ...
    (y) => {
      if (y.ctrlKey) return;
      const { isLetter: O, isDigit: Z } = yn(y.key);
      if (f === "chapters") {
        if (y.key === "Backspace") {
        ...
        if (O || Z) {
          if (y.preventDefault(), y.stopPropagation(), b("books"), x(void 0), Z && v) {
            const ot = yt[v];
            h(`${ot} ${y.key}`);
          } else
            h(y.key);
      ...
      if ((f === "chapters" || f === "books" && _) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key)) {
        ...
        switch (y.key) {
          case "ArrowLeft":
            st !== 0 && (vt = st > 1 ? st - 1 : Rt);
            break;
          case "ArrowRight":
            st !== 0 && (vt = st < Rt ? st + 1 : 1);
            break;
          case "ArrowUp":
            vt = st === 0 ? Rt : Math.max(1, st - hn);
            break;
          case "ArrowDown":
            vt = st === 0 ? 1 : Math.min(Rt, st + hn);
            break;
          default:
            return;
        }
        vt !== st && (y.preventDefault(), y.stopPropagation(), m(Nn(ot, vt)), setTimeout(() => {
    ...
    const { isLetter: O, isDigit: Z } = yn(y.key);
    (O || Z) && (y.preventDefault(), h((ot) => ot + y.key), $.current.focus(), N(!1));
  }, []);
  return fn(() => {
    const y = setTimeout(() => {
      if (w && f === "books" && Q.current && H.current) {
        const O = Q.current, Z = H.current, ot = Z.offsetTop, st = O.clientHeight, Rt = Z.clientHeight, vt = ot - st / 2 + Rt / 2;
        O.scrollTo({
          top: Math.max(0, vt),
          behavior: "smooth"
        }), m(Nn(t.book));
  ...
  }, [f, v, _, t.book, t.chapterNum]), /* @__PURE__ */ l(we, { open: w, onOpenChange: S, children: [
    /* @__PURE__ */ r(le, { asChild: !0, children: /* @__PURE__ */ r(
      D,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "tw-truncate", children: zr })
      }
    ) }),
    /* @__PURE__ */ r(Lt, { forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      oe,
      {
        ref: M,
        onKeyDown: Ar,
        ...
        children: [
          f === "books" ? /* @__PURE__ */ l("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: Y.map(({ onClick: y, disabled: O, title: Z, icon: ot }) => /* @__PURE__ */ r(
              D,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              D,
              {
                ...
                tabIndex: -1,
                children: i === "ltr" ? /* @__PURE__ */ r($r, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Xr, { className: "tw-h-4 tw-w-4" })
              }
            ),
            /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: o && ((pn = o.get(v || "")) == null ? void 0 : pn.localizedName) || yt[v || ""] || "" })
          ] }),
          !C && /* @__PURE__ */ l(ie, { ref: Q, children: [
            f === "books" && /* @__PURE__ */ l(Qt, { children: [
              !_ && Object.entries(j).map(([y, O]) => {
                if (O.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(At, { heading: Dr(y), children: O.map((Z) => /* @__PURE__ */ r(
                      Kn,
                      {
                        bookId: Z,
                        onSelect: (ot) => R(ot),
              ...
              _ && /* @__PURE__ */ r(At, { children: /* @__PURE__ */ r(
                Ft,
                {
                  value: `${_.book} ${yt[_.book]} ${_.chapterNum || ""}:${_.verseNum || ""})}`,
                  onSelect: Ht,
                  ...
                  children: Jt(
                    ...
                    o && ((un = o.get(_.book)) == null ? void 0 : un.localizedId) || void 0
                  )
                },
                "top-match"
              ) }),
              _ && ht(_.book) > 1 && /* @__PURE__ */ l(Qt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: o && ((mn = o.get(_.book)) == null ? void 0 : mn.localizedName) || yt[_.book] }),
                /* @__PURE__ */ r(
                  kn,
                  {
                    bookId: _.book,
...
), tt = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(zn.Root, { ref: n, className: d("pr-twp", qa(), t), ...e }));
tt.displayName = zn.Root.displayName;
const Ze = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    ee.Root,
    {
...
Ze.displayName = ee.Root.displayName;
const pe = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ee.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(ee.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(he, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
pe.displayName = ee.Item.displayName;
function Ja(t) {
...
function $e({
  ...
  const [x, C] = z(!1);
  return /* @__PURE__ */ l(we, { open: x, onOpenChange: C, ...v, children: [
    ...
    /* @__PURE__ */ r(
      Lt,
      {
        ...
        children: /* @__PURE__ */ l(oe, { children: [
          /* @__PURE__ */ r(se, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(be, { children: g }),
          /* @__PURE__ */ r(ie, { children: e.map((N) => /* @__PURE__ */ l(
            Ft,
            {
              value: w(N),
              onSelect: () => {
...
function mi({
  ...
  const m = Ve(c, "%webView_bookSelector_currentBook%"), g = Ve(c, "%webView_bookSelector_choose%"), h = Ve(c, "%webView_bookSelector_chooseBooks%"), [f, b] = z(
    "current book"
    /* CURRENT_BOOK */
  ), v = (x) => {
    b(x), t(x);
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(tt, { className: "tw-ms-1", children: m })
          ] }),
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(tt, { className: "tw-flex tw-items-center", children: a.map((x) => I.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
}), Jn = F.Trigger, Wn = F.Group, Qa = F.Portal, to = F.Sub, eo = F.RadioGroup;
function tn({ variant: t = "default", ...e }) {
  const n = p.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ r(Qe.Provider, { value: n, children: /* @__PURE__ */ r(F.Root, { ...e }) });
}
...
ve.displayName = F.Content.displayName;
...
tr.displayName = F.Item.displayName;
const en = p.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const s = ut();
  return /* @__PURE__ */ l(
    F.CheckboxItem,
    {
      ...
      ...a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
en.displayName = F.CheckboxItem.displayName;
const er = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    F.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(F.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
const nn = p.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  F.Label,
  {
    ref: a,
...
nn.displayName = F.Label.displayName;
...
xe.displayName = F.Separator.displayName;
...
function ro({ table: t }) {
  return /* @__PURE__ */ l(tn, { children: [
    /* @__PURE__ */ r(ka, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Fr, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Pt = K.Root, ao = K.Group, Bt = K.Value, oo = St(
  ...
  return /* @__PURE__ */ l(
    K.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(K.Icon, { asChild: !0, children: /* @__PURE__ */ r(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const nr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  K.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Gr, { className: "tw-h-4 tw-w-4" })
  }
));
nr.displayName = K.ScrollUpButton.displayName;
...
rr.displayName = K.ScrollDownButton.displayName;
...
zt.displayName = K.Content.displayName;
...
so.displayName = K.Label.displayName;
const ct = p.forwardRef(({ className: t, children: e, ...n }, a) => /* @__PURE__ */ l(
  K.Item,
  {
    ref: a,
    className: d(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(K.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
...
io.displayName = K.Separator.displayName;
function wo({ table: t }) {
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ l(
        Pt,
        {
          ...
          children: [
            /* @__PURE__ */ r(It, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Bt, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(zt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(ct, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
  ...
  p.useEffect(() => {
    ...
    const w = () => {
      requestAnimationFrame(() => {
        ne(i, '[tabindex]:not([tabindex="-1"])').forEach((m) => {
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? ne(t.current) : [], s = o.indexOf(document.activeElement), i = a.key === "ArrowRight" ? s + 1 : s - 1;
...
function fo({
  ...
  var x;
  const [w, u] = z([]), [c, m] = z([]), [g, h] = z({}), [f, b] = z({}), v = On({
    data: e,
    columns: t,
    getCoreRowModel: Pn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(Ne, { stickyHeader: s, children: v.getHeaderGroups().map((C) => /* @__PURE__ */ r(Ct, { children: C.headers.map((N) => /* @__PURE__ */ r(re, { children: N.isPlaceholder ? void 0 : Zt(N.column.columnDef.header, N.getContext()) }, N.id)) }, C.id)) }),
      /* @__PURE__ */ r(ke, { children: (x = v.getRowModel().rows) != null && x.length ? v.getRowModel().rows.map((C) => /* @__PURE__ */ r(
        Ct,
        {
          onClick: () => i(C, v),
          "data-state": C.getIsSelected() && "selected",
          children: C.getVisibleCells().map((N) => /* @__PURE__ */ r(jt, { children: Zt(N.column.columnDef.cell, N.getContext()) }, N.id))
        },
        C.id
...
function go({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
  const a = _n(n, "%webView_error_dump_header%"), o = _n(n, "%webView_error_dump_info_message%");
  function s() {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-w-full tw-flex-col tw-items-start tw-justify-start tw-gap-4", children: [
    /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
      ...
      /* @__PURE__ */ r(D, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(Kr, {}) })
    ] }),
...
function gi({
  ...
  return /* @__PURE__ */ l(we, { children: [
    ...
    /* @__PURE__ */ r(Lt, { className: d("tw-min-w-80 tw-max-w-96", o), children: /* @__PURE__ */ r(
      go,
      {
        errorDetails: t,
        handleCopyNotify: e,
...
function bi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(tn, { children: [
    /* @__PURE__ */ r(Jn, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ve, { children: n.map((c, m) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(Wn, { children: c.itemType === 0 ? /* @__PURE__ */ r(Qt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        en,
        {
          checked: a[m][h],
...
function yo({
  ...
  const [g, h] = z(!1), f = X(
    (x) => {
      var N;
      const C = (N = t.find((M) => M.label === x)) == null ? void 0 : N.value;
      C && a(
    ...
    if (!u) return t;
    const x = t.filter((N) => N.starred).sort((N, M) => N.label.localeCompare(M.label)), C = t.filter((N) => !N.starred).sort((N, M) => {
      const $ = n.includes(N.value), Q = n.includes(M.value);
      return $ && !Q ? -1 : !$ && Q ? 1 : N.label.localeCompare(M.label);
    });
    return [...x, ...C];
  }, [t, n, u]);
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ l(we, { open: g, onOpenChange: h, children: [
    /* @__PURE__ */ r(le, { asChild: !0, children: /* @__PURE__ */ l(
      D,
      {
        variant: "ghost",
  ...
  return /* @__PURE__ */ l(ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(ke, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      Ct,
      {
        ...
        children: [
          /* @__PURE__ */ r(jt, { children: `${I.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
rn.displayName = Pe.Root.displayName;
...
ko.displayName = Bn.Root.displayName;
...
const ce = p.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, s) => {
...
function Ei({
  ...
  const c = xt(n, "%webView_inventory_all%"), m = xt(n, "%webView_inventory_approved%"), g = xt(n, "%webView_inventory_unapproved%"), h = xt(n, "%webView_inventory_unknown%"), f = xt(n, "%webView_inventory_scope_currentBook%"), b = xt(n, "%webView_inventory_scope_chapter%"), v = xt(n, "%webView_inventory_scope_verse%"), x = xt(n, "%webView_inventory_filter_text%"), C = xt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [N, M] = z(!1), [$, Q] = z("all"), [H, gt] = z(""), [k, T] = z([]), rt = J(() => t.length === 0 ? [] : Ro(t, o, s), [t, o, s]), j = J(() => {
    if (N) return rt;
    const S = [];
    return rt.forEach((U) => {
      const at = U.items[0], W = S.find(
        (bt) => bt.items[0] === at
      );
      W ? (W.count += U.count, W.occurrences = W.occurrences.concat(U.occurrences)) : S.push({
        items: [at],
        count: U.count,
  ...
  }, [N, rt]), _ = J(() => So(j, $, H), [j, $, H]), Ht = J(() => {
    var at, W;
    if (!N) return u;
    const S = (at = a == null ? void 0 : a.tableHeaders) == null ? void 0 : at.length;
    if (!S) return u;
    const U = [];
    for (let bt = 0; bt < S; bt++)
      U.push(
        Co(
          ((W = a == null ? void 0 : a.tableHeaders) == null ? void 0 : W[bt]) || "Additional Item",
          bt + 1
        )
      );
    return [...U, ...u];
    ...
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ l(
        Pt,
        {
          ...
          defaultValue: $,
          children: [
            /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Bt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ l(Pt, { onValueChange: (S) => q(S), defaultValue: i, children: [
        /* @__PURE__ */ r(It, { className: "tw-m-1", children: /* @__PURE__ */ r(Bt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ l(zt, { children: [
...
const an = p.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  jn.Root,
  {
    ref: o,
    decorative: n,
...
an.displayName = jn.Root.displayName;
...
const on = ae.Provider, sn = ae.Root, wn = ae.Trigger, _e = p.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  ae.Content,
  {
    ref: a,
    sideOffset: e,
...
_e.displayName = ae.Content.displayName;
...
const wr = p.forwardRef(
  ({
    ...
    const [c, m] = p.useState(t), g = e ?? c, h = p.useCallback(
      (M) => {
        const $ = typeof M == "function" ? M(g) : M;
        n ? n($) : m($);
      },
      [n, g]
    ), f = p.useCallback(() => h((M) => !M), [h]), b = g ? "expanded" : "collapsed", C = et() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = p.useMemo(
      () => ({
        state: b,
        open: g,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(ir.Provider, { value: N, children: /* @__PURE__ */ r(on, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Po = St(
  ...
  ({
    ...
    const u = t ? $t : "button", { state: c } = Se(), m = /* @__PURE__ */ r(
      u,
      {
        ref: w,
    ...
    return o ? (typeof o == "string" && (o = {
      ...
      /* @__PURE__ */ r(wn, { asChild: !0, children: m }),
...
const $o = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(Sn, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          Sn,
          {
...
const Go = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, s) => /* @__PURE__ */ r(
  t ? $t : "a",
  {
    ref: s,
    ...
    lr,
    {
      ...
      children: /* @__PURE__ */ l(cr, { children: [
        /* @__PURE__ */ l(Xe, { children: [
          ...
          /* @__PURE__ */ r(Ge, { children: /* @__PURE__ */ r(pr, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ r(ur, { children: /* @__PURE__ */ r(
            mr,
            {
              onClick: () => c(h),
              isActive: g(h),
  ...
  return [
    {
      ...
      cell: (a) => {
        ...
        return a.row.getIsGrouped() ? I.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === kt ? Jt(o.start) : void 0;
      },
...
}, Rn = (t) => `${Wo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Mi({
  sources: t,
  ...
  const [u, c] = z([]), [m, g] = z([{ id: kt, desc: !1 }]), [h, f] = z({}), b = J(
  ...
  Mt(() => {
    if (w) {
      ...
      if (T.length === 1) {
        const rt = b.find((j) => Rn(j) === T[0]) || void 0;
        rt && w(rt);
      }
    }
  }, [h, b, w, x]);
  const C = o ?? Ko, N = s ?? hr, M = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${C}`, value: [kt] },
  ...
  }, H = (k, T) => k.getIsGrouped() ? "" : d("banded-row", T % 2 === 0 ? "even" : "odd"), gt = (k, T, rt) => {
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ l(
      Pt,
      {
        ...
        children: [
          /* @__PURE__ */ r(It, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Bt, {}) }),
          /* @__PURE__ */ r(zt, { position: "item-aligned", children: /* @__PURE__ */ r(ao, { children: M.map((k) => /* @__PURE__ */ r(ct, { value: JSON.stringify(k.value), children: k.label }, k.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(Ne, { children: x.getHeaderGroups().map((k) => /* @__PURE__ */ r(Ct, { children: k.headers.filter((T) => T.column.columnDef.header).map((T) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(re, { colSpan: T.colSpan, className: "top-0 tw-sticky", children: T.isPlaceholder ? void 0 : /* @__PURE__ */ l("div", { children: [
          ...
          " ",
          Zt(T.column.columnDef.header, T.getContext())
        ] }) }, T.id)
      )) }, k.id)) }),
      /* @__PURE__ */ r(ke, { children: x.getRowModel().rows.map((k, T) => {
        const rt = et();
        return /* @__PURE__ */ r(
          Ct,
          {
            ...
            children: k.getVisibleCells().map((j) => {
              if (!(j.getIsPlaceholder() || j.column.columnDef.enableGrouping && !j.getIsGrouped() && (j.column.columnDef.id !== Vt || !n)))
                return /* @__PURE__ */ r(
                  jt,
                  {
                    className: d(
                    ...
                    children: j.getIsGrouped() ? /* @__PURE__ */ l(
                      D,
                      {
                        ...
                        children: [
                          ...
                          !k.getIsExpanded() && (rt === "ltr" ? /* @__PURE__ */ r(Ot, {}) : /* @__PURE__ */ r(Oe, {})),
                          " ",
                          Zt(j.column.columnDef.cell, j.getContext()),
                          " (",
                          k.subRows.length,
                          ")"
                        ]
...
const dn = (t, e) => t.filter((n) => {
  try {
    return Wt(n) === e;
  } catch {
    return !1;
  }
}), fr = (t, e, n) => dn(t, e).every((a) => n.includes(a));
function Zo({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = dn(e, t).length === 0, i = o["%scripture_section_ot_short%"], w = o["%scripture_section_nt_short%"], u = o["%scripture_section_dc_short%"], c = o["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    D,
    {
      variant: "outline",
...
function Qo({
  ...
  const H = J(() => I.allBookIds.filter(
    ...
    (R, q = !1) => {
      ...
      const Y = H.findIndex((W) => W === $.current), P = H.findIndex((W) => W === R);
      if (Y === -1 || P === -1) return;
      const [S, U] = [
        Math.min(Y, P),
        Math.max(Y, P)
      ], at = H.slice(S, U + 1).map((W) => W);
      n(
        e.includes(R) ? e.filter((W) => !at.includes(W)) : [.../* @__PURE__ */ new Set([...e, ...at])]
      );
    },
    [e, n, H]
  ), T = (R) => {
    k(R, Q.current), Q.current = !1;
  }, rt = (R, q) => {
    R.preventDefault(), k(q, R.shiftKey);
  }, j = X(
    (R) => {
      const q = dn(H, R).map((Y) => Y);
      n(
        fr(H, R, e) ? e.filter((Y) => !q.includes(Y)) : [.../* @__PURE__ */ new Set([...e, ...q])]
      );
    },
    [e, n, H]
  ), _ = () => {
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(B).map((R) => /* @__PURE__ */ r(
      Zo,
      {
        section: R,
        availableBookIds: H,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Lt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
            oe,
            {
              shouldFilter: !1,
              onKeyDown: (R) => {
                R.key === "Enter" && (Q.current = R.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  se,
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: _, children: u }),
                  /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: Ht, children: c })
                ] }),
                /* @__PURE__ */ l(ie, { children: [
                  /* @__PURE__ */ r(be, { children: m }),
                  Object.values(B).map((R, q) => {
                    const Y = gt[R];
                    if (Y.length !== 0)
                      return /* @__PURE__ */ l(Vn, { children: [
                          ...
                          At,
                          {
                            ...
                            children: Y.map((P) => {
                              ...
                              return /* @__PURE__ */ r(
                                ...
                                {
                                  bookId: P,
                                  isSelected: e.includes(P),
                                  onSelect: () => T(P),
                                  onMouseDown: (at) => rt(at, P),
                                  section: Wt(P),
                                  showCheck: !0,
                                  localizedBookNames: o,
                                  commandValue: `${P} ${I.bookIdToEnglishName(P)} ${o ? `${(S = o.get(P)) == null ? void 0 : S.localizedName} ${(U = o.get(P)) == null ? void 0 : U.localizedId}` : ""}`,
                        ...
                        q < Object.values(B).length - 1 && /* @__PURE__ */ r(Xn, {})
                      ] }, R);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        ...
        var q;
        return /* @__PURE__ */ r(ue, { className: "hover:tw-bg-secondary", variant: "secondary", children: o && ((q = o.get(R)) == null ? void 0 : q.localizedName) || I.bookIdToEnglishName(R) || R }, R);
      }),
    ...
    /* @__PURE__ */ l("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        Ze,
        {
          ...
          children: x.map(({ value: C, label: N, id: M }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(pe, { className: "tw-me-2", value: C, id: M }),
            /* @__PURE__ */ r(tt, { htmlFor: M, children: N })
          ] }, M))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ r(
          zt,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((u) => /* @__PURE__ */ r(ct, { value: `${u}`, children: i[A(u)] }, `${u}`))
          }
        )
      ]
    }
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, u) => w.order - u.order).map((w) => /* @__PURE__ */ l(sn, { children: [
  /* @__PURE__ */ r(wn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    tr,
    {
      onClick: () => {
        a(w);
...
function En({
  ...
  return /* @__PURE__ */ l(tn, { variant: s, children: [
    /* @__PURE__ */ r(Jn, { "aria-label": n, className: o, asChild: !0, id: i, children: /* @__PURE__ */ r(D, { variant: "ghost", size: "icon", children: a ?? /* @__PURE__ */ r(la, {}) }) }),
    /* @__PURE__ */ r(ve, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, u]) => typeof w == "boolean" || typeof u == "boolean" ? 0 : w.order - u.order).map(([w], u, c) => /* @__PURE__ */ l(Vn, { children: [
      /* @__PURE__ */ r(Wn, { children: /* @__PURE__ */ r(on, { children: br(e.groups, e.items, w, t) }) }),
...
kr.displayName = G.Trigger.displayName;
...
_r.displayName = G.SubContent.displayName;
...
Rr.displayName = G.Item.displayName;
...
const as = p.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ l(
    G.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(he, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
as.displayName = G.RadioItem.displayName;
...
os.displayName = G.Label.displayName;
...
Tr.displayName = G.Separator.displayName;
const Kt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
  ...
  return o.flatMap(([s], i) => {
    const w = e.filter((c) => c.group === s).sort((c, m) => c.order - m.order).map((c) => /* @__PURE__ */ l(sn, { children: [
      /* @__PURE__ */ r(wn, { asChild: !0, children: "command" in c ? /* @__PURE__ */ l(
        Rr,
        {
          onClick: () => {
            a(c);
...
function ss({
  ...
  const o = nt(void 0), s = nt(void 0), i = nt(void 0), w = nt(void 0), u = nt(void 0), c = (m) => {
    switch (m) {
      case "platform.app":
        return s;
  ...
  if (_a(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (m, g) => {
    ...
    switch (g.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (C = u.current) == null || C.focus(), Kt(u, [h, f]);
        break;
    }
  }), Mt(() => {
    ...
    return /* @__PURE__ */ r(Nr, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, g]) => typeof m == "boolean" || typeof g == "boolean" ? 0 : m.order - g.order).map(([m, g]) => /* @__PURE__ */ l(es, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(on, { children: Er(t.groups, t.items, m, e) })
        }
      )
    ] }, m)) });
}
...
function Fi({
  ...
  const u = is(
    ...
    var x, C, N, M, $, Q;
    const v = b !== f ? ((C = (x = t[f]) == null ? void 0 : x.uiNames) == null ? void 0 : C[b]) ?? ((M = (N = t[f]) == null ? void 0 : N.uiNames) == null ? void 0 : M.en) : void 0;
    return v ? `${($ = t[f]) == null ? void 0 : $.autonym} (${v})` : (Q = t[f]) == null ? void 0 : Q.autonym;
  };
  return /* @__PURE__ */ l("div", { className: d("pr-twp tw-max-w-sm", w), children: [
    /* @__PURE__ */ l(
      Pt,
      {
        ...
        onOpenChange: (f) => m(f),
        children: [
          /* @__PURE__ */ r(It, { children: /* @__PURE__ */ r(Bt, {}) }),
          /* @__PURE__ */ r(
            zt,
            {
              className: "tw-z-[250]",
    ...
    e !== "en" && /* @__PURE__ */ l(Qt, { children: [
      /* @__PURE__ */ r(tt, { className: "tw-ms-3", children: u }),
...
const ls = Le(({ className: t, ...e }, n) => /* @__PURE__ */ r(pa, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
ms.displayName = Xt.Root.displayName;
...
hs.displayName = Xt.Image.displayName;
...
fs.displayName = Xt.Fallback.displayName;
...
const Hi = L.Root, Yi = L.Trigger, Ui = L.Group, Ki = L.Portal, qi = L.Sub, Ji = L.RadioGroup, ks = p.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  L.SubTrigger,
  {
    ref: o,
    className: d(
...
ks.displayName = L.SubTrigger.displayName;
...
Cs.displayName = L.SubContent.displayName;
const _s = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(L.Portal, { children: /* @__PURE__ */ r(
  L.Content,
  {
    ref: n,
    className: d(
...
_s.displayName = L.Content.displayName;
...
Ss.displayName = L.Item.displayName;
...
Ts.displayName = L.RadioItem.displayName;
...
Es.displayName = L.Label.displayName;
...
Vs.displayName = L.Separator.displayName;
...
const Wi = pt.Trigger, Is = pt.Portal, Zi = pt.Close, Mr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  pt.Overlay,
  {
    ref: n,
...
const zs = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...a }, o) => {
...
Xs.displayName = je.Root.displayName;
const tw = lt.Root, Fs = p.forwardRef(({ className: t, ...e }, n) => {
  const a = et();
  return /* @__PURE__ */ r(
    lt.List,
    {
...
const Us = (t, e, n = {}) => {
  ...
  const o = nt(null), [s, i] = z(void 0), [w, u] = z(void 0), c = X(
    (h) => {
      i(h);
