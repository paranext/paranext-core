...
import b, { forwardRef as sn, useRef as H, useMemo as j, useState as S, useCallback as K, useLayoutEffect as At, createContext as Tn, useContext as gr, useEffect as Y, Component as hs, createElement as jr, Suspense as gs, Fragment as go } from "react";
import { Command as Tt } from "cmdk";
import { X as je, Search as bo, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Zn, ChevronRight as Ie, ArrowLeft as bs, ArrowRight as vs, Circle as Rn, ChevronDown as ze, BoldIcon as xs, ItalicIcon as ys, AtSign as vo, Pencil as Ns, Trash2 as ks, ArrowUp as xo, MoreHorizontal as _s, MailOpen as Cs, Mail as Es, ChevronUp as yo, FilterIcon as Ts, ArrowLeftIcon as Rs, ChevronLeftIcon as Ss, ChevronRightIcon as Ds, ArrowRightIcon as Ms, Copy as No, Filter as Is, User as Os, Link as As, CircleHelp as Ps, ChevronsUpDown as ko, Star as $s, Undo as Ls, Redo as Vs, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, Ban as js, AlertCircle as Qn, CircleCheckIcon as zs, CircleXIcon as Fs, CircleHelpIcon as Bs, ArrowUpIcon as Ks, ArrowDownIcon as Gs, PanelLeft as Us, PanelRight as qs, ScrollText as Hs, MenuIcon as Ys, Menu as Xs, EllipsisVertical as Ws, MoreVertical as Kr, LoaderCircle as Js, GripVertical as Zs } from "lucide-react";
...
import { GENERATOR_NOTE_CALLER as nr, HIDDEN_NOTE_CALLER as rr, getDefaultViewOptions as el, isInsertEmbedOpOfType as pn, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
const ea = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Fe : "button", { className: h(na({ variant: e, size: n, className: t })), ref: s, ...a })
);
...
function vl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (w > 0) {
        const c = e[w - 1], d = Math.max(Ut(c), 1);
        o({
          book: c,
          chapterNum: d,
          verseNum: 1
...
function Jr({
  ...
  if (t)
    return /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Ut(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Yt,
      {
        value: `${t} ${ye[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Np({
  ...
  const c = mt(), [d, m] = S(!1), [f, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, z] = S(!1), F = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ...
  }), [$]), P = j(() => Object.values(O).flat(), [O]), W = j(() => {
    if (!g.trim()) return O;
    const D = {
      [X.OT]: [],
      [X.NT]: [],
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: h("pr-twp", xl(), t), ...e }));
    ...
    /* @__PURE__ */ r(
      Xt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          /* @__PURE__ */ r(Ge, { placeholder: f, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(wn, { children: u }),
          /* @__PURE__ */ r(re, { children: F(e) ? e.map((M) => /* @__PURE__ */ r(qt, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
function Cp({
  ...
  const d = zn(c, "%webView_bookSelector_currentBook%"), m = zn(c, "%webView_bookSelector_choose%"), f = zn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
const Cr = {
  ...
  {
    ref: o,
    className: e ? h(na({ variant: e }), t) : t,
    ...n
  }
));
...
function Al() {
  return function(t) {
    const [e] = Wt(), n = j(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), s = H(o);
    return Il(() => {
...
function Pl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !wi(e) && o !== null) {
    ...
    if (c || d) {
      const [m, f] = ci(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, y = 0;
...
function Kl(t) {
  ...
  ia(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Mn();
}
function De(t, e) {
...
Ht({ build: (t, e, n) => In(e), config: ln({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
Ht({ build: (t, e, n) => In(e), config: ln({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
...
const Bn = ui("format", { parse: (t) => typeof t == "number" ? t : 0 });
class da extends er {
  $config() {
...
const cr = Ht({ build: (t) => pa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Rr = 0, dr = 1, ma = 2, Kn = 3, mn = 4, Se = 5, Gn = 6, Ye = 7;
function Un(t) {
  return t.id === Rr;
}
function fa(t) {
...
class tn {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Un(s) || et(300, i, a || "[unknown]"), Un(l = s) || et(304, String(l.id), String(Rr)), s = Object.assign(l, { id: dr }), o.state = s;
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: m } = d;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const f of Gl(m)) {
  ...
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = pa(() => {
    ...
    o.value.read(() => {
      if (Vt()) for (const [d, m] of l.entries()) {
        ...
        const f = Ri(d), u = f && f.isSelected() || !1;
...
Ht({ dependencies: [cr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  ...
  return de(t.registerCommand(vi, (i) => {
    if (xi(i.target)) {
      ...
      if (tw(l)) return function(w, c = !1) {
        const d = Vt(), m = w.isSelected(), f = w.getKey();
        let u;
        c && Po(d) ? u = d : (u = Ni(), ki(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
    ...
    Fl(() => {
      ...
      for (const [d, m] of i.entries()) if (m === "destroyed") c.delete(d), w = !0;
        ...
        f ? f.domNode.value = u : (w = !0, c.set(d, { domNode: rn(u), selectedSignal: o(d) }));
      }
  ...
  return de(t.registerCommand(Di, (o) => {
    ...
    const s = function(i) {
      ...
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Mi();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Ii(u), u.anchor.is(c)) return !0;
      }
      return !1;
...
Ht({ build: (t, e, n) => In(e), config: ln({ $canIndent: ga, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
...
Ht({ build: (t, e, n) => In(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : va(t)) });
function sw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (f) => n._onError(f), children: r(gs, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
...
function Nw({
  ...
  const [e] = Wt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = yw(), w = () => {
  };
...
Dr.displayName = Dn.Root.displayName;
...
function Ca(t, e, n, o = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Ca(t, g, f, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Vi(d) || Hr(d)) && d.append(f), n.append(d), m) {
      const u = m.call(i, d);
...
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < m.length; g++) f.push(...Ta(m[g], e, n, u, new Map(a), l));
  return d != null && (f = d(f)), Yr(t) && (f = Mw(t, f, u ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Sn)), l == null ? f.length > 0 ? i = i.concat(f) : Yr(t) && function(g) {
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
          /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Ir(y) && (y.preventDefault(), y.stopPropagation(), Lt(a) && f());
        },
        onKeyDown: (y) => {
...
const zw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function lo({
  ...
  const u = K(
    ...
    [t.user]
  ), N = j(() => ri(t.contents), [t.contents]), k = j(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          Cn,
    ...
    "div",
    {
      ...
      children: [
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_s, {}) }) }),
...
function Hw({
  ...
  const [A, M] = S(wo), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [St, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Jt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Bt = j(() => e.filter((T) => !T.deleted), [e]);
  Y(() => {
    let T = !0;
    if (!o || !k) {
      Jt(/* @__PURE__ */ new Map());
  ...
  const Kt = j(() => Bt[0], [Bt]), Re = H(null), se = H(void 0), Zt = K(() => {
    var T;
  ...
  }, [s, n]), L = j(() => Bt.slice(1), [Bt]), U = j(() => L.length ?? 0, [L.length]), q = j(() => U > 0, [U]), it = j(() => $ || U <= 2 ? L : L.slice(-2), [L, U, $]), tt = j(() => $ || U <= 2 ? 0 : U - 2, [U, $]), bt = j(
  ...
  const Dt = K(
    ...
    async (T) => {
      const vt = Lt(A) ? _n(A) : void 0, ft = await m({
        ...T,
        contents: vt,
...
const Pn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", t), ...e }));
...
function sc({
  ...
  var F;
  const [d, m] = S([]), [f, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = j(() => e ?? [], [e]), k = Go({
    data: N,
    columns: t,
    getCoreRowModel: qo(),
  ...
  return w ? z = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? z = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    ...
    /* @__PURE__ */ p(On, { stickyHeader: s, children: [
      /* @__PURE__ */ r(An, { stickyHeader: s, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Qt, { children: A.headers.map((M) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Ze(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
      /* @__PURE__ */ r(Pn, { children: z })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(B, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(No, {}) })
        ] }),
...
function Ip({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Xt, { id: s, className: h("tw-min-w-80 tw-max-w-96", a), children: [
...
function Op({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ p(B, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Aa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((m, f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][f],
  ...
  return Y(() => {
    ...
    const o = /Macintosh/i.test(navigator.userAgent), a = ((i = n.current) == null ? void 0 : i.querySelector(".editor-input")) ?? void 0, s = (l) => {
      ...
      if (o) {
        ...
        if (!l.ctrlKey) return;
        !l.shiftKey && w === "z" ? (l.preventDefault(), (m = e.current) == null || m.undo()) : (w === "y" || l.shiftKey && w === "z") && (l.preventDefault(), (f = e.current) == null || f.redo());
      }
    };
...
function hc({
  ...
  const s = H(null), i = H(null), l = H(!1), [w, c] = S(t), [d, m] = S(n), [f, u] = S(!1);
  Y(() => {
    c(t);
  }, [t]), Y(() => {
    d !== n && m(n);
  ...
  return /* @__PURE__ */ p(ue, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: fc(t, a, n) }) }) }),
...
function vc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Bi, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(B, { variant: "outline", className: "tw-h-6", children: gc(t, n) }) }) }),
...
function Lp({
  ...
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, z] = S(!1), [F, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, O] = S(!1), [P, W] = S(), [I, J] = S(), [St, Pt] = S(), [It, gt] = S(), pt = H(null), G = j(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && pn("note", L)) {
      ...
      let tt = "custom";
      it === nr ? tt = "generated" : it === rr ? tt = "hidden" : it && y(it), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
  ...
  const st = K(
    (_, L, U = !1) => {
      ...
      if (q && pn("note", q)) {
        if (q.insert.note) {
          let ct;
          _ === "custom" ? ct = L : _ === "generated" ? ct = nr : ct = rr, q.insert.note.caller = ct;
        }
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
            /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(B, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(je, {}) }) }),
...
function jp({
  ...
  const d = w ?? ii(n, void 0), m = (N, k) => {
    c == null || c(N, k, a);
  }, f = s ? n.findIndex((N) => N === s) : -1, [u, g] = S(f), x = (N, k, C) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
...
}, $n = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
  /* @__PURE__ */ p(
    Et,
    {
...
function Hp({
  ...
  const u = Gt(n, "%webView_inventory_all%"), g = Gt(n, "%webView_inventory_approved%"), x = Gt(n, "%webView_inventory_unapproved%"), v = Gt(n, "%webView_inventory_unknown%"), y = Gt(n, "%webView_inventory_scope_currentBook%"), N = Gt(n, "%webView_inventory_scope_chapter%"), k = Gt(n, "%webView_inventory_scope_verse%"), C = Gt(n, "%webView_inventory_filter_text%"), z = Gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), F = Gt(n, "%webView_inventory_no_results%"), [A, M] = S(!1), [E, R] = S("all"), [V, $] = S(""), [O, P] = S([]), W = j(() => {
    const G = t ?? [];
  ...
  }, [A, W]), J = j(() => I.length === 0 ? [] : Pc(I, E, V), [I, E, V]), St = j(() => {
    var st, wt;
    if (!A) return w;
...
function Yp({
  ...
  const u = j(
    () => t.map((v) => ({
      id: v.id,
      label: v.shortName,
      secondaryLabel: v.fullName
    })),
    [t]
  ), g = j(
    () => o ? [{ groupHeading: o, options: u }] : u,
    [u, o]
  ), x = j(
    () => u.find((v) => v.id === e),
    [u, e]
...
const Ba = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), m = e ?? c, f = b.useCallback(
      (k) => {
        const C = typeof k == "function" ? k(m) : k;
        n ? n(C) : d(C);
      },
      [n, m]
    ), u = b.useCallback(() => f((k) => !k), [f]), g = m ? "expanded" : "collapsed", y = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
...
const qc = me(
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = Ln(), d = /* @__PURE__ */ r(
      w,
      {
        ref: l,
    ...
    Ka,
    {
      ...
      children: /* @__PURE__ */ p(Ua, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(qa, { children: Object.entries(e).map(([f, u]) => /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(
            Ya,
            {
              onClick: () => c(f),
              isActive: m(f),
...
function Wp({
  ...
  const [c, d] = S([]), [m, f] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = j(
  ...
  return /* @__PURE__ */ p("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ p(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(An, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
      ...
      /* @__PURE__ */ r(Pn, { children: y.getRowModel().rows.map((E, R) => {
        const V = mt();
        return /* @__PURE__ */ r(
          Qt,
          {
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ p(
                      B,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(Zn, {})),
                          " ",
...
function ld({
  ...
  }, [v, y] = S(!1), [N, k] = S(""), C = H(void 0), z = H(!1);
  if (t.length !== ut.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const F = j(() => ut.allBookIds.filter(
    ...
    (P, W = !1) => {
      ...
      const I = F.findIndex((gt) => gt === C.current), J = F.findIndex((gt) => gt === P);
      if (I === -1 || J === -1) return;
      const [St, Pt] = [
        Math.min(I, J),
        Math.max(I, J)
      ], It = F.slice(St, Pt + 1).map((gt) => gt);
      n(
    ...
    (P) => {
      const W = Lr(F, P).map((I) => I);
      n(
        Wa(F, P, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, F]
  ), $ = () => {
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(B, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Ys, {}) }) }),
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, m) => {
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = s.current) == null || g.focus(), Xe(s, [f, u]);
        break;
      case "alt+l":
        (x = i.current) == null || x.focus(), Xe(i, [f, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [f, u]);
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Xe(w, [f, u]);
        break;
    }
  }), Y(() => {
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && f && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: h(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(B, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
...
const Nd = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Nd.displayName = "AlertDescription";
const pu = ot.Root, uu = ot.Trigger, mu = ot.Group, fu = ot.Portal, hu = ot.Sub, gu = ot.RadioGroup, kd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: h(
...
const bu = zt.Trigger, Od = zt.Portal, vu = zt.Close, ps = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
const _u = Rt.Root, Bd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
