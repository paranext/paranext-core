import sl, { jsx as i, jsxs as N, Fragment as Qt } from "react/jsx-runtime";
import * as B from "react";
import S, { forwardRef as lr, useCallback as Et, useState as ut, useRef as Ht, useEffect as ce, useLayoutEffect as ma, useMemo as Rt } from "react";
...
const xo = ft.Root, Si = ft.Trigger, rc = ft.Group, Km = ft.Portal, Jm = ft.Sub, Zm = ft.RadioGroup, oc = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
...
oc.displayName = ft.SubTrigger.displayName;
const ac = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  ft.SubContent,
  {
    ref: n,
    className: y(
...
ac.displayName = ft.SubContent.displayName;
const pr = S.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...r }, o) => {
  const a = Nt();
...
const Ti = S.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ i(
    ft.Item,
    {
...
const No = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ N(
  ft.CheckboxItem,
  {
    ref: o,
    className: y(
...
const Ci = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  ft.RadioItem,
  {
    ref: r,
    className: y(
...
const ur = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ i(
  ft.Label,
  {
    ref: r,
...
const To = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), xc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ba = ["OT", "NT", "DC"], Nc = 96, kc = [
  /^(\w+)$/i,
...
function th({
  ...
  const o = Nt(), [a, s] = ut(""), [l, c] = ut(
  ...
  ), [d, p] = ut(t.chapterNum ?? 0), [h, u] = ut(
    at.bookNumberToId(t.bookNum)
  ), [f, b] = ut(!1), [m, g] = ut(f), k = Ht(void 0), T = Ht(void 0), C = Ht(void 0), E = Et(
    (j) => {
      const M = r ? r() : To;
      return {
    ...
    kc.forEach((j) => {
      const M = a.match(j);
      if (M) {
        const [A, G = void 0, H = void 0] = M.slice(1), rt = Tc(A);
    ...
    (j) => {
      f ? (j.key === "ArrowDown" || j.key === "ArrowUp") && (typeof C < "u" && // Ref uses null
    ...
    if (h === l) {
      ...
      d + H <= 0 || d + H > ln(h) ? p(0) : H !== 0 && (p(d + H), j.preventDefault());
    }
  };
  return ce(() => {
    l === h ? l === at.bookNumberToId(t.bookNum) ? p(t.chapterNum) : p(1) : p(0);
  }, [h, t.bookNum, t.chapterNum, l]), ma(() => {
    g(f);
  }, [f]), ma(() => {
    const j = setTimeout(() => {
      if (m && T.current && C.current) {
        const A = C.current.offsetTop - Nc;
  ...
  }, [m]), /* @__PURE__ */ i("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ N(xo, { modal: !1, open: f, onOpenChange: F, children: [
    /* @__PURE__ */ i(Si, { asChild: !0, children: /* @__PURE__ */ i(
      ec,
      {
        ...
        handleKeyDown: D,
        handleOnClick: () => {
          c(at.bookNumberToId(t.bookNum)), u(at.bookNumberToId(t.bookNum)), p(t.chapterNum > 0 ? t.chapterNum : 0), b(!0), k.current.focus();
        },
        onFocus: () => {
          P.current = !0;
        },
      ...
      pr,
      {
        ...
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: ba.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ i(ur, { className: "tw-font-semibold tw-text-foreground/80", children: xc[j] }),
            ...
            ba.length - 1 !== M ? /* @__PURE__ */ i(wr, {}) : void 0
          ] }, j);
        }) })
      }
    )
...
const Cc = Re(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ i(r ? Ze : "button", { className: y(Cc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const Rc = Re(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Dt = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(hi.Root, { ref: n, className: y("pr-twp", Rc(), t), ...e }));
Dt.displayName = hi.Root.displayName;
const Mi = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    xn.Root,
    {
...
const Ai = Nn.Root, Di = Nn.Trigger, Co = S.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = Nt();
...
const Oc = Kt.Portal, ji = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Kt.Overlay,
  {
    ref: n,
    className: y(
...
const _c = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(Oc, { children: [
    /* @__PURE__ */ i(ji, {}),
    /* @__PURE__ */ N(
      Kt.Content,
      {
...
_c.displayName = Kt.Content.displayName;
const Pc = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Kt.Title,
  {
    ref: n,
...
Pc.displayName = Kt.Title.displayName;
const Ic = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Kt.Description,
  {
    ref: n,
...
Ic.displayName = Kt.Description.displayName;
const Ro = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Pt,
  {
    ref: n,
    className: y(
...
const Oo = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
...
const _o = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Pt.List,
  {
    ref: n,
...
const Po = S.forwardRef((t, e) => /* @__PURE__ */ i(Pt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Po.displayName = Pt.Empty.displayName;
const Bi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Pt.Group,
  {
    ref: n,
    className: y(
...
const $c = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  Pt.Separator,
  {
    ref: n,
...
$c.displayName = Pt.Separator.displayName;
...
var Dc = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(Dc || {});
...
function nh({
  ...
  const p = zr(d, "%webView_bookSelector_currentBook%"), h = zr(d, "%webView_bookSelector_choose%"), u = zr(d, "%webView_bookSelector_chooseBooks%"), [f, b] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), m = (g) => {
    b(g), t(g);
      ...
      children: /* @__PURE__ */ N("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ i(Dt, { className: "tw-ms-1", children: u })
          ] }),
...
function jc({ table: t }) {
  return /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ i(dl, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Le = vt.Root, Bc = vt.Group, Ge = vt.Value, ke = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Nt();
  return /* @__PURE__ */ N(
    vt.Trigger,
    {
...
const Vi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  vt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ i(ul, { className: "tw-h-4 tw-w-4" })
  }
));
...
const Ee = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => {
  const a = Nt();
...
Vc.displayName = vt.Label.displayName;
const Vt = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  vt.Item,
  {
    ref: r,
    className: y(
...
zc.displayName = vt.Separator.displayName;
function Fc({ table: t }) {
...
const fr = S.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ i("div", { className: y("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ i(
  "table",
  {
    ref: r,
...
const hr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("tbody", { ref: n, className: y("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const kn = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  "th",
  {
    ref: n,
    className: y(
...
const Ue = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  "td",
  {
    ref: n,
...
function Uc({
  ...
  var g;
  const [l, c] = ut([]), [d, p] = ut([]), [h, u] = ut({}), [f, b] = ut({}), m = gi({
    data: e,
    columns: t,
    getCoreRowModel: vi(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ i(jc, { table: m }),
    /* @__PURE__ */ N(fr, { stickyHeader: a, children: [
      /* @__PURE__ */ i(mr, { stickyHeader: a, children: m.getHeaderGroups().map((k) => /* @__PURE__ */ i(le, { children: k.headers.map((T) => /* @__PURE__ */ i(kn, { children: T.isPlaceholder ? void 0 : gn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ i(hr, { children: (g = m.getRowModel().rows) != null && g.length ? m.getRowModel().rows.map((k) => /* @__PURE__ */ i(
        le,
        {
          onClick: () => s(k, m),
...
function Xc({
  ...
  return /* @__PURE__ */ N(fr, { stickyHeader: !0, children: [
    /* @__PURE__ */ i(mr, { stickyHeader: !0, children: /* @__PURE__ */ N(le, { children: [
...
const $o = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  no.Root,
  {
    ref: n,
    className: y(
...
}, qc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Fi = Re(
...
), Wc = S.forwardRef(({ className: t, variant: e, size: n, ...r }, o) => /* @__PURE__ */ i(
  yi.Root,
  {
    ref: o,
...
Wc.displayName = yi.Root.displayName;
const Li = S.createContext({
  size: "default",
  variant: "default"
}), Gi = S.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => {
  const s = Nt();
  return /* @__PURE__ */ i(
    dr.Root,
    {
...
const Wn = S.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
  const s = S.useContext(Li);
  return /* @__PURE__ */ i(
    dr.Item,
    {
      ref: a,
...
const gr = (t) => t === "asc" ? /* @__PURE__ */ i(yl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(xl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Nl, { className: "tw-ms-2 tw-h-4 tw-w-4" }), rh = (t) => ({
  accessorKey: "item",
  ...
  return Yc(t).forEach((p) => {
    p.startsWith("\\id") && (s = Hc(p), l = 0, c = 0), p.startsWith("\\c") && (l = va(p), c = 0), p.startsWith("\\v") && (c = va(p), l === 0 && (l = e.chapterNum));
    let h = o.exec(p) ?? void 0;
    for (; h; ) {
      const u = [];
      h.forEach((g) => u.push(g));
      const f = h.index, b = a.find((g) => yo(g.items, u)), m = {
        reference: {
          bookNum: s !== void 0 ? s : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: Al(p, Math.max(0, f - 25), Math.min(f + 25, p.length))
      };
      if (b)
...
function sh({
  ...
  const h = ee(n, "%webView_inventory_all%"), u = ee(n, "%webView_inventory_approved%"), f = ee(n, "%webView_inventory_unapproved%"), b = ee(n, "%webView_inventory_unknown%"), m = ee(n, "%webView_inventory_scope_currentBook%"), g = ee(n, "%webView_inventory_scope_chapter%"), k = ee(n, "%webView_inventory_scope_verse%"), T = ee(n, "%webView_inventory_filter_text%"), C = ee(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? Zc(
    l,
    t,
    a,
    s,
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ N(Ee, { children: [
              /* @__PURE__ */ i(Vt, { value: "all", children: h }),
              /* @__PURE__ */ i(Vt, { value: "approved", children: u }),
              /* @__PURE__ */ i(Vt, { value: "unapproved", children: f }),
...
function Qc({
  ...
  return /* @__PURE__ */ i("div", { className: d, children: /* @__PURE__ */ N(Ai, { open: p, onOpenChange: h, children: [
    /* @__PURE__ */ i(Di, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: "ghost",
          ...
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ i(
              "div",
              {
                ...
                children: /* @__PURE__ */ i("div", { className: "tw-font-normal", children: f() })
              }
            )
          ] }),
          ...
          return /* @__PURE__ */ N(
            Io,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ i("div", { className: "tw-w-4", children: m.starred && /* @__PURE__ */ i(kl, { className: "tw-h-4 tw-w-4" }) }),
...
const Xi = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    It.Root,
    {
...
const Yi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.List,
  {
    ref: n,
    className: y(
...
const td = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Trigger,
  {
    ref: n,
    ...e,
...
)), Hi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Content,
  {
    ref: n,
    className: y(
...
function lh({
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(Xi, { children: [
      /* @__PURE__ */ i(Yi, { children: t.map((s) => /* @__PURE__ */ i(td, { value: s.value, children: s.value }, s.key)) }),
      t.map((s) => /* @__PURE__ */ i(Hi, { value: s.value, children: s.content }, s.key))
    ] })
  ] });
}
const Mo = S.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ i(
  xi.Root,
  {
    ref: o,
    decorative: n,
...
const ed = Rn.Provider, nd = Rn.Root, rd = Rn.Trigger, qi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ i(
  Rn.Content,
  {
    ref: r,
    sideOffset: e,
...
const od = "16rem", ad = "3rem", Wi = S.createContext(void 0);
function br() {
...
const Ki = S.forwardRef(
  ({
    ...
    const [d, p] = S.useState(t), h = e ?? d, u = S.useCallback(
      (C) => {
        const E = typeof C == "function" ? C(h) : C;
        n ? n(E) : p(E);
      },
      [n, h]
    ), f = S.useCallback(() => u((C) => !C), [u]), b = h ? "expanded" : "collapsed", k = Nt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", T = S.useMemo(
      () => ({
        state: b,
        open: h,
        setOpen: u,
    ...
    return /* @__PURE__ */ i(Wi.Provider, { value: T, children: /* @__PURE__ */ i(ed, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
...
const Ji = S.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: r, ...o }, a) => {
  const s = br();
...
const id = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  const o = br();
  return /* @__PURE__ */ N(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ i(El, {}) : /* @__PURE__ */ i(Sl, {}),
        /* @__PURE__ */ i("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
id.displayName = "SidebarTrigger";
...
pd.displayName = "SidebarSeparator";
...
const so = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Ze : "div",
  {
    ref: r,
...
const ud = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: r,
...
ud.displayName = "SidebarGroupAction";
  ...
  ({
    ...
    const c = t ? Ze : "button", { state: d } = br(), p = /* @__PURE__ */ i(
      c,
      {
        ...
        "data-size": r,
        "data-active": e,
        className: y(wd({ variant: n, size: r }), a),
        ...s
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ N(nd, { children: [
      /* @__PURE__ */ i(rd, { asChild: !0, children: p }),
      /* @__PURE__ */ i(qi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ns.displayName = "SidebarMenuButton";
const fd = S.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...r }, o) => /* @__PURE__ */ i(
  e ? Ze : "button",
  {
    ref: o,
...
md.displayName = "SidebarMenuBadge";
const hd = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
...
gd.displayName = "SidebarMenuSub";
const bd = S.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ i("li", { ref: e, ...t })
);
bd.displayName = "SidebarMenuSubItem";
const vd = S.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: r, ...o }, a) => /* @__PURE__ */ i(
  t ? Ze : "a",
  {
    ref: a,
...
vd.displayName = "SidebarMenuSubButton";
function yd({
  id: t,
  extensionLabels: e,
  projectInfo: n,
  ...
  const d = Et(
    ...
    (u) => {
      const f = n.find((b) => b.projectId === u);
      return f ? f.projectName : u;
    },
    [n]
  ), h = Et(
    (u) => !o.projectId && u === o.label,
    [o]
  );
  return /* @__PURE__ */ i(
    Ji,
    {
      ...
      children: /* @__PURE__ */ N(Qi, { children: [
        /* @__PURE__ */ N(io, { children: [
          ...
          /* @__PURE__ */ i(lo, { children: /* @__PURE__ */ i(ts, { children: Object.entries(e).map(([u, f]) => /* @__PURE__ */ i(es, { children: /* @__PURE__ */ i(
            ns,
            {
              className: y(
                ...
                { "tw-bg-white tw-text-gray-900 tw-shadow-sm": h(u) }
              ),
              onClick: () => d(u),
              isActive: h(u),
    ...
    /* @__PURE__ */ N(
      Ki,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Zi, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const ie = "scrBook", xd = "scrRef", he = "source", Nd = "details", kd = "Scripture Reference", Ed = "Scripture Book", rs = "Type", Sd = "Details";
function Td(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: ie,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? kd,
      cell: (r) => {
        const o = r.row.original;
        return r.row.getIsGrouped() ? at.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === ie ? Br(o.start) : void 0;
      },
...
}, xa = (t) => `${Cd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function dh({
  sources: t,
  ...
  const [c, d] = ut([]), [p, h] = ut([{ id: ie, desc: !1 }]), [u, f] = ut({}), b = Rt(
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(Bc, { children: C.map((R) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ N(fr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ i(mr, { children: g.getHeaderGroups().map((R) => /* @__PURE__ */ i(le, { children: R.headers.filter((I) => I.column.columnDef.header).map((I) => (
                    ...
                    children: D.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ i(go, {}) : /* @__PURE__ */ i(Cl, {})),
                          " ",
...
function ne(t, e, n = {
  ...
  return ve(t) && ve(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ve(e[o]) && o in t && ve(t[o]) ? r[o] = ne(t[o], e[o], n) : n.clone ? r[o] = ve(e[o]) ? as(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
...
function _d() {
  ...
  return it.AsyncMode = c, it.ConcurrentMode = d, it.ContextConsumer = l, it.ContextProvider = s, it.Element = e, it.ForwardRef = p, it.Fragment = r, it.Lazy = b, it.Memo = f, it.Portal = n, it.Profiler = a, it.StrictMode = o, it.Suspense = h, it.isAsyncMode = function(v) {
    return E(v) || C(v) === c;
    ...
    return typeof v == "string" || typeof v == "function" || v === r || v === d || v === a || v === o || v === h || v === u || typeof v == "object" && v !== null && (v.$$typeof === b || v.$$typeof === f || v.$$typeof === s || v.$$typeof === l || v.$$typeof === p || v.$$typeof === g || v.$$typeof === k || v.$$typeof === T || v.$$typeof === m);
  }, it.typeOf = C, it;
}
var st = {};
/** @license React v16.13.1
...
function Pd() {
  return Ea || (Ea = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function C($) {
      ...
      $ === r || $ === d || $ === a || $ === o || $ === h || $ === u || typeof $ == "object" && $ !== null && ($.$$typeof === b || $.$$typeof === f || $.$$typeof === s || $.$$typeof === l || $.$$typeof === p || $.$$typeof === g || $.$$typeof === k || $.$$typeof === T || $.$$typeof === m);
    }
    function E($) {
    ...
    var v = c, P = d, F = l, R = s, I = e, L = p, D = r, tt = b, J = f, j = n, M = a, A = o, G = h, H = !1;
    function rt($) {
      return H || (H = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), x($) || E($) === c;
    }
    function x($) {
      return E($) === d;
    }
    ...
    st.AsyncMode = v, st.ConcurrentMode = P, st.ContextConsumer = F, st.ContextProvider = R, st.Element = I, st.ForwardRef = L, st.Fragment = D, st.Lazy = tt, st.Memo = J, st.Portal = j, st.Profiler = M, st.StrictMode = A, st.Suspense = G, st.isAsyncMode = rt, st.isConcurrentMode = x, st.isContextConsumer = O, st.isContextProvider = U, st.isElement = X, st.isForwardRef = z, st.isFragment = K, st.isLazy = q, st.isMemo = W, st.isPortal = Y, st.isProfiler = Z, st.isStrictMode = Q, st.isSuspense = dt, st.isValidElementType = C, st.typeOf = E;
  }()), st;
}
var Sa;
function is() {
  return Sa || (Sa = 1, process.env.NODE_ENV === "production" ? Gn.exports = _d() : Gn.exports = Pd()), Gn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Md() {
  if (_a) return Wr;
  _a = 1;
  var t = is(), e = Id(), n = /* @__PURE__ */ Do(), r = /* @__PURE__ */ ss(), o = /* @__PURE__ */ $d(), a = function() {
  };
...
function Dd() {
  ...
  if (Ia = 1, process.env.NODE_ENV !== "production") {
    var t = is(), e = !0;
    Ln.exports = /* @__PURE__ */ Md()(t.isElement, e);
  } else
    Ln.exports = /* @__PURE__ */ Ad()();
  return Ln.exports;
}
var jd = /* @__PURE__ */ Dd();
const w = /* @__PURE__ */ os(jd);
function Bd(t) {
  const {
    prototype: e = {}
  } = t;
...
const jo = Ao(w.element, ls);
jo.isRequired = Ao(w.element.isRequired, ls);
const Vd = "exact-prop: ​";
function zd(t) {
...
function Fd() {
  ...
  return lt.ContextConsumer = s, lt.ContextProvider = a, lt.Element = t, lt.ForwardRef = c, lt.Fragment = n, lt.Lazy = u, lt.Memo = h, lt.Portal = e, lt.Profiler = o, lt.StrictMode = r, lt.Suspense = d, lt.SuspenseList = p, lt.isAsyncMode = function() {
    return !1;
    ...
    return typeof g == "string" || typeof g == "function" || g === n || g === o || g === r || g === d || g === p || g === f || typeof g == "object" && g !== null && (g.$$typeof === u || g.$$typeof === h || g.$$typeof === a || g.$$typeof === s || g.$$typeof === c || g.$$typeof === b || g.getModuleId !== void 0);
  }, lt.typeOf = m, lt;
}
var ct = {};
/**
...
function Ld() {
  return Ma || (Ma = 1, process.env.NODE_ENV !== "production" && function() {
    var t = Symbol.for("react.element"), e = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), u = Symbol.for("react.lazy"), f = Symbol.for("react.offscreen"), b = !1, m = !1, g = !1, k = !1, T = !1, C;
    C = Symbol.for("react.module.reference");
    function E(V) {
      return !!(typeof V == "string" || typeof V == "function" || V === n || V === o || T || V === r || V === d || V === p || k || V === f || b || m || g || typeof V == "object" && V !== null && (V.$$typeof === u || V.$$typeof === h || V.$$typeof === a || V.$$typeof === s || V.$$typeof === c || // This needs to include all possible module reference object
    ...
    var P = s, F = a, R = t, I = c, L = n, D = u, tt = h, J = e, j = o, M = r, A = d, G = p, H = !1, rt = !1;
    function x(V) {
...
const ds = w.oneOfType([w.func, w.object]);
function Jt(t) {
  if (typeof t != "string")
...
function Zd(t, e) {
  ...
  return (o) => (a, s, l, c, d, ...p) => {
    const h = d || s, u = n == null ? void 0 : n[h];
    if (u) {
      const f = u(a, s, l, c, d, ...p);
      if (f)
        return f;
    }
    return typeof a[s] < "u" && !a[o] ? new Error(`The prop \`${h}\` of \`${t}\` can only be used together with the \`${o}\` prop.`) : null;
  };
}
function tr(t, e) {
...
function cp(t) {
  t.addEventListener("keydown", sp, !0), t.addEventListener("mousedown", Jr, !0), t.addEventListener("pointerdown", Jr, !0), t.addEventListener("touchstart", Jr, !0), t.addEventListener("visibilitychange", lp, !0);
}
function dp(t) {
  const {
    target: e
...
function ws() {
  ...
  function n() {
    return e.current ? (po = !0, op.start(100, () => {
      po = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
function mp(t) {
  ...
  function l(u) {
    return `@media (min-width:${typeof e[u] == "number" ? e[u] : u}${n})`;
  }
  function c(u) {
    return `@media (max-width:${(typeof e[u] == "number" ? e[u] : u) - r / 100}${n})`;
  }
  function d(u, f) {
    const b = s.indexOf(f);
    return `@media (min-width:${typeof e[u] == "number" ? e[u] : u}${n}) and (max-width:${(b !== -1 && typeof e[s[b]] == "number" ? e[s[b]] : f) - r / 100}${n})`;
  }
  function p(u) {
    return s.indexOf(u) + 1 < s.length ? d(u, s[s.indexOf(u) + 1]) : l(u);
  }
  function h(u) {
    const f = s.indexOf(u);
    return f === 0 ? l(s[1]) : f === s.length - 1 ? c(s[f]) : d(u, s[s.indexOf(u) + 1]).replace("@media", "@media not all and");
  }
  return _({
    keys: s,
    values: a,
...
const hp = {
  borderRadius: 4
}, de = process.env.NODE_ENV !== "production" ? w.oneOfType([w.number, w.string, w.object, w.array]) : {};
function bn(t, e) {
  return e ? ne(t, e, {
    clone: !1
...
function yt(t) {
  const {
    ...
    return re(s, l, (h) => {
      let u = er(d, o, h);
      return h === u && typeof h == "string" && (u = er(d, o, `${e}${h === "default" ? "" : Jt(h)}`, h)), n === !1 ? u : {
        [n]: u
      };
    });
  };
...
function vs(t, e) {
  const n = bs(t.theme);
  return Object.keys(t).map((r) => Sp(t, e, r, n)).reduce(bn, {});
}
function gt(t) {
  return vs(t, Nr);
}
...
bt.filterProps = kr;
process.env.NODE_ENV !== "production" && kp.reduce((t, e) => (t[e] = de, t), {});
function Tp(t = 8) {
  if (t.mui)
    return t;
  const e = bs({
...
const Cp = Ut("border", zt), Rp = Ut("borderTop", zt), Op = Ut("borderRight", zt), _p = Ut("borderBottom", zt), Pp = Ut("borderLeft", zt), Ip = Ut("borderColor"), $p = Ut("borderTopColor"), Mp = Ut("borderRightColor"), Ap = Ut("borderBottomColor"), Dp = Ut("borderLeftColor"), jp = Ut("outline", zt), Bp = Ut("outlineColor"), Sr = (t) => {
...
Er(Cp, Rp, Op, _p, Pp, Ip, $p, Mp, Ap, Dp, Sr, jp, Bp);
const Tr = (t) => {
...
Er(Tr, Cr, Rr, Vp, zp, Fp, Lp, Gp, Up, Xp, Yp, Hp);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const qp = yt({
...
function au() {
  function t(n, r, o, a) {
    ...
    const u = xr(o, d) || {};
    return h ? h(s) : re(s, r, (b) => {
      let m = er(u, p, b);
      return b === m && typeof b == "string" && (m = er(u, p, `${n}${b === "default" ? "" : Jt(b)}`, b)), c === !1 ? m : {
        [c]: m
      };
    });
  }
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = gp(a.breakpoints), h = Object.keys(p);
      let u = p;
...
function Lo(t = {}, ...e) {
  ...
  return d.applyStyles = iu, d = e.reduce((p, h) => ne(p, h), d), d.unstable_sxConfig = _({}, Fo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(h) {
    return Or({
      sx: h,
      theme: this
    });
...
const mu = Lo(), Ua = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Xn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function gu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    Ul(s, (v) => v.filter((P) => !(P != null && P.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: u = hu(Ua(d))
    } = l, f = St(l, uu), b = p !== void 0 ? p : (
    ...
    const T = Ll(s, _({
      shouldForwardProp: k,
      label: g
    }, f)), C = (v) => typeof v == "function" && v.__emotion_real !== v || ve(v) ? (P) => Jn(v, _({}, P, {
      theme: Xn({
        theme: P.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${Jt(d || "")}`), D === void 0 && (D = `Styled(${Yd(s)})`), L.displayName = D;
      }
...
function Xa(t) {
  t = Te(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Te(xu(t)).values : t.values;
...
const Sn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, Tu = ["mode", "contrastThreshold", "tonalOffset"], Ha = {
...
function $u(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = St(t, Tu), a = t.primary || Cu(e), s = t.secondary || Ru(e), l = t.error || Ou(e), c = t.info || _u(e), d = t.success || Pu(e), p = t.warning || Iu(e);
  function h(m) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return qa(m, "light", T, r), qa(m, "dark", C, r), m.contrastText || (m.contrastText = h(m.main)), m;
  }, f = {
    dark: Zr,
    light: Ha
  };
  return process.env.NODE_ENV !== "production" && (f[e] || console.error(`MUI: The palette mode \`${e}\` is not supported.`)), ne(_({
...
function Du(t, e) {
  ...
  const f = o / 14, b = h || ((k) => `${k / d * f}rem`), m = (k, T, C, E, v) => _({
    fontFamily: r,
    fontWeight: k,
    fontSize: b(T),
...
function Xu(t) {
  const e = _({}, Lu, t.easing), n = _({}, Gu, t.duration);
  return _({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        const p = (u) => typeof u == "string", h = (u) => !isNaN(parseFloat(u));
...
function qu(t = {}, ...e) {
  ...
  if (d = ne(d, s), d = e.reduce((p, h) => ne(p, h), d), process.env.NODE_ENV !== "production") {
    const p = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], h = (u, f) => {
      let b;
      for (b in u) {
        const m = u[b];
        if (p.indexOf(b) !== -1 && Object.keys(m).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const g = yr("", b);
            console.error([`MUI: The \`${f}\` component increases the CSS specificity of the \`${b}\` internal state.`, "You can not override it like this: ", JSON.stringify(u, null, 2), "", `Instead, you need to use the '&.${g}' syntax:`, JSON.stringify({
              root: {
                [`&.${g}`]: m
              }
...
`));
    ...
    Object.keys(d.components).forEach((u) => {
      const f = d.components[u].styleOverrides;
      f && u.indexOf("Mui") === 0 && h(f, u);
    });
  }
  return d.unstable_sxConfig = _({}, Fo, s == null ? void 0 : s.unstable_sxConfig), d.unstable_sx = function(h) {
    return Or({
      sx: h,
      theme: this
    });
...
const Wu = (t) => Kn(t) && t !== "classes", In = gu({
  themeId: Xo,
  defaultTheme: Uo,
...
const Ju = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Zu = (t) => {
  ...
  return {
    ...
    color: (h = (u = (t.vars || t).palette) == null || (u = u[e.color]) == null ? void 0 : u.main) != null ? h : {
      action: (f = (t.vars || t).palette) == null || (f = f.action) == null ? void 0 : f.active,
  ...
  const r = Yo({
    ...
    titleAccess: h,
    viewBox: u = "0 0 24 24"
  } = r, f = St(r, Ju), b = /* @__PURE__ */ B.isValidElement(o) && o.type === "svg", m = _({}, r, {
    color: s,
    component: l,
    fontSize: c,
  ...
  return /* @__PURE__ */ N(Qu, _({
    ...
    ownerState: m,
    children: [b ? o.props.children : o, h ? /* @__PURE__ */ i("title", {
      children: h
    }) : null]
  }));
});
...
function ow() {
  ...
  var e = t(/* @__PURE__ */ rw()), n = sl;
  return cn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), cn;
}
var aw = /* @__PURE__ */ ow();
const iw = /* @__PURE__ */ os(aw);
function sw(t) {
  return typeof t == "string";
}
function mn(t, e, n) {
  return t === void 0 || sw(t) ? e : _({}, e, {
...
function ww(t) {
  ...
  if (!e) {
    const f = ye(n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), b = _({}, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), m = _({}, n, o, r);
    return f.length > 0 && (m.className = f), Object.keys(b).length > 0 && (m.style = b), {
      props: m,
      internalRef: void 0
    };
  }
  const s = pw(_({}, o, r)), l = ti(r), c = ti(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), u = _({}, d, n, c, l);
...
process.env.NODE_ENV !== "production" && (rr.propTypes = zd(rr.propTypes));
var Ot = "top", Lt = "bottom", Gt = "right", _t = "left", Ho = "auto", $n = [Ot, Lt, Gt, _t], He = "start", Tn = "end", yw = "clippingParents", Ss = "viewport", pn = "popper", xw = "reference", ei = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + He, e + "-" + Tn]);
}, []), Ts = /* @__PURE__ */ [].concat($n, [Ho]).reduce(function(t, e) {
  return t.concat([e, e + "-" + He, e + "-" + Tn]);
}, []), Nw = "beforeRead", kw = "read", Ew = "afterRead", Sw = "beforeMain", Tw = "main", Cw = "afterMain", Rw = "beforeWrite", Ow = "write", _w = "afterWrite", Pw = [Nw, kw, Ew, Sw, Tw, Cw, Rw, Ow, _w];
function Zt(t) {
...
function We(t, e, n) {
  ...
  var s = Ce(t) ? jt(t) : window, l = s.visualViewport, c = !Cs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, u = r.height / a;
  return {
    width: h,
    height: u,
    top: p,
...
function Mn(t) {
  for (var e = jt(t), n = ni(t); n && Aw(n) && oe(n).position === "static"; )
    n = ni(n);
  return n && (Zt(n) === "html" || Zt(n) === "body" && oe(n).position === "static") ? e : n || Dw(t) || e;
}
function Ko(t) {
...
function Vw(t) {
  ...
  if (!(!a || !s)) {
    var h = Bw(o.padding, n), u = Wo(a), f = c === "y" ? Ot : _t, b = c === "y" ? Lt : Gt, m = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Mn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = m / 2 - g / 2, E = h[f], v = T - u[p] - h[b], P = T / 2 - u[p] / 2 + C, F = vn(E, P, v), R = c;
...
function ri(t) {
  var e, n = t.popper, r = t.popperRect, o = t.placement, a = t.variation, s = t.offsets, l = t.position, c = t.gpuAcceleration, d = t.adaptive, p = t.roundOffsets, h = t.isFixed, u = s.x, f = u === void 0 ? 0 : u, b = s.y, m = b === void 0 ? 0 : b, g = typeof p == "function" ? p({
    x: f,
    y: m
  }) : {
    x: f,
  ...
  f = g.x, m = g.y;
  var k = s.hasOwnProperty("x"), T = s.hasOwnProperty("y"), C = _t, E = Ot, v = window;
  if (d) {
    var P = Mn(n), F = "clientHeight", R = "clientWidth";
    if (P === jt(n) && (P = pe(n), oe(P).position !== "static" && l === "absolute" && (F = "scrollHeight", R = "scrollWidth")), P = P, o === Ot || (o === _t || o === Gt) && a === Tn) {
      E = Lt;
      var I = h && P === v && v.visualViewport ? v.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        P[F]
      );
    ...
    if (o === _t || (o === Ot || o === Lt) && a === Tn) {
      C = Gt;
      var L = h && P === v && v.visualViewport ? v.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        P[R]
      );
      f -= L - r.width, f *= c ? 1 : -1;
  ...
  if (f = tt.x, m = tt.y, c) {
    var J;
    return Object.assign({}, D, (J = {}, J[E] = T ? "0" : "", J[C] = k ? "0" : "", J.transform = (v.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)", J));
  }
  return Object.assign({}, D, (e = {}, e[E] = T ? m + "px" : "", e[C] = k ? f + "px" : "", e.transform = "", e));
}
function Uw(t) {
...
function Is(t) {
  return ["html", "body", "#document"].indexOf(Zt(t)) >= 0 ? t.ownerDocument.body : Ft(t) && Qo(t) ? t : Is(Pr(t));
}
function yn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = Is(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = jt(r), s = o ? [a].concat(a.visualViewport || [], Qo(r) ? r : []) : r, l = e.concat(s);
  return o ? l : (
...
function ai(t, e, n) {
  return e === Ss ? wo(Kw(t, n)) : Ce(e) ? Zw(e, n) : wo(Jw(pe(t)));
}
function Qw(t) {
  var e = yn(Pr(t)), n = ["absolute", "fixed"].indexOf(oe(t).position) >= 0, r = n && Ft(t) ? Mn(t) : t;
  return Ce(r) ? e.filter(function(o) {
    return Ce(o) && Rs(o, r) && Zt(o) !== "body";
  }) : [];
}
function tf(t, e, n, r) {
...
function Cn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? yw : l, d = n.rootBoundary, p = d === void 0 ? Ss : d, h = n.elementContext, u = h === void 0 ? pn : h, f = n.altBoundary, b = f === void 0 ? !1 : f, m = n.padding, g = m === void 0 ? 0 : m, k = _s(typeof g != "number" ? g : Ps(g, $n)), T = u === pn ? xw : pn, C = t.rects.popper, E = t.elements[b ? T : u], v = tf(Ce(E) ? E : E.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = $s({
    reference: P,
    element: C,
    placement: o
  }), R = wo(Object.assign({}, C, F)), I = u === pn ? R : P, L = {
...
function ef(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, s = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Ts : c, p = Ke(r), h = p ? l ? ei : ei.filter(function(b) {
    return Ke(b) === p;
  }) : $n, u = h.filter(function(b) {
  ...
  return Object.keys(f).sort(function(b, m) {
    return f[b] - f[m];
  });
}
function nf(t) {
...
function rf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, u = n.altBoundary, f = n.flipVariations, b = f === void 0 ? !0 : f, m = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), T = k === g, C = c || (T || !b ? [Zn(g)] : nf(g)), E = [g].concat(C).reduce(function(z, K) {
      return z.concat(Wt(K) === Ho ? ef(e, {
        placement: K,
        boundary: p,
        rootBoundary: h,
        padding: d,
    ...
    }, []), v = e.rects.reference, P = e.rects.popper, F = /* @__PURE__ */ new Map(), R = !0, I = E[0], L = 0; L < E.length; L++) {
      var D = E[L], tt = Wt(D), J = Ke(D) === He, j = [Ot, Lt].indexOf(tt) >= 0, M = j ? "width" : "height", A = Cn(e, {
        placement: D,
        boundary: p,
        rootBoundary: h,
        altBoundary: u,
...
function af(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, s = Cn(e, {
    ...
    altBoundary: !0
  }), c = ii(s, r), d = ii(l, o, a), p = si(c), h = si(d);
  e.modifiersData[n] = {
...
function cf(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, s = Ts.reduce(function(p, h) {
    return p[h] = lf(h, e.rects, a), p;
...
function ff(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, u = n.tether, f = u === void 0 ? !0 : u, b = n.tetherOffset, m = b === void 0 ? 0 : b, g = Cn(e, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), k = Wt(e.placement), T = Ke(e.placement), C = !T, E = Ko(k), v = wf(E), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = E === "y" ? Ot : _t, M = E === "y" ? Lt : Gt, A = E === "y" ? "height" : "width", G = P[E], H = G + g[j], rt = G - g[M], x = f ? -R[A] / 2 : 0, O = T === He ? F[A] : R[A], U = T === He ? -R[A] : -F[A], X = e.elements.arrow, z = f && X ? Wo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Os(), q = K[j], W = K[M], Y = vn(0, F[A], z[A]), Z = C ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Mn(e.elements.arrow), $ = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[E]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Xt = vn(f ? or(H, V) : H, G, f ? xe(rt, xt) : rt);
      P[E] = Xt, tt[E] = Xt - G;
    }
    if (l) {
      var ue, Tt = E === "x" ? Ot : _t, jn = E === "x" ? Lt : Gt, Yt = P[v], _e = v === "y" ? "height" : "width", we = Yt + g[Tt], Pe = Yt - g[jn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Yt - F[_e] - R[_e] - $e + L.altAxis, en = Ie ? Yt + F[_e] + R[_e] - $e - L.altAxis : Pe, Bn = f && Ie ? jw(fe, Yt, en) : vn(f ? fe : we, Yt, f ? en : Pe);
      P[v] = Bn, tt[v] = Bn - Yt;
    }
...
function vf(t, e, n) {
  n === void 0 && (n = !1);
  var r = Ft(e), o = Ft(e) && bf(e), a = pe(e), s = We(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Qo(a)) && (l = gf(e)), Ft(e) ? (c = We(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = Zo(a))), {
...
function Ef(t) {
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      forceUpdate: function() {
        if (!u) {
          ...
          if (ci(T, C)) {
            p.rects = {
              reference: vf(T, Mn(C), p.options.strategy === "fixed"),
              popper: Wo(C)
            ...
            for (var E = 0; E < p.orderedModifiers.length; E++) {
              ...
              var v = p.orderedModifiers[E], P = v.fn, F = v.options, R = F === void 0 ? {} : F, I = v.name;
    ...
    f.setOptions(d).then(function(g) {
      !u && d.onFirstUpdate && d.onFirstUpdate(g);
    });
    function b() {
      p.orderedModifiers.forEach(function(g) {
        var k = g.name, T = g.options, C = T === void 0 ? {} : T, E = g.effect;
        if (typeof E == "function") {
          var v = E({
            state: p,
            name: k,
...
const Of = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], _f = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Pf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const $f = () => Bo({
  ...
  } = e, g = St(e, Of), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), E = Se(C, u), v = B.useRef(E);
  Ye(() => {
    v.current = E;
  }, [E]), B.useImperativeHandle(u, () => C.current, []);
  const P = Pf(p, s), [F, R] = B.useState(P), [I, L] = B.useState(ar(o));
  B.useEffect(() => {
...
`));
    ...
    c != null && (A = A.concat(c)), h && h.modifiers != null && (A = A.concat(h.modifiers));
    const G = Tf(I, k.current, _({
      placement: P
    }, h, {
      modifiers: A
    }));
  ...
  const tt = $f(), J = (r = b.root) != null ? r : "div", j = mw({
    elementType: J,
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = St(e, _f), [C, E] = B.useState(!0), v = () => {
    E(!1);
  }, P = () => {
    E(!0);
  };
...
process.env.NODE_ENV !== "production" && (Ms.propTypes = {
   ...
   */
  anchorEl: Ao(w.oneOfType([En, w.object, w.func]), (t) => {
    if (t.open) {
...
var jf = process.env.NODE_ENV !== "production" ? w.oneOfType([w.number, w.shape({
  enter: w.number,
  exit: w.number,
  appear: w.number
}).isRequired]) : null;
...
var Bf = function(e) {
  return e.scrollTop;
}, hn = "unmounted", ge = "exited", be = "entering", ze = "entered", mo = "exiting", ae = /* @__PURE__ */ function(t) {
  Df(e, t);
  function e(r, o) {
    var a;
  ...
  return n.componentDidMount = function() {
    ...
    var a = this, s = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Fn.findDOMNode(this), l], d = c[0], p = c[1], h = this.getTimeouts(), u = l ? h.appear : h.enter;
    if (!o && !s || di.disabled) {
      this.safeSetState({
        status: ze
      }, function() {
    ...
    this.props.onEnter(d, p), this.safeSetState({
      ...
      a.props.onEntering(d, p), a.onTransitionEnd(u, function() {
        a.safeSetState({
          status: ze
        }, function() {
...
ae.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  nodeRef: w.shape({
    current: typeof Element > "u" ? w.any : function(t, e, n, r, o, a) {
      var s = t[e];
      return w.instanceOf(s && "ownerDocument" in s ? s.ownerDocument.defaultView.Element : Element)(t, e, n, r, o, a);
    }
  }),
  /**
...
const Ff = {
  ...
  const {
  ...
  } = e, k = St(e, zf), T = fn(), C = B.useRef(), E = As(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
    ...
    let x;
    m === "auto" ? (x = E.transitions.getAutoHeightDuration(M.clientHeight), C.current = x) : x = G, M.style.transition = [E.transitions.create("opacity", {
      duration: x,
      delay: H
    ...
    let rt;
    m === "auto" ? (rt = E.transitions.getAutoHeightDuration(M.clientHeight), C.current = rt) : rt = A, M.style.transition = [E.transitions.create("opacity", {
      duration: rt,
      delay: G
    }), E.transitions.create("transform", {
      ...
      easing: H
    })].join(","), M.style.opacity = 0, M.style.transform = ho(0.75), h && h(M);
  }), J = F(u);
...
ir.muiSupportAuto = !0;
const Lf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Gf = In(Ms, {
  name: "MuiPopper",
  slot: "Root",
  ...
  const o = ys(), a = Yo({
    ...
    slots: C,
    slotProps: E
  } = a, v = St(a, Lf), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: h,
    keepMounted: u,
...
const se = gs("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Xf = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function Yf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Hf = (t) => {
...
const js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r, o, a, s, l, c, d, p, h, u, f, b, m, g, k, T, C, E, v;
  const P = Yo({
    props: e,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: kt
  } = P, V = St(P, Xf), xt = /* @__PURE__ */ B.isValidElement(R) ? R : /* @__PURE__ */ i("span", {
    children: R
  }), Xt = As(), ue = Xt.direction === "rtl", [Tt, jn] = B.useState(), [Yt, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = fn(), $e = fn(), fe = fn(), en = fn(), [Bn, ea] = us({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const na = (et) => {
    ...
    (et) => {
      ui.start(800 + O, () => {
        Hn = !1;
      }), ea(!1), X && te && X(et), Ie.start(Xt.transitions.duration.shortest, () => {
        we.current = !1;
      });
    }
  ), Mr = (et) => {
  ...
  D ? (rn.title = !te && Dr && !J ? dt : null, rn["aria-describedby"] = te ? $r : null) : (rn["aria-label"] = Dr ? dt : null, rn["aria-labelledby"] = te && !Dr ? $r : null);
...
`));
  const nl = B.useMemo(() => {
    ...
    touch: we.current
  }), jr = Hf(an), pa = (r = (o = Q.popper) != null ? o : I.Popper) != null ? r : qf, ua = (a = (s = (l = Q.transition) != null ? l : I.Transition) != null ? s : $) != null ? a : ir, wa = (c = (d = Q.tooltip) != null ? d : I.Tooltip) != null ? c : Wf, fa = (p = (h = Q.arrow) != null ? h : I.Arrow) != null ? p : Kf, rl = mn(pa, _({}, Y, (u = Z.popper) != null ? u : L.popper, {
    className: ye(jr.popper, Y == null ? void 0 : Y.className, (f = (b = Z.popper) != null ? b : L.popper) == null ? void 0 : f.className)
    ...
    className: ye(jr.arrow, (E = (v = Z.arrow) != null ? v : L.arrow) == null ? void 0 : E.className)
  }), an);
    ...
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ i(pa, _({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(wa, _({}, al, {
          children: [dt, F ? /* @__PURE__ */ i(fa, _({}, il, {
            ref: _e
          })) : null]
        }))
      }))
  ...
  const {
    ...
    Xl,
    {
      ...
      children: n ? /* @__PURE__ */ N(Qt, { children: [
        ...
        h ? /* @__PURE__ */ i(Ni, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ i(iw, {}) }) : wi(s, n, !1)
      ] }) : g
    }
  );
...
function Jf(t) {
  ...
  return /* @__PURE__ */ N(Qt, { children: [
    /* @__PURE__ */ i(Bs, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ i(
      Hl,
      {
        anchorEl: e,
...
function zs(t) {
  const { menuDefinition: e, onClick: n, commandHandler: r, includedGroups: o } = t, { items: a, allowForLeadingIcons: s } = Rt(() => {
    ...
    h.forEach((b) => {
      Zf(b.id, e.items).forEach(
        (m) => u.push({ item: m, isLastItemInGroup: !1 })
    ...
    return { items: u, allowForLeadingIcons: f };
...
function om({
  ...
  const [c, d] = ut(!1), [p, h] = ut(!1), u = Et(() => {
    c && d(!1), h(!1);
  }, [c]), f = Et((E) => {
    E.stopPropagation(), d((v) => {
      const P = !v;
      return P && E.shiftKey ? h(!0) : P || h(!1), P;
    });
  }, []), b = Et(
    (E) => (u(), r(E)),
    [r, u]
  ...
  ce(() => {
    if (c) {
      ...
      if (E) {
        const v = E.getBoundingClientRect(), P = window.scrollY, F = window.scrollX, R = v.top + P + E.clientHeight, I = v.left + F;
        g({ top: R, left: I });
      }
    }
  }, [c, o]);
...
const An = lr(({ className: t, ...e }, n) => /* @__PURE__ */ i(Rl, { size: 35, className: y("tw-animate-spin", t), ...e, ref: n }));
...
const Ls = S.forwardRef(({ className: t, variant: e = "default", ...n }, r) => {
  const o = S.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ i(Fs.Provider, { value: o, children: /* @__PURE__ */ i(
    mt.Root,
    {
      ref: r,
      className: y(
...
const Gs = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ i(
    mt.Trigger,
    {
...
const Us = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.SubTrigger,
    {
...
const Xs = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Oe();
  return /* @__PURE__ */ i(
    mt.SubContent,
    {
...
const Ys = S.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: r = 8, ...o }, a) => {
  const s = Oe();
...
const Hs = S.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ i(
    mt.Item,
    {
...
const sm = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => {
  const a = Oe();
  return /* @__PURE__ */ N(
    mt.CheckboxItem,
    {
...
sm.displayName = mt.CheckboxItem.displayName;
const lm = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = Oe();
  return /* @__PURE__ */ N(
    mt.RadioItem,
    {
...
lm.displayName = mt.RadioItem.displayName;
const cm = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ i(
  mt.Label,
  {
    ref: r,
    className: y("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
cm.displayName = mt.Label.displayName;
...
function dm({
  ...
  const [r] = sr(
    ...
    var b;
    return (b = Object.entries(u).find(
      ([, m]) => "menuItem" in m && m.menuItem === f
    )) == null ? void 0 : b[0];
  }, a = (u, f, b) => {
    if (!b) return;
    const m = Object.entries(u).filter(
      ([g, k]) => "column" in k && k.column === b || g === b
    ).sort(([, g], [, k]) => g.order - k.order);
    return m.flatMap(([g], k) => {
      const T = f.filter((E) => E.group === g).sort((E, v) => E.order - v.order).map(
        (E) => "command" in E ? /* @__PURE__ */ i(
          Hs,
          {
            onClick: () => {
              e(E);
          ...
          E.command
        ) : /* @__PURE__ */ N(im, { children: [
          /* @__PURE__ */ i(Us, { children: E.label }),
          /* @__PURE__ */ i(Xs, { children: a(u, f, o(u, E.id)) })
        ] }, E.id)
      ), C = [...T];
      return T.length > 0 && k < m.length - 1 && C.push(/* @__PURE__ */ i(qs, {}, `${g}-separator`)), C;
    });
  }, s = Ht(void 0), l = Ht(void 0), c = Ht(void 0), d = Ht(void 0), p = (u) => {
    switch (u) {
      case "paratext.paratext":
        return console.log("yes"), s;
    ...
    setTimeout(() => {
      var f, b;
      (f = u.current) == null || f.dispatchEvent(
        new KeyboardEvent("keydown", { key: "Escape", code: "Escape", keyCode: 27, bubbles: !0 })
      ), (b = u.current) == null || b.dispatchEvent(
        new KeyboardEvent("keydown", { key: " ", code: "Space", keyCode: 32, bubbles: !0 })
      );
    }, 0);
  };
  if (Jl(["alt+p", "alt+l", "alt+n", "alt+h"], (u, f) => {
    var b, m, g, k;
    switch (u.preventDefault(), f.hotkey) {
      case "alt+p":
        (b = s.current) == null || b.focus(), h(s);
        break;
      case "alt+l":
        (m = l.current) == null || m.focus(), h(l);
        break;
      case "alt+n":
        (g = c.current) == null || g.focus(), h(c);
        break;
      case "alt+h":
        (k = d.current) == null || k.focus(), h(d);
        break;
    }
  }), !!r)
    return /* @__PURE__ */ i(Ls, { className: "pr-twp tw-border-0 tw-bg-transparent", variant: n, children: Object.entries(r.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, f]) => typeof u == "boolean" || typeof f == "boolean" ? 0 : u.order - f.order).map(([u, f]) => /* @__PURE__ */ N(am, { children: [
      /* @__PURE__ */ i(Gs, { ref: p(u), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ i(Ys, { children: a(r.groups, r.items, u) })
    ] }, u)) });
}
function bh({
  menuProvider: t,
...
), um = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ i("div", { ref: r, role: "alert", className: y(pm({ variant: e }), t), ...n }));
um.displayName = "Alert";
...
const fm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("div", { ref: n, className: y("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
...
function hm({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ i("div", { className: y("pr-twp", mm({ variant: e }), t), ...n });
}
...
const ym = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i("p", { ref: n, className: y("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
km.displayName = wn.Root.displayName;
const Em = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    ro.Root,
    {
...
Em.displayName = ro.Root.displayName;
const yh = It.Root, Sm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = Nt();
  return /* @__PURE__ */ i(
    It.List,
    {
...
Sm.displayName = It.List.displayName;
const Tm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Trigger,
  {
    ref: n,
    className: y(
...
Tm.displayName = It.Trigger.displayName;
const Cm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ i(
  It.Content,
  {
    ref: n,
    className: y(
...
Cm.displayName = It.Content.displayName;
function xh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ i(An, { size: 15 }) : /* @__PURE__ */ N(Qt, { children: [
        /* @__PURE__ */ i(Ol, { size: 25, className: y("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function Nh({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      ...r,
      children: t ? /* @__PURE__ */ N(Qt, { children: [
        /* @__PURE__ */ i(An, { size: 15, className: "tw-mr-1 tw-text-white" }),
        "Enabling..."
      ] }) : "Enable"
    }
  );
...
function kh({
  ...
  return /* @__PURE__ */ i(
    wt,
    {
      ...
      ...r,
      children: t ? /* @__PURE__ */ N(Qt, { children: [
        /* @__PURE__ */ i(An, { size: 15, className: "tw-mr-1 tw-text-black" }),
        "Disabling..."
      ] }) : "Disable"
    }
  );
...
const Rm = lr((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ i(_l, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4 tw-text-gray-700 hover:tw-text-blue-600" }),
      "Filter",
      /* @__PURE__ */ i(
        cr,
        {
...
var Om = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(Om || {});
function Th({ id: t, groups: e }) {
  return /* @__PURE__ */ i("div", { id: t, children: /* @__PURE__ */ N(xo, { children: [
    /* @__PURE__ */ i(Si, { asChild: !0, children: /* @__PURE__ */ i(Rm, {}) }),
    /* @__PURE__ */ i(pr, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ i(ur, { children: n.label }),
      /* @__PURE__ */ i(rc, { children: n.items.map((r) => /* @__PURE__ */ i("div", { children: r.itemType === 0 ? /* @__PURE__ */ i(No, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ i(Ci, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ i(wr, {})
    ] }, n.label)) })
  ] }) });
}
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(Pl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
...
function _m({ id: t, versionHistory: e }) {
  const [n, r] = ut(!1), o = /* @__PURE__ */ new Date();
  function a(l) {
    const c = new Date(l), d = new Date(o.getTime() - c.getTime()), p = d.getUTCFullYear() - 1970, h = d.getUTCMonth(), u = d.getUTCDate() - 1;
    let f = "";
    return p > 0 ? f = `${p.toString()} year${p === 1 ? "" : "s"} ago` : h > 0 ? f = `${h.toString()} month${h === 1 ? "" : "s"} ago` : u === 0 ? f = "today" : f = `${u.toString()} day${u === 1 ? "" : "s"} ago`, f;
  }
...
function Oh({
  ...
  return /* @__PURE__ */ i("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ N("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ i(_m, { versionHistory: o }),
...
function _h({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ i("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((h) => {
      var u;
      return /* @__PURE__ */ N(hm, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ i(
          wt,
          {
            variant: "ghost",
            ...
            onClick: () => r(n.filter((f) => f !== h)),
            children: /* @__PURE__ */ i(vo, { className: "tw-h-3 tw-w-3" })
          }
        ),
        (u = t.find((f) => f.value === h)) == null ? void 0 : u.label
      ] }, h);
...
function Ph({
  ...
  const c = Pm(
    ...
    o && o(f), r && r([f, ...n.filter((b) => b !== f)]), a && n.find((b) => b === f) && a([...n.filter((b) => b !== f)]), p(!1);
  }, u = (f, b) => {
    var g, k, T, C, E, v;
    const m = b !== f ? ((k = (g = t[f]) == null ? void 0 : g.uiNames) == null ? void 0 : k[b]) ?? ((C = (T = t[f]) == null ? void 0 : T.uiNames) == null ? void 0 : C.en) : void 0;
    return m ? `${(E = t[f]) == null ? void 0 : E.autonym} (${m})` : (v = t[f]) == null ? void 0 : v.autonym;
  };
  return /* @__PURE__ */ N("div", { className: y("pr-twp tw-max-w-sm", l), children: [
      ...
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(
            ...
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((f) => /* @__PURE__ */ i(Vt, { value: f, children: u(f, e) }, f))
            }
          )
        ]
      }
    ...
    e !== "en" && /* @__PURE__ */ N(Qt, { children: [
      ...
      /* @__PURE__ */ i("div", { className: "tw-ms-3", children: /* @__PURE__ */ N(Dt, { children: [
        "Currently:",
        " ",
        (n == null ? void 0 : n.length) > 0 ? `${n.map((f) => u(f, e)).join(", ")}` : `default (${t.en.autonym})`
      ] }) })
    ] })
  ] });
}
