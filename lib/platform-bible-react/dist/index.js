...
import { getChaptersForBook as eo, formatScrRef as Jt, NumberFormat as no, formatBytes as ro, deepEqual as Ue, isString as Te, compareScrRefs as Ae, scrRefToBBBCCCVVV as Re, getLocalizeKeyForScrollGroupId as P } from "platform-bible-utils";
...
const uo = Ct(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Ft : "button", { className: d(uo({ variant: e, size: n, className: t })), ref: i, ...a })
);
              ...
              !y && Object.entries(v).map(([N, O]) => {
                if (O.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(Pt, { heading: Mo[N], children: O.map((H) => /* @__PURE__ */ r(
                      "div",
                      {
                        className: d(
...
), X = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Tn.Root, { ref: n, className: d("pr-twp", Ao(), t), ...e }));
...
function Xo({ table: t }) {
  return /* @__PURE__ */ l(Ze, { children: [
    /* @__PURE__ */ r(wo, { asChild: !0, children: /* @__PURE__ */ l(z, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Bt = G.Root, Ho = G.Group, jt = G.Value, Uo = Ct(
  ...
  return /* @__PURE__ */ l(
    G.Trigger,
    {
      className: d(Uo({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
...
function oi({ id: t, markdown: e, className: n, anchorTarget: o }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: d("pr-twp tw-prose", n), children: /* @__PURE__ */ r(lo, { options: a, children: e }) });
}
const ra = Object.freeze([
  "%webView_error_dump_header%",
  "%webView_error_dump_info_message%"
]), vn = (t, e) => t[e] ?? e;
function oa({ errorDetails: t, handleCopyNotify: e, localizedStrings: n }) {
...
function li({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(sa, { versionHistory: a }),
...
const ia = Ct(
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: d("pr-twp", ia({ variant: e }), t), ...n })
);
...
), da = p.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Dn.Root,
  {
    ref: a,
...
da.displayName = Dn.Root.displayName;
...
const Ce = (t) => t === "asc" ? /* @__PURE__ */ r(Hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Ur, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Yr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ci = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, pa = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", gi = Object.freeze([
...
function bi({
  ...
  const c = gt(n, "%webView_inventory_all%"), u = gt(n, "%webView_inventory_approved%"), g = gt(n, "%webView_inventory_unapproved%"), h = gt(n, "%webView_inventory_unknown%"), f = gt(n, "%webView_inventory_scope_currentBook%"), b = gt(n, "%webView_inventory_scope_chapter%"), _ = gt(n, "%webView_inventory_scope_verse%"), k = gt(n, "%webView_inventory_filter_text%"), S = gt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [x, V] = I(!1), [A, W] = I("all"), [nt, it] = I(""), [C, v] = I([]), y = L(() => t.length === 0 ? [] : ua(t, a, i), [t, a, i]), E = L(() => {
    if (x) return y;
    const T = [];
    return y.forEach((q) => {
...
const ha = "16rem", fa = "3rem", Qn = p.createContext(void 0);
function Se() {
...
const ga = p.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Se();
  return /* @__PURE__ */ l(
    z,
    {
...
Na.displayName = "SidebarSeparator";
...
const ka = p.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Ft : "button",
  {
    ref: o,
  ...
  ({
    ...
    const m = t ? Ft : "button", { state: c } = Se(), u = /* @__PURE__ */ r(
      m,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: d(Ca({ variant: n, size: o }), i),
        ...s
      }
    );
...
const _a = p.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Ft : "button",
  {
    ref: a,
...
_a.displayName = "SidebarMenuAction";
const Sa = p.forwardRef(
  ({ className: t, ...e }, n) => /* @__PURE__ */ r(
    "div",
    {
      ref: n,
...
Sa.displayName = "SidebarMenuBadge";
const Ta = p.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Ta.displayName = "SidebarMenuSkeleton";
...
Ra.displayName = "SidebarMenuSub";
const Ea = p.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Ea.displayName = "SidebarMenuSubItem";
const Va = p.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Ft : "a",
  {
    ref: i,
...
Va.displayName = "SidebarMenuSubButton";
function Da({
  id: t,
  extensionLabels: e,
  projectInfo: n,
...
const yt = "scrBook", Ma = "scrRef", Rt = "source", za = "details", Oa = "Scripture Reference", Ia = "Scripture Book", ir = "Type", Aa = "Details";
function Pa(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: yt,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? Oa,
      cell: (o) => {
    ...
    },
    {
      ...
      id: za,
      header: (t == null ? void 0 : t.detailsColumnName) ?? Aa,
      cell: (o) => o.getValue(),
      enableGrouping: !1
    }
  ];
...
}, yn = (t) => `${Ba({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function xi({
  sources: t,
...
function Ri({
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ l(cr, { children: [
      /* @__PURE__ */ r(pr, { children: t.map((s) => /* @__PURE__ */ r(Xa, { value: s.value, children: s.value }, s.key)) }),
...
const Ya = p.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const i = lt();
  return /* @__PURE__ */ l(
    j.CheckboxItem,
    {
...
Ya.displayName = j.CheckboxItem.displayName;
const qa = p.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = lt();
  return /* @__PURE__ */ l(
    j.RadioItem,
    {
...
qa.displayName = j.RadioItem.displayName;
const Ka = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  j.Label,
  {
    ref: o,
    className: d("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
Ka.displayName = j.Label.displayName;
...
function Ja({
  ...
  if (co(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (u, g) => {
    ...
    return /* @__PURE__ */ r(ur, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, g]) => typeof u == "boolean" || typeof g == "boolean" ? 0 : u.order - g.order).map(([u, g]) => /* @__PURE__ */ l(Ha, { children: [
...
function Za({ item: t, createLabel: e, createComplexLabel: n }) {
...
const Qa = Cn(({ className: t, ...e }, n) => /* @__PURE__ */ r(to, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
), es = p.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, role: "alert", className: d(ts({ variant: e }), t), ...n }));
...
os.displayName = Gt.Root.displayName;
...
as.displayName = Gt.Image.displayName;
...
ss.displayName = Gt.Fallback.displayName;
...
const Oi = $.Root, Ii = $.Trigger, Ai = $.Group, Pi = $.Portal, Bi = $.Sub, ji = $.RadioGroup, ms = p.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  $.SubTrigger,
  {
    ref: a,
    className: d(
...
const fs = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  $.Item,
  {
    ref: o,
    className: d(
...
const gs = p.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ l(
  $.CheckboxItem,
  {
    ref: a,
    className: d(
...
const bs = p.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  $.RadioItem,
  {
    ref: o,
    className: d(
...
const vs = p.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  $.Label,
  {
    ref: o,
    className: d(
...
const $i = wt.Trigger, ks = wt.Portal, Fi = wt.Close, kr = p.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  wt.Overlay,
  {
    ref: n,
...
const Cs = p.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
const Es = p.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  Be.Root,
  {
    ref: o,
    className: d(
...
const Li = et.Root, Ms = p.forwardRef(({ className: t, ...e }, n) => {
  const o = Y();
  return /* @__PURE__ */ r(
    et.List,
    {
