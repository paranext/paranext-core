import Js, { jsx as s, jsxs as N, Fragment as ne } from "react/jsx-runtime";
import * as j from "react";
import S, { forwardRef as ar, useCallback as Et, useState as ut, useRef as be, useEffect as se, useLayoutEffect as pa, useMemo as Ct } from "react";
import ve, { clsx as Zs } from "clsx";
...
import { ChevronRight as di, Check as Tn, Circle as pi, X as mo, Search as ui, ChevronsUpDown as wi, FilterIcon as el, ChevronDown as ir, ChevronUp as nl, ArrowLeftIcon as rl, ChevronLeftIcon as ol, ChevronRightIcon as al, ArrowRightIcon as il, CircleCheckIcon as sl, CircleXIcon as ll, CircleHelpIcon as cl, ArrowUpIcon as dl, ArrowDownIcon as pl, ArrowUpDownIcon as ul, Star as wl, PanelLeft as fl, PanelRight as ml, ScrollText as hl, ChevronLeft as gl, LoaderCircle as bl, Download as vl, Filter as yl, User as xl, Link as Nl, CircleHelp as kl } from "lucide-react";
import { getChaptersForBook as El, deepEqual as ho, substring as Sl, formatScrRef as Ar, compareScrRefs as Zr, scrRefToBBBCCCVVV as Dr, getLocalizeKeyForScrollGroupId as pt, NumberFormat as Tl, formatBytes as Cl } from "platform-bible-utils";
...
import { useReactTable as mi, getFilteredRowModel as Ol, getSortedRowModel as hi, getPaginationRowModel as Rl, getCoreRowModel as gi, flexRender as mn, getGroupedRowModel as _l, getExpandedRowModel as Pl } from "@tanstack/react-table";
import * as bt from "@radix-ui/react-select";
import * as Qr from "@radix-ui/react-checkbox";
import * as sr from "@radix-ui/react-toggle-group";
...
import $l, { ThemeContext as Il, internal_processStyles as Ml } from "@mui/styled-engine";
import { MenuItem as Al, ListItemText as Dl, ListItemIcon as yi, Menu as jl, Grid as xi, List as Bl, IconButton as Ni, Drawer as Vl, AppBar as zl, Toolbar as Fl } from "@mui/material";
...
const go = ft.Root, ki = ft.Trigger, ql = ft.Group, jm = ft.Portal, Bm = ft.Sub, Vm = ft.RadioGroup, Wl = S.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: x(
    ...
    children: [
      n,
      /* @__PURE__ */ s(di, { className: "tw-ml-auto tw-h-4 tw-w-4" })
    ]
  }
));
Wl.displayName = ft.SubTrigger.displayName;
const Kl = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.SubContent,
  {
    ref: n,
    className: x(
...
Kl.displayName = ft.SubContent.displayName;
const lr = S.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...r }, o) => {
  const a = xt();
...
lr.displayName = ft.Content.displayName;
const Ei = S.forwardRef(({ className: t, inset: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ s(
    ft.Item,
    {
...
Ei.displayName = ft.Item.displayName;
const bo = S.forwardRef(({ className: t, children: e, checked: n, ...r }, o) => /* @__PURE__ */ N(
  ft.CheckboxItem,
  {
    ref: o,
    className: x(
    ...
    ...r,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ s(ft.ItemIndicator, { children: /* @__PURE__ */ s(Tn, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
bo.displayName = ft.CheckboxItem.displayName;
const Si = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  ft.RadioItem,
  {
    ref: r,
    className: x(
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ s(ft.ItemIndicator, { children: /* @__PURE__ */ s(pi, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      e
    ]
  }
));
Si.displayName = ft.RadioItem.displayName;
const cr = S.forwardRef(({ className: t, inset: e, ...n }, r) => /* @__PURE__ */ s(
  ft.Label,
  {
    ref: r,
...
cr.displayName = ft.Label.displayName;
const dr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  ft.Separator,
  {
    ref: n,
...
dr.displayName = ft.Separator.displayName;
...
Jl.displayName = "DropdownMenuShortcut";
var Zl = Object.defineProperty, Ql = (t, e, n) => e in t ? Zl(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, et = (t, e, n) => Ql(t, typeof e != "symbol" ? e + "" : e, n);
const xe = [
  "GEN",
  "EXO",
  "LEV",
...
function Ze(t, e = !0) {
  return e && (t = t.toUpperCase()), t in ua ? ua[t] : 0;
}
function yo(t) {
  return Ze(t) > 0;
}
...
function Ri(t) {
  return t <= 0 || t > Oi ? "******" : Ti[t - 1];
}
function ic(t) {
  return Ri(Ze(t));
}
function _i(t) {
  const e = typeof t == "number" ? xo(t) : t;
  return yo(e) && !vo.includes(e);
}
function sc(t) {
  const e = typeof t == "number" ? xo(t) : t;
  return yo(e) && vo.includes(e);
...
const No = ot.allBookIds.filter((t) => !ot.isObsolete(ot.bookIdToNumber(t))), uc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, fa = ["OT", "NT", "DC"], wc = 96, fc = [
  /^(\w+)$/i,
...
], an = (t) => El(ot.bookIdToNumber(t));
function mc() {
  return No.map((e) => ot.bookIdToEnglishName(e));
}
function hc(t) {
...
function gc(t) {
  ...
  if (hc(e))
    return No.find((r) => ot.bookIdToEnglishName(r) === e);
}
function Fm({ scrRef: t, handleSubmit: e, getActiveBookIds: n }) {
  const r = xt(), [o, a] = ut(""), [i, l] = ut(
    ...
    fc.forEach(($) => {
      const F = o.match($);
      if (F) {
        const [B, D = void 0, U = void 0] = F.slice(1), nt = gc(B);
    ...
    if (p === i) {
      ...
      c + U <= 0 || c + U > an(p) ? d(0) : U !== 0 && (d(c + U), $.preventDefault());
    }
  };
  return se(() => {
    i === p ? i === ot.bookNumberToId(t.bookNum) ? d(t.chapterNum) : d(1) : d(0);
  }, [p, t.bookNum, t.chapterNum, i]), pa(() => {
    f(w);
  }, [w]), pa(() => {
    const $ = setTimeout(() => {
      if (v && k.current && T.current) {
        const B = T.current.offsetTop - wc;
  ...
  }, [v]), /* @__PURE__ */ s("div", { className: "pr-twp tw-flex", children: /* @__PURE__ */ N(go, { modal: !1, open: w, onOpenChange: I, children: [
    /* @__PURE__ */ s(ki, { asChild: !0, children: /* @__PURE__ */ s(
      Yl,
      {
        ref: m,
        value: o,
    ...
    /* @__PURE__ */ s(
      lr,
      {
        ...
        ref: k,
        children: /* @__PURE__ */ s("div", { className: "rtl:tw-ps-2", children: fa.map(($, F) => {
          const B = C($);
          return B.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ s(cr, { className: "tw-font-semibold tw-text-foreground/80", children: uc[$] }),
            ...
            fa.length - 1 !== F ? /* @__PURE__ */ s(dr, {}) : void 0
          ] }, $);
        }) })
      }
    )
...
const bc = We(
  ...
  ({ className: t, variant: e, size: n, asChild: r = !1, ...o }, a) => /* @__PURE__ */ s(r ? qe : "button", { className: x(bc({ variant: e, size: n, className: t })), ref: a, ...o })
);
wt.displayName = "Button";
const vc = We(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), At = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(fi.Root, { ref: n, className: x("pr-twp", vc(), t), ...e }));
At.displayName = fi.Root.displayName;
const $i = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    vn.Root,
    {
...
$i.displayName = vn.Root.displayName;
const eo = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  vn.Item,
  {
    ref: n,
    className: x(
    ...
    ...e,
    children: /* @__PURE__ */ s(vn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ s(pi, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
eo.displayName = vn.Item.displayName;
const Ii = yn.Root, Mi = yn.Trigger, ko = S.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...r }, o) => {
  const a = xt();
  return /* @__PURE__ */ s(yn.Portal, { children: /* @__PURE__ */ s(
    yn.Content,
    {
      ref: o,
      align: e,
...
ko.displayName = yn.Content.displayName;
const yc = qt.Portal, Ai = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  qt.Overlay,
  {
    ref: n,
    className: x(
...
Ai.displayName = qt.Overlay.displayName;
const xc = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  const o = xt();
  return /* @__PURE__ */ N(yc, { children: [
    /* @__PURE__ */ s(Ai, {}),
    /* @__PURE__ */ N(
      qt.Content,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ N(
            qt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ s(mo, { className: "tw-h-4 tw-w-4" }),
...
xc.displayName = qt.Content.displayName;
...
Nc.displayName = qt.Title.displayName;
...
kc.displayName = qt.Description.displayName;
const Eo = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  _t,
  {
    ref: n,
...
Eo.displayName = _t.displayName;
const So = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ s(ui, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ s(
      _t.Input,
      {
        ref: n,
...
So.displayName = _t.Input.displayName;
...
const Co = S.forwardRef((t, e) => /* @__PURE__ */ s(_t.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Co.displayName = _t.Empty.displayName;
...
Di.displayName = _t.Group.displayName;
...
Oo.displayName = _t.Item.displayName;
function Sc(t) {
...
function no({
  ...
  const [m, k] = ut(!1);
  return /* @__PURE__ */ N(Ii, { open: m, onOpenChange: k, ...f, children: [
    /* @__PURE__ */ s(Mi, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: w,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ s(wi, { className: "tw-ms-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(
      ko,
      {
        ...
        children: /* @__PURE__ */ N(Eo, { children: [
          /* @__PURE__ */ s(So, { placeholder: p, className: "tw-text-inherit" }),
          /* @__PURE__ */ s(Co, { children: h }),
          /* @__PURE__ */ s(To, { children: e.map((T) => /* @__PURE__ */ N(
            Oo,
            {
              value: l(T),
              onSelect: () => {
...
function Gm({
  ...
  const p = jr(d, "%webView_bookSelector_currentBook%"), h = jr(d, "%webView_bookSelector_choose%"), w = jr(d, "%webView_bookSelector_chooseBooks%"), [g, v] = ut(
    "current book"
    /* CURRENT_BOOK */
  ), f = (m) => {
    v(m), t(m);
...
function Oc({ table: t }) {
  return /* @__PURE__ */ N(go, { children: [
    /* @__PURE__ */ s(tl, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ s(el, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ N(lr, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ s(cr, { children: "Toggle columns" }),
      /* @__PURE__ */ s(dr, {}),
...
const Ve = bt.Root, Rc = bt.Group, ze = bt.Value, Ne = S.forwardRef(({ className: t, children: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    bt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ s(bt.Icon, { asChild: !0, children: /* @__PURE__ */ s(ir, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
...
const ji = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  bt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ s(nl, { className: "tw-h-4 tw-w-4" })
  }
));
ji.displayName = bt.ScrollUpButton.displayName;
const Bi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  bt.ScrollDownButton,
  {
    ...
    className: x("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", t),
    ...e,
    children: /* @__PURE__ */ s(ir, { className: "tw-h-4 tw-w-4" })
  }
));
Bi.displayName = bt.ScrollDownButton.displayName;
const ke = S.forwardRef(({ className: t, children: e, position: n = "popper", ...r }, o) => {
  const a = xt();
  return /* @__PURE__ */ s(bt.Portal, { children: /* @__PURE__ */ N(
    bt.Content,
    {
      ref: o,
      className: x(
...
const Bt = S.forwardRef(({ className: t, children: e, ...n }, r) => /* @__PURE__ */ N(
  bt.Item,
  {
    ref: r,
    className: x(
    ...
    ...n,
    children: [
      /* @__PURE__ */ s("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ s(bt.ItemIndicator, { children: /* @__PURE__ */ s(Tn, { className: "tw-h-4 tw-w-4" }) }) }),
...
const pr = S.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s("div", { className: x("pr-twp tw-relative tw-w-full", { "tw-overflow-auto": !e }), children: /* @__PURE__ */ s(
  "table",
  {
    ref: r,
...
const ur = S.forwardRef(({ className: t, stickyHeader: e, ...n }, r) => /* @__PURE__ */ s(
  "thead",
  {
    ref: r,
    className: x(
...
const wr = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("tbody", { ref: n, className: x("[&_tr:last-child]:tw-border-0", t), ...e }));
...
const xn = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  "th",
  {
    ref: n,
    className: x(
...
function Ac({
  ...
  var m;
  const [l, c] = ut([]), [d, p] = ut([]), [h, w] = ut({}), [g, v] = ut({}), f = mi({
    data: e,
    columns: t,
    getCoreRowModel: gi(),
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ s(Oc, { table: f }),
    /* @__PURE__ */ N(pr, { stickyHeader: a, children: [
      /* @__PURE__ */ s(ur, { stickyHeader: a, children: f.getHeaderGroups().map((k) => /* @__PURE__ */ s(ie, { children: k.headers.map((T) => /* @__PURE__ */ s(xn, { children: T.isPlaceholder ? void 0 : mn(T.column.columnDef.header, T.getContext()) }, T.id)) }, k.id)) }),
      /* @__PURE__ */ s(wr, { children: (m = f.getRowModel().rows) != null && m.length ? f.getRowModel().rows.map((k) => /* @__PURE__ */ s(
        ie,
        {
          onClick: () => i(k, f),
          "data-state": k.getIsSelected() && "selected",
          children: k.getVisibleCells().map((T) => /* @__PURE__ */ s(Fe, { children: mn(T.column.columnDef.cell, T.getContext()) }, T.id))
        },
        k.id
...
function Dc({
  ...
  const r = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], a = Ct(() => {
    const i = [];
    return t.forEach((l) => {
      i.some((c) => ho(c, l)) || i.push(l);
    }), i;
  }, [t]);
  return /* @__PURE__ */ N(pr, { stickyHeader: !0, children: [
    /* @__PURE__ */ s(ur, { stickyHeader: !0, children: /* @__PURE__ */ N(ie, { children: [
      /* @__PURE__ */ s(xn, { children: r }),
      /* @__PURE__ */ s(xn, { children: o })
    ] }) }),
    /* @__PURE__ */ s(wr, { children: a.length > 0 && a.map((i) => /* @__PURE__ */ N(
      ie,
      {
        onClick: () => {
          e(i.reference);
...
const Ro = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Qr.Root,
  {
    ref: n,
    className: x(
    ...
    children: /* @__PURE__ */ s(
      Qr.Indicator,
      {
        ...
        children: /* @__PURE__ */ s(Tn, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
...
const jc = (t) => t.split(/(?:\r?\n|\r)|(?=(?:\\(?:v|c|id)))/g), ma = (t) => {
...
}, Vc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Vi = We(
  ...
  {
    ref: o,
    className: x(Vi({ variant: e, size: n, className: t })),
    ...r
  }
));
zc.displayName = bi.Root.displayName;
const zi = S.createContext({
  size: "default",
  variant: "default"
}), Fi = S.forwardRef(({ className: t, variant: e, size: n, children: r, ...o }, a) => {
  const i = xt();
  return /* @__PURE__ */ s(
    sr.Root,
    {
...
Fi.displayName = sr.Root.displayName;
const Hn = S.forwardRef(({ className: t, children: e, variant: n, size: r, ...o }, a) => {
  const i = S.useContext(zi);
  return /* @__PURE__ */ s(
    sr.Item,
    {
      ref: a,
...
Hn.displayName = sr.Item.displayName;
const fr = (t) => t === "asc" ? /* @__PURE__ */ s(dl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ s(pl, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ s(ul, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Um = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: a }) => {
    ...
    return /* @__PURE__ */ N(Fi, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ s(
        Hn,
        {
          onClick: () => Br(
  ...
  return jc(t).forEach((p) => {
    p.startsWith("\\id") && (i = Bc(p), l = 0, c = 0), p.startsWith("\\c") && (l = ma(p), c = 0), p.startsWith("\\v") && (c = ma(p), l === 0 && (l = e.chapterNum));
    let h = o.exec(p) ?? void 0;
    for (; h; ) {
      const w = [];
      h.forEach((m) => w.push(m));
      const g = h.index, v = a.find((m) => ho(m.items, w)), f = {
        reference: {
          bookNum: i !== void 0 ? i : -1,
          chapterNum: l !== void 0 ? l : -1,
          verseNum: c !== void 0 ? c : -1
        },
        text: Sl(p, Math.max(0, g - 25), Math.min(g + 25, p.length))
      };
      if (v)
...
function qm({
  ...
  const h = Zt(n, "%webView_inventory_all%"), w = Zt(n, "%webView_inventory_approved%"), g = Zt(n, "%webView_inventory_unapproved%"), v = Zt(n, "%webView_inventory_unknown%"), f = Zt(n, "%webView_inventory_scope_currentBook%"), m = Zt(n, "%webView_inventory_scope_chapter%"), k = Zt(n, "%webView_inventory_scope_verse%"), T = Zt(n, "%webView_inventory_filter_text%"), C = Zt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [E, b] = ut(!1), [I, V] = ut("all"), [R, P] = ut(""), [G, A] = ut([]), Q = Ct(() => l ? r instanceof RegExp ? Gc(
    l,
    t,
    a,
    i,
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ N("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ N(Ve, { onValueChange: (y) => U(y), defaultValue: c, children: [
...
function Uc({
  ...
  return /* @__PURE__ */ s("div", { className: d, children: /* @__PURE__ */ N(Ii, { open: p, onOpenChange: h, children: [
    /* @__PURE__ */ s(Mi, { asChild: !0, children: /* @__PURE__ */ N(
      wt,
      {
        variant: "ghost",
        ...
        children: [
          ...
          /* @__PURE__ */ s(wi, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ s(ko, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ N(Eo, { children: [
      /* @__PURE__ */ s(So, { placeholder: `Search ${o.toLowerCase()}...` }),
      /* @__PURE__ */ N(To, { children: [
        /* @__PURE__ */ s(Co, { children: a }),
        /* @__PURE__ */ s(Di, { children: v.map((f) => {
          ...
          return /* @__PURE__ */ N(
            Oo,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ s("div", { className: "tw-w-4", children: f.starred && /* @__PURE__ */ s(wl, { className: "tw-h-4 tw-w-4" }) }),
...
function Li({
  ...
  const a = xt();
  return /* @__PURE__ */ N("div", { className: x("tw-relative", { "tw-w-full": r }, o), children: [
    /* @__PURE__ */ s(
      ui,
      {
        className: x(
...
const Gi = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Pt.Root,
    {
...
const Ui = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.List,
  {
    ref: n,
    className: x(
...
Ui.displayName = Pt.List.displayName;
...
)), Xi = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Content,
  {
    ref: n,
    className: x(
...
Xi.displayName = Pt.Content.displayName;
function Wm({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ N(Gi, { children: [
      /* @__PURE__ */ s(Ui, { children: t.map((i) => /* @__PURE__ */ s(Xc, { value: i.value, children: i.value }, i.key)) }),
      t.map((i) => /* @__PURE__ */ s(Xi, { value: i.value, children: i.content }, i.key))
    ] })
  ] });
}
const _o = S.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...r }, o) => /* @__PURE__ */ s(
  vi.Root,
  {
    ref: o,
    decorative: n,
...
_o.displayName = vi.Root.displayName;
...
const Yc = Cn.Provider, Hc = Cn.Root, qc = Cn.Trigger, Yi = S.forwardRef(({ className: t, sideOffset: e = 4, ...n }, r) => /* @__PURE__ */ s(
  Cn.Content,
  {
    ref: r,
    sideOffset: e,
...
Yi.displayName = Cn.Content.displayName;
const Wc = "16rem", Kc = "3rem", Hi = S.createContext(void 0);
function mr() {
...
const qi = S.forwardRef(
  ({
    ...
    return /* @__PURE__ */ s(Hi.Provider, { value: T, children: /* @__PURE__ */ s(Yc, { delayDuration: 0, children: /* @__PURE__ */ s(
      "div",
      {
        style: (
...
qi.displayName = "SidebarProvider";
const Wi = S.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: r, ...o }, a) => {
  const i = mr();
...
const Jc = S.forwardRef(({ className: t, onClick: e, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    wt,
    {
      ...
      ...n,
      children: [
        o.side === "primary" ? /* @__PURE__ */ s(fl, {}) : /* @__PURE__ */ s(ml, {}),
...
ro.displayName = "SidebarGroup";
const oo = S.forwardRef(({ className: t, asChild: e = !1, ...n }, r) => /* @__PURE__ */ s(
  e ? qe : "div",
  {
    ref: r,
...
oo.displayName = "SidebarGroupLabel";
...
ao.displayName = "SidebarGroupContent";
...
const od = We(
  ...
  ({
    ...
    const c = t ? qe : "button", { state: d } = mr(), p = /* @__PURE__ */ s(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": e,
        className: x(od({ variant: n, size: r }), a),
        ...i
      }
    );
    return o ? (typeof o == "string" && (o = {
      children: o
    }), /* @__PURE__ */ N(Hc, { children: [
      /* @__PURE__ */ s(qc, { asChild: !0, children: p }),
      /* @__PURE__ */ s(Yi, { side: "right", align: "center", hidden: d !== "collapsed", ...o })
    ] })) : p;
  }
);
ts.displayName = "SidebarMenuButton";
...
const sd = S.forwardRef(({ className: t, showIcon: e = !1, ...n }, r) => {
  ...
  return /* @__PURE__ */ N(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ s(ha, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ s(
          ha,
          {
...
function pd({
  ...
  return /* @__PURE__ */ s(
    Wi,
    {
      ...
      children: /* @__PURE__ */ N(Ji, { children: [
        /* @__PURE__ */ N(ro, { children: [
          /* @__PURE__ */ s(oo, { className: "tw-text-sm tw-text-gray-400", children: a }),
          /* @__PURE__ */ s(ao, { children: /* @__PURE__ */ s(Zi, { children: Object.entries(e).map(([w, g]) => /* @__PURE__ */ s(Qi, { children: /* @__PURE__ */ s(
            ts,
            {
              className: x(
        ...
        /* @__PURE__ */ N(ro, { children: [
          /* @__PURE__ */ s(oo, { className: "tw-text-sm tw-text-gray-400", children: i }),
          /* @__PURE__ */ s(ao, { className: "tw-pl-3", children: /* @__PURE__ */ s(
            no,
            {
    ...
    /* @__PURE__ */ N(
      qi,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(Ki, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const oe = "scrBook", ud = "scrRef", fe = "source", wd = "details", fd = "Scripture Reference", md = "Scripture Book", es = "Type", hd = "Details";
function gd(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (r) => {
        ...
        return r.row.getIsGrouped() ? ot.bookNumberToEnglishName(o.start.bookNum) : r.row.groupingColumnId === oe ? Ar(o.start) : void 0;
      },
...
}, ga = (t) => `${bd({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Jm({
  sources: t,
  ...
  se(() => {
    if (l) {
      ...
      if (P.length === 1) {
        const G = v.find((A) => ga(A) === P[0]) || void 0;
        G && l(G);
      }
    }
  }, [w, v, l, m]);
  const k = o ?? md, T = a ?? es, C = [
  ...
  }, I = (R, P) => R.getIsGrouped() ? "" : x("banded-row", P % 2 === 0 ? "even" : "odd"), V = (R, P, G) => {
  ...
  return /* @__PURE__ */ N("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    ...
    /* @__PURE__ */ N(pr, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ s(ur, { children: m.getHeaderGroups().map((R) => /* @__PURE__ */ s(ie, { children: R.headers.filter((P) => P.column.columnDef.header).map((P) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ s(xn, { colSpan: P.colSpan, className: "top-0 tw-sticky", children: P.isPlaceholder ? void 0 : /* @__PURE__ */ N("div", { children: [
      ...
      /* @__PURE__ */ s(wr, { children: m.getRowModel().rows.map((R, P) => {
        const G = xt();
        return /* @__PURE__ */ s(
          ie,
          {
              ...
              if (!(A.getIsPlaceholder() || A.column.columnDef.enableGrouping && !A.getIsGrouped() && (A.column.columnDef.id !== fe || !n)))
                return /* @__PURE__ */ s(
                  Fe,
                  {
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ N(
                      wt,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          R.getIsExpanded() && /* @__PURE__ */ s(ir, {}),
                          !R.getIsExpanded() && (G === "ltr" ? /* @__PURE__ */ s(di, {}) : /* @__PURE__ */ s(gl, {})),
                          " ",
                          mn(A.column.columnDef.cell, A.getContext()),
                          " (",
                          R.subRows.length,
                          ")"
                        ]
...
function Qt(t, e, n = {
  ...
  return ge(t) && ge(e) && Object.keys(e).forEach((o) => {
    o !== "__proto__" && (ge(e[o]) && o in t && ge(t[o]) ? r[o] = Qt(t[o], e[o], n) : n.clone ? r[o] = ge(e[o]) ? rs(e[o]) : e[o] : r[o] = e[o]);
  }), r;
}
var zn = { exports: {} }, Fn = { exports: {} }, it = {};
...
var xa;
function os() {
  return xa || (xa = 1, process.env.NODE_ENV === "production" ? Fn.exports = xd() : Fn.exports = Nd()), Fn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ed() {
  ...
  if (process.env.NODE_ENV !== "production") {
    var e = /* @__PURE__ */ $o(), n = {}, r = /* @__PURE__ */ as();
    t = function(a) {
      var i = "Warning: " + a;
...
function Sd() {
  if (Ta) return Yr;
  Ta = 1;
  var t = os(), e = kd(), n = /* @__PURE__ */ $o(), r = /* @__PURE__ */ as(), o = /* @__PURE__ */ Ed(), a = function() {
  };
...
var Oa;
function Cd() {
  if (Oa) return zn.exports;
  if (Oa = 1, process.env.NODE_ENV !== "production") {
    var t = os(), e = !0;
    zn.exports = /* @__PURE__ */ Sd()(t.isElement, e);
  } else
    zn.exports = /* @__PURE__ */ Td()();
  return zn.exports;
}
var Od = /* @__PURE__ */ Cd();
const u = /* @__PURE__ */ ns(Od);
function Rd(t) {
  const {
    prototype: e = {}
  } = t;
...
function is(t, e, n, r, o) {
  ...
  let l;
  const c = a.type;
  return typeof c == "function" && !Rd(c) && (l = "Did you accidentally use a plain function component for an element instead?"), l !== void 0 ? new Error(`Invalid ${r} \`${i}\` supplied to \`${n}\`. Expected an element that can hold a ref. ${l} For more information see https://mui.com/r/caveat-with-refs-guide`) : null;
}
const Io = Po(u.element, is);
Io.isRequired = Po(u.element.isRequired, is);
const _d = "exact-prop: ​";
function Pd(t) {
...
var Pa;
function Md() {
  return Pa || (Pa = 1, process.env.NODE_ENV === "production" ? Ln.exports = $d() : Ln.exports = Id()), Ln.exports;
}
var $a = Md();
...
function ss(t, e = "") {
  return t.displayName || t.name || Dd(t) || e;
}
function Ia(t, e, n) {
  const r = ss(e);
...
const ls = u.oneOfType([u.func, u.object]);
function Wt(t) {
  if (typeof t != "string")
...
function Ld(t) {
  return Jn(t).defaultView || window;
}
function Gd(t, e) {
  if (process.env.NODE_ENV === "production")
    return () => null;
...
function Yd(t, e) {
  const n = j.useRef(Da);
  return n.current === Da && (n.current = t(e)), n;
}
const Hd = [];
function qd(t) {
  j.useEffect(t, Hd);
...
function Jd(t) {
  ...
  return !!(n === "INPUT" && Kd[e] && !t.readOnly || n === "TEXTAREA" && !t.readOnly || t.isContentEditable);
}
function Zd(t) {
...
function tp(t) {
  t.addEventListener("keydown", Zd, !0), t.addEventListener("mousedown", qr, !0), t.addEventListener("pointerdown", qr, !0), t.addEventListener("touchstart", qr, !0), t.addEventListener("visibilitychange", Qd, !0);
}
function ep(t) {
  const {
    target: e
...
function ps() {
  ...
  function n() {
    return e.current ? (so = !0, Wd.start(100, () => {
      so = !1;
    }), e.current = !1, !0) : !1;
  }
  function r(o) {
...
const op = ["values", "unit", "step"], ap = (t) => {
...
function ip(t) {
  const {
    ...
    unit: n = "px",
    step: r = 5
  } = t, o = kt(t, op), a = ap(e), i = Object.keys(a);
  function l(w) {
...
function vt(t) {
  const {
    ...
    if (i[e] == null)
      return null;
    const l = i[e], c = i.theme, d = br(c, r) || {};
    return te(i, l, (h) => {
      let w = Qn(d, o, h);
      return h === w && typeof h == "string" && (w = Qn(d, o, `${e}${h === "default" ? "" : Wt(h)}`, h)), n === !1 ? w : {
        [n]: w
      };
    });
  };
...
const pp = {
  ...
  if (t.length > 2)
    if (Va[t])
      ...
      return [t];
  const [e, n] = t.split(""), r = pp[e], o = up[n] || "";
  return Array.isArray(o) ? o.map((a) => r + a) : [r + o];
}), vr = ["m", "mt", "mr", "mb", "ml", "mx", "my", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginX", "marginY", "marginInline", "marginInlineStart", "marginInlineEnd", "marginBlock", "marginBlockStart", "marginBlockEnd"], yr = ["p", "pt", "pr", "pb", "pl", "px", "py", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingX", "paddingY", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "paddingBlock", "paddingBlockStart", "paddingBlockEnd"], fp = [...vr, ...yr];
function Rn(t, e, n, r) {
  var o;
...
function hp(t, e, n, r) {
  if (e.indexOf(n) === -1)
    return null;
  const o = wp(n), a = mp(o, r), i = t[n];
  return te(t, i, a);
}
function gs(t, e) {
  const n = hs(t.theme);
  return Object.keys(t).map((r) => hp(t, e, r, n)).reduce(hn, {});
}
function ht(t) {
  return gs(t, vr);
}
ht.propTypes = process.env.NODE_ENV !== "production" ? vr.reduce((t, e) => (t[e] = le, t), {}) : {};
ht.filterProps = vr;
function gt(t) {
  return gs(t, yr);
}
gt.propTypes = process.env.NODE_ENV !== "production" ? yr.reduce((t, e) => (t[e] = le, t), {}) : {};
gt.filterProps = yr;
process.env.NODE_ENV !== "production" && fp.reduce((t, e) => (t[e] = le, t), {});
function gp(t = 8) {
  if (t.mui)
    return t;
  const e = hs({
...
const bp = Gt("border", Vt), vp = Gt("borderTop", Vt), yp = Gt("borderRight", Vt), xp = Gt("borderBottom", Vt), Np = Gt("borderLeft", Vt), kp = Gt("borderColor"), Ep = Gt("borderTopColor"), Sp = Gt("borderRightColor"), Tp = Gt("borderBottomColor"), Cp = Gt("borderLeftColor"), Op = Gt("outline", Vt), Rp = Gt("outlineColor"), Nr = (t) => {
...
xr(bp, vp, yp, xp, Np, kp, Ep, Sp, Tp, Cp, Nr, Op, Rp);
const kr = (t) => {
...
xr(kr, Er, Sr, _p, Pp, $p, Ip, Mp, Ap, Dp, jp, Bp);
function Be(t, e) {
  return e === "grey" ? e : t;
}
const Vp = vt({
...
function Kp() {
  ...
  function e(n) {
    ...
    function l(c) {
      ...
      if (!d)
        return null;
      const p = lp(a.breakpoints), h = Object.keys(p);
      let w = p;
...
function Bo(t = {}, ...e) {
  ...
  return d.applyStyles = Jp, d = e.reduce((p, h) => Qt(p, h), d), d.unstable_sxConfig = _({}, jo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return Tr({
      sx: h,
      theme: this
    });
...
const eu = ["ownerState"], nu = ["variants"], ru = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function ou(t) {
  return Object.keys(t).length === 0;
}
function au(t) {
...
const iu = Bo(), za = (t) => t && t.charAt(0).toLowerCase() + t.slice(1);
function Gn({
  defaultTheme: t,
  theme: e,
  themeId: n
...
function lu(t = {}) {
  ...
  return a.__mui_systemSx = !0, (i, l = {}) => {
    Ml(i, (b) => b.filter((I) => !(I != null && I.__mui_systemSx)));
    const {
      name: c,
      slot: d,
      ...
      overridesResolver: w = su(za(d))
    } = l, g = kt(l, ru), v = p !== void 0 ? p : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      d && d !== "Root" && d !== "root" || !1
    ), f = h || !1;
    let m;
    process.env.NODE_ENV !== "production" && c && (m = `${c}-${za(d || "Root")}`);
    let k = qn;
    d === "Root" || d === "root" ? k = r : d ? k = o : au(i) && (k = void 0);
    const T = $l(i, _({
      shouldForwardProp: k,
      label: m
    }, g)), C = (b) => typeof b == "function" && b.__emotion_real !== b || ge(b) ? (I) => Wn(b, _({}, I, {
      theme: Gn({
        theme: I.theme,
        defaultTheme: n,
        themeId: e
      ...
      if (process.env.NODE_ENV !== "production") {
        let A;
        c && (A = `${c}${Wt(d || "")}`), A === void 0 && (A = `Styled(${jd(i)})`), G.displayName = A;
      }
...
function Fa(t) {
  t = Se(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Se(uu(t)).values : t.values;
...
function ys(t, e) {
  return t = Se(t), e = Vo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Cr(t);
}
function wu(t, e) {
...
const kn = {
  ...
  800: "#2e7d32",
  900: "#1b5e20"
}, gu = ["mode", "contrastThreshold", "tonalOffset"], Ga = {
...
function Ua(t, e, n, r) {
  ...
  t[e] || (t.hasOwnProperty(n) ? t[e] = t[n] : e === "light" ? t.light = fu(t.main, o) : e === "dark" && (t.dark = wu(t.main, a)));
}
function bu(t = "light") {
  return t === "dark" ? {
    main: Ie[200],
...
function Eu(t) {
  const {
    ...
    tonalOffset: r = 0.2
  } = t, o = kt(t, gu), a = t.primary || bu(e), i = t.secondary || vu(e), l = t.error || yu(e), c = t.info || xu(e), d = t.success || Nu(e), p = t.warning || ku(e);
  function h(f) {
    const m = La(f, Wr.text.primary) >= n ? Wr.text.primary : Ga.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const k = La(f, m);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ua(f, "light", T, r), Ua(f, "dark", C, r), f.contrastText || (f.contrastText = h(f.main)), f;
  }, g = {
    dark: Wr,
    light: Ga
  };
...
function Cu(t, e) {
  ...
  const g = o / 14, v = h || ((k) => `${k / d * g}rem`), f = (k, T, C, E, b) => _({
    ...
    button: f(l, 14, 1.75, 0.4, Xa),
    caption: f(i, 12, 1.66, 0.4),
    overline: f(i, 12, 2.66, 1, Xa),
...
const Ou = 0.2, Ru = 0.14, _u = 0.12;
function mt(...t) {
  return [`${t[0]}px ${t[1]}px ${t[2]}px ${t[3]}px rgba(0,0,0,${Ou})`, `${t[4]}px ${t[5]}px ${t[6]}px ${t[7]}px rgba(0,0,0,${Ru})`, `${t[8]}px ${t[9]}px ${t[10]}px ${t[11]}px rgba(0,0,0,${_u})`].join(",");
}
const Pu = ["none", mt(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), mt(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), mt(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), mt(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), mt(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), mt(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), mt(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), mt(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), mt(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), mt(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), mt(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), mt(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), mt(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), mt(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), mt(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), mt(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), mt(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), mt(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), mt(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), mt(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), mt(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), mt(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), mt(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), mt(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], $u = ["duration", "easing", "delay"], Iu = {
...
function Du(t) {
  const e = _({}, Iu, t.easing), n = _({}, Mu, t.duration);
  return _({
...
`)), Object.keys(d).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(d).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((p) => `${p} ${typeof i == "string" ? i : Ha(i)} ${l} ${typeof c == "string" ? c : Ha(c)}`).join(",");
    }
  }, t, {
    easing: e,
    duration: n
...
`));
  ...
  return d.unstable_sxConfig = _({}, jo, i == null ? void 0 : i.unstable_sxConfig), d.unstable_sx = function(h) {
    return Tr({
      sx: h,
      theme: this
    });
...
const zu = (t) => qn(t) && t !== "classes", Pn = lu({
  themeId: Fo,
  defaultTheme: zo,
...
const Lu = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Gu = (t) => {
  const {
    color: e,
    fontSize: n,
    classes: r
...
}), tr = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const r = Lo({
    props: e,
    name: "MuiSvgIcon"
  }), {
    ...
    titleAccess: h,
    viewBox: w = "0 0 24 24"
  } = r, g = kt(r, Lu), v = /* @__PURE__ */ j.isValidElement(o) && o.type === "svg", f = _({}, r, {
    color: i,
    component: l,
    fontSize: c,
...
function xs(t, e) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${e}Icon`), n.muiName = tr.muiName, /* @__PURE__ */ j.memo(/* @__PURE__ */ j.forwardRef(n));
}
const Xu = {
  configure: (t) => {
...
`)), ws.configure(t);
  ...
  ownerDocument: Jn,
  ownerWindow: Ld,
  requirePropFactory: Gd,
  setRef: Zn,
  unstable_ClassNameGenerator: Xu,
...
}, Symbol.toStringTag, { value: "Module" })), Hu = /* @__PURE__ */ vd(Yu);
var qa;
function qu() {
...
function Wu() {
  ...
  var e = t(/* @__PURE__ */ qu()), n = Js;
  return sn.default = (0, e.default)(/* @__PURE__ */ (0, n.jsx)("path", {
    d: "m10 17 5-5-5-5z"
  }), "ArrowRight"), sn;
}
var Ku = /* @__PURE__ */ Wu();
const Ju = /* @__PURE__ */ ns(Ku);
function Zu(t) {
  return typeof t == "string";
}
function wn(t, e, n) {
  return t === void 0 || Zu(t) ? e : _({}, e, {
    ownerState: _({}, e.ownerState, n)
  });
}
const Qu = {
  disableDefaultClasses: !1
}, tw = /* @__PURE__ */ j.createContext(Qu);
function ew(t) {
  const {
...
function ow(t) {
  ...
  const i = nw(_({}, o, r)), l = Ka(r), c = Ka(o), d = e(i), p = ve(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), h = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
function cw(t, e) {
  const n = fs[e];
  return n ? sw(n) : lw(t, e);
}
function dw(t) {
  return typeof t == "function" ? t() : t;
}
const er = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    children: r,
    container: o,
    disablePortal: a = !1
...
process.env.NODE_ENV !== "production" && (er.propTypes = {
   ...
   */
  container: u.oneOfType([Nn, u.func]),
  /**
...
process.env.NODE_ENV !== "production" && (er.propTypes = Pd(er.propTypes));
var Ot = "top", Ft = "bottom", Lt = "right", Rt = "left", Go = "auto", $n = [Ot, Ft, Lt, Rt], Ue = "start", En = "end", pw = "clippingParents", ks = "viewport", cn = "popper", uw = "reference", Ja = /* @__PURE__ */ $n.reduce(function(t, e) {
  return t.concat([e + "-" + Ue, e + "-" + En]);
}, []), Es = /* @__PURE__ */ [].concat($n, [Go]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Ue, e + "-" + En]);
}, []), ww = "beforeRead", fw = "read", mw = "afterRead", hw = "beforeMain", gw = "main", bw = "afterMain", vw = "beforeWrite", yw = "write", xw = "afterWrite", Nw = [ww, fw, mw, hw, gw, bw, vw, yw, xw];
function Kt(t) {
...
var ye = Math.max, nr = Math.min, Xe = Math.round;
function lo() {
...
function Ye(t, e, n) {
  ...
  var i = Te(t) ? Dt(t) : window, l = i.visualViewport, c = !Ss() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, h = r.width / o, w = r.height / a;
  return {
    width: h,
    height: w,
    top: p,
...
function Cw(t) {
  ...
  var o = Or(t);
  for (Uo(o) && (o = o.host); zt(o) && ["html", "body"].indexOf(Kt(o)) < 0; ) {
    var a = ee(o);
...
function In(t) {
  for (var e = Dt(t), n = Za(t); n && Tw(n) && ee(n).position === "static"; )
    n = Za(n);
  return n && (Kt(n) === "html" || Kt(n) === "body" && ee(n).position === "static") ? e : n || Cw(t) || e;
}
function Yo(t) {
...
var Rw = function(e, n) {
  ...
  })) : e, Os(typeof e != "number" ? e : Rs(e, $n));
};
function _w(t) {
  var e, n = t.state, r = t.name, o = t.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, l = Ht(n.placement), c = Yo(l), d = [Rt, Lt].indexOf(l) >= 0, p = d ? "height" : "width";
  if (!(!a || !i)) {
    var h = Rw(o.padding, n), w = Xo(a), g = c === "y" ? Ot : Rt, v = c === "y" ? Ft : Lt, f = n.rects.reference[p] + n.rects.reference[c] - i[c] - n.rects.popper[p], m = i[c] - n.rects.reference[c], k = In(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = f / 2 - m / 2, E = h[g], b = T - w[p] - h[v], I = T / 2 - w[p] / 2 + C, V = gn(E, I, b), R = c;
    n.modifiersData[r] = (e = {}, e[R] = V, e.centerOffset = V - I, e);
  }
}
function Pw(t) {
  var e = t.state, n = t.options, r = n.element, o = r === void 0 ? "[data-popper-arrow]" : r;
  o != null && (typeof o == "string" && (o = e.elements.popper.querySelector(o), !o) || Ts(e.elements.popper, o) && (e.elements.arrow = o));
}
const $w = {
  name: "arrow",
  enabled: !0,
...
function Qa(t) {
  ...
  if (d) {
    var I = In(n), V = "clientHeight", R = "clientWidth";
    if (I === Dt(n) && (I = ce(n), ee(I).position !== "static" && l === "absolute" && (V = "scrollHeight", R = "scrollWidth")), I = I, o === Ot || (o === Rt || o === Lt) && a === En) {
      E = Ft;
...
function Aw(t) {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Qa(Object.assign({}, d, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: i,
    roundOffsets: c
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Qa(Object.assign({}, d, {
...
function jw(t) {
  ...
  }), l && c.addEventListener("resize", n.update, Un), function() {
    a && d.forEach(function(p) {
      p.removeEventListener("scroll", n.update, Un);
    }), l && c.removeEventListener("resize", n.update, Un);
  };
}
const Bw = {
  name: "eventListeners",
...
function qo(t) {
  return Ye(ce(t)).left + Ho(t).scrollLeft;
}
function Fw(t, e) {
...
function Lw(t) {
  var e, n = ce(t), r = Ho(t), o = (e = t.ownerDocument) == null ? void 0 : e.body, a = ye(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = ye(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), l = -r.scrollLeft + qo(t), c = -r.scrollTop;
...
function _s(t) {
  return ["html", "body", "#document"].indexOf(Kt(t)) >= 0 ? t.ownerDocument.body : zt(t) && Wo(t) ? t : _s(Or(t));
}
function bn(t, e) {
  var n;
  e === void 0 && (e = []);
  var r = _s(t), o = r === ((n = t.ownerDocument) == null ? void 0 : n.body), a = Dt(r), i = o ? [a].concat(a.visualViewport || [], Wo(r) ? r : []) : r, l = e.concat(i);
  return o ? l : (
...
function ei(t, e, n) {
  return e === ks ? co(Fw(t, n)) : Te(e) ? Gw(e, n) : co(Lw(ce(t)));
}
function Uw(t) {
  var e = bn(Or(t)), n = ["absolute", "fixed"].indexOf(ee(t).position) >= 0, r = n && zt(t) ? In(t) : t;
  return Te(r) ? e.filter(function(o) {
    return Te(o) && Ts(o, r) && Kt(o) !== "body";
  }) : [];
}
function Xw(t, e, n, r) {
  var o = e === "clippingParents" ? Uw(t) : [].concat(e), a = [].concat(o, [n]), i = a[0], l = a.reduce(function(c, d) {
    var p = ei(t, d, r);
    return c.top = ye(p.top, c.top), c.right = nr(p.right, c.right), c.bottom = nr(p.bottom, c.bottom), c.left = ye(p.left, c.left), c;
  }, ei(t, i, r));
...
function Sn(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, i = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? pw : l, d = n.rootBoundary, p = d === void 0 ? ks : d, h = n.elementContext, w = h === void 0 ? cn : h, g = n.altBoundary, v = g === void 0 ? !1 : g, f = n.padding, m = f === void 0 ? 0 : f, k = Os(typeof m != "number" ? m : Rs(m, $n)), T = w === cn ? uw : cn, C = t.rects.popper, E = t.elements[v ? T : w], b = Xw(Te(E) ? E : E.contextElement || ce(t.elements.popper), c, p, i), I = Ye(t.elements.reference), V = Ps({
    reference: I,
    element: C,
    placement: o
  }), R = co(Object.assign({}, C, V)), P = w === cn ? R : I, G = {
...
function Yw(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = n.boundary, a = n.rootBoundary, i = n.padding, l = n.flipVariations, c = n.allowedAutoPlacements, d = c === void 0 ? Es : c, p = He(r), h = p ? l ? Ja : Ja.filter(function(v) {
    return He(v) === p;
  }) : $n, w = h.filter(function(v) {
...
function qw(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !0 : i, c = n.fallbackPlacements, d = n.padding, p = n.boundary, h = n.rootBoundary, w = n.altBoundary, g = n.flipVariations, v = g === void 0 ? !0 : g, f = n.allowedAutoPlacements, m = e.options.placement, k = Ht(m), T = k === m, C = c || (T || !v ? [Kn(m)] : Hw(m)), E = [m].concat(C).reduce(function(L, K) {
      return L.concat(Ht(K) === Go ? Yw(e, {
        placement: K,
        boundary: p,
        rootBoundary: h,
        padding: d,
      ...
      var A = E[G], Q = Ht(A), $ = He(A) === Ue, F = [Ot, Ft].indexOf(Q) >= 0, B = F ? "width" : "height", D = Sn(e, {
        placement: A,
        boundary: p,
        rootBoundary: h,
        altBoundary: w,
...
function Kw(t) {
  var e = t.state, n = t.name, r = e.rects.reference, o = e.rects.popper, a = e.modifiersData.preventOverflow, i = Sn(e, {
    elementContext: "reference"
  }), l = Sn(e, {
    altBoundary: !0
  }), c = ni(i, r), d = ni(l, o, a), p = ri(c), h = ri(d);
  e.modifiersData[n] = {
...
function Qw(t) {
  var e = t.state, n = t.options, r = t.name, o = n.offset, a = o === void 0 ? [0, 0] : o, i = Es.reduce(function(p, h) {
    return p[h] = Zw(h, e.rects, a), p;
...
function of(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, i = n.altAxis, l = i === void 0 ? !1 : i, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, h = n.padding, w = n.tether, g = w === void 0 ? !0 : w, v = n.tetherOffset, f = v === void 0 ? 0 : v, m = Sn(e, {
    boundary: c,
    rootBoundary: d,
    padding: h,
    altBoundary: p
  }), k = Ht(e.placement), T = He(e.placement), C = !T, E = Yo(k), b = rf(E), I = e.modifiersData.popperOffsets, V = e.rects.reference, R = e.rects.popper, P = typeof f == "function" ? f(Object.assign({}, e.rects, {
    placement: e.placement
  })) : f, G = typeof P == "number" ? {
    mainAxis: P,
    altAxis: P
  ...
  if (I) {
    if (a) {
      var $, F = E === "y" ? Ot : Rt, B = E === "y" ? Ft : Lt, D = E === "y" ? "height" : "width", U = I[E], nt = U + m[F], at = U - m[B], y = g ? -R[D] / 2 : 0, O = T === Ue ? V[D] : R[D], X = T === Ue ? -R[D] : -V[D], Y = e.elements.arrow, L = g && Y ? Xo(Y) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Cs(), q = K[F], W = K[B], H = gn(0, V[D], L[D]), J = C ? V[D] / 2 - y - H - q - G.mainAxis : O - H - q - G.mainAxis, Z = C ? -V[D] / 2 + y + H + W + G.mainAxis : X + H + W + G.mainAxis, dt = e.elements.arrow && In(e.elements.arrow), M = dt ? E === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, Nt = ($ = A == null ? void 0 : A[E]) != null ? $ : 0, z = U + J - Nt - M, yt = U + Z - Nt, Ut = gn(g ? nr(nt, z) : nt, U, g ? ye(at, yt) : at);
      I[E] = Ut, Q[E] = Ut - U;
    }
    if (l) {
      var de, St = E === "x" ? Ot : Rt, An = E === "x" ? Ft : Lt, Xt = I[b], Ce = b === "y" ? "height" : "width", pe = Xt + m[St], Oe = Xt - m[An], Re = [Ot, Rt].indexOf(k) !== -1, _e = (de = A == null ? void 0 : A[b]) != null ? de : 0, ue = Re ? pe : Xt - V[Ce] - R[Ce] - _e + G.altAxis, Qe = Re ? Xt + V[Ce] + R[Ce] - _e - G.altAxis : Oe, Dn = g && Re ? Ow(ue, Xt, Qe) : gn(g ? ue : pe, Xt, g ? Qe : Oe);
      I[b] = Dn, Q[b] = Dn - Xt;
    }
    e.modifiersData[r] = Q;
  }
...
function df(t, e, n) {
  n === void 0 && (n = !1);
  var r = zt(e), o = zt(e) && cf(e), a = ce(e), i = Ye(t, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wo(a)) && (l = lf(e)), zt(e) ? (c = Ye(e, !0), c.x += e.clientLeft, c.y += e.clientTop) : a && (c.x = qo(a))), {
...
function mf(t) {
  t === void 0 && (t = {});
  var e = t, n = e.defaultModifiers, r = n === void 0 ? [] : n, o = e.defaultOptions, a = o === void 0 ? oi : o;
  return function(l, c, d) {
    d === void 0 && (d = a);
    var p = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, oi, a),
      modifiersData: {},
      elements: {
        reference: l,
        popper: c
      ...
      setOptions: function(k) {
        ...
        var C = uf(ff([].concat(r, p.options.modifiers)));
...
var hf = [Bw, nf, Dw, Sw, tf, Ww, af, $w, Jw], gf = /* @__PURE__ */ mf({
  defaultModifiers: hf
});
const bf = "Popper";
function vf(t) {
...
const yf = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"], xf = ["anchorEl", "children", "container", "direction", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition", "slotProps", "slots"];
function Nf(t, e) {
  if (e === "ltr")
    return t;
  switch (t) {
...
const Ef = () => Mo({
  root: ["root"]
}, ew(vf)), Sf = {}, Tf = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, m = kt(e, yf), k = j.useRef(null), T = Ee(k, n), C = j.useRef(null), E = Ee(C, w), b = j.useRef(E);
  Ge(() => {
    b.current = E;
  }, [E]), j.useImperativeHandle(w, () => C.current, []);
  const I = Nf(p, i), [V, R] = j.useState(I), [P, G] = j.useState(rr(o));
  j.useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "production" && P && Rr(P) && P.nodeType === 1) {
...
`));
  ...
  const Q = Ef(), $ = (r = v.root) != null ? r : "div", F = iw({
    elementType: $,
  ...
  const {
    ...
    slotProps: m = {},
    slots: k = {}
  } = e, T = kt(e, xf), [C, E] = j.useState(!0), b = () => {
    E(!1);
  }, I = () => {
    E(!0);
  };
  ...
  if (a)
    ...
    const G = rr(r);
    V = G && Rr(G) ? Jn(G).body : Jn(null).body;
  }
...
process.env.NODE_ENV !== "production" && ($s.propTypes = {
   ...
   */
  anchorEl: Po(u.oneOfType([Nn, u.object, u.func]), (t) => {
    if (t.open) {
      const e = rr(t.anchorEl);
      if (e && Rr(e) && e.nodeType === 1) {
        const n = e.getBoundingClientRect();
        if (process.env.NODE_ENV !== "test" && n.top === 0 && n.left === 0 && n.right === 0 && n.bottom === 0)
          return new Error(["MUI: The `anchorEl` prop provided to the component is invalid.", "The anchor element should be part of the document layout.", "Make sure the element is present in the document or that it's not display none."].join(`
`));
      } else if (!e || typeof e.getBoundingClientRect != "function" || kf(e) && e.contextElement != null && e.contextElement.nodeType !== 1)
...
function Is() {
  const t = vs(zo);
  return process.env.NODE_ENV !== "production" && j.useDebugValue(t), t[Fo] || t;
}
function po(t, e) {
...
var Of = process.env.NODE_ENV !== "production" ? u.oneOfType([u.number, u.shape({
  enter: u.number,
  exit: u.number,
  appear: u.number
}).isRequired]) : null;
...
const Ms = S.createContext(null);
var Rf = function(e) {
  return e.scrollTop;
}, fn = "unmounted", me = "exited", he = "entering", je = "entered", uo = "exiting", re = /* @__PURE__ */ function(t) {
  Cf(e, t);
  function e(r, o) {
    var a;
    a = t.call(this, r, o) || this;
    var i = o, l = i && !i.isMounting ? r.enter : r.appear, c;
    return a.appearStatus = null, r.in ? l ? (c = me, a.appearStatus = he) : c = je : r.unmountOnExit || r.mountOnEnter ? c = fn : c = me, a.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? i !== he && i !== je && (a = he) : (i === he || i === je) && (a = uo);
    }
    ...
    var a = this, i = this.props.enter, l = this.context ? this.context.isMounting : o, c = this.props.nodeRef ? [l] : [Vn.findDOMNode(this), l], d = c[0], p = c[1], h = this.getTimeouts(), w = l ? h.appear : h.enter;
    if (!o && !i || ii.disabled) {
      this.safeSetState({
        status: je
      }, function() {
    ...
    return (
      ...
      /* @__PURE__ */ S.createElement(Ms.Provider, {
        value: null
...
const Pf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
function wo(t) {
  return `scale(${t}, ${t ** 2})`;
}
const $f = {
...
}, Kr = typeof navigator < "u" && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)4/i.test(navigator.userAgent), or = /* @__PURE__ */ j.forwardRef(function(e, n) {
  const {
    addEndListener: r,
    appear: o = !0,
    children: a,
  ...
  } = e, k = kt(e, Pf), T = un(), C = j.useRef(), E = Is(), b = j.useRef(null), I = Ee(b, a.ref, n), V = (B) => (D) => {
    if (B) {
      const U = b.current;
      D === void 0 ? B(U) : B(U, D);
    }
    ...
    f === "auto" ? (at = E.transitions.getAutoHeightDuration(B.clientHeight), C.current = at) : at = D, B.style.transition = [E.transitions.create("opacity", {
      ...
      duration: Kr ? at : at * 0.666,
      delay: Kr ? U : U || at * 0.333,
      easing: nt
    })].join(","), B.style.opacity = 0, B.style.transform = wo(0.75), h && h(B);
  }), $ = V(w);
...
or.muiSupportAuto = !0;
const If = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Mf = Pn($s, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (t, e) => e.root
})({}), Ko = /* @__PURE__ */ j.forwardRef(function(e, n) {
  var r;
  const o = bs(), a = Lo({
    props: e,
    name: "MuiPopper"
    ...
    slots: C,
    slotProps: E
  } = a, b = kt(a, If), I = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, V = _({
    anchorEl: i,
    container: p,
    disablePortal: h,
    keepMounted: w,
...
process.env.NODE_ENV !== "production" && (Ko.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: u.oneOfType([Nn, u.object, u.func]),
  /**
   * Popper render function or node.
   */
  children: u.oneOfType([u.node, u.func]),
...
const ae = ms("MuiTooltip", ["popper", "popperInteractive", "popperArrow", "popperClose", "tooltip", "tooltipArrow", "touch", "tooltipPlacementLeft", "tooltipPlacementRight", "tooltipPlacementTop", "tooltipPlacementBottom", "arrow"]), Df = ["arrow", "children", "classes", "components", "componentsProps", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "slotProps", "slots", "title", "TransitionComponent", "TransitionProps"];
function jf(t) {
  return Math.round(t * 1e5) / 1e5;
}
const Bf = (t) => {
...
const As = /* @__PURE__ */ j.forwardRef(function(e, n) {
  ...
  const I = Lo({
    ...
    TransitionProps: Nt
  } = I, z = kt(I, Df), yt = /* @__PURE__ */ j.isValidElement(R) ? R : /* @__PURE__ */ s("span", {
    children: R
  }), Ut = Is(), de = Ut.direction === "rtl", [St, An] = j.useState(), [Xt, Ce] = j.useState(null), pe = j.useRef(!1), Oe = F || at, Re = un(), _e = un(), ue = un(), Qe = un(), [Dn, Jo] = ds({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const Zo = (tt) => {
    ...
    (tt) => {
      li.start(800 + O, () => {
        Xn = !1;
      }), Jo(!1), Y && Jt && Y(tt), Re.start(Ut.transitions.duration.shortest, () => {
        pe.current = !1;
      });
    }
  ), Pr = (tt) => {
    pe.current && tt.type !== "touchstart" || (St && St.removeAttribute("title"), _e.clear(), ue.clear(), D || Xn && U ? _e.start(Xn ? U : D, () => {
      Zo(tt);
    }) : Zo(tt));
  }, Qo = (tt) => {
    _e.clear(), ue.start(O, () => {
    ...
    onFocus: zs,
    ref: Fs
  } = ps(), [, ea] = j.useState(!1), na = (tt) => {
    Vs(tt), ta.current === !1 && (ea(!1), Qo(tt));
  }, ra = (tt) => {
    St || An(tt.currentTarget), zs(tt), ta.current === !0 && (ea(!0), Pr(tt));
  }, oa = (tt) => {
    pe.current = !0;
    const $t = yt.props;
    $t.onTouchStart && $t.onTouchStart(tt);
  }, aa = Pr, ia = Qo, Ls = (tt) => {
    oa(tt), ue.clear(), Re.clear(), jn(), tn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", Qe.start(nt, () => {
      document.body.style.WebkitUserSelect = tn.current, Pr(tt);
    });
  }, Gs = (tt) => {
    yt.props.onTouchEnd && yt.props.onTouchEnd(tt), jn(), ue.start(X, () => {
      Bn(tt);
    });
  };
  j.useEffect(() => {
  ...
  const Us = Ee(yt.ref, Fs, An, n);
  !dt && dt !== 0 && (Jt = !1);
  const $r = j.useRef(), Xs = (tt) => {
    const $t = yt.props;
    $t.onMouseMove && $t.onMouseMove(tt), dn = {
      x: tt.clientX,
      y: tt.clientY
    }, $r.current && $r.current.update();
  }, en = {}, Ir = typeof dt == "string";
  A ? (en.title = !Jt && Ir && !$ ? dt : null, en["aria-describedby"] = Jt ? _r : null) : (en["aria-label"] = Ir ? dt : null, en["aria-labelledby"] = Jt && !Ir ? _r : null);
  const jt = _({}, en, z, yt.props, {
...
`));
  ...
  const nn = {};
  B || (jt.onTouchStart = Ls, jt.onTouchEnd = Gs), $ || (jt.onMouseOver = Yn(aa, jt.onMouseOver), jt.onMouseLeave = Yn(ia, jt.onMouseLeave), Oe || (nn.onMouseOver = aa, nn.onMouseLeave = ia)), Q || (jt.onFocus = Yn(ra, jt.onFocus), jt.onBlur = Yn(na, jt.onBlur), Oe || (nn.onFocus = ra, nn.onBlur = na)), process.env.NODE_ENV !== "production" && yt.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${yt.props.title}\` or the Tooltip component.`].join(`
`));
  const Ys = j.useMemo(() => {
    var tt;
    let $t = [{
    ...
    touch: pe.current
  }), Mr = Bf(rn), sa = (r = (o = Z.popper) != null ? o : P.Popper) != null ? r : Vf, la = (a = (i = (l = Z.transition) != null ? l : P.Transition) != null ? i : M) != null ? a : or, ca = (c = (d = Z.tooltip) != null ? d : P.Tooltip) != null ? c : zf, da = (p = (h = Z.arrow) != null ? h : P.Arrow) != null ? p : Ff, Hs = wn(sa, _({}, H, (w = J.popper) != null ? w : G.popper, {
    className: ve(Mr.popper, H == null ? void 0 : H.className, (g = (v = J.popper) != null ? v : G.popper) == null ? void 0 : g.className)
  }), rn), qs = wn(la, _({}, Nt, (f = J.transition) != null ? f : G.transition), rn), Ws = wn(ca, _({}, (m = J.tooltip) != null ? m : G.tooltip, {
    className: ve(Mr.tooltip, (k = (T = J.tooltip) != null ? T : G.tooltip) == null ? void 0 : k.className)
  }), rn), Ks = wn(da, _({}, (C = J.arrow) != null ? C : G.arrow, {
    className: ve(Mr.arrow, (E = (b = J.arrow) != null ? b : G.arrow) == null ? void 0 : E.className)
  }), rn);
  return /* @__PURE__ */ N(j.Fragment, {
    children: [/* @__PURE__ */ j.cloneElement(yt, jt), /* @__PURE__ */ s(sa, _({
      as: W ?? Ko,
      placement: q,
      anchorEl: at ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(ca, _({}, Ws, {
          children: [dt, V ? /* @__PURE__ */ s(da, _({}, Ks, {
            ref: Ce
          })) : null]
        }))
      }))
...
function ci(t, e, n) {
  return t ? /* @__PURE__ */ s(yi, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ s("img", { src: t, alt: `${n ? "Leading" : "Trailing"} icon for ${e}` }) }) : void 0;
}
function Ds(t) {
  const {
    onClick: e,
    ...
    Al,
    {
      ...
      onClick: e,
      id: f,
      children: n ? /* @__PURE__ */ N(ne, { children: [
        ci(a, n, !0),
        /* @__PURE__ */ s(Dl, { primary: n, inset: !a && o }),
        h ? /* @__PURE__ */ s(yi, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ s(Ju, {}) }) : ci(i, n, !1)
      ] }) : m
    }
  );
  return r ? /* @__PURE__ */ s(As, { title: r, placement: "right", children: /* @__PURE__ */ s("div", { children: k }) }) : k;
}
function js(t) {
...
function Lf(t) {
  const [e, n] = ut(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: a } = t, i = (d) => {
    ...
    ), /* @__PURE__ */ s(Bs, { ...t, includedGroups: d });
  };
  return /* @__PURE__ */ N(ne, { children: [
    /* @__PURE__ */ s(Ds, { onClick: i, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ s(
      jl,
      {
        anchorEl: e,
...
const Gf = (t, e) => e.filter((o) => o.group === t).sort((o, a) => (o.order || 0) - (a.order || 0));
function Bs(t) {
  ...
  return /* @__PURE__ */ N(
    xi,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ s(Bl, { id: n, dense: !0, className: a ?? "", children: /* @__PURE__ */ s(
          Uf,
          {
            commandHandler: t,
            menuDefinition: e,
...
const Mn = ar(({ className: t, ...e }, n) => /* @__PURE__ */ s(bl, { size: 35, className: x("tw-animate-spin", t), ...e, ref: n }));
...
function ah({
  ...
  const a = be(void 0);
  return /* @__PURE__ */ s("div", { ref: a, style: { position: "relative" }, children: /* @__PURE__ */ s(zl, { position: "static", id: r, children: /* @__PURE__ */ N(
    Fl,
    {
...
), Jf = S.forwardRef(({ className: t, variant: e, ...n }, r) => /* @__PURE__ */ s("div", { ref: r, role: "alert", className: x(Kf({ variant: e }), t), ...n }));
...
const Qf = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("div", { ref: n, className: x("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Qf.displayName = "AlertDescription";
const tm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ke.Root,
  {
    ref: n,
    className: x(
...
tm.displayName = Ke.Root.displayName;
const em = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ke.Image,
  {
    ref: n,
    className: x("pr-twp tw-aspect-square tw-h-full tw-w-full", t),
    ...e
  }
));
em.displayName = Ke.Image.displayName;
const nm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Ke.Fallback,
  {
    ref: n,
    className: x(
...
nm.displayName = Ke.Fallback.displayName;
const rm = We(
...
function om({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ s("div", { className: x("pr-twp", rm({ variant: e }), t), ...n });
}
...
const lm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s("p", { ref: n, className: x("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
lm.displayName = "CardDescription";
...
const pm = S.forwardRef(({ className: t, ...e }, n) => {
  ...
  return /* @__PURE__ */ N(
    pn.Root,
    {
      ...
      dir: r,
      children: [
        /* @__PURE__ */ s(pn.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ s(pn.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ s(pn.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
pm.displayName = pn.Root.displayName;
const um = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    to.Root,
    {
...
um.displayName = to.Root.displayName;
const sh = Pt.Root, wm = S.forwardRef(({ className: t, ...e }, n) => {
  const r = xt();
  return /* @__PURE__ */ s(
    Pt.List,
    {
...
wm.displayName = Pt.List.displayName;
const fm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Trigger,
  {
    ref: n,
    className: x(
...
const mm = S.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ s(
  Pt.Content,
  {
    ref: n,
    className: x(
...
mm.displayName = Pt.Content.displayName;
function lh({
  isInstalling: t,
  handleClick: e,
  buttonText: n,
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      onClick: e,
      ...o,
      children: t ? /* @__PURE__ */ s(Mn, { size: 15 }) : /* @__PURE__ */ N(ne, { children: [
        /* @__PURE__ */ s(vl, { size: 25, className: x("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function ch({
  ...
  return /* @__PURE__ */ s(
    wt,
    {
      ...
      onClick: e,
      ...r,
      children: t ? /* @__PURE__ */ N(ne, { children: [
...
function uh({
  ...
  return /* @__PURE__ */ s("div", { id: t, className: x("pr-twp tw-prose", n), children: /* @__PURE__ */ s(Ul, { options: o, children: e }) });
}
const hm = ar((t, e) => /* @__PURE__ */ N(
  wt,
  {
    ref: e,
...
var gm = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(gm || {});
function wh({ id: t, groups: e }) {
  return /* @__PURE__ */ s("div", { id: t, children: /* @__PURE__ */ N(go, { children: [
    /* @__PURE__ */ s(ki, { asChild: !0, children: /* @__PURE__ */ s(hm, {}) }),
    /* @__PURE__ */ s(lr, { children: e.map((n) => /* @__PURE__ */ N("div", { children: [
      /* @__PURE__ */ s(cr, { children: n.label }),
      /* @__PURE__ */ s(ql, { children: n.items.map((r) => /* @__PURE__ */ s("div", { children: r.itemType === 0 ? /* @__PURE__ */ s(bo, { onClick: r.onClick, children: r.label }) : /* @__PURE__ */ s(Si, { onClick: r.onClick, value: r.label, children: r.label }) }, r.label)) }),
      /* @__PURE__ */ s(dr, {})
    ] }, n.label)) })
  ] }) });
}
function fh({ id: t, message: e }) {
...
function gh({
  ...
  return /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ s("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((h) => {
      var w;
      return /* @__PURE__ */ N(om, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ s(
          wt,
          {
            variant: "ghost",
            ...
            children: /* @__PURE__ */ s(mo, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
function bh({
  ...
  return /* @__PURE__ */ N("div", { className: x("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ N(
      Ve,
      {
        name: "uiLanguage",
    ...
    e !== "en" && /* @__PURE__ */ N(ne, { children: [
      /* @__PURE__ */ s(At, { className: "tw-ms-3", children: c }),
      /* @__PURE__ */ s("div", { className: "tw-ms-3", children: /* @__PURE__ */ N(At, { children: [
        "Currently:",
        " ",
...
export {
  ...
  Zf as AlertTitle,
  tm as Avatar,
  nm as AvatarFallback,
  em as AvatarImage,
  Lm as BOOK_SELECTOR_STRING_KEYS,
  om as Badge,
  Fm as BookChapterControl,
  ...
  Wm as NavigationContentSearch,
  fh as NoExtensionsFound,
  Ii as Popover,
  ko as PopoverContent,
  Mi as PopoverTrigger,
  $i as RadioGroup,
  ...
  Km as SettingsSidebarContentSearch,
  pm as Slider,
  ih as Sonner,
  Mn as Spinner,
  um as Switch,
  ...
  Xm as inventoryCountColumn,
  Um as inventoryItemColumn,
  Ym as inventoryStatusColumn,
  kh as sonner,
  vh as useEvent,
  yh as useEventAsync,
  fo as usePromise
