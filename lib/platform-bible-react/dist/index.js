...
import b, { forwardRef as Ve, useRef as et, useMemo as L, useState as M, useCallback as B, useLayoutEffect as It, createContext as Dn, useContext as In, useEffect as q, Suspense as ia, createRef as la, Fragment as Nr } from "react";
...
const Os = ft.Root, Vs = ft.Portal, Hr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: u(
...
const Xr = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
...
function yd({
  ...
  const w = st(), [c, f] = M(!1), [h, m] = M(""), [g, v] = M(""), [y, O] = M("books"), [N, x] = M(void 0), [_, A] = M(!1), C = et(void 0), E = et(void 0), S = et(void 0), T = et(void 0), R = et({}), P = B(
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: X, isDigit: rt } = dr(D.key);
      if (y === "chapters") {
        if (D.key === "Backspace") {
...
), at = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ir.Root, { ref: n, className: u("pr-twp", Qs(), t), ...e }));
...
function fo(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < f.length; g++) h.push(...fo(f[g], e, n, m, new Map(a), l));
  return c != null && (h = c(h)), sr(t) && (h = Hi(t, h, m ? () => {
    const g = new Pr();
    return n.push(g), g;
  } : On)), l == null ? h.length > 0 ? i = i.concat(h) : sr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : ir(g.nextSibling) && ir(g.previousSibling);
...
function rl({
  ...
  const [m, g] = M(gr), [v, y] = M(!1), [O, N] = M(!1), [x, _] = M(!1), [A, C] = M(!1), E = L(() => t.filter((k) => !k.deleted), [t]), S = L(() => E[0], [E]), T = et(null), R = et(void 0);
  q(() => {
    const k = T.current;
    if (!k) return;
    const Y = () => {
  ...
  const P = L(
    ...
    var Y;
    await c(l, go(m)) && ((Y = R.current) == null || Y.call(R), g(gr));
  }, [m, c, l]);
  return /* @__PURE__ */ r(
    Xn,
    {
...
function fl({
  ...
  var C;
  const [c, f] = M([]), [h, m] = M([]), [g, v] = M({}), [y, O] = M({}), N = L(() => e ?? [], [e]), x = jr({
    data: N,
    columns: t,
    getCoreRowModel: Gr(),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Ut, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Er, {}) }) }),
...
function Sl({
  ...
  /* @__PURE__ */ d("span", { className: u("note-caller", { formatted: s }), children: [
    ...
    Kn(t.marker, [i], o, !1),
    " "
  ] }), g = u(e === "horizontal" ? "horizontal tw-table-cell" : "vertical", o ? "marker-visible" : "");
  return /* @__PURE__ */ d(ot, { children: [
    /* @__PURE__ */ d("div", { className: u("textual-note-header tw-text-nowrap tw-pr-1", g), children: [
      p,
      c,
      e === "vertical" && f
    ] }),
    e === "horizontal" && /* @__PURE__ */ r("div", { className: u("textual-note-header tw-text-nowrap tw-pr-1", g), children: f }),
    /* @__PURE__ */ r("div", { className: u("textual-note-body", g), children: l && l.length > 0 && /* @__PURE__ */ r(ot, { children: Tl(t.marker, l, o, w) }) })
  ] });
}
