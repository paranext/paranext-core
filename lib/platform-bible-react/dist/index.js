...
Ve.displayName = bt.Input.displayName;
...
ee.displayName = bt.List.displayName;
const an = b.forwardRef((e, t) => /* @__PURE__ */ o(bt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
an.displayName = bt.Empty.displayName;
...
zt.displayName = bt.Group.displayName;
...
Ho.displayName = bt.Separator.displayName;
...
H(xt, "Original", new xt(Rt.Original)), H(xt, "Septuagint", new xt(Rt.Septuagint)), H(xt, "Vulgate", new xt(Rt.Vulgate)), H(xt, "English", new xt(Rt.English)), H(xt, "RussianProtestant", new xt(Rt.RussianProtestant)), H(xt, "RussianOrthodox", new xt(Rt.RussianOrthodox));
let ie = xt;
function Yr(e, t) {
  const n = t[0];
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new ie(Rt[i]);
        } catch {
...
H(gt, "defaultVersification", ie.English), H(gt, "verseRangeSeparator", "-"), H(gt, "verseSequenceIndicator", ","), H(gt, "verseRangeSeparators", [gt.verseRangeSeparator]), H(gt, "verseSequenceIndicators", [gt.verseSequenceIndicator]), H(gt, "chapterDigitShifter", 1e3), H(gt, "bookDigitShifter", gt.chapterDigitShifter * gt.chapterDigitShifter), H(gt, "bcvMaxValue", gt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
H(gt, "ValidStatusType", Wo);
...
function Jr({
  ...
  if (e)
    return /* @__PURE__ */ o(zt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Dt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Gt,
      {
        value: `${e} ${ue[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function fp({
  ...
  const w = ct(), [p, m] = I(!1), [f, u] = I(""), [g, k] = I(""), [v, T] = I("books"), [N, S] = I(void 0), [A, j] = I(!1), V = tt(void 0), y = tt(void 0), C = tt(void 0), x = tt(void 0), E = tt({}), O = F(
    ...
    return [X.OT, X.NT, X.DC, X.Extra].forEach((U) => {
      M[U] = G[U].filter((st) => _r(st, g, a));
    }), M;
  }, [G, g, a]), D = $(
    () => yl(g, R, a),
    [g, R, a]
    ...
    [v, B]
  ), { otLong: pt, ntLong: ut, dcLong: yt, extraLong: Xt } = {
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: U } = qr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
        ...
        if (_ || U) {
          if (M.preventDefault(), M.stopPropagation(), T("books"), S(void 0), U && N) {
            const st = ue[N];
            k(`${st} ${M.key}`);
          } else
            k(M.key);
    ...
    const { isLetter: _, isDigit: U } = qr(M.key);
    (_ || U) && (M.preventDefault(), k((st) => st + M.key), y.current.focus(), j(!1));
  }, []);
  return Bt(() => {
    const M = setTimeout(() => {
      if (p && v === "books" && C.current && x.current) {
        const _ = C.current, U = x.current, st = U.offsetTop, mt = _.clientHeight, ae = U.clientHeight, At = st - mt / 2 + ae / 2;
        _.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(or(e.book));
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: it.map(({ onClick: M, disabled: _, title: U, icon: st }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
          ...
          !A && /* @__PURE__ */ d(ee, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !D && Object.entries(z).map(([M, _]) => {
                if (_.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ o(zt, { heading: Nt(M), children: _.map((U) => /* @__PURE__ */ o(
                      ta,
                      {
                        bookId: U,
                        onSelect: (st) => dt(st),
              ...
              D && Dt(D.book) > 1 && /* @__PURE__ */ d(lt, { children: [
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = na ? Bt : q, dn = { tag: gr };
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = It(), n = $(() => e(t), [t, e]), [r, a] = I(() => n.initialValueFn()), s = tt(r);
    return Bl(() => {
...
function le(e, t) {
  ft.call(this, void 0), this.x = e, this.s = void 0, this.g = mn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function ql(e, t) {
  return new le(e, t);
}
...
function Jl(e) {
  ...
  ia(this), Y = e, this.f &= -2, 8 & this.f && Tr(this), Cn();
}
function _e(e, t) {
...
} }), le.prototype = new ft(), le.prototype.h = function() {
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
function vw({ onClear: e }) {
  const [t] = It();
  return bw(() => ca(t, e), [t, e]), null;
}
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : q;
...
function Tw({
  ...
  const [t] = It(), [n, r] = I(t), [a, s] = I("paragraph"), [i, l] = Sw(), c = () => {
  };
...
const Lt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    et.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
...
function Jw({
  ...
  const [N, S] = I(wo), [A, j] = I(!1), [V, y] = I(!1), [C, x] = I(!1), [E, O] = I(!1), [P, G] = I(!1), [R, z] = I(void 0), [D, J] = I(!1), [dt, Ot] = I(!1);
  q(() => {
    let _ = !0;
    if (!r) {
      J(!1), Ot(!1);
  ...
  const _t = $(() => t.filter((_) => !_.deleted), [t]), it = $(() => _t[0], [_t]), B = tt(null), at = tt(void 0), pt = F(() => {
    var _;
  ...
  const ut = $(
  ...
  }, [s, n]), Xt = $(() => _t.slice(1), [_t]), Nt = $(() => Xt.length ?? 0, [Xt.length]), In = $(() => Nt > 0, [Nt]), On = $(() => C || Nt <= 2 ? Xt : Xt.slice(-2), [Xt, Nt, C]), oe = $(() => C || Nt <= 2 ? 0 : Nt - 2, [Nt, C]), An = $(
    () => Nt === 1 ? ut.singleReply : ce(ut.multipleReplies, { count: Nt }),
    [Nt, ut]
  ), Vn = $(
    ...
    async (_) => {
      const U = Kt(N) ? cr(N) : void 0, st = await p({
        ..._,
        contents: U,
        assignedUser: R ?? _.assignedUser
      });
      return st && U && pt(), st && R !== void 0 && z(void 0), st;
    },
    [pt, N, p, R]
  );
  return /* @__PURE__ */ o(
    Sa,
    {
      ...
      children: /* @__PURE__ */ d(Ta, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          yt && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: yt }),
...
const kt = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  ot.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(ot.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
...
function Rp({
  ...
  const S = F(() => {
    ...
    const y = (x = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : x.at(0);
    if (y && cn("note", y)) {
      const G = (E = y.insert.note) == null ? void 0 : E.style, R = (P = (O = y.insert.note) == null ? void 0 : O.contents) == null ? void 0 : P.ops;
      G || T(!1), T(
        G === "x" ? !!(R != null && R.every((z) => {
          var J, dt;
          if (!((J = z.attributes) != null && J.char)) return !0;
          const D = ((dt = z.attributes) == null ? void 0 : dt.char).style;
...
function Bp({
  ...
  const f = Tt(n, "%webView_inventory_all%"), u = Tt(n, "%webView_inventory_approved%"), g = Tt(n, "%webView_inventory_unapproved%"), k = Tt(n, "%webView_inventory_unknown%"), v = Tt(n, "%webView_inventory_scope_currentBook%"), T = Tt(n, "%webView_inventory_scope_chapter%"), N = Tt(n, "%webView_inventory_scope_verse%"), S = Tt(n, "%webView_inventory_filter_text%"), A = Tt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Tt(n, "%webView_inventory_no_results%"), [V, y] = I(!1), [C, x] = I("all"), [E, O] = I(""), [P, G] = I([]), R = $(() => {
    const B = e ?? [];
  ...
  }, [V, R]), D = $(() => z.length === 0 ? [] : Rc(z, C, E), [z, C, E]), J = $(() => {
    var pt, ut;
    if (!V) return c;
    ...
    for (let yt = 0; yt < B; yt++)
      at.push(
        Sc(
          ((ut = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ut[yt]) || "Additional Item",
          yt + 1
        )
      );
    return [...at, ...c];
        ...
        Me,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ d(ve, { children: [
              ...
              /* @__PURE__ */ o(kt, { value: "approved", children: u }),
              /* @__PURE__ */ o(kt, { value: "unapproved", children: g }),
              /* @__PURE__ */ o(kt, { value: "unknown", children: k })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Me, { onValueChange: (B) => Ot(B), defaultValue: i, children: [
        /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(kt, { value: "book", children: v }),
          /* @__PURE__ */ o(kt, { value: "chapter", children: T }),
          /* @__PURE__ */ o(kt, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Be,
    ...
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(ve, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: A.map((x) => /* @__PURE__ */ o(kt, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
...
function nd({
  ...
  const V = $(() => Z.allBookIds.filter(
    ...
    (R, z = !1) => {
      ...
      const D = V.findIndex((it) => it === A.current), J = V.findIndex((it) => it === R);
      if (D === -1 || J === -1) return;
      const [dt, Ot] = [
        Math.min(D, J),
        Math.max(D, J)
      ], _t = V.slice(dt, Ot + 1).map((it) => it);
      n(
        t.includes(R) ? t.filter((it) => !_t.includes(it)) : [.../* @__PURE__ */ new Set([...t, ..._t])]
      );
    },
    [t, n, V]
  ), x = (R) => {
...
Wa.displayName = vt.List.displayName;
...
Qa.displayName = vt.Content.displayName;
function Zp({
  tabList: e,
  searchValue: t,
  onSearch: n,
...
const sd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
...
const yd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Mt, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
...
const du = Et.Trigger, Sd = Et.Portal, pu = Et.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
...
ws.displayName = Et.Overlay.displayName;
...
Md.displayName = Et.Title.displayName;
...
Id.displayName = Et.Description.displayName;
...
const gu = vt.Root, Pd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = ct();
  return /* @__PURE__ */ o(
    vt.List,
    {
...
Pd.displayName = vt.List.displayName;
...
$d.displayName = vt.Trigger.displayName;
...
Ld.displayName = vt.Content.displayName;
