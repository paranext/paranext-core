...
var vs = (e, t, n) => t in e ? bs(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var ft = (e, t, n) => vs(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as st } from "react/jsx-runtime";
import b, { forwardRef as cn, useRef as Z, useMemo as B, useState as A, useCallback as z, useLayoutEffect as Ht, createContext as Rn, useContext as xr, useEffect as Y, Component as xs, createElement as Gr, Suspense as ys, createRef as Ns, Fragment as xo } from "react";
import { Command as vt } from "cmdk";
import { X as Le, Search as yo, Check as Dt, Clock as Kr, ChevronsLeft as Hr, ChevronsRight as Xr, ChevronLeft as nr, ChevronRight as Me, ArrowLeft as ks, ArrowRight as _s, Circle as Dn, ChevronDown as Be, BoldIcon as Cs, ItalicIcon as Es, UnderlineIcon as Ts, StrikethroughIcon as Ss, AtSign as No, Pencil as Rs, Trash2 as Ds, ArrowUp as ko, MoreHorizontal as _o, MailOpen as Ms, Mail as Os, ChevronUp as Co, FilterIcon as Is, ArrowLeftIcon as As, ChevronLeftIcon as Ps, ChevronRightIcon as Vs, ArrowRightIcon as $s, Copy as Eo, Filter as Ls, User as Bs, Link as js, CircleHelp as zs, ChevronsUpDown as To, Star as Fs, SquareX as So, FunctionSquare as Ro, SquareSigma as Do, AlertCircle as rr, CircleCheckIcon as Gs, CircleXIcon as Ks, CircleHelpIcon as Hs, ArrowUpIcon as Xs, ArrowDownIcon as Us, ArrowUpDownIcon as Ys, PanelLeft as qs, PanelRight as Js, ScrollText as Ws, MenuIcon as Zs, Menu as Qs, EllipsisVertical as ti, LoaderCircle as ei, GripVertical as ni } from "lucide-react";
import { clsx as ri } from "clsx";
import { extendTailwindMerge as oi } from "tailwind-merge";
import * as Rt from "@radix-ui/react-dialog";
import { includes as hn, Section as X, getChaptersForBook as ai, formatScrRef as ve, getSectionForBook as Ze, formatRelativeDate as si, formatReplacementString as be, sanitizeHtml as ii, parseParatextHtml as Ur, hasCustomParatextTags as li, NumberFormat as ci, formatBytes as wi, getCurrentLocale as di, getFormatCallerFunction as pi, deepEqual as Mo, isString as Fn, compareScrRefs as or, scrRefToBBBCCCVVV as Gn, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as Io, $getRoot as ae, $createParagraphNode as Mn, $getSelection as Xt, HISTORY_MERGE_TAG as yr, ParagraphNode as Ao, TextNode as Po, $isTokenOrSegmented as ui, $getCharacterOffsets as mi, $cloneWithPropertiesEphemeral as hi, $findMatchingParent as fi, $isElementNode as xe, CLEAR_EDITOR_COMMAND as Vo, COMMAND_PRIORITY_EDITOR as $o, $isRangeSelection as on, shallowMergeConfig as gi, defineExtension as Yt, safeCast as wn, RootNode as bi, LineBreakNode as vi, TabNode as xi, $isEditorState as yi, createCommand as Ni, CLICK_COMMAND as ki, isDOMNode as _i, $getNodeFromDOMNode as Ci, $isNodeSelection as Ei, $createNodeSelection as Ti, $setSelection as Si, COMMAND_PRIORITY_LOW as Ri, DecoratorNode as Di, $create as Mi, $getNodeByKey as Oi, INDENT_CONTENT_COMMAND as Yr, COMMAND_PRIORITY_CRITICAL as Nr, KEY_TAB_COMMAND as Ii, $createRangeSelection as Ai, $normalizeSelection__EXPERIMENTAL as Pi, OUTDENT_CONTENT_COMMAND as Vi, INSERT_TAB_COMMAND as $i, $isBlockElementNode as Nn, $isDecoratorNode as Li, $isParagraphNode as Bi, $isTextNode as kn, SELECTION_CHANGE_COMMAND as Lo, FORMAT_TEXT_COMMAND as ji, getRegisteredNode as zi, isHTMLElement as Fi, isDocumentFragment as qr, isDOMDocumentNode as Gi, ArtificialNode__DO_NOT_USE as Bo, $createLineBreakNode as jo, $isRootOrShadowRoot as Ki, isBlockDomNode as Jr, isInlineDomNode as Wr, $insertNodes as Hi } from "lexical";
import * as dn from "@radix-ui/react-tooltip";
import { TooltipTrigger as Xi } from "@radix-ui/react-tooltip";
import { HeadingNode as Ui, QuoteNode as Yi, registerRichText as qi } from "@lexical/rich-text";
import { flushSync as Ji, createPortal as Wi } from "react-dom";
...
import { useReactTable as Ko, getFilteredRowModel as tl, getSortedRowModel as Ho, getPaginationRowModel as el, getCoreRowModel as Xo, flexRender as Qe, getGroupedRowModel as nl, getExpandedRowModel as rl } from "@tanstack/react-table";
import * as at from "@radix-ui/react-select";
import ol from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as ar, HIDDEN_NOTE_CALLER as sr, getDefaultViewOptions as al, isInsertEmbedOpOfType as fn, Editorial as sl } from "@eten-tech-foundation/platform-editor";
...
const dl = Rt.Root, pl = Rt.Portal, Uo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Overlay,
  {
    ref: n,
    className: h(
...
Uo.displayName = Rt.Overlay.displayName;
const Yo = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = dt();
        ...
        children: [
          ...
          /* @__PURE__ */ d(
            Rt.Close,
            {
              ...
              children: [
                /* @__PURE__ */ o(Le, { className: "tw-h-4 tw-w-4" }),
...
Yo.displayName = Rt.Content.displayName;
...
const Jo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Title,
  {
    ref: n,
...
Jo.displayName = Rt.Title.displayName;
const ul = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Rt.Description,
  {
    ref: n,
...
ul.displayName = Rt.Description.displayName;
...
qt.displayName = vt.displayName;
const Fe = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: r, children: [
    /* @__PURE__ */ o(yo, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ o(
      vt.Input,
      {
        ref: n,
...
Fe.displayName = vt.Input.displayName;
...
Jt.displayName = vt.List.displayName;
const pn = b.forwardRef((e, t) => /* @__PURE__ */ o(vt.Empty, { ref: t, className: "tw-py-6 tw-text-center tw-text-sm", ...e }));
pn.displayName = vt.Empty.displayName;
...
Ut.displayName = vt.Group.displayName;
...
Wo.displayName = vt.Separator.displayName;
const Lt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  vt.Item,
  {
    ref: n,
    className: h(
...
Lt.displayName = vt.Item.displayName;
...
var ml = Object.defineProperty, hl = (e, t, n) => t in e ? ml(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, H = (e, t, n) => hl(e, typeof t != "symbol" ? t + "" : t, n);
const ke = [
  "GEN",
  "EXO",
  "LEV",
...
function Ge(e, t = !0) {
  return t && (e = e.toUpperCase()), e in Zr ? Zr[e] : 0;
}
function Cr(e) {
  return Ge(e) > 0;
}
function fl(e) {
  const t = typeof e == "string" ? Ge(e) : e;
  return t >= 40 && t <= 66;
}
function gl(e) {
...
const xl = 1, ea = ke.length;
function yl() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function Er(e, t = "***") {
  const n = e - 1;
  return n < 0 || n >= ke.length ? t : ke[n];
}
function na(e) {
...
const kt = class {
  ...
  constructor(t) {
    ...
    typeof t == "string" ? (this.name = t, this._type = Pt[t]) : (this._type = t, this.name = Pt[t]);
  }
  get type() {
    return this._type;
  }
...
H(kt, "Original", new kt(Pt.Original)), H(kt, "Septuagint", new kt(Pt.Septuagint)), H(kt, "Vulgate", new kt(Pt.Vulgate)), H(kt, "English", new kt(Pt.English)), H(kt, "RussianProtestant", new kt(Pt.RussianProtestant)), H(kt, "RussianOrthodox", new kt(Pt.RussianOrthodox));
let he = kt;
function Qr(e, t) {
  const n = t[0];
...
const bt = class U {
  constructor(t, n, r, a) {
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        const s = t, i = n != null && n instanceof he ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (t != null && typeof t == "number") {
        const s = n != null && n instanceof he ? n : void 0;
        this.setEmpty(s), this._verseNum = t % U.chapterDigitShifter, this._chapterNum = Math.floor(
          t % U.bookDigitShifter / U.chapterDigitShifter
        ), this._bookNum = Math.floor(t / U.bookDigitShifter);
      } else if (n == null)
        if (t != null && t instanceof U) {
          ...
          if (t == null) return;
          const s = t instanceof he ? t : U.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof t == "string" && typeof n == "string" && typeof r == "string")
        ...
        this._bookNum = t, this._chapterNum = n, this._verseNum = r, this.versification = a ?? U.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static tryParse(t) {
    let n;
    try {
      return n = new U(t), { success: !0, verseRef: n };
    } catch (r) {
      if (r instanceof Ye)
        return n = new U(), { success: !1, verseRef: n };
      throw r;
    }
  }
  /**
  ...
  static getBBBCCCVVV(t, n, r) {
    return t % U.bcvMaxValue * U.bookDigitShifter + (n >= 0 ? n % U.bcvMaxValue * U.chapterDigitShifter : 0) + (r >= 0 ? r % U.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(t) {
    ...
    let w;
    return i && (w = new he(i)), n ? new U(n, r.toString(), l, w) : new U();
  }
  /**
   ...
   */
  get hasMultiple() {
    return this._verse != null && (this._verse.includes(U.verseRangeSeparator) || this._verse.includes(U.verseSequenceIndicator));
  }
  /**
  ...
  set verse(t) {
    const { success: n, vNum: r } = U.tryGetVerseNum(t);
    this._verse = n ? void 0 : t.replace(this.rtlMark, ""), this._verseNum = r, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = U.tryGetVerseNum(this._verse));
  }
  /**
   ...
   */
  get validStatus() {
    return this.validateVerse(U.verseRangeSeparators, U.verseSequenceIndicators);
  }
  /**
   ...
   */
  get BBBCCC() {
    return U.getBBBCCCVVV(this._bookNum, this._chapterNum, 0);
  }
  /**
   * Gets the reference as a comparable integer where the book,
   ...
   */
  get BBBCCCVVV() {
    return U.getBBBCCCVVV(this._bookNum, this._chapterNum, this._verseNum);
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new he(Pt[i]);
        } catch {
    ...
    if (r.length !== 2 || Q.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !U.isVerseParseable(r[1]))
      throw new Ye("Invalid reference : " + t);
   ...
   */
  equals(t) {
    return t instanceof U ? t._bookNum === this._bookNum && t._chapterNum === this._chapterNum && t._verseNum === this._verseNum && t.verse === this.verse && (t.versification == null && this.versification == null || t.versification != null && this.versification != null && t.versification.equals(this.versification)) : !1;
  }
  /**
   ...
   */
  allVerses(t = !1, n = U.verseRangeSeparators, r = U.verseSequenceIndicators) {
  ...
  setEmpty(t = U.defaultVersification) {
...
H(bt, "defaultVersification", he.English), H(bt, "verseRangeSeparator", "-"), H(bt, "verseSequenceIndicator", ","), H(bt, "verseRangeSeparators", [bt.verseRangeSeparator]), H(bt, "verseSequenceIndicators", [bt.verseSequenceIndicator]), H(bt, "chapterDigitShifter", 1e3), H(bt, "bookDigitShifter", bt.chapterDigitShifter * bt.chapterDigitShifter), H(bt, "bcvMaxValue", bt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
H(bt, "ValidStatusType", oa);
...
function Sr(e, t, n) {
  ...
  return !!(hn(a.toLowerCase(), r) || hn(e.toLowerCase(), r) || (s ? hn(s.localizedName.toLowerCase(), r) || hn(s.localizedId.toLowerCase(), r) : !1));
}
const ia = cn(
  ({
    bookId: e,
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? je : "button", { className: h(Tl({ variant: t, size: n, className: e })), ref: s, ...a })
);
L.displayName = "Button";
const ce = Oe.Root, we = Oe.Trigger, kp = Oe.Anchor, Wt = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ o(Oe.Portal, { children: /* @__PURE__ */ o(
    Oe.Content,
    {
      ref: a,
      align: t,
...
Wt.displayName = Oe.Content.displayName;
function wr(e, t, n) {
  return `${e} ${ye[e]}${t ? ` ${Tr(e, t)} ${De(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function Sl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ d(ce, { open: w, onOpenChange: c, children: [
...
function _p(e, t, n = (a, s) => a === s, r = 15) {
  return (a) => {
    const s = e.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, r - 1)];
...
function Ml(e, t, n, r) {
  const a = z(() => {
    if (e.chapterNum > 1)
      ...
      if (w > 0) {
        const c = t[w - 1], p = Math.max(Vt(c), 1);
        r({
          book: c,
          chapterNum: p,
          verseNum: 1
...
function eo({
  ...
  if (e)
    return /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Vt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Lt,
      {
        value: `${e} ${ye[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function Cp({
  ...
  const c = dt(), [p, m] = A(!1), [f, u] = A(""), [g, x] = A(""), [v, y] = A("books"), [N, C] = A(void 0), [R, $] = A(!1), V = Z(void 0), k = Z(void 0), E = Z(void 0), _ = Z(void 0), S = Z({}), T = z(
    (O) => {
      t(O), l && l(O);
    },
    [t, l]
  ), P = B(() => r ? r() : sa, [r]), K = B(() => ({
    [X.OT]: P.filter((G) => Q.isBookOT(G)),
    [X.NT]: P.filter((G) => Q.isBookNT(G)),
    [X.DC]: P.filter((G) => Q.isBookDC(G)),
    [X.Extra]: P.filter((G) => Q.extraBooks().includes(G))
  }), [P]), D = B(() => Object.values(K).flat(), [K]), F = B(() => {
    if (!g.trim()) return K;
    const O = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    return [X.OT, X.NT, X.DC, X.Extra].forEach((ot) => {
      O[ot] = K[ot].filter((ut) => Sr(ut, g, a));
    }), O;
  }, [K, g, a]), I = B(
    () => Dl(g, D, a),
    [g, D, a]
    ...
    (O) => {
      const G = v === "chapters" ? N : I == null ? void 0 : I.book;
      G && (T({
        book: G,
        chapterNum: O,
        verseNum: 1
    ...
    (O) => {
      ...
      m(O), O && (y("books"), C(void 0), x(""));
    },
    [v, j]
  ), { otLong: ht, ntLong: yt, dcLong: Nt, extraLong: jt } = {
    ...
    (O) => I ? !!I.chapterNum && !O.toString().includes(I.chapterNum.toString()) : !1,
    [I]
  ), Te = B(
    () => ve(
      e,
      a ? De(e.book, a) : "English"
    ),
    [e, a]
  ), te = z((O) => (G) => {
    S.current[O] = G;
    ...
    (O) => {
      if (O.ctrlKey) return;
      const { isLetter: G, isDigit: ot } = to(O.key);
      if (v === "chapters") {
        if (O.key === "Backspace") {
        ...
        if (G || ot) {
          if (O.preventDefault(), O.stopPropagation(), y("books"), C(void 0), ot && N) {
            const ut = ye[N];
            x(`${ut} ${O.key}`);
          } else
            x(O.key);
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(O.key)) {
        const ut = v === "chapters" ? N : I == null ? void 0 : I.book;
        if (!ut) return;
        const lt = (() => {
          if (!f) return 1;
          const ne = f.match(/(\d+)$/);
        ...
        switch (O.key) {
          case "ArrowLeft":
            lt !== 0 && (Ct = lt > 1 ? lt - 1 : zt);
            break;
          case "ArrowRight":
            lt !== 0 && (Ct = lt < zt ? lt + 1 : 1);
            break;
          case "ArrowUp":
            Ct = lt === 0 ? zt : Math.max(1, lt - Ue);
            break;
          case "ArrowDown":
            Ct = lt === 0 ? 1 : Math.min(zt, lt + Ue);
            break;
          default:
            return;
        }
        Ct !== lt && (O.preventDefault(), O.stopPropagation(), u(wr(ut, a, Ct)), setTimeout(() => {
          const ne = S.current[Ct];
    ...
    const { isLetter: G, isDigit: ot } = to(O.key);
    (G || ot) && (O.preventDefault(), x((ut) => ut + O.key), k.current.focus(), $(!1));
  }, []);
  return Ht(() => {
    const O = setTimeout(() => {
      if (p && v === "books" && E.current && _.current) {
        const G = E.current, ot = _.current, ut = ot.offsetTop, lt = G.clientHeight, zt = ot.clientHeight, Ct = ut - lt / 2 + zt / 2;
        G.scrollTo({
          top: Math.max(0, Ct),
          behavior: "smooth"
        }), u(wr(e.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if (E.current)
          if (O) {
            const G = S.current[e.chapterNum];
  ...
  }, [v, N, I, e.book, e.chapterNum]), /* @__PURE__ */ d(ce, { open: p, onOpenChange: it, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
      ...
      qt,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: pt.map(({ onClick: O, disabled: G, title: ot, icon: ut }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              L,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ o(ks, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(_s, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ o("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: De(N, a) })
          ] }),
          !R && /* @__PURE__ */ d(Jt, { ref: E, children: [
            v === "books" && /* @__PURE__ */ d(st, { children: [
              !I && Object.entries(F).map(([O, G]) => {
                if (G.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(Ut, { heading: pe(O), children: G.map((ot) => /* @__PURE__ */ o(
                      ia,
                      {
                        bookId: ot,
                        onSelect: (ut) => ct(ut),
                        section: Ze(ot),
                        commandValue: `${ot} ${ye[ot]}`,
                        ref: ot === e.book ? _ : void 0,
                        localizedBookNames: a
                      },
                      ot
                    )) }, O)
              ...
              I && /* @__PURE__ */ o(Ut, { children: /* @__PURE__ */ o(
                Lt,
                {
                  value: `${I.book} ${ye[I.book]} ${I.chapterNum || ""}:${I.verseNum || ""})}`,
                  onSelect: J,
                  ...
                  children: ve(
                    ...
                    a ? Tr(I.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              I && Vt(I.book) > 1 && /* @__PURE__ */ d(st, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: De(I.book, a) }),
                /* @__PURE__ */ o(
                  eo,
                  {
                    bookId: I.book,
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Oo.Root, { ref: n, className: h("pr-twp", Ol(), e), ...t }));
wt.displayName = Oo.Root.displayName;
...
const _n = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  rn.Item,
  {
    ref: n,
    className: h(
    ...
    ...t,
    children: /* @__PURE__ */ o(rn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ o(Dn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
_n.displayName = rn.Item.displayName;
function Il(e) {
...
function dr({
  ...
  const [N, C] = A(!1), R = w ?? l, $ = (k) => k.length > 0 && typeof k[0] == "object" && "options" in k[0], V = (k, E) => {
    const _ = l(k), S = typeof k == "object" && "secondaryLabel" in k ? k.secondaryLabel : void 0, T = `${E ?? ""}${_}${S ?? ""}`;
    return /* @__PURE__ */ d(
      Lt,
      {
        value: _,
  ...
  return /* @__PURE__ */ d(ce, { open: N, onOpenChange: C, ...y, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: u,
        role: "combobox",
    ...
    /* @__PURE__ */ o(
      Wt,
      {
        ...
        children: /* @__PURE__ */ d(qt, { children: [
          /* @__PURE__ */ o(Fe, { placeholder: m, className: "tw-text-inherit" }),
          /* @__PURE__ */ o(pn, { children: f }),
          /* @__PURE__ */ o(Jt, { children: $(t) ? t.map((k) => /* @__PURE__ */ o(Ut, { heading: k.groupHeading, children: k.options.map((E) => V(E, k.groupHeading)) }, k.groupHeading)) : t.map((k) => V(k)) })
        ] })
      }
    )
  ] });
...
var Pl = /* @__PURE__ */ ((e) => (e.CURRENT_BOOK = "current book", e.CHOOSE_BOOKS = "choose books", e))(Pl || {});
...
function Sp({
  ...
  const p = Hn(c, "%webView_bookSelector_currentBook%"), m = Hn(c, "%webView_bookSelector_choose%"), f = Hn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = A(
    "current book"
    /* CURRENT_BOOK */
  ), x = (v) => {
    g(v), e(v);
...
const ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, $l = ca ? Ht : Y, gn = { tag: yr };
function Ll({ initialConfig: e, children: t }) {
  const n = B(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: w } = e, c = Vl(null, r), p = Io({ editable: e.editable, html: w, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
  ...
  }, []), o(la.Provider, { value: n, children: t });
}
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function jl({ ignoreHistoryMergeTagChange: e = !0, ignoreSelectionChange: t = !1, onChange: n }) {
  const [r] = Bt();
  return Bl(() => {
    if (n) return r.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: w }) => {
      t && s.size === 0 && i.size === 0 || e && w.has(yr) || l.isEmpty() || n(a, r, w);
    });
  }, [r, e, t, n]), null;
}
const Dr = {
  ...
  mark: "",
  markOverlap: ""
}, Tt = dn.Provider, $t = dn.Root, Gt = dn.Trigger, St = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  dn.Content,
  {
    ref: r,
    sideOffset: t,
...
St.displayName = dn.Content.displayName;
const Mr = [
  Ui,
  Ao,
  Po,
...
class Fl extends xs {
  ...
  componentDidUpdate(t, n) {
    ...
    if (r && n.error !== null && Gl(t.resetKeys, a)) {
      var s, i;
...
function Kl({ children: e, onError: t }) {
  return o(Fl, { fallback: o("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: t, children: e });
}
const Hl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Xl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function Ul() {
  return function(e) {
    const [t] = Bt(), n = B(() => e(t), [t, e]), [r, a] = A(() => n.initialValueFn()), s = Z(r);
    return Hl(() => {
...
function Yl(e, t, n = "self") {
  ...
  if (t.isSelected(e) && !ui(t) && r !== null) {
    const [a, s] = r, i = e.isBackward(), l = a.getNode(), w = s.getNode(), c = t.is(l), p = t.is(w);
    if (c || p) {
      const [m, f] = mi(e), u = l.is(w), g = t.is(i ? w : l), x = t.is(i ? l : w);
      let v, y = 0;
      u ? (y = m > f ? f : m, v = m > f ? m : f) : g ? (y = i ? f : m, v = void 0) : x && (y = 0, v = i ? m : f);
      const N = t.__text.slice(y, v);
      N !== t.__text && (n === "clone" && (t = hi(t)), t.__text = N);
    }
  }
  return t;
}
...
const wa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Jl = wa && "documentMode" in document ? document.documentMode : null;
!(!wa || !("InputEvent" in window) || Jl) && "getTargetRanges" in new window.InputEvent("input");
function da(...e) {
  const t = [];
...
function no(e) {
  const t = fi(e, (n) => xe(n) && !n.isInline());
  return xe(t) || ql(4, e.__key), t;
}
function Zl(e, t) {
  const n = [];
...
function fe(e, t) {
  gt.call(this, void 0), this.x = e, this.s = void 0, this.g = xn - 1, this.f = 4, this.W = t == null ? void 0 : t.watched, this.Z = t == null ? void 0 : t.unwatched, this.name = t == null ? void 0 : t.name;
}
function ec(e, t) {
  return new fe(e, t);
}
...
function Or(e) {
  ...
  e.x = void 0, e.s = void 0, ha(e);
}
function nc(e) {
  if (q !== this) throw new Error("Out-of-order effect");
  ma(this), q = e, this.f &= -2, 8 & this.f && Or(this), In();
}
function Re(e, t) {
...
function An(e, t = {}) {
  const n = {};
  for (const r in e) {
    const a = t[r], s = an(a === void 0 ? e[r] : a);
    n[r] = s;
  }
  return n;
}
gt.prototype.brand = Ql, gt.prototype.h = function() {
  return !0;
}, gt.prototype.S = function(e) {
  const t = this.t;
  t !== e && e.e === void 0 && (e.x = t, this.t = e, t !== void 0 ? t.e = e : ro(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const t = e.e, n = e.x;
    t !== void 0 && (t.x = n, e.e = void 0), n !== void 0 && (n.e = t, e.x = void 0), e === this.t && (this.t = n, n === void 0 && ro(() => {
      var r;
...
} }), fe.prototype = new gt(), fe.prototype.h = function() {
  if (this.f &= -3, 1 & this.f) return !1;
  if ((36 & this.f) == 32 || (this.f &= -5, this.g === xn)) return !0;
  if (this.g = xn, this.f |= 1, this.i > 0 && !ua(this)) return this.f &= -2, !0;
  const e = q;
  try {
    ao(this), q = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, ha(this), ao(this), oe++;
  const e = q;
  return q = this, nc.bind(this, e);
...
Yt({ build: (e, t, n) => An(t), config: wn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
  return ie(() => r.disabled.value ? void 0 : e.registerRootListener((a) => {
    e.focus(() => {
...
function fa() {
  const e = ae(), t = Xt(), n = Mn();
  e.clear(), e.append(n), t !== null && n.select(), on(t) && (t.format = 0);
}
function ga(e, t = fa) {
  return e.registerCommand(Vo, (n) => (e.update(t), !0), $o);
}
Yt({ build: (e, t, n) => An(t), config: wn({ $onClear: fa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return ie(() => ga(e, r.value));
} });
function rc(e) {
...
function ba(e, t) {
  let n;
  return an(e(), { unwatched() {
    n && (n(), n = void 0);
  }, watched() {
    this.value = e(), n = t(this);
  } });
}
const ur = Yt({ build: (e) => ba(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
function va(e, t) {
  if (e && t && !Array.isArray(t) && typeof e == "object" && typeof t == "object") {
    const n = e, r = t;
    for (const a in r) n[a] = va(n[a], r[a]);
    return e;
  }
  return t;
}
const Ir = 0, mr = 1, xa = 2, Un = 3, bn = 4, Se = 5, Yn = 6, qe = 7;
function qn(e) {
  return e.id === Ir;
}
function ya(e) {
...
function oc(e) {
  return function(t) {
    return t.id === mr;
  }(e) || tt(305, String(e.id), String(mr)), Object.assign(e, { id: xa });
}
...
class sc {
  ...
  mergeConfigs() {
    ...
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : gi;
  ...
  build(t) {
    const n = this.state;
    let r;
    n.id !== bn && tt(307, String(n.id), String(Se)), this.extension.build && (r = this.extension.build(t, n.config, n.registerState));
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Yn && tt(310, String(n.id), String(Yn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getInitResult() {
    ...
    return function(n) {
      return n.id >= bn;
    }(t) || tt(313, String(t.id), String(bn)), t.initResult;
  }
  getInitPeer(t) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Un;
    }(t) || tt(314, String(t.id), String(Un)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
  ...
  getState() {
    ...
    return function(n) {
      return n.id >= qe;
    }(t) || tt(316, String(t.id), String(qe)), t;
  }
...
function ic() {
  const e = ae();
  e.isEmpty() && e.append(Mn());
}
const lc = Yt({ config: wn({ setOptions: so, updateOptions: so }), init: ({ $initialEditorState: e = ic }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
  const a = r.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: s } = a;
    if (yi(s)) e.setEditorState(s, n);
...
}, name: "@lexical/extension/InitialState", nodes: [bi, Po, vi, xi, Ao] }), io = Symbol.for("@lexical/extension/LexicalBuilder");
function lo() {
}
function cc(e) {
  throw e;
...
class en {
  constructor(t) {
    ...
    this.outgoingConfigEdges = /* @__PURE__ */ new Map(), this.incomingEdges = /* @__PURE__ */ new Map(), this.extensionNameMap = /* @__PURE__ */ new Map(), this.conflicts = /* @__PURE__ */ new Map(), this.PACKAGE_VERSION = Jn, this.roots = t;
    for (const n of t) this.addExtension(n);
  }
  static fromExtensions(t) {
    const n = [vn(lc)];
    for (const r of t) n.push(vn(r));
    return new en(n);
  }
  static maybeFromEditor(t) {
    const n = t[io];
    return n && (n.PACKAGE_VERSION !== Jn && tt(292, n.PACKAGE_VERSION, Jn), n instanceof en || tt(293)), n;
  }
  static fromEditor(t) {
    const n = en.maybeFromEditor(t);
    return n === void 0 && tt(294), n;
  }
  constructEditor() {
    const { $initialEditorState: t, onError: n, ...r } = this.buildCreateEditorArgs(), a = Object.assign(Io({ ...r, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [io]: this });
  ...
  buildEditor() {
    ...
    return t = se(this.registerEditor(r), () => r.setRootElement(null)), r;
  }
  ...
  addExtension(t) {
    ...
    if (a !== void 0 && a.extension !== r && tt(298, r.name), !a) {
      a = new sc(this, r), this.extensionNameMap.set(r.name, a);
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      qn(s) || tt(300, i, a || "[unknown]"), qn(l = s) || tt(304, String(l.id), String(Ir)), s = Object.assign(l, { id: mr }), r.state = s;
      const w = this.outgoingConfigEdges.get(i);
      if (w) for (const c of w.keys()) {
        const p = this.extensionNameMap.get(c);
        p && n(p, i);
      }
      s = oc(s), r.state = s, t.push(r);
    };
    for (const r of this.extensionNameMap.values()) qn(r.state) && n(r);
  ...
  buildCreateEditorArgs() {
    ...
    return t.onError || (t.onError = cc), t;
  }
}
const wc = /* @__PURE__ */ new Set(), co = Yt({ build(e, t, n) {
  const r = n.getDependency(ur).output, a = an({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ba(() => {
  }, () => ie(() => {
...
class Ie extends Di {
  ...
  static clone(t) {
    return new Ie(t.__key);
  }
  static importJSON(t) {
    return Na().updateFromJSON(t);
  }
  static importDOM() {
    return { hr: () => ({ conversion: dc, priority: 0 }) };
  }
  exportDOM() {
...
Yt({ dependencies: [ur, co], name: "@lexical/extension/HorizontalRule", nodes: [Ie], register(e, t, n) {
  const { watchNodeKey: r } = n.getDependency(co).output, a = an({ nodeSelections: /* @__PURE__ */ new Map() }), s = e._config.theme.hrSelected ?? "selected";
  return se(e.registerCommand(ki, (i) => {
    if (_i(i.target)) {
      const l = Ci(i.target);
      if (pc(l)) return function(w, c = !1) {
        const p = Xt(), m = w.isSelected(), f = w.getKey();
        let u;
        c && Ei(p) ? u = p : (u = Ti(), Si(u)), m ? u.delete(f) : u.add(f);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Ri), e.registerMutationListener(Ie, (i, l) => {
    tc(() => {
      let w = !1;
      ...
      for (const [p, m] of i.entries()) if (m === "destroyed") c.delete(p), w = !0;
        ...
        f ? f.domNode.value = u : (w = !0, c.set(p, { domNode: an(u), selectedSignal: r(p) }));
      }
      w && (a.value = { nodeSelections: c });
    });
  }), ie(() => {
    const i = [];
    for (const { domNode: l, selectedSignal: w } of a.value.nodeSelections.values()) i.push(ie(() => {
      const c = l.value;
      c && (w.value ? pa(c, s) : Wl(c, s));
    }));
    return se(...i);
  }));
} });
function uc(e, t) {
  return se(e.registerCommand(Ii, (n) => {
    const r = Xt();
    if (!on(r)) return !1;
    n.preventDefault();
    const a = function(s) {
      const i = s.getNodes();
      if (Zl(i, (f) => Nn(f) && f.canIndent() ? f : null).length > 0) return !0;
      const l = s.anchor, w = s.focus, c = w.isBefore(l) ? w : l, p = c.getNode(), m = no(p);
      if (m.canIndent()) {
        const f = m.getKey();
        let u = Ai();
        if (u.anchor.set(f, 0, "element"), u.focus.set(f, 0, "element"), u = Pi(u), u.anchor.is(c)) return !0;
      }
      return !1;
    }(r) ? n.shiftKey ? Vi : Yr : $i;
    ...
    const r = Xt();
    if (!on(r)) return !1;
    const a = r.getNodes().map((s) => no(s).getIndent());
    return Math.max(...a) + 1 >= n;
  }, Nr));
}
Yt({ build: (e, t, n) => An(t), config: wn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
  const { disabled: r, maxIndent: a } = n.getOutput();
  return ie(() => {
    if (!r.value) return uc(e, a);
  });
} });
const mc = Yt({ name: "@lexical/react/ReactProvider" });
function hc() {
          ...
          if (w) {
            ...
            e.update(() => {
              ...
              if (on(g)) {
                ...
                if (kn(v) && c >= 0 && p >= 0 && (y = c, N = c + p, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), kn(v)) {
                  y = f, N = f + u;
...
Yt({ build: (e, t, n) => An(t), config: wn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => ie(() => n.getOutput().disabled.value ? void 0 : _a(e)) });
function bc(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Ar = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function vc({ editor: e, ErrorBoundary: t }) {
  return function(n, r) {
    ...
    return Ar(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], p = o(r, { onError: (f) => n._onError(f), children: o(ys, { fallback: null, children: a[c] }) }), m = n.getElementByKey(c);
        m !== null && i.push(Wi(p, m, c));
      }
      return i;
    }, [r, a, n]);
  }(e, t);
}
function xc({ editor: e, ErrorBoundary: t }) {
  return function(n) {
    const r = en.maybeFromEditor(n);
    if (r && r.hasExtensionByName(mc.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) r.hasExtensionByName(a) && bc(320, a);
      return !0;
    }
    return !1;
  }(e) ? null : o(vc, { editor: e, ErrorBoundary: t });
}
function wo(e) {
  return e.getEditorState().read(ka(e.isComposing()));
}
function yc({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  const [r] = Bt();
  return function(a) {
    Ar(() => se(qi(a), _a(a)), [a]);
  }(r), d(st, { children: [e, o(Nc, { content: t }), o(xc, { editor: r, ErrorBoundary: n })] });
}
function Nc({ content: e }) {
  const [t] = Bt(), n = function(a) {
    const [s, i] = A(() => wo(a));
    return Ar(() => {
      function l() {
        const w = wo(a);
...
function kc({ defaultSelection: e }) {
  const [t] = Bt();
  return Y(() => {
    t.focus(() => {
...
const _c = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Cc({ onClear: e }) {
  const [t] = Bt();
  return _c(() => ga(t, e), [t, e]), null;
}
const Ca = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ht : Y;
function Ec({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: C, "data-testid": R, ...$ }, V) {
  const [k, E] = A(e.isEditable()), _ = z((T) => {
    T && T.ownerDocument && T.ownerDocument.defaultView ? e.setRootElement(T) : e.setRootElement(null);
  }, [e]), S = B(() => /* @__PURE__ */ function(...T) {
    return (P) => {
      for (const K of T) typeof K == "function" ? K(P) : K != null && (K.current = P);
    };
  }(V, _), [_, V]);
  return Ca(() => (E(e.isEditable()), e.registerEditableListener((T) => {
    E(T);
  })), [e]), o("div", { "aria-activedescendant": k ? t : void 0, "aria-autocomplete": k ? n : "none", "aria-controls": k ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": k && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": w, "aria-labelledby": c, "aria-multiline": p, "aria-owns": k ? m : void 0, "aria-readonly": !k || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: k, "data-testid": R, id: x, ref: S, role: v, spellCheck: y, style: N, tabIndex: C, ...$ });
}
const Tc = cn(Ec);
function po(e) {
  return e.getEditorState().read(ka(e.isComposing()));
...
const Sc = cn(Rc);
function Rc(e, t) {
  const { placeholder: n, ...r } = e, [a] = Bt();
  return d(st, { children: [o(Tc, { editor: a, ...r, ref: t }), n != null && o(Dc, { editor: a, content: n })] });
}
function Dc({ content: e, editor: t }) {
  const n = function(i) {
    const [l, w] = A(() => po(i));
    return Ca(() => {
      function c() {
      ...
      return c(), se(i.registerUpdateListener(() => {
        c();
...
function Oc({
  ...
  return /* @__PURE__ */ o(Ea.Provider, { value: i, children: s });
}
function Ta() {
  const e = xr(Ea);
  if (!e)
...
function Ic() {
  const [e, t] = A(void 0), n = z(() => {
    t(void 0);
  }, []), r = B(() => {
    if (e === void 0)
      return;
    const { title: s, content: i } = e;
    return /* @__PURE__ */ o(dl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Yo, { children: [
      /* @__PURE__ */ o(qo, { children: /* @__PURE__ */ o(Jo, { children: s }) }),
      i
    ] }) });
  }, [e, n]), a = z(
    (s, i, l = !1) => {
...
function Ac({
  ...
  const [t] = Bt(), [n, r] = A(t), [a, s] = A("paragraph"), [i, l] = Ic(), w = () => {
  };
...
), Vc = b.forwardRef(({ className: e, variant: t, size: n, ...r }, a) => /* @__PURE__ */ o(
  zo.Root,
  {
    ref: a,
    className: h(Sa({ variant: t, size: n, className: e })),
    ...r
  }
));
Vc.displayName = zo.Root.displayName;
const Ra = b.createContext({
  size: "default",
  variant: "default"
}), Pr = b.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = dt();
  return /* @__PURE__ */ o(
    On.Root,
    {
...
Pr.displayName = On.Root.displayName;
const nn = b.forwardRef(({ className: e, children: t, variant: n, size: r, ...a }, s) => {
...
const uo = [
  ...
  { format: "underline", icon: Ts, label: "Underline" },
  { format: "strikethrough", icon: Ss, label: "Strikethrough" }
];
function $c() {
  const { activeEditor: e } = Ta(), [t, n] = A([]), r = z((a) => {
    if (on(a) || Zi(a)) {
      const s = [];
      uo.forEach(({ format: i }) => {
  ...
  return Pc(r), /* @__PURE__ */ o(
    Pr,
    {
      ...
      variant: "outline",
      size: "sm",
      children: uo.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ o(
        nn,
        {
          value: a,
          "aria-label": i,
          onClick: () => {
            e.dispatchCommand(ji, a);
          },
...
function Bc({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-relative", children: [
    /* @__PURE__ */ o(Ac, { children: () => /* @__PURE__ */ o("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ o($c, {}) }) }),
      ...
      /* @__PURE__ */ o(
        yc,
        {
          contentEditable: /* @__PURE__ */ o("div", { ref: (s) => {
            s !== void 0 && r(s);
          }, children: /* @__PURE__ */ o(Mc, { placeholder: e }) }),
          ErrorBoundary: Kl
        }
      ),
      t && /* @__PURE__ */ o(kc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ o(Lc, { onClear: n }),
      /* @__PURE__ */ o(Cc, {})
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Ll,
    {
      ...
      children: /* @__PURE__ */ d(Tt, { children: [
        /* @__PURE__ */ o(Bc, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ o(
          jl,
          {
...
function zc(e, t) {
  const n = Gi(t) ? t.body.childNodes : t.childNodes;
  let r = [];
  const a = [];
...
function Da(e, t, n, r = null) {
  ...
  let i = t;
  r !== null && kn(t) && (i = Yl(r, t, "clone"));
  const l = xe(i) ? i.getChildren() : [], w = zi(e, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Da(e, g, f, r);
    !a && xe(t) && x && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Fi(p) || qr(p)) && p.append(f), n.append(p), m) {
      const u = m.call(i, p);
...
function Oa(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  ...
  let f = [];
  const u = (l == null || !Ki(l)) && (l != null && Nn(l) || r);
  for (let g = 0; g < m.length; g++) f.push(...Oa(m[g], t, n, u, new Map(a), l));
  return p != null && (f = p(f)), Jr(e) && (f = Gc(e, f, u ? () => {
    const g = new Bo();
    return n.push(g), g;
  } : Mn)), l == null ? f.length > 0 ? i = i.concat(f) : Jr(e) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Wr(g.nextSibling) && Wr(g.previousSibling);
  }(e) && (i = i.concat(jo())) : xe(l) && l.append(...f), i;
}
function Gc(e, t, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    const l = t[i];
    if (Nn(l)) r && !l.getFormat() && l.setFormat(r), a.push(l);
    else if (s.push(l), i === t.length - 1 || i < t.length - 1 && Nn(t[i + 1])) {
      const w = n();
...
function Kc(e) {
  ...
  const t = e.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = Fo({
  ...
  if (n.update(
    () => {
      const s = new DOMParser().parseFromString(t, "text/html"), i = zc(n, s);
      ae().clear(), Hi(i);
    },
    {
      discrete: !0
...
function Rp({
  ...
  const [a, s] = A(Hc), [i, l] = A(void 0), [w, c] = A(!1), p = Z(void 0), m = Z(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Le, {}) }) }),
          /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: x }) })
        ] }) }),
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          ...
          /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: g }) })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-2", children: /* @__PURE__ */ d(ce, { open: w, onOpenChange: c, children: [
      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
        L,
        {
          variant: "outline",
          ...
          disabled: e.length === 0,
          children: [
            /* @__PURE__ */ o(No, { className: "tw-h-4 tw-w-4" }),
            /* @__PURE__ */ o("span", { children: Wn(i !== void 0 ? i : "", r) })
          ]
        }
      ) }),
      /* @__PURE__ */ o(
        Wt,
        {
          ...
          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: e.map((y) => /* @__PURE__ */ o(
            Lt,
            {
              onSelect: () => {
                l(y === "" ? void 0 : y), c(!1);
              ...
              className: "tw-flex tw-items-center",
              children: /* @__PURE__ */ o("span", { children: Wn(y, r) })
            },
            y || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        onKeyDown: (y) => {
          Vr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ o(
          Cn,
          {
...
const Dp = Object.freeze([
  ...
  "%no_comments%"
], Xc = ["input", "select", "textarea", "button"], Uc = ["button", "textbox"], Yc = ({
  options: e,
  onFocusChange: t,
  onOptionSelect: n,
  onCharacterPress: r
}) => {
  const a = Z(null), [s, i] = A(void 0), [l, w] = A(void 0), c = z(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || Xc.includes(g)) return !0;
    ...
    (u) => {
      var k;
      const g = u.target, x = (E) => E ? document.getElementById(E) : void 0, v = x(l), y = x(s);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            u.preventDefault(), u.stopPropagation();
            const E = e.find((_) => _.id === l);
            E && c(E.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const _ = E.findIndex((T) => T === g);
          if (_ === -1) return;
          let S;
          u.key === "ArrowDown" ? S = Math.min(_ + 1, E.length - 1) : S = Math.max(_ - 1, 0), S !== _ && (u.preventDefault(), u.stopPropagation(), (k = E[S]) == null || k.focus());
          return;
        }
        return;
      }
      const R = e.findIndex((E) => E.id === s);
      let $ = R;
      switch (u.key) {
        case "ArrowDown":
          $ = Math.min(R + 1, e.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          $ = Math.max(R - 1, 0), u.preventDefault();
          break;
        case "Home":
          $ = 0, u.preventDefault();
          break;
  ...
  ({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o("div", { ref: r, className: h("pr-twp", qc({ variant: t }), e), ...n })
);
...
const Zc = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("p", { ref: n, className: h("pr-twp tw-text-sm tw-text-muted-foreground", e), ...t }));
Zc.displayName = "CardDescription";
...
Pe.displayName = Go.Root.displayName;
...
Va.displayName = ze.Root.displayName;
const tw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ze.Image,
  {
    ref: n,
...
tw.displayName = ze.Image.displayName;
...
$a.displayName = ze.Fallback.displayName;
const $r = Rn(void 0);
function Ot() {
  const e = xr($r);
  if (!e)
...
}), Ke = et.Trigger, La = et.Group, ew = et.Portal, nw = et.Sub, rw = et.RadioGroup;
function Ee({ variant: e = "default", ...t }) {
  const n = b.useMemo(
    () => ({
      variant: e
    }),
  ...
  return /* @__PURE__ */ o($r.Provider, { value: n, children: /* @__PURE__ */ o(et.Root, { ...t }) });
}
const Ba = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    et.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ o(Me, { className: "tw-ml-auto tw-h-4 tw-w-4" })
      ]
    }
  );
});
Ba.displayName = et.SubTrigger.displayName;
...
ja.displayName = et.SubContent.displayName;
const de = b.forwardRef(({ className: e, sideOffset: t = 4, children: n, ...r }, a) => {
  const s = dt();
...
de.displayName = et.Content.displayName;
const Tn = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = dt(), s = Ot();
  return /* @__PURE__ */ o(
    et.Item,
    {
...
Tn.displayName = et.Item.displayName;
const Kt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    et.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
Kt.displayName = et.CheckboxItem.displayName;
const za = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(Dn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
za.displayName = et.RadioItem.displayName;
...
un.displayName = et.Label.displayName;
...
He.displayName = et.Separator.displayName;
...
ow.displayName = "DropdownMenuShortcut";
function yn(e, t) {
...
function mo({
  ...
  const u = z(() => {
    ...
    const R = new Date(e.date), $ = si(
      R,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), V = R.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
  ...
  }, [e.date, n]), v = B(() => e.user, [e.user]), y = B(
    () => e.user.split(" ").map((R) => R[0]).join("").toUpperCase().slice(0, 2),
    [e.user]
  ), N = B(
    () => ii(Ur(e.contents)),
    [e.contents]
    ...
    if (r && l)
      return /* @__PURE__ */ d(st, { children: [
        !li(e.contents) && /* @__PURE__ */ d(
          Tn,
          {
            onClick: () => {
              c(!0), m(Kc(Ur(e.contents))), i == null || i(!0);
            },
            children: [
              /* @__PURE__ */ o(Rs, { className: "tw-me-2 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ d(
          Tn,
          {
            ...
            children: [
              /* @__PURE__ */ o(Ds, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Va, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o($a, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ o("p", { className: "tw-text-sm tw-font-medium", children: v }),
            /* @__PURE__ */ o("p", { className: "tw-text-xs tw-font-normal tw-text-muted-foreground", children: x }),
            /* @__PURE__ */ o("div", { className: "tw-flex-1" }),
            t && e.assignedUser !== void 0 && /* @__PURE__ */ d(Ae, { variant: "secondary", className: "tw-text-xs tw-font-normal", children: [
              "→ ",
              yn(e.assignedUser, n)
            ] })
          ] }),
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (R) => {
                R.key === "Escape" ? (R.preventDefault(), R.stopPropagation(), u()) : R.key === "Enter" && R.shiftKey && (R.preventDefault(), R.stopPropagation(), Et(p) && g());
              },
              onKeyDown: (R) => {
                Vr(R), (R.key === "Enter" || R.key === " ") && R.stopPropagation();
              },
              children: [
                /* @__PURE__ */ o(
                  Cn,
        ...
        C && /* @__PURE__ */ d(Ee, { children: [
          /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "ghost", size: "icon", children: /* @__PURE__ */ o(_o, {}) }) }),
          /* @__PURE__ */ o(de, { align: "end", children: C })
        ] })
      ]
    }
  );
...
function aw({
  ...
  const [$, V] = A(ho), k = r, [E, _] = A(!1), [S, T] = A(!1), [P, K] = A(!1), [D, F] = A(void 0), [I, J] = A(!1), [ct, Qt] = A(!1), [mt, pt] = A(C), [j, it] = A(!1), ht = Z(void 0), [yt, Nt] = A(/* @__PURE__ */ new Map());
  Y(() => {
    let M = !0;
    return (async () => {
      const It = y ? await y(w) : !1;
      M && Qt(It);
    })(), () => {
      M = !1;
    };
  ...
  const jt = B(() => t.filter((M) => !M.deleted), [t]);
  Y(() => {
    let M = !0;
    if (!r || !N) {
      Nt(/* @__PURE__ */ new Map());
  ...
  const pe = B(() => jt[0], [jt]), jn = Z(null), Te = Z(void 0), te = z(() => {
    var M;
    (M = Te.current) == null || M.call(Te), V(ho);
  }, []), zn = z(() => {
    const M = !mt;
    pt(M), it(!M), u == null || u(w, M);
  }, [mt, u, w]);
  Y(() => {
    _(!1);
  }, [r]), Y(() => {
    if (r && !mt && !j) {
      ...
      return ht.current = M, () => clearTimeout(M);
    }
    ht.current && (clearTimeout(ht.current), ht.current = void 0);
  }, [r, mt, j, R, w, u]);
  const ee = B(
    () => ({
  ...
  }, [s, n]), O = B(() => jt.slice(1), [jt]), G = B(() => O.length ?? 0, [O.length]), ot = B(() => G > 0, [G]), ut = B(() => E || G <= 2 ? O : O.slice(-2), [O, G, E]), lt = B(() => E || G <= 2 ? 0 : G - 2, [G, E]), zt = B(
    () => G === 1 ? ee.singleReply : be(ee.multipleReplies, { count: G }),
    [G, ee]
  ), Ct = B(
    () => lt === 1 ? ee.singleReply : be(ee.multipleReplies, { count: lt }),
    [lt, ee]
  ), Ue = z(async () => {
    const M = Et($) ? En($) : void 0;
    if (D !== void 0) {
      await p({
        threadId: w,
        contents: M,
    ...
    M && await p({ threadId: w, contents: M }) && te();
  }, [te, $, p, D, w]), ne = z(
    async (M) => {
      const ue = Et($) ? En($) : void 0, It = await p({
        ...M,
        contents: ue,
        assignedUser: D ?? M.assignedUser
      });
      return It && ue && te(), It && D !== void 0 && F(void 0), It;
    },
    [te, $, p, D]
  );
  return /* @__PURE__ */ o(
    Aa,
    {
      ...
      className: h(
        ...
        {
          "tw-bg-primary-foreground": !r && c !== "Resolved" && mt,
          "tw-bg-background": r && c !== "Resolved" && mt,
          "tw-bg-muted": c === "Resolved",
          "tw-bg-blue-50": !mt && !r && c !== "Resolved"
        }
      ),
      onClick: () => {
        l(w);
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ d(Pa, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            /* @__PURE__ */ o(
              L,
              {
                ...
                size: "icon",
                onClick: (M) => {
                  M.stopPropagation(), zn();
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": mt ? "Mark as unread" : "Mark as read",
                children: mt ? /* @__PURE__ */ o(Ms, {}) : /* @__PURE__ */ o(Os, {})
              }
            ),
            mn && /* @__PURE__ */ o(Ae, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: mn }),
            ct && c !== "Resolved" && /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "icon",
            ...
            "p",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("span", { className: e, children: [
                  pe.contextBefore,
                  /* @__PURE__ */ o("span", { className: "tw-font-bold", children: pe.selectedText }),
                  pe.contextAfter
                ] })
              ]
            }
          ...
          /* @__PURE__ */ o(
            mo,
            {
              ...
              handleDeleteComment: f,
              onEditingChange: T,
              canEditOrDelete: yt.get(pe.id) ?? !1,
              canUserResolveThread: ct
            }
          )
        ] }),
        /* @__PURE__ */ d(st, { children: [
          ot && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          !r && Et($) && /* @__PURE__ */ o(
            Cn,
            {
              ...
              onSerializedChange: (M) => V(M),
              placeholder: n["%comment_replyOrAssign%"]
            }
          ),
          r && /* @__PURE__ */ d(st, { children: [
            lt > 0 && /* @__PURE__ */ d(
              "div",
              {
                className: "tw-flex tw-cursor-pointer tw-items-center tw-gap-5 tw-py-2",
                onClick: (M) => {
                  M.stopPropagation(), _(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (M) => {
                  (M.key === "Enter" || M.key === " ") && (M.preventDefault(), M.stopPropagation(), _(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(Pe, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    /* @__PURE__ */ o("p", { className: "tw-text-sm tw-text-muted-foreground", children: Ct }),
                    E ? /* @__PURE__ */ o(Co, {}) : /* @__PURE__ */ o(Be, {})
                  ] })
                ]
              }
            ),
            ut.map((M) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              mo,
              {
                comment: M,
                localizedStrings: n,
            ...
            x !== !1 && (!S || Et($)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (M) => {
                  M.key === "Enter" && M.shiftKey && (M.preventDefault(), M.stopPropagation(), (Et($) || D !== void 0) && Ue());
                },
                onKeyDown: (M) => {
                  Vr(M), (M.key === "Enter" || M.key === " ") && M.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    Cn,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    D !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: be(
                    ...
                    /* @__PURE__ */ d(ce, { open: P, onOpenChange: K, children: [
                      /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !I || !g || g.length === 0 || !g.includes(i),
                      ...
                      /* @__PURE__ */ o(
                        Wt,
                        {
                          ...
                          align: "end",
                          onKeyDown: (M) => {
                            M.key === "Escape" && (M.stopPropagation(), K(!1));
                          },
                          children: /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(Jt, { children: g == null ? void 0 : g.map((M) => /* @__PURE__ */ o(
                            Lt,
                            {
                              onSelect: () => {
                                F(M !== s ? M : void 0), K(!1);
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ o("span", { children: yn(M, n) })
                            },
                            M || "unassigned"
                          )) }) })
                        }
...
function Op({
  ...
  const C = n.filter(
    (T) => T.comments.some((P) => !P.deleted)
  ), R = C.map((T) => ({
    id: T.id
  })), $ = z(
    (T) => {
      y(T.id), x == null || x(T.id);
    },
    [x]
  ), V = z(
    (T) => {
      const P = N === T ? void 0 : T;
      y(P), x == null || x(P);
    },
    [N, x]
  ), { listboxRef: k, activeId: E, handleKeyDown: _ } = Yc({
    options: R,
    onOptionSelect: $
  }), S = z(
    (T) => {
      T.key === "Escape" ? (y(void 0), x == null || x(void 0), T.preventDefault(), T.stopPropagation()) : _(T);
    },
    [_, x]
  );
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      onKeyDown: S,
      children: C.map((T) => /* @__PURE__ */ o(
        "div",
        {
          id: T.id,
          className: h({
            "tw-opacity-60": T.status === "Resolved"
          }),
          children: /* @__PURE__ */ o(
            aw,
            {
...
function sw({ table: e }) {
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ o(Qi, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(Is, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Ve = at.Root, iw = at.Group, $e = at.Value, lw = le(
...
), _e = b.forwardRef(({ className: e, children: t, size: n, ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ d(
    at.Trigger,
    {
      className: h(lw({ size: n, className: e })),
      ref: a,
      ...r,
      dir: s,
      children: [
        t,
        /* @__PURE__ */ o(at.Icon, { asChild: !0, children: /* @__PURE__ */ o(Be, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
_e.displayName = at.Trigger.displayName;
const Fa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.ScrollUpButton,
  {
    ref: n,
    className: h("tw-flex tw-cursor-default tw-items-center tw-justify-center tw-py-1", e),
    ...t,
    children: /* @__PURE__ */ o(Co, { className: "tw-h-4 tw-w-4" })
  }
));
Fa.displayName = at.ScrollUpButton.displayName;
...
Ga.displayName = at.ScrollDownButton.displayName;
const Ce = b.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = dt();
  return /* @__PURE__ */ o(at.Portal, { children: /* @__PURE__ */ d(
    at.Content,
    {
      ref: a,
      className: h(
...
Ce.displayName = at.Content.displayName;
const cw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  at.Label,
  {
    ref: n,
...
cw.displayName = at.Label.displayName;
const _t = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  at.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(at.ItemIndicator, { children: /* @__PURE__ */ o(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ o(at.ItemText, { children: t })
    ]
  }
));
_t.displayName = at.Item.displayName;
...
ww.displayName = at.Separator.displayName;
function dw({ table: e }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Ve,
        {
          ...
          children: [
            /* @__PURE__ */ o(_e, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o($e, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(Ce, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(_t, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ d(
        L,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o(Ps, { className: "tw-h-4 tw-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ d(
...
function sn(e, t) {
  ...
  return Array.from(e.querySelectorAll(n)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && pw(r)
  );
}
const Pn = b.forwardRef(({ className: e, stickyHeader: t, ...n }, r) => {
...
const $n = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("tbody", { ref: n, className: h("[&_tr:last-child]:tw-border-0", e), ...t }));
    ...
    const n = (r) => {
      if (t.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const a = e.current ? sn(e.current) : [], s = a.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
...
const ln = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "th",
  {
    ref: n,
    className: h(
...
const Ne = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  "td",
  {
    ref: n,
...
function bw({
  ...
  var V;
  const [p, m] = A([]), [f, u] = A([]), [g, x] = A({}), [v, y] = A({}), N = B(() => t ?? [], [t]), C = Ko({
    data: N,
    columns: e,
    getCoreRowModel: Xo(),
  ...
  }), R = C.getVisibleFlatColumns();
  let $;
  return w ? $ = Array.from({ length: 10 }).map((_, S) => `skeleton-row-${S}`).map((_) => /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(Ne, { colSpan: R.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(hr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, _)) : ((V = C.getRowModel().rows) == null ? void 0 : V.length) > 0 ? $ = C.getRowModel().rows.map((k) => /* @__PURE__ */ o(
    Ft,
    {
      onClick: () => i(k, C),
      "data-state": k.getIsSelected() && "selected",
      children: k.getVisibleCells().map((E) => /* @__PURE__ */ o(Ne, { children: Qe(E.column.columnDef.cell, E.getContext()) }, E.id))
    },
    k.id
  )) : $ = /* @__PURE__ */ o(Ft, { children: /* @__PURE__ */ o(Ne, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: c }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(sw, { table: C }),
    /* @__PURE__ */ d(Pn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Vn, { stickyHeader: s, children: C.getHeaderGroups().map((k) => /* @__PURE__ */ o(Ft, { children: k.headers.map((E) => /* @__PURE__ */ o(ln, { children: E.isPlaceholder ? void 0 : Qe(E.column.columnDef.header, E.getContext()) }, E.id)) }, k.id)) }),
...
function Ip({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: /* @__PURE__ */ o(ol, { options: s, children: t })
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ o(L, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ o(Eo, {}) })
        ] }),
...
function Pp({
  ...
  return /* @__PURE__ */ d(ce, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ o(we, { asChild: !0, children: r }),
...
var yw = /* @__PURE__ */ ((e) => (e[e.Check = 0] = "Check", e[e.Radio = 1] = "Radio", e))(yw || {});
function Vp({ id: e, label: t, groups: n }) {
  const [r, a] = A(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "default", children: [
      /* @__PURE__ */ o(Ls, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
      /* @__PURE__ */ o(Be, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ o(de, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ o(un, { children: c.label }),
      /* @__PURE__ */ o(La, { children: c.itemType === 0 ? /* @__PURE__ */ o(st, { children: c.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Kt,
        {
          checked: r[p][f],
        ...
        rw,
        {
          ...
          children: c.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(za, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(He, {})
    ] }, c.label)) })
        ...
        (a || i) && /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          ...
          i && /* @__PURE__ */ o("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ d(
            L,
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ o(zs, { className: "tw-h-4 tw-w-4" })
              ]
            }
          ) })
        ] })
...
function Nw({ id: e, versionHistory: t }) {
...
function Lp({
  ...
  const i = B(() => wi(n), [n]), w = ((c) => {
    const p = new Intl.DisplayNames(di(), { type: "language" });
  ...
  return /* @__PURE__ */ o("div", { id: e, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ o(Nw, { versionHistory: a }),
...
function kw({
  ...
  const [y, N] = A(!1), C = z(
    (S) => {
      var P;
      const T = (P = e.find((K) => K.label === S)) == null ? void 0 : P.value;
      T && n(
        t.includes(T) ? t.filter((K) => K !== T) : [...t, T]
      );
    },
    [e, t, n]
  ), R = () => w || r, $ = B(() => {
    if (!f) return e;
    const S = e.filter((P) => P.starred).sort((P, K) => P.label.localeCompare(K.label)), T = e.filter((P) => !P.starred).sort((P, K) => {
      const D = t.includes(P.value), F = t.includes(K.value);
      return D && !F ? -1 : !D && F ? 1 : P.label.localeCompare(K.label);
    });
    return [...S, ...T];
  }, [e, t, f]), V = () => {
    n(e.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(ce, { open: E, onOpenChange: p ?? N, children: [
    /* @__PURE__ */ o(we, { asChild: !0, children: /* @__PURE__ */ d(
      L,
      {
        variant: x,
        ...
        /* @__PURE__ */ o(Ut, { children: $.map((S) => /* @__PURE__ */ d(
          Lt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Fs, { className: "tw-h-4 tw-w-4" }),
      ...
      return /* @__PURE__ */ d(Ae, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ o(
          L,
          {
            ...
            children: /* @__PURE__ */ o(Le, { className: "tw-h-3 tw-w-3" })
          }
        ),
...
const _w = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o("p", { children: "+" }),
  " ",
  t["%footnoteEditor_callerDropdown_item_generated%"]
] }) : e === "hidden" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o("p", { children: "-" }),
  " ",
...
function Cw({
  ...
  const s = Z(null), i = Z(null), l = Z(!1), [w, c] = A(e), [p, m] = A(n), [f, u] = A(!1);
  Y(() => {
    c(e);
  }, [e]), Y(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var y, N, C, R;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = s.current) == null || y.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((C = s.current) == null ? void 0 : C.selectionStart) === 0 && ((R = i.current) == null || R.focus(), l.current = !1), w === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ee, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: _w(e, a, n) }) }) }),
      /* @__PURE__ */ o(St, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ d(
      de,
      {
          ...
          /* @__PURE__ */ o(
            Kt,
            {
              ...
              children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
                ...
                /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: ar })
              ] })
            }
          ),
          /* @__PURE__ */ o(
            Kt,
            {
              ...
              children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-between", children: [
                ...
                /* @__PURE__ */ o("span", { className: "tw-w-10 tw-text-center", children: sr })
              ] })
            }
          ),
          /* @__PURE__ */ o(
...
const Ew = (e, t) => e === "f" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o(Ro, {}),
  " ",
  t["%footnoteEditor_noteType_footnote_label%"]
] }) : e === "fe" ? /* @__PURE__ */ d(st, { children: [
  /* @__PURE__ */ o(Do, {}),
  " ",
  ...
  return e === "f" && (n = t["%footnoteEditor_noteType_footnote_label%"]), be(t["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function Sw({
  ...
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Xi, { asChild: !0, children: /* @__PURE__ */ o(Ke, { asChild: !0, children: /* @__PURE__ */ o(L, { variant: "outline", className: "tw-h-6", children: Ew(e, n) }) }) }),
      /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: Tw(e, n) }) })
    ] }) }),
...
function jp({
  ...
  const w = Z(null), c = Ns(), [p, m] = A("generated"), [f, u] = A("*"), [g, x] = A("f"), [v, y] = A(!1), N = B(
    () => ({
      ...i,
  ...
  Y(() => {
    ...
    var _, S;
    let k;
    const E = t == null ? void 0 : t.at(0);
    if (E && fn("note", E)) {
      const T = (_ = E.insert.note) == null ? void 0 : _.caller;
      let P = "custom";
      T === ar ? P = "generated" : T === sr ? P = "hidden" : T && u(T), m(P), x(((S = E.insert.note) == null ? void 0 : S.style) ?? "f"), k = setTimeout(() => {
        var K;
        (K = w.current) == null || K.applyUpdate([{ delete: 1 }, E]);
      }, 0);
    }
    return () => {
      k && clearTimeout(k);
  ...
  const C = z(() => {
    var E, _;
    const k = (_ = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    k && fn("note", k) && (k.insert.note && (p === "custom" ? k.insert.note.caller = f : k.insert.note.caller = p === "generated" ? ar : sr), n([k]));
  }, [p, f, n]), R = () => {
    var E;
    const k = (E = c.current) == null ? void 0 : E.getElementsByClassName("editor-input")[0];
    k != null && k.textContent && navigator.clipboard.writeText(k.textContent);
  }, $ = (k) => {
    var _, S, T, P, K;
    x(k);
    const E = (S = (_ = w.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : S.at(0);
    if (E && fn("note", E)) {
      E.insert.note && (E.insert.note.style = k);
      const D = (P = (T = E.insert.note) == null ? void 0 : T.contents) == null ? void 0 : P.ops;
      g !== "x" && k === "x" ? D == null || D.forEach((F) => Rw(F)) : g === "x" && k !== "x" && (D == null || D.forEach((F) => Dw(F))), (K = w.current) == null || K.applyUpdate([{ delete: 1 }, E]);
    }
  }, V = () => {
    var E, _, S, T, P;
    const k = (_ = (E = w.current) == null ? void 0 : E.getNoteOps(0)) == null ? void 0 : _.at(0);
    if (k && fn("note", k)) {
      const K = (S = k.insert.note) == null ? void 0 : S.style, D = (P = (T = k.insert.note) == null ? void 0 : T.contents) == null ? void 0 : P.ops;
      K || y(!1), y(
        K === "x" ? !!(D != null && D.every((F) => {
          var J, ct;
          if (!((J = F.attributes) != null && J.char)) return !0;
          const I = ((ct = F.attributes) == null ? void 0 : ct.char).style;
          return I === "xt" || I === "xo" || I === "xq";
        })) : !!(D != null && D.every((F) => {
          var J, ct;
          if (!((J = F.attributes) != null && J.char)) return !0;
          const I = ((ct = F.attributes) == null ? void 0 : ct.char).style;
          return I === "ft" || I === "fr" || I === "fq";
        }))
      );
    } else
      y(!1);
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: r, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ o(Le, {}) }) }),
          /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
          /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(
            L,
          ...
          /* @__PURE__ */ o(St, { children: l["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Tt, { children: /* @__PURE__ */ d($t, { children: [
            /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(L, { onClick: R, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(Eo, {}) }) }),
            /* @__PURE__ */ o(St, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ o(rr, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
  ...
  return /* @__PURE__ */ d(st, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(st, { children: Mw(e.marker, l, r, c) })
      }
    )
  ] });
}
function Fp({
  ...
  const p = w ?? pi(n, void 0), m = (N, C) => {
    c == null || c(N, C, a);
  }, f = s ? n.findIndex((N) => N === s) : -1, [u, g] = A(f), x = (N, C, R) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), c == null || c(C, R, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
        ...
        "ul",
        {
          ...
          children: n.map((N, C) => {
            ...
            return /* @__PURE__ */ d(st, { children: [
              ...
              C < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(Pe, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function Pw({
  ...
  return /* @__PURE__ */ d(Pn, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Vn, { stickyHeader: !0, children: /* @__PURE__ */ d(Ft, { children: [
      /* @__PURE__ */ o(ln, { children: a }),
      /* @__PURE__ */ o(ln, { children: s })
    ] }) }),
    /* @__PURE__ */ o($n, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Ft,
      {
        onClick: () => {
          t(l.reference);
        ...
        children: [
          /* @__PURE__ */ o(Ne, { children: ve(l.reference, "English") }),
          /* @__PURE__ */ o(Ne, { className: r, children: Aw(l.text) })
        ]
      },
...
const Br = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  ir.Root,
  {
    ref: n,
    className: h(
...
const Ln = (e) => e === "asc" ? /* @__PURE__ */ o(Xs, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Us, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Ys, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Gp = (e) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(Pr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        nn,
        {
          onClick: (w) => {
            w.stopPropagation(), Zn(
              [l],
              "approved",
              t,
              n,
  ...
  return t ? t[1] : "";
}, $w = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", qp = Object.freeze([
  ...
  return e.forEach((a) => {
    const s = r.find(
      (i) => Mo(
        i.items,
        Fn(a.inventoryText) ? [a.inventoryText] : a.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: Fn(a.inventoryText) ? [a.inventoryText] : a.inventoryText,
        count: 1,
        status: $w(
          Fn(a.inventoryText) ? a.inventoryText : a.inventoryText[0],
          t,
          n
        ),
        occurrences: [
...
function Jp({
  ...
  const f = At(n, "%webView_inventory_all%"), u = At(n, "%webView_inventory_approved%"), g = At(n, "%webView_inventory_unapproved%"), x = At(n, "%webView_inventory_unknown%"), v = At(n, "%webView_inventory_scope_currentBook%"), y = At(n, "%webView_inventory_scope_chapter%"), N = At(n, "%webView_inventory_scope_verse%"), C = At(n, "%webView_inventory_filter_text%"), R = At(
    n,
    "%webView_inventory_show_additional_items%"
  ), $ = At(n, "%webView_inventory_no_results%"), [V, k] = A(!1), [E, _] = A("all"), [S, T] = A(""), [P, K] = A([]), D = B(() => {
    const j = e ?? [];
    return j.length === 0 ? [] : Bw(j, a, s);
  }, [e, a, s]), F = B(() => {
    if (V) return D;
    const j = [];
    return D.forEach((it) => {
      const ht = it.items[0], yt = j.find(
        (Nt) => Nt.items[0] === ht
      );
      yt ? (yt.count += it.count, yt.occurrences = yt.occurrences.concat(it.occurrences)) : j.push({
        items: [ht],
        count: it.count,
  ...
  }, [V, D]), I = B(() => F.length === 0 ? [] : Lw(F, E, S), [F, E, S]), J = B(() => {
    var ht, yt;
    if (!V) return w;
    const j = (ht = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ht.length;
    if (!j) return w;
    const it = [];
    for (let Nt = 0; Nt < j; Nt++)
      it.push(
        Vw(
          ((yt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : yt[Nt]) || "Additional Item",
          Nt + 1
        )
      );
    return [...it, ...w];
  }, [r == null ? void 0 : r.tableHeaders, w, V]);
  Y(() => {
    I.length === 0 ? K([]) : I.length === 1 && K(I[0].items);
  }, [I]);
  const ct = (j, it) => {
    it.setRowSelection(() => {
      const ht = {};
    ...
    const j = F.filter((it) => Mo(
      V ? it.items : [it.items[0]],
      P
    ));
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Ve,
        {
          onValueChange: (j) => mt(j),
          defaultValue: E,
          children: [
            /* @__PURE__ */ o(_e, { className: "tw-m-1", children: /* @__PURE__ */ o($e, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(Ve, { onValueChange: (j) => Qt(j), defaultValue: i, children: [
        /* @__PURE__ */ o(_e, { className: "tw-m-1", children: /* @__PURE__ */ o($e, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Ce, { children: [
          /* @__PURE__ */ o(_t, { value: "book", children: v }),
          /* @__PURE__ */ o(_t, { value: "chapter", children: y }),
          /* @__PURE__ */ o(_t, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ o(
        Xe,
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? R })
      ] })
    ] }),
      ...
      /* @__PURE__ */ o(Ut, { children: a.map((s) => /* @__PURE__ */ d(
        Lt,
        {
          ...
          children: [
            ...
            (s.isDisallowed || s.isDeprecated) && /* @__PURE__ */ o(Zo, { className: "tw-font-sans", children: s.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
          ]
        },
        `item-${s.title}`
      )) })
...
const jw = "16rem", zw = "3rem", Ha = b.createContext(void 0);
function Bn() {
  const e = b.useContext(Ha);
  if (!e)
...
const Xa = b.forwardRef(
  ({
    ...
    const [c, p] = b.useState(e), m = t ?? c, f = b.useCallback(
      ...
      [n, m]
    ), u = b.useCallback(() => f((C) => !C), [f]), g = m ? "expanded" : "collapsed", y = dt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o(Ha.Provider, { value: N, children: /* @__PURE__ */ o(Tt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const Ua = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Bn();
...
Ua.displayName = "Sidebar";
const Fw = b.forwardRef(({ className: e, onClick: t, ...n }, r) => {
  const a = Bn();
  return /* @__PURE__ */ d(
    L,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ o(qs, {}) : /* @__PURE__ */ o(Js, {}),
        /* @__PURE__ */ o("span", { className: "tw-sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
});
Fw.displayName = "SidebarTrigger";
...
const Kw = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Xe,
  {
    ref: n,
    "data-sidebar": "input",
...
Uw.displayName = "SidebarSeparator";
...
const Yw = b.forwardRef(({ className: e, asChild: t = !1, ...n }, r) => /* @__PURE__ */ o(
  t ? je : "button",
  {
    ref: r,
...
Yw.displayName = "SidebarGroupAction";
...
Wa.displayName = "SidebarMenuItem";
const qw = le(
  ...
  ({
    ...
    const w = e ? je : "button", { state: c } = Bn(), p = /* @__PURE__ */ o(
      w,
      {
        ref: l,
    ...
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o(St, { side: "right", align: "center", hidden: c !== "collapsed", ...a })
    ] })) : p;
  }
);
Za.displayName = "SidebarMenuButton";
const Jw = b.forwardRef(({ className: e, asChild: t = !1, showOnHover: n = !1, ...r }, a) => /* @__PURE__ */ o(
  t ? je : "button",
  {
    ref: a,
...
Jw.displayName = "SidebarMenuAction";
...
Ww.displayName = "SidebarMenuBadge";
const Zw = b.forwardRef(({ className: e, showIcon: t = !1, ...n }, r) => {
...
Zw.displayName = "SidebarMenuSkeleton";
...
Qw.displayName = "SidebarMenuSub";
const td = b.forwardRef(
  ({ ...e }, t) => /* @__PURE__ */ o("li", { ref: t, ...e })
);
td.displayName = "SidebarMenuSubItem";
const ed = b.forwardRef(({ asChild: e = !1, size: t = "md", isActive: n, className: r, ...a }, s) => /* @__PURE__ */ o(
  e ? je : "a",
  {
    ref: s,
...
function nd({
  ...
  return /* @__PURE__ */ o(
    Ua,
    {
      ...
      children: /* @__PURE__ */ d(qa, { children: [
        /* @__PURE__ */ d(fr, { children: [
          /* @__PURE__ */ o(gr, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ o(br, { children: /* @__PURE__ */ o(Ja, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Wa, { children: /* @__PURE__ */ o(
            Za,
            {
              onClick: () => c(f),
              isActive: m(f),
    ...
    /* @__PURE__ */ d(
      Xa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Ya, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const re = "scrBook", rd = "scrRef", ge = "source", od = "details", ad = "Scripture Reference", sd = "Scripture Book", Qa = "Type", id = "Details";
function ld(e, t) {
  const n = t ?? !1;
  return [
    {
      ...
      id: re,
      header: (e == null ? void 0 : e.scriptureReferenceColumnName) ?? ad,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? Q.bookIdToEnglishName(a.start.book) : r.row.groupingColumnId === re ? ve(a.start) : void 0;
      },
      getGroupingValue: (r) => Q.bookIdToNumber(r.start.book),
      sortingFn: (r, a) => or(r.original.start, a.original.start),
      enableGrouping: !0
    },
    {
      accessorFn: (r) => ve(r.start),
      id: rd,
      header: void 0,
      cell: (r) => {
        const a = r.row.original;
        return r.row.getIsGrouped() ? void 0 : ve(a.start);
      },
      sortingFn: (r, a) => or(r.original.start, a.original.start),
      enableGrouping: !1
    },
    ...
    },
    {
      ...
      id: od,
      header: (e == null ? void 0 : e.detailsColumnName) ?? id,
      cell: (r) => r.getValue(),
      enableGrouping: !1
    }
  ];
...
const cd = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || or(e.start, e.end) === 0 ? `${Gn(e.start)}+${t}` : `${Gn(e.start)}+${t}-${Gn(e.end)}+${n}`;
}, bo = (e) => `${cd({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function tu({
  sources: e,
  ...
  const [c, p] = A([]), [m, f] = A([{ id: re, desc: !1 }]), [u, g] = A({}), x = B(
  ...
  Y(() => {
    if (l) {
      const _ = y.getSelectedRowModel().rowsById, S = Object.keys(_);
      if (S.length === 1) {
        const T = x.find((P) => bo(P) === S[0]) || void 0;
        T && l(T);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? sd, C = s ?? Qa, R = [
  ...
  }, k = (_, S) => _.getIsGrouped() ? "" : h("banded-row", S % 2 === 0 ? "even" : "odd"), E = (_, S, T) => {
    if (!((_ == null ? void 0 : _.length) === 0 || S.depth < T.column.getGroupedIndex())) {
      if (S.getIsGrouped())
        switch (S.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      Ve,
      {
        ...
        children: [
          /* @__PURE__ */ o(_e, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o($e, {}) }),
          /* @__PURE__ */ o(Ce, { position: "item-aligned", children: /* @__PURE__ */ o(iw, { children: R.map((_) => /* @__PURE__ */ o(_t, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Pn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Vn, { children: y.getHeaderGroups().map((_) => /* @__PURE__ */ o(Ft, { children: _.headers.filter((S) => S.column.columnDef.header).map((S) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(ln, { colSpan: S.colSpan, className: "top-0 tw-sticky", children: S.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o($n, { children: y.getRowModel().rows.map((_, S) => {
        const T = dt();
        return /* @__PURE__ */ o(
          Ft,
          {
            ...
            children: _.getVisibleCells().map((P) => {
              if (!(P.getIsPlaceholder() || P.column.columnDef.enableGrouping && !P.getIsGrouped() && (P.column.columnDef.id !== ge || !n)))
                return /* @__PURE__ */ o(
                  Ne,
                  {
                    className: h(
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          _.getIsExpanded() && /* @__PURE__ */ o(Be, {}),
                          !_.getIsExpanded() && (T === "ltr" ? /* @__PURE__ */ o(Me, {}) : /* @__PURE__ */ o(nr, {})),
                          " ",
                          Qe(P.column.columnDef.cell, P.getContext()),
                          " (",
                          _.subRows.length,
                          ")"
                        ]
...
const zr = (e, t) => e.filter((n) => {
  try {
    return Ze(n) === t;
  } catch {
    return !1;
  }
}), ts = (e, t, n) => zr(e, t).every((r) => n.includes(r));
function wd({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = zr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], w = a["%scripture_section_dc_short%"], c = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    L,
    {
      variant: "outline",
      ...
      onClick: () => r(e),
      className: h(
        ts(t, e, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: El(
        e,
...
function dd({
  ...
  }, [v, y] = A(!1), [N, C] = A(""), R = Z(void 0), $ = Z(!1);
  if (e.length !== Q.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const V = B(() => Q.allBookIds.filter(
    (D, F) => e[F] === "1" && !Q.isObsolete(Q.bookIdToNumber(D))
  ), [e]), k = B(() => {
    if (!N.trim()) {
      const I = {
        [X.OT]: [],
    ...
    (D, F = !1) => {
      if (!F || !R.current) {
        n(
          t.includes(D) ? t.filter((pt) => pt !== D) : [...t, D]
        ), R.current = D;
        return;
      }
      const I = V.findIndex((pt) => pt === R.current), J = V.findIndex((pt) => pt === D);
      if (I === -1 || J === -1) return;
      const [ct, Qt] = [
        Math.min(I, J),
        Math.max(I, J)
      ], mt = V.slice(ct, Qt + 1).map((pt) => pt);
      n(
        t.includes(D) ? t.filter((pt) => !mt.includes(pt)) : [.../* @__PURE__ */ new Set([...t, ...mt])]
      );
    },
    [t, n, V]
  ), _ = (D) => {
    E(D, $.current), $.current = !1;
  }, S = (D, F) => {
    D.preventDefault(), E(F, D.shiftKey);
  }, T = z(
    (D) => {
      const F = zr(V, D).map((I) => I);
      n(
        ts(V, D, t) ? t.filter((I) => !F.includes(I)) : [.../* @__PURE__ */ new Set([...t, ...F])]
      );
    },
    [t, n, V]
  ), P = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(X).map((D) => /* @__PURE__ */ o(
      wd,
      {
        section: D,
        availableBookIds: V,
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: P, children: w }),
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: K, children: c })
                ] }),
                /* @__PURE__ */ d(Jt, { children: [
                  /* @__PURE__ */ o(pn, { children: p }),
                  Object.values(X).map((D, F) => {
                    const I = k[D];
                    if (I.length !== 0)
                      return /* @__PURE__ */ d(xo, { children: [
                        /* @__PURE__ */ o(
                          Ut,
                          {
                            heading: aa(D, f, u, g, x),
                            children: I.map((J) => /* @__PURE__ */ o(
                              ia,
                              {
                                bookId: J,
                                isSelected: t.includes(J),
                                onSelect: () => _(J),
                                onMouseDown: (ct) => S(ct, J),
                                section: Ze(J),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: wr(J, a),
                        ...
                        F < Object.values(X).length - 1 && /* @__PURE__ */ o(Wo, {})
                      ] }, D);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Qn ? Qn : vo
      ).map((D) => /* @__PURE__ */ o(Ae, { className: "hover:tw-bg-secondary", variant: "secondary", children: De(D, a) }, D)),
      t.length > Qn && /* @__PURE__ */ o(
        Ae,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${t.length - vo} ${m}`
        }
      )
    ] })
  ] });
...
function nu({
  ...
  const c = me(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), f = me(i, "%webView_scope_selector_current_book%"), u = me(i, "%webView_scope_selector_choose_books%"), g = me(i, "%webView_scope_selector_scope%"), x = me(i, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Rr,
        {
          ...
          children: y.map(({ value: N, label: C, id: R }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(_n, { className: "tw-me-2", value: N, id: R }),
            /* @__PURE__ */ o(wt, { htmlFor: R, children: C })
          ] }, R))
        }
      )
    ] }),
    e === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ o(wt, { children: x }),
      /* @__PURE__ */ o(
        dd,
        {
          availableBookInfo: r,
...
function ru({
  ...
  return /* @__PURE__ */ d(
    Ve,
    {
      ...
      children: [
        /* @__PURE__ */ o(_e, { size: a, className: h("pr-twp tw-w-auto", s), children: /* @__PURE__ */ o(
          $e,
          {
            placeholder: l[W(t)] ?? t
          }
...
const ns = (e, t, n, r) => n ? Object.entries(e).filter(
  ([s, i]) => "column" in i && i.column === n || s === n
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => t.filter((l) => l.group === s).sort((l, w) => l.order - w.order).map((l) => /* @__PURE__ */ d($t, { children: [
  /* @__PURE__ */ o(Gt, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ o(Ba, { children: l.label }),
    /* @__PURE__ */ o(ew, { children: /* @__PURE__ */ o(ja, { children: ns(
      e,
      t,
      es(e, l.id),
      r
  ...
  l.tooltip && /* @__PURE__ */ o(St, { children: l.tooltip })
...
function vr({
  ...
  return /* @__PURE__ */ d(Ee, { variant: s, children: [
    /* @__PURE__ */ o(Ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Zs, {}) }) }),
    /* @__PURE__ */ o(de, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(xo, { children: [
      /* @__PURE__ */ o(La, { children: /* @__PURE__ */ o(Tt, { children: ns(t.groups, t.items, w, e) }) }),
      c < p.length - 1 && /* @__PURE__ */ o(He, {})
    ] }, w)) })
  ] });
}
...
function iu({
  ...
  return /* @__PURE__ */ d(rs, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ o(
      vr,
      {
        onSelectMenuItem: e,
...
function lu({
  ...
  return /* @__PURE__ */ o(rs, { className: "tw-pointer-events-none", id: n, children: t && /* @__PURE__ */ o(
    vr,
    {
      onSelectMenuItem: e,
      menuData: t,
...
os.displayName = xt.List.displayName;
...
)), ss = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  xt.Content,
  {
    ref: n,
    className: h(
...
ss.displayName = xt.Content.displayName;
function cu({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(os, { children: [
      /* @__PURE__ */ o(as, { children: e.map((l) => /* @__PURE__ */ o(pd, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(ss, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function ud({ ...e }) {
...
const is = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
  ...
  return /* @__PURE__ */ o($r.Provider, { value: a, children: /* @__PURE__ */ o(
    nt.Root,
    {
      ref: r,
      className: h(
...
is.displayName = nt.Root.displayName;
const ls = b.forwardRef(({ className: e, ...t }, n) => {
  const r = Ot();
  return /* @__PURE__ */ o(
    nt.Trigger,
    {
...
const cs = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    nt.SubTrigger,
    {
...
cs.displayName = nt.SubTrigger.displayName;
const ws = b.forwardRef(({ className: e, ...t }, n) => {
  const r = Ot();
  return /* @__PURE__ */ o(
    nt.SubContent,
    {
...
ws.displayName = nt.SubContent.displayName;
const ds = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = Ot();
...
const ps = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ o(
    nt.Item,
    {
...
ps.displayName = nt.Item.displayName;
const hd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Ot();
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
hd.displayName = nt.CheckboxItem.displayName;
const fd = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Ot();
  return /* @__PURE__ */ d(
    nt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(Dn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        t
      ]
    }
  );
});
fd.displayName = nt.RadioItem.displayName;
...
gd.displayName = nt.Label.displayName;
const us = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  nt.Separator,
  {
    ref: n,
    className: h("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", e),
...
us.displayName = nt.Separator.displayName;
const Je = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((c) => c.group === s).sort((c, p) => c.order - p.order).map((c) => /* @__PURE__ */ d($t, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: "command" in c ? /* @__PURE__ */ d(
        ps,
        {
          ...
          children: [
            c.iconPathBefore && /* @__PURE__ */ o(Sn, { icon: c.iconPathBefore, menuLabel: c.label, leading: !0 }),
            c.label,
            c.iconPathAfter && /* @__PURE__ */ o(Sn, { icon: c.iconPathAfter, menuLabel: c.label })
          ]
        },
        `menubar-item-${c.label}-${c.command}`
      ) : /* @__PURE__ */ d(md, { children: [
        /* @__PURE__ */ o(cs, { children: c.label }),
        /* @__PURE__ */ o(ws, { children: ms(
          e,
          t,
          es(e, c.id),
          r
      ...
      c.tooltip && /* @__PURE__ */ o(St, { children: c.tooltip })
    ] }, `tooltip-${c.label}-${"command" in c ? c.command : c.id}`)), w = [...l];
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ o(us, {}, `separator-${s}`)), w;
  });
};
function bd({
  menuData: e,
  ...
  if (il(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    var g, x, v, y;
    p.preventDefault();
    ...
    switch (m.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (y = w.current) == null || y.focus(), Je(w, [f, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ o(is, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(ud, { children: [
      /* @__PURE__ */ o(ls, { ref: c(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        ds,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Tt, { children: ms(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function pu({
  ...
  const c = vd(
    ...
    var y, N, C, R, $, V;
    const v = x !== g ? ((N = (y = e[g]) == null ? void 0 : y.uiNames) == null ? void 0 : N[x]) ?? ((R = (C = e[g]) == null ? void 0 : C.uiNames) == null ? void 0 : R.en) : void 0;
    return v ? `${($ = e[g]) == null ? void 0 : $.autonym} (${v})` : (V = e[g]) == null ? void 0 : V.autonym;
  };
  return /* @__PURE__ */ d("div", { id: w, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      Ve,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ o(_e, { children: /* @__PURE__ */ o($e, {}) }),
          /* @__PURE__ */ o(
            Ce,
            {
              className: "tw-z-[250]",
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(wt, { className: "tw-font-normal tw-text-muted-foreground", children: be(c, {
      fallbackLanguages: (n == null ? void 0 : n.length) > 0 ? n.map((g) => u(g, t)).join(", ") : e.en.autonym
    }) }) })
  ] });
}
function xd({ item: e, createLabel: t, createComplexLabel: n }) {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            t && l && /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ o(Ke, { className: h(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ o(L, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ o(_o, {}) }) }),
              /* @__PURE__ */ o(de, { align: "end", children: l })
            ] })
          ] }),
...
const yd = cn(({ className: e, ...t }, n) => /* @__PURE__ */ o(ei, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
), kd = b.forwardRef(({ className: e, variant: t, ...n }, r) => /* @__PURE__ */ o(
  "div",
  {
    ref: r,
    role: "alert",
...
_d.displayName = "AlertTitle";
const Cd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
Cd.displayName = "AlertDescription";
const fu = rt.Root, gu = rt.Trigger, bu = rt.Group, vu = rt.Portal, xu = rt.Sub, yu = rt.RadioGroup, Ed = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  rt.SubTrigger,
  {
    ref: a,
    className: h(
...
Ed.displayName = rt.SubTrigger.displayName;
...
Td.displayName = rt.SubContent.displayName;
const Sd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ o(
  rt.Content,
  {
    ref: n,
    className: h(
...
Sd.displayName = rt.Content.displayName;
const Rd = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  rt.Item,
  {
    ref: r,
    className: h(
...
Rd.displayName = rt.Item.displayName;
const Dd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ref: a,
    className: h(
    ...
    ...r,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Dt, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
Dd.displayName = rt.CheckboxItem.displayName;
const Md = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  rt.RadioItem,
  {
    ref: r,
    className: h(
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(Dn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
      t
    ]
  }
));
Md.displayName = rt.RadioItem.displayName;
const Od = b.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ o(
  rt.Label,
  {
    ref: r,
    className: h(
...
Od.displayName = rt.Label.displayName;
...
Id.displayName = rt.Separator.displayName;
...
Ad.displayName = "ContextMenuShortcut";
...
function Pd({
  ...
  return /* @__PURE__ */ o(hs.Provider, { value: r, children: /* @__PURE__ */ o(
    Mt.Root,
    {
...
Pd.displayName = "Drawer";
const Nu = Mt.Trigger, Vd = Mt.Portal, ku = Mt.Close, fs = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Overlay,
  {
    ref: n,
...
fs.displayName = Mt.Overlay.displayName;
const $d = b.forwardRef(({ className: e, children: t, hideDrawerHandle: n = !1, ...r }, a) => {
...
jd.displayName = Mt.Title.displayName;
const zd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Mt.Description,
  {
    ref: n,
    className: h("tw-text-sm tw-text-muted-foreground", e),
...
zd.displayName = Mt.Description.displayName;
const Fd = b.forwardRef(({ className: e, value: t, ...n }, r) => /* @__PURE__ */ o(
  lr.Root,
  {
    ref: r,
    className: h(
...
Fd.displayName = lr.Root.displayName;
function _u({
  className: e,
  ...t
}) {
...
function Eu({
  ...
  return /* @__PURE__ */ o(
    kr.PanelResizeHandle,
    {
      ...
      ...n,
      children: e && /* @__PURE__ */ o("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ o(ni, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Tu({ ...e }) {
...
const Gd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ d(
    We.Root,
    {
      ...
      dir: r,
      children: [
        /* @__PURE__ */ o(We.Track, { className: "tw-relative tw-h-2 tw-w-full tw-grow tw-overflow-hidden tw-rounded-full tw-bg-secondary", children: /* @__PURE__ */ o(We.Range, { className: "tw-absolute tw-h-full tw-bg-primary" }) }),
        /* @__PURE__ */ o(We.Thumb, { className: "tw-block tw-h-5 tw-w-5 tw-rounded-full tw-border-2 tw-border-primary tw-bg-background tw-ring-offset-background tw-transition-colors focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-ring focus-visible:tw-ring-offset-2 disabled:tw-pointer-events-none disabled:tw-opacity-50" })
      ]
    }
  );
});
Gd.displayName = We.Root.displayName;
...
Kd.displayName = cr.Root.displayName;
const Su = xt.Root, Hd = b.forwardRef(({ className: e, ...t }, n) => {
  const r = dt();
  return /* @__PURE__ */ o(
    xt.List,
    {
...
Hd.displayName = xt.List.displayName;
...
Xd.displayName = xt.Trigger.displayName;
...
Ud.displayName = xt.Content.displayName;
...
export {
  ...
  Ae as Badge,
  Cp as BookChapterControl,
  Pl as BookSelectionMode,
  Sp as BookSelector,
  L as Button,
  ...
  Md as ContextMenuRadioItem,
  Id as ContextMenuSeparator,
  Ad as ContextMenuShortcut,
  xu as ContextMenuSub,
  Td as ContextMenuSubContent,
  Ed as ContextMenuSubTrigger,
  ...
  Jp as Inventory,
  wt as Label,
  Wp as MARKER_MENU_STRING_KEYS,
  Ip as MarkdownRenderer,
  Zp as MarkerMenu,
  $p as MoreInfo,
  kw as MultiSelectComboBox,
  cu as NavigationContentSearch,
  ce as Popover,
  kp as PopoverAnchor,
  ...
  _u as ResizablePanelGroup,
  mu as ResultsCard,
  eu as SCOPE_SELECTOR_STRING_KEYS,
  nu as ScopeSelector,
  tu as ScriptureResultsViewer,
  ru as ScrollGroupSelector,
  jr as SearchBar,
  Ve as Select,
  Ce as SelectContent,
  iw as SelectGroup,
  ...
  Ww as SidebarMenuBadge,
  Za as SidebarMenuButton,
  Wa as SidebarMenuItem,
  Zw as SidebarMenuSkeleton,
  Qw as SidebarMenuSub,
  ed as SidebarMenuSubButton,
  td as SidebarMenuSubItem,
  Xa as SidebarProvider,
  Gw as SidebarRail,
  Uw as SidebarSeparator,
  Fw as SidebarTrigger,
  hr as Skeleton,
  Gd as Slider,
  Tu as Sonner,
  yd as Spinner,
