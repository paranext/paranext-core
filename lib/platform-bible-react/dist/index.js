...
import { c as m, g as ze, a as Xr, C as Ie, u as zo, T as jt, b as Ft, d as Bt, e as Ut, A as fe, P as Be, f as rr, B as Z, h as Ue, i as Ke, j as He, k as Me, l as Yi, m as Wi, n as Xi, E as Ji, o as Qa, r as Ce, p as Zi, q as yn, s as na, t as ia, L as Tt, R as to, v as Jr, D as Oa, w as Ia, x as $a, y as Aa, z as kn, F as Fr, G as eo, H as _n, I as ro, J as Qe, K as Cr, M as qe, N as Ge, O as Ye, S as Er, Q as cr, U as Qi, V as zr, W as er, X as Le, Z as ar, Y as Ve, _ as lr, $ as ao, a0 as oo, a1 as Zr, a2 as no, a3 as Nn, a4 as ts, a5 as es, a6 as rs, a7 as Pa, a8 as Cn, a9 as sa, aa as En, ab as as, ac as os, ad as ns, ae as is, af as Tn, ag as Sn, ah as io, ai as ss, aj as zn, ak as fa, al as Ro, am as ma, an as cs, ao as ls, ap as ds, aq as ws, ar as us, as as Rr, at as so, au as ps, av as hs } from "./resizable-BufEsL_o.js";
import { aw as $g, ax as Ag, ay as Pg, az as Vg, aA as Lg, aB as jg, aC as Fg, aD as Bg, aE as Ug, aF as Kg, aG as Hg, aH as qg, aI as Gg, aJ as Yg, aK as Wg, aL as Xg, aM as Jg, aN as Zg, aO as Qg, aP as tf, aQ as ef, aR as rf, aS as af, aT as of } from "./resizable-BufEsL_o.js";
...
import { Section as pt, getChaptersForBook as Ys, formatScrRef as Re, getSectionForBook as Br, formatRelativeDate as Ws, formatReplacementString as tr, sanitizeHtml as lo, NumberFormat as An, formatBytes as Xs, getCurrentLocale as Js, MODIFIER_KEYS as Zs, usfmMarkers as Ur, isPlatformError as Qs, ABORTED as tc, getErrorMessage as ec, getFormatCallerFunction as rc, deepEqual as ac, isString as Io, compareScrRefs as Fa, scrRefToBBBCCCVVV as va, defaultScrRef as ba, formatScrRefRange as oc, getLocalizeKeyForScrollGroupId as $o, formatReplacementStringToArray as Ao, collectUsjMarkers as nc } from "platform-bible-utils";
import Yt, { useRef as H, useMemo as $, createContext as ca, useContext as wo, useState as N, useEffect as Y, useCallback as V, useImperativeHandle as ic, useLayoutEffect as Jt, Component as sc, createElement as Po, Suspense as cc, forwardRef as Pn, useId as Vo, Fragment as la } from "react";
import { IconSelector as Vn, IconCheck as da, IconChevronDown as lc, IconChevronUp as dc, IconLayoutSidebar as wc, IconLayoutSidebarRight as uc, IconChevronRight as Ln, IconSearch as pc, IconLoader as hc, IconAlertOctagon as gc, IconAlertTriangle as fc, IconInfoCircle as mc, IconCircleCheck as vc } from "@tabler/icons-react";
import { createEditor as jn, $getRoot as Fe, $createParagraphNode as Dr, $getSelection as Zt, HISTORY_MERGE_TAG as uo, ParagraphNode as Fn, TextNode as Bn, $getPreviousSelection as bc, $isRangeSelection as _e, $caretFromPoint as xc, $getSiblingCaret as Un, $getChildCaret as yc, $getAdjacentChildCaret as kc, $isChildCaret as _c, $normalizeCaret as Nc, $setSelectionFromCaretRange as Cc, $getCollapsedCaretRange as Ec, $getCaretInDirection as Lo, $splitAtPointCaretNext as Tc, $isTextPointCaret as Sc, $findMatchingParent as Kn, $isElementNode as Tr, mergeRegister as Oe, getDOMTextNode as zc, isHTMLElement as Rc, CLEAR_EDITOR_COMMAND as Hn, COMMAND_PRIORITY_EDITOR as po, shallowMergeConfig as Dc, defineExtension as we, safeCast as or, createState as Mc, FORMAT_TEXT_COMMAND as qn, $isNodeSelection as Gn, COMMAND_PRIORITY_LOW as Yn, RootNode as Oc, LineBreakNode as Ic, TabNode as $c, $isEditorState as Ac, createCommand as Pc, CLICK_COMMAND as Vc, isDOMNode as Lc, $getNodeFromDOMNode as jc, $createNodeSelection as Fc, $setSelection as Bc, $getEditor as Uc, DecoratorNode as Ba, $getState as Kc, toggleTextFormatType as jo, TEXT_TYPE_TO_FORMAT as Hc, $setState as qc, addClassNamesToElement as Wn, $create as Gc, $getNodeByKey as Yc, removeClassNamesFromElement as Wc, KEY_TAB_COMMAND as Xc, $isBlockElementNode as Jc, $createRangeSelection as Zc, $normalizeSelection__EXPERIMENTAL as Qc, OUTDENT_CONTENT_COMMAND as tl, INDENT_CONTENT_COMMAND as Fo, INSERT_TAB_COMMAND as el, COMMAND_PRIORITY_CRITICAL as ho, $isDecoratorNode as rl, $isParagraphNode as al, $isTextNode as Ua, SELECTION_CHANGE_COMMAND as Xn, $insertNodes as ol } from "lexical";
...
import { Avatar as go, Select as Wt, Checkbox as Bo, Slot as Mr, Tabs as me, Menubar as Ee, ContextMenu as Kt, Progress as Uo, Slider as Ar, Switch as Ko } from "radix-ui";
import { useReactTable as Zn, getFilteredRowModel as pl, getSortedRowModel as Qn, getPaginationRowModel as hl, getCoreRowModel as ti, flexRender as _r, getGroupedRowModel as gl, getExpandedRowModel as fl } from "@tanstack/react-table";
import ml from "markdown-to-jsx";
import { filterAndRankItems as Ho, GENERATOR_NOTE_CALLER as Ka, HIDDEN_NOTE_CALLER as Ha, getDefaultViewOptions as vl, isInsertEmbedOpOfType as xr, getMarkerMenuItems as bl, defaultStyleInfo as xl, Editorial as yl } from "@eten-tech-foundation/platform-editor";
...
import { toast as sf } from "sonner";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ u(
        Ie,
        {
          ...
          "aria-label": `${Lt.bookIdToEnglishName(e)} (${e.toLocaleUpperCase()})`,
          disabled: w,
...
function Tl({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: v
  } = zo(), [b, z] = N(!1), [k, _] = N(!1), S = H(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), q = n && e !== void 0, T = i ?? (e !== void 0 && !n);
  Y(() => {
    var C;
    El();
    const Q = (C = S.current) == null ? void 0 : C.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
    const M = (J) => !!J && J.scrollWidth > J.clientWidth, U = () => {
      qa !== "pointer" && (T || M(h.current) || M(l.current)) && _(!0);
    }, O = () => _(!1);
    return Q.addEventListener("focus", U), Q.addEventListener("blur", O), () => {
      Q.removeEventListener("focus", U), Q.removeEventListener("blur", O);
    };
  }, [T, h, l]);
  const j = V(() => {
    T && z(!0), f(), q && w();
  ...
  const R = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), K = q ? (
...
function Sl({
  ...
  const [h, g] = N(!1), f = w !== void 0, v = f ? w : h, b = (k) => {
    f || g(k), p == null || p(k);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(Be, { open: v, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ a(Ue, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: /* @__PURE__ */ a(Me, { heading: i, children: t.map((k) => /* @__PURE__ */ u(
      Ie,
      {
        onSelect: () => z(k),
  ...
  const o = Rl.reduce(
    (n, i) => {
      ...
      if (s) {
        ...
        if (!w && l) {
          const g = ((f) => Object.keys(fe).find(
            (v) => fe[v].toLowerCase() === f.toLowerCase()
          ))(c);
...
function ai({
  ...
  if (!(t <= 0))
    return /* @__PURE__ */ a(Me, { children: /* @__PURE__ */ a("div", { className: m("tw:grid tw:grid-cols-6 tw:gap-1", c), children: Array.from({ length: t }, (l, d) => d + 1).map((l) => {
...
function ya({
  ...
  const T = Ce(), j = Cl(), A = q ?? j, [R, K] = N(!1), [W, L] = N(""), [Q, M] = N(""), [U, O] = N("books"), [C, J] = N(void 0), [et, ft] = N(
    void 0
  ), [ot, Mt] = N(void 0), [tt, ct] = N(!1), ht = H(null), mt = H(!1), lt = H(void 0), Ot = H(void 0), wt = H(void 0), ie = H(void 0), Qt = H({}), St = H({}), xt = V(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ), Nt = $(() => o ? o() : Zi, [o]), It = $(() => ({
    [pt.OT]: Nt.filter((X) => Lt.isBookOT(X)),
    [pt.NT]: Nt.filter((X) => Lt.isBookNT(X)),
    [pt.DC]: Nt.filter((X) => Lt.isBookDC(X)),
    [pt.Extra]: Nt.filter((X) => Lt.extraBooks().includes(X))
  }), [Nt]), vt = $(() => Object.values(It).flat(), [It]), zt = $(() => {
    if (!Q.trim()) return It;
    const y = {
      [pt.OT]: [],
      [pt.NT]: [],
    ...
    return [pt.OT, pt.NT, pt.DC, pt.Extra].forEach((nt) => {
      y[nt] = It[nt].filter((Rt) => Qa(Rt, Q, n));
    }), y;
  }, [It, Q, n]), D = $(
    () => Ol(Q, vt, n),
    [Q, vt, n]
  ...
  const se = V(() => {
    if (D) {
      const y = D.chapterNum ?? 1, X = D.verseNum ?? 1;
      if (w && xa(D.book, y, X, w))
        return;
      xt({
        book: D.book,
        chapterNum: y,
    ...
    (y) => {
      const X = U === "chapters" ? C : D == null ? void 0 : D.book;
      if (X) {
        if (d && d(X, y) > 1) {
          ft(X), Mt(y), O("verses"), L("");
          return;
        }
        xt({
          book: X,
    ...
    O("books"), J(void 0), ft(void 0), Mt(void 0), setTimeout(() => {
      Ot.current && Ot.current.focus();
    }, 0);
  }, []), re = V(() => {
    const y = et;
    ft(void 0), Mt(void 0), y ? (J(y), O("chapters"), L("")) : _t();
  }, [et, _t]), $t = V((y) => {
    K(y), y && (O("books"), J(void 0), ft(void 0), Mt(void 0), M(""));
  }, []);
  Y(() => {
    S && $t(!1);
  }, [S, $t]);
  ...
  Y(() => {
    var y;
    At !== 0 && ((y = Ot.current) == null || y.focus());
  }, [At]), ic(
    _,
    () => ({
      open: () => {
  ...
  const { otLong: be, ntLong: ae, dcLong: E, extraLong: F } = {
    ...
    () => A >= Kr.TIGHT ? Xr(t.book, n) : ze(t.book, n),
    [t.book, n, A]
  ), at = `${t.chapterNum}:${t.verseNum}`, it = V((y) => (X) => {
    Qt.current[y] = X;
  }, []), gt = V((y) => (X) => {
    St.current[y] = X;
  }, []), bt = $(
    () => Dl(Q),
    [Q]
  ), yt = $(() => !d || !D || !D.chapterNum || !bt ? !1 : d(D.book, D.chapterNum) > 0, [d, D, bt]), Ct = V(
    (y) => w ? Go(y, w) : !1,
    [w]
  ), Pt = V(
    (y) => (X) => w ? Ml(y, X, w) : !1,
    ...
    (y, X) => (nt) => w ? xa(y, X, nt, w) : !1,
    [w]
  ), oe = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Or = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Eo = V(
    (y) => {
      (y.key === "Home" || y.key === "End") && y.stopPropagation(), p && p.includes(y.key) && D && D.chapterNum !== void 0 && D.verseNum !== void 0 && (y.preventDefault(), y.stopPropagation(), se());
    },
    [p, D, se]
  ), ga = V(
    (y) => {
      var $e, Se, nr;
      if (y.ctrlKey) return;
      const { isLetter: X, isDigit: nt } = Yo(y.key);
      if ((U === "chapters" || U === "verses") && (y.key === " " || y.key === "Enter")) {
        ...
        const Ht = ($e = lt.current) == null ? void 0 : $e.querySelector(
          '[cmdk-item][data-selected="true"]:not([data-disabled="true"])'
        );
        if (Ht) {
          y.preventDefault(), y.stopPropagation(), Ht.click();
          return;
        }
      }
      if ((U === "chapters" || U === "verses") && (X || nt)) {
        y.preventDefault(), y.stopPropagation();
        return;
      }
      if (U === "chapters" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), _t();
        return;
      }
      if (U === "verses" && y.key === "Backspace") {
        y.preventDefault(), y.stopPropagation(), re();
        return;
      }
      const Rt = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(y.key);
      if (U === "verses" && Rt) {
        const Dt = et, Et = ot;
        if (!Dt || !Et || !d) return;
        const Ht = d(Dt, Et);
        if (!Ht) return;
        (Se = lt.current) == null || Se.focus();
        const kt = (() => {
          if (!W) return 1;
          const Ae = W.match(/:(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            kt !== 0 && (le = kt > 1 ? kt - 1 : Ht);
            break;
          case "ArrowRight":
            kt !== 0 && (le = kt < Ht ? kt + 1 : 1);
            break;
          case "ArrowUp":
            le = kt === 0 ? Ht : Math.max(1, kt - he);
            break;
          case "ArrowDown":
            le = kt === 0 ? 1 : Math.min(Ht, kt + he);
            break;
          default:
            return;
        }
        le !== kt && (y.preventDefault(), y.stopPropagation(), L(
          `${Dt} ${fe[Dt] || ""} ${Et}:${le}`
        ), setTimeout(() => {
          const Ae = St.current[le];
          Ae && Ae.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((U === "chapters" || U === "books" && D) && Rt) {
        const Dt = U === "chapters" ? C : D == null ? void 0 : D.book;
        if (!Dt) return;
        U === "chapters" && ((nr = lt.current) == null || nr.focus());
        const Et = (() => {
          if (!W) return 1;
          const he = W.match(/(\d+)$/);
        ...
        switch (y.key) {
          case "ArrowLeft":
            Et !== 0 && (kt = Et > 1 ? Et - 1 : Ht);
            break;
          case "ArrowRight":
            Et !== 0 && (kt = Et < Ht ? Et + 1 : 1);
            break;
          case "ArrowUp":
            kt = Et === 0 ? Ht : Math.max(1, Et - le);
            break;
          case "ArrowDown":
            kt = Et === 0 ? 1 : Math.min(Ht, Et + le);
            break;
          default:
            return;
        }
        kt !== Et && (y.preventDefault(), y.stopPropagation(), L(
          `${Dt} ${fe[Dt] || ""} ${kt}`
        ), setTimeout(() => {
          const he = Qt.current[kt];
    ...
    const { isLetter: X, isDigit: nt } = Yo(y.key);
    (X || nt) && (y.preventDefault(), M(($e) => $e + y.key), Ot.current.focus(), ct(!1));
  }, []);
  return Jt(() => {
    const y = setTimeout(() => {
      if (R && U === "books" && wt.current && ie.current) {
        const X = wt.current, nt = ie.current, Rt = nt.offsetTop, $e = X.clientHeight, Se = nt.clientHeight, nr = Rt - $e / 2 + Se / 2;
        X.scrollTo({
          top: Math.max(0, nr),
          behavior: "smooth"
        }), L(ri(t.book));
    ...
    if (U === "chapters" && C) {
      const y = C === t.book, X = y ? t.chapterNum : 1;
      L(
        `${C} ${fe[C] || ""} ${X}`
      ), setTimeout(() => {
        if (wt.current)
  ...
  }, [U, C, D, t.book, t.chapterNum]), Jt(() => {
    if (U === "verses" && et && ot !== void 0) {
      const y = et === t.book && ot === t.chapterNum, X = y ? t.verseNum : 1;
      L(
        `${et} ${fe[et] || ""} ${ot}:${X}`
      ), setTimeout(() => {
        if (wt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(Be, { open: R, onOpenChange: $t, modal: z, children: [
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        onPointerDownOutside: (y) => {
          const { target: X } = y;
          R && ht.current && X instanceof Node && ht.current.contains(X) && (mt.current = !0, $t(!1));
        },
        onCloseAutoFocus: b,
        children: /* @__PURE__ */ u(
          Ke,
          {
            ...
            shouldFilter: !1,
            children: [
              U === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: ee.map(
                  ({ onClick: y, disabled: X, title: nt, icon: Rt }) => /* @__PURE__ */ a(
                    Z,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  Z,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: U === "verses" ? re : _t,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: T === "ltr" ? /* @__PURE__ */ a(gs, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(fs, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                U === "chapters" && C && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: ze(C, n) }),
                U === "verses" && et && ot !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${ze(et, n)} ${ot}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: U === "verses" ? Or : oe
                  }
                )
              ] }),
              !tt && /* @__PURE__ */ u(He, { ref: wt, children: [
                U === "books" && /* @__PURE__ */ u(dt, { children: [
                  !D && Object.entries(zt).map(([y, X]) => {
                    if (X.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(Me, { heading: x(y), children: X.map((nt) => /* @__PURE__ */ a(
                          ei,
                          {
                            bookId: nt,
                            onSelect: (Rt) => Xe(Rt),
                  ...
                  D && yt && D.chapterNum && d && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${ze(D.book, n)} ${D.chapterNum}` }),
                      /* @__PURE__ */ a("span", { children: Or })
                    ] }),
                    /* @__PURE__ */ a(
                      Xo,
                      {
                  ...
                  D && !yt && dr(D.book) > 1 && /* @__PURE__ */ u(dt, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: ze(D.book, n) }),
                    ...
                    /* @__PURE__ */ a(
                      Wo,
                      {
                        ...
                        setChapterRef: it,
                        isChapterDimmed: I,
                        isChapterDisabled: Pt(D.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                U === "chapters" && C && /* @__PURE__ */ a(
                  Wo,
                  {
                    bookId: C,
                    scrRef: t,
                    onChapterSelect: te,
                    setChapterRef: it,
                    isChapterDisabled: Pt(C),
                    className: "tw:p-4"
                  }
                ),
                U === "verses" && et && ot !== void 0 && d && /* @__PURE__ */ a(
                  Xo,
                  {
                    bookId: et,
                    chapterNum: ot,
...
function Jo({
  ...
  const [_, S] = N(!1), q = d ?? l, T = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], j = (A, R) => {
    const K = l(A), W = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, L = `${R ?? ""}${K}${W ?? ""}`;
    return /* @__PURE__ */ u(
      Ie,
      {
        value: K,
  ...
  return /* @__PURE__ */ u(Be, { open: _, onOpenChange: S, ...k, children: [
    /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ u(
      Z,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Ue,
      {
        ...
        children: /* @__PURE__ */ u(Ke, { children: [
          ...
          /* @__PURE__ */ a(He, { children: T(e) ? e.map((A) => /* @__PURE__ */ a(Me, { heading: A.groupHeading, children: A.options.map((R) => j(R, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(Me, { children: e.map((A) => j(A)) }) })
        ] })
      }
    )
  ] });
...
function Tp({
  ...
  const w = ka(d, "%webView_bookSelector_currentBook%"), p = ka(d, "%webView_bookSelector_choose%"), h = ka(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    f(b), t(b);
    ...
    to,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "tw:flex tw:w-full tw:flex-col tw:gap-4", children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:grid tw:grid-cols-[25%_50%_25%]", children: [
          ...
          /* @__PURE__ */ a(Tt, { className: "tw:flex tw:items-center", children: o.map((b) => Lt.bookIdToEnglishName(b)).join(", ") }),
          /* @__PURE__ */ a(
            Z,
            {
...
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = ni ? Jt : Y, Vr = { tag: uo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            const f = Dr();
            g.append(f);
            const v = ni ? document.activeElement : null;
            (Zt() !== null || v !== null && v === p.getRootElement()) && f.select();
          }
        }, Vr);
...
const Ll = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Gl() {
  return function(t) {
    const [e] = Te(), r = $(() => t(e), [e, t]), [o, n] = N(() => r.initialValueFn()), i = H(o);
    return Hl(() => {
...
function Jl(t, e, r) {
  ...
  function l() {
    ...
    for (let z = 0; z < g.length; z++) {
      const k = g[z], _ = s[z] || document.createElement("div"), S = _.style;
      S.position !== "absolute" && (S.position = "absolute", b = !0);
      const q = ke(k.left - p);
      S.left !== q && (S.left = q, b = !0);
      const T = ke(k.top - h);
      S.top !== T && (_.style.top = T, b = !0);
      const j = ke(k.width);
      S.width !== j && (_.style.width = j, b = !0);
      const A = ke(k.height);
      S.height !== A && (_.style.height = A, b = !0), _.parentNode !== c && (c.append(_), b = !0), s[z] = _;
    }
...
function Ql(t, e = Zl) {
  ...
  function d(w) {
    w.read(() => {
      const p = Zt();
      if (!_e(p)) return r = null, n = null, i = null, c = null, l(), void (l = () => {
      });
      const [h, g] = function(A) {
        const R = A.getStartEndPoints();
        return A.isBackward() ? [R[1], R[0]] : R;
      }(p), f = h.getNode(), v = f.getKey(), b = h.offset, z = g.getNode(), k = z.getKey(), _ = g.offset, S = t.getElementByKey(v), q = t.getElementByKey(k), T = r === null || S !== o || b !== n || v !== r.getKey(), j = i === null || q !== s || _ !== c || k !== i.getKey();
      if ((T || j) && S !== null && q !== null) {
        const A = function(R, K, W, L, Q, M, U) {
          const O = (R._window ? R._window.document : document).createRange();
          return O.setStart(...Zo(K, W, L)), O.setEnd(...Zo(Q, M, U)), O;
        }(t, h, f, S, g, z, q);
        l(), l = Jl(t, A, e);
      }
      r = f, o = S, n = b, i = z, s = q, c = _;
    });
  }
...
function ed(t) {
  const e = Kn(t, (r) => Tr(r) && !r.isInline());
  return Tr(e) || Qr(4, t.__key), e;
}
function rd(t) {
  const e = Zt() || bc();
  let r;
  if (_e(e)) r = xc(e.focus, "next");
  else {
    if (e != null) {
      const s = e.getNodes(), c = s[s.length - 1];
      c && (r = Un(c, "next"));
    }
    r = r || yc(Fe(), "previous").getFlipped().insert(Dr());
  }
...
function ad(t, e, r) {
  ...
  return Sc(o) && Qr(283), o.insert(t.isInline() ? Dr().append(t) : t), Lo(Un(t.getLatest(), "next"), e.direction);
}
function od(t) {
  const e = Zt();
  if (!_e(e)) return !1;
  ...
  for (let n = 0; n < o.length; n++) {
    ...
    if (r.has(s)) continue;
    const c = Kn(i, (d) => Tr(d) && !d.isInline());
    if (c === null) continue;
    const l = c.getKey();
...
let ta, De = 0, ea = 0, sd = 0, Ya = 0, qr = 0;
function tn(t) {
  if (st === void 0) return;
  let e = t.n;
...
Gt.prototype.brand = nd, Gt.prototype.h = function() {
  return !0;
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      De !== 0 && ea === 0 && e.l !== Ya && (e.l = Ya, ta = { S: e, v: e.v, i: e.i, o: ta });
    })(this), this.v = t, this.i++, qr++, De++;
    try {
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, li(this), en(this), De++;
  const t = st;
  return st = this, ld.bind(this, t);
...
we({ build: (t, e, r) => vr(e), config: or({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function di() {
  const t = Fe(), e = Zt(), r = Dr();
  t.clear(), t.append(r), e !== null && r.select(), _e(e) && (e.format = 0);
}
function wi(t, e = di) {
  return t.registerCommand(Hn, (r) => (t.update(e), !0), po);
}
we({ build: (t, e, r) => vr(e), config: or({ $onClear: di }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
  const { $onClear: o } = r.getOutput();
  return Ne(() => wi(t, o.value));
} });
function dd(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Na = Mc("format", { parse: (t) => typeof t == "number" ? t : 0 });
class ui extends Ba {
  $config() {
...
we({ name: "@lexical/extension/DecoratorText", nodes: () => [ui], register: (t, e, r) => t.registerCommand(qn, (o) => {
  const n = Zt();
  if (Gn(n) || _e(n)) for (const i of n.getNodes()) wd(i) && i.toggleFormat(o);
  return !1;
}, Yn) });
function pi(t, e) {
  let r;
...
const Wa = we({ build: (t) => pi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const xo = 0, Xa = 1, gi = 2, Ca = 3, Lr = 4, ir = 5, Ea = 6, yr = 7;
function Ta(t) {
  return t.id === xo;
}
function fi(t) {
...
const fd = we({ config: or({ setOptions: rn, updateOptions: rn }), init: ({ $initialEditorState: t = gd }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [Oc, Bn, Ic, $c, Fn] }), an = Symbol.for("@lexical/extension/LexicalBuilder");
function on() {
}
function md(t) {
  throw t;
...
const vd = /* @__PURE__ */ new Set(), nn = we({ build(t, e, r) {
  const o = r.getDependency(Wa).output, n = Sr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = pi(() => {
  }, () => Ne(() => {
...
we({ dependencies: [Wa, nn], name: "@lexical/extension/HorizontalRule", nodes: () => [pr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(nn).output, n = Sr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return Oe(t.registerCommand(bd, (s) => {
    const c = Zt();
    if (!_e(c)) return !1;
    ...
    const s = [];
    for (const { domNode: c, selectedSignal: l } of n.value.nodeSelections.values()) s.push(Ne(() => {
      const d = c.value;
...
we({ build: (t, e) => vr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: or({ $getParentEditor: function() {
  const t = Uc();
...
we({ build: (t, e, r) => vr(e), config: or({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ne(() => {
...
function kd(t, e, r = mi) {
  return Oe(t.registerCommand(Xc, (o) => {
    const n = Zt();
    if (!_e(n)) return !1;
    o.preventDefault();
    const i = function(s) {
...
we({ build: (t, e, r) => vr(e), config: or({ $canIndent: mi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
  const { disabled: o, maxIndent: n, $canIndent: i } = r.getOutput();
  return Ne(() => {
    if (!o.value) return kd(t, n, i);
  });
} });
const _d = we({ name: "@lexical/react/ReactProvider" });
function Nd() {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (_e(f)) {
                const v = f.anchor;
                let b = v.getNode(), z = 0, k = 0;
                if (Ua(b) && d >= 0 && w >= 0 && (z = d, k = d + w, f.setTextNodeRange(b, z, b, k)), z === k && p === "" || (f.insertRawText(p), b = v.getNode()), Ua(b)) {
                  z = h, k = h + g;
                  const _ = b.getTextContentSize();
                  z = z > _ ? _ : z, k = k > _ ? _ : k, f.setTextNodeRange(b, z, b, k);
                }
...
we({ build: (t, e, r) => vr(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ne(() => r.getOutput().disabled.value ? void 0 : bi(t)) });
function Td(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
const ko = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Jt : Y;
...
function Ld({ content: t, editor: e }) {
  const r = function(s) {
    ...
    return xi(() => {
      ...
      return d(), Oe(s.registerUpdateListener(() => {
        d();
...
function Ud({
  ...
  const [e] = Te(), [r, o] = N(e), [n, i] = N("paragraph"), [s, c] = Bd(), l = () => {
  };
...
function Hd() {
  const { activeEditor: t } = ki(), [e, r] = N([]), o = V((n) => {
    if (_e(n) || dl(n)) {
      const i = [];
      ln.forEach(({ format: s }) => {
...
function Ei({
  ...
  return /* @__PURE__ */ u(eo, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
...
const Xd = "verseText", Sp = Object.freeze([
...
function zp({
  ...
  const [i, s] = N(Jd), [c, l] = N(n), [d, w] = N(!1), p = H(void 0), h = H(null);
  Y(() => {
    let b = !0;
    const z = h.current;
    if (!z) return;
  ...
  const g = V(() => {
    ...
    const b = aa(i);
    e(b, c);
  }, [i, e, c]), f = o["%commentEditor_placeholder%"] ?? "Type your comment here...", v = o["%commentEditor_assignTo_label%"] ?? "Assign to";
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Be, { open: d, onOpenChange: w, children: [
      ...
      /* @__PURE__ */ a(
        Ue,
        {
          ...
          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: t.map((b) => /* @__PURE__ */ a(
            Ie,
            {
              onSelect: () => {
                l(b || void 0), w(!1);
              ...
              children: /* @__PURE__ */ a("span", { children: za(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        onKeyDownCapture: (b) => {
          b.key === "Escape" ? (b.preventDefault(), b.stopPropagation(), r()) : No(b) && (b.preventDefault(), b.stopPropagation(), de(i) && g());
        },
        onKeyDown: (b) => {
          _o(b), (b.key === "Enter" || b.key === " ") && b.stopPropagation();
        },
        children: /* @__PURE__ */ a(
          ra,
          {
...
function wn({
  ...
  }, [t.date, r]), b = $(() => t.user, [t.user]), z = $(
    () => t.user.split(" ").map((T) => T[0]).join("").toUpperCase().slice(0, 2),
    [t.user]
  ), k = $(() => lo(t.contents), [t.contents]), _ = $(
    () => t.contents.replace(/<[^>]*>/g, "").trim().length > 0,
    [t.contents]
  ), S = !!t.conflictResolutionAction && !_, q = $(() => {
    if (o && c)
      return /* @__PURE__ */ u(dt, { children: [
        /* @__PURE__ */ u(
          Qe,
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(Wd(t.contents)), s == null || s(!0);
            },
            children: [
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(ew, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(rw, { className: "tw:text-xs tw:font-medium", children: z }) }),
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : No(T) && (T.preventDefault(), T.stopPropagation(), de(w) && f());
              },
              onKeyDown: (T) => {
                _o(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
              },
              onClick: (T) => {
                T.stopPropagation();
              },
          ...
          !l && /* @__PURE__ */ u(dt, { children: [
            t.status === "Resolved" && !S && /* @__PURE__ */ a("div", { className: "tw:text-sm tw:italic", children: r["%comment_status_resolved%"] }),
        ...
        q && /* @__PURE__ */ u(qe, { children: [
          /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(ys, {}) }) }),
...
function Di({
  ...
  const [L, Q] = N(un), [M, U] = N(), [O, C] = N(), J = o, [et, ft] = N(!1), [ot, Mt] = N(!1), [tt, ct] = N(!1), [ht, mt] = N(!1), [lt, Ot] = N(!1), [wt, ie] = N(S), [Qt, St] = N(!1), xt = H(void 0), [Nt, It] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
      const B = k ? await k(l) : !1;
      x && Ot(B);
    })(), () => {
      x = !1;
    };
  ...
  Y(() => {
    if (!o) {
      vt.current !== "idle" && (U(void 0), C(void 0), vt.current = "idle");
      return;
    }
    vt.current === "idle" && (vt.current = "pending"), ht ? vt.current === "pending" && j !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    j !== i && (U(j), vt.current = "auto-populated") : vt.current === "auto-populated" && (U(void 0), vt.current = "pending");
  }, [o, j, ht, i]);
  const zt = $(
  ...
  const D = $(() => zt[0], [zt]), ue = H(null), se = H(void 0), ce = V(() => {
    var x;
    (x = se.current) == null || x.call(se), Q(un);
  }, []), Xe = V(() => {
    const x = !wt;
    ie(x), St(!x), f == null || f(l, x);
  }, [wt, f, l]);
  Y(() => {
    ft(!1);
  }, [o]), Y(() => {
    if (o && !wt && !Qt) {
      ...
      return xt.current = x, () => clearTimeout(x);
    }
  ...
  }, [i, r]), ee = $(() => zt.slice(1), [zt]), _t = $(() => ee.length ?? 0, [ee.length]), re = $(() => _t > 0, [_t]), $t = $(() => et || _t <= 2 ? ee : ee.slice(-2), [ee, _t, et]), At = $(() => et || _t <= 2 ? 0 : _t - 2, [_t, et]), ve = $(
    () => _t === 1 ? te.singleReply : tr(te.multipleReplies, { count: _t }),
    [_t, te]
  ), be = $(
    () => At === 1 ? te.singleReply : tr(te.multipleReplies, { count: At }),
    [At, te]
  );
  Y(() => {
    !o && ot && re && Mt(!1);
  ...
  const ae = V(
    async (x) => {
      ...
      I && await p({ threadId: l, contents: I }) && ce();
    },
    [
      ce,
      L,
    ...
    async (x) => {
      const I = de(L) ? aa(L) : void 0, B = x.status ? x.assignedUser : M ?? x.assignedUser, G = await p({
        ...x,
        contents: I,
        assignedUser: B
      });
      return G && (B !== void 0 && C(B), I && ce()), G;
    },
    [ce, L, p, M]
  );
  ...
  const F = /* @__PURE__ */ a(
    wn,
    {
      ...
      isThreadExpanded: o,
      threadStatus: w,
      handleAddCommentToThread: E,
      handleUpdateComment: h,
      handleDeleteComment: g,
      onEditingChange: Mt,
      canEditOrDelete: (!ot && Nt.get(D.id)) ?? !1,
      ...
      children: /* @__PURE__ */ u(tw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            pe && /* @__PURE__ */ a(Cr, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: pe }),
            /* @__PURE__ */ a(
              Z,
              {
                variant: "ghost",
            ...
            K === void 0 ? (
              ...
              /* @__PURE__ */ a(
                ...
                {
                  show: lt && w !== "Resolved",
                  onClick: () => E({ threadId: l, status: "Resolved" }),
        ...
        /* @__PURE__ */ u(dt, { children: [
          re && !o && /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            W && $t.length > 0 && /* @__PURE__ */ a("div", { className: "tw:h-2", "data-slot": "root-content-reply-gap", "aria-hidden": "true" }),
            At > 0 && /* @__PURE__ */ u(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    et ? /* @__PURE__ */ a(Ns, {}) : /* @__PURE__ */ a(ur, {})
                  ] })
                ]
              }
            ),
            $t.map((x) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              wn,
              {
                comment: x,
                localizedStrings: r,
                ...
                handleDeleteComment: g,
                onEditingChange: Mt,
                canEditOrDelete: (!ot && Nt.get(x.id)) ?? !1
              }
            ) }, x.id)),
            b !== !1 && (!ot || de(L)) && /* @__PURE__ */ u(
              "div",
              {
                role: "textbox",
                tabIndex: -1,
                ...
                onKeyDownCapture: (x) => {
                  No(x) && (x.preventDefault(), x.stopPropagation(), (de(L) || M !== void 0 && M !== O) && ae());
                },
                onKeyDown: (x) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    M !== void 0 && (de(L) || M !== O) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: tr(
                    ...
                    /* @__PURE__ */ u(Be, { open: tt, onOpenChange: ct, children: [
                      /* @__PURE__ */ a(rr, { asChild: !0, children: /* @__PURE__ */ a(
                        Z,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw:flex tw:items-center tw:justify-center tw:rounded-md",
                          disabled: !ht || !v || v.length === 0 || !v.includes(s),
                      ...
                      /* @__PURE__ */ a(
                        Ue,
                        {
                          ...
                          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: v == null ? void 0 : v.map((x) => /* @__PURE__ */ a(
                            Ie,
                            {
                              onSelect: () => {
                                U(x !== i ? x : void 0), vt.current = "user-selected", C(void 0), ct(!1);
                              },
                              className: "tw:flex tw:items-center",
...
), ow = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Yr = (t) => ow(lo(t));
function Wr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function nw({
  ...
  const [s, c] = N("accept"), l = Vo(), d = Vo(), w = r === "loading", p = r === "accept", h = r === "none", g = r === "acceptRejectOrMerge", f = p ? "accept" : s, v = $(
    () => Yr(t.rejectedText ?? ""),
    [t.rejectedText]
  ), b = $(
    () => Yr(t.acceptedText ?? ""),
    ...
    () => Yr(t.mergedText ?? ""),
    [t.mergedText]
  ), k = $(() => lo(t.contents), [t.contents]);
  if (!Si(t))
    return /* @__PURE__ */ a(Wr, { html: k });
  const _ = (O) => {
    c(O === "reject" || O === "merge" ? O : "accept");
  }, S = e["%conflict_note_stale_notice%"] ?? "The verse was edited after this conflict was recorded, so 'Use the other change' is no longer available. Keep the current text to resolve.", q = g ? [
    {
      value: "merge",
  ...
  let R;
  j ? R = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (R = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), L = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, Q = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Wr, { html: z }) : W : L(O === "reject" ? t.rejectedResultText : t.resultText);
  }, M = (O) => p && O.value === "reject", U = (O) => {
    const C = f === O.value, J = `${d}-${O.value}`, et = M(O);
    return (
      ...
      /* @__PURE__ */ u(
        "label",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("span", { id: l, className: "tw:sr-only", children: S }),
      ...
      !w && !h && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(
          to,
          {
            ...
            children: T.map((O) => M(O) ? /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Bt, { asChild: !0, children: U(O) }),
              /* @__PURE__ */ a(Ut, { children: S })
            ] }) }, O.value) : U(O))
          }
        ),
        /* @__PURE__ */ a(jt, { delayDuration: 0, children: /* @__PURE__ */ u(Ft, { children: [
          /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a("span", { className: "tw:inline-flex tw:self-start", children: /* @__PURE__ */ a(
            Z,
            {
              size: "sm",
              disabled: A,
    ...
    if (e === "Resolved") {
      for (let k = o.length - 1; k >= 0; k -= 1)
        if (o[k].status === "Resolved")
          return zi(o[k].conflictResolutionAction);
      return "accept";
    }
  }, [e, o]) ?? d;
...
function Vp({
  ...
  const [k, _] = N(/* @__PURE__ */ new Set()), [S, q] = N(), [T, j] = N(), A = V(
    async (C) => {
      const J = await i(C);
      return J !== void 0 && C.assignedUser !== void 0 && C.assignedUser !== "" && j(C.assignedUser), J;
    },
    [i]
  );
  Y(() => {
    f && (_((C) => new Set(C).add(f)), q(f));
  }, [f]);
  const R = r.filter(
    (C) => C.comments.some((J) => !J.deleted)
  ), K = R.map((C) => ({ id: C.id })), W = V(
    (C) => {
      _((J) => new Set(J).add(C.id)), q(C.id), v == null || v(C.id);
    },
    [v]
  ), L = V(
    (C) => {
      ...
      _((et) => {
        const ft = new Set(et);
        return ft.has(C) ? ft.delete(C) : ft.add(C), ft;
      }), q(C), v == null || v(J ? void 0 : C);
    },
    [k, v]
  ), { listboxRef: Q, activeId: M, handleKeyDown: U } = Qi({
    options: K,
    onOptionSelect: W
  }), O = V(
    (C) => {
      C.key === "Escape" ? (S && k.has(S) && (_((J) => {
        const et = new Set(J);
        return et.delete(S), et;
      }), q(void 0), v == null || v(void 0)), C.preventDefault(), C.stopPropagation()) : U(C);
    },
    [S, k, U, v]
  );
  return /* @__PURE__ */ a(
      ...
      children: R.map((C) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: C.type === "Conflict" ? /* @__PURE__ */ a(dw, { ...J, conflictResolution: z }) : /* @__PURE__ */ a(Di, { ...J })
          },
          C.id
        );
      })
...
function ww({ table: t }) {
  return /* @__PURE__ */ u(qe, { children: [
    /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ u(Z, { variant: "outline", size: "sm", className: "tw:ml-auto tw:hidden tw:h-8 tw:lg:flex", children: [
      ...
      /* @__PURE__ */ u(
        hr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(mr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ge, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function fw({
  ...
  var T;
  const [w, p] = N([]), [h, g] = N([]), [f, v] = N({}), [b, z] = N({}), k = $(() => e ?? [], [e]), _ = Zn({
    data: k,
    columns: t,
    getCoreRowModel: ti(),
  ...
  let q;
  return l ? q = Array.from({ length: 10 }).map((R, K) => `skeleton-row-${K}`).map((R) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: S.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, R)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? q = _.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(j, _),
      "data-state": j.getIsSelected() && "selected",
      children: j.getVisibleCells().map((A) => /* @__PURE__ */ a(lr, { children: _r(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    j.id
    ...
    n && /* @__PURE__ */ a(ww, { table: _ }),
    /* @__PURE__ */ u(ao, { stickyHeader: i, children: [
      /* @__PURE__ */ a(oo, { stickyHeader: i, children: _.getHeaderGroups().map((j) => /* @__PURE__ */ a(Ve, { children: j.headers.map((A) => /* @__PURE__ */ a(Zr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : _r(A.column.columnDef.header, A.getContext()) }, A.id)) }, j.id)) }),
...
function Up({
  ...
  return /* @__PURE__ */ u(Be, { onOpenChange: (w) => {
    ...
    /* @__PURE__ */ u(Ue, { id: i, className: m("tw:min-w-80 tw:max-w-96", n), children: [
...
function Kp({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(qe, { children: [
    /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ u(Z, { variant: "default", children: [
...
function Cw(t, e, r) {
  ...
  const { kind: o } = e;
  if (o === "enter")
    return t.key === "Enter" ? (ne(t), r.commit(), "ended") : t.key === "Escape" ? (ne(t), r.dismiss(), "ended") : "passed";
  ...
  if (t.key === "ArrowDown" || t.key === "ArrowUp")
    return ne(t), r.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue";
  ...
  if (t.key === "Escape")
    return ne(t), r.dismiss(), "ended";
  if (t.key === " ") {
    if (o === "backslash")
      return ne(t), e.filter === "" ? (r.dismiss(), "ended") : (i = e.shouldSpaceCommit) != null && i.call(e, e.filter) ? (r.commit(), "ended") : (r.commitTyped(e.filter), r.dismiss(), "ended");
    ne(t);
    const s = e.filter.toLowerCase(), c = e.items.find((l) => l.marker.toLowerCase() === s);
    return c && r.commitItem(c.marker), r.dismiss(), "ended";
  }
  return t.key === "*" ? o === "selection" && e.filter === "" ? (ne(t), r.dismiss(), "ended") : (ne(t), r.commitTypedCloser(e.filter), r.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (r.dismiss(), "ended") : (ne(t), r.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (ne(t), r.dismiss(), "ended") : t.key === "Backspace" || Oi[o].test(t.key) ? (ne(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, r.update({ filterText: e.filter }), "continue") : (o === "selection" && ne(t), r.dismiss(), "ended");
}
function Ra(t, e) {
  var r;
...
function Tw({
  ...
  return /* @__PURE__ */ u(eo, { children: [
    ...
    e && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(
        Z,
        {
          "aria-label": w,
...
function Rw({
  ...
  const i = H(null), s = H(null), c = H(!1), [l, d] = N(t), [w, p] = N(r), [h, g] = N(!1), f = H(l);
  f.current = l;
  const v = H(w);
  v.current = w, Y(() => {
    d(t);
  ...
  const b = (k) => {
    if (c.current = !1, g(k), !k) {
      const _ = f.current, S = v.current;
      _ !== "custom" || S ? (_ !== t && e(_), S !== r && o(S)) : (d(t), p(r));
    }
  }, z = (k) => {
    var _, S, q, T;
    k.stopPropagation(), document.activeElement === s.current && k.key === "ArrowDown" || k.key === "ArrowRight" ? ((_ = i.current) == null || _.focus(), c.current = !0) : document.activeElement === i.current && k.key === "ArrowUp" ? ((S = s.current) == null || S.focus(), c.current = !1) : document.activeElement === i.current && k.key === "ArrowLeft" && ((q = i.current) == null ? void 0 : q.selectionStart) === 0 && ((T = s.current) == null || T.focus(), c.current = !1), l === "custom" && k.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && b(!1);
  };
  return /* @__PURE__ */ u(qe, { open: h, onOpenChange: b, children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: zw(t, n, r) }) }) }),
    ...
    /* @__PURE__ */ u(
      Ye,
      {
        ...
        children: [
          /* @__PURE__ */ a(zr, { children: n["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ a(er, {}),
          /* @__PURE__ */ a(
            Le,
            {
          ...
          /* @__PURE__ */ a(
            Le,
            {
              ...
              onClick: (k) => {
                var _;
                k.stopPropagation(), c.current = !0, (_ = i.current) == null || _.focus();
              },
...
function Ow({
  ...
  return /* @__PURE__ */ u(qe, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ a(Z, { variant: "outline", className: "tw:h-6", children: Dw(t, r) }) }) }),
...
function Pw({
  ...
  return /* @__PURE__ */ u(Ke, { className: "tw:p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ u(He, { children: [
      ...
      /* @__PURE__ */ a(Me, { children: s.map((l) => {
        var d;
        return /* @__PURE__ */ a(
          gn,
          {
      ...
      c.length > 0 && /* @__PURE__ */ u(dt, { children: [
        ...
        /* @__PURE__ */ a(Me, { children: c.map((l) => {
          var d;
          return /* @__PURE__ */ a(
            gn,
            {
...
function Yp({
  ...
  var ae;
  const h = H(null), g = H(null), f = H(null), v = H(null);
  Jt(() => {
    if (!v.current) return;
    const { width: E } = v.current.getBoundingClientRect();
    E > 0 && (v.current.style.width = `${E}px`);
  }, []);
  const [b, z] = N("generated"), [k, _] = N("generated"), [S, q] = N("*"), [T, j] = N("*"), [A, R] = N("f"), [K, W] = N(!1), [L, Q] = N(!0), [M, U] = N(!1), O = H(!1), C = H(""), [J, et] = N(!1), [ft, ot] = N(), [Mt, tt] = N(), [ct, ht] = N(), [mt, lt] = N(), Ot = H(null), wt = H(void 0), ie = H(0), Qt = H(void 0), St = $(
    () => ({
      ...s,
  ...
  Y(() => {
    var E;
    J || (E = h.current) == null || E.focus();
  }, [A, J]);
  const Nt = V(() => {
    var I, B, G;
    const E = (I = g.current) == null ? void 0 : I.querySelector(".editor-input"), F = E == null ? void 0 : E.querySelector("span.note"), x = (G = (B = g.current) == null ? void 0 : B.ownerDocument.getSelection()) == null ? void 0 : G.anchorNode;
    return !!F && !!x && F.contains(x);
  }, []);
  Y(() => {
    var B, G;
    let E, F, x;
    O.current = !1, Qt.current = void 0, Q(!0);
    const I = e == null ? void 0 : e.at(0);
    if (I && xr("note", I)) {
      const at = (B = I.insert.note) == null ? void 0 : B.caller;
      let it = "custom";
      at === Ka ? it = "generated" : at === Ha ? it = "hidden" : at && (q(at), j(at)), z(it), _(it), R(((G = I.insert.note) == null ? void 0 : G.style) ?? "f"), E = setTimeout(() => {
        var gt, bt, yt;
        (gt = h.current) == null || gt.applyUpdate([I]), (bt = h.current) == null || bt.selectNote(0), (yt = h.current) == null || yt.focus(), F = requestAnimationFrame(() => {
          x = setTimeout(() => {
            var Ct, Pt;
            Nt() || ((Ct = h.current) == null || Ct.selectNote(0), (Pt = h.current) == null || Pt.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      E && clearTimeout(E), F !== void 0 && cancelAnimationFrame(F), x !== void 0 && clearTimeout(x);
    };
  }, [e, i, Nt]);
  const It = V(
    (E = !1) => {
      var x, I, B;
      p == null || p();
      const F = (I = (x = h.current) == null ? void 0 : x.getNoteOps(0)) == null ? void 0 : I.at(0);
      F && xr("note", F) && (r == null || r([F]), E && d && i && ((B = d.current) == null || B.replaceEmbedUpdate(i, [F])));
    },
    [i, r, p, d]
  ), vt = V(
    (E, F) => {
      var B, G, at;
      const x = (G = (B = h.current) == null ? void 0 : B.getNoteOps(0)) == null ? void 0 : G.at(0);
      if (!x || !xr("note", x) || !x.insert.note) return;
      let I;
      E === "custom" ? I = F : E === "generated" ? I = Ka : I = Ha, x.insert.note.caller !== I && (x.insert.note.caller = I, (at = h.current) == null || at.applyUpdate([x, { delete: 1 }]));
    },
    []
  ), zt = V(() => {
    var E;
    wt.current || (E = h.current) == null || E.commitPendingMarkerEdits(), It(!0), o();
  }, [o, It]), D = H(zt);
  Jt(() => {
    D.current = zt;
  });
  const ue = H({ book: n.book, chapterNum: n.chapterNum });
  Jt(() => {
    (ue.current.book !== n.book || ue.current.chapterNum !== n.chapterNum) && (ue.current = { book: n.book, chapterNum: n.chapterNum }, D.current());
  }, [n.book, n.chapterNum]);
  const se = () => {
    var F;
    ...
    if (F && xr("note", F)) {
      ...
      const it = (G = (B = F.insert.note) == null ? void 0 : B.contents) == null ? void 0 : G.ops;
      A !== "x" && E === "x" ? it == null || it.forEach((gt) => jw(gt)) : A === "x" && E !== "x" && (it == null || it.forEach((gt) => Fw(gt))), (at = h.current) == null || at.applyUpdate([F, { delete: 1 }]);
    }
  }, pe = (E) => {
    lt(E.contextMarker), U(E.canRedo);
  }, ee = V(
    (E) => {
      var x, I, B, G, at;
      const F = (I = (x = h.current) == null ? void 0 : x.getNoteOps(0)) == null ? void 0 : I.at(0);
      if (F && xr("note", F)) {
        ...
        const it = (B = F.insert.note) == null ? void 0 : B.style, gt = (at = (G = F.insert.note) == null ? void 0 : G.contents) == null ? void 0 : at.ops;
        if (it || W(!1), W(
          it === "x" ? !!(gt != null && gt.every((bt) => {
            var Ct, Pt;
            if (!((Ct = bt.attributes) != null && Ct.char)) return !0;
            const yt = ((Pt = bt.attributes) == null ? void 0 : Pt.char).style;
          ...
          O.current = !0, C.current = JSON.stringify(F), Q(!0);
          return;
        }
        Q(JSON.stringify(F) === C.current), It();
      } else
        W(!1), Q(!0);
    },
    [It]
    ...
    if (f.current && xt.length && E && E.rangeCount > 0) {
      const F = E.getRangeAt(0).getBoundingClientRect(), x = f.current.getBoundingClientRect();
      ot(F.left - x.left), tt(F.top - x.top), ht(F.height), et(!0);
    }
  }, [xt, f]), re = H(() => {
  }), $t = V(
    (E, F, x) => {
      const { anchorRect: I } = E;
      if (!w || !I) return;
      const { passive: B } = x;
      ie.current += 1;
      const G = ie.current;
      wt.current = {
        ...
        keys: Nw(B ? "backslash" : "selection"),
        onKey: (at) => re.current(at)
      }).then((at) => {
        var it, gt, bt, yt, Ct, Pt;
        if (Ra(wt, G), at !== void 0) {
          if (!((it = h.current) != null && it.getSelection())) {
            const oe = Qt.current;
            oe ? (gt = h.current) == null || gt.setSelection(oe) : (bt = h.current) == null || bt.selectNote(0);
          }
          (yt = h.current) == null || yt.focus();
          const xe = F.find((oe) => oe.marker === at);
          xe && ((Ct = h.current) == null || Ct.applyMarkerMenuSelection(xe, {
            trigger: "backslash",
        ...
        } else B || (Pt = h.current) == null || Pt.focus();
      }).catch((at) => {
        var it;
        Ra(wt, G), B || (it = h.current) == null || it.focus(), (!Qs(at) || at.code !== tc) && console.warn(
          `FootnoteEditor: the marker palette did not open: ${ec(at)}`
        );
      });
    },
    [w]
    ...
    var x;
    const E = (x = h.current) == null ? void 0 : x.getMarkerMenuContext();
    if (!E) return !1;
    const F = bl(St.styleInfo ?? xl, E);
    return F.length === 0 ? !1 : ($t(E, F, { passive: !E.hasTextSelection }), !0);
  }, [$t, St.styleInfo]), ve = V(
    (E) => {
      const F = wt.current;
      if (!F || !w) return;
      Cw(E, F, {
        ...
        commitTyped: (I) => {
          var B;
          return (B = h.current) == null ? void 0 : B.commitTypedMarker(I);
        },
        commitTypedAndReopen: (I) => {
          var B;
          (B = h.current) == null || B.commitTypedMarker(I, { trailingSpace: !1 }), At();
        },
        commitTypedCloser: (I) => {
          var B;
          return (B = h.current) == null ? void 0 : B.commitTypedCloser(I);
        },
        commitItem: (I) => {
          var G;
          const B = F.items.find((at) => at.marker === I);
          B && ((G = h.current) == null || G.applyMarkerMenuSelection(B, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const E = (F) => {
      var B, G;
      const x = (B = g.current) == null ? void 0 : B.querySelector(".editor-input");
      if (!x || F.target !== x) return;
      const I = (G = h.current) == null ? void 0 : G.getSelection();
      I && (Qt.current = I);
    };
    ...
    var E;
    J && ((E = Ot.current) == null || E.focus());
  }, [J]), Y(() => {
    var x;
    const E = () => {
      var I;
      return ((I = g.current) == null ? void 0 : I.querySelector(".editor-input")) ?? void 0;
    };
    if (((x = St.view) == null ? void 0 : x.markerMode) === "editable") {
      const I = (G) => {
        var gt, bt, yt, Ct;
        if (Mi(G)) return;
        const at = E();
        ...
        if (G.key === "Enter" && !Nt()) {
          G.preventDefault(), G.stopPropagation(), (gt = h.current) == null || gt.selectNote(0), (bt = h.current) == null || bt.focus();
          return;
        }
        if (w && G.key === c) {
          if (!Nt()) {
            G.preventDefault(), G.stopPropagation(), (yt = h.current) == null || yt.selectNote(0), (Ct = h.current) == null || Ct.focus();
            return;
          }
          At() && (G.preventDefault(), G.stopPropagation());
        }
      }, B = () => {
        var at, it;
        const G = E();
        !G || document.activeElement !== G || Nt() || ((at = h.current) == null || at.selectNote(0), (it = h.current) == null || it.focus());
      };
      return document.addEventListener("keydown", I, { capture: !0 }), document.addEventListener("paste", B, { capture: !0 }), () => {
        document.removeEventListener("keydown", I, { capture: !0 }), document.removeEventListener("paste", B, { capture: !0 });
      };
    }
    const F = (I) => {
      const B = E();
      !J && B && document.activeElement === B && I.key === c ? (I.preventDefault(), _t()) : J && I.key === "Escape" && (I.preventDefault(), et(!1));
    };
    ...
    _t,
    c,
    (ae = St.view) == null ? void 0 : ae.markerMode,
    St.styleInfo,
    w,
    At,
    Nt
    ...
    const E = () => {
      var I, B, G;
      const F = ((I = g.current) == null ? void 0 : I.querySelector(".editor-input")) ?? void 0;
      if (!F || document.activeElement !== F) return;
      const x = document.getSelection();
      x && !x.isCollapsed || Nt() || ((B = h.current) == null || B.selectNote(0), (G = h.current) == null || G.focus());
    };
  ...
  const be = l["%footnoteEditor_copyButton_tooltip%"];
  return /* @__PURE__ */ u(dt, { children: [
      ...
      /* @__PURE__ */ u(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
              /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(
                Z,
                {
                  "aria-label": be,
              ...
              /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ a("p", { children: be }) })
            ] }) }) })
          ]
        }
      )
...
function Hw({
  ...
  /* @__PURE__ */ u("span", { className: m("note-caller tw:inline-block", { formatted: i }), children: [
    ...
    Co(t.marker, [s], o, !1),
    " "
  ] }), h = e === "horizontal" ? "horizontal" : "vertical", g = o ? "marker-visible" : "", f = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", v = m(h, g);
  return /* @__PURE__ */ u(dt, { children: [
    /* @__PURE__ */ u("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", v), children: [
      l,
      w
    ] }),
    /* @__PURE__ */ a("div", { className: m("textual-note-header tw:col-span-1 tw:w-fit tw:text-nowrap", v), children: p }),
    /* @__PURE__ */ a(
      "div",
      {
        className: m(
...
function Xp({
  ...
  const w = l ?? rc(r, void 0), p = (_, S) => {
    d == null || d(_, S, n);
  }, h = i ? r.findIndex((_) => _ === i) : -1, [g, f] = N(h), v = (_, S, q) => {
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), d == null || d(S, q, n);
          break;
      }
  }, b = (_) => {
    if (r.length)
      switch (_.key) {
        case "ArrowDown":
          _.preventDefault(), f((S) => Math.min(S + 1, r.length - 1));
          break;
        case "ArrowUp":
          _.preventDefault(), f((S) => Math.max(S - 1, 0));
          break;
      }
  }, z = H([]);
  Y(() => {
    var _;
    g >= 0 && g < z.current.length && ((_ = z.current[g]) == null || _.focus());
  }, [g]);
  const k = i ? r.findIndex((_) => _ === i) : -1;
  return Y(() => {
    var _;
    k < 0 || k >= z.current.length || (_ = z.current[k]) == null || _.scrollIntoView({ block: "nearest" });
  }, [k]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
                  ...
                  "li",
                  {
                    ...
                    children: /* @__PURE__ */ a(
                      Hw,
                      {
                        footnote: _,
                        layout: o,
                        formatCaller: () => w(_.caller, S),
                        showMarkers: s
                      }
                    )
                  }
                ),
                S < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Er, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, T)
            );
          })
        }
  ...
  return /* @__PURE__ */ u(ao, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ a(no, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Ve,
      {
        ...
        children: [
          /* @__PURE__ */ a(lr, { children: Re(c.reference, "English") }),
          /* @__PURE__ */ a(lr, { className: o, children: qw(c.text) })
        ]
      },
...
const Yw = (t) => {
...
}, pa = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Bt,
    {
  ...
  return e ? e[1] : "";
}, Xw = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", ah = Object.freeze([
...
function oh({
  ...
  const g = ye(r, "%webView_inventory_all%"), f = ye(r, "%webView_inventory_approved%"), v = ye(r, "%webView_inventory_unapproved%"), b = ye(r, "%webView_inventory_unknown%"), z = ye(r, "%webView_inventory_scope_currentBook%"), k = ye(r, "%webView_inventory_scope_chapter%"), _ = ye(r, "%webView_inventory_scope_verse%"), S = ye(r, "%webView_inventory_filter_text%"), q = ye(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = ye(r, "%webView_inventory_no_results%"), [j, A] = N(!1), [R, K] = N("all"), [W, L] = N(""), [Q, M] = N([]), U = $(() => {
    const tt = t ?? [];
    return tt.length === 0 ? [] : Zw(tt, n, i);
  }, [t, n, i]), O = $(() => {
    if (j) return U;
    const tt = [];
    return U.forEach((ct) => {
      const ht = ct.items[0], mt = tt.find(
        (lt) => lt.items[0] === ht
      );
      mt ? (mt.count += ct.count, mt.occurrences = mt.occurrences.concat(ct.occurrences)) : tt.push({
        items: [ht],
        count: ct.count,
  ...
  }, [j, U]), C = $(() => O.length === 0 ? [] : Jw(O, R, W), [O, R, W]), J = $(() => {
    var ht, mt;
    if (!j) return l;
  ...
  Y(() => {
    C.length === 0 ? M([]) : C.length === 1 && M(C[0].items);
  }, [C]);
  const et = (tt, ct) => {
    ct.setRowSelection(() => {
      const mt = {};
    ...
    if (O.length === 0 || Q.length === 0) return [];
    const tt = O.filter((ct) => ac(
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
        ...
        hr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ u(mr, { children: [
              /* @__PURE__ */ a(ge, { value: "all", children: g }),
              /* @__PURE__ */ a(ge, { value: "approved", children: f }),
              /* @__PURE__ */ a(ge, { value: "unapproved", children: v }),
              /* @__PURE__ */ a(ge, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ u(hr, { onValueChange: (tt) => ft(tt), defaultValue: s, children: [
        /* @__PURE__ */ a(fr, { className: "tw:m-1 tw:w-auto tw:flex-1", children: /* @__PURE__ */ a(gr, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ u(mr, { children: [
          /* @__PURE__ */ a(ge, { value: "book", children: z }),
          /* @__PURE__ */ a(ge, { value: "chapter", children: k }),
          /* @__PURE__ */ a(ge, { value: "verse", children: _ })
        ] })
      ] }),
      /* @__PURE__ */ a(
        sa,
      ...
      o && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
        /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ u("div", { className: "tw:m-1 tw:flex tw:w-fit tw:min-w-[26px] tw:items-center tw:rounded-md tw:border", children: [
          ...
          /* @__PURE__ */ a(Tt, { className: "tw:m-1 tw:truncate", children: (o == null ? void 0 : o.checkboxText) ?? q })
        ] }) }),
        /* @__PURE__ */ a(Ut, { children: (o == null ? void 0 : o.checkboxText) ?? q })
      ] }) })
    ] }),
...
const Qw = "16rem", tu = "3rem", $i = Yt.createContext(void 0);
function ha() {
...
function eu({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    (_) => {
      const S = typeof _ == "function" ? _(w) : _;
      r ? r(S) : d(S);
    },
    [r, w]
  ), h = Yt.useCallback(() => p((_) => !_), [p]), g = w ? "expanded" : "collapsed", b = Ce() === "ltr" ? s : s === "primary" ? "secondary" : "primary", z = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
  ...
  return /* @__PURE__ */ a($i.Provider, { value: z, children: /* @__PURE__ */ a(
    "div",
    {
...
function cu({
  ...
  const c = t ? Mr.Root : "button", { state: l } = ha(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    ru,
    {
      ...
      children: /* @__PURE__ */ u(ou, { children: [
        /* @__PURE__ */ u(fn, { children: [
          ...
          /* @__PURE__ */ a(vn, { children: /* @__PURE__ */ a(nu, { children: Object.entries(e).map(([g, f]) => /* @__PURE__ */ a(iu, { children: /* @__PURE__ */ a(
            cu,
            {
              onClick: () => d(g),
              isActive: h(g),
...
const Pe = "scrBook", du = "scrRef", Ze = "source", wu = "details", uu = "Scripture Reference", pu = "Scripture Book", Ai = "Type", hu = "Details";
function gu(t, e) {
  const r = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? Lt.bookIdToEnglishName(n.start.book) : o.row.groupingColumnId === Pe ? Re(n.start) : void 0;
      },
...
}, bn = (t) => `${fu({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function bh({
  sources: t,
  ...
  const [d, w] = N([]), [p, h] = N([{ id: Pe, desc: !1 }]), [g, f] = N({}), v = $(
    () => t.flatMap((R) => R.data.map((K) => ({
      ...K,
      source: R.source
    }))),
    [t]
  ...
  Y(() => {
    if (c) {
      const R = z.getSelectedRowModel().rowsById, K = Object.keys(R);
      if (K.length === 1) {
        const W = v.find((L) => bn(L) === K[0]) || void 0;
        W && c(W);
      }
    }
  }, [g, v, c, z]);
  const k = n ?? pu, _ = i ?? Ai, S = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${k}`, value: [Pe] },
  ...
  }, j = (R, K) => R.getIsGrouped() ? "" : m("banded-row", K % 2 === 0 ? "even" : "odd"), A = (R, K, W) => {
    if (!((R == null ? void 0 : R.length) === 0 || K.depth < W.column.getGroupedIndex())) {
      if (K.getIsGrouped())
        switch (K.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      hr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(mr, { position: "item-aligned", children: /* @__PURE__ */ a(uw, { children: S.map((R) => /* @__PURE__ */ a(ge, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(ao, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(oo, { children: z.getHeaderGroups().map((R) => /* @__PURE__ */ a(Ve, { children: R.headers.filter((K) => K.column.columnDef.header).map((K) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(Zr, { colSpan: K.colSpan, className: "tw:sticky top-0", children: K.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          _r(K.column.columnDef.header, K.getContext())
        ] }) }, K.id)
      )) }, R.id)) }),
      /* @__PURE__ */ a(no, { children: z.getRowModel().rows.map((R, K) => {
        const W = Ce();
        return /* @__PURE__ */ a(
          Ve,
          {
            ...
            className: m(j(R, K)),
            onClick: (L) => T(R, L),
            children: R.getVisibleCells().map((L) => {
              if (!(L.getIsPlaceholder() || L.column.columnDef.enableGrouping && !L.getIsGrouped() && (L.column.columnDef.id !== Ze || !r)))
                return /* @__PURE__ */ a(
                  lr,
                  {
                    className: m(
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      Z,
                      {
                        ...
                        children: [
                          ...
                          !R.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(La, {}) : /* @__PURE__ */ a(Va, {})),
                          " ",
                          _r(L.column.columnDef.cell, L.getContext()),
                          " (",
                          R.subRows.length,
                          ")"
                        ]
...
function mu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [b, z] = N(!1), [k, _] = N(""), S = H(void 0), q = H(!1), T = $(
    () => Sn(t),
    [t]
  ), j = $(() => {
    if (!k.trim()) {
    ...
    (M, U = !1) => {
      ...
      const O = T.findIndex((ot) => ot === S.current), C = T.findIndex((ot) => ot === M);
      if (O === -1 || C === -1) return;
      const [J, et] = [
        Math.min(O, C),
        Math.max(O, C)
      ], ft = T.slice(J, et + 1).map((ot) => ot);
      r(
    ...
    A(M, q.current), q.current = !1;
  }, K = (M, U) => {
    M.preventDefault(), A(U, M.shiftKey);
  }, W = () => {
    r(T.map((M) => M));
  }, L = () => {
    r([]);
    ...
    () => Object.values(pt).filter(
      (M) => (i == null ? void 0 : i[M]) !== void 0 && io(T, M).length === 0
              ...
              Ke,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u(He, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(pt).filter((M) => j[M].length > 0).map((M, U) => {
                      const O = j[M];
                      return /* @__PURE__ */ u(la, { children: [
                        U > 0 && /* @__PURE__ */ a(En, { alwaysRender: !0 }),
                        /* @__PURE__ */ a(
                          Me,
                          {
                            heading: yn(M, h, g, f, v),
                  ...
                  Q.length > 0 && /* @__PURE__ */ a("div", { className: "tw:shrink-0 tw:border-t tw:p-2", children: Q.map(({ section: M, explanation: U }) => /* @__PURE__ */ a("p", { className: "tw:text-xs tw:text-muted-foreground", children: U }, M)) })
                ]
              }
            )
          }
...
function bu({
  ...
  return /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
    /* @__PURE__ */ a(Bt, { asChild: !0, children: /* @__PURE__ */ a(
      vu,
      {
        className: o,
...
function xu({
  ...
  const s = io(e, t).length === 0, c = n["%scripture_section_ot_short%"], l = n["%scripture_section_nt_short%"], d = n["%scripture_section_dc_short%"], w = n["%scripture_section_extra_short%"], p = /* @__PURE__ */ a(
    Z,
    {
      variant: "outline",
      size: "sm",
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Ma ? Ma : xn
      ).map((d) => /* @__PURE__ */ a(Cr, { className: "tw:hover:bg-secondary", variant: "secondary", children: ze(d, n) }, d)),
...
function yh({
  ...
  const q = Vt(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = Vt(s, "%webView_scope_selector_verse%"), j = Vt(s, "%webView_scope_selector_chapter%"), A = Vt(s, "%webView_scope_selector_book%"), R = Vt(
    s,
    "%webView_scope_selector_current_verse%"
  ), K = Vt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), W = Vt(s, "%webView_scope_selector_current_book%"), L = Vt(s, "%webView_scope_selector_choose_books%"), Q = Vt(s, "%webView_scope_selector_scope%"), M = Vt(s, "%webView_scope_selector_select_books%"), U = Vt(s, "%webView_scope_selector_range%"), O = Vt(s, "%webView_scope_selector_select_range%"), C = Vt(s, "%webView_scope_selector_range_start%"), J = Vt(s, "%webView_scope_selector_range_end%"), et = Vt(s, "%webView_scope_selector_ok%"), ft = Vt(s, "%webView_scope_selector_cancel%"), ot = Vt(s, "%webView_scope_selector_navigate%"), Mt = (P) => {
    if (!v) return;
  ...
  ], ct = (P, rt, Xt = !1) => /* @__PURE__ */ u(dt, { children: [
    P,
    rt && !Xt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      rt
    ] })
  ] }), ht = e ? tt.filter((P) => e.includes(P.value)) : tt, mt = v ?? ba, lt = p ?? mt, Ot = h ?? mt, wt = () => {
  }, ie = H(null), Qt = H(null), St = H(!1), xt = H(null), Nt = H(!1), [It, vt] = N(void 0), zt = H(!1), D = H(!1), ue = H(null), se = V((P) => {
    if (P) {
      vt("start"), zt.current = !1;
      return;
    }
    vt((rt) => rt === "start" ? void 0 : rt), zt.current && (zt.current = !1, requestAnimationFrame(() => {
      var Xt;
      const rt = (Xt = ie.current) == null ? void 0 : Xt.querySelector("button");
      rt == null || rt.click();
    }));
  }, []), ce = V((P) => {
    if (P) {
    ...
    (P) => {
      g == null || g(P), f == null || f(P), zt.current = !0;
    },
    [g, f]
  ), te = V(
    (P) => {
      f == null || f(P), D.current = !0;
    },
    [f]
  ), pe = V(
    (P) => {
      r(P), P === "selectedBooks" && n.length === 0 && (v != null && v.book) && i([v.book]);
    },
    [r, n, v, i]
  ), ee = ht.find((P) => P.value === t), _t = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? oc(lt, Ot, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : ee ? ct(ee.label, ee.scrRefSuffix) : t, re = ht.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), $t = ht.find((P) => P.value === "selectedBooks"), At = ht.find((P) => P.value === "range"), [ve, be] = N(!1), [ae, E] = N(void 0), [F, x] = N(void 0), [I, B] = N(void 0), [G, at] = N(void 0), [it, gt] = N([]), bt = w === "dropdown" && ae === "selectedBooks", yt = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
      selectedBookIds: bt ? it : n,
      onChangeSelectedBookIds: bt ? gt : i,
      localizedStrings: s,
      localizedBookNames: c,
      disabledSectionExplanations: l
    }
  ), Ct = It === "end", Pt = It === "start", xe = "tw:text-muted-foreground", oe = w === "dropdown" && ae === "range", Or = oe ? B : Xe, ga = oe ? at : f ? te : wt, Ir = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-start", className: m(Ct && xe), children: C }),
      /* @__PURE__ */ a(
        ya,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ie, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { htmlFor: "scope-range-end", className: m(Pt && xe), children: J }),
      /* @__PURE__ */ a(
        ya,
        {
          id: "scope-range-end",
          ...
          localizedStrings: z,
          getEndVerse: k,
          disableReferencesUpTo: oe ? I ?? lt : lt,
          onOpenChange: ce,
          onCloseAutoFocus: (P) => {
            var rt;
            D.current && (D.current = !1, P.preventDefault(), (rt = ue.current) == null || rt.focus());
          },
          className: m(Pt && xe),
          modal: !0,
          align: "start"
  ...
  Y(() => {
    ...
    const rt = requestAnimationFrame(() => {
      P = requestAnimationFrame(() => {
        var Xt;
        (Xt = y.current[t]) == null || Xt.focus();
      });
    });
    return () => {
      cancelAnimationFrame(rt), P && cancelAnimationFrame(P);
    };
  }, [ve, t]);
  const [Rt, $e] = N(null), [Se, nr] = N(null), [Dt, Et] = N(null), Ht = 200, [kt, le] = N(!1);
  Y(() => {
    if (!Dt || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([rt]) => {
      le(rt.contentRect.width < Ht);
    });
    return P.observe(Dt), () => P.disconnect();
  }, [Dt]);
  const he = V(
    (P) => {
      x(P), B(lt), at(Ot), gt(n), be(!1), E(P);
    },
    [lt, Ot, n]
  ), Ae = V(() => {
    F !== void 0 && (F === "range" ? (I && (g == null || g(I)), G && (f == null || f(G))) : F === "selectedBooks" && i(it), pe(F), E(void 0), x(void 0));
  }, [
    F,
    I,
    G,
    ...
    var rt;
    P.preventDefault(), (rt = nt.current) == null || rt.focus();
  }, []), So = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      !_ && /* @__PURE__ */ a(Tt, { children: Q }),
      w === "dropdown" ? /* @__PURE__ */ u(qe, { open: ve, onOpenChange: be, children: [
        /* @__PURE__ */ a(Ge, { asChild: !0, children: /* @__PURE__ */ u(
          Z,
          {
            ...
            children: [
              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: _t() }),
              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
            ]
          }
        ) }),
        /* @__PURE__ */ a(
          Ye,
          {
            ...
            children: /* @__PURE__ */ u(fa, { container: Dt, children: [
              re.map(({ value: P, label: rt, dropdownLabel: Xt, scrRefSuffix: br, id: Hi }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: X(P),
                  ...
                  children: [
                    t === P && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(je, { className: "tw:h-4 tw:w-4" }) }),
                    ct(Xt ?? rt, br, kt)
                  ]
                },
                Hi
              ...
              b && /* @__PURE__ */ u(dt, { children: [
                /* @__PURE__ */ a(er, {}),
                /* @__PURE__ */ a(zr, { className: "tw:px-2 tw:py-1.5 tw:text-xs tw:font-medium tw:text-muted-foreground", children: ot }),
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ref: xt,
                    ...
                    onSelect: (P) => {
                      var rt, Xt;
                      if (P.preventDefault(), St.current) {
                        St.current = !1;
                        return;
                      }
                      Nt.current || (Xt = (rt = Qt.current) == null ? void 0 : rt.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        onPointerDownCapture: (P) => {
                          const rt = P.target instanceof HTMLElement ? P.target : void 0;
                          rt != null && rt.closest("button") && (St.current = !0, requestAnimationFrame(() => {
                            St.current = !1;
                          }));
                        },
                        children: /* @__PURE__ */ a(
                          ya,
                          {
                            ...
                            onCloseAutoFocus: (P) => {
                              var rt;
                              P.preventDefault(), (rt = xt.current) == null || rt.focus();
                            },
                            modal: !0,
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Re(v ?? ba, "id") }),
                              /* @__PURE__ */ a(ur, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        to,
        {
          ...
          children: ht.map(({ value: P, label: rt, scrRefSuffix: Xt, id: br }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Jr, { className: "tw:me-2", value: P, id: br }),
            /* @__PURE__ */ a(Tt, { htmlFor: br, children: ct(rt, Xt) })
          ] }, br))
        }
      )
    ] }),
    w === "radio" && t === "selectedBooks" && /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Tt, { children: M }),
      yt
    ] }),
    w === "radio" && t === "range" && Ir,
    w === "dropdown" && $t && /* @__PURE__ */ a(Oa, { open: ae === "selectedBooks", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ia,
      {
        ref: nr,
        onCloseAutoFocus: To,
        onEscapeKeyDown: (P) => {
          Se != null && Se.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(fa, { container: Se, children: [
          /* @__PURE__ */ a($a, { className: "tw:pe-8", children: /* @__PURE__ */ a(Aa, { children: L }) }),
          yt,
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => $r(!1), children: ft }),
            /* @__PURE__ */ a(Z, { onClick: Ae, children: et })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && At && /* @__PURE__ */ a(Oa, { open: ae === "range", onOpenChange: $r, children: /* @__PURE__ */ a(
      Ia,
      {
        ref: $e,
        onCloseAutoFocus: To,
        onEscapeKeyDown: (P) => {
          Rt != null && Rt.querySelector('[data-state="open"]') && P.preventDefault();
        },
        children: /* @__PURE__ */ u(fa, { container: Rt, children: [
          ...
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => $r(!1), children: ft }),
            /* @__PURE__ */ a(Z, { ref: ue, onClick: Ae, children: et })
          ] })
        ] })
      }
    ) })
...
function kh({
  ...
  return /* @__PURE__ */ u(
    hr,
    {
      ...
      disabled: c,
      children: [
        /* @__PURE__ */ a(fr, { size: n, className: m("pr-twp tw:w-auto", i), children: /* @__PURE__ */ a(
          gr,
          {
            placeholder: l[$o(e)] ?? e
          }
        ...
        /* @__PURE__ */ a(
          mr,
          {
            ...
            style: { zIndex: ar },
            children: t.map((w) => /* @__PURE__ */ a(ge, { value: `${w}`, children: l[$o(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Za({
  ...
  return /* @__PURE__ */ u(qe, { variant: i, children: [
    /* @__PURE__ */ a(Ge, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(Z, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(Ks, {}) }) }),
    /* @__PURE__ */ a(Ye, { align: "start", style: { zIndex: ar }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(la, { children: [
      /* @__PURE__ */ a(Nn, { children: /* @__PURE__ */ a(jt, { children: Vi(e.groups, e.items, l, t) }) }),
...
const Eu = Object.freeze([520, 420, 340]), ji = Yt.forwardRef(
  ({ id: t, className: e, children: r, shrinkStep: o }, n) => {
    const [i, s] = N(void 0), c = H(n);
    c.current = n;
    const l = V((p) => {
      s(p ?? void 0);
      const h = c.current;
...
Fi.displayName = me.List.displayName;
...
Bi.displayName = me.List.displayName;
const Tu = Yt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  me.Trigger,
  {
    ref: r,
    ...e,
...
Ui.displayName = me.Content.displayName;
function Sh({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(Fi, { children: [
      /* @__PURE__ */ a(Bi, { children: t.map((c) => /* @__PURE__ */ a(Tu, { value: c.value, children: c.value }, c.key)) }),
  ...
  if (kl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (v = s.current) == null || v.focus(), kr(s, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), kr(c, [h, g]);
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), kr(l, [h, g]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ a(Su, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(zu, { children: [
      /* @__PURE__ */ a(Du, { ref: d(w), children: typeof p == "object" && "label" in p && p.label }),
      /* @__PURE__ */ a(
        Mu,
        {
          style: { zIndex: ar },
          children: /* @__PURE__ */ a(jt, { children: Ki(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function Rh({
  ...
  const [p, h] = N(void 0), g = V(
    (b) => h(b ?? void 0),
    []
  ), f = Li(p, Lu), v = w ?? f;
  return /* @__PURE__ */ a(fo.Provider, { value: v, children: /* @__PURE__ */ a(
    "div",
    {
...
function Dh({
  ...
  const d = ju(
    ...
    n && n(f), o && o([f, ...r.filter((v) => v !== f)]), i && r.find((v) => v === f) && i([...r.filter((v) => v !== f)]), p(!1);
  }, g = (f, v) => {
    var z, k, _, S, q, T;
    const b = v !== f ? ((k = (z = t[f]) == null ? void 0 : z.uiNames) == null ? void 0 : k[v]) ?? ((S = (_ = t[f]) == null ? void 0 : _.uiNames) == null ? void 0 : S.en) : void 0;
    return b ? `${(q = t[f]) == null ? void 0 : q.autonym} (${b})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
      ...
      hr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(
            ...
            {
              style: { zIndex: ar },
              children: Object.keys(t).map((f) => /* @__PURE__ */ a(ge, { value: f, children: g(f, e) }, f))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Tt, { className: "tw:font-normal tw:text-muted-foreground", children: tr(d, {
...
function Oh({
  ...
  return /* @__PURE__ */ u(Ke, { id: i, className: m("pr-twp", n), shouldFilter: !1, children: [
      ...
      /* @__PURE__ */ a(
        Ut,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:h-full tw:rounded-md tw:bg-destructive/10 tw:px-3 tw:py-1.5", children: Ao(d, {
            ...
            // disable.
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ a(la, { children: h }, `key-${g}`)
          )) })
        }
      )
    ] })
            ...
            d && (e || h && f) && /* @__PURE__ */ a(
              "div",
              {
                ...
                children: /* @__PURE__ */ u(qe, { children: [
                  /* @__PURE__ */ a(Ge, { className: m(p && "tw:me-1"), asChild: !0, children: /* @__PURE__ */ a(
                    Z,
                    {
...
function Ph({ message: t, id: e, className: r }) {
  return /* @__PURE__ */ a(
    "p",
    {
      role: "status",
...
function Qh({
  ...
  return /* @__PURE__ */ u(
    Kt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Kt.ItemIndicator, { children: /* @__PURE__ */ a(da, {}) }) }),
        e
      ]
    }
  );
...
function Rg(t) {
  const e = $(() => nc(t).slice().sort().join(" "), [t]);
  return $(() => e ? e.split(" ") : [], [e]);
}
const Ju = () => {
  const [t, e] = N(
