...
import { useReactTable as Xn, getFilteredRowModel as Ia, getSortedRowModel as Fn, getPaginationRowModel as Aa, getCoreRowModel as Hn, flexRender as oe, getGroupedRowModel as Pa, getExpandedRowModel as za } from "@tanstack/react-table";
...
import { toast as Iw } from "sonner";
...
const Zt = se.Root, Qt = se.Trigger, jt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...a }, o) => {
  const s = nt();
...
function Oi({
  ...
  const c = nt(), [p, g] = A(!1), [h, f] = A(""), [b, y] = A(""), [v, O] = A("books"), [C, R] = A(void 0), [K, tt] = A(!1), B = rt(void 0), at = rt(void 0), ot = rt(void 0), _ = rt(void 0), k = rt({}), L = j(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
    ...
    (x) => {
      ...
      if ((v === "chapters" || v === "books" && N) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          case "ArrowLeft":
            it !== 0 && (xt = it > 1 ? it - 1 : Et);
            break;
          case "ArrowRight":
            it !== 0 && (xt = it < Et ? it + 1 : 1);
            break;
          case "ArrowUp":
            xt = it === 0 ? Et : Math.max(1, it - Sn);
            break;
          case "ArrowDown":
            xt = it === 0 ? 1 : Math.min(Et, it + Sn);
            break;
          default:
            return;
        }
        xt !== it && (x.preventDefault(), x.stopPropagation(), f(He(st, o, xt)), setTimeout(() => {
          const te = k.current[xt];
    ...
    const { isLetter: P, isDigit: Z } = On(x.key);
    (P || Z) && (x.preventDefault(), y((st) => st + x.key), at.current.focus(), tt(!1));
  }, []);
  return Rn(() => {
    const x = setTimeout(() => {
      if (p && v === "books" && ot.current && _.current) {
        const P = ot.current, Z = _.current, st = Z.offsetTop, it = P.clientHeight, Et = Z.clientHeight, xt = st - it / 2 + Et / 2;
        P.scrollTo({
          top: Math.max(0, xt),
          behavior: "smooth"
        }), f(He(t.book));
        ...
        children: [
          ...
          !K && /* @__PURE__ */ l(Jt, { ref: ot, children: [
            v === "books" && /* @__PURE__ */ l(Nt, { children: [
              !N && Object.entries(q).map(([x, P]) => {
                if (P.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ r(At, { heading: Xr(x), children: P.map((Z) => /* @__PURE__ */ r(
                      ar,
                      {
                        bookId: Z,
                        onSelect: (st) => ft(st),
              ...
              N && bt(N.book) > 1 && /* @__PURE__ */ l(Nt, { children: [
...
), et = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Gn.Root, { ref: n, className: d("pr-twp", uo(), t), ...e }));
    ...
    wn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(et, { className: "tw-flex tw-items-center", children: a.map((v) => $.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            M,
            {
...
}), cn = G.Trigger, or = G.Group, go = G.Portal, bo = G.Sub, vo = G.RadioGroup;
...
const Ft = U.Root, No = U.Group, Ht = U.Value, ko = Tt(
...
Co.displayName = U.Label.displayName;
...
_o.displayName = U.Separator.displayName;
function So({ table: t }) {
...
function Oo({
  ...
  var O;
  const [u, c] = A([]), [p, g] = A([]), [h, f] = A({}), [b, y] = A({}), v = Xn({
    data: e,
    columns: t,
    getCoreRowModel: Hn(),
...
function Li({
  ...
  return /* @__PURE__ */ l(Zt, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ l(jt, { id: s, className: d("tw-min-w-80 tw-max-w-96", o), children: [
...
function ji({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ke, { children: [
    ...
    /* @__PURE__ */ r(pe, { children: n.map((c, p) => /* @__PURE__ */ l("div", { children: [
      ...
      /* @__PURE__ */ r(or, { children: c.itemType === 0 ? /* @__PURE__ */ r(Nt, { children: c.items.map((g, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        dn,
        {
          checked: a[p][h],
...
function Lo({
  ...
  const [O, C] = A(!1), R = j(
    (k) => {
      var T;
      const L = (T = t.find((Y) => Y.label === k)) == null ? void 0 : T.value;
      L && n(
        e.includes(L) ? e.filter((Y) => Y !== L) : [...e, L]
      );
    },
    [t, e, n]
  ), K = () => u || a, tt = H(() => {
    if (!h) return t;
    const k = t.filter((T) => T.starred).sort((T, Y) => T.label.localeCompare(Y.label)), L = t.filter((T) => !T.starred).sort((T, Y) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: b, children: /* @__PURE__ */ l(Zt, { open: ot, onOpenChange: p ?? C, children: [
      ...
      M,
      {
        ...
        children: [
          /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-font-normal", children: K() })
          ] }),
    ...
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(qt, { children: [
      ...
      /* @__PURE__ */ l(Jt, { children: [
        ...
        /* @__PURE__ */ r(At, { children: tt.map((k) => /* @__PURE__ */ l(
          Lt,
          {
            value: k.label,
            onSelect: R,
...
function Go({
  ...
  const u = a ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, c = a ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(Nt, { children: [
  ...
  return /* @__PURE__ */ l(Nt, { children: [
    ...
    /* @__PURE__ */ r("div", { className: d("textual-note-body", f), children: w && w.length > 0 && /* @__PURE__ */ r(Nt, { children: jo(t.marker, w, a, c) }) })
  ] });
}
...
const Te = (t) => t === "asc" ? /* @__PURE__ */ r(ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ha, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fa, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Hi = (t) => ({
  accessorKey: "item",
...
function Zi({
  ...
  const p = yt(n, "%webView_inventory_all%"), g = yt(n, "%webView_inventory_approved%"), h = yt(n, "%webView_inventory_unapproved%"), f = yt(n, "%webView_inventory_unknown%"), b = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), v = yt(n, "%webView_inventory_scope_verse%"), O = yt(n, "%webView_inventory_filter_text%"), C = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [R, K] = A(!1), [tt, B] = A("all"), [at, ot] = A(""), [_, k] = A([]), L = H(() => t.length === 0 ? [] : ts(t, o, s), [t, o, s]), T = H(() => {
    if (R) return L;
    const E = [];
    return L.forEach((Q) => {
  ...
  }, [R, L]), Y = H(() => Qo(T, tt, at), [T, tt, at]), S = H(() => {
    var W, dt;
    if (!R) return u;
  ...
  return /* @__PURE__ */ l("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ l("div", { className: "tw-flex tw-items-stretch", children: [
      ...
      /* @__PURE__ */ l(Ft, { onValueChange: (E) => N(E), defaultValue: i, children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(et, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (a == null ? void 0 : a.checkboxText) ?? C })
      ] })
    ] }),
...
const _t = "scrBook", bs = "scrRef", Dt = "source", vs = "details", xs = "Scripture Reference", ys = "Scripture Book", _r = "Type", Ns = "Details";
function ks(t, e) {
  const n = e ?? !1;
  return [
    {
...
function tw({
  ...
  It(() => {
    if (w) {
      ...
      if (k.length === 1) {
        const L = y.find((T) => $n(T) === k[0]) || void 0;
        L && w(L);
      }
    }
  }, [f, y, w, O]);
  const C = o ?? ys, R = s ?? _r, K = [
  ...
  }, at = (_, k) => _.getIsGrouped() ? "" : d("banded-row", k % 2 === 0 ? "even" : "odd"), ot = (_, k, L) => {
    if (!((_ == null ? void 0 : _.length) === 0 || k.depth < L.column.getGroupedIndex())) {
      if (k.getIsGrouped())
        switch (k.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      Ft,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($t, { position: "item-aligned", children: /* @__PURE__ */ r(No, { children: K.map((_) => /* @__PURE__ */ r(ut, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
                    ...
                    children: T.getIsGrouped() ? /* @__PURE__ */ l(
                      M,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(Xt, {}) : /* @__PURE__ */ r(Le, {})),
                          " ",
...
function Ss({
  ...
  }, [v, O] = A(!1), [C, R] = A(""), K = rt(void 0), tt = rt(!1);
        ...
        children: [
          ...
          /* @__PURE__ */ r(jt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ l(
            qt,
            {
              shouldFilter: !1,
              onKeyDown: (S) => {
                S.key === "Enter" && (tt.current = S.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  de,
...
function Je({
  ...
  return /* @__PURE__ */ l(ke, { variant: s, children: [
    ...
    /* @__PURE__ */ r(pe, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, c]) => typeof u == "boolean" || typeof c == "boolean" ? 0 : u.order - c.order).map(([u], c, p) => /* @__PURE__ */ l(jn, { children: [
...
Or.displayName = X.Root.displayName;
...
Ir.displayName = X.Trigger.displayName;
...
Vs.displayName = X.CheckboxItem.displayName;
...
Ms.displayName = X.RadioItem.displayName;
...
Ds.displayName = X.Label.displayName;
...
Lr.displayName = X.Separator.displayName;
const ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
...
function Os({
  ...
  if (ja(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    ...
    return /* @__PURE__ */ r(Or, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(Ts, { children: [
...
function pw({
  ...
  const c = Is(
    ...
    return v ? `${(tt = t[b]) == null ? void 0 : tt.autonym} (${v})` : (B = t[b]) == null ? void 0 : B.autonym;
  };
  return /* @__PURE__ */ l("div", { id: u, className: d("pr-twp tw-max-w-sm", w), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(et, { className: "tw-font-normal tw-text-muted-foreground", children: Oa(c, {
...
const Ps = We(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ca, { size: 35, className: d("tw-animate-spin", t), ...e, ref: n }));
...
Gs.displayName = Kt.Image.displayName;
...
Xs.displayName = Kt.Fallback.displayName;
const fw = F.Root, gw = F.Trigger, bw = F.Group, vw = F.Portal, xw = F.Sub, yw = F.RadioGroup, Fs = m.forwardRef(({ className: t, inset: e, children: n, ...a }, o) => /* @__PURE__ */ l(
  F.SubTrigger,
  {
    ref: o,
    className: d(
...
Fs.displayName = F.SubTrigger.displayName;
...
Hs.displayName = F.SubContent.displayName;
const Ys = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(F.Portal, { children: /* @__PURE__ */ r(
  F.Content,
  {
    ref: n,
    className: d(
...
Ys.displayName = F.Content.displayName;
...
Us.displayName = F.Item.displayName;
...
qs.displayName = F.RadioItem.displayName;
...
Ws.displayName = F.Separator.displayName;
...
const Nw = mt.Trigger, ti = mt.Portal, kw = mt.Close, Gr = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  mt.Overlay,
  {
    ref: n,
...
ai.displayName = mt.Title.displayName;
...
oi.displayName = mt.Description.displayName;
...
ii.displayName = re.Root.displayName;
...
wi.displayName = Fe.Root.displayName;
const Tw = ct.Root, li = m.forwardRef(({ className: t, ...e }, n) => {
  const a = nt();
  return /* @__PURE__ */ r(
    ct.List,
    {
...
li.displayName = ct.List.displayName;
...
ci.displayName = ct.Trigger.displayName;
...
di.displayName = ct.Content.displayName;
...
const mi = (t, e, n = {}) => {
  ...
  const o = rt(null), [s, i] = A(void 0), [w, u] = A(void 0), c = j(
    (h) => {
      i(h);
