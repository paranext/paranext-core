...
import { Section as ut, getChaptersForBook as Fs, formatScrRef as ke, getSectionForBook as br, formatRelativeDate as Bs, formatReplacementString as Ge, sanitizeHtml as no, NumberFormat as Tn, formatBytes as Us, getCurrentLocale as Ks, usfmMarkers as Fr, getFormatCallerFunction as qs, deepEqual as Hs, isString as zo, compareScrRefs as ja, scrRefToBBBCCCVVV as ma, defaultScrRef as va, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as Ro, formatReplacementStringToArray as Do, collectUsjMarkers as Ys } from "platform-bible-utils";
import Wt, { useRef as U, useMemo as O, createContext as ia, useContext as io, useState as k, useEffect as W, useCallback as j, useImperativeHandle as Ws, useLayoutEffect as Xt, Component as Xs, createElement as Oo, Suspense as Js, forwardRef as Sn, useId as Mo, Fragment as sa } from "react";
...
function xa({
  ...
  const T = fe(), L = ul(), A = F ?? L, [N, V] = k(!1), [K, E] = k(""), [X, B] = k(""), [$, M] = k("books"), [z, tt] = k(void 0), [q, kt] = k(
    void 0
  ), [lt, $t] = k(void 0), [Y, rt] = k(!1), ft = U(null), dt = U(!1), pt = U(void 0), Ht = U(void 0), nt = U(void 0), Zt = U(void 0), Gt = U({}), Qt = U({}), xt = j(
    (x) => {
      e(x), c && c(x);
    },
    [e, c]
  ...
  const { otLong: Et, ntLong: Lt, dcLong: Tt, extraLong: Te } = {
    ...
    (x) => {
      var ne, Ze, xe;
      if (x.ctrlKey) return;
      const { isLetter: H, isDigit: Q } = Fo(x.key);
    ...
    const { isLetter: H, isDigit: Q } = Fo(x.key);
    (H || Q) && (x.preventDefault(), B((ne) => ne + x.key), Ht.current.focus(), rt(!1));
  }, []);
  return Xt(() => {
    const x = setTimeout(() => {
    ...
    w.read(() => {
      ...
      if ((T || L) && D !== null && F !== null) {
        const A = function(N, V, K, E, X, B, $) {
          ...
          return M.setStart(...qo(V, K, E)), M.setEnd(...qo(X, B, $)), M;
        }(t, h, f, D, g, C, F);
        l(), l = Pl(t, A, e);
      }
...
class ai extends Fa {
  $config() {
    return this.config("decorator-text", { extends: Fa, stateConfigs: [{ flat: !0, stateConfig: _a }] });
  }
  getFormat() {
    return Mc(this, _a);
  }
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (he(f)) {
                ...
                if (Ba(m) && d >= 0 && w >= 0 && (C = d, y = d + w, f.setTextNodeRange(m, C, m, y)), C === y && p === "" || (f.insertRawText(p), m = b.getNode()), Ba(m)) {
                  C = h, y = h + g;
...
function yd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: h, autoCapitalize: g, className: f, id: b, role: m = "textbox", spellCheck: C = !0, style: y, tabIndex: _, "data-testid": D, ...F }, T) {
  ...
  return wi(() => (A(t.isEditable()), t.registerEditableListener((K) => {
    A(K);
...
function Dd() {
  const { activeEditor: t } = pi(), [e, r] = k([]), o = j((n) => {
    if (he(n) || Qc(n)) {
      const i = [];
      en.forEach(({ format: s }) => {
...
function an({
  ...
  return /* @__PURE__ */ u(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(Fd, { className: "tw:h-8 tw:w-8", children: /* @__PURE__ */ a(Bd, { className: "tw:text-xs tw:font-medium", children: C }) }),
...
function ki({
  ...
  const [E, X] = k(on), [B, $] = k(), [M, z] = k(), tt = o, [q, kt] = k(!1), [lt, $t] = k(!1), [Y, rt] = k(!1), [ft, dt] = k(!1), [pt, Ht] = k(!1), [nt, Zt] = k(D), [Gt, Qt] = k(!1), xt = U(void 0), [te, It] = k(/* @__PURE__ */ new Map());
  W(() => {
    let S = !0;
    return (async () => {
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            m !== !1 && (!lt || ae(E)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  xo(S) && (S.preventDefault(), S.stopPropagation(), (ae(E) || B !== void 0 && B !== M) && Lt());
                },
                onKeyDown: (S) => {
...
function qd({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", K = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), E = (M) => M ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: M }) : K, X = () => {
    ...
    const z = f === M.value, tt = `${d}-${M.value}`, q = B(M);
    return (
      ...
      children: N.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(Xd, { ...tt, conflictResolution: C }) : /* @__PURE__ */ a(ki, { ...tt })
          },
          z.id
        );
      })
...
function rw({
  ...
  var T;
  const [w, p] = k([]), [h, g] = k([]), [f, b] = k({}), [m, C] = k({}), y = O(() => e ?? [], [e]), _ = Un({
    data: y,
    columns: t,
    getCoreRowModel: qn(),
...
function Sp({
  ...
  const [f, b] = k("generated"), [m, C] = k("generated"), [y, _] = k("*"), [D, F] = k("*"), [T, L] = k("f"), [A, N] = k(!1), [V, K] = k(!0), [E, X] = k(!1), B = U(!1), $ = U(""), [M, z] = k(!1), [tt, q] = k(), [kt, lt] = k(), [$t, Y] = k(), [rt, ft] = k(), dt = U(null), pt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  W(() => {
    ...
    if (Z && Ir("note", Z)) {
      ...
      let et = "custom";
      ht === Ua ? et = "generated" : ht === Ka ? et = "hidden" : ht && (_(ht), F(ht)), b(et), C(et), L(((it = Z.insert.note) == null ? void 0 : it.style) ?? "f"), P = setTimeout(() => {
        var gt;
  ...
  const nt = j(
    (P, Z, at = !1) => {
      ...
      if (it && Ir("note", it)) {
        if (it.insert.note) {
          let st;
          P === "custom" ? st = Z : P === "generated" ? st = Ua : st = Ka, it.insert.note.caller = st;
        }
  ...
  const xt = () => {
    ...
    if (Z && Ir("note", Z)) {
      ...
      T !== "x" && P === "x" ? st == null || st.forEach((mt) => xw(mt)) : T === "x" && P !== "x" && (st == null || st.forEach((mt) => yw(mt))), (gt = w.current) == null || gt.applyUpdate([Z, { delete: 1 }]);
    }
  }, At = (P) => {
...
function Vp({
  ...
  }, [L, $]), z = O(() => M.length === 0 ? [] : Dw(M, N, K), [M, N, K]), tt = O(() => {
    var ft, dt;
    if (!L) return l;
...
function Iw({
  ...
  return /* @__PURE__ */ a(Ci.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
...
function Bw({
  ...
  const c = t ? zr.Root : "button", { state: l } = ua(), d = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(Fw({ variant: r, size: o }), i),
      ...s
    }
  );
...
function Qp({
  ...
  W(() => {
    if (c) {
      ...
      if (V.length === 1) {
        const K = b.find((E) => un(E) === V[0]) || void 0;
        K && c(K);
      }
    }
  }, [g, b, c, C]);
    ...
    !e && /* @__PURE__ */ u(
      sr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(dr, { position: "item-aligned", children: /* @__PURE__ */ a(Zd, { children: D.map((N) => /* @__PURE__ */ a(se, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(to, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(eo, { children: C.getHeaderGroups().map((N) => /* @__PURE__ */ a(Re, { children: N.headers.filter((V) => V.column.columnDef.header).map((V) => (
      ...
      /* @__PURE__ */ a(ro, { children: C.getRowModel().rows.map((N, V) => {
        const K = fe();
        return /* @__PURE__ */ a(
          Re,
          {
                    ...
                    children: E.getIsGrouped() ? /* @__PURE__ */ u(
                      G,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ a(Va, {}) : /* @__PURE__ */ a(Pa, {})),
                          " ",
...
function Jw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], { otLong: p, ntLong: h, dcLong: g, extraLong: f } = {
    ...
    (E, X = !1) => {
      ...
      const B = F.findIndex((q) => q === _.current), $ = F.findIndex((q) => q === E);
      if (B === -1 || $ === -1) return;
      const [M, z] = [
        Math.min(B, $),
        Math.max(B, $)
...
function eh({
  ...
  const D = St(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), V = St(s, "%webView_scope_selector_current_book%"), K = St(s, "%webView_scope_selector_choose_books%"), E = St(s, "%webView_scope_selector_scope%"), X = St(s, "%webView_scope_selector_select_books%"), B = St(s, "%webView_scope_selector_range%"), $ = St(s, "%webView_scope_selector_select_range%"), M = St(s, "%webView_scope_selector_range_start%"), z = St(s, "%webView_scope_selector_range_end%"), tt = St(s, "%webView_scope_selector_ok%"), q = St(s, "%webView_scope_selector_cancel%"), kt = St(s, "%webView_scope_selector_navigate%"), lt = (I) => {
    if (!f) return;
    ...
    d === "dropdown" && gt && /* @__PURE__ */ a(Oa, { open: Et === "selectedBooks", onOpenChange: we, children: /* @__PURE__ */ a(
      Ma,
      {
        ...
        children: /* @__PURE__ */ u(ga, { container: ne, children: [
          /* @__PURE__ */ a($a, { className: "tw:pe-8", children: /* @__PURE__ */ a(Ia, { children: K }) }),
          hr,
