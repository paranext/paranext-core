...
function ba({
  ...
  const _ = bt(), [z, C] = T(!1), [N, E] = T(""), [I, y] = T(""), [b, S] = T("books"), [M, F] = T(void 0), [K, L] = T(
    void 0
  ), [q, $] = T(void 0), [W, pt] = T(!1), _t = U(null), $t = U(!1), tt = U(void 0), Rt = U(void 0), G = U(void 0), ot = U(void 0), it = U({}), st = U({}), ct = j(
    (k) => {
      e(k), c && c(k);
    },
    [e, c]
...
function tn({
  ...
  const [z, C] = T(!1), N = l ?? d, E = (y) => y.length > 0 && typeof y[0] == "object" && "options" in y[0], I = (y, b) => {
...
function td(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !uc(e) && o !== null) {
    ...
    if (l || w) {
      ...
      _ !== e.__text && (r === "clone" && (e = gc(e)), e.__text = _);
    }
  }
  return e;
}
...
function ad(t, e, r) {
  ...
  function d() {
    ...
    for (let D = 0; D < p.length; D++) {
      ...
      const y = de(_.height);
      C.height !== y && (z.style.height = y, v = !0), z.parentNode !== c && (c.append(z), v = !0), s[D] = z;
    }
...
function nd(t, e = od) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(g), f = m.getNode(), x = f.getKey(), v = m.offset, D = p.getNode(), _ = D.getKey(), z = p.offset, C = t.getElementByKey(x), N = t.getElementByKey(_), E = r === null || C !== o || v !== n || x !== r.getKey(), I = i === null || N !== s || z !== c || _ !== i.getKey();
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(f)) {
                ...
                if (ea(v) && l >= 0 && w >= 0 && (D = l, _ = l + w, f.setTextNodeRange(v, D, v, _)), D === _ && g === "" || (f.insertRawText(g), v = x.getNode()), ea(v)) {
                  D = m, _ = m + p;
...
const Kp = Object.freeze([
  ...
  const n = U(null), [i, s] = T(void 0), [c, d] = T(void 0), l = j(
    ...
    (p) => {
      var I;
      const f = p.target, x = (y) => y ? document.getElementById(y) : void 0, v = x(c), D = x(i);
      if (!!(v && f && v.contains(f) && f !== v) && g(f)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !f.isContentEditable) {
          if (c) {
            p.preventDefault(), p.stopPropagation();
            const y = t.find((b) => b.id === c);
            y && l(y.id);
          }
          return;
        }
...
function kw({
  ...
  const [y, b] = T(hn), [S, M] = T(), [F, K] = T(), L = o, [q, $] = T(!1), [W, pt] = T(!1), [_t, $t] = T(!1), [tt, Rt] = T(!1), [G, ot] = T(!1), [it, st] = T(C), [ct, Vt] = T(!1), vt = U(void 0), [Wt, Yt] = T(/* @__PURE__ */ new Map());
  X(() => {
    let R = !0;
    return (async () => {
...
function $w({
  ...
  let N;
  return d ? N = Array.from({ length: 10 }).map((b, S) => `skeleton-row-${S}`).map((b) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((E = z.getRowModel().rows) == null ? void 0 : E.length) > 0 ? N = z.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(I, z),
      "data-state": I.getIsSelected() && "selected",
      children: I.getVisibleCells().map((y) => /* @__PURE__ */ a(lr, { children: zr(y.column.columnDef.cell, y.getContext()) }, y.id))
    },
    I.id
  )) : N = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(lr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function Bw(t) {
  const [e, r] = T(!1), [o, n] = T(""), [i, s] = T(t.defaultGroupByOpenTabs ?? !0), [c, d] = T(!1), l = Aw(t.localizedStrings), w = B(() => t.mode === "project" ? Ta({
    ...
    )), t.mode === "project-multi" && c && (E = E.filter((I) => I.isSelected)), E;
  }, [w, o, t.mode, c]), m = B(
    () => Ow(g, i),
    [g, i]
  ), p = B(() => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        t.onChangeSelection({ pairs: y }), y.length === 0 && c && d(!1);
        return;
      }
      ...
      _e,
      {
        ...
        children: /* @__PURE__ */ a(Ut, { delayDuration: 400, children: /* @__PURE__ */ u($e, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: v, children: `${l.selectAll} (${p.length.toString()})` }),
            /* @__PURE__ */ a(V, { variant: "ghost", size: "sm", onClick: D, children: `${l.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ u(Re, { children: [
            /* @__PURE__ */ a(Mr, { children: t.commandEmptyMessage ?? "No projects found" }),
            m.map((N, E) => /* @__PURE__ */ u(eo, { children: [
              /* @__PURE__ */ a(he, { heading: Fw(N, l), children: N.rows.map((I) => /* @__PURE__ */ a(
                Lw,
                {
                  row: I,
                  mode: t.mode,
...
function Zw({
  ...
  const f = (v) => {
    ...
    var D, _, z, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((D = i.current) == null || D.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((_ = s.current) == null || _.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((z = i.current) == null ? void 0 : z.selectionStart) === 0 && ((C = s.current) == null || C.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function wg({
  ...
  const [f, x] = T("generated"), [v, D] = T("generated"), [_, z] = T("*"), [C, N] = T("*"), [E, I] = T("f"), [y, b] = T(!1), [S, M] = T(!0), [F, K] = T(!1), L = U(!1), q = U(""), [$, W] = T(!1), [pt, _t] = T(), [$t, tt] = T(), [Rt, G] = T(), [ot, it] = T(), st = U(null), ct = B(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const w = d ?? Ds(r, void 0), g = (_, z) => {
    ...
    if (r.length)
      switch (_.key) {
        case "Enter":
        case " ":
          _.preventDefault(), l == null || l(z, C, n);
          break;
      }
  }, v = (_) => {
    if (r.length)
...
function yg({
  ...
  const p = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), x = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), D = le(r, "%webView_inventory_scope_currentBook%"), _ = le(r, "%webView_inventory_scope_chapter%"), z = le(r, "%webView_inventory_scope_verse%"), C = le(r, "%webView_inventory_filter_text%"), N = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), E = le(r, "%webView_inventory_no_results%"), [I, y] = T(!1), [b, S] = T("all"), [M, F] = T(""), [K, L] = T([]), q = B(() => {
    const G = t ?? [];
...
function jg({
  ...
  ), yt = ot.find((A) => A.value === "selectedBooks"), ft = ot.find((A) => A.value === "range"), [Ct, R] = T(!1), [ut, gt] = T(void 0), [kt, Ke] = T(void 0), [Pe, br] = T(void 0), [qe, xr] = T(void 0), [yr, Ar] = T([]), Pr = l === "dropdown" && ut === "selectedBooks", k = /* @__PURE__ */ a(
    ju,
    {
      availableBookInfo: o,
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(me, { open: Ct, onOpenChange: R, children: [
