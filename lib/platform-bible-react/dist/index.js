...
import { c as m, g as ze, a as Jr, C as Ie, u as zo, T as jt, b as Ft, d as Bt, e as Ut, A as fe, P as Be, f as rr, B as Z, h as Ue, i as Ke, j as He, k as Me, l as Yi, m as Wi, n as Xi, E as Ji, o as Qa, r as Ce, p as Zi, q as yn, s as ia, t as sa, L as Tt, R as to, v as Zr, D as Ia, w as $a, x as Aa, y as Pa, z as kn, F as Br, G as eo, H as _n, I as ro, J as Qe, K as Er, M as qe, N as Ge, O as Ye, S as Tr, Q as cr, U as Qi, V as Rr, W as er, X as Le, Z as ar, Y as Ve, _ as lr, $ as ao, a0 as oo, a1 as Qr, a2 as no, a3 as Nn, a4 as ts, a5 as es, a6 as rs, a7 as Va, a8 as Cn, a9 as ca, aa as En, ab as as, ac as os, ad as ns, ae as is, af as Tn, ag as Sn, ah as io, ai as ss, aj as zn, ak as ma, al as Ro, am as va, an as cs, ao as ls, ap as ds, aq as ws, ar as us, as as Dr, at as so, au as ps, av as hs } from "./resizable-BufEsL_o.js";
...
import { Check as je, Clock as Do, ChevronsLeft as Mo, ChevronsRight as Oo, ChevronLeft as La, ChevronRight as ja, ArrowLeft as gs, ArrowRight as fs, ChevronDown as pr, BoldIcon as ms, ItalicIcon as vs, X as co, AtSign as Rn, Pencil as bs, Trash2 as xs, ArrowUp as Dn, MoreHorizontal as ys, MailOpen as ks, Mail as _s, ChevronUp as Ns, FilterIcon as Cs, ArrowLeftIcon as Es, ChevronLeftIcon as Ts, ChevronRightIcon as Ss, ArrowRightIcon as zs, Copy as Mn, Filter as Rs, User as Ds, Link as Ms, CircleHelp as Os, Undo as Is, Redo as $s, SquareX as On, FunctionSquare as In, SquareSigma as $n, Ban as As, AlertCircle as Fa, CircleCheckIcon as Ps, CircleXIcon as Vs, CircleHelpIcon as Ls, ArrowUpIcon as js, ArrowDownIcon as Fs, ScrollText as Bs, ChevronsUpDown as Us, MenuIcon as Ks, Menu as Hs, EllipsisVertical as qs, MoreVertical as Gs } from "lucide-react";
import { Section as pt, getChaptersForBook as Ys, formatScrRef as Re, getSectionForBook as Ur, formatRelativeDate as Ws, formatReplacementString as tr, sanitizeHtml as lo, NumberFormat as An, formatBytes as Xs, getCurrentLocale as Js, MODIFIER_KEYS as Zs, usfmMarkers as Kr, isPlatformError as Qs, ABORTED as tc, getErrorMessage as ec, getFormatCallerFunction as rc, deepEqual as ac, isString as Io, compareScrRefs as Ba, scrRefToBBBCCCVVV as ba, defaultScrRef as xa, formatScrRefRange as oc, getLocalizeKeyForScrollGroupId as $o, formatReplacementStringToArray as Ao, collectUsjMarkers as nc } from "platform-bible-utils";
import Yt, { useRef as H, useMemo as $, createContext as la, useContext as wo, useState as N, useEffect as Y, useCallback as V, useImperativeHandle as ic, useLayoutEffect as Zt, Component as sc, createElement as Po, Suspense as cc, forwardRef as Pn, useId as Vo, Fragment as da } from "react";
...
import { Avatar as go, Select as Wt, Checkbox as Bo, Slot as Or, Tabs as me, Menubar as Ee, ContextMenu as Kt, Progress as Uo, Slider as Pr, Switch as Ko } from "radix-ui";
...
import { filterAndRankItems as Ho, GENERATOR_NOTE_CALLER as Ha, HIDDEN_NOTE_CALLER as qa, getDefaultViewOptions as vl, isInsertEmbedOpOfType as yr, getMarkerMenuItems as bl, defaultStyleInfo as xl, Editorial as yl } from "@eten-tech-foundation/platform-editor";
...
function Tl({
  ...
  Y(() => {
    ...
    const M = (J) => !!J && J.scrollWidth > J.clientWidth, U = () => {
      Ga !== "pointer" && (T || M(h.current) || M(l.current)) && _(!0);
    }, O = () => _(!1);
...
function ka({
  ...
  const T = Ce(), j = Cl(), A = q ?? j, [R, K] = N(!1), [W, L] = N(""), [Q, M] = N(""), [U, O] = N("books"), [C, J] = N(void 0), [et, ft] = N(
    void 0
  ), [ot, Mt] = N(void 0), [tt, ct] = N(!1), ht = H(null), mt = H(!1), lt = H(void 0), Ot = H(void 0), wt = H(void 0), ie = H(void 0), te = H({}), St = H({}), xt = V(
    (y) => {
      e(y), c && c(y);
    },
    [e, c]
  ...
  const { otLong: be, ntLong: oe, dcLong: E, extraLong: F } = {
    ...
    () => A >= Hr.TIGHT ? Jr(t.book, n) : ze(t.book, n),
    [t.book, n, A]
    ...
    (y, X) => (nt) => w ? ya(y, X, nt, w) : !1,
    [w]
  ), ne = (i == null ? void 0 : i["%webView_bookChapterControl_selectChapter%"]) ?? "Select Chapter", Ir = (i == null ? void 0 : i["%webView_bookChapterControl_selectVerse%"]) ?? "Select Verse", Eo = V(
    (y) => {
        ...
        children: [
          h ?? /* @__PURE__ */ a(
            Tl,
            {
              primary: G,
              secondary: at,
              showSecondary: A < Hr.MINIMUM,
              isPartial: A >= Hr.TIGHT,
              fullText: B
            }
          ),
          f && /* @__PURE__ */ a(
...
function Tp({
  ...
  const w = _a(d, "%webView_bookSelector_currentBook%"), p = _a(d, "%webView_bookSelector_choose%"), h = _a(d, "%webView_bookSelector_chooseBooks%"), [g, f] = N(
    "current book"
    /* CurrentBook */
  ), v = (b) => {
    f(b), t(b);
...
const ni = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = ni ? Zt : Y, Lr = { tag: uo };
      ...
      if (h !== null) {
        if (h === void 0) p.update(() => {
          ...
          if (g.isEmpty()) {
            ...
            (Qt() !== null || v !== null && v === p.getRootElement()) && f.select();
          }
        }, Lr);
...
function rd(t) {
  ...
  if (_e(e)) r = xc(e.focus, "next");
    ...
    r = r || yc(Fe(), "previous").getFlipped().insert(Mr());
  }
...
function ad(t, e, r) {
  ...
  return Sc(o) && ta(283), o.insert(t.isInline() ? Mr().append(t) : t), Lo(Un(t.getLatest(), "next"), e.direction);
}
function od(t) {
  const e = Qt();
  if (!_e(e)) return !1;
...
let ea, De = 0, ra = 0, sd = 0, Wa = 0, Gr = 0;
function tn(t) {
  if (st === void 0) return;
  let e = t.n;
...
function ld(t) {
  ...
  ci(this), st = t, this.f &= -2, 8 & this.f && bo(this), pa();
}
function sr(t, e) {
...
Gt.prototype.brand = nd, Gt.prototype.h = function() {
  ...
  if (t !== this.v) {
    ...
    (function(e) {
      De !== 0 && ra === 0 && e.l !== Wa && (e.l = Wa, ea = { S: e, v: e.v, i: e.i, o: ea });
    })(this), this.v = t, this.i++, Gr++, De++;
    try {
...
we({ build: (t, e, r) => br(e), config: or({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
function di() {
  const t = Fe(), e = Qt(), r = Mr();
  t.clear(), t.append(r), e !== null && r.select(), _e(e) && (e.format = 0);
}
function wi(t, e = di) {
  return t.registerCommand(Hn, (r) => (t.update(e), !0), po);
}
we({ build: (t, e, r) => br(e), config: or({ $onClear: di }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
class ui extends Ua {
  $config() {
    return this.config("decorator-text", { extends: Ua, stateConfigs: [{ flat: !0, stateConfig: Ca }] });
  }
  getFormat() {
    return Kc(this, Ca);
  }
...
const Xa = we({ build: (t) => pi(() => t.getEditorState(), (e) => t.registerUpdateListener((r) => {
...
const xo = 0, Ja = 1, gi = 2, Ea = 3, jr = 4, ir = 5, Ta = 6, kr = 7;
function Sa(t) {
  return t.id === xo;
}
function fi(t) {
...
function ud(t) {
  return function(e) {
    return e.id === Ja;
  }(t) || ut(305, String(t.id), String(Ja)), Object.assign(t, { id: gi });
}
...
class hd {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== jr && ut(307, String(r.id), String(ir)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  afterRegistration(e) {
    const r = this.state;
    let o;
    return r.id !== Ta && ut(310, String(r.id), String(Ta)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, r.config, r.registerState)), this.state = function(n) {
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= jr;
    }(e) || ut(313, String(e.id), String(jr)), e.initResult;
  }
  getInitPeer(e) {
  ...
  getExtensionInitDependency() {
    ...
    return function(r) {
      return r.id >= Ea;
    }(e) || ut(314, String(e.id), String(Ea)), { config: e.config };
  }
  getPeer(e) {
    const r = this.builder.extensionNameMap.get(e);
...
class wr {
  ...
  static maybeFromEditor(e) {
    const r = e[an];
    return r && (r.PACKAGE_VERSION !== za && ut(292, r.PACKAGE_VERSION, za), r instanceof wr || ut(293)), r;
  }
  static fromEditor(e) {
  ...
  sortedExtensionReps() {
    ...
    const e = [], r = (o, n) => {
      ...
      var c;
      Sa(i) || ut(300, s, n || "[unknown]"), Sa(c = i) || ut(304, String(c.id), String(xo)), i = Object.assign(c, { id: Ja }), o.state = i;
...
const vd = /* @__PURE__ */ new Set(), nn = we({ build(t, e, r) {
  const o = r.getDependency(Xa).output, n = zr({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = pi(() => {
  }, () => Ne(() => {
...
}, dependencies: [Xa], name: "@lexical/extension/NodeSelection" }), bd = Pc("INSERT_HORIZONTAL_RULE_COMMAND");
class hr extends Ua {
  static getType() {
...
we({ dependencies: [Xa, nn], name: "@lexical/extension/HorizontalRule", nodes: () => [hr], register(t, e, r) {
  const { watchNodeKey: o } = r.getDependency(nn).output, n = zr({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
...
we({ build: (t, e) => br({ inheritEditableFromParent: e.inheritEditableFromParent }), config: or({ $getParentEditor: function() {
  const t = Uc();
...
we({ build: (t, e, r) => br(e), config: or({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return Ne(() => {
...
we({ build: (t, e, r) => br(e), config: or({ $canIndent: mi, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (_e(f)) {
                ...
                if (Ka(b) && d >= 0 && w >= 0 && (z = d, k = d + w, f.setTextNodeRange(b, z, b, k)), z === k && p === "" || (f.insertRawText(p), b = v.getNode()), Ka(b)) {
                  z = h, k = h + g;
...
we({ build: (t, e, r) => br(e), config: or({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => Ne(() => r.getOutput().disabled.value ? void 0 : bi(t)) });
function Td(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function Bd() {
  const [t, e] = N(void 0), r = V(() => {
    ...
    return /* @__PURE__ */ a(Ia, { open: !0, onOpenChange: r, children: /* @__PURE__ */ u($a, { children: [
      /* @__PURE__ */ a(Aa, { children: /* @__PURE__ */ a(Pa, { children: i }) }),
      s
    ] }) });
  }, [t, r]), n = V(
    (i, s, c = !1) => {
        ...
        Ue,
        {
          ...
          children: /* @__PURE__ */ a(Ke, { children: /* @__PURE__ */ a(He, { children: t.map((b) => /* @__PURE__ */ a(
            Ie,
            {
              ...
              children: /* @__PURE__ */ a("span", { children: Ra(b, o) })
            },
            b || "unassigned"
          )) }) })
        }
...
function Di({
  ...
  const [L, Q] = N(un), [M, U] = N(), [O, C] = N(), J = o, [et, ft] = N(!1), [ot, Mt] = N(!1), [tt, ct] = N(!1), [ht, mt] = N(!1), [lt, Ot] = N(!1), [wt, ie] = N(S), [te, St] = N(!1), xt = H(void 0), [Nt, It] = N(/* @__PURE__ */ new Map());
  Y(() => {
    let x = !0;
    return (async () => {
  ...
  }, [i, r]), re = $(() => zt.slice(1), [zt]), _t = $(() => re.length ?? 0, [re.length]), ae = $(() => _t > 0, [_t]), $t = $(() => et || _t <= 2 ? re : re.slice(-2), [re, _t, et]), At = $(() => et || _t <= 2 ? 0 : _t - 2, [_t, et]), ve = $(
    () => _t === 1 ? ee.singleReply : tr(ee.multipleReplies, { count: _t }),
    [_t, ee]
  ), be = $(
    () => At === 1 ? ee.singleReply : tr(ee.multipleReplies, { count: At }),
    [At, ee]
  );
  Y(() => {
    !o && ot && ae && Mt(!1);
  ...
  const oe = V(
    ...
    async (x) => {
      const I = de(L) ? oa(L) : void 0, B = x.status ? x.assignedUser : M ?? x.assignedUser, G = await p({
        ...x,
        contents: I,
        assignedUser: B
      });
      ...
      children: /* @__PURE__ */ u(tw, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            pe && /* @__PURE__ */ a(Er, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: pe }),
            /* @__PURE__ */ a(
              Z,
              {
                variant: "ghost",
          ...
          o && /* @__PURE__ */ u(dt, { children: [
            ...
            b !== !1 && (!ot || de(L)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (x) => {
                  No(x) && (x.preventDefault(), x.stopPropagation(), (de(L) || M !== void 0 && M !== O) && oe());
                },
                onKeyDown: (x) => {
...
), ow = (t) => t.replace(/(\s+)(<\/[us]>)/g, "$2$1"), Wr = (t) => ow(lo(t));
function Xr({ html: t }) {
  return /* @__PURE__ */ a(
    "div",
    {
...
function nw({
  ...
  const K = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: K }), L = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, Q = () => {
    const O = o ?? "accept";
    return O === "merged" ? t.mergedText ? /* @__PURE__ */ a(Xr, { html: z }) : W : L(O === "reject" ? t.rejectedResultText : t.resultText);
      ...
      /* @__PURE__ */ u(
        gr,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(vr, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ a(ge, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function fw({
  ...
  return l ? q = Array.from({ length: 10 }).map((R, K) => `skeleton-row-${K}`).map((R) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: S.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(cr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, R)) : ((T = _.getRowModel().rows) == null ? void 0 : T.length) > 0 ? q = _.getRowModel().rows.map((j) => /* @__PURE__ */ a(
    Ve,
    {
      ...
      children: j.getVisibleCells().map((A) => /* @__PURE__ */ a(lr, { children: Nr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    j.id
    ...
    /* @__PURE__ */ u(ao, { stickyHeader: i, children: [
      /* @__PURE__ */ a(oo, { stickyHeader: i, children: _.getHeaderGroups().map((j) => /* @__PURE__ */ a(Ve, { children: j.headers.map((A) => /* @__PURE__ */ a(Qr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : Nr(A.column.columnDef.header, A.getContext()) }, A.id)) }, j.id)) }),
  ...
  return /* @__PURE__ */ u(eo, { children: [
    /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      ...
      /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(dt, { children: [
          " ",
          /* @__PURE__ */ a(Va, { children: l ? "⌘Z" : "Ctrl+Z" })
        ] })
      ] }) })
    ] }) }),
    ...
    e && /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
      ...
      /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u("p", { children: [
        ...
        i && /* @__PURE__ */ u(dt, { children: [
          " ",
          /* @__PURE__ */ a(Va, { children: l ? "⌘⇧Z" : "Ctrl+Y" })
        ] })
      ] }) })
    ] }) })
  ] });
...
function Yp({
  ...
  const [b, z] = N("generated"), [k, _] = N("generated"), [S, q] = N("*"), [T, j] = N("*"), [A, R] = N("f"), [K, W] = N(!1), [L, Q] = N(!0), [M, U] = N(!1), O = H(!1), C = H(""), [J, et] = N(!1), [ft, ot] = N(), [Mt, tt] = N(), [ct, ht] = N(), [mt, lt] = N(), Ot = H(null), wt = H(void 0), ie = H(0), te = H(void 0), St = $(
    () => ({
      ...s,
  ...
  Y(() => {
    var B, G;
    let E, F, x;
    O.current = !1, te.current = void 0, Q(!0);
    const I = e == null ? void 0 : e.at(0);
    if (I && yr("note", I)) {
      const at = (B = I.insert.note) == null ? void 0 : B.caller;
      let it = "custom";
      at === Ha ? it = "generated" : at === qa ? it = "hidden" : at && (q(at), j(at)), z(it), _(it), R(((G = I.insert.note) == null ? void 0 : G.style) ?? "f"), E = setTimeout(() => {
        var gt, bt, yt;
  ...
  const It = V(
    (E = !1) => {
      ...
      F && yr("note", F) && (r == null || r([F]), E && d && i && ((B = d.current) == null || B.replaceEmbedUpdate(i, [F])));
    },
    [i, r, p, d]
  ), vt = V(
    (E, F) => {
      ...
      let I;
      E === "custom" ? I = F : E === "generated" ? I = Ha : I = qa, x.insert.note.caller !== I && (x.insert.note.caller = I, (at = h.current) == null || at.applyUpdate([x, { delete: 1 }]));
    },
    []
  ), zt = V(() => {
    var E;
  ...
  const se = () => {
    ...
    (E, F, x) => {
      ...
      wt.current = {
        ...
        onKey: (at) => ae.current(at)
      }).then((at) => {
        var it, gt, bt, yt, Ct, Pt;
        if (Da(wt, G), at !== void 0) {
          if (!((it = h.current) != null && it.getSelection())) {
            const ne = te.current;
            ne ? (gt = h.current) == null || gt.setSelection(ne) : (bt = h.current) == null || bt.selectNote(0);
          }
          (yt = h.current) == null || yt.focus();
          const xe = F.find((ne) => ne.marker === at);
        ...
        var it;
        Da(wt, G), B || (it = h.current) == null || it.focus(), (!Qs(at) || at.code !== tc) && console.warn(
  ...
  Y(() => {
    ...
    _t,
    c,
    (oe = St.view) == null ? void 0 : oe.markerMode,
    St.styleInfo,
    w,
    At,
    Nt
      ...
      if (typeof i == "string") {
        ...
        return /* @__PURE__ */ u(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ a(Fa, { className: "tw:h-4 tw:w-4 tw:fill-destructive" }),
          ...
          children: r.map((_, S) => {
            ...
            return (
              ...
              /* @__PURE__ */ u(Yt.Fragment, { children: [
                ...
                S < r.length - 1 && o === "vertical" && /* @__PURE__ */ a(Tr, { tabIndex: -1, className: "tw:col-span-2" })
              ] }, T)
            );
          })
        }
...
}, ha = (t, e, r) => /* @__PURE__ */ a(jt, { children: /* @__PURE__ */ u(Ft, { children: [
  /* @__PURE__ */ u(
    Bt,
    {
  ...
  return [
    {
      ...
      sortingFn: (o, n) => Ba(o.original.start, n.original.start),
      enableGrouping: !0
    },
    {
...
const fu = (t) => {
  ...
  let r = 0;
  return t.end && ({ offset: r } = t.end), !t.end || Ba(t.start, t.end) === 0 ? `${ba(t.start)}+${e}` : `${ba(t.start)}+${e}-${ba(t.end)}+${r}`;
    ...
    !e && /* @__PURE__ */ u(
      gr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(vr, { position: "item-aligned", children: /* @__PURE__ */ a(uw, { children: S.map((R) => /* @__PURE__ */ a(ge, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
                  ...
                  lr,
                  {
                    ...
                    children: L.getIsGrouped() ? /* @__PURE__ */ u(
                      Z,
                      {
                        ...
                        type: "button",
                        children: [
                          R.getIsExpanded() && /* @__PURE__ */ a(pr, {}),
                          !R.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(ja, {}) : /* @__PURE__ */ a(La, {})),
                          " ",
  ...
  return /* @__PURE__ */ u("div", { className: "tw:space-y-2", children: [
    ...
    e.length > 0 && /* @__PURE__ */ u("div", { className: "tw:mt-2 tw:flex tw:flex-wrap tw:gap-1", children: [
      e.slice(
        0,
        e.length === Oa ? Oa : xn
      ).map((d) => /* @__PURE__ */ a(Er, { className: "tw:hover:bg-secondary", variant: "secondary", children: ze(d, n) }, d)),
...
function yh({
  ...
  const q = Vt(
  ...
  ] }), ht = e ? tt.filter((P) => e.includes(P.value)) : tt, mt = v ?? xa, lt = p ?? mt, Ot = h ?? mt, wt = () => {
  }, ie = H(null), te = H(null), St = H(!1), xt = H(null), Nt = H(!1), [It, vt] = N(void 0), zt = H(!1), D = H(!1), ue = H(null), se = V((P) => {
    if (P) {
    ...
    [r, n, v, i]
  ), re = ht.find((P) => P.value === t), _t = () => t === "selectedBooks" && n.length > 0 ? n.map((P) => P.toUpperCase()).join(", ") : t === "range" ? oc(lt, Ot, {
    optionOrLocalizedBookName: "id",
    endRefOptionOrLocalizedBookName: "id",
    repeatBookName: !0
  }) : re ? ct(re.label, re.scrRefSuffix) : t, ae = ht.filter(
    (P) => P.value !== "selectedBooks" && P.value !== "range"
  ), $t = ht.find((P) => P.value === "selectedBooks"), At = ht.find((P) => P.value === "range"), [ve, be] = N(!1), [oe, E] = N(void 0), [F, x] = N(void 0), [I, B] = N(void 0), [G, at] = N(void 0), [it, gt] = N([]), bt = w === "dropdown" && oe === "selectedBooks", yt = /* @__PURE__ */ a(
    yu,
    {
      availableBookInfo: o,
  ...
  ), Ct = It === "end", Pt = It === "start", xe = "tw:text-muted-foreground", ne = w === "dropdown" && oe === "range", Ir = ne ? B : Xe, fa = ne ? at : f ? ee : wt, $r = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    ...
    /* @__PURE__ */ u("div", { ref: ie, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        ka,
        {
          ...
          localizedStrings: z,
          getEndVerse: k,
          disableReferencesUpTo: ne ? I ?? lt : lt,
          onOpenChange: ce,
          onCloseAutoFocus: (P) => {
            var rt;
  ...
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(qe, { open: ve, onOpenChange: be, children: [
        ...
        /* @__PURE__ */ a(
          Ye,
          {
            ...
            align: "start",
            children: /* @__PURE__ */ u(ma, { container: Dt, children: [
              ae.map(({ value: P, label: rt, dropdownLabel: Xt, scrRefSuffix: xr, id: Hi }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: X(P),
                ...
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ...
                    onSelect: (P) => {
                      ...
                      Nt.current || (Xt = (rt = te.current) == null ? void 0 : rt.querySelector("button")) == null || Xt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          ka,
                          {
                            ...
                            triggerContent: /* @__PURE__ */ u(dt, { children: [
                              /* @__PURE__ */ a("span", { className: "tw:min-w-0 tw:flex-1 tw:truncate tw:text-start", children: Re(v ?? xa, "id") }),
                              /* @__PURE__ */ a(pr, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
                            ] })
                          }
                        )
        ...
        to,
        {
          ...
          children: ht.map(({ value: P, label: rt, scrRefSuffix: Xt, id: xr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Zr, { className: "tw:me-2", value: P, id: xr }),
            /* @__PURE__ */ a(Tt, { htmlFor: xr, children: ct(rt, Xt) })
          ] }, xr))
        }
      )
    ] }),
    ...
    w === "radio" && t === "range" && $r,
    w === "dropdown" && $t && /* @__PURE__ */ a(Ia, { open: oe === "selectedBooks", onOpenChange: Ar, children: /* @__PURE__ */ a(
      $a,
      {
        ref: nr,
        onCloseAutoFocus: To,
        ...
        children: /* @__PURE__ */ u(ma, { container: Se, children: [
          /* @__PURE__ */ a(Aa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Pa, { children: L }) }),
          yt,
    ...
    w === "dropdown" && At && /* @__PURE__ */ a(Ia, { open: oe === "range", onOpenChange: Ar, children: /* @__PURE__ */ a(
      $a,
      {
        ref: $e,
        onCloseAutoFocus: To,
        ...
        children: /* @__PURE__ */ u(ma, { container: Rt, children: [
          /* @__PURE__ */ a(Aa, { className: "tw:pe-8", children: /* @__PURE__ */ a(Pa, { children: O }) }),
          $r,
          /* @__PURE__ */ u(Ro, { children: [
            /* @__PURE__ */ a(Z, { variant: "outline", onClick: () => Ar(!1), children: ft }),
...
function Za({
  ...
  return /* @__PURE__ */ u(qe, { variant: i, children: [
    ...
    /* @__PURE__ */ a(Ye, { align: "start", style: { zIndex: ar }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(da, { children: [
  ...
  if (kl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+p":
        ...
        break;
      case "alt+l":
        (v = s.current) == null || v.focus(), _r(s, [h, g]);
        break;
      case "alt+n":
        (b = c.current) == null || b.focus(), _r(c, [h, g]);
        break;
      case "alt+h":
        (z = l.current) == null || z.focus(), _r(l, [h, g]);
        break;
    }
  }), Y(() => {
...
function Qh({
  ...
  return /* @__PURE__ */ u(
    Kt.CheckboxItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ a("span", { className: "tw:pointer-events-none tw:absolute tw:end-2", children: /* @__PURE__ */ a(Kt.ItemIndicator, { children: /* @__PURE__ */ a(wa, {}) }) }),
        e
      ]
    }
  );
...
export {
  ...
  Da as clearPaletteSessionIfCurrent,
  m as cn,
