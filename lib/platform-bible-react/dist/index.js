...
var ms = (t, e, r) => e in t ? fs(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var Wt = (t, e, r) => ms(t, typeof e != "symbol" ? e + "" : e, r);
import { c as b, g as Re, a as zr, C as Ge, L as Un, u as Zo, T as Ot, b as Ct, d as Et, e as Tt, A as ha, r as re, D as Ie, f as ke, h as ze, i as tr, j as Be, B as J, x as vs, k as bs, l as xs, I as ys, m as _o, n as Ke, o as Ce, p as ks, q as Kn, P as er, s as _r, t as rr, v as ar, w as Ca, y as Ea, z as No, E as or, F as Ta, G as Mt, R as Co, H as ga, J as ao, K as oo, M as no, N as io, O as Hn, Q as na, S as Eo, U as Vr, V as Lr, W as hr, X as _s, Y as Ze, Z as Ue, _ as Pe, $ as je, a0 as gr, a1 as To, a2 as So, a3 as fa, a4 as Ro, a5 as qn, a6 as Ns, a7 as Cs, a8 as Es, a9 as so, aa as Gn, ab as Sa, ac as Ts, ad as Wn, ae as Ss, af as Rs, ag as Ds, ah as Qo, ai as Ms, aj as Os, ak as Is, al as Yn, am as Xn, an as Do, ao as zs, ap as Jn, aq as ja, ar as tn, as as Fa, at as Ps, au as $s, av as As, aw as Vs, ax as Ls, ay as Bs, az as Fr, aA as Mo, aB as js, aC as Fs } from "./resizable-BVyOT7My.js";
import { aD as cf, aE as lf, aF as df, aG as wf, aH as uf, aI as pf, aJ as hf, aK as gf, aL as ff, aM as mf, aN as vf, aO as bf, aP as xf, aQ as yf, aR as kf, aS as _f, aT as Nf, aU as Cf, aV as Ef, aW as Tf, aX as Sf, aY as Rf, aZ as Df, a_ as Mf, a$ as Of, b0 as If, b1 as zf, b2 as Pf, b3 as $f, b4 as Af, b5 as Vf, b6 as Lf, b7 as Bf, b8 as jf, b9 as Ff, ba as Uf, bb as Kf } from "./resizable-BVyOT7My.js";
import { jsx as a, jsxs as u, Fragment as ht } from "react/jsx-runtime";
import { Canon as jt } from "@sillsdev/scripture";
import { Check as He, Clock as en, ChevronsLeft as rn, ChevronsRight as an, ChevronUp as Zn, ChevronDown as Qe, ArrowLeft as Us, ArrowRight as Ks, BoldIcon as Hs, ItalicIcon as qs, X as Oo, AtSign as Qn, Pencil as Gs, Trash2 as Ws, ArrowUp as ti, MoreHorizontal as Ys, MailOpen as Xs, Mail as Js, FilterIcon as Zs, ArrowLeftIcon as Qs, ChevronLeftIcon as tc, ChevronRightIcon as ec, ArrowRightIcon as rc, Copy as ei, Filter as ac, User as oc, Link as nc, CircleHelp as ic, Undo as sc, Redo as cc, SquareX as ri, FunctionSquare as ai, SquareSigma as oi, Ban as lc, AlertCircle as co, CircleCheckIcon as dc, CircleXIcon as wc, CircleHelpIcon as uc, ArrowUpIcon as pc, ArrowDownIcon as hc, ScrollText as gc, ChevronRight as fc, ChevronLeft as mc, ChevronsUpDown as vc, MenuIcon as bc, Menu as xc, EllipsisVertical as yc, MoreVertical as kc } from "lucide-react";
import { Section as Dt, compareScrRefs as ma, getChaptersForBook as _c, formatScrRef as De, formatReplacementString as Fe, getSectionForBook as ia, formatRelativeDate as Nc, sanitizeHtml as Io, NumberFormat as ni, formatBytes as Cc, getCurrentLocale as Ec, usfmMarkers as sa, isPlatformError as Tc, ABORTED as Sc, getErrorMessage as Rc, getFormatCallerFunction as Dc, deepEqual as Mc, isString as on, scrRefToBBBCCCVVV as Ua, defaultScrRef as Ka, formatScrRefRange as Oc, getLocalizeKeyForScrollGroupId as nn, formatReplacementStringToArray as sn, collectUsjMarkers as Ic } from "platform-bible-utils";
import Xt, { useRef as F, useMemo as V, createContext as Ur, useContext as Ra, useState as _, useEffect as Y, useCallback as j, useId as va, useImperativeHandle as zc, useLayoutEffect as Jt, Fragment as Kr, Component as Pc, createElement as cn, Suspense as $c, forwardRef as ii } from "react";
import { IconSelector as si, IconCheck as Da, IconChevronDown as Ac, IconChevronUp as Vc, IconLayoutSidebar as Lc, IconLayoutSidebarRight as Bc, IconChevronRight as ci, IconSearch as jc, IconLoader as Fc, IconAlertOctagon as Uc, IconAlertTriangle as Kc, IconInfoCircle as Hc, IconCircleCheck as qc } from "@tabler/icons-react";
import { createEditor as li, $getRoot as qe, $createParagraphNode as Hr, $getSelection as ae, HISTORY_MERGE_TAG as zo, ParagraphNode as di, TextNode as wi, $getPreviousSelection as Gc, $isRangeSelection as _e, $caretFromPoint as Wc, $getSiblingCaret as ui, $getChildCaret as Yc, $getAdjacentChildCaret as Xc, $isChildCaret as Jc, $normalizeCaret as Zc, $setSelectionFromCaretRange as Qc, $getCollapsedCaretRange as tl, $getCaretInDirection as ln, $splitAtPointCaretNext as el, $isTextPointCaret as rl, $findMatchingParent as pi, $isElementNode as Br, mergeRegister as Oe, getDOMTextNode as al, isHTMLElement as ol, CLEAR_EDITOR_COMMAND as hi, COMMAND_PRIORITY_EDITOR as Po, shallowMergeConfig as nl, defineExtension as ue, safeCast as nr, createState as il, FORMAT_TEXT_COMMAND as gi, $isNodeSelection as fi, COMMAND_PRIORITY_LOW as mi, RootNode as sl, LineBreakNode as cl, TabNode as ll, $isEditorState as dl, createCommand as wl, CLICK_COMMAND as ul, isDOMNode as pl, $getNodeFromDOMNode as hl, $createNodeSelection as gl, $setSelection as fl, $getEditor as ml, DecoratorNode as lo, $getState as vl, toggleTextFormatType as dn, TEXT_TYPE_TO_FORMAT as bl, $setState as xl, addClassNamesToElement as vi, $create as yl, $getNodeByKey as kl, removeClassNamesFromElement as _l, KEY_TAB_COMMAND as Nl, $isBlockElementNode as Cl, $createRangeSelection as El, $normalizeSelection__EXPERIMENTAL as Tl, OUTDENT_CONTENT_COMMAND as Sl, INDENT_CONTENT_COMMAND as wn, INSERT_TAB_COMMAND as Rl, COMMAND_PRIORITY_CRITICAL as $o, $isDecoratorNode as Dl, $isParagraphNode as Ml, $isTextNode as wo, SELECTION_CHANGE_COMMAND as bi, $insertNodes as Ol } from "lexical";
import { HeadingNode as Il, QuoteNode as zl, registerRichText as Pl } from "@lexical/rich-text";
import { flushSync as $l, createPortal as Al } from "react-dom";
...
import { Avatar as Ao, Select as Zt, Checkbox as un, Slot as qr, Tabs as fe, Menubar as Ee, ContextMenu as Ft, Progress as pn, Slider as Qr, Switch as hn } from "radix-ui";
import { useReactTable as yi, getFilteredRowModel as jl, getSortedRowModel as ki, getPaginationRowModel as Fl, getCoreRowModel as _i, flexRender as Pr, getGroupedRowModel as Ul, getExpandedRowModel as Kl } from "@tanstack/react-table";
import Hl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as uo, HIDDEN_NOTE_CALLER as po, getDefaultViewOptions as ql, isInsertEmbedOpOfType as Dr, getMarkerMenuItems as Gl, defaultStyleInfo as Wl, Editorial as Yl } from "@eten-tech-foundation/platform-editor";
...
function qa({
  ...
  const T = Ce(), B = ed(), [z, D] = _(!1), [M, W] = _(""), [U, tt] = _(""), [N, rt] = _("books"), [O, I] = _(void 0), [q, it] = _(
    void 0
  ), [ot, dt] = _(void 0), [St, Z] = _(!1), [lt, vt] = _(!1), [pt, It] = _(!1), [Ht, wt] = _(!1), me = F(null), oe = F(!1), bt = F(void 0), gt = F(void 0), xt = F(void 0), qt = F(void 0), Rt = F({}), Nt = F({}), ft = j(
    (v) => {
      e(v), l && l(v);
    },
    [e, l]
  ...
  const Qt = j(() => {
    ...
    (v) => {
      const H = q ?? ($ == null ? void 0 : $.book), at = ot ?? ($ == null ? void 0 : $.chapterNum);
      !H || !at || (ft({
        book: H,
        chapterNum: at,
        verseNum: v
  ...
  const { otLong: Vt, ntLong: te, dcLong: Cr, extraLong: Er } = {
    ...
    (v) => {
      ...
      if (v.key === "Tab") {
        ...
        const de = At[At.length - 1], Gt = v.shiftKey ? At[0] : de;
        document.activeElement === Gt && (v.preventDefault(), v.stopPropagation(), (v.shiftKey ? de : At[0]).focus());
        return;
      }
      ...
      if (!td(v.key) || St) return;
      if (N === "books" && !Ht && (v.key === "ArrowLeft" || v.key === "ArrowRight")) {
        const At = H === gt.current ? gt.current : void 0, de = (At == null ? void 0 : At.selectionStart) ?? 0, Gt = (At == null ? void 0 : At.selectionEnd) ?? 0, he = T === "rtl" ? v.key === "ArrowRight" : v.key === "ArrowLeft";
        if (!!At && (de !== Gt || (he ? de > 0 : Gt < At.value.length))) return;
      }
      if (v.shiftKey || N === "books" && H !== gt.current && (H != null && H.closest('button, a, [role="button"]')))
        return;
      const yt = (() => {
        const At = N === "books" && $ && be && $.chapterNum ? { bookId: $.book, chapterNum: $.chapterNum } : void 0, de = N === "verses" ? { bookId: q, chapterNum: ot } : At;
        if (de) {
          const { bookId: Gt, chapterNum: he } = de;
          return !Gt || !he || !w ? void 0 : {
            max: w(Gt, he),
            current: ta(M) ?? 0,
            buildValue: (Rr) => ca(Gt, he, Rr),
            refs: Nt,
        ...
        if (N === "chapters" || N === "books" && $ && Le($.book) > 1) {
          const Gt = N === "chapters" ? O : $ == null ? void 0 : $.book;
          return Gt ? {
            max: Le(Gt),
            current: Ir(M) ?? 0,
            buildValue: (he) => fr(Gt, he),
            refs: Rt,
  ...
  Jt(() => {
    const v = setTimeout(() => {
      if (z && N === "books" && xt.current && qt.current) {
        const H = xt.current, at = qt.current, Lt = at.offsetTop, Kt = H.clientHeight, yt = at.clientHeight, ee = Lt - Kt / 2 + yt / 2;
        H.scrollTo({
          top: Math.max(0, ee),
          behavior: "smooth"
        }), W(go(t.book));
    ...
    if (N === "verses" && q && ot !== void 0) {
      const v = q === t.book && ot === t.chapterNum, H = v ? t.verseNum : 1;
      W(
        ca(q, ot, H)
      ), setTimeout(() => {
        if (xt.current)
              ...
              N === "books" ? /* @__PURE__ */ u(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ a(Ea, { className: "tw:translate-y-px tw:gap-1 tw:pe-2", children: G.map(
                      ({ onClick: v, disabled: H, title: at, icon: Lt, group: Kt }, yt) => {
                        ...
                        return (
                          ...
                          /* @__PURE__ */ u(Kr, { children: [
                            yt > 0 && Kt !== G[yt - 1].group && /* @__PURE__ */ a(No, {}),
                            H ? (
                ...
                /* @__PURE__ */ u(Ct, { children: [
                  /* @__PURE__ */ a(Et, { asChild: !0, children: /* @__PURE__ */ a(
                    J,
                    {
                      ...
                      tabIndex: -1,
                      "aria-label": Gr,
                      children: T === "ltr" ? /* @__PURE__ */ a(Us, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(Ks, { className: "tw:h-4 tw:w-4" })
                    }
                  ) }),
...
function sh({
  ...
  const w = Ga(d, "%webView_bookSelector_currentBook%"), p = Ga(d, "%webView_bookSelector_choose%"), h = Ga(d, "%webView_bookSelector_chooseBooks%"), [f, m] = _(
    "current book"
    /* CurrentBook */
  ), x = (g) => {
    m(g), t(g);
...
function Bd(t) {
  const e = ae() || Gc();
  let r;
  if (_e(e)) r = Wc(e.focus, "next");
  else {
    if (e != null) {
      const i = e.getNodes(), c = i[i.length - 1];
      c && (r = ui(c, "next"));
    }
    r = r || Yc(qe(), "previous").getFlipped().insert(Hr());
  }
  const o = jd(t, r), n = Xc(o), s = Jc(n) ? Zc(n) : o;
  return Qc(tl(s)), t.getLatest();
}
function jd(t, e, r) {
  let o = ln(e, "next");
  for (let n = o; n; n = el(n, r)) o = n;
  return rl(o) && ba(283), o.insert(t.isInline() ? Hr().append(t) : t), ln(ui(t.getLatest(), "next"), e.direction);
}
function Fd(t) {
  const e = ae();
  if (!_e(e)) return !1;
...
const Ya = il("format", { parse: (t) => typeof t == "number" ? t : 0 });
class Ai extends lo {
  $config() {
...
}, name: "@lexical/extension/InitialState", nodes: [sl, wi, cl, ll, di] }), En = Symbol.for("@lexical/extension/LexicalBuilder");
function Tn() {
}
function ew(t) {
  throw t;
...
}, dependencies: [xo], name: "@lexical/extension/NodeSelection" }), aw = wl("INSERT_HORIZONTAL_RULE_COMMAND");
class vr extends lo {
  static getType() {
...
ue({ dependencies: [xo, Sn], name: "@lexical/extension/HorizontalRule", nodes: () => [vr], register(t, e, r) {
  ...
  return Oe(t.registerCommand(aw, (i) => {
    ...
    return !0;
  }, Po), t.registerCommand(ul, (i) => {
    if (pl(i.target)) {
      const c = hl(i.target);
      if (nw(c)) return function(l, d = !1) {
        const w = ae(), p = l.isSelected(), h = l.getKey();
        let f;
        d && fi(w) ? f = w : (f = gl(), fl(f)), p ? f.delete(h) : f.add(h);
      }(c, i.shiftKey), !0;
    }
    return !1;
...
function iw(t, e, r = Fi) {
  return Oe(t.registerCommand(Nl, (o) => {
    const n = ae();
    if (!_e(n)) return !1;
    o.preventDefault();
    const s = function(i) {
      ...
      if (p.canIndent()) {
        const h = p.getKey();
        let f = El();
        if (f.anchor.set(h, 0, "element"), f.focus.set(h, 0, "element"), f = Tl(f), f.anchor.is(d)) return !0;
      }
      return !1;
  ...
  return function(r, o) {
    ...
    return Uo(() => r.registerDecoratorListener((i) => {
      ...
      for (let l = 0; l < c.length; l++) {
        const d = c[l], w = a(o, { onError: (h) => r._onError(h), children: a($c, { fallback: null, children: n[d] }) }), p = r.getElementByKey(d);
...
function Rw() {
  const { activeEditor: t } = Gi(), [e, r] = _([]), o = j((n) => {
    if (_e(n) || Vl(n)) {
      const s = [];
      Mn.forEach(({ format: i }) => {
    ...
    "div",
    {
      ...
      children: [
        ...
        P && /* @__PURE__ */ u(Ie, { children: [
          /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(J, { variant: "ghost", size: "icon", children: /* @__PURE__ */ a(Ys, {}) }) }),
...
function rs({
  ...
  const [U, tt] = _(zn), [N, rt] = _(), [O, I] = _(), q = o, [it, ot] = _(!1), [dt, St] = _(!1), [Z, lt] = _(!1), [vt, pt] = _(!1), [It, Ht] = _(!1), [wt, me] = _(E), [oe, bt] = _(!1), gt = F(void 0), [xt, qt] = _(/* @__PURE__ */ new Map());
  Y(() => {
    let y = !0;
    return (async () => {
  ...
  const R = j(
    async (y) => {
      ...
      G && await p({ threadId: l, contents: G }) && se();
    },
    [
      se,
      U,
    ...
    async (y) => {
      const G = we(U) ? _a(U) : void 0, A = y.status ? y.assignedUser : N ?? y.assignedUser, et = await p({
        ...y,
        contents: G,
        assignedUser: A
      });
      return et && (A !== void 0 && I(A), G && se()), et;
    },
    [se, U, p, N]
  );
          ...
          /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            ...
            /* @__PURE__ */ a(
              J,
              {
                ...
                children: wt ? /* @__PURE__ */ a(Xs, {}) : /* @__PURE__ */ a(Js, {})
              }
            ),
            M === void 0 ? (
...
function Uw({
  ...
  const M = e["%conflict_note_no_result%"] ?? "No result preview available.", W = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: M }), U = (O) => O ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: O }) : W, tt = () => {
    ...
    const I = m === O.value, q = `${d}-${O.value}`, it = N(O);
    return (
...
function vh({
  ...
  const [k, C] = _(/* @__PURE__ */ new Set()), [E, P] = _(), [T, B] = _(), z = j(
    async (I) => {
      const q = await s(I);
      return q !== void 0 && I.assignedUser !== void 0 && I.assignedUser !== "" && B(I.assignedUser), q;
    },
    [s]
  );
  Y(() => {
  ...
  const D = r.filter(
    ...
    (I) => {
      C((q) => new Set(q).add(I.id)), P(I.id), x == null || x(I.id);
    },
    [x]
  ), U = j(
    (I) => {
      ...
      }), P(I), x == null || x(q ? void 0 : I);
    },
    [k, x]
  ), { listboxRef: tt, activeId: N, handleKeyDown: rt } = _s({
    options: M,
    onOptionSelect: W
  }), O = j(
    (I) => {
      ...
      children: D.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Ww, { ...q, conflictResolution: S }) : /* @__PURE__ */ a(rs, { ...q })
          },
          I.id
        );
      })
...
function Nh({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ a("div", { id: t, children: /* @__PURE__ */ u(Ie, { children: [
    ...
    /* @__PURE__ */ a(ze, { children: r.map((d, w) => /* @__PURE__ */ u("div", { children: [
      ...
      /* @__PURE__ */ a(qn, { children: d.itemType === 0 ? /* @__PURE__ */ a(ht, { children: d.items.map((p, h) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
        Ue,
        {
          checked: o[w][h],
        ...
        Ns,
        {
          ...
          children: d.items.map((p) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(Cs, { value: p.id, children: p.label }) }, p.id))
        }
      ) }),
      /* @__PURE__ */ a(Ze, {})
    ] }, d.label)) })
...
function Sh({
  ...
  const [g, S] = _("generated"), [k, C] = _("generated"), [E, P] = _("*"), [T, B] = _("*"), [z, D] = _("f"), [M, W] = _(!1), [U, tt] = _(!0), [N, rt] = _(!1), O = F(!1), I = F(""), [q, it] = _(!1), [ot, dt] = _(), [St, Z] = _(), [lt, vt] = _(), [pt, It] = _(), Ht = F(null), wt = F(
    void 0
  ...
  const xt = j(() => {
    var y, G, A;
    const R = (y = f.current) == null ? void 0 : y.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), X = (A = (G = f.current) == null ? void 0 : G.ownerDocument.getSelection()) == null ? void 0 : A.anchorNode;
  ...
  Y(() => {
    ...
    if (y && Dr("note", y)) {
      const et = (G = y.insert.note) == null ? void 0 : G.caller;
      let nt = "custom";
  ...
  const qt = j(
    (R = !1) => {
      ...
      K && Dr("note", K) && (r == null || r([K]), R && d && s && ((G = d.current) == null || G.replaceEmbedUpdate(s, [K])));
    },
    [s, r, p, d]
  ), Rt = j(
    (R, K) => {
      var G, A, et;
      const X = (A = (G = h.current) == null ? void 0 : G.getNoteOps(0)) == null ? void 0 : A.at(0);
    ...
    var R;
    wt.current || (R = h.current) == null || R.commitPendingMarkerEdits(), qt(!0), o();
  }, [o, qt]), ft = F(Nt);
  Jt(() => {
    ft.current = Nt;
  });
  ...
  const ie = () => {
    ...
    if (K && Dr("note", K)) {
      ...
      const nt = (A = (G = K.insert.note) == null ? void 0 : G.contents) == null ? void 0 : A.ops;
    ...
    (R) => {
      ...
      if (K && Dr("note", K)) {
        ...
        const nt = (G = K.insert.note) == null ? void 0 : G.style, ct = (et = (A = K.insert.note) == null ? void 0 : A.contents) == null ? void 0 : et.ops;
        if (nt || W(!1), W(
        ...
        tt(JSON.stringify(K) === I.current), qt();
      } else
        W(!1), tt(!0);
    },
    [qt]
    ...
    (R, K, X) => {
      ...
      Rs({
        ...
        onShowError: (A) => {
          (!Tc(A) || A.code !== Sc) && console.warn(
            `FootnoteEditor: the marker palette did not open: ${Rc(A)}`
          );
        }
      });
    },
    ...
    (R) => {
      ...
      Ds(R, K, {
        ...
        commitTyped: (y) => {
          var G;
          return (G = h.current) == null ? void 0 : G.commitTypedMarker(y);
        },
        commitTypedAndReopen: (y) => {
          var G;
          (G = h.current) == null || G.commitTypedMarker(y, { trailingSpace: !1 }), $();
        },
        commitTypedCloser: (y) => {
          var G;
          return (G = h.current) == null ? void 0 : G.commitTypedCloser(y);
        },
        commitItem: (y) => {
          var A;
          const G = K.items.find((et) => et.marker === y);
          G && ((A = h.current) == null || A.applyMarkerMenuSelection(G, {
            trigger: "backslash",
            literalPrefixLanded: !1
          }));
        }
  ...
  Y(() => {
    ...
    const R = (K) => {
      var G, A;
      const X = (G = f.current) == null ? void 0 : G.querySelector(".editor-input");
    ...
    if (((X = bt.view) == null ? void 0 : X.markerMode) === "editable") {
      ...
      return document.addEventListener("keydown", y, { capture: !0 }), document.addEventListener("paste", G, { capture: !0 }), () => {
        document.removeEventListener("keydown", y, { capture: !0 }), document.removeEventListener("paste", G, { capture: !0 });
      };
    }
    const K = (y) => {
      const G = R();
      !q && G && document.activeElement === G && y.key === c ? (y.preventDefault(), zt()) : q && y.key === "Escape" && (y.preventDefault(), it(!1));
    };
    ...
    const R = () => {
      ...
      X && !X.isCollapsed || xt() || ((G = h.current) == null || G.selectNote(0), (A = h.current) == null || A.focus());
    };
...
function Vh({
  ...
  }, [B, rt]), I = V(() => O.length === 0 ? [] : Du(O, D, W), [O, D, W]), q = V(() => {
    var vt, pt;
    if (!B) return l;
...
function ju({
  ...
  const c = t ? qr.Root : "button", { state: l } = za(), d = /* @__PURE__ */ a(
    c,
    {
...
const Ve = "scrBook", Uu = "scrRef", Je = "source", Ku = "details", Hu = "Scripture Reference", qu = "Scripture Book", ns = "Type", Gu = "Details";
function Wu(t, e) {
  const r = e ?? !1;
  return [
    {
                    ...
                    children: U.getIsGrouped() ? /* @__PURE__ */ u(
                      J,
                      {
                        ...
                        children: [
                          ...
                          !D.getIsExpanded() && (W === "ltr" ? /* @__PURE__ */ a(fc, {}) : /* @__PURE__ */ a(mc, {})),
                          " ",
...
function eg({
  ...
  const T = Bt(
  ...
  }, oe = F(null), bt = F(null), gt = F(!1), xt = F(null), qt = F(!1), [Rt, Nt] = _(void 0), ft = F(!1), ne = F(!1), ie = F(null), se = j((L) => {
    if (L) {
    ...
    [r, n, g, s]
  ), kt = pt.find((L) => L.value === t), ve = () => t === "selectedBooks" && n.length > 0 ? n.map((L) => L.toUpperCase()).join(", ") : t === "range" ? Oc(Ht, wt, {
  ...
  ), mt = pt.find((L) => L.value === "selectedBooks"), ce = pt.find((L) => L.value === "range"), [Qt, R] = _(!1), [K, X] = _(void 0), [y, G] = _(void 0), [A, et] = _(void 0), [nt, ct] = _(void 0), [_t, Pt] = _([]), Vt = p === "dropdown" && K === "selectedBooks", te = /* @__PURE__ */ a(
    tp,
    {
      availableBookInfo: o,
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Mt, { htmlFor: "scope-range-start", className: b(Cr && ir), children: q }),
      /* @__PURE__ */ a(
        qa,
        {
  ...
  const [cr, Aa] = _(null), [Se, lr] = _(null), [dr, Va] = _(null), Gr = 200, [La, Wr] = _(!1);
  Y(() => {
  ...
  const Yr = j(
    (L) => {
      G(L), et(Ht), ct(wt), Pt(n), R(!1), X(L);
    },
    [Ht, wt, n]
  ), Xr = j(() => {
    y !== void 0 && (y === "range" ? (A && (m == null || m(A)), nt && (x == null || x(nt))) : y === "selectedBooks" && s(_t), zt(y), X(void 0), G(void 0));
  }, [
    y,
    A,
    nt,
                ...
                /* @__PURE__ */ a(
                  Be,
                  {
                    ...
                    onSelect: (L) => {
                      ...
                      qt.current || ($t = (Q = bt.current) == null ? void 0 : Q.querySelector("button")) == null || $t.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
...
const ls = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => cs(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, l) => c.order - l.order).map((c) => /* @__PURE__ */ u(Ct, { children: [
  /* @__PURE__ */ a(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ u(
    Be,
    {
      ...
      children: [
        ...
        c.shortcut && /* @__PURE__ */ a(Ps, { children: c.shortcut })
      ]
    },
    `dropdown-menu-item-${c.label}-${c.command}`
  ) : /* @__PURE__ */ u($s, { children: [
    /* @__PURE__ */ a(As, { children: c.label }),
    /* @__PURE__ */ a(Vs, { children: /* @__PURE__ */ a(Ls, { children: ls(
      t,
      e,
      is(t, c.id),
      o
...
function ko({
  ...
  return /* @__PURE__ */ u(Ie, { variant: i, children: [
    /* @__PURE__ */ a(ke, { "aria-label": r, className: n, asChild: !0, id: l, children: /* @__PURE__ */ a(J, { variant: c, size: "icon", children: o ?? /* @__PURE__ */ a(bc, {}) }) }),
    /* @__PURE__ */ a(ze, { align: "start", style: { zIndex: Pe }, children: w.map(({ columnKey: h, label: f }, m) => {
      const x = `${d}-${h}`;
      return /* @__PURE__ */ u(Kr, { children: [
        /* @__PURE__ */ u(qn, { "aria-labelledby": p ? x : void 0, children: [
          p && /* @__PURE__ */ a(tr, { id: x, children: f }),
          /* @__PURE__ */ a(Ot, { children: ls(e.groups, e.items, h, t) })
        ] }),
...
const ip = Object.freeze([520, 420, 340]), ws = Xt.forwardRef(
  ({ id: t, className: e, children: r }, o) => {
    ...
    }, []), l = ds(n, ip), d = Ti() ?? l, w = d >= $r.MINIMUM;
...
function ig({
  ...
  return /* @__PURE__ */ u(ws, { className: `tw:w-full tw:border-b ${s}`, id: n, children: [
    r && /* @__PURE__ */ a(
      ko,
      {
        onSelectMenuItem: t,
...
function sg({
  ...
  return /* @__PURE__ */ a(ws, { className: "tw:pointer-events-none", id: r, children: e && /* @__PURE__ */ a(
    ko,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const us = Xt.forwardRef(({ className: t, ...e }, r) => {
  const o = Ce();
  return /* @__PURE__ */ a(
    fe.Root,
    {
...
ps.displayName = fe.List.displayName;
...
)), hs = Xt.forwardRef(({ className: t, ...e }, r) => /* @__PURE__ */ a(
  fe.Content,
  {
    ref: r,
    className: b(
...
hs.displayName = fe.Content.displayName;
function cg({
  tabList: t,
  searchValue: e,
  onSearch: r,
  ...
  return /* @__PURE__ */ u("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ u(us, { children: [
      /* @__PURE__ */ a(ps, { children: t.map((c) => /* @__PURE__ */ a(sp, { value: c.value, children: c.value }, c.key)) }),
      t.map((c) => /* @__PURE__ */ a(hs, { value: c.value, children: c.content }, c.key))
    ] })
  ] });
}
function cp({
  ...
  if (Xl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(cp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: ss(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(lp, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Pe },
          children: /* @__PURE__ */ a(Ot, { children: gs(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function pg({
  ...
  return /* @__PURE__ */ u(ar, { id: s, className: b("pr-twp", n), shouldFilter: !1, children: [
    ...
    /* @__PURE__ */ a("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", children: /* @__PURE__ */ u(js, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ a(Fs, { children: /* @__PURE__ */ a(jc, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) }),
    /* @__PURE__ */ u(or, { children: [
