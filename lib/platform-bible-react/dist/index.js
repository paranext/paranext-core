...
import Rt, { forwardRef as ts, useState as ze, useRef as Rn, useCallback as $e, useMemo as Bt, useEffect as Vn } from "react";
...
const Gs = ge.Root, Xs = ge.Trigger, Ks = x.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.SubTrigger,
  {
    ref: o,
    className: je(
...
Ks.displayName = ge.SubTrigger.displayName;
...
const Js = x.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ue(
  ge.CheckboxItem,
  {
    ref: o,
    className: je(
...
const Zs = x.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ue(
  ge.RadioItem,
  {
    ref: r,
    className: je(
...
const Qs = ts(
  ({ handleSearch: e, handleKeyUp: t, handleOnClick: n, ...r }, o) => /* @__PURE__ */ ue("div", { className: "pr-relative", children: [
    /* @__PURE__ */ T(
      _i,
      {
        ...r,
...
function el({ endChapter: e, activeChapter: t, handleSelectChapter: n }) {
  ...
  return /* @__PURE__ */ T("div", { className: "pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch pr-bg-amber-50", children: r.map((o) => /* @__PURE__ */ T(
    "div",
    {
      className: je(
...
function yh({ scrRef: e, handleSubmit: t }) {
  const { allBookIds: n } = he, [r, o] = ze(""), [i, s] = ze(""), [l, c] = ze(!1), u = Rn(void 0), d = $e(
    (S) => ({
  ...
  return /* @__PURE__ */ T("div", { children: /* @__PURE__ */ ue(Gs, { modal: !1, open: l, onOpenChange: h, children: [
    /* @__PURE__ */ T(Xs, { asChild: !0, children: /* @__PURE__ */ T(
      Qs,
      {
        ...
        handleSearch: p,
        handleKeyUp: () => c(!0),
        handleOnClick: () => s(he.bookNumberToId(e.bookNum)),
    ...
    /* @__PURE__ */ ue(
      $i,
      {
        ...
        children: [
          ...
          ol.map(
            (S) => f(S).length > 0 && /* @__PURE__ */ ue("div", { children: [
              /* @__PURE__ */ T(Mi, { className: "pr-font-semibold pr-text-slate-700", children: rl[S] }),
...
function cl() {
  return So || (So = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var m = c, C = u, P = l, A = s, _ = t, D = d, B = r, z = v, G = b, L = n, I = i, R = o, j = f, Q = !1;
    function Z($) {
...
function Tl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function w(N) {
      return !!(typeof N == "string" || typeof N == "function" || N === n || N === o || S || N === r || N === u || N === d || E || N === b || v || g || h || typeof N == "object" && N !== null && (N.$$typeof === p || N.$$typeof === f || N.$$typeof === i || N.$$typeof === s || N.$$typeof === c || // This needs to include all possible module reference object
    ...
    var C = s, P = i, A = e, _ = c, D = n, B = p, z = f, G = t, L = o, I = r, R = u, j = d, Q = !1, Z = !1;
    function O(N) {
...
function In(e) {
  const {
    ...
    isEnabled: s = uc,
    open: l
  } = e, c = x.useRef(!1), u = x.useRef(null), d = x.useRef(null), f = x.useRef(null), p = x.useRef(null), b = x.useRef(!1), v = x.useRef(null), g = Be(t.ref, v), h = x.useRef(null);
  x.useEffect(() => {
...
`)), v.current.setAttribute("tabIndex", "-1")), b.current && v.current.focus()), () => {
    ...
    const y = xe(v.current), w = (P) => {
      ...
      if ((y.activeElement === u.current || y.activeElement === d.current) && (A = i(v.current)), A.length > 0) {
        var _, D;
        const B = !!((_ = h.current) != null && _.shiftKey && ((D = h.current) == null ? void 0 : D.key) === "Tab"), z = A[0], G = A[A.length - 1];
...
function wc(e) {
  const {
    ...
    open: d,
    rootRef: f
  } = e, p = x.useRef({}), b = x.useRef(null), v = x.useRef(null), g = Be(v, f), [h, E] = x.useState(!d), S = vc(c);
  let y = !0;
  ...
  const w = () => xe(b.current), m = () => (p.current.modalRef = v.current, p.current.mount = b.current, p.current), C = () => {
    ...
    const R = bc(t) || w().body;
    o.add(m(), R), v.current && C();
  }), A = x.useCallback(() => o.isTopModal(m()), [o]), _ = on((R) => {
    b.current = R, R && (d && A() ? C() : v.current && en(v.current, y));
  }), D = x.useCallback(() => {
    o.remove(m(), y);
  }, [y, o]);
  x.useEffect(() => () => {
...
var Se = "top", Le = "bottom", Fe = "right", Ce = "left", Lr = "auto", pn = [Se, Le, Fe, Ce], _t = "start", sn = "end", xc = "clippingParents", ra = "viewport", Gt = "popper", Ec = "reference", Ho = /* @__PURE__ */ pn.reduce(function(e, t) {
...
function fn(e) {
  for (var t = Ie(e), n = Wo(e); n && Dc(n) && Ze(n).position === "static"; )
    n = Wo(n);
...
function Fc(e) {
  ...
  if (!(!i || !s)) {
    var f = Lc(o.padding, n), p = Vr(i), b = c === "y" ? Se : Ce, v = c === "y" ? Le : Fe, g = n.rects.reference[d] + n.rects.reference[c] - s[c] - n.rects.popper[d], h = s[c] - n.rects.reference[c], E = fn(i), S = E ? c === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, y = g / 2 - h / 2, w = f[b], m = S - p[d] - f[v], C = S / 2 - p[d] / 2 + y, P = tn(w, C, m), A = c;
...
function qo(e) {
  ...
  b = h.x, g = h.y;
  var E = s.hasOwnProperty("x"), S = s.hasOwnProperty("y"), y = Ce, w = Se, m = window;
  if (u) {
    ...
    if (C === Ie(n) && (C = at(n), Ze(C).position !== "static" && l === "absolute" && (P = "scrollHeight", A = "scrollWidth")), C = C, o === Se || (o === Ce || o === Fe) && i === sn) {
      w = Le;
      var _ = f && C === m && m.visualViewport ? m.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        C[P]
      );
  ...
  if (b = z.x, g = z.y, c) {
    var G;
    return Object.assign({}, B, (G = {}, G[w] = S ? "0" : "", G[y] = E ? "0" : "", G.transform = (m.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + g + "px)" : "translate3d(" + b + "px, " + g + "px, 0)", G));
  }
...
function ou(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, f = n.rootBoundary, p = n.altBoundary, b = n.flipVariations, v = b === void 0 ? !0 : b, g = n.allowedAutoPlacements, h = t.options.placement, E = Ue(h), S = E === h, y = c || (S || !v ? [Sn(h)] : ru(h)), w = [h].concat(y).reduce(function(F, U) {
    ...
    }, []), m = t.rects.reference, C = t.rects.popper, P = /* @__PURE__ */ new Map(), A = !0, _ = w[0], D = 0; D < w.length; D++) {
      var B = w[D], z = Ue(B), G = jt(B) === _t, L = [Se, Le].indexOf(z) >= 0, I = L ? "width" : "height", R = ln(t, {
        placement: B,
        boundary: d,
        rootBoundary: f,
        altBoundary: p,
...
function hu(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, f = n.padding, p = n.tether, b = p === void 0 ? !0 : p, v = n.tetherOffset, g = v === void 0 ? 0 : v, h = ln(t, {
    ...
    padding: f,
    altBoundary: d
  }), E = Ue(t.placement), S = jt(t.placement), y = !S, w = zr(E), m = fu(w), C = t.modifiersData.popperOffsets, P = t.rects.reference, A = t.rects.popper, _ = typeof g == "function" ? g(Object.assign({}, t.rects, {
    placement: t.placement
  })) : g, D = typeof _ == "number" ? {
    mainAxis: _,
    altAxis: _
  ...
  if (C) {
    if (i) {
      var G, L = w === "y" ? Se : Ce, I = w === "y" ? Le : Fe, R = w === "y" ? "height" : "width", j = C[w], Q = j + h[L], Z = j - h[I], O = b ? -A[R] / 2 : 0, M = S === _t ? P[R] : A[R], V = S === _t ? -A[R] : -P[R], X = t.elements.arrow, F = b && X ? Vr(X) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : sa(), W = U[L], q = U[I], H = tn(0, P[R], F[R]), K = y ? P[R] / 2 - O - H - W - D.mainAxis : M - H - W - D.mainAxis, Y = y ? -P[R] / 2 + O + H + q + D.mainAxis : V + H + q + D.mainAxis, ne = t.elements.arrow && fn(t.elements.arrow), $ = ne ? w === "y" ? ne.clientTop || 0 : ne.clientLeft || 0 : 0, J = (G = B == null ? void 0 : B[w]) != null ? G : 0, N = j + K - J - $, re = j + Y - J, ve = tn(b ? _n(Q, N) : Q, j, b ? ft(Z, re) : Z);
      C[w] = ve, z[w] = ve - j;
    }
    if (l) {
      var Te, me = w === "x" ? Se : Ce, lt = w === "x" ? Le : Fe, ke = C[m], Ge = m === "y" ? "height" : "width", Pe = ke + h[me], Xe = ke - h[lt], ye = [Se, Ce].indexOf(E) !== -1, yt = (Te = B == null ? void 0 : B[m]) != null ? Te : 0, ct = ye ? Pe : ke - P[Ge] - A[Ge] - yt + D.altAxis, Vt = ye ? ke + P[Ge] + A[Ge] - yt - D.altAxis : Xe, bn = b && ye ? Bc(ct, ke, Vt) : tn(b ? ct : Pe, ke, b ? Vt : Xe);
      C[m] = bn, z[m] = bn - ke;
    }
    t.modifiersData[r] = z;
  }
...
function yu(e, t, n) {
  n === void 0 && (n = !1);
  var r = De(t), o = De(t) && vu(t), i = at(t), s = Dt(e, o, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  Wr(i)) && (l = bu(t)), De(t) ? (c = Dt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = Hr(i))), {
  ...
  return function(l, c, u) {
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!p) {
          ...
          if (Zo(S, y)) {
            d.rects = {
              reference: yu(S, fn(y), d.options.strategy === "fixed"),
              popper: Vr(y)
            ...
            for (var w = 0; w < d.orderedModifiers.length; w++) {
              ...
              var m = d.orderedModifiers[w], C = m.fn, P = m.options, A = P === void 0 ? {} : P, _ = m.name;
    ...
    function v() {
      d.orderedModifiers.forEach(function(h) {
        var E = h.name, S = h.options, y = S === void 0 ? {} : S, w = h.effect;
...
var Ou = [Xc, pu, qc, Ac, uu, iu, mu, zc, su], Su = /* @__PURE__ */ ku({
  defaultModifiers: Ou
});
const pa = "Popper";
function Cu(e) {
...
const Mu = () => et({
  ...
  } = t, h = ce(t, Pu), E = x.useRef(null), S = Be(E, n), y = x.useRef(null), w = Be(y, p), m = x.useRef(w);
  mt(() => {
    m.current = w;
...
`));
  ...
  const {
    ...
    slotProps: h = {},
    slots: E = {}
  } = t, S = ce(t, Nu), [y, w] = x.useState(!0), m = () => {
    w(!1);
  }, C = () => {
    w(!0);
  };
...
const Ju = Ve("border", Ae), Zu = Ve("borderTop", Ae), Qu = Ve("borderRight", Ae), ed = Ve("borderBottom", Ae), td = Ve("borderLeft", Ae), nd = Ve("borderColor"), rd = Ve("borderTopColor"), od = Ve("borderRightColor"), id = Ve("borderBottomColor"), ad = Ve("borderLeftColor"), sd = Ve("outline", Ae), ld = Ve("outlineColor"), Kn = (e) => {
...
Xn(Ju, Zu, Qu, ed, td, nd, rd, od, id, ad, Kn, sd, ld);
const Yn = (e) => {
...
Xn(Yn, Jn, Zn, cd, ud, dd, pd, fd, hd, md, gd, bd);
function $t(e, t) {
  return t === "grey" ? t : e;
}
const vd = be({
...
function Yr(e = {}, ...t) {
  ...
  return u.applyStyles = $d, u = t.reduce((d, f) => Ye(d, f), u), u.unstable_sxConfig = k({}, Xr, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(f) {
    return Kr({
      sx: f,
      theme: this
    });
...
function ii(e, t, n, r) {
  ...
  e[t] || (e.hasOwnProperty(n) ? e[t] = e[n] : t === "light" ? e.light = Xd(e.main, o) : t === "dark" && (e.dark = Gd(e.main, i)));
}
function ap(e = "light") {
  return e === "dark" ? {
    main: Tt[200],
...
function mp(e, t) {
  ...
  const b = o / 14, v = f || ((E) => `${E / u * b}rem`), g = (E, S, y, w, m) => k({
    fontFamily: r,
    fontWeight: E,
    fontSize: v(S),
...
const Rp = Np(), Zr = Rp, Qr = "$$material", ya = (e) => Cn(e) && e !== "classes", $p = zd({
  themeId: Qr,
  defaultTheme: Zr,
...
const Dp = {
  ...
  const {
  ...
  } = t, E = ce(t, Ap), S = Jt(), y = x.useRef(), w = gn(), m = x.useRef(null), C = Be(m, i.ref, n), P = (I) => (R) => {
    if (I) {
      const j = m.current;
      R === void 0 ? I(j) : I(j, R);
    }
    ...
    let Z;
    g === "auto" ? (Z = w.transitions.getAutoHeightDuration(I.clientHeight), y.current = Z) : Z = R, I.style.transition = [w.transitions.create("opacity", {
      duration: Z,
      delay: j
    }), w.transitions.create("transform", {
      ...
      easing: Q
    })].join(","), I.style.opacity = 0, I.style.transform = Rr(0.75), f && f(I);
  }), G = P(p);
  return /* @__PURE__ */ T(h, k({
    ...
    onExiting: B,
    addEndListener: (I) => {
      g === "auto" && S.start(y.current || 0, I), r && r(m.current, I);
    },
    timeout: g === "auto" ? null : g
  }, E, {
    children: (I, R) => /* @__PURE__ */ x.cloneElement(i, k({
      style: k({
        opacity: 0,
        transform: Rr(0.75),
        visibility: I === "exited" && !l ? "hidden" : void 0
      }, Dp[I], v, i.props.style),
      ref: C
    }, R))
  }));
});
...
const $r = eo, jp = (e) => {
  ...
  const o = ba(), i = tt({
    ...
    slots: y,
    slotProps: w
  } = i, m = ce(i, Bp), C = (r = y == null ? void 0 : y.root) != null ? r : c == null ? void 0 : c.Root, P = k({
    anchorEl: s,
    container: d,
    disablePortal: f,
    keepMounted: p,
...
const Oa = /* @__PURE__ */ x.forwardRef(function(t, n) {
  var r, o, i, s, l, c, u, d, f, p, b, v, g, h, E, S, y, w, m;
  const C = tt({
    props: t,
    name: "MuiTooltip"
  }), {
    ...
    TransitionProps: J
  } = C, N = ce(C, zp), re = /* @__PURE__ */ x.isValidElement(A) ? A : /* @__PURE__ */ T("span", {
    children: A
...
`));
  ...
  const io = (ee) => {
    ...
    Pe.current && ee.type !== "touchstart" || (me && me.removeAttribute("title"), yt.clear(), ct.clear(), R || kn && j ? yt.start(kn ? j : R, () => {
      io(ee);
    }) : io(ee));
  }, ao = (ee) => {
    yt.clear(), ct.start(M, () => {
  ...
  x.useEffect(() => {
    if (!Ke)
      return;
    function ee(Ne) {
      (Ne.key === "Escape" || Ne.key === "Esc") && yn(Ne);
    }
  ...
  const nr = x.useRef(), Xa = (ee) => {
    const Ne = re.props;
    Ne.onMouseMove && Ne.onMouseMove(ee), Kt = {
      x: ee.clientX,
      y: ee.clientY
...
`));
  ...
  const Ht = {};
  I || (_e.onTouchStart = Wa, _e.onTouchEnd = qa), G || (_e.onMouseOver = On(fo, _e.onMouseOver), _e.onMouseLeave = On(ho, _e.onMouseLeave), Xe || (Ht.onMouseOver = fo, Ht.onMouseLeave = ho)), z || (_e.onFocus = On(uo, _e.onFocus), _e.onBlur = On(co, _e.onBlur), Xe || (Ht.onFocus = uo, Ht.onBlur = co)), process.env.NODE_ENV !== "production" && re.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${re.props.title}\` or the Tooltip component.`].join(`
`));
  const Ka = x.useMemo(() => {
    var ee;
    let Ne = [{
    ...
    touch: Pe.current
  }), or = Hp(Wt), mo = (r = (o = Y.popper) != null ? o : _.Popper) != null ? r : Wp, go = (i = (s = (l = Y.transition) != null ? l : _.Transition) != null ? s : $) != null ? i : $r, bo = (c = (u = Y.tooltip) != null ? u : _.Tooltip) != null ? c : qp, vo = (d = (f = Y.arrow) != null ? f : _.Arrow) != null ? d : Gp, Ya = Zt(mo, k({}, H, (p = K.popper) != null ? p : D.popper, {
    className: we(or.popper, H == null ? void 0 : H.className, (b = (v = K.popper) != null ? v : D.popper) == null ? void 0 : b.className)
  }), Wt), Ja = Zt(go, k({}, J, (g = K.transition) != null ? g : D.transition), Wt), Za = Zt(bo, k({}, (h = K.tooltip) != null ? h : D.tooltip, {
    className: we(or.tooltip, (E = (S = K.tooltip) != null ? S : D.tooltip) == null ? void 0 : E.className)
  }), Wt), Qa = Zt(vo, k({}, (y = K.arrow) != null ? y : D.arrow, {
    className: we(or.arrow, (w = (m = K.arrow) != null ? m : D.arrow) == null ? void 0 : w.className)
  }), Wt);
  return /* @__PURE__ */ ue(x.Fragment, {
    children: [/* @__PURE__ */ x.cloneElement(re, _e), /* @__PURE__ */ T(mo, k({
      as: q ?? ka,
      placement: W,
      anchorEl: Z ? {
...
function Na(e) {
  ...
  return r ? /* @__PURE__ */ T(Xp, { title: r, placement: "right", children: /* @__PURE__ */ T("div", { children: E }) }) : E;
}
function Ra(e) {
...
const _a = /* @__PURE__ */ x.forwardRef(function(t, n) {
  ...
  const g = (y) => {
    ...
    if (m === "ArrowDown")
      ...
      y.preventDefault(), Yt(w, C, u, c, mi);
    else if (m === "Home")
      y.preventDefault(), Yt(w, null, u, c, gr);
    else if (m === "End")
      y.preventDefault(), Yt(w, null, u, c, mi);
    else if (m.length === 1) {
      const P = v.current, A = m.toLowerCase(), _ = performance.now();
...
const wf = _a, xf = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ef = {
  ...
  } = t, y = ce(t, xf), w = x.useRef(null), m = Be(w, l.ref, n), C = (L) => (I) => {
    if (L) {
      const R = w.current;
      I === void 0 ? L(R) : L(R, I);
    }
...
const Rf = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], $f = (e) => {
  ...
  if (v.props.tabIndex === void 0 && (W.tabIndex = "-1"), X) {
    ...
    W.onEnter = J, W.onExited = N;
  }
  const q = (r = (o = L == null ? void 0 : L.root) != null ? o : E.Root) != null ? r : Mf, H = (i = (s = L == null ? void 0 : L.backdrop) != null ? s : E.Backdrop) != null ? i : d, K = (l = G == null ? void 0 : G.root) != null ? l : S.root, Y = (c = G == null ? void 0 : G.backdrop) != null ? c : S.backdrop, ne = gt({
    elementType: q,
    externalSlotProps: K,
    ...
    ownerState: F,
    className: we(p, K == null ? void 0 : K.className, U == null ? void 0 : U.root, !F.open && F.exited && (U == null ? void 0 : U.hidden))
  }), $ = gt({
    elementType: H,
    externalSlotProps: Y,
    additionalProps: f,
    getSlotProps: (J) => Q(k({}, J, {
      onClick: (N) => {
        B && B(N), J != null && J.onClick && J.onClick(N);
      }
    })),
...
const Hf = (e) => {
  ...
  const s = tt({
  ...
  } = s, D = ce(s.TransitionProps, Vf), B = ce(s, zf), z = (r = w == null ? void 0 : w.paper) != null ? r : S, G = x.useRef(), L = Be(G, z.ref), I = k({}, s, {
    anchorOrigin: u,
    anchorReference: f,
    elevation: g,
    marginThreshold: h,
    ...
    TransitionProps: D
  }), R = Hf(I), j = x.useCallback(() => {
    if (f === "anchorPosition")
      return process.env.NODE_ENV !== "production" && (d || console.error('MUI: You need to provide a `anchorPosition` prop when using <Popover anchorReference="anchorPosition" />.')), d;
    const J = Nn(c), N = J && J.nodeType === 1 ? J : xe(G.current).body, re = N.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`));
    ...
    const lt = Te + N.height, ke = me + N.width, Ge = It(Nn(c)), Pe = Ge.innerHeight - h, Xe = Ge.innerWidth - h;
    if (h !== null && Te < h) {
      const ye = Te - h;
    ...
    if (process.env.NODE_ENV !== "production" && N.height > Pe && N.height && Pe && console.error(["MUI: The popover component is too tall.", `Some part of it can not be seen on the screen (${N.height - Pe}px).`, "Please consider adding a `max-height` to improve the user-experience."].join(`
`)), h !== null && me < h) {
      const ye = me - h;
    ...
    if (!J)
      return;
    const N = Z(J);
    N.top !== null && (J.style.top = N.top), N.left !== null && (J.style.left = N.left), J.style.transformOrigin = N.transformOrigin, M(!0);
  }, [Z]);
  ...
  const W = v || (c ? xe(Nn(c)).body : void 0), q = (o = y == null ? void 0 : y.root) != null ? o : Wf, H = (i = y == null ? void 0 : y.paper) != null ? i : La, K = gt({
    elementType: H,
...
const Xf = ["onEntering"], Kf = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], Yf = {
  vertical: "top",
  horizontal: "right"
}, Jf = {
  vertical: "top",
  ...
  const i = tt({
    ...
    slots: S = {},
    slotProps: y = {}
  } = i, w = ce(i.TransitionProps, Xf), m = ce(i, Kf), C = gn(), P = C.direction === "rtl", A = k({}, i, {
    autoFocus: s,
    ...
    TransitionProps: w,
    variant: E
  }), _ = Zf(A), D = s && !u && p, B = x.useRef(null), z = (Z, O) => {
...
`)), Z.props.disabled || (E === "selectedMenu" && Z.props.selected || L === -1) && (L = O));
  ...
  const I = (r = S.paper) != null ? r : eh, R = (o = y.paper) != null ? o : b, j = gt({
    elementType: S.root,
...
function xh({
  ...
  var u;
  const [o, i] = Rt.useState(void 0), s = $e(
    (d) => {
      d.preventDefault(), i(
        o === void 0 ? {
          mouseX: d.clientX + 2,
...
function ih({
  ...
  Vn(() => {
    if (c) {
      ...
      if (w) {
        const m = w.getBoundingClientRect(), C = window.scrollY, P = window.scrollX, A = m.top + C + w.clientHeight, _ = m.left + P;
        h({ top: A, left: _ });
      }
    }
  }, [c, o]);
...
function Nh({
  ...
  const i = Rn(void 0);
  return /* @__PURE__ */ T("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ T(Cs, { position: "static", id: r, children: /* @__PURE__ */ ue(Ps, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ T(
      ih,
      {
        commandHandler: t,
