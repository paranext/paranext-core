...
function en({
  ...
  return /* @__PURE__ */ l(_e, { variant: s, children: [
    /* @__PURE__ */ r(hn, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: i, size: "icon", className: "tw-h-8", children: o ?? /* @__PURE__ */ r(Mo, {}) }) }),
...
const Dr = m.forwardRef(
  ({ id: t, className: e, children: n }, o) => /* @__PURE__ */ r(
    ...
    {
      ref: o,
      className: `tw-sticky tw-top-0 tw-box-border tw-flex tw-h-[3.2rem] tw-flex-row tw-items-center tw-justify-between tw-gap-2 tw-overflow-clip tw-px-4 tw-py-2 tw-text-foreground tw-@container/toolbar ${e}`,
      id: t,
      children: n
    }
  )
...
function Sw({
  ...
  return /* @__PURE__ */ l(Dr, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    /* @__PURE__ */ r("div", { className: "tw-h-full tw-p-[1px]", children: n && /* @__PURE__ */ r(
      en,
      {
        onSelectMenuItem: t,
        menuData: n,
    ...
    i && /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[2] tw-flex-row tw-flex-wrap tw-items-start tw-gap-2 tw-overflow-clip tw-p-[1px] tw-@container/tab-toolbar-start", children: i }),
    w && /* @__PURE__ */ r("div", { className: "tw-flex tw-h-full tw-shrink tw-basis-0 tw-flex-row tw-flex-wrap tw-items-start tw-justify-center tw-gap-2 tw-overflow-clip tw-p-[1px] tw-@container/tab-toolbar-center @sm:tw-grow @sm:tw-basis-auto", children: w }),
    /* @__PURE__ */ l("div", { className: "tw-flex tw-h-full tw-shrink tw-grow-[2] tw-flex-row-reverse tw-flex-wrap tw-items-start tw-gap-2 tw-overflow-clip tw-p-[1px] tw-@container/tab-toolbar-end", children: [
      o && /* @__PURE__ */ r(
        en,
        {
          onSelectMenuItem: e,
