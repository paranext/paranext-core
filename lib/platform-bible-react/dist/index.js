...
import re, { forwardRef as fs, useCallback as Te, useState as Ce, useRef as Tt, useEffect as ht, useLayoutEffect as li, useMemo as Jt } from "react";
...
const Me = class ce {
    ...
    if (se(this, "firstChapter"), se(this, "lastChapter"), se(this, "lastVerse"), se(this, "hasSegmentsDefined"), se(this, "text"), se(this, "BBBCCCVVVS"), se(this, "longHashCode"), se(this, "versification"), se(this, "rtlMark", "‏"), se(this, "_bookNum", 0), se(this, "_chapterNum", 0), se(this, "_verseNum", 0), se(this, "_verse"), r == null && o == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof ce) {
          ...
          if (t == null)
            return;
          const i = t instanceof Ct ? t : ce.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  static fromJSON(t) {
    ...
    let c;
    return s && (c = new Ct(s)), n ? new ce(n, r.toString(), a, c) : new ce();
  }
  /**
  ...
  parse(t) {
    if (t = t.replace(this.rtlMark, ""), t.includes("/")) {
      ...
      if (t = i[0], i.length > 1)
        try {
          const s = +i[1].trim();
          this.versification = new Ct(Je[s]);
        } catch {
...
se(Me, "defaultVersification", Ct.English), se(Me, "verseRangeSeparator", "-"), se(Me, "verseSequenceIndicator", ","), se(Me, "verseRangeSeparators", [Me.verseRangeSeparator]), se(Me, "verseSequenceIndicators", [Me.verseSequenceIndicator]), se(Me, "chapterDigitShifter", 1e3), se(Me, "bookDigitShifter", Me.chapterDigitShifter * Me.chapterDigitShifter), se(Me, "bcvMaxValue", Me.chapterDigitShifter - 1), /**
...
function xv({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ce(""), [o, i] = Ce(
    ...
    ue.bookNumberToId(e.bookNum)
  ), [d, g] = Ce(!1), [p, f] = Ce(d), h = Tt(void 0), m = Tt(void 0), v = Tt(void 0), y = Te(
    (N) => kc(N).filter((E) => {
    ...
    if (c === o) {
      ...
      s + k <= 0 || s + k > an(c) ? a(0) : k !== 0 && (a(s + k), N.preventDefault());
    }
  };
  return ht(() => {
...
function Ns({
  ...
  let g;
  if (n) {
    const p = r === jt.Before || r === jt.Above, f = /* @__PURE__ */ w("span", { className: `papi-checkbox-label ${a ? "error" : ""} ${c ?? ""}`, children: n }), h = r === jt.Before || r === jt.After, m = h ? f : /* @__PURE__ */ w("div", { children: f }), v = h ? d : /* @__PURE__ */ w("div", { children: d });
    g = /* @__PURE__ */ ie(
      Al,
      {
...
function at(e, t, n = {
  ...
  return kt(e) && kt(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (kt(t[o]) && o in e && kt(e[o]) ? r[o] = at(e[o], t[o], n) : n.clone ? r[o] = kt(t[o]) ? Ms(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function zc(e) {
  const {
...
const Uc = Qt(l.elementType, Gc), qc = "exact-prop: ​";
function Ds(e) {
...
const nu = typeof window < "u" ? R.useLayoutEffect : R.useEffect, Nt = nu;
let Pi = 0;
function ru(e) {
...
process.env.NODE_ENV !== "production" && (Rn.propTypes = {
   ...
   */
  container: l.oneOfType([lt, l.func]),
  /**
...
var Ie = "top", We = "bottom", Xe = "right", Ae = "left", ko = "auto", $n = [Ie, We, Xe, Ae], Wt = "start", kn = "end", qu = "clippingParents", Qs = "viewport", ln = "popper", Wu = "reference", Ai = /* @__PURE__ */ $n.reduce(function(e, t) {
...
var Pt = Math.max, tr = Math.min, Xt = Math.round;
function oo() {
...
function Yt(e, t, n) {
  ...
  var s = _t(e) ? je(e) : window, a = s.visualViewport, c = !ta() && n, u = (r.left + (c && a ? a.offsetLeft : 0)) / o, d = (r.top + (c && a ? a.offsetTop : 0)) / i, g = r.width / o, p = r.height / i;
  return {
    width: g,
    height: p,
    top: d,
...
function _n(e) {
  for (var t = je(e), n = Di(e); n && ad(n) && ct(n).position === "static"; )
    n = Di(n);
  return n && (et(n) === "html" || et(n) === "body" && ct(n).position === "static") ? t : n || ld(e) || t;
}
function Oo(e) {
...
function Fi(e) {
  ...
  if (u) {
    ...
    if (C === je(n) && (C = wt(n), ct(C).position !== "static" && a === "absolute" && ($ = "scrollHeight", A = "scrollWidth")), C = C, o === Ie || (o === Ae || o === Xe) && i === kn) {
      S = We;
...
function $o(e) {
  return Yt(wt(e)).left + No(e).scrollLeft;
}
function Sd(e, t) {
  var n = je(e), r = wt(e), o = n.visualViewport, i = r.clientWidth, s = r.clientHeight, a = 0, c = 0;
  if (o) {
...
function Cd(e) {
  var t, n = wt(e), r = No(e), o = (t = e.ownerDocument) == null ? void 0 : t.body, i = Pt(n.scrollWidth, n.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = Pt(n.scrollHeight, n.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), a = -r.scrollLeft + $o(e), c = -r.scrollTop;
  return ct(o || n).direction === "rtl" && (a += Pt(n.clientWidth, o ? o.clientWidth : 0) - i), {
    width: i,
    height: s,
    x: a,
    y: c
...
function Li(e, t, n) {
  return t === Qs ? io(Sd(e, n)) : _t(t) ? Ed(t, n) : io(Cd(wt(e)));
}
function Rd(e) {
  var t = xn(cr(e)), n = ["absolute", "fixed"].indexOf(ct(e).position) >= 0, r = n && Ue(e) ? _n(e) : e;
  return _t(r) ? t.filter(function(o) {
    return _t(o) && na(o, r) && et(o) !== "body";
  }) : [];
}
function kd(e, t, n, r) {
  var o = t === "clippingParents" ? Rd(e) : [].concat(t), i = [].concat(o, [n]), s = i[0], a = i.reduce(function(c, u) {
    var d = Li(e, u, r);
    return c.top = Pt(d.top, c.top), c.right = tr(d.right, c.right), c.bottom = tr(d.bottom, c.bottom), c.left = Pt(d.left, c.left), c;
  }, Li(e, s, r));
  return a.width = a.right - a.left, a.height = a.bottom - a.top, a.x = a.left, a.y = a.top, a;
}
function aa(e) {
  var t = e.reference, n = e.element, r = e.placement, o = r ? Ze(r) : null, i = r ? Kt(r) : null, s = t.x + t.width / 2 - n.width / 2, a = t.y + t.height / 2 - n.height / 2, c;
  switch (o) {
    case Ie:
      c = {
        x: s,
...
function Tn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, c = a === void 0 ? qu : a, u = n.rootBoundary, d = u === void 0 ? Qs : u, g = n.elementContext, p = g === void 0 ? ln : g, f = n.altBoundary, h = f === void 0 ? !1 : f, m = n.padding, v = m === void 0 ? 0 : m, y = oa(typeof v != "number" ? v : ia(v, $n)), P = p === ln ? Wu : ln, x = e.rects.popper, S = e.elements[h ? P : p], b = kd(_t(S) ? S : S.contextElement || wt(e.elements.popper), c, d, s), C = Yt(e.elements.reference), $ = aa({
    reference: C,
    element: x,
    strategy: "absolute",
    placement: o
  }), A = io(Object.assign({}, x, $)), D = p === ln ? A : C, B = {
...
function Td(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, a = n.flipVariations, c = n.allowedAutoPlacements, u = c === void 0 ? ea : c, d = Kt(r), g = d ? a ? Ai : Ai.filter(function(h) {
    return Kt(h) === d;
...
function Od(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !0 : s, c = n.fallbackPlacements, u = n.padding, d = n.boundary, g = n.rootBoundary, p = n.altBoundary, f = n.flipVariations, h = f === void 0 ? !0 : f, m = n.allowedAutoPlacements, v = t.options.placement, y = Ze(v), P = y === v, x = c || (P || !h ? [Xn(v)] : Pd(v)), S = [v].concat(x).reduce(function(z, U) {
      ...
      var N = S[B], E = Ze(N), k = Kt(N) === Wt, _ = [Ie, We].indexOf(E) >= 0, V = _ ? "width" : "height", I = Tn(t, {
        placement: N,
        boundary: d,
        rootBoundary: g,
        altBoundary: p,
...
function Ld(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, c = n.boundary, u = n.rootBoundary, d = n.altBoundary, g = n.padding, p = n.tether, f = p === void 0 ? !0 : p, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = Tn(t, {
    ...
    padding: g,
    altBoundary: d
  }), y = Ze(t.placement), P = Kt(t.placement), x = !P, S = Oo(y), b = Vd(S), C = t.modifiersData.popperOffsets, $ = t.rects.reference, A = t.rects.popper, D = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, B = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (C) {
    if (i) {
      var k, _ = S === "y" ? Ie : Ae, V = S === "y" ? We : Xe, I = S === "y" ? "height" : "width", j = C[S], ne = j + v[_], te = j - v[V], O = f ? -A[I] / 2 : 0, L = P === Wt ? $[I] : A[I], H = P === Wt ? -A[I] : -$[I], Y = t.elements.arrow, z = f && Y ? Po(Y) : {
        width: 0,
        height: 0
      }, U = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : ra(), W = U[_], X = U[V], q = yn(0, $[I], z[I]), K = x ? $[I] / 2 - O - q - W - B.mainAxis : L - q - W - B.mainAxis, Q = x ? -$[I] / 2 + O + q + X + B.mainAxis : H + q + X + B.mainAxis, ae = t.elements.arrow && _n(t.elements.arrow), F = ae ? S === "y" ? ae.clientTop || 0 : ae.clientLeft || 0 : 0, ee = (k = N == null ? void 0 : N[S]) != null ? k : 0, M = j + K - ee - F, le = j + Q - ee, Ee = yn(f ? tr(ne, M) : ne, j, f ? Pt(te, le) : te);
      C[S] = Ee, E[S] = Ee - j;
    }
    if (a) {
      var $e, xe = S === "x" ? Ie : Ae, xt = S === "x" ? We : Xe, _e = C[b], nt = b === "y" ? "height" : "width", Fe = _e + v[xe], rt = _e - v[xt], Re = [Ie, Ae].indexOf(y) !== -1, It = ($e = N == null ? void 0 : N[b]) != null ? $e : 0, St = Re ? Fe : _e - $[nt] - A[nt] - It + B.altAxis, en = Re ? _e + $[nt] + A[nt] - It - B.altAxis : rt, Dn = f && Re ? cd(St, _e, en) : yn(f ? St : Fe, _e, f ? en : rt);
      C[b] = Dn, E[b] = Dn - _e;
    }
    t.modifiersData[r] = E;
  }
...
function Gd(e, t, n) {
  ...
  _o(i)) && (a = zd(t)), Ue(t) ? (c = Yt(t, !0), c.x += t.clientLeft, c.y += t.clientTop) : i && (c.x = $o(i))), {
    ...
    var d = {
      ...
      setOptions: function(y) {
        ...
        m(), d.options = Object.assign({}, i, d.options, P), d.scrollParents = {
          reference: _t(a) ? xn(a) : a.contextElement ? xn(a.contextElement) : [],
          popper: xn(c)
        };
...
`));
  ...
  const E = rp(), k = (r = h.root) != null ? r : "div", _ = $t({
    elementType: k,
...
process.env.NODE_ENV !== "production" && (ca.propTypes = {
   ...
   */
  anchorEl: Qt(l.oneOfType([lt, l.object, l.func]), (e) => {
    if (e.open) {
...
const cp = {
  borderRadius: 4
}, up = cp, dp = process.env.NODE_ENV !== "production" ? l.oneOfType([l.number, l.string, l.object, l.array]) : {}, yt = dp;
function Sn(e, t) {
  return t ? at(e, t, {
    clone: !1
...
function Fo(e = {}, ...t) {
  ...
  return u.applyStyles = nf, u = t.reduce((d, g) => at(d, g), u), u.unstable_sxConfig = T({}, Ao, s == null ? void 0 : s.unstable_sxConfig), u.unstable_sx = function(g) {
    return Do({
      sx: g,
      theme: this
    });
...
function gf(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, a = {}) => {
    ...
    const P = Wl(s, T({
      shouldForwardProp: y,
      label: v
    }, f)), x = (b) => typeof b == "function" && b.__emotion_real !== b || kt(b) ? (C) => Kn(b, T({}, C, {
      theme: zn({
        theme: C.theme,
        defaultTheme: n,
        themeId: t
...
function Wi(e) {
  e = Mt(e);
  let t = e.type === "hsl" || e.type === "hsla" ? Mt(bf(e)).values : e.values;
...
function or(e, t) {
  return e = Mt(e), t = Vo(t), (e.type === "rgb" || e.type === "hsl") && (e.type += "a"), e.type === "color" ? e.values[3] = `/${t}` : e.values[3] = t, wr(e);
}
function wf(e, t) {
  if (e = Mt(e), t = Vo(t), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - t;
...
const Sf = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Lt = Nf, $f = ["mode", "contrastThreshold", "tonalOffset"], Yi = {
...
const theme2 = createTheme({ palette: {
  ...
  return process.env.NODE_ENV !== "production" && (f[t] || console.error(`MUI: The palette mode \`${t}\` is not supported.`)), at(T({
...
function tg(e = {}, ...t) {
  ...
  if (u = at(u, s), u = t.reduce((d, g) => at(d, g), u), process.env.NODE_ENV !== "production") {
...
var sg = function(t) {
  return t.scrollTop;
}, hn = "unmounted", Et = "exited", Rt = "entering", zt = "entered", ao = "exiting", ft = /* @__PURE__ */ function(e) {
  og(t, e);
  function t(r, o) {
    var i;
    i = e.call(this, r, o) || this;
    var s = o, a = s && !s.isMounting ? r.enter : r.appear, c;
    return i.appearStatus = null, r.in ? a ? (c = Et, i.appearStatus = Rt) : c = zt : r.unmountOnExit || r.mountOnEnter ? c = hn : c = Et, i.state = {
      status: c
  ...
  return n.componentDidMount = function() {
    ...
    if (o !== this.props) {
      ...
      this.props.in ? s !== Rt && s !== zt && (i = Rt) : (s === Rt || s === zt) && (i = ao);
    }
...
const lg = {
  ...
  } = t, y = me(t, ag), P = gn(), x = R.useRef(), S = An(), b = R.useRef(null), C = qe(b, i.ref, n), $ = (V) => (I) => {
    if (V) {
      const j = b.current;
      I === void 0 ? V(j) : V(j, I);
    }
...
process.env.NODE_ENV !== "production" && (wa.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: l.oneOfType([lt, l.object, l.func]),
  /**
   * Popper render function or node.
   */
  children: l.oneOfType([l.node, l.func]),
...
const xa = /* @__PURE__ */ R.forwardRef(function(t, n) {
  ...
  const C = pt({
    ...
    children: A
  }), Ee = An(), $e = Ee.direction === "rtl", [xe, xt] = R.useState(), [_e, nt] = R.useState(null), Fe = R.useRef(!1), rt = _ || te, Re = gn(), It = gn(), St = gn(), en = gn(), [Dn, Xo] = Bs({
    controlled: U,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const xr = Ls(O), tn = R.useRef(), Fn = En(() => {
  ...
  const Yo = (oe) => {
    ...
    Fe.current && oe.type !== "touchstart" || (xe && xe.removeAttribute("title"), It.clear(), St.clear(), I || Hn && j ? It.start(Hn ? j : I, () => {
      Yo(oe);
    }) : Yo(oe));
  }, Ko = (oe) => {
    It.clear(), St.start(L, () => {
    ...
    xe || xt(oe.currentTarget), ll(oe), Jo.current === !0 && (Zo(!0), Sr(oe));
  }, ti = (oe) => {
    Fe.current = !0;
    const Ve = le.props;
    Ve.onTouchStart && Ve.onTouchStart(oe);
  }, ni = Sr, ri = Ko, ul = (oe) => {
    ti(oe), St.clear(), Re.clear(), Fn(), tn.current = document.body.style.WebkitUserSelect, document.body.style.WebkitUserSelect = "none", en.start(ne, () => {
      document.body.style.WebkitUserSelect = tn.current, Sr(oe);
    });
  }, dl = (oe) => {
    le.props.onTouchEnd && le.props.onTouchEnd(oe), Fn(), St.start(H, () => {
      Vn(oe);
    });
  };
  R.useEffect(() => {
  ...
  }, nn = {}, Er = typeof ae == "string";
  N ? (nn.title = !ot && Er && !k ? ae : null, nn["aria-describedby"] = ot ? xr : null) : (nn["aria-label"] = Er ? ae : null, nn["aria-labelledby"] = ot && !Er ? xr : null);
  const He = T({}, nn, M, le.props, {
...
`));
  const gl = R.useMemo(() => {
    ...
    touch: Fe.current
  }), Rr = hg(on), oi = (r = (o = Q.popper) != null ? o : D.Popper) != null ? r : vg, ii = (i = (s = (a = Q.transition) != null ? a : D.Transition) != null ? s : F) != null ? i : co, si = (c = (u = Q.tooltip) != null ? u : D.Tooltip) != null ? c : bg, ai = (d = (g = Q.arrow) != null ? g : D.Arrow) != null ? d : wg, ml = mn(oi, T({}, q, (p = K.popper) != null ? p : B.popper, {
    className: Pe(Rr.popper, q == null ? void 0 : q.className, (f = (h = K.popper) != null ? h : B.popper) == null ? void 0 : f.className)
  }), on), hl = mn(ii, T({}, ee, (m = K.transition) != null ? m : B.transition), on), vl = mn(si, T({}, (v = K.tooltip) != null ? v : B.tooltip, {
    className: Pe(Rr.tooltip, (y = (P = K.tooltip) != null ? P : B.tooltip) == null ? void 0 : y.className)
  }), on), bl = mn(ai, T({}, (x = K.arrow) != null ? x : B.arrow, {
...
const Na = /* @__PURE__ */ R.forwardRef(function(t, n) {
  ...
  const m = (x) => {
    ...
    if (b === "ArrowDown")
      x.preventDefault(), dn(S, C, u, c, Vr);
    else if (b === "ArrowUp")
      x.preventDefault(), dn(S, C, u, c, ss);
    else if (b === "Home")
      x.preventDefault(), dn(S, null, u, c, Vr);
    else if (b === "End")
      x.preventDefault(), dn(S, null, u, c, ss);
    else if (b.length === 1) {
      ...
      $.previousKeyMatched && (B || dn(S, C, !1, c, Vr, $)) ? x.preventDefault() : $.previousKeyMatched = !1;
    }
    d && d(x);
  }, v = qe(f, n);
  let y = -1;
...
const tm = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], nm = (e) => {
  ...
  const X = (r = (o = _ == null ? void 0 : _.root) != null ? o : y.Root) != null ? r : rm, q = (i = (s = _ == null ? void 0 : _.backdrop) != null ? s : y.Backdrop) != null ? i : d, K = (a = k == null ? void 0 : k.root) != null ? a : P.root, Q = (c = k == null ? void 0 : k.backdrop) != null ? c : P.backdrop, ae = $t({
    elementType: X,
    externalSlotProps: K,
    externalForwardedProps: V,
    getSlotProps: j,
...
`));
    ...
    const xt = $e + M.height, _e = xe + M.width, nt = qt(Jn(c)), Fe = nt.innerHeight - v, rt = nt.innerWidth - v;
    if (v !== null && $e < v) {
      const Re = $e - v;
      $e -= Re, le.vertical += Re;
...
`)), v !== null && xe < v) {
  ...
  const W = h || (c ? Oe(Jn(c)).body : void 0), X = (o = x == null ? void 0 : x.root) != null ? o : hm, q = (i = x == null ? void 0 : x.paper) != null ? i : Aa, K = $t({
    elementType: q,
...
process.env.NODE_ENV !== "production" && (Da.propTypes = {
   ...
   */
  anchorEl: Qt(l.oneOfType([lt, l.func]), (e) => {
...
`)), te.props.disabled || (y === "selectedMenu" && te.props.selected || _ === -1) && (_ = O));
  ...
  const V = (r = P.paper) != null ? r : Rm, I = (o = x.paper) != null ? o : f, j = $t({
    elementType: P.root,
...
process.env.NODE_ENV !== "production" && (Fa.propTypes = {
   ...
   */
  anchorEl: l.oneOfType([lt, l.func]),
  /**
...
const ho = /([0-9]+)/gm, sh = (e, t, n) => Ya(vt(e.getValue(n)).toLowerCase(), vt(t.getValue(n)).toLowerCase()), ah = (e, t, n) => Ya(vt(e.getValue(n)), vt(t.getValue(n))), lh = (e, t, n) => Wo(vt(e.getValue(n)).toLowerCase(), vt(t.getValue(n)).toLowerCase()), ch = (e, t, n) => Wo(vt(e.getValue(n)), vt(t.getValue(n))), uh = (e, t, n) => {
...
const Ht = "scrBook", _h = "scrRef", vn = "source", Mh = "details", Ih = "Scripture Reference", Ah = "Scripture Book", sl = "Type", Dh = "Details";
function Fh(e, t) {
  const n = t ?? !1;
  return [
    {
...
function Tv({
  ...
  const [c, u] = Ce([]), [d, g] = Ce([{ id: Ht, desc: !1 }]), [p, f] = Ce(() => e.flatMap((E) => {
    const k = E.src;
    return E.data.map((_) => ({
      ..._,
      source: k
...
const tv = re.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ ie(
  fn.Root,
  {
    ...
    ...t,
    children: [
      /* @__PURE__ */ w(fn.Track, { className: "pr-relative pr-h-2 pr-w-full pr-grow pr-overflow-hidden pr-rounded-full pr-bg-secondary", children: /* @__PURE__ */ w(fn.Range, { className: "pr-absolute pr-h-full pr-bg-primary" }) }),
      /* @__PURE__ */ w(fn.Thumb, { className: "pr-block pr-h-5 pr-w-5 pr-rounded-full pr-border-2 pr-border-primary pr-bg-background pr-ring-offset-background pr-transition-colors focus-visible:pr-outline-none focus-visible:pr-ring-2 focus-visible:pr-ring-ring focus-visible:pr-ring-offset-2 disabled:pr-pointer-events-none disabled:pr-opacity-50" })
    ]
  }
));
tv.displayName = fn.Root.displayName;
