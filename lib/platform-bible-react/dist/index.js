...
const bt = class K {
    ...
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), r == null && a == null)
      if (t != null && typeof t == "string") {
        ...
        if (t != null && t instanceof K) {
          ...
          if (t == null) return;
          const s = t instanceof ie ? t : K.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof t == "string" && typeof n == "string" && typeof r == "string")
        ...
        this._bookNum = t, this._chapterNum = n, this._verseNum = r, this.versification = a ?? K.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static getBBBCCCVVV(t, n, r) {
    return t % K.bcvMaxValue * K.bookDigitShifter + (n >= 0 ? n % K.bcvMaxValue * K.chapterDigitShifter : 0) + (r >= 0 ? r % K.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(t) {
    ...
    let c;
    return i && (c = new ie(i)), n ? new K(n, r.toString(), l, c) : new K();
  }
  /**
  ...
  set verse(t) {
    const { success: n, vNum: r } = K.tryGetVerseNum(t);
    this._verse = n ? void 0 : t.replace(this.rtlMark, ""), this._verseNum = r, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = K.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(t) {
    ...
    if (r.length !== 2 || Z.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !K.isVerseParseable(r[1]))
      throw new ze("Invalid reference : " + t);
   ...
   */
  allVerses(t = !1, n = K.verseRangeSeparators, r = K.verseSequenceIndicators) {
...
function fp({
  ...
  const w = ct(), [p, m] = I(!1), [f, u] = I(""), [g, k] = I(""), [v, T] = I("books"), [N, S] = I(void 0), [A, j] = I(!1), V = tt(void 0), y = tt(void 0), C = tt(void 0), x = tt(void 0), E = tt({}), O = F(
    ...
    [X.OT]: P.filter((_) => Z.isBookOT(_)),
    [X.NT]: P.filter((_) => Z.isBookNT(_)),
    [X.DC]: P.filter((_) => Z.isBookDC(_)),
    [X.Extra]: P.filter((_) => Z.extraBooks().includes(_))
  }), [P]), R = $(() => Object.values(G).flat(), [G]), z = $(() => {
    if (!g.trim()) return G;
    const M = {
      [X.OT]: [],
      [X.NT]: [],
  ...
  }, [v, N, D, e.book, e.chapterNum]), /* @__PURE__ */ d(xe, { open: p, onOpenChange: at, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        children: [
          ...
          !A && /* @__PURE__ */ d(ee, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              ...
              D && /* @__PURE__ */ o(zt, { children: /* @__PURE__ */ o(
                Gt,
                {
                  ...
                  children: de(
                    ...
                    a ? kr(D.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              D && Mt(D.book) > 1 && /* @__PURE__ */ d(lt, { children: [
...
function Jw({
  ...
  const [N, S] = I(wo), [A, j] = I(!1), [V, y] = I(!1), [C, x] = I(!1), [E, O] = I(!1), [P, G] = I(!1), [R, z] = I(void 0), [D, U] = I(!1), [dt, ht] = I(!1);
  J(() => {
    let _ = !0;
    if (!r) {
      U(!1), ht(!1);
  ...
  const ut = $(
    ...
    async (_) => {
      ...
      return st && Y && pt(), st && R !== void 0 && z(void 0), st;
    },
    [pt, N, p, R]
  );
  return /* @__PURE__ */ o(
...
function mc({
  ...
  const [T, N] = I(!1), S = F(
    ...
    const E = e.filter((P) => P.starred).sort((P, G) => P.label.localeCompare(G.label)), O = e.filter((P) => !P.starred).sort((P, G) => {
      const R = t.includes(P.value), z = t.includes(G.value);
      return R && !z ? -1 : !R && z ? 1 : P.label.localeCompare(G.label);
    });
    return [...E, ...O];
  }, [e, t, f]), V = () => {
    n(e.map((E) => E.value));
...
function Rp({
  ...
  const S = F(() => {
    ...
    if (C && cn("note", C)) {
      ...
      const R = (P = (O = C.insert.note) == null ? void 0 : O.contents) == null ? void 0 : P.ops;
      g !== "x" && y === "x" ? R == null || R.forEach((z) => xc(z)) : g === "x" && y !== "x" && (R == null || R.forEach((z) => yc(z))), (G = c.current) == null || G.applyUpdate([{ delete: 1 }, C]);
    }
  }, V = () => {
    var C, x, E, O, P, G;
    const y = (x = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : x.at(0);
    if (console.log(y), y && cn("note", y)) {
      const R = (O = (E = y == null ? void 0 : y.insert) == null ? void 0 : E.note) == null ? void 0 : O.style, z = (G = (P = y.insert.note) == null ? void 0 : P.contents) == null ? void 0 : G.ops;
      R || T(!1), T(
        R === "x" ? !!(z != null && z.every((D) => {
          var dt, ht;
          if (!((dt = D.attributes) != null && dt.char)) return !0;
          const U = ((ht = D.attributes) == null ? void 0 : ht.char).style;
          return U === "xt" || U === "xo" || U === "xq";
        })) : !!(z != null && z.every((D) => {
          var dt, ht;
          if (!((dt = D.attributes) != null && dt.char)) return !0;
          const U = ((ht = D.attributes) == null ? void 0 : ht.char).style;
          return console.log(U), U === "ft" || U === "fr" || U === "fq";
        }))
      );
    } else
      T(!1);
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(lt, { children: Nc(e.marker, l, r, w) })
      }
    )
  ] });
}
...
const Dn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ip = (e) => ({
  accessorKey: "item",
...
function Bp({
  ...
  const f = Rt(n, "%webView_inventory_all%"), u = Rt(n, "%webView_inventory_approved%"), g = Rt(n, "%webView_inventory_unapproved%"), k = Rt(n, "%webView_inventory_unknown%"), v = Rt(n, "%webView_inventory_scope_currentBook%"), T = Rt(n, "%webView_inventory_scope_chapter%"), N = Rt(n, "%webView_inventory_scope_verse%"), S = Rt(n, "%webView_inventory_filter_text%"), A = Rt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Rt(n, "%webView_inventory_no_results%"), [V, y] = I(!1), [C, x] = I("all"), [E, O] = I(""), [P, G] = I([]), R = $(() => {
    const B = e ?? [];
  ...
  }, [V, R]), D = $(() => z.length === 0 ? [] : Rc(z, C, E), [z, C, E]), U = $(() => {
    var pt, ut;
    if (!V) return c;
...
const Mc = "16rem", Ic = "3rem", La = b.createContext(void 0);
function Mn() {
...
const Ut = "scrBook", Yc = "scrRef", we = "source", qc = "details", Jc = "Scripture Reference", Wc = "Scripture Book", Ka = "Type", Zc = "Details";
function Qc(e, t) {
  const n = t ?? !1;
  return [
    {
...
function nd({
  ...
  const V = $(() => Z.allBookIds.filter(
    (R, z) => e[z] === "1" && !Z.isObsolete(Z.bookIdToNumber(R))
  ), [e]), y = $(() => {
    if (!N.trim()) {
      const D = {
        [X.OT]: [],
    ...
    (R, z = !1) => {
      if (!z || !A.current) {
        n(
          t.includes(R) ? t.filter((it) => it !== R) : [...t, R]
        ), A.current = R;
        return;
      }
      const D = V.findIndex((it) => it === A.current), U = V.findIndex((it) => it === R);
      if (D === -1 || U === -1) return;
      const [dt, ht] = [
        Math.min(D, U),
        Math.max(D, U)
      ...
      n(
        t.includes(R) ? t.filter((it) => !Ct.includes(it)) : [.../* @__PURE__ */ new Set([...t, ...Ct])]
      );
    },
    [t, n, V]
  ), x = (R) => {
    ...
    R.preventDefault(), C(z, R.shiftKey);
  }, O = F(
    (R) => {
      const z = Pr(V, R).map((D) => D);
      n(
        Ua(V, R, t) ? t.filter((D) => !z.includes(D)) : [.../* @__PURE__ */ new Set([...t, ...z])]
      );
    },
    [t, n, V]
  ), P = () => {
                  ...
                  Object.values(X).map((R, z) => {
                    ...
                    if (D.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        ...
                        z < Object.values(X).length - 1 && /* @__PURE__ */ o(Ho, {})
                      ] }, R);
                  })
                ] })
              ]
...
function Zp({
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Wa, { children: [
      /* @__PURE__ */ o(Za, { children: e.map((l) => /* @__PURE__ */ o(rd, { value: l.value, children: l.value }, l.key)) }),
...
function wd({
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ o(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(od, { children: [
...
const pd = en(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ks, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
const du = St.Trigger, Sd = St.Portal, pu = St.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  St.Overlay,
  {
    ref: n,
...
Id.displayName = St.Description.displayName;
...
Vd.displayName = rr.Root.displayName;
