...
import { c as v, g as $e, a as Vr, C as er, L as Kn, t as _s, u as tn, T as Vt, b as bt, d as xt, e as yt, f as Hn, A as ba, r as se, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as Ns, l as Cs, m as Es, I as Ts, n as Co, o as Je, p as De, q as Ss, s as Gn, P as lr, v as Dr, w as dr, y as wr, z as Da, E as Ma, F as Eo, G as ur, H as Oa, J as $t, R as To, K as xa, M as io, N as so, O as co, Q as lo, S as qn, U as da, V as So, W as jr, X as Ur, Y as yr, Z as Rs, _ as ir, $ as Ze, a0 as Ue, a1 as Ye, a2 as kr, a3 as Ro, a4 as Do, a5 as ya, a6 as Mo, a7 as Wn, a8 as Ds, a9 as Ms, aa as Os, ab as wo, ac as Yn, ad as Ia, ae as Is, af as Xn, ag as zs, ah as Ps, ai as As, aj as en, ak as $s, al as Vs, am as Ls, an as Zn, ao as Jn, ap as Oo, aq as Bs, ar as Qn, as as Ka, at as rn, au as Ha, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as Gs, aB as qs, aC as Ws, aD as Ys, aE as Io, aF as zo, aG as Xs, aH as Zs } from "./resizable-hujhStja.js";
import { aI as yf, aJ as kf, aK as _f, aL as Nf, aM as Cf, aN as Ef, aO as Tf, aP as Sf, aQ as Rf, aR as Df, aS as Mf, aT as Of, aU as If, aV as zf, aW as Pf, aX as Af, aY as $f, aZ as Vf, a_ as Lf, a$ as Bf, b0 as Ff, b1 as jf, b2 as Uf, b3 as Kf, b4 as Hf, b5 as Gf, b6 as qf, b7 as Wf, b8 as Yf, b9 as Xf, ba as Zf, bb as Jf, bc as Qf, bd as tm, be as em, bf as rm, bg as am, bh as om, bi as nm } from "./resizable-hujhStja.js";
...
function Si({
  ...
  const b = L(!1), x = () => {
    ...
    () => Vr(e, d),
    [e, d]
  ), N = !!h && !p, C = `${E} (${y})`, A = N ? f || `${C}, ${h}` : C, R = /* @__PURE__ */ u(
    er,
    {
      ref: t,
      ...
      className: v(
        ...
        N && "tw:bg-muted/50 tw:text-muted-foreground/50 tw:data-selected:bg-muted/50 tw:data-selected:text-muted-foreground/50"
      ),
      children: [
        c && /* @__PURE__ */ a(
          Qe,
...
function ud({
  ...
  Mi(), Z(() => {
    var X;
    const $ = (X = C.current) == null ? void 0 : X.closest('button, [role="combobox"], [tabindex]');
    if (!$) return;
    const _ = (q) => !!q && q.scrollWidth > q.clientWidth, ot = () => {
      Hn() !== "pointer" && (R || _(h.current) || _(d.current)) && N(!0);
    }, P = () => N(!1);
...
function fd({
  ...
  const [h, f] = k(!1), [b, x] = k(!1), g = _a(), E = L(!1), y = w !== void 0, N = y ? w : h, C = n === "" ? "" : se(n, hd), A = se(s, gd), R = (O) => {
  ...
  return /* @__PURE__ */ u(Fe, { open: N, onOpenChange: R, modal: !1, children: [
    /* @__PURE__ */ a(Vt, { children: C ? /* @__PURE__ */ u(bt, { open: b, onOpenChange: z, children: [
      /* @__PURE__ */ a(xt, { asChild: !0, children: /* @__PURE__ */ a(Te, { asChild: !0, children: T }) }),
      /* @__PURE__ */ a(yt, { children: C })
...
function Ya({
  ...
  const R = De(), z = wd(), [M, T] = k(!1), [O, W] = k(""), [Y, $] = k(""), [_, ot] = k("books"), [P, X] = k(void 0), [q, B] = k(
    void 0
...
function yn({
  ...
  const [N, C] = k(!1), A = l ?? d, R = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], z = (M, T) => {
  ...
  return /* @__PURE__ */ u(lr, { open: N, onOpenChange: C, ...y, children: [
    /* @__PURE__ */ a(Dr, { asChild: !0, children: /* @__PURE__ */ u(
      et,
      {
        variant: b,
...
function Kd(t, e, r) {
  ...
  function d() {
    ...
    for (let E = 0; E < f.length; E++) {
      const y = f[E], N = i[E] || document.createElement("div"), C = N.style;
      C.position !== "absolute" && (C.position = "absolute", g = !0);
      const A = Ee(y.left - p);
      C.left !== A && (C.left = A, g = !0);
      const R = Ee(y.top - h);
      C.top !== R && (N.style.top = R, g = !0);
      const z = Ee(y.width);
      C.width !== z && (N.style.width = z, g = !0);
      const M = Ee(y.height);
      C.height !== M && (N.style.height = M, g = !0), N.parentNode !== c && (c.append(N), g = !0), i[E] = N;
    }
...
function Gd(t, e = Hd) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(p), b = h.getNode(), x = b.getKey(), g = h.offset, E = f.getNode(), y = E.getKey(), N = f.offset, C = t.getElementByKey(x), A = t.getElementByKey(y), R = r === null || C !== o || g !== n || x !== r.getKey(), z = s === null || A !== i || N !== c || y !== s.getKey();
      if ((R || z) && C !== null && A !== null) {
            ...
            t.update(() => {
              ...
              if (Se(b)) {
                ...
                if (ho(g) && l >= 0 && w >= 0 && (E = l, y = l + w, b.setTextNodeRange(g, E, g, y)), E === y && p === "" || (b.insertRawText(p), g = x.getNode()), ho(g)) {
                  E = h, y = h + f;
                  const N = g.getTextContentSize();
                  E = E > N ? N : E, y = y > N ? N : y, b.setTextNodeRange(g, E, g, y);
                }
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-1", children: [
          ...
          b && /* @__PURE__ */ a(
            "div",
            {
              ...
              ref: E,
              onKeyDownCapture: ($) => {
                $.key === "Escape" ? ($.preventDefault(), $.stopPropagation(), N()) : Wo($) && ($.preventDefault(), $.stopPropagation(), de(h) && C());
              },
              onKeyDown: ($) => {
...
const Zw = {
  ...
  var gr;
  const [ot, P] = k({}), X = $ ?? ot, q = X.editorState ?? Zw, B = X.assignedUser, at = _ !== void 0, ut = L(X);
  ut.current = X;
  const dt = F(
    (S) => {
...
function Dh({
  ...
  const [C, A] = k(/* @__PURE__ */ new Set()), [R, z] = k(), [M, T] = k(), O = F(
    async (B) => {
      const at = await s(B);
...
function uu({
  ...
  var R;
  const [w, p] = k([]), [h, f] = k([]), [b, x] = k({}), [g, E] = k({}), y = V(() => e ?? [], [e]), N = Ni({
    data: y,
    columns: t,
    getCoreRowModel: Ei(),
  ...
  }), C = N.getVisibleFlatColumns();
  let A;
  return d ? A = Array.from({ length: 10 }).map((T, O) => `skeleton-row-${O}`).map((T) => /* @__PURE__ */ a(Ye, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(kr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(yr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, T)) : ((R = N.getRowModel().rows) == null ? void 0 : R.length) > 0 ? A = N.getRowModel().rows.map((z) => /* @__PURE__ */ a(
    Ye,
    {
      onClick: () => i(z, N),
    ...
    n && /* @__PURE__ */ a(su, { table: N }),
    /* @__PURE__ */ u(Ro, { stickyHeader: s, children: [
      /* @__PURE__ */ a(Do, { stickyHeader: s, children: N.getHeaderGroups().map((z) => /* @__PURE__ */ a(Ye, { children: z.headers.map((M) => /* @__PURE__ */ a(ya, { className: "tw:p-0", children: M.isPlaceholder ? void 0 : Lr(M.column.columnDef.header, M.getContext()) }, M.id)) }, z.id)) }),
...
function yu({
  ...
  const g = (y) => {
    if (i.current = !1, h(y), !y) {
      const N = b.current, C = x.current;
      N !== "custom" || C ? (N !== t || C !== e) && r(N, C) : (d(t), w(e));
    }
  }, E = (y) => {
    var N, C, A, R;
    y.stopPropagation(), document.activeElement === s.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((N = n.current) == null || N.focus(), i.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((C = s.current) == null || C.focus(), i.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && ((A = n.current) == null ? void 0 : A.selectionStart) === 0 && ((R = s.current) == null || R.focus(), i.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === s.current || document.activeElement === n.current) && g(!1);
  };
...
function Fh({
  ...
  const [g, E] = k("generated"), [y, N] = k("generated"), [C, A] = k("*"), [R, z] = k("*"), [M, T] = k("f"), [O, W] = k(!1), [Y, $] = k(!0), [_, ot] = k(!1), P = L(!1), X = L(""), [q, B] = k(!1), [at, ut] = k(), [dt, tt] = k(), [pt, kt] = k(), [mt, Rt] = k(), Ft = L(null), Pt = L(
    void 0
  ...
  Z(() => {
    ...
    if (H && Ir("note", H)) {
      ...
      let st = "custom";
      nt === go ? st = "generated" : nt === fo ? st = "hidden" : nt && (A(nt), z(nt)), E(st), N(st), T(((j = H.insert.note) == null ? void 0 : j.style) ?? "f"), D = setTimeout(() => {
        var it, vt, Ct;
...
function Au({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: s }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Yo(t.marker, [i], o, !1),
    " "
  ] }), f = !!d, b = !!w, x = !!p, g = e === "horizontal" ? "horizontal" : "vertical", E = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", N = v(g, E);
  return /* @__PURE__ */ u(gt, { children: [
...
function Uh({
  ...
  const p = l ?? Bc(r, void 0), h = (C, A) => {
    w == null || w(C, A, n);
  }, f = s ? r.findIndex((C) => C === s) : -1, [b, x] = k(f), g = (C, A, R) => {
    if (r.length)
      switch (C.key) {
        case "Enter":
        case " ":
          C.preventDefault(), w == null || w(A, R, n);
          break;
      }
  }, E = (C) => {
    if (r.length)
  ...
  Z(() => {
    var C;
    b >= 0 && b < y.current.length && ((C = y.current[b]) == null || C.focus());
  }, [b]);
  const N = s ? r.findIndex((C) => C === s) : -1;
  return Z(() => {
    var C;
    N < 0 || N >= y.current.length || (C = y.current[N]) == null || C.scrollIntoView({ block: "nearest" });
  }, [N, i]), /* @__PURE__ */ a(
    "div",
    {
      role: "listbox",
...
function Zh({
  ...
  const f = Ce(r, "%webView_inventory_all%"), b = Ce(r, "%webView_inventory_approved%"), x = Ce(r, "%webView_inventory_unapproved%"), g = Ce(r, "%webView_inventory_unknown%"), E = Ce(r, "%webView_inventory_scope_currentBook%"), y = Ce(r, "%webView_inventory_scope_chapter%"), N = Ce(r, "%webView_inventory_scope_verse%"), C = Ce(r, "%webView_inventory_filter_text%"), A = Ce(
    r,
    "%webView_inventory_show_additional_items%"
  ...
  }, [z, ot]), X = V(() => P.length === 0 ? [] : ju(P, T, W), [P, T, W]), q = V(() => {
    var kt, mt;
    if (!z) return d;
    ...
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(Er, { onValueChange: (tt) => at(tt), defaultValue: i, children: [
        ...
        /* @__PURE__ */ u(Rr, { children: [
          ...
          /* @__PURE__ */ a(ye, { value: "verse", children: N })
        ] })
      ] }),
      /* @__PURE__ */ a(
        Ia,
...
function Gu({
  ...
  const [d, l] = re.useState(t), w = e ?? d, p = re.useCallback(
    (N) => {
      const C = typeof N == "function" ? N(w) : N;
      r ? r(C) : l(C);
    },
    [r, w]
  ), h = re.useCallback(() => p((N) => !N), [p]), f = w ? "expanded" : "collapsed", g = De() === "ltr" ? i : i === "primary" ? "secondary" : "primary", E = re.useMemo(
    () => ({
      state: f,
      open: w,
      setOpen: p,
...
function ug({
  ...
  const y = n ?? op, N = s ?? ls, C = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Ge] },
    { label: `Group by ${N}`, value: [nr] },
    {
    ...
    !e && /* @__PURE__ */ u(
      Er,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Rr, { position: "item-aligned", children: /* @__PURE__ */ a(cu, { children: C.map((T) => /* @__PURE__ */ a(ye, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
...
function cp({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: b, extraLong: x } = {
  ...
  }, [g, E] = k(!1), [y, N] = k(""), C = L(void 0), A = L(!1), R = V(
    () => Jn(t),
    [t]
  ), z = V(() => {
    if (!y.trim()) {
    ...
    (_, ot = !1) => {
      ...
      const P = R.findIndex((ut) => ut === C.current), X = R.findIndex((ut) => ut === _);
      if (P === -1 || X === -1) return;
      const [q, B] = [
        Math.min(P, X),
        Math.max(P, X)
...
const ps = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => us(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => {
  ...
  const d = /* @__PURE__ */ a(Ks, { children: c.label });
  return /* @__PURE__ */ u(Hs, { children: [
          ...
          return /* @__PURE__ */ u(Wr, { children: [
            /* @__PURE__ */ u(
              Wn,
              {
                ...
                children: [
                  N && /* @__PURE__ */ a(cr, { id: y, children: x }),
...
function Ng({
  ...
  const l = Op(
    ...
    var E, y, N, C, A, R;
    const g = x !== b ? ((y = (E = t[b]) == null ? void 0 : E.uiNames) == null ? void 0 : y[x]) ?? ((C = (N = t[b]) == null ? void 0 : N.uiNames) == null ? void 0 : C.en) : void 0;
...
function Eg({
  ...
  const N = o["%firstRun_language_search_placeholder%"] ?? "", C = o["%firstRun_language_noResults%"] ?? "", A = o["%firstRun_language_selected%"] ?? "";
  return /* @__PURE__ */ u(
    wr,
    {
      id: s,
