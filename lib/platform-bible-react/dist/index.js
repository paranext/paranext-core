...
import { c as m, g as Se, a as qa, C as Ce, A as ie, P as Me, b as We, B as K, d as $e, e as Ae, f as Ie, h as xe, i as ji, k as Bi, j as Fi, E as Ui, l as Ga, r as se, m as Ki, n as un, o as ea, p as ra, L as Et, R as Ha, q as Gr, D as Ea, s as Ta, t as za, u as Sa, T as pn, v as Lr, w as Kt, x as Ya, y as qt, z as Gt, F as Ht, G as hn, H as Wa, I as qe, J as kr, K as ye, M as ke, N as _e, S as _r, O as er, Q as qi, U as Er, V as He, W as De, Z as Xe, X as Re, Y as rr, _ as Xa, $ as Ja, a0 as Hr, a1 as Za, a2 as gn, a3 as Gi, a4 as Hi, a5 as Yi, a6 as Ra, a7 as fn, a8 as aa, a9 as mn, aa as Wi, ab as Xi, ac as Ji, ad as Zi, ae as vn, af as Qi, ag as la, ah as _o, ai as da, aj as ts, ak as es, al as rs, am as as, an as os, ao as Tr, ap as Qa, aq as ns, ar as is, as as ss } from "./resizable-CY2GHYj0.js";
import { at as ag, au as og, av as ng, aw as ig, ax as sg, ay as cg, az as lg, aA as dg, aB as wg, aC as ug, aD as pg, aE as hg, aF as gg, aG as fg, aH as mg, aI as vg, aJ as bg, aK as xg, aL as yg, aM as kg, aN as _g, aO as Ng, aP as Cg, aQ as Eg, aR as Tg } from "./resizable-CY2GHYj0.js";
import { jsx as a, jsxs as u, Fragment as ct } from "react/jsx-runtime";
import { Canon as xt } from "@sillsdev/scripture";
import { Check as Ye, Clock as No, ChevronsLeft as Co, ChevronsRight as Eo, ChevronLeft as Da, ChevronRight as Oa, ArrowLeft as cs, ArrowRight as ls, ChevronDown as nr, BoldIcon as ds, ItalicIcon as ws, X as to, AtSign as bn, Pencil as us, Trash2 as ps, ArrowUp as xn, MoreHorizontal as hs, MailOpen as gs, Mail as fs, ChevronUp as ms, FilterIcon as vs, ArrowLeftIcon as bs, ChevronLeftIcon as xs, ChevronRightIcon as ys, ArrowRightIcon as ks, Copy as yn, Filter as _s, User as Ns, Link as Cs, CircleHelp as Es, Undo as Ts, Redo as zs, SquareX as kn, FunctionSquare as _n, SquareSigma as Nn, Ban as Ss, AlertCircle as Ma, CircleCheckIcon as Rs, CircleXIcon as Ds, CircleHelpIcon as Os, ArrowUpIcon as Ms, ArrowDownIcon as $s, ScrollText as As, ChevronsUpDown as Is, MenuIcon as Ps, Menu as Vs, EllipsisVertical as Ls, MoreVertical as To } from "lucide-react";
import { Section as wt, getChaptersForBook as js, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as Bs, formatReplacementString as Ge, sanitizeHtml as eo, NumberFormat as Cn, formatBytes as Fs, getCurrentLocale as Us, usfmMarkers as jr, getFormatCallerFunction as Ks, deepEqual as qs, isString as zo, compareScrRefs as $a, scrRefToBBBCCCVVV as wa, defaultScrRef as ua, formatScrRefRange as Gs, getLocalizeKeyForScrollGroupId as So, formatReplacementStringToArray as Ro, collectUsjMarkers as Hs } from "platform-bible-utils";
import Xt, { useRef as U, useMemo as M, useState as _, useCallback as B, useEffect as H, useImperativeHandle as Ys, useLayoutEffect as Ft, createContext as ro, useContext as En, Component as Ws, createElement as Do, Suspense as Xs, forwardRef as Tn, useId as Yr, Fragment as oa } from "react";
import { IconSelector as zn, IconCheck as na, IconChevronDown as Js, IconChevronUp as Zs, IconLayoutSidebar as Qs, IconLayoutSidebarRight as tc, IconChevronRight as Sn, IconSearch as ec, IconLoader as rc, IconAlertOctagon as ac, IconAlertTriangle as oc, IconInfoCircle as nc, IconCircleCheck as ic } from "@tabler/icons-react";
import { createEditor as Rn, $getRoot as Oe, $createParagraphNode as zr, $getSelection as Jt, HISTORY_MERGE_TAG as ao, ParagraphNode as Dn, TextNode as On, $getPreviousSelection as sc, $isRangeSelection as ue, $caretFromPoint as cc, $getSiblingCaret as Mn, $getChildCaret as lc, $getAdjacentChildCaret as dc, $isChildCaret as wc, $normalizeCaret as uc, $setSelectionFromCaretRange as pc, $getCollapsedCaretRange as hc, $getCaretInDirection as Oo, $splitAtPointCaretNext as gc, $isTextPointCaret as fc, $findMatchingParent as $n, $isElementNode as Nr, mergeRegister as Ne, getDOMTextNode as mc, isHTMLElement as vc, CLEAR_EDITOR_COMMAND as An, COMMAND_PRIORITY_EDITOR as oo, shallowMergeConfig as bc, defineExtension as re, safeCast as Je, createState as xc, FORMAT_TEXT_COMMAND as In, $isNodeSelection as Pn, COMMAND_PRIORITY_LOW as Vn, RootNode as yc, LineBreakNode as kc, TabNode as _c, $isEditorState as Nc, createCommand as Cc, CLICK_COMMAND as Ec, isDOMNode as Tc, $getNodeFromDOMNode as zc, $createNodeSelection as Sc, $setSelection as Rc, $getEditor as Dc, DecoratorNode as Aa, $getState as Oc, toggleTextFormatType as Mo, TEXT_TYPE_TO_FORMAT as Mc, $setState as $c, addClassNamesToElement as Ln, $create as Ac, $getNodeByKey as Ic, removeClassNamesFromElement as Pc, KEY_TAB_COMMAND as Vc, $isBlockElementNode as Lc, $createRangeSelection as jc, $normalizeSelection__EXPERIMENTAL as Bc, OUTDENT_CONTENT_COMMAND as Fc, INDENT_CONTENT_COMMAND as $o, INSERT_TAB_COMMAND as Uc, COMMAND_PRIORITY_CRITICAL as no, $isDecoratorNode as Kc, $isParagraphNode as qc, $isTextNode as Ia, SELECTION_CHANGE_COMMAND as jn, $insertNodes as Gc } from "lexical";
...
import { Avatar as io, Select as Ut, Checkbox as Ao, Slot as Sr, Tabs as ce, Menubar as he, ContextMenu as Ot, Progress as Io, Slider as Or, Switch as Po } from "radix-ui";
...
function ha({
  ...
  const F = se(), [C, $] = _(!1), [A, E] = _(""), [V, G] = _(""), [y, J] = _("books"), [j, X] = _(void 0), [z, I] = _(
    void 0
  ...
  }), [Mt]), Zt = M(() => Object.values(Vt).flat(), [Vt]), fe = M(() => {
    if (!V.trim()) return Vt;
    const b = {
      [wt.OT]: [],
      [wt.NT]: [],
    ...
    return [wt.OT, wt.NT, wt.DC, wt.Extra].forEach((rt) => {
      b[rt] = Vt[rt].filter((Pt) => Ga(Pt, V, n));
    }), b;
  }, [Vt, V, n]), R = M(
    () => fl(V, Zt, n),
    [V, Zt, n]
  ...
  const zt = B(() => {
    ...
    $(b), b && (J("books"), X(void 0), I(void 0), Y(void 0), G(""));
  }, []);
  H(() => {
    D && it(!1);
  }, [D, it]);
  ...
  const { otLong: gt, ntLong: mt, dcLong: $t, extraLong: Rt } = {
    ...
    () => hl(V),
    [V]
  ), oe = M(() => !d || !R || !R.chapterNum || !kt ? !1 : d(R.book, R.chapterNum) > 0, [d, R, kt]), Le = B(
    (b) => w ? Vo(b, w) : !1,
    [w]
  ), ur = B(
    (b) => (W) => w ? gl(b, W, w) : !1,
        ...
        children: /* @__PURE__ */ u(
          Ae,
          {
            ...
            children: [
              ...
              !lt && /* @__PURE__ */ u(Ie, { ref: at, children: [
                ...
                y === "verses" && z && O !== void 0 && d && /* @__PURE__ */ a(
                  Bo,
                  {
                    bookId: z,
                    chapterNum: O,
...
function Fo({
  ...
  const [N, D] = _(!1), F = d ?? l, C = (A) => A.length > 0 && typeof A[0] == "object" && "options" in A[0], $ = (A, E) => {
    const V = l(A), G = typeof A == "object" && "secondaryLabel" in A ? A.secondaryLabel : void 0, y = `${E ?? ""}${V}${G ?? ""}`;
    return /* @__PURE__ */ u(
      Ce,
      {
        value: V,
    ...
    /* @__PURE__ */ a(
      $e,
      {
        ...
        children: /* @__PURE__ */ u(Ae, { children: [
          ...
          /* @__PURE__ */ a(Ie, { children: C(e) ? e.map((A) => /* @__PURE__ */ a(xe, { heading: A.groupHeading, children: A.options.map((E) => $(E, A.groupHeading)) }, A.groupHeading)) : /* @__PURE__ */ a(xe, { children: e.map((A) => $(A)) }) })
        ] })
      }
    )
  ] });
...
const Wn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xl = Wn ? Ft : H, Ar = { tag: ao };
...
function $l(t, e, r) {
  ...
  function l() {
    ...
    for (let T = 0; T < h.length; T++) {
      ...
      const A = we(k.height);
      D.height !== A && (N.style.height = A, v = !0), N.parentNode !== c && (c.append(N), v = !0), s[T] = N;
    }
...
function Il(t, e = Al) {
  ...
  function d(w) {
    w.read(() => {
      ...
      if ((C || $) && D !== null && F !== null) {
        const A = function(E, V, G, y, J, j, X) {
          const z = (E._window ? E._window.document : document).createRange();
          return z.setStart(...Uo(V, G, y)), z.setEnd(...Uo(J, j, X)), z;
        }(t, g, f, D, h, T, F);
        l(), l = $l(t, A, e);
      }
...
function jl(t, e, r) {
  ...
  return fc(o) && Wr(283), o.insert(t.isInline() ? zr().append(t) : t), Oo(Mn(t.getLatest(), "next"), e.direction);
}
function Bl(t) {
  const e = Jt();
  if (!ue(e)) return !1;
...
re({ name: "@lexical/extension/DecoratorText", nodes: () => [ri], register: (t, e, r) => t.registerCommand(In, (o) => {
  const n = Jt();
...
const uo = 0, Fa = 1, ni = 2, va = 3, Ir = 4, Qe = 5, ba = 6, mr = 7;
function xa(t) {
  return t.id === uo;
}
function ii(t) {
...
class Jl {
  ...
  build(e) {
    const r = this.state;
    let o;
    r.id !== Ir && dt(307, String(r.id), String(Qe)), this.extension.build && (o = this.extension.build(e, r.config, r.registerState));
  ...
  getInitResult() {
    ...
    return function(r) {
      return r.id >= Ir;
    }(e) || dt(313, String(e.id), String(Ir)), e.initResult;
  }
  getInitPeer(e) {
  ...
  return Ne(t.registerCommand(rd, (s) => {
    ...
    if (Tc(s.target)) {
      ...
      if (od(c)) return function(l, d = !1) {
        ...
        let h;
        d && Pn(w) ? h = w : (h = Sc(), Rc(h)), p ? h.delete(g) : h.add(g);
      }(c, s.shiftKey), !0;
    }
    return !1;
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ue(f)) {
                ...
                if (Ia(v) && d >= 0 && w >= 0 && (T = d, k = d + w, f.setTextNodeRange(v, T, v, k)), T === k && p === "" || (f.insertRawText(p), v = x.getNode()), Ia(v)) {
                  T = g, k = g + h;
...
const ho = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
...
const di = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Ft : H;
function vd({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: o, ariaDescribedBy: n, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: c, ariaLabel: l, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: p, ariaRequired: g, autoCapitalize: h, className: f, id: x, role: v = "textbox", spellCheck: T = !0, style: k, tabIndex: N, "data-testid": D, ...F }, C) {
  ...
  return di(() => (A(t.isEditable()), t.registerEditableListener((G) => {
    A(G);
...
const Md = "verseText", ap = Object.freeze([
...
function yi({
  ...
  const [y, J] = _(rn), [j, X] = _(), [z, I] = _(), O = o, [Y, lt] = _(!1), [ut, Tt] = _(!1), [q, tt] = _(!1), [pt, at] = _(!1), [bt, ae] = _(!1), [ht, yt] = _(D), [Mt, Vt] = _(!1), Zt = U(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
  ...
  const Qt = M(() => zt[0], [zt]), Ee = U(null), te = U(void 0), L = B(() => {
    var S;
    (S = te.current) == null || S.call(te), J(rn);
  }, []), Q = B(() => {
    const S = !ht;
    yt(S), Vt(!S), f == null || f(l, S);
  }, [ht, f, l]);
  H(() => {
    lt(!1);
  }, [o]), H(() => {
  ...
  }, [i, r]), it = M(() => zt.slice(1), [zt]), st = M(() => it.length ?? 0, [it.length]), ft = M(() => st > 0, [st]), gt = M(() => Y || st <= 2 ? it : it.slice(-2), [it, st, Y]), mt = M(() => Y || st <= 2 ? 0 : st - 2, [st, Y]), $t = M(
  ...
  const Yt = B(
    async (S) => {
      ...
      It && await p({ threadId: l, contents: It }) && L();
    },
    [
      L,
      y,
    ...
    async (S) => {
      const It = ee(y) ? Qr(y) : void 0, kt = S.status ? S.assignedUser : j ?? S.assignedUser, oe = await p({
        ...S,
        contents: It,
        assignedUser: kt
      });
      return oe && (kt !== void 0 && I(kt), It && L()), oe;
    },
    [L, y, p, j]
  );
          ...
          o && /* @__PURE__ */ u(ct, { children: [
            ...
            v !== !1 && (!ut || ee(y)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (S) => {
                  fo(S) && (S.preventDefault(), S.stopPropagation(), (ee(y) || j !== void 0 && j !== z) && Yt());
                },
                onKeyDown: (S) => {
...
function Fd({
  ...
  const V = e["%conflict_note_no_result%"] ?? "No result preview available.", G = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: V }), y = (z) => z ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: z }) : G, J = () => {
    ...
    const I = f === z.value, O = `${d}-${z.value}`, Y = j(z);
    return (
      ...
      !w && !g && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          Ha,
          {
            ...
            children: C.map((z) => j(z) ? /* @__PURE__ */ a(Kt, { delayDuration: 0, children: /* @__PURE__ */ u(qt, { children: [
              /* @__PURE__ */ a(Gt, { asChild: !0, children: X(z) }),
...
function pp({
  ...
  const [k, N] = _(/* @__PURE__ */ new Set()), [D, F] = _(), [C, $] = _(), A = B(
    async (I) => {
      const O = await i(I);
      return O !== void 0 && I.assignedUser !== void 0 && I.assignedUser !== "" && $(I.assignedUser), O;
    },
    [i]
  );
  H(() => {
      ...
      children: E.map((I) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: I.type === "Conflict" ? /* @__PURE__ */ a(Hd, { ...O, conflictResolution: T }) : /* @__PURE__ */ a(yi, { ...O })
          },
          I.id
        );
      })
...
function lr({ className: t, size: e = "default", children: r, ...o }) {
  ...
  return /* @__PURE__ */ u(
    Ut.Trigger,
    {
      ...
      children: [
        r,
        /* @__PURE__ */ a(Ut.Icon, { asChild: !0, children: /* @__PURE__ */ a(zn, { className: "tw:pointer-events-none tw:size-4 tw:text-muted-foreground" }) })
      ]
    }
  );
}
...
function Qd({
  ...
  return l ? F = Array.from({ length: 10 }).map((E, V) => `skeleton-row-${V}`).map((E) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(rr, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(er, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, E)) : ((C = N.getRowModel().rows) == null ? void 0 : C.length) > 0 ? F = N.getRowModel().rows.map(($) => /* @__PURE__ */ a(
    Re,
    {
      ...
      children: $.getVisibleCells().map((A) => /* @__PURE__ */ a(rr, { children: xr(A.column.columnDef.cell, A.getContext()) }, A.id))
    },
    $.id
    ...
    /* @__PURE__ */ u(Xa, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ja, { stickyHeader: i, children: N.getHeaderGroups().map(($) => /* @__PURE__ */ a(Re, { children: $.headers.map((A) => /* @__PURE__ */ a(Hr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, $.id)) }),
...
function cw({
  ...
  return /* @__PURE__ */ u(ye, { open: g, onOpenChange: f, children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: sw(t, n, r) }) }) }),
...
function ww({
  ...
  return /* @__PURE__ */ u(ye, { children: [
    /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
      /* @__PURE__ */ a(Gt, { asChild: !0, children: /* @__PURE__ */ a(ke, { asChild: !0, children: /* @__PURE__ */ a(K, { variant: "outline", className: "tw:h-6", children: lw(t, r) }) }) }),
...
function _p({
  ...
  const [f, x] = _("generated"), [v, T] = _("generated"), [k, N] = _("*"), [D, F] = _("*"), [C, $] = _("f"), [A, E] = _(!1), [V, G] = _(!0), [y, J] = _(!1), j = U(!1), X = U(""), [z, I] = _(!1), [O, Y] = _(), [lt, ut] = _(), [Tt, q] = _(), [tt, pt] = _(), at = U(null), bt = M(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const Zt = () => {
    ...
    if (Q && Mr("note", Q)) {
      ...
      C !== "x" && L === "x" ? gt == null || gt.forEach((mt) => fw(mt)) : C === "x" && L !== "x" && (gt == null || gt.forEach((mt) => mw(mt))), (ft = w.current) == null || ft.applyUpdate([Q, { delete: 1 }]);
    }
  }, zt = (L) => {
      ...
      if (Q && Mr("note", Q)) {
        ...
        if (gt || E(!1), E(
          gt === "x" ? !!(mt != null && mt.every(($t) => {
            ...
            const Rt = ((At = $t.attributes) == null ? void 0 : At.char).style;
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ a(Kt, { children: /* @__PURE__ */ u(qt, { children: [
              ...
              /* @__PURE__ */ a(Ht, { children: /* @__PURE__ */ a("p", { children: te }) })
            ] }) }) })
          ]
        }
      )
  ...
  return /* @__PURE__ */ u(ct, { children: [
    ...
    /* @__PURE__ */ a(
      "div",
      {
        ...
        children: c && c.length > 0 && /* @__PURE__ */ a(ct, { children: bw(t.marker, c, o, d) })
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ a(Za, { children: s.length > 0 && s.map((c) => /* @__PURE__ */ u(
      Re,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(rr, { className: o, children: kw(c.text) })
        ]
      },
...
const Nw = (t) => {
  ...
  return e ? e[1] : "";
}, Ew = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Op = Object.freeze([
...
function Mp({
  ...
  const h = de(r, "%webView_inventory_all%"), f = de(r, "%webView_inventory_approved%"), x = de(r, "%webView_inventory_unapproved%"), v = de(r, "%webView_inventory_unknown%"), T = de(r, "%webView_inventory_scope_currentBook%"), k = de(r, "%webView_inventory_scope_chapter%"), N = de(r, "%webView_inventory_scope_verse%"), D = de(r, "%webView_inventory_filter_text%"), F = de(
    r,
    "%webView_inventory_show_additional_items%"
  ), C = de(r, "%webView_inventory_no_results%"), [$, A] = _(!1), [E, V] = _("all"), [G, y] = _(""), [J, j] = _([]), X = M(() => {
    const q = t ?? [];
  ...
  }, [$, X]), I = M(() => z.length === 0 ? [] : Tw(z, E, G), [z, E, G]), O = M(() => {
    var pt, at;
    if (!$) return l;
...
const Sw = "16rem", Rw = "3rem", Ni = Xt.createContext(void 0);
function ca() {
...
function Vw({
  ...
  const c = t ? Sr.Root : "button", { state: l } = ca(), d = /* @__PURE__ */ a(
    c,
    {
    ...
    Ow,
    {
      ...
      children: /* @__PURE__ */ u($w, { children: [
        /* @__PURE__ */ u(sn, { children: [
          ...
          /* @__PURE__ */ a(ln, { children: /* @__PURE__ */ a(Aw, { children: Object.entries(e).map(([h, f]) => /* @__PURE__ */ a(Iw, { children: /* @__PURE__ */ a(
            Vw,
            {
              onClick: () => d(h),
              isActive: g(h),
...
const ze = "scrBook", jw = "scrRef", Ke = "source", Bw = "details", Fw = "Scripture Reference", Uw = "Scripture Book", Ci = "Type", Kw = "Details";
function qw(t, e) {
  const r = e ?? !1;
  return [
    {
...
function Yp({
  ...
  const [d, w] = _([]), [p, g] = _([{ id: ze, desc: !1 }]), [h, f] = _({}), x = M(
  ...
  }, $ = (E, V) => E.getIsGrouped() ? "" : m("banded-row", V % 2 === 0 ? "even" : "odd"), A = (E, V, G) => {
...
function Xp({
  ...
  const D = Dt(
    s,
    "%webView_scope_selector_selected_text%"
  ), F = Dt(s, "%webView_scope_selector_verse%"), C = Dt(s, "%webView_scope_selector_chapter%"), $ = Dt(s, "%webView_scope_selector_book%"), A = Dt(
    s,
    "%webView_scope_selector_current_verse%"
  ), E = Dt(
    s,
  ...
  ), ft = tt.find((P) => P.value === "selectedBooks"), gt = tt.find((P) => P.value === "range"), [mt, $t] = _(!1), [Rt, Yt] = _(void 0), [At, Ve] = _(void 0), [S, It] = _(void 0), [kt, oe] = _(void 0), [Le, ur] = _([]), pr = d === "dropdown" && Rt === "selectedBooks", hr = /* @__PURE__ */ a(
    Ww,
    {
      availableBookInfo: o,
  ...
  ), gr = fe === "end", Rr = fe === "start", Ze = "tw:text-muted-foreground", je = d === "dropdown" && Rt === "range", b = je ? It : L, rt = je ? oe : h ? Q : ae, Pt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-start", className: m(gr && Ze), children: z }),
      /* @__PURE__ */ a(
        ha,
        {
    ...
    /* @__PURE__ */ u("div", { ref: ht, className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Et, { htmlFor: "scope-range-end", className: m(Rr && Ze), children: I }),
      /* @__PURE__ */ a(
        ha,
        {
          id: "scope-range-end",
  ...
  const [St, Nt] = _(null), [Ct, vt] = _(null), [Lt, le] = _(null), Fe = 200, [Ai, Ii] = _(!1);
  H(() => {
    if (!Lt || typeof ResizeObserver > "u") return;
    const P = new ResizeObserver(([Z]) => {
      Ii(Z.contentRect.width < Fe);
    });
    return P.observe(Lt), () => P.disconnect();
  }, [Lt]);
  const bo = B(
    (P) => {
      Ve(P), It(at), oe(bt), ur(n), $t(!1), Yt(P);
    },
    [at, bt, n]
  ), xo = B(() => {
    At !== void 0 && (At === "range" ? (S && (g == null || g(S)), kt && (h == null || h(kt))) : At === "selectedBooks" && i(Le), et(At), Yt(void 0), Ve(void 0));
  }, [
    At,
    S,
    kt,
    ...
    P || (Yt(void 0), Ve(void 0));
  }, []), yo = B((P) => {
    var Z;
    P.preventDefault(), (Z = Be.current) == null || Z.focus();
  }, []), ko = (P) => t === P ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ye, { className: "tw:h-4 tw:w-4" }) }) : void 0;
            ...
            children: /* @__PURE__ */ u(la, { container: Lt, children: [
              st.map(({ value: P, label: Z, dropdownLabel: Wt, scrRefSuffix: fr, id: Pi }) => /* @__PURE__ */ u(
                qe,
                {
                  ...
                  children: [
                    t === P && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ye, { className: "tw:h-4 tw:w-4" }) }),
                    q(Wt ?? Z, fr, Ai)
                  ]
                },
                Pi
    ...
    d === "dropdown" && ft && /* @__PURE__ */ a(Ea, { open: Rt === "selectedBooks", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ...
        children: /* @__PURE__ */ u(la, { container: Ct, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: G }) }),
          hr,
    ...
    d === "dropdown" && gt && /* @__PURE__ */ a(Ea, { open: Rt === "range", onOpenChange: Dr, children: /* @__PURE__ */ a(
      Ta,
      {
        ...
        children: /* @__PURE__ */ u(la, { container: St, children: [
          /* @__PURE__ */ a(za, { className: "tw:pe-8", children: /* @__PURE__ */ a(Sa, { children: X }) }),
          Pt,
          /* @__PURE__ */ u(_o, { children: [
            /* @__PURE__ */ a(K, { variant: "outline", onClick: () => Dr(!1), children: Y }),
      ...
      children: [
        ...
        /* @__PURE__ */ a(
          dr,
          {
            ...
            style: { zIndex: Xe },
            children: t.map((w) => /* @__PURE__ */ a(ne, { value: `${w}`, children: l[So(w)] }, `${w}`))
          }
        )
      ]
    }
...
function Ua({
  ...
  return /* @__PURE__ */ u(ye, { variant: i, children: [
    ...
    /* @__PURE__ */ a(_e, { align: "start", style: { zIndex: Xe }, children: Object.entries(e.columns).filter(([, l]) => typeof l == "object").sort(([, l], [, d]) => typeof l == "boolean" || typeof d == "boolean" ? 0 : l.order - d.order).map(([l], d, w) => /* @__PURE__ */ u(oa, { children: [
      /* @__PURE__ */ a(gn, { children: /* @__PURE__ */ a(Kt, { children: Si(e.groups, e.items, l, t) }) }),
  ...
  if (cl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Qw, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, p]) => typeof w == "boolean" || typeof p == "boolean" ? 0 : w.order - p.order).map(([w, p]) => /* @__PURE__ */ u(tu, { children: [
      ...
      /* @__PURE__ */ a(
        ...
        {
          style: { zIndex: Xe },
          children: /* @__PURE__ */ a(Kt, { children: $i(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function ih({
  ...
  return /* @__PURE__ */ u("div", { id: l, className: m("pr-twp tw:max-w-sm", c), children: [
    ...
    e !== "en" && /* @__PURE__ */ a("div", { className: "tw:pt-3", children: /* @__PURE__ */ a(Et, { className: "tw:font-normal tw:text-muted-foreground", children: Ge(d, {
...
const Ka = 288, _u = 176, Vr = 12, Nu = 6;
function Cu(t) {
...
function tg({
  ...
  const [d, w] = _([]), [p, g] = _(0), [h, f] = _(void 0), [x, v] = _(_u), T = U(null), k = U(null), N = U(void 0), D = Yr(), F = Yr();
  Ft(() => {
    if (!e) {
      w([]), g(0), f(void 0);
      return;
  ...
  const G = Eu(C.side ?? "bottom"), y = Tu(h, G, x), J = C.spotlightPadding ?? Nu, j = h.left - J, X = h.top - J, z = h.width + J * 2, I = h.height + J * 2;
  return /* @__PURE__ */ u(
    "div",
    {
      role: "dialog",
            ...
            children: [
              ...
              /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:justify-between tw:pt-1", children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:gap-2", children: [
                  !A && /* @__PURE__ */ a(K, { variant: "outline", size: "sm", onClick: V, children: s }),
