...
import { c as v, g as xe, a as Cr, C as Me, u as Io, T as Mt, b as Ot, d as It, e as $t, A as ue, P as je, f as er, B as X, h as Be, i as Fe, j as Ue, k as ze, x as Xi, l as Ji, m as Zi, I as Qi, n as so, r as Ne, o as ts, p as En, q as la, s as da, L as Nt, R as co, t as ea, D as Ba, v as Fa, w as Ua, y as Ka, z as Tn, E as qr, F as lo, G as Sn, H as wo, J as Qe, K as Sr, M as Ke, N as He, O as Ge, S as Rr, Q as sr, U as es, V as Mr, W as tr, X as Ae, Z as rr, Y as $e, _ as cr, $ as uo, a0 as po, a1 as ra, a2 as ho, a3 as Rn, a4 as rs, a5 as as, a6 as os, a7 as Ha, a8 as zn, a9 as wa, aa as ns, ab as Dn, ac as is, ad as ss, ae as cs, af as $o, ag as ls, ah as ds, ai as ws, aj as us, ak as Mn, al as On, am as go, an as ps, ao as In, ap as Ca, aq as Po, ar as Ea, as as hs, at as gs, au as fs, av as ms, aw as vs, ax as Or, ay as fo, az as bs, aA as xs } from "./resizable-C3OJPqMk.js";
...
import Yt, { useRef as U, useMemo as V, createContext as ua, useContext as bo, useState as _, useEffect as W, useCallback as L, useImperativeHandle as wc, useLayoutEffect as ee, Component as uc, createElement as Uo, Suspense as pc, forwardRef as Fn, useId as Ko, Fragment as pa } from "react";
...
import { GENERATOR_NOTE_CALLER as Za, HIDDEN_NOTE_CALLER as Qa, getDefaultViewOptions as _l, isInsertEmbedOpOfType as kr, getMarkerMenuItems as Nl, defaultStyleInfo as Cl, Editorial as El } from "@eten-tech-foundation/platform-editor";
...
function ii({
  ...
  const g = U(!1), f = () => {
    ...
    () => Cr(e, l),
    [e, l]
  ), y = !!p && !w, C = `${b} (${S})`, E = y ? h || `${C}, ${p}` : C, $ = /* @__PURE__ */ u(
    Me,
    {
      ref: t,
...
function Ml({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: x
  } = Io(), [b, S] = _(!1), [y, C] = _(!1), E = U(
    // React's ref API requires `null` as the initial value for DOM refs.
    // eslint-disable-next-line no-null/no-null
    null
  ), $ = n && e !== void 0, T = i ?? (e !== void 0 && !n);
  W(() => {
    var z;
    Dl();
    const Q = (z = E.current) == null ? void 0 : z.closest('button, [role="combobox"], [tabindex]');
    if (!Q) return;
    const I = (G) => !!G && G.scrollWidth > G.clientWidth, tt = () => {
      to !== "pointer" && (T || I(h.current) || I(l.current)) && C(!0);
    }, N = () => C(!1);
  ...
  const D = /* @__PURE__ */ a("span", { ref: h, className: "tw:min-w-0 tw:shrink tw:truncate", children: t }, "primary"), F = $ ? (
...
function Ol({
  ...
  const [h, g] = _(!1), f = w !== void 0, x = f ? w : h, b = (y) => {
    f || g(y), p == null || p(y);
  };
  if (t.length === 0)
    return;
  ...
  return /* @__PURE__ */ u(je, { open: x, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ a(Be, { id: s, className: "tw:w-[300px] tw:p-0", align: "start", children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: /* @__PURE__ */ a(ze, { heading: i, children: t.map((y) => /* @__PURE__ */ u(
      Me,
      {
        onSelect: () => S(y),
...
function za({
  ...
  const B = Ne(), P = zl(), D = T ?? P, [F, Y] = _(!1), [K, Q] = _(""), [I, tt] = _(""), [N, z] = _("books"), [G, nt] = _(void 0), [rt, ut] = _(
    void 0
  ), [lt, J] = _(void 0), [dt, pt] = _(!1), [ht, gt] = _(!1), Jt = U(null), ft = U(!1), At = U(void 0), Vt = U(void 0), vt = U(void 0), Kt = U(void 0), Lt = U({}), Zt = U({}), ot = L(
    (k) => {
      e(k), l && l(k);
    },
    [e, l]
    ...
    () => Ll(bt, Tt),
    [bt, Tt]
  ), ne = Ht.has(t.book), oe = V(() => I.trim() ? eo(
    jt.filter((k) => so(k, I, i))
  ) : ht ? ae : he, [
    he,
    ae,
    jt,
  ...
  const Qt = L(() => {
    if (M) {
      const k = M.chapterNum ?? 1, et = M.verseNum ?? 1;
      if (p && Ra(M.book, k, et, p))
        return;
      ot({
        book: M.book,
        chapterNum: k,
    ...
    (k) => {
      const et = rt ?? (M == null ? void 0 : M.book), at = lt ?? (M == null ? void 0 : M.chapterNum);
      !et || !at || (ot({
        book: et,
        chapterNum: at,
        verseNum: k
    ...
    (k) => {
      const et = N === "chapters" ? G : M == null ? void 0 : M.book;
      if (et) {
        if (w && w(et, k) > 1) {
          ut(et), J(k), z("verses"), Q("");
          return;
        }
        ot({
          book: et,
    ...
    z("books"), nt(void 0), ut(void 0), J(void 0), setTimeout(() => {
      Vt.current && Vt.current.focus();
    }, 0);
  }, []), m = L(() => {
    const k = rt;
    ut(void 0), J(void 0), k ? (nt(k), z("chapters"), Q("")) : Ft();
  }, [rt, Ft]), R = L(
    (k) => {
      Y(k), k && (z("books"), nt(void 0), ut(void 0), J(void 0), tt(""), gt(ne));
    },
    [ne]
  );
  W(() => {
  ...
  const { otLong: q, ntLong: H, dcLong: it, extraLong: mt } = {
    ...
    () => D >= Yr.TIGHT ? Cr(t.book, i) : xe(t.book, i),
    [t.book, i, D]
  ), Ut = `${t.chapterNum}:${t.verseNum}`, Pr = L((k) => (et) => {
    Lt.current[k] = et;
  }, []), ba = L((k) => (et) => {
    Zt.current[k] = et;
  }, []), Ar = V(
    () => Pl(I),
    [I]
  ), vr = V(() => !w || !M || !M.chapterNum || !Ar ? !1 : w(M.book, M.chapterNum) > 0, [w, M, Ar]), Vr = N === "books" && !dt && !I.trim() && Ht.size > 0, br = L(
    (k) => p ? Zo(k, p) : !1,
    [p]
  ), xr = L(
    (k) => (et) => p ? Al(k, et, p) : !1,
    ...
    (k) => {
      (k.key === "Home" || k.key === "End") && k.stopPropagation(), h && h.includes(k.key) && M && M.chapterNum !== void 0 && M.verseNum !== void 0 && (k.preventDefault(), k.stopPropagation(), Qt());
    },
    [h, M, Qt]
  ), jr = L(
    (k) => {
      var Z, kt, me;
      if (k.ctrlKey) return;
      const { isLetter: et, isDigit: at } = Qo(k.key);
      if ((N === "chapters" || N === "verses") && (k.key === " " || k.key === "Enter")) {
        const Gt = k.target instanceof HTMLElement ? k.target : void 0;
        ...
        if (te) {
          k.preventDefault(), k.stopPropagation(), te.click();
          return;
        }
      }
      if ((N === "chapters" || N === "verses") && (et || at)) {
      ...
      if (N === "verses" && O) {
        ...
        ve !== xt && (k.preventDefault(), k.stopPropagation(), Q(
          `${Gt} ${ue[Gt] || ""} ${Rt}:${ve}`
        ), setTimeout(() => {
          const yr = Zt.current[ve];
          yr && yr.scrollIntoView({ block: "nearest", behavior: "smooth" });
        }, 0));
        return;
      }
      if ((N === "chapters" || N === "books" && M) && O) {
        const Gt = N === "chapters" ? G : M == null ? void 0 : M.book;
        if (!Gt) return;
        N === "chapters" && ((me = At.current) == null || me.focus());
        const Rt = (() => {
          if (!K) return 1;
          const Oe = K.match(/(\d+)$/);
        ...
        xt !== Rt && (k.preventDefault(), k.stopPropagation(), Q(
          `${Gt} ${ue[Gt] || ""} ${xt}`
        ), setTimeout(() => {
          const Oe = Lt.current[xt];
    ...
    if (k.key === "ArrowUp" || k.key === "ArrowDown") {
      (O = Vt.current) == null || O.focus();
      return;
    }
    const { isLetter: et, isDigit: at } = Qo(k.key);
    (et || at) && (k.preventDefault(), tt((Z) => Z + k.key), Vt.current.focus(), pt(!1));
  }, []);
  return ee(() => {
    const k = setTimeout(() => {
      if (F && N === "books" && vt.current && Kt.current) {
        const et = vt.current, at = Kt.current, O = at.offsetTop, Z = et.clientHeight, kt = at.clientHeight, me = O - Z / 2 + kt / 2;
        et.scrollTo({
          top: Math.max(0, me),
          behavior: "smooth"
        }), Q(si(t.book));
    ...
    if (N === "chapters" && G) {
      const k = G === t.book, et = k ? t.chapterNum : 1;
      Q(
        `${G} ${ue[G] || ""} ${et}`
      ), setTimeout(() => {
        if (vt.current)
          if (k) {
            const at = Lt.current[t.chapterNum];
  ...
  }, [N, G, M, t.book, t.chapterNum]), ee(() => {
    if (N === "verses" && rt && lt !== void 0) {
      const k = rt === t.book && lt === t.chapterNum, et = k ? t.verseNum : 1;
      Q(
        `${rt} ${ue[rt] || ""} ${lt}:${et}`
      ), setTimeout(() => {
        if (vt.current)
    ...
    t.chapterNum,
    t.verseNum
  ]), /* @__PURE__ */ u(je, { open: F, onOpenChange: R, modal: y, children: [
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        onPointerDownOutside: (k) => {
          const { target: et } = k;
          F && Jt.current && et instanceof Node && Jt.current.contains(et) && (ft.current = !0, R(!1));
        },
        onCloseAutoFocus: S,
        children: /* @__PURE__ */ u(
          Fe,
            ...
            children: [
              N === "books" ? /* @__PURE__ */ u("div", { className: "tw:flex tw:items-end", children: [
                ...
                /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: de.map(
                  ({ onClick: k, disabled: et, title: at, icon: O }) => /* @__PURE__ */ a(
                    X,
                    {
                      variant: "ghost",
                      size: "sm",
                ...
                /* @__PURE__ */ a(
                  X,
                  {
                    variant: "ghost",
                    size: "sm",
                    onClick: N === "verses" ? m : Ft,
                    className: "tw:mr-2 tw:h-6 tw:w-6 tw:p-0",
                    tabIndex: -1,
                    children: B === "ltr" ? /* @__PURE__ */ a(ys, { className: "tw:h-4 tw:w-4" }) : /* @__PURE__ */ a(ks, { className: "tw:h-4 tw:w-4" })
                  }
                ),
                N === "chapters" && G && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: xe(G, i) }),
                N === "verses" && rt && lt !== void 0 && /* @__PURE__ */ a("span", { tabIndex: -1, className: "tw:text-sm tw:font-medium", children: `${xe(rt, i)} ${lt}` }),
                /* @__PURE__ */ a(
                  "span",
                  {
                    tabIndex: -1,
                    className: "tw:ms-auto tw:text-sm tw:font-medium tw:text-muted-foreground",
                    children: N === "verses" ? Ye : Lr
                  }
                )
              ] }),
              !dt && /* @__PURE__ */ u(Ue, { ref: vt, children: [
                N === "books" && /* @__PURE__ */ u(ct, { children: [
                  !M && Object.entries(oe).map(([k, et]) => {
                    if (et.length !== 0)
                      return (
                        // We are mapping over filteredBooksByType, which uses Section as key type
                        // eslint-disable-next-line no-type-assertion/no-type-assertion
                        /* @__PURE__ */ a(ze, { heading: St(k), children: et.map((at) => /* @__PURE__ */ a(
                          ii,
                          {
                            bookId: at,
                            onSelect: (O) => fe(O),
                  ...
                  M && /* @__PURE__ */ a(ze, { children: /* @__PURE__ */ a(
                    Me,
                    {
                      value: `${M.book} ${ue[M.book]} ${M.chapterNum || ""}:${M.verseNum || ""})}`,
                      onSelect: Qt,
                      disabled: !!p && Ra(
                        M.book,
                        M.chapterNum ?? 1,
                      ...
                      children: Se(
                        ...
                        // one control.
                        i ? Cr(M.book, i) : "English"
                      )
                    },
                    "top-match"
                  ) }),
                  M && vr && M.chapterNum && w && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: `${xe(M.book, i)} ${M.chapterNum}` }),
                    ...
                    /* @__PURE__ */ a(
                      en,
                      {
                        ...
                        onVerseSelect: Bt,
                        setVerseRef: ba,
                        isVerseDisabled: We(M.book, M.chapterNum),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] }),
                  M && !vr && lr(M.book) > 1 && /* @__PURE__ */ u(ct, { children: [
                    /* @__PURE__ */ u("div", { className: "tw:mb-2 tw:flex tw:items-center tw:justify-between tw:px-3 tw:text-sm tw:font-medium tw:text-muted-foreground", children: [
                      /* @__PURE__ */ a("span", { children: xe(M.book, i) }),
                    ...
                    /* @__PURE__ */ a(
                      tn,
                      {
                        ...
                        setChapterRef: Pr,
                        isChapterDimmed: yt,
                        isChapterDisabled: xr(M.book),
                        className: "tw:px-4 tw:pb-4"
                      }
                    )
                  ] })
                ] }),
                N === "chapters" && G && /* @__PURE__ */ a(
                  tn,
                  {
                    bookId: G,
                    scrRef: t,
                    onChapterSelect: ie,
                    setChapterRef: Pr,
                    isChapterDisabled: xr(G),
                    className: "tw:p-4"
                  }
                ),
                N === "verses" && rt && lt !== void 0 && w && /* @__PURE__ */ a(
                  en,
                  {
                    bookId: rt,
                    chapterNum: lt,
...
function rn({
  ...
  const [C, E] = _(!1), $ = d ?? l, T = (P) => P.length > 0 && typeof P[0] == "object" && "options" in P[0], B = (P, D) => {
    const F = l(P), Y = typeof P == "object" && "secondaryLabel" in P ? P.secondaryLabel : void 0, K = `${D ?? ""}${F}${Y ?? ""}`;
    return /* @__PURE__ */ u(
      Me,
      {
        value: F,
  ...
  return /* @__PURE__ */ u(je, { open: C, onOpenChange: E, ...y, children: [
    /* @__PURE__ */ a(er, { asChild: !0, children: /* @__PURE__ */ u(
      X,
      {
        variant: f,
    ...
    /* @__PURE__ */ a(
      Be,
      {
        ...
        children: /* @__PURE__ */ u(Fe, { children: [
          ...
          /* @__PURE__ */ a(Ue, { children: T(e) ? e.map((P) => /* @__PURE__ */ a(ze, { heading: P.groupHeading, children: P.options.map((D) => B(D, P.groupHeading)) }, P.groupHeading)) : /* @__PURE__ */ a(ze, { children: e.map((P) => B(P)) }) })
        ] })
      }
    )
  ] });
...
function Ql() {
  return function(t) {
    const [e] = Ee(), r = V(() => t(e), [e, t]), [o, n] = _(() => r.initialValueFn()), i = U(o);
    return Jl(() => {
...
function ad(t, e, r) {
  ...
  function l() {
    ...
    for (let S = 0; S < g.length; S++) {
      const y = g[S], C = s[S] || document.createElement("div"), E = C.style;
      ...
      const B = ye(y.width);
      E.width !== B && (C.style.width = B, b = !0);
      const P = ye(y.height);
      E.height !== P && (C.style.height = P, b = !0), C.parentNode !== c && (c.append(C), b = !0), s[S] = C;
    }
...
function nd(t, e = od) {
  ...
  function d(w) {
    w.read(() => {
      ...
      }(p), f = h.getNode(), x = f.getKey(), b = h.offset, S = g.getNode(), y = S.getKey(), C = g.offset, E = t.getElementByKey(x), $ = t.getElementByKey(y), T = r === null || E !== o || b !== n || x !== r.getKey(), B = i === null || $ !== s || C !== c || y !== i.getKey();
      if ((T || B) && E !== null && $ !== null) {
        const P = function(D, F, Y, K, Q, I, tt) {
          const N = (D._window ? D._window.document : document).createRange();
          return N.setStart(...an(F, Y, K)), N.setEnd(...an(Q, I, tt)), N;
        }(t, h, f, E, g, S, $);
        l(), l = ad(t, P, e);
      }
      r = f, o = E, n = b, i = S, s = $, c = C;
    });
  }
...
le({ build: (t, e, r) => mr(e), config: ar({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const o = r.getOutput();
...
le({ build: (t, e, r) => mr(e), config: ar({ $onClear: gi }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
const So = 0, no = 1, xi = 2, Ia = 3, Hr = 4, or = 5, $a = 6, _r = 7;
function Pa(t) {
  return t.id === So;
}
function yi(t) {
...
class xd {
  ...
  register(e, r) {
    ...
    return this.state = function(i) {
      ...
      const i = this.state;
      i.id !== _r && wt(309, String(o.id), String(_r)), this.state = function(s) {
  ...
  getState() {
    ...
    return function(r) {
      return r.id >= _r;
    }(e) || wt(316, String(e.id), String(_r)), e;
  }
...
class dr {
  ...
  static maybeFromEditor(e) {
    const r = e[ln];
    return r && (r.PACKAGE_VERSION !== Aa && wt(292, r.PACKAGE_VERSION, Aa), r instanceof dr || wt(293)), r;
  }
  static fromEditor(e) {
...
le({ dependencies: [oo, wn], name: "@lexical/extension/HorizontalRule", nodes: () => [ur], register(t, e, r) {
  ...
  return De(t.registerCommand(Cd, (s) => {
    ...
    return !1;
  }, Qn), t.registerMutationListener(ur, (s, c) => {
    ud(() => {
      let l = !1;
...
le({ build: (t, e) => mr({ inheritEditableFromParent: e.inheritEditableFromParent }), config: ar({ $getParentEditor: function() {
  const t = Wc();
...
le({ build: (t, e, r) => mr(e), config: ar({ disabled: !1, onReposition: void 0 }), name: "@lexical/utils/SelectionAlwaysOnDisplay", register: (t, e, r) => {
  const o = r.getOutput();
  return _e(() => {
...
le({ build: (t, e, r) => mr(e), config: ar({ $canIndent: ki, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
        ...
        if (c && c.functionId === "makeChanges") {
          ...
          if (l) {
            ...
            t.update(() => {
              ...
              if (ke(f)) {
                const x = f.anchor;
                let b = x.getNode(), S = 0, y = 0;
                if (Ja(b) && d >= 0 && w >= 0 && (S = d, y = d + w, f.setTextNodeRange(b, S, b, y)), S === y && p === "" || (f.insertRawText(p), b = x.getNode()), Ja(b)) {
                  S = h, y = h + g;
                  const C = b.getTextContentSize();
                  S = S > C ? C : S, y = y > C ? C : y, f.setTextNodeRange(b, S, b, y);
                }
...
le({ build: (t, e, r) => mr(e), config: ar({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => _e(() => r.getOutput().disabled.value ? void 0 : Ni(t)) });
function Od(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const n of e) o.append("v", n);
...
function fn({
  ...
  const g = L(
    ...
    [t.user]
  ), y = V(() => vo(t.contents), [t.contents]), C = V(
    ...
    if (o && c)
      return /* @__PURE__ */ u(ct, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (T) => {
              T.stopPropagation(), d(!0), p(ew(t.contents)), s == null || s(!0);
            },
            children: [
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          l && /* @__PURE__ */ u(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (T) => {
                T.key === "Escape" ? (T.preventDefault(), T.stopPropagation(), g()) : Mo(T) && (T.preventDefault(), T.stopPropagation(), ce(w) && f());
              },
              onKeyDown: (T) => {
        ...
        $ && /* @__PURE__ */ u(Ke, { children: [
          ...
          /* @__PURE__ */ a(Ge, { align: "end", children: $ })
        ] })
      ]
    }
  );
...
function Pi({
  ...
  const [K, Q] = _(mn), [I, tt] = _(), [N, z] = _(), G = o, [nt, rt] = _(!1), [ut, lt] = _(!1), [J, dt] = _(!1), [pt, ht] = _(!1), [gt, Jt] = _(!1), [ft, At] = _(E), [Vt, vt] = _(!1), Kt = U(void 0), [Lt, Zt] = _(/* @__PURE__ */ new Map());
  W(() => {
    let m = !0;
    return (async () => {
      const j = y ? await y(l) : !1;
      m && Jt(j);
    })(), () => {
      m = !1;
    };
  ...
  W(() => {
    if (!o) {
      ot.current !== "idle" && (tt(void 0), z(void 0), ot.current = "idle");
      return;
    }
    ot.current === "idle" && (ot.current = "pending"), pt ? ot.current === "pending" && B !== void 0 && // Skip pre-population if the thread is already assigned to this user — doing so
    // would show "Assigning to: Alice" and enable the submit button for a no-op call.
    B !== i && (tt(B), ot.current = "auto-populated") : ot.current === "auto-populated" && (tt(void 0), ot.current = "pending");
  }, [o, B, pt, i]);
  const bt = V(
  ...
  const Tt = V(() => bt[0], [bt]), he = U(null), ae = U(void 0), jt = L(() => {
    var m;
  ...
  W(() => {
    ...
    if (o && !ft && !Vt) {
      ...
      return Kt.current = m, () => clearTimeout(m);
    }
  ...
  }, [i, r]), oe = V(() => bt.slice(1), [bt]), M = V(() => oe.length ?? 0, [oe.length]), ge = V(() => M > 0, [M]), Qt = V(() => nt || M <= 2 ? oe : oe.slice(-2), [oe, M, nt]), Bt = V(() => nt || M <= 2 ? 0 : M - 2, [M, nt]), fe = V(
    () => M === 1 ? Ht.singleReply : Pe(Ht.multipleReplies, { count: M }),
    [M, Ht]
  ), ie = V(
    () => Bt === 1 ? Ht.singleReply : Pe(Ht.multipleReplies, { count: Bt }),
    [Bt, Ht]
  );
  W(() => {
    !o && ut && ge && lt(!1);
  ...
  const se = L(
    async (m) => {
      ...
      R && await p({ threadId: l, contents: R }) && jt();
    },
    [
      jt,
      K,
    ...
    async (m) => {
      const R = ce(K) ? sa(K) : void 0, j = m.status ? m.assignedUser : I ?? m.assignedUser, A = await p({
        ...m,
        contents: R,
        assignedUser: j
      });
      return A && (j !== void 0 && z(j), R && jt()), A;
    },
    [jt, K, p, I]
  );
  ...
  const Ft = /* @__PURE__ */ a(
    fn,
    {
      ...
      handleDeleteComment: g,
      onEditingChange: lt,
      canEditOrDelete: (!ut && Lt.get(Tt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ u(ct, { children: [
              ...
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
                    ...
                    nt ? /* @__PURE__ */ a(zs, {}) : /* @__PURE__ */ a(wr, {})
                  ] })
                ]
              }
            ),
            Qt.map((m) => /* @__PURE__ */ a("div", { children: /* @__PURE__ */ a(
              fn,
              {
                ...
                handleDeleteComment: g,
                onEditingChange: lt,
                canEditOrDelete: (!ut && Lt.get(m.id)) ?? !1
              }
            ) }, m.id)),
            b !== !1 && (!ut || ce(K)) && /* @__PURE__ */ u(
              "div",
              {
                ...
                onKeyDownCapture: (m) => {
                  Mo(m) && (m.preventDefault(), m.stopPropagation(), (ce(K) || I !== void 0 && I !== N) && se());
                },
                onKeyDown: (m) => {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-row tw:items-center tw:justify-end tw:gap-2", children: [
                    I !== void 0 && (ce(K) || I !== N) && /* @__PURE__ */ a("span", { className: "tw:flex-1 tw:text-sm tw:text-muted-foreground", children: Pe(
                      ...
                      /* @__PURE__ */ a(
                        Be,
                        {
                          ...
                          children: /* @__PURE__ */ a(Fe, { children: /* @__PURE__ */ a(Ue, { children: x == null ? void 0 : x.map((m) => /* @__PURE__ */ a(
                            ...
                            {
                              onSelect: () => {
                                tt(m !== i ? m : void 0), ot.current = "user-selected", z(void 0), dt(!1);
                              },
                              className: "tw:flex tw:items-center",
...
function ww({
  ...
  let D;
  B ? D = e["%conflict_note_save_disabled_tooltip%"] ?? "Keeping the current text makes no change — resolve the thread with the ✓ to keep it." : i || (D = e["%conflict_note_save_warning%"] ?? "This can't be undone.");
  const F = e["%conflict_note_no_result%"] ?? "No result preview available.", Y = /* @__PURE__ */ a("p", { className: "tw:text-muted-foreground", children: F }), K = (N) => N ? /* @__PURE__ */ a("p", { className: "tw:whitespace-pre-wrap tw:text-foreground", children: N }) : Y, Q = () => {
    const N = o ?? "accept";
    return N === "merged" ? t.mergedText ? /* @__PURE__ */ a(ta, { html: S }) : Y : K(N === "reject" ? t.rejectedResultText : t.resultText);
  }, I = (N) => p && N.value === "reject", tt = (N) => {
    const z = f === N.value, G = `${d}-${N.value}`, nt = I(N);
    return (
      ...
      !w && !h && /* @__PURE__ */ u(ct, { children: [
        ...
        /* @__PURE__ */ a(
          co,
          {
            ...
            children: T.map((N) => I(N) ? /* @__PURE__ */ a(Mt, { delayDuration: 0, children: /* @__PURE__ */ u(Ot, { children: [
              /* @__PURE__ */ a(It, { asChild: !0, children: tt(N) }),
...
function Lp({
  ...
  const [y, C] = _(/* @__PURE__ */ new Set()), [E, $] = _(), [T, B] = _(), P = L(
    async (z) => {
      const G = await i(z);
      return G !== void 0 && z.assignedUser !== void 0 && z.assignedUser !== "" && B(z.assignedUser), G;
    },
    [i]
  );
  W(() => {
  ...
  ), F = D.map((z) => ({ id: z.id })), Y = L(
    (z) => {
      C((G) => new Set(G).add(z.id)), $(z.id), x == null || x(z.id);
    },
    [x]
  ), K = L(
    (z) => {
      ...
      C((nt) => {
        const rt = new Set(nt);
        return rt.has(z) ? rt.delete(z) : rt.add(z), rt;
      }), $(z), x == null || x(G ? void 0 : z);
    },
    [y, x]
  ), { listboxRef: Q, activeId: I, handleKeyDown: tt } = es({
    options: F,
    onOptionSelect: Y
  }), N = L(
    (z) => {
      z.key === "Escape" ? (E && y.has(E) && (C((G) => {
        const nt = new Set(G);
        return nt.delete(E), nt;
      }), $(void 0), x == null || x(void 0)), z.preventDefault(), z.stopPropagation()) : tt(z);
    },
    [E, y, tt, x]
  );
  return /* @__PURE__ */ a(
      ...
      children: D.map((z) => {
        ...
        return /* @__PURE__ */ a(
          "div",
          {
            ...
            children: z.type === "Conflict" ? /* @__PURE__ */ a(fw, { ...G, conflictResolution: S }) : /* @__PURE__ */ a(Pi, { ...G })
          },
          z.id
        );
      })
...
function kw({
  ...
  var T;
  const [w, p] = _([]), [h, g] = _([]), [f, x] = _({}), [b, S] = _({}), y = V(() => e ?? [], [e]), C = ai({
    data: y,
    columns: t,
    getCoreRowModel: ni(),
  ...
  let $;
  return l ? $ = Array.from({ length: 10 }).map((D, F) => `skeleton-row-${F}`).map((D) => /* @__PURE__ */ a($e, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(cr, { colSpan: E.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(sr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, D)) : ((T = C.getRowModel().rows) == null ? void 0 : T.length) > 0 ? $ = C.getRowModel().rows.map((B) => /* @__PURE__ */ a(
    $e,
    {
      onClick: () => s(B, C),
      "data-state": B.getIsSelected() && "selected",
      children: B.getVisibleCells().map((P) => /* @__PURE__ */ a(cr, { children: Er(P.column.columnDef.cell, P.getContext()) }, P.id))
    },
    B.id
  )) : $ = /* @__PURE__ */ a($e, { children: /* @__PURE__ */ a(cr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: d }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
    n && /* @__PURE__ */ a(mw, { table: C }),
    /* @__PURE__ */ u(uo, { stickyHeader: i, children: [
      /* @__PURE__ */ a(po, { stickyHeader: i, children: C.getHeaderGroups().map((B) => /* @__PURE__ */ a($e, { children: B.headers.map((P) => /* @__PURE__ */ a(ra, { className: "tw:p-0", children: P.isPlaceholder ? void 0 : Er(P.column.columnDef.header, P.getContext()) }, P.id)) }, B.id)) }),
...
function Dw({
  ...
  const b = (y) => {
    ...
    var C, E, $, T;
    y.stopPropagation(), document.activeElement === i.current && y.key === "ArrowDown" || y.key === "ArrowRight" ? ((C = n.current) == null || C.focus(), s.current = !0) : document.activeElement === n.current && y.key === "ArrowUp" ? ((E = i.current) == null || E.focus(), s.current = !1) : document.activeElement === n.current && y.key === "ArrowLeft" && (($ = n.current) == null ? void 0 : $.selectionStart) === 0 && ((T = i.current) == null || T.focus(), s.current = !1), c === "custom" && y.key === "Enter" && (document.activeElement === i.current || document.activeElement === n.current) && b(!1);
  };
...
function Lw(t, e, r, o, n) {
  var c;
  if (!o || o === "p") return [];
  const i = (c = nr[o]) != null && c.children ? nr[o] : nr[n ?? o];
  if (!(i != null && i.children)) return [];
  const s = [];
  return Object.entries(i.children).forEach(([, l]) => {
    s.push(
      ...l.map((d) => ({
        marker: d,
  ...
  }), s.sort((l, d) => (l.marker ?? l.title).localeCompare(d.marker ?? d.title));
}
function jw(t) {
  return {
    id: t.marker,
...
function Yp({
  ...
  const [b, S] = _("generated"), [y, C] = _("generated"), [E, $] = _("*"), [T, B] = _("*"), [P, D] = _("f"), [F, Y] = _(!1), [K, Q] = _(!0), [I, tt] = _(!1), N = U(!1), z = U(""), [G, nt] = _(!1), [rt, ut] = _(), [lt, J] = _(), [dt, pt] = _(), [ht, gt] = _(), Jt = U(null), ft = U(
    void 0
  ), At = U(0), Vt = U(void 0), vt = L(() => {
    var R, j, A;
    if ((R = h.current) != null && R.getSelection()) return;
    const m = Vt.current;
    m ? (j = h.current) == null || j.setSelection(m) : (A = h.current) == null || A.selectNote(0);
  }, []), Kt = L(() => {
    var m;
  ...
  const ot = L(() => {
    var A, q, H;
    const m = (A = g.current) == null ? void 0 : A.querySelector(".editor-input"), R = m == null ? void 0 : m.querySelector("span.note"), j = (H = (q = g.current) == null ? void 0 : q.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
    return !!R && !!j && R.contains(j);
  }, []);
  W(() => {
    var q, H;
    let m, R, j;
    N.current = !1, Vt.current = void 0, Q(!0);
    const A = e == null ? void 0 : e.at(0);
    if (A && kr("note", A)) {
      const it = (q = A.insert.note) == null ? void 0 : q.caller;
      let mt = "custom";
      it === Za ? mt = "generated" : it === Qa ? mt = "hidden" : it && ($(it), B(it)), S(mt), C(mt), D(((H = A.insert.note) == null ? void 0 : H.style) ?? "f"), m = setTimeout(() => {
        var St, yt, Ct;
        (St = h.current) == null || St.applyUpdate([A]), (yt = h.current) == null || yt.selectNote(0), (Ct = h.current) == null || Ct.focus(), R = requestAnimationFrame(() => {
          j = setTimeout(() => {
            var Et, Ut;
            ot() || ((Et = h.current) == null || Et.selectNote(0), (Ut = h.current) == null || Ut.focus());
          }, 0);
        });
      }, 0);
    }
    return () => {
      m && clearTimeout(m), R !== void 0 && cancelAnimationFrame(R), j !== void 0 && clearTimeout(j);
    };
  }, [e, i, ot]);
  const bt = L(
    (m = !1) => {
      var j, A, q;
      p == null || p();
      const R = (A = (j = h.current) == null ? void 0 : j.getNoteOps(0)) == null ? void 0 : A.at(0);
      R && kr("note", R) && (r == null || r([R]), m && d && i && ((q = d.current) == null || q.replaceEmbedUpdate(i, [R])));
    },
    [i, r, p, d]
  ), Tt = L(
    (m) => {
      var j, A, q;
      const R = (j = h.current) == null ? void 0 : j.getSelection();
      (A = h.current) == null || A.applyUpdate([m, { delete: 1 }]), R && ((q = h.current) == null || q.setSelection(R)), Kt();
    },
    [Kt]
  ), he = L(
    (m, R) => {
      var q, H;
      const j = (H = (q = h.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : H.at(0);
      if (!j || !kr("note", j) || !j.insert.note) return;
      let A;
      m === "custom" ? A = R : m === "generated" ? A = Za : A = Qa, j.insert.note.caller !== A && (j.insert.note.caller = A, Tt(j));
    },
    [Tt]
  ), ae = L(() => {
    var m;
  ...
  ee(() => {
    (Te.current.book !== n.book || Te.current.chapterNum !== n.chapterNum) && (Te.current = { book: n.book, chapterNum: n.chapterNum }, jt.current());
  }, [n.book, n.chapterNum]);
  const Ht = () => {
    var R;
      ...
      if (R && kr("note", R)) {
        ...
        if (mt || Y(!1), Y(
          mt === "x" ? !!(St != null && St.every((yt) => {
            ...
            const Ct = ((Ut = yt.attributes) == null ? void 0 : Ut.char).style;
          ...
          N.current = !0, z.current = JSON.stringify(R), Q(!0);
          return;
        }
        Q(JSON.stringify(R) === z.current), bt();
      } else
        Y(!1), Q(!0);
    },
    [bt]
    ...
    if (f.current && Zt.length && m && m.rangeCount > 0) {
      const R = m.getRangeAt(0).getBoundingClientRect(), j = f.current.getBoundingClientRect();
      ut(R.left - j.left), J(R.top - j.top), pt(R.height), nt(!0);
    }
  }, [Zt, f]), Bt = U(() => {
  }), fe = L(
    (m, R, j) => {
  ...
  W(() => {
    ...
    const m = (R) => {
      var q, H;
      const j = (q = g.current) == null ? void 0 : q.querySelector(".editor-input");
      if (!j || R.target !== j) return;
    ...
    if (((j = Lt.view) == null ? void 0 : j.markerMode) === "editable") {
      const A = (H) => {
        var St, yt, Ct, Et;
        if (ds(H)) return;
        const it = m();
    ...
    Qt,
    c,
    (Ft = Lt.view) == null ? void 0 : Ft.markerMode,
    Lt.styleInfo,
    w,
    ie,
    ot
    ...
    const m = () => {
      ...
      j && !j.isCollapsed || ot() || ((q = h.current) == null || q.selectNote(0), (H = h.current) == null || H.focus());
    };
...
function Gw({
  ...
  /* @__PURE__ */ a("span", { className: v("note-caller tw:inline-block", { formatted: i }), children: n }), p = t.category && /* @__PURE__ */ u("span", { className: "note-category tw:inline-block", children: [
    ...
    Oo(t.marker, [s], o, !1),
    " "
  ] }), g = !!l, f = !!w, x = !!p, b = e === "horizontal" ? "horizontal" : "vertical", S = o ? "marker-visible" : "", y = e === "horizontal" ? "tw:col-span-1" : "tw:col-span-2 tw:col-start-1 tw:row-start-2", C = v(b, S);
  return /* @__PURE__ */ u(ct, { children: [
...
function Jp({
  ...
  const p = d ?? sc(r, void 0), h = (E, $) => {
    w == null || w(E, $, n);
  }, g = i ? r.findIndex((E) => E === i) : -1, [f, x] = _(g), b = (E, $, T) => {
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
          E.preventDefault(), w == null || w($, T, n);
          break;
      }
  }, S = (E) => {
    if (r.length)
      switch (E.key) {
        case "ArrowDown":
          E.preventDefault(), x(($) => Math.min($ + 1, r.length - 1));
          break;
        case "ArrowUp":
          E.preventDefault(), x(($) => Math.max($ - 1, 0));
          break;
      }
  }, y = U([]);
  W(() => {
...
function nh({
  ...
  const g = be(r, "%webView_inventory_all%"), f = be(r, "%webView_inventory_approved%"), x = be(r, "%webView_inventory_unapproved%"), b = be(r, "%webView_inventory_unknown%"), S = be(r, "%webView_inventory_scope_currentBook%"), y = be(r, "%webView_inventory_scope_chapter%"), C = be(r, "%webView_inventory_scope_verse%"), E = be(r, "%webView_inventory_filter_text%"), $ = be(
    r,
    "%webView_inventory_show_additional_items%"
  ), T = be(r, "%webView_inventory_no_results%"), [B, P] = _(!1), [D, F] = _("all"), [Y, K] = _(""), [Q, I] = _([]), tt = V(() => {
    const J = t ?? [];
  ...
  }, [B, tt]), z = V(() => N.length === 0 ? [] : Zw(N, D, Y), [N, D, Y]), G = V(() => {
    var pt, ht;
    if (!B) return l;
  ...
  return /* @__PURE__ */ a("div", { id: d, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ u("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ u("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ u(pr, { onValueChange: (J) => rt(J), defaultValue: s, children: [
        ...
        /* @__PURE__ */ u(fr, { children: [
          ...
          /* @__PURE__ */ a(we, { value: "chapter", children: y }),
          /* @__PURE__ */ a(we, { value: "verse", children: C })
        ] })
      ] }),
      /* @__PURE__ */ a(
        wa,
...
function ru({
  ...
  const [l, d] = Yt.useState(t), w = e ?? l, p = Yt.useCallback(
    ...
    [r, w]
  ), h = Yt.useCallback(() => p((C) => !C), [p]), g = w ? "expanded" : "collapsed", b = Ne() === "ltr" ? s : s === "primary" ? "secondary" : "primary", S = Yt.useMemo(
    () => ({
      state: g,
      open: w,
      setOpen: p,
...
function xh({
  ...
  W(() => {
    if (c) {
      const D = S.getSelectedRowModel().rowsById, F = Object.keys(D);
      if (F.length === 1) {
        const Y = x.find((K) => Nn(K) === F[0]) || void 0;
        Y && c(Y);
      }
    }
  }, [g, x, c, S]);
  const y = n ?? hu, C = i ?? Li, E = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${y}`, value: [Ie] },
    { label: `Group by ${C}`, value: [Ze] },
    {
    ...
    !D.getIsGrouped() && !D.getIsSelected() && D.getToggleSelectedHandler()(F);
  }, B = (D, F) => D.getIsGrouped() ? "" : v("banded-row", F % 2 === 0 ? "even" : "odd"), P = (D, F, Y) => {
    if (!((D == null ? void 0 : D.length) === 0 || F.depth < Y.column.getGroupedIndex())) {
      if (F.getIsGrouped())
        switch (F.depth) {
          case 1:
            return "tw:ps-4";
    ...
    !e && /* @__PURE__ */ u(
      pr,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(fr, { position: "item-aligned", children: /* @__PURE__ */ a(vw, { children: E.map((D) => /* @__PURE__ */ a(we, { value: JSON.stringify(D.value), children: D.label }, D.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ u(uo, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ a(po, { children: S.getHeaderGroups().map((D) => /* @__PURE__ */ a($e, { children: D.headers.filter((F) => F.column.columnDef.header).map((F) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ a(ra, { colSpan: F.colSpan, className: "tw:sticky top-0", children: F.isPlaceholder ? void 0 : /* @__PURE__ */ u("div", { children: [
          ...
          " ",
          Er(F.column.columnDef.header, F.getContext())
        ] }) }, F.id)
      )) }, D.id)) }),
      /* @__PURE__ */ a(ho, { children: S.getRowModel().rows.map((D, F) => {
        const Y = Ne();
        return /* @__PURE__ */ a(
          $e,
          {
                  ...
                  cr,
                  {
                    ...
                    children: K.getIsGrouped() ? /* @__PURE__ */ u(
                      X,
                      {
                        ...
                        type: "button",
                        children: [
                          D.getIsExpanded() && /* @__PURE__ */ a(wr, {}),
                          !D.getIsExpanded() && (Y === "ltr" ? /* @__PURE__ */ a(qa, {}) : /* @__PURE__ */ a(Ga, {})),
                          " ",
...
function vu({
  ...
  const s = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: g, dcLong: f, extraLong: x } = {
  ...
  }, [b, S] = _(!1), [y, C] = _(""), E = U(void 0), $ = U(!1), T = V(
    () => On(t),
    [t]
  ), B = V(() => {
    if (!y.trim()) {
    ...
    (I, tt = !1) => {
      if (!tt || !E.current) {
        r(
          e.includes(I) ? e.filter((ut) => ut !== I) : [...e, I]
        ), E.current = I;
        return;
      }
      const N = T.findIndex((ut) => ut === E.current), z = T.findIndex((ut) => ut === I);
      if (N === -1 || z === -1) return;
      const [G, nt] = [
        Math.min(N, z),
        Math.max(N, z)
      ], rt = T.slice(G, nt + 1).map((ut) => ut);
      r(
        e.includes(I) ? e.filter((ut) => !rt.includes(ut)) : [.../* @__PURE__ */ new Set([...e, ...rt])]
      );
    },
    [e, r, T]
  ), D = (I) => {
    P(I, $.current), $.current = !1;
  }, F = (I, tt) => {
    I.preventDefault(), P(tt, I.shiftKey);
  }, Y = () => {
    r(T.map((I) => I));
  }, K = () => {
    r([]);
    ...
    () => Object.values(_t).filter(
      (I) => (i == null ? void 0 : i[I]) !== void 0 && go(T, I).length === 0
              ...
              Fe,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ u(Ue, { className: "tw:max-h-72 tw:min-h-0 tw:flex-1", children: [
                    ...
                    Object.values(_t).filter((I) => B[I].length > 0).map((I, tt) => {
                      const N = B[I];
...
function kh({
  ...
  const $ = zt(
    s,
    "%webView_scope_selector_selected_text%"
  ), T = zt(s, "%webView_scope_selector_verse%"), B = zt(s, "%webView_scope_selector_chapter%"), P = zt(s, "%webView_scope_selector_book%"), D = zt(
    s,
    "%webView_scope_selector_current_verse%"
  ), F = zt(
    s,
    "%webView_scope_selector_current_chapter%"
  ), Y = zt(s, "%webView_scope_selector_current_book%"), K = zt(s, "%webView_scope_selector_choose_books%"), Q = zt(s, "%webView_scope_selector_scope%"), I = zt(s, "%webView_scope_selector_select_books%"), tt = zt(s, "%webView_scope_selector_range%"), N = zt(s, "%webView_scope_selector_select_range%"), z = zt(s, "%webView_scope_selector_range_start%"), G = zt(s, "%webView_scope_selector_range_end%"), nt = zt(s, "%webView_scope_selector_ok%"), rt = zt(s, "%webView_scope_selector_cancel%"), ut = zt(s, "%webView_scope_selector_navigate%"), lt = (O) => {
    if (!x) return;
  ...
  ], dt = (O, Z, kt = !1) => /* @__PURE__ */ u(ct, { children: [
    O,
    Z && !kt && /* @__PURE__ */ u("span", { className: "tw:text-muted-foreground", children: [
      ": ",
      Z
    ] })
  ] }), pt = e ? J.filter((O) => e.includes(O.value)) : J, ht = x ?? Sa, gt = p ?? ht, Jt = h ?? ht, ft = () => {
  }, At = U(null), Vt = U(null), vt = U(!1), Kt = U(null), Lt = U(!1), [Zt, ot] = _(void 0), bt = U(!1), Tt = U(!1), he = U(null), ae = L((O) => {
    if (O) {
    ...
    (O) => {
      g == null || g(O), f == null || f(O), bt.current = !0;
    },
    [g, f]
  ), Ht = L(
    (O) => {
      f == null || f(O), Tt.current = !0;
    },
    [f]
  ), ne = L(
    (O) => {
      r(O), O === "selectedBooks" && n.length === 0 && (x != null && x.book) && i([x.book]);
    },
    [r, n, x, i]
  ), oe = pt.find((O) => O.value === t), M = () => t === "selectedBooks" && n.length > 0 ? n.map((O) => O.toUpperCase()).join(", ") : t === "range" ? lc(gt, Jt, {
  ...
  ), Qt = pt.find((O) => O.value === "selectedBooks"), Bt = pt.find((O) => O.value === "range"), [fe, ie] = _(!1), [se, de] = _(void 0), [Ft, m] = _(void 0), [R, j] = _(void 0), [A, q] = _(void 0), [H, it] = _([]), mt = w === "dropdown" && se === "selectedBooks", St = /* @__PURE__ */ a(
    ku,
    {
      availableBookInfo: o,
  ...
  ), yt = Zt === "end", Ct = Zt === "start", Et = "tw:text-muted-foreground", Ut = w === "dropdown" && se === "range", Pr = Ut ? j : Te, Ar = Ut ? q : f ? Ht : ft, vr = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      /* @__PURE__ */ a(Nt, { htmlFor: "scope-range-start", className: v(yt && Et), children: z }),
      /* @__PURE__ */ a(
        za,
        {
    ...
    /* @__PURE__ */ u("div", { ref: At, className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ a(
        za,
        {
          ...
          localizedStrings: S,
          getEndVerse: y,
          disableReferencesUpTo: Ut ? R ?? gt : gt,
          onOpenChange: jt,
          onCloseAutoFocus: (O) => {
            var Z;
            Tt.current && (Tt.current = !1, O.preventDefault(), (Z = he.current) == null || Z.focus());
          },
          className: v(Ct && Et),
          modal: !0,
          align: "start"
  ...
  W(() => {
    ...
    return O.observe(Xe), () => O.disconnect();
  }, [Xe]);
  const jr = L(
    (O) => {
      m(O), j(gt), q(Jt), it(n), ie(!1), de(O);
    },
    [gt, Jt, n]
  ), Br = L(() => {
    Ft !== void 0 && (Ft === "range" ? (R && (g == null || g(R)), A && (f == null || f(A))) : Ft === "selectedBooks" && i(H), ne(Ft), de(void 0), m(void 0));
  }, [
    Ft,
    R,
    A,
    ...
    O || (de(void 0), m(void 0));
  }, []), et = L((O) => {
    var Z;
    O.preventDefault(), (Z = xr.current) == null || Z.focus();
  }, []), at = (O) => t === O ? /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }) : void 0;
  return /* @__PURE__ */ u("div", { id: d, className: "tw:grid tw:gap-4", children: [
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      w === "dropdown" ? /* @__PURE__ */ u(Ke, { open: fe, onOpenChange: ie, children: [
        ...
        /* @__PURE__ */ a(
          Ge,
          {
            ...
            children: /* @__PURE__ */ u(Ca, { container: Xe, children: [
              ge.map(({ value: O, label: Z, dropdownLabel: kt, scrRefSuffix: me, id: Gt }) => /* @__PURE__ */ u(
                Qe,
                {
                  ref: br(O),
                  ...
                  children: [
                    t === O && /* @__PURE__ */ a("span", { className: "tw:absolute tw:flex tw:h-3.5 tw:w-3.5 tw:items-center tw:justify-center tw:ltr:left-2 tw:rtl:right-2", children: /* @__PURE__ */ a(Ve, { className: "tw:h-4 tw:w-4" }) }),
                    dt(kt ?? Z, me, _a)
                  ]
                },
                Gt
              ...
              b && /* @__PURE__ */ u(ct, { children: [
                ...
                /* @__PURE__ */ a(
                  Qe,
                  {
                    ...
                    onSelect: (O) => {
                      var Z, kt;
                      if (O.preventDefault(), vt.current) {
                        vt.current = !1;
                        return;
                      }
                      Lt.current || (kt = (Z = Vt.current) == null ? void 0 : Z.querySelector("button")) == null || kt.click();
                    },
                    children: /* @__PURE__ */ a(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ a(
                          za,
                          {
                            ...
                            onCloseAutoFocus: (O) => {
                              var Z;
                              O.preventDefault(), (Z = Kt.current) == null || Z.focus();
                            },
                            modal: !0,
        ...
        co,
        {
          ...
          children: pt.map(({ value: O, label: Z, scrRefSuffix: kt, id: me }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(ea, { className: "tw:me-2", value: O, id: me }),
    ...
    w === "radio" && t === "range" && vr,
    w === "dropdown" && Qt && /* @__PURE__ */ a(Ba, { open: se === "selectedBooks", onOpenChange: k, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: xa,
        onCloseAutoFocus: et,
        onEscapeKeyDown: (O) => {
          Ye != null && Ye.querySelector('[data-state="open"]') && O.preventDefault();
        },
        children: /* @__PURE__ */ u(Ca, { container: Ye, children: [
          ...
          /* @__PURE__ */ u(Po, { children: [
            /* @__PURE__ */ a(X, { variant: "outline", onClick: () => k(!1), children: rt }),
            /* @__PURE__ */ a(X, { onClick: Br, children: nt })
          ] })
        ] })
      }
    ) }),
    w === "dropdown" && Bt && /* @__PURE__ */ a(Ba, { open: se === "range", onOpenChange: k, children: /* @__PURE__ */ a(
      Fa,
      {
        ref: Lr,
        onCloseAutoFocus: et,
        onEscapeKeyDown: (O) => {
          We != null && We.querySelector('[data-state="open"]') && O.preventDefault();
        },
  ...
  if (Tl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    switch (p.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (S = l.current) == null || S.focus(), Nr(l, [h, g]);
        break;
    }
  }), W(() => {
...
function Mh({
  ...
  const d = Bu(
    ...
    var S, y, C, E, $, T;
    const b = x !== f ? ((y = (S = t[f]) == null ? void 0 : S.uiNames) == null ? void 0 : y[x]) ?? ((E = (C = t[f]) == null ? void 0 : C.uiNames) == null ? void 0 : E.en) : void 0;
    return b ? `${($ = t[f]) == null ? void 0 : $.autonym} (${b})` : (T = t[f]) == null ? void 0 : T.autonym;
  };
