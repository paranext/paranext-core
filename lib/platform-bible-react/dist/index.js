...
import { includes as rr, Section as W, getChaptersForBook as yi, formatScrRef as be, getSectionForBook as Be, formatRelativeDate as ki, formatReplacementString as ge, sanitizeHtml as _i, NumberFormat as Ni, formatBytes as Ci, getCurrentLocale as Ei, usfmMarkers as lr, getFormatCallerFunction as Ti, deepEqual as Si, isString as Io, compareScrRefs as Kr, scrRefToBBBCCCVVV as Tr, getLocalizeKeyForScrollGroupId as Z } from "platform-bible-utils";
import Q, { forwardRef as Xe, useRef as U, useMemo as z, useState as S, useCallback as B, useLayoutEffect as Rt, createContext as br, useContext as io, useEffect as H, Component as Ri, createElement as Ao, Suspense as Di, Fragment as kn } from "react";
...
import { useReactTable as Ln, getFilteredRowModel as xs, getSortedRowModel as jn, getPaginationRowModel as ys, getCoreRowModel as zn, flexRender as Ke, getGroupedRowModel as ks, getExpandedRowModel as _s } from "@tanstack/react-table";
import * as yt from "@radix-ui/react-select";
import Ns from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Ur, HIDDEN_NOTE_CALLER as Hr, getDefaultViewOptions as Cs, isInsertEmbedOpOfType as or, Editorial as Es } from "@eten-tech-foundation/platform-editor";
...
const $s = Ut.Root, yd = Ut.Trigger, Ps = Ut.Portal, kd = Ut.Close;
function Vs({
  className: t,
  style: e,
  ref: r,
...
function F({
  ...
  return /* @__PURE__ */ o(n ? Ve : "button", { className: m(Un({ variant: e, size: r, className: t })), ref: a, ...i });
}
const Yt = Ue.Root, ue = Ue.Trigger, Ks = Ue.Anchor;
function Jt({
  className: t,
  align: e = "center",
  sideOffset: r = 4,
  ...
  const s = wt();
  return /* @__PURE__ */ o(Ue.Portal, { children: /* @__PURE__ */ o(
    Ue.Content,
    {
      ref: a,
      align: e,
...
function Ed({
  ...
  const w = wt(), [d, h] = S(!1), [f, u] = S(""), [g, v] = S(""), [b, x] = S("books"), [y, k] = S(void 0), [N, L] = S(!1), j = U(void 0), I = U(void 0), D = U(void 0), C = U(void 0), T = U({}), V = B(
    (R) => {
      e(R), l && l(R);
    },
    [e, l]
    ...
    (R) => {
      if (R.ctrlKey) return;
      const { isLetter: _, isDigit: P } = Ko(R.key);
      if (b === "chapters") {
        if (R.key === "Backspace") {
      ...
      if ((b === "chapters" || b === "books" && M) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(R.key)) {
        ...
        switch (R.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            tt = G === 0 ? nt : Math.max(1, G - mt);
            break;
          case "ArrowDown":
            tt = G === 0 ? 1 : Math.min(nt, G + mt);
            break;
          default:
            return;
        }
        tt !== G && (R.preventDefault(), R.stopPropagation(), u(Yr(q, a, tt)), setTimeout(() => {
    ...
    const { isLetter: _, isDigit: P } = Ko(R.key);
    (_ || P) && (R.preventDefault(), v((q) => q + R.key), I.current.focus(), L(!1));
  }, []);
  return Rt(() => {
    const R = setTimeout(() => {
      if (d && b === "books" && D.current && C.current) {
        const _ = D.current, P = C.current, q = P.offsetTop, G = _.clientHeight, nt = P.clientHeight, tt = q - G / 2 + nt / 2;
        _.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(Yr(t.book));
      ...
      de,
      {
        ...
        children: [
          b === "books" ? /* @__PURE__ */ p("div", { className: "tw:flex tw:items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw:flex tw:items-center tw:gap-1 tw:border-b tw:pe-2", children: pt.map(({ onClick: R, disabled: _, title: P, icon: q }) => /* @__PURE__ */ o(
              F,
              {
                variant: "ghost",
                size: "sm",
          ...
          !N && /* @__PURE__ */ p(pe, { ref: D, children: [
              ...
              !M && Object.entries(Y).map(([R, _]) => {
                if (_.length !== 0)
                  return (
                    ...
                    /* @__PURE__ */ o(Ht, { heading: Kt(R), children: _.map((P) => /* @__PURE__ */ o(
                      Gn,
                      {
                        bookId: P,
                        onSelect: (q) => Ct(q),
...
function Jr({
  ...
  return /* @__PURE__ */ o(
    qr.Item,
    {
      ...
      ...r,
      children: /* @__PURE__ */ o(qr.Indicator, { className: "tw:flex tw:items-center tw:justify-center", children: /* @__PURE__ */ o(ao, { className: "tw:h-3.5 tw:w-3.5 tw:fill-primary" }) })
    }
  );
}
function Ys(t) {
...
function Xr({
  ...
  const [k, N] = S(!1), L = w ?? c, j = (D) => D.length > 0 && typeof D[0] == "object" && "options" in D[0], I = (D, C) => {
  ...
  return /* @__PURE__ */ p(Yt, { open: k, onOpenChange: N, ...y, children: [
...
function Qs({ initialConfig: t, children: e }) {
  const r = z(() => {
    const { theme: n, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, w = Xs(null, n), d = _n({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (h) => s(h, d), theme: n });
    return function(h, f) {
      if (f !== null) {
...
function Tt({
  ...
  return /* @__PURE__ */ o(
    ...
    {
      ref: r,
      className: e ? m(Un({ variant: e }), t) : t,
      ...n
    }
  );
}
...
function ll() {
  return function(t) {
    const [e] = Bt(), r = z(() => t(e), [e, t]), [n, a] = S(() => r.initialValueFn()), i = U(n);
    return il(() => {
...
Ft({ build: (t, e, r) => _r(e), config: Ze({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, r) {
  const n = r.getOutput();
...
Ft({ build: (t, e, r) => _r(e), config: Ze({ $onClear: ta }), name: "@lexical/extension/ClearEditor", register(t, e, r) {
...
class ra extends Gr {
  $config() {
    return this.config("decorator-text", { extends: Gr, stateConfigs: [{ flat: !0, stateConfig: Mr }] });
  }
  getFormat() {
    return Hi(this, Mr);
  }
...
const Nl = Ft({ config: Ze({ setOptions: Wo, updateOptions: Wo }), init: ({ $initialEditorState: t = _l }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: r }, n) {
...
}, name: "@lexical/extension/InitialState", nodes: [Vi, Cn, Li, ji, Nn] }), Yo = Symbol.for("@lexical/extension/LexicalBuilder");
function Jo() {
}
function Cl(t) {
  throw t;
...
class Ge {
  ...
  static maybeFromEditor(e) {
    const r = e[Yo];
    return r && (r.PACKAGE_VERSION !== $r && et(292, r.PACKAGE_VERSION, $r), r instanceof Ge || et(293)), r;
  }
  static fromEditor(e) {
    const r = Ge.maybeFromEditor(e);
    return r === void 0 && et(294), r;
  }
  constructEditor() {
    const { $initialEditorState: e, onError: r, ...n } = this.buildCreateEditorArgs(), a = Object.assign(_n({ ...n, ...r ? { onError: (i) => {
      r(i, a);
    } } : {} }), { [Yo]: this });
  ...
  return ae(t.registerCommand(Bi, (s) => {
    if (Ki(s.target)) {
      ...
      if (Sl(l)) return function(c, w = !1) {
        ...
        let u;
        w && Dn(d) ? u = d : (u = Gi(), Ui(u)), h ? u.delete(f) : u.add(f);
      }(l, s.shiftKey), !0;
    }
    return !1;
...
Ft({ build: (t, e, r) => _r(e), config: Ze({ $canIndent: la, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, r) {
...
Ft({ build: (t, e, r) => _r(e), config: Ze({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, r) => ie(() => r.getOutput().disabled.value ? void 0 : wa(t)) });
function Al(t, ...e) {
  const r = new URL("https://lexical.dev/docs/error"), n = new URLSearchParams();
  n.append("code", t);
  for (const a of e) n.append("v", a);
...
function Bl({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: r, ariaControls: n, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: d, ariaOwns: h, ariaRequired: f, autoCapitalize: u, className: g, id: v, role: b = "textbox", spellCheck: x = !0, style: y, tabIndex: k, "data-testid": N, ...L }, j) {
...
function Gl(t, e) {
  ...
  return p(at, { children: [o(Kl, { editor: a, ...n, ref: e }), r != null && o(Ul, { editor: a, content: r })] });
}
...
function Dd({
  ...
  const [a, i] = S(sc), [s, l] = S(void 0), [c, w] = S(!1), d = U(void 0), h = U(null);
  H(() => {
    let x = !0;
    const y = h.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw:flex tw:gap-2", children: [
        /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
          ...
          /* @__PURE__ */ o(Nt, { children: /* @__PURE__ */ o("p", { children: v }) })
        ] }) }),
        /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
          ...
          /* @__PURE__ */ o(Nt, { children: /* @__PURE__ */ o("p", { children: g }) })
        ] }) })
      ] })
    ] }),
...
const Md = Object.freeze([
  ...
  const a = U(null), [i, s] = S(void 0), [l, c] = S(void 0), w = B(
    (u) => {
      s(u);
    ...
    (u) => {
      ...
      switch (u.key) {
        case "ArrowDown":
          L = Math.min(N + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          L = Math.max(N - 1, 0), u.preventDefault();
          break;
        case "Home":
...
function Ad({
  ...
  return /* @__PURE__ */ o(
    ...
    {
      ref: e,
      className: m("pr-twp tw:font-semibold tw:leading-none tw:tracking-tight", t),
      ...r,
      children: r.children
    }
  );
...
function en({
  ...
  const u = B(
    (N) => {
      N && N.stopPropagation(), w(!1), h(void 0), s == null || s(!1);
    },
    [s]
  ), g = B(
    async (N) => {
    ...
    const N = new Date(t.date), L = ki(
      N,
      r["%comment_date_today%"],
      r["%comment_date_yesterday%"]
    ), j = N.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    [t.user]
  ), y = z(() => _i(t.contents), [t.contents]), k = z(() => {
    if (n && l)
      return /* @__PURE__ */ p(at, { children: [
        /* @__PURE__ */ p(
          ro,
          {
            onClick: (N) => {
              N.stopPropagation(), w(!0), h(ic(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-1 tw:flex-col tw:gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: f,
              onKeyDownCapture: (N) => {
                N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), u()) : xo(N) && (N.preventDefault(), N.stopPropagation(), It(d) && g());
              },
              onKeyDown: (N) => {
                vo(N), (N.key === "Enter" || N.key === " ") && N.stopPropagation();
              },
              onClick: (N) => {
                N.stopPropagation();
              },
...
function kc({
  ...
  const [I, D] = S(rn), [C, T] = S(
    void 0
  ), V = n, [$, O] = S(!1), [A, Y] = S(!1), [M, J] = S(!1), [Ct, Dt] = S(!1), [St, pt] = S(!1), [lt, K] = S(N), [rt, ot] = S(!1), it = U(void 0), [bt, Kt] = S(/* @__PURE__ */ new Map());
  H(() => {
    let E = !0;
    return (async () => {
  ...
  const qt = z(() => Pt[0], [Pt]), Ne = U(null), Zt = U(void 0), Gt = B(() => {
    var E;
  ...
  }, [i, r]), P = z(() => Pt.slice(1), [Pt]), q = z(() => P.length ?? 0, [P.length]), G = z(() => q > 0, [q]), nt = z(() => $ || q <= 2 ? P : P.slice(-2), [P, q, $]), tt = z(() => $ || q <= 2 ? 0 : q - 2, [q, $]), mt = z(
  ...
  const Et = B(
    async (E) => {
      ...
      gt && await h({ threadId: c, contents: gt }) && Gt();
    },
    [
      Gt,
      I,
      ...
      children: /* @__PURE__ */ p(uc, { className: "tw:flex tw:flex-col tw:gap-2 tw:p-0", children: [
        /* @__PURE__ */ p("div", { className: "tw:flex tw:flex-col tw:content-center tw:items-start tw:gap-4", children: [
          /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-2", children: [
            _ && /* @__PURE__ */ o(We, { className: "tw:rounded-sm tw:bg-input tw:text-sm tw:font-normal tw:text-primary tw:hover:bg-input", children: _ }),
            /* @__PURE__ */ o(
              F,
              {
                variant: "ghost",
                ...
                children: lt ? /* @__PURE__ */ o(Ga, {}) : /* @__PURE__ */ o(Ua, {})
              }
            ),
        ...
        /* @__PURE__ */ p(at, { children: [
          G && !n && /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center tw:gap-5", children: [
...
function jd({
  ...
  const [x, y] = S(/* @__PURE__ */ new Set()), [k, N] = S();
  H(() => {
  ...
  const L = r.filter(
    ...
    (O) => {
      y((A) => new Set(A).add(O.id)), N(O.id), v == null || v(O.id);
    },
    [v]
  ), D = B(
    (O) => {
    ...
    (O) => {
      O.key === "Escape" ? (k && x.has(k) && (y((A) => {
        const Y = new Set(A);
        return Y.delete(k), Y;
      }), N(void 0), v == null || v(void 0)), O.preventDefault(), O.stopPropagation()) : V(O);
    },
    [k, x, V, v]
  );
  return /* @__PURE__ */ o(
...
function _c({ table: t }) {
  return /* @__PURE__ */ p(se, { children: [
    ...
    /* @__PURE__ */ p(le, { align: "end", className: "tw:w-[150px]", children: [
      /* @__PURE__ */ o(Nr, { children: "Toggle columns" }),
      /* @__PURE__ */ o(tr, {}),
...
const Me = yt.Root, Nc = yt.Group, Oe = yt.Value, Cc = ce(
...
function Ic({
  ...
  return c ? L = Array.from({ length: 10 }).map((C, T) => `skeleton-row-${T}`).map((C) => /* @__PURE__ */ o(te, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ o(Se, { colSpan: N.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ o("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ o(oo, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((j = k.getRowModel().rows) == null ? void 0 : j.length) > 0 ? L = k.getRowModel().rows.map((I) => /* @__PURE__ */ o(
    ...
    a && /* @__PURE__ */ o(_c, { table: k }),
    /* @__PURE__ */ p(ko, { stickyHeader: i, children: [
      /* @__PURE__ */ o(_o, { stickyHeader: i, children: k.getHeaderGroups().map((I) => /* @__PURE__ */ o(te, { children: I.headers.map((D) => /* @__PURE__ */ o(mr, { className: "tw:p-0", children: D.isPlaceholder ? void 0 : Ke(D.column.columnDef.header, D.getContext()) }, D.id)) }, I.id)) }),
      /* @__PURE__ */ o(No, { children: L })
    ] }),
...
function qd({
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: /* @__PURE__ */ o(Ns, { options: i, children: e })
    }
  );
}
...
function Hd({ id: t, label: e, groups: r }) {
  ...
  return /* @__PURE__ */ o("div", { id: t, children: /* @__PURE__ */ p(se, { children: [
    ...
    /* @__PURE__ */ o(le, { children: r.map((w, d) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ o(Nr, { children: w.label }),
...
function zc({
  ...
  return /* @__PURE__ */ p(at, { children: [
    ...
    e && /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
      /* @__PURE__ */ o(Tt, { asChild: !0, children: /* @__PURE__ */ o(
        F,
        {
          "aria-label": "Redo",
...
function Kc({
  ...
  const i = U(null), s = U(null), l = U(!1), [c, w] = S(t), [d, h] = S(r), [f, u] = S(!1);
  H(() => {
    w(t);
  }, [t]), H(() => {
    d !== r && h(r);
  ...
  const g = (b) => {
    ...
    var x, y, k, N;
    b.stopPropagation(), document.activeElement === s.current && b.key === "ArrowDown" || b.key === "ArrowRight" ? ((x = i.current) == null || x.focus(), l.current = !0) : document.activeElement === i.current && b.key === "ArrowUp" ? ((y = s.current) == null || y.focus(), l.current = !1) : document.activeElement === i.current && b.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((N = s.current) == null || N.focus(), l.current = !1), c === "custom" && b.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ p(se, { open: f, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ p(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ o(Nr, { children: a["%footnoteEditor_callerDropdown_label%"] }),
          /* @__PURE__ */ o(tr, {}),
          /* @__PURE__ */ o(
            oe,
            {
              ...
              children: /* @__PURE__ */ p("div", { className: "tw:flex tw:w-full tw:justify-between", children: [
                ...
                /* @__PURE__ */ o("span", { className: "tw:w-10 tw:text-center", children: Ur })
              ] })
            }
          ),
          /* @__PURE__ */ o(
...
function Uc({
  ...
  return /* @__PURE__ */ p(se, { children: [
    /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
      ...
      /* @__PURE__ */ o(Nt, { children: /* @__PURE__ */ o("p", { children: Gc(t, r) }) })
    ] }) }),
    /* @__PURE__ */ p(le, { style: { zIndex: Fn }, children: [
      /* @__PURE__ */ o(Nr, { children: r["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ o(tr, {}),
      /* @__PURE__ */ p(
        oe,
        {
...
function Xd({
  ...
  const d = U(null), h = U(null), f = U(null), u = U(null);
  Rt(() => {
    if (!u.current) return;
    const { width: _ } = u.current.getBoundingClientRect();
    _ > 0 && (u.current.style.width = `${_}px`);
  }, []);
  const [g, v] = S("generated"), [b, x] = S("*"), [y, k] = S("f"), [N, L] = S(!1), [j, I] = S(!0), [D, C] = S(!1), T = U(!1), V = U(""), [$, O] = S(!1), [A, Y] = S(), [M, J] = S(), [Ct, Dt] = S(), [St, pt] = S(), lt = U(null), K = z(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  H(() => {
    ...
    if (P && or("note", P)) {
      ...
      let tt = "custom";
      nt === Ur ? tt = "generated" : nt === Hr ? tt = "hidden" : nt && x(nt), v(tt), k(((G = P.insert.note) == null ? void 0 : G.style) ?? "f"), _ = setTimeout(() => {
        var mt;
  ...
  const ot = B(
    (_, P, q = !1) => {
      var nt, tt, mt;
      const G = (tt = (nt = d.current) == null ? void 0 : nt.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (G && or("note", G)) {
        if (G.insert.note) {
          let st;
          _ === "custom" ? st = P : _ === "generated" ? st = Ur : st = Hr, G.insert.note.caller = st;
        }
        r == null || r([G]), q && w && i && ((mt = w.current) == null || mt.replaceEmbedUpdate(i, [G]));
      }
    },
    [i, r, w]
  ), it = B(() => {
  ...
  const Kt = U({ book: a.book, chapterNum: a.chapterNum });
  Rt(() => {
    (Kt.current.book !== a.book || Kt.current.chapterNum !== a.chapterNum) && (Kt.current = { book: a.book, chapterNum: a.chapterNum }, bt.current());
  }, [a.book, a.chapterNum]);
  const Pt = () => {
    var P;
    const _ = (P = h.current) == null ? void 0 : P.getElementsByClassName("editor-input")[0];
    ...
    var q, G, nt, tt, mt;
    k(_);
    const P = (G = (q = d.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : G.at(0);
    if (P && or("note", P)) {
      P.insert.note && (P.insert.note.style = _);
      const st = (tt = (nt = P.insert.note) == null ? void 0 : nt.contents) == null ? void 0 : tt.ops;
      y !== "x" && _ === "x" ? st == null || st.forEach((Et) => Xc(Et)) : y === "x" && _ !== "x" && (st == null || st.forEach((Et) => Zc(Et))), (mt = d.current) == null || mt.applyUpdate([P, { delete: 1 }]);
    }
  }, Gt = (_) => {
    pt(_.contextMarker), C(_.canRedo);
  }, je = B(
    (_) => {
      var q, G, nt, tt, mt;
      const P = (G = (q = d.current) == null ? void 0 : q.getNoteOps(0)) == null ? void 0 : G.at(0);
    ...
    if (f.current && rt.length && _ && _.rangeCount > 0) {
      const P = _.getRangeAt(0).getBoundingClientRect(), q = f.current.getBoundingClientRect();
  ...
  return H(() => {
    ...
    var q;
    const _ = ((q = h.current) == null ? void 0 : q.querySelector(".editor-input")) ?? void 0, P = (G) => {
      !$ && _ && document.activeElement === _ && G.key === l ? (G.preventDefault(), R()) : $ && G.key === "Escape" && (G.preventDefault(), O(!1));
    };
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw:absolute tw:bottom-0 tw:right-0", children: /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
              /* @__PURE__ */ o(Tt, { asChild: !0, children: /* @__PURE__ */ o(
                F,
                {
                  onClick: Pt,
...
function Qd({
  ...
  const d = c ?? Ti(r, void 0), h = (y, k) => {
    w == null || w(y, k, a);
  }, f = i ? r.findIndex((y) => y === i) : -1, [u, g] = S(f), v = (y, k, N) => {
    if (r.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function nw({
  ...
  return /* @__PURE__ */ p(ko, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(_o, { stickyHeader: !0, children: /* @__PURE__ */ p(te, { children: [
      /* @__PURE__ */ o(mr, { children: a }),
      /* @__PURE__ */ o(mr, { children: i })
    ] }) }),
    /* @__PURE__ */ o(No, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ p(
      te,
      {
        onClick: () => {
          e(l.reference);
...
}, Cr = (t, e, r) => /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
  /* @__PURE__ */ p(
    Tt,
    {
...
function sp({
  ...
  const u = Vt(r, "%webView_inventory_all%"), g = Vt(r, "%webView_inventory_approved%"), v = Vt(r, "%webView_inventory_unapproved%"), b = Vt(r, "%webView_inventory_unknown%"), x = Vt(r, "%webView_inventory_scope_currentBook%"), y = Vt(r, "%webView_inventory_scope_chapter%"), k = Vt(r, "%webView_inventory_scope_verse%"), N = Vt(r, "%webView_inventory_filter_text%"), L = Vt(
    r,
    "%webView_inventory_show_additional_items%"
  ...
  return /* @__PURE__ */ o("div", { id: w, className: "pr-twp tw:h-full tw:overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw:flex tw:h-full tw:w-full tw:min-w-min tw:flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw:flex tw:items-stretch", style: { contain: "inline-size" }, children: [
      ...
      n && /* @__PURE__ */ o(kt, { children: /* @__PURE__ */ p(_t, { children: [
        ...
        /* @__PURE__ */ o(Nt, { children: (n == null ? void 0 : n.checkboxText) ?? L })
      ] }) })
    ] }),
...
const ww = "16rem", dw = "3rem", Na = Q.createContext(void 0);
function Er() {
...
function pw({
  ...
  const [w, d] = Q.useState(t), h = e ?? w, f = Q.useCallback(
    (k) => {
      const N = typeof k == "function" ? k(h) : k;
      r ? r(N) : d(N);
    },
    [r, h]
  ...
  return /* @__PURE__ */ o(Na.Provider, { value: y, children: /* @__PURE__ */ o(kt, { delayDuration: 0, children: /* @__PURE__ */ o(
    "div",
    {
      style: (
...
const Qt = "scrBook", yw = "scrRef", me = "source", kw = "details", _w = "Scripture Reference", Nw = "Scripture Book", Ca = "Type", Cw = "Details";
function Ew(t, e) {
  const r = e ?? !1;
  return [
    {
    ...
    !e && /* @__PURE__ */ p(
      Me,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Ae, { position: "item-aligned", children: /* @__PURE__ */ o(Nc, { children: N.map((C) => /* @__PURE__ */ o(Ot, { value: JSON.stringify(C.value), children: C.label }, C.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(ko, { className: "tw:relative tw:flex tw:flex-col tw:overflow-y-auto tw:p-0", children: [
      e && /* @__PURE__ */ o(_o, { children: x.getHeaderGroups().map((C) => /* @__PURE__ */ o(te, { children: C.headers.filter((T) => T.column.columnDef.header).map((T) => (
      ...
      /* @__PURE__ */ o(No, { children: x.getRowModel().rows.map((C, T) => {
        const V = wt();
        return /* @__PURE__ */ o(
          te,
          {
...
function Rw({
  ...
  }, [b, x] = S(!1), [y, k] = S(""), N = U(void 0), L = U(!1);
  ...
  const j = z(() => ct.allBookIds.filter(
    ...
    (A, Y = !1) => {
      ...
      const M = j.findIndex((pt) => pt === N.current), J = j.findIndex((pt) => pt === A);
      if (M === -1 || J === -1) return;
      const [Ct, Dt] = [
        Math.min(M, J),
        Math.max(M, J)
    ...
    /* @__PURE__ */ p("div", { className: "tw:grid tw:gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Hn,
        {
          ...
          children: x.map(({ value: y, label: k, id: N }) => /* @__PURE__ */ p("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ o(Jr, { className: "tw:me-2", value: y, id: N }),
            /* @__PURE__ */ o(ut, { htmlFor: N, children: k })
          ] }, N))
        }
      )
    ] }),
  ...
  return /* @__PURE__ */ o(
    jt.Trigger,
    {
      ...
      className: m(
        ...
        // CUSTOM
        "pr-twp",
        _e({ variant: n.variant, className: t })
        // CUSTOM use context to add variants
      ),
      ...r
    }
  ...
  return /* @__PURE__ */ o(
    jt.Item,
    {
      ...
      className: m(
        ...
        e && "tw:pl-8",
        _e({ variant: a.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...n
...
function zw({
  ...
  const a = U(void 0), i = U(void 0), s = U(void 0), l = U(void 0), c = U(void 0), w = (d) => {
    switch (d) {
      case "platform.app":
        return i;
...
function Ap({
  ...
  const w = Fw(
    ...
    var x, y, k, N, L, j;
    const b = v !== g ? ((y = (x = t[g]) == null ? void 0 : x.uiNames) == null ? void 0 : y[v]) ?? ((N = (k = t[g]) == null ? void 0 : k.uiNames) == null ? void 0 : N.en) : void 0;
...
const Fp = ft.Root, Bp = ft.Trigger, Kp = ft.Group, qp = ft.Portal, Gp = ft.Sub, Up = ft.RadioGroup;
function Hp({
  className: t,
  inset: e,
  children: r,
...
const ou = we.Trigger, Gw = we.Portal, nu = we.Close;
function Uw({
  className: t,
  ref: e,
  ...r
...
function fu({
  ...
  return /* @__PURE__ */ p(
    nr.Root,
    {
      ...
      dir: n,
      children: [
        /* @__PURE__ */ o(nr.Track, { className: "tw:relative tw:h-1.5 tw:w-full tw:grow tw:overflow-hidden tw:rounded-full tw:bg-primary/20", children: /* @__PURE__ */ o(nr.Range, { className: "tw:absolute tw:h-full tw:bg-primary" }) }),
        /* @__PURE__ */ o(nr.Thumb, { className: "tw:block tw:h-4 tw:w-4 tw:rounded-full tw:border tw:border-primary/50 tw:bg-background tw:shadow tw:transition-colors tw:focus-visible:outline-none tw:focus-visible:ring-1 tw:focus-visible:ring-ring tw:disabled:pointer-events-none tw:disabled:opacity-50" })
      ]
    }
  );
}
...
export {
  ...
  Gd as ERROR_POPOVER_STRING_KEYS,
