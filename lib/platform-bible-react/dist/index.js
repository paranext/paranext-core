...
import { useReactTable as Je, getFilteredRowModel as Sr, getSortedRowModel as Ke, getPaginationRowModel as Rr, getCoreRowModel as We, flexRender as It, getGroupedRowModel as Tr, getExpandedRowModel as _r } from "@tanstack/react-table";
import * as j from "@radix-ui/react-select";
import * as Ze from "@radix-ui/react-separator";
import zr from "markdown-to-jsx";
...
const ke = B.Trigger, tn = B.Group, Vr = B.Portal, Ar = B.Sub, Wo = B.RadioGroup;
function Jt({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Ne.Provider, { value: n, children: /* @__PURE__ */ r(B.Root, { ...e }) });
}
...
Ce.displayName = B.Item.displayName;
...
Se.displayName = B.CheckboxItem.displayName;
const rn = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  ...
  return /* @__PURE__ */ d(
    B.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(B.ItemIndicator, { children: /* @__PURE__ */ r(ve, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
...
var Pr = Object.defineProperty, Xr = (t, e, n) => e in t ? Pr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, R = (t, e, n) => Xr(t, typeof e != "symbol" ? e + "" : e, n);
const ht = [
  "GEN",
  "EXO",
  "LEV",
...
const Y = class z {
  constructor(e, n, a, o) {
    if (R(this, "firstChapter"), R(this, "lastChapter"), R(this, "lastVerse"), R(this, "hasSegmentsDefined"), R(this, "text"), R(this, "BBBCCCVVVS"), R(this, "longHashCode"), R(this, "versification"), R(this, "rtlMark", "‏"), R(this, "_bookNum", 0), R(this, "_chapterNum", 0), R(this, "_verseNum", 0), R(this, "_verse"), a == null && o == null)
      if (e != null && typeof e == "string") {
        ...
        this.setEmpty(i), this._verseNum = e % z.chapterDigitShifter, this._chapterNum = Math.floor(
        ...
        if (e != null && e instanceof z) {
          ...
          if (e == null) return;
          const i = e instanceof pt ? e : z.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return w && (p = new pt(w)), n ? new z(n, a.toString(), s, p) : new z();
  }
  /**
  ...
  allVerses(e = !1, n = z.verseRangeSeparators, a = z.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], i = Ge(this._verse, a);
    for (const w of i.map((s) => Ge(s, n))) {
      const s = this.clone();
      s.verse = w[0];
      const p = s.verseNum;
...
const ze = X.allBookIds.filter((t) => !X.isObsolete(X.bookIdToNumber(t))), Zr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, $e = ["OT", "NT", "DC"], Qr = 96, ta = [
...
function Qo({
  ...
  const o = F(), [i, w] = P(""), [s, p] = P(t.book), [u, g] = P(t.chapterNum ?? 0), [b, h] = P(t.book), [m, f] = P(!1), [k, C] = P(m), y = K(void 0), x = K(void 0), E = K(void 0), $ = tt(
    (S) => {
      const D = a ? a() : ze;
      return {
        ...
        const v = X.bookIdToEnglishName(O).toLowerCase(), _ = i.replace(/[^a-zA-Z]/g, "").toLowerCase();
    ...
    ta.forEach((S) => {
      const D = S.exec(i);
      if (D) {
        const [O, v = void 0, _ = void 0] = D.slice(1), Z = ra(O);
  ...
  return wt(() => {
    s === b ? s === t.book ? g(t.chapterNum) : g(1) : g(0);
  }, [b, t.book, t.chapterNum, s]), je(() => {
    C(m);
  }, [m]), je(() => {
    const S = setTimeout(() => {
      if (k && x.current && E.current && !i) {
        const O = E.current.offsetTop - Qr;
  ...
  }, [k, i]), /* @__PURE__ */ r("div", { className: "pr-twp tw-flex tw-bg-transparent", children: /* @__PURE__ */ d(Jt, { modal: !1, open: m, onOpenChange: dt, children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(
      Ir,
      {
        ...
        handleKeyDown: A,
        handleOnClick: () => {
          p(t.book), h(t.book), g(t.chapterNum > 0 ? t.chapterNum : 0), f(!0), w(mt(t, "English")), y.current.focus();
        },
        onFocus: () => {
          lt.current = !0;
        },
      ...
      Xt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: $e.map((S, D) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Kt, { className: "tw-font-semibold tw-text-foreground/80", children: Zr[S] }),
...
const aa = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? St : "button", { className: l(aa({ variant: e, size: n, className: t })), ref: i, ...o })
);
I.displayName = "Button";
const oa = vt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), G = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(qe.Root, { ref: n, className: l("pr-twp", oa(), t), ...e }));
...
const ue = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Bt.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Bt.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(ve, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
ue.displayName = Bt.Item.displayName;
...
const sa = rt.Portal, mn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Overlay,
  {
    ref: n,
    className: l(
...
const ia = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
...
ia.displayName = rt.Content.displayName;
...
wa.displayName = rt.Title.displayName;
...
la.displayName = rt.Description.displayName;
...
const Be = c.forwardRef((t, e) => /* @__PURE__ */ r(H.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Be.displayName = H.Empty.displayName;
...
da.displayName = H.Separator.displayName;
    ...
    /* @__PURE__ */ r(
      Ee,
      {
        ...
        children: /* @__PURE__ */ d(De, { children: [
          ...
          /* @__PURE__ */ r(Be, { children: b }),
          /* @__PURE__ */ r(Ie, { children: e.map((x) => /* @__PURE__ */ d(
            Ve,
            {
              value: s(x),
              onSelect: () => {
...
var ua = /* @__PURE__ */ ((t) => (t.CURRENT_BOOK = "current book", t.CHOOSE_BOOKS = "choose books", t))(ua || {});
...
const yt = j.Root, ha = j.Group, Nt = j.Value, gt = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = F();
  return /* @__PURE__ */ d(
    j.Trigger,
    {
...
ga.displayName = j.Label.displayName;
...
fa.displayName = j.Separator.displayName;
function ba({ table: t }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        yt,
        {
          ...
          children: [
            /* @__PURE__ */ r(gt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(Nt, { placeholder: t.getState().pagination.pageSize }) }),
...
function At(t) {
  return Array.from(t.querySelectorAll(va)).filter(
    (e) => !e.hasAttribute("disabled") && !e.getAttribute("aria-hidden") && xa(e)
  );
}
    ...
    const n = (a) => {
      if (e.contains(document.activeElement)) {
        if (a.key === "ArrowRight" || a.key === "ArrowLeft") {
          ...
          const o = t.current ? At(t.current) : [], i = o.indexOf(document.activeElement), w = a.key === "ArrowRight" ? i + 1 : i - 1;
...
const at = c.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: a, ...o }, i) => {
...
const bt = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
function Ca({
  ...
  var C;
  const [s, p] = P([]), [u, g] = P([]), [b, h] = P({}), [m, f] = P({}), k = Je({
    data: e,
    columns: t,
    getCoreRowModel: We(),
    ...n && { getPaginationRowModel: Rr() },
    onSortingChange: p,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    o && /* @__PURE__ */ r(ma, { table: k }),
    /* @__PURE__ */ d(Ft, { stickyHeader: i, children: [
      /* @__PURE__ */ r(Wt, { stickyHeader: i, children: k.getHeaderGroups().map((y) => /* @__PURE__ */ r(at, { children: y.headers.map((x) => /* @__PURE__ */ r(Ot, { children: x.isPlaceholder ? void 0 : It(x.column.columnDef.header, x.getContext()) }, x.id)) }, y.id)) }),
      /* @__PURE__ */ r(Gt, { children: (C = k.getRowModel().rows) != null && C.length ? k.getRowModel().rows.map((y) => /* @__PURE__ */ r(
        at,
        {
          ...
          children: y.getVisibleCells().map((x) => /* @__PURE__ */ r(bt, { children: It(x.column.columnDef.cell, x.getContext()) }, x.id))
        },
        y.id
      )) : /* @__PURE__ */ r(at, { children: /* @__PURE__ */ r(bt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: "No results." }) }) })
    ] }),
    ...
    n && a && /* @__PURE__ */ r(ba, { table: k })
  ] });
}
const Zt = c.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...a }, o) => /* @__PURE__ */ r(
  Ze.Root,
  {
    ref: o,
    decorative: n,
...
Zt.displayName = Ze.Root.displayName;
function ns({
  dictionaryEntry: t,
  backToListButton: e,
  definitionLabel: n,
...
function bn({ dictionaryEntry: t, handleEntryClick: e }) {
  return /* @__PURE__ */ r(
    at,
    {
      ...
      children: /* @__PURE__ */ d(bt, { colSpan: 100, className: "tw-p-2", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-items-baseline tw-gap-2", children: [
...
function rs({ dictionaryData: t, handleEntryClick: e }) {
...
const $t = Ht(({ className: t, ...e }, n) => /* @__PURE__ */ r(ar, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function ws({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: l("pr-twp tw-prose", n), children: /* @__PURE__ */ r(zr, { options: o, children: e }) });
}
const Sa = Ht((t, e) => /* @__PURE__ */ d(
  I,
  {
    ref: e,
...
function ls({ id: t, groups: e }) {
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Jt, { children: [
    /* @__PURE__ */ r(ke, { asChild: !0, children: /* @__PURE__ */ r(Sa, {}) }),
    /* @__PURE__ */ r(Xt, { children: e.map((n) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r(Kt, { children: n.label }),
      /* @__PURE__ */ r(tn, { children: n.items.map((a) => /* @__PURE__ */ r("div", { children: a.itemType === 0 ? /* @__PURE__ */ r(Se, { onClick: a.onClick, children: a.label }) : /* @__PURE__ */ r(rn, { onClick: a.onClick, value: a.label, children: a.label }) }, a.label)) }),
      /* @__PURE__ */ r(jt, {})
    ] }, n.label)) })
  ] }) });
}
function ds({ id: t, message: e }) {
...
function cs({ id: t, category: e, downloads: n, languages: a, moreInfoUrl: o }) {
  const i = new kr("en", {
    notation: "compact",
...
function Ta({ id: t, versionHistory: e }) {
  ...
  function i(s) {
    const p = new Date(s), u = new Date(o.getTime() - p.getTime()), g = u.getUTCFullYear() - 1970, b = u.getUTCMonth(), h = u.getUTCDate() - 1;
    let m = "";
...
function ps({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "tw-border-t tw-pb-4 tw-pt-4", children: /* @__PURE__ */ d("div", { className: "tw-md:flex-row tw-md:space-x-8 tw-flex tw-flex-col tw-space-x-0", children: [
    /* @__PURE__ */ r(Ta, { versionHistory: o }),
...
const _a = vt(
  ...
  ({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, className: l("pr-twp", _a({ variant: e }), t), ...n })
);
...
function Ea({
  ...
  const a = n["%webView_inventory_occurrences_table_header_reference%"], o = n["%webView_inventory_occurrences_table_header_occurrence%"], i = W(() => {
    const w = [];
    return t.forEach((s) => {
  ...
  return /* @__PURE__ */ d(Ft, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Gt, { children: i.length > 0 && i.map((w) => /* @__PURE__ */ d(
      at,
      {
        onClick: () => {
          e(w.reference);
        ...
        children: [
          /* @__PURE__ */ r(bt, { children: `${X.bookIdToEnglishName(w.reference.book)} ${w.reference.chapterNum}:${w.reference.verseNum}` }),
          /* @__PURE__ */ r(bt, { children: w.text })
        ]
      },
...
), Da = c.forwardRef(({ className: t, variant: e, size: n, ...a }, o) => /* @__PURE__ */ r(
  Qe.Root,
  {
    ref: o,
...
Da.displayName = Qe.Root.displayName;
...
const Lt = c.forwardRef(({ className: t, children: e, variant: n, size: a, ...o }, i) => {
...
const Qt = (t) => t === "asc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ms = (t) => ({
  accessorKey: "item",
  ...
  return e ? e[1] : "";
}, Ia = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", xs = Object.freeze([
...
function ys({
  ...
  const u = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), b = st(n, "%webView_inventory_unapproved%"), h = st(n, "%webView_inventory_unknown%"), m = st(n, "%webView_inventory_scope_currentBook%"), f = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_filter_text%"), C = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [y, x] = P(!1), [E, $] = P("all"), [q, lt] = P(""), [dt, N] = P([]), T = W(() => t.length === 0 ? [] : Va(t, o, i), [t, o, i]), L = W(() => {
    if (y) return T;
    const v = [];
    return T.forEach((_) => {
    ...
    for (let xt = 0; xt < v; xt++)
      _.push(
        Ma(
          ((ct = a == null ? void 0 : a.tableHeaders) == null ? void 0 : ct[xt]) || "Additional Item",
          xt + 1
        )
      );
    return [..._, ...p];
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        yt,
        {
          ...
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(gt, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select filter" }) }),
      ...
      /* @__PURE__ */ d(yt, { onValueChange: (v) => S(v), defaultValue: w, children: [
        /* @__PURE__ */ r(gt, { className: "tw-m-1", children: /* @__PURE__ */ r(Nt, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ft, { children: [
...
const Oe = Pt.Provider, Pe = Pt.Root, Xe = Pt.Trigger, te = c.forwardRef(({ className: t, sideOffset: e = 4, ...n }, a) => /* @__PURE__ */ r(
  Pt.Content,
  {
    ref: a,
    sideOffset: e,
...
const Aa = "16rem", Oa = "3rem", kn = c.createContext(void 0);
function ee() {
...
const Pa = c.forwardRef(({ className: t, onClick: e, ...n }, a) => {
  const o = ee();
  return /* @__PURE__ */ d(
    I,
    {
...
$a.displayName = "SidebarSeparator";
...
const Ya = vt(
  ...
  ({
    ...
    const p = t ? St : "button", { state: u } = ee(), g = /* @__PURE__ */ r(
      p,
      {
        ref: s,
        ...
        "data-size": a,
        "data-active": e,
        className: l(Ya({ variant: n, size: a }), i),
        ...w
      }
    );
...
const Ha = c.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...a }, o) => /* @__PURE__ */ r(
  e ? St : "button",
  {
    ref: o,
...
Ha.displayName = "SidebarMenuAction";
...
Ka.displayName = "SidebarMenuSubItem";
const Wa = c.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: a, ...o }, i) => /* @__PURE__ */ r(
  t ? St : "a",
  {
    ref: i,
    ...
    Sn,
    {
      ...
      children: /* @__PURE__ */ d(Tn, { children: [
        /* @__PURE__ */ d(he, { children: [
          ...
          /* @__PURE__ */ r(fe, { children: /* @__PURE__ */ r(_n, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(zn, { children: /* @__PURE__ */ r(
            En,
            {
              onClick: () => u(h),
              isActive: b(h),
...
const it = "scrBook", Qa = "scrRef", ut = "source", to = "details", eo = "Scripture Reference", no = "Scripture Book", Mn = "Type", ro = "Details";
function ao(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: it,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? eo,
      cell: (a) => {
        const o = a.row.original;
        return a.row.getIsGrouped() ? X.bookIdToEnglishName(o.start.book) : a.row.groupingColumnId === it ? mt(o.start) : void 0;
      },
    ...
    },
    {
      ...
      id: to,
      header: (t == null ? void 0 : t.detailsColumnName) ?? ro,
      cell: (a) => a.getValue(),
      enableGrouping: !1
    }
  ];
...
}, Ye = (t) => `${oo({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function ks({
  sources: t,
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          /* @__PURE__ */ r(gt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(Nt, {}) }),
          /* @__PURE__ */ r(ft, { position: "item-aligned", children: /* @__PURE__ */ r(ha, { children: E.map((N) => /* @__PURE__ */ r(Q, { value: JSON.stringify(N.value), children: N.label }, N.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !N.getIsExpanded() && (L === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(xr, {})),
                          " ",
...
function Cs({
  ...
  return /* @__PURE__ */ d(
    yt,
    {
      ...
      children: [
        /* @__PURE__ */ r(gt, { className: l("pr-twp tw-w-auto", o), children: /* @__PURE__ */ r(
          Nt,
          {
            placeholder: i[M(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          ft,
          {
            ...
            style: { zIndex: 250 },
            children: t.map((s) => /* @__PURE__ */ r(Q, { value: `${s}`, children: i[M(s)] }, `${s}`))
          }
        )
      ]
    }
...
const Bn = (t, e, n, a) => n ? Object.entries(t).filter(
...
).sort(([, i], [, w]) => i.order - w.order).flatMap(([i]) => e.filter((s) => s.group === i).sort((s, p) => s.order - p.order).map((s) => /* @__PURE__ */ d(Pe, { children: [
  /* @__PURE__ */ r(Xe, { asChild: !0, children: "command" in s ? /* @__PURE__ */ d(
    Ce,
    {
      onClick: () => {
        a(s);
      ...
      children: [
        s.iconPathBefore && /* @__PURE__ */ r(Yt, { icon: s.iconPathBefore, menuLabel: s.label, leading: !0 }),
        s.label,
        s.iconPathAfter && /* @__PURE__ */ r(Yt, { icon: s.iconPathAfter, menuLabel: s.label })
      ]
    },
    `dropdown-menu-item-${s.label}-${s.command}`
  ) : /* @__PURE__ */ d(Ar, { children: [
    /* @__PURE__ */ r(en, { children: s.label }),
    /* @__PURE__ */ r(Vr, { children: /* @__PURE__ */ r(nn, { children: Bn(
      t,
      e,
      In(t, s.id),
      a
  ...
  s.tooltip && /* @__PURE__ */ r(te, { children: s.tooltip })
...
function _s({
  ...
  return /* @__PURE__ */ d(Jt, { variant: i, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(yr, {}) }) }),
    /* @__PURE__ */ r(Xt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(qn, { children: [
      /* @__PURE__ */ r(tn, { children: /* @__PURE__ */ r(Oe, { children: Bn(e.groups, e.items, s, t) }) }),
...
function zs({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Vn, { children: [
      /* @__PURE__ */ r(An, { children: t.map((w) => /* @__PURE__ */ r(so, { value: w.value, children: w.value }, w.key)) }),
  ...
  return /* @__PURE__ */ d(
    V.SubTrigger,
    {
      ...
      className: l(
        ...
        e && "tw-pl-8",
        ot({ variant: i.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...a,
...
const lo = c.forwardRef(({ className: t, children: e, checked: n, ...a }, o) => {
  const i = et();
  return /* @__PURE__ */ d(
    V.CheckboxItem,
    {
...
lo.displayName = V.CheckboxItem.displayName;
const co = c.forwardRef(({ className: t, children: e, ...n }, a) => {
  const o = et();
  return /* @__PURE__ */ d(
    V.RadioItem,
    {
...
co.displayName = V.RadioItem.displayName;
const po = c.forwardRef(({ className: t, inset: e, ...n }, a) => /* @__PURE__ */ r(
  V.Label,
  {
    ref: a,
    className: l("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
po.displayName = V.Label.displayName;
...
const Dt = (t, e) => {
  ...
  return o.flatMap(([i], w) => {
    const s = e.filter((u) => u.group === i).sort((u, g) => u.order - g.order).map((u) => /* @__PURE__ */ d(Pe, { children: [
    ...
    return s.length > 0 && w < o.length - 1 && p.push(/* @__PURE__ */ r(Ln, {}, `separator-${i}`)), p;
  });
};
function uo({
  menuData: t,
  ...
  const o = K(void 0), i = K(void 0), w = K(void 0), s = K(void 0), p = K(void 0), u = (g) => {
    switch (g) {
      case "platform.app":
        return i;
  ...
  if (Er(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (g, b) => {
    ...
    switch (b.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (f = i.current) == null || f.focus(), Dt(i, [h, m]);
        break;
      case "alt+l":
        (k = w.current) == null || k.focus(), Dt(w, [h, m]);
        break;
      case "alt+n":
        (C = s.current) == null || C.focus(), Dt(s, [h, m]);
        break;
      case "alt+h":
    ...
    return /* @__PURE__ */ r(Pn, { ref: o, className: "pr-twp tw-border-0 tw-bg-transparent", variant: a, children: Object.entries(t.columns).filter(([, g]) => typeof g == "object").sort(([, g], [, b]) => typeof g == "boolean" || typeof b == "boolean" ? 0 : g.order - b.order).map(([g, b]) => /* @__PURE__ */ d(io, { children: [
...
function Ms({
  ...
  const p = mo(
    ...
    o && o(m), a && a([m, ...n.filter((f) => f !== m)]), i && n.find((f) => f === m) && i([...n.filter((f) => f !== m)]), g(!1);
  }, h = (m, f) => {
    var C, y, x, E, $, q;
  ...
  return /* @__PURE__ */ d("div", { className: l("pr-twp tw-max-w-sm", s), children: [
    /* @__PURE__ */ d(
      yt,
      {
        ...
        onOpenChange: (m) => g(m),
        children: [
          /* @__PURE__ */ r(gt, { children: /* @__PURE__ */ r(Nt, {}) }),
          /* @__PURE__ */ r(
            ft,
            {
              className: "tw-z-[250]",
...
), fo = c.forwardRef(({ className: t, variant: e, ...n }, a) => /* @__PURE__ */ r("div", { ref: a, role: "alert", className: l(go({ variant: e }), t), ...n }));
fo.displayName = "Alert";
...
const vo = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: l("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
vo.displayName = "AlertDescription";
...
xo.displayName = Rt.Root.displayName;
...
yo.displayName = Rt.Image.displayName;
...
No.displayName = Rt.Fallback.displayName;
...
const Ro = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
zo.displayName = Mt.Root.displayName;
...
Eo.displayName = pe.Root.displayName;
const As = U.Root, Do = c.forwardRef(({ className: t, ...e }, n) => {
  const a = F();
  return /* @__PURE__ */ r(
    U.List,
    {
...
Do.displayName = U.List.displayName;
...
Io.displayName = U.Content.displayName;
const Os = (t, e) => {
  wt(() => {
    if (!t) return () => {
    };
...
export {
  ...
  me as ComboBox,
  Ca as DataTable,
  ns as DictionaryEntryDisplay,
  bn as DictionaryListItem,
  rs as DictionaryTable,
  ss as DisableButton,
  Jt as DropdownMenu,
  ...
  l as cn,
  vs as getBookIdFromUSFM,
  fs as getLinesFromUSFM,
  bs as getNumberFromUSFM,
  Ia as getStatusForItem,
  Es as getToolbarOSReservedSpaceClassName,
  hs as inventoryCountColumn,
  ms as inventoryItemColumn,
