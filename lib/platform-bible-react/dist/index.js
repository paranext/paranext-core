import { jsx as r, jsxs as d, Fragment as rt } from "react/jsx-runtime";
import * as Qe from "react";
import g, { forwardRef as Ve, useRef as et, useMemo as L, useState as M, useCallback as B, useLayoutEffect as It, createContext as Dn, useContext as In, useEffect as q, Suspense as ia, createRef as la, Fragment as Nr } from "react";
import { Command as dt } from "cmdk";
import { X as Me, Search as kr, Check as _t, Clock as er, ChevronsLeft as nr, ChevronsRight as rr, ChevronLeft as dn, ChevronRight as ae, ArrowLeft as wa, ArrowRight as da, Circle as Xe, ChevronDown as qt, BoldIcon as ca, ItalicIcon as pa, UnderlineIcon as ua, StrikethroughIcon as ma, Pencil as ha, Trash2 as fa, ArrowUp as _r, MoreHorizontal as Cr, ChevronUp as cn, AtSign as ga, FilterIcon as ba, ArrowLeftIcon as va, ChevronLeftIcon as xa, ChevronRightIcon as ya, ArrowRightIcon as Na, Copy as Er, Filter as ka, User as _a, Link as Ca, CircleHelp as Ea, ChevronsUpDown as Tr, Star as Ta, FunctionSquare as Rr, SquareSigma as Sr, SquareX as Ra, AlertCircle as pn, CircleCheckIcon as Sa, CircleXIcon as Da, CircleHelpIcon as Ia, ArrowUpIcon as Oa, ArrowDownIcon as Va, ArrowUpDownIcon as Ma, PanelLeft as Aa, PanelRight as Pa, ScrollText as $a, MenuIcon as La, Menu as za, EllipsisVertical as Ba, LoaderCircle as ja, GripVertical as Fa } from "lucide-react";
import { clsx as Ga } from "clsx";
import { extendTailwindMerge as Ha } from "tailwind-merge";
import * as ft from "@radix-ui/react-dialog";
import { includes as Le, Section as F, getChaptersForBook as Xa, formatScrRef as re, getSectionForBook as _e, formatRelativeDate as Ua, formatReplacementString as Xt, sanitizeHtml as Ka, parseParatextHtml as or, hasCustomParatextTags as Ya, NumberFormat as qa, formatBytes as Ja, getCurrentLocale as Wa, getFormatCallerFunction as Za, deepEqual as Dr, isString as tn, compareScrRefs as un, scrRefToBBBCCCVVV as en, getLocalizeKeyForScrollGroupId as U } from "platform-bible-utils";
...
import * as Ir from "@radix-ui/react-label";
import * as Re from "@radix-ui/react-radio-group";
import { createEditor as Qa, $getRoot as Jt, $createParagraphNode as On, $getSelection as Se, HISTORY_MERGE_TAG as Or, ParagraphNode as ts, TextNode as es, $isDecoratorNode as ns, $isElementNode as Ce, $isParagraphNode as rs, $isTextNode as je, $isTokenOrSegmented as os, $getCharacterOffsets as as, $isRangeSelection as Vn, CLEAR_EDITOR_COMMAND as Vr, COMMAND_PRIORITY_EDITOR as ss, SELECTION_CHANGE_COMMAND as Mr, COMMAND_PRIORITY_CRITICAL as Ar, FORMAT_TEXT_COMMAND as is, $cloneWithProperties as ls, getRegisteredNode as ws, isHTMLElement as ds, isDocumentFragment as ar, ArtificialNode__DO_NOT_USE as Pr, $createLineBreakNode as $r, $isRootOrShadowRoot as cs, $isBlockElementNode as mn, isBlockDomNode as sr, isInlineDomNode as ir, $insertNodes as ps } from "lexical";
...
import * as Lr from "@radix-ui/react-toggle";
import { createHeadlessEditor as zr } from "@lexical/headless";
...
import { useReactTable as jr, getFilteredRowModel as ys, getSortedRowModel as Fr, getPaginationRowModel as Ns, getCoreRowModel as Gr, flexRender as Ee, getGroupedRowModel as ks, getExpandedRowModel as _s } from "@tanstack/react-table";
import * as nt from "@radix-ui/react-select";
import Cs from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as hn, HIDDEN_NOTE_CALLER as fn, getDefaultViewOptions as Es, isInsertEmbedOpOfType as nn, Editorial as Ts } from "@eten-tech-foundation/platform-editor";
import * as gn from "@radix-ui/react-checkbox";
...
import { Drawer as gt } from "vaul";
import * as bn from "@radix-ui/react-progress";
import * as Mn from "react-resizable-panels";
import { Toaster as Ss } from "sonner";
import { toast as Ec } from "sonner";
import * as ke from "@radix-ui/react-slider";
import * as vn from "@radix-ui/react-switch";
...
const Os = ft.Root, Vs = ft.Portal, Hr = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Overlay,
  {
    ref: n,
    className: u(
...
Hr.displayName = ft.Overlay.displayName;
const Xr = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = st();
  return /* @__PURE__ */ d(Vs, { children: [
    /* @__PURE__ */ r(Hr, {}),
    /* @__PURE__ */ d(
      ft.Content,
      {
...
Xr.displayName = ft.Content.displayName;
...
const Kr = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Title,
  {
    ref: n,
...
Kr.displayName = ft.Title.displayName;
const Ms = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ft.Description,
  {
    ref: n,
...
Ms.displayName = ft.Description.displayName;
...
pe.displayName = dt.displayName;
const Pe = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-border-b tw-px-3", dir: o, children: [
    /* @__PURE__ */ r(kr, { className: "tw-me-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" }),
    /* @__PURE__ */ r(
      dt.Input,
      {
        ref: n,
...
Pe.displayName = dt.Input.displayName;
...
ue.displayName = dt.List.displayName;
const Ke = g.forwardRef((t, e) => /* @__PURE__ */ r(dt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
Ke.displayName = dt.Empty.displayName;
const $t = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Group,
  {
    ref: n,
    className: u(
...
$t.displayName = dt.Group.displayName;
...
Yr.displayName = dt.Separator.displayName;
const te = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.Item,
  {
    ref: n,
    className: u(
...
te.displayName = dt.Item.displayName;
var As = Object.defineProperty, Ps = (t, e, n) => e in t ? As(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, j = (t, e, n) => Ps(t, typeof e != "symbol" ? e + "" : e, n);
const Wt = [
  "GEN",
  "EXO",
  "LEV",
...
function me(t, e = !0) {
  return e && (t = t.toUpperCase()), t in lr ? lr[t] : 0;
}
function Pn(t) {
  return me(t) > 0;
}
...
function* Bs() {
  for (let t = 1; t <= Wt.length; t++) yield t;
}
const js = 1, Wr = Wt.length;
function Fs() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function $n(t, e = "***") {
  const n = t - 1;
  return n < 0 || n >= Wt.length ? e : Wt[n];
}
function Zr(t) {
  return t <= 0 || t > Wr ? "******" : qr[t - 1];
}
function Gs(t) {
  return Zr(me(t));
}
function Qr(t) {
  const e = typeof t == "number" ? $n(t) : t;
  return Pn(e) && !An.includes(e);
}
function Hs(t) {
  const e = typeof t == "number" ? $n(t) : t;
  return Pn(e) && An.includes(e);
...
function Xs(t) {
  return qr[t - 1].includes("*obsolete*");
}
function Us() {
  const t = {};
...
j(pt, "Original", new pt(Nt.Original)), j(pt, "Septuagint", new pt(Nt.Septuagint)), j(pt, "Vulgate", new pt(Nt.Vulgate)), j(pt, "English", new pt(Nt.English)), j(pt, "RussianProtestant", new pt(Nt.RussianProtestant)), j(pt, "RussianOrthodox", new pt(Nt.RussianOrthodox));
let Ft = pt;
function wr(t, e) {
  const n = e[0];
...
var to = /* @__PURE__ */ ((t) => (t[t.Valid = 0] = "Valid", t[t.UnknownVersification = 1] = "UnknownVersification", t[t.OutOfRange = 2] = "OutOfRange", t[t.VerseOutOfOrder = 3] = "VerseOutOfOrder", t[t.VerseRepeated = 4] = "VerseRepeated", t))(to || {});
const wt = class H {
  constructor(e, n, o, a) {
    if (j(this, "firstChapter"), j(this, "lastChapter"), j(this, "lastVerse"), j(this, "hasSegmentsDefined"), j(this, "text"), j(this, "BBBCCCVVVS"), j(this, "longHashCode"), j(this, "versification"), j(this, "rtlMark", "‏"), j(this, "_bookNum", 0), j(this, "_chapterNum", 0), j(this, "_verseNum", 0), j(this, "_verse"), o == null && a == null)
      if (e != null && typeof e == "string") {
        const s = e, i = n != null && n instanceof Ft ? n : void 0;
        this.setEmpty(i), this.parse(s);
      } else if (e != null && typeof e == "number") {
        const s = n != null && n instanceof Ft ? n : void 0;
        this.setEmpty(s), this._verseNum = e % H.chapterDigitShifter, this._chapterNum = Math.floor(
          e % H.bookDigitShifter / H.chapterDigitShifter
        ), this._bookNum = Math.floor(e / H.bookDigitShifter);
      } else if (n == null)
        if (e != null && e instanceof H) {
          ...
          if (e == null) return;
          const s = e instanceof Ft ? e : H.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof e == "string" && typeof n == "string" && typeof o == "string")
        ...
        this._bookNum = e, this._chapterNum = n, this._verseNum = o, this.versification = a ?? H.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static tryParse(e) {
    let n;
    try {
      return n = new H(e), { success: !0, verseRef: n };
    } catch (o) {
      if (o instanceof ye)
  ...
  static getBBBCCCVVV(e, n, o) {
    return e % H.bcvMaxValue * H.bookDigitShifter + (n >= 0 ? n % H.bcvMaxValue * H.chapterDigitShifter : 0) + (o >= 0 ? o % H.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(e) {
    ...
    let p;
    return i && (p = new Ft(i)), n ? new H(n, o.toString(), l, p) : new H();
  }
  /**
   ...
   */
  get book() {
    return K.bookNumberToId(this.bookNum, "");
  }
  set book(e) {
    this.bookNum = K.bookIdToNumber(e);
  }
  /**
  ...
  set verse(e) {
    const { success: n, vNum: o } = H.tryGetVerseNum(e);
    this._verse = n ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = o, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = H.tryGetVerseNum(this._verse));
  }
  /**
  ...
  set versificationStr(e) {
    this.versification = this.versification != null ? new Ft(e) : void 0;
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = s[0], s.length > 1)
        try {
          const i = +s[1].trim();
          this.versification = new Ft(Nt[i]);
        } catch {
          throw new ye("Invalid reference : " + e);
        }
    }
    ...
    if (o.length !== 2 || K.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !H.isVerseParseable(o[1]))
      throw new ye("Invalid reference : " + e);
   ...
   */
  equals(e) {
    return e instanceof H ? e._bookNum === this._bookNum && e._chapterNum === this._chapterNum && e._verseNum === this._verseNum && e.verse === this.verse && (e.versification == null && this.versification == null || e.versification != null && this.versification != null && e.versification.equals(this.versification)) : !1;
  }
  /**
   ...
   */
  allVerses(e = !1, n = H.verseRangeSeparators, o = H.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], s = wr(this._verse, o);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > K.lastBook ? 2 : (K.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = H.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, o) {
    this.bookNum = K.bookIdToNumber(e), this.chapter = n, this.verse = o;
  }
};
j(wt, "defaultVersification", Ft.English), j(wt, "verseRangeSeparator", "-"), j(wt, "verseSequenceIndicator", ","), j(wt, "verseRangeSeparators", [wt.verseRangeSeparator]), j(wt, "verseSequenceIndicators", [wt.verseSequenceIndicator]), j(wt, "chapterDigitShifter", 1e3), j(wt, "bookDigitShifter", wt.chapterDigitShifter * wt.chapterDigitShifter), j(wt, "bcvMaxValue", wt.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
j(wt, "ValidStatusType", to);
...
function oe(t, e) {
  var o;
  return ((o = e == null ? void 0 : e.get(t)) == null ? void 0 : o.localizedName) ?? K.bookIdToEnglishName(t);
}
function Ln(t, e) {
  var o;
  return ((o = e == null ? void 0 : e.get(t)) == null ? void 0 : o.localizedId) ?? t.toUpperCase();
}
const no = K.allBookIds.filter(
  (t) => !K.isObsolete(K.bookIdToNumber(t))
), Ut = Object.fromEntries(
  no.map((t) => [t, K.bookIdToEnglishName(t)])
);
function zn(t, e, n) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const a = K.bookIdToEnglishName(t), s = n == null ? void 0 : n.get(t);
  return !!(Le(a.toLowerCase(), o) || Le(t.toLowerCase(), o) || (s ? Le(s.localizedName.toLowerCase(), o) || Le(s.localizedId.toLowerCase(), o) : !1));
}
const ro = Ve(
  ({
    bookId: t,
    ...
    const c = et(!1), f = () => {
      c.current || n == null || n(t), setTimeout(() => {
        c.current = !1;
      }, 100);
    }, h = (v) => {
      c.current = !0, o ? o(v) : n == null || n(t);
    }, m = L(
      () => oe(t, l),
      [t, l]
    ), b = L(
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ d(
          ...
          {
            ref: w,
            value: p || `${t} ${K.bookIdToEnglishName(t)}`,
            onSelect: f,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
            "aria-label": `${K.bookIdToEnglishName(t)} (${t.toLocaleUpperCase()})`,
            className: s,
            children: [
              i && /* @__PURE__ */ r(
                _t,
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? de : "button", { className: u(Ys({ variant: e, size: n, className: t })), ref: s, ...a })
);
$.displayName = "Button";
const he = se.Root, fe = se.Trigger, vd = se.Anchor, ee = g.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = st();
...
ee.displayName = se.Content.displayName;
function xn(t, e, n) {
  return `${t} ${Ut[t]}${e ? ` ${Ln(t, e)} ${oe(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function qs({
  recentSearches: t,
  ...
  return /* @__PURE__ */ d(he, { open: l, onOpenChange: p, children: [
    ...
    /* @__PURE__ */ r(ee, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(pe, { children: /* @__PURE__ */ r(ue, { children: /* @__PURE__ */ r($t, { heading: s, children: t.map((c) => /* @__PURE__ */ d(
      te,
      {
        onSelect: () => w(c),
        className: "tw-flex tw-items-center",
        children: [
          /* @__PURE__ */ r(er, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function xd(t, e, n = (a, s) => a === s, o = 15) {
  return (a) => {
    const s = t.filter(
      (l) => !n(l, a)
    ), i = [a, ...s.slice(0, o - 1)];
...
function Ws(t, e, n) {
  ...
  const o = Js.reduce(
    (a, s) => {
      ...
      if (i) {
        const [l, p = void 0, w = void 0] = i.slice(1);
        let c;
        const f = e.filter((h) => zn(h, l, n));
        if (f.length === 1 && ([c] = f), !c && p) {
          if (K.isBookIdValid(l)) {
          ...
          if (!c && n) {
            ...
            h && e.includes(h[0]) && ([c] = h);
          }
        }
        if (!c && p) {
          const m = ((b) => Object.keys(Ut).find(
            (v) => Ut[v].toLowerCase() === b.toLowerCase()
          ))(l);
          if (m && e.includes(m) && (c = m), !c && n) {
            const b = Array.from(n.entries()).find(
              ([, v]) => v.localizedName.toLowerCase() === l.toLowerCase()
            );
            b && e.includes(b[0]) && ([c] = b);
          }
        }
        if (c) {
          let h = p ? parseInt(p, 10) : void 0;
          h && h > kt(c) && (h = Math.max(kt(c), 1));
...
function Zs(t, e, n, o) {
  const a = B(() => {
    if (t.chapterNum > 1)
      ...
      if (p > 0) {
        const w = e[p - 1], c = Math.max(kt(w), 1);
        o({
          book: w,
          chapterNum: c,
          verseNum: 1
  ...
  return L(() => [
    ...
    {
      onClick: s,
      disabled: e.length === 0 || (t.chapterNum === kt(t.book) || kt(t.book) === -1) && e.indexOf(t.book) === e.length - 1,
      title: "Next chapter",
      icon: n === "ltr" ? rr : nr
    }
  ], [
...
function cr({
  ...
  if (t)
    return /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r("div", { className: u("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: kt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      te,
      {
        value: `${t} ${Ut[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function yd({
  ...
  const w = st(), [c, f] = M(!1), [h, m] = M(""), [b, v] = M(""), [y, O] = M("books"), [N, x] = M(void 0), [_, A] = M(!1), C = et(void 0), E = et(void 0), S = et(void 0), T = et(void 0), R = et({}), P = B(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ), z = L(() => o ? o() : no, [o]), G = L(() => ({
    [F.OT]: z.filter((X) => K.isBookOT(X)),
    [F.NT]: z.filter((X) => K.isBookNT(X)),
    [F.DC]: z.filter((X) => K.isBookDC(X)),
    [F.Extra]: z.filter((X) => K.extraBooks().includes(X))
  }), [z]), I = L(() => Object.values(G).flat(), [G]), J = L(() => {
    if (!b.trim()) return G;
    const D = {
      [F.OT]: [],
      [F.NT]: [],
    ...
    return [F.OT, F.NT, F.DC, F.Extra].forEach((ot) => {
      D[ot] = G[ot].filter((it) => zn(it, b, a));
    }), D;
  }, [G, b, a]), V = L(
    () => Ws(b, I, a),
    [b, I, a]
    ...
    (D) => {
      const X = y === "chapters" ? N : V == null ? void 0 : V.book;
      X && (P({
        book: X,
        chapterNum: D,
        verseNum: 1
    ...
    (D) => {
      ...
      f(D), D && (O("books"), x(void 0), v(""));
    },
    [y, Y]
  ), { otLong: xt, ntLong: Et, dcLong: Wn, extraLong: Zn } = {
    ...
    (D) => V ? !!V.chapterNum && !D.toString().includes(V.chapterNum.toString()) : !1,
    [V]
  ), ra = L(
    () => re(
      t,
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: X, isDigit: ot } = dr(D.key);
      if (y === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (X || ot) {
          if (D.preventDefault(), D.stopPropagation(), O("books"), x(void 0), ot && N) {
            const it = Ut[N];
            v(`${it} ${D.key}`);
          } else
            v(D.key);
      ...
      if ((y === "chapters" || y === "books" && V) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        const it = y === "chapters" ? N : V == null ? void 0 : V.book;
        if (!it) return;
        const lt = (() => {
          if (!h) return 1;
          const xe = h.match(/(\d+)$/);
        ...
        switch (D.key) {
          case "ArrowLeft":
            lt !== 0 && (Tt = lt > 1 ? lt - 1 : Bt);
            break;
          case "ArrowRight":
            lt !== 0 && (Tt = lt < Bt ? lt + 1 : 1);
            break;
          case "ArrowUp":
            Tt = lt === 0 ? Bt : Math.max(1, lt - tr);
            break;
          case "ArrowDown":
            Tt = lt === 0 ? 1 : Math.min(Bt, lt + tr);
            break;
          default:
            return;
        }
        Tt !== lt && (D.preventDefault(), D.stopPropagation(), m(xn(it, a, Tt)), setTimeout(() => {
          const xe = R.current[Tt];
    ...
    const { isLetter: X, isDigit: ot } = dr(D.key);
    (X || ot) && (D.preventDefault(), v((it) => it + D.key), E.current.focus(), A(!1));
  }, []);
  return It(() => {
    const D = setTimeout(() => {
      if (c && y === "books" && S.current && T.current) {
        const X = S.current, ot = T.current, it = ot.offsetTop, lt = X.clientHeight, Bt = ot.clientHeight, Tt = it - lt / 2 + Bt / 2;
        X.scrollTo({
          top: Math.max(0, Tt),
          behavior: "smooth"
        }), m(xn(t.book));
  ...
  }, [y, N, V, t.book, t.chapterNum]), /* @__PURE__ */ d(he, { open: c, onOpenChange: ut, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      $,
      {
    ...
    /* @__PURE__ */ r(ee, { id: p, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ d(
      pe,
      {
        ref: C,
        onKeyDown: aa,
        ...
        shouldFilter: !1,
        children: [
          y === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: k.map(({ onClick: D, disabled: X, title: ot, icon: it }) => /* @__PURE__ */ r(
              $,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              $,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ r(wa, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(da, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: oe(N, a) })
          ] }),
          !_ && /* @__PURE__ */ d(ue, { ref: S, children: [
            y === "books" && /* @__PURE__ */ d(rt, { children: [
              !V && Object.entries(J).map(([D, X]) => {
                if (X.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r($t, { heading: ea(D), children: X.map((ot) => /* @__PURE__ */ r(
                      ro,
                      {
                        bookId: ot,
                        onSelect: (it) => ht(it),
                        section: _e(ot),
                        commandValue: `${ot} ${Ut[ot]}`,
                        ref: ot === t.book ? T : void 0,
                        localizedBookNames: a
                      },
                      ot
                    )) }, D)
              ...
              V && /* @__PURE__ */ r($t, { children: /* @__PURE__ */ r(
                te,
                {
                  value: `${V.book} ${Ut[V.book]} ${V.chapterNum || ""}:${V.verseNum || ""})}`,
                  onSelect: W,
                  ...
                  children: re(
                    ...
                    a ? Ln(V.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              V && kt(V.book) > 1 && /* @__PURE__ */ d(rt, { children: [
...
), at = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ir.Root, { ref: n, className: u("pr-twp", Qs(), t), ...e }));
at.displayName = Ir.Root.displayName;
const Bn = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    Re.Root,
    {
...
Bn.displayName = Re.Root.displayName;
const Fe = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Re.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(Re.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Xe, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
Fe.displayName = Re.Item.displayName;
function ti(t) {
...
function yn({
  ...
  const [N, x] = M(!1), _ = p ?? l, A = (E) => E.length > 0 && typeof E[0] == "object" && "options" in E[0], C = (E, S) => {
    const T = l(E), R = typeof E == "object" && "secondaryLabel" in E ? E.secondaryLabel : void 0, P = `${S ?? ""}${T}${R ?? ""}`;
    return /* @__PURE__ */ d(
      te,
      {
        value: T,
  ...
  return /* @__PURE__ */ d(he, { open: N, onOpenChange: x, ...O, children: [
    ...
    /* @__PURE__ */ r(
      ee,
      {
        ...
        children: /* @__PURE__ */ d(pe, { children: [
          ...
          /* @__PURE__ */ r(ue, { children: A(e) ? e.map((E) => /* @__PURE__ */ r($t, { heading: E.groupHeading, children: E.options.map((S) => C(S, E.groupHeading)) }, E.groupHeading)) : e.map((E) => C(E)) })
        ] })
      }
    )
  ] });
...
function _d({
  ...
  const c = on(w, "%webView_bookSelector_currentBook%"), f = on(w, "%webView_bookSelector_choose%"), h = on(w, "%webView_bookSelector_chooseBooks%"), [m, b] = M(
    "current book"
    /* CURRENT_BOOK */
  ), v = (y) => {
    b(y), t(y);
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(at, { className: "tw-ms-1", children: c })
          ] }),
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(at, { className: "tw-flex tw-items-center", children: o.map((y) => K.bookIdToEnglishName(y)).join(", ") }),
          /* @__PURE__ */ r(
            $,
            {
...
const Cd = [
  ...
  const a = et(null), [s, i] = M(void 0), [l, p] = M(void 0), w = B(
    (m) => {
      i(m);
      const b = t.find((y) => y.id === m);
      b && (e == null || e(b));
    ...
    (m) => {
      ...
      b && (p((v) => v === m ? void 0 : m), n == null || n(b));
    },
    [n, t]
  ), f = (m) => {
    if (!m) return !1;
    const b = m.tagName.toLowerCase();
    if (m.isContentEditable || ri.includes(b)) return !0;
    const v = m.getAttribute("role");
    if (v && oi.includes(v)) return !0;
    const y = m.getAttribute("tabindex");
    return y !== void 0 && y !== "-1";
  }, h = B(
    (m) => {
      var E;
      const b = m.target, v = (S) => S ? document.getElementById(S) : void 0, y = v(l), O = v(s);
      if (!!(y && b && y.contains(b) && b !== y) && f(b)) {
        if (m.key === "Escape" || m.key === "ArrowLeft" && !b.isContentEditable) {
          if (l) {
            m.preventDefault(), m.stopPropagation();
            const S = t.find((T) => T.id === l);
            S && w(S.id);
          }
          return;
        }
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          const T = S.findIndex((P) => P === b);
          if (T === -1) return;
          let R;
          m.key === "ArrowDown" ? R = Math.min(T + 1, S.length - 1) : R = Math.max(T - 1, 0), R !== T && (m.preventDefault(), m.stopPropagation(), (E = S[R]) == null || E.focus());
          return;
        }
        return;
      }
      const _ = t.findIndex((S) => S.id === s);
      let A = _;
      switch (m.key) {
        case "ArrowDown":
          A = Math.min(_ + 1, t.length - 1), m.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(_ - 1, 0), m.preventDefault();
          break;
        case "Home":
        ...
        case " ":
        case "Enter":
          s && c(s), m.preventDefault(), m.stopPropagation();
          return;
        case "ArrowRight": {
          const S = O;
          if (S) {
...
const ao = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, ii = ao ? It : q, ze = { tag: Or };
function li({ initialConfig: t, children: e }) {
  const n = L(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: p } = t, w = si(null, o), c = Qa({ editable: t.editable, html: p, namespace: a, nodes: s, onError: (f) => i(f, c), theme: o });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (m.isEmpty()) {
            const b = On();
            m.append(b);
            const v = ao ? document.activeElement : null;
            (Se() !== null || v !== null && v === f.getRootElement()) && b.select();
          }
        }, ze);
        else if (h !== null) switch (typeof h) {
          case "string": {
            const m = f.parseEditorState(h);
            f.setEditorState(m, ze);
            break;
          }
          case "object":
            f.setEditorState(h, ze);
            break;
          case "function":
            f.update(() => {
              Jt().isEmpty() && h(f);
  ...
  }, []), r(oo.Provider, { value: n, children: e });
}
const wi = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function di({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Ct();
  return wi(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: s, dirtyLeaves: i, prevEditorState: l, tags: p }) => {
      e && s.size === 0 && i.size === 0 || t && p.has(Or) || l.isEmpty() || n(a, o, p);
    });
  }, [o, t, e, n]), null;
}
const jn = {
  ...
  mark: "",
  markOverlap: ""
}, St = Ae.Provider, At = Ae.Root, Kt = Ae.Trigger, Dt = g.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  Ae.Content,
  {
    ref: o,
    sideOffset: e,
...
Dt.displayName = Ae.Content.displayName;
const Fn = [
  ms,
  ts,
  es,
...
var pr = { error: null }, ci = function(t) {
  var e, n;
  function o() {
    for (var s, i = arguments.length, l = new Array(i), p = 0; p < i; p++) l[p] = arguments[p];
    return (s = t.call.apply(t, [this].concat(l)) || this).state = pr, s.resetErrorBoundary = function() {
      for (var w, c = arguments.length, f = new Array(c), h = 0; h < c; h++) f[h] = arguments[h];
      s.props.onReset == null || (w = s.props).onReset.apply(w, f), s.reset();
    }, s;
  }
  n = t, (e = o).prototype = Object.create(n.prototype), e.prototype.constructor = e, Nn(e, n), o.getDerivedStateFromError = function(s) {
    return { error: s };
  };
  var a = o.prototype;
  return a.reset = function() {
    ...
    var l, p;
    (l = (p = this.props).onError) == null || l.call(p, s, i);
  }, a.componentDidUpdate = function(s, i) {
    var l, p, w, c, f = this.state.error, h = this.props.resetKeys;
    f !== null && i.error !== null && ((w = s.resetKeys) === void 0 && (w = []), (c = h) === void 0 && (c = []), w.length !== c.length || w.some(function(m, b) {
      return !Object.is(m, c[b]);
    })) && ((l = (p = this.props).onResetKeysChange) == null || l.call(p, s.resetKeys, h), this.reset());
  }, a.render = function() {
    var s = this.state.error, i = this.props, l = i.fallbackRender, p = i.FallbackComponent, w = i.fallback;
    if (s !== null) {
      var c = { error: s, resetErrorBoundary: this.resetErrorBoundary };
      if (Qe.isValidElement(w)) return w;
      if (typeof l == "function") return l(c);
      if (p) return Qe.createElement(p, c);
...
function pi({ children: t, onError: e }) {
  return r(ci, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
const ui = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function mi(t) {
  return { initialValueFn: () => t.isEditable(), subscribe: (e) => t.registerEditableListener(e) };
}
function hi() {
  return function(t) {
    const [e] = Ct(), n = L(() => t(e), [e, t]), [o, a] = M(() => n.initialValueFn()), s = et(o);
    return ui(() => {
      const { initialValueFn: i, subscribe: l } = n, p = i();
      return s.current !== p && (s.current = p, a(p)), l((w) => {
        s.current = w, a(w);
      });
    }, [n, t]), o;
  }(mi);
...
function bi(t) {
  if (!gi(t, !1)) return !1;
  const e = Jt().getChildren(), n = e.length;
  if (n > 1) return !1;
  for (let o = 0; o < n; o++) {
    const a = e[o];
    if (ns(a)) return !1;
...
function vi(t, e) {
  ...
  if (e.isSelected(t) && !os(e) && n !== null) {
    const [o, a] = n, s = t.isBackward(), i = o.getNode(), l = a.getNode(), p = e.is(i), w = e.is(l);
    if (p || w) {
      const [c, f] = as(t), h = i.is(l), m = e.is(s ? l : i), b = e.is(s ? i : l);
      let v, y = 0;
      h ? (y = c > f ? f : c, v = c > f ? c : f) : m ? (y = s ? f : c, v = void 0) : b && (y = 0, v = s ? c : f), e.__text = e.__text.slice(y, v);
    }
  }
  return e;
}
const io = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, xi = io && "documentMode" in document ? document.documentMode : null;
!(!io || !("InputEvent" in window) || xi) && "getTargetRanges" in new window.InputEvent("input");
function Gn(...t) {
  return () => {
        ...
        if (l && l.functionId === "makeChanges") {
          ...
          if (p) {
            ...
            t.update(() => {
              ...
              if (Vn(v)) {
                const y = v.anchor;
                let O = y.getNode(), N = 0, x = 0;
                if (je(O) && w >= 0 && c >= 0 && (N = w, x = w + c, v.setTextNodeRange(O, N, O, x)), N === x && f === "" || (v.insertRawText(f), O = y.getNode()), je(O)) {
                  N = h, x = h + m;
                  const _ = O.getTextContentSize();
                  N = N > _ ? _ : N, x = x > _ ? _ : x, v.setTextNodeRange(O, N, O, x);
                }
...
const kn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function ur(t) {
  return t.getEditorState().read(so(t.isComposing()));
}
function Ni({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Ct(), a = function(s, i) {
    const [l, p] = M(() => s.getDecorators());
    return kn(() => s.registerDecoratorListener((w) => {
      gs(() => {
        p(w);
      });
    }), [s]), q(() => {
      ...
      const w = [], c = Object.keys(l);
      for (let f = 0; f < c.length; f++) {
        const h = c[f], m = r(i, { onError: (v) => s._onError(v), children: r(ia, { fallback: null, children: l[h] }) }), b = s.getElementByKey(h);
        b !== null && w.push(bs(m, b, h));
      }
      return w;
    }, [i, l, s]);
  }(o, n);
  return function(s) {
    kn(() => Gn(fs(s), yi(s)), [s]);
  }(o), d(rt, { children: [t, r(ki, { content: e }), a] });
}
function ki({ content: t }) {
  const [e] = Ct(), n = function(a) {
    const [s, i] = M(() => ur(a));
    return kn(() => {
      function l() {
        const p = ur(a);
      ...
      return l(), Gn(a.registerUpdateListener(() => {
        l();
...
const Ci = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Ei({ onClear: t }) {
  const [e] = Ct();
  return Ci(() => e.registerCommand(Vr, (n) => (e.update(() => {
    if (t == null) {
      const o = Jt(), a = Se(), s = On();
      o.clear(), o.append(s), a !== null && s.select(), Vn(a) && (a.format = 0);
    } else t();
  }), !0), ss), [e, t]), null;
}
const lo = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? It : q;
function Ti({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: p, ariaLabelledBy: w, ariaMultiline: c, ariaOwns: f, ariaRequired: h, autoCapitalize: m, className: b, id: v, role: y = "textbox", spellCheck: O = !0, style: N, tabIndex: x, "data-testid": _, ...A }, C) {
  const [E, S] = M(t.isEditable()), T = B((P) => {
    P && P.ownerDocument && P.ownerDocument.defaultView ? t.setRootElement(P) : t.setRootElement(null);
  }, [t]), R = L(() => /* @__PURE__ */ function(...P) {
    return (z) => {
      P.forEach((G) => {
        typeof G == "function" ? G(z) : G != null && (G.current = z);
      });
    };
  }(C, T), [T, C]);
  return lo(() => (S(t.isEditable()), t.registerEditableListener((P) => {
    S(P);
  })), [t]), r("div", { "aria-activedescendant": E ? e : void 0, "aria-autocomplete": E ? n : "none", "aria-controls": E ? o : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": E && y === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": p, "aria-labelledby": w, "aria-multiline": c, "aria-owns": E ? f : void 0, "aria-readonly": !E || void 0, "aria-required": h, autoCapitalize: m, className: b, contentEditable: E, "data-testid": _, id: v, ref: R, role: y, spellCheck: O, style: N, tabIndex: x, ...A });
}
const Ri = Ve(Ti);
function mr(t) {
  return t.getEditorState().read(so(t.isComposing()));
...
const Si = Ve(Di);
function Di(t, e) {
  const { placeholder: n, ...o } = t, [a] = Ct();
  return d(rt, { children: [r(Ri, { editor: a, ...o, ref: e }), n != null && r(Ii, { editor: a, content: n })] });
}
function Ii({ content: t, editor: e }) {
  const n = function(i) {
    ...
    return lo(() => {
      ...
      return w(), Gn(i.registerUpdateListener(() => {
        w();
...
function Vi({
  ...
  return /* @__PURE__ */ r(wo.Provider, { value: i, children: s });
}
function co() {
  const t = In(wo);
  if (!t)
...
function Mi() {
  const [t, e] = M(void 0), n = B(() => {
    e(void 0);
  }, []), o = L(() => {
    if (t === void 0)
      return;
    const { title: s, content: i } = t;
    return /* @__PURE__ */ r(Os, { open: !0, onOpenChange: n, children: /* @__PURE__ */ d(Xr, { children: [
      /* @__PURE__ */ r(Ur, { children: /* @__PURE__ */ r(Kr, { children: s }) }),
      i
    ] }) });
  }, [t, n]), a = B(
    (s, i, l = !1) => {
...
function Ai({
  ...
  const [e] = Ct(), [n, o] = M(e), [a, s] = M("paragraph"), [i, l] = Mi(), p = () => {
  };
...
), $i = g.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Lr.Root,
  {
    ref: a,
    className: u(po({ variant: e, size: n, className: t })),
    ...o
  }
));
$i.displayName = Lr.Root.displayName;
const uo = g.createContext({
  size: "default",
  variant: "default"
}), Hn = g.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, s) => {
  const i = st();
  return /* @__PURE__ */ r(
    Ue.Root,
    {
...
Hn.displayName = Ue.Root.displayName;
const Te = g.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, s) => {
  const i = g.useContext(uo);
  return /* @__PURE__ */ r(
    Ue.Item,
    {
      ref: s,
...
Te.displayName = Ue.Item.displayName;
const hr = [
  { format: "bold", icon: ca, label: "Bold" },
...
function Li() {
  const { activeEditor: t } = co(), [e, n] = M([]), o = B((a) => {
    if (Vn(a) || vs(a)) {
      const s = [];
      hr.forEach(({ format: i }) => {
  ...
  return Pi(o), /* @__PURE__ */ r(
    Hn,
    {
      ...
      variant: "outline",
      size: "sm",
      children: hr.map(({ format: a, icon: s, label: i }) => /* @__PURE__ */ r(
        Te,
        {
          value: a,
          "aria-label": i,
...
function zi({ onClear: t }) {
  const [e] = Ct();
  q(() => {
    t && t(() => {
      e.dispatchCommand(Vr, void 0);
    });
  }, [e, t]);
}
function Bi({
  ...
  return /* @__PURE__ */ r("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ r(
    li,
    {
      ...
      children: /* @__PURE__ */ d(St, { children: [
        /* @__PURE__ */ r(Bi, { placeholder: a, autoFocus: s, onClear: i }),
        /* @__PURE__ */ r(
          di,
          {
...
function Fi(t, e) {
  ...
  for (let s = 0; s < n.length; s++) {
    const i = n[s];
    if (!ho.has(i.nodeName)) {
      const l = fo(i, t, a, !1);
      l !== null && (o = o.concat(l));
    }
  }
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Pr && i.insertAfter($r());
    for (const i of s) {
      const l = i.getChildren();
      for (const p of l) i.insertBefore(p);
      i.remove();
    }
  }(a), o;
}
...
function mo(t, e, n, o = null) {
  let a = o === null || e.isSelected(o);
  const s = Ce(e) && e.excludeFromCopy("html");
  let i = e;
  if (o !== null) {
    let m = ls(e);
    m = je(m) && o !== null ? vi(o, m) : m, i = m;
  }
  const l = Ce(i) ? i.getChildren() : [], p = ws(t, i.getType());
  let w;
  w = p && p.exportDOM !== void 0 ? p.exportDOM(t, i) : i.exportDOM(t);
  const { element: c, after: f } = w;
  if (!c) return !1;
  const h = document.createDocumentFragment();
  for (let m = 0; m < l.length; m++) {
    const b = l[m], v = mo(t, b, h, o);
    !a && Ce(e) && v && e.extractWithChild(b, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((ds(c) || ar(c)) && c.append(h), n.append(c), f) {
      const m = f.call(i, c);
      m && (ar(c) ? c.replaceChildren(m) : c.replaceWith(m));
    }
  } else n.append(h);
  return a;
}
const ho = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function fo(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  let i = [];
  if (ho.has(t.nodeName)) return i;
  let l = null;
  const p = function(b, v) {
    const { nodeName: y } = b, O = v._htmlConversions.get(y.toLowerCase());
    let N = null;
    if (O !== void 0) for (const x of O) {
      const _ = x(b);
      _ !== null && (N === null || (N.priority || 0) <= (_.priority || 0)) && (N = _);
    }
  ...
  let h = [];
  const m = (l == null || !cs(l)) && (l != null && mn(l) || o);
  for (let b = 0; b < f.length; b++) h.push(...fo(f[b], e, n, m, new Map(a), l));
  return c != null && (h = c(h)), sr(t) && (h = Hi(t, h, m ? () => {
    const b = new Pr();
    return n.push(b), b;
  } : On)), l == null ? h.length > 0 ? i = i.concat(h) : sr(t) && function(b) {
    return b.nextSibling == null || b.previousSibling == null ? !1 : ir(b.nextSibling) && ir(b.previousSibling);
  }(t) && (i = i.concat($r())) : Ce(l) && l.append(...h), i;
}
function Hi(t, e, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    else if (s.push(l), i === e.length - 1 || i < e.length - 1 && mn(e[i + 1])) {
      const p = n();
      p.setFormat(o), p.append(...s), a.push(p), s = [];
    }
  }
  return a;
}
...
function Ui(t) {
  ...
  const e = t.replace(/<strikethrough>([\s\S]*?)<\/strikethrough>/gi, "<s>$1</s>").replace(/<color[^>]*>([\s\S]*?)<\/color>/gi, "$1").replace(/<language[^>]*>([\s\S]*?)<\/language>/gi, "$1"), n = zr({
...
function go(t) {
  ...
  return e.getEditorState().read(() => {
    o = Gi(e);
  }), o = o.replace(/\s+style="[^"]*"/g, "").replace(/\s+class="[^"]*"/g, "").replace(/<span>(.*?)<\/span>/g, "$1").replace(/<b><strong[^>]*>(.*?)<\/strong><\/b>/g, "<b>$1</b>").replace(/<strong><b[^>]*>(.*?)<\/b><\/strong>/g, "<b>$1</b>").replace(/<i><em[^>]*>(.*?)<\/em><\/i>/g, "<i>$1</i>").replace(/<em><i[^>]*>(.*?)<\/i><\/em>/g, "<i>$1</i>").replace(/<u><span[^>]*>(.*?)<\/span><\/u>/g, "<u>$1</u>").replace(/<s><span[^>]*>(.*?)<\/span><\/s>/g, "<s>$1</s>").replace(/<s>(.*?)<\/s>/g, "<strikethrough>$1</strikethrough>"), o;
}
function bo(t) {
...
const Ji = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: u("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
ie.displayName = Br.Root.displayName;
...
const Zi = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ce.Image,
  {
    ref: n,
...
Zi.displayName = ce.Image.displayName;
...
}), ge = Z.Trigger, No = Z.Group, Qi = Z.Portal, tl = Z.Sub, el = Z.RadioGroup;
function ne({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Un.Provider, { value: n, children: /* @__PURE__ */ r(Z.Root, { ...e }) });
}
...
const zt = g.forwardRef(({ className: t, sideOffset: e = 4, children: n, ...o }, a) => {
  const s = st();
...
zt.displayName = Z.Content.displayName;
...
const Pt = g.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Z.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
Pt.displayName = Z.CheckboxItem.displayName;
...
const $e = g.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Z.Label,
  {
    ref: o,
...
$e.displayName = Z.Label.displayName;
...
function fr({
  ...
  const v = B(() => {
    ...
    const C = new Date(t.date), E = Ua(
      C,
      o["%comment_date_today%"],
      o["%comment_date_yesterday%"]
    ), S = C.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    return Xt(o["%comment_dateAtTime%"], {
      date: E,
      time: S
    });
  }, [t.date, o]), N = L(
    () => !e && t.assignedUser ? Xt(o["%comment_assigned_to%"], {
      assignedUser: t.assignedUser
    }) : t.user,
    [e, t.assignedUser, t.user, o]
  ), x = L(
    ...
    if (a && n)
      return /* @__PURE__ */ d(rt, { children: [
        !Ya(t.contents) && /* @__PURE__ */ d(
          Ge,
          {
            onClick: () => {
              f(!0), m(Ui(or(t.contents))), w == null || w(!0);
            },
            children: [
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-flex-wrap tw-items-baseline tw-gap-x-2", children: [
            /* @__PURE__ */ r("p", { className: "tw-text-sm tw-font-medium", children: N }),
          ...
          c && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: b,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), v()) : C.key === "Enter" && C.shiftKey && (C.preventDefault(), C.stopPropagation(), Ht(h) && y());
              },
              onKeyDown: (C) => {
                bo(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              children: [
                /* @__PURE__ */ r(
                  _n,
        ...
        a && !e && s !== "Resolved" && /* @__PURE__ */ r(
          $,
          {
            ...
            onClick: (C) => {
              C.stopPropagation(), i(t.thread);
            },
            children: /* @__PURE__ */ r(_t, {})
          }
        ),
        A && /* @__PURE__ */ d(ne, { children: [
          /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
          /* @__PURE__ */ r(zt, { align: "end", children: A })
        ] })
      ]
    }
  );
...
function rl({
  ...
  const [m, b] = M(gr), [v, y] = M(!1), [O, N] = M(!1), [x, _] = M(!1), [A, C] = M(!1), E = L(() => t.filter((k) => !k.deleted), [t]), S = L(() => E[0], [E]), T = et(null), R = et(void 0);
  q(() => {
    const k = T.current;
    if (!k) return;
    const Y = () => {
  ...
  const P = L(
    ...
    () => a ? Xt(e["%comment_assigned_to%"], { assignedUser: a }) : void 0,
    [a, e]
  ), G = L(() => E.slice(1), [E]), I = L(() => G.length ?? 0, [G.length]), J = L(() => I > 0, [I]), V = L(() => x || I <= 2 ? G : G.slice(-2), [G, I, x]), W = L(() => x || I <= 2 ? 0 : I - 2, [I, x]), ht = L(
    () => I === 1 ? P.singleReply : Xt(P.multipleReplies, { count: I }),
    [I, P]
  ), Vt = L(
    () => W === 1 ? P.singleReply : Xt(P.multipleReplies, { count: W }),
    [W, P]
  ), vt = B(async () => {
    var Y;
    await c(l, go(m)) && ((Y = R.current) == null || Y.call(R), b(gr));
  }, [m, c, l]);
  return /* @__PURE__ */ r(
    Xn,
    {
      ...
      children: /* @__PURE__ */ d(vo, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          z && /* @__PURE__ */ r(De, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: z }),
          /* @__PURE__ */ d("div", { className: "tw-flex tw-max-w-full tw-flex-wrap tw-items-baseline tw-gap-2", children: [
            ...
            O && /* @__PURE__ */ r(
              $,
              {
                ...
                size: "icon",
                onClick: (k) => {
                  k.stopPropagation(), y(!v);
                },
                className: "tw-text-muted-foreground tw-transition hover:tw-text-foreground",
                "aria-label": v ? "Collapse text" : "Expand text",
                children: v ? /* @__PURE__ */ r(cn, {}) : /* @__PURE__ */ r(qt, {})
              }
            )
          ] }),
          /* @__PURE__ */ r(
            fr,
            {
              ...
              isThreadExpanded: n,
              threadStatus: p,
              isEditable: E.length === 1 && (S == null ? void 0 : S.user) === s,
              handleResolveCommentThread: w,
              handleUpdateComment: f,
              handleDeleteComment: h,
              onEditingChange: C
          ...
          n && /* @__PURE__ */ d(rt, { children: [
            W > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                onClick: (k) => {
                  k.stopPropagation(), _(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (k) => {
                  (k.key === "Enter" || k.key === " ") && (k.preventDefault(), k.stopPropagation(), _(!0));
                },
                children: [
                  /* @__PURE__ */ r("div", { className: "tw-w-8", children: /* @__PURE__ */ r(ie, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    x ? /* @__PURE__ */ r(cn, {}) : /* @__PURE__ */ r(qt, {})
                  ] })
                ]
              }
            ),
            V.map((k) => {
              const ut = k.id === G[G.length - 1].id && k.user === s;
            ...
            (!A || Ht(m)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (k) => {
                  k.key === "Enter" && k.shiftKey && (k.preventDefault(), k.stopPropagation(), Ht(m) && vt());
                },
                onKeyDown: (k) => {
                  bo(k), (k.key === "Enter" || k.key === " ") && k.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    _n,
...
function Ed({
  ...
  const [p, w] = M(), c = e.filter(
    ...
    w(N);
  }, []), { listboxRef: b, activeId: v, handleKeyDown: y } = ai({
    options: f,
    onOptionSelect: h
  }), O = B(
    (N) => {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      onKeyDown: O,
      children: c.map((N) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        rl,
        {
          comments: N.comments,
          localizedStrings: o,
...
function ol({ table: t }) {
  return /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(xs, { asChild: !0, children: /* @__PURE__ */ d($, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(ba, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
    /* @__PURE__ */ d(zt, { align: "end", className: "tw-w-[150px]", children: [
      /* @__PURE__ */ r($e, { children: "Toggle columns" }),
      /* @__PURE__ */ r(be, {}),
...
const le = nt.Root, al = nt.Group, we = nt.Value, sl = Lt(
...
), Zt = g.forwardRef(({ className: t, children: e, size: n, ...o }, a) => {
  const s = st();
  return /* @__PURE__ */ d(
    nt.Trigger,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(nt.Icon, { asChild: !0, children: /* @__PURE__ */ r(qt, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Zt.displayName = nt.Trigger.displayName;
...
Eo.displayName = nt.ScrollUpButton.displayName;
...
To.displayName = nt.ScrollDownButton.displayName;
const Qt = g.forwardRef(({ className: t, children: e, position: n = "popper", ...o }, a) => {
  const s = st();
  return /* @__PURE__ */ r(nt.Portal, { children: /* @__PURE__ */ d(
    nt.Content,
    {
      ref: a,
      className: u(
...
Qt.displayName = nt.Content.displayName;
...
il.displayName = nt.Label.displayName;
const mt = g.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  nt.Item,
  {
    ref: o,
    className: u(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(nt.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(nt.ItemText, { children: e })
    ]
  }
));
mt.displayName = nt.Item.displayName;
const ll = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nt.Separator,
  {
    ref: n,
    className: u("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ll.displayName = nt.Separator.displayName;
function wl({ table: t }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        le,
        {
          ...
          children: [
            /* @__PURE__ */ r(Zt, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ r(we, { placeholder: t.getState().pagination.pageSize }) }),
            /* @__PURE__ */ r(Qt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(mt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Ie(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && dl(o)
  );
}
  ...
  g.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        Ie(i, '[tabindex]:not([tabindex="-1"])').forEach((c) => {
...
const cl = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "tfoot",
  {
    ref: n,
  ...
  const l = g.useMemo(
    ...
    (c) => {
      ...
      if (c.key === "ArrowDown" || c.key === "ArrowUp")
        c.preventDefault(), ml(m, b, c.key);
      else if (c.key === "ArrowLeft" || c.key === "ArrowRight")
        c.preventDefault(), ul(l, v, c.key);
...
const Oe = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: u(
...
const Yt = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "td",
  {
    ref: n,
...
const hl = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "caption",
  {
    ref: n,
...
function fl({
  ...
  var C;
  const [c, f] = M([]), [h, m] = M([]), [b, v] = M({}), [y, O] = M({}), N = L(() => e ?? [], [e]), x = jr({
    data: N,
    columns: t,
    getCoreRowModel: Gr(),
  ...
  }), _ = x.getVisibleFlatColumns();
  let A;
  return p ? A = Array.from({ length: 10 }).map((T, R) => `skeleton-row-${R}`).map((T) => /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Yt, { colSpan: _.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(Cn, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, T)) : ((C = x.getRowModel().rows) == null ? void 0 : C.length) > 0 ? A = x.getRowModel().rows.map((E) => /* @__PURE__ */ r(
    Rt,
    {
      onClick: () => i(E, x),
      "data-state": E.getIsSelected() && "selected",
      children: E.getVisibleCells().map((S) => /* @__PURE__ */ r(Yt, { children: Ee(S.column.columnDef.cell, S.getContext()) }, S.id))
    },
    E.id
  )) : A = /* @__PURE__ */ r(Rt, { children: /* @__PURE__ */ r(Yt, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(ol, { table: x }),
    /* @__PURE__ */ d(Ye, { stickyHeader: s, children: [
      /* @__PURE__ */ r(qe, { stickyHeader: s, children: x.getHeaderGroups().map((E) => /* @__PURE__ */ r(Rt, { children: E.headers.map((S) => /* @__PURE__ */ r(Oe, { children: S.isPlaceholder ? void 0 : Ee(S.column.columnDef.header, S.getContext()) }, S.id)) }, E.id)) }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r($, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(Er, {}) })
        ] }),
...
function Sd({
  ...
  return /* @__PURE__ */ d(he, { onOpenChange: (c) => {
    c || l(!1);
  }, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: o }),
    /* @__PURE__ */ d(ee, { id: s, className: u("tw-min-w-80 tw-max-w-96", a), children: [
...
function Dd({ id: t, label: e, groups: n }) {
  const [o, a] = M(
    Object.fromEntries(
      n.map(
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ d($, { variant: "default", children: [
      /* @__PURE__ */ r(ka, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(qt, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(zt, { children: n.map((w, c) => /* @__PURE__ */ d("div", { children: [
      /* @__PURE__ */ r($e, { children: w.label }),
      /* @__PURE__ */ r(No, { children: w.itemType === 0 ? /* @__PURE__ */ r(rt, { children: w.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Pt,
        {
          checked: o[c][h],
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-1 tw-ps-4", children: [
          /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-2", children: o.slice(0, 3).map((c) => /* @__PURE__ */ r("span", { className: "tw-text-xs tw-font-semibold tw-text-foreground", children: c.toUpperCase() }, c)) }),
...
function xl({ id: t, versionHistory: e }) {
  ...
  function s(l) {
    const p = new Date(l), w = new Date(a.getTime() - p.getTime()), c = w.getUTCFullYear() - 1970, f = w.getUTCMonth(), h = w.getUTCDate() - 1;
    let m = "";
    return c > 0 ? m = `${c.toString()} year${c === 1 ? "" : "s"} ago` : f > 0 ? m = `${f.toString()} month${f === 1 ? "" : "s"} ago` : h === 0 ? m = "today" : m = `${h.toString()} day${h === 1 ? "" : "s"} ago`, m;
  }
  const i = Object.entries(e).sort((l, p) => p[0].localeCompare(l[0]));
...
function Od({
  ...
  const i = L(() => Ja(n), [n]), p = ((w) => {
    const c = new Intl.DisplayNames(Wa(), { type: "language" });
...
function yl({
  ...
  const [O, N] = M(!1), x = B(
    (R) => {
      var z;
      const P = (z = t.find((G) => G.label === R)) == null ? void 0 : z.value;
      P && n(
        e.includes(P) ? e.filter((G) => G !== P) : [...e, P]
      );
    },
    [t, e, n]
  ), _ = () => p || o, A = L(() => {
    if (!h) return t;
    const R = t.filter((z) => z.starred).sort((z, G) => z.label.localeCompare(G.label)), P = t.filter((z) => !z.starred).sort((z, G) => {
      const I = e.includes(z.value), J = e.includes(G.value);
      return I && !J ? -1 : !I && J ? 1 : z.label.localeCompare(G.label);
    });
    return [...R, ...P];
  }, [t, e, h]), C = () => {
    n(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ r("div", { id: y, className: b, children: /* @__PURE__ */ d(he, { open: S, onOpenChange: c ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ d(
      $,
      {
        variant: v,
        ...
        children: [
          ...
          /* @__PURE__ */ r(Tr, { className: "tw-ml-2 tw-h-4 tw-w-4 tw-shrink-0 tw-opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(pe, { children: [
      ...
      a && /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: C, children: s }),
        /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: E, children: i })
      ] }),
      /* @__PURE__ */ d(ue, { children: [
        /* @__PURE__ */ r(Ke, { children: l }),
        /* @__PURE__ */ r($t, { children: A.map((R) => /* @__PURE__ */ d(
          te,
          {
            value: R.label,
            onSelect: x,
...
const Nl = (t, e, n) => t === "generated" ? /* @__PURE__ */ d(rt, { children: [
  /* @__PURE__ */ r("p", { children: "+" }),
  " ",
  e["%footnoteEditor_callerDropdown_item_generated%"]
] }) : t === "hidden" ? /* @__PURE__ */ d(rt, { children: [
  /* @__PURE__ */ r("p", { children: "-" }),
  " ",
...
function kl({
  ...
  const [s, i] = M(t), [l, p] = M(n);
  return q(() => {
    i(t);
  }, [t]), q(() => {
    l !== n && p(n);
  }, [n]), /* @__PURE__ */ d(ne, { onOpenChange: (c) => {
    c || (s !== "custom" || l ? (e(s), o(l)) : (i(t), p(n)));
  }, children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r($, { variant: "outline", className: "tw-h-6", children: Nl(t, a, n) }) }) }),
      /* @__PURE__ */ r(Dt, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ d(zt, { className: "tw-z-[300]", children: [
      /* @__PURE__ */ r($e, { children: a["%footnoteEditor_callerDropdown_label%"] }),
      /* @__PURE__ */ r(be, {}),
      /* @__PURE__ */ r(
        Pt,
        {
...
const _l = (t, e) => t === "f" ? /* @__PURE__ */ d(rt, { children: [
  /* @__PURE__ */ r(Rr, {}),
  " ",
  e["%footnoteEditor_noteType_footnote_label%"]
] }) : t === "fe" ? /* @__PURE__ */ d(rt, { children: [
  /* @__PURE__ */ r(Sr, {}),
  " ",
  ...
  return t === "f" && (n = e["%footnoteEditor_noteType_footnote_label%"]), Xt(e["%footnoteEditor_noteType_tooltip%"] ?? "", {
    noteType: n
  });
};
function El({
  ...
  return /* @__PURE__ */ d(ne, { children: [
    /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(us, { asChild: !0, children: /* @__PURE__ */ r(ge, { asChild: !0, children: /* @__PURE__ */ r(
        $,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ r(Dt, { children: /* @__PURE__ */ r("p", { children: Cl(t, n) }) })
    ] }) }),
    t !== "x" && /* @__PURE__ */ d(zt, { className: "tw-z-[300]", children: [
      /* @__PURE__ */ r($e, { children: n["%footnoteEditor_noteTypeDropdown_label%"] }),
      /* @__PURE__ */ r(be, {}),
      /* @__PURE__ */ d(
        Pt,
        {
...
function Md({
  ...
  const l = et(null), p = la(), [w, c] = M("generated"), [f, h] = M("*"), [m, b] = M("f"), v = L(
    () => ({
      ...s,
  ...
  q(() => {
    ...
    if (_ && nn("note", _)) {
      const E = (A = _.insert.note) == null ? void 0 : A.caller;
      let S = "custom";
      E === hn ? S = "generated" : E === fn ? S = "hidden" : E && h(E), c(S), b(((C = _.insert.note) == null ? void 0 : C.style) ?? "f"), _.insert.note && (_.insert.note.caller = ""), x = setTimeout(() => {
        var T;
        (T = l.current) == null || T.applyUpdate([{ delete: 1 }, _]);
      }, 0);
    }
    return () => {
      x && clearTimeout(x);
  ...
  const y = B(() => {
    var _, A;
    const x = (A = (_ = l.current) == null ? void 0 : _.getNoteOps(0)) == null ? void 0 : A.at(0);
    x && nn("note", x) && (x.insert.note && (w === "custom" ? x.insert.note.caller = f : x.insert.note.caller = w === "generated" ? hn : fn), e([x]));
  }, [w, f, e]), O = () => {
    var _;
    const x = (_ = p.current) == null ? void 0 : _.getElementsByClassName("editor-input")[0];
  ...
  return /* @__PURE__ */ d("div", { className: "footnote-editor tw-grid tw-gap-[12px]", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ r(
          El,
          {
            ...
            handleNoteTypeChange: (x) => {
              var A, C, E;
              b(x);
              const _ = (C = (A = l.current) == null ? void 0 : A.getNoteOps(0)) == null ? void 0 : C.at(0);
              _ && nn("note", _) && (_.insert.note && (_.insert.note.style = x), (E = l.current) == null || E.applyUpdate([{ delete: 1 }, _]));
            },
            localizedStrings: i
          }
        ),
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
          /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(Me, {}) }) }),
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ r(Ts, { options: v, onScrRefChange: () => {
          }, scrRef: o, ref: l }),
          /* @__PURE__ */ r("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ r(St, { children: /* @__PURE__ */ d(At, { children: [
            /* @__PURE__ */ r(Kt, { asChild: !0, children: /* @__PURE__ */ r($, { onClick: O, className: "tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Er, {}) }) }),
...
function Tl(t, e, n = !0, o = void 0) {
  ...
  }), i.length > 0 && s.push(i), s.map((l, p) => {
    const w = p === s.length - 1;
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ d(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ r(pn, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
function Sl({
  ...
  const p = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, w = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, c = /* @__PURE__ */ d(rt, { children: [
...
const Pd = ["%webView_footnoteList_header%"], Dl = (t, e) => t[e] ?? e;
function $d({
  className: t,
  classNameForItems: e,
  footnotes: n,
  ...
  const f = c ? Dl(c, "%webView_footnoteList_header%") : "Footnotes", h = p ?? Za(n, void 0), m = (x, _) => {
    w == null || w(x, _, a);
  }, b = s ? n.findIndex((x) => x === s) : 0, [v, y] = M(b), O = (x) => {
    if (n.length)
      switch (x.key) {
        case "ArrowDown":
          x.preventDefault(), y((_) => Math.min(_ + 1, n.length - 1));
          break;
        case "ArrowUp":
  ...
  return q(() => {
    var x;
    v >= 0 && v < N.current.length && ((x = N.current[v]) == null || x.focus());
  }, [v]), /* @__PURE__ */ d(rt, { children: [
          ...
          "div",
          {
            ...
            children: n.map((x, _) => {
              ...
              return /* @__PURE__ */ d(rt, { children: [
                ...
                _ < n.length - 1 && o === "vertical" && /* @__PURE__ */ r(ie, {})
              ] });
            })
          }
        )
...
function Ol({
  ...
  const o = n["%webView_inventory_occurrences_table_header_reference%"], a = n["%webView_inventory_occurrences_table_header_occurrence%"], s = L(() => {
    ...
    return t.forEach((p) => {
      const w = `${p.reference.book}:${p.reference.chapterNum}:${p.reference.verseNum}:${p.text}`;
      l.has(w) || (l.add(w), i.push(p));
    }), i;
  }, [t]);
  return /* @__PURE__ */ d(Ye, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Je, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ d(
      Rt,
      {
        ...
        children: [
          /* @__PURE__ */ r(Yt, { children: `${K.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
          /* @__PURE__ */ r(Yt, { children: Il(i.text) })
        ]
      },
...
const Yn = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gn.Root,
  {
    ref: n,
    className: u(
...
Yn.displayName = gn.Root.displayName;
const We = (t) => t === "asc" ? /* @__PURE__ */ r(Oa, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(Va, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(Ma, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Ld = (t) => ({
  accessorKey: "item",
  accessorFn: (e) => e.items[0],
  header: ({ column: e }) => /* @__PURE__ */ d($, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    We(e.getIsSorted())
  ] })
}), Vl = (t, e) => ({
  ...
  accessorKey: "count",
  header: ({ column: e }) => /* @__PURE__ */ r("div", { className: "tw-flex tw-justify-end tw-tabular-nums", children: /* @__PURE__ */ d($, { variant: "ghost", onClick: () => e.toggleSorting(void 0), children: [
    t,
    We(e.getIsSorted())
  ] }) }),
  ...
  let i = [...n];
  t.forEach((p) => {
    e === "approved" ? i.includes(p) || i.push(p) : i = i.filter((w) => w !== p);
  }), o(i);
  let l = [...a];
  t.forEach((p) => {
    e === "unapproved" ? l.includes(p) || l.push(p) : l = l.filter((w) => w !== p);
  }), s(l);
}, Bd = (t, e, n, o, a) => ({
  accessorKey: "status",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(Hn, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Te,
        {
          onClick: (p) => {
            p.stopPropagation(), an(
              [l],
              "approved",
              e,
              n,
  ...
  return e ? e[1] : "";
}, Ml = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Hd = Object.freeze([
...
function Xd({
  ...
  const f = yt(n, "%webView_inventory_all%"), h = yt(n, "%webView_inventory_approved%"), m = yt(n, "%webView_inventory_unapproved%"), b = yt(n, "%webView_inventory_unknown%"), v = yt(n, "%webView_inventory_scope_currentBook%"), y = yt(n, "%webView_inventory_scope_chapter%"), O = yt(n, "%webView_inventory_scope_verse%"), N = yt(n, "%webView_inventory_filter_text%"), x = yt(
    n,
    "%webView_inventory_show_additional_items%"
  ), _ = yt(n, "%webView_inventory_no_results%"), [A, C] = M(!1), [E, S] = M("all"), [T, R] = M(""), [P, z] = M([]), G = L(() => {
    const k = t ?? [];
    return k.length === 0 ? [] : Pl(k, a, s);
  }, [t, a, s]), I = L(() => {
    if (A) return G;
    const k = [];
    return G.forEach((Y) => {
      const ut = Y.items[0], xt = k.find(
        (Et) => Et.items[0] === ut
      );
      xt ? (xt.count += Y.count, xt.occurrences = xt.occurrences.concat(Y.occurrences)) : k.push({
        items: [ut],
        count: Y.count,
  ...
  }, [A, G]), J = L(() => I.length === 0 ? [] : Al(I, E, T), [I, E, T]), V = L(() => {
    var ut, xt;
    if (!A) return p;
    const k = (ut = o == null ? void 0 : o.tableHeaders) == null ? void 0 : ut.length;
    if (!k) return p;
    const Y = [];
    for (let Et = 0; Et < k; Et++)
      Y.push(
        Vl(
          ((xt = o == null ? void 0 : o.tableHeaders) == null ? void 0 : xt[Et]) || "Additional Item",
          Et + 1
        )
      );
    return [...Y, ...p];
  }, [o == null ? void 0 : o.tableHeaders, p, A]);
  q(() => {
    J.length === 0 ? z([]) : J.length === 1 && z(J[0].items);
  }, [J]);
  const W = (k, Y) => {
    Y.setRowSelection(() => {
      const ut = {};
    ...
    if (I.length === 0 || P.length === 0) return [];
    const k = I.filter((Y) => Dr(
      A ? Y.items : [Y.items[0]],
      P
    ));
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        le,
        {
          onValueChange: (k) => Vt(k),
          defaultValue: E,
          children: [
            /* @__PURE__ */ r(Zt, { className: "tw-m-1", children: /* @__PURE__ */ r(we, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ d(Qt, { children: [
              /* @__PURE__ */ r(mt, { value: "all", children: f }),
              /* @__PURE__ */ r(mt, { value: "approved", children: h }),
              /* @__PURE__ */ r(mt, { value: "unapproved", children: m }),
              /* @__PURE__ */ r(mt, { value: "unknown", children: b })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(le, { onValueChange: (k) => ht(k), defaultValue: i, children: [
        /* @__PURE__ */ r(Zt, { className: "tw-m-1", children: /* @__PURE__ */ r(we, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(Qt, { children: [
          /* @__PURE__ */ r(mt, { value: "book", children: v }),
          /* @__PURE__ */ r(mt, { value: "chapter", children: y }),
          /* @__PURE__ */ r(mt, { value: "verse", children: O })
        ] })
      ] }),
      /* @__PURE__ */ r(
        ve,
      ...
      o && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ r(at, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (o == null ? void 0 : o.checkboxText) ?? x })
      ] })
    ] }),
...
const $l = "16rem", Ll = "3rem", So = g.createContext(void 0);
function Ze() {
...
const Do = g.forwardRef(
  ({
    ...
    const [w, c] = g.useState(t), f = e ?? w, h = g.useCallback(
      (x) => {
        const _ = typeof x == "function" ? x(f) : x;
        n ? n(_) : c(_);
      },
      [n, f]
    ), m = g.useCallback(() => h((x) => !x), [h]), b = f ? "expanded" : "collapsed", O = st() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = g.useMemo(
      () => ({
        state: b,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(So.Provider, { value: N, children: /* @__PURE__ */ r(St, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const zl = g.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = Ze();
  return /* @__PURE__ */ d(
    $,
    {
...
const jl = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ve,
  {
    ref: n,
    "data-sidebar": "input",
...
En.displayName = "SidebarGroup";
const Tn = g.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? de : "div",
  {
    ref: o,
...
const Xl = g.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? de : "button",
  {
    ref: o,
...
Rn.displayName = "SidebarGroupContent";
...
const Ul = Lt(
  ...
  ({
    ...
    const p = t ? de : "button", { state: w } = Ze(), c = /* @__PURE__ */ r(
      p,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: u(Ul({ variant: n, size: o }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Kt, { asChild: !0, children: c }),
...
const ql = g.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      ...n,
      children: [
        e && /* @__PURE__ */ r(Cn, { className: "tw-size-4 tw-rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ r(
          Cn,
          {
...
const Zl = g.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? de : "a",
  {
    ref: s,
...
function Ql({
  ...
  return /* @__PURE__ */ r(
    Io,
    {
      ...
      collapsible: "none",
      variant: "inset",
      className: u("tw-w-96 tw-gap-2 tw-overflow-y-auto", p),
      children: /* @__PURE__ */ d(Vo, { children: [
        /* @__PURE__ */ d(En, { children: [
          /* @__PURE__ */ r(Tn, { className: "tw-text-sm", children: s }),
          /* @__PURE__ */ r(Rn, { children: /* @__PURE__ */ r(Mo, { children: Object.entries(e).map(([h, m]) => /* @__PURE__ */ r(Ao, { children: /* @__PURE__ */ r(
            Po,
            {
              onClick: () => w(h),
              isActive: f(h),
        ...
        /* @__PURE__ */ d(En, { children: [
          /* @__PURE__ */ r(Tn, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(Rn, { className: "tw-pl-3", children: /* @__PURE__ */ r(
            yn,
            {
              buttonVariant: "ghost",
...
const Mt = "scrBook", tw = "scrRef", Gt = "source", ew = "details", nw = "Scripture Reference", rw = "Scripture Book", $o = "Type", ow = "Details";
function aw(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? K.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === Mt ? re(a.start) : void 0;
      },
      getGroupingValue: (o) => K.bookIdToNumber(o.start.book),
...
const sw = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || un(t.start, t.end) === 0 ? `${en(t.start)}+${e}` : `${en(t.start)}+${e}-${en(t.end)}+${n}`;
}, xr = (t) => `${sw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Kd({
  sources: t,
  ...
  const [w, c] = M([]), [f, h] = M([{ id: Mt, desc: !1 }]), [m, b] = M({}), v = L(
    () => t.flatMap((T) => T.data.map((R) => ({
      ...R,
      source: T.source
    }))),
    [t]
  ...
  q(() => {
    if (l) {
      const T = O.getSelectedRowModel().rowsById, R = Object.keys(T);
      if (R.length === 1) {
        const P = v.find((z) => xr(z) === R[0]) || void 0;
        P && l(P);
      }
    }
  }, [m, v, l, O]);
  const N = a ?? rw, x = s ?? $o, _ = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Mt] },
    { label: `Group by ${x}`, value: [Gt] },
    {
    ...
    !T.getIsGrouped() && !T.getIsSelected() && T.getToggleSelectedHandler()(R);
  }, E = (T, R) => T.getIsGrouped() ? "" : u("banded-row", R % 2 === 0 ? "even" : "odd"), S = (T, R, P) => {
    if (!((T == null ? void 0 : T.length) === 0 || R.depth < P.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: p, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !e && /* @__PURE__ */ d(
      le,
      {
        ...
        children: [
          /* @__PURE__ */ r(Zt, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ r(we, {}) }),
          /* @__PURE__ */ r(Qt, { position: "item-aligned", children: /* @__PURE__ */ r(al, { children: _.map((T) => /* @__PURE__ */ r(mt, { value: JSON.stringify(T.value), children: T.label }, T.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Ye, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(qe, { children: O.getHeaderGroups().map((T) => /* @__PURE__ */ r(Rt, { children: T.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(Oe, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          ...
          " ",
          Ee(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, T.id)) }),
      /* @__PURE__ */ r(Je, { children: O.getRowModel().rows.map((T, R) => {
        const P = st();
        return /* @__PURE__ */ r(
          Rt,
          {
            ...
            children: T.getVisibleCells().map((z) => {
              if (!(z.getIsPlaceholder() || z.column.columnDef.enableGrouping && !z.getIsGrouped() && (z.column.columnDef.id !== Gt || !n)))
                return /* @__PURE__ */ r(
                  Yt,
                  {
                    className: u(
                    ...
                    children: z.getIsGrouped() ? /* @__PURE__ */ d(
                      $,
                      {
                        variant: "link",
                        ...
                        type: "button",
                        children: [
                          T.getIsExpanded() && /* @__PURE__ */ r(qt, {}),
                          !T.getIsExpanded() && (P === "ltr" ? /* @__PURE__ */ r(ae, {}) : /* @__PURE__ */ r(dn, {})),
                          " ",
                          Ee(z.column.columnDef.cell, z.getContext()),
                          " (",
                          T.subRows.length,
                          ")"
                        ]
...
const Jn = (t, e) => t.filter((n) => {
  try {
    return _e(n) === e;
  } catch {
    return !1;
  }
}), Lo = (t, e, n) => Jn(t, e).every((o) => n.includes(o));
function iw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = Jn(e, t).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], p = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    $,
    {
      variant: "outline",
...
function lw({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], p = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], c = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: m, dcLong: b, extraLong: v } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [y, O] = M(!1), [N, x] = M(""), _ = et(void 0), A = et(!1);
  if (t.length !== K.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const C = L(() => K.allBookIds.filter(
    (I, J) => t[J] === "1" && !K.isObsolete(K.bookIdToNumber(I))
  ), [t]), E = L(() => {
    if (!N.trim()) {
      const V = {
        [F.OT]: [],
    ...
    (I, J = !1) => {
      if (!J || !_.current) {
        n(
          e.includes(I) ? e.filter((k) => k !== I) : [...e, I]
        ), _.current = I;
        return;
      }
      const V = C.findIndex((k) => k === _.current), W = C.findIndex((k) => k === I);
      if (V === -1 || W === -1) return;
      const [ht, Vt] = [
        Math.min(V, W),
        Math.max(V, W)
      ], vt = C.slice(ht, Vt + 1).map((k) => k);
      n(
        e.includes(I) ? e.filter((k) => !vt.includes(k)) : [.../* @__PURE__ */ new Set([...e, ...vt])]
      );
    },
    [e, n, C]
  ), T = (I) => {
    S(I, A.current), A.current = !1;
  }, R = (I, J) => {
    I.preventDefault(), S(J, I.shiftKey);
  }, P = B(
    (I) => {
      const J = Jn(C, I).map((V) => V);
      n(
        Lo(C, I, e) ? e.filter((V) => !J.includes(V)) : [.../* @__PURE__ */ new Set([...e, ...J])]
      );
    },
    [e, n, C]
  ), z = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(F).map((I) => /* @__PURE__ */ r(
      iw,
      {
        section: I,
        availableBookIds: C,
        ...
        children: [
          ...
          /* @__PURE__ */ r(ee, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            pe,
            {
              shouldFilter: !1,
              onKeyDown: (I) => {
                I.key === "Enter" && (A.current = I.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Pe,
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: z, children: p }),
                  /* @__PURE__ */ r($, { variant: "ghost", size: "sm", onClick: G, children: w })
                ] }),
                /* @__PURE__ */ d(ue, { children: [
                  /* @__PURE__ */ r(Ke, { children: c }),
                  Object.values(F).map((I, J) => {
                    const V = E[I];
                    if (V.length !== 0)
                      return /* @__PURE__ */ d(Nr, { children: [
                        ...
                        J < Object.values(F).length - 1 && /* @__PURE__ */ r(Yr, {})
                      ] }, I);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === sn ? sn : yr
      ).map((I) => /* @__PURE__ */ r(De, { className: "hover:tw-bg-secondary", variant: "secondary", children: oe(I, a) }, I)),
      e.length > sn && /* @__PURE__ */ r(
        De,
        {
...
function qd({
  ...
  const w = jt(
    ...
    i,
    "%webView_scope_selector_current_chapter%"
  ), h = jt(i, "%webView_scope_selector_current_book%"), m = jt(i, "%webView_scope_selector_choose_books%"), b = jt(i, "%webView_scope_selector_scope%"), v = jt(i, "%webView_scope_selector_select_books%"), y = [
  ...
  ], O = e ? y.filter((N) => e.includes(N.value)) : y;
  return /* @__PURE__ */ d("div", { id: p, className: "tw-grid tw-gap-4", children: [
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(at, { children: b }),
      /* @__PURE__ */ r(
        Bn,
        {
          value: t,
          ...
          children: O.map(({ value: N, label: x, id: _ }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(Fe, { className: "tw-me-2", value: N, id: _ }),
            /* @__PURE__ */ r(at, { htmlFor: _, children: x })
          ] }, _))
        }
      )
    ] }),
    t === "selectedBooks" && /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      /* @__PURE__ */ r(at, { children: v }),
      /* @__PURE__ */ r(
        lw,
        {
          availableBookInfo: o,
...
function Jd({
  ...
  return /* @__PURE__ */ d(
    le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Zt, { size: a, className: u("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          we,
          {
            placeholder: l[U(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          ...
          {
            id: i,
            align: p === "rtl" ? "end" : "start",
            style: { zIndex: 250 },
            children: t.map((w) => /* @__PURE__ */ r(mt, { value: `${w}`, children: l[U(w)] }, `${w}`))
          }
        )
      ]
    }
...
const Bo = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((l) => l.group === s).sort((l, p) => l.order - p.order).map((l) => /* @__PURE__ */ d(At, { children: [
  ...
  ) : /* @__PURE__ */ d(tl, { children: [
    /* @__PURE__ */ r(ko, { children: l.label }),
    /* @__PURE__ */ r(Qi, { children: /* @__PURE__ */ r(_o, { children: Bo(
      t,
      e,
      zo(t, l.id),
      o
...
function Sn({
  ...
  return /* @__PURE__ */ d(ne, { variant: s, children: [
    /* @__PURE__ */ r(ge, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r($, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(La, {}) }) }),
    /* @__PURE__ */ r(zt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, w]) => typeof p == "boolean" || typeof w == "boolean" ? 0 : p.order - w.order).map(([p], w, c) => /* @__PURE__ */ d(Nr, { children: [
      /* @__PURE__ */ r(No, { children: /* @__PURE__ */ r(St, { children: Bo(e.groups, e.items, p, t) }) }),
      w < c.length - 1 && /* @__PURE__ */ r(be, {})
    ] }, p)) })
  ] });
}
...
Fo.displayName = ct.List.displayName;
...
Go.displayName = ct.List.displayName;
const ww = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Trigger,
  {
    ref: n,
    ...e,
...
Ho.displayName = ct.Content.displayName;
function nc({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Fo, { children: [
      /* @__PURE__ */ r(Go, { children: t.map((l) => /* @__PURE__ */ r(ww, { value: l.value, children: l.value }, l.key)) }),
...
const Xo = g.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  ...
  return /* @__PURE__ */ r(Un.Provider, { value: a, children: /* @__PURE__ */ r(
    Q.Root,
    {
      ref: o,
      className: u(
...
const Uo = g.forwardRef(({ className: t, ...e }, n) => {
  const o = bt();
  return /* @__PURE__ */ r(
    Q.Trigger,
    {
...
Ko.displayName = Q.SubTrigger.displayName;
...
const pw = g.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = bt();
  return /* @__PURE__ */ d(
    Q.CheckboxItem,
    {
      ...
      ...o,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Q.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
        e
      ]
    }
  );
});
pw.displayName = Q.CheckboxItem.displayName;
const uw = g.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = bt();
  return /* @__PURE__ */ d(
    Q.RadioItem,
    {
...
uw.displayName = Q.RadioItem.displayName;
const mw = g.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  Q.Label,
  {
    ref: o,
    className: u("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
mw.displayName = Q.Label.displayName;
...
const Ne = (t, e) => {
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((w) => w.group === s).sort((w, c) => w.order - c.order).map((w) => /* @__PURE__ */ d(At, { children: [
      /* @__PURE__ */ r(Kt, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        ...
        /* @__PURE__ */ r(Ko, { children: w.label }),
    ...
    ] }, `tooltip-${w.label}-${"command" in w ? w.command : w.id}`)), p = [...l];
    return l.length > 0 && i < a.length - 1 && p.push(/* @__PURE__ */ r(Wo, {}, `separator-${s}`)), p;
  });
};
function hw({
  menuData: t,
  ...
  const a = et(void 0), s = et(void 0), i = et(void 0), l = et(void 0), p = et(void 0), w = (c) => {
    switch (c) {
      case "platform.app":
        return s;
  ...
  if (Rs(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (c, f) => {
    var b, v, y, O;
    c.preventDefault();
    ...
    switch (f.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (b = s.current) == null || b.focus(), Ne(s, [h, m]);
        break;
      case "alt+l":
        (v = i.current) == null || v.focus(), Ne(i, [h, m]);
        break;
      case "alt+n":
        (y = l.current) == null || y.focus(), Ne(l, [h, m]);
        break;
      case "alt+h":
        (O = p.current) == null || O.focus(), Ne(p, [h, m]);
        break;
    }
  }), q(() => {
    ...
    return a.current.querySelectorAll("[data-state]").forEach((m) => {
      c.observe(m, { attributes: !0 });
    }), () => c.disconnect();
  }, [n]), !!t)
    return /* @__PURE__ */ r(Xo, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, f]) => typeof c == "boolean" || typeof f == "boolean" ? 0 : c.order - f.order).map(([c, f]) => /* @__PURE__ */ d(dw, { children: [
      /* @__PURE__ */ r(Uo, { ref: w(c), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        qo,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(St, { children: Zo(t.groups, t.items, c, e) })
        }
      )
    ] }, c)) });
}
...
function ac({
  ...
  const w = fw(
    ...
    var O, N, x, _, A, C;
    const y = v !== b ? ((N = (O = t[b]) == null ? void 0 : O.uiNames) == null ? void 0 : N[v]) ?? ((_ = (x = t[b]) == null ? void 0 : x.uiNames) == null ? void 0 : _.en) : void 0;
    return y ? `${(A = t[b]) == null ? void 0 : A.autonym} (${y})` : (C = t[b]) == null ? void 0 : C.autonym;
  };
  return /* @__PURE__ */ d("div", { id: p, className: u("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      le,
      {
        name: "uiLanguage",
        ...
        onOpenChange: (b) => f(b),
        children: [
          /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(we, {}) }),
          /* @__PURE__ */ r(
            Qt,
            {
              className: "tw-z-[250]",
              children: Object.keys(t).map((b) => /* @__PURE__ */ r(mt, { value: b, children: m(b, e) }, b))
            }
          )
        ]
      }
    ),
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(at, { className: "tw-font-normal tw-text-muted-foreground", children: Xt(w, {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(ne, { children: [
              /* @__PURE__ */ r(ge, { className: u(w && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r($, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cr, {}) }) }),
              /* @__PURE__ */ r(zt, { align: "end", children: l })
            ] })
          ] }),
...
const bw = Ve(({ className: t, ...e }, n) => /* @__PURE__ */ r(ja, { size: 35, className: u("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ d("div", { className: u("tw-inline-grid tw-items-center tw-gap-1.5", { "tw-w-full": o }), children: [
    ...
    /* @__PURE__ */ r(
      ve,
      {
        ...
        placeholder: i,
        required: l,
        className: u(p, { "tw-border-red-600": n }),
        defaultValue: w,
        value: c,
        onChange: f,
        onFocus: h,
...
), xw = g.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
const Nw = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: u("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
Nw.displayName = "AlertDescription";
const wc = tt.Root, dc = tt.Trigger, cc = tt.Group, pc = tt.Portal, uc = tt.Sub, mc = tt.RadioGroup, kw = g.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ d(
  tt.SubTrigger,
  {
    ref: a,
    className: u(
...
kw.displayName = tt.SubTrigger.displayName;
const _w = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.SubContent,
  {
    ref: n,
    className: u(
...
_w.displayName = tt.SubContent.displayName;
const Cw = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(tt.Portal, { children: /* @__PURE__ */ r(
  tt.Content,
  {
    ref: n,
    className: u(
...
Cw.displayName = tt.Content.displayName;
const Ew = g.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Item,
  {
    ref: o,
    className: u(
...
Ew.displayName = tt.Item.displayName;
const Tw = g.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ d(
  tt.CheckboxItem,
  {
    ref: a,
    className: u(
    ...
    ...o,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(tt.ItemIndicator, { children: /* @__PURE__ */ r(_t, { className: "tw-h-4 tw-w-4" }) }) }),
      e
    ]
  }
));
Tw.displayName = tt.CheckboxItem.displayName;
const Rw = g.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ d(
  tt.RadioItem,
  {
    ref: o,
    className: u(
...
Rw.displayName = tt.RadioItem.displayName;
const Sw = g.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  tt.Label,
  {
    ref: o,
    className: u(
...
Sw.displayName = tt.Label.displayName;
const Dw = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  tt.Separator,
  {
    ref: n,
...
Dw.displayName = tt.Separator.displayName;
...
const hc = gt.Trigger, Vw = gt.Portal, fc = gt.Close, ta = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  gt.Overlay,
  {
    ref: n,
...
ta.displayName = gt.Overlay.displayName;
const Mw = g.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
...
$w.displayName = gt.Title.displayName;
...
Lw.displayName = gt.Description.displayName;
const zw = g.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  bn.Root,
  {
    ref: o,
    className: u(
...
zw.displayName = bn.Root.displayName;
function gc({
  className: t,
  ...e
}) {
...
Bw.displayName = ke.Root.displayName;
const jw = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    vn.Root,
    {
...
jw.displayName = vn.Root.displayName;
const yc = ct.Root, Fw = g.forwardRef(({ className: t, ...e }, n) => {
  const o = st();
  return /* @__PURE__ */ r(
    ct.List,
    {
...
Fw.displayName = ct.List.displayName;
...
Gw.displayName = ct.Trigger.displayName;
const Hw = g.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ct.Content,
  {
    ref: n,
    className: u(
...
Hw.displayName = ct.Content.displayName;
...
const Kw = (t, e, n = {}) => {
  ...
  o.current = e;
  const a = et(n);
  a.current = Uw(a.current);
  const [s, i] = M(() => o.current), [l, p] = M(!0);
  return q(() => {
    let w = !0;
    return p(!!t), (async () => {
      if (t) {
...
export {
  ...
  Zi as AvatarImage,
  Nd as BOOK_CHAPTER_CONTROL_STRING_KEYS,
  kd as BOOK_SELECTOR_STRING_KEYS,
  De as Badge,
  yd as BookChapterControl,
  ni as BookSelectionMode,
  _d as BookSelector,
  $ as Button,
  Cd as COMMENT_LIST_STRING_KEYS,
  Xn as Card,
  vo as CardContent,
  ...
  hc as DrawerTrigger,
  ne as DropdownMenu,
  Pt as DropdownMenuCheckboxItem,
  ...
  bl as ErrorDump,
  Sd as ErrorPopover,
  Ad as FOOTNOTE_EDITOR_STRING_KEYS,
  Pd as FOOTNOTE_LIST_STRING_KEYS,
  Vd as Filter,
  Dd as FilterDropdown,
  Od as Footer,
  Md as FootnoteEditor,
  Sl as FootnoteItem,
  $d as FootnoteList,
  Hd as INVENTORY_STRING_KEYS,
  ve as Input,
  Xd as Inventory,
  at as Label,
  Td as MarkdownRenderer,
  Id as MoreInfo,
  yl as MultiSelectComboBox,
  nc as NavigationContentSearch,
  he as Popover,
  vd as PopoverAnchor,
  ...
  vc as ResizableHandle,
  bc as ResizablePanel,
  gc as ResizablePanelGroup,
  ic as ResultsCard,
  Yd as SCOPE_SELECTOR_STRING_KEYS,
  qd as ScopeSelector,
  Kd as ScriptureResultsViewer,
  Jd as ScrollGroupSelector,
  qn as SearchBar,
  le as Select,
  Qt as SelectContent,
  al as SelectGroup,
  ...
  ie as Separator,
  Wd as SettingsList,
  Qd as SettingsListHeader,
  Zd as SettingsListItem,
  Ql as SettingsSidebar,
  Ud as SettingsSidebarContentSearch,
  Io as Sidebar,
  ...
  u as cn,
  Gd as getBookIdFromUSFM,
  jd as getLinesFromUSFM,
  Fd as getNumberFromUSFM,
  Ml as getStatusForItem,
  rc as getToolbarOSReservedSpaceClassName,
  zd as inventoryCountColumn,
  Ld as inventoryItemColumn,
