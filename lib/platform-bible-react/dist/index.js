...
import c, { forwardRef as Ut, createContext as Hn, useContext as Un, useCallback as tt, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as qn } from "react";
...
import { useReactTable as We, getFilteredRowModel as Rr, getSortedRowModel as Ze, getPaginationRowModel as Tr, getCoreRowModel as Qe, flexRender as Pt, getGroupedRowModel as _r, getExpandedRowModel as zr } from "@tanstack/react-table";
...
const ze = D.allBookIds.filter((t) => !D.isObsolete(D.bookIdToNumber(t))), Qr = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  return ct(() => {
    ...
    const C = setTimeout(() => {
      if (x && k.current && P.current) {
        const O = P.current.offsetTop - ta;
      ...
      Gt,
      {
        ...
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((C, z) => {
          ...
          return O.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Wt, { className: "tw-font-semibold tw-text-foreground/80", children: Qr[C] }),
...
const oa = vt(
  ...
  ({ className: t, variant: e, size: n, asChild: a = !1, ...o }, i) => /* @__PURE__ */ r(a ? Rt : "button", { className: w(oa({ variant: e, size: n, className: t })), ref: i, ...o })
);
M.displayName = "Button";
const sa = vt(
  "tw-text-sm tw-font-medium tw-leading-none peer-disabled:tw-cursor-not-allowed peer-disabled:tw-opacity-70"
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ke.Root, { ref: n, className: w("pr-twp", sa(), t), ...e }));
...
const Yt = Ut(({ className: t, ...e }, n) => /* @__PURE__ */ r(ar, { size: 35, className: w("tw-animate-spin", t), ...e, ref: n }));
  ...
  return /* @__PURE__ */ r(
    M,
    {
      ...
      children: t ? /* @__PURE__ */ r(Yt, { size: 15 }) : /* @__PURE__ */ d(Ct, { children: [
        /* @__PURE__ */ r(or, { size: 25, className: w("tw-h-4 tw-w-4", { "tw-mr-1": n }) }),
        n
      ] })
    }
  );
...
function is({ id: t, markdown: e, className: n, anchorTarget: a }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, className: w("pr-twp tw-prose", n), children: /* @__PURE__ */ r(Er, { options: o, children: e }) });
}
const ka = Ut((t, e) => /* @__PURE__ */ d(
  M,
  {
    ref: e,
...
function Ta({ className: t, variant: e, ...n }) {
  return /* @__PURE__ */ r("div", { className: w("pr-twp", Ra({ variant: e }), t), ...n });
}
function _a({
  entries: t,
...
function ps({
  ...
  return /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
    ...
    n.length > 0 ? /* @__PURE__ */ r("div", { className: "tw-flex tw-flex-wrap tw-items-center tw-gap-2", children: n.map((f) => {
      var g;
      return /* @__PURE__ */ d(Ta, { variant: "muted", className: "tw-flex tw-items-center tw-gap-1", children: [
        /* @__PURE__ */ r(
          M,
          {
            variant: "ghost",
...
const xn = vt(
  ...
  {
    ref: o,
    className: w(xn({ variant: e, size: n, className: t })),
    ...a
  }
));
...
const ee = (t) => t === "asc" ? /* @__PURE__ */ r(mr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), us = (t) => ({
  accessorKey: "item",
  ...
  cell: ({ row: i }) => {
    ...
    return /* @__PURE__ */ d(Nn, { value: l, variant: "outline", type: "single", children: [
      /* @__PURE__ */ r(
        Lt,
        {
          onClick: () => ie(
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(ga, { children: P.map((b) => /* @__PURE__ */ r(W, { value: JSON.stringify(b.value), children: b.label }, b.label)) }) })
        ]
      }
    ),
...
function Cs({
  ...
  return /* @__PURE__ */ d(Kt, { variant: i, children: [
    ...
    /* @__PURE__ */ r(Gt, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(qn, { children: [
...
function Ss({
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Bn, { children: [
      /* @__PURE__ */ r(On, { children: t.map((l) => /* @__PURE__ */ r(io, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(Pn, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function wo({ ...t }) {
...
const Bt = (t, e) => {
  ...
  return o.flatMap(([i], l) => {
    ...
    return s.length > 0 && l < o.length - 1 && p.push(/* @__PURE__ */ r(Yn, {}, `separator-${i}`)), p;
  });
};
function mo({
  menuData: t,
