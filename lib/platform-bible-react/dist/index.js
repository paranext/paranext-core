...
import rt, { useRef as G, useMemo as F, useState as I, useCallback as P, useEffect as X, useLayoutEffect as ee, createContext as la, useContext as to, Component as is, createElement as Oo, Suspense as ss, forwardRef as da, Fragment as eo } from "react";
...
const Rr = 250, ei = 300, lo = 400, yl = 450, kl = 500, Nl = 550, ri = ye(
...
const _l = "layoutDirection";
function bt() {
  const t = localStorage.getItem(_l);
  return t === "rtl" ? t : "ltr";
}
function Ga({ ...t }) {
...
function ba({
  ...
  const E = bt(), [T, C] = I(!1), [j, O] = I(""), [k, x] = I(""), [b, _] = I("books"), [S, V] = I(void 0), [K, L] = I(
    void 0
  ), [q, D] = I(void 0), [W, pt] = I(!1), _t = G(null), $t = G(!1), tt = G(void 0), Rt = G(void 0), U = G(void 0), ot = G(void 0), it = G({}), st = G({}), ct = P(
    (N) => {
      e(N), c && c(N);
    },
    [e, c]
  ...
  const Bt = P(() => {
    ...
    () => Ml(k),
    [k]
  ), kt = F(() => !l || !R || !R.chapterNum || !gt ? !1 : l(R.book, R.chapterNum) > 0, [l, R, gt]), Ke = P(
    (N) => w ? Xo(N, w) : !1,
    [w]
  ), Pe = P(
    (N) => (H) => w ? Al(N, H, w) : !1,
            ...
            children: [
              ...
              !W && /* @__PURE__ */ u(Re, { ref: U, children: [
                b === "books" && /* @__PURE__ */ u(at, { children: [
                  ...
                  R && kt && R.chapterNum && l && /* @__PURE__ */ u(at, { children: [
...
function tn({
  ...
  const [T, C] = I(!1), j = l ?? d, O = (x) => x.length > 0 && typeof x[0] == "object" && "options" in x[0], k = (x, b) => {
...
function Fp({
  ...
  const w = xa(l, "%webView_bookSelector_currentBook%"), g = xa(l, "%webView_bookSelector_choose%"), m = xa(l, "%webView_bookSelector_chooseBooks%"), [p, f] = I(
    "current book"
    /* CurrentBook */
  ), y = (v) => {
    f(v), t(v);
...
function td(t, e, r = "self") {
  ...
  if (e.isSelected(t) && !uc(e) && o !== null) {
    ...
    if (l || w) {
      const [g, m] = pc(t), p = c.is(d), f = e.is(s ? d : c), y = e.is(s ? c : d);
      let v, z = 0;
      p ? (z = g > m ? m : g, v = g > m ? g : m) : f ? (z = s ? m : g, v = void 0) : y && (z = 0, v = s ? g : m);
      const E = e.__text.slice(z, v);
      E !== e.__text && (r === "clone" && (e = gc(e)), e.__text = E);
    }
  }
  return e;
}
...
function ad(t, e, r) {
  ...
  function d() {
    ...
    for (let z = 0; z < p.length; z++) {
      ...
      const x = de(E.height);
      C.height !== x && (T.style.height = x, v = !0), T.parentNode !== c && (c.append(T), v = !0), s[z] = T;
    }
...
function nd(t, e = od) {
  ...
  function l(w) {
    w.read(() => {
      ...
      }(g), f = m.getNode(), y = f.getKey(), v = m.offset, z = p.getNode(), E = z.getKey(), T = p.offset, C = t.getElementByKey(y), j = t.getElementByKey(E), O = r === null || C !== o || v !== n || y !== r.getKey(), k = i === null || j !== s || T !== c || E !== i.getKey();
...
function ld(t, e, r) {
  ...
  return _c(o) && ra(283), o.insert(t.isInline() ? fr().append(t) : t), Go(Vn(t.getLatest(), "next"), e.direction);
}
function dd(t) {
  const e = Gt();
  if (!ge(e)) return !1;
...
class xd {
  ...
  init(e) {
    ...
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, n = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(c, d, l) {
      return Object.assign(c, { config: d, id: Na, registerState: l });
...
const _d = /* @__PURE__ */ new Set(), ln = oe({ build(t, e, r) {
  ...
  return { watchNodeKey: function(s) {
    const c = gd(() => (i.value || _d).has(s)), { watchedNodeKeys: d } = n.peek();
    let l = d.get(s);
    const w = l !== void 0;
          ...
          if (d) {
            ...
            t.update(() => {
              ...
              if (ge(f)) {
                ...
                if (ea(v) && l >= 0 && w >= 0 && (z = l, E = l + w, f.setTextNodeRange(v, z, v, E)), z === E && g === "" || (f.insertRawText(g), v = y.getNode()), ea(v)) {
                  z = m, E = m + p;
...
function Yd({
  ...
  const [e] = Ce(), [r, o] = I(e), [n, i] = I("paragraph"), [s, c] = Wd(), d = () => {
  };
...
function Ri(t, e, r, o, n = /* @__PURE__ */ new Map(), i) {
  ...
  if (l !== null) {
    ...
    if (c = Array.isArray(f) ? f[f.length - 1] : f, c !== null) {
      for (const [, y] of n) if (c = y(c, i), !c) break;
...
function Up({
  ...
  const [i, s] = I(sw), [c, d] = I(n), [l, w] = I(!1), g = G(void 0), m = G(null);
  X(() => {
    let v = !0;
    const z = m.current;
    if (!z) return;
  ...
  return /* @__PURE__ */ u("div", { className: "pr-twp tw:grid tw:gap-3", children: [
    ...
    /* @__PURE__ */ a("div", { className: "tw:flex tw:items-center tw:gap-2", children: /* @__PURE__ */ u(Ne, { open: l, onOpenChange: w, children: [
      /* @__PURE__ */ a(Oe, { asChild: !0, children: /* @__PURE__ */ u(
        B,
        {
          variant: "outline",
...
const Kp = Object.freeze([
  ...
  const n = G(null), [i, s] = I(void 0), [c, d] = I(void 0), l = P(
    (p) => {
      s(p);
    ...
    (p) => {
      var k;
      const f = p.target, y = (x) => x ? document.getElementById(x) : void 0, v = y(c), z = y(i);
      if (!!(v && f && v.contains(f) && f !== v) && g(f)) {
        if (p.key === "Escape" || p.key === "ArrowLeft" && !f.isContentEditable) {
          if (c) {
            p.preventDefault(), p.stopPropagation();
            const x = t.find((b) => b.id === c);
            x && l(x.id);
          }
          return;
        }
...
function gn({
  ...
  const p = P(
    (C) => {
      C && C.stopPropagation(), l(!1), g(void 0), s == null || s(!1);
    },
    [s]
  ), f = P(
    async (C) => {
    ...
    if (o && c)
      return /* @__PURE__ */ u(at, { children: [
        /* @__PURE__ */ u(
          ...
          {
            onClick: (C) => {
              C.stopPropagation(), l(!0), g(nw(t.contents)), s == null || s(!0);
            },
            children: [
...
function kw({
  ...
  const [x, b] = I(hn), [_, S] = I(), [V, K] = I(), L = o, [q, D] = I(!1), [W, pt] = I(!1), [_t, $t] = I(!1), [tt, Rt] = I(!1), [U, ot] = I(!1), [it, st] = I(C), [ct, Vt] = I(!1), vt = G(void 0), [Wt, Yt] = I(/* @__PURE__ */ new Map());
  X(() => {
    let $ = !0;
    return (async () => {
  ...
  }, [i, r]), A = F(() => Ot.slice(1), [Ot]), Y = F(() => A.length ?? 0, [A.length]), lt = F(() => Y > 0, [Y]), nt = F(() => q || Y <= 2 ? A : A.slice(-2), [A, Y, q]), ht = F(() => q || Y <= 2 ? 0 : Y - 2, [Y, q]), xt = F(
...
function $w({
  ...
  let j;
  return d ? j = Array.from({ length: 10 }).map((b, _) => `skeleton-row-${_}`).map((b) => /* @__PURE__ */ a(Ve, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(lr, { colSpan: C.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(Za, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, b)) : ((O = T.getRowModel().rows) == null ? void 0 : O.length) > 0 ? j = T.getRowModel().rows.map((k) => /* @__PURE__ */ a(
    Ve,
    {
      onClick: () => s(k, T),
      "data-state": k.getIsSelected() && "selected",
      children: k.getVisibleCells().map((x) => /* @__PURE__ */ a(lr, { children: zr(x.column.columnDef.cell, x.getContext()) }, x.id))
    },
    k.id
  )) : j = /* @__PURE__ */ a(Ve, { children: /* @__PURE__ */ a(lr, { colSpan: t.length, className: "tw:h-24 tw:text-center", children: l }) }), /* @__PURE__ */ u("div", { className: "pr-twp", id: c, children: [
...
function Lw({ row: t, mode: e, strings: r, onClick: o, onOpen: n, selectedRowRef: i }) {
  const [s, c] = I(!1), d = G(null), l = !!(t.language || t.languageCode), w = l || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, g = P(() => {
    if (w) {
      c(!0);
      return;
    }
    const z = d.current;
    z && z.scrollWidth > z.clientWidth && c(!0);
    ...
    /* @__PURE__ */ u(
      Ht,
      {
        ...
        children: [
          ...
          l && /* @__PURE__ */ u("div", { className: "tw:text-sm", children: [
            t.language,
...
function Bw(t) {
  const [e, r] = I(!1), [o, n] = I(""), [i, s] = I(t.defaultGroupByOpenTabs ?? !0), [c, d] = I(!1), l = G(null), w = P((k) => {
    r(k), k || n("");
  }, []);
  X(() => {
    if (!e) return;
  ...
  const g = Aw(t.localizedStrings), m = F(() => t.mode === "project" ? Ta({
    ...
    )), t.mode === "project-multi" && c && (x = x.filter((b) => b.isSelected)), x;
  }, [m, o, t.mode, c]), f = F(
    () => Ow(p, i),
    [p, i]
  ), y = F(() => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        t.onChangeSelection({ pairs: _ }), _.length === 0 && c && d(!1);
        return;
      }
...
function Yw({
  ...
  const d = F(() => /Macintosh/i.test(navigator.userAgent), []), l = yn(n, "%undoButton_tooltip%"), w = yn(n, "%redoButton_tooltip%");
  return /* @__PURE__ */ u(yo, { children: [
    /* @__PURE__ */ a(Ut, { children: /* @__PURE__ */ u(Kt, { children: [
      /* @__PURE__ */ a(qt, { asChild: !0, children: /* @__PURE__ */ a(
        B,
...
function Zw({
  ...
  const i = G(null), s = G(null), c = G(!1), [d, l] = I(t), [w, g] = I(r), [m, p] = I(!1);
  X(() => {
    l(t);
  }, [t]), X(() => {
    w !== r && g(r);
  ...
  const f = (v) => {
    ...
    var z, E, T, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((z = i.current) == null || z.focus(), c.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((E = s.current) == null || E.focus(), c.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((T = i.current) == null ? void 0 : T.selectionStart) === 0 && ((C = s.current) == null || C.focus(), c.current = !1), d === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && f(!1);
  };
...
function wg({
  ...
  const [f, y] = I("generated"), [v, z] = I("generated"), [E, T] = I("*"), [C, j] = I("*"), [O, k] = I("f"), [x, b] = I(!1), [_, S] = I(!0), [V, K] = I(!1), L = G(!1), q = G(""), [D, W] = I(!1), [pt, _t] = I(), [$t, tt] = I(), [Rt, U] = I(), [ot, it] = I(), st = G(null), ct = F(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
  ...
  const Ot = () => {
    ...
    if (m.current && Vt.length && A && A.rangeCount > 0) {
      const Y = A.getRangeAt(0).getBoundingClientRect(), lt = m.current.getBoundingClientRect();
      _t(Y.left - lt.left), tt(Y.top - lt.top), U(Y.height), W(!0);
    }
  }, [Vt, m]);
  X(() => {
    const A = () => {
    ...
    var lt;
    const A = ((lt = g.current) == null ? void 0 : lt.querySelector(".editor-input")) ?? void 0, Y = (nt) => {
      !D && A && document.activeElement === A && nt.key === c ? (nt.preventDefault(), Jt()) : D && nt.key === "Escape" && (nt.preventDefault(), W(!1));
    };
  ...
  const w = d ?? Ds(r, void 0), g = (E, T) => {
    ...
    if (r.length)
      switch (E.key) {
        case "Enter":
        case " ":
          E.preventDefault(), l == null || l(T, C, n);
          break;
      }
  }, v = (E) => {
    if (r.length)
...
function yg({
  ...
  const p = le(r, "%webView_inventory_all%"), f = le(r, "%webView_inventory_approved%"), y = le(r, "%webView_inventory_unapproved%"), v = le(r, "%webView_inventory_unknown%"), z = le(r, "%webView_inventory_scope_currentBook%"), E = le(r, "%webView_inventory_scope_chapter%"), T = le(r, "%webView_inventory_scope_verse%"), C = le(r, "%webView_inventory_filter_text%"), j = le(
    r,
    "%webView_inventory_show_additional_items%"
  ), O = le(r, "%webView_inventory_no_results%"), [k, x] = I(!1), [b, _] = I("all"), [S, V] = I(""), [K, L] = I([]), q = F(() => {
    const U = t ?? [];
...
function Ag({
  ...
  const [l, w] = I([]), [g, m] = I([{ id: je, desc: !1 }]), [p, f] = I({}), y = F(
...
function ju({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], c = o["%webView_book_selector_search_books%"], d = o["%webView_book_selector_select_all%"], l = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], g = o["%webView_book_selector_more%"], { otLong: m, ntLong: p, dcLong: f, extraLong: y } = {
            ...
            $e,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
                  ...
                  /* @__PURE__ */ a(B, { variant: "ghost", size: "sm", onClick: K, children: l })
                ] }),
                /* @__PURE__ */ u(Re, { children: [
...
function jg({
  ...
  const C = St(
  ...
  ] }), ot = e ? Rt.filter((M) => e.includes(M.value)) : Rt, it = f ?? fa, st = w ?? it, ct = g ?? it, Vt = () => {
    ...
    [r, n, f, i]
  ), nt = ot.find((M) => M.value === t), ht = () => t === "selectedBooks" && n.length > 0 ? n.map((M) => M.toUpperCase()).join(", ") : t === "range" ? Rs(st, ct, {
  ...
  ), yt = ot.find((M) => M.value === "selectedBooks"), ft = ot.find((M) => M.value === "range"), [Ct, $] = I(!1), [ut, gt] = I(void 0), [kt, Ke] = I(void 0), [Pe, br] = I(void 0), [qe, xr] = I(void 0), [yr, Ar] = I([]), Pr = l === "dropdown" && ut === "selectedBooks", N = /* @__PURE__ */ a(
    ju,
    {
      availableBookInfo: o,
  ...
  ), H = Bt === "end", Z = Bt === "start", zt = "tw:text-muted-foreground", re = l === "dropdown" && ut === "range", or = re ? br : A, At = re ? xr : p ? Y : Vt, Nt = /* @__PURE__ */ u("div", { className: "tw:flex tw:flex-wrap tw:items-end tw:gap-4", children: [
...
function Qa({
  ...
  return /* @__PURE__ */ u(me, { variant: i, children: [
    /* @__PURE__ */ a(ve, { "aria-label": r, className: n, asChild: !0, id: c, children: /* @__PURE__ */ a(B, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ a(cc, {}) }) }),
