...
import { c as b, g as $e, a as Vr, C as er, L as Un, t as ks, u as Qo, T as Vt, b as bt, d as xt, e as yt, f as Kn, A as ba, D as Fe, h as Te, i as je, j as cr, k as We, B as et, x as _s, l as Ns, m as Cs, I as Es, n as Co, o as Ze, r as De, p as Ts, q as Hn, P as lr, s as Dr, v as dr, w as wr, y as Da, z as Ma, E as Eo, F as ur, G as Oa, H as $t, R as To, J as xa, K as io, M as so, N as co, O as lo, Q as qn, S as da, U as So, V as jr, W as Ur, X as yr, Y as Ss, Z as ir, _ as Je, $ as Ue, a0 as Ye, a1 as kr, a2 as Ro, a3 as Do, a4 as ya, a5 as Mo, a6 as Gn, a7 as Rs, a8 as Ds, a9 as Ms, aa as wo, ab as Wn, ac as Ia, ad as Os, ae as Yn, af as Is, ag as zs, ah as Ps, ai as tn, aj as As, ak as $s, al as Vs, am as Xn, an as Jn, ao as Oo, ap as Ls, aq as Zn, ar as Ka, as as en, at as Ha, au as Bs, av as Fs, aw as js, ax as Us, ay as Ks, az as Hs, aA as qs, aB as Gs, aC as Ws, aD as Io, aE as zo, aF as Ys, aG as Xs } from "./resizable-C4ekm4_I.js";
import { aH as vf, aI as bf, aJ as xf, aK as yf, aL as kf, aM as _f, aN as Nf, aO as Cf, aP as Ef, aQ as Tf, aR as Sf, aS as Rf, aT as Df, aU as Mf, aV as Of, aW as If, aX as zf, aY as Pf, aZ as Af, a_ as $f, a$ as Vf, b0 as Lf, b1 as Bf, b2 as Ff, b3 as jf, b4 as Uf, b5 as Kf, b6 as Hf, b7 as qf, b8 as Gf, b9 as Wf, ba as Yf, bb as Xf, bc as Jf, bd as Zf, be as Qf, bf as tm } from "./resizable-C4ekm4_I.js";
...
function Vh({
  ...
  const [g, E] = _("generated"), [y, C] = _("generated"), [N, A] = _("*"), [B, U] = _("*"), [O, S] = _("f"), [D, W] = _(!1), [Y, z] = _(!0), [k, ot] = _(!1), I = L(!1), X = L(""), [G, $] = _(!1), [at, ut] = _(), [dt, tt] = _(), [pt, kt] = _(), [mt, Rt] = _(), Ft = L(null), Pt = L(
    void 0
  ...
  const Et = V(() => {
    var H, Q, F;
    const R = (H = f.current) == null ? void 0 : H.querySelector(".editor-input"), K = R == null ? void 0 : R.querySelector("span.note"), Z = (F = (Q = f.current) == null ? void 0 : Q.ownerDocument.getSelection()) == null ? void 0 : F.anchorNode;
  ...
  const oe = V(
    ...
    (R, K) => {
      var Q, F, nt;
      const Z = (F = (Q = h.current) == null ? void 0 : Q.getNoteOps(0)) == null ? void 0 : F.at(0);
  ...
  J(() => {
    ...
    const R = () => {
      ...
      Z && !Z.isCollapsed || Et() || ((Q = h.current) == null || Q.selectNote(0), (F = h.current) == null || F.focus());
    };
...
function wg({
  ...
  const B = Ut(
    ...
    [r, n, g, s]
  ), Jt = mt.find((j) => j.value === t), ze = () => t === "selectedBooks" && n.length > 0 ? n.map((j) => j.toUpperCase()).join(", ") : t === "range" ? Fc(Ft, Pt, {
  ...
  ), Ot = mt.find((j) => j.value === "selectedBooks"), qt = mt.find((j) => j.value === "range"), [It, R] = _(!1), [K, Z] = _(void 0), [H, Q] = _(void 0), [F, nt] = _(void 0), [st, it] = _(void 0), [vt, Ct] = _([]), Tt = p === "dropdown" && K === "selectedBooks", Gt = /* @__PURE__ */ a(
    dp,
    {
      availableBookInfo: o,
  ...
  const [He, Ba] = _(null), [Ae, fr] = _(null), [mr, Fa] = _(null), Zr = 200, [ja, Qr] = _(!1);
  J(() => {
  ...
  const ta = V(
    (j) => {
      Q(j), nt(Ft), it(Pt), Ct(n), R(!1), Z(j);
    },
    [Ft, Pt, n]
  ), ea = V(() => {
    H !== void 0 && (H === "range" ? (F && (m == null || m(F)), st && (x == null || x(st))) : H === "selectedBooks" && s(vt), Xt(H), Z(void 0), Q(void 0));
  }, [
    H,
    F,
    st,
