...
var ft = (e, t, n) => ds(e, typeof t != "symbol" ? t + "" : t, n);
import { jsx as o, jsxs as d, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as en, useRef as tt, useMemo as $, useState as I, useCallback as F, useLayoutEffect as Bt, createContext as yn, useContext as fr, useEffect as J, Component as ps, createElement as Lr, Suspense as us, createRef as ms, Fragment as ho } from "react";
import { Command as vt } from "cmdk";
import { X as nn, Search as fo, Check as It, Clock as Br, ChevronsLeft as jr, ChevronsRight as zr, ChevronLeft as qn, ChevronRight as Ee, ArrowLeft as hs, ArrowRight as fs, Circle as Nn, ChevronDown as fe, BoldIcon as gs, ItalicIcon as bs, UnderlineIcon as vs, StrikethroughIcon as xs, Pencil as ys, Trash2 as Ns, ArrowUp as go, MoreHorizontal as bo, ChevronUp as Jn, AtSign as ks, FilterIcon as _s, ArrowLeftIcon as Cs, ChevronLeftIcon as Es, ChevronRightIcon as Ss, ArrowRightIcon as Ts, Copy as vo, Filter as Rs, User as Ds, Link as Ms, CircleHelp as Is, ChevronsUpDown as xo, Star as Os, SquareX as yo, FunctionSquare as No, SquareSigma as ko, AlertCircle as Wn, CircleCheckIcon as As, CircleXIcon as Vs, CircleHelpIcon as Ps, ArrowUpIcon as $s, ArrowDownIcon as Ls, ArrowUpDownIcon as Bs, PanelLeft as js, PanelRight as zs, ScrollText as Fs, MenuIcon as Gs, Menu as Hs, EllipsisVertical as Xs, LoaderCircle as Ks, GripVertical as Us } from "lucide-react";
import { clsx as Ys } from "clsx";
import { extendTailwindMerge as qs } from "tailwind-merge";
import * as Et from "@radix-ui/react-dialog";
import { includes as wn, Section as K, getChaptersForBook as Js, formatScrRef as de, getSectionForBook as Xe, formatRelativeDate as Ws, formatReplacementString as ce, sanitizeHtml as Zs, parseParatextHtml as Fr, hasCustomParatextTags as Qs, NumberFormat as ti, formatBytes as ei, getCurrentLocale as ni, getFormatCallerFunction as ri, deepEqual as _o, isString as Pn, compareScrRefs as Zn, scrRefToBBBCCCVVV as $n, getLocalizeKeyForScrollGroupId as W } from "platform-bible-utils";
...
import { createEditor as Eo, $getRoot as Jt, $createParagraphNode as kn, $getSelection as jt, HISTORY_MERGE_TAG as gr, ParagraphNode as So, TextNode as To, $isTokenOrSegmented as oi, $getCharacterOffsets as ai, $cloneWithPropertiesEphemeral as si, $findMatchingParent as ii, $isElementNode as pe, CLEAR_EDITOR_COMMAND as Ro, COMMAND_PRIORITY_EDITOR as Do, $isRangeSelection as We, shallowMergeConfig as li, defineExtension as Ft, safeCast as rn, RootNode as wi, LineBreakNode as ci, TabNode as di, $isEditorState as pi, createCommand as ui, CLICK_COMMAND as mi, isDOMNode as hi, $getNodeFromDOMNode as fi, $isNodeSelection as gi, $createNodeSelection as bi, $setSelection as vi, COMMAND_PRIORITY_LOW as xi, DecoratorNode as yi, $create as Ni, $getNodeByKey as ki, INDENT_CONTENT_COMMAND as Gr, COMMAND_PRIORITY_CRITICAL as br, KEY_TAB_COMMAND as _i, $createRangeSelection as Ci, $normalizeSelection__EXPERIMENTAL as Ei, OUTDENT_CONTENT_COMMAND as Si, INSERT_TAB_COMMAND as Ti, $isBlockElementNode as fn, $isDecoratorNode as Ri, $isParagraphNode as Di, $isTextNode as gn, SELECTION_CHANGE_COMMAND as Mo, FORMAT_TEXT_COMMAND as Mi, getRegisteredNode as Ii, isHTMLElement as Oi, isDocumentFragment as Hr, isDOMDocumentNode as Ai, ArtificialNode__DO_NOT_USE as Io, $createLineBreakNode as Oo, $isRootOrShadowRoot as Vi, isBlockDomNode as Xr, isInlineDomNode as Kr, $insertNodes as Pi } from "lexical";
...
import { useReactTable as $o, getFilteredRowModel as Xi, getSortedRowModel as Lo, getPaginationRowModel as Ki, getCoreRowModel as Bo, flexRender as Ke, getGroupedRowModel as Ui, getExpandedRowModel as Yi } from "@tanstack/react-table";
import * as ot from "@radix-ui/react-select";
import qi from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as Qn, HIDDEN_NOTE_CALLER as tr, getDefaultViewOptions as Ji, isInsertEmbedOpOfType as cn, Editorial as Wi } from "@eten-tech-foundation/platform-editor";
...
const nl = Et.Root, rl = Et.Portal, jo = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  Et.Overlay,
  {
    ref: n,
    className: h(
...
jo.displayName = Et.Overlay.displayName;
...
zo.displayName = Et.Content.displayName;
...
Go.displayName = Et.Title.displayName;
...
zt.displayName = vt.Group.displayName;
...
Ho.displayName = vt.Separator.displayName;
const Gt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  vt.Item,
  {
    ref: n,
    className: h(
...
Gt.displayName = vt.Item.displayName;
...
const Qo = Z.allBookIds.filter(
  (e) => !Z.isObsolete(Z.bookIdToNumber(e))
), ue = Object.fromEntries(
  Qo.map((e) => [e, Z.bookIdToEnglishName(e)])
);
function _r(e, t, n) {
...
const ta = en(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...a }, s) => /* @__PURE__ */ o(r ? Oe : "button", { className: h(bl({ variant: t, size: n, className: e })), ref: s, ...a })
);
L.displayName = "Button";
const xe = Se.Root, ye = Se.Trigger, pp = Se.Anchor, ne = b.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, a) => {
  const s = ct();
...
function or(e, t, n) {
  return `${e} ${ue[e]}${t ? ` ${kr(e, t)} ${Ce(e, t)}` : ""}${n ? ` ${n}` : ""}`;
}
function vl({
  recentSearches: e,
  ...
  return /* @__PURE__ */ d(xe, { open: c, onOpenChange: w, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        "aria-label": a,
        children: /* @__PURE__ */ o(Br, { className: "tw-h-4 tw-w-4" })
      }
    ) }),
    /* @__PURE__ */ o(ne, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ o(te, { children: /* @__PURE__ */ o(ee, { children: /* @__PURE__ */ o(zt, { heading: s, children: e.map((m) => /* @__PURE__ */ d(
      Gt,
      {
        onSelect: () => p(m),
        className: h("tw-flex tw-items-center", l),
        children: [
          /* @__PURE__ */ o(Br, { className: "tw-mr-2 tw-h-4 tw-w-4 tw-opacity-50" }),
...
function Jr({
  ...
  if (e)
    return /* @__PURE__ */ o(zt, { children: /* @__PURE__ */ o("div", { className: h("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Mt(e) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ o(
      Gt,
      {
        value: `${e} ${ue[e] || ""} ${i}`,
        onSelect: () => n(i),
...
function mp({
  ...
  const w = ct(), [p, m] = I(!1), [f, u] = I(""), [g, k] = I(""), [v, T] = I("books"), [N, S] = I(void 0), [A, j] = I(!1), V = tt(void 0), y = tt(void 0), C = tt(void 0), x = tt(void 0), E = tt({}), O = F(
    (M) => {
      t(M), l && l(M);
    },
    [t, l]
  ), P = $(() => r ? r() : Qo, [r]), G = $(() => ({
    [K.OT]: P.filter((_) => Z.isBookOT(_)),
    [K.NT]: P.filter((_) => Z.isBookNT(_)),
    [K.DC]: P.filter((_) => Z.isBookDC(_)),
    [K.Extra]: P.filter((_) => Z.extraBooks().includes(_))
  }), [P]), D = $(() => Object.values(G).flat(), [G]), z = $(() => {
    if (!g.trim()) return G;
    const M = {
      [K.OT]: [],
      [K.NT]: [],
    ...
    return [K.OT, K.NT, K.DC, K.Extra].forEach((Y) => {
      M[Y] = G[Y].filter((st) => _r(st, g, a));
    }), M;
  }, [G, g, a]), R = $(
    () => yl(g, D, a),
    [g, D, a]
    ...
    (M) => {
      const _ = v === "chapters" ? N : R == null ? void 0 : R.book;
      _ && (O({
        book: _,
        chapterNum: M,
        verseNum: 1
      }), m(!1), T("books"), S(void 0), k(""));
    },
    [O, v, N, R]
  ), Ct = F(
    (M) => {
    ...
    (M) => {
      ...
      m(M), M && (T("books"), S(void 0), k(""));
    },
    [v, B]
  ), { otLong: pt, ntLong: ut, dcLong: Nt, extraLong: Xt } = {
    ...
    (M) => R ? !!R.chapterNum && !M.toString().includes(R.chapterNum.toString()) : !1,
    [R]
  ), On = $(
    () => de(
      e,
    ...
    (M) => {
      ...
      if (v === "chapters") {
        ...
        if (_ || Y) {
          if (M.preventDefault(), M.stopPropagation(), T("books"), S(void 0), Y && N) {
            const st = ue[N];
            k(`${st} ${M.key}`);
          } else
            k(M.key);
      ...
      if ((v === "chapters" || v === "books" && R) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        const st = v === "chapters" ? N : R == null ? void 0 : R.book;
        if (!st) return;
        const mt = (() => {
          if (!f) return 1;
          const je = f.match(/(\d+)$/);
        ...
        switch (M.key) {
          case "ArrowLeft":
            mt !== 0 && (At = mt > 1 ? mt - 1 : ae);
            break;
          case "ArrowRight":
            mt !== 0 && (At = mt < ae ? mt + 1 : 1);
            break;
          case "ArrowUp":
            At = mt === 0 ? ae : Math.max(1, mt - $r);
            break;
          case "ArrowDown":
            At = mt === 0 ? 1 : Math.min(ae, mt + $r);
            break;
          default:
            return;
        }
        At !== mt && (M.preventDefault(), M.stopPropagation(), u(or(st, a, At)), setTimeout(() => {
          const je = E.current[At];
    ...
    const { isLetter: _, isDigit: Y } = qr(M.key);
    (_ || Y) && (M.preventDefault(), k((st) => st + M.key), y.current.focus(), j(!1));
  }, []);
  return Bt(() => {
    const M = setTimeout(() => {
      if (p && v === "books" && C.current && x.current) {
        const _ = C.current, Y = x.current, st = Y.offsetTop, mt = _.clientHeight, ae = Y.clientHeight, At = st - mt / 2 + ae / 2;
        _.scrollTo({
          top: Math.max(0, At),
          behavior: "smooth"
        }), u(or(e.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if (C.current)
          if (M) {
            const _ = E.current[e.chapterNum];
  ...
  }, [v, N, R, e.book, e.chapterNum]), /* @__PURE__ */ d(xe, { open: p, onOpenChange: at, children: [
    /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
      L,
      {
        ...
        children: /* @__PURE__ */ o("span", { className: "tw-truncate", children: On })
      }
    ) }),
      ...
      te,
      {
        ...
        children: [
          v === "books" ? /* @__PURE__ */ d("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ o("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: it.map(({ onClick: M, disabled: _, title: Y, icon: st }) => /* @__PURE__ */ o(
              L,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ o(
              L,
              {
                ...
                tabIndex: -1,
                children: w === "ltr" ? /* @__PURE__ */ o(hs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(fs, { className: "tw-h-4 tw-w-4" })
              }
            ),
          ...
          !A && /* @__PURE__ */ d(ee, { ref: C, children: [
            v === "books" && /* @__PURE__ */ d(lt, { children: [
              !R && Object.entries(z).map(([M, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ o(zt, { heading: kt(M), children: _.map((Y) => /* @__PURE__ */ o(
                      ta,
                      {
                        bookId: Y,
                        onSelect: (st) => dt(st),
              ...
              R && /* @__PURE__ */ o(zt, { children: /* @__PURE__ */ o(
                Gt,
                {
                  ...
                  children: de(
                    ...
                    a ? kr(R.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              R && Mt(R.book) > 1 && /* @__PURE__ */ d(lt, { children: [
                /* @__PURE__ */ o("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Ce(R.book, a) }),
                /* @__PURE__ */ o(
                  Jr,
                  {
                    bookId: R.book,
...
), wt = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(Co.Root, { ref: n, className: h("pr-twp", kl(), e), ...t }));
wt.displayName = Co.Root.displayName;
...
Cr.displayName = Je.Root.displayName;
...
function ar({
  ...
  const [N, S] = I(!1), A = c ?? l, j = (y) => y.length > 0 && typeof y[0] == "object" && "options" in y[0], V = (y, C) => {
    const x = l(y), E = typeof y == "object" && "secondaryLabel" in y ? y.secondaryLabel : void 0, O = `${C ?? ""}${x}${E ?? ""}`;
    return /* @__PURE__ */ d(
      Gt,
      {
        value: x,
  ...
  return /* @__PURE__ */ d(xe, { open: N, onOpenChange: S, ...T, children: [
    ...
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ d(te, { children: [
          ...
          /* @__PURE__ */ o(ee, { children: j(t) ? t.map((y) => /* @__PURE__ */ o(zt, { heading: y.groupHeading, children: y.options.map((C) => V(C, y.groupHeading)) }, y.groupHeading)) : t.map((y) => V(y)) })
        ] })
      }
    )
  ] });
...
function gp({
  ...
  const p = Bn(w, "%webView_bookSelector_currentBook%"), m = Bn(w, "%webView_bookSelector_choose%"), f = Bn(w, "%webView_bookSelector_chooseBooks%"), [u, g] = I(
    "current book"
    /* CURRENT_BOOK */
  ), k = (v) => {
    g(v), e(v);
...
const bp = [
  ...
  const a = tt(null), [s, i] = I(void 0), [l, c] = I(void 0), w = F(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const x = C.findIndex((O) => O === g);
          if (x === -1) return;
          let E;
          u.key === "ArrowDown" ? E = Math.min(x + 1, C.length - 1) : E = Math.max(x - 1, 0), E !== x && (u.preventDefault(), u.stopPropagation(), (y = C[E]) == null || y.focus());
          return;
        }
        return;
      }
...
const na = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Ml = na ? Bt : J, dn = { tag: gr };
function Il({ initialConfig: e, children: t }) {
  const n = $(() => {
    const { theme: r, namespace: a, nodes: s, onError: i, editorState: l, html: c } = e, w = Dl(null, r), p = Eo({ editable: e.editable, html: c, namespace: a, nodes: s, onError: (m) => i(m, p), theme: r });
    return function(m, f) {
      if (f !== null) {
        if (f === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            ...
            (jt() !== null || k !== null && k === m.getRootElement()) && g.select();
          }
        }, dn);
...
const Ol = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : J;
...
const Er = {
  ...
  mark: "",
  markOverlap: ""
}, Pt = on.Provider, Yt = on.Root, me = on.Trigger, $t = b.forwardRef(({ className: e, sideOffset: t = 4, ...n }, r) => /* @__PURE__ */ o(
  on.Content,
  {
    ref: r,
    sideOffset: t,
...
$t.displayName = on.Content.displayName;
const Sr = [
  Li,
  So,
  To,
...
const Bl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : J;
function jl(e) {
  return { initialValueFn: () => e.isEditable(), subscribe: (t) => e.registerEditableListener(t) };
}
function zl() {
  return function(e) {
    const [t] = Ot(), n = $(() => e(t), [t, e]), [r, a] = I(() => n.initialValueFn()), s = tt(r);
    return Bl(() => {
...
function Jl(e) {
  ...
  ia(this), q = e, this.f &= -2, 8 & this.f && Tr(this), Cn();
}
function _e(e, t) {
...
gt.prototype.brand = Ul, gt.prototype.h = function() {
  ...
  if (this.g = mn, this.f |= 1, this.i > 0 && !sa(this)) return this.f &= -2, !0;
  const e = q;
  try {
    to(this), q = this;
    const t = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), to(this), qt++;
  const e = q;
...
Ft({ build: (e, t, n) => En(t), config: rn({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(e, t, n) {
  const r = n.getOutput();
...
function wa() {
  const e = Jt(), t = jt(), n = kn();
  e.clear(), e.append(n), t !== null && n.select(), We(t) && (t.format = 0);
}
function ca(e, t = wa) {
  return e.registerCommand(Ro, (n) => (e.update(t), !0), Do);
}
Ft({ build: (e, t, n) => En(t), config: rn({ $onClear: wa }), name: "@lexical/extension/ClearEditor", register(e, t, n) {
  const { $onClear: r } = n.getOutput();
  return Zt(() => ca(e, r.value));
} });
function Wl(e) {
...
const ir = Ft({ build: (e) => da(() => e.getEditorState(), (t) => e.registerUpdateListener((n) => {
...
const Rr = 0, lr = 1, ua = 2, zn = 3, pn = 4, ke = 5, Fn = 6, Fe = 7;
function Gn(e) {
  return e.id === Rr;
}
function ma(e) {
...
function Zl(e) {
  return function(t) {
    return t.id === lr;
  }(e) || Q(305, String(e.id), String(lr)), Object.assign(e, { id: ua });
}
...
class tw {
  ...
  afterRegistration(t) {
    const n = this.state;
    let r;
    return n.id !== Fn && Q(310, String(n.id), String(Fn)), this.extension.afterRegistration && (r = this.extension.afterRegistration(t, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= zn;
    }(t) || Q(314, String(t.id), String(zn)), { config: t.config };
  }
  getPeer(t) {
    const n = this.builder.extensionNameMap.get(t);
...
const nw = Ft({ config: rn({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: e = ew }) => ({ $initialEditorState: e, initialized: !1 }), afterRegistration(e, { updateOptions: t, setOptions: n }, r) {
...
}, name: "@lexical/extension/InitialState", nodes: [wi, To, ci, di, So] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function rw(e) {
  throw e;
...
class Ye {
  ...
  static maybeFromEditor(t) {
    const n = t[no];
    return n && (n.PACKAGE_VERSION !== Hn && Q(292, n.PACKAGE_VERSION, Hn), n instanceof Ye || Q(293)), n;
  }
  static fromEditor(t) {
  ...
  sortedExtensionReps() {
    ...
    const t = [], n = (r, a) => {
      ...
      var l;
      Gn(s) || Q(300, i, a || "[unknown]"), Gn(l = s) || Q(304, String(l.id), String(Rr)), s = Object.assign(l, { id: lr }), r.state = s;
...
const ow = /* @__PURE__ */ new Set(), oo = Ft({ build(e, t, n) {
  const r = n.getDependency(ir).output, a = Ze({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = da(() => {
  }, () => Zt(() => {
    const i = s.peek(), { watchedNodeKeys: l } = a.value;
    let c, w = !1;
    r.value.read(() => {
      if (jt()) for (const [p, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(p);
          continue;
        }
...
Ft({ dependencies: [ir, oo], name: "@lexical/extension/HorizontalRule", nodes: [Te], register(e, t, n) {
  ...
  return Wt(e.registerCommand(mi, (i) => {
    if (hi(i.target)) {
      ...
      if (sw(l)) return function(c, w = !1) {
        const p = jt(), m = c.isSelected(), f = c.getKey();
        let u;
...
Ft({ build: (e, t, n) => En(t), config: rn({ disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(e, t, n) {
            ...
            e.update(() => {
              ...
              if (We(g)) {
                ...
                if (gn(v) && w >= 0 && p >= 0 && (T = w, N = w + p, g.setTextNodeRange(v, T, v, N)), T === N && m === "" || (g.insertRawText(m), v = k.getNode()), gn(v)) {
                  ...
                  T = T > S ? S : T, N = N > S ? S : N, g.setTextNodeRange(v, T, v, N);
                }
...
Ft({ build: (e, t, n) => En(t), config: rn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (e, t, n) => Zt(() => n.getOutput().disabled.value ? void 0 : ga(e)) });
function pw(e, ...t) {
  const n = new URL("https://lexical.dev/docs/error"), r = new URLSearchParams();
  r.append("code", e);
  for (const a of t) r.append("v", a);
...
const Dr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : J;
  ...
  return function(n, r) {
    ...
    return Dr(() => n.registerDecoratorListener((i) => {
      ...
      for (let c = 0; c < l.length; c++) {
        const w = l[c], p = o(r, { onError: (f) => n._onError(f), children: o(us, { fallback: null, children: a[w] }) }), m = n.getElementByKey(w);
...
function hw({ contentEditable: e, placeholder: t = null, ErrorBoundary: n }) {
  ...
  return function(a) {
    Dr(() => Wt(ji(a), ga(a)), [a]);
  }(r), d(lt, { children: [e, o(fw, { content: t }), o(mw, { editor: r, ErrorBoundary: n })] });
}
function fw({ content: e }) {
  const [t] = Ot(), n = function(a) {
    const [s, i] = I(() => ao(a));
    return Dr(() => {
      function l() {
        const c = ao(a);
...
const bw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : J;
function vw({ onClear: e }) {
  const [t] = Ot();
  return bw(() => ca(t, e), [t, e]), null;
}
const ba = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? Bt : J;
function xw({ editor: e, ariaActiveDescendant: t, ariaAutoComplete: n, ariaControls: r, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: w, ariaMultiline: p, ariaOwns: m, ariaRequired: f, autoCapitalize: u, className: g, id: k, role: v = "textbox", spellCheck: T = !0, style: N, tabIndex: S, "data-testid": A, ...j }, V) {
  const [y, C] = I(e.isEditable()), x = F((O) => {
    O && O.ownerDocument && O.ownerDocument.defaultView ? e.setRootElement(O) : e.setRootElement(null);
  }, [e]), E = $(() => /* @__PURE__ */ function(...O) {
    return (P) => {
      for (const G of O) typeof G == "function" ? G(P) : G != null && (G.current = P);
    };
  }(V, x), [x, V]);
  return ba(() => (C(e.isEditable()), e.registerEditableListener((O) => {
    C(O);
  })), [e]), o("div", { "aria-activedescendant": y ? t : void 0, "aria-autocomplete": y ? n : "none", "aria-controls": y ? r : void 0, "aria-describedby": a, ...s != null ? { "aria-errormessage": s } : {}, "aria-expanded": y && v === "combobox" ? !!i : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": w, "aria-multiline": p, "aria-owns": y ? m : void 0, "aria-readonly": !y || void 0, "aria-required": f, autoCapitalize: u, className: g, contentEditable: y, "data-testid": A, id: k, ref: E, role: v, spellCheck: T, style: N, tabIndex: S, ...j });
}
const yw = en(xw);
function so(e) {
  return e.getEditorState().read(fa(e.isComposing()));
...
const Nw = en(kw);
function kw(e, t) {
  const { placeholder: n, ...r } = e, [a] = Ot();
  return d(lt, { children: [o(yw, { editor: a, ...r, ref: t }), n != null && o(_w, { editor: a, content: n })] });
}
function _w({ content: e, editor: t }) {
  ...
  if (Bt(() => (a(t.isEditable()), t.registerEditableListener((i) => {
    a(i);
  })), [t]), !n) return null;
  let s = null;
...
function Tw({
  ...
  const [t] = Ot(), [n, r] = I(t), [a, s] = I("paragraph"), [i, l] = Sw(), c = () => {
  };
...
const Na = b.createContext({
  size: "default",
  variant: "default"
}), Mr = b.forwardRef(({ className: e, variant: t, size: n, children: r, ...a }, s) => {
  const i = ct();
  return /* @__PURE__ */ o(
    _n.Root,
    {
...
Mr.displayName = _n.Root.displayName;
...
function Mw() {
  const { activeEditor: e } = xa(), [t, n] = I([]), r = F((a) => {
    if (We(a) || Gi(a)) {
      const s = [];
      io.forEach(({ format: i }) => {
...
function wr({
  ...
  return /* @__PURE__ */ o("div", { className: "pr-twp tw-overflow-hidden tw-rounded-lg tw-border tw-bg-background tw-shadow", children: /* @__PURE__ */ o(
    Il,
    {
      ...
      children: /* @__PURE__ */ d(Pt, { children: [
...
function Vw(e, t) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof Io && i.insertAfter(Oo());
    for (const i of s) {
...
function ka(e, t, n, r = null) {
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], k = ka(e, g, f, r);
    !a && pe(t) && k && t.extractWithChild(g, r, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Oi(p) || Hr(p)) && p.append(f), n.append(p), m) {
      const u = m.call(i, p);
...
function Ca(e, t, n, r, a = /* @__PURE__ */ new Map(), s) {
  ...
  for (let g = 0; g < m.length; g++) f.push(...Ca(m[g], t, n, u, new Map(a), l));
...
De.displayName = Po.Root.displayName;
...
}), $e = et.Trigger, Ma = et.Group, Kw = et.Portal, Uw = et.Sub, Yw = et.RadioGroup;
...
const Ia = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Tt();
  return /* @__PURE__ */ d(
    et.SubTrigger,
    {
...
Ia.displayName = et.SubTrigger.displayName;
...
const Lt = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  const s = Tt();
  return /* @__PURE__ */ d(
    et.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ o(et.ItemIndicator, { children: /* @__PURE__ */ o(It, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
Lt.displayName = et.CheckboxItem.displayName;
const Aa = b.forwardRef(({ className: e, children: t, ...n }, r) => {
  const a = Tt();
  return /* @__PURE__ */ d(
    et.RadioItem,
    {
...
Aa.displayName = et.RadioItem.displayName;
...
function lo({
  ...
  const [m, f] = I(!1), [u, g] = I(), [k, v] = I(!1), T = tt(null);
  J(() => {
    let x = !0;
    if (!r) {
      v(!1);
    ...
    if (r && k)
      return /* @__PURE__ */ d(lt, { children: [
        !Qs(e.contents) && /* @__PURE__ */ d(
          ...
          {
            onClick: () => {
              f(!0), g(Bw(Fr(e.contents))), c == null || c(!0);
            },
            children: [
        ...
        /* @__PURE__ */ d(
          vn,
          {
            ...
            children: [
              /* @__PURE__ */ o(Ns, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(Ra, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ o(Da, { className: "tw-text-xs tw-font-medium", children: V }) }),
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          m && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: T,
              onKeyDownCapture: (x) => {
                x.key === "Escape" ? (x.preventDefault(), x.stopPropagation(), N()) : x.key === "Enter" && x.shiftKey && (x.preventDefault(), x.stopPropagation(), Kt(u) && S());
              },
              onKeyDown: (x) => {
...
function Jw({
  ...
  const [N, S] = I(wo), [A, j] = I(!1), [V, y] = I(!1), [C, x] = I(!1), [E, O] = I(!1), [P, G] = I(!1), [D, z] = I(void 0), [R, X] = I(!1), [dt, ht] = I(!1);
  J(() => {
    let _ = !0;
    if (!r) {
      X(!1), ht(!1);
  ...
  const Ct = $(() => t.filter((_) => !_.deleted), [t]), it = $(() => Ct[0], [Ct]), B = tt(null), at = tt(void 0), pt = F(() => {
    var _;
    (_ = at.current) == null || _.call(at), S(wo);
  }, []);
  J(() => {
    const _ = B.current;
    if (!_) return;
    const Y = () => {
      y(_.scrollWidth > _.clientWidth);
    };
    return Y(), window.addEventListener("resize", Y), () => window.removeEventListener("resize", Y);
  }, [it == null ? void 0 : it.verse]), J(() => {
    x(!1);
  }, [r]);
  const ut = $(
    () => ({
  ...
  }, [s, n]), Xt = $(() => Ct.slice(1), [Ct]), kt = $(() => Xt.length ?? 0, [Xt.length]), In = $(() => kt > 0, [kt]), On = $(() => C || kt <= 2 ? Xt : Xt.slice(-2), [Xt, kt, C]), oe = $(() => C || kt <= 2 ? 0 : kt - 2, [kt, C]), An = $(
    () => kt === 1 ? ut.singleReply : ce(ut.multipleReplies, { count: kt }),
    [kt, ut]
  ), Vn = $(
    () => oe === 1 ? ut.singleReply : ce(ut.multipleReplies, { count: oe }),
    [oe, ut]
  ), ln = F(async () => {
    const _ = Kt(N) ? cr(N) : void 0;
    if (D !== void 0) {
      await p({
        threadId: c,
        contents: _,
    ...
    _ && await p({ threadId: c, contents: _ }) && pt();
  }, [pt, N, p, D, c]), M = F(
    async (_) => {
      const Y = Kt(N) ? cr(N) : void 0, st = await p({
        ..._,
        contents: Y,
        assignedUser: D ?? _.assignedUser
      });
      return st && Y && pt(), st && D !== void 0 && z(void 0), st;
    },
    [pt, N, p, D]
  );
  return /* @__PURE__ */ o(
    Sa,
    {
      ...
      children: /* @__PURE__ */ d(Ta, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          Nt && /* @__PURE__ */ o(Re, { className: "tw-rounded-sm tw-bg-input tw-text-sm tw-font-normal tw-text-primary hover:tw-bg-input", children: Nt }),
            ...
            /* @__PURE__ */ d(
              "p",
              {
                ...
                children: [
                  a,
                  " ",
                  /* @__PURE__ */ o("span", { className: e, children: it.verse })
                ]
              }
            ),
            V && /* @__PURE__ */ o(
              L,
              {
                ...
                children: A ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(fe, {})
              }
            )
          ] }),
          /* @__PURE__ */ o(
        ...
        /* @__PURE__ */ d(lt, { children: [
          In && !r && /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-5", children: [
          ...
          r && /* @__PURE__ */ d(lt, { children: [
            oe > 0 && /* @__PURE__ */ d(
              "div",
              {
                ...
                onClick: (_) => {
                  _.stopPropagation(), x(!0);
                },
                role: "button",
                tabIndex: 0,
                onKeyDown: (_) => {
                  (_.key === "Enter" || _.key === " ") && (_.preventDefault(), _.stopPropagation(), x(!0));
                },
                children: [
                  /* @__PURE__ */ o("div", { className: "tw-w-8", children: /* @__PURE__ */ o(De, {}) }),
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
                    ...
                    C ? /* @__PURE__ */ o(Jn, {}) : /* @__PURE__ */ o(fe, {})
                  ] })
                ]
              }
            ),
            On.map((_) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
              lo,
              {
                comment: _,
                localizedStrings: n,
            ...
            g !== !1 && (!E || Kt(N)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (_) => {
                  _.key === "Enter" && _.shiftKey && (_.preventDefault(), _.stopPropagation(), (Kt(N) || D !== void 0) && ln());
                },
                onKeyDown: (_) => {
                  Ea(_), (_.key === "Enter" || _.key === " ") && _.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ o(
                    wr,
                  ...
                  /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    D !== void 0 && /* @__PURE__ */ o("span", { className: "tw-flex-1 tw-text-sm tw-text-muted-foreground", children: ce(
                    ...
                    /* @__PURE__ */ d(xe, { open: P, onOpenChange: G, children: [
                      /* @__PURE__ */ o(ye, { asChild: !0, children: /* @__PURE__ */ o(
                        L,
                        {
                          size: "icon",
                          variant: "outline",
                          className: "tw-flex tw-items-center tw-justify-center tw-rounded-md",
                          disabled: !R || !u || u.length === 0 || !u.includes(i),
                      ...
                      /* @__PURE__ */ o(
                        ne,
                        {
                          ...
                          align: "end",
                          onKeyDown: (_) => {
                            _.key === "Escape" && (_.stopPropagation(), G(!1));
                          },
...
function vp({
  ...
  const [u, g] = I(), k = n.filter(
    (y) => y.comments.some((C) => !C.deleted)
  ), v = k.map((y) => ({
    id: y.id
  })), T = F((y) => {
    g(y.id);
    ...
    g(y);
  }, []), { listboxRef: S, activeId: A, handleKeyDown: j } = Rl({
    options: v,
    onOptionSelect: T
  }), V = F(
    (y) => {
      y.key === "Escape" ? (g(void 0), y.preventDefault(), y.stopPropagation()) : j(y);
    },
    [j]
  );
  return /* @__PURE__ */ o(
...
function Ww({ table: e }) {
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Hi, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ o(_s, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Me = ot.Root, Zw = ot.Group, Ie = ot.Value, Qw = Qt(
  ...
  return /* @__PURE__ */ d(
    ot.Trigger,
    {
      ...
      children: [
        t,
        /* @__PURE__ */ o(ot.Icon, { asChild: !0, children: /* @__PURE__ */ o(fe, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
be.displayName = ot.Trigger.displayName;
...
Va.displayName = ot.ScrollUpButton.displayName;
...
Pa.displayName = ot.ScrollDownButton.displayName;
const ve = b.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, a) => {
  const s = ct();
  return /* @__PURE__ */ o(ot.Portal, { children: /* @__PURE__ */ d(
    ot.Content,
    {
      ref: a,
      className: h(
...
ve.displayName = ot.Content.displayName;
...
tc.displayName = ot.Label.displayName;
const _t = b.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ d(
  ot.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(ot.ItemIndicator, { children: /* @__PURE__ */ o(It, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ o(ot.ItemText, { children: t })
    ]
  }
));
_t.displayName = ot.Item.displayName;
...
ec.displayName = ot.Separator.displayName;
function nc({ table: e }) {
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-space-x-2", children: [
      ...
      /* @__PURE__ */ d(
        Me,
        {
          ...
          children: [
            /* @__PURE__ */ o(be, { className: "tw-h-8 tw-w-[70px]", children: /* @__PURE__ */ o(Ie, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ o(ve, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ o(_t, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
...
function wc({
  ...
  var V;
  const [p, m] = I([]), [f, u] = I([]), [g, k] = I({}), [v, T] = I({}), N = $(() => t ?? [], [t]), S = $o({
    data: N,
    columns: e,
    getCoreRowModel: Bo(),
  ...
  }), A = S.getVisibleFlatColumns();
  let j;
  return c ? j = Array.from({ length: 10 }).map((x, E) => `skeleton-row-${E}`).map((x) => /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(he, { colSpan: A.length ?? e.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ o("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ o(dr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, x)) : ((V = S.getRowModel().rows) == null ? void 0 : V.length) > 0 ? j = S.getRowModel().rows.map((y) => /* @__PURE__ */ o(
    Vt,
    {
      onClick: () => i(y, S),
      "data-state": y.getIsSelected() && "selected",
      children: y.getVisibleCells().map((C) => /* @__PURE__ */ o(he, { children: Ke(C.column.columnDef.cell, C.getContext()) }, C.id))
    },
    y.id
  )) : j = /* @__PURE__ */ o(Vt, { children: /* @__PURE__ */ o(he, { colSpan: e.length, className: "tw-h-24 tw-text-center", children: w }) }), /* @__PURE__ */ d("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ o(Ww, { table: S }),
    /* @__PURE__ */ d(Sn, { stickyHeader: s, children: [
      /* @__PURE__ */ o(Tn, { stickyHeader: s, children: S.getHeaderGroups().map((y) => /* @__PURE__ */ o(Vt, { children: y.headers.map((C) => /* @__PURE__ */ o(tn, { children: C.isPlaceholder ? void 0 : Ke(C.column.columnDef.header, C.getContext()) }, C.id)) }, y.id)) }),
...
function kp({ id: e, label: t, groups: n }) {
  ...
  return /* @__PURE__ */ o("div", { id: e, children: /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o($e, { asChild: !0, children: /* @__PURE__ */ d(L, { variant: "default", children: [
      /* @__PURE__ */ o(Rs, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      t,
    ...
    /* @__PURE__ */ o(re, { children: n.map((w, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ o(Ma, { children: w.itemType === 0 ? /* @__PURE__ */ o(lt, { children: w.items.map((m, f) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(
        Lt,
        {
          checked: r[p][f],
        ...
        Yw,
        {
          ...
          children: w.items.map((m) => /* @__PURE__ */ o("div", { children: /* @__PURE__ */ o(Aa, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ o(Le, {})
    ] }, w.label)) })
...
function mc({
  ...
  const [T, N] = I(!1), S = F(
    (E) => {
      var P;
      const O = (P = e.find((G) => G.label === E)) == null ? void 0 : P.value;
      O && n(
        t.includes(O) ? t.filter((G) => G !== O) : [...t, O]
      );
    },
    [e, t, n]
  ), A = () => c || r, j = $(() => {
    if (!f) return e;
    const E = e.filter((P) => P.starred).sort((P, G) => P.label.localeCompare(G.label)), O = e.filter((P) => !P.starred).sort((P, G) => {
      const D = t.includes(P.value), z = t.includes(G.value);
      return D && !z ? -1 : !D && z ? 1 : P.label.localeCompare(G.label);
    });
    return [...E, ...O];
  }, [e, t, f]), V = () => {
    n(e.map((E) => E.value));
  ...
  return /* @__PURE__ */ o("div", { id: v, className: g, children: /* @__PURE__ */ d(xe, { open: C, onOpenChange: p ?? N, children: [
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(te, { children: [
      ...
      /* @__PURE__ */ d(ee, { children: [
        ...
        /* @__PURE__ */ o(zt, { children: j.map((E) => /* @__PURE__ */ d(
          Gt,
          {
            value: E.label,
            onSelect: S,
            ...
            children: [
              /* @__PURE__ */ o("div", { className: "w-4", children: /* @__PURE__ */ o(
                It,
                {
                  className: h(
                    "tw-h-4 tw-w-4",
                    t.includes(E.value) ? "tw-opacity-100" : "tw-opacity-0"
                  )
                }
              ) }),
              E.starred && /* @__PURE__ */ o(Os, { className: "tw-h-4 tw-w-4" }),
              /* @__PURE__ */ o("div", { className: "tw-flex-grow", children: E.label }),
              E.secondaryLabel && /* @__PURE__ */ o("div", { className: "tw-text-end tw-text-muted-foreground", children: E.secondaryLabel })
            ]
          },
          E.label
        )) })
...
const hc = (e, t, n) => e === "generated" ? /* @__PURE__ */ d(lt, { children: [
...
function fc({
  ...
  const s = tt(null), i = tt(null), l = tt(!1), [c, w] = I(e), [p, m] = I(n), [f, u] = I(!1);
  J(() => {
    w(e);
  }, [e]), J(() => {
    p !== n && m(n);
  ...
  const g = (v) => {
    ...
    var T, N, S, A;
    v.stopPropagation(), document.activeElement === i.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((T = s.current) == null || T.focus(), l.current = !0) : document.activeElement === s.current && v.key === "ArrowUp" ? ((N = i.current) == null || N.focus(), l.current = !1) : document.activeElement === s.current && v.key === "ArrowLeft" && ((S = s.current) == null ? void 0 : S.selectionStart) === 0 && ((A = i.current) == null || A.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === i.current || document.activeElement === s.current) && g(!1);
  };
  return /* @__PURE__ */ d(Ne, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Yt, { children: [
      ...
      /* @__PURE__ */ o($t, { children: a["%footnoteEditor_callerDropdown_tooltip%"] })
    ] }) }),
    /* @__PURE__ */ d(
      re,
      {
...
const gc = (e, t) => e === "f" ? /* @__PURE__ */ d(lt, { children: [
  /* @__PURE__ */ o(No, {}),
  " ",
...
function vc({
  ...
  return /* @__PURE__ */ d(Ne, { children: [
    /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Yt, { children: [
      ...
      /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: bc(e, n) }) })
    ] }) }),
...
function Sp({
  ...
  const c = tt(null), w = ms(), [p, m] = I("generated"), [f, u] = I("*"), [g, k] = I("f"), [v, T] = I(!1), N = $(
    () => ({
      ...i,
  ...
  J(() => {
    ...
    if (C && cn("note", C)) {
      const O = (x = C.insert.note) == null ? void 0 : x.caller;
      let P = "custom";
      O === Qn ? P = "generated" : O === tr ? P = "hidden" : O && u(O), m(P), k(((E = C.insert.note) == null ? void 0 : E.style) ?? "f"), C.insert.note && (C.insert.note.caller = ""), y = setTimeout(() => {
        var G;
  ...
  const S = F(() => {
    var C, x;
    const y = (x = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : x.at(0);
    y && cn("note", y) && (y.insert.note && (p === "custom" ? y.insert.note.caller = f : y.insert.note.caller = p === "generated" ? Qn : tr), n([y]));
  }, [p, f, n]), A = () => {
    var C;
    ...
    var x, E, O, P, G;
    k(y);
    const C = (E = (x = c.current) == null ? void 0 : x.getNoteOps(0)) == null ? void 0 : E.at(0);
    if (C && cn("note", C)) {
      C.insert.note && (C.insert.note.style = y);
      const D = (P = (O = C.insert.note) == null ? void 0 : O.contents) == null ? void 0 : P.ops;
      g !== "x" && y === "x" ? D == null || D.forEach((z) => {
        var X;
        const R = (X = z.attributes) == null ? void 0 : X.char;
        R.style && (R.style = R.style === "ft" ? "xt" : "xo");
      }) : g === "x" && y !== "x" && (D == null || D.forEach((z) => {
        var X;
        const R = (X = z.attributes) == null ? void 0 : X.char;
        R.style && (R.style = R.style === "xt" ? "ft" : "fr");
      })), (G = c.current) == null || G.applyUpdate([{ delete: 1 }, C]);
    }
  }, V = () => {
    var C, x, E, O, P, G;
    const y = (x = (C = c.current) == null ? void 0 : C.getNoteOps(0)) == null ? void 0 : x.at(0);
    if (y && cn("note", y)) {
      const D = (O = (E = y == null ? void 0 : y.insert) == null ? void 0 : E.note) == null ? void 0 : O.style, z = (G = (P = y.insert.note) == null ? void 0 : P.contents) == null ? void 0 : G.ops;
      D || T(!1), T(
        D === "x" ? !!(z != null && z.every((R) => {
          var dt, ht;
          if (!((dt = R.attributes) != null && dt.char)) return !1;
          const X = ((ht = R.attributes) == null ? void 0 : ht.char).style;
          return X === "xt" || X === "xo";
        })) : !!(z != null && z.every((R) => {
          var dt, ht;
          if (!((dt = R.attributes) != null && dt.char)) return !1;
    ...
    /* @__PURE__ */ d("div", { className: "tw-flex", children: [
      ...
      /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
        /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Yt, { children: [
          ...
          /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_cancelButton_tooltip%"] }) })
        ] }) }),
        /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Yt, { children: [
          ...
          /* @__PURE__ */ o($t, { children: l["%footnoteEditor_saveButton_tooltip%"] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("div", { className: "tw-absolute tw-bottom-0 tw-right-0", children: /* @__PURE__ */ o(Pt, { children: /* @__PURE__ */ d(Yt, { children: [
            ...
            /* @__PURE__ */ o($t, { children: /* @__PURE__ */ o("p", { children: l["%footnoteEditor_copyButton_tooltip%"] }) })
          ] }) }) })
        ]
      }
    )
  ...
  return /* @__PURE__ */ d(lt, { children: [
    ...
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ o(lt, { children: xc(e.marker, l, r, w) })
      }
    )
  ] });
}
function Rp({
  ...
  const p = c ?? ri(n, void 0), m = (N, S) => {
    w == null || w(N, S, a);
  }, f = s ? n.findIndex((N) => N === s) : -1, [u, g] = I(f), k = (N, S, A) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), w == null || w(S, A, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
        ...
        "ul",
        {
          ...
          children: n.map((N, S) => {
            ...
            return /* @__PURE__ */ d(lt, { children: [
              ...
              S < n.length - 1 && r === "vertical" && /* @__PURE__ */ o(De, { tabIndex: -1, className: "tw-col-span-2" })
            ] });
          })
        }
      )
...
function _c({
  ...
  return /* @__PURE__ */ d(Sn, { stickyHeader: !0, children: [
    /* @__PURE__ */ o(Tn, { stickyHeader: !0, children: /* @__PURE__ */ d(Vt, { children: [
    ...
    /* @__PURE__ */ o(Rn, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ d(
      Vt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(he, { className: r, children: kc(l.text) })
        ]
      },
...
const Ar = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  er.Root,
  {
    ref: n,
    className: h(
    ...
    children: /* @__PURE__ */ o(
      er.Indicator,
      {
        ...
        children: /* @__PURE__ */ o(It, { className: "tw-h-4 tw-w-4" })
      }
    )
  }
));
Ar.displayName = er.Root.displayName;
const Dn = (e) => e === "asc" ? /* @__PURE__ */ o($s, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : e === "desc" ? /* @__PURE__ */ o(Ls, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ o(Bs, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Dp = (e) => ({
  accessorKey: "item",
  ...
  cell: ({ row: s }) => {
    ...
    return /* @__PURE__ */ d(Mr, { value: i, variant: "outline", type: "single", children: [
      /* @__PURE__ */ o(
        qe,
        {
          onClick: (c) => {
  ...
  return t ? t[1] : "";
}, Ec = (e, t, n) => n.includes(e) ? "unapproved" : t.includes(e) ? "approved" : "unknown", Pp = Object.freeze([
  ...
  return e.forEach((a) => {
    const s = r.find(
      (i) => _o(
        i.items,
        Pn(a.inventoryText) ? [a.inventoryText] : a.inventoryText
      )
    );
    if (s)
      ...
      const i = {
        items: Pn(a.inventoryText) ? [a.inventoryText] : a.inventoryText,
        count: 1,
        status: Ec(
          Pn(a.inventoryText) ? a.inventoryText : a.inventoryText[0],
          t,
          n
        ),
        occurrences: [
...
function $p({
  ...
  const f = Rt(n, "%webView_inventory_all%"), u = Rt(n, "%webView_inventory_approved%"), g = Rt(n, "%webView_inventory_unapproved%"), k = Rt(n, "%webView_inventory_unknown%"), v = Rt(n, "%webView_inventory_scope_currentBook%"), T = Rt(n, "%webView_inventory_scope_chapter%"), N = Rt(n, "%webView_inventory_scope_verse%"), S = Rt(n, "%webView_inventory_filter_text%"), A = Rt(
    n,
    "%webView_inventory_show_additional_items%"
  ), j = Rt(n, "%webView_inventory_no_results%"), [V, y] = I(!1), [C, x] = I("all"), [E, O] = I(""), [P, G] = I([]), D = $(() => {
    const B = e ?? [];
    return B.length === 0 ? [] : Tc(B, a, s);
  }, [e, a, s]), z = $(() => {
    if (V) return D;
    const B = [];
    return D.forEach((at) => {
      const pt = at.items[0], ut = B.find(
        (Nt) => Nt.items[0] === pt
      );
      ut ? (ut.count += at.count, ut.occurrences = ut.occurrences.concat(at.occurrences)) : B.push({
        items: [pt],
        count: at.count,
  ...
  }, [V, D]), R = $(() => z.length === 0 ? [] : Sc(z, C, E), [z, C, E]), X = $(() => {
    var pt, ut;
    if (!V) return c;
    const B = (pt = r == null ? void 0 : r.tableHeaders) == null ? void 0 : pt.length;
    if (!B) return c;
    const at = [];
    for (let Nt = 0; Nt < B; Nt++)
      at.push(
        Cc(
          ((ut = r == null ? void 0 : r.tableHeaders) == null ? void 0 : ut[Nt]) || "Additional Item",
          Nt + 1
        )
      );
    return [...at, ...c];
  }, [r == null ? void 0 : r.tableHeaders, c, V]);
  J(() => {
    R.length === 0 ? G([]) : R.length === 1 && G(R[0].items);
  }, [R]);
  const dt = (B, at) => {
    at.setRowSelection(() => {
      const pt = {};
      return pt[B.index] = !0, pt;
    }), G(B.original.items);
  }, ht = (B) => {
    ...
    if (z.length === 0 || P.length === 0) return [];
    const B = z.filter((at) => _o(
      V ? at.items : [at.items[0]],
      P
    ));
  ...
  return /* @__PURE__ */ d("div", { id: w, className: "pr-twp tw-flex tw-h-full tw-flex-col", children: [
    /* @__PURE__ */ d("div", { className: "tw-flex tw-items-stretch", children: [
      /* @__PURE__ */ d(
        Me,
        {
          onValueChange: (B) => Ct(B),
          defaultValue: C,
          children: [
            /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select filter" }) }),
            /* @__PURE__ */ d(ve, { children: [
              ...
              /* @__PURE__ */ o(_t, { value: "unknown", children: k })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ d(Me, { onValueChange: (B) => ht(B), defaultValue: i, children: [
        /* @__PURE__ */ o(be, { className: "tw-m-1", children: /* @__PURE__ */ o(Ie, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ d(ve, { children: [
          /* @__PURE__ */ o(_t, { value: "book", children: v }),
          /* @__PURE__ */ o(_t, { value: "chapter", children: T }),
      ...
      r && /* @__PURE__ */ d("div", { className: "tw-m-1 tw-flex tw-items-center tw-rounded-md tw-border", children: [
        ...
        /* @__PURE__ */ o(wt, { className: "tw-m-1 tw-flex-shrink-0 tw-whitespace-nowrap", children: (r == null ? void 0 : r.checkboxText) ?? A })
      ] })
    ] }),
    ...
    it.length > 0 && /* @__PURE__ */ o("div", { className: "tw-m-1 tw-flex-1 tw-overflow-auto tw-rounded-md tw-border", children: /* @__PURE__ */ o(
      _c,
      {
        classNameForText: m,
        occurrenceData: it,
...
function Bp({ localizedStrings: e, markerMenuItems: t }) {
  const [n, r] = I(""), a = $(() => {
  ...
  return /* @__PURE__ */ d(te, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ d(ee, { children: [
      ...
      /* @__PURE__ */ o(zt, { children: a.map((s) => /* @__PURE__ */ d(
        Gt,
        {
...
const Rc = "16rem", Dc = "3rem", La = b.createContext(void 0);
function Mn() {
...
const Ba = b.forwardRef(
  ({
    ...
    const [w, p] = b.useState(e), m = t ?? w, f = b.useCallback(
      (S) => {
        const A = typeof S == "function" ? S(m) : S;
        n ? n(A) : p(A);
      },
      [n, m]
    ), u = b.useCallback(() => f((S) => !S), [f]), g = m ? "expanded" : "collapsed", T = ct() === "ltr" ? i : i === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: f,
    ...
    return /* @__PURE__ */ o(La.Provider, { value: N, children: /* @__PURE__ */ o(Pt, { delayDuration: 0, children: /* @__PURE__ */ o(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const ja = b.forwardRef(({ variant: e = "sidebar", collapsible: t = "offcanvas", className: n, children: r, ...a }, s) => {
  const i = Mn();
...
const Lc = Qt(
  ...
  ({
    ...
    const c = e ? Oe : "button", { state: w } = Mn(), p = /* @__PURE__ */ o(
      c,
      {
        ref: l,
        ...
        "data-size": r,
        "data-active": t,
        className: h(Lc({ variant: n, size: r }), s),
        ...i
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ o($t, { side: "right", align: "center", hidden: w !== "collapsed", ...a })
    ] })) : p;
  }
);
...
jc.displayName = "SidebarMenuBadge";
    ...
    ja,
    {
      ...
      children: /* @__PURE__ */ d(Fa, { children: [
        /* @__PURE__ */ d(pr, { children: [
          ...
          /* @__PURE__ */ o(mr, { children: /* @__PURE__ */ o(Ga, { children: Object.entries(t).map(([f, u]) => /* @__PURE__ */ o(Ha, { children: /* @__PURE__ */ o(
            Xa,
            {
              onClick: () => w(f),
              isActive: m(f),
    ...
    /* @__PURE__ */ d(
      Ba,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(za, { className: "tw-min-w-[215px]", children: r })
        ]
      }
    )
  ] });
}
const Ut = "scrBook", Kc = "scrRef", we = "source", Uc = "details", Yc = "Scripture Reference", qc = "Scripture Book", Ka = "Type", Jc = "Details";
function Wc(e, t) {
  const n = t ?? !1;
  return [
    {
...
const Zc = (e) => {
  ...
  let n = 0;
  return e.end && ({ offset: n } = e.end), !e.end || Zn(e.start, e.end) === 0 ? `${$n(e.start)}+${t}` : `${$n(e.start)}+${t}-${$n(e.end)}+${n}`;
}, uo = (e) => `${Zc({ start: e.start, end: e.end })} ${e.source.displayName} ${e.detail}`;
function zp({
  sources: e,
  ...
  const [w, p] = I([]), [m, f] = I([{ id: Ut, desc: !1 }]), [u, g] = I({}), k = $(
    () => e.flatMap((x) => x.data.map((E) => ({
      ...E,
      source: x.source
    }))),
    [e]
  ...
  J(() => {
    if (l) {
      const x = T.getSelectedRowModel().rowsById, E = Object.keys(x);
      if (E.length === 1) {
        const O = k.find((P) => uo(P) === E[0]) || void 0;
        O && l(O);
      }
    }
  }, [u, k, l, T]);
  const N = a ?? qc, S = s ?? Ka, A = [
    { label: "No Grouping", value: [] },
    { label: `Group by ${N}`, value: [Ut] },
    { label: `Group by ${S}`, value: [we] },
    {
    ...
    !x.getIsGrouped() && !x.getIsSelected() && x.getToggleSelectedHandler()(E);
  }, y = (x, E) => x.getIsGrouped() ? "" : h("banded-row", E % 2 === 0 ? "even" : "odd"), C = (x, E, O) => {
    if (!((x == null ? void 0 : x.length) === 0 || E.depth < O.column.getGroupedIndex())) {
      if (E.getIsGrouped())
        switch (E.depth) {
          case 1:
            return "tw-ps-4";
  ...
  return /* @__PURE__ */ d("div", { id: c, className: "pr-twp tw-flex tw-h-full tw-w-full tw-flex-col", children: [
    !t && /* @__PURE__ */ d(
      Me,
      {
        ...
        children: [
          /* @__PURE__ */ o(be, { className: "tw-mb-1 tw-mt-2", children: /* @__PURE__ */ o(Ie, {}) }),
          /* @__PURE__ */ o(ve, { position: "item-aligned", children: /* @__PURE__ */ o(Zw, { children: A.map((x) => /* @__PURE__ */ o(_t, { value: JSON.stringify(x.value), children: x.label }, x.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ d(Sn, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      t && /* @__PURE__ */ o(Tn, { children: T.getHeaderGroups().map((x) => /* @__PURE__ */ o(Vt, { children: x.headers.filter((E) => E.column.columnDef.header).map((E) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ o(tn, { colSpan: E.colSpan, className: "top-0 tw-sticky", children: E.isPlaceholder ? void 0 : /* @__PURE__ */ d("div", { children: [
          E.column.getCanGroup() ? /* @__PURE__ */ o(
            L,
            {
              variant: "ghost",
      ...
      /* @__PURE__ */ o(Rn, { children: T.getRowModel().rows.map((x, E) => {
        const O = ct();
        return /* @__PURE__ */ o(
          Vt,
          {
            ...
            children: x.getVisibleCells().map((P) => {
              if (!(P.getIsPlaceholder() || P.column.columnDef.enableGrouping && !P.getIsGrouped() && (P.column.columnDef.id !== we || !n)))
                return /* @__PURE__ */ o(
                  he,
                  {
                    className: h(
                    ...
                    children: P.getIsGrouped() ? /* @__PURE__ */ d(
                      L,
                      {
                        ...
                        type: "button",
                        children: [
                          x.getIsExpanded() && /* @__PURE__ */ o(fe, {}),
                          !x.getIsExpanded() && (O === "ltr" ? /* @__PURE__ */ o(Ee, {}) : /* @__PURE__ */ o(qn, {})),
                          " ",
...
const Pr = (e, t) => e.filter((n) => {
  try {
    return Xe(n) === t;
  } catch {
    return !1;
  }
}), Ua = (e, t, n) => Pr(e, t).every((r) => n.includes(r));
function Qc({
  section: e,
  availableBookIds: t,
  selectedBookIds: n,
  ...
  const s = Pr(t, e).length === 0, i = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], w = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ o(
    L,
    {
      variant: "outline",
...
function td({
  ...
  }, [v, T] = I(!1), [N, S] = I(""), A = tt(void 0), j = tt(!1);
  if (e.length !== Z.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const V = $(() => Z.allBookIds.filter(
    (D, z) => e[z] === "1" && !Z.isObsolete(Z.bookIdToNumber(D))
  ), [e]), y = $(() => {
    if (!N.trim()) {
      const R = {
        [K.OT]: [],
    ...
    (D, z = !1) => {
      if (!z || !A.current) {
        n(
          t.includes(D) ? t.filter((it) => it !== D) : [...t, D]
        ), A.current = D;
        return;
      }
      const R = V.findIndex((it) => it === A.current), X = V.findIndex((it) => it === D);
      if (R === -1 || X === -1) return;
      const [dt, ht] = [
        Math.min(R, X),
        Math.max(R, X)
      ], Ct = V.slice(dt, ht + 1).map((it) => it);
      n(
        t.includes(D) ? t.filter((it) => !Ct.includes(it)) : [.../* @__PURE__ */ new Set([...t, ...Ct])]
      );
    },
    [t, n, V]
  ), x = (D) => {
    C(D, j.current), j.current = !1;
  }, E = (D, z) => {
    D.preventDefault(), C(z, D.shiftKey);
  }, O = F(
    (D) => {
      const z = Pr(V, D).map((R) => R);
      n(
        Ua(V, D, t) ? t.filter((R) => !z.includes(R)) : [.../* @__PURE__ */ new Set([...t, ...z])]
      );
    },
    [t, n, V]
  ), P = () => {
  ...
  return /* @__PURE__ */ d("div", { className: "tw-space-y-2", children: [
    /* @__PURE__ */ o("div", { className: "tw-flex tw-flex-wrap tw-gap-2", children: Object.values(K).map((D) => /* @__PURE__ */ o(
      Qc,
      {
        section: D,
        availableBookIds: V,
        ...
        children: [
          ...
          /* @__PURE__ */ o(ne, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ d(
            te,
            {
              shouldFilter: !1,
              onKeyDown: (D) => {
                D.key === "Enter" && (j.current = D.shiftKey);
              },
              children: [
                /* @__PURE__ */ o(
                  Ve,
                ...
                /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: P, children: c }),
                  /* @__PURE__ */ o(L, { variant: "ghost", size: "sm", onClick: G, children: w })
                ] }),
                /* @__PURE__ */ d(ee, { children: [
                  /* @__PURE__ */ o(an, { children: p }),
                  Object.values(K).map((D, z) => {
                    const R = y[D];
                    if (R.length !== 0)
                      return /* @__PURE__ */ d(ho, { children: [
                        /* @__PURE__ */ o(
                          zt,
                          {
                            heading: Zo(D, f, u, g, k),
                            children: R.map((X) => /* @__PURE__ */ o(
                              ta,
                              {
                                bookId: X,
                                isSelected: t.includes(X),
                                onSelect: () => x(X),
                                onMouseDown: (dt) => E(dt, X),
                                section: Xe(X),
                                showCheck: !0,
                                localizedBookNames: a,
                                commandValue: or(X, a),
                        ...
                        z < Object.values(K).length - 1 && /* @__PURE__ */ o(Ho, {})
                      ] }, D);
                  })
                ] })
              ]
    ...
    t.length > 0 && /* @__PURE__ */ d("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      t.slice(
        0,
        t.length === Kn ? Kn : mo
      ).map((D) => /* @__PURE__ */ o(Re, { className: "hover:tw-bg-secondary", variant: "secondary", children: Ce(D, a) }, D)),
    ...
    /* @__PURE__ */ d("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ o(
        Cr,
        {
          ...
          children: T.map(({ value: N, label: S, id: A }) => /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ o(bn, { className: "tw-me-2", value: N, id: A }),
            /* @__PURE__ */ o(wt, { htmlFor: A, children: S })
          ] }, A))
        }
      )
    ] }),
      ...
      children: [
        ...
        /* @__PURE__ */ o(
          ve,
          {
            ...
            style: { zIndex: 250 },
            children: e.map((w) => /* @__PURE__ */ o(_t, { value: `${w}`, children: l[W(w)] }, `${w}`))
          }
        )
      ]
    }
...
const qa = (e, t, n, r) => n ? Object.entries(e).filter(
  ...
  /* @__PURE__ */ o(me, { asChild: !0, children: "command" in l ? /* @__PURE__ */ d(
    ...
    /* @__PURE__ */ o(Ia, { children: l.label }),
    /* @__PURE__ */ o(Kw, { children: /* @__PURE__ */ o(Oa, { children: qa(
      e,
      t,
      Ya(e, l.id),
      r
  ...
  l.tooltip && /* @__PURE__ */ o($t, { children: l.tooltip })
...
function hr({
  ...
  return /* @__PURE__ */ d(Ne, { variant: s, children: [
    /* @__PURE__ */ o($e, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ o(L, { variant: i, size: "icon", children: r ?? /* @__PURE__ */ o(Gs, {}) }) }),
    /* @__PURE__ */ o(re, { align: "start", className: "tw-z-[250]", children: Object.entries(t.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, w]) => typeof c == "boolean" || typeof w == "boolean" ? 0 : c.order - w.order).map(([c], w, p) => /* @__PURE__ */ d(ho, { children: [
      /* @__PURE__ */ o(Ma, { children: /* @__PURE__ */ o(Pt, { children: qa(t.groups, t.items, c, e) }) }),
...
)), Qa = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  xt.Content,
  {
    ref: n,
    className: h(
...
Qa.displayName = xt.Content.displayName;
function Jp({
  tabList: e,
  searchValue: t,
  onSearch: n,
  ...
  return /* @__PURE__ */ d("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ d(Wa, { children: [
      /* @__PURE__ */ o(Za, { children: e.map((l) => /* @__PURE__ */ o(ed, { value: l.value, children: l.value }, l.key)) }),
      e.map((l) => /* @__PURE__ */ o(Qa, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function nd({ ...e }) {
...
const ts = b.forwardRef(({ className: e, variant: t = "default", ...n }, r) => {
  const a = b.useMemo(
    () => ({
      variant: t
    }),
...
ts.displayName = nt.Root.displayName;
  ...
  return /* @__PURE__ */ o(
    nt.Trigger,
    {
      ...
      className: h(
        ...
        // CUSTOM
        "pr-twp",
        Ht({ variant: r.variant, className: e })
        // CUSTOM use context to add variants
      ),
      ...t
    }
...
es.displayName = nt.Trigger.displayName;
const ns = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => {
  const s = Tt();
  return /* @__PURE__ */ d(
    nt.SubTrigger,
    {
      ...
      className: h(
        ...
        t && "tw-pl-8",
        Ht({ variant: s.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...r,
...
ns.displayName = nt.SubTrigger.displayName;
...
rs.displayName = nt.SubContent.displayName;
const os = b.forwardRef(({ className: e, align: t = "start", alignOffset: n = -4, sideOffset: r = 8, ...a }, s) => {
  const i = Tt();
...
os.displayName = nt.Content.displayName;
const as = b.forwardRef(({ className: e, inset: t, ...n }, r) => {
  const a = Tt();
  return /* @__PURE__ */ o(
    nt.Item,
    {
      ...
      className: h(
        ...
        t && "tw-pl-8",
        Ht({ variant: a.variant, className: e }),
        // CUSTOM use context to add variants
        e
      ),
      ...n
...
as.displayName = nt.Item.displayName;
const od = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => {
  ...
  return /* @__PURE__ */ d(
    nt.CheckboxItem,
    {
      ...
      ...r,
      children: [
        /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(nt.ItemIndicator, { children: /* @__PURE__ */ o(It, { className: "tw-h-4 tw-w-4" }) }) }),
        t
      ]
    }
  );
});
od.displayName = nt.CheckboxItem.displayName;
...
ad.displayName = nt.RadioItem.displayName;
...
sd.displayName = nt.Label.displayName;
...
ss.displayName = nt.Separator.displayName;
const Ge = (e, t) => {
  setTimeout(() => {
    t.forEach((n) => {
      var r;
  ...
  return a.flatMap(([s], i) => {
    const l = t.filter((w) => w.group === s).sort((w, p) => w.order - p.order).map((w) => /* @__PURE__ */ d(Yt, { children: [
      /* @__PURE__ */ o(me, { asChild: !0, children: "command" in w ? /* @__PURE__ */ d(
        ...
        /* @__PURE__ */ o(ns, { children: w.label }),
        /* @__PURE__ */ o(rs, { children: is(
          e,
          t,
          Ya(e, w.id),
          r
      ...
      w.tooltip && /* @__PURE__ */ o($t, { children: w.tooltip })
    ] }, `tooltip-${w.label}-${"command" in w ? w.command : w.id}`)), c = [...l];
    return l.length > 0 && i < a.length - 1 && c.push(/* @__PURE__ */ o(ss, {}, `separator-${s}`)), c;
  });
};
function id({
  menuData: e,
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, m) => {
    ...
    return /* @__PURE__ */ o(ts, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: r, children: Object.entries(e.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, m]) => typeof p == "boolean" || typeof m == "boolean" ? 0 : p.order - m.order).map(([p, m]) => /* @__PURE__ */ d(nd, { children: [
      /* @__PURE__ */ o(es, { ref: w(p), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ o(
        os,
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ o(Pt, { children: is(e.groups, e.items, p, t) })
        }
      )
    ] }, p)) });
}
...
function Qp({
  ...
  const w = ld(
    ...
    var T, N, S, A, j, V;
    const v = k !== g ? ((N = (T = e[g]) == null ? void 0 : T.uiNames) == null ? void 0 : N[k]) ?? ((A = (S = e[g]) == null ? void 0 : S.uiNames) == null ? void 0 : A.en) : void 0;
    return v ? `${(j = e[g]) == null ? void 0 : j.autonym} (${v})` : (V = e[g]) == null ? void 0 : V.autonym;
  };
  return /* @__PURE__ */ d("div", { id: c, className: h("pr-twp tw-max-w-sm", l), children: [
    /* @__PURE__ */ d(
      Me,
      {
        ...
        onOpenChange: (g) => m(g),
        children: [
          /* @__PURE__ */ o(be, { children: /* @__PURE__ */ o(Ie, {}) }),
          /* @__PURE__ */ o(
            ve,
            {
              className: "tw-z-[250]",
    ...
    t !== "en" && /* @__PURE__ */ o("div", { className: "tw-pt-3", children: /* @__PURE__ */ o(wt, { className: "tw-font-normal tw-text-muted-foreground", children: ce(w, {
...
const cd = en(({ className: e, ...t }, n) => /* @__PURE__ */ o(Ks, { size: 35, className: h("tw-animate-spin", e), ...t, ref: n }));
...
const md = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o("div", { ref: n, className: h("tw-text-sm [&_p]:tw-leading-relaxed", e), ...t }));
md.displayName = "AlertDescription";
const ru = rt.Root, ou = rt.Trigger, au = rt.Group, su = rt.Portal, iu = rt.Sub, lu = rt.RadioGroup, hd = b.forwardRef(({ className: e, inset: t, children: n, ...r }, a) => /* @__PURE__ */ d(
  rt.SubTrigger,
  {
    ref: a,
    className: h(
...
hd.displayName = rt.SubTrigger.displayName;
...
fd.displayName = rt.SubContent.displayName;
const gd = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ o(
  rt.Content,
  {
    ref: n,
    className: h(
...
gd.displayName = rt.Content.displayName;
...
bd.displayName = rt.Item.displayName;
const vd = b.forwardRef(({ className: e, children: t, checked: n, ...r }, a) => /* @__PURE__ */ d(
  rt.CheckboxItem,
  {
    ...
    ...r,
    children: [
      /* @__PURE__ */ o("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ o(rt.ItemIndicator, { children: /* @__PURE__ */ o(It, { className: "tw-h-4 tw-w-4" }) }) }),
      t
    ]
  }
));
vd.displayName = rt.CheckboxItem.displayName;
...
xd.displayName = rt.RadioItem.displayName;
...
yd.displayName = rt.Label.displayName;
...
Nd.displayName = rt.Separator.displayName;
...
function _d({
  ...
  return /* @__PURE__ */ o(ls.Provider, { value: r, children: /* @__PURE__ */ o(
    St.Root,
    {
...
const wu = St.Trigger, Cd = St.Portal, cu = St.Close, ws = b.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ o(
  St.Overlay,
  {
    ref: n,
...
ws.displayName = St.Overlay.displayName;
...
Rd.displayName = St.Title.displayName;
...
Dd.displayName = St.Description.displayName;
...
Id.displayName = He.Root.displayName;
...
const hu = xt.Root, Ad = b.forwardRef(({ className: e, ...t }, n) => {
  const r = ct();
  return /* @__PURE__ */ o(
    xt.List,
    {
...
Ad.displayName = xt.List.displayName;
...
Vd.displayName = xt.Trigger.displayName;
...
Pd.displayName = xt.Content.displayName;
...
export {
  ...
  wu as DrawerTrigger,
  Ne as DropdownMenu,
  Lt as DropdownMenuCheckboxItem,
