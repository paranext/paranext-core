...
var fi = (t, e, n) => e in t ? mi(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var yt = (t, e, n) => fi(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as sn, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as hi, createElement as jr, Suspense as gi, Fragment as go } from "react";
import { Command as Tt } from "cmdk";
import { X as je, Search as bo, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Jn, ChevronRight as Ie, ArrowLeft as bi, ArrowRight as vi, Circle as Tn, ChevronDown as ze, BoldIcon as xi, ItalicIcon as yi, AtSign as vo, Pencil as Ni, Trash2 as ki, ArrowUp as xo, MoreHorizontal as _i, MailOpen as Ci, Mail as Ei, ChevronUp as yo, FilterIcon as Ti, ArrowLeftIcon as Ri, ChevronLeftIcon as Si, ChevronRightIcon as Di, ArrowRightIcon as Mi, Copy as No, Filter as Ii, User as Oi, Link as Ai, CircleHelp as Pi, ChevronsUpDown as ko, Star as $i, Undo as Li, Redo as Vi, SquareX as _o, FunctionSquare as Co, SquareSigma as Eo, Ban as ji, AlertCircle as Zn, CircleCheckIcon as zi, CircleXIcon as Fi, CircleHelpIcon as Bi, ArrowUpIcon as Ki, ArrowDownIcon as Gi, PanelLeft as Ui, PanelRight as qi, ScrollText as Hi, MenuIcon as Yi, Menu as Xi, EllipsisVertical as Wi, MoreVertical as Kr, LoaderCircle as Ji, GripVertical as Zi } from "lucide-react";
import { clsx as Qi } from "clsx";
import { extendTailwindMerge as ts } from "tailwind-merge";
import * as Mt from "@radix-ui/react-dialog";
import { Canon as ut } from "@sillsdev/scripture";
import { includes as wn, Section as X, getChaptersForBook as es, formatScrRef as xe, getSectionForBook as Je, formatRelativeDate as ns, formatReplacementString as ve, sanitizeHtml as rs, NumberFormat as os, formatBytes as as, getCurrentLocale as is, usfmMarkers as hn, getFormatCallerFunction as ss, deepEqual as ls, isString as Gr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q } from "platform-bible-utils";
...
import { createEditor as Ro, $getRoot as de, $createParagraphNode as Rn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as So, TextNode as Do, $isTokenOrSegmented as cs, $getCharacterOffsets as ds, $cloneWithPropertiesEphemeral as ws, $findMatchingParent as Mo, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Io, COMMAND_PRIORITY_EDITOR as Oo, mergeRegister as we, shallowMergeConfig as ps, defineExtension as qt, safeCast as ln, createState as us, FORMAT_TEXT_COMMAND as Ao, $isNodeSelection as Po, COMMAND_PRIORITY_LOW as $o, RootNode as ms, LineBreakNode as fs, TabNode as hs, $isEditorState as gs, createCommand as bs, CLICK_COMMAND as vs, isDOMNode as xs, $getNodeFromDOMNode as ys, $createNodeSelection as Ns, $setSelection as ks, DecoratorNode as tr, $getState as _s, toggleTextFormatType as Ur, TEXT_TYPE_TO_FORMAT as Cs, $setState as Es, addClassNamesToElement as Lo, $create as Ts, $getNodeByKey as Rs, removeClassNamesFromElement as Ss, KEY_TAB_COMMAND as Ds, $isBlockElementNode as vn, $createRangeSelection as Ms, $normalizeSelection__EXPERIMENTAL as Is, OUTDENT_CONTENT_COMMAND as Os, INDENT_CONTENT_COMMAND as qr, INSERT_TAB_COMMAND as As, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Ps, $isParagraphNode as $s, $isTextNode as xn, SELECTION_CHANGE_COMMAND as Vo, getRegisteredNode as Ls, isHTMLElement as Vs, isDocumentFragment as Hr, isDOMDocumentNode as js, ArtificialNode__DO_NOT_USE as jo, $createLineBreakNode as zo, $isRootOrShadowRoot as zs, isBlockDomNode as Yr, isInlineDomNode as Xr, $insertNodes as Fs } from "lexical";
import * as _e from "@radix-ui/react-tooltip";
import { TooltipTrigger as Bs } from "@radix-ui/react-tooltip";
import { HeadingNode as Ks, QuoteNode as Gs, registerRichText as Us } from "@lexical/rich-text";
import { flushSync as qs, createPortal as Hs } from "react-dom";
import { $isTableSelection as Ys } from "@lexical/table";
import * as Sn from "@radix-ui/react-toggle-group";
import * as Fo from "@radix-ui/react-toggle";
import { createHeadlessEditor as Bo } from "@lexical/headless";
import * as Ko from "@radix-ui/react-separator";
...
import { useReactTable as Go, getFilteredRowModel as Ws, getSortedRowModel as Uo, getPaginationRowModel as Js, getCoreRowModel as qo, flexRender as Ze, getGroupedRowModel as Zs, getExpandedRowModel as Qs } from "@tanstack/react-table";
import * as wt from "@radix-ui/react-select";
import tl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as er, HIDDEN_NOTE_CALLER as nr, getDefaultViewOptions as el, isInsertEmbedOpOfType as pn, Editorial as nl } from "@eten-tech-foundation/platform-editor";
...
const sl = Mt.Root, gp = Mt.Trigger, ll = Mt.Portal, bp = Mt.Close, Ho = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
    className: f(
...
Ho.displayName = Mt.Overlay.displayName;
const Yo = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ p(ll, { children: [
    /* @__PURE__ */ r(Ho, {}),
    /* @__PURE__ */ p(
      Mt.Content,
      {
...
Yo.displayName = Mt.Content.displayName;
...
cl.displayName = "DialogFooter";
const Wo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Title,
  {
    ref: n,
...
Wo.displayName = Mt.Title.displayName;
...
dl.displayName = Mt.Description.displayName;
...
const cn = b.forwardRef((t, e) => /* @__PURE__ */ r(Tt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
cn.displayName = Tt.Empty.displayName;
...
const yr = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Tt.Separator,
  {
    ref: n,
...
yr.displayName = Tt.Separator.displayName;
...
const Qo = ut.allBookIds.filter(
  (t) => !ut.isObsolete(ut.bookIdToNumber(t))
), ye = Object.fromEntries(
  Qo.map((t) => [t, ut.bookIdToEnglishName(t)])
);
function kr(t, e, n) {
...
const ta = sn(
  ({
    ...
    const w = H(!1), m = () => {
      w.current || n == null || n(t), setTimeout(() => {
        w.current = !1;
      }, 100);
    }, h = (x) => {
      w.current = !0, o ? o(x) : n == null || n(t);
    }, u = B(
      () => Me(t, l),
      [t, l]
    ), g = B(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? Fe : "button", { className: f(ea({ variant: e, size: n, className: t })), ref: i, ...a })
);
F.displayName = "Button";
const Ge = 250, na = 300, pl = 400, vp = 450, xp = 500, oe = Oe.Root, fe = Oe.Trigger, ul = Oe.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, i) => {
  const s = mt();
...
Yt.displayName = Oe.Content.displayName;
function ir(t, e, n) {
  return `${t} ${ye[t]}${e ? ` ${Nr(t, e)} ${Me(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function ml({
  recentSearches: t,
  ...
  return /* @__PURE__ */ p(oe, { open: w, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ r(Yt, { id: s, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r(Ut, { heading: i, children: t.map((u) => /* @__PURE__ */ p(
      Ht,
      {
        onSelect: () => h(u),
  ...
  const o = fl.reduce(
    (a, i) => {
      ...
      if (s) {
        ...
        let w;
        const m = e.filter((h) => kr(h, l, n));
        if (m.length === 1 && ([w] = m), !w && c) {
        ...
        if (w) {
          ...
          h && h > Gt(w) && (h = Math.max(Gt(w), 1));
          const u = d ? parseInt(d, 10) : void 0;
          return {
            book: w,
            chapterNum: h,
            verseNum: u
...
function gl(t, e, n, o) {
  const a = K(() => {
    if (t.chapterNum > 1)
      ...
      if (c > 0) {
        const d = e[c - 1], w = Math.max(Gt(d), 1);
        o({
          book: d,
          chapterNum: w,
          verseNum: 1
...
function Jr({
  ...
  if (t)
    return /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r("div", { className: f("tw-grid tw-grid-cols-6 tw-gap-1", i), children: Array.from({ length: Gt(t) }, (s, l) => l + 1).map((s) => /* @__PURE__ */ r(
      Ht,
      {
        value: `${t} ${ye[t] || ""} ${s}`,
        onSelect: () => n(s),
...
function Np({
  ...
  const d = mt(), [w, m] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, y] = S("books"), [N, k] = S(void 0), [C, j] = S(!1), z = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ), $ = B(() => o ? o() : Qo, [o]), O = B(() => ({
    [X.OT]: $.filter((_) => ut.isBookOT(_)),
    [X.NT]: $.filter((_) => ut.isBookNT(_)),
    [X.DC]: $.filter((_) => ut.isBookDC(_)),
    [X.Extra]: $.filter((_) => ut.extraBooks().includes(_))
  }), [$]), P = B(() => Object.values(O).flat(), [O]), W = B(() => {
    if (!g.trim()) return O;
    const D = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    (D) => I ? !!I.chapterNum && !D.toString().includes(I.chapterNum.toString()) : !1,
    [I]
  ), Jt = B(
    () => xe(
      t,
    ...
    (D) => {
      if (D.ctrlKey) return;
      const { isLetter: _, isDigit: L } = Wr(D.key);
      if (v === "chapters") {
        if (D.key === "Backspace") {
        ...
        if (_ || L) {
          if (D.preventDefault(), D.stopPropagation(), y("books"), k(void 0), L && N) {
            const U = ye[N];
            x(`${U} ${D.key}`);
          } else
            x(D.key);
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(D.key)) {
        ...
        tt !== q && (D.preventDefault(), D.stopPropagation(), u(ir(U, a, tt)), setTimeout(() => {
          const dt = R.current[tt];
    ...
    const { isLetter: _, isDigit: L } = Wr(D.key);
    (_ || L) && (D.preventDefault(), x((U) => U + D.key), A.current.focus(), j(!1));
  }, []);
  return At(() => {
    const D = setTimeout(() => {
      if (w && v === "books" && M.current && E.current) {
        const _ = M.current, L = E.current, U = L.offsetTop, q = _.clientHeight, st = L.clientHeight, tt = U - q / 2 + st / 2;
        _.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), u(ir(t.book));
    ...
    if (v === "chapters" && N) {
      ...
      setTimeout(() => {
        if (M.current)
          if (D) {
            const _ = R.current[t.chapterNum];
  ...
  }, [v, N, I, t.book, t.chapterNum]), /* @__PURE__ */ p(oe, { open: w, onOpenChange: G, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
      F,
      {
    ...
    /* @__PURE__ */ r(Yt, { id: c, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ p(
      ne,
      {
        ref: z,
        onKeyDown: Zt,
        ...
        children: [
          v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r("div", { className: "tw-flex tw-items-center tw-gap-1 tw-border-b tw-pe-2", children: gt.map(({ onClick: D, disabled: _, title: L, icon: U }) => /* @__PURE__ */ r(
              F,
              {
                variant: "ghost",
                size: "sm",
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                tabIndex: -1,
                children: d === "ltr" ? /* @__PURE__ */ r(bi, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(vi, { className: "tw-h-4 tw-w-4" })
              }
            ),
            N && /* @__PURE__ */ r("span", { tabIndex: -1, className: "tw-text-sm tw-font-medium", children: Me(N, a) })
          ] }),
          !C && /* @__PURE__ */ p(re, { ref: M, children: [
            v === "books" && /* @__PURE__ */ p(lt, { children: [
              !I && Object.entries(W).map(([D, _]) => {
                if (_.length !== 0)
                  return (
                    // We are mapping over filteredBooksByType, which uses Section as key type
                    // eslint-disable-next-line no-type-assertion/no-type-assertion
                    /* @__PURE__ */ r(Ut, { heading: Wt(D), children: _.map((L) => /* @__PURE__ */ r(
                      ta,
                      {
                        bookId: L,
                        onSelect: (U) => St(U),
              ...
              I && /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r(
                Ht,
                {
                  ...
                  children: xe(
                    ...
                    a ? Nr(I.book, a) : void 0
                  )
                },
                "top-match"
              ) }),
              I && Gt(I.book) > 1 && /* @__PURE__ */ p(lt, { children: [
                /* @__PURE__ */ r("div", { className: "tw-mb-2 tw-px-3 tw-text-sm tw-font-medium tw-text-muted-foreground", children: Me(I.book, a) }),
                /* @__PURE__ */ r(
                  Jr,
                  {
                    bookId: I.book,
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(To.Root, { ref: n, className: f("pr-twp", bl(), t), ...e }));
ht.displayName = To.Root.displayName;
const _r = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    nn.Root,
    {
...
_r.displayName = nn.Root.displayName;
const yn = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  nn.Item,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(nn.Indicator, { className: "tw-flex tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Tn, { className: "tw-h-2.5 tw-w-2.5 tw-fill-current tw-text-current" }) })
  }
));
yn.displayName = nn.Item.displayName;
function vl(t) {
...
function sr({
  ...
  const [k, C] = S(!1), j = d ?? c, z = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
    const R = c(M), V = typeof M == "object" && "secondaryLabel" in M ? M.secondaryLabel : void 0, $ = `${E ?? ""}${R}${V ?? ""}`;
    return /* @__PURE__ */ p(
      Ht,
      {
        value: R,
  ...
  return /* @__PURE__ */ p(oe, { open: k, onOpenChange: C, ...N, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          /* @__PURE__ */ r(Ke, { placeholder: h, className: "tw-text-inherit" }),
          /* @__PURE__ */ r(cn, { children: u }),
          /* @__PURE__ */ r(re, { children: z(e) ? e.map((M) => /* @__PURE__ */ r(Ut, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
var lr = /* @__PURE__ */ ((t) => (t.CurrentBook = "current book", t.ChooseBooks = "choose books", t))(lr || {});
((t) => {
...
function Cp({
  ...
  const w = jn(d, "%webView_bookSelector_currentBook%"), m = jn(d, "%webView_bookSelector_choose%"), h = jn(d, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
      ...
      children: /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        /* @__PURE__ */ p("div", { className: "tw-grid tw-grid-cols-[25%,25%,50%]", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            ...
            /* @__PURE__ */ r(ht, { className: "tw-ms-1", children: w })
          ] }),
...
const oa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Nl = oa ? At : Y, un = { tag: br };
function kl({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: i, onError: s, editorState: l, html: c } = t, d = yl(null, o), w = Ro({ editable: t.editable, html: c, namespace: a, nodes: i, onError: (m) => s(m, w), theme: o });
    return function(m, h) {
      if (h !== null) {
        if (h === void 0) m.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Rn();
            u.append(g);
            const x = oa ? document.activeElement : null;
            (Vt() !== null || x !== null && x === m.getRootElement()) && g.select();
          }
        }, un);
  ...
  }, []), r(ra.Provider, { value: n, children: e });
}
const _l = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function Cl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  ...
  return _l(() => {
    if (n) return o.registerUpdateListener(({ editorState: a, dirtyElements: i, dirtyLeaves: s, prevEditorState: l, tags: c }) => {
      e && i.size === 0 && s.size === 0 || t && c.has(br) || l.isEmpty() || n(a, o, c);
    });
  }, [o, t, e, n]), null;
}
const Cr = {
  ...
  {
    ref: o,
    className: e ? f(ea({ variant: e }), t) : t,
    ...n
  }
));
Et.displayName = _e.Trigger.displayName;
const _t = b.forwardRef(({ className: t, sideOffset: e = 4, style: n, ...o }, a) => /* @__PURE__ */ r(_e.Portal, { children: /* @__PURE__ */ r(
  _e.Content,
  {
    ref: a,
    sideOffset: e,
...
class Tl extends hi {
  ...
  componentDidUpdate(e, n) {
    ...
    if (o && n.error !== null && Rl(e.resetKeys, a)) {
      var i, s;
...
function Sl({ children: t, onError: e }) {
  return r(Tl, { fallback: r("div", { style: { border: "1px solid #f00", color: "#f00", padding: "8px" }, children: "An error was thrown." }), onError: e, children: t });
}
...
function Il() {
  return function(t) {
    const [e] = Xt(), n = B(() => t(e), [e, t]), [o, a] = S(() => n.initialValueFn()), i = H(o);
    return Dl(() => {
      const { initialValueFn: s, subscribe: l } = n, c = s();
      return i.current !== c && (i.current = c, a(c)), l((d) => {
        i.current = d, a(d);
      });
    }, [n, t]), o;
  }(Ml);
}
function Ol(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !cs(e) && o !== null) {
    const [a, i] = o, s = t.isBackward(), l = a.getNode(), c = i.getNode(), d = e.is(l), w = e.is(c);
    if (d || w) {
      const [m, h] = ds(t), u = l.is(c), g = e.is(s ? c : l), x = e.is(s ? l : c);
      let v, y = 0;
      u ? (y = m > h ? h : m, v = m > h ? m : h) : g ? (y = s ? h : m, v = void 0) : x && (y = 0, v = s ? m : h);
...
const aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Pl = aa && "documentMode" in document ? document.documentMode : null;
!(!aa || !("InputEvent" in window) || Pl) && "getTargetRanges" in new window.InputEvent("input");
function $l(t) {
  const e = Mo(t, (n) => le(n) && !n.isInline());
  return le(e) || Al(4, t.__key), e;
}
function Ll(t) {
  const e = Vt();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(s)) continue;
    const l = Mo(i, (d) => le(d) && !d.isInline());
    if (l === null) continue;
    const c = l.getKey();
...
function ge(t, e) {
  Nt.call(this, void 0), this.x = t, this.s = void 0, this.g = gn - 1, this.f = 4, this.W = e == null ? void 0 : e.watched, this.Z = e == null ? void 0 : e.unwatched, this.name = e == null ? void 0 : e.name;
}
function zl(t, e) {
  return new ge(t, e);
}
...
function Fl(t) {
  ...
  sa(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Dn();
}
function De(t, e) {
...
function Mn(t, e = {}) {
  const n = {};
  for (const o in t) {
    const a = e[o], i = rn(a === void 0 ? t[o] : a);
    n[o] = i;
  }
  return n;
}
Nt.prototype.brand = Vl, Nt.prototype.h = function() {
  return !0;
}, Nt.prototype.S = function(t) {
  const e = this.t;
  e !== t && t.e === void 0 && (t.x = e, this.t = t, e !== void 0 ? e.e = t : Zr(() => {
    var n;
  ...
  if (this.t !== void 0) {
    const e = t.e, n = t.x;
    e !== void 0 && (e.x = n, t.e = void 0), n !== void 0 && (n.e = e, t.x = void 0), t === this.t && (this.t = n, n === void 0 && Zr(() => {
      var o;
  ...
  if (this.g = gn, this.f |= 1, this.i > 0 && !ia(this)) return this.f &= -2, !0;
  const t = Z;
  try {
    to(this), Z = this;
    const e = this.x();
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, la(this), to(this), ce++;
  const t = Z;
  return Z = this, Fl.bind(this, t);
...
qt({ build: (t, e, n) => Mn(e), config: ln({ defaultSelection: "rootEnd", disabled: !1 }), name: "@lexical/extension/AutoFocus", register(t, e, n) {
  const o = n.getOutput();
...
function ca() {
  const t = de(), e = Vt(), n = Rn();
  t.clear(), t.append(n), e !== null && n.select(), ke(e) && (e.format = 0);
}
function da(t, e = ca) {
  return t.registerCommand(Io, (n) => (t.update(e), !0), Oo);
}
qt({ build: (t, e, n) => Mn(e), config: ln({ $onClear: ca }), name: "@lexical/extension/ClearEditor", register(t, e, n) {
  const { $onClear: o } = n.getOutput();
  return pe(() => da(t, o.value));
} });
function Bl(t) {
  return (typeof t.nodes == "function" ? t.nodes() : t.nodes) || [];
}
const Fn = us("format", { parse: (t) => typeof t == "number" ? t : 0 });
class wa extends tr {
  $config() {
  ...
  toggleFormat(e) {
    const n = this.getFormat(), o = Ur(n, e, null);
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [wa], register: (t, e, n) => t.registerCommand(Ao, (o) => {
  const a = Vt();
  if (Po(a) || ke(a)) for (const i of a.getNodes()) Kl(i) && i.toggleFormat(o);
  return !1;
}, $o) });
function pa(t, e) {
  let n;
...
const dr = qt({ build: (t) => pa(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Rr = 0, wr = 1, ma = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Rr;
}
function fa(t) {
...
function Gl(t) {
  return function(e) {
    return e.id === wr;
  }(t) || et(305, String(t.id), String(wr)), Object.assign(t, { id: ma });
}
...
class ql {
  constructor(e, n) {
    ...
    yt(this, "state");
    yt(this, "_signal");
    this.builder = e, this.extension = n, this.configs = /* @__PURE__ */ new Set(), this.state = { id: Rr };
  }
  mergeConfigs() {
    let e = this.extension.config || {};
    const n = this.extension.mergeConfig ? this.extension.mergeConfig.bind(this.extension) : ps;
    for (const o of this.configs) e = n(e, o);
    return e;
  }
  init(e) {
    const n = this.state;
    fa(n) || et(306, String(n.id));
    const o = { getDependency: this.getInitDependency.bind(this), getDirectDependentNames: this.getDirectDependentNames.bind(this), getPeer: this.getInitPeer.bind(this), getPeerNameSet: this.getPeerNameSet.bind(this) }, a = { ...o, getDependency: this.getDependency.bind(this), getInitResult: this.getInitResult.bind(this), getPeer: this.getPeer.bind(this) }, i = function(l, c, d) {
      return Object.assign(l, { config: c, id: Bn, registerState: d });
    }(n, this.mergeConfigs(), o);
    let s;
    this.state = i, this.extension.init && (s = this.extension.init(e, i.config, o)), this.state = function(l, c, d) {
      return Object.assign(l, { id: mn, initResult: c, registerState: d });
    }(i, s, a);
  }
  build(e) {
    const n = this.state;
    let o;
    n.id !== mn && et(307, String(n.id), String(Se)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
    const a = { ...n.registerState, getOutput: () => o, getSignal: this.getSignal.bind(this) };
    this.state = function(i, s, l) {
      return Object.assign(i, { id: Se, output: s, registerState: l });
    }(n, o, a);
  }
  register(e, n) {
    this._signal = n;
    ...
    return this.state = function(i) {
      return Object.assign(i, { id: Kn });
    }(o), () => {
      const i = this.state;
      i.id !== Ye && et(309, String(o.id), String(Ye)), this.state = function(s) {
        return Object.assign(s, { id: Se });
      }(i), a && a();
    };
  }
  afterRegistration(e) {
    const n = this.state;
    let o;
    return n.id !== Kn && et(310, String(n.id), String(Kn)), this.extension.afterRegistration && (o = this.extension.afterRegistration(e, n.config, n.registerState)), this.state = function(a) {
  ...
  getExtensionInitDependency() {
    ...
    return function(n) {
      return n.id >= Bn;
    }(e) || et(314, String(e.id), String(Bn)), { config: e.config };
  }
  getPeer(e) {
    const n = this.builder.extensionNameMap.get(e);
  ...
  getDirectDependentNames() {
    return this.builder.incomingEdges.get(this.extension.name) || Ul;
  }
  getPeerNameSet() {
...
const Yl = qt({ config: ln({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: t = Hl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
  const a = o.getInitResult();
  if (!a.initialized) {
    a.initialized = !0;
    const { $initialEditorState: i } = a;
    if (gs(i)) t.setEditorState(i, n);
...
}, name: "@lexical/extension/InitialState", nodes: [ms, Do, fs, hs, So] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function Xl(t) {
  throw t;
...
class tn {
  ...
  static maybeFromEditor(e) {
    const n = e[no];
    return n && (n.PACKAGE_VERSION !== Un && et(292, n.PACKAGE_VERSION, Un), n instanceof tn || et(293)), n;
  }
  static fromEditor(e) {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(Ro({ ...o, ...n ? { onError: (i) => {
      n(i, a);
    } } : {} }), { [no]: this });
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Gn(i) || et(300, s, a || "[unknown]"), Gn(l = i) || et(304, String(l.id), String(Rr)), i = Object.assign(l, { id: wr }), o.state = i;
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of l) {
      const { extension: m } = w;
      if (m.onError !== void 0 && (e.onError = m.onError), m.disableEvents !== void 0 && (e.disableEvents = m.disableEvents), m.parentEditor !== void 0 && (e.parentEditor = m.parentEditor), m.editable !== void 0 && (e.editable = m.editable), m.namespace !== void 0 && (e.namespace = m.namespace), m.$initialEditorState !== void 0 && (e.$initialEditorState = m.$initialEditorState), m.nodes) for (const h of Bl(m)) {
        if (typeof h != "function") {
          const u = o.get(h.replace);
          u && et(302, m.name, h.replace.name, u.extension.name), o.set(h.replace, w);
        }
        n.add(h);
      }
      if (m.html) {
      ...
      m.theme && ua(s, m.theme);
    }
    Object.keys(s).length > 0 && (e.theme = s), n.size && (e.nodes = [...n]);
    const c = Object.keys(i).length > 0, d = a.size > 0;
    (c || d) && (e.html = {}, c && (e.html.import = i), d && (e.html.export = a));
    for (const w of l) w.init(e);
    return e.onError || (e.onError = Xl), e;
  }
}
const Wl = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(dr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), i = pa(() => {
  }, () => pe(() => {
    const s = i.peek(), { watchedNodeKeys: l } = a.value;
    let c, d = !1;
    o.value.read(() => {
      if (Vt()) for (const [w, m] of l.entries()) {
        if (m.size === 0) {
          l.delete(w);
          continue;
        }
        const h = Rs(w), u = h && h.isSelected() || !1;
        d = d || u !== (!!s && s.has(w)), u && (c = c || /* @__PURE__ */ new Set(), c.add(w));
      }
    }), !d && c && s && c.size === s.size || (i.value = c);
  }));
  return { watchNodeKey: function(s) {
    const l = zl(() => (i.value || Wl).has(s)), { watchedNodeKeys: c } = a.peek();
    let d = c.get(s);
    const w = d !== void 0;
    return d = d || /* @__PURE__ */ new Set(), d.add(l), w || (c.set(s, d), a.value = { watchedNodeKeys: c }), l;
  } };
...
class Ae extends tr {
  ...
  static importJSON(e) {
    return ha().updateFromJSON(e);
  }
  static importDOM() {
    return { hr: () => ({ conversion: Jl, priority: 0 }) };
  }
  exportDOM() {
...
qt({ dependencies: [dr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  const { watchNodeKey: o } = n.getDependency(oo).output, a = rn({ nodeSelections: /* @__PURE__ */ new Map() }), i = t._config.theme.hrSelected ?? "selected";
  return we(t.registerCommand(vs, (s) => {
    if (xs(s.target)) {
      const l = ys(s.target);
      if (Zl(l)) return function(c, d = !1) {
        const w = Vt(), m = c.isSelected(), h = c.getKey();
        let u;
        d && Po(w) ? u = w : (u = Ns(), ks(u)), m ? u.delete(h) : u.add(h);
      }(l, s.shiftKey), !0;
    }
    return !1;
  }, $o), t.registerMutationListener(Ae, (s, l) => {
    jl(() => {
      let c = !1;
      const { nodeSelections: d } = a.peek();
      for (const [w, m] of s.entries()) if (m === "destroyed") d.delete(w), c = !0;
      else {
        const h = d.get(w), u = t.getElementByKey(w);
        h ? h.domNode.value = u : (c = !0, d.set(w, { domNode: rn(u), selectedSignal: o(w) }));
      }
      c && (a.value = { nodeSelections: d });
    });
  }), pe(() => {
    const s = [];
    for (const { domNode: l, selectedSignal: c } of a.value.nodeSelections.values()) s.push(pe(() => {
      const d = l.value;
      d && (c.value ? Lo(d, i) : Ss(d, i));
    }));
    return we(...s);
  }));
} });
...
function Ql(t, e, n = ga) {
  return we(t.registerCommand(Ds, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const i = function(s) {
      if (s.getNodes().filter((h) => vn(h) && h.canIndent()).length > 0) return !0;
      const l = s.anchor, c = s.focus, d = c.isBefore(l) ? c : l, w = d.getNode(), m = $l(w);
      if (m.canIndent()) {
        const h = m.getKey();
        let u = Ms();
        if (u.anchor.set(h, 0, "element"), u.focus.set(h, 0, "element"), u = Is(u), u.anchor.is(d)) return !0;
      }
      return !1;
    }(a) ? o.shiftKey ? Os : qr : As;
    return t.dispatchCommand(i, void 0);
  }, Oo), t.registerCommand(qr, () => {
...
qt({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ga, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: i } = n.getOutput();
  return pe(() => {
    if (!o.value) return Ql(t, a, i);
  });
} });
const tc = qt({ name: "@lexical/react/ReactProvider" });
function ec() {
          ...
          if (c) {
            ...
            t.update(() => {
              ...
              if (ke(g)) {
                ...
                if (xn(v) && d >= 0 && w >= 0 && (y = d, N = d + w, g.setTextNodeRange(v, y, v, N)), y === N && m === "" || (g.insertRawText(m), v = x.getNode()), xn(v)) {
                  y = h, N = h + u;
...
qt({ build: (t, e, n) => Mn(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : va(t)) });
function oc(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Sr = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function ac({ editor: t, ErrorBoundary: e }) {
  return function(n, o) {
    const [a, i] = S(() => n.getDecorators());
    return Sr(() => n.registerDecoratorListener((s) => {
      qs(() => {
        i(s);
      });
    }), [n]), Y(() => {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = l[c], w = r(o, { onError: (h) => n._onError(h), children: r(gi, { fallback: null, children: a[d] }) }), m = n.getElementByKey(d);
        m !== null && s.push(Hs(w, m, d));
      }
      return s;
    }, [o, a, n]);
  }(t, e);
...
function ic({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(tc.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && oc(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(ac, { editor: t, ErrorBoundary: e });
}
function ao(t) {
  return t.getEditorState().read(ba(t.isComposing()));
}
function sc({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => we(Us(a), va(a)), [a]);
  }(o), p(lt, { children: [t, r(lc, { content: e }), r(ic, { editor: o, ErrorBoundary: n })] });
}
...
function cc({ defaultSelection: t }) {
  const [e] = Xt();
  return Y(() => {
    e.focus(() => {
...
const dc = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function wc({ onClear: t }) {
  const [e] = Xt();
  return dc(() => da(e, t), [e, t]), null;
}
const xa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function pc({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: c, ariaLabelledBy: d, ariaMultiline: w, ariaOwns: m, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...j }, z) {
  const [A, M] = S(t.isEditable()), E = K((V) => {
    V && V.ownerDocument && V.ownerDocument.defaultView ? t.setRootElement(V) : t.setRootElement(null);
  }, [t]), R = B(() => /* @__PURE__ */ function(...V) {
    return ($) => {
      for (const O of V) typeof O == "function" ? O($) : O != null && (O.current = $);
    };
  }(z, E), [E, z]);
  return xa(() => (M(t.isEditable()), t.registerEditableListener((V) => {
    M(V);
  })), [t]), r("div", { "aria-activedescendant": A ? e : void 0, "aria-autocomplete": A ? n : "none", "aria-controls": A ? o : void 0, "aria-describedby": a, ...i != null ? { "aria-errormessage": i } : {}, "aria-expanded": A && v === "combobox" ? !!s : void 0, ...l != null ? { "aria-invalid": l } : {}, "aria-label": c, "aria-labelledby": d, "aria-multiline": w, "aria-owns": A ? m : void 0, "aria-readonly": !A || void 0, "aria-required": h, autoCapitalize: u, className: g, contentEditable: A, "data-testid": C, id: x, ref: R, role: v, spellCheck: y, style: N, tabIndex: k, ...j });
}
const uc = sn(pc);
function io(t) {
  return t.getEditorState().read(ba(t.isComposing()));
...
function fc(t, e) {
  ...
  return p(lt, { children: [r(uc, { editor: a, ...o, ref: e }), n != null && r(hc, { editor: a, content: n })] });
}
function hc({ content: t, editor: e }) {
  const n = function(s) {
    ...
    return xa(() => {
      ...
      return d(), we(s.registerUpdateListener(() => {
        d();
...
function bc({
  ...
  return /* @__PURE__ */ r(ya.Provider, { value: s, children: i });
}
function Na() {
  const t = gr(ya);
  if (!t)
...
function vc() {
  const [t, e] = S(void 0), n = K(() => {
    ...
    return /* @__PURE__ */ r(sl, { open: !0, onOpenChange: n, children: /* @__PURE__ */ p(Yo, { children: [
      /* @__PURE__ */ r(Xo, { children: /* @__PURE__ */ r(Wo, { children: i }) }),
      s
    ] }) });
  }, [t, n]), a = K(
    (i, s, l = !1) => {
...
function xc({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, i] = S("paragraph"), [s, l] = vc(), c = () => {
  };
...
), Nc = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Fo.Root,
  {
    ref: a,
    className: f(ka({ variant: e, size: n, className: t })),
    ...o
  }
));
Nc.displayName = Fo.Root.displayName;
const _a = b.createContext({
  size: "default",
  variant: "default"
}), Dr = b.forwardRef(({ className: t, variant: e, size: n, children: o, ...a }, i) => {
  const s = mt();
  return /* @__PURE__ */ r(
    Sn.Root,
    {
...
Dr.displayName = Sn.Root.displayName;
const en = b.forwardRef(({ className: t, children: e, variant: n, size: o, ...a }, i) => {
  const s = b.useContext(_a);
  return /* @__PURE__ */ r(
    Sn.Item,
    {
      ref: i,
...
en.displayName = Sn.Item.displayName;
const so = [
  { format: "bold", icon: xi, label: "Bold" },
  { format: "italic", icon: yi, label: "Italic" }
...
function kc() {
  const { activeEditor: t } = Na(), [e, n] = S([]), o = K((a) => {
    if (ke(a) || Ys(a)) {
      const i = [];
      so.forEach(({ format: s }) => {
...
function _c({ onClear: t }) {
  const [e] = Xt();
  Y(() => {
    t && t(() => {
      e.dispatchCommand(Io, void 0);
    });
  }, [e, t]);
}
function Cc({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(xc, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(kc, {}) }) }),
      ...
      /* @__PURE__ */ r(
        sc,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (i) => {
            i !== void 0 && o(i);
          }, children: /* @__PURE__ */ r(gc, { placeholder: t }) }),
          ErrorBoundary: Sl
        }
      ),
      e && /* @__PURE__ */ r(cc, { defaultSelection: "rootEnd" }),
      /* @__PURE__ */ r(_c, { onClear: n }),
      /* @__PURE__ */ r(wc, {})
    ] })
  ] });
}
        ...
        children: /* @__PURE__ */ r(
          kl,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(Cc, { placeholder: a, autoFocus: i, onClear: s }),
              /* @__PURE__ */ r(
                Cl,
                {
...
function Tc(t, e) {
  const n = js(e) ? e.body.childNodes : e.childNodes;
  let o = [];
  const a = [];
  for (const i of n) if (!Ea.has(i.nodeName)) {
    const s = Ta(i, t, a, !1);
    s !== null && (o = o.concat(s));
  }
  return function(i) {
...
function Ca(t, e, n, o = null) {
  ...
  const i = le(e) && e.excludeFromCopy("html");
  let s = e;
  o !== null && xn(e) && (s = Ol(o, e, "clone"));
  const l = le(s) ? s.getChildren() : [], c = Ls(t, s.getType());
  let d;
  d = c && c.exportDOM !== void 0 ? c.exportDOM(t, s) : s.exportDOM(t);
  const { element: w, after: m } = d;
  if (!w) return !1;
  const h = document.createDocumentFragment();
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Ca(t, g, h, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !i) {
    if ((Vs(w) || Hr(w)) && w.append(h), n.append(w), m) {
      const u = m.call(s, w);
      u && (Hr(w) ? w.replaceChildren(u) : w.replaceWith(u));
    }
  } else n.append(h);
  return a;
}
const Ea = /* @__PURE__ */ new Set(["STYLE", "SCRIPT"]);
function Ta(t, e, n, o, a = /* @__PURE__ */ new Map(), i) {
  let s = [];
  ...
  let h = [];
  const u = (l == null || !zs(l)) && (l != null && vn(l) || o);
  for (let g = 0; g < m.length; g++) h.push(...Ta(m[g], e, n, u, new Map(a), l));
  return w != null && (h = w(h)), Yr(t) && (h = Sc(t, h, u ? () => {
    const g = new jo();
    return n.push(g), g;
  } : Rn)), l == null ? h.length > 0 ? s = s.concat(h) : Yr(t) && function(g) {
    return g.nextSibling == null || g.previousSibling == null ? !1 : Xr(g.nextSibling) && Xr(g.previousSibling);
  }(t) && (s = s.concat(zo())) : le(l) && l.append(...h), s;
}
function Sc(t, e, n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    else if (i.push(l), s === e.length - 1 || s < e.length - 1 && vn(e[s + 1])) {
      const c = n();
...
function Sa(t) {
  return t ? t.some(
    (e) => e && "text" in e && e.text.trim().length > 0 ? !0 : !e || !("children" in e) ? !1 : Sa(e.children)
  ) : !1;
}
function Lt(t) {
  var e;
  return (e = t == null ? void 0 : t.root) != null && e.children ? Sa(t.root.children) : !1;
}
function Dc(t) {
  if (!t || t.trim() === "")
  ...
  if (e.update(
    () => {
      const a = new DOMParser().parseFromString(t, "text/html"), i = Tc(e, a);
      de().clear(), Fs(i);
    },
    {
      discrete: !0
...
function Ep({
  ...
  const [a, i] = S(Mc), [s, l] = S(void 0), [c, d] = S(!1), w = H(void 0), m = H(null);
  Y(() => {
    let y = !0;
    const N = m.current;
    if (!N) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
      ...
      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
        F,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r("span", { children: qn(s !== void 0 ? s : "", o) })
          ]
        }
      ) }),
      /* @__PURE__ */ r(
        Yt,
        {
          ...
          children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: t.map((y) => /* @__PURE__ */ r(
            Ht,
            {
              onSelect: () => {
                l(y === "" ? void 0 : y), d(!1);
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (y) => {
          y.key === "Escape" ? (y.preventDefault(), y.stopPropagation(), n()) : Ir(y) && (y.preventDefault(), y.stopPropagation(), Lt(a) && h());
        },
        onKeyDown: (y) => {
          Mr(y), (y.key === "Enter" || y.key === " ") && y.stopPropagation();
        },
        children: /* @__PURE__ */ r(
          Nn,
          {
...
const Tp = Object.freeze([
...
], Ic = ["input", "select", "textarea", "button"], Oc = ["button", "textbox"], Ac = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: o
}) => {
  const a = H(null), [i, s] = S(void 0), [l, c] = S(void 0), d = K(
    (u) => {
      s(u);
    ...
    if (x && Oc.includes(x)) return !0;
    const v = u.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, h = K(
    (u) => {
      var A;
      const g = u.target, x = (M) => M ? document.getElementById(M) : void 0, v = x(l), y = x(i);
      if (!!(v && g && v.contains(g) && g !== v) && m(g)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const E = M.findIndex((V) => V === g);
          if (E === -1) return;
          let R;
          u.key === "ArrowDown" ? R = Math.min(E + 1, M.length - 1) : R = Math.max(E - 1, 0), R !== E && (u.preventDefault(), u.stopPropagation(), (A = M[R]) == null || A.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          j = Math.min(C + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(C - 1, 0), u.preventDefault();
          break;
        case "Home":
  ...
  ({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r("div", { ref: o, className: f("pr-twp", Pc({ variant: e }), t), ...n })
);
...
const Vc = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: f("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
Vc.displayName = "CardDescription";
...
$e.displayName = Ko.Root.displayName;
...
Ia.displayName = Be.Root.displayName;
...
zc.displayName = Be.Image.displayName;
...
Oa.displayName = Be.Fallback.displayName;
const Or = En(void 0);
function Ft() {
  const t = gr(Or);
  if (!t)
...
}), Ce = nt.Trigger, Aa = nt.Group, Fc = nt.Portal, Bc = nt.Sub, Kc = nt.RadioGroup;
...
const Pa = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Ft();
  return /* @__PURE__ */ p(
    nt.SubTrigger,
    {
...
Pa.displayName = nt.SubTrigger.displayName;
const $a = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
  return /* @__PURE__ */ r(
    nt.SubContent,
    {
...
$a.displayName = nt.SubContent.displayName;
...
const La = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  ...
  return /* @__PURE__ */ p(
    nt.RadioItem,
    {
      ...
      dir: a,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center ltr:tw-left-2 rtl:tw-right-2", children: /* @__PURE__ */ r(nt.ItemIndicator, { children: /* @__PURE__ */ r(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
La.displayName = nt.RadioItem.displayName;
...
dn.displayName = nt.Label.displayName;
...
Ue.displayName = nt.Separator.displayName;
...
function lo({
  ...
  const u = K(
    (C) => {
      C && C.stopPropagation(), d(!1), m(void 0), s == null || s(!1);
    },
    [s]
  ), g = K(
    async (C) => {
      if (C && C.stopPropagation(), !w || !a) return;
      await a(
        t.id,
        kn(w)
      ) && (d(!1), m(void 0), s == null || s(!1));
    },
    [w, a, t.id, s]
  ), x = B(() => {
    const C = new Date(t.date), j = ns(
      C,
      n["%comment_date_today%"],
      n["%comment_date_yesterday%"]
    ), z = C.toLocaleTimeString(void 0, {
      hour: "numeric",
      minute: "2-digit"
    });
    ...
    [t.user]
  ), N = B(() => rs(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          _n,
          {
            onClick: (C) => {
              C.stopPropagation(), d(!0), m(Dc(t.contents)), s == null || s(!0);
            },
            children: [
        ...
        /* @__PURE__ */ p(
          _n,
          {
            ...
            children: [
              /* @__PURE__ */ r(ki, { className: "tw-me-2 tw-h-4 tw-w-4" }),
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ia, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Oa, { className: "tw-text-xs tw-font-medium", children: y }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          c && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Ir(C) && (C.preventDefault(), C.stopPropagation(), Lt(w) && g());
              },
              onKeyDown: (C) => {
                Mr(C), (C.key === "Enter" || C.key === " ") && C.stopPropagation();
              },
              onClick: (C) => {
                C.stopPropagation();
              },
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(_i, {}) }) }),
...
function Uc({
  ...
  const [A, M] = S(co), [E, R] = S(
    void 0
  ), V = o, [$, O] = S(!1), [P, W] = S(!1), [I, J] = S(!1), [St, Pt] = S(!1), [It, gt] = S(!1), [pt, G] = S(C), [at, it] = S(!1), ct = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
  ...
  const Jt = B(() => Bt[0], [Bt]), Re = H(null), ie = H(void 0), Zt = K(() => {
    var T;
    (T = ie.current) == null || T.call(ie), M(co);
  }, []), He = K(() => {
    const T = !pt;
  ...
  }, [i, n]), L = B(() => Bt.slice(1), [Bt]), U = B(() => L.length ?? 0, [L.length]), q = B(() => U > 0, [U]), st = B(() => $ || U <= 2 ? L : L.slice(-2), [L, U, $]), tt = B(() => $ || U <= 2 ? 0 : U - 2, [U, $]), bt = B(
    () => U === 1 ? D.singleReply : ve(D.multipleReplies, { count: U }),
    [U, D]
  ), dt = B(
  ...
  const Dt = K(
    async (T) => {
      ...
      vt && await m({ threadId: c, contents: vt }) && Zt();
    },
    [
      Zt,
      A,
    ...
    async (T) => {
      const vt = Lt(A) ? kn(A) : void 0, ft = await m({
        ...T,
        contents: vt,
        assignedUser: E ?? T.assignedUser
      });
      return ft && vt && Zt(), ft && E !== void 0 && R(void 0), ft;
    },
    [Zt, A, m, E]
  );
  return /* @__PURE__ */ r(
    Da,
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ p(Ma, { className: "tw-flex tw-flex-col tw-gap-2 tw-p-0", children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-content-center tw-items-start tw-gap-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                children: pt ? /* @__PURE__ */ r(Ci, {}) : /* @__PURE__ */ r(Ei, {})
              }
            ),
          ...
          /* @__PURE__ */ r(
            lo,
            {
              ...
              handleDeleteComment: u,
              onEditingChange: W,
              canEditOrDelete: (!P && xt.get(Jt.id)) ?? !1,
          ...
          o && /* @__PURE__ */ p(lt, { children: [
            ...
            v !== !1 && (!P || Lt(A)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Ir(T) && (T.preventDefault(), T.stopPropagation(), (Lt(A) || E !== void 0) && Dt());
                },
                onKeyDown: (T) => {
                  Mr(T), (T.key === "Enter" || T.key === " ") && T.stopPropagation();
                },
                children: [
                  /* @__PURE__ */ r(
                    Nn,
                  ...
                  /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-row tw-items-center tw-justify-end tw-gap-2", children: [
                    ...
                    /* @__PURE__ */ p(oe, { open: I, onOpenChange: J, children: [
                      /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ r(
                        F,
                        {
                          size: "icon",
                        ...
                        Yt,
                        {
                          ...
                          children: /* @__PURE__ */ r(ne, { children: /* @__PURE__ */ r(re, { children: x == null ? void 0 : x.map((T) => /* @__PURE__ */ r(
                            Ht,
                            {
                              ...
                              className: "tw-flex tw-items-center",
                              children: /* @__PURE__ */ r("span", { children: bn(T, n) })
                            },
                            T || "unassigned"
                          )) }) })
                        }
...
function Sp({
  ...
  const [y, N] = S(/* @__PURE__ */ new Set()), [k, C] = S();
  Y(() => {
    g && (N((O) => new Set(O).add(g)), C(g));
  }, [g]);
  const j = n.filter(
    (O) => O.comments.some((P) => !P.deleted)
  ), z = j.map((O) => ({
    id: O.id
  })), A = K(
    (O) => {
      N((P) => new Set(P).add(O.id)), C(O.id), x == null || x(O.id);
    },
    [x]
  ), M = K(
    (O) => {
      ...
      }), C(O), x == null || x(P ? void 0 : O);
    },
    [y, x]
  ), { listboxRef: E, activeId: R, handleKeyDown: V } = Ac({
    options: z,
    onOptionSelect: A
  }), $ = K(
    (O) => {
      O.key === "Escape" ? (k && y.has(k) && (N((P) => {
        const W = new Set(P);
        return W.delete(k), W;
      }), C(void 0), x == null || x(void 0)), O.preventDefault(), O.stopPropagation()) : V(O);
    },
    [k, y, V, x]
  );
  return /* @__PURE__ */ r(
...
function qc({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Xs, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Ti, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = wt.Root, Hc = wt.Group, Ve = wt.Value, Yc = me(
  ...
  return /* @__PURE__ */ p(
    wt.Trigger,
    {
      className: f(Yc({ size: n, className: t })),
      ref: a,
      ...o,
      dir: i,
      children: [
        e,
        /* @__PURE__ */ r(wt.Icon, { asChild: !0, children: /* @__PURE__ */ r(ze, { className: "tw-h-4 tw-w-4 tw-opacity-50" }) })
      ]
    }
  );
});
Ee.displayName = wt.Trigger.displayName;
...
Va.displayName = wt.ScrollUpButton.displayName;
...
ja.displayName = wt.ScrollDownButton.displayName;
...
Te.displayName = wt.Content.displayName;
...
Xc.displayName = wt.Label.displayName;
...
Wc.displayName = wt.Separator.displayName;
function Jc({ table: t }) {
...
function on(t, e) {
  ...
  return Array.from(t.querySelectorAll(n)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Zc(o)
  );
}
  ...
  b.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        on(s, '[tabindex]:not([tabindex="-1"])').forEach((w) => {
...
const An = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("tbody", { ref: n, className: f("[&_tr:last-child]:tw-border-0", t), ...e }));
    ...
    const n = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const a = t.current ? on(t.current) : [], i = a.indexOf(document.activeElement), s = o.key === "ArrowRight" ? i + 1 : i - 1;
...
const Qt = b.forwardRef(({ className: t, onKeyDown: e, onSelect: n, setFocusAlsoRunsSelect: o = !1, ...a }, i) => {
  const s = b.useRef(null);
  b.useEffect(() => {
    typeof i == "function" ? i(s.current) : i && "current" in i && (i.current = s.current);
  }, [i]), td(s);
  const l = b.useMemo(
    () => s.current ? on(s.current) : [],
    [s]
  ), c = b.useCallback(
    (w) => {
      const { current: m } = s;
      ...
      if (w.key === "ArrowDown" || w.key === "ArrowUp")
        w.preventDefault(), nd(u, g, w.key);
      else if (w.key === "ArrowLeft" || w.key === "ArrowRight")
        w.preventDefault(), ed(l, x, w.key);
...
const an = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  "th",
  {
    ref: n,
    className: f(
...
function od({
  ...
  var z;
  const [w, m] = S([]), [h, u] = S([]), [g, x] = S({}), [v, y] = S({}), N = B(() => e ?? [], [e]), k = Go({
    data: N,
    columns: t,
    getCoreRowModel: qo(),
    ...n && { getPaginationRowModel: Js() },
    onSortingChange: m,
  ...
  let j;
  return c ? j = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((z = k.getRowModel().rows) == null ? void 0 : z.length) > 0 ? j = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => s(A, k),
      "data-state": A.getIsSelected() && "selected",
      children: A.getVisibleCells().map((M) => /* @__PURE__ */ r(Ne, { children: Ze(M.column.columnDef.cell, M.getContext()) }, M.id))
    },
    A.id
  )) : j = /* @__PURE__ */ r(Qt, { children: /* @__PURE__ */ r(Ne, { colSpan: t.length, className: "tw-h-24 tw-text-center", children: d }) }), /* @__PURE__ */ p("div", { className: "pr-twp", id: l, children: [
    a && /* @__PURE__ */ r(qc, { table: k }),
    /* @__PURE__ */ p(In, { stickyHeader: i, children: [
      /* @__PURE__ */ r(On, { stickyHeader: i, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Qt, { children: A.headers.map((M) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Ze(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
...
function Dp({
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r(tl, { options: i, children: e })
    }
  );
}
...
function id({
  ...
  const a = po(n, "%webView_error_dump_header%"), i = po(n, "%webView_error_dump_info_message%");
  function s() {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(F, { variant: "secondary", size: "icon", className: "size-8", onClick: () => s(), children: /* @__PURE__ */ r(No, {}) })
        ] }),
...
function Ip({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (w) => {
    w || l(!1);
  }, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: o }),
    /* @__PURE__ */ p(Yt, { id: i, className: f("tw-min-w-80 tw-max-w-96", a), children: [
...
var sd = /* @__PURE__ */ ((t) => (t[t.Check = 0] = "Check", t[t.Radio = 1] = "Radio", t))(sd || {});
function Op({ id: t, label: e, groups: n }) {
  const [o, a] = S(
    ...
    s((h) => (h[d] = w, { ...h }));
    const m = n[d].items.find((h) => h.id === w);
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ p(F, { variant: "default", children: [
      /* @__PURE__ */ r(Ii, { size: 16, className: "tw-mr-2 tw-h-4 tw-w-4" }),
      e,
      /* @__PURE__ */ r(ze, { size: 16, className: "tw-ml-2 tw-h-4 tw-w-4" })
    ] }) }),
    /* @__PURE__ */ r(ee, { children: n.map((d, w) => /* @__PURE__ */ p("div", { children: [
      /* @__PURE__ */ r(dn, { children: d.label }),
      /* @__PURE__ */ r(Aa, { children: d.itemType === 0 ? /* @__PURE__ */ r(lt, { children: d.items.map((m, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[w][h],
        ...
        {
          value: i[w],
          onValueChange: (m) => c(w, m),
          children: d.items.map((m) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(La, { value: m.id, children: m.label }) }, m.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, d.label)) })
...
function Ap({
  ...
  }).format(Object.values(n).reduce((w, m) => w + m, 0)), d = () => {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-items-center tw-gap-1 tw-ps-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-1", children: [
            /* @__PURE__ */ r(Oi, { className: "tw-h-4 tw-w-4" }),
        ...
        (a || s) && /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-1 tw-ps-4", children: [
          a && /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ p(
            F,
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ r(Ai, { className: "tw-h-4 tw-w-4" })
              ]
            }
          ) }),
          s && /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-1", children: /* @__PURE__ */ p(
            F,
            {
              ...
              children: [
                "Support",
                /* @__PURE__ */ r(Pi, { className: "tw-h-4 tw-w-4" })
              ]
            }
          ) })
        ] })
...
function ld({ id: t, versionHistory: e }) {
  ...
  function i(l) {
    const c = new Date(l), d = new Date(a.getTime() - c.getTime()), w = d.getUTCFullYear() - 1970, m = d.getUTCMonth(), h = d.getUTCDate() - 1;
    let u = "";
...
function Pp({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(ld, { versionHistory: a }),
...
function cd({
  ...
  const [y, N] = S(!1), k = K(
    (R) => {
      var $;
      const V = ($ = t.find((O) => O.label === R)) == null ? void 0 : $.value;
      V && n(
    ...
    if (!h) return t;
    const R = t.filter(($) => $.starred).sort(($, O) => $.label.localeCompare(O.label)), V = t.filter(($) => !$.starred).sort(($, O) => {
      const P = e.includes($.value), W = e.includes(O.value);
      return P && !W ? -1 : !P && W ? 1 : $.label.localeCompare(O.label);
    });
    return [...R, ...V];
  }, [t, e, h]), z = () => {
    n(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(oe, { open: M, onOpenChange: w ?? N, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: x,
        ...
        /* @__PURE__ */ r(Ut, { children: j.map((R) => /* @__PURE__ */ p(
          Ht,
          {
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r($i, { className: "tw-h-4 tw-w-4" }),
...
const ud = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function md({
  ...
  const i = H(null), s = H(null), l = H(!1), [c, d] = S(t), [w, m] = S(n), [h, u] = S(!1);
  Y(() => {
    d(t);
  }, [t]), Y(() => {
    w !== n && m(n);
  ...
  const g = (v) => {
    l.current = !1, u(v), v || (c !== "custom" || w ? (e(c), o(w)) : (d(t), m(n)));
  }, x = (v) => {
    var y, N, k, C;
    v.stopPropagation(), document.activeElement === s.current && v.key === "ArrowDown" || v.key === "ArrowRight" ? ((y = i.current) == null || y.focus(), l.current = !0) : document.activeElement === i.current && v.key === "ArrowUp" ? ((N = s.current) == null || N.focus(), l.current = !1) : document.activeElement === i.current && v.key === "ArrowLeft" && ((k = i.current) == null ? void 0 : k.selectionStart) === 0 && ((C = s.current) == null || C.focus(), l.current = !1), c === "custom" && v.key === "Enter" && (document.activeElement === s.current || document.activeElement === i.current) && g(!1);
  };
  return /* @__PURE__ */ p(ue, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: ud(t, a, n) }) }) }),
...
const fd = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Co, {}),
  " ",
...
function gd({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Bs, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: fd(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: hd(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ee, { style: { zIndex: na }, children: [
...
function mo({
  ...
  return /* @__PURE__ */ p(
    Ht,
    {
      ...
      onSelect: t.action,
      children: [
        /* @__PURE__ */ r("div", { className: "tw-w-8 tw-min-w-8", children: t.marker ? /* @__PURE__ */ r("span", { className: "tw-text-xs", children: t.marker }) : /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(vd, { icon: t.icon }) }) }),
        /* @__PURE__ */ p("div", { children: [
        ...
        (t.isDisallowed || t.isDeprecated) && /* @__PURE__ */ r(Jo, { className: "tw-font-sans", children: t.isDisallowed ? e["%markerMenu_disallowed_label%"] : e["%markerMenu_deprecated_label%"] })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ p(ne, { className: "tw-p-1", shouldFilter: !1, loop: !0, children: [
    ...
    /* @__PURE__ */ p(re, { children: [
      ...
      s.length > 0 && /* @__PURE__ */ p(lt, { children: [
        i.length > 0 && /* @__PURE__ */ r(yr, { alwaysRender: !0 }),
...
function Lp({
  ...
  At(() => {
    if (!u.current) return;
    const { width: _ } = u.current.getBoundingClientRect();
    _ > 0 && (u.current.style.width = `${_}px`);
  }, []);
  const [g, x] = S("generated"), [v, y] = S("*"), [N, k] = S("f"), [C, j] = S(!1), [z, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, O] = S(!1), [P, W] = S(), [I, J] = S(), [St, Pt] = S(), [It, gt] = S(), pt = H(null), G = B(
    () => ({
      ...s,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  Y(() => {
    ...
    if (L && pn("note", L)) {
      const st = (U = L.insert.note) == null ? void 0 : U.caller;
      let tt = "custom";
      st === er ? tt = "generated" : st === nr ? tt = "hidden" : st && y(st), x(tt), k(((q = L.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var bt;
        (bt = w.current) == null || bt.applyUpdate([L]);
      }, 0);
    }
    return () => {
      _ && clearTimeout(_);
  ...
  const it = K(
    (_, L, U = !1) => {
      var st, tt, bt;
      const q = (tt = (st = w.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (q && pn("note", q)) {
        if (q.insert.note) {
          let dt;
          _ === "custom" ? dt = L : _ === "generated" ? dt = er : dt = nr, q.insert.note.caller = dt;
        }
        n == null || n([q]), U && d && i && ((bt = d.current) == null || bt.replaceEmbedUpdate(i, [q]));
      }
    },
    [i, n, d]
  ), ct = K(() => {
  ...
  const Bt = () => {
    var L;
    const _ = (L = m.current) == null ? void 0 : L.getElementsByClassName("editor-input")[0];
    ...
    var U, q, st, tt, bt;
    k(_);
    const L = (q = (U = w.current) == null ? void 0 : U.getNoteOps(0)) == null ? void 0 : q.at(0);
    if (L && pn("note", L)) {
      L.insert.note && (L.insert.note.style = _);
      const dt = (tt = (st = L.insert.note) == null ? void 0 : st.contents) == null ? void 0 : tt.ops;
      N !== "x" && _ === "x" ? dt == null || dt.forEach((Dt) => Nd(Dt)) : N === "x" && _ !== "x" && (dt == null || dt.forEach((Dt) => kd(Dt))), (bt = w.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    (_) => {
      ...
      if (L && pn("note", L)) {
        ...
        const dt = (st = L.insert.note) == null ? void 0 : st.style, Dt = (bt = (tt = L.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : bt.ops;
        if (dt || j(!1), j(
          dt === "x" ? !!(Dt != null && Dt.every(($t) => {
            var vt, ft;
            if (!((vt = $t.attributes) != null && vt.char)) return !0;
            const T = ((ft = $t.attributes) == null ? void 0 : ft.char).style;
          ...
          R.current = !0, V.current = JSON.stringify(L), A(!0);
          return;
        }
        A(JSON.stringify(L) === V.current), it(g, v);
      } else
        j(!1), A(!0);
    },
    [g, v, it]
    ...
    if (h.current && at.length && _ && _.rangeCount > 0) {
      const L = _.getRangeAt(0).getBoundingClientRect(), U = h.current.getBoundingClientRect();
      W(L.left - U.left), J(L.top - U.top), Pt(L.height), O(!0);
    }
  }, [at, h]);
  return Y(() => {
    const _ = () => {
    ...
    var _;
    $ && ((_ = pt.current) == null || _.focus());
  }, [$]), Y(() => {
    var U;
    const _ = ((U = m.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
      !$ && _ && document.activeElement === _ && q.key === l ? (q.preventDefault(), D()) : $ && q.key === "Escape" && (q.preventDefault(), O(!1));
    };
    return document.addEventListener("keydown", L), () => {
      document.removeEventListener("keydown", L);
    };
  }, [$, D, l]), /* @__PURE__ */ p(lt, { children: [
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(pd, { editorRef: w, children: /* @__PURE__ */ r(
              nl,
              {
                options: G,
                onStateChange: Zt,
...
function Td({
  ...
  const c = o ? /* @__PURE__ */ r("span", { className: "marker", children: `\\${t.marker} ` }) : void 0, d = o ? /* @__PURE__ */ r("span", { className: "marker", children: ` \\${t.marker}*` }) : void 0, w = a && // USFM does not specify a marker for caller, so instead of a usfm_* class, we use a
  ...
  return /* @__PURE__ */ p(lt, { children: [
    /* @__PURE__ */ p("div", { className: f("textual-note-header tw-col-span-1 tw-w-fit tw-text-nowrap", x), children: [
      c,
      w
    ] }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Cd(t.marker, l, o, d) })
      }
    )
  ] });
}
function jp({
  ...
  const w = c ?? ss(n, void 0), m = (N, k) => {
    d == null || d(N, k, a);
  }, h = i ? n.findIndex((N) => N === i) : -1, [u, g] = S(h), x = (N, k, C) => {
    if (n.length)
      switch (N.key) {
        case "Enter":
        case " ":
          N.preventDefault(), d == null || d(k, C, a);
          break;
      }
  }, v = (N) => {
    if (n.length)
...
function Sd({
  ...
  return /* @__PURE__ */ p(In, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(On, { stickyHeader: !0, children: /* @__PURE__ */ p(Qt, { children: [
      ...
      /* @__PURE__ */ r(an, { children: i })
    ] }) }),
    /* @__PURE__ */ r(An, { children: s.length > 0 && s.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        onClick: () => {
          e(l.reference);
...
Pr.displayName = rr.Root.displayName;
const Dd = (t) => {
  if (t === "asc")
    return /* @__PURE__ */ r(Ki, { className: "tw-h-4 tw-w-4" });
  if (t === "desc")
    return /* @__PURE__ */ r(Gi, { className: "tw-h-4 tw-w-4" });
}, Pn = (t, e, n) => /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
  /* @__PURE__ */ p(
    Et,
    {
  ...
  accessorKey: "status",
  header: ({ column: i }) => Pn(i, t, "tw-justify-center"),
  cell: ({ row: i }) => {
    const s = i.getValue("status"), l = i.getValue("item");
    return /* @__PURE__ */ p(Dr, { value: s, variant: "outline", type: "single", className: "tw-gap-0", children: [
      /* @__PURE__ */ r(
        en,
        {
          onClick: (c) => {
  ...
  return e ? e[1] : "";
}, Id = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", qp = Object.freeze([
  ...
  const a = Gr(o.key) ? o.key : o.key[0];
  return {
    items: Gr(o.key) ? [o.key] : o.key,
    count: o.count,
    status: o.status || Id(a, e, n),
...
function Hp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), y = Kt(n, "%webView_inventory_scope_currentBook%"), N = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), j = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), z = Kt(n, "%webView_inventory_no_results%"), [A, M] = S(!1), [E, R] = S("all"), [V, $] = S(""), [O, P] = S([]), W = B(() => {
    const G = t ?? [];
    return G.length === 0 ? [] : Ad(G, a, i);
  }, [t, a, i]), I = B(() => {
    if (A) return W;
    const G = [];
    return W.forEach((at) => {
  ...
  }, [A, W]), J = B(() => I.length === 0 ? [] : Od(I, E, V), [I, E, V]), St = B(() => {
    var it, ct;
    if (!A) return c;
  ...
  return /* @__PURE__ */ r("div", { id: d, className: "pr-twp tw-h-full tw-overflow-auto", children: /* @__PURE__ */ p("div", { className: "tw-flex tw-h-full tw-w-full tw-min-w-min tw-flex-col", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-stretch", style: { contain: "inline-size" }, children: [
      ...
      /* @__PURE__ */ p(Le, { onValueChange: (G) => It(G), defaultValue: s, children: [
      ...
      o && /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
        /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ p("div", { className: "tw-m-1 tw-flex tw-w-fit tw-min-w-[26px] tw-items-center tw-rounded-md tw-border", children: [
          ...
          /* @__PURE__ */ r(ht, { className: "tw-m-1 tw-truncate", children: (o == null ? void 0 : o.checkboxText) ?? j })
        ] }) }),
        /* @__PURE__ */ r(_t, { children: (o == null ? void 0 : o.checkboxText) ?? j })
      ] }) })
    ] }),
...
const Pd = "16rem", $d = "3rem", Fa = b.createContext(void 0);
function $n() {
  const t = b.useContext(Fa);
  if (!t)
...
const Ba = b.forwardRef(
  ({
    ...
    const [d, w] = b.useState(t), m = e ?? d, h = b.useCallback(
      (k) => {
        const C = typeof k == "function" ? k(m) : k;
        n ? n(C) : w(C);
      },
      [n, m]
    ), u = b.useCallback(() => h((k) => !k), [h]), g = m ? "expanded" : "collapsed", y = mt() === "ltr" ? s : s === "primary" ? "secondary" : "primary", N = b.useMemo(
      () => ({
        state: g,
        open: m,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Fa.Provider, { value: N, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
...
const Ka = b.forwardRef(({ variant: t = "sidebar", collapsible: e = "offcanvas", className: n, children: o, ...a }, i) => {
  const s = $n();
...
const Ld = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    F,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(Ui, {}) : /* @__PURE__ */ r(qi, {}),
...
const Kd = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: o,
...
const Gd = me(
  ...
  ({
    ...
    const c = t ? Fe : "button", { state: d } = $n(), w = /* @__PURE__ */ r(
      c,
      {
        ref: l,
        ...
        "data-size": o,
        "data-active": e,
        className: f(Gd({ variant: n, size: o }), i),
        ...s
      }
    );
    return a ? (typeof a == "string" && (a = {
      ...
      /* @__PURE__ */ r(Et, { asChild: !0, children: w }),
      /* @__PURE__ */ r(_t, { side: "right", align: "center", hidden: d !== "collapsed", ...a })
    ] })) : w;
  }
);
Ya.displayName = "SidebarMenuButton";
const Ud = b.forwardRef(({ className: t, asChild: e = !1, showOnHover: n = !1, ...o }, a) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: a,
...
qd.displayName = "SidebarMenuBadge";
const Hd = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
Hd.displayName = "SidebarMenuSkeleton";
...
Yd.displayName = "SidebarMenuSub";
const Xd = b.forwardRef(
  ({ ...t }, e) => /* @__PURE__ */ r("li", { ref: e, ...t })
);
Xd.displayName = "SidebarMenuSubItem";
const Wd = b.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, i) => /* @__PURE__ */ r(
  t ? Fe : "a",
  {
    ref: i,
...
function Jd({
  ...
  return /* @__PURE__ */ r(
    Ka,
    {
      ...
      children: /* @__PURE__ */ p(Ua, { children: [
        /* @__PURE__ */ p(ur, { children: [
          /* @__PURE__ */ r(mr, { className: "tw-text-sm", children: i }),
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(qa, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ha, { children: /* @__PURE__ */ r(
            Ya,
            {
              onClick: () => d(h),
              isActive: m(h),
...
const se = "scrBook", Zd = "scrRef", be = "source", Qd = "details", tw = "Scripture Reference", ew = "Scripture Book", Xa = "Type", nw = "Details";
function rw(t, e) {
  const n = e ?? !1;
  return [
    {
      ...
      id: se,
      header: (t == null ? void 0 : t.scriptureReferenceColumnName) ?? tw,
      cell: (o) => {
        const a = o.row.original;
        return o.row.getIsGrouped() ? ut.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === se ? xe(a.start) : void 0;
      },
    ...
    },
    {
      ...
      id: be,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Xa : void 0,
...
const ow = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || Qn(t.start, t.end) === 0 ? `${Ln(t.start)}+${e}` : `${Ln(t.start)}+${e}-${Ln(t.end)}+${n}`;
}, fo = (t) => `${ow({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Xp({
  sources: t,
  ...
  const [d, w] = S([]), [m, h] = S([{ id: se, desc: !1 }]), [u, g] = S({}), x = B(
    () => t.flatMap((E) => E.data.map((R) => ({
      ...R,
      source: E.source
    }))),
    [t]
  ...
  Y(() => {
    if (l) {
      ...
      if (R.length === 1) {
        const V = x.find(($) => fo($) === R[0]) || void 0;
        V && l(V);
      }
    }
  }, [u, x, l, y]);
  const N = a ?? ew, k = i ?? Xa, C = [
  ...
  }, A = (E, R) => E.getIsGrouped() ? "" : f("banded-row", R % 2 === 0 ? "even" : "odd"), M = (E, R, V) => {
    if (!((E == null ? void 0 : E.length) === 0 || R.depth < V.column.getGroupedIndex())) {
      if (R.getIsGrouped())
        switch (R.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(Hc, { children: C.map((E) => /* @__PURE__ */ r(Ot, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(In, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(On, { children: y.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
        /* For sticky column headers to work, we probably need to change the default definition of the shadcn Table component. See https://github.com/shadcn-ui/ui/issues/1151 */
        /* @__PURE__ */ r(an, { colSpan: R.colSpan, className: "top-0 tw-sticky", children: R.isPlaceholder ? void 0 : /* @__PURE__ */ p("div", { children: [
          ...
          " ",
          Ze(R.column.columnDef.header, R.getContext())
        ] }) }, R.id)
      )) }, E.id)) }),
      /* @__PURE__ */ r(An, { children: y.getRowModel().rows.map((E, R) => {
        const V = mt();
        return /* @__PURE__ */ r(
          Qt,
          {
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ p(
                      F,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Ie, {}) : /* @__PURE__ */ r(Jn, {})),
                          " ",
...
const Lr = (t, e) => t.filter((n) => {
  try {
    return Je(n) === e;
  } catch {
    return !1;
  }
}), Wa = (t, e, n) => Lr(t, e).every((o) => n.includes(o));
function aw({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const i = Lr(e, t).length === 0, s = a["%scripture_section_ot_short%"], l = a["%scripture_section_nt_short%"], c = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    F,
    {
      variant: "outline",
      ...
      onClick: () => o(t),
      className: f(
        Wa(e, t, n) && !i && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: i,
      children: wl(
        t,
...
function iw({
  ...
  const i = o["%webView_book_selector_books_selected%"], s = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], c = o["%webView_book_selector_select_all%"], d = o["%webView_book_selector_clear_all%"], w = o["%webView_book_selector_no_book_found%"], m = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
    otLong: o == null ? void 0 : o["%scripture_section_ot_long%"],
    ntLong: o == null ? void 0 : o["%scripture_section_nt_long%"],
    dcLong: o == null ? void 0 : o["%scripture_section_dc_long%"],
    extraLong: o == null ? void 0 : o["%scripture_section_extra_long%"]
  }, [v, y] = S(!1), [N, k] = S(""), C = H(void 0), j = H(!1);
  if (t.length !== ut.allBookIds.length)
    throw new Error("availableBookInfo length must match Canon.allBookIds length");
  const z = B(() => ut.allBookIds.filter(
    ...
    (P, W = !1) => {
      ...
      const I = z.findIndex((gt) => gt === C.current), J = z.findIndex((gt) => gt === P);
      if (I === -1 || J === -1) return;
      const [St, Pt] = [
        Math.min(I, J),
        Math.max(I, J)
      ], It = z.slice(St, Pt + 1).map((gt) => gt);
      n(
    ...
    M(P, j.current), j.current = !1;
  }, R = (P, W) => {
    P.preventDefault(), M(W, P.shiftKey);
  }, V = K(
    (P) => {
      const W = Lr(z, P).map((I) => I);
      n(
        Wa(z, P, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, z]
  ), $ = () => {
  ...
  return /* @__PURE__ */ p("div", { className: "tw-space-y-2", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            ne,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
                P.key === "Enter" && (j.current = P.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ke,
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: $, children: c }),
                  /* @__PURE__ */ r(F, { variant: "ghost", size: "sm", onClick: O, children: d })
                ] }),
                /* @__PURE__ */ p(re, { children: [
                  /* @__PURE__ */ r(cn, { children: w }),
                  Object.values(X).map((P, W) => {
                    ...
                    if (I.length !== 0)
                      return /* @__PURE__ */ p(go, { children: [
                        ...
                        W < Object.values(X).length - 1 && /* @__PURE__ */ r(yr, {})
                      ] }, P);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ p("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Yn ? Yn : ho
      ).map((P) => /* @__PURE__ */ r(Pe, { className: "hover:tw-bg-secondary", variant: "secondary", children: Me(P, a) }, P)),
      e.length > Yn && /* @__PURE__ */ r(
        Pe,
        {
          className: "hover:tw-bg-secondary",
          variant: "secondary",
          children: `+${e.length - ho} ${m}`
        }
      )
    ] })
  ] });
...
function Jp({
  ...
  const d = he(
    ...
    s,
    "%webView_scope_selector_current_chapter%"
  ), h = he(s, "%webView_scope_selector_current_book%"), u = he(s, "%webView_scope_selector_choose_books%"), g = he(s, "%webView_scope_selector_scope%"), x = he(s, "%webView_scope_selector_select_books%"), v = [
    ...
    /* @__PURE__ */ p("div", { className: "tw-grid tw-gap-2", children: [
      ...
      /* @__PURE__ */ r(
        _r,
        {
          ...
          children: y.map(({ value: N, label: k, id: C }) => /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(yn, { className: "tw-me-2", value: N, id: C }),
...
function Zp({
  ...
  return /* @__PURE__ */ p(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ee, { size: a, className: f("pr-twp tw-w-auto", i), children: /* @__PURE__ */ r(
          Ve,
          {
            placeholder: l[Q(e)] ?? e
          }
...
const Za = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  ) : /* @__PURE__ */ p(Bc, { children: [
    /* @__PURE__ */ r(Pa, { children: l.label }),
    /* @__PURE__ */ r(Fc, { children: /* @__PURE__ */ r($a, { children: Za(
      t,
      e,
      Ja(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: i, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Yi, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, c]) => typeof c == "object").sort(([, c], [, d]) => typeof c == "boolean" || typeof d == "boolean" ? 0 : c.order - d.order).map(([c], d, w) => /* @__PURE__ */ p(go, { children: [
      /* @__PURE__ */ r(Aa, { children: /* @__PURE__ */ r(kt, { children: Za(e.groups, e.items, c, t) }) }),
      d < w.length - 1 && /* @__PURE__ */ r(Ue, {})
    ] }, c)) })
  ] });
}
const Qa = b.forwardRef(
...
function nu({
  ...
  return /* @__PURE__ */ p(Qa, { className: `tw-w-full tw-border ${i}`, id: a, children: [
    n && /* @__PURE__ */ r(
      hr,
      {
        onSelectMenuItem: t,
...
function ru({
  ...
  return /* @__PURE__ */ r(Qa, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    hr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
const ti = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.Root,
    {
...
ti.displayName = Rt.List.displayName;
const ei = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.List,
  {
    ref: n,
    className: f(
...
ei.displayName = Rt.List.displayName;
...
)), ni = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Content,
  {
    ref: n,
    className: f(
...
ni.displayName = Rt.Content.displayName;
function ou({
  tabList: t,
  searchValue: e,
  onSearch: n,
  ...
  return /* @__PURE__ */ p("div", { id: s, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(ti, { children: [
      /* @__PURE__ */ r(ei, { children: t.map((l) => /* @__PURE__ */ r(sw, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(ni, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function lw({ ...t }) {
...
const ri = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
ri.displayName = rt.Root.displayName;
const oi = b.forwardRef(({ className: t, ...e }, n) => {
  const o = Ft();
  return /* @__PURE__ */ r(
    rt.Trigger,
    {
...
oi.displayName = rt.Trigger.displayName;
const ai = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const i = Ft();
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
      ...
      className: f(
        ...
        e && "tw-pl-8",
        ae({ variant: i.variant, className: t }),
        // CUSTOM use context to add variants
        t
      ),
      ...o,
...
ai.displayName = rt.SubTrigger.displayName;
...
ii.displayName = rt.SubContent.displayName;
const si = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, i) => {
  const s = Ft();
...
si.displayName = rt.Content.displayName;
const li = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
li.displayName = rt.Item.displayName;
...
dw.displayName = rt.CheckboxItem.displayName;
const ww = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
      ...
      ...n,
      children: [
        /* @__PURE__ */ r("span", { className: "tw-absolute tw-left-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(rt.ItemIndicator, { children: /* @__PURE__ */ r(Tn, { className: "tw-h-2 tw-w-2 tw-fill-current" }) }) }),
        e
      ]
    }
  );
});
ww.displayName = rt.RadioItem.displayName;
const pw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  rt.Label,
  {
    ref: o,
    className: f("tw-px-2 tw-py-1.5 tw-text-sm tw-font-semibold", e && "tw-pl-8", t),
...
pw.displayName = rt.Label.displayName;
const ci = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  rt.Separator,
  {
    ref: n,
    className: f("tw--mx-1 tw-my-1 tw-h-px tw-bg-muted", t),
...
ci.displayName = rt.Separator.displayName;
const Xe = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([i], s) => {
    const l = e.filter((d) => d.group === i).sort((d, w) => d.order - w.order).map((d) => /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in d ? /* @__PURE__ */ p(
        li,
        {
          onClick: () => {
            o(d);
          ...
          children: [
            d.iconPathBefore && /* @__PURE__ */ r(Cn, { icon: d.iconPathBefore, menuLabel: d.label, leading: !0 }),
            d.label,
            d.iconPathAfter && /* @__PURE__ */ r(Cn, { icon: d.iconPathAfter, menuLabel: d.label })
          ]
        },
        `menubar-item-${d.label}-${d.command}`
      ) : /* @__PURE__ */ p(cw, { children: [
        /* @__PURE__ */ r(ai, { children: d.label }),
        /* @__PURE__ */ r(ii, { children: di(
          t,
          e,
          Ja(t, d.id),
          o
      ...
      d.tooltip && /* @__PURE__ */ r(_t, { children: d.tooltip })
    ] }, `tooltip-${d.label}-${"command" in d ? d.command : d.id}`)), c = [...l];
    return l.length > 0 && s < a.length - 1 && c.push(/* @__PURE__ */ r(ci, {}, `separator-${i}`)), c;
  });
};
function uw({
  menuData: t,
  ...
  const a = H(void 0), i = H(void 0), s = H(void 0), l = H(void 0), c = H(void 0), d = (w) => {
    switch (w) {
      case "platform.app":
        return i;
  ...
  if (rl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, m) => {
    var g, x, v, y;
    w.preventDefault();
    ...
    switch (m.hotkey) {
      case "alt":
        ...
        break;
      case "alt+p":
        (g = i.current) == null || g.focus(), Xe(i, [h, u]);
        break;
      case "alt+l":
        (x = s.current) == null || x.focus(), Xe(s, [h, u]);
        break;
      case "alt+n":
        (v = l.current) == null || v.focus(), Xe(l, [h, u]);
        break;
      case "alt+h":
        (y = c.current) == null || y.focus(), Xe(c, [h, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(ri, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, m]) => typeof w == "boolean" || typeof m == "boolean" ? 0 : w.order - m.order).map(([w, m]) => /* @__PURE__ */ p(lw, { children: [
      /* @__PURE__ */ r(oi, { ref: d(w), children: typeof m == "object" && "label" in m && m.label }),
      /* @__PURE__ */ r(
        si,
        {
          style: { zIndex: Ge },
          children: /* @__PURE__ */ r(kt, { children: di(t.groups, t.items, w, e) })
        }
      )
    ] }, w)) });
}
...
function su({
  ...
  const d = mw(
    ...
    return v ? `${(j = t[g]) == null ? void 0 : j.autonym} (${v})` : (z = t[g]) == null ? void 0 : z.autonym;
  };
  return /* @__PURE__ */ p("div", { id: c, className: f("pr-twp tw-max-w-sm", l), children: [
    ...
    e !== "en" && /* @__PURE__ */ r("div", { className: "tw-pt-3", children: /* @__PURE__ */ r(ht, { className: "tw-font-normal tw-text-muted-foreground", children: ve(d, {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            !e && h && d && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: d })
            ] }) }),
            e && d && /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f(m && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: d })
            ] })
          ] }),
...
const hw = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ji, { size: 35, className: f("tw-animate-spin", t), ...e, ref: n }));
hw.displayName = "Spinner";
function du({
  id: t,
  isDisabled: e = !1,
  hasError: n = !1,
...
vw.displayName = "AlertTitle";
const xw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: f("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
xw.displayName = "AlertDescription";
const wu = ot.Root, pu = ot.Trigger, uu = ot.Group, mu = ot.Portal, fu = ot.Sub, hu = ot.RadioGroup, yw = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: f(
...
yw.displayName = ot.SubTrigger.displayName;
...
Nw.displayName = ot.SubContent.displayName;
const kw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: f(
...
kw.displayName = ot.Content.displayName;
const _w = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Item,
  {
    ref: o,
    className: f(
...
_w.displayName = ot.Item.displayName;
const Cw = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => /* @__PURE__ */ p(
  ot.CheckboxItem,
  {
    ref: a,
    className: f(
...
Cw.displayName = ot.CheckboxItem.displayName;
const Ew = b.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ p(
  ot.RadioItem,
  {
    ref: o,
    className: f(
...
Ew.displayName = ot.RadioItem.displayName;
const Tw = b.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  ot.Label,
  {
    ref: o,
    className: f(
...
Tw.displayName = ot.Label.displayName;
...
Rw.displayName = ot.Separator.displayName;
...
Sw.displayName = "ContextMenuShortcut";
const wi = b.createContext({
  direction: "bottom"
});
function Dw({
  ...
  return /* @__PURE__ */ r(wi.Provider, { value: o, children: /* @__PURE__ */ r(
    zt.Root,
    {
...
Dw.displayName = "Drawer";
const gu = zt.Trigger, Mw = zt.Portal, bu = zt.Close, pi = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
pi.displayName = zt.Overlay.displayName;
const Iw = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: i = "bottom" } = b.useContext(wi), s = {
...
Pw.displayName = zt.Title.displayName;
...
$w.displayName = zt.Description.displayName;
const Lw = b.forwardRef(({ className: t, value: e, ...n }, o) => /* @__PURE__ */ r(
  or.Root,
  {
    ref: o,
    className: f(
...
Lw.displayName = or.Root.displayName;
function vu({
  className: t,
  ...e
}) {
...
function yu({
  ...
  return /* @__PURE__ */ r(
    xr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Zi, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Nu({ ...t }) {
...
const Vw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ p(
    We.Root,
    {
...
Vw.displayName = We.Root.displayName;
...
jw.displayName = ar.Root.displayName;
const ku = Rt.Root, zw = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
zw.displayName = Rt.List.displayName;
...
Fw.displayName = Rt.Trigger.displayName;
...
Bw.displayName = Rt.Content.displayName;
...
const Uw = (t, e, n = {}) => {
  ...
  return Y(() => {
    ...
    return c(!!t), (async () => {
      ...
      d = !1, a.current.preserveValue || s(() => o.current);
    };
  }, [t]), [i, l];
}, Wn = () => !1, Cu = (t, e) => {
  const [n] = Uw(
...
export {
  ...
  Sp as CommentList,
  wu as ContextMenu,
  Cw as ContextMenuCheckboxItem,
  kw as ContextMenuContent,
  uu as ContextMenuGroup,
  _w as ContextMenuItem,
  Tw as ContextMenuLabel,
  mu as ContextMenuPortal,
  hu as ContextMenuRadioGroup,
  Ew as ContextMenuRadioItem,
  Rw as ContextMenuSeparator,
  Sw as ContextMenuShortcut,
  fu as ContextMenuSub,
  Nw as ContextMenuSubContent,
  yw as ContextMenuSubTrigger,
  ...
  sd as DropdownMenuItemType,
  dn as DropdownMenuLabel,
  Fc as DropdownMenuPortal,
  Kc as DropdownMenuRadioGroup,
  ...
  $e as Separator,
  Qp as SettingsList,
  eu as SettingsListHeader,
  tu as SettingsListItem,
  Jd as SettingsSidebar,
  ...
  dd as UNDO_REDO_BUTTONS_STRING_KEYS,
  su as UiLanguageSelector,
  wd as UndoRedoButtons,
  ti as VerticalTabs,
