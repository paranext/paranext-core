...
function Ya({
  ...
  const T = Re(), O = ud(), [M, D] = _(!1), [I, Y] = _(""), [X, B] = _(""), [k, ot] = _("books"), [$, G] = _(void 0), [Q, j] = _(
    void 0
  ), [at, wt] = _(void 0), [ct, tt] = _(!1), [ut, xt] = _(!1), [gt, yt] = _(!1), [St, qt] = _(!1), $t = A(null), ie = A(!1), Rt = A(void 0), Et = A(void 0), Bt = A(void 0), ce = A(void 0), le = A({}), Mt = A({}), Dt = L(
    (m) => {
      e(m), d && d(m);
    },
    [e, d]
  ...
  const q = L(() => {
    ...
    (m) => {
      D(m), m && (ot("books"), G(void 0), j(void 0), wt(void 0), B(""), qt(!1), yt(!1), xt(re));
    },
    [re]
  );
  J(() => {
...
const Jw = {
  ...
  const ct = L(
    ...
    [G.commentEdits, ct]
  ), [ut, xt] = _(), gt = n, [yt, St] = _(!1), [qt, $t] = _(!1), [ie, Rt] = _(!1), [Et, Bt] = _(!1), [ce, le] = _(!1), [Mt, Dt] = _(z), [de, xe] = _(!1), ge = A(void 0), [ye, Zt] = _(/* @__PURE__ */ new Map());
  J(() => {
    let R = !0;
    return (async () => {
  ...
  }, [ht, lt, yt, G.commentEdits]), ke = V(() => yt || lt <= 2 ? 0 : lt - Ie.length, [lt, yt, Ie.length]), rr = V(
...
function Hh({
  ...
  const [x, g] = _("generated"), [C, E] = _("generated"), [S, y] = _("*"), [z, T] = _("*"), [O, M] = _("f"), [D, I] = _(!1), [Y, X] = _(!0), [B, k] = _(!1), ot = A(!1), $ = A(""), [G, Q] = _(!1), j = yu(), [at, wt] = _(), ct = A(null), tt = A(
    void 0
  ), ut = A(0), xt = A(void 0), gt = L(() => {
    var F, q, U;
    if ((F = h.current) != null && F.getSelection()) return;
    const N = xt.current;
    N ? (q = h.current) == null || q.setSelection(N) : (U = h.current) == null || U.selectNote(0);
  }, []), yt = L(() => {
    var N;
  ...
  J(() => {
    var N;
    G || (N = h.current) == null || N.focus();
  }, [O, G]);
  const $t = L(() => {
    var U, Z, H;
    const N = (U = f.current) == null ? void 0 : U.querySelector(".editor-input"), F = N == null ? void 0 : N.querySelector("span.note"), q = (H = (Z = f.current) == null ? void 0 : Z.ownerDocument.getSelection()) == null ? void 0 : H.anchorNode;
  ...
  J(() => {
    ...
    return () => {
      N && clearTimeout(N), F !== void 0 && cancelAnimationFrame(F), q !== void 0 && clearTimeout(q);
    };
  }, [e, s, $t]);
  const ie = L(
    (N = !1) => {
    ...
    (N, F) => {
      ...
      let U;
      N === "custom" ? U = F : N === "generated" ? U = go : U = fo, q.insert.note.caller !== U && (q.insert.note.caller = U, Rt(q));
    },
    [Rt]
  ), Bt = L(() => {
    var N;
  ...
  const Mt = () => {
    ...
    if (!qt.length || !N || N.rangeCount === 0)
      return;
    const F = f.current;
    if (!F) return;
    const q = N.getRangeAt(0).cloneRange();
    j.setSource({
      measure: () => {
        const U = ku(q);
        return U && _u(U);
    ...
    var q;
    const N = (q = h.current) == null ? void 0 : q.getMarkerMenuContext();
    if (!N) return !1;
...
function up({
  ...
  const i = o["%webView_book_selector_books_selected%"], c = o["%webView_book_selector_select_books%"], d = o["%webView_book_selector_search_books%"], l = o["%webView_book_selector_select_all%"], w = o["%webView_book_selector_clear_all%"], p = o["%webView_book_selector_no_book_found%"], { otLong: h, ntLong: f, dcLong: b, extraLong: x } = {
    ...
    (k, ot = !1) => {
      ...
      const $ = T.findIndex((wt) => wt === y.current), G = T.findIndex((wt) => wt === k);
      if ($ === -1 || G === -1) return;
      const [Q, j] = [
        Math.min($, G),
        Math.max($, G)
...
function vg({
  ...
  ] }), gt = e ? ut.filter((K) => e.includes(K.value)) : ut, yt = g ?? qa, St = h ?? yt, qt = f ?? yt, $t = () => {
  ...
  ), N = gt.find((K) => K.value === "selectedBooks"), F = gt.find((K) => K.value === "range"), [q, U] = _(!1), [Z, H] = _(void 0), [nt, kt] = _(void 0), [mt, bt] = _(void 0), [ht, lt] = _(void 0), [It, Ie] = _([]), ke = p === "dropdown" && Z === "selectedBooks", rr = /* @__PURE__ */ a(
    gp,
    {
      availableBookInfo: o,
