...
import u, { forwardRef as We, useRef as nt, useMemo as H, useState as O, useCallback as L, useLayoutEffect as Sn, createContext as qr, useContext as Jr, useEffect as Ot, Fragment as jn } from "react";
import { Command as it } from "cmdk";
import { X as Ze, Search as Ln, Check as Rt, Clock as Rn, ChevronsLeft as Tn, ChevronsRight as En, ChevronLeft as $e, ChevronRight as Ft, ArrowLeft as Wr, ArrowRight as Zr, Circle as be, ChevronsUpDown as Qe, FilterIcon as Qr, ChevronDown as ve, ChevronUp as to, ArrowLeftIcon as eo, ChevronLeftIcon as no, ChevronRightIcon as ro, ArrowRightIcon as oo, Copy as ao, Filter as so, User as io, Link as wo, CircleHelp as lo, Star as co, AlertCircle as je, CircleCheckIcon as po, CircleXIcon as mo, CircleHelpIcon as uo, ArrowUpIcon as ho, ArrowDownIcon as fo, ArrowUpDownIcon as go, PanelLeft as bo, PanelRight as vo, ScrollText as xo, MenuIcon as yo, Menu as No, EllipsisVertical as ko, LoaderCircle as Co } from "lucide-react";
import { clsx as _o } from "clsx";
import { extendTailwindMerge as So } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as me, Section as M, getChaptersForBook as Ro, formatScrRef as Bt, getSectionForBook as oe, NumberFormat as To, formatBytes as Eo, getCurrentLocale as Vo, getFormatCallerFunction as Mo, deepEqual as tn, isString as Ve, compareScrRefs as Le, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
function Xe(t, e, n) {
  return `${t} ${It[t]}${e ? ` ${on(t, e)} ${Gt(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function sa({
  recentSearches: t,
...
), Q = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Bn.Root, { ref: n, className: c("pr-twp", da(), t), ...e }));
...
const dn = u.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = ht();
  return /* @__PURE__ */ l(
    G.CheckboxItem,
    {
...
const cn = u.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: o,
...
cn.displayName = G.Label.displayName;
...
function Va({
  ...
  var S;
  const [m, d] = O([]), [p, g] = O([]), [h, f] = O({}), [b, y] = O({}), v = Gn({
    data: e,
    columns: t,
    getCoreRowModel: Xn(),
...
function zi({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(ln, { children: [
    ...
    /* @__PURE__ */ r(Ne, { children: n.map((d, p) => /* @__PURE__ */ l("div", { children: [
      /* @__PURE__ */ r(cn, { children: d.label }),
          ...
          return /* @__PURE__ */ l(
            jt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ r("div", { className: "tw-w-4", children: S.starred && /* @__PURE__ */ r(co, { className: "tw-h-4 tw-w-4" }) }),
...
function pn(t, e, n = !0, o = !0, a = []) {
  ...
  return e.map((i) => {
    if (typeof i == "string") {
      if (o) {
        const w = c(`usfm_${t}`);
        return /* @__PURE__ */ r("span", { className: w, children: i }, s);
      }
      return /* @__PURE__ */ l(
        "span",
        {
...
function ja({
  ...
  const m = o ? /* @__PURE__ */ r("span", { className: Ue, children: `\\${t.marker} ` }) : void 0, d = o ? /* @__PURE__ */ r("span", { className: Ue, children: ` \\${t.marker}*` }) : void 0, p = /* @__PURE__ */ l(bt, { children: [
  ...
  return /* @__PURE__ */ l(bt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: w && w.length > 0 && /* @__PURE__ */ r(bt, { children: za(t.marker, w, o, d) })
      }
    )
  ] });
}
...
const Ga = u.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
function Bi({
  ...
  const p = d ? Ha(d, "%webView_footnoteList_header%") : "Footnotes", g = w ?? Mo(e, void 0), h = (f) => {
    m && m(f);
  };
  return /* @__PURE__ */ l(bt, { children: [
...
), Ya = u.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Hn.Root,
  {
    ref: a,
    className: c(ur({ variant: e, size: n, className: t })),
    ...o
  }
));
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(fo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(go, { className: "tw-ms-2 tw-h-4 tw-w-4" }), Gi = (t) => ({
  accessorKey: "item",
...
function qi({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), S = Nt(n, "%webView_inventory_filter_text%"), N = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [C, j] = O(!1), [W, B] = O("all"), [ot, pt] = O(""), [_, E] = O([]), Y = H(() => t.length === 0 ? [] : Wa(t, a, s), [t, a, s]), A = H(() => {
    if (C) return Y;
    const T = [];
    return Y.forEach((Z) => {
...
const un = u.forwardRef(({ className: t, orientation: e = "horizontal", decorative: n = !0, ...o }, a) => /* @__PURE__ */ r(
  Un.Root,
  {
    ref: a,
    decorative: n,
...
const hn = de.Provider, fn = de.Root, gn = de.Trigger, Te = u.forwardRef(({ className: t, sideOffset: e = 4, ...n }, o) => /* @__PURE__ */ r(
  de.Content,
  {
    ref: o,
    sideOffset: e,
...
const Ke = u.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Yt : "div",
  {
    ref: o,
  ...
  ({
    ...
    const m = t ? Yt : "button", { state: d } = Ee(), p = /* @__PURE__ */ r(
      m,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: c(is({ variant: n, size: o }), s),
        ...i
      }
    );
...
const ds = u.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
...
const ms = u.forwardRef(({ asChild: t = !1, size: e = "md", isActive: n, className: o, ...a }, s) => /* @__PURE__ */ r(
  t ? Yt : "a",
  {
    ref: s,
...
}, zn = (t) => `${ys({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Wi({
  sources: t,
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r($t, { position: "item-aligned", children: /* @__PURE__ */ r(va, { children: j.map((_) => /* @__PURE__ */ r(mt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
...
}), Sr = (t, e, n) => vn(t, e).every((o) => n.includes(o));
function Ns({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  const s = vn(e, t).length === 0, i = a["%scripture_section_ot_short%"], w = a["%scripture_section_nt_short%"], m = a["%scripture_section_dc_short%"], d = a["%scripture_section_extra_short%"];
  return /* @__PURE__ */ r(
    I,
    {
      variant: "outline",
...
const Tr = (t, e, n, o) => n ? Object.entries(t).filter(
...
).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((w) => w.group === s).sort((w, m) => w.order - m.order).map((w) => /* @__PURE__ */ l(fn, { children: [
  /* @__PURE__ */ r(gn, { asChild: !0, children: "command" in w ? /* @__PURE__ */ l(
    ...
    /* @__PURE__ */ r(ua, { children: /* @__PURE__ */ r(ir, { children: Tr(
      t,
      e,
      Rr(t, w.id),
      o
...
function Je({
  ...
  return /* @__PURE__ */ l(ln, { variant: s, children: [
    ...
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, m]) => typeof m == "object").sort(([, m], [, d]) => typeof m == "boolean" || typeof d == "boolean" ? 0 : m.order - d.order).map(([m], d, p) => /* @__PURE__ */ l(jn, { children: [
      /* @__PURE__ */ r(ar, { children: /* @__PURE__ */ r(hn, { children: Tr(e.groups, e.items, m, t) }) }),
...
const Ir = u.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  ...
  return /* @__PURE__ */ r(wn.Provider, { value: a, children: /* @__PURE__ */ r(
    F.Root,
    {
      ref: o,
      className: c(
...
const Is = We(({ className: t, ...e }, n) => /* @__PURE__ */ r(Co, { size: 35, className: c("tw-animate-spin", t), ...e, ref: n }));
...
const pw = X.Root, mw = X.Trigger, uw = X.Group, hw = X.Portal, fw = X.Sub, gw = X.RadioGroup, Bs = u.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
Bs.displayName = X.SubTrigger.displayName;
...
const Us = u.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  X.RadioItem,
  {
    ref: o,
    className: c(
...
Us.displayName = X.RadioItem.displayName;
const Ys = u.forwardRef(({ className: t, inset: e, ...n }, o) => /* @__PURE__ */ r(
  X.Label,
  {
    ref: o,
    className: c(
...
Ys.displayName = X.Label.displayName;
...
ai.displayName = Fe.Root.displayName;
const yw = wt.Root, si = u.forwardRef(({ className: t, ...e }, n) => {
  const o = tt();
  return /* @__PURE__ */ r(
    wt.List,
    {
