...
import { c as m, g as Se, a as Fa, C as Ce, A as se, P as $e, b as Ye, B as U, d as Me, e as Ie, f as Ae, h as xe, i as ji, k as Li, j as Bi, E as Fi, l as Ua, r as re, m as Ui, n as ln, o as Qr, p as ta, L as Nt, D as Na, q as Ca, s as Ea, t as Ta, T as Gt, u as Ka, v as Ht, w as Yt, x as Wt, y as dn, z as qa, F as qe, G as kr, H as ye, I as ke, J as _e, S as _r, K as tr, M as Ki, N as Er, O as He, Q as De, Z as We, R as Re, U as er, V as Ga, W as Ha, X as qr, Y as Ya, _ as wn, $ as qi, a0 as Gi, a1 as Hi, a2 as bo, a3 as un, a4 as ea, a5 as pn, a6 as Yi, a7 as Wi, a8 as Xi, a9 as Ji, aa as hn, ab as Zi, ac as sa, ad as xo, ae as ca, af as Qi, ag as ts, ah as es, ai as rs, aj as as, ak as Tr, al as Wa, am as os, an as ns } from "./resizable-Ds9c_6hc.js";
import { ao as Gh, ap as Hh, aq as Yh, ar as Wh, as as Xh, at as Jh, au as Zh, av as Qh, aw as tg, ax as eg, ay as rg, az as ag, aA as og, aB as ng, aC as ig, aD as sg, aE as cg, aF as lg, aG as dg, aH as wg, aI as ug, aJ as pg, aK as hg, aL as gg, aM as fg } from "./resizable-Ds9c_6hc.js";
...
import { Section as dt, getChaptersForBook as Ps, formatScrRef as ve, getSectionForBook as br, formatRelativeDate as js, formatReplacementString as Ge, sanitizeHtml as Ja, NumberFormat as Ls, formatBytes as Bs, getCurrentLocale as Fs, usfmMarkers as Pr, getFormatCallerFunction as Us, deepEqual as Ks, isString as Co, compareScrRefs as Da, scrRefToBBBCCCVVV as la, defaultScrRef as da, formatScrRefRange as qs, getLocalizeKeyForScrollGroupId as Eo, collectUsjMarkers as Gs } from "platform-bible-utils";
...
function ua({
  ...
  const B = re(), [z, I] = _(!1), [A, C] = _(""), [V, K] = _(""), [y, J] = _("books"), [j, Y] = _(void 0), [T, M] = _(
    void 0
  ), [W, Z] = _(void 0), [Ot, Tt] = _(!1), Pt = F(null), q = F(!1), tt = F(void 0), wt = F(void 0), at = F(void 0), mt = F(void 0), oe = F({}), ut = F({}), bt = L(
    (b) => {
      e(b), c && c(b);
    },
    [e, c]
  ...
  return Qt(() => {
    const b = setTimeout(() => {
      if (z && y === "books" && at.current && mt.current) {
        const G = at.current, rt = mt.current, Vt = rt.offsetTop, me = G.clientHeight, Te = rt.clientHeight, Be = Vt - me / 2 + Te / 2;
        G.scrollTo({
          top: Math.max(0, Be),
          behavior: "smooth"
        }), C(Un(t.book));
...
const Gn = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, bl = Gn ? Qt : H, Ir = { tag: to };
...
}, name: "@lexical/extension/InitialState", nodes: [xc, Sn, yc, kc, zn] }), qo = Symbol.for("@lexical/extension/LexicalBuilder");
function Go() {
}
function Ql(t) {
  throw t;
...
class ar {
  ...
  buildCreateEditorArgs() {
    ...
    for (const w of c) {
      const { extension: p } = w;
      if (p.onError !== void 0 && (e.onError = p.onError), p.disableEvents !== void 0 && (e.disableEvents = p.disableEvents), p.parentEditor !== void 0 && (e.parentEditor = p.parentEditor), p.editable !== void 0 && (e.editable = p.editable), p.namespace !== void 0 && (e.namespace = p.namespace), p.$initialEditorState !== void 0 && (e.$initialEditorState = p.$initialEditorState), p.nodes) for (const g of Gl(p)) {
...
const $d = "verseText", Wu = Object.freeze([
...
function xi({
  ...
  const [y, J] = _(Qo), [j, Y] = _(), [T, M] = _(), W = o, [Z, Ot] = _(!1), [Tt, Pt] = _(!1), [q, tt] = _(!1), [wt, at] = _(!1), [mt, oe] = _(!1), [ut, bt] = _(D), [$t, jt] = _(!1), Jt = F(void 0), [fe, R] = _(/* @__PURE__ */ new Map());
  H(() => {
    let S = !0;
    return (async () => {
...
function Qd({
  ...
  return d ? B = Array.from({ length: 10 }).map((C, V) => `skeleton-row-${V}`).map((C) => /* @__PURE__ */ a(Re, { className: "tw:hover:bg-transparent", children: /* @__PURE__ */ a(er, { colSpan: D.length ?? t.length, className: "tw:border-0 tw:p-0", children: /* @__PURE__ */ a("div", { className: "tw:w-full tw:py-2", children: /* @__PURE__ */ a(tr, { className: "tw:h-14 tw:w-full tw:rounded-md" }) }) }) }, C)) : ((z = N.getRowModel().rows) == null ? void 0 : z.length) > 0 ? B = N.getRowModel().rows.map((I) => /* @__PURE__ */ a(
    ...
    /* @__PURE__ */ u(Ga, { stickyHeader: i, children: [
      /* @__PURE__ */ a(Ha, { stickyHeader: i, children: N.getHeaderGroups().map((I) => /* @__PURE__ */ a(Re, { children: I.headers.map((A) => /* @__PURE__ */ a(qr, { className: "tw:p-0", children: A.isPlaceholder ? void 0 : xr(A.column.columnDef.header, A.getContext()) }, A.id)) }, I.id)) }),
...
function gp({
  ...
  const [f, x] = _("generated"), [v, E] = _("generated"), [k, N] = _("*"), [D, B] = _("*"), [z, I] = _("f"), [A, C] = _(!1), [V, K] = _(!0), [y, J] = _(!1), j = F(!1), Y = F(""), [T, M] = _(!1), [W, Z] = _(), [Ot, Tt] = _(), [Pt, q] = _(), [tt, wt] = _(), at = F(null), mt = O(
    () => ({
      ...s,
      markerMenuTrigger: c,
      hasExternalUI: !0,
...
const Nw = (t) => {
...
}, na = (t, e, r) => /* @__PURE__ */ a(Gt, { children: /* @__PURE__ */ u(Ht, { children: [
  /* @__PURE__ */ u(
    Yt,
    {
  ...
  return e ? e[1] : "";
}, Ew = (t, e, r) => r.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Np = Object.freeze([
...
}, sn = (t) => `${Gw({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Lp({
  sources: t,
...
function Fp({
  ...
  const D = St(
  ...
  ], q = ($, X, qt = !1) => /* @__PURE__ */ u(ct, { children: [
    $,
    ...
    [r, n, f, i]
  ), ot = tt.find(($) => $.value === t), it = () => t === "selectedBooks" && n.length > 0 ? n.map(($) => $.toUpperCase()).join(", ") : t === "range" ? qs(at, mt, {
    ...
    /* @__PURE__ */ u("div", { className: "tw:grid tw:gap-2", children: [
      ...
      l === "dropdown" ? /* @__PURE__ */ u(ye, { open: gt, onOpenChange: Mt, children: [
        ...
        /* @__PURE__ */ a(
          _e,
          {
            ...
            children: /* @__PURE__ */ u(sa, { container: Lt, children: [
              st.map(({ value: $, label: X, dropdownLabel: qt, scrRefSuffix: fr, id: Ai }) => /* @__PURE__ */ u(
                qe,
                {
                  ref: Te($),
        ...
        ao,
        {
          ...
          children: tt.map(({ value: $, label: X, scrRefSuffix: qt, id: fr }) => /* @__PURE__ */ u("div", { className: "tw:flex tw:items-center", children: [
            /* @__PURE__ */ a(Gr, { className: "tw:me-2", value: $, id: fr }),
