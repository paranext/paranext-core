...
const nl = Lt.Root, rl = Lt.Portal, Ko = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Lt.Overlay,
  {
    ref: n,
    className: f(
...
Ko.displayName = Lt.Overlay.displayName;
...
Go.displayName = Lt.Content.displayName;
...
qo.displayName = Lt.Title.displayName;
...
ol.displayName = Lt.Description.displayName;
...
Ho.displayName = Et.Separator.displayName;
...
const Wo = ct.allBookIds.filter(
  (t) => !ct.isObsolete(ct.bookIdToNumber(t))
), xe = Object.fromEntries(
  Wo.map((t) => [t, ct.bookIdToEnglishName(t)])
);
function xr(t, e, n) {
...
const Jo = an(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, i) => /* @__PURE__ */ r(o ? ze : "button", { className: f(Zo({ variant: e, size: n, className: t })), ref: i, ...a })
);
F.displayName = "Button";
const re = Oe.Root, ue = Oe.Trigger, sl = Oe.Anchor, Ht = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const i = bt();
...
function ar(t, e, n) {
  return `${t} ${xe[t]}${e ? ` ${vr(t, e)} ${De(t, e)}` : ""}${n ? ` ${n}` : ""}`;
}
function il({
  recentSearches: t,
...
function pp({
  ...
  const c = bt(), [p, u] = R(!1), [h, m] = R(""), [g, x] = R(""), [v, y] = R("books"), [N, k] = R(void 0), [C, B] = R(!1), L = Y(void 0), S = Y(void 0), P = Y(void 0), E = Y(void 0), O = Y({}), V = K(
    ...
    [v, dt]
  ), { otLong: it, ntLong: ut, dcLong: nt, extraLong: vt } = {
    ...
    (M) => {
      if (M.ctrlKey) return;
      const { isLetter: _, isDigit: $ } = qr(M.key);
      if (v === "chapters") {
        if (M.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && I) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(M.key)) {
        ...
        switch (M.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            tt = q === 0 ? st : Math.max(1, q - xt);
            break;
          case "ArrowDown":
            tt = q === 0 ? 1 : Math.min(st, q + xt);
            break;
          default:
            return;
        }
        tt !== q && (M.preventDefault(), M.stopPropagation(), m(ar(U, a, tt)), setTimeout(() => {
          const pt = O.current[tt];
  ...
  return $t(() => {
    const M = setTimeout(() => {
      if (p && v === "books" && P.current && E.current) {
        const _ = P.current, $ = E.current, U = $.offsetTop, q = _.clientHeight, st = $.clientHeight, tt = U - q / 2 + st / 2;
        _.scrollTo({
          top: Math.max(0, tt),
          behavior: "smooth"
        }), m(ar(t.book));
...
), gt = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ko.Root, { ref: n, className: f("pr-twp", dl(), t), ...e }));
gt.displayName = ko.Root.displayName;
...
const ta = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, hl = ta ? $t : H, pn = { tag: hr };
...
function Tl(t, e, n = "self") {
  ...
  if (e.isSelected(t) && !oi(e) && o !== null) {
    ...
    if (c || p) {
      const [u, h] = ai(t), m = l.is(w), g = e.is(s ? w : l), x = e.is(s ? l : w);
      let v, y = 0;
...
const Cr = 0, wr = 1, ca = 2, Fn = 3, un = 4, Re = 5, Bn = 6, He = 7;
function Kn(t) {
  return t.id === Cr;
}
function da(t) {
...
function Vl(t) {
  return function(e) {
    return e.id === wr;
  }(t) || et(305, String(t.id), String(wr)), Object.assign(t, { id: ca });
}
...
class zl {
  ...
  build(e) {
    const n = this.state;
    let o;
    n.id !== un && et(307, String(n.id), String(Re)), this.extension.build && (o = this.extension.build(e, n.config, n.registerState));
...
class Qe {
  ...
  sortedExtensionReps() {
    ...
    const e = [], n = (o, a) => {
      ...
      var l;
      Kn(i) || et(300, s, a || "[unknown]"), Kn(l = i) || et(304, String(l.id), String(Cr)), i = Object.assign(l, { id: wr }), o.state = i;
...
Ut({ dependencies: [lr, to], name: "@lexical/extension/HorizontalRule", nodes: () => [Ie], register(t, e, n) {
  ...
  return ce(t.registerCommand(mi, (s) => {
    ...
    return !1;
  }, Oo), t.registerMutationListener(Ie, (s, l) => {
    Il(() => {
      let w = !1;
...
Ut({ build: (t, e, n) => Dn(e), config: sn({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => de(() => n.getOutput().disabled.value ? void 0 : fa(t)) });
function Zl(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
...
const Er = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : H;
...
const ha = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? $t : H;
function sw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: i, ariaExpanded: s, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: p, ariaOwns: u, ariaRequired: h, autoCapitalize: m, className: g, id: x, role: v = "textbox", spellCheck: y = !0, style: N, tabIndex: k, "data-testid": C, ...B }, L) {
  ...
  return ha(() => (P(t.isEditable()), t.registerEditableListener((V) => {
    P(V);
...
Pe.displayName = jo.Root.displayName;
...
Ra.displayName = Fe.Root.displayName;
...
Sa.displayName = Fe.Fallback.displayName;
const Dr = Cn(void 0);
function Ft() {
  const t = fr(Dr);
  if (!t)
...
}), Ke = rt.Trigger, Da = rt.Group, Pw = rt.Portal, $w = rt.Sub, Lw = rt.RadioGroup;
function Ee({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Dr.Provider, { value: n, children: /* @__PURE__ */ r(rt.Root, { ...e }) });
}
...
Ma.displayName = rt.SubTrigger.displayName;
...
Oa.displayName = rt.SubContent.displayName;
...
Ia.displayName = rt.RadioItem.displayName;
...
function oo({
  ...
  const m = K(
    ...
    [t.user]
  ), N = z(() => Zs(t.contents), [t.contents]), k = z(() => {
    if (o && l)
      return /* @__PURE__ */ d(lt, { children: [
        /* @__PURE__ */ d(
          kn,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ d(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), m()) : Sr(C) && (C.preventDefault(), C.stopPropagation(), Pt(p) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ d(Ee, { children: [
          /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
...
function jw({
  ...
  const [S, P] = R(ao), [E, O] = R(
    void 0
  ), V = o, [j, D] = R(!1), [A, W] = R(!1), [I, J] = R(!1), [Rt, Ot] = R(!1), [It, mt] = R(!1), [dt, G] = R(C), [it, ut] = R(!1), nt = Y(void 0), [vt, Xt] = R(/* @__PURE__ */ new Map());
  H(() => {
    let T = !0;
    return (async () => {
  ...
  }, [i, n]), $ = z(() => Bt.slice(1), [Bt]), U = z(() => $.length ?? 0, [$.length]), q = z(() => U > 0, [U]), st = z(() => j || U <= 2 ? $ : $.slice(-2), [$, U, j]), tt = z(() => j || U <= 2 ? 0 : U - 2, [U, j]), xt = z(
    () => U === 1 ? M.singleReply : be(M.multipleReplies, { count: U }),
    [U, M]
  ), pt = z(
    () => tt === 1 ? M.singleReply : be(M.multipleReplies, { count: tt }),
    [tt, M]
  );
  H(() => {
    !o && A && q && W(!1);
          ...
          /* @__PURE__ */ d("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              F,
              {
                ...
                children: dt ? /* @__PURE__ */ r(xs, {}) : /* @__PURE__ */ r(ys, {})
              }
            ),
          ...
          o && /* @__PURE__ */ d(lt, { children: [
            ...
            v !== !1 && (!A || Pt(S)) && /* @__PURE__ */ d(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Sr(T) && (T.preventDefault(), T.stopPropagation(), (Pt(S) || E !== void 0) && ft());
                },
                onKeyDown: (T) => {
...
function Zw({
  ...
  var L;
  const [p, u] = R([]), [h, m] = R([]), [g, x] = R({}), [v, y] = R({}), N = z(() => e ?? [], [e]), k = zo({
    data: N,
    columns: t,
    getCoreRowModel: Bo(),
  ...
  let B;
  return w ? B = Array.from({ length: 10 }).map((E, O) => `skeleton-row-${O}`).map((E) => /* @__PURE__ */ r(Zt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(ye, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(cr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((L = k.getRowModel().rows) == null ? void 0 : L.length) > 0 ? B = k.getRowModel().rows.map((S) => /* @__PURE__ */ r(
    Zt,
    {
      onClick: () => s(S, k),
...
function kp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ d(Ee, { children: [
    ...
    /* @__PURE__ */ r(me, { children: n.map((c, p) => /* @__PURE__ */ d("div", { children: [
      ...
      /* @__PURE__ */ r(Da, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((u, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        Qt,
        {
          checked: o[p][h],
        ...
        /* @__PURE__ */ r(te, { children: B.map((O) => /* @__PURE__ */ d(
          qt,
          {
            ...
            children: [
              ...
              O.starred && /* @__PURE__ */ r(Ms, { className: "tw-h-4 tw-w-4" }),
...
function dc({
  ...
  return /* @__PURE__ */ d(Ee, { children: [
    /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ d(St, { children: [
      /* @__PURE__ */ r(Li, { asChild: !0, children: /* @__PURE__ */ r(Ke, { asChild: !0, children: /* @__PURE__ */ r(F, { variant: "outline", className: "tw-h-6", children: wc(t, n) }) }) }),
...
function Tp({
  ...
  H(() => {
    ...
    if ($ && dn("note", $)) {
      ...
      let tt = "custom";
      st === tr ? tt = "generated" : st === er ? tt = "hidden" : st && N(st), v(tt), C(((q = $.insert.note) == null ? void 0 : q.style) ?? "f"), _ = setTimeout(() => {
        var xt;
  ...
  const nt = K(
    (_, $, U = !1) => {
      var st, tt, xt;
      const q = (tt = (st = u.current) == null ? void 0 : st.getNoteOps(0)) == null ? void 0 : tt.at(0);
      if (q && dn("note", q)) {
        if (q.insert.note) {
          let ft;
    ...
    nt(x, y, !0), o();
  }, [x, y, o, nt]), Xt = Y({ book: a.book, chapterNum: a.chapterNum });
  $t(() => {
  ...
  const Bt = () => {
    ...
    if ($ && dn("note", $)) {
      ...
      const pt = (tt = (st = $.insert.note) == null ? void 0 : st.contents) == null ? void 0 : tt.ops;
    ...
    if ($ && dn("note", $)) {
      ...
      const pt = (st = $.insert.note) == null ? void 0 : st.style, ft = (xt = (tt = $.insert.note) == null ? void 0 : tt.contents) == null ? void 0 : xt.ops;
      if (pt || L(!1), L(
...
const Va = b.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(La.Provider, { value: N, children: /* @__PURE__ */ r(_t, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const se = "scrBook", qc = "scrRef", ge = "source", Hc = "details", Yc = "Scripture Reference", Xc = "Scripture Book", Ua = "Type", Wc = "Details";
function Jc(t, e) {
  const n = e ?? !1;
  return [
    {
...
function jp({
  ...
  H(() => {
    if (l) {
      ...
      if (O.length === 1) {
        const V = x.find((j) => wo(j) === O[0]) || void 0;
        V && l(V);
      }
    }
  }, [m, x, l, y]);
  const N = a ?? Xc, k = i ?? Ua, C = [
...
function td({
  ...
  const L = z(() => ct.allBookIds.filter(
    ...
    (A) => {
      const W = Ar(L, A).map((I) => I);
      n(
        qa(L, A, e) ? e.filter((I) => !W.includes(I)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, L]
  ), j = () => {
...
function mr({
  ...
  return /* @__PURE__ */ d(Ee, { variant: i, children: [
    /* @__PURE__ */ r(Ke, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(F, { variant: s, size: "icon", children: o ?? /* @__PURE__ */ r(Ks, {}) }) }),
    /* @__PURE__ */ r(me, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, p) => /* @__PURE__ */ d(po, { children: [
      /* @__PURE__ */ r(Da, { children: /* @__PURE__ */ r(_t, { children: Ya(e.groups, e.items, w, t) }) }),
...
Wa.displayName = Tt.List.displayName;
...
Za.displayName = Tt.Content.displayName;
function Yp({
  tabList: t,
  searchValue: e,
  onSearch: n,
...
Qa.displayName = ot.Root.displayName;
...
ts.displayName = ot.Trigger.displayName;
...
es.displayName = ot.SubTrigger.displayName;
...
ns.displayName = ot.SubContent.displayName;
...
rs.displayName = ot.Content.displayName;
...
os.displayName = ot.Item.displayName;
...
as.displayName = ot.Separator.displayName;
const Ye = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  if (Zi(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, u) => {
    ...
    return /* @__PURE__ */ r(Qa, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, u]) => typeof p == "boolean" || typeof u == "boolean" ? 0 : p.order - u.order).map(([p, u]) => /* @__PURE__ */ d(nd, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(_t, { children: ss(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
        ...
        /* @__PURE__ */ d("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-p-4", children: [
          /* @__PURE__ */ d("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
            ...
            e && l && /* @__PURE__ */ d(Ee, { children: [
              /* @__PURE__ */ r(Ke, { className: f(c && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(F, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(ho, {}) }) }),
...
const iu = zt.Trigger, Cd = zt.Portal, lu = zt.Close, ls = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
ls.displayName = zt.Overlay.displayName;
