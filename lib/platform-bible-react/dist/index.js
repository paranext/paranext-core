...
var hs = (t, e, n) => e in t ? fs(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var yt = (t, e, n) => hs(t, typeof e != "symbol" ? e + "" : e, n);
import { jsx as r, jsxs as p, Fragment as lt } from "react/jsx-runtime";
import b, { forwardRef as sn, useRef as H, useMemo as B, useState as S, useCallback as K, useLayoutEffect as At, createContext as En, useContext as gr, useEffect as Y, Component as gs, createElement as jr, Suspense as bs, Fragment as bo } from "react";
import { Command as Tt } from "cmdk";
import { X as je, Search as vo, Check as jt, Clock as zr, ChevronsLeft as Fr, ChevronsRight as Br, ChevronLeft as Jn, ChevronRight as Oe, ArrowLeft as vs, ArrowRight as xs, Circle as Tn, ChevronDown as ze, BoldIcon as ys, ItalicIcon as Ns, AtSign as xo, Pencil as ks, Trash2 as _s, ArrowUp as yo, MoreHorizontal as Cs, MailOpen as Es, Mail as Ts, ChevronUp as No, FilterIcon as Rs, ArrowLeftIcon as Ss, ChevronLeftIcon as Ds, ChevronRightIcon as Ms, ArrowRightIcon as Os, Copy as ko, Filter as Is, User as As, Link as Ps, CircleHelp as $s, ChevronsUpDown as _o, Star as Ls, Undo as Vs, Redo as js, SquareX as Co, FunctionSquare as Eo, SquareSigma as To, Ban as zs, AlertCircle as Zn, CircleCheckIcon as Fs, CircleXIcon as Bs, CircleHelpIcon as Ks, ArrowUpIcon as Gs, ArrowDownIcon as Us, PanelLeft as qs, PanelRight as Hs, ScrollText as Ys, MenuIcon as Xs, Menu as Ws, EllipsisVertical as Js, MoreVertical as Kr, LoaderCircle as Zs, GripVertical as Qs } from "lucide-react";
...
import { includes as dn, Section as X, getChaptersForBook as ni, formatScrRef as xe, getSectionForBook as Je, formatRelativeDate as ri, formatReplacementString as ve, sanitizeHtml as oi, NumberFormat as ai, formatBytes as si, getCurrentLocale as ii, usfmMarkers as hn, getFormatCallerFunction as li, deepEqual as wi, isString as Gr, compareScrRefs as Qn, scrRefToBBBCCCVVV as Ln, getLocalizeKeyForScrollGroupId as Q, formatScrRefRange as ci, formatScrRefWithOptionalParts as di } from "platform-bible-utils";
import { getLocalizedBookName as Iu } from "platform-bible-utils";
...
import { createEditor as So, $getRoot as ce, $createParagraphNode as Rn, $getSelection as Vt, HISTORY_MERGE_TAG as br, ParagraphNode as Do, TextNode as Mo, $isTokenOrSegmented as pi, $getCharacterOffsets as ui, $cloneWithPropertiesEphemeral as mi, $findMatchingParent as Oo, $isElementNode as le, $isRangeSelection as ke, CLEAR_EDITOR_COMMAND as Io, COMMAND_PRIORITY_EDITOR as Ao, mergeRegister as de, shallowMergeConfig as fi, defineExtension as qt, safeCast as ln, createState as hi, FORMAT_TEXT_COMMAND as Po, $isNodeSelection as $o, COMMAND_PRIORITY_LOW as Lo, RootNode as gi, LineBreakNode as bi, TabNode as vi, $isEditorState as xi, createCommand as yi, CLICK_COMMAND as Ni, isDOMNode as ki, $getNodeFromDOMNode as _i, $createNodeSelection as Ci, $setSelection as Ei, DecoratorNode as tr, $getState as Ti, toggleTextFormatType as Ur, TEXT_TYPE_TO_FORMAT as Ri, $setState as Si, addClassNamesToElement as Vo, $create as Di, $getNodeByKey as Mi, removeClassNamesFromElement as Oi, KEY_TAB_COMMAND as Ii, $isBlockElementNode as vn, $createRangeSelection as Ai, $normalizeSelection__EXPERIMENTAL as Pi, OUTDENT_CONTENT_COMMAND as $i, INDENT_CONTENT_COMMAND as qr, INSERT_TAB_COMMAND as Li, COMMAND_PRIORITY_CRITICAL as vr, $isDecoratorNode as Vi, $isParagraphNode as ji, $isTextNode as xn, SELECTION_CHANGE_COMMAND as jo, getRegisteredNode as zi, isHTMLElement as Fi, isDocumentFragment as Hr, isDOMDocumentNode as Bi, ArtificialNode__DO_NOT_USE as zo, $createLineBreakNode as Fo, $isRootOrShadowRoot as Ki, isBlockDomNode as Yr, isInlineDomNode as Xr, $insertNodes as Gi } from "lexical";
...
import { createHeadlessEditor as Ko } from "@lexical/headless";
...
import { useReactTable as Uo, getFilteredRowModel as Qi, getSortedRowModel as qo, getPaginationRowModel as tl, getCoreRowModel as Ho, flexRender as Ze, getGroupedRowModel as el, getExpandedRowModel as nl } from "@tanstack/react-table";
import * as dt from "@radix-ui/react-select";
import rl from "markdown-to-jsx";
import { GENERATOR_NOTE_CALLER as er, HIDDEN_NOTE_CALLER as nr, getDefaultViewOptions as ol, isInsertEmbedOpOfType as pn, Editorial as al } from "@eten-tech-foundation/platform-editor";
...
const cl = Mt.Root, yp = Mt.Trigger, dl = Mt.Portal, Np = Mt.Close, Yo = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Mt.Overlay,
  {
    ref: n,
    className: m(
...
const Xo = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = mt();
...
const ea = sn(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, ...a }, s) => /* @__PURE__ */ r(o ? Fe : "button", { className: m(na({ variant: e, size: n, className: t })), ref: s, ...a })
);
j.displayName = "Button";
const Ge = 250, ra = 300, fl = 400, kp = 450, _p = 500, oe = Ie.Root, fe = Ie.Trigger, hl = Ie.Anchor, Yt = b.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, style: o, ...a }, s) => {
  const i = mt();
...
function gl({
  ...
  return /* @__PURE__ */ p(oe, { open: d, onOpenChange: f, children: [
...
function Jr({
  ...
  if (t)
    return /* @__PURE__ */ r(Ut, { children: /* @__PURE__ */ r("div", { className: m("tw-grid tw-grid-cols-6 tw-gap-1", s), children: Array.from({ length: Gt(t) }, (i, l) => l + 1).map((i) => /* @__PURE__ */ r(
      Ht,
      {
        value: `${t} ${ye[t] || ""} ${i}`,
        onSelect: () => n(i),
...
function Ep({
  ...
  const c = mt(), [d, f] = S(!1), [h, u] = S(""), [g, x] = S(""), [v, N] = S("books"), [y, k] = S(void 0), [C, z] = S(!1), F = H(void 0), A = H(void 0), M = H(void 0), E = H(void 0), R = H({}), V = K(
    (D) => {
      e(D), l && l(D);
    },
    [e, l]
  ...
  }), [$]), P = B(() => Object.values(I).flat(), [I]), W = B(() => {
    if (!g.trim()) return I;
    const D = {
      [X.OT]: [],
      [X.NT]: [],
    ...
    const { isLetter: _, isDigit: L } = Wr(D.key);
    (_ || L) && (D.preventDefault(), x((U) => U + D.key), A.current.focus(), z(!1));
  }, []);
  return At(() => {
    const D = setTimeout(() => {
          ...
          v === "books" ? /* @__PURE__ */ p("div", { className: "tw-flex tw-items-end", children: [
            ...
            /* @__PURE__ */ r(
              j,
              {
                ...
                tabIndex: -1,
                children: c === "ltr" ? /* @__PURE__ */ r(vs, { className: "tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(xs, { className: "tw-h-4 tw-w-4" })
              }
            ),
...
), ht = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ro.Root, { ref: n, className: m("pr-twp", yl(), t), ...e }));
ht.displayName = Ro.Root.displayName;
...
function ir({
  ...
  const [k, C] = S(!1), z = c ?? w, F = (M) => M.length > 0 && typeof M[0] == "object" && "options" in M[0], A = (M, E) => {
  ...
  return /* @__PURE__ */ p(oe, { open: k, onOpenChange: C, ...y, children: [
    ...
    /* @__PURE__ */ r(
      Yt,
      {
        ...
        children: /* @__PURE__ */ p(ne, { children: [
          ...
          /* @__PURE__ */ r(re, { children: F(e) ? e.map((M) => /* @__PURE__ */ r(Ut, { heading: M.groupHeading, children: M.options.map((E) => A(E, M.groupHeading)) }, M.groupHeading)) : e.map((M) => A(M)) })
        ] })
      }
    )
  ] });
...
function Sp({
  ...
  const d = jn(c, "%webView_bookSelector_currentBook%"), f = jn(c, "%webView_bookSelector_choose%"), h = jn(c, "%webView_bookSelector_chooseBooks%"), [u, g] = S(
    "current book"
    /* CurrentBook */
  ), x = (v) => {
    g(v), t(v);
...
const aa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Cl = aa ? At : Y, un = { tag: br };
function El({ initialConfig: t, children: e }) {
  const n = B(() => {
    const { theme: o, namespace: a, nodes: s, onError: i, editorState: l, html: w } = t, c = _l(null, o), d = So({ editable: t.editable, html: w, namespace: a, nodes: s, onError: (f) => i(f, d), theme: o });
    return function(f, h) {
      if (h !== null) {
        if (h === void 0) f.update(() => {
          ...
          if (u.isEmpty()) {
            const g = Rn();
            u.append(g);
            const x = aa ? document.activeElement : null;
...
const Tl = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function Rl({ ignoreHistoryMergeTagChange: t = !0, ignoreSelectionChange: e = !1, onChange: n }) {
  const [o] = Xt();
  return Tl(() => {
...
const Cr = {
  ...
  {
    ref: o,
    className: e ? m(na({ variant: e }), t) : t,
    ...n
  }
));
...
function $l(t, e, n = "self") {
  const o = t.getStartEndPoints();
  if (e.isSelected(t) && !pi(e) && o !== null) {
    const [a, s] = o, i = t.isBackward(), l = a.getNode(), w = s.getNode(), c = e.is(l), d = e.is(w);
    if (c || d) {
      const [f, h] = ui(t), u = l.is(w), g = e.is(i ? w : l), x = e.is(i ? l : w);
      let v, N = 0;
      u ? (N = f > h ? h : f, v = f > h ? f : h) : g ? (N = i ? h : f, v = void 0) : x && (N = 0, v = i ? f : h);
      const y = e.__text.slice(N, v);
      y !== e.__text && (n === "clone" && (e = mi(e)), e.__text = y);
    }
  }
  return e;
}
...
const sa = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0, Vl = sa && "documentMode" in document ? document.documentMode : null;
!(!sa || !("InputEvent" in window) || Vl) && "getTargetRanges" in new window.InputEvent("input");
function jl(t) {
  const e = Oo(t, (n) => le(n) && !n.isInline());
  return le(e) || Ll(4, t.__key), e;
}
function zl(t) {
  const e = Vt();
  if (!ke(e)) return !1;
  ...
  for (let a = 0; a < o.length; a++) {
    ...
    if (n.has(i)) continue;
    const l = Oo(s, (c) => le(c) && !c.isInline());
    if (l === null) continue;
    const w = l.getKey();
...
function Gl(t) {
  ...
  la(this), Z = t, this.f &= -2, 8 & this.f && Tr(this), Dn();
}
function De(t, e) {
...
Nt.prototype.brand = Fl, Nt.prototype.h = function() {
  return !0;
  ...
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, wa(this), to(this), we++;
  const t = Z;
  return Z = this, Gl.bind(this, t);
...
function da(t, e = ca) {
  return t.registerCommand(Io, (n) => (t.update(e), !0), Ao);
}
...
const Fn = hi("format", { parse: (t) => typeof t == "number" ? t : 0 });
class pa extends tr {
  $config() {
...
qt({ name: "@lexical/extension/DecoratorText", nodes: () => [pa], register: (t, e, n) => t.registerCommand(Po, (o) => {
  const a = Vt();
  if ($o(a) || ke(a)) for (const s of a.getNodes()) ql(s) && s.toggleFormat(o);
  return !1;
}, Lo) });
function ua(t, e) {
  let n;
...
const cr = qt({ build: (t) => ua(() => t.getEditorState(), (e) => t.registerUpdateListener((n) => {
...
const Rr = 0, dr = 1, fa = 2, Bn = 3, mn = 4, Se = 5, Kn = 6, Ye = 7;
function Gn(t) {
  return t.id === Rr;
}
function ha(t) {
...
function Hl(t) {
  return function(e) {
    return e.id === dr;
  }(t) || et(305, String(t.id), String(dr)), Object.assign(t, { id: fa });
}
...
const Jl = qt({ config: ln({ setOptions: eo, updateOptions: eo }), init: ({ $initialEditorState: t = Wl }) => ({ $initialEditorState: t, initialized: !1 }), afterRegistration(t, { updateOptions: e, setOptions: n }, o) {
...
}, name: "@lexical/extension/InitialState", nodes: [gi, Mo, bi, vi, Do] }), no = Symbol.for("@lexical/extension/LexicalBuilder");
function ro() {
}
function Zl(t) {
  throw t;
...
class tn {
  ...
  constructEditor() {
    const { $initialEditorState: e, onError: n, ...o } = this.buildCreateEditorArgs(), a = Object.assign(So({ ...o, ...n ? { onError: (s) => {
      n(s, a);
    } } : {} }), { [no]: this });
  ...
  buildCreateEditorArgs() {
    ...
    for (const d of l) {
      const { extension: f } = d;
      if (f.onError !== void 0 && (e.onError = f.onError), f.disableEvents !== void 0 && (e.disableEvents = f.disableEvents), f.parentEditor !== void 0 && (e.parentEditor = f.parentEditor), f.editable !== void 0 && (e.editable = f.editable), f.namespace !== void 0 && (e.namespace = f.namespace), f.$initialEditorState !== void 0 && (e.$initialEditorState = f.$initialEditorState), f.nodes) for (const h of Ul(f)) {
        if (typeof h != "function") {
          const u = o.get(h.replace);
          u && et(302, f.name, h.replace.name, u.extension.name), o.set(h.replace, d);
        }
        n.add(h);
      }
      if (f.html) {
...
const Ql = /* @__PURE__ */ new Set(), oo = qt({ build(t, e, n) {
  const o = n.getDependency(cr).output, a = rn({ watchedNodeKeys: /* @__PURE__ */ new Map() }), s = ua(() => {
  }, () => pe(() => {
  ...
  return { watchNodeKey: function(i) {
    const l = Kl(() => (s.value || Ql).has(i)), { watchedNodeKeys: w } = a.peek();
    let c = w.get(i);
    const d = c !== void 0;
...
class Ae extends tr {
  ...
  static importDOM() {
    return { hr: () => ({ conversion: tw, priority: 0 }) };
  }
  exportDOM() {
...
qt({ dependencies: [cr, oo], name: "@lexical/extension/HorizontalRule", nodes: () => [Ae], register(t, e, n) {
  ...
  return de(t.registerCommand(Ni, (i) => {
    if (ki(i.target)) {
      const l = _i(i.target);
      if (ew(l)) return function(w, c = !1) {
        const d = Vt(), f = w.isSelected(), h = w.getKey();
        let u;
        c && $o(d) ? u = d : (u = Ci(), Ei(u)), f ? u.delete(h) : u.add(h);
      }(l, i.shiftKey), !0;
    }
    return !1;
  }, Lo), t.registerMutationListener(Ae, (i, l) => {
    Bl(() => {
      let w = !1;
...
function nw(t, e, n = ba) {
  return de(t.registerCommand(Ii, (o) => {
    const a = Vt();
    if (!ke(a)) return !1;
    o.preventDefault();
    const s = function(i) {
      if (i.getNodes().filter((h) => vn(h) && h.canIndent()).length > 0) return !0;
      const l = i.anchor, w = i.focus, c = w.isBefore(l) ? w : l, d = c.getNode(), f = jl(d);
      if (f.canIndent()) {
        const h = f.getKey();
        let u = Ai();
      ...
      return !1;
    }(a) ? o.shiftKey ? $i : qr : Li;
    return t.dispatchCommand(s, void 0);
  }, Ao), t.registerCommand(qr, () => {
...
qt({ build: (t, e, n) => Mn(e), config: ln({ $canIndent: ba, disabled: !1, maxIndent: null }), name: "@lexical/extension/TabIndentation", register(t, e, n) {
  const { disabled: o, maxIndent: a, $canIndent: s } = n.getOutput();
  return pe(() => {
    if (!o.value) return nw(t, a, s);
  });
} });
const rw = qt({ name: "@lexical/react/ReactProvider" });
function ow() {
...
qt({ build: (t, e, n) => Mn(e), config: ln({ disabled: typeof window > "u" }), name: "@lexical/dragon", register: (t, e, n) => pe(() => n.getOutput().disabled.value ? void 0 : xa(t)) });
function iw(t, ...e) {
  const n = new URL("https://lexical.dev/docs/error"), o = new URLSearchParams();
  o.append("code", t);
  for (const a of e) o.append("v", a);
  ...
  return function(n, o) {
    ...
    return Sr(() => n.registerDecoratorListener((i) => {
      ...
      for (let w = 0; w < l.length; w++) {
        const c = l[w], d = r(o, { onError: (h) => n._onError(h), children: r(bs, { fallback: null, children: a[c] }) }), f = n.getElementByKey(c);
        f !== null && i.push(Wi(d, f, c));
      }
      return i;
    }, [o, a, n]);
  }(t, e);
...
function ww({ editor: t, ErrorBoundary: e }) {
  return function(n) {
    ...
    if (o && o.hasExtensionByName(rw.name)) {
      for (const a of ["@lexical/plain-text", "@lexical/rich-text"]) o.hasExtensionByName(a) && iw(320, a);
      return !0;
    }
    return !1;
  }(t) ? null : r(lw, { editor: t, ErrorBoundary: e });
}
function ao(t) {
  return t.getEditorState().read(va(t.isComposing()));
}
function cw({ contentEditable: t, placeholder: e = null, ErrorBoundary: n }) {
  const [o] = Xt();
  return function(a) {
    Sr(() => de(Yi(a), xa(a)), [a]);
  }(o), p(lt, { children: [t, r(dw, { content: e }), r(ww, { editor: o, ErrorBoundary: n })] });
}
function dw({ content: t }) {
...
const uw = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function mw({ onClear: t }) {
  const [e] = Xt();
  return uw(() => da(e, t), [e, t]), null;
}
const ya = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? At : Y;
function fw({ editor: t, ariaActiveDescendant: e, ariaAutoComplete: n, ariaControls: o, ariaDescribedBy: a, ariaErrorMessage: s, ariaExpanded: i, ariaInvalid: l, ariaLabel: w, ariaLabelledBy: c, ariaMultiline: d, ariaOwns: f, ariaRequired: h, autoCapitalize: u, className: g, id: x, role: v = "textbox", spellCheck: N = !0, style: y, tabIndex: k, "data-testid": C, ...z }, F) {
...
function bw(t, e) {
  ...
  return p(lt, { children: [r(hw, { editor: a, ...o, ref: e }), n != null && r(vw, { editor: a, content: n })] });
}
function vw({ content: t, editor: e }) {
  const n = function(i) {
    const [l, w] = S(() => so(i));
    return ya(() => {
      function c() {
...
function kw({
  ...
  const [e] = Xt(), [n, o] = S(e), [a, s] = S("paragraph"), [i, l] = Nw(), w = () => {
  };
...
), Cw = b.forwardRef(({ className: t, variant: e, size: n, ...o }, a) => /* @__PURE__ */ r(
  Bo.Root,
  {
    ref: a,
    className: m(_a({ variant: e, size: n, className: t })),
    ...o
  }
));
Cw.displayName = Bo.Root.displayName;
...
function Rw({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-relative", children: [
    /* @__PURE__ */ r(kw, { children: () => /* @__PURE__ */ r("div", { className: "tw-sticky tw-top-0 tw-z-10 tw-flex tw-gap-2 tw-overflow-auto tw-border-b tw-p-1", children: /* @__PURE__ */ r(Ew, {}) }) }),
      ...
      /* @__PURE__ */ r(
        cw,
        {
          contentEditable: /* @__PURE__ */ r("div", { ref: (s) => {
            s !== void 0 && o(s);
          }, children: /* @__PURE__ */ r(xw, { placeholder: t }) }),
          ErrorBoundary: Ol
        }
      ),
      e && /* @__PURE__ */ r(pw, { defaultSelection: "rootEnd" }),
        ...
        children: /* @__PURE__ */ r(
          El,
          {
            ...
            children: /* @__PURE__ */ p(kt, { children: [
              /* @__PURE__ */ r(Rw, { placeholder: a, autoFocus: s, onClear: i }),
              /* @__PURE__ */ r(
                Rl,
                {
...
function Dw(t, e) {
  ...
  return function(s) {
    for (const i of s) i.getNextSibling() instanceof zo && i.insertAfter(Fo());
    for (const i of s) {
...
function Ea(t, e, n, o = null) {
  ...
  let i = e;
  o !== null && xn(e) && (i = $l(o, e, "clone"));
  const l = le(i) ? i.getChildren() : [], w = zi(t, i.getType());
  let c;
  ...
  for (let u = 0; u < l.length; u++) {
    const g = l[u], x = Ea(t, g, h, o);
    !a && le(e) && x && e.extractWithChild(g, o, "html") && (a = !0);
  }
  if (a && !s) {
    if ((Fi(d) || Hr(d)) && d.append(h), n.append(d), f) {
      const u = f.call(i, d);
...
function Ra(t, e, n, o, a = /* @__PURE__ */ new Map(), s) {
  ...
  let h = [];
  const u = (l == null || !Ki(l)) && (l != null && vn(l) || o);
  for (let g = 0; g < f.length; g++) h.push(...Ra(f[g], e, n, u, new Map(a), l));
  return d != null && (h = d(h)), Yr(t) && (h = Ow(t, h, u ? () => {
    const g = new zo();
    return n.push(g), g;
  ...
  }(t) && (i = i.concat(Fo())) : le(l) && l.append(...h), i;
}
function Ow(t, e, n) {
...
function Dp({
  ...
  const [a, s] = S(Aw), [i, l] = S(void 0), [w, c] = S(!1), d = H(void 0), f = H(null);
  Y(() => {
    let N = !0;
    const y = f.current;
    if (!y) return;
  ...
  return /* @__PURE__ */ p("div", { className: "pr-twp tw-grid tw-gap-3", children: [
    /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-justify-between", children: [
      ...
      /* @__PURE__ */ p("div", { className: "tw-flex tw-gap-2", children: [
        /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
          /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(j, { onClick: n, className: "tw-h-6 tw-w-6", size: "icon", variant: "secondary", children: /* @__PURE__ */ r(je, {}) }) }),
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        onKeyDownCapture: (N) => {
          N.key === "Escape" ? (N.preventDefault(), N.stopPropagation(), n()) : Or(N) && (N.preventDefault(), N.stopPropagation(), Lt(a) && h());
        },
        onKeyDown: (N) => {
...
const Fw = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: m("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
$e.displayName = Go.Root.displayName;
...
Kw.displayName = Be.Image.displayName;
...
Aa.displayName = Be.Fallback.displayName;
const Ir = En(void 0);
function Ft() {
  const t = gr(Ir);
  if (!t)
...
}), Ce = nt.Trigger, Pa = nt.Group, Gw = nt.Portal, Uw = nt.Sub, qw = nt.RadioGroup;
...
const $a = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    nt.SubTrigger,
    {
...
$a.displayName = nt.SubTrigger.displayName;
...
La.displayName = nt.SubContent.displayName;
...
function lo({
  ...
  const u = K(
    ...
    [t.user]
  ), y = B(() => oi(t.contents), [t.contents]), k = B(() => {
    if (o && l)
      return /* @__PURE__ */ p(lt, { children: [
        /* @__PURE__ */ p(
          _n,
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r(Ia, { className: "tw-h-8 tw-w-8", children: /* @__PURE__ */ r(Aa, { className: "tw-text-xs tw-font-medium", children: N }) }),
        /* @__PURE__ */ p("div", { className: "tw-flex tw-flex-1 tw-flex-col tw-gap-2", children: [
          ...
          w && /* @__PURE__ */ p(
            "div",
            {
              ...
              ref: h,
              onKeyDownCapture: (C) => {
                C.key === "Escape" ? (C.preventDefault(), C.stopPropagation(), u()) : Or(C) && (C.preventDefault(), C.stopPropagation(), Lt(d) && g());
              },
              onKeyDown: (C) => {
        ...
        k && /* @__PURE__ */ p(ue, { children: [
          /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Cs, {}) }) }),
...
function Yw({
  ...
  const [A, M] = S(wo), [E, R] = S(
    void 0
  ), V = o, [$, I] = S(!1), [P, W] = S(!1), [O, J] = S(!1), [St, Pt] = S(!1), [Ot, gt] = S(!1), [pt, G] = S(C), [at, st] = S(!1), wt = H(void 0), [xt, Wt] = S(/* @__PURE__ */ new Map());
  Y(() => {
    let T = !0;
    return (async () => {
          ...
          /* @__PURE__ */ p("div", { className: "tw-flex tw-items-center tw-gap-2", children: [
            ...
            /* @__PURE__ */ r(
              j,
              {
                ...
                children: pt ? /* @__PURE__ */ r(Es, {}) : /* @__PURE__ */ r(Ts, {})
              }
            ),
            Ot && d !== "Resolved" && /* @__PURE__ */ r(
              j,
              {
                variant: "ghost",
                size: "icon",
          ...
          o && /* @__PURE__ */ p(lt, { children: [
            ...
            v !== !1 && (!P || Lt(A)) && /* @__PURE__ */ p(
              "div",
              {
                ...
                onKeyDownCapture: (T) => {
                  Or(T) && (T.preventDefault(), T.stopPropagation(), (Lt(A) || E !== void 0) && Dt());
                },
                onKeyDown: (T) => {
...
function Ip({
  ...
  const z = n.filter(
    ...
    (I) => {
      y((P) => new Set(P).add(I.id)), C(I.id), x == null || x(I.id);
    },
    [x]
  ), M = K(
    (I) => {
    ...
    [N, x]
  ), { listboxRef: E, activeId: R, handleKeyDown: V } = Lw({
    options: F,
    onOptionSelect: A
  }), $ = K(
    (I) => {
      I.key === "Escape" ? (k && N.has(k) && (y((P) => {
        const W = new Set(P);
        return W.delete(k), W;
...
function Xw({ table: t }) {
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Zi, { asChild: !0, children: /* @__PURE__ */ p(j, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
      /* @__PURE__ */ r(Rs, { className: "tw-mr-2 tw-h-4 tw-w-4" }),
      "View"
    ] }) }),
...
const Le = dt.Root, Ww = dt.Group, Ve = dt.Value, Jw = me(
  ...
  return /* @__PURE__ */ p(
    dt.Trigger,
    {
      className: m(Jw({ size: n, className: t })),
      ref: a,
      ...o,
      dir: s,
      children: [
...
const ja = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  dt.ScrollUpButton,
  {
    ...
    ...e,
    children: /* @__PURE__ */ r(No, { className: "tw-h-4 tw-w-4" })
  }
));
ja.displayName = dt.ScrollUpButton.displayName;
...
za.displayName = dt.ScrollDownButton.displayName;
...
Zw.displayName = dt.Label.displayName;
...
It.displayName = dt.Item.displayName;
      ...
      /* @__PURE__ */ p(
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Te, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(It, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function ic({
  ...
  var F;
  const [d, f] = S([]), [h, u] = S([]), [g, x] = S({}), [v, N] = S({}), y = B(() => e ?? [], [e]), k = Uo({
    data: y,
    columns: t,
    getCoreRowModel: Ho(),
  ...
  let z;
  return w ? z = Array.from({ length: 10 }).map((E, R) => `skeleton-row-${R}`).map((E) => /* @__PURE__ */ r(Qt, { className: "hover:tw-bg-transparent", children: /* @__PURE__ */ r(Ne, { colSpan: C.length ?? t.length, className: "tw-border-0 tw-p-0", children: /* @__PURE__ */ r("div", { className: "tw-w-full tw-py-2", children: /* @__PURE__ */ r(pr, { className: "tw-h-14 tw-w-full tw-rounded-md" }) }) }) }, E)) : ((F = k.getRowModel().rows) == null ? void 0 : F.length) > 0 ? z = k.getRowModel().rows.map((A) => /* @__PURE__ */ r(
    Qt,
    {
      onClick: () => i(A, k),
    ...
    /* @__PURE__ */ p(On, { stickyHeader: s, children: [
      /* @__PURE__ */ r(In, { stickyHeader: s, children: k.getHeaderGroups().map((A) => /* @__PURE__ */ r(Qt, { children: A.headers.map((M) => /* @__PURE__ */ r(an, { className: "tw-p-0", children: M.isPlaceholder ? void 0 : Ze(M.column.columnDef.header, M.getContext()) }, M.id)) }, A.id)) }),
      /* @__PURE__ */ r(An, { children: z })
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ p("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(j, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(ko, {}) })
        ] }),
...
function $p({
  ...
  return /* @__PURE__ */ p(oe, { onOpenChange: (d) => {
    ...
    /* @__PURE__ */ p(Yt, { id: s, className: m("tw-min-w-80 tw-max-w-96", a), children: [
...
function Lp({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ p(j, { variant: "default", children: [
    ...
    /* @__PURE__ */ r(ee, { children: n.map((c, d) => /* @__PURE__ */ p("div", { children: [
      ...
      /* @__PURE__ */ r(Pa, { children: c.itemType === 0 ? /* @__PURE__ */ r(lt, { children: c.items.map((f, h) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(
        te,
        {
          checked: o[d][h],
        ...
        qw,
        {
          ...
          children: c.items.map((f) => /* @__PURE__ */ r("div", { children: /* @__PURE__ */ r(Va, { value: f.id, children: f.label }) }, f.id))
        }
      ) }),
      /* @__PURE__ */ r(Ue, {})
    ] }, c.label)) })
...
function jp({
  ...
  const i = B(() => si(n), [n]), w = ((c) => {
    const d = new Intl.DisplayNames(ii(), { type: "language" });
...
function pc({
  ...
  const [N, y] = S(!1), k = K(
    (R) => {
      var $;
      const V = ($ = t.find((I) => I.label === R)) == null ? void 0 : $.value;
      V && n(
    ...
    if (!h) return t;
    const R = t.filter(($) => $.starred).sort(($, I) => $.label.localeCompare(I.label)), V = t.filter(($) => !$.starred).sort(($, I) => {
      const P = e.includes($.value), W = e.includes(I.value);
      return P && !W ? -1 : !P && W ? 1 : $.label.localeCompare(I.label);
    });
    return [...R, ...V];
  }, [t, e, h]), F = () => {
    n(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ r("div", { id: v, className: g, children: /* @__PURE__ */ p(oe, { open: M, onOpenChange: d ?? y, children: [
    /* @__PURE__ */ r(fe, { asChild: !0, children: /* @__PURE__ */ p(
      j,
      {
        variant: x,
    ...
    /* @__PURE__ */ r(Yt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ p(ne, { children: [
      ...
      a && /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: F, children: s }),
        /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: A, children: i })
      ] }),
      /* @__PURE__ */ p(re, { children: [
        /* @__PURE__ */ r(wn, { children: l }),
        /* @__PURE__ */ r(Ut, { children: z.map((R) => /* @__PURE__ */ p(
          Ht,
          {
            value: R.label,
            onSelect: k,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ r(Ls, { className: "tw-h-4 tw-w-4" }),
...
const hc = (t, e, n) => t === "generated" ? /* @__PURE__ */ p(lt, { children: [
...
function gc({
  ...
  return /* @__PURE__ */ p(ue, { open: h, onOpenChange: g, children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: hc(t, a, n) }) }) }),
...
const bc = (t, e) => t === "f" ? /* @__PURE__ */ p(lt, { children: [
  /* @__PURE__ */ r(Eo, {}),
  " ",
...
function xc({
  ...
  return /* @__PURE__ */ p(ue, { children: [
    /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Ui, { asChild: !0, children: /* @__PURE__ */ r(Ce, { asChild: !0, children: /* @__PURE__ */ r(j, { variant: "outline", className: "tw-h-6", children: bc(t, n) }) }) }),
      /* @__PURE__ */ r(_t, { children: /* @__PURE__ */ r("p", { children: vc(t, n) }) })
    ] }) }),
    /* @__PURE__ */ p(ee, { style: { zIndex: ra }, children: [
...
function Nc({ icon: t, className: e }) {
  return /* @__PURE__ */ r(t ?? zs, { className: e, size: 16 });
}
function mo({
  item: t,
  localizedStrings: e
...
function Fp({
  ...
  const [g, x] = S("generated"), [v, N] = S("*"), [y, k] = S("f"), [C, z] = S(!1), [F, A] = S(!0), [M, E] = S(!1), R = H(!1), V = H(""), [$, I] = S(!1), [P, W] = S(), [O, J] = S(), [St, Pt] = S(), [Ot, gt] = S(), pt = H(null), G = B(
    () => ({
      ...i,
      markerMenuTrigger: l,
      hasExternalUI: !0,
  ...
  const Bt = () => {
    ...
    if (L && pn("note", L)) {
      ...
      y !== "x" && _ === "x" ? ct == null || ct.forEach((Dt) => Cc(Dt)) : y === "x" && _ !== "x" && (ct == null || ct.forEach((Dt) => Ec(Dt))), (bt = d.current) == null || bt.applyUpdate([L, { delete: 1 }]);
    }
  }, Zt = (_) => {
    ...
    if (h.current && at.length && _ && _.rangeCount > 0) {
      ...
      W(L.left - U.left), J(L.top - U.top), Pt(L.height), I(!0);
    }
  }, [at, h]);
  return Y(() => {
    const _ = () => {
    ...
    const _ = ((U = f.current) == null ? void 0 : U.querySelector(".editor-input")) ?? void 0, L = (q) => {
      !$ && _ && document.activeElement === _ && q.key === l ? (q.preventDefault(), D()) : $ && q.key === "Escape" && (q.preventDefault(), I(!1));
    };
    ...
    /* @__PURE__ */ p("div", { ref: u, className: "footnote-editor tw-grid tw-gap-[12px]", children: [
      /* @__PURE__ */ p("div", { className: "tw-flex", children: [
        ...
        /* @__PURE__ */ p("div", { className: "tw-flex tw-w-full tw-justify-end tw-gap-4", children: [
          ...
          /* @__PURE__ */ r(kt, { children: /* @__PURE__ */ p(Ct, { children: [
            /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(j, { onClick: o, className: "tw-h-6 tw-w-6", size: "icon", variant: "ghost", children: /* @__PURE__ */ r(je, {}) }) }),
      ...
      /* @__PURE__ */ p(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ r("div", { className: t, children: /* @__PURE__ */ r(fc, { editorRef: d, children: /* @__PURE__ */ r(
              al,
              {
                options: G,
                onStateChange: Zt,
  ...
  return /* @__PURE__ */ p(lt, { children: [
    ...
    /* @__PURE__ */ r(
      "div",
      {
        ...
        children: l && l.length > 0 && /* @__PURE__ */ r(lt, { children: Rc(t.marker, l, o, c) })
      }
    )
  ] });
}
function Kp({
  ...
  const d = w ?? li(n, void 0), f = (y, k) => {
    c == null || c(y, k, a);
  }, h = s ? n.findIndex((y) => y === s) : -1, [u, g] = S(h), x = (y, k, C) => {
    if (n.length)
      switch (y.key) {
        case "Enter":
        case " ":
...
function Oc({
  ...
  return /* @__PURE__ */ p(On, { stickyHeader: !0, children: [
    /* @__PURE__ */ r(In, { stickyHeader: !0, children: /* @__PURE__ */ p(Qt, { children: [
    ...
    /* @__PURE__ */ r(An, { children: i.length > 0 && i.map((l) => /* @__PURE__ */ p(
      Qt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ne, { className: o, children: Mc(l.text) })
        ]
      },
...
const Ic = (t) => {
  ...
  if (t === "desc")
    return /* @__PURE__ */ r(Us, { className: "tw-h-4 tw-w-4" });
  ...
  return e ? e[1] : "";
}, Pc = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Wp = Object.freeze([
...
function Jp({
  ...
  const u = Kt(n, "%webView_inventory_all%"), g = Kt(n, "%webView_inventory_approved%"), x = Kt(n, "%webView_inventory_unapproved%"), v = Kt(n, "%webView_inventory_unknown%"), N = Kt(n, "%webView_inventory_scope_currentBook%"), y = Kt(n, "%webView_inventory_scope_chapter%"), k = Kt(n, "%webView_inventory_scope_verse%"), C = Kt(n, "%webView_inventory_filter_text%"), z = Kt(
    n,
    "%webView_inventory_show_additional_items%"
  ), F = Kt(n, "%webView_inventory_no_results%"), [A, M] = S(!1), [E, R] = S("all"), [V, $] = S(""), [I, P] = S([]), W = B(() => {
    const G = t ?? [];
  ...
  }, [A, W]), J = B(() => O.length === 0 ? [] : $c(O, E, V), [O, E, V]), St = B(() => {
    var st, wt;
    if (!A) return w;
        ...
        Le,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ p(Te, { children: [
              ...
              /* @__PURE__ */ r(It, { value: "unapproved", children: x }),
              /* @__PURE__ */ r(It, { value: "unknown", children: v })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ p(Le, { onValueChange: (G) => Ot(G), defaultValue: i, children: [
        /* @__PURE__ */ r(Ee, { className: "tw-m-1 tw-w-auto tw-flex-1", children: /* @__PURE__ */ r(Ve, { placeholder: "Select scope" }) }),
        /* @__PURE__ */ p(Te, { children: [
          /* @__PURE__ */ r(It, { value: "book", children: N }),
...
const Vc = "16rem", jc = "3rem", Ba = b.createContext(void 0);
function $n() {
  const t = b.useContext(Ba);
  if (!t)
...
const Ka = b.forwardRef(
  ({
    ...
    const [c, d] = b.useState(t), f = e ?? c, h = b.useCallback(
      ...
      [n, f]
    ), u = b.useCallback(() => h((k) => !k), [h]), g = f ? "expanded" : "collapsed", N = mt() === "ltr" ? i : i === "primary" ? "secondary" : "primary", y = b.useMemo(
      () => ({
        state: g,
        open: f,
        setOpen: h,
    ...
    return /* @__PURE__ */ r(Ba.Provider, { value: y, children: /* @__PURE__ */ r(kt, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
...
const zc = b.forwardRef(({ className: t, onClick: e, ...n }, o) => {
  const a = $n();
  return /* @__PURE__ */ p(
    j,
    {
      ...
      ...n,
      children: [
        a.side === "primary" ? /* @__PURE__ */ r(qs, {}) : /* @__PURE__ */ r(Hs, {}),
...
const qc = b.forwardRef(({ className: t, asChild: e = !1, ...n }, o) => /* @__PURE__ */ r(
  e ? Fe : "button",
  {
    ref: o,
  ...
  ({
    ...
    const w = t ? Fe : "button", { state: c } = $n(), d = /* @__PURE__ */ r(
      w,
      {
        ...
        "data-size": o,
        "data-active": e,
        className: m(Hc({ variant: n, size: o }), s),
        ...i
      }
    );
...
const Wc = b.forwardRef(({ className: t, showIcon: e = !1, ...n }, o) => {
    ...
    Ga,
    {
      ...
      children: /* @__PURE__ */ p(qa, { children: [
        /* @__PURE__ */ p(ur, { children: [
          ...
          /* @__PURE__ */ r(fr, { children: /* @__PURE__ */ r(Ha, { children: Object.entries(e).map(([h, u]) => /* @__PURE__ */ r(Ya, { children: /* @__PURE__ */ r(
            Xa,
            {
              onClick: () => c(h),
              isActive: f(h),
    ...
    /* @__PURE__ */ p(
      Ka,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ua, { className: "tw-min-w-[215px]", children: o })
        ]
      }
    )
  ] });
}
const ie = "scrBook", ed = "scrRef", be = "source", nd = "details", rd = "Scripture Reference", od = "Scripture Book", Wa = "Type", ad = "Details";
function sd(t, e) {
  const n = e ?? !1;
  return [
    {
    ...
    },
    {
      ...
      id: be,
      header: n ? (t == null ? void 0 : t.typeColumnName) ?? Wa : void 0,
...
}, fo = (t) => `${id({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function Qp({
  sources: t,
  ...
  const [c, d] = S([]), [f, h] = S([{ id: ie, desc: !1 }]), [u, g] = S({}), x = B(
  ...
  }, A = (E, R) => E.getIsGrouped() ? "" : m("banded-row", R % 2 === 0 ? "even" : "odd"), M = (E, R, V) => {
    ...
    !e && /* @__PURE__ */ p(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Te, { position: "item-aligned", children: /* @__PURE__ */ r(Ww, { children: C.map((E) => /* @__PURE__ */ r(It, { value: JSON.stringify(E.value), children: E.label }, E.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ p(On, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(In, { children: N.getHeaderGroups().map((E) => /* @__PURE__ */ r(Qt, { children: E.headers.filter((R) => R.column.columnDef.header).map((R) => (
                    ...
                    children: $.getIsGrouped() ? /* @__PURE__ */ p(
                      j,
                      {
                        ...
                        children: [
                          ...
                          !E.getIsExpanded() && (V === "ltr" ? /* @__PURE__ */ r(Oe, {}) : /* @__PURE__ */ r(Jn, {})),
                          " ",
...
}), Ja = (t, e, n) => Lr(t, e).every((o) => n.includes(o));
function ld({
  section: t,
  availableBookIds: e,
  selectedBookIds: n,
  ...
  return /* @__PURE__ */ r(
    j,
    {
      ...
      onClick: () => o(t),
      className: m(
        Ja(e, t, n) && !s && "tw-bg-primary tw-text-primary-foreground hover:tw-bg-primary/70 hover:tw-text-primary-foreground"
      ),
      disabled: s,
      children: ml(
        t,
...
function wd({
  ...
  const s = o["%webView_book_selector_books_selected%"], i = o["%webView_book_selector_select_books%"], l = o["%webView_book_selector_search_books%"], w = o["%webView_book_selector_select_all%"], c = o["%webView_book_selector_clear_all%"], d = o["%webView_book_selector_no_book_found%"], f = o["%webView_book_selector_more%"], { otLong: h, ntLong: u, dcLong: g, extraLong: x } = {
  ...
  const F = B(() => ut.allBookIds.filter(
    ...
    (P, W = !1) => {
      ...
      const O = F.findIndex((gt) => gt === C.current), J = F.findIndex((gt) => gt === P);
      if (O === -1 || J === -1) return;
      const [St, Pt] = [
        Math.min(O, J),
        Math.max(O, J)
      ], Ot = F.slice(St, Pt + 1).map((gt) => gt);
      n(
        e.includes(P) ? e.filter((gt) => !Ot.includes(gt)) : [.../* @__PURE__ */ new Set([...e, ...Ot])]
      );
    },
    [e, n, F]
  ), E = (P) => {
    M(P, z.current), z.current = !1;
  }, R = (P, W) => {
    P.preventDefault(), M(W, P.shiftKey);
  }, V = K(
    (P) => {
      const W = Lr(F, P).map((O) => O);
      n(
        Ja(F, P, e) ? e.filter((O) => !W.includes(O)) : [.../* @__PURE__ */ new Set([...e, ...W])]
      );
    },
    [e, n, F]
  ), $ = () => {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Yt, { className: "tw-w-full tw-p-0", align: "start", children: /* @__PURE__ */ p(
            ne,
            {
              shouldFilter: !1,
              onKeyDown: (P) => {
                P.key === "Enter" && (z.current = P.shiftKey);
              },
              children: [
                /* @__PURE__ */ r(
                  Ke,
                ...
                /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: $, children: w }),
                  /* @__PURE__ */ r(j, { variant: "ghost", size: "sm", onClick: I, children: c })
                ] }),
                /* @__PURE__ */ p(re, { children: [
...
function nu({
  ...
  return /* @__PURE__ */ p(
    Le,
    {
      ...
      children: [
        /* @__PURE__ */ r(Ee, { size: a, className: m("pr-twp tw-w-auto", s), children: /* @__PURE__ */ r(
          Ve,
          {
            placeholder: l[Q(e)] ?? e
          }
        ...
        /* @__PURE__ */ r(
          Te,
          {
            ...
            style: { zIndex: Ge },
            children: t.map((c) => /* @__PURE__ */ r(It, { value: `${c}`, children: l[Q(c)] }, `${c}`))
          }
        )
      ]
    }
...
const Qa = (t, e, n, o) => n ? Object.entries(t).filter(
  ...
  /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in l ? /* @__PURE__ */ p(
    ...
    /* @__PURE__ */ r($a, { children: l.label }),
    /* @__PURE__ */ r(Gw, { children: /* @__PURE__ */ r(La, { children: Qa(
      t,
      e,
      Za(t, l.id),
      o
...
function hr({
  ...
  return /* @__PURE__ */ p(ue, { variant: s, children: [
    /* @__PURE__ */ r(Ce, { "aria-label": n, className: a, asChild: !0, id: l, children: /* @__PURE__ */ r(j, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(Xs, {}) }) }),
    /* @__PURE__ */ r(ee, { align: "start", style: { zIndex: Ge }, children: Object.entries(e.columns).filter(([, w]) => typeof w == "object").sort(([, w], [, c]) => typeof w == "boolean" || typeof c == "boolean" ? 0 : w.order - c.order).map(([w], c, d) => /* @__PURE__ */ p(bo, { children: [
      /* @__PURE__ */ r(Pa, { children: /* @__PURE__ */ r(kt, { children: Qa(e.groups, e.items, w, t) }) }),
...
function su({
  ...
  return /* @__PURE__ */ p(ts, { className: `tw-w-full tw-border ${s}`, id: a, children: [
    n && /* @__PURE__ */ r(
      hr,
      {
        onSelectMenuItem: t,
...
function iu({
  ...
  return /* @__PURE__ */ r(ts, { className: "tw-pointer-events-none", id: n, children: e && /* @__PURE__ */ r(
    hr,
    {
      onSelectMenuItem: t,
      menuData: e,
...
ns.displayName = Rt.List.displayName;
...
)), rs = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  Rt.Content,
  {
    ref: n,
    className: m(
...
function lu({
  ...
  return /* @__PURE__ */ p("div", { id: i, className: "pr-twp", children: [
    ...
    /* @__PURE__ */ p(es, { children: [
      /* @__PURE__ */ r(ns, { children: t.map((l) => /* @__PURE__ */ r(cd, { value: l.value, children: l.value }, l.key)) }),
      t.map((l) => /* @__PURE__ */ r(rs, { value: l.value, children: l.content }, l.key))
    ] })
  ] });
}
function dd({ ...t }) {
...
const os = b.forwardRef(({ className: t, variant: e = "default", ...n }, o) => {
  const a = b.useMemo(
    () => ({
      variant: e
    }),
...
os.displayName = rt.Root.displayName;
...
as.displayName = rt.Trigger.displayName;
const ss = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.SubTrigger,
    {
...
ss.displayName = rt.SubTrigger.displayName;
...
is.displayName = rt.SubContent.displayName;
const ls = b.forwardRef(({ className: t, align: e = "start", alignOffset: n = -4, sideOffset: o = 8, ...a }, s) => {
  const i = Ft();
...
ls.displayName = rt.Content.displayName;
const ws = b.forwardRef(({ className: t, inset: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ r(
    rt.Item,
    {
...
ws.displayName = rt.Item.displayName;
const ud = b.forwardRef(({ className: t, children: e, checked: n, ...o }, a) => {
  const s = Ft();
  return /* @__PURE__ */ p(
    rt.CheckboxItem,
    {
...
ud.displayName = rt.CheckboxItem.displayName;
const md = b.forwardRef(({ className: t, children: e, ...n }, o) => {
  const a = Ft();
  return /* @__PURE__ */ p(
    rt.RadioItem,
    {
...
fd.displayName = rt.Label.displayName;
  ...
  return a.flatMap(([s], i) => {
    const l = e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: "command" in c ? /* @__PURE__ */ p(
        ...
        /* @__PURE__ */ r(ss, { children: c.label }),
        /* @__PURE__ */ r(is, { children: ds(
          t,
          e,
          Za(t, c.id),
          o
    ...
    return l.length > 0 && i < a.length - 1 && w.push(/* @__PURE__ */ r(cs, {}, `separator-${s}`)), w;
  });
};
function hd({
  menuData: t,
  ...
  if (sl(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (d, f) => {
    var g, x, v, N;
    d.preventDefault();
    ...
    switch (f.hotkey) {
      ...
      case "alt+n":
        ...
        break;
      case "alt+h":
        (N = w.current) == null || N.focus(), Xe(w, [h, u]);
        break;
    }
  }), Y(() => {
    ...
    return /* @__PURE__ */ r(os, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, d]) => typeof d == "object").sort(([, d], [, f]) => typeof d == "boolean" || typeof f == "boolean" ? 0 : d.order - f.order).map(([d, f]) => /* @__PURE__ */ p(dd, { children: [
      /* @__PURE__ */ r(as, { ref: c(d), children: typeof f == "object" && "label" in f && f.label }),
      /* @__PURE__ */ r(
        ls,
        {
          style: { zIndex: Ge },
          children: /* @__PURE__ */ r(kt, { children: ds(t.groups, t.items, d, e) })
        }
      )
    ] }, d)) });
}
...
function du({
  ...
  const c = gd(
    ...
    return v ? `${(z = t[g]) == null ? void 0 : z.autonym} (${v})` : (F = t[g]) == null ? void 0 : F.autonym;
  };
...
function vd({
  ...
  return /* @__PURE__ */ p("div", { className: "tw-overflow-hidden tw-truncate tw-p-1 tw-text-start tw-leading-none", children: [
    /* @__PURE__ */ p(
      j,
      {
        variant: "link",
        ...
        children: [
          /* @__PURE__ */ r("span", { className: m({ "tw-me-2": i === "allText" }), children: e ? ci(t, e, s) : di(t, s) }),
          i === "allText" && go(n, o)
        ]
      }
    ),
...
function uu({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      onDoubleClick: u,
      onKeyDown: (y) => {
        document.activeElement === (v == null ? void 0 : v.current) && (y.key === "Enter" || y.key === " ") && (y.preventDefault(), n == null || n());
      },
      ref: v,
      role: "button",
      tabIndex: 0,
      ...
      children: [
        /* @__PURE__ */ p("div", { className: m("tw-flex tw-flex-col tw-px-4 tw-py-3", { "tw-pb-4": e }), children: [
          /* @__PURE__ */ p("div", { className: "tw-flex tw-justify-between tw-overflow-hidden", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ r(
                    vd,
                    {
                      startRef: g == null ? void 0 : g.startRef,
                      endRef: g == null ? void 0 : g.endRef,
                      scriptureTextPart: g.scriptureTextPart,
                      scrRefFormattingOptions: g.scrRefFormattingOptions,
                      onClick: (y) => {
                        y == null || y.stopPropagation(), n(), u == null || u();
                      },
                      className: "tw-whitespace-normal tw-rounded-sm tw-text-xs tw-font-medium"
                    }
                  ),
                  x && /* @__PURE__ */ r("div", { className: "tw-flex tw-gap-2 tw-whitespace-normal tw-break-words", children: x }),
                  i && /* @__PURE__ */ r(
                    "div",
                    {
                      className: m(
            ...
            !e && h && c && /* @__PURE__ */ r("div", { className: "tw-invisible group-hover:tw-visible", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: m(f && "tw-me-1"), asChild: !0, children: /* @__PURE__ */ r(j, { className: "tw-m-1 tw-h-6 tw-w-6", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] }) }),
            e && c && /* @__PURE__ */ r("div", { className: "tw-p-1", children: /* @__PURE__ */ p(ue, { children: [
              /* @__PURE__ */ r(Ce, { className: f, asChild: !0, children: /* @__PURE__ */ r(j, { className: "tw-h-6 tw-w-8", variant: "ghost", size: "icon", children: /* @__PURE__ */ r(Kr, {}) }) }),
              /* @__PURE__ */ r(ee, { align: "end", children: c })
            ] }) })
          ] }),
          e && d && /* @__PURE__ */ r("div", { className: "tw-ms-1 tw-w-fit tw-min-w-0 tw-max-w-full tw-overflow-hidden tw-break-words", children: d })
        ] }),
        f && /* @__PURE__ */ r(
          "div",
          {
...
const xd = sn(({ className: t, ...e }, n) => /* @__PURE__ */ r(Zs, { size: 35, className: m("tw-animate-spin", t), ...e, ref: n }));
...
const _d = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("div", { ref: n, className: m("tw-text-sm [&_p]:tw-leading-relaxed", t), ...e }));
_d.displayName = "AlertDescription";
const fu = ot.Root, hu = ot.Trigger, gu = ot.Group, bu = ot.Portal, vu = ot.Sub, xu = ot.RadioGroup, Cd = b.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ p(
  ot.SubTrigger,
  {
    ref: a,
    className: m(
...
Cd.displayName = ot.SubTrigger.displayName;
...
Ed.displayName = ot.SubContent.displayName;
const Td = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: n,
    className: m(
...
Td.displayName = ot.Content.displayName;
...
Rd.displayName = ot.Item.displayName;
...
Sd.displayName = ot.CheckboxItem.displayName;
...
Md.displayName = ot.Label.displayName;
...
Od.displayName = ot.Separator.displayName;
...
function Ad({
  ...
  return /* @__PURE__ */ r(ps.Provider, { value: o, children: /* @__PURE__ */ r(
    zt.Root,
    {
...
const yu = zt.Trigger, Pd = zt.Portal, Nu = zt.Close, us = b.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  zt.Overlay,
  {
    ref: n,
...
us.displayName = zt.Overlay.displayName;
const $d = b.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = b.useContext(ps), i = {
...
jd.displayName = zt.Title.displayName;
...
zd.displayName = zt.Description.displayName;
...
Fd.displayName = or.Root.displayName;
function ku({
  className: t,
  ...e
}) {
...
function Cu({
  ...
  return /* @__PURE__ */ r(
    xr.PanelResizeHandle,
    {
      ...
      ...n,
      children: t && /* @__PURE__ */ r("div", { className: "tw-z-10 tw-flex tw-h-4 tw-w-3 tw-items-center tw-justify-center tw-rounded-sm tw-border tw-bg-border", children: /* @__PURE__ */ r(Qs, { className: "tw-h-2.5 tw-w-2.5" }) })
    }
  );
}
function Eu({ ...t }) {
...
Bd.displayName = We.Root.displayName;
...
Kd.displayName = ar.Root.displayName;
const Tu = Rt.Root, Gd = b.forwardRef(({ className: t, ...e }, n) => {
  const o = mt();
  return /* @__PURE__ */ r(
    Rt.List,
    {
...
Ud.displayName = Rt.Trigger.displayName;
...
qd.displayName = Rt.Content.displayName;
...
export {
  ...
  ra as Z_INDEX_FOOTNOTE_EDITOR,
  _p as Z_INDEX_MODAL,
  kp as Z_INDEX_MODAL_BACKDROP,
  fl as Z_INDEX_OVERLAY,
  Vw as badgeVariants,
