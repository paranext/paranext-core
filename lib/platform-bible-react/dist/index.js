...
const ep = "16rem", rp = "3rem", ms = Bt.createContext(void 0);
function Fa() {
  const t = Bt.useContext(ms);
  if (!t)
...
function ap({
  ...
  const [d, l] = Bt.useState(t), w = e ?? d, p = Bt.useCallback(
    ...
    "--sidebar-width": ep,
    "--sidebar-width-icon": rp,
    ...n
  };
  return /* @__PURE__ */ a(ms.Provider, { value: C, children: /* @__PURE__ */ a(
    "div",
    {
...
function dp({
  ...
  const c = t ? ea.Root : "button", { state: d } = Fa(), l = /* @__PURE__ */ a(
    c,
    {
      ...
      "data-size": o,
      "data-active": e,
      className: v(lp({ variant: r, size: o }), s),
      ...i
    }
  );
...
function wp({
  ...
  return /* @__PURE__ */ a(
    op,
    {
      ...
      children: /* @__PURE__ */ u(ip, { children: [
        /* @__PURE__ */ u(Fn, { children: [
          /* @__PURE__ */ a(jn, { className: "tw:text-sm", children: s }),
          /* @__PURE__ */ a(Un, { children: /* @__PURE__ */ a(sp, { children: Object.entries(e).map(([g, C]) => /* @__PURE__ */ a(cp, { children: /* @__PURE__ */ a(
            dp,
            {
              onClick: () => p(g),
              isActive: b(g),
    ...
    /* @__PURE__ */ u(
      ap,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(np, { className: "tw:min-w-[215px]", children: e })
        ]
      }
    )
  ] });
}
const He = "scrBook", up = "scrRef", nr = "source", pp = "details", hp = "Scripture Reference", gp = "Scripture Book", vs = "Type", fp = "Details";
function mp(t, e) {
  const r = e ?? !1;
  return [
    {
...
}, Kn = (t) => `${vp({ start: t.start, end: t.end })} ${t.source.displayName} ${t.detail}`;
function _g({
  sources: t,
...
const bs = (t, e, r, o) => r ? Object.entries(t).filter(([s, i]) => fs(s, i, r)).sort(([, s], [, i]) => s.order - i.order).flatMap(([s]) => e.filter((c) => c.group === s).sort((c, d) => c.order - d.order).map((c) => {
  if ("command" in c)
...
function Eo({
  ...
  const l = Ea(), w = tp(e), p = s && w.length > 1;
  Mi();
    ...
    /* @__PURE__ */ a(
      Fe,
      {
        ...
        children: w.map(({ columnKey: y, label: b, isHeaderHidden: g }, C) => {
          const E = `${l}-${y}`;
          return /* @__PURE__ */ u(Qr, { children: [
            /* @__PURE__ */ u(Yn, { "aria-labelledby": p ? E : void 0, children: [
              p && // A section shown without its heading keeps it for assistive technology only
              /* @__PURE__ */ a(
                cr,
                {
                  id: E,
                  className: g ? "tw:sr-only" : void 0,
                  children: b
                }
              ),
...
function Bp({
  ...
  if (ud(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (w, p) => {
    ...
    return /* @__PURE__ */ a(Rp, { ref: n, className: "pr-twp tw:border-0 tw:bg-transparent", variant: o, children: gs(t.columns).map(({ columnKey: w, column: p }) => /* @__PURE__ */ u(Dp, { children: [
...
export {
  ...
  _p as SELECT_BOOKS_STRING_KEYS,
  Hr as SHRINK_STEP,
  Cg as ScopeSelector,
  ...
  fs as isGroupUnderColumnOrSubMenu,
  Do as isMacOs,
  mm as isWindows,
  Ru as leftEdgeRect,
