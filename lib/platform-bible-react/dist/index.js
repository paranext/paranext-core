import il, { jsxs as ne, jsx as w, Fragment as rr } from "react/jsx-runtime";
...
import { getChaptersForBook as sl } from "platform-bible-utils";
import * as we from "@radix-ui/react-dropdown-menu";
import { DropdownMenuTrigger as al } from "@radix-ui/react-dropdown-menu";
import { ChevronRight as ll, Check as os, Circle as ul, History as cl, ArrowDownWideNarrow as dl, Clock as pl, Bookmark as fl, ChevronDown as is, ChevronUp as gl, ArrowLeftIcon as ml, ChevronLeftIcon as hl, ChevronRightIcon as vl, ArrowRightIcon as bl, FilterIcon as yl } from "lucide-react";
import Te, { clsx as wl } from "clsx";
...
import { Autocomplete as Cl, TextField as El, FormControlLabel as ei, FormLabel as Rl, Checkbox as Tl, MenuItem as Pl, ListItemText as kl, ListItemIcon as as, Menu as Ol, Grid as ls, List as _l, IconButton as us, Drawer as $l, Paper as Nl, Slider as Ml, Snackbar as Il, Switch as Al, AppBar as Fl, Toolbar as Dl } from "@mui/material";
import Vl, { ThemeContext as Ll, internal_processStyles as Bl } from "@mui/styled-engine";
import * as jl from "react-dom";
import An from "react-dom";
import * as cs from "@radix-ui/react-label";
import zl, { SelectColumn as Hl } from "react-data-grid";
import * as ye from "@radix-ui/react-select";
var Gl = Object.defineProperty, Ul = (e, t, n) => t in e ? Gl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, oe = (e, t, n) => (Ul(e, typeof t != "symbol" ? t + "" : t, n), n);
const Rt = [
  "GEN",
  "EXO",
  "LEV",
...
const vs = we.Root, nu = we.Trigger, ru = C.forwardRef(({ className: e, inset: t, children: n, ...r }, o) => /* @__PURE__ */ ne(
  we.SubTrigger,
  {
    ref: o,
    className: ie(
    ...
    children: [
      n,
      /* @__PURE__ */ w(ll, { className: "pr-ml-auto pr-h-4 pr-w-4" })
    ]
  }
));
ru.displayName = we.SubTrigger.displayName;
const ou = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  we.SubContent,
  {
    ref: n,
    className: ie(
...
ou.displayName = we.SubContent.displayName;
...
const bs = C.forwardRef(({ className: e, inset: t, ...n }, r) => /* @__PURE__ */ w(
  we.Item,
  {
    ref: r,
    className: ie(
...
const ys = C.forwardRef(({ className: e, children: t, checked: n, ...r }, o) => /* @__PURE__ */ ne(
  we.CheckboxItem,
  {
    ref: o,
    className: ie(
    ...
    ...r,
    children: [
      /* @__PURE__ */ w("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ w(we.ItemIndicator, { children: /* @__PURE__ */ w(os, { className: "pr-h-4 pr-w-4" }) }) }),
      t
    ]
  }
));
ys.displayName = we.CheckboxItem.displayName;
const iu = C.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  we.RadioItem,
  {
    ref: r,
    className: ie(
    ...
    ...n,
    children: [
      /* @__PURE__ */ w("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ w(we.ItemIndicator, { children: /* @__PURE__ */ w(ul, { className: "pr-h-2 pr-w-2 pr-fill-current" }) }) }),
      t
    ]
  }
));
iu.displayName = we.RadioItem.displayName;
...
function au({
  ...
  return /* @__PURE__ */ w("div", { className: ie("pr-flex pr-flex-wrap pr-items-start pr-justify-start pr-self-stretch"), children: i.map((a) => /* @__PURE__ */ w(
    "div",
    {
      className: ie(
...
function uu({ handleSort: e, handleLocationHistory: t, handleBookmarks: n }) {
...
const pn = ge.allBookIds, cu = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
}, ri = ["OT", "NT", "DC"], du = 32 + 32 + 32, pu = [
  /^(\w+)$/i,
...
function Bh({ scrRef: e, handleSubmit: t }) {
  const [n, r] = Ee(""), [o, i] = Ee(
    ...
    pu.forEach((P) => {
      const $ = n.match(P);
      if ($) {
        const [N, B = void 0, F = void 0] = $.slice(1), M = hu(N);
  ...
  return Cn(() => {
    ...
    const P = setTimeout(() => {
      if (f && m.current && v.current) {
        const N = v.current.offsetTop - du;
  ...
  }, [f]), /* @__PURE__ */ w("div", { children: /* @__PURE__ */ ne(vs, { modal: !1, open: d, onOpenChange: S, children: [
    /* @__PURE__ */ w(nu, { asChild: !0, children: /* @__PURE__ */ w(
      su,
      {
        ref: h,
        value: n,
        ...
        children: [
          ...
          ri.map(
            (P, $) => y(P).length > 0 && /* @__PURE__ */ ne("div", { children: [
              /* @__PURE__ */ w(or, { className: "pr-font-semibold pr-text-slate-700", children: cu[P] }),
              ...
              ri.length - 1 !== $ ? /* @__PURE__ */ w(po, {}) : void 0
            ] }, P)
          )
        ]
      }
...
const vu = ss(
  ...
  ({ className: e, variant: t, size: n, asChild: r = !1, ...o }, i) => /* @__PURE__ */ w(r ? Sl : "button", { className: ie(vu({ variant: t, size: n, className: e })), ref: i, ...o })
);
...
var ai;
function ws() {
  return ai || (ai = 1, process.env.NODE_ENV === "production" ? Fn.exports = xu() : Fn.exports = Su()), Fn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ru() {
  if (pi)
    return Pr;
  pi = 1;
  var e = ws(), t = Cu(), n = go(), r = xs(), o = Eu(), i = function() {
  };
...
function ot(e, t, n = {
  ...
  return St(e) && St(t) && Object.keys(t).forEach((o) => {
    o !== "__proto__" && (St(t[o]) && o in e && St(e[o]) ? r[o] = ot(e[o], t[o], n) : n.clone ? r[o] = St(t[o]) ? Ss(t[o]) : t[o] : r[o] = t[o]);
  }), r;
}
function _u(e) {
  const {
...
const Es = Kt(l.element, Cs);
Es.isRequired = Kt(l.element.isRequired, Cs);
const Rn = Es;
function $u(e) {
  const {
    prototype: t = {}
...
const Mu = Kt(l.elementType, Nu), Iu = "exact-prop: ​";
function Rs(e) {
...
function Ms(e, t, ...n) {
  return e[t] === void 0 ? null : Ns(e, t, ...n);
}
function Wr() {
  return null;
}
...
function fc(e) {
  ...
  const s = Ls(E({}, o, r)), a = xi(r), u = xi(o), c = t(s), d = Te(c == null ? void 0 : c.className, n == null ? void 0 : n.className, i, o == null ? void 0 : o.className, r == null ? void 0 : r.className), g = E({}, c == null ? void 0 : c.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), f = E({}, c, n, u, a);
...
function Mc(e) {
  const {
    ...
    open: d,
    rootRef: g
  } = e, f = C.useRef({}), p = C.useRef(null), h = C.useRef(null), m = Ge(h, g), [v, y] = C.useState(!d), k = $c(u);
  let x = !0;
...
var Me = "top", Ue = "bottom", qe = "right", Ie = "left", ho = "auto", Pn = [Me, Ue, qe, Ie], Gt = "start", wn = "end", Ic = "clippingParents", zs = "viewport", rn = "popper", Ac = "reference", Ei = /* @__PURE__ */ Pn.reduce(function(e, t) {
  return e.concat([t + "-" + Gt, t + "-" + wn]);
}, []), Hs = /* @__PURE__ */ [].concat(Pn, [ho]).reduce(function(e, t) {
...
function qt(e, t, n) {
  ...
  var s = kt(e) ? Le(e) : window, a = s.visualViewport, u = !Gs() && n, c = (r.left + (u && a ? a.offsetLeft : 0)) / o, d = (r.top + (u && a ? a.offsetTop : 0)) / i, g = r.width / o, f = r.height / i;
  return {
    width: g,
    height: f,
    top: d,
...
function Qc(e) {
  ...
  if (!(!i || !s)) {
    var g = Zc(o.padding, n), f = bo(i), p = u === "y" ? Me : Ie, h = u === "y" ? Ue : qe, m = n.rects.reference[d] + n.rects.reference[u] - s[u] - n.rects.popper[d], v = s[u] - n.rects.reference[u], y = kn(i), k = y ? u === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, x = m / 2 - v / 2, S = g[p], b = k - f[d] - g[h], T = k / 2 - f[d] / 2 + x, O = gn(S, T, b), D = u;
...
function Ti(e) {
  ...
  if (c) {
    ...
    if (T === Le(n) && (T = ht(n), st(T).position !== "static" && a === "absolute" && (O = "scrollHeight", D = "scrollWidth")), T = T, o === Me || (o === Ie || o === qe) && i === wn) {
      S = Ue;
...
function Ks(e) {
  return ["html", "body", "#document"].indexOf(Je(e)) >= 0 ? e.ownerDocument.body : He(e) && So(e) ? e : Ks(sr(e));
}
function mn(e, t) {
  var n;
  t === void 0 && (t = []);
  var r = Ks(e), o = r === ((n = e.ownerDocument) == null ? void 0 : n.body), i = Le(r), s = o ? [i].concat(i.visualViewport || [], So(r) ? r : []) : r, a = t.concat(s);
  return o ? a : (
...
function ki(e, t, n) {
  return t === zs ? Kr(cd(e, n)) : kt(t) ? pd(t, n) : Kr(dd(ht(e)));
}
function fd(e) {
  var t = mn(sr(e)), n = ["absolute", "fixed"].indexOf(st(e).position) >= 0, r = n && He(e) ? kn(e) : e;
  return kt(r) ? t.filter(function(o) {
    return kt(o) && Us(o, r) && Je(o) !== "body";
  }) : [];
}
function gd(e, t, n, r) {
...
function xn(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = r === void 0 ? e.placement : r, i = n.strategy, s = i === void 0 ? e.strategy : i, a = n.boundary, u = a === void 0 ? Ic : a, c = n.rootBoundary, d = c === void 0 ? zs : c, g = n.elementContext, f = g === void 0 ? rn : g, p = n.altBoundary, h = p === void 0 ? !1 : p, m = n.padding, v = m === void 0 ? 0 : m, y = Ws(typeof v != "number" ? v : Xs(v, Pn)), k = f === rn ? Ac : rn, x = e.rects.popper, S = e.elements[h ? k : f], b = gd(kt(S) ? S : S.contextElement || ht(e.elements.popper), u, d, s), T = qt(e.elements.reference), O = Ys({
    reference: T,
    element: x,
    strategy: "absolute",
    placement: o
...
function md(e, t) {
  t === void 0 && (t = {});
  var n = t, r = n.placement, o = n.boundary, i = n.rootBoundary, s = n.padding, a = n.flipVariations, u = n.allowedAutoPlacements, c = u === void 0 ? Hs : u, d = Wt(r), g = d ? a ? Ei : Ei.filter(function(h) {
    return Wt(h) === d;
...
function vd(e) {
  ...
  if (!t.modifiersData[r]._skip) {
    for (var o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !0 : s, u = n.fallbackPlacements, c = n.padding, d = n.boundary, g = n.rootBoundary, f = n.altBoundary, p = n.flipVariations, h = p === void 0 ? !0 : p, m = n.allowedAutoPlacements, v = t.options.placement, y = Ke(v), k = y === v, x = u || (k || !h ? [Gn(v)] : hd(v)), S = [v].concat(x).reduce(function(z, G) {
...
function Pd(e) {
  var t = e.state, n = e.options, r = e.name, o = n.mainAxis, i = o === void 0 ? !0 : o, s = n.altAxis, a = s === void 0 ? !1 : s, u = n.boundary, c = n.rootBoundary, d = n.altBoundary, g = n.padding, f = n.tether, p = f === void 0 ? !0 : f, h = n.tetherOffset, m = h === void 0 ? 0 : h, v = xn(t, {
    ...
    padding: g,
    altBoundary: d
  }), y = Ke(t.placement), k = Wt(t.placement), x = !k, S = yo(y), b = Td(S), T = t.modifiersData.popperOffsets, O = t.rects.reference, D = t.rects.popper, V = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  })) : m, L = typeof V == "number" ? {
    mainAxis: V,
    altAxis: V
  ...
  if (T) {
    if (i) {
      var N, B = S === "y" ? Me : Ie, F = S === "y" ? Ue : qe, M = S === "y" ? "height" : "width", j = T[S], te = j + v[B], ee = j - v[F], R = p ? -D[M] / 2 : 0, A = k === Gt ? O[M] : D[M], H = k === Gt ? -D[M] : -O[M], X = t.elements.arrow, z = p && X ? bo(X) : {
        width: 0,
        height: 0
      }, G = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : qs(), q = G[B], W = G[F], U = gn(0, O[M], z[M]), K = x ? O[M] / 2 - R - U - q - L.mainAxis : A - U - q - L.mainAxis, Z = x ? -O[M] / 2 + R + U + W + L.mainAxis : H + U + W + L.mainAxis, se = t.elements.arrow && kn(t.elements.arrow), I = se ? S === "y" ? se.clientTop || 0 : se.clientLeft || 0 : 0, Q = (N = P == null ? void 0 : P[S]) != null ? N : 0, _ = j + K - Q - I, ae = j + Z - Q, Se = gn(p ? Zn(te, _) : te, j, p ? Et(ee, ae) : ee);
      T[S] = Se, $[S] = Se - j;
    }
    if (a) {
      var Oe, be = S === "x" ? Me : Ie, bt = S === "x" ? Ue : qe, _e = T[b], Qe = b === "y" ? "height" : "width", Ae = _e + v[be], et = _e - v[bt], Ce = [Me, Ie].indexOf(y) !== -1, _t = (Oe = P == null ? void 0 : P[b]) != null ? Oe : 0, yt = Ce ? Ae : _e - O[Qe] - D[Qe] - _t + L.altAxis, Yt = Ce ? _e + O[Qe] + D[Qe] - _t - L.altAxis : et, Nn = p && Ce ? Jc(yt, _e, Yt) : gn(p ? yt : Ae, _e, p ? Yt : et);
      T[b] = Nn, $[b] = Nn - _e;
    }
    t.modifiersData[r] = $;
  }
    ...
    var d = {
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (Ni(k, x)) {
            d.rects = {
              reference: Nd(k, kn(x), d.options.strategy === "fixed"),
              popper: bo(x)
...
const Ud = () => lt({
  ...
  } = t, v = fe(t, jd), y = C.useRef(null), k = Ge(y, n), x = C.useRef(null), S = Ge(x, f), b = C.useRef(S);
  Tt(() => {
    b.current = S;
  }, [S]), C.useImperativeHandle(f, () => x.current, []);
  const T = Hd(d, s), [O, D] = C.useState(T), [V, L] = C.useState(Qn(o));
  C.useEffect(() => {
...
}), Zs = /* @__PURE__ */ C.forwardRef(function(t, n) {
  const {
    anchorEl: r,
    children: o,
    container: i,
...
process.env.NODE_ENV !== "production" && (Zs.propTypes = {
   ...
   */
  anchorEl: Kt(l.oneOfType([it, l.object, l.func]), (e) => {
    if (e.open) {
...
function ea(e, t) {
  const n = Qs(e.theme);
  return Object.keys(e).map((r) => lp(e, t, r, n)).reduce(hn, {});
}
function he(e) {
  return ea(e, ur);
}
...
function tf(e = {}) {
  ...
  return i.__mui_systemSx = !0, (s, a = {}) => {
    Bl(s, (b) => b.filter((T) => !(T != null && T.__mui_systemSx)));
    const {
      name: u,
      slot: c,
...
const Gf = Hf(), Oo = Gf, _o = "$$material", oa = (e) => Un(e) && e !== "classes", Uf = tf({
  themeId: _o,
  defaultTheme: Oo,
...
const ia = Bt.createContext(null);
var Xf = function(t) {
  return t.scrollTop;
}, dn = "unmounted", wt = "exited", xt = "entering", Lt = "entered", Jr = "exiting", ct = /* @__PURE__ */ function(e) {
  qf(t, e);
  function t(r, o) {
    var i;
  ...
  return n.componentDidMount = function() {
    ...
    return (
      ...
      /* @__PURE__ */ Bt.createElement(ia.Provider, {
        value: null
...
const Yf = {
  ...
  } = t, y = fe(t, Kf), k = un(), x = C.useRef(), S = $n(), b = C.useRef(null), T = Ge(b, i.ref, n), O = (F) => (M) => {
    if (F) {
      const j = b.current;
      M === void 0 ? F(j) : F(j, M);
    }
...
}, Gi = Jf, Zf = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], Qf = ke(Zs, {
  name: "MuiPopper",
  slot: "Root",
...
const ca = /* @__PURE__ */ C.forwardRef(function(t, n) {
  ...
  const T = ut({
    ...
    TransitionProps: Q
  } = T, _ = fe(T, ng), ae = /* @__PURE__ */ C.isValidElement(D) ? D : /* @__PURE__ */ w("span", {
    children: D
  }), Se = $n(), Oe = Se.direction === "rtl", [be, bt] = C.useState(), [_e, Qe] = C.useState(null), Ae = C.useRef(!1), et = B || ee, Ce = un(), _t = un(), yt = un(), Yt = un(), [Nn, Lo] = Os({
    controlled: G,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const br = ks(R), Jt = C.useRef(), Mn = bn(() => {
  ...
  const Bo = (re) => {
    ...
    onFocus: Xa,
    ref: Ka
  } = _s(), [, Ho] = C.useState(!1), Go = (re) => {
    Wa(re), zo.current === !1 && (Ho(!1), jo(re));
  }, Uo = (re) => {
    be || bt(re.currentTarget), Xa(re), zo.current === !0 && (Ho(!0), yr(re));
  }, qo = (re) => {
    Ae.current = !0;
    const Fe = ae.props;
    ...
    ae.props.onTouchEnd && ae.props.onTouchEnd(re), Mn(), yt.start(H, () => {
      In(re);
    });
  };
  C.useEffect(() => {
  ...
  const Za = Ge(ae.ref, Ka, bt, n);
  !se && se !== 0 && (tt = !1);
  const wr = C.useRef(), Qa = (re) => {
    const Fe = ae.props;
    Fe.onMouseMove && Fe.onMouseMove(re), sn = {
      x: re.clientX,
      y: re.clientY
    }, wr.current && wr.current.update();
  }, Zt = {}, xr = typeof se == "string";
  P ? (Zt.title = !tt && xr && !N ? se : null, Zt["aria-describedby"] = tt ? br : null) : (Zt["aria-label"] = xr ? se : null, Zt["aria-labelledby"] = tt && !xr ? br : null);
  const je = E({}, Zt, _, ae.props, {
...
`));
  ...
  const Qt = {};
  F || (je.onTouchStart = Ya, je.onTouchEnd = Ja), N || (je.onMouseOver = Bn(Wo, je.onMouseOver), je.onMouseLeave = Bn(Xo, je.onMouseLeave), et || (Qt.onMouseOver = Wo, Qt.onMouseLeave = Xo)), $ || (je.onFocus = Bn(Uo, je.onFocus), je.onBlur = Bn(Go, je.onBlur), et || (Qt.onFocus = Uo, Qt.onBlur = Go)), process.env.NODE_ENV !== "production" && ae.props.title && console.error(["MUI: You have provided a `title` prop to the child of <Tooltip />.", `Remove this title prop \`${ae.props.title}\` or the Tooltip component.`].join(`
`));
  const el = C.useMemo(() => {
    var re;
    let Fe = [{
    ...
    touch: Ae.current
  }), Sr = og(en), Ko = (r = (o = Z.popper) != null ? o : V.Popper) != null ? r : ig, Yo = (i = (s = (a = Z.transition) != null ? a : V.Transition) != null ? s : I) != null ? i : Qr, Jo = (u = (c = Z.tooltip) != null ? c : V.Tooltip) != null ? u : sg, Zo = (d = (g = Z.arrow) != null ? g : V.Arrow) != null ? d : ag, tl = cn(Ko, E({}, U, (f = K.popper) != null ? f : L.popper, {
    className: Te(Sr.popper, U == null ? void 0 : U.className, (p = (h = K.popper) != null ? h : L.popper) == null ? void 0 : p.className)
  }), en), nl = cn(Yo, E({}, Q, (m = K.transition) != null ? m : L.transition), en), rl = cn(Jo, E({}, (v = K.tooltip) != null ? v : L.tooltip, {
    className: Te(Sr.tooltip, (y = (k = K.tooltip) != null ? k : L.tooltip) == null ? void 0 : y.className)
  }), en), ol = cn(Zo, E({}, (x = K.arrow) != null ? x : L.arrow, {
    className: Te(Sr.arrow, (S = (b = K.arrow) != null ? b : L.arrow) == null ? void 0 : S.className)
  }), en);
  return /* @__PURE__ */ ne(C.Fragment, {
    children: [/* @__PURE__ */ C.cloneElement(ae, je), /* @__PURE__ */ w(Ko, E({
      as: W ?? ua,
      placement: q,
      anchorEl: ee ? {
      ...
      children: ({
        ...
        children: /* @__PURE__ */ ne(Jo, E({}, rl, {
          children: [se, O ? /* @__PURE__ */ w(Zo, E({}, ol, {
            ref: Qe
          })) : null]
        }))
      }))
...
var fa = No.default = void 0, yg = bg(vg()), wg = il;
fa = No.default = (0, yg.default)(/* @__PURE__ */ (0, wg.jsx)("path", {
  d: "m10 17 5-5-5-5z"
}), "ArrowRight");
function Xi(e, t, n) {
  return e ? /* @__PURE__ */ w(as, { className: `papi-menu-icon-${n ? "leading" : "trailing"}`, children: /* @__PURE__ */ w("img", { src: e, alt: `${n ? "Leading" : "Trailing"} icon for ${t}` }) }) : void 0;
}
function ga(e) {
  const {
    onClick: t,
    ...
    Pl,
    {
      ...
      children: n ? /* @__PURE__ */ ne(rr, { children: [
        Xi(i, n, !0),
        /* @__PURE__ */ w(kl, { primary: n, inset: !i && o }),
        g ? /* @__PURE__ */ w(as, { className: "papi-menu-icon-trailing", children: /* @__PURE__ */ w(fa, {}) }) : Xi(s, n, !1)
      ] }) : v
    }
  );
  return r ? /* @__PURE__ */ w(lg, { title: r, placement: "right", children: /* @__PURE__ */ w("div", { children: y }) }) : y;
}
function ma(e) {
...
function xg(e) {
  const [t, n] = Ee(void 0), { parentMenuItem: r, parentItemProps: o, menuDefinition: i } = e, s = (c) => {
    ...
    ), /* @__PURE__ */ w(Io, { ...e, includedGroups: c });
  };
  return /* @__PURE__ */ ne(rr, { children: [
    /* @__PURE__ */ w(ga, { onClick: s, ...o, isSubMenuParent: !0 }),
    /* @__PURE__ */ w(
      Ol,
      {
        anchorEl: t,
...
function Cg(e) {
  ...
  )), /* @__PURE__ */ w(Io, { ...e, includedGroups: i });
}
function Eg({
  commandHandler: e,
  menuDefinition: t,
  ...
  return /* @__PURE__ */ ne(
    ls,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ w(_l, { id: n, dense: !0, className: i ?? "", children: /* @__PURE__ */ w(
          Cg,
          {
            commandHandler: e,
            menuDefinition: t,
...
const ha = /* @__PURE__ */ C.createContext({});
...
const kg = ["children", "className", "component", "dense", "disablePadding", "subheader"], Og = (e) => {
  ...
  return /* @__PURE__ */ w(Tg.Provider, {
    value: g,
    children: /* @__PURE__ */ ne(_g, E({
      as: s,
...
const $g = va, Ng = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
function Ir(e, t, n) {
...
const Mg = ya, Ig = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"], Ag = {
  entering: {
    opacity: 1
  },
  entered: {
...
const Hg = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "onTransitionEnter", "onTransitionExited", "open", "slotProps", "slots", "theme"], Gg = (e) => {
  ...
  const W = (r = (o = B == null ? void 0 : B.root) != null ? o : y.Root) != null ? r : Ug, U = (i = (s = B == null ? void 0 : B.backdrop) != null ? s : y.Backdrop) != null ? i : d, K = (a = N == null ? void 0 : N.root) != null ? a : k.root, Z = (u = N == null ? void 0 : N.backdrop) != null ? u : k.backdrop, se = Pt({
    elementType: W,
    externalSlotProps: K,
...
const rm = (e) => {
  ...
  const s = ut({
    ...
    const Q = Wn(u), _ = Q && Q.nodeType === 1 ? Q : Pe(N.current).body, ae = _.getBoundingClientRect();
    if (process.env.NODE_ENV !== "production") {
...
`)), v !== null && be < v) {
  ...
  const q = h || (u ? Pe(Wn(u)).body : void 0), W = (o = x == null ? void 0 : x.root) != null ? o : om, U = (i = x == null ? void 0 : x.paper) != null ? i : Ea, K = Pt({
    elementType: U,
    externalSlotProps: E({}, $, {
...
process.env.NODE_ENV !== "production" && (Ra.propTypes = {
   ...
   */
  anchorEl: Kt(l.oneOfType([it, l.func]), (e) => {
...
const am = ["onEntering"], lm = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"], um = {
  ...
  const i = ut({
    ...
    slots: k = {},
    slotProps: x = {}
  } = i, S = fe(i.TransitionProps, am), b = fe(i, lm), T = $n(), O = T.direction === "rtl", D = E({}, i, {
    autoFocus: s,
...
), Pa = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(cs.Root, { ref: n, className: ie(ym(), e), ...t }));
...
function ka({
  ...
  return /* @__PURE__ */ ne("div", { className: "pr-inline-grid pr-items-center pr-gap-1.5", children: [
    /* @__PURE__ */ w(
      Pa,
      {
        htmlFor: e,
    ...
    /* @__PURE__ */ w("p", { className: ie({ "pr-hidden": !r }), children: r })
  ] });
}
function Uh({ onSearch: e, placeholder: t }) {
  const [n, r] = Ee(""), o = (i) => {
    r(i), e(i);
  };
  return /* @__PURE__ */ w(Nl, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ w(
    ka,
    {
...
function Qi({ onRowChange: e, row: t, column: n }) {
  ...
  return (
    ...
    // eslint-disable-next-line no-type-assertion/no-type-assertion
    /* @__PURE__ */ w(ka, { defaultValue: t[n.key], onChange: r })
  );
}
const wm = ({ onChange: e, disabled: t, checked: n, ...r }) => /* @__PURE__ */ w(
  bu,
  {
    ...r,
    isChecked: n,
...
const io = /([0-9]+)/gm, Ym = (e, t, n) => Da(gt(e.getValue(n)).toLowerCase(), gt(t.getValue(n)).toLowerCase()), Jm = (e, t, n) => Da(gt(e.getValue(n)), gt(t.getValue(n))), Zm = (e, t, n) => Vo(gt(e.getValue(n)).toLowerCase(), gt(t.getValue(n)).toLowerCase()), Qm = (e, t, n) => Vo(gt(e.getValue(n)), gt(t.getValue(n))), eh = (e, t, n) => {
...
const La = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w("thead", { ref: n, className: ie("[&_tr]:pr-border-b", e), ...t }));
La.displayName = "TableHeader";
const Ba = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w("tbody", { ref: n, className: ie("[&_tr:last-child]:pr-border-0", e), ...t }));
Ba.displayName = "TableBody";
const vh = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  "tfoot",
  {
    ref: n,
...
const bh = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  "caption",
  {
    ref: n,
...
const yh = ye.Root, wh = ye.Value, za = C.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  ye.Trigger,
  {
    ref: r,
    className: ie(
    ...
    children: [
      t,
      /* @__PURE__ */ w(ye.Icon, { asChild: !0, children: /* @__PURE__ */ w(is, { className: "pr-h-4 pr-w-4 pr-opacity-50" }) })
    ]
  }
));
za.displayName = ye.Trigger.displayName;
const Ha = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  ye.ScrollUpButton,
  {
    ref: n,
    className: ie("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ w(gl, { className: "pr-h-4 pr-w-4" })
  }
));
Ha.displayName = ye.ScrollUpButton.displayName;
const Ga = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  ye.ScrollDownButton,
  {
    ref: n,
    className: ie("pr-flex pr-cursor-default pr-items-center pr-justify-center pr-py-1", e),
    ...t,
    children: /* @__PURE__ */ w(is, { className: "pr-h-4 pr-w-4" })
  }
));
Ga.displayName = ye.ScrollDownButton.displayName;
const Ua = C.forwardRef(({ className: e, children: t, position: n = "popper", ...r }, o) => /* @__PURE__ */ w(ye.Portal, { children: /* @__PURE__ */ ne(
  ye.Content,
  {
    ref: o,
    className: ie(
...
Ua.displayName = ye.Content.displayName;
const xh = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  ye.Label,
  {
    ref: n,
...
const qa = C.forwardRef(({ className: e, children: t, ...n }, r) => /* @__PURE__ */ ne(
  ye.Item,
  {
    ref: r,
    className: ie(
    ...
    ...n,
    children: [
      /* @__PURE__ */ w("span", { className: "pr-absolute pr-left-2 pr-flex pr-h-3.5 pr-w-3.5 pr-items-center pr-justify-center", children: /* @__PURE__ */ w(ye.ItemIndicator, { children: /* @__PURE__ */ w(os, { className: "pr-h-4 pr-w-4" }) }) }),
      /* @__PURE__ */ w(ye.ItemText, { children: t })
    ]
  }
));
qa.displayName = ye.Item.displayName;
const Sh = C.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ w(
  ye.Separator,
  {
    ref: n,
    className: ie("pr--mx-1 pr-my-1 pr-h-px pr-bg-muted", e),
    ...
    /* @__PURE__ */ ne("div", { className: "pr-flex pr-items-center pr-space-x-2", children: [
      ...
      /* @__PURE__ */ ne(
        yh,
        {
          ...
          children: [
            /* @__PURE__ */ w(za, { className: "pr-h-8 pr-w-[70px]", children: /* @__PURE__ */ w(wh, { placeholder: e.getState().pagination.pageSize }) }),
            /* @__PURE__ */ w(Ua, { side: "top", children: [10, 20, 30, 40, 50].map((t) => /* @__PURE__ */ w(qa, { value: `${t}`, children: t }, t)) })
          ]
        }
      )
    ] }),
      ...
      /* @__PURE__ */ ne(
        rt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ w(vl, { className: "pr-h-4 pr-w-4" })
          ]
        }
      ),
      /* @__PURE__ */ ne(
        rt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ w(bl, { className: "pr-h-4 pr-w-4" })
          ]
        }
      )
    ] })
...
function Eh({ table: e }) {
  return /* @__PURE__ */ ne(vs, { children: [
    /* @__PURE__ */ w(al, { asChild: !0, children: /* @__PURE__ */ ne(rt, { variant: "outline", size: "sm", className: "pr-ml-auto pr-hidden pr-h-8 lg:pr-flex", children: [
      /* @__PURE__ */ w(yl, { className: "pr-mr-2 pr-h-4 pr-w-4" }),
      "View"
    ] }) }),
...
function Yh({
  ...
  var m;
  const [s, a] = Ee([]), [u, c] = Ee([]), [d, g] = Ee({}), [f, p] = Ee({}), h = hh({
    data: t,
    columns: e,
    getCoreRowModel: ih(),
  ...
  return /* @__PURE__ */ ne("div", { children: [
    o && /* @__PURE__ */ w(Eh, { table: h }),
    /* @__PURE__ */ w("div", { className: "pr-rounded-md pr-border", children: /* @__PURE__ */ ne(Va, { children: [
      /* @__PURE__ */ w(La, { children: h.getHeaderGroups().map((v) => /* @__PURE__ */ w(Xn, { children: v.headers.map((y) => /* @__PURE__ */ w(ja, { children: y.isPlaceholder ? void 0 : ns(y.column.columnDef.header, y.getContext()) }, y.id)) }, v.id)) }),
      /* @__PURE__ */ w(Ba, { children: (m = h.getRowModel().rows) != null && m.length ? h.getRowModel().rows.map((v) => /* @__PURE__ */ w(
        Xn,
        {
          onClick: () => i(h, v),
          "data-state": v.getIsSelected() && "selected",
          children: v.getVisibleCells().map((y) => /* @__PURE__ */ w(so, { children: ns(y.column.columnDef.cell, y.getContext()) }, y.id))
        },
        v.id
...
function Jh({
  ...
  const i = Ct(void 0);
  return /* @__PURE__ */ w("div", { ref: i, style: { position: "relative" }, children: /* @__PURE__ */ w(Fl, { position: "static", id: r, children: /* @__PURE__ */ ne(Dl, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    e ? /* @__PURE__ */ w(
      bm,
      {
        commandHandler: t,
