...
import E, { forwardRef as cr, useCallback as St, useState as ut, useRef as Ft, useEffect as ne, useLayoutEffect as ba, useMemo as Rt } from "react";
...
import { MenuItem as Ql, ListItemText as tc, ListItemIcon as Si, Menu as ec, Grid as Ti, List as nc, IconButton as Ci, Drawer as rc } from "@mui/material";
...
const ko = ft.Root, Ri = ft.Trigger, cc = ft.Group, nh = ft.Portal, rh = ft.Sub, oh = ft.RadioGroup, dc = E.forwardRef(({ className: t, inset: e, children: n, ...r }, o) => /* @__PURE__ */ N(
  ft.SubTrigger,
  {
    ref: o,
    className: y(
...
dc.displayName = ft.SubTrigger.displayName;
...
pc.displayName = ft.SubContent.displayName;
...
Oi.displayName = ft.Item.displayName;
...
_i.displayName = ft.RadioItem.displayName;
...
const Ro = at.allBookIds.filter((t) => !at.isObsolete(at.bookIdToNumber(t))), Cc = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
...
function ih({
  ...
  }, [f, t.bookNum, t.chapterNum, l]), ba(() => {
    g(m);
  }, [m]), ba(() => {
    const j = setTimeout(() => {
      if (h && T.current && C.current) {
        const A = C.current.offsetTop - Rc;
      ...
      ur,
      {
        ...
        children: /* @__PURE__ */ i("div", { className: "rtl:tw-ps-2", children: xa.map((j, M) => {
          ...
          return A.length > 0 && /* @__PURE__ */ N("div", { children: [
            /* @__PURE__ */ i(wr, { className: "tw-font-semibold tw-text-foreground/80", children: Cc[j] }),
...
function Gc({ table: t }) {
  return /* @__PURE__ */ N(ko, { children: [
    /* @__PURE__ */ i(hl, { asChild: !0, children: /* @__PURE__ */ N(wt, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
function Kc({
  ...
  var g;
  const [l, c] = ut([]), [d, p] = ut([]), [f, w] = ut({}), [m, b] = ut({}), h = yi({
    data: e,
    columns: t,
    getCoreRowModel: Ni(),
      ...
      children: [
        ...
        /* @__PURE__ */ N("div", { className: "tw-flex tw-flex-col tw-items-center", children: [
          /* @__PURE__ */ N("div", { className: "tw-flex tw-items-center tw-rounded-md tw-bg-gray-100 tw-px-2 tw-py-1", children: [
            /* @__PURE__ */ i(Tl, { className: "tw-mr-1 tw-h-4 tw-w-4" }),
        ...
        /* @__PURE__ */ N("div", { className: "tw-ml-auto tw-flex tw-flex-col tw-space-y-2", children: [
          /* @__PURE__ */ N(
            "a",
            {
              ...
              children: [
                "Website",
                /* @__PURE__ */ i(Cl, { className: "tw-ml-1 tw-inline tw-h-4 tw-w-4" })
              ]
            }
          ),
          /* @__PURE__ */ N(
...
}, id = (t, e, n) => n.includes(t) ? "unapproved" : e.includes(t) ? "approved" : "unknown", Ui = Re(
...
sd.displayName = ki.Root.displayName;
...
const br = (t) => t === "asc" ? /* @__PURE__ */ i($l, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ i(Ml, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ i(Al, { className: "tw-ms-2 tw-h-4 tw-w-4" }), vh = (t) => ({
  ...
  return od(t).forEach((p) => {
    p.startsWith("\\id") && (s = ad(p), l = 0, c = 0), p.startsWith("\\c") && (l = Na(p), c = 0), p.startsWith("\\v") && (c = Na(p), l === 0 && (l = e.chapterNum));
...
function kh({
  ...
  const f = te(n, "%webView_inventory_all%"), w = te(n, "%webView_inventory_approved%"), m = te(n, "%webView_inventory_unapproved%"), b = te(n, "%webView_inventory_unknown%"), h = te(n, "%webView_inventory_scope_currentBook%"), g = te(n, "%webView_inventory_scope_chapter%"), k = te(n, "%webView_inventory_scope_verse%"), T = te(n, "%webView_inventory_filter_text%"), C = te(
    n,
    "%webView_inventory_show_additional_items%"
  ), [S, v] = ut(!1), [P, F] = ut("all"), [R, I] = ut(""), [L, D] = ut([]), tt = Rt(() => l ? r instanceof RegExp ? dd(
    l,
    t,
    a,
    s,
...
const Ji = E.forwardRef(
  ({
    ...
    return /* @__PURE__ */ i(Ki.Provider, { value: T, children: /* @__PURE__ */ i(Hi, { delayDuration: 0, children: /* @__PURE__ */ i(
      "div",
      {
        style: (
    ...
    !e && /* @__PURE__ */ N(
      Le,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ i(Ee, { position: "item-aligned", children: /* @__PURE__ */ i(Uc, { children: C.map((R) => /* @__PURE__ */ i(Vt, { value: JSON.stringify(R.value), children: R.label }, R.label)) }) })
        ]
      }
    ),
...
ds.displayName = mt.Root.displayName;
...
ps.displayName = mt.Trigger.displayName;
...
ws.displayName = mt.SubContent.displayName;
...
fs.displayName = mt.Content.displayName;
...
ms.displayName = mt.Item.displayName;
...
hs.displayName = mt.Separator.displayName;
const dn = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var r;
...
const Gp = Xt("border", zt), Up = Xt("borderTop", zt), Xp = Xt("borderRight", zt), Yp = Xt("borderBottom", zt), Hp = Xt("borderLeft", zt), qp = Xt("borderColor"), Wp = Xt("borderTopColor"), Kp = Xt("borderRightColor"), Jp = Xt("borderBottomColor"), Zp = Xt("borderLeftColor"), Qp = Xt("outline", zt), tu = Xt("outlineColor"), Tr = (t) => {
...
Sr(Gp, Up, Xp, Yp, Hp, qp, Wp, Kp, Jp, Zp, Tr, Qp, tu);
const Cr = (t) => {
...
Sr(Cr, Rr, Or, eu, nu, ru, ou, au, iu, su, lu, cu);
function Fe(t, e) {
  return e === "grey" ? e : t;
}
const du = yt({
...
function qa(t) {
  t = Te(t);
  let e = t.type === "hsl" || t.type === "hsla" ? Te(ju(t)).values : t.values;
...
function Ds(t, e) {
  return t = Te(t), e = Yo(e), (t.type === "rgb" || t.type === "hsl") && (t.type += "a"), t.type === "color" ? t.values[3] = `/${e}` : t.values[3] = e, Pr(t);
}
function Bu(t, e) {
  if (t = Te(t), e = Yo(e), t.type.indexOf("hsl") !== -1)
    t.values[2] *= 1 - e;
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Ja(h, "light", T, r), Ja(h, "dark", C, r), h.contrastText || (h.contrastText = f(h.main)), h;
  }, m = {
    dark: Qr,
    light: Ka
  };
...
const nw = ["none", ht(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), ht(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), ht(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), ht(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), ht(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), ht(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), ht(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), ht(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), ht(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), ht(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), ht(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), ht(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), ht(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), ht(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), ht(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), ht(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), ht(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), ht(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), ht(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), ht(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), ht(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), ht(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), ht(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), ht(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], rw = ["duration", "easing", "delay"], ow = {
...
function Ow(t) {
  ...
  const s = Cw(_({}, o, r)), l = ri(r), c = ri(o), d = e(s), p = ye(d == null ? void 0 : d.className, n == null ? void 0 : n.className, a, o == null ? void 0 : o.className, r == null ? void 0 : r.className), f = _({}, d == null ? void 0 : d.style, n == null ? void 0 : n.style, o == null ? void 0 : o.style, r == null ? void 0 : r.style), w = _({}, d, n, c, l);
...
function We(t, e, n) {
  ...
  var s = Ce(t) ? jt(t) : window, l = s.visualViewport, c = !Fs() && n, d = (r.left + (c && l ? l.offsetLeft : 0)) / o, p = (r.top + (c && l ? l.offsetTop : 0)) / a, f = r.width / o, w = r.height / a;
  return {
    width: f,
    height: w,
    top: p,
...
function ef(t) {
  ...
  if (!(!a || !s)) {
    var f = tf(o.padding, n), w = Zo(a), m = c === "y" ? Ot : _t, b = c === "y" ? Gt : Ut, h = n.rects.reference[p] + n.rects.reference[c] - s[c] - n.rects.popper[p], g = s[c] - n.rects.reference[c], k = Bn(a), T = k ? c === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, C = h / 2 - g / 2, S = f[m], v = T - w[p] - f[b], P = T / 2 - w[p] / 2 + C, F = xn(S, P, v), R = c;
...
function On(t, e) {
  e === void 0 && (e = {});
  var n = e, r = n.placement, o = r === void 0 ? t.placement : r, a = n.strategy, s = a === void 0 ? t.strategy : a, l = n.boundary, c = l === void 0 ? Dw : l, d = n.rootBoundary, p = d === void 0 ? Vs : d, f = n.elementContext, w = f === void 0 ? wn : f, m = n.altBoundary, b = m === void 0 ? !1 : m, h = n.padding, g = h === void 0 ? 0 : h, k = Us(typeof g != "number" ? g : Xs(g, jn)), T = w === wn ? jw : wn, C = t.rects.popper, S = t.elements[b ? T : w], v = gf(Ce(S) ? S : S.contextElement || pe(t.elements.popper), c, p, s), P = We(t.elements.reference), F = Hs({
    reference: P,
    element: C,
    placement: o
...
function yf(t) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !0 : s, c = n.fallbackPlacements, d = n.padding, p = n.boundary, f = n.rootBoundary, w = n.altBoundary, m = n.flipVariations, b = m === void 0 ? !0 : m, h = n.allowedAutoPlacements, g = e.options.placement, k = Wt(g), T = k === g, C = c || (T || !b ? [tr(g)] : vf(g)), S = [g].concat(C).reduce(function(z, K) {
...
function _f(t) {
  var e = t.state, n = t.options, r = t.name, o = n.mainAxis, a = o === void 0 ? !0 : o, s = n.altAxis, l = s === void 0 ? !1 : s, c = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.padding, w = n.tether, m = w === void 0 ? !0 : w, b = n.tetherOffset, h = b === void 0 ? 0 : b, g = On(e, {
    ...
    padding: f,
    altBoundary: p
  }), k = Wt(e.placement), T = Ke(e.placement), C = !T, S = Qo(k), v = Of(S), P = e.modifiersData.popperOffsets, F = e.rects.reference, R = e.rects.popper, I = typeof h == "function" ? h(Object.assign({}, e.rects, {
    placement: e.placement
  })) : h, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
  ...
  if (P) {
    if (a) {
      var J, j = S === "y" ? Ot : _t, M = S === "y" ? Gt : Ut, A = S === "y" ? "height" : "width", G = P[S], H = G + g[j], rt = G - g[M], x = m ? -R[A] / 2 : 0, O = T === He ? F[A] : R[A], U = T === He ? -R[A] : -F[A], X = e.elements.arrow, z = m && X ? Zo(X) : {
        width: 0,
        height: 0
      }, K = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Gs(), q = K[j], W = K[M], Y = xn(0, F[A], z[A]), Z = C ? F[A] / 2 - x - Y - q - L.mainAxis : O - Y - q - L.mainAxis, Q = C ? -F[A] / 2 + x + Y + W + L.mainAxis : U + Y + W + L.mainAxis, dt = e.elements.arrow && Bn(e.elements.arrow), $ = dt ? S === "y" ? dt.clientTop || 0 : dt.clientLeft || 0 : 0, kt = (J = D == null ? void 0 : D[S]) != null ? J : 0, V = G + Z - kt - $, xt = G + Q - kt, Yt = xn(m ? ir(H, V) : H, G, m ? xe(rt, xt) : rt);
      P[S] = Yt, tt[S] = Yt - G;
    }
    if (l) {
      var ue, Tt = S === "x" ? Ot : _t, Vn = S === "x" ? Gt : Ut, Ht = P[v], _e = v === "y" ? "height" : "width", we = Ht + g[Tt], Pe = Ht - g[Vn], Ie = [Ot, _t].indexOf(k) !== -1, $e = (ue = D == null ? void 0 : D[v]) != null ? ue : 0, fe = Ie ? we : Ht - F[_e] - R[_e] - $e + L.altAxis, nn = Ie ? Ht + F[_e] + R[_e] - $e - L.altAxis : Pe, zn = m && Ie ? Qw(fe, Ht, nn) : xn(m ? fe : we, Ht, m ? nn : Pe);
      P[v] = zn, tt[v] = zn - Ht;
    }
  ...
  return function(l, c, d) {
    ...
    var p = {
      ...
      setOptions: function(k) {
        ...
        var C = jf(Vf([].concat(r, p.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!w) {
          ...
          if (ui(T, C)) {
            p.rects = {
              reference: Af(T, Bn(C), p.options.strategy === "fixed"),
              popper: Zo(C)
...
var Ff = [df, Rf, lf, Kw, Tf, xf, Pf, rf, kf], Lf = /* @__PURE__ */ zf({
  defaultModifiers: Ff
});
const Gf = "Popper";
function Uf(t) {
...
const Wf = () => Fo({
  root: ["root"]
}, Tw(Uf)), Kf = {}, Jf = /* @__PURE__ */ B.forwardRef(function(e, n) {
  var r;
  const {
    anchorEl: o,
    children: a,
  ...
  } = e, g = Et(e, Xf), k = B.useRef(null), T = Se(k, n), C = B.useRef(null), S = Se(C, w), v = B.useRef(S);
  Ye(() => {
    v.current = S;
...
`));
  ...
  const {
    ...
    slotProps: g = {},
    slots: k = {}
  } = e, T = Et(e, Yf), [C, S] = B.useState(!0), v = () => {
    S(!1);
  }, P = () => {
    S(!0);
  };
...
process.env.NODE_ENV !== "production" && (qs.propTypes = {
   ...
   */
  anchorEl: Bo(u.oneOfType([Tn, u.object, u.func]), (t) => {
    if (t.open) {
...
const rm = {
  ...
  } = e, k = Et(e, nm), T = hn(), C = B.useRef(), S = Ws(), v = B.useRef(null), P = Se(v, a.ref, n), F = (M) => (A) => {
    if (M) {
      const G = v.current;
      A === void 0 ? M(G) : M(G, A);
    }
...
const om = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"], am = Dn(qs, {
  ...
  const o = Ms(), a = Wo({
    ...
    slots: C,
    slotProps: S
  } = a, v = Et(a, om), P = (r = C == null ? void 0 : C.root) != null ? r : c == null ? void 0 : c.Root, F = _({
    anchorEl: s,
    container: p,
    disablePortal: f,
    keepMounted: w,
...
const Js = /* @__PURE__ */ B.forwardRef(function(e, n) {
  ...
  const P = Wo({
    ...
    children: R
  }), Yt = Ws(), ue = Yt.direction === "rtl", [Tt, Vn] = B.useState(), [Ht, _e] = B.useState(null), we = B.useRef(!1), Pe = j || rt, Ie = hn(), $e = hn(), fe = hn(), nn = hn(), [zn, oa] = Ts({
    controlled: K,
    default: !1,
    name: "Tooltip",
    state: "open"
...
`));
  ...
  const aa = (et) => {
    ...
    we.current && et.type !== "touchstart" || (Tt && Tt.removeAttribute("title"), $e.clear(), fe.clear(), A || Wn && G ? $e.start(Wn ? G : A, () => {
      aa(et);
    }) : aa(et));
  }, ia = (et) => {
    $e.clear(), fe.start(O, () => {
    ...
    onFocus: nl,
    ref: rl
  } = Cs(), [, la] = B.useState(!1), ca = (et) => {
    el(et), sa.current === !1 && (la(!1), ia(et));
  }, da = (et) => {
    Tt || Vn(et.currentTarget), nl(et), sa.current === !0 && (la(!0), Ar(et));
  }, pa = (et) => {
    we.current = !0;
    const $t = xt.props;
...
`));
  ...
  }), sn), ul = gn(ga, _({}, (C = Z.arrow) != null ? C : L.arrow, {
    ...
    children: [/* @__PURE__ */ B.cloneElement(xt, Bt), /* @__PURE__ */ i(fa, _({
      ...
      children: ({
        ...
        children: /* @__PURE__ */ N(ha, _({}, pl, {
          children: [dt, F ? /* @__PURE__ */ i(ga, _({}, ul, {
            ref: _e
          })) : null]
        }))
      }))
...
Tm.displayName = Qe.Fallback.displayName;
