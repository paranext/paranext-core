...
import m, { forwardRef as Ze, useRef as rt, useMemo as H, useState as A, useCallback as j, useLayoutEffect as Sn, createContext as Kr, useContext as qr, useEffect as It, Fragment as $n } from "react";
import { Command as lt } from "cmdk";
import { X as Qe, Search as jn, Check as Rt, Clock as Rn, ChevronsLeft as Tn, ChevronsRight as En, ChevronLeft as Le, ChevronRight as Ft, ArrowLeft as Jr, ArrowRight as Wr, Circle as be, ChevronsUpDown as tn, FilterIcon as Zr, ChevronDown as ve, ChevronUp as Qr, ArrowLeftIcon as to, ChevronLeftIcon as eo, ChevronRightIcon as no, ArrowRightIcon as ro, Copy as oo, Filter as ao, User as so, Link as io, CircleHelp as wo, Star as lo, AlertCircle as $e, CircleCheckIcon as co, CircleXIcon as po, CircleHelpIcon as mo, ArrowUpIcon as uo, ArrowDownIcon as ho, ArrowUpDownIcon as fo, PanelLeft as go, PanelRight as bo, ScrollText as vo, MenuIcon as xo, Menu as yo, EllipsisVertical as No, LoaderCircle as ko } from "lucide-react";
import { clsx as Co } from "clsx";
import { extendTailwindMerge as _o } from "tailwind-merge";
import * as xt from "@radix-ui/react-dialog";
import { includes as me, Section as M, getChaptersForBook as So, formatScrRef as Bt, getSectionForBook as oe, NumberFormat as Ro, formatBytes as To, getCurrentLocale as Eo, getFormatCallerFunction as Vo, deepEqual as en, isString as Ve, compareScrRefs as je, scrRefToBBBCCCVVV as Me, getLocalizeKeyForScrollGroupId as z } from "platform-bible-utils";
...
import { useReactTable as Gn, getFilteredRowModel as Mo, getSortedRowModel as Fn, getPaginationRowModel as Do, getCoreRowModel as Xn, flexRender as ae, getGroupedRowModel as Oo, getExpandedRowModel as Io } from "@tanstack/react-table";
...
const $o = _o({ prefix: "tw-" });
function c(...t) {
  return $o(Co(t));
}
const jo = "layoutDirection";
function nt() {
  const t = localStorage.getItem(jo);
  return t === "rtl" ? t : "ltr";
}
const Bo = xt.Portal, Yn = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  xt.Overlay,
  {
    ref: n,
    className: c(
...
const ye = m.forwardRef((t, e) => /* @__PURE__ */ r(lt.Empty, { ref: e, className: "tw-py-6 tw-text-center tw-text-sm", ...t }));
ye.displayName = lt.Empty.displayName;
...
Kn.displayName = lt.Separator.displayName;
...
$t.displayName = lt.Item.displayName;
...
const wt = class I {
  ...
  static fromJSON(e) {
    ...
    let u;
    return i && (u = new Mt(i)), n ? new I(n, o.toString(), w, u) : new I();
  }
  /**
  ...
  parse(e) {
    ...
    if (o.length !== 2 || L.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !I.isVerseParseable(o[1]))
      throw new ee("Invalid reference : " + e);
  ...
  updateInternal(e, n, o) {
    this.bookNum = L.bookIdToNumber(e), this.chapter = n, this.verse = o;
  }
};
...
const nr = L.allBookIds.filter(
  (t) => !L.isObsolete(L.bookIdToNumber(t))
), Ot = Object.fromEntries(
  nr.map((t) => [t, L.bookIdToEnglishName(t)])
);
function sn(t, e, n) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const a = L.bookIdToEnglishName(t), s = n == null ? void 0 : n.get(t);
    ...
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        children: /* @__PURE__ */ l(
          ...
          {
            ref: d,
            value: u || `${t} ${L.bookIdToEnglishName(t)}`,
            onSelect: g,
            onMouseDown: h,
            role: "option",
            "aria-selected": e,
...
const Zt = se.Root, Qt = se.Trigger, jt = m.forwardRef(({ className: t, align: e = "center", sideOffset: n = 4, ...o }, a) => {
  const s = nt();
...
function aa({
  ...
  return /* @__PURE__ */ l(Zt, { open: w, onOpenChange: u, children: [
    ...
    /* @__PURE__ */ r(jt, { id: i, className: "tw-w-[300px] tw-p-0", align: "start", children: /* @__PURE__ */ r(qt, { children: /* @__PURE__ */ r(Jt, { children: /* @__PURE__ */ r(At, { heading: s, children: t.map((p) => /* @__PURE__ */ l(
      $t,
      {
        onSelect: () => d(p),
...
function Ti({
  ...
  const d = nt(), [p, g] = A(!1), [h, f] = A(""), [b, y] = A(""), [v, O] = A("books"), [C, R] = A(void 0), [K, et] = A(!1), B = rt(void 0), ot = rt(void 0), at = rt(void 0), _ = rt(void 0), k = rt({}), $ = j(
    (x) => {
      e(x), w && w(x);
    },
    [e, w]
  ), T = H(() => o ? o() : nr, [o]), U = H(() => ({
    [M.OT]: T.filter((P) => L.isBookOT(P)),
    [M.NT]: T.filter((P) => L.isBookNT(P)),
    [M.DC]: T.filter((P) => L.isBookDC(P)),
    [M.Extra]: T.filter((P) => L.extraBooks().includes(P))
    ...
    return [M.OT, M.NT, M.DC, M.Extra].forEach((Z) => {
      x[Z] = U[Z].filter((st) => sn(st, b, a));
    }), x;
  }, [U, b, a]), N = H(
    () => ia(b, S, a),
    [b, S, a]
    ...
    (x) => {
      if (x.ctrlKey) return;
      const { isLetter: P, isDigit: Z } = Dn(x.key);
      if (v === "chapters") {
        if (x.key === "Backspace") {
      ...
      if ((v === "chapters" || v === "books" && N) && ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(x.key)) {
        ...
        switch (x.key) {
          ...
          case "ArrowRight":
            ...
            break;
          case "ArrowUp":
            yt = it === 0 ? Et : Math.max(1, it - _n);
            break;
          case "ArrowDown":
            yt = it === 0 ? 1 : Math.min(Et, it + _n);
            break;
          default:
            return;
        }
        yt !== it && (x.preventDefault(), x.stopPropagation(), f(Xe(st, a, yt)), setTimeout(() => {
  ...
  return Sn(() => {
    ...
    /* @__PURE__ */ r(jt, { id: u, forceMount: !0, className: "tw-w-[280px] tw-p-0", align: "center", children: /* @__PURE__ */ l(
      qt,
      {
        ref: B,
        onKeyDown: Ur,
        ...
        children: [
          ...
          !K && /* @__PURE__ */ l(Jt, { ref: at, children: [
...
), tt = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Bn.Root, { ref: n, className: c("pr-twp", la(), t), ...e }));
tt.displayName = Bn.Root.displayName;
...
function Mi({
  ...
  const p = Oe(d, "%webView_bookSelector_currentBook%"), g = Oe(d, "%webView_bookSelector_choose%"), h = Oe(d, "%webView_bookSelector_chooseBooks%"), [f, b] = A(
    "current book"
    /* CURRENT_BOOK */
  ), y = (v) => {
    b(v), t(v);
    ...
    wn,
    {
      ...
      children: /* @__PURE__ */ l("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ l("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(tt, { className: "tw-flex tw-items-center", children: o.map((v) => L.bookIdToEnglishName(v)).join(", ") }),
          /* @__PURE__ */ r(
            D,
            {
...
function ga({ table: t }) {
  return /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(Ao, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "outline", size: "sm", className: "tw-ml-auto tw-hidden tw-h-8 lg:tw-flex", children: [
...
const Xt = Y.Root, ba = Y.Group, Ht = Y.Value, va = Tt(
...
dr.displayName = Y.ScrollUpButton.displayName;
...
cr.displayName = Y.ScrollDownButton.displayName;
...
Lt.displayName = Y.Content.displayName;
...
xa.displayName = Y.Label.displayName;
const mt = m.forwardRef(({ className: t, children: e, ...n }, o) => /* @__PURE__ */ l(
  Y.Item,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "tw-absolute tw-start-2 tw-flex tw-h-3.5 tw-w-3.5 tw-items-center tw-justify-center", children: /* @__PURE__ */ r(Y.ItemIndicator, { children: /* @__PURE__ */ r(Rt, { className: "tw-h-4 tw-w-4" }) }) }),
      /* @__PURE__ */ r(Y.ItemText, { children: e })
    ]
  }
));
mt.displayName = Y.Item.displayName;
...
ya.displayName = Y.Separator.displayName;
function Na({ table: t }) {
      ...
      /* @__PURE__ */ l(
        Xt,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ r(Lt, { side: "top", children: [10, 20, 30, 40, 50].map((e) => /* @__PURE__ */ r(mt, { value: `${e}`, children: e }, e)) })
          ]
        }
      )
    ] }),
...
function Ea({
  ...
  var O;
  const [u, d] = A([]), [p, g] = A([]), [h, f] = A({}), [b, y] = A({}), v = Gn({
    data: e,
    columns: t,
    getCoreRowModel: Xn(),
  ...
  return /* @__PURE__ */ l("div", { className: "pr-twp", id: w, children: [
    ...
    /* @__PURE__ */ l(Ce, { stickyHeader: s, children: [
      /* @__PURE__ */ r(_e, { stickyHeader: s, children: v.getHeaderGroups().map((C) => /* @__PURE__ */ r(St, { children: C.headers.map((R) => /* @__PURE__ */ r(le, { children: R.isPlaceholder ? void 0 : ae(R.column.columnDef.header, R.getContext()) }, R.id)) }, C.id)) }),
      /* @__PURE__ */ r(Se, { children: (O = v.getRowModel().rows) != null && O.length ? v.getRowModel().rows.map((C) => /* @__PURE__ */ r(
        St,
        {
          onClick: () => i(C, v),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ l("div", { className: "tw-inline-flex tw-items-start tw-justify-start tw-gap-4 tw-self-stretch", children: [
          ...
          /* @__PURE__ */ r(D, { variant: "secondary", size: "icon", className: "size-8", onClick: () => i(), children: /* @__PURE__ */ r(oo, {}) })
        ] }),
...
function Ii({
  ...
  return /* @__PURE__ */ l(Zt, { onOpenChange: (p) => {
    ...
    /* @__PURE__ */ l(jt, { id: s, className: c("tw-min-w-80 tw-max-w-96", a), children: [
...
function Ai({ id: t, label: e, groups: n }) {
  ...
  return /* @__PURE__ */ r("div", { id: t, children: /* @__PURE__ */ l(dn, { children: [
    /* @__PURE__ */ r(or, { asChild: !0, children: /* @__PURE__ */ l(D, { variant: "default", children: [
...
function Oa({ id: t, versionHistory: e }) {
...
function zi({
  ...
  return /* @__PURE__ */ r("div", { id: t, className: "pr-twp tw-border-t tw-py-2", children: /* @__PURE__ */ l("div", { className: "tw-flex tw-flex-col tw-gap-2 tw-divide-y", children: [
    Object.entries(a).length > 0 && /* @__PURE__ */ r(Oa, { versionHistory: a }),
...
function Aa({
  ...
  const [O, C] = A(!1), R = j(
    (k) => {
      var T;
      const $ = (T = t.find((U) => U.label === k)) == null ? void 0 : T.value;
      $ && n(
        e.includes($) ? e.filter((U) => U !== $) : [...e, $]
      );
    },
    [t, e, n]
  ), K = () => u || o, et = H(() => {
    if (!h) return t;
    const k = t.filter((T) => T.starred).sort((T, U) => T.label.localeCompare(U.label)), $ = t.filter((T) => !T.starred).sort((T, U) => {
  ...
  return /* @__PURE__ */ r("div", { id: v, className: b, children: /* @__PURE__ */ l(Zt, { open: at, onOpenChange: p ?? C, children: [
    ...
    /* @__PURE__ */ r(jt, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ l(qt, { children: [
      ...
      a && /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
        /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: B, children: s }),
        /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: ot, children: i })
      ] }),
      /* @__PURE__ */ l(Jt, { children: [
        /* @__PURE__ */ r(ye, { children: w }),
      ...
      if (typeof s == "string") {
        ...
        return /* @__PURE__ */ l(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ r($e, { className: "tw-h-4 tw-w-4 tw-fill-destructive" }),
...
const ja = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: c("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
  ...
  return /* @__PURE__ */ l(Ce, { stickyHeader: !0, children: [
    ...
    /* @__PURE__ */ r(Se, { children: s.length > 0 && s.map((i) => /* @__PURE__ */ l(
      St,
      {
        ...
        children: [
          /* @__PURE__ */ r(Ut, { children: `${L.bookIdToEnglishName(i.reference.book)} ${i.reference.chapterNum}:${i.reference.verseNum}` }),
...
mn.displayName = Be.Root.displayName;
...
const Re = (t) => t === "asc" ? /* @__PURE__ */ r(uo, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(ho, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fo, { className: "tw-ms-2 tw-h-4 tw-w-4" }), ji = (t) => ({
  accessorKey: "item",
...
function Yi({
  ...
  const p = Nt(n, "%webView_inventory_all%"), g = Nt(n, "%webView_inventory_approved%"), h = Nt(n, "%webView_inventory_unapproved%"), f = Nt(n, "%webView_inventory_unknown%"), b = Nt(n, "%webView_inventory_scope_currentBook%"), y = Nt(n, "%webView_inventory_scope_chapter%"), v = Nt(n, "%webView_inventory_scope_verse%"), O = Nt(n, "%webView_inventory_filter_text%"), C = Nt(
    n,
    "%webView_inventory_show_additional_items%"
  ), [R, K] = A(!1), [et, B] = A("all"), [ot, at] = A(""), [_, k] = A([]), $ = H(() => t.length === 0 ? [] : qa(t, a, s), [t, a, s]), T = H(() => {
    if (R) return $;
    const E = [];
    return $.forEach((Q) => {
    ...
    return [...Q, ...u];
  }, [o == null ? void 0 : o.tableHeaders, u, R]);
  It(() => {
...
const gr = m.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(fr.Provider, { value: C, children: /* @__PURE__ */ r(hn, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
          // eslint-disable-next-line no-type-assertion/no-type-assertion
  ...
  return [
    {
      ...
      cell: (o) => {
        ...
        return o.row.getIsGrouped() ? L.bookIdToEnglishName(a.start.book) : o.row.groupingColumnId === _t ? Bt(a.start) : void 0;
      },
      getGroupingValue: (o) => L.bookIdToNumber(o.start.book),
...
const vs = (t) => {
  ...
  let n = 0;
  return t.end && ({ offset: n } = t.end), !t.end || je(t.start, t.end) === 0 ? `${Me(t.start)}+${e}` : `${Me(t.start)}+${e}-${Me(t.end)}+${n}`;
...
function qi({
  ...
  It(() => {
    if (w) {
      ...
      if (k.length === 1) {
        const $ = y.find((T) => zn(T) === k[0]) || void 0;
        $ && w($);
      }
    }
  }, [f, y, w, O]);
  const C = a ?? fs, R = s ?? Cr, K = [
  ...
  }, ot = (_, k) => _.getIsGrouped() ? "" : c("banded-row", k % 2 === 0 ? "even" : "odd"), at = (_, k, $) => {
    if (!((_ == null ? void 0 : _.length) === 0 || k.depth < $.column.getGroupedIndex())) {
      if (k.getIsGrouped())
        switch (k.depth) {
          case 1:
            return "tw-ps-4";
    ...
    !e && /* @__PURE__ */ l(
      Xt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Lt, { position: "item-aligned", children: /* @__PURE__ */ r(ba, { children: K.map((_) => /* @__PURE__ */ r(mt, { value: JSON.stringify(_.value), children: _.label }, _.label)) }) })
        ]
      }
    ),
    /* @__PURE__ */ l(Ce, { className: "tw-relative tw-flex tw-flex-col tw-overflow-y-auto tw-p-0", children: [
      e && /* @__PURE__ */ r(_e, { children: O.getHeaderGroups().map((_) => /* @__PURE__ */ r(St, { children: _.headers.filter((k) => k.column.columnDef.header).map((k) => (
      ...
      /* @__PURE__ */ r(Se, { children: O.getRowModel().rows.map((_, k) => {
        const $ = nt();
        return /* @__PURE__ */ r(
          St,
          {
                    ...
                    children: T.getIsGrouped() ? /* @__PURE__ */ l(
                      D,
                      {
                        ...
                        children: [
                          ...
                          !_.getIsExpanded() && ($ === "ltr" ? /* @__PURE__ */ r(Ft, {}) : /* @__PURE__ */ r(Le, {})),
                          " ",
...
function ys({
  ...
  const B = H(() => L.allBookIds.filter(
    (S, q) => t[q] === "1" && !L.isObsolete(L.bookIdToNumber(S))
  ), [t]), ot = H(() => {
    if (!C.trim()) {
      const N = {
        [M.OT]: [],
  ...
  return /* @__PURE__ */ l("div", { className: "tw-space-y-2", children: [
            ...
            qt,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ l("div", { className: "tw-flex tw-justify-between tw-border-b tw-p-2", children: [
                  /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: T, children: u }),
                  /* @__PURE__ */ r(D, { variant: "ghost", size: "sm", onClick: U, children: d })
                ] }),
                /* @__PURE__ */ l(Jt, { children: [
                  /* @__PURE__ */ r(ye, { children: p }),
                  Object.values(M).map((S, q) => {
                    const N = ot[S];
                    if (N.length !== 0)
                      return /* @__PURE__ */ l($n, { children: [
                        ...
                        q < Object.values(M).length - 1 && /* @__PURE__ */ r(Kn, {})
                      ] }, S);
                  })
                ] })
              ]
    ...
    e.length > 0 && /* @__PURE__ */ l("div", { className: "tw-mt-2 tw-flex tw-flex-wrap tw-gap-1", children: [
      e.slice(
        0,
        e.length === Ae ? Ae : Ln
      ).map((S) => /* @__PURE__ */ r(fe, { className: "hover:tw-bg-secondary", variant: "secondary", children: Gt(S, a) }, S)),
      ...
      /* @__PURE__ */ r(
        wn,
        {
          ...
          children: O.map(({ value: C, label: R, id: K }) => /* @__PURE__ */ l("div", { className: "tw-flex tw-items-center", children: [
            /* @__PURE__ */ r(he, { className: "tw-me-2", value: C, id: K }),
...
function We({
  ...
  return /* @__PURE__ */ l(dn, { variant: s, children: [
    /* @__PURE__ */ r(or, { "aria-label": n, className: a, asChild: !0, id: w, children: /* @__PURE__ */ r(D, { variant: i, size: "icon", children: o ?? /* @__PURE__ */ r(xo, {}) }) }),
    /* @__PURE__ */ r(Ne, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, u]) => typeof u == "object").sort(([, u], [, d]) => typeof u == "boolean" || typeof d == "boolean" ? 0 : u.order - d.order).map(([u], d, p) => /* @__PURE__ */ l($n, { children: [
...
Lr.displayName = F.Separator.displayName;
const ne = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var o;
  ...
  return a.flatMap(([s], i) => {
    ...
    return w.length > 0 && i < a.length - 1 && u.push(/* @__PURE__ */ r(Lr, {}, `separator-${s}`)), u;
  });
};
function Ts({
  menuData: t,
  ...
  const a = rt(void 0), s = rt(void 0), i = rt(void 0), w = rt(void 0), u = rt(void 0), d = (p) => {
    switch (p) {
      case "platform.app":
        return s;
  ...
  if (zo(["alt", "alt+p", "alt+l", "alt+n", "alt+h"], (p, g) => {
    ...
    return /* @__PURE__ */ r(Dr, { ref: a, className: "pr-twp tw-border-0 tw-bg-transparent", variant: o, children: Object.entries(t.columns).filter(([, p]) => typeof p == "object").sort(([, p], [, g]) => typeof p == "boolean" || typeof g == "boolean" ? 0 : p.order - g.order).map(([p, g]) => /* @__PURE__ */ l(ks, { children: [
      ...
      /* @__PURE__ */ r(
        ...
        {
          className: "tw-z-[250]",
          children: /* @__PURE__ */ r(hn, { children: $r(t.groups, t.items, p, e) })
        }
      )
    ] }, p)) });
}
...
), Os = m.forwardRef(({ className: t, variant: e, ...n }, o) => /* @__PURE__ */ r(
  "div",
  {
    ref: o,
    role: "alert",
...
Ls.displayName = Kt.Fallback.displayName;
const dw = X.Root, cw = X.Trigger, pw = X.Group, mw = X.Portal, uw = X.Sub, hw = X.RadioGroup, $s = m.forwardRef(({ className: t, inset: e, children: n, ...o }, a) => /* @__PURE__ */ l(
  X.SubTrigger,
  {
    ref: a,
    className: c(
...
const Bs = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(X.Portal, { children: /* @__PURE__ */ r(
  X.Content,
  {
    ref: n,
    className: c(
...
Bs.displayName = X.Content.displayName;
...
function Ks({
  ...
  return /* @__PURE__ */ r(jr.Provider, { value: o, children: /* @__PURE__ */ r(
    ut.Root,
    {
...
const fw = ut.Trigger, qs = ut.Portal, gw = ut.Close, Br = m.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  ut.Overlay,
  {
    ref: n,
...
const Js = m.forwardRef(({ className: t, children: e, hideDrawerHandle: n = !1, ...o }, a) => {
  const { direction: s = "bottom" } = m.useContext(jr), i = {
...
const vw = dt.Root, oi = m.forwardRef(({ className: t, ...e }, n) => {
  const o = nt();
  return /* @__PURE__ */ r(
    dt.List,
    {
...
oi.displayName = dt.List.displayName;
...
ai.displayName = dt.Trigger.displayName;
...
si.displayName = dt.Content.displayName;
...
const li = (t, e, n = {}) => {
  ...
  const a = rt(null), [s, i] = A(void 0), [w, u] = A(void 0), d = j(
    (h) => {
      i(h);
