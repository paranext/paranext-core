...
import c, { forwardRef as qt, createContext as Un, useContext as qn, useCallback as et, useState as B, useRef as Z, useEffect as ct, useLayoutEffect as Fe, useMemo as Q, Fragment as Jn } from "react";
...
import { ChevronRight as be, Check as St, Circle as ve, X as xe, Search as qe, ChevronsUpDown as Je, FilterIcon as Qn, ChevronDown as Jt, ChevronUp as tr, ArrowLeftIcon as er, ChevronLeftIcon as nr, ChevronRightIcon as rr, ArrowRightIcon as ar, LoaderCircle as or, Download as sr, Filter as ir, User as wr, Link as lr, CircleHelp as dr, Star as cr, CircleCheckIcon as pr, CircleXIcon as ur, CircleHelpIcon as mr, ArrowUpIcon as hr, ArrowDownIcon as gr, ArrowUpDownIcon as fr, PanelLeft as br, PanelRight as vr, ScrollText as xr, ChevronLeft as yr, MenuIcon as Nr } from "lucide-react";
import { formatScrRef as Ot, getChaptersForBook as kr, NumberFormat as Cr, formatBytes as Sr, deepEqual as ye, substring as Rr, compareScrRefs as de, scrRefToBBBCCCVVV as oe, getLocalizeKeyForScrollGroupId as M } from "platform-bible-utils";
...
import { useReactTable as We, getFilteredRowModel as Tr, getSortedRowModel as Ze, getPaginationRowModel as _r, getCoreRowModel as Qe, flexRender as At, getGroupedRowModel as zr, getExpandedRowModel as Er } from "@tanstack/react-table";
...
import { toast as Os } from "sonner";
...
const ke = V.Trigger, nn = V.Group, Or = V.Portal, Ar = V.Sub, Zo = V.RadioGroup;
...
var jr = Object.defineProperty, Fr = (t, e, n) => e in t ? jr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, C = (t, e, n) => Fr(t, typeof e != "symbol" ? e + "" : e, n);
const gt = [
  "GEN",
  "EXO",
  "LEV",
...
const ze = O.allBookIds.filter((t) => !O.isObsolete(O.bookIdToNumber(t))), ta = {
  OT: "Old Testament",
  NT: "New Testament",
  DC: "Deuterocanon"
  ...
  return ct(() => {
    ...
    /* @__PURE__ */ r(
      $t,
      {
        ...
        ref: y,
        children: /* @__PURE__ */ r("div", { className: "rtl:tw-ps-2", children: Ye.map((N, z) => {
          const P = j(N);
          return P.length > 0 && /* @__PURE__ */ d("div", { children: [
            /* @__PURE__ */ r(Zt, { className: "tw-font-semibold tw-text-foreground/80", children: ta[N] }),
...
), Y = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(Ke.Root, { ref: n, className: l("pr-twp", ia(), t), ...e }));
...
const wa = at.Portal, gn = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r(
  at.Overlay,
  {
    ref: n,
    className: l(
...
da.displayName = at.Title.displayName;
...
ca.displayName = at.Description.displayName;
...
function me({
  ...
  const [x, k] = B(!1);
  return /* @__PURE__ */ d(mn, { open: x, onOpenChange: k, ...S, children: [
    ...
    un,
    {
      ...
      children: /* @__PURE__ */ d("div", { className: "tw-flex tw-w-full tw-flex-col tw-gap-4", children: [
        ...
        /* @__PURE__ */ d("div", { className: "tw-grid tw-grid-cols-[25%,50%,25%]", children: [
          ...
          /* @__PURE__ */ r(Y, { className: "tw-flex tw-items-center", children: a.map((x) => O.bookIdToEnglishName(x)).join(", ") }),
          /* @__PURE__ */ r(
            I,
            {
...
function ka({
  ...
  var x;
  const [s, p] = B([]), [u, m] = B([]), [f, g] = B({}), [h, b] = B({}), S = We({
    data: e,
    columns: t,
    getCoreRowModel: Qe(),
  ...
  return /* @__PURE__ */ d("div", { className: "pr-twp", children: [
    ...
    n && a && /* @__PURE__ */ r(xa, { table: S })
  ] });
}
const Lt = qt(({ className: t, ...e }, n) => /* @__PURE__ */ r(or, { size: 35, className: l("tw-animate-spin", t), ...e, ref: n }));
...
function _a({
  ...
  return /* @__PURE__ */ r("div", { className: m, children: /* @__PURE__ */ d(mn, { open: f, onOpenChange: g, children: [
    /* @__PURE__ */ r(hn, { asChild: !0, children: /* @__PURE__ */ d(
      I,
      {
        variant: "ghost",
    ...
    /* @__PURE__ */ r(Ee, { align: "start", className: "tw-w-full tw-p-0", children: /* @__PURE__ */ d(Me, { children: [
      ...
      /* @__PURE__ */ d(Ve, { children: [
        ...
        /* @__PURE__ */ r(fn, { children: S.map((x) => {
...
kn.displayName = Kt.Root.displayName;
...
const ne = (t) => t === "asc" ? /* @__PURE__ */ r(hr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : t === "desc" ? /* @__PURE__ */ r(gr, { className: "tw-ms-2 tw-h-4 tw-w-4" }) : /* @__PURE__ */ r(fr, { className: "tw-ms-2 tw-h-4 tw-w-4" }), us = (t) => ({
  accessorKey: "item",
...
function fs({
  ...
  const f = st(n, "%webView_inventory_all%"), g = st(n, "%webView_inventory_approved%"), h = st(n, "%webView_inventory_unapproved%"), b = st(n, "%webView_inventory_unknown%"), S = st(n, "%webView_inventory_scope_currentBook%"), x = st(n, "%webView_inventory_scope_chapter%"), k = st(n, "%webView_inventory_scope_verse%"), y = st(n, "%webView_inventory_filter_text%"), E = st(
    n,
    "%webView_inventory_show_additional_items%"
  ), [j, tt] = B(!1), [ot, Et] = B("all"), [v, _] = B(""), [K, A] = B([]), Mt = Q(() => s ? a instanceof RegExp ? Pa(s, t, i, w, a) : a(s, t, i, w) : [], [s, a, t, i, w]), pt = Q(() => {
    if (j) return Mt;
    const R = [];
    return Mt.forEach((L) => {
  ...
  }, [j, Mt]), N = Q(() => Ba(pt, ot, v), [pt, ot, v]), z = Q(() => {
    var wt, ut;
    if (!j) return m;
...
Oe.displayName = en.Root.displayName;
...
const Oa = "16rem", Aa = "3rem", Cn = c.createContext(void 0);
function ae() {
...
const Sn = c.forwardRef(
  ({
    ...
    return /* @__PURE__ */ r(Cn.Provider, { value: y, children: /* @__PURE__ */ r(Ae, { delayDuration: 0, children: /* @__PURE__ */ r(
      "div",
      {
        style: (
    ...
    !e && /* @__PURE__ */ d(
      yt,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(bt, { position: "item-aligned", children: /* @__PURE__ */ r(fa, { children: E.map((v) => /* @__PURE__ */ r(W, { value: JSON.stringify(v.value), children: v.label }, v.label)) }) })
        ]
      }
    ),
                    ...
                    children: A.getIsGrouped() ? /* @__PURE__ */ d(
                      I,
                      {
                        ...
                        children: [
                          ...
                          !v.getIsExpanded() && (K === "ltr" ? /* @__PURE__ */ r(be, {}) : /* @__PURE__ */ r(yr, {})),
                          " ",
...
function Cs({
  ...
  return /* @__PURE__ */ d(Wt, { variant: i, children: [
    /* @__PURE__ */ r(ke, { "aria-label": n, className: o, asChild: !0, id: w, children: /* @__PURE__ */ r(I, { variant: "ghost", className: "tw-h-6 tw-p-1", children: a ?? /* @__PURE__ */ r(Nr, {}) }) }),
    /* @__PURE__ */ r($t, { align: "start", className: "tw-z-[250]", children: Object.entries(e.columns).filter(([, s]) => typeof s == "object").sort(([, s], [, p]) => typeof s == "boolean" || typeof p == "boolean" ? 0 : s.order - p.order).map(([s], p, u) => /* @__PURE__ */ d(Jn, { children: [
...
Xn.displayName = D.Root.displayName;
...
jn.displayName = D.Trigger.displayName;
...
Fn.displayName = D.SubTrigger.displayName;
...
Gn.displayName = D.SubContent.displayName;
...
$n.displayName = D.Content.displayName;
...
co.displayName = D.CheckboxItem.displayName;
...
po.displayName = D.RadioItem.displayName;
...
uo.displayName = D.Label.displayName;
...
Ln.displayName = D.Separator.displayName;
const Bt = (t, e) => {
  setTimeout(() => {
    e.forEach((n) => {
      var a;
...
const To = c.forwardRef(({ className: t, ...e }, n) => /* @__PURE__ */ r("p", { ref: n, className: l("pr-twp tw-text-sm tw-text-muted-foreground", t), ...e }));
...
Eo.displayName = Pt.Root.displayName;
