...
import { Slot as Nt, Dialog as X, Popover as ot, Tooltip as et, Label as ce, RadioGroup as ht, ToggleGroup as Bt, Separator as ue, DropdownMenu as T } from "radix-ui";
import { IconX as we, IconSearch as me, IconCheck as vt, IconChevronRight as fe } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as W, useRef as xt, useCallback as J, createContext as pe, useContext as he, useMemo as Q, useEffect as ge, Fragment as be, forwardRef as Ot } from "react";
import { cva as q } from "class-variance-authority";
import { ChevronsUpDown as Mt, Check as jt, Star as Ne, SlidersHorizontal as ve, ArrowRight as xe, Loader2 as ye, ChevronDown as ke, Search as Ie, X as Se, AlertTriangle as Ce, LoaderCircle as Ee } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as Te, normalizeProjectId as K, compareProjectsByName as ze, formatProjectName as _t, getLocalizeKeyForScrollGroupId as Ge, hasDistinctFullName as Ae, getSectionForBook as De } from "platform-bible-utils";
...
import { extendTailwindMerge as Re, twMerge as Pe } from "tailwind-merge";
const Be = Re({ prefix: "tw" });
function gt(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  ...
  }), Pe(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const f = r.get(c);
    return f ? Me(c, f) : c;
  }).join(" ");
}
const je = 600, Ut = 650, fr = 400, _e = 450, Ue = 500, $e = 550, pr = 650, hr = 700, $t = q(
  ...
  return /* @__PURE__ */ m(He, { children: [
    ...
    /* @__PURE__ */ m(
      X.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(X.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(_, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(we, {}),
...
function kr({
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(X.Close, { asChild: !0, children: /* @__PURE__ */ o(_, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Ft({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m(Ke, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        tt.Input,
        {
      ...
      /* @__PURE__ */ o(Xe, { children: /* @__PURE__ */ o(me, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Pr = Object.fromEntries(
  Ze.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Br(t, e, a) {
...
const oa = ["input", "select", "textarea", "button"], sa = ["button", "textbox"], Yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = xt(null), [s, i] = W(void 0), [l, c] = W(void 0), f = J(
    (u) => {
      i(u);
    ...
    if (u.isContentEditable || oa.includes(b)) return !0;
    const g = u.getAttribute("role");
    if (g && sa.includes(g)) return !0;
    ...
    (u) => {
      ...
      switch (u.key) {
        case "ArrowDown":
          O = Math.min(B + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          O = Math.max(B - 1, 0), u.preventDefault();
          break;
        case "Home":
...
function la({ variant: t = "default", ...e }) {
...
function on({ className: t, children: e, ...a }) {
  const r = U();
  return /* @__PURE__ */ o(
    T.SubContent,
    {
...
function st(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && fa(r)
  );
}
function ln({
  className: t,
  ...
  const l = z.useMemo(
    ...
    (h) => {
      ...
      if (h.key === "ArrowDown" || h.key === "ArrowUp")
        h.preventDefault(), ga(u, b, h.key);
      else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
        h.preventDefault(), ha(l, g, h.key);
...
function hn({
  ...
  const [A, $] = W(!1), Y = J(
    (C) => {
      var P;
      const R = (P = t.find((F) => F.label === C)) == null ? void 0 : P.value;
      R && a(
        e.includes(R) ? e.filter((F) => F !== R) : [...e, R]
      );
    },
    [t, e, a]
  ), B = () => c || r, O = Q(() => {
    if (!S) return t;
    const C = t.filter((P) => P.starred).sort((P, F) => P.label.localeCompare(F.label)), R = t.filter((P) => !P.starred).sort((P, F) => {
      const lt = e.includes(P.value), H = e.includes(F.value);
      return lt && !H ? -1 : !lt && H ? 1 : P.label.localeCompare(F.label);
    });
    return [...C, ...R];
  }, [t, e, S]), M = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ m(Wt, { open: x, onOpenChange: h ?? $, children: [
    ...
    /* @__PURE__ */ o(Zt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Vt, { children: [
      /* @__PURE__ */ o(
        Ft,
        {
      ...
      n && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: V, children: i })
      ] }),
      /* @__PURE__ */ m(Kt, { children: [
        /* @__PURE__ */ o(Jt, { children: l }),
        /* @__PURE__ */ o(Xt, { children: O.map((C) => /* @__PURE__ */ m(
          kt,
          {
            value: C.label,
            onSelect: Y,
            ...
            children: [
              ...
              C.starred && /* @__PURE__ */ o(Ne, { className: "tw:h-4 tw:w-4" }),
...
function gn(t, e, a) {
  ...
  if (Na(t) || Te.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (L(t), a.dismiss(), "ended") : (L(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (L(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (L(t), a.dismiss(), "ended") : t.key === "Backspace" || re[r].test(t.key) ? (L(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && L(t), a.dismiss(), "ended");
}
function bn(t, e) {
  var a;
...
function ka(t) {
  ...
  return t.forEach((a) => {
    const r = K(a.projectId), n = e.get(r), s = {
...
function Ta(t) {
  ...
  return t.map((a) => a.id).find((a) => a === ne || e.has(a) ? !0 : (e.add(a), !1));
}
...
function Ga(t, e, a, r) {
  ...
  t.forEach((v) => {
    const S = i(K(v.projectId));
    S < 0 ? c.push(v) : l[S].push(v);
  });
  const f = (v, S) => {
    const { compare: u } = S;
    return u ? [...v].sort((b, g) => {
      const N = a.get(K(b.projectId)), A = a.get(K(g.projectId));
      if (!N || !A) return D(b, g);
      const $ = u(N, A);
      return $ !== 0 ? $ : D(b, g);
    }) : [...v].sort(D);
...
function it(t) {
  return Qe[Ge(t)] ?? String(t);
}
const La = "platform.footerAction", oe = [
  "openTabs",
  "lastUsed",
  "language",
  "versification",
...
function Oa({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = ea(), [S, u] = W(!1), b = !!(t.language || t.languageCode), g = b || !!t.typeName || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = f || S, A = J(() => {
    if (g) {
      u(!0);
      return;
    }
  ...
  let B;
  e === "project" ? t.openGroups.length > 0 && (B = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((x) => /* @__PURE__ */ o(ut, { variant: "secondary", children: it(x) }, x)) })) : t.scrollGroupId !== void 0 && (B = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Ba,
      {
        ...
        /* @__PURE__ */ m(
          "span",
          {
            ...
            children: [
              ...
              Ae(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        B
  ...
  ), M = t.scrollGroupId !== void 0 ? it(t.scrollGroupId) : void 0, V = t.isBoundButClosed && M ? a.boundButClosedTooltip.replace("{group}", M) : void 0;
  return /* @__PURE__ */ m(Yt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(Qt, { asChild: !0, children: O }),
    /* @__PURE__ */ m(
      te,
      {
        side: "top",
        ...
        style: { zIndex: Ut },
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", children: _t(t) }),
...
function Ua({
  ...
  return /* @__PURE__ */ m(la, { children: [
    /* @__PURE__ */ o(da, { asChild: !0, children: /* @__PURE__ */ o(
      _,
      {
        variant: "ghost",
        size: "sm",
            ...
            /* @__PURE__ */ m(
              wa,
              {
                ...
                children: [
                  ...
                  t.map((c) => /* @__PURE__ */ o(zt, { value: c, children: _a(c, i) }, c))
                ]
              }
            )
          ] }),
          s && /* @__PURE__ */ m(ct, { children: [
            t.length > 0 && /* @__PURE__ */ o(ma, {}),
...
function yn(t) {
  const [e, a] = W(!1), [r, n] = W(""), s = t.availableGroupings ?? Ra, i = Ma(
    s,
    t.defaultGrouping,
    t.defaultGroupByOpenTabs
  ), [l, c] = W(i), [f, h] = W(!1), v = xt(null), S = J((w) => {
    a(w), w || n("");
  }, []);
  ge(() => {
    if (!e) return;
  ...
  const u = Da(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    () => new Map(t.projects.map((w) => [K(w.id), w])),
    [t.projects]
  ), { renderProjectIndicator: A } = t, $ = J(
    (w) => {
      if (!A) return;
      const p = N.get(K(w.projectId));
      return p ? A(p) : void 0;
    },
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: B } = u, { languageUnknownSectionHeading: O } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: V } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Rt(g, !0);
      case "lastUsed":
    ...
    switch (t.mode) {
      case "project": {
        ...
        if (t.renderTriggerLabel)
          return { node: t.renderTriggerLabel(w), title: "", hasSelection: !!w };
        let p = w ? w.shortName : t.buttonPlaceholder ?? "";
        return w && t.triggerLabelFormat === "shortNameAndFullName" && (p = _t(w)), { node: p, title: p, hasSelection: !!w };
      }
      case "project-multi": {
        const { pairs: w } = t.selection;
        if (w.length === 0) {
          const k = t.buttonPlaceholder ?? "";
          return { node: k, title: k, hasSelection: !1 };
        }
        const p = [];
        if (w.forEach((k) => {
          const rt = t.projects.find((de) => de.id === k.projectId);
        ...
        if (t.getSelectedText) {
          ...
          return { node: k, title: k, hasSelection: !0 };
        }
        const y = p.map(
          ({ project: k, scrollGroupId: rt }) => rt === void 0 ? k.shortName : `${k.shortName} (${it(rt)})`
        ).join(", ");
        if (p.length === 1) return { node: y, title: y, hasSelection: !0 };
      ...
      case "projectScrollGroup": {
        ...
        if (p === void 0)
          return { node: w.shortName, title: w.shortName, hasSelection: !0 };
        const y = `${w.shortName} · ${it(p)}`;
        return { node: y, title: y, hasSelection: !0 };
      }
      default:
  ...
  let at;
  t.isLoading ? at = /* @__PURE__ */ o(ye, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? at = void 0 : t.mode === "project-multi" ? at = /* @__PURE__ */ o(Mt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : at = /* @__PURE__ */ o(ke, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const se = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? R : void 0, ie = t.ariaLabel && H.hasSelection && H.title ? `${t.ariaLabel}: ${H.title}` : t.ariaLabel, St = /* @__PURE__ */ m(
    _,
    {
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof H.node == "string" ? /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: H.node }) : H.node }),
        at
      ]
    }
  ), le = H.title ? /* @__PURE__ */ o(Tt, { delayDuration: 400, children: /* @__PURE__ */ m(Yt, { children: [
    /* @__PURE__ */ o(Qt, { asChild: !0, children: /* @__PURE__ */ o(bt, { asChild: !0, children: St }) }),
    /* @__PURE__ */ o(te, { children: H.title })
  ...
  return /* @__PURE__ */ m(Wt, { open: e, onOpenChange: S, children: [
    ...
    /* @__PURE__ */ o(
      Zt,
      {
        ...
        children: /* @__PURE__ */ o(Tt, { delayDuration: 400, children: /* @__PURE__ */ m(Vt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: F, children: `${u.selectAll} (${C.length.toString()})` }),
            /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: lt, children: `${u.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ m(Kt, { children: [
            /* @__PURE__ */ o(Jt, { children: t.commandEmptyMessage ?? "No projects found" }),
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(be, { children: [
                /* @__PURE__ */ o(Xt, { heading: $a(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Oa,
                  {
                    row: y,
                    mode: t.mode,
...
const In = (t, e, a) => Fa(t, e).every((r) => a.includes(r));
function Ka(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, n) => G.bookIdToNumber(r) - G.bookIdToNumber(n)).map((r) => ta(r, e));
}
function Sn(t, e, a, r) {
...
function Tn({
  ...
  return /* @__PURE__ */ m(Ja, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Xa, { children: [
      /* @__PURE__ */ o(qa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ce, {}) }),
      /* @__PURE__ */ o(Za, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Ya, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
const Qa = Ot(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ee, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DwGeb8Dp.js.map
