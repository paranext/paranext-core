...
import { jsx as n, jsxs as p, Fragment as It } from "react/jsx-runtime";
...
import { ChevronsUpDown as Et, Check as Tt, Star as re, Filter as oe, ArrowRight as ne, Loader2 as se, ChevronDown as ie, Search as le, X as de, AlertTriangle as ce, LoaderCircle as ue } from "lucide-react";
import { Section as V, MODIFIER_KEYS as we, normalizeProjectId as Q, getLocalizeKeyForScrollGroupId as me, getSectionForBook as fe } from "platform-bible-utils";
...
import { extendTailwindMerge as he, twMerge as ge } from "tailwind-merge";
const be = he({ prefix: "tw" });
function ct(t) {
  const e = [];
  let a = "", r = 0;
...
function c(...t) {
  ...
  }), ge(o.join(" ")).split(" ").filter(Boolean).map((m) => {
    const b = r.get(m);
    return b ? ve(m, b) : m;
  }).join(" ");
}
s(c, "cn");
const xe = 600, _a = 650, zt = 400, ye = 450, ke = 500, Ie = 550, $a = 700, Gt = H(
  ...
  return /* @__PURE__ */ p(Ce, { children: [
    ...
    /* @__PURE__ */ p(
      j.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(j.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(P, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(qt, {}),
...
function Xa({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(j.Close, { asChild: !0, children: /* @__PURE__ */ n(P, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Lt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ p(Te, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        J.Input,
        {
      ...
      /* @__PURE__ */ n(Ge, { children: /* @__PURE__ */ n(Zt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
s(Lt, "CommandInput");
...
}, "getSectionLongName"), or = /* @__PURE__ */ s((t, e, a, r, o) => {
  switch (t) {
    case V.OT:
      return e ?? "OT";
    case V.NT:
...
s(lr, "PopoverPortalContainerProvider");
function _t({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
...
s(yr, "isWindows");
const He = ["input", "select", "textarea", "button"], Fe = ["button", "textbox"], kr = /* @__PURE__ */ s(({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const o = ft(null), [i, l] = _(void 0), [d, m] = _(void 0), b = $(
    (f) => {
      ...
      I && (I.scrollIntoView({ block: "center" }), I.focus()), o.current && o.current.setAttribute("aria-activedescendant", f);
    },
    [e, t]
  ), N = $(
    (f) => {
      const x = t.find((I) => I.id === f);
      x && (m((I) => I === f ? void 0 : f), a == null || a(x));
    },
    [a, t]
  ), C = /* @__PURE__ */ s((f) => {
    if (!f) return !1;
    const x = f.tagName.toLowerCase();
    if (f.isContentEditable || He.includes(x)) return !0;
    const I = f.getAttribute("role");
    if (I && Fe.includes(I)) return !0;
    const y = f.getAttribute("tabindex");
    return y !== void 0 && y !== "-1";
  }, "isInteractiveElement"), D = $(
    (f) => {
      var K;
      const x = f.target, I = /* @__PURE__ */ s((S) => S ? document.getElementById(S) : void 0, "getElementById"), y = I(d), M = I(i);
      if (!!(y && x && y.contains(x) && x !== y) && C(x)) {
        ...
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          if (u === -1) return;
          let w;
          f.key === "ArrowDown" ? w = Math.min(u + 1, S.length - 1) : w = Math.max(u - 1, 0), w !== u && (f.preventDefault(), f.stopPropagation(), (K = S[w]) == null || K.focus());
          return;
        }
        return;
      }
...
function Ke({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Kt.Provider, { value: r, children: /* @__PURE__ */ n(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
s(Ke, "DropdownMenu");
function Ir({
  ...t
...
function Hr({
  ...
  const [M, O] = _(!1), U = $(
    ...
    const w = t.filter((v) => v.starred).sort((v, g) => v.label.localeCompare(g.label)), h = t.filter((v) => !v.starred).sort((v, g) => {
      const F = e.includes(v.value), at = e.includes(g.value);
      return F && !at ? -1 : !F && at ? 1 : v.label.localeCompare(g.label);
    });
    return [...w, ...h];
  }, [t, e, D]), R = /* @__PURE__ */ s(() => {
    a(t.map((w) => w.value));
  }, "handleSelectAll"), K = /* @__PURE__ */ s(() => {
    a([]);
  ...
  return /* @__PURE__ */ n("div", { id: y, className: x, children: /* @__PURE__ */ p(Ot, { open: S, onOpenChange: N ?? O, children: [
    ...
    /* @__PURE__ */ n(_t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(Dt, { children: [
      ...
      o && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: R, children: i }),
        /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: K, children: l })
      ] }),
...
s(Qe, "filterAndRankPaletteItems");
function ta(t) {
  return t.isComposing || t.keyCode === 229;
}
s(ta, "isImeCompositionKeyEvent");
const Jt = {
...
function ra(t) {
  return [
    ...ea,
    ...aa.filter((e) => Jt[t].test(e))
  ];
}
s(ra, "getMarkerPaletteClaimedKeys");
function L(t) {
...
function Fr(t, e, a) {
  ...
  if (ta(t) || we.has(t.key) || t.key === "Dead")
    return "passed";
...
s(Fr, "handleMarkerPaletteSessionKeyDown");
function Vr(t, e) {
  var a;
  ((a = t.current) == null ? void 0 : a.token) === e && (t.current = void 0);
}
s(Vr, "clearPaletteSessionIfCurrent");
function Kr(t) {
  const {
    items: e,
    passive: a,
  ...
  o.current += 1;
  const f = o.current, x = a ? "backslash" : "selection", I = { kind: x, token: f, filter: "", items: e };
  x === "backslash" && r && (I.shouldSpaceCommit = r), i(I), m({
...
s(ca, "ScrollGroupChip");
function ua({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: i }) {
  const {
    ref: l,
    open: d,
    onPointerEnter: m,
    onPointerLeave: b
  } = Oe(), [N, C] = _(!1), D = !!(t.language || t.languageCode), f = D || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, x = d || N, I = $(() => {
    if (f) {
      C(!0);
      return;
    }
...
function wa({
  ...
  return /* @__PURE__ */ p(Ke, { children: [
    ...
    /* @__PURE__ */ p(Ue, { align: "end", className: "tw:w-56", style: { zIndex: zt }, children: [
...
function Xr(t) {
  ...
  const C = la(t.localizedStrings), D = X(() => t.mode === "project" ? lt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const w = [];
        if (u.forEach((g) => {
          const F = t.projects.find((at) => at.id === g.projectId);
          F && w.push({ project: F, scrollGroupId: g.scrollGroupId });
        }), w.length === 0) {
          const g = t.buttonPlaceholder ?? "";
          return { node: g, title: g };
        }
        ...
        const h = w.map(
          ({ project: g, scrollGroupId: F }) => F === void 0 ? g.shortName : `${g.shortName} (${et(F)})`
        ).join(", ");
  ...
  const R = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, K = /* @__PURE__ */ p(
    P,
    {
    ...
    /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(ut, { asChild: !0, children: K }) }),
      ...
      _t,
      {
        ...
        children: /* @__PURE__ */ n(bt, { delayDuration: 400, children: /* @__PURE__ */ p(Dt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: O, children: `${C.selectAll} (${I.length.toString()})` }),
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: U, children: `${C.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ p(Rt, { children: [
            ...
            x.map((u, w) => (
              ...
              /* @__PURE__ */ p(ae, { children: [
                /* @__PURE__ */ n(Bt, { heading: ma(u, C), children: u.rows.map((h) => /* @__PURE__ */ n(
                  ua,
                  {
                    row: h,
                    mode: t.mode,
...
s(ha, "getBooksForSection");
const qr = /* @__PURE__ */ s((t, e, a) => ha(t, e).every((r) => a.includes(r)), "isSectionFullySelected");
function ga(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => A.bookIdToNumber(r) > 0).sort((r, o) => A.bookIdToNumber(r) - A.bookIdToNumber(o)).map((r) => Me(r, e));
}
s(ga, "localizeBookIdsInCanonOrder");
function Zr(t, e, a, r) {
  ...
  const l = ga(t, r);
  if (l.length !== 0)
    return l.length <= pa ? l.join(", ") : `${l[0]} - ${l[l.length - 1]}`;
}
s(Zr, "summarizeSelectedBooks");
...
function to({
  ...
  return /* @__PURE__ */ p(ba, { className: c(i), role: o, children: [
    /* @__PURE__ */ p(Na, { children: [
      /* @__PURE__ */ n(xa, { variant: "icon", children: r ?? /* @__PURE__ */ n(ce, {}) }),
      /* @__PURE__ */ n(ya, { children: t })
    ] }),
    a && /* @__PURE__ */ n(ka, { children: /* @__PURE__ */ n(P, { onClick: /* @__PURE__ */ s(() => a(), "onClick"), children: e }) })
  ] });
}
s(to, "RetryableErrorView");
const Ia = St(({ className: t, ...e }, a) => /* @__PURE__ */ n(ue, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DuMP1-g4.js.map
