...
import { Slot as ut, Dialog as O, Popover as Z, Tooltip as X, Label as Vt, RadioGroup as lt, Separator as Kt, DropdownMenu as S } from "radix-ui";
import { IconX as Jt, IconSearch as Ut, IconCheck as wt, IconChevronRight as Xt } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as F } from "class-variance-authority";
import P, { useState as j, useRef as mt, useCallback as _, createContext as Wt, useContext as qt, useMemo as U, useEffect as Zt, Fragment as Yt, forwardRef as It } from "react";
import { ChevronsUpDown as Ct, Check as St, Star as Qt, Filter as te, ArrowRight as ee, Loader2 as ae, ChevronDown as re, Search as oe, X as ne, AlertTriangle as se, LoaderCircle as ie } from "lucide-react";
...
const ge = 600, Oa = 650, Et = 400, be = 450, Ne = 500, ve = 550, ja = 700, Tt = F(
...
function At({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ f(Ie, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ o(Se, { children: /* @__PURE__ */ o(Ut, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const { PortalContainerProvider: Le, usePortalContainer: Re } = Bt(), sr = Le;
function Ot({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
...
const { PortalContainerProvider: Be, usePortalContainer: Me } = Bt(), ur = Be;
function $t({
  className: t,
  sideOffset: e = 0,
...
const $e = ["input", "select", "textarea", "button"], He = ["button", "textbox"], vr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = mt(null), [s, i] = j(void 0), [l, w] = j(void 0), g = _(
    (m) => {
      i(m);
...
function Tr({
  ...
  return /* @__PURE__ */ f(
    S.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(Xt, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function jr({
  ...
  return /* @__PURE__ */ o("div", { id: x, className: v, children: /* @__PURE__ */ f(Mt, { open: C, onOpenChange: b ?? M, children: [
    ...
    /* @__PURE__ */ o(Ot, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Gt, { children: [
      /* @__PURE__ */ o(
        At,
        {
...
function ca({ row: t, mode: e, strings: a, onClick: r, onOpen: n, selectedRowRef: s }) {
  const {
    ...
    I(!1), g();
  }, [g]), B = /* @__PURE__ */ o(St, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let M;
  ...
  return /* @__PURE__ */ f(jt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ o(_t, { asChild: !0, children: J }),
    /* @__PURE__ */ f(
      $t,
      {
        side: "top",
...
function Kr(t) {
  const [e, a] = j(!1), [r, n] = j(""), [s, i] = j(t.defaultGroupByOpenTabs ?? !0), [l, w] = j(!1), g = mt(null), b = _((c) => {
    a(c), c || n("");
  }, []);
  Zt(() => {
    if (!e) return;
  ...
  const I = ia(t.localizedStrings), G = U(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  let T;
  t.isLoading ? T = /* @__PURE__ */ o(ae, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? T = void 0 : t.mode === "project-multi" ? T = /* @__PURE__ */ o(Ct, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : T = /* @__PURE__ */ o(re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), C = E.title ? /* @__PURE__ */ o(gt, { delayDuration: 400, children: /* @__PURE__ */ f(jt, { children: [
    /* @__PURE__ */ o(_t, { asChild: !0, children: /* @__PURE__ */ o(ct, { asChild: !0, children: V }) }),
          ...
          /* @__PURE__ */ f(Dt, { children: [
            ...
            v.map((c, u) => (
              ...
              /* @__PURE__ */ f(Yt, { children: [
                /* @__PURE__ */ o(Lt, { heading: wa(c, I), children: c.rows.map((p) => /* @__PURE__ */ o(
                  ca,
                  {
                    row: p,
                    mode: t.mode,
...
const Ur = (t, e, a) => pa(t, e).every((r) => a.includes(r));
function ha(t, e) {
  return [
...
const ka = It(({ className: t, ...e }, a) => /* @__PURE__ */ o(ie, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C93ywfdf.js.map
