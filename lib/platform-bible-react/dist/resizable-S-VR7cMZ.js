...
import { IconX as ke, IconCheck as Rt, IconSearch as Ie, IconChevronLeft as Ee, IconChevronRight as Te } from "@tabler/icons-react";
import { Canon as C } from "@sillsdev/scripture";
import { cva as rt } from "class-variance-authority";
import M, { useState as H, useRef as pt, useCallback as X, createContext as _e, useContext as Ce, useEffect as Ct, useMemo as at, Fragment as Le, forwardRef as Qt } from "react";
...
const Zo = Object.fromEntries(
  la.map((t) => [t, C.bookIdToEnglishName(t)])
);
function Yo(t, e, a) {
...
function vr({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        s === "rtl" ? /* @__PURE__ */ n(Ee, { className: "tw:ms-auto" }) : /* @__PURE__ */ n(Te, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function zr({
  ...
  const [V, tt] = H(!1), L = pt(null), et = X(
    (k) => {
      var B;
      const Y = (B = t.find((J) => J.label === k)) == null ? void 0 : B.value;
      Y && a(
        e.includes(Y) ? e.filter((J) => J !== Y) : [...e, Y]
      );
    },
    [t, e, a]
  ), P = () => m || o, x = f ?? V, U = y ?? tt, [W, Z] = H(x), [it, z] = H(e);
  W !== x && (Z(x), x && z(e));
  const ht = at(() => {
    if (!w) return t;
    const k = t.filter((B) => B.starred).sort((B, J) => B.label.localeCompare(J.label)), Y = t.filter((B) => !B.starred).sort((B, J) => {
      const bt = it.includes(B.value), Nt = it.includes(J.value);
      return bt && !Nt ? -1 : !bt && Nt ? 1 : B.label.localeCompare(J.label);
    });
    return [...k, ...Y];
  }, [t, it, w]), gt = () => {
  ...
  return /* @__PURE__ */ n("div", { id: F, className: h, children: /* @__PURE__ */ p(fe, { open: x, onOpenChange: U, children: [
    ...
    /* @__PURE__ */ n(he, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(le, { children: [
      ...
      /* @__PURE__ */ n(Pa, { isEnabled: g, scrollerRef: L, children: /* @__PURE__ */ p(de, { ref: L, children: [
...
function Za({
  ...
  const {
    ...
    w(!1), y();
  }, [y]), F = /* @__PURE__ */ n(ee, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let V;
  e === "project" ? t.openGroups.length > 0 && (V = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((P) => /* @__PURE__ */ n(St, { variant: "secondary", children: ft(P) }, P)) })) : t.scrollGroupId !== void 0 && (V = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Wa,
      {
...
function Xr(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = at(() => Xa(t.localizedStrings), [t.localizedStrings]), i = at(() => {
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, y = pt(null), [I, w] = H(void 0), g = X((c) => {
    a(c), c || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const N = at(() => t.mode === "project" ? Tt({
    ...
    (c) => c === void 0 ? void 0 : K.get(D(c)),
    [K]
  ), { renderProjectIndicator: V } = t, tt = X(
    (c) => V ? V(c.project) : void 0,
    [V]
  ), L = !!V, et = !!t.footerAction && h.length === 0, P = at(() => {
    if (f === ct) return Gt(h);
  ...
  const Y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, B = s.ariaLabel && z.hasSelection && z.title ? `${s.ariaLabel}: ${z.accessibleTitle ?? z.title}` : s.ariaLabel || void 0, J = /* @__PURE__ */ p(
    q,
    {
      ref: ht,
              ...
              /* @__PURE__ */ p(de, { children: [
                ...
                P.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(we, { heading: to(c, s), children: c.rows.map((j) => /* @__PURE__ */ n(
                          Za,
                          {
                            row: j,
                            mode: t.mode,
...
function ro(t, e) {
  ...
  ].filter((o) => C.bookIdToNumber(o) > 0).sort((o, r) => C.bookIdToNumber(o) - C.bookIdToNumber(r)).map((o) => ua(o, e));
}
function Zr(t, e, a, o) {
...
function tn({
  ...
  return /* @__PURE__ */ p(no, { className: d(s), role: r, children: [
    /* @__PURE__ */ p(so, { children: [
      /* @__PURE__ */ n(lo, { variant: "icon", children: o ?? /* @__PURE__ */ n(Be, {}) }),
      /* @__PURE__ */ n(co, { children: t })
    ] }),
    a && /* @__PURE__ */ n(uo, { children: /* @__PURE__ */ n(q, { onClick: () => a(), children: e }) })
  ] });
}
const wo = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Oe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-S-VR7cMZ.js.map
