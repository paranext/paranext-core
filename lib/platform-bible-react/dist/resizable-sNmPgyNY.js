...
function zr(t) {
  t && (t.setAttribute(Yt, ""), t.style.outline = "none");
}
function jr(t) {
  ...
  return /* @__PURE__ */ n(C.Portal, { children: /* @__PURE__ */ n(
    C.Content,
    {
      ...
      className: d(
        ...
        // This surface scrolls, and the blur layer scrolled away with its items while never covering
...
//# sourceMappingURL=resizable-sNmPgyNY.js.map
