...
import { Slot as vt, Dialog as $, Separator as ne, Popover as rt, Tooltip as Q, DropdownMenu as T, Label as se, RadioGroup as ft, ToggleGroup as Dt } from "radix-ui";
...
import G, { useState as K, useRef as dt, useCallback as F, createContext as ce, useContext as ue, useMemo as X, useEffect as Ct, Fragment as we, forwardRef as Ot } from "react";
...
import { Section as W, MODIFIER_KEYS as ye, normalizeProjectId as ot, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as et, localizedStringOrUndefined as Se, resolveLocalizedString as ke, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as Ee } from "platform-bible-utils";
...
const Mt = 600, Ht = 650, or = 400, je = 450, Ae = 500, Re = 675, nr = 690, sr = 700, ir = 800, Ut = J(
...
function Ft({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Be, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(He, { children: /* @__PURE__ */ n(le, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(T.ItemIndicator, { children: /* @__PURE__ */ n(xt, {}) })
          }
        ),
        e
      ]
...
const sa = ["input", "select", "textarea", "button"], ia = ["button", "textbox"], Yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function lo({
  ...
  const [O, V] = K(!1), R = F(
    (S) => {
      var c;
      const D = (c = t.find((p) => p.label === S)) == null ? void 0 : c.value;
      D && a(
        e.includes(D) ? e.filter((p) => p !== D) : [...e, D]
      );
    },
    [t, e, a]
  ), M = () => u || r, _ = X(() => {
    if (!C) return t;
    const S = t.filter((c) => c.starred).sort((c, p) => c.label.localeCompare(p.label)), D = t.filter((c) => !c.starred).sort((c, p) => {
...
function Ca({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
  ...
  return /* @__PURE__ */ m(kt, { open: w, delayDuration: 400, children: [
    /* @__PURE__ */ n(It, { asChild: !0, children: V }),
    /* @__PURE__ */ m(
      Et,
      {
        side: "top",
...
function Ga({
  ...
  return /* @__PURE__ */ m(Qe, { children: [
    /* @__PURE__ */ m(kt, { children: [
      /* @__PURE__ */ n(It, { asChild: !0, children: /* @__PURE__ */ n(ta, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
...
function vo(t) {
  const [e, a] = K(!1), [r, o] = K(""), s = X(() => Ea(t.localizedStrings), [t.localizedStrings]), i = X(() => {
  ...
  const w = X(() => t.mode === "project" ? mt({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), g = X(() => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, I = ot(c.projectId), E = (j) => ot(j.projectId) === I && j.scrollGroupId === c.scrollGroupId, L = p.some(E) ? p.filter((j) => !E(j)) : [
          ...p.filter((j) => !E(j)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((L) => {
          const j = t.projects.find((re) => re.id === L.projectId);
          j && p.push({ project: j, scrollGroupId: L.scrollGroupId });
        }), p.length === 0) {
          const L = s.buttonPlaceholder;
          return { node: L, title: L };
        }
        const I = p.map(
          ({ project: L, scrollGroupId: j }) => j === void 0 ? L.shortName : `${L.shortName} (${st(j)})`
  ...
  Ct(() => {
    ...
    const I = new ResizeObserver((E) => {
      E.forEach((L) => {
        const [j] = L.borderBoxSize;
        p(j ? j.inlineSize : c.getBoundingClientRect().width);
      });
    });
  ...
  ), S = R.title ? /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(kt, { children: [
    /* @__PURE__ */ n(It, { asChild: !0, children: /* @__PURE__ */ n(gt, { asChild: !0, children: P }) }),
    /* @__PURE__ */ n(Et, { children: R.title })
  ] }) }) : /* @__PURE__ */ n(gt, { asChild: !0, children: P }), D = i.length > 1;
  return /* @__PURE__ */ m(Zt, { open: e, onOpenChange: C, children: [
    ...
    /* @__PURE__ */ n(
      Yt,
      {
        ...
        children: /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(Kt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Jt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Xt, { heading: La(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      Ca,
                      {
                        row: I,
                        mode: t.mode,
...
const yo = (t, e, a) => Ra(t, e).every((r) => a.includes(r));
function Da(t, e) {
  return [
...
function Eo({
  ...
  return /* @__PURE__ */ m(Oa, { className: d(s), role: o, children: [
    /* @__PURE__ */ m(Pa, { children: [
      /* @__PURE__ */ n(Ma, { variant: "icon", children: r ?? /* @__PURE__ */ n(ve, {}) }),
      /* @__PURE__ */ n(Ha, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ua, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const $a = Ot(({ className: t, ...e }, a) => /* @__PURE__ */ n(xe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BL-MJIYA.js.map
