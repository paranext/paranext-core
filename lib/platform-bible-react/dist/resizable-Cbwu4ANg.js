import { jsx as n, jsxs as m, Fragment as ne } from "react/jsx-runtime";
import { Slot as xt, Dialog as F, Separator as se, Popover as nt, Tooltip as et, DropdownMenu as _, Label as ie, RadioGroup as ht, ToggleGroup as Bt } from "radix-ui";
import { IconX as le, IconSearch as de, IconCheck as St, IconChevronRight as ce } from "@tabler/icons-react";
import { Canon as j } from "@sillsdev/scripture";
import { cva as X } from "class-variance-authority";
import z, { useState as V, useRef as ut, useCallback as J, createContext as ue, useContext as we, useMemo as Z, useEffect as Gt, Fragment as pe, forwardRef as Pt } from "react";
import { ChevronsUpDown as Ot, Check as Mt, Star as me, Group as fe, ArrowRight as ge, Loader2 as he, ChevronDown as be, Search as Ne, X as ve, AlertTriangle as xe, LoaderCircle as Se } from "lucide-react";
import { Section as q, MODIFIER_KEYS as ye, normalizeProjectId as st, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as rt, isResolvedLocalizedValue as ke, resolveLocalizedString as G, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as Ee } from "platform-bible-utils";
import { filterAndRankItems as Lt } from "@eten-tech-foundation/platform-editor";
...
function ze(t, e) {
  ...
  const a = bt(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), o = a[a.length - 1], s = bt(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const u = o.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
const Ht = 600, Ut = 650, rr = 400, je = 450, Ae = 500, Re = 675, or = 690, nr = 700, sr = 800, $t = X(
  ...
  return /* @__PURE__ */ m(De, { children: [
    ...
    /* @__PURE__ */ m(
      F.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(F.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m($, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(le, {}),
...
function pr({
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(F.Close, { asChild: !0, children: /* @__PURE__ */ n($, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Qe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(te.Provider, { value: r, children: /* @__PURE__ */ n(_.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Dr({
  ...t
}) {
  return /* @__PURE__ */ n(_.Portal, { "data-slot": "dropdown-menu-portal", ...t });
}
function ta({
  ...t
}) {
  return /* @__PURE__ */ n(_.Trigger, { "data-slot": "dropdown-menu-trigger", ...t });
}
function ea({
  className: t,
  align: e = "start",
  ...
  const i = H();
  return /* @__PURE__ */ n(_.Portal, { children: /* @__PURE__ */ n(
    _.Content,
    {
...
function Br({ ...t }) {
  return /* @__PURE__ */ n(_.Group, { "data-slot": "dropdown-menu-group", ...t });
}
function Pr({
  className: t,
  inset: e,
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(_.ItemIndicator, { children: /* @__PURE__ */ n(St, {}) })
          }
        ),
        e
      ]
...
function aa({
  ...
  return /* @__PURE__ */ n(_.RadioGroup, { "data-slot": "dropdown-menu-radio-group", ...t });
}
function At({
  className: t,
  children: e,
...
function Hr({ ...t }) {
  return /* @__PURE__ */ n(_.Sub, { "data-slot": "dropdown-menu-sub", ...t });
}
function Ur({
  className: t,
  inset: e,
...
const sa = ["input", "select", "textarea", "button"], ia = ["button", "textbox"], qr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = ut(null), [s, i] = V(void 0), [l, u] = V(void 0), f = J(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || sa.includes(h)) return !0;
    ...
    (w) => {
      var K;
      const h = w.target, v = (S) => S ? document.getElementById(S) : void 0, b = v(l), O = v(s);
      if (!!(b && h && b.contains(h) && h !== b) && k(h)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !h.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const S = t.find((M) => M.id === l);
            S && f(S.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          if (M === -1) return;
          let y;
          w.key === "ArrowDown" ? y = Math.min(M + 1, S.length - 1) : y = Math.max(M - 1, 0), y !== M && (w.preventDefault(), w.stopPropagation(), (K = S[y]) == null || K.focus());
          return;
        }
        return;
      }
      const U = t.findIndex((S) => S.id === s);
      let T = U;
      switch (w.key) {
        case "ArrowDown":
          T = Math.min(U + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          T = Math.max(U - 1, 0), w.preventDefault();
          break;
        case "Home":
  ...
  const l = z.useMemo(
    ...
    (g) => {
      ...
      if (g.key === "ArrowDown" || g.key === "ArrowUp")
        g.preventDefault(), ua(w, h, g.key);
      else if (g.key === "ArrowLeft" || g.key === "ArrowRight")
        g.preventDefault(), ca(l, v, g.key);
...
function io({
  ...
  const [O, W] = V(!1), B = J(
    (y) => {
      var c;
      const P = (c = t.find((p) => p.label === y)) == null ? void 0 : c.value;
      P && a(
    ...
    if (!C) return t;
    const y = t.filter((c) => c.starred).sort((c, p) => c.label.localeCompare(p.label)), P = t.filter((c) => !c.starred).sort((c, p) => {
  ...
  return /* @__PURE__ */ n("div", { id: b, className: h, children: /* @__PURE__ */ m(qt, { open: S, onOpenChange: g ?? W, children: [
    /* @__PURE__ */ n(Nt, { asChild: !0, children: /* @__PURE__ */ m(
      $,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n(Ot, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(Qt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Ft, { children: [
      ...
      o && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n($, { variant: "ghost", size: "sm", onClick: tt, children: s }),
        /* @__PURE__ */ n($, { variant: "ghost", size: "sm", onClick: K, children: i })
      ] }),
      /* @__PURE__ */ m(Jt, { children: [
        /* @__PURE__ */ n(Xt, { children: l }),
        /* @__PURE__ */ n(Wt, { children: T.map((y) => /* @__PURE__ */ m(
          Zt,
          {
            value: y.label,
            onSelect: B,
            ...
            children: [
              ...
              y.starred && /* @__PURE__ */ n(me, { className: "tw:h-4 tw:w-4" }),
...
function lo(t, e, a) {
  ...
  if (pa(t) || ye.has(t.key) || t.key === "Dead")
    return "passed";
...
const _t = "Selected", Ct = "Unselected";
function Dt(t) {
...
function Na(t, e) {
  const a = t.filter((i) => i.isSelected).sort(Y), r = t.filter((i) => !i.isSelected).sort(Y), o = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? _t : Ct;
  }, s = [];
...
function va(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    var k;
    const f = [...u].sort(Y), g = ((k = e.getSectionHeading) == null ? void 0 : k.call(
      e,
      l,
      f.map((C) => C.project)
    )) ?? l;
...
function x(t, e) {
  const a = t[e];
  if (!(typeof a != "string" || !ke(a)))
    return a;
}
const dt = "recent", xa = "other";
function re(t) {
  return {
    id: "openTabs",
    label: t ?? "Open tabs"
...
function Sa(t) {
  ...
  return [
    re(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[rt.lastUsedAt]) == "number" ? dt : xa;
      },
    ...
    },
    {
      ...
      getSectionHeading: (a, r) => {
        ...
        const o = r.find(
          (l) => {
            var u;
            return typeof ((u = l.customData) == null ? void 0 : u[rt.typeName]) == "string";
          }
...
function ya(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? _t : e.unselectedSectionHeading ?? Ct
  };
}
function go(t) {
  return {
...
const ka = 100, L = {
  ...
  autoSelectionSelectedSectionHeading: _t,
...
function Ia(t) {
  ...
  return {
    ...
    ariaLabel: e.ariaLabel === "" ? "" : G(e.ariaLabel, L.ariaLabel),
    buttonPlaceholder: G(
      e.buttonPlaceholder,
      L.buttonPlaceholder
    ),
    commandEmptyMessage: G(
      e.commandEmptyMessage,
      L.commandEmptyMessage
    ),
    searchPlaceholder: G(
      e.searchPlaceholder,
      L.searchPlaceholder
    ...
    groupByNone: G(e.groupByNone, L.groupByNone),
    openTabsSectionHeading: G(
      e.openTabsSectionHeading,
      L.openTabsSectionHeading
    ),
    otherProjectsSectionHeading: G(
      e.otherProjectsSectionHeading,
      L.otherProjectsSectionHeading
    ),
    autoOpenTabsGroupingLabel: G(
      e.autoOpenTabsGroupingLabel,
      L.autoOpenTabsGroupingLabel
    ),
    autoSelectionGroupingLabel: G(
      e.autoSelectionGroupingLabel,
      L.autoSelectionGroupingLabel
    ),
    autoSelectionSelectedSectionHeading: G(
      e.autoSelectionSelectedSectionHeading,
      L.autoSelectionSelectedSectionHeading
    ),
    autoSelectionUnselectedSectionHeading: G(
      e.autoSelectionUnselectedSectionHeading,
      L.autoSelectionUnselectedSectionHeading
    ),
    boundButClosedTooltip: G(
      e.boundButClosedTooltip,
      L.boundButClosedTooltip
    ),
    openButtonLabel: G(e.openButtonLabel, L.openButtonLabel),
    clearAll: G(e.clearAll, L.clearAll)
  };
}
function bo(t) {
  return {
...
function _a({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: f
  } = Ye(), [g, k] = V(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || g, h = J(() => {
    if (C) {
      k(!0);
      return;
    }
    ...
    k(!1), f();
  }, [f]), b = /* @__PURE__ */ n(Mt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
  e === "project" ? t.openGroups.length > 0 && (O = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((T) => /* @__PURE__ */ n(wt, { variant: "secondary", children: lt(T) }, T)) })) : t.scrollGroupId !== void 0 && (O = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ta,
      {
  ...
  ), B = t.scrollGroupId !== void 0 ? lt(t.scrollGroupId) : void 0, U = t.isBoundButClosed && B ? a.boundButClosedTooltip.replace("{group}", B) : void 0;
  return /* @__PURE__ */ m(It, { open: w, delayDuration: 400, children: [
    /* @__PURE__ */ n(Et, { asChild: !0, children: W }),
    /* @__PURE__ */ m(
      Tt,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && B && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
          ...
          U && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: U }),
...
function Ca({
  ...
  return /* @__PURE__ */ m(Qe, { children: [
    /* @__PURE__ */ m(It, { children: [
      ...
      /* @__PURE__ */ n(Tt, { children: r.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      ea,
      {
...
function No(t) {
  const [e, a] = V(!1), [r, o] = V(""), s = Z(() => Ia(t.localizedStrings), [t.localizedStrings]), i = Z(() => {
  ...
  const w = Z(() => t.mode === "project" ? gt({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), h = Z(() => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, I = st(c.projectId), E = (R) => st(R.projectId) === I && R.scrollGroupId === c.scrollGroupId, A = p.some(E) ? p.filter((R) => !E(R)) : [
          ...p.filter((R) => !E(R)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((A) => {
          const R = t.projects.find((oe) => oe.id === A.projectId);
          R && p.push({ project: R, scrollGroupId: A.scrollGroupId });
        }), p.length === 0) {
          const A = s.buttonPlaceholder;
          return { node: A, title: A };
        }
        const I = p.map(
          ({ project: A, scrollGroupId: R }) => R === void 0 ? A.shortName : `${A.shortName} (${lt(R)})`
        ).join(", "), E = p.length.toString();
        return {
          node: /* @__PURE__ */ m(ne, { children: [
            /* @__PURE__ */ n(wt, { variant: "muted", className: "tw:shrink-0", children: E }),
      ...
      case "projectScrollGroup": {
        ...
        const I = `${c.shortName} · ${lt(p)}`;
        return { node: I, title: I };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t, s.buttonPlaceholder]), U = ut(null), [T, tt] = V(!1);
  Gt(() => {
    const c = U.current;
    if (!c) return;
    const p = (E) => {
    ...
    const I = new ResizeObserver((E) => {
      E.forEach((A) => {
        const [R] = A.borderBoxSize;
        p(R ? R.inlineSize : c.getBoundingClientRect().width);
      });
    });
    return I.observe(c, { box: "border-box" }), () => I.disconnect();
  }, []);
  let K;
  t.isLoading ? K = /* @__PURE__ */ n(he, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : T ? K = void 0 : t.mode === "project-multi" ? K = /* @__PURE__ */ n(Ot, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : K = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const S = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, M = /* @__PURE__ */ m(
    $,
    {
      ref: U,
      ...
      className: d(
        ...
        // wide case.
        T && "tw:px-0.5 tw:text-xs",
        t.buttonClassName
      ),
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof B.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: B.node }) : B.node }),
        K
      ]
    }
  ), y = B.title ? /* @__PURE__ */ n(jt, { delayDuration: 400, children: /* @__PURE__ */ m(It, { children: [
    /* @__PURE__ */ n(Et, { asChild: !0, children: /* @__PURE__ */ n(Nt, { asChild: !0, children: M }) }),
    /* @__PURE__ */ n(Tt, { children: B.title })
  ] }) }) : /* @__PURE__ */ n(Nt, { asChild: !0, children: M }), P = i.length > 1;
  return /* @__PURE__ */ m(qt, { open: e, onOpenChange: C, children: [
    y,
    /* @__PURE__ */ n(
      Qt,
      {
        ...
        children: /* @__PURE__ */ n(jt, { delayDuration: 400, children: /* @__PURE__ */ m(Ft, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n($, { variant: "ghost", size: "sm", onClick: W, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
          /* @__PURE__ */ m(Jt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Wt, { heading: La(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      _a,
                      {
                        row: I,
                        mode: t.mode,
...
function Io({
  ...
  return /* @__PURE__ */ m(Da, { className: d(s), role: o, children: [
    /* @__PURE__ */ m(Ba, { children: [
      /* @__PURE__ */ n(Oa, { variant: "icon", children: r ?? /* @__PURE__ */ n(xe, {}) }),
      /* @__PURE__ */ n(Ma, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ha, { children: /* @__PURE__ */ n($, { onClick: () => a(), children: e }) })
  ] });
}
const Ua = Pt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-Cbwu4ANg.js.map
