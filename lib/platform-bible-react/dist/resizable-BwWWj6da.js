...
import { Slot as mt, Popover as H, Tooltip as _, Separator as Ct, DropdownMenu as G } from "radix-ui";
import Y, { useRef as nt, useState as R, useCallback as O, createContext as St, useContext as Gt, useEffect as zt, useMemo as A, Fragment as jt } from "react";
import { Filter as Dt, Check as Tt, ArrowRight as Et, Loader2 as Rt, ChevronsUpDown as $t, ChevronDown as Bt } from "lucide-react";
import { getLocalizeKeyForScrollGroupId as Pt } from "platform-bible-utils";
import "@sillsdev/scripture";
import "@eten-tech-foundation/scripture-utilities";
import { cva as W } from "class-variance-authority";
import { Command as $ } from "cmdk";
import { IconSearch as _t, IconCheck as rt, IconChevronRight as Mt } from "@tabler/icons-react";
import * as at from "react-resizable-panels";
import { clsx as Lt } from "clsx";
import { extendTailwindMerge as At, twMerge as Ot } from "tailwind-merge";
const Vt = At({ prefix: "tw" });
function ot(t) {
  const e = [];
  let n = "", i = 0;
...
function g(...t) {
  const e = Lt(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return Vt(e);
  const n = e.split(" ").filter(Boolean), i = /* @__PURE__ */ new Map(), o = [];
  return n.forEach((d) => {
    const l = Ft(d);
    i.set(l.normalized, l.original), o.push(l.normalized);
  }), Ot(o.join(" ")).split(" ").filter(Boolean).map((d) => {
    const l = i.get(d);
    return l ? Ht(d, l) : d;
  }).join(" ");
}
const qt = 600, _e = 300, gt = 400, Me = 450, Le = 500, Kt = 550, ht = W(
...
function Yt({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: i, children: /* @__PURE__ */ I(Wt, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ r(Zt, { children: /* @__PURE__ */ r(_t, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const vt = Y.createContext(null);
function Ve({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ r(vt.Provider, { value: t, children: e });
}
function re({
  className: t,
  align: e = "center",
...
const ae = ["input", "select", "textarea", "button"], ie = ["button", "textbox"], Ue = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: n,
  onCharacterPress: i
...
function de({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(Nt.Provider, { value: i, children: /* @__PURE__ */ r(G.Root, { "data-slot": "dropdown-menu", dir: n, ...e }) });
}
function Ze({
  ...t
}) {
...
function oo({
  ...
  return /* @__PURE__ */ I(
    G.SubTrigger,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ r(Mt, { className: "tw:ms-auto" })
      ]
    }
  );
}
function no({ className: t, children: e, ...n }) {
  const i = E();
  return /* @__PURE__ */ r(
    G.SubContent,
    {
...
function ye({ row: t, mode: e, strings: n, onClick: i, onOpen: o, selectedRowRef: a }) {
  ...
  }, [w]), N = /* @__PURE__ */ r(Tt, { className: g("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let c;
  e === "project" ? t.openGroups.length > 0 && (c = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((z) => /* @__PURE__ */ r(X, { variant: "secondary", children: K(z) }, z)) })) : t.scrollGroupId !== void 0 && (c = /* @__PURE__ */ I("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ I(
      V,
      {
        ...
        children: [
          /* @__PURE__ */ r(Et, { className: "tw:h-3 tw:w-3" }),
          n.openButtonLabel
        ]
      }
    )
  ...
  return /* @__PURE__ */ I(xt, { open: u, delayDuration: 400, children: [
    /* @__PURE__ */ r(It, { asChild: !0, children: v }),
    /* @__PURE__ */ I(
      yt,
      {
        side: "top",
...
function ao(t) {
  ...
  const m = ve(t.localizedStrings), N = A(() => t.mode === "project" ? et({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (s.forEach((x) => {
          const L = t.projects.find((kt) => kt.id === x.projectId);
  ...
  let j;
  t.isLoading ? j = /* @__PURE__ */ r(Rt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? j = void 0 : t.mode === "project-multi" ? j = /* @__PURE__ */ r($t, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : j = /* @__PURE__ */ r(Bt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), k = D.title ? /* @__PURE__ */ r(st, { delayDuration: 400, children: /* @__PURE__ */ I(xt, { children: [
    /* @__PURE__ */ r(It, { asChild: !0, children: /* @__PURE__ */ r(it, { asChild: !0, children: P }) }),
    /* @__PURE__ */ r(yt, { children: D.title })
...
//# sourceMappingURL=resizable-BwWWj6da.js.map
