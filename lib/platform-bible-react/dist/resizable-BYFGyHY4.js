...
import A, { useState as W, useRef as yt, useCallback as K, createContext as me, useContext as fe, useMemo as Y, useEffect as pe, Fragment as he, forwardRef as Mt } from "react";
...
function La({
  ...
  const {
    ...
    u(!1), v();
  }, [v]), tt = /* @__PURE__ */ n(jt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let _;
...
function vo(t) {
  ...
  const u = Ta(t.localizedStrings), b = Y(() => t.mode === "project" ? ht({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    [N]
  ), { renderProjectIndicator: P } = t, tt = K(
    (w) => {
      if (!P) return;
    ...
    [P, T]
  ), { lastUsedRecentSectionHeading: _ } = u, { lastUsedOtherSectionHeading: j } = u, { languageUnknownSectionHeading: U } = u, { versificationUnknownSectionHeading: F } = u, { typeUnknownSectionHeading: x } = u, { customUnmatchedSectionHeading: $ } = u, C = Y(() => {
    switch (l) {
      case "openTabs":
        return Ot(g, !0);
      case "lastUsed":
...
//# sourceMappingURL=resizable-BYFGyHY4.js.map
