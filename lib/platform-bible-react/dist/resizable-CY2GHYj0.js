...
import { Slot as wt, Dialog as M, Popover as W, Label as Ut, RadioGroup as dt, Tooltip as X, ToggleGroup as Et, Separator as Xt, DropdownMenu as z } from "radix-ui";
...
import G, { useRef as mt, useState as B, useCallback as $, createContext as Qt, useContext as te, useMemo as U, useEffect as ee, Fragment as ae, forwardRef as St } from "react";
...
const ge = 600, va = 300, Gt = 400, be = 450, ve = 500, Ne = 550, Na = 650, xa = 700, Dt = V(
...
function ze() {
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", c = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", E = "\\u200d", P = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", O = `[${l}]`, j = `${I}?`, S = `[${c}]?`, T = `(?:${E}(?:${[f, N, x].join("|")})${S + j})*`, D = S + j + T, C = `(?:${[`${f}${m}?`, m, N, x, d, O].join("|")})`;
    return new RegExp(`${P}|${h}(?=${h})|${C + D}`, "g");
  }), it;
}
var bt;
function Ge() {
...
const Pe = ["input", "select", "textarea", "button"], je = ["button", "textbox"], or = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const o = mt(null), [s, i] = B(void 0), [c, l] = B(void 0), d = $(
    ...
    if (f.isContentEditable || Pe.includes(N)) return !0;
    ...
    (f) => {
      var H;
      const N = f.target, x = (C) => C ? document.getElementById(C) : void 0, E = x(c), P = x(s);
  ...
  return /* @__PURE__ */ n("div", { id: E, className: N, children: /* @__PURE__ */ g(Bt, { open: C, onOpenChange: m ?? O, children: [
    ...
    /* @__PURE__ */ n($t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(At, { children: [
      ...
      /* @__PURE__ */ g(Ot, { children: [
        /* @__PURE__ */ n(Mt, { children: c }),
        /* @__PURE__ */ n(Pt, { children: T.map((p) => /* @__PURE__ */ g(
          jt,
          {
            value: p.label,
            onSelect: j,
...
function aa({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: d
  } = Xe(), [m, h] = B(!1), I = !!(t.language || t.languageCode), f = I || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = c || m, x = $(() => {
    if (f) {
      h(!0);
      return;
    }
    ...
    h(!1), d();
  }, [d]), P = /* @__PURE__ */ n(zt, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
...
function Er(t) {
  ...
  const h = Qe(t.localizedStrings), I = U(() => t.mode === "project" ? lt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), f = U(() => {
          ...
          /* @__PURE__ */ g(Ot, { children: [
            ...
            N.map((u, p) => (
              ...
              /* @__PURE__ */ g(ae, { children: [
                /* @__PURE__ */ n(Pt, { heading: oa(u, h), children: u.rows.map((b) => /* @__PURE__ */ n(
                  aa,
                  {
                    row: b,
                    mode: t.mode,
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-C3AVzTx2.js
//# sourceMappingURL=resizable-C3AVzTx2.js.map
|||||||| parent of 8c57757775a (chore(PT-4262): rebuild platform-bible-react dist after rebase onto main):lib/platform-bible-react/dist/resizable-C2eEiE_z.js
//# sourceMappingURL=resizable-C2eEiE_z.js.map
========
//# sourceMappingURL=resizable-CY2GHYj0.js.map
>>>>>>>> 8c57757775a (chore(PT-4262): rebuild platform-bible-react dist after rebase onto main):lib/platform-bible-react/dist/resizable-CY2GHYj0.js
