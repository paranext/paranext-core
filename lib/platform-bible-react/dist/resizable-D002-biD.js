...
import z, { useState as X, useRef as xt, useCallback as K, createContext as we, useContext as me, useMemo as Q, useEffect as fe, Fragment as pe, forwardRef as Bt } from "react";
import { cva as W } from "class-variance-authority";
import { ChevronsUpDown as Pt, Check as Ot, Star as he, SlidersHorizontal as ge, ArrowRight as be, Loader2 as Ne, ChevronDown as ve, Search as xe, X as ye, AlertTriangle as ke, LoaderCircle as Ie } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as Se, normalizeProjectId as F, getLocalizeKeyForScrollGroupId as Ce, getSectionForBook as Ee } from "platform-bible-utils";
...
const Re = 600, Mt = 650, dr = 400, Be = 450, Pe = 500, Oe = 550, cr = 650, ur = 700, jt = W(
...
function _({
  ...
  return /* @__PURE__ */ o(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(jt({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
const _t = "layoutDirection";
function U() {
  ...
  return /* @__PURE__ */ f(Me, { children: [
    ...
    /* @__PURE__ */ f(
      J.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(J.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(_, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(de, {}),
...
function _e({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ o(
    "input",
    {
      type: e,
...
function Zt({
  ...
  return /* @__PURE__ */ o(
    et.Trigger,
    {
      ...
      className: e ? d(jt({ variant: e }), t) : t,
      ...a
    }
  );
}
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ f(Jt, { open: x, onOpenChange: h ?? $, children: [
    /* @__PURE__ */ o(bt, { asChild: !0, children: /* @__PURE__ */ f(
      _,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Pt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(Wt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Ut, { children: [
      ...
      /* @__PURE__ */ f(Ht, { children: [
        ...
        /* @__PURE__ */ o(Ft, { children: O.map((C) => /* @__PURE__ */ f(
          Kt,
          {
            value: C.label,
            onSelect: Y,
...
function Da({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = Ze(), [S, u] = X(!1), b = !!(t.language || t.languageCode), g = b || !!t.typeName || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = m || S, A = K(() => {
    if (g) {
      u(!0);
      return;
    }
    ...
    u(!1), v();
  }, [v]), Y = /* @__PURE__ */ o(Ot, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let P;
  ...
  return /* @__PURE__ */ f(qt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(Zt, { asChild: !0, children: O }),
    /* @__PURE__ */ f(
      Yt,
      {
        side: "top",
            ...
            /* @__PURE__ */ f(
              la,
              {
                ...
                children: [
                  ...
                  t.map((c) => /* @__PURE__ */ o(Et, { value: c, children: Ba(c, i) }, c))
                ]
              }
            )
          ] }),
...
function gn(t) {
  ...
  const u = Ta(t.localizedStrings), b = Q(() => t.mode === "project" ? ft({
    ...
    [A, N]
  ), Y = u.lastUsedRecentSectionHeading, P = u.lastUsedOtherSectionHeading, O = u.languageUnknownSectionHeading, M = u.versificationUnknownSectionHeading, H = u.typeUnknownSectionHeading, x = u.customUnmatchedSectionHeading, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Dt(g, !0);
      case "lastUsed":
  ...
  ), oe = q.title ? /* @__PURE__ */ o(Ct, { delayDuration: 400, children: /* @__PURE__ */ f(qt, { children: [
    /* @__PURE__ */ o(Zt, { asChild: !0, children: /* @__PURE__ */ o(bt, { asChild: !0, children: It }) }),
    /* @__PURE__ */ o(Yt, { children: q.title })
          ...
          /* @__PURE__ */ f(Ht, { children: [
            ...
            j.map((w, p) => (
              ...
              /* @__PURE__ */ f(pe, { children: [
                /* @__PURE__ */ o(Ft, { heading: Oa(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Da,
                  {
                    row: y,
                    mode: t.mode,
...
const Xa = Bt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ie, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-D002-biD.js.map
