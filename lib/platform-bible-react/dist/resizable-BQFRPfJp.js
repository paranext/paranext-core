...
import { Slot as _t, Dialog as q, Separator as _e, Popover as ut, Tooltip as rt, DropdownMenu as E, Label as Te, RadioGroup as yt, ToggleGroup as qt } from "radix-ui";
import { IconX as Ce, IconCheck as Tt, IconSearch as Ae, IconChevronRight as Le } from "@tabler/icons-react";
import { Canon as A } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import C, { createContext as Wt, useContext as Yt, useState as Z, useRef as ht, useCallback as J, useMemo as Q, useEffect as Mt, Fragment as ze, forwardRef as Qt } from "react";
import { ChevronsUpDown as te, Check as ee, Star as Ge, Group as je, ArrowRight as Re, Loader2 as Oe, ChevronDown as Pe, Search as De, X as Be, AlertTriangle as Me, LoaderCircle as He } from "lucide-react";
import { Section as et, MODIFIER_KEYS as Ue, normalizeProjectId as M, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, getLocalizeKeyForScrollGroupId as $e, getSectionForBook as Fe } from "platform-bible-utils";
...
function qe(t, e) {
  ...
  const a = St(t);
  if (a[0] !== "tw") return t;
  const o = a.slice(1, -1), n = a[a.length - 1], s = St(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && n.startsWith("-")) {
    const u = n.slice(1);
    return [...o, `-tw-${u}`].join(":");
  }
...
function d(...t) {
  ...
  }), Je(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? qe(u, m) : u;
  }).join(" ");
}
const ae = 600, oe = 650, _o = 400, We = 450, Ye = 500, To = 510, Co = 520, Qe = 675, Ao = 690, Lo = 700, zo = 800, re = tt(
...
function X({
  ...
  return /* @__PURE__ */ r(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(re({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
const ne = "layoutDirection";
function se() {
...
function U() {
  var t;
  try {
    const e = (t = se()) == null ? void 0 : t.getItem(ne);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function Po({
  ...
  return /* @__PURE__ */ p(ta, { children: [
    /* @__PURE__ */ r(ea, { className: o, style: n }),
    /* @__PURE__ */ p(
      q.Content,
      {
...
function le({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(oa, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ r(
        ot.Input,
        {
      ...
      /* @__PURE__ */ r(na, { children: /* @__PURE__ */ r(Ae, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function At({
  ...
  return /* @__PURE__ */ p(
    ot.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(Tt, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
function $o(t, e, a) {
  ...
  if (s)
    return {
      book: s,
      chapterNum: Math.max(Lt(s), 1),
      verseNum: 1
    };
}
function Fo(t, e, a) {
  const { book: o, chapterNum: n } = t;
  if (e.includes(o) && n < Lt(o))
    return { book: o, chapterNum: n + 1, verseNum: 1 };
  const s = bt(o, e, "next");
  if (s)
...
const Wo = Object.fromEntries(
  la.map((t) => [t, A.bookIdToEnglishName(t)])
);
function Yo(t, e, a) {
...
const we = "data-quiet-focus";
function ar(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(we, ""), t.style.outline = "none"));
}
function or(t) {
  t && (t.removeAttribute(we), t.style.removeProperty("outline"));
}
...
const lr = "data-platform-content-zoom-root", dr = "data-platform-content-zoom-popup", fa = "--platform-content-zoom-", ha = "--platform-content-zoom-default", ga = "main", ba = "--platform-content-zoom-popup-factor", pe = Wt(void 0);
function cr({ area: t, children: e }) {
  return /* @__PURE__ */ r(pe.Provider, { value: t ?? "", children: e });
}
function zt() {
  return Yt(pe);
}
...
function he({
  ...
  const s = U(), i = C.useContext(fe), l = zt();
  return (
...
function Rt({
  ...
  return /* @__PURE__ */ r(
    rt.Trigger,
    {
      ...
      className: e ? d(re({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const va = /^%[^%]*%$/;
function ge(t) {
  return t !== void 0 && !va.test(t) && t.trim() !== "";
}
function _(t, e) {
  return ge(t) ? t : e;
}
...
function xa({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(be.Provider, { value: o, children: /* @__PURE__ */ r(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function hr({
  ...t
}) {
...
const Sa = "min(8rem, calc(max(var(--radix-dropdown-menu-content-available-width, 100vw), 8rem) / var(--platform-content-zoom-popup-factor, 1)))";
function Ia({
  className: t,
  align: e = "start",
  sideOffset: a = 4,
      ...
      children: [
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: /* @__PURE__ */ r(E.ItemIndicator, { children: /* @__PURE__ */ r(Tt, {}) })
          }
        ),
        e
      ]
...
function yr({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ r(Le, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const Ca = ["input", "select", "textarea", "button"], Aa = ["button", "textbox"], Lr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const n = ht(null), [s, i] = Z(void 0), [l, u] = Z(void 0), m = J(
    ...
    if (w.isContentEditable || Ca.includes(g)) return !0;
    const N = w.getAttribute("role");
    if (N && Aa.includes(N)) return !0;
    const h = w.getAttribute("tabindex");
    return h !== void 0 && h !== "-1";
  }, k = J(
    (w) => {
      var R;
      const g = w.target, N = (y) => y ? document.getElementById(y) : void 0, h = N(l), $ = N(s);
      if (!!(h && g && h.contains(g) && g !== h) && I(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const y = t.find((V) => V.id === l);
            y && m(y.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const V = y.findIndex((L) => L === g);
          if (V === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(V + 1, y.length - 1) : S = Math.max(V - 1, 0), S !== V && (w.preventDefault(), w.stopPropagation(), (R = y[S]) == null || R.focus());
          return;
        }
        return;
      }
      const W = t.findIndex((y) => y.id === s);
      let j = W;
      switch (w.key) {
        case "ArrowDown":
          j = Math.min(W + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(W - 1, 0), w.preventDefault();
          break;
        case "Home":
        ...
        case "ArrowRight": {
          const y = $;
          if (y) {
            const V = y.querySelector(
              'input:not([disabled]):not([type="hidden"]), textarea:not([disabled]), select:not([disabled])'
            ), S = y.querySelector(
              'button:not([disabled]), [href], [tabindex]:not([tabindex="-1"]), [contenteditable="true"]'
            ), L = V ?? S;
            if (L) {
              w.preventDefault(), L.focus();
              return;
            }
          }
          break;
  ...
  const l = C.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), ja(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), Ga(l, N, f.key);
...
function Hr({
  ...
  const [$, F] = Z(!1), K = J(
    (S) => {
      var O;
      const L = (O = t.find((P) => P.label === S)) == null ? void 0 : O.value;
      L && a(
    ...
    if (!k) return t;
    const S = t.filter((O) => O.starred).sort((O, P) => O.label.localeCompare(P.label)), L = t.filter((O) => !O.starred).sort((O, P) => {
      const st = e.includes(O.value), it = e.includes(P.value);
      return st && !it ? -1 : !st && it ? 1 : O.label.localeCompare(P.label);
    });
    return [...S, ...L];
  }, [t, e, k]), Y = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ r("div", { id: h, className: g, children: /* @__PURE__ */ p(me, { open: y, onOpenChange: f ?? F, children: [
    /* @__PURE__ */ r(kt, { asChild: !0, children: /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(te, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(he, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ie, { children: [
      /* @__PURE__ */ r(
        le,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ r(X, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ p(de, { children: [
        /* @__PURE__ */ r(ce, { children: l }),
        /* @__PURE__ */ r(ue, { children: j.map((S) => /* @__PURE__ */ p(
          At,
          {
            value: S.label,
            onSelect: K,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(Ge, { className: "tw:h-4 tw:w-4" }),
...
function Ra(t, e, a) {
  if (!e) return [...t];
  const o = [...t], n = ct(e).toLowerCase();
  return a === "passive" ? Ht({
    query: n,
    items: o,
    filter: (s) => ct(s.label).toLowerCase().startsWith(n),
    sortBy: "label"
  }) : Ht({
    query: n,
    items: o,
    filter: (s) => ct(s.label).toLowerCase().includes(n),
    sortBy: "label"
  });
}
function Oa(t) {
...
function Ur(t, e, a) {
  ...
  if (Oa(t) || Ue.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (B(t), a.dismiss(), "ended") : (B(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (B(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (B(t), a.dismiss(), "ended") : t.key === "Backspace" || Ne[o].test(t.key) ? (B(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && B(t), a.dismiss(), "ended");
}
function $r(t, e) {
  var a;
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Jt(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
...
function Ha(t) {
  const e = t.filter(Xt).sort(at), a = t.filter((n) => !Xt(n)).sort(at);
  if (e.length === 0)
...
function Ka(t) {
  ...
  return [
    xe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? mt : Fa;
      },
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[dt.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[dt.type];
        return typeof o == "string" ? o : void 0;
      },
      ...
      getSectionHeading: (a, o) => {
        ...
        ), s = (i = n == null ? void 0 : n.customData) == null ? void 0 : i[dt.typeName];
...
function Xa(t) {
  ...
  return {
    ...
    ariaLabel: e.ariaLabel === "" ? "" : _(e.ariaLabel, T.ariaLabel),
    buttonPlaceholder: _(
      e.buttonPlaceholder,
      T.buttonPlaceholder
    ),
...
function pt(t) {
  return ca[$e(t)] ?? String(t);
}
const Zt = "platform.footerAction", Za = {
...
function qa({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = pt(t);
  return e ? /* @__PURE__ */ r(
    gt,
    {
...
function Wa({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: I
  } = Na(), [k, w] = Z(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || k, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), I();
  }, [I]), F = /* @__PURE__ */ r(ee, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let K;
  e === "project" ? t.openGroups.length > 0 && (K = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ r(gt, { variant: "secondary", children: pt(R) }, R)) })) : t.scrollGroupId !== void 0 && (K = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ r(
      qa,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ r(Re, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  ), j = t.scrollGroupId !== void 0 ? pt(t.scrollGroupId) : void 0, Y = t.isBoundButClosed && j ? a.boundButClosedTooltip.replace("{group}", j) : void 0;
  return /* @__PURE__ */ p(jt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ r(Rt, { asChild: !0, children: W }),
    /* @__PURE__ */ p(
      Ot,
      {
        side: "top",
...
function Ya({
  ...
  return /* @__PURE__ */ p(xa, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(ya, { asChild: !0, children: /* @__PURE__ */ r(
        X,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ r(Ot, { children: o.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ p(
      Ia,
      {
        ...
        style: { zIndex: oe },
        children: [
          /* @__PURE__ */ r(Ea, { children: o.groupSectionLabel }),
...
function Yr(t) {
  const [e, a] = Z(!1), [o, n] = Z(""), s = Q(() => Xa(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(xe(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      Va({
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, I = ht(null), [k, w] = Z(void 0), g = J((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Mt(() => {
    if (!e) return;
  ...
  const N = Q(() => t.mode === "project" ? xt({
    ...
    () => new Map(t.projects.map((c) => [M(c.id), c])),
    [t.projects]
  ), F = J(
    (c) => c === void 0 ? void 0 : $.get(M(c)),
    [$]
  ), { renderProjectIndicator: K } = t, W = J(
    (c) => K ? K(c.project) : void 0,
    [K]
  ), j = !!K, Y = !!t.footerAction && h.length === 0, R = Q(() => {
    if (f === nt) return Et(h);
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, D = M(c.projectId), H = (G) => M(G.projectId) === D && G.scrollGroupId === c.scrollGroupId, z = b.some(H) ? b.filter((G) => !H(G)) : [
          ...b.filter((G) => !H(G)),
  ...
  }, L = t.mode === "project" ? t.renderTriggerLabel : void 0, O = t.mode === "project" ? t.triggerLabelFormat : void 0, P = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = F(t.selection.projectId);
        if (L) return { node: L(c), title: "" };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && O === "shortNameAndFullName" && c.fullName && c.fullName !== c.shortName && (b = `${c.shortName} - ${c.fullName}`), { node: b, title: b };
      }
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((z) => {
          const G = F(z.projectId);
          G && b.push({ project: G, scrollGroupId: z.scrollGroupId });
        }), b.length === 0) {
          const z = s.buttonPlaceholder;
          return { node: z, title: z };
        }
        const D = b.map(
          ({ project: z, scrollGroupId: G }) => G === void 0 ? z.shortName : `${z.shortName} (${pt(G)})`
        ).join(", "), H = b.length.toString();
        return {
          node: /* @__PURE__ */ p(Ee, { children: [
            /* @__PURE__ */ r(gt, { variant: "muted", className: "tw:shrink-0", children: H }),
            /* @__PURE__ */ r("span", { className: "tw:min-w-0 tw:truncate", children: D })
          ] }),
          title: `${H} ${D}`
        };
      }
  ...
  Mt(() => {
    ...
    const D = new ResizeObserver((H) => {
      H.forEach((z) => {
        const [G] = z.borderBoxSize;
        b(G ? G.inlineSize : c.getBoundingClientRect().width);
      });
    });
    return D.observe(c, { box: "border-box" }), () => D.disconnect();
  }, []);
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ r(Oe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ r(te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ r(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Se = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, Bt = /* @__PURE__ */ p(
    X,
    {
      ref: st,
      ...
      children: [
        /* @__PURE__ */ r("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof P.node == "string" ? /* @__PURE__ */ r("span", { className: "tw:min-w-0 tw:truncate", children: P.node }) : P.node }),
        lt
      ]
    }
  ), Ie = P.title ? /* @__PURE__ */ r(Kt, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(kt, { asChild: !0, children: Bt }) }),
    /* @__PURE__ */ r(Ot, { children: P.title })
  ] }) }) : /* @__PURE__ */ r(kt, { asChild: !0, children: Bt }), ke = i.length > 1;
        ...
        children: /* @__PURE__ */ r(Kt, { delayDuration: 400, children: /* @__PURE__ */ p(
          ie,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ r(X, { variant: "ghost", size: "sm", onClick: S, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(de, { children: [
                /* @__PURE__ */ r(ce, { children: s.commandEmptyMessage }),
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(ue, { heading: to(c, s), children: c.rows.map((D) => /* @__PURE__ */ r(
                          Wa,
                          {
                            row: D,
                            mode: t.mode,
                            ...
                            selectedRowRef: I,
                            indicator: W(D),
                            reserveIndicatorSlot: j
                          },
                          D.rowKey
                        )) }),
                        b < R.length - 1 && /* @__PURE__ */ r(Ut, { alwaysRender: !0 })
                      ]
                    },
...
const tn = (t, e, a) => oo(t, e).every((o) => a.includes(o));
function ro(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => A.bookIdToNumber(o) > 0).sort((o, n) => A.bookIdToNumber(o) - A.bookIdToNumber(n)).map((o) => ua(o, e));
}
function en(t, e, a, o) {
...
function an({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ r(
    "p",
    {
      role: "status",
...
function rn({
  ...
  return /* @__PURE__ */ p(no, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(so, { children: [
      /* @__PURE__ */ r(lo, { variant: "icon", children: o ?? /* @__PURE__ */ r(Me, {}) }),
      /* @__PURE__ */ r(co, { children: t })
    ] }),
    a && /* @__PURE__ */ r(uo, { children: /* @__PURE__ */ r(X, { onClick: () => a(), children: e }) })
  ] });
}
const wo = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ r(He, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BQFRPfJp.js.map
