...
import { Slot as Nt, Dialog as J, Popover as ot, Tooltip as et, Label as de, RadioGroup as ht, ToggleGroup as Ot, Separator as ce, DropdownMenu as T } from "radix-ui";
import { IconX as ue, IconSearch as we, IconCheck as vt, IconChevronRight as me } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as X, useRef as xt, useCallback as K, createContext as fe, useContext as pe, useMemo as Q, useEffect as he, Fragment as ge, forwardRef as Mt } from "react";
import { cva as W } from "class-variance-authority";
import { ChevronsUpDown as jt, Check as _t, Star as be, SlidersHorizontal as Ne, ArrowRight as ve, Loader2 as xe, ChevronDown as ye, Search as ke, X as Ie, AlertTriangle as Se, LoaderCircle as Ce } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as Ee, normalizeProjectId as F, compareProjectsByName as Te, formatProjectName as ze, getLocalizeKeyForScrollGroupId as Ge, hasDistinctFullName as Ct, getSectionForBook as Ae } from "platform-bible-utils";
...
import { extendTailwindMerge as Le, twMerge as Re } from "tailwind-merge";
const Pe = Le({ prefix: "tw" });
function gt(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  ...
  }), Re(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const f = r.get(c);
    return f ? Oe(c, f) : c;
  }).join(" ");
}
const Me = 600, Ut = 650, mr = 400, je = 450, _e = 500, Ue = 550, fr = 650, pr = 700, $t = W(
...
function Ft({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m(Fe, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        tt.Input,
        {
      ...
      /* @__PURE__ */ o(Je, { children: /* @__PURE__ */ o(we, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const na = ["input", "select", "textarea", "button"], oa = ["button", "textbox"], Zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const n = xt(null), [s, i] = X(void 0), [l, c] = X(void 0), f = K(
    ...
    if (u.isContentEditable || na.includes(b)) return !0;
...
function At({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ o(
    T.Label,
    {
...
function nn({ className: t, children: e, ...a }) {
  const r = U();
  return /* @__PURE__ */ o(
    T.SubContent,
    {
...
function st(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && ma(r)
  );
}
function sn({
  className: t,
  ...
  const l = z.useMemo(
    ...
    (h) => {
      ...
      if (h.key === "ArrowDown" || h.key === "ArrowUp")
        h.preventDefault(), ha(u, b, h.key);
      else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
        h.preventDefault(), pa(l, g, h.key);
...
function pn({
  ...
  const [A, $] = X(!1), Y = K(
    (C) => {
      var P;
      const R = (P = t.find((V) => V.label === C)) == null ? void 0 : P.value;
      R && a(
    ...
    if (!S) return t;
    const C = t.filter((P) => P.starred).sort((P, V) => P.label.localeCompare(V.label)), R = t.filter((P) => !P.starred).sort((P, V) => {
      const lt = e.includes(P.value), q = e.includes(V.value);
      return lt && !q ? -1 : !lt && q ? 1 : P.label.localeCompare(V.label);
    });
    return [...C, ...R];
  }, [t, e, S]), M = () => {
    a(t.map((C) => C.value));
...
function hn(t, e, a) {
  ...
  if (ba(t) || Ee.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: Lt(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
...
function it(t) {
  return Ye[Ge(t)] ?? String(t);
}
const Da = "platform.footerAction", oe = [
  "openTabs",
  "lastUsed",
  "language",
  "versification",
...
function Ba({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = ta(), [S, u] = X(!1), b = !!(t.language || t.languageCode), g = b || !!t.typeName || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = f || S, A = K(() => {
    if (g) {
      u(!0);
      return;
    }
    ...
    u(!1), v();
  }, [v]), Y = /* @__PURE__ */ o(_t, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let B;
        ...
        /* @__PURE__ */ m(
          "span",
          {
            ...
            children: [
              ...
              Ct(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        B
  ...
  return /* @__PURE__ */ m(Yt, { open: N, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ m(
      te,
      {
        ...
        style: { zIndex: Ut },
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", children: Ct(t) ? t.fullName : t.shortName }),
...
function _a({
  ...
  const l = !!n || e !== a;
  return /* @__PURE__ */ m(ia, { children: [
    /* @__PURE__ */ o(la, { asChild: !0, children: /* @__PURE__ */ o(
      _,
      {
        variant: "ghost",
        size: "sm",
      ...
      da,
      {
        ...
        children: [
          t.length > 0 && /* @__PURE__ */ m(ct, { children: [
            /* @__PURE__ */ o(At, { children: i.groupSectionLabel }),
            /* @__PURE__ */ m(
              ua,
              {
                value: e,
                ...
                children: [
                  /* @__PURE__ */ o(Gt, { value: "none", children: i.filterGroupNone }),
                  t.map((c) => /* @__PURE__ */ o(Gt, { value: c, children: ja(c, i) }, c))
                ]
              }
            )
          ] }),
          s && /* @__PURE__ */ m(ct, { children: [
            t.length > 0 && /* @__PURE__ */ o(wa, {}),
            /* @__PURE__ */ o(At, { children: i.filterSectionLabel }),
            /* @__PURE__ */ o(
              ca,
              {
                checked: !!n,
...
function xn(t) {
  const [e, a] = X(!1), [r, n] = X(""), s = t.availableGroupings ?? La, i = Oa(
    s,
    t.defaultGrouping,
  ...
  const u = Aa(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: B } = u, { languageUnknownSectionHeading: O } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: H } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Pt(g, !0);
      case "lastUsed":
    ...
    switch (t.mode) {
      case "project": {
        ...
        return w && t.triggerLabelFormat === "shortNameAndFullName" && (p = ze(w)), { node: p, title: p };
      }
      case "project-multi": {
        ...
        const p = [];
        if (w.forEach((k) => {
          const rt = t.projects.find((le) => le.id === k.projectId);
  ...
  let at;
  t.isLoading ? at = /* @__PURE__ */ o(xe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? at = void 0 : t.mode === "project-multi" ? at = /* @__PURE__ */ o(jt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : at = /* @__PURE__ */ o(ye, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const se = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? R : void 0, St = /* @__PURE__ */ m(
    _,
    {
  ...
  ), ie = q.title ? /* @__PURE__ */ o(zt, { delayDuration: 400, children: /* @__PURE__ */ m(Yt, { children: [
    /* @__PURE__ */ o(Qt, { asChild: !0, children: /* @__PURE__ */ o(bt, { asChild: !0, children: St }) }),
    /* @__PURE__ */ o(te, { children: q.title })
  ...
  return /* @__PURE__ */ m(Wt, { open: e, onOpenChange: S, children: [
    ...
    /* @__PURE__ */ o(
      Zt,
      {
        ...
        children: /* @__PURE__ */ o(zt, { delayDuration: 400, children: /* @__PURE__ */ m(Vt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Kt, { children: [
            ...
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(ge, { children: [
                /* @__PURE__ */ o(Xt, { heading: Ua(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Ba,
                  {
                    row: y,
                    mode: t.mode,
...
const kn = (t, e, a) => Va(t, e).every((r) => a.includes(r));
function Fa(t, e) {
  return [
...
function En({
  ...
  return /* @__PURE__ */ m(Ka, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Ja, { children: [
      /* @__PURE__ */ o(Wa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Se, {}) }),
      /* @__PURE__ */ o(qa, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Za, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
const Ya = Mt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ce, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C8x3w7-M.js.map
