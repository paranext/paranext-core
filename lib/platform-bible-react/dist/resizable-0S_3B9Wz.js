import { jsx as n, jsxs as p, Fragment as ke } from "react/jsx-runtime";
import { Slot as zt, Dialog as Q, Separator as Ie, Popover as wt, Tooltip as lt, DropdownMenu as E, Label as Ee, RadioGroup as _t, ToggleGroup as te } from "radix-ui";
import { IconX as Te, IconCheck as Rt, IconSearch as _e, IconChevronRight as Ce } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as ot } from "class-variance-authority";
import C, { useState as H, useRef as pt, useCallback as X, createContext as Le, useContext as Ge, useEffect as Ct, useMemo as at, Fragment as je, forwardRef as ee } from "react";
import { ChevronsUpDown as ae, Check as oe, Star as Ae, Group as ze, ArrowRight as Re, Loader2 as De, ChevronDown as Pe, Search as Be, X as Oe, AlertTriangle as Me, LoaderCircle as He } from "lucide-react";
import { Section as rt, MODIFIER_KEYS as Ue, normalizeProjectId as P, compareProjectsByName as $e, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as re, getLocalizeKeyForScrollGroupId as Fe, hasDistinctFullName as Ke, getSectionForBook as Ve } from "platform-bible-utils";
import { filterAndRankItems as Ft } from "@eten-tech-foundation/platform-editor";
...
import { extendTailwindMerge as Xe, twMerge as qe } from "tailwind-merge";
const We = Xe({ prefix: "tw" });
function Lt(t) {
  const e = [];
  let a = "", o = 0;
...
const ne = 600, se = 650, Eo = 400, Qe = 450, ta = 500, To = 510, _o = 520, ea = 675, Co = 690, Lo = 700, Go = 800, ie = ot(
...
function q({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(ie({ variant: e, size: a, className: t })),
      ...r
    }
  );
}
const le = "layoutDirection";
function ce() {
...
function $() {
  var t;
  try {
    const e = (t = ce()) == null ? void 0 : t.getItem(le);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function Do({
  ...
  return /* @__PURE__ */ p(aa, { children: [
    /* @__PURE__ */ n(oa, { className: o, style: r }),
    /* @__PURE__ */ p(
      Q.Content,
      {
...
function ue({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(na, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        st.Input,
        {
      ...
      /* @__PURE__ */ n(ia, { children: /* @__PURE__ */ n(_e, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const la = [
  ...
  var e;
  return ((e = la[t]) == null ? void 0 : e.chapters) ?? -1;
...
function mt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && ma(o)
  );
}
...
const fe = "data-quiet-focus";
function er(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(fe, ""), t.style.outline = "none"));
}
function ar(t) {
  t && (t.removeAttribute(fe), t.style.removeProperty("outline"));
}
...
const ge = C.createContext(null);
function ir({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ n(ge.Provider, { value: t, children: e });
}
function be({
  className: t,
  align: e = "center",
...
function Mt({
  ...
  return /* @__PURE__ */ n(
    lt.Trigger,
    {
      ...
      className: e ? c(ie({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const ga = /^%[^%]*%$/;
function Ne(t) {
  return t !== void 0 && !ga.test(t) && t.trim() !== "";
}
function T(t, e) {
  return Ne(t) ? t : e;
}
...
function Na({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(ve.Provider, { value: o, children: /* @__PURE__ */ n(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function wr({
  ...t
}) {
...
function ya({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ n(
    E.Label,
    {
...
const Ea = ["input", "select", "textarea", "button"], Ta = ["button", "textbox"], Tr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const r = pt(null), [s, i] = H(void 0), [l, u] = H(void 0), m = X(
    ...
    (w) => {
      var R;
      const g = w.target, N = (x) => x ? document.getElementById(x) : void 0, h = N(l), F = N(s);
...
function Pr({
  ...
  return /* @__PURE__ */ n("div", { id: K, className: h, children: /* @__PURE__ */ p(he, { open: x, onOpenChange: U, children: [
    /* @__PURE__ */ n(jt, { asChild: !0, children: /* @__PURE__ */ p(
      q,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n(ae, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(be, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(de, { children: [
      /* @__PURE__ */ n(
        ue,
        {
          placeholder: r ?? o,
      ...
      /* @__PURE__ */ n(Aa, { isEnabled: g, scrollerRef: G, children: /* @__PURE__ */ p(we, { ref: G, children: [
        /* @__PURE__ */ n(pe, { children: u }),
        /* @__PURE__ */ n(me, { children: ht.map((k) => /* @__PURE__ */ p(
          Pt,
          {
            value: k.label,
            onSelect: et,
            ...
            children: [
              ...
              k.starred && /* @__PURE__ */ n(Ae, { className: "tw:h-4 tw:w-4" }),
...
function Br(t, e, a) {
  ...
  if (Ra(t) || Ue.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || Se[o].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && D(t), a.dismiss(), "ended");
}
function Or(t, e) {
  var a;
...
const Wt = '[aria-controls="editor-context-menu"]';
function $r(t) {
  return t ? t.matches(Wt) ? !0 : !!t.querySelector(Wt) : !1;
}
function Oa(t) {
...
function ft(t) {
  return wa[Fe(t)] ?? String(t);
}
const Qt = "platform.footerAction", Xa = {
...
function Wa({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = ba(), [I, w] = H(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || I, h = X(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), y();
  }, [y]), K = /* @__PURE__ */ n(oe, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let V;
  ...
  return /* @__PURE__ */ p(Ot, { open: N, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      Ht,
      {
        ...
        children: [
          /* @__PURE__ */ n("div", { className: "tw:font-semibold", dir: "auto", children: re(t) }),
...
function Za({
  ...
  return /* @__PURE__ */ p(Na, { children: [
    /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(va, { asChild: !0, children: /* @__PURE__ */ n(
        q,
        {
          variant: "ghost",
          size: "sm",
          ...
          children: /* @__PURE__ */ n(ze, { className: "tw:h-4 tw:w-4" })
        }
      ) }) }),
    ...
    /* @__PURE__ */ p(
      xa,
      {
        ...
        style: { zIndex: se },
        children: [
          /* @__PURE__ */ n(ya, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(Sa, { value: e, onValueChange: a, children: [
...
function qr(t) {
  ...
  const N = at(() => t.mode === "project" ? Tt({
    ...
    switch (t.mode) {
      case "project": {
        ...
        return d && it === "shortNameAndFullName" && (b = re(d)), { node: b, title: b, hasSelection: !!d };
      }
      case "project-multi": {
  ...
  let k;
  t.isLoading ? k = /* @__PURE__ */ n(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? k = void 0 : t.mode === "project-multi" ? k = /* @__PURE__ */ n(ae, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : k = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
          ...
          de,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p(we, { children: [
                /* @__PURE__ */ n(pe, { children: s.commandEmptyMessage }),
                R.map((d, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(me, { heading: Qa(d, s), children: d.rows.map((j) => /* @__PURE__ */ n(
                          Wa,
                          {
                            row: j,
                            mode: t.mode,
                        ...
                        b < R.length - 1 && /* @__PURE__ */ n(Kt, { alwaysRender: !0 })
                      ]
                    },
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            q,
            {
              ...
              children: [
                /* @__PURE__ */ n(Oe, { className: "tw:h-4 tw:w-4" }),
...
const Zr = (t, e, a) => ao(t, e).every((o) => a.includes(o));
function oo(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => L.bookIdToNumber(o) > 0).sort((o, r) => L.bookIdToNumber(o) - L.bookIdToNumber(r)).map((o) => pa(o, e));
}
function Yr(t, e, a, o) {
...
function en({
  ...
  return /* @__PURE__ */ p(ro, { className: c(s), role: r, children: [
    /* @__PURE__ */ p(no, { children: [
      /* @__PURE__ */ n(io, { variant: "icon", children: o ?? /* @__PURE__ */ n(Me, {}) }),
      /* @__PURE__ */ n(lo, { children: t })
    ] }),
    a && /* @__PURE__ */ n(co, { children: /* @__PURE__ */ n(q, { onClick: () => a(), children: e }) })
  ] });
}
const uo = ee(({ className: t, ...e }, a) => /* @__PURE__ */ n(He, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-0S_3B9Wz.js.map
