...
import { Slot as ut, Dialog as M, Popover as Z, Tooltip as X, Label as Jt, RadioGroup as lt, ToggleGroup as kt, Separator as Ut, DropdownMenu as S } from "radix-ui";
...
const be = 600, Ga = 650, Tt = 400, Ne = 450, ve = 500, xe = 550, Aa = 700, Da = 800, zt = F(
...
function Ir({ className: t, children: e, ...a }) {
  const r = R();
  return /* @__PURE__ */ n(
    S.SubContent,
    {
...
//# sourceMappingURL=resizable-_uylirA1.js.map
