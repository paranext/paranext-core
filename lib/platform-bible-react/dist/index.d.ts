...
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuSubContent({ className, ref, ...props }: DropdownMenuSubContentProps & {
...
/** @inheritdoc Popover */
export declare function PopoverContent({ className, align, sideOffset, ref, ...props }: React$1.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content> & {
...
/** @inheritdoc Tooltip */
export declare function TooltipContent({ className, sideOffset, ref, ...props }: React$1.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content> & {
