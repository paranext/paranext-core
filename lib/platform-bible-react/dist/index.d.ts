...
export declare const badgeVariants: (props?: ({
	variant?: "default" | "outline" | "secondary" | "ghost" | "destructive" | "link" | "muted" | "blueIndicator" | "mutedIndicator" | null | undefined;
} & ClassProp) | undefined) => string;
/**
...
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuContent({ className, align, sideOffset, children, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.Content>): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
...
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuItem({ className, inset, variant, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.Item> & {
	inset?: boolean;
	variant?: "default" | "destructive";
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuCheckboxItem({ className, children, checked, inset, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.CheckboxItem> & {
	inset?: boolean;
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
...
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuRadioItem({ className, children, inset, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.RadioItem> & {
	inset?: boolean;
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuLabel({ className, inset, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.Label> & {
	inset?: boolean;
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuSeparator({ className, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.Separator>): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuShortcut({ className, ...props }: React$1.ComponentProps<"span">): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
...
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuSubTrigger({ className, inset, children, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.SubTrigger> & {
	inset?: boolean;
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc DropdownMenuProps */
export declare function DropdownMenuSubContent({ className, children, ...props }: React$1.ComponentProps<typeof DropdownMenuPrimitive.SubContent>): import("react/jsx-runtime").JSX.Element;
/**
...
/** @inheritdoc Select */
export declare function SelectTrigger({ className, size, children, ...props }: React$1.ComponentProps<typeof SelectPrimitive.Trigger> & {
	size?: "sm" | "default";
}): import("react/jsx-runtime").JSX.Element;
/** @inheritdoc Select */
