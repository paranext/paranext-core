...
export declare const PROJECT_PICKER_DIALOG_STRING_KEYS: readonly [
	"%projectPicker_title%",
 ...
 */
export function ProjectPickerDialog({ currentProject, recentProjects, allProjects, isLoading, onSelect, localizedStrings, }: ProjectPickerDialogProps): import("react/jsx-runtime").JSX.Element;
/**
