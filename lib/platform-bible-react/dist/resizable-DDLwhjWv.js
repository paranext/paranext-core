...
import { Slot as ut, Dialog as P, Popover as W, Label as Xt, RadioGroup as lt, Tooltip as K, ToggleGroup as St, Separator as Kt, DropdownMenu as z } from "radix-ui";
import { IconX as qt, IconSearch as Wt, IconCheck as wt, IconChevronRight as Zt } from "@tabler/icons-react";
import { Canon as D } from "@sillsdev/scripture";
import G, { useRef as ft, useState as _, useCallback as $, createContext as Yt, useContext as Qt, useMemo as X, useEffect as te, Fragment as ee, forwardRef as Et } from "react";
...
import { includes as ht, Section as J, normalizeProjectId as Z, getLocalizeKeyForScrollGroupId as ce, getSectionForBook as ue } from "platform-bible-utils";
...
function he(t) {
  ...
  const e = dt(t), r = e.findIndex((s) => s.startsWith("-tw-"));
  if (r !== -1) {
    const s = e[r].slice(4);
...
function ge(t, e) {
  ...
  const r = dt(t);
  if (r[0] !== "tw") return t;
  const a = r.slice(1, -1), o = r[r.length - 1], s = dt(e), i = s.some((l) => l.startsWith("-tw-")), d = s.some((l) => l.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const l = o.slice(1);
    return [...a, `-tw-${l}`].join(":");
  }
...
function $a(t, e, r) {
  ...
  return !!(o.toLowerCase().includes(a) || t.toLowerCase().includes(a) || (s ? ht(s.localizedName.toLowerCase(), a) || ht(s.localizedId.toLowerCase(), a) : !1));
}
function Bt({ ...t }) {
...
function qa(t, e, r) {
  ...
  if (e === void 0) return;
  const i = rt(a, e, "previous");
  if (!i) return;
  const d = Math.max(pt(i), 1);
...
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], lr = ({
  ...
  const o = ft(null), [s, i] = _(void 0), [d, l] = _(void 0), c = $(
    (f) => {
      i(f);
...
function at({ className: t, variant: e = "default", asChild: r = !1, ...a }) {
  const o = r ? ut.Root : "span";
  return /* @__PURE__ */ n(
    o,
    {
      "data-slot": "badge",
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(z.ItemIndicator, { children: /* @__PURE__ */ n(wt, {}) })
          }
        ),
        e
      ]
...
function oa({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ n(at, { variant: "secondary", children: r });
}
function na({ row: t, mode: e, strings: r, onClick: a, onOpen: o, selectedRowRef: s }) {
  ...
  let O;
  e === "project" ? t.openGroups.length > 0 && (O = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((A) => /* @__PURE__ */ n(at, { variant: "secondary", children: Q(A) }, A)) })) : t.scrollGroupId !== void 0 && (O = /* @__PURE__ */ g("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      oa,
      {
...
function Gr(t) {
  const [e, r] = _(!1), [a, o] = _(""), [s, i] = _(t.defaultGroupByOpenTabs ?? !0), [d, l] = _(!1), c = ft(null), m = $((u) => {
    r(u), u || o("");
  }, []);
  te(() => {
    if (!e) return;
  ...
  const h = aa(t.localizedStrings), I = X(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
      ...
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ g(Ct, { children: [
            /* @__PURE__ */ n(at, { variant: "muted", className: "tw:shrink-0", children: y }),
  ...
  const A = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? S : void 0, F = /* @__PURE__ */ g(
    ...
    /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(ct, { asChild: !0, children: F }) }),
...
//# sourceMappingURL=resizable-DDLwhjWv.js.map
