...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-CqDIffSo.js
import { Slot as wt, Dialog as P, Popover as W, Tooltip as K, Label as Xt, RadioGroup as dt, ToggleGroup as St, Separator as Kt, DropdownMenu as z } from "radix-ui";
|||||||| parent of 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-WH6eKveD.js
import { Slot as wt, Dialog as P, Popover as W, Label as Xt, RadioGroup as dt, Tooltip as K, ToggleGroup as St, Separator as Kt, DropdownMenu as z } from "radix-ui";
========
...
>>>>>>>> 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-DxYWGvfC.js
...
import G, { useState as _, useRef as mt, useCallback as $, createContext as Yt, useContext as Qt, useMemo as X, useEffect as te, Fragment as ee, forwardRef as Et } from "react";
...
const be = 600, Ca = 300, Gt = 400, ve = 450, Ne = 500, xe = 550, Sa = 650, Ea = 700, Dt = V(
  ...
  return /* @__PURE__ */ g(ye, { children: [
    ...
    /* @__PURE__ */ g(
      B.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ n(B.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ g(O, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(qt, {}),
...
function La({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ n(B.Close, { asChild: !0, children: /* @__PURE__ */ n(O, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Ae() {
  return bt || (bt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", S = "\\u200d", j = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", O = `[${l}]`, B = `${I}?`, E = `[${d}]?`, T = `(?:${S}(?:${[f, N, x].join("|")})${E + B})*`, A = E + B + T, C = `(?:${[`${f}${m}?`, m, N, x, c, O].join("|")})`;
    return new RegExp(`${j}|${h}(?=${h})|${C + A}`, "g");
|||||||| parent of 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-WH6eKveD.js
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", S = "\\u200d", j = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", O = `[${l}]`, B = `${I}?`, E = `[${d}]?`, T = `(?:${S}(?:${[f, N, x].join("|")})${E + B})*`, A = E + B + T, C = `(?:${[`${f}${m}?`, m, N, x, c, O].join("|")})`;
    return new RegExp(`${j}|${h}(?=${h})|${C + A}`, "g");
========
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", S = "\\u200d", P = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", M = `[${l}]`, j = `${I}?`, E = `[${d}]?`, T = `(?:${S}(?:${[f, N, x].join("|")})${E + j})*`, A = E + j + T, C = `(?:${[`${f}${m}?`, m, N, x, c, M].join("|")})`;
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-CqDIffSo.js
const $e = ["input", "select", "textarea", "button"], Fe = ["button", "textbox"], lr = ({
|||||||| parent of 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-WH6eKveD.js
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], lr = ({
========
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], dr = ({
>>>>>>>> 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-DxYWGvfC.js
  options: t,
  onFocusChange: e,
  onOptionSelect: r,
  ...
  const o = mt(null), [s, i] = _(void 0), [d, l] = _(void 0), c = $(
    ...
    if (f.isContentEditable || $e.includes(N)) return !0;
    const x = f.getAttribute("role");
    if (x && Fe.includes(x)) return !0;
...
function br({ className: t, children: e, ...r }) {
  const a = R();
  return /* @__PURE__ */ n(
    z.SubContent,
    {
...
function Y(t, e) {
  ...
  return Array.from(t.querySelectorAll(r)).filter(
    (a) => !a.hasAttribute("disabled") && !a.getAttribute("aria-hidden") && Ke(a)
  );
}
function Nr({
  className: t,
  ...
  const d = G.useMemo(
    ...
    (m) => {
      ...
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), Ze(f, N, m.key);
      else if (m.key === "ArrowLeft" || m.key === "ArrowRight")
        m.preventDefault(), We(d, x, m.key);
...
function Tr({
  ...
  return /* @__PURE__ */ n("div", { id: S, className: N, children: /* @__PURE__ */ g(jt, { open: C, onOpenChange: m ?? M, children: [
...
function Q(t) {
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-CqDIffSo.js
  return Pe[ce(t)] ?? String(t);
|||||||| parent of 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-WH6eKveD.js
  return Oe[ce(t)] ?? String(t);
========
  return Me[ce(t)] ?? String(t);
>>>>>>>> 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-DxYWGvfC.js
}
const ra = {
...
function na({ row: t, mode: e, strings: r, onClick: a, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: c
  } = De(), [m, h] = _(!1), I = !!(t.language || t.languageCode), f = I || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = d || m, x = $(() => {
    if (f) {
      h(!0);
      return;
    }
  ...
  let M;
  e === "project" ? t.openGroups.length > 0 && (M = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((A) => /* @__PURE__ */ n(rt, { variant: "secondary", children: Q(A) }, A)) })) : t.scrollGroupId !== void 0 && (M = /* @__PURE__ */ g("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      oa,
      {
...
>>>>>>>> 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-DxYWGvfC.js
    ...
    /* @__PURE__ */ g(Ue, { align: "end", className: "tw:w-56", style: { zIndex: Gt }, children: [
...
function Dr(t) {
  ...
  ), C = E.title ? /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ g(Ft, { children: [
  ...
  return /* @__PURE__ */ g(jt, { open: e, onOpenChange: m, children: [
    ...
    /* @__PURE__ */ n(
      $t,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ g(Rt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            ...
            /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: j, children: `${h.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ g(Ot, { children: [
            /* @__PURE__ */ n(Mt, { children: t.commandEmptyMessage ?? "No projects found" }),
            N.map((u, p) => (
...
const Rr = (t, e, r) => ca(t, e).every((a) => r.includes(a));
function ua(t, e) {
  return [
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-CqDIffSo.js
//# sourceMappingURL=resizable-CqDIffSo.js.map
|||||||| parent of 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-WH6eKveD.js
//# sourceMappingURL=resizable-WH6eKveD.js.map
========
//# sourceMappingURL=resizable-DxYWGvfC.js.map
>>>>>>>> 29baad5a2a5 (feat(PT-4262): onboarding orientation tour for Simple mode):lib/platform-bible-react/dist/resizable-DxYWGvfC.js
