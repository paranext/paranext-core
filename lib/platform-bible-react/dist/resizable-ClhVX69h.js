import { jsx as o, jsxs as p, Fragment as le } from "react/jsx-runtime";
import { Slot as St, Dialog as V, Separator as de, Popover as st, Tooltip as at, DropdownMenu as E, Label as ce, RadioGroup as Nt, ToggleGroup as Ut } from "radix-ui";
...
import T, { useState as F, useRef as wt, useCallback as W, createContext as me, useContext as fe, useMemo as Q, useEffect as Lt, Fragment as he, forwardRef as $t } from "react";
...
import { Section as Y, MODIFIER_KEYS as Ee, normalizeProjectId as P, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as ot, getLocalizeKeyForScrollGroupId as _e, getSectionForBook as Te } from "platform-bible-utils";
...
function d(...t) {
  ...
  }), ze(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = r.get(u);
    return m ? Ae(u, m) : u;
  }).join(" ");
}
const Vt = 600, Jt = 650, nr = 400, Re = 450, De = 500, Pe = 675, sr = 690, ir = 700, lr = 800, Xt = Z(
...
function U({
  ...
  return /* @__PURE__ */ o(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Xt({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
...
function qt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(He, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ o($e, { children: /* @__PURE__ */ o(we, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function ee({ ...t }) {
  return /* @__PURE__ */ o(st.Root, { "data-slot": "popover", ...t });
}
function xt({ ...t }) {
  return /* @__PURE__ */ o(st.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function Lr({
  ...
  return /* @__PURE__ */ o(ae.Provider, { value: t, children: e });
}
function re({
  className: t,
  align: e = "center",
  ...
  const s = M(), i = T.useContext(ae);
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ o(st.Portal, { container: i ?? void 0, children: /* @__PURE__ */ o(
      st.Content,
      {
...
function Ar({ ...t }) {
  return /* @__PURE__ */ o(st.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function Ct({
  ...
  return /* @__PURE__ */ o(
    at.Trigger,
    {
      ...
      className: e ? d(Xt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
function ta({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(oe.Provider, { value: r, children: /* @__PURE__ */ o(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Or({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ o(
          "span",
          {
            ...
            children: /* @__PURE__ */ o(E.ItemIndicator, { children: /* @__PURE__ */ o(kt, {}) })
          }
        ),
        e
      ]
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      className: d(
        ...
        t,
        // CUSTOM: Apply variant-driven styles from menu context
        ht({ variant: n.variant })
      ),
      ...r,
      children: [
        a,
        /* @__PURE__ */ o(pe, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ia = ["input", "select", "textarea", "button"], la = ["button", "textbox"], Qr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = wt(null), [s, i] = F(void 0), [l, u] = F(void 0), m = W(
    (w) => {
      i(w);
    ...
    (w) => {
      var L;
      const g = w.target, v = (S) => S ? document.getElementById(S) : void 0, h = v(l), $ = v(s);
      if (!!(h && g && h.contains(g) && g !== h) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const H = S.findIndex((B) => B === g);
          if (H === -1) return;
          let x;
          w.key === "ArrowDown" ? x = Math.min(H + 1, S.length - 1) : x = Math.max(H - 1, 0), x !== H && (w.preventDefault(), w.stopPropagation(), (L = S[x]) == null || L.focus());
          return;
        }
        return;
      }
      const X = t.findIndex((S) => S.id === s);
      let j = X;
      switch (w.key) {
        case "ArrowDown":
          j = Math.min(X + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(X - 1, 0), w.preventDefault();
          break;
        case "Home":
  ...
  T.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        it(i, '[tabindex]:not([tabindex="-1"])').forEach((f) => {
    ...
    const a = (r) => {
      if (e.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const n = t.current ? it(t.current) : [], s = n.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = T.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), wa(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), ua(l, v, f.key);
...
function co({
  ...
  const [$, J] = F(!1), q = W(
    (x) => {
      var A;
      const B = (A = t.find((K) => K.label === x)) == null ? void 0 : A.value;
      B && a(
    ...
    if (!I) return t;
    const x = t.filter((A) => A.starred).sort((A, K) => A.label.localeCompare(K.label)), B = t.filter((A) => !A.starred).sort((A, K) => {
      const dt = e.includes(A.value), c = e.includes(K.value);
      return dt && !c ? -1 : !dt && c ? 1 : A.label.localeCompare(K.label);
    });
    return [...x, ...B];
  }, [t, e, I]), O = () => {
    a(t.map((x) => x.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(ee, { open: S, onOpenChange: f ?? J, children: [
    /* @__PURE__ */ o(xt, { asChild: !0, children: /* @__PURE__ */ p(
      U,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o(Kt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(re, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(Zt, { children: [
      /* @__PURE__ */ o(
        qt,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: O, children: s }),
        /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: L, children: i })
      ] }),
      /* @__PURE__ */ p(Yt, { children: [
        /* @__PURE__ */ o(Qt, { children: l }),
        /* @__PURE__ */ o(te, { children: j.map((x) => /* @__PURE__ */ p(
          Et,
          {
            value: x.label,
            onSelect: q,
            ...
            children: [
              ...
              x.starred && /* @__PURE__ */ o(ge, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ o("div", { className: "tw:flex-grow", children: x.label }),
              x.secondaryLabel && /* @__PURE__ */ o("div", { className: "tw:text-end tw:text-muted-foreground", children: x.secondaryLabel })
            ]
          },
          x.label
        )) })
...
function uo(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || se[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function wo(t, e) {
  var a;
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: Bt(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
...
function Na(t) {
  const e = t.filter(Mt).sort(tt), a = t.filter((n) => !Mt(n)).sort(tt);
  if (e.length === 0)
...
function Sa(t) {
  ...
  return [
    ie(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[ot.lastUsedAt]) == "number" ? ct : ya;
      },
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const r = (n = a.customData) == null ? void 0 : n[ot.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const r = (n = a.customData) == null ? void 0 : n[ot.type];
        return typeof r == "string" ? r : void 0;
      },
      ...
      getSectionHeading: (a, r) => {
        ...
        ), s = (i = n == null ? void 0 : n.customData) == null ? void 0 : i[ot.typeName];
...
const Ht = "platform.footerAction", Ta = {
...
function Ca({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ o(pt, { variant: "secondary", children: a });
}
function Ga({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = Qe(), [I, w] = F(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = m || I, h = W(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), J = /* @__PURE__ */ o(Ft, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let q;
  e === "project" ? t.openGroups.length > 0 && (q = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ o(pt, { variant: "secondary", children: lt(L) }, L)) })) : t.scrollGroupId !== void 0 && (q = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Ca,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      U,
      {
        ...
        children: [
          /* @__PURE__ */ o(Ne, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  ), j = t.scrollGroupId !== void 0 ? lt(t.scrollGroupId) : void 0, O = t.isBoundButClosed && j ? a.boundButClosedTooltip.replace("{group}", j) : void 0;
  return /* @__PURE__ */ p(Tt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ o(Ct, { asChild: !0, children: X }),
    /* @__PURE__ */ p(
      Gt,
      {
        side: "top",
...
function za({
  ...
  return /* @__PURE__ */ p(ta, { children: [
    /* @__PURE__ */ p(Tt, { children: [
      /* @__PURE__ */ o(Ct, { asChild: !0, children: /* @__PURE__ */ o(ea, { asChild: !0, children: /* @__PURE__ */ o(
        U,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      aa,
      {
        ...
        style: { zIndex: Jt },
        children: [
          /* @__PURE__ */ o(oa, { children: r.groupSectionLabel }),
          /* @__PURE__ */ p(ra, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ o(Ot, { value: rt, children: r.groupByNone }),
            /* @__PURE__ */ o(na, {}),
            t.map((s) => /* @__PURE__ */ o(Ot, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function xo(t) {
  const [e, a] = F(!1), [r, n] = F(""), s = _a(t.localizedStrings), i = Q(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(ie(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      ka({
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, k = wt(null), [I, w] = F(void 0), g = W((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Lt(() => {
    if (!e) return;
  ...
  const v = Q(() => t.mode === "project" ? gt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, R = P(c.projectId), _ = (z) => P(z.projectId) === R && z.scrollGroupId === c.scrollGroupId, G = b.some(_) ? b.filter((z) => !_(z)) : [
          ...b.filter((z) => !_(z)),
    ...
    switch (t.mode) {
      case "project": {
        const c = bt(t.projects, t.selection.projectId);
      ...
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((G) => {
          const z = bt(t.projects, G.projectId);
        ...
        const R = b.map(
          ({ project: G, scrollGroupId: z }) => z === void 0 ? G.shortName : `${G.shortName} (${lt(z)})`
        ).join(", "), _ = b.length.toString();
        return {
          node: /* @__PURE__ */ p(le, { children: [
            /* @__PURE__ */ o(pt, { variant: "muted", className: "tw:shrink-0", children: _ }),
      ...
      case "projectScrollGroup": {
        ...
        const R = `${c.shortName} · ${lt(b)}`;
        return { node: R, title: R };
      }
      default:
        return { node: "", title: "" };
    }
  }, [t, s.buttonPlaceholder]), L = wt(null), [S, H] = F(!1);
  Lt(() => {
    const c = L.current;
    if (!c) return;
    const b = (_) => {
  ...
  let x;
  t.isLoading ? x = /* @__PURE__ */ o(ve, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : S ? x = void 0 : t.mode === "project-multi" ? x = /* @__PURE__ */ o(Kt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : x = /* @__PURE__ */ o(xe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const B = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? q : void 0, A = /* @__PURE__ */ p(
    U,
    {
      ref: L,
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof O.node == "string" ? /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: O.node }) : O.node }),
        x
      ]
    }
  ), K = O.title ? /* @__PURE__ */ o(Pt, { delayDuration: 400, children: /* @__PURE__ */ p(Tt, { children: [
    /* @__PURE__ */ o(Ct, { asChild: !0, children: /* @__PURE__ */ o(xt, { asChild: !0, children: A }) }),
    /* @__PURE__ */ o(Gt, { children: O.title })
  ] }) }) : /* @__PURE__ */ o(xt, { asChild: !0, children: A }), dt = i.length > 1;
  return /* @__PURE__ */ p(ee, { open: e, onOpenChange: g, children: [
    K,
    /* @__PURE__ */ o(
      re,
      {
        ...
        children: /* @__PURE__ */ o(Pt, { delayDuration: 400, children: /* @__PURE__ */ p(
          Zt,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: j, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(Yt, { children: [
                /* @__PURE__ */ o(Qt, { children: s.commandEmptyMessage }),
                J.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(te, { heading: La(c, s), children: c.rows.map((R) => {
                          var _;
                          return /* @__PURE__ */ o(
                            Ga,
                            {
                              ...
                              onOpen: B,
                              selectedRowRef: k,
                              indicator: (_ = t.renderProjectIndicator) == null ? void 0 : _.call(t, R.project),
                              reserveIndicatorSlot: !!t.renderProjectIndicator
                            },
                            R.rowKey
                          );
                        }) }),
                        b < J.length - 1 && /* @__PURE__ */ o(Rt, { alwaysRender: !0 })
                      ]
                    },
...
const So = (t, e, a) => Da(t, e).every((r) => a.includes(r));
function Pa(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => C.bookIdToNumber(r) > 0).sort((r, n) => C.bookIdToNumber(r) - C.bookIdToNumber(n)).map((r) => We(r, e));
}
function ko(t, e, a, r) {
...
function _o({
  ...
  return /* @__PURE__ */ p(Oa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Ba, { children: [
      /* @__PURE__ */ o(Ha, { variant: "icon", children: r ?? /* @__PURE__ */ o(ke, {}) }),
      /* @__PURE__ */ o(Ua, { children: t })
    ] }),
    a && /* @__PURE__ */ o($a, { children: /* @__PURE__ */ o(U, { onClick: () => a(), children: e }) })
  ] });
}
const Ka = $t(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ie, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-ClhVX69h.js.map
