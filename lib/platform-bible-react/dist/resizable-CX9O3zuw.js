...
import { Slot as ut, Dialog as M, Separator as Ut, Popover as q, Tooltip as X, DropdownMenu as S, Label as Xt, RadioGroup as lt, ToggleGroup as kt } from "radix-ui";
...
const Tt = 600, zt = 650, Oa = 400, ve = 450, xe = 500, ye = 675, Ma = 690, _a = 700, ja = 800, Gt = $(
...
const Ke = ["input", "select", "textarea", "button"], Je = ["button", "textbox"], Dr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const o = mt(null), [s, i] = _(void 0), [l, w] = _(void 0), g = j(
    ...
    if (m.isContentEditable || Ke.includes(v)) return !0;
    const I = m.getAttribute("role");
    if (I && Je.includes(I)) return !0;
...
function Hr({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f(Mt, { open: C, onOpenChange: b ?? O, children: [
    ...
    /* @__PURE__ */ n(jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Dt, { children: [
      /* @__PURE__ */ n(
        Lt,
        {
...
function da({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: g
  } = _e(), [b, k] = _(!1), A = !!(t.language || t.languageCode), m = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, I = j(() => {
    if (m) {
      k(!0);
      return;
    }
...
function Xr(t) {
  ...
  ), C = E.title ? /* @__PURE__ */ n(bt, { delayDuration: 400, children: /* @__PURE__ */ f($t, { children: [
    /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(ct, { asChild: !0, children: V }) }),
      ...
      jt,
      {
        ...
        children: /* @__PURE__ */ n(bt, { delayDuration: 400, children: /* @__PURE__ */ f(Dt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: O, children: `${k.selectAll} (${I.length.toString()})` }),
          ...
          /* @__PURE__ */ f(Rt, { children: [
            ...
            v.map((c, u) => (
              ...
              /* @__PURE__ */ f(ee, { children: [
                /* @__PURE__ */ n(Bt, { heading: ua(c, k), children: c.rows.map((p) => /* @__PURE__ */ n(
                  da,
                  {
                    row: p,
                    mode: t.mode,
...
//# sourceMappingURL=resizable-CX9O3zuw.js.map
