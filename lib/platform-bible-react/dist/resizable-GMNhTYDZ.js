...
import z, { useState as X, useRef as xt, useCallback as K, createContext as me, useContext as fe, useMemo as Q, useEffect as pe, Fragment as he, forwardRef as Bt } from "react";
...
import { Section as Z, MODIFIER_KEYS as Ce, normalizeProjectId as F, formatProjectName as Ee, getLocalizeKeyForScrollGroupId as Te, hasDistinctFullName as ze, getSectionForBook as Ge } from "platform-bible-utils";
...
function d(...t) {
  ...
  }), Le(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const f = r.get(c);
    return f ? Pe(c, f) : c;
  }).join(" ");
}
const Be = 600, _t = 650, wr = 400, Me = 450, je = 500, _e = 550, mr = 650, fr = 700, Ut = W(
...
function Vt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m(Ve, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        tt.Input,
        {
      ...
      /* @__PURE__ */ o(Ke, { children: /* @__PURE__ */ o(ue, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Lr = Object.fromEntries(
  We.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Rr(t, e, a) {
...
const ra = ["input", "select", "textarea", "button"], na = ["button", "textbox"], qr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const n = xt(null), [s, i] = X(void 0), [l, c] = X(void 0), f = K(
    ...
    if (u.isContentEditable || ra.includes(b)) return !0;
    const g = u.getAttribute("role");
    if (g && na.includes(g)) return !0;
    ...
    (u) => {
      ...
      switch (u.key) {
        case "ArrowDown":
          B = Math.min(P + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          B = Math.max(P - 1, 0), u.preventDefault();
          break;
        case "Home":
...
function fn({
  ...
  const [A, $] = X(!1), Y = K(
    ...
    const C = t.filter((O) => O.starred).sort((O, V) => O.label.localeCompare(V.label)), R = t.filter((O) => !O.starred).sort((O, V) => {
      const lt = e.includes(O.value), q = e.includes(V.value);
      return lt && !q ? -1 : !lt && q ? 1 : O.label.localeCompare(V.label);
    });
    return [...C, ...R];
  }, [t, e, S]), M = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ m(Xt, { open: x, onOpenChange: h ?? $, children: [
    ...
    /* @__PURE__ */ o(qt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Ht, { children: [
      ...
      /* @__PURE__ */ m(Ft, { children: [
        ...
        /* @__PURE__ */ o(Jt, { children: B.map((C) => /* @__PURE__ */ m(
          kt,
          {
            value: C.label,
            onSelect: Y,
...
function pn(t, e, a) {
  ...
  if (ga(t) || Ce.has(t.key) || t.key === "Dead")
    return "passed";
...
const Aa = "platform.footerAction", ne = [
  "openTabs",
  "lastUsed",
  "language",
  "versification",
...
function Oa({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = Qe(), [S, u] = X(!1), b = !!(t.language || t.languageCode), g = b || !!t.typeName || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = f || S, A = K(() => {
    if (g) {
      u(!0);
      return;
    }
        ...
        /* @__PURE__ */ m(
          "span",
          {
            ...
            children: [
              ...
              ze(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        P
  ...
  return /* @__PURE__ */ m(Zt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(Yt, { asChild: !0, children: B }),
    /* @__PURE__ */ m(
      Qt,
      {
        side: "top",
...
function ja({
  ...
  return /* @__PURE__ */ m(sa, { children: [
    /* @__PURE__ */ o(ia, { asChild: !0, children: /* @__PURE__ */ o(
      _,
      {
        variant: "ghost",
        size: "sm",
            ...
            /* @__PURE__ */ m(
              ca,
              {
                ...
                children: [
                  ...
                  t.map((c) => /* @__PURE__ */ o(zt, { value: c, children: Ma(c, i) }, c))
                ]
              }
            )
          ] }),
...
function vn(t) {
  const [e, a] = X(!1), [r, n] = X(""), s = t.availableGroupings ?? Da, i = Pa(
    s,
    t.defaultGrouping,
  ...
  const u = Ga(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: P } = u, { languageUnknownSectionHeading: B } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: H } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Rt(g, !0);
      case "lastUsed":
    ...
    switch (t.mode) {
      case "project": {
        ...
        return w && t.triggerLabelFormat === "shortNameAndFullName" && (p = Ee(w)), { node: p, title: p };
      }
      case "project-multi": {
          ...
          /* @__PURE__ */ m(Ft, { children: [
            ...
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(he, { children: [
                /* @__PURE__ */ o(Jt, { heading: _a(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Oa,
                  {
                    row: y,
                    mode: t.mode,
...
const yn = (t, e, a) => Ha(t, e).every((r) => a.includes(r));
function Va(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, n) => G.bookIdToNumber(r) - G.bookIdToNumber(n)).map((r) => Ye(r, e));
}
function kn(t, e, a, r) {
...
function In({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function Cn({
  ...
  return /* @__PURE__ */ m(Fa, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Ka, { children: [
      /* @__PURE__ */ o(Xa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ie, {}) }),
      /* @__PURE__ */ o(Wa, { children: t })
    ] }),
    a && /* @__PURE__ */ o(qa, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
const Za = Bt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-GMNhTYDZ.js.map
