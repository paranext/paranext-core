...
import { IconX as Ee, IconCheck as Rt, IconSearch as Te, IconChevronLeft as _e, IconChevronRight as Ce } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as ot } from "class-variance-authority";
import C, { useState as H, useRef as pt, useCallback as X, createContext as Le, useContext as Ge, useEffect as Ct, useMemo as at, Fragment as je, forwardRef as te } from "react";
import { ChevronsUpDown as ee, Check as ae, Star as Ae, Group as ze, ArrowRight as Re, Loader2 as De, ChevronDown as Pe, Search as Be, X as Oe, AlertTriangle as Me, LoaderCircle as He } from "lucide-react";
import { Section as rt, MODIFIER_KEYS as Ue, normalizeProjectId as P, compareProjectsByName as $e, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as oe, getLocalizeKeyForScrollGroupId as Ke, hasDistinctFullName as Fe, getSectionForBook as Ve } from "platform-bible-utils";
...
const re = 600, ne = 650, Eo = 400, Qe = 450, ta = 500, To = 510, _o = 520, ea = 675, Co = 690, Lo = 700, Go = 800, se = ot(
...
function de({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(na, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(ia, { children: /* @__PURE__ */ n(Te, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function br({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        s === "rtl" ? /* @__PURE__ */ n(_e, { className: "tw:ms-auto" }) : /* @__PURE__ */ n(Ce, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function Pr({
  ...
  const [V, tt] = H(!1), G = pt(null), et = X(
    ...
    [t, e, a]
  ), R = () => m || o, x = f ?? V, $ = y ?? tt, [W, Z] = H(x), [it, B] = H(e);
  W !== x && (Z(x), x && B(e));
  const ht = at(() => {
    if (!w) return t;
  ...
  return /* @__PURE__ */ n("div", { id: F, className: h, children: /* @__PURE__ */ p(fe, { open: x, onOpenChange: $, children: [
    ...
    /* @__PURE__ */ n(ge, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ce, { children: [
      ...
      /* @__PURE__ */ n(Aa, { isEnabled: g, scrollerRef: G, children: /* @__PURE__ */ p(ue, { ref: G, children: [
...
function Xr(t) {
  ...
  let k;
  t.isLoading ? k = /* @__PURE__ */ n(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? k = void 0 : t.mode === "project-multi" ? k = /* @__PURE__ */ n(ee, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : k = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
              ...
              /* @__PURE__ */ p(ue, { children: [
                ...
                R.map((d, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(pe, { heading: Qa(d, s), children: d.rows.map((j) => /* @__PURE__ */ n(
                          Wa,
                          {
                            row: j,
                            mode: t.mode,
...
const Wr = (t, e, a) => ao(t, e).every((o) => a.includes(o));
function oo(t, e) {
  return [
...
const uo = te(({ className: t, ...e }, a) => /* @__PURE__ */ n(He, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BFpDZJ3Z.js.map
