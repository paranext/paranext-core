...
import { Slot as xt, Dialog as F, Separator as ie, Popover as nt, Tooltip as et, DropdownMenu as _, Label as le, RadioGroup as ht, ToggleGroup as Bt } from "radix-ui";
import { IconX as de, IconSearch as ce, IconCheck as St, IconChevronRight as ue } from "@tabler/icons-react";
import { Canon as j } from "@sillsdev/scripture";
import { cva as X } from "class-variance-authority";
import z, { useState as V, useRef as ut, useCallback as J, createContext as we, useContext as pe, useMemo as Z, useEffect as Gt, Fragment as me, forwardRef as Ot } from "react";
...
import { Section as q, MODIFIER_KEYS as ke, normalizeProjectId as st, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as rt, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as Ee } from "platform-bible-utils";
...
const Ut = 600, $t = 650, or = 400, je = 450, Ae = 500, Re = 675, nr = 690, sr = 700, ir = 800, Kt = X(
...
function ta({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(ee.Provider, { value: r, children: /* @__PURE__ */ n(_.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Br({
  ...t
}) {
...
function co({
  ...
  const [O, W] = V(!1), P = J(
    (y) => {
      var c;
      const B = (c = t.find((p) => p.label === y)) == null ? void 0 : c.value;
      B && a(
        e.includes(B) ? e.filter((p) => p !== B) : [...e, B]
      );
    },
    [t, e, a]
  ), U = () => u || r, T = Z(() => {
    if (!C) return t;
    const y = t.filter((c) => c.starred).sort((c, p) => c.label.localeCompare(p.label)), B = t.filter((c) => !c.starred).sort((c, p) => {
  ...
  return /* @__PURE__ */ n("div", { id: b, className: h, children: /* @__PURE__ */ m(Yt, { open: S, onOpenChange: g ?? W, children: [
    ...
    /* @__PURE__ */ n(te, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Vt, { children: [
      ...
      /* @__PURE__ */ m(Xt, { children: [
        ...
        /* @__PURE__ */ n(Zt, { children: T.map((y) => /* @__PURE__ */ m(
          qt,
          {
            value: y.label,
            onSelect: P,
...
function uo(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || re[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function wo(t, e) {
  var a;
...
function ya(t) {
  ...
  return [
    oe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[rt.lastUsedAt]) == "number" ? dt : Sa;
      },
...
function Ca({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: u,
    onPointerLeave: f
  } = Qe(), [g, k] = V(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || g, h = J(() => {
    if (C) {
      k(!0);
      return;
    }
    ...
    k(!1), f();
  }, [f]), b = /* @__PURE__ */ n(Ht, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
  ...
  ), P = t.scrollGroupId !== void 0 ? lt(t.scrollGroupId) : void 0, U = t.isBoundButClosed && P ? a.boundButClosedTooltip.replace("{group}", P) : void 0;
    ...
    /* @__PURE__ */ m(
      Tt,
      {
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && P && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
      ...
      aa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(ra, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(Rt, { value: at, children: r.groupByNone }),
            /* @__PURE__ */ n(na, {}),
...
function xo(t) {
  const [e, a] = V(!1), [r, o] = V(""), s = Z(() => Ea(t.localizedStrings), [t.localizedStrings]), i = Z(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(oe(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      ka({
  ...
  const w = Z(() => t.mode === "project" ? gt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((A) => {
          const R = t.projects.find((ne) => ne.id === A.projectId);
  ...
  let K;
  t.isLoading ? K = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : T ? K = void 0 : t.mode === "project-multi" ? K = /* @__PURE__ */ n(Mt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : K = /* @__PURE__ */ n(Ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), y = P.title ? /* @__PURE__ */ n(At, { delayDuration: 400, children: /* @__PURE__ */ m(It, { children: [
    /* @__PURE__ */ n(Et, { asChild: !0, children: /* @__PURE__ */ n(Nt, { asChild: !0, children: M }) }),
    /* @__PURE__ */ n(Tt, { children: P.title })
  ] }) }) : /* @__PURE__ */ n(Nt, { asChild: !0, children: M }), B = i.length > 1;
  return /* @__PURE__ */ m(Yt, { open: e, onOpenChange: C, children: [
    y,
    /* @__PURE__ */ n(
      te,
      {
          ...
          /* @__PURE__ */ m(Xt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Zt, { heading: za(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      Ca,
                      {
                        row: I,
                        mode: t.mode,
...
//# sourceMappingURL=resizable-_T0jT9JT.js.map
