...
const $e = ["input", "select", "textarea", "button"], Fe = ["button", "textbox"], lr = ({
  ...
  const o = mt(null), [s, i] = _(void 0), [d, l] = _(void 0), c = $(
    ...
    (f) => {
      var F;
      const N = f.target, x = (C) => C ? document.getElementById(C) : void 0, S = x(d), j = x(s);
...
function Er({
  ...
  return /* @__PURE__ */ n("div", { id: S, className: N, children: /* @__PURE__ */ g(Bt, { open: C, onOpenChange: m ?? O, children: [
...
function na({ row: t, mode: e, strings: r, onClick: a, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    h(!1), c();
  }, [c]), j = /* @__PURE__ */ n(zt, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
  ...
  return /* @__PURE__ */ g(Ft, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ht, { asChild: !0, children: B }),
    /* @__PURE__ */ g(
      Jt,
      {
        side: "top",
      ...
      $t,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ g(Rt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            ...
            /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: B, children: `${h.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ g(Mt, { children: [
