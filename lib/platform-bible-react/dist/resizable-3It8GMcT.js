...
const $t = 600, Kt = 650, co = 400, Le = 450, je = 500, Re = 675, uo = 690, wo = 700, po = 800, Ft = V(
...
const jo = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
function We({
  className: t,
...
const Po = "data-platform-content-zoom-root", Bo = "data-platform-content-zoom-popup", Ye = "--platform-content-zoom-", Qe = "--platform-content-zoom-default", ta = "main", ea = "--platform-content-zoom-popup-factor", Qt = Pt(void 0);
function Mo({ area: t, children: e }) {
...
const na = "min(8rem, calc(var(--radix-dropdown-menu-content-available-width, 100vw) / var(--platform-content-zoom-popup-factor, 1)))";
function sa({
  className: t,
  align: e = "start",
  sideOffset: a = 4,
...
const ua = ["input", "select", "textarea", "button"], wa = ["button", "textbox"], ir = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const r = dt(null), [s, i] = K(void 0), [l, u] = K(void 0), f = F(
    ...
    if (w.isContentEditable || ua.includes(g)) return !0;
    const v = w.getAttribute("role");
    if (v && wa.includes(v)) return !0;
  ...
  const l = z.useMemo(
    ...
    (h) => {
      ...
      if (h.key === "ArrowDown" || h.key === "ArrowUp")
        h.preventDefault(), ha(w, g, h.key);
      else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
        h.preventDefault(), fa(l, v, h.key);
...
function br(t, e, a) {
  ...
  if (ba(t) || ke.has(t.key) || t.key === "Dead")
    return "passed";
...
function Ia(t, e) {
  if (e.id === "openTabs") return Sa(t);
  if (e.id === "selection") return ka(t, e);
...
function Ea(t) {
  ...
  return [
    se(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[et.lastUsedAt]) == "number" ? it : _a;
      },
...
function ja({ row: t, mode: e, strings: a, onClick: o, onOpen: r, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    ...
    /* @__PURE__ */ m(
      sa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(ia, { value: e, onValueChange: a, children: [
...
function Tr(t) {
  const [e, a] = K(!1), [o, r] = K(""), s = Ga(t.localizedStrings), i = Z(() => {
          ...
          /* @__PURE__ */ m(Zt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(qt, { heading: Da(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      ja,
                      {
                        row: I,
                        mode: t.mode,
...
const zr = (t, e, a) => Ma(t, e).every((o) => a.includes(o));
function Ha(t, e) {
  return [
...
function Gr(t, e, a, o) {
  ...
  const i = Ha(t, o);
  if (i.length !== 0)
    return i.length <= Ba ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
function Ar({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
function jr({
  ...
  return /* @__PURE__ */ m(Ua, { className: d(s), role: r, children: [
    /* @__PURE__ */ m($a, { children: [
      /* @__PURE__ */ n(Fa, { variant: "icon", children: o ?? /* @__PURE__ */ n(ye, {}) }),
      /* @__PURE__ */ n(Va, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ja, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Xa = Mt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-3It8GMcT.js.map
