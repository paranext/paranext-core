...
import { Slot as ut, Dialog as M, Popover as Z, Tooltip as X, Label as Vt, RadioGroup as lt, ToggleGroup as kt, Separator as Ut, DropdownMenu as S } from "radix-ui";
...
const be = 600, za = 650, Tt = 400, Ne = 450, ve = 500, xe = 550, Ga = 650, Aa = 700, zt = K(
  ...
  return /* @__PURE__ */ f(ye, { children: [
    ...
    /* @__PURE__ */ f(
      M.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(M.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(P, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(Xt, {}),
...
function Ma({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(M.Close, { asChild: !0, children: /* @__PURE__ */ n(P, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Dr({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f(Ot, { open: C, onOpenChange: b ?? O, children: [
    ...
    /* @__PURE__ */ n(jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(At, { children: [
      ...
      o && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: F, children: i })
      ] }),
...
function la({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    k(!1), g();
  }, [g]), B = /* @__PURE__ */ n(Et, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
  e === "project" ? t.openGroups.length > 0 && (O = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(rt, { variant: "secondary", children: tt(L) }, L)) })) : t.scrollGroupId !== void 0 && (O = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ia,
      {
  ...
  return /* @__PURE__ */ f(_t, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n($t, { asChild: !0, children: V }),
    /* @__PURE__ */ f(
      Ht,
      {
        side: "top",
...
function Mr(t) {
  ...
  const L = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, F = /* @__PURE__ */ f(
    P,
    {
    ...
    /* @__PURE__ */ n($t, { asChild: !0, children: /* @__PURE__ */ n(ct, { asChild: !0, children: F }) }),
      ...
      jt,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f(At, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: O, children: `${k.selectAll} (${I.length.toString()})` }),
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: V, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(Lt, { children: [
            ...
            v.map((d, u) => (
              ...
              /* @__PURE__ */ f(te, { children: [
                /* @__PURE__ */ n(Pt, { heading: ca(d, k), children: d.rows.map((p) => /* @__PURE__ */ n(
                  la,
                  {
                    row: p,
                    mode: t.mode,
...
const pa = Ct(({ className: t, ...e }, a) => /* @__PURE__ */ n(le, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BBoNbclt.js.map
