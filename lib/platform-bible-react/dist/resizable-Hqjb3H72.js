...
import { Slot as wt, Dialog as M, Popover as W, Label as Vt, RadioGroup as dt, Tooltip as X, Separator as Kt, DropdownMenu as D } from "radix-ui";
import { IconX as Xt, IconSearch as Ut, IconCheck as ft, IconChevronRight as qt } from "@tabler/icons-react";
import { Canon as _ } from "@sillsdev/scripture";
import { includes as et, Section as J, normalizeProjectId as Z, getLocalizeKeyForScrollGroupId as Wt } from "platform-bible-utils";
import { cva as U } from "class-variance-authority";
import z, { useRef as mt, useState as B, useCallback as $, createContext as Zt, useContext as Yt, useMemo as K, useEffect as Qt, Fragment as te, forwardRef as Et } from "react";
import { ChevronsUpDown as St, Check as Tt, Star as ee, Filter as ae, ArrowRight as re, Loader2 as oe, ChevronDown as ne, Search as se, X as ie, LoaderCircle as le } from "lucide-react";
...
import { extendTailwindMerge as ce, twMerge as ue } from "tailwind-merge";
const we = ce({ prefix: "tw" });
function ct(t) {
  const e = [];
  let a = "", r = 0;
...
function w(...t) {
  ...
  }), ue(o.join(" ")).split(" ").filter(Boolean).map((l) => {
    const d = r.get(l);
    return d ? me(l, d) : l;
  }).join(" ");
}
const pe = 600, Na = 300, Dt = 400, he = 450, ge = 500, be = 550, xa = 700, Gt = U(
...
function R({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: w(Gt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
...
function xe({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
function Rt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ g(ye, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        V.Input,
        {
      ...
      /* @__PURE__ */ n(ke, { children: /* @__PURE__ */ n(Ut, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Ee = _.allBookIds.filter(
  (t) => !_.isObsolete(_.bookIdToNumber(t))
), Ma = Object.fromEntries(
  Ee.map((t) => [t, _.bookIdToEnglishName(t)])
);
function Oa(t, e, a) {
...
const { PortalContainerProvider: Se, usePortalContainer: Te } = jt(), ja = Se;
function _t({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
  ...
  return (
    ...
    /* @__PURE__ */ n(W.Portal, { container: i, children: /* @__PURE__ */ n(
      W.Content,
      {
...
function De() {
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", c = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", E = "\\u200d", O = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", L = `[${l}]`, j = `${I}?`, S = `[${c}]?`, T = `(?:${E}(?:${[f, N, x].join("|")})${S + j})*`, G = S + j + T, C = `(?:${[`${f}${m}?`, m, N, x, d, L].join("|")})`;
    return new RegExp(`${O}|${h}(?=${h})|${C + G}`, "g");
  }), it;
}
var bt;
function Ge() {
...
function Ht({
  ...
  return /* @__PURE__ */ n(
    X.Trigger,
    {
      ...
      className: e ? w(Gt({ variant: e }), t) : t,
      ...a
    }
  );
}
const { PortalContainerProvider: Pe, usePortalContainer: Le } = jt(), Za = Pe;
function Ft({
  className: t,
  sideOffset: e = 0,
  ...
  return (
    ...
    /* @__PURE__ */ n(X.Portal, { container: c, children: /* @__PURE__ */ g(
      X.Content,
      {
...
function $e({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Jt.Provider, { value: r, children: /* @__PURE__ */ n(D.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function or({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(D.ItemIndicator, { children: /* @__PURE__ */ n(ft, {}) })
          }
        ),
        e
      ]
...
function yr({
  ...
  return /* @__PURE__ */ n("div", { id: E, className: N, children: /* @__PURE__ */ g(Bt, { open: C, onOpenChange: m ?? L, children: [
    ...
    /* @__PURE__ */ n(_t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(At, { children: [
      /* @__PURE__ */ n(Rt, { placeholder: `Search ${r.toLowerCase()}...` }),
        ...
        /* @__PURE__ */ n(Mt, { children: T.map((p) => /* @__PURE__ */ g(
          Ot,
          {
            ...
            children: [
              ...
              p.starred && /* @__PURE__ */ n(ee, { className: "tw:h-4 tw:w-4" }),
...
function ra({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: c,
    onPointerEnter: l,
    onPointerLeave: d
  } = qe(), [m, h] = B(!1), I = !!(t.language || t.languageCode), f = I || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = c || m, x = $(() => {
    if (f) {
      h(!0);
      return;
    }
    ...
    h(!1), d();
  }, [d]), O = /* @__PURE__ */ n(Tt, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let L;
  ...
  return /* @__PURE__ */ g($t, { open: N, delayDuration: 400, children: [
...
function oa({
  ...
  return /* @__PURE__ */ g($e, { children: [
    ...
    /* @__PURE__ */ g(Fe, { align: "end", className: "tw:w-56", style: { zIndex: Dt }, children: [
...
function Cr(t) {
  ...
  const h = ta(t.localizedStrings), I = K(() => t.mode === "project" ? lt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  ), C = S.title ? /* @__PURE__ */ n(vt, { delayDuration: 400, children: /* @__PURE__ */ g($t, { children: [
    /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(ut, { asChild: !0, children: H }) }),
    /* @__PURE__ */ n(Ft, { children: S.title })
          ...
          /* @__PURE__ */ g(Pt, { children: [
            ...
            N.map((u, p) => (
              ...
              /* @__PURE__ */ g(te, { children: [
                /* @__PURE__ */ n(Mt, { heading: na(u, h), children: u.rows.map((b) => /* @__PURE__ */ n(
                  ra,
                  {
                    row: b,
                    mode: t.mode,
...
const ia = Et(({ className: t, ...e }, a) => /* @__PURE__ */ n(le, { size: 35, className: w("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-Hqjb3H72.js.map
