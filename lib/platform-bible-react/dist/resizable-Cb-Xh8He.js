...
import { Slot as _t, Dialog as $, Separator as fe, Popover as st, Tooltip as et, DropdownMenu as C, Label as he, RadioGroup as xt, ToggleGroup as Vt } from "radix-ui";
...
import j, { useState as P, useRef as it, useCallback as J, createContext as ve, useContext as xe, useEffect as yt, useMemo as Y, Fragment as ye, forwardRef as Jt } from "react";
...
import { Section as Z, MODIFIER_KEYS as ze, normalizeProjectId as R, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as ot, getLocalizeKeyForScrollGroupId as Le, getSectionForBook as Ae } from "platform-bible-utils";
...
const pa = ["input", "select", "textarea", "button"], ma = ["button", "textbox"], po = ({
  ...
  const o = it(null), [s, i] = P(void 0), [l, u] = P(void 0), f = J(
    (w) => {
      i(w);
...
function So({
  ...
  const [q, K] = P(!1), z = it(null), B = J(
    (d) => {
      var y;
      const m = (y = t.find((S) => S.label === d)) == null ? void 0 : y.value;
      m && a(
        e.includes(m) ? e.filter((S) => S !== m) : [...e, m]
      );
    },
    [t, e, a]
  ), L = () => f || r, N = h ?? q, D = I ?? K, [M, W] = P(N), [V, rt] = P(e);
  M !== N && (W(N), N && rt(e));
  const ct = Y(() => {
    if (!w) return t;
    const d = t.filter((y) => y.starred).sort((y, S) => y.label.localeCompare(S.label)), m = t.filter((y) => !y.starred).sort((y, S) => {
      const E = V.includes(y.value), _ = V.includes(S.value);
      return E && !_ ? -1 : !E && _ ? 1 : y.label.localeCompare(S.label);
    });
    return [...d, ...m];
  }, [t, V, w]), gt = () => {
    const d = t.map((m) => m.value);
    rt(d), a(d);
  }, bt = () => {
    rt([]), a([]);
  };
  return /* @__PURE__ */ n("div", { id: F, className: g, children: /* @__PURE__ */ p(ie, { open: N, onOpenChange: D, children: [
    ...
    /* @__PURE__ */ n(de, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ee, { children: [
      ...
      /* @__PURE__ */ n(va, { isEnabled: b, scrollerRef: z, children: /* @__PURE__ */ p(re, { ref: z, children: [
        ...
        /* @__PURE__ */ n(ne, { children: ct.map((d) => /* @__PURE__ */ p(
          jt,
          {
            value: d.label,
            onSelect: B,
...
function Ga(t) {
  ...
  return [
    pe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[ot.lastUsedAt]) == "number" ? ut : ja;
      },
...
function Oa({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: I
  } = na(), [T, w] = P(!1), b = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = f || T, g = J(() => {
    if (b) {
      w(!0);
      return;
    }
  ...
  let q;
  e === "project" ? t.openGroups.length > 0 && (q = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(pt, { variant: "secondary", children: dt(L) }, L)) })) : t.scrollGroupId !== void 0 && (q = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Pa,
      {
  ...
  ), z = t.scrollGroupId !== void 0 ? dt(t.scrollGroupId) : void 0, B = t.isBoundButClosed && z ? a.boundButClosedTooltip.replace("{group}", z) : void 0;
...
function Ao(t) {
  const [e, a] = P(!1), [r, o] = P(""), s = Ra(t.localizedStrings), i = Y(() => {
    ...
    [i, t.defaultGrouping]
  ), h = l ?? f, I = it(null), [T, w] = P(void 0), b = J((d) => {
    a(d), d || (o(""), w(void 0));
  }, []);
  yt(() => {
    if (!e) return;
  ...
  const v = Y(() => t.mode === "project" ? Nt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const m = t.selection.pairs, y = R(d.projectId), S = (_) => R(_.projectId) === y && _.scrollGroupId === d.scrollGroupId, E = m.some(S) ? m.filter((_) => !S(_)) : [
          ...m.filter((_) => !S(_)),
    ...
    switch (t.mode) {
      case "project": {
        ...
        return d && L === "shortNameAndFullName" && d.fullName && d.fullName !== d.shortName && (m = `${d.shortName} - ${d.fullName}`), { node: m, title: m };
      }
      case "project-multi": {
        ...
        if (d.forEach((E) => {
          ...
          _ && m.push({ project: _, scrollGroupId: E.scrollGroupId });
        }), m.length === 0) {
          const E = s.buttonPlaceholder;
          return { node: E, title: E };
        }
        const y = m.map(
          ({ project: E, scrollGroupId: _ }) => _ === void 0 ? E.shortName : `${E.shortName} (${dt(_)})`
        ).join(", "), S = m.length.toString();
        return {
          node: /* @__PURE__ */ p(me, { children: [
            /* @__PURE__ */ n(pt, { variant: "muted", className: "tw:shrink-0", children: S }),
  ...
  yt(() => {
    ...
    const y = new ResizeObserver((S) => {
      S.forEach((E) => {
        ...
        m(_ ? _.inlineSize : d.getBoundingClientRect().width);
      });
    });
  ...
  const rt = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? q : void 0, ct = /* @__PURE__ */ p(
    H,
    {
      ref: D,
  ...
  ] }) }) : /* @__PURE__ */ n(It, { asChild: !0, children: ct }), bt = i.length > 1;
                  ...
                  /* @__PURE__ */ p(
                    ye,
                    {
                      children: [
                        ...
                        m < F.length - 1 && /* @__PURE__ */ n(Ot, { alwaysRender: !0 })
                      ]
                    },
...
//# sourceMappingURL=resizable-Cb-Xh8He.js.map
