...
import z, { createContext as Pt, createElement as me, useContext as Bt, useState as K, useRef as dt, useCallback as F, useMemo as Z, useEffect as zt, Fragment as fe, forwardRef as Mt } from "react";
import { ChevronsUpDown as Ht, Check as Ut, Star as he, Group as ge, ArrowRight as be, Loader2 as Ne, ChevronDown as ve, Search as xe, X as ye, AlertTriangle as Se, LoaderCircle as ke } from "lucide-react";
import { Section as X, MODIFIER_KEYS as Ie, normalizeProjectId as rt, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as et, getLocalizeKeyForScrollGroupId as _e, getSectionForBook as Ee } from "platform-bible-utils";
...
import { extendTailwindMerge as Ce, twMerge as ze } from "tailwind-merge";
const Ge = Ce({ prefix: "tw" });
function ht(t) {
  const e = [];
  let a = "", o = 0;
...
const $t = 600, Kt = 650, co = 400, je = 450, Re = 500, Oe = 675, uo = 690, wo = 700, po = 800, Ft = V(
...
function Xt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ m(Me, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        q.Input,
        {
      ...
      /* @__PURE__ */ n(Ue, { children: /* @__PURE__ */ n(we, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Ao = Object.fromEntries(
  Ve.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Lo(t, e, a) {
...
function nt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && We(o)
  );
}
...
const Po = "data-platform-content-zoom-root", Bo = "data-platform-content-zoom-popup", Qe = "--platform-content-zoom-", ta = "--platform-content-zoom-default", ea = "main", aa = "--platform-content-zoom-popup-factor", Qt = Pt(void 0);
function Mo({ area: t, children: e }) {
  return me(Qt.Provider, { value: t ?? "" }, e);
}
function St() {
  return Bt(Qt);
}
...
function br(t, e, a) {
  ...
  if (ba(t) || Ie.has(t.key) || t.key === "Dead")
    return "passed";
...
function ja({ row: t, mode: e, strings: a, onClick: o, onOpen: r, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: u,
    onPointerLeave: f
  } = oa(), [h, k] = K(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || h, g = F(() => {
    if (C) {
      k(!0);
      return;
    }
...
function Ra({
  ...
  return /* @__PURE__ */ m(ra, { children: [
    /* @__PURE__ */ m(It, { children: [
      /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(na, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
...
function Tr(t) {
  ...
  let U;
  t.isLoading ? U = /* @__PURE__ */ n(Ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : E ? U = void 0 : t.mode === "project-multi" ? U = /* @__PURE__ */ n(Ht, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : U = /* @__PURE__ */ n(ve, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
...
function Ha(t, e) {
  ...
  ].filter((o) => G.bookIdToNumber(o) > 0).sort((o, r) => G.bookIdToNumber(o) - G.bookIdToNumber(r)).map((o) => Ze(o, e));
}
function Gr(t, e, a, o) {
...
function jr({
  ...
  return /* @__PURE__ */ m(Ua, { className: d(s), role: r, children: [
    /* @__PURE__ */ m($a, { children: [
      /* @__PURE__ */ n(Fa, { variant: "icon", children: o ?? /* @__PURE__ */ n(Se, {}) }),
      /* @__PURE__ */ n(Va, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ja, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Xa = Mt(({ className: t, ...e }, a) => /* @__PURE__ */ n(ke, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-ESKWSVhk.js.map
