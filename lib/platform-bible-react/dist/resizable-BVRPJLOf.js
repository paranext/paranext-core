import { jsx as n, jsxs as p, Fragment as me } from "react/jsx-runtime";
import { Slot as _t, Dialog as $, Separator as fe, Popover as nt, Tooltip as et, DropdownMenu as C, Label as he, RadioGroup as xt, ToggleGroup as Vt } from "radix-ui";
...
import j, { useState as P, useRef as st, useCallback as J, createContext as ve, useContext as xe, useEffect as yt, useMemo as Y, Fragment as ye, forwardRef as Jt } from "react";
...
import { Section as Z, MODIFIER_KEYS as ze, normalizeProjectId as R, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as rt, getLocalizeKeyForScrollGroupId as Le, getSectionForBook as Ae } from "platform-bible-utils";
...
const Wt = 600, Zt = 650, pr = 400, He = 450, Ue = 500, $e = 675, mr = 690, fr = 700, hr = 800, Yt = X(
...
function H({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(Yt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ p(Fe, { children: [
    ...
    /* @__PURE__ */ p(
      $.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n($.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(H, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ge, {}),
...
function ae({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ p(Je, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        tt.Input,
        {
...
const Rr = Object.fromEntries(
  Ye.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Dr(t, e, a) {
...
function Lt({
  ...
  return /* @__PURE__ */ n(
    et.Trigger,
    {
      ...
      className: e ? c(Yt({ variant: e }), t) : t,
      ...a
    }
  );
}
function At({
  ...
  return /* @__PURE__ */ n(et.Portal, { children: /* @__PURE__ */ p(
    et.Content,
    {
...
function sa({ variant: t = "default", ...e }) {
  const a = O(), r = j.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ n(ce.Provider, { value: r, children: /* @__PURE__ */ n(C.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Zr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(C.ItemIndicator, { children: /* @__PURE__ */ n(Tt, {}) })
          }
        ),
        e
      ]
...
const pa = ["input", "select", "textarea", "button"], ma = ["button", "textbox"], po = ({
  ...
  const o = st(null), [s, i] = P(void 0), [l, u] = P(void 0), m = J(
    (w) => {
      i(w);
    ...
    (w) => {
      var L;
      const b = w.target, v = (N) => N ? document.getElementById(N) : void 0, g = v(l), U = v(s);
      if (!!(g && b && g.contains(b) && b !== g) && I(b)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !b.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const N = t.find((D) => D.id === l);
            N && m(N.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const D = N.findIndex((W) => W === b);
          if (D === -1) return;
          let M;
          w.key === "ArrowDown" ? M = Math.min(D + 1, N.length - 1) : M = Math.max(D - 1, 0), M !== D && (w.preventDefault(), w.stopPropagation(), (L = N[M]) == null || L.focus());
          return;
        }
        return;
      }
      const K = t.findIndex((N) => N.id === s);
      let z = K;
      switch (w.key) {
        case "ArrowDown":
          z = Math.min(K + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          z = Math.max(K - 1, 0), w.preventDefault();
          break;
        case "Home":
        ...
        default:
          w.key.length === 1 && !w.metaKey && !w.ctrlKey && !w.altKey && (I(b) || (r == null || r(w.key), w.preventDefault()));
          return;
      }
      const B = t[z];
      B && m(B.id);
  ...
  j.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        it(i, '[tabindex]:not([tabindex="-1"])').forEach((h) => {
...
function No({
  ...
  const l = j.useMemo(
    ...
    (h) => {
      ...
      const T = I.closest("table"), w = T ? (
        // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        it(T).filter(
          (g) => g.tagName === "TR"
        )
      ) : [], b = w.indexOf(I), v = l.indexOf(
...
function So({
  ...
  const [q, K] = P(!1), z = st(null), B = J(
    (d) => {
      var y;
      const f = (y = t.find((S) => S.label === d)) == null ? void 0 : y.value;
      f && a(
        e.includes(f) ? e.filter((S) => S !== f) : [...e, f]
      );
    },
    [t, e, a]
  ), L = () => m || r, N = h ?? q, D = I ?? K, [M, W] = P(N), [V, ht] = P(e);
  M !== N && (W(N), N && ht(e));
  const dt = Y(() => {
    if (!w) return t;
    const d = t.filter((y) => y.starred).sort((y, S) => y.label.localeCompare(S.label)), f = t.filter((y) => !y.starred).sort((y, S) => {
      const E = V.includes(y.value), _ = V.includes(S.value);
      return E && !_ ? -1 : !E && _ ? 1 : y.label.localeCompare(S.label);
    });
    return [...d, ...f];
  }, [t, V, w]), gt = () => {
    a(t.map((d) => d.value));
  ...
  return /* @__PURE__ */ n("div", { id: F, className: g, children: /* @__PURE__ */ p(ie, { open: N, onOpenChange: D, children: [
    /* @__PURE__ */ n(It, { asChild: !0, children: /* @__PURE__ */ p(
      H,
      {
        variant: U,
        role: "combobox",
    ...
    /* @__PURE__ */ n(de, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ee, { children: [
      /* @__PURE__ */ n(
        ae,
        {
          placeholder: o ?? r,
      ...
      s && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(H, { variant: "ghost", size: "sm", onClick: gt, children: i }),
        /* @__PURE__ */ n(H, { variant: "ghost", size: "sm", onClick: bt, children: l })
      ] }),
      /* @__PURE__ */ n(va, { isEnabled: b, scrollerRef: z, children: /* @__PURE__ */ p(re, { ref: z, children: [
        /* @__PURE__ */ n(oe, { children: u }),
        /* @__PURE__ */ n(ne, { children: dt.map((d) => /* @__PURE__ */ p(
          jt,
          {
            value: d.label,
            onSelect: B,
...
function ko(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (A(t), a.dismiss(), "ended") : (A(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (A(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (A(t), a.dismiss(), "ended") : t.key === "Backspace" || we[r].test(t.key) ? (A(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && A(t), a.dismiss(), "ended");
}
function Io(t, e) {
  var a;
...
function _a(t) {
  const e = t.filter(Ft).sort(Q), a = t.filter((o) => !Ft(o)).sort(Q);
  if (e.length === 0)
...
function Ta(t, e) {
  const a = t.filter((i) => i.isSelected).sort(Q), r = t.filter((i) => !i.isSelected).sort(Q), o = (i, l) => {
    var m;
...
function Ca(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (T, w) => {
        var b;
        return ((b = e.compareProjects) == null ? void 0 : b.call(e, T.project, w.project)) || Q(T, w);
      }
    ), h = ((I = e.getSectionHeading) == null ? void 0 : I.call(
      e,
      l,
      m.map((T) => T.project)
    )) ?? l;
    return { key: l, heading: h, rows: m };
  });
...
function Ga(t) {
  ...
  return [
    pe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[rt.lastUsedAt]) == "number" ? ct : ja;
      },
...
function Go(t) {
  return {
    openTabsLabel: k(t, "%projectSelector_grouping_openTabs_label%"),
    lastUsedLabel: k(t, "%projectSelector_grouping_lastUsed_label%"),
    lastUsedRecentSectionHeading: k(
      t,
      "%projectSelector_grouping_lastUsed_recentSectionHeading%"
    ),
    lastUsedOtherSectionHeading: k(
      t,
      "%projectSelector_grouping_lastUsed_otherSectionHeading%"
    ),
    languageLabel: k(t, "%projectSelector_grouping_language_label%"),
    languageUnknownSectionHeading: k(
      t,
      "%projectSelector_grouping_language_unknownSectionHeading%"
    ),
    typeLabel: k(t, "%projectSelector_grouping_type_label%"),
    typeUnknownSectionHeading: k(
      t,
      "%projectSelector_grouping_type_unknownSectionHeading%"
    )
  };
...
function zo(t) {
  return {
    label: k(t, "%projectSelector_grouping_selection_label%"),
    selectedSectionHeading: k(
      t,
      "%projectSelector_grouping_selection_selectedSectionHeading%"
    ),
    unselectedSectionHeading: k(
      t,
      "%projectSelector_grouping_selection_unselectedSectionHeading%"
    )
  };
...
function Lo(t) {
  return {
    searchPlaceholder: k(t, "%projectSelector_searchPlaceholder%"),
    commandEmptyMessage: k(
      t,
      "%projectSelector_commandEmptyMessage%"
    ),
    groupByAriaLabel: k(t, "%projectSelector_groupByAriaLabel%"),
    groupSectionLabel: k(t, "%projectSelector_groupSectionLabel%"),
    groupByNone: k(t, "%projectSelector_groupByNone%"),
    openTabsSectionHeading: k(
      t,
      "%projectSelector_openTabsSectionHeading%"
    ),
    otherProjectsSectionHeading: k(
      t,
      "%projectSelector_otherProjectsSectionHeading%"
    ),
    autoOpenTabsGroupingLabel: k(
      t,
      "%projectSelector_grouping_openTabs_label%"
    ),
    autoSelectionGroupingLabel: k(
      t,
      "%projectSelector_grouping_selection_label%"
    ),
    autoSelectionSelectedSectionHeading: k(
      t,
      "%projectSelector_grouping_selection_selectedSectionHeading%"
    ),
    autoSelectionUnselectedSectionHeading: k(
      t,
      "%projectSelector_grouping_selection_unselectedSectionHeading%"
    ),
    boundButClosedTooltip: k(
      t,
      "%projectSelector_boundButClosedTooltip%"
    ),
    openButtonLabel: k(t, "%projectSelector_openButtonLabel%"),
    clearAll: k(t, "%projectSelector_clearAll%")
  };
}
function lt(t) {
...
function Oa({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: I
  } = na(), [T, w] = P(!1), b = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = m || T, g = J(() => {
    if (b) {
      w(!0);
      return;
    }
    ...
    w(!1), I();
  }, [I]), F = /* @__PURE__ */ n(qt, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let q;
  e === "project" ? t.openGroups.length > 0 && (q = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(wt, { variant: "secondary", children: lt(L) }, L)) })) : t.scrollGroupId !== void 0 && (q = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Pa,
      {
  ...
  ), z = t.scrollGroupId !== void 0 ? lt(t.scrollGroupId) : void 0, B = t.isBoundButClosed && z ? a.boundButClosedTooltip.replace("{group}", z) : void 0;
  return /* @__PURE__ */ p(zt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Lt, { asChild: !0, children: K }),
    /* @__PURE__ */ p(
      At,
      {
        side: "top",
        ...
        children: [
          ...
          B && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: B }),
      ...
      la,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ p(da, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(Ut, { value: at, children: r.groupByNone }),
            /* @__PURE__ */ n(ua, {}),
...
function Ao(t) {
  const [e, a] = P(!1), [r, o] = P(""), s = Ra(t.localizedStrings), i = Y(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const d = [];
    return t.openTabs.length > 0 && d.push(pe(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && d.push(
      za({
    ...
    [i, t.defaultGrouping]
  ), h = l ?? m, I = st(null), [T, w] = P(void 0), b = J((d) => {
    a(d), d || (o(""), w(void 0));
  }, []);
  yt(() => {
    if (!e) return;
  ...
  const v = Y(() => t.mode === "project" ? Nt({
    ...
    return d ? v.filter(
      (f) => f.shortName.toLowerCase().includes(d) || f.fullName.toLowerCase().includes(d)
    ) : v;
  }, [v, r]), U = !!t.footerAction && g.length === 0, F = Y(() => {
    if (h === at) return Et(g);
    const d = i.find((f) => f.id === h);
    return d ? Ca(g, d) : Et(g);
  }, [g, h, i]), q = (d) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const f = t.selection.pairs, y = R(d.projectId), S = (_) => R(_.projectId) === y && _.scrollGroupId === d.scrollGroupId, E = f.some(S) ? f.filter((_) => !S(_)) : [
          ...f.filter((_) => !S(_)),
  ...
  }, B = t.mode === "project" ? t.renderTriggerLabel : void 0, L = t.mode === "project" ? t.triggerLabelFormat : void 0, N = Y(() => {
    switch (t.mode) {
      case "project": {
        const d = vt(t.projects, t.selection.projectId);
        if (B) return { node: B(d), title: "" };
        let f = d ? d.shortName : s.buttonPlaceholder;
        return d && L === "shortNameAndFullName" && d.fullName && d.fullName !== d.shortName && (f = `${d.shortName} - ${d.fullName}`), { node: f, title: f };
      }
      case "project-multi": {
        ...
        const f = [];
        if (d.forEach((E) => {
          const _ = vt(t.projects, E.projectId);
          _ && f.push({ project: _, scrollGroupId: E.scrollGroupId });
        }), f.length === 0) {
          const E = s.buttonPlaceholder;
          return { node: E, title: E };
        }
        const y = f.map(
          ({ project: E, scrollGroupId: _ }) => _ === void 0 ? E.shortName : `${E.shortName} (${lt(_)})`
        ).join(", "), S = f.length.toString();
        return {
          node: /* @__PURE__ */ p(me, { children: [
            /* @__PURE__ */ n(wt, { variant: "muted", className: "tw:shrink-0", children: S }),
  ...
  yt(() => {
    ...
    if (f(d.getBoundingClientRect().width), typeof ResizeObserver > "u") return;
    const y = new ResizeObserver((S) => {
      S.forEach((E) => {
        const [_] = E.borderBoxSize;
        f(_ ? _.inlineSize : d.getBoundingClientRect().width);
      });
    });
    return y.observe(d, { box: "border-box" }), () => y.disconnect();
  }, []);
  let V;
  t.isLoading ? V = /* @__PURE__ */ n(Ee, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : M ? V = void 0 : t.mode === "project-multi" ? V = /* @__PURE__ */ n(Xt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : V = /* @__PURE__ */ n(_e, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const ht = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? q : void 0, dt = /* @__PURE__ */ p(
    H,
    {
      ref: D,
  ...
  ), gt = N.title ? /* @__PURE__ */ n(Ht, { delayDuration: 400, children: /* @__PURE__ */ p(zt, { children: [
    /* @__PURE__ */ n(Lt, { asChild: !0, children: /* @__PURE__ */ n(It, { asChild: !0, children: dt }) }),
    /* @__PURE__ */ n(At, { children: N.title })
  ] }) }) : /* @__PURE__ */ n(It, { asChild: !0, children: dt }), bt = i.length > 1;
  return /* @__PURE__ */ p(ie, { open: e, onOpenChange: b, children: [
    gt,
    /* @__PURE__ */ n(
      de,
      {
        ...
        children: /* @__PURE__ */ n(Ht, { delayDuration: 400, children: /* @__PURE__ */ p(
          ee,
          {
            shouldFilter: !1,
            value: U ? T ?? Kt : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(H, { variant: "ghost", size: "sm", onClick: z, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(re, { children: [
                ...
                F.map((d, f) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(ne, { heading: Ha(d, s), children: d.rows.map((y) => {
                          var S;
                          return /* @__PURE__ */ n(
                            Oa,
                            {
                              ...
                              onOpen: ht,
                              selectedRowRef: I,
                              indicator: (S = t.renderProjectIndicator) == null ? void 0 : S.call(t, y.project),
                              reserveIndicatorSlot: !!t.renderProjectIndicator
                            },
                            y.rowKey
                          );
                        }) }),
                        f < F.length - 1 && /* @__PURE__ */ n(Ot, { alwaysRender: !0 })
                      ]
                    },
                ...
                /* @__PURE__ */ p("div", { role: "presentation", className: "tw:sticky tw:bottom-0 tw:z-10 tw:bg-popover", children: [
                  ...
                  /* @__PURE__ */ p(
                    jt,
                    {
                      ...
                      onSelect: () => {
                        var d;
                        (d = t.footerAction) == null || d.onSelect(), b(!1);
                      },
                      children: [
                        /* @__PURE__ */ n(
                          "span",
...
function Ka(t, e) {
  ...
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, o) => G.bookIdToNumber(r) - G.bookIdToNumber(o)).map((r) => ea(r, e));
}
function Po(t, e, a, r) {
...
function Mo({
  ...
  return /* @__PURE__ */ p(Va, { className: c(s), role: o, children: [
    /* @__PURE__ */ p(Ja, { children: [
      /* @__PURE__ */ n(qa, { variant: "icon", children: r ?? /* @__PURE__ */ n(je, {}) }),
      /* @__PURE__ */ n(Wa, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Za, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Ya = Jt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Ge, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BVRPJLOf.js.map
