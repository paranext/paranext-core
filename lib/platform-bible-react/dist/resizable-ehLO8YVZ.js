...
import { Slot as Tt, Dialog as Z, Separator as ye, Popover as ut, Tooltip as ot, DropdownMenu as E, Label as Se, RadioGroup as yt, ToggleGroup as Xt } from "radix-ui";
import { IconX as ke, IconCheck as _t, IconSearch as Ie, IconChevronRight as Ee } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import C, { useState as q, useRef as gt, useCallback as J, createContext as Te, useContext as _e, useMemo as Q, useEffect as Bt, Fragment as Ce, forwardRef as qt } from "react";
import { ChevronsUpDown as Zt, Check as Wt, Star as Le, Group as Ge, ArrowRight as je, Loader2 as Ae, ChevronDown as ze, Search as Re, X as De, AlertTriangle as Pe, LoaderCircle as Be } from "lucide-react";
import { Section as et, MODIFIER_KEYS as Oe, normalizeProjectId as M, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, getLocalizeKeyForScrollGroupId as Me, getSectionForBook as He } from "platform-bible-utils";
...
import { extendTailwindMerge as $e, twMerge as Ke } from "tailwind-merge";
const Fe = $e({ prefix: "tw" });
function St(t) {
  const e = [];
  let a = "", r = 0;
...
function Je(t, e) {
  ...
  const a = St(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), n = a[a.length - 1], s = St(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && n.startsWith("-")) {
    const u = n.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
function d(...t) {
  ...
  }), Ke(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = r.get(u);
    return m ? Je(u, m) : u;
  }).join(" ");
}
const Yt = 600, Qt = 650, br = 400, Xe = 450, qe = 500, Nr = 510, vr = 520, Ze = 675, xr = 690, yr = 700, Sr = 800, te = tt(
...
function X({
  ...
  return /* @__PURE__ */ o(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(te({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
const ee = "layoutDirection";
function ae() {
...
function U() {
  var t;
  try {
    const e = (t = ae()) == null ? void 0 : t.getItem(ee);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function kr(t) {
  var e;
  try {
    (e = ae()) == null || e.setItem(ee, t);
  } catch {
  }
}
function Ir({ ...t }) {
  return /* @__PURE__ */ o(Z.Root, { "data-slot": "dialog", ...t });
}
function Er({ ...t }) {
  return /* @__PURE__ */ o(Z.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function We({ ...t }) {
  return /* @__PURE__ */ o(Z.Portal, { "data-slot": "dialog-portal", ...t });
}
function Tr({ ...t }) {
  return /* @__PURE__ */ o(Z.Close, { "data-slot": "dialog-close", ...t });
}
function Ye({
  className: t,
...
function _r({
  ...
  return /* @__PURE__ */ p(We, { children: [
    /* @__PURE__ */ o(Ye, { className: r, style: n }),
    /* @__PURE__ */ p(
      Z.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(Z.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(X, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(ke, {}),
...
function Lr({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(Z.Close, { asChild: !0, children: /* @__PURE__ */ o(X, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function oe({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ta, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        rt.Input,
        {
      ...
      /* @__PURE__ */ o(aa, { children: /* @__PURE__ */ o(Ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Lt({
  ...
  return /* @__PURE__ */ p(
    rt.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ o(_t, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const ra = [
  ...
  var e;
  return ((e = ra[t]) == null ? void 0 : e.chapters) ?? -1;
}, na = L.allBookIds.filter(
...
const Ur = Object.fromEntries(
  na.map((t) => [t, L.bookIdToEnglishName(t)])
);
function $r(t, e, a) {
...
const Kr = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
let kt = "keyboard", Ut = !1;
function Fr() {
  Ut || typeof document > "u" || (Ut = !0, document.addEventListener(
    "pointerdown",
    () => {
      kt = "pointer";
    },
...
const le = "data-quiet-focus";
function Jr(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(le, ""), t.style.outline = "none"));
}
function Xr(t) {
  t && (t.removeAttribute(le), t.style.removeProperty("outline"));
}
const qr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function ca({
  className: t,
...
function de({ ...t }) {
  return /* @__PURE__ */ o(ut.Root, { "data-slot": "popover", ...t });
}
function It({ ...t }) {
  return /* @__PURE__ */ o(ut.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function Qr({
  ...
  return /* @__PURE__ */ o(ce.Provider, { value: t, children: e });
}
function ue({
  className: t,
  align: e = "center",
  ...
  const s = U(), i = C.useContext(ce);
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ o(ut.Portal, { container: i ?? void 0, children: /* @__PURE__ */ o(
      ut.Content,
      {
...
function to({ ...t }) {
  return /* @__PURE__ */ o(ut.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function jt({ ...t }) {
  return /* @__PURE__ */ o(ot.Root, { "data-slot": "tooltip", ...t });
}
function At({
  className: t,
  variant: e,
  ...
  return /* @__PURE__ */ o(
    ot.Trigger,
    {
      ...
      className: e ? d(te({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const wa = /^%[^%]*%$/;
function we(t) {
  return t !== void 0 && !wa.test(t) && t.trim() !== "";
}
function T(t, e) {
  return we(t) ? t : e;
}
function pa() {
  const [t, e] = q(!1), a = gt(null), r = J(() => {
    const s = a.current;
...
function ma({ variant: t = "default", ...e }) {
  const a = U(), r = C.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ o(pe.Provider, { value: r, children: /* @__PURE__ */ o(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function oo({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ o(
          "span",
          {
            ...
            children: /* @__PURE__ */ o(E.ItemIndicator, { children: /* @__PURE__ */ o(_t, {}) })
          }
        ),
        e
      ]
...
const xa = ["input", "select", "textarea", "button"], ya = ["button", "textbox"], vo = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = gt(null), [s, i] = q(void 0), [l, u] = q(void 0), m = J(
    (w) => {
      i(w);
      const h = t.find((g) => g.id === w);
      h && (e == null || e(h));
    ...
    if (w.isContentEditable || xa.includes(h)) return !0;
    const v = w.getAttribute("role");
    if (v && ya.includes(v)) return !0;
    const g = w.getAttribute("tabindex");
    return g !== void 0 && g !== "-1";
  }, I = J(
    (w) => {
      var R;
      const h = w.target, v = (y) => y ? document.getElementById(y) : void 0, g = v(l), $ = v(s);
      if (!!(g && h && g.contains(h) && h !== g) && k(h)) {
      ...
      switch (w.key) {
        case "ArrowDown":
          z = Math.min(W + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          z = Math.max(W - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function ht({ className: t, variant: e = "default", asChild: a = !1, ...r }) {
    ...
    const a = (r) => {
      if (e.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const n = t.current ? wt(t.current) : [], s = n.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = C.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), Ea(w, h, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), Ia(l, v, f.key);
...
function Lo({
  ...
  const [$, K] = q(!1), F = J(
    (S) => {
      var D;
      const G = (D = t.find((P) => P.label === S)) == null ? void 0 : D.value;
      G && a(
        e.includes(G) ? e.filter((P) => P !== G) : [...e, G]
      );
    },
    [t, e, a]
  ), W = () => u || r, z = Q(() => {
    if (!I) return t;
    const S = t.filter((D) => D.starred).sort((D, P) => D.label.localeCompare(P.label)), G = t.filter((D) => !D.starred).sort((D, P) => {
      const st = e.includes(D.value), it = e.includes(P.value);
      return st && !it ? -1 : !st && it ? 1 : D.label.localeCompare(P.label);
    });
    return [...S, ...G];
  }, [t, e, I]), Y = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: g, className: h, children: /* @__PURE__ */ p(de, { open: y, onOpenChange: f ?? K, children: [
    /* @__PURE__ */ o(It, { asChild: !0, children: /* @__PURE__ */ p(
      X,
      {
        variant: v,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ o(Zt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(ue, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(re, { children: [
      /* @__PURE__ */ o(
        oe,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(X, { variant: "ghost", size: "sm", onClick: Y, children: s }),
        /* @__PURE__ */ o(X, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ p(ne, { children: [
        /* @__PURE__ */ o(se, { children: l }),
        /* @__PURE__ */ o(ie, { children: z.map((S) => /* @__PURE__ */ p(
          Lt,
          {
            value: S.label,
            onSelect: F,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Le, { className: "tw:h-4 tw:w-4" }),
...
function Go(t, e, a) {
  ...
  if (_a(t) || Oe.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (O(t), a.dismiss(), "ended") : (O(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (O(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (O(t), a.dismiss(), "ended") : t.key === "Backspace" || fe[r].test(t.key) ? (O(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && O(t), a.dismiss(), "ended");
}
function jo(t, e) {
  var a;
...
function Ao(t) {
  ...
  n.current += 1;
  const w = n.current, h = a ? "backslash" : "selection", v = { kind: h, token: w, filter: "", items: e };
...
function ja(t) {
  ...
  return t.forEach((a) => {
    const r = M(a.projectId), n = e.get(r), s = {
...
function Ft(t, e, a) {
  const r = M(e);
  return t.some(
    (n) => M(n.projectId) === r && n.scrollGroupId === a
  );
}
function xt(t) {
...
function Aa(t) {
  const e = t.filter(Vt).sort(at), a = t.filter((n) => !Vt(n)).sort(at);
  if (e.length === 0)
...
function za(t, e) {
  const a = t.filter((i) => i.isSelected).sort(at), r = t.filter((i) => !i.isSelected).sort(at), n = (i, l) => {
    var m;
...
function Ra(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (I, w) => {
        var h;
        return ((h = e.compareProjects) == null ? void 0 : h.call(e, I.project, w.project)) || at(I, w);
      }
...
function x(t, e) {
  const a = t[e];
  if (!(typeof a != "string" || !we(a)))
    return a;
}
const mt = "recent", Da = "other";
function ge(t) {
  return {
    id: "openTabs",
    label: t ?? "Open tabs"
...
function Pa(t) {
  ...
  return [
    ge(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[dt.lastUsedAt]) == "number" ? mt : Da;
      },
      ...
      compareSections: (a, r) => a.key === mt ? -1 : r.key === mt ? 1 : 0
    },
    {
      id: "language",
      ...
      getGroupKey: (a) => {
        var n;
        const r = (n = a.customData) == null ? void 0 : n[dt.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const r = (n = a.customData) == null ? void 0 : n[dt.type];
        return typeof r == "string" ? r : void 0;
      },
...
function pt(t) {
  return ia[Me(t)] ?? String(t);
}
const Jt = "platform.footerAction", Ha = {
...
function Ua({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ o(ht, { variant: "secondary", children: a });
}
function $a({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = pa(), [I, w] = q(!1), h = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, g = J(() => {
    if (h) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), K = /* @__PURE__ */ o(Wt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let F;
  e === "project" ? t.openGroups.length > 0 && (F = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ o(ht, { variant: "secondary", children: pt(R) }, R)) })) : t.scrollGroupId !== void 0 && (F = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Ua,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ o(je, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  const W = /* @__PURE__ */ p(
    Lt,
    {
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: K }),
  ...
  ), z = t.scrollGroupId !== void 0 ? pt(t.scrollGroupId) : void 0, Y = t.isBoundButClosed && z ? a.boundButClosedTooltip.replace("{group}", z) : void 0;
  return /* @__PURE__ */ p(jt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ o(At, { asChild: !0, children: W }),
    /* @__PURE__ */ p(
      zt,
      {
        side: "top",
        ...
        children: [
          ...
          Y && /* @__PURE__ */ o("div", { className: "tw:text-sm tw:italic", children: Y }),
...
function Ka({
  ...
  return /* @__PURE__ */ p(ma, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ o(At, { asChild: !0, children: /* @__PURE__ */ o(fa, { asChild: !0, children: /* @__PURE__ */ o(
        X,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      ga,
      {
        ...
        style: { zIndex: Qt },
        children: [
          /* @__PURE__ */ o(ba, { children: r.groupSectionLabel }),
          /* @__PURE__ */ p(ha, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ o(Kt, { value: nt, children: r.groupByNone }),
            /* @__PURE__ */ o(Na, {}),
            t.map((s) => /* @__PURE__ */ o(Kt, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function Ho(t) {
  const [e, a] = q(!1), [r, n] = q(""), s = Q(() => Ma(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
    ...
    () => Fa(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), f = l ?? m, k = gt(null), [I, w] = q(void 0), h = J((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Bt(() => {
    if (!e) return;
  ...
  const v = Q(() => t.mode === "project" ? xt({
    ...
    [$]
  ), { renderProjectIndicator: F } = t, W = J(
    (c) => F ? F(c.project) : void 0,
    [F]
  ), z = !!F, Y = !!t.footerAction && g.length === 0, R = Q(() => {
    if (f === nt) return Et(g);
    const c = i.find((b) => b.id === f);
    return c ? Ra(g, c) : Et(g);
  }, [g, f, i]), y = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, B = M(c.projectId), H = (A) => M(A.projectId) === B && A.scrollGroupId === c.scrollGroupId, j = b.some(H) ? b.filter((A) => !H(A)) : [
          ...b.filter((A) => !H(A)),
  ...
  }, G = t.mode === "project" ? t.renderTriggerLabel : void 0, D = t.mode === "project" ? t.triggerLabelFormat : void 0, P = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = K(t.selection.projectId);
        if (G) return { node: G(c), title: "" };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && D === "shortNameAndFullName" && c.fullName && c.fullName !== c.shortName && (b = `${c.shortName} - ${c.fullName}`), { node: b, title: b };
      }
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((j) => {
          const A = K(j.projectId);
          A && b.push({ project: A, scrollGroupId: j.scrollGroupId });
        }), b.length === 0) {
          const j = s.buttonPlaceholder;
          return { node: j, title: j };
        }
        const B = b.map(
          ({ project: j, scrollGroupId: A }) => A === void 0 ? j.shortName : `${j.shortName} (${pt(A)})`
        ).join(", "), H = b.length.toString();
        return {
          node: /* @__PURE__ */ p(xe, { children: [
            /* @__PURE__ */ o(ht, { variant: "muted", className: "tw:shrink-0", children: H }),
            /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: B })
          ] }),
          title: `${H} ${B}`
        };
      }
  ...
  Bt(() => {
    ...
    const B = new ResizeObserver((H) => {
      H.forEach((j) => {
        const [A] = j.borderBoxSize;
        b(A ? A.inlineSize : c.getBoundingClientRect().width);
      });
    });
    return B.observe(c, { box: "border-box" }), () => B.disconnect();
  }, []);
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ o(Ae, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ o(Zt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ o(ze, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const be = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, Pt = /* @__PURE__ */ p(
    X,
    {
      ref: st,
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof P.node == "string" ? /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: P.node }) : P.node }),
        lt
      ]
    }
  ), Ne = P.title ? /* @__PURE__ */ o($t, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ o(At, { asChild: !0, children: /* @__PURE__ */ o(It, { asChild: !0, children: Pt }) }),
    /* @__PURE__ */ o(zt, { children: P.title })
  ] }) }) : /* @__PURE__ */ o(It, { asChild: !0, children: Pt }), ve = i.length > 1;
  return /* @__PURE__ */ p(de, { open: e, onOpenChange: h, children: [
    Ne,
    /* @__PURE__ */ o(
      ue,
      {
        ...
        children: /* @__PURE__ */ o($t, { delayDuration: 400, children: /* @__PURE__ */ p(
          re,
          {
            shouldFilter: !1,
            value: Y ? I ?? Jt : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ o(X, { variant: "ghost", size: "sm", onClick: S, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(ne, { children: [
                /* @__PURE__ */ o(se, { children: s.commandEmptyMessage }),
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(ie, { heading: Va(c, s), children: c.rows.map((B) => /* @__PURE__ */ o(
                          $a,
                          {
                            row: B,
                            mode: t.mode,
                        ...
                        b < R.length - 1 && /* @__PURE__ */ o(Mt, { alwaysRender: !0 })
                      ]
                    },
                ...
                /* @__PURE__ */ p("div", { role: "presentation", className: "tw:sticky tw:bottom-0 tw:z-10 tw:bg-popover", children: [
                  ...
                  /* @__PURE__ */ p(
                    Lt,
                    {
                      ...
                      onSelect: () => {
                        var c;
                        (c = t.footerAction) == null || c.onSelect(), h(!1);
                      },
                      children: [
                        /* @__PURE__ */ o(
                          "span",
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            X,
            {
              ...
              children: [
                /* @__PURE__ */ o(De, { className: "tw:h-4 tw:w-4" }),
...
const $o = (t, e, a) => qa(t, e).every((r) => a.includes(r));
function Za(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => L.bookIdToNumber(r) > 0).sort((r, n) => L.bookIdToNumber(r) - L.bookIdToNumber(n)).map((r) => la(r, e));
}
function Ko(t, e, a, r) {
...
function Jo({
  ...
  return /* @__PURE__ */ p(Wa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Ya, { children: [
      /* @__PURE__ */ o(tr, { variant: "icon", children: r ?? /* @__PURE__ */ o(Pe, {}) }),
      /* @__PURE__ */ o(er, { children: t })
    ] }),
    a && /* @__PURE__ */ o(ar, { children: /* @__PURE__ */ o(X, { onClick: () => a(), children: e }) })
  ] });
}
const rr = qt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Be, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-ehLO8YVZ.js.map
