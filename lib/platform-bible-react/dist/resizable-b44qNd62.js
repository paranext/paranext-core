...
import { Slot as jt, Dialog as Y, Separator as Ce, Popover as wt, Tooltip as lt, DropdownMenu as T, Label as Le, RadioGroup as _t, ToggleGroup as ee } from "radix-ui";
...
import L, { createContext as ae, useContext as oe, useState as H, useRef as pt, useCallback as J, useEffect as Ct, useMemo as et, Fragment as je, useId as Re, forwardRef as re } from "react";
...
const le = 600, ce = 650, jo = 400, aa = 450, oa = 500, Ro = 510, Oo = 520, ra = 675, Po = 690, Do = 700, Bo = 800, de = at(
  ...
  return /* @__PURE__ */ p(na, { children: [
    ...
    /* @__PURE__ */ p(
      Y.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(Y.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(X, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(Ae, {}),
...
function Vo({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(Y.Close, { asChild: !0, children: /* @__PURE__ */ n(X, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
at("tw:flex tw:items-center tw:gap-2 tw:text-sm tw:shadow-none", {
  variants: {
    size: {
...
function nr(t, e, a) {
  ...
  if (!o) return !1;
  const r = A.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function Se({
  ...
  const s = $(), i = L.useContext(xe), l = Bt();
  return (
...
function Ea({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Ie.Provider, { value: o, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function yr({
  ...t
}) {
...
const ja = ["input", "select", "textarea", "button"], Ra = ["button", "textbox"], Dr = ({
  ...
  const r = pt(null), [s, i] = H(void 0), [l, u] = H(void 0), m = J(
    (w) => {
      i(w);
    ...
    (w) => {
      var U;
      const g = w.target, v = (N) => N ? document.getElementById(N) : void 0, h = v(l), F = v(s);
      if (!!(h && g && h.contains(g) && g !== h) && y(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const N = t.find((k) => k.id === l);
            N && m(N.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const k = N.findIndex((W) => W === g);
          if (k === -1) return;
          let Z;
          w.key === "ArrowDown" ? Z = Math.min(k + 1, N.length - 1) : Z = Math.max(k - 1, 0), Z !== k && (w.preventDefault(), w.stopPropagation(), (U = N[Z]) == null || U.focus());
          return;
        }
        return;
      }
      const tt = t.findIndex((N) => N.id === s);
      let R = tt;
      switch (w.key) {
        case "ArrowDown":
          R = Math.min(tt + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          R = Math.max(tt - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function Xr({
  ...
  const [Q, tt] = H(!1), R = pt(null), ot = J(
    (I) => {
      var B;
      const q = (B = t.find((V) => V.label === I)) == null ? void 0 : B.value;
      q && a(
        e.includes(q) ? e.filter((V) => V !== q) : [...e, q]
      );
    },
    [t, e, a]
  ), U = () => m || o, N = f ?? Q, k = y ?? tt, [Z, W] = H(N), [it, D] = H(e);
  Z !== N && (W(N), N && D(e));
  const ht = et(() => {
    if (!w) return t;
    const I = t.filter((B) => B.starred).sort((B, V) => B.label.localeCompare(V.label)), q = t.filter((B) => !B.starred).sort((B, V) => {
      const bt = it.includes(B.value), vt = it.includes(V.value);
      return bt && !vt ? -1 : !bt && vt ? 1 : B.label.localeCompare(V.label);
    });
    return [...I, ...q];
  }, [t, it, w]), gt = () => {
    const I = t.map((q) => q.value);
    D(I), a(I);
  }, Et = () => {
    D([]), a([]);
  };
  return /* @__PURE__ */ n("div", { id: K, className: h, children: /* @__PURE__ */ p(Ne, { open: N, onOpenChange: k, children: [
    ...
    /* @__PURE__ */ n(Se, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(pe, { children: [
      ...
      s && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(X, { variant: "ghost", size: "sm", onClick: gt, children: i }),
        /* @__PURE__ */ n(X, { variant: "ghost", size: "sm", onClick: Et, children: l })
      ] }),
      /* @__PURE__ */ n(Ha, { isEnabled: g, scrollerRef: R, children: /* @__PURE__ */ p(fe, { ref: R, children: [
...
function ro({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = ka(), [E, w] = H(!1), g = Re(), v = t.isDisabled && !!t.disabledReason, h = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || v, F = m || E, K = J(() => {
    if (h) {
      w(!0);
      return;
    }
    ...
    w(!1), y();
  }, [y]), tt = /* @__PURE__ */ n(se, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let R;
  e === "project" ? t.openGroups.length > 0 && (R = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((k) => /* @__PURE__ */ n(St, { variant: "secondary", children: ft(k) }, k)) })) : t.scrollGroupId !== void 0 && (R = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      oo,
      {
  ...
  const ot = /* @__PURE__ */ p(
    Pt,
    {
      ...
      children: [
        ...
        R,
        v && /* @__PURE__ */ n("span", { id: g, hidden: !0, children: t.disabledReason })
      ]
    }
  ), U = t.scrollGroupId !== void 0 ? ft(t.scrollGroupId) : void 0, N = t.isBoundButClosed && U ? a.boundButClosedTooltip.replace("{group}", U) : void 0;
  return /* @__PURE__ */ p(Ht, { open: F, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ut, { asChild: !0, children: ot }),
    /* @__PURE__ */ p(
      $t,
      {
        side: "top",
        ...
        children: [
          ...
          N && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: N }),
...
function nn(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = et(() => eo(t.localizedStrings), [t.localizedStrings]), i = et(() => {
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, y = pt(null), [E, w] = H(void 0), g = J((d) => {
    a(d), d || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const v = et(() => t.mode === "project" ? Tt({
    ...
    [F]
  ), { renderProjectIndicator: Q } = t, tt = J(
    (d) => Q ? Q(d.project) : void 0,
    [Q]
  ), R = !!Q, ot = !!t.footerAction && h.length === 0, U = et(() => {
    if (f === ct) return Gt(h);
  ...
  }, W = t.mode === "project" ? t.renderTriggerLabel : void 0, it = t.mode === "project" ? t.triggerLabelFormat : void 0, D = et(() => {
    switch (t.mode) {
      case "project": {
  ...
  const q = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? N : void 0, B = s.ariaLabel && D.hasSelection && D.title ? `${s.ariaLabel}: ${D.accessibleTitle ?? D.title}` : s.ariaLabel || void 0, V = /* @__PURE__ */ p(
    X,
    {
      ref: ht,
    ...
    /* @__PURE__ */ n(Ut, { asChild: !0, children: /* @__PURE__ */ n(zt, { asChild: !0, children: V }) }),
    /* @__PURE__ */ n($t, { dir: "auto", children: D.title })
  ] }) }) : /* @__PURE__ */ n(zt, { asChild: !0, children: V }), vt = i.length > 1;
        ...
        children: /* @__PURE__ */ n(Wt, { delayDuration: 400, children: /* @__PURE__ */ p(
          pe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(X, { variant: "ghost", size: "sm", onClick: Z, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
                  ...
                  /* @__PURE__ */ p(
                    je,
                    {
                      children: [
                        ...
                        b < U.length - 1 && /* @__PURE__ */ n(Jt, { alwaysRender: !0 })
                      ]
                    },
...
function wo(t, e) {
  ...
  ].filter((o) => A.bookIdToNumber(o) > 0).sort((o, r) => A.bookIdToNumber(o) - A.bookIdToNumber(r)).map((o) => ha(o, e));
}
function cn(t, e, a, o) {
...
function wn({
  ...
  return /* @__PURE__ */ p(po, { className: c(s), role: r, children: [
    ...
    a && /* @__PURE__ */ n(bo, { children: /* @__PURE__ */ n(X, { onClick: () => a(), children: e }) })
  ] });
}
...
//# sourceMappingURL=resizable-b44qNd62.js.map
