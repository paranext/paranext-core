...
import { Slot as Nt, Dialog as $, Separator as de, Popover as ot, Tooltip as Q, DropdownMenu as T, Label as ce, RadioGroup as ft, ToggleGroup as Pt } from "radix-ui";
...
import z, { createContext as Bt, forwardRef as xt, useContext as Mt, useState as K, useRef as dt, useCallback as F, useMemo as Z, useEffect as Gt, Fragment as me } from "react";
...
function Ae(t, e) {
  ...
  const a = ht(t);
  if (a[0] !== "tw") return t;
  const o = a.slice(1, -1), n = a[a.length - 1], s = ht(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && n.startsWith("-")) {
    const u = n.slice(1);
    return [...o, `-tw-${u}`].join(":");
  }
...
function d(...t) {
  ...
  return a.forEach((u) => {
    const f = Ge(u);
    o.set(f.normalized, f.original), n.push(f.normalized);
  }), Ce(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const f = o.get(u);
    return f ? Ae(u, f) : u;
  }).join(" ");
}
const $t = 600, Kt = 650, uo = 400, Le = 450, je = 500, Re = 675, wo = 690, po = 700, mo = 800, Ft = V(
...
function ho({ ...t }) {
  return /* @__PURE__ */ r($.Root, { "data-slot": "dialog", ...t });
}
function go({ ...t }) {
  return /* @__PURE__ */ r($.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function Oe({ ...t }) {
  return /* @__PURE__ */ r($.Portal, { "data-slot": "dialog-portal", ...t });
}
function bo({ ...t }) {
  return /* @__PURE__ */ r($.Close, { "data-slot": "dialog-close", ...t });
}
function De({
  className: t,
  ...
  return /* @__PURE__ */ m(Oe, { children: [
    ...
    /* @__PURE__ */ m(
      $.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ r($.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(H, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ r(ue, {}),
...
function xo({
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ r($.Close, { asChild: !0, children: /* @__PURE__ */ r(H, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Xt({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m(Be, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ r(
        q.Input,
        {
      ...
      /* @__PURE__ */ r(He, { children: /* @__PURE__ */ r(we, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Yt({
  ...
  return /* @__PURE__ */ m(
    q.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ r(vt, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const Ro = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
function We({
  className: t,
...
const Bo = "data-platform-content-zoom-root", Mo = "data-platform-content-zoom-popup", Ye = "--platform-content-zoom-", Qe = "--platform-content-zoom-default", ta = "main", ea = "--platform-content-zoom-popup-factor", Qt = Bt(void 0);
function aa({ area: t, children: e }) {
  return /* @__PURE__ */ r(Qt.Provider, { value: t ?? "", children: e });
}
function kt() {
  return Mt(Qt);
}
...
const oa = xt(
  function({ area: e, ...a }, o) {
    return /* @__PURE__ */ r(aa, { area: e, children: /* @__PURE__ */ r(
      "div",
      {
        ref: o,
        ...a,
...
oa.displayName = "ContentZoomRoot";
function te({ ...t }) {
  return /* @__PURE__ */ r(ot.Root, { "data-slot": "popover", ...t });
}
function gt({ ...t }) {
  return /* @__PURE__ */ r(ot.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function Ho({
  ...
  return /* @__PURE__ */ r(ee.Provider, { value: t, children: e });
}
function ae({
  className: t,
  align: e = "center",
  ...
  const s = B(), i = z.useContext(ee), l = kt();
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ r(ot.Portal, { container: i ?? void 0, children: /* @__PURE__ */ r(
      ot.Content,
      {
        ...
        className: d(
          ...
          l !== void 0 && "tw:max-h-[calc(var(--radix-popover-content-available-height)/var(--platform-content-zoom-popup-factor,1))]",
          t
        ),
        style: {
          zIndex: $t,
          ...l === void 0 ? void 0 : It(l),
          ...o
        },
        dir: s,
...
function Uo({ ...t }) {
  return /* @__PURE__ */ r(ot.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function _t({ ...t }) {
  return /* @__PURE__ */ r(Q.Root, { "data-slot": "tooltip", ...t });
}
function Et({
  className: t,
  variant: e,
...
function Tt({
  ...
  const l = kt();
  return /* @__PURE__ */ r(Q.Portal, { children: /* @__PURE__ */ m(
    Q.Content,
    {
...
function na({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ r(oe.Provider, { value: o, children: /* @__PURE__ */ r(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Vo({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: /* @__PURE__ */ r(T.ItemIndicator, { children: /* @__PURE__ */ r(vt, {}) })
          }
        ),
        e
      ]
  ...
  return /* @__PURE__ */ m(
    T.SubTrigger,
    {
      ...
      className: d(
        ...
        t,
        // CUSTOM: Apply variant-driven styles from menu context
        pt({ variant: n.variant })
      ),
      ...o,
      children: [
        a,
        /* @__PURE__ */ r(pe, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const wa = ["input", "select", "textarea", "button"], pa = ["button", "textbox"], ir = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const n = dt(null), [s, i] = K(void 0), [l, u] = K(void 0), f = F(
    (w) => {
      i(w);
    ...
    const a = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const n = t.current ? nt(t.current) : [], s = n.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = z.useMemo(
    ...
    (h) => {
      ...
      if (h.key === "ArrowDown" || h.key === "ArrowUp")
        h.preventDefault(), ga(w, g, h.key);
      else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
        h.preventDefault(), ha(l, v, h.key);
...
function gr({
  ...
  return /* @__PURE__ */ r("div", { id: b, className: g, children: /* @__PURE__ */ m(te, { open: y, onOpenChange: h ?? J, children: [
    /* @__PURE__ */ r(gt, { asChild: !0, children: /* @__PURE__ */ m(
      H,
      {
        variant: v,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ r(Ht, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(ae, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Jt, { children: [
      /* @__PURE__ */ r(
        Xt,
        {
      ...
      n && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ r(H, { variant: "ghost", size: "sm", onClick: Y, children: s }),
        /* @__PURE__ */ r(H, { variant: "ghost", size: "sm", onClick: U, children: i })
      ] }),
      /* @__PURE__ */ m(Zt, { children: [
        /* @__PURE__ */ r(Wt, { children: l }),
        /* @__PURE__ */ r(qt, { children: E.map((S) => /* @__PURE__ */ m(
          Yt,
          {
            value: S.label,
            onSelect: R,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(fe, { className: "tw:h-4 tw:w-4" }),
...
function ba(t, e, a) {
  if (!e) return [...t];
  const o = [...t], n = at(e).toLowerCase();
  return a === "passive" ? At({
    query: n,
    items: o,
    filter: (s) => at(s.label).toLowerCase().startsWith(n),
    sortBy: "label"
  }) : At({
    query: n,
    items: o,
    filter: (s) => at(s.label).toLowerCase().includes(n),
    sortBy: "label"
  });
}
function Na(t) {
...
function br(t, e, a) {
  ...
  if (Na(t) || ke.has(t.key) || t.key === "Dead")
    return "passed";
...
function Sa(t) {
  ...
  return t.forEach((a) => {
    const o = rt(a.projectId), n = e.get(o), s = {
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Ot(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
    ...
    if (n.scrollGroupId === void 0 || o.some((i) => i.projectId === n.projectId && i.scrollGroupId === n.scrollGroupId))
      return;
...
const Ct = "Selected", zt = "Unselected";
function Dt(t) {
...
function ka(t) {
  const e = t.filter(Dt).sort(W), a = t.filter((n) => !Dt(n)).sort(W);
  if (e.length === 0)
...
function Ia(t, e) {
  const a = t.filter((i) => i.isSelected).sort(W), o = t.filter((i) => !i.isSelected).sort(W), n = (i, l) => {
    var f;
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? Ct : zt;
  }, s = [];
...
function Ta(t) {
  ...
  return [
    se(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[et.lastUsedAt]) == "number" ? it : Ea;
      },
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[et.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[et.type];
        return typeof o == "string" ? o : void 0;
      },
      ...
      getSectionHeading: (a, o) => {
        ...
        ), s = (i = n == null ? void 0 : n.customData) == null ? void 0 : i[et.typeName];
...
function Ca(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? Ct : e.unselectedSectionHeading ?? zt
  };
}
function Ir(t) {
  return {
...
const za = 100, Ga = {
  ...
  autoSelectionUnselectedSectionHeading: zt,
...
function ja({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = st(t);
  return e ? /* @__PURE__ */ r(
    ct,
    {
  ...
  ) : /* @__PURE__ */ r(ct, { variant: "secondary", children: a });
}
function Ra({ row: t, mode: e, strings: a, onClick: o, onOpen: n, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: f
  } = ra(), [h, k] = K(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || h, g = F(() => {
    if (C) {
      k(!0);
      return;
    }
    ...
    k(!1), f();
  }, [f]), b = /* @__PURE__ */ r(Ut, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let D;
  e === "project" ? t.openGroups.length > 0 && (D = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((E) => /* @__PURE__ */ r(ct, { variant: "secondary", children: st(E) }, E)) })) : t.scrollGroupId !== void 0 && (D = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ r(
      ja,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ m(
      H,
      {
        ...
        children: [
          /* @__PURE__ */ r(ge, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  const J = /* @__PURE__ */ m(
    Yt,
    {
      ...
      children: [
        /* @__PURE__ */ r("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: b }),
        /* @__PURE__ */ m(
          "span",
          {
            ref: i,
  ...
  return /* @__PURE__ */ m(_t, { open: w, delayDuration: 400, children: [
    /* @__PURE__ */ r(Et, { asChild: !0, children: J }),
    /* @__PURE__ */ m(
      Tt,
      {
        side: "top",
        ...
        children: [
          ...
          M && /* @__PURE__ */ r("div", { className: "tw:text-sm tw:italic", children: M }),
...
function Oa({
  ...
  return /* @__PURE__ */ m(na, { children: [
    /* @__PURE__ */ m(_t, { children: [
      /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(sa, { asChild: !0, children: /* @__PURE__ */ r(
        H,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ r(Tt, { children: o.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      ia,
      {
        ...
        style: { zIndex: Kt },
        children: [
          /* @__PURE__ */ r(da, { children: o.groupSectionLabel }),
          /* @__PURE__ */ m(la, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ r(Rt, { value: tt, children: o.groupByNone }),
            /* @__PURE__ */ r(ca, {}),
            t.map((s) => /* @__PURE__ */ r(Rt, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function Tr(t) {
  const [e, a] = K(!1), [o, n] = K(""), s = Aa(t.localizedStrings), i = Z(() => {
      ...
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ m(le, { children: [
            /* @__PURE__ */ r(ct, { variant: "muted", className: "tw:shrink-0", children: _ }),
            /* @__PURE__ */ r("span", { className: "tw:min-w-0 tw:truncate", children: I })
          ] }),
          title: `${_} ${I}`
        };
      }
  ...
  let U;
  t.isLoading ? U = /* @__PURE__ */ r(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : E ? U = void 0 : t.mode === "project-multi" ? U = /* @__PURE__ */ r(Ht, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : U = /* @__PURE__ */ r(Ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  ...
  ), S = R.title ? /* @__PURE__ */ r(jt, { delayDuration: 400, children: /* @__PURE__ */ m(_t, { children: [
    /* @__PURE__ */ r(Et, { asChild: !0, children: /* @__PURE__ */ r(gt, { asChild: !0, children: P }) }),
    /* @__PURE__ */ r(Tt, { children: R.title })
  ] }) }) : /* @__PURE__ */ r(gt, { asChild: !0, children: P }), O = i.length > 1;
  return /* @__PURE__ */ m(te, { open: e, onOpenChange: C, children: [
    ...
    /* @__PURE__ */ r(
      ae,
      {
        ...
        children: /* @__PURE__ */ r(jt, { delayDuration: 400, children: /* @__PURE__ */ m(Jt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ r("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ r(H, { variant: "ghost", size: "sm", onClick: J, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
          /* @__PURE__ */ m(Zt, { children: [
            /* @__PURE__ */ r(Wt, { children: s.commandEmptyMessage }),
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ r(qt, { heading: Pa(c, s), children: c.rows.map((I) => /* @__PURE__ */ r(
                      Ra,
                      {
                        row: I,
                        mode: t.mode,
...
const zr = (t, e, a) => Ha(t, e).every((o) => a.includes(o));
function Ua(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => G.bookIdToNumber(o) > 0).sort((o, n) => G.bookIdToNumber(o) - G.bookIdToNumber(n)).map((o) => Xe(o, e));
}
function Gr(t, e, a, o) {
...
function jr({
  ...
  return /* @__PURE__ */ m($a, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Ka, { children: [
      /* @__PURE__ */ r(Va, { variant: "icon", children: o ?? /* @__PURE__ */ r(ye, {}) }),
      /* @__PURE__ */ r(Ja, { children: t })
    ] }),
    a && /* @__PURE__ */ r(Xa, { children: /* @__PURE__ */ r(H, { onClick: () => a(), children: e }) })
  ] });
}
const Za = xt(({ className: t, ...e }, a) => /* @__PURE__ */ r(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-D4RudJny.js.map
