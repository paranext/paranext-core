...
import { Slot as ut, Dialog as M, Popover as W, Label as Jt, Tooltip as X, Separator as Vt, DropdownMenu as D } from "radix-ui";
import { IconX as Kt, IconSearch as Xt, IconCheck as wt, IconChevronRight as Ut } from "@tabler/icons-react";
import { Canon as _ } from "@sillsdev/scripture";
import { includes as et, Section as J, normalizeProjectId as Z, getLocalizeKeyForScrollGroupId as qt } from "platform-bible-utils";
import { cva as U } from "class-variance-authority";
import z, { useRef as ft, useState as B, useCallback as $, createContext as Wt, useContext as Zt, useMemo as K, useEffect as Yt, Fragment as Qt, forwardRef as Ct } from "react";
...
const me = 600, pa = 300, Tt = 400, pe = 450, he = 500, ge = 550, ha = 700, Dt = U(
  ...
  return /* @__PURE__ */ g(be, { children: [
    ...
    /* @__PURE__ */ g(
      M.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(M.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ g(R, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(Kt, {}),
...
function At({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ g(xe, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Ie, { children: /* @__PURE__ */ n(Xt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Ce = _.allBookIds.filter(
  (t) => !_.isObsolete(_.bookIdToNumber(t))
), za = Object.fromEntries(
  Ce.map((t) => [t, _.bookIdToEnglishName(t)])
);
function Aa(t, e, a) {
...
function Ee() {
  return ht || (ht = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", u = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, v = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", E = "\\u200d", P = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", L = `[${l}]`, j = `${I}?`, S = `[${u}]?`, T = `(?:${E}(?:${[f, v, x].join("|")})${S + j})*`, G = S + j + T, C = `(?:${[`${f}${m}?`, m, v, x, d, L].join("|")})`;
...
function pt(t, e) {
  return De(_.bookIdToNumber(t));
}
function ot(t, e, a) {
  const r = _.bookIdToNumber(t);
  let o, s = a === "next" ? 1 / 0 : -1 / 0;
  return e.forEach((i) => {
    const u = _.bookIdToNumber(i);
...
function Ht({
  ...
  return /* @__PURE__ */ n(X.Portal, { children: /* @__PURE__ */ g(
    X.Content,
    {
...
const Re = ["input", "select", "textarea", "button"], Le = ["button", "textbox"], qa = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = ft(null), [s, i] = B(void 0), [u, l] = B(void 0), d = $(
    (f) => {
      i(f);
      const v = t.find((E) => E.id === f);
      v && (e == null || e(v));
    ...
    if (f.isContentEditable || Re.includes(v)) return !0;
    const x = f.getAttribute("role");
    if (x && Le.includes(x)) return !0;
    const E = f.getAttribute("tabindex");
    return E !== void 0 && E !== "-1";
  }, I = $(
    (f) => {
      var H;
      const v = f.target, x = (C) => C ? document.getElementById(C) : void 0, E = x(u), P = x(s);
      if (!!(E && v && E.contains(v) && v !== E) && h(v)) {
        ...
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          if (c === -1) return;
          let p;
          f.key === "ArrowDown" ? p = Math.min(c + 1, C.length - 1) : p = Math.max(c - 1, 0), p !== c && (f.preventDefault(), f.stopPropagation(), (H = C[p]) == null || H.focus());
          return;
        }
        return;
      }
...
function rr({
  ...
  return /* @__PURE__ */ g(
    D.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(Ut, { className: "tw:ms-auto" })
      ]
    }
  );
}
function or({ className: t, children: e, ...a }) {
  const r = O();
  return /* @__PURE__ */ n(
    D.SubContent,
    {
...
function Y(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && _e(r)
  );
}
function sr({
  className: t,
...
function cr({
  ...
  const u = z.useMemo(
    ...
    (m) => {
      ...
      ) : [], v = f.indexOf(h), x = u.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), Fe(f, v, m.key);
...
function mr({
  ...
  return /* @__PURE__ */ n("div", { id: E, className: v, children: /* @__PURE__ */ g(Pt, { open: C, onOpenChange: m ?? L, children: [
    ...
    /* @__PURE__ */ n(Bt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(zt, { children: [
      ...
      o && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: G, children: s }),
        /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: H, children: i })
      ] }),
      /* @__PURE__ */ g(Rt, { children: [
        /* @__PURE__ */ n(Lt, { children: u }),
...
function Ye({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: d
  } = Je(), [m, h] = B(!1), I = !!(t.language || t.languageCode), f = I || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = u || m, x = $(() => {
    if (f) {
      h(!0);
      return;
    }
    ...
    h(!1), d();
  }, [d]), P = /* @__PURE__ */ n(St, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let L;
  e === "project" ? t.openGroups.length > 0 && (L = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((G) => /* @__PURE__ */ n(rt, { variant: "secondary", children: Q(G) }, G)) })) : t.scrollGroupId !== void 0 && (L = /* @__PURE__ */ g("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ze,
      {
  ...
  return /* @__PURE__ */ g(_t, { open: v, delayDuration: 400, children: [
...
function gr(t) {
  const [e, a] = B(!1), [r, o] = B(""), [s, i] = B(t.defaultGroupByOpenTabs ?? !0), [u, l] = B(!1), d = ft(null), m = $((c) => {
    a(c), c || o("");
  }, []);
  Yt(() => {
    if (!e) return;
  ...
  const h = qe(t.localizedStrings), I = K(() => t.mode === "project" ? lt({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), f = K(() => {
  ...
  ), C = S.title ? /* @__PURE__ */ n(bt, { delayDuration: 400, children: /* @__PURE__ */ g(_t, { children: [
    /* @__PURE__ */ n($t, { asChild: !0, children: /* @__PURE__ */ n(ct, { asChild: !0, children: H }) }),
      ...
      Bt,
      {
        ...
        children: /* @__PURE__ */ n(bt, { delayDuration: 400, children: /* @__PURE__ */ g(zt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: L, children: `${h.selectAll} (${x.length.toString()})` }),
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: j, children: `${h.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ g(Rt, { children: [
...
const aa = Ct(({ className: t, ...e }, a) => /* @__PURE__ */ n(ie, { size: 35, className: w("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-31R2bzLZ.js.map
