...
const na = "min(8rem, calc(max(var(--radix-dropdown-menu-content-available-width, 100vw), 8rem) / var(--platform-content-zoom-popup-factor, 1)))";
function sa({
  className: t,
  align: e = "start",
  sideOffset: a = 4,
...
//# sourceMappingURL=resizable-CziXCIjM.js.map
