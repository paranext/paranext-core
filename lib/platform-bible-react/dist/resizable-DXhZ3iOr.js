import { jsx as n, jsxs as f, Fragment as St } from "react/jsx-runtime";
import { Slot as wt, Dialog as M, Separator as Wt, Popover as Z, Tooltip as X, DropdownMenu as C, Label as Zt, RadioGroup as lt, ToggleGroup as Ct } from "radix-ui";
...
import z, { useState as _, useRef as ft, useCallback as j, createContext as ee, useContext as ae, useMemo as J, useEffect as re, Fragment as oe, forwardRef as Et } from "react";
import { ChevronsUpDown as Tt, Check as zt, Star as ne, Filter as se, ArrowRight as ie, Loader2 as le, ChevronDown as de, Search as ce, X as ue, AlertTriangle as we, LoaderCircle as me } from "lucide-react";
import { Section as F, MODIFIER_KEYS as fe, normalizeProjectId as Y, getLocalizeKeyForScrollGroupId as pe, getSectionForBook as he } from "platform-bible-utils";
...
function d(...t) {
  ...
  }), Ne(o.join(" ")).split(" ").filter(Boolean).map((w) => {
    const g = r.get(w);
    return g ? ye(w, g) : w;
  }).join(" ");
}
const Gt = 600, At = 650, ja = 400, Ie = 450, ke = 500, Se = 675, $a = 690, Ha = 700, Fa = 800, Dt = $(
...
function R({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Dt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
...
function Pt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(ze, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Ae, { children: /* @__PURE__ */ n(Qt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const lr = Object.fromEntries(
  Pe.map((t) => [t, G.bookIdToEnglishName(t)])
);
function dr(t, e, a) {
...
let ct = "keyboard", Nt = !1;
function ur() {
  Nt || typeof document > "u" || (Nt = !0, document.addEventListener(
    "pointerdown",
    () => {
      ct = "pointer";
    },
...
const jt = "data-quiet-focus";
function mr(t) {
  t && (t.setAttribute(jt, ""), t.style.outline = "none");
}
function fr(t) {
  t && (t.removeAttribute(jt), t.style.removeProperty("outline"));
}
...
function Vt({
  ...
  return /* @__PURE__ */ n(
    X.Trigger,
    {
      ...
      className: e ? d(Dt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
function Fe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Jt.Provider, { value: r, children: /* @__PURE__ */ n(C.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function kr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(C.ItemIndicator, { children: /* @__PURE__ */ n(mt, {}) })
          }
        ),
        e
      ]
...
function Ar({
  ...
  return /* @__PURE__ */ f(
    C.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(te, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const Xe = ["input", "select", "textarea", "button"], qe = ["button", "textbox"], jr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = ft(null), [s, i] = _(void 0), [l, w] = _(void 0), g = j(
    (m) => {
      i(m);
    ...
    if (m.isContentEditable || Xe.includes(v)) return !0;
    const I = m.getAttribute("role");
    if (I && qe.includes(I)) return !0;
    const x = m.getAttribute("tabindex");
    return x !== void 0 && x !== "-1";
  }, A = j(
    (m) => {
      var U;
      const v = m.target, I = (S) => S ? document.getElementById(S) : void 0, x = I(l), O = I(s);
      if (!!(x && v && x.contains(v) && v !== x) && k(v)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          if (c === -1) return;
          let u;
          m.key === "ArrowDown" ? u = Math.min(c + 1, S.length - 1) : u = Math.max(c - 1, 0), u !== c && (m.preventDefault(), m.stopPropagation(), (U = S[u]) == null || U.focus());
          return;
        }
        return;
      }
...
function Wr({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f($t, { open: S, onOpenChange: b ?? B, children: [
    /* @__PURE__ */ n(ut, { asChild: !0, children: /* @__PURE__ */ f(
      R,
      {
        variant: I,
        role: "combobox",
    ...
    /* @__PURE__ */ n(Ft, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Rt, { children: [
      /* @__PURE__ */ n(
        Pt,
        {
      ...
      o && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: U, children: i })
      ] }),
      /* @__PURE__ */ f(Ot, { children: [
        /* @__PURE__ */ n(Bt, { children: l }),
        /* @__PURE__ */ n(Mt, { children: T.map((u) => /* @__PURE__ */ f(
          _t,
          {
            value: u.label,
            onSelect: K,
            ...
            children: [
              ...
              u.starred && /* @__PURE__ */ n(ne, { className: "tw:h-4 tw:w-4" }),
...
function Zr(t, e, a) {
  ...
  if (ea(t) || fe.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  if (t.key === " ") {
    ...
    const i = q(e.filter).toLowerCase(), l = e.items.find(
      (w) => q(w.marker).toLowerCase() === i
    );
    return l && a.commitItem(l.marker), a.dismiss(), "ended";
  }
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || qt[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function Yr(t, e) {
  var a;
...
function sa(t, e) {
  ...
  const a = t.filter(kt).sort(W), r = t.filter((s) => !kt(s)).sort(W);
  if (a.length === 0)
...
function wa({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: w,
    onPointerLeave: g
  } = He(), [b, k] = _(!1), A = !!(t.language || t.languageCode), m = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, I = j(() => {
    if (m) {
      k(!0);
      return;
    }
    ...
    k(!1), g();
  }, [g]), O = /* @__PURE__ */ n(zt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let B;
  ...
  return /* @__PURE__ */ f(Ut, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Vt, { asChild: !0, children: K }),
    /* @__PURE__ */ f(
      Kt,
      {
        side: "top",
...
function ma({
  ...
  return /* @__PURE__ */ f(Fe, { children: [
    /* @__PURE__ */ n(Ue, { asChild: !0, children: /* @__PURE__ */ n(
      R,
      {
        variant: "ghost",
        size: "sm",
        ...
        children: /* @__PURE__ */ n(se, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ f(
      Ve,
      {
        ...
        style: { zIndex: At },
        children: [
          /* @__PURE__ */ n(yt, { children: o.groupSectionLabel }),
          /* @__PURE__ */ n(
            xt,
            {
              checked: t,
          ...
          r && /* @__PURE__ */ f(St, { children: [
            /* @__PURE__ */ n(Ke, {}),
            /* @__PURE__ */ n(yt, { children: o.filterSectionLabel }),
            /* @__PURE__ */ n(
              xt,
              {
                checked: !!a,
...
function ao(t) {
  const [e, a] = _(!1), [r, o] = _(""), [s, i] = _(t.defaultGroupByOpenTabs ?? !0), [l, w] = _(!1), g = ft(null), b = j((c) => {
    a(c), c || o("");
  }, []);
  re(() => {
    if (!e) return;
  ...
  const k = da(t.localizedStrings), A = J(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), m = J(() => {
  ...
  let T;
  t.isLoading ? T = /* @__PURE__ */ n(le, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? T = void 0 : t.mode === "project-multi" ? T = /* @__PURE__ */ n(Tt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : T = /* @__PURE__ */ n(de, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const L = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, U = /* @__PURE__ */ f(
    R,
    {
  ...
  ), S = E.title ? /* @__PURE__ */ n(vt, { delayDuration: 400, children: /* @__PURE__ */ f(Ut, { children: [
    /* @__PURE__ */ n(Vt, { asChild: !0, children: /* @__PURE__ */ n(ut, { asChild: !0, children: U }) }),
    /* @__PURE__ */ n(Kt, { children: E.title })
  ] }) }) : /* @__PURE__ */ n(ut, { asChild: !0, children: U });
  return /* @__PURE__ */ f($t, { open: e, onOpenChange: b, children: [
    S,
    /* @__PURE__ */ n(
      Ft,
      {
        ...
        children: /* @__PURE__ */ n(vt, { delayDuration: 400, children: /* @__PURE__ */ f(Rt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            ...
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: K, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(Ot, { children: [
            /* @__PURE__ */ n(Bt, { children: t.commandEmptyMessage ?? "No projects found" }),
            v.map((c, u) => (
              ...
              /* @__PURE__ */ f(oe, { children: [
                /* @__PURE__ */ n(Mt, { heading: fa(c, k), children: c.rows.map((p) => /* @__PURE__ */ n(
                  wa,
                  {
                    row: p,
                    mode: t.mode,
...
const oo = (t, e, a) => ga(t, e).every((r) => a.includes(r));
function ba(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, o) => G.bookIdToNumber(r) - G.bookIdToNumber(o)).map((r) => Me(r, e));
}
function no(t, e, a, r) {
...
function lo({
  ...
  return /* @__PURE__ */ f(Na, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(va, { children: [
      /* @__PURE__ */ n(ya, { variant: "icon", children: r ?? /* @__PURE__ */ n(we, {}) }),
      /* @__PURE__ */ n(Ia, { children: t })
    ] }),
    a && /* @__PURE__ */ n(ka, { children: /* @__PURE__ */ n(R, { onClick: () => a(), children: e }) })
  ] });
}
const Sa = Et(({ className: t, ...e }, a) => /* @__PURE__ */ n(me, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DXhZ3iOr.js.map
