...
import { Slot as yt, Dialog as V, Separator as de, Popover as st, Tooltip as at, DropdownMenu as T, Label as ce, RadioGroup as bt, ToggleGroup as Ht } from "radix-ui";
...
import G, { useState as J, useRef as wt, useCallback as F, createContext as me, useContext as fe, useMemo as Y, useEffect as Lt, Fragment as he, forwardRef as Ut } from "react";
import { ChevronsUpDown as $t, Check as Kt, Star as ge, Group as be, ArrowRight as Ne, Loader2 as ve, ChevronDown as xe, Search as ye, X as Se, AlertTriangle as ke, LoaderCircle as Ie } from "lucide-react";
...
function qt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f($e, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        tt.Input,
        {
...
function aa({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(oe.Provider, { value: r, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Hr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(T.ItemIndicator, { children: /* @__PURE__ */ n(St, {}) })
          }
        ),
        e
      ]
...
function po({
  ...
  return /* @__PURE__ */ n("div", { id: N, className: h, children: /* @__PURE__ */ f(ee, { open: S, onOpenChange: m ?? $, children: [
    /* @__PURE__ */ n(vt, { asChild: !0, children: /* @__PURE__ */ f(
      U,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ n($t, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
...
function La({
  ...
  let $;
  e === "project" ? t.openGroups.length > 0 && ($ = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((D) => /* @__PURE__ */ n(pt, { variant: "secondary", children: lt(D) }, D)) })) : t.scrollGroupId !== void 0 && ($ = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      za,
      {
...
function ko(t) {
  ...
  const u = Y(() => t.mode === "project" ? gt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const g = t.selection.pairs, C = Q(d.projectId), L = (A) => Q(A.projectId) === C && A.scrollGroupId === d.scrollGroupId, E = g.some(L) ? g.filter((A) => !L(A)) : [
          ...g.filter((A) => !L(A)),
    ...
    switch (t.mode) {
      case "project": {
        const d = t.projects.find((C) => C.id === t.selection.projectId);
      ...
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ f(zt, { children: [
            ...
            /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: C })
          ] }),
          title: `${L} ${C}`,
          hasSelection: !0
        };
      ...
      case "projectScrollGroup": {
        ...
        const C = `${d.shortName} · ${lt(g)}`;
        return { node: C, title: C, hasSelection: !0 };
      }
      default:
  ...
  Lt(() => {
    ...
    return C.observe(d, { box: "border-box" }), () => C.disconnect();
  }, []);
  let z;
  t.isLoading ? z = /* @__PURE__ */ n(ve, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : q ? z = void 0 : t.mode === "project-multi" ? z = /* @__PURE__ */ n($t, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : z = /* @__PURE__ */ n(xe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const k = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? $ : void 0, O = s.ariaLabel && I.hasSelection && I.title ? `${s.ariaLabel}: ${I.title}` : s.ariaLabel || void 0, R = /* @__PURE__ */ f(
    U,
    {
      ref: D,
          ...
          /* @__PURE__ */ f(Yt, { children: [
            ...
            H.map((d, g) => (
              ...
              /* @__PURE__ */ f(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(te, { heading: Ra(d, s), children: d.rows.map((C) => /* @__PURE__ */ n(
                      La,
                      {
                        row: C,
                        mode: t.mode,
...
function Go({
  ...
  return /* @__PURE__ */ f(Ha, { className: l(s), role: o, children: [
    /* @__PURE__ */ f(Ua, { children: [
      /* @__PURE__ */ n(Ka, { variant: "icon", children: r ?? /* @__PURE__ */ n(ke, {}) }),
      /* @__PURE__ */ n(Fa, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Va, { children: /* @__PURE__ */ n(U, { onClick: () => a(), children: e }) })
  ] });
}
const Ja = Ut(({ className: t, ...e }, a) => /* @__PURE__ */ n(Ie, { size: 35, className: l("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CZWHx6Gr.js.map
