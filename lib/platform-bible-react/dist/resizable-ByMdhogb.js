...
const Ne = 600, Ba = 650, Tt = 400, ve = 450, xe = 500, ye = 550, Ma = 700, zt = F(
...
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], Nr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
const Jr = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
  return [
...
function Xr({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
//# sourceMappingURL=resizable-ByMdhogb.js.map
