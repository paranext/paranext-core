...
import z, { useState as M, useRef as at, useCallback as H, createContext as oe, useContext as ne, useEffect as bt, useMemo as Z, Fragment as se, forwardRef as Dt } from "react";
import { cva as V } from "class-variance-authority";
import { ChevronsUpDown as Lt, Check as Rt, Star as ie, Filter as le, ArrowRight as de, Loader2 as ce, ChevronDown as ue, Search as we, X as me, LoaderCircle as fe } from "lucide-react";
import { Section as K, MODIFIER_KEYS as pe, normalizeProjectId as rt, getLocalizeKeyForScrollGroupId as he, getSectionForBook as ge } from "platform-bible-utils";
...
const ke = 600, Oa = 650, Bt = 400, Ce = 450, Se = 500, Ee = 550, ja = 700, Pt = V(
...
function Ge({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
function jt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Ae, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        X.Input,
        {
      ...
      /* @__PURE__ */ n(Le, { children: /* @__PURE__ */ n(ae, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Be = [
  ...
  var e;
  return ((e = Be[t]) == null ? void 0 : e.chapters) ?? -1;
}, Me = G.allBookIds.filter(
...
const or = Object.fromEntries(
  Me.map((t) => [t, G.bookIdToEnglishName(t)])
);
function nr(t, e, a) {
...
const Vt = z.createContext(null);
function sr({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ n(Vt.Provider, { value: t, children: e });
}
function Jt({
  className: t,
  align: e = "center",
...
const Ve = ["input", "select", "textarea", "button"], Je = ["button", "textbox"], xr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = at(null), [s, i] = M(void 0), [l, u] = M(void 0), p = H(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || Ve.includes(N)) return !0;
    const y = w.getAttribute("role");
    if (y && Je.includes(y)) return !0;
    const v = w.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, A = H(
    (w) => {
      var J;
      const N = w.target, y = (k) => k ? document.getElementById(k) : void 0, v = y(l), j = y(s);
      if (!!(v && N && v.contains(N) && N !== v) && I(N)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !N.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const k = t.find((c) => c.id === l);
            k && p(k.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const c = k.findIndex((h) => h === N);
          if (c === -1) return;
          let m;
          w.key === "ArrowDown" ? m = Math.min(c + 1, k.length - 1) : m = Math.max(c - 1, 0), m !== c && (w.preventDefault(), w.stopPropagation(), (J = k[m]) == null || J.focus());
          return;
        }
        return;
      }
      const T = t.findIndex((k) => k.id === s);
      let S = T;
      switch (w.key) {
        case "ArrowDown":
        ...
        default:
          w.key.length === 1 && !w.metaKey && !w.ctrlKey && !w.altKey && (I(N) || (r == null || r(w.key), w.preventDefault()));
          return;
      }
      const L = t[S];
      L && p(L.id);
...
function _r({
  ...
  const [W, T] = M(!1), S = at(null), L = H(
    (R) => {
      var P;
      const q = (P = t.find((F) => F.label === R)) == null ? void 0 : P.value;
      q && a(
        e.includes(q) ? e.filter((F) => F !== q) : [...e, q]
      );
    },
    [t, e, a]
  ), J = () => p || r, k = g ?? W, c = I ?? T, m = at(e);
  m.current = e;
  const [h, C] = M(e);
  bt(() => {
    k && C(m.current);
  ...
  const b = Z(() => {
    if (!w) return t;
    const R = t.filter((P) => P.starred).sort((P, F) => P.label.localeCompare(F.label)), q = t.filter((P) => !P.starred).sort((P, F) => {
      const xt = h.includes(P.value), yt = h.includes(F.value);
      return xt && !yt ? -1 : !xt && yt ? 1 : P.label.localeCompare(F.label);
    });
    return [...R, ...q];
  }, [t, h, w]), U = () => {
    a(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ n("div", { id: _, className: v, children: /* @__PURE__ */ f(Kt, { open: k, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ n(Jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Ot, { children: [
      ...
      s && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: U, children: i }),
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: ut, children: l })
      ] }),
      /* @__PURE__ */ n(ra, { isEnabled: N, scrollerRef: S, children: /* @__PURE__ */ f(_t, { ref: S, children: [
...
function $r(t, e, a) {
  ...
  if (na(t) || pe.has(t.key) || t.key === "Dead")
    return "passed";
...
function ha({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: p
  } = $e(), [g, I] = M(!1), A = !!(t.language || t.languageCode), w = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = l || g, y = H(() => {
    if (w) {
      I(!0);
      return;
    }
...
function ga({
  ...
  return /* @__PURE__ */ f(Xe, { children: [
    ...
    /* @__PURE__ */ f(qe, { align: "end", className: "tw:w-56", style: { zIndex: Bt }, children: [
...
function Jr(t) {
  const [e, a] = M(!1), [r, o] = M(""), [s, i] = M(t.defaultGroupByOpenTabs ?? !0), [l, u] = M(!1), p = at(null), g = H((c) => {
    a(c), c || o("");
  }, []);
  bt(() => {
    if (!e) return;
  ...
  const I = ma(t.localizedStrings), A = Z(() => t.mode === "project" ? wt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  ), k = T.title ? /* @__PURE__ */ n(kt, { delayDuration: 400, children: /* @__PURE__ */ f(Ut, { children: [
  ...
  return /* @__PURE__ */ f(Kt, { open: e, onOpenChange: g, children: [
    k,
    /* @__PURE__ */ n(
      Jt,
      {
        ...
        children: /* @__PURE__ */ n(kt, { delayDuration: 400, children: /* @__PURE__ */ f(Ot, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: _, children: `${I.selectAll} (${y.length.toString()})` }),
            /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: W, children: `${I.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(_t, { children: [
            ...
            N.map((c, m) => (
              ...
              /* @__PURE__ */ f(se, { children: [
                /* @__PURE__ */ n(Ht, { heading: ba(c, I), children: c.rows.map((h) => /* @__PURE__ */ n(
                  ha,
                  {
                    row: h,
                    mode: t.mode,
...
const Xr = (t, e, a) => xa(t, e).every((r) => a.includes(r));
function ya(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, o) => G.bookIdToNumber(r) - G.bookIdToNumber(o)).map((r) => _e(r, e));
}
function Wr(t, e, a, r) {
...
const Ia = Dt(({ className: t, ...e }, a) => /* @__PURE__ */ n(fe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DRdbldA-.js.map
