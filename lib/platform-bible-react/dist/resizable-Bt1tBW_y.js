...
import { Slot as ut, Dialog as O, Popover as Z, Tooltip as X, Label as Kt, RadioGroup as lt, Separator as Jt, DropdownMenu as S } from "radix-ui";
import { IconX as Vt, IconSearch as Ut, IconCheck as wt, IconChevronRight as Xt } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as K } from "class-variance-authority";
import P, { useState as j, useRef as mt, useCallback as _, createContext as Wt, useContext as qt, useMemo as U, useEffect as Zt, Fragment as Yt, forwardRef as kt } from "react";
import { ChevronsUpDown as Ct, Check as St, Star as Qt, Filter as te, ArrowRight as ee, Loader2 as ae, ChevronDown as re, Search as oe, X as ne, LoaderCircle as se } from "lucide-react";
import { Section as H, MODIFIER_KEYS as ie, normalizeProjectId as Y, getLocalizeKeyForScrollGroupId as le, getSectionForBook as de } from "platform-bible-utils";
...
import { extendTailwindMerge as ue, twMerge as we } from "tailwind-merge";
const me = ue({ prefix: "tw" });
function dt(t) {
  const e = [];
  let a = "", r = 0;
...
function c(...t) {
  ...
  }), we(o.join(" ")).split(" ").filter(Boolean).map((w) => {
    const g = r.get(w);
    return g ? pe(w, g) : w;
  }).join(" ");
}
const he = 600, Aa = 650, Et = 400, ge = 450, be = 500, Ne = 550, Da = 700, Tt = K(
...
function L({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(Tt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ f(ve, { children: [
    ...
    /* @__PURE__ */ f(
      O.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(O.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(L, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(Vt, {}),
...
function ja({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(O.Close, { asChild: !0, children: /* @__PURE__ */ n(L, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ye({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
function At({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Ie, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        J.Input,
        {
      ...
      /* @__PURE__ */ n(Ce, { children: /* @__PURE__ */ n(Ut, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Za = Object.fromEntries(
  ze.map((t) => [t, z.bookIdToEnglishName(t)])
);
function Ya(t, e, a) {
...
function Bt() {
  ...
  function e({
    ...
    return /* @__PURE__ */ n(t.Provider, { value: r, children: o });
  }
  function a() {
...
const { PortalContainerProvider: Pe, usePortalContainer: Le } = Bt(), Qa = Pe;
function Ot({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
  ...
  return (
    ...
    /* @__PURE__ */ n(Z.Portal, { container: i, children: /* @__PURE__ */ n(
      Z.Content,
      {
...
function _t({
  ...
  return /* @__PURE__ */ n(
    X.Trigger,
    {
      ...
      className: e ? c(Tt({ variant: e }), t) : t,
      ...a
    }
  );
}
const { PortalContainerProvider: Re, usePortalContainer: Be } = Bt(), or = Re;
function $t({
  className: t,
  sideOffset: e = 0,
  ...
  return (
    ...
    /* @__PURE__ */ n(X.Portal, { container: l, children: /* @__PURE__ */ f(
      X.Content,
      {
...
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], mr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const o = mt(null), [s, i] = j(void 0), [l, w] = j(void 0), g = _(
    (m) => {
      ...
      I && (I.scrollIntoView({ block: "center" }), I.focus()), o.current && o.current.setAttribute("aria-activedescendant", m);
    },
    [e, t]
  ), b = _(
    (m) => {
    ...
    (m) => {
      ...
      if (!!(x && v && x.contains(v) && v !== x) && k(v)) {
        ...
        if (m.key === "ArrowDown" || m.key === "ArrowUp") {
          ...
          const d = C.findIndex((p) => p === v);
          if (d === -1) return;
          let u;
          m.key === "ArrowDown" ? u = Math.min(d + 1, C.length - 1) : u = Math.max(d - 1, 0), u !== d && (m.preventDefault(), m.stopPropagation(), (F = C[u]) == null || F.focus());
          return;
        }
        return;
      }
...
function Fe({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Ht.Provider, { value: r, children: /* @__PURE__ */ n(S.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function fr({
  ...t
}) {
...
function Dr({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f(Mt, { open: C, onOpenChange: b ?? M, children: [
    ...
    /* @__PURE__ */ n(Ot, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Gt, { children: [
      /* @__PURE__ */ n(
        At,
        {
      ...
      o && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ n(L, { variant: "ghost", size: "sm", onClick: F, children: i })
      ] }),
      /* @__PURE__ */ f(Dt, { children: [
        /* @__PURE__ */ n(Pt, { children: l }),
        /* @__PURE__ */ n(Lt, { children: T.map((u) => /* @__PURE__ */ f(
          Rt,
          {
            value: u.label,
            onSelect: V,
            ...
            children: [
              ...
              u.starred && /* @__PURE__ */ n(Qt, { className: "tw:h-4 tw:w-4" }),
...
function Pr(t, e, a) {
  ...
  if (Ye(t) || ie.has(t.key) || t.key === "Dead")
    return "passed";
...
function Rr(t) {
  ...
  o.current += 1;
  const m = o.current, v = a ? "backslash" : "selection", I = { kind: v, token: m, filter: "", items: e };
...
function da({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: g
  } = Me(), [b, k] = j(!1), G = !!(t.language || t.languageCode), m = G || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, I = _(() => {
    if (m) {
      k(!0);
      return;
    }
    ...
    k(!1), g();
  }, [g]), B = /* @__PURE__ */ n(St, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let M;
  e === "project" ? t.openGroups.length > 0 && (M = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((D) => /* @__PURE__ */ n(rt, { variant: "secondary", children: tt(D) }, D)) })) : t.scrollGroupId !== void 0 && (M = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      la,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ f(
      L,
      {
        ...
        children: [
          /* @__PURE__ */ n(ee, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  return /* @__PURE__ */ f(jt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(_t, { asChild: !0, children: V }),
    /* @__PURE__ */ f(
      $t,
      {
        side: "top",
  ...
  return /* @__PURE__ */ f(Fe, { children: [
    /* @__PURE__ */ n(Ke, { asChild: !0, children: /* @__PURE__ */ n(
      L,
      {
        ...
        children: /* @__PURE__ */ n(te, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ f(Je, { align: "end", className: "tw:w-56", style: { zIndex: Et }, children: [
...
function Or(t) {
  const [e, a] = j(!1), [r, o] = j(""), [s, i] = j(t.defaultGroupByOpenTabs ?? !0), [l, w] = j(!1), g = mt(null), b = _((d) => {
    a(d), d || o("");
  }, []);
  Zt(() => {
    if (!e) return;
  ...
  const k = sa(t.localizedStrings), G = U(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    let u = G;
    return d && (u = u.filter(
      (p) => p.shortName.toLowerCase().includes(d) || p.fullName.toLowerCase().includes(d) || (p.language ?? "").toLowerCase().includes(d) || (p.languageCode ?? "").toLowerCase().includes(d)
    ...
    return t.projects.forEach((u) => {
      ...
      if (p.length === 0) {
        d.push({ projectId: u.id });
        return;
      }
      const N = /* @__PURE__ */ new Set();
      p.forEach((h) => {
        N.has(h.scrollGroupId) || (N.add(h.scrollGroupId), d.push({ projectId: u.id, scrollGroupId: h.scrollGroupId }));
      });
    }), d;
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const u = t.selection.pairs, p = (h) => h.projectId === d.projectId && h.scrollGroupId === d.scrollGroupId, N = u.some(p) ? u.filter((h) => !p(h)) : [...u, { projectId: d.projectId, scrollGroupId: d.scrollGroupId }];
      ...
      case "projectScrollGroup": {
        ...
        t.onChangeSelection({ projectId: d.projectId, scrollGroupId: u }), t.onOpenProjectInGroup(d.projectId, u), a(!1);
      }
    }
  }, M = () => {
    if (t.mode !== "project-multi") return;
    const d = t.selection.pairs, u = new Set(d.map((N) => `${N.projectId}:${N.scrollGroupId ?? ""}`)), p = [...d];
    I.forEach((N) => {
    ...
    switch (t.mode) {
      case "project": {
        const d = t.projects.find((p) => p.id === t.selection.projectId);
        let u = d ? d.shortName : t.buttonPlaceholder ?? "";
        return d && t.triggerLabelFormat === "shortNameAndFullName" && d.fullName && d.fullName !== d.shortName && (u = `${d.shortName} - ${d.fullName}`), { node: u, title: u };
      }
      case "project-multi": {
      ...
      case "projectScrollGroup": {
        const d = t.projects.find((N) => N.id === t.selection.projectId);
        if (!d) {
  ...
  let T;
  t.isLoading ? T = /* @__PURE__ */ n(ae, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? T = void 0 : t.mode === "project-multi" ? T = /* @__PURE__ */ n(Ct, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : T = /* @__PURE__ */ n(re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const D = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, F = /* @__PURE__ */ f(
    L,
    {
  ...
  ), C = E.title ? /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f(jt, { children: [
    /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(ct, { asChild: !0, children: F }) }),
    /* @__PURE__ */ n($t, { children: E.title })
  ] }) }) : /* @__PURE__ */ n(ct, { asChild: !0, children: F });
  return /* @__PURE__ */ f(Mt, { open: e, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ n(
      Ot,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f(Gt, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(L, { variant: "ghost", size: "sm", onClick: M, children: `${k.selectAll} (${I.length.toString()})` }),
            /* @__PURE__ */ n(L, { variant: "ghost", size: "sm", onClick: V, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(Dt, { children: [
            ...
            v.map((d, u) => (
              ...
              /* @__PURE__ */ f(Yt, { children: [
                /* @__PURE__ */ n(Lt, { heading: ua(d, k), children: d.rows.map((p) => /* @__PURE__ */ n(
                  da,
                  {
                    row: p,
                    mode: t.mode,
...
const _r = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => z.bookIdToNumber(r) > 0).sort((r, o) => z.bookIdToNumber(r) - z.bookIdToNumber(o)).map((r) => De(r, e));
}
function $r(t, e, a, r) {
...
const ha = kt(({ className: t, ...e }, a) => /* @__PURE__ */ n(se, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-Bt1tBW_y.js.map
