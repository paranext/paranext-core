...
import { Slot as Nt, Dialog as $, Separator as se, Popover as rt, Tooltip as Q, DropdownMenu as T, Label as ie, RadioGroup as ft, ToggleGroup as Rt } from "radix-ui";
import { IconX as le, IconSearch as de, IconCheck as vt, IconChevronRight as ce } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as V } from "class-variance-authority";
import G, { useState as K, useRef as dt, useCallback as F, createContext as ue, useContext as we, useMemo as W, useEffect as Tt, Fragment as pe, forwardRef as Ot } from "react";
import { ChevronsUpDown as Pt, Check as Bt, Star as me, Group as fe, ArrowRight as he, Loader2 as ge, ChevronDown as be, Search as Ne, X as ve, AlertTriangle as xe, LoaderCircle as ye } from "lucide-react";
import { Section as X, MODIFIER_KEYS as Se, normalizeProjectId as ot, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as et, isLocalizeKey as ke, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as Ee } from "platform-bible-utils";
...
const Mt = 600, Ht = 650, rr = 400, Le = 450, Ae = 500, De = 675, or = 690, nr = 700, sr = 800, Ut = V(
...
function io({
  ...
  return /* @__PURE__ */ n("div", { id: b, className: g, children: /* @__PURE__ */ m(Zt, { open: y, onOpenChange: h ?? J, children: [
        ...
        /* @__PURE__ */ n(Xt, { children: _.map((S) => /* @__PURE__ */ m(
          Wt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ n(me, { className: "tw:h-4 tw:w-4" }),
...
function ya(t) {
  ...
  return [
    re(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[et.lastUsedAt]) == "number" ? it : xa;
      },
...
function Ta({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: f
  } = Ye(), [h, k] = K(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || h, g = F(() => {
    if (C) {
      k(!0);
      return;
    }
  ...
  return /* @__PURE__ */ m(St, { open: w, delayDuration: 400, children: [
    /* @__PURE__ */ n(kt, { asChild: !0, children: J }),
    /* @__PURE__ */ m(
      It,
      {
        side: "top",
...
function Ca({
  ...
  return /* @__PURE__ */ m(Qe, { children: [
    /* @__PURE__ */ m(St, { children: [
      /* @__PURE__ */ n(kt, { asChild: !0, children: /* @__PURE__ */ n(ta, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
...
function No(t) {
  const [e, a] = K(!1), [r, o] = K(""), s = Ia(t.localizedStrings), i = W(() => {
  ...
  const w = W(() => t.mode === "project" ? mt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((j) => {
          const L = t.projects.find((oe) => oe.id === j.projectId);
  ...
  let U;
  t.isLoading ? U = /* @__PURE__ */ n(ge, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : _ ? U = void 0 : t.mode === "project-multi" ? U = /* @__PURE__ */ n(Pt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : U = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
    ...
    /* @__PURE__ */ n(
      Yt,
      {
        ...
        children: /* @__PURE__ */ n(zt, { delayDuration: 400, children: /* @__PURE__ */ m(Kt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Vt, { children: [
            /* @__PURE__ */ n(Jt, { children: s.commandEmptyMessage }),
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Xt, { heading: za(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      Ta,
                      {
                        row: I,
                        mode: t.mode,
...
function Io({
  ...
  return /* @__PURE__ */ m(Ra, { className: d(s), role: o, children: [
    /* @__PURE__ */ m(Oa, { children: [
      /* @__PURE__ */ n(Ba, { variant: "icon", children: r ?? /* @__PURE__ */ n(xe, {}) }),
      /* @__PURE__ */ n(Ma, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ha, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Ua = Ot(({ className: t, ...e }, a) => /* @__PURE__ */ n(ye, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DMVHmKB8.js.map
