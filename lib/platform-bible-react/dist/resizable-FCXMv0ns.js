import { jsx as o, jsxs as p, Fragment as ve } from "react/jsx-runtime";
import { Slot as It, Dialog as X, Separator as xe, Popover as dt, Tooltip as at, DropdownMenu as _, Label as ye, RadioGroup as vt, ToggleGroup as Vt } from "radix-ui";
import { IconX as Se, IconCheck as Et, IconSearch as ke, IconChevronRight as Ie } from "@tabler/icons-react";
import { Canon as C } from "@sillsdev/scripture";
import { cva as Z } from "class-variance-authority";
import T, { useState as J, useRef as mt, useCallback as K, createContext as Ee, useContext as _e, useMemo as Y, useEffect as Dt, Fragment as Te, forwardRef as Jt } from "react";
import { ChevronsUpDown as Xt, Check as qt, Star as Ce, Group as Ge, ArrowRight as je, Loader2 as Le, ChevronDown as ze, Search as Ae, X as Re, AlertTriangle as De, LoaderCircle as Pe } from "lucide-react";
import { Section as Q, MODIFIER_KEYS as Oe, normalizeProjectId as O, compareProjectsByName as Be, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as it, formatProjectName as Wt, getLocalizeKeyForScrollGroupId as Me, hasDistinctFullName as He, getSectionForBook as Ue } from "platform-bible-utils";
...
import { extendTailwindMerge as Fe, twMerge as Ke } from "tailwind-merge";
const Ve = Fe({ prefix: "tw" });
function xt(t) {
  const e = [];
  let a = "", r = 0;
...
const Zt = 600, Yt = 650, Nr = 400, qe = 450, We = 500, vr = 510, xr = 520, Ze = 675, yr = 690, Sr = 700, kr = 800, Qt = Z(
...
function V({
  ...
  return /* @__PURE__ */ o(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Qt({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
const te = "layoutDirection";
function ee() {
...
function M() {
  var t;
  try {
    const e = (t = ee()) == null ? void 0 : t.getItem(te);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function Cr({
  ...
  return /* @__PURE__ */ p(Ye, { children: [
    /* @__PURE__ */ o(Qe, { className: r, style: n }),
    /* @__PURE__ */ p(
      X.Content,
      {
...
function re({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ea, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        et.Input,
        {
      ...
      /* @__PURE__ */ o(ra, { children: /* @__PURE__ */ o(ke, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const oa = [
  ...
  var e;
  return ((e = oa[t]) == null ? void 0 : e.chapters) ?? -1;
}, sa = C.allBookIds.filter(
...
const $r = Object.fromEntries(
  sa.map((t) => [t, C.bookIdToEnglishName(t)])
);
function Fr(t, e, a) {
...
const ie = "data-quiet-focus";
function Xr(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(ie, ""), t.style.outline = "none"));
}
function qr(t) {
  t && (t.removeAttribute(ie), t.style.removeProperty("outline"));
}
const Wr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function ua({
  className: t,
...
const de = T.createContext(null);
function to({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ o(de.Provider, { value: t, children: e });
}
function ce({
  className: t,
  align: e = "center",
...
function jt({
  ...
  return /* @__PURE__ */ o(
    at.Trigger,
    {
      ...
      className: e ? d(Qt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
function ma({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(ue.Provider, { value: r, children: /* @__PURE__ */ o(_.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function no({
  ...t
}) {
...
function wo({
  ...
  return /* @__PURE__ */ p(
    _.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(Ie, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const xa = ["input", "select", "textarea", "button"], ya = ["button", "textbox"], xo = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function jo({
  ...
  const [H, U] = J(!1), $ = K(
    (S) => {
      var D;
      const G = (D = t.find((E) => E.label === S)) == null ? void 0 : D.value;
      G && a(
        e.includes(G) ? e.filter((E) => E !== G) : [...e, G]
      );
    },
    [t, e, a]
  ), q = () => u || r, A = Y(() => {
    if (!I) return t;
    const S = t.filter((D) => D.starred).sort((D, E) => D.label.localeCompare(E.label)), G = t.filter((D) => !D.starred).sort((D, E) => {
      const ot = e.includes(D.value), nt = e.includes(E.value);
      return ot && !nt ? -1 : !ot && nt ? 1 : D.label.localeCompare(E.label);
    });
    return [...S, ...G];
  }, [t, e, I]), W = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(le, { open: y, onOpenChange: f ?? U, children: [
    ...
    /* @__PURE__ */ o(ce, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ae, { children: [
      /* @__PURE__ */ o(
        re,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ o(V, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ p(oe, { children: [
        /* @__PURE__ */ o(ne, { children: l }),
        /* @__PURE__ */ o(se, { children: A.map((S) => /* @__PURE__ */ p(
          Tt,
          {
            value: S.label,
            onSelect: $,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Ce, { className: "tw:h-4 tw:w-4" }),
...
function Lo(t, e, a) {
  ...
  if (Ta(t) || Oe.has(t.key) || t.key === "Dead")
    return "passed";
...
const zt = "Selected", At = "Unselected";
function Ft(t) {
...
function za(t) {
  const e = t.filter(Ft).sort(tt), a = t.filter((n) => !Ft(n)).sort(tt);
  if (e.length === 0)
...
function Aa(t, e) {
  const a = t.filter((i) => i.isSelected).sort(tt), r = t.filter((i) => !i.isSelected).sort(tt), n = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? zt : At;
  }, s = [];
...
function Ra(t, e) {
  ...
  if (e.id === "selection") return Aa(t, e);
...
function Pa(t) {
  ...
  return [
    me(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[it.lastUsedAt]) == "number" ? wt : Da;
      },
...
function Oa(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? zt : e.unselectedSectionHeading ?? At
  };
}
function Bo(t) {
  return {
...
function ut(t) {
  return la[Me(t)] ?? String(t);
}
const Kt = "platform.footerAction", Ua = {
...
function Fa({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = pa(), [I, w] = J(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = K(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  let $;
  e === "project" ? t.openGroups.length > 0 && ($ = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ o(ft, { variant: "secondary", children: ut(R) }, R)) })) : t.scrollGroupId !== void 0 && ($ = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      $a,
      {
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              He(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        $
  ...
  ), A = t.scrollGroupId !== void 0 ? ut(t.scrollGroupId) : void 0, W = t.isBoundButClosed && A ? a.boundButClosedTooltip.replace("{group}", A) : void 0;
  return /* @__PURE__ */ p(Gt, { open: v, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      Lt,
      {
        ...
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", dir: "auto", children: Wt(t) }),
...
function Ka({
  ...
  return /* @__PURE__ */ p(ma, { children: [
    /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(fa, { asChild: !0, children: /* @__PURE__ */ o(
        V,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ o(Lt, { children: r.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ p(
      ha,
      {
...
function Uo(t) {
  const [e, a] = J(!1), [r, n] = J(""), s = Ha(t.localizedStrings), i = Y(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(me(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      Oa({
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, k = mt(null), [I, w] = J(void 0), g = K((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Dt(() => {
    if (!e) return;
  ...
  const v = Y(() => t.mode === "project" ? Nt({
    ...
    (c) => c === void 0 ? void 0 : H.get(O(c)),
    [H]
  ), { renderProjectIndicator: $ } = t, q = K(
    (c) => $ ? $(c.project) : void 0,
    [$]
  ), A = !!$, W = !!t.footerAction && h.length === 0, R = Y(() => {
    if (f === rt) return kt(h);
    const c = i.find((b) => b.id === f);
    return c ? Ra(h, c) : kt(h);
  }, [h, f, i]), y = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, j = O(c.projectId), B = (z) => O(z.projectId) === j && z.scrollGroupId === c.scrollGroupId, L = b.some(B) ? b.filter((z) => !B(z)) : [
          ...b.filter((z) => !B(z)),
  ...
  }, G = t.mode === "project" ? t.renderTriggerLabel : void 0, D = t.mode === "project" ? t.triggerLabelFormat : void 0, E = Y(() => {
    switch (t.mode) {
      case "project": {
        const c = U(t.selection.projectId);
        if (G)
          return { node: G(c), title: "", hasSelection: !!c };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && D === "shortNameAndFullName" && (b = Wt(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((L) => {
          const z = U(L.projectId);
          z && b.push({ project: z, scrollGroupId: L.scrollGroupId });
        }), b.length === 0) {
          const L = s.buttonPlaceholder;
          return { node: L, title: L, hasSelection: !1 };
        }
        const j = b.map(
          ({ project: L, scrollGroupId: z }) => z === void 0 ? L.shortName : `${L.shortName} (${ut(z)})`
        ).join(", "), B = b.length.toString();
        return {
          node: /* @__PURE__ */ p(ve, { children: [
            /* @__PURE__ */ o(ft, { variant: "muted", className: "tw:shrink-0", children: B }),
            /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: j })
          ] }),
          title: `${B} ${j}`,
          hasSelection: !0
        };
  ...
  let st;
  t.isLoading ? st = /* @__PURE__ */ o(Le, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : nt ? st = void 0 : t.mode === "project-multi" ? st = /* @__PURE__ */ o(Xt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : st = /* @__PURE__ */ o(ze, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const he = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, ge = s.ariaLabel && E.hasSelection && E.title ? `${s.ariaLabel}: ${E.accessibleTitle ?? E.title}` : s.ariaLabel || void 0, Rt = /* @__PURE__ */ p(
    V,
    {
      ref: ot,
  ...
  ), be = E.title ? /* @__PURE__ */ o(Ht, { delayDuration: 400, children: /* @__PURE__ */ p(Gt, { children: [
    /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(St, { asChild: !0, children: Rt }) }),
    /* @__PURE__ */ o(Lt, { dir: "auto", children: E.title })
  ] }) }) : /* @__PURE__ */ o(St, { asChild: !0, children: Rt }), Ne = i.length > 1;
  return /* @__PURE__ */ p(le, { open: e, onOpenChange: g, children: [
    be,
    /* @__PURE__ */ o(
      ce,
      {
        ...
        children: /* @__PURE__ */ o(Ht, { delayDuration: 400, children: /* @__PURE__ */ p(
          ae,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p(oe, { children: [
                /* @__PURE__ */ o(ne, { children: s.commandEmptyMessage }),
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(se, { heading: Ja(c, s), children: c.rows.map((j) => /* @__PURE__ */ o(
                          Fa,
                          {
                            row: j,
                            mode: t.mode,
                        ...
                        b < R.length - 1 && /* @__PURE__ */ o(Ot, { alwaysRender: !0 })
                      ]
                    },
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            V,
            {
              ...
              children: [
                /* @__PURE__ */ o(Re, { className: "tw:h-4 tw:w-4" }),
...
const Fo = (t, e, a) => Wa(t, e).every((r) => a.includes(r));
function Za(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => C.bookIdToNumber(r) > 0).sort((r, n) => C.bookIdToNumber(r) - C.bookIdToNumber(n)).map((r) => da(r, e));
}
function Ko(t, e, a, r) {
...
function Vo({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function Xo({
  ...
  return /* @__PURE__ */ p(Ya, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Qa, { children: [
      /* @__PURE__ */ o(er, { variant: "icon", children: r ?? /* @__PURE__ */ o(De, {}) }),
      /* @__PURE__ */ o(ar, { children: t })
    ] }),
    a && /* @__PURE__ */ o(rr, { children: /* @__PURE__ */ o(V, { onClick: () => a(), children: e }) })
  ] });
}
const or = Jt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Pe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
or.displayName = "Spinner";
const nr = Z(
...
//# sourceMappingURL=resizable-FCXMv0ns.js.map
