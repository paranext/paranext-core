...
import { Slot as et, Dialog as T, Popover as J, Tooltip as G, Label as bt, RadioGroup as Y, ToggleGroup as ut, Separator as Nt, DropdownMenu as x } from "radix-ui";
import { IconX as vt, IconSearch as xt, IconCheck as at, IconChevronRight as yt } from "@tabler/icons-react";
import { Canon as k } from "@sillsdev/scripture";
import y, { useRef as kt, useState as Q, useCallback as F, createContext as Et, useContext as zt, useMemo as It, forwardRef as ct } from "react";
import { cva as M } from "class-variance-authority";
import { Command as P } from "cmdk";
import { ChevronsUpDown as Ct, Check as St, Star as Tt, Search as At, X as Dt, AlertTriangle as Mt, LoaderCircle as _t } from "lucide-react";
import { Section as R, MODIFIER_KEYS as Rt, getSectionForBook as Lt } from "platform-bible-utils";
...
import { extendTailwindMerge as Pt, twMerge as Bt } from "tailwind-merge";
const Gt = Pt({ prefix: "tw" });
function tt(t) {
  const e = [];
  let a = "", r = 0;
...
function jt(t, e) {
  ...
  const a = tt(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), n = a[a.length - 1], s = tt(e), i = s.some((c) => c.startsWith("-tw-")), d = s.some((c) => c.startsWith("!tw-"));
  if (i && n.startsWith("-")) {
    const c = n.slice(1);
    return [...r, `-tw-${c}`].join(":");
  }
...
function l(...t) {
  const e = Ot(t);
  if (!e) return e;
  if (e.indexOf("tw-") === -1) return Gt(e);
  const a = e.split(" ").filter(Boolean), r = /* @__PURE__ */ new Map(), n = [];
  return a.forEach((c) => {
    const m = $t(c);
    r.set(m.normalized, m.original), n.push(m.normalized);
  }), Bt(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const m = r.get(c);
    return m ? jt(c, m) : c;
  }).join(" ");
}
const Jt = 600, Ye = 650, Qe = 400, Ht = 450, Vt = 500, Xt = 550, ta = 650, ea = 700, wt = M(
...
function O({
  ...
  return /* @__PURE__ */ o(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: l(wt({ variant: e, size: a, className: t })),
      ...n
    }
  );
}
...
function ra({ ...t }) {
  return /* @__PURE__ */ o(T.Root, { "data-slot": "dialog", ...t });
}
function oa({ ...t }) {
  return /* @__PURE__ */ o(T.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function Kt({ ...t }) {
  return /* @__PURE__ */ o(T.Portal, { "data-slot": "dialog-portal", ...t });
}
function na({ ...t }) {
  return /* @__PURE__ */ o(T.Close, { "data-slot": "dialog-close", ...t });
}
function Ut({
  className: t,
...
function sa({
  ...
  const i = I();
  return /* @__PURE__ */ g(Kt, { children: [
    /* @__PURE__ */ o(Ut, { className: r }),
    /* @__PURE__ */ g(
      T.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(T.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ g(O, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(vt, {}),
...
function la({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(T.Close, { asChild: !0, children: /* @__PURE__ */ o(O, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Ft({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ o(
    "input",
    {
      type: e,
...
M("tw:flex tw:items-center tw:gap-2 tw:text-sm tw:shadow-none", {
  variants: {
    size: {
...
function Qt({
  ...
  const n = I(), s = y.useCallback(
    (i) => {
      if (e == null || e(i), i.defaultPrevented || !a || i.key !== " " || i.currentTarget.value !== "") return;
      const d = i.currentTarget.closest("[cmdk-root]"), c = d == null ? void 0 : d.querySelector(
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ g(Zt, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        P.Input,
        {
      ...
      /* @__PURE__ */ o(qt, { children: /* @__PURE__ */ o(xt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function re({
  ...
  return /* @__PURE__ */ g(
    P.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ o(at, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const oe = [
  ...
  var e;
  return ((e = oe[t]) == null ? void 0 : e.chapters) ?? -1;
}, se = k.allBookIds.filter(
  (t) => !k.isObsolete(k.bookIdToNumber(t))
);
function ie(t) {
  const e = [], a = Math.min(t.length, k.allBookIds.length);
  for (let r = 0; r < a; r += 1)
    t[r] === "1" && e.push(k.bookNumberToId(r + 1));
  return e;
}
function w(t) {
...
function ot(t, e) {
  return ne(k.bookIdToNumber(t));
}
function Z(t, e, a) {
  const r = k.bookIdToNumber(t);
  let n, s = a === "next" ? 1 / 0 : -1 / 0;
  return e.forEach((i) => {
    const d = k.bookIdToNumber(i);
...
function ha(t, e, a) {
  ...
  if (e === void 0) return;
  const i = Z(r, e, "previous");
  if (!i) return;
  const d = Math.max(ot(i), 1);
...
function xa(t, e) {
  var r;
  return ((r = e == null ? void 0 : e.get(t)) == null ? void 0 : r.localizedName) ?? k.bookIdToEnglishName(t);
}
function le(t, e) {
  var r;
...
const ya = Object.fromEntries(
  se.map((t) => [t, k.bookIdToEnglishName(t)])
);
function ka(t, e, a) {
  const r = e.trim().toLowerCase();
  if (!r) return !1;
  const n = k.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function de({ ...t }) {
  return /* @__PURE__ */ o(J.Root, { "data-slot": "popover", ...t });
}
function ue({ ...t }) {
  return /* @__PURE__ */ o(J.Trigger, { "data-slot": "popover-trigger", ...t });
}
const pt = y.createContext(null);
function Ea({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ o(pt.Provider, { value: t, children: e });
}
function ce({
  className: t,
  align: e = "center",
  ...
  const s = I(), i = y.useContext(pt);
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ o(J.Portal, { container: i ?? void 0, children: /* @__PURE__ */ o(
      J.Content,
      {
...
function za({ ...t }) {
  return /* @__PURE__ */ o(J.Anchor, { "data-slot": "popover-anchor", ...t });
}
function Ia({ className: t, ...e }) {
  return /* @__PURE__ */ o(
    "div",
...
function Aa({ ...t }) {
  return /* @__PURE__ */ o(G.Root, { "data-slot": "tooltip", ...t });
}
function Da({
  className: t,
  variant: e,
  ...
  return /* @__PURE__ */ o(
    G.Trigger,
    {
      ...
      className: e ? l(wt({ variant: e }), t) : t,
      ...a
    }
  );
}
function Ma({
  ...
  return /* @__PURE__ */ o(G.Portal, { children: /* @__PURE__ */ g(
    G.Content,
    {
...
const fe = ["input", "select", "textarea", "button"], he = ["button", "textbox"], Ha = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = kt(null), [s, i] = Q(void 0), [d, c] = Q(void 0), m = F(
    (u) => {
      i(u);
      const h = t.find((f) => f.id === u);
      h && (e == null || e(h));
      const b = document.getElementById(u);
      b && (b.scrollIntoView({ block: "center" }), b.focus()), n.current && n.current.setAttribute("aria-activedescendant", u);
    },
    [e, t]
  ), p = F(
    (u) => {
      const h = t.find((b) => b.id === u);
      h && (c((b) => b === u ? void 0 : u), a == null || a(h));
    },
    [a, t]
  ), z = (u) => {
    if (!u) return !1;
    const h = u.tagName.toLowerCase();
    if (u.isContentEditable || fe.includes(h)) return !0;
    const b = u.getAttribute("role");
    if (b && he.includes(b)) return !0;
    const f = u.getAttribute("tabindex");
    return f !== void 0 && f !== "-1";
  }, A = F(
    (u) => {
      var K;
      const h = u.target, b = (N) => N ? document.getElementById(N) : void 0, f = b(d), B = b(s);
      if (!!(f && h && f.contains(h) && h !== f) && z(h)) {
        if (u.key === "Escape" || u.key === "ArrowLeft" && !h.isContentEditable) {
          if (d) {
            u.preventDefault(), u.stopPropagation();
            const N = t.find((D) => D.id === d);
            N && m(N.id);
          }
          return;
        }
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const D = N.findIndex((C) => C === h);
          if (D === -1) return;
          let v;
          u.key === "ArrowDown" ? v = Math.min(D + 1, N.length - 1) : v = Math.max(D - 1, 0), v !== D && (u.preventDefault(), u.stopPropagation(), (K = N[v]) == null || K.focus());
          return;
        }
        return;
      }
      ...
      switch (u.key) {
        case "ArrowDown":
          L = Math.min($ + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          L = Math.max($ - 1, 0), u.preventDefault();
          break;
        case "Home":
        ...
        default:
          u.key.length === 1 && !u.metaKey && !u.ctrlKey && !u.altKey && (z(h) || (r == null || r(u.key), u.preventDefault()));
          return;
      }
      const X = t[L];
      X && m(X.id);
...
function Va({ className: t, variant: e = "default", asChild: a = !1, ...r }) {
  const n = a ? et.Root : "span";
  return /* @__PURE__ */ o(
    n,
    {
      "data-slot": "badge",
...
function Xa({ variant: t = "default", ...e }) {
  const a = I(), r = y.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ o(ht.Provider, { value: r, children: /* @__PURE__ */ o(x.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Ka({
  ...t
}) {
  return /* @__PURE__ */ o(x.Portal, { "data-slot": "dropdown-menu-portal", ...t });
}
function Ua({
  ...t
}) {
  return /* @__PURE__ */ o(x.Trigger, { "data-slot": "dropdown-menu-trigger", ...t });
}
function Fa({
  className: t,
  align: e = "start",
  ...
  const s = I();
  return /* @__PURE__ */ o(x.Portal, { children: /* @__PURE__ */ o(
    x.Content,
    {
...
function Za({ ...t }) {
  return /* @__PURE__ */ o(x.Group, { "data-slot": "dropdown-menu-group", ...t });
}
function Wa({
  className: t,
  inset: e,
      ...
      children: [
        /* @__PURE__ */ o(
          "span",
          {
            ...
            children: /* @__PURE__ */ o(x.ItemIndicator, { children: /* @__PURE__ */ o(at, {}) })
          }
        ),
        e
      ]
...
function Ya({
  ...
  return /* @__PURE__ */ o(x.RadioGroup, { "data-slot": "dropdown-menu-radio-group", ...t });
}
function Qa({
  className: t,
  children: e,
...
function tr({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ o(
    x.Label,
    {
...
function rr({ ...t }) {
  return /* @__PURE__ */ o(x.Sub, { "data-slot": "dropdown-menu-sub", ...t });
}
function or({
  className: t,
  inset: e,
  ...
  return /* @__PURE__ */ g(
    x.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(yt, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function H(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && be(r)
  );
}
function ir({
  className: t,
  ...
  y.useEffect(() => {
    ...
    const d = () => {
      requestAnimationFrame(() => {
        H(i, '[tabindex]:not([tabindex="-1"])').forEach((p) => {
    ...
    const a = (r) => {
      if (e.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const n = t.current ? H(t.current) : [], s = n.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
...
function cr({
  ...
  const d = y.useMemo(
    ...
    (p) => {
      ...
      const A = z.closest("table"), u = A ? (
        // getFocusableElements returns an HTMLElement[] but we are filtering for HTMLTableRowElements
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        H(A).filter(
          (f) => f.tagName === "TR"
        )
      ) : [], h = u.indexOf(z), b = d.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (p.key === "ArrowDown" || p.key === "ArrowUp")
        p.preventDefault(), xe(u, h, p.key);
      else if (p.key === "ArrowLeft" || p.key === "ArrowRight")
        p.preventDefault(), ve(d, b, p.key);
      else if (p.key === "Escape") {
        p.preventDefault();
        const f = z.closest("table");
        f && f.focus();
      }
      e == null || e(p);
    },
...
function fr({
  ...
  const [B, V] = Q(!1), nt = F(
    (v) => {
      var S;
      const C = (S = t.find((_) => _.label === v)) == null ? void 0 : S.value;
      C && a(
        e.includes(C) ? e.filter((_) => _ !== C) : [...e, C]
      );
    },
    [t, e, a]
  ), $ = () => c || r, L = It(() => {
    if (!A) return t;
    const v = t.filter((S) => S.starred).sort((S, _) => S.label.localeCompare(_.label)), C = t.filter((S) => !S.starred).sort((S, _) => {
      const st = e.includes(S.value), it = e.includes(_.value);
      return st && !it ? -1 : !st && it ? 1 : S.label.localeCompare(_.label);
    });
    return [...v, ...C];
  }, [t, e, A]), X = () => {
    a(t.map((v) => v.value));
  ...
  return /* @__PURE__ */ o("div", { id: f, className: h, children: /* @__PURE__ */ g(de, { open: N, onOpenChange: p ?? V, children: [
    /* @__PURE__ */ o(ue, { asChild: !0, children: /* @__PURE__ */ g(
      O,
      {
        variant: b,
        role: "combobox",
    ...
    /* @__PURE__ */ o(ce, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(Yt, { children: [
      /* @__PURE__ */ o(
        Qt,
        {
      ...
      n && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(O, { variant: "ghost", size: "sm", onClick: X, children: s }),
        /* @__PURE__ */ o(O, { variant: "ghost", size: "sm", onClick: K, children: i })
      ] }),
      /* @__PURE__ */ g(te, { children: [
        /* @__PURE__ */ o(ee, { children: d }),
        /* @__PURE__ */ o(ae, { children: L.map((v) => /* @__PURE__ */ g(
          re,
          {
            value: v.label,
            onSelect: nt,
            ...
            children: [
              /* @__PURE__ */ o("div", { className: "w-4", children: /* @__PURE__ */ o(
                St,
                {
                  className: l(
                    "tw:h-4 tw:w-4",
                    e.includes(v.value) ? "tw:opacity-100" : "tw:opacity-0"
                  )
                }
              ) }),
              v.starred && /* @__PURE__ */ o(Tt, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ o("div", { className: "tw:flex-grow", children: v.label }),
              v.secondaryLabel && /* @__PURE__ */ o("div", { className: "tw:text-end tw:text-muted-foreground", children: v.secondaryLabel })
            ]
          },
          v.label
        )) })
...
function ye(t, e, a) {
  if (!e) return [...t];
  const r = [...t], n = j(e).toLowerCase();
  return a === "passive" ? lt({
    query: n,
    items: r,
    filter: (s) => j(s.label).toLowerCase().startsWith(n),
    sortBy: "label"
  }) : lt({
    query: n,
    items: r,
    filter: (s) => j(s.label).toLowerCase().includes(n),
    sortBy: "label"
  });
}
function ke(t) {
...
function hr(t, e, a) {
  ...
  const { kind: r } = e;
  if (r === "enter")
    return t.key === "Enter" ? (E(t), a.commit(), "ended") : t.key === "Escape" ? (E(t), a.dismiss(), "ended") : "passed";
  if (ke(t) || Rt.has(t.key) || t.key === "Dead")
    return "passed";
  if ((t.ctrlKey || t.metaKey || t.altKey) && !((n = t.getModifierState) != null && n.call(t, "AltGraph")))
    return t.key === "Enter" && E(t), a.dismiss(), "ended";
  if (t.key === "ArrowDown" || t.key === "ArrowUp")
    return E(t), a.update({ moveSelection: t.key === "ArrowDown" ? 1 : -1 }), "continue";
  ...
  if (t.key === "Escape")
    return E(t), a.dismiss(), "ended";
  if (t.key === " ") {
    if (r === "backslash")
      return E(t), e.filter === "" ? (a.dismiss(), "ended") : (s = e.shouldSpaceCommit) != null && s.call(e, e.filter) ? (a.commit(), "ended") : (a.commitTyped(e.filter), a.dismiss(), "ended");
    E(t);
    const i = j(e.filter).toLowerCase(), d = e.items.find(
      (c) => j(c.marker).toLowerCase() === i
    );
    return d && a.commitItem(d.marker), a.dismiss(), "ended";
  }
  return t.key === "*" ? r === "selection" && e.filter === "" ? (E(t), a.dismiss(), "ended") : (E(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (E(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (E(t), a.dismiss(), "ended") : t.key === "Backspace" || gt[r].test(t.key) ? (E(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && E(t), a.dismiss(), "ended");
}
function gr(t, e) {
  var a;
...
function br(t) {
  ...
  n.current += 1;
  const u = n.current, h = a ? "backslash" : "selection", b = { kind: h, token: u, filter: "", items: e };
  h === "backslash" && r && (b.shouldSpaceCommit = r), s(b), c({
...
const Ce = ct(
  ({ value: t, onSearch: e, placeholder: a, isFullWidth: r, className: n, isDisabled: s = !1, id: i }, d) => {
    ...
    return /* @__PURE__ */ g(
      ...
      {
        id: i,
        className: l("tw:relative tw:@container/search", { "tw:w-full": r }, n),
        children: [
          /* @__PURE__ */ o(
            At,
            {
          ...
          t && /* @__PURE__ */ g(
            O,
            {
              ...
              children: [
                /* @__PURE__ */ o(Dt, { className: "tw:h-4 tw:w-4" }),
...
Ce.displayName = "SearchBar";
const Se = 5;
function xr(t) {
  return ie(t).filter(
    (e) => !k.isObsolete(k.bookIdToNumber(e))
  );
}
function Te(t, e) {
  return t.filter((a) => {
...
const yr = (t, e, a) => Te(t, e).every((r) => a.includes(r));
function Ae(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => k.bookIdToNumber(r) > 0).sort((r, n) => k.bookIdToNumber(r) - k.bookIdToNumber(n)).map((r) => le(r, e));
}
function kr(t, e, a, r) {
  ...
  const i = Ae(t, r);
  if (i.length !== 0)
    return i.length <= Se ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
function Er({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function Ir({
  ...
  return /* @__PURE__ */ g(De, { className: l(s), role: n, children: [
    /* @__PURE__ */ g(Me, { children: [
      /* @__PURE__ */ o(Re, { variant: "icon", children: r ?? /* @__PURE__ */ o(Mt, {}) }),
      /* @__PURE__ */ o(Le, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Oe, { children: /* @__PURE__ */ o(O, { onClick: () => a(), children: e }) })
  ] });
}
const Pe = ct(({ className: t, ...e }, a) => /* @__PURE__ */ o(_t, { size: 35, className: l("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-B1exdhUM.js.map
