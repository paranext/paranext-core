import { jsx as n, jsxs as m, Fragment as me } from "react/jsx-runtime";
import { Slot as _t, Dialog as K, Separator as fe, Popover as it, Tooltip as at, DropdownMenu as T, Label as he, RadioGroup as yt, ToggleGroup as Vt } from "radix-ui";
import { IconX as ge, IconCheck as Tt, IconSearch as be, IconChevronRight as Ne } from "@tabler/icons-react";
import { Canon as j } from "@sillsdev/scripture";
import { cva as q } from "class-variance-authority";
import C, { useState as B, useRef as ot, useCallback as X, createContext as ve, useContext as xe, useEffect as pt, useMemo as Q, Fragment as ye, forwardRef as Jt } from "react";
import { ChevronsUpDown as Xt, Check as qt, Star as Se, Group as ke, ArrowRight as Ie, Loader2 as Ee, ChevronDown as _e, Search as Te, X as Ce, AlertTriangle as je, LoaderCircle as Ge } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as ze, normalizeProjectId as D, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as nt, getLocalizeKeyForScrollGroupId as Le, getSectionForBook as Ae } from "platform-bible-utils";
...
function Be(t) {
  ...
  const e = St(t), a = e.findIndex((s) => s.startsWith("-tw-"));
  if (a !== -1) {
    const s = e[a].slice(4);
...
function Me(t, e) {
  ...
  const a = St(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), o = a[a.length - 1], s = St(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const u = o.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
const Wt = 600, Zt = 650, pr = 400, He = 450, Ue = 500, $e = 675, mr = 690, fr = 700, hr = 800, Yt = q(
...
function M() {
  var t;
  try {
    const e = (t = te()) == null ? void 0 : t.getItem(Qt);
    if (e === "rtl")
      return e;
  } catch {
  }
  ...
  return /* @__PURE__ */ m(Fe, { children: [
    ...
    /* @__PURE__ */ m(
      K.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(K.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ge, {}),
...
function Sr({
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(K.Close, { asChild: !0, children: /* @__PURE__ */ n(U, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ae({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Je, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        et.Input,
        {
      ...
      /* @__PURE__ */ n(qe, { children: /* @__PURE__ */ n(be, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function jt({
  ...
  return /* @__PURE__ */ m(
    et.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ n(Tt, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const Pr = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
let kt = "keyboard", Mt = !1;
function Or() {
...
const se = "data-quiet-focus";
function Mr(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(se, ""), t.style.outline = "none"));
}
function Hr(t) {
  t && (t.removeAttribute(se), t.style.removeProperty("outline"));
}
...
function sa({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(ce.Provider, { value: r, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Zr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(T.ItemIndicator, { children: /* @__PURE__ */ n(Tt, {}) })
          }
        ),
        e
      ]
...
function ro({
  ...
  return /* @__PURE__ */ m(
    T.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(Ne, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const pa = ["input", "select", "textarea", "button"], ma = ["button", "textbox"], po = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = ot(null), [s, i] = B(void 0), [l, u] = B(void 0), f = X(
    (w) => {
      i(w);
    ...
    (w) => {
      const b = t.find((v) => v.id === w);
      b && (u((v) => v === w ? void 0 : w), a == null || a(b));
    },
    [a, t]
  ), k = (w) => {
    if (!w) return !1;
    const b = w.tagName.toLowerCase();
    if (w.isContentEditable || pa.includes(b)) return !0;
    ...
    (w) => {
      var A;
      const b = w.target, v = (N) => N ? document.getElementById(N) : void 0, g = v(l), $ = v(s);
      if (!!(g && b && g.contains(b) && b !== g) && k(b)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !b.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const N = t.find((P) => P.id === l);
            N && f(N.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const P = N.findIndex((F) => F === b);
          if (P === -1) return;
          let O;
          w.key === "ArrowDown" ? O = Math.min(P + 1, N.length - 1) : O = Math.max(P - 1, 0), O !== P && (w.preventDefault(), w.stopPropagation(), (A = N[O]) == null || A.focus());
          return;
        }
        return;
      }
      const J = t.findIndex((N) => N.id === s);
      let G = J;
      switch (w.key) {
        case "ArrowDown":
          G = Math.min(J + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          G = Math.max(J - 1, 0), w.preventDefault();
          break;
        case "Home":
  ...
  C.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        lt(i, '[tabindex]:not([tabindex="-1"])').forEach((h) => {
...
function So({
  ...
  const [W, J] = B(!1), G = ot(null), H = X(
    (z) => {
      var p;
      const c = (p = t.find((S) => S.label === z)) == null ? void 0 : p.value;
      c && a(
        e.includes(c) ? e.filter((S) => S !== c) : [...e, c]
      );
    },
    [t, e, a]
  ), A = () => f || r, N = h ?? W, P = k ?? J, O = ot(e);
  O.current = e;
  const [F, Y] = B(e);
  pt(() => {
    N && Y(O.current);
  ...
  const bt = Q(() => {
    if (!w) return t;
    const z = t.filter((p) => p.starred).sort((p, S) => p.label.localeCompare(S.label)), c = t.filter((p) => !p.starred).sort((p, S) => {
      const I = F.includes(p.value), E = F.includes(S.value);
      return I && !E ? -1 : !I && E ? 1 : p.label.localeCompare(S.label);
    });
    return [...z, ...c];
  }, [t, F, w]), ct = () => {
    a(t.map((z) => z.value));
  ...
  return /* @__PURE__ */ n("div", { id: V, className: g, children: /* @__PURE__ */ m(ie, { open: N, onOpenChange: P, children: [
    /* @__PURE__ */ n(It, { asChild: !0, children: /* @__PURE__ */ m(
      U,
      {
        variant: $,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ n(Xt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(de, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(ee, { children: [
      /* @__PURE__ */ n(
        ae,
        {
          placeholder: o ?? r,
      ...
      s && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(U, { variant: "ghost", size: "sm", onClick: ct, children: i }),
        /* @__PURE__ */ n(U, { variant: "ghost", size: "sm", onClick: Nt, children: l })
      ] }),
      /* @__PURE__ */ n(va, { isEnabled: b, scrollerRef: G, children: /* @__PURE__ */ m(re, { ref: G, children: [
        /* @__PURE__ */ n(oe, { children: u }),
        /* @__PURE__ */ n(ne, { children: bt.map((z) => /* @__PURE__ */ m(
          jt,
          {
            value: z.label,
            onSelect: H,
            ...
            children: [
              ...
              z.starred && /* @__PURE__ */ n(Se, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ n("div", { className: "tw:flex-grow", children: z.label }),
              z.secondaryLabel && /* @__PURE__ */ n("div", { className: "tw:text-end tw:text-muted-foreground", children: z.secondaryLabel })
            ]
          },
          z.label
        )) })
...
function ko(t, e, a) {
  ...
  if (ya(t) || ze.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (R(t), a.dismiss(), "ended") : (R(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (R(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (R(t), a.dismiss(), "ended") : t.key === "Backspace" || we[r].test(t.key) ? (R(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && R(t), a.dismiss(), "ended");
}
function Io(t, e) {
  var a;
...
function Eo(t) {
  ...
  o.current += 1;
  const w = o.current, b = a ? "backslash" : "selection", v = { kind: b, token: w, filter: "", items: e };
  b === "backslash" && r && (v.shouldSpaceCommit = r), s(v), u({
  ...
  return t.projects.forEach((o) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: $t(a, o.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: o.isDisabled === !0,
        disabledReason: o.disabledReason,
...
const Rt = "Selected", Dt = "Unselected";
function Ft(t) {
...
function _a(t) {
  const e = t.filter(Ft).sort(tt), a = t.filter((o) => !Ft(o)).sort(tt);
  if (e.length === 0)
...
function Ta(t, e) {
  const a = t.filter((i) => i.isSelected).sort(tt), r = t.filter((i) => !i.isSelected).sort(tt), o = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? Rt : Dt;
  }, s = [];
...
function Ca(t, e) {
  if (e.id === "openTabs") return _a(t);
  if (e.id === "selection") return Ta(t, e);
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const f = [...u].sort(
      (_, w) => {
        var b;
        return ((b = e.compareProjects) == null ? void 0 : b.call(e, _.project, w.project)) || tt(_, w);
      }
...
function Ga(t) {
  ...
  return [
    pe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[nt.lastUsedAt]) == "number" ? ut : ja;
      },
...
function za(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? Rt : e.unselectedSectionHeading ?? Dt
  };
}
function Go(t) {
  return {
...
const Kt = "platform.footerAction", Da = {
...
function Oa({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: k
  } = na(), [_, w] = B(!1), b = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = f || _, g = X(() => {
    if (b) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), V = /* @__PURE__ */ n(qt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let W;
  e === "project" ? t.openGroups.length > 0 && (W = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((A) => /* @__PURE__ */ n(mt, { variant: "secondary", children: dt(A) }, A)) })) : t.scrollGroupId !== void 0 && (W = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Pa,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ m(
      U,
      {
        ...
        children: [
          /* @__PURE__ */ n(Ie, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  const J = /* @__PURE__ */ m(
    jt,
    {
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: V }),
  ...
  return /* @__PURE__ */ m(zt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Lt, { asChild: !0, children: J }),
    /* @__PURE__ */ m(
      At,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && G && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
...
function Ba({
  ...
  return /* @__PURE__ */ m(sa, { children: [
    /* @__PURE__ */ m(zt, { children: [
      /* @__PURE__ */ n(Lt, { asChild: !0, children: /* @__PURE__ */ n(ia, { asChild: !0, children: /* @__PURE__ */ n(
        U,
        {
          variant: "ghost",
          size: "sm",
          ...
          children: /* @__PURE__ */ n(ke, { className: "tw:h-4 tw:w-4" })
        }
      ) }) }),
      /* @__PURE__ */ n(At, { children: r.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      la,
      {
        ...
        style: { zIndex: Zt },
        children: [
          /* @__PURE__ */ n(ca, { children: r.groupSectionLabel }),
          /* @__PURE__ */ m(da, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(Ut, { value: rt, children: r.groupByNone }),
            /* @__PURE__ */ n(ua, {}),
            t.map((s) => /* @__PURE__ */ n(Ut, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function Ao(t) {
  const [e, a] = B(!1), [r, o] = B(""), s = Ra(t.localizedStrings), i = Q(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(pe(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      za({
    ...
    () => Ma(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), h = l ?? f, k = ot(null), [_, w] = B(void 0), b = X((c) => {
    a(c), c || (o(""), w(void 0));
  }, []);
  pt(() => {
    if (!e) return;
  ...
  const v = Q(() => t.mode === "project" ? vt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? vt({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  ...
  }, [v, r]), $ = !!t.footerAction && g.length === 0, V = Q(() => {
    if (h === rt) return Et(g);
    const c = i.find((p) => p.id === h);
    return c ? Ca(g, c) : Et(g);
  }, [g, h, i]), W = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, S = D(c.projectId), I = (L) => D(L.projectId) === S && L.scrollGroupId === c.scrollGroupId, E = p.some(I) ? p.filter((L) => !I(L)) : [
          ...p.filter((L) => !I(L)),
  ...
  }, H = t.mode === "project" ? t.renderTriggerLabel : void 0, A = t.mode === "project" ? t.triggerLabelFormat : void 0, N = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = xt(t.projects, t.selection.projectId);
        if (H) return { node: H(c), title: "" };
        let p = c ? c.shortName : s.buttonPlaceholder;
        return c && A === "shortNameAndFullName" && c.fullName && c.fullName !== c.shortName && (p = `${c.shortName} - ${c.fullName}`), { node: p, title: p };
      }
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((E) => {
          const L = xt(t.projects, E.projectId);
          L && p.push({ project: L, scrollGroupId: E.scrollGroupId });
        }), p.length === 0) {
          const E = s.buttonPlaceholder;
          return { node: E, title: E };
        }
        const S = p.map(
          ({ project: E, scrollGroupId: L }) => L === void 0 ? E.shortName : `${E.shortName} (${dt(L)})`
        ).join(", "), I = p.length.toString();
        return {
          node: /* @__PURE__ */ m(me, { children: [
            /* @__PURE__ */ n(mt, { variant: "muted", className: "tw:shrink-0", children: I }),
            /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: S })
          ] }),
          title: `${I} ${S}`
        };
      }
  ...
  pt(() => {
    ...
    const S = new ResizeObserver((I) => {
      I.forEach((E) => {
        const [L] = E.borderBoxSize;
        p(L ? L.inlineSize : c.getBoundingClientRect().width);
      });
    });
    return S.observe(c, { box: "border-box" }), () => S.disconnect();
  }, []);
  let Y;
  t.isLoading ? Y = /* @__PURE__ */ n(Ee, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : O ? Y = void 0 : t.mode === "project-multi" ? Y = /* @__PURE__ */ n(Xt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : Y = /* @__PURE__ */ n(_e, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const bt = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? W : void 0, ct = /* @__PURE__ */ m(
    U,
    {
      ref: P,
      ...
      className: d(
        ...
        // wide case.
        O && "tw:px-0.5 tw:text-xs",
        t.buttonClassName
      ),
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof N.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: N.node }) : N.node }),
        Y
      ]
    }
  ), Nt = N.title ? /* @__PURE__ */ n(Ht, { delayDuration: 400, children: /* @__PURE__ */ m(zt, { children: [
    /* @__PURE__ */ n(Lt, { asChild: !0, children: /* @__PURE__ */ n(It, { asChild: !0, children: ct }) }),
    /* @__PURE__ */ n(At, { children: N.title })
  ] }) }) : /* @__PURE__ */ n(It, { asChild: !0, children: ct }), z = i.length > 1;
  return /* @__PURE__ */ m(ie, { open: e, onOpenChange: b, children: [
    Nt,
    /* @__PURE__ */ n(
      de,
      {
        ...
        children: /* @__PURE__ */ n(Ht, { delayDuration: 400, children: /* @__PURE__ */ m(
          ee,
          {
            shouldFilter: !1,
            value: $ ? _ ?? Kt : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(U, { variant: "ghost", size: "sm", onClick: G, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ m(re, { children: [
                /* @__PURE__ */ n(oe, { children: s.commandEmptyMessage }),
                V.map((c, p) => (
                  ...
                  /* @__PURE__ */ m(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(ne, { heading: Ha(c, s), children: c.rows.map((S) => {
                          var I;
                          return /* @__PURE__ */ n(
                            Oa,
                            {
                              ...
                              onOpen: bt,
                              selectedRowRef: k,
                              indicator: (I = t.renderProjectIndicator) == null ? void 0 : I.call(t, S.project),
                              reserveIndicatorSlot: !!t.renderProjectIndicator
                            },
                            S.rowKey
                          );
                        }) }),
                        p < V.length - 1 && /* @__PURE__ */ n(Ot, { alwaysRender: !0 })
                      ]
                    },
                ...
                // "1 of N".
                /* @__PURE__ */ m("div", { role: "presentation", className: "tw:sticky tw:bottom-0 tw:z-10 tw:bg-popover", children: [
                  ...
                  /* @__PURE__ */ m(
                    jt,
                    {
                      ...
                      onSelect: () => {
                        var c;
                        (c = t.footerAction) == null || c.onSelect(), b(!1);
                      },
                      children: [
                        /* @__PURE__ */ n(
                          "span",
        ...
        children: [
          ...
          t && /* @__PURE__ */ m(
            U,
            {
              ...
              children: [
                /* @__PURE__ */ n(Ce, { className: "tw:h-4 tw:w-4" }),
...
const Do = (t, e, a) => Fa(t, e).every((r) => a.includes(r));
function Ka(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => j.bookIdToNumber(r) > 0).sort((r, o) => j.bookIdToNumber(r) - j.bookIdToNumber(o)).map((r) => ea(r, e));
}
function Po(t, e, a, r) {
...
function Oo({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
function Mo({
  ...
  return /* @__PURE__ */ m(Va, { className: d(s), role: o, children: [
    /* @__PURE__ */ m(Ja, { children: [
      /* @__PURE__ */ n(qa, { variant: "icon", children: r ?? /* @__PURE__ */ n(je, {}) }),
      /* @__PURE__ */ n(Wa, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Za, { children: /* @__PURE__ */ n(U, { onClick: () => a(), children: e }) })
  ] });
}
const Ya = Jt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Ge, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DPRMj8J0.js.map
