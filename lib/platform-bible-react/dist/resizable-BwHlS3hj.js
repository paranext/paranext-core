...
import { Slot as kt, Dialog as V, Separator as pe, Popover as it, Tooltip as at, DropdownMenu as _, Label as me, RadioGroup as vt, ToggleGroup as Ut } from "radix-ui";
import { IconX as fe, IconSearch as he, IconCheck as It, IconChevronRight as ge } from "@tabler/icons-react";
import { Canon as j } from "@sillsdev/scripture";
import { cva as Z } from "class-variance-authority";
import C, { useState as F, useRef as pt, useCallback as W, createContext as be, useContext as Ne, useMemo as Q, useEffect as At, Fragment as ve, forwardRef as Kt } from "react";
...
import { Section as Y, MODIFIER_KEYS as je, normalizeProjectId as P, compareProjectsByName as Ge, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as nt, formatProjectName as Jt, getLocalizeKeyForScrollGroupId as ze, hasDistinctFullName as Le, getSectionForBook as Ae } from "platform-bible-utils";
...
const Xt = 600, Wt = 650, ur = 400, He = 450, $e = 500, Ue = 675, wr = 690, pr = 700, mr = 800, Zt = Z(
  ...
  return /* @__PURE__ */ p(Ke, { children: [
    ...
    /* @__PURE__ */ p(
      V.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(V.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p($, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(fe, {}),
...
function xr({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(V.Close, { asChild: !0, children: /* @__PURE__ */ o($, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Qt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(Je, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ o(We, { children: /* @__PURE__ */ o(he, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const oe = C.createContext(null);
function Br({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ o(oe.Provider, { value: t, children: e });
}
function ne({
  className: t,
  align: e = "center",
...
function sa({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(se.Provider, { value: r, children: /* @__PURE__ */ o(_.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Kr({
  ...t
}) {
...
const pa = ["input", "select", "textarea", "button"], ma = ["button", "textbox"], no = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function ho({
  ...
  const [U, J] = F(!1), q = W(
    ...
    const S = t.filter((E) => E.starred).sort((E, K) => E.label.localeCompare(K.label)), O = t.filter((E) => !E.starred).sort((E, K) => {
      const ct = e.includes(E.value), ot = e.includes(K.value);
      return ct && !ot ? -1 : !ct && ot ? 1 : E.label.localeCompare(K.label);
    });
    return [...S, ...O];
  }, [t, e, I]), H = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(re, { open: N, onOpenChange: f ?? J, children: [
    ...
    /* @__PURE__ */ o(ne, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(Yt, { children: [
      /* @__PURE__ */ o(
        Qt,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: H, children: s }),
        /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ p(te, { children: [
        /* @__PURE__ */ o(ee, { children: l }),
        /* @__PURE__ */ o(ae, { children: A.map((S) => /* @__PURE__ */ p(
          _t,
          {
            value: S.label,
            onSelect: q,
...
function go(t, e, a) {
  ...
  if (va(t) || je.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || le[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function bo(t, e) {
  var a;
...
function dt(t) {
  return ta[ze(t)] ?? String(t);
}
const $t = "platform.footerAction", Aa = {
...
function Da({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = na(), [I, w] = F(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, x = m || I, h = W(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  let q;
  e === "project" ? t.openGroups.length > 0 && (q = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ o(mt, { variant: "secondary", children: dt(R) }, R)) })) : t.scrollGroupId !== void 0 && (q = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Ra,
      {
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              Le(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        q
  ...
  return /* @__PURE__ */ p(Ct, { open: x, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      Gt,
      {
        ...
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", dir: "auto", children: Jt(t) }),
...
function Pa({
  ...
  return /* @__PURE__ */ p(sa, { children: [
    /* @__PURE__ */ p(Ct, { children: [
      /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(ia, { asChild: !0, children: /* @__PURE__ */ o(
        $,
        {
          variant: "ghost",
          size: "sm",
...
function _o(t) {
  const [e, a] = F(!1), [r, n] = F(""), s = La(t.localizedStrings), i = Q(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(de(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      ja({
  ...
  const x = Q(() => t.mode === "project" ? bt({
  ...
  }, [x, r]), U = !!t.footerAction && h.length === 0, J = Q(() => {
    if (f === rt) return St(h);
    const c = i.find((b) => b.id === f);
    return c ? _a(h, c) : St(h);
  }, [h, f, i]), q = (c) => {
    ...
    switch (t.mode) {
      case "project": {
        ...
        return c && R === "shortNameAndFullName" && (b = Jt(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
  ...
  let E;
  t.isLoading ? E = /* @__PURE__ */ o(ke, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : S ? E = void 0 : t.mode === "project-multi" ? E = /* @__PURE__ */ o(Ft, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : E = /* @__PURE__ */ o(Ie, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const K = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? q : void 0, ct = s.ariaLabel && N.hasSelection && N.title ? `${s.ariaLabel}: ${N.accessibleTitle ?? N.title}` : s.ariaLabel || void 0, ot = /* @__PURE__ */ p(
    $,
    {
      ref: B,
  ...
  ), ce = N.title ? /* @__PURE__ */ o(Ot, { delayDuration: 400, children: /* @__PURE__ */ p(Ct, { children: [
    /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(yt, { asChild: !0, children: ot }) }),
    /* @__PURE__ */ o(Gt, { dir: "auto", children: N.title })
  ] }) }) : /* @__PURE__ */ o(yt, { asChild: !0, children: ot }), ue = i.length > 1;
  return /* @__PURE__ */ p(re, { open: e, onOpenChange: g, children: [
    ce,
    /* @__PURE__ */ o(
      ne,
      {
        ...
        children: /* @__PURE__ */ o(Ot, { delayDuration: 400, children: /* @__PURE__ */ p(
          Yt,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ o($, { variant: "ghost", size: "sm", onClick: A, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(te, { children: [
                /* @__PURE__ */ o(ee, { children: s.commandEmptyMessage }),
                J.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(ae, { heading: Ba(c, s), children: c.rows.map((G) => {
                          var T;
                          return /* @__PURE__ */ o(
                            Da,
                            {
...
const Co = (t, e, a) => $a(t, e).every((r) => a.includes(r));
function Ua(t, e) {
  return [
...
function Lo({
  ...
  return /* @__PURE__ */ p(Ka, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Fa, { children: [
      /* @__PURE__ */ o(Ja, { variant: "icon", children: r ?? /* @__PURE__ */ o(Te, {}) }),
      /* @__PURE__ */ o(Xa, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Wa, { children: /* @__PURE__ */ o($, { onClick: () => a(), children: e }) })
  ] });
}
const Za = Kt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ce, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BwHlS3hj.js.map
