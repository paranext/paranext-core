...
|||||||| parent of 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-IStUK-JI.js
...
import { includes as rt, Section as K, MODIFIER_KEYS as me, normalizeProjectId as Q, getLocalizeKeyForScrollGroupId as pe, getSectionForBook as he } from "platform-bible-utils";
import { filterAndRankItems as vt } from "@eten-tech-foundation/platform-editor";
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
...
========
          f.key === "ArrowDown" ? p = Math.min(w + 1, S.length - 1) : p = Math.max(w - 1, 0), p !== w && (f.preventDefault(), f.stopPropagation(), (F = S[p]) == null || F.focus());
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
          return;
        }
        return;
...
========
  return /* @__PURE__ */ n("div", { id: I, className: v, children: /* @__PURE__ */ g(Ht, { open: S, onOpenChange: m ?? M, children: [
    /* @__PURE__ */ n(ft, { asChild: !0, children: /* @__PURE__ */ g(
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
      O,
      {
...
========
  } = He(), [m, h] = $(!1), k = !!(t.language || t.languageCode), f = k || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = d || m, x = H(() => {
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
    if (f) {
      h(!0);
      return;
...
========
  e === "project" ? t.openGroups.length > 0 && (M = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((G) => /* @__PURE__ */ n(nt, { variant: "secondary", children: et(G) }, G)) })) : t.scrollGroupId !== void 0 && (M = /* @__PURE__ */ g("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
    /* @__PURE__ */ n(
      ma,
      {
...
|||||||| parent of 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-IStUK-JI.js
  const [e, a] = $(!1), [r, o] = $(""), [s, i] = $(t.defaultGroupByOpenTabs ?? !0), [d, l] = $(!1), c = ht(null), m = H((u) => {
    a(u), u || o("");
========
  const [e, a] = $(!1), [r, o] = $(""), [s, i] = $(t.defaultGroupByOpenTabs ?? !0), [d, l] = $(!1), c = ht(null), m = H((w) => {
    a(w), w || o("");
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
  }, []);
  oe(() => {
...
========
  ...
  const G = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? I : void 0, F = /* @__PURE__ */ g(
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
    O,
    {
...
========
    ...
    /* @__PURE__ */ n(Jt, { asChild: !0, children: /* @__PURE__ */ n(ft, { asChild: !0, children: F }) }),
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
...
========
//# sourceMappingURL=resizable-CQfx9M-c.js.map
>>>>>>>> 79fa259a2c8 (feat(text-collection): re-enable Get Resources and bind the grid to the project):lib/platform-bible-react/dist/resizable-CQfx9M-c.js
