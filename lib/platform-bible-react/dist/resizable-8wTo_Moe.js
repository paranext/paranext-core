...
const Gt = 600, Ka = 650, Ja = 400, ye = 450, ke = 500, Ie = 550, Xa = 650, Wa = 700, zt = H(
...
const $e = ["input", "select", "textarea", "button"], He = ["button", "textbox"], Ar = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const n = ft(null), [s, i] = U(void 0), [l, u] = U(void 0), p = $(
    ...
    (w) => {
      var X;
      const b = w.target, I = (S) => S ? document.getElementById(S) : void 0, x = I(l), O = I(s);
      if (!!(x && b && x.contains(b) && b !== x) && C(b)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !b.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const S = t.find((B) => B.id === l);
            S && p(S.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const B = S.findIndex((m) => m === b);
          if (B === -1) return;
          let d;
          w.key === "ArrowDown" ? d = Math.min(B + 1, S.length - 1) : d = Math.max(B - 1, 0), d !== B && (w.preventDefault(), w.stopPropagation(), (X = S[d]) == null || X.focus());
          return;
        }
        return;
      }
...
function Mr({ className: t, children: e, ...a }) {
  const r = P();
  return /* @__PURE__ */ o(
    T.SubContent,
    {
  ...
  return /* @__PURE__ */ o("div", { id: x, className: b, children: /* @__PURE__ */ f(Mt, { open: S, onOpenChange: g ?? M, children: [
    ...
    /* @__PURE__ */ o(jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Lt, { children: [
      ...
      /* @__PURE__ */ f(Rt, { children: [
        ...
        /* @__PURE__ */ o(Bt, { children: G.map((d) => /* @__PURE__ */ f(
          Ot,
          {
            value: d.label,
            onSelect: J,
...
function ha({ row: t, mode: e, strings: a, onClick: r, onOpen: n, selectedRowRef: s }) {
  const {
    ...
    C(!1), p();
  }, [p]), O = /* @__PURE__ */ o(Tt, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let M;
...
function tn(t) {
  ...
  }, [t.mode, t.projects, t.openTabs]), O = (d) => {
  ...
  const X = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? O : void 0, S = /* @__PURE__ */ f(
    R,
    {
  ...
  ), B = G.title ? /* @__PURE__ */ o(bt, { delayDuration: 400, children: /* @__PURE__ */ f(Ut, { children: [
          ...
          /* @__PURE__ */ f(Rt, { children: [
            ...
            I.map((d, m) => (
              ...
              /* @__PURE__ */ f(re, { children: [
                /* @__PURE__ */ o(Bt, { heading: va(d, v), children: d.rows.map((h) => /* @__PURE__ */ o(
                  ha,
                  {
                    row: h,
                    mode: t.mode,
...
const an = (t, e, a) => ka(t, e).every((r) => a.includes(r));
function Ia(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => A.bookIdToNumber(r) > 0).sort((r, n) => A.bookIdToNumber(r) - A.bookIdToNumber(n)).map((r) => Oe(r, e));
}
function rn(t, e, a, r) {
...
function nn({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
//# sourceMappingURL=resizable-8wTo_Moe.js.map
