import { jsx as n, jsxs as f, Fragment as Gt } from "react/jsx-runtime";
import { Slot as ht, Dialog as $, Popover as et, Tooltip as Y, Label as Qt, RadioGroup as mt, ToggleGroup as At, Separator as te, DropdownMenu as E } from "radix-ui";
import { IconX as ee, IconSearch as ae, IconCheck as gt, IconChevronRight as re } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as O, useRef as at, useCallback as H, createContext as oe, useContext as ne, useEffect as bt, useMemo as Z, Fragment as se, forwardRef as Dt } from "react";
import { cva as F } from "class-variance-authority";
import { ChevronsUpDown as Lt, Check as Rt, Star as ie, Filter as le, ArrowRight as de, Loader2 as ce, ChevronDown as ue, Search as we, X as me, AlertTriangle as fe, LoaderCircle as pe } from "lucide-react";
import { Section as K, MODIFIER_KEYS as he, normalizeProjectId as rt, getLocalizeKeyForScrollGroupId as ge, getSectionForBook as be } from "platform-bible-utils";
...
import { extendTailwindMerge as ve, twMerge as xe } from "tailwind-merge";
const ye = ve({ prefix: "tw" });
function ft(t) {
  const e = [];
  let a = "", r = 0;
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
const Ne = 600, Ma = 650, Tt = 400, ve = 450, xe = 500, ye = 550, Oa = 650, ja = 700, zt = $(
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
const Ne = 600, Ma = 650, Tt = 400, ve = 450, xe = 500, ye = 550, Oa = 700, zt = $(
========
const Ce = 600, Ka = 650, Bt = 400, Se = 450, Ee = 500, Te = 550, Ja = 700, Pt = F(
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
...
function B({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Pt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ f(ze, { children: [
    ...
    /* @__PURE__ */ f(
      $.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n($.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(B, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ee, {}),
...
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n($.Close, { asChild: !0, children: /* @__PURE__ */ n(B, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Ae({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
function jt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(De, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        X.Input,
        {
      ...
      /* @__PURE__ */ n(Re, { children: /* @__PURE__ */ n(ae, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Xt({
  ...
  return /* @__PURE__ */ n(
    Y.Trigger,
    {
      ...
      className: e ? d(Pt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], xr = ({
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], vr = ({
========
const Je = ["input", "select", "textarea", "button"], Ue = ["button", "textbox"], Tr = ({
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  ...
  const o = at(null), [s, i] = O(void 0), [l, u] = O(void 0), p = H(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || Je.includes(N)) return !0;
    const y = w.getAttribute("role");
    if (y && Ue.includes(y)) return !0;
    const v = w.getAttribute("tabindex");
    return v !== void 0 && v !== "-1";
  }, A = H(
    (w) => {
      var J;
      const N = w.target, y = (I) => I ? document.getElementById(I) : void 0, v = y(l), j = y(s);
      if (!!(v && N && v.contains(N) && N !== v) && k(N)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          if (c === -1) return;
          let m;
          w.key === "ArrowDown" ? m = Math.min(c + 1, I.length - 1) : m = Math.max(c - 1, 0), m !== c && (w.preventDefault(), w.stopPropagation(), (J = I[m]) == null || J.focus());
          return;
        }
        return;
      }
...
function We({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Zt.Provider, { value: r, children: /* @__PURE__ */ n(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
function yr({
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
...
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  ...
  return /* @__PURE__ */ f(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(re, { className: "tw:ms-auto" })
      ]
    }
  );
}
  ...
  z.useEffect(() => {
    ...
    const l = () => {
      requestAnimationFrame(() => {
        ot(i, '[tabindex]:not([tabindex="-1"])').forEach((g) => {
    ...
    const a = (r) => {
      if (e.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const o = t.current ? ot(t.current) : [], s = o.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = z.useMemo(
    ...
    (g) => {
      ...
      if (g.key === "ArrowDown" || g.key === "ArrowUp")
        g.preventDefault(), aa(w, N, g.key);
      else if (g.key === "ArrowLeft" || g.key === "ArrowRight")
        g.preventDefault(), ea(l, y, g.key);
...
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  ...
  const [W, T] = O(!1), S = at(null), L = H(
    (R) => {
      var M;
      const q = (M = t.find((V) => V.label === R)) == null ? void 0 : M.value;
      q && a(
        e.includes(q) ? e.filter((V) => V !== q) : [...e, q]
      );
    },
    [t, e, a]
  ), J = () => p || r, I = g ?? W, c = k ?? T, m = at(e);
  m.current = e;
  const [h, C] = O(e);
  bt(() => {
    I && C(m.current);
  ...
  const b = Z(() => {
    if (!w) return t;
    const R = t.filter((M) => M.starred).sort((M, V) => M.label.localeCompare(V.label)), q = t.filter((M) => !M.starred).sort((M, V) => {
      const xt = h.includes(M.value), yt = h.includes(V.value);
      return xt && !yt ? -1 : !xt && yt ? 1 : M.label.localeCompare(V.label);
    });
    return [...R, ...q];
  }, [t, h, w]), U = () => {
    a(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ n("div", { id: _, className: v, children: /* @__PURE__ */ f(Vt, { open: I, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ n(Jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Ot, { children: [
      /* @__PURE__ */ n(
        jt,
        {
          placeholder: o ?? r,
      ...
      s && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: U, children: i }),
        /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: ut, children: l })
      ] }),
      /* @__PURE__ */ n(oa, { isEnabled: N, scrollerRef: S, children: /* @__PURE__ */ f(_t, { ref: S, children: [
        /* @__PURE__ */ n($t, { children: u }),
        /* @__PURE__ */ n(Ht, { children: b.map((R) => /* @__PURE__ */ f(
          Ft,
          {
            value: R.label,
            onSelect: L,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ n(ie, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ n("div", { className: "tw:flex-grow", children: R.label }),
              R.secondaryLabel && /* @__PURE__ */ n("div", { className: "tw:text-end tw:text-muted-foreground", children: R.secondaryLabel })
            ]
          },
          R.label
        )) })
...
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  ...
  if (sa(t) || he.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || Yt[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
function Hr(t, e) {
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
...
function ca(t) {
  ...
  return t.forEach((a) => {
    const r = rt(a.projectId), o = e.get(r), s = {
  ...
  return t.projects.forEach((o) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: Tt(a, o.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: o.isDisabled === !0,
        disabledReason: o.disabledReason,
...
function ua(t, e) {
  ...
  const a = t.filter(zt).sort(tt), r = t.filter((s) => !zt(s)).sort(tt);
  if (a.length === 0)
...
function ha({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = nt(t);
  return e ? /* @__PURE__ */ n(
    it,
    {
...
function ga({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: p
  } = He(), [g, k] = O(!1), A = !!(t.language || t.languageCode), w = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = l || g, y = H(() => {
    if (w) {
      k(!0);
      return;
    }
    ...
    k(!1), p();
  }, [p]), j = /* @__PURE__ */ n(Rt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let _;
  e === "project" ? t.openGroups.length > 0 && (_ = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(it, { variant: "secondary", children: nt(L) }, L)) })) : t.scrollGroupId !== void 0 && (_ = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ha,
      {
  ...
  ), T = t.scrollGroupId !== void 0 ? nt(t.scrollGroupId) : void 0, S = t.isBoundButClosed && T ? a.boundButClosedTooltip.replace("{group}", T) : void 0;
  return /* @__PURE__ */ f(Ut, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Xt, { asChild: !0, children: W }),
    /* @__PURE__ */ f(
      Wt,
      {
        side: "top",
...
function ba({
  ...
  return /* @__PURE__ */ f(We, { children: [
    ...
    /* @__PURE__ */ f(Ze, { align: "end", className: "tw:w-56", style: { zIndex: Bt }, children: [
...
========
function Qr(t) {
  const [e, a] = O(!1), [r, o] = O(""), [s, i] = O(t.defaultGroupByOpenTabs ?? !0), [l, u] = O(!1), p = at(null), g = H((c) => {
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
    a(c), c || o("");
  }, []);
  bt(() => {
  ...
  const k = fa(t.localizedStrings), A = Z(() => t.mode === "project" ? wt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const m = [];
        if (c.forEach((b) => {
          const U = t.projects.find((ut) => ut.id === b.projectId);
          U && m.push({ project: U, scrollGroupId: b.scrollGroupId });
        }), m.length === 0) {
          const b = t.buttonPlaceholder ?? "";
          return { node: b, title: b };
        }
        ...
        const h = m.map(
          ({ project: b, scrollGroupId: U }) => U === void 0 ? b.shortName : `${b.shortName} (${nt(U)})`
        ).join(", ");
        if (m.length === 1) return { node: h, title: h };
        const C = m.length.toString();
        return {
          node: /* @__PURE__ */ f(Gt, { children: [
            /* @__PURE__ */ n(it, { variant: "muted", className: "tw:shrink-0", children: C }),
  ...
  let S;
  t.isLoading ? S = /* @__PURE__ */ n(ce, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? S = void 0 : t.mode === "project-multi" ? S = /* @__PURE__ */ n(Lt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : S = /* @__PURE__ */ n(ue, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const L = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? v : void 0, J = /* @__PURE__ */ f(
    B,
    {
    ...
    /* @__PURE__ */ n(Xt, { asChild: !0, children: /* @__PURE__ */ n(pt, { asChild: !0, children: J }) }),
    /* @__PURE__ */ n(Wt, { children: T.title })
  ] }) }) : /* @__PURE__ */ n(pt, { asChild: !0, children: J });
  return /* @__PURE__ */ f(Vt, { open: e, onOpenChange: g, children: [
    I,
    /* @__PURE__ */ n(
      Jt,
      {
        ...
        children: /* @__PURE__ */ n(It, { delayDuration: 400, children: /* @__PURE__ */ f(Ot, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: _, children: `${k.selectAll} (${y.length.toString()})` }),
            /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: W, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(_t, { children: [
            ...
            N.map((c, m) => (
              ...
              /* @__PURE__ */ f(se, { children: [
                /* @__PURE__ */ n(Ht, { heading: Na(c, k), children: c.rows.map((h) => /* @__PURE__ */ n(
                  ga,
                  {
                    row: h,
                    mode: t.mode,
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
const Xr = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
const Ur = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
========
const eo = (t, e, a) => ya(t, e).every((r) => a.includes(r));
function ka(t, e) {
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  return [
...
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
  ...
  return /* @__PURE__ */ f(Ia, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(Ca, { children: [
      /* @__PURE__ */ n(Ea, { variant: "icon", children: r ?? /* @__PURE__ */ n(fe, {}) }),
      /* @__PURE__ */ n(Ta, { children: t })
    ] }),
    a && /* @__PURE__ */ n(za, { children: /* @__PURE__ */ n(B, { onClick: () => a(), children: e }) })
  ] });
}
const Ga = Dt(({ className: t, ...e }, a) => /* @__PURE__ */ n(pe, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
<<<<<<<< HEAD:lib/platform-bible-react/dist/resizable-4-0w1we4.js
//# sourceMappingURL=resizable-4-0w1we4.js.map
|||||||| parent of c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-CPdgp7Xh.js
//# sourceMappingURL=resizable-CPdgp7Xh.js.map
========
//# sourceMappingURL=resizable-BYoZgQbJ.js.map
>>>>>>>> c0be58c2bda (PT-4430: reconcile the language filter with main's resource-picker rework):lib/platform-bible-react/dist/resizable-BYoZgQbJ.js
