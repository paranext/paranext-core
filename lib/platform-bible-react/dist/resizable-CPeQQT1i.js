...
import { Slot as ht, Dialog as $, Popover as et, Tooltip as Y, Label as te, RadioGroup as mt, ToggleGroup as Gt, Separator as ee, DropdownMenu as E } from "radix-ui";
import { IconX as ae, IconSearch as re, IconCheck as gt, IconChevronRight as oe } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as B, useRef as it, useCallback as H, createContext as ne, useContext as se, useEffect as At, useMemo as Z, Fragment as ie, forwardRef as Dt } from "react";
import { cva as F } from "class-variance-authority";
import { ChevronsUpDown as Lt, Check as Rt, Star as le, Filter as de, ArrowRight as ce, Loader2 as ue, ChevronDown as we, Search as me, X as fe, AlertTriangle as pe, LoaderCircle as he } from "lucide-react";
import { Section as K, MODIFIER_KEYS as ge, normalizeProjectId as at, getLocalizeKeyForScrollGroupId as be, getSectionForBook as Ne } from "platform-bible-utils";
...
import { extendTailwindMerge as xe, twMerge as ye } from "tailwind-merge";
const ke = xe({ prefix: "tw" });
function ft(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  ...
  }), ye(o.join(" ")).split(" ").filter(Boolean).map((u) => {
    const p = r.get(u);
    return p ? Ce(u, p) : u;
  }).join(" ");
}
const Se = 600, Ja = 650, Bt = 400, Ee = 450, Te = 500, ze = 550, Ua = 700, Pt = F(
  ...
  return /* @__PURE__ */ f(Ge, { children: [
    ...
    /* @__PURE__ */ f(
      $.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n($.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(P, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ae, {}),
...
function tr({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n($.Close, { asChild: !0, children: /* @__PURE__ */ n(P, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function jt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Le, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Be, { children: /* @__PURE__ */ n(re, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Ue = ["input", "select", "textarea", "button"], Xe = ["button", "textbox"], zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function Mr({
  ...
  return /* @__PURE__ */ f(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ n(oe, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
function Xr({
  ...
  const [W, T] = B(!1), S = it(null), L = H(
    (R) => {
      var O;
      const q = (O = t.find((V) => V.label === R)) == null ? void 0 : O.value;
      q && a(
        e.includes(q) ? e.filter((V) => V !== q) : [...e, q]
      );
    },
    [t, e, a]
  ), J = () => p || r, k = g ?? W, c = I ?? T, [m, h] = B(k), [C, b] = B(e);
  m !== k && (h(k), k && b(e));
  const U = Z(() => {
    if (!w) return t;
    const R = t.filter((O) => O.starred).sort((O, V) => O.label.localeCompare(V.label)), q = t.filter((O) => !O.starred).sort((O, V) => {
      const vt = C.includes(O.value), xt = C.includes(V.value);
      return vt && !xt ? -1 : !vt && xt ? 1 : O.label.localeCompare(V.label);
    });
    return [...R, ...q];
  }, [t, C, w]), ut = () => {
    a(t.map((R) => R.value));
  ...
  return /* @__PURE__ */ n("div", { id: _, className: v, children: /* @__PURE__ */ f(Vt, { open: k, onOpenChange: c, children: [
    ...
    /* @__PURE__ */ n(Jt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Ot, { children: [
      ...
      s && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: ut, children: i }),
        /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: Qt, children: l })
      ] }),
      /* @__PURE__ */ n(na, { isEnabled: N, scrollerRef: S, children: /* @__PURE__ */ f(_t, { ref: S, children: [
        /* @__PURE__ */ n($t, { children: u }),
        /* @__PURE__ */ n(Ht, { children: U.map((R) => /* @__PURE__ */ f(
          Ft,
          {
            value: R.label,
            onSelect: L,
            ...
            children: [
              ...
              R.starred && /* @__PURE__ */ n(le, { className: "tw:h-4 tw:w-4" }),
...
function Wr(t, e, a) {
  ...
  if (ia(t) || ge.has(t.key) || t.key === "Dead")
    return "passed";
...
function ba({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: u,
    onPointerLeave: p
  } = Fe(), [g, I] = B(!1), A = !!(t.language || t.languageCode), w = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = l || g, y = H(() => {
    if (w) {
      I(!0);
      return;
    }
  ...
  let _;
  e === "project" ? t.openGroups.length > 0 && (_ = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(st, { variant: "secondary", children: ot(L) }, L)) })) : t.scrollGroupId !== void 0 && (_ = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ga,
      {
    ...
    t.isBoundButClosed && o && /* @__PURE__ */ f(
      P,
      {
        ...
        children: [
          /* @__PURE__ */ n(ce, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  return /* @__PURE__ */ f(qe, { children: [
    /* @__PURE__ */ n(Ze, { asChild: !0, children: /* @__PURE__ */ n(
      P,
      {
        ...
        children: /* @__PURE__ */ n(de, { className: "tw:h-4 tw:w-4" })
      }
    ) }),
    /* @__PURE__ */ f(Ye, { align: "end", className: "tw:w-56", style: { zIndex: Bt }, children: [
...
function to(t) {
  ...
  const I = pa(t.localizedStrings), A = Z(() => t.mode === "project" ? wt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const h = m.map(
          ({ project: b, scrollGroupId: U }) => U === void 0 ? b.shortName : `${b.shortName} (${ot(U)})`
        ).join(", ");
  ...
  let S;
  t.isLoading ? S = /* @__PURE__ */ n(ue, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? S = void 0 : t.mode === "project-multi" ? S = /* @__PURE__ */ n(Lt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : S = /* @__PURE__ */ n(we, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
      ...
      Jt,
      {
        ...
        children: /* @__PURE__ */ n(kt, { delayDuration: 400, children: /* @__PURE__ */ f(Ot, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: _, children: `${I.selectAll} (${y.length.toString()})` }),
            /* @__PURE__ */ n(P, { variant: "ghost", size: "sm", onClick: W, children: `${I.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(_t, { children: [
            ...
            N.map((c, m) => (
              ...
              /* @__PURE__ */ f(ie, { children: [
                /* @__PURE__ */ n(Ht, { heading: va(c, I), children: c.rows.map((h) => /* @__PURE__ */ n(
                  ba,
                  {
                    row: h,
                    mode: t.mode,
...
const ao = (t, e, a) => ka(t, e).every((r) => a.includes(r));
function Ia(t, e) {
  return [
...
function so({
  ...
  return /* @__PURE__ */ f(Ca, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(Sa, { children: [
      /* @__PURE__ */ n(Ta, { variant: "icon", children: r ?? /* @__PURE__ */ n(pe, {}) }),
      /* @__PURE__ */ n(za, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Ga, { children: /* @__PURE__ */ n(P, { onClick: () => a(), children: e }) })
  ] });
}
const Aa = Dt(({ className: t, ...e }, a) => /* @__PURE__ */ n(he, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CPeQQT1i.js.map
