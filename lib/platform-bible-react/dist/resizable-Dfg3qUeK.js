...
function Te() {
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", c = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", E = "\\u200d", j = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", M = `[${l}]`, O = `${I}?`, S = `[${c}]?`, T = `(?:${E}(?:${[f, N, x].join("|")})${S + O})*`, D = S + O + T, C = `(?:${[`${f}${m}?`, m, N, x, d, M].join("|")})`;
    return new RegExp(`${j}|${h}(?=${h})|${C + D}`, "g");
  }), it;
}
var bt;
function ze() {
...
const _a = Object.fromEntries(
  Re.map((t) => [t, _.bookIdToEnglishName(t)])
);
function $a(t, e, a) {
...
const je = ["input", "select", "textarea", "button"], Oe = ["button", "textbox"], rr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const o = mt(null), [s, i] = B(void 0), [c, l] = B(void 0), d = $(
    ...
    if (f.isContentEditable || je.includes(N)) return !0;
    const x = f.getAttribute("role");
    if (x && Oe.includes(x)) return !0;
    const E = f.getAttribute("tabindex");
    return E !== void 0 && E !== "-1";
  }, I = $(
    (f) => {
      var H;
      const N = f.target, x = (C) => C ? document.getElementById(C) : void 0, E = x(c), j = x(s);
...
function aa({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    h(!1), d();
  }, [d]), j = /* @__PURE__ */ n(zt, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let M;
  ...
  return /* @__PURE__ */ g(Ht, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ft, { asChild: !0, children: O }),
    /* @__PURE__ */ g(
      Jt,
      {
        side: "top",
      ...
      $t,
      {
        ...
        children: /* @__PURE__ */ n(vt, { delayDuration: 400, children: /* @__PURE__ */ g(At, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            ...
            /* @__PURE__ */ n(L, { variant: "ghost", size: "sm", onClick: O, children: `${h.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ g(Mt, { children: [
            ...
            N.map((u, p) => (
              ...
              /* @__PURE__ */ g(ae, { children: [
                /* @__PURE__ */ n(jt, { heading: oa(u, h), children: u.rows.map((b) => /* @__PURE__ */ n(
                  aa,
                  {
                    row: b,
                    mode: t.mode,
...
========
//# sourceMappingURL=resizable-Dfg3qUeK.js.map
>>>>>>>> 292b960c5e6 (refactor: move ALL_BOOK_IDS into platform-bible-utils (PT-4275)):lib/platform-bible-react/dist/resizable-Dfg3qUeK.js
