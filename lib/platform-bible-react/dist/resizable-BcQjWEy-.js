...
import D, { useState as $, useRef as ht, useCallback as F, createContext as ae, useContext as re, useMemo as X, useEffect as oe, Fragment as ne, forwardRef as Dt } from "react";
...
function pa({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: c
  } = Pe(), [m, h] = $(!1), k = !!(t.language || t.languageCode), f = k || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = d || m, x = F(() => {
    if (f) {
      h(!0);
      return;
    }
...
function Kr(t) {
  ...
  const A = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? I : void 0, H = /* @__PURE__ */ g(
    ...
    /* @__PURE__ */ n(Vt, { asChild: !0, children: /* @__PURE__ */ n(ft, { asChild: !0, children: H }) }),
...
//# sourceMappingURL=resizable-BcQjWEy-.js.map
