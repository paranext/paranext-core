...
import { IconX as de, IconCheck as yt, IconSearch as ce, IconChevronLeft as ue, IconChevronRight as we } from "@tabler/icons-react";
...
function Vt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Me, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Ue, { children: /* @__PURE__ */ n(ce, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function qr({
  ...
  return /* @__PURE__ */ m(
    C.SubTrigger,
    {
      ...
      children: [
        a,
        s === "rtl" ? /* @__PURE__ */ n(ue, { className: "tw:ms-auto" }) : /* @__PURE__ */ n(we, { className: "tw:ms-auto" })
      ]
    }
  );
}
    ...
    (w) => {
      ...
      if (!!(b && g && b.contains(g) && g !== b) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const M = y.findIndex((P) => P === g);
          if (M === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(M + 1, y.length - 1) : S = Math.max(M - 1, 0), S !== M && (w.preventDefault(), w.stopPropagation(), (_ = y[S]) == null || _.focus());
          return;
        }
        return;
      }
...
function Eo(t) {
  ...
  const y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, M = /* @__PURE__ */ m(
    H,
    {
      ref: $,
  ...
  ), S = B.title ? /* @__PURE__ */ n(At, { delayDuration: 400, children: /* @__PURE__ */ m(It, { children: [
    /* @__PURE__ */ n(Et, { asChild: !0, children: /* @__PURE__ */ n(Nt, { asChild: !0, children: M }) }),
    /* @__PURE__ */ n(_t, { children: B.title })
          ...
          /* @__PURE__ */ m(Xt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Wt, { heading: La(c, s), children: c.rows.map((T) => {
                      var I;
                      return /* @__PURE__ */ n(
                        Ga,
                        {
...
//# sourceMappingURL=resizable-CKuMD-fd.js.map
