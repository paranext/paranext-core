...
import { Slot as ut, Dialog as M, Popover as q, Tooltip as X, Label as Jt, RadioGroup as lt, ToggleGroup as kt, Separator as Ut, DropdownMenu as S } from "radix-ui";
import { IconX as Xt, IconSearch as Wt, IconCheck as wt, IconChevronRight as Zt } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as j, useRef as mt, useCallback as _, createContext as qt, useContext as Yt, useMemo as U, useEffect as Qt, Fragment as te, forwardRef as Ct } from "react";
...
const Ne = 600, Oa = 650, Tt = 400, ve = 450, xe = 500, ye = 550, Ma = 650, ja = 700, _a = 800, zt = $(
...
const _e = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function da({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: g
  } = Be(), [b, k] = j(!1), A = !!(t.language || t.languageCode), m = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, I = _(() => {
    if (m) {
      k(!0);
      return;
    }
...
const Wr = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
  return [
...
//# sourceMappingURL=resizable-5NEfrGIS.js.map
