import { jsx as o, jsxs as p, Fragment as Se } from "react/jsx-runtime";
import { Slot as Tt, Dialog as Z, Separator as ke, Popover as ut, Tooltip as ot, DropdownMenu as T, Label as Ie, RadioGroup as yt, ToggleGroup as Xt } from "radix-ui";
import { IconX as Ee, IconCheck as _t, IconSearch as Te, IconChevronRight as _e } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import L, { useState as q, useRef as ht, useCallback as J, createContext as Ce, useContext as Le, useMemo as Q, useEffect as Bt, Fragment as Ge, forwardRef as qt } from "react";
import { ChevronsUpDown as Zt, Check as Wt, Star as je, Group as Ae, ArrowRight as ze, Loader2 as Re, ChevronDown as De, Search as Pe, X as Be, AlertTriangle as Oe, LoaderCircle as Me } from "lucide-react";
import { Section as et, MODIFIER_KEYS as He, normalizeProjectId as M, compareProjectsByName as Ue, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as Yt, getLocalizeKeyForScrollGroupId as $e, hasDistinctFullName as Ke, getSectionForBook as Fe } from "platform-bible-utils";
...
const Qt = 600, te = 650, yr = 400, Ye = 450, Qe = 500, Sr = 510, kr = 520, ta = 675, Ir = 690, Er = 700, Tr = 800, ee = tt(
...
function U() {
  var t;
  try {
    const e = (t = re()) == null ? void 0 : t.getItem(ae);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function jr({
  ...
  return /* @__PURE__ */ p(ea, { children: [
    /* @__PURE__ */ o(aa, { className: r, style: n }),
    /* @__PURE__ */ p(
      Z.Content,
      {
...
function ne({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(oa, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        rt.Input,
        {
      ...
      /* @__PURE__ */ o(sa, { children: /* @__PURE__ */ o(Te, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Vr = Object.fromEntries(
  da.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Jr(t, e, a) {
...
const Xr = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const ue = L.createContext(null);
function ro({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ o(ue.Provider, { value: t, children: e });
}
function we({
  className: t,
  align: e = "center",
...
function ba({ variant: t = "default", ...e }) {
  const a = U(), r = L.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ o(me.Provider, { value: r, children: /* @__PURE__ */ o(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function lo({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ o(
          "span",
          {
            ...
            children: /* @__PURE__ */ o(T.ItemIndicator, { children: /* @__PURE__ */ o(_t, {}) })
          }
        ),
        e
      ]
...
function fo({
  ...
  return /* @__PURE__ */ p(
    T.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(_e, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const Ia = ["input", "select", "textarea", "button"], Ea = ["button", "textbox"], ko = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
    ...
    (w) => {
      ...
      if (!!(h && g && h.contains(g) && g !== h) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const V = y.findIndex((j) => j === g);
          if (V === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(V + 1, y.length - 1) : S = Math.max(V - 1, 0), S !== V && (w.preventDefault(), w.stopPropagation(), (P = y[S]) == null || P.focus());
          return;
        }
        return;
      }
      ...
      switch (w.key) {
        case "ArrowDown":
          D = Math.min(W + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          D = Math.max(W - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function gt({ className: t, variant: e = "default", asChild: a = !1, ...r }) {
...
function zo({
  ...
  const [$, K] = q(!1), F = J(
    (S) => {
      var B;
      const j = (B = t.find((E) => E.label === S)) == null ? void 0 : B.value;
      j && a(
        e.includes(j) ? e.filter((E) => E !== j) : [...e, j]
      );
    },
    [t, e, a]
  ), W = () => u || r, D = Q(() => {
    if (!I) return t;
    const S = t.filter((B) => B.starred).sort((B, E) => B.label.localeCompare(E.label)), j = t.filter((B) => !B.starred).sort((B, E) => {
      const st = e.includes(B.value), it = e.includes(E.value);
      return st && !it ? -1 : !st && it ? 1 : B.label.localeCompare(E.label);
    });
    return [...S, ...j];
  }, [t, e, I]), Y = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(ce, { open: y, onOpenChange: f ?? K, children: [
    ...
    /* @__PURE__ */ o(we, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(oe, { children: [
      /* @__PURE__ */ o(
        ne,
        {
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ o(X, { variant: "ghost", size: "sm", onClick: P, children: i })
      ] }),
      /* @__PURE__ */ p(se, { children: [
        /* @__PURE__ */ o(ie, { children: l }),
        /* @__PURE__ */ o(le, { children: D.map((S) => /* @__PURE__ */ p(
          Lt,
          {
            value: S.label,
            onSelect: F,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(je, { className: "tw:h-4 tw:w-4" }),
...
function Ro(t, e, a) {
  ...
  if (ja(t) || He.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (O(t), a.dismiss(), "ended") : (O(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (O(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (O(t), a.dismiss(), "ended") : t.key === "Backspace" || he[r].test(t.key) ? (O(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && O(t), a.dismiss(), "ended");
}
function Do(t, e) {
  var a;
...
function Ha(t) {
  ...
  return [
    ge(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[dt.lastUsedAt]) == "number" ? mt : Ma;
      },
...
const Jt = "platform.footerAction", Fa = {
...
function Va({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = pt(t);
  return e ? /* @__PURE__ */ o(
    gt,
    {
  ...
  ) : /* @__PURE__ */ o(gt, { variant: "secondary", children: a });
}
function Ja({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = ga(), [I, w] = q(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  let F;
  e === "project" ? t.openGroups.length > 0 && (F = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((P) => /* @__PURE__ */ o(gt, { variant: "secondary", children: pt(P) }, P)) })) : t.scrollGroupId !== void 0 && (F = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Va,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ o(ze, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              Ke(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        F
  ...
  ), D = t.scrollGroupId !== void 0 ? pt(t.scrollGroupId) : void 0, Y = t.isBoundButClosed && D ? a.boundButClosedTooltip.replace("{group}", D) : void 0;
  return /* @__PURE__ */ p(jt, { open: v, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      zt,
      {
        ...
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", dir: "auto", children: Yt(t) }),
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && D && /* @__PURE__ */ p("div", { className: "tw:text-sm", children: [
...
function Xa({
  ...
  return /* @__PURE__ */ p(ba, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ o(At, { asChild: !0, children: /* @__PURE__ */ o(Na, { asChild: !0, children: /* @__PURE__ */ o(
        X,
        {
          variant: "ghost",
          size: "sm",
          ...
          children: /* @__PURE__ */ o(Ae, { className: "tw:h-4 tw:w-4" })
        }
      ) }) }),
    ...
    /* @__PURE__ */ p(
      va,
      {
        ...
        style: { zIndex: te },
        children: [
          /* @__PURE__ */ o(ya, { children: r.groupSectionLabel }),
...
function Fo(t) {
  const [e, a] = q(!1), [r, n] = q(""), s = Q(() => Ka(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
  ...
  const v = Q(() => t.mode === "project" ? xt({
    ...
    [F]
  ), D = !!F, Y = !!t.footerAction && h.length === 0, P = Q(() => {
    if (f === nt) return Et(h);
    const c = i.find((b) => b.id === f);
    return c ? Oa(h, c) : Et(h);
  }, [h, f, i]), y = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, A = M(c.projectId), H = (R) => M(R.projectId) === A && R.scrollGroupId === c.scrollGroupId, z = b.some(H) ? b.filter((R) => !H(R)) : [
          ...b.filter((R) => !H(R)),
  ...
  }, j = t.mode === "project" ? t.renderTriggerLabel : void 0, B = t.mode === "project" ? t.triggerLabelFormat : void 0, E = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = K(t.selection.projectId);
        if (j)
          return { node: j(c), title: "", hasSelection: !!c };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && B === "shortNameAndFullName" && (b = Yt(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((z) => {
          const R = K(z.projectId);
          R && b.push({ project: R, scrollGroupId: z.scrollGroupId });
        }), b.length === 0) {
          const z = s.buttonPlaceholder;
          return { node: z, title: z, hasSelection: !1 };
        }
        const A = b.map(
          ({ project: z, scrollGroupId: R }) => R === void 0 ? z.shortName : `${z.shortName} (${pt(R)})`
        ).join(", "), H = b.length.toString();
        return {
          node: /* @__PURE__ */ p(Se, { children: [
            /* @__PURE__ */ o(gt, { variant: "muted", className: "tw:shrink-0", children: H }),
  ...
  Bt(() => {
    ...
    const A = new ResizeObserver((H) => {
      H.forEach((z) => {
        const [R] = z.borderBoxSize;
        b(R ? R.inlineSize : c.getBoundingClientRect().width);
      });
    });
    return A.observe(c, { box: "border-box" }), () => A.disconnect();
  }, []);
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ o(Re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ o(Zt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ o(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Ne = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, ve = s.ariaLabel && E.hasSelection && E.title ? `${s.ariaLabel}: ${E.accessibleTitle ?? E.title}` : s.ariaLabel || void 0, Pt = /* @__PURE__ */ p(
    X,
    {
      ref: st,
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof E.node == "string" ? /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", dir: "auto", children: E.node }) : E.node }),
        lt
      ]
    }
  ), xe = E.title ? /* @__PURE__ */ o($t, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ o(At, { asChild: !0, children: /* @__PURE__ */ o(It, { asChild: !0, children: Pt }) }),
    /* @__PURE__ */ o(zt, { dir: "auto", children: E.title })
  ] }) }) : /* @__PURE__ */ o(It, { asChild: !0, children: Pt }), ye = i.length > 1;
  return /* @__PURE__ */ p(ce, { open: e, onOpenChange: g, children: [
    xe,
    /* @__PURE__ */ o(
      we,
      {
        ...
        children: /* @__PURE__ */ o($t, { delayDuration: 400, children: /* @__PURE__ */ p(
          oe,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p(se, { children: [
                /* @__PURE__ */ o(ie, { children: s.commandEmptyMessage }),
                P.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(le, { heading: Za(c, s), children: c.rows.map((A) => /* @__PURE__ */ o(
                          Ja,
                          {
                            row: A,
                            mode: t.mode,
                        ...
                        b < P.length - 1 && /* @__PURE__ */ o(Mt, { alwaysRender: !0 })
                      ]
                    },
...
const Jo = (t, e, a) => Qa(t, e).every((r) => a.includes(r));
function tr(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, n) => G.bookIdToNumber(r) - G.bookIdToNumber(n)).map((r) => wa(r, e));
}
function Xo(t, e, a, r) {
...
function qo({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function Wo({
  ...
  return /* @__PURE__ */ p(er, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(ar, { children: [
      /* @__PURE__ */ o(or, { variant: "icon", children: r ?? /* @__PURE__ */ o(Oe, {}) }),
      /* @__PURE__ */ o(nr, { children: t })
    ] }),
    a && /* @__PURE__ */ o(sr, { children: /* @__PURE__ */ o(X, { onClick: () => a(), children: e }) })
  ] });
}
const ir = qt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Me, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
ir.displayName = "Spinner";
const lr = tt(
...
//# sourceMappingURL=resizable-SDHmUfye.js.map
