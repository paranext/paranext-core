...
import { Slot as wt, Dialog as P, Popover as W, Label as Kt, RadioGroup as dt, Tooltip as U, ToggleGroup as Et, Separator as Ut, DropdownMenu as z } from "radix-ui";
...
import G, { useRef as mt, useState as B, useCallback as $, createContext as Qt, useContext as te, useMemo as K, useEffect as ee, Fragment as ae, forwardRef as St } from "react";
...
function _e({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Xt.Provider, { value: r, children: /* @__PURE__ */ n(z.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function or({
  ...t
}) {
...
//# sourceMappingURL=resizable-BXTCesWU.js.map
