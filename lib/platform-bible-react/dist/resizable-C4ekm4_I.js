...
import { Slot as It, Dialog as V, Separator as ge, Popover as it, Tooltip as at, DropdownMenu as _, Label as be, RadioGroup as vt, ToggleGroup as Kt } from "radix-ui";
import { IconX as Ne, IconCheck as Et, IconSearch as ve, IconChevronRight as xe } from "@tabler/icons-react";
import { Canon as j } from "@sillsdev/scripture";
import { cva as W } from "class-variance-authority";
import C, { useState as K, useRef as pt, useCallback as q, createContext as ye, useContext as Se, useMemo as Q, useEffect as Rt, Fragment as ke, forwardRef as Vt } from "react";
import { ChevronsUpDown as Jt, Check as Xt, Star as Ie, Group as Ee, ArrowRight as _e, Loader2 as Te, ChevronDown as Ce, Search as je, X as Ge, AlertTriangle as ze, LoaderCircle as Le } from "lucide-react";
import { Section as Y, MODIFIER_KEYS as Ae, normalizeProjectId as P, compareProjectsByName as Re, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as nt, formatProjectName as qt, getLocalizeKeyForScrollGroupId as De, hasDistinctFullName as Pe, getSectionForBook as Oe } from "platform-bible-utils";
...
import { extendTailwindMerge as Me, twMerge as He } from "tailwind-merge";
const Ue = Me({ prefix: "tw" });
function xt(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  ...
  }), He(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = r.get(u);
    return m ? Fe(u, m) : u;
  }).join(" ");
}
const Wt = 600, Zt = 650, fr = 400, Ke = 450, Ve = 500, Je = 675, hr = 690, gr = 700, br = 800, Yt = W(
...
function ae({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(Ze, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        et.Input,
        {
      ...
      /* @__PURE__ */ o(Qe, { children: /* @__PURE__ */ o(ve, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const ta = [
  ...
  var e;
  return ((e = ta[t]) == null ? void 0 : e.chapters) ?? -1;
}, aa = j.allBookIds.filter(
...
const Pr = Object.fromEntries(
  aa.map((t) => [t, j.bookIdToEnglishName(t)])
);
function Or(t, e, a) {
...
function lt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && sa(r)
  );
}
...
function Xr({
  ...
  return /* @__PURE__ */ o(le.Provider, { value: t, children: e });
}
function de({
  className: t,
  align: e = "center",
...
function ca({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(ce.Provider, { value: r, children: /* @__PURE__ */ o(_.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Qr({
  ...t
}) {
...
function ma({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ o(
    _.Label,
    {
...
function no({
  ...
  return /* @__PURE__ */ p(
    _.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(xe, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ga = ["input", "select", "textarea", "button"], ba = ["button", "textbox"], fo = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
  ...
  const n = pt(null), [s, i] = K(void 0), [l, u] = K(void 0), m = q(
    ...
    if (x && ba.includes(x)) return !0;
    const h = w.getAttribute("tabindex");
    return h !== void 0 && h !== "-1";
  }, I = q(
    (w) => {
      var R;
      const g = w.target, x = (N) => N ? document.getElementById(N) : void 0, h = x(l), $ = x(s);
      if (!!(h && g && h.contains(g) && g !== h) && k(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const N = t.find((B) => B.id === l);
            N && m(N.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const B = N.findIndex((O) => O === g);
          if (B === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(B + 1, N.length - 1) : S = Math.max(B - 1, 0), S !== B && (w.preventDefault(), w.stopPropagation(), (R = N[S]) == null || R.focus());
          return;
        }
        return;
      }
      const X = t.findIndex((N) => N.id === s);
      let A = X;
      switch (w.key) {
        case "ArrowDown":
          A = Math.min(X + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max(X - 1, 0), w.preventDefault();
          break;
        case "Home":
  ...
  const l = C.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), ya(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), xa(l, x, f.key);
...
function Io({
  ...
  const [$, J] = K(!1), Z = q(
    ...
    const S = t.filter((E) => E.starred).sort((E, F) => E.label.localeCompare(F.label)), O = t.filter((E) => !E.starred).sort((E, F) => {
      const ct = e.includes(E.value), ot = e.includes(F.value);
      return ct && !ot ? -1 : !ct && ot ? 1 : E.label.localeCompare(F.label);
    });
    return [...S, ...O];
  }, [t, e, I]), H = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(ie, { open: N, onOpenChange: f ?? J, children: [
    ...
    /* @__PURE__ */ o(de, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ee, { children: [
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
      /* @__PURE__ */ p(re, { children: [
        /* @__PURE__ */ o(oe, { children: l }),
        /* @__PURE__ */ o(ne, { children: A.map((S) => /* @__PURE__ */ p(
          Tt,
          {
            value: S.label,
            onSelect: Z,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(Ie, { className: "tw:h-4 tw:w-4" }),
...
function Eo(t, e, a) {
  ...
  if (ka(t) || Ae.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || we[r].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && D(t), a.dismiss(), "ended");
}
function _o(t, e) {
  var a;
...
function La(t) {
  ...
  return [
    pe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[nt.lastUsedAt]) == "number" ? ut : za;
      },
...
function Ma({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = da(), [I, w] = K(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, x = m || I, h = q(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  let Z;
  e === "project" ? t.openGroups.length > 0 && (Z = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ o(mt, { variant: "secondary", children: dt(R) }, R)) })) : t.scrollGroupId !== void 0 && (Z = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Ba,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      U,
      {
        ...
        children: [
          /* @__PURE__ */ o(_e, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              Pe(t) && /* @__PURE__ */ o("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        Z
  ...
  ), A = t.scrollGroupId !== void 0 ? dt(t.scrollGroupId) : void 0, H = t.isBoundButClosed && A ? a.boundButClosedTooltip.replace("{group}", A) : void 0;
  return /* @__PURE__ */ p(jt, { open: x, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ p(
      zt,
      {
        ...
        children: [
          /* @__PURE__ */ o("div", { className: "tw:font-semibold", dir: "auto", children: qt(t) }),
...
function Ha({
  ...
  const n = e !== rt;
  return /* @__PURE__ */ p(ca, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(ua, { asChild: !0, children: /* @__PURE__ */ o(
        U,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      wa,
      {
        ...
        style: { zIndex: Zt },
        children: [
          /* @__PURE__ */ o(ma, { children: r.groupSectionLabel }),
          /* @__PURE__ */ p(pa, { value: e, onValueChange: a, children: [
...
function Do(t) {
  const [e, a] = K(!1), [r, n] = K(""), s = Pa(t.localizedStrings), i = Q(() => {
  ...
  const x = Q(() => t.mode === "project" ? bt({
  ...
  }, [x, r]), $ = !!t.footerAction && h.length === 0, J = Q(() => {
    if (f === rt) return kt(h);
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, G = P(c.projectId), T = (L) => P(L.projectId) === G && L.scrollGroupId === c.scrollGroupId, z = b.some(T) ? b.filter((L) => !T(L)) : [
          ...b.filter((L) => !T(L)),
  ...
  }, H = t.mode === "project" ? t.renderTriggerLabel : void 0, R = t.mode === "project" ? t.triggerLabelFormat : void 0, N = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = Nt(t.projects, t.selection.projectId);
        if (H)
          return { node: H(c), title: "", hasSelection: !!c };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && R === "shortNameAndFullName" && (b = qt(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
        const { pairs: c } = t.selection;
        if (c.length === 0) {
          const z = s.buttonPlaceholder;
          return { node: z, title: z, hasSelection: !1 };
        }
        const b = [];
        if (c.forEach((z) => {
        ...
        return {
          node: /* @__PURE__ */ p(he, { children: [
            /* @__PURE__ */ o(mt, { variant: "muted", className: "tw:shrink-0", children: T }),
            /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", children: G })
          ] }),
          title: `${T} ${G}`,
          hasSelection: !0
        };
      ...
      case "projectScrollGroup": {
        ...
        if (!c) {
          ...
          return { node: T, title: T, hasSelection: !1 };
        }
  ...
  Rt(() => {
    ...
    return G.observe(c, { box: "border-box" }), () => G.disconnect();
  }, []);
  let E;
  t.isLoading ? E = /* @__PURE__ */ o(Te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : S ? E = void 0 : t.mode === "project-multi" ? E = /* @__PURE__ */ o(Jt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : E = /* @__PURE__ */ o(Ce, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const F = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? Z : void 0, ct = s.ariaLabel && N.hasSelection && N.title ? `${s.ariaLabel}: ${N.accessibleTitle ?? N.title}` : s.ariaLabel || void 0, ot = /* @__PURE__ */ p(
    U,
    {
      ref: B,
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof N.node == "string" ? /* @__PURE__ */ o("span", { className: "tw:min-w-0 tw:truncate", dir: "auto", children: N.node }) : N.node }),
        E
      ]
    }
  ), me = N.title ? /* @__PURE__ */ o(Mt, { delayDuration: 400, children: /* @__PURE__ */ p(jt, { children: [
    /* @__PURE__ */ o(Gt, { asChild: !0, children: /* @__PURE__ */ o(St, { asChild: !0, children: ot }) }),
    /* @__PURE__ */ o(zt, { dir: "auto", children: N.title })
  ] }) }) : /* @__PURE__ */ o(St, { asChild: !0, children: ot }), fe = i.length > 1;
  return /* @__PURE__ */ p(ie, { open: e, onOpenChange: g, children: [
    me,
    /* @__PURE__ */ o(
      de,
      {
        ...
        children: /* @__PURE__ */ o(Mt, { delayDuration: 400, children: /* @__PURE__ */ p(
          ee,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ o(U, { variant: "ghost", size: "sm", onClick: A, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(re, { children: [
                /* @__PURE__ */ o(oe, { children: s.commandEmptyMessage }),
                J.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(ne, { heading: $a(c, s), children: c.rows.map((G) => {
                          var T;
                          return /* @__PURE__ */ o(
                            Ma,
                            {
                              ...
                              onOpen: F,
                              selectedRowRef: k,
                              indicator: (T = t.renderProjectIndicator) == null ? void 0 : T.call(t, G.project),
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            U,
            {
              ...
              children: [
                /* @__PURE__ */ o(Ge, { className: "tw:h-4 tw:w-4" }),
...
const Oo = (t, e, a) => Va(t, e).every((r) => a.includes(r));
function Ja(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => j.bookIdToNumber(r) > 0).sort((r, n) => j.bookIdToNumber(r) - j.bookIdToNumber(n)).map((r) => na(r, e));
}
function Bo(t, e, a, r) {
...
function Uo({
  ...
  return /* @__PURE__ */ p(Xa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(qa, { children: [
      /* @__PURE__ */ o(Za, { variant: "icon", children: r ?? /* @__PURE__ */ o(ze, {}) }),
      /* @__PURE__ */ o(Ya, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Qa, { children: /* @__PURE__ */ o(U, { onClick: () => a(), children: e }) })
  ] });
}
const tr = Vt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Le, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C4ekm4_I.js.map
