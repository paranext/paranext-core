import { jsx as n, jsxs as f, Fragment as qt } from "react/jsx-runtime";
import { Slot as ht, Dialog as M, Separator as Yt, Popover as tt, Tooltip as q, DropdownMenu as z, Label as Qt, RadioGroup as wt, ToggleGroup as Et } from "radix-ui";
...
import { Section as F, MODIFIER_KEYS as fe, normalizeProjectId as et, getLocalizeKeyForScrollGroupId as he, getSectionForBook as ge } from "platform-bible-utils";
...
function Se(t, e) {
  ...
  const a = pt(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), o = a[a.length - 1], s = pt(e), i = s.some((u) => u.startsWith("-tw-")), d = s.some((u) => u.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const u = o.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
function c(...t) {
  ...
  }), ve(o.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = r.get(u);
    return m ? Se(u, m) : u;
  }).join(" ");
}
const Gt = 600, jt = 650, Xa = 400, ke = 450, Ie = 500, _e = 675, Wa = 690, Za = 700, qa = 800, Lt = K(
...
function B({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(Lt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
  ...
  return /* @__PURE__ */ f(Ee, { children: [
    ...
    /* @__PURE__ */ f(
      M.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(M.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(B, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(te, {}),
...
function or({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(M.Close, { asChild: !0, children: /* @__PURE__ */ n(B, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Dt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(ze, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        X.Input,
        {
      ...
      /* @__PURE__ */ n(je, { children: /* @__PURE__ */ n(ee, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function gr(t, e, a) {
  ...
  if (!r) return !1;
  const o = L.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function at(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (r) => !r.hasAttribute("disabled") && !r.getAttribute("aria-hidden") && Me(r)
  );
}
const br = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
function He({
  className: t,
...
function Ht({ ...t }) {
  return /* @__PURE__ */ n(tt.Root, { "data-slot": "popover", ...t });
}
function mt({ ...t }) {
  return /* @__PURE__ */ n(tt.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function yr({
  ...
  return /* @__PURE__ */ n($t.Provider, { value: t, children: e });
}
function Ut({
  className: t,
  align: e = "center",
  ...
  const s = R(), i = j.useContext($t);
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ n(tt.Portal, { container: i ?? void 0, children: /* @__PURE__ */ n(
      tt.Content,
      {
...
function Sr({ ...t }) {
  return /* @__PURE__ */ n(tt.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function Ft({
  ...
  return /* @__PURE__ */ n(
    q.Trigger,
    {
      ...
      className: e ? c(Lt({ variant: e }), t) : t,
      ...a
    }
  );
}
function Vt({
  ...
  return /* @__PURE__ */ n(q.Portal, { children: /* @__PURE__ */ f(
    q.Content,
    {
...
function Ke({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Jt.Provider, { value: r, children: /* @__PURE__ */ n(z.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Er({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(z.ItemIndicator, { children: /* @__PURE__ */ n(gt, {}) })
          }
        ),
        e
      ]
...
function Xe({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ n(
    z.Label,
    {
...
const qe = ["input", "select", "textarea", "button"], Ye = ["button", "textbox"], $r = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = st(null), [s, i] = $(void 0), [d, u] = $(void 0), m = U(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || qe.includes(b)) return !0;
    const y = w.getAttribute("role");
    if (y && Ye.includes(y)) return !0;
    ...
    (w) => {
      ...
      if (!!(g && b && g.contains(b) && b !== g) && k(b)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          if (D === -1) return;
          let l;
          w.key === "ArrowDown" ? l = Math.min(D + 1, I.length - 1) : l = Math.max(D - 1, 0), l !== D && (w.preventDefault(), w.stopPropagation(), (V = I[l]) == null || V.focus());
          return;
        }
        return;
      }
      ...
      switch (w.key) {
        case "ArrowDown":
          _ = Math.min(O + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          _ = Math.max(O - 1, 0), w.preventDefault();
          break;
        case "Home":
    ...
    const a = (r) => {
      if (e.contains(document.activeElement)) {
        if (r.key === "ArrowRight" || r.key === "ArrowLeft") {
          ...
          const o = t.current ? at(t.current) : [], s = o.indexOf(document.activeElement), i = r.key === "ArrowRight" ? s + 1 : s - 1;
...
function Yr({
  ...
  return /* @__PURE__ */ n("div", { id: g, className: b, children: /* @__PURE__ */ f(Ht, { open: I, onOpenChange: h ?? H, children: [
    /* @__PURE__ */ n(mt, { asChild: !0, children: /* @__PURE__ */ f(
      B,
      {
        variant: y,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ n(Ct, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(Ut, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(Rt, { children: [
      /* @__PURE__ */ n(
        Dt,
        {
      ...
      o && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: W, children: s }),
        /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: V, children: i })
      ] }),
      /* @__PURE__ */ f(Bt, { children: [
        /* @__PURE__ */ n(Pt, { children: d }),
        /* @__PURE__ */ n(Ot, { children: _.map((l) => /* @__PURE__ */ f(
          Mt,
          {
            value: l.label,
            onSelect: P,
            ...
            children: [
              ...
              l.starred && /* @__PURE__ */ n(se, { className: "tw:h-4 tw:w-4" }),
              /* @__PURE__ */ n("div", { className: "tw:flex-grow", children: l.label }),
              l.secondaryLabel && /* @__PURE__ */ n("div", { className: "tw:text-end tw:text-muted-foreground", children: l.secondaryLabel })
            ]
          },
          l.label
        )) })
...
function ra(t, e, a) {
  if (!e) return [...t];
  const r = [...t], o = Y(e).toLowerCase();
  return a === "passive" ? xt({
    query: o,
    items: r,
    filter: (s) => Y(s.label).toLowerCase().startsWith(o),
    sortBy: "label"
  }) : xt({
    query: o,
    items: r,
    filter: (s) => Y(s.label).toLowerCase().includes(o),
    sortBy: "label"
  });
}
function oa(t) {
...
function Qr(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (A(t), a.dismiss(), "ended") : (A(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (A(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (A(t), a.dismiss(), "ended") : t.key === "Backspace" || Wt[r].test(t.key) ? (A(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && A(t), a.dismiss(), "ended");
}
function to(t, e) {
  var a;
...
function eo(t) {
  ...
  o.current += 1;
  const w = o.current, b = a ? "backslash" : "selection", y = { kind: b, token: w, filter: "", items: e };
...
function la(t) {
  ...
  return t.forEach((a) => {
    const r = et(a.projectId), o = e.get(r), s = {
...
function da(t) {
  const e = t.filter(_t).sort(J), a = t.filter((o) => !_t(o)).sort(J);
  if (e.length === 0)
...
function ca(t, e) {
  const a = t.filter((i) => i.isSelected).sort(J), r = t.filter((i) => !i.isSelected).sort(J), o = (i, d) => {
    var m;
  ...
  return [
    ...
    },
    {
      ...
      getSectionHeading: (a, r) => {
        ...
        }), s = (i = o == null ? void 0 : o.customData) == null ? void 0 : i.typeName;
...
function Na({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ref: i,
    open: d,
    onPointerEnter: u,
    onPointerLeave: m
  } = Ue(), [h, k] = $(!1), E = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = d || h, b = U(() => {
    if (E) {
      k(!0);
      return;
    }
    ...
    k(!1), m();
  }, [m]), g = /* @__PURE__ */ n(zt, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let G;
  e === "project" ? t.openGroups.length > 0 && (G = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((_) => /* @__PURE__ */ n(it, { variant: "secondary", children: rt(_) }, _)) })) : t.scrollGroupId !== void 0 && (G = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ba,
      {
  ...
  const H = /* @__PURE__ */ f(
    Mt,
    {
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: g }),
        /* @__PURE__ */ f(
          "span",
          {
            ref: i,
  ...
  ), P = t.scrollGroupId !== void 0 ? rt(t.scrollGroupId) : void 0, O = t.isBoundButClosed && P ? a.boundButClosedTooltip.replace("{group}", P) : void 0;
  return /* @__PURE__ */ f(Kt, { open: w, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ft, { asChild: !0, children: H }),
    /* @__PURE__ */ f(
      Vt,
      {
        side: "top",
        ...
        children: [
          ...
          O && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: O }),
  ...
  return /* @__PURE__ */ f(Ke, { children: [
    ...
    /* @__PURE__ */ f(
      Ve,
      {
        ...
        style: { zIndex: jt },
        children: [
          /* @__PURE__ */ n(Xe, { children: r.groupSectionLabel }),
          /* @__PURE__ */ f(Je, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(kt, { value: Q, children: r.groupByNone }),
            /* @__PURE__ */ n(We, {}),
            t.map((o) => /* @__PURE__ */ n(kt, { value: o.id, children: o.label }, o.id))
          ] })
        ]
      }
    )
...
function uo(t) {
  const [e, a] = $(!1), [r, o] = $(""), s = ha(t.localizedStrings), i = Z(() => {
  ...
  const k = Z(() => t.mode === "project" ? ut({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), E = Z(() => {
      ...
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ f(qt, { children: [
            /* @__PURE__ */ n(it, { variant: "muted", className: "tw:shrink-0", children: S }),
            /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: N })
          ] }),
          title: `${S} ${N}`
        };
      }
  ...
  }, [t, s.buttonPlaceholder]), H = st(null), [P, O] = $(!1);
  vt(() => {
    const l = H.current;
    if (!l) return;
    const p = (S) => {
    ...
    if (p(l.getBoundingClientRect().width), typeof ResizeObserver > "u") return;
  ...
  let _;
  t.isLoading ? _ = /* @__PURE__ */ n(de, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : P ? _ = void 0 : t.mode === "project-multi" ? _ = /* @__PURE__ */ n(Ct, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : _ = /* @__PURE__ */ n(ce, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const W = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, V = /* @__PURE__ */ f(
    B,
    {
      ref: H,
  ...
  ), I = G.title ? /* @__PURE__ */ n(St, { delayDuration: 400, children: /* @__PURE__ */ f(Kt, { children: [
    /* @__PURE__ */ n(Ft, { asChild: !0, children: /* @__PURE__ */ n(mt, { asChild: !0, children: V }) }),
    /* @__PURE__ */ n(Vt, { children: G.title })
  ] }) }) : /* @__PURE__ */ n(mt, { asChild: !0, children: V }), D = i.length > 1;
  return /* @__PURE__ */ f(Ht, { open: e, onOpenChange: h, children: [
    I,
    /* @__PURE__ */ n(
      Ut,
      {
        ...
        children: /* @__PURE__ */ n(St, { delayDuration: 400, children: /* @__PURE__ */ f(Rt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(B, { variant: "ghost", size: "sm", onClick: g, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
          /* @__PURE__ */ f(Bt, { children: [
            /* @__PURE__ */ n(Pt, { children: s.commandEmptyMessage }),
            w.map((l, p) => (
              ...
              /* @__PURE__ */ f(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Ot, { heading: ya(l, s), children: l.rows.map((N) => /* @__PURE__ */ n(
                      Na,
                      {
                        row: N,
                        mode: t.mode,
...
function _a(t, e) {
  ...
  ].filter((r) => L.bookIdToNumber(r) > 0).sort((r, o) => L.bookIdToNumber(r) - L.bookIdToNumber(o)).map((r) => Oe(r, e));
}
function mo(t, e, a, r) {
...
function go({
  ...
  return /* @__PURE__ */ f(Ea, { className: c(s), role: o, children: [
    /* @__PURE__ */ f(Ta, { children: [
      /* @__PURE__ */ n(za, { variant: "icon", children: r ?? /* @__PURE__ */ n(pe, {}) }),
      /* @__PURE__ */ n(Ga, { children: t })
    ] }),
    a && /* @__PURE__ */ n(ja, { children: /* @__PURE__ */ n(B, { onClick: () => a(), children: e }) })
  ] });
}
const La = Tt(({ className: t, ...e }, a) => /* @__PURE__ */ n(me, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-s4-Avg1I.js.map
