...
import { Slot as Nt, Dialog as K, Separator as de, Popover as rt, Tooltip as tt, DropdownMenu as C, Label as ce, RadioGroup as ht, ToggleGroup as Pt } from "radix-ui";
import { IconX as ue, IconCheck as xt, IconSearch as we, IconChevronRight as pe } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import { cva as X } from "class-variance-authority";
import z, { createContext as Bt, useContext as Mt, useState as V, useRef as dt, useCallback as J, useMemo as q, useEffect as Gt, Fragment as me, forwardRef as Ht } from "react";
import { ChevronsUpDown as Ut, Check as $t, Star as fe, Group as he, ArrowRight as ge, Loader2 as be, ChevronDown as ve, Search as Ne, X as xe, AlertTriangle as ye, LoaderCircle as Se } from "lucide-react";
import { Section as W, MODIFIER_KEYS as ke, normalizeProjectId as O, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as at, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as _e } from "platform-bible-utils";
...
function Ae(t, e) {
  ...
  const a = gt(t);
  if (a[0] !== "tw") return t;
  const o = a.slice(1, -1), r = a[a.length - 1], s = gt(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && r.startsWith("-")) {
    const u = r.slice(1);
    return [...o, `-tw-${u}`].join(":");
  }
...
const Kt = 600, Ft = 650, co = 400, je = 450, Le = 500, Re = 675, uo = 690, wo = 700, po = 800, Vt = X(
...
const Po = "data-platform-content-zoom-root", Bo = "data-platform-content-zoom-popup", Ye = "--platform-content-zoom-", Qe = "--platform-content-zoom-default", ta = "main", ea = "--platform-content-zoom-popup-factor", te = Bt(void 0);
...
function oe({
  ...
  const s = M(), i = z.useContext(ae), l = kt();
  return (
...
function oa({ variant: t = "default", ...e }) {
  const a = M(), o = z.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ n(re.Provider, { value: o, children: /* @__PURE__ */ n(C.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Vo({
  ...t
}) {
...
const ua = ["input", "select", "textarea", "button"], wa = ["button", "textbox"], ir = ({
  ...
  const r = dt(null), [s, i] = V(void 0), [l, u] = V(void 0), f = J(
    (w) => {
      i(w);
    ...
    if (N && wa.includes(N)) return !0;
    const b = w.getAttribute("tabindex");
    return b !== void 0 && b !== "-1";
  }, _ = J(
    (w) => {
      var E;
      const g = w.target, N = (y) => y ? document.getElementById(y) : void 0, b = N(l), U = N(s);
      if (!!(b && g && b.contains(g) && g !== b) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const B = y.findIndex((D) => D === g);
          if (B === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(B + 1, y.length - 1) : S = Math.max(B - 1, 0), S !== B && (w.preventDefault(), w.stopPropagation(), (E = y[S]) == null || E.focus());
          return;
        }
        return;
      }
      ...
      switch (w.key) {
        case "ArrowDown":
          A = Math.min($ + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          A = Math.max($ - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function gr({
  ...
  return /* @__PURE__ */ n("div", { id: b, className: g, children: /* @__PURE__ */ m(ee, { open: y, onOpenChange: h ?? Z, children: [
    ...
    /* @__PURE__ */ n(oe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Xt, { children: [
      /* @__PURE__ */ n(
        Zt,
        {
      ...
      r && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ n(H, { variant: "ghost", size: "sm", onClick: E, children: i })
      ] }),
...
function ga(t, e, a) {
  if (!e) return [...t];
  const o = [...t], r = ot(e).toLowerCase();
  return a === "passive" ? At({
    query: r,
    items: o,
    filter: (s) => ot(s.label).toLowerCase().startsWith(r),
    sortBy: "label"
  }) : At({
    query: r,
    items: o,
    filter: (s) => ot(s.label).toLowerCase().includes(r),
    sortBy: "label"
  });
}
function ba(t) {
...
function br(t, e, a) {
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (R(t), a.dismiss(), "ended") : (R(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (R(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (R(t), a.dismiss(), "ended") : t.key === "Backspace" || se[o].test(t.key) ? (R(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && R(t), a.dismiss(), "ended");
}
function vr(t, e) {
  var a;
...
function ya(t) {
  ...
  return t.forEach((a) => {
    const o = O(a.projectId), r = e.get(o), s = {
...
function Ot(t, e, a) {
  const o = O(e);
  return t.some(
    (r) => O(r.projectId) === o && r.scrollGroupId === a
  );
}
function mt(t) {
  ...
  if (t.mode === "project") {
    ...
    return t.projects.map((s) => {
      ...
      return {
        ...
        isSelected: r !== void 0 && O(r) === O(s.id),
        isMuted: i.length === 0,
        isBoundButClosed: !1,
  ...
  return t.projects.forEach((r) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Ot(a, r.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: r.isDisabled === !0,
        disabledReason: r.disabledReason,
    ...
    const s = O(r.projectId);
    if (o.some(
      (l) => O(l.projectId) === s && l.scrollGroupId === r.scrollGroupId
    ))
      return;
...
function Sa(t) {
  const e = t.filter(Dt).sort(Y), a = t.filter((r) => !Dt(r)).sort(Y);
  if (e.length === 0)
...
function ka(t, e) {
  const a = t.filter((i) => i.isSelected).sort(Y), o = t.filter((i) => !i.isSelected).sort(Y), r = (i, l) => {
    var f;
...
function Ia(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const f = [...u].sort(
      (_, w) => {
        var g;
        return ((g = e.compareProjects) == null ? void 0 : g.call(e, _.project, w.project)) || Y(_, w);
      }
...
function Ea(t) {
  ...
  return [
    ie(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[at.lastUsedAt]) == "number" ? it : _a;
      },
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[at.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[at.type];
        return typeof o == "string" ? o : void 0;
      },
      ...
      getSectionHeading: (a, o) => {
        ...
        ), s = (i = r == null ? void 0 : r.customData) == null ? void 0 : i[at.typeName];
...
function La({
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: k
  } = aa(), [_, w] = V(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = f || _, b = J(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  let P;
  e === "project" ? t.openGroups.length > 0 && (P = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((E) => /* @__PURE__ */ n(ct, { variant: "secondary", children: st(E) }, E)) })) : t.scrollGroupId !== void 0 && (P = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ja,
      {
  ...
  ), A = t.scrollGroupId !== void 0 ? st(t.scrollGroupId) : void 0, F = t.isBoundButClosed && A ? a.boundButClosedTooltip.replace("{group}", A) : void 0;
  return /* @__PURE__ */ m(_t, { open: N, delayDuration: 400, children: [
...
function Ra({
  ...
  return /* @__PURE__ */ m(oa, { children: [
    /* @__PURE__ */ m(_t, { children: [
      /* @__PURE__ */ n(Et, { asChild: !0, children: /* @__PURE__ */ n(ra, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
      ...
      /* @__PURE__ */ n(Tt, { children: o.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      sa,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(ia, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(Rt, { value: et, children: o.groupByNone }),
            /* @__PURE__ */ n(da, {}),
...
function ft(t, e) {
  if (e === void 0) return;
  const a = O(e);
  return t.find((o) => O(o.id) === a);
}
function Tr(t) {
  const [e, a] = V(!1), [o, r] = V(""), s = Ga(t.localizedStrings), i = q(() => {
  ...
  const w = q(() => t.mode === "project" ? mt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, T = O(c.projectId), I = (L) => O(L.projectId) === T && L.scrollGroupId === c.scrollGroupId, j = p.some(I) ? p.filter((L) => !I(L)) : [
          ...p.filter((L) => !I(L)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((j) => {
          const L = ft(t.projects, j.projectId);
  ...
  }, [t, s.buttonPlaceholder]), $ = dt(null), [A, F] = V(!1);
  Gt(() => {
    const c = $.current;
    if (!c) return;
    const p = (I) => {
  ...
  let E;
  t.isLoading ? E = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : A ? E = void 0 : t.mode === "project-multi" ? E = /* @__PURE__ */ n(Ut, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : E = /* @__PURE__ */ n(ve, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, B = /* @__PURE__ */ m(
    H,
    {
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof P.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: P.node }) : P.node }),
        E
      ]
    }
  ), S = P.title ? /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(_t, { children: [
    /* @__PURE__ */ n(Et, { asChild: !0, children: /* @__PURE__ */ n(bt, { asChild: !0, children: B }) }),
    /* @__PURE__ */ n(Tt, { children: P.title })
  ] }) }) : /* @__PURE__ */ n(bt, { asChild: !0, children: B }), D = i.length > 1;
  return /* @__PURE__ */ m(ee, { open: e, onOpenChange: _, children: [
    S,
    /* @__PURE__ */ n(
      oe,
      {
        ...
        children: /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(Xt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Wt, { children: [
            ...
            N.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Yt, { heading: Da(c, s), children: c.rows.map((T) => {
                      var I;
                      return /* @__PURE__ */ n(
                        La,
                        {
...
const Xa = Ht(({ className: t, ...e }, a) => /* @__PURE__ */ n(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CrbhDCEe.js.map
