...
import { Slot as ut, Dialog as O, Popover as Z, Tooltip as X, Label as Ut, RadioGroup as lt, ToggleGroup as It, Separator as Xt, DropdownMenu as S } from "radix-ui";
...
const ve = 600, Oa = 650, Tt = 400, xe = 450, ye = 500, ke = 550, ja = 650, _a = 700, zt = $(
...
function P() {
  var e;
  const t = (e = At()) == null ? void 0 : e.getItem(Gt);
  return t === "rtl" ? t : "ltr";
}
function $a(t) {
  var e;
  (e = At()) == null || e.setItem(Gt, t);
}
function Ha({ ...t }) {
...
function Lt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ f(Ee, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        K.Input,
        {
      ...
      /* @__PURE__ */ n(ze, { children: /* @__PURE__ */ n(qt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const nr = Object.fromEntries(
  Le.map((t) => [t, G.bookIdToEnglishName(t)])
);
function sr(t, e, a) {
...
const $e = ["input", "select", "textarea", "button"], He = ["button", "textbox"], yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function $r({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f(Ot, { open: C, onOpenChange: b ?? M, children: [
...
function ca({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: g
  } = Me(), [b, I] = j(!1), A = !!(t.language || t.languageCode), m = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, k = _(() => {
    if (m) {
      I(!0);
      return;
    }
...
function Ur(t) {
  ...
  const I = ia(t.localizedStrings), A = U(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  ), C = E.title ? /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f($t, { children: [
  ...
  return /* @__PURE__ */ f(Ot, { open: e, onOpenChange: b, children: [
    ...
    /* @__PURE__ */ n(
      _t,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f(Dt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ f(Rt, { children: [
            ...
            v.map((c, u) => (
              ...
              /* @__PURE__ */ f(ee, { children: [
                /* @__PURE__ */ n(Bt, { heading: wa(c, I), children: c.rows.map((p) => /* @__PURE__ */ n(
                  ca,
                  {
                    row: p,
                    mode: t.mode,
...
const Wr = (t, e, a) => pa(t, e).every((r) => a.includes(r));
function ha(t, e) {
  return [
...
function Qr({
  ...
  return /* @__PURE__ */ f(ga, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(ba, { children: [
      /* @__PURE__ */ n(va, { variant: "icon", children: r ?? /* @__PURE__ */ n(de, {}) }),
      /* @__PURE__ */ n(xa, { children: t })
    ] }),
    a && /* @__PURE__ */ n(ya, { children: /* @__PURE__ */ n(R, { onClick: () => a(), children: e }) })
  ] });
}
const ka = Ct(({ className: t, ...e }, a) => /* @__PURE__ */ n(ce, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-Nnt4VUSN.js.map
