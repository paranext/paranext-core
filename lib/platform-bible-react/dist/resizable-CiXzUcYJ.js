...
import { Slot as It, Dialog as V, Separator as ve, Popover as it, Tooltip as at, DropdownMenu as E, Label as xe, RadioGroup as vt, ToggleGroup as Jt } from "radix-ui";
import { IconX as ye, IconCheck as _t, IconSearch as Se, IconChevronRight as ke } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as q } from "class-variance-authority";
import C, { createContext as Xt, useContext as Zt, useState as K, useRef as pt, useCallback as Z, useMemo as Q, useEffect as Pt, Fragment as Ie, forwardRef as qt } from "react";
...
import { Section as Y, MODIFIER_KEYS as Re, normalizeProjectId as P, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as nt, getLocalizeKeyForScrollGroupId as Oe, getSectionForBook as Pe } from "platform-bible-utils";
...
const Qt = 600, te = 650, No = 400, Fe = 450, Ke = 500, Ve = 675, vo = 690, xo = 700, yo = 800, ee = q(
...
const $o = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const Xo = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function sa({
  className: t,
...
const Yo = "data-platform-content-zoom-root", Qo = "data-platform-content-zoom-popup", la = "--platform-content-zoom-", da = "--platform-content-zoom-default", ca = "main", ua = "--platform-content-zoom-popup-factor", ce = Xt(void 0);
function tr({ area: t, children: e }) {
...
function ga({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ r(
    E.Label,
    {
...
function wr({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ r(ke, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const va = ["input", "select", "textarea", "button"], xa = ["button", "textbox"], xr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
  ...
  const n = pt(null), [s, i] = K(void 0), [l, u] = K(void 0), m = Z(
    ...
    if (w.isContentEditable || va.includes(g)) return !0;
    const v = w.getAttribute("role");
    if (v && xa.includes(v)) return !0;
  ...
  const l = C.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), Ia(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), ka(l, v, f.key);
...
function Ar({
  ...
  const [$, J] = K(!1), W = Z(
    (S) => {
      var _;
      const D = (_ = t.find((F) => F.label === S)) == null ? void 0 : _.value;
      D && a(
        e.includes(D) ? e.filter((F) => F !== D) : [...e, D]
      );
    },
    [t, e, a]
  ), X = () => u || o, G = Q(() => {
    if (!I) return t;
    const S = t.filter((_) => _.starred).sort((_, F) => _.label.localeCompare(F.label)), D = t.filter((_) => !_.starred).sort((_, F) => {
...
function jr(t, e, a) {
  ...
  if (Ea(t) || Re.has(t.key) || t.key === "Dead")
    return "passed";
...
function Aa(t) {
  ...
  return t.forEach((a) => {
    const o = P(a.projectId), n = e.get(o), s = {
...
function Ft(t, e, a) {
  const o = P(e);
  return t.some(
    (n) => P(n.projectId) === o && n.scrollGroupId === a
  );
}
function bt(t) {
...
function Oa(t) {
  ...
  return [
    ge(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[nt.lastUsedAt]) == "number" ? ut : Ra;
      },
...
const Vt = "platform.footerAction", Ha = {
...
function Ua({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = dt(t);
  return e ? /* @__PURE__ */ r(
    mt,
    {
...
function $a({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = wa(), [I, w] = K(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = m || I, h = Z(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), J = /* @__PURE__ */ r(Yt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let W;
  ...
  return /* @__PURE__ */ p(pa, { children: [
    ...
    /* @__PURE__ */ p(
      fa,
      {
        ...
        style: { zIndex: te },
        children: [
          /* @__PURE__ */ r(ga, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(ha, { value: e, onValueChange: a, children: [
...
function Nt(t, e) {
  if (e === void 0) return;
  const a = P(e);
  return t.find((o) => P(o.id) === a);
}
function Ur(t) {
  const [e, a] = K(!1), [o, n] = K(""), s = Ma(t.localizedStrings), i = Q(() => {
    ...
    () => Ka(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), f = l ?? m, k = pt(null), [I, w] = K(void 0), g = Z((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Pt(() => {
    if (!e) return;
  ...
  const v = Q(() => t.mode === "project" ? bt({
  ...
  }, [v, o]), $ = !!t.footerAction && h.length === 0, J = Q(() => {
    if (f === ot) return kt(h);
    const c = i.find((b) => b.id === f);
    return c ? La(h, c) : kt(h);
  }, [h, f, i]), W = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, R = P(c.projectId), T = (j) => P(j.projectId) === R && j.scrollGroupId === c.scrollGroupId, A = b.some(T) ? b.filter((j) => !T(j)) : [
          ...b.filter((j) => !T(j)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((A) => {
          const j = Nt(t.projects, A.projectId);
              ...
              /* @__PURE__ */ p(se, { children: [
                ...
                J.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(le, { heading: Va(c, s), children: c.rows.map((R) => {
                          var T;
                          return /* @__PURE__ */ r(
                            $a,
                            {
...
const Fr = (t, e, a) => Za(t, e).every((o) => a.includes(o));
function qa(t, e) {
  return [
...
function Kr(t, e, a, o) {
  ...
  const i = qa(t, o);
  if (i.length !== 0)
    return i.length <= Xa ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
function Vr({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ r(
    "p",
    {
      role: "status",
...
function Xr({
  ...
  return /* @__PURE__ */ p(Wa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(Ya, { children: [
      /* @__PURE__ */ r(to, { variant: "icon", children: o ?? /* @__PURE__ */ r(Ge, {}) }),
      /* @__PURE__ */ r(eo, { children: t })
    ] }),
    a && /* @__PURE__ */ r(ao, { children: /* @__PURE__ */ r(U, { onClick: () => a(), children: e }) })
  ] });
}
const oo = qt(({ className: t, ...e }, a) => /* @__PURE__ */ r(Le, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CiXzUcYJ.js.map
