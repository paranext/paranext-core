import { jsx as o, jsxs as m, Fragment as ct } from "react/jsx-runtime";
import { Slot as Nt, Dialog as J, Popover as ot, Tooltip as et, Label as le, RadioGroup as ht, ToggleGroup as Pt, Separator as de, DropdownMenu as T } from "radix-ui";
import { IconX as ce, IconSearch as ue, IconCheck as vt, IconChevronRight as we } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import z, { useState as X, useRef as xt, useCallback as K, createContext as me, useContext as fe, useMemo as Q, useEffect as pe, Fragment as he, forwardRef as Ot } from "react";
import { cva as W } from "class-variance-authority";
import { ChevronsUpDown as Mt, Check as jt, Star as ge, SlidersHorizontal as be, ArrowRight as Ne, Loader2 as ve, ChevronDown as xe, Search as ye, X as ke, AlertTriangle as Ie, LoaderCircle as Se } from "lucide-react";
import { Section as Z, MODIFIER_KEYS as Ce, normalizeProjectId as F, getLocalizeKeyForScrollGroupId as Ee, getSectionForBook as Te } from "platform-bible-utils";
...
import { extendTailwindMerge as Ge, twMerge as Ae } from "tailwind-merge";
const De = Ge({ prefix: "tw" });
function gt(t) {
  const e = [];
  let a = "", r = 0;
...
function d(...t) {
  ...
  return a.forEach((c) => {
    const f = Le(c);
    r.set(f.normalized, f.original), n.push(f.normalized);
  }), Ae(n.join(" ")).split(" ").filter(Boolean).map((c) => {
    const f = r.get(c);
    return f ? Re(c, f) : c;
  }).join(" ");
}
const Be = 600, _t = 650, dr = 400, Pe = 450, Oe = 500, Me = 550, cr = 650, ur = 700, Ut = W(
  ...
  return /* @__PURE__ */ m(je, { children: [
    ...
    /* @__PURE__ */ m(
      J.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(J.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(_, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(ce, {}),
...
function br({
  ...
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(J.Close, { asChild: !0, children: /* @__PURE__ */ o(_, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Vt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ m($e, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        tt.Input,
        {
      ...
      /* @__PURE__ */ o(Ve, { children: /* @__PURE__ */ o(ue, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Wt = z.createContext(null);
function Dr({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ o(Wt.Provider, { value: t, children: e });
}
function qt({
  className: t,
  align: e = "center",
...
function Qt({
  ...
  return /* @__PURE__ */ o(et.Portal, { children: /* @__PURE__ */ m(
    et.Content,
    {
...
const ea = ["input", "select", "textarea", "button"], aa = ["button", "textbox"], Jr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = xt(null), [s, i] = X(void 0), [l, c] = X(void 0), f = K(
    (u) => {
      i(u);
    ...
    (u) => {
      ...
      if (!!(N && b && N.contains(b) && b !== N) && v(b)) {
        ...
        if (u.key === "ArrowDown" || u.key === "ArrowUp") {
          ...
          const j = x.findIndex((R) => R === b);
          if (j === -1) return;
          let C;
          u.key === "ArrowDown" ? C = Math.min(j + 1, x.length - 1) : C = Math.max(j - 1, 0), C !== j && (u.preventDefault(), u.stopPropagation(), (H = x[C]) == null || H.focus());
          return;
        }
        return;
      }
      const P = t.findIndex((x) => x.id === s);
      let O = P;
      switch (u.key) {
        case "ArrowDown":
          O = Math.min(P + 1, t.length - 1), u.preventDefault();
          break;
        case "ArrowUp":
          O = Math.max(P - 1, 0), u.preventDefault();
          break;
        case "Home":
          O = 0, u.preventDefault();
          break;
        case "End":
          O = t.length - 1, u.preventDefault();
          break;
        case " ":
        case "Enter":
...
function na({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(ee.Provider, { value: r, children: /* @__PURE__ */ o(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Xr({
  ...t
}) {
  ...
  return /* @__PURE__ */ m(
    T.SubTrigger,
    {
      ...
      className: d(
        ...
        t,
        // CUSTOM: Apply variant-driven styles from menu context
        ft({ variant: n.variant })
      ),
      ...r,
      children: [
        a,
        /* @__PURE__ */ o(we, { className: "tw:ms-auto" })
      ]
    }
  );
}
function tn({ className: t, children: e, ...a }) {
  const r = U();
  return /* @__PURE__ */ o(
    T.SubContent,
    {
...
function un({
  ...
  const [A, $] = X(!1), Y = K(
    (C) => {
      var B;
      const R = (B = t.find((V) => V.label === C)) == null ? void 0 : B.value;
      R && a(
    ...
    if (!S) return t;
    const C = t.filter((B) => B.starred).sort((B, V) => B.label.localeCompare(V.label)), R = t.filter((B) => !B.starred).sort((B, V) => {
      const lt = e.includes(B.value), q = e.includes(V.value);
      return lt && !q ? -1 : !lt && q ? 1 : B.label.localeCompare(V.label);
    });
    return [...C, ...R];
  }, [t, e, S]), M = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ m(Xt, { open: x, onOpenChange: h ?? $, children: [
    /* @__PURE__ */ o(bt, { asChild: !0, children: /* @__PURE__ */ m(
      _,
      {
        variant: g,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ o(Mt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ o(qt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Ht, { children: [
      /* @__PURE__ */ o(
        Vt,
        {
      ...
      n && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: M, children: s }),
        /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: H, children: i })
      ] }),
      /* @__PURE__ */ m(Ft, { children: [
        /* @__PURE__ */ o(Kt, { children: l }),
        /* @__PURE__ */ o(Jt, { children: O.map((C) => /* @__PURE__ */ m(
          kt,
          {
            value: C.label,
            onSelect: Y,
            ...
            children: [
              ...
              C.starred && /* @__PURE__ */ o(ge, { className: "tw:h-4 tw:w-4" }),
...
function wn(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (L(t), a.dismiss(), "ended") : (L(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (L(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (L(t), a.dismiss(), "ended") : t.key === "Backspace" || ae[r].test(t.key) ? (L(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && L(t), a.dismiss(), "ended");
}
function mn(t, e) {
  var a;
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      r.push({
        ...
        openGroups: [],
        isSelected: Dt(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
...
function Rt(t, e) {
  ...
  const a = t.filter(Lt).sort(D), r = t.filter((s) => !Lt(s)).sort(D);
  if (a.length === 0)
...
const re = "__unmatched__";
function Ia(t) {
  const e = /* @__PURE__ */ new Set();
  return t.map((a) => a.id).find((a) => a === re || e.has(a) ? !0 : (e.add(a), !1));
}
const Bt = /* @__PURE__ */ new Set();
function Sa(t) {
  Bt.has(t) || (Bt.add(t), console.warn(
...
function Aa({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ o(ut, { variant: "secondary", children: a });
}
function Da({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: h,
    onPointerLeave: v
  } = Ze(), [S, u] = X(!1), b = !!(t.language || t.languageCode), g = b || !!t.typeName || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = f || S, A = K(() => {
    if (g) {
      u(!0);
      return;
    }
    ...
    u(!1), v();
  }, [v]), Y = /* @__PURE__ */ o(jt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let P;
  e === "project" ? t.openGroups.length > 0 && (P = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((x) => /* @__PURE__ */ o(ut, { variant: "secondary", children: it(x) }, x)) })) : t.scrollGroupId !== void 0 && (P = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      Aa,
      {
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ m(
      _,
      {
        size: "sm",
        variant: "ghost",
  ...
  return /* @__PURE__ */ m(Zt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(Yt, { asChild: !0, children: O }),
    /* @__PURE__ */ m(
      Qt,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && M && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
  ...
  return /* @__PURE__ */ m(na, { children: [
    ...
    /* @__PURE__ */ m(
      sa,
      {
        ...
        style: { zIndex: _t },
        children: [
          t.length > 0 && /* @__PURE__ */ m(ct, { children: [
            /* @__PURE__ */ o(Gt, { children: i.groupSectionLabel }),
            /* @__PURE__ */ m(
              la,
              {
                value: e,
                ...
                children: [
                  /* @__PURE__ */ o(zt, { value: "none", children: i.filterGroupNone }),
                  t.map((c) => /* @__PURE__ */ o(zt, { value: c, children: Ba(c, i) }, c))
                ]
              }
            )
          ] }),
          s && /* @__PURE__ */ m(ct, { children: [
            t.length > 0 && /* @__PURE__ */ o(da, {}),
            /* @__PURE__ */ o(Gt, { children: i.filterSectionLabel }),
            /* @__PURE__ */ o(
              ia,
              {
                checked: !!n,
...
function gn(t) {
  ...
  ), [l, c] = X(i), [f, h] = X(!1), v = xt(null), S = K((w) => {
    a(w), w || n("");
  }, []);
  pe(() => {
    if (!e) return;
  ...
  const u = Ta(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? pt({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
    ...
    )), t.mode === "project-multi" && f && (p = p.filter((y) => y.isSelected)), p;
  }, [b, r, t.mode, f]), N = Q(
    ...
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: P } = u, { languageUnknownSectionHeading: O } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: H } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Rt(g, !0);
      case "lastUsed":
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        t.onChangeSelection({ pairs: E }), E.length === 0 && f && h(!1);
        return;
      }
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (w.forEach((k) => {
          const rt = t.projects.find((ie) => ie.id === k.projectId);
        ...
        return {
          node: /* @__PURE__ */ m(ct, { children: [
            /* @__PURE__ */ o(ut, { variant: "muted", className: "tw:shrink-0", children: E }),
  ...
  let at;
  t.isLoading ? at = /* @__PURE__ */ o(ve, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? at = void 0 : t.mode === "project-multi" ? at = /* @__PURE__ */ o(Mt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : at = /* @__PURE__ */ o(xe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const oe = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? R : void 0, St = /* @__PURE__ */ m(
    _,
    {
  ...
  ), se = q.title ? /* @__PURE__ */ o(Tt, { delayDuration: 400, children: /* @__PURE__ */ m(Zt, { children: [
    /* @__PURE__ */ o(Yt, { asChild: !0, children: /* @__PURE__ */ o(bt, { asChild: !0, children: St }) }),
    /* @__PURE__ */ o(Qt, { children: q.title })
  ] }) }) : /* @__PURE__ */ o(bt, { asChild: !0, children: St });
  return /* @__PURE__ */ m(Xt, { open: e, onOpenChange: S, children: [
    se,
    /* @__PURE__ */ o(
      qt,
      {
        ...
        children: /* @__PURE__ */ o(Tt, { delayDuration: 400, children: /* @__PURE__ */ m(Ht, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: V, children: `${u.selectAll} (${C.length.toString()})` }),
            /* @__PURE__ */ o(_, { variant: "ghost", size: "sm", onClick: lt, children: `${u.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ m(Ft, { children: [
            /* @__PURE__ */ o(Kt, { children: t.commandEmptyMessage ?? "No projects found" }),
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(he, { children: [
                /* @__PURE__ */ o(Jt, { heading: Oa(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  Da,
                  {
                    row: y,
                    mode: t.mode,
                ...
                p < j.length - 1 && /* @__PURE__ */ o(Et, {})
              ] }, w.id ?? `${w.kind}:${w.label ?? ""}`)
            )),
            t.footerAction && /* @__PURE__ */ m(ct, { children: [
              g.length > 0 && /* @__PURE__ */ o(Et, { alwaysRender: !0, "data-testid": "project-selector-footer-separator" }),
              /* @__PURE__ */ o(
                kt,
                {
                  forceMount: !0,
                  ...
                  onSelect: () => {
                    var w;
                    (w = t.footerAction) == null || w.onSelect(), a(!1);
                  },
...
const Nn = (t, e, a) => _a(t, e).every((r) => a.includes(r));
function Ua(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => G.bookIdToNumber(r) > 0).sort((r, n) => G.bookIdToNumber(r) - G.bookIdToNumber(n)).map((r) => qe(r, e));
}
function vn(t, e, a, r) {
...
function xn({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function kn({
  ...
  return /* @__PURE__ */ m($a, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Ha, { children: [
      /* @__PURE__ */ o(Fa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ie, {}) }),
      /* @__PURE__ */ o(Ka, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Ja, { children: /* @__PURE__ */ o(_, { onClick: () => a(), children: e }) })
  ] });
}
const Xa = Ot(({ className: t, ...e }, a) => /* @__PURE__ */ o(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BsNvTYwD.js.map
