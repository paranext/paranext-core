...
import { Slot as Pt, Dialog as Y, Separator as Se, Popover as wt, Tooltip as lt, DropdownMenu as T, Label as ye, RadioGroup as _t } from "radix-ui";
import { IconX as ke, IconCheck as Rt, IconSearch as Ie, IconChevronRight as Ee } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as rt } from "class-variance-authority";
import M, { useState as H, useRef as pt, useCallback as V, createContext as Te, useContext as _e, useEffect as Ct, useMemo as et, Fragment as Ce, useId as Le, forwardRef as Qt } from "react";
import { ChevronsUpDown as te, Check as ee, Star as je, Group as Ae, ArrowRight as Ge, Loader2 as Pe, ChevronDown as Re, Search as De, X as ze, AlertTriangle as Be, LoaderCircle as Oe } from "lucide-react";
import { Section as ot, MODIFIER_KEYS as Me, normalizeProjectId as D, compareProjectsByName as He, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, formatProjectName as ae, getLocalizeKeyForScrollGroupId as Ue, hasDistinctFullName as $e, getSectionForBook as Ke } from "platform-bible-utils";
...
import { extendTailwindMerge as Ve, twMerge as Je } from "tailwind-merge";
const Xe = Ve({ prefix: "tw" });
function Lt(t) {
  const e = [];
  let a = "", o = 0;
...
function c(...t) {
  ...
  }), Je(r.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? We(u, m) : u;
  }).join(" ");
}
const oe = 600, re = 650, To = 400, Ze = 450, Ye = 500, _o = 510, Co = 520, Qe = 675, Lo = 690, jo = 700, Ao = 800, ne = rt(
...
function J({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: c(ne({ variant: e, size: a, className: t })),
      ...r
    }
  );
}
...
function Po({ ...t }) {
  return /* @__PURE__ */ n(Y.Root, { "data-slot": "dialog", ...t });
}
function Ro({ ...t }) {
  return /* @__PURE__ */ n(Y.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function ta({ ...t }) {
  return /* @__PURE__ */ n(Y.Portal, { "data-slot": "dialog-portal", ...t });
}
function Do({ ...t }) {
  return /* @__PURE__ */ n(Y.Close, { "data-slot": "dialog-close", ...t });
}
function ea({
  className: t,
...
function zo({
  ...
  const l = X();
  return /* @__PURE__ */ p(ta, { children: [
    /* @__PURE__ */ n(ea, { className: o, style: r }),
    /* @__PURE__ */ p(
      Y.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(Y.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(J, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(ke, {}),
...
function Oo({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(Y.Close, { asChild: !0, children: /* @__PURE__ */ n(J, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function aa({ className: t, type: e, ...a }) {
  return /* @__PURE__ */ n(
    "input",
    {
      type: e,
...
rt("tw:flex tw:items-center tw:gap-2 tw:text-sm tw:shadow-none", {
  variants: {
    size: {
...
function ce({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(oa, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        st.Input,
        {
      ...
      /* @__PURE__ */ n(na, { children: /* @__PURE__ */ n(Ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const sa = [
  ...
  var e;
  return ((e = sa[t]) == null ? void 0 : e.chapters) ?? -1;
}, la = L.allBookIds.filter(
...
const Zo = Object.fromEntries(
  la.map((t) => [t, L.bookIdToEnglishName(t)])
);
function Yo(t, e, a) {
...
function mt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && wa(o)
  );
}
const Qo = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
let jt = "keyboard", Jt = !1;
function tr() {
...
const rr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function pa({
  className: t,
...
const { PortalContainerProvider: fa, usePortalContainer: ha } = me(), lr = fa;
function he({
  className: t,
  align: e = "center",
  sideOffset: a = 4,
  ...
  return (
    ...
    /* @__PURE__ */ n(wt.Portal, { container: i, children: /* @__PURE__ */ n(
      wt.Content,
      {
...
function Mt({
  ...
  return /* @__PURE__ */ n(
    lt.Trigger,
    {
      ...
      className: e ? c(ne({ variant: e }), t) : t,
      ...a
    }
  );
}
const { PortalContainerProvider: ga, usePortalContainer: ba } = me(), pr = ga;
function Ht({
  className: t,
  sideOffset: e = 0,
  ...
  return (
    ...
    /* @__PURE__ */ n(lt.Portal, { container: l, children: /* @__PURE__ */ p(
      lt.Content,
      {
...
const Na = /^%[^%]*%$/;
function ge(t) {
  return t !== void 0 && !Na.test(t) && t.trim() !== "";
}
function _(t, e) {
  return ge(t) ? t : e;
}
function va() {
  const [t, e] = H(!1), a = pt(null), o = V(() => {
    const s = a.current;
...
function xa({ variant: t = "default", ...e }) {
  const a = X(), o = M.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ n(be.Provider, { value: o, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function mr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(T.ItemIndicator, { children: /* @__PURE__ */ n(Rt, {}) })
          }
        ),
        e
      ]
...
const Ta = ["input", "select", "textarea", "button"], _a = ["button", "textbox"], Tr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const r = pt(null), [s, i] = H(void 0), [l, u] = H(void 0), m = V(
    (w) => {
      i(w);
    ...
    if (w.isContentEditable || Ta.includes(g)) return !0;
    const N = w.getAttribute("role");
    if (N && _a.includes(N)) return !0;
    const h = w.getAttribute("tabindex");
    return h !== void 0 && h !== "-1";
  }, E = V(
    (w) => {
      var U;
      const g = w.target, N = (v) => v ? document.getElementById(v) : void 0, h = N(l), $ = N(s);
      if (!!(h && g && h.contains(g) && g !== h) && y(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const v = t.find((I) => I.id === l);
            v && m(v.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const I = v.findIndex((W) => W === g);
          if (I === -1) return;
          let q;
          w.key === "ArrowDown" ? q = Math.min(I + 1, v.length - 1) : q = Math.max(I - 1, 0), q !== I && (w.preventDefault(), w.stopPropagation(), (U = v[q]) == null || U.focus());
          return;
        }
        return;
      }
      const tt = t.findIndex((v) => v.id === s);
      let P = tt;
      switch (w.key) {
        case "ArrowDown":
          P = Math.min(tt + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          P = Math.max(tt - 1, 0), w.preventDefault();
          break;
        case "Home":
          P = 0, w.preventDefault();
          break;
        case "End":
          P = t.length - 1, w.preventDefault();
          break;
        case " ":
        case "Enter":
  ...
  const l = M.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), Aa(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), ja(l, N, f.key);
...
function zr({
  ...
  const [Q, tt] = H(!1), P = pt(null), at = V(
    (k) => {
      var B;
      const Z = (B = t.find((F) => F.label === k)) == null ? void 0 : B.value;
      Z && a(
        e.includes(Z) ? e.filter((F) => F !== Z) : [...e, Z]
      );
    },
    [t, e, a]
  ), U = () => m || o, v = f ?? Q, I = y ?? tt, [q, W] = H(v), [it, z] = H(e);
  q !== v && (W(v), v && z(e));
  const ht = et(() => {
    if (!w) return t;
    const k = t.filter((B) => B.starred).sort((B, F) => B.label.localeCompare(F.label)), Z = t.filter((B) => !B.starred).sort((B, F) => {
      const bt = it.includes(B.value), Nt = it.includes(F.value);
      return bt && !Nt ? -1 : !bt && Nt ? 1 : B.label.localeCompare(F.label);
    });
    return [...k, ...Z];
  }, [t, it, w]), gt = () => {
    const k = t.map((Z) => Z.value);
    z(k), a(k);
  }, Et = () => {
    z([]), a([]);
  };
  return /* @__PURE__ */ n("div", { id: K, className: h, children: /* @__PURE__ */ p(fe, { open: v, onOpenChange: I, children: [
    /* @__PURE__ */ n(At, { asChild: !0, children: /* @__PURE__ */ p(
      J,
      {
        variant: $,
        role: "combobox",
    ...
    /* @__PURE__ */ n(he, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(le, { children: [
      ...
      s && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(J, { variant: "ghost", size: "sm", onClick: gt, children: i }),
        /* @__PURE__ */ n(J, { variant: "ghost", size: "sm", onClick: Et, children: l })
      ] }),
      /* @__PURE__ */ n(Pa, { isEnabled: g, scrollerRef: P, children: /* @__PURE__ */ p(de, { ref: P, children: [
        /* @__PURE__ */ n(ue, { children: u }),
        /* @__PURE__ */ n(we, { children: ht.map((k) => /* @__PURE__ */ p(
          zt,
          {
            value: k.label,
            onSelect: at,
...
function Br(t, e, a) {
  ...
  if (Da(t) || Me.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (R(t), a.dismiss(), "ended") : (R(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (R(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (R(t), a.dismiss(), "ended") : t.key === "Backspace" || Ne[o].test(t.key) ? (R(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && R(t), a.dismiss(), "ended");
}
function Or(t, e) {
  var a;
...
function Ma(t) {
  ...
  return t.forEach((a) => {
    const o = D(a.projectId), r = e.get(o), s = {
...
function Wt(t, e, a) {
  const o = D(e);
  return t.some(
    (r) => D(r.projectId) === o && r.scrollGroupId === a
  );
}
function Tt(t) {
  const e = Ma(t.openTabs);
  if (t.mode === "project") {
    const r = t.selection.projectId === void 0 ? void 0 : D(t.selection.projectId);
  ...
  return t.projects.forEach((r) => {
    ...
    const s = D(r.projectId);
    if (o.some(
      (l) => D(l.projectId) === s && l.scrollGroupId === r.scrollGroupId
    ))
      return;
...
function $a(t, e) {
  ...
  if (e.id === "selection") return Ua(t, e);
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (E, w) => {
        var g;
        return ((g = e.compareProjects) == null ? void 0 : g.call(e, E.project, w.project)) || nt(E, w);
      }
...
function S(t, e) {
  const a = t[e];
  if (!(typeof a != "string" || !ge(a)))
    return a;
}
const vt = "recent", Ka = "other";
function ve(t) {
  return {
    id: "openTabs",
    label: t ?? "Open tabs"
...
function Fa(t) {
  ...
  return [
    ve(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? vt : Ka;
      },
...
function ft(t) {
  return da[Ue(t)] ?? String(t);
}
const Yt = "platform.footerAction", qa = {
...
function Wa({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = ft(t);
  return e ? /* @__PURE__ */ n(
    St,
    {
...
function Za({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: y
  } = va(), [E, w] = H(!1), g = Le(), N = t.isDisabled && !!t.disabledReason, h = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || N, $ = m || E, K = V(() => {
    if (h) {
      w(!0);
      return;
    }
    ...
    w(!1), y();
  }, [y]), tt = /* @__PURE__ */ n(ee, { className: c("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let P;
  e === "project" ? t.openGroups.length > 0 && (P = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((I) => /* @__PURE__ */ n(St, { variant: "secondary", children: ft(I) }, I)) })) : t.scrollGroupId !== void 0 && (P = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Wa,
      {
    ...
    t.isBoundButClosed && !t.isDisabled && r && /* @__PURE__ */ p(
      J,
      {
        size: "sm",
        variant: "ghost",
        ...
        children: [
          /* @__PURE__ */ n(Ge, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
  ...
  const at = /* @__PURE__ */ p(
    zt,
    {
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: tt }),
        ...
        /* @__PURE__ */ p(
          "span",
          {
            ...
            children: [
              ...
              $e(t) && /* @__PURE__ */ n("span", { className: "tw:w-full tw:truncate tw:text-xs tw:text-muted-foreground", children: t.fullName })
            ]
          }
        ),
        P,
        N && /* @__PURE__ */ n("span", { id: g, hidden: !0, children: t.disabledReason })
      ]
    }
  ), U = t.scrollGroupId !== void 0 ? ft(t.scrollGroupId) : void 0, v = t.isBoundButClosed && U ? a.boundButClosedTooltip.replace("{group}", U) : void 0;
  return /* @__PURE__ */ p(Ot, { open: $, delayDuration: 400, children: [
    /* @__PURE__ */ n(Mt, { asChild: !0, children: at }),
    /* @__PURE__ */ p(
      Ht,
      {
        side: "top",
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && U && /* @__PURE__ */ p("div", { className: "tw:text-sm", children: [
          ...
          v && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: v }),
          (i == null ? void 0 : i.label) && /* @__PURE__ */ n("div", { className: "tw:text-sm", "aria-hidden": !0, children: i.label }),
          t.isDisabled && t.disabledReason && /* @__PURE__ */ n("div", { className: "tw:text-sm tw:italic", children: t.disabledReason })
        ]
      }
    )
  ] });
...
function Ya({
  ...
  const r = e !== ct;
  return /* @__PURE__ */ p(xa, { children: [
    /* @__PURE__ */ p(Ot, { children: [
      /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(Sa, { asChild: !0, children: /* @__PURE__ */ n(
        J,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      ya,
      {
        ...
        style: { zIndex: re },
        children: [
          /* @__PURE__ */ n(Ia, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(ka, { value: e, onValueChange: a, children: [
...
function Xr(t) {
  const [e, a] = H(!1), [o, r] = H(""), s = et(() => Xa(t.localizedStrings), [t.localizedStrings]), i = et(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const d = [];
    return t.openTabs.length > 0 && d.push(ve(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && d.push(
      Va({
    ...
    () => Qa(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), f = l ?? m, y = pt(null), [E, w] = H(void 0), g = V((d) => {
    a(d), d || (r(""), w(void 0));
  }, []);
  Ct(() => {
    if (!e) return;
  ...
  const N = et(() => t.mode === "project" ? Tt({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), h = et(() => {
    ...
    (d) => d === void 0 ? void 0 : $.get(D(d)),
    [$]
  ), { renderProjectIndicator: Q } = t, tt = V(
    (d) => Q ? Q(d.project) : void 0,
    [Q]
  ), P = !!Q, at = !!t.footerAction && h.length === 0, U = et(() => {
    if (f === ct) return Gt(h);
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, j = D(d.projectId), O = (G) => D(G.projectId) === j && G.scrollGroupId === d.scrollGroupId, A = b.some(O) ? b.filter((G) => !O(G)) : [
          ...b.filter((G) => !O(G)),
  ...
  }, W = t.mode === "project" ? t.renderTriggerLabel : void 0, it = t.mode === "project" ? t.triggerLabelFormat : void 0, z = et(() => {
    switch (t.mode) {
      case "project": {
        const d = K(t.selection.projectId);
        if (W)
          return { node: W(d), title: "", hasSelection: !!d };
        let b = d ? d.shortName : s.buttonPlaceholder;
        return d && it === "shortNameAndFullName" && (b = ae(d)), { node: b, title: b, hasSelection: !!d };
      }
      case "project-multi": {
        ...
        const b = [];
        if (d.forEach((A) => {
          const G = K(A.projectId);
          G && b.push({ project: G, scrollGroupId: A.scrollGroupId });
        }), b.length === 0) {
          const A = s.buttonPlaceholder;
          return { node: A, title: A, hasSelection: !1 };
        }
        const j = b.map(
          ({ project: A, scrollGroupId: G }) => G === void 0 ? A.shortName : `${A.shortName} (${ft(G)})`
        ).join(", "), O = b.length.toString();
        return {
          node: /* @__PURE__ */ p(xe, { children: [
            /* @__PURE__ */ n(St, { variant: "muted", className: "tw:shrink-0", children: O }),
      ...
      case "projectScrollGroup": {
        const d = K(t.selection.projectId);
        if (!d) {
          const O = s.buttonPlaceholder;
          return { node: O, title: O, hasSelection: !1 };
        }
  ...
  Ct(() => {
    ...
    const j = new ResizeObserver((O) => {
      O.forEach((A) => {
        const [G] = A.borderBoxSize;
        b(G ? G.inlineSize : d.getBoundingClientRect().width);
      });
    });
    return j.observe(d, { box: "border-box" }), () => j.disconnect();
  }, []);
  let k;
  t.isLoading ? k = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? k = void 0 : t.mode === "project-multi" ? k = /* @__PURE__ */ n(te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : k = /* @__PURE__ */ n(Re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const Z = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? v : void 0, B = s.ariaLabel && z.hasSelection && z.title ? `${s.ariaLabel}: ${z.accessibleTitle ?? z.title}` : s.ariaLabel || void 0, F = /* @__PURE__ */ p(
    J,
    {
      ref: ht,
      ...
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof z.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", dir: "auto", children: z.node }) : z.node }),
        k
      ]
    }
  ), bt = z.title ? /* @__PURE__ */ n(Xt, { delayDuration: 400, children: /* @__PURE__ */ p(Ot, { children: [
    /* @__PURE__ */ n(Mt, { asChild: !0, children: /* @__PURE__ */ n(At, { asChild: !0, children: F }) }),
    /* @__PURE__ */ n(Ht, { dir: "auto", children: z.title })
  ] }) }) : /* @__PURE__ */ n(At, { asChild: !0, children: F }), Nt = i.length > 1;
        ...
        children: /* @__PURE__ */ n(Xt, { delayDuration: 400, children: /* @__PURE__ */ p(
          le,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(J, { variant: "ghost", size: "sm", onClick: q, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(de, { children: [
                ...
                U.map((d, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(we, { heading: to(d, s), children: d.rows.map((j) => /* @__PURE__ */ n(
                          Za,
                          {
                            row: j,
                            mode: t.mode,
                            ...
                            selectedRowRef: y,
                            indicator: tt(j),
                            reserveIndicatorSlot: P
                          },
                          j.rowKey
                        )) }),
                        b < U.length - 1 && /* @__PURE__ */ n(Ft, { alwaysRender: !0 })
                      ]
                    },
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            J,
            {
              ...
              children: [
                /* @__PURE__ */ n(ze, { className: "tw:h-4 tw:w-4" }),
...
const Wr = (t, e, a) => oo(t, e).every((o) => a.includes(o));
function ro(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => L.bookIdToNumber(o) > 0).sort((o, r) => L.bookIdToNumber(o) - L.bookIdToNumber(r)).map((o) => ua(o, e));
}
function Zr(t, e, a, o) {
  ...
  const i = ro(t, o);
  if (i.length !== 0)
    return i.length <= ao ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
...
function tn({
  ...
  return /* @__PURE__ */ p(no, { className: c(s), role: r, children: [
    /* @__PURE__ */ p(so, { children: [
      /* @__PURE__ */ n(lo, { variant: "icon", children: o ?? /* @__PURE__ */ n(Be, {}) }),
      /* @__PURE__ */ n(co, { children: t })
    ] }),
    a && /* @__PURE__ */ n(uo, { children: /* @__PURE__ */ n(J, { onClick: () => a(), children: e }) })
  ] });
}
const wo = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Oe, { size: 35, className: c("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DoQPdjm5.js.map
