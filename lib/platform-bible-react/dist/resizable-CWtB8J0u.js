...
import { IconX as Ce, IconCheck as Tt, IconSearch as Le, IconChevronLeft as Ae, IconChevronRight as ze } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as tt } from "class-variance-authority";
import C, { createContext as Wt, useContext as Yt, useState as Z, useRef as ht, useCallback as J, useMemo as Q, useEffect as Mt, Fragment as Ge, forwardRef as Qt } from "react";
import { ChevronsUpDown as te, Check as ee, Star as je, Group as Re, ArrowRight as Oe, Loader2 as Pe, ChevronDown as De, Search as Be, X as Me, AlertTriangle as He, LoaderCircle as Ue } from "lucide-react";
import { Section as et, MODIFIER_KEYS as $e, normalizeProjectId as M, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, getLocalizeKeyForScrollGroupId as Fe, getSectionForBook as Ke } from "platform-bible-utils";
...
function d(...t) {
  ...
  }), Xe(n.join(" ")).split(" ").filter(Boolean).map((u) => {
    const m = o.get(u);
    return m ? We(u, m) : u;
  }).join(" ");
}
const ae = 600, oe = 650, To = 400, Ye = 450, Qe = 500, Co = 510, Lo = 520, ta = 675, Ao = 690, zo = 700, Go = 800, re = tt(
...
function Do({
  ...
  return /* @__PURE__ */ p(ea, { children: [
    /* @__PURE__ */ r(aa, { className: o, style: n }),
    /* @__PURE__ */ p(
      q.Content,
      {
...
function le({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ra, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ r(
        ot.Input,
        {
      ...
      /* @__PURE__ */ r(sa, { children: /* @__PURE__ */ r(Le, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Yo = Object.fromEntries(
  da.map((t) => [t, L.bookIdToEnglishName(t)])
);
function Qo(t, e, a) {
...
const nr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function ma({
  className: t,
...
const dr = "data-platform-content-zoom-root", cr = "data-platform-content-zoom-popup", ha = "--platform-content-zoom-", ga = "--platform-content-zoom-default", ba = "main", va = "--platform-content-zoom-popup-factor", pe = Wt(void 0);
function ur({ area: t, children: e }) {
...
function ya({ variant: t = "default", ...e }) {
...
const Ia = "min(8rem, calc(max(var(--radix-dropdown-menu-content-available-width, 100vw), 8rem) / var(--platform-content-zoom-popup-factor, 1)))";
function ka({
  className: t,
  align: e = "start",
  sideOffset: a = 4,
...
function _a({ className: t, inset: e, ...a }) {
  return /* @__PURE__ */ r(
    E.Label,
    {
...
function Sr({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        s === "rtl" ? /* @__PURE__ */ r(Ae, { className: "tw:ms-auto" }) : /* @__PURE__ */ r(ze, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const La = ["input", "select", "textarea", "button"], Aa = ["button", "textbox"], zr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
...
function Ur({
  ...
  const [$, F] = Z(!1), K = J(
    (S) => {
      var O;
      const A = (O = t.find((P) => P.label === S)) == null ? void 0 : O.value;
      A && a(
        e.includes(A) ? e.filter((P) => P !== A) : [...e, A]
      );
    },
    [t, e, a]
  ), W = () => u || o, j = Q(() => {
    if (!k) return t;
    const S = t.filter((O) => O.starred).sort((O, P) => O.label.localeCompare(P.label)), A = t.filter((O) => !O.starred).sort((O, P) => {
        ...
        /* @__PURE__ */ r(ue, { children: j.map((S) => /* @__PURE__ */ p(
          Lt,
          {
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ r(je, { className: "tw:h-4 tw:w-4" }),
...
function $r(t, e, a) {
  ...
  if (Pa(t) || $e.has(t.key) || t.key === "Dead")
    return "passed";
...
function Fa(t, e) {
  if (e.id === "openTabs") return Ua(t);
  if (e.id === "selection") return $a(t, e);
...
function Va(t) {
  ...
  return [
    xe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? mt : Ka;
      },
...
function pt(t) {
  return ua[Fe(t)] ?? String(t);
}
const Zt = "platform.footerAction", qa = {
...
function Ya({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: I
  } = xa(), [k, w] = Z(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || k, h = J(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  e === "project" ? t.openGroups.length > 0 && (K = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ r(gt, { variant: "secondary", children: pt(R) }, R)) })) : t.scrollGroupId !== void 0 && (K = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      X,
      {
        ...
        children: [
          /* @__PURE__ */ r(Oe, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
...
function Qa({
  ...
  return /* @__PURE__ */ p(ya, { children: [
    /* @__PURE__ */ p(jt, { children: [
      /* @__PURE__ */ r(Rt, { asChild: !0, children: /* @__PURE__ */ r(Sa, { asChild: !0, children: /* @__PURE__ */ r(
        X,
        {
          variant: "ghost",
          size: "sm",
          ...
          children: /* @__PURE__ */ r(Re, { className: "tw:h-4 tw:w-4" })
        }
      ) }) }),
    ...
    /* @__PURE__ */ p(
      ka,
      {
        ...
        style: { zIndex: oe },
        children: [
          /* @__PURE__ */ r(_a, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(Ea, { value: e, onValueChange: a, children: [
...
function Qr(t) {
  const [e, a] = Z(!1), [o, n] = Z(""), s = Q(() => Za(t.localizedStrings), [t.localizedStrings]), i = Q(() => {
  ...
  }, A = t.mode === "project" ? t.renderTriggerLabel : void 0, O = t.mode === "project" ? t.triggerLabelFormat : void 0, P = Q(() => {
    switch (t.mode) {
      case "project": {
        const c = F(t.selection.projectId);
        if (A) return { node: A(c), title: "" };
  ...
  let lt;
  t.isLoading ? lt = /* @__PURE__ */ r(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : it ? lt = void 0 : t.mode === "project-multi" ? lt = /* @__PURE__ */ r(te, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : lt = /* @__PURE__ */ r(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
              ...
              /* @__PURE__ */ p(de, { children: [
                ...
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(ue, { heading: eo(c, s), children: c.rows.map((D) => /* @__PURE__ */ r(
                          Ya,
                          {
                            row: D,
                            mode: t.mode,
...
const en = (t, e, a) => ro(t, e).every((o) => a.includes(o));
function no(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => L.bookIdToNumber(o) > 0).sort((o, n) => L.bookIdToNumber(o) - L.bookIdToNumber(n)).map((o) => wa(o, e));
}
function an(t, e, a, o) {
  ...
  const i = no(t, o);
  if (i.length !== 0)
    return i.length <= oo ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
...
function nn({
  ...
  return /* @__PURE__ */ p(so, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(io, { children: [
      /* @__PURE__ */ r(co, { variant: "icon", children: o ?? /* @__PURE__ */ r(He, {}) }),
      /* @__PURE__ */ r(uo, { children: t })
    ] }),
    a && /* @__PURE__ */ r(wo, { children: /* @__PURE__ */ r(X, { onClick: () => a(), children: e }) })
  ] });
}
const po = Qt(({ className: t, ...e }, a) => /* @__PURE__ */ r(Ue, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CWtB8J0u.js.map
