...
const fa = "min(8rem, calc(var(--radix-dropdown-menu-content-available-width, 100vw) / var(--platform-content-zoom-popup-factor, 1)))";
function ha({
  className: t,
  align: e = "start",
  sideOffset: a = 4,
...
//# sourceMappingURL=resizable-o0SXfO19.js.map
