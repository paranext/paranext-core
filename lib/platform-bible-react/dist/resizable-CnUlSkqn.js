...
import Z, { useRef as nt, useState as R, useCallback as O, createContext as Ct, useContext as St, useEffect as Gt, useMemo as A, Fragment as zt } from "react";
...
function Zt({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: i, children: /* @__PURE__ */ I(Wt, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ r(Xt, { children: /* @__PURE__ */ r(Pt, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Y({ className: t, variant: e = "default", asChild: n = !1, ...i }) {
...
function Ie({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ r(Y, { variant: "secondary", children: n });
}
function ye({ row: t, mode: e, strings: n, onClick: i, onOpen: o, selectedRowRef: a }) {
  ...
  let c;
  e === "project" ? t.openGroups.length > 0 && (c = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((z) => /* @__PURE__ */ r(Y, { variant: "secondary", children: K(z) }, z)) })) : t.scrollGroupId !== void 0 && (c = /* @__PURE__ */ I("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ r(
      Ie,
      {
      ...
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ I(pt, { children: [
            /* @__PURE__ */ r(Y, { variant: "muted", className: "tw:shrink-0", children: C }),
  ...
  return /* @__PURE__ */ I(ne, { open: e, onOpenChange: w, children: [
    ...
    /* @__PURE__ */ r(
      re,
      {
        ...
        children: /* @__PURE__ */ r(st, { delayDuration: 400, children: /* @__PURE__ */ I(Yt, { shouldFilter: !1, children: [
...
//# sourceMappingURL=resizable-CnUlSkqn.js.map
