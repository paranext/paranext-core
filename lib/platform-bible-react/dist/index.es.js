import { jsx as k, jsxs as He, Fragment as Sn } from "react/jsx-runtime";
import { Button as xn, Autocomplete as wn, TextField as Lt, FormControlLabel as Zr, FormLabel as Tn, Checkbox as Cn, MenuItem as On, Grid as qt, IconButton as Xt, Paper as _n, Slider as $n, Snackbar as Rn, Switch as An, AppBar as Pn, Toolbar as Mn, Drawer as In } from "@mui/material";
import * as rr from "react";
import { useMemo as Ir, useState as Le, useCallback as cr, useRef as Rr, useEffect as dr } from "react";
...
function Ti({
  ...
  return /* @__PURE__ */ He(Sn, { children: [
    /* @__PURE__ */ k(
      Zr,
      {
...
function Ln({
  ...
  const c = /* @__PURE__ */ k(
    Cn,
    {
      ...
      defaultChecked: a,
      disabled: s,
      className: `papi-checkbox ${l ? "error" : ""} ${u ?? ""}`,
      onChange: i
    }
  );
  let d;
  if (t) {
    const f = n === je.Before || n === je.Above, b = /* @__PURE__ */ k("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${u ?? ""}`, children: t }), y = n === je.Before || n === je.After, h = y ? b : /* @__PURE__ */ k("div", { children: b }), p = y ? c : /* @__PURE__ */ k("div", { children: c });
    d = /* @__PURE__ */ He(
      Tn,
      {
...
function Xn({ commandHandler: e, name: r, className: t, items: n, id: o }) {
  return /* @__PURE__ */ He(qt, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${t ?? ""}`, children: [
...
function Ge(e, r = !0) {
  return r && (e = e.toUpperCase()), e in Qr ? Qr[e] : 0;
}
function Dr(e) {
  return Ge(e) > 0;
}
...
function ro(e) {
  return Jt[e - 1].includes("*obsolete*");
}
function to() {
  const e = {};
...
var Kt = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(Kt || {});
const _ = class {
  constructor(r, t, n, o) {
  ...
  allVerses(r = !1, t = _.verseRangeSeparators, n = _.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], a = et(this._verse, n);
    for (const s of a.map((l) => et(l, t))) {
      const l = this.clone();
      l.verse = s[0];
      const u = l.verseNum;
...
function Ue(e, r = !0) {
  return r && (e = e.toUpperCase()), e in rt ? rt[e] : 0;
}
function zr(e) {
  return Ue(e) > 0;
}
...
function Qt(e) {
  return e <= 0 || e > Zt ? "******" : Wt[e - 1];
}
function fo(e) {
  return Qt(Ue(e));
}
function en(e) {
  const r = typeof e == "number" ? Lr(e) : e;
  return zr(r) && !jr.includes(r);
}
function po(e) {
  const r = typeof e == "number" ? Lr(e) : e;
  return zr(r) && jr.includes(r);
...
function ho(e) {
  return Wt[e - 1].includes("*obsolete*");
}
function mo() {
  const e = {};
...
var rn = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(rn || {});
const $ = class {
  constructor(e, r, t, n) {
  ...
  allVerses(e = !1, r = $.verseRangeSeparators, t = $.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const n = [], o = tt(this._verse, t);
    for (const a of o.map((s) => tt(s, r))) {
      const s = this.clone();
      s.verse = a[0];
      const l = s.verseNum;
...
}))), Er), nn = 1, go = tn.length - 1, on = 1, an = 1, sn = (e) => {
  var r;
  return ((r = tn[e]) == null ? void 0 : r.chapters) ?? -1;
}, nt = (e, r) => ({
  bookNum: Math.max(nn, Math.min(e.bookNum + r, go)),
  chapterNum: 1,
  verseNum: 1
}), ot = (e, r) => ({
  ...e,
  chapterNum: Math.min(
    Math.max(on, e.chapterNum + r),
    sn(e.bookNum)
  ),
  verseNum: 1
}), at = (e, r) => ({
  ...e,
  verseNum: Math.max(an, e.verseNum + r)
});
...
function sr(e) {
  return function(r, t, n) {
    ...
    o.set(r, t), o.set(t, r);
    var l = e(r, t, n);
    return o.delete(r), o.delete(t), l;
  };
}
function it(e) {
  return bo(e).concat(yo(e));
}
var cn = Object.hasOwn || function(e, r) {
  return vo.call(e, r);
};
function Fe(e, r) {
  return e || r ? e === r : e === r || e !== e && r !== r;
}
var ln = "_owner", ct = Object.getOwnPropertyDescriptor, lt = Object.keys;
function No(e, r, t) {
  var n = e.length;
  if (r.length !== n)
    return !1;
...
function ut(e, r, t) {
  if (e.size !== r.size)
    return !1;
  for (var n = {}, o = e.entries(), a = 0, s, l; (s = o.next()) && !s.done; ) {
    for (var u = r.entries(), i = !1, c = 0; (l = u.next()) && !l.done; ) {
      var d = s.value, f = d[0], b = d[1], y = l.value, h = y[0], p = y[1];
      !i && !n[c] && (i = t.equals(f, h, a, c, e, r, t) && t.equals(b, p, f, h, e, r, t)) && (n[c] = !0), c++;
    }
    if (!i)
      return !1;
    a++;
...
function ko(e, r, t) {
  var n = lt(e), o = n.length;
  if (lt(r).length !== o)
    return !1;
  for (var a; o-- > 0; )
    if (a = n[o], a === ln && (e.$$typeof || r.$$typeof) && e.$$typeof !== r.$$typeof || !cn(r, a) || !t.equals(e[a], r[a], a, a, e, r, t))
      return !1;
  return !0;
}
function Ye(e, r, t) {
  var n = it(e), o = n.length;
  if (it(r).length !== o)
    return !1;
  for (var a, s, l; o-- > 0; )
    if (a = n[o], a === ln && (e.$$typeof || r.$$typeof) && e.$$typeof !== r.$$typeof || !cn(r, a) || !t.equals(e[a], r[a], a, a, e, r, t) || (s = ct(e, a), l = ct(r, a), (s || l) && (!s || !l || s.configurable !== l.configurable || s.enumerable !== l.enumerable || s.writable !== l.writable)))
      return !1;
  return !0;
}
function So(e, r) {
...
function ft(e, r, t) {
  ...
  for (var n = {}, o = e.values(), a, s; (a = o.next()) && !a.done; ) {
    for (var l = r.values(), u = !1, i = 0; (s = l.next()) && !s.done; )
...
var To = "[object Arguments]", Co = "[object Boolean]", Oo = "[object Date]", _o = "[object Map]", $o = "[object Number]", Ro = "[object Object]", Ao = "[object RegExp]", Po = "[object Set]", Mo = "[object String]", Io = Array.isArray, dt = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, pt = Object.assign, Bo = Object.prototype.toString.call.bind(Object.prototype.toString);
function Do(e) {
  var r = e.areArraysEqual, t = e.areDatesEqual, n = e.areMapsEqual, o = e.areObjectsEqual, a = e.arePrimitiveWrappersEqual, s = e.areRegExpsEqual, l = e.areSetsEqual, u = e.areTypedArraysEqual;
  return function(i, c, d) {
    ...
    if (f === Set)
      return l(i, c, d);
    var b = Bo(i);
    return b === Oo ? t(i, c, d) : b === Ao ? s(i, c, d) : b === _o ? n(i, c, d) : b === Po ? l(i, c, d) : b === Ro ? typeof i.then != "function" && typeof c.then != "function" && o(i, c, d) : b === To ? o(i, c, d) : b === Co || b === $o || b === Mo ? a(i, c, d) : !1;
  };
}
function Vo(e) {
  var r = e.circular, t = e.createCustomConfig, n = e.strict, o = {
    ...
    areDatesEqual: Eo,
    areMapsEqual: n ? st(ut, Ye) : ut,
    areObjectsEqual: n ? Ye : ko,
    arePrimitiveWrappersEqual: So,
    areRegExpsEqual: xo,
    areSetsEqual: n ? st(ft, Ye) : ft,
    areTypedArraysEqual: n ? Ye : wo
  };
  if (t && (o = pt({}, o, t(o))), r) {
    var a = sr(o.areArraysEqual), s = sr(o.areMapsEqual), l = sr(o.areObjectsEqual), u = sr(o.areSetsEqual);
    o = pt({}, o, {
      areArraysEqual: a,
      areMapsEqual: s,
      areObjectsEqual: l,
...
function zo(e) {
  ...
  if (n)
    return function(l, u) {
      var i = n(), c = i.cache, d = c === void 0 ? r ? /* @__PURE__ */ new WeakMap() : void 0 : c, f = i.meta;
      return t(l, u, {
        cache: d,
        equals: o,
        meta: f,
...
function Se(e) {
  e === void 0 && (e = {});
  var r = e.circular, t = r === void 0 ? !1 : r, n = e.createInternalComparator, o = e.createState, a = e.strict, s = a === void 0 ? !1 : a, l = Vo(e), u = Do(l), i = n ? n(u) : jo(u);
...
function _i({ scrRef: e, handleSubmit: r, id: t }) {
  const n = (u) => {
    r(u);
  }, o = (u, i) => {
  ...
  return /* @__PURE__ */ He("span", { id: t, children: [
    ...
    /* @__PURE__ */ k(
      ...
      {
        onClick: () => r(at(e, -1)),
        isDisabled: e.verseNum <= an,
        children: "<"
      }
    ),
    /* @__PURE__ */ k(Pe, { onClick: () => r(at(e, 1)), children: ">" })
  ] });
}
function $i({ onSearch: e, placeholder: r, isFullWidth: t }) {
  const [n, o] = Le(""), a = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ k(_n, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ k(
    ur,
    {
      isFullWidth: t,
...
function ht({ onRowChange: e, row: r, column: t }) {
  const n = (o) => {
...
function Mi({
  ...
  const de = Ir(() => {
    const re = e.map((W) => typeof W.editable == "function" ? {
      ...
      renderEditCell: W.renderEditCell || ht
    } : W.editable && !W.renderEditCell ? { ...W, renderEditCell: ht } : W.renderEditCell && !W.editable ? { ...W, editable: !1 } : W);
    return c ? [{ ...Dn, minWidth: d }, ...re] : re;
  }, [e, c, d]);
  return /* @__PURE__ */ k(
    Bn,
    {
...
function be(e, r, t = {
  ...
  return ze(e) && ze(r) && Object.keys(r).forEach((o) => {
    o !== "__proto__" && (ze(r[o]) && o in e && ze(e[o]) ? n[o] = be(e[o], r[o], t) : t.clone ? n[o] = ze(r[o]) ? un(r[o]) : r[o] : n[o] = r[o]);
  }), n;
}
function Xo(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var Pr = { exports: {} }, ir = { exports: {} }, L = {};
...
function Jo() {
  ...
  return L.AsyncMode = u, L.ConcurrentMode = i, L.ContextConsumer = l, L.ContextProvider = s, L.Element = r, L.ForwardRef = c, L.Fragment = n, L.Lazy = y, L.Memo = b, L.Portal = t, L.Profiler = a, L.StrictMode = o, L.Suspense = d, L.isAsyncMode = function(m) {
    return P(m) || V(m) === u;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === i || m === a || m === o || m === d || m === f || typeof m == "object" && m !== null && (m.$$typeof === y || m.$$typeof === b || m.$$typeof === s || m.$$typeof === l || m.$$typeof === c || m.$$typeof === p || m.$$typeof === S || m.$$typeof === Y || m.$$typeof === h);
  }, L.typeOf = V, L;
}
var q = {};
/** @license React v16.13.1
...
function Ho() {
  return gt || (gt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function V(v) {
      ...
      v === n || v === i || v === a || v === o || v === d || v === f || typeof v == "object" && v !== null && (v.$$typeof === y || v.$$typeof === b || v.$$typeof === s || v.$$typeof === l || v.$$typeof === c || v.$$typeof === p || v.$$typeof === S || v.$$typeof === Y || v.$$typeof === h);
    }
    function P(v) {
    ...
    var m = u, Z = i, oe = l, ue = s, ce = r, j = c, Q = n, fe = y, de = b, re = t, W = a, te = o, le = d, we = !1;
    function Re(v) {
...
var bt;
function fn() {
  return bt || (bt = 1, process.env.NODE_ENV === "production" ? ir.exports = Jo() : ir.exports = Ho()), ir.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Go() {
  ...
  return Sr = o() ? Object.assign : function(a, s) {
    for (var l, u = n(a), i, c = 1; c < arguments.length; c++) {
...
var wr, Nt;
function dn() {
  return Nt || (Nt = 1, wr = Function.call.bind(Object.prototype.hasOwnProperty)), wr;
}
var Tr, Et;
function Uo() {
  if (Et)
        ...
        if (n(a, c)) {
          ...
          try {
            if (typeof a[c] != "function") {
              var f = Error(
                (u || "React class") + ": " + l + " type `" + c + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof a[c] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`."
              );
              throw f.name = "Invariant Violation", f;
            }
            d = a[c](s, c, u, l, null, r);
          } catch (y) {
            d = y;
          }
          if (d && !(d instanceof Error) && e(
            (u || "React class") + ": type specification of " + l + " `" + c + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof d + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
          ), d instanceof Error && !(d.message in t)) {
            t[d.message] = !0;
            var b = i ? i() : "";
            e(
              "Failed " + l + " type: " + d.message + (b ?? "")
            );
          }
        }
    }
...
function Fo() {
  if (kt)
    return Cr;
  kt = 1;
  var e = fn(), r = Go(), t = qr(), n = dn(), o = Uo(), a = function() {
  };
...
function Qo() {
  if (xt)
    return X;
  xt = 1;
  var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), t = Symbol.for("react.fragment"), n = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), u = Symbol.for("react.forward_ref"), i = Symbol.for("react.suspense"), c = Symbol.for("react.suspense_list"), d = Symbol.for("react.memo"), f = Symbol.for("react.lazy"), b = Symbol.for("react.offscreen"), y;
  ...
  return X.ContextConsumer = s, X.ContextProvider = a, X.Element = e, X.ForwardRef = u, X.Fragment = t, X.Lazy = f, X.Memo = d, X.Portal = r, X.Profiler = o, X.StrictMode = n, X.Suspense = i, X.SuspenseList = c, X.isAsyncMode = function() {
    return !1;
    ...
    return typeof p == "string" || typeof p == "function" || p === t || p === o || p === n || p === i || p === c || p === b || typeof p == "object" && p !== null && (p.$$typeof === f || p.$$typeof === d || p.$$typeof === a || p.$$typeof === s || p.$$typeof === u || p.$$typeof === y || p.getModuleId !== void 0);
  }, X.typeOf = h, X;
}
var J = {};
/**
...
function ea() {
  return wt || (wt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function P(E) {
      return !!(typeof E == "string" || typeof E == "function" || E === t || E === o || Y || E === n || E === i || E === c || S || E === b || y || h || p || typeof E == "object" && E !== null && (E.$$typeof === f || E.$$typeof === d || E.$$typeof === a || E.$$typeof === s || E.$$typeof === u || // This needs to include all possible module reference object
    ...
    var Z = s, oe = a, ue = e, ce = u, j = t, Q = f, fe = d, de = r, re = o, W = n, te = i, le = c, we = !1, Re = !1;
    function g(E) {
...
process.env.NODE_ENV === "production" ? Mr.exports = Qo() : Mr.exports = ea();
var Tt = Mr.exports;
...
function pa(e) {
  ...
  function c(f) {
    return s.indexOf(f) + 1 < s.length ? i(f, s[s.indexOf(f) + 1]) : l(f);
  }
  function d(f) {
    const b = s.indexOf(f);
    return b === 0 ? l(s[1]) : b === s.length - 1 ? u(s[b]) : i(f, s[s.indexOf(f) + 1]).replace("@media", "@media not all and");
  }
  return M({
    keys: s,
    values: a,
...
function ye(e, r, t) {
  const n = e.theme || {};
  if (Array.isArray(r)) {
    const a = n.breakpoints || _t;
    return r.reduce((s, l, u) => (s[a.up(a.keys[u])] = t(r[u]), s), {});
  }
  if (typeof r == "object") {
    const a = n.breakpoints || _t;
...
function H(e) {
  const {
    ...
    if (s[r] == null)
      return null;
    const l = s[r], u = s.theme, i = pr(u, n) || {};
    return ye(s, l, (d) => {
      let f = fr(i, o, d);
...
const Ka = H({
  ...
  if (e.maxWidth !== void 0 && e.maxWidth !== null) {
    const r = (t) => {
      var n;
      return {
        maxWidth: ((n = e.theme) == null || (n = n.breakpoints) == null || (n = n.values) == null ? void 0 : n[t]) || Jr[t] || ne(t)
      };
    };
...
function os() {
  function e(t, n, o, a) {
    ...
    return d ? d(s) : ye(s, n, (y) => {
      let h = fr(f, c, y);
      return y === h && typeof y == "string" && (h = fr(f, c, `${t}${y === "default" ? "" : he(y)}`, y)), u === !1 ? h : {
        [u]: h
      };
    });
  }
  function r(t) {
    ...
    if (!o)
      return null;
    const s = (n = a.unstable_sxConfig) != null ? n : Gr;
    function l(u) {
      let i = u;
      ...
      if (!i)
        return null;
      const c = ba(a.breakpoints), d = Object.keys(c);
      let f = c;
...
const yn = os();
yn.filterProps = ["sx"];
const Ur = yn, as = ["breakpoints", "palette", "spacing", "shape"];
function Fr(e = {}, ...r) {
  const {
    breakpoints: t = {},
    palette: n = {},
  ...
  return i = r.reduce((c, d) => be(c, d), i), i.unstable_sxConfig = M({}, Gr, s == null ? void 0 : s.unstable_sxConfig), i.unstable_sx = function(d) {
    return Ur({
      sx: d,
      theme: this
    });
...
function vn(e) {
  ...
  return Object.keys(t).sort().forEach((o) => {
    o === "color" ? n += Rt(n) ? e[o] : he(e[o]) : n += `${Rt(n) ? o : he(o)}${he(e[o].toString())}`;
  }), n;
}
...
const hs = (e, r) => r.components && r.components[e] && r.components[e].styleOverrides ? r.components[e].styleOverrides : null, ms = (e, r) => {
  ...
  const {
    ownerState: a = {}
  } = e, s = [], l = t == null || (o = t.components) == null || (o = o[n]) == null ? void 0 : o.variants;
  return l && l.forEach((u) => {
    let i = !0;
    Object.keys(u.props).forEach((c) => {
      a[c] !== u.props[c] && e[c] !== u.props[c] && (i = !1);
    }), i && s.push(r[vn(u.props)]);
  }), s;
};
function lr(e) {
  return e !== "ownerState" && e !== "theme" && e !== "sx" && e !== "as";
}
const bs = Fr(), At = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function Ze({
  defaultTheme: e,
  theme: r,
  themeId: t
...
function vs(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: f = ys(At(i))
    } = l, b = ve(l, fs), y = c !== void 0 ? c : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      i && i !== "Root" && i !== "root" || !1
    ), h = d || !1;
    let p;
    process.env.NODE_ENV !== "production" && u && (p = `${u}-${At(i || "Root")}`);
    let S = lr;
...
function Ss(e) {
  ...
  const {
    values: r
  } = e, t = r[0], n = r[1] / 100, o = r[2] / 100, a = n * Math.min(o, 1 - o), s = (i, c = (i + t / 30) % 12) => o - a * Math.max(Math.min(c - 3, 9 - c, 1), -1);
  let l = "rgb";
  const u = [Math.round(s(0) * 255), Math.round(s(8) * 255), Math.round(s(4) * 255)];
  return e.type === "hsla" && (l += "a", u.push(r[3])), Kr({
    type: l,
    values: u
  });
}
...
function xs(e, r) {
  if (e = Je(e), r = Nn(r), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - r;
...
const Cs = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Ve = Is, Bs = ["mode", "contrastThreshold", "tonalOffset"], It = {
...
function Xs(e) {
  const {
    ...
    tonalOffset: n = 0.2
  } = e, o = ve(e, Bs), a = e.primary || Ds(r), s = e.secondary || Vs(r), l = e.error || js(r), u = e.info || zs(r), i = e.success || Ls(r), c = e.warning || qs(r);
  function d(h) {
    const p = Mt(h, _r.text.primary) >= t ? _r.text.primary : It.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = Mt(h, p);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return Bt(h, "light", Y, n), Bt(h, "dark", V, n), h.contrastText || (h.contrastText = d(h.main)), h;
  }, b = {
    dark: _r,
    light: It
  };
...
function Gs(e, r) {
  ...
  const b = o / 14, y = d || ((S) => `${S / i * b}rem`), h = (S, Y, V, P, m) => M({
    ...
    button: h(l, 14, 1.75, 0.4, Dt),
    caption: h(s, 12, 1.66, 0.4),
    overline: h(s, 12, 2.66, 1, Dt),
  ...
  return M({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        ...
        !c(o) && !Array.isArray(o) && console.error('MUI: Argument "props" must be a string or Array.'), !d(s) && !c(s) && console.error(`MUI: Argument "duration" must be a number or a string but found ${s}.`), c(l) || console.error('MUI: Argument "easing" must be a string.'), !d(u) && !c(u) && console.error('MUI: Argument "delay" must be a number or a string.'), typeof a != "object" && console.error(["MUI: Secong argument of transition.create must be an object.", "Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)), Object.keys(i).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(i).join(",")}].`);
      }
      return (Array.isArray(o) ? o : [o]).map((c) => `${c} ${typeof s == "string" ? s : jt(s)} ${l} ${typeof u == "string" ? u : jt(u)}`).join(",");
    }
  }, e, {
    easing: r,
    duration: t
...
function si(e = {}, ...r) {
  ...
  if (i = be(i, s), i = r.reduce((c, d) => be(c, d), i), process.env.NODE_ENV !== "production") {
    const c = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], d = (f, b) => {
      let y;
      for (y in f) {
        const h = f[y];
        if (c.indexOf(y) !== -1 && Object.keys(h).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const p = Xr("", y);
...
`));
  ...
  return i.unstable_sxConfig = M({}, Gr, s == null ? void 0 : s.unstable_sxConfig), i.unstable_sx = function(d) {
    return Ur({
      sx: d,
      theme: this
    });
...
const pi = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], hi = (e) => {
  ...
  return {
    ...
    fontSize: {
      ...
      large: ((i = e.typography) == null || (c = i.pxToRem) == null ? void 0 : c.call(i, 35)) || "2.1875rem"
    }[r.fontSize],
...
}), Wr = /* @__PURE__ */ rr.forwardRef(function(r, t) {
  const n = ci({
    props: r,
    name: "MuiSvgIcon"
  }), {
...
function gi(e, r) {
  ...
  return process.env.NODE_ENV !== "production" && (t.displayName = `${r}Icon`), t.muiName = zt.muiName, /* @__PURE__ */ rr.memo(/* @__PURE__ */ rr.forwardRef(t));
}
...
function Ii({
  ...
  let p = e;
  return !p && r && (p = r(u)), /* @__PURE__ */ k("div", { ref: f, style: { position: "relative" }, children: /* @__PURE__ */ k(Pn, { position: "static", id: o, children: /* @__PURE__ */ He(Mn, { className: `papi-toolbar ${n ?? ""}`, variant: "dense", children: [
    p ? /* @__PURE__ */ k(
      Xt,
      {
        edge: "start",
...
const vi = (e, r, t = {}) => {
  ...
  n.current = r;
  const o = Rr(t);
  o.current = yi(o.current);
  const [a, s] = Le(() => n.current), [l, u] = Le(!0);
  return dr(() => {
    let i = !0;
    return u(!!e), (async () => {
      if (e) {
      ...
      i = !1, o.current.preserveValue || s(() => n.current);
    };
  }, [e]), [a, l];
}, $r = () => !1, Di = (e, r) => {
  const [t] = vi(
