...
import { Slot as ft, Dialog as j, Popover as Y, Tooltip as q, Label as Zt, RadioGroup as ct, ToggleGroup as zt, Separator as Yt, DropdownMenu as z } from "radix-ui";
import { IconX as Qt, IconSearch as te, IconCheck as mt, IconChevronRight as ee } from "@tabler/icons-react";
import { Canon as A } from "@sillsdev/scripture";
import D, { useState as $, useRef as pt, useCallback as F, createContext as ae, useContext as re, useMemo as X, useEffect as oe, Fragment as ne, forwardRef as Dt } from "react";
import { cva as J } from "class-variance-authority";
import { ChevronsUpDown as At, Check as Gt, Star as se, Filter as ie, ArrowRight as le, Loader2 as de, ChevronDown as ce, Search as ue, X as we, LoaderCircle as fe } from "lucide-react";
import { includes as bt, Section as K, MODIFIER_KEYS as me, normalizeProjectId as Q, getLocalizeKeyForScrollGroupId as pe, getSectionForBook as he } from "platform-bible-utils";
...
import { extendTailwindMerge as be, twMerge as ve } from "tailwind-merge";
const Ne = be({ prefix: "tw" });
function ut(t) {
  const e = [];
  let a = "", r = 0;
...
function xe(t) {
  ...
  const e = ut(t), a = e.findIndex((s) => s.startsWith("-tw-"));
  if (a !== -1) {
    const s = e[a].slice(4);
...
function ye(t, e) {
  ...
  const a = ut(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), o = a[a.length - 1], s = ut(e), i = s.some((l) => l.startsWith("-tw-")), d = s.some((l) => l.startsWith("!tw-"));
  if (i && o.startsWith("-")) {
    const l = o.slice(1);
    return [...r, `-tw-${l}`].join(":");
  }
...
function u(...t) {
  ...
  }), ve(o.join(" ")).split(" ").filter(Boolean).map((l) => {
    const c = r.get(l);
    return c ? ye(l, c) : l;
  }).join(" ");
}
const ke = 600, Ba = 650, Rt = 400, Ie = 450, Ce = 500, Se = 550, Oa = 700, Lt = J(
...
function O({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: u(Lt({ variant: e, size: a, className: t })),
      ...o
    }
  );
}
...
function Bt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ g(De, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Ge, { children: /* @__PURE__ */ n(te, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Le() {
  return Nt || (Nt = 1, lt = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", k = `(?:${m}|${h})`, f = `[^${t}]`, v = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", I = "\\u200d", L = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", M = `[${l}]`, _ = `${k}?`, E = `[${d}]?`, T = `(?:${I}(?:${[f, v, x].join("|")})${E + _})*`, G = E + _ + T, S = `(?:${[`${f}${m}?`, m, v, x, c, M].join("|")})`;
    return new RegExp(`${L}|${h}(?=${h})|${S + G}`, "g");
  }), lt;
}
var xt;
function Me() {
  ...
  function d(l, c, m) {
    ...
    for (v = m; v < h.length; v += 1) {
      for (var x = 0; x < k.length && k[x] === h[v + x]; )
        x += 1;
      if (x === k.length && k[x - 1] === h[v + x - 1]) {
        f = !0;
        break;
      }
    }
...
const rr = Object.fromEntries(
  Oe.map((t) => [t, A.bookIdToEnglishName(t)])
);
function or(t, e, a) {
  const r = e.trim().toLowerCase();
  if (!r) return !1;
  const o = A.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
  return !!(o.toLowerCase().includes(r) || t.toLowerCase().includes(r) || (s ? bt(s.localizedName.toLowerCase(), r) || bt(s.localizedId.toLowerCase(), r) : !1));
}
function Ft({ ...t }) {
...
function nr({
  ...
  return /* @__PURE__ */ n(Ht.Provider, { value: t, children: e });
}
function Vt({
  className: t,
  align: e = "center",
...
function ir({ className: t, ...e }) {
  return /* @__PURE__ */ n(
    "div",
    {
      ...
      className: u("pr-twp tw:flex tw:flex-col tw:gap-0.5 tw:text-sm", t),
      ...e
    }
  );
}
function lr({ className: t, ...e }) {
  return /* @__PURE__ */ n(
    "div",
    {
      ...
      className: u("pr-twp tw:font-medium", t),
      ...e
    }
  );
}
function dr({ className: t, ...e }) {
  return /* @__PURE__ */ n(
    "p",
    {
      ...
      className: u("pr-twp tw:text-muted-foreground", t),
      ...e
    }
  );
}
...
function Jt({
  ...
  return /* @__PURE__ */ n(
    q.Trigger,
    {
      ...
      className: e ? u(Lt({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const Je = ["input", "select", "textarea", "button"], Ue = ["button", "textbox"], Nr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = pt(null), [s, i] = $(void 0), [d, l] = $(void 0), c = F(
    (f) => {
      i(f);
      const v = t.find((I) => I.id === f);
      v && (e == null || e(v));
    ...
    (f) => {
      const v = t.find((x) => x.id === f);
      v && (l((x) => x === f ? void 0 : f), a == null || a(v));
    },
    [a, t]
  ), h = (f) => {
    if (!f) return !1;
    const v = f.tagName.toLowerCase();
    if (f.isContentEditable || Je.includes(v)) return !0;
    ...
    (f) => {
      var H;
      const v = f.target, x = (S) => S ? document.getElementById(S) : void 0, I = x(d), L = x(s);
      if (!!(I && v && I.contains(v) && v !== I) && h(v)) {
        if (f.key === "Escape" || f.key === "ArrowLeft" && !v.isContentEditable) {
          if (d) {
            f.preventDefault(), f.stopPropagation();
            const S = t.find((w) => w.id === d);
            S && c(S.id);
          }
          return;
        }
        if (f.key === "ArrowDown" || f.key === "ArrowUp") {
          ...
          const w = S.findIndex((b) => b === v);
          if (w === -1) return;
          let p;
          f.key === "ArrowDown" ? p = Math.min(w + 1, S.length - 1) : p = Math.max(w - 1, 0), p !== w && (f.preventDefault(), f.stopPropagation(), (H = S[p]) == null || H.focus());
          return;
        }
        return;
      }
      ...
      switch (f.key) {
        ...
        default:
          f.key.length === 1 && !f.metaKey && !f.ctrlKey && !f.altKey && (h(v) || (r == null || r(f.key), f.preventDefault()));
          return;
      }
      const G = t[T];
      G && c(G.id);
      ...
      children: [
        /* @__PURE__ */ n(
          "span",
          {
            ...
            children: /* @__PURE__ */ n(z.ItemIndicator, { children: /* @__PURE__ */ n(mt, {}) })
          }
        ),
        e
      ]
  ...
  return (
    ...
    /* @__PURE__ */ n(
      "div",
      {
        ...
        className: u("pr-twp tw:relative tw:w-full", { "tw:p-1": e }),
        children: /* @__PURE__ */ n(
          "table",
          {
            "data-slot": "table",
...
function Rr({ className: t, ...e }) {
  return /* @__PURE__ */ n(
    "tbody",
    {
      ...
      className: u("tw:[&_tr:last-child]:border-0", t),
      ...e
    }
  );
}
...
function Mr({
  ...
  const d = D.useMemo(
    ...
    (m) => {
      ...
      ) : [], v = f.indexOf(h), x = d.indexOf(
        // activeElement is generic Element, so we need to cast it to HTMLElement
        // eslint-disable-next-line no-type-assertion/no-type-assertion
        document.activeElement
      );
      if (m.key === "ArrowDown" || m.key === "ArrowUp")
        m.preventDefault(), aa(f, v, m.key);
...
function jr({
  ...
  const [L, M] = $(!1), _ = F(
    ...
    const p = t.filter((y) => y.starred).sort((y, N) => y.label.localeCompare(N.label)), b = t.filter((y) => !y.starred).sort((y, N) => {
      const V = e.includes(y.value), at = e.includes(N.value);
      return V && !at ? -1 : !V && at ? 1 : y.label.localeCompare(N.label);
    });
    return [...p, ...b];
  }, [t, e, k]), G = () => {
    a(t.map((p) => p.value));
  ...
  return /* @__PURE__ */ n("div", { id: I, className: v, children: /* @__PURE__ */ g(Ft, { open: S, onOpenChange: m ?? M, children: [
    /* @__PURE__ */ n(wt, { asChild: !0, children: /* @__PURE__ */ g(
      O,
      {
        variant: x,
        role: "combobox",
        ...
        children: [
          ...
          /* @__PURE__ */ n(At, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ n(Vt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(Pt, { children: [
      /* @__PURE__ */ n(
        Bt,
        {
      ...
      o && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: G, children: s }),
        /* @__PURE__ */ n(O, { variant: "ghost", size: "sm", onClick: H, children: i })
      ] }),
...
function Fr(t) {
  ...
  o.current += 1;
  const f = o.current, v = a ? "backslash" : "selection", x = { kind: v, token: f, filter: "", items: e };
  v === "backslash" && r && (x.shouldSpaceCommit = r), s(x), l({
...
function Vr({ className: t, ...e }) {
  return /* @__PURE__ */ n(
    ...
    {
      "data-slot": "kbd-group",
      className: u("pr-twp tw:inline-flex tw:items-center tw:gap-1", t),
      ...e
    }
  );
}
...
function pa({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: c
  } = Fe(), [m, h] = $(!1), k = !!(t.language || t.languageCode), f = k || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = d || m, x = F(() => {
    if (f) {
      h(!0);
      return;
    }
    ...
    h(!1), c();
  }, [c]), L = /* @__PURE__ */ n(Gt, { className: u("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let M;
  e === "project" ? t.openGroups.length > 0 && (M = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((G) => /* @__PURE__ */ n(ot, { variant: "secondary", children: et(G) }, G)) })) : t.scrollGroupId !== void 0 && (M = /* @__PURE__ */ g("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      ma,
      {
  ...
  return /* @__PURE__ */ g(Kt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Jt, { asChild: !0, children: _ }),
    /* @__PURE__ */ g(
      Ut,
      {
        side: "top",
...
function Kr(t) {
  const [e, a] = $(!1), [r, o] = $(""), [s, i] = $(t.defaultGroupByOpenTabs ?? !0), [d, l] = $(!1), c = pt(null), m = F((w) => {
    a(w), w || o("");
  }, []);
  oe(() => {
    if (!e) return;
  ...
  const h = wa(t.localizedStrings), k = X(() => t.mode === "project" ? dt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
  }) : t.mode === "project-multi" ? dt({
    mode: "project-multi",
    projects: t.projects,
    openTabs: t.openTabs,
    selection: t.selection
    ...
    let p = k;
    return w && (p = p.filter(
      (b) => b.shortName.toLowerCase().includes(w) || b.fullName.toLowerCase().includes(w) || (b.language ?? "").toLowerCase().includes(w) || (b.languageCode ?? "").toLowerCase().includes(w)
    ...
    return t.projects.forEach((p) => {
      ...
      b.forEach((N) => {
        y.has(N.scrollGroupId) || (y.add(N.scrollGroupId), w.push({ projectId: p.id, scrollGroupId: N.scrollGroupId }));
      });
    }), w;
  }, [t.mode, t.projects, t.openTabs]), I = (w) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, b = (N) => N.projectId === w.projectId && N.scrollGroupId === w.scrollGroupId, y = p.some(b) ? p.filter((N) => !b(N)) : [...p, { projectId: w.projectId, scrollGroupId: w.scrollGroupId }];
    ...
    if (t.mode !== "project-multi") return;
    const w = t.selection.pairs, p = new Set(w.map((y) => `${y.projectId}:${y.scrollGroupId ?? ""}`)), b = [...w];
    x.forEach((y) => {
    ...
    switch (t.mode) {
      case "project": {
        const w = t.projects.find((b) => b.id === t.selection.projectId);
      ...
      case "project-multi": {
        ...
        const p = [];
        if (w.forEach((N) => {
          const V = t.projects.find((at) => at.id === N.projectId);
          V && p.push({ project: V, scrollGroupId: N.scrollGroupId });
        }), p.length === 0) {
          const N = t.buttonPlaceholder ?? "";
          return { node: N, title: N };
        }
        ...
        const b = p.map(
          ({ project: N, scrollGroupId: V }) => V === void 0 ? N.shortName : `${N.shortName} (${et(V)})`
        ).join(", ");
        if (p.length === 1) return { node: b, title: b };
        const y = p.length.toString();
        return {
          node: /* @__PURE__ */ g(Tt, { children: [
            /* @__PURE__ */ n(ot, { variant: "muted", className: "tw:shrink-0", children: y }),
  ...
  let T;
  t.isLoading ? T = /* @__PURE__ */ n(de, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? T = void 0 : t.mode === "project-multi" ? T = /* @__PURE__ */ n(At, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : T = /* @__PURE__ */ n(ce, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const G = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? I : void 0, H = /* @__PURE__ */ g(
    O,
    {
  ...
  ), S = E.title ? /* @__PURE__ */ n(yt, { delayDuration: 400, children: /* @__PURE__ */ g(Kt, { children: [
    /* @__PURE__ */ n(Jt, { asChild: !0, children: /* @__PURE__ */ n(wt, { asChild: !0, children: H }) }),
    /* @__PURE__ */ n(Ut, { children: E.title })
  ] }) }) : /* @__PURE__ */ n(wt, { asChild: !0, children: H });
  return /* @__PURE__ */ g(Ft, { open: e, onOpenChange: m, children: [
    S,
    /* @__PURE__ */ n(
      Vt,
      {
        ...
        collisionPadding: 16,
        className: u("tw:w-80 tw:max-w-[calc(100vw-2rem)] tw:p-0", t.popoverContentClassName),
          ...
          /* @__PURE__ */ g(Ot, { children: [
            ...
            v.map((w, p) => (
              ...
              /* @__PURE__ */ g(ne, { children: [
                /* @__PURE__ */ n(_t, { heading: ga(w, h), children: w.rows.map((b) => /* @__PURE__ */ n(
                  pa,
                  {
                    row: b,
                    mode: t.mode,
...
const ba = Dt(
  ({ value: t, onSearch: e, placeholder: a, isFullWidth: r, className: o, isDisabled: s = !1, id: i }, d) => {
    ...
    return /* @__PURE__ */ g(
      ...
      {
        id: i,
        className: u("tw:relative tw:@container/search", { "tw:w-full": r }, o),
        children: [
          /* @__PURE__ */ n(
            ue,
            {
...
const Ur = (t, e, a) => Na(t, e).every((r) => a.includes(r));
function xa(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => A.bookIdToNumber(r) > 0).sort((r, o) => A.bookIdToNumber(r) - A.bookIdToNumber(o)).map((r) => $e(r, e));
}
function Xr(t, e, a, r) {
...
const ya = Dt(({ className: t, ...e }, a) => /* @__PURE__ */ n(fe, { size: 35, className: u("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-CYewDr6Y.js.map
