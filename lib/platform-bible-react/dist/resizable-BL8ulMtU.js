...
import { Slot as It, Dialog as V, Separator as ve, Popover as it, Tooltip as at, DropdownMenu as E, Label as xe, RadioGroup as vt, ToggleGroup as Xt } from "radix-ui";
...
import C, { createContext as Zt, forwardRef as Et, useContext as qt, useState as K, useRef as pt, useCallback as Z, useMemo as Q, useEffect as Dt, Fragment as Ie } from "react";
...
import { filterAndRankItems as Bt } from "@eten-tech-foundation/platform-editor";
...
const Qt = 600, te = 650, xo = 400, Fe = 450, Ke = 500, Ve = 675, yo = 690, So = 700, ko = 800, ee = q(
...
const Ko = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
let yt = "keyboard", Ut = !1;
function Vo() {
...
const qo = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function sa({
  className: t,
...
const tr = "data-platform-content-zoom-root", er = "data-platform-content-zoom-popup", la = "--platform-content-zoom-", da = "--platform-content-zoom-default", ca = "main", ua = "--platform-content-zoom-popup-factor", ce = Zt(void 0);
function wa({ area: t, children: e }) {
...
const pa = Et(
  function({ area: e, ...a }, o) {
    return /* @__PURE__ */ r(wa, { area: e, children: /* @__PURE__ */ r(
      "div",
      {
        ref: o,
        ...a,
...
pa.displayName = "ContentZoomRoot";
function ue({ ...t }) {
...
function pe({
  ...
  const s = M(), i = C.useContext(we), l = At();
  return (
...
const ya = ["input", "select", "textarea", "button"], Sa = ["button", "textbox"], yr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
...
function Gr(t, e, a) {
  ...
  if (Ca(t) || Re.has(t.key) || t.key === "Dead")
    return "passed";
...
const Ot = "Selected", Pt = "Unselected";
function Vt(t) {
...
function La(t) {
  const e = t.filter(Vt).sort(tt), a = t.filter((n) => !Vt(n)).sort(tt);
  if (e.length === 0)
...
function Ra(t, e) {
  const a = t.filter((i) => i.isSelected).sort(tt), o = t.filter((i) => !i.isSelected).sort(tt), n = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? Ot : Pt;
  }, s = [];
...
function Da(t) {
  ...
  return [
    ge(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[nt.lastUsedAt]) == "number" ? ut : Pa;
      },
...
function Ba(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? Ot : e.unselectedSectionHeading ?? Pt
  };
}
function Mr(t) {
  return {
...
const Ma = 100, Ha = {
  ...
  autoSelectionUnselectedSectionHeading: Pt,
...
const Jt = "platform.footerAction", $a = {
...
function Ka({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = ma(), [I, w] = K(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = m || I, h = Z(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  return /* @__PURE__ */ p(Gt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ r(Lt, { asChild: !0, children: X }),
    /* @__PURE__ */ p(
      Rt,
      {
        side: "top",
...
function Va({
  ...
  return /* @__PURE__ */ p(fa, { children: [
    /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(Lt, { asChild: !0, children: /* @__PURE__ */ r(ha, { asChild: !0, children: /* @__PURE__ */ r(
        U,
        {
          variant: "ghost",
          size: "sm",
      ...
      ga,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ p(ba, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ r(Ft, { value: ot, children: o.groupByNone }),
            /* @__PURE__ */ r(va, {}),
            t.map((s) => /* @__PURE__ */ r(Ft, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function $r(t) {
  const [e, a] = K(!1), [o, n] = K(""), s = Ua(t.localizedStrings), i = Q(() => {
  ...
  ), ct = x.title ? /* @__PURE__ */ r($t, { delayDuration: 400, children: /* @__PURE__ */ p(Gt, { children: [
    /* @__PURE__ */ r(Lt, { asChild: !0, children: /* @__PURE__ */ r(St, { asChild: !0, children: rt }) }),
    /* @__PURE__ */ r(Rt, { children: x.title })
              ...
              /* @__PURE__ */ p(se, { children: [
                ...
                J.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(le, { heading: Xa(c, s), children: c.rows.map((R) => {
                          var T;
                          return /* @__PURE__ */ r(
                            Ka,
                            {
                        ...
                        b < J.length - 1 && /* @__PURE__ */ r(Mt, { alwaysRender: !0 })
                      ]
                    },
...
const Kr = (t, e, a) => Wa(t, e).every((o) => a.includes(o));
function Ya(t, e) {
  return [
...
function Zr({
  ...
  return /* @__PURE__ */ p(Qa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(to, { children: [
      /* @__PURE__ */ r(ao, { variant: "icon", children: o ?? /* @__PURE__ */ r(Ge, {}) }),
      /* @__PURE__ */ r(oo, { children: t })
    ] }),
    a && /* @__PURE__ */ r(ro, { children: /* @__PURE__ */ r(U, { onClick: () => a(), children: e }) })
  ] });
}
const no = Et(({ className: t, ...e }, a) => /* @__PURE__ */ r(Le, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
no.displayName = "Spinner";
const so = q(
...
//# sourceMappingURL=resizable-BL8ulMtU.js.map
