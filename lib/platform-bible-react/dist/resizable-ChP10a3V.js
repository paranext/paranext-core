...
import { Slot as _t, Dialog as X, Separator as Ee, Popover as dt, Tooltip as at, DropdownMenu as E, Label as Te, RadioGroup as Nt, ToggleGroup as Zt } from "radix-ui";
import { IconX as Ce, IconCheck as Et, IconSearch as ze, IconChevronRight as Ae } from "@tabler/icons-react";
import { Canon as C } from "@sillsdev/scripture";
import { cva as Y } from "class-variance-authority";
import T, { createContext as qt, useContext as Wt, useState as J, useRef as mt, useCallback as K, useMemo as W, useEffect as Bt, Fragment as Le, forwardRef as Yt } from "react";
import { ChevronsUpDown as Qt, Check as te, Star as Ge, Group as je, ArrowRight as Re, Loader2 as Oe, ChevronDown as De, Search as Pe, X as Be, AlertTriangle as Me, LoaderCircle as He } from "lucide-react";
import { Section as Q, MODIFIER_KEYS as Ue, normalizeProjectId as P, compareProjectsByName as $e, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as it, localizedStringOrUndefined as Fe, formatProjectName as ee, resolveLocalizedString as Ke, getLocalizeKeyForScrollGroupId as Ve, hasDistinctFullName as Je, getSectionForBook as Xe } from "platform-bible-utils";
import { filterAndRankItems as Mt } from "@eten-tech-foundation/platform-editor";
import { Command as et } from "cmdk";
import "@eten-tech-foundation/scripture-utilities";
import * as Tt from "react-resizable-panels";
...
const ae = 600, oe = 650, Ao = 400, ea = 450, aa = 500, Lo = 510, Go = 520, oa = 675, jo = 690, Ro = 700, Oo = 800, re = Y(
...
function Po({ ...t }) {
  return /* @__PURE__ */ r(X.Root, { "data-slot": "dialog", ...t });
}
function Bo({ ...t }) {
  return /* @__PURE__ */ r(X.Trigger, { "data-slot": "dialog-trigger", ...t });
}
function ra({ ...t }) {
  return /* @__PURE__ */ r(X.Portal, { "data-slot": "dialog-portal", ...t });
}
function Mo({ ...t }) {
  return /* @__PURE__ */ r(X.Close, { "data-slot": "dialog-close", ...t });
}
function na({
  className: t,
  ...
  return /* @__PURE__ */ p(ra, { children: [
    ...
    /* @__PURE__ */ p(
      X.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ r(X.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(V, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ r(Ce, {}),
...
function $o({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ r(X.Close, { asChild: !0, children: /* @__PURE__ */ r(V, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function le({
  ...
  return (
    ...
    /* @__PURE__ */ r("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(ia, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ r(da, { children: /* @__PURE__ */ r(ze, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const ca = [
  ...
  var e;
  return ((e = ca[t]) == null ? void 0 : e.chapters) ?? -1;
}, wa = C.allBookIds.filter(
  (t) => !C.isObsolete(C.bookIdToNumber(t))
);
function pa(t) {
  const e = [], a = Math.min(t.length, C.allBookIds.length);
  for (let o = 0; o < a; o += 1)
    t[o] === "1" && e.push(C.bookNumberToId(o + 1));
  return e;
}
function v(t) {
...
function zt(t, e) {
  return ua(C.bookIdToNumber(t));
}
function ht(t, e, a) {
  const o = C.bookIdToNumber(t);
...
function Jo(t, e, a) {
  ...
  const s = ht(o, e, "previous");
  if (s)
    return {
      book: s,
      chapterNum: Math.max(zt(s), 1),
      verseNum: 1
    };
}
function Xo(t, e, a) {
  const { book: o, chapterNum: n } = t;
  if (e.includes(o) && n < zt(o))
    return { book: o, chapterNum: n + 1, verseNum: 1 };
  const s = ht(o, e, "next");
  if (s)
...
function Zo(t, e, a) {
  ...
  if (e === void 0) return;
  const i = ht(o, e, "previous");
  if (!i) return;
  const l = Math.max(zt(i), 1);
...
function tr(t, e) {
  var o;
  return ((o = e == null ? void 0 : e.get(t)) == null ? void 0 : o.localizedName) ?? C.bookIdToEnglishName(t);
}
function fa(t, e) {
  var o;
...
const er = Object.fromEntries(
  wa.map((t) => [t, C.bookIdToEnglishName(t)])
);
function ar(t, e, a) {
...
let yt = "keyboard", $t = !1;
function rr() {
  $t || typeof document > "u" || ($t = !0, document.addEventListener(
    "pointerdown",
    () => {
      yt = "pointer";
    },
...
const wr = "data-platform-content-zoom-root", pr = "data-platform-content-zoom-popup", va = "--platform-content-zoom-", Na = "--platform-content-zoom-default", xa = "main", ya = "--platform-content-zoom-popup-factor", pe = qt(void 0);
...
function me({ ...t }) {
  return /* @__PURE__ */ r(dt.Root, { "data-slot": "popover", ...t });
}
function St({ ...t }) {
  return /* @__PURE__ */ r(dt.Trigger, { "data-slot": "popover-trigger", ...t });
}
...
function he({
  ...
  const s = M(), i = T.useContext(fe), l = At();
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ r(dt.Portal, { container: i ?? void 0, children: /* @__PURE__ */ r(
      dt.Content,
      {
...
function hr({ ...t }) {
  return /* @__PURE__ */ r(dt.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
function Ia({ variant: t = "default", ...e }) {
  const a = M(), o = T.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ r(ge.Provider, { value: o, children: /* @__PURE__ */ r(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Nr({
  ...t
}) {
      ...
      children: [
        /* @__PURE__ */ r(
          "span",
          {
            ...
            children: /* @__PURE__ */ r(E.ItemIndicator, { children: /* @__PURE__ */ r(Et, {}) })
          }
        ),
        e
      ]
...
function _r({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ r(Ae, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const La = ["input", "select", "textarea", "button"], Ga = ["button", "textbox"], Rr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const n = mt(null), [s, i] = J(void 0), [l, u] = J(void 0), m = K(
    (w) => {
      i(w);
    ...
    if (N && Ga.includes(N)) return !0;
    const h = w.getAttribute("tabindex");
    return h !== void 0 && h !== "-1";
  }, k = K(
    (w) => {
      var R;
      const g = w.target, N = (y) => y ? document.getElementById(y) : void 0, h = N(l), H = N(s);
      if (!!(h && g && h.contains(g) && g !== h) && I(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const y = t.find((F) => F.id === l);
            y && m(y.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const F = y.findIndex((z) => z === g);
          if (F === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(F + 1, y.length - 1) : S = Math.max(F - 1, 0), S !== F && (w.preventDefault(), w.stopPropagation(), (R = y[S]) == null || R.focus());
          return;
        }
        return;
      }
      const Z = t.findIndex((y) => y.id === s);
      let j = Z;
      switch (w.key) {
        case "ArrowDown":
          j = Math.min(Z + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          j = Math.max(Z - 1, 0), w.preventDefault();
          break;
        case "Home":
...
function ft({ className: t, variant: e = "default", asChild: a = !1, ...o }) {
    ...
    const a = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const n = t.current ? ct(t.current) : [], s = n.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
...
function Kr({
  ...
  const [H, U] = J(!1), $ = K(
    (S) => {
      var O;
      const z = (O = t.find((_) => _.label === S)) == null ? void 0 : O.value;
      z && a(
        e.includes(z) ? e.filter((_) => _ !== z) : [...e, z]
      );
    },
    [t, e, a]
  ), Z = () => u || o, j = W(() => {
    if (!k) return t;
    const S = t.filter((O) => O.starred).sort((O, _) => O.label.localeCompare(_.label)), z = t.filter((O) => !O.starred).sort((O, _) => {
      const rt = e.includes(O.value), nt = e.includes(_.value);
      return rt && !nt ? -1 : !rt && nt ? 1 : O.label.localeCompare(_.label);
    });
    return [...S, ...z];
  }, [t, e, k]), q = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ r("div", { id: h, className: g, children: /* @__PURE__ */ p(me, { open: y, onOpenChange: f ?? U, children: [
    /* @__PURE__ */ r(St, { asChild: !0, children: /* @__PURE__ */ p(
      V,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ r(Qt, { className: "tw:ml-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" })
        ]
      }
    ) }),
    /* @__PURE__ */ r(he, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ie, { children: [
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: q, children: s }),
        /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: R, children: i })
      ] }),
...
function Vr(t, e, a) {
  ...
  if (Ba(t) || Ue.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (D(t), a.dismiss(), "ended") : (D(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (D(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (D(t), a.dismiss(), "ended") : t.key === "Backspace" || ve[o].test(t.key) ? (D(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && D(t), a.dismiss(), "ended");
}
function Jr(t, e) {
  var a;
  ...
  return t.projects.forEach((n) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Vt(a, n.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: n.isDisabled === !0,
        disabledReason: n.disabledReason,
...
const Ot = "Selected", Dt = "Unselected";
function Jt(t) {
...
function Fa(t) {
  const e = t.filter(Jt).sort(tt), a = t.filter((n) => !Jt(n)).sort(tt);
  if (e.length === 0)
...
function Ka(t, e) {
  const a = t.filter((i) => i.isSelected).sort(tt), o = t.filter((i) => !i.isSelected).sort(tt), n = (i, l) => {
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? Ot : Dt;
  }, s = [];
...
function Xa(t) {
  ...
  return [
    Ne(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[it.lastUsedAt]) == "number" ? wt : Ja;
      },
      ...
      compareSections: (a, o) => a.key === wt ? -1 : o.key === wt ? 1 : 0
    },
    {
      id: "language",
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[it.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var n;
        const o = (n = a.customData) == null ? void 0 : n[it.type];
        return typeof o == "string" ? o : void 0;
      },
...
function Za(t) {
  ...
  return {
    ...
    getSectionHeading: (a) => a === "selected" ? e.selectedSectionHeading ?? Ot : e.unselectedSectionHeading ?? Dt
  };
}
function Qr(t) {
  return {
...
const qa = 100, kt = {
  ...
  autoSelectionSelectedSectionHeading: Ot,
...
const Xt = "platform.footerAction", Qa = {
...
function to({ scrollGroupId: t, isBoundButClosed: e }) {
  ...
  ) : /* @__PURE__ */ r(ft, { variant: "secondary", children: a });
}
function eo({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: I
  } = Sa(), [k, w] = J(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, N = m || k, h = K(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), I();
  }, [I]), U = /* @__PURE__ */ r(te, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let $;
  e === "project" ? t.openGroups.length > 0 && ($ = /* @__PURE__ */ r("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((R) => /* @__PURE__ */ r(ft, { variant: "secondary", children: ut(R) }, R)) })) : t.scrollGroupId !== void 0 && ($ = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ r(
      to,
      {
  ...
  const Z = /* @__PURE__ */ p(
    Ct,
    {
      ...
      children: [
        /* @__PURE__ */ r("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: U }),
  ...
  ), j = t.scrollGroupId !== void 0 ? ut(t.scrollGroupId) : void 0, q = t.isBoundButClosed && j ? a.boundButClosedTooltip.replace("{group}", j) : void 0;
  return /* @__PURE__ */ p(Gt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ r(jt, { asChild: !0, children: Z }),
    /* @__PURE__ */ p(
      Rt,
      {
        side: "top",
        ...
        children: [
          /* @__PURE__ */ r("div", { className: "tw:font-semibold", dir: "auto", children: ee(t) }),
          ...
          q && /* @__PURE__ */ r("div", { className: "tw:text-sm tw:italic", children: q }),
...
function ao({
  ...
  return /* @__PURE__ */ p(Ia, { children: [
    /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ r(jt, { asChild: !0, children: /* @__PURE__ */ r(ka, { asChild: !0, children: /* @__PURE__ */ r(
        V,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      Ea,
      {
        ...
        style: { zIndex: oe },
        children: [
          /* @__PURE__ */ r(Ca, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(Ta, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ r(Kt, { value: ot, children: o.groupByNone }),
            /* @__PURE__ */ r(za, {}),
            t.map((s) => /* @__PURE__ */ r(Kt, { value: s.id, children: s.label }, s.id))
          ] })
        ]
      }
    )
...
function an(t) {
  const [e, a] = J(!1), [o, n] = J(""), s = W(() => Ya(t.localizedStrings), [t.localizedStrings]), i = W(() => {
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, I = mt(null), [k, w] = J(void 0), g = K((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  Bt(() => {
    if (!e) return;
  ...
  const N = W(() => t.mode === "project" ? vt({
    ...
    openTabs: t.openTabs,
    selection: t.selection
  }), [t.mode, t.projects, t.openTabs, t.selection]), h = W(() => {
    ...
    [H]
  ), { renderProjectIndicator: $ } = t, Z = K(
    (c) => $ ? $(c.project) : void 0,
    [$]
  ), j = !!$, q = !!t.footerAction && h.length === 0, R = W(() => {
    if (f === ot) return It(h);
    const c = i.find((b) => b.id === f);
    return c ? Va(h, c) : It(h);
  }, [h, f, i]), y = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, A = P(c.projectId), B = (G) => P(G.projectId) === A && G.scrollGroupId === c.scrollGroupId, L = b.some(B) ? b.filter((G) => !B(G)) : [
          ...b.filter((G) => !B(G)),
  ...
  }, z = t.mode === "project" ? t.renderTriggerLabel : void 0, O = t.mode === "project" ? t.triggerLabelFormat : void 0, _ = W(() => {
    switch (t.mode) {
      case "project": {
        const c = U(t.selection.projectId);
        if (z)
          return { node: z(c), title: "", hasSelection: !!c };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && O === "shortNameAndFullName" && (b = ee(c)), { node: b, title: b, hasSelection: !!c };
      }
      case "project-multi": {
        ...
        const b = [];
        if (c.forEach((L) => {
          const G = U(L.projectId);
          G && b.push({ project: G, scrollGroupId: L.scrollGroupId });
        }), b.length === 0) {
          const L = s.buttonPlaceholder;
          return { node: L, title: L, hasSelection: !1 };
        }
        const A = b.map(
          ({ project: L, scrollGroupId: G }) => G === void 0 ? L.shortName : `${L.shortName} (${ut(G)})`
        ).join(", "), B = b.length.toString();
        return {
          node: /* @__PURE__ */ p(_e, { children: [
            /* @__PURE__ */ r(ft, { variant: "muted", className: "tw:shrink-0", children: B }),
            /* @__PURE__ */ r("span", { className: "tw:min-w-0 tw:truncate", children: A })
          ] }),
          title: `${B} ${A}`,
          hasSelection: !0
        };
      ...
      case "projectScrollGroup": {
        ...
        if (!c) {
          ...
          return { node: B, title: B, hasSelection: !1 };
        }
  ...
  let st;
  t.isLoading ? st = /* @__PURE__ */ r(Oe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : nt ? st = void 0 : t.mode === "project-multi" ? st = /* @__PURE__ */ r(Qt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : st = /* @__PURE__ */ r(De, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const ye = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, Se = s.ariaLabel && _.hasSelection && _.title ? `${s.ariaLabel}: ${_.accessibleTitle ?? _.title}` : s.ariaLabel || void 0, Pt = /* @__PURE__ */ p(
    V,
    {
      ref: rt,
      ...
      children: [
        /* @__PURE__ */ r("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof _.node == "string" ? /* @__PURE__ */ r("span", { className: "tw:min-w-0 tw:truncate", dir: "auto", children: _.node }) : _.node }),
        st
      ]
    }
  ), Ie = _.title ? /* @__PURE__ */ r(Ft, { delayDuration: 400, children: /* @__PURE__ */ p(Gt, { children: [
    /* @__PURE__ */ r(jt, { asChild: !0, children: /* @__PURE__ */ r(St, { asChild: !0, children: Pt }) }),
    /* @__PURE__ */ r(Rt, { dir: "auto", children: _.title })
  ] }) }) : /* @__PURE__ */ r(St, { asChild: !0, children: Pt }), ke = i.length > 1;
  return /* @__PURE__ */ p(me, { open: e, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ r(
      he,
      {
        ...
        children: /* @__PURE__ */ r(Ft, { delayDuration: 400, children: /* @__PURE__ */ p(
          ie,
          {
            shouldFilter: !1,
            value: q ? k ?? Xt : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ r("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ r(V, { variant: "ghost", size: "sm", onClick: S, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(de, { children: [
                ...
                R.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ r(ue, { heading: ro(c, s), children: c.rows.map((A) => /* @__PURE__ */ r(
                          eo,
                          {
                            row: A,
                            mode: t.mode,
                        ...
                        b < R.length - 1 && /* @__PURE__ */ r(Ht, { alwaysRender: !0 })
                      ]
                    },
...
function lo(t, e) {
  ...
  ].filter((o) => C.bookIdToNumber(o) > 0).sort((o, n) => C.bookIdToNumber(o) - C.bookIdToNumber(n)).map((o) => fa(o, e));
}
function nn(t, e, a, o) {
...
function dn({
  ...
  return /* @__PURE__ */ p(co, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(uo, { children: [
      /* @__PURE__ */ r(po, { variant: "icon", children: o ?? /* @__PURE__ */ r(Me, {}) }),
      /* @__PURE__ */ r(mo, { children: t })
    ] }),
    a && /* @__PURE__ */ r(fo, { children: /* @__PURE__ */ r(V, { onClick: () => a(), children: e }) })
  ] });
}
const ho = Yt(({ className: t, ...e }, a) => /* @__PURE__ */ r(He, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-ChP10a3V.js.map
