import { jsx as o, jsxs as p, Fragment as we } from "react/jsx-runtime";
import { Slot as St, Dialog as X, Separator as pe, Popover as it, Tooltip as rt, DropdownMenu as _, Label as me, RadioGroup as Nt, ToggleGroup as $t } from "radix-ui";
import { IconX as fe, IconSearch as he, IconCheck as kt, IconChevronRight as ge } from "@tabler/icons-react";
import { Canon as C } from "@sillsdev/scripture";
import { cva as q } from "class-variance-authority";
import T, { useState as J, useRef as pt, useCallback as K, createContext as be, useContext as Ne, useMemo as tt, useEffect as At, Fragment as ve, forwardRef as Kt } from "react";
import { ChevronsUpDown as Ft, Check as Vt, Star as xe, Group as ye, ArrowRight as Se, Loader2 as ke, ChevronDown as Ie, Search as Ee, X as _e, AlertTriangle as Te, LoaderCircle as Ce } from "lucide-react";
import { Section as Q, MODIFIER_KEYS as Ge, normalizeProjectId as O, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as nt, getLocalizeKeyForScrollGroupId as ze, getSectionForBook as je } from "platform-bible-utils";
...
import { extendTailwindMerge as Ae, twMerge as De } from "tailwind-merge";
...
function Pe(t, e) {
  ...
  const a = vt(t);
  if (a[0] !== "tw") return t;
  const r = a.slice(1, -1), n = a[a.length - 1], s = vt(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && n.startsWith("-")) {
    const u = n.slice(1);
    return [...r, `-tw-${u}`].join(":");
  }
...
const Jt = 600, Xt = 650, dr = 400, Be = 450, Me = 500, cr = 510, ur = 520, He = 675, wr = 690, pr = 700, mr = 800, Wt = q(
...
function Nr({
  ...
  return /* @__PURE__ */ p(Ue, { children: [
    /* @__PURE__ */ o($e, { className: r, style: n }),
    /* @__PURE__ */ p(
      X.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(X.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ p(F, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(fe, {}),
...
function xr({
  ...
  return /* @__PURE__ */ p(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ o(X.Close, { asChild: !0, children: /* @__PURE__ */ o(F, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Yt({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(Fe, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ o(
        at.Input,
        {
      ...
      /* @__PURE__ */ o(Je, { children: /* @__PURE__ */ o(he, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
function Qt({ className: t, ...e }) {
...
function Et({
  ...
  return /* @__PURE__ */ p(
    at.Item,
    {
      ...
      children: [
        e,
        /* @__PURE__ */ o(kt, { className: "tw:ms-auto tw:opacity-0 tw:group-has-data-[slot=command-shortcut]/command-item:hidden tw:group-data-[checked=true]/command-item:opacity-100" })
      ]
    }
  );
}
...
const Xe = [
  ...
  var e;
  return ((e = Xe[t]) == null ? void 0 : e.chapters) ?? -1;
}, Ze = C.allBookIds.filter(
...
function _t(t, e) {
  return We(C.bookIdToNumber(t));
}
function ft(t, e, a) {
  const r = C.bookIdToNumber(t);
  let n, s = a === "next" ? 1 / 0 : -1 / 0;
  return e.forEach((i) => {
    const l = C.bookIdToNumber(i);
...
const Lr = Object.fromEntries(
  Ze.map((t) => [t, C.bookIdToEnglishName(t)])
);
function Ar(t, e, a) {
  const r = e.trim().toLowerCase();
  if (!r) return !1;
  const n = C.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function Tt({ ...t }) {
  return /* @__PURE__ */ o(rt.Root, { "data-slot": "tooltip", ...t });
}
function Ct({
  className: t,
  variant: e,
...
function Gt({
  ...
  return /* @__PURE__ */ o(rt.Portal, { children: /* @__PURE__ */ p(
    rt.Content,
    {
      ...
      children: [
        /* @__PURE__ */ o(
          "span",
          {
            ...
            children: /* @__PURE__ */ o(_.ItemIndicator, { children: /* @__PURE__ */ o(kt, {}) })
          }
        ),
        e
      ]
...
function Zr({
  ...
  return /* @__PURE__ */ p(
    _.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(ge, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ua = ["input", "select", "textarea", "button"], wa = ["button", "textbox"], no = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const n = pt(null), [s, i] = J(void 0), [l, u] = J(void 0), m = K(
    (w) => {
      i(w);
    ...
    (w) => {
      var L;
      const g = w.target, v = (y) => y ? document.getElementById(y) : void 0, h = v(l), M = v(s);
      if (!!(h && g && h.contains(g) && g !== h) && k(g)) {
        if (w.key === "Escape" || w.key === "ArrowLeft" && !g.isContentEditable) {
          if (l) {
            w.preventDefault(), w.stopPropagation();
            const y = t.find((U) => U.id === l);
            y && m(y.id);
          }
          return;
        }
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const U = y.findIndex((E) => E === g);
          if (U === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(U + 1, y.length - 1) : S = Math.max(U - 1, 0), S !== U && (w.preventDefault(), w.stopPropagation(), (L = y[S]) == null || L.focus());
          return;
        }
        return;
      }
      ...
      switch (w.key) {
        ...
        case "ArrowRight": {
          const y = M;
          if (y) {
            const U = y.querySelector(
              'input:not([disabled]):not([type="hidden"]), textarea:not([disabled]), select:not([disabled])'
            ), S = y.querySelector(
              'button:not([disabled]), [href], [tabindex]:not([tabindex="-1"]), [contenteditable="true"]'
            ), E = U ?? S;
            if (E) {
              w.preventDefault(), E.focus();
              return;
            }
          }
          break;
  ...
  const l = T.useMemo(
    ...
    (f) => {
      ...
      if (f.key === "ArrowDown" || f.key === "ArrowUp")
        f.preventDefault(), ha(w, g, f.key);
      else if (f.key === "ArrowLeft" || f.key === "ArrowRight")
        f.preventDefault(), fa(l, v, f.key);
...
function ho({
  ...
  const [M, V] = J(!1), H = K(
    (S) => {
      var A;
      const E = (A = t.find(($) => $.label === S)) == null ? void 0 : A.value;
      E && a(
        e.includes(E) ? e.filter(($) => $ !== E) : [...e, E]
      );
    },
    [t, e, a]
  ), W = () => u || r, j = tt(() => {
    if (!I) return t;
    const S = t.filter((A) => A.starred).sort((A, $) => A.label.localeCompare($.label)), E = t.filter((A) => !A.starred).sort((A, $) => {
      const ct = e.includes(A.value), Y = e.includes($.value);
      return ct && !Y ? -1 : !ct && Y ? 1 : A.label.localeCompare($.label);
    });
    return [...S, ...E];
  }, [t, e, I]), Z = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(ae, { open: y, onOpenChange: f ?? V, children: [
    /* @__PURE__ */ o(xt, { asChild: !0, children: /* @__PURE__ */ p(
      F,
      {
        variant: v,
        role: "combobox",
    ...
    /* @__PURE__ */ o(oe, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(qt, { children: [
      ...
      n && /* @__PURE__ */ p("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        /* @__PURE__ */ o(F, { variant: "ghost", size: "sm", onClick: Z, children: s }),
        /* @__PURE__ */ o(F, { variant: "ghost", size: "sm", onClick: L, children: i })
      ] }),
      /* @__PURE__ */ p(Qt, { children: [
        /* @__PURE__ */ o(te, { children: l }),
        /* @__PURE__ */ o(ee, { children: j.map((S) => /* @__PURE__ */ p(
          Et,
          {
            value: S.label,
            onSelect: H,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(xe, { className: "tw:h-4 tw:w-4" }),
...
function go(t, e, a) {
  ...
  if (ba(t) || Ge.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (R(t), a.dismiss(), "ended") : (R(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (R(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (R(t), a.dismiss(), "ended") : t.key === "Backspace" || ie[r].test(t.key) ? (R(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && R(t), a.dismiss(), "ended");
}
function bo(t, e) {
  var a;
...
function ya(t) {
  ...
  return t.forEach((a) => {
    const r = O(a.projectId), n = e.get(r), s = {
...
function Mt(t, e, a) {
  const r = O(e);
  return t.some(
    (n) => O(n.projectId) === r && n.scrollGroupId === a
  );
}
function bt(t) {
  const e = ya(t.openTabs);
  if (t.mode === "project") {
    const n = t.selection.projectId === void 0 ? void 0 : O(t.selection.projectId);
    return t.projects.map((s) => {
      const i = e.get(O(s.id)) ?? [];
      return {
        rowKey: s.id,
        projectId: s.id,
  ...
  return t.projects.forEach((n) => {
    ...
    const s = O(n.projectId);
    if (r.some(
      (l) => O(l.projectId) === s && l.scrollGroupId === n.scrollGroupId
    ))
      return;
    const i = t.projects.find((l) => O(l.id) === s);
    i && r.push({
...
function yt(t) {
  return [{ kind: "flat", rows: [...t].sort(et) }];
}
function Sa(t) {
  const e = t.filter(Ht).sort(et), a = t.filter((n) => !Ht(n)).sort(et);
  if (e.length === 0)
...
function ka(t, e) {
  const a = t.filter((i) => i.isSelected).sort(et), r = t.filter((i) => !i.isSelected).sort(et), n = (i, l) => {
    var m;
    ...
    return typeof u == "string" && u.length > 0 ? u : i === "selected" ? zt : jt;
  }, s = [];
...
function Ia(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    ...
    const m = [...u].sort(
      (I, w) => {
        var g;
        return ((g = e.compareProjects) == null ? void 0 : g.call(e, I.project, w.project)) || et(I, w);
      }
...
function _a(t) {
  ...
  return [
    le(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[nt.lastUsedAt]) == "number" ? ut : Ea;
      },
...
function Aa({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = ra(), [I, w] = J(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = K(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), k();
  }, [k]), V = /* @__PURE__ */ o(Vt, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let H;
  e === "project" ? t.openGroups.length > 0 && (H = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ o(mt, { variant: "secondary", children: dt(L) }, L)) })) : t.scrollGroupId !== void 0 && (H = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ o(
      La,
      {
  ...
  const W = /* @__PURE__ */ p(
    Et,
    {
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "tw:flex tw:h-4 tw:w-4 tw:shrink-0 tw:items-center tw:justify-center", children: V }),
  ...
  ), j = t.scrollGroupId !== void 0 ? dt(t.scrollGroupId) : void 0, Z = t.isBoundButClosed && j ? a.boundButClosedTooltip.replace("{group}", j) : void 0;
  return /* @__PURE__ */ p(Tt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ o(Ct, { asChild: !0, children: W }),
    /* @__PURE__ */ p(
      Gt,
      {
        side: "top",
        ...
        children: [
          ...
          Z && /* @__PURE__ */ o("div", { className: "tw:text-sm tw:italic", children: Z }),
...
function Da({
  ...
  const n = e !== ot;
  return /* @__PURE__ */ p(oa, { children: [
    /* @__PURE__ */ p(Tt, { children: [
      /* @__PURE__ */ o(Ct, { asChild: !0, children: /* @__PURE__ */ o(na, { asChild: !0, children: /* @__PURE__ */ o(
        F,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      sa,
      {
        ...
        style: { zIndex: Xt },
        children: [
          /* @__PURE__ */ o(la, { children: r.groupSectionLabel }),
          /* @__PURE__ */ p(ia, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ o(Bt, { value: ot, children: r.groupByNone }),
            /* @__PURE__ */ o(da, {}),
...
function _o(t) {
  const [e, a] = J(!1), [r, n] = J(""), s = za(t.localizedStrings), i = tt(() => {
    ...
    [i, t.defaultGrouping]
  ), f = l ?? m, k = pt(null), [I, w] = J(void 0), g = K((c) => {
    a(c), c || (n(""), w(void 0));
  }, []);
  At(() => {
    if (!e) return;
  ...
  const v = tt(() => t.mode === "project" ? bt({
    ...
    () => new Map(t.projects.map((c) => [O(c.id), c])),
    [t.projects]
  ), V = K(
    (c) => c === void 0 ? void 0 : M.get(O(c)),
    [M]
  ), { renderProjectIndicator: H } = t, W = K(
    (c) => H ? H(c.project) : void 0,
    [H]
  ), j = !!H, Z = !!t.footerAction && h.length === 0, L = tt(() => {
    if (f === ot) return yt(h);
    const c = i.find((b) => b.id === f);
    return c ? Ia(h, c) : yt(h);
  }, [h, f, i]), y = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, D = O(c.projectId), P = (z) => O(z.projectId) === D && z.scrollGroupId === c.scrollGroupId, G = b.some(P) ? b.filter((z) => !P(z)) : [
          ...b.filter((z) => !P(z)),
    ...
    switch (t.mode) {
      case "project": {
        const c = V(t.selection.projectId);
        if (t.renderTriggerLabel)
          return { node: t.renderTriggerLabel(c), title: "" };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && t.triggerLabelFormat === "shortNameAndFullName" && c.fullName && c.fullName !== c.shortName && (b = `${c.shortName} - ${c.fullName}`), { node: b, title: b };
      }
      case "project-multi": {
        ...
        return {
          node: /* @__PURE__ */ p(we, { children: [
            /* @__PURE__ */ o(mt, { variant: "muted", className: "tw:shrink-0", children: P }),
  ...
  let Y;
  t.isLoading ? Y = /* @__PURE__ */ o(ke, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : $ ? Y = void 0 : t.mode === "project-multi" ? Y = /* @__PURE__ */ o(Ft, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : Y = /* @__PURE__ */ o(Ie, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const de = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, Lt = /* @__PURE__ */ p(
    F,
    {
      ref: A,
  ...
  ), ce = E.title ? /* @__PURE__ */ o(Pt, { delayDuration: 400, children: /* @__PURE__ */ p(Tt, { children: [
    /* @__PURE__ */ o(Ct, { asChild: !0, children: /* @__PURE__ */ o(xt, { asChild: !0, children: Lt }) }),
    /* @__PURE__ */ o(Gt, { children: E.title })
  ] }) }) : /* @__PURE__ */ o(xt, { asChild: !0, children: Lt }), ue = i.length > 1;
  return /* @__PURE__ */ p(ae, { open: e, onOpenChange: g, children: [
    ...
    /* @__PURE__ */ o(
      oe,
      {
        ...
        children: /* @__PURE__ */ o(Pt, { delayDuration: 400, children: /* @__PURE__ */ p(
          qt,
          {
            shouldFilter: !1,
            value: Z ? I ?? Ut : void 0,
            ...
            children: [
              ...
              /* @__PURE__ */ o("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ o(F, { variant: "ghost", size: "sm", onClick: S, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
              /* @__PURE__ */ p(Qt, { children: [
                ...
                L.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(ee, { heading: Oa(c, s), children: c.rows.map((D) => /* @__PURE__ */ o(
                          Aa,
                          {
                            row: D,
                            mode: t.mode,
                        ...
                        b < L.length - 1 && /* @__PURE__ */ o(Rt, { alwaysRender: !0 })
                      ]
                    },
                ...
                /* @__PURE__ */ p("div", { className: "tw:sticky tw:bottom-0 tw:z-10 tw:bg-popover", children: [
        ...
        children: [
          ...
          t && /* @__PURE__ */ p(
            F,
            {
              ...
              children: [
                /* @__PURE__ */ o(_e, { className: "tw:h-4 tw:w-4" }),
...
const Co = (t, e, a) => Ma(t, e).every((r) => a.includes(r));
function Ha(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => C.bookIdToNumber(r) > 0).sort((r, n) => C.bookIdToNumber(r) - C.bookIdToNumber(n)).map((r) => Qe(r, e));
}
function Go(t, e, a, r) {
...
function Lo({
  ...
  return /* @__PURE__ */ p(Ua, { className: d(s), role: n, children: [
    /* @__PURE__ */ p($a, { children: [
      /* @__PURE__ */ o(Fa, { variant: "icon", children: r ?? /* @__PURE__ */ o(Te, {}) }),
      /* @__PURE__ */ o(Va, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Ja, { children: /* @__PURE__ */ o(F, { onClick: () => a(), children: e }) })
  ] });
}
const Xa = Kt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Ce, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-kbtQvgvD.js.map
