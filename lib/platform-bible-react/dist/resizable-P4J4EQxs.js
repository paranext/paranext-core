...
import { Slot as Nt, Dialog as $, Separator as oe, Popover as rt, Tooltip as Q, DropdownMenu as T, Label as ne, RadioGroup as ft, ToggleGroup as Dt } from "radix-ui";
import { IconX as se, IconSearch as ie, IconCheck as vt, IconChevronRight as le } from "@tabler/icons-react";
import { Canon as z } from "@sillsdev/scripture";
import { cva as J } from "class-variance-authority";
import G, { useState as K, useRef as dt, useCallback as F, createContext as de, useContext as ce, useMemo as W, useEffect as Tt, Fragment as ue, forwardRef as Rt } from "react";
import { ChevronsUpDown as Pt, Check as Ot, Star as we, Group as pe, ArrowRight as me, Loader2 as fe, ChevronDown as he, Search as ge, X as be, AlertTriangle as Ne, LoaderCircle as ve } from "lucide-react";
import { Section as X, MODIFIER_KEYS as xe, normalizeProjectId as ot, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as et, getLocalizeKeyForScrollGroupId as ye, getSectionForBook as Se } from "platform-bible-utils";
...
const Bt = 600, Mt = 650, er = 400, Ge = 450, ze = 500, je = 675, ar = 690, rr = 700, or = 800, Ht = J(
...
function Kt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ m(Re, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(Oe, { children: /* @__PURE__ */ n(ie, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function Ze({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ n(Yt.Provider, { value: r, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Ar({
  ...t
}) {
...
const ra = ["input", "select", "textarea", "button"], oa = ["button", "textbox"], Wr = ({
  ...
  const o = dt(null), [s, i] = K(void 0), [l, u] = K(void 0), f = F(
    ...
    (w) => {
      var U;
      const g = w.target, v = (y) => y ? document.getElementById(y) : void 0, b = v(l), P = v(s);
      if (!!(b && g && b.contains(g) && g !== b) && k(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const O = y.findIndex((R) => R === g);
          if (O === -1) return;
          let S;
          w.key === "ArrowDown" ? S = Math.min(O + 1, y.length - 1) : S = Math.max(O - 1, 0), S !== O && (w.preventDefault(), w.stopPropagation(), (U = y[S]) == null || U.focus());
          return;
        }
        return;
      }
...
function no({
  ...
  return /* @__PURE__ */ n("div", { id: b, className: g, children: /* @__PURE__ */ m(Wt, { open: y, onOpenChange: h ?? V, children: [
    ...
    /* @__PURE__ */ n(qt, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m($t, { children: [
      /* @__PURE__ */ n(
        Kt,
        {
      ...
      /* @__PURE__ */ m(Ft, { children: [
        ...
        /* @__PURE__ */ n(Vt, { children: _.map((S) => /* @__PURE__ */ m(
          Xt,
          {
            value: S.label,
            onSelect: D,
...
function so(t, e, a) {
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (A(t), a.dismiss(), "ended") : (A(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (A(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (A(t), a.dismiss(), "ended") : t.key === "Backspace" || te[r].test(t.key) ? (A(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && A(t), a.dismiss(), "ended");
}
function io(t, e) {
  var a;
...
function Na(t) {
  ...
  return [
    ee(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[et.lastUsedAt]) == "number" ? it : ba;
      },
...
function Ea({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: u,
    onPointerLeave: f
  } = We(), [h, k] = K(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || h, g = F(() => {
    if (C) {
      k(!0);
      return;
    }
    ...
    k(!1), f();
  }, [f]), b = /* @__PURE__ */ n(Ot, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let P;
  e === "project" ? t.openGroups.length > 0 && (P = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((_) => /* @__PURE__ */ n(ct, { variant: "secondary", children: st(_) }, _)) })) : t.scrollGroupId !== void 0 && (P = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ia,
      {
...
function _a({
  ...
  return /* @__PURE__ */ m(Ze, { children: [
    /* @__PURE__ */ m(St, { children: [
      /* @__PURE__ */ n(kt, { asChild: !0, children: /* @__PURE__ */ n(qe, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
...
function go(t) {
  const [e, a] = K(!1), [r, o] = K(""), s = Sa(t.localizedStrings), i = W(() => {
    ...
    const c = [];
    return t.openTabs.length > 0 && c.push(ee(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      va({
  ...
  const w = W(() => t.mode === "project" ? mt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((j) => {
          const L = t.projects.find((ae) => ae.id === j.projectId);
  ...
  let U;
  t.isLoading ? U = /* @__PURE__ */ n(fe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : _ ? U = void 0 : t.mode === "project-multi" ? U = /* @__PURE__ */ n(Pt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : U = /* @__PURE__ */ n(he, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, O = /* @__PURE__ */ m(
    ...
    /* @__PURE__ */ n(kt, { asChild: !0, children: /* @__PURE__ */ n(gt, { asChild: !0, children: O }) }),
    /* @__PURE__ */ n(It, { children: D.title })
  ] }) }) : /* @__PURE__ */ n(gt, { asChild: !0, children: O }), R = i.length > 1;
  return /* @__PURE__ */ m(Wt, { open: e, onOpenChange: C, children: [
    S,
    /* @__PURE__ */ n(
      qt,
      {
        ...
        children: /* @__PURE__ */ n(zt, { delayDuration: 400, children: /* @__PURE__ */ m($t, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ m(Ft, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(Vt, { heading: Ca(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      Ea,
                      {
                        row: I,
                        mode: t.mode,
...
const Ma = Rt(({ className: t, ...e }, a) => /* @__PURE__ */ n(ve, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-P4J4EQxs.js.map
