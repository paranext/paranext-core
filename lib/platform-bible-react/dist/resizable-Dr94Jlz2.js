...
import { Slot as wt, Dialog as P, Popover as W, Tooltip as X, Label as Kt, RadioGroup as dt, ToggleGroup as St, Separator as Xt, DropdownMenu as z } from "radix-ui";
...
import G, { useState as _, useRef as mt, useCallback as $, createContext as Yt, useContext as Qt, useMemo as K, useEffect as te, Fragment as ee, forwardRef as Et } from "react";
...
const be = 600, Ca = 650, Gt = 400, ve = 450, Ne = 500, xe = 550, Sa = 700, Dt = V(
  ...
  return /* @__PURE__ */ g(ye, { children: [
    ...
    /* @__PURE__ */ g(
      P.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ n(P.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ g(M, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(qt, {}),
...
function Ra({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ n(P.Close, { asChild: !0, children: /* @__PURE__ */ n(M, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Lt({
  ...
  // the spread below
  spaceSelectsHighlightedItem: r = !1,
  ...a
}) {
  const o = R(), s = G.useCallback(
    (i) => {
      if (e == null || e(i), i.defaultPrevented || !r || i.key !== " " || i.currentTarget.value !== "") return;
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: o, children: /* @__PURE__ */ g(Ce, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        U.Input,
        {
...
function Ae() {
  return bt || (bt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", S = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", O = `[${l}]`, j = `${I}?`, E = `[${d}]?`, T = `(?:${S}(?:${[f, N, x].join("|")})${E + j})*`, A = E + j + T, C = `(?:${[`${f}${m}?`, m, N, x, c, O].join("|")})`;
    return new RegExp(`${B}|${h}(?=${h})|${C + A}`, "g");
  }), it;
}
var vt;
function Re() {
...
const $e = ["input", "select", "textarea", "button"], He = ["button", "textbox"], lr = ({
  ...
  const o = mt(null), [s, i] = _(void 0), [d, l] = _(void 0), c = $(
    ...
    if (x && He.includes(x)) return !0;
    const S = f.getAttribute("tabindex");
    return S !== void 0 && S !== "-1";
  }, I = $(
    (f) => {
      var H;
      const N = f.target, x = (C) => C ? document.getElementById(C) : void 0, S = x(d), B = x(s);
  ...
  return /* @__PURE__ */ n("div", { id: S, className: N, children: /* @__PURE__ */ g(jt, { open: C, onOpenChange: m ?? O, children: [
    ...
    /* @__PURE__ */ n($t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(Rt, { children: [
      ...
      o && /* @__PURE__ */ g("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
        ...
        /* @__PURE__ */ n(M, { variant: "ghost", size: "sm", onClick: H, children: i })
      ] }),
...
function na({ row: t, mode: e, strings: r, onClick: a, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    h(!1), c();
  }, [c]), B = /* @__PURE__ */ n(zt, { className: w("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let O;
...
function Gr(t) {
  ...
  const h = aa(t.localizedStrings), I = K(() => t.mode === "project" ? lt({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  const A = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? S : void 0, H = /* @__PURE__ */ g(
    M,
    {
  ...
  ), C = E.title ? /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ g(Ht, { children: [
          ...
          /* @__PURE__ */ g(Mt, { children: [
            ...
            N.map((u, p) => (
              ...
              /* @__PURE__ */ g(ee, { children: [
                /* @__PURE__ */ n(Pt, { heading: ia(u, h), children: u.rows.map((b) => /* @__PURE__ */ n(
                  na,
                  {
                    row: b,
                    mode: t.mode,
...
//# sourceMappingURL=resizable-Dr94Jlz2.js.map
