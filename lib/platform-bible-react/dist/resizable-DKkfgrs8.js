...
import { Slot as Nt, Dialog as $, Separator as de, Popover as ot, Tooltip as Q, DropdownMenu as T, Label as ce, RadioGroup as ft, ToggleGroup as Dt } from "radix-ui";
import { IconX as ue, IconSearch as we, IconCheck as vt, IconChevronRight as pe } from "@tabler/icons-react";
import { Canon as G } from "@sillsdev/scripture";
import { cva as V } from "class-variance-authority";
import z, { createContext as Pt, useContext as Bt, useState as K, useRef as dt, useCallback as F, useMemo as Z, useEffect as zt, Fragment as me, forwardRef as Mt } from "react";
import { ChevronsUpDown as Ht, Check as Ut, Star as fe, Group as he, ArrowRight as ge, Loader2 as be, ChevronDown as Ne, Search as ve, X as xe, AlertTriangle as ye, LoaderCircle as Se } from "lucide-react";
import { Section as X, MODIFIER_KEYS as ke, normalizeProjectId as rt, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as et, getLocalizeKeyForScrollGroupId as Ie, getSectionForBook as _e } from "platform-bible-utils";
...
import { extendTailwindMerge as Te, twMerge as Ce } from "tailwind-merge";
...
function Ge(t) {
  ...
  if (o !== -1) {
    const s = e[o].slice(4);
    return { normalized: `tw:${[...e.filter((u, f) => f !== o), `!${s}`].join(":")}`, original: t };
  }
...
function Ae(t, e) {
  ...
  const a = ht(t);
  if (a[0] !== "tw") return t;
  const o = a.slice(1, -1), r = a[a.length - 1], s = ht(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && r.startsWith("-")) {
    const u = r.slice(1);
    return [...o, `-tw-${u}`].join(":");
  }
...
function d(...t) {
  ...
  return a.forEach((u) => {
    const f = Ge(u);
    o.set(f.normalized, f.original), r.push(f.normalized);
  }), Ce(r.join(" ")).split(" ").filter(Boolean).map((u) => {
    const f = o.get(u);
    return f ? Ae(u, f) : u;
  }).join(" ");
}
const $t = 600, Kt = 650, lo = 400, Le = 450, je = 500, Re = 675, co = 690, uo = 700, wo = 800, Ft = V(
...
function H({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(Ft({ variant: e, size: a, className: t })),
      ...r
    }
  );
}
...
function Xt({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ m(Be, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      /* @__PURE__ */ n(
        q.Input,
        {
      ...
      /* @__PURE__ */ n(He, { children: /* @__PURE__ */ n(we, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
function zo(t, e) {
  var o;
  return ((o = e == null ? void 0 : e.get(t)) == null ? void 0 : o.localizedName) ?? G.bookIdToEnglishName(t);
}
function Xe(t, e) {
  var o;
...
const Go = Object.fromEntries(
  Fe.map((t) => [t, G.bookIdToEnglishName(t)])
);
function Ao(t, e, a) {
  const o = e.trim().toLowerCase();
  if (!o) return !1;
  const r = G.bookIdToEnglishName(t), s = a == null ? void 0 : a.get(t);
...
function nt(t, e) {
  ...
  return Array.from(t.querySelectorAll(a)).filter(
    (o) => !o.hasAttribute("disabled") && !o.getAttribute("aria-hidden") && Ze(o)
  );
}
const Lo = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
function We({
  className: t,
...
const Do = "data-platform-content-zoom-root", Po = "data-platform-content-zoom-popup", Ye = "--platform-content-zoom-", Qe = "--platform-content-zoom-default", ta = "main", ea = "--platform-content-zoom-popup-factor", Qt = Pt(void 0);
function Bo({ area: t, children: e }) {
...
function ae({
  ...
  const s = B(), i = z.useContext(ee), l = St();
  return (
    ...
    /* @__PURE__ */ n(ot.Portal, { container: i ?? void 0, children: /* @__PURE__ */ n(
      ot.Content,
      {
        ...
        className: d(
          ...
          l !== void 0 && "tw:max-w-[calc(var(--radix-popover-content-available-width)/var(--platform-content-zoom-popup-factor,1))]",
          ...
          // no nested pop-up.
          l !== void 0 && "tw:max-h-[calc(var(--radix-popover-content-available-height)/var(--platform-content-zoom-popup-factor,1))] tw:overflow-y-auto",
          t
        ),
        style: {
          zIndex: $t,
          ...l === void 0 ? void 0 : kt(l),
          ...o
        },
        dir: s,
...
function _t({
  ...
  return /* @__PURE__ */ n(
    Q.Trigger,
    {
      ...
      className: e ? d(Ft({ variant: e }), t) : t,
      ...a
    }
  );
}
  ...
  return /* @__PURE__ */ n(Q.Portal, { children: /* @__PURE__ */ m(
    Q.Content,
    {
      ...
      className: d(
        ...
        l !== void 0 && "tw:max-w-[min(20rem,calc(var(--radix-tooltip-content-available-width)/var(--platform-content-zoom-popup-factor,1)))]",
        t
      ),
      "data-platform-content-zoom-root": l,
      "data-platform-content-zoom-popup": l === void 0 ? void 0 : "",
...
function oa({ variant: t = "default", ...e }) {
  const a = B(), o = z.useMemo(
    () => ({
      variant: t
    }),
    [t]
  );
  return /* @__PURE__ */ n(oe.Provider, { value: o, children: /* @__PURE__ */ n(T.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function Fo({
  ...t
}) {
  ...
  return /* @__PURE__ */ n(T.Portal, { children: /* @__PURE__ */ n(
    T.Content,
    {
      ...
      className: d(
        ...
        l !== void 0 && "tw:max-h-[calc(var(--radix-dropdown-menu-content-available-height)/var(--platform-content-zoom-popup-factor,1))] tw:max-w-[calc(var(--radix-dropdown-menu-content-available-width)/var(--platform-content-zoom-popup-factor,1))]",
        t
      ),
      style: {
        zIndex: $t,
...
const ca = ["input", "select", "textarea", "button"], ua = ["button", "textbox"], sr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const r = dt(null), [s, i] = K(void 0), [l, u] = K(void 0), f = F(
    (w) => {
      i(w);
    ...
    (w) => {
      var U;
      const g = w.target, v = (y) => y ? document.getElementById(y) : void 0, b = v(l), D = v(s);
      ...
      switch (w.key) {
        case "ArrowDown":
          E = Math.min(M + 1, t.length - 1), w.preventDefault();
          break;
        case "ArrowUp":
          E = Math.max(M - 1, 0), w.preventDefault();
          break;
        case "Home":
        ...
        default:
          w.key.length === 1 && !w.metaKey && !w.ctrlKey && !w.altKey && (k(g) || (o == null || o(w.key), w.preventDefault()));
          return;
      }
      const Y = t[E];
      Y && f(Y.id);
...
function ct({ className: t, variant: e = "default", asChild: a = !1, ...o }) {
  const r = a ? Nt.Root : "span";
  return /* @__PURE__ */ n(
    r,
    {
      "data-slot": "badge",
    ...
    const a = (o) => {
      if (e.contains(document.activeElement)) {
        if (o.key === "ArrowRight" || o.key === "ArrowLeft") {
          ...
          const r = t.current ? nt(t.current) : [], s = r.indexOf(document.activeElement), i = o.key === "ArrowRight" ? s + 1 : s - 1;
  ...
  const l = z.useMemo(
    ...
    (h) => {
      ...
      if (h.key === "ArrowDown" || h.key === "ArrowUp")
        h.preventDefault(), fa(w, g, h.key);
      else if (h.key === "ArrowLeft" || h.key === "ArrowRight")
        h.preventDefault(), ma(l, v, h.key);
...
function hr({
  ...
  const [D, J] = K(!1), R = F(
    ...
    const S = t.filter((c) => c.starred).sort((c, p) => c.label.localeCompare(p.label)), O = t.filter((c) => !c.starred).sort((c, p) => {
      const I = e.includes(c.value), _ = e.includes(p.value);
      return I && !_ ? -1 : !I && _ ? 1 : c.label.localeCompare(p.label);
    });
    return [...S, ...O];
  }, [t, e, C]), Y = () => {
    a(t.map((S) => S.value));
  ...
  return /* @__PURE__ */ n("div", { id: b, className: g, children: /* @__PURE__ */ m(te, { open: y, onOpenChange: h ?? J, children: [
    ...
    /* @__PURE__ */ n(ae, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ m(Jt, { children: [
      /* @__PURE__ */ n(
        Xt,
        {
      ...
      r && /* @__PURE__ */ m("div", { className: "tw:flex tw:justify-between tw:border-b tw:p-2", children: [
      ...
      /* @__PURE__ */ m(Zt, { children: [
        ...
        /* @__PURE__ */ n(qt, { children: E.map((S) => /* @__PURE__ */ m(
          Yt,
          {
            value: S.label,
            onSelect: R,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ n(fe, { className: "tw:h-4 tw:w-4" }),
...
function ha(t, e, a) {
  if (!e) return [...t];
  const o = [...t], r = at(e).toLowerCase();
  return a === "passive" ? Gt({
    query: r,
    items: o,
    filter: (s) => at(s.label).toLowerCase().startsWith(r),
    sortBy: "label"
  }) : Gt({
    query: r,
    items: o,
    filter: (s) => at(s.label).toLowerCase().includes(r),
    sortBy: "label"
  });
}
function ga(t) {
...
function gr(t, e, a) {
  ...
  if (ga(t) || ke.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? o === "selection" && e.filter === "" ? (j(t), a.dismiss(), "ended") : (j(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && o === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (j(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (j(t), a.dismiss(), "ended") : t.key === "Backspace" || ne[o].test(t.key) ? (j(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (o === "selection" && j(t), a.dismiss(), "ended");
}
function br(t, e) {
  var a;
...
function xa(t) {
  ...
  return t.forEach((a) => {
    const o = rt(a.projectId), r = e.get(o), s = {
  ...
  return t.projects.forEach((r) => {
    ...
    s.forEach((i) => {
      o.push({
        ...
        openGroups: [],
        isSelected: Rt(a, r.id, i.scrollGroupId),
        isMuted: !1,
        isBoundButClosed: !1,
        isDisabled: r.isDisabled === !0,
        disabledReason: r.disabledReason,
    ...
    if (r.scrollGroupId === void 0 || o.some((i) => i.projectId === r.projectId && i.scrollGroupId === r.scrollGroupId))
      return;
    const s = t.projects.find((i) => i.id === r.projectId);
    s && o.push({
      rowKey: `closed:${s.id}:${r.scrollGroupId}`,
      projectId: s.id,
      shortName: s.shortName,
      fullName: s.fullName,
...
function bt(t) {
  return [{ kind: "flat", rows: [...t].sort(W) }];
}
function ya(t) {
  const e = t.filter(Ot).sort(W), a = t.filter((r) => !Ot(r)).sort(W);
  if (e.length === 0)
...
function Sa(t, e) {
  const a = t.filter((i) => i.isSelected).sort(W), o = t.filter((i) => !i.isSelected).sort(W), r = (i, l) => {
    var f;
...
function ka(t, e) {
  ...
  const s = [...a.entries()].map(([l, u]) => {
    var k;
    const f = [...u].sort(W), h = ((k = e.getSectionHeading) == null ? void 0 : k.call(
      e,
      l,
      f.map((C) => C.project)
    )) ?? l;
...
function _a(t) {
  ...
  return [
    se(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[et.lastUsedAt]) == "number" ? it : Ia;
      },
      ...
      compareSections: (a, o) => a.key === it ? -1 : o.key === it ? 1 : 0
    },
    {
      id: "language",
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[et.language];
    ...
    },
    {
      ...
      getGroupKey: (a) => {
        var r;
        const o = (r = a.customData) == null ? void 0 : r[et.type];
        return typeof o == "string" ? o : void 0;
      },
      ...
      getSectionHeading: (a, o) => {
        ...
        ), s = (i = r == null ? void 0 : r.customData) == null ? void 0 : i[et.typeName];
...
function La({ row: t, mode: e, strings: a, onClick: o, onOpen: r, selectedRowRef: s }) {
  const {
    ref: i,
    open: l,
    onPointerEnter: u,
    onPointerLeave: f
  } = aa(), [h, k] = K(!1), C = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, w = l || h, g = F(() => {
    if (C) {
      k(!0);
      return;
    }
    ...
    k(!1), f();
  }, [f]), b = /* @__PURE__ */ n(Ut, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let D;
  e === "project" ? t.openGroups.length > 0 && (D = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((E) => /* @__PURE__ */ n(ct, { variant: "secondary", children: st(E) }, E)) })) : t.scrollGroupId !== void 0 && (D = /* @__PURE__ */ m("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Aa,
      {
    ...
    t.isBoundButClosed && r && /* @__PURE__ */ m(
      H,
      {
        size: "sm",
        variant: "ghost",
  ...
  ), R = t.scrollGroupId !== void 0 ? st(t.scrollGroupId) : void 0, M = t.isBoundButClosed && R ? a.boundButClosedTooltip.replace("{group}", R) : void 0;
  return /* @__PURE__ */ m(It, { open: w, delayDuration: 400, children: [
    ...
    /* @__PURE__ */ m(
      Et,
      {
        ...
        children: [
          ...
          !t.isBoundButClosed && t.scrollGroupScrRefLabel && R && /* @__PURE__ */ m("div", { className: "tw:text-sm", children: [
...
function ja({
  ...
  return /* @__PURE__ */ m(oa, { children: [
    /* @__PURE__ */ m(It, { children: [
      /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(ra, { asChild: !0, children: /* @__PURE__ */ n(
        H,
        {
          variant: "ghost",
          size: "sm",
          ...
          children: /* @__PURE__ */ n(he, { className: "tw:h-4 tw:w-4" })
        }
      ) }) }),
      /* @__PURE__ */ n(Et, { children: o.groupByAriaLabel })
    ] }),
    /* @__PURE__ */ m(
      na,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(sa, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(jt, { value: tt, children: o.groupByNone }),
            /* @__PURE__ */ n(la, {}),
...
function Er(t) {
  const [e, a] = K(!1), [o, r] = K(""), s = za(t.localizedStrings), i = Z(() => {
  ...
  const w = Z(() => t.mode === "project" ? mt({
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const p = t.selection.pairs, I = rt(c.projectId), _ = (L) => rt(L.projectId) === I && L.scrollGroupId === c.scrollGroupId, A = p.some(_) ? p.filter((L) => !_(L)) : [
          ...p.filter((L) => !_(L)),
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        ...
        const p = [];
        if (c.forEach((A) => {
          const L = t.projects.find((ie) => ie.id === A.projectId);
          L && p.push({ project: L, scrollGroupId: A.scrollGroupId });
        }), p.length === 0) {
          const A = s.buttonPlaceholder;
          return { node: A, title: A };
        }
        const I = p.map(
          ({ project: A, scrollGroupId: L }) => L === void 0 ? A.shortName : `${A.shortName} (${st(L)})`
        ).join(", "), _ = p.length.toString();
        return {
          node: /* @__PURE__ */ m(le, { children: [
            /* @__PURE__ */ n(ct, { variant: "muted", className: "tw:shrink-0", children: _ }),
  ...
  }, [t, s.buttonPlaceholder]), M = dt(null), [E, Y] = K(!1);
  zt(() => {
    const c = M.current;
    if (!c) return;
    const p = (_) => {
  ...
  let U;
  t.isLoading ? U = /* @__PURE__ */ n(be, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : E ? U = void 0 : t.mode === "project-multi" ? U = /* @__PURE__ */ n(Ht, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : U = /* @__PURE__ */ n(Ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const y = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? b : void 0, P = /* @__PURE__ */ m(
    H,
    {
      ...
      className: d(
        ...
        // wide case.
        E && "tw:px-0.5 tw:text-xs",
        t.buttonClassName
      ),
      children: [
        /* @__PURE__ */ n("span", { className: "tw:flex tw:min-w-0 tw:flex-1 tw:items-baseline tw:gap-2 tw:overflow-hidden tw:whitespace-nowrap tw:text-start", children: typeof R.node == "string" ? /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: R.node }) : R.node }),
        U
      ]
    }
  ), S = R.title ? /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(It, { children: [
    /* @__PURE__ */ n(_t, { asChild: !0, children: /* @__PURE__ */ n(gt, { asChild: !0, children: P }) }),
    /* @__PURE__ */ n(Et, { children: R.title })
  ] }) }) : /* @__PURE__ */ n(gt, { asChild: !0, children: P }), O = i.length > 1;
  return /* @__PURE__ */ m(te, { open: e, onOpenChange: C, children: [
    S,
    /* @__PURE__ */ n(
      ae,
      {
        ...
        children: /* @__PURE__ */ n(Lt, { delayDuration: 400, children: /* @__PURE__ */ m(Jt, { shouldFilter: !1, children: [
          ...
          /* @__PURE__ */ n("div", { className: "tw:flex tw:justify-end tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: /* @__PURE__ */ n(H, { variant: "ghost", size: "sm", onClick: J, children: `${s.clearAll} (${t.selection.pairs.length.toString()})` }) }),
          /* @__PURE__ */ m(Zt, { children: [
            ...
            v.map((c, p) => (
              ...
              /* @__PURE__ */ m(
                ...
                {
                  children: [
                    /* @__PURE__ */ n(qt, { heading: Oa(c, s), children: c.rows.map((I) => /* @__PURE__ */ n(
                      La,
                      {
                        row: I,
                        mode: t.mode,
...
const Da = Mt(
  ({ value: t, onSearch: e, placeholder: a, isFullWidth: o, className: r, isDisabled: s = !1, id: i }, l) => {
    ...
    return /* @__PURE__ */ m(
      ...
      {
        id: i,
        className: d("tw:relative tw:@container/search", { "tw:w-full": o }, r),
        children: [
          /* @__PURE__ */ n(
            ve,
            {
...
const Cr = (t, e, a) => Ba(t, e).every((o) => a.includes(o));
function Ma(t, e) {
  return [
    ...new Set(t.map((o) => o.toUpperCase()))
  ].filter((o) => G.bookIdToNumber(o) > 0).sort((o, r) => G.bookIdToNumber(o) - G.bookIdToNumber(r)).map((o) => Xe(o, e));
}
function zr(t, e, a, o) {
...
function Gr({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ n(
    "p",
    {
      role: "status",
...
function Lr({
  ...
  return /* @__PURE__ */ m(Ha, { className: d(s), role: r, children: [
    /* @__PURE__ */ m(Ua, { children: [
      /* @__PURE__ */ n(Ka, { variant: "icon", children: o ?? /* @__PURE__ */ n(ye, {}) }),
      /* @__PURE__ */ n(Fa, { children: t })
    ] }),
    a && /* @__PURE__ */ n(Va, { children: /* @__PURE__ */ n(H, { onClick: () => a(), children: e }) })
  ] });
}
const Ja = Mt(({ className: t, ...e }, a) => /* @__PURE__ */ n(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-DKkfgrs8.js.map
