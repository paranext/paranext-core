...
import { IconX as Wt, IconSearch as Zt, IconCheck as wt, IconChevronRight as qt } from "@tabler/icons-react";
...
function d(...t) {
  ...
  }), he(o.join(" ")).split(" ").filter(Boolean).map((w) => {
    const g = r.get(w);
    return g ? Ne(w, g) : w;
  }).join(" ");
}
const Tt = 600, Ba = 650, Ma = 400, ve = 450, xe = 500, ye = 550, _a = 650, ja = 700, $a = 800, zt = $(
  ...
  return /* @__PURE__ */ f(Ie, { children: [
    ...
    /* @__PURE__ */ f(
      M.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ n(M.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ f(R, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(Wt, {}),
...
function Xa({
  ...
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: [
        a,
        e && /* @__PURE__ */ n(M.Close, { asChild: !0, children: /* @__PURE__ */ n(R, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function Bt({ ...t }) {
  return /* @__PURE__ */ n(q.Root, { "data-slot": "popover", ...t });
}
function ct({ ...t }) {
  return /* @__PURE__ */ n(q.Trigger, { "data-slot": "popover-trigger", ...t });
}
const Mt = z.createContext(null);
function lr({
  container: t,
  children: e
}) {
  return /* @__PURE__ */ n(Mt.Provider, { value: t, children: e });
}
function _t({
  className: t,
  align: e = "center",
  ...
  const s = P(), i = z.useContext(Mt);
  return (
    // CUSTOM: When a PopoverPortalContainerProvider is in scope, portal into its container
    // instead of the default document.body so nested popovers stay inside modal dialogs.
    /* @__PURE__ */ n(q.Portal, { container: i ?? void 0, children: /* @__PURE__ */ n(
      q.Content,
      {
...
function dr({ ...t }) {
  return /* @__PURE__ */ n(q.Anchor, { "data-slot": "popover-anchor", ...t });
}
...
const je = ["input", "select", "textarea", "button"], $e = ["button", "textbox"], Ir = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
}) => {
  const o = mt(null), [s, i] = _(void 0), [l, w] = _(void 0), g = j(
    (m) => {
      i(m);
...
function Hr({
  ...
  return /* @__PURE__ */ n("div", { id: x, className: v, children: /* @__PURE__ */ f(Bt, { open: C, onOpenChange: b ?? B, children: [
    ...
    /* @__PURE__ */ n(_t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ f(At, { children: [
      /* @__PURE__ */ n(
        Dt,
        {
...
function Fr(t, e, a) {
  ...
  if (Ye(t) || ue.has(t.key) || t.key === "Dead")
    return "passed";
...
function da({ row: t, mode: e, strings: a, onClick: r, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: w,
    onPointerLeave: g
  } = Oe(), [b, k] = _(!1), A = !!(t.language || t.languageCode), m = A || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, v = l || b, I = j(() => {
    if (m) {
      k(!0);
      return;
    }
    ...
    k(!1), g();
  }, [g]), O = /* @__PURE__ */ n(Et, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let B;
  e === "project" ? t.openGroups.length > 0 && (B = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ n(rt, { variant: "secondary", children: tt(L) }, L)) })) : t.scrollGroupId !== void 0 && (B = /* @__PURE__ */ f("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      la,
      {
...
function Xr(t) {
  const [e, a] = _(!1), [r, o] = _(""), [s, i] = _(t.defaultGroupByOpenTabs ?? !0), [l, w] = _(!1), g = mt(null), b = j((c) => {
    a(c), c || o("");
  }, []);
  te(() => {
    if (!e) return;
  ...
  const k = sa(t.localizedStrings), A = U(() => t.mode === "project" ? it({
    mode: "project",
    projects: t.projects,
    openTabs: t.openTabs,
  ...
  let T;
  t.isLoading ? T = /* @__PURE__ */ n(ne, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : t.hideTriggerChevron ? T = void 0 : t.mode === "project-multi" ? T = /* @__PURE__ */ n(St, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : T = /* @__PURE__ */ n(se, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
      ...
      _t,
      {
        ...
        children: /* @__PURE__ */ n(gt, { delayDuration: 400, children: /* @__PURE__ */ f(At, { shouldFilter: !1, children: [
          ...
          t.mode === "project-multi" && /* @__PURE__ */ f("div", { className: "tw:flex tw:justify-between tw:border-b tw:py-2 tw:pe-4 tw:ps-2", children: [
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: B, children: `${k.selectAll} (${I.length.toString()})` }),
            /* @__PURE__ */ n(R, { variant: "ghost", size: "sm", onClick: J, children: `${k.clearAll} (${t.selection.pairs.length.toString()})` })
          ] }),
          /* @__PURE__ */ f(Lt, { children: [
            ...
            v.map((c, u) => (
              ...
              /* @__PURE__ */ f(ee, { children: [
                /* @__PURE__ */ n(Pt, { heading: ua(c, k), children: c.rows.map((p) => /* @__PURE__ */ n(
                  da,
                  {
                    row: p,
                    mode: t.mode,
...
const Zr = (t, e, a) => fa(t, e).every((r) => a.includes(r));
function pa(t, e) {
  return [
...
function to({
  ...
  return /* @__PURE__ */ f(ha, { className: d(s), role: o, children: [
    /* @__PURE__ */ f(ga, { children: [
      /* @__PURE__ */ n(Na, { variant: "icon", children: r ?? /* @__PURE__ */ n(de, {}) }),
      /* @__PURE__ */ n(va, { children: t })
    ] }),
    a && /* @__PURE__ */ n(xa, { children: /* @__PURE__ */ n(R, { onClick: () => a(), children: e }) })
  ] });
}
const ya = Ct(({ className: t, ...e }, a) => /* @__PURE__ */ n(ce, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-BTh0w_GD.js.map
