...
import { Slot as wt, Dialog as j, Popover as W, Tooltip as K, Label as Xt, RadioGroup as dt, ToggleGroup as St, Separator as Kt, DropdownMenu as z } from "radix-ui";
  ...
  return /* @__PURE__ */ g(ye, { children: [
    ...
    /* @__PURE__ */ g(
      j.Content,
      {
        ...
        children: [
          e,
          r && /* @__PURE__ */ n(j.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ g(M, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ n(qt, {}),
...
function Ra({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        r,
        e && /* @__PURE__ */ n(j.Close, { asChild: !0, children: /* @__PURE__ */ n(M, { variant: "outline", children: "Close" }) })
      ]
    }
  );
}
...
function ze() {
  return gt || (gt = 1, it = () => {
    const t = "\\ud800-\\udfff", i = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", d = "\\ufe0e\\ufe0f", l = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, m = `[${i}]`, h = "\\ud83c[\\udffb-\\udfff]", I = `(?:${m}|${h})`, f = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", x = "[\\ud800-\\udbff][\\udc00-\\udfff]", S = "\\u200d", P = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", O = `[${l}]`, B = `${I}?`, E = `[${d}]?`, T = `(?:${S}(?:${[f, N, x].join("|")})${E + B})*`, A = E + B + T, C = `(?:${[`${f}${m}?`, m, N, x, c, O].join("|")})`;
...
const Va = Object.fromEntries(
  Re.map((t) => [t, D.bookIdToEnglishName(t)])
);
function Ua(t, e, r) {
  ...
  return /* @__PURE__ */ n("div", { id: S, className: N, children: /* @__PURE__ */ g(Bt, { open: C, onOpenChange: m ?? O, children: [
    ...
    /* @__PURE__ */ n($t, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ g(Rt, { children: [
      ...
      /* @__PURE__ */ g(Mt, { children: [
        ...
        /* @__PURE__ */ n(jt, { children: T.map((p) => /* @__PURE__ */ g(
          Pt,
          {
            value: p.label,
            onSelect: B,
...
function na({ row: t, mode: e, strings: r, onClick: a, onOpen: o, selectedRowRef: s }) {
  const {
    ...
    onPointerEnter: l,
    onPointerLeave: c
  } = je(), [m, h] = _(!1), I = !!(t.language || t.languageCode), f = I || !!t.scrollGroupScrRefLabel || t.isBoundButClosed || t.isDisabled && !!t.disabledReason, N = d || m, x = $(() => {
    if (f) {
      h(!0);
      return;
    }
          ...
          /* @__PURE__ */ g(Mt, { children: [
            ...
            N.map((u, p) => (
              ...
              /* @__PURE__ */ g(ee, { children: [
                /* @__PURE__ */ n(jt, { heading: ia(u, h), children: u.rows.map((b) => /* @__PURE__ */ n(
                  na,
                  {
                    row: b,
                    mode: t.mode,
...
function ua(t, e) {
  ...
  ].filter((a) => D.bookIdToNumber(a) > 0).sort((a, o) => D.bookIdToNumber(a) - D.bookIdToNumber(o)).map((a) => Oe(a, e));
}
function Rr(t, e, r, a) {
...
//# sourceMappingURL=resizable-CE8CrItT.js.map
